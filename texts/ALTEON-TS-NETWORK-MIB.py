...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxHello=ospfIntfTxHello, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSAId=routerLSAId, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpGeneral=vrrpGeneral, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfBackup=ospfIntfBackup, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxPkts=ospfAreaTxPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalAreas=ospfTotalAreas, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfHello=ospfCumIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwState=ipCurCfgGwState, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwAddr=ipNewCfgGwAddr, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrStart=ospfCumNbrStart, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfArea=ospfArea, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSALinkData=routerLSALinkData, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, dnsStats=dnsStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfProcessUptime=ospfProcessUptime, ipRouteInfoEntry=ipRouteInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStatInAdvers=vrrpStatInAdvers, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoMacAddr=arpInfoMacAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripNewCfgState=ripNewCfgState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfStats=ospfStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgState=ripCurCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfLoop=ospfIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrhello=ospfCumNbrhello, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStats=vrrpStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoTag=ipRouteInfoTag, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoFlag=arpInfoFlag, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkID=routerLSALinkID, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrp_info=vrrp_info, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, iprouting=iprouting, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripStatInPkts=ripStatInPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfInterface=ospfInterface, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgDefListen=ripNewCfgDefListen, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfGeneralStats=ospfGeneralStats, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgVip=ripCurCfgVip, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxHello=ospfAreaTxHello, arpStatHighWater=arpStatHighWater, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaChangeStats=ospfAreaChangeStats, arpStatEntries=arpStatEntries, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgBootpState=ipCurCfgBootpState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipForward=ipForward, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routeStatEntries=routeStatEntries, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaInfoId=ospfAreaInfoId, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripStats=ripStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfinfo=ospfinfo, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCfg=ospfCfg, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfGeneral=ospfGeneral, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfDown=ospfAreaIntfDown, ripConfig=ripConfig, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfState=ipCurCfgIntfState, routeStatMaxEntries=routeStatMaxEntries, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrp=vrrp, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripStatInErrorPkts=ripStatInErrorPkts, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrhello=ospfIntfNbrhello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfState=ipNewCfgIntfState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpStats=arpStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxPkts=ospfCumRxPkts, ospfIntfDown=ospfIntfDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, vrrpStatOutAdvers=vrrpStatOutAdvers, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoTable=arpInfoTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwTable=ipCurCfgGwTable, arpInfoEntry=arpInfoEntry, ripStatOutPkts=ripStatOutPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ip_info=ip_info, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort)
