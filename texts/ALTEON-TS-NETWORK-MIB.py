...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfInterface=ospfInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoSrcPort=arpInfoSrcPort, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfStats=ospfStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpStats=arpStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfHello=ospfCumIntfHello, arpInfoVLAN=arpInfoVLAN, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaInfoEntry=ospfAreaInfoEntry, routeStatHighWater=routeStatHighWater, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoTag=ipRouteInfoTag, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgListen=ripNewCfgListen, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxPkts=ospfCumTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrp_info=vrrp_info, ipCurCfgGwState=ipCurCfgGwState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfGeneral=ospfGeneral, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfArea=ospfArea, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSAId=routerLSAId, ripCurCfgSupply=ripCurCfgSupply, ospfIntfBackup=ospfIntfBackup, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpStatHighWater=arpStatHighWater, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfHello=ospfIntfHello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpStats=vrrpStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfinfo=ospfinfo, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrStart=ospfCumNbrStart, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ip_info=ip_info, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, routeStats=routeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfIndex=ospfIntfIndex, ospfIntfChangeStats=ospfIntfChangeStats, dnsStats=dnsStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripStatOutPkts=ripStatOutPkts, ospfCfg=ospfCfg, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfState=ipCurCfgIntfState, vrrpGeneral=vrrpGeneral, ipRouteInfoDestIp=ipRouteInfoDestIp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkID=routerLSALinkID, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoTable=arpInfoTable, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoEntry=arpInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfStartTime=ospfStartTime, ipGatewayTableMax=ipGatewayTableMax, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripStats=ripStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgListen=ripCurCfgListen, ospfTotalNeighbours=ospfTotalNeighbours, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfProcessUptime=ospfProcessUptime, ospfCumNbrDown=ospfCumNbrDown, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStatEntries=routeStatEntries, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgState=ripCurCfgState, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrp=vrrp, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOper=vrrpOper, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripConfig=ripConfig, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwAddr=ipNewCfgGwAddr, ripStatInPkts=ripStatInPkts, ipForward=ipForward, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, iprouting=iprouting, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routerLSALinkData=routerLSALinkData, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripNewCfgState=ripNewCfgState, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfLoop=ospfCumIntfLoop, ospfGeneralInfo=ospfGeneralInfo, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfLsTypesSupported=ospfLsTypesSupported, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer)
