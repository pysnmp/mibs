...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfStartTime=ospfStartTime, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaInfoId=ospfAreaInfoId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, arpInfoEntry=arpInfoEntry, ripNewCfgListen=ripNewCfgListen, ripStatOutPkts=ripStatOutPkts, ipNewCfgBootpState=ipNewCfgBootpState, ospfTotalAreas=ospfTotalAreas, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoType=ipRouteInfoType, ripStatInPkts=ripStatInPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routerLSALinkIndex=routerLSALinkIndex, ospfIfInfoIndex=ospfIfInfoIndex, ip_info=ip_info, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStats=ospfStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCfg=ospfCfg, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgState=ripCurCfgState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxHello=ospfCumTxHello, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripConfig=ripConfig, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripStats=ripStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxHello=ospfAreaTxHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpStats=arpStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfLoop=ospfIntfLoop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgState=ipFwdNewCfgState, ripNewCfgState=ripNewCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSALinkData=routerLSALinkData, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStatEntries=routeStatEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, dnsStats=dnsStats, vrrpOper=vrrpOper, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgDefListen=ripNewCfgDefListen, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoTable=arpInfoTable, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoSrcPort=arpInfoSrcPort, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenState=vrrpNewCfgGenState, arpStatHighWater=arpStatHighWater, ospfCumIntfDown=ospfCumIntfDown, ospfNbrInExchState=ospfNbrInExchState, ospfIntfHello=ospfIntfHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSAId=routerLSAId, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpGeneral=vrrpGeneral, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxPkts=ospfIntfRxPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfArea=ospfArea, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfProcessUptime=ospfProcessUptime, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgListen=ripCurCfgListen, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgVip=ripCurCfgVip, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaChangeStats=ospfAreaChangeStats, ospfGeneralStats=ospfGeneralStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipForward=ipForward, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, iprouting=iprouting, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStats=vrrpStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfinfo=ospfinfo, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwArp=ipNewCfgGwArp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfLoop=ospfCumIntfLoop, ospfNbrInInitState=ospfNbrInInitState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrhello=ospfAreaNbrhello, routeStats=routeStats, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrp=vrrp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripNewCfgVip=ripNewCfgVip)
