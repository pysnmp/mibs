...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoFlag=arpInfoFlag, ospfAreaTxHello=ospfAreaTxHello, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCfg=ospfCfg, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSAId=routerLSAId, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfGeneral=ospfGeneral, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoSrcPort=arpInfoSrcPort, ipRouteInfoTable=ipRouteInfoTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routeStatHighWater=routeStatHighWater, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, iprouting=iprouting, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgState=ripCurCfgState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumTxHello=ospfCumTxHello, arpInfoEntry=arpInfoEntry, vrrp=vrrp, ripCurCfgSupply=ripCurCfgSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfArea=ospfArea, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripConfig=ripConfig, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripStats=ripStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfInfoTable=ospfIntfInfoTable, routeStats=routeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxDatabase=ospfCumRxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfDown=ospfCumIntfDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrp_info=vrrp_info, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfInterface=ospfInterface, ospfIntfLoop=ospfIntfLoop, ospfLsTypesSupported=ospfLsTypesSupported, ip_info=ip_info, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStats=vrrpStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxHello=ospfCumRxHello, ospfIntfDown=ospfIntfDown, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgVip=ripNewCfgVip, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSALinkID=routerLSALinkID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfinfo=ospfinfo, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoMask=ipRouteInfoMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfStats=ospfStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, dnsStats=dnsStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpGeneral=vrrpGeneral, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxDatabase=ospfCumTxDatabase, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpStats=arpStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpInfoTable=arpInfoTable, arpStatHighWater=arpStatHighWater, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrDown=ospfCumNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfIndex=ospfIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ospfIntfHello=ospfIntfHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwState=ipNewCfgGwState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipForward=ipForward, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfLoop=ospfAreaIntfLoop, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxPkts=ospfIntfRxPkts, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoDestIp=arpInfoDestIp, vrrpOper=vrrpOper, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone)
