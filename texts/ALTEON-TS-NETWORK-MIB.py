...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoSrcPort=arpInfoSrcPort, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfGeneral=ospfGeneral, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStats=ripStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoDestIp=arpInfoDestIp, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipForward=ipForward, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, dnsStats=dnsStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfArea=ospfArea, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxlsReqs=ospfIntfTxlsReqs, iprouting=iprouting, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOper=vrrpOper, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgBootpState=ipCurCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgState=ripCurCfgState, ospfIntfIndex=ospfIntfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routeStatHighWater=routeStatHighWater, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpStatEntries=arpStatEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrhello=ospfCumNbrhello, ospfIntfChangeStats=ospfIntfChangeStats, vrrpStats=vrrpStats, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, arpStatHighWater=arpStatHighWater, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgListen=ripNewCfgListen, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfStartTime=ospfStartTime, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxHello=ospfCumRxHello, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfGeneralInfo=ospfGeneralInfo, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfInterface=ospfInterface, arpInfoTable=arpInfoTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routerLSAId=routerLSAId)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgDefListen=ripCurCfgDefListen, ripStatInPkts=ripStatInPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoFlag=arpInfoFlag, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpInfoVLAN=arpInfoVLAN, ospfAreaTxHello=ospfAreaTxHello, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfLoop=ospfIntfLoop, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgListen=ripCurCfgListen, vrrpGeneral=vrrpGeneral, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrp=vrrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ip_info=ip_info, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxPkts=ospfIntfRxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgState=ipFwdNewCfgState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfCountForRouter=ospfIntfCountForRouter, ripCurCfgVip=ripCurCfgVip, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkData=routerLSALinkData, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpStats=arpStats, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrp_info=vrrp_info, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoMacAddr=arpInfoMacAddr, routerLSALinkID=routerLSALinkID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCfg=ospfCfg, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripConfig=ripConfig, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfProcessUptime=ospfProcessUptime, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrhello=ospfAreaNbrhello)
