...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routeStatMaxEntries=routeStatMaxEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpStatEntries=arpStatEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripStatOutPkts=ripStatOutPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgSupply=ripNewCfgSupply, vrrpStats=vrrpStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfinfo=ospfinfo, ospfIntfHello=ospfIntfHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripConfig=ripConfig, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfMask=ipCurCfgIntfMask, ipForward=ipForward, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfDown=ospfCumIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoEntry=arpInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfGeneralStats=ospfGeneralStats, arpStats=arpStats, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwArp=ipNewCfgGwArp, iprouting=iprouting, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, arpStatHighWater=arpStatHighWater, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfHello=ospfCumIntfHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSAId=routerLSAId, ospfIntfCountForRouter=ospfIntfCountForRouter, routeStats=routeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSALinkData=routerLSALinkData, vrrp=vrrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfDown=ospfIntfDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipGatewayTableMax=ipGatewayTableMax, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwIndex=ipNewCfgGwIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripStats=ripStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgListen=ripNewCfgListen, arpInfoTable=arpInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgBootpState=ipNewCfgBootpState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfProcessUptime=ospfProcessUptime, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgBootpState=ipCurCfgBootpState, ripCurCfgState=ripCurCfgState, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTxHello=ospfAreaTxHello, ospfIntfBackup=ospfIntfBackup, vrrp_info=vrrp_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTotalAreas=ospfTotalAreas, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ip_info=ip_info, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrN1way=ospfCumNbrN1way, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwState=ipCurCfgGwState, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStats=dnsStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfIndex=ospfIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfInterface=ospfInterface, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpOper=vrrpOper, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripStatInPkts=ripStatInPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoSrcPort=arpInfoSrcPort, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfStartTime=ospfStartTime, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrDown=ospfAreaNbrDown, vrrpGeneral=vrrpGeneral, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoDestIp=arpInfoDestIp, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoEntry=ipRouteInfoEntry, ospfCfg=ospfCfg, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask)
