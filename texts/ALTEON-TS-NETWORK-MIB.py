...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgSupply=ripCurCfgSupply, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfGeneral=ospfGeneral, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCfg=ospfCfg, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoVLAN=arpInfoVLAN, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxHello=ospfAreaRxHello, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfGeneralInfo=ospfGeneralInfo, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpStats=vrrpStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNbrInExchState=ospfNbrInExchState, routerLSALinkID=routerLSALinkID, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrp=vrrp, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, routeStats=routeStats, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpStatInAdvers=vrrpStatInAdvers, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaInfoEntry=ospfAreaInfoEntry, arpStatMaxEntries=arpStatMaxEntries, ip_info=ip_info, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwAddr=ipNewCfgGwAddr, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrN1way=ospfCumNbrN1way, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripStats=ripStats, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStats=arpStats, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfLoop=ospfIntfLoop, vrrp_info=vrrp_info, ospfCumTxHello=ospfCumTxHello, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfArea=ospfArea, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfIndex=ospfIntfIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatOutPkts=ripStatOutPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfStartTime=ospfStartTime, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoFlag=arpInfoFlag, ipRouteInfoEntry=ipRouteInfoEntry, iprouting=iprouting, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrhello=ospfCumNbrhello, ospfInterface=ospfInterface, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, dnsStats=dnsStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxPkts=ospfCumRxPkts, ospfProcessUptime=ospfProcessUptime, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfBackup=ospfIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfLsTypesSupported=ospfLsTypesSupported, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoEntry=arpInfoEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgState=ripCurCfgState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripConfig=ripConfig, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfHello=ospfIntfHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgState=ripNewCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgVip=ripCurCfgVip, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoDestIp=arpInfoDestIp, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfinfo=ospfinfo, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgState=ipFwdCurCfgState, ripStatInPkts=ripStatInPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfStats=ospfStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ipGatewayTableMax=ipGatewayTableMax, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoType=ipRouteInfoType, arpInfoTable=arpInfoTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats)
