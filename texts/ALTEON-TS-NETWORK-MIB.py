...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpInfoEntry=arpInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfLoop=ospfCumIntfLoop, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOper=vrrpOper, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfIndex=ospfIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStats=routeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoMask=ipRouteInfoMask, vrrpStats=vrrpStats, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfStats=ospfStats, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfBackup=ospfCumIntfBackup, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrDown=ospfCumNbrDown, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwState=ipNewCfgGwState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTxHello=ospfIntfTxHello, vrrpGeneral=vrrpGeneral, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxPkts=ospfAreaRxPkts, ospfArea=ospfArea, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwTable=ipNewCfgGwTable, ripStatInErrorPkts=ripStatInErrorPkts, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwInterval=ipNewCfgGwInterval, ip_info=ip_info, vrrp_info=vrrp_info, ripNewCfgState=ripNewCfgState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoVLAN=arpInfoVLAN, arpStatEntries=arpStatEntries, ospfCumRxTxStats=ospfCumRxTxStats, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumTxPkts=ospfCumTxPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTotalAreas=ospfTotalAreas, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxHello=ospfIntfRxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfinfo=ospfinfo, ospfIntfInfoTable=ospfIntfInfoTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfHello=ospfIntfHello, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgListen=ripCurCfgListen, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSAId=routerLSAId, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, iprouting=iprouting, ripStats=ripStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripConfig=ripConfig, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStats=arpStats, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStats=dnsStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSALinkID=routerLSALinkID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfLoop=ospfIntfLoop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfDown=ospfIntfDown, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfDown=ospfCumIntfDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrDown=ospfIntfNbrDown, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaId=ospfNewCfgAreaId, ripNewCfgListen=ripNewCfgListen, arpStatHighWater=arpStatHighWater, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNbrInExchState=ospfNbrInExchState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgVip=ripCurCfgVip, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfGeneral=ospfGeneral, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrStart=ospfCumNbrStart, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipRouteInfoTag=ipRouteInfoTag, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfStartTime=ospfStartTime, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoType=ipRouteInfoType, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp=vrrp, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipForward=ipForward, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwState=ipCurCfgGwState, ospfProcessUptime=ospfProcessUptime, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCfg=ospfCfg, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ripCurCfgState=ripCurCfgState)
