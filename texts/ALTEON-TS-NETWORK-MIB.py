...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwState=ipNewCfgGwState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStats=arpStats, ripStats=ripStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, iprouting=iprouting, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfArea=ospfArea, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfLoop=ospfIntfLoop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfChangeStats=ospfIntfChangeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfLoop=ospfCumIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfStats=ospfStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxHello=ospfCumRxHello, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfStartTime=ospfStartTime, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfDown=ospfIntfDown, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpOper=vrrpOper, ospfCumRxDatabase=ospfCumRxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwTable=ipNewCfgGwTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripConfig=ripConfig, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripCurCfgVip=ripCurCfgVip, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, dnsStats=dnsStats, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoVLAN=arpInfoVLAN, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSALinkIndex=routerLSALinkIndex, arpInfoEntry=arpInfoEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfinfo=ospfinfo, routerLSALinkID=routerLSALinkID, ipNewCfgGwInterval=ipNewCfgGwInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgSupply=ripNewCfgSupply, ip_info=ip_info, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpGeneral=vrrpGeneral, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoTable=ipRouteInfoTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfUnloop=ospfIntfUnloop, vrrp=vrrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoMacAddr=arpInfoMacAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipForward=ipForward, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxHello=ospfAreaRxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfProcessUptime=ospfProcessUptime, arpStatEntries=arpStatEntries, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfGeneral=ospfGeneral, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkData=routerLSALinkData, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdCurCfgState=ipFwdCurCfgState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSAId=routerLSAId, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfInterface=ospfInterface, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routeStatHighWater=routeStatHighWater, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStats=routeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrN1way=ospfCumNbrN1way, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatInPkts=ripStatInPkts, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry)
