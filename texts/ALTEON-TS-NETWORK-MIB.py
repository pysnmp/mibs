...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfGeneralInfo=ospfGeneralInfo, routeStatHighWater=routeStatHighWater, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfInterface=ospfInterface, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNbrInFullState=ospfNbrInFullState, vrrp_info=vrrp_info, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStatHighWater=arpStatHighWater, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOper=vrrpOper, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrp=vrrp, ospfIntfHello=ospfIntfHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpGeneral=vrrpGeneral, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpStatOutAdvers=vrrpStatOutAdvers, ripCurCfgVip=ripCurCfgVip, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxDatabase=ospfIntfTxDatabase, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipForward=ipForward, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSAId=routerLSAId, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfStats=ospfStats, arpInfoEntry=arpInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgSupply=ripCurCfgSupply, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwArp=ipCurCfgGwArp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxHello=ospfAreaRxHello, arpInfoVLAN=arpInfoVLAN, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwState=ipCurCfgGwState, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, dnsStats=dnsStats, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaInfoId=ospfAreaInfoId, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStatMaxEntries=routeStatMaxEntries, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routeStats=routeStats, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routeStatEntries=routeStatEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpStats=vrrpStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfIndex=ospfIntfIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ospfIntfDown=ospfIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgState=ripNewCfgState, ospfAreaChangeStats=ospfAreaChangeStats, ip_info=ip_info, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ripStatInPkts=ripStatInPkts, arpStatMaxEntries=arpStatMaxEntries, ospfProcessUptime=ospfProcessUptime, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCfg=ospfCfg, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfStartTime=ospfStartTime, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfGeneralStats=ospfGeneralStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpStatEntries=arpStatEntries, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, iprouting=iprouting, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfInfoTable=ospfIntfInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoTable=arpInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripStats=ripStats, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripStatOutPkts=ripStatOutPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfBackup=ospfIntfBackup, ripNewCfgListen=ripNewCfgListen, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrhello=ospfAreaNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpStats=arpStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripConfig=ripConfig, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxHello=ospfCumTxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState)
