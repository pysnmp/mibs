...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrp=vrrp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfBackup=ospfAreaIntfBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipForward=ipForward, ospfCumRxHello=ospfCumRxHello, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfBackup=ospfIntfBackup, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoGateway=ipRouteInfoGateway, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoTag=ipRouteInfoTag, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxHello=ospfAreaTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfDown=ospfIntfDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfArea=ospfArea, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfChangeStats=ospfIntfChangeStats, routeStatEntries=routeStatEntries, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, routeStats=routeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCfg=ospfCfg, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpGeneral=vrrpGeneral, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpStats=vrrpStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgState=ripCurCfgState, ripCurCfgVip=ripCurCfgVip, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSALinkData=routerLSALinkData, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfProcessUptime=ospfProcessUptime, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgIntfMask=ipCurCfgIntfMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgListen=ripCurCfgListen, ripNewCfgDefListen=ripNewCfgDefListen, arpStatHighWater=arpStatHighWater, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxPkts=ospfCumRxPkts, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgBootpState=ipCurCfgBootpState, dnsStats=dnsStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routeStatHighWater=routeStatHighWater, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoVLAN=arpInfoVLAN, ospfCumNbrN1way=ospfCumNbrN1way, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfinfo=ospfinfo, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwState=ipNewCfgGwState, ripStatInPkts=ripStatInPkts, routerLSALinkID=routerLSALinkID, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgSupply=ripCurCfgSupply, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStats=ripStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwDelete=ipNewCfgGwDelete, iprouting=iprouting, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfInterface=ospfInterface, ospfAreaChangeStats=ospfAreaChangeStats, ripConfig=ripConfig, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaInfoId=ospfAreaInfoId, ip_info=ip_info, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpStats=arpStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfGeneralInfo=ospfGeneralInfo, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrp_info=vrrp_info, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfStats=ospfStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgVip=ripNewCfgVip, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAId=routerLSAId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer)
