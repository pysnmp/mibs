...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfHello=ospfIntfHello, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaChangeStats=ospfAreaChangeStats, ospfinfo=ospfinfo, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpStatEntries=arpStatEntries, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, arpStats=arpStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripStats=ripStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ip_info=ip_info, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgVip=ripNewCfgVip, ospfAreaTxPkts=ospfAreaTxPkts, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrp_info=vrrp_info, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfChangeStats=ospfIntfChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrDown=ospfAreaNbrDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpGeneral=vrrpGeneral, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routeStatEntries=routeStatEntries, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpStats=vrrpStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxPkts=ospfCumRxPkts, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenState=vrrpNewCfgGenState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalAreas=ospfTotalAreas, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipGatewayTableMax=ipGatewayTableMax, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenState=vrrpCurCfgGenState, ripStatInPkts=ripStatInPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routeStatHighWater=routeStatHighWater, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, dnsStats=dnsStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, iprouting=iprouting, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, ipRouteInfoInterface=ipRouteInfoInterface, ospfArea=ospfArea)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSALinkData=routerLSALinkData, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumTxDatabase=ospfCumTxDatabase, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipForward=ipForward, routeStats=routeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfDown=ospfIntfDown, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfStats=ospfStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routerLSALinkID=routerLSALinkID, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgState=ripNewCfgState, ospfCumRxTxStats=ospfCumRxTxStats, ipRouteInfoTable=ipRouteInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfProcessUptime=ospfProcessUptime, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgState=ripCurCfgState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrp=vrrp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoTable=arpInfoTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgSupply=ripNewCfgSupply, ospfCumTxPkts=ospfCumTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfHello=ospfCumIntfHello, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSAId=routerLSAId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfGeneralInfo=ospfGeneralInfo, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipRouteInfoGateway=ipRouteInfoGateway, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripConfig=ripConfig, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStatHighWater=arpStatHighWater, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoType=ipRouteInfoType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfBackup=ospfIntfBackup, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv)
