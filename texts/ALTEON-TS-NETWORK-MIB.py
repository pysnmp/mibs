...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfInfoIndex=ospfIfInfoIndex, ip_info=ip_info, ipCurCfgBootpState=ipCurCfgBootpState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpInfoEntry=arpInfoEntry, vrrpStats=vrrpStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoType=ipRouteInfoType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxHello=ospfAreaTxHello, dnsStats=dnsStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgState=ripNewCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStatMaxEntries=routeStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpStatEntries=arpStatEntries, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routerLSALinkData=routerLSALinkData, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpGeneral=vrrpGeneral, ospfTotalTransitAreas=ospfTotalTransitAreas, routeStats=routeStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfArea=ospfArea, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfHostTableMaxSize=ospfHostTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxDatabase=ospfCumTxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrp=vrrp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNbrInInitState=ospfNbrInInitState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, iprouting=iprouting, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfGeneral=ospfGeneral, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfUnloop=ospfIntfUnloop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoMask=ipRouteInfoMask, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfinfo=ospfinfo, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrhello=ospfCumNbrhello, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoVLAN=arpInfoVLAN, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoMacAddr=arpInfoMacAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxPkts=ospfAreaRxPkts, ripConfig=ripConfig, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgSupply=ripNewCfgSupply, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxTxStats=ospfCumRxTxStats, ipForward=ipForward, arpInfoRefPorts=arpInfoRefPorts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfIndex=ospfIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrp_info=vrrp_info, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrStart=ospfIntfNbrStart, ripStats=ripStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSAId=routerLSAId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgState=ripCurCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwState=ipNewCfgGwState, arpInfoFlag=arpInfoFlag, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgVip=ripNewCfgVip, ospfIntfTxPkts=ospfIntfTxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgListen=ripCurCfgListen, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrN1way=ospfCumNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfCfg=ospfCfg, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwInterval=ipCurCfgGwInterval, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfHello=ospfAreaIntfHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgSupply=ripCurCfgSupply, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkIndex=routerLSALinkIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrRstAd=ospfCumNbrRstAd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoTable=arpInfoTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoEntry=ipRouteInfoEntry, ospfStats=ospfStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpStats=arpStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfState=ipNewCfgIntfState)
