...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfStats=ospfStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStatEntries=arpStatEntries, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, dnsStats=dnsStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrp_info=vrrp_info, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfInfoTable=ospfIntfInfoTable, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfArea=ospfArea, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoDestIp=arpInfoDestIp, arpStats=arpStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfInterface=ospfInterface, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipForward=ipForward, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatInPkts=ripStatInPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgState=ripNewCfgState, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaTxPkts=ospfAreaTxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrChange=ospfIntfNbrChange, ospfGeneralInfo=ospfGeneralInfo, routeStats=routeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrN1way=ospfIntfNbrN1way, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSAId=routerLSAId, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfDown=ospfIntfDown, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNbrInInitState=ospfNbrInInitState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoFlag=arpInfoFlag, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripCurCfgVip=ripCurCfgVip, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfGeneralStats=ospfGeneralStats, ospfIntfLoop=ospfIntfLoop, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgVip=ripNewCfgVip, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrhello=ospfCumNbrhello, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoVLAN=arpInfoVLAN, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfinfo=ospfinfo, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfBackup=ospfIntfBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ip_info=ip_info, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgState=ripCurCfgState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxDatabase=ospfIntfTxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrIndex=ospfIntfNbrIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpGeneral=vrrpGeneral, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkID=routerLSALinkID, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgListen=ripNewCfgListen, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpStatHighWater=arpStatHighWater, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoTable=ipRouteInfoTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrp=vrrp, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwTable=ipNewCfgGwTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfIndex=ospfIntfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCfg=ospfCfg, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSALinkIndex=routerLSALinkIndex, routeStatEntries=routeStatEntries, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, iprouting=iprouting, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripConfig=ripConfig, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoRefPorts=arpInfoRefPorts, ospfProcessUptime=ospfProcessUptime, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStats=vrrpStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStatInAdvers=vrrpStatInAdvers, ospfLsTypesSupported=ospfLsTypesSupported, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStats=ripStats, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaInfoIndex=ospfAreaInfoIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfHello=ospfIntfHello, ipNewCfgIntfTable=ipNewCfgIntfTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfStartTime=ospfStartTime, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTxHello=ospfAreaTxHello)
