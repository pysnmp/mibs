...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routeStatEntries=routeStatEntries, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgState=ripNewCfgState, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxHello=ospfCumRxHello, ipNewCfgBootpState=ipNewCfgBootpState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxPkts=ospfCumTxPkts, ospfCfg=ospfCfg, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpStatOutAdvers=vrrpStatOutAdvers, dnsStats=dnsStats, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfinfo=ospfinfo, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrStart=ospfCumNbrStart, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfGeneral=ospfGeneral, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaChangeStats=ospfAreaChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipRouteInfoType=ipRouteInfoType, vrrp=vrrp, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfDown=ospfIntfDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrDown=ospfAreaNbrDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpInfoRefPorts=arpInfoRefPorts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoGateway=ipRouteInfoGateway, arpStatMaxEntries=arpStatMaxEntries, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrp_info=vrrp_info, arpStatEntries=arpStatEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfHello=ospfIntfHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOper=vrrpOper, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwState=ipCurCfgGwState, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfState=ipCurCfgIntfState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfGeneralInfo=ospfGeneralInfo, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripStats=ripStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgListen=ripCurCfgListen, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpStats=vrrpStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSAAreaIndex=routerLSAAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSAId=routerLSAId, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfHello=ospfAreaIntfHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoInterface=ipRouteInfoInterface, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfArea=ospfArea, ipRouteInfoMask=ipRouteInfoMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routeStats=routeStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoEntry=arpInfoEntry, ospfStats=ospfStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwTable=ipNewCfgGwTable, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwState=ipNewCfgGwState, arpInfoDestIp=arpInfoDestIp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, iprouting=iprouting, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripNewCfgVip=ripNewCfgVip, ospfTotalAreas=ospfTotalAreas, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrhello=ospfAreaNbrhello, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStatHighWater=arpStatHighWater, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxHello=ospfCumTxHello, ospfStartTime=ospfStartTime, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrStart=ospfAreaNbrStart, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgVip=ripCurCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrDown=ospfCumNbrDown, vrrpGeneral=vrrpGeneral, arpStats=arpStats, routerLSALinkID=routerLSALinkID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ip_info=ip_info, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipForward=ipForward, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkData=routerLSALinkData, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwInterval=ipNewCfgGwInterval)
