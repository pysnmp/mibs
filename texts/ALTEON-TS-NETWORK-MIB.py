...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSAId=routerLSAId, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpStatEntries=arpStatEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxPkts=ospfIntfRxPkts, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStats=arpStats, arpInfoEntry=arpInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipForward=ipForward, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfStartTime=ospfStartTime, ripNewCfgSupply=ripNewCfgSupply, ripCurCfgListen=ripCurCfgListen, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, routerLSALinkData=routerLSALinkData, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfUnloop=ospfIntfUnloop, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCfg=ospfCfg, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpInfoFlag=arpInfoFlag, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgState=ripNewCfgState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneral=ospfGeneral, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfInterface=ospfInterface, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfinfo=ospfinfo, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStats=vrrpStats, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfDown=ospfIntfDown, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStatHighWater=arpStatHighWater, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfArea=ospfArea, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrp=vrrp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, dnsStats=dnsStats, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwArp=ipCurCfgGwArp, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgState=ripCurCfgState, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoMask=ipRouteInfoMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpOper=vrrpOper, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoTable=arpInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoDestIp=arpInfoDestIp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgDefListen=ripCurCfgDefListen, vrrp_info=vrrp_info, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfHello=ospfIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrDown=ospfCumNbrDown, ospfStats=ospfStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxTxStats=ospfCumRxTxStats, routeStatEntries=routeStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStats=routeStats, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInFullState=ospfNbrInFullState, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, iprouting=iprouting, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast)
