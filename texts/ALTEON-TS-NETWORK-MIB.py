...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStatInPkts=ripStatInPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrDown=ospfCumNbrDown, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ip_info=ip_info, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoEntry=arpInfoEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrhello=ospfCumNbrhello, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, dnsStats=dnsStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfIndex=ospfIntfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipForward=ipForward, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxHello=ospfCumRxHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfGeneralInfo=ospfGeneralInfo, ospfInterface=ospfInterface, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpStatHighWater=arpStatHighWater, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpStats=vrrpStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfLsTypesSupported=ospfLsTypesSupported, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfStats=ospfStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwRetry=ipNewCfgGwRetry, ripCurCfgSupply=ripCurCfgSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routeStats=routeStats, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSALinkID=routerLSALinkID, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgListen=ripNewCfgListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfDown=ospfIntfDown, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSAId=routerLSAId, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfNbrInInitState=ospfNbrInInitState, arpInfoSrcPort=arpInfoSrcPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgState=ripNewCfgState, ospfTotalAreas=ospfTotalAreas, ospfCfg=ospfCfg, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoTable=ipRouteInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfLoop=ospfIntfLoop, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoType=ipRouteInfoType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfGeneral=ospfGeneral, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfChangeStats=ospfIntfChangeStats, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfArea=ospfArea, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatEntries=routeStatEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfUnloop=ospfCumIntfUnloop, ipRouteInfoTag=ipRouteInfoTag, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrp=vrrp, vrrpGeneral=vrrpGeneral, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfinfo=ospfinfo, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripConfig=ripConfig, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrp_info=vrrp_info, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStats=ripStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaTxPkts=ospfAreaTxPkts, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTotalNeighbours=ospfTotalNeighbours, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfHello=ospfAreaIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpStats=arpStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpInfoFlag=arpInfoFlag, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfBackup=ospfCumIntfBackup, ospfStartTime=ospfStartTime, routerLSALinkData=routerLSALinkData, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpOper=vrrpOper, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpIfTableMaxSize=vrrpIfTableMaxSize)
