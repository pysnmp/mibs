...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routeStatEntries=routeStatEntries, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfGeneralStats=ospfGeneralStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxHello=ospfAreaRxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripNewCfgListen=ripNewCfgListen, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgState=ripNewCfgState, ospfIntfHello=ospfIntfHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalAreas=ospfTotalAreas, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripStatInPkts=ripStatInPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwMetric=ipCurCfgGwMetric, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSALinkData=routerLSALinkData, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipForward=ipForward, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNbrInFullState=ospfNbrInFullState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpStats=vrrpStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxHello=ospfIntfRxHello, arpStats=arpStats, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStats=routeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgVip=ripCurCfgVip, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpInfoDestIp=arpInfoDestIp, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNewCfgAreaId=ospfNewCfgAreaId, ripNewCfgSupply=ripNewCfgSupply, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgState=ripCurCfgState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxPkts=ospfCumTxPkts, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfDown=ospfIntfDown, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, routeStatHighWater=routeStatHighWater, ospfinfo=ospfinfo, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrp=vrrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripConfig=ripConfig, ospfCfg=ospfCfg, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfBackup=ospfCumIntfBackup, ospfArea=ospfArea, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, iprouting=iprouting, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxHello=ospfCumRxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfStats=ospfStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSALinkID=routerLSALinkID, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrp_info=vrrp_info, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpGeneral=vrrpGeneral, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpStatEntries=arpStatEntries, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoSrcPort=arpInfoSrcPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoEntry=arpInfoEntry, ospfInterface=ospfInterface, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStats=ripStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfLoop=ospfIntfLoop, ip_info=ip_info, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoType=ipRouteInfoType, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSAId=routerLSAId, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfGeneral=ospfGeneral, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoTable=ipRouteInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoFlag=arpInfoFlag, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxHello=ospfCumTxHello)
