...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpInfoVLAN=arpInfoVLAN, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrp=vrrp, iprouting=iprouting, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSALinkID=routerLSALinkID, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNbrInInitState=ospfNbrInInitState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatOutPkts=ripStatOutPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfInterface=ospfInterface, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfBackup=ospfIntfBackup, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripStatInPkts=ripStatInPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoTable=arpInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ip_info=ip_info, arpStats=arpStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpOper=vrrpOper, ospfIntfHello=ospfIntfHello, ipFwdCurCfgState=ipFwdCurCfgState, ospfProcessUptime=ospfProcessUptime, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoType=ipRouteInfoType, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpStatEntries=arpStatEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripConfig=ripConfig, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipRouteInfoTag=ipRouteInfoTag, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfinfo=ospfinfo, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkData=routerLSALinkData, ospfAreaNbrRstAd=ospfAreaNbrRstAd, dnsStats=dnsStats, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfDown=ospfIntfDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTxHello=ospfAreaTxHello, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripCurCfgVip=ripCurCfgVip, routeStats=routeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfLoop=ospfIntfLoop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfHello=ospfCumIntfHello, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStats=ripStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxHello=ospfIntfRxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoSrcPort=arpInfoSrcPort, ospfTotalAreas=ospfTotalAreas, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfStartTime=ospfStartTime, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSAId=routerLSAId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgState=ripNewCfgState, routeStatEntries=routeStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipForward=ipForward, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumRxTxStats=ospfCumRxTxStats, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaInfoTable=ospfAreaInfoTable, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpStats=vrrpStats, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpInfoEntry=arpInfoEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxPkts=ospfIntfRxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfStats=ospfStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfArea=ospfArea, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routeStatHighWater=routeStatHighWater, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxHello=ospfIntfTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrhello=ospfAreaNbrhello, vrrpGeneral=vrrpGeneral, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfLsTypesSupported=ospfLsTypesSupported, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc)
