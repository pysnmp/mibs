...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipGatewayTableMax=ipGatewayTableMax, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfDown=ospfIntfDown, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStats=routeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routeStatHighWater=routeStatHighWater, vrrpOper=vrrpOper, ipRouteInfoTable=ipRouteInfoTable, arpInfoFlag=arpInfoFlag, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfInterface=ospfInterface, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgSupply=ripCurCfgSupply, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipRouteInfoIndx=ipRouteInfoIndx, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpGeneral=vrrpGeneral, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, dnsStats=dnsStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwState=ipNewCfgGwState, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfArea=ospfArea, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoMacAddr=arpInfoMacAddr, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ip_info=ip_info, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpStatEntries=arpStatEntries, ospfAreaNbrDown=ospfAreaNbrDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfStartTime=ospfStartTime, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgState=ripNewCfgState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoEntry=arpInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCfg=ospfCfg, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp=vrrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfProcessUptime=ospfProcessUptime, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrp_info=vrrp_info, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfCountForRouter=ospfIntfCountForRouter, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfUnloop=ospfCumIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgVip=ripCurCfgVip, routeStatEntries=routeStatEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgState=ripCurCfgState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripStats=ripStats, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatInPkts=ripStatInPkts, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfBackup=ospfIntfBackup, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSAId=routerLSAId, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStats=vrrpStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfInfoTable=ospfIntfInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfRxTxStats=ospfIntfRxTxStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfGeneral=ospfGeneral, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfGeneralStats=ospfGeneralStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfHello=ospfIntfHello, ospfStats=ospfStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxHello=ospfAreaRxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxHello=ospfCumTxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpStatHighWater=arpStatHighWater, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgVip=ripNewCfgVip, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgListen=ripNewCfgListen, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxDatabase=ospfAreaRxDatabase, arpStats=arpStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, iprouting=iprouting, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates)
