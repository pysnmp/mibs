...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumTxHello=ospfCumTxHello, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfHello=ospfIntfHello, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNbrInFullState=ospfNbrInFullState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaChangeStats=ospfAreaChangeStats, ospfInterface=ospfInterface, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgListen=ripNewCfgListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStats=routeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgVip=ripNewCfgVip, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoTable=ipRouteInfoTable, iprouting=iprouting, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripStatInPkts=ripStatInPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpGeneral=vrrpGeneral, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStats=arpStats, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripNewCfgState=ripNewCfgState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoTag=ipRouteInfoTag, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpStats=vrrpStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgDefListen=ripNewCfgDefListen, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumTxDatabase=ospfCumTxDatabase, ospfCfg=ospfCfg, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxHello=ospfIntfRxHello, ospfCumIntfBackup=ospfCumIntfBackup, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfDown=ospfIntfDown, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfLoop=ospfIntfLoop, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripCurCfgState=ripCurCfgState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ip_info=ip_info, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoTable=arpInfoTable, ospfinfo=ospfinfo, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfArea=ospfArea, routerLSALinkID=routerLSALinkID, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaInfoId=ospfAreaInfoId, arpStatEntries=arpStatEntries, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfGeneralStats=ospfGeneralStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoType=ipRouteInfoType, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfBackup=ospfIntfBackup, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatHighWater=arpStatHighWater, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrhello=ospfAreaNbrhello, vrrp_info=vrrp_info, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStatHighWater=routeStatHighWater, ripConfig=ripConfig, routerLSAId=routerLSAId, ospfTotalNeighbours=ospfTotalNeighbours, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfDown=ospfCumIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrp=vrrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripStatOutPkts=ripStatOutPkts, ospfIfInfoIndex=ospfIfInfoIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxTxStats=ospfCumRxTxStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, dnsStats=dnsStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipForward=ipForward, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfGeneralInfo=ospfGeneralInfo, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSALinkData=routerLSALinkData, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpInfoEntry=arpInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoVLAN=arpInfoVLAN, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfStats=ospfStats)
