...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipRouteInfoType=ipRouteInfoType, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoVLAN=arpInfoVLAN, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgState=ripNewCfgState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwArp=ipCurCfgGwArp, iprouting=iprouting, ipCurCfgGwTable=ipCurCfgGwTable, ospfArea=ospfArea, ospfIntfHello=ospfIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoSrcPort=arpInfoSrcPort, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpGeneral=vrrpGeneral, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrStart=ospfIntfNbrStart, ospfCfg=ospfCfg, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpStats=arpStats, ospfAreaIntfDown=ospfAreaIntfDown, routerLSAId=routerLSAId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrp_info=vrrp_info, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfInterface=ospfInterface, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, dnsStats=dnsStats, ospfNbrInInitState=ospfNbrInInitState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSALinkID=routerLSALinkID, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfProcessUptime=ospfProcessUptime, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripStats=ripStats, routeStatHighWater=routeStatHighWater, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripConfig=ripConfig, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgSupply=ripNewCfgSupply, ospfinfo=ospfinfo, ripNewCfgVip=ripNewCfgVip, vrrpStats=vrrpStats, ospfIntfLoop=ospfIntfLoop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSAAreaIndex=routerLSAAreaIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrp=vrrp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfStats=ospfStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoFlag=arpInfoFlag, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNbrInFullState=ospfNbrInFullState, ripCurCfgState=ripCurCfgState, ipForward=ipForward, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfGeneral=ospfGeneral, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatEntries=arpStatEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxHello=ospfCumRxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoEntry=arpInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfBackup=ospfIntfBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfStartTime=ospfStartTime, routeStats=routeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ip_info=ip_info, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfHello=ospfCumIntfHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgListen=ripNewCfgListen, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalAreas=ospfTotalAreas, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoMacAddr=arpInfoMacAddr, ripStatInPkts=ripStatInPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripStatOutPkts=ripStatOutPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatEntries=routeStatEntries, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpOper=vrrpOper, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfDown=ospfIntfDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry)
