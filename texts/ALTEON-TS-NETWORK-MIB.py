...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrp_info=vrrp_info, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStatEntries=arpStatEntries, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpStatOutAdvers=vrrpStatOutAdvers, iprouting=iprouting, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfBackup=ospfCumIntfBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOper=vrrpOper, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipForward=ipForward, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpInfoEntry=arpInfoEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfGeneralInfo=ospfGeneralInfo, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfUnloop=ospfIntfUnloop, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, arpStats=arpStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfStartTime=ospfStartTime, vrrp=vrrp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfGeneral=ospfGeneral, arpInfoFlag=arpInfoFlag, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpStats=vrrpStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfIndex=ospfIntfIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfGeneralStats=ospfGeneralStats, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfinfo=ospfinfo, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoType=ipRouteInfoType, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgState=ipFwdCurCfgState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpGeneral=vrrpGeneral, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, dnsStats=dnsStats, routeStatMaxEntries=routeStatMaxEntries, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxPkts=ospfCumRxPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routeStatHighWater=routeStatHighWater, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, ip_info=ip_info, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrStart=ospfCumNbrStart, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfInterface=ospfInterface, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoTable=ipRouteInfoTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCfg=ospfCfg, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgIntfIndex=ipCurCfgIntfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfArea=ospfArea, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrhello=ospfCumNbrhello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaChangeStats=ospfAreaChangeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxHello=ospfAreaRxHello, ospfIntfInfoTable=ospfIntfInfoTable, ospfStats=ospfStats, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipInterfaceTableMax=ipInterfaceTableMax, ripStats=ripStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfChangeStats=ospfIntfChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgListen=ripCurCfgListen, ripStatInErrorPkts=ripStatInErrorPkts, arpInfoDestIp=arpInfoDestIp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, ospfCumRxHello=ospfCumRxHello, ripNewCfgVip=ripNewCfgVip, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgSupply=ripCurCfgSupply, routerLSAId=routerLSAId, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrChangeStats=ospfCumNbrChangeStats, routeStatEntries=routeStatEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, routeStats=routeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipGatewayTableMax=ipGatewayTableMax, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt)
