...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrhello=ospfCumNbrhello, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoEntry=arpInfoEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOper=vrrpOper, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfInterface=ospfInterface, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCfg=ospfCfg, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAId=routerLSAId, ospfinfo=ospfinfo, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routeStatEntries=routeStatEntries, ospfGeneralStats=ospfGeneralStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStatMaxEntries=routeStatMaxEntries, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpStats=vrrpStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfStats=ospfStats, routeStatHighWater=routeStatHighWater, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalAreas=ospfTotalAreas, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTotalNeighbours=ospfTotalNeighbours, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipForward=ipForward, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStats=ripStats, arpInfoRefPorts=arpInfoRefPorts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwState=ipNewCfgGwState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrp=vrrp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoDestIp=ipRouteInfoDestIp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfArea=ospfArea, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfIndex=ospfIntfIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxPkts=ospfCumTxPkts, ospfCumTxHello=ospfCumTxHello, ospfAreaTxPkts=ospfAreaTxPkts, vrrp_info=vrrp_info, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfProcessUptime=ospfProcessUptime, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfLoop=ospfIntfLoop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxPkts=ospfAreaRxPkts, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoType=ipRouteInfoType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTxPkts=ospfIntfTxPkts, ip_info=ip_info, ospfIntfHello=ospfIntfHello, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfLoop=ospfCumIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfStartTime=ospfStartTime, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfInfoTable=ospfIntfInfoTable, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenState=vrrpCurCfgGenState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoFlag=arpInfoFlag, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoMacAddr=arpInfoMacAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpStatEntries=arpStatEntries, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoEntry=ipRouteInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, dnsStats=dnsStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgVip=ripCurCfgVip, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfDown=ospfIntfDown, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatInPkts=ripStatInPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrRstAd=ospfAreaNbrRstAd, iprouting=iprouting, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwArp=ipCurCfgGwArp, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaInfoTable=ospfAreaInfoTable, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpStats=arpStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay)
