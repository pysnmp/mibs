...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfHello=ospfCumIntfHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOper=vrrpOper, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumTxPkts=ospfCumTxPkts, arpStatHighWater=arpStatHighWater, ip_info=ip_info, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfIndex=ospfIntfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfinfo=ospfinfo, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfBackup=ospfCumIntfBackup, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgState=ripNewCfgState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrp=vrrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfArea=ospfArea, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgVip=ripNewCfgVip, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumRxHello=ospfCumRxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoTable=arpInfoTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwState=ipNewCfgGwState, dnsStats=dnsStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStatOutPkts=ripStatOutPkts, vrrpGeneral=vrrpGeneral, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgState=ripCurCfgState, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfInterface=ospfInterface, ospfCumIntfDown=ospfCumIntfDown, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ripStats=ripStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfDown=ospfIntfDown, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkID=routerLSALinkID, ospfGeneralInfo=ospfGeneralInfo, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgListen=ripCurCfgListen, ripStatInErrorPkts=ripStatInErrorPkts, ospfCfg=ospfCfg, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoEntry=arpInfoEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpStats=vrrpStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSALinkData=routerLSALinkData, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfHello=ospfIntfHello, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatInPkts=ripStatInPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfInfoTable=ospfIntfInfoTable, arpStatMaxEntries=arpStatMaxEntries, ospfGeneral=ospfGeneral, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStats=arpStats, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpStatEntries=arpStatEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, iprouting=iprouting, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrDown=ospfAreaNbrDown, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxlsReqs=ospfCumRxlsReqs, ipForward=ipForward, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfWaitInterval=ospfIfWaitInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoFlag=arpInfoFlag, routerLSAAreaIndex=routerLSAAreaIndex, routeStatEntries=routeStatEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfStats=ospfStats, ospfNbrInExchState=ospfNbrInExchState, ospfIntfUnloop=ospfIntfUnloop, ospfStartTime=ospfStartTime, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkIndex=routerLSALinkIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaInfoTable=ospfAreaInfoTable, routerLSAId=routerLSAId, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrDown=ospfCumNbrDown, vrrp_info=vrrp_info, ospfCumTxDatabase=ospfCumTxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone)
