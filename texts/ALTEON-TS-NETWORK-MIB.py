...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoTable=arpInfoTable, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfGeneral=ospfGeneral, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoDestIp=ipRouteInfoDestIp, arpStatMaxEntries=arpStatMaxEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumTxlsAcks=ospfCumTxlsAcks, arpStats=arpStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfInterface=ospfInterface, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSALinkID=routerLSALinkID, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgState=ripNewCfgState, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgVip=ripCurCfgVip, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfBackup=ospfCumIntfBackup, routerLSAId=routerLSAId, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgSupply=ripCurCfgSupply, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfStartTime=ospfStartTime, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTotalAreas=ospfTotalAreas, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoSrcPort=arpInfoSrcPort, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripConfig=ripConfig, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgListen=ripCurCfgListen, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSALinkIndex=routerLSALinkIndex, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripStats=ripStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoId=ospfAreaInfoId, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxHello=ospfAreaTxHello, routeStatHighWater=routeStatHighWater, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCfg=ospfCfg, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfArea=ospfArea, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, dnsStats=dnsStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrp=vrrp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxHello=ospfCumTxHello, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpOper=vrrpOper, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpStatHighWater=arpStatHighWater, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfBackup=ospfIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, iprouting=iprouting, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ip_info=ip_info, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwTable=ipNewCfgGwTable, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgListen=ripNewCfgListen, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ospfinfo=ospfinfo, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routeStatEntries=routeStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfHello=ospfIntfHello, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfStats=ospfStats, vrrpStats=vrrpStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfState=ipCurCfgIntfState, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfIndex=ospfIntfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routeStats=routeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxPkts=ospfCumTxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfDown=ospfIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoTable=ipRouteInfoTable)
