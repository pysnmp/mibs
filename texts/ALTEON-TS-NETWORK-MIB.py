...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfinfo=ospfinfo, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgBootpState=ipNewCfgBootpState, vrrp_info=vrrp_info, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOper=vrrpOper, ospfIntfDown=ospfIntfDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfUnloop=ospfCumIntfUnloop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIfWaitInterval=ospfIfWaitInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoRefPorts=arpInfoRefPorts, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrDown=ospfCumNbrDown, ospfAreaTxHello=ospfAreaTxHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenState=vrrpNewCfgGenState, ripConfig=ripConfig, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwTable=ipCurCfgGwTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, iprouting=iprouting, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfArea=ospfArea, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumRxHello=ospfCumRxHello, routerLSAId=routerLSAId, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpStatOutAdvers=vrrpStatOutAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpInfoMacAddr=arpInfoMacAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCfg=ospfCfg, ripNewCfgState=ripNewCfgState, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSALinkID=routerLSALinkID, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfBackup=ospfCumIntfBackup, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStatEntries=arpStatEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkData=routerLSALinkData, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaInfoId=ospfAreaInfoId, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumNbrN1way=ospfCumNbrN1way)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrp=vrrp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoInterface=ipRouteInfoInterface, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripStatOutPkts=ripStatOutPkts, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, dnsStats=dnsStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStatHighWater=arpStatHighWater, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfIndex=ospfIntfIndex, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoSrcPort=arpInfoSrcPort, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfGeneralStats=ospfGeneralStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfGeneral=ospfGeneral, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgState=ripCurCfgState, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ip_info=ip_info, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoEntry=arpInfoEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxPkts=ospfIntfRxPkts, routeStats=routeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoType=ipRouteInfoType, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoTable=arpInfoTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrhello=ospfCumNbrhello, ospfStats=ospfStats, ospfProcessUptime=ospfProcessUptime, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripStatInPkts=ripStatInPkts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfDown=ospfCumIntfDown, ipForward=ipForward, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalAreas=ospfTotalAreas, ripNewCfgVip=ripNewCfgVip, arpStats=arpStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState)
