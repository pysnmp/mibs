...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrp=vrrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxPkts=ospfCumRxPkts, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStats=routeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfArea=ospfArea, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ip_info=ip_info, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpStats=vrrpStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfInfoTable=ospfIntfInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgListen=ripCurCfgListen, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpStats=arpStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripConfig=ripConfig, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfState=ipNewCfgIntfState, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgState=ripNewCfgState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrp_info=vrrp_info, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, dnsStats=dnsStats, ospfIfWaitInterval=ospfIfWaitInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfBackup=ospfIntfBackup, ipForward=ipForward, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpInfoTable=arpInfoTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgState=ripCurCfgState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfStats=ospfStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgVip=ripCurCfgVip, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrhello=ospfIntfNbrhello, arpStatHighWater=arpStatHighWater, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoTag=ipRouteInfoTag, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpGeneral=vrrpGeneral, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNbrInFullState=ospfNbrInFullState, vrrpOper=vrrpOper, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStats=ripStats, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNbrInInitState=ospfNbrInInitState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routeStatEntries=routeStatEntries, ospfIntfRxHello=ospfIntfRxHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfDown=ospfIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCfg=ospfCfg, ospfStartTime=ospfStartTime, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalAreas=ospfTotalAreas, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfHello=ospfIntfHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrhello=ospfAreaNbrhello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStatEntries=arpStatEntries, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routeStatMaxEntries=routeStatMaxEntries, routerLSALinkID=routerLSALinkID, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStatHighWater=routeStatHighWater, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStatInPkts=ripStatInPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoFlag=arpInfoFlag, routerLSALinkData=routerLSALinkData, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNbrInExchState=ospfNbrInExchState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSAId=routerLSAId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumTxHello=ospfCumTxHello, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfBackup=ospfCumIntfBackup, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex)
