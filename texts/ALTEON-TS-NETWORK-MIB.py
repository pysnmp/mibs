...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgVip=ripNewCfgVip, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfProcessUptime=ospfProcessUptime, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwEntry=ipCurCfgGwEntry, ipForward=ipForward, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxPkts=ospfCumRxPkts, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxHello=ospfCumTxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrN1way=ospfCumNbrN1way, ospfInterface=ospfInterface, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ipRouteInfoMask=ipRouteInfoMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfUnloop=ospfCumIntfUnloop, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNbrInFullState=ospfNbrInFullState, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfLoop=ospfIntfLoop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaInfoId=ospfAreaInfoId, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxlsAcks=ospfCumTxlsAcks, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ip_info=ip_info, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, iprouting=iprouting, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpStats=vrrpStats, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpStatEntries=arpStatEntries, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfIndex=ospfIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTotalAreas=ospfTotalAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfDown=ospfIntfDown, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxHello=ospfCumRxHello, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkID=routerLSALinkID, vrrp=vrrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStats=arpStats, ospfCumNbrhello=ospfCumNbrhello, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStatInPkts=ripStatInPkts, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routeStats=routeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripStats=ripStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, routeStatHighWater=routeStatHighWater, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ripNewCfgListen=ripNewCfgListen, arpInfoDestIp=arpInfoDestIp, arpStatHighWater=arpStatHighWater, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ospfStats=ospfStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfHello=ospfCumIntfHello, ospfArea=ospfArea, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaIntfUnloop=ospfAreaIntfUnloop)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfBackup=ospfIntfBackup, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxlsAcks=ospfIntfRxlsAcks, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSAId=routerLSAId, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfInfoIndex=ospfIfInfoIndex, ripConfig=ripConfig, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpGeneral=vrrpGeneral, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrp_info=vrrp_info, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrChangeStats=ospfCumNbrChangeStats, dnsStats=dnsStats, ripNewCfgState=ripNewCfgState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfGeneralStats=ospfGeneralStats, routeStatEntries=routeStatEntries, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, routeStatMaxEntries=routeStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTotalNeighbours=ospfTotalNeighbours, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOper=vrrpOper, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrhello=ospfAreaNbrhello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoFlag=arpInfoFlag, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripCurCfgState=ripCurCfgState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoTable=ipRouteInfoTable, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgListen=ripCurCfgListen, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello)
