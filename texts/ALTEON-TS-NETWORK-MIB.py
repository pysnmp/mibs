...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCfg=ospfCfg, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxHello=ospfAreaRxHello, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripStatInPkts=ripStatInPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripStats=ripStats, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStats=routeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoInterface=ipRouteInfoInterface, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgState=ripCurCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfArea=ospfArea, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routeStatHighWater=routeStatHighWater, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrp_info=vrrp_info, ip_info=ip_info, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfGeneralInfo=ospfGeneralInfo, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripCurCfgDefListen=ripCurCfgDefListen, arpStatEntries=arpStatEntries, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfInterface=ospfInterface, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrChangeStats=ospfCumNbrChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNbrInExchState=ospfNbrInExchState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxPkts=ospfIntfRxPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfLoop=ospfIntfLoop, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfBackup=ospfIntfBackup, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfGeneralStats=ospfGeneralStats, arpInfoEntry=arpInfoEntry, ospfinfo=ospfinfo, ipForward=ipForward, ripNewCfgState=ripNewCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoRefPorts=arpInfoRefPorts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwTable=ipCurCfgGwTable, routerLSALinkData=routerLSALinkData, vrrpStats=vrrpStats, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenState=vrrpCurCfgGenState, ripNewCfgVip=ripNewCfgVip, arpStatHighWater=arpStatHighWater, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoDestIp=arpInfoDestIp, routerLSALinkID=routerLSALinkID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, dnsStats=dnsStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxlsAcks=ospfCumTxlsAcks, ripConfig=ripConfig, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpGeneral=vrrpGeneral, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfIndex=ospfIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfStats=ospfStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxHello=ospfCumTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrDown=ospfCumNbrDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfDown=ospfIntfDown, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgListen=ripCurCfgListen, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOper=vrrpOper, iprouting=iprouting, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfProcessUptime=ospfProcessUptime, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoType=ipRouteInfoType, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfGeneral=ospfGeneral, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStats=arpStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTxHello=ospfAreaTxHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoEntry=ipRouteInfoEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, routeStatEntries=routeStatEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ipGatewayTableMax=ipGatewayTableMax, vrrp=vrrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSAId=routerLSAId)
