...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, iprouting=iprouting, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrhello=ospfCumNbrhello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTotalNssaAreas=ospfTotalNssaAreas, arpStats=arpStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumTxPkts=ospfCumTxPkts, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsAcks=ospfCumRxlsAcks, dnsStats=dnsStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSALinkIndex=routerLSALinkIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripStats=ripStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfStats=ospfStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfInterface=ospfInterface, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatHighWater=arpStatHighWater, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSALinkID=routerLSALinkID, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOper=vrrpOper, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxDatabase=ospfCumTxDatabase, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfHello=ospfIntfHello, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoTable=arpInfoTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, arpStatEntries=arpStatEntries, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripStatOutPkts=ripStatOutPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxPkts=ospfCumRxPkts, ripConfig=ripConfig, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrp=vrrp, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routerLSAId=routerLSAId, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrDown=ospfCumNbrDown, vrrpStats=vrrpStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ip_info=ip_info, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfProcessUptime=ospfProcessUptime, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoVLAN=arpInfoVLAN, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxHello=ospfCumRxHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfDown=ospfCumIntfDown, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfCfg=ospfCfg, ospfIntfDown=ospfIntfDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoEntry=arpInfoEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripNewCfgListen=ripNewCfgListen, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalAreas=ospfTotalAreas, ospfIntfIndex=ospfIntfIndex, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfArea=ospfArea, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaInfoId=ospfAreaInfoId, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxPkts=ospfIntfTxPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrhello=ospfIntfNbrhello, ospfStartTime=ospfStartTime, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routeStatEntries=routeStatEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipForward=ipForward, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStatInPkts=ripStatInPkts, arpInfoFlag=arpInfoFlag, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoMacAddr=arpInfoMacAddr, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routeStats=routeStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgBootpState=ipNewCfgBootpState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTxlsReqs=ospfIntfTxlsReqs)
