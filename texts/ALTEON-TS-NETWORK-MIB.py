...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfHello=ospfIntfHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpGeneral=vrrpGeneral, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSAId=routerLSAId, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenState=vrrpCurCfgGenState, arpStats=arpStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgIntfState=ipCurCfgIntfState, vrrp_info=vrrp_info, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipForward=ipForward, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrp=vrrp, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfGeneral=ospfGeneral, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripConfig=ripConfig, ospfCumNbrStart=ospfCumNbrStart, iprouting=iprouting, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfLoop=ospfIntfLoop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSALinkData=routerLSALinkData, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpInfoVLAN=arpInfoVLAN, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpOper=vrrpOper, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfArea=ospfArea, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwState=ipNewCfgGwState, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwRetry=ipCurCfgGwRetry, arpStatEntries=arpStatEntries, ripStats=ripStats, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoTable=arpInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoEntry=ipRouteInfoEntry, dnsStats=dnsStats, ripStatInPkts=ripStatInPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfIndex=ospfIntfIndex, ospfIntfTxHello=ospfIntfTxHello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpStatHighWater=arpStatHighWater, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoEntry=arpInfoEntry, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgVip=ripCurCfgVip, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgSupply=ripCurCfgSupply, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ip_info=ip_info, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routeStatEntries=routeStatEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfInterface=ospfInterface, ospfStats=ospfStats, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgVip=ripNewCfgVip, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfDown=ospfIntfDown, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgSupply=ripNewCfgSupply, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripStatOutPkts=ripStatOutPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStats=vrrpStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfProcessUptime=ospfProcessUptime, ripCurCfgListen=ripCurCfgListen, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripNewCfgState=ripNewCfgState, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxDatabase=ospfIntfRxDatabase, routeStats=routeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoFlag=arpInfoFlag, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrStart=ospfIntfNbrStart, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStats=ospfAreaRxTxStats)
