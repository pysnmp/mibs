...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, iso, TimeTicks, Gauge32, ObjectIdentity, Integer32, NotificationType, Counter64, Unsigned32, Bits, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "iso", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "Unsigned32", "Bits", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoRefPorts=arpInfoRefPorts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgState=ripNewCfgState, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwTable=ipNewCfgGwTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfGeneral=ospfGeneral, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfState=ipNewCfgIntfState, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrChange=ospfIntfNbrChange, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrp=vrrp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfStats=ospfStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ip_info=ip_info, ospfAreaTxHello=ospfAreaTxHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpStatHighWater=arpStatHighWater, ipInterfaceTableMax=ipInterfaceTableMax, arpStatEntries=arpStatEntries, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoTable=arpInfoTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfIndex=ospfIntfIndex, routerLSAId=routerLSAId, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpStats=vrrpStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrhello=ospfIntfNbrhello, routerLSALinkIndex=routerLSALinkIndex, arpInfoEntry=arpInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipRouteInfoTag=ipRouteInfoTag, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routeStatEntries=routeStatEntries, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfArea=ospfArea, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStats=ripStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrp_info=vrrp_info, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrN1way=ospfCumNbrN1way, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, dnsStats=dnsStats, routeStats=routeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCfg=ospfCfg, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpStats=arpStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrStart=ospfIntfNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxHello=ospfAreaRxHello, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwVlan=ipNewCfgGwVlan, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfProcessUptime=ospfProcessUptime, ipRouteInfoMask=ipRouteInfoMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfLsTypesSupported=ospfLsTypesSupported, routerLSALinkID=routerLSALinkID, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxHello=ospfCumTxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoIndx=ipRouteInfoIndx, routeStatHighWater=routeStatHighWater, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfinfo=ospfinfo, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrStart=ospfAreaNbrStart, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfTxlsReqs=ospfIntfTxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpOper=vrrpOper, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxHello=ospfCumRxHello, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipForward=ipForward, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, iprouting=iprouting, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut)
