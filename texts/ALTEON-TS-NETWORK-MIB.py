...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrp=vrrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTotalAreas=ospfTotalAreas, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpGeneral=vrrpGeneral, vrrpStats=vrrpStats, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfGeneralInfo=ospfGeneralInfo, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSALinkIndex=routerLSALinkIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfArea=ospfArea, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNbrInInitState=ospfNbrInInitState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgState=ripCurCfgState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routeStats=routeStats, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routeStatEntries=routeStatEntries, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfHello=ospfIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfInterface=ospfInterface, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrStart=ospfCumNbrStart, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfStartTime=ospfStartTime, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStats=ripStats, arpInfoFlag=arpInfoFlag, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSAId=routerLSAId, ospfCumRxHello=ospfCumRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoTable=arpInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfBackup=ospfIntfBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ripNewCfgListen=ripNewCfgListen, dnsStats=dnsStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ip_info=ip_info, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkID=routerLSALinkID, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoEntry=arpInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSALinkData=routerLSALinkData, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, iprouting=iprouting, arpStatEntries=arpStatEntries, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfGeneralStats=ospfGeneralStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoMacAddr=arpInfoMacAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgState=ripNewCfgState, ripStatOutPkts=ripStatOutPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routeStatHighWater=routeStatHighWater, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoMask=ipRouteInfoMask, ipForward=ipForward, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgVip=ripNewCfgVip, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsAcks=ospfCumRxlsAcks, arpStats=arpStats, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpOper=vrrpOper, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoIndx=ipRouteInfoIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfGeneral=ospfGeneral, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgVip=ripCurCfgVip, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripConfig=ripConfig, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCfg=ospfCfg, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxHello=ospfCumTxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgListen=ripCurCfgListen, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoGateway=ipRouteInfoGateway, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfIndex=ospfIntfIndex, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrhello=ospfCumNbrhello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgState=ipFwdNewCfgState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgSupply=ripCurCfgSupply, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfDown=ospfIntfDown, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby)
