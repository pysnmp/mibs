...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwMetric=ipCurCfgGwMetric, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgDefListen=ripCurCfgDefListen, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoInterface=ipRouteInfoInterface, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrp=vrrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpStatHighWater=arpStatHighWater, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfinfo=ospfinfo, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneralInfo=ospfGeneralInfo, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwState=ipCurCfgGwState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxPkts=ospfCumTxPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripStats=ripStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSAId=routerLSAId, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, dnsStats=dnsStats, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfDown=ospfIntfDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpStats=vrrpStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgSupply=ripNewCfgSupply, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfBackup=ospfIntfBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfDown=ospfCumIntfDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ip_info=ip_info, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfStats=ospfStats, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwTable=ipNewCfgGwTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrp_info=vrrp_info, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumIntfHello=ospfCumIntfHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routeStats=routeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgState=ipFwdNewCfgState, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfHello=ospfIntfHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpGeneral=vrrpGeneral, ospfAreaInfoTable=ospfAreaInfoTable, ripStatInPkts=ripStatInPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripCurCfgVip=ripCurCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfLoop=ospfIntfLoop, ipForward=ipForward, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoTable=arpInfoTable, ripNewCfgState=ripNewCfgState, routerLSALinkID=routerLSALinkID, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSALinkData=routerLSALinkData, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfArea=ospfArea, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routeStatHighWater=routeStatHighWater, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgState=ripCurCfgState, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, iprouting=iprouting, ospfAreaIntfHello=ospfAreaIntfHello, ospfCfg=ospfCfg, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgListen=ripNewCfgListen, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoEntry=arpInfoEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfLsTypesSupported=ospfLsTypesSupported, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxHello=ospfIntfRxHello, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoVLAN=arpInfoVLAN, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgBootpState=ipNewCfgBootpState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalAreas=ospfTotalAreas, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpStats=arpStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState)
