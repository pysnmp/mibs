...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routerLSALinkID=routerLSALinkID, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInInitState=ospfNbrInInitState, ospfProcessUptime=ospfProcessUptime, ospfIntfRxHello=ospfIntfRxHello, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ip_info=ip_info, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, dnsStats=dnsStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoVLAN=arpInfoVLAN, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfinfo=ospfinfo, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoDestIp=arpInfoDestIp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfDown=ospfIntfDown, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgState=ripNewCfgState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripCurCfgDefListen=ripCurCfgDefListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ripCurCfgListen=ripCurCfgListen, ripConfig=ripConfig, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgVip=ripCurCfgVip, ipForward=ipForward, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfHello=ospfIntfHello, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoFlag=arpInfoFlag, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routeStatEntries=routeStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOper=vrrpOper, ospfIfInfoIndex=ospfIfInfoIndex, ospfCfg=ospfCfg, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStatInPkts=ripStatInPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxPkts=ospfCumTxPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxHello=ospfAreaRxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routeStats=routeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoType=ipRouteInfoType, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgSupply=ripNewCfgSupply, ospfTotalAreas=ospfTotalAreas, ospfNbrInFullState=ospfNbrInFullState, ospfCumTxlsReqs=ospfCumTxlsReqs, iprouting=iprouting, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneral=ospfGeneral, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdCurCfgState=ipFwdCurCfgState, ripStats=ripStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStats=arpStats, vrrpStats=vrrpStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatHighWater=routeStatHighWater, routerLSALinkIndex=routerLSALinkIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpGeneral=vrrpGeneral, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfStartTime=ospfStartTime, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoEntry=arpInfoEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgState=ripCurCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxHello=ospfCumRxHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrDown=ospfAreaNbrDown, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfGeneralStats=ospfGeneralStats, ospfIntfIndex=ospfIntfIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfInterface=ospfInterface, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaInfoId=ospfAreaInfoId, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrStart=ospfAreaNbrStart, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfStats=ospfStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrp_info=vrrp_info, ospfIntfNbrChange=ospfIntfNbrChange, vrrp=vrrp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStatOutPkts=ripStatOutPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp)
