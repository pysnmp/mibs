...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgListen=ripCurCfgListen, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfStats=ospfStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfIndex=ospfIntfIndex, vrrp_info=vrrp_info, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrDown=ospfIntfNbrDown, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSAAreaIndex=routerLSAAreaIndex, routeStats=routeStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfStartTime=ospfStartTime, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumRxTxStats=ospfCumRxTxStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStatEntries=arpStatEntries, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgVip=ripCurCfgVip, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpGeneral=vrrpGeneral, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCfg=ospfCfg, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfInterface=ospfInterface, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, iprouting=iprouting, routerLSALinkID=routerLSALinkID, ripStatInErrorPkts=ripStatInErrorPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSAId=routerLSAId, ospfIntfBackup=ospfIntfBackup, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgState=ripCurCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgSupply=ripNewCfgSupply, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoId=ospfAreaInfoId, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfGeneral=ospfGeneral, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwState=ipNewCfgGwState, vrrp=vrrp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumTxPkts=ospfCumTxPkts, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfUnloop=ospfIntfUnloop, ripConfig=ripConfig, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, dnsStats=dnsStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOper=vrrpOper, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoGateway=ipRouteInfoGateway, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTotalNeighbours=ospfTotalNeighbours, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoDestIp=arpInfoDestIp, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwInterval=ipCurCfgGwInterval, ip_info=ip_info, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfHello=ospfCumIntfHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoTable=arpInfoTable, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoTag=ipRouteInfoTag, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgListen=ripNewCfgListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxHello=ospfCumTxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatEntries=routeStatEntries, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgState=ripNewCfgState, arpInfoSrcPort=arpInfoSrcPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripStats=ripStats, ospfinfo=ospfinfo, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumTxlsReqs=ospfCumTxlsReqs, routeStatHighWater=routeStatHighWater, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipForward=ipForward, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfLoop=ospfCumIntfLoop, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpInfoFlag=arpInfoFlag, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpStats=vrrpStats, ospfArea=ospfArea, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpStatHighWater=arpStatHighWater, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests)
