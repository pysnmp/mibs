...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfinfo=ospfinfo, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrhello=ospfCumNbrhello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfGeneral=ospfGeneral, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSALinkID=routerLSALinkID, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripConfig=ripConfig, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfState=ipCurCfgIntfState, routeStatEntries=routeStatEntries, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxTxStats=ospfCumRxTxStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripStatOutPkts=ripStatOutPkts, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNbrInInitState=ospfNbrInInitState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ip_info=ip_info, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, iprouting=iprouting, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSALinkIndex=routerLSALinkIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfStartTime=ospfStartTime, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrp=vrrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOper=vrrpOper, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripStats=ripStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpGeneral=vrrpGeneral, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfCfg=ospfCfg, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoTable=ipRouteInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfHello=ospfAreaIntfHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfInterface=ospfInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoMask=ipRouteInfoMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, ipForward=ipForward, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfDown=ospfIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfProcessUptime=ospfProcessUptime, routeStats=routeStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpInfoFlag=arpInfoFlag, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgVip=ripNewCfgVip, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrp_info=vrrp_info, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfState=ipNewCfgIntfState, ospfGeneralStats=ospfGeneralStats, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStats=arpStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfArea=ospfArea, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfLoop=ospfIntfLoop, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgState=ripNewCfgState, ospfIntfHello=ospfIntfHello, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStats=vrrpStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfStats=ospfStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgListen=ripNewCfgListen, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, dnsStats=dnsStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTxHello=ospfAreaTxHello, ospfNbrInExchState=ospfNbrInExchState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoVLAN=arpInfoVLAN, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpStatHighWater=arpStatHighWater, ospfAreaChangeStats=ospfAreaChangeStats, routerLSAId=routerLSAId, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoTag=ipRouteInfoTag)
