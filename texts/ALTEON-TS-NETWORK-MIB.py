...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routeStatMaxEntries=routeStatMaxEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStatOutPkts=ripStatOutPkts, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipForward=ipForward, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCfg=ospfCfg, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxPkts=ospfCumTxPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripConfig=ripConfig, arpInfoRefPorts=arpInfoRefPorts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgVip=ripCurCfgVip, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoType=ipRouteInfoType, ospfNbrInExchState=ospfNbrInExchState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoTag=ipRouteInfoTag, vrrp_info=vrrp_info, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, iprouting=iprouting, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfHello=ospfCumIntfHello, ospfArea=ospfArea, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfinfo=ospfinfo, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoEntry=arpInfoEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkIndex=routerLSALinkIndex, arpInfoFlag=arpInfoFlag, arpStatHighWater=arpStatHighWater, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfUnloop=ospfIntfUnloop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgListen=ripNewCfgListen, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routeStatEntries=routeStatEntries, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpStatMaxEntries=arpStatMaxEntries, ospfStats=ospfStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfInterface=ospfInterface, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxlsReqs=ospfCumTxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumTxHello=ospfCumTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, vrrpStats=vrrpStats, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrp=vrrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTotalNssaAreas=ospfTotalNssaAreas)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgState=ripNewCfgState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfLoop=ospfIntfLoop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgState=ripCurCfgState, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfDown=ospfIntfDown, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwTable=ipCurCfgGwTable, ospfTotalAreas=ospfTotalAreas, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStats=dnsStats, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxPkts=ospfCumRxPkts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfStartTime=ospfStartTime, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpGeneral=vrrpGeneral, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfGeneralInfo=ospfGeneralInfo, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgBootpState=ipNewCfgBootpState, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatInPkts=ripStatInPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpInfoSrcPort=arpInfoSrcPort, ripStats=ripStats, arpStats=arpStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfUnloop=ospfCumIntfUnloop, routeStats=routeStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfHello=ospfIntfHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ip_info=ip_info, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval)
