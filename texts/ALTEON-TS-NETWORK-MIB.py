...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgState=ripNewCfgState, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoEntry=arpInfoEntry, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrp_info=vrrp_info, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoId=ospfAreaInfoId, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxHello=ospfIntfTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrDown=ospfAreaNbrDown, ospfStartTime=ospfStartTime, arpInfoTable=arpInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrp=vrrp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoDestIp=arpInfoDestIp, routerLSALinkData=routerLSALinkData, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwTable=ipCurCfgGwTable, iprouting=iprouting, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpOper=vrrpOper, ip_info=ip_info, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgState=ripCurCfgState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTxPkts=ospfIntfTxPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfArea=ospfArea, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfBackup=ospfIntfBackup, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSALinkID=routerLSALinkID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpGeneral=vrrpGeneral, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoRefPorts=arpInfoRefPorts, ripConfig=ripConfig, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaInfoEntry=ospfAreaInfoEntry, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgGwArp=ipCurCfgGwArp, ripStats=ripStats, ospfGeneral=ospfGeneral, ospfinfo=ospfinfo, ospfStats=ospfStats, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfProcessUptime=ospfProcessUptime, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfInterface=ospfInterface, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripNewCfgListen=ripNewCfgListen, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfUnloop=ospfIntfUnloop, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpStatEntries=arpStatEntries, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSAAreaIndex=routerLSAAreaIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgListen=ripCurCfgListen, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxHello=ospfAreaRxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripStatInPkts=ripStatInPkts, ospfIntfIndex=ospfIntfIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTotalNeighbours=ospfTotalNeighbours, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, dnsStats=dnsStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStats=vrrpStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxHello=ospfIntfRxHello, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoFlag=arpInfoFlag, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipForward=ipForward, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwState=ipNewCfgGwState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStats=routeStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgVip=ripNewCfgVip, ipRouteInfoType=ipRouteInfoType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgSupply=ripNewCfgSupply, ospfIntfDown=ospfIntfDown, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, routeStatHighWater=routeStatHighWater, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaRxPkts=ospfAreaRxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routerLSAId=routerLSAId, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr)
