...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxPkts=ospfIntfRxPkts, ospfinfo=ospfinfo, iprouting=iprouting, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ip_info=ip_info, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumTxPkts=ospfCumTxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfHello=ospfCumIntfHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoType=ipRouteInfoType, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoIndx=ipRouteInfoIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxHello=ospfCumRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrp=vrrp, ospfInterface=ospfInterface, arpInfoRefPorts=arpInfoRefPorts, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCfg=ospfCfg, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpGeneral=vrrpGeneral, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoFlag=arpInfoFlag, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNbrInInitState=ospfNbrInInitState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfGeneral=ospfGeneral, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTotalAreas=ospfTotalAreas, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStatInPkts=ripStatInPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStats=ripStats, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripNewCfgVip=ripNewCfgVip, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgVip=ripCurCfgVip, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoTable=arpInfoTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routerLSAId=routerLSAId, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumTxHello=ospfCumTxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoEntry=arpInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpStatEntries=arpStatEntries, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgState=ripCurCfgState, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routeStatEntries=routeStatEntries, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfStats=ospfStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfHello=ospfIntfHello, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, dnsStats=dnsStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfStartTime=ospfStartTime, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfBackup=ospfIntfBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNbrInExchState=ospfNbrInExchState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoVLAN=arpInfoVLAN, ripConfig=ripConfig, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfArea=ospfArea, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaIntfIndex=ospfAreaIntfIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routeStatMaxEntries=routeStatMaxEntries, ospfIntfIndex=ospfIntfIndex, arpStats=arpStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOper=vrrpOper, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipForward=ipForward, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrp_info=vrrp_info, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfHostTableMaxSize=ospfHostTableMaxSize)
