...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfLoop=ospfIntfLoop, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwMetric=ipNewCfgGwMetric, ripStats=ripStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOper=vrrpOper, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwState=ipCurCfgGwState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxHello=ospfCumTxHello, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaInfoId=ospfAreaInfoId, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoInterface=ipRouteInfoInterface, iprouting=iprouting, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoTable=ipRouteInfoTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfStartTime=ospfStartTime, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfNbrInInitState=ospfNbrInInitState, arpStats=arpStats, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoFlag=arpInfoFlag, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfDown=ospfCumIntfDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpGeneral=vrrpGeneral, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgDefListen=ripNewCfgDefListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfStats=ospfStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgState=ripNewCfgState, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgListen=ripCurCfgListen, vrrpStatOutAdvers=vrrpStatOutAdvers, ip_info=ip_info, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSALinkData=routerLSALinkData, arpStatHighWater=arpStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTotalAreas=ospfTotalAreas, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenState=vrrpCurCfgGenState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSALinkID=routerLSALinkID, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTxHello=ospfIntfTxHello, ripStatInPkts=ripStatInPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgState=ripCurCfgState, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfHello=ospfIntfHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routeStatHighWater=routeStatHighWater, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCfg=ospfCfg, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoVLAN=arpInfoVLAN, vrrpStats=vrrpStats, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenState=vrrpNewCfgGenState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfBackup=ospfCumIntfBackup, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipForward=ipForward, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfIndex=ospfAreaIntfIndex, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpInfoTable=arpInfoTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrp=vrrp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrDown=ospfAreaNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfTable=ipNewCfgIntfTable, routeStats=routeStats, vrrp_info=vrrp_info, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoMask=ipRouteInfoMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfDown=ospfIntfDown, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, dnsStats=dnsStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routeStatEntries=routeStatEntries, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfArea=ospfArea, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoEntry=arpInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumRxlsUpdates=ospfCumRxlsUpdates)
