...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfinfo=ospfinfo, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, routerLSALinkData=routerLSALinkData, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNbrInFullState=ospfNbrInFullState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfInfoIndex=ospfIfInfoIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSALinkID=routerLSALinkID, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfDown=ospfIntfDown, ospfAreaTxPkts=ospfAreaTxPkts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, dnsStats=dnsStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routeStats=routeStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxTxStats=ospfAreaRxTxStats, ipInterfaceTableMax=ipInterfaceTableMax, ripStats=ripStats, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfGeneralStats=ospfGeneralStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpGeneral=vrrpGeneral, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgState=ipFwdNewCfgState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoType=ipRouteInfoType, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrp=vrrp, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfInterface=ospfInterface, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfGeneral=ospfGeneral, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routeStatMaxEntries=routeStatMaxEntries, arpStatEntries=arpStatEntries, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumTxHello=ospfCumTxHello)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpInfoEntry=arpInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ripStatInPkts=ripStatInPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfArea=ospfArea, arpStats=arpStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCfg=ospfCfg, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoTable=arpInfoTable, ospfNbrInExchState=ospfNbrInExchState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ip_info=ip_info, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, routerLSAId=routerLSAId, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripConfig=ripConfig, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, iprouting=iprouting, arpInfoFlag=arpInfoFlag, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpOper=vrrpOper, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoDestIp=arpInfoDestIp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrp_info=vrrp_info, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrN1way=ospfCumNbrN1way, ripStatOutPkts=ripStatOutPkts, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxDatabase=ospfAreaTxDatabase, routeStatEntries=routeStatEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipForward=ipForward, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfStartTime=ospfStartTime, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwVlan=ipCurCfgGwVlan, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfStats=ospfStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable)
