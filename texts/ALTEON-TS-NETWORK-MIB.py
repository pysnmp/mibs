...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoFlag=arpInfoFlag, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routeStatHighWater=routeStatHighWater, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfHello=ospfIntfHello, ospfInterface=ospfInterface, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfIndex=ospfIntfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrp_info=vrrp_info, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStats=arpStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfStats=ospfStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgState=ripCurCfgState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfinfo=ospfinfo, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgVip=ripNewCfgVip, ripStatInPkts=ripStatInPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoTable=ipRouteInfoTable, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpInfoEntry=arpInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNbrInInitState=ospfNbrInInitState, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgDefListen=ripNewCfgDefListen, ripConfig=ripConfig, arpStatEntries=arpStatEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgListen=ripNewCfgListen, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoSrcPort=arpInfoSrcPort, ripCurCfgListen=ripCurCfgListen, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, arpInfoRefPorts=arpInfoRefPorts, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfProcessUptime=ospfProcessUptime, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoMask=ipRouteInfoMask, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpStatMaxEntries=arpStatMaxEntries, routerLSAId=routerLSAId, routeStats=routeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrDown=ospfCumNbrDown, vrrpStats=vrrpStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfInfoTable=ospfIntfInfoTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrChange=ospfIntfNbrChange, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxHello=ospfCumRxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfGeneral=ospfGeneral, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoVLAN=arpInfoVLAN, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatEntries=routeStatEntries, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfGeneralStats=ospfGeneralStats, arpInfoTable=arpInfoTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgSupply=ripCurCfgSupply, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipForward=ipForward, routerLSALinkID=routerLSALinkID, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfState=ipCurCfgIntfState, iprouting=iprouting, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpStatHighWater=arpStatHighWater, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxHello=ospfCumTxHello, ripStats=ripStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ip_info=ip_info, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrp=vrrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInFullState=ospfNbrInFullState, routerLSALinkIndex=routerLSALinkIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCfg=ospfCfg, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfStartTime=ospfStartTime, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc)
