...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrp_info=vrrp_info, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxPkts=ospfCumRxPkts, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgGwArp=ipCurCfgGwArp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoTable=ipRouteInfoTable, vrrpGeneral=vrrpGeneral, ospfIntfIndex=ospfIntfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgVip=ripCurCfgVip, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoRefPorts=arpInfoRefPorts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ospfStats=ospfStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, ospfTotalAreas=ospfTotalAreas, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripCurCfgState=ripCurCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoEntry=arpInfoEntry, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumRxHello=ospfCumRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCfg=ospfCfg, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, iprouting=iprouting, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStats=vrrpStats, ospfInterface=ospfInterface, ospfAreaInfoId=ospfAreaInfoId, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpStatOutAdvers=vrrpStatOutAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfinfo=ospfinfo, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNbrInInitState=ospfNbrInInitState, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, ospfArea=ospfArea, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfHello=ospfIntfHello, ospfGeneral=ospfGeneral, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ripStatOutPkts=ripStatOutPkts, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgSupply=ripNewCfgSupply, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoVLAN=arpInfoVLAN, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaIntfDown=ospfAreaIntfDown, dnsStats=dnsStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOper=vrrpOper, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, routeStats=routeStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoDestIp=arpInfoDestIp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripStatInPkts=ripStatInPkts, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoSrcPort=arpInfoSrcPort, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipForward=ipForward, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ip_info=ip_info, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfGeneralStats=ospfGeneralStats, ripConfig=ripConfig, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkID=routerLSALinkID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfInfoTable=ospfIntfInfoTable, ripStats=ripStats, ospfCumIntfHello=ospfCumIntfHello, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgState=ripNewCfgState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgDefListen=ripNewCfgDefListen, vrrp=vrrp, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTxPkts=ospfIntfTxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaIntfHello=ospfAreaIntfHello, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNbrInExchState=ospfNbrInExchState, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStats=arpStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routerLSAId=routerLSAId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfInfoIndex=ospfIfInfoIndex, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx)
