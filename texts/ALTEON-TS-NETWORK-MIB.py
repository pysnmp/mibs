...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalAreas=ospfTotalAreas, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrp_info=vrrp_info, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfStats=ospfStats, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrp=vrrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoType=ipRouteInfoType, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNbrInFullState=ospfNbrInFullState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOper=vrrpOper, ospfCurCfgAreaId=ospfCurCfgAreaId, dnsStats=dnsStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfProcessUptime=ospfProcessUptime, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgState=ripNewCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoRefPorts=arpInfoRefPorts, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfinfo=ospfinfo, ipCurCfgGwRetry=ipCurCfgGwRetry, ripStatOutPkts=ripStatOutPkts, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfDown=ospfCumIntfDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNbrInInitState=ospfNbrInInitState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrChange=ospfIntfNbrChange, arpStatHighWater=arpStatHighWater, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgSupply=ripNewCfgSupply, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfIndex=ipCurCfgIntfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfHello=ospfIntfHello, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxHello=ospfAreaRxHello, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, arpStats=arpStats, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ip_info=ip_info, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfArea=ospfArea, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCfg=ospfCfg, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwIndex=ipNewCfgGwIndex, routerLSAId=routerLSAId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumNbrBadRequests=ospfCumNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxDatabase=ospfCumTxDatabase, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpStatEntries=arpStatEntries, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrDown=ospfCumNbrDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, ipForward=ipForward, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrhello=ospfIntfNbrhello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStats=ripStats, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumTxHello=ospfCumTxHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumTxPkts=ospfCumTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwTable=ipCurCfgGwTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfState=ipNewCfgIntfState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrStart=ospfCumNbrStart, ospfStartTime=ospfStartTime, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpInfoDestIp=arpInfoDestIp, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatHighWater=routeStatHighWater, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkData=routerLSALinkData, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfIndex=ospfIntfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, iprouting=iprouting, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgListen=ripCurCfgListen, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry)
