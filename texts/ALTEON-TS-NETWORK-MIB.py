...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfStats=ospfStats, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfInterface=ospfInterface, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ip_info=ip_info, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxPkts=ospfCumRxPkts, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgDefListen=ripCurCfgDefListen, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, ripStatInPkts=ripStatInPkts, ospfCfg=ospfCfg, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfLsTypesSupported=ospfLsTypesSupported, routerLSALinkIndex=routerLSALinkIndex, dnsStats=dnsStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfBackup=ospfIntfBackup, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwState=ipNewCfgGwState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInExchState=ospfNbrInExchState, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrDown=ospfIntfNbrDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwState=ipCurCfgGwState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfGeneralStats=ospfGeneralStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoEntry=arpInfoEntry, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, routeStats=routeStats, ospfCumNbrN1way=ospfCumNbrN1way, arpStatHighWater=arpStatHighWater, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfStartTime=ospfStartTime, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipForward=ipForward, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxDatabase=ospfIntfRxDatabase, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTotalAreas=ospfTotalAreas, ripCurCfgState=ripCurCfgState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoTable=arpInfoTable, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSAId=routerLSAId, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgSupply=ripNewCfgSupply, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpStatMaxEntries=arpStatMaxEntries, arpInfoDestIp=arpInfoDestIp, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfArea=ospfArea, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkID=routerLSALinkID, routeStatHighWater=routeStatHighWater, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgListen=ripNewCfgListen, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoSrcPort=arpInfoSrcPort, ripStatOutPkts=ripStatOutPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgVip=ripCurCfgVip, ripStats=ripStats, vrrp=vrrp, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpGeneral=vrrpGeneral, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgState=ripNewCfgState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpStatEntries=arpStatEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfHello=ospfIntfHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripConfig=ripConfig, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routerLSALinkData=routerLSALinkData, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfNbrChange=ospfCumIntfNbrChange, iprouting=iprouting, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfBackup=ospfCumIntfBackup, arpStats=arpStats, arpInfoVLAN=arpInfoVLAN, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrhello=ospfAreaNbrhello, routeStatEntries=routeStatEntries, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfLoop=ospfIntfLoop, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry)
