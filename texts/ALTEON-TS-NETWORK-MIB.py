...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfDown=ospfCumIntfDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfGeneral=ospfGeneral, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfinfo=ospfinfo, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxHello=ospfCumRxHello, ospfAreaIntfDown=ospfAreaIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ip_info=ip_info, ipRouteInfoType=ipRouteInfoType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNbrInFullState=ospfNbrInFullState, routeStatMaxEntries=routeStatMaxEntries, arpStatEntries=arpStatEntries, ipRouteInfoTag=ipRouteInfoTag, vrrp=vrrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripStatOutPkts=ripStatOutPkts, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrhello=ospfCumNbrhello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routeStats=routeStats, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgVip=ripCurCfgVip, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripConfig=ripConfig, ripCurCfgSupply=ripCurCfgSupply, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpStats=arpStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfLoop=ospfIntfLoop, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCfg=ospfCfg, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpInfoFlag=arpInfoFlag, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpGeneral=vrrpGeneral, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStats=ospfStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfInterface=ospfInterface, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfHello=ospfIntfHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoEntry=arpInfoEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSAId=routerLSAId, ospfGeneralStats=ospfGeneralStats, routerLSALinkID=routerLSALinkID, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpStatHighWater=arpStatHighWater, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgListen=ripCurCfgListen, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNbrInExchState=ospfNbrInExchState, ospfNbrInInitState=ospfNbrInInitState, vrrpOper=vrrpOper, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkData=routerLSALinkData, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfDown=ospfIntfDown, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgBootpState=ipNewCfgBootpState, ripStats=ripStats, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgBootpState=ipCurCfgBootpState, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwEntry=ipCurCfgGwEntry, dnsStats=dnsStats, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpStats=vrrpStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStatInPkts=ripStatInPkts, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfArea=ospfArea, ipRouteInfoMask=ipRouteInfoMask, arpInfoRefPorts=arpInfoRefPorts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routeStatEntries=routeStatEntries, iprouting=iprouting, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfWaitInterval=ospfIfWaitInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalAreas=ospfTotalAreas, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpInfoTable=arpInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfProcessUptime=ospfProcessUptime, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripNewCfgListen=ripNewCfgListen)
