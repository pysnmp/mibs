...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrhello=ospfCumNbrhello, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxHello=ospfAreaRxHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumTxlsReqs=ospfCumTxlsReqs, arpStatEntries=arpStatEntries, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfHello=ospfIntfHello, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatHighWater=arpStatHighWater, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalAreas=ospfTotalAreas, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCfg=ospfCfg, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfState=ipCurCfgIntfState, ospfInterface=ospfInterface, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfinfo=ospfinfo, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoEntry=arpInfoEntry, ripNewCfgState=ripNewCfgState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfArea=ospfArea, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgState=ripCurCfgState, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripStatOutPkts=ripStatOutPkts, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripStatInPkts=ripStatInPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumRxHello=ospfCumRxHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxHello=ospfIntfRxHello, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfDown=ospfIntfDown, vrrpStatOutAdvers=vrrpStatOutAdvers, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrDown=ospfAreaNbrDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfBackup=ospfIntfBackup, arpInfoVLAN=arpInfoVLAN, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStats=routeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipForward=ipForward, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfStats=ospfStats, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrp=vrrp, routeStatEntries=routeStatEntries, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfHello=ospfCumIntfHello, iprouting=iprouting, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrStart=ospfCumNbrStart, ospfAreaTxPkts=ospfAreaTxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoType=ipRouteInfoType, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ip_info=ip_info, ripNewCfgListen=ripNewCfgListen, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgVip=ripCurCfgVip, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNbrInInitState=ospfNbrInInitState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripStats=ripStats, routeStatHighWater=routeStatHighWater, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, dnsStats=dnsStats, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, arpStats=arpStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgBootpState=ipCurCfgBootpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrp_info=vrrp_info, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrDown=ospfCumNbrDown, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSALinkID=routerLSALinkID, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripConfig=ripConfig, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxPkts=ospfAreaRxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfStartTime=ospfStartTime, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfGeneral=ospfGeneral, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOper=vrrpOper, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgPortState=ipFwdNewCfgPortState)
