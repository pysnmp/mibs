...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoMacAddr=arpInfoMacAddr, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSALinkID=routerLSALinkID, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgVip=ripNewCfgVip, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrp_info=vrrp_info, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfIndex=ospfIntfIndex, routeStats=routeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStats=arpStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfStats=ospfStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfGeneral=ospfGeneral, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgListen=ripCurCfgListen, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routeStatMaxEntries=routeStatMaxEntries, ospfGeneralStats=ospfGeneralStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCfg=ospfCfg, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOper=vrrpOper, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatEntries=arpStatEntries, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfChangeStats=ospfIntfChangeStats, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrDown=ospfIntfNbrDown, ospfStartTime=ospfStartTime, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStats=ripStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStatInPkts=ripStatInPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ipRouteInfoGateway=ipRouteInfoGateway, vrrp=vrrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfHello=ospfIntfHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpStats=vrrpStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxPkts=ospfCumTxPkts, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSALinkIndex=routerLSALinkIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgState=ripCurCfgState, ipNewCfgIntfMask=ipNewCfgIntfMask, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfDown=ospfIntfDown, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ip_info=ip_info, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumTxDatabase=ospfCumTxDatabase, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, dnsStats=dnsStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripConfig=ripConfig, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkData=routerLSALinkData, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrStart=ospfIntfNbrStart, ipForward=ipForward, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoFlag=arpInfoFlag, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTimersKickOffStats=ospfTimersKickOffStats, routeStatEntries=routeStatEntries, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumTxHello=ospfCumTxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfArea=ospfArea, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoTable=arpInfoTable, vrrpGeneral=vrrpGeneral, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpStatHighWater=arpStatHighWater, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxHello=ospfIntfRxHello, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSAId=routerLSAId, routeStatHighWater=routeStatHighWater, ospfInterface=ospfInterface, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfDown=ospfCumIntfDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, iprouting=iprouting, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwArp=ipNewCfgGwArp, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalNeighbours=ospfTotalNeighbours, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTotalAreas=ospfTotalAreas, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfLoop=ospfIntfLoop)
