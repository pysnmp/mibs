...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgDefListen=ripCurCfgDefListen, ospfGeneralStats=ospfGeneralStats, ospfIntfTxHello=ospfIntfTxHello, ip_info=ip_info, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpStats=vrrpStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOper=vrrpOper, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfInterface=ospfInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrp=vrrp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoTable=ipRouteInfoTable, arpStatHighWater=arpStatHighWater, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgAreaId=ospfCurCfgAreaId, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfStartTime=ospfStartTime, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalAreas=ospfTotalAreas, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoTable=arpInfoTable, ripStatInPkts=ripStatInPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgState=ripNewCfgState, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgSupply=ripCurCfgSupply, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoIndx=ipRouteInfoIndx, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoMacAddr=arpInfoMacAddr, vrrp_info=vrrp_info, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrDown=ospfCumNbrDown, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCfg=ospfCfg, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfinfo=ospfinfo, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxPkts=ospfCumRxPkts, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipGatewayTableMax=ipGatewayTableMax, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfProcessUptime=ospfProcessUptime, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgPortState=ipFwdCurCfgPortState, iprouting=iprouting, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfArea=ospfArea, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfStats=ospfStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxHello=ospfCumRxHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrRstAd=ospfAreaNbrRstAd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkID=routerLSALinkID, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxHello=ospfCumTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpStatEntries=arpStatEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgListen=ripNewCfgListen, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSALinkIndex=routerLSALinkIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgListen=ripCurCfgListen, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrStart=ospfAreaNbrStart, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpStatInAdvers=vrrpStatInAdvers, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpStats=arpStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoEntry=arpInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrhello=ospfAreaNbrhello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSAId=routerLSAId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, dnsStats=dnsStats, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatOutPkts=ripStatOutPkts, ospfIntfDown=ospfIntfDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routeStatHighWater=routeStatHighWater, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routeStats=routeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ripStatInErrorPkts=ripStatInErrorPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routeStatEntries=routeStatEntries, ripConfig=ripConfig, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoTable=ospfAreaInfoTable, ipForward=ipForward, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfLoop=ospfIntfLoop, ospfGeneral=ospfGeneral, ripStats=ripStats, vrrpGeneral=vrrpGeneral, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfBackup=ospfIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfTable=ipNewCfgIntfTable)
