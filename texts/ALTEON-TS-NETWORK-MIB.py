...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfStartTime=ospfStartTime, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpStats=vrrpStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoTag=ipRouteInfoTag, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfArea=ospfArea, ospfTotalNeighbours=ospfTotalNeighbours, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripConfig=ripConfig, ospfAreaTxPkts=ospfAreaTxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumIntfDown=ospfCumIntfDown, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTotalAreas=ospfTotalAreas, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgListen=ripCurCfgListen, vrrp=vrrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrDown=ospfCumNbrDown, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoType=ipRouteInfoType, routerLSALinkID=routerLSALinkID, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipForward=ipForward, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripStats=ripStats, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpStatInAdvers=vrrpStatInAdvers, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgSupply=ripNewCfgSupply, ospfGeneral=ospfGeneral, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgDefListen=ripNewCfgDefListen, vrrp_info=vrrp_info, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStatHighWater=routeStatHighWater, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ip_info=ip_info, ipNewCfgGwMetric=ipNewCfgGwMetric, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSAId=routerLSAId, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routeStats=routeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfinfo=ospfinfo, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatOutPkts=ripStatOutPkts, arpInfoTable=arpInfoTable, iprouting=iprouting, dnsStats=dnsStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpStats=arpStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfProcessUptime=ospfProcessUptime, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgState=ripNewCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoFlag=arpInfoFlag, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwState=ipNewCfgGwState, arpInfoEntry=arpInfoEntry, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfStats=ospfStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxHello=ospfCumRxHello, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpGeneral=vrrpGeneral, ospfIntfHello=ospfIntfHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgVip=ripNewCfgVip, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoMacAddr=arpInfoMacAddr, routeStatEntries=routeStatEntries, ospfInterface=ospfInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOper=vrrpOper, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoRefPorts=arpInfoRefPorts, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpStatHighWater=arpStatHighWater, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpStatEntries=arpStatEntries, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgListen=ripNewCfgListen, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex)
