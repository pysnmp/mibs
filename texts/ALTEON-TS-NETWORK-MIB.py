...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrRstAd=ospfCumNbrRstAd, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgState=ripNewCfgState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrp_info=vrrp_info, ospfinfo=ospfinfo, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgVip=ripCurCfgVip, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfStartTime=ospfStartTime, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpGeneral=vrrpGeneral, vrrpStatOutAdvers=vrrpStatOutAdvers, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoMacAddr=arpInfoMacAddr, ospfStats=ospfStats, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfDown=ospfIntfDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaTable=ospfNewCfgAreaTable, routeStatEntries=routeStatEntries, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfLoop=ospfIntfLoop, ripCurCfgListen=ripCurCfgListen, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxHello=ospfAreaRxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfArea=ospfArea, vrrpStats=vrrpStats, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipForward=ipForward, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwInterval=ipCurCfgGwInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfBackup=ospfIntfBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, arpStats=arpStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStats=ripStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgState=ipFwdNewCfgState, routeStats=routeStats, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaInfoId=ospfAreaInfoId, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaInfoTable=ospfAreaInfoTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoTable=ipRouteInfoTable, ospfInterface=ospfInterface, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxHello=ospfCumRxHello, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCfg=ospfCfg, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTimersKickOffStats=ospfTimersKickOffStats, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwState=ipNewCfgGwState, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpInfoFlag=arpInfoFlag, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfGeneral=ospfGeneral, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgState=ripCurCfgState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrp=vrrp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpStatHighWater=arpStatHighWater, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, iprouting=iprouting, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripConfig=ripConfig, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTotalAreas=ospfTotalAreas, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpStatEntries=arpStatEntries, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ip_info=ip_info, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSALinkID=routerLSALinkID, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpStatInAdvers=vrrpStatInAdvers, routerLSAId=routerLSAId, routerLSALinkData=routerLSALinkData, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoRefPorts=arpInfoRefPorts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfDown=ospfCumIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, dnsStats=dnsStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoEntry=arpInfoEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routeStatHighWater=routeStatHighWater, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxHello=ospfCumTxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNbrInExchState=ospfNbrInExchState, ospfGeneralInfo=ospfGeneralInfo, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby)
