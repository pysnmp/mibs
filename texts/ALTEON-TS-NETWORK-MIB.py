...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoInterface=ipRouteInfoInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfBackup=ospfIntfBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoEntry=arpInfoEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxPkts=ospfCumRxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripConfig=ripConfig, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripCurCfgState=ripCurCfgState, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoDestIp=arpInfoDestIp, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfProcessUptime=ospfProcessUptime, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpStats=vrrpStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTotalAreas=ospfTotalAreas, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfinfo=ospfinfo, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfIndex=ospfIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfLsTypesSupported=ospfLsTypesSupported, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpStatInAdvers=vrrpStatInAdvers, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ip_info=ip_info, ospfStats=ospfStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfGeneralStats=ospfGeneralStats, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgState=ripNewCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoGateway=ipRouteInfoGateway, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCfg=ospfCfg, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoTable=arpInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwRetry=ipNewCfgGwRetry, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrp=vrrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOper=vrrpOper, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipForward=ipForward, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgVip=ripCurCfgVip, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxPkts=ospfIntfRxPkts, routeStatEntries=routeStatEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoMacAddr=arpInfoMacAddr, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfLoop=ospfIntfLoop, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStatEntries=arpStatEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgBootpState=ipNewCfgBootpState, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, iprouting=iprouting, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoVLAN=arpInfoVLAN, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, routeStats=routeStats, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSALinkID=routerLSALinkID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpStatMaxEntries=arpStatMaxEntries, ospfIntfHello=ospfIntfHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxHello=ospfIntfTxHello, ripStatInPkts=ripStatInPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoType=ipRouteInfoType, ospfArea=ospfArea, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwState=ipNewCfgGwState, ospfInterface=ospfInterface, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInExchState=ospfNbrInExchState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStats=ripStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpGeneral=vrrpGeneral, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxHello=ospfAreaRxHello, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfDown=ospfIntfDown, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpInfoFlag=arpInfoFlag, arpStatHighWater=arpStatHighWater, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfStartTime=ospfStartTime, ospfGeneral=ospfGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpStats=arpStats, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSAId=routerLSAId)
