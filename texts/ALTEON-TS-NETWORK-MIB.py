...
MibIdentifier, Bits, Unsigned32, TimeTicks, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, ModuleIdentity, ObjectIdentity, Integer32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Unsigned32", "TimeTicks", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Integer32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgListen=ripCurCfgListen, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInFullState=ospfNbrInFullState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxDatabase=ospfCumRxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, routerLSALinkID=routerLSALinkID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStatHighWater=arpStatHighWater, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwTable=ipCurCfgGwTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfGeneralStats=ospfGeneralStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfIndex=ospfIntfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, iprouting=iprouting, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfBackup=ospfIntfBackup, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrStart=ospfCumNbrStart, arpInfoFlag=arpInfoFlag, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfinfo=ospfinfo, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfStats=ospfStats, routerLSAId=routerLSAId, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOper=vrrpOper, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ripStatInPkts=ripStatInPkts, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgState=ripCurCfgState, ipCurCfgBootpState=ipCurCfgBootpState, ripConfig=ripConfig, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routeStats=routeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpInfoMacAddr=arpInfoMacAddr, vrrp=vrrp, ipCurCfgIntfTable=ipCurCfgIntfTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalAreas=ospfTotalAreas, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwVlan=ipCurCfgGwVlan, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoVLAN=arpInfoVLAN, ospfIntfHello=ospfIntfHello, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwInterval=ipCurCfgGwInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipForward=ipForward, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfArea=ospfArea, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfLoop=ospfIntfLoop, arpInfoSrcPort=arpInfoSrcPort, routeStatEntries=routeStatEntries, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxHello=ospfCumTxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSAAreaIndex=routerLSAAreaIndex, ospfGeneral=ospfGeneral, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoIndex=ospfAreaInfoIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxPkts=ospfCumRxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwInterval=ipNewCfgGwInterval, arpStatEntries=arpStatEntries, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoTable=arpInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfGeneralInfo=ospfGeneralInfo, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoTag=ipRouteInfoTag, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCfg=ospfCfg, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpStats=arpStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwRetry=ipNewCfgGwRetry, ip_info=ip_info, dnsStats=dnsStats, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwAddr=ipCurCfgGwAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripStats=ripStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpStats=vrrpStats, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfStartTime=ospfStartTime, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf)
