...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfStartTime=ospfStartTime, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrDown=ospfIntfNbrDown, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwRetry=ipCurCfgGwRetry, ripStats=ripStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgState=ripNewCfgState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwState=ipNewCfgGwState, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoTable=ipRouteInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfDown=ospfIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfInfoTable=ospfIntfInfoTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrp_info=vrrp_info, routeStatEntries=routeStatEntries, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxTxStats=ospfAreaRxTxStats, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStats=vrrpStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpStatEntries=arpStatEntries, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgSupply=ripNewCfgSupply, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrN1way=ospfAreaNbrN1way, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfProcessUptime=ospfProcessUptime, vrrpGeneral=vrrpGeneral, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSAId=routerLSAId, arpInfoTable=arpInfoTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrStart=ospfAreaNbrStart, ospfNbrInExchState=ospfNbrInExchState, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaChangeStats=ospfAreaChangeStats, vrrp=vrrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSAAreaIndex=routerLSAAreaIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxDatabase=ospfAreaTxDatabase, routeStats=routeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, iprouting=iprouting, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpStats=arpStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrDown=ospfCumNbrDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrhello=ospfIntfNbrhello, routerLSALinkID=routerLSALinkID, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaTxHello=ospfAreaTxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaInfoId=ospfAreaInfoId)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStatMaxEntries=arpStatMaxEntries, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ip_info=ip_info, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripStatInErrorPkts=ripStatInErrorPkts, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpInfoSrcPort=arpInfoSrcPort, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, dnsStats=dnsStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoType=ipRouteInfoType, arpInfoEntry=arpInfoEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInFullState=ospfNbrInFullState, arpStatHighWater=arpStatHighWater, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpInfoFlag=arpInfoFlag, ospfIntfLoop=ospfIntfLoop, ospfCumTxPkts=ospfCumTxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfinfo=ospfinfo, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfGeneralStats=ospfGeneralStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfArea=ospfArea, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripConfig=ripConfig, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipForward=ipForward, ospfStats=ospfStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgListen=ripCurCfgListen, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock)
