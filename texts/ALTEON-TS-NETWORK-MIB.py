...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalNssaAreas=ospfTotalNssaAreas, iprouting=iprouting, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrDown=ospfCumNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrStart=ospfCumNbrStart, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStatHighWater=routeStatHighWater, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrp=vrrp, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgDefListen=ripCurCfgDefListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfinfo=ospfinfo, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgState=ripNewCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfInterface=ospfInterface, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpStats=vrrpStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfDown=ospfIntfDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfArea=ospfArea, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoMacAddr=arpInfoMacAddr, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInExchState=ospfNbrInExchState, routeStats=routeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxHello=ospfAreaTxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpGeneral=vrrpGeneral, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routeStatEntries=routeStatEntries, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfUnloop=ospfCumIntfUnloop, dnsStats=dnsStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStats=arpStats, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfGeneral=ospfGeneral, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoVLAN=arpInfoVLAN, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNbrInFullState=ospfNbrInFullState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpOper=vrrpOper, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpStatHighWater=arpStatHighWater, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxPkts=ospfCumRxPkts, ripStats=ripStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp_info=vrrp_info, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwTable=ipNewCfgGwTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgState=ripCurCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCfg=ospfCfg, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumTxHello=ospfCumTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfState=ipNewCfgIntfState, routerLSAAreaIndex=routerLSAAreaIndex, routerLSALinkData=routerLSALinkData, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgState=ipFwdCurCfgState, ripStatOutPkts=ripStatOutPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgSupply=ripNewCfgSupply, ripConfig=ripConfig, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSAId=routerLSAId, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrN1way=ospfCumNbrN1way, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipForward=ipForward, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStatEntries=arpStatEntries, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfHello=ospfIntfHello, ip_info=ip_info, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, arpInfoEntry=arpInfoEntry, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfProcessUptime=ospfProcessUptime, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgVip=ripCurCfgVip, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfStats=ospfStats, arpInfoRefPorts=arpInfoRefPorts, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSALinkID=routerLSALinkID, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfIndex=ospfIntfIndex, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry)
