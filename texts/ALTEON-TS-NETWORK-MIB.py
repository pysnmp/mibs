...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgState=ripNewCfgState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoEntry=arpInfoEntry, iprouting=iprouting, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatOutPkts=ripStatOutPkts, routeStats=routeStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgDefListen=ripNewCfgDefListen, ripStatInPkts=ripStatInPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgState=ripCurCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripCurCfgSupply=ripCurCfgSupply, ip_info=ip_info, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfLoop=ospfCumIntfLoop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNbrInFullState=ospfNbrInFullState, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrp_info=vrrp_info, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpState=ipCurCfgBootpState, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwState=ipNewCfgGwState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgListen=ripNewCfgListen, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfStartTime=ospfStartTime, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoSrcPort=arpInfoSrcPort, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSALinkData=routerLSALinkData, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripConfig=ripConfig, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumIntfDown=ospfCumIntfDown, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpGeneral=vrrpGeneral, ospfAreaTxPkts=ospfAreaTxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInExchState=ospfNbrInExchState, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipForward=ipForward, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrp=vrrp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfStats=ospfStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgListen=ripCurCfgListen, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfArea=ospfArea, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxDatabase=ospfCumTxDatabase, ripStats=ripStats, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfInfoIndex=ospfIfInfoIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfHello=ospfIntfHello, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfBackup=ospfIntfBackup, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoEntry=ipRouteInfoEntry, routerLSALinkID=routerLSALinkID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxPkts=ospfCumRxPkts, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStatHighWater=arpStatHighWater, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfDown=ospfIntfDown, ospfCumTxHello=ospfCumTxHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoGateway=ipRouteInfoGateway, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCfg=ospfCfg, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, dnsStats=dnsStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpStats=arpStats, routeStatEntries=routeStatEntries, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfGeneralStats=ospfGeneralStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage)
