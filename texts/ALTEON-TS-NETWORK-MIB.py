...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOper=vrrpOper, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfStartTime=ospfStartTime, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ip_info=ip_info, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoSrcPort=arpInfoSrcPort, ripCurCfgState=ripCurCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwInterval=ipCurCfgGwInterval, arpStats=arpStats, routeStatHighWater=routeStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripStatInPkts=ripStatInPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxHello=ospfCumRxHello, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwIndex=ipNewCfgGwIndex, ripNewCfgVip=ripNewCfgVip, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStatHighWater=arpStatHighWater, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgState=ripNewCfgState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfLsTypesSupported=ospfLsTypesSupported, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwDelete=ipNewCfgGwDelete, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxHello=ospfCumTxHello, routerLSAId=routerLSAId, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCfg=ospfCfg, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgBootpState=ipNewCfgBootpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwMetric=ipCurCfgGwMetric, ripCurCfgVip=ripCurCfgVip, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripConfig=ripConfig, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrp=vrrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfGeneralStats=ospfGeneralStats, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgBootpState=ipCurCfgBootpState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoFlag=arpInfoFlag, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpStatEntries=arpStatEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfDown=ospfIntfDown, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxPkts=ospfCumTxPkts, ospfStats=ospfStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrp_info=vrrp_info, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrN1way=ospfIntfNbrN1way)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, iprouting=iprouting, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxlsAcks=ospfCumRxlsAcks, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwVlan=ipCurCfgGwVlan, routeStats=routeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipForward=ipForward, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwTable=ipNewCfgGwTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfInfoTable=ospfIntfInfoTable, dnsStats=dnsStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrDown=ospfCumNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfWaitInterval=ospfIfWaitInterval, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgListen=ripNewCfgListen, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSAAreaIndex=routerLSAAreaIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfArea=ospfArea, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkData=routerLSALinkData, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoIndx=ipRouteInfoIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, arpInfoEntry=arpInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripStats=ripStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpGeneral=vrrpGeneral, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoTag=ipRouteInfoTag, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority)
