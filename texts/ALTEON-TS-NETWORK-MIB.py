...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, dnsStats=dnsStats, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfHello=ospfCumIntfHello, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ip_info=ip_info, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoMacAddr=arpInfoMacAddr, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routerLSALinkID=routerLSALinkID, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripConfig=ripConfig, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfGeneralStats=ospfGeneralStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipForward=ipForward, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoFlag=arpInfoFlag, routerLSALinkIndex=routerLSALinkIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStats=arpStats, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStatHighWater=arpStatHighWater, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrp_info=vrrp_info, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOper=vrrpOper, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxPkts=ospfAreaRxPkts, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoSrcPort=arpInfoSrcPort, ospfTotalNeighbours=ospfTotalNeighbours, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgState=ripNewCfgState, ospfCumNbrStart=ospfCumNbrStart, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoEntry=arpInfoEntry, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNbrInExchState=ospfNbrInExchState, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrDown=ospfAreaNbrDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStatEntries=routeStatEntries, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, iprouting=iprouting, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpGeneral=vrrpGeneral, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfProcessUptime=ospfProcessUptime, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStats=ripStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoType=ipRouteInfoType, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSAId=routerLSAId, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfStats=ospfStats, ospfGeneral=ospfGeneral, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrStart=ospfAreaNbrStart, ipGatewayTableMax=ipGatewayTableMax, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoTable=arpInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStatEntries=arpStatEntries, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgVip=ripCurCfgVip, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routeStats=routeStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfGeneralInfo=ospfGeneralInfo)
