...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenState=vrrpCurCfgGenState, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpStats=vrrpStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrN1way=ospfCumNbrN1way, ripConfig=ripConfig, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCfg=ospfCfg, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrp_info=vrrp_info, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfDown=ospfCumIntfDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipForward=ipForward, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrStart=ospfCumNbrStart, ospfGeneral=ospfGeneral, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStats=ripStats, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpGeneral=vrrpGeneral, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgListen=ripCurCfgListen, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ip_info=ip_info, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpStatEntries=arpStatEntries, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfStats=ospfStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwState=ipCurCfgGwState, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxHello=ospfCumRxHello, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfStartTime=ospfStartTime, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routeStatHighWater=routeStatHighWater, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrN1way=ospfAreaNbrN1way, dnsStats=dnsStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfHello=ospfIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNbrInFullState=ospfNbrInFullState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOper=vrrpOper, routeStats=routeStats, vrrp=vrrp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfArea=ospfArea, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfDown=ospfIntfDown, routerLSALinkID=routerLSALinkID, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripStatInPkts=ripStatInPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgDefListen=ripNewCfgDefListen, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfGeneralStats=ospfGeneralStats, routeStatEntries=routeStatEntries, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfTotalAreas=ospfTotalAreas, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, iprouting=iprouting, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSALinkData=routerLSALinkData, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoMacAddr=arpInfoMacAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrDown=ospfCumNbrDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfinfo=ospfinfo, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoEntry=ipRouteInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfProcessUptime=ospfProcessUptime, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpStatHighWater=arpStatHighWater, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgGwTable=ipCurCfgGwTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgVip=ripCurCfgVip, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfInterface=ospfInterface, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfBackup=ospfIntfBackup, arpStats=arpStats, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp)
