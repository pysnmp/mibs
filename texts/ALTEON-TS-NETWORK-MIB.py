...
ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Gauge32, NotificationType, Integer32, IpAddress, TimeTicks, iso, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Gauge32", "NotificationType", "Integer32", "IpAddress", "TimeTicks", "iso", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfGeneral=ospfGeneral, ospfIntfBackup=ospfIntfBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfDown=ospfIntfDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxPkts=ospfIntfRxPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrp_info=vrrp_info, arpInfoTable=arpInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routeStatHighWater=routeStatHighWater, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTotalAreas=ospfTotalAreas, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgState=ripCurCfgState, routeStatMaxEntries=routeStatMaxEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfArea=ospfArea, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaChangeStats=ospfAreaChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfUnloop=ospfIntfUnloop, vrrpOper=vrrpOper, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routerLSALinkID=routerLSALinkID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpStats=vrrpStats, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxDatabase=ospfAreaRxDatabase, iprouting=iprouting, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripStats=ripStats, ospfAreaNbrStart=ospfAreaNbrStart, routerLSALinkIndex=routerLSALinkIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpStatEntries=arpStatEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoTable=ipRouteInfoTable, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpStatInAdvers=vrrpStatInAdvers, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpGeneral=vrrpGeneral, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCfg=ospfCfg, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgState=ripNewCfgState, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStats=routeStats, ospfInterface=ospfInterface, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoEntry=arpInfoEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoMask=ipRouteInfoMask, ospfIntfLoop=ospfIntfLoop, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoRefPorts=arpInfoRefPorts, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ospfinfo=ospfinfo, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfDown=ospfAreaIntfDown, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routeStatEntries=routeStatEntries, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripConfig=ripConfig, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfState=ipCurCfgIntfState, ripStatInPkts=ripStatInPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgVip=ripNewCfgVip, routerLSAId=routerLSAId, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoEntry=ipRouteInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwVlan=ipNewCfgGwVlan, routerLSALinkData=routerLSALinkData, ripCurCfgListen=ripCurCfgListen, ipForward=ipForward, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfHello=ospfIntfHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfGeneralStats=ospfGeneralStats, ospfNbrInInitState=ospfNbrInInitState, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxHello=ospfCumTxHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoType=ipRouteInfoType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfStartTime=ospfStartTime, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrp=vrrp, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrDown=ospfIntfNbrDown, ip_info=ip_info, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, dnsStats=dnsStats, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete)
