...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoTag=ipRouteInfoTag, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, arpStatEntries=arpStatEntries, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfLoop=ospfIntfLoop, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfProcessUptime=ospfProcessUptime, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrp_info=vrrp_info, ospfTotalAreas=ospfTotalAreas, ripStatOutPkts=ripStatOutPkts, dnsStats=dnsStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSALinkIfIndex=routerLSALinkIfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoFlag=arpInfoFlag, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfinfo=ospfinfo, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoMacAddr=arpInfoMacAddr, ospfArea=ospfArea, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStats=vrrpStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStatInAdvers=vrrpStatInAdvers, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfGeneral=ospfGeneral, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrIndex=ospfIntfNbrIndex, iprouting=iprouting, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxHello=ospfCumRxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgState=ripCurCfgState, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, vrrp=vrrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routeStatHighWater=routeStatHighWater, vrrpGeneral=vrrpGeneral, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripConfig=ripConfig, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumTxPkts=ospfCumTxPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumIntfDown=ospfCumIntfDown, ospfIntfBackup=ospfIntfBackup, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrDown=ospfCumNbrDown, ospfCfg=ospfCfg, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStats=routeStats, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpStats=arpStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSAId=routerLSAId, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaChangeStats=ospfAreaChangeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripStatInErrorPkts=ripStatInErrorPkts, ripStats=ripStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ip_info=ip_info, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkData=routerLSALinkData, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpOper=vrrpOper, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoEntry=arpInfoEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfBackup=ospfCumIntfBackup, ipForward=ipForward, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrDown=ospfIntfNbrDown, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNbrInExchState=ospfNbrInExchState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfState=ipCurCfgIntfState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSALinkID=routerLSALinkID, ospfStats=ospfStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfState=ipNewCfgIntfState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgSupply=ripNewCfgSupply, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP)
