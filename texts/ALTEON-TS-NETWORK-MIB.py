...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrp=vrrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCfg=ospfCfg, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrIndex=ospfIntfNbrIndex, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routeStatEntries=routeStatEntries, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxHello=ospfCumTxHello, arpInfoFlag=arpInfoFlag, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfState=ipCurCfgIntfState, ripStats=ripStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNbrInFullState=ospfNbrInFullState, arpStats=arpStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoType=ipRouteInfoType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpStatMaxEntries=arpStatMaxEntries, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfDown=ospfIntfDown, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrDown=ospfAreaNbrDown, vrrpOper=vrrpOper, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNbrInInitState=ospfNbrInInitState, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxPkts=ospfCumTxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfGeneral=ospfGeneral, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpStats=vrrpStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfIndex=ospfIntfIndex, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, arpInfoEntry=arpInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgDefListen=ripNewCfgDefListen, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxPkts=ospfAreaRxPkts, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipForward=ipForward, ripCurCfgVip=ripCurCfgVip, arpStatEntries=arpStatEntries, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, dnsStats=dnsStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfUnloop=ospfCumIntfUnloop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfLoop=ospfIntfLoop, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfInterface=ospfInterface, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalAreas=ospfTotalAreas, routeStats=routeStats, ospfIntfRxHello=ospfIntfRxHello, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxHello=ospfCumRxHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfBackup=ospfCumIntfBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoGateway=ipRouteInfoGateway, ospfStats=ospfStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoId=ospfAreaInfoId, ospfStartTime=ospfStartTime, iprouting=iprouting, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoTable=ipRouteInfoTable, ospfIntfInfoTable=ospfIntfInfoTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routeStatHighWater=routeStatHighWater, ospfCumIntfDown=ospfCumIntfDown, routeStatMaxEntries=routeStatMaxEntries, ip_info=ip_info, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrp_info=vrrp_info, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfHello=ospfCumIntfHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgVip=ripNewCfgVip)
