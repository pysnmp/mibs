...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwState=ipNewCfgGwState, ospfCumIntfLoop=ospfCumIntfLoop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgGwTable=ipNewCfgGwTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgVip=ripNewCfgVip, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumRxTxStats=ospfCumRxTxStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwState=ipCurCfgGwState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpStats=vrrpStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfBackup=ospfIntfBackup, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfLsTypesSupported=ospfLsTypesSupported, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, dnsStats=dnsStats, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfLoop=ospfIntfLoop, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSALinkData=routerLSALinkData, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoMask=ipRouteInfoMask, arpInfoEntry=arpInfoEntry, arpInfoDestIp=arpInfoDestIp, ospfCumTxHello=ospfCumTxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxDatabase=ospfCumRxDatabase, routeStatHighWater=routeStatHighWater, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNbrInInitState=ospfNbrInInitState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfInfoIndex=ospfIfInfoIndex, ospfArea=ospfArea, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStats=arpStats, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSAId=routerLSAId, iprouting=iprouting, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfDown=ospfIntfDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStatOutPkts=ripStatOutPkts, ospfIntfUnloop=ospfIntfUnloop, ospfCfg=ospfCfg, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfHello=ospfIntfHello, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumIntfHello=ospfCumIntfHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStatHighWater=arpStatHighWater, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpGeneral=vrrpGeneral, ripCurCfgVip=ripCurCfgVip, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfGeneral=ospfGeneral, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipForward=ipForward, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoMacAddr=arpInfoMacAddr, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgListen=ripNewCfgListen, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfRxTxStats=ospfIntfRxTxStats, ripConfig=ripConfig, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoTable=arpInfoTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxPkts=ospfAreaRxPkts, ripStatInPkts=ripStatInPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrp_info=vrrp_info, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrStart=ospfAreaNbrStart, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpInfoFlag=arpInfoFlag, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaInfoTable=ospfAreaInfoTable, ospfinfo=ospfinfo, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStats=routeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ripStats=ripStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfProcessUptime=ospfProcessUptime, arpStatEntries=arpStatEntries, ospfCumIntfBackup=ospfCumIntfBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoInterface=ipRouteInfoInterface, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routeStatEntries=routeStatEntries, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpOper=vrrpOper, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ip_info=ip_info, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpInfoVLAN=arpInfoVLAN, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routerLSALinkID=routerLSALinkID, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrp=vrrp, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfTxPkts=ospfIntfTxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts)
