...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgVip=ripCurCfgVip, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaInfoId=ospfAreaInfoId, ospfInterface=ospfInterface, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfUnloop=ospfIntfUnloop, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routeStats=routeStats, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrhello=ospfCumNbrhello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwState=ipCurCfgGwState, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgSupply=ripCurCfgSupply, ipGatewayTableMax=ipGatewayTableMax, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpGeneral=vrrpGeneral, dnsStats=dnsStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoDestIp=arpInfoDestIp, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoGateway=ipRouteInfoGateway, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfHello=ospfAreaIntfHello, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxHello=ospfIntfRxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatEntries=routeStatEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ip_info=ip_info, ospfAreaChangeStats=ospfAreaChangeStats, arpStats=arpStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfIndex=ospfIntfIndex, vrrpStats=vrrpStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrp=vrrp, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripConfig=ripConfig, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOper=vrrpOper, ospfNbrInFullState=ospfNbrInFullState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatOutPkts=ripStatOutPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwTable=ipNewCfgGwTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, ospfTotalAreas=ospfTotalAreas, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoTable=arpInfoTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCfg=ospfCfg, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripCurCfgState=ripCurCfgState, arpInfoMacAddr=arpInfoMacAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipForward=ipForward, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfDown=ospfIntfDown, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxHello=ospfCumRxHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpState=ipCurCfgBootpState, ospfGeneralStats=ospfGeneralStats, ospfArea=ospfArea, ospfCumTxHello=ospfCumTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrStart=ospfCumNbrStart, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripCurCfgListen=ripCurCfgListen, iprouting=iprouting, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxPkts=ospfAreaRxPkts, arpStatEntries=arpStatEntries, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxlsReqs=ospfCumTxlsReqs, ripNewCfgState=ripNewCfgState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrp_info=vrrp_info, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfStartTime=ospfStartTime, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routeStatHighWater=routeStatHighWater, ospfStats=ospfStats, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSAId=routerLSAId, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTxHello=ospfIntfTxHello, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfinfo=ospfinfo, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxlsReqs=ospfAreaTxlsReqs)
