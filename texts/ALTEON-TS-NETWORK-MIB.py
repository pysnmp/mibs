...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrhello=ospfCumNbrhello, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfBackup=ospfIntfBackup, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgState=ripCurCfgState, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTimersKickOffStats=ospfTimersKickOffStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrp=vrrp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCfg=ospfCfg, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoTable=arpInfoTable, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSAId=routerLSAId, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrp_info=vrrp_info, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxDatabase=ospfCumTxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgBootpState=ipNewCfgBootpState, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxHello=ospfCumTxHello, ripStatOutPkts=ripStatOutPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStats=ripStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoDestIp=ipRouteInfoDestIp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgSupply=ripNewCfgSupply, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgVip=ripCurCfgVip, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpGeneral=vrrpGeneral, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgListen=ripCurCfgListen, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwState=ipNewCfgGwState, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalAreas=ospfTotalAreas, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwTable=ipNewCfgGwTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripConfig=ripConfig, ipForward=ipForward, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfDown=ospfIntfDown, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxlsAcks=ospfCumRxlsAcks, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrStart=ospfCumNbrStart, ospfGeneral=ospfGeneral, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfInfoTable=ospfIntfInfoTable, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatEntries=routeStatEntries, ospfinfo=ospfinfo, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgState=ripNewCfgState, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpStats=arpStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfStartTime=ospfStartTime, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxHello=ospfAreaTxHello, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrStart=ospfIntfNbrStart, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOper=vrrpOper, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routeStatHighWater=routeStatHighWater, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, routerLSALinkData=routerLSALinkData, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrDown=ospfAreaNbrDown, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, iprouting=iprouting, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripStatInPkts=ripStatInPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ip_info=ip_info, ospfArea=ospfArea, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxHello=ospfCumRxHello, ripCurCfgDefListen=ripCurCfgDefListen, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxHello=ospfAreaRxHello, routeStatMaxEntries=routeStatMaxEntries, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrDown=ospfCumNbrDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfTxHello=ospfIntfTxHello, ospfStats=ospfStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpStatHighWater=arpStatHighWater, ipCurCfgBootpState=ipCurCfgBootpState, ospfInterface=ospfInterface, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatEntries=arpStatEntries, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripNewCfgListen=ripNewCfgListen, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routeStats=routeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse)
