...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpStats=vrrpStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ip_info=ip_info, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfBackup=ospfIntfBackup, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStats=arpStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripCurCfgVip=ripCurCfgVip, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxHello=ospfIntfTxHello, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipForward=ipForward, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routeStatEntries=routeStatEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxHello=ospfCumRxHello, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoEntry=arpInfoEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripConfig=ripConfig, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfHello=ospfCumIntfHello, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwState=ipCurCfgGwState, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfLoop=ospfIntfLoop, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenState=vrrpNewCfgGenState, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpStatEntries=arpStatEntries, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfProcessUptime=ospfProcessUptime, ospfGeneralInfo=ospfGeneralInfo, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrp=vrrp, ipNewCfgGwTable=ipNewCfgGwTable, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfDown=ospfIntfDown, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgSupply=ripNewCfgSupply, arpStatHighWater=arpStatHighWater, routeStatHighWater=routeStatHighWater, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrhello=ospfCumNbrhello, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgListen=ripNewCfgListen, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripCurCfgListen=ripCurCfgListen, vrrpGeneral=vrrpGeneral, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrStart=ospfCumNbrStart, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfHello=ospfIntfHello, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoFlag=arpInfoFlag, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfGeneral=ospfGeneral, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoTable=arpInfoTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfArea=ospfArea, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoDestIp=arpInfoDestIp, ripCurCfgState=ripCurCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrDown=ospfAreaNbrDown, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfinfo=ospfinfo, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfGeneralStats=ospfGeneralStats, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripStats=ripStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfIndex=ospfIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCfg=ospfCfg, ospfAreaRxPkts=ospfAreaRxPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOper=vrrpOper, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwArp=ipNewCfgGwArp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, iprouting=iprouting, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routeStats=routeStats, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNbrInExchState=ospfNbrInExchState, ospfIfInfoIndex=ospfIfInfoIndex, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkID=routerLSALinkID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfLoop=ospfCumIntfLoop, routerLSAId=routerLSAId, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumIntfBackup=ospfCumIntfBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrp_info=vrrp_info)
