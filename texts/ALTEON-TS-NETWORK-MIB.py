...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoTable=ipRouteInfoTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfLoop=ospfIntfLoop, vrrp_info=vrrp_info, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routeStats=routeStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStats=vrrpStats, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStatEntries=arpStatEntries, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfTxPkts=ospfIntfTxPkts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipForward=ipForward, ipRouteInfoMask=ipRouteInfoMask, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfDown=ospfIntfDown, arpInfoEntry=arpInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgListen=ripNewCfgListen, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfGeneral=ospfGeneral, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoType=ipRouteInfoType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgState=ipFwdCurCfgState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCfg=ospfCfg, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgState=ripCurCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxHello=ospfAreaRxHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoTag=ipRouteInfoTag, routeStatHighWater=routeStatHighWater, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripStatInPkts=ripStatInPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgVip=ripNewCfgVip, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoFlag=arpInfoFlag, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrIndex=ospfAreaNbrIndex, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNbrInExchState=ospfNbrInExchState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStats=dnsStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripConfig=ripConfig, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfStartTime=ospfStartTime, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwDelete=ipNewCfgGwDelete, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwRetry=ipCurCfgGwRetry, iprouting=iprouting, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxPkts=ospfAreaTxPkts, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStatInAdvers=vrrpStatInAdvers, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routeStatMaxEntries=routeStatMaxEntries, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpGeneral=vrrpGeneral, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTotalAreas=ospfTotalAreas, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfHello=ospfIntfHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routeStatEntries=routeStatEntries, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfInterface=ospfInterface, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfArea=ospfArea, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaInfoId=ospfAreaInfoId, ip_info=ip_info, ripNewCfgState=ripNewCfgState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgBootpState=ipNewCfgBootpState, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStats=ripStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoSrcPort=arpInfoSrcPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxHello=ospfIntfTxHello, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpOper=vrrpOper, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwTable=ipNewCfgGwTable, arpStats=arpStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSAId=routerLSAId, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkID=routerLSALinkID, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaChangeStats=ospfAreaChangeStats, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgListen=ripCurCfgListen, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrp=vrrp, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxHello=ospfAreaTxHello)
