...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStats=routeStats, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, iprouting=iprouting, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfUnloop=ospfIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpStats=arpStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpStats=vrrpStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgDefListen=ripCurCfgDefListen, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, dnsStats=dnsStats, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoEntry=arpInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwRetry=ipCurCfgGwRetry, routeStatMaxEntries=routeStatMaxEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfGeneralStats=ospfGeneralStats, ospfTotalAreas=ospfTotalAreas, ip_info=ip_info, vrrp_info=vrrp_info, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgState=ripNewCfgState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfStats=ospfStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfinfo=ospfinfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgVip=ripCurCfgVip, arpStatEntries=arpStatEntries, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripStatInErrorPkts=ripStatInErrorPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgState=ipFwdCurCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfGeneral=ospfGeneral, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfDown=ospfAreaIntfDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfGeneralInfo=ospfGeneralInfo, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgSupply=ripCurCfgSupply, routerLSALinkID=routerLSALinkID, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpStatHighWater=arpStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ospfArea=ospfArea, arpInfoMacAddr=arpInfoMacAddr, ripStatInPkts=ripStatInPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgListen=ripNewCfgListen, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxTxStats=ospfIntfRxTxStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfInterface=ospfInterface, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripConfig=ripConfig, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfState=ipCurCfgIntfState, ospfStartTime=ospfStartTime, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripStatOutPkts=ripStatOutPkts, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStats=ripStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ripNewCfgDefListen=ripNewCfgDefListen, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfDown=ospfIntfDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrChange=ospfIntfNbrChange, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCfg=ospfCfg, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfProcessUptime=ospfProcessUptime, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumTxHello=ospfCumTxHello, arpInfoFlag=arpInfoFlag, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpGeneral=vrrpGeneral, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfHello=ospfCumIntfHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrIndex=ospfIntfNbrIndex, routeStatEntries=routeStatEntries, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrp=vrrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNbrInFullState=ospfNbrInFullState, ipForward=ipForward, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics)
