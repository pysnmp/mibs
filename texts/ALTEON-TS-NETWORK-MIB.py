...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStats=ripStats, arpInfoRefPorts=arpInfoRefPorts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrDown=ospfIntfNbrDown, routeStatMaxEntries=routeStatMaxEntries, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoTable=ipRouteInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp_info=vrrp_info, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ip_info=ip_info, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoFlag=arpInfoFlag, routerLSALinkIndex=routerLSALinkIndex, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgListen=ripNewCfgListen, ospfCumIntfLoop=ospfCumIntfLoop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfGeneralInfo=ospfGeneralInfo, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxHello=ospfCumRxHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgSupply=ripCurCfgSupply, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ospfProcessUptime=ospfProcessUptime, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaIntfDown=ospfAreaIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumRxDatabase=ospfCumRxDatabase, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgState=ripNewCfgState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgState=ripCurCfgState, ripStatInErrorPkts=ripStatInErrorPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStatInPkts=ripStatInPkts, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfStats=ospfStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCfg=ospfCfg, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfBackup=ospfIntfBackup, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOper=vrrpOper, ospfStartTime=ospfStartTime, ospfTotalNssaAreas=ospfTotalNssaAreas)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpStatMaxEntries=arpStatMaxEntries, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgDefListen=ripNewCfgDefListen, arpStatEntries=arpStatEntries, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoVLAN=arpInfoVLAN, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpGeneral=vrrpGeneral, ripConfig=ripConfig, ospfIntfNbrhello=ospfIntfNbrhello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfinfo=ospfinfo, ripNewCfgVip=ripNewCfgVip, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInFullState=ospfNbrInFullState, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routeStats=routeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSALinkData=routerLSALinkData, ipForward=ipForward, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxHello=ospfAreaRxHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfHello=ospfIntfHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpStats=vrrpStats, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoEntry=arpInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrp=vrrp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, iprouting=iprouting, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfTxPkts=ospfIntfTxPkts, ospfArea=ospfArea, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, dnsStats=dnsStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfLoop=ospfIntfLoop, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwTable=ipCurCfgGwTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests)
