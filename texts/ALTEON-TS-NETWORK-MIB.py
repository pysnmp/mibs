...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsReqs=ospfCumTxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfInterface=ospfInterface, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfDelete=ipNewCfgIntfDelete, iprouting=iprouting, ospfArea=ospfArea, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrStart=ospfCumNbrStart, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfHello=ospfCumIntfHello, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSALinkID=routerLSALinkID, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoId=ospfAreaInfoId, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgState=ripNewCfgState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoDestIp=arpInfoDestIp, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwState=ipCurCfgGwState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrp_info=vrrp_info, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoFlag=arpInfoFlag, arpStats=arpStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpGeneral=vrrpGeneral, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgListen=ripNewCfgListen, routeStatEntries=routeStatEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrhello=ospfCumNbrhello, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfInfoTable=ospfIntfInfoTable, ospfStartTime=ospfStartTime, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoEntry=arpInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxHello=ospfAreaRxHello, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCfg=ospfCfg, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfinfo=ospfinfo, ospfIfInfoIndex=ospfIfInfoIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ip_info=ip_info, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrStart=ospfAreaNbrStart, ipForward=ipForward, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSAId=routerLSAId, ospfGeneral=ospfGeneral, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwIndex=ipCurCfgGwIndex, routeStatHighWater=routeStatHighWater, ipRouteInfoType=ipRouteInfoType, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgSupply=ripCurCfgSupply, ripStatInPkts=ripStatInPkts, ipRouteInfoMask=ipRouteInfoMask, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfIndex=ospfIntfIndex, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfLoop=ospfIntfLoop, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, ripConfig=ripConfig, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfStats=ospfStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, routerLSAAreaIndex=routerLSAAreaIndex, ipInterfaceTableMax=ipInterfaceTableMax, routeStats=routeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStats=ripStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpStatHighWater=arpStatHighWater, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, dnsStats=dnsStats, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatEntries=arpStatEntries, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrDown=ospfCumNbrDown, vrrpStats=vrrpStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgState=ripCurCfgState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrp=vrrp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfTxHello=ospfIntfTxHello)
