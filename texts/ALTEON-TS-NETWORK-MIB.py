...
Gauge32, Counter64, iso, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Unsigned32, Counter32, Integer32, IpAddress, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "iso", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgState=ripCurCfgState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfGeneralStats=ospfGeneralStats, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfBackup=ospfIntfBackup, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStatHighWater=arpStatHighWater, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoVLAN=arpInfoVLAN, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, dnsStats=dnsStats, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, ripStatInPkts=ripStatInPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTxHello=ospfAreaTxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpStats=arpStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ripConfig=ripConfig, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoMask=ipRouteInfoMask, vrrp_info=vrrp_info, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpGeneral=vrrpGeneral, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfStartTime=ospfStartTime, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoFlag=arpInfoFlag, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSAId=routerLSAId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfinfo=ospfinfo, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIfInfoIndex=ospfIfInfoIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfTable=ipNewCfgIntfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routeStats=routeStats, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoDestIp=arpInfoDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkData=routerLSALinkData, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNbrInFullState=ospfNbrInFullState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfArea=ospfArea, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgState=ripNewCfgState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumRxHello=ospfCumRxHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, routeStatEntries=routeStatEntries, ospfCumNbrhello=ospfCumNbrhello, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCfg=ospfCfg, vrrpOper=vrrpOper, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrp=vrrp, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipForward=ipForward, ospfInterface=ospfInterface, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneral=ospfGeneral, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgState=ipFwdCurCfgState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpStats=vrrpStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoTable=arpInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTotalNeighbours=ospfTotalNeighbours, ip_info=ip_info, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoEntry=arpInfoEntry, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgVip=ripCurCfgVip, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfStats=ospfStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, iprouting=iprouting, arpStatEntries=arpStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipRouteInfoTag=ipRouteInfoTag, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgVip=ripNewCfgVip, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSALinkID=routerLSALinkID, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv)
