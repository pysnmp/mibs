...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkData=routerLSALinkData, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpOper=vrrpOper, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfBackup=ospfIntfBackup, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgListen=ripCurCfgListen, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgState=ipFwdCurCfgState, arpInfoEntry=arpInfoEntry, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneral=ospfGeneral, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routeStats=routeStats, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgState=ripCurCfgState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStatOutPkts=ripStatOutPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routeStatHighWater=routeStatHighWater, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfStartTime=ospfStartTime, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxHello=ospfCumRxHello, ripConfig=ripConfig, arpStatMaxEntries=arpStatMaxEntries, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwRetry=ipNewCfgGwRetry, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwAddr=ipNewCfgGwAddr, routeStatMaxEntries=routeStatMaxEntries, vrrp=vrrp, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaRxHello=ospfAreaRxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfBackup=ospfCumIntfBackup, ripStats=ripStats, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfStats=ospfStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoIndx=ipRouteInfoIndx, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpStatHighWater=arpStatHighWater, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSAId=routerLSAId, ospfIntfTxHello=ospfIntfTxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfInterface=ospfInterface, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfIndex=ospfIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgState=ipFwdNewCfgState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfDown=ospfIntfDown, routerLSALinkID=routerLSALinkID, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfLoop=ospfAreaIntfLoop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipForward=ipForward, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxHello=ospfCumTxHello, vrrpStats=vrrpStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfArea=ospfArea, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, arpStatEntries=arpStatEntries, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoFlag=arpInfoFlag, ospfGeneralStats=ospfGeneralStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoVLAN=arpInfoVLAN, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumTxlsAcks=ospfCumTxlsAcks, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgVip=ripNewCfgVip, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfinfo=ospfinfo, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgSupply=ripCurCfgSupply, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routeStatEntries=routeStatEntries, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrhello=ospfIntfNbrhello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrp_info=vrrp_info, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, iprouting=iprouting, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpStats=arpStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxPkts=ospfCumRxPkts, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ip_info=ip_info, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwState=ipCurCfgGwState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTotalAreas=ospfTotalAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgSupply=ripNewCfgSupply, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxDatabase=ospfCumRxDatabase)
