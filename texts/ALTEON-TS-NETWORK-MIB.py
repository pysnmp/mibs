...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCfg=ospfCfg, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoTable=arpInfoTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfBackup=ospfIntfBackup, ospfNbrInFullState=ospfNbrInFullState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSALinkID=routerLSALinkID, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfMask=ipCurCfgIntfMask, ip_info=ip_info, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfStartTime=ospfStartTime, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfIndex=ospfIntfIndex, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routeStatEntries=routeStatEntries, ripCurCfgState=ripCurCfgState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrChange=ospfIntfNbrChange, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpStatInAdvers=vrrpStatInAdvers, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatHighWater=arpStatHighWater, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStats=ripStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStats=arpStats, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaTxDatabase=ospfAreaTxDatabase, ipForward=ipForward, vrrpOper=vrrpOper, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoIndx=ipRouteInfoIndx, routeStats=routeStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, dnsStats=dnsStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpGeneral=vrrpGeneral, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfLoop=ospfIntfLoop, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoFlag=arpInfoFlag, ospfIntfHello=ospfIntfHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneralInfo=ospfGeneralInfo, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfArea=ospfArea, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routeStatHighWater=routeStatHighWater, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStatEntries=arpStatEntries, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrDown=ospfCumNbrDown, ospfCumRxHello=ospfCumRxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrp_info=vrrp_info, ospfAreaRxDatabase=ospfAreaRxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoMacAddr=arpInfoMacAddr, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ospfCumTxDatabase=ospfCumTxDatabase, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgVip=ripCurCfgVip, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwState=ipNewCfgGwState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrp=vrrp, ospfStats=ospfStats, arpInfoSrcPort=arpInfoSrcPort, ripStatInPkts=ripStatInPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSAAreaIndex=routerLSAAreaIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNbrInExchState=ospfNbrInExchState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfHello=ospfAreaIntfHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgDefListen=ripNewCfgDefListen, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfinfo=ospfinfo, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumRxPkts=ospfCumRxPkts, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripNewCfgSupply=ripNewCfgSupply, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrhello=ospfAreaNbrhello, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfInterface=ospfInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwRetry=ipCurCfgGwRetry, iprouting=iprouting, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripConfig=ripConfig, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, arpInfoEntry=arpInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc)
