...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfDown=ospfIntfDown, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoTable=arpInfoTable, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipForward=ipForward, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaInfoTable=ospfAreaInfoTable, arpInfoEntry=arpInfoEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfInterface=ospfInterface, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxTxStats=ospfCumRxTxStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routeStats=routeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrp=vrrp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoType=ipRouteInfoType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoVLAN=arpInfoVLAN, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxHello=ospfCumTxHello, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkData=routerLSALinkData, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSAId=routerLSAId, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripStats=ripStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgGwState=ipCurCfgGwState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routeStatHighWater=routeStatHighWater, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoMask=ipRouteInfoMask, arpInfoMacAddr=arpInfoMacAddr, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgState=ripNewCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrDown=ospfAreaNbrDown, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxHello=ospfCumRxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxHello=ospfAreaRxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoDestIp=arpInfoDestIp, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgBootpState=ipCurCfgBootpState, arpStats=arpStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxPkts=ospfCumTxPkts, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfArea=ospfArea, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCfg=ospfCfg, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfStats=ospfStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaChangeStats=ospfAreaChangeStats, ripConfig=ripConfig, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgDefListen=ripNewCfgDefListen, ospfTotalNeighbours=ospfTotalNeighbours, ip_info=ip_info, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgState=ripCurCfgState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpInfoFlag=arpInfoFlag, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfinfo=ospfinfo, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfIndex=ospfIntfIndex, dnsStats=dnsStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, arpStatHighWater=arpStatHighWater, vrrp_info=vrrp_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfStartTime=ospfStartTime, ospfGeneralStats=ospfGeneralStats, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfGeneral=ospfGeneral, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgListen=ripCurCfgListen)
