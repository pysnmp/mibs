...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxlsReqs=ospfCumRxlsReqs, ripConfig=ripConfig, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoType=ipRouteInfoType, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStats=vrrpStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routeStatHighWater=routeStatHighWater, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfStartTime=ospfStartTime, ospfAreaRxHello=ospfAreaRxHello, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatOutPkts=ripStatOutPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoTable=arpInfoTable, arpStatHighWater=arpStatHighWater, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routeStatEntries=routeStatEntries, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ip_info=ip_info, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ospfIntfHello=ospfIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgState=ripNewCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoMask=ipRouteInfoMask, vrrp_info=vrrp_info, ospfinfo=ospfinfo, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIfInfoIndex=ospfIfInfoIndex, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSALinkData=routerLSALinkData, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxPkts=ospfIntfTxPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoEntry=arpInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStats=ripStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfChangeStats=ospfIntfChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoTable=ospfAreaInfoTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgSupply=ripNewCfgSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStats=arpStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumRxHello=ospfCumRxHello, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgVip=ripCurCfgVip, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrStart=ospfAreaNbrStart, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipForward=ipForward, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNbrInFullState=ospfNbrInFullState, ripCurCfgState=ripCurCfgState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTotalNssaAreas=ospfTotalNssaAreas, ripStatInPkts=ripStatInPkts, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routeStats=routeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfStats=ospfStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTotalAreas=ospfTotalAreas, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrStart=ospfIntfNbrStart, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, routerLSALinkID=routerLSALinkID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, dnsStats=dnsStats, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpStatMaxEntries=arpStatMaxEntries, vrrp=vrrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, iprouting=iprouting, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSAId=routerLSAId, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpGeneral=vrrpGeneral, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfArea=ospfArea, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoFlag=arpInfoFlag, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfIndex=ospfIntfIndex, ospfCfg=ospfCfg, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgVip=ripNewCfgVip, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoIndex=ospfAreaInfoIndex)
