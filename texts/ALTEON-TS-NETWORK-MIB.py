...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routerLSAId=routerLSAId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgState=ripNewCfgState, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoVLAN=arpInfoVLAN, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripCurCfgState=ripCurCfgState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripStatOutPkts=ripStatOutPkts, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStats=arpStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfBackup=ospfIntfBackup, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTotalAreas=ospfTotalAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCfg=ospfCfg, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStatHighWater=arpStatHighWater, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfGeneral=ospfGeneral, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoTable=ospfAreaInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrp_info=vrrp_info, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfDown=ospfIntfDown, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoTable=arpInfoTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfArea=ospfArea, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfIndex=ospfIntfIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpGeneral=vrrpGeneral, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSALinkData=routerLSALinkData, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTotalNeighbours=ospfTotalNeighbours, ip_info=ip_info, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfHello=ospfIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrp=vrrp, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatInErrorPkts=ripStatInErrorPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNbrInFullState=ospfNbrInFullState, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, iprouting=iprouting, ospfIntfNbrStart=ospfIntfNbrStart, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpInfoRefPorts=arpInfoRefPorts, ripStats=ripStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkID=routerLSALinkID, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStats=ospfStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpOper=vrrpOper, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSALinkIndex=routerLSALinkIndex, ripConfig=ripConfig, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpInfoSrcPort=arpInfoSrcPort, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfStartTime=ospfStartTime, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwArp=ipNewCfgGwArp, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoMacAddr=arpInfoMacAddr, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStatInPkts=ripStatInPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoGateway=ipRouteInfoGateway, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipForward=ipForward, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoTag=ipRouteInfoTag, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxHello=ospfCumRxHello, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routeStatEntries=routeStatEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfInterface=ospfInterface, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrDown=ospfCumNbrDown, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxTxStats=ospfAreaRxTxStats, routeStatHighWater=routeStatHighWater, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStats=vrrpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfinfo=ospfinfo, arpStatEntries=arpStatEntries, dnsStats=dnsStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgListen=ripNewCfgListen, ospfIntfTxHello=ospfIntfTxHello, ospfCumRxDatabase=ospfCumRxDatabase, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoType=ipRouteInfoType, arpInfoEntry=arpInfoEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoMask=ipRouteInfoMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex)
