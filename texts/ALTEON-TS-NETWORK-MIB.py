...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfGeneralStats=ospfGeneralStats, ripStats=ripStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxHello=ospfAreaTxHello, ripNewCfgSupply=ripNewCfgSupply, arpStats=arpStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSALinkData=routerLSALinkData, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxHello=ospfCumTxHello, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrN1way=ospfCumNbrN1way, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSAId=routerLSAId, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfDown=ospfIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipForward=ipForward, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfHello=ospfIntfHello, ripStatInErrorPkts=ripStatInErrorPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfProcessUptime=ospfProcessUptime, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, routerLSALinkIndex=routerLSALinkIndex, routerLSALinkID=routerLSALinkID, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, iprouting=iprouting, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routeStats=routeStats, ospfAreaInfoId=ospfAreaInfoId, ripConfig=ripConfig, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrStart=ospfAreaNbrStart, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrp=vrrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, dnsStats=dnsStats, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpStatHighWater=arpStatHighWater, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpOper=vrrpOper, ospfinfo=ospfinfo, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgListen=ripNewCfgListen, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpStatEntries=arpStatEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, routeStatHighWater=routeStatHighWater, ospfAreaInfoTable=ospfAreaInfoTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoType=ipRouteInfoType, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfState=ipNewCfgIntfState, routeStatEntries=routeStatEntries, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgState=ripNewCfgState, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripStatOutPkts=ripStatOutPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxPkts=ospfCumTxPkts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrp_info=vrrp_info, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpInfoFlag=arpInfoFlag, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgState=ripCurCfgState, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNbrInExchState=ospfNbrInExchState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfInterface=ospfInterface, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpGeneral=vrrpGeneral, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripStatInPkts=ripStatInPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, arpStatMaxEntries=arpStatMaxEntries, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInFullState=ospfNbrInFullState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ip_info=ip_info, arpInfoTable=arpInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTotalAreas=ospfTotalAreas, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfStartTime=ospfStartTime, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfIndex=ospfIntfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs)
