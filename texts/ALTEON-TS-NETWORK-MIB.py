...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfStartTime=ospfStartTime, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrhello=ospfCumNbrhello, arpInfoEntry=arpInfoEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrp=vrrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoTable=arpInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumRxTxStats=ospfCumRxTxStats, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwTable=ipNewCfgGwTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ip_info=ip_info, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfInfoTable=ospfIntfInfoTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripStats=ripStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpStats=vrrpStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfStats=ospfStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrp_info=vrrp_info, ospfIntfRxPkts=ospfIntfRxPkts, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfTxHello=ospfIntfTxHello, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrStart=ospfIntfNbrStart, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripStatOutPkts=ripStatOutPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgState=ripNewCfgState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfBackup=ospfAreaIntfBackup, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCfg=ospfCfg, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfBackup=ospfIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfIndex=ospfIntfIndex, vrrpGeneral=vrrpGeneral, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgState=ipFwdCurCfgState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, dnsStats=dnsStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkID=routerLSALinkID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfDown=ospfIntfDown, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats, ipRouteInfoType=ipRouteInfoType, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripConfig=ripConfig, ripNewCfgVip=ripNewCfgVip, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStatHighWater=arpStatHighWater, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpStats=arpStats, ipRouteInfoTag=ipRouteInfoTag, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routeStats=routeStats, ipForward=ipForward, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgSupply=ripNewCfgSupply, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfHello=ospfIntfHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoMask=ipRouteInfoMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, iprouting=iprouting, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrDown=ospfCumNbrDown, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaChangeStats=ospfAreaChangeStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfInterface=ospfInterface, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routerLSAId=routerLSAId, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfLoop=ospfIntfLoop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrDown=ospfAreaNbrDown, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrStart=ospfAreaNbrStart, ospfinfo=ospfinfo, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInInitState=ospfNbrInInitState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgVip=ripCurCfgVip, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSALinkIndex=routerLSALinkIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumRxPkts=ospfCumRxPkts, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoFlag=arpInfoFlag, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOper=vrrpOper, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfArea=ospfArea, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex)
