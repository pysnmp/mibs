...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoTable=ipRouteInfoTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfState=ipNewCfgIntfState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfinfo=ospfinfo, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatEntries=arpStatEntries, ospfCumRxDatabase=ospfCumRxDatabase, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpStats=vrrpStats, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStatHighWater=routeStatHighWater, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoVLAN=arpInfoVLAN, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ripStats=ripStats, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgState=ripNewCfgState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpGeneral=vrrpGeneral, vrrp_info=vrrp_info, ospfIntfBackup=ospfIntfBackup, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfLoop=ospfIntfLoop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripConfig=ripConfig, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoDestIp=arpInfoDestIp, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOper=vrrpOper, ospfIntfTxPkts=ospfIntfTxPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrp=vrrp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpStatMaxEntries=arpStatMaxEntries, ospfArea=ospfArea, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routeStats=routeStats, ospfIfInfoIndex=ospfIfInfoIndex, arpStats=arpStats, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTotalAreas=ospfTotalAreas, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoIndx=ipRouteInfoIndx, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgListen=ripNewCfgListen, ospfCumNbrDown=ospfCumNbrDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfProcessUptime=ospfProcessUptime, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoType=ipRouteInfoType, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrStart=ospfIntfNbrStart, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwMetric=ipCurCfgGwMetric, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoRefPorts=arpInfoRefPorts, ospfStats=ospfStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatHighWater=arpStatHighWater)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfDown=ospfIntfDown, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ip_info=ip_info, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpInfoTable=arpInfoTable, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipForward=ipForward, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrStart=ospfCumNbrStart, ospfStartTime=ospfStartTime, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgState=ipFwdNewCfgState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfInterface=ospfInterface, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxPkts=ospfCumTxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgState=ripCurCfgState, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkData=routerLSALinkData, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoFlag=arpInfoFlag, ospfCumRxTxStats=ospfCumRxTxStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routeStatEntries=routeStatEntries, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfChangeStats=ospfIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoEntry=arpInfoEntry, ospfCfg=ospfCfg, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, iprouting=iprouting, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxHello=ospfAreaRxHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfState=ipCurCfgIntfState, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfIndex=ospfIntfIndex)
