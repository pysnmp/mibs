...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, routeStatEntries=routeStatEntries, arpInfoRefPorts=arpInfoRefPorts, ospfinfo=ospfinfo, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgState=ipFwdCurCfgState, ripStatInPkts=ripStatInPkts, routerLSALinkID=routerLSALinkID, iprouting=iprouting, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoTable=ipRouteInfoTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfLsTypesSupported=ospfLsTypesSupported, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStatOutPkts=ripStatOutPkts, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripNewCfgVip=ripNewCfgVip, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfInterface=ospfInterface, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoType=ipRouteInfoType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxPkts=ospfAreaRxPkts, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkData=routerLSALinkData, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routeStatHighWater=routeStatHighWater, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfGeneralStats=ospfGeneralStats, dnsStats=dnsStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgListen=ripNewCfgListen, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatHighWater=arpStatHighWater, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpGeneral=vrrpGeneral, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfDown=ospfIntfDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfUnloop=ospfIntfUnloop, arpInfoEntry=arpInfoEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoVLAN=arpInfoVLAN, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ip_info=ip_info, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfStartTime=ospfStartTime, ospfNbrInExchState=ospfNbrInExchState, arpStatEntries=arpStatEntries, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoTag=ipRouteInfoTag, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrp_info=vrrp_info)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaId=ospfCurCfgAreaId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpInfoTable=arpInfoTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxDatabase=ospfIntfTxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCfg=ospfCfg, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStats=ripStats, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgState=ripCurCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgVip=ripCurCfgVip, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrp=vrrp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfInfoIndex=ospfIfInfoIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumTxPkts=ospfCumTxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneral=ospfGeneral, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripConfig=ripConfig, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfCountForRouter=ospfIntfCountForRouter, ripCurCfgDefListen=ripCurCfgDefListen, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgBootpState=ipCurCfgBootpState, arpStats=arpStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfStats=ospfStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOper=vrrpOper, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfHello=ospfIntfHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfArea=ospfArea, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxPkts=ospfAreaTxPkts, vrrpStats=vrrpStats, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routeStats=routeStats, ospfIntfTxHello=ospfIntfTxHello, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrDown=ospfCumNbrDown, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfBackup=ospfIntfBackup, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipForward=ipForward, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics)
