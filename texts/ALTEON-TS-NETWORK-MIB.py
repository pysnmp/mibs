...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpStatEntries=arpStatEntries, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipForward=ipForward, routerLSAId=routerLSAId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStats=ripStats, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoTag=ipRouteInfoTag, ipGatewayTableMax=ipGatewayTableMax, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfInterface=ospfInterface, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgState=ripNewCfgState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, arpInfoSrcPort=arpInfoSrcPort, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfState=ipCurCfgIntfState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrp=vrrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoType=ipRouteInfoType, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripConfig=ripConfig, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrp_info=vrrp_info, ipNewCfgGwTable=ipNewCfgGwTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfArea=ospfArea, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoTable=ipRouteInfoTable, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoEntry=arpInfoEntry, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ospfCfg=ospfCfg, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoTable=arpInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routeStatMaxEntries=routeStatMaxEntries, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpGeneral=vrrpGeneral, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrhello=ospfIntfNbrhello, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxHello=ospfCumTxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfBackup=ospfIntfBackup, ospfGeneral=ospfGeneral, arpInfoFlag=arpInfoFlag, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfHello=ospfIntfHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgBootpState=ipNewCfgBootpState, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpInfoDestIp=arpInfoDestIp, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routeStats=routeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfTotalAreas=ospfTotalAreas, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgVip=ripCurCfgVip)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrN1way=ospfIntfNbrN1way, ip_info=ip_info, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfProcessUptime=ospfProcessUptime, ospfCumNbrStart=ospfCumNbrStart, ospfCumRxHello=ospfCumRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfStats=ospfStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfinfo=ospfinfo, vrrpStats=vrrpStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaTxPkts=ospfAreaTxPkts, ripStatRoutesAgedOut=ripStatRoutesAgedOut, dnsStats=dnsStats, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfTable=ipCurCfgIntfTable, routeStatEntries=routeStatEntries, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkID=routerLSALinkID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwState=ipNewCfgGwState, ospfIntfTxHello=ospfIntfTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOper=vrrpOper, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxHello=ospfIntfRxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgSupply=ripCurCfgSupply, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers)
