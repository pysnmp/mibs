...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoTable=arpInfoTable, ospfNbrInFullState=ospfNbrInFullState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgState=ipFwdCurCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpInfoFlag=arpInfoFlag, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfArea=ospfArea, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routeStatEntries=routeStatEntries, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoDestIp=arpInfoDestIp, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpStatMaxEntries=arpStatMaxEntries, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxDatabase=ospfCumTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, routerLSALinkID=routerLSALinkID, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoMacAddr=arpInfoMacAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpOper=vrrpOper, dnsStats=dnsStats, ripNewCfgVip=ripNewCfgVip, ospfGeneral=ospfGeneral, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgVip=ripCurCfgVip, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTotalAreas=ospfTotalAreas, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStats=arpStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoTable=ospfAreaInfoTable, routeStats=routeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfLoop=ospfIntfLoop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routeStatHighWater=routeStatHighWater, ospfCumNbrStart=ospfCumNbrStart, ospfIntfIndex=ospfIntfIndex, iprouting=iprouting, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripConfig=ripConfig, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgState=ripNewCfgState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSAId=routerLSAId, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStats=ripStats, ospfGeneralInfo=ospfGeneralInfo, arpInfoRefPorts=arpInfoRefPorts, routerLSALinkIfIndex=routerLSALinkIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgState=ripCurCfgState, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgSupply=ripNewCfgSupply, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipForward=ipForward, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfStats=ospfStats, arpStatHighWater=arpStatHighWater, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ip_info=ip_info, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSAAreaIndex=routerLSAAreaIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfDown=ospfIntfDown, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxHello=ospfAreaRxHello, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrp=vrrp, ospfinfo=ospfinfo, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgDefListen=ripCurCfgDefListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCfg=ospfCfg, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfInterface=ospfInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrp_info=vrrp_info, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgListen=ripCurCfgListen, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoEntry=arpInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpGeneral=vrrpGeneral, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpStatEntries=arpStatEntries, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState)
