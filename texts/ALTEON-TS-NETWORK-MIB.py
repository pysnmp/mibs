...
ObjectIdentity, Integer32, Bits, Gauge32, Counter64, ModuleIdentity, iso, MibIdentifier, NotificationType, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Bits", "Gauge32", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routeStats=routeStats, ospfinfo=ospfinfo, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ip_info=ip_info, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgVip=ripNewCfgVip, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripConfig=ripConfig, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, iprouting=iprouting, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfStartTime=ospfStartTime, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpGeneral=vrrpGeneral, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipGatewayTableMax=ipGatewayTableMax, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfHello=ospfIntfHello, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTotalAreas=ospfTotalAreas, routeStatEntries=routeStatEntries, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfArea=ospfArea, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgListen=ripNewCfgListen, ipForward=ipForward, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumIntfDown=ospfCumIntfDown, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, dnsStats=dnsStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripStatInPkts=ripStatInPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxHello=ospfIntfTxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpStats=arpStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfInterface=ospfInterface, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfDown=ospfIntfDown, ospfCumRxDatabase=ospfCumRxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOper=vrrpOper, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCfg=ospfCfg, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoType=ipRouteInfoType, ripNewCfgSupply=ripNewCfgSupply, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStats=ripStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfIndex=ipCurCfgIntfIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoMacAddr=arpInfoMacAddr, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpStatHighWater=arpStatHighWater, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxPkts=ospfCumTxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrp_info=vrrp_info, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, routerLSAId=routerLSAId, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripStatOutPkts=ripStatOutPkts, ospfCumIntfBackup=ospfCumIntfBackup, arpStatEntries=arpStatEntries, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfStats=ospfStats, ipRouteInfoTable=ipRouteInfoTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNbrInFullState=ospfNbrInFullState, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfGeneralStats=ospfGeneralStats, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSALinkData=routerLSALinkData, vrrpStats=vrrpStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp=vrrp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfWaitInterval=ospfIfWaitInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrhello=ospfCumNbrhello, ipInterfaceTableMax=ipInterfaceTableMax, ospfTimersKickOffStats=ospfTimersKickOffStats, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoIndx=ipRouteInfoIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoVLAN=arpInfoVLAN, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex)
