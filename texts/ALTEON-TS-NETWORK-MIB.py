...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOper=vrrpOper, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCfg=ospfCfg, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpStatEntries=arpStatEntries, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routeStats=routeStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfGeneral=ospfGeneral, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoTag=ipRouteInfoTag, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrBadSequence=ospfCumNbrBadSequence, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoEntry=ipRouteInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfStartTime=ospfStartTime, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfInterface=ospfInterface, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfDown=ospfIntfDown, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfUnloop=ospfIntfUnloop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStats=arpStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxHello=ospfCumRxHello, ripCurCfgState=ripCurCfgState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSALinkData=routerLSALinkData, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpStats=vrrpStats, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIfInfoIndex=ospfIfInfoIndex, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfGeneralInfo=ospfGeneralInfo, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumIntfLoop=ospfCumIntfLoop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routerLSALinkID=routerLSALinkID, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrp=vrrp, dnsStats=dnsStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ip_info=ip_info, ipForward=ipForward, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoEntry=arpInfoEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripStats=ripStats, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoMacAddr=arpInfoMacAddr, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxPkts=ospfAreaTxPkts, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrStart=ospfIntfNbrStart, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwState=ipNewCfgGwState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoTable=arpInfoTable, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrhello=ospfAreaNbrhello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrp_info=vrrp_info, arpStatHighWater=arpStatHighWater, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoVLAN=arpInfoVLAN, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStatInPkts=ripStatInPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoType=ipRouteInfoType, arpStatMaxEntries=arpStatMaxEntries, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfDown=ospfCumIntfDown, routerLSALinkIndex=routerLSALinkIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfGeneralStats=ospfGeneralStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfBackup=ospfIntfBackup, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoTable=ipRouteInfoTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfStats=ospfStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpGeneral=vrrpGeneral, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfArea=ospfArea, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgSupply=ripCurCfgSupply, ospfTotalAreas=ospfTotalAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfinfo=ospfinfo, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, iprouting=iprouting, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID)
