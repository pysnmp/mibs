...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwState=ipCurCfgGwState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, ripStatInPkts=ripStatInPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfLoop=ospfIntfLoop, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStatEntries=arpStatEntries, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, iprouting=iprouting, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfHello=ospfIntfHello, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOper=vrrpOper, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoFlag=arpInfoFlag, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoEntry=arpInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrDown=ospfIntfNbrDown, routerLSALinkID=routerLSALinkID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpStatHighWater=arpStatHighWater, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfinfo=ospfinfo, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCfg=ospfCfg, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrDown=ospfCumNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfBackup=ospfIntfBackup, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfStats=ospfStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrStart=ospfIntfNbrStart, ospfArea=ospfArea, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgBootpState=ipNewCfgBootpState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxTxStats=ospfAreaRxTxStats, ipGatewayTableMax=ipGatewayTableMax, vrrp_info=vrrp_info, routeStatEntries=routeStatEntries, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipInterfaceTableMax=ipInterfaceTableMax, ospfIfWaitInterval=ospfIfWaitInterval, ospfTotalAreas=ospfTotalAreas, ripConfig=ripConfig, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipForward=ipForward, ospfAreaNbrN1way=ospfAreaNbrN1way, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routeStatHighWater=routeStatHighWater, vrrp=vrrp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfGeneral=ospfGeneral, ospfIntfDown=ospfIntfDown, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwTable=ipNewCfgGwTable, ripStatOutPkts=ripStatOutPkts, ospfLsTypesSupported=ospfLsTypesSupported, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgState=ripCurCfgState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgState=ripNewCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgState=ipFwdCurCfgState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ip_info=ip_info, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStats=dnsStats, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwInterval=ipCurCfgGwInterval, routeStatMaxEntries=routeStatMaxEntries, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, ospfGeneralStats=ospfGeneralStats, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routerLSAId=routerLSAId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStats=vrrpStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfProcessUptime=ospfProcessUptime, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgListen=ripCurCfgListen, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpStats=arpStats, ripNewCfgListen=ripNewCfgListen, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpInfoSrcPort=arpInfoSrcPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfDown=ospfCumIntfDown, arpInfoTable=arpInfoTable, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routeStats=routeStats, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2)
