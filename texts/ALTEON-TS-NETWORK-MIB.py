...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoTable=ipRouteInfoTable, ripStats=ripStats, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ip_info=ip_info, routerLSAId=routerLSAId, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTotalAreas=ospfTotalAreas, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrDown=ospfCumNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStatHighWater=arpStatHighWater, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwMetric=ipNewCfgGwMetric, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfInterface=ospfInterface, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoEntry=ipRouteInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwState=ipNewCfgGwState, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipForward=ipForward, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgState=ripCurCfgState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpStats=vrrpStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgBootpState=ipNewCfgBootpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpStatInAdvers=vrrpStatInAdvers, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoGateway=ipRouteInfoGateway, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSAAreaIndex=routerLSAAreaIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoTable=arpInfoTable, arpInfoSrcPort=arpInfoSrcPort, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgVip=ripCurCfgVip, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrp=vrrp, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoFlag=arpInfoFlag, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatEntries=arpStatEntries, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfGeneral=ospfGeneral, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routeStatEntries=routeStatEntries, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrhello=ospfCumNbrhello, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfStats=ospfStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSALinkID=routerLSALinkID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOper=vrrpOper, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoEntry=arpInfoEntry, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpStats=arpStats, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkData=routerLSALinkData, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfinfo=ospfinfo, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, dnsStats=dnsStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgGwArp=ipNewCfgGwArp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgVip=ripNewCfgVip, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfArea=ospfArea, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, iprouting=iprouting, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStats=routeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfHello=ospfIntfHello, ospfIntfTxHello=ospfIntfTxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgDefListen=ripNewCfgDefListen, routeStatHighWater=routeStatHighWater, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripConfig=ripConfig, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfLoop=ospfIntfLoop, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex)
