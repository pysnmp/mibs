...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfInterface=ospfInterface, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routeStatMaxEntries=routeStatMaxEntries, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSAAreaIndex=routerLSAAreaIndex, vrrp_info=vrrp_info, routeStatHighWater=routeStatHighWater, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxPkts=ospfAreaRxPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routeStats=routeStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpStats=arpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, arpStatEntries=arpStatEntries, ospfArea=ospfArea, ospfCumRxPkts=ospfCumRxPkts, ospfNbrInFullState=ospfNbrInFullState, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatHighWater=arpStatHighWater, ospfIntfRxHello=ospfIntfRxHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoIndx=ipRouteInfoIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwArp=ipCurCfgGwArp, routerLSAId=routerLSAId, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoTable=arpInfoTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfStartTime=ospfStartTime, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpInfoFlag=arpInfoFlag, ipNewCfgIntfState=ipNewCfgIntfState, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkID=routerLSALinkID, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfinfo=ospfinfo, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpStats=vrrpStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfLsTypesSupported=ospfLsTypesSupported, ospfStats=ospfStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfHello=ospfIntfHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgGwState=ipCurCfgGwState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumTxHello=ospfCumTxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgState=ripNewCfgState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfGeneral=ospfGeneral, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgVip=ripNewCfgVip, vrrp=vrrp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaInfoEntry=ospfAreaInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, ripConfig=ripConfig, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgState=ripCurCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ospfGeneralInfo=ospfGeneralInfo, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoMacAddr=arpInfoMacAddr, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpInfoEntry=arpInfoEntry, ipForward=ipForward, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripStats=ripStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, iprouting=iprouting, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgBootpState=ipNewCfgBootpState, ripStatInPkts=ripStatInPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ip_info=ip_info, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfIndex=ospfIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCfg=ospfCfg, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfGeneralStats=ospfGeneralStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSALinkData=routerLSALinkData, ipNewCfgIntfTable=ipNewCfgIntfTable)
