...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoMacAddr=arpInfoMacAddr, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfMask=ipNewCfgIntfMask, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgState=ripCurCfgState, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ip_info=ip_info, ospfArea=ospfArea, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipForward=ipForward, routerLSALinkData=routerLSALinkData, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routeStatHighWater=routeStatHighWater, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfStartTime=ospfStartTime, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfInfoIndex=ospfIfInfoIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgGwArp=ipCurCfgGwArp, arpStatHighWater=arpStatHighWater, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfProcessUptime=ospfProcessUptime, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, ospfNbrInInitState=ospfNbrInInitState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxPkts=ospfIntfTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripStatInPkts=ripStatInPkts, vrrpOper=vrrpOper, ospfCumTxHello=ospfCumTxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrp=vrrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoSrcPort=arpInfoSrcPort, ospfIntfHello=ospfIntfHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStats=routeStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrDown=ospfCumNbrDown, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, iprouting=iprouting, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfDown=ospfIntfDown, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxPkts=ospfAreaRxPkts, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfGeneralInfo=ospfGeneralInfo, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumRxlsAcks=ospfCumRxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripStatOutPkts=ripStatOutPkts, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgState=ipFwdCurCfgState, ripStatInErrorPkts=ripStatInErrorPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, routerLSAId=routerLSAId, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgDefListen=ripNewCfgDefListen, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStats=arpStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfStats=ospfStats, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoVLAN=arpInfoVLAN, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoTable=ipRouteInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpGeneral=vrrpGeneral, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgListen=ripCurCfgListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwTable=ipNewCfgGwTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStats=ripStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripConfig=ripConfig, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routerLSALinkID=routerLSALinkID, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSALinkIndex=routerLSALinkIndex, vrrp_info=vrrp_info, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwState=ipNewCfgGwState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, routerLSAAreaIndex=routerLSAAreaIndex, ospfinfo=ospfinfo, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrStart=ospfCumNbrStart, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoTable=arpInfoTable, ospfGeneral=ospfGeneral, ospfCumRxDatabase=ospfCumRxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, dnsStats=dnsStats, ipCurCfgGwTable=ipCurCfgGwTable, routeStatEntries=routeStatEntries, vrrpStats=vrrpStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgState=ripNewCfgState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc)
