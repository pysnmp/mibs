...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfDown=ospfCumIntfDown, ospfIntfHello=ospfIntfHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOper=vrrpOper, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfDown=ospfIntfDown, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaIntfDown=ospfAreaIntfDown, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routeStatEntries=routeStatEntries, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStats=vrrpStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfBackup=ospfIntfBackup, vrrp_info=vrrp_info, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgSupply=ripNewCfgSupply, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxDatabase=ospfAreaRxDatabase, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaTable=ospfCurCfgAreaTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfInterface=ospfInterface, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routeStats=routeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNbrInInitState=ospfNbrInInitState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwTable=ipNewCfgGwTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwIndex=ipNewCfgGwIndex, routerLSALinkID=routerLSALinkID, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoDestIp=arpInfoDestIp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfArea=ospfArea, ospfTotalNeighbours=ospfTotalNeighbours, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoId=ospfAreaInfoId, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrp=vrrp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrStart=ospfIntfNbrStart, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxPkts=ospfCumTxPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routeStatMaxEntries=routeStatMaxEntries, routerLSALinkIndex=routerLSALinkIndex, ripStatOutPkts=ripStatOutPkts, ospfCfg=ospfCfg, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwDelete=ipNewCfgGwDelete, ripConfig=ripConfig, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfLoop=ospfAreaIntfLoop, dnsStats=dnsStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ip_info=ip_info, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgState=ripNewCfgState, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSAId=routerLSAId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpStats=arpStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpGeneral=vrrpGeneral)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfGeneralStats=ospfGeneralStats, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfStats=ospfStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoRefPorts=arpInfoRefPorts, ipRouteInfoType=ipRouteInfoType, routerLSAAreaIndex=routerLSAAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxHello=ospfIntfTxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfGeneral=ospfGeneral, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpStatHighWater=arpStatHighWater, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripStatInPkts=ripStatInPkts, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoEntry=arpInfoEntry, ospfinfo=ospfinfo, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfStartTime=ospfStartTime, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgVip=ripCurCfgVip, iprouting=iprouting, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgSupply=ripCurCfgSupply, ipForward=ipForward, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoTable=arpInfoTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripStats=ripStats, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoFlag=arpInfoFlag, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID)
