...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfArea=ospfArea, arpStatMaxEntries=arpStatMaxEntries, ipGatewayTableMax=ipGatewayTableMax, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routeStatHighWater=routeStatHighWater, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfHello=ospfCumIntfHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgListen=ripCurCfgListen, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripConfig=ripConfig, ipRouteInfoEntry=ipRouteInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrDown=ospfCumNbrDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfTable=ipNewCfgIntfTable, dnsStats=dnsStats, arpInfoFlag=arpInfoFlag, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNbrInInitState=ospfNbrInInitState, ipForward=ipForward, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoVLAN=arpInfoVLAN, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfStartTime=ospfStartTime, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaTxHello=ospfAreaTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgState=ripCurCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfStats=ospfStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoTable=ipRouteInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoEntry=arpInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumTxHello=ospfCumTxHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSAId=routerLSAId, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCfg=ospfCfg, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routeStatEntries=routeStatEntries, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfGeneral=ospfGeneral, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoTable=arpInfoTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfDown=ospfIntfDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxPkts=ospfCumTxPkts, ripStatInPkts=ripStatInPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripCurCfgVip=ripCurCfgVip, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStats=routeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxDatabase=ospfCumTxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfGeneralStats=ospfGeneralStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoDestIp=arpInfoDestIp, ripNewCfgListen=ripNewCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, ospfinfo=ospfinfo, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfHello=ospfIntfHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumRxlsUpdates=ospfCumRxlsUpdates, iprouting=iprouting, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrp=vrrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpStatHighWater=arpStatHighWater, vrrp_info=vrrp_info, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpStats=arpStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpStatEntries=arpStatEntries, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgDefListen=ripCurCfgDefListen, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxHello=ospfAreaRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaInfoId=ospfAreaInfoId, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfInterface=ospfInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ip_info=ip_info, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxHello=ospfIntfRxHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpOper=vrrpOper, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTotalAreas=ospfTotalAreas, ospfAreaIntfDown=ospfAreaIntfDown, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripStats=ripStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx)
