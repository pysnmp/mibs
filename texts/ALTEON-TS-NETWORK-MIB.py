...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgSupply=ripNewCfgSupply, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoSrcPort=arpInfoSrcPort, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgVip=ripNewCfgVip, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfLoop=ospfIntfLoop, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoVLAN=arpInfoVLAN, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipForward=ipForward, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgState=ripNewCfgState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoTag=ipRouteInfoTag, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfInterface=ospfInterface, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpOper=vrrpOper, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfBackup=ospfIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumRxPkts=ospfCumRxPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoFlag=arpInfoFlag, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrp_info=vrrp_info, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStatOutPkts=ripStatOutPkts, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfDown=ospfIntfDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfStats=ospfStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, routeStats=routeStats, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfIndex=ospfIntfIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfStartTime=ospfStartTime, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSALinkData=routerLSALinkData, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNbrInInitState=ospfNbrInInitState, routerLSAId=routerLSAId, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgVip=ripCurCfgVip, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, routeStatEntries=routeStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatEntries=arpStatEntries, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, dnsStats=dnsStats, vrrpGeneral=vrrpGeneral, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrStart=ospfCumNbrStart, ripStatInPkts=ripStatInPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpStats=arpStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpStatMaxEntries=arpStatMaxEntries, vrrp=vrrp, arpInfoEntry=arpInfoEntry, ipRouteInfoDestIp=ipRouteInfoDestIp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgListen=ripNewCfgListen, ospfinfo=ospfinfo, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrhello=ospfIntfNbrhello, ipRouteInfoType=ipRouteInfoType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSALinkID=routerLSALinkID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfDown=ospfAreaIntfDown, routeStatMaxEntries=routeStatMaxEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ip_info=ip_info, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoMask=ipRouteInfoMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgBootpState=ipNewCfgBootpState, ipGatewayTableMax=ipGatewayTableMax, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfGeneral=ospfGeneral, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfBackup=ospfCumIntfBackup, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfArea=ospfArea, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpStats=vrrpStats, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaInfoEntry=ospfAreaInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripStats=ripStats, arpInfoMacAddr=arpInfoMacAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxPkts=ospfIntfRxPkts, ospfGeneralStats=ospfGeneralStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfLoop=ospfCumIntfLoop, iprouting=iprouting, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routeStatHighWater=routeStatHighWater, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripConfig=ripConfig, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwTable=ipCurCfgGwTable, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTxPkts=ospfAreaTxPkts, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCfg=ospfCfg, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfCountForRouter=ospfIntfCountForRouter, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxHello=ospfAreaRxHello, ospfIntfHello=ospfIntfHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoIndx=ipRouteInfoIndx)
