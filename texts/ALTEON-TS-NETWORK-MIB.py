...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfGeneralInfo=ospfGeneralInfo, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpStatOutAdvers=vrrpStatOutAdvers, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpStatHighWater=arpStatHighWater, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripStats=ripStats, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfIndex=ospfIntfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTotalNeighbours=ospfTotalNeighbours, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgState=ripNewCfgState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfHello=ospfIntfHello, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routerLSAId=routerLSAId, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfDown=ospfIntfDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStats=vrrpStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoEntry=arpInfoEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNbrInFullState=ospfNbrInFullState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalAreas=ospfTotalAreas, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStatEntries=routeStatEntries, arpInfoFlag=arpInfoFlag, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoMask=ipRouteInfoMask, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipForward=ipForward, ripStatInPkts=ripStatInPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfGeneralStats=ospfGeneralStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxHello=ospfAreaRxHello, ospfinfo=ospfinfo, ip_info=ip_info, arpInfoSrcPort=arpInfoSrcPort, ospfNbrInExchState=ospfNbrInExchState, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkData=routerLSALinkData, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routeStats=routeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfProcessUptime=ospfProcessUptime, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrp=vrrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, dnsStats=dnsStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgState=ripCurCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfMask=ipNewCfgIntfMask, ripConfig=ripConfig, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpGeneral=vrrpGeneral, arpStats=arpStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgListen=ripCurCfgListen, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrp_info=vrrp_info, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSALinkID=routerLSALinkID, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgVip=ripCurCfgVip, ripNewCfgListen=ripNewCfgListen, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routeStatHighWater=routeStatHighWater, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpOper=vrrpOper, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, iprouting=iprouting, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpInfoDestIp=arpInfoDestIp, ospfGeneral=ospfGeneral, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxHello=ospfCumRxHello, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCfg=ospfCfg, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStatOutPkts=ripStatOutPkts, ospfArea=ospfArea, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoTag=ipRouteInfoTag, ospfStats=ospfStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType)
