...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpGeneral=vrrpGeneral, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfUnloop=ospfIntfUnloop, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStatInPkts=ripStatInPkts, ospfNbrInExchState=ospfNbrInExchState, arpStatHighWater=arpStatHighWater, vrrpStats=vrrpStats, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, iprouting=iprouting, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfChangeStats=ospfIntfChangeStats, ospfGeneralStats=ospfGeneralStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfLoop=ospfIntfLoop, ospfIntfBackup=ospfIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSAId=routerLSAId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxDatabase=ospfAreaTxDatabase, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfDown=ospfCumIntfDown, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ip_info=ip_info, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxHello=ospfAreaTxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfinfo=ospfinfo, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoMask=ipRouteInfoMask, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrp_info=vrrp_info, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfStartTime=ospfStartTime, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfInterface=ospfInterface, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfIndex=ospfIntfIndex, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, dnsStats=dnsStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfHello=ospfIntfHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routeStatEntries=routeStatEntries, ripCurCfgState=ripCurCfgState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwState=ipNewCfgGwState, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfDown=ospfIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxPkts=ospfCumTxPkts, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoType=ipRouteInfoType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStatMaxEntries=arpStatMaxEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCfg=ospfCfg, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoGateway=ipRouteInfoGateway, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfStats=ospfStats, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoVLAN=arpInfoVLAN, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfGeneral=ospfGeneral, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrhello=ospfIntfNbrhello, arpStats=arpStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOper=vrrpOper, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgListen=ripNewCfgListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfProcessUptime=ospfProcessUptime, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStats=ripStats, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoTag=ipRouteInfoTag, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSALinkID=routerLSALinkID, ospfCumRxTxStats=ospfCumRxTxStats, ospfArea=ospfArea, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSALinkIndex=routerLSALinkIndex, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoTable=arpInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgVip=ripCurCfgVip, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipForward=ipForward, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routerLSALinkData=routerLSALinkData, ipNewCfgGwEntry=ipNewCfgGwEntry, arpInfoDestIp=arpInfoDestIp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrStart=ospfCumNbrStart, vrrp=vrrp, ripStatInErrorPkts=ripStatInErrorPkts, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalNssaAreas=ospfTotalNssaAreas, arpStatEntries=arpStatEntries, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc)
