...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaInfoTable=ospfAreaInfoTable, ripConfig=ripConfig, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoTable=arpInfoTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrp=vrrp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripNewCfgState=ripNewCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfTxPkts=ospfIntfTxPkts, ripStatOutPkts=ripStatOutPkts, ospfCumTxPkts=ospfCumTxPkts, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, dnsStats=dnsStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrhello=ospfIntfNbrhello, routerLSALinkID=routerLSALinkID, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpStats=vrrpStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfinfo=ospfinfo, ipNewCfgGwTable=ipNewCfgGwTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfDown=ospfIntfDown, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrDown=ospfCumNbrDown, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrp_info=vrrp_info, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSAAreaIndex=routerLSAAreaIndex, ipRouteInfoTable=ipRouteInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStats=routeStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfInterface=ospfInterface, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoIndx=ipRouteInfoIndx, ospfCfg=ospfCfg, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripStats=ripStats, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpStats=arpStats, routeStatHighWater=routeStatHighWater, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpStatHighWater=arpStatHighWater, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOper=vrrpOper, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatInPkts=ripStatInPkts, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxPkts=ospfAreaRxPkts, ip_info=ip_info, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipForward=ipForward, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaInfoId=ospfAreaInfoId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoVLAN=arpInfoVLAN, ospfCumTxDatabase=ospfCumTxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfArea=ospfArea, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfHello=ospfCumIntfHello, ospfStartTime=ospfStartTime, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfLoop=ospfIntfLoop, ripCurCfgVip=ripCurCfgVip, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, routeStatEntries=routeStatEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwArp=ipCurCfgGwArp, iprouting=iprouting, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoType=ipRouteInfoType, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrN1way=ospfCumNbrN1way, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfProcessUptime=ospfProcessUptime, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTotalAreas=ospfTotalAreas, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTxPkts=ospfAreaTxPkts, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNbrInFullState=ospfNbrInFullState, arpStatEntries=arpStatEntries, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgState=ripCurCfgState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoFlag=arpInfoFlag, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry)
