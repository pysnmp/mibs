...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfArea=ospfArea, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfStartTime=ospfStartTime, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoTable=ipRouteInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCfg=ospfCfg, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, iprouting=iprouting, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfProcessUptime=ospfProcessUptime, arpStats=arpStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoDestIp=arpInfoDestIp, ospfIntfIndex=ospfIntfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, dnsStats=dnsStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxTxStats=ospfCumRxTxStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfUnloop=ospfIntfUnloop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpInfoRefPorts=arpInfoRefPorts, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalAreas=ospfTotalAreas, ripCurCfgState=ripCurCfgState, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoFlag=arpInfoFlag, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripConfig=ripConfig, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatMaxEntries=routeStatMaxEntries, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfinfo=ospfinfo, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgDefListen=ripNewCfgDefListen, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInInitState=ospfNbrInInitState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpGeneral=vrrpGeneral, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrp_info=vrrp_info, arpStatHighWater=arpStatHighWater, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ip_info=ip_info, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxHello=ospfAreaRxHello, ospfGeneral=ospfGeneral, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routeStatEntries=routeStatEntries, ripNewCfgState=ripNewCfgState, ipCurCfgIntfAddr=ipCurCfgIntfAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routeStatHighWater=routeStatHighWater, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfHello=ospfCumIntfHello, ospfStats=ospfStats, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routerLSAId=routerLSAId, ospfGeneralInfo=ospfGeneralInfo, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrDown=ospfCumNbrDown, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpInfoEntry=arpInfoEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgState=ipFwdNewCfgState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatInErrorPkts=ripStatInErrorPkts, ospfNbrInExchState=ospfNbrInExchState, arpInfoSrcPort=arpInfoSrcPort, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoMask=ipRouteInfoMask, routerLSALinkID=routerLSALinkID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripStatInPkts=ripStatInPkts, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfChangeStats=ospfIntfChangeStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfLoop=ospfIntfLoop, vrrpStats=vrrpStats, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgStaticSupply=ripNewCfgStaticSupply, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfHello=ospfIntfHello, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaTxHello=ospfAreaTxHello, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStats=ripStats, ospfInterface=ospfInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrp=vrrp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfBackup=ospfIntfBackup, ospfIntfCountForRouter=ospfIntfCountForRouter, routeStats=routeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoTable=arpInfoTable, arpInfoVLAN=arpInfoVLAN, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase)
