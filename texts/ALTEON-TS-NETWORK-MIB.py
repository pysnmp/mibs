...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoFlag=arpInfoFlag, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfDown=ospfIntfDown, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfGeneralStats=ospfGeneralStats, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, routeStatMaxEntries=routeStatMaxEntries, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfinfo=ospfinfo, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaId=ospfNewCfgAreaId, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripConfig=ripConfig, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric, ipGatewayTableMax=ipGatewayTableMax, ospfStartTime=ospfStartTime, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routeStats=routeStats, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfHello=ospfCumIntfHello, ripStats=ripStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwRetry=ipNewCfgGwRetry, iprouting=iprouting, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgState=ripNewCfgState, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpInfoDestIp=arpInfoDestIp, ospfArea=ospfArea, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrp=vrrp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoSrcPort=arpInfoSrcPort, ospfCumRxPkts=ospfCumRxPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpStats=arpStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStats=vrrpStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgVip=ripNewCfgVip, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfInterface=ospfInterface, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSALinkData=routerLSALinkData, ospfIntfBackup=ospfIntfBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpOper=vrrpOper, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipForward=ipForward, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpGeneral=vrrpGeneral, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwEntry=ipCurCfgGwEntry, ip_info=ip_info, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfProcessUptime=ospfProcessUptime, routerLSAId=routerLSAId, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoEntry=ipRouteInfoEntry, ospfNbrInExchState=ospfNbrInExchState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumRxTxStats=ospfCumRxTxStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpStatEntries=arpStatEntries, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrhello=ospfIntfNbrhello, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoInterface=ipRouteInfoInterface, ospfCfg=ospfCfg, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgState=ripCurCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaRxHello=ospfAreaRxHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfHello=ospfAreaIntfHello, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoTag=ipRouteInfoTag, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStatInPkts=ripStatInPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNbrInInitState=ospfNbrInInitState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkID=routerLSALinkID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfHello=ospfIntfHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfStats=ospfStats, vrrp_info=vrrp_info, ipRouteInfoTable=ipRouteInfoTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfGeneral=ospfGeneral, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfInfoEntry=ospfIntfInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgVip=ripCurCfgVip, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete)
