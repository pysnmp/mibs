...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCfg=ospfCfg, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgVip=ripCurCfgVip, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenState=vrrpNewCfgGenState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwState=ipNewCfgGwState, ospfNbrInFullState=ospfNbrInFullState, ripCurCfgState=ripCurCfgState, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrp_info=vrrp_info, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrp=vrrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpStatOutAdvers=vrrpStatOutAdvers, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfArea=ospfArea, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripStats=ripStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpStatEntries=arpStatEntries, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrChange=ospfIntfNbrChange, ipGatewayTableMax=ipGatewayTableMax, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxHello=ospfCumTxHello, ospfIfInfoIndex=ospfIfInfoIndex, ospfinfo=ospfinfo, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfStartTime=ospfStartTime, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxDatabase=ospfIntfTxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStatMaxEntries=routeStatMaxEntries, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAId=routerLSAId, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfDown=ospfIntfDown, ripCurCfgSupply=ripCurCfgSupply, ip_info=ip_info, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfLoop=ospfIntfLoop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaTxHello=ospfAreaTxHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpGeneral=vrrpGeneral, ospfTotalTransitAreas=ospfTotalTransitAreas)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfStats=ospfStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoTable=arpInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfInterface=ospfInterface, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ripStatInPkts=ripStatInPkts, vrrpOper=vrrpOper, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkData=routerLSALinkData, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoEntry=arpInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpStats=arpStats, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, iprouting=iprouting, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStats=routeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrDown=ospfCumNbrDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxlsReqs=ospfCumTxlsReqs, routeStatHighWater=routeStatHighWater, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxTxStats=ospfCumRxTxStats, ipForward=ipForward, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgState=ipFwdNewCfgState, ripNewCfgState=ripNewCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpStats=vrrpStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoType=ipRouteInfoType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripConfig=ripConfig, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, dnsStats=dnsStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc)
