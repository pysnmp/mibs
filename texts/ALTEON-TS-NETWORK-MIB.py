...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxDatabase=ospfCumRxDatabase, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripConfig=ripConfig, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoFlag=arpInfoFlag, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoRefPorts=arpInfoRefPorts, ospfNbrInInitState=ospfNbrInInitState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfState=ipCurCfgIntfState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenState=vrrpCurCfgGenState, ripNewCfgState=ripNewCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStats=routeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, iprouting=iprouting, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, dnsStats=dnsStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaTxPkts=ospfAreaTxPkts, ospfInterface=ospfInterface, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoEntry=ipRouteInfoEntry, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfArea=ospfArea, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrDown=ospfCumNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaTxDatabase=ospfAreaTxDatabase, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ip_info=ip_info, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpStats=vrrpStats, ospfStartTime=ospfStartTime, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStatEntries=arpStatEntries, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoTable=arpInfoTable, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwArp=ipCurCfgGwArp, routeStatEntries=routeStatEntries, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAId=routerLSAId, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfStats=ospfStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgSupply=ripNewCfgSupply, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoVLAN=arpInfoVLAN, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoDestIp=arpInfoDestIp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoEntry=arpInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCfg=ospfCfg, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxHello=ospfCumRxHello, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpOper=vrrpOper, ipInterfaceTableMax=ipInterfaceTableMax, vrrpGeneral=vrrpGeneral, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfinfo=ospfinfo, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoType=ipRouteInfoType, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpStats=arpStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgState=ipFwdNewCfgState, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfGeneral=ospfGeneral, ospfAreaNbrN1way=ospfAreaNbrN1way, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfHello=ospfIntfHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrp=vrrp, ripNewCfgVip=ripNewCfgVip, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxTxStats=ospfCumRxTxStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrp_info=vrrp_info, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStats=ripStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkData=routerLSALinkData, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipForward=ipForward, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStatInAdvers=vrrpStatInAdvers)
