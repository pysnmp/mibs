...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStatMaxEntries=arpStatMaxEntries, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpStatHighWater=arpStatHighWater, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfStats=ospfStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpStats=arpStats, routerLSALinkID=routerLSALinkID, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfHello=ospfCumIntfHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStats=ripStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrp=vrrp, ripNewCfgState=ripNewCfgState, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStats=routeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ip_info=ip_info, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfBackup=ospfIntfBackup, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, ipForward=ipForward, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoTable=arpInfoTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipGatewayTableMax=ipGatewayTableMax, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrStart=ospfIntfNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoEntry=arpInfoEntry, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoType=ipRouteInfoType, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfInterface=ospfInterface, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfLoop=ospfIntfLoop, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripNewCfgSupply=ripNewCfgSupply, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumTxPkts=ospfCumTxPkts, vrrpGeneral=vrrpGeneral, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfHello=ospfIntfHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpStats=vrrpStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSALinkData=routerLSALinkData, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumTxDatabase=ospfCumTxDatabase, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStatEntries=routeStatEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfArea=ospfArea, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgVip=ripNewCfgVip, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalAreas=ospfTotalAreas, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoVLAN=arpInfoVLAN, ripCurCfgState=ripCurCfgState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfinfo=ospfinfo, ospfCfg=ospfCfg, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrhello=ospfCumNbrhello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, dnsStats=dnsStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOper=vrrpOper, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgBootpState=ipNewCfgBootpState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumRxHello=ospfCumRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfGeneral=ospfGeneral, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgListen=ripNewCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfDown=ospfAreaIntfDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoMacAddr=arpInfoMacAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgListen=ripCurCfgListen, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, vrrp_info=vrrp_info, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoFlag=arpInfoFlag, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStatOutPkts=ripStatOutPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfProcessUptime=ospfProcessUptime, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripConfig=ripConfig, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSAId=routerLSAId, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfIndex=ospfIntfIndex)
