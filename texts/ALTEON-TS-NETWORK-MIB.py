...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfDown=ospfCumIntfDown, vrrp=vrrp, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfArea=ospfArea, dnsStats=dnsStats, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpStatOutAdvers=vrrpStatOutAdvers, ripStatOutPkts=ripStatOutPkts, routeStatEntries=routeStatEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfStartTime=ospfStartTime, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaInfoId=ospfAreaInfoId, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfIndex=ospfIntfIndex, ripNewCfgState=ripNewCfgState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgListen=ripCurCfgListen, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxPkts=ospfCumRxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpStats=vrrpStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxHello=ospfIntfTxHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkID=routerLSALinkID, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatEntries=arpStatEntries, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStats=arpStats, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrRstAd=ospfCumNbrRstAd, routeStats=routeStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxPkts=ospfIntfRxPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrp_info=vrrp_info, arpStatHighWater=arpStatHighWater, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNbrInFullState=ospfNbrInFullState, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripConfig=ripConfig, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfinfo=ospfinfo, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgState=ripCurCfgState, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwMetric=ipCurCfgGwMetric, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfUnloop=ospfCumIntfUnloop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, iprouting=iprouting, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ip_info=ip_info, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSAId=routerLSAId, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrhello=ospfAreaNbrhello, ospfStats=ospfStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfLoop=ospfIntfLoop, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfGeneralStats=ospfGeneralStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipForward=ipForward, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgState=ipFwdNewCfgState, ripNewCfgListen=ripNewCfgListen, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfHello=ospfIntfHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoTable=arpInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTotalAreas=ospfTotalAreas, routerLSALinkIndex=routerLSALinkIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfDown=ospfIntfDown, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoType=ipRouteInfoType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoInterface=ipRouteInfoInterface, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routeStatHighWater=routeStatHighWater, ospfIntfNbrStart=ospfIntfNbrStart, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfUnloop=ospfIntfUnloop, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpGeneral=vrrpGeneral, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfInterface=ospfInterface, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfGeneral=ospfGeneral, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumTxDatabase=ospfCumTxDatabase, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStatInPkts=ripStatInPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfState=ipCurCfgIntfState, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgGwArp=ipNewCfgGwArp)
