...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdCurCfgState=ipFwdCurCfgState, ipForward=ipForward, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoEntry=ipRouteInfoEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxDatabase=ospfIntfTxDatabase, arpStatHighWater=arpStatHighWater, arpInfoTable=arpInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoGateway=ipRouteInfoGateway, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumIntfHello=ospfCumIntfHello, ospfGeneral=ospfGeneral, ospfStats=ospfStats, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfNbrInInitState=ospfNbrInInitState, ospfIntfHello=ospfIntfHello, ospfAreaTxPkts=ospfAreaTxPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwState=ipNewCfgGwState, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routeStats=routeStats, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfIndex=ospfIntfIndex, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrN1way=ospfCumNbrN1way, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumRxHello=ospfCumRxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCfg=ospfCfg, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoTable=ipRouteInfoTable, ospfCumIntfDown=ospfCumIntfDown, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoType=ipRouteInfoType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfBackup=ospfIntfBackup, ripCurCfgSupply=ripCurCfgSupply, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routeStatHighWater=routeStatHighWater, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoFlag=arpInfoFlag, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfDown=ospfIntfDown, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoIndx=ipRouteInfoIndx, vrrpStats=vrrpStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, ipGatewayTableMax=ipGatewayTableMax, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoDestIp=arpInfoDestIp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrp=vrrp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfLoop=ospfIntfLoop, ospfInterface=ospfInterface, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgSupply=ripNewCfgSupply, routerLSALinkID=routerLSALinkID, vrrp_info=vrrp_info, arpStats=arpStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStats=ripStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrhello=ospfCumNbrhello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxPkts=ospfCumTxPkts, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStatEntries=arpStatEntries, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ip_info=ip_info, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripNewCfgState=ripNewCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfState=ipNewCfgIntfState, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsAcks=ospfIntfTxlsAcks, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwState=ipCurCfgGwState, routerLSALinkData=routerLSALinkData, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoRefPorts=arpInfoRefPorts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfArea=ospfArea, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpOper=vrrpOper, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSAId=routerLSAId, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfStartTime=ospfStartTime, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfProcessUptime=ospfProcessUptime, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripConfig=ripConfig, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpGeneral=vrrpGeneral)
