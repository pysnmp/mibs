...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxHello=ospfIntfRxHello, arpStatEntries=arpStatEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkID=routerLSALinkID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routeStatHighWater=routeStatHighWater, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfState=ipCurCfgIntfState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOper=vrrpOper, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, iprouting=iprouting, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwTable=ipNewCfgGwTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrp=vrrp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNbrInFullState=ospfNbrInFullState, ripCurCfgState=ripCurCfgState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoTable=ipRouteInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoEntry=arpInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgVip=ripCurCfgVip, ospfAreaChangeStats=ospfAreaChangeStats, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routerLSAId=routerLSAId, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgListen=ripNewCfgListen, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatInErrorPkts=ripStatInErrorPkts, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTxHello=ospfAreaTxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoIndx=ipRouteInfoIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxDatabase=ospfAreaTxDatabase, ripStats=ripStats, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfGeneral=ospfGeneral, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ip_info=ip_info, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routeStats=routeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfIndex=ospfIntfIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripConfig=ripConfig, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, arpStatMaxEntries=arpStatMaxEntries, routerLSALinkData=routerLSALinkData, arpInfoVLAN=arpInfoVLAN, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStats=dnsStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpStatHighWater=arpStatHighWater, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwAddr=ipNewCfgGwAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfHello=ospfIntfHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipRouteInfoMask=ipRouteInfoMask, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoDestIp=arpInfoDestIp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfStartTime=ospfStartTime, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfStats=ospfStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoType=ipRouteInfoType, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgVip=ripNewCfgVip, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfGeneralInfo=ospfGeneralInfo, ospfArea=ospfArea, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfBackup=ospfIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfLsTypesSupported=ospfLsTypesSupported, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpGeneral=vrrpGeneral, vrrp_info=vrrp_info, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatMaxEntries=routeStatMaxEntries, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoSrcPort=arpInfoSrcPort, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrStart=ospfCumNbrStart, ipForward=ipForward, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpStats=arpStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwState=ipNewCfgGwState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfinfo=ospfinfo, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxHello=ospfCumRxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCfg=ospfCfg, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer)
