...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoEntry=arpInfoEntry, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStats=ripStats, vrrp_info=vrrp_info, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfTxPkts=ospfIntfTxPkts, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpInfoTable=arpInfoTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrhello=ospfIntfNbrhello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgState=ripNewCfgState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripStatInPkts=ripStatInPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfGeneralStats=ospfGeneralStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfGeneral=ospfGeneral, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfLoop=ospfIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ip_info=ip_info, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrStart=ospfAreaNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routeStatHighWater=routeStatHighWater, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routeStats=routeStats, routerLSAId=routerLSAId, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpInfoVLAN=arpInfoVLAN, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTotalAreas=ospfTotalAreas, routerLSALinkID=routerLSALinkID, ospfAreaRxHello=ospfAreaRxHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipGatewayTableMax=ipGatewayTableMax, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipRouteInfoInterface=ipRouteInfoInterface, ospfProcessUptime=ospfProcessUptime, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipRouteInfoIndx=ipRouteInfoIndx, ipForward=ipForward, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCfg=ospfCfg, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgState=ripCurCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgListen=ripNewCfgListen, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripStatOutPkts=ripStatOutPkts, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxPkts=ospfIntfRxPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfStartTime=ospfStartTime, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumTxHello=ospfCumTxHello, arpStatEntries=arpStatEntries, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrp=vrrp, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNbrInFullState=ospfNbrInFullState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfInterface=ospfInterface, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, routerLSALinkData=routerLSALinkData, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrN1way=ospfCumNbrN1way, ospfinfo=ospfinfo, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfDown=ospfIntfDown, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNbrInExchState=ospfNbrInExchState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfHello=ospfIntfHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfMask=ipCurCfgIntfMask, ripConfig=ripConfig, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfArea=ospfArea, ipFwdNewCfgPortState=ipFwdNewCfgPortState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoType=ipRouteInfoType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgVip=ripNewCfgVip, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc)
