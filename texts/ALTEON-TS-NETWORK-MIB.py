...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfHello=ospfIntfHello, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwState=ipNewCfgGwState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfLoop=ospfCumIntfLoop, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStatOutPkts=ripStatOutPkts, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStats=ripStats, ospfTotalAreas=ospfTotalAreas, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, iprouting=iprouting, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpStatEntries=arpStatEntries, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgBootpState=ipNewCfgBootpState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwState=ipCurCfgGwState, ospfProcessUptime=ospfProcessUptime, ripNewCfgDefListen=ripNewCfgDefListen, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, routeStatHighWater=routeStatHighWater, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSAId=routerLSAId, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipForward=ipForward, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpInfoVLAN=arpInfoVLAN, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkID=routerLSALinkID, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfArea=ospfArea, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpStats=arpStats, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpStatHighWater=arpStatHighWater, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfInterface=ospfInterface, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrp_info=vrrp_info, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfGeneral=ospfGeneral, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfinfo=ospfinfo, vrrpStats=vrrpStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ip_info=ip_info, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOper=vrrpOper, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrp=vrrp, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSAAreaIndex=routerLSAAreaIndex, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrhello=ospfCumNbrhello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumTxlsReqs=ospfCumTxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfWaitTimer=ospfIntfWaitTimer, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkData=routerLSALinkData, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, routeStatEntries=routeStatEntries, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrhello=ospfAreaNbrhello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxDatabase=ospfCumTxDatabase, ospfStats=ospfStats, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgState=ripNewCfgState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfTxHello=ospfIntfTxHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfStartTime=ospfStartTime, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxlsAcks=ospfCumRxlsAcks, dnsStats=dnsStats, vrrpGeneral=vrrpGeneral, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgVip=ripCurCfgVip, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfLoop=ospfAreaIntfLoop, arpInfoEntry=arpInfoEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripConfig=ripConfig, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgState=ripCurCfgState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoMacAddr=arpInfoMacAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfIndex=ospfIntfIndex, ospfGeneralStats=ospfGeneralStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routeStats=routeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf)
