...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNbrInExchState=ospfNbrInExchState, ip_info=ip_info, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatInPkts=ripStatInPkts, vrrpGeneral=vrrpGeneral, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxHello=ospfCumRxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfStartTime=ospfStartTime, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOper=vrrpOper, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfGeneralStats=ospfGeneralStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxHello=ospfCumTxHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStats=ripStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoRefPorts=arpInfoRefPorts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgListen=ripNewCfgListen, dnsStats=dnsStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxPkts=ospfAreaTxPkts, ospfCfg=ospfCfg, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumTxDatabase=ospfCumTxDatabase, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTotalAreas=ospfTotalAreas, ospfNbrInInitState=ospfNbrInInitState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgListen=ripCurCfgListen, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipForward=ipForward, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfArea=ospfArea, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoEntry=ipRouteInfoEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routeStats=routeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfDown=ospfIntfDown, arpStats=arpStats, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routeStatMaxEntries=routeStatMaxEntries, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoFlag=arpInfoFlag, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfHello=ospfIntfHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, iprouting=iprouting, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfProcessUptime=ospfProcessUptime, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfDown=ospfCumIntfDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpStats=vrrpStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenState=vrrpNewCfgGenState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaInfoId=ospfAreaInfoId, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfinfo=ospfinfo, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfGeneral=ospfGeneral, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNbrInFullState=ospfNbrInFullState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoTable=arpInfoTable, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfInterface=ospfInterface, routerLSALinkID=routerLSALinkID, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrp=vrrp, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSAId=routerLSAId, ripNewCfgState=ripNewCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxDatabase=ospfCumRxDatabase, arpStatEntries=arpStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripConfig=ripConfig, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwTable=ipNewCfgGwTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpStatHighWater=arpStatHighWater, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwAddr=ipCurCfgGwAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipRouteInfoIndx=ipRouteInfoIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routeStatEntries=routeStatEntries, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrChange=ospfIntfNbrChange)
