...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfState=ipCurCfgIntfState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwMetric=ipNewCfgGwMetric, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfHello=ospfIntfHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoGateway=ipRouteInfoGateway, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxPkts=ospfCumRxPkts, arpStatHighWater=arpStatHighWater, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgListen=ripNewCfgListen, ospfStartTime=ospfStartTime, vrrpStats=vrrpStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgVip=ripCurCfgVip, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfinfo=ospfinfo, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripStats=ripStats, dnsStats=dnsStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOper=vrrpOper, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpStatEntries=arpStatEntries, iprouting=iprouting, ipRouteInfoType=ipRouteInfoType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ip_info=ip_info, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfGeneralInfo=ospfGeneralInfo, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfInterface=ospfInterface, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfUnloop=ospfIntfUnloop, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwIndex=ipNewCfgGwIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpGeneral=vrrpGeneral, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfTable=ipNewCfgIntfTable, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgState=ripCurCfgState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrStart=ospfAreaNbrStart, routeStats=routeStats, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSAId=routerLSAId, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, ospfAreaIntfDown=ospfAreaIntfDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipForward=ipForward, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSALinkID=routerLSALinkID, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpStats=arpStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxDatabase=ospfIntfRxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfLoop=ospfIntfLoop, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgState=ripNewCfgState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoTable=arpInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCfg=ospfCfg, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatHighWater=routeStatHighWater, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoId=ospfAreaInfoId, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfHello=ospfCumIntfHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, arpInfoDestIp=arpInfoDestIp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwArp=ipCurCfgGwArp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfGeneralStats=ospfGeneralStats, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfArea=ospfArea, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxHello=ospfCumTxHello, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrp=vrrp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoTable=ipRouteInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatInAdvers=vrrpStatInAdvers, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoEntry=arpInfoEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfBackup=ospfCumIntfBackup, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfStats=ospfStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc)
