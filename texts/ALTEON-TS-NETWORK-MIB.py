...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoTable=ipRouteInfoTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgListen=ripCurCfgListen, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripConfig=ripConfig, ospfIntfNbrhello=ospfIntfNbrhello, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ip_info=ip_info, vrrpNewCfgGenState=vrrpNewCfgGenState, iprouting=iprouting, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrp_info=vrrp_info, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaInfoId=ospfAreaInfoId, ospfCumTxPkts=ospfCumTxPkts, ospfStartTime=ospfStartTime, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwState=ipCurCfgGwState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpStats=vrrpStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoFlag=arpInfoFlag, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfHello=ospfIntfHello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routeStatHighWater=routeStatHighWater, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, dnsStats=dnsStats, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpStatHighWater=arpStatHighWater, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfGeneral=ospfGeneral, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSALinkData=routerLSALinkData, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwTable=ipNewCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfGeneralStats=ospfGeneralStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoEntry=arpInfoEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripStatInPkts=ripStatInPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpGeneral=vrrpGeneral, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfBackup=ospfIntfBackup, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStats=arpStats, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatOutPkts=ripStatOutPkts, ripNewCfgState=ripNewCfgState, ospfAreaRxHello=ospfAreaRxHello, ospfInterface=ospfInterface, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrhello=ospfCumNbrhello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgVip=ripNewCfgVip, ipForward=ipForward, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgState=ipFwdCurCfgState, routeStatEntries=routeStatEntries, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routerLSAId=routerLSAId, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoEntry=ipRouteInfoEntry, vrrpOper=vrrpOper, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgGwState=ipNewCfgGwState, ospfIntfDown=ospfIntfDown, ospfCumIntfDown=ospfCumIntfDown, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfLoop=ospfCumIntfLoop, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripStats=ripStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNbrInFullState=ospfNbrInFullState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxHello=ospfCumTxHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoTable=arpInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrStart=ospfCumNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoDestIp=arpInfoDestIp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCfg=ospfCfg, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routerLSALinkIndex=routerLSALinkIndex, ospfArea=ospfArea, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripCurCfgState=ripCurCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrp=vrrp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfinfo=ospfinfo, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfStats=ospfStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrN1way=ospfCumNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoGateway=ipRouteInfoGateway, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx)
