...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgSupply=ripCurCfgSupply, routeStatEntries=routeStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfinfo=ospfinfo, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfArea=ospfArea, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOper=vrrpOper, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoTable=arpInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgVip=ripCurCfgVip, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgSupply=ripNewCfgSupply, iprouting=iprouting, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripConfig=ripConfig, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpStatEntries=arpStatEntries, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoTag=ipRouteInfoTag, ripStats=ripStats, arpStatHighWater=arpStatHighWater, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgState=ripNewCfgState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkIndex=routerLSALinkIndex, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ip_info=ip_info, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrStart=ospfIntfNbrStart, ripCurCfgListen=ripCurCfgListen, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfChangeStats=ospfIntfChangeStats, arpInfoFlag=arpInfoFlag, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfInterface=ospfInterface, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipInterfaceTableMax=ipInterfaceTableMax, ripStatInPkts=ripStatInPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfBackup=ospfIntfBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxHello=ospfCumTxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxPkts=ospfAreaTxPkts, routeStats=routeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatOutPkts=ripStatOutPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoType=ipRouteInfoType, vrrp=vrrp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoTable=ipRouteInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoEntry=arpInfoEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfHello=ospfIntfHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxHello=ospfIntfRxHello, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpStats=vrrpStats, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, dnsStats=dnsStats, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCfg=ospfCfg, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsAcks=ospfCumTxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrhello=ospfIntfNbrhello, ospfIfWaitInterval=ospfIfWaitInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSALinkData=routerLSALinkData, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxDatabase=ospfCumTxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpInfoSrcPort=arpInfoSrcPort, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoRefPorts=arpInfoRefPorts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenState=vrrpCurCfgGenState, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgState=ipFwdCurCfgState, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwState=ipNewCfgGwState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaInfoId=ospfAreaInfoId, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkID=routerLSALinkID, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpGeneral=vrrpGeneral, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipForward=ipForward, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routeStatHighWater=routeStatHighWater, ospfProcessUptime=ospfProcessUptime, ospfStats=ospfStats, ospfIntfUnloop=ospfIntfUnloop, ospfTotalNeighbours=ospfTotalNeighbours, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfHello=ospfAreaIntfHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNbrInExchState=ospfNbrInExchState, ospfGeneral=ospfGeneral, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrp_info=vrrp_info, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripCurCfgState=ripCurCfgState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership)
