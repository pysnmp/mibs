...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwRetry=ipNewCfgGwRetry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, iprouting=iprouting, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routeStatMaxEntries=routeStatMaxEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routeStatHighWater=routeStatHighWater, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumIntfHello=ospfCumIntfHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipGatewayTableMax=ipGatewayTableMax, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwArp=ipCurCfgGwArp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrp=vrrp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfStats=ospfStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpStatInAdvers=vrrpStatInAdvers, ripStatInPkts=ripStatInPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripStatOutPkts=ripStatOutPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoType=ipRouteInfoType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxlsAcks=ospfCumTxlsAcks, arpStats=arpStats, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxDatabase=ospfCumRxDatabase, ip_info=ip_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfHello=ospfIntfHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpStatEntries=arpStatEntries, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgState=ripNewCfgState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfDown=ospfIntfDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgState=ripCurCfgState, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoVLAN=arpInfoVLAN, arpInfoRefPorts=arpInfoRefPorts, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoTag=ipRouteInfoTag, vrrpOper=vrrpOper, ospfIntfRxTxStats=ospfIntfRxTxStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfDown=ospfCumIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpGeneral=vrrpGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrDown=ospfCumNbrDown, ospfIntfUnloop=ospfIntfUnloop)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfLoop=ospfIntfLoop, ospfCfg=ospfCfg, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgListen=ripNewCfgListen, ospfAreaRxHello=ospfAreaRxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routeStats=routeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxHello=ospfIntfRxHello, vrrp_info=vrrp_info, routerLSAAreaIndex=routerLSAAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStats=ripStats, ospfArea=ospfArea, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoIndx=ipRouteInfoIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSALinkID=routerLSALinkID, ospfStartTime=ospfStartTime, dnsStats=dnsStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwArp=ipNewCfgGwArp, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipForward=ipForward, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStats=vrrpStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripConfig=ripConfig, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfinfo=ospfinfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routeStatEntries=routeStatEntries, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfUnloop=ospfAreaIntfUnloop)
