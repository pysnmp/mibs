...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatEntries=arpStatEntries, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfDown=ospfAreaIntfDown, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOper=vrrpOper, ospfIntfNbrDown=ospfIntfNbrDown, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfDown=ospfIntfDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrDown=ospfAreaNbrDown, routeStats=routeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripStatInPkts=ripStatInPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxPkts=ospfAreaTxPkts, routerLSALinkID=routerLSALinkID, ipNewCfgIntfState=ipNewCfgIntfState, iprouting=iprouting, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgListen=ripNewCfgListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripCurCfgSupply=ripCurCfgSupply, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfStats=ospfStats, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgState=ripNewCfgState, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfStartTime=ospfStartTime, ripCurCfgListen=ripCurCfgListen, arpInfoTable=arpInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoFlag=arpInfoFlag, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoEntry=arpInfoEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ip_info=ip_info, ospfNbrInFullState=ospfNbrInFullState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoTag=ipRouteInfoTag, ospfCfg=ospfCfg, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routeStatEntries=routeStatEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxHello=ospfCumTxHello, arpInfoSrcPort=arpInfoSrcPort, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfinfo=ospfinfo, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripStats=ripStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoVLAN=arpInfoVLAN, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxPkts=ospfCumTxPkts, vrrp_info=vrrp_info, routeStatHighWater=routeStatHighWater, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoDestIp=arpInfoDestIp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, routerLSAId=routerLSAId, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwState=ipNewCfgGwState, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfGeneralStats=ospfGeneralStats, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfIndex=ospfIntfIndex, ospfCumRxHello=ospfCumRxHello, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgGwTable=ipNewCfgGwTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrp=vrrp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfBackup=ospfIntfBackup, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoTable=ipRouteInfoTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ripConfig=ripConfig, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfGeneral=ospfGeneral, ospfIfInfoIndex=ospfIfInfoIndex, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpGeneral=vrrpGeneral, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfInterface=ospfInterface, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgVip=ripCurCfgVip, ospfIntfHello=ospfIntfHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpStatHighWater=arpStatHighWater, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpInfoMacAddr=arpInfoMacAddr, ospfTotalAreas=ospfTotalAreas, ipForward=ipForward, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable)
