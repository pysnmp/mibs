...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:12:33 2022
...
Gauge32, Bits, Unsigned32, ModuleIdentity, Counter64, iso, Integer32, TimeTicks, Counter32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "Counter64", "iso", "Integer32", "TimeTicks", "Counter32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "ObjectIdentity")
StorageType, DisplayString, TimeInterval, TruthValue, MacAddress, TextualConvention, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "DisplayString", "TimeInterval", "TruthValue", "MacAddress", "TextualConvention", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpNodeVersion=vrrpNodeVersion, vrrpOperState=vrrpOperState, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpTrapProtoError=vrrpTrapProtoError, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpOperationsState=vrrpOperationsState, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperAdminState=vrrpOperAdminState, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperations=vrrpOperations, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpMIB=vrrpMIB, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperRowStatus=vrrpOperRowStatus, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperationsTable=vrrpOperationsTable, vrrpOperationsGroup=vrrpOperationsGroup, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpNotifications=vrrpNotifications, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperPriority=vrrpOperPriority, vrrpOperProtocol=vrrpOperProtocol, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperationsPriority=vrrpOperationsPriority, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperGroup=vrrpOperGroup, vrrpOperTable=vrrpOperTable, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, VrId=VrId, vrrpStatsGroup=vrrpStatsGroup, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperAuthType=vrrpOperAuthType, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpTrapGroup=vrrpTrapGroup, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpConformance=vrrpConformance, vrrpOperEntry=vrrpOperEntry, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpMIBCompliance=vrrpMIBCompliance, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpMIBCompliances=vrrpMIBCompliances, vrrpNotificationGroup=vrrpNotificationGroup, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, PYSNMP_MODULE_ID=vrrpMIB, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperationsVrId=vrrpOperationsVrId, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperAuthKey=vrrpOperAuthKey, vrrpMIBGroups=vrrpMIBGroups, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperVrId=vrrpOperVrId, vrrpStatistics=vrrpStatistics, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpOperationsAddrCount=vrrpOperationsAddrCount)
