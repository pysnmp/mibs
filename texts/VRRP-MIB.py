...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:12:58 2022
...
NotificationType, MibIdentifier, ModuleIdentity, Gauge32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, mib_2, ObjectIdentity, Unsigned32, Counter32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ModuleIdentity", "Gauge32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "mib-2", "ObjectIdentity", "Unsigned32", "Counter32", "Integer32", "Bits")
DisplayString, StorageType, TextualConvention, TimeStamp, RowStatus, TruthValue, TimeInterval, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "StorageType", "TextualConvention", "TimeStamp", "RowStatus", "TruthValue", "TimeInterval", "MacAddress")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpMIBCompliance=vrrpMIBCompliance, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperTable=vrrpOperTable, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpMIBGroups=vrrpMIBGroups, vrrpMIB=vrrpMIB, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperationsGroup=vrrpOperationsGroup, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpNodeVersion=vrrpNodeVersion, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperPriority=vrrpOperPriority, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpNotifications=vrrpNotifications, vrrpNotificationGroup=vrrpNotificationGroup, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpNewMasterReason=vrrpNewMasterReason, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperProtocol=vrrpOperProtocol, vrrpConformance=vrrpConformance, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpStatistics=vrrpStatistics, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperGroup=vrrpOperGroup, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpOperVrId=vrrpOperVrId, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperEntry=vrrpOperEntry, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpTrapGroup=vrrpTrapGroup, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpOperationsEntry=vrrpOperationsEntry, VrId=VrId, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpOperations=vrrpOperations, vrrpOperAuthType=vrrpOperAuthType, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperationsState=vrrpOperationsState, vrrpOperAdminState=vrrpOperAdminState, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperState=vrrpOperState, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpOperationsPriority=vrrpOperationsPriority, vrrpTrapProtoError=vrrpTrapProtoError, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperationsVrId=vrrpOperationsVrId, vrrpStatsGroup=vrrpStatsGroup, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpRouterVersionErrors=vrrpRouterVersionErrors, PYSNMP_MODULE_ID=vrrpMIB, vrrpOperationsTable=vrrpOperationsTable, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType)
