...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:04:32 2023
...
Integer32, Counter32, Unsigned32, Counter64, IpAddress, iso, Bits, TimeTicks, mib_2, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "Counter64", "IpAddress", "iso", "Bits", "TimeTicks", "mib-2", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Gauge32")
TimeInterval, StorageType, TruthValue, TextualConvention, RowStatus, TimeStamp, MacAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "StorageType", "TruthValue", "TextualConvention", "RowStatus", "TimeStamp", "MacAddress", "DisplayString")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperationsPriority=vrrpOperationsPriority, vrrpMIB=vrrpMIB, vrrpStatsGroup=vrrpStatsGroup, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpMIBGroups=vrrpMIBGroups, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpOperRowStatus=vrrpOperRowStatus, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperPriority=vrrpOperPriority, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpOperGroup=vrrpOperGroup, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpNodeVersion=vrrpNodeVersion, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperationsState=vrrpOperationsState, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperTable=vrrpOperTable, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperProtocol=vrrpOperProtocol, vrrpMIBCompliance=vrrpMIBCompliance, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperAuthType=vrrpOperAuthType, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpOperationsGroup=vrrpOperationsGroup, vrrpNotifications=vrrpNotifications, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, VrId=VrId, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperationsTable=vrrpOperationsTable, vrrpOperations=vrrpOperations, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperationsVrId=vrrpOperationsVrId, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperEntry=vrrpOperEntry, vrrpOperVrId=vrrpOperVrId, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperState=vrrpOperState, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatistics=vrrpStatistics, vrrpNotificationGroup=vrrpNotificationGroup, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, PYSNMP_MODULE_ID=vrrpMIB, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpConformance=vrrpConformance, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpTrapGroup=vrrpTrapGroup)
