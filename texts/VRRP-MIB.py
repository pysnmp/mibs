...
ModuleIdentity, ObjectIdentity, iso, mib_2, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Integer32, Counter32, Counter64, TimeTicks, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "iso", "mib-2", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Integer32", "Counter32", "Counter64", "TimeTicks", "Bits", "MibIdentifier")
TextualConvention, StorageType, TruthValue, TimeStamp, RowStatus, TimeInterval, DisplayString, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "StorageType", "TruthValue", "TimeStamp", "RowStatus", "TimeInterval", "DisplayString", "MacAddress")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperationsEntry=vrrpOperationsEntry, vrrpConformance=vrrpConformance, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperationsUpTime=vrrpOperationsUpTime, PYSNMP_MODULE_ID=vrrpMIB, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, VrId=VrId, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperationsState=vrrpOperationsState, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpMIBCompliances=vrrpMIBCompliances, vrrpStatistics=vrrpStatistics, vrrpTrapGroup=vrrpTrapGroup, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpNotificationGroup=vrrpNotificationGroup, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperGroup=vrrpOperGroup, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpOperRowStatus=vrrpOperRowStatus, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperationsTable=vrrpOperationsTable, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperAuthType=vrrpOperAuthType, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpStatsGroup=vrrpStatsGroup, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperState=vrrpOperState, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpMIBGroups=vrrpMIBGroups, vrrpTrapProtoError=vrrpTrapProtoError, vrrpNodeVersion=vrrpNodeVersion, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperEntry=vrrpOperEntry, vrrpOperations=vrrpOperations, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperPriority=vrrpOperPriority, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpOperTable=vrrpOperTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpMIB=vrrpMIB, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpMIBCompliance=vrrpMIBCompliance, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperVrId=vrrpOperVrId, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperationsVrId=vrrpOperationsVrId, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperAdminState=vrrpOperAdminState, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperProtocol=vrrpOperProtocol, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpNotifications=vrrpNotifications, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr)
