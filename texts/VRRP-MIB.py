...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:45:03 2022
...
MibIdentifier, Counter32, IpAddress, Bits, Unsigned32, NotificationType, iso, ModuleIdentity, Gauge32, ObjectIdentity, TimeTicks, Counter64, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "IpAddress", "Bits", "Unsigned32", "NotificationType", "iso", "ModuleIdentity", "Gauge32", "ObjectIdentity", "TimeTicks", "Counter64", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, TimeInterval, StorageType, TimeStamp, TextualConvention, MacAddress, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeInterval", "StorageType", "TimeStamp", "TextualConvention", "MacAddress", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpOperEntry=vrrpOperEntry, VrId=VrId, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpOperationsTable=vrrpOperationsTable, vrrpOperationsState=vrrpOperationsState, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperAuthKey=vrrpOperAuthKey, PYSNMP_MODULE_ID=vrrpMIB, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpNotificationGroup=vrrpNotificationGroup, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpNodeVersion=vrrpNodeVersion, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperAdminState=vrrpOperAdminState, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpTrapGroup=vrrpTrapGroup, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperRowStatus=vrrpOperRowStatus, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpMIB=vrrpMIB, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpOperationsPriority=vrrpOperationsPriority, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperTable=vrrpOperTable, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpNotifications=vrrpNotifications, vrrpStatsGroup=vrrpStatsGroup, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperVrId=vrrpOperVrId, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperPriority=vrrpOperPriority, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpOperationsGroup=vrrpOperationsGroup, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperProtocol=vrrpOperProtocol, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperAuthType=vrrpOperAuthType, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpMIBGroups=vrrpMIBGroups, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpMIBCompliance=vrrpMIBCompliance, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperState=vrrpOperState, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperationsVrId=vrrpOperationsVrId, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperations=vrrpOperations, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperGroup=vrrpOperGroup, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpStatistics=vrrpStatistics, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpConformance=vrrpConformance, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpRouterStatsEntry=vrrpRouterStatsEntry)
