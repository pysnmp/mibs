...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperAdminState=vrrpOperAdminState, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpMIB=vrrpMIB, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperationsVrId=vrrpOperationsVrId, VrId=VrId, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperEntry=vrrpOperEntry, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, PYSNMP_MODULE_ID=vrrpMIB, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpNotifications=vrrpNotifications, vrrpOperVrId=vrrpOperVrId, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperationsTable=vrrpOperationsTable, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatsGroup=vrrpStatsGroup, vrrpNodeVersion=vrrpNodeVersion, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpConformance=vrrpConformance, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperationsGroup=vrrpOperationsGroup, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpMIBCompliance=vrrpMIBCompliance, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpNewMasterReason=vrrpNewMasterReason, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperPriority=vrrpOperPriority, vrrpOperRowStatus=vrrpOperRowStatus, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperProtocol=vrrpOperProtocol, vrrpOperationsPriority=vrrpOperationsPriority, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpMIBGroups=vrrpMIBGroups, vrrpOperState=vrrpOperState, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatistics=vrrpStatistics, vrrpOperations=vrrpOperations, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpTrapGroup=vrrpTrapGroup, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpOperGroup=vrrpOperGroup, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperationsState=vrrpOperationsState, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperTable=vrrpOperTable, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperAuthType=vrrpOperAuthType, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster)
