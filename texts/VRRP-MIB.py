...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:29:32 2023
...
Integer32, Unsigned32, NotificationType, IpAddress, Counter64, Gauge32, ObjectIdentity, MibIdentifier, Counter32, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter32", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "iso")
RowStatus, MacAddress, TimeStamp, StorageType, TimeInterval, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TimeStamp", "StorageType", "TimeInterval", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperationsState=vrrpOperationsState, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperGroup=vrrpOperGroup, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperationsPriority=vrrpOperationsPriority, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpNotificationGroup=vrrpNotificationGroup, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpMIBCompliance=vrrpMIBCompliance, PYSNMP_MODULE_ID=vrrpMIB, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperAdminState=vrrpOperAdminState, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpOperationsVrId=vrrpOperationsVrId, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperProtocol=vrrpOperProtocol, vrrpOperations=vrrpOperations, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperPreemptMode=vrrpOperPreemptMode, VrId=VrId, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperAuthType=vrrpOperAuthType, vrrpMIB=vrrpMIB, vrrpNotificationCntl=vrrpNotificationCntl, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperPriority=vrrpOperPriority, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperationsGroup=vrrpOperationsGroup, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpNodeVersion=vrrpNodeVersion, vrrpOperVrId=vrrpOperVrId, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperState=vrrpOperState, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpOperEntry=vrrpOperEntry, vrrpNotifications=vrrpNotifications, vrrpOperationsTable=vrrpOperationsTable, vrrpTrapGroup=vrrpTrapGroup, vrrpMIBGroups=vrrpMIBGroups, vrrpStatistics=vrrpStatistics, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpMIBCompliances=vrrpMIBCompliances, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpStatsGroup=vrrpStatsGroup, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpConformance=vrrpConformance, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpTrapProtoError=vrrpTrapProtoError, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperTable=vrrpOperTable, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperationsRowStatus=vrrpOperationsRowStatus)
