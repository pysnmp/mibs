...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:45:55 2023
...
Integer32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, TimeTicks, iso, IpAddress, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "TimeTicks", "iso", "IpAddress", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Unsigned32", "NotificationType")
RowStatus, TruthValue, TimeInterval, TextualConvention, StorageType, MacAddress, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeInterval", "TextualConvention", "StorageType", "MacAddress", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpOperEntry=vrrpOperEntry, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperationsState=vrrpOperationsState, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, VrId=VrId, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpNotificationGroup=vrrpNotificationGroup, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperProtocol=vrrpOperProtocol, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperAdminState=vrrpOperAdminState, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpTrapGroup=vrrpTrapGroup, vrrpOperVrId=vrrpOperVrId, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperState=vrrpOperState, vrrpMIB=vrrpMIB, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpOperationsVrId=vrrpOperationsVrId, vrrpNotifications=vrrpNotifications, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpModuleFullCompliance=vrrpModuleFullCompliance, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperTable=vrrpOperTable, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpStatsGroup=vrrpStatsGroup, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpNotificationCntl=vrrpNotificationCntl, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperationsPriority=vrrpOperationsPriority, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperGroup=vrrpOperGroup, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpTrapProtoError=vrrpTrapProtoError, vrrpMIBCompliance=vrrpMIBCompliance, vrrpStatistics=vrrpStatistics, vrrpOperationsTable=vrrpOperationsTable, vrrpOperAuthType=vrrpOperAuthType, vrrpConformance=vrrpConformance, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperations=vrrpOperations, vrrpOperationsGroup=vrrpOperationsGroup, vrrpMIBGroups=vrrpMIBGroups, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperPriority=vrrpOperPriority, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors)
