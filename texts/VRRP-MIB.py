...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:52:33 2022
...
Counter64, Counter32, Unsigned32, mib_2, iso, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, IpAddress, TimeTicks, Gauge32, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "Unsigned32", "mib-2", "iso", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "IpAddress", "TimeTicks", "Gauge32", "Integer32", "ObjectIdentity")
TruthValue, DisplayString, StorageType, RowStatus, MacAddress, TimeInterval, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "StorageType", "RowStatus", "MacAddress", "TimeInterval", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, VrId=VrId, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpOperationsVrId=vrrpOperationsVrId, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperAdminState=vrrpOperAdminState, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperState=vrrpOperState, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpMIBGroups=vrrpMIBGroups, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperEntry=vrrpOperEntry, vrrpOperGroup=vrrpOperGroup, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperTable=vrrpOperTable, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperationsTable=vrrpOperationsTable, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperationsState=vrrpOperationsState, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatistics=vrrpStatistics, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpNotifications=vrrpNotifications, vrrpOperAuthType=vrrpOperAuthType, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperPriority=vrrpOperPriority, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpNotificationCntl=vrrpNotificationCntl, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpTrapGroup=vrrpTrapGroup, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperVrId=vrrpOperVrId, vrrpMIBCompliances=vrrpMIBCompliances, vrrpStatsGroup=vrrpStatsGroup, vrrpOperations=vrrpOperations, vrrpOperationsGroup=vrrpOperationsGroup, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpMIB=vrrpMIB, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpMIBCompliance=vrrpMIBCompliance, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperProtocol=vrrpOperProtocol, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpConformance=vrrpConformance)
