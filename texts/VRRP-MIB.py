...
# Produced by pysmi-1.1.12 at Mon Sep  9 09:49:53 2024
...
mib_2, NotificationType, ModuleIdentity, Integer32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, iso, Bits, Unsigned32, ObjectIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "ModuleIdentity", "Integer32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "iso", "Bits", "Unsigned32", "ObjectIdentity", "MibIdentifier", "IpAddress")
MacAddress, StorageType, TruthValue, TextualConvention, DisplayString, TimeStamp, TimeInterval, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "StorageType", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp", "TimeInterval", "RowStatus")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperEntry=vrrpOperEntry, vrrpStatistics=vrrpStatistics, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsTable=vrrpOperationsTable, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperAuthType=vrrpOperAuthType, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperProtocol=vrrpOperProtocol, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperPriority=vrrpOperPriority, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperationsState=vrrpOperationsState, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpConformance=vrrpConformance, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpOperTable=vrrpOperTable, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperAdminState=vrrpOperAdminState, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatsGroup=vrrpStatsGroup, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperGroup=vrrpOperGroup, vrrpOperationsVrId=vrrpOperationsVrId, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperState=vrrpOperState, vrrpOperationsUpTime=vrrpOperationsUpTime, PYSNMP_MODULE_ID=vrrpMIB, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpNotificationCntl=vrrpNotificationCntl, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpMIB=vrrpMIB, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpOperVrId=vrrpOperVrId, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, VrId=VrId, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpMIBGroups=vrrpMIBGroups, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpOperRowStatus=vrrpOperRowStatus, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpNotifications=vrrpNotifications, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperations=vrrpOperations, vrrpTrapGroup=vrrpTrapGroup, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpMIBCompliance=vrrpMIBCompliance, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpNewMasterReason=vrrpNewMasterReason)
