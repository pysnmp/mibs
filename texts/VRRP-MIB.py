...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:06:22 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, IpAddress, Counter32, Unsigned32, Counter64, iso, ObjectIdentity, MibIdentifier, Integer32, NotificationType, ModuleIdentity, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "IpAddress", "Counter32", "Unsigned32", "Counter64", "iso", "ObjectIdentity", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "Bits")
StorageType, TimeInterval, DisplayString, TextualConvention, MacAddress, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "TimeInterval", "DisplayString", "TextualConvention", "MacAddress", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpNotificationCntl=vrrpNotificationCntl, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpTrapGroup=vrrpTrapGroup, vrrpOperState=vrrpOperState, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpMIB=vrrpMIB, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpNodeVersion=vrrpNodeVersion, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperPriority=vrrpOperPriority, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpConformance=vrrpConformance, vrrpMIBCompliance=vrrpMIBCompliance, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperationsState=vrrpOperationsState, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperationsGroup=vrrpOperationsGroup, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperAuthKey=vrrpOperAuthKey, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperationsTable=vrrpOperationsTable, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, VrId=VrId, vrrpOperProtocol=vrrpOperProtocol, vrrpStatistics=vrrpStatistics, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpOperationsPriority=vrrpOperationsPriority, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperEntry=vrrpOperEntry, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpMIBGroups=vrrpMIBGroups, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperations=vrrpOperations, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperAuthType=vrrpOperAuthType, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatsGroup=vrrpStatsGroup, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpNotifications=vrrpNotifications, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpOperGroup=vrrpOperGroup, vrrpOperTable=vrrpOperTable, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpOperVrId=vrrpOperVrId, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd)
