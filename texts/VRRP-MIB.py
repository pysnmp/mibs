...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:16:52 2024
...
ModuleIdentity, TimeTicks, Counter64, iso, Unsigned32, Counter32, IpAddress, mib_2, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter64", "iso", "Unsigned32", "Counter32", "IpAddress", "mib-2", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Integer32", "Gauge32")
TextualConvention, StorageType, TruthValue, RowStatus, MacAddress, TimeInterval, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "StorageType", "TruthValue", "RowStatus", "MacAddress", "TimeInterval", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpConformance=vrrpConformance, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpOperTable=vrrpOperTable, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperationsState=vrrpOperationsState, vrrpOperations=vrrpOperations, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpMIBGroups=vrrpMIBGroups, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperationsTable=vrrpOperationsTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperGroup=vrrpOperGroup, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpStatsGroup=vrrpStatsGroup, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpMIB=vrrpMIB, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpOperRowStatus=vrrpOperRowStatus, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperationsGroup=vrrpOperationsGroup, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperVrId=vrrpOperVrId, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperProtocol=vrrpOperProtocol, vrrpMIBCompliance=vrrpMIBCompliance, VrId=VrId, vrrpNotificationGroup=vrrpNotificationGroup, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpNotifications=vrrpNotifications, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperEntry=vrrpOperEntry, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, PYSNMP_MODULE_ID=vrrpMIB, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpTrapGroup=vrrpTrapGroup, vrrpOperPriority=vrrpOperPriority, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperAuthType=vrrpOperAuthType, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatistics=vrrpStatistics, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperState=vrrpOperState, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpMIBCompliances=vrrpMIBCompliances, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperAuthKey=vrrpOperAuthKey, vrrpNotificationCntl=vrrpNotificationCntl)
