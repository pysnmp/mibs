...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:39:24 2022
...
Bits, mib_2, Counter32, Integer32, IpAddress, ObjectIdentity, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, ModuleIdentity, Unsigned32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "Counter32", "Integer32", "IpAddress", "ObjectIdentity", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "ModuleIdentity", "Unsigned32", "TimeTicks", "iso")
TruthValue, TimeInterval, TimeStamp, RowStatus, MacAddress, TextualConvention, StorageType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeInterval", "TimeStamp", "RowStatus", "MacAddress", "TextualConvention", "StorageType", "DisplayString")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperGroup=vrrpOperGroup, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperAdminState=vrrpOperAdminState, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpTrapGroup=vrrpTrapGroup, vrrpOperPriority=vrrpOperPriority, vrrpOperTable=vrrpOperTable, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpOperationsState=vrrpOperationsState, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperationsTable=vrrpOperationsTable, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpNotificationGroup=vrrpNotificationGroup, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatsGroup=vrrpStatsGroup, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, PYSNMP_MODULE_ID=vrrpMIB, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperProtocol=vrrpOperProtocol, vrrpStatistics=vrrpStatistics, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpMIB=vrrpMIB, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpTrapProtoError=vrrpTrapProtoError, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperAuthType=vrrpOperAuthType, VrId=VrId, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpOperations=vrrpOperations, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpNotifications=vrrpNotifications, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperState=vrrpOperState, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperEntry=vrrpOperEntry, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperVrId=vrrpOperVrId, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpNotificationCntl=vrrpNotificationCntl, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpConformance=vrrpConformance, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpOperAuthKey=vrrpOperAuthKey, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpMIBCompliance=vrrpMIBCompliance, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperRowStatus=vrrpOperRowStatus, vrrpMIBGroups=vrrpMIBGroups, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr)
