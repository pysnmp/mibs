...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:31:00 2023
...
ModuleIdentity, MibIdentifier, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ObjectIdentity, Integer32, Unsigned32, Bits, iso, NotificationType, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ObjectIdentity", "Integer32", "Unsigned32", "Bits", "iso", "NotificationType", "mib-2", "IpAddress")
TimeInterval, StorageType, TruthValue, DisplayString, TimeStamp, MacAddress, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "StorageType", "TruthValue", "DisplayString", "TimeStamp", "MacAddress", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpNotifications=vrrpNotifications, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpNodeVersion=vrrpNodeVersion, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpNewMasterReason=vrrpNewMasterReason, vrrpMIBCompliance=vrrpMIBCompliance, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsState=vrrpOperationsState, vrrpOperations=vrrpOperations, VrId=VrId, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperPriority=vrrpOperPriority, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpNotificationCntl=vrrpNotificationCntl, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpOperEntry=vrrpOperEntry, vrrpMIB=vrrpMIB, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpStatistics=vrrpStatistics, vrrpOperationsPriority=vrrpOperationsPriority, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperGroup=vrrpOperGroup, vrrpOperProtocol=vrrpOperProtocol, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperState=vrrpOperState, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpMIBCompliances=vrrpMIBCompliances, vrrpMIBGroups=vrrpMIBGroups, PYSNMP_MODULE_ID=vrrpMIB, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpConformance=vrrpConformance, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperationsTable=vrrpOperationsTable, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpNotificationGroup=vrrpNotificationGroup, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpOperVrId=vrrpOperVrId, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperAuthType=vrrpOperAuthType, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperTable=vrrpOperTable, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpTrapProtoError=vrrpTrapProtoError, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatsGroup=vrrpStatsGroup, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpTrapGroup=vrrpTrapGroup)
