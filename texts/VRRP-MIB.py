...
NotificationType, Integer32, Gauge32, mib_2, ModuleIdentity, ObjectIdentity, Unsigned32, iso, MibIdentifier, IpAddress, Bits, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "mib-2", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "MibIdentifier", "IpAddress", "Bits", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
MacAddress, TextualConvention, TruthValue, DisplayString, StorageType, TimeStamp, TimeInterval, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "TruthValue", "DisplayString", "StorageType", "TimeStamp", "TimeInterval", "RowStatus")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperations=vrrpOperations, vrrpMIB=vrrpMIB, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperPriority=vrrpOperPriority, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpOperTable=vrrpOperTable, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpTrapProtoError=vrrpTrapProtoError, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpMIBCompliance=vrrpMIBCompliance, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpConformance=vrrpConformance, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpNotifications=vrrpNotifications, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperVrId=vrrpOperVrId, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperAuthType=vrrpOperAuthType, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperGroup=vrrpOperGroup, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperationsPriority=vrrpOperationsPriority, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpMIBGroups=vrrpMIBGroups, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperEntry=vrrpOperEntry, PYSNMP_MODULE_ID=vrrpMIB, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatistics=vrrpStatistics, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpOperProtocol=vrrpOperProtocol, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpTrapGroup=vrrpTrapGroup, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpOperRowStatus=vrrpOperRowStatus, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperAdminState=vrrpOperAdminState, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperState=vrrpOperState, vrrpMIBCompliances=vrrpMIBCompliances, vrrpStatsGroup=vrrpStatsGroup, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpModuleFullCompliance=vrrpModuleFullCompliance, VrId=VrId, vrrpOperationsTable=vrrpOperationsTable, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperationsState=vrrpOperationsState, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors)
