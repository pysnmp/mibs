...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:19:15 2024
...
Integer32, Bits, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, Counter64, NotificationType, ModuleIdentity, Counter32, mib_2, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "mib-2", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
StorageType, TruthValue, TimeStamp, TimeInterval, DisplayString, TextualConvention, MacAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "TruthValue", "TimeStamp", "TimeInterval", "DisplayString", "TextualConvention", "MacAddress", "RowStatus")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperPriority=vrrpOperPriority, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpStatsGroup=vrrpStatsGroup, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperTable=vrrpOperTable, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpStatistics=vrrpStatistics, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperationsPriority=vrrpOperationsPriority, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpMIBCompliance=vrrpMIBCompliance, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperEntry=vrrpOperEntry, vrrpOperVrId=vrrpOperVrId, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperRowStatus=vrrpOperRowStatus, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpMIBGroups=vrrpMIBGroups, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, VrId=VrId, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperations=vrrpOperations, vrrpOperState=vrrpOperState, vrrpOperProtocol=vrrpOperProtocol, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpOperationsGroup=vrrpOperationsGroup, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpNotificationCntl=vrrpNotificationCntl, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperationsTable=vrrpOperationsTable, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpNotifications=vrrpNotifications, vrrpMIB=vrrpMIB, vrrpNodeVersion=vrrpNodeVersion, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpNotificationGroup=vrrpNotificationGroup, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, PYSNMP_MODULE_ID=vrrpMIB, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpTrapGroup=vrrpTrapGroup, vrrpOperGroup=vrrpOperGroup, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpConformance=vrrpConformance, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpOperationsEntry=vrrpOperationsEntry, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpTrapProtoError=vrrpTrapProtoError, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpOperAuthType=vrrpOperAuthType, vrrpOperationsState=vrrpOperationsState, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors)
