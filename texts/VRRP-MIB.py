...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:03:29 2023
...
Counter64, Counter32, Integer32, IpAddress, TimeTicks, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, mib_2, Bits, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "Integer32", "IpAddress", "TimeTicks", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "mib-2", "Bits", "Unsigned32", "iso")
DisplayString, TruthValue, RowStatus, TextualConvention, MacAddress, TimeInterval, StorageType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "TextualConvention", "MacAddress", "TimeInterval", "StorageType", "TimeStamp")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpTrapProtoError=vrrpTrapProtoError, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, VrId=VrId, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpNewMasterReason=vrrpNewMasterReason, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperGroup=vrrpOperGroup, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperations=vrrpOperations, vrrpOperTable=vrrpOperTable, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpOperEntry=vrrpOperEntry, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperPriority=vrrpOperPriority, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperProtocol=vrrpOperProtocol, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpNotifications=vrrpNotifications, vrrpStatsGroup=vrrpStatsGroup, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpMIBCompliance=vrrpMIBCompliance, vrrpNotificationCntl=vrrpNotificationCntl, vrrpOperVrId=vrrpOperVrId, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpStatistics=vrrpStatistics, vrrpOperationsState=vrrpOperationsState, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpTrapGroup=vrrpTrapGroup, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperAuthKey=vrrpOperAuthKey, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpOperState=vrrpOperState, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpMIB=vrrpMIB, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperationsTable=vrrpOperationsTable, vrrpConformance=vrrpConformance, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperRowStatus=vrrpOperRowStatus, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperAuthType=vrrpOperAuthType, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpOperationsVrId=vrrpOperationsVrId, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperationsPriority=vrrpOperationsPriority, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpMIBGroups=vrrpMIBGroups, vrrpTrapNewMaster=vrrpTrapNewMaster)
