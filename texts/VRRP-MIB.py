...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:45:41 2022
...
Unsigned32, IpAddress, iso, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, Counter32, NotificationType, Counter64, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "iso", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter32", "NotificationType", "Counter64", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits")
MacAddress, RowStatus, TruthValue, TimeStamp, DisplayString, TextualConvention, TimeInterval, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "RowStatus", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention", "TimeInterval", "StorageType")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatistics=vrrpStatistics, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpNotificationCntl=vrrpNotificationCntl, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpMIBGroups=vrrpMIBGroups, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperationsTable=vrrpOperationsTable, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpOperations=vrrpOperations, VrId=VrId, vrrpOperationsPriority=vrrpOperationsPriority, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, PYSNMP_MODULE_ID=vrrpMIB, vrrpNotifications=vrrpNotifications, vrrpOperAdminState=vrrpOperAdminState, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperAuthType=vrrpOperAuthType, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpConformance=vrrpConformance, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpNodeVersion=vrrpNodeVersion, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperTable=vrrpOperTable, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperVrId=vrrpOperVrId, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpTrapProtoError=vrrpTrapProtoError, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperGroup=vrrpOperGroup, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpTrapGroup=vrrpTrapGroup, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpMIB=vrrpMIB, vrrpOperationsVrId=vrrpOperationsVrId, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpOperPriority=vrrpOperPriority, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpOperationsState=vrrpOperationsState, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperProtocol=vrrpOperProtocol, vrrpStatsGroup=vrrpStatsGroup, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpOperationsEntry=vrrpOperationsEntry, vrrpOperState=vrrpOperState, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperEntry=vrrpOperEntry, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpMIBCompliance=vrrpMIBCompliance)
