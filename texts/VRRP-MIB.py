...
Integer32, Gauge32, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, iso, ObjectIdentity, Counter32, Bits, ModuleIdentity, Counter64, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "Counter32", "Bits", "ModuleIdentity", "Counter64", "NotificationType", "Unsigned32")
RowStatus, TextualConvention, StorageType, TimeInterval, MacAddress, DisplayString, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "StorageType", "TimeInterval", "MacAddress", "DisplayString", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperations=vrrpOperations, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpOperationsState=vrrpOperationsState, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpConformance=vrrpConformance, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpStatsGroup=vrrpStatsGroup, vrrpOperationsTable=vrrpOperationsTable, vrrpOperState=vrrpOperState, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperGroup=vrrpOperGroup, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpOperationsGroup=vrrpOperationsGroup, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpOperationsPriority=vrrpOperationsPriority, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperVrId=vrrpOperVrId, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpTrapGroup=vrrpTrapGroup, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperationsVrId=vrrpOperationsVrId, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpMIBGroups=vrrpMIBGroups, vrrpStatistics=vrrpStatistics, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperPriority=vrrpOperPriority, vrrpOperAdminState=vrrpOperAdminState, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpOperAuthType=vrrpOperAuthType, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpNotifications=vrrpNotifications, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpOperTable=vrrpOperTable, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, VrId=VrId, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpNotificationGroup=vrrpNotificationGroup, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpMIB=vrrpMIB, vrrpNotificationCntl=vrrpNotificationCntl, vrrpNodeVersion=vrrpNodeVersion, vrrpNewMasterReason=vrrpNewMasterReason, vrrpOperEntry=vrrpOperEntry, vrrpTrapProtoError=vrrpTrapProtoError, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperProtocol=vrrpOperProtocol, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpMIBCompliance=vrrpMIBCompliance, vrrpOperRowStatus=vrrpOperRowStatus, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry)
