...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:10:28 2024
...
Integer32, NotificationType, iso, MibIdentifier, Counter32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, TimeTicks, mib_2, ModuleIdentity, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "iso", "MibIdentifier", "Counter32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "TimeTicks", "mib-2", "ModuleIdentity", "Gauge32", "Bits")
MacAddress, TimeInterval, DisplayString, RowStatus, TextualConvention, TimeStamp, TruthValue, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TimeInterval", "DisplayString", "RowStatus", "TextualConvention", "TimeStamp", "TruthValue", "StorageType")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpStatsGroup=vrrpStatsGroup, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperations=vrrpOperations, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpOperAdminState=vrrpOperAdminState, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpMIB=vrrpMIB, vrrpNodeVersion=vrrpNodeVersion, vrrpNotificationGroup=vrrpNotificationGroup, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpMIBGroups=vrrpMIBGroups, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperationsEntry=vrrpOperationsEntry, vrrpMIBCompliances=vrrpMIBCompliances, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperProtocol=vrrpOperProtocol, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpTrapGroup=vrrpTrapGroup, vrrpOperAuthKey=vrrpOperAuthKey, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpNotificationCntl=vrrpNotificationCntl, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperationsTable=vrrpOperationsTable, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpOperPriority=vrrpOperPriority, vrrpOperGroup=vrrpOperGroup, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperTable=vrrpOperTable, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpNotificationsGroup=vrrpNotificationsGroup, VrId=VrId, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpOperAuthType=vrrpOperAuthType, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperState=vrrpOperState, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpOperEntry=vrrpOperEntry, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpOperVrId=vrrpOperVrId, vrrpOperationsState=vrrpOperationsState, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpMIBCompliance=vrrpMIBCompliance, vrrpConformance=vrrpConformance, vrrpNotifications=vrrpNotifications, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpOperationsGroup=vrrpOperationsGroup, vrrpOperRowStatus=vrrpOperRowStatus, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpStatistics=vrrpStatistics, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr)
