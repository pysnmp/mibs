...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:49:31 2024
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Gauge32, iso, MibIdentifier, IpAddress, Bits, ObjectIdentity, Unsigned32, NotificationType, mib_2, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Gauge32", "iso", "MibIdentifier", "IpAddress", "Bits", "ObjectIdentity", "Unsigned32", "NotificationType", "mib-2", "Integer32", "TimeTicks")
TimeStamp, DisplayString, RowStatus, TimeInterval, TruthValue, StorageType, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "TimeInterval", "TruthValue", "StorageType", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("VRRP-MIB", vrrpOperationsPriority=vrrpOperationsPriority, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpOperVirtualMacAddr=vrrpOperVirtualMacAddr, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatsPacketLengthErrors=vrrpStatsPacketLengthErrors, vrrpRouterVrIdErrors=vrrpRouterVrIdErrors, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpStatsGroup=vrrpStatsGroup, vrrpStatsAuthTypeMismatch=vrrpStatsAuthTypeMismatch, vrrpMIB=vrrpMIB, vrrpRouterStatsTable=vrrpRouterStatsTable, vrrpStatsAuthFailures=vrrpStatsAuthFailures, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperationsGroup=vrrpOperationsGroup, vrrpStatsAdvertiseIntervalErrors=vrrpStatsAdvertiseIntervalErrors, vrrpStatsPriorityZeroPktsRcvd=vrrpStatsPriorityZeroPktsRcvd, vrrpConformance=vrrpConformance, vrrpAssoIpAddrRowStatus=vrrpAssoIpAddrRowStatus, vrrpOperAdvertisementInterval=vrrpOperAdvertisementInterval, vrrpOperAuthType=vrrpOperAuthType, vrrpStatsIpTtlErrors=vrrpStatsIpTtlErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpTrapNewMaster=vrrpTrapNewMaster, vrrpStatistics=vrrpStatistics, vrrpOperationsTable=vrrpOperationsTable, vrrpOperVirtualRouterUpTime=vrrpOperVirtualRouterUpTime, vrrpStatsAddressListErrors=vrrpStatsAddressListErrors, vrrpOperationsEntry=vrrpOperationsEntry, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, PYSNMP_MODULE_ID=vrrpMIB, vrrpStatsInvalidTypePktsRcvd=vrrpStatsInvalidTypePktsRcvd, vrrpNotificationGroup=vrrpNotificationGroup, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperMasterIpAddr=vrrpOperMasterIpAddr, vrrpOperAdminState=vrrpOperAdminState, vrrpOperAuthKey=vrrpOperAuthKey, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperEntry=vrrpOperEntry, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperations=vrrpOperations, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpStatsBecomeMaster=vrrpStatsBecomeMaster, vrrpOperRowStatus=vrrpOperRowStatus, vrrpNodeVersion=vrrpNodeVersion, vrrpStatsInvalidAuthType=vrrpStatsInvalidAuthType, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperState=vrrpOperState, vrrpTrapPacketSrc=vrrpTrapPacketSrc, vrrpOperVrId=vrrpOperVrId, VrId=VrId, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpRouterChecksumErrors=vrrpRouterChecksumErrors, vrrpOperTable=vrrpOperTable, vrrpOperProtocol=vrrpOperProtocol, vrrpStatsAdvertiseRcvd=vrrpStatsAdvertiseRcvd, vrrpOperIpAddrCount=vrrpOperIpAddrCount, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpMIBGroups=vrrpMIBGroups, vrrpAssoIpAddrEntry=vrrpAssoIpAddrEntry, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpAssoIpAddrTable=vrrpAssoIpAddrTable, vrrpNotificationCntl=vrrpNotificationCntl, vrrpTrapAuthErrorType=vrrpTrapAuthErrorType, vrrpAssoIpAddr=vrrpAssoIpAddr, vrrpStatsPriorityZeroPktsSent=vrrpStatsPriorityZeroPktsSent, vrrpMIBCompliance=vrrpMIBCompliance, vrrpOperationsVrId=vrrpOperationsVrId, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpOperPrimaryIpAddr=vrrpOperPrimaryIpAddr, vrrpRouterVersionErrors=vrrpRouterVersionErrors, vrrpOperationsState=vrrpOperationsState, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpNewMasterReason=vrrpNewMasterReason, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpRouterStatsEntry=vrrpRouterStatsEntry, vrrpTrapGroup=vrrpTrapGroup, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpNotifications=vrrpNotifications, vrrpTrapAuthFailure=vrrpTrapAuthFailure, vrrpOperPriority=vrrpOperPriority, vrrpOperPreemptMode=vrrpOperPreemptMode, vrrpOperGroup=vrrpOperGroup, vrrpMIBCompliances=vrrpMIBCompliances, vrrpTrapInfoGroup=vrrpTrapInfoGroup)
