...
iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter64, Gauge32, ModuleIdentity, Counter32, Bits, ObjectIdentity, Integer32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "Bits", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlLocalAccess=controlLocalAccess, sizeOfRepairlog=sizeOfRepairlog, statusLidStatus=statusLidStatus, productKeyFeatureEnable=productKeyFeatureEnable, moduleNotebookTable=moduleNotebookTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusRunningSwImage=statusRunningSwImage, regIndex=regIndex, sizeOfNotebook=sizeOfNotebook, sWUpdateControl=sWUpdateControl, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapLifeTime=controlTrapLifeTime, moduleRackNo=moduleRackNo, statusRestartCounter=statusRestartCounter, moduleRegistryEntry=moduleRegistryEntry, regName=regName, moduleHwSerialNumber=moduleHwSerialNumber, productKeyIndex=productKeyIndex, moduleRegistry=moduleRegistry, moduleHwType=moduleHwType, elementConfigChangeCode=elementConfigChangeCode, controlTrapReceiverTable=controlTrapReceiverTable, productKeyCipher=productKeyCipher, notebookLineText=notebookLineText, repairNameCode=repairNameCode, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTempLimitLo=controlTempLimitLo, moduleRepairLogTable=moduleRepairLogTable, moduleAppDate=moduleAppDate, productKeyFeatureIndex=productKeyFeatureIndex, moduleDetailTable=moduleDetailTable, statusGeneral=statusGeneral, controlAlarmOffDelay=controlAlarmOffDelay, productKeyTable=productKeyTable, elementProductKey=elementProductKey, productKeyMask=productKeyMask, controlTrapDelay=controlTrapDelay, receiverEntryId=receiverEntryId, elementStructure=elementStructure, elementTotalUpTime=elementTotalUpTime, moduleStatus=moduleStatus, controlMarkState=controlMarkState, moduleControl=moduleControl, sWUpdateStatus=sWUpdateStatus, controlTrapSending=controlTrapSending, moduleStatusEntry=moduleStatusEntry, controlTempDeadBand=controlTempDeadBand, productKeyStatus=productKeyStatus, moduleMacAddress=moduleMacAddress, statusSoftware=statusSoftware, repairReasonCode=repairReasonCode, moduleNotebookEntry=moduleNotebookEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusBusMaster=statusBusMaster, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapInterval=controlTrapInterval, elementControl=elementControl, moduleAppVersion=moduleAppVersion, controlResetElement=controlResetElement, statusResetCause=statusResetCause, element=element, receiverAddress=receiverAddress, receiverCommunity=receiverCommunity, moduleName=moduleName, moduleStatusTable=moduleStatusTable, productKeyFeatureName=productKeyFeatureName, statusSettings=statusSettings, elementName=elementName, moduleControlEntry=moduleControlEntry, moduleSizeOfEntry=moduleSizeOfEntry, swUpdateURL=swUpdateURL, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleControlTable=moduleControlTable, moduleEntry=moduleEntry, controlAlarmDetection=controlAlarmDetection, moduleDetailEntry=moduleDetailEntry, statusInternalTemperature=statusInternalTemperature, controlTempLimitLoLo=controlTempLimitLoLo, elementLatitude=elementLatitude, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleId=moduleId, statusFan=statusFan, repairComment=repairComment, moduleBiosDate=moduleBiosDate, controlTempLimitHiHi=controlTempLimitHiHi, elementInformation=elementInformation, elementLongitude=elementLongitude, controlAlarmOnDelay=controlAlarmOnDelay, controlTempLimitHi=controlTempLimitHi, moduleHwVersion=moduleHwVersion, elementResetCount=elementResetCount, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleBiosVersion=moduleBiosVersion, sizeOfRegistry=sizeOfRegistry, moduleBusAddress=moduleBusAddress, moduleSlotNo=moduleSlotNo, moduleInformation=moduleInformation, moduleSizeOfTable=moduleSizeOfTable, receiverPort=receiverPort, moduleRegistryTable=moduleRegistryTable, statusHardware=statusHardware, productKeyFeatureEntry=productKeyFeatureEntry, module=module, notebookLineNumber=notebookLineNumber, elementAltitude=elementAltitude, statusLmt=statusLmt, productKeyEntry=productKeyEntry, controlLedUsage=controlLedUsage, productKeyValue=productKeyValue, repairIndex=repairIndex, repairDate=repairDate, regValue=regValue, moduleTable=moduleTable, productKeyFeatureTable=productKeyFeatureTable, controlReset=controlReset, controlBusMasterAdminState=controlBusMasterAdminState, statusLid=statusLid, controlInternalAppAccess=controlInternalAppAccess, sWUpdateFileName=sWUpdateFileName, statusTemperature=statusTemperature, elementStatus=elementStatus)
