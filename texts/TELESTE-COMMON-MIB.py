...
ModuleIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ObjectIdentity, IpAddress, Integer32, Bits, NotificationType, MibIdentifier, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "Bits", "NotificationType", "MibIdentifier", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusTemperature=statusTemperature, moduleBusAddress=moduleBusAddress, moduleBiosDate=moduleBiosDate, elementConfigChangeCode=elementConfigChangeCode, controlReset=controlReset, moduleStatus=moduleStatus, controlTrapSending=controlTrapSending, moduleNotebookTable=moduleNotebookTable, productKeyFeatureTable=productKeyFeatureTable, notebookLineText=notebookLineText, moduleControlEntry=moduleControlEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, statusLidStatus=statusLidStatus, controlTempLimitHiHi=controlTempLimitHiHi, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementLatitude=elementLatitude, controlTrapLifeTime=controlTrapLifeTime, moduleSizeOfTable=moduleSizeOfTable, sizeOfRegistry=sizeOfRegistry, receiverPort=receiverPort, moduleSizeOfEntry=moduleSizeOfEntry, moduleHwSerialNumber=moduleHwSerialNumber, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusHardware=statusHardware, productKeyStatus=productKeyStatus, elementTotalUpTime=elementTotalUpTime, moduleSlotNo=moduleSlotNo, controlInternalAppAccess=controlInternalAppAccess, statusInternalTemperature=statusInternalTemperature, moduleAppVersion=moduleAppVersion, statusRestartCounter=statusRestartCounter, controlTempLimitLoLo=controlTempLimitLoLo, controlResetElement=controlResetElement, moduleInformation=moduleInformation, repairIndex=repairIndex, productKeyTable=productKeyTable, moduleRepairLogEntry=moduleRepairLogEntry, elementAltitude=elementAltitude, elementProductKey=elementProductKey, controlTrapInterval=controlTrapInterval, moduleEntry=moduleEntry, moduleRegistry=moduleRegistry, moduleRegistryEntry=moduleRegistryEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyFeatureEnable=productKeyFeatureEnable, swUpdateURL=swUpdateURL, moduleDetailEntry=moduleDetailEntry, moduleStatusTable=moduleStatusTable, controlLedUsage=controlLedUsage, statusGeneral=statusGeneral, moduleRackNo=moduleRackNo, receiverAddress=receiverAddress, controlTempDeadBand=controlTempDeadBand, statusSettings=statusSettings, moduleRepairLogTable=moduleRepairLogTable, elementStructure=elementStructure, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmDetection=controlAlarmDetection, moduleAppDate=moduleAppDate, productKeyFeatureName=productKeyFeatureName, controlAlarmOffDelay=controlAlarmOffDelay, statusBusMaster=statusBusMaster, moduleRegistryTable=moduleRegistryTable, moduleNotebookEntry=moduleNotebookEntry, repairDate=repairDate, productKeyValue=productKeyValue, repairComment=repairComment, repairNameCode=repairNameCode, statusSoftware=statusSoftware, moduleStatusEntry=moduleStatusEntry, elementLongitude=elementLongitude, moduleName=moduleName, controlAlarmOnDelay=controlAlarmOnDelay, notebookLineNumber=notebookLineNumber, productKeyFeatureEntry=productKeyFeatureEntry, regName=regName, controlLocalAccess=controlLocalAccess, repairReasonCode=repairReasonCode, module=module, productKeyCipher=productKeyCipher, controlTrapDelay=controlTrapDelay, moduleControl=moduleControl, moduleTable=moduleTable, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleControlTable=moduleControlTable, controlBusMasterAdminState=controlBusMasterAdminState, sWUpdateStatus=sWUpdateStatus, statusLid=statusLid, sizeOfRepairlog=sizeOfRepairlog, regValue=regValue, receiverEntryId=receiverEntryId, receiverCommunity=receiverCommunity, moduleDetailTable=moduleDetailTable, productKeyMask=productKeyMask, statusFan=statusFan, moduleId=moduleId, elementStatus=elementStatus, elementResetCount=elementResetCount, statusRunningSwImage=statusRunningSwImage, moduleBiosVersion=moduleBiosVersion, controlMarkState=controlMarkState, moduleMacAddress=moduleMacAddress, elementName=elementName, controlTrapReceiverEntry=controlTrapReceiverEntry, elementInformation=elementInformation, statusResetCause=statusResetCause, controlTempLimitHi=controlTempLimitHi, sWUpdateControl=sWUpdateControl, element=element, productKeyEntry=productKeyEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleHwVersion=moduleHwVersion, moduleHwType=moduleHwType, sWUpdateFileName=sWUpdateFileName, elementControl=elementControl, controlTempLimitLo=controlTempLimitLo, moduleSWUpdateTable=moduleSWUpdateTable, productKeyIndex=productKeyIndex, sizeOfNotebook=sizeOfNotebook, regIndex=regIndex, statusLmt=statusLmt)
