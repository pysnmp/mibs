...
Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, MibIdentifier, Counter32, Gauge32, TimeTicks, iso, Integer32, ModuleIdentity, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "iso", "Integer32", "ModuleIdentity", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapInterval=controlTrapInterval, statusSoftware=statusSoftware, moduleRackNo=moduleRackNo, statusInternalTemperature=statusInternalTemperature, controlTempLimitHiHi=controlTempLimitHiHi, moduleStatusTable=moduleStatusTable, elementProductKey=elementProductKey, swUpdateURL=swUpdateURL, moduleRegistryEntry=moduleRegistryEntry, moduleBiosVersion=moduleBiosVersion, elementLatitude=elementLatitude, controlResetElement=controlResetElement, productKeyMask=productKeyMask, elementControl=elementControl, controlTrapReceiverEntry=controlTrapReceiverEntry, statusRestartCounter=statusRestartCounter, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyValue=productKeyValue, sizeOfRepairlog=sizeOfRepairlog, controlInternalAppAccess=controlInternalAppAccess, moduleBusAddress=moduleBusAddress, controlBusMasterAdminState=controlBusMasterAdminState, moduleHwType=moduleHwType, repairComment=repairComment, productKeyFeatureName=productKeyFeatureName, productKeyFeatureIndex=productKeyFeatureIndex, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosDate=moduleBiosDate, productKeyStatus=productKeyStatus, controlTempLimitLoLo=controlTempLimitLoLo, repairReasonCode=repairReasonCode, receiverAddress=receiverAddress, statusRunningSwImage=statusRunningSwImage, moduleMacAddress=moduleMacAddress, controlLedUsage=controlLedUsage, sWUpdateControl=sWUpdateControl, regValue=regValue, moduleId=moduleId, elementInformation=elementInformation, sizeOfNotebook=sizeOfNotebook, elementName=elementName, repairNameCode=repairNameCode, notebookLineText=notebookLineText, moduleRepairLogEntry=moduleRepairLogEntry, statusFan=statusFan, controlTrapSending=controlTrapSending, productKeyIndex=productKeyIndex, moduleSizeOfEntry=moduleSizeOfEntry, controlAlarmOffDelay=controlAlarmOffDelay, controlReset=controlReset, elementConfigChangeCode=elementConfigChangeCode, moduleHwVersion=moduleHwVersion, moduleControlTable=moduleControlTable, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleAppDate=moduleAppDate, elementStructure=elementStructure, notebookLineNumber=notebookLineNumber, statusLmt=statusLmt, moduleSWUpdateEntry=moduleSWUpdateEntry, receiverPort=receiverPort, regIndex=regIndex, controlTrapDelay=controlTrapDelay, element=element, controlTempDeadBand=controlTempDeadBand, controlLocalAccess=controlLocalAccess, moduleStatus=moduleStatus, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistry=moduleRegistry, moduleHwSerialNumber=moduleHwSerialNumber, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureEntry=productKeyFeatureEntry, statusSettings=statusSettings, productKeyTable=productKeyTable, elementTotalUpTime=elementTotalUpTime, statusResetCause=statusResetCause, moduleInformation=moduleInformation, moduleEntry=moduleEntry, moduleRegistryTable=moduleRegistryTable, productKeyEntry=productKeyEntry, statusHardware=statusHardware, moduleControl=moduleControl, statusBusMaster=statusBusMaster, controlTempLimitHi=controlTempLimitHi, moduleStatusEntry=moduleStatusEntry, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureEnable=productKeyFeatureEnable, statusTemperature=statusTemperature, statusLid=statusLid, receiverEntryId=receiverEntryId, controlTempLimitLo=controlTempLimitLo, elementStatus=elementStatus, elementResetCount=elementResetCount, elementLongitude=elementLongitude, moduleDetailTable=moduleDetailTable, moduleNotebookTable=moduleNotebookTable, repairDate=repairDate, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSlotNo=moduleSlotNo, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogTable=moduleRepairLogTable, moduleDetailEntry=moduleDetailEntry, sizeOfRegistry=sizeOfRegistry, productKeyFeatureTable=productKeyFeatureTable, productKeyCipher=productKeyCipher, statusLidStatus=statusLidStatus, statusGeneral=statusGeneral, moduleAppVersion=moduleAppVersion, regName=regName, controlAlarmDetection=controlAlarmDetection, moduleName=moduleName, receiverCommunity=receiverCommunity, sWUpdateStatus=sWUpdateStatus, controlMarkState=controlMarkState, module=module, moduleControlEntry=moduleControlEntry, moduleSizeOfTable=moduleSizeOfTable, moduleTable=moduleTable, moduleSWUpdateTable=moduleSWUpdateTable, repairIndex=repairIndex, elementAltitude=elementAltitude)
