...
IpAddress, NotificationType, Counter64, ObjectIdentity, Counter32, TimeTicks, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Bits, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "TimeTicks", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Bits", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyTable=productKeyTable, swUpdateURL=swUpdateURL, moduleMacAddress=moduleMacAddress, moduleRackNo=moduleRackNo, moduleId=moduleId, productKeyFeatureName=productKeyFeatureName, controlTempLimitLo=controlTempLimitLo, moduleSizeOfEntry=moduleSizeOfEntry, moduleDetailEntry=moduleDetailEntry, statusLidStatus=statusLidStatus, productKeyFeatureTable=productKeyFeatureTable, productKeyMask=productKeyMask, statusFan=statusFan, controlTempLimitLoLo=controlTempLimitLoLo, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleNotebookEntry=moduleNotebookEntry, moduleNotebookTable=moduleNotebookTable, receiverPort=receiverPort, controlTrapReceiverEntry=controlTrapReceiverEntry, elementName=elementName, statusRunningSwImage=statusRunningSwImage, repairIndex=repairIndex, controlAlarmOnDelay=controlAlarmOnDelay, elementStructure=elementStructure, sWUpdateStatus=sWUpdateStatus, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapInterval=controlTrapInterval, productKeyFeatureIndex=productKeyFeatureIndex, elementStatus=elementStatus, controlMarkState=controlMarkState, controlTempLimitHiHi=controlTempLimitHiHi, controlAlarmDetection=controlAlarmDetection, productKeyValue=productKeyValue, productKeyEntry=productKeyEntry, moduleHwType=moduleHwType, controlTrapReceiverTable=controlTrapReceiverTable, repairNameCode=repairNameCode, receiverEntryId=receiverEntryId, controlTrapLifeTime=controlTrapLifeTime, repairDate=repairDate, moduleTable=moduleTable, controlTrapDelay=controlTrapDelay, regIndex=regIndex, notebookLineNumber=notebookLineNumber, moduleAppVersion=moduleAppVersion, sizeOfNotebook=sizeOfNotebook, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureEntry=productKeyFeatureEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, statusLmt=statusLmt, statusTemperature=statusTemperature, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementResetCount=elementResetCount, productKeyStatus=productKeyStatus, moduleStatusEntry=moduleStatusEntry, elementProductKey=elementProductKey, statusGeneral=statusGeneral, moduleHwSerialNumber=moduleHwSerialNumber, elementControl=elementControl, moduleSlotNo=moduleSlotNo, moduleStatus=moduleStatus, moduleRegistryEntry=moduleRegistryEntry, statusBusMaster=statusBusMaster, controlLedUsage=controlLedUsage, moduleBusAddress=moduleBusAddress, statusSettings=statusSettings, repairComment=repairComment, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlReset=controlReset, moduleRepairLogEntry=moduleRepairLogEntry, moduleDetailTable=moduleDetailTable, moduleSizeOfTable=moduleSizeOfTable, sWUpdateFileName=sWUpdateFileName, moduleRegistryTable=moduleRegistryTable, productKeyCipher=productKeyCipher, elementTotalUpTime=elementTotalUpTime, sizeOfRegistry=sizeOfRegistry, moduleName=moduleName, moduleHwVersion=moduleHwVersion, notebookLineText=notebookLineText, controlLocalAccess=controlLocalAccess, controlAlarmOffDelay=controlAlarmOffDelay, element=element, moduleStatusTable=moduleStatusTable, sWUpdateControl=sWUpdateControl, repairReasonCode=repairReasonCode, elementLongitude=elementLongitude, statusResetCause=statusResetCause, moduleInformation=moduleInformation, moduleEntry=moduleEntry, moduleBiosVersion=moduleBiosVersion, elementConfigChangeCode=elementConfigChangeCode, elementLatitude=elementLatitude, statusRestartCounter=statusRestartCounter, statusSoftware=statusSoftware, module=module, productKeyFeatureEnable=productKeyFeatureEnable, controlBusMasterAdminState=controlBusMasterAdminState, regValue=regValue, moduleControl=moduleControl, statusLid=statusLid, controlTrapSending=controlTrapSending, statusHardware=statusHardware, moduleBiosDate=moduleBiosDate, controlTempDeadBand=controlTempDeadBand, controlResetElement=controlResetElement, moduleControlTable=moduleControlTable, regName=regName, controlInternalAppAccess=controlInternalAppAccess, moduleAppDate=moduleAppDate, receiverAddress=receiverAddress, controlTempLimitHi=controlTempLimitHi, elementInformation=elementInformation, sizeOfRepairlog=sizeOfRepairlog, moduleControlEntry=moduleControlEntry, receiverCommunity=receiverCommunity, elementAltitude=elementAltitude, moduleRegistry=moduleRegistry, statusInternalTemperature=statusInternalTemperature, productKeyIndex=productKeyIndex)
