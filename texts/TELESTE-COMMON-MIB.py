...
iso, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ModuleIdentity, Unsigned32, Gauge32, Counter32, Counter64, ObjectIdentity, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter32", "Counter64", "ObjectIdentity", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureName=productKeyFeatureName, productKeyFeatureIndex=productKeyFeatureIndex, moduleRegistryTable=moduleRegistryTable, regName=regName, moduleId=moduleId, elementStructure=elementStructure, sizeOfRepairlog=sizeOfRepairlog, controlTrapSending=controlTrapSending, notebookLineText=notebookLineText, elementProductKey=elementProductKey, moduleDetailEntry=moduleDetailEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleSizeOfEntry=moduleSizeOfEntry, statusHardware=statusHardware, controlTempDeadBand=controlTempDeadBand, sWUpdateStatus=sWUpdateStatus, moduleDetailTable=moduleDetailTable, swUpdateURL=swUpdateURL, elementAltitude=elementAltitude, statusSoftware=statusSoftware, statusSettings=statusSettings, moduleTable=moduleTable, regValue=regValue, repairComment=repairComment, moduleBusAddress=moduleBusAddress, statusRunningSwImage=statusRunningSwImage, moduleHwType=moduleHwType, elementControl=elementControl, elementLatitude=elementLatitude, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyValue=productKeyValue, controlTempLimitLoLo=controlTempLimitLoLo, moduleControlEntry=moduleControlEntry, statusRestartCounter=statusRestartCounter, notebookLineNumber=notebookLineNumber, moduleRegistry=moduleRegistry, moduleStatusEntry=moduleStatusEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapInterval=controlTrapInterval, moduleSlotNo=moduleSlotNo, elementLongitude=elementLongitude, productKeyMask=productKeyMask, controlTempLimitHi=controlTempLimitHi, controlLedUsage=controlLedUsage, statusFan=statusFan, productKeyIndex=productKeyIndex, moduleRepairLogTable=moduleRepairLogTable, controlMarkState=controlMarkState, receiverPort=receiverPort, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, statusResetCause=statusResetCause, moduleStatus=moduleStatus, productKeyEntry=productKeyEntry, moduleRackNo=moduleRackNo, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleBiosDate=moduleBiosDate, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, moduleEntry=moduleEntry, statusLid=statusLid, moduleHwVersion=moduleHwVersion, elementConfigChangeCode=elementConfigChangeCode, moduleSWUpdateTable=moduleSWUpdateTable, elementTotalUpTime=elementTotalUpTime, sizeOfRegistry=sizeOfRegistry, controlTrapLifeTime=controlTrapLifeTime, controlReset=controlReset, moduleControl=moduleControl, moduleInformation=moduleInformation, productKeyTable=productKeyTable, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfTable=moduleSizeOfTable, repairReasonCode=repairReasonCode, statusLidStatus=statusLidStatus, statusBusMaster=statusBusMaster, receiverAddress=receiverAddress, moduleNotebookTable=moduleNotebookTable, moduleMacAddress=moduleMacAddress, productKeyFeatureEntry=productKeyFeatureEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, element=element, receiverCommunity=receiverCommunity, controlTrapDelay=controlTrapDelay, controlAlarmDetection=controlAlarmDetection, controlBusMasterAdminState=controlBusMasterAdminState, controlResetElement=controlResetElement, controlTrapReceiverEntry=controlTrapReceiverEntry, controlLocalAccess=controlLocalAccess, moduleControlTable=moduleControlTable, elementStatus=elementStatus, moduleAppVersion=moduleAppVersion, elementResetCount=elementResetCount, controlInternalAppAccess=controlInternalAppAccess, elementName=elementName, elementInformation=elementInformation, controlTempLimitLo=controlTempLimitLo, moduleNotebookEntry=moduleNotebookEntry, repairDate=repairDate, statusTemperature=statusTemperature, moduleRepairLogEntry=moduleRepairLogEntry, moduleName=moduleName, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverEntryId=receiverEntryId, controlTrapReceiverTable=controlTrapReceiverTable, repairNameCode=repairNameCode, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOnDelay=controlAlarmOnDelay, productKeyCipher=productKeyCipher, sWUpdateControl=sWUpdateControl, controlAlarmOffDelay=controlAlarmOffDelay, moduleStatusTable=moduleStatusTable, moduleAppDate=moduleAppDate, regIndex=regIndex, statusGeneral=statusGeneral, statusInternalTemperature=statusInternalTemperature, module=module, repairIndex=repairIndex, productKeyFeatureTable=productKeyFeatureTable)
