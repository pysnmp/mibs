...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleId=moduleId, controlTrapDelay=controlTrapDelay, controlTempLimitLoLo=controlTempLimitLoLo, productKeyMask=productKeyMask, repairIndex=repairIndex, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusSettings=statusSettings, statusInternalTemperature=statusInternalTemperature, productKeyNumberOfKeys=productKeyNumberOfKeys, elementConfigChangeCode=elementConfigChangeCode, moduleControlEntry=moduleControlEntry, statusRestartCounter=statusRestartCounter, moduleName=moduleName, elementLongitude=elementLongitude, statusLmt=statusLmt, moduleAppVersion=moduleAppVersion, productKeyEntry=productKeyEntry, module=module, moduleRackNo=moduleRackNo, controlTrapReceiverEntry=controlTrapReceiverEntry, controlAlarmDetection=controlAlarmDetection, notebookLineText=notebookLineText, productKeyTable=productKeyTable, sWUpdateControl=sWUpdateControl, moduleHwSerialNumber=moduleHwSerialNumber, productKeyCipher=productKeyCipher, moduleEntry=moduleEntry, receiverCommunity=receiverCommunity, moduleNotebookTable=moduleNotebookTable, productKeyFeatureEntry=productKeyFeatureEntry, controlLocalAccess=controlLocalAccess, moduleBusAddress=moduleBusAddress, moduleStatusTable=moduleStatusTable, moduleMacAddress=moduleMacAddress, moduleRegistryEntry=moduleRegistryEntry, regValue=regValue, repairComment=repairComment, elementLatitude=elementLatitude, moduleAppDate=moduleAppDate, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusRunningSwImage=statusRunningSwImage, moduleSWUpdateEntry=moduleSWUpdateEntry, repairDate=repairDate, statusLid=statusLid, elementStructure=elementStructure, element=element, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairReasonCode=repairReasonCode, sWUpdateStatus=sWUpdateStatus, elementProductKey=elementProductKey, moduleDetailTable=moduleDetailTable, elementControl=elementControl, moduleNotebookEntry=moduleNotebookEntry, productKeyValue=productKeyValue, statusResetCause=statusResetCause, regIndex=regIndex, receiverPort=receiverPort, productKeyFeatureIndex=productKeyFeatureIndex, statusBusMaster=statusBusMaster, statusTemperature=statusTemperature, productKeyFeatureTable=productKeyFeatureTable, moduleSizeOfTable=moduleSizeOfTable, statusLidStatus=statusLidStatus, statusSoftware=statusSoftware, controlTempDeadBand=controlTempDeadBand, sizeOfNotebook=sizeOfNotebook, receiverAddress=receiverAddress, moduleRegistryTable=moduleRegistryTable, elementTotalUpTime=elementTotalUpTime, moduleInformation=moduleInformation, controlTempLimitLo=controlTempLimitLo, statusGeneral=statusGeneral, moduleRepairLogTable=moduleRepairLogTable, controlTrapReceiverTable=controlTrapReceiverTable, elementName=elementName, moduleDetailEntry=moduleDetailEntry, swUpdateURL=swUpdateURL, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogEntry=moduleRepairLogEntry, regName=regName, controlTempLimitHiHi=controlTempLimitHiHi, moduleStatus=moduleStatus, moduleSWUpdateTable=moduleSWUpdateTable, productKeyIndex=productKeyIndex, controlReset=controlReset, sWUpdateFileName=sWUpdateFileName, elementStatus=elementStatus, productKeyFeatureName=productKeyFeatureName, moduleBiosVersion=moduleBiosVersion, moduleTable=moduleTable, moduleHwVersion=moduleHwVersion, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapInterval=controlTrapInterval, controlInternalAppAccess=controlInternalAppAccess, moduleControl=moduleControl, elementInformation=elementInformation, moduleSizeOfEntry=moduleSizeOfEntry, moduleSlotNo=moduleSlotNo, controlTempLimitHi=controlTempLimitHi, notebookLineNumber=notebookLineNumber, moduleStatusEntry=moduleStatusEntry, statusHardware=statusHardware, controlMarkState=controlMarkState, controlBusMasterAdminState=controlBusMasterAdminState, moduleHwType=moduleHwType, elementResetCount=elementResetCount, controlTrapSending=controlTrapSending, repairNameCode=repairNameCode, moduleRegistry=moduleRegistry, sizeOfRegistry=sizeOfRegistry, productKeyStatus=productKeyStatus, controlLedUsage=controlLedUsage, receiverEntryId=receiverEntryId, elementAltitude=elementAltitude, moduleBiosDate=moduleBiosDate, controlAlarmOnDelay=controlAlarmOnDelay, moduleControlTable=moduleControlTable, statusFan=statusFan, controlResetElement=controlResetElement, controlAlarmOffDelay=controlAlarmOffDelay)
