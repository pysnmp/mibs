...
ModuleIdentity, Counter64, Integer32, IpAddress, TimeTicks, Gauge32, Counter32, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "IpAddress", "TimeTicks", "Gauge32", "Counter32", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairNameCode=repairNameCode, sizeOfRepairlog=sizeOfRepairlog, element=element, moduleInformation=moduleInformation, controlResetElement=controlResetElement, moduleNotebookTable=moduleNotebookTable, statusLmt=statusLmt, statusFan=statusFan, statusHardware=statusHardware, productKeyMask=productKeyMask, moduleBiosVersion=moduleBiosVersion, regValue=regValue, elementResetCount=elementResetCount, sWUpdateControl=sWUpdateControl, controlAlarmOffDelay=controlAlarmOffDelay, statusLid=statusLid, moduleName=moduleName, moduleHwSerialNumber=moduleHwSerialNumber, statusRestartCounter=statusRestartCounter, statusTemperature=statusTemperature, repairDate=repairDate, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistryEntry=moduleRegistryEntry, controlBusMasterAdminState=controlBusMasterAdminState, elementAltitude=elementAltitude, controlTrapSending=controlTrapSending, productKeyCipher=productKeyCipher, regIndex=regIndex, moduleMacAddress=moduleMacAddress, controlTempLimitHiHi=controlTempLimitHiHi, moduleSlotNo=moduleSlotNo, moduleAppVersion=moduleAppVersion, moduleDetailTable=moduleDetailTable, moduleRegistryTable=moduleRegistryTable, statusRunningSwImage=statusRunningSwImage, moduleTable=moduleTable, controlTrapInterval=controlTrapInterval, elementConfigChangeCode=elementConfigChangeCode, moduleHwType=moduleHwType, swUpdateURL=swUpdateURL, controlLocalAccess=controlLocalAccess, productKeyFeatureEnable=productKeyFeatureEnable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTempDeadBand=controlTempDeadBand, moduleControlTable=moduleControlTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleRegistry=moduleRegistry, sizeOfNotebook=sizeOfNotebook, controlTempLimitLoLo=controlTempLimitLoLo, moduleControlEntry=moduleControlEntry, sWUpdateStatus=sWUpdateStatus, productKeyTable=productKeyTable, receiverPort=receiverPort, elementLatitude=elementLatitude, productKeyFeatureEntry=productKeyFeatureEntry, module=module, moduleBusAddress=moduleBusAddress, repairReasonCode=repairReasonCode, receiverEntryId=receiverEntryId, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTempLimitLo=controlTempLimitLo, moduleRackNo=moduleRackNo, moduleDetailEntry=moduleDetailEntry, elementTotalUpTime=elementTotalUpTime, notebookLineText=notebookLineText, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleControl=moduleControl, moduleSWUpdateTable=moduleSWUpdateTable, statusGeneral=statusGeneral, moduleAppDate=moduleAppDate, repairComment=repairComment, productKeyFeatureTable=productKeyFeatureTable, controlAlarmDetection=controlAlarmDetection, productKeyValue=productKeyValue, statusInternalTemperature=statusInternalTemperature, elementControl=elementControl, statusSoftware=statusSoftware, receiverAddress=receiverAddress, moduleSizeOfEntry=moduleSizeOfEntry, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapReceiverEntry=controlTrapReceiverEntry, controlMarkState=controlMarkState, controlLedUsage=controlLedUsage, elementProductKey=elementProductKey, productKeyStatus=productKeyStatus, moduleStatusEntry=moduleStatusEntry, notebookLineNumber=notebookLineNumber, receiverCommunity=receiverCommunity, statusLidStatus=statusLidStatus, controlTrapDelay=controlTrapDelay, elementLongitude=elementLongitude, moduleStatus=moduleStatus, productKeyEntry=productKeyEntry, productKeyFeatureName=productKeyFeatureName, moduleBiosDate=moduleBiosDate, elementInformation=elementInformation, statusResetCause=statusResetCause, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleId=moduleId, productKeyIndex=productKeyIndex, statusBusMaster=statusBusMaster, moduleSizeOfTable=moduleSizeOfTable, statusSettings=statusSettings, elementName=elementName, moduleStatusTable=moduleStatusTable, sWUpdateFileName=sWUpdateFileName, controlInternalAppAccess=controlInternalAppAccess, controlTempLimitHi=controlTempLimitHi, moduleRepairLogTable=moduleRepairLogTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleHwVersion=moduleHwVersion, elementStatus=elementStatus, regName=regName, sizeOfRegistry=sizeOfRegistry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlReset=controlReset, repairIndex=repairIndex, moduleEntry=moduleEntry, elementStructure=elementStructure)
