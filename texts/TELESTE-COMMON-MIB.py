...
TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter64, IpAddress, NotificationType, Gauge32, MibIdentifier, iso, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "Gauge32", "MibIdentifier", "iso", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleControl=moduleControl, controlTempLimitLo=controlTempLimitLo, statusLmt=statusLmt, elementName=elementName, statusInternalTemperature=statusInternalTemperature, productKeyCipher=productKeyCipher, moduleRegistryEntry=moduleRegistryEntry, controlTrapDelay=controlTrapDelay, receiverPort=receiverPort, statusLidStatus=statusLidStatus, regName=regName, moduleEntry=moduleEntry, productKeyMask=productKeyMask, sWUpdateStatus=sWUpdateStatus, receiverAddress=receiverAddress, moduleStatusEntry=moduleStatusEntry, sizeOfRegistry=sizeOfRegistry, productKeyEntry=productKeyEntry, moduleHwType=moduleHwType, moduleSizeOfTable=moduleSizeOfTable, statusLid=statusLid, elementStructure=elementStructure, module=module, statusResetCause=statusResetCause, moduleNotebookTable=moduleNotebookTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleHwSerialNumber=moduleHwSerialNumber, moduleControlEntry=moduleControlEntry, controlBusMasterAdminState=controlBusMasterAdminState, element=element, controlLocalAccess=controlLocalAccess, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleAppDate=moduleAppDate, controlTempDeadBand=controlTempDeadBand, regIndex=regIndex, moduleTable=moduleTable, moduleBusAddress=moduleBusAddress, moduleName=moduleName, moduleHwVersion=moduleHwVersion, controlLedUsage=controlLedUsage, controlInternalAppAccess=controlInternalAppAccess, productKeyNumberOfKeys=productKeyNumberOfKeys, notebookLineNumber=notebookLineNumber, receiverCommunity=receiverCommunity, notebookLineText=notebookLineText, moduleRepairLogEntry=moduleRepairLogEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementTotalUpTime=elementTotalUpTime, productKeyFeatureTable=productKeyFeatureTable, statusHardware=statusHardware, statusRestartCounter=statusRestartCounter, controlMarkState=controlMarkState, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairDate=repairDate, elementStatus=elementStatus, elementConfigChangeCode=elementConfigChangeCode, controlAlarmDetection=controlAlarmDetection, moduleDetailTable=moduleDetailTable, repairIndex=repairIndex, productKeyValue=productKeyValue, moduleAppVersion=moduleAppVersion, moduleId=moduleId, statusBusMaster=statusBusMaster, controlTrapSending=controlTrapSending, moduleBiosDate=moduleBiosDate, statusGeneral=statusGeneral, moduleDetailEntry=moduleDetailEntry, statusTemperature=statusTemperature, moduleInformation=moduleInformation, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistry=moduleRegistry, statusFan=statusFan, statusSoftware=statusSoftware, moduleStatusTable=moduleStatusTable, controlReset=controlReset, controlTrapInterval=controlTrapInterval, productKeyTable=productKeyTable, controlTempLimitLoLo=controlTempLimitLoLo, controlTrapLifeTime=controlTrapLifeTime, moduleSizeOfEntry=moduleSizeOfEntry, moduleControlTable=moduleControlTable, productKeyFeatureIndex=productKeyFeatureIndex, repairNameCode=repairNameCode, receiverEntryId=receiverEntryId, productKeyStatus=productKeyStatus, sizeOfRepairlog=sizeOfRepairlog, elementInformation=elementInformation, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementProductKey=elementProductKey, moduleMacAddress=moduleMacAddress, sWUpdateControl=sWUpdateControl, controlAlarmOffDelay=controlAlarmOffDelay, productKeyIndex=productKeyIndex, repairReasonCode=repairReasonCode, statusRunningSwImage=statusRunningSwImage, swUpdateURL=swUpdateURL, moduleRackNo=moduleRackNo, controlResetElement=controlResetElement, sizeOfNotebook=sizeOfNotebook, repairComment=repairComment, productKeyFeatureName=productKeyFeatureName, controlTempLimitHi=controlTempLimitHi, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, elementResetCount=elementResetCount, controlAlarmOnDelay=controlAlarmOnDelay, regValue=regValue, statusSettings=statusSettings, moduleBiosVersion=moduleBiosVersion, moduleRegistryTable=moduleRegistryTable, moduleStatus=moduleStatus, elementLatitude=elementLatitude, sWUpdateFileName=sWUpdateFileName, moduleNotebookEntry=moduleNotebookEntry, elementControl=elementControl, moduleSlotNo=moduleSlotNo, controlTrapReceiverEntry=controlTrapReceiverEntry, elementLongitude=elementLongitude, controlTempLimitHiHi=controlTempLimitHiHi, moduleRepairLogTable=moduleRepairLogTable, elementAltitude=elementAltitude)
