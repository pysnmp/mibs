...
Counter64, ModuleIdentity, Counter32, IpAddress, Bits, Integer32, Gauge32, MibIdentifier, iso, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Counter32", "IpAddress", "Bits", "Integer32", "Gauge32", "MibIdentifier", "iso", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateStatus=sWUpdateStatus, controlTrapDelay=controlTrapDelay, moduleMacAddress=moduleMacAddress, sWUpdateFileName=sWUpdateFileName, repairNameCode=repairNameCode, sizeOfRepairlog=sizeOfRepairlog, module=module, element=element, productKeyTable=productKeyTable, productKeyFeatureEntry=productKeyFeatureEntry, moduleStatusEntry=moduleStatusEntry, moduleInformation=moduleInformation, controlResetElement=controlResetElement, moduleRegistryEntry=moduleRegistryEntry, statusLid=statusLid, controlAlarmOnDelay=controlAlarmOnDelay, productKeyNumberOfKeys=productKeyNumberOfKeys, controlReset=controlReset, moduleEntry=moduleEntry, moduleBiosVersion=moduleBiosVersion, controlTempDeadBand=controlTempDeadBand, elementInformation=elementInformation, elementProductKey=elementProductKey, moduleSizeOfTable=moduleSizeOfTable, moduleHwVersion=moduleHwVersion, repairIndex=repairIndex, regValue=regValue, receiverEntryId=receiverEntryId, sizeOfNotebook=sizeOfNotebook, receiverAddress=receiverAddress, moduleSlotNo=moduleSlotNo, swUpdateURL=swUpdateURL, productKeyValue=productKeyValue, elementTotalUpTime=elementTotalUpTime, productKeyStatus=productKeyStatus, statusResetCause=statusResetCause, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapReceiverEntry=controlTrapReceiverEntry, statusTemperature=statusTemperature, controlTrapInterval=controlTrapInterval, moduleRegistry=moduleRegistry, controlInternalAppAccess=controlInternalAppAccess, repairDate=repairDate, elementLongitude=elementLongitude, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairComment=repairComment, moduleAppVersion=moduleAppVersion, moduleAppDate=moduleAppDate, moduleNotebookTable=moduleNotebookTable, productKeyFeatureEnable=productKeyFeatureEnable, productKeyIndex=productKeyIndex, productKeyFeatureName=productKeyFeatureName, statusSoftware=statusSoftware, controlAlarmDetection=controlAlarmDetection, controlTrapReceiverTable=controlTrapReceiverTable, moduleBusAddress=moduleBusAddress, controlBusMasterAdminState=controlBusMasterAdminState, notebookLineNumber=notebookLineNumber, regName=regName, moduleNotebookEntry=moduleNotebookEntry, statusFan=statusFan, elementAltitude=elementAltitude, controlTrapSending=controlTrapSending, receiverCommunity=receiverCommunity, moduleId=moduleId, moduleBiosDate=moduleBiosDate, productKeyFeatureIndex=productKeyFeatureIndex, productKeyMask=productKeyMask, moduleControlEntry=moduleControlEntry, moduleDetailEntry=moduleDetailEntry, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfEntry=moduleSizeOfEntry, moduleRepairLogTable=moduleRepairLogTable, sWUpdateControl=sWUpdateControl, elementStructure=elementStructure, moduleRepairLogEntry=moduleRepairLogEntry, repairReasonCode=repairReasonCode, controlMarkState=controlMarkState, controlTempLimitHiHi=controlTempLimitHiHi, sizeOfRegistry=sizeOfRegistry, controlTrapLifeTime=controlTrapLifeTime, controlAlarmOffDelay=controlAlarmOffDelay, productKeyCipher=productKeyCipher, statusRunningSwImage=statusRunningSwImage, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyEntry=productKeyEntry, productKeyFeatureTable=productKeyFeatureTable, notebookLineText=notebookLineText, moduleRackNo=moduleRackNo, statusHardware=statusHardware, statusGeneral=statusGeneral, moduleControl=moduleControl, moduleControlTable=moduleControlTable, statusLidStatus=statusLidStatus, moduleStatusTable=moduleStatusTable, controlLocalAccess=controlLocalAccess, elementLatitude=elementLatitude, moduleName=moduleName, moduleDetailTable=moduleDetailTable, statusInternalTemperature=statusInternalTemperature, statusBusMaster=statusBusMaster, elementName=elementName, moduleTable=moduleTable, controlTempLimitHi=controlTempLimitHi, elementControl=elementControl, controlTempLimitLoLo=controlTempLimitLoLo, moduleHwType=moduleHwType, elementResetCount=elementResetCount, moduleSWUpdateTable=moduleSWUpdateTable, receiverPort=receiverPort, statusRestartCounter=statusRestartCounter, elementConfigChangeCode=elementConfigChangeCode, controlLedUsage=controlLedUsage, moduleStatus=moduleStatus, statusSettings=statusSettings, controlTempLimitLo=controlTempLimitLo, statusLmt=statusLmt, elementStatus=elementStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRegistryTable=moduleRegistryTable, regIndex=regIndex)
