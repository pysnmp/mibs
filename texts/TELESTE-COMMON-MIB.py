...
Integer32, NotificationType, ModuleIdentity, Unsigned32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, iso, MibIdentifier, Counter64, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "Counter64", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateFileName=sWUpdateFileName, statusTemperature=statusTemperature, regName=regName, controlTrapInterval=controlTrapInterval, moduleSlotNo=moduleSlotNo, receiverAddress=receiverAddress, moduleHwVersion=moduleHwVersion, notebookLineText=notebookLineText, productKeyFeatureName=productKeyFeatureName, moduleControlEntry=moduleControlEntry, receiverPort=receiverPort, productKeyEntry=productKeyEntry, controlMarkState=controlMarkState, controlAlarmDetection=controlAlarmDetection, elementStructure=elementStructure, moduleId=moduleId, elementTotalUpTime=elementTotalUpTime, controlTrapDelay=controlTrapDelay, elementConfigChangeCode=elementConfigChangeCode, elementControl=elementControl, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, repairIndex=repairIndex, elementLatitude=elementLatitude, statusResetCause=statusResetCause, receiverEntryId=receiverEntryId, productKeyCipher=productKeyCipher, moduleName=moduleName, moduleControl=moduleControl, sizeOfNotebook=sizeOfNotebook, moduleRackNo=moduleRackNo, moduleTable=moduleTable, elementStatus=elementStatus, controlTempLimitLoLo=controlTempLimitLoLo, sizeOfRegistry=sizeOfRegistry, statusSoftware=statusSoftware, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmOnDelay=controlAlarmOnDelay, controlLedUsage=controlLedUsage, productKeyFeatureEntry=productKeyFeatureEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleNotebookTable=moduleNotebookTable, moduleDetailEntry=moduleDetailEntry, productKeyTable=productKeyTable, statusLmt=statusLmt, repairDate=repairDate, controlTrapReceiverTable=controlTrapReceiverTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, receiverCommunity=receiverCommunity, productKeyFeatureEnable=productKeyFeatureEnable, regValue=regValue, statusLid=statusLid, moduleStatusTable=moduleStatusTable, elementInformation=elementInformation, statusInternalTemperature=statusInternalTemperature, moduleRepairLogTable=moduleRepairLogTable, controlTrapSending=controlTrapSending, statusSettings=statusSettings, sWUpdateStatus=sWUpdateStatus, statusBusMaster=statusBusMaster, statusGeneral=statusGeneral, regIndex=regIndex, repairNameCode=repairNameCode, moduleSizeOfEntry=moduleSizeOfEntry, controlInternalAppAccess=controlInternalAppAccess, moduleStatus=moduleStatus, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateControl=sWUpdateControl, controlTempLimitHi=controlTempLimitHi, productKeyValue=productKeyValue, moduleRegistryEntry=moduleRegistryEntry, elementResetCount=elementResetCount, moduleMacAddress=moduleMacAddress, productKeyFeatureTable=productKeyFeatureTable, moduleHwType=moduleHwType, moduleNotebookEntry=moduleNotebookEntry, moduleStatusEntry=moduleStatusEntry, moduleAppVersion=moduleAppVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, element=element, statusHardware=statusHardware, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosDate=moduleBiosDate, repairComment=repairComment, productKeyIndex=productKeyIndex, moduleEntry=moduleEntry, elementName=elementName, elementProductKey=elementProductKey, controlTempLimitLo=controlTempLimitLo, elementAltitude=elementAltitude, moduleDetailTable=moduleDetailTable, controlAlarmOffDelay=controlAlarmOffDelay, moduleRegistryTable=moduleRegistryTable, sizeOfRepairlog=sizeOfRepairlog, statusRunningSwImage=statusRunningSwImage, statusLidStatus=statusLidStatus, moduleSizeOfTable=moduleSizeOfTable, moduleAppDate=moduleAppDate, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTempDeadBand=controlTempDeadBand, moduleRegistry=moduleRegistry, productKeyMask=productKeyMask, module=module, controlBusMasterAdminState=controlBusMasterAdminState, controlLocalAccess=controlLocalAccess, notebookLineNumber=notebookLineNumber, swUpdateURL=swUpdateURL, controlResetElement=controlResetElement, moduleControlTable=moduleControlTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleSWUpdateTable=moduleSWUpdateTable, moduleBusAddress=moduleBusAddress, moduleInformation=moduleInformation, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, repairReasonCode=repairReasonCode, statusFan=statusFan, controlTrapLifeTime=controlTrapLifeTime, controlReset=controlReset, elementLongitude=elementLongitude, moduleHwSerialNumber=moduleHwSerialNumber, statusRestartCounter=statusRestartCounter)
