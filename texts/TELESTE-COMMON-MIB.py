...
TimeTicks, ModuleIdentity, Counter32, Integer32, ObjectIdentity, Bits, NotificationType, Gauge32, iso, Unsigned32, Counter64, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Counter32", "Integer32", "ObjectIdentity", "Bits", "NotificationType", "Gauge32", "iso", "Unsigned32", "Counter64", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyMask=productKeyMask, moduleRepairLogEntry=moduleRepairLogEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlInternalAppAccess=controlInternalAppAccess, elementProductKey=elementProductKey, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleNotebookTable=moduleNotebookTable, controlTrapSending=controlTrapSending, regName=regName, controlTrapLifeTime=controlTrapLifeTime, moduleSlotNo=moduleSlotNo, statusLmt=statusLmt, elementLatitude=elementLatitude, module=module, elementTotalUpTime=elementTotalUpTime, statusLidStatus=statusLidStatus, notebookLineText=notebookLineText, moduleId=moduleId, moduleStatusTable=moduleStatusTable, productKeyFeatureName=productKeyFeatureName, statusGeneral=statusGeneral, moduleInformation=moduleInformation, elementLongitude=elementLongitude, moduleSizeOfTable=moduleSizeOfTable, repairNameCode=repairNameCode, controlLedUsage=controlLedUsage, receiverPort=receiverPort, controlBusMasterAdminState=controlBusMasterAdminState, moduleSizeOfEntry=moduleSizeOfEntry, statusFan=statusFan, statusHardware=statusHardware, sWUpdateStatus=sWUpdateStatus, productKeyFeatureTable=productKeyFeatureTable, repairIndex=repairIndex, receiverCommunity=receiverCommunity, statusBusMaster=statusBusMaster, statusRunningSwImage=statusRunningSwImage, moduleControl=moduleControl, controlAlarmOffDelay=controlAlarmOffDelay, moduleMacAddress=moduleMacAddress, moduleSWUpdateEntry=moduleSWUpdateEntry, repairDate=repairDate, moduleHwType=moduleHwType, controlMarkState=controlMarkState, statusSoftware=statusSoftware, controlTempLimitLoLo=controlTempLimitLoLo, productKeyEntry=productKeyEntry, moduleBusAddress=moduleBusAddress, productKeyFeatureIndex=productKeyFeatureIndex, productKeyStatus=productKeyStatus, moduleRegistryTable=moduleRegistryTable, notebookLineNumber=notebookLineNumber, statusTemperature=statusTemperature, productKeyTable=productKeyTable, moduleAppVersion=moduleAppVersion, productKeyCipher=productKeyCipher, controlAlarmDetection=controlAlarmDetection, controlTempDeadBand=controlTempDeadBand, moduleAppDate=moduleAppDate, statusResetCause=statusResetCause, controlTrapReceiverTable=controlTrapReceiverTable, controlResetElement=controlResetElement, moduleStatus=moduleStatus, moduleRepairLogTable=moduleRepairLogTable, repairComment=repairComment, productKeyIndex=productKeyIndex, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistry=moduleRegistry, controlTempLimitHi=controlTempLimitHi, moduleDetailTable=moduleDetailTable, statusSettings=statusSettings, moduleControlEntry=moduleControlEntry, elementResetCount=elementResetCount, regValue=regValue, elementInformation=elementInformation, statusLid=statusLid, controlReset=controlReset, controlTrapInterval=controlTrapInterval, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosVersion=moduleBiosVersion, controlTempLimitLo=controlTempLimitLo, sizeOfRepairlog=sizeOfRepairlog, elementStructure=elementStructure, element=element, moduleTable=moduleTable, moduleHwVersion=moduleHwVersion, sizeOfRegistry=sizeOfRegistry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRackNo=moduleRackNo, elementStatus=elementStatus, moduleBiosDate=moduleBiosDate, regIndex=regIndex, statusInternalTemperature=statusInternalTemperature, swUpdateURL=swUpdateURL, moduleRegistryEntry=moduleRegistryEntry, moduleNotebookEntry=moduleNotebookEntry, moduleStatusEntry=moduleStatusEntry, receiverEntryId=receiverEntryId, moduleDetailEntry=moduleDetailEntry, moduleControlTable=moduleControlTable, controlTrapDelay=controlTrapDelay, sWUpdateFileName=sWUpdateFileName, productKeyValue=productKeyValue, moduleName=moduleName, productKeyFeatureEnable=productKeyFeatureEnable, repairReasonCode=repairReasonCode, sWUpdateControl=sWUpdateControl, controlAlarmOnDelay=controlAlarmOnDelay, elementControl=elementControl, elementAltitude=elementAltitude, controlLocalAccess=controlLocalAccess, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureEntry=productKeyFeatureEntry, controlTempLimitHiHi=controlTempLimitHiHi, statusRestartCounter=statusRestartCounter, moduleHwSerialNumber=moduleHwSerialNumber, elementName=elementName, receiverAddress=receiverAddress, sizeOfNotebook=sizeOfNotebook, moduleEntry=moduleEntry)
