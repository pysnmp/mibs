...
IpAddress, ModuleIdentity, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Unsigned32, Integer32, NotificationType, ObjectIdentity, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRackNo=moduleRackNo, repairIndex=repairIndex, moduleControl=moduleControl, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEntry=productKeyFeatureEntry, statusLid=statusLid, moduleInformation=moduleInformation, regValue=regValue, statusHardware=statusHardware, receiverPort=receiverPort, moduleNotebookEntry=moduleNotebookEntry, module=module, receiverAddress=receiverAddress, productKeyTable=productKeyTable, receiverEntryId=receiverEntryId, productKeyIndex=productKeyIndex, elementResetCount=elementResetCount, moduleRegistryTable=moduleRegistryTable, moduleHwType=moduleHwType, sWUpdateControl=sWUpdateControl, productKeyCipher=productKeyCipher, statusLmt=statusLmt, moduleSWUpdateEntry=moduleSWUpdateEntry, repairComment=repairComment, elementStatus=elementStatus, statusTemperature=statusTemperature, controlBusMasterAdminState=controlBusMasterAdminState, statusSoftware=statusSoftware, receiverCommunity=receiverCommunity, elementInformation=elementInformation, productKeyMask=productKeyMask, controlTrapDelay=controlTrapDelay, elementLatitude=elementLatitude, elementAltitude=elementAltitude, controlTempLimitLo=controlTempLimitLo, elementLongitude=elementLongitude, moduleSizeOfEntry=moduleSizeOfEntry, statusResetCause=statusResetCause, productKeyEntry=productKeyEntry, moduleControlTable=moduleControlTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleBiosDate=moduleBiosDate, moduleSWUpdateTable=moduleSWUpdateTable, controlReset=controlReset, moduleEntry=moduleEntry, elementStructure=elementStructure, controlTempLimitLoLo=controlTempLimitLoLo, controlLocalAccess=controlLocalAccess, controlTempLimitHi=controlTempLimitHi, moduleAppVersion=moduleAppVersion, productKeyStatus=productKeyStatus, moduleNotebookTable=moduleNotebookTable, moduleRepairLogTable=moduleRepairLogTable, moduleSlotNo=moduleSlotNo, statusFan=statusFan, notebookLineNumber=notebookLineNumber, controlTrapReceiverTable=controlTrapReceiverTable, controlTempLimitHiHi=controlTempLimitHiHi, statusInternalTemperature=statusInternalTemperature, moduleBiosVersion=moduleBiosVersion, controlLedUsage=controlLedUsage, moduleStatusTable=moduleStatusTable, elementProductKey=elementProductKey, statusRestartCounter=statusRestartCounter, controlTempDeadBand=controlTempDeadBand, repairDate=repairDate, sizeOfRegistry=sizeOfRegistry, controlTrapReceiverEntry=controlTrapReceiverEntry, element=element, moduleHwVersion=moduleHwVersion, controlAlarmOffDelay=controlAlarmOffDelay, controlInternalAppAccess=controlInternalAppAccess, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleTable=moduleTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementConfigChangeCode=elementConfigChangeCode, swUpdateURL=swUpdateURL, regIndex=regIndex, statusGeneral=statusGeneral, controlTrapInterval=controlTrapInterval, productKeyValue=productKeyValue, elementControl=elementControl, sizeOfNotebook=sizeOfNotebook, statusLidStatus=statusLidStatus, statusSettings=statusSettings, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureIndex=productKeyFeatureIndex, moduleId=moduleId, moduleDetailTable=moduleDetailTable, moduleMacAddress=moduleMacAddress, moduleRegistry=moduleRegistry, sWUpdateStatus=sWUpdateStatus, repairNameCode=repairNameCode, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppDate=moduleAppDate, controlMarkState=controlMarkState, notebookLineText=notebookLineText, controlAlarmDetection=controlAlarmDetection, moduleControlEntry=moduleControlEntry, sWUpdateFileName=sWUpdateFileName, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfTable=moduleSizeOfTable, productKeyNumberOfKeys=productKeyNumberOfKeys, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sizeOfRepairlog=sizeOfRepairlog, moduleStatusEntry=moduleStatusEntry, repairReasonCode=repairReasonCode, moduleStatus=moduleStatus, moduleBusAddress=moduleBusAddress, statusBusMaster=statusBusMaster, moduleName=moduleName, moduleDetailEntry=moduleDetailEntry, elementName=elementName, controlAlarmOnDelay=controlAlarmOnDelay, controlResetElement=controlResetElement, regName=regName, moduleRegistryEntry=moduleRegistryEntry, controlTrapSending=controlTrapSending, elementTotalUpTime=elementTotalUpTime, statusRunningSwImage=statusRunningSwImage)
