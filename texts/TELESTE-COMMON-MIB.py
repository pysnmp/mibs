...
Gauge32, NotificationType, Integer32, Unsigned32, IpAddress, ModuleIdentity, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Bits, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Integer32", "Unsigned32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Bits", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairIndex=repairIndex, moduleBiosDate=moduleBiosDate, statusFan=statusFan, productKeyValue=productKeyValue, statusInternalTemperature=statusInternalTemperature, regIndex=regIndex, productKeyTable=productKeyTable, elementStructure=elementStructure, sizeOfNotebook=sizeOfNotebook, controlTempLimitLoLo=controlTempLimitLoLo, moduleInformation=moduleInformation, moduleStatus=moduleStatus, moduleRegistryTable=moduleRegistryTable, statusResetCause=statusResetCause, moduleName=moduleName, moduleBusAddress=moduleBusAddress, regName=regName, moduleRegistryEntry=moduleRegistryEntry, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, controlLedUsage=controlLedUsage, moduleNotebookTable=moduleNotebookTable, controlAlarmOnDelay=controlAlarmOnDelay, element=element, productKeyFeatureName=productKeyFeatureName, notebookLineText=notebookLineText, receiverAddress=receiverAddress, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTempDeadBand=controlTempDeadBand, controlAlarmDetection=controlAlarmDetection, statusBusMaster=statusBusMaster, controlTrapInterval=controlTrapInterval, moduleNotebookEntry=moduleNotebookEntry, moduleRepairLogEntry=moduleRepairLogEntry, elementTotalUpTime=elementTotalUpTime, moduleMacAddress=moduleMacAddress, moduleSizeOfEntry=moduleSizeOfEntry, moduleHwSerialNumber=moduleHwSerialNumber, productKeyEntry=productKeyEntry, moduleEntry=moduleEntry, statusGeneral=statusGeneral, controlTempLimitHi=controlTempLimitHi, moduleControlTable=moduleControlTable, controlMarkState=controlMarkState, elementConfigChangeCode=elementConfigChangeCode, moduleAppDate=moduleAppDate, controlBusMasterAdminState=controlBusMasterAdminState, repairNameCode=repairNameCode, controlLocalAccess=controlLocalAccess, productKeyFeatureIndex=productKeyFeatureIndex, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSlotNo=moduleSlotNo, productKeyIndex=productKeyIndex, controlTrapSending=controlTrapSending, elementInformation=elementInformation, controlResetElement=controlResetElement, productKeyCipher=productKeyCipher, moduleRegistry=moduleRegistry, moduleTable=moduleTable, moduleDetailEntry=moduleDetailEntry, sWUpdateControl=sWUpdateControl, productKeyFeatureEntry=productKeyFeatureEntry, moduleStatusTable=moduleStatusTable, elementLatitude=elementLatitude, swUpdateURL=swUpdateURL, moduleAppVersion=moduleAppVersion, sWUpdateStatus=sWUpdateStatus, elementResetCount=elementResetCount, productKeyFeatureTable=productKeyFeatureTable, elementLongitude=elementLongitude, controlTempLimitHiHi=controlTempLimitHiHi, moduleSizeOfTable=moduleSizeOfTable, statusSettings=statusSettings, controlTempLimitLo=controlTempLimitLo, statusLid=statusLid, receiverCommunity=receiverCommunity, controlTrapLifeTime=controlTrapLifeTime, moduleHwType=moduleHwType, moduleControl=moduleControl, elementControl=elementControl, controlTrapDelay=controlTrapDelay, statusLidStatus=statusLidStatus, receiverPort=receiverPort, repairReasonCode=repairReasonCode, elementProductKey=elementProductKey, notebookLineNumber=notebookLineNumber, controlTrapReceiverTable=controlTrapReceiverTable, repairDate=repairDate, statusTemperature=statusTemperature, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleRepairLogTable=moduleRepairLogTable, statusHardware=statusHardware, moduleStatusEntry=moduleStatusEntry, controlInternalAppAccess=controlInternalAppAccess, statusRestartCounter=statusRestartCounter, controlReset=controlReset, elementName=elementName, productKeyFeatureEnable=productKeyFeatureEnable, moduleControlEntry=moduleControlEntry, statusRunningSwImage=statusRunningSwImage, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementAltitude=elementAltitude, sizeOfRegistry=sizeOfRegistry, productKeyMask=productKeyMask, regValue=regValue, receiverEntryId=receiverEntryId, controlAlarmOffDelay=controlAlarmOffDelay, statusSoftware=statusSoftware, moduleRackNo=moduleRackNo, sWUpdateFileName=sWUpdateFileName, statusLmt=statusLmt, module=module, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleId=moduleId, moduleHwVersion=moduleHwVersion, sizeOfRepairlog=sizeOfRepairlog, moduleDetailTable=moduleDetailTable, elementStatus=elementStatus, repairComment=repairComment)
