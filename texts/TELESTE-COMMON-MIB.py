...
ModuleIdentity, Counter64, Gauge32, MibIdentifier, Unsigned32, Integer32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Gauge32", "MibIdentifier", "Unsigned32", "Integer32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLatitude=elementLatitude, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapInterval=controlTrapInterval, moduleDetailEntry=moduleDetailEntry, moduleBiosVersion=moduleBiosVersion, controlResetElement=controlResetElement, statusBusMaster=statusBusMaster, statusResetCause=statusResetCause, moduleHwSerialNumber=moduleHwSerialNumber, elementLongitude=elementLongitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlBusMasterAdminState=controlBusMasterAdminState, repairNameCode=repairNameCode, moduleRackNo=moduleRackNo, moduleTable=moduleTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, element=element, statusSettings=statusSettings, moduleDetailTable=moduleDetailTable, moduleHwVersion=moduleHwVersion, moduleRepairLogEntry=moduleRepairLogEntry, repairIndex=repairIndex, productKeyEntry=productKeyEntry, sWUpdateControl=sWUpdateControl, receiverEntryId=receiverEntryId, controlAlarmDetection=controlAlarmDetection, productKeyFeatureIndex=productKeyFeatureIndex, controlLocalAccess=controlLocalAccess, moduleRegistry=moduleRegistry, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineText=notebookLineText, elementTotalUpTime=elementTotalUpTime, statusLid=statusLid, sizeOfRegistry=sizeOfRegistry, elementResetCount=elementResetCount, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogTable=moduleRepairLogTable, controlLedUsage=controlLedUsage, elementName=elementName, elementAltitude=elementAltitude, statusTemperature=statusTemperature, moduleStatusEntry=moduleStatusEntry, controlTempDeadBand=controlTempDeadBand, productKeyValue=productKeyValue, sizeOfRepairlog=sizeOfRepairlog, elementStructure=elementStructure, notebookLineNumber=notebookLineNumber, statusLmt=statusLmt, moduleMacAddress=moduleMacAddress, productKeyStatus=productKeyStatus, elementInformation=elementInformation, controlMarkState=controlMarkState, statusInternalTemperature=statusInternalTemperature, regValue=regValue, moduleBusAddress=moduleBusAddress, moduleAppVersion=moduleAppVersion, statusSoftware=statusSoftware, moduleControlTable=moduleControlTable, receiverAddress=receiverAddress, moduleNotebookTable=moduleNotebookTable, productKeyFeatureName=productKeyFeatureName, productKeyCipher=productKeyCipher, elementStatus=elementStatus, elementControl=elementControl, productKeyIndex=productKeyIndex, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapReceiverTable=controlTrapReceiverTable, productKeyMask=productKeyMask, moduleControl=moduleControl, moduleHwType=moduleHwType, moduleName=moduleName, controlReset=controlReset, repairDate=repairDate, controlAlarmOnDelay=controlAlarmOnDelay, moduleStatusTable=moduleStatusTable, statusGeneral=statusGeneral, module=module, moduleRegistryTable=moduleRegistryTable, statusLidStatus=statusLidStatus, moduleEntry=moduleEntry, moduleRegistryEntry=moduleRegistryEntry, swUpdateURL=swUpdateURL, moduleNotebookEntry=moduleNotebookEntry, elementConfigChangeCode=elementConfigChangeCode, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleControlEntry=moduleControlEntry, controlInternalAppAccess=controlInternalAppAccess, moduleInformation=moduleInformation, controlTrapSending=controlTrapSending, elementProductKey=elementProductKey, moduleId=moduleId, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitHi=controlTempLimitHi, moduleSWUpdateTable=moduleSWUpdateTable, statusHardware=statusHardware, sWUpdateStatus=sWUpdateStatus, moduleSizeOfTable=moduleSizeOfTable, productKeyFeatureTable=productKeyFeatureTable, receiverPort=receiverPort, receiverCommunity=receiverCommunity, moduleBiosDate=moduleBiosDate, sizeOfNotebook=sizeOfNotebook, moduleStatus=moduleStatus, controlTrapLifeTime=controlTrapLifeTime, repairReasonCode=repairReasonCode, controlTrapDelay=controlTrapDelay, moduleAppDate=moduleAppDate, regName=regName, statusRestartCounter=statusRestartCounter, repairComment=repairComment, moduleSlotNo=moduleSlotNo, controlTempLimitLoLo=controlTempLimitLoLo, statusRunningSwImage=statusRunningSwImage, controlTempLimitLo=controlTempLimitLo, controlTempLimitHiHi=controlTempLimitHiHi, productKeyTable=productKeyTable, sWUpdateFileName=sWUpdateFileName, statusFan=statusFan, regIndex=regIndex)
