...
Counter64, Unsigned32, Gauge32, ObjectIdentity, Counter32, Bits, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "Bits", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateControl=sWUpdateControl, productKeyFeatureEntry=productKeyFeatureEntry, statusSettings=statusSettings, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleControlEntry=moduleControlEntry, module=module, elementConfigChangeCode=elementConfigChangeCode, elementControl=elementControl, elementAltitude=elementAltitude, moduleHwType=moduleHwType, moduleDetailEntry=moduleDetailEntry, statusInternalTemperature=statusInternalTemperature, regName=regName, swUpdateURL=swUpdateURL, statusHardware=statusHardware, productKeyValue=productKeyValue, productKeyFeatureTable=productKeyFeatureTable, controlTempDeadBand=controlTempDeadBand, moduleName=moduleName, productKeyFeatureIndex=productKeyFeatureIndex, elementName=elementName, moduleControl=moduleControl, controlReset=controlReset, productKeyMask=productKeyMask, moduleRepairLogEntry=moduleRepairLogEntry, sizeOfRepairlog=sizeOfRepairlog, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapLifeTime=controlTrapLifeTime, controlLedUsage=controlLedUsage, moduleSlotNo=moduleSlotNo, sizeOfNotebook=sizeOfNotebook, controlTrapReceiverEntry=controlTrapReceiverEntry, receiverCommunity=receiverCommunity, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryTable=moduleRegistryTable, controlAlarmOnDelay=controlAlarmOnDelay, regIndex=regIndex, moduleNotebookEntry=moduleNotebookEntry, moduleRegistryEntry=moduleRegistryEntry, controlTempLimitHi=controlTempLimitHi, moduleAppVersion=moduleAppVersion, sWUpdateFileName=sWUpdateFileName, regValue=regValue, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleEntry=moduleEntry, moduleSizeOfTable=moduleSizeOfTable, element=element, moduleId=moduleId, elementProductKey=elementProductKey, controlTempLimitLo=controlTempLimitLo, productKeyFeatureEnable=productKeyFeatureEnable, statusSoftware=statusSoftware, notebookLineText=notebookLineText, statusTemperature=statusTemperature, receiverPort=receiverPort, moduleRepairLogTable=moduleRepairLogTable, elementStatus=elementStatus, controlLocalAccess=controlLocalAccess, repairComment=repairComment, statusRunningSwImage=statusRunningSwImage, productKeyCipher=productKeyCipher, moduleControlTable=moduleControlTable, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitLoLo=controlTempLimitLoLo, moduleDetailTable=moduleDetailTable, productKeyStatus=productKeyStatus, statusBusMaster=statusBusMaster, controlAlarmOffDelay=controlAlarmOffDelay, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureName=productKeyFeatureName, repairNameCode=repairNameCode, statusLid=statusLid, repairReasonCode=repairReasonCode, statusFan=statusFan, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatusTable=moduleStatusTable, repairIndex=repairIndex, statusGeneral=statusGeneral, controlAlarmDetection=controlAlarmDetection, moduleMacAddress=moduleMacAddress, moduleRegistry=moduleRegistry, controlBusMasterAdminState=controlBusMasterAdminState, moduleTable=moduleTable, moduleStatusEntry=moduleStatusEntry, moduleBiosVersion=moduleBiosVersion, controlTrapInterval=controlTrapInterval, productKeyIndex=productKeyIndex, moduleBiosDate=moduleBiosDate, moduleStatus=moduleStatus, repairDate=repairDate, controlTrapDelay=controlTrapDelay, moduleNotebookTable=moduleNotebookTable, statusLmt=statusLmt, moduleSizeOfEntry=moduleSizeOfEntry, controlMarkState=controlMarkState, productKeyEntry=productKeyEntry, moduleHwVersion=moduleHwVersion, receiverAddress=receiverAddress, moduleHwSerialNumber=moduleHwSerialNumber, statusResetCause=statusResetCause, elementTotalUpTime=elementTotalUpTime, elementLatitude=elementLatitude, moduleBusAddress=moduleBusAddress, elementResetCount=elementResetCount, receiverEntryId=receiverEntryId, elementInformation=elementInformation, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleInformation=moduleInformation, sizeOfRegistry=sizeOfRegistry, moduleSWUpdateTable=moduleSWUpdateTable, moduleAppDate=moduleAppDate, statusLidStatus=statusLidStatus, statusRestartCounter=statusRestartCounter, controlTrapSending=controlTrapSending, notebookLineNumber=notebookLineNumber, controlResetElement=controlResetElement, elementStructure=elementStructure, elementLongitude=elementLongitude, sWUpdateStatus=sWUpdateStatus, moduleRackNo=moduleRackNo, productKeyTable=productKeyTable)
