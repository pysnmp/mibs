...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Bits, ObjectIdentity, iso, Integer32, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Bits", "ObjectIdentity", "iso", "Integer32", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleNotebookTable=moduleNotebookTable, sizeOfRepairlog=sizeOfRepairlog, moduleSWUpdateEntry=moduleSWUpdateEntry, sWUpdateControl=sWUpdateControl, statusGeneral=statusGeneral, moduleSWUpdateTable=moduleSWUpdateTable, controlTempDeadBand=controlTempDeadBand, elementConfigChangeCode=elementConfigChangeCode, productKeyMask=productKeyMask, controlReset=controlReset, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureIndex=productKeyFeatureIndex, moduleSizeOfEntry=moduleSizeOfEntry, controlMarkState=controlMarkState, statusSettings=statusSettings, controlTrapDelay=controlTrapDelay, controlTrapSending=controlTrapSending, moduleRegistry=moduleRegistry, regIndex=regIndex, elementName=elementName, statusLid=statusLid, repairReasonCode=repairReasonCode, productKeyTable=productKeyTable, statusHardware=statusHardware, productKeyStatus=productKeyStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, repairDate=repairDate, controlTrapLifeTime=controlTrapLifeTime, controlAlarmOnDelay=controlAlarmOnDelay, statusLidStatus=statusLidStatus, elementProductKey=elementProductKey, moduleDetailEntry=moduleDetailEntry, productKeyValue=productKeyValue, repairNameCode=repairNameCode, moduleHwType=moduleHwType, controlResetElement=controlResetElement, moduleDetailTable=moduleDetailTable, regValue=regValue, elementAltitude=elementAltitude, moduleHwSerialNumber=moduleHwSerialNumber, notebookLineText=notebookLineText, moduleMacAddress=moduleMacAddress, sWUpdateStatus=sWUpdateStatus, elementLatitude=elementLatitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapReceiverEntry=controlTrapReceiverEntry, elementStructure=elementStructure, repairIndex=repairIndex, swUpdateURL=swUpdateURL, statusResetCause=statusResetCause, controlTempLimitLo=controlTempLimitLo, controlTrapReceiverTable=controlTrapReceiverTable, elementControl=elementControl, moduleEntry=moduleEntry, moduleControl=moduleControl, statusSoftware=statusSoftware, controlLocalAccess=controlLocalAccess, moduleHwVersion=moduleHwVersion, repairComment=repairComment, moduleNotebookEntry=moduleNotebookEntry, statusFan=statusFan, moduleBiosDate=moduleBiosDate, moduleRepairLogTable=moduleRepairLogTable, moduleBusAddress=moduleBusAddress, regName=regName, receiverPort=receiverPort, productKeyEntry=productKeyEntry, productKeyFeatureEnable=productKeyFeatureEnable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfRegistry=sizeOfRegistry, elementStatus=elementStatus, productKeyIndex=productKeyIndex, moduleRackNo=moduleRackNo, moduleBiosVersion=moduleBiosVersion, receiverCommunity=receiverCommunity, controlTempLimitHi=controlTempLimitHi, statusLmt=statusLmt, moduleName=moduleName, moduleStatusTable=moduleStatusTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleRegistryEntry=moduleRegistryEntry, elementInformation=elementInformation, elementLongitude=elementLongitude, controlBusMasterAdminState=controlBusMasterAdminState, moduleRepairLogEntry=moduleRepairLogEntry, moduleRegistryTable=moduleRegistryTable, moduleStatusEntry=moduleStatusEntry, moduleAppVersion=moduleAppVersion, sWUpdateFileName=sWUpdateFileName, productKeyCipher=productKeyCipher, statusBusMaster=statusBusMaster, controlAlarmOffDelay=controlAlarmOffDelay, sizeOfNotebook=sizeOfNotebook, controlInternalAppAccess=controlInternalAppAccess, moduleControlTable=moduleControlTable, productKeyFeatureEntry=productKeyFeatureEntry, moduleSlotNo=moduleSlotNo, moduleStatus=moduleStatus, moduleTable=moduleTable, controlLedUsage=controlLedUsage, moduleSizeOfTable=moduleSizeOfTable, moduleInformation=moduleInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, notebookLineNumber=notebookLineNumber, statusRunningSwImage=statusRunningSwImage, elementResetCount=elementResetCount, receiverEntryId=receiverEntryId, statusInternalTemperature=statusInternalTemperature, moduleAppDate=moduleAppDate, element=element, statusRestartCounter=statusRestartCounter, elementTotalUpTime=elementTotalUpTime, controlAlarmDetection=controlAlarmDetection, controlTrapInterval=controlTrapInterval, productKeyFeatureName=productKeyFeatureName, moduleId=moduleId, statusTemperature=statusTemperature, moduleControlEntry=moduleControlEntry, receiverAddress=receiverAddress, module=module, productKeyFeatureTable=productKeyFeatureTable)
