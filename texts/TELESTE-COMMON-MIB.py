...
Bits, iso, Counter64, IpAddress, ObjectIdentity, Counter32, Unsigned32, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Counter64", "IpAddress", "ObjectIdentity", "Counter32", "Unsigned32", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOffDelay=controlAlarmOffDelay, controlTrapLifeTime=controlTrapLifeTime, moduleEntry=moduleEntry, controlBusMasterAdminState=controlBusMasterAdminState, sWUpdateFileName=sWUpdateFileName, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureEnable=productKeyFeatureEnable, moduleTable=moduleTable, moduleAppVersion=moduleAppVersion, moduleHwType=moduleHwType, controlTrapSending=controlTrapSending, productKeyFeatureName=productKeyFeatureName, statusGeneral=statusGeneral, sWUpdateControl=sWUpdateControl, moduleDetailEntry=moduleDetailEntry, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, elementAltitude=elementAltitude, statusInternalTemperature=statusInternalTemperature, productKeyMask=productKeyMask, regIndex=regIndex, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistry=moduleRegistry, controlLedUsage=controlLedUsage, moduleStatusTable=moduleStatusTable, moduleNotebookEntry=moduleNotebookEntry, elementStatus=elementStatus, receiverPort=receiverPort, moduleInformation=moduleInformation, moduleNotebookTable=moduleNotebookTable, elementProductKey=elementProductKey, moduleBiosDate=moduleBiosDate, moduleStatusEntry=moduleStatusEntry, statusSoftware=statusSoftware, regValue=regValue, controlTempLimitHiHi=controlTempLimitHiHi, moduleAppDate=moduleAppDate, moduleSlotNo=moduleSlotNo, productKeyIndex=productKeyIndex, controlTempLimitLoLo=controlTempLimitLoLo, productKeyNumberOfKeys=productKeyNumberOfKeys, controlReset=controlReset, controlTrapDelay=controlTrapDelay, statusLidStatus=statusLidStatus, sWUpdateStatus=sWUpdateStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyFeatureTable=productKeyFeatureTable, statusHardware=statusHardware, productKeyValue=productKeyValue, sizeOfRegistry=sizeOfRegistry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSWUpdateTable=moduleSWUpdateTable, moduleId=moduleId, moduleDetailTable=moduleDetailTable, moduleRackNo=moduleRackNo, sizeOfRepairlog=sizeOfRepairlog, statusSettings=statusSettings, moduleRegistryEntry=moduleRegistryEntry, moduleRegistryTable=moduleRegistryTable, repairComment=repairComment, elementStructure=elementStructure, elementLongitude=elementLongitude, elementControl=elementControl, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleStatus=moduleStatus, statusLid=statusLid, regName=regName, moduleControlTable=moduleControlTable, controlTempLimitLo=controlTempLimitLo, statusLmt=statusLmt, controlTempLimitHi=controlTempLimitHi, controlInternalAppAccess=controlInternalAppAccess, statusRunningSwImage=statusRunningSwImage, productKeyStatus=productKeyStatus, receiverEntryId=receiverEntryId, receiverAddress=receiverAddress, repairDate=repairDate, moduleName=moduleName, element=element, statusTemperature=statusTemperature, repairIndex=repairIndex, moduleSizeOfEntry=moduleSizeOfEntry, statusResetCause=statusResetCause, notebookLineNumber=notebookLineNumber, moduleHwVersion=moduleHwVersion, moduleHwSerialNumber=moduleHwSerialNumber, statusRestartCounter=statusRestartCounter, moduleMacAddress=moduleMacAddress, controlMarkState=controlMarkState, moduleRepairLogEntry=moduleRepairLogEntry, controlAlarmDetection=controlAlarmDetection, controlTempDeadBand=controlTempDeadBand, controlLocalAccess=controlLocalAccess, elementConfigChangeCode=elementConfigChangeCode, elementTotalUpTime=elementTotalUpTime, productKeyTable=productKeyTable, moduleSizeOfTable=moduleSizeOfTable, module=module, moduleControlEntry=moduleControlEntry, swUpdateURL=swUpdateURL, moduleControl=moduleControl, elementLatitude=elementLatitude, statusBusMaster=statusBusMaster, elementName=elementName, statusFan=statusFan, elementResetCount=elementResetCount, controlResetElement=controlResetElement, productKeyEntry=productKeyEntry, repairNameCode=repairNameCode, controlTrapInterval=controlTrapInterval, moduleBiosVersion=moduleBiosVersion, productKeyFeatureIndex=productKeyFeatureIndex, productKeyCipher=productKeyCipher, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfNotebook=sizeOfNotebook, repairReasonCode=repairReasonCode, elementInformation=elementInformation, moduleBusAddress=moduleBusAddress, notebookLineText=notebookLineText, receiverCommunity=receiverCommunity)
