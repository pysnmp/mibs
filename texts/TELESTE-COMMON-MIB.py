...
ObjectIdentity, Integer32, IpAddress, ModuleIdentity, Counter32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Unsigned32, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "IpAddress", "ModuleIdentity", "Counter32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapInterval=controlTrapInterval, productKeyEntry=productKeyEntry, productKeyFeatureIndex=productKeyFeatureIndex, statusSettings=statusSettings, moduleSWUpdateTable=moduleSWUpdateTable, sizeOfRepairlog=sizeOfRepairlog, controlTrapLifeTime=controlTrapLifeTime, statusRestartCounter=statusRestartCounter, controlBusMasterAdminState=controlBusMasterAdminState, moduleStatusTable=moduleStatusTable, controlTempLimitHiHi=controlTempLimitHiHi, regValue=regValue, moduleRegistryEntry=moduleRegistryEntry, productKeyIndex=productKeyIndex, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitHi=controlTempLimitHi, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRackNo=moduleRackNo, elementAltitude=elementAltitude, moduleControlEntry=moduleControlEntry, receiverAddress=receiverAddress, moduleInformation=moduleInformation, statusBusMaster=statusBusMaster, elementConfigChangeCode=elementConfigChangeCode, controlLedUsage=controlLedUsage, moduleBusAddress=moduleBusAddress, moduleHwType=moduleHwType, module=module, productKeyFeatureEnable=productKeyFeatureEnable, moduleHwSerialNumber=moduleHwSerialNumber, receiverPort=receiverPort, statusTemperature=statusTemperature, controlMarkState=controlMarkState, moduleBiosVersion=moduleBiosVersion, controlResetElement=controlResetElement, elementProductKey=elementProductKey, controlAlarmDetection=controlAlarmDetection, moduleRepairLogTable=moduleRepairLogTable, controlTempLimitLoLo=controlTempLimitLoLo, moduleAppVersion=moduleAppVersion, regIndex=regIndex, statusLmt=statusLmt, sWUpdateControl=sWUpdateControl, moduleHwVersion=moduleHwVersion, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatus=moduleStatus, controlTrapSending=controlTrapSending, productKeyFeatureTable=productKeyFeatureTable, repairNameCode=repairNameCode, repairDate=repairDate, moduleName=moduleName, elementInformation=elementInformation, productKeyTable=productKeyTable, regName=regName, moduleSWUpdateEntry=moduleSWUpdateEntry, repairReasonCode=repairReasonCode, statusSoftware=statusSoftware, productKeyMask=productKeyMask, moduleNotebookTable=moduleNotebookTable, moduleBiosDate=moduleBiosDate, productKeyValue=productKeyValue, sWUpdateStatus=sWUpdateStatus, moduleControl=moduleControl, elementLatitude=elementLatitude, statusResetCause=statusResetCause, controlAlarmOffDelay=controlAlarmOffDelay, elementControl=elementControl, productKeyCipher=productKeyCipher, controlTempLimitLo=controlTempLimitLo, moduleAppDate=moduleAppDate, productKeyFeatureEntry=productKeyFeatureEntry, sizeOfRegistry=sizeOfRegistry, statusFan=statusFan, controlAlarmOnDelay=controlAlarmOnDelay, controlInternalAppAccess=controlInternalAppAccess, swUpdateURL=swUpdateURL, statusGeneral=statusGeneral, elementLongitude=elementLongitude, productKeyStatus=productKeyStatus, sWUpdateFileName=sWUpdateFileName, controlTrapDelay=controlTrapDelay, elementResetCount=elementResetCount, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementStatus=elementStatus, moduleId=moduleId, moduleSlotNo=moduleSlotNo, receiverEntryId=receiverEntryId, moduleMacAddress=moduleMacAddress, statusLidStatus=statusLidStatus, moduleDetailTable=moduleDetailTable, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTempDeadBand=controlTempDeadBand, statusLid=statusLid, sizeOfNotebook=sizeOfNotebook, receiverCommunity=receiverCommunity, controlLocalAccess=controlLocalAccess, elementName=elementName, moduleEntry=moduleEntry, moduleDetailEntry=moduleDetailEntry, element=element, productKeyFeatureName=productKeyFeatureName, elementStructure=elementStructure, controlReset=controlReset, notebookLineText=notebookLineText, repairIndex=repairIndex, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRepairLogEntry=moduleRepairLogEntry, statusInternalTemperature=statusInternalTemperature, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryTable=moduleRegistryTable, moduleRegistry=moduleRegistry, statusRunningSwImage=statusRunningSwImage, elementTotalUpTime=elementTotalUpTime, moduleStatusEntry=moduleStatusEntry, notebookLineNumber=notebookLineNumber, moduleSizeOfEntry=moduleSizeOfEntry, moduleControlTable=moduleControlTable, moduleNotebookEntry=moduleNotebookEntry, statusHardware=statusHardware, moduleTable=moduleTable, repairComment=repairComment)
