...
MibIdentifier, iso, Gauge32, TimeTicks, NotificationType, ModuleIdentity, Bits, Counter32, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Gauge32", "TimeTicks", "NotificationType", "ModuleIdentity", "Bits", "Counter32", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureIndex=productKeyFeatureIndex, sizeOfNotebook=sizeOfNotebook, moduleInformation=moduleInformation, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementInformation=elementInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSizeOfTable=moduleSizeOfTable, controlReset=controlReset, moduleNotebookEntry=moduleNotebookEntry, repairReasonCode=repairReasonCode, controlTrapInterval=controlTrapInterval, receiverEntryId=receiverEntryId, sizeOfRegistry=sizeOfRegistry, statusTemperature=statusTemperature, controlResetElement=controlResetElement, moduleRepairLogEntry=moduleRepairLogEntry, elementLongitude=elementLongitude, notebookLineText=notebookLineText, moduleStatus=moduleStatus, controlMarkState=controlMarkState, moduleName=moduleName, sWUpdateFileName=sWUpdateFileName, elementAltitude=elementAltitude, regValue=regValue, productKeyTable=productKeyTable, moduleTable=moduleTable, moduleDetailEntry=moduleDetailEntry, elementStructure=elementStructure, controlTempLimitHiHi=controlTempLimitHiHi, moduleControl=moduleControl, moduleId=moduleId, elementConfigChangeCode=elementConfigChangeCode, statusFan=statusFan, swUpdateURL=swUpdateURL, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyCipher=productKeyCipher, moduleRegistry=moduleRegistry, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, regIndex=regIndex, controlTrapDelay=controlTrapDelay, moduleAppVersion=moduleAppVersion, statusInternalTemperature=statusInternalTemperature, receiverCommunity=receiverCommunity, moduleNotebookTable=moduleNotebookTable, moduleRepairLogTable=moduleRepairLogTable, statusRestartCounter=statusRestartCounter, receiverAddress=receiverAddress, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitLoLo=controlTempLimitLoLo, elementLatitude=elementLatitude, moduleDetailTable=moduleDetailTable, moduleRegistryTable=moduleRegistryTable, controlTempLimitLo=controlTempLimitLo, controlTempDeadBand=controlTempDeadBand, moduleHwType=moduleHwType, repairDate=repairDate, controlTrapSending=controlTrapSending, controlAlarmOnDelay=controlAlarmOnDelay, sizeOfRepairlog=sizeOfRepairlog, module=module, moduleEntry=moduleEntry, moduleMacAddress=moduleMacAddress, elementProductKey=elementProductKey, statusResetCause=statusResetCause, moduleStatusTable=moduleStatusTable, elementStatus=elementStatus, controlBusMasterAdminState=controlBusMasterAdminState, regName=regName, sWUpdateControl=sWUpdateControl, controlTempLimitHi=controlTempLimitHi, productKeyFeatureTable=productKeyFeatureTable, moduleBusAddress=moduleBusAddress, element=element, productKeyValue=productKeyValue, moduleSlotNo=moduleSlotNo, statusLid=statusLid, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, notebookLineNumber=notebookLineNumber, moduleStatusEntry=moduleStatusEntry, statusGeneral=statusGeneral, moduleControlEntry=moduleControlEntry, moduleHwVersion=moduleHwVersion, statusSoftware=statusSoftware, productKeyIndex=productKeyIndex, receiverPort=receiverPort, moduleSWUpdateTable=moduleSWUpdateTable, statusLmt=statusLmt, repairIndex=repairIndex, controlInternalAppAccess=controlInternalAppAccess, controlAlarmDetection=controlAlarmDetection, productKeyStatus=productKeyStatus, statusSettings=statusSettings, elementControl=elementControl, productKeyMask=productKeyMask, controlLedUsage=controlLedUsage, moduleHwSerialNumber=moduleHwSerialNumber, statusBusMaster=statusBusMaster, elementResetCount=elementResetCount, statusLidStatus=statusLidStatus, moduleControlTable=moduleControlTable, sWUpdateStatus=sWUpdateStatus, moduleRackNo=moduleRackNo, productKeyFeatureEnable=productKeyFeatureEnable, controlLocalAccess=controlLocalAccess, moduleSizeOfEntry=moduleSizeOfEntry, repairComment=repairComment, productKeyEntry=productKeyEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, elementTotalUpTime=elementTotalUpTime, elementName=elementName, statusHardware=statusHardware, repairNameCode=repairNameCode, statusRunningSwImage=statusRunningSwImage, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleBiosDate=moduleBiosDate, moduleBiosVersion=moduleBiosVersion, productKeyFeatureName=productKeyFeatureName, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleAppDate=moduleAppDate)
