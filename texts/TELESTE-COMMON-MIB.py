...
iso, MibIdentifier, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, Counter32, Gauge32, Bits, ObjectIdentity, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "Counter32", "Gauge32", "Bits", "ObjectIdentity", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverEntryId=receiverEntryId, controlTempLimitHi=controlTempLimitHi, regName=regName, notebookLineText=notebookLineText, controlTempDeadBand=controlTempDeadBand, moduleBusAddress=moduleBusAddress, statusLmt=statusLmt, controlResetElement=controlResetElement, statusLid=statusLid, controlTempLimitLo=controlTempLimitLo, elementStatus=elementStatus, elementTotalUpTime=elementTotalUpTime, moduleSWUpdateEntry=moduleSWUpdateEntry, statusTemperature=statusTemperature, controlTrapDelay=controlTrapDelay, productKeyCipher=productKeyCipher, receiverCommunity=receiverCommunity, elementLongitude=elementLongitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleAppDate=moduleAppDate, moduleSizeOfTable=moduleSizeOfTable, moduleBiosVersion=moduleBiosVersion, productKeyFeatureTable=productKeyFeatureTable, moduleNotebookTable=moduleNotebookTable, swUpdateURL=swUpdateURL, controlAlarmDetection=controlAlarmDetection, controlTrapSending=controlTrapSending, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistryEntry=moduleRegistryEntry, statusSettings=statusSettings, moduleRegistry=moduleRegistry, productKeyFeatureIndex=productKeyFeatureIndex, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureEnable=productKeyFeatureEnable, elementProductKey=elementProductKey, productKeyEntry=productKeyEntry, moduleMacAddress=moduleMacAddress, moduleHwType=moduleHwType, moduleControl=moduleControl, statusInternalTemperature=statusInternalTemperature, statusFan=statusFan, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusHardware=statusHardware, controlLedUsage=controlLedUsage, repairNameCode=repairNameCode, statusResetCause=statusResetCause, moduleSizeOfEntry=moduleSizeOfEntry, elementInformation=elementInformation, productKeyFeatureEntry=productKeyFeatureEntry, moduleTable=moduleTable, moduleName=moduleName, moduleBiosDate=moduleBiosDate, productKeyStatus=productKeyStatus, sizeOfRepairlog=sizeOfRepairlog, sWUpdateControl=sWUpdateControl, moduleDetailEntry=moduleDetailEntry, elementConfigChangeCode=elementConfigChangeCode, receiverAddress=receiverAddress, moduleId=moduleId, controlInternalAppAccess=controlInternalAppAccess, moduleControlEntry=moduleControlEntry, productKeyFeatureName=productKeyFeatureName, notebookLineNumber=notebookLineNumber, statusLidStatus=statusLidStatus, moduleStatusEntry=moduleStatusEntry, repairDate=repairDate, productKeyIndex=productKeyIndex, moduleRackNo=moduleRackNo, elementResetCount=elementResetCount, repairIndex=repairIndex, repairComment=repairComment, moduleRepairLogEntry=moduleRepairLogEntry, elementStructure=elementStructure, regValue=regValue, statusRunningSwImage=statusRunningSwImage, statusBusMaster=statusBusMaster, elementControl=elementControl, moduleEntry=moduleEntry, controlMarkState=controlMarkState, elementAltitude=elementAltitude, moduleRegistryTable=moduleRegistryTable, elementLatitude=elementLatitude, regIndex=regIndex, controlTrapInterval=controlTrapInterval, moduleStatusTable=moduleStatusTable, sizeOfNotebook=sizeOfNotebook, statusRestartCounter=statusRestartCounter, moduleNotebookEntry=moduleNotebookEntry, sizeOfRegistry=sizeOfRegistry, module=module, repairReasonCode=repairReasonCode, controlTrapLifeTime=controlTrapLifeTime, elementName=elementName, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleStatus=moduleStatus, moduleRepairLogTable=moduleRepairLogTable, statusGeneral=statusGeneral, sWUpdateFileName=sWUpdateFileName, controlAlarmOffDelay=controlAlarmOffDelay, element=element, sWUpdateStatus=sWUpdateStatus, controlTempLimitHiHi=controlTempLimitHiHi, moduleAppVersion=moduleAppVersion, moduleInformation=moduleInformation, moduleSWUpdateTable=moduleSWUpdateTable, productKeyMask=productKeyMask, statusSoftware=statusSoftware, productKeyValue=productKeyValue, controlBusMasterAdminState=controlBusMasterAdminState, moduleSlotNo=moduleSlotNo, moduleHwSerialNumber=moduleHwSerialNumber, controlTempLimitLoLo=controlTempLimitLoLo, productKeyTable=productKeyTable, moduleHwVersion=moduleHwVersion, receiverPort=receiverPort, moduleControlTable=moduleControlTable, controlLocalAccess=controlLocalAccess, controlReset=controlReset, moduleDetailTable=moduleDetailTable)
