...
iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Unsigned32, ObjectIdentity, Bits, MibIdentifier, TimeTicks, Counter64, Gauge32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits", "MibIdentifier", "TimeTicks", "Counter64", "Gauge32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementProductKey=elementProductKey, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapSending=controlTrapSending, statusLidStatus=statusLidStatus, notebookLineNumber=notebookLineNumber, regValue=regValue, moduleRegistryTable=moduleRegistryTable, elementTotalUpTime=elementTotalUpTime, productKeyIndex=productKeyIndex, statusGeneral=statusGeneral, moduleBusAddress=moduleBusAddress, moduleStatusEntry=moduleStatusEntry, moduleStatusTable=moduleStatusTable, receiverCommunity=receiverCommunity, statusRestartCounter=statusRestartCounter, repairDate=repairDate, moduleRackNo=moduleRackNo, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleSWUpdateTable=moduleSWUpdateTable, controlMarkState=controlMarkState, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureIndex=productKeyFeatureIndex, statusRunningSwImage=statusRunningSwImage, statusFan=statusFan, moduleHwSerialNumber=moduleHwSerialNumber, receiverEntryId=receiverEntryId, moduleId=moduleId, elementName=elementName, moduleSWUpdateEntry=moduleSWUpdateEntry, element=element, moduleHwType=moduleHwType, elementAltitude=elementAltitude, regName=regName, statusBusMaster=statusBusMaster, elementInformation=elementInformation, statusTemperature=statusTemperature, moduleControl=moduleControl, moduleTable=moduleTable, statusResetCause=statusResetCause, sWUpdateStatus=sWUpdateStatus, productKeyFeatureEntry=productKeyFeatureEntry, regIndex=regIndex, statusSoftware=statusSoftware, moduleRepairLogTable=moduleRepairLogTable, receiverPort=receiverPort, controlTempLimitHi=controlTempLimitHi, controlTrapDelay=controlTrapDelay, swUpdateURL=swUpdateURL, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitLoLo=controlTempLimitLoLo, moduleControlEntry=moduleControlEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlInternalAppAccess=controlInternalAppAccess, statusSettings=statusSettings, productKeyNumberOfKeys=productKeyNumberOfKeys, module=module, controlAlarmOffDelay=controlAlarmOffDelay, statusHardware=statusHardware, moduleSizeOfEntry=moduleSizeOfEntry, repairNameCode=repairNameCode, moduleMacAddress=moduleMacAddress, controlTrapInterval=controlTrapInterval, moduleBiosVersion=moduleBiosVersion, moduleName=moduleName, elementResetCount=elementResetCount, controlLocalAccess=controlLocalAccess, elementStatus=elementStatus, productKeyStatus=productKeyStatus, repairComment=repairComment, controlReset=controlReset, controlBusMasterAdminState=controlBusMasterAdminState, productKeyTable=productKeyTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyMask=productKeyMask, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureName=productKeyFeatureName, controlAlarmOnDelay=controlAlarmOnDelay, sWUpdateControl=sWUpdateControl, productKeyEntry=productKeyEntry, moduleInformation=moduleInformation, moduleAppVersion=moduleAppVersion, productKeyCipher=productKeyCipher, controlLedUsage=controlLedUsage, repairIndex=repairIndex, productKeyFeatureTable=productKeyFeatureTable, moduleDetailTable=moduleDetailTable, moduleHwVersion=moduleHwVersion, elementLongitude=elementLongitude, moduleBiosDate=moduleBiosDate, elementStructure=elementStructure, elementControl=elementControl, repairReasonCode=repairReasonCode, statusLmt=statusLmt, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitLo=controlTempLimitLo, sWUpdateFileName=sWUpdateFileName, elementConfigChangeCode=elementConfigChangeCode, controlResetElement=controlResetElement, moduleRepairLogEntry=moduleRepairLogEntry, sizeOfNotebook=sizeOfNotebook, productKeyValue=productKeyValue, moduleRegistry=moduleRegistry, moduleControlTable=moduleControlTable, controlTrapReceiverTable=controlTrapReceiverTable, moduleNotebookTable=moduleNotebookTable, statusLid=statusLid, moduleStatus=moduleStatus, statusInternalTemperature=statusInternalTemperature, moduleEntry=moduleEntry, sizeOfRepairlog=sizeOfRepairlog, elementLatitude=elementLatitude, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverAddress=receiverAddress, moduleSlotNo=moduleSlotNo, notebookLineText=notebookLineText, moduleDetailEntry=moduleDetailEntry, controlAlarmDetection=controlAlarmDetection, moduleNotebookEntry=moduleNotebookEntry, controlTempDeadBand=controlTempDeadBand, moduleAppDate=moduleAppDate, sizeOfRegistry=sizeOfRegistry)
