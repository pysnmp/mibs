...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSizeOfTable=moduleSizeOfTable, controlMarkState=controlMarkState, repairComment=repairComment, controlBusMasterAdminState=controlBusMasterAdminState, swUpdateURL=swUpdateURL, moduleAppVersion=moduleAppVersion, productKeyMask=productKeyMask, controlTempLimitLoLo=controlTempLimitLoLo, controlLedUsage=controlLedUsage, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleId=moduleId, productKeyIndex=productKeyIndex, repairNameCode=repairNameCode, moduleMacAddress=moduleMacAddress, sizeOfRegistry=sizeOfRegistry, statusFan=statusFan, controlResetElement=controlResetElement, statusLmt=statusLmt, moduleEntry=moduleEntry, sizeOfRepairlog=sizeOfRepairlog, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureEnable=productKeyFeatureEnable, moduleSWUpdateEntry=moduleSWUpdateEntry, elementStructure=elementStructure, moduleControlTable=moduleControlTable, regName=regName, moduleAppDate=moduleAppDate, moduleStatusTable=moduleStatusTable, elementProductKey=elementProductKey, statusLid=statusLid, regValue=regValue, moduleNotebookEntry=moduleNotebookEntry, receiverCommunity=receiverCommunity, controlLocalAccess=controlLocalAccess, notebookLineText=notebookLineText, controlTempLimitLo=controlTempLimitLo, notebookLineNumber=notebookLineNumber, moduleBusAddress=moduleBusAddress, statusBusMaster=statusBusMaster, statusSettings=statusSettings, elementLongitude=elementLongitude, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapLifeTime=controlTrapLifeTime, statusRestartCounter=statusRestartCounter, moduleDetailEntry=moduleDetailEntry, moduleBiosDate=moduleBiosDate, controlTempDeadBand=controlTempDeadBand, receiverAddress=receiverAddress, moduleNotebookTable=moduleNotebookTable, controlTrapReceiverTable=controlTrapReceiverTable, statusLidStatus=statusLidStatus, controlTempLimitHi=controlTempLimitHi, moduleHwVersion=moduleHwVersion, elementConfigChangeCode=elementConfigChangeCode, statusGeneral=statusGeneral, statusTemperature=statusTemperature, statusSoftware=statusSoftware, moduleBiosVersion=moduleBiosVersion, controlReset=controlReset, productKeyEntry=productKeyEntry, moduleStatus=moduleStatus, elementResetCount=elementResetCount, sizeOfNotebook=sizeOfNotebook, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleHwType=moduleHwType, receiverPort=receiverPort, elementControl=elementControl, element=element, sWUpdateStatus=sWUpdateStatus, moduleName=moduleName, productKeyValue=productKeyValue, module=module, productKeyFeatureEntry=productKeyFeatureEntry, elementAltitude=elementAltitude, moduleRegistry=moduleRegistry, controlTempLimitHiHi=controlTempLimitHiHi, statusResetCause=statusResetCause, moduleDetailTable=moduleDetailTable, moduleRepairLogTable=moduleRepairLogTable, controlTrapInterval=controlTrapInterval, moduleStatusEntry=moduleStatusEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleRackNo=moduleRackNo, repairIndex=repairIndex, statusHardware=statusHardware, sWUpdateControl=sWUpdateControl, controlAlarmDetection=controlAlarmDetection, regIndex=regIndex, elementStatus=elementStatus, controlInternalAppAccess=controlInternalAppAccess, repairReasonCode=repairReasonCode, sWUpdateFileName=sWUpdateFileName, moduleInformation=moduleInformation, moduleTable=moduleTable, moduleRegistryTable=moduleRegistryTable, elementTotalUpTime=elementTotalUpTime, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapSending=controlTrapSending, moduleControlEntry=moduleControlEntry, statusInternalTemperature=statusInternalTemperature, elementInformation=elementInformation, controlTrapDelay=controlTrapDelay, moduleRepairLogEntry=moduleRepairLogEntry, elementName=elementName, productKeyStatus=productKeyStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryEntry=moduleRegistryEntry, receiverEntryId=receiverEntryId, productKeyFeatureName=productKeyFeatureName, statusRunningSwImage=statusRunningSwImage, productKeyTable=productKeyTable, controlAlarmOnDelay=controlAlarmOnDelay, moduleSWUpdateTable=moduleSWUpdateTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementLatitude=elementLatitude, productKeyFeatureTable=productKeyFeatureTable, productKeyCipher=productKeyCipher, moduleHwSerialNumber=moduleHwSerialNumber, moduleSlotNo=moduleSlotNo, repairDate=repairDate, moduleControl=moduleControl)
