...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, MibIdentifier, TimeTicks, Counter32, Unsigned32, iso, Gauge32, ObjectIdentity, NotificationType, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "Unsigned32", "iso", "Gauge32", "ObjectIdentity", "NotificationType", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sizeOfRegistry=sizeOfRegistry, controlAlarmOffDelay=controlAlarmOffDelay, productKeyIndex=productKeyIndex, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleMacAddress=moduleMacAddress, elementProductKey=elementProductKey, moduleRepairLogEntry=moduleRepairLogEntry, sizeOfNotebook=sizeOfNotebook, statusFan=statusFan, statusLid=statusLid, moduleSWUpdateTable=moduleSWUpdateTable, elementLatitude=elementLatitude, module=module, elementStructure=elementStructure, moduleEntry=moduleEntry, repairIndex=repairIndex, controlBusMasterAdminState=controlBusMasterAdminState, statusTemperature=statusTemperature, productKeyValue=productKeyValue, controlAlarmOnDelay=controlAlarmOnDelay, statusHardware=statusHardware, moduleDetailEntry=moduleDetailEntry, moduleRackNo=moduleRackNo, repairReasonCode=repairReasonCode, controlTrapReceiverTable=controlTrapReceiverTable, elementInformation=elementInformation, productKeyFeatureIndex=productKeyFeatureIndex, moduleSizeOfEntry=moduleSizeOfEntry, moduleBusAddress=moduleBusAddress, elementControl=elementControl, moduleNotebookEntry=moduleNotebookEntry, controlLocalAccess=controlLocalAccess, receiverAddress=receiverAddress, receiverCommunity=receiverCommunity, moduleAppDate=moduleAppDate, moduleHwVersion=moduleHwVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRepairLogTable=moduleRepairLogTable, controlTrapSending=controlTrapSending, statusSoftware=statusSoftware, regName=regName, receiverEntryId=receiverEntryId, moduleBiosVersion=moduleBiosVersion, moduleRegistryTable=moduleRegistryTable, controlInternalAppAccess=controlInternalAppAccess, moduleName=moduleName, elementResetCount=elementResetCount, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureTable=productKeyFeatureTable, moduleRegistry=moduleRegistry, regValue=regValue, productKeyTable=productKeyTable, notebookLineText=notebookLineText, moduleInformation=moduleInformation, productKeyFeatureEntry=productKeyFeatureEntry, statusSettings=statusSettings, controlAlarmDetection=controlAlarmDetection, moduleControlEntry=moduleControlEntry, controlLedUsage=controlLedUsage, statusRestartCounter=statusRestartCounter, productKeyFeatureName=productKeyFeatureName, controlTrapLifeTime=controlTrapLifeTime, notebookLineNumber=notebookLineNumber, productKeyCipher=productKeyCipher, statusRunningSwImage=statusRunningSwImage, moduleSlotNo=moduleSlotNo, statusBusMaster=statusBusMaster, elementName=elementName, moduleAppVersion=moduleAppVersion, statusResetCause=statusResetCause, controlMarkState=controlMarkState, statusLmt=statusLmt, controlTempLimitHiHi=controlTempLimitHiHi, controlTempLimitLo=controlTempLimitLo, elementConfigChangeCode=elementConfigChangeCode, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleControl=moduleControl, moduleControlTable=moduleControlTable, moduleDetailTable=moduleDetailTable, moduleRegistryEntry=moduleRegistryEntry, controlTempDeadBand=controlTempDeadBand, moduleHwType=moduleHwType, moduleStatusEntry=moduleStatusEntry, moduleStatusTable=moduleStatusTable, productKeyMask=productKeyMask, repairDate=repairDate, productKeyFeatureEnable=productKeyFeatureEnable, moduleStatus=moduleStatus, sWUpdateStatus=sWUpdateStatus, elementTotalUpTime=elementTotalUpTime, controlTrapInterval=controlTrapInterval, moduleBiosDate=moduleBiosDate, sWUpdateFileName=sWUpdateFileName, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleSizeOfTable=moduleSizeOfTable, elementAltitude=elementAltitude, statusInternalTemperature=statusInternalTemperature, productKeyNumberOfFeatures=productKeyNumberOfFeatures, swUpdateURL=swUpdateURL, controlTempLimitHi=controlTempLimitHi, statusLidStatus=statusLidStatus, sWUpdateControl=sWUpdateControl, repairComment=repairComment, moduleNotebookTable=moduleNotebookTable, productKeyEntry=productKeyEntry, repairNameCode=repairNameCode, moduleTable=moduleTable, statusGeneral=statusGeneral, regIndex=regIndex, productKeyStatus=productKeyStatus, moduleHwSerialNumber=moduleHwSerialNumber, controlTrapDelay=controlTrapDelay, elementLongitude=elementLongitude, element=element, controlReset=controlReset, controlTempLimitLoLo=controlTempLimitLoLo, receiverPort=receiverPort, moduleId=moduleId, elementStatus=elementStatus, controlResetElement=controlResetElement)
