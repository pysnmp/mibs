...
Counter32, IpAddress, Integer32, ModuleIdentity, MibIdentifier, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, iso, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Integer32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "iso", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusFan=statusFan, moduleAppVersion=moduleAppVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, elementTotalUpTime=elementTotalUpTime, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapReceiverEntry=controlTrapReceiverEntry, statusLidStatus=statusLidStatus, statusResetCause=statusResetCause, moduleSizeOfEntry=moduleSizeOfEntry, elementStatus=elementStatus, controlTrapSending=controlTrapSending, statusRestartCounter=statusRestartCounter, productKeyCipher=productKeyCipher, statusBusMaster=statusBusMaster, productKeyTable=productKeyTable, moduleControl=moduleControl, elementStructure=elementStructure, controlAlarmDetection=controlAlarmDetection, receiverPort=receiverPort, productKeyStatus=productKeyStatus, controlMarkState=controlMarkState, controlTempLimitHiHi=controlTempLimitHiHi, controlLocalAccess=controlLocalAccess, moduleSWUpdateTable=moduleSWUpdateTable, moduleHwSerialNumber=moduleHwSerialNumber, moduleDetailEntry=moduleDetailEntry, statusRunningSwImage=statusRunningSwImage, element=element, controlAlarmOnDelay=controlAlarmOnDelay, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSoftware=statusSoftware, notebookLineText=notebookLineText, moduleId=moduleId, receiverEntryId=receiverEntryId, controlBusMasterAdminState=controlBusMasterAdminState, moduleInformation=moduleInformation, moduleRackNo=moduleRackNo, moduleBusAddress=moduleBusAddress, receiverAddress=receiverAddress, productKeyFeatureEntry=productKeyFeatureEntry, elementProductKey=elementProductKey, productKeyFeatureEnable=productKeyFeatureEnable, controlTempDeadBand=controlTempDeadBand, statusTemperature=statusTemperature, moduleTable=moduleTable, moduleRegistryEntry=moduleRegistryEntry, productKeyIndex=productKeyIndex, elementResetCount=elementResetCount, regIndex=regIndex, productKeyFeatureName=productKeyFeatureName, moduleRegistry=moduleRegistry, swUpdateURL=swUpdateURL, controlTrapReceiverTable=controlTrapReceiverTable, statusLid=statusLid, elementName=elementName, statusGeneral=statusGeneral, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapDelay=controlTrapDelay, moduleHwVersion=moduleHwVersion, elementInformation=elementInformation, controlResetElement=controlResetElement, elementLatitude=elementLatitude, notebookLineNumber=notebookLineNumber, elementAltitude=elementAltitude, sWUpdateFileName=sWUpdateFileName, repairNameCode=repairNameCode, repairComment=repairComment, sWUpdateStatus=sWUpdateStatus, elementLongitude=elementLongitude, controlTrapLifeTime=controlTrapLifeTime, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSlotNo=moduleSlotNo, moduleNotebookEntry=moduleNotebookEntry, sizeOfRepairlog=sizeOfRepairlog, moduleStatusEntry=moduleStatusEntry, repairReasonCode=repairReasonCode, repairIndex=repairIndex, controlTempLimitHi=controlTempLimitHi, statusHardware=statusHardware, productKeyValue=productKeyValue, sizeOfNotebook=sizeOfNotebook, sizeOfRegistry=sizeOfRegistry, moduleBiosVersion=moduleBiosVersion, moduleNotebookTable=moduleNotebookTable, controlTempLimitLoLo=controlTempLimitLoLo, statusLmt=statusLmt, controlReset=controlReset, moduleControlEntry=moduleControlEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, module=module, regName=regName, moduleDetailTable=moduleDetailTable, repairDate=repairDate, moduleHwType=moduleHwType, moduleStatusTable=moduleStatusTable, controlTempLimitLo=controlTempLimitLo, moduleBiosDate=moduleBiosDate, productKeyMask=productKeyMask, moduleEntry=moduleEntry, moduleAppDate=moduleAppDate, controlLedUsage=controlLedUsage, moduleRegistryTable=moduleRegistryTable, elementControl=elementControl, statusSettings=statusSettings, statusInternalTemperature=statusInternalTemperature, moduleStatus=moduleStatus, productKeyEntry=productKeyEntry, moduleSizeOfTable=moduleSizeOfTable, moduleName=moduleName, productKeyFeatureIndex=productKeyFeatureIndex, productKeyFeatureTable=productKeyFeatureTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRepairLogTable=moduleRepairLogTable, sWUpdateControl=sWUpdateControl, controlInternalAppAccess=controlInternalAppAccess, moduleControlTable=moduleControlTable, moduleMacAddress=moduleMacAddress, controlTrapInterval=controlTrapInterval, regValue=regValue, receiverCommunity=receiverCommunity)
