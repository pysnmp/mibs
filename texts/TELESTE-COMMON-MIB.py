...
ModuleIdentity, Counter64, Gauge32, NotificationType, iso, Unsigned32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlMarkState=controlMarkState, elementResetCount=elementResetCount, module=module, controlTrapLifeTime=controlTrapLifeTime, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleId=moduleId, elementProductKey=elementProductKey, moduleEntry=moduleEntry, moduleRegistryEntry=moduleRegistryEntry, element=element, statusResetCause=statusResetCause, sWUpdateStatus=sWUpdateStatus, statusSoftware=statusSoftware, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleAppVersion=moduleAppVersion, productKeyMask=productKeyMask, receiverPort=receiverPort, repairReasonCode=repairReasonCode, regIndex=regIndex, productKeyFeatureTable=productKeyFeatureTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleHwType=moduleHwType, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmDetection=controlAlarmDetection, controlTrapReceiverTable=controlTrapReceiverTable, statusSettings=statusSettings, controlReset=controlReset, statusLidStatus=statusLidStatus, controlTempLimitLo=controlTempLimitLo, moduleDetailTable=moduleDetailTable, statusRunningSwImage=statusRunningSwImage, controlInternalAppAccess=controlInternalAppAccess, swUpdateURL=swUpdateURL, productKeyFeatureEnable=productKeyFeatureEnable, moduleSizeOfTable=moduleSizeOfTable, productKeyFeatureIndex=productKeyFeatureIndex, repairDate=repairDate, moduleHwVersion=moduleHwVersion, productKeyIndex=productKeyIndex, elementLongitude=elementLongitude, statusGeneral=statusGeneral, elementControl=elementControl, controlLocalAccess=controlLocalAccess, sizeOfRepairlog=sizeOfRepairlog, controlTempLimitHi=controlTempLimitHi, moduleNotebookTable=moduleNotebookTable, moduleNotebookEntry=moduleNotebookEntry, productKeyValue=productKeyValue, moduleBusAddress=moduleBusAddress, controlBusMasterAdminState=controlBusMasterAdminState, moduleSlotNo=moduleSlotNo, elementStructure=elementStructure, elementAltitude=elementAltitude, productKeyCipher=productKeyCipher, moduleInformation=moduleInformation, moduleRackNo=moduleRackNo, statusLmt=statusLmt, receiverAddress=receiverAddress, controlTempLimitLoLo=controlTempLimitLoLo, controlTempDeadBand=controlTempDeadBand, statusLid=statusLid, moduleHwSerialNumber=moduleHwSerialNumber, repairNameCode=repairNameCode, moduleMacAddress=moduleMacAddress, moduleStatusTable=moduleStatusTable, controlTempLimitHiHi=controlTempLimitHiHi, elementStatus=elementStatus, productKeyTable=productKeyTable, statusTemperature=statusTemperature, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapDelay=controlTrapDelay, moduleRegistry=moduleRegistry, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistryTable=moduleRegistryTable, elementConfigChangeCode=elementConfigChangeCode, moduleBiosVersion=moduleBiosVersion, receiverCommunity=receiverCommunity, elementName=elementName, controlAlarmOnDelay=controlAlarmOnDelay, moduleName=moduleName, notebookLineText=notebookLineText, controlTrapInterval=controlTrapInterval, moduleStatusEntry=moduleStatusEntry, statusFan=statusFan, moduleControlTable=moduleControlTable, controlResetElement=controlResetElement, elementLatitude=elementLatitude, moduleAppDate=moduleAppDate, moduleStatus=moduleStatus, productKeyEntry=productKeyEntry, repairIndex=repairIndex, repairComment=repairComment, sizeOfNotebook=sizeOfNotebook, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateControl=sWUpdateControl, moduleTable=moduleTable, statusBusMaster=statusBusMaster, productKeyFeatureEntry=productKeyFeatureEntry, statusInternalTemperature=statusInternalTemperature, productKeyFeatureName=productKeyFeatureName, statusHardware=statusHardware, receiverEntryId=receiverEntryId, sWUpdateFileName=sWUpdateFileName, moduleRepairLogTable=moduleRepairLogTable, regValue=regValue, statusRestartCounter=statusRestartCounter, moduleDetailEntry=moduleDetailEntry, moduleControl=moduleControl, controlLedUsage=controlLedUsage, controlAlarmOffDelay=controlAlarmOffDelay, elementInformation=elementInformation, regName=regName, notebookLineNumber=notebookLineNumber, controlTrapSending=controlTrapSending, moduleControlEntry=moduleControlEntry, elementTotalUpTime=elementTotalUpTime, productKeyStatus=productKeyStatus, moduleBiosDate=moduleBiosDate, moduleSizeOfEntry=moduleSizeOfEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sizeOfRegistry=sizeOfRegistry)
