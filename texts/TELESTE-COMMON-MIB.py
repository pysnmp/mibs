...
NotificationType, TimeTicks, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Counter64, Integer32, ObjectIdentity, Bits, IpAddress, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Counter64", "Integer32", "ObjectIdentity", "Bits", "IpAddress", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyValue=productKeyValue, controlInternalAppAccess=controlInternalAppAccess, repairDate=repairDate, controlReset=controlReset, productKeyFeatureName=productKeyFeatureName, controlTrapDelay=controlTrapDelay, moduleName=moduleName, moduleHwType=moduleHwType, moduleAppDate=moduleAppDate, moduleRackNo=moduleRackNo, controlTrapLifeTime=controlTrapLifeTime, moduleControlTable=moduleControlTable, controlTempLimitLoLo=controlTempLimitLoLo, receiverAddress=receiverAddress, moduleDetailEntry=moduleDetailEntry, productKeyFeatureTable=productKeyFeatureTable, moduleDetailTable=moduleDetailTable, moduleEntry=moduleEntry, elementStatus=elementStatus, elementTotalUpTime=elementTotalUpTime, elementAltitude=elementAltitude, elementConfigChangeCode=elementConfigChangeCode, moduleControlEntry=moduleControlEntry, statusRunningSwImage=statusRunningSwImage, notebookLineText=notebookLineText, statusSoftware=statusSoftware, elementName=elementName, controlTrapInterval=controlTrapInterval, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistry=moduleRegistry, moduleSlotNo=moduleSlotNo, productKeyMask=productKeyMask, elementStructure=elementStructure, controlBusMasterAdminState=controlBusMasterAdminState, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureEnable=productKeyFeatureEnable, moduleMacAddress=moduleMacAddress, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosVersion=moduleBiosVersion, notebookLineNumber=notebookLineNumber, moduleAppVersion=moduleAppVersion, controlAlarmOffDelay=controlAlarmOffDelay, receiverCommunity=receiverCommunity, statusBusMaster=statusBusMaster, productKeyCipher=productKeyCipher, elementLatitude=elementLatitude, moduleId=moduleId, regValue=regValue, moduleTable=moduleTable, elementInformation=elementInformation, moduleSizeOfEntry=moduleSizeOfEntry, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitHiHi=controlTempLimitHiHi, statusRestartCounter=statusRestartCounter, regIndex=regIndex, controlTrapReceiverEntry=controlTrapReceiverEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapReceiverTable=controlTrapReceiverTable, element=element, statusLmt=statusLmt, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmDetection=controlAlarmDetection, moduleRegistryTable=moduleRegistryTable, statusResetCause=statusResetCause, moduleRepairLogTable=moduleRepairLogTable, sWUpdateStatus=sWUpdateStatus, receiverEntryId=receiverEntryId, moduleStatusTable=moduleStatusTable, elementProductKey=elementProductKey, elementControl=elementControl, moduleSizeOfTable=moduleSizeOfTable, productKeyIndex=productKeyIndex, controlResetElement=controlResetElement, moduleStatus=moduleStatus, repairIndex=repairIndex, moduleHwSerialNumber=moduleHwSerialNumber, repairComment=repairComment, statusGeneral=statusGeneral, moduleBiosDate=moduleBiosDate, controlLocalAccess=controlLocalAccess, sWUpdateControl=sWUpdateControl, moduleInformation=moduleInformation, moduleStatusEntry=moduleStatusEntry, moduleControl=moduleControl, statusHardware=statusHardware, sWUpdateFileName=sWUpdateFileName, regName=regName, statusLidStatus=statusLidStatus, controlMarkState=controlMarkState, repairNameCode=repairNameCode, statusSettings=statusSettings, moduleBusAddress=moduleBusAddress, repairReasonCode=repairReasonCode, statusTemperature=statusTemperature, productKeyFeatureEntry=productKeyFeatureEntry, controlTempLimitHi=controlTempLimitHi, controlAlarmOnDelay=controlAlarmOnDelay, moduleRegistryEntry=moduleRegistryEntry, controlTrapSending=controlTrapSending, module=module, controlLedUsage=controlLedUsage, productKeyStatus=productKeyStatus, moduleNotebookTable=moduleNotebookTable, statusFan=statusFan, productKeyFeatureIndex=productKeyFeatureIndex, elementLongitude=elementLongitude, moduleRepairLogEntry=moduleRepairLogEntry, moduleHwVersion=moduleHwVersion, controlTempLimitLo=controlTempLimitLo, sizeOfRegistry=sizeOfRegistry, productKeyEntry=productKeyEntry, elementResetCount=elementResetCount, controlTempDeadBand=controlTempDeadBand, sizeOfRepairlog=sizeOfRepairlog, receiverPort=receiverPort, productKeyTable=productKeyTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusLid=statusLid, swUpdateURL=swUpdateURL, sizeOfNotebook=sizeOfNotebook)
