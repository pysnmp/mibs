...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlLocalAccess=controlLocalAccess, controlTempLimitHi=controlTempLimitHi, productKeyFeatureIndex=productKeyFeatureIndex, repairComment=repairComment, statusBusMaster=statusBusMaster, moduleStatus=moduleStatus, moduleHwSerialNumber=moduleHwSerialNumber, statusLmt=statusLmt, controlResetElement=controlResetElement, moduleAppDate=moduleAppDate, elementTotalUpTime=elementTotalUpTime, regValue=regValue, moduleRackNo=moduleRackNo, statusInternalTemperature=statusInternalTemperature, productKeyEntry=productKeyEntry, elementStructure=elementStructure, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitLoLo=controlTempLimitLoLo, moduleId=moduleId, moduleSizeOfEntry=moduleSizeOfEntry, elementConfigChangeCode=elementConfigChangeCode, swUpdateURL=swUpdateURL, elementControl=elementControl, productKeyFeatureTable=productKeyFeatureTable, controlAlarmOffDelay=controlAlarmOffDelay, statusSettings=statusSettings, moduleControlTable=moduleControlTable, statusRestartCounter=statusRestartCounter, elementStatus=elementStatus, sWUpdateFileName=sWUpdateFileName, statusSoftware=statusSoftware, moduleBusAddress=moduleBusAddress, moduleHwType=moduleHwType, moduleControlEntry=moduleControlEntry, controlMarkState=controlMarkState, moduleDetailTable=moduleDetailTable, moduleBiosVersion=moduleBiosVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, receiverCommunity=receiverCommunity, regIndex=regIndex, moduleStatusEntry=moduleStatusEntry, moduleRegistryEntry=moduleRegistryEntry, receiverEntryId=receiverEntryId, sizeOfRegistry=sizeOfRegistry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapInterval=controlTrapInterval, moduleMacAddress=moduleMacAddress, moduleSizeOfTable=moduleSizeOfTable, repairNameCode=repairNameCode, moduleEntry=moduleEntry, elementInformation=elementInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapDelay=controlTrapDelay, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapLifeTime=controlTrapLifeTime, statusLid=statusLid, moduleName=moduleName, sizeOfNotebook=sizeOfNotebook, controlLedUsage=controlLedUsage, notebookLineText=notebookLineText, statusFan=statusFan, controlInternalAppAccess=controlInternalAppAccess, receiverPort=receiverPort, controlTempDeadBand=controlTempDeadBand, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyMask=productKeyMask, statusGeneral=statusGeneral, statusHardware=statusHardware, repairIndex=repairIndex, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmDetection=controlAlarmDetection, receiverAddress=receiverAddress, controlTempLimitHiHi=controlTempLimitHiHi, moduleSlotNo=moduleSlotNo, elementName=elementName, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleHwVersion=moduleHwVersion, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEntry=productKeyFeatureEntry, statusRunningSwImage=statusRunningSwImage, controlTempLimitLo=controlTempLimitLo, elementLongitude=elementLongitude, moduleControl=moduleControl, sWUpdateStatus=sWUpdateStatus, moduleBiosDate=moduleBiosDate, moduleDetailEntry=moduleDetailEntry, moduleRepairLogTable=moduleRepairLogTable, module=module, element=element, notebookLineNumber=notebookLineNumber, moduleRegistry=moduleRegistry, moduleRepairLogEntry=moduleRepairLogEntry, repairDate=repairDate, moduleStatusTable=moduleStatusTable, productKeyStatus=productKeyStatus, elementAltitude=elementAltitude, productKeyFeatureName=productKeyFeatureName, regName=regName, productKeyValue=productKeyValue, controlAlarmOnDelay=controlAlarmOnDelay, statusTemperature=statusTemperature, statusLidStatus=statusLidStatus, moduleTable=moduleTable, elementResetCount=elementResetCount, moduleNotebookEntry=moduleNotebookEntry, moduleRegistryTable=moduleRegistryTable, productKeyTable=productKeyTable, moduleInformation=moduleInformation, controlBusMasterAdminState=controlBusMasterAdminState, productKeyIndex=productKeyIndex, elementProductKey=elementProductKey, controlTrapSending=controlTrapSending, repairReasonCode=repairReasonCode, controlReset=controlReset, sWUpdateControl=sWUpdateControl, elementLatitude=elementLatitude, statusResetCause=statusResetCause, moduleAppVersion=moduleAppVersion, moduleNotebookTable=moduleNotebookTable, productKeyCipher=productKeyCipher)
