...
MibIdentifier, iso, ObjectIdentity, Integer32, Gauge32, Counter64, Unsigned32, Counter32, Bits, NotificationType, IpAddress, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "ObjectIdentity", "Integer32", "Gauge32", "Counter64", "Unsigned32", "Counter32", "Bits", "NotificationType", "IpAddress", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", module=module, statusInternalTemperature=statusInternalTemperature, elementLatitude=elementLatitude, productKeyFeatureName=productKeyFeatureName, moduleRegistry=moduleRegistry, elementControl=elementControl, moduleSizeOfTable=moduleSizeOfTable, productKeyIndex=productKeyIndex, elementResetCount=elementResetCount, moduleSizeOfEntry=moduleSizeOfEntry, repairDate=repairDate, moduleControlEntry=moduleControlEntry, controlLedUsage=controlLedUsage, sWUpdateControl=sWUpdateControl, statusLmt=statusLmt, elementInformation=elementInformation, controlTempLimitLoLo=controlTempLimitLoLo, moduleStatusTable=moduleStatusTable, moduleRackNo=moduleRackNo, moduleControlTable=moduleControlTable, repairIndex=repairIndex, elementProductKey=elementProductKey, elementLongitude=elementLongitude, elementConfigChangeCode=elementConfigChangeCode, receiverAddress=receiverAddress, moduleName=moduleName, productKeyTable=productKeyTable, moduleRegistryTable=moduleRegistryTable, element=element, regName=regName, statusSettings=statusSettings, moduleSWUpdateTable=moduleSWUpdateTable, controlAlarmDetection=controlAlarmDetection, repairNameCode=repairNameCode, statusRestartCounter=statusRestartCounter, moduleEntry=moduleEntry, moduleNotebookEntry=moduleNotebookEntry, moduleHwType=moduleHwType, controlTempDeadBand=controlTempDeadBand, elementStatus=elementStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleBiosDate=moduleBiosDate, controlTrapDelay=controlTrapDelay, moduleTable=moduleTable, regValue=regValue, statusLidStatus=statusLidStatus, statusRunningSwImage=statusRunningSwImage, sizeOfNotebook=sizeOfNotebook, moduleDetailEntry=moduleDetailEntry, statusTemperature=statusTemperature, controlTempLimitHiHi=controlTempLimitHiHi, repairComment=repairComment, moduleMacAddress=moduleMacAddress, statusBusMaster=statusBusMaster, receiverCommunity=receiverCommunity, moduleRegistryEntry=moduleRegistryEntry, controlTempLimitHi=controlTempLimitHi, statusFan=statusFan, moduleRepairLogTable=moduleRepairLogTable, controlResetElement=controlResetElement, productKeyMask=productKeyMask, sWUpdateStatus=sWUpdateStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlLocalAccess=controlLocalAccess, controlAlarmOnDelay=controlAlarmOnDelay, moduleBusAddress=moduleBusAddress, controlInternalAppAccess=controlInternalAppAccess, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, statusLid=statusLid, elementName=elementName, controlTrapSending=controlTrapSending, moduleAppDate=moduleAppDate, moduleHwSerialNumber=moduleHwSerialNumber, moduleSlotNo=moduleSlotNo, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlBusMasterAdminState=controlBusMasterAdminState, productKeyValue=productKeyValue, productKeyFeatureIndex=productKeyFeatureIndex, statusResetCause=statusResetCause, regIndex=regIndex, moduleStatus=moduleStatus, productKeyCipher=productKeyCipher, statusGeneral=statusGeneral, moduleControl=moduleControl, moduleInformation=moduleInformation, elementAltitude=elementAltitude, sWUpdateFileName=sWUpdateFileName, productKeyStatus=productKeyStatus, moduleNotebookTable=moduleNotebookTable, controlTrapReceiverTable=controlTrapReceiverTable, productKeyEntry=productKeyEntry, statusSoftware=statusSoftware, productKeyFeatureEnable=productKeyFeatureEnable, moduleBiosVersion=moduleBiosVersion, controlTempLimitLo=controlTempLimitLo, controlReset=controlReset, moduleHwVersion=moduleHwVersion, moduleRepairLogEntry=moduleRepairLogEntry, repairReasonCode=repairReasonCode, statusHardware=statusHardware, controlTrapLifeTime=controlTrapLifeTime, moduleAppVersion=moduleAppVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, controlMarkState=controlMarkState, receiverEntryId=receiverEntryId, moduleDetailTable=moduleDetailTable, controlTrapReceiverEntry=controlTrapReceiverEntry, swUpdateURL=swUpdateURL, controlAlarmOffDelay=controlAlarmOffDelay, sizeOfRepairlog=sizeOfRepairlog, receiverPort=receiverPort, moduleStatusEntry=moduleStatusEntry, notebookLineText=notebookLineText, moduleId=moduleId, sizeOfRegistry=sizeOfRegistry, productKeyFeatureTable=productKeyFeatureTable, controlTrapInterval=controlTrapInterval, productKeyNumberOfKeys=productKeyNumberOfKeys, elementTotalUpTime=elementTotalUpTime, notebookLineNumber=notebookLineNumber)
