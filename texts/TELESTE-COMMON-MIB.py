...
ObjectIdentity, TimeTicks, Bits, IpAddress, Integer32, NotificationType, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ModuleIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Bits", "IpAddress", "Integer32", "NotificationType", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementTotalUpTime=elementTotalUpTime, receiverAddress=receiverAddress, moduleName=moduleName, moduleTable=moduleTable, sWUpdateStatus=sWUpdateStatus, moduleSWUpdateTable=moduleSWUpdateTable, moduleNotebookTable=moduleNotebookTable, moduleRegistryTable=moduleRegistryTable, elementName=elementName, productKeyFeatureEnable=productKeyFeatureEnable, moduleBiosDate=moduleBiosDate, regValue=regValue, controlLocalAccess=controlLocalAccess, controlTrapDelay=controlTrapDelay, controlTrapReceiverEntry=controlTrapReceiverEntry, elementConfigChangeCode=elementConfigChangeCode, moduleHwType=moduleHwType, elementStatus=elementStatus, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineNumber=notebookLineNumber, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleDetailTable=moduleDetailTable, elementInformation=elementInformation, productKeyFeatureEntry=productKeyFeatureEntry, moduleRepairLogEntry=moduleRepairLogEntry, controlReset=controlReset, sizeOfRepairlog=sizeOfRepairlog, moduleStatusTable=moduleStatusTable, moduleSlotNo=moduleSlotNo, moduleStatusEntry=moduleStatusEntry, sWUpdateControl=sWUpdateControl, controlTempLimitHiHi=controlTempLimitHiHi, moduleHwSerialNumber=moduleHwSerialNumber, moduleBusAddress=moduleBusAddress, elementStructure=elementStructure, moduleBiosVersion=moduleBiosVersion, productKeyValue=productKeyValue, productKeyCipher=productKeyCipher, elementProductKey=elementProductKey, controlMarkState=controlMarkState, moduleControlEntry=moduleControlEntry, element=element, moduleAppVersion=moduleAppVersion, productKeyMask=productKeyMask, controlBusMasterAdminState=controlBusMasterAdminState, swUpdateURL=swUpdateURL, statusLid=statusLid, repairIndex=repairIndex, productKeyTable=productKeyTable, productKeyFeatureIndex=productKeyFeatureIndex, regName=regName, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleAppDate=moduleAppDate, statusRestartCounter=statusRestartCounter, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementLatitude=elementLatitude, elementControl=elementControl, moduleMacAddress=moduleMacAddress, repairDate=repairDate, statusLidStatus=statusLidStatus, elementLongitude=elementLongitude, controlAlarmDetection=controlAlarmDetection, moduleStatus=moduleStatus, receiverPort=receiverPort, elementAltitude=elementAltitude, module=module, controlInternalAppAccess=controlInternalAppAccess, moduleInformation=moduleInformation, controlLedUsage=controlLedUsage, moduleId=moduleId, regIndex=regIndex, controlResetElement=controlResetElement, receiverEntryId=receiverEntryId, moduleRegistryEntry=moduleRegistryEntry, statusSoftware=statusSoftware, moduleNotebookEntry=moduleNotebookEntry, moduleSizeOfTable=moduleSizeOfTable, productKeyEntry=productKeyEntry, moduleRackNo=moduleRackNo, controlTrapInterval=controlTrapInterval, controlTrapLifeTime=controlTrapLifeTime, productKeyIndex=productKeyIndex, moduleControlTable=moduleControlTable, controlAlarmOnDelay=controlAlarmOnDelay, productKeyStatus=productKeyStatus, controlTempLimitHi=controlTempLimitHi, statusFan=statusFan, notebookLineText=notebookLineText, moduleControl=moduleControl, sizeOfRegistry=sizeOfRegistry, statusRunningSwImage=statusRunningSwImage, statusHardware=statusHardware, productKeyFeatureName=productKeyFeatureName, statusLmt=statusLmt, repairReasonCode=repairReasonCode, moduleHwVersion=moduleHwVersion, controlTrapSending=controlTrapSending, controlTempDeadBand=controlTempDeadBand, controlTempLimitLo=controlTempLimitLo, statusInternalTemperature=statusInternalTemperature, sizeOfNotebook=sizeOfNotebook, statusResetCause=statusResetCause, moduleRegistry=moduleRegistry, repairComment=repairComment, controlTrapReceiverTable=controlTrapReceiverTable, repairNameCode=repairNameCode, statusSettings=statusSettings, moduleEntry=moduleEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusBusMaster=statusBusMaster, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitLoLo=controlTempLimitLoLo, statusGeneral=statusGeneral, moduleRepairLogTable=moduleRepairLogTable, elementResetCount=elementResetCount, statusTemperature=statusTemperature, receiverCommunity=receiverCommunity, moduleDetailEntry=moduleDetailEntry)
