...
Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, TimeTicks, Gauge32, iso, NotificationType, Unsigned32, ObjectIdentity, Counter64, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "TimeTicks", "Gauge32", "iso", "NotificationType", "Unsigned32", "ObjectIdentity", "Counter64", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusResetCause=statusResetCause, sWUpdateFileName=sWUpdateFileName, moduleControl=moduleControl, elementLongitude=elementLongitude, statusRunningSwImage=statusRunningSwImage, controlTrapDelay=controlTrapDelay, moduleRegistryEntry=moduleRegistryEntry, moduleHwSerialNumber=moduleHwSerialNumber, moduleAppVersion=moduleAppVersion, module=module, moduleMacAddress=moduleMacAddress, elementControl=elementControl, moduleRegistry=moduleRegistry, moduleInformation=moduleInformation, receiverEntryId=receiverEntryId, controlLocalAccess=controlLocalAccess, regName=regName, productKeyMask=productKeyMask, controlResetElement=controlResetElement, elementConfigChangeCode=elementConfigChangeCode, elementStatus=elementStatus, elementLatitude=elementLatitude, moduleBiosVersion=moduleBiosVersion, repairComment=repairComment, notebookLineText=notebookLineText, elementTotalUpTime=elementTotalUpTime, controlTempLimitHiHi=controlTempLimitHiHi, controlAlarmOnDelay=controlAlarmOnDelay, moduleHwType=moduleHwType, regValue=regValue, moduleNotebookEntry=moduleNotebookEntry, element=element, moduleRackNo=moduleRackNo, moduleStatus=moduleStatus, controlTrapSending=controlTrapSending, regIndex=regIndex, controlTempDeadBand=controlTempDeadBand, repairDate=repairDate, repairReasonCode=repairReasonCode, moduleTable=moduleTable, statusLmt=statusLmt, moduleStatusEntry=moduleStatusEntry, elementName=elementName, receiverPort=receiverPort, controlInternalAppAccess=controlInternalAppAccess, moduleAppDate=moduleAppDate, statusLidStatus=statusLidStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusHardware=statusHardware, controlAlarmOffDelay=controlAlarmOffDelay, receiverAddress=receiverAddress, productKeyTable=productKeyTable, controlTrapLifeTime=controlTrapLifeTime, moduleNotebookTable=moduleNotebookTable, controlBusMasterAdminState=controlBusMasterAdminState, sizeOfRepairlog=sizeOfRepairlog, elementInformation=elementInformation, moduleDetailTable=moduleDetailTable, controlAlarmDetection=controlAlarmDetection, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBiosDate=moduleBiosDate, statusBusMaster=statusBusMaster, controlReset=controlReset, controlTempLimitLo=controlTempLimitLo, controlLedUsage=controlLedUsage, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureEntry=productKeyFeatureEntry, productKeyEntry=productKeyEntry, moduleControlTable=moduleControlTable, controlMarkState=controlMarkState, productKeyStatus=productKeyStatus, productKeyCipher=productKeyCipher, productKeyFeatureTable=productKeyFeatureTable, moduleRepairLogEntry=moduleRepairLogEntry, statusTemperature=statusTemperature, elementStructure=elementStructure, productKeyNumberOfKeys=productKeyNumberOfKeys, receiverCommunity=receiverCommunity, sizeOfNotebook=sizeOfNotebook, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitHi=controlTempLimitHi, controlTempLimitLoLo=controlTempLimitLoLo, controlTrapReceiverTable=controlTrapReceiverTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusLid=statusLid, controlTrapInterval=controlTrapInterval, elementAltitude=elementAltitude, elementProductKey=elementProductKey, productKeyIndex=productKeyIndex, repairNameCode=repairNameCode, moduleEntry=moduleEntry, moduleName=moduleName, moduleDetailEntry=moduleDetailEntry, moduleRegistryTable=moduleRegistryTable, moduleBusAddress=moduleBusAddress, repairIndex=repairIndex, notebookLineNumber=notebookLineNumber, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyValue=productKeyValue, moduleSWUpdateTable=moduleSWUpdateTable, moduleSizeOfEntry=moduleSizeOfEntry, moduleId=moduleId, moduleHwVersion=moduleHwVersion, moduleSizeOfTable=moduleSizeOfTable, moduleStatusTable=moduleStatusTable, sWUpdateStatus=sWUpdateStatus, elementResetCount=elementResetCount, statusSoftware=statusSoftware, productKeyFeatureEnable=productKeyFeatureEnable, moduleControlEntry=moduleControlEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusInternalTemperature=statusInternalTemperature, sWUpdateControl=sWUpdateControl, statusRestartCounter=statusRestartCounter, swUpdateURL=swUpdateURL, productKeyFeatureName=productKeyFeatureName, sizeOfRegistry=sizeOfRegistry, moduleSlotNo=moduleSlotNo, statusFan=statusFan, statusGeneral=statusGeneral, statusSettings=statusSettings)
