...
Counter32, ModuleIdentity, Unsigned32, Bits, Integer32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter64, MibIdentifier, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Unsigned32", "Bits", "Integer32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter64", "MibIdentifier", "Gauge32", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmDetection=controlAlarmDetection, controlTempLimitHiHi=controlTempLimitHiHi, elementAltitude=elementAltitude, statusHardware=statusHardware, receiverCommunity=receiverCommunity, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitLo=controlTempLimitLo, moduleRegistryEntry=moduleRegistryEntry, moduleName=moduleName, elementControl=elementControl, sizeOfRegistry=sizeOfRegistry, moduleRepairLogEntry=moduleRepairLogEntry, controlTempDeadBand=controlTempDeadBand, moduleStatus=moduleStatus, elementName=elementName, sWUpdateFileName=sWUpdateFileName, moduleRepairLogTable=moduleRepairLogTable, statusLid=statusLid, elementLongitude=elementLongitude, repairNameCode=repairNameCode, moduleNotebookTable=moduleNotebookTable, controlReset=controlReset, controlTempLimitHi=controlTempLimitHi, regIndex=regIndex, controlLocalAccess=controlLocalAccess, element=element, productKeyValue=productKeyValue, controlMarkState=controlMarkState, moduleDetailEntry=moduleDetailEntry, statusGeneral=statusGeneral, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmOffDelay=controlAlarmOffDelay, controlBusMasterAdminState=controlBusMasterAdminState, repairIndex=repairIndex, controlTrapInterval=controlTrapInterval, statusFan=statusFan, moduleMacAddress=moduleMacAddress, productKeyFeatureIndex=productKeyFeatureIndex, repairReasonCode=repairReasonCode, moduleAppDate=moduleAppDate, sizeOfNotebook=sizeOfNotebook, moduleStatusEntry=moduleStatusEntry, moduleSizeOfEntry=moduleSizeOfEntry, receiverEntryId=receiverEntryId, elementProductKey=elementProductKey, moduleControlEntry=moduleControlEntry, moduleRegistryTable=moduleRegistryTable, controlTrapDelay=controlTrapDelay, productKeyTable=productKeyTable, sWUpdateStatus=sWUpdateStatus, statusSoftware=statusSoftware, moduleAppVersion=moduleAppVersion, statusRestartCounter=statusRestartCounter, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleNotebookEntry=moduleNotebookEntry, moduleEntry=moduleEntry, controlInternalAppAccess=controlInternalAppAccess, moduleSlotNo=moduleSlotNo, statusRunningSwImage=statusRunningSwImage, repairComment=repairComment, productKeyNumberOfKeys=productKeyNumberOfKeys, sizeOfRepairlog=sizeOfRepairlog, elementStatus=elementStatus, productKeyFeatureEnable=productKeyFeatureEnable, regValue=regValue, moduleId=moduleId, controlTempLimitLoLo=controlTempLimitLoLo, elementInformation=elementInformation, controlTrapLifeTime=controlTrapLifeTime, statusBusMaster=statusBusMaster, receiverPort=receiverPort, moduleControlTable=moduleControlTable, moduleSWUpdateEntry=moduleSWUpdateEntry, notebookLineNumber=notebookLineNumber, controlTrapSending=controlTrapSending, productKeyStatus=productKeyStatus, moduleBiosDate=moduleBiosDate, elementConfigChangeCode=elementConfigChangeCode, notebookLineText=notebookLineText, controlAlarmOnDelay=controlAlarmOnDelay, moduleRackNo=moduleRackNo, receiverAddress=receiverAddress, repairDate=repairDate, productKeyCipher=productKeyCipher, productKeyFeatureEntry=productKeyFeatureEntry, statusSettings=statusSettings, moduleInformation=moduleInformation, statusLmt=statusLmt, statusResetCause=statusResetCause, swUpdateURL=swUpdateURL, moduleRegistry=moduleRegistry, productKeyFeatureName=productKeyFeatureName, moduleBiosVersion=moduleBiosVersion, statusTemperature=statusTemperature, statusLidStatus=statusLidStatus, moduleHwVersion=moduleHwVersion, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyEntry=productKeyEntry, productKeyMask=productKeyMask, moduleHwType=moduleHwType, moduleSWUpdateTable=moduleSWUpdateTable, elementStructure=elementStructure, module=module, controlResetElement=controlResetElement, elementTotalUpTime=elementTotalUpTime, moduleSizeOfTable=moduleSizeOfTable, moduleBusAddress=moduleBusAddress, moduleStatusTable=moduleStatusTable, controlLedUsage=controlLedUsage, moduleDetailTable=moduleDetailTable, moduleControl=moduleControl, elementLatitude=elementLatitude, moduleHwSerialNumber=moduleHwSerialNumber, sWUpdateControl=sWUpdateControl, statusInternalTemperature=statusInternalTemperature, regName=regName, productKeyIndex=productKeyIndex, moduleTable=moduleTable, productKeyFeatureTable=productKeyFeatureTable, elementResetCount=elementResetCount)
