...
TimeTicks, NotificationType, Gauge32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Bits, Unsigned32, Counter64, ObjectIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Gauge32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Bits", "Unsigned32", "Counter64", "ObjectIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlBusMasterAdminState=controlBusMasterAdminState, productKeyCipher=productKeyCipher, swUpdateURL=swUpdateURL, moduleSWUpdateTable=moduleSWUpdateTable, element=element, controlMarkState=controlMarkState, statusInternalTemperature=statusInternalTemperature, controlAlarmOnDelay=controlAlarmOnDelay, moduleRackNo=moduleRackNo, elementControl=elementControl, statusResetCause=statusResetCause, moduleControl=moduleControl, moduleMacAddress=moduleMacAddress, statusHardware=statusHardware, moduleId=moduleId, productKeyFeatureIndex=productKeyFeatureIndex, productKeyFeatureEntry=productKeyFeatureEntry, repairDate=repairDate, elementProductKey=elementProductKey, receiverAddress=receiverAddress, statusLid=statusLid, elementInformation=elementInformation, controlAlarmDetection=controlAlarmDetection, moduleControlEntry=moduleControlEntry, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, statusBusMaster=statusBusMaster, controlTempLimitHiHi=controlTempLimitHiHi, sWUpdateStatus=sWUpdateStatus, regName=regName, sizeOfRegistry=sizeOfRegistry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementAltitude=elementAltitude, moduleRegistryTable=moduleRegistryTable, elementTotalUpTime=elementTotalUpTime, repairComment=repairComment, elementName=elementName, moduleHwSerialNumber=moduleHwSerialNumber, moduleDetailEntry=moduleDetailEntry, controlTrapLifeTime=controlTrapLifeTime, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempDeadBand=controlTempDeadBand, sWUpdateFileName=sWUpdateFileName, moduleRepairLogTable=moduleRepairLogTable, productKeyTable=productKeyTable, statusLmt=statusLmt, statusFan=statusFan, elementResetCount=elementResetCount, sizeOfRepairlog=sizeOfRepairlog, moduleAppDate=moduleAppDate, repairIndex=repairIndex, repairNameCode=repairNameCode, controlTrapDelay=controlTrapDelay, repairReasonCode=repairReasonCode, elementStatus=elementStatus, moduleSizeOfTable=moduleSizeOfTable, moduleStatus=moduleStatus, sWUpdateControl=sWUpdateControl, controlResetElement=controlResetElement, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapReceiverTable=controlTrapReceiverTable, receiverEntryId=receiverEntryId, notebookLineNumber=notebookLineNumber, statusTemperature=statusTemperature, productKeyStatus=productKeyStatus, moduleInformation=moduleInformation, statusSoftware=statusSoftware, controlLocalAccess=controlLocalAccess, controlReset=controlReset, moduleNotebookTable=moduleNotebookTable, moduleBusAddress=moduleBusAddress, statusLidStatus=statusLidStatus, module=module, receiverCommunity=receiverCommunity, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryEntry=moduleRegistryEntry, receiverPort=receiverPort, moduleBiosVersion=moduleBiosVersion, moduleHwType=moduleHwType, sizeOfNotebook=sizeOfNotebook, controlTempLimitLoLo=controlTempLimitLoLo, productKeyValue=productKeyValue, moduleStatusEntry=moduleStatusEntry, moduleTable=moduleTable, controlTrapInterval=controlTrapInterval, productKeyIndex=productKeyIndex, productKeyMask=productKeyMask, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapSending=controlTrapSending, moduleSizeOfEntry=moduleSizeOfEntry, moduleHwVersion=moduleHwVersion, moduleAppVersion=moduleAppVersion, elementLatitude=elementLatitude, controlInternalAppAccess=controlInternalAppAccess, statusSettings=statusSettings, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleBiosDate=moduleBiosDate, moduleEntry=moduleEntry, statusRunningSwImage=statusRunningSwImage, statusGeneral=statusGeneral, elementStructure=elementStructure, productKeyEntry=productKeyEntry, regIndex=regIndex, moduleName=moduleName, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleRepairLogEntry=moduleRepairLogEntry, moduleRegistry=moduleRegistry, moduleControlTable=moduleControlTable, controlTempLimitHi=controlTempLimitHi, notebookLineText=notebookLineText, elementLongitude=elementLongitude, statusRestartCounter=statusRestartCounter, controlTempLimitLo=controlTempLimitLo, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureTable=productKeyFeatureTable, moduleStatusTable=moduleStatusTable, moduleNotebookEntry=moduleNotebookEntry, regValue=regValue, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleDetailTable=moduleDetailTable)
