...
MibIdentifier, Integer32, iso, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ObjectIdentity, TimeTicks, ModuleIdentity, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "iso", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOffDelay=controlAlarmOffDelay, notebookLineText=notebookLineText, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleName=moduleName, statusResetCause=statusResetCause, regValue=regValue, controlTempLimitLoLo=controlTempLimitLoLo, repairIndex=repairIndex, moduleInformation=moduleInformation, moduleHwVersion=moduleHwVersion, controlAlarmDetection=controlAlarmDetection, receiverPort=receiverPort, statusTemperature=statusTemperature, repairComment=repairComment, statusHardware=statusHardware, controlTrapInterval=controlTrapInterval, statusLid=statusLid, elementLatitude=elementLatitude, element=element, sWUpdateStatus=sWUpdateStatus, regName=regName, controlTempLimitLo=controlTempLimitLo, moduleStatusTable=moduleStatusTable, moduleSizeOfTable=moduleSizeOfTable, controlInternalAppAccess=controlInternalAppAccess, repairNameCode=repairNameCode, moduleMacAddress=moduleMacAddress, statusSoftware=statusSoftware, moduleRegistryEntry=moduleRegistryEntry, moduleStatus=moduleStatus, productKeyMask=productKeyMask, statusInternalTemperature=statusInternalTemperature, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitHi=controlTempLimitHi, controlResetElement=controlResetElement, sWUpdateControl=sWUpdateControl, sizeOfRegistry=sizeOfRegistry, moduleRepairLogEntry=moduleRepairLogEntry, productKeyStatus=productKeyStatus, elementStructure=elementStructure, elementProductKey=elementProductKey, controlTrapSending=controlTrapSending, productKeyTable=productKeyTable, elementStatus=elementStatus, moduleDetailTable=moduleDetailTable, controlTempLimitHiHi=controlTempLimitHiHi, elementTotalUpTime=elementTotalUpTime, moduleAppDate=moduleAppDate, moduleDetailEntry=moduleDetailEntry, statusGeneral=statusGeneral, moduleRegistry=moduleRegistry, statusLidStatus=statusLidStatus, moduleEntry=moduleEntry, moduleSWUpdateTable=moduleSWUpdateTable, receiverAddress=receiverAddress, elementConfigChangeCode=elementConfigChangeCode, productKeyValue=productKeyValue, module=module, elementInformation=elementInformation, productKeyFeatureEntry=productKeyFeatureEntry, moduleBusAddress=moduleBusAddress, moduleControlEntry=moduleControlEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempDeadBand=controlTempDeadBand, moduleRepairLogTable=moduleRepairLogTable, productKeyIndex=productKeyIndex, statusFan=statusFan, productKeyFeatureTable=productKeyFeatureTable, moduleHwType=moduleHwType, controlLocalAccess=controlLocalAccess, controlAlarmOnDelay=controlAlarmOnDelay, moduleHwSerialNumber=moduleHwSerialNumber, elementLongitude=elementLongitude, productKeyFeatureIndex=productKeyFeatureIndex, productKeyCipher=productKeyCipher, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapReceiverTable=controlTrapReceiverTable, statusBusMaster=statusBusMaster, statusSettings=statusSettings, swUpdateURL=swUpdateURL, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleAppVersion=moduleAppVersion, controlTrapLifeTime=controlTrapLifeTime, controlMarkState=controlMarkState, sizeOfRepairlog=sizeOfRepairlog, controlTrapDelay=controlTrapDelay, statusLmt=statusLmt, notebookLineNumber=notebookLineNumber, sizeOfNotebook=sizeOfNotebook, repairReasonCode=repairReasonCode, controlReset=controlReset, moduleRackNo=moduleRackNo, elementName=elementName, statusRunningSwImage=statusRunningSwImage, moduleControl=moduleControl, moduleRegistryTable=moduleRegistryTable, moduleTable=moduleTable, elementResetCount=elementResetCount, productKeyFeatureEnable=productKeyFeatureEnable, moduleSlotNo=moduleSlotNo, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairDate=repairDate, moduleControlTable=moduleControlTable, elementControl=elementControl, controlLedUsage=controlLedUsage, productKeyEntry=productKeyEntry, moduleNotebookTable=moduleNotebookTable, sWUpdateFileName=sWUpdateFileName, receiverEntryId=receiverEntryId, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureName=productKeyFeatureName, moduleBiosDate=moduleBiosDate, receiverCommunity=receiverCommunity, statusRestartCounter=statusRestartCounter, moduleStatusEntry=moduleStatusEntry, moduleNotebookEntry=moduleNotebookEntry, regIndex=regIndex, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleBiosVersion=moduleBiosVersion, moduleId=moduleId, elementAltitude=elementAltitude)
