...
Unsigned32, Counter32, TimeTicks, ModuleIdentity, Gauge32, MibIdentifier, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "TimeTicks", "ModuleIdentity", "Gauge32", "MibIdentifier", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementTotalUpTime=elementTotalUpTime, notebookLineText=notebookLineText, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementName=elementName, controlLocalAccess=controlLocalAccess, controlTempLimitHi=controlTempLimitHi, productKeyFeatureTable=productKeyFeatureTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusResetCause=statusResetCause, productKeyCipher=productKeyCipher, controlTrapDelay=controlTrapDelay, moduleSlotNo=moduleSlotNo, sWUpdateFileName=sWUpdateFileName, moduleSizeOfTable=moduleSizeOfTable, moduleSizeOfEntry=moduleSizeOfEntry, moduleControlEntry=moduleControlEntry, repairComment=repairComment, controlLedUsage=controlLedUsage, elementLongitude=elementLongitude, productKeyFeatureEntry=productKeyFeatureEntry, controlAlarmOffDelay=controlAlarmOffDelay, regIndex=regIndex, productKeyFeatureName=productKeyFeatureName, controlInternalAppAccess=controlInternalAppAccess, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementStructure=elementStructure, productKeyStatus=productKeyStatus, moduleAppDate=moduleAppDate, controlTempLimitLo=controlTempLimitLo, statusInternalTemperature=statusInternalTemperature, moduleStatusEntry=moduleStatusEntry, sizeOfRegistry=sizeOfRegistry, moduleStatusTable=moduleStatusTable, moduleHwVersion=moduleHwVersion, moduleRegistry=moduleRegistry, statusHardware=statusHardware, statusSoftware=statusSoftware, productKeyEntry=productKeyEntry, statusRestartCounter=statusRestartCounter, moduleEntry=moduleEntry, elementStatus=elementStatus, statusBusMaster=statusBusMaster, elementAltitude=elementAltitude, elementControl=elementControl, moduleDetailEntry=moduleDetailEntry, statusRunningSwImage=statusRunningSwImage, controlBusMasterAdminState=controlBusMasterAdminState, productKeyMask=productKeyMask, moduleMacAddress=moduleMacAddress, controlResetElement=controlResetElement, statusTemperature=statusTemperature, moduleHwSerialNumber=moduleHwSerialNumber, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleId=moduleId, statusSettings=statusSettings, moduleRepairLogTable=moduleRepairLogTable, controlTempDeadBand=controlTempDeadBand, elementLatitude=elementLatitude, repairIndex=repairIndex, element=element, moduleBiosDate=moduleBiosDate, statusLid=statusLid, moduleHwType=moduleHwType, elementResetCount=elementResetCount, controlAlarmDetection=controlAlarmDetection, regValue=regValue, controlReset=controlReset, moduleControlTable=moduleControlTable, productKeyTable=productKeyTable, repairNameCode=repairNameCode, moduleBiosVersion=moduleBiosVersion, module=module, moduleName=moduleName, moduleBusAddress=moduleBusAddress, sWUpdateStatus=sWUpdateStatus, moduleRegistryEntry=moduleRegistryEntry, regName=regName, moduleControl=moduleControl, moduleNotebookEntry=moduleNotebookEntry, sizeOfRepairlog=sizeOfRepairlog, moduleAppVersion=moduleAppVersion, notebookLineNumber=notebookLineNumber, moduleRackNo=moduleRackNo, swUpdateURL=swUpdateURL, productKeyValue=productKeyValue, elementProductKey=elementProductKey, productKeyNumberOfKeys=productKeyNumberOfKeys, elementInformation=elementInformation, productKeyFeatureIndex=productKeyFeatureIndex, statusFan=statusFan, elementConfigChangeCode=elementConfigChangeCode, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureEnable=productKeyFeatureEnable, statusLmt=statusLmt, receiverAddress=receiverAddress, repairReasonCode=repairReasonCode, controlTempLimitHiHi=controlTempLimitHiHi, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapInterval=controlTrapInterval, moduleNotebookTable=moduleNotebookTable, moduleRegistryTable=moduleRegistryTable, controlAlarmOnDelay=controlAlarmOnDelay, productKeyIndex=productKeyIndex, receiverCommunity=receiverCommunity, moduleInformation=moduleInformation, controlTrapReceiverEntry=controlTrapReceiverEntry, receiverEntryId=receiverEntryId, moduleDetailTable=moduleDetailTable, controlMarkState=controlMarkState, controlTempLimitLoLo=controlTempLimitLoLo, controlTrapSending=controlTrapSending, sizeOfNotebook=sizeOfNotebook, statusLidStatus=statusLidStatus, statusGeneral=statusGeneral, repairDate=repairDate, moduleTable=moduleTable, sWUpdateControl=sWUpdateControl, receiverPort=receiverPort, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatus=moduleStatus)
