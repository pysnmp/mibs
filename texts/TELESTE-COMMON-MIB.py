...
TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, iso, ModuleIdentity, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "iso", "ModuleIdentity", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleControlTable=moduleControlTable, moduleStatusTable=moduleStatusTable, statusLid=statusLid, moduleName=moduleName, regName=regName, repairIndex=repairIndex, statusSettings=statusSettings, controlLocalAccess=controlLocalAccess, moduleNotebookTable=moduleNotebookTable, notebookLineText=notebookLineText, sizeOfRegistry=sizeOfRegistry, productKeyStatus=productKeyStatus, moduleTable=moduleTable, elementName=elementName, moduleHwSerialNumber=moduleHwSerialNumber, moduleRegistry=moduleRegistry, regValue=regValue, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementStructure=elementStructure, module=module, elementStatus=elementStatus, controlTempDeadBand=controlTempDeadBand, controlAlarmDetection=controlAlarmDetection, repairNameCode=repairNameCode, controlAlarmOnDelay=controlAlarmOnDelay, moduleBiosVersion=moduleBiosVersion, moduleRegistryTable=moduleRegistryTable, moduleRegistryEntry=moduleRegistryEntry, controlBusMasterAdminState=controlBusMasterAdminState, moduleRepairLogTable=moduleRepairLogTable, statusInternalTemperature=statusInternalTemperature, moduleDetailTable=moduleDetailTable, moduleControl=moduleControl, moduleHwVersion=moduleHwVersion, productKeyFeatureIndex=productKeyFeatureIndex, moduleStatusEntry=moduleStatusEntry, moduleNotebookEntry=moduleNotebookEntry, receiverPort=receiverPort, statusTemperature=statusTemperature, moduleAppVersion=moduleAppVersion, elementTotalUpTime=elementTotalUpTime, statusFan=statusFan, moduleMacAddress=moduleMacAddress, moduleEntry=moduleEntry, productKeyFeatureName=productKeyFeatureName, statusSoftware=statusSoftware, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairComment=repairComment, moduleInformation=moduleInformation, moduleSWUpdateEntry=moduleSWUpdateEntry, controlMarkState=controlMarkState, controlInternalAppAccess=controlInternalAppAccess, controlTrapLifeTime=controlTrapLifeTime, sizeOfNotebook=sizeOfNotebook, controlLedUsage=controlLedUsage, statusLidStatus=statusLidStatus, controlTrapSending=controlTrapSending, productKeyMask=productKeyMask, productKeyTable=productKeyTable, productKeyFeatureTable=productKeyFeatureTable, moduleAppDate=moduleAppDate, statusBusMaster=statusBusMaster, statusRunningSwImage=statusRunningSwImage, moduleControlEntry=moduleControlEntry, moduleBusAddress=moduleBusAddress, productKeyCipher=productKeyCipher, productKeyNumberOfKeys=productKeyNumberOfKeys, repairDate=repairDate, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapDelay=controlTrapDelay, controlResetElement=controlResetElement, receiverCommunity=receiverCommunity, regIndex=regIndex, elementControl=elementControl, controlReset=controlReset, controlTempLimitHiHi=controlTempLimitHiHi, statusLmt=statusLmt, receiverEntryId=receiverEntryId, moduleDetailEntry=moduleDetailEntry, controlTempLimitHi=controlTempLimitHi, receiverAddress=receiverAddress, repairReasonCode=repairReasonCode, controlTrapReceiverTable=controlTrapReceiverTable, elementResetCount=elementResetCount, productKeyIndex=productKeyIndex, elementLatitude=elementLatitude, productKeyValue=productKeyValue, moduleId=moduleId, moduleSizeOfTable=moduleSizeOfTable, elementAltitude=elementAltitude, controlTempLimitLo=controlTempLimitLo, sizeOfRepairlog=sizeOfRepairlog, productKeyEntry=productKeyEntry, statusGeneral=statusGeneral, controlTrapReceiverEntry=controlTrapReceiverEntry, elementConfigChangeCode=elementConfigChangeCode, element=element, moduleBiosDate=moduleBiosDate, sWUpdateStatus=sWUpdateStatus, elementProductKey=elementProductKey, statusHardware=statusHardware, sWUpdateControl=sWUpdateControl, moduleRackNo=moduleRackNo, notebookLineNumber=notebookLineNumber, controlTempLimitLoLo=controlTempLimitLoLo, sWUpdateFileName=sWUpdateFileName, productKeyFeatureEntry=productKeyFeatureEntry, moduleStatus=moduleStatus, moduleSlotNo=moduleSlotNo, moduleSWUpdateTable=moduleSWUpdateTable, controlAlarmOffDelay=controlAlarmOffDelay, statusRestartCounter=statusRestartCounter, moduleHwType=moduleHwType, moduleSizeOfEntry=moduleSizeOfEntry, elementInformation=elementInformation, elementLongitude=elementLongitude, statusResetCause=statusResetCause, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapInterval=controlTrapInterval, swUpdateURL=swUpdateURL)
