...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Integer32, ObjectIdentity, TimeTicks, Unsigned32, Bits, Gauge32, Counter32, Counter64, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Integer32", "ObjectIdentity", "TimeTicks", "Unsigned32", "Bits", "Gauge32", "Counter32", "Counter64", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLongitude=elementLongitude, statusInternalTemperature=statusInternalTemperature, repairNameCode=repairNameCode, module=module, moduleSizeOfEntry=moduleSizeOfEntry, moduleBusAddress=moduleBusAddress, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleTable=moduleTable, moduleDetailTable=moduleDetailTable, controlLocalAccess=controlLocalAccess, statusTemperature=statusTemperature, elementAltitude=elementAltitude, elementProductKey=elementProductKey, moduleStatusEntry=moduleStatusEntry, moduleBiosDate=moduleBiosDate, receiverPort=receiverPort, productKeyFeatureEntry=productKeyFeatureEntry, statusLmt=statusLmt, productKeyValue=productKeyValue, moduleMacAddress=moduleMacAddress, controlTempLimitLo=controlTempLimitLo, moduleBiosVersion=moduleBiosVersion, moduleDetailEntry=moduleDetailEntry, elementLatitude=elementLatitude, moduleRegistryEntry=moduleRegistryEntry, moduleHwType=moduleHwType, productKeyEntry=productKeyEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleInformation=moduleInformation, elementResetCount=elementResetCount, statusHardware=statusHardware, controlResetElement=controlResetElement, sWUpdateStatus=sWUpdateStatus, moduleRepairLogEntry=moduleRepairLogEntry, moduleSWUpdateTable=moduleSWUpdateTable, moduleNotebookTable=moduleNotebookTable, statusLidStatus=statusLidStatus, moduleControlEntry=moduleControlEntry, productKeyStatus=productKeyStatus, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitLoLo=controlTempLimitLoLo, controlAlarmDetection=controlAlarmDetection, regName=regName, statusRestartCounter=statusRestartCounter, controlTrapReceiverEntry=controlTrapReceiverEntry, repairIndex=repairIndex, notebookLineNumber=notebookLineNumber, statusFan=statusFan, elementControl=elementControl, controlTrapSending=controlTrapSending, statusLid=statusLid, controlMarkState=controlMarkState, repairDate=repairDate, statusRunningSwImage=statusRunningSwImage, swUpdateURL=swUpdateURL, productKeyFeatureName=productKeyFeatureName, sWUpdateControl=sWUpdateControl, sizeOfNotebook=sizeOfNotebook, moduleControlTable=moduleControlTable, receiverAddress=receiverAddress, elementStructure=elementStructure, productKeyMask=productKeyMask, moduleHwSerialNumber=moduleHwSerialNumber, repairReasonCode=repairReasonCode, moduleId=moduleId, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleControl=moduleControl, elementConfigChangeCode=elementConfigChangeCode, productKeyCipher=productKeyCipher, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusGeneral=statusGeneral, repairComment=repairComment, moduleRegistryTable=moduleRegistryTable, productKeyFeatureEnable=productKeyFeatureEnable, receiverCommunity=receiverCommunity, moduleRepairLogTable=moduleRepairLogTable, moduleEntry=moduleEntry, moduleAppVersion=moduleAppVersion, moduleStatus=moduleStatus, moduleRegistry=moduleRegistry, moduleSizeOfTable=moduleSizeOfTable, controlInternalAppAccess=controlInternalAppAccess, notebookLineText=notebookLineText, moduleName=moduleName, controlAlarmOffDelay=controlAlarmOffDelay, productKeyIndex=productKeyIndex, statusSoftware=statusSoftware, elementInformation=elementInformation, controlAlarmOnDelay=controlAlarmOnDelay, moduleSlotNo=moduleSlotNo, moduleHwVersion=moduleHwVersion, moduleAppDate=moduleAppDate, elementName=elementName, sizeOfRegistry=sizeOfRegistry, controlTrapReceiverTable=controlTrapReceiverTable, regValue=regValue, controlTrapInterval=controlTrapInterval, elementTotalUpTime=elementTotalUpTime, controlTrapDelay=controlTrapDelay, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementStatus=elementStatus, controlTrapLifeTime=controlTrapLifeTime, controlBusMasterAdminState=controlBusMasterAdminState, controlReset=controlReset, statusBusMaster=statusBusMaster, regIndex=regIndex, productKeyFeatureIndex=productKeyFeatureIndex, statusResetCause=statusResetCause, statusSettings=statusSettings, controlLedUsage=controlLedUsage, sWUpdateFileName=sWUpdateFileName, receiverEntryId=receiverEntryId, moduleNotebookEntry=moduleNotebookEntry, productKeyTable=productKeyTable, sizeOfRepairlog=sizeOfRepairlog, controlTempLimitHi=controlTempLimitHi, moduleRackNo=moduleRackNo, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempDeadBand=controlTempDeadBand, moduleStatusTable=moduleStatusTable, element=element)
