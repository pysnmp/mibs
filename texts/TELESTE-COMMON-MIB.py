...
Bits, Gauge32, Counter64, TimeTicks, NotificationType, Unsigned32, ObjectIdentity, iso, Counter32, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Counter64", "TimeTicks", "NotificationType", "Unsigned32", "ObjectIdentity", "iso", "Counter32", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleStatusTable=moduleStatusTable, controlMarkState=controlMarkState, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapDelay=controlTrapDelay, receiverCommunity=receiverCommunity, moduleAppVersion=moduleAppVersion, controlTempDeadBand=controlTempDeadBand, productKeyFeatureIndex=productKeyFeatureIndex, swUpdateURL=swUpdateURL, elementAltitude=elementAltitude, moduleName=moduleName, elementStructure=elementStructure, statusRunningSwImage=statusRunningSwImage, controlLedUsage=controlLedUsage, statusLmt=statusLmt, receiverPort=receiverPort, elementLatitude=elementLatitude, repairReasonCode=repairReasonCode, elementName=elementName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitLo=controlTempLimitLo, moduleAppDate=moduleAppDate, moduleBiosVersion=moduleBiosVersion, elementStatus=elementStatus, moduleControl=moduleControl, moduleRackNo=moduleRackNo, controlBusMasterAdminState=controlBusMasterAdminState, repairNameCode=repairNameCode, controlResetElement=controlResetElement, controlInternalAppAccess=controlInternalAppAccess, statusHardware=statusHardware, controlTempLimitHi=controlTempLimitHi, moduleBusAddress=moduleBusAddress, statusFan=statusFan, moduleStatus=moduleStatus, moduleInformation=moduleInformation, moduleEntry=moduleEntry, productKeyStatus=productKeyStatus, moduleDetailEntry=moduleDetailEntry, module=module, sWUpdateControl=sWUpdateControl, moduleRegistryEntry=moduleRegistryEntry, moduleDetailTable=moduleDetailTable, productKeyTable=productKeyTable, productKeyMask=productKeyMask, moduleSWUpdateTable=moduleSWUpdateTable, elementInformation=elementInformation, elementConfigChangeCode=elementConfigChangeCode, statusRestartCounter=statusRestartCounter, moduleSizeOfEntry=moduleSizeOfEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureEnable=productKeyFeatureEnable, elementControl=elementControl, productKeyFeatureTable=productKeyFeatureTable, moduleMacAddress=moduleMacAddress, sizeOfRegistry=sizeOfRegistry, statusSoftware=statusSoftware, controlTrapInterval=controlTrapInterval, controlTempLimitHiHi=controlTempLimitHiHi, regIndex=regIndex, statusLid=statusLid, moduleControlEntry=moduleControlEntry, moduleNotebookTable=moduleNotebookTable, sWUpdateFileName=sWUpdateFileName, moduleSlotNo=moduleSlotNo, productKeyFeatureEntry=productKeyFeatureEntry, productKeyCipher=productKeyCipher, statusGeneral=statusGeneral, sizeOfRepairlog=sizeOfRepairlog, productKeyIndex=productKeyIndex, moduleTable=moduleTable, moduleHwType=moduleHwType, notebookLineNumber=notebookLineNumber, statusSettings=statusSettings, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistry=moduleRegistry, moduleRegistryTable=moduleRegistryTable, statusTemperature=statusTemperature, regName=regName, sWUpdateStatus=sWUpdateStatus, receiverAddress=receiverAddress, productKeyValue=productKeyValue, moduleNotebookEntry=moduleNotebookEntry, moduleId=moduleId, elementTotalUpTime=elementTotalUpTime, statusBusMaster=statusBusMaster, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwVersion=moduleHwVersion, moduleSizeOfTable=moduleSizeOfTable, element=element, moduleRepairLogTable=moduleRepairLogTable, moduleControlTable=moduleControlTable, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmDetection=controlAlarmDetection, controlReset=controlReset, repairIndex=repairIndex, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureName=productKeyFeatureName, statusResetCause=statusResetCause, elementLongitude=elementLongitude, elementResetCount=elementResetCount, moduleHwSerialNumber=moduleHwSerialNumber, statusLidStatus=statusLidStatus, statusInternalTemperature=statusInternalTemperature, elementProductKey=elementProductKey, regValue=regValue, receiverEntryId=receiverEntryId, moduleBiosDate=moduleBiosDate, controlTrapSending=controlTrapSending, controlTempLimitLoLo=controlTempLimitLoLo, productKeyEntry=productKeyEntry, controlAlarmOnDelay=controlAlarmOnDelay, controlLocalAccess=controlLocalAccess, notebookLineText=notebookLineText, controlAlarmOffDelay=controlAlarmOffDelay, repairDate=repairDate, sizeOfNotebook=sizeOfNotebook, repairComment=repairComment, moduleStatusEntry=moduleStatusEntry, moduleRepairLogEntry=moduleRepairLogEntry)
