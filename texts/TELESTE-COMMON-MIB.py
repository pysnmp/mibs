...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, iso, NotificationType, ModuleIdentity, IpAddress, Integer32, Counter32, TimeTicks, MibIdentifier, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "ModuleIdentity", "IpAddress", "Integer32", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateFileName=sWUpdateFileName, controlTrapSending=controlTrapSending, productKeyTable=productKeyTable, moduleStatus=moduleStatus, controlTempDeadBand=controlTempDeadBand, moduleMacAddress=moduleMacAddress, statusSoftware=statusSoftware, moduleSizeOfTable=moduleSizeOfTable, elementLatitude=elementLatitude, controlLocalAccess=controlLocalAccess, repairIndex=repairIndex, elementResetCount=elementResetCount, moduleNotebookEntry=moduleNotebookEntry, productKeyIndex=productKeyIndex, statusLmt=statusLmt, controlTempLimitLo=controlTempLimitLo, productKeyNumberOfKeys=productKeyNumberOfKeys, statusFan=statusFan, statusRestartCounter=statusRestartCounter, moduleBiosVersion=moduleBiosVersion, moduleSizeOfEntry=moduleSizeOfEntry, moduleHwVersion=moduleHwVersion, moduleControlEntry=moduleControlEntry, productKeyEntry=productKeyEntry, module=module, elementAltitude=elementAltitude, moduleId=moduleId, productKeyFeatureEntry=productKeyFeatureEntry, elementLongitude=elementLongitude, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleHwType=moduleHwType, controlTempLimitLoLo=controlTempLimitLoLo, controlResetElement=controlResetElement, moduleEntry=moduleEntry, receiverCommunity=receiverCommunity, statusResetCause=statusResetCause, elementTotalUpTime=elementTotalUpTime, receiverEntryId=receiverEntryId, moduleControl=moduleControl, statusRunningSwImage=statusRunningSwImage, moduleSlotNo=moduleSlotNo, moduleRegistryEntry=moduleRegistryEntry, sizeOfRepairlog=sizeOfRepairlog, moduleSWUpdateTable=moduleSWUpdateTable, moduleHwSerialNumber=moduleHwSerialNumber, notebookLineNumber=notebookLineNumber, elementStructure=elementStructure, receiverPort=receiverPort, controlTrapDelay=controlTrapDelay, statusSettings=statusSettings, controlReset=controlReset, controlTrapLifeTime=controlTrapLifeTime, productKeyCipher=productKeyCipher, regValue=regValue, productKeyFeatureIndex=productKeyFeatureIndex, moduleRepairLogTable=moduleRepairLogTable, elementControl=elementControl, controlTrapInterval=controlTrapInterval, statusLidStatus=statusLidStatus, statusLid=statusLid, controlAlarmDetection=controlAlarmDetection, elementInformation=elementInformation, controlBusMasterAdminState=controlBusMasterAdminState, moduleStatusEntry=moduleStatusEntry, moduleAppVersion=moduleAppVersion, controlInternalAppAccess=controlInternalAppAccess, controlAlarmOnDelay=controlAlarmOnDelay, notebookLineText=notebookLineText, moduleControlTable=moduleControlTable, element=element, elementConfigChangeCode=elementConfigChangeCode, controlLedUsage=controlLedUsage, moduleBusAddress=moduleBusAddress, receiverAddress=receiverAddress, productKeyMask=productKeyMask, productKeyFeatureEnable=productKeyFeatureEnable, repairReasonCode=repairReasonCode, controlTempLimitHiHi=controlTempLimitHiHi, moduleBiosDate=moduleBiosDate, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleNotebookTable=moduleNotebookTable, moduleStatusTable=moduleStatusTable, moduleInformation=moduleInformation, moduleDetailTable=moduleDetailTable, sWUpdateStatus=sWUpdateStatus, regName=regName, statusHardware=statusHardware, productKeyValue=productKeyValue, productKeyFeatureTable=productKeyFeatureTable, moduleAppDate=moduleAppDate, controlTrapReceiverTable=controlTrapReceiverTable, statusInternalTemperature=statusInternalTemperature, sWUpdateControl=sWUpdateControl, elementName=elementName, repairNameCode=repairNameCode, moduleDetailEntry=moduleDetailEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, swUpdateURL=swUpdateURL, sizeOfNotebook=sizeOfNotebook, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistryTable=moduleRegistryTable, statusBusMaster=statusBusMaster, moduleTable=moduleTable, productKeyStatus=productKeyStatus, moduleRackNo=moduleRackNo, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureName=productKeyFeatureName, repairComment=repairComment, elementProductKey=elementProductKey, controlTempLimitHi=controlTempLimitHi, regIndex=regIndex, moduleRegistry=moduleRegistry, moduleRepairLogEntry=moduleRepairLogEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairDate=repairDate, controlMarkState=controlMarkState, statusTemperature=statusTemperature, statusGeneral=statusGeneral, moduleName=moduleName, elementStatus=elementStatus, sizeOfRegistry=sizeOfRegistry)
