...
ObjectIdentity, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, MibIdentifier, Counter32, Bits, Counter64, iso, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "MibIdentifier", "Counter32", "Bits", "Counter64", "iso", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverEntryId=receiverEntryId, controlTempLimitHiHi=controlTempLimitHiHi, moduleControlEntry=moduleControlEntry, productKeyEntry=productKeyEntry, productKeyMask=productKeyMask, moduleNotebookEntry=moduleNotebookEntry, elementControl=elementControl, elementProductKey=elementProductKey, moduleId=moduleId, productKeyIndex=productKeyIndex, module=module, moduleAppDate=moduleAppDate, swUpdateURL=swUpdateURL, moduleSWUpdateTable=moduleSWUpdateTable, receiverAddress=receiverAddress, statusInternalTemperature=statusInternalTemperature, moduleNotebookTable=moduleNotebookTable, repairReasonCode=repairReasonCode, moduleBiosVersion=moduleBiosVersion, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTempDeadBand=controlTempDeadBand, moduleMacAddress=moduleMacAddress, controlInternalAppAccess=controlInternalAppAccess, statusRunningSwImage=statusRunningSwImage, repairDate=repairDate, productKeyStatus=productKeyStatus, moduleSizeOfEntry=moduleSizeOfEntry, repairNameCode=repairNameCode, controlTempLimitHi=controlTempLimitHi, elementStatus=elementStatus, moduleStatusTable=moduleStatusTable, productKeyTable=productKeyTable, sizeOfRegistry=sizeOfRegistry, moduleDetailEntry=moduleDetailEntry, sWUpdateControl=sWUpdateControl, moduleInformation=moduleInformation, moduleName=moduleName, receiverPort=receiverPort, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateStatus=sWUpdateStatus, moduleRackNo=moduleRackNo, moduleHwVersion=moduleHwVersion, controlTrapDelay=controlTrapDelay, moduleRepairLogEntry=moduleRepairLogEntry, productKeyFeatureTable=productKeyFeatureTable, moduleRegistryEntry=moduleRegistryEntry, elementTotalUpTime=elementTotalUpTime, moduleHwType=moduleHwType, moduleBusAddress=moduleBusAddress, statusLmt=statusLmt, moduleDetailTable=moduleDetailTable, regName=regName, notebookLineNumber=notebookLineNumber, element=element, elementStructure=elementStructure, controlLedUsage=controlLedUsage, moduleStatusEntry=moduleStatusEntry, statusTemperature=statusTemperature, moduleControlTable=moduleControlTable, repairComment=repairComment, elementLongitude=elementLongitude, repairIndex=repairIndex, receiverCommunity=receiverCommunity, sWUpdateFileName=sWUpdateFileName, elementResetCount=elementResetCount, controlTrapSending=controlTrapSending, statusGeneral=statusGeneral, statusBusMaster=statusBusMaster, statusSoftware=statusSoftware, productKeyFeatureEnable=productKeyFeatureEnable, statusLidStatus=statusLidStatus, moduleHwSerialNumber=moduleHwSerialNumber, moduleAppVersion=moduleAppVersion, elementLatitude=elementLatitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSizeOfTable=moduleSizeOfTable, productKeyFeatureEntry=productKeyFeatureEntry, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineText=notebookLineText, moduleBiosDate=moduleBiosDate, sizeOfNotebook=sizeOfNotebook, controlBusMasterAdminState=controlBusMasterAdminState, productKeyCipher=productKeyCipher, elementInformation=elementInformation, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleControl=moduleControl, moduleEntry=moduleEntry, moduleRegistry=moduleRegistry, moduleTable=moduleTable, controlMarkState=controlMarkState, moduleRegistryTable=moduleRegistryTable, controlTrapInterval=controlTrapInterval, controlLocalAccess=controlLocalAccess, elementConfigChangeCode=elementConfigChangeCode, regIndex=regIndex, statusLid=statusLid, statusHardware=statusHardware, statusRestartCounter=statusRestartCounter, statusResetCause=statusResetCause, moduleRepairLogTable=moduleRepairLogTable, controlAlarmOnDelay=controlAlarmOnDelay, statusFan=statusFan, elementAltitude=elementAltitude, elementName=elementName, controlReset=controlReset, sizeOfRepairlog=sizeOfRepairlog, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyValue=productKeyValue, moduleStatus=moduleStatus, controlResetElement=controlResetElement, controlAlarmDetection=controlAlarmDetection, statusSettings=statusSettings, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitLo=controlTempLimitLo, productKeyFeatureName=productKeyFeatureName, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureIndex=productKeyFeatureIndex, regValue=regValue, controlTrapReceiverTable=controlTrapReceiverTable)
