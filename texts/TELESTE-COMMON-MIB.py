...
ModuleIdentity, TimeTicks, Integer32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, MibIdentifier, ObjectIdentity, Gauge32, Counter64, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Integer32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter64", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlMarkState=controlMarkState, sWUpdateStatus=sWUpdateStatus, moduleRackNo=moduleRackNo, elementLatitude=elementLatitude, moduleRepairLogEntry=moduleRepairLogEntry, repairReasonCode=repairReasonCode, receiverCommunity=receiverCommunity, moduleName=moduleName, moduleHwType=moduleHwType, notebookLineText=notebookLineText, elementControl=elementControl, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusSettings=statusSettings, productKeyCipher=productKeyCipher, productKeyFeatureEntry=productKeyFeatureEntry, notebookLineNumber=notebookLineNumber, moduleBiosVersion=moduleBiosVersion, moduleControlEntry=moduleControlEntry, controlTrapLifeTime=controlTrapLifeTime, productKeyMask=productKeyMask, module=module, elementResetCount=elementResetCount, moduleSlotNo=moduleSlotNo, productKeyStatus=productKeyStatus, statusGeneral=statusGeneral, elementInformation=elementInformation, controlLedUsage=controlLedUsage, productKeyFeatureName=productKeyFeatureName, statusLidStatus=statusLidStatus, productKeyFeatureTable=productKeyFeatureTable, productKeyIndex=productKeyIndex, controlLocalAccess=controlLocalAccess, moduleSizeOfEntry=moduleSizeOfEntry, controlInternalAppAccess=controlInternalAppAccess, swUpdateURL=swUpdateURL, moduleId=moduleId, moduleBiosDate=moduleBiosDate, moduleAppVersion=moduleAppVersion, sWUpdateControl=sWUpdateControl, element=element, controlReset=controlReset, statusRestartCounter=statusRestartCounter, moduleDetailTable=moduleDetailTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleStatusEntry=moduleStatusEntry, elementName=elementName, moduleRegistry=moduleRegistry, receiverAddress=receiverAddress, controlTempLimitLo=controlTempLimitLo, moduleSizeOfTable=moduleSizeOfTable, statusTemperature=statusTemperature, controlResetElement=controlResetElement, moduleNotebookTable=moduleNotebookTable, elementLongitude=elementLongitude, moduleRegistryEntry=moduleRegistryEntry, elementStatus=elementStatus, controlBusMasterAdminState=controlBusMasterAdminState, controlTempLimitHiHi=controlTempLimitHiHi, productKeyEntry=productKeyEntry, sizeOfRepairlog=sizeOfRepairlog, elementProductKey=elementProductKey, repairNameCode=repairNameCode, sizeOfNotebook=sizeOfNotebook, moduleControlTable=moduleControlTable, repairIndex=repairIndex, productKeyNumberOfKeys=productKeyNumberOfKeys, statusLid=statusLid, repairDate=repairDate, moduleEntry=moduleEntry, moduleControl=moduleControl, controlTempDeadBand=controlTempDeadBand, controlTrapInterval=controlTrapInterval, receiverPort=receiverPort, moduleRegistryTable=moduleRegistryTable, sWUpdateFileName=sWUpdateFileName, elementConfigChangeCode=elementConfigChangeCode, regName=regName, statusSoftware=statusSoftware, moduleNotebookEntry=moduleNotebookEntry, controlTempLimitHi=controlTempLimitHi, controlAlarmOnDelay=controlAlarmOnDelay, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleAppDate=moduleAppDate, controlTrapDelay=controlTrapDelay, sizeOfRegistry=sizeOfRegistry, moduleMacAddress=moduleMacAddress, controlTrapReceiverTable=controlTrapReceiverTable, moduleInformation=moduleInformation, elementTotalUpTime=elementTotalUpTime, receiverEntryId=receiverEntryId, repairComment=repairComment, controlAlarmOffDelay=controlAlarmOffDelay, statusLmt=statusLmt, statusFan=statusFan, statusInternalTemperature=statusInternalTemperature, statusBusMaster=statusBusMaster, productKeyValue=productKeyValue, regValue=regValue, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyFeatureEnable=productKeyFeatureEnable, statusResetCause=statusResetCause, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureIndex=productKeyFeatureIndex, moduleTable=moduleTable, moduleRepairLogTable=moduleRepairLogTable, statusRunningSwImage=statusRunningSwImage, productKeyTable=productKeyTable, elementAltitude=elementAltitude, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatusTable=moduleStatusTable, elementStructure=elementStructure, moduleBusAddress=moduleBusAddress, moduleHwSerialNumber=moduleHwSerialNumber, regIndex=regIndex, moduleHwVersion=moduleHwVersion, statusHardware=statusHardware, moduleStatus=moduleStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleDetailEntry=moduleDetailEntry, controlTrapSending=controlTrapSending, controlAlarmDetection=controlAlarmDetection)
