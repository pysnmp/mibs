...
MibIdentifier, Counter64, ObjectIdentity, IpAddress, Counter32, NotificationType, Bits, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ObjectIdentity", "IpAddress", "Counter32", "NotificationType", "Bits", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapDelay=controlTrapDelay, moduleRepairLogEntry=moduleRepairLogEntry, moduleStatus=moduleStatus, moduleHwType=moduleHwType, elementLongitude=elementLongitude, statusLidStatus=statusLidStatus, productKeyEntry=productKeyEntry, sWUpdateControl=sWUpdateControl, element=element, controlLedUsage=controlLedUsage, controlTempLimitHi=controlTempLimitHi, moduleRegistryTable=moduleRegistryTable, statusFan=statusFan, sizeOfRepairlog=sizeOfRepairlog, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureEntry=productKeyFeatureEntry, elementInformation=elementInformation, moduleBiosVersion=moduleBiosVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRegistry=moduleRegistry, productKeyFeatureName=productKeyFeatureName, moduleControl=moduleControl, controlTrapLifeTime=controlTrapLifeTime, moduleDetailTable=moduleDetailTable, controlTempLimitLo=controlTempLimitLo, controlTrapReceiverEntry=controlTrapReceiverEntry, sWUpdateFileName=sWUpdateFileName, receiverAddress=receiverAddress, moduleNotebookEntry=moduleNotebookEntry, moduleNotebookTable=moduleNotebookTable, controlTempDeadBand=controlTempDeadBand, notebookLineText=notebookLineText, elementProductKey=elementProductKey, moduleDetailEntry=moduleDetailEntry, regValue=regValue, statusBusMaster=statusBusMaster, sizeOfNotebook=sizeOfNotebook, receiverPort=receiverPort, controlTrapReceiverTable=controlTrapReceiverTable, elementResetCount=elementResetCount, regName=regName, repairNameCode=repairNameCode, productKeyMask=productKeyMask, repairComment=repairComment, elementControl=elementControl, regIndex=regIndex, moduleRegistryEntry=moduleRegistryEntry, statusLmt=statusLmt, controlAlarmDetection=controlAlarmDetection, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairIndex=repairIndex, elementTotalUpTime=elementTotalUpTime, repairDate=repairDate, controlTrapSending=controlTrapSending, moduleControlEntry=moduleControlEntry, statusInternalTemperature=statusInternalTemperature, statusRunningSwImage=statusRunningSwImage, notebookLineNumber=notebookLineNumber, moduleRackNo=moduleRackNo, productKeyStatus=productKeyStatus, swUpdateURL=swUpdateURL, moduleHwSerialNumber=moduleHwSerialNumber, sWUpdateStatus=sWUpdateStatus, controlInternalAppAccess=controlInternalAppAccess, moduleEntry=moduleEntry, productKeyCipher=productKeyCipher, controlReset=controlReset, moduleSizeOfTable=moduleSizeOfTable, moduleAppDate=moduleAppDate, statusHardware=statusHardware, statusLid=statusLid, module=module, controlTrapInterval=controlTrapInterval, controlResetElement=controlResetElement, controlTempLimitHiHi=controlTempLimitHiHi, moduleHwVersion=moduleHwVersion, elementName=elementName, controlAlarmOnDelay=controlAlarmOnDelay, receiverEntryId=receiverEntryId, productKeyFeatureTable=productKeyFeatureTable, elementAltitude=elementAltitude, moduleSWUpdateTable=moduleSWUpdateTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusResetCause=statusResetCause, statusSoftware=statusSoftware, moduleInformation=moduleInformation, moduleSizeOfEntry=moduleSizeOfEntry, statusRestartCounter=statusRestartCounter, productKeyValue=productKeyValue, sizeOfRegistry=sizeOfRegistry, moduleRepairLogTable=moduleRepairLogTable, elementConfigChangeCode=elementConfigChangeCode, statusTemperature=statusTemperature, moduleName=moduleName, controlLocalAccess=controlLocalAccess, moduleControlTable=moduleControlTable, elementStatus=elementStatus, controlAlarmOffDelay=controlAlarmOffDelay, repairReasonCode=repairReasonCode, controlTempLimitLoLo=controlTempLimitLoLo, elementStructure=elementStructure, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosDate=moduleBiosDate, productKeyIndex=productKeyIndex, statusSettings=statusSettings, moduleMacAddress=moduleMacAddress, statusGeneral=statusGeneral, moduleAppVersion=moduleAppVersion, moduleStatusEntry=moduleStatusEntry, moduleSlotNo=moduleSlotNo, moduleBusAddress=moduleBusAddress, productKeyTable=productKeyTable, controlMarkState=controlMarkState, moduleStatusTable=moduleStatusTable, moduleId=moduleId, elementLatitude=elementLatitude, productKeyFeatureEnable=productKeyFeatureEnable, receiverCommunity=receiverCommunity, moduleTable=moduleTable)
