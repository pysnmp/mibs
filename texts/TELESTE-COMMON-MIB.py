...
IpAddress, Counter64, Integer32, TimeTicks, Gauge32, Unsigned32, iso, Counter32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Integer32", "TimeTicks", "Gauge32", "Unsigned32", "iso", "Counter32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyMask=productKeyMask, productKeyFeatureEntry=productKeyFeatureEntry, elementTotalUpTime=elementTotalUpTime, moduleBiosVersion=moduleBiosVersion, moduleControlTable=moduleControlTable, regName=regName, elementStatus=elementStatus, statusHardware=statusHardware, moduleSWUpdateTable=moduleSWUpdateTable, moduleSlotNo=moduleSlotNo, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRepairLogEntry=moduleRepairLogEntry, statusLmt=statusLmt, statusLid=statusLid, productKeyValue=productKeyValue, sWUpdateStatus=sWUpdateStatus, productKeyTable=productKeyTable, repairIndex=repairIndex, controlReset=controlReset, element=element, controlBusMasterAdminState=controlBusMasterAdminState, moduleRegistryEntry=moduleRegistryEntry, controlTrapLifeTime=controlTrapLifeTime, elementConfigChangeCode=elementConfigChangeCode, repairReasonCode=repairReasonCode, controlTrapInterval=controlTrapInterval, productKeyFeatureEnable=productKeyFeatureEnable, moduleBiosDate=moduleBiosDate, statusTemperature=statusTemperature, moduleSWUpdateEntry=moduleSWUpdateEntry, elementName=elementName, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleInformation=moduleInformation, sizeOfRepairlog=sizeOfRepairlog, moduleHwType=moduleHwType, moduleControlEntry=moduleControlEntry, regValue=regValue, receiverPort=receiverPort, controlLedUsage=controlLedUsage, controlTempLimitHiHi=controlTempLimitHiHi, controlAlarmOffDelay=controlAlarmOffDelay, elementInformation=elementInformation, controlAlarmDetection=controlAlarmDetection, moduleMacAddress=moduleMacAddress, moduleDetailTable=moduleDetailTable, controlTempLimitLoLo=controlTempLimitLoLo, moduleSizeOfTable=moduleSizeOfTable, moduleStatus=moduleStatus, moduleAppDate=moduleAppDate, controlInternalAppAccess=controlInternalAppAccess, moduleStatusTable=moduleStatusTable, elementControl=elementControl, notebookLineText=notebookLineText, receiverAddress=receiverAddress, statusLidStatus=statusLidStatus, controlTrapDelay=controlTrapDelay, controlAlarmOnDelay=controlAlarmOnDelay, statusGeneral=statusGeneral, moduleRackNo=moduleRackNo, controlLocalAccess=controlLocalAccess, repairComment=repairComment, elementLongitude=elementLongitude, productKeyFeatureTable=productKeyFeatureTable, statusFan=statusFan, regIndex=regIndex, controlTrapReceiverTable=controlTrapReceiverTable, statusInternalTemperature=statusInternalTemperature, sWUpdateFileName=sWUpdateFileName, sizeOfNotebook=sizeOfNotebook, moduleRegistry=moduleRegistry, moduleName=moduleName, statusRunningSwImage=statusRunningSwImage, statusBusMaster=statusBusMaster, controlTrapReceiverEntry=controlTrapReceiverEntry, receiverCommunity=receiverCommunity, elementResetCount=elementResetCount, controlTrapSending=controlTrapSending, moduleBusAddress=moduleBusAddress, sWUpdateControl=sWUpdateControl, controlMarkState=controlMarkState, controlTempDeadBand=controlTempDeadBand, controlTempLimitHi=controlTempLimitHi, controlTempLimitLo=controlTempLimitLo, moduleHwVersion=moduleHwVersion, moduleDetailEntry=moduleDetailEntry, repairNameCode=repairNameCode, moduleStatusEntry=moduleStatusEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleId=moduleId, productKeyEntry=productKeyEntry, moduleRegistryTable=moduleRegistryTable, productKeyStatus=productKeyStatus, module=module, controlResetElement=controlResetElement, moduleNotebookTable=moduleNotebookTable, moduleAppVersion=moduleAppVersion, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfRegistry=sizeOfRegistry, productKeyFeatureName=productKeyFeatureName, swUpdateURL=swUpdateURL, moduleNotebookEntry=moduleNotebookEntry, productKeyIndex=productKeyIndex, statusRestartCounter=statusRestartCounter, moduleControl=moduleControl, receiverEntryId=receiverEntryId, productKeyCipher=productKeyCipher, statusSoftware=statusSoftware, moduleHwSerialNumber=moduleHwSerialNumber, statusResetCause=statusResetCause, elementLatitude=elementLatitude, moduleRepairLogTable=moduleRepairLogTable, repairDate=repairDate, elementStructure=elementStructure, statusSettings=statusSettings, elementAltitude=elementAltitude, moduleEntry=moduleEntry, productKeyFeatureIndex=productKeyFeatureIndex, notebookLineNumber=notebookLineNumber, moduleTable=moduleTable, elementProductKey=elementProductKey)
