...
Integer32, Gauge32, Unsigned32, Counter64, IpAddress, TimeTicks, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Counter32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Unsigned32", "Counter64", "IpAddress", "TimeTicks", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Counter32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyEntry=productKeyEntry, moduleSWUpdateTable=moduleSWUpdateTable, sizeOfRepairlog=sizeOfRepairlog, notebookLineNumber=notebookLineNumber, productKeyStatus=productKeyStatus, moduleRackNo=moduleRackNo, repairComment=repairComment, productKeyFeatureIndex=productKeyFeatureIndex, productKeyTable=productKeyTable, moduleBusAddress=moduleBusAddress, elementControl=elementControl, statusRunningSwImage=statusRunningSwImage, regName=regName, moduleStatusEntry=moduleStatusEntry, repairDate=repairDate, controlTempLimitLo=controlTempLimitLo, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementTotalUpTime=elementTotalUpTime, elementProductKey=elementProductKey, moduleStatus=moduleStatus, elementConfigChangeCode=elementConfigChangeCode, moduleControlEntry=moduleControlEntry, moduleBiosVersion=moduleBiosVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRegistryTable=moduleRegistryTable, regIndex=regIndex, moduleHwVersion=moduleHwVersion, controlMarkState=controlMarkState, sWUpdateFileName=sWUpdateFileName, controlTrapDelay=controlTrapDelay, moduleControl=moduleControl, elementStatus=elementStatus, elementResetCount=elementResetCount, controlTrapReceiverTable=controlTrapReceiverTable, productKeyCipher=productKeyCipher, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmDetection=controlAlarmDetection, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleMacAddress=moduleMacAddress, element=element, repairIndex=repairIndex, sWUpdateControl=sWUpdateControl, moduleRepairLogTable=moduleRepairLogTable, controlLocalAccess=controlLocalAccess, statusResetCause=statusResetCause, productKeyFeatureTable=productKeyFeatureTable, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, receiverPort=receiverPort, statusSoftware=statusSoftware, elementName=elementName, moduleRegistryEntry=moduleRegistryEntry, controlBusMasterAdminState=controlBusMasterAdminState, moduleSlotNo=moduleSlotNo, moduleId=moduleId, controlTempLimitHi=controlTempLimitHi, statusTemperature=statusTemperature, statusLidStatus=statusLidStatus, moduleNotebookTable=moduleNotebookTable, controlReset=controlReset, controlAlarmOnDelay=controlAlarmOnDelay, sWUpdateStatus=sWUpdateStatus, moduleStatusTable=moduleStatusTable, controlTempLimitLoLo=controlTempLimitLoLo, elementStructure=elementStructure, productKeyIndex=productKeyIndex, moduleNotebookEntry=moduleNotebookEntry, elementInformation=elementInformation, moduleTable=moduleTable, controlTrapLifeTime=controlTrapLifeTime, moduleControlTable=moduleControlTable, statusHardware=statusHardware, elementLongitude=elementLongitude, elementAltitude=elementAltitude, controlTrapInterval=controlTrapInterval, moduleAppVersion=moduleAppVersion, moduleSizeOfEntry=moduleSizeOfEntry, productKeyMask=productKeyMask, receiverAddress=receiverAddress, productKeyValue=productKeyValue, controlLedUsage=controlLedUsage, swUpdateURL=swUpdateURL, receiverEntryId=receiverEntryId, statusInternalTemperature=statusInternalTemperature, statusLid=statusLid, moduleDetailEntry=moduleDetailEntry, notebookLineText=notebookLineText, statusRestartCounter=statusRestartCounter, moduleEntry=moduleEntry, statusGeneral=statusGeneral, moduleName=moduleName, productKeyFeatureEntry=productKeyFeatureEntry, productKeyFeatureName=productKeyFeatureName, statusBusMaster=statusBusMaster, elementLatitude=elementLatitude, moduleInformation=moduleInformation, controlInternalAppAccess=controlInternalAppAccess, controlTempLimitHiHi=controlTempLimitHiHi, repairReasonCode=repairReasonCode, moduleHwType=moduleHwType, repairNameCode=repairNameCode, statusFan=statusFan, moduleBiosDate=moduleBiosDate, module=module, moduleSizeOfTable=moduleSizeOfTable, moduleRegistry=moduleRegistry, controlTrapSending=controlTrapSending, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfRegistry=sizeOfRegistry, statusSettings=statusSettings, moduleRepairLogEntry=moduleRepairLogEntry, moduleAppDate=moduleAppDate, receiverCommunity=receiverCommunity, moduleHwSerialNumber=moduleHwSerialNumber, regValue=regValue, controlTempDeadBand=controlTempDeadBand, controlResetElement=controlResetElement, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapReceiverEntry=controlTrapReceiverEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleDetailTable=moduleDetailTable)
