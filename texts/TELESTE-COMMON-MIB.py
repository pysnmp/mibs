...
ModuleIdentity, iso, Unsigned32, TimeTicks, IpAddress, Counter64, ObjectIdentity, Bits, MibIdentifier, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Unsigned32", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverPort=receiverPort, productKeyTable=productKeyTable, productKeyFeatureTable=productKeyFeatureTable, controlAlarmOffDelay=controlAlarmOffDelay, moduleSWUpdateEntry=moduleSWUpdateEntry, elementConfigChangeCode=elementConfigChangeCode, productKeyCipher=productKeyCipher, sWUpdateStatus=sWUpdateStatus, moduleBiosVersion=moduleBiosVersion, receiverAddress=receiverAddress, statusSoftware=statusSoftware, receiverEntryId=receiverEntryId, moduleEntry=moduleEntry, swUpdateURL=swUpdateURL, statusLmt=statusLmt, statusInternalTemperature=statusInternalTemperature, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapSending=controlTrapSending, moduleControlEntry=moduleControlEntry, elementStatus=elementStatus, controlBusMasterAdminState=controlBusMasterAdminState, repairComment=repairComment, moduleSlotNo=moduleSlotNo, moduleMacAddress=moduleMacAddress, controlTempDeadBand=controlTempDeadBand, moduleStatus=moduleStatus, statusLidStatus=statusLidStatus, moduleRepairLogTable=moduleRepairLogTable, elementName=elementName, productKeyMask=productKeyMask, elementLatitude=elementLatitude, moduleId=moduleId, moduleAppDate=moduleAppDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementProductKey=elementProductKey, controlTempLimitLo=controlTempLimitLo, moduleRegistry=moduleRegistry, controlAlarmDetection=controlAlarmDetection, productKeyFeatureIndex=productKeyFeatureIndex, moduleAppVersion=moduleAppVersion, moduleBusAddress=moduleBusAddress, controlTempLimitHi=controlTempLimitHi, controlTempLimitLoLo=controlTempLimitLoLo, notebookLineNumber=notebookLineNumber, sWUpdateFileName=sWUpdateFileName, elementInformation=elementInformation, sizeOfRepairlog=sizeOfRepairlog, statusTemperature=statusTemperature, moduleNotebookTable=moduleNotebookTable, statusBusMaster=statusBusMaster, controlMarkState=controlMarkState, controlTrapInterval=controlTrapInterval, productKeyFeatureEntry=productKeyFeatureEntry, elementAltitude=elementAltitude, statusRestartCounter=statusRestartCounter, regName=regName, moduleHwVersion=moduleHwVersion, moduleControlTable=moduleControlTable, controlTrapReceiverTable=controlTrapReceiverTable, productKeyIndex=productKeyIndex, elementStructure=elementStructure, moduleSizeOfEntry=moduleSizeOfEntry, repairReasonCode=repairReasonCode, moduleStatusTable=moduleStatusTable, moduleHwType=moduleHwType, productKeyValue=productKeyValue, statusRunningSwImage=statusRunningSwImage, moduleRegistryTable=moduleRegistryTable, statusLid=statusLid, sizeOfNotebook=sizeOfNotebook, productKeyStatus=productKeyStatus, moduleName=moduleName, moduleBiosDate=moduleBiosDate, sWUpdateControl=sWUpdateControl, moduleNotebookEntry=moduleNotebookEntry, module=module, controlResetElement=controlResetElement, regValue=regValue, elementControl=elementControl, moduleRackNo=moduleRackNo, receiverCommunity=receiverCommunity, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRegistryEntry=moduleRegistryEntry, statusHardware=statusHardware, moduleDetailEntry=moduleDetailEntry, repairIndex=repairIndex, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapLifeTime=controlTrapLifeTime, moduleDetailTable=moduleDetailTable, moduleControl=moduleControl, productKeyEntry=productKeyEntry, controlLocalAccess=controlLocalAccess, moduleSizeOfTable=moduleSizeOfTable, statusFan=statusFan, elementLongitude=elementLongitude, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleInformation=moduleInformation, controlInternalAppAccess=controlInternalAppAccess, regIndex=regIndex, repairDate=repairDate, controlTrapDelay=controlTrapDelay, elementTotalUpTime=elementTotalUpTime, statusResetCause=statusResetCause, moduleHwSerialNumber=moduleHwSerialNumber, elementResetCount=elementResetCount, moduleTable=moduleTable, repairNameCode=repairNameCode, element=element, statusSettings=statusSettings, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogEntry=moduleRepairLogEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlLedUsage=controlLedUsage, moduleSWUpdateTable=moduleSWUpdateTable, controlReset=controlReset, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyFeatureName=productKeyFeatureName, sizeOfRegistry=sizeOfRegistry, notebookLineText=notebookLineText, moduleStatusEntry=moduleStatusEntry, statusGeneral=statusGeneral)
