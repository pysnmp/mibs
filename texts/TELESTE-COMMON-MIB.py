...
iso, Integer32, Counter64, Gauge32, ModuleIdentity, MibIdentifier, Counter32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Counter64", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleDetailTable=moduleDetailTable, moduleRackNo=moduleRackNo, productKeyValue=productKeyValue, productKeyIndex=productKeyIndex, controlAlarmOffDelay=controlAlarmOffDelay, moduleRegistryTable=moduleRegistryTable, controlBusMasterAdminState=controlBusMasterAdminState, controlAlarmDetection=controlAlarmDetection, moduleId=moduleId, repairIndex=repairIndex, moduleHwVersion=moduleHwVersion, statusRestartCounter=statusRestartCounter, moduleControlEntry=moduleControlEntry, moduleStatus=moduleStatus, sWUpdateStatus=sWUpdateStatus, sizeOfRepairlog=sizeOfRepairlog, moduleRepairLogEntry=moduleRepairLogEntry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureTable=productKeyFeatureTable, controlTrapReceiverEntry=controlTrapReceiverEntry, sWUpdateControl=sWUpdateControl, statusSoftware=statusSoftware, productKeyFeatureEntry=productKeyFeatureEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempDeadBand=controlTempDeadBand, controlLocalAccess=controlLocalAccess, controlTempLimitHi=controlTempLimitHi, repairDate=repairDate, moduleRepairLogTable=moduleRepairLogTable, moduleAppVersion=moduleAppVersion, controlTrapDelay=controlTrapDelay, receiverPort=receiverPort, moduleHwSerialNumber=moduleHwSerialNumber, statusLmt=statusLmt, productKeyMask=productKeyMask, controlTempLimitHiHi=controlTempLimitHiHi, controlLedUsage=controlLedUsage, statusGeneral=statusGeneral, moduleTable=moduleTable, moduleNotebookEntry=moduleNotebookEntry, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateTable=moduleSWUpdateTable, moduleNotebookTable=moduleNotebookTable, moduleStatusEntry=moduleStatusEntry, moduleControlTable=moduleControlTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementTotalUpTime=elementTotalUpTime, controlReset=controlReset, elementConfigChangeCode=elementConfigChangeCode, elementLongitude=elementLongitude, regName=regName, productKeyStatus=productKeyStatus, moduleName=moduleName, elementLatitude=elementLatitude, receiverEntryId=receiverEntryId, sizeOfRegistry=sizeOfRegistry, controlAlarmOnDelay=controlAlarmOnDelay, controlResetElement=controlResetElement, notebookLineText=notebookLineText, moduleMacAddress=moduleMacAddress, moduleHwType=moduleHwType, elementAltitude=elementAltitude, elementStructure=elementStructure, swUpdateURL=swUpdateURL, controlTrapReceiverTable=controlTrapReceiverTable, moduleSlotNo=moduleSlotNo, statusLid=statusLid, module=module, moduleBusAddress=moduleBusAddress, regIndex=regIndex, notebookLineNumber=notebookLineNumber, productKeyEntry=productKeyEntry, elementStatus=elementStatus, statusResetCause=statusResetCause, moduleInformation=moduleInformation, statusBusMaster=statusBusMaster, moduleSizeOfTable=moduleSizeOfTable, statusFan=statusFan, repairReasonCode=repairReasonCode, productKeyNumberOfKeys=productKeyNumberOfKeys, elementInformation=elementInformation, productKeyFeatureIndex=productKeyFeatureIndex, moduleDetailEntry=moduleDetailEntry, moduleEntry=moduleEntry, controlTempLimitLoLo=controlTempLimitLoLo, moduleRegistryEntry=moduleRegistryEntry, statusLidStatus=statusLidStatus, moduleAppDate=moduleAppDate, elementResetCount=elementResetCount, productKeyCipher=productKeyCipher, controlMarkState=controlMarkState, moduleBiosDate=moduleBiosDate, regValue=regValue, elementName=elementName, moduleStatusTable=moduleStatusTable, statusHardware=statusHardware, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBiosVersion=moduleBiosVersion, moduleControl=moduleControl, controlTrapSending=controlTrapSending, controlInternalAppAccess=controlInternalAppAccess, sizeOfNotebook=sizeOfNotebook, receiverAddress=receiverAddress, moduleSizeOfEntry=moduleSizeOfEntry, sWUpdateFileName=sWUpdateFileName, productKeyTable=productKeyTable, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEnable=productKeyFeatureEnable, receiverCommunity=receiverCommunity, controlTrapLifeTime=controlTrapLifeTime, repairComment=repairComment, elementProductKey=elementProductKey, moduleRegistry=moduleRegistry, elementControl=elementControl, controlTrapInterval=controlTrapInterval, statusSettings=statusSettings, controlTempLimitLo=controlTempLimitLo, repairNameCode=repairNameCode, element=element, statusTemperature=statusTemperature, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers)
