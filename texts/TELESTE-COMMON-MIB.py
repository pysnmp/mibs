...
iso, ModuleIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, IpAddress, Bits, NotificationType, Gauge32, MibIdentifier, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "IpAddress", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureTable=productKeyFeatureTable, statusHardware=statusHardware, sizeOfNotebook=sizeOfNotebook, notebookLineNumber=notebookLineNumber, controlInternalAppAccess=controlInternalAppAccess, moduleInformation=moduleInformation, swUpdateURL=swUpdateURL, moduleRegistryEntry=moduleRegistryEntry, moduleControl=moduleControl, moduleRegistryTable=moduleRegistryTable, elementStructure=elementStructure, elementControl=elementControl, receiverCommunity=receiverCommunity, moduleSizeOfTable=moduleSizeOfTable, moduleSizeOfEntry=moduleSizeOfEntry, statusTemperature=statusTemperature, moduleStatusTable=moduleStatusTable, elementTotalUpTime=elementTotalUpTime, statusBusMaster=statusBusMaster, controlTrapSending=controlTrapSending, moduleHwType=moduleHwType, controlTempLimitHiHi=controlTempLimitHiHi, moduleRepairLogEntry=moduleRepairLogEntry, moduleAppVersion=moduleAppVersion, moduleNotebookTable=moduleNotebookTable, productKeyValue=productKeyValue, statusLmt=statusLmt, moduleName=moduleName, productKeyMask=productKeyMask, receiverPort=receiverPort, moduleBiosVersion=moduleBiosVersion, moduleDetailTable=moduleDetailTable, productKeyFeatureName=productKeyFeatureName, sizeOfRepairlog=sizeOfRepairlog, notebookLineText=notebookLineText, controlTempLimitLo=controlTempLimitLo, elementConfigChangeCode=elementConfigChangeCode, moduleEntry=moduleEntry, moduleAppDate=moduleAppDate, sizeOfRegistry=sizeOfRegistry, moduleSlotNo=moduleSlotNo, statusFan=statusFan, moduleBiosDate=moduleBiosDate, productKeyFeatureIndex=productKeyFeatureIndex, moduleId=moduleId, productKeyStatus=productKeyStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureEntry=productKeyFeatureEntry, moduleDetailEntry=moduleDetailEntry, elementInformation=elementInformation, controlTrapDelay=controlTrapDelay, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwVersion=moduleHwVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapReceiverTable=controlTrapReceiverTable, moduleRepairLogTable=moduleRepairLogTable, repairNameCode=repairNameCode, moduleRegistry=moduleRegistry, elementLongitude=elementLongitude, moduleRackNo=moduleRackNo, moduleControlTable=moduleControlTable, statusGeneral=statusGeneral, controlResetElement=controlResetElement, statusRestartCounter=statusRestartCounter, controlTempLimitHi=controlTempLimitHi, sWUpdateStatus=sWUpdateStatus, moduleHwSerialNumber=moduleHwSerialNumber, elementProductKey=elementProductKey, controlAlarmOnDelay=controlAlarmOnDelay, controlAlarmDetection=controlAlarmDetection, moduleSWUpdateTable=moduleSWUpdateTable, elementStatus=elementStatus, statusSettings=statusSettings, repairReasonCode=repairReasonCode, statusLid=statusLid, controlAlarmOffDelay=controlAlarmOffDelay, productKeyEntry=productKeyEntry, regValue=regValue, receiverEntryId=receiverEntryId, controlTrapLifeTime=controlTrapLifeTime, productKeyTable=productKeyTable, statusInternalTemperature=statusInternalTemperature, elementLatitude=elementLatitude, elementAltitude=elementAltitude, moduleControlEntry=moduleControlEntry, sWUpdateControl=sWUpdateControl, repairComment=repairComment, controlLocalAccess=controlLocalAccess, controlTempDeadBand=controlTempDeadBand, moduleBusAddress=moduleBusAddress, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleMacAddress=moduleMacAddress, controlReset=controlReset, statusLidStatus=statusLidStatus, moduleStatusEntry=moduleStatusEntry, element=element, controlBusMasterAdminState=controlBusMasterAdminState, controlMarkState=controlMarkState, elementName=elementName, sWUpdateFileName=sWUpdateFileName, moduleStatus=moduleStatus, statusSoftware=statusSoftware, controlTrapReceiverEntry=controlTrapReceiverEntry, elementResetCount=elementResetCount, regName=regName, module=module, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairIndex=repairIndex, productKeyCipher=productKeyCipher, receiverAddress=receiverAddress, regIndex=regIndex, statusRunningSwImage=statusRunningSwImage, repairDate=repairDate, controlTempLimitLoLo=controlTempLimitLoLo, moduleTable=moduleTable, moduleNotebookEntry=moduleNotebookEntry, statusResetCause=statusResetCause, controlLedUsage=controlLedUsage, productKeyIndex=productKeyIndex, controlTrapInterval=controlTrapInterval)
