...
Counter64, iso, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Gauge32, ObjectIdentity, MibIdentifier, Bits, TimeTicks, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Gauge32", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusGeneral=statusGeneral, controlTrapDelay=controlTrapDelay, controlTrapSending=controlTrapSending, receiverEntryId=receiverEntryId, controlMarkState=controlMarkState, controlAlarmDetection=controlAlarmDetection, moduleRegistry=moduleRegistry, controlResetElement=controlResetElement, moduleRackNo=moduleRackNo, controlTrapInterval=controlTrapInterval, repairIndex=repairIndex, module=module, moduleInformation=moduleInformation, regValue=regValue, moduleHwType=moduleHwType, moduleDetailTable=moduleDetailTable, elementStatus=elementStatus, productKeyIndex=productKeyIndex, regIndex=regIndex, productKeyFeatureIndex=productKeyFeatureIndex, moduleSlotNo=moduleSlotNo, productKeyFeatureTable=productKeyFeatureTable, moduleStatusEntry=moduleStatusEntry, moduleSWUpdateTable=moduleSWUpdateTable, moduleBusAddress=moduleBusAddress, moduleHwVersion=moduleHwVersion, controlTrapReceiverTable=controlTrapReceiverTable, controlBusMasterAdminState=controlBusMasterAdminState, statusSettings=statusSettings, controlReset=controlReset, productKeyMask=productKeyMask, repairReasonCode=repairReasonCode, controlTempLimitHi=controlTempLimitHi, moduleBiosVersion=moduleBiosVersion, regName=regName, controlTempLimitHiHi=controlTempLimitHiHi, notebookLineText=notebookLineText, repairComment=repairComment, elementName=elementName, statusTemperature=statusTemperature, productKeyEntry=productKeyEntry, sizeOfNotebook=sizeOfNotebook, sizeOfRepairlog=sizeOfRepairlog, moduleNotebookTable=moduleNotebookTable, moduleBiosDate=moduleBiosDate, statusRestartCounter=statusRestartCounter, statusFan=statusFan, moduleControlEntry=moduleControlEntry, productKeyFeatureEnable=productKeyFeatureEnable, moduleDetailEntry=moduleDetailEntry, elementResetCount=elementResetCount, moduleAppVersion=moduleAppVersion, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyStatus=productKeyStatus, controlTrapLifeTime=controlTrapLifeTime, repairDate=repairDate, moduleNotebookEntry=moduleNotebookEntry, statusLidStatus=statusLidStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sizeOfRegistry=sizeOfRegistry, controlLedUsage=controlLedUsage, receiverAddress=receiverAddress, moduleSizeOfTable=moduleSizeOfTable, elementInformation=elementInformation, moduleAppDate=moduleAppDate, productKeyTable=productKeyTable, controlTrapReceiverEntry=controlTrapReceiverEntry, statusLid=statusLid, productKeyValue=productKeyValue, statusHardware=statusHardware, elementLatitude=elementLatitude, elementAltitude=elementAltitude, statusLmt=statusLmt, elementStructure=elementStructure, receiverCommunity=receiverCommunity, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogTable=moduleRepairLogTable, controlAlarmOffDelay=controlAlarmOffDelay, moduleStatusTable=moduleStatusTable, controlLocalAccess=controlLocalAccess, moduleEntry=moduleEntry, statusRunningSwImage=statusRunningSwImage, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTempDeadBand=controlTempDeadBand, productKeyNumberOfKeys=productKeyNumberOfKeys, statusBusMaster=statusBusMaster, moduleName=moduleName, moduleTable=moduleTable, moduleRepairLogEntry=moduleRepairLogEntry, elementProductKey=elementProductKey, controlTempLimitLoLo=controlTempLimitLoLo, moduleId=moduleId, moduleRegistryEntry=moduleRegistryEntry, statusInternalTemperature=statusInternalTemperature, swUpdateURL=swUpdateURL, controlTempLimitLo=controlTempLimitLo, productKeyCipher=productKeyCipher, moduleRegistryTable=moduleRegistryTable, statusSoftware=statusSoftware, sWUpdateStatus=sWUpdateStatus, elementTotalUpTime=elementTotalUpTime, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureEntry=productKeyFeatureEntry, sWUpdateFileName=sWUpdateFileName, moduleControlTable=moduleControlTable, element=element, receiverPort=receiverPort, moduleControl=moduleControl, moduleStatus=moduleStatus, elementLongitude=elementLongitude, sWUpdateControl=sWUpdateControl, productKeyFeatureName=productKeyFeatureName, moduleHwSerialNumber=moduleHwSerialNumber, notebookLineNumber=notebookLineNumber, repairNameCode=repairNameCode, moduleSizeOfEntry=moduleSizeOfEntry, statusResetCause=statusResetCause, moduleMacAddress=moduleMacAddress, controlInternalAppAccess=controlInternalAppAccess, elementControl=elementControl)
