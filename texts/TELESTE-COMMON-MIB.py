...
ObjectIdentity, Counter32, Integer32, TimeTicks, IpAddress, Counter64, ModuleIdentity, Unsigned32, Gauge32, MibIdentifier, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Integer32", "TimeTicks", "IpAddress", "Counter64", "ModuleIdentity", "Unsigned32", "Gauge32", "MibIdentifier", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleControl=moduleControl, productKeyCipher=productKeyCipher, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusResetCause=statusResetCause, statusInternalTemperature=statusInternalTemperature, moduleNotebookTable=moduleNotebookTable, controlAlarmOnDelay=controlAlarmOnDelay, element=element, moduleAppDate=moduleAppDate, statusTemperature=statusTemperature, controlReset=controlReset, repairNameCode=repairNameCode, moduleHwSerialNumber=moduleHwSerialNumber, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyMask=productKeyMask, moduleRegistry=moduleRegistry, controlTrapLifeTime=controlTrapLifeTime, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTempLimitHiHi=controlTempLimitHiHi, notebookLineText=notebookLineText, receiverCommunity=receiverCommunity, moduleRackNo=moduleRackNo, elementStructure=elementStructure, elementResetCount=elementResetCount, statusRunningSwImage=statusRunningSwImage, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyValue=productKeyValue, regName=regName, productKeyStatus=productKeyStatus, moduleNotebookEntry=moduleNotebookEntry, controlTempDeadBand=controlTempDeadBand, productKeyEntry=productKeyEntry, elementLatitude=elementLatitude, moduleDetailEntry=moduleDetailEntry, elementInformation=elementInformation, moduleStatus=moduleStatus, receiverPort=receiverPort, sizeOfRegistry=sizeOfRegistry, moduleControlTable=moduleControlTable, moduleHwType=moduleHwType, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleBusAddress=moduleBusAddress, statusHardware=statusHardware, receiverEntryId=receiverEntryId, module=module, controlTrapReceiverEntry=controlTrapReceiverEntry, statusGeneral=statusGeneral, controlMarkState=controlMarkState, moduleHwVersion=moduleHwVersion, moduleBiosDate=moduleBiosDate, elementControl=elementControl, repairReasonCode=repairReasonCode, statusLmt=statusLmt, moduleSizeOfTable=moduleSizeOfTable, moduleId=moduleId, moduleSizeOfEntry=moduleSizeOfEntry, receiverAddress=receiverAddress, statusLid=statusLid, sWUpdateStatus=sWUpdateStatus, productKeyIndex=productKeyIndex, notebookLineNumber=notebookLineNumber, productKeyFeatureEntry=productKeyFeatureEntry, elementName=elementName, moduleStatusEntry=moduleStatusEntry, moduleAppVersion=moduleAppVersion, elementAltitude=elementAltitude, regValue=regValue, elementConfigChangeCode=elementConfigChangeCode, controlLocalAccess=controlLocalAccess, statusRestartCounter=statusRestartCounter, statusFan=statusFan, statusLidStatus=statusLidStatus, productKeyFeatureName=productKeyFeatureName, swUpdateURL=swUpdateURL, moduleRepairLogTable=moduleRepairLogTable, moduleRegistryTable=moduleRegistryTable, controlTempLimitLo=controlTempLimitLo, moduleName=moduleName, elementStatus=elementStatus, controlResetElement=controlResetElement, repairComment=repairComment, statusBusMaster=statusBusMaster, moduleControlEntry=moduleControlEntry, sWUpdateControl=sWUpdateControl, moduleBiosVersion=moduleBiosVersion, controlTempLimitLoLo=controlTempLimitLoLo, regIndex=regIndex, statusSettings=statusSettings, moduleSlotNo=moduleSlotNo, productKeyTable=productKeyTable, sizeOfNotebook=sizeOfNotebook, controlTrapDelay=controlTrapDelay, elementLongitude=elementLongitude, statusSoftware=statusSoftware, controlTrapReceiverTable=controlTrapReceiverTable, elementProductKey=elementProductKey, controlBusMasterAdminState=controlBusMasterAdminState, controlInternalAppAccess=controlInternalAppAccess, controlTrapSending=controlTrapSending, repairDate=repairDate, moduleTable=moduleTable, productKeyFeatureIndex=productKeyFeatureIndex, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureEnable=productKeyFeatureEnable, elementTotalUpTime=elementTotalUpTime, moduleSWUpdateTable=moduleSWUpdateTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleMacAddress=moduleMacAddress, controlLedUsage=controlLedUsage, moduleRegistryEntry=moduleRegistryEntry, moduleDetailTable=moduleDetailTable, controlTempLimitHi=controlTempLimitHi, moduleStatusTable=moduleStatusTable, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureTable=productKeyFeatureTable, moduleInformation=moduleInformation, repairIndex=repairIndex, moduleEntry=moduleEntry, controlAlarmDetection=controlAlarmDetection, controlTrapInterval=controlTrapInterval)
