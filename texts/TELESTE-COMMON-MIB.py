...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32, TimeTicks, NotificationType, Gauge32, IpAddress, iso, ObjectIdentity, Unsigned32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "iso", "ObjectIdentity", "Unsigned32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlInternalAppAccess=controlInternalAppAccess, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosDate=moduleBiosDate, moduleHwType=moduleHwType, receiverAddress=receiverAddress, moduleControlTable=moduleControlTable, productKeyFeatureTable=productKeyFeatureTable, moduleMacAddress=moduleMacAddress, moduleStatus=moduleStatus, moduleHwVersion=moduleHwVersion, elementProductKey=elementProductKey, statusInternalTemperature=statusInternalTemperature, moduleHwSerialNumber=moduleHwSerialNumber, statusSoftware=statusSoftware, sizeOfRegistry=sizeOfRegistry, controlBusMasterAdminState=controlBusMasterAdminState, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairIndex=repairIndex, controlAlarmDetection=controlAlarmDetection, receiverPort=receiverPort, regIndex=regIndex, statusSettings=statusSettings, controlTempLimitHiHi=controlTempLimitHiHi, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitLo=controlTempLimitLo, controlAlarmOnDelay=controlAlarmOnDelay, elementLatitude=elementLatitude, productKeyIndex=productKeyIndex, moduleAppDate=moduleAppDate, controlTempDeadBand=controlTempDeadBand, productKeyFeatureEntry=productKeyFeatureEntry, moduleBiosVersion=moduleBiosVersion, moduleNotebookTable=moduleNotebookTable, statusRunningSwImage=statusRunningSwImage, sizeOfNotebook=sizeOfNotebook, moduleControlEntry=moduleControlEntry, sWUpdateStatus=sWUpdateStatus, moduleTable=moduleTable, moduleSWUpdateTable=moduleSWUpdateTable, repairDate=repairDate, statusBusMaster=statusBusMaster, elementResetCount=elementResetCount, moduleSlotNo=moduleSlotNo, statusGeneral=statusGeneral, moduleRegistryTable=moduleRegistryTable, regValue=regValue, productKeyEntry=productKeyEntry, controlTrapInterval=controlTrapInterval, moduleBusAddress=moduleBusAddress, moduleDetailEntry=moduleDetailEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureEnable=productKeyFeatureEnable, moduleDetailTable=moduleDetailTable, moduleRepairLogEntry=moduleRepairLogEntry, productKeyValue=productKeyValue, sWUpdateFileName=sWUpdateFileName, controlResetElement=controlResetElement, moduleRegistryEntry=moduleRegistryEntry, controlTrapReceiverTable=controlTrapReceiverTable, notebookLineText=notebookLineText, module=module, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementStructure=elementStructure, notebookLineNumber=notebookLineNumber, repairReasonCode=repairReasonCode, moduleNotebookEntry=moduleNotebookEntry, controlTrapLifeTime=controlTrapLifeTime, controlLedUsage=controlLedUsage, sWUpdateControl=sWUpdateControl, sizeOfRepairlog=sizeOfRepairlog, productKeyMask=productKeyMask, elementLongitude=elementLongitude, moduleName=moduleName, statusResetCause=statusResetCause, controlReset=controlReset, controlTrapSending=controlTrapSending, statusRestartCounter=statusRestartCounter, repairNameCode=repairNameCode, elementTotalUpTime=elementTotalUpTime, moduleRegistry=moduleRegistry, statusLmt=statusLmt, controlMarkState=controlMarkState, moduleStatusTable=moduleStatusTable, elementAltitude=elementAltitude, receiverCommunity=receiverCommunity, controlTempLimitLoLo=controlTempLimitLoLo, regName=regName, repairComment=repairComment, moduleStatusEntry=moduleStatusEntry, swUpdateURL=swUpdateURL, moduleSizeOfEntry=moduleSizeOfEntry, moduleSizeOfTable=moduleSizeOfTable, productKeyStatus=productKeyStatus, productKeyFeatureName=productKeyFeatureName, statusFan=statusFan, moduleId=moduleId, elementName=elementName, moduleControl=moduleControl, elementInformation=elementInformation, productKeyTable=productKeyTable, elementControl=elementControl, elementStatus=elementStatus, controlTrapDelay=controlTrapDelay, moduleEntry=moduleEntry, controlTempLimitHi=controlTempLimitHi, moduleAppVersion=moduleAppVersion, controlLocalAccess=controlLocalAccess, moduleRepairLogTable=moduleRepairLogTable, statusTemperature=statusTemperature, statusLidStatus=statusLidStatus, productKeyCipher=productKeyCipher, element=element, moduleRackNo=moduleRackNo, statusLid=statusLid, statusHardware=statusHardware, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleInformation=moduleInformation, moduleSWUpdateEntry=moduleSWUpdateEntry, receiverEntryId=receiverEntryId)
