...
ObjectIdentity, Integer32, IpAddress, TimeTicks, Counter64, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Gauge32, MibIdentifier, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "IpAddress", "TimeTicks", "Counter64", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Gauge32", "MibIdentifier", "iso", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sizeOfRegistry=sizeOfRegistry, statusBusMaster=statusBusMaster, controlAlarmDetection=controlAlarmDetection, controlLedUsage=controlLedUsage, moduleRegistryEntry=moduleRegistryEntry, elementStatus=elementStatus, productKeyFeatureEntry=productKeyFeatureEntry, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistry=moduleRegistry, regIndex=regIndex, controlTrapSending=controlTrapSending, moduleDetailEntry=moduleDetailEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleSizeOfEntry=moduleSizeOfEntry, moduleRackNo=moduleRackNo, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapLifeTime=controlTrapLifeTime, sWUpdateControl=sWUpdateControl, productKeyTable=productKeyTable, controlReset=controlReset, moduleHwVersion=moduleHwVersion, productKeyFeatureEnable=productKeyFeatureEnable, elementTotalUpTime=elementTotalUpTime, controlTrapReceiverEntry=controlTrapReceiverEntry, elementConfigChangeCode=elementConfigChangeCode, moduleAppVersion=moduleAppVersion, controlLocalAccess=controlLocalAccess, moduleHwSerialNumber=moduleHwSerialNumber, elementControl=elementControl, statusLidStatus=statusLidStatus, controlTrapInterval=controlTrapInterval, moduleStatusEntry=moduleStatusEntry, controlInternalAppAccess=controlInternalAppAccess, controlTrapDelay=controlTrapDelay, repairNameCode=repairNameCode, repairComment=repairComment, elementName=elementName, moduleAppDate=moduleAppDate, repairIndex=repairIndex, sWUpdateStatus=sWUpdateStatus, moduleNotebookEntry=moduleNotebookEntry, moduleMacAddress=moduleMacAddress, elementLongitude=elementLongitude, moduleTable=moduleTable, productKeyNumberOfKeys=productKeyNumberOfKeys, sizeOfNotebook=sizeOfNotebook, moduleControlEntry=moduleControlEntry, controlTempLimitLo=controlTempLimitLo, moduleRepairLogEntry=moduleRepairLogEntry, statusGeneral=statusGeneral, moduleControlTable=moduleControlTable, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitHi=controlTempLimitHi, moduleRegistryTable=moduleRegistryTable, receiverEntryId=receiverEntryId, statusSettings=statusSettings, controlResetElement=controlResetElement, regName=regName, moduleId=moduleId, regValue=regValue, productKeyFeatureName=productKeyFeatureName, element=element, elementResetCount=elementResetCount, receiverCommunity=receiverCommunity, repairDate=repairDate, notebookLineText=notebookLineText, moduleEntry=moduleEntry, moduleBusAddress=moduleBusAddress, controlTempLimitLoLo=controlTempLimitLoLo, productKeyStatus=productKeyStatus, swUpdateURL=swUpdateURL, moduleBiosDate=moduleBiosDate, controlBusMasterAdminState=controlBusMasterAdminState, statusLmt=statusLmt, productKeyCipher=productKeyCipher, moduleDetailTable=moduleDetailTable, elementProductKey=elementProductKey, statusHardware=statusHardware, sWUpdateFileName=sWUpdateFileName, moduleControl=moduleControl, statusSoftware=statusSoftware, statusResetCause=statusResetCause, controlTrapReceiverTable=controlTrapReceiverTable, moduleBiosVersion=moduleBiosVersion, receiverPort=receiverPort, moduleHwType=moduleHwType, productKeyFeatureTable=productKeyFeatureTable, moduleNotebookTable=moduleNotebookTable, productKeyMask=productKeyMask, statusFan=statusFan, moduleStatusTable=moduleStatusTable, moduleName=moduleName, repairReasonCode=repairReasonCode, statusLid=statusLid, receiverAddress=receiverAddress, statusRunningSwImage=statusRunningSwImage, productKeyIndex=productKeyIndex, controlMarkState=controlMarkState, statusInternalTemperature=statusInternalTemperature, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSizeOfTable=moduleSizeOfTable, moduleInformation=moduleInformation, notebookLineNumber=notebookLineNumber, module=module, controlAlarmOnDelay=controlAlarmOnDelay, controlTempDeadBand=controlTempDeadBand, productKeyEntry=productKeyEntry, moduleSlotNo=moduleSlotNo, elementAltitude=elementAltitude, moduleSWUpdateEntry=moduleSWUpdateEntry, statusRestartCounter=statusRestartCounter, elementInformation=elementInformation, productKeyValue=productKeyValue, moduleRepairLogTable=moduleRepairLogTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleStatus=moduleStatus, elementStructure=elementStructure, elementLatitude=elementLatitude, statusTemperature=statusTemperature, sizeOfRepairlog=sizeOfRepairlog)
