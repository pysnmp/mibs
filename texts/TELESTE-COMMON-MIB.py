...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Gauge32, IpAddress, Counter32, Counter64, Unsigned32, TimeTicks, NotificationType, MibIdentifier, Bits, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Gauge32", "IpAddress", "Counter32", "Counter64", "Unsigned32", "TimeTicks", "NotificationType", "MibIdentifier", "Bits", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusHardware=statusHardware, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusLidStatus=statusLidStatus, productKeyFeatureEntry=productKeyFeatureEntry, notebookLineNumber=notebookLineNumber, moduleRepairLogTable=moduleRepairLogTable, receiverEntryId=receiverEntryId, elementName=elementName, controlTempLimitHiHi=controlTempLimitHiHi, moduleHwVersion=moduleHwVersion, notebookLineText=notebookLineText, statusBusMaster=statusBusMaster, module=module, element=element, moduleNotebookTable=moduleNotebookTable, moduleSWUpdateTable=moduleSWUpdateTable, sWUpdateStatus=sWUpdateStatus, repairDate=repairDate, statusTemperature=statusTemperature, moduleRegistryEntry=moduleRegistryEntry, moduleBiosVersion=moduleBiosVersion, moduleEntry=moduleEntry, elementConfigChangeCode=elementConfigChangeCode, moduleId=moduleId, productKeyIndex=productKeyIndex, moduleName=moduleName, controlResetElement=controlResetElement, moduleRegistry=moduleRegistry, swUpdateURL=swUpdateURL, moduleInformation=moduleInformation, moduleHwSerialNumber=moduleHwSerialNumber, controlTempLimitLoLo=controlTempLimitLoLo, productKeyEntry=productKeyEntry, productKeyStatus=productKeyStatus, controlMarkState=controlMarkState, moduleRegistryTable=moduleRegistryTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlBusMasterAdminState=controlBusMasterAdminState, receiverCommunity=receiverCommunity, productKeyFeatureIndex=productKeyFeatureIndex, repairReasonCode=repairReasonCode, moduleControlEntry=moduleControlEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBusAddress=moduleBusAddress, statusFan=statusFan, elementStructure=elementStructure, statusInternalTemperature=statusInternalTemperature, controlTempDeadBand=controlTempDeadBand, elementStatus=elementStatus, controlLocalAccess=controlLocalAccess, moduleHwType=moduleHwType, statusLid=statusLid, productKeyCipher=productKeyCipher, elementInformation=elementInformation, controlAlarmDetection=controlAlarmDetection, elementProductKey=elementProductKey, repairComment=repairComment, moduleRepairLogEntry=moduleRepairLogEntry, sWUpdateFileName=sWUpdateFileName, controlReset=controlReset, receiverPort=receiverPort, moduleStatusTable=moduleStatusTable, sWUpdateControl=sWUpdateControl, regName=regName, statusRunningSwImage=statusRunningSwImage, productKeyValue=productKeyValue, moduleStatusEntry=moduleStatusEntry, regValue=regValue, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureName=productKeyFeatureName, moduleSizeOfEntry=moduleSizeOfEntry, elementLatitude=elementLatitude, elementResetCount=elementResetCount, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapSending=controlTrapSending, receiverAddress=receiverAddress, repairIndex=repairIndex, controlAlarmOnDelay=controlAlarmOnDelay, elementControl=elementControl, moduleMacAddress=moduleMacAddress, moduleSlotNo=moduleSlotNo, sizeOfNotebook=sizeOfNotebook, controlAlarmOffDelay=controlAlarmOffDelay, statusResetCause=statusResetCause, controlLedUsage=controlLedUsage, moduleSizeOfTable=moduleSizeOfTable, moduleStatus=moduleStatus, controlTrapInterval=controlTrapInterval, moduleNotebookEntry=moduleNotebookEntry, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapDelay=controlTrapDelay, moduleControlTable=moduleControlTable, moduleAppVersion=moduleAppVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyMask=productKeyMask, controlTempLimitLo=controlTempLimitLo, moduleTable=moduleTable, moduleAppDate=moduleAppDate, controlInternalAppAccess=controlInternalAppAccess, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEnable=productKeyFeatureEnable, statusSoftware=statusSoftware, moduleBiosDate=moduleBiosDate, statusSettings=statusSettings, controlTempLimitHi=controlTempLimitHi, moduleControl=moduleControl, sizeOfRegistry=sizeOfRegistry, moduleDetailEntry=moduleDetailEntry, moduleRackNo=moduleRackNo, productKeyFeatureTable=productKeyFeatureTable, elementAltitude=elementAltitude, statusGeneral=statusGeneral, elementTotalUpTime=elementTotalUpTime, regIndex=regIndex, productKeyTable=productKeyTable, repairNameCode=repairNameCode, statusRestartCounter=statusRestartCounter, statusLmt=statusLmt, elementLongitude=elementLongitude, moduleDetailTable=moduleDetailTable)
