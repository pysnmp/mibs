...
Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Counter32, Gauge32, iso, Unsigned32, ObjectIdentity, ModuleIdentity, MibIdentifier, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Counter32", "Gauge32", "iso", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleStatusTable=moduleStatusTable, moduleName=moduleName, moduleSWUpdateTable=moduleSWUpdateTable, elementResetCount=elementResetCount, statusSoftware=statusSoftware, controlTrapSending=controlTrapSending, moduleAppVersion=moduleAppVersion, element=element, statusHardware=statusHardware, productKeyIndex=productKeyIndex, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapDelay=controlTrapDelay, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyCipher=productKeyCipher, moduleBiosVersion=moduleBiosVersion, statusInternalTemperature=statusInternalTemperature, moduleSizeOfTable=moduleSizeOfTable, regIndex=regIndex, controlInternalAppAccess=controlInternalAppAccess, moduleRepairLogEntry=moduleRepairLogEntry, notebookLineText=notebookLineText, controlAlarmDetection=controlAlarmDetection, moduleControl=moduleControl, statusLidStatus=statusLidStatus, receiverCommunity=receiverCommunity, receiverAddress=receiverAddress, regValue=regValue, statusLmt=statusLmt, moduleEntry=moduleEntry, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureTable=productKeyFeatureTable, statusRestartCounter=statusRestartCounter, controlMarkState=controlMarkState, moduleRegistryEntry=moduleRegistryEntry, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureName=productKeyFeatureName, elementStructure=elementStructure, moduleStatusEntry=moduleStatusEntry, elementControl=elementControl, moduleAppDate=moduleAppDate, notebookLineNumber=notebookLineNumber, controlTrapLifeTime=controlTrapLifeTime, moduleHwVersion=moduleHwVersion, moduleRepairLogTable=moduleRepairLogTable, controlResetElement=controlResetElement, controlTempLimitHi=controlTempLimitHi, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitHiHi=controlTempLimitHiHi, sizeOfRepairlog=sizeOfRepairlog, productKeyStatus=productKeyStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSizeOfEntry=moduleSizeOfEntry, controlReset=controlReset, elementLatitude=elementLatitude, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapReceiverTable=controlTrapReceiverTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRegistry=moduleRegistry, moduleNotebookEntry=moduleNotebookEntry, productKeyEntry=productKeyEntry, moduleStatus=moduleStatus, moduleHwType=moduleHwType, productKeyMask=productKeyMask, moduleBusAddress=moduleBusAddress, sizeOfNotebook=sizeOfNotebook, statusGeneral=statusGeneral, controlLocalAccess=controlLocalAccess, statusRunningSwImage=statusRunningSwImage, statusSettings=statusSettings, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistryTable=moduleRegistryTable, controlTrapReceiverEntry=controlTrapReceiverEntry, elementLongitude=elementLongitude, repairComment=repairComment, controlAlarmOffDelay=controlAlarmOffDelay, repairIndex=repairIndex, controlTrapInterval=controlTrapInterval, controlLedUsage=controlLedUsage, swUpdateURL=swUpdateURL, module=module, moduleControlEntry=moduleControlEntry, moduleNotebookTable=moduleNotebookTable, sizeOfRegistry=sizeOfRegistry, controlTempDeadBand=controlTempDeadBand, sWUpdateFileName=sWUpdateFileName, receiverPort=receiverPort, productKeyTable=productKeyTable, sWUpdateStatus=sWUpdateStatus, repairDate=repairDate, controlTempLimitLo=controlTempLimitLo, regName=regName, elementName=elementName, moduleRackNo=moduleRackNo, elementStatus=elementStatus, elementProductKey=elementProductKey, moduleMacAddress=moduleMacAddress, repairNameCode=repairNameCode, moduleInformation=moduleInformation, elementInformation=elementInformation, moduleTable=moduleTable, statusLid=statusLid, productKeyValue=productKeyValue, moduleId=moduleId, moduleDetailTable=moduleDetailTable, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleDetailEntry=moduleDetailEntry, repairReasonCode=repairReasonCode, statusResetCause=statusResetCause, moduleControlTable=moduleControlTable, receiverEntryId=receiverEntryId, sWUpdateControl=sWUpdateControl, moduleBiosDate=moduleBiosDate, elementAltitude=elementAltitude, statusFan=statusFan, moduleHwSerialNumber=moduleHwSerialNumber, statusBusMaster=statusBusMaster, statusTemperature=statusTemperature, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementTotalUpTime=elementTotalUpTime)
