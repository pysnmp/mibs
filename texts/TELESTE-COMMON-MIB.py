...
Counter32, Integer32, ModuleIdentity, MibIdentifier, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter64, Gauge32, iso, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "MibIdentifier", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter64", "Gauge32", "iso", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOnDelay=controlAlarmOnDelay, moduleAppVersion=moduleAppVersion, moduleStatusEntry=moduleStatusEntry, statusSoftware=statusSoftware, moduleName=moduleName, moduleAppDate=moduleAppDate, productKeyFeatureName=productKeyFeatureName, statusResetCause=statusResetCause, controlAlarmOffDelay=controlAlarmOffDelay, controlInternalAppAccess=controlInternalAppAccess, receiverEntryId=receiverEntryId, elementTotalUpTime=elementTotalUpTime, moduleStatus=moduleStatus, controlMarkState=controlMarkState, elementStructure=elementStructure, moduleBiosVersion=moduleBiosVersion, moduleSWUpdateTable=moduleSWUpdateTable, moduleDetailEntry=moduleDetailEntry, sWUpdateFileName=sWUpdateFileName, moduleId=moduleId, elementInformation=elementInformation, statusHardware=statusHardware, controlAlarmDetection=controlAlarmDetection, controlResetElement=controlResetElement, element=element, receiverPort=receiverPort, moduleControlEntry=moduleControlEntry, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapReceiverTable=controlTrapReceiverTable, elementStatus=elementStatus, moduleSWUpdateEntry=moduleSWUpdateEntry, repairDate=repairDate, moduleStatusTable=moduleStatusTable, statusFan=statusFan, statusTemperature=statusTemperature, moduleHwSerialNumber=moduleHwSerialNumber, statusRunningSwImage=statusRunningSwImage, moduleRackNo=moduleRackNo, elementName=elementName, moduleInformation=moduleInformation, sizeOfRepairlog=sizeOfRepairlog, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureEnable=productKeyFeatureEnable, sWUpdateControl=sWUpdateControl, elementConfigChangeCode=elementConfigChangeCode, controlReset=controlReset, productKeyValue=productKeyValue, moduleRepairLogEntry=moduleRepairLogEntry, controlLocalAccess=controlLocalAccess, statusInternalTemperature=statusInternalTemperature, productKeyFeatureIndex=productKeyFeatureIndex, moduleControl=moduleControl, repairIndex=repairIndex, controlTempLimitLoLo=controlTempLimitLoLo, moduleMacAddress=moduleMacAddress, receiverAddress=receiverAddress, moduleNotebookTable=moduleNotebookTable, statusLidStatus=statusLidStatus, receiverCommunity=receiverCommunity, controlTempDeadBand=controlTempDeadBand, notebookLineNumber=notebookLineNumber, controlLedUsage=controlLedUsage, productKeyTable=productKeyTable, moduleTable=moduleTable, regValue=regValue, statusBusMaster=statusBusMaster, productKeyMask=productKeyMask, controlTrapInterval=controlTrapInterval, module=module, statusSettings=statusSettings, moduleSizeOfTable=moduleSizeOfTable, repairNameCode=repairNameCode, moduleSlotNo=moduleSlotNo, statusLid=statusLid, moduleBiosDate=moduleBiosDate, statusGeneral=statusGeneral, moduleEntry=moduleEntry, controlTrapSending=controlTrapSending, productKeyCipher=productKeyCipher, notebookLineText=notebookLineText, moduleRegistry=moduleRegistry, moduleNotebookEntry=moduleNotebookEntry, regName=regName, productKeyNumberOfKeys=productKeyNumberOfKeys, statusRestartCounter=statusRestartCounter, repairComment=repairComment, sWUpdateStatus=sWUpdateStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyIndex=productKeyIndex, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureEntry=productKeyFeatureEntry, moduleBusAddress=moduleBusAddress, moduleHwVersion=moduleHwVersion, regIndex=regIndex, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSizeOfEntry=moduleSizeOfEntry, moduleRepairLogTable=moduleRepairLogTable, moduleRegistryTable=moduleRegistryTable, controlTempLimitHiHi=controlTempLimitHiHi, elementControl=elementControl, elementResetCount=elementResetCount, statusLmt=statusLmt, controlTempLimitLo=controlTempLimitLo, sizeOfRegistry=sizeOfRegistry, elementLatitude=elementLatitude, swUpdateURL=swUpdateURL, elementLongitude=elementLongitude, productKeyFeatureTable=productKeyFeatureTable, productKeyEntry=productKeyEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, elementAltitude=elementAltitude, sizeOfNotebook=sizeOfNotebook, controlTempLimitHi=controlTempLimitHi, elementProductKey=elementProductKey, moduleControlTable=moduleControlTable, repairReasonCode=repairReasonCode, moduleDetailTable=moduleDetailTable, moduleHwType=moduleHwType, productKeyStatus=productKeyStatus, controlTrapDelay=controlTrapDelay)
