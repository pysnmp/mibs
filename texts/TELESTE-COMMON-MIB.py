...
ModuleIdentity, TimeTicks, NotificationType, ObjectIdentity, IpAddress, Bits, Counter32, MibIdentifier, Integer32, Gauge32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "Counter32", "MibIdentifier", "Integer32", "Gauge32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleNotebookEntry=moduleNotebookEntry, productKeyValue=productKeyValue, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleEntry=moduleEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, elementAltitude=elementAltitude, productKeyFeatureEntry=productKeyFeatureEntry, productKeyStatus=productKeyStatus, controlAlarmOffDelay=controlAlarmOffDelay, moduleStatus=moduleStatus, controlTempDeadBand=controlTempDeadBand, repairNameCode=repairNameCode, moduleSlotNo=moduleSlotNo, productKeyFeatureName=productKeyFeatureName, moduleBusAddress=moduleBusAddress, elementName=elementName, moduleBiosDate=moduleBiosDate, controlLocalAccess=controlLocalAccess, moduleInformation=moduleInformation, repairReasonCode=repairReasonCode, controlMarkState=controlMarkState, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusLid=statusLid, productKeyFeatureEnable=productKeyFeatureEnable, statusInternalTemperature=statusInternalTemperature, controlTempLimitHi=controlTempLimitHi, controlTempLimitLoLo=controlTempLimitLoLo, elementStatus=elementStatus, elementConfigChangeCode=elementConfigChangeCode, regValue=regValue, repairComment=repairComment, controlTrapReceiverTable=controlTrapReceiverTable, sizeOfNotebook=sizeOfNotebook, regIndex=regIndex, controlAlarmDetection=controlAlarmDetection, elementProductKey=elementProductKey, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleName=moduleName, sizeOfRepairlog=sizeOfRepairlog, elementLatitude=elementLatitude, productKeyIndex=productKeyIndex, moduleBiosVersion=moduleBiosVersion, moduleHwSerialNumber=moduleHwSerialNumber, regName=regName, statusLidStatus=statusLidStatus, receiverCommunity=receiverCommunity, module=module, productKeyFeatureTable=productKeyFeatureTable, moduleHwVersion=moduleHwVersion, receiverPort=receiverPort, statusSoftware=statusSoftware, statusBusMaster=statusBusMaster, notebookLineText=notebookLineText, controlReset=controlReset, productKeyMask=productKeyMask, moduleNotebookTable=moduleNotebookTable, receiverEntryId=receiverEntryId, sWUpdateControl=sWUpdateControl, moduleHwType=moduleHwType, moduleId=moduleId, elementStructure=elementStructure, element=element, repairIndex=repairIndex, moduleMacAddress=moduleMacAddress, sWUpdateStatus=sWUpdateStatus, moduleAppDate=moduleAppDate, statusTemperature=statusTemperature, controlTrapInterval=controlTrapInterval, moduleAppVersion=moduleAppVersion, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapDelay=controlTrapDelay, moduleStatusEntry=moduleStatusEntry, repairDate=repairDate, statusLmt=statusLmt, moduleRepairLogEntry=moduleRepairLogEntry, moduleSizeOfEntry=moduleSizeOfEntry, statusResetCause=statusResetCause, moduleControlEntry=moduleControlEntry, controlInternalAppAccess=controlInternalAppAccess, controlTrapSending=controlTrapSending, productKeyEntry=productKeyEntry, elementControl=elementControl, productKeyCipher=productKeyCipher, elementResetCount=elementResetCount, statusHardware=statusHardware, controlResetElement=controlResetElement, moduleControl=moduleControl, productKeyTable=productKeyTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusSettings=statusSettings, controlTempLimitLo=controlTempLimitLo, statusFan=statusFan, moduleRepairLogTable=moduleRepairLogTable, elementInformation=elementInformation, receiverAddress=receiverAddress, statusRestartCounter=statusRestartCounter, statusRunningSwImage=statusRunningSwImage, controlTrapLifeTime=controlTrapLifeTime, moduleRegistryEntry=moduleRegistryEntry, sizeOfRegistry=sizeOfRegistry, controlLedUsage=controlLedUsage, moduleSizeOfTable=moduleSizeOfTable, moduleControlTable=moduleControlTable, statusGeneral=statusGeneral, moduleDetailTable=moduleDetailTable, notebookLineNumber=notebookLineNumber, sWUpdateFileName=sWUpdateFileName, moduleRegistry=moduleRegistry, moduleSWUpdateTable=moduleSWUpdateTable, swUpdateURL=swUpdateURL, moduleDetailEntry=moduleDetailEntry, moduleRegistryTable=moduleRegistryTable, moduleStatusTable=moduleStatusTable, controlTempLimitHiHi=controlTempLimitHiHi, elementLongitude=elementLongitude, productKeyFeatureIndex=productKeyFeatureIndex, elementTotalUpTime=elementTotalUpTime, moduleRackNo=moduleRackNo, controlBusMasterAdminState=controlBusMasterAdminState, moduleTable=moduleTable)
