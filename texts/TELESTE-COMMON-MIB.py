...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Unsigned32, MibIdentifier, ModuleIdentity, IpAddress, Integer32, Counter64, NotificationType, Gauge32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Unsigned32", "MibIdentifier", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "NotificationType", "Gauge32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", regName=regName, controlResetElement=controlResetElement, moduleBiosDate=moduleBiosDate, controlAlarmOffDelay=controlAlarmOffDelay, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementLatitude=elementLatitude, productKeyFeatureIndex=productKeyFeatureIndex, moduleSWUpdateTable=moduleSWUpdateTable, elementControl=elementControl, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapLifeTime=controlTrapLifeTime, elementInformation=elementInformation, statusRestartCounter=statusRestartCounter, moduleAppVersion=moduleAppVersion, controlTempLimitLoLo=controlTempLimitLoLo, moduleRepairLogTable=moduleRepairLogTable, sWUpdateFileName=sWUpdateFileName, controlMarkState=controlMarkState, controlLocalAccess=controlLocalAccess, moduleNotebookEntry=moduleNotebookEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, controlAlarmDetection=controlAlarmDetection, sizeOfRepairlog=sizeOfRepairlog, controlTrapSending=controlTrapSending, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleControlEntry=moduleControlEntry, controlBusMasterAdminState=controlBusMasterAdminState, module=module, receiverPort=receiverPort, sizeOfRegistry=sizeOfRegistry, elementTotalUpTime=elementTotalUpTime, regIndex=regIndex, moduleSWUpdateEntry=moduleSWUpdateEntry, statusResetCause=statusResetCause, elementLongitude=elementLongitude, moduleAppDate=moduleAppDate, statusRunningSwImage=statusRunningSwImage, elementStructure=elementStructure, moduleRepairLogEntry=moduleRepairLogEntry, receiverAddress=receiverAddress, controlInternalAppAccess=controlInternalAppAccess, moduleInformation=moduleInformation, repairNameCode=repairNameCode, statusBusMaster=statusBusMaster, statusLmt=statusLmt, controlTrapInterval=controlTrapInterval, moduleHwType=moduleHwType, moduleControl=moduleControl, controlTempDeadBand=controlTempDeadBand, productKeyFeatureEnable=productKeyFeatureEnable, receiverCommunity=receiverCommunity, element=element, moduleRegistryTable=moduleRegistryTable, statusLidStatus=statusLidStatus, repairIndex=repairIndex, moduleRegistry=moduleRegistry, repairDate=repairDate, productKeyMask=productKeyMask, productKeyFeatureName=productKeyFeatureName, controlTrapDelay=controlTrapDelay, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyIndex=productKeyIndex, statusSoftware=statusSoftware, moduleMacAddress=moduleMacAddress, statusFan=statusFan, notebookLineText=notebookLineText, statusSettings=statusSettings, statusHardware=statusHardware, moduleStatus=moduleStatus, controlLedUsage=controlLedUsage, productKeyFeatureEntry=productKeyFeatureEntry, statusGeneral=statusGeneral, controlTempLimitHiHi=controlTempLimitHiHi, moduleNotebookTable=moduleNotebookTable, moduleRackNo=moduleRackNo, moduleEntry=moduleEntry, moduleTable=moduleTable, statusTemperature=statusTemperature, elementResetCount=elementResetCount, productKeyTable=productKeyTable, moduleHwSerialNumber=moduleHwSerialNumber, moduleName=moduleName, moduleControlTable=moduleControlTable, swUpdateURL=swUpdateURL, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitHi=controlTempLimitHi, moduleRegistryEntry=moduleRegistryEntry, elementProductKey=elementProductKey, elementAltitude=elementAltitude, moduleDetailTable=moduleDetailTable, controlTrapReceiverTable=controlTrapReceiverTable, productKeyCipher=productKeyCipher, moduleDetailEntry=moduleDetailEntry, sizeOfNotebook=sizeOfNotebook, sWUpdateStatus=sWUpdateStatus, productKeyValue=productKeyValue, moduleId=moduleId, moduleHwVersion=moduleHwVersion, controlTempLimitLo=controlTempLimitLo, statusInternalTemperature=statusInternalTemperature, statusLid=statusLid, moduleStatusEntry=moduleStatusEntry, sWUpdateControl=sWUpdateControl, moduleBiosVersion=moduleBiosVersion, elementConfigChangeCode=elementConfigChangeCode, elementStatus=elementStatus, moduleBusAddress=moduleBusAddress, controlReset=controlReset, notebookLineNumber=notebookLineNumber, repairComment=repairComment, productKeyEntry=productKeyEntry, productKeyStatus=productKeyStatus, moduleSlotNo=moduleSlotNo, moduleSizeOfTable=moduleSizeOfTable, productKeyFeatureTable=productKeyFeatureTable, moduleStatusTable=moduleStatusTable, elementName=elementName, regValue=regValue, repairReasonCode=repairReasonCode, receiverEntryId=receiverEntryId)
