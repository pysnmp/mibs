...
iso, ModuleIdentity, MibIdentifier, Integer32, Counter32, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, IpAddress, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "IpAddress", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleInformation=moduleInformation, moduleControlTable=moduleControlTable, statusBusMaster=statusBusMaster, productKeyMask=productKeyMask, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatusTable=moduleStatusTable, swUpdateURL=swUpdateURL, repairDate=repairDate, elementTotalUpTime=elementTotalUpTime, statusRestartCounter=statusRestartCounter, moduleRegistry=moduleRegistry, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogEntry=moduleRepairLogEntry, statusSettings=statusSettings, moduleNotebookTable=moduleNotebookTable, statusLid=statusLid, controlTrapReceiverEntry=controlTrapReceiverEntry, element=element, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapSending=controlTrapSending, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatusEntry=moduleStatusEntry, controlTrapLifeTime=controlTrapLifeTime, controlAlarmDetection=controlAlarmDetection, moduleNotebookEntry=moduleNotebookEntry, elementControl=elementControl, controlAlarmOffDelay=controlAlarmOffDelay, receiverEntryId=receiverEntryId, productKeyCipher=productKeyCipher, notebookLineText=notebookLineText, receiverAddress=receiverAddress, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureName=productKeyFeatureName, moduleControl=moduleControl, moduleHwSerialNumber=moduleHwSerialNumber, moduleEntry=moduleEntry, regIndex=regIndex, elementName=elementName, statusSoftware=statusSoftware, elementStatus=elementStatus, controlTempLimitHiHi=controlTempLimitHiHi, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverPort=receiverPort, moduleBiosDate=moduleBiosDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleAppDate=moduleAppDate, notebookLineNumber=notebookLineNumber, moduleAppVersion=moduleAppVersion, controlAlarmOnDelay=controlAlarmOnDelay, sizeOfNotebook=sizeOfNotebook, statusFan=statusFan, controlReset=controlReset, elementConfigChangeCode=elementConfigChangeCode, sizeOfRepairlog=sizeOfRepairlog, regName=regName, controlTrapInterval=controlTrapInterval, controlTempLimitHi=controlTempLimitHi, moduleHwVersion=moduleHwVersion, repairReasonCode=repairReasonCode, controlMarkState=controlMarkState, elementLongitude=elementLongitude, statusLidStatus=statusLidStatus, productKeyFeatureIndex=productKeyFeatureIndex, elementProductKey=elementProductKey, controlTempLimitLoLo=controlTempLimitLoLo, moduleTable=moduleTable, sWUpdateFileName=sWUpdateFileName, receiverCommunity=receiverCommunity, controlInternalAppAccess=controlInternalAppAccess, controlTempDeadBand=controlTempDeadBand, moduleId=moduleId, sWUpdateStatus=sWUpdateStatus, elementResetCount=elementResetCount, statusLmt=statusLmt, statusInternalTemperature=statusInternalTemperature, repairComment=repairComment, elementInformation=elementInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlLocalAccess=controlLocalAccess, productKeyTable=productKeyTable, repairIndex=repairIndex, moduleName=moduleName, moduleHwType=moduleHwType, statusTemperature=statusTemperature, controlResetElement=controlResetElement, module=module, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleRackNo=moduleRackNo, repairNameCode=repairNameCode, statusGeneral=statusGeneral, moduleDetailEntry=moduleDetailEntry, moduleSlotNo=moduleSlotNo, moduleBusAddress=moduleBusAddress, moduleMacAddress=moduleMacAddress, controlTempLimitLo=controlTempLimitLo, moduleRegistryEntry=moduleRegistryEntry, statusResetCause=statusResetCause, moduleControlEntry=moduleControlEntry, productKeyEntry=productKeyEntry, moduleBiosVersion=moduleBiosVersion, controlTrapDelay=controlTrapDelay, sWUpdateControl=sWUpdateControl, elementAltitude=elementAltitude, elementStructure=elementStructure, moduleDetailTable=moduleDetailTable, statusHardware=statusHardware, elementLatitude=elementLatitude, statusRunningSwImage=statusRunningSwImage, moduleRepairLogTable=moduleRepairLogTable, controlLedUsage=controlLedUsage, moduleSizeOfTable=moduleSizeOfTable, productKeyNumberOfKeys=productKeyNumberOfKeys, regValue=regValue, productKeyIndex=productKeyIndex, moduleStatus=moduleStatus, moduleRegistryTable=moduleRegistryTable, productKeyStatus=productKeyStatus, productKeyValue=productKeyValue, sizeOfRegistry=sizeOfRegistry)
