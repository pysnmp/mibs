...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ObjectIdentity, Unsigned32, Integer32, TimeTicks, Bits, ModuleIdentity, IpAddress, MibIdentifier, NotificationType, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ObjectIdentity", "Unsigned32", "Integer32", "TimeTicks", "Bits", "ModuleIdentity", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", swUpdateURL=swUpdateURL, controlTempDeadBand=controlTempDeadBand, regName=regName, moduleControlEntry=moduleControlEntry, element=element, moduleHwType=moduleHwType, moduleNotebookTable=moduleNotebookTable, controlBusMasterAdminState=controlBusMasterAdminState, controlTempLimitLo=controlTempLimitLo, repairIndex=repairIndex, statusRunningSwImage=statusRunningSwImage, statusGeneral=statusGeneral, moduleDetailEntry=moduleDetailEntry, module=module, moduleHwSerialNumber=moduleHwSerialNumber, controlAlarmDetection=controlAlarmDetection, controlResetElement=controlResetElement, statusLid=statusLid, controlLedUsage=controlLedUsage, controlLocalAccess=controlLocalAccess, moduleRackNo=moduleRackNo, moduleMacAddress=moduleMacAddress, receiverAddress=receiverAddress, elementProductKey=elementProductKey, moduleAppVersion=moduleAppVersion, productKeyFeatureName=productKeyFeatureName, moduleHwVersion=moduleHwVersion, sizeOfNotebook=sizeOfNotebook, moduleStatus=moduleStatus, elementControl=elementControl, controlAlarmOffDelay=controlAlarmOffDelay, moduleRepairLogTable=moduleRepairLogTable, moduleRegistry=moduleRegistry, moduleStatusTable=moduleStatusTable, elementInformation=elementInformation, moduleSlotNo=moduleSlotNo, controlTempLimitHiHi=controlTempLimitHiHi, controlTempLimitHi=controlTempLimitHi, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRegistryTable=moduleRegistryTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleTable=moduleTable, productKeyFeatureTable=productKeyFeatureTable, sWUpdateStatus=sWUpdateStatus, repairComment=repairComment, moduleStatusEntry=moduleStatusEntry, productKeyEntry=productKeyEntry, regIndex=regIndex, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapDelay=controlTrapDelay, moduleControl=moduleControl, statusInternalTemperature=statusInternalTemperature, controlMarkState=controlMarkState, moduleSizeOfEntry=moduleSizeOfEntry, elementAltitude=elementAltitude, elementResetCount=elementResetCount, repairReasonCode=repairReasonCode, notebookLineText=notebookLineText, elementLongitude=elementLongitude, elementLatitude=elementLatitude, moduleName=moduleName, controlTrapLifeTime=controlTrapLifeTime, moduleNotebookEntry=moduleNotebookEntry, statusSoftware=statusSoftware, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusResetCause=statusResetCause, statusRestartCounter=statusRestartCounter, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sWUpdateControl=sWUpdateControl, moduleBiosDate=moduleBiosDate, controlInternalAppAccess=controlInternalAppAccess, moduleControlTable=moduleControlTable, moduleSizeOfTable=moduleSizeOfTable, receiverPort=receiverPort, productKeyFeatureIndex=productKeyFeatureIndex, regValue=regValue, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusFan=statusFan, elementStructure=elementStructure, sizeOfRepairlog=sizeOfRepairlog, moduleRepairLogEntry=moduleRepairLogEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, receiverEntryId=receiverEntryId, controlTempLimitLoLo=controlTempLimitLoLo, moduleEntry=moduleEntry, statusTemperature=statusTemperature, elementTotalUpTime=elementTotalUpTime, controlTrapInterval=controlTrapInterval, productKeyCipher=productKeyCipher, elementStatus=elementStatus, controlTrapSending=controlTrapSending, moduleDetailTable=moduleDetailTable, statusBusMaster=statusBusMaster, repairNameCode=repairNameCode, sWUpdateFileName=sWUpdateFileName, productKeyIndex=productKeyIndex, elementName=elementName, moduleId=moduleId, moduleRegistryEntry=moduleRegistryEntry, sizeOfRegistry=sizeOfRegistry, moduleBiosVersion=moduleBiosVersion, elementConfigChangeCode=elementConfigChangeCode, productKeyStatus=productKeyStatus, productKeyFeatureEntry=productKeyFeatureEntry, productKeyTable=productKeyTable, repairDate=repairDate, notebookLineNumber=notebookLineNumber, moduleInformation=moduleInformation, productKeyFeatureEnable=productKeyFeatureEnable, moduleBusAddress=moduleBusAddress, receiverCommunity=receiverCommunity, statusLidStatus=statusLidStatus, statusSettings=statusSettings, productKeyValue=productKeyValue, controlTrapReceiverTable=controlTrapReceiverTable, productKeyMask=productKeyMask, statusHardware=statusHardware, controlAlarmOnDelay=controlAlarmOnDelay, statusLmt=statusLmt, moduleAppDate=moduleAppDate, controlReset=controlReset)
