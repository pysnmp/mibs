...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTempDeadBand=controlTempDeadBand, statusHardware=statusHardware, productKeyFeatureIndex=productKeyFeatureIndex, moduleId=moduleId, sizeOfRepairlog=sizeOfRepairlog, receiverEntryId=receiverEntryId, moduleAppVersion=moduleAppVersion, swUpdateURL=swUpdateURL, productKeyEntry=productKeyEntry, repairIndex=repairIndex, controlTrapReceiverTable=controlTrapReceiverTable, statusSettings=statusSettings, elementName=elementName, elementStructure=elementStructure, productKeyIndex=productKeyIndex, repairReasonCode=repairReasonCode, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleSlotNo=moduleSlotNo, sWUpdateStatus=sWUpdateStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleEntry=moduleEntry, notebookLineNumber=notebookLineNumber, productKeyFeatureTable=productKeyFeatureTable, elementConfigChangeCode=elementConfigChangeCode, receiverAddress=receiverAddress, moduleSWUpdateTable=moduleSWUpdateTable, moduleRepairLogTable=moduleRepairLogTable, productKeyStatus=productKeyStatus, regValue=regValue, moduleHwType=moduleHwType, controlInternalAppAccess=controlInternalAppAccess, productKeyMask=productKeyMask, statusGeneral=statusGeneral, moduleAppDate=moduleAppDate, statusRestartCounter=statusRestartCounter, statusSoftware=statusSoftware, moduleRackNo=moduleRackNo, controlTrapSending=controlTrapSending, elementLongitude=elementLongitude, moduleControlEntry=moduleControlEntry, elementTotalUpTime=elementTotalUpTime, moduleStatusEntry=moduleStatusEntry, element=element, moduleHwVersion=moduleHwVersion, productKeyFeatureEntry=productKeyFeatureEntry, sWUpdateFileName=sWUpdateFileName, productKeyCipher=productKeyCipher, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSizeOfEntry=moduleSizeOfEntry, moduleBusAddress=moduleBusAddress, controlTempLimitHiHi=controlTempLimitHiHi, controlTempLimitHi=controlTempLimitHi, statusRunningSwImage=statusRunningSwImage, moduleDetailEntry=moduleDetailEntry, controlBusMasterAdminState=controlBusMasterAdminState, controlAlarmOnDelay=controlAlarmOnDelay, moduleControlTable=moduleControlTable, controlTempLimitLoLo=controlTempLimitLoLo, productKeyTable=productKeyTable, moduleRegistryTable=moduleRegistryTable, moduleName=moduleName, statusResetCause=statusResetCause, controlReset=controlReset, moduleRegistryEntry=moduleRegistryEntry, statusFan=statusFan, moduleNotebookTable=moduleNotebookTable, statusInternalTemperature=statusInternalTemperature, controlAlarmDetection=controlAlarmDetection, controlLedUsage=controlLedUsage, elementLatitude=elementLatitude, elementControl=elementControl, elementResetCount=elementResetCount, statusLidStatus=statusLidStatus, elementProductKey=elementProductKey, moduleSizeOfTable=moduleSizeOfTable, moduleMacAddress=moduleMacAddress, moduleControl=moduleControl, controlMarkState=controlMarkState, moduleBiosVersion=moduleBiosVersion, statusTemperature=statusTemperature, repairDate=repairDate, statusLmt=statusLmt, elementInformation=elementInformation, moduleInformation=moduleInformation, statusBusMaster=statusBusMaster, controlTrapInterval=controlTrapInterval, module=module, moduleTable=moduleTable, productKeyNumberOfKeys=productKeyNumberOfKeys, controlLocalAccess=controlLocalAccess, productKeyFeatureEnable=productKeyFeatureEnable, receiverPort=receiverPort, controlTrapLifeTime=controlTrapLifeTime, moduleStatusTable=moduleStatusTable, regIndex=regIndex, moduleHwSerialNumber=moduleHwSerialNumber, productKeyFeatureName=productKeyFeatureName, moduleRegistry=moduleRegistry, moduleStatus=moduleStatus, sizeOfNotebook=sizeOfNotebook, elementAltitude=elementAltitude, controlResetElement=controlResetElement, controlTrapDelay=controlTrapDelay, regName=regName, repairNameCode=repairNameCode, repairComment=repairComment, moduleRepairLogEntry=moduleRepairLogEntry, notebookLineText=notebookLineText, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementStatus=elementStatus, receiverCommunity=receiverCommunity, productKeyValue=productKeyValue, sizeOfRegistry=sizeOfRegistry, moduleDetailTable=moduleDetailTable, moduleNotebookEntry=moduleNotebookEntry, moduleBiosDate=moduleBiosDate, controlTempLimitLo=controlTempLimitLo, controlAlarmOffDelay=controlAlarmOffDelay, statusLid=statusLid, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sWUpdateControl=sWUpdateControl)
