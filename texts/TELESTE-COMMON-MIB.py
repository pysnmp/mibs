...
Gauge32, Unsigned32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, NotificationType, TimeTicks, Integer32, Counter64, IpAddress, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "Counter64", "IpAddress", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlLedUsage=controlLedUsage, moduleAppVersion=moduleAppVersion, elementProductKey=elementProductKey, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateControl=sWUpdateControl, repairComment=repairComment, sWUpdateFileName=sWUpdateFileName, repairDate=repairDate, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapReceiverEntry=controlTrapReceiverEntry, sizeOfRepairlog=sizeOfRepairlog, moduleEntry=moduleEntry, statusLmt=statusLmt, statusHardware=statusHardware, regValue=regValue, controlTrapDelay=controlTrapDelay, controlAlarmDetection=controlAlarmDetection, moduleStatus=moduleStatus, moduleBusAddress=moduleBusAddress, sizeOfNotebook=sizeOfNotebook, elementName=elementName, moduleRepairLogEntry=moduleRepairLogEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlInternalAppAccess=controlInternalAppAccess, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitLo=controlTempLimitLo, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusRestartCounter=statusRestartCounter, moduleStatusTable=moduleStatusTable, productKeyStatus=productKeyStatus, controlTrapReceiverTable=controlTrapReceiverTable, productKeyIndex=productKeyIndex, moduleName=moduleName, receiverPort=receiverPort, productKeyCipher=productKeyCipher, productKeyMask=productKeyMask, statusSoftware=statusSoftware, statusLidStatus=statusLidStatus, moduleNotebookTable=moduleNotebookTable, controlAlarmOffDelay=controlAlarmOffDelay, swUpdateURL=swUpdateURL, moduleRepairLogTable=moduleRepairLogTable, statusGeneral=statusGeneral, elementResetCount=elementResetCount, notebookLineText=notebookLineText, moduleSizeOfTable=moduleSizeOfTable, statusResetCause=statusResetCause, productKeyFeatureEntry=productKeyFeatureEntry, notebookLineNumber=notebookLineNumber, controlBusMasterAdminState=controlBusMasterAdminState, regName=regName, controlTrapInterval=controlTrapInterval, receiverEntryId=receiverEntryId, sWUpdateStatus=sWUpdateStatus, productKeyValue=productKeyValue, elementAltitude=elementAltitude, statusSettings=statusSettings, moduleControlTable=moduleControlTable, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleInformation=moduleInformation, controlResetElement=controlResetElement, moduleBiosVersion=moduleBiosVersion, elementLongitude=elementLongitude, controlTempLimitHi=controlTempLimitHi, repairIndex=repairIndex, controlTempLimitHiHi=controlTempLimitHiHi, statusLid=statusLid, controlTrapLifeTime=controlTrapLifeTime, elementStructure=elementStructure, element=element, elementControl=elementControl, controlTempDeadBand=controlTempDeadBand, statusRunningSwImage=statusRunningSwImage, moduleRegistry=moduleRegistry, moduleSlotNo=moduleSlotNo, moduleHwSerialNumber=moduleHwSerialNumber, statusFan=statusFan, controlTrapSending=controlTrapSending, receiverCommunity=receiverCommunity, moduleMacAddress=moduleMacAddress, statusTemperature=statusTemperature, controlTempLimitLoLo=controlTempLimitLoLo, moduleSizeOfEntry=moduleSizeOfEntry, elementLatitude=elementLatitude, moduleDetailEntry=moduleDetailEntry, moduleTable=moduleTable, elementConfigChangeCode=elementConfigChangeCode, moduleHwVersion=moduleHwVersion, moduleControl=moduleControl, moduleBiosDate=moduleBiosDate, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureName=productKeyFeatureName, moduleRackNo=moduleRackNo, productKeyEntry=productKeyEntry, sizeOfRegistry=sizeOfRegistry, moduleControlEntry=moduleControlEntry, productKeyTable=productKeyTable, regIndex=regIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleHwType=moduleHwType, moduleAppDate=moduleAppDate, moduleRegistryTable=moduleRegistryTable, module=module, receiverAddress=receiverAddress, productKeyFeatureEnable=productKeyFeatureEnable, elementTotalUpTime=elementTotalUpTime, elementStatus=elementStatus, moduleRegistryEntry=moduleRegistryEntry, moduleDetailTable=moduleDetailTable, moduleStatusEntry=moduleStatusEntry, controlReset=controlReset, moduleId=moduleId, elementInformation=elementInformation, repairNameCode=repairNameCode, controlLocalAccess=controlLocalAccess, statusBusMaster=statusBusMaster, repairReasonCode=repairReasonCode, controlMarkState=controlMarkState, productKeyFeatureTable=productKeyFeatureTable, moduleNotebookEntry=moduleNotebookEntry)
