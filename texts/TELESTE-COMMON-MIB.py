...
Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, TimeTicks, IpAddress, Integer32, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "TimeTicks", "IpAddress", "Integer32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapSending=controlTrapSending, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineNumber=notebookLineNumber, receiverEntryId=receiverEntryId, statusResetCause=statusResetCause, controlReset=controlReset, controlLocalAccess=controlLocalAccess, moduleDetailEntry=moduleDetailEntry, elementControl=elementControl, regIndex=regIndex, moduleHwType=moduleHwType, controlTrapInterval=controlTrapInterval, statusGeneral=statusGeneral, controlTrapReceiverTable=controlTrapReceiverTable, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusLidStatus=statusLidStatus, controlTempLimitLoLo=controlTempLimitLoLo, controlTempLimitHi=controlTempLimitHi, moduleSWUpdateTable=moduleSWUpdateTable, elementAltitude=elementAltitude, module=module, moduleRepairLogEntry=moduleRepairLogEntry, controlAlarmOnDelay=controlAlarmOnDelay, productKeyMask=productKeyMask, elementStatus=elementStatus, controlTempLimitLo=controlTempLimitLo, productKeyFeatureIndex=productKeyFeatureIndex, receiverCommunity=receiverCommunity, productKeyFeatureEntry=productKeyFeatureEntry, moduleRegistryEntry=moduleRegistryEntry, moduleRackNo=moduleRackNo, moduleRepairLogTable=moduleRepairLogTable, moduleHwSerialNumber=moduleHwSerialNumber, repairReasonCode=repairReasonCode, moduleBiosDate=moduleBiosDate, productKeyTable=productKeyTable, moduleAppVersion=moduleAppVersion, statusBusMaster=statusBusMaster, statusSettings=statusSettings, moduleDetailTable=moduleDetailTable, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureName=productKeyFeatureName, moduleNotebookEntry=moduleNotebookEntry, elementResetCount=elementResetCount, repairComment=repairComment, repairNameCode=repairNameCode, elementInformation=elementInformation, statusLid=statusLid, moduleInformation=moduleInformation, moduleBiosVersion=moduleBiosVersion, sWUpdateControl=sWUpdateControl, productKeyIndex=productKeyIndex, receiverPort=receiverPort, regName=regName, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementProductKey=elementProductKey, elementLongitude=elementLongitude, statusRunningSwImage=statusRunningSwImage, productKeyCipher=productKeyCipher, sWUpdateFileName=sWUpdateFileName, moduleHwVersion=moduleHwVersion, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleControl=moduleControl, moduleAppDate=moduleAppDate, moduleRegistry=moduleRegistry, notebookLineText=notebookLineText, moduleNotebookTable=moduleNotebookTable, controlAlarmDetection=controlAlarmDetection, statusRestartCounter=statusRestartCounter, statusFan=statusFan, moduleRegistryTable=moduleRegistryTable, statusHardware=statusHardware, elementStructure=elementStructure, moduleSizeOfEntry=moduleSizeOfEntry, moduleId=moduleId, moduleSizeOfTable=moduleSizeOfTable, moduleMacAddress=moduleMacAddress, sWUpdateStatus=sWUpdateStatus, statusInternalTemperature=statusInternalTemperature, productKeyStatus=productKeyStatus, moduleEntry=moduleEntry, controlResetElement=controlResetElement, moduleSlotNo=moduleSlotNo, repairIndex=repairIndex, sizeOfRegistry=sizeOfRegistry, elementName=elementName, moduleStatusEntry=moduleStatusEntry, elementLatitude=elementLatitude, productKeyValue=productKeyValue, moduleName=moduleName, controlTempLimitHiHi=controlTempLimitHiHi, elementTotalUpTime=elementTotalUpTime, controlMarkState=controlMarkState, controlLedUsage=controlLedUsage, statusLmt=statusLmt, moduleBusAddress=moduleBusAddress, elementConfigChangeCode=elementConfigChangeCode, controlTrapDelay=controlTrapDelay, swUpdateURL=swUpdateURL, statusSoftware=statusSoftware, sizeOfRepairlog=sizeOfRepairlog, regValue=regValue, controlTempDeadBand=controlTempDeadBand, controlTrapLifeTime=controlTrapLifeTime, moduleStatusTable=moduleStatusTable, element=element, moduleControlEntry=moduleControlEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, statusTemperature=statusTemperature, moduleStatus=moduleStatus, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureEnable=productKeyFeatureEnable, moduleTable=moduleTable, sizeOfNotebook=sizeOfNotebook, productKeyEntry=productKeyEntry, receiverAddress=receiverAddress, repairDate=repairDate, moduleControlTable=moduleControlTable, productKeyNumberOfKeys=productKeyNumberOfKeys)
