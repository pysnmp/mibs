...
Unsigned32, Bits, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Integer32, IpAddress, Gauge32, iso, TimeTicks, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "Gauge32", "iso", "TimeTicks", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sizeOfRegistry=sizeOfRegistry, productKeyEntry=productKeyEntry, controlTempDeadBand=controlTempDeadBand, productKeyFeatureIndex=productKeyFeatureIndex, moduleName=moduleName, productKeyStatus=productKeyStatus, elementResetCount=elementResetCount, controlInternalAppAccess=controlInternalAppAccess, moduleNotebookEntry=moduleNotebookEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlLocalAccess=controlLocalAccess, moduleBiosVersion=moduleBiosVersion, productKeyTable=productKeyTable, controlTrapDelay=controlTrapDelay, moduleBiosDate=moduleBiosDate, controlResetElement=controlResetElement, statusLid=statusLid, moduleDetailTable=moduleDetailTable, elementConfigChangeCode=elementConfigChangeCode, regName=regName, swUpdateURL=swUpdateURL, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairComment=repairComment, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureEntry=productKeyFeatureEntry, moduleAppVersion=moduleAppVersion, repairReasonCode=repairReasonCode, receiverCommunity=receiverCommunity, receiverAddress=receiverAddress, moduleDetailEntry=moduleDetailEntry, elementInformation=elementInformation, controlTrapReceiverTable=controlTrapReceiverTable, moduleHwType=moduleHwType, controlBusMasterAdminState=controlBusMasterAdminState, statusBusMaster=statusBusMaster, regValue=regValue, moduleSWUpdateTable=moduleSWUpdateTable, statusSettings=statusSettings, elementName=elementName, element=element, repairDate=repairDate, statusFan=statusFan, moduleId=moduleId, controlAlarmOnDelay=controlAlarmOnDelay, statusLidStatus=statusLidStatus, moduleSizeOfEntry=moduleSizeOfEntry, controlAlarmDetection=controlAlarmDetection, productKeyFeatureTable=productKeyFeatureTable, productKeyValue=productKeyValue, productKeyFeatureName=productKeyFeatureName, elementStructure=elementStructure, elementLatitude=elementLatitude, statusRestartCounter=statusRestartCounter, moduleNotebookTable=moduleNotebookTable, statusRunningSwImage=statusRunningSwImage, statusHardware=statusHardware, moduleSlotNo=moduleSlotNo, productKeyCipher=productKeyCipher, repairNameCode=repairNameCode, regIndex=regIndex, productKeyFeatureEnable=productKeyFeatureEnable, statusTemperature=statusTemperature, controlTrapInterval=controlTrapInterval, module=module, controlTrapSending=controlTrapSending, moduleEntry=moduleEntry, elementStatus=elementStatus, moduleInformation=moduleInformation, sWUpdateControl=sWUpdateControl, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitHi=controlTempLimitHi, sizeOfNotebook=sizeOfNotebook, elementProductKey=elementProductKey, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sWUpdateFileName=sWUpdateFileName, moduleRegistryTable=moduleRegistryTable, sizeOfRepairlog=sizeOfRepairlog, elementControl=elementControl, statusGeneral=statusGeneral, moduleHwVersion=moduleHwVersion, moduleStatusTable=moduleStatusTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleControlEntry=moduleControlEntry, productKeyMask=productKeyMask, receiverEntryId=receiverEntryId, controlMarkState=controlMarkState, moduleHwSerialNumber=moduleHwSerialNumber, repairIndex=repairIndex, statusInternalTemperature=statusInternalTemperature, moduleAppDate=moduleAppDate, moduleStatusEntry=moduleStatusEntry, moduleRackNo=moduleRackNo, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleBusAddress=moduleBusAddress, receiverPort=receiverPort, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitLoLo=controlTempLimitLoLo, statusSoftware=statusSoftware, moduleTable=moduleTable, statusLmt=statusLmt, moduleStatus=moduleStatus, moduleRegistry=moduleRegistry, moduleMacAddress=moduleMacAddress, moduleRepairLogEntry=moduleRepairLogEntry, moduleControl=moduleControl, elementTotalUpTime=elementTotalUpTime, controlLedUsage=controlLedUsage, statusResetCause=statusResetCause, productKeyIndex=productKeyIndex, sWUpdateStatus=sWUpdateStatus, moduleSizeOfTable=moduleSizeOfTable, moduleRepairLogTable=moduleRepairLogTable, moduleControlTable=moduleControlTable, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineText=notebookLineText, controlTempLimitLo=controlTempLimitLo, controlReset=controlReset, elementLongitude=elementLongitude, notebookLineNumber=notebookLineNumber, elementAltitude=elementAltitude, controlTempLimitHiHi=controlTempLimitHiHi)
