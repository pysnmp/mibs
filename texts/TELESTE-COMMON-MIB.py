...
NotificationType, Counter32, Integer32, ObjectIdentity, IpAddress, Gauge32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Bits, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Integer32", "ObjectIdentity", "IpAddress", "Gauge32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Bits", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSWUpdateEntry=moduleSWUpdateEntry, elementResetCount=elementResetCount, elementControl=elementControl, productKeyFeatureIndex=productKeyFeatureIndex, moduleMacAddress=moduleMacAddress, repairDate=repairDate, sWUpdateFileName=sWUpdateFileName, controlResetElement=controlResetElement, moduleHwVersion=moduleHwVersion, statusLid=statusLid, moduleStatusTable=moduleStatusTable, moduleInformation=moduleInformation, controlMarkState=controlMarkState, moduleNotebookEntry=moduleNotebookEntry, controlAlarmDetection=controlAlarmDetection, moduleRegistryTable=moduleRegistryTable, receiverCommunity=receiverCommunity, moduleAppVersion=moduleAppVersion, sWUpdateStatus=sWUpdateStatus, elementLongitude=elementLongitude, moduleBiosVersion=moduleBiosVersion, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapInterval=controlTrapInterval, moduleControlEntry=moduleControlEntry, elementStructure=elementStructure, controlLedUsage=controlLedUsage, productKeyFeatureEntry=productKeyFeatureEntry, moduleControl=moduleControl, statusRestartCounter=statusRestartCounter, controlBusMasterAdminState=controlBusMasterAdminState, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlInternalAppAccess=controlInternalAppAccess, moduleHwType=moduleHwType, controlTempLimitLoLo=controlTempLimitLoLo, moduleRepairLogTable=moduleRepairLogTable, moduleHwSerialNumber=moduleHwSerialNumber, productKeyTable=productKeyTable, regIndex=regIndex, productKeyFeatureTable=productKeyFeatureTable, elementLatitude=elementLatitude, productKeyMask=productKeyMask, element=element, controlTempLimitHi=controlTempLimitHi, controlTrapSending=controlTrapSending, controlTrapReceiverEntry=controlTrapReceiverEntry, sWUpdateControl=sWUpdateControl, moduleRepairLogEntry=moduleRepairLogEntry, elementName=elementName, statusInternalTemperature=statusInternalTemperature, productKeyStatus=productKeyStatus, statusResetCause=statusResetCause, statusSoftware=statusSoftware, controlAlarmOffDelay=controlAlarmOffDelay, statusGeneral=statusGeneral, moduleDetailTable=moduleDetailTable, notebookLineNumber=notebookLineNumber, regName=regName, sizeOfRegistry=sizeOfRegistry, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitHiHi=controlTempLimitHiHi, repairIndex=repairIndex, elementConfigChangeCode=elementConfigChangeCode, controlReset=controlReset, productKeyFeatureName=productKeyFeatureName, moduleAppDate=moduleAppDate, moduleSizeOfTable=moduleSizeOfTable, controlTempDeadBand=controlTempDeadBand, statusRunningSwImage=statusRunningSwImage, sizeOfNotebook=sizeOfNotebook, controlAlarmOnDelay=controlAlarmOnDelay, elementInformation=elementInformation, receiverPort=receiverPort, notebookLineText=notebookLineText, moduleDetailEntry=moduleDetailEntry, moduleControlTable=moduleControlTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSettings=statusSettings, moduleSlotNo=moduleSlotNo, moduleEntry=moduleEntry, moduleName=moduleName, controlTrapReceiverTable=controlTrapReceiverTable, repairNameCode=repairNameCode, receiverAddress=receiverAddress, productKeyIndex=productKeyIndex, statusTemperature=statusTemperature, moduleRegistryEntry=moduleRegistryEntry, productKeyValue=productKeyValue, productKeyEntry=productKeyEntry, moduleTable=moduleTable, controlLocalAccess=controlLocalAccess, module=module, receiverEntryId=receiverEntryId, swUpdateURL=swUpdateURL, controlTrapDelay=controlTrapDelay, elementTotalUpTime=elementTotalUpTime, repairComment=repairComment, statusLmt=statusLmt, moduleBiosDate=moduleBiosDate, moduleStatusEntry=moduleStatusEntry, statusHardware=statusHardware, productKeyCipher=productKeyCipher, elementAltitude=elementAltitude, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapLifeTime=controlTrapLifeTime, sizeOfRepairlog=sizeOfRepairlog, repairReasonCode=repairReasonCode, moduleRegistry=moduleRegistry, moduleNotebookTable=moduleNotebookTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRackNo=moduleRackNo, statusFan=statusFan, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatus=moduleStatus, controlTempLimitLo=controlTempLimitLo, elementStatus=elementStatus, regValue=regValue, statusBusMaster=statusBusMaster, moduleBusAddress=moduleBusAddress, statusLidStatus=statusLidStatus, moduleId=moduleId, elementProductKey=elementProductKey)
