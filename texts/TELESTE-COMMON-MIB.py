...
IpAddress, Integer32, NotificationType, Counter32, TimeTicks, Counter64, ModuleIdentity, MibIdentifier, Bits, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "NotificationType", "Counter32", "TimeTicks", "Counter64", "ModuleIdentity", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusHardware=statusHardware, statusLidStatus=statusLidStatus, productKeyValue=productKeyValue, controlAlarmDetection=controlAlarmDetection, repairIndex=repairIndex, moduleTable=moduleTable, statusResetCause=statusResetCause, element=element, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRegistryEntry=moduleRegistryEntry, repairNameCode=repairNameCode, statusTemperature=statusTemperature, statusLmt=statusLmt, controlTrapInterval=controlTrapInterval, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyCipher=productKeyCipher, moduleAppDate=moduleAppDate, statusBusMaster=statusBusMaster, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitHi=controlTempLimitHi, moduleRepairLogEntry=moduleRepairLogEntry, moduleDetailTable=moduleDetailTable, statusInternalTemperature=statusInternalTemperature, controlInternalAppAccess=controlInternalAppAccess, elementLatitude=elementLatitude, sWUpdateStatus=sWUpdateStatus, elementStatus=elementStatus, regValue=regValue, controlAlarmOnDelay=controlAlarmOnDelay, statusRestartCounter=statusRestartCounter, statusSoftware=statusSoftware, moduleSlotNo=moduleSlotNo, moduleStatus=moduleStatus, moduleStatusEntry=moduleStatusEntry, statusGeneral=statusGeneral, productKeyFeatureName=productKeyFeatureName, moduleBusAddress=moduleBusAddress, moduleControlTable=moduleControlTable, elementControl=elementControl, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitLoLo=controlTempLimitLoLo, moduleRepairLogTable=moduleRepairLogTable, swUpdateURL=swUpdateURL, moduleId=moduleId, controlTempLimitLo=controlTempLimitLo, controlResetElement=controlResetElement, moduleRegistryTable=moduleRegistryTable, elementName=elementName, controlLedUsage=controlLedUsage, elementResetCount=elementResetCount, receiverEntryId=receiverEntryId, moduleRackNo=moduleRackNo, controlTrapReceiverTable=controlTrapReceiverTable, moduleSizeOfTable=moduleSizeOfTable, moduleMacAddress=moduleMacAddress, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyTable=productKeyTable, controlLocalAccess=controlLocalAccess, repairDate=repairDate, sizeOfNotebook=sizeOfNotebook, regName=regName, moduleEntry=moduleEntry, controlMarkState=controlMarkState, productKeyFeatureEnable=productKeyFeatureEnable, moduleName=moduleName, notebookLineNumber=notebookLineNumber, receiverAddress=receiverAddress, elementAltitude=elementAltitude, moduleStatusTable=moduleStatusTable, moduleHwType=moduleHwType, controlTrapDelay=controlTrapDelay, moduleControlEntry=moduleControlEntry, regIndex=regIndex, moduleHwSerialNumber=moduleHwSerialNumber, moduleInformation=moduleInformation, productKeyNumberOfKeys=productKeyNumberOfKeys, elementTotalUpTime=elementTotalUpTime, controlTempLimitHiHi=controlTempLimitHiHi, repairComment=repairComment, controlReset=controlReset, controlTrapSending=controlTrapSending, controlBusMasterAdminState=controlBusMasterAdminState, moduleSWUpdateTable=moduleSWUpdateTable, sWUpdateControl=sWUpdateControl, moduleControl=moduleControl, moduleHwVersion=moduleHwVersion, elementStructure=elementStructure, statusSettings=statusSettings, moduleNotebookEntry=moduleNotebookEntry, productKeyStatus=productKeyStatus, moduleBiosVersion=moduleBiosVersion, moduleRegistry=moduleRegistry, moduleBiosDate=moduleBiosDate, moduleDetailEntry=moduleDetailEntry, productKeyFeatureEntry=productKeyFeatureEntry, sizeOfRepairlog=sizeOfRepairlog, controlTempDeadBand=controlTempDeadBand, repairReasonCode=repairReasonCode, statusLid=statusLid, elementConfigChangeCode=elementConfigChangeCode, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, notebookLineText=notebookLineText, statusRunningSwImage=statusRunningSwImage, productKeyFeatureTable=productKeyFeatureTable, productKeyMask=productKeyMask, elementLongitude=elementLongitude, productKeyEntry=productKeyEntry, productKeyIndex=productKeyIndex, receiverCommunity=receiverCommunity, receiverPort=receiverPort, moduleSWUpdateEntry=moduleSWUpdateEntry, elementInformation=elementInformation, elementProductKey=elementProductKey, sWUpdateFileName=sWUpdateFileName, sizeOfRegistry=sizeOfRegistry, module=module, moduleSizeOfEntry=moduleSizeOfEntry, statusFan=statusFan, moduleNotebookTable=moduleNotebookTable, moduleAppVersion=moduleAppVersion)
