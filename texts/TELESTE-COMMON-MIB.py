...
NotificationType, ModuleIdentity, Counter64, IpAddress, Gauge32, ObjectIdentity, Unsigned32, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Counter64", "IpAddress", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", swUpdateURL=swUpdateURL, productKeyFeatureTable=productKeyFeatureTable, moduleEntry=moduleEntry, moduleStatusTable=moduleStatusTable, productKeyFeatureName=productKeyFeatureName, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapInterval=controlTrapInterval, controlTrapReceiverEntry=controlTrapReceiverEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSWUpdateTable=moduleSWUpdateTable, elementStructure=elementStructure, moduleSizeOfTable=moduleSizeOfTable, module=module, moduleTable=moduleTable, regValue=regValue, moduleRegistry=moduleRegistry, moduleHwSerialNumber=moduleHwSerialNumber, regIndex=regIndex, repairDate=repairDate, elementStatus=elementStatus, elementAltitude=elementAltitude, receiverCommunity=receiverCommunity, statusInternalTemperature=statusInternalTemperature, controlBusMasterAdminState=controlBusMasterAdminState, controlTempLimitHi=controlTempLimitHi, controlAlarmOnDelay=controlAlarmOnDelay, elementProductKey=elementProductKey, statusLmt=statusLmt, controlResetElement=controlResetElement, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusTemperature=statusTemperature, receiverEntryId=receiverEntryId, moduleRackNo=moduleRackNo, controlTrapLifeTime=controlTrapLifeTime, sizeOfRegistry=sizeOfRegistry, statusLidStatus=statusLidStatus, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, moduleId=moduleId, moduleHwType=moduleHwType, productKeyFeatureEnable=productKeyFeatureEnable, repairNameCode=repairNameCode, moduleRegistryTable=moduleRegistryTable, productKeyIndex=productKeyIndex, controlAlarmDetection=controlAlarmDetection, receiverAddress=receiverAddress, moduleControlEntry=moduleControlEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleDetailTable=moduleDetailTable, controlReset=controlReset, repairIndex=repairIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairComment=repairComment, productKeyMask=productKeyMask, notebookLineNumber=notebookLineNumber, moduleBiosDate=moduleBiosDate, statusHardware=statusHardware, productKeyEntry=productKeyEntry, controlTrapSending=controlTrapSending, moduleControlTable=moduleControlTable, statusBusMaster=statusBusMaster, elementTotalUpTime=elementTotalUpTime, moduleSWUpdateEntry=moduleSWUpdateEntry, element=element, moduleName=moduleName, controlTempLimitHiHi=controlTempLimitHiHi, sizeOfNotebook=sizeOfNotebook, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, controlInternalAppAccess=controlInternalAppAccess, notebookLineText=notebookLineText, productKeyValue=productKeyValue, statusFan=statusFan, productKeyTable=productKeyTable, moduleStatus=moduleStatus, moduleControl=moduleControl, statusResetCause=statusResetCause, regName=regName, moduleBusAddress=moduleBusAddress, controlTempLimitLo=controlTempLimitLo, controlTrapDelay=controlTrapDelay, receiverPort=receiverPort, statusSoftware=statusSoftware, elementName=elementName, moduleAppVersion=moduleAppVersion, elementInformation=elementInformation, controlTempDeadBand=controlTempDeadBand, sizeOfRepairlog=sizeOfRepairlog, elementControl=elementControl, moduleHwVersion=moduleHwVersion, moduleDetailEntry=moduleDetailEntry, elementLongitude=elementLongitude, repairReasonCode=repairReasonCode, moduleInformation=moduleInformation, moduleStatusEntry=moduleStatusEntry, moduleRegistryEntry=moduleRegistryEntry, productKeyCipher=productKeyCipher, statusSettings=statusSettings, moduleSlotNo=moduleSlotNo, moduleNotebookEntry=moduleNotebookEntry, controlMarkState=controlMarkState, productKeyNumberOfKeys=productKeyNumberOfKeys, controlLocalAccess=controlLocalAccess, statusGeneral=statusGeneral, moduleNotebookTable=moduleNotebookTable, elementConfigChangeCode=elementConfigChangeCode, statusRestartCounter=statusRestartCounter, moduleSizeOfEntry=moduleSizeOfEntry, moduleMacAddress=moduleMacAddress, moduleAppDate=moduleAppDate, sWUpdateControl=sWUpdateControl, statusLid=statusLid, elementLatitude=elementLatitude, moduleRepairLogTable=moduleRepairLogTable, controlTempLimitLoLo=controlTempLimitLoLo, controlLedUsage=controlLedUsage, elementResetCount=elementResetCount, statusRunningSwImage=statusRunningSwImage, sWUpdateStatus=sWUpdateStatus)
