...
Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, TimeTicks, IpAddress, NotificationType, Gauge32, MibIdentifier, iso, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "TimeTicks", "IpAddress", "NotificationType", "Gauge32", "MibIdentifier", "iso", "ObjectIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementProductKey=elementProductKey, moduleBiosVersion=moduleBiosVersion, moduleSlotNo=moduleSlotNo, regIndex=regIndex, controlTempLimitLo=controlTempLimitLo, moduleEntry=moduleEntry, moduleDetailEntry=moduleDetailEntry, moduleAppDate=moduleAppDate, productKeyIndex=productKeyIndex, sizeOfRepairlog=sizeOfRepairlog, regName=regName, moduleStatus=moduleStatus, controlTrapInterval=controlTrapInterval, receiverEntryId=receiverEntryId, statusLidStatus=statusLidStatus, moduleSWUpdateEntry=moduleSWUpdateEntry, elementLongitude=elementLongitude, sWUpdateFileName=sWUpdateFileName, statusBusMaster=statusBusMaster, productKeyFeatureEntry=productKeyFeatureEntry, statusInternalTemperature=statusInternalTemperature, controlTempLimitLoLo=controlTempLimitLoLo, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRegistryTable=moduleRegistryTable, moduleDetailTable=moduleDetailTable, swUpdateURL=swUpdateURL, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleTable=moduleTable, moduleBusAddress=moduleBusAddress, moduleControl=moduleControl, moduleControlEntry=moduleControlEntry, controlAlarmOnDelay=controlAlarmOnDelay, controlResetElement=controlResetElement, statusRestartCounter=statusRestartCounter, moduleInformation=moduleInformation, moduleSizeOfTable=moduleSizeOfTable, elementName=elementName, statusHardware=statusHardware, moduleBiosDate=moduleBiosDate, elementStructure=elementStructure, moduleHwType=moduleHwType, statusTemperature=statusTemperature, productKeyFeatureName=productKeyFeatureName, moduleAppVersion=moduleAppVersion, controlTempDeadBand=controlTempDeadBand, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogTable=moduleRepairLogTable, statusLmt=statusLmt, moduleStatusTable=moduleStatusTable, moduleMacAddress=moduleMacAddress, controlTrapReceiverTable=controlTrapReceiverTable, statusRunningSwImage=statusRunningSwImage, controlInternalAppAccess=controlInternalAppAccess, receiverPort=receiverPort, productKeyFeatureIndex=productKeyFeatureIndex, moduleRegistryEntry=moduleRegistryEntry, module=module, statusSoftware=statusSoftware, productKeyTable=productKeyTable, controlMarkState=controlMarkState, productKeyMask=productKeyMask, moduleSizeOfEntry=moduleSizeOfEntry, statusFan=statusFan, moduleNotebookEntry=moduleNotebookEntry, controlLedUsage=controlLedUsage, productKeyEntry=productKeyEntry, elementLatitude=elementLatitude, repairReasonCode=repairReasonCode, moduleHwSerialNumber=moduleHwSerialNumber, element=element, moduleRackNo=moduleRackNo, moduleRepairLogEntry=moduleRepairLogEntry, repairNameCode=repairNameCode, moduleControlTable=moduleControlTable, moduleName=moduleName, moduleRegistry=moduleRegistry, moduleId=moduleId, elementAltitude=elementAltitude, elementControl=elementControl, elementTotalUpTime=elementTotalUpTime, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfNotebook=sizeOfNotebook, controlAlarmDetection=controlAlarmDetection, productKeyNumberOfKeys=productKeyNumberOfKeys, controlBusMasterAdminState=controlBusMasterAdminState, statusSettings=statusSettings, moduleNotebookTable=moduleNotebookTable, sWUpdateStatus=sWUpdateStatus, controlTrapDelay=controlTrapDelay, productKeyFeatureTable=productKeyFeatureTable, controlReset=controlReset, moduleSWUpdateTable=moduleSWUpdateTable, sWUpdateControl=sWUpdateControl, elementConfigChangeCode=elementConfigChangeCode, elementStatus=elementStatus, repairIndex=repairIndex, controlTempLimitHi=controlTempLimitHi, elementInformation=elementInformation, controlTempLimitHiHi=controlTempLimitHiHi, statusGeneral=statusGeneral, notebookLineNumber=notebookLineNumber, receiverCommunity=receiverCommunity, controlTrapSending=controlTrapSending, receiverAddress=receiverAddress, controlLocalAccess=controlLocalAccess, statusLid=statusLid, sizeOfRegistry=sizeOfRegistry, regValue=regValue, productKeyFeatureEnable=productKeyFeatureEnable, elementResetCount=elementResetCount, productKeyValue=productKeyValue, repairDate=repairDate, repairComment=repairComment, controlTrapReceiverEntry=controlTrapReceiverEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleHwVersion=moduleHwVersion, statusResetCause=statusResetCause, productKeyCipher=productKeyCipher, productKeyStatus=productKeyStatus, moduleStatusEntry=moduleStatusEntry, notebookLineText=notebookLineText)
