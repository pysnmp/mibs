...
Counter64, iso, Integer32, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, Counter32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Integer32", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Counter32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairReasonCode=repairReasonCode, statusHardware=statusHardware, moduleName=moduleName, moduleBusAddress=moduleBusAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryTable=moduleRegistryTable, repairIndex=repairIndex, statusTemperature=statusTemperature, moduleControlTable=moduleControlTable, statusBusMaster=statusBusMaster, controlAlarmOffDelay=controlAlarmOffDelay, controlLocalAccess=controlLocalAccess, moduleNotebookEntry=moduleNotebookEntry, statusLid=statusLid, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitHi=controlTempLimitHi, moduleSizeOfTable=moduleSizeOfTable, elementResetCount=elementResetCount, element=element, controlTrapDelay=controlTrapDelay, moduleRegistry=moduleRegistry, regIndex=regIndex, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwSerialNumber=moduleHwSerialNumber, sizeOfRegistry=sizeOfRegistry, sizeOfRepairlog=sizeOfRepairlog, receiverAddress=receiverAddress, sWUpdateStatus=sWUpdateStatus, moduleHwType=moduleHwType, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureName=productKeyFeatureName, controlTrapReceiverTable=controlTrapReceiverTable, productKeyEntry=productKeyEntry, swUpdateURL=swUpdateURL, moduleStatusEntry=moduleStatusEntry, statusLmt=statusLmt, moduleNotebookTable=moduleNotebookTable, repairComment=repairComment, statusRunningSwImage=statusRunningSwImage, statusGeneral=statusGeneral, elementInformation=elementInformation, moduleBiosDate=moduleBiosDate, productKeyCipher=productKeyCipher, moduleDetailTable=moduleDetailTable, controlInternalAppAccess=controlInternalAppAccess, controlAlarmOnDelay=controlAlarmOnDelay, moduleHwVersion=moduleHwVersion, productKeyTable=productKeyTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSizeOfEntry=moduleSizeOfEntry, sWUpdateFileName=sWUpdateFileName, moduleMacAddress=moduleMacAddress, moduleDetailEntry=moduleDetailEntry, elementConfigChangeCode=elementConfigChangeCode, controlReset=controlReset, receiverEntryId=receiverEntryId, statusSettings=statusSettings, module=module, productKeyFeatureTable=productKeyFeatureTable, statusRestartCounter=statusRestartCounter, moduleControl=moduleControl, statusLidStatus=statusLidStatus, controlTrapInterval=controlTrapInterval, controlTrapReceiverEntry=controlTrapReceiverEntry, controlMarkState=controlMarkState, elementAltitude=elementAltitude, elementName=elementName, productKeyIndex=productKeyIndex, repairDate=repairDate, elementTotalUpTime=elementTotalUpTime, elementControl=elementControl, statusInternalTemperature=statusInternalTemperature, elementLatitude=elementLatitude, moduleEntry=moduleEntry, statusFan=statusFan, productKeyFeatureIndex=productKeyFeatureIndex, statusResetCause=statusResetCause, moduleSWUpdateTable=moduleSWUpdateTable, elementStructure=elementStructure, productKeyStatus=productKeyStatus, controlAlarmDetection=controlAlarmDetection, repairNameCode=repairNameCode, receiverCommunity=receiverCommunity, controlTempDeadBand=controlTempDeadBand, elementStatus=elementStatus, productKeyMask=productKeyMask, elementLongitude=elementLongitude, moduleRepairLogEntry=moduleRepairLogEntry, controlResetElement=controlResetElement, productKeyFeatureEntry=productKeyFeatureEntry, notebookLineNumber=notebookLineNumber, controlTrapSending=controlTrapSending, regName=regName, moduleBiosVersion=moduleBiosVersion, controlTempLimitHiHi=controlTempLimitHiHi, notebookLineText=notebookLineText, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitLoLo=controlTempLimitLoLo, sizeOfNotebook=sizeOfNotebook, controlTrapLifeTime=controlTrapLifeTime, regValue=regValue, moduleRepairLogTable=moduleRepairLogTable, controlTempLimitLo=controlTempLimitLo, moduleTable=moduleTable, moduleRegistryEntry=moduleRegistryEntry, receiverPort=receiverPort, statusSoftware=statusSoftware, moduleId=moduleId, moduleAppDate=moduleAppDate, moduleInformation=moduleInformation, moduleStatusTable=moduleStatusTable, moduleSlotNo=moduleSlotNo, moduleControlEntry=moduleControlEntry, sWUpdateControl=sWUpdateControl, moduleAppVersion=moduleAppVersion, productKeyValue=productKeyValue, elementProductKey=elementProductKey, controlLedUsage=controlLedUsage, moduleStatus=moduleStatus, moduleRackNo=moduleRackNo)
