...
Counter32, iso, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, NotificationType, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTempLimitHiHi=controlTempLimitHiHi, moduleAppVersion=moduleAppVersion, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusInternalTemperature=statusInternalTemperature, controlResetElement=controlResetElement, moduleStatusTable=moduleStatusTable, controlLocalAccess=controlLocalAccess, repairDate=repairDate, repairReasonCode=repairReasonCode, productKeyFeatureTable=productKeyFeatureTable, moduleAppDate=moduleAppDate, moduleEntry=moduleEntry, elementResetCount=elementResetCount, elementTotalUpTime=elementTotalUpTime, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleInformation=moduleInformation, statusRestartCounter=statusRestartCounter, moduleSWUpdateTable=moduleSWUpdateTable, elementLongitude=elementLongitude, controlAlarmOffDelay=controlAlarmOffDelay, statusLid=statusLid, repairNameCode=repairNameCode, productKeyIndex=productKeyIndex, sWUpdateFileName=sWUpdateFileName, elementStructure=elementStructure, controlTempDeadBand=controlTempDeadBand, statusTemperature=statusTemperature, controlAlarmOnDelay=controlAlarmOnDelay, receiverAddress=receiverAddress, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapSending=controlTrapSending, notebookLineNumber=notebookLineNumber, controlAlarmDetection=controlAlarmDetection, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRepairLogTable=moduleRepairLogTable, sizeOfRegistry=sizeOfRegistry, statusLidStatus=statusLidStatus, controlTrapInterval=controlTrapInterval, controlTempLimitLoLo=controlTempLimitLoLo, moduleNotebookTable=moduleNotebookTable, moduleHwType=moduleHwType, elementControl=elementControl, statusRunningSwImage=statusRunningSwImage, statusLmt=statusLmt, moduleId=moduleId, swUpdateURL=swUpdateURL, regIndex=regIndex, moduleNotebookEntry=moduleNotebookEntry, moduleControlTable=moduleControlTable, elementInformation=elementInformation, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlReset=controlReset, elementProductKey=elementProductKey, receiverPort=receiverPort, moduleStatus=moduleStatus, moduleName=moduleName, elementAltitude=elementAltitude, regValue=regValue, moduleHwSerialNumber=moduleHwSerialNumber, sWUpdateStatus=sWUpdateStatus, statusFan=statusFan, moduleControlEntry=moduleControlEntry, moduleTable=moduleTable, receiverCommunity=receiverCommunity, moduleRegistryEntry=moduleRegistryEntry, sizeOfNotebook=sizeOfNotebook, productKeyValue=productKeyValue, controlTrapReceiverTable=controlTrapReceiverTable, statusSoftware=statusSoftware, moduleControl=moduleControl, productKeyTable=productKeyTable, controlLedUsage=controlLedUsage, repairComment=repairComment, sWUpdateControl=sWUpdateControl, moduleDetailTable=moduleDetailTable, repairIndex=repairIndex, productKeyCipher=productKeyCipher, statusGeneral=statusGeneral, productKeyFeatureIndex=productKeyFeatureIndex, regName=regName, receiverEntryId=receiverEntryId, notebookLineText=notebookLineText, statusBusMaster=statusBusMaster, moduleMacAddress=moduleMacAddress, controlTrapDelay=controlTrapDelay, statusSettings=statusSettings, module=module, moduleDetailEntry=moduleDetailEntry, elementName=elementName, element=element, moduleRegistryTable=moduleRegistryTable, productKeyFeatureName=productKeyFeatureName, moduleSWUpdateEntry=moduleSWUpdateEntry, controlMarkState=controlMarkState, sizeOfRepairlog=sizeOfRepairlog, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapLifeTime=controlTrapLifeTime, controlBusMasterAdminState=controlBusMasterAdminState, moduleHwVersion=moduleHwVersion, productKeyStatus=productKeyStatus, moduleBusAddress=moduleBusAddress, elementLatitude=elementLatitude, moduleBiosVersion=moduleBiosVersion, controlTempLimitHi=controlTempLimitHi, elementStatus=elementStatus, elementConfigChangeCode=elementConfigChangeCode, productKeyMask=productKeyMask, productKeyEntry=productKeyEntry, statusResetCause=statusResetCause, statusHardware=statusHardware, moduleSlotNo=moduleSlotNo, moduleRackNo=moduleRackNo, moduleStatusEntry=moduleStatusEntry, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureEnable=productKeyFeatureEnable, moduleBiosDate=moduleBiosDate, productKeyFeatureEntry=productKeyFeatureEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRegistry=moduleRegistry, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitLo=controlTempLimitLo)
