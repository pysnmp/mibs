...
Integer32, IpAddress, TimeTicks, Counter64, Bits, Counter32, ObjectIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "TimeTicks", "Counter64", "Bits", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverPort=receiverPort, receiverAddress=receiverAddress, productKeyFeatureEntry=productKeyFeatureEntry, repairReasonCode=repairReasonCode, moduleControlEntry=moduleControlEntry, moduleHwVersion=moduleHwVersion, statusSoftware=statusSoftware, controlTrapInterval=controlTrapInterval, notebookLineNumber=notebookLineNumber, receiverCommunity=receiverCommunity, moduleSWUpdateTable=moduleSWUpdateTable, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleHwSerialNumber=moduleHwSerialNumber, controlAlarmOnDelay=controlAlarmOnDelay, receiverEntryId=receiverEntryId, productKeyFeatureName=productKeyFeatureName, repairComment=repairComment, controlInternalAppAccess=controlInternalAppAccess, sWUpdateStatus=sWUpdateStatus, sizeOfNotebook=sizeOfNotebook, elementTotalUpTime=elementTotalUpTime, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSizeOfEntry=moduleSizeOfEntry, elementResetCount=elementResetCount, productKeyCipher=productKeyCipher, moduleId=moduleId, swUpdateURL=swUpdateURL, regIndex=regIndex, moduleName=moduleName, elementStatus=elementStatus, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmOffDelay=controlAlarmOffDelay, regName=regName, elementStructure=elementStructure, productKeyFeatureIndex=productKeyFeatureIndex, moduleBusAddress=moduleBusAddress, statusGeneral=statusGeneral, elementInformation=elementInformation, repairDate=repairDate, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTempLimitHi=controlTempLimitHi, productKeyIndex=productKeyIndex, controlReset=controlReset, moduleSizeOfTable=moduleSizeOfTable, statusResetCause=statusResetCause, moduleNotebookTable=moduleNotebookTable, sWUpdateControl=sWUpdateControl, statusRunningSwImage=statusRunningSwImage, controlTrapLifeTime=controlTrapLifeTime, moduleDetailEntry=moduleDetailEntry, statusFan=statusFan, elementConfigChangeCode=elementConfigChangeCode, controlLedUsage=controlLedUsage, productKeyEntry=productKeyEntry, controlTempLimitHiHi=controlTempLimitHiHi, statusInternalTemperature=statusInternalTemperature, moduleRepairLogTable=moduleRepairLogTable, moduleEntry=moduleEntry, moduleNotebookEntry=moduleNotebookEntry, controlBusMasterAdminState=controlBusMasterAdminState, statusBusMaster=statusBusMaster, moduleRegistryTable=moduleRegistryTable, elementLatitude=elementLatitude, productKeyValue=productKeyValue, controlAlarmDetection=controlAlarmDetection, module=module, productKeyStatus=productKeyStatus, controlMarkState=controlMarkState, elementName=elementName, moduleDetailTable=moduleDetailTable, moduleInformation=moduleInformation, element=element, productKeyFeatureEnable=productKeyFeatureEnable, moduleTable=moduleTable, elementControl=elementControl, moduleBiosVersion=moduleBiosVersion, moduleStatusTable=moduleStatusTable, moduleStatusEntry=moduleStatusEntry, repairIndex=repairIndex, controlTrapReceiverTable=controlTrapReceiverTable, moduleMacAddress=moduleMacAddress, statusLmt=statusLmt, controlLocalAccess=controlLocalAccess, statusHardware=statusHardware, statusTemperature=statusTemperature, elementLongitude=elementLongitude, controlTempDeadBand=controlTempDeadBand, statusLidStatus=statusLidStatus, statusRestartCounter=statusRestartCounter, moduleHwType=moduleHwType, moduleStatus=moduleStatus, notebookLineText=notebookLineText, controlTempLimitLoLo=controlTempLimitLoLo, controlTrapSending=controlTrapSending, productKeyMask=productKeyMask, productKeyTable=productKeyTable, controlTempLimitLo=controlTempLimitLo, moduleRackNo=moduleRackNo, controlResetElement=controlResetElement, repairNameCode=repairNameCode, elementAltitude=elementAltitude, elementProductKey=elementProductKey, moduleControl=moduleControl, statusSettings=statusSettings, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapDelay=controlTrapDelay, productKeyFeatureTable=productKeyFeatureTable, moduleBiosDate=moduleBiosDate, moduleRegistry=moduleRegistry, statusLid=statusLid, sWUpdateFileName=sWUpdateFileName, sizeOfRegistry=sizeOfRegistry, moduleRepairLogEntry=moduleRepairLogEntry, regValue=regValue, moduleAppVersion=moduleAppVersion, sizeOfRepairlog=sizeOfRepairlog, moduleAppDate=moduleAppDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleControlTable=moduleControlTable)
