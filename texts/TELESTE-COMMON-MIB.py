...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, IpAddress, Gauge32, Unsigned32, Counter64, ModuleIdentity, MibIdentifier, NotificationType, Counter32, Bits, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "IpAddress", "Gauge32", "Unsigned32", "Counter64", "ModuleIdentity", "MibIdentifier", "NotificationType", "Counter32", "Bits", "Integer32", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleStatus=moduleStatus, controlTempLimitHiHi=controlTempLimitHiHi, notebookLineText=notebookLineText, statusSoftware=statusSoftware, moduleNotebookTable=moduleNotebookTable, productKeyFeatureTable=productKeyFeatureTable, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureEntry=productKeyFeatureEntry, controlAlarmDetection=controlAlarmDetection, sWUpdateControl=sWUpdateControl, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateFileName=sWUpdateFileName, moduleRegistry=moduleRegistry, productKeyCipher=productKeyCipher, receiverCommunity=receiverCommunity, statusRunningSwImage=statusRunningSwImage, moduleAppDate=moduleAppDate, moduleHwType=moduleHwType, moduleBiosVersion=moduleBiosVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlResetElement=controlResetElement, statusFan=statusFan, receiverEntryId=receiverEntryId, controlTempLimitHi=controlTempLimitHi, notebookLineNumber=notebookLineNumber, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleControl=moduleControl, controlMarkState=controlMarkState, moduleRackNo=moduleRackNo, elementConfigChangeCode=elementConfigChangeCode, controlBusMasterAdminState=controlBusMasterAdminState, moduleBusAddress=moduleBusAddress, controlTrapSending=controlTrapSending, regValue=regValue, moduleDetailEntry=moduleDetailEntry, moduleControlTable=moduleControlTable, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTempDeadBand=controlTempDeadBand, repairIndex=repairIndex, receiverPort=receiverPort, statusInternalTemperature=statusInternalTemperature, elementResetCount=elementResetCount, statusBusMaster=statusBusMaster, moduleRepairLogTable=moduleRepairLogTable, repairDate=repairDate, moduleStatusEntry=moduleStatusEntry, moduleDetailTable=moduleDetailTable, swUpdateURL=swUpdateURL, productKeyEntry=productKeyEntry, moduleRepairLogEntry=moduleRepairLogEntry, elementLatitude=elementLatitude, statusLmt=statusLmt, elementName=elementName, receiverAddress=receiverAddress, elementLongitude=elementLongitude, repairComment=repairComment, elementControl=elementControl, productKeyMask=productKeyMask, statusGeneral=statusGeneral, elementProductKey=elementProductKey, elementInformation=elementInformation, moduleAppVersion=moduleAppVersion, moduleHwVersion=moduleHwVersion, moduleStatusTable=moduleStatusTable, controlLocalAccess=controlLocalAccess, controlTrapDelay=controlTrapDelay, sizeOfNotebook=sizeOfNotebook, productKeyTable=productKeyTable, moduleId=moduleId, controlReset=controlReset, productKeyFeatureName=productKeyFeatureName, elementStatus=elementStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitLo=controlTempLimitLo, statusLidStatus=statusLidStatus, statusRestartCounter=statusRestartCounter, sizeOfRepairlog=sizeOfRepairlog, moduleControlEntry=moduleControlEntry, regName=regName, moduleNotebookEntry=moduleNotebookEntry, regIndex=regIndex, statusHardware=statusHardware, sizeOfRegistry=sizeOfRegistry, statusSettings=statusSettings, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureEnable=productKeyFeatureEnable, statusResetCause=statusResetCause, controlAlarmOnDelay=controlAlarmOnDelay, productKeyValue=productKeyValue, moduleInformation=moduleInformation, statusTemperature=statusTemperature, elementStructure=elementStructure, elementAltitude=elementAltitude, sWUpdateStatus=sWUpdateStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, repairReasonCode=repairReasonCode, repairNameCode=repairNameCode, controlLedUsage=controlLedUsage, moduleMacAddress=moduleMacAddress, moduleSlotNo=moduleSlotNo, moduleTable=moduleTable, elementTotalUpTime=elementTotalUpTime, statusLid=statusLid, productKeyIndex=productKeyIndex, moduleEntry=moduleEntry, element=element, moduleName=moduleName, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapInterval=controlTrapInterval, module=module, controlTrapReceiverTable=controlTrapReceiverTable, moduleBiosDate=moduleBiosDate, controlInternalAppAccess=controlInternalAppAccess, moduleRegistryTable=moduleRegistryTable, moduleSWUpdateTable=moduleSWUpdateTable, productKeyStatus=productKeyStatus)
