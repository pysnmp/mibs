...
MibIdentifier, TimeTicks, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Bits, iso, ModuleIdentity, Gauge32, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Bits", "iso", "ModuleIdentity", "Gauge32", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleMacAddress=moduleMacAddress, moduleStatusTable=moduleStatusTable, controlAlarmDetection=controlAlarmDetection, controlMarkState=controlMarkState, controlTempLimitHi=controlTempLimitHi, regName=regName, repairDate=repairDate, moduleAppVersion=moduleAppVersion, elementControl=elementControl, receiverCommunity=receiverCommunity, moduleSlotNo=moduleSlotNo, statusLidStatus=statusLidStatus, controlTrapInterval=controlTrapInterval, regIndex=regIndex, statusGeneral=statusGeneral, moduleAppDate=moduleAppDate, moduleDetailTable=moduleDetailTable, productKeyFeatureIndex=productKeyFeatureIndex, regValue=regValue, productKeyFeatureName=productKeyFeatureName, moduleSWUpdateTable=moduleSWUpdateTable, elementTotalUpTime=elementTotalUpTime, elementLongitude=elementLongitude, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapReceiverEntry=controlTrapReceiverEntry, receiverAddress=receiverAddress, controlTempLimitLo=controlTempLimitLo, receiverEntryId=receiverEntryId, elementProductKey=elementProductKey, notebookLineNumber=notebookLineNumber, statusRestartCounter=statusRestartCounter, moduleControlEntry=moduleControlEntry, controlLedUsage=controlLedUsage, moduleNotebookTable=moduleNotebookTable, controlLocalAccess=controlLocalAccess, moduleDetailEntry=moduleDetailEntry, productKeyStatus=productKeyStatus, elementAltitude=elementAltitude, receiverPort=receiverPort, statusLmt=statusLmt, moduleHwVersion=moduleHwVersion, elementStructure=elementStructure, moduleStatusEntry=moduleStatusEntry, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleStatus=moduleStatus, sWUpdateFileName=sWUpdateFileName, moduleBiosVersion=moduleBiosVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyCipher=productKeyCipher, elementStatus=elementStatus, statusRunningSwImage=statusRunningSwImage, notebookLineText=notebookLineText, controlTrapLifeTime=controlTrapLifeTime, sizeOfRepairlog=sizeOfRepairlog, repairReasonCode=repairReasonCode, productKeyValue=productKeyValue, moduleEntry=moduleEntry, sWUpdateControl=sWUpdateControl, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyTable=productKeyTable, controlAlarmOffDelay=controlAlarmOffDelay, controlTempDeadBand=controlTempDeadBand, statusSoftware=statusSoftware, moduleBiosDate=moduleBiosDate, controlReset=controlReset, moduleSWUpdateEntry=moduleSWUpdateEntry, sizeOfRegistry=sizeOfRegistry, elementInformation=elementInformation, statusTemperature=statusTemperature, productKeyFeatureEntry=productKeyFeatureEntry, moduleId=moduleId, statusBusMaster=statusBusMaster, controlTrapSending=controlTrapSending, moduleInformation=moduleInformation, statusSettings=statusSettings, moduleControlTable=moduleControlTable, moduleSizeOfTable=moduleSizeOfTable, controlTrapReceiverTable=controlTrapReceiverTable, sWUpdateStatus=sWUpdateStatus, elementLatitude=elementLatitude, moduleRegistry=moduleRegistry, repairComment=repairComment, repairNameCode=repairNameCode, moduleControl=moduleControl, controlResetElement=controlResetElement, moduleTable=moduleTable, statusLid=statusLid, elementConfigChangeCode=elementConfigChangeCode, elementResetCount=elementResetCount, productKeyMask=productKeyMask, controlTrapDelay=controlTrapDelay, element=element, productKeyEntry=productKeyEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusResetCause=statusResetCause, moduleName=moduleName, moduleNotebookEntry=moduleNotebookEntry, moduleHwSerialNumber=moduleHwSerialNumber, elementName=elementName, controlAlarmOnDelay=controlAlarmOnDelay, moduleBusAddress=moduleBusAddress, productKeyIndex=productKeyIndex, controlInternalAppAccess=controlInternalAppAccess, moduleRegistryEntry=moduleRegistryEntry, module=module, moduleRegistryTable=moduleRegistryTable, repairIndex=repairIndex, moduleRackNo=moduleRackNo, productKeyFeatureTable=productKeyFeatureTable, moduleHwType=moduleHwType, sizeOfNotebook=sizeOfNotebook, swUpdateURL=swUpdateURL, statusHardware=statusHardware, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogEntry=moduleRepairLogEntry, moduleRepairLogTable=moduleRepairLogTable, statusInternalTemperature=statusInternalTemperature, controlTempLimitLoLo=controlTempLimitLoLo, statusFan=statusFan)
