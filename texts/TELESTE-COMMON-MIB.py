...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Counter64, Counter32, Unsigned32, NotificationType, MibIdentifier, IpAddress, Integer32, TimeTicks, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Counter64", "Counter32", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "TimeTicks", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sizeOfNotebook=sizeOfNotebook, controlTempLimitLoLo=controlTempLimitLoLo, elementLongitude=elementLongitude, receiverAddress=receiverAddress, controlAlarmOnDelay=controlAlarmOnDelay, productKeyValue=productKeyValue, element=element, moduleRegistry=moduleRegistry, regValue=regValue, moduleControl=moduleControl, moduleHwSerialNumber=moduleHwSerialNumber, productKeyFeatureEnable=productKeyFeatureEnable, productKeyCipher=productKeyCipher, sizeOfRegistry=sizeOfRegistry, moduleHwVersion=moduleHwVersion, productKeyTable=productKeyTable, moduleRackNo=moduleRackNo, moduleStatusEntry=moduleStatusEntry, moduleSizeOfEntry=moduleSizeOfEntry, statusInternalTemperature=statusInternalTemperature, module=module, notebookLineText=notebookLineText, statusLmt=statusLmt, moduleRegistryTable=moduleRegistryTable, moduleRepairLogEntry=moduleRepairLogEntry, statusSettings=statusSettings, elementTotalUpTime=elementTotalUpTime, controlMarkState=controlMarkState, statusGeneral=statusGeneral, statusLid=statusLid, productKeyFeatureName=productKeyFeatureName, statusLidStatus=statusLidStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, swUpdateURL=swUpdateURL, statusSoftware=statusSoftware, productKeyNumberOfKeys=productKeyNumberOfKeys, repairIndex=repairIndex, productKeyStatus=productKeyStatus, productKeyFeatureEntry=productKeyFeatureEntry, sizeOfRepairlog=sizeOfRepairlog, repairReasonCode=repairReasonCode, elementResetCount=elementResetCount, productKeyIndex=productKeyIndex, moduleId=moduleId, elementConfigChangeCode=elementConfigChangeCode, notebookLineNumber=notebookLineNumber, moduleMacAddress=moduleMacAddress, productKeyEntry=productKeyEntry, moduleBiosVersion=moduleBiosVersion, moduleControlTable=moduleControlTable, sWUpdateFileName=sWUpdateFileName, moduleInformation=moduleInformation, sWUpdateStatus=sWUpdateStatus, moduleAppVersion=moduleAppVersion, controlTrapInterval=controlTrapInterval, controlTempLimitLo=controlTempLimitLo, moduleSizeOfTable=moduleSizeOfTable, statusTemperature=statusTemperature, moduleNotebookTable=moduleNotebookTable, controlAlarmOffDelay=controlAlarmOffDelay, controlReset=controlReset, receiverEntryId=receiverEntryId, controlBusMasterAdminState=controlBusMasterAdminState, receiverPort=receiverPort, controlTempLimitHiHi=controlTempLimitHiHi, statusHardware=statusHardware, moduleStatus=moduleStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlLedUsage=controlLedUsage, productKeyMask=productKeyMask, regName=regName, elementInformation=elementInformation, moduleEntry=moduleEntry, controlResetElement=controlResetElement, statusRunningSwImage=statusRunningSwImage, moduleDetailTable=moduleDetailTable, controlTempDeadBand=controlTempDeadBand, repairComment=repairComment, elementAltitude=elementAltitude, moduleBusAddress=moduleBusAddress, controlLocalAccess=controlLocalAccess, controlAlarmDetection=controlAlarmDetection, elementLatitude=elementLatitude, controlTrapLifeTime=controlTrapLifeTime, elementStructure=elementStructure, elementStatus=elementStatus, statusFan=statusFan, moduleName=moduleName, receiverCommunity=receiverCommunity, controlTrapReceiverTable=controlTrapReceiverTable, moduleNotebookEntry=moduleNotebookEntry, moduleSWUpdateTable=moduleSWUpdateTable, repairDate=repairDate, moduleAppDate=moduleAppDate, statusResetCause=statusResetCause, sWUpdateControl=sWUpdateControl, controlTrapDelay=controlTrapDelay, controlTrapSending=controlTrapSending, moduleStatusTable=moduleStatusTable, regIndex=regIndex, elementName=elementName, controlInternalAppAccess=controlInternalAppAccess, elementProductKey=elementProductKey, controlTempLimitHi=controlTempLimitHi, moduleDetailEntry=moduleDetailEntry, moduleHwType=moduleHwType, statusBusMaster=statusBusMaster, statusRestartCounter=statusRestartCounter, moduleControlEntry=moduleControlEntry, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureIndex=productKeyFeatureIndex, repairNameCode=repairNameCode, moduleRegistryEntry=moduleRegistryEntry, moduleTable=moduleTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSWUpdateEntry=moduleSWUpdateEntry, elementControl=elementControl, moduleBiosDate=moduleBiosDate, moduleSlotNo=moduleSlotNo, controlTrapReceiverEntry=controlTrapReceiverEntry)
