...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, iso, Bits, Unsigned32, Counter64, NotificationType, ObjectIdentity, IpAddress, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "iso", "Bits", "Unsigned32", "Counter64", "NotificationType", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusLidStatus=statusLidStatus, controlTempLimitLo=controlTempLimitLo, moduleMacAddress=moduleMacAddress, sWUpdateControl=sWUpdateControl, controlTrapDelay=controlTrapDelay, statusInternalTemperature=statusInternalTemperature, element=element, statusFan=statusFan, module=module, elementLongitude=elementLongitude, productKeyCipher=productKeyCipher, sWUpdateStatus=sWUpdateStatus, moduleId=moduleId, elementInformation=elementInformation, productKeyIndex=productKeyIndex, moduleStatusTable=moduleStatusTable, moduleAppVersion=moduleAppVersion, elementName=elementName, controlLedUsage=controlLedUsage, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, swUpdateURL=swUpdateURL, statusTemperature=statusTemperature, sizeOfRepairlog=sizeOfRepairlog, statusGeneral=statusGeneral, moduleControlEntry=moduleControlEntry, controlBusMasterAdminState=controlBusMasterAdminState, notebookLineNumber=notebookLineNumber, productKeyNumberOfKeys=productKeyNumberOfKeys, repairDate=repairDate, statusRestartCounter=statusRestartCounter, productKeyFeatureName=productKeyFeatureName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sizeOfNotebook=sizeOfNotebook, notebookLineText=notebookLineText, statusHardware=statusHardware, moduleEntry=moduleEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmOffDelay=controlAlarmOffDelay, controlTempDeadBand=controlTempDeadBand, moduleDetailTable=moduleDetailTable, controlTempLimitLoLo=controlTempLimitLoLo, moduleSizeOfTable=moduleSizeOfTable, regValue=regValue, moduleNotebookTable=moduleNotebookTable, elementStatus=elementStatus, repairReasonCode=repairReasonCode, elementTotalUpTime=elementTotalUpTime, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusBusMaster=statusBusMaster, controlTempLimitHi=controlTempLimitHi, regName=regName, productKeyFeatureEnable=productKeyFeatureEnable, productKeyStatus=productKeyStatus, controlInternalAppAccess=controlInternalAppAccess, repairNameCode=repairNameCode, receiverEntryId=receiverEntryId, moduleAppDate=moduleAppDate, statusResetCause=statusResetCause, moduleSizeOfEntry=moduleSizeOfEntry, elementControl=elementControl, productKeyValue=productKeyValue, repairComment=repairComment, controlReset=controlReset, statusLmt=statusLmt, controlResetElement=controlResetElement, elementProductKey=elementProductKey, moduleStatus=moduleStatus, moduleRackNo=moduleRackNo, moduleRegistryTable=moduleRegistryTable, sizeOfRegistry=sizeOfRegistry, moduleNotebookEntry=moduleNotebookEntry, moduleHwSerialNumber=moduleHwSerialNumber, repairIndex=repairIndex, moduleTable=moduleTable, moduleRepairLogEntry=moduleRepairLogEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosVersion=moduleBiosVersion, regIndex=regIndex, statusSettings=statusSettings, receiverPort=receiverPort, moduleControlTable=moduleControlTable, productKeyFeatureEntry=productKeyFeatureEntry, productKeyTable=productKeyTable, elementLatitude=elementLatitude, controlMarkState=controlMarkState, productKeyEntry=productKeyEntry, moduleRepairLogTable=moduleRepairLogTable, moduleHwVersion=moduleHwVersion, moduleDetailEntry=moduleDetailEntry, statusLid=statusLid, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapInterval=controlTrapInterval, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOnDelay=controlAlarmOnDelay, moduleRegistry=moduleRegistry, elementAltitude=elementAltitude, statusSoftware=statusSoftware, moduleSlotNo=moduleSlotNo, statusRunningSwImage=statusRunningSwImage, controlTrapSending=controlTrapSending, controlTrapLifeTime=controlTrapLifeTime, elementConfigChangeCode=elementConfigChangeCode, controlAlarmDetection=controlAlarmDetection, moduleSWUpdateTable=moduleSWUpdateTable, controlLocalAccess=controlLocalAccess, elementStructure=elementStructure, moduleHwType=moduleHwType, moduleBusAddress=moduleBusAddress, controlTrapReceiverTable=controlTrapReceiverTable, sWUpdateFileName=sWUpdateFileName, moduleInformation=moduleInformation, moduleBiosDate=moduleBiosDate, productKeyMask=productKeyMask, elementResetCount=elementResetCount, productKeyFeatureTable=productKeyFeatureTable, moduleName=moduleName, moduleStatusEntry=moduleStatusEntry, receiverCommunity=receiverCommunity, moduleControl=moduleControl, receiverAddress=receiverAddress, controlTempLimitHiHi=controlTempLimitHiHi)
