...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSoftware=statusSoftware, controlAlarmDetection=controlAlarmDetection, moduleControlTable=moduleControlTable, moduleRegistry=moduleRegistry, statusResetCause=statusResetCause, receiverAddress=receiverAddress, controlReset=controlReset, regValue=regValue, repairComment=repairComment, elementInformation=elementInformation, moduleRegistryTable=moduleRegistryTable, moduleBusAddress=moduleBusAddress, controlAlarmOnDelay=controlAlarmOnDelay, statusRunningSwImage=statusRunningSwImage, moduleRackNo=moduleRackNo, moduleBiosVersion=moduleBiosVersion, controlTempLimitLoLo=controlTempLimitLoLo, controlMarkState=controlMarkState, sizeOfNotebook=sizeOfNotebook, sWUpdateFileName=sWUpdateFileName, statusFan=statusFan, statusLid=statusLid, productKeyFeatureEnable=productKeyFeatureEnable, moduleHwVersion=moduleHwVersion, elementProductKey=elementProductKey, elementName=elementName, controlTempDeadBand=controlTempDeadBand, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureIndex=productKeyFeatureIndex, swUpdateURL=swUpdateURL, regName=regName, repairDate=repairDate, productKeyMask=productKeyMask, moduleBiosDate=moduleBiosDate, notebookLineText=notebookLineText, elementLatitude=elementLatitude, controlTempLimitLo=controlTempLimitLo, moduleName=moduleName, sizeOfRepairlog=sizeOfRepairlog, productKeyNumberOfFeatures=productKeyNumberOfFeatures, regIndex=regIndex, moduleInformation=moduleInformation, controlTrapSending=controlTrapSending, controlTrapLifeTime=controlTrapLifeTime, moduleStatus=moduleStatus, statusRestartCounter=statusRestartCounter, moduleId=moduleId, moduleSizeOfEntry=moduleSizeOfEntry, elementConfigChangeCode=elementConfigChangeCode, controlResetElement=controlResetElement, receiverEntryId=receiverEntryId, module=module, statusInternalTemperature=statusInternalTemperature, moduleNotebookTable=moduleNotebookTable, moduleRegistryEntry=moduleRegistryEntry, elementTotalUpTime=elementTotalUpTime, moduleRepairLogTable=moduleRepairLogTable, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureEntry=productKeyFeatureEntry, moduleTable=moduleTable, productKeyFeatureName=productKeyFeatureName, statusTemperature=statusTemperature, productKeyStatus=productKeyStatus, controlAlarmOffDelay=controlAlarmOffDelay, statusHardware=statusHardware, sWUpdateStatus=sWUpdateStatus, sWUpdateControl=sWUpdateControl, productKeyFeatureTable=productKeyFeatureTable, receiverCommunity=receiverCommunity, moduleControlEntry=moduleControlEntry, statusBusMaster=statusBusMaster, elementResetCount=elementResetCount, moduleNotebookEntry=moduleNotebookEntry, elementStructure=elementStructure, repairReasonCode=repairReasonCode, controlTrapDelay=controlTrapDelay, controlTempLimitHiHi=controlTempLimitHiHi, controlLocalAccess=controlLocalAccess, repairIndex=repairIndex, sizeOfRegistry=sizeOfRegistry, controlBusMasterAdminState=controlBusMasterAdminState, statusLmt=statusLmt, moduleDetailEntry=moduleDetailEntry, statusGeneral=statusGeneral, productKeyEntry=productKeyEntry, moduleDetailTable=moduleDetailTable, moduleMacAddress=moduleMacAddress, elementLongitude=elementLongitude, statusLidStatus=statusLidStatus, controlTrapReceiverTable=controlTrapReceiverTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleEntry=moduleEntry, moduleAppDate=moduleAppDate, moduleStatusEntry=moduleStatusEntry, productKeyCipher=productKeyCipher, controlTrapReceiverEntry=controlTrapReceiverEntry, elementStatus=elementStatus, productKeyValue=productKeyValue, element=element, moduleHwType=moduleHwType, receiverPort=receiverPort, productKeyTable=productKeyTable, moduleSlotNo=moduleSlotNo, statusSettings=statusSettings, elementAltitude=elementAltitude, elementControl=elementControl, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyIndex=productKeyIndex, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfTable=moduleSizeOfTable, moduleAppVersion=moduleAppVersion, controlLedUsage=controlLedUsage, moduleStatusTable=moduleStatusTable, controlTempLimitHi=controlTempLimitHi, controlInternalAppAccess=controlInternalAppAccess, notebookLineNumber=notebookLineNumber, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleControl=moduleControl, repairNameCode=repairNameCode, controlTrapInterval=controlTrapInterval)
