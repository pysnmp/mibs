...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits, MibIdentifier, Integer32, Counter64, Unsigned32, ObjectIdentity, IpAddress, Counter32, NotificationType, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits", "MibIdentifier", "Integer32", "Counter64", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter32", "NotificationType", "iso", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", swUpdateURL=swUpdateURL, controlTrapSending=controlTrapSending, sizeOfNotebook=sizeOfNotebook, productKeyIndex=productKeyIndex, moduleStatusEntry=moduleStatusEntry, elementStatus=elementStatus, sWUpdateStatus=sWUpdateStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, elementTotalUpTime=elementTotalUpTime, productKeyFeatureName=productKeyFeatureName, statusRestartCounter=statusRestartCounter, moduleStatus=moduleStatus, elementLongitude=elementLongitude, repairIndex=repairIndex, controlLocalAccess=controlLocalAccess, controlResetElement=controlResetElement, controlTrapInterval=controlTrapInterval, controlAlarmOffDelay=controlAlarmOffDelay, moduleNotebookTable=moduleNotebookTable, moduleDetailEntry=moduleDetailEntry, moduleNotebookEntry=moduleNotebookEntry, controlTempDeadBand=controlTempDeadBand, moduleInformation=moduleInformation, statusBusMaster=statusBusMaster, moduleHwSerialNumber=moduleHwSerialNumber, statusLid=statusLid, moduleRegistryTable=moduleRegistryTable, receiverAddress=receiverAddress, statusResetCause=statusResetCause, productKeyValue=productKeyValue, moduleSlotNo=moduleSlotNo, controlTempLimitLo=controlTempLimitLo, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistry=moduleRegistry, repairNameCode=repairNameCode, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogEntry=moduleRepairLogEntry, elementControl=elementControl, element=element, statusGeneral=statusGeneral, receiverPort=receiverPort, elementProductKey=elementProductKey, controlAlarmDetection=controlAlarmDetection, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSettings=statusSettings, moduleSWUpdateTable=moduleSWUpdateTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, regValue=regValue, moduleControl=moduleControl, moduleStatusTable=moduleStatusTable, productKeyCipher=productKeyCipher, moduleHwType=moduleHwType, moduleSizeOfTable=moduleSizeOfTable, module=module, sizeOfRepairlog=sizeOfRepairlog, notebookLineNumber=notebookLineNumber, moduleDetailTable=moduleDetailTable, statusRunningSwImage=statusRunningSwImage, repairComment=repairComment, moduleRepairLogTable=moduleRepairLogTable, controlTrapReceiverTable=controlTrapReceiverTable, sWUpdateControl=sWUpdateControl, productKeyStatus=productKeyStatus, moduleAppVersion=moduleAppVersion, moduleBusAddress=moduleBusAddress, elementResetCount=elementResetCount, receiverCommunity=receiverCommunity, moduleControlEntry=moduleControlEntry, controlBusMasterAdminState=controlBusMasterAdminState, productKeyNumberOfKeys=productKeyNumberOfKeys, controlAlarmOnDelay=controlAlarmOnDelay, controlMarkState=controlMarkState, sWUpdateFileName=sWUpdateFileName, productKeyTable=productKeyTable, moduleMacAddress=moduleMacAddress, moduleName=moduleName, receiverEntryId=receiverEntryId, statusHardware=statusHardware, statusLidStatus=statusLidStatus, moduleControlTable=moduleControlTable, elementLatitude=elementLatitude, statusLmt=statusLmt, controlTempLimitLoLo=controlTempLimitLoLo, moduleHwVersion=moduleHwVersion, controlTempLimitHiHi=controlTempLimitHiHi, repairDate=repairDate, moduleRackNo=moduleRackNo, elementAltitude=elementAltitude, productKeyMask=productKeyMask, controlTrapDelay=controlTrapDelay, elementName=elementName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusInternalTemperature=statusInternalTemperature, moduleBiosVersion=moduleBiosVersion, controlLedUsage=controlLedUsage, regName=regName, productKeyFeatureTable=productKeyFeatureTable, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitHi=controlTempLimitHi, moduleEntry=moduleEntry, controlInternalAppAccess=controlInternalAppAccess, repairReasonCode=repairReasonCode, productKeyFeatureEntry=productKeyFeatureEntry, elementConfigChangeCode=elementConfigChangeCode, moduleRegistryEntry=moduleRegistryEntry, moduleBiosDate=moduleBiosDate, notebookLineText=notebookLineText, controlReset=controlReset, statusTemperature=statusTemperature, elementStructure=elementStructure, elementInformation=elementInformation, sizeOfRegistry=sizeOfRegistry, productKeyEntry=productKeyEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleTable=moduleTable, statusFan=statusFan, statusSoftware=statusSoftware, moduleAppDate=moduleAppDate, regIndex=regIndex, moduleId=moduleId, productKeyFeatureIndex=productKeyFeatureIndex)
