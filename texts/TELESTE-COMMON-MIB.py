...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sizeOfNotebook=sizeOfNotebook, receiverEntryId=receiverEntryId, moduleStatus=moduleStatus, moduleBusAddress=moduleBusAddress, statusResetCause=statusResetCause, sWUpdateFileName=sWUpdateFileName, moduleHwVersion=moduleHwVersion, statusRunningSwImage=statusRunningSwImage, controlTempDeadBand=controlTempDeadBand, elementLatitude=elementLatitude, controlTrapReceiverTable=controlTrapReceiverTable, receiverPort=receiverPort, controlTrapLifeTime=controlTrapLifeTime, regName=regName, moduleId=moduleId, productKeyTable=productKeyTable, controlLedUsage=controlLedUsage, moduleRackNo=moduleRackNo, controlInternalAppAccess=controlInternalAppAccess, statusBusMaster=statusBusMaster, statusSettings=statusSettings, moduleDetailEntry=moduleDetailEntry, notebookLineText=notebookLineText, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleName=moduleName, controlLocalAccess=controlLocalAccess, statusLid=statusLid, receiverCommunity=receiverCommunity, controlTempLimitHi=controlTempLimitHi, repairDate=repairDate, repairReasonCode=repairReasonCode, controlMarkState=controlMarkState, elementStructure=elementStructure, moduleBiosVersion=moduleBiosVersion, moduleRegistry=moduleRegistry, controlTrapSending=controlTrapSending, productKeyMask=productKeyMask, moduleSWUpdateTable=moduleSWUpdateTable, repairIndex=repairIndex, elementTotalUpTime=elementTotalUpTime, moduleSizeOfEntry=moduleSizeOfEntry, productKeyValue=productKeyValue, productKeyFeatureEnable=productKeyFeatureEnable, moduleSizeOfTable=moduleSizeOfTable, elementLongitude=elementLongitude, elementAltitude=elementAltitude, controlAlarmOnDelay=controlAlarmOnDelay, moduleTable=moduleTable, statusRestartCounter=statusRestartCounter, moduleControlTable=moduleControlTable, sizeOfRepairlog=sizeOfRepairlog, moduleStatusEntry=moduleStatusEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyStatus=productKeyStatus, sWUpdateStatus=sWUpdateStatus, repairNameCode=repairNameCode, moduleControl=moduleControl, elementResetCount=elementResetCount, productKeyEntry=productKeyEntry, controlTrapDelay=controlTrapDelay, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleMacAddress=moduleMacAddress, statusTemperature=statusTemperature, repairComment=repairComment, sWUpdateControl=sWUpdateControl, productKeyCipher=productKeyCipher, elementControl=elementControl, controlAlarmOffDelay=controlAlarmOffDelay, elementName=elementName, sizeOfRegistry=sizeOfRegistry, controlTempLimitLo=controlTempLimitLo, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapInterval=controlTrapInterval, moduleBiosDate=moduleBiosDate, notebookLineNumber=notebookLineNumber, element=element, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRepairLogEntry=moduleRepairLogEntry, statusFan=statusFan, statusSoftware=statusSoftware, productKeyIndex=productKeyIndex, swUpdateURL=swUpdateURL, moduleNotebookTable=moduleNotebookTable, productKeyFeatureTable=productKeyFeatureTable, moduleHwType=moduleHwType, moduleSWUpdateEntry=moduleSWUpdateEntry, regValue=regValue, elementStatus=elementStatus, productKeyFeatureEntry=productKeyFeatureEntry, moduleStatusTable=moduleStatusTable, module=module, statusInternalTemperature=statusInternalTemperature, elementProductKey=elementProductKey, moduleSlotNo=moduleSlotNo, elementConfigChangeCode=elementConfigChangeCode, statusLmt=statusLmt, moduleDetailTable=moduleDetailTable, moduleAppVersion=moduleAppVersion, controlReset=controlReset, productKeyFeatureIndex=productKeyFeatureIndex, moduleAppDate=moduleAppDate, receiverAddress=receiverAddress, productKeyFeatureName=productKeyFeatureName, moduleRegistryTable=moduleRegistryTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusGeneral=statusGeneral, statusLidStatus=statusLidStatus, controlResetElement=controlResetElement, elementInformation=elementInformation, moduleInformation=moduleInformation, moduleNotebookEntry=moduleNotebookEntry, moduleRepairLogTable=moduleRepairLogTable, moduleRegistryEntry=moduleRegistryEntry, regIndex=regIndex, moduleEntry=moduleEntry, statusHardware=statusHardware, controlTempLimitHiHi=controlTempLimitHiHi, controlAlarmDetection=controlAlarmDetection, controlTempLimitLoLo=controlTempLimitLoLo, moduleControlEntry=moduleControlEntry, moduleHwSerialNumber=moduleHwSerialNumber)
