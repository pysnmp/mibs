...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, iso, ObjectIdentity, Bits, Unsigned32, Gauge32, TimeTicks, Integer32, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "iso", "ObjectIdentity", "Bits", "Unsigned32", "Gauge32", "TimeTicks", "Integer32", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleTable=moduleTable, moduleRackNo=moduleRackNo, repairNameCode=repairNameCode, elementResetCount=elementResetCount, controlTempLimitLoLo=controlTempLimitLoLo, notebookLineNumber=notebookLineNumber, productKeyTable=productKeyTable, productKeyIndex=productKeyIndex, statusRunningSwImage=statusRunningSwImage, productKeyMask=productKeyMask, moduleControlEntry=moduleControlEntry, moduleAppVersion=moduleAppVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapReceiverTable=controlTrapReceiverTable, elementAltitude=elementAltitude, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, controlBusMasterAdminState=controlBusMasterAdminState, statusInternalTemperature=statusInternalTemperature, productKeyValue=productKeyValue, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, receiverEntryId=receiverEntryId, controlMarkState=controlMarkState, moduleNotebookTable=moduleNotebookTable, productKeyFeatureIndex=productKeyFeatureIndex, swUpdateURL=swUpdateURL, productKeyStatus=productKeyStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusBusMaster=statusBusMaster, sWUpdateFileName=sWUpdateFileName, elementInformation=elementInformation, moduleStatusTable=moduleStatusTable, controlTempLimitHi=controlTempLimitHi, moduleEntry=moduleEntry, productKeyFeatureTable=productKeyFeatureTable, moduleControl=moduleControl, statusLidStatus=statusLidStatus, elementTotalUpTime=elementTotalUpTime, sWUpdateControl=sWUpdateControl, moduleHwType=moduleHwType, receiverCommunity=receiverCommunity, controlLedUsage=controlLedUsage, moduleNotebookEntry=moduleNotebookEntry, statusRestartCounter=statusRestartCounter, controlTrapDelay=controlTrapDelay, moduleBusAddress=moduleBusAddress, statusTemperature=statusTemperature, controlTrapInterval=controlTrapInterval, moduleHwVersion=moduleHwVersion, productKeyFeatureName=productKeyFeatureName, regIndex=regIndex, repairIndex=repairIndex, elementStructure=elementStructure, sWUpdateStatus=sWUpdateStatus, module=module, moduleSWUpdateTable=moduleSWUpdateTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlAlarmOnDelay=controlAlarmOnDelay, statusSoftware=statusSoftware, moduleDetailEntry=moduleDetailEntry, controlLocalAccess=controlLocalAccess, statusHardware=statusHardware, repairReasonCode=repairReasonCode, elementName=elementName, statusLmt=statusLmt, statusSettings=statusSettings, productKeyEntry=productKeyEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleSizeOfTable=moduleSizeOfTable, moduleDetailTable=moduleDetailTable, productKeyFeatureEntry=productKeyFeatureEntry, moduleStatusEntry=moduleStatusEntry, moduleBiosVersion=moduleBiosVersion, regValue=regValue, repairComment=repairComment, elementStatus=elementStatus, elementControl=elementControl, moduleInformation=moduleInformation, controlTrapLifeTime=controlTrapLifeTime, moduleHwSerialNumber=moduleHwSerialNumber, statusLid=statusLid, moduleRegistry=moduleRegistry, controlTempDeadBand=controlTempDeadBand, moduleMacAddress=moduleMacAddress, productKeyCipher=productKeyCipher, moduleRegistryEntry=moduleRegistryEntry, moduleSizeOfEntry=moduleSizeOfEntry, moduleStatus=moduleStatus, sizeOfRepairlog=sizeOfRepairlog, notebookLineText=notebookLineText, sizeOfNotebook=sizeOfNotebook, statusFan=statusFan, controlTempLimitLo=controlTempLimitLo, moduleRegistryTable=moduleRegistryTable, regName=regName, statusGeneral=statusGeneral, controlAlarmDetection=controlAlarmDetection, moduleAppDate=moduleAppDate, receiverPort=receiverPort, moduleBiosDate=moduleBiosDate, controlTempLimitHiHi=controlTempLimitHiHi, controlReset=controlReset, controlInternalAppAccess=controlInternalAppAccess, elementProductKey=elementProductKey, elementLongitude=elementLongitude, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogTable=moduleRepairLogTable, repairDate=repairDate, controlTrapSending=controlTrapSending, elementConfigChangeCode=elementConfigChangeCode, elementLatitude=elementLatitude, moduleControlTable=moduleControlTable, sizeOfRegistry=sizeOfRegistry, moduleId=moduleId, moduleRepairLogEntry=moduleRepairLogEntry, statusResetCause=statusResetCause, moduleName=moduleName, element=element, controlResetElement=controlResetElement, receiverAddress=receiverAddress)
