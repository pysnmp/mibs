...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity, iso, Unsigned32, Counter32, Integer32, ModuleIdentity, NotificationType, MibIdentifier, Bits, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity", "iso", "Unsigned32", "Counter32", "Integer32", "ModuleIdentity", "NotificationType", "MibIdentifier", "Bits", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlBusMasterAdminState=controlBusMasterAdminState, controlTempLimitHiHi=controlTempLimitHiHi, notebookLineText=notebookLineText, controlTempDeadBand=controlTempDeadBand, regName=regName, repairComment=repairComment, productKeyFeatureTable=productKeyFeatureTable, productKeyTable=productKeyTable, moduleControl=moduleControl, statusTemperature=statusTemperature, moduleRegistry=moduleRegistry, elementConfigChangeCode=elementConfigChangeCode, elementName=elementName, repairIndex=repairIndex, regIndex=regIndex, module=module, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmDetection=controlAlarmDetection, productKeyFeatureName=productKeyFeatureName, moduleHwVersion=moduleHwVersion, controlResetElement=controlResetElement, controlMarkState=controlMarkState, moduleControlEntry=moduleControlEntry, statusFan=statusFan, moduleDetailTable=moduleDetailTable, moduleId=moduleId, statusResetCause=statusResetCause, notebookLineNumber=notebookLineNumber, productKeyEntry=productKeyEntry, productKeyFeatureEntry=productKeyFeatureEntry, sWUpdateFileName=sWUpdateFileName, moduleMacAddress=moduleMacAddress, moduleStatus=moduleStatus, elementTotalUpTime=elementTotalUpTime, moduleRepairLogTable=moduleRepairLogTable, moduleHwType=moduleHwType, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleAppDate=moduleAppDate, controlAlarmOffDelay=controlAlarmOffDelay, elementInformation=elementInformation, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleNotebookEntry=moduleNotebookEntry, receiverEntryId=receiverEntryId, moduleControlTable=moduleControlTable, controlTrapReceiverTable=controlTrapReceiverTable, productKeyMask=productKeyMask, productKeyIndex=productKeyIndex, moduleInformation=moduleInformation, controlTrapLifeTime=controlTrapLifeTime, moduleBusAddress=moduleBusAddress, elementLatitude=elementLatitude, controlAlarmOnDelay=controlAlarmOnDelay, statusGeneral=statusGeneral, controlInternalAppAccess=controlInternalAppAccess, elementStatus=elementStatus, element=element, controlLocalAccess=controlLocalAccess, receiverPort=receiverPort, statusHardware=statusHardware, elementProductKey=elementProductKey, regValue=regValue, repairReasonCode=repairReasonCode, elementLongitude=elementLongitude, moduleBiosVersion=moduleBiosVersion, swUpdateURL=swUpdateURL, moduleSWUpdateTable=moduleSWUpdateTable, repairNameCode=repairNameCode, elementAltitude=elementAltitude, controlTempLimitHi=controlTempLimitHi, controlReset=controlReset, moduleRepairLogEntry=moduleRepairLogEntry, statusLmt=statusLmt, statusSoftware=statusSoftware, moduleSizeOfEntry=moduleSizeOfEntry, sWUpdateStatus=sWUpdateStatus, moduleRegistryEntry=moduleRegistryEntry, statusRunningSwImage=statusRunningSwImage, moduleRegistryTable=moduleRegistryTable, moduleEntry=moduleEntry, moduleAppVersion=moduleAppVersion, moduleTable=moduleTable, moduleBiosDate=moduleBiosDate, sizeOfRegistry=sizeOfRegistry, productKeyValue=productKeyValue, sWUpdateControl=sWUpdateControl, controlTrapInterval=controlTrapInterval, moduleSizeOfTable=moduleSizeOfTable, moduleSlotNo=moduleSlotNo, sizeOfNotebook=sizeOfNotebook, moduleNotebookTable=moduleNotebookTable, statusLid=statusLid, controlLedUsage=controlLedUsage, moduleHwSerialNumber=moduleHwSerialNumber, controlTrapDelay=controlTrapDelay, statusBusMaster=statusBusMaster, elementControl=elementControl, statusInternalTemperature=statusInternalTemperature, statusLidStatus=statusLidStatus, controlTempLimitLo=controlTempLimitLo, statusRestartCounter=statusRestartCounter, statusSettings=statusSettings, repairDate=repairDate, moduleRackNo=moduleRackNo, controlTempLimitLoLo=controlTempLimitLoLo, productKeyStatus=productKeyStatus, moduleName=moduleName, productKeyFeatureEnable=productKeyFeatureEnable, productKeyNumberOfKeys=productKeyNumberOfKeys, sizeOfRepairlog=sizeOfRepairlog, controlTrapSending=controlTrapSending, moduleStatusEntry=moduleStatusEntry, moduleDetailEntry=moduleDetailEntry, receiverAddress=receiverAddress, productKeyCipher=productKeyCipher, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSWUpdateEntry=moduleSWUpdateEntry, elementResetCount=elementResetCount, productKeyFeatureIndex=productKeyFeatureIndex, elementStructure=elementStructure, receiverCommunity=receiverCommunity, moduleStatusTable=moduleStatusTable)
