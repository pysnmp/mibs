...
iso, ObjectIdentity, Gauge32, Integer32, IpAddress, Bits, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, TimeTicks, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Gauge32", "Integer32", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureTable=productKeyFeatureTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairReasonCode=repairReasonCode, statusSoftware=statusSoftware, moduleName=moduleName, statusResetCause=statusResetCause, repairDate=repairDate, controlLedUsage=controlLedUsage, sizeOfRepairlog=sizeOfRepairlog, moduleSizeOfEntry=moduleSizeOfEntry, elementStatus=elementStatus, controlTrapLifeTime=controlTrapLifeTime, sWUpdateFileName=sWUpdateFileName, elementLatitude=elementLatitude, moduleRackNo=moduleRackNo, controlTempLimitLoLo=controlTempLimitLoLo, moduleNotebookTable=moduleNotebookTable, repairIndex=repairIndex, statusRunningSwImage=statusRunningSwImage, statusFan=statusFan, controlTrapReceiverTable=controlTrapReceiverTable, elementName=elementName, moduleStatusEntry=moduleStatusEntry, notebookLineNumber=notebookLineNumber, controlReset=controlReset, elementAltitude=elementAltitude, statusInternalTemperature=statusInternalTemperature, productKeyFeatureIndex=productKeyFeatureIndex, repairComment=repairComment, moduleControlTable=moduleControlTable, moduleInformation=moduleInformation, elementLongitude=elementLongitude, productKeyCipher=productKeyCipher, productKeyTable=productKeyTable, sizeOfRegistry=sizeOfRegistry, controlAlarmOnDelay=controlAlarmOnDelay, controlTempLimitHi=controlTempLimitHi, receiverEntryId=receiverEntryId, moduleBiosDate=moduleBiosDate, moduleHwType=moduleHwType, receiverCommunity=receiverCommunity, elementResetCount=elementResetCount, productKeyFeatureName=productKeyFeatureName, moduleDetailTable=moduleDetailTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sWUpdateControl=sWUpdateControl, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleAppVersion=moduleAppVersion, repairNameCode=repairNameCode, moduleStatus=moduleStatus, controlTrapInterval=controlTrapInterval, statusLmt=statusLmt, controlTrapDelay=controlTrapDelay, moduleTable=moduleTable, controlInternalAppAccess=controlInternalAppAccess, statusHardware=statusHardware, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureEntry=productKeyFeatureEntry, swUpdateURL=swUpdateURL, elementProductKey=elementProductKey, regValue=regValue, moduleRegistryTable=moduleRegistryTable, moduleMacAddress=moduleMacAddress, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleHwVersion=moduleHwVersion, sizeOfNotebook=sizeOfNotebook, statusLid=statusLid, statusRestartCounter=statusRestartCounter, moduleEntry=moduleEntry, moduleRegistry=moduleRegistry, elementStructure=elementStructure, moduleControlEntry=moduleControlEntry, receiverAddress=receiverAddress, regIndex=regIndex, elementConfigChangeCode=elementConfigChangeCode, elementInformation=elementInformation, controlTempLimitLo=controlTempLimitLo, moduleStatusTable=moduleStatusTable, productKeyEntry=productKeyEntry, productKeyMask=productKeyMask, moduleDetailEntry=moduleDetailEntry, controlResetElement=controlResetElement, controlTrapSending=controlTrapSending, regName=regName, receiverPort=receiverPort, moduleSizeOfTable=moduleSizeOfTable, statusGeneral=statusGeneral, elementTotalUpTime=elementTotalUpTime, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleControl=moduleControl, statusSettings=statusSettings, moduleRegistryEntry=moduleRegistryEntry, productKeyValue=productKeyValue, element=element, moduleBusAddress=moduleBusAddress, moduleAppDate=moduleAppDate, moduleSlotNo=moduleSlotNo, statusTemperature=statusTemperature, controlAlarmOffDelay=controlAlarmOffDelay, moduleBiosVersion=moduleBiosVersion, notebookLineText=notebookLineText, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleHwSerialNumber=moduleHwSerialNumber, moduleNotebookEntry=moduleNotebookEntry, moduleId=moduleId, productKeyFeatureEnable=productKeyFeatureEnable, sWUpdateStatus=sWUpdateStatus, productKeyIndex=productKeyIndex, module=module, moduleRepairLogEntry=moduleRepairLogEntry, controlAlarmDetection=controlAlarmDetection, controlLocalAccess=controlLocalAccess, statusBusMaster=statusBusMaster, controlBusMasterAdminState=controlBusMasterAdminState, elementControl=elementControl, controlMarkState=controlMarkState, statusLidStatus=statusLidStatus, moduleRepairLogTable=moduleRepairLogTable, controlTempDeadBand=controlTempDeadBand, productKeyStatus=productKeyStatus)
