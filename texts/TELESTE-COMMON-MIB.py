...
TimeTicks, Counter32, Counter64, Integer32, Unsigned32, NotificationType, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Counter64", "Integer32", "Unsigned32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "Gauge32", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOffDelay=controlAlarmOffDelay, moduleHwSerialNumber=moduleHwSerialNumber, controlTempLimitLo=controlTempLimitLo, repairReasonCode=repairReasonCode, moduleDetailTable=moduleDetailTable, productKeyStatus=productKeyStatus, productKeyMask=productKeyMask, receiverPort=receiverPort, moduleBiosDate=moduleBiosDate, statusTemperature=statusTemperature, moduleSizeOfTable=moduleSizeOfTable, notebookLineNumber=notebookLineNumber, elementStatus=elementStatus, moduleTable=moduleTable, controlMarkState=controlMarkState, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistryTable=moduleRegistryTable, controlBusMasterAdminState=controlBusMasterAdminState, moduleSlotNo=moduleSlotNo, controlResetElement=controlResetElement, repairDate=repairDate, regName=regName, moduleStatusEntry=moduleStatusEntry, productKeyFeatureTable=productKeyFeatureTable, moduleControlTable=moduleControlTable, moduleRackNo=moduleRackNo, moduleDetailEntry=moduleDetailEntry, statusHardware=statusHardware, sizeOfRepairlog=sizeOfRepairlog, controlTrapSending=controlTrapSending, productKeyFeatureName=productKeyFeatureName, module=module, controlTrapLifeTime=controlTrapLifeTime, statusLid=statusLid, moduleSWUpdateTable=moduleSWUpdateTable, notebookLineText=notebookLineText, controlReset=controlReset, elementTotalUpTime=elementTotalUpTime, statusBusMaster=statusBusMaster, receiverAddress=receiverAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sWUpdateControl=sWUpdateControl, controlTempLimitHiHi=controlTempLimitHiHi, elementName=elementName, sizeOfRegistry=sizeOfRegistry, moduleRegistry=moduleRegistry, elementConfigChangeCode=elementConfigChangeCode, controlAlarmOnDelay=controlAlarmOnDelay, moduleSizeOfEntry=moduleSizeOfEntry, productKeyTable=productKeyTable, controlTrapReceiverEntry=controlTrapReceiverEntry, statusLidStatus=statusLidStatus, statusRunningSwImage=statusRunningSwImage, repairNameCode=repairNameCode, productKeyIndex=productKeyIndex, moduleStatus=moduleStatus, sWUpdateFileName=sWUpdateFileName, statusSoftware=statusSoftware, moduleBusAddress=moduleBusAddress, moduleEntry=moduleEntry, moduleHwType=moduleHwType, moduleControlEntry=moduleControlEntry, regValue=regValue, productKeyEntry=productKeyEntry, statusInternalTemperature=statusInternalTemperature, controlLocalAccess=controlLocalAccess, sizeOfNotebook=sizeOfNotebook, moduleMacAddress=moduleMacAddress, moduleHwVersion=moduleHwVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, repairComment=repairComment, moduleControl=moduleControl, productKeyCipher=productKeyCipher, moduleRepairLogEntry=moduleRepairLogEntry, moduleName=moduleName, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitHi=controlTempLimitHi, moduleAppVersion=moduleAppVersion, elementInformation=elementInformation, statusFan=statusFan, controlTrapDelay=controlTrapDelay, controlTrapInterval=controlTrapInterval, moduleRegistryEntry=moduleRegistryEntry, moduleRepairLogTable=moduleRepairLogTable, statusResetCause=statusResetCause, repairIndex=repairIndex, regIndex=regIndex, statusGeneral=statusGeneral, moduleInformation=moduleInformation, element=element, moduleNotebookEntry=moduleNotebookEntry, statusRestartCounter=statusRestartCounter, moduleId=moduleId, controlLedUsage=controlLedUsage, receiverEntryId=receiverEntryId, receiverCommunity=receiverCommunity, moduleNotebookTable=moduleNotebookTable, sWUpdateStatus=sWUpdateStatus, elementResetCount=elementResetCount, controlTempDeadBand=controlTempDeadBand, elementAltitude=elementAltitude, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureIndex=productKeyFeatureIndex, swUpdateURL=swUpdateURL, elementLatitude=elementLatitude, productKeyFeatureEntry=productKeyFeatureEntry, statusLmt=statusLmt, elementLongitude=elementLongitude, statusSettings=statusSettings, moduleStatusTable=moduleStatusTable, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmDetection=controlAlarmDetection, elementStructure=elementStructure, elementProductKey=elementProductKey, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlInternalAppAccess=controlInternalAppAccess, controlTrapReceiverTable=controlTrapReceiverTable, productKeyValue=productKeyValue, moduleBiosVersion=moduleBiosVersion, elementControl=elementControl, moduleAppDate=moduleAppDate)
