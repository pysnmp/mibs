...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairComment=repairComment, moduleRackNo=moduleRackNo, notebookLineNumber=notebookLineNumber, sWUpdateStatus=sWUpdateStatus, controlTempLimitLoLo=controlTempLimitLoLo, moduleRepairLogTable=moduleRepairLogTable, statusLidStatus=statusLidStatus, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, moduleBiosDate=moduleBiosDate, moduleName=moduleName, sizeOfNotebook=sizeOfNotebook, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusLid=statusLid, moduleHwVersion=moduleHwVersion, moduleMacAddress=moduleMacAddress, moduleTable=moduleTable, statusResetCause=statusResetCause, productKeyFeatureIndex=productKeyFeatureIndex, repairNameCode=repairNameCode, productKeyIndex=productKeyIndex, moduleAppDate=moduleAppDate, controlBusMasterAdminState=controlBusMasterAdminState, elementAltitude=elementAltitude, statusHardware=statusHardware, controlTempDeadBand=controlTempDeadBand, elementInformation=elementInformation, sizeOfRepairlog=sizeOfRepairlog, elementConfigChangeCode=elementConfigChangeCode, moduleRegistryTable=moduleRegistryTable, productKeyValue=productKeyValue, controlAlarmOnDelay=controlAlarmOnDelay, receiverPort=receiverPort, receiverAddress=receiverAddress, regValue=regValue, controlTempLimitHi=controlTempLimitHi, controlTrapDelay=controlTrapDelay, elementProductKey=elementProductKey, repairDate=repairDate, controlTrapReceiverTable=controlTrapReceiverTable, moduleControlTable=moduleControlTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleEntry=moduleEntry, moduleSizeOfEntry=moduleSizeOfEntry, statusInternalTemperature=statusInternalTemperature, statusLmt=statusLmt, receiverEntryId=receiverEntryId, moduleRepairLogEntry=moduleRepairLogEntry, controlMarkState=controlMarkState, statusSoftware=statusSoftware, statusRestartCounter=statusRestartCounter, productKeyStatus=productKeyStatus, productKeyFeatureTable=productKeyFeatureTable, moduleStatus=moduleStatus, controlTrapSending=controlTrapSending, statusGeneral=statusGeneral, receiverCommunity=receiverCommunity, moduleDetailEntry=moduleDetailEntry, moduleRegistryEntry=moduleRegistryEntry, moduleDetailTable=moduleDetailTable, productKeyFeatureEntry=productKeyFeatureEntry, elementName=elementName, productKeyFeatureName=productKeyFeatureName, regIndex=regIndex, statusBusMaster=statusBusMaster, sWUpdateFileName=sWUpdateFileName, element=element, sWUpdateControl=sWUpdateControl, controlAlarmDetection=controlAlarmDetection, notebookLineText=notebookLineText, controlInternalAppAccess=controlInternalAppAccess, repairReasonCode=repairReasonCode, controlTrapLifeTime=controlTrapLifeTime, module=module, elementControl=elementControl, controlReset=controlReset, elementLongitude=elementLongitude, moduleSizeOfTable=moduleSizeOfTable, moduleNotebookTable=moduleNotebookTable, elementStructure=elementStructure, controlAlarmOffDelay=controlAlarmOffDelay, productKeyMask=productKeyMask, moduleBusAddress=moduleBusAddress, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, statusRunningSwImage=statusRunningSwImage, controlTrapInterval=controlTrapInterval, moduleStatusTable=moduleStatusTable, controlLocalAccess=controlLocalAccess, regName=regName, statusSettings=statusSettings, moduleHwSerialNumber=moduleHwSerialNumber, swUpdateURL=swUpdateURL, controlTempLimitHiHi=controlTempLimitHiHi, productKeyEntry=productKeyEntry, moduleSWUpdateTable=moduleSWUpdateTable, statusFan=statusFan, moduleStatusEntry=moduleStatusEntry, moduleControl=moduleControl, statusTemperature=statusTemperature, sizeOfRegistry=sizeOfRegistry, elementTotalUpTime=elementTotalUpTime, elementResetCount=elementResetCount, moduleControlEntry=moduleControlEntry, controlResetElement=controlResetElement, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementLatitude=elementLatitude, elementStatus=elementStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleBiosVersion=moduleBiosVersion, moduleHwType=moduleHwType, moduleNotebookEntry=moduleNotebookEntry, moduleAppVersion=moduleAppVersion, moduleInformation=moduleInformation, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitLo=controlTempLimitLo, repairIndex=repairIndex, productKeyTable=productKeyTable, moduleId=moduleId, moduleRegistry=moduleRegistry, productKeyCipher=productKeyCipher)
