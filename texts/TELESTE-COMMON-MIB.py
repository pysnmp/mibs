...
MibIdentifier, ModuleIdentity, TimeTicks, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Integer32, Bits, IpAddress, ObjectIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Integer32", "Bits", "IpAddress", "ObjectIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusRestartCounter=statusRestartCounter, moduleSizeOfEntry=moduleSizeOfEntry, elementAltitude=elementAltitude, moduleSlotNo=moduleSlotNo, productKeyIndex=productKeyIndex, controlTrapInterval=controlTrapInterval, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleBusAddress=moduleBusAddress, sizeOfRegistry=sizeOfRegistry, statusTemperature=statusTemperature, moduleSizeOfTable=moduleSizeOfTable, statusRunningSwImage=statusRunningSwImage, moduleHwType=moduleHwType, elementLatitude=elementLatitude, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatusEntry=moduleStatusEntry, sizeOfNotebook=sizeOfNotebook, receiverCommunity=receiverCommunity, statusInternalTemperature=statusInternalTemperature, notebookLineText=notebookLineText, moduleRegistryTable=moduleRegistryTable, productKeyValue=productKeyValue, moduleAppDate=moduleAppDate, moduleHwVersion=moduleHwVersion, moduleControlEntry=moduleControlEntry, repairIndex=repairIndex, controlTempLimitHi=controlTempLimitHi, regValue=regValue, moduleDetailTable=moduleDetailTable, moduleBiosDate=moduleBiosDate, controlLedUsage=controlLedUsage, statusLmt=statusLmt, notebookLineNumber=notebookLineNumber, moduleRackNo=moduleRackNo, element=element, elementName=elementName, controlAlarmDetection=controlAlarmDetection, controlTempLimitHiHi=controlTempLimitHiHi, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitLo=controlTempLimitLo, statusLidStatus=statusLidStatus, sizeOfRepairlog=sizeOfRepairlog, repairComment=repairComment, moduleRepairLogTable=moduleRepairLogTable, productKeyMask=productKeyMask, moduleNotebookEntry=moduleNotebookEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureName=productKeyFeatureName, regIndex=regIndex, receiverEntryId=receiverEntryId, statusLid=statusLid, elementLongitude=elementLongitude, controlAlarmOffDelay=controlAlarmOffDelay, elementTotalUpTime=elementTotalUpTime, controlLocalAccess=controlLocalAccess, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogEntry=moduleRepairLogEntry, statusFan=statusFan, regName=regName, controlTrapSending=controlTrapSending, moduleId=moduleId, controlReset=controlReset, productKeyFeatureEnable=productKeyFeatureEnable, productKeyEntry=productKeyEntry, controlTempDeadBand=controlTempDeadBand, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleEntry=moduleEntry, receiverAddress=receiverAddress, statusResetCause=statusResetCause, moduleControlTable=moduleControlTable, sWUpdateStatus=sWUpdateStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateFileName=sWUpdateFileName, moduleInformation=moduleInformation, elementConfigChangeCode=elementConfigChangeCode, elementInformation=elementInformation, sWUpdateControl=sWUpdateControl, controlTrapDelay=controlTrapDelay, moduleNotebookTable=moduleNotebookTable, module=module, statusBusMaster=statusBusMaster, moduleHwSerialNumber=moduleHwSerialNumber, statusHardware=statusHardware, repairReasonCode=repairReasonCode, elementProductKey=elementProductKey, controlTempLimitLoLo=controlTempLimitLoLo, moduleControl=moduleControl, moduleName=moduleName, controlResetElement=controlResetElement, moduleRegistry=moduleRegistry, elementControl=elementControl, productKeyCipher=productKeyCipher, moduleRegistryEntry=moduleRegistryEntry, elementResetCount=elementResetCount, moduleMacAddress=moduleMacAddress, controlTrapLifeTime=controlTrapLifeTime, moduleStatus=moduleStatus, controlMarkState=controlMarkState, repairDate=repairDate, productKeyFeatureEntry=productKeyFeatureEntry, statusSettings=statusSettings, statusSoftware=statusSoftware, moduleDetailEntry=moduleDetailEntry, elementStatus=elementStatus, productKeyTable=productKeyTable, receiverPort=receiverPort, moduleStatusTable=moduleStatusTable, moduleAppVersion=moduleAppVersion, elementStructure=elementStructure, productKeyStatus=productKeyStatus, controlBusMasterAdminState=controlBusMasterAdminState, moduleTable=moduleTable, productKeyFeatureTable=productKeyFeatureTable, repairNameCode=repairNameCode, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosVersion=moduleBiosVersion, controlInternalAppAccess=controlInternalAppAccess, statusGeneral=statusGeneral, swUpdateURL=swUpdateURL)
