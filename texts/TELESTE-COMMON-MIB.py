...
Gauge32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ModuleIdentity, IpAddress, Counter64, MibIdentifier, iso, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "MibIdentifier", "iso", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRegistry=moduleRegistry, controlAlarmOnDelay=controlAlarmOnDelay, moduleBusAddress=moduleBusAddress, elementConfigChangeCode=elementConfigChangeCode, controlReset=controlReset, moduleStatus=moduleStatus, statusResetCause=statusResetCause, controlAlarmDetection=controlAlarmDetection, moduleStatusEntry=moduleStatusEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlInternalAppAccess=controlInternalAppAccess, statusRunningSwImage=statusRunningSwImage, notebookLineText=notebookLineText, moduleRegistryEntry=moduleRegistryEntry, statusLidStatus=statusLidStatus, moduleSlotNo=moduleSlotNo, controlMarkState=controlMarkState, controlTempLimitHiHi=controlTempLimitHiHi, elementControl=elementControl, receiverEntryId=receiverEntryId, sizeOfNotebook=sizeOfNotebook, moduleTable=moduleTable, statusHardware=statusHardware, sizeOfRegistry=sizeOfRegistry, productKeyValue=productKeyValue, productKeyCipher=productKeyCipher, productKeyTable=productKeyTable, receiverCommunity=receiverCommunity, sWUpdateControl=sWUpdateControl, moduleInformation=moduleInformation, controlAlarmOffDelay=controlAlarmOffDelay, regName=regName, moduleMacAddress=moduleMacAddress, moduleControl=moduleControl, moduleDetailTable=moduleDetailTable, elementStatus=elementStatus, moduleId=moduleId, elementResetCount=elementResetCount, moduleHwType=moduleHwType, statusBusMaster=statusBusMaster, statusTemperature=statusTemperature, controlTrapReceiverEntry=controlTrapReceiverEntry, elementLongitude=elementLongitude, moduleRepairLogTable=moduleRepairLogTable, statusLid=statusLid, sizeOfRepairlog=sizeOfRepairlog, elementInformation=elementInformation, moduleHwVersion=moduleHwVersion, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureIndex=productKeyFeatureIndex, controlTrapLifeTime=controlTrapLifeTime, element=element, moduleControlTable=moduleControlTable, moduleHwSerialNumber=moduleHwSerialNumber, moduleAppDate=moduleAppDate, moduleNotebookEntry=moduleNotebookEntry, moduleBiosVersion=moduleBiosVersion, statusFan=statusFan, elementLatitude=elementLatitude, statusInternalTemperature=statusInternalTemperature, moduleRackNo=moduleRackNo, notebookLineNumber=notebookLineNumber, sWUpdateStatus=sWUpdateStatus, moduleEntry=moduleEntry, productKeyIndex=productKeyIndex, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapInterval=controlTrapInterval, controlTrapSending=controlTrapSending, controlTrapDelay=controlTrapDelay, moduleDetailEntry=moduleDetailEntry, controlLocalAccess=controlLocalAccess, elementAltitude=elementAltitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementTotalUpTime=elementTotalUpTime, moduleBiosDate=moduleBiosDate, moduleRegistryTable=moduleRegistryTable, repairNameCode=repairNameCode, productKeyFeatureEnable=productKeyFeatureEnable, controlTempDeadBand=controlTempDeadBand, moduleRepairLogEntry=moduleRepairLogEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverPort=receiverPort, statusSoftware=statusSoftware, controlTrapReceiverTable=controlTrapReceiverTable, moduleNotebookTable=moduleNotebookTable, swUpdateURL=swUpdateURL, elementProductKey=elementProductKey, statusGeneral=statusGeneral, repairReasonCode=repairReasonCode, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, moduleName=moduleName, moduleControlEntry=moduleControlEntry, repairComment=repairComment, statusRestartCounter=statusRestartCounter, controlTempLimitHi=controlTempLimitHi, controlTempLimitLoLo=controlTempLimitLoLo, controlLedUsage=controlLedUsage, productKeyStatus=productKeyStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, repairDate=repairDate, moduleSizeOfEntry=moduleSizeOfEntry, regValue=regValue, receiverAddress=receiverAddress, productKeyFeatureName=productKeyFeatureName, productKeyEntry=productKeyEntry, statusSettings=statusSettings, moduleSizeOfTable=moduleSizeOfTable, regIndex=regIndex, controlTempLimitLo=controlTempLimitLo, controlBusMasterAdminState=controlBusMasterAdminState, module=module, sWUpdateFileName=sWUpdateFileName, elementName=elementName, controlResetElement=controlResetElement, statusLmt=statusLmt, productKeyMask=productKeyMask, moduleStatusTable=moduleStatusTable, repairIndex=repairIndex, moduleAppVersion=moduleAppVersion, productKeyFeatureTable=productKeyFeatureTable)
