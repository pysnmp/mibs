...
ModuleIdentity, iso, Gauge32, Counter32, Bits, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter64, ObjectIdentity, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Gauge32", "Counter32", "Bits", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter64", "ObjectIdentity", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusResetCause=statusResetCause, sizeOfRegistry=sizeOfRegistry, moduleStatusTable=moduleStatusTable, statusFan=statusFan, statusTemperature=statusTemperature, controlTempLimitHi=controlTempLimitHi, productKeyFeatureName=productKeyFeatureName, moduleStatus=moduleStatus, productKeyCipher=productKeyCipher, controlTrapLifeTime=controlTrapLifeTime, moduleRegistryEntry=moduleRegistryEntry, controlMarkState=controlMarkState, statusGeneral=statusGeneral, statusSoftware=statusSoftware, productKeyFeatureIndex=productKeyFeatureIndex, moduleAppDate=moduleAppDate, elementLatitude=elementLatitude, regIndex=regIndex, controlAlarmOffDelay=controlAlarmOffDelay, moduleRepairLogTable=moduleRepairLogTable, elementProductKey=elementProductKey, elementControl=elementControl, controlLedUsage=controlLedUsage, moduleHwType=moduleHwType, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementConfigChangeCode=elementConfigChangeCode, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateTable=moduleSWUpdateTable, elementStatus=elementStatus, productKeyValue=productKeyValue, statusHardware=statusHardware, controlReset=controlReset, statusRunningSwImage=statusRunningSwImage, statusLid=statusLid, elementResetCount=elementResetCount, moduleAppVersion=moduleAppVersion, repairNameCode=repairNameCode, repairIndex=repairIndex, sWUpdateControl=sWUpdateControl, receiverEntryId=receiverEntryId, repairReasonCode=repairReasonCode, moduleId=moduleId, elementTotalUpTime=elementTotalUpTime, productKeyEntry=productKeyEntry, controlBusMasterAdminState=controlBusMasterAdminState, sWUpdateStatus=sWUpdateStatus, moduleControlTable=moduleControlTable, productKeyIndex=productKeyIndex, receiverPort=receiverPort, receiverCommunity=receiverCommunity, moduleInformation=moduleInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, regName=regName, elementName=elementName, productKeyMask=productKeyMask, moduleDetailTable=moduleDetailTable, controlTrapReceiverTable=controlTrapReceiverTable, elementAltitude=elementAltitude, receiverAddress=receiverAddress, sizeOfRepairlog=sizeOfRepairlog, controlTempLimitHiHi=controlTempLimitHiHi, sizeOfNotebook=sizeOfNotebook, moduleSWUpdateEntry=moduleSWUpdateEntry, controlInternalAppAccess=controlInternalAppAccess, notebookLineNumber=notebookLineNumber, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleControl=moduleControl, elementInformation=elementInformation, moduleRepairLogEntry=moduleRepairLogEntry, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapSending=controlTrapSending, controlTempDeadBand=controlTempDeadBand, statusLidStatus=statusLidStatus, controlLocalAccess=controlLocalAccess, productKeyFeatureEnable=productKeyFeatureEnable, controlAlarmDetection=controlAlarmDetection, moduleHwVersion=moduleHwVersion, moduleTable=moduleTable, moduleRegistry=moduleRegistry, moduleBiosVersion=moduleBiosVersion, moduleRegistryTable=moduleRegistryTable, moduleSlotNo=moduleSlotNo, productKeyFeatureTable=productKeyFeatureTable, moduleBusAddress=moduleBusAddress, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleHwSerialNumber=moduleHwSerialNumber, moduleName=moduleName, moduleNotebookEntry=moduleNotebookEntry, moduleBiosDate=moduleBiosDate, module=module, elementLongitude=elementLongitude, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleStatusEntry=moduleStatusEntry, moduleSizeOfEntry=moduleSizeOfEntry, repairDate=repairDate, controlAlarmOnDelay=controlAlarmOnDelay, productKeyTable=productKeyTable, productKeyStatus=productKeyStatus, statusSettings=statusSettings, moduleNotebookTable=moduleNotebookTable, controlTrapInterval=controlTrapInterval, controlResetElement=controlResetElement, moduleRackNo=moduleRackNo, controlTrapDelay=controlTrapDelay, statusRestartCounter=statusRestartCounter, statusBusMaster=statusBusMaster, sWUpdateFileName=sWUpdateFileName, controlTempLimitLo=controlTempLimitLo, element=element, moduleMacAddress=moduleMacAddress, repairComment=repairComment, notebookLineText=notebookLineText, moduleEntry=moduleEntry, moduleDetailEntry=moduleDetailEntry, moduleSizeOfTable=moduleSizeOfTable, statusLmt=statusLmt, regValue=regValue, swUpdateURL=swUpdateURL, controlTempLimitLoLo=controlTempLimitLoLo, moduleControlEntry=moduleControlEntry)
