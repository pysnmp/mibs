...
MibIdentifier, iso, Unsigned32, Integer32, Bits, TimeTicks, NotificationType, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Unsigned32", "Integer32", "Bits", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRackNo=moduleRackNo, elementInformation=elementInformation, controlTrapSending=controlTrapSending, productKeyEntry=productKeyEntry, moduleSWUpdateTable=moduleSWUpdateTable, elementResetCount=elementResetCount, elementConfigChangeCode=elementConfigChangeCode, controlTempLimitLoLo=controlTempLimitLoLo, statusSoftware=statusSoftware, productKeyMask=productKeyMask, controlReset=controlReset, regIndex=regIndex, moduleRegistryEntry=moduleRegistryEntry, controlInternalAppAccess=controlInternalAppAccess, regValue=regValue, moduleSizeOfEntry=moduleSizeOfEntry, moduleAppVersion=moduleAppVersion, moduleNotebookTable=moduleNotebookTable, moduleControlEntry=moduleControlEntry, element=element, productKeyCipher=productKeyCipher, elementLongitude=elementLongitude, productKeyFeatureTable=productKeyFeatureTable, repairIndex=repairIndex, statusTemperature=statusTemperature, repairNameCode=repairNameCode, controlAlarmOnDelay=controlAlarmOnDelay, controlResetElement=controlResetElement, statusRestartCounter=statusRestartCounter, statusBusMaster=statusBusMaster, sWUpdateStatus=sWUpdateStatus, moduleBusAddress=moduleBusAddress, statusGeneral=statusGeneral, moduleRegistry=moduleRegistry, receiverAddress=receiverAddress, elementControl=elementControl, moduleMacAddress=moduleMacAddress, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapInterval=controlTrapInterval, moduleInformation=moduleInformation, moduleId=moduleId, controlTrapReceiverTable=controlTrapReceiverTable, moduleHwSerialNumber=moduleHwSerialNumber, moduleControl=moduleControl, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleRepairLogTable=moduleRepairLogTable, productKeyNumberOfKeys=productKeyNumberOfKeys, elementTotalUpTime=elementTotalUpTime, moduleDetailEntry=moduleDetailEntry, controlAlarmOffDelay=controlAlarmOffDelay, controlTempLimitHiHi=controlTempLimitHiHi, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureEntry=productKeyFeatureEntry, moduleBiosDate=moduleBiosDate, repairReasonCode=repairReasonCode, controlTempLimitHi=controlTempLimitHi, notebookLineNumber=notebookLineNumber, notebookLineText=notebookLineText, controlAlarmDetection=controlAlarmDetection, repairComment=repairComment, moduleControlTable=moduleControlTable, moduleStatus=moduleStatus, controlTrapDelay=controlTrapDelay, statusSettings=statusSettings, controlTempLimitLo=controlTempLimitLo, controlLedUsage=controlLedUsage, receiverPort=receiverPort, sizeOfRegistry=sizeOfRegistry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleBiosVersion=moduleBiosVersion, moduleRegistryTable=moduleRegistryTable, productKeyTable=productKeyTable, productKeyValue=productKeyValue, module=module, moduleAppDate=moduleAppDate, repairDate=repairDate, moduleEntry=moduleEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleStatusTable=moduleStatusTable, elementName=elementName, moduleSizeOfTable=moduleSizeOfTable, elementStatus=elementStatus, moduleName=moduleName, statusFan=statusFan, elementStructure=elementStructure, productKeyStatus=productKeyStatus, statusResetCause=statusResetCause, controlMarkState=controlMarkState, controlTempDeadBand=controlTempDeadBand, moduleStatusEntry=moduleStatusEntry, statusHardware=statusHardware, moduleRepairLogEntry=moduleRepairLogEntry, statusLmt=statusLmt, moduleHwVersion=moduleHwVersion, elementProductKey=elementProductKey, sWUpdateControl=sWUpdateControl, elementLatitude=elementLatitude, statusLid=statusLid, receiverEntryId=receiverEntryId, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleDetailTable=moduleDetailTable, moduleTable=moduleTable, swUpdateURL=swUpdateURL, elementAltitude=elementAltitude, moduleNotebookEntry=moduleNotebookEntry, moduleSlotNo=moduleSlotNo, moduleHwType=moduleHwType, regName=regName, receiverCommunity=receiverCommunity, productKeyFeatureIndex=productKeyFeatureIndex, controlTrapLifeTime=controlTrapLifeTime, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureName=productKeyFeatureName, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusLidStatus=statusLidStatus, sWUpdateFileName=sWUpdateFileName, controlLocalAccess=controlLocalAccess, statusRunningSwImage=statusRunningSwImage, productKeyIndex=productKeyIndex, sizeOfNotebook=sizeOfNotebook)
