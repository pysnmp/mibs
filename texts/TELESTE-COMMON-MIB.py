...
Bits, Counter64, MibIdentifier, TimeTicks, iso, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "iso", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlReset=controlReset, moduleSWUpdateTable=moduleSWUpdateTable, moduleSizeOfTable=moduleSizeOfTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyTable=productKeyTable, statusFan=statusFan, moduleMacAddress=moduleMacAddress, moduleControlEntry=moduleControlEntry, receiverPort=receiverPort, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRepairLogTable=moduleRepairLogTable, statusRunningSwImage=statusRunningSwImage, regName=regName, moduleHwVersion=moduleHwVersion, moduleControl=moduleControl, statusLid=statusLid, receiverEntryId=receiverEntryId, moduleBiosVersion=moduleBiosVersion, elementTotalUpTime=elementTotalUpTime, moduleRegistryTable=moduleRegistryTable, statusLmt=statusLmt, moduleNotebookTable=moduleNotebookTable, moduleDetailEntry=moduleDetailEntry, receiverCommunity=receiverCommunity, moduleDetailTable=moduleDetailTable, moduleBiosDate=moduleBiosDate, productKeyMask=productKeyMask, statusInternalTemperature=statusInternalTemperature, regValue=regValue, moduleRegistryEntry=moduleRegistryEntry, repairNameCode=repairNameCode, controlTrapDelay=controlTrapDelay, statusRestartCounter=statusRestartCounter, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSWUpdateEntry=moduleSWUpdateEntry, swUpdateURL=swUpdateURL, controlTempLimitHiHi=controlTempLimitHiHi, productKeyIndex=productKeyIndex, elementConfigChangeCode=elementConfigChangeCode, productKeyValue=productKeyValue, moduleBusAddress=moduleBusAddress, repairComment=repairComment, elementProductKey=elementProductKey, controlTempDeadBand=controlTempDeadBand, moduleStatus=moduleStatus, moduleNotebookEntry=moduleNotebookEntry, statusTemperature=statusTemperature, productKeyFeatureTable=productKeyFeatureTable, moduleHwSerialNumber=moduleHwSerialNumber, controlLedUsage=controlLedUsage, controlTempLimitLoLo=controlTempLimitLoLo, controlAlarmOffDelay=controlAlarmOffDelay, productKeyStatus=productKeyStatus, controlInternalAppAccess=controlInternalAppAccess, repairIndex=repairIndex, regIndex=regIndex, moduleSlotNo=moduleSlotNo, statusSettings=statusSettings, elementName=elementName, moduleName=moduleName, controlMarkState=controlMarkState, elementControl=elementControl, statusHardware=statusHardware, productKeyFeatureEnable=productKeyFeatureEnable, sWUpdateFileName=sWUpdateFileName, sWUpdateStatus=sWUpdateStatus, moduleRegistry=moduleRegistry, elementStatus=elementStatus, controlLocalAccess=controlLocalAccess, productKeyCipher=productKeyCipher, moduleAppDate=moduleAppDate, statusResetCause=statusResetCause, statusGeneral=statusGeneral, elementLatitude=elementLatitude, moduleInformation=moduleInformation, moduleRepairLogEntry=moduleRepairLogEntry, moduleStatusTable=moduleStatusTable, elementLongitude=elementLongitude, moduleControlTable=moduleControlTable, moduleEntry=moduleEntry, moduleHwType=moduleHwType, moduleId=moduleId, moduleAppVersion=moduleAppVersion, controlTrapReceiverTable=controlTrapReceiverTable, module=module, elementInformation=elementInformation, productKeyFeatureIndex=productKeyFeatureIndex, moduleTable=moduleTable, elementResetCount=elementResetCount, controlAlarmOnDelay=controlAlarmOnDelay, notebookLineNumber=notebookLineNumber, controlTrapLifeTime=controlTrapLifeTime, controlResetElement=controlResetElement, elementAltitude=elementAltitude, moduleRackNo=moduleRackNo, productKeyFeatureName=productKeyFeatureName, statusBusMaster=statusBusMaster, elementStructure=elementStructure, moduleStatusEntry=moduleStatusEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfRepairlog=sizeOfRepairlog, element=element, controlTrapInterval=controlTrapInterval, controlTempLimitHi=controlTempLimitHi, repairDate=repairDate, repairReasonCode=repairReasonCode, controlTrapSending=controlTrapSending, controlAlarmDetection=controlAlarmDetection, productKeyNumberOfKeys=productKeyNumberOfKeys, sizeOfRegistry=sizeOfRegistry, statusSoftware=statusSoftware, notebookLineText=notebookLineText, productKeyFeatureEntry=productKeyFeatureEntry, sizeOfNotebook=sizeOfNotebook, sWUpdateControl=sWUpdateControl, controlTempLimitLo=controlTempLimitLo, statusLidStatus=statusLidStatus, productKeyEntry=productKeyEntry, moduleSizeOfEntry=moduleSizeOfEntry, receiverAddress=receiverAddress)
