...
Bits, ObjectIdentity, TimeTicks, IpAddress, iso, Counter32, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Gauge32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "TimeTicks", "IpAddress", "iso", "Counter32", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Gauge32", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairDate=repairDate, moduleRegistry=moduleRegistry, productKeyMask=productKeyMask, notebookLineNumber=notebookLineNumber, moduleSlotNo=moduleSlotNo, moduleStatusEntry=moduleStatusEntry, productKeyCipher=productKeyCipher, moduleNotebookEntry=moduleNotebookEntry, controlLedUsage=controlLedUsage, controlTrapLifeTime=controlTrapLifeTime, elementProductKey=elementProductKey, regName=regName, moduleHwVersion=moduleHwVersion, receiverPort=receiverPort, controlTrapInterval=controlTrapInterval, element=element, moduleSizeOfTable=moduleSizeOfTable, elementResetCount=elementResetCount, moduleControl=moduleControl, moduleControlEntry=moduleControlEntry, productKeyEntry=productKeyEntry, moduleDetailTable=moduleDetailTable, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapSending=controlTrapSending, productKeyFeatureTable=productKeyFeatureTable, statusBusMaster=statusBusMaster, moduleHwSerialNumber=moduleHwSerialNumber, statusSettings=statusSettings, controlTempLimitHi=controlTempLimitHi, regValue=regValue, receiverAddress=receiverAddress, elementLongitude=elementLongitude, moduleNotebookTable=moduleNotebookTable, elementControl=elementControl, notebookLineText=notebookLineText, moduleSWUpdateTable=moduleSWUpdateTable, moduleHwType=moduleHwType, elementName=elementName, productKeyFeatureEnable=productKeyFeatureEnable, moduleMacAddress=moduleMacAddress, controlTempLimitHiHi=controlTempLimitHiHi, controlAlarmOnDelay=controlAlarmOnDelay, controlInternalAppAccess=controlInternalAppAccess, moduleDetailEntry=moduleDetailEntry, sizeOfNotebook=sizeOfNotebook, moduleStatusTable=moduleStatusTable, productKeyNumberOfKeys=productKeyNumberOfKeys, statusLmt=statusLmt, repairIndex=repairIndex, controlResetElement=controlResetElement, moduleAppVersion=moduleAppVersion, elementInformation=elementInformation, moduleSizeOfEntry=moduleSizeOfEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleRegistryTable=moduleRegistryTable, moduleBusAddress=moduleBusAddress, controlTrapReceiverEntry=controlTrapReceiverEntry, statusGeneral=statusGeneral, productKeyValue=productKeyValue, moduleEntry=moduleEntry, controlMarkState=controlMarkState, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTempLimitLo=controlTempLimitLo, controlTempLimitLoLo=controlTempLimitLoLo, repairComment=repairComment, elementAltitude=elementAltitude, moduleControlTable=moduleControlTable, controlAlarmOffDelay=controlAlarmOffDelay, productKeyTable=productKeyTable, sWUpdateFileName=sWUpdateFileName, moduleBiosDate=moduleBiosDate, moduleRepairLogTable=moduleRepairLogTable, statusTemperature=statusTemperature, controlLocalAccess=controlLocalAccess, productKeyFeatureName=productKeyFeatureName, statusInternalTemperature=statusInternalTemperature, elementLatitude=elementLatitude, statusResetCause=statusResetCause, sWUpdateStatus=sWUpdateStatus, controlTrapReceiverTable=controlTrapReceiverTable, moduleInformation=moduleInformation, elementStructure=elementStructure, controlTempDeadBand=controlTempDeadBand, receiverCommunity=receiverCommunity, elementConfigChangeCode=elementConfigChangeCode, repairReasonCode=repairReasonCode, repairNameCode=repairNameCode, controlAlarmDetection=controlAlarmDetection, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, module=module, productKeyIndex=productKeyIndex, statusFan=statusFan, statusLid=statusLid, controlBusMasterAdminState=controlBusMasterAdminState, moduleName=moduleName, swUpdateURL=swUpdateURL, sWUpdateControl=sWUpdateControl, controlReset=controlReset, statusLidStatus=statusLidStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementTotalUpTime=elementTotalUpTime, statusSoftware=statusSoftware, moduleStatus=moduleStatus, moduleBiosVersion=moduleBiosVersion, statusRunningSwImage=statusRunningSwImage, receiverEntryId=receiverEntryId, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEntry=productKeyFeatureEntry, statusHardware=statusHardware, moduleId=moduleId, moduleRackNo=moduleRackNo, sizeOfRegistry=sizeOfRegistry, productKeyStatus=productKeyStatus, productKeyFeatureIndex=productKeyFeatureIndex, moduleTable=moduleTable, statusRestartCounter=statusRestartCounter, regIndex=regIndex, moduleAppDate=moduleAppDate, controlTrapDelay=controlTrapDelay, elementStatus=elementStatus)
