...
ObjectIdentity, IpAddress, NotificationType, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, iso, ModuleIdentity, Unsigned32, Bits, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "NotificationType", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "iso", "ModuleIdentity", "Unsigned32", "Bits", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusTemperature=statusTemperature, productKeyFeatureEntry=productKeyFeatureEntry, elementName=elementName, receiverPort=receiverPort, moduleAppVersion=moduleAppVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlAlarmOffDelay=controlAlarmOffDelay, repairNameCode=repairNameCode, elementProductKey=elementProductKey, productKeyFeatureName=productKeyFeatureName, statusFan=statusFan, productKeyEntry=productKeyEntry, moduleEntry=moduleEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleDetailEntry=moduleDetailEntry, controlTrapLifeTime=controlTrapLifeTime, moduleControlEntry=moduleControlEntry, statusRunningSwImage=statusRunningSwImage, module=module, moduleSlotNo=moduleSlotNo, repairIndex=repairIndex, receiverAddress=receiverAddress, productKeyFeatureEnable=productKeyFeatureEnable, elementResetCount=elementResetCount, sWUpdateFileName=sWUpdateFileName, elementInformation=elementInformation, repairComment=repairComment, moduleHwVersion=moduleHwVersion, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusSettings=statusSettings, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapInterval=controlTrapInterval, moduleStatusTable=moduleStatusTable, moduleRegistryEntry=moduleRegistryEntry, notebookLineText=notebookLineText, controlTempDeadBand=controlTempDeadBand, sizeOfRepairlog=sizeOfRepairlog, statusInternalTemperature=statusInternalTemperature, controlLedUsage=controlLedUsage, controlBusMasterAdminState=controlBusMasterAdminState, regIndex=regIndex, elementControl=elementControl, moduleBusAddress=moduleBusAddress, moduleHwSerialNumber=moduleHwSerialNumber, statusResetCause=statusResetCause, sizeOfRegistry=sizeOfRegistry, moduleName=moduleName, statusGeneral=statusGeneral, moduleHwType=moduleHwType, moduleMacAddress=moduleMacAddress, receiverCommunity=receiverCommunity, regValue=regValue, controlResetElement=controlResetElement, regName=regName, sizeOfNotebook=sizeOfNotebook, moduleStatus=moduleStatus, statusLmt=statusLmt, receiverEntryId=receiverEntryId, statusLidStatus=statusLidStatus, statusSoftware=statusSoftware, moduleControl=moduleControl, moduleNotebookTable=moduleNotebookTable, moduleSizeOfTable=moduleSizeOfTable, moduleTable=moduleTable, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapReceiverTable=controlTrapReceiverTable, moduleSizeOfEntry=moduleSizeOfEntry, moduleInformation=moduleInformation, controlTempLimitLoLo=controlTempLimitLoLo, repairDate=repairDate, elementAltitude=elementAltitude, controlTrapDelay=controlTrapDelay, swUpdateURL=swUpdateURL, sWUpdateStatus=sWUpdateStatus, elementLatitude=elementLatitude, productKeyFeatureIndex=productKeyFeatureIndex, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleDetailTable=moduleDetailTable, notebookLineNumber=notebookLineNumber, productKeyTable=productKeyTable, elementStatus=elementStatus, elementStructure=elementStructure, moduleId=moduleId, moduleAppDate=moduleAppDate, controlMarkState=controlMarkState, moduleRepairLogTable=moduleRepairLogTable, statusRestartCounter=statusRestartCounter, controlReset=controlReset, elementTotalUpTime=elementTotalUpTime, productKeyFeatureTable=productKeyFeatureTable, moduleRegistry=moduleRegistry, moduleRegistryTable=moduleRegistryTable, statusHardware=statusHardware, statusLid=statusLid, controlTempLimitLo=controlTempLimitLo, productKeyIndex=productKeyIndex, elementConfigChangeCode=elementConfigChangeCode, element=element, controlTrapSending=controlTrapSending, controlTempLimitHi=controlTempLimitHi, statusBusMaster=statusBusMaster, moduleStatusEntry=moduleStatusEntry, productKeyStatus=productKeyStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, elementLongitude=elementLongitude, moduleControlTable=moduleControlTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTempLimitHiHi=controlTempLimitHiHi, moduleNotebookEntry=moduleNotebookEntry, productKeyValue=productKeyValue, productKeyCipher=productKeyCipher, repairReasonCode=repairReasonCode, sWUpdateControl=sWUpdateControl, controlAlarmOnDelay=controlAlarmOnDelay, controlLocalAccess=controlLocalAccess, controlInternalAppAccess=controlInternalAppAccess, productKeyMask=productKeyMask, moduleBiosVersion=moduleBiosVersion, moduleRackNo=moduleRackNo, controlAlarmDetection=controlAlarmDetection, moduleBiosDate=moduleBiosDate)
