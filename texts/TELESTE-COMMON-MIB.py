...
ModuleIdentity, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, MibIdentifier, iso, Counter32, Counter64, TimeTicks, NotificationType, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "MibIdentifier", "iso", "Counter32", "Counter64", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusInternalTemperature=statusInternalTemperature, controlTrapReceiverEntry=controlTrapReceiverEntry, statusSoftware=statusSoftware, statusLidStatus=statusLidStatus, moduleSizeOfEntry=moduleSizeOfEntry, moduleSlotNo=moduleSlotNo, productKeyValue=productKeyValue, productKeyIndex=productKeyIndex, moduleRegistry=moduleRegistry, receiverAddress=receiverAddress, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleHwType=moduleHwType, moduleSWUpdateTable=moduleSWUpdateTable, statusRestartCounter=statusRestartCounter, sizeOfRegistry=sizeOfRegistry, productKeyTable=productKeyTable, notebookLineNumber=notebookLineNumber, controlTempDeadBand=controlTempDeadBand, moduleStatus=moduleStatus, productKeyEntry=productKeyEntry, controlTempLimitLo=controlTempLimitLo, moduleDetailTable=moduleDetailTable, moduleHwSerialNumber=moduleHwSerialNumber, controlLocalAccess=controlLocalAccess, sWUpdateControl=sWUpdateControl, regName=regName, elementStructure=elementStructure, moduleControlTable=moduleControlTable, moduleNotebookEntry=moduleNotebookEntry, statusLmt=statusLmt, moduleEntry=moduleEntry, module=module, elementResetCount=elementResetCount, moduleStatusEntry=moduleStatusEntry, moduleRackNo=moduleRackNo, statusLid=statusLid, receiverCommunity=receiverCommunity, statusTemperature=statusTemperature, elementTotalUpTime=elementTotalUpTime, controlResetElement=controlResetElement, repairNameCode=repairNameCode, controlBusMasterAdminState=controlBusMasterAdminState, moduleHwVersion=moduleHwVersion, repairComment=repairComment, moduleNotebookTable=moduleNotebookTable, moduleSizeOfTable=moduleSizeOfTable, statusBusMaster=statusBusMaster, controlTempLimitLoLo=controlTempLimitLoLo, moduleRegistryTable=moduleRegistryTable, sizeOfNotebook=sizeOfNotebook, moduleTable=moduleTable, moduleControlEntry=moduleControlEntry, productKeyFeatureEnable=productKeyFeatureEnable, productKeyFeatureTable=productKeyFeatureTable, controlTrapSending=controlTrapSending, elementLongitude=elementLongitude, moduleAppDate=moduleAppDate, elementProductKey=elementProductKey, controlAlarmDetection=controlAlarmDetection, controlLedUsage=controlLedUsage, moduleMacAddress=moduleMacAddress, sWUpdateFileName=sWUpdateFileName, moduleId=moduleId, statusGeneral=statusGeneral, sWUpdateStatus=sWUpdateStatus, productKeyCipher=productKeyCipher, controlTrapInterval=controlTrapInterval, elementLatitude=elementLatitude, moduleRepairLogTable=moduleRepairLogTable, controlAlarmOnDelay=controlAlarmOnDelay, moduleRegistryEntry=moduleRegistryEntry, controlTempLimitHiHi=controlTempLimitHiHi, controlMarkState=controlMarkState, controlReset=controlReset, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverEntryId=receiverEntryId, moduleInformation=moduleInformation, controlTrapDelay=controlTrapDelay, regIndex=regIndex, repairDate=repairDate, moduleDetailEntry=moduleDetailEntry, statusResetCause=statusResetCause, elementConfigChangeCode=elementConfigChangeCode, controlTrapLifeTime=controlTrapLifeTime, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleStatusTable=moduleStatusTable, controlInternalAppAccess=controlInternalAppAccess, controlTrapReceiverTable=controlTrapReceiverTable, element=element, repairReasonCode=repairReasonCode, controlAlarmOffDelay=controlAlarmOffDelay, statusRunningSwImage=statusRunningSwImage, sizeOfRepairlog=sizeOfRepairlog, elementName=elementName, productKeyNumberOfKeys=productKeyNumberOfKeys, swUpdateURL=swUpdateURL, elementControl=elementControl, moduleRepairLogEntry=moduleRepairLogEntry, moduleBusAddress=moduleBusAddress, notebookLineText=notebookLineText, elementStatus=elementStatus, moduleBiosDate=moduleBiosDate, controlTempLimitHi=controlTempLimitHi, moduleName=moduleName, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyMask=productKeyMask, receiverPort=receiverPort, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, moduleAppVersion=moduleAppVersion, productKeyFeatureName=productKeyFeatureName, regValue=regValue, productKeyFeatureIndex=productKeyFeatureIndex, elementAltitude=elementAltitude, repairIndex=repairIndex, statusHardware=statusHardware, productKeyFeatureEntry=productKeyFeatureEntry, moduleControl=moduleControl, statusSettings=statusSettings, elementInformation=elementInformation, statusFan=statusFan)
