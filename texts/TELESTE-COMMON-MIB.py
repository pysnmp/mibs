...
IpAddress, iso, Integer32, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ModuleIdentity, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Integer32", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ModuleIdentity", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusLid=statusLid, notebookLineText=notebookLineText, regValue=regValue, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleId=moduleId, productKeyFeatureTable=productKeyFeatureTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleMacAddress=moduleMacAddress, productKeyMask=productKeyMask, statusLmt=statusLmt, notebookLineNumber=notebookLineNumber, moduleInformation=moduleInformation, statusRestartCounter=statusRestartCounter, elementConfigChangeCode=elementConfigChangeCode, controlTrapInterval=controlTrapInterval, controlTrapReceiverEntry=controlTrapReceiverEntry, elementStatus=elementStatus, controlTempDeadBand=controlTempDeadBand, productKeyFeatureEntry=productKeyFeatureEntry, controlMarkState=controlMarkState, sWUpdateStatus=sWUpdateStatus, receiverEntryId=receiverEntryId, module=module, regName=regName, productKeyCipher=productKeyCipher, statusSettings=statusSettings, repairIndex=repairIndex, moduleDetailTable=moduleDetailTable, productKeyFeatureEnable=productKeyFeatureEnable, elementStructure=elementStructure, receiverAddress=receiverAddress, moduleDetailEntry=moduleDetailEntry, moduleStatusEntry=moduleStatusEntry, moduleAppDate=moduleAppDate, controlTempLimitLo=controlTempLimitLo, controlTempLimitHiHi=controlTempLimitHiHi, controlInternalAppAccess=controlInternalAppAccess, repairComment=repairComment, sizeOfRepairlog=sizeOfRepairlog, moduleRegistryTable=moduleRegistryTable, statusSoftware=statusSoftware, controlTrapReceiverTable=controlTrapReceiverTable, elementName=elementName, controlTrapSending=controlTrapSending, moduleHwSerialNumber=moduleHwSerialNumber, productKeyEntry=productKeyEntry, moduleBiosDate=moduleBiosDate, moduleSizeOfTable=moduleSizeOfTable, statusTemperature=statusTemperature, moduleSWUpdateEntry=moduleSWUpdateEntry, elementInformation=elementInformation, sizeOfRegistry=sizeOfRegistry, repairNameCode=repairNameCode, moduleName=moduleName, moduleRackNo=moduleRackNo, productKeyNumberOfKeys=productKeyNumberOfKeys, elementProductKey=elementProductKey, controlTrapDelay=controlTrapDelay, moduleHwType=moduleHwType, controlLedUsage=controlLedUsage, sWUpdateFileName=sWUpdateFileName, moduleStatus=moduleStatus, repairReasonCode=repairReasonCode, moduleBiosVersion=moduleBiosVersion, swUpdateURL=swUpdateURL, receiverCommunity=receiverCommunity, moduleAppVersion=moduleAppVersion, sizeOfNotebook=sizeOfNotebook, regIndex=regIndex, repairDate=repairDate, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryEntry=moduleRegistryEntry, moduleSlotNo=moduleSlotNo, productKeyTable=productKeyTable, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapLifeTime=controlTrapLifeTime, statusHardware=statusHardware, moduleEntry=moduleEntry, statusRunningSwImage=statusRunningSwImage, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusInternalTemperature=statusInternalTemperature, receiverPort=receiverPort, elementAltitude=elementAltitude, controlAlarmDetection=controlAlarmDetection, moduleControlEntry=moduleControlEntry, statusResetCause=statusResetCause, controlTempLimitLoLo=controlTempLimitLoLo, controlLocalAccess=controlLocalAccess, statusFan=statusFan, moduleControlTable=moduleControlTable, elementControl=elementControl, controlTempLimitHi=controlTempLimitHi, statusBusMaster=statusBusMaster, controlBusMasterAdminState=controlBusMasterAdminState, elementTotalUpTime=elementTotalUpTime, productKeyIndex=productKeyIndex, productKeyFeatureIndex=productKeyFeatureIndex, moduleStatusTable=moduleStatusTable, moduleSWUpdateTable=moduleSWUpdateTable, productKeyStatus=productKeyStatus, moduleTable=moduleTable, moduleRegistry=moduleRegistry, sWUpdateControl=sWUpdateControl, controlResetElement=controlResetElement, controlReset=controlReset, moduleRepairLogTable=moduleRepairLogTable, statusGeneral=statusGeneral, controlAlarmOnDelay=controlAlarmOnDelay, moduleNotebookTable=moduleNotebookTable, elementLatitude=elementLatitude, elementResetCount=elementResetCount, moduleBusAddress=moduleBusAddress, productKeyFeatureName=productKeyFeatureName, moduleControl=moduleControl, elementLongitude=elementLongitude, moduleNotebookEntry=moduleNotebookEntry, moduleHwVersion=moduleHwVersion, statusLidStatus=statusLidStatus, productKeyValue=productKeyValue, moduleSizeOfEntry=moduleSizeOfEntry, element=element)
