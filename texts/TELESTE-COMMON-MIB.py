...
Counter32, Unsigned32, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ObjectIdentity, iso, ModuleIdentity, Counter64, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ObjectIdentity", "iso", "ModuleIdentity", "Counter64", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementStatus=elementStatus, statusLmt=statusLmt, moduleRegistryEntry=moduleRegistryEntry, elementName=elementName, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitHi=controlTempLimitHi, moduleSWUpdateTable=moduleSWUpdateTable, moduleAppVersion=moduleAppVersion, productKeyFeatureEntry=productKeyFeatureEntry, controlReset=controlReset, repairReasonCode=repairReasonCode, notebookLineNumber=notebookLineNumber, receiverEntryId=receiverEntryId, moduleStatus=moduleStatus, sWUpdateFileName=sWUpdateFileName, controlAlarmDetection=controlAlarmDetection, elementStructure=elementStructure, controlMarkState=controlMarkState, controlBusMasterAdminState=controlBusMasterAdminState, repairDate=repairDate, statusLidStatus=statusLidStatus, productKeyValue=productKeyValue, repairNameCode=repairNameCode, moduleBusAddress=moduleBusAddress, controlAlarmOffDelay=controlAlarmOffDelay, controlLocalAccess=controlLocalAccess, elementConfigChangeCode=elementConfigChangeCode, controlResetElement=controlResetElement, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleRepairLogTable=moduleRepairLogTable, elementResetCount=elementResetCount, moduleMacAddress=moduleMacAddress, controlTrapDelay=controlTrapDelay, swUpdateURL=swUpdateURL, moduleDetailTable=moduleDetailTable, sWUpdateControl=sWUpdateControl, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusTemperature=statusTemperature, controlTempDeadBand=controlTempDeadBand, productKeyIndex=productKeyIndex, productKeyFeatureName=productKeyFeatureName, elementAltitude=elementAltitude, moduleHwVersion=moduleHwVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSizeOfEntry=moduleSizeOfEntry, moduleStatusTable=moduleStatusTable, moduleStatusEntry=moduleStatusEntry, moduleRegistry=moduleRegistry, moduleHwType=moduleHwType, statusInternalTemperature=statusInternalTemperature, sizeOfNotebook=sizeOfNotebook, element=element, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBiosDate=moduleBiosDate, receiverAddress=receiverAddress, moduleDetailEntry=moduleDetailEntry, regIndex=regIndex, moduleBiosVersion=moduleBiosVersion, productKeyMask=productKeyMask, moduleTable=moduleTable, moduleName=moduleName, sizeOfRepairlog=sizeOfRepairlog, productKeyCipher=productKeyCipher, productKeyFeatureIndex=productKeyFeatureIndex, productKeyEntry=productKeyEntry, controlAlarmOnDelay=controlAlarmOnDelay, statusFan=statusFan, statusRunningSwImage=statusRunningSwImage, controlTempLimitLoLo=controlTempLimitLoLo, regValue=regValue, moduleControl=moduleControl, statusHardware=statusHardware, statusSoftware=statusSoftware, elementLongitude=elementLongitude, elementControl=elementControl, moduleRackNo=moduleRackNo, moduleControlEntry=moduleControlEntry, sizeOfRegistry=sizeOfRegistry, productKeyStatus=productKeyStatus, statusBusMaster=statusBusMaster, regName=regName, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistryTable=moduleRegistryTable, productKeyFeatureTable=productKeyFeatureTable, moduleRepairLogEntry=moduleRepairLogEntry, repairComment=repairComment, controlLedUsage=controlLedUsage, statusGeneral=statusGeneral, receiverCommunity=receiverCommunity, elementInformation=elementInformation, controlTrapInterval=controlTrapInterval, productKeyTable=productKeyTable, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureEnable=productKeyFeatureEnable, moduleControlTable=moduleControlTable, moduleEntry=moduleEntry, moduleInformation=moduleInformation, receiverPort=receiverPort, statusSettings=statusSettings, elementLatitude=elementLatitude, elementProductKey=elementProductKey, sWUpdateStatus=sWUpdateStatus, repairIndex=repairIndex, moduleAppDate=moduleAppDate, statusRestartCounter=statusRestartCounter, moduleNotebookEntry=moduleNotebookEntry, controlTrapLifeTime=controlTrapLifeTime, moduleId=moduleId, controlTempLimitHiHi=controlTempLimitHiHi, moduleSlotNo=moduleSlotNo, controlTempLimitLo=controlTempLimitLo, statusResetCause=statusResetCause, module=module, moduleNotebookTable=moduleNotebookTable, moduleSizeOfTable=moduleSizeOfTable, moduleHwSerialNumber=moduleHwSerialNumber, statusLid=statusLid, notebookLineText=notebookLineText, controlInternalAppAccess=controlInternalAppAccess, elementTotalUpTime=elementTotalUpTime, controlTrapSending=controlTrapSending)
