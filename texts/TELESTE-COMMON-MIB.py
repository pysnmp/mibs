...
Bits, iso, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, Counter64, Integer32, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter64", "Integer32", "Counter32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverAddress=receiverAddress, statusHardware=statusHardware, controlTrapReceiverTable=controlTrapReceiverTable, moduleSlotNo=moduleSlotNo, moduleSizeOfTable=moduleSizeOfTable, moduleSWUpdateTable=moduleSWUpdateTable, controlAlarmDetection=controlAlarmDetection, sizeOfRegistry=sizeOfRegistry, statusBusMaster=statusBusMaster, receiverEntryId=receiverEntryId, moduleInformation=moduleInformation, productKeyEntry=productKeyEntry, elementInformation=elementInformation, productKeyTable=productKeyTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, repairComment=repairComment, moduleNotebookTable=moduleNotebookTable, productKeyIndex=productKeyIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairReasonCode=repairReasonCode, moduleEntry=moduleEntry, controlLocalAccess=controlLocalAccess, statusRunningSwImage=statusRunningSwImage, statusFan=statusFan, moduleControl=moduleControl, controlTrapSending=controlTrapSending, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapInterval=controlTrapInterval, elementStructure=elementStructure, elementConfigChangeCode=elementConfigChangeCode, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureEntry=productKeyFeatureEntry, elementLatitude=elementLatitude, productKeyFeatureTable=productKeyFeatureTable, moduleControlEntry=moduleControlEntry, elementResetCount=elementResetCount, moduleHwType=moduleHwType, moduleStatus=moduleStatus, controlLedUsage=controlLedUsage, productKeyFeatureIndex=productKeyFeatureIndex, repairIndex=repairIndex, elementAltitude=elementAltitude, statusTemperature=statusTemperature, controlInternalAppAccess=controlInternalAppAccess, notebookLineNumber=notebookLineNumber, moduleName=moduleName, productKeyFeatureName=productKeyFeatureName, moduleRegistry=moduleRegistry, repairNameCode=repairNameCode, sizeOfRepairlog=sizeOfRepairlog, controlMarkState=controlMarkState, statusSettings=statusSettings, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sWUpdateControl=sWUpdateControl, moduleNotebookEntry=moduleNotebookEntry, module=module, element=element, statusInternalTemperature=statusInternalTemperature, controlTrapDelay=controlTrapDelay, moduleTable=moduleTable, sWUpdateStatus=sWUpdateStatus, regValue=regValue, productKeyCipher=productKeyCipher, controlTempDeadBand=controlTempDeadBand, productKeyMask=productKeyMask, elementName=elementName, moduleHwVersion=moduleHwVersion, statusRestartCounter=statusRestartCounter, moduleAppDate=moduleAppDate, moduleBiosDate=moduleBiosDate, controlAlarmOnDelay=controlAlarmOnDelay, moduleBusAddress=moduleBusAddress, swUpdateURL=swUpdateURL, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitLo=controlTempLimitLo, moduleRegistryTable=moduleRegistryTable, controlBusMasterAdminState=controlBusMasterAdminState, receiverPort=receiverPort, moduleControlTable=moduleControlTable, moduleId=moduleId, regIndex=regIndex, moduleRepairLogTable=moduleRepairLogTable, statusGeneral=statusGeneral, elementControl=elementControl, moduleRackNo=moduleRackNo, regName=regName, moduleRegistryEntry=moduleRegistryEntry, moduleSizeOfEntry=moduleSizeOfEntry, sizeOfNotebook=sizeOfNotebook, controlReset=controlReset, elementProductKey=elementProductKey, moduleDetailEntry=moduleDetailEntry, moduleDetailTable=moduleDetailTable, moduleStatusEntry=moduleStatusEntry, receiverCommunity=receiverCommunity, moduleHwSerialNumber=moduleHwSerialNumber, elementTotalUpTime=elementTotalUpTime, controlTempLimitHiHi=controlTempLimitHiHi, statusLidStatus=statusLidStatus, controlTempLimitHi=controlTempLimitHi, statusSoftware=statusSoftware, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleStatusTable=moduleStatusTable, elementStatus=elementStatus, moduleMacAddress=moduleMacAddress, moduleBiosVersion=moduleBiosVersion, productKeyFeatureEnable=productKeyFeatureEnable, statusLmt=statusLmt, controlResetElement=controlResetElement, repairDate=repairDate, controlAlarmOffDelay=controlAlarmOffDelay, productKeyStatus=productKeyStatus, notebookLineText=notebookLineText, controlTrapLifeTime=controlTrapLifeTime, statusResetCause=statusResetCause, controlTempLimitLoLo=controlTempLimitLoLo, elementLongitude=elementLongitude, moduleAppVersion=moduleAppVersion, productKeyValue=productKeyValue, statusLid=statusLid)
