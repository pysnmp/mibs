...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSizeOfEntry=moduleSizeOfEntry, sizeOfRepairlog=sizeOfRepairlog, controlReset=controlReset, moduleId=moduleId, receiverEntryId=receiverEntryId, controlAlarmOffDelay=controlAlarmOffDelay, elementLongitude=elementLongitude, repairNameCode=repairNameCode, controlTempLimitHiHi=controlTempLimitHiHi, moduleRegistryEntry=moduleRegistryEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleStatusTable=moduleStatusTable, moduleSizeOfTable=moduleSizeOfTable, statusLmt=statusLmt, controlLedUsage=controlLedUsage, statusLidStatus=statusLidStatus, statusBusMaster=statusBusMaster, controlTempDeadBand=controlTempDeadBand, repairDate=repairDate, statusLid=statusLid, productKeyFeatureIndex=productKeyFeatureIndex, repairIndex=repairIndex, moduleHwSerialNumber=moduleHwSerialNumber, controlLocalAccess=controlLocalAccess, moduleControl=moduleControl, productKeyFeatureEnable=productKeyFeatureEnable, productKeyEntry=productKeyEntry, moduleControlTable=moduleControlTable, moduleInformation=moduleInformation, moduleAppVersion=moduleAppVersion, productKeyFeatureEntry=productKeyFeatureEntry, productKeyTable=productKeyTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleTable=moduleTable, statusResetCause=statusResetCause, controlTrapDelay=controlTrapDelay, sWUpdateControl=sWUpdateControl, moduleBusAddress=moduleBusAddress, controlInternalAppAccess=controlInternalAppAccess, regName=regName, controlTrapReceiverTable=controlTrapReceiverTable, moduleEntry=moduleEntry, statusInternalTemperature=statusInternalTemperature, elementAltitude=elementAltitude, controlTrapSending=controlTrapSending, statusTemperature=statusTemperature, elementResetCount=elementResetCount, repairComment=repairComment, moduleAppDate=moduleAppDate, controlMarkState=controlMarkState, moduleBiosDate=moduleBiosDate, notebookLineNumber=notebookLineNumber, elementConfigChangeCode=elementConfigChangeCode, moduleControlEntry=moduleControlEntry, moduleRegistryTable=moduleRegistryTable, elementName=elementName, receiverPort=receiverPort, notebookLineText=notebookLineText, statusRestartCounter=statusRestartCounter, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapInterval=controlTrapInterval, statusFan=statusFan, productKeyMask=productKeyMask, moduleHwVersion=moduleHwVersion, productKeyValue=productKeyValue, productKeyCipher=productKeyCipher, elementInformation=elementInformation, elementTotalUpTime=elementTotalUpTime, elementStatus=elementStatus, regValue=regValue, controlTempLimitLo=controlTempLimitLo, productKeyFeatureTable=productKeyFeatureTable, controlResetElement=controlResetElement, module=module, swUpdateURL=swUpdateURL, elementLatitude=elementLatitude, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureName=productKeyFeatureName, moduleName=moduleName, productKeyIndex=productKeyIndex, moduleRackNo=moduleRackNo, moduleMacAddress=moduleMacAddress, moduleRepairLogTable=moduleRepairLogTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusHardware=statusHardware, controlTempLimitLoLo=controlTempLimitLoLo, moduleDetailEntry=moduleDetailEntry, statusSoftware=statusSoftware, sizeOfRegistry=sizeOfRegistry, productKeyStatus=productKeyStatus, controlTempLimitHi=controlTempLimitHi, moduleStatus=moduleStatus, moduleHwType=moduleHwType, moduleStatusEntry=moduleStatusEntry, sWUpdateStatus=sWUpdateStatus, statusSettings=statusSettings, elementControl=elementControl, moduleRegistry=moduleRegistry, receiverCommunity=receiverCommunity, statusRunningSwImage=statusRunningSwImage, elementProductKey=elementProductKey, moduleBiosVersion=moduleBiosVersion, controlTrapLifeTime=controlTrapLifeTime, repairReasonCode=repairReasonCode, element=element, controlAlarmDetection=controlAlarmDetection, statusGeneral=statusGeneral, receiverAddress=receiverAddress, moduleDetailTable=moduleDetailTable, regIndex=regIndex, elementStructure=elementStructure, moduleNotebookEntry=moduleNotebookEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sWUpdateFileName=sWUpdateFileName, moduleRepairLogEntry=moduleRepairLogEntry, moduleNotebookTable=moduleNotebookTable, sizeOfNotebook=sizeOfNotebook, moduleSlotNo=moduleSlotNo, controlAlarmOnDelay=controlAlarmOnDelay, productKeyNumberOfFeatures=productKeyNumberOfFeatures)
