...
Counter32, ModuleIdentity, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter64, NotificationType, Bits, iso, Unsigned32, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "Bits", "iso", "Unsigned32", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlReset=controlReset, moduleRegistryEntry=moduleRegistryEntry, moduleBiosVersion=moduleBiosVersion, controlTempDeadBand=controlTempDeadBand, moduleDetailEntry=moduleDetailEntry, elementProductKey=elementProductKey, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementName=elementName, moduleRepairLogTable=moduleRepairLogTable, elementStatus=elementStatus, controlAlarmOnDelay=controlAlarmOnDelay, statusInternalTemperature=statusInternalTemperature, moduleSizeOfTable=moduleSizeOfTable, elementTotalUpTime=elementTotalUpTime, controlLedUsage=controlLedUsage, moduleNotebookEntry=moduleNotebookEntry, regName=regName, statusSoftware=statusSoftware, productKeyTable=productKeyTable, controlMarkState=controlMarkState, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusBusMaster=statusBusMaster, elementInformation=elementInformation, statusResetCause=statusResetCause, moduleSizeOfEntry=moduleSizeOfEntry, moduleStatusEntry=moduleStatusEntry, moduleMacAddress=moduleMacAddress, controlTrapSending=controlTrapSending, moduleEntry=moduleEntry, controlTempLimitLoLo=controlTempLimitLoLo, receiverEntryId=receiverEntryId, moduleStatus=moduleStatus, statusGeneral=statusGeneral, statusRestartCounter=statusRestartCounter, repairNameCode=repairNameCode, sizeOfRepairlog=sizeOfRepairlog, productKeyIndex=productKeyIndex, controlTempLimitHiHi=controlTempLimitHiHi, module=module, receiverPort=receiverPort, repairReasonCode=repairReasonCode, moduleNotebookTable=moduleNotebookTable, productKeyEntry=productKeyEntry, controlBusMasterAdminState=controlBusMasterAdminState, moduleBusAddress=moduleBusAddress, repairDate=repairDate, element=element, statusLmt=statusLmt, receiverCommunity=receiverCommunity, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyCipher=productKeyCipher, moduleDetailTable=moduleDetailTable, moduleStatusTable=moduleStatusTable, moduleControlEntry=moduleControlEntry, moduleRegistryTable=moduleRegistryTable, statusLid=statusLid, regIndex=regIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusHardware=statusHardware, productKeyStatus=productKeyStatus, moduleAppVersion=moduleAppVersion, moduleAppDate=moduleAppDate, elementAltitude=elementAltitude, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapInterval=controlTrapInterval, repairIndex=repairIndex, elementLatitude=elementLatitude, controlInternalAppAccess=controlInternalAppAccess, controlTempLimitHi=controlTempLimitHi, moduleTable=moduleTable, moduleRepairLogEntry=moduleRepairLogEntry, productKeyFeatureName=productKeyFeatureName, receiverAddress=receiverAddress, productKeyNumberOfKeys=productKeyNumberOfKeys, notebookLineNumber=notebookLineNumber, productKeyFeatureTable=productKeyFeatureTable, controlAlarmDetection=controlAlarmDetection, statusRunningSwImage=statusRunningSwImage, moduleHwType=moduleHwType, controlTrapDelay=controlTrapDelay, controlLocalAccess=controlLocalAccess, productKeyFeatureIndex=productKeyFeatureIndex, controlTrapLifeTime=controlTrapLifeTime, moduleBiosDate=moduleBiosDate, statusTemperature=statusTemperature, moduleSlotNo=moduleSlotNo, notebookLineText=notebookLineText, moduleHwVersion=moduleHwVersion, moduleRackNo=moduleRackNo, moduleRegistry=moduleRegistry, statusSettings=statusSettings, moduleInformation=moduleInformation, sizeOfRegistry=sizeOfRegistry, controlAlarmOffDelay=controlAlarmOffDelay, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, moduleHwSerialNumber=moduleHwSerialNumber, moduleControl=moduleControl, controlResetElement=controlResetElement, moduleSWUpdateTable=moduleSWUpdateTable, elementLongitude=elementLongitude, statusLidStatus=statusLidStatus, elementResetCount=elementResetCount, elementConfigChangeCode=elementConfigChangeCode, swUpdateURL=swUpdateURL, elementControl=elementControl, productKeyValue=productKeyValue, productKeyFeatureEnable=productKeyFeatureEnable, productKeyMask=productKeyMask, moduleId=moduleId, sWUpdateControl=sWUpdateControl, statusFan=statusFan, regValue=regValue, moduleName=moduleName, sWUpdateFileName=sWUpdateFileName, sizeOfNotebook=sizeOfNotebook, controlTrapReceiverEntry=controlTrapReceiverEntry, sWUpdateStatus=sWUpdateStatus, controlTempLimitLo=controlTempLimitLo, moduleControlTable=moduleControlTable, repairComment=repairComment)
