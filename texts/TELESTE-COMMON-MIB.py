...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOnDelay=controlAlarmOnDelay, sizeOfRegistry=sizeOfRegistry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sWUpdateControl=sWUpdateControl, regName=regName, receiverPort=receiverPort, moduleName=moduleName, sizeOfNotebook=sizeOfNotebook, controlTrapReceiverEntry=controlTrapReceiverEntry, statusGeneral=statusGeneral, sWUpdateStatus=sWUpdateStatus, moduleTable=moduleTable, controlTrapDelay=controlTrapDelay, moduleAppVersion=moduleAppVersion, elementAltitude=elementAltitude, moduleDetailTable=moduleDetailTable, controlTrapLifeTime=controlTrapLifeTime, controlMarkState=controlMarkState, controlInternalAppAccess=controlInternalAppAccess, productKeyIndex=productKeyIndex, moduleSizeOfTable=moduleSizeOfTable, elementProductKey=elementProductKey, statusInternalTemperature=statusInternalTemperature, statusLmt=statusLmt, moduleSizeOfEntry=moduleSizeOfEntry, elementResetCount=elementResetCount, statusLidStatus=statusLidStatus, moduleBusAddress=moduleBusAddress, controlAlarmDetection=controlAlarmDetection, statusLid=statusLid, moduleNotebookTable=moduleNotebookTable, controlTempLimitLoLo=controlTempLimitLoLo, elementName=elementName, moduleDetailEntry=moduleDetailEntry, controlTempLimitLo=controlTempLimitLo, moduleRackNo=moduleRackNo, receiverEntryId=receiverEntryId, controlBusMasterAdminState=controlBusMasterAdminState, controlLocalAccess=controlLocalAccess, moduleSlotNo=moduleSlotNo, repairReasonCode=repairReasonCode, controlTrapInterval=controlTrapInterval, moduleHwSerialNumber=moduleHwSerialNumber, regIndex=regIndex, productKeyNumberOfKeys=productKeyNumberOfKeys, controlLedUsage=controlLedUsage, elementLongitude=elementLongitude, productKeyFeatureEntry=productKeyFeatureEntry, elementInformation=elementInformation, controlTrapReceiverTable=controlTrapReceiverTable, moduleId=moduleId, productKeyValue=productKeyValue, moduleAppDate=moduleAppDate, controlTempLimitHi=controlTempLimitHi, moduleBiosDate=moduleBiosDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyEntry=productKeyEntry, controlReset=controlReset, statusBusMaster=statusBusMaster, moduleRepairLogEntry=moduleRepairLogEntry, statusSoftware=statusSoftware, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateFileName=sWUpdateFileName, controlAlarmOffDelay=controlAlarmOffDelay, elementLatitude=elementLatitude, productKeyTable=productKeyTable, regValue=regValue, swUpdateURL=swUpdateURL, controlTrapSending=controlTrapSending, productKeyMask=productKeyMask, moduleSWUpdateEntry=moduleSWUpdateEntry, statusResetCause=statusResetCause, repairIndex=repairIndex, moduleRegistryEntry=moduleRegistryEntry, moduleHwType=moduleHwType, module=module, statusHardware=statusHardware, moduleRegistry=moduleRegistry, moduleMacAddress=moduleMacAddress, statusRestartCounter=statusRestartCounter, element=element, moduleControlEntry=moduleControlEntry, moduleControl=moduleControl, moduleEntry=moduleEntry, productKeyCipher=productKeyCipher, moduleStatusEntry=moduleStatusEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatusTable=moduleStatusTable, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureTable=productKeyFeatureTable, repairComment=repairComment, receiverCommunity=receiverCommunity, statusTemperature=statusTemperature, elementControl=elementControl, moduleRepairLogTable=moduleRepairLogTable, productKeyStatus=productKeyStatus, moduleControlTable=moduleControlTable, productKeyFeatureEnable=productKeyFeatureEnable, elementTotalUpTime=elementTotalUpTime, elementStatus=elementStatus, sizeOfRepairlog=sizeOfRepairlog, moduleRegistryTable=moduleRegistryTable, moduleInformation=moduleInformation, repairNameCode=repairNameCode, productKeyFeatureName=productKeyFeatureName, moduleBiosVersion=moduleBiosVersion, controlResetElement=controlResetElement, moduleHwVersion=moduleHwVersion, notebookLineText=notebookLineText, elementStructure=elementStructure, receiverAddress=receiverAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairDate=repairDate, statusSettings=statusSettings, notebookLineNumber=notebookLineNumber, moduleNotebookEntry=moduleNotebookEntry, controlTempDeadBand=controlTempDeadBand, statusRunningSwImage=statusRunningSwImage, statusFan=statusFan, moduleStatus=moduleStatus)
