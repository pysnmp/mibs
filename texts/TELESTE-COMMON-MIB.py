...
ModuleIdentity, TimeTicks, Counter32, Counter64, IpAddress, Unsigned32, Bits, MibIdentifier, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementAltitude=elementAltitude, statusGeneral=statusGeneral, moduleHwSerialNumber=moduleHwSerialNumber, moduleRegistryTable=moduleRegistryTable, elementControl=elementControl, moduleBiosVersion=moduleBiosVersion, moduleInformation=moduleInformation, moduleBiosDate=moduleBiosDate, moduleMacAddress=moduleMacAddress, moduleRackNo=moduleRackNo, controlTrapInterval=controlTrapInterval, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTempLimitLo=controlTempLimitLo, regIndex=regIndex, moduleDetailEntry=moduleDetailEntry, moduleHwVersion=moduleHwVersion, controlTempLimitHi=controlTempLimitHi, controlTrapReceiverTable=controlTrapReceiverTable, receiverAddress=receiverAddress, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementProductKey=elementProductKey, moduleName=moduleName, controlReset=controlReset, receiverEntryId=receiverEntryId, elementLongitude=elementLongitude, productKeyStatus=productKeyStatus, productKeyCipher=productKeyCipher, controlLedUsage=controlLedUsage, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, elementLatitude=elementLatitude, repairComment=repairComment, productKeyIndex=productKeyIndex, moduleSlotNo=moduleSlotNo, repairDate=repairDate, controlBusMasterAdminState=controlBusMasterAdminState, productKeyMask=productKeyMask, elementInformation=elementInformation, statusInternalTemperature=statusInternalTemperature, productKeyEntry=productKeyEntry, statusLid=statusLid, controlTrapSending=controlTrapSending, moduleAppVersion=moduleAppVersion, moduleControlEntry=moduleControlEntry, controlTempLimitLoLo=controlTempLimitLoLo, repairReasonCode=repairReasonCode, moduleRegistryEntry=moduleRegistryEntry, moduleNotebookEntry=moduleNotebookEntry, element=element, statusSoftware=statusSoftware, sWUpdateControl=sWUpdateControl, regValue=regValue, statusLidStatus=statusLidStatus, statusRestartCounter=statusRestartCounter, moduleSWUpdateTable=moduleSWUpdateTable, elementStatus=elementStatus, moduleRegistry=moduleRegistry, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitHiHi=controlTempLimitHiHi, elementName=elementName, statusTemperature=statusTemperature, moduleBusAddress=moduleBusAddress, controlTempDeadBand=controlTempDeadBand, productKeyFeatureIndex=productKeyFeatureIndex, statusHardware=statusHardware, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureTable=productKeyFeatureTable, elementResetCount=elementResetCount, moduleControl=moduleControl, sWUpdateFileName=sWUpdateFileName, statusFan=statusFan, sizeOfRegistry=sizeOfRegistry, moduleDetailTable=moduleDetailTable, sWUpdateStatus=sWUpdateStatus, elementTotalUpTime=elementTotalUpTime, statusRunningSwImage=statusRunningSwImage, statusSettings=statusSettings, receiverCommunity=receiverCommunity, moduleEntry=moduleEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleRepairLogTable=moduleRepairLogTable, moduleControlTable=moduleControlTable, sizeOfRepairlog=sizeOfRepairlog, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleAppDate=moduleAppDate, controlResetElement=controlResetElement, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRepairLogEntry=moduleRepairLogEntry, moduleStatusEntry=moduleStatusEntry, productKeyValue=productKeyValue, controlInternalAppAccess=controlInternalAppAccess, statusBusMaster=statusBusMaster, moduleNotebookTable=moduleNotebookTable, notebookLineNumber=notebookLineNumber, receiverPort=receiverPort, moduleSizeOfEntry=moduleSizeOfEntry, statusResetCause=statusResetCause, notebookLineText=notebookLineText, repairIndex=repairIndex, controlAlarmDetection=controlAlarmDetection, moduleId=moduleId, elementStructure=elementStructure, controlMarkState=controlMarkState, controlLocalAccess=controlLocalAccess, elementConfigChangeCode=elementConfigChangeCode, repairNameCode=repairNameCode, regName=regName, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyTable=productKeyTable, swUpdateURL=swUpdateURL, controlTrapLifeTime=controlTrapLifeTime, moduleHwType=moduleHwType, moduleStatus=moduleStatus, moduleTable=moduleTable, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEntry=productKeyFeatureEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, module=module, moduleStatusTable=moduleStatusTable, controlTrapDelay=controlTrapDelay)
