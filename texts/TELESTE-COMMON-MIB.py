...
TimeTicks, iso, ObjectIdentity, Bits, Counter64, MibIdentifier, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Unsigned32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "ObjectIdentity", "Bits", "Counter64", "MibIdentifier", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Unsigned32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOnDelay=controlAlarmOnDelay, moduleEntry=moduleEntry, statusLidStatus=statusLidStatus, statusHardware=statusHardware, swUpdateURL=swUpdateURL, moduleInformation=moduleInformation, statusFan=statusFan, moduleRegistryEntry=moduleRegistryEntry, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleStatusTable=moduleStatusTable, statusTemperature=statusTemperature, productKeyCipher=productKeyCipher, notebookLineNumber=notebookLineNumber, statusSettings=statusSettings, controlTrapDelay=controlTrapDelay, statusResetCause=statusResetCause, statusBusMaster=statusBusMaster, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureEnable=productKeyFeatureEnable, receiverCommunity=receiverCommunity, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateStatus=sWUpdateStatus, productKeyIndex=productKeyIndex, productKeyFeatureEntry=productKeyFeatureEntry, controlMarkState=controlMarkState, statusRunningSwImage=statusRunningSwImage, module=module, elementStatus=elementStatus, controlTempLimitHiHi=controlTempLimitHiHi, moduleControl=moduleControl, moduleDetailTable=moduleDetailTable, moduleBusAddress=moduleBusAddress, elementAltitude=elementAltitude, repairReasonCode=repairReasonCode, productKeyValue=productKeyValue, moduleControlEntry=moduleControlEntry, moduleBiosVersion=moduleBiosVersion, controlTempLimitHi=controlTempLimitHi, controlReset=controlReset, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleControlTable=moduleControlTable, sizeOfRegistry=sizeOfRegistry, controlTempDeadBand=controlTempDeadBand, moduleNotebookTable=moduleNotebookTable, statusGeneral=statusGeneral, productKeyTable=productKeyTable, controlInternalAppAccess=controlInternalAppAccess, moduleSizeOfTable=moduleSizeOfTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatus=moduleStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapInterval=controlTrapInterval, moduleStatusEntry=moduleStatusEntry, productKeyStatus=productKeyStatus, moduleRegistryTable=moduleRegistryTable, receiverPort=receiverPort, controlAlarmOffDelay=controlAlarmOffDelay, controlLocalAccess=controlLocalAccess, controlTrapReceiverTable=controlTrapReceiverTable, elementControl=elementControl, moduleName=moduleName, moduleRepairLogTable=moduleRepairLogTable, moduleSlotNo=moduleSlotNo, elementConfigChangeCode=elementConfigChangeCode, repairNameCode=repairNameCode, sWUpdateFileName=sWUpdateFileName, controlTempLimitLo=controlTempLimitLo, statusRestartCounter=statusRestartCounter, elementName=elementName, moduleHwVersion=moduleHwVersion, productKeyEntry=productKeyEntry, receiverAddress=receiverAddress, receiverEntryId=receiverEntryId, controlAlarmDetection=controlAlarmDetection, controlResetElement=controlResetElement, controlLedUsage=controlLedUsage, statusSoftware=statusSoftware, moduleMacAddress=moduleMacAddress, productKeyFeatureName=productKeyFeatureName, regIndex=regIndex, elementResetCount=elementResetCount, moduleRegistry=moduleRegistry, moduleAppVersion=moduleAppVersion, notebookLineText=notebookLineText, statusInternalTemperature=statusInternalTemperature, moduleSizeOfEntry=moduleSizeOfEntry, sizeOfRepairlog=sizeOfRepairlog, elementInformation=elementInformation, moduleTable=moduleTable, repairIndex=repairIndex, moduleRepairLogEntry=moduleRepairLogEntry, repairComment=repairComment, statusLid=statusLid, element=element, moduleAppDate=moduleAppDate, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sWUpdateControl=sWUpdateControl, moduleDetailEntry=moduleDetailEntry, moduleRackNo=moduleRackNo, moduleHwSerialNumber=moduleHwSerialNumber, productKeyMask=productKeyMask, repairDate=repairDate, elementTotalUpTime=elementTotalUpTime, moduleHwType=moduleHwType, regName=regName, elementLatitude=elementLatitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapLifeTime=controlTrapLifeTime, moduleId=moduleId, elementLongitude=elementLongitude, controlTrapSending=controlTrapSending, regValue=regValue, elementStructure=elementStructure, moduleBiosDate=moduleBiosDate, elementProductKey=elementProductKey, controlTempLimitLoLo=controlTempLimitLoLo, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapReceiverEntry=controlTrapReceiverEntry)
