...
IpAddress, Unsigned32, Integer32, NotificationType, Gauge32, Counter64, ModuleIdentity, MibIdentifier, iso, TimeTicks, Bits, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Integer32", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "MibIdentifier", "iso", "TimeTicks", "Bits", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyMask=productKeyMask, statusLmt=statusLmt, receiverAddress=receiverAddress, elementTotalUpTime=elementTotalUpTime, productKeyStatus=productKeyStatus, repairIndex=repairIndex, notebookLineNumber=notebookLineNumber, controlAlarmOnDelay=controlAlarmOnDelay, moduleStatus=moduleStatus, elementControl=elementControl, moduleBiosVersion=moduleBiosVersion, controlTempLimitLo=controlTempLimitLo, sizeOfRegistry=sizeOfRegistry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureIndex=productKeyFeatureIndex, elementLatitude=elementLatitude, moduleNotebookEntry=moduleNotebookEntry, moduleControlEntry=moduleControlEntry, moduleTable=moduleTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyTable=productKeyTable, repairDate=repairDate, controlTrapDelay=controlTrapDelay, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairComment=repairComment, statusHardware=statusHardware, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlMarkState=controlMarkState, sizeOfRepairlog=sizeOfRepairlog, elementResetCount=elementResetCount, moduleSlotNo=moduleSlotNo, receiverCommunity=receiverCommunity, elementInformation=elementInformation, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistryTable=moduleRegistryTable, controlReset=controlReset, elementProductKey=elementProductKey, controlBusMasterAdminState=controlBusMasterAdminState, moduleHwVersion=moduleHwVersion, sizeOfNotebook=sizeOfNotebook, controlLedUsage=controlLedUsage, statusResetCause=statusResetCause, moduleId=moduleId, moduleBusAddress=moduleBusAddress, moduleStatusEntry=moduleStatusEntry, productKeyFeatureEnable=productKeyFeatureEnable, productKeyFeatureName=productKeyFeatureName, moduleRegistry=moduleRegistry, regName=regName, sWUpdateControl=sWUpdateControl, controlTrapLifeTime=controlTrapLifeTime, productKeyValue=productKeyValue, moduleRegistryEntry=moduleRegistryEntry, moduleEntry=moduleEntry, controlTrapReceiverTable=controlTrapReceiverTable, controlLocalAccess=controlLocalAccess, repairNameCode=repairNameCode, moduleHwType=moduleHwType, controlTempLimitHiHi=controlTempLimitHiHi, notebookLineText=notebookLineText, statusSettings=statusSettings, moduleRepairLogEntry=moduleRepairLogEntry, sWUpdateStatus=sWUpdateStatus, moduleNotebookTable=moduleNotebookTable, controlTrapSending=controlTrapSending, moduleDetailTable=moduleDetailTable, moduleSWUpdateTable=moduleSWUpdateTable, productKeyCipher=productKeyCipher, controlTrapInterval=controlTrapInterval, elementConfigChangeCode=elementConfigChangeCode, elementStatus=elementStatus, elementName=elementName, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureEntry=productKeyFeatureEntry, moduleAppDate=moduleAppDate, statusSoftware=statusSoftware, moduleControlTable=moduleControlTable, statusLidStatus=statusLidStatus, moduleName=moduleName, moduleRepairLogTable=moduleRepairLogTable, elementLongitude=elementLongitude, receiverEntryId=receiverEntryId, moduleSWUpdateEntry=moduleSWUpdateEntry, statusTemperature=statusTemperature, moduleDetailEntry=moduleDetailEntry, swUpdateURL=swUpdateURL, moduleInformation=moduleInformation, statusRestartCounter=statusRestartCounter, regValue=regValue, statusFan=statusFan, controlAlarmDetection=controlAlarmDetection, element=element, receiverPort=receiverPort, module=module, productKeyEntry=productKeyEntry, statusInternalTemperature=statusInternalTemperature, sWUpdateFileName=sWUpdateFileName, moduleStatusTable=moduleStatusTable, statusGeneral=statusGeneral, moduleMacAddress=moduleMacAddress, moduleHwSerialNumber=moduleHwSerialNumber, controlTempLimitLoLo=controlTempLimitLoLo, moduleSizeOfEntry=moduleSizeOfEntry, statusBusMaster=statusBusMaster, regIndex=regIndex, elementStructure=elementStructure, controlResetElement=controlResetElement, productKeyFeatureTable=productKeyFeatureTable, moduleRackNo=moduleRackNo, repairReasonCode=repairReasonCode, productKeyIndex=productKeyIndex, controlTempDeadBand=controlTempDeadBand, statusLid=statusLid, moduleBiosDate=moduleBiosDate, controlTempLimitHi=controlTempLimitHi, moduleAppVersion=moduleAppVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, elementAltitude=elementAltitude, moduleSizeOfTable=moduleSizeOfTable, controlInternalAppAccess=controlInternalAppAccess, moduleControl=moduleControl)
