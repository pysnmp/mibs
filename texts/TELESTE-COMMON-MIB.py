...
IpAddress, iso, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier, NotificationType, Counter64, Gauge32, Integer32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "Integer32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTempDeadBand=controlTempDeadBand, elementConfigChangeCode=elementConfigChangeCode, productKeyIndex=productKeyIndex, notebookLineText=notebookLineText, statusSoftware=statusSoftware, receiverAddress=receiverAddress, productKeyCipher=productKeyCipher, statusHardware=statusHardware, sWUpdateStatus=sWUpdateStatus, controlTrapReceiverTable=controlTrapReceiverTable, receiverPort=receiverPort, moduleRegistryTable=moduleRegistryTable, repairDate=repairDate, controlAlarmOnDelay=controlAlarmOnDelay, elementControl=elementControl, statusTemperature=statusTemperature, moduleTable=moduleTable, regIndex=regIndex, elementAltitude=elementAltitude, moduleRepairLogEntry=moduleRepairLogEntry, elementLatitude=elementLatitude, controlMarkState=controlMarkState, swUpdateURL=swUpdateURL, notebookLineNumber=notebookLineNumber, controlResetElement=controlResetElement, repairReasonCode=repairReasonCode, moduleRackNo=moduleRackNo, elementProductKey=elementProductKey, moduleDetailTable=moduleDetailTable, controlTempLimitHi=controlTempLimitHi, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyFeatureEntry=productKeyFeatureEntry, productKeyFeatureEnable=productKeyFeatureEnable, statusGeneral=statusGeneral, controlTrapSending=controlTrapSending, moduleStatusTable=moduleStatusTable, module=module, sizeOfNotebook=sizeOfNotebook, moduleSizeOfEntry=moduleSizeOfEntry, moduleEntry=moduleEntry, element=element, moduleStatus=moduleStatus, moduleRepairLogTable=moduleRepairLogTable, elementTotalUpTime=elementTotalUpTime, repairComment=repairComment, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleMacAddress=moduleMacAddress, moduleRegistryEntry=moduleRegistryEntry, elementLongitude=elementLongitude, receiverCommunity=receiverCommunity, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusLid=statusLid, statusInternalTemperature=statusInternalTemperature, controlLocalAccess=controlLocalAccess, elementName=elementName, regValue=regValue, productKeyEntry=productKeyEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleId=moduleId, controlTempLimitHiHi=controlTempLimitHiHi, moduleAppDate=moduleAppDate, repairNameCode=repairNameCode, statusSettings=statusSettings, moduleAppVersion=moduleAppVersion, moduleBusAddress=moduleBusAddress, moduleControl=moduleControl, repairIndex=repairIndex, moduleInformation=moduleInformation, productKeyMask=productKeyMask, moduleStatusEntry=moduleStatusEntry, statusBusMaster=statusBusMaster, elementStatus=elementStatus, moduleBiosVersion=moduleBiosVersion, controlLedUsage=controlLedUsage, moduleSizeOfTable=moduleSizeOfTable, statusResetCause=statusResetCause, productKeyTable=productKeyTable, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateFileName=sWUpdateFileName, moduleName=moduleName, controlAlarmDetection=controlAlarmDetection, statusLmt=statusLmt, controlReset=controlReset, regName=regName, receiverEntryId=receiverEntryId, elementResetCount=elementResetCount, controlAlarmOffDelay=controlAlarmOffDelay, statusLidStatus=statusLidStatus, controlTrapDelay=controlTrapDelay, productKeyStatus=productKeyStatus, elementInformation=elementInformation, moduleNotebookEntry=moduleNotebookEntry, moduleControlEntry=moduleControlEntry, moduleControlTable=moduleControlTable, sWUpdateControl=sWUpdateControl, controlTrapInterval=controlTrapInterval, statusRunningSwImage=statusRunningSwImage, sizeOfRepairlog=sizeOfRepairlog, controlTrapLifeTime=controlTrapLifeTime, moduleSlotNo=moduleSlotNo, moduleHwType=moduleHwType, moduleNotebookTable=moduleNotebookTable, productKeyFeatureTable=productKeyFeatureTable, moduleDetailEntry=moduleDetailEntry, elementStructure=elementStructure, controlTempLimitLo=controlTempLimitLo, productKeyFeatureIndex=productKeyFeatureIndex, statusFan=statusFan, productKeyFeatureName=productKeyFeatureName, moduleHwVersion=moduleHwVersion, moduleBiosDate=moduleBiosDate, controlTempLimitLoLo=controlTempLimitLoLo, controlInternalAppAccess=controlInternalAppAccess, moduleHwSerialNumber=moduleHwSerialNumber, statusRestartCounter=statusRestartCounter, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistry=moduleRegistry, productKeyValue=productKeyValue, sizeOfRegistry=sizeOfRegistry)
