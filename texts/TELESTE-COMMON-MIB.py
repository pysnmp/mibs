...
ModuleIdentity, Counter32, NotificationType, iso, Integer32, Counter64, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "NotificationType", "iso", "Integer32", "Counter64", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusGeneral=statusGeneral, statusBusMaster=statusBusMaster, moduleHwSerialNumber=moduleHwSerialNumber, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sWUpdateControl=sWUpdateControl, controlTrapLifeTime=controlTrapLifeTime, controlMarkState=controlMarkState, statusLidStatus=statusLidStatus, moduleDetailEntry=moduleDetailEntry, controlTempLimitLo=controlTempLimitLo, productKeyTable=productKeyTable, controlLocalAccess=controlLocalAccess, moduleRegistryTable=moduleRegistryTable, statusInternalTemperature=statusInternalTemperature, moduleSlotNo=moduleSlotNo, swUpdateURL=swUpdateURL, controlAlarmOffDelay=controlAlarmOffDelay, sWUpdateFileName=sWUpdateFileName, elementInformation=elementInformation, moduleRegistryEntry=moduleRegistryEntry, moduleControl=moduleControl, controlLedUsage=controlLedUsage, element=element, controlTempLimitHiHi=controlTempLimitHiHi, moduleSizeOfTable=moduleSizeOfTable, moduleTable=moduleTable, productKeyFeatureEntry=productKeyFeatureEntry, elementTotalUpTime=elementTotalUpTime, sWUpdateStatus=sWUpdateStatus, notebookLineNumber=notebookLineNumber, productKeyEntry=productKeyEntry, elementResetCount=elementResetCount, statusRestartCounter=statusRestartCounter, repairIndex=repairIndex, moduleAppDate=moduleAppDate, moduleMacAddress=moduleMacAddress, productKeyFeatureTable=productKeyFeatureTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistry=moduleRegistry, controlTrapDelay=controlTrapDelay, controlAlarmDetection=controlAlarmDetection, repairComment=repairComment, sizeOfRepairlog=sizeOfRepairlog, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlBusMasterAdminState=controlBusMasterAdminState, statusFan=statusFan, statusSoftware=statusSoftware, controlInternalAppAccess=controlInternalAppAccess, productKeyStatus=productKeyStatus, moduleNotebookEntry=moduleNotebookEntry, receiverEntryId=receiverEntryId, moduleStatusEntry=moduleStatusEntry, moduleRackNo=moduleRackNo, moduleEntry=moduleEntry, productKeyMask=productKeyMask, moduleDetailTable=moduleDetailTable, productKeyFeatureIndex=productKeyFeatureIndex, elementControl=elementControl, controlAlarmOnDelay=controlAlarmOnDelay, moduleBusAddress=moduleBusAddress, controlTrapSending=controlTrapSending, receiverPort=receiverPort, regValue=regValue, receiverAddress=receiverAddress, statusLmt=statusLmt, moduleControlEntry=moduleControlEntry, productKeyValue=productKeyValue, productKeyCipher=productKeyCipher, moduleBiosVersion=moduleBiosVersion, moduleNotebookTable=moduleNotebookTable, controlTempLimitHi=controlTempLimitHi, statusRunningSwImage=statusRunningSwImage, controlTempLimitLoLo=controlTempLimitLoLo, receiverCommunity=receiverCommunity, moduleHwType=moduleHwType, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempDeadBand=controlTempDeadBand, moduleName=moduleName, statusResetCause=statusResetCause, elementLongitude=elementLongitude, controlTrapReceiverEntry=controlTrapReceiverEntry, elementName=elementName, moduleStatus=moduleStatus, moduleAppVersion=moduleAppVersion, repairDate=repairDate, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleInformation=moduleInformation, statusHardware=statusHardware, controlReset=controlReset, elementStructure=elementStructure, elementStatus=elementStatus, statusTemperature=statusTemperature, moduleControlTable=moduleControlTable, productKeyFeatureName=productKeyFeatureName, controlTrapInterval=controlTrapInterval, sizeOfNotebook=sizeOfNotebook, controlResetElement=controlResetElement, elementLatitude=elementLatitude, moduleSizeOfEntry=moduleSizeOfEntry, elementConfigChangeCode=elementConfigChangeCode, statusLid=statusLid, repairNameCode=repairNameCode, notebookLineText=notebookLineText, moduleHwVersion=moduleHwVersion, productKeyIndex=productKeyIndex, statusSettings=statusSettings, module=module, elementProductKey=elementProductKey, moduleBiosDate=moduleBiosDate, repairReasonCode=repairReasonCode, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogTable=moduleRepairLogTable, moduleId=moduleId, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sizeOfRegistry=sizeOfRegistry, moduleStatusTable=moduleStatusTable, moduleRepairLogEntry=moduleRepairLogEntry, elementAltitude=elementAltitude, regName=regName, regIndex=regIndex)
