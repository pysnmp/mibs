...
Counter32, Unsigned32, Bits, TimeTicks, Gauge32, ModuleIdentity, iso, Integer32, MibIdentifier, NotificationType, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Bits", "TimeTicks", "Gauge32", "ModuleIdentity", "iso", "Integer32", "MibIdentifier", "NotificationType", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapReceiverTable=controlTrapReceiverTable, moduleHwVersion=moduleHwVersion, moduleStatus=moduleStatus, controlReset=controlReset, sWUpdateControl=sWUpdateControl, repairComment=repairComment, moduleRegistryEntry=moduleRegistryEntry, swUpdateURL=swUpdateURL, moduleTable=moduleTable, moduleMacAddress=moduleMacAddress, elementProductKey=elementProductKey, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sWUpdateStatus=sWUpdateStatus, elementStructure=elementStructure, moduleRepairLogTable=moduleRepairLogTable, moduleEntry=moduleEntry, receiverEntryId=receiverEntryId, productKeyFeatureEntry=productKeyFeatureEntry, moduleHwType=moduleHwType, moduleBusAddress=moduleBusAddress, productKeyMask=productKeyMask, elementTotalUpTime=elementTotalUpTime, productKeyCipher=productKeyCipher, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlInternalAppAccess=controlInternalAppAccess, moduleRepairLogEntry=moduleRepairLogEntry, moduleBiosDate=moduleBiosDate, statusGeneral=statusGeneral, elementControl=elementControl, statusSettings=statusSettings, statusHardware=statusHardware, elementLatitude=elementLatitude, controlTempLimitHi=controlTempLimitHi, controlTempLimitLo=controlTempLimitLo, moduleSWUpdateTable=moduleSWUpdateTable, regName=regName, controlAlarmOffDelay=controlAlarmOffDelay, moduleBiosVersion=moduleBiosVersion, regIndex=regIndex, statusTemperature=statusTemperature, moduleControlEntry=moduleControlEntry, moduleNotebookTable=moduleNotebookTable, elementName=elementName, moduleSizeOfEntry=moduleSizeOfEntry, receiverCommunity=receiverCommunity, productKeyStatus=productKeyStatus, controlAlarmDetection=controlAlarmDetection, productKeyValue=productKeyValue, productKeyIndex=productKeyIndex, statusResetCause=statusResetCause, moduleName=moduleName, controlTrapDelay=controlTrapDelay, receiverAddress=receiverAddress, statusFan=statusFan, productKeyFeatureIndex=productKeyFeatureIndex, sizeOfRegistry=sizeOfRegistry, controlTempLimitLoLo=controlTempLimitLoLo, controlLedUsage=controlLedUsage, statusRestartCounter=statusRestartCounter, moduleSWUpdateEntry=moduleSWUpdateEntry, elementInformation=elementInformation, elementResetCount=elementResetCount, controlTempDeadBand=controlTempDeadBand, productKeyFeatureEnable=productKeyFeatureEnable, statusRunningSwImage=statusRunningSwImage, moduleAppDate=moduleAppDate, moduleDetailTable=moduleDetailTable, productKeyEntry=productKeyEntry, controlResetElement=controlResetElement, moduleStatusTable=moduleStatusTable, statusLid=statusLid, sizeOfNotebook=sizeOfNotebook, notebookLineNumber=notebookLineNumber, controlBusMasterAdminState=controlBusMasterAdminState, moduleStatusEntry=moduleStatusEntry, statusLidStatus=statusLidStatus, statusLmt=statusLmt, controlTrapSending=controlTrapSending, controlTrapInterval=controlTrapInterval, controlTempLimitHiHi=controlTempLimitHiHi, moduleInformation=moduleInformation, statusBusMaster=statusBusMaster, sWUpdateFileName=sWUpdateFileName, moduleRegistryTable=moduleRegistryTable, repairIndex=repairIndex, controlLocalAccess=controlLocalAccess, element=element, controlTrapLifeTime=controlTrapLifeTime, moduleControl=moduleControl, elementConfigChangeCode=elementConfigChangeCode, moduleDetailEntry=moduleDetailEntry, regValue=regValue, elementLongitude=elementLongitude, repairReasonCode=repairReasonCode, moduleAppVersion=moduleAppVersion, controlAlarmOnDelay=controlAlarmOnDelay, moduleSlotNo=moduleSlotNo, moduleHwSerialNumber=moduleHwSerialNumber, notebookLineText=notebookLineText, productKeyFeatureName=productKeyFeatureName, sizeOfRepairlog=sizeOfRepairlog, statusInternalTemperature=statusInternalTemperature, repairDate=repairDate, productKeyFeatureTable=productKeyFeatureTable, module=module, moduleRackNo=moduleRackNo, moduleNotebookEntry=moduleNotebookEntry, moduleControlTable=moduleControlTable, moduleRegistry=moduleRegistry, elementStatus=elementStatus, moduleSizeOfTable=moduleSizeOfTable, elementAltitude=elementAltitude, productKeyTable=productKeyTable, repairNameCode=repairNameCode, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleId=moduleId, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusSoftware=statusSoftware, controlMarkState=controlMarkState, receiverPort=receiverPort)
