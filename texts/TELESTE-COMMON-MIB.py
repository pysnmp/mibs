...
iso, Counter64, ModuleIdentity, Counter32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Gauge32, Bits, MibIdentifier, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "ModuleIdentity", "Counter32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlReset=controlReset, sizeOfRepairlog=sizeOfRepairlog, repairComment=repairComment, moduleRackNo=moduleRackNo, module=module, controlTrapReceiverTable=controlTrapReceiverTable, elementLongitude=elementLongitude, controlTempDeadBand=controlTempDeadBand, moduleDetailTable=moduleDetailTable, elementResetCount=elementResetCount, controlTrapDelay=controlTrapDelay, statusLidStatus=statusLidStatus, elementProductKey=elementProductKey, controlAlarmOnDelay=controlAlarmOnDelay, notebookLineNumber=notebookLineNumber, swUpdateURL=swUpdateURL, statusTemperature=statusTemperature, controlAlarmOffDelay=controlAlarmOffDelay, sWUpdateStatus=sWUpdateStatus, controlLedUsage=controlLedUsage, moduleBiosDate=moduleBiosDate, productKeyValue=productKeyValue, elementStatus=elementStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleName=moduleName, repairNameCode=repairNameCode, elementControl=elementControl, moduleRegistryEntry=moduleRegistryEntry, statusGeneral=statusGeneral, moduleNotebookEntry=moduleNotebookEntry, regIndex=regIndex, statusFan=statusFan, element=element, productKeyStatus=productKeyStatus, controlAlarmDetection=controlAlarmDetection, receiverCommunity=receiverCommunity, moduleDetailEntry=moduleDetailEntry, elementConfigChangeCode=elementConfigChangeCode, moduleHwSerialNumber=moduleHwSerialNumber, statusResetCause=statusResetCause, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlBusMasterAdminState=controlBusMasterAdminState, statusRestartCounter=statusRestartCounter, moduleInformation=moduleInformation, productKeyFeatureIndex=productKeyFeatureIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleControlTable=moduleControlTable, moduleStatusEntry=moduleStatusEntry, controlTrapInterval=controlTrapInterval, receiverEntryId=receiverEntryId, controlInternalAppAccess=controlInternalAppAccess, repairReasonCode=repairReasonCode, elementLatitude=elementLatitude, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitLo=controlTempLimitLo, controlTrapSending=controlTrapSending, productKeyEntry=productKeyEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyTable=productKeyTable, moduleId=moduleId, statusLid=statusLid, moduleBiosVersion=moduleBiosVersion, sWUpdateControl=sWUpdateControl, regValue=regValue, controlResetElement=controlResetElement, repairDate=repairDate, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistry=moduleRegistry, productKeyFeatureEntry=productKeyFeatureEntry, receiverAddress=receiverAddress, repairIndex=repairIndex, statusInternalTemperature=statusInternalTemperature, statusHardware=statusHardware, elementAltitude=elementAltitude, statusSoftware=statusSoftware, controlLocalAccess=controlLocalAccess, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapLifeTime=controlTrapLifeTime, productKeyIndex=productKeyIndex, moduleTable=moduleTable, regName=regName, sizeOfNotebook=sizeOfNotebook, elementStructure=elementStructure, moduleBusAddress=moduleBusAddress, moduleSlotNo=moduleSlotNo, notebookLineText=notebookLineText, sWUpdateFileName=sWUpdateFileName, moduleControlEntry=moduleControlEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleMacAddress=moduleMacAddress, statusSettings=statusSettings, sizeOfRegistry=sizeOfRegistry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRepairLogTable=moduleRepairLogTable, elementName=elementName, moduleHwType=moduleHwType, moduleStatus=moduleStatus, moduleAppVersion=moduleAppVersion, moduleNotebookTable=moduleNotebookTable, productKeyFeatureTable=productKeyFeatureTable, statusLmt=statusLmt, controlMarkState=controlMarkState, elementTotalUpTime=elementTotalUpTime, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyCipher=productKeyCipher, receiverPort=receiverPort, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitHi=controlTempLimitHi, controlTempLimitLoLo=controlTempLimitLoLo, productKeyMask=productKeyMask, statusBusMaster=statusBusMaster, moduleAppDate=moduleAppDate, moduleEntry=moduleEntry, moduleControl=moduleControl, moduleHwVersion=moduleHwVersion, moduleRegistryTable=moduleRegistryTable, moduleRepairLogEntry=moduleRepairLogEntry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureName=productKeyFeatureName, elementInformation=elementInformation, moduleStatusTable=moduleStatusTable)
