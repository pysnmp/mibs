...
ObjectIdentity, iso, Bits, MibIdentifier, Integer32, Gauge32, ModuleIdentity, Unsigned32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Bits", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "Unsigned32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverCommunity=receiverCommunity, moduleBiosDate=moduleBiosDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapLifeTime=controlTrapLifeTime, productKeyNumberOfKeys=productKeyNumberOfKeys, controlLocalAccess=controlLocalAccess, productKeyTable=productKeyTable, sWUpdateFileName=sWUpdateFileName, moduleRegistryEntry=moduleRegistryEntry, statusGeneral=statusGeneral, moduleId=moduleId, elementInformation=elementInformation, statusFan=statusFan, elementAltitude=elementAltitude, controlTempLimitLo=controlTempLimitLo, controlResetElement=controlResetElement, moduleStatusEntry=moduleStatusEntry, receiverAddress=receiverAddress, statusSoftware=statusSoftware, moduleAppVersion=moduleAppVersion, statusHardware=statusHardware, controlAlarmDetection=controlAlarmDetection, elementTotalUpTime=elementTotalUpTime, controlLedUsage=controlLedUsage, regName=regName, statusBusMaster=statusBusMaster, moduleStatusTable=moduleStatusTable, statusRestartCounter=statusRestartCounter, moduleHwSerialNumber=moduleHwSerialNumber, repairIndex=repairIndex, regValue=regValue, moduleBiosVersion=moduleBiosVersion, controlTempLimitLoLo=controlTempLimitLoLo, moduleEntry=moduleEntry, moduleBusAddress=moduleBusAddress, controlTempLimitHi=controlTempLimitHi, repairDate=repairDate, controlTempDeadBand=controlTempDeadBand, moduleRegistryTable=moduleRegistryTable, moduleName=moduleName, moduleMacAddress=moduleMacAddress, statusLid=statusLid, notebookLineText=notebookLineText, controlTrapInterval=controlTrapInterval, statusInternalTemperature=statusInternalTemperature, elementLongitude=elementLongitude, moduleDetailEntry=moduleDetailEntry, controlTempLimitHiHi=controlTempLimitHiHi, productKeyFeatureEnable=productKeyFeatureEnable, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSizeOfTable=moduleSizeOfTable, elementControl=elementControl, productKeyFeatureEntry=productKeyFeatureEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sizeOfNotebook=sizeOfNotebook, moduleControl=moduleControl, productKeyFeatureIndex=productKeyFeatureIndex, elementName=elementName, productKeyValue=productKeyValue, elementStatus=elementStatus, receiverPort=receiverPort, controlTrapSending=controlTrapSending, productKeyEntry=productKeyEntry, moduleRackNo=moduleRackNo, notebookLineNumber=notebookLineNumber, moduleSizeOfEntry=moduleSizeOfEntry, moduleControlTable=moduleControlTable, moduleTable=moduleTable, moduleNotebookEntry=moduleNotebookEntry, moduleRegistry=moduleRegistry, productKeyStatus=productKeyStatus, moduleHwType=moduleHwType, moduleAppDate=moduleAppDate, statusTemperature=statusTemperature, productKeyFeatureName=productKeyFeatureName, statusSettings=statusSettings, module=module, elementResetCount=elementResetCount, statusResetCause=statusResetCause, elementProductKey=elementProductKey, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogTable=moduleRepairLogTable, controlBusMasterAdminState=controlBusMasterAdminState, moduleStatus=moduleStatus, regIndex=regIndex, productKeyIndex=productKeyIndex, moduleInformation=moduleInformation, repairComment=repairComment, controlTrapReceiverTable=controlTrapReceiverTable, sizeOfRepairlog=sizeOfRepairlog, sWUpdateControl=sWUpdateControl, statusLmt=statusLmt, moduleSlotNo=moduleSlotNo, moduleHwVersion=moduleHwVersion, swUpdateURL=swUpdateURL, statusLidStatus=statusLidStatus, controlMarkState=controlMarkState, controlReset=controlReset, moduleSWUpdateTable=moduleSWUpdateTable, moduleDetailTable=moduleDetailTable, receiverEntryId=receiverEntryId, elementStructure=elementStructure, repairNameCode=repairNameCode, productKeyMask=productKeyMask, sizeOfRegistry=sizeOfRegistry, controlAlarmOffDelay=controlAlarmOffDelay, repairReasonCode=repairReasonCode, controlTrapDelay=controlTrapDelay, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleNotebookTable=moduleNotebookTable, controlInternalAppAccess=controlInternalAppAccess, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureTable=productKeyFeatureTable, element=element, elementLatitude=elementLatitude, statusRunningSwImage=statusRunningSwImage, moduleControlEntry=moduleControlEntry, sWUpdateStatus=sWUpdateStatus, productKeyCipher=productKeyCipher, moduleRepairLogEntry=moduleRepairLogEntry)
