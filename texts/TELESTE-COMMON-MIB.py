...
ObjectIdentity, ModuleIdentity, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Unsigned32, Integer32, Counter64, Gauge32, NotificationType, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Unsigned32", "Integer32", "Counter64", "Gauge32", "NotificationType", "Bits", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSWUpdateTable=moduleSWUpdateTable, repairNameCode=repairNameCode, controlAlarmDetection=controlAlarmDetection, productKeyFeatureEnable=productKeyFeatureEnable, moduleMacAddress=moduleMacAddress, repairComment=repairComment, statusTemperature=statusTemperature, moduleEntry=moduleEntry, sizeOfRegistry=sizeOfRegistry, productKeyTable=productKeyTable, repairDate=repairDate, moduleHwSerialNumber=moduleHwSerialNumber, statusGeneral=statusGeneral, moduleInformation=moduleInformation, statusInternalTemperature=statusInternalTemperature, receiverEntryId=receiverEntryId, productKeyValue=productKeyValue, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRackNo=moduleRackNo, sWUpdateControl=sWUpdateControl, regIndex=regIndex, moduleDetailTable=moduleDetailTable, controlTempLimitLo=controlTempLimitLo, moduleRegistry=moduleRegistry, notebookLineText=notebookLineText, moduleDetailEntry=moduleDetailEntry, elementStructure=elementStructure, controlTempLimitHiHi=controlTempLimitHiHi, elementTotalUpTime=elementTotalUpTime, moduleStatusTable=moduleStatusTable, productKeyStatus=productKeyStatus, moduleControlEntry=moduleControlEntry, notebookLineNumber=notebookLineNumber, statusFan=statusFan, elementResetCount=elementResetCount, moduleStatusEntry=moduleStatusEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleHwVersion=moduleHwVersion, controlTrapDelay=controlTrapDelay, moduleSlotNo=moduleSlotNo, receiverPort=receiverPort, controlTempLimitHi=controlTempLimitHi, productKeyFeatureTable=productKeyFeatureTable, statusLidStatus=statusLidStatus, moduleControl=moduleControl, moduleSWUpdateEntry=moduleSWUpdateEntry, statusLid=statusLid, statusBusMaster=statusBusMaster, moduleName=moduleName, moduleHwType=moduleHwType, productKeyEntry=productKeyEntry, productKeyCipher=productKeyCipher, regValue=regValue, elementConfigChangeCode=elementConfigChangeCode, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapInterval=controlTrapInterval, controlTempDeadBand=controlTempDeadBand, moduleId=moduleId, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, statusLmt=statusLmt, controlInternalAppAccess=controlInternalAppAccess, statusSettings=statusSettings, repairReasonCode=repairReasonCode, statusHardware=statusHardware, statusRestartCounter=statusRestartCounter, productKeyNumberOfKeys=productKeyNumberOfKeys, elementInformation=elementInformation, module=module, controlReset=controlReset, moduleSizeOfEntry=moduleSizeOfEntry, sizeOfNotebook=sizeOfNotebook, moduleBiosVersion=moduleBiosVersion, productKeyIndex=productKeyIndex, regName=regName, controlAlarmOffDelay=controlAlarmOffDelay, elementLongitude=elementLongitude, element=element, moduleStatus=moduleStatus, sWUpdateFileName=sWUpdateFileName, controlBusMasterAdminState=controlBusMasterAdminState, moduleAppDate=moduleAppDate, productKeyFeatureName=productKeyFeatureName, moduleRegistryEntry=moduleRegistryEntry, statusSoftware=statusSoftware, controlLocalAccess=controlLocalAccess, moduleRegistryTable=moduleRegistryTable, sWUpdateStatus=sWUpdateStatus, moduleRepairLogTable=moduleRepairLogTable, moduleBusAddress=moduleBusAddress, productKeyMask=productKeyMask, moduleNotebookEntry=moduleNotebookEntry, moduleTable=moduleTable, elementControl=elementControl, sizeOfRepairlog=sizeOfRepairlog, controlResetElement=controlResetElement, controlTrapSending=controlTrapSending, repairIndex=repairIndex, receiverCommunity=receiverCommunity, elementProductKey=elementProductKey, elementName=elementName, statusResetCause=statusResetCause, controlTempLimitLoLo=controlTempLimitLoLo, moduleControlTable=moduleControlTable, elementAltitude=elementAltitude, swUpdateURL=swUpdateURL, moduleRepairLogEntry=moduleRepairLogEntry, controlMarkState=controlMarkState, moduleNotebookTable=moduleNotebookTable, elementLatitude=elementLatitude, statusRunningSwImage=statusRunningSwImage, moduleBiosDate=moduleBiosDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSizeOfTable=moduleSizeOfTable, controlAlarmOnDelay=controlAlarmOnDelay, elementStatus=elementStatus, controlTrapLifeTime=controlTrapLifeTime, receiverAddress=receiverAddress, moduleAppVersion=moduleAppVersion, controlLedUsage=controlLedUsage, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime)
