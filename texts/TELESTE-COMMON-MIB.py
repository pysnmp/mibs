...
IpAddress, TimeTicks, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Integer32, Gauge32, iso, MibIdentifier, Counter64, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Integer32", "Gauge32", "iso", "MibIdentifier", "Counter64", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleHwType=moduleHwType, moduleControlTable=moduleControlTable, statusLmt=statusLmt, elementStructure=elementStructure, moduleSizeOfTable=moduleSizeOfTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, notebookLineNumber=notebookLineNumber, statusFan=statusFan, statusBusMaster=statusBusMaster, statusResetCause=statusResetCause, moduleName=moduleName, module=module, moduleBiosDate=moduleBiosDate, moduleDetailEntry=moduleDetailEntry, regIndex=regIndex, receiverCommunity=receiverCommunity, moduleInformation=moduleInformation, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureIndex=productKeyFeatureIndex, receiverPort=receiverPort, controlTempDeadBand=controlTempDeadBand, productKeyValue=productKeyValue, controlLedUsage=controlLedUsage, moduleId=moduleId, statusSoftware=statusSoftware, sizeOfNotebook=sizeOfNotebook, repairComment=repairComment, sWUpdateStatus=sWUpdateStatus, controlTempLimitHiHi=controlTempLimitHiHi, moduleNotebookTable=moduleNotebookTable, controlTrapDelay=controlTrapDelay, statusHardware=statusHardware, elementProductKey=elementProductKey, productKeyTable=productKeyTable, moduleTable=moduleTable, regName=regName, moduleRepairLogTable=moduleRepairLogTable, repairDate=repairDate, moduleRegistryEntry=moduleRegistryEntry, moduleMacAddress=moduleMacAddress, elementConfigChangeCode=elementConfigChangeCode, moduleControlEntry=moduleControlEntry, moduleRepairLogEntry=moduleRepairLogEntry, moduleRegistry=moduleRegistry, moduleBiosVersion=moduleBiosVersion, controlAlarmOffDelay=controlAlarmOffDelay, sWUpdateFileName=sWUpdateFileName, statusLid=statusLid, controlTrapReceiverTable=controlTrapReceiverTable, moduleSWUpdateTable=moduleSWUpdateTable, statusTemperature=statusTemperature, controlResetElement=controlResetElement, controlTrapSending=controlTrapSending, moduleStatusEntry=moduleStatusEntry, swUpdateURL=swUpdateURL, controlTempLimitLoLo=controlTempLimitLoLo, controlAlarmOnDelay=controlAlarmOnDelay, statusSettings=statusSettings, moduleHwSerialNumber=moduleHwSerialNumber, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyFeatureEntry=productKeyFeatureEntry, statusInternalTemperature=statusInternalTemperature, sWUpdateControl=sWUpdateControl, elementName=elementName, regValue=regValue, statusLidStatus=statusLidStatus, statusRestartCounter=statusRestartCounter, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureEnable=productKeyFeatureEnable, elementLongitude=elementLongitude, elementInformation=elementInformation, repairNameCode=repairNameCode, productKeyCipher=productKeyCipher, productKeyFeatureName=productKeyFeatureName, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitHi=controlTempLimitHi, receiverAddress=receiverAddress, statusRunningSwImage=statusRunningSwImage, receiverEntryId=receiverEntryId, productKeyStatus=productKeyStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleNotebookEntry=moduleNotebookEntry, moduleStatusTable=moduleStatusTable, controlReset=controlReset, elementAltitude=elementAltitude, productKeyMask=productKeyMask, moduleAppVersion=moduleAppVersion, moduleSlotNo=moduleSlotNo, elementStatus=elementStatus, controlAlarmDetection=controlAlarmDetection, elementResetCount=elementResetCount, moduleEntry=moduleEntry, controlLocalAccess=controlLocalAccess, moduleStatus=moduleStatus, moduleRegistryTable=moduleRegistryTable, sizeOfRepairlog=sizeOfRepairlog, elementControl=elementControl, element=element, moduleRackNo=moduleRackNo, statusGeneral=statusGeneral, repairIndex=repairIndex, controlTrapLifeTime=controlTrapLifeTime, notebookLineText=notebookLineText, controlInternalAppAccess=controlInternalAppAccess, moduleHwVersion=moduleHwVersion, elementLatitude=elementLatitude, controlTempLimitLo=controlTempLimitLo, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleControl=moduleControl, moduleBusAddress=moduleBusAddress, moduleAppDate=moduleAppDate, elementTotalUpTime=elementTotalUpTime, productKeyIndex=productKeyIndex, sizeOfRegistry=sizeOfRegistry, moduleDetailTable=moduleDetailTable, controlMarkState=controlMarkState, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyEntry=productKeyEntry, controlBusMasterAdminState=controlBusMasterAdminState, repairReasonCode=repairReasonCode, controlTrapInterval=controlTrapInterval)
