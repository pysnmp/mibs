...
Counter32, TimeTicks, Integer32, Unsigned32, IpAddress, NotificationType, ObjectIdentity, Bits, Gauge32, ModuleIdentity, iso, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Integer32", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "Bits", "Gauge32", "ModuleIdentity", "iso", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusSoftware=statusSoftware, swUpdateURL=swUpdateURL, moduleControlTable=moduleControlTable, moduleHwType=moduleHwType, moduleEntry=moduleEntry, productKeyFeatureName=productKeyFeatureName, moduleTable=moduleTable, regValue=regValue, sWUpdateFileName=sWUpdateFileName, productKeyCipher=productKeyCipher, moduleName=moduleName, statusLidStatus=statusLidStatus, elementLatitude=elementLatitude, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairIndex=repairIndex, sizeOfNotebook=sizeOfNotebook, controlTrapReceiverTable=controlTrapReceiverTable, controlMarkState=controlMarkState, statusHardware=statusHardware, regIndex=regIndex, repairComment=repairComment, elementTotalUpTime=elementTotalUpTime, moduleHwVersion=moduleHwVersion, receiverEntryId=receiverEntryId, elementAltitude=elementAltitude, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatusEntry=moduleStatusEntry, productKeyFeatureTable=productKeyFeatureTable, productKeyNumberOfKeys=productKeyNumberOfKeys, statusTemperature=statusTemperature, moduleAppVersion=moduleAppVersion, controlAlarmOnDelay=controlAlarmOnDelay, productKeyEntry=productKeyEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleSizeOfEntry=moduleSizeOfEntry, controlAlarmDetection=controlAlarmDetection, moduleRegistryTable=moduleRegistryTable, receiverPort=receiverPort, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusInternalTemperature=statusInternalTemperature, statusFan=statusFan, productKeyFeatureIndex=productKeyFeatureIndex, productKeyValue=productKeyValue, statusRunningSwImage=statusRunningSwImage, sizeOfRegistry=sizeOfRegistry, moduleSlotNo=moduleSlotNo, elementStructure=elementStructure, controlTempLimitLo=controlTempLimitLo, controlResetElement=controlResetElement, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementConfigChangeCode=elementConfigChangeCode, element=element, statusGeneral=statusGeneral, moduleDetailTable=moduleDetailTable, moduleNotebookEntry=moduleNotebookEntry, statusBusMaster=statusBusMaster, moduleRegistryEntry=moduleRegistryEntry, productKeyTable=productKeyTable, moduleInformation=moduleInformation, moduleDetailEntry=moduleDetailEntry, controlBusMasterAdminState=controlBusMasterAdminState, elementLongitude=elementLongitude, elementInformation=elementInformation, controlAlarmOffDelay=controlAlarmOffDelay, controlLocalAccess=controlLocalAccess, moduleRepairLogTable=moduleRepairLogTable, moduleId=moduleId, controlLedUsage=controlLedUsage, moduleBiosVersion=moduleBiosVersion, controlTrapSending=controlTrapSending, regName=regName, controlInternalAppAccess=controlInternalAppAccess, productKeyIndex=productKeyIndex, moduleControl=moduleControl, sWUpdateControl=sWUpdateControl, productKeyFeatureEnable=productKeyFeatureEnable, moduleSizeOfTable=moduleSizeOfTable, statusLid=statusLid, controlTrapLifeTime=controlTrapLifeTime, moduleSWUpdateEntry=moduleSWUpdateEntry, elementControl=elementControl, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyStatus=productKeyStatus, moduleControlEntry=moduleControlEntry, statusRestartCounter=statusRestartCounter, statusLmt=statusLmt, moduleStatusTable=moduleStatusTable, controlTempLimitLoLo=controlTempLimitLoLo, moduleRackNo=moduleRackNo, moduleRegistry=moduleRegistry, repairDate=repairDate, elementName=elementName, productKeyFeatureEntry=productKeyFeatureEntry, controlTempLimitHi=controlTempLimitHi, statusResetCause=statusResetCause, sizeOfRepairlog=sizeOfRepairlog, notebookLineNumber=notebookLineNumber, notebookLineText=notebookLineText, controlTrapDelay=controlTrapDelay, module=module, repairReasonCode=repairReasonCode, moduleBiosDate=moduleBiosDate, receiverCommunity=receiverCommunity, moduleMacAddress=moduleMacAddress, receiverAddress=receiverAddress, elementResetCount=elementResetCount, elementStatus=elementStatus, moduleStatus=moduleStatus, controlReset=controlReset, sWUpdateStatus=sWUpdateStatus, productKeyMask=productKeyMask, elementProductKey=elementProductKey, moduleRepairLogEntry=moduleRepairLogEntry, moduleNotebookTable=moduleNotebookTable, moduleBusAddress=moduleBusAddress, controlTempDeadBand=controlTempDeadBand, repairNameCode=repairNameCode, statusSettings=statusSettings, controlTrapInterval=controlTrapInterval, moduleAppDate=moduleAppDate, moduleHwSerialNumber=moduleHwSerialNumber)
