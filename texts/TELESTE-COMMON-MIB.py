...
Unsigned32, ObjectIdentity, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, MibIdentifier, IpAddress, TimeTicks, NotificationType, Counter32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "TimeTicks", "NotificationType", "Counter32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleDetailTable=moduleDetailTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlReset=controlReset, notebookLineNumber=notebookLineNumber, controlTempLimitHi=controlTempLimitHi, elementLongitude=elementLongitude, receiverCommunity=receiverCommunity, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, controlTempLimitLo=controlTempLimitLo, elementInformation=elementInformation, sWUpdateFileName=sWUpdateFileName, productKeyFeatureTable=productKeyFeatureTable, controlAlarmDetection=controlAlarmDetection, regIndex=regIndex, controlTrapLifeTime=controlTrapLifeTime, repairNameCode=repairNameCode, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyTable=productKeyTable, productKeyValue=productKeyValue, statusBusMaster=statusBusMaster, controlBusMasterAdminState=controlBusMasterAdminState, moduleAppDate=moduleAppDate, elementTotalUpTime=elementTotalUpTime, statusSettings=statusSettings, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRegistry=moduleRegistry, module=module, statusRunningSwImage=statusRunningSwImage, controlTrapReceiverTable=controlTrapReceiverTable, productKeyEntry=productKeyEntry, statusLid=statusLid, elementLatitude=elementLatitude, moduleNotebookEntry=moduleNotebookEntry, moduleRegistryTable=moduleRegistryTable, productKeyMask=productKeyMask, receiverPort=receiverPort, sizeOfRegistry=sizeOfRegistry, controlAlarmOffDelay=controlAlarmOffDelay, elementName=elementName, controlTempLimitLoLo=controlTempLimitLoLo, repairReasonCode=repairReasonCode, repairIndex=repairIndex, moduleControlEntry=moduleControlEntry, moduleRepairLogTable=moduleRepairLogTable, controlInternalAppAccess=controlInternalAppAccess, notebookLineText=notebookLineText, element=element, moduleBusAddress=moduleBusAddress, moduleStatusTable=moduleStatusTable, moduleHwType=moduleHwType, elementConfigChangeCode=elementConfigChangeCode, controlLocalAccess=controlLocalAccess, statusGeneral=statusGeneral, moduleTable=moduleTable, controlTrapInterval=controlTrapInterval, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistryEntry=moduleRegistryEntry, swUpdateURL=swUpdateURL, sWUpdateControl=sWUpdateControl, statusLidStatus=statusLidStatus, statusSoftware=statusSoftware, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapDelay=controlTrapDelay, elementControl=elementControl, statusFan=statusFan, productKeyFeatureIndex=productKeyFeatureIndex, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, productKeyFeatureEnable=productKeyFeatureEnable, statusInternalTemperature=statusInternalTemperature, productKeyIndex=productKeyIndex, elementResetCount=elementResetCount, statusHardware=statusHardware, moduleName=moduleName, moduleSizeOfEntry=moduleSizeOfEntry, moduleBiosDate=moduleBiosDate, moduleId=moduleId, moduleEntry=moduleEntry, statusResetCause=statusResetCause, controlTempDeadBand=controlTempDeadBand, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitHiHi=controlTempLimitHiHi, elementProductKey=elementProductKey, statusTemperature=statusTemperature, moduleHwVersion=moduleHwVersion, moduleAppVersion=moduleAppVersion, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleMacAddress=moduleMacAddress, moduleRackNo=moduleRackNo, repairComment=repairComment, moduleHwSerialNumber=moduleHwSerialNumber, statusRestartCounter=statusRestartCounter, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogEntry=moduleRepairLogEntry, productKeyCipher=productKeyCipher, repairDate=repairDate, moduleStatusEntry=moduleStatusEntry, receiverAddress=receiverAddress, moduleControlTable=moduleControlTable, receiverEntryId=receiverEntryId, controlMarkState=controlMarkState, regValue=regValue, productKeyStatus=productKeyStatus, moduleBiosVersion=moduleBiosVersion, regName=regName, productKeyNumberOfKeys=productKeyNumberOfKeys, elementAltitude=elementAltitude, elementStatus=elementStatus, moduleControl=moduleControl, productKeyFeatureName=productKeyFeatureName, moduleInformation=moduleInformation, moduleNotebookTable=moduleNotebookTable, moduleStatus=moduleStatus, sWUpdateStatus=sWUpdateStatus, sizeOfRepairlog=sizeOfRepairlog, controlResetElement=controlResetElement, controlTrapSending=controlTrapSending, moduleDetailEntry=moduleDetailEntry, elementStructure=elementStructure)
