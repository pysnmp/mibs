...
Bits, Counter32, ModuleIdentity, Unsigned32, ObjectIdentity, NotificationType, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Gauge32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "NotificationType", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Gauge32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleEntry=moduleEntry, controlLedUsage=controlLedUsage, controlMarkState=controlMarkState, controlAlarmDetection=controlAlarmDetection, notebookLineText=notebookLineText, productKeyCipher=productKeyCipher, moduleAppVersion=moduleAppVersion, statusInternalTemperature=statusInternalTemperature, statusResetCause=statusResetCause, elementInformation=elementInformation, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlInternalAppAccess=controlInternalAppAccess, moduleDetailEntry=moduleDetailEntry, moduleBiosVersion=moduleBiosVersion, elementResetCount=elementResetCount, sWUpdateControl=sWUpdateControl, controlTrapReceiverTable=controlTrapReceiverTable, productKeyNumberOfKeys=productKeyNumberOfKeys, statusBusMaster=statusBusMaster, moduleTable=moduleTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleControl=moduleControl, sizeOfNotebook=sizeOfNotebook, moduleRepairLogEntry=moduleRepairLogEntry, moduleStatus=moduleStatus, productKeyFeatureName=productKeyFeatureName, productKeyStatus=productKeyStatus, regName=regName, moduleBusAddress=moduleBusAddress, repairNameCode=repairNameCode, statusTemperature=statusTemperature, productKeyMask=productKeyMask, receiverAddress=receiverAddress, moduleSWUpdateTable=moduleSWUpdateTable, elementStructure=elementStructure, statusLmt=statusLmt, controlTrapLifeTime=controlTrapLifeTime, productKeyEntry=productKeyEntry, statusRestartCounter=statusRestartCounter, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairReasonCode=repairReasonCode, moduleAppDate=moduleAppDate, statusSettings=statusSettings, elementTotalUpTime=elementTotalUpTime, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSlotNo=moduleSlotNo, swUpdateURL=swUpdateURL, productKeyValue=productKeyValue, moduleName=moduleName, elementProductKey=elementProductKey, moduleHwType=moduleHwType, module=module, elementControl=elementControl, controlAlarmOffDelay=controlAlarmOffDelay, moduleSizeOfEntry=moduleSizeOfEntry, productKeyTable=productKeyTable, controlBusMasterAdminState=controlBusMasterAdminState, moduleStatusEntry=moduleStatusEntry, statusRunningSwImage=statusRunningSwImage, repairComment=repairComment, controlTrapReceiverEntry=controlTrapReceiverEntry, element=element, statusHardware=statusHardware, controlTempLimitLoLo=controlTempLimitLoLo, elementConfigChangeCode=elementConfigChangeCode, moduleBiosDate=moduleBiosDate, controlTempLimitLo=controlTempLimitLo, repairIndex=repairIndex, moduleId=moduleId, sWUpdateStatus=sWUpdateStatus, productKeyFeatureEntry=productKeyFeatureEntry, elementLongitude=elementLongitude, receiverPort=receiverPort, moduleNotebookEntry=moduleNotebookEntry, controlLocalAccess=controlLocalAccess, productKeyFeatureEnable=productKeyFeatureEnable, regValue=regValue, moduleHwSerialNumber=moduleHwSerialNumber, elementAltitude=elementAltitude, sWUpdateFileName=sWUpdateFileName, controlTrapSending=controlTrapSending, elementLatitude=elementLatitude, moduleRegistryTable=moduleRegistryTable, moduleRegistry=moduleRegistry, productKeyIndex=productKeyIndex, moduleDetailTable=moduleDetailTable, moduleInformation=moduleInformation, elementName=elementName, moduleRackNo=moduleRackNo, moduleRepairLogTable=moduleRepairLogTable, moduleSizeOfTable=moduleSizeOfTable, controlReset=controlReset, controlTempLimitHi=controlTempLimitHi, sizeOfRepairlog=sizeOfRepairlog, controlResetElement=controlResetElement, controlTrapInterval=controlTrapInterval, moduleMacAddress=moduleMacAddress, elementStatus=elementStatus, notebookLineNumber=notebookLineNumber, productKeyFeatureIndex=productKeyFeatureIndex, moduleControlTable=moduleControlTable, statusGeneral=statusGeneral, statusFan=statusFan, repairDate=repairDate, moduleStatusTable=moduleStatusTable, statusLid=statusLid, controlAlarmOnDelay=controlAlarmOnDelay, statusLidStatus=statusLidStatus, receiverCommunity=receiverCommunity, moduleSWUpdateEntry=moduleSWUpdateEntry, sizeOfRegistry=sizeOfRegistry, regIndex=regIndex, moduleHwVersion=moduleHwVersion, controlTempDeadBand=controlTempDeadBand, statusSoftware=statusSoftware, productKeyFeatureTable=productKeyFeatureTable, moduleControlEntry=moduleControlEntry, receiverEntryId=receiverEntryId, moduleRegistryEntry=moduleRegistryEntry, moduleNotebookTable=moduleNotebookTable, controlTrapDelay=controlTrapDelay)
