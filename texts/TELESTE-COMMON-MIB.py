...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapDelay=controlTrapDelay, controlInternalAppAccess=controlInternalAppAccess, statusSoftware=statusSoftware, productKeyFeatureEnable=productKeyFeatureEnable, controlBusMasterAdminState=controlBusMasterAdminState, controlMarkState=controlMarkState, moduleStatus=moduleStatus, moduleStatusTable=moduleStatusTable, regIndex=regIndex, elementConfigChangeCode=elementConfigChangeCode, moduleSWUpdateTable=moduleSWUpdateTable, controlAlarmOnDelay=controlAlarmOnDelay, productKeyValue=productKeyValue, moduleRegistry=moduleRegistry, moduleMacAddress=moduleMacAddress, statusInternalTemperature=statusInternalTemperature, elementInformation=elementInformation, repairReasonCode=repairReasonCode, repairDate=repairDate, moduleId=moduleId, sWUpdateControl=sWUpdateControl, controlTempLimitLoLo=controlTempLimitLoLo, sizeOfNotebook=sizeOfNotebook, controlTempDeadBand=controlTempDeadBand, moduleRackNo=moduleRackNo, statusLmt=statusLmt, elementAltitude=elementAltitude, module=module, moduleRegistryTable=moduleRegistryTable, productKeyEntry=productKeyEntry, statusFan=statusFan, controlLocalAccess=controlLocalAccess, productKeyCipher=productKeyCipher, moduleDetailEntry=moduleDetailEntry, moduleNotebookEntry=moduleNotebookEntry, statusLidStatus=statusLidStatus, statusBusMaster=statusBusMaster, productKeyFeatureIndex=productKeyFeatureIndex, swUpdateURL=swUpdateURL, repairIndex=repairIndex, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureName=productKeyFeatureName, elementName=elementName, elementLongitude=elementLongitude, moduleBiosVersion=moduleBiosVersion, moduleControl=moduleControl, productKeyFeatureEntry=productKeyFeatureEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwType=moduleHwType, controlLedUsage=controlLedUsage, elementStatus=elementStatus, statusLid=statusLid, sizeOfRegistry=sizeOfRegistry, receiverEntryId=receiverEntryId, moduleSlotNo=moduleSlotNo, statusResetCause=statusResetCause, statusRestartCounter=statusRestartCounter, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBiosDate=moduleBiosDate, moduleBusAddress=moduleBusAddress, moduleDetailTable=moduleDetailTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleHwVersion=moduleHwVersion, statusGeneral=statusGeneral, moduleName=moduleName, regName=regName, controlReset=controlReset, moduleInformation=moduleInformation, productKeyNumberOfKeys=productKeyNumberOfKeys, receiverCommunity=receiverCommunity, elementControl=elementControl, statusSettings=statusSettings, moduleHwSerialNumber=moduleHwSerialNumber, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogEntry=moduleRepairLogEntry, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureTable=productKeyFeatureTable, repairComment=repairComment, moduleEntry=moduleEntry, moduleControlTable=moduleControlTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementProductKey=elementProductKey, elementStructure=elementStructure, moduleControlEntry=moduleControlEntry, statusHardware=statusHardware, productKeyMask=productKeyMask, moduleStatusEntry=moduleStatusEntry, statusRunningSwImage=statusRunningSwImage, receiverPort=receiverPort, productKeyStatus=productKeyStatus, moduleNotebookTable=moduleNotebookTable, controlAlarmDetection=controlAlarmDetection, controlTempLimitHiHi=controlTempLimitHiHi, moduleSizeOfEntry=moduleSizeOfEntry, productKeyTable=productKeyTable, moduleAppDate=moduleAppDate, controlTempLimitHi=controlTempLimitHi, controlTrapSending=controlTrapSending, notebookLineText=notebookLineText, controlResetElement=controlResetElement, regValue=regValue, elementLatitude=elementLatitude, moduleSizeOfTable=moduleSizeOfTable, repairNameCode=repairNameCode, sWUpdateStatus=sWUpdateStatus, sizeOfRepairlog=sizeOfRepairlog, moduleAppVersion=moduleAppVersion, controlTrapReceiverTable=controlTrapReceiverTable, elementTotalUpTime=elementTotalUpTime, controlTempLimitLo=controlTempLimitLo, element=element, productKeyIndex=productKeyIndex, statusTemperature=statusTemperature, moduleTable=moduleTable, sWUpdateFileName=sWUpdateFileName, receiverAddress=receiverAddress, controlAlarmOffDelay=controlAlarmOffDelay, elementResetCount=elementResetCount, notebookLineNumber=notebookLineNumber, controlTrapInterval=controlTrapInterval, moduleSWUpdateEntry=moduleSWUpdateEntry)
