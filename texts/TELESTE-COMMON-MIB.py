...
iso, ObjectIdentity, Counter64, IpAddress, NotificationType, Integer32, Gauge32, Bits, MibIdentifier, Counter32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Counter64", "IpAddress", "NotificationType", "Integer32", "Gauge32", "Bits", "MibIdentifier", "Counter32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRegistryTable=moduleRegistryTable, productKeyIndex=productKeyIndex, productKeyMask=productKeyMask, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusGeneral=statusGeneral, moduleRackNo=moduleRackNo, moduleAppVersion=moduleAppVersion, moduleMacAddress=moduleMacAddress, moduleId=moduleId, elementStatus=elementStatus, moduleEntry=moduleEntry, moduleBiosDate=moduleBiosDate, receiverEntryId=receiverEntryId, controlAlarmOnDelay=controlAlarmOnDelay, statusRunningSwImage=statusRunningSwImage, statusFan=statusFan, elementControl=elementControl, controlTrapReceiverTable=controlTrapReceiverTable, controlResetElement=controlResetElement, productKeyFeatureTable=productKeyFeatureTable, sWUpdateControl=sWUpdateControl, productKeyFeatureEntry=productKeyFeatureEntry, moduleTable=moduleTable, element=element, statusTemperature=statusTemperature, elementInformation=elementInformation, productKeyCipher=productKeyCipher, receiverCommunity=receiverCommunity, controlAlarmDetection=controlAlarmDetection, elementResetCount=elementResetCount, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapLifeTime=controlTrapLifeTime, notebookLineNumber=notebookLineNumber, moduleStatusEntry=moduleStatusEntry, notebookLineText=notebookLineText, controlLocalAccess=controlLocalAccess, controlMarkState=controlMarkState, moduleSizeOfEntry=moduleSizeOfEntry, receiverPort=receiverPort, elementStructure=elementStructure, productKeyFeatureName=productKeyFeatureName, controlTrapInterval=controlTrapInterval, repairReasonCode=repairReasonCode, controlTempLimitLo=controlTempLimitLo, moduleSizeOfTable=moduleSizeOfTable, statusLid=statusLid, moduleControl=moduleControl, sWUpdateStatus=sWUpdateStatus, elementConfigChangeCode=elementConfigChangeCode, moduleSlotNo=moduleSlotNo, moduleHwType=moduleHwType, controlInternalAppAccess=controlInternalAppAccess, elementAltitude=elementAltitude, moduleRepairLogTable=moduleRepairLogTable, controlTempLimitHi=controlTempLimitHi, statusHardware=statusHardware, moduleName=moduleName, controlTempLimitHiHi=controlTempLimitHiHi, moduleBusAddress=moduleBusAddress, elementName=elementName, moduleBiosVersion=moduleBiosVersion, statusRestartCounter=statusRestartCounter, moduleNotebookTable=moduleNotebookTable, controlLedUsage=controlLedUsage, productKeyFeatureIndex=productKeyFeatureIndex, regValue=regValue, productKeyValue=productKeyValue, productKeyEntry=productKeyEntry, controlTrapSending=controlTrapSending, regName=regName, controlBusMasterAdminState=controlBusMasterAdminState, statusBusMaster=statusBusMaster, controlTempLimitLoLo=controlTempLimitLoLo, elementLatitude=elementLatitude, controlTrapReceiverEntry=controlTrapReceiverEntry, sizeOfRegistry=sizeOfRegistry, controlTempDeadBand=controlTempDeadBand, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapDelay=controlTrapDelay, moduleDetailEntry=moduleDetailEntry, swUpdateURL=swUpdateURL, elementTotalUpTime=elementTotalUpTime, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEnable=productKeyFeatureEnable, moduleInformation=moduleInformation, elementLongitude=elementLongitude, moduleControlEntry=moduleControlEntry, moduleHwVersion=moduleHwVersion, elementProductKey=elementProductKey, repairIndex=repairIndex, moduleHwSerialNumber=moduleHwSerialNumber, sWUpdateFileName=sWUpdateFileName, moduleSWUpdateTable=moduleSWUpdateTable, moduleSWUpdateEntry=moduleSWUpdateEntry, sizeOfNotebook=sizeOfNotebook, productKeyStatus=productKeyStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyTable=productKeyTable, receiverAddress=receiverAddress, moduleRegistryEntry=moduleRegistryEntry, controlReset=controlReset, moduleNotebookEntry=moduleNotebookEntry, moduleDetailTable=moduleDetailTable, regIndex=regIndex, moduleAppDate=moduleAppDate, statusSettings=statusSettings, moduleStatus=moduleStatus, moduleRegistry=moduleRegistry, statusLmt=statusLmt, statusInternalTemperature=statusInternalTemperature, repairDate=repairDate, repairComment=repairComment, statusSoftware=statusSoftware, moduleStatusTable=moduleStatusTable, module=module, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairNameCode=repairNameCode, statusLidStatus=statusLidStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusResetCause=statusResetCause, moduleControlTable=moduleControlTable)
