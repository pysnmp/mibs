...
MibIdentifier, ModuleIdentity, NotificationType, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, ObjectIdentity, Unsigned32, IpAddress, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementTotalUpTime=elementTotalUpTime, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleAppVersion=moduleAppVersion, swUpdateURL=swUpdateURL, statusBusMaster=statusBusMaster, controlLedUsage=controlLedUsage, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementControl=elementControl, productKeyStatus=productKeyStatus, moduleDetailTable=moduleDetailTable, repairReasonCode=repairReasonCode, regName=regName, productKeyValue=productKeyValue, statusHardware=statusHardware, moduleBiosDate=moduleBiosDate, controlBusMasterAdminState=controlBusMasterAdminState, controlMarkState=controlMarkState, controlLocalAccess=controlLocalAccess, statusGeneral=statusGeneral, moduleNotebookEntry=moduleNotebookEntry, elementAltitude=elementAltitude, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleHwVersion=moduleHwVersion, sWUpdateStatus=sWUpdateStatus, productKeyIndex=productKeyIndex, sizeOfNotebook=sizeOfNotebook, notebookLineText=notebookLineText, receiverAddress=receiverAddress, moduleTable=moduleTable, moduleStatusTable=moduleStatusTable, sizeOfRegistry=sizeOfRegistry, moduleControl=moduleControl, repairComment=repairComment, productKeyMask=productKeyMask, repairDate=repairDate, moduleId=moduleId, productKeyEntry=productKeyEntry, receiverPort=receiverPort, elementResetCount=elementResetCount, controlTempDeadBand=controlTempDeadBand, elementStatus=elementStatus, productKeyTable=productKeyTable, moduleRepairLogTable=moduleRepairLogTable, elementConfigChangeCode=elementConfigChangeCode, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureTable=productKeyFeatureTable, element=element, elementStructure=elementStructure, receiverEntryId=receiverEntryId, moduleAppDate=moduleAppDate, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapDelay=controlTrapDelay, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmDetection=controlAlarmDetection, moduleBiosVersion=moduleBiosVersion, moduleStatus=moduleStatus, moduleSWUpdateTable=moduleSWUpdateTable, moduleInformation=moduleInformation, controlAlarmOnDelay=controlAlarmOnDelay, receiverCommunity=receiverCommunity, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistry=moduleRegistry, statusSoftware=statusSoftware, productKeyFeatureName=productKeyFeatureName, moduleRegistryEntry=moduleRegistryEntry, moduleHwType=moduleHwType, moduleDetailEntry=moduleDetailEntry, moduleRegistryTable=moduleRegistryTable, statusInternalTemperature=statusInternalTemperature, repairIndex=repairIndex, moduleHwSerialNumber=moduleHwSerialNumber, controlResetElement=controlResetElement, controlTempLimitLoLo=controlTempLimitLoLo, moduleRepairLogEntry=moduleRepairLogEntry, controlAlarmOffDelay=controlAlarmOffDelay, sizeOfRepairlog=sizeOfRepairlog, statusLidStatus=statusLidStatus, productKeyCipher=productKeyCipher, elementProductKey=elementProductKey, moduleSizeOfTable=moduleSizeOfTable, elementLongitude=elementLongitude, statusResetCause=statusResetCause, moduleStatusEntry=moduleStatusEntry, sWUpdateControl=sWUpdateControl, regValue=regValue, controlTempLimitLo=controlTempLimitLo, moduleMacAddress=moduleMacAddress, sWUpdateFileName=sWUpdateFileName, statusFan=statusFan, moduleName=moduleName, statusRestartCounter=statusRestartCounter, regIndex=regIndex, controlTrapSending=controlTrapSending, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitHi=controlTempLimitHi, moduleSWUpdateEntry=moduleSWUpdateEntry, module=module, elementLatitude=elementLatitude, moduleRackNo=moduleRackNo, controlTrapInterval=controlTrapInterval, moduleBusAddress=moduleBusAddress, statusRunningSwImage=statusRunningSwImage, moduleNotebookTable=moduleNotebookTable, controlTrapLifeTime=controlTrapLifeTime, moduleControlTable=moduleControlTable, controlReset=controlReset, productKeyFeatureEntry=productKeyFeatureEntry, moduleSlotNo=moduleSlotNo, controlTempLimitHiHi=controlTempLimitHiHi, elementName=elementName, moduleEntry=moduleEntry, notebookLineNumber=notebookLineNumber, statusTemperature=statusTemperature, statusLid=statusLid, statusLmt=statusLmt, elementInformation=elementInformation, statusSettings=statusSettings, moduleControlEntry=moduleControlEntry, repairNameCode=repairNameCode)
