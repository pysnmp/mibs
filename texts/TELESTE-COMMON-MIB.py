...
Unsigned32, MibIdentifier, Gauge32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ObjectIdentity, Bits, Integer32, ModuleIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Gauge32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ObjectIdentity", "Bits", "Integer32", "ModuleIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairIndex=repairIndex, moduleTable=moduleTable, module=module, productKeyFeatureName=productKeyFeatureName, elementStructure=elementStructure, statusLmt=statusLmt, regName=regName, productKeyFeatureEntry=productKeyFeatureEntry, controlAlarmOnDelay=controlAlarmOnDelay, moduleStatus=moduleStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSlotNo=moduleSlotNo, controlTempLimitHiHi=controlTempLimitHiHi, controlTempLimitHi=controlTempLimitHi, elementInformation=elementInformation, moduleHwType=moduleHwType, statusSettings=statusSettings, moduleEntry=moduleEntry, moduleDetailEntry=moduleDetailEntry, receiverCommunity=receiverCommunity, sizeOfRegistry=sizeOfRegistry, moduleControlTable=moduleControlTable, moduleBiosVersion=moduleBiosVersion, moduleRepairLogTable=moduleRepairLogTable, moduleAppDate=moduleAppDate, moduleStatusTable=moduleStatusTable, repairComment=repairComment, moduleNotebookEntry=moduleNotebookEntry, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistry=moduleRegistry, moduleBiosDate=moduleBiosDate, productKeyTable=productKeyTable, sWUpdateFileName=sWUpdateFileName, notebookLineText=notebookLineText, elementControl=elementControl, elementProductKey=elementProductKey, statusInternalTemperature=statusInternalTemperature, elementLongitude=elementLongitude, moduleRegistryTable=moduleRegistryTable, receiverPort=receiverPort, repairDate=repairDate, moduleSWUpdateTable=moduleSWUpdateTable, sizeOfNotebook=sizeOfNotebook, regValue=regValue, controlAlarmDetection=controlAlarmDetection, statusGeneral=statusGeneral, productKeyStatus=productKeyStatus, statusRunningSwImage=statusRunningSwImage, moduleHwSerialNumber=moduleHwSerialNumber, elementAltitude=elementAltitude, productKeyFeatureIndex=productKeyFeatureIndex, moduleSizeOfEntry=moduleSizeOfEntry, controlResetElement=controlResetElement, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusRestartCounter=statusRestartCounter, controlTempLimitLo=controlTempLimitLo, statusTemperature=statusTemperature, moduleAppVersion=moduleAppVersion, moduleId=moduleId, swUpdateURL=swUpdateURL, notebookLineNumber=notebookLineNumber, regIndex=regIndex, productKeyCipher=productKeyCipher, statusSoftware=statusSoftware, sWUpdateControl=sWUpdateControl, moduleRegistryEntry=moduleRegistryEntry, elementStatus=elementStatus, productKeyIndex=productKeyIndex, statusLid=statusLid, sWUpdateStatus=sWUpdateStatus, moduleControl=moduleControl, controlTrapLifeTime=controlTrapLifeTime, statusLidStatus=statusLidStatus, elementLatitude=elementLatitude, moduleHwVersion=moduleHwVersion, statusFan=statusFan, controlTrapSending=controlTrapSending, repairReasonCode=repairReasonCode, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBusAddress=moduleBusAddress, moduleStatusEntry=moduleStatusEntry, elementResetCount=elementResetCount, moduleName=moduleName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleDetailTable=moduleDetailTable, controlTrapReceiverEntry=controlTrapReceiverEntry, elementTotalUpTime=elementTotalUpTime, controlLocalAccess=controlLocalAccess, moduleNotebookTable=moduleNotebookTable, statusHardware=statusHardware, elementName=elementName, controlTempLimitLoLo=controlTempLimitLoLo, sizeOfRepairlog=sizeOfRepairlog, controlLedUsage=controlLedUsage, controlInternalAppAccess=controlInternalAppAccess, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyValue=productKeyValue, productKeyFeatureTable=productKeyFeatureTable, controlTempDeadBand=controlTempDeadBand, moduleSizeOfTable=moduleSizeOfTable, receiverEntryId=receiverEntryId, repairNameCode=repairNameCode, productKeyEntry=productKeyEntry, productKeyFeatureEnable=productKeyFeatureEnable, statusResetCause=statusResetCause, moduleControlEntry=moduleControlEntry, moduleRepairLogEntry=moduleRepairLogEntry, productKeyMask=productKeyMask, elementConfigChangeCode=elementConfigChangeCode, moduleMacAddress=moduleMacAddress, controlTrapInterval=controlTrapInterval, statusBusMaster=statusBusMaster, moduleRackNo=moduleRackNo, controlMarkState=controlMarkState, controlTrapDelay=controlTrapDelay, moduleInformation=moduleInformation, element=element, receiverAddress=receiverAddress, controlReset=controlReset, controlAlarmOffDelay=controlAlarmOffDelay)
