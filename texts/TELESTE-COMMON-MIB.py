...
Counter32, TimeTicks, NotificationType, ModuleIdentity, iso, MibIdentifier, Integer32, Gauge32, Bits, ObjectIdentity, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "NotificationType", "ModuleIdentity", "iso", "MibIdentifier", "Integer32", "Gauge32", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRepairLogEntry=moduleRepairLogEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistryEntry=moduleRegistryEntry, elementName=elementName, moduleControlTable=moduleControlTable, controlReset=controlReset, moduleId=moduleId, notebookLineNumber=notebookLineNumber, statusSettings=statusSettings, moduleRepairLogTable=moduleRepairLogTable, elementStructure=elementStructure, productKeyFeatureIndex=productKeyFeatureIndex, controlInternalAppAccess=controlInternalAppAccess, elementAltitude=elementAltitude, moduleNotebookEntry=moduleNotebookEntry, moduleRegistryTable=moduleRegistryTable, statusGeneral=statusGeneral, moduleBusAddress=moduleBusAddress, moduleSlotNo=moduleSlotNo, moduleBiosDate=moduleBiosDate, moduleTable=moduleTable, moduleHwType=moduleHwType, elementProductKey=elementProductKey, elementStatus=elementStatus, statusHardware=statusHardware, moduleNotebookTable=moduleNotebookTable, elementResetCount=elementResetCount, moduleHwVersion=moduleHwVersion, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateControl=sWUpdateControl, statusTemperature=statusTemperature, moduleBiosVersion=moduleBiosVersion, statusLid=statusLid, moduleSWUpdateTable=moduleSWUpdateTable, elementConfigChangeCode=elementConfigChangeCode, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, regName=regName, repairDate=repairDate, controlResetElement=controlResetElement, moduleStatus=moduleStatus, repairNameCode=repairNameCode, controlTempLimitLo=controlTempLimitLo, controlAlarmOnDelay=controlAlarmOnDelay, controlTempLimitHiHi=controlTempLimitHiHi, moduleName=moduleName, elementTotalUpTime=elementTotalUpTime, elementLatitude=elementLatitude, statusBusMaster=statusBusMaster, statusRestartCounter=statusRestartCounter, moduleControl=moduleControl, controlMarkState=controlMarkState, controlTrapInterval=controlTrapInterval, controlTempDeadBand=controlTempDeadBand, elementControl=elementControl, repairReasonCode=repairReasonCode, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapLifeTime=controlTrapLifeTime, statusSoftware=statusSoftware, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapDelay=controlTrapDelay, moduleAppDate=moduleAppDate, moduleHwSerialNumber=moduleHwSerialNumber, productKeyCipher=productKeyCipher, receiverAddress=receiverAddress, productKeyEntry=productKeyEntry, productKeyFeatureTable=productKeyFeatureTable, productKeyValue=productKeyValue, moduleDetailEntry=moduleDetailEntry, statusResetCause=statusResetCause, controlAlarmOffDelay=controlAlarmOffDelay, moduleControlEntry=moduleControlEntry, element=element, productKeyMask=productKeyMask, swUpdateURL=swUpdateURL, sizeOfRegistry=sizeOfRegistry, receiverCommunity=receiverCommunity, controlTempLimitLoLo=controlTempLimitLoLo, sWUpdateStatus=sWUpdateStatus, controlLedUsage=controlLedUsage, regValue=regValue, repairIndex=repairIndex, moduleStatusEntry=moduleStatusEntry, productKeyFeatureEntry=productKeyFeatureEntry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppVersion=moduleAppVersion, statusLmt=statusLmt, sizeOfRepairlog=sizeOfRepairlog, moduleMacAddress=moduleMacAddress, statusLidStatus=statusLidStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusInternalTemperature=statusInternalTemperature, sWUpdateFileName=sWUpdateFileName, productKeyFeatureName=productKeyFeatureName, moduleEntry=moduleEntry, statusFan=statusFan, module=module, elementInformation=elementInformation, moduleStatusTable=moduleStatusTable, moduleSWUpdateEntry=moduleSWUpdateEntry, repairComment=repairComment, notebookLineText=notebookLineText, controlAlarmDetection=controlAlarmDetection, productKeyIndex=productKeyIndex, moduleRegistry=moduleRegistry, elementLongitude=elementLongitude, productKeyTable=productKeyTable, receiverPort=receiverPort, sizeOfNotebook=sizeOfNotebook, moduleSizeOfTable=moduleSizeOfTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlLocalAccess=controlLocalAccess, regIndex=regIndex, productKeyStatus=productKeyStatus, receiverEntryId=receiverEntryId, controlTrapSending=controlTrapSending, moduleInformation=moduleInformation, moduleDetailTable=moduleDetailTable, moduleRackNo=moduleRackNo, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitHi=controlTempLimitHi)
