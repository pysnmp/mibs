...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapInterval=controlTrapInterval, elementName=elementName, repairNameCode=repairNameCode, controlInternalAppAccess=controlInternalAppAccess, elementAltitude=elementAltitude, receiverAddress=receiverAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementLongitude=elementLongitude, statusInternalTemperature=statusInternalTemperature, controlLedUsage=controlLedUsage, moduleEntry=moduleEntry, elementStructure=elementStructure, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusGeneral=statusGeneral, receiverCommunity=receiverCommunity, sizeOfRegistry=sizeOfRegistry, moduleMacAddress=moduleMacAddress, moduleRackNo=moduleRackNo, moduleId=moduleId, moduleHwSerialNumber=moduleHwSerialNumber, controlTrapLifeTime=controlTrapLifeTime, moduleStatusEntry=moduleStatusEntry, moduleBiosDate=moduleBiosDate, moduleStatusTable=moduleStatusTable, moduleAppVersion=moduleAppVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, notebookLineText=notebookLineText, element=element, moduleRepairLogEntry=moduleRepairLogEntry, productKeyFeatureTable=productKeyFeatureTable, moduleSlotNo=moduleSlotNo, moduleNotebookEntry=moduleNotebookEntry, moduleRegistryTable=moduleRegistryTable, moduleName=moduleName, moduleRegistryEntry=moduleRegistryEntry, controlTempLimitLoLo=controlTempLimitLoLo, swUpdateURL=swUpdateURL, statusLid=statusLid, moduleSWUpdateTable=moduleSWUpdateTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusTemperature=statusTemperature, controlTrapReceiverEntry=controlTrapReceiverEntry, controlReset=controlReset, receiverPort=receiverPort, productKeyEntry=productKeyEntry, sizeOfNotebook=sizeOfNotebook, regName=regName, controlAlarmDetection=controlAlarmDetection, controlAlarmOffDelay=controlAlarmOffDelay, sWUpdateFileName=sWUpdateFileName, productKeyFeatureIndex=productKeyFeatureIndex, statusHardware=statusHardware, notebookLineNumber=notebookLineNumber, statusLmt=statusLmt, productKeyStatus=productKeyStatus, moduleHwType=moduleHwType, statusRunningSwImage=statusRunningSwImage, moduleRepairLogTable=moduleRepairLogTable, statusBusMaster=statusBusMaster, repairIndex=repairIndex, repairComment=repairComment, moduleControlTable=moduleControlTable, controlTempLimitLo=controlTempLimitLo, productKeyIndex=productKeyIndex, moduleInformation=moduleInformation, productKeyTable=productKeyTable, statusSettings=statusSettings, controlTempDeadBand=controlTempDeadBand, moduleBiosVersion=moduleBiosVersion, moduleControlEntry=moduleControlEntry, elementProductKey=elementProductKey, controlTrapSending=controlTrapSending, elementLatitude=elementLatitude, regValue=regValue, repairDate=repairDate, productKeyFeatureEnable=productKeyFeatureEnable, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitHiHi=controlTempLimitHiHi, statusFan=statusFan, statusSoftware=statusSoftware, controlTrapReceiverTable=controlTrapReceiverTable, moduleBusAddress=moduleBusAddress, controlTempLimitHi=controlTempLimitHi, elementConfigChangeCode=elementConfigChangeCode, moduleStatus=moduleStatus, moduleSizeOfTable=moduleSizeOfTable, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapDelay=controlTrapDelay, regIndex=regIndex, statusRestartCounter=statusRestartCounter, moduleTable=moduleTable, sWUpdateStatus=sWUpdateStatus, elementTotalUpTime=elementTotalUpTime, elementControl=elementControl, productKeyMask=productKeyMask, receiverEntryId=receiverEntryId, moduleRegistry=moduleRegistry, moduleDetailTable=moduleDetailTable, controlLocalAccess=controlLocalAccess, repairReasonCode=repairReasonCode, moduleNotebookTable=moduleNotebookTable, controlBusMasterAdminState=controlBusMasterAdminState, moduleDetailEntry=moduleDetailEntry, productKeyFeatureEntry=productKeyFeatureEntry, productKeyFeatureName=productKeyFeatureName, elementInformation=elementInformation, statusLidStatus=statusLidStatus, productKeyValue=productKeyValue, moduleHwVersion=moduleHwVersion, elementResetCount=elementResetCount, elementStatus=elementStatus, controlResetElement=controlResetElement, productKeyCipher=productKeyCipher, statusResetCause=statusResetCause, moduleControl=moduleControl, sizeOfRepairlog=sizeOfRepairlog, module=module, sWUpdateControl=sWUpdateControl, moduleAppDate=moduleAppDate, controlMarkState=controlMarkState)
