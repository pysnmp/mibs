...
TimeTicks, Unsigned32, Integer32, IpAddress, Gauge32, NotificationType, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "Gauge32", "NotificationType", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "iso", "Counter32", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sizeOfNotebook=sizeOfNotebook, productKeyIndex=productKeyIndex, elementConfigChangeCode=elementConfigChangeCode, moduleMacAddress=moduleMacAddress, sizeOfRepairlog=sizeOfRepairlog, repairComment=repairComment, notebookLineText=notebookLineText, statusFan=statusFan, controlLedUsage=controlLedUsage, productKeyCipher=productKeyCipher, moduleSizeOfTable=moduleSizeOfTable, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, productKeyEntry=productKeyEntry, moduleStatusEntry=moduleStatusEntry, moduleRegistry=moduleRegistry, sizeOfRegistry=sizeOfRegistry, statusResetCause=statusResetCause, moduleRepairLogEntry=moduleRepairLogEntry, elementName=elementName, regName=regName, sWUpdateStatus=sWUpdateStatus, statusLidStatus=statusLidStatus, elementLongitude=elementLongitude, sWUpdateControl=sWUpdateControl, moduleHwType=moduleHwType, productKeyFeatureTable=productKeyFeatureTable, controlLocalAccess=controlLocalAccess, elementStatus=elementStatus, elementTotalUpTime=elementTotalUpTime, controlTempLimitLoLo=controlTempLimitLoLo, regValue=regValue, statusRestartCounter=statusRestartCounter, controlTrapDelay=controlTrapDelay, controlReset=controlReset, moduleTable=moduleTable, productKeyMask=productKeyMask, controlTempDeadBand=controlTempDeadBand, controlAlarmDetection=controlAlarmDetection, statusGeneral=statusGeneral, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureName=productKeyFeatureName, moduleSlotNo=moduleSlotNo, repairNameCode=repairNameCode, productKeyValue=productKeyValue, receiverCommunity=receiverCommunity, elementProductKey=elementProductKey, statusLmt=statusLmt, controlInternalAppAccess=controlInternalAppAccess, elementInformation=elementInformation, moduleAppVersion=moduleAppVersion, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitHiHi=controlTempLimitHiHi, statusLid=statusLid, statusSoftware=statusSoftware, moduleStatusTable=moduleStatusTable, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRegistryEntry=moduleRegistryEntry, moduleControlTable=moduleControlTable, moduleInformation=moduleInformation, controlTempLimitHi=controlTempLimitHi, productKeyStatus=productKeyStatus, element=element, statusBusMaster=statusBusMaster, controlTrapReceiverEntry=controlTrapReceiverEntry, elementControl=elementControl, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppDate=moduleAppDate, moduleHwVersion=moduleHwVersion, controlAlarmOnDelay=controlAlarmOnDelay, moduleRackNo=moduleRackNo, receiverEntryId=receiverEntryId, moduleControlEntry=moduleControlEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleHwSerialNumber=moduleHwSerialNumber, statusTemperature=statusTemperature, moduleRegistryTable=moduleRegistryTable, receiverAddress=receiverAddress, repairIndex=repairIndex, statusHardware=statusHardware, swUpdateURL=swUpdateURL, receiverPort=receiverPort, moduleDetailEntry=moduleDetailEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleName=moduleName, controlTempLimitLo=controlTempLimitLo, moduleStatus=moduleStatus, moduleBiosDate=moduleBiosDate, sWUpdateFileName=sWUpdateFileName, moduleNotebookTable=moduleNotebookTable, controlTrapSending=controlTrapSending, controlResetElement=controlResetElement, module=module, elementAltitude=elementAltitude, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusInternalTemperature=statusInternalTemperature, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, regIndex=regIndex, repairReasonCode=repairReasonCode, moduleControl=moduleControl, statusSettings=statusSettings, productKeyTable=productKeyTable, moduleEntry=moduleEntry, controlBusMasterAdminState=controlBusMasterAdminState, moduleId=moduleId, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapInterval=controlTrapInterval, moduleNotebookEntry=moduleNotebookEntry, elementLatitude=elementLatitude, moduleDetailTable=moduleDetailTable, notebookLineNumber=notebookLineNumber, elementResetCount=elementResetCount, moduleBusAddress=moduleBusAddress, moduleBiosVersion=moduleBiosVersion, statusRunningSwImage=statusRunningSwImage, moduleRepairLogTable=moduleRepairLogTable, moduleSWUpdateTable=moduleSWUpdateTable, controlAlarmOffDelay=controlAlarmOffDelay, repairDate=repairDate, controlMarkState=controlMarkState)
