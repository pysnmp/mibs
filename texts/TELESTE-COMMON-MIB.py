...
Bits, Counter64, TimeTicks, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Gauge32, iso, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "TimeTicks", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Gauge32", "iso", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementInformation=elementInformation, statusBusMaster=statusBusMaster, receiverAddress=receiverAddress, moduleSlotNo=moduleSlotNo, productKeyStatus=productKeyStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, sizeOfNotebook=sizeOfNotebook, elementLatitude=elementLatitude, controlAlarmDetection=controlAlarmDetection, moduleRepairLogTable=moduleRepairLogTable, statusTemperature=statusTemperature, controlReset=controlReset, moduleRepairLogEntry=moduleRepairLogEntry, elementStatus=elementStatus, moduleRegistryEntry=moduleRegistryEntry, receiverCommunity=receiverCommunity, moduleControl=moduleControl, sWUpdateFileName=sWUpdateFileName, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitHiHi=controlTempLimitHiHi, repairIndex=repairIndex, moduleStatusEntry=moduleStatusEntry, moduleHwVersion=moduleHwVersion, regValue=regValue, statusRunningSwImage=statusRunningSwImage, productKeyIndex=productKeyIndex, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfTable=moduleSizeOfTable, moduleStatus=moduleStatus, moduleDetailTable=moduleDetailTable, controlAlarmOnDelay=controlAlarmOnDelay, moduleNotebookEntry=moduleNotebookEntry, controlTrapSending=controlTrapSending, elementTotalUpTime=elementTotalUpTime, statusLmt=statusLmt, productKeyMask=productKeyMask, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosVersion=moduleBiosVersion, repairComment=repairComment, statusLid=statusLid, element=element, notebookLineNumber=notebookLineNumber, controlTempDeadBand=controlTempDeadBand, statusRestartCounter=statusRestartCounter, moduleDetailEntry=moduleDetailEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, receiverPort=receiverPort, moduleAppDate=moduleAppDate, sWUpdateStatus=sWUpdateStatus, productKeyTable=productKeyTable, elementResetCount=elementResetCount, moduleRegistryTable=moduleRegistryTable, moduleMacAddress=moduleMacAddress, statusLidStatus=statusLidStatus, controlTrapInterval=controlTrapInterval, moduleControlEntry=moduleControlEntry, controlLocalAccess=controlLocalAccess, moduleBiosDate=moduleBiosDate, moduleInformation=moduleInformation, moduleControlTable=moduleControlTable, elementControl=elementControl, moduleRegistry=moduleRegistry, controlTrapLifeTime=controlTrapLifeTime, controlBusMasterAdminState=controlBusMasterAdminState, moduleAppVersion=moduleAppVersion, elementConfigChangeCode=elementConfigChangeCode, moduleNotebookTable=moduleNotebookTable, moduleBusAddress=moduleBusAddress, controlTempLimitLoLo=controlTempLimitLoLo, sizeOfRepairlog=sizeOfRepairlog, statusGeneral=statusGeneral, moduleStatusTable=moduleStatusTable, repairNameCode=repairNameCode, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleId=moduleId, moduleSizeOfEntry=moduleSizeOfEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusResetCause=statusResetCause, statusFan=statusFan, productKeyEntry=productKeyEntry, module=module, regName=regName, repairReasonCode=repairReasonCode, sWUpdateControl=sWUpdateControl, moduleRackNo=moduleRackNo, repairDate=repairDate, controlTempLimitLo=controlTempLimitLo, moduleHwType=moduleHwType, controlAlarmOffDelay=controlAlarmOffDelay, statusInternalTemperature=statusInternalTemperature, moduleTable=moduleTable, elementProductKey=elementProductKey, productKeyCipher=productKeyCipher, productKeyFeatureEntry=productKeyFeatureEntry, productKeyFeatureName=productKeyFeatureName, sizeOfRegistry=sizeOfRegistry, elementStructure=elementStructure, productKeyFeatureTable=productKeyFeatureTable, statusSettings=statusSettings, controlLedUsage=controlLedUsage, productKeyValue=productKeyValue, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleEntry=moduleEntry, elementName=elementName, elementAltitude=elementAltitude, controlMarkState=controlMarkState, receiverEntryId=receiverEntryId, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapDelay=controlTrapDelay, moduleName=moduleName, swUpdateURL=swUpdateURL, controlTempLimitHi=controlTempLimitHi, moduleSWUpdateTable=moduleSWUpdateTable, controlInternalAppAccess=controlInternalAppAccess, controlResetElement=controlResetElement, regIndex=regIndex, elementLongitude=elementLongitude, notebookLineText=notebookLineText, controlTrapReceiverTable=controlTrapReceiverTable, statusSoftware=statusSoftware, statusHardware=statusHardware)
