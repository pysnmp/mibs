...
IpAddress, ObjectIdentity, Bits, Counter32, Gauge32, TimeTicks, iso, NotificationType, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Bits", "Counter32", "Gauge32", "TimeTicks", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleDetailTable=moduleDetailTable, elementResetCount=elementResetCount, controlTrapLifeTime=controlTrapLifeTime, moduleName=moduleName, controlTrapInterval=controlTrapInterval, statusSoftware=statusSoftware, moduleRegistryEntry=moduleRegistryEntry, moduleBiosVersion=moduleBiosVersion, moduleControlTable=moduleControlTable, productKeyFeatureEntry=productKeyFeatureEntry, controlTempLimitHiHi=controlTempLimitHiHi, controlLocalAccess=controlLocalAccess, productKeyNumberOfKeys=productKeyNumberOfKeys, controlAlarmDetection=controlAlarmDetection, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverAddress=receiverAddress, sizeOfRepairlog=sizeOfRepairlog, receiverPort=receiverPort, moduleMacAddress=moduleMacAddress, moduleNotebookEntry=moduleNotebookEntry, productKeyValue=productKeyValue, moduleRackNo=moduleRackNo, moduleHwVersion=moduleHwVersion, moduleStatusTable=moduleStatusTable, moduleAppVersion=moduleAppVersion, controlTrapSending=controlTrapSending, statusFan=statusFan, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleHwType=moduleHwType, elementConfigChangeCode=elementConfigChangeCode, moduleRepairLogTable=moduleRepairLogTable, regValue=regValue, productKeyMask=productKeyMask, repairIndex=repairIndex, controlTrapDelay=controlTrapDelay, elementProductKey=elementProductKey, receiverEntryId=receiverEntryId, elementLatitude=elementLatitude, moduleId=moduleId, moduleStatusEntry=moduleStatusEntry, controlAlarmOnDelay=controlAlarmOnDelay, productKeyStatus=productKeyStatus, controlTempLimitHi=controlTempLimitHi, moduleRepairLogEntry=moduleRepairLogEntry, notebookLineNumber=notebookLineNumber, moduleControl=moduleControl, elementControl=elementControl, statusRestartCounter=statusRestartCounter, moduleEntry=moduleEntry, moduleRegistry=moduleRegistry, moduleRegistryTable=moduleRegistryTable, module=module, controlTrapReceiverTable=controlTrapReceiverTable, elementName=elementName, elementInformation=elementInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitLoLo=controlTempLimitLoLo, moduleBiosDate=moduleBiosDate, controlTempLimitLo=controlTempLimitLo, moduleBusAddress=moduleBusAddress, controlReset=controlReset, moduleSizeOfEntry=moduleSizeOfEntry, notebookLineText=notebookLineText, productKeyFeatureEnable=productKeyFeatureEnable, moduleSWUpdateEntry=moduleSWUpdateEntry, elementStructure=elementStructure, repairDate=repairDate, moduleSlotNo=moduleSlotNo, elementStatus=elementStatus, moduleSWUpdateTable=moduleSWUpdateTable, regIndex=regIndex, moduleControlEntry=moduleControlEntry, productKeyFeatureIndex=productKeyFeatureIndex, element=element, statusHardware=statusHardware, productKeyTable=productKeyTable, moduleAppDate=moduleAppDate, statusSettings=statusSettings, repairReasonCode=repairReasonCode, moduleHwSerialNumber=moduleHwSerialNumber, controlTempDeadBand=controlTempDeadBand, moduleStatus=moduleStatus, statusLidStatus=statusLidStatus, sizeOfRegistry=sizeOfRegistry, statusInternalTemperature=statusInternalTemperature, moduleTable=moduleTable, controlMarkState=controlMarkState, productKeyEntry=productKeyEntry, moduleSizeOfTable=moduleSizeOfTable, elementAltitude=elementAltitude, statusLmt=statusLmt, productKeyIndex=productKeyIndex, elementLongitude=elementLongitude, swUpdateURL=swUpdateURL, sizeOfNotebook=sizeOfNotebook, statusRunningSwImage=statusRunningSwImage, sWUpdateStatus=sWUpdateStatus, productKeyCipher=productKeyCipher, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sWUpdateControl=sWUpdateControl, statusLid=statusLid, moduleNotebookTable=moduleNotebookTable, statusResetCause=statusResetCause, statusTemperature=statusTemperature, repairNameCode=repairNameCode, elementTotalUpTime=elementTotalUpTime, controlBusMasterAdminState=controlBusMasterAdminState, moduleInformation=moduleInformation, sWUpdateFileName=sWUpdateFileName, controlLedUsage=controlLedUsage, repairComment=repairComment, productKeyFeatureTable=productKeyFeatureTable, moduleDetailEntry=moduleDetailEntry, controlInternalAppAccess=controlInternalAppAccess, statusGeneral=statusGeneral, controlResetElement=controlResetElement, statusBusMaster=statusBusMaster, receiverCommunity=receiverCommunity, regName=regName, productKeyFeatureName=productKeyFeatureName)
