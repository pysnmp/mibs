...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLatitude=elementLatitude, moduleSlotNo=moduleSlotNo, elementLongitude=elementLongitude, statusRestartCounter=statusRestartCounter, controlTrapInterval=controlTrapInterval, elementResetCount=elementResetCount, statusTemperature=statusTemperature, moduleControlEntry=moduleControlEntry, statusInternalTemperature=statusInternalTemperature, controlTempLimitLo=controlTempLimitLo, regValue=regValue, moduleInformation=moduleInformation, controlAlarmOffDelay=controlAlarmOffDelay, moduleAppVersion=moduleAppVersion, moduleBiosVersion=moduleBiosVersion, productKeyFeatureEnable=productKeyFeatureEnable, statusBusMaster=statusBusMaster, notebookLineNumber=notebookLineNumber, controlAlarmDetection=controlAlarmDetection, productKeyFeatureIndex=productKeyFeatureIndex, moduleNotebookTable=moduleNotebookTable, statusLid=statusLid, moduleHwSerialNumber=moduleHwSerialNumber, controlInternalAppAccess=controlInternalAppAccess, repairDate=repairDate, elementControl=elementControl, moduleDetailTable=moduleDetailTable, moduleNotebookEntry=moduleNotebookEntry, moduleHwType=moduleHwType, repairIndex=repairIndex, moduleBiosDate=moduleBiosDate, moduleRegistryEntry=moduleRegistryEntry, controlMarkState=controlMarkState, receiverEntryId=receiverEntryId, controlLocalAccess=controlLocalAccess, receiverCommunity=receiverCommunity, moduleTable=moduleTable, moduleControl=moduleControl, elementAltitude=elementAltitude, statusLmt=statusLmt, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, elementStatus=elementStatus, sWUpdateFileName=sWUpdateFileName, controlTempDeadBand=controlTempDeadBand, controlResetElement=controlResetElement, statusGeneral=statusGeneral, regName=regName, repairComment=repairComment, controlTrapSending=controlTrapSending, moduleId=moduleId, controlTempLimitLoLo=controlTempLimitLoLo, controlBusMasterAdminState=controlBusMasterAdminState, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyIndex=productKeyIndex, moduleStatusEntry=moduleStatusEntry, productKeyMask=productKeyMask, moduleEntry=moduleEntry, controlTempLimitHi=controlTempLimitHi, statusHardware=statusHardware, productKeyFeatureName=productKeyFeatureName, notebookLineText=notebookLineText, moduleRepairLogTable=moduleRepairLogTable, sWUpdateControl=sWUpdateControl, receiverAddress=receiverAddress, elementConfigChangeCode=elementConfigChangeCode, sWUpdateStatus=sWUpdateStatus, controlTrapLifeTime=controlTrapLifeTime, controlReset=controlReset, moduleAppDate=moduleAppDate, moduleStatus=moduleStatus, moduleStatusTable=moduleStatusTable, swUpdateURL=swUpdateURL, sizeOfRegistry=sizeOfRegistry, controlTrapDelay=controlTrapDelay, controlTempLimitHiHi=controlTempLimitHiHi, moduleHwVersion=moduleHwVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleSizeOfEntry=moduleSizeOfEntry, sizeOfRepairlog=sizeOfRepairlog, moduleRegistry=moduleRegistry, statusSettings=statusSettings, sizeOfNotebook=sizeOfNotebook, productKeyCipher=productKeyCipher, productKeyFeatureTable=productKeyFeatureTable, productKeyEntry=productKeyEntry, regIndex=regIndex, statusFan=statusFan, productKeyStatus=productKeyStatus, moduleName=moduleName, moduleMacAddress=moduleMacAddress, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementProductKey=elementProductKey, repairNameCode=repairNameCode, moduleSWUpdateTable=moduleSWUpdateTable, statusRunningSwImage=statusRunningSwImage, statusResetCause=statusResetCause, moduleDetailEntry=moduleDetailEntry, productKeyFeatureEntry=productKeyFeatureEntry, productKeyTable=productKeyTable, receiverPort=receiverPort, moduleRackNo=moduleRackNo, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistryTable=moduleRegistryTable, elementName=elementName, element=element, statusLidStatus=statusLidStatus, elementStructure=elementStructure, elementTotalUpTime=elementTotalUpTime, productKeyValue=productKeyValue, moduleSizeOfTable=moduleSizeOfTable, statusSoftware=statusSoftware, controlLedUsage=controlLedUsage, module=module, repairReasonCode=repairReasonCode, elementInformation=elementInformation, moduleControlTable=moduleControlTable, moduleBusAddress=moduleBusAddress, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogEntry=moduleRepairLogEntry)
