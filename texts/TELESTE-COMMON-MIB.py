...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLatitude=elementLatitude, elementAltitude=elementAltitude, statusLidStatus=statusLidStatus, controlTrapReceiverTable=controlTrapReceiverTable, receiverEntryId=receiverEntryId, statusGeneral=statusGeneral, moduleEntry=moduleEntry, moduleRackNo=moduleRackNo, elementName=elementName, elementStatus=elementStatus, moduleBiosDate=moduleBiosDate, statusBusMaster=statusBusMaster, repairReasonCode=repairReasonCode, regIndex=regIndex, controlMarkState=controlMarkState, moduleStatusEntry=moduleStatusEntry, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOffDelay=controlAlarmOffDelay, controlLedUsage=controlLedUsage, elementTotalUpTime=elementTotalUpTime, controlTrapSending=controlTrapSending, statusSettings=statusSettings, receiverAddress=receiverAddress, statusLid=statusLid, statusSoftware=statusSoftware, moduleBusAddress=moduleBusAddress, repairDate=repairDate, moduleControlTable=moduleControlTable, controlTempLimitHi=controlTempLimitHi, controlReset=controlReset, sizeOfRepairlog=sizeOfRepairlog, statusRestartCounter=statusRestartCounter, moduleRegistryTable=moduleRegistryTable, elementResetCount=elementResetCount, productKeyStatus=productKeyStatus, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmOnDelay=controlAlarmOnDelay, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureEnable=productKeyFeatureEnable, statusResetCause=statusResetCause, moduleSWUpdateTable=moduleSWUpdateTable, repairIndex=repairIndex, receiverPort=receiverPort, productKeyFeatureName=productKeyFeatureName, controlTempLimitLo=controlTempLimitLo, statusInternalTemperature=statusInternalTemperature, moduleDetailEntry=moduleDetailEntry, repairNameCode=repairNameCode, moduleSizeOfTable=moduleSizeOfTable, moduleAppDate=moduleAppDate, statusFan=statusFan, moduleRegistry=moduleRegistry, repairComment=repairComment, controlTrapInterval=controlTrapInterval, moduleControl=moduleControl, controlTrapDelay=controlTrapDelay, elementProductKey=elementProductKey, notebookLineText=notebookLineText, productKeyCipher=productKeyCipher, sizeOfRegistry=sizeOfRegistry, sWUpdateFileName=sWUpdateFileName, moduleHwVersion=moduleHwVersion, notebookLineNumber=notebookLineNumber, moduleTable=moduleTable, moduleMacAddress=moduleMacAddress, receiverCommunity=receiverCommunity, statusHardware=statusHardware, elementInformation=elementInformation, productKeyTable=productKeyTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRepairLogEntry=moduleRepairLogEntry, moduleId=moduleId, productKeyEntry=productKeyEntry, regValue=regValue, moduleInformation=moduleInformation, sWUpdateControl=sWUpdateControl, moduleRepairLogTable=moduleRepairLogTable, controlResetElement=controlResetElement, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateStatus=sWUpdateStatus, elementStructure=elementStructure, controlTrapLifeTime=controlTrapLifeTime, moduleHwSerialNumber=moduleHwSerialNumber, controlAlarmDetection=controlAlarmDetection, elementConfigChangeCode=elementConfigChangeCode, moduleNotebookTable=moduleNotebookTable, productKeyFeatureEntry=productKeyFeatureEntry, moduleStatusTable=moduleStatusTable, moduleNotebookEntry=moduleNotebookEntry, productKeyMask=productKeyMask, moduleHwType=moduleHwType, productKeyIndex=productKeyIndex, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, module=module, regName=regName, element=element, moduleDetailTable=moduleDetailTable, moduleSlotNo=moduleSlotNo, controlLocalAccess=controlLocalAccess, moduleAppVersion=moduleAppVersion, moduleControlEntry=moduleControlEntry, elementLongitude=elementLongitude, controlTempLimitLoLo=controlTempLimitLoLo, moduleName=moduleName, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosVersion=moduleBiosVersion, elementControl=elementControl, controlBusMasterAdminState=controlBusMasterAdminState, statusLmt=statusLmt, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitHiHi=controlTempLimitHiHi, controlTempDeadBand=controlTempDeadBand, swUpdateURL=swUpdateURL, statusTemperature=statusTemperature, sizeOfNotebook=sizeOfNotebook, productKeyValue=productKeyValue, statusRunningSwImage=statusRunningSwImage, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleStatus=moduleStatus)
