...
ObjectIdentity, IpAddress, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Gauge32, ModuleIdentity, MibIdentifier, Unsigned32, Bits, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Bits", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyEntry=productKeyEntry, moduleId=moduleId, controlAlarmOnDelay=controlAlarmOnDelay, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, swUpdateURL=swUpdateURL, controlTrapSending=controlTrapSending, sWUpdateFileName=sWUpdateFileName, productKeyIndex=productKeyIndex, moduleBiosDate=moduleBiosDate, sWUpdateStatus=sWUpdateStatus, statusHardware=statusHardware, productKeyTable=productKeyTable, moduleMacAddress=moduleMacAddress, moduleControlTable=moduleControlTable, moduleEntry=moduleEntry, elementName=elementName, elementStructure=elementStructure, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleName=moduleName, repairReasonCode=repairReasonCode, moduleStatus=moduleStatus, moduleBusAddress=moduleBusAddress, moduleDetailEntry=moduleDetailEntry, productKeyFeatureEntry=productKeyFeatureEntry, controlTempDeadBand=controlTempDeadBand, productKeyMask=productKeyMask, moduleControl=moduleControl, repairIndex=repairIndex, controlTempLimitLo=controlTempLimitLo, productKeyFeatureIndex=productKeyFeatureIndex, statusGeneral=statusGeneral, elementAltitude=elementAltitude, receiverAddress=receiverAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementLongitude=elementLongitude, regName=regName, moduleNotebookEntry=moduleNotebookEntry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureTable=productKeyFeatureTable, controlTrapInterval=controlTrapInterval, sizeOfRepairlog=sizeOfRepairlog, statusResetCause=statusResetCause, elementResetCount=elementResetCount, moduleSlotNo=moduleSlotNo, statusTemperature=statusTemperature, controlTrapLifeTime=controlTrapLifeTime, sizeOfNotebook=sizeOfNotebook, regIndex=regIndex, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineText=notebookLineText, notebookLineNumber=notebookLineNumber, moduleRepairLogTable=moduleRepairLogTable, productKeyValue=productKeyValue, moduleDetailTable=moduleDetailTable, moduleStatusTable=moduleStatusTable, elementTotalUpTime=elementTotalUpTime, module=module, statusLidStatus=statusLidStatus, elementLatitude=elementLatitude, statusRestartCounter=statusRestartCounter, controlBusMasterAdminState=controlBusMasterAdminState, controlTempLimitHi=controlTempLimitHi, moduleAppDate=moduleAppDate, statusSettings=statusSettings, controlReset=controlReset, moduleHwVersion=moduleHwVersion, sWUpdateControl=sWUpdateControl, elementProductKey=elementProductKey, receiverCommunity=receiverCommunity, controlLocalAccess=controlLocalAccess, controlTempLimitLoLo=controlTempLimitLoLo, regValue=regValue, elementConfigChangeCode=elementConfigChangeCode, moduleHwSerialNumber=moduleHwSerialNumber, sizeOfRegistry=sizeOfRegistry, moduleRegistryTable=moduleRegistryTable, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmDetection=controlAlarmDetection, controlLedUsage=controlLedUsage, statusInternalTemperature=statusInternalTemperature, moduleAppVersion=moduleAppVersion, statusLmt=statusLmt, statusBusMaster=statusBusMaster, moduleSizeOfEntry=moduleSizeOfEntry, moduleNotebookTable=moduleNotebookTable, elementStatus=elementStatus, moduleTable=moduleTable, element=element, controlResetElement=controlResetElement, statusLid=statusLid, controlTrapReceiverEntry=controlTrapReceiverEntry, elementControl=elementControl, elementInformation=elementInformation, moduleInformation=moduleInformation, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleRegistryEntry=moduleRegistryEntry, moduleBiosVersion=moduleBiosVersion, moduleRegistry=moduleRegistry, controlInternalAppAccess=controlInternalAppAccess, controlMarkState=controlMarkState, productKeyCipher=productKeyCipher, moduleControlEntry=moduleControlEntry, statusFan=statusFan, repairNameCode=repairNameCode, statusSoftware=statusSoftware, receiverPort=receiverPort, repairDate=repairDate, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEnable=productKeyFeatureEnable, repairComment=repairComment, moduleRepairLogEntry=moduleRepairLogEntry, moduleStatusEntry=moduleStatusEntry, productKeyStatus=productKeyStatus, moduleSizeOfTable=moduleSizeOfTable, receiverEntryId=receiverEntryId, moduleHwType=moduleHwType, controlTrapDelay=controlTrapDelay, moduleRackNo=moduleRackNo, productKeyNumberOfKeys=productKeyNumberOfKeys)
