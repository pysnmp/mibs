...
Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, TimeTicks, Integer32, Counter64, iso, Counter32, MibIdentifier, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "TimeTicks", "Integer32", "Counter64", "iso", "Counter32", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapDelay=controlTrapDelay, moduleBusAddress=moduleBusAddress, moduleBiosDate=moduleBiosDate, controlLocalAccess=controlLocalAccess, controlTrapReceiverTable=controlTrapReceiverTable, productKeyIndex=productKeyIndex, controlTempDeadBand=controlTempDeadBand, moduleNotebookTable=moduleNotebookTable, regIndex=regIndex, controlBusMasterAdminState=controlBusMasterAdminState, controlMarkState=controlMarkState, moduleHwVersion=moduleHwVersion, moduleRegistry=moduleRegistry, moduleRepairLogTable=moduleRepairLogTable, moduleInformation=moduleInformation, receiverCommunity=receiverCommunity, moduleSWUpdateTable=moduleSWUpdateTable, receiverAddress=receiverAddress, controlAlarmOffDelay=controlAlarmOffDelay, statusBusMaster=statusBusMaster, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitLo=controlTempLimitLo, moduleSizeOfEntry=moduleSizeOfEntry, statusGeneral=statusGeneral, productKeyCipher=productKeyCipher, elementInformation=elementInformation, elementStructure=elementStructure, moduleControl=moduleControl, controlAlarmDetection=controlAlarmDetection, productKeyEntry=productKeyEntry, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppDate=moduleAppDate, moduleMacAddress=moduleMacAddress, moduleHwType=moduleHwType, statusRestartCounter=statusRestartCounter, elementAltitude=elementAltitude, moduleStatusEntry=moduleStatusEntry, sWUpdateControl=sWUpdateControl, productKeyMask=productKeyMask, statusLid=statusLid, controlTrapSending=controlTrapSending, repairIndex=repairIndex, productKeyFeatureIndex=productKeyFeatureIndex, sizeOfNotebook=sizeOfNotebook, elementLongitude=elementLongitude, statusRunningSwImage=statusRunningSwImage, elementName=elementName, elementStatus=elementStatus, statusLmt=statusLmt, productKeyValue=productKeyValue, controlTrapInterval=controlTrapInterval, productKeyTable=productKeyTable, moduleSlotNo=moduleSlotNo, moduleNotebookEntry=moduleNotebookEntry, moduleControlEntry=moduleControlEntry, elementProductKey=elementProductKey, controlTempLimitHiHi=controlTempLimitHiHi, productKeyStatus=productKeyStatus, regName=regName, sizeOfRegistry=sizeOfRegistry, elementTotalUpTime=elementTotalUpTime, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapLifeTime=controlTrapLifeTime, controlLedUsage=controlLedUsage, moduleStatus=moduleStatus, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureName=productKeyFeatureName, controlTempLimitLoLo=controlTempLimitLoLo, moduleHwSerialNumber=moduleHwSerialNumber, elementConfigChangeCode=elementConfigChangeCode, statusSettings=statusSettings, notebookLineText=notebookLineText, moduleName=moduleName, moduleRackNo=moduleRackNo, controlReset=controlReset, sizeOfRepairlog=sizeOfRepairlog, statusLidStatus=statusLidStatus, controlInternalAppAccess=controlInternalAppAccess, elementLatitude=elementLatitude, controlResetElement=controlResetElement, statusSoftware=statusSoftware, moduleDetailEntry=moduleDetailEntry, statusResetCause=statusResetCause, module=module, receiverPort=receiverPort, repairComment=repairComment, moduleRegistryEntry=moduleRegistryEntry, productKeyFeatureEntry=productKeyFeatureEntry, repairReasonCode=repairReasonCode, elementControl=elementControl, statusHardware=statusHardware, moduleId=moduleId, statusInternalTemperature=statusInternalTemperature, moduleTable=moduleTable, sWUpdateStatus=sWUpdateStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleEntry=moduleEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, regValue=regValue, elementResetCount=elementResetCount, repairDate=repairDate, receiverEntryId=receiverEntryId, productKeyFeatureTable=productKeyFeatureTable, moduleSizeOfTable=moduleSizeOfTable, statusFan=statusFan, controlTempLimitHi=controlTempLimitHi, moduleAppVersion=moduleAppVersion, moduleBiosVersion=moduleBiosVersion, swUpdateURL=swUpdateURL, moduleRepairLogEntry=moduleRepairLogEntry, element=element, notebookLineNumber=notebookLineNumber, repairNameCode=repairNameCode, statusTemperature=statusTemperature, sWUpdateFileName=sWUpdateFileName, moduleStatusTable=moduleStatusTable, moduleDetailTable=moduleDetailTable, moduleControlTable=moduleControlTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRegistryTable=moduleRegistryTable)
