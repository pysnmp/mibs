...
Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Gauge32, ModuleIdentity, Unsigned32, ObjectIdentity, MibIdentifier, IpAddress, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter64", "iso", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyStatus=productKeyStatus, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapDelay=controlTrapDelay, productKeyTable=productKeyTable, statusLmt=statusLmt, moduleControl=moduleControl, statusHardware=statusHardware, moduleName=moduleName, moduleAppDate=moduleAppDate, controlTrapSending=controlTrapSending, module=module, statusLidStatus=statusLidStatus, productKeyMask=productKeyMask, elementConfigChangeCode=elementConfigChangeCode, moduleBiosDate=moduleBiosDate, repairIndex=repairIndex, sWUpdateControl=sWUpdateControl, moduleRackNo=moduleRackNo, moduleStatusEntry=moduleStatusEntry, elementName=elementName, elementAltitude=elementAltitude, productKeyFeatureEntry=productKeyFeatureEntry, sizeOfRegistry=sizeOfRegistry, controlLedUsage=controlLedUsage, controlLocalAccess=controlLocalAccess, repairReasonCode=repairReasonCode, moduleSlotNo=moduleSlotNo, swUpdateURL=swUpdateURL, statusRestartCounter=statusRestartCounter, regIndex=regIndex, moduleDetailTable=moduleDetailTable, elementProductKey=elementProductKey, moduleSizeOfTable=moduleSizeOfTable, moduleStatusTable=moduleStatusTable, sizeOfRepairlog=sizeOfRepairlog, statusInternalTemperature=statusInternalTemperature, moduleRegistryEntry=moduleRegistryEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, elementStatus=elementStatus, moduleRegistry=moduleRegistry, moduleDetailEntry=moduleDetailEntry, moduleRegistryTable=moduleRegistryTable, controlBusMasterAdminState=controlBusMasterAdminState, receiverPort=receiverPort, moduleEntry=moduleEntry, moduleHwSerialNumber=moduleHwSerialNumber, controlTempDeadBand=controlTempDeadBand, receiverCommunity=receiverCommunity, moduleHwVersion=moduleHwVersion, statusResetCause=statusResetCause, statusGeneral=statusGeneral, controlTrapInterval=controlTrapInterval, moduleControlEntry=moduleControlEntry, moduleSizeOfEntry=moduleSizeOfEntry, moduleBusAddress=moduleBusAddress, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTempLimitLo=controlTempLimitLo, statusSoftware=statusSoftware, elementLongitude=elementLongitude, statusRunningSwImage=statusRunningSwImage, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sizeOfNotebook=sizeOfNotebook, statusTemperature=statusTemperature, statusFan=statusFan, receiverEntryId=receiverEntryId, controlMarkState=controlMarkState, productKeyFeatureIndex=productKeyFeatureIndex, productKeyFeatureName=productKeyFeatureName, moduleInformation=moduleInformation, moduleMacAddress=moduleMacAddress, notebookLineNumber=notebookLineNumber, receiverAddress=receiverAddress, statusLid=statusLid, controlAlarmOnDelay=controlAlarmOnDelay, moduleBiosVersion=moduleBiosVersion, controlResetElement=controlResetElement, repairDate=repairDate, repairNameCode=repairNameCode, elementTotalUpTime=elementTotalUpTime, controlInternalAppAccess=controlInternalAppAccess, productKeyIndex=productKeyIndex, productKeyValue=productKeyValue, regName=regName, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairComment=repairComment, productKeyEntry=productKeyEntry, controlTempLimitLoLo=controlTempLimitLoLo, moduleStatus=moduleStatus, moduleControlTable=moduleControlTable, moduleRepairLogEntry=moduleRepairLogEntry, sWUpdateStatus=sWUpdateStatus, productKeyFeatureTable=productKeyFeatureTable, statusSettings=statusSettings, moduleTable=moduleTable, regValue=regValue, controlReset=controlReset, moduleNotebookTable=moduleNotebookTable, controlTrapLifeTime=controlTrapLifeTime, controlAlarmDetection=controlAlarmDetection, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitHi=controlTempLimitHi, sWUpdateFileName=sWUpdateFileName, controlTrapReceiverTable=controlTrapReceiverTable, elementInformation=elementInformation, elementResetCount=elementResetCount, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleHwType=moduleHwType, moduleAppVersion=moduleAppVersion, elementLatitude=elementLatitude, elementControl=elementControl, notebookLineText=notebookLineText, element=element, moduleNotebookEntry=moduleNotebookEntry, moduleId=moduleId, productKeyCipher=productKeyCipher, elementStructure=elementStructure, statusBusMaster=statusBusMaster, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureEnable=productKeyFeatureEnable, controlAlarmOffDelay=controlAlarmOffDelay)
