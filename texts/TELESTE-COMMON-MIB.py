...
ObjectIdentity, Integer32, IpAddress, TimeTicks, Counter64, NotificationType, MibIdentifier, Gauge32, ModuleIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "MibIdentifier", "Gauge32", "ModuleIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairNameCode=repairNameCode, statusBusMaster=statusBusMaster, elementStatus=elementStatus, elementAltitude=elementAltitude, moduleBiosVersion=moduleBiosVersion, elementConfigChangeCode=elementConfigChangeCode, elementTotalUpTime=elementTotalUpTime, elementStructure=elementStructure, regIndex=regIndex, moduleNotebookTable=moduleNotebookTable, moduleControlTable=moduleControlTable, productKeyFeatureIndex=productKeyFeatureIndex, moduleHwType=moduleHwType, moduleDetailEntry=moduleDetailEntry, moduleStatus=moduleStatus, moduleRackNo=moduleRackNo, controlTrapReceiverTable=controlTrapReceiverTable, productKeyStatus=productKeyStatus, elementResetCount=elementResetCount, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitLoLo=controlTempLimitLoLo, controlInternalAppAccess=controlInternalAppAccess, controlAlarmDetection=controlAlarmDetection, moduleStatusTable=moduleStatusTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleName=moduleName, elementControl=elementControl, moduleHwSerialNumber=moduleHwSerialNumber, statusGeneral=statusGeneral, moduleSlotNo=moduleSlotNo, elementLatitude=elementLatitude, controlLedUsage=controlLedUsage, sizeOfRegistry=sizeOfRegistry, repairReasonCode=repairReasonCode, moduleMacAddress=moduleMacAddress, productKeyIndex=productKeyIndex, moduleAppDate=moduleAppDate, sWUpdateFileName=sWUpdateFileName, productKeyTable=productKeyTable, moduleRegistryEntry=moduleRegistryEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, swUpdateURL=swUpdateURL, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sWUpdateStatus=sWUpdateStatus, statusResetCause=statusResetCause, moduleControl=moduleControl, moduleRegistryTable=moduleRegistryTable, receiverPort=receiverPort, controlBusMasterAdminState=controlBusMasterAdminState, sizeOfRepairlog=sizeOfRepairlog, elementName=elementName, controlTempLimitLo=controlTempLimitLo, productKeyFeatureName=productKeyFeatureName, statusTemperature=statusTemperature, controlLocalAccess=controlLocalAccess, controlTrapInterval=controlTrapInterval, moduleBiosDate=moduleBiosDate, receiverEntryId=receiverEntryId, controlTempDeadBand=controlTempDeadBand, controlTrapLifeTime=controlTrapLifeTime, moduleTable=moduleTable, statusLidStatus=statusLidStatus, moduleRegistry=moduleRegistry, moduleNotebookEntry=moduleNotebookEntry, sWUpdateControl=sWUpdateControl, productKeyMask=productKeyMask, productKeyCipher=productKeyCipher, productKeyFeatureEntry=productKeyFeatureEntry, moduleRepairLogEntry=moduleRepairLogEntry, moduleBusAddress=moduleBusAddress, controlResetElement=controlResetElement, moduleRepairLogTable=moduleRepairLogTable, element=element, statusInternalTemperature=statusInternalTemperature, moduleAppVersion=moduleAppVersion, receiverCommunity=receiverCommunity, controlTempLimitHi=controlTempLimitHi, moduleControlEntry=moduleControlEntry, statusRestartCounter=statusRestartCounter, productKeyEntry=productKeyEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlMarkState=controlMarkState, statusLmt=statusLmt, controlTrapSending=controlTrapSending, controlTrapDelay=controlTrapDelay, moduleId=moduleId, moduleEntry=moduleEntry, moduleDetailTable=moduleDetailTable, statusSoftware=statusSoftware, productKeyFeatureEnable=productKeyFeatureEnable, statusSettings=statusSettings, elementInformation=elementInformation, repairDate=repairDate, sizeOfNotebook=sizeOfNotebook, moduleInformation=moduleInformation, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusLid=statusLid, statusRunningSwImage=statusRunningSwImage, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleSizeOfTable=moduleSizeOfTable, module=module, controlTempLimitHiHi=controlTempLimitHiHi, productKeyValue=productKeyValue, repairComment=repairComment, controlAlarmOffDelay=controlAlarmOffDelay, regName=regName, elementProductKey=elementProductKey, statusHardware=statusHardware, controlAlarmOnDelay=controlAlarmOnDelay, moduleSizeOfEntry=moduleSizeOfEntry, elementLongitude=elementLongitude, controlReset=controlReset, receiverAddress=receiverAddress, regValue=regValue, notebookLineNumber=notebookLineNumber, moduleHwVersion=moduleHwVersion, notebookLineText=notebookLineText, moduleStatusEntry=moduleStatusEntry, statusFan=statusFan, repairIndex=repairIndex, productKeyFeatureTable=productKeyFeatureTable)
