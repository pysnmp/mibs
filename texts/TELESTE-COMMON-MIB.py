...
TimeTicks, Integer32, iso, NotificationType, ObjectIdentity, ModuleIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, MibIdentifier, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "iso", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "MibIdentifier", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleControlTable=moduleControlTable, swUpdateURL=swUpdateURL, controlInternalAppAccess=controlInternalAppAccess, productKeyValue=productKeyValue, productKeyIndex=productKeyIndex, elementAltitude=elementAltitude, sizeOfRegistry=sizeOfRegistry, receiverPort=receiverPort, statusGeneral=statusGeneral, moduleHwSerialNumber=moduleHwSerialNumber, moduleSlotNo=moduleSlotNo, elementName=elementName, controlTrapReceiverEntry=controlTrapReceiverEntry, repairComment=repairComment, elementProductKey=elementProductKey, receiverCommunity=receiverCommunity, elementConfigChangeCode=elementConfigChangeCode, moduleId=moduleId, sizeOfRepairlog=sizeOfRepairlog, moduleControl=moduleControl, controlTempLimitHiHi=controlTempLimitHiHi, statusRunningSwImage=statusRunningSwImage, elementControl=elementControl, productKeyFeatureEnable=productKeyFeatureEnable, regValue=regValue, receiverEntryId=receiverEntryId, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapLifeTime=controlTrapLifeTime, element=element, statusHardware=statusHardware, moduleSWUpdateTable=moduleSWUpdateTable, productKeyTable=productKeyTable, moduleInformation=moduleInformation, controlTempLimitLo=controlTempLimitLo, controlBusMasterAdminState=controlBusMasterAdminState, statusLid=statusLid, moduleSizeOfTable=moduleSizeOfTable, repairNameCode=repairNameCode, productKeyFeatureEntry=productKeyFeatureEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, controlLocalAccess=controlLocalAccess, statusBusMaster=statusBusMaster, repairReasonCode=repairReasonCode, moduleStatusTable=moduleStatusTable, statusRestartCounter=statusRestartCounter, notebookLineNumber=notebookLineNumber, elementResetCount=elementResetCount, notebookLineText=notebookLineText, elementInformation=elementInformation, controlTrapInterval=controlTrapInterval, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureName=productKeyFeatureName, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusSoftware=statusSoftware, moduleRegistryEntry=moduleRegistryEntry, moduleSizeOfEntry=moduleSizeOfEntry, moduleRegistryTable=moduleRegistryTable, moduleNotebookTable=moduleNotebookTable, sWUpdateControl=sWUpdateControl, moduleHwType=moduleHwType, productKeyMask=productKeyMask, statusTemperature=statusTemperature, moduleBiosVersion=moduleBiosVersion, moduleMacAddress=moduleMacAddress, elementLatitude=elementLatitude, productKeyFeatureIndex=productKeyFeatureIndex, regIndex=regIndex, receiverAddress=receiverAddress, moduleTable=moduleTable, moduleName=moduleName, productKeyFeatureTable=productKeyFeatureTable, moduleRackNo=moduleRackNo, controlTrapReceiverTable=controlTrapReceiverTable, moduleDetailEntry=moduleDetailEntry, moduleRegistry=moduleRegistry, moduleAppVersion=moduleAppVersion, productKeyEntry=productKeyEntry, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogTable=moduleRepairLogTable, statusInternalTemperature=statusInternalTemperature, controlLedUsage=controlLedUsage, controlTempLimitHi=controlTempLimitHi, moduleStatusEntry=moduleStatusEntry, controlTrapDelay=controlTrapDelay, elementStructure=elementStructure, statusSettings=statusSettings, regName=regName, controlMarkState=controlMarkState, controlTrapSending=controlTrapSending, moduleControlEntry=moduleControlEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, repairIndex=repairIndex, controlTempLimitLoLo=controlTempLimitLoLo, moduleEntry=moduleEntry, elementTotalUpTime=elementTotalUpTime, controlAlarmOffDelay=controlAlarmOffDelay, statusLidStatus=statusLidStatus, moduleAppDate=moduleAppDate, productKeyCipher=productKeyCipher, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sWUpdateFileName=sWUpdateFileName, controlAlarmDetection=controlAlarmDetection, productKeyStatus=productKeyStatus, elementLongitude=elementLongitude, sWUpdateStatus=sWUpdateStatus, controlResetElement=controlResetElement, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, module=module, sizeOfNotebook=sizeOfNotebook, moduleStatus=moduleStatus, elementStatus=elementStatus, moduleHwVersion=moduleHwVersion, moduleBiosDate=moduleBiosDate, moduleBusAddress=moduleBusAddress, statusResetCause=statusResetCause, controlTempDeadBand=controlTempDeadBand, moduleDetailTable=moduleDetailTable, statusLmt=statusLmt, controlReset=controlReset, repairDate=repairDate, statusFan=statusFan)
