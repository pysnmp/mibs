...
Integer32, iso, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter64, Gauge32, Bits, ObjectIdentity, Unsigned32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter64", "Gauge32", "Bits", "ObjectIdentity", "Unsigned32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRepairLogTable=moduleRepairLogTable, receiverAddress=receiverAddress, sizeOfRepairlog=sizeOfRepairlog, moduleRegistryEntry=moduleRegistryEntry, moduleRegistry=moduleRegistry, productKeyValue=productKeyValue, controlLocalAccess=controlLocalAccess, controlAlarmOnDelay=controlAlarmOnDelay, repairDate=repairDate, elementInformation=elementInformation, productKeyCipher=productKeyCipher, moduleHwType=moduleHwType, statusSoftware=statusSoftware, moduleBusAddress=moduleBusAddress, element=element, controlAlarmOffDelay=controlAlarmOffDelay, moduleControlEntry=moduleControlEntry, moduleSizeOfTable=moduleSizeOfTable, moduleNotebookTable=moduleNotebookTable, moduleStatusEntry=moduleStatusEntry, statusLid=statusLid, elementConfigChangeCode=elementConfigChangeCode, controlTrapLifeTime=controlTrapLifeTime, controlInternalAppAccess=controlInternalAppAccess, moduleSWUpdateTable=moduleSWUpdateTable, receiverCommunity=receiverCommunity, moduleEntry=moduleEntry, sWUpdateStatus=sWUpdateStatus, moduleNotebookEntry=moduleNotebookEntry, statusTemperature=statusTemperature, moduleInformation=moduleInformation, controlTempLimitHiHi=controlTempLimitHiHi, elementProductKey=elementProductKey, controlTempLimitHi=controlTempLimitHi, controlTrapReceiverEntry=controlTrapReceiverEntry, module=module, repairNameCode=repairNameCode, moduleHwSerialNumber=moduleHwSerialNumber, moduleRegistryTable=moduleRegistryTable, swUpdateURL=swUpdateURL, controlTrapInterval=controlTrapInterval, repairIndex=repairIndex, moduleRackNo=moduleRackNo, elementName=elementName, productKeyFeatureName=productKeyFeatureName, statusLidStatus=statusLidStatus, controlReset=controlReset, controlResetElement=controlResetElement, moduleId=moduleId, sWUpdateFileName=sWUpdateFileName, statusGeneral=statusGeneral, sWUpdateControl=sWUpdateControl, regName=regName, statusHardware=statusHardware, elementResetCount=elementResetCount, controlLedUsage=controlLedUsage, moduleBiosVersion=moduleBiosVersion, statusBusMaster=statusBusMaster, repairComment=repairComment, moduleHwVersion=moduleHwVersion, receiverEntryId=receiverEntryId, moduleAppVersion=moduleAppVersion, productKeyMask=productKeyMask, moduleAppDate=moduleAppDate, statusSettings=statusSettings, productKeyFeatureEnable=productKeyFeatureEnable, productKeyTable=productKeyTable, moduleDetailEntry=moduleDetailEntry, moduleDetailTable=moduleDetailTable, regValue=regValue, sizeOfNotebook=sizeOfNotebook, elementLongitude=elementLongitude, statusRestartCounter=statusRestartCounter, statusInternalTemperature=statusInternalTemperature, productKeyStatus=productKeyStatus, sizeOfRegistry=sizeOfRegistry, controlMarkState=controlMarkState, controlTrapDelay=controlTrapDelay, controlBusMasterAdminState=controlBusMasterAdminState, moduleName=moduleName, elementAltitude=elementAltitude, notebookLineNumber=notebookLineNumber, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureEntry=productKeyFeatureEntry, elementTotalUpTime=elementTotalUpTime, moduleTable=moduleTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapSending=controlTrapSending, moduleMacAddress=moduleMacAddress, elementLatitude=elementLatitude, productKeyIndex=productKeyIndex, statusResetCause=statusResetCause, statusFan=statusFan, elementControl=elementControl, elementStructure=elementStructure, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleStatus=moduleStatus, regIndex=regIndex, repairReasonCode=repairReasonCode, moduleRepairLogEntry=moduleRepairLogEntry, statusRunningSwImage=statusRunningSwImage, notebookLineText=notebookLineText, productKeyFeatureTable=productKeyFeatureTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempDeadBand=controlTempDeadBand, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, statusLmt=statusLmt, controlTrapReceiverTable=controlTrapReceiverTable, productKeyEntry=productKeyEntry, controlTempLimitLo=controlTempLimitLo, controlAlarmDetection=controlAlarmDetection, controlTempLimitLoLo=controlTempLimitLoLo, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleControl=moduleControl, elementStatus=elementStatus, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosDate=moduleBiosDate, receiverPort=receiverPort, moduleStatusTable=moduleStatusTable, moduleControlTable=moduleControlTable)
