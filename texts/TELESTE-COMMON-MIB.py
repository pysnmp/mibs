...
MibIdentifier, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Unsigned32, IpAddress, Integer32, Gauge32, NotificationType, iso, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Unsigned32", "IpAddress", "Integer32", "Gauge32", "NotificationType", "iso", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", receiverCommunity=receiverCommunity, moduleDetailTable=moduleDetailTable, elementResetCount=elementResetCount, statusFan=statusFan, statusSettings=statusSettings, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, regValue=regValue, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, swUpdateURL=swUpdateURL, statusHardware=statusHardware, moduleDetailEntry=moduleDetailEntry, controlAlarmOnDelay=controlAlarmOnDelay, moduleControlEntry=moduleControlEntry, regName=regName, statusSoftware=statusSoftware, productKeyStatus=productKeyStatus, statusLmt=statusLmt, controlTempLimitLoLo=controlTempLimitLoLo, moduleSlotNo=moduleSlotNo, controlMarkState=controlMarkState, repairDate=repairDate, moduleStatusEntry=moduleStatusEntry, controlLedUsage=controlLedUsage, controlReset=controlReset, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleAppVersion=moduleAppVersion, moduleMacAddress=moduleMacAddress, notebookLineText=notebookLineText, elementLongitude=elementLongitude, controlResetElement=controlResetElement, controlTrapReceiverTable=controlTrapReceiverTable, statusRestartCounter=statusRestartCounter, repairComment=repairComment, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureEnable=productKeyFeatureEnable, elementTotalUpTime=elementTotalUpTime, productKeyFeatureTable=productKeyFeatureTable, elementStatus=elementStatus, productKeyCipher=productKeyCipher, notebookLineNumber=notebookLineNumber, sWUpdateStatus=sWUpdateStatus, controlTrapSending=controlTrapSending, controlLocalAccess=controlLocalAccess, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureIndex=productKeyFeatureIndex, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBiosDate=moduleBiosDate, moduleSizeOfTable=moduleSizeOfTable, sizeOfRegistry=sizeOfRegistry, moduleRegistryTable=moduleRegistryTable, statusBusMaster=statusBusMaster, moduleEntry=moduleEntry, moduleRepairLogEntry=moduleRepairLogEntry, repairNameCode=repairNameCode, controlTempLimitLo=controlTempLimitLo, elementInformation=elementInformation, controlAlarmDetection=controlAlarmDetection, productKeyFeatureEntry=productKeyFeatureEntry, moduleControl=moduleControl, moduleRegistryEntry=moduleRegistryEntry, moduleRepairLogTable=moduleRepairLogTable, moduleName=moduleName, productKeyNumberOfKeys=productKeyNumberOfKeys, repairIndex=repairIndex, controlTempDeadBand=controlTempDeadBand, moduleRackNo=moduleRackNo, moduleStatus=moduleStatus, moduleNotebookEntry=moduleNotebookEntry, moduleId=moduleId, elementStructure=elementStructure, receiverEntryId=receiverEntryId, controlTrapInterval=controlTrapInterval, moduleStatusTable=moduleStatusTable, moduleSizeOfEntry=moduleSizeOfEntry, sizeOfNotebook=sizeOfNotebook, moduleBiosVersion=moduleBiosVersion, moduleNotebookTable=moduleNotebookTable, moduleControlTable=moduleControlTable, controlBusMasterAdminState=controlBusMasterAdminState, productKeyEntry=productKeyEntry, productKeyMask=productKeyMask, productKeyValue=productKeyValue, elementProductKey=elementProductKey, controlTrapLifeTime=controlTrapLifeTime, moduleSWUpdateTable=moduleSWUpdateTable, moduleRegistry=moduleRegistry, elementName=elementName, moduleHwType=moduleHwType, statusGeneral=statusGeneral, statusInternalTemperature=statusInternalTemperature, elementConfigChangeCode=elementConfigChangeCode, moduleBusAddress=moduleBusAddress, module=module, productKeyTable=productKeyTable, statusLidStatus=statusLidStatus, moduleAppDate=moduleAppDate, controlTempLimitHi=controlTempLimitHi, productKeyFeatureName=productKeyFeatureName, statusResetCause=statusResetCause, sWUpdateFileName=sWUpdateFileName, elementControl=elementControl, receiverPort=receiverPort, controlInternalAppAccess=controlInternalAppAccess, productKeyIndex=productKeyIndex, sWUpdateControl=sWUpdateControl, sizeOfRepairlog=sizeOfRepairlog, repairReasonCode=repairReasonCode, regIndex=regIndex, statusRunningSwImage=statusRunningSwImage, element=element, statusTemperature=statusTemperature, moduleTable=moduleTable, receiverAddress=receiverAddress, controlTempLimitHiHi=controlTempLimitHiHi, statusLid=statusLid, elementAltitude=elementAltitude, moduleHwSerialNumber=moduleHwSerialNumber, elementLatitude=elementLatitude, moduleHwVersion=moduleHwVersion, moduleInformation=moduleInformation, controlTrapDelay=controlTrapDelay)
