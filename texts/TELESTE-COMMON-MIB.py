...
ObjectIdentity, ModuleIdentity, NotificationType, Gauge32, Unsigned32, Bits, Counter32, iso, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Gauge32", "Unsigned32", "Bits", "Counter32", "iso", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSWUpdateEntry=moduleSWUpdateEntry, sizeOfRegistry=sizeOfRegistry, productKeyFeatureEnable=productKeyFeatureEnable, moduleStatusEntry=moduleStatusEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapReceiverTable=controlTrapReceiverTable, elementLatitude=elementLatitude, moduleStatusTable=moduleStatusTable, moduleRepairLogEntry=moduleRepairLogEntry, statusLidStatus=statusLidStatus, productKeyFeatureTable=productKeyFeatureTable, moduleAppVersion=moduleAppVersion, controlTempLimitHiHi=controlTempLimitHiHi, controlTempLimitLoLo=controlTempLimitLoLo, statusSoftware=statusSoftware, moduleRegistry=moduleRegistry, moduleTable=moduleTable, swUpdateURL=swUpdateURL, receiverPort=receiverPort, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementResetCount=elementResetCount, sizeOfNotebook=sizeOfNotebook, elementName=elementName, productKeyMask=productKeyMask, receiverCommunity=receiverCommunity, elementControl=elementControl, element=element, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusSettings=statusSettings, productKeyFeatureIndex=productKeyFeatureIndex, statusResetCause=statusResetCause, moduleRackNo=moduleRackNo, repairComment=repairComment, moduleControl=moduleControl, controlAlarmOffDelay=controlAlarmOffDelay, moduleHwVersion=moduleHwVersion, receiverEntryId=receiverEntryId, productKeyCipher=productKeyCipher, statusInternalTemperature=statusInternalTemperature, regValue=regValue, elementConfigChangeCode=elementConfigChangeCode, elementStatus=elementStatus, statusFan=statusFan, repairNameCode=repairNameCode, moduleHwSerialNumber=moduleHwSerialNumber, sizeOfRepairlog=sizeOfRepairlog, productKeyTable=productKeyTable, elementStructure=elementStructure, elementTotalUpTime=elementTotalUpTime, sWUpdateStatus=sWUpdateStatus, productKeyStatus=productKeyStatus, elementInformation=elementInformation, moduleStatus=moduleStatus, statusRunningSwImage=statusRunningSwImage, moduleSizeOfTable=moduleSizeOfTable, repairReasonCode=repairReasonCode, receiverAddress=receiverAddress, regIndex=regIndex, moduleEntry=moduleEntry, controlTempLimitLo=controlTempLimitLo, controlLedUsage=controlLedUsage, elementLongitude=elementLongitude, controlTrapLifeTime=controlTrapLifeTime, moduleBusAddress=moduleBusAddress, regName=regName, moduleSizeOfEntry=moduleSizeOfEntry, moduleControlTable=moduleControlTable, repairIndex=repairIndex, elementProductKey=elementProductKey, controlMarkState=controlMarkState, statusLmt=statusLmt, notebookLineNumber=notebookLineNumber, statusHardware=statusHardware, moduleSlotNo=moduleSlotNo, moduleBiosVersion=moduleBiosVersion, notebookLineText=notebookLineText, moduleBiosDate=moduleBiosDate, moduleNotebookTable=moduleNotebookTable, moduleSWUpdateTable=moduleSWUpdateTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapSending=controlTrapSending, moduleMacAddress=moduleMacAddress, moduleAppDate=moduleAppDate, controlLocalAccess=controlLocalAccess, elementAltitude=elementAltitude, moduleDetailEntry=moduleDetailEntry, controlTempLimitHi=controlTempLimitHi, moduleId=moduleId, controlAlarmDetection=controlAlarmDetection, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapInterval=controlTrapInterval, controlResetElement=controlResetElement, controlTempDeadBand=controlTempDeadBand, controlBusMasterAdminState=controlBusMasterAdminState, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateFileName=sWUpdateFileName, repairDate=repairDate, moduleHwType=moduleHwType, moduleRegistryTable=moduleRegistryTable, moduleNotebookEntry=moduleNotebookEntry, statusTemperature=statusTemperature, sWUpdateControl=sWUpdateControl, module=module, moduleInformation=moduleInformation, moduleControlEntry=moduleControlEntry, moduleRegistryEntry=moduleRegistryEntry, moduleDetailTable=moduleDetailTable, statusBusMaster=statusBusMaster, moduleRepairLogTable=moduleRepairLogTable, statusGeneral=statusGeneral, productKeyEntry=productKeyEntry, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEntry=productKeyFeatureEntry, statusLid=statusLid, statusRestartCounter=statusRestartCounter, productKeyValue=productKeyValue, moduleName=moduleName, controlReset=controlReset, productKeyIndex=productKeyIndex, controlTrapDelay=controlTrapDelay)
