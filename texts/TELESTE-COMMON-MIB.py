...
TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, NotificationType, IpAddress, Bits, Integer32, Counter64, Counter32, ObjectIdentity, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress", "Bits", "Integer32", "Counter64", "Counter32", "ObjectIdentity", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapLifeTime=controlTrapLifeTime, sizeOfRegistry=sizeOfRegistry, moduleDetailTable=moduleDetailTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleSWUpdateTable=moduleSWUpdateTable, productKeyIndex=productKeyIndex, repairDate=repairDate, moduleRegistryEntry=moduleRegistryEntry, controlLedUsage=controlLedUsage, moduleAppDate=moduleAppDate, productKeyEntry=productKeyEntry, repairNameCode=repairNameCode, moduleNotebookEntry=moduleNotebookEntry, statusInternalTemperature=statusInternalTemperature, moduleRegistryTable=moduleRegistryTable, statusTemperature=statusTemperature, productKeyNumberOfFeatures=productKeyNumberOfFeatures, regName=regName, elementResetCount=elementResetCount, productKeyMask=productKeyMask, statusFan=statusFan, element=element, controlTrapDelay=controlTrapDelay, controlInternalAppAccess=controlInternalAppAccess, controlResetElement=controlResetElement, receiverAddress=receiverAddress, productKeyFeatureEnable=productKeyFeatureEnable, repairIndex=repairIndex, productKeyValue=productKeyValue, statusBusMaster=statusBusMaster, moduleRepairLogEntry=moduleRepairLogEntry, regValue=regValue, statusLid=statusLid, receiverPort=receiverPort, elementName=elementName, moduleSizeOfTable=moduleSizeOfTable, moduleRackNo=moduleRackNo, productKeyStatus=productKeyStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSoftware=statusSoftware, moduleName=moduleName, productKeyFeatureTable=productKeyFeatureTable, moduleSlotNo=moduleSlotNo, controlTempLimitLo=controlTempLimitLo, controlAlarmOffDelay=controlAlarmOffDelay, controlAlarmDetection=controlAlarmDetection, controlLocalAccess=controlLocalAccess, elementStatus=elementStatus, statusLmt=statusLmt, elementStructure=elementStructure, statusResetCause=statusResetCause, repairReasonCode=repairReasonCode, controlTrapSending=controlTrapSending, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosVersion=moduleBiosVersion, notebookLineNumber=notebookLineNumber, moduleSizeOfEntry=moduleSizeOfEntry, moduleAppVersion=moduleAppVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, elementControl=elementControl, statusGeneral=statusGeneral, controlBusMasterAdminState=controlBusMasterAdminState, moduleEntry=moduleEntry, repairComment=repairComment, elementConfigChangeCode=elementConfigChangeCode, controlMarkState=controlMarkState, moduleId=moduleId, moduleStatus=moduleStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwVersion=moduleHwVersion, receiverEntryId=receiverEntryId, moduleInformation=moduleInformation, statusSettings=statusSettings, moduleControl=moduleControl, elementInformation=elementInformation, moduleNotebookTable=moduleNotebookTable, controlTrapReceiverEntry=controlTrapReceiverEntry, sWUpdateFileName=sWUpdateFileName, productKeyFeatureName=productKeyFeatureName, sizeOfRepairlog=sizeOfRepairlog, moduleRepairLogTable=moduleRepairLogTable, sWUpdateStatus=sWUpdateStatus, controlAlarmOnDelay=controlAlarmOnDelay, moduleMacAddress=moduleMacAddress, elementProductKey=elementProductKey, module=module, swUpdateURL=swUpdateURL, elementAltitude=elementAltitude, moduleTable=moduleTable, statusRestartCounter=statusRestartCounter, statusRunningSwImage=statusRunningSwImage, controlReset=controlReset, moduleHwSerialNumber=moduleHwSerialNumber, moduleDetailEntry=moduleDetailEntry, moduleBiosDate=moduleBiosDate, productKeyCipher=productKeyCipher, moduleBusAddress=moduleBusAddress, sizeOfNotebook=sizeOfNotebook, controlTrapReceiverTable=controlTrapReceiverTable, moduleControlTable=moduleControlTable, notebookLineText=notebookLineText, controlTrapInterval=controlTrapInterval, moduleStatusTable=moduleStatusTable, moduleHwType=moduleHwType, elementLongitude=elementLongitude, elementTotalUpTime=elementTotalUpTime, statusHardware=statusHardware, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempDeadBand=controlTempDeadBand, productKeyFeatureEntry=productKeyFeatureEntry, productKeyTable=productKeyTable, sWUpdateControl=sWUpdateControl, moduleControlEntry=moduleControlEntry, moduleRegistry=moduleRegistry, regIndex=regIndex, receiverCommunity=receiverCommunity, moduleStatusEntry=moduleStatusEntry, elementLatitude=elementLatitude, statusLidStatus=statusLidStatus, controlTempLimitHi=controlTempLimitHi, controlTempLimitLoLo=controlTempLimitLoLo)
