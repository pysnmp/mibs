...
Integer32, ModuleIdentity, NotificationType, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ObjectIdentity, TimeTicks, MibIdentifier, Counter32, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "NotificationType", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter32", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSizeOfTable=moduleSizeOfTable, statusLid=statusLid, repairIndex=repairIndex, controlTrapReceiverEntry=controlTrapReceiverEntry, controlBusMasterAdminState=controlBusMasterAdminState, moduleSizeOfEntry=moduleSizeOfEntry, elementStatus=elementStatus, moduleName=moduleName, repairReasonCode=repairReasonCode, moduleRegistry=moduleRegistry, statusHardware=statusHardware, notebookLineNumber=notebookLineNumber, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementResetCount=elementResetCount, moduleRegistryEntry=moduleRegistryEntry, statusLmt=statusLmt, moduleSWUpdateEntry=moduleSWUpdateEntry, receiverPort=receiverPort, elementStructure=elementStructure, controlReset=controlReset, receiverEntryId=receiverEntryId, receiverCommunity=receiverCommunity, moduleBusAddress=moduleBusAddress, statusFan=statusFan, moduleControlTable=moduleControlTable, sizeOfRepairlog=sizeOfRepairlog, controlTrapInterval=controlTrapInterval, regName=regName, elementAltitude=elementAltitude, controlAlarmOnDelay=controlAlarmOnDelay, productKeyEntry=productKeyEntry, moduleSWUpdateTable=moduleSWUpdateTable, moduleEntry=moduleEntry, productKeyStatus=productKeyStatus, statusGeneral=statusGeneral, productKeyNumberOfKeys=productKeyNumberOfKeys, controlAlarmDetection=controlAlarmDetection, moduleMacAddress=moduleMacAddress, regIndex=regIndex, controlTempLimitHi=controlTempLimitHi, elementControl=elementControl, notebookLineText=notebookLineText, elementTotalUpTime=elementTotalUpTime, elementLongitude=elementLongitude, statusResetCause=statusResetCause, controlMarkState=controlMarkState, regValue=regValue, moduleId=moduleId, statusInternalTemperature=statusInternalTemperature, swUpdateURL=swUpdateURL, sWUpdateFileName=sWUpdateFileName, moduleBiosVersion=moduleBiosVersion, statusBusMaster=statusBusMaster, receiverAddress=receiverAddress, elementLatitude=elementLatitude, elementInformation=elementInformation, statusSoftware=statusSoftware, productKeyFeatureTable=productKeyFeatureTable, moduleStatusTable=moduleStatusTable, statusTemperature=statusTemperature, moduleControl=moduleControl, productKeyValue=productKeyValue, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleHwSerialNumber=moduleHwSerialNumber, statusRestartCounter=statusRestartCounter, productKeyIndex=productKeyIndex, sizeOfNotebook=sizeOfNotebook, moduleStatus=moduleStatus, moduleHwType=moduleHwType, repairNameCode=repairNameCode, moduleDetailTable=moduleDetailTable, productKeyFeatureEnable=productKeyFeatureEnable, statusRunningSwImage=statusRunningSwImage, sizeOfRegistry=sizeOfRegistry, productKeyFeatureIndex=productKeyFeatureIndex, elementName=elementName, productKeyCipher=productKeyCipher, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRegistryTable=moduleRegistryTable, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureName=productKeyFeatureName, sWUpdateStatus=sWUpdateStatus, controlTrapDelay=controlTrapDelay, moduleNotebookEntry=moduleNotebookEntry, moduleAppDate=moduleAppDate, repairComment=repairComment, moduleNotebookTable=moduleNotebookTable, moduleRepairLogTable=moduleRepairLogTable, moduleDetailEntry=moduleDetailEntry, controlTempLimitLoLo=controlTempLimitLoLo, statusSettings=statusSettings, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatusEntry=moduleStatusEntry, controlTrapSending=controlTrapSending, controlInternalAppAccess=controlInternalAppAccess, controlLocalAccess=controlLocalAccess, repairDate=repairDate, elementConfigChangeCode=elementConfigChangeCode, productKeyTable=productKeyTable, statusLidStatus=statusLidStatus, module=module, elementProductKey=elementProductKey, moduleControlEntry=moduleControlEntry, moduleRepairLogEntry=moduleRepairLogEntry, sWUpdateControl=sWUpdateControl, moduleAppVersion=moduleAppVersion, controlAlarmOffDelay=controlAlarmOffDelay, controlTempLimitLo=controlTempLimitLo, productKeyFeatureEntry=productKeyFeatureEntry, productKeyMask=productKeyMask, moduleTable=moduleTable, element=element, moduleRackNo=moduleRackNo, controlTempLimitHiHi=controlTempLimitHiHi, controlResetElement=controlResetElement, moduleHwVersion=moduleHwVersion, moduleInformation=moduleInformation, moduleBiosDate=moduleBiosDate, controlTempDeadBand=controlTempDeadBand)
