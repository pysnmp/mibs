...
Bits, Gauge32, ModuleIdentity, ObjectIdentity, Counter64, iso, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Unsigned32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Counter64", "iso", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Unsigned32", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLongitude=elementLongitude, receiverEntryId=receiverEntryId, productKeyNumberOfKeys=productKeyNumberOfKeys, productKeyFeatureIndex=productKeyFeatureIndex, receiverAddress=receiverAddress, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureEnable=productKeyFeatureEnable, controlAlarmDetection=controlAlarmDetection, productKeyMask=productKeyMask, controlAlarmOffDelay=controlAlarmOffDelay, productKeyCipher=productKeyCipher, controlTempLimitHi=controlTempLimitHi, repairNameCode=repairNameCode, controlBusMasterAdminState=controlBusMasterAdminState, productKeyTable=productKeyTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleSizeOfTable=moduleSizeOfTable, moduleHwType=moduleHwType, moduleEntry=moduleEntry, controlLocalAccess=controlLocalAccess, moduleName=moduleName, moduleSWUpdateTable=moduleSWUpdateTable, controlMarkState=controlMarkState, controlTempDeadBand=controlTempDeadBand, moduleInformation=moduleInformation, sizeOfNotebook=sizeOfNotebook, productKeyFeatureEntry=productKeyFeatureEntry, elementAltitude=elementAltitude, moduleControlTable=moduleControlTable, controlTempLimitLo=controlTempLimitLo, controlAlarmOnDelay=controlAlarmOnDelay, moduleBusAddress=moduleBusAddress, notebookLineText=notebookLineText, moduleControl=moduleControl, moduleBiosVersion=moduleBiosVersion, controlReset=controlReset, statusFan=statusFan, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapReceiverTable=controlTrapReceiverTable, elementInformation=elementInformation, moduleSizeOfEntry=moduleSizeOfEntry, controlTempLimitLoLo=controlTempLimitLoLo, moduleStatus=moduleStatus, productKeyEntry=productKeyEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, elementControl=elementControl, notebookLineNumber=notebookLineNumber, statusGeneral=statusGeneral, elementResetCount=elementResetCount, elementProductKey=elementProductKey, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementStatus=elementStatus, moduleRegistryEntry=moduleRegistryEntry, repairReasonCode=repairReasonCode, controlResetElement=controlResetElement, sizeOfRepairlog=sizeOfRepairlog, moduleStatusTable=moduleStatusTable, receiverPort=receiverPort, productKeyFeatureName=productKeyFeatureName, statusInternalTemperature=statusInternalTemperature, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapDelay=controlTrapDelay, moduleDetailTable=moduleDetailTable, elementName=elementName, sWUpdateStatus=sWUpdateStatus, productKeyValue=productKeyValue, statusRunningSwImage=statusRunningSwImage, statusRestartCounter=statusRestartCounter, statusHardware=statusHardware, moduleRegistryTable=moduleRegistryTable, moduleMacAddress=moduleMacAddress, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleNotebookEntry=moduleNotebookEntry, module=module, moduleRackNo=moduleRackNo, moduleRegistry=moduleRegistry, controlInternalAppAccess=controlInternalAppAccess, element=element, moduleAppDate=moduleAppDate, productKeyStatus=productKeyStatus, statusLidStatus=statusLidStatus, moduleAppVersion=moduleAppVersion, statusResetCause=statusResetCause, moduleNotebookTable=moduleNotebookTable, elementLatitude=elementLatitude, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapInterval=controlTrapInterval, moduleHwSerialNumber=moduleHwSerialNumber, controlTrapSending=controlTrapSending, elementTotalUpTime=elementTotalUpTime, repairDate=repairDate, moduleRepairLogTable=moduleRepairLogTable, statusSettings=statusSettings, controlLedUsage=controlLedUsage, repairIndex=repairIndex, receiverCommunity=receiverCommunity, controlTrapLifeTime=controlTrapLifeTime, statusTemperature=statusTemperature, regValue=regValue, elementStructure=elementStructure, moduleTable=moduleTable, moduleControlEntry=moduleControlEntry, moduleId=moduleId, repairComment=repairComment, statusBusMaster=statusBusMaster, sWUpdateControl=sWUpdateControl, swUpdateURL=swUpdateURL, moduleDetailEntry=moduleDetailEntry, statusLid=statusLid, sizeOfRegistry=sizeOfRegistry, statusLmt=statusLmt, moduleHwVersion=moduleHwVersion, productKeyIndex=productKeyIndex, elementConfigChangeCode=elementConfigChangeCode, moduleBiosDate=moduleBiosDate, moduleStatusEntry=moduleStatusEntry, regName=regName, sWUpdateFileName=sWUpdateFileName, regIndex=regIndex, statusSoftware=statusSoftware)
