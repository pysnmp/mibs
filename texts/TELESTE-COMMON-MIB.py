...
Counter32, ModuleIdentity, Gauge32, Bits, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, TimeTicks, ObjectIdentity, Unsigned32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Gauge32", "Bits", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusGeneral=statusGeneral, moduleAppDate=moduleAppDate, elementConfigChangeCode=elementConfigChangeCode, statusLidStatus=statusLidStatus, statusLmt=statusLmt, moduleRepairLogTable=moduleRepairLogTable, moduleTable=moduleTable, controlLocalAccess=controlLocalAccess, moduleBiosVersion=moduleBiosVersion, elementStructure=elementStructure, regValue=regValue, notebookLineText=notebookLineText, elementControl=elementControl, productKeyIndex=productKeyIndex, receiverAddress=receiverAddress, moduleMacAddress=moduleMacAddress, moduleHwVersion=moduleHwVersion, moduleRegistryEntry=moduleRegistryEntry, elementAltitude=elementAltitude, elementName=elementName, module=module, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureIndex=productKeyFeatureIndex, controlLedUsage=controlLedUsage, statusSoftware=statusSoftware, moduleHwSerialNumber=moduleHwSerialNumber, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusTemperature=statusTemperature, controlTrapInterval=controlTrapInterval, productKeyEntry=productKeyEntry, regName=regName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleBusAddress=moduleBusAddress, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleControlTable=moduleControlTable, moduleSizeOfTable=moduleSizeOfTable, sizeOfRegistry=sizeOfRegistry, elementProductKey=elementProductKey, notebookLineNumber=notebookLineNumber, moduleSlotNo=moduleSlotNo, receiverCommunity=receiverCommunity, receiverPort=receiverPort, sizeOfNotebook=sizeOfNotebook, regIndex=regIndex, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureEnable=productKeyFeatureEnable, repairNameCode=repairNameCode, elementLatitude=elementLatitude, moduleInformation=moduleInformation, moduleAppVersion=moduleAppVersion, elementInformation=elementInformation, moduleStatusTable=moduleStatusTable, statusBusMaster=statusBusMaster, statusSettings=statusSettings, controlTempLimitHiHi=controlTempLimitHiHi, elementResetCount=elementResetCount, moduleRegistry=moduleRegistry, sWUpdateControl=sWUpdateControl, controlTrapLifeTime=controlTrapLifeTime, controlAlarmOffDelay=controlAlarmOffDelay, statusRunningSwImage=statusRunningSwImage, productKeyFeatureName=productKeyFeatureName, moduleEntry=moduleEntry, productKeyCipher=productKeyCipher, controlBusMasterAdminState=controlBusMasterAdminState, moduleName=moduleName, moduleStatus=moduleStatus, moduleControlEntry=moduleControlEntry, element=element, moduleRegistryTable=moduleRegistryTable, controlAlarmDetection=controlAlarmDetection, controlTrapSending=controlTrapSending, productKeyFeatureEntry=productKeyFeatureEntry, moduleDetailEntry=moduleDetailEntry, moduleSWUpdateTable=moduleSWUpdateTable, swUpdateURL=swUpdateURL, moduleRepairLogEntry=moduleRepairLogEntry, controlResetElement=controlResetElement, receiverEntryId=receiverEntryId, productKeyMask=productKeyMask, moduleControl=moduleControl, moduleBiosDate=moduleBiosDate, controlMarkState=controlMarkState, productKeyFeatureTable=productKeyFeatureTable, elementLongitude=elementLongitude, repairComment=repairComment, elementTotalUpTime=elementTotalUpTime, repairReasonCode=repairReasonCode, controlTempLimitHi=controlTempLimitHi, moduleId=moduleId, sWUpdateStatus=sWUpdateStatus, elementStatus=elementStatus, sizeOfRepairlog=sizeOfRepairlog, productKeyStatus=productKeyStatus, controlTempLimitLo=controlTempLimitLo, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleStatusEntry=moduleStatusEntry, productKeyTable=productKeyTable, controlTrapDelay=controlTrapDelay, moduleNotebookTable=moduleNotebookTable, controlReset=controlReset, productKeyValue=productKeyValue, repairIndex=repairIndex, controlTrapReceiverTable=controlTrapReceiverTable, moduleDetailTable=moduleDetailTable, moduleHwType=moduleHwType, controlTempLimitLoLo=controlTempLimitLoLo, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateFileName=sWUpdateFileName, moduleRackNo=moduleRackNo, statusFan=statusFan, statusResetCause=statusResetCause, statusRestartCounter=statusRestartCounter, controlTempDeadBand=controlTempDeadBand, statusLid=statusLid, controlInternalAppAccess=controlInternalAppAccess, statusInternalTemperature=statusInternalTemperature, statusHardware=statusHardware, repairDate=repairDate, moduleSizeOfEntry=moduleSizeOfEntry)
