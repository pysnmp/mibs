...
IpAddress, Counter32, Counter64, NotificationType, ModuleIdentity, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlMarkState=controlMarkState, repairReasonCode=repairReasonCode, moduleDetailTable=moduleDetailTable, controlInternalAppAccess=controlInternalAppAccess, sizeOfRepairlog=sizeOfRepairlog, repairNameCode=repairNameCode, moduleControl=moduleControl, receiverPort=receiverPort, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementStructure=elementStructure, productKeyFeatureEnable=productKeyFeatureEnable, moduleNotebookEntry=moduleNotebookEntry, moduleEntry=moduleEntry, receiverCommunity=receiverCommunity, productKeyFeatureIndex=productKeyFeatureIndex, moduleRepairLogTable=moduleRepairLogTable, elementInformation=elementInformation, sWUpdateFileName=sWUpdateFileName, moduleStatus=moduleStatus, moduleHwVersion=moduleHwVersion, controlTempLimitHiHi=controlTempLimitHiHi, moduleControlEntry=moduleControlEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, repairIndex=repairIndex, elementProductKey=elementProductKey, statusRunningSwImage=statusRunningSwImage, moduleInformation=moduleInformation, statusInternalTemperature=statusInternalTemperature, moduleStatusTable=moduleStatusTable, moduleSizeOfTable=moduleSizeOfTable, productKeyEntry=productKeyEntry, productKeyMask=productKeyMask, controlTempLimitHi=controlTempLimitHi, moduleNotebookTable=moduleNotebookTable, moduleBiosDate=moduleBiosDate, controlTempDeadBand=controlTempDeadBand, elementName=elementName, productKeyIndex=productKeyIndex, elementAltitude=elementAltitude, module=module, moduleDetailEntry=moduleDetailEntry, moduleSlotNo=moduleSlotNo, controlLocalAccess=controlLocalAccess, statusRestartCounter=statusRestartCounter, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, receiverEntryId=receiverEntryId, regValue=regValue, sWUpdateControl=sWUpdateControl, productKeyCipher=productKeyCipher, elementLatitude=elementLatitude, swUpdateURL=swUpdateURL, moduleRackNo=moduleRackNo, element=element, moduleStatusEntry=moduleStatusEntry, regName=regName, sizeOfRegistry=sizeOfRegistry, statusFan=statusFan, controlAlarmOffDelay=controlAlarmOffDelay, controlTempLimitLo=controlTempLimitLo, statusSettings=statusSettings, controlTrapInterval=controlTrapInterval, moduleId=moduleId, elementTotalUpTime=elementTotalUpTime, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleAppVersion=moduleAppVersion, statusLid=statusLid, controlLedUsage=controlLedUsage, moduleRepairLogEntry=moduleRepairLogEntry, moduleName=moduleName, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleSWUpdateTable=moduleSWUpdateTable, statusLidStatus=statusLidStatus, statusHardware=statusHardware, notebookLineNumber=notebookLineNumber, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleControlTable=moduleControlTable, controlTempLimitLoLo=controlTempLimitLoLo, productKeyValue=productKeyValue, productKeyFeatureEntry=productKeyFeatureEntry, elementLongitude=elementLongitude, repairComment=repairComment, moduleBusAddress=moduleBusAddress, controlResetElement=controlResetElement, controlReset=controlReset, controlBusMasterAdminState=controlBusMasterAdminState, elementConfigChangeCode=elementConfigChangeCode, controlTrapLifeTime=controlTrapLifeTime, controlAlarmOnDelay=controlAlarmOnDelay, moduleMacAddress=moduleMacAddress, controlTrapSending=controlTrapSending, regIndex=regIndex, repairDate=repairDate, moduleBiosVersion=moduleBiosVersion, moduleHwType=moduleHwType, productKeyFeatureTable=productKeyFeatureTable, receiverAddress=receiverAddress, elementControl=elementControl, moduleRegistry=moduleRegistry, moduleRegistryEntry=moduleRegistryEntry, statusTemperature=statusTemperature, notebookLineText=notebookLineText, controlTrapDelay=controlTrapDelay, statusBusMaster=statusBusMaster, moduleAppDate=moduleAppDate, moduleTable=moduleTable, moduleHwSerialNumber=moduleHwSerialNumber, statusResetCause=statusResetCause, moduleSizeOfEntry=moduleSizeOfEntry, moduleRegistryTable=moduleRegistryTable, statusGeneral=statusGeneral, controlAlarmDetection=controlAlarmDetection, productKeyTable=productKeyTable, productKeyFeatureName=productKeyFeatureName, sWUpdateStatus=sWUpdateStatus, statusSoftware=statusSoftware, productKeyStatus=productKeyStatus, elementStatus=elementStatus, elementResetCount=elementResetCount, productKeyNumberOfKeys=productKeyNumberOfKeys)
