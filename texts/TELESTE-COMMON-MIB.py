...
Unsigned32, iso, Counter64, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, Bits, IpAddress, TimeTicks, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter64", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "Bits", "IpAddress", "TimeTicks", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapLifeTime=controlTrapLifeTime, repairIndex=repairIndex, moduleRepairLogTable=moduleRepairLogTable, statusBusMaster=statusBusMaster, statusLmt=statusLmt, elementStatus=elementStatus, moduleSizeOfEntry=moduleSizeOfEntry, elementControl=elementControl, sWUpdateFileName=sWUpdateFileName, controlAlarmOnDelay=controlAlarmOnDelay, moduleControl=moduleControl, elementConfigChangeCode=elementConfigChangeCode, moduleStatus=moduleStatus, controlTempLimitHiHi=controlTempLimitHiHi, moduleHwSerialNumber=moduleHwSerialNumber, repairComment=repairComment, moduleRegistryEntry=moduleRegistryEntry, moduleSizeOfTable=moduleSizeOfTable, moduleTable=moduleTable, controlInternalAppAccess=controlInternalAppAccess, elementInformation=elementInformation, moduleRegistryTable=moduleRegistryTable, element=element, moduleRegistry=moduleRegistry, moduleSWUpdateTable=moduleSWUpdateTable, productKeyIndex=productKeyIndex, controlResetElement=controlResetElement, controlReset=controlReset, statusFan=statusFan, controlTrapInterval=controlTrapInterval, moduleDetailEntry=moduleDetailEntry, moduleDetailTable=moduleDetailTable, controlTempLimitLo=controlTempLimitLo, statusSoftware=statusSoftware, moduleBiosVersion=moduleBiosVersion, moduleNotebookEntry=moduleNotebookEntry, statusHardware=statusHardware, receiverCommunity=receiverCommunity, statusInternalTemperature=statusInternalTemperature, regValue=regValue, controlTrapSending=controlTrapSending, productKeyMask=productKeyMask, elementAltitude=elementAltitude, controlMarkState=controlMarkState, productKeyFeatureEntry=productKeyFeatureEntry, elementProductKey=elementProductKey, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementResetCount=elementResetCount, moduleAppDate=moduleAppDate, moduleMacAddress=moduleMacAddress, elementLatitude=elementLatitude, sizeOfNotebook=sizeOfNotebook, productKeyStatus=productKeyStatus, controlAlarmOffDelay=controlAlarmOffDelay, receiverEntryId=receiverEntryId, elementName=elementName, moduleEntry=moduleEntry, controlTrapReceiverEntry=controlTrapReceiverEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, statusGeneral=statusGeneral, productKeyCipher=productKeyCipher, moduleRackNo=moduleRackNo, moduleStatusEntry=moduleStatusEntry, swUpdateURL=swUpdateURL, moduleStatusTable=moduleStatusTable, statusSettings=statusSettings, notebookLineNumber=notebookLineNumber, productKeyEntry=productKeyEntry, statusResetCause=statusResetCause, elementTotalUpTime=elementTotalUpTime, receiverPort=receiverPort, moduleRepairLogEntry=moduleRepairLogEntry, elementStructure=elementStructure, moduleControlEntry=moduleControlEntry, repairReasonCode=repairReasonCode, controlAlarmDetection=controlAlarmDetection, productKeyTable=productKeyTable, moduleControlTable=moduleControlTable, moduleAppVersion=moduleAppVersion, elementLongitude=elementLongitude, notebookLineText=notebookLineText, module=module, statusTemperature=statusTemperature, moduleNotebookTable=moduleNotebookTable, productKeyNumberOfKeys=productKeyNumberOfKeys, sWUpdateControl=sWUpdateControl, controlTrapReceiverTable=controlTrapReceiverTable, statusRunningSwImage=statusRunningSwImage, controlTrapDelay=controlTrapDelay, productKeyFeatureTable=productKeyFeatureTable, controlBusMasterAdminState=controlBusMasterAdminState, moduleHwType=moduleHwType, receiverAddress=receiverAddress, moduleBusAddress=moduleBusAddress, repairDate=repairDate, moduleHwVersion=moduleHwVersion, controlTempDeadBand=controlTempDeadBand, sizeOfRegistry=sizeOfRegistry, moduleName=moduleName, controlTempLimitLoLo=controlTempLimitLoLo, controlLocalAccess=controlLocalAccess, moduleInformation=moduleInformation, regName=regName, productKeyFeatureIndex=productKeyFeatureIndex, statusLid=statusLid, controlTempLimitHi=controlTempLimitHi, repairNameCode=repairNameCode, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyFeatureName=productKeyFeatureName, moduleBiosDate=moduleBiosDate, productKeyFeatureEnable=productKeyFeatureEnable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusLidStatus=statusLidStatus, productKeyValue=productKeyValue, regIndex=regIndex, moduleId=moduleId, statusRestartCounter=statusRestartCounter, sizeOfRepairlog=sizeOfRepairlog, sWUpdateStatus=sWUpdateStatus)
