...
Integer32, ObjectIdentity, Counter64, TimeTicks, MibIdentifier, Bits, Gauge32, ModuleIdentity, Unsigned32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter64", "TimeTicks", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "Unsigned32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusGeneral=statusGeneral, moduleControlTable=moduleControlTable, elementStatus=elementStatus, controlTrapDelay=controlTrapDelay, moduleBiosVersion=moduleBiosVersion, statusRestartCounter=statusRestartCounter, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleBusAddress=moduleBusAddress, elementControl=elementControl, moduleRegistry=moduleRegistry, productKeyFeatureIndex=productKeyFeatureIndex, repairReasonCode=repairReasonCode, moduleSlotNo=moduleSlotNo, elementLongitude=elementLongitude, moduleMacAddress=moduleMacAddress, statusHardware=statusHardware, elementTotalUpTime=elementTotalUpTime, productKeyStatus=productKeyStatus, moduleHwType=moduleHwType, controlMarkState=controlMarkState, moduleRegistryTable=moduleRegistryTable, repairNameCode=repairNameCode, moduleSWUpdateTable=moduleSWUpdateTable, sWUpdateFileName=sWUpdateFileName, productKeyMask=productKeyMask, statusTemperature=statusTemperature, statusLidStatus=statusLidStatus, statusFan=statusFan, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleId=moduleId, moduleNotebookEntry=moduleNotebookEntry, controlTempDeadBand=controlTempDeadBand, moduleAppVersion=moduleAppVersion, element=element, moduleNotebookTable=moduleNotebookTable, receiverEntryId=receiverEntryId, moduleDetailTable=moduleDetailTable, notebookLineNumber=notebookLineNumber, controlTrapInterval=controlTrapInterval, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyValue=productKeyValue, controlTempLimitLo=controlTempLimitLo, sizeOfRegistry=sizeOfRegistry, controlTrapReceiverTable=controlTrapReceiverTable, sizeOfRepairlog=sizeOfRepairlog, repairDate=repairDate, moduleDetailEntry=moduleDetailEntry, regName=regName, elementLatitude=elementLatitude, swUpdateURL=swUpdateURL, elementInformation=elementInformation, elementConfigChangeCode=elementConfigChangeCode, elementProductKey=elementProductKey, controlReset=controlReset, statusBusMaster=statusBusMaster, productKeyCipher=productKeyCipher, moduleEntry=moduleEntry, sWUpdateControl=sWUpdateControl, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleControl=moduleControl, productKeyTable=productKeyTable, moduleRackNo=moduleRackNo, controlInternalAppAccess=controlInternalAppAccess, controlTempLimitHiHi=controlTempLimitHiHi, productKeyEntry=productKeyEntry, moduleStatusEntry=moduleStatusEntry, productKeyFeatureEntry=productKeyFeatureEntry, sWUpdateStatus=sWUpdateStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTempLimitLoLo=controlTempLimitLoLo, controlResetElement=controlResetElement, moduleBiosDate=moduleBiosDate, controlLocalAccess=controlLocalAccess, controlLedUsage=controlLedUsage, moduleControlEntry=moduleControlEntry, statusLmt=statusLmt, moduleHwSerialNumber=moduleHwSerialNumber, repairComment=repairComment, regValue=regValue, controlTrapReceiverEntry=controlTrapReceiverEntry, regIndex=regIndex, productKeyFeatureName=productKeyFeatureName, receiverPort=receiverPort, productKeyIndex=productKeyIndex, controlAlarmDetection=controlAlarmDetection, controlAlarmOffDelay=controlAlarmOffDelay, elementAltitude=elementAltitude, controlTempLimitHi=controlTempLimitHi, moduleSizeOfEntry=moduleSizeOfEntry, moduleRegistryEntry=moduleRegistryEntry, moduleRepairLogEntry=moduleRepairLogEntry, statusLid=statusLid, repairIndex=repairIndex, controlAlarmOnDelay=controlAlarmOnDelay, statusRunningSwImage=statusRunningSwImage, moduleHwVersion=moduleHwVersion, statusSoftware=statusSoftware, statusResetCause=statusResetCause, moduleName=moduleName, module=module, receiverAddress=receiverAddress, moduleStatus=moduleStatus, controlTrapSending=controlTrapSending, moduleRepairLogTable=moduleRepairLogTable, elementResetCount=elementResetCount, elementName=elementName, moduleStatusTable=moduleStatusTable, productKeyFeatureTable=productKeyFeatureTable, sizeOfNotebook=sizeOfNotebook, moduleSizeOfTable=moduleSizeOfTable, moduleAppDate=moduleAppDate, productKeyFeatureEnable=productKeyFeatureEnable, notebookLineText=notebookLineText, statusSettings=statusSettings, elementStructure=elementStructure, receiverCommunity=receiverCommunity, controlTrapLifeTime=controlTrapLifeTime, statusInternalTemperature=statusInternalTemperature, moduleTable=moduleTable, moduleInformation=moduleInformation, controlBusMasterAdminState=controlBusMasterAdminState)
