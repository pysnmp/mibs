...
iso, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, ModuleIdentity, NotificationType, Gauge32, ObjectIdentity, TimeTicks, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "ModuleIdentity", "NotificationType", "Gauge32", "ObjectIdentity", "TimeTicks", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSlotNo=moduleSlotNo, statusRestartCounter=statusRestartCounter, moduleRegistryTable=moduleRegistryTable, sWUpdateStatus=sWUpdateStatus, notebookLineNumber=notebookLineNumber, moduleStatusTable=moduleStatusTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleSizeOfEntry=moduleSizeOfEntry, statusLidStatus=statusLidStatus, productKeyNumberOfKeys=productKeyNumberOfKeys, controlLocalAccess=controlLocalAccess, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitLoLo=controlTempLimitLoLo, swUpdateURL=swUpdateURL, regValue=regValue, productKeyIndex=productKeyIndex, sWUpdateControl=sWUpdateControl, statusLmt=statusLmt, moduleHwSerialNumber=moduleHwSerialNumber, moduleMacAddress=moduleMacAddress, sizeOfRepairlog=sizeOfRepairlog, controlTrapDelay=controlTrapDelay, statusHardware=statusHardware, repairComment=repairComment, moduleRegistry=moduleRegistry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementLongitude=elementLongitude, moduleRackNo=moduleRackNo, elementControl=elementControl, controlTrapLifeTime=controlTrapLifeTime, moduleStatusEntry=moduleStatusEntry, receiverEntryId=receiverEntryId, repairNameCode=repairNameCode, productKeyMask=productKeyMask, controlReset=controlReset, elementStatus=elementStatus, productKeyFeatureName=productKeyFeatureName, sWUpdateFileName=sWUpdateFileName, moduleId=moduleId, moduleRepairLogTable=moduleRepairLogTable, element=element, elementStructure=elementStructure, statusInternalTemperature=statusInternalTemperature, moduleAppDate=moduleAppDate, statusResetCause=statusResetCause, productKeyCipher=productKeyCipher, elementConfigChangeCode=elementConfigChangeCode, controlBusMasterAdminState=controlBusMasterAdminState, statusGeneral=statusGeneral, moduleBiosDate=moduleBiosDate, statusLid=statusLid, receiverCommunity=receiverCommunity, productKeyFeatureEnable=productKeyFeatureEnable, productKeyEntry=productKeyEntry, repairIndex=repairIndex, moduleBiosVersion=moduleBiosVersion, moduleRepairLogEntry=moduleRepairLogEntry, elementTotalUpTime=elementTotalUpTime, elementLatitude=elementLatitude, moduleDetailTable=moduleDetailTable, elementName=elementName, statusSettings=statusSettings, notebookLineText=notebookLineText, controlTrapInterval=controlTrapInterval, regName=regName, controlLedUsage=controlLedUsage, controlAlarmDetection=controlAlarmDetection, receiverAddress=receiverAddress, receiverPort=receiverPort, statusTemperature=statusTemperature, controlTrapSending=controlTrapSending, controlTrapReceiverEntry=controlTrapReceiverEntry, elementResetCount=elementResetCount, controlTempLimitHi=controlTempLimitHi, moduleBusAddress=moduleBusAddress, moduleHwVersion=moduleHwVersion, sizeOfRegistry=sizeOfRegistry, controlTrapReceiverTable=controlTrapReceiverTable, controlAlarmOffDelay=controlAlarmOffDelay, moduleEntry=moduleEntry, elementAltitude=elementAltitude, controlResetElement=controlResetElement, productKeyFeatureIndex=productKeyFeatureIndex, statusBusMaster=statusBusMaster, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleInformation=moduleInformation, statusFan=statusFan, productKeyTable=productKeyTable, statusSoftware=statusSoftware, productKeyFeatureEntry=productKeyFeatureEntry, productKeyStatus=productKeyStatus, moduleHwType=moduleHwType, moduleDetailEntry=moduleDetailEntry, moduleTable=moduleTable, module=module, controlTempDeadBand=controlTempDeadBand, moduleSizeOfTable=moduleSizeOfTable, controlInternalAppAccess=controlInternalAppAccess, controlTempLimitLo=controlTempLimitLo, repairDate=repairDate, repairReasonCode=repairReasonCode, regIndex=regIndex, moduleControlEntry=moduleControlEntry, sizeOfNotebook=sizeOfNotebook, elementInformation=elementInformation, productKeyValue=productKeyValue, moduleControlTable=moduleControlTable, productKeyFeatureTable=productKeyFeatureTable, moduleControl=moduleControl, moduleName=moduleName, moduleRegistryEntry=moduleRegistryEntry, moduleAppVersion=moduleAppVersion, controlMarkState=controlMarkState, statusRunningSwImage=statusRunningSwImage, controlAlarmOnDelay=controlAlarmOnDelay, moduleStatus=moduleStatus, moduleNotebookTable=moduleNotebookTable, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementProductKey=elementProductKey)
