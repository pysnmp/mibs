...
NotificationType, IpAddress, Integer32, ObjectIdentity, Bits, Counter64, ModuleIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Integer32", "ObjectIdentity", "Bits", "Counter64", "ModuleIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleRegistryTable=moduleRegistryTable, moduleAppVersion=moduleAppVersion, moduleTable=moduleTable, productKeyFeatureIndex=productKeyFeatureIndex, statusBusMaster=statusBusMaster, moduleBiosDate=moduleBiosDate, moduleStatusTable=moduleStatusTable, moduleRegistry=moduleRegistry, statusFan=statusFan, statusSettings=statusSettings, controlTempDeadBand=controlTempDeadBand, moduleControlTable=moduleControlTable, moduleControlEntry=moduleControlEntry, productKeyCipher=productKeyCipher, sizeOfRepairlog=sizeOfRepairlog, moduleHwSerialNumber=moduleHwSerialNumber, receiverAddress=receiverAddress, controlTrapDelay=controlTrapDelay, regName=regName, moduleAppDate=moduleAppDate, statusLid=statusLid, controlLedUsage=controlLedUsage, controlTrapLifeTime=controlTrapLifeTime, moduleSizeOfTable=moduleSizeOfTable, elementControl=elementControl, moduleBiosVersion=moduleBiosVersion, sWUpdateControl=sWUpdateControl, productKeyFeatureEnable=productKeyFeatureEnable, controlTempLimitLo=controlTempLimitLo, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineText=notebookLineText, sizeOfRegistry=sizeOfRegistry, controlTempLimitLoLo=controlTempLimitLoLo, productKeyEntry=productKeyEntry, moduleDetailTable=moduleDetailTable, elementName=elementName, sWUpdateStatus=sWUpdateStatus, receiverCommunity=receiverCommunity, productKeyIndex=productKeyIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlAlarmDetection=controlAlarmDetection, moduleNotebookEntry=moduleNotebookEntry, moduleSizeOfEntry=moduleSizeOfEntry, moduleStatus=moduleStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlLocalAccess=controlLocalAccess, elementStructure=elementStructure, controlTrapReceiverEntry=controlTrapReceiverEntry, repairNameCode=repairNameCode, statusTemperature=statusTemperature, moduleNotebookTable=moduleNotebookTable, productKeyValue=productKeyValue, sizeOfNotebook=sizeOfNotebook, receiverPort=receiverPort, controlAlarmOnDelay=controlAlarmOnDelay, repairDate=repairDate, moduleControl=moduleControl, repairIndex=repairIndex, controlBusMasterAdminState=controlBusMasterAdminState, statusSoftware=statusSoftware, statusRunningSwImage=statusRunningSwImage, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, moduleHwVersion=moduleHwVersion, controlTempLimitHiHi=controlTempLimitHiHi, swUpdateURL=swUpdateURL, controlTrapSending=controlTrapSending, controlTrapInterval=controlTrapInterval, elementAltitude=elementAltitude, moduleDetailEntry=moduleDetailEntry, elementProductKey=elementProductKey, productKeyFeatureTable=productKeyFeatureTable, elementStatus=elementStatus, module=module, moduleRegistryEntry=moduleRegistryEntry, moduleRepairLogTable=moduleRepairLogTable, moduleBusAddress=moduleBusAddress, regValue=regValue, moduleHwType=moduleHwType, moduleStatusEntry=moduleStatusEntry, statusResetCause=statusResetCause, sWUpdateFileName=sWUpdateFileName, statusHardware=statusHardware, controlReset=controlReset, elementResetCount=elementResetCount, productKeyNumberOfKeys=productKeyNumberOfKeys, elementTotalUpTime=elementTotalUpTime, statusRestartCounter=statusRestartCounter, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateTable=moduleSWUpdateTable, repairReasonCode=repairReasonCode, productKeyMask=productKeyMask, elementLatitude=elementLatitude, moduleName=moduleName, moduleInformation=moduleInformation, notebookLineNumber=notebookLineNumber, controlResetElement=controlResetElement, controlTempLimitHi=controlTempLimitHi, repairComment=repairComment, statusGeneral=statusGeneral, elementInformation=elementInformation, productKeyTable=productKeyTable, controlInternalAppAccess=controlInternalAppAccess, elementConfigChangeCode=elementConfigChangeCode, controlMarkState=controlMarkState, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRackNo=moduleRackNo, elementLongitude=elementLongitude, element=element, moduleSWUpdateEntry=moduleSWUpdateEntry, regIndex=regIndex, productKeyStatus=productKeyStatus, moduleId=moduleId, productKeyFeatureName=productKeyFeatureName, moduleMacAddress=moduleMacAddress, moduleSlotNo=moduleSlotNo, statusLidStatus=statusLidStatus, moduleEntry=moduleEntry, statusLmt=statusLmt, receiverEntryId=receiverEntryId, moduleRepairLogEntry=moduleRepairLogEntry)
