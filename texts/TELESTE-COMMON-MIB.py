...
ObjectIdentity, Counter32, ModuleIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Gauge32, Bits, TimeTicks, Integer32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Gauge32", "Bits", "TimeTicks", "Integer32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementTotalUpTime=elementTotalUpTime, regName=regName, receiverCommunity=receiverCommunity, moduleBusAddress=moduleBusAddress, elementProductKey=elementProductKey, controlTrapInterval=controlTrapInterval, moduleDetailEntry=moduleDetailEntry, repairReasonCode=repairReasonCode, statusInternalTemperature=statusInternalTemperature, controlMarkState=controlMarkState, controlResetElement=controlResetElement, statusTemperature=statusTemperature, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementLongitude=elementLongitude, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppVersion=moduleAppVersion, controlAlarmOnDelay=controlAlarmOnDelay, controlTrapLifeTime=controlTrapLifeTime, moduleEntry=moduleEntry, moduleStatusTable=moduleStatusTable, productKeyEntry=productKeyEntry, controlLocalAccess=controlLocalAccess, statusLidStatus=statusLidStatus, moduleStatusEntry=moduleStatusEntry, elementStructure=elementStructure, statusLmt=statusLmt, moduleSlotNo=moduleSlotNo, moduleRegistryEntry=moduleRegistryEntry, moduleStatus=moduleStatus, productKeyTable=productKeyTable, elementResetCount=elementResetCount, controlInternalAppAccess=controlInternalAppAccess, statusHardware=statusHardware, controlTempLimitHi=controlTempLimitHi, moduleHwSerialNumber=moduleHwSerialNumber, moduleSizeOfTable=moduleSizeOfTable, productKeyMask=productKeyMask, regIndex=regIndex, statusSoftware=statusSoftware, moduleRegistryTable=moduleRegistryTable, repairDate=repairDate, moduleDetailTable=moduleDetailTable, productKeyNumberOfKeys=productKeyNumberOfKeys, statusRestartCounter=statusRestartCounter, statusBusMaster=statusBusMaster, controlTempDeadBand=controlTempDeadBand, moduleNotebookTable=moduleNotebookTable, moduleSWUpdateTable=moduleSWUpdateTable, sizeOfNotebook=sizeOfNotebook, moduleSizeOfEntry=moduleSizeOfEntry, moduleBiosVersion=moduleBiosVersion, moduleControlTable=moduleControlTable, elementConfigChangeCode=elementConfigChangeCode, receiverEntryId=receiverEntryId, sWUpdateControl=sWUpdateControl, statusLid=statusLid, elementName=elementName, productKeyValue=productKeyValue, moduleRegistry=moduleRegistry, moduleBiosDate=moduleBiosDate, statusRunningSwImage=statusRunningSwImage, moduleRackNo=moduleRackNo, sizeOfRegistry=sizeOfRegistry, statusFan=statusFan, repairComment=repairComment, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitLoLo=controlTempLimitLoLo, elementStatus=elementStatus, moduleName=moduleName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusSettings=statusSettings, notebookLineText=notebookLineText, sWUpdateFileName=sWUpdateFileName, moduleId=moduleId, elementInformation=elementInformation, moduleHwType=moduleHwType, controlTempLimitLo=controlTempLimitLo, swUpdateURL=swUpdateURL, moduleRepairLogTable=moduleRepairLogTable, productKeyCipher=productKeyCipher, module=module, moduleControlEntry=moduleControlEntry, controlAlarmOffDelay=controlAlarmOffDelay, moduleTable=moduleTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, repairNameCode=repairNameCode, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureEntry=productKeyFeatureEntry, moduleInformation=moduleInformation, sizeOfRepairlog=sizeOfRepairlog, moduleControl=moduleControl, moduleAppDate=moduleAppDate, moduleHwVersion=moduleHwVersion, productKeyStatus=productKeyStatus, moduleNotebookEntry=moduleNotebookEntry, controlReset=controlReset, receiverPort=receiverPort, receiverAddress=receiverAddress, controlLedUsage=controlLedUsage, controlBusMasterAdminState=controlBusMasterAdminState, regValue=regValue, productKeyFeatureIndex=productKeyFeatureIndex, moduleMacAddress=moduleMacAddress, statusGeneral=statusGeneral, statusResetCause=statusResetCause, controlAlarmDetection=controlAlarmDetection, repairIndex=repairIndex, element=element, controlTrapDelay=controlTrapDelay, productKeyIndex=productKeyIndex, sWUpdateStatus=sWUpdateStatus, notebookLineNumber=notebookLineNumber, elementLatitude=elementLatitude, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapSending=controlTrapSending, elementAltitude=elementAltitude, elementControl=elementControl, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureName=productKeyFeatureName, moduleRepairLogEntry=moduleRepairLogEntry)
