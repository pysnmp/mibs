...
ModuleIdentity, Gauge32, iso, Integer32, Unsigned32, Counter64, Counter32, NotificationType, TimeTicks, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "iso", "Integer32", "Unsigned32", "Counter64", "Counter32", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementResetCount=elementResetCount, controlTempLimitHi=controlTempLimitHi, elementName=elementName, regIndex=regIndex, repairComment=repairComment, moduleSWUpdateTable=moduleSWUpdateTable, repairNameCode=repairNameCode, controlTrapLifeTime=controlTrapLifeTime, receiverEntryId=receiverEntryId, statusGeneral=statusGeneral, moduleBiosVersion=moduleBiosVersion, element=element, moduleEntry=moduleEntry, moduleTable=moduleTable, moduleDetailEntry=moduleDetailEntry, sizeOfRegistry=sizeOfRegistry, productKeyFeatureIndex=productKeyFeatureIndex, statusFan=statusFan, moduleBiosDate=moduleBiosDate, sizeOfRepairlog=sizeOfRepairlog, regValue=regValue, controlBusMasterAdminState=controlBusMasterAdminState, controlTrapReceiverTable=controlTrapReceiverTable, moduleControl=moduleControl, moduleSizeOfTable=moduleSizeOfTable, productKeyStatus=productKeyStatus, sWUpdateControl=sWUpdateControl, moduleNotebookEntry=moduleNotebookEntry, statusHardware=statusHardware, controlResetElement=controlResetElement, statusResetCause=statusResetCause, moduleRegistryEntry=moduleRegistryEntry, controlTempDeadBand=controlTempDeadBand, statusLidStatus=statusLidStatus, productKeyMask=productKeyMask, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyCipher=productKeyCipher, regName=regName, moduleNotebookTable=moduleNotebookTable, statusRunningSwImage=statusRunningSwImage, swUpdateURL=swUpdateURL, moduleAppDate=moduleAppDate, moduleId=moduleId, productKeyNumberOfKeys=productKeyNumberOfKeys, controlInternalAppAccess=controlInternalAppAccess, elementAltitude=elementAltitude, productKeyFeatureEntry=productKeyFeatureEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyValue=productKeyValue, receiverAddress=receiverAddress, module=module, controlLedUsage=controlLedUsage, statusLmt=statusLmt, productKeyEntry=productKeyEntry, moduleDetailTable=moduleDetailTable, statusRestartCounter=statusRestartCounter, moduleStatusTable=moduleStatusTable, moduleInformation=moduleInformation, notebookLineNumber=notebookLineNumber, controlTrapInterval=controlTrapInterval, elementStatus=elementStatus, productKeyTable=productKeyTable, moduleSlotNo=moduleSlotNo, sWUpdateFileName=sWUpdateFileName, elementProductKey=elementProductKey, elementInformation=elementInformation, moduleControlTable=moduleControlTable, controlLocalAccess=controlLocalAccess, repairReasonCode=repairReasonCode, elementLongitude=elementLongitude, moduleStatus=moduleStatus, statusBusMaster=statusBusMaster, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleRegistry=moduleRegistry, moduleHwVersion=moduleHwVersion, statusTemperature=statusTemperature, moduleRegistryTable=moduleRegistryTable, receiverCommunity=receiverCommunity, productKeyFeatureName=productKeyFeatureName, statusInternalTemperature=statusInternalTemperature, statusSettings=statusSettings, statusSoftware=statusSoftware, repairIndex=repairIndex, productKeyFeatureTable=productKeyFeatureTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairDate=repairDate, controlTempLimitLoLo=controlTempLimitLoLo, elementControl=elementControl, elementTotalUpTime=elementTotalUpTime, controlTempLimitHiHi=controlTempLimitHiHi, moduleControlEntry=moduleControlEntry, moduleStatusEntry=moduleStatusEntry, notebookLineText=notebookLineText, receiverPort=receiverPort, controlMarkState=controlMarkState, moduleMacAddress=moduleMacAddress, sWUpdateStatus=sWUpdateStatus, elementConfigChangeCode=elementConfigChangeCode, controlReset=controlReset, controlTrapDelay=controlTrapDelay, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmDetection=controlAlarmDetection, controlTrapSending=controlTrapSending, moduleHwType=moduleHwType, moduleHwSerialNumber=moduleHwSerialNumber, moduleRepairLogEntry=moduleRepairLogEntry, controlAlarmOffDelay=controlAlarmOffDelay, elementStructure=elementStructure, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureEnable=productKeyFeatureEnable, moduleSizeOfEntry=moduleSizeOfEntry, moduleRepairLogTable=moduleRepairLogTable, moduleRackNo=moduleRackNo, statusLid=statusLid, moduleBusAddress=moduleBusAddress, moduleName=moduleName, sizeOfNotebook=sizeOfNotebook, controlTempLimitLo=controlTempLimitLo, moduleAppVersion=moduleAppVersion, productKeyIndex=productKeyIndex, elementLatitude=elementLatitude)
