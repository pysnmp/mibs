...
TimeTicks, NotificationType, MibIdentifier, Bits, Counter64, Unsigned32, Counter32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "MibIdentifier", "Bits", "Counter64", "Unsigned32", "Counter32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlAlarmOffDelay=controlAlarmOffDelay, productKeyEntry=productKeyEntry, controlAlarmDetection=controlAlarmDetection, moduleRepairLogTable=moduleRepairLogTable, statusResetCause=statusResetCause, moduleInformation=moduleInformation, controlLedUsage=controlLedUsage, sizeOfRegistry=sizeOfRegistry, moduleStatusTable=moduleStatusTable, productKeyFeatureName=productKeyFeatureName, elementTotalUpTime=elementTotalUpTime, controlLocalAccess=controlLocalAccess, elementResetCount=elementResetCount, moduleSWUpdateTable=moduleSWUpdateTable, swUpdateURL=swUpdateURL, repairNameCode=repairNameCode, statusSoftware=statusSoftware, controlBusMasterAdminState=controlBusMasterAdminState, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sizeOfNotebook=sizeOfNotebook, receiverAddress=receiverAddress, elementStatus=elementStatus, element=element, controlInternalAppAccess=controlInternalAppAccess, controlMarkState=controlMarkState, controlTempLimitLoLo=controlTempLimitLoLo, repairIndex=repairIndex, statusSettings=statusSettings, moduleRegistryTable=moduleRegistryTable, statusBusMaster=statusBusMaster, moduleNotebookTable=moduleNotebookTable, elementProductKey=elementProductKey, repairReasonCode=repairReasonCode, moduleRepairLogEntry=moduleRepairLogEntry, elementInformation=elementInformation, moduleControl=moduleControl, productKeyMask=productKeyMask, regName=regName, statusGeneral=statusGeneral, moduleRegistry=moduleRegistry, productKeyTable=productKeyTable, receiverPort=receiverPort, controlTempDeadBand=controlTempDeadBand, controlTrapReceiverEntry=controlTrapReceiverEntry, sizeOfRepairlog=sizeOfRepairlog, statusLid=statusLid, controlAlarmOnDelay=controlAlarmOnDelay, moduleSlotNo=moduleSlotNo, module=module, productKeyFeatureEntry=productKeyFeatureEntry, moduleDetailTable=moduleDetailTable, controlTempLimitLo=controlTempLimitLo, statusRunningSwImage=statusRunningSwImage, statusHardware=statusHardware, notebookLineNumber=notebookLineNumber, statusLmt=statusLmt, controlTrapDelay=controlTrapDelay, controlReset=controlReset, moduleSizeOfEntry=moduleSizeOfEntry, receiverCommunity=receiverCommunity, moduleName=moduleName, elementControl=elementControl, elementName=elementName, moduleHwVersion=moduleHwVersion, controlTempLimitHi=controlTempLimitHi, elementStructure=elementStructure, repairComment=repairComment, moduleTable=moduleTable, moduleSizeOfTable=moduleSizeOfTable, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapInterval=controlTrapInterval, controlTrapReceiverTable=controlTrapReceiverTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sWUpdateControl=sWUpdateControl, statusInternalTemperature=statusInternalTemperature, receiverEntryId=receiverEntryId, moduleRackNo=moduleRackNo, productKeyStatus=productKeyStatus, moduleNotebookEntry=moduleNotebookEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementAltitude=elementAltitude, statusLidStatus=statusLidStatus, moduleControlTable=moduleControlTable, productKeyIndex=productKeyIndex, moduleDetailEntry=moduleDetailEntry, repairDate=repairDate, sWUpdateStatus=sWUpdateStatus, statusRestartCounter=statusRestartCounter, controlResetElement=controlResetElement, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateEntry=moduleSWUpdateEntry, elementLongitude=elementLongitude, moduleStatus=moduleStatus, moduleMacAddress=moduleMacAddress, elementLatitude=elementLatitude, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleBiosVersion=moduleBiosVersion, productKeyCipher=productKeyCipher, controlTrapLifeTime=controlTrapLifeTime, moduleControlEntry=moduleControlEntry, moduleBiosDate=moduleBiosDate, moduleHwSerialNumber=moduleHwSerialNumber, statusFan=statusFan, moduleAppVersion=moduleAppVersion, moduleEntry=moduleEntry, regIndex=regIndex, elementConfigChangeCode=elementConfigChangeCode, moduleRegistryEntry=moduleRegistryEntry, moduleHwType=moduleHwType, moduleBusAddress=moduleBusAddress, controlTrapSending=controlTrapSending, moduleId=moduleId, notebookLineText=notebookLineText, regValue=regValue, productKeyFeatureIndex=productKeyFeatureIndex, productKeyValue=productKeyValue, moduleStatusEntry=moduleStatusEntry, statusTemperature=statusTemperature, moduleAppDate=moduleAppDate, sWUpdateFileName=sWUpdateFileName)
