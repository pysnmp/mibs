...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLongitude=elementLongitude, controlTrapSending=controlTrapSending, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSoftware=statusSoftware, moduleRegistryEntry=moduleRegistryEntry, moduleAppDate=moduleAppDate, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSizeOfTable=moduleSizeOfTable, controlMarkState=controlMarkState, repairReasonCode=repairReasonCode, moduleHwType=moduleHwType, regValue=regValue, receiverPort=receiverPort, moduleRegistryTable=moduleRegistryTable, productKeyFeatureEnable=productKeyFeatureEnable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleSlotNo=moduleSlotNo, statusLidStatus=statusLidStatus, moduleStatusEntry=moduleStatusEntry, controlAlarmDetection=controlAlarmDetection, productKeyIndex=productKeyIndex, repairNameCode=repairNameCode, elementLatitude=elementLatitude, controlBusMasterAdminState=controlBusMasterAdminState, regName=regName, controlTrapLifeTime=controlTrapLifeTime, moduleControl=moduleControl, swUpdateURL=swUpdateURL, elementStructure=elementStructure, moduleBusAddress=moduleBusAddress, productKeyFeatureEntry=productKeyFeatureEntry, statusBusMaster=statusBusMaster, statusTemperature=statusTemperature, moduleMacAddress=moduleMacAddress, notebookLineNumber=notebookLineNumber, statusSettings=statusSettings, statusInternalTemperature=statusInternalTemperature, repairIndex=repairIndex, controlTempLimitLo=controlTempLimitLo, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureName=productKeyFeatureName, controlTrapDelay=controlTrapDelay, controlAlarmOnDelay=controlAlarmOnDelay, controlTempLimitHi=controlTempLimitHi, statusRestartCounter=statusRestartCounter, moduleNotebookTable=moduleNotebookTable, moduleDetailEntry=moduleDetailEntry, elementProductKey=elementProductKey, elementStatus=elementStatus, statusResetCause=statusResetCause, moduleNotebookEntry=moduleNotebookEntry, elementAltitude=elementAltitude, moduleName=moduleName, productKeyMask=productKeyMask, moduleAppVersion=moduleAppVersion, moduleHwSerialNumber=moduleHwSerialNumber, controlLocalAccess=controlLocalAccess, productKeyValue=productKeyValue, moduleSWUpdateTable=moduleSWUpdateTable, moduleHwVersion=moduleHwVersion, elementResetCount=elementResetCount, moduleBiosDate=moduleBiosDate, productKeyFeatureTable=productKeyFeatureTable, controlInternalAppAccess=controlInternalAppAccess, sizeOfNotebook=sizeOfNotebook, elementInformation=elementInformation, sizeOfRepairlog=sizeOfRepairlog, controlReset=controlReset, sizeOfRegistry=sizeOfRegistry, moduleSizeOfEntry=moduleSizeOfEntry, module=module, productKeyCipher=productKeyCipher, controlAlarmOffDelay=controlAlarmOffDelay, productKeyTable=productKeyTable, moduleDetailTable=moduleDetailTable, elementConfigChangeCode=elementConfigChangeCode, moduleId=moduleId, moduleTable=moduleTable, receiverEntryId=receiverEntryId, moduleStatus=moduleStatus, statusLid=statusLid, controlTempLimitHiHi=controlTempLimitHiHi, moduleEntry=moduleEntry, productKeyStatus=productKeyStatus, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyEntry=productKeyEntry, repairComment=repairComment, receiverCommunity=receiverCommunity, statusLmt=statusLmt, regIndex=regIndex, repairDate=repairDate, elementControl=elementControl, moduleControlEntry=moduleControlEntry, controlTrapReceiverTable=controlTrapReceiverTable, controlLedUsage=controlLedUsage, elementTotalUpTime=elementTotalUpTime, controlResetElement=controlResetElement, elementName=elementName, controlTrapInterval=controlTrapInterval, moduleRepairLogEntry=moduleRepairLogEntry, receiverAddress=receiverAddress, statusHardware=statusHardware, notebookLineText=notebookLineText, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRegistry=moduleRegistry, moduleStatusTable=moduleStatusTable, moduleInformation=moduleInformation, moduleRackNo=moduleRackNo, statusFan=statusFan, moduleBiosVersion=moduleBiosVersion, sWUpdateControl=sWUpdateControl, statusGeneral=statusGeneral, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureIndex=productKeyFeatureIndex, moduleRepairLogTable=moduleRepairLogTable, sWUpdateStatus=sWUpdateStatus, statusRunningSwImage=statusRunningSwImage, element=element, moduleControlTable=moduleControlTable, controlTempDeadBand=controlTempDeadBand)
