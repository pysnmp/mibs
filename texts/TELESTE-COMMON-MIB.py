...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Gauge32, iso, IpAddress, NotificationType, Unsigned32, Integer32, MibIdentifier, ModuleIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Gauge32", "iso", "IpAddress", "NotificationType", "Unsigned32", "Integer32", "MibIdentifier", "ModuleIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleStatusTable=moduleStatusTable, moduleRepairLogEntry=moduleRepairLogEntry, moduleDetailTable=moduleDetailTable, sizeOfRegistry=sizeOfRegistry, statusTemperature=statusTemperature, elementTotalUpTime=elementTotalUpTime, moduleHwType=moduleHwType, controlTempLimitLo=controlTempLimitLo, swUpdateURL=swUpdateURL, repairIndex=repairIndex, moduleDetailEntry=moduleDetailEntry, notebookLineNumber=notebookLineNumber, elementAltitude=elementAltitude, statusResetCause=statusResetCause, moduleRegistryTable=moduleRegistryTable, regName=regName, statusLmt=statusLmt, moduleAppDate=moduleAppDate, moduleStatus=moduleStatus, elementLongitude=elementLongitude, moduleAppVersion=moduleAppVersion, moduleHwVersion=moduleHwVersion, controlTrapLifeTime=controlTrapLifeTime, controlTrapReceiverTable=controlTrapReceiverTable, elementProductKey=elementProductKey, moduleControlEntry=moduleControlEntry, elementName=elementName, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateTable=moduleSWUpdateTable, moduleNotebookEntry=moduleNotebookEntry, elementControl=elementControl, statusFan=statusFan, moduleControl=moduleControl, moduleName=moduleName, elementInformation=elementInformation, productKeyEntry=productKeyEntry, statusBusMaster=statusBusMaster, moduleControlTable=moduleControlTable, statusGeneral=statusGeneral, controlAlarmOnDelay=controlAlarmOnDelay, sWUpdateControl=sWUpdateControl, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementResetCount=elementResetCount, receiverCommunity=receiverCommunity, productKeyStatus=productKeyStatus, moduleSizeOfTable=moduleSizeOfTable, controlTempDeadBand=controlTempDeadBand, moduleSlotNo=moduleSlotNo, repairNameCode=repairNameCode, repairDate=repairDate, sWUpdateStatus=sWUpdateStatus, moduleInformation=moduleInformation, receiverAddress=receiverAddress, sizeOfNotebook=sizeOfNotebook, productKeyMask=productKeyMask, sWUpdateFileName=sWUpdateFileName, module=module, controlTrapInterval=controlTrapInterval, moduleSWUpdateEntry=moduleSWUpdateEntry, controlAlarmDetection=controlAlarmDetection, moduleTable=moduleTable, controlTrapReceiverEntry=controlTrapReceiverEntry, receiverPort=receiverPort, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, productKeyValue=productKeyValue, productKeyFeatureTable=productKeyFeatureTable, controlTrapDelay=controlTrapDelay, controlAlarmOffDelay=controlAlarmOffDelay, moduleSizeOfEntry=moduleSizeOfEntry, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEnable=productKeyFeatureEnable, statusLidStatus=statusLidStatus, regValue=regValue, statusLid=statusLid, moduleRackNo=moduleRackNo, controlInternalAppAccess=controlInternalAppAccess, moduleRegistryEntry=moduleRegistryEntry, statusRestartCounter=statusRestartCounter, controlTempLimitHiHi=controlTempLimitHiHi, repairComment=repairComment, productKeyTable=productKeyTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairReasonCode=repairReasonCode, moduleBiosDate=moduleBiosDate, moduleBiosVersion=moduleBiosVersion, moduleStatusEntry=moduleStatusEntry, moduleMacAddress=moduleMacAddress, productKeyFeatureIndex=productKeyFeatureIndex, controlMarkState=controlMarkState, element=element, moduleBusAddress=moduleBusAddress, statusInternalTemperature=statusInternalTemperature, moduleEntry=moduleEntry, controlReset=controlReset, receiverEntryId=receiverEntryId, controlTempLimitHi=controlTempLimitHi, controlLedUsage=controlLedUsage, controlTempLimitLoLo=controlTempLimitLoLo, controlLocalAccess=controlLocalAccess, productKeyFeatureName=productKeyFeatureName, moduleRepairLogTable=moduleRepairLogTable, moduleRegistry=moduleRegistry, elementStatus=elementStatus, controlTrapSending=controlTrapSending, statusSoftware=statusSoftware, statusRunningSwImage=statusRunningSwImage, notebookLineText=notebookLineText, productKeyCipher=productKeyCipher, productKeyFeatureEntry=productKeyFeatureEntry, moduleHwSerialNumber=moduleHwSerialNumber, controlBusMasterAdminState=controlBusMasterAdminState, productKeyIndex=productKeyIndex, moduleNotebookTable=moduleNotebookTable, moduleId=moduleId, controlResetElement=controlResetElement, elementLatitude=elementLatitude, statusHardware=statusHardware, elementConfigChangeCode=elementConfigChangeCode, statusSettings=statusSettings, elementStructure=elementStructure, regIndex=regIndex)
