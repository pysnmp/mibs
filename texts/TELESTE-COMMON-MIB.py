...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, iso, Unsigned32, Bits, Counter64, ObjectIdentity, MibIdentifier, Integer32, NotificationType, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "iso", "Unsigned32", "Bits", "Counter64", "ObjectIdentity", "MibIdentifier", "Integer32", "NotificationType", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyNumberOfKeys=productKeyNumberOfKeys, controlAlarmDetection=controlAlarmDetection, moduleSWUpdateTable=moduleSWUpdateTable, statusGeneral=statusGeneral, controlTempDeadBand=controlTempDeadBand, controlMarkState=controlMarkState, statusResetCause=statusResetCause, moduleDetailEntry=moduleDetailEntry, moduleRackNo=moduleRackNo, moduleRegistry=moduleRegistry, controlTrapReceiverTable=controlTrapReceiverTable, moduleName=moduleName, elementStructure=elementStructure, repairDate=repairDate, statusRestartCounter=statusRestartCounter, elementProductKey=elementProductKey, productKeyCipher=productKeyCipher, moduleInformation=moduleInformation, controlTrapLifeTime=controlTrapLifeTime, moduleStatus=moduleStatus, regValue=regValue, repairReasonCode=repairReasonCode, repairNameCode=repairNameCode, controlLocalAccess=controlLocalAccess, receiverCommunity=receiverCommunity, statusTemperature=statusTemperature, moduleStatusTable=moduleStatusTable, moduleStatusEntry=moduleStatusEntry, statusLmt=statusLmt, statusLidStatus=statusLidStatus, productKeyMask=productKeyMask, elementStatus=elementStatus, moduleSizeOfEntry=moduleSizeOfEntry, element=element, elementAltitude=elementAltitude, module=module, controlTempLimitHi=controlTempLimitHi, moduleNotebookTable=moduleNotebookTable, productKeyFeatureEntry=productKeyFeatureEntry, statusSoftware=statusSoftware, moduleId=moduleId, elementLongitude=elementLongitude, moduleControlEntry=moduleControlEntry, controlLedUsage=controlLedUsage, moduleControlTable=moduleControlTable, productKeyEntry=productKeyEntry, moduleRegistryTable=moduleRegistryTable, statusLid=statusLid, moduleDetailTable=moduleDetailTable, statusRunningSwImage=statusRunningSwImage, receiverAddress=receiverAddress, controlTrapSending=controlTrapSending, moduleRepairLogTable=moduleRepairLogTable, receiverPort=receiverPort, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapDelay=controlTrapDelay, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusHardware=statusHardware, moduleBusAddress=moduleBusAddress, productKeyTable=productKeyTable, moduleRegistryEntry=moduleRegistryEntry, statusInternalTemperature=statusInternalTemperature, regIndex=regIndex, receiverEntryId=receiverEntryId, sizeOfRepairlog=sizeOfRepairlog, elementLatitude=elementLatitude, sizeOfNotebook=sizeOfNotebook, productKeyIndex=productKeyIndex, productKeyFeatureIndex=productKeyFeatureIndex, productKeyFeatureName=productKeyFeatureName, moduleRepairLogEntry=moduleRepairLogEntry, notebookLineNumber=notebookLineNumber, controlAlarmOffDelay=controlAlarmOffDelay, moduleAppDate=moduleAppDate, moduleControl=moduleControl, controlResetElement=controlResetElement, controlTempLimitLo=controlTempLimitLo, sWUpdateStatus=sWUpdateStatus, sizeOfRegistry=sizeOfRegistry, productKeyStatus=productKeyStatus, productKeyValue=productKeyValue, controlTrapInterval=controlTrapInterval, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppVersion=moduleAppVersion, sWUpdateControl=sWUpdateControl, moduleSlotNo=moduleSlotNo, productKeyFeatureTable=productKeyFeatureTable, moduleTable=moduleTable, moduleMacAddress=moduleMacAddress, controlTrapReceiverEntry=controlTrapReceiverEntry, controlAlarmOnDelay=controlAlarmOnDelay, statusSettings=statusSettings, repairComment=repairComment, moduleHwSerialNumber=moduleHwSerialNumber, moduleNotebookEntry=moduleNotebookEntry, moduleHwType=moduleHwType, statusFan=statusFan, notebookLineText=notebookLineText, regName=regName, elementControl=elementControl, moduleBiosVersion=moduleBiosVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTempLimitLoLo=controlTempLimitLoLo, moduleSizeOfTable=moduleSizeOfTable, repairIndex=repairIndex, moduleHwVersion=moduleHwVersion, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementConfigChangeCode=elementConfigChangeCode, statusBusMaster=statusBusMaster, controlInternalAppAccess=controlInternalAppAccess, elementTotalUpTime=elementTotalUpTime, controlBusMasterAdminState=controlBusMasterAdminState, controlTempLimitHiHi=controlTempLimitHiHi, controlReset=controlReset, elementInformation=elementInformation, swUpdateURL=swUpdateURL, elementResetCount=elementResetCount, moduleBiosDate=moduleBiosDate, elementName=elementName, moduleEntry=moduleEntry, sWUpdateFileName=sWUpdateFileName)
