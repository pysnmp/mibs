...
Bits, TimeTicks, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, NotificationType, MibIdentifier, Unsigned32, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTempDeadBand=controlTempDeadBand, receiverPort=receiverPort, moduleEntry=moduleEntry, productKeyCipher=productKeyCipher, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sizeOfRepairlog=sizeOfRepairlog, moduleRackNo=moduleRackNo, repairNameCode=repairNameCode, statusLidStatus=statusLidStatus, repairDate=repairDate, statusHardware=statusHardware, controlAlarmOffDelay=controlAlarmOffDelay, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitHi=controlTempLimitHi, sWUpdateStatus=sWUpdateStatus, elementConfigChangeCode=elementConfigChangeCode, moduleSWUpdateTable=moduleSWUpdateTable, moduleInformation=moduleInformation, controlTempLimitLoLo=controlTempLimitLoLo, controlTrapSending=controlTrapSending, repairIndex=repairIndex, moduleControlTable=moduleControlTable, moduleHwType=moduleHwType, productKeyNumberOfFeatures=productKeyNumberOfFeatures, notebookLineText=notebookLineText, controlBusMasterAdminState=controlBusMasterAdminState, statusSettings=statusSettings, controlLedUsage=controlLedUsage, controlTrapDelay=controlTrapDelay, elementTotalUpTime=elementTotalUpTime, controlReset=controlReset, repairComment=repairComment, elementControl=elementControl, productKeyMask=productKeyMask, statusRunningSwImage=statusRunningSwImage, controlLocalAccess=controlLocalAccess, moduleRepairLogEntry=moduleRepairLogEntry, productKeyIndex=productKeyIndex, regValue=regValue, statusRestartCounter=statusRestartCounter, moduleNotebookEntry=moduleNotebookEntry, moduleAppDate=moduleAppDate, statusTemperature=statusTemperature, productKeyFeatureName=productKeyFeatureName, sWUpdateControl=sWUpdateControl, controlAlarmDetection=controlAlarmDetection, moduleSizeOfEntry=moduleSizeOfEntry, moduleNotebookTable=moduleNotebookTable, notebookLineNumber=notebookLineNumber, controlResetElement=controlResetElement, productKeyFeatureEnable=productKeyFeatureEnable, sizeOfRegistry=sizeOfRegistry, moduleDetailTable=moduleDetailTable, moduleRegistry=moduleRegistry, moduleControlEntry=moduleControlEntry, receiverEntryId=receiverEntryId, productKeyFeatureTable=productKeyFeatureTable, sWUpdateFileName=sWUpdateFileName, statusLid=statusLid, swUpdateURL=swUpdateURL, controlMarkState=controlMarkState, regName=regName, moduleMacAddress=moduleMacAddress, moduleStatusEntry=moduleStatusEntry, moduleRepairLogTable=moduleRepairLogTable, moduleTable=moduleTable, controlTempLimitLo=controlTempLimitLo, statusSoftware=statusSoftware, moduleId=moduleId, elementStructure=elementStructure, controlTrapInterval=controlTrapInterval, elementName=elementName, controlTrapReceiverTable=controlTrapReceiverTable, moduleName=moduleName, regIndex=regIndex, productKeyFeatureEntry=productKeyFeatureEntry, moduleBusAddress=moduleBusAddress, elementStatus=elementStatus, moduleRegistryTable=moduleRegistryTable, elementResetCount=elementResetCount, elementLongitude=elementLongitude, controlAlarmOnDelay=controlAlarmOnDelay, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleHwVersion=moduleHwVersion, moduleStatusTable=moduleStatusTable, productKeyFeatureIndex=productKeyFeatureIndex, moduleDetailEntry=moduleDetailEntry, repairReasonCode=repairReasonCode, statusResetCause=statusResetCause, moduleSizeOfTable=moduleSizeOfTable, statusLmt=statusLmt, moduleSlotNo=moduleSlotNo, elementProductKey=elementProductKey, productKeyNumberOfKeys=productKeyNumberOfKeys, element=element, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverAddress=receiverAddress, module=module, statusFan=statusFan, elementInformation=elementInformation, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, moduleHwSerialNumber=moduleHwSerialNumber, receiverCommunity=receiverCommunity, statusInternalTemperature=statusInternalTemperature, moduleAppVersion=moduleAppVersion, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleStatus=moduleStatus, moduleRegistryEntry=moduleRegistryEntry, elementLatitude=elementLatitude, controlTempLimitHiHi=controlTempLimitHiHi, controlInternalAppAccess=controlInternalAppAccess, productKeyEntry=productKeyEntry, productKeyTable=productKeyTable, sizeOfNotebook=sizeOfNotebook, elementAltitude=elementAltitude, statusGeneral=statusGeneral, statusBusMaster=statusBusMaster, productKeyValue=productKeyValue, moduleControl=moduleControl, moduleBiosDate=moduleBiosDate)
