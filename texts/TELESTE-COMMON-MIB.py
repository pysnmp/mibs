...
MibIdentifier, iso, Counter64, NotificationType, ModuleIdentity, Counter32, IpAddress, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlBusMasterAdminState=controlBusMasterAdminState, moduleAppDate=moduleAppDate, elementProductKey=elementProductKey, moduleControlEntry=moduleControlEntry, controlResetElement=controlResetElement, productKeyCipher=productKeyCipher, elementResetCount=elementResetCount, statusBusMaster=statusBusMaster, controlTempLimitLo=controlTempLimitLo, elementLatitude=elementLatitude, sWUpdateControl=sWUpdateControl, elementConfigChangeCode=elementConfigChangeCode, controlTempLimitHi=controlTempLimitHi, productKeyEntry=productKeyEntry, moduleBiosDate=moduleBiosDate, moduleSlotNo=moduleSlotNo, controlTrapDelay=controlTrapDelay, controlTempDeadBand=controlTempDeadBand, moduleSWUpdateEntry=moduleSWUpdateEntry, sizeOfRepairlog=sizeOfRepairlog, sWUpdateStatus=sWUpdateStatus, controlTrapLifeTime=controlTrapLifeTime, controlLocalAccess=controlLocalAccess, moduleRegistryTable=moduleRegistryTable, productKeyFeatureEnable=productKeyFeatureEnable, moduleSizeOfTable=moduleSizeOfTable, controlTrapReceiverTable=controlTrapReceiverTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSizeOfEntry=moduleSizeOfEntry, moduleHwType=moduleHwType, statusFan=statusFan, elementControl=elementControl, notebookLineNumber=notebookLineNumber, regName=regName, moduleRackNo=moduleRackNo, controlAlarmDetection=controlAlarmDetection, elementStructure=elementStructure, repairIndex=repairIndex, productKeyValue=productKeyValue, moduleDetailEntry=moduleDetailEntry, repairReasonCode=repairReasonCode, repairComment=repairComment, module=module, moduleBusAddress=moduleBusAddress, moduleRepairLogTable=moduleRepairLogTable, elementTotalUpTime=elementTotalUpTime, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureName=productKeyFeatureName, moduleTable=moduleTable, repairNameCode=repairNameCode, statusLid=statusLid, elementAltitude=elementAltitude, moduleControlTable=moduleControlTable, moduleRegistry=moduleRegistry, statusInternalTemperature=statusInternalTemperature, controlLedUsage=controlLedUsage, controlTrapInterval=controlTrapInterval, sizeOfRegistry=sizeOfRegistry, receiverAddress=receiverAddress, productKeyFeatureEntry=productKeyFeatureEntry, moduleNotebookEntry=moduleNotebookEntry, moduleEntry=moduleEntry, swUpdateURL=swUpdateURL, notebookLineText=notebookLineText, elementLongitude=elementLongitude, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateFileName=sWUpdateFileName, statusSettings=statusSettings, element=element, sizeOfNotebook=sizeOfNotebook, statusSoftware=statusSoftware, controlInternalAppAccess=controlInternalAppAccess, productKeyMask=productKeyMask, statusLidStatus=statusLidStatus, controlTempLimitHiHi=controlTempLimitHiHi, statusRestartCounter=statusRestartCounter, controlAlarmOffDelay=controlAlarmOffDelay, controlMarkState=controlMarkState, moduleSWUpdateTable=moduleSWUpdateTable, receiverCommunity=receiverCommunity, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleName=moduleName, statusHardware=statusHardware, statusRunningSwImage=statusRunningSwImage, statusTemperature=statusTemperature, moduleStatus=moduleStatus, moduleRegistryEntry=moduleRegistryEntry, statusGeneral=statusGeneral, elementName=elementName, elementInformation=elementInformation, moduleStatusEntry=moduleStatusEntry, productKeyStatus=productKeyStatus, elementStatus=elementStatus, moduleId=moduleId, controlTrapSending=controlTrapSending, controlReset=controlReset, receiverPort=receiverPort, repairDate=repairDate, productKeyIndex=productKeyIndex, regValue=regValue, moduleBiosVersion=moduleBiosVersion, regIndex=regIndex, moduleMacAddress=moduleMacAddress, moduleControl=moduleControl, controlTempLimitLoLo=controlTempLimitLoLo, moduleAppVersion=moduleAppVersion, moduleHwSerialNumber=moduleHwSerialNumber, moduleHwVersion=moduleHwVersion, receiverEntryId=receiverEntryId, moduleNotebookTable=moduleNotebookTable, statusResetCause=statusResetCause, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleRepairLogEntry=moduleRepairLogEntry, moduleInformation=moduleInformation, moduleDetailTable=moduleDetailTable, statusLmt=statusLmt, moduleStatusTable=moduleStatusTable, productKeyTable=productKeyTable)
