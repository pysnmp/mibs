...
TimeTicks, MibIdentifier, Gauge32, ObjectIdentity, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Counter64, iso, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Gauge32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Counter64", "iso", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sizeOfRepairlog=sizeOfRepairlog, productKeyValue=productKeyValue, receiverEntryId=receiverEntryId, controlTempLimitLo=controlTempLimitLo, controlAlarmOffDelay=controlAlarmOffDelay, elementControl=elementControl, statusRunningSwImage=statusRunningSwImage, moduleNotebookTable=moduleNotebookTable, moduleRegistryTable=moduleRegistryTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleStatusTable=moduleStatusTable, moduleSizeOfTable=moduleSizeOfTable, statusLidStatus=statusLidStatus, statusResetCause=statusResetCause, moduleDetailTable=moduleDetailTable, elementStatus=elementStatus, productKeyFeatureName=productKeyFeatureName, moduleBiosDate=moduleBiosDate, controlAlarmDetection=controlAlarmDetection, elementResetCount=elementResetCount, moduleRegistry=moduleRegistry, moduleRegistryEntry=moduleRegistryEntry, controlTempLimitHiHi=controlTempLimitHiHi, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverCommunity=receiverCommunity, elementProductKey=elementProductKey, statusLid=statusLid, elementInformation=elementInformation, controlTrapSending=controlTrapSending, controlTempLimitLoLo=controlTempLimitLoLo, moduleRackNo=moduleRackNo, moduleHwType=moduleHwType, moduleInformation=moduleInformation, regValue=regValue, repairDate=repairDate, notebookLineNumber=notebookLineNumber, element=element, sizeOfRegistry=sizeOfRegistry, controlTempLimitHi=controlTempLimitHi, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, repairComment=repairComment, elementStructure=elementStructure, controlInternalAppAccess=controlInternalAppAccess, moduleStatus=moduleStatus, controlLocalAccess=controlLocalAccess, controlLedUsage=controlLedUsage, statusBusMaster=statusBusMaster, controlTrapLifeTime=controlTrapLifeTime, controlResetElement=controlResetElement, statusTemperature=statusTemperature, moduleBiosVersion=moduleBiosVersion, controlAlarmOnDelay=controlAlarmOnDelay, statusInternalTemperature=statusInternalTemperature, sizeOfNotebook=sizeOfNotebook, statusSettings=statusSettings, controlTempDeadBand=controlTempDeadBand, moduleId=moduleId, moduleEntry=moduleEntry, statusLmt=statusLmt, notebookLineText=notebookLineText, moduleControl=moduleControl, sWUpdateControl=sWUpdateControl, elementAltitude=elementAltitude, productKeyCipher=productKeyCipher, productKeyFeatureEntry=productKeyFeatureEntry, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapReceiverTable=controlTrapReceiverTable, moduleStatusEntry=moduleStatusEntry, sWUpdateFileName=sWUpdateFileName, receiverAddress=receiverAddress, productKeyStatus=productKeyStatus, elementTotalUpTime=elementTotalUpTime, statusGeneral=statusGeneral, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapDelay=controlTrapDelay, elementName=elementName, controlMarkState=controlMarkState, module=module, controlBusMasterAdminState=controlBusMasterAdminState, statusFan=statusFan, statusHardware=statusHardware, moduleHwSerialNumber=moduleHwSerialNumber, moduleBusAddress=moduleBusAddress, controlTrapInterval=controlTrapInterval, elementConfigChangeCode=elementConfigChangeCode, moduleControlEntry=moduleControlEntry, regName=regName, productKeyMask=productKeyMask, statusSoftware=statusSoftware, swUpdateURL=swUpdateURL, sWUpdateStatus=sWUpdateStatus, moduleControlTable=moduleControlTable, productKeyEntry=productKeyEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleSlotNo=moduleSlotNo, moduleDetailEntry=moduleDetailEntry, repairReasonCode=repairReasonCode, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureEnable=productKeyFeatureEnable, controlReset=controlReset, productKeyFeatureTable=productKeyFeatureTable, moduleNotebookEntry=moduleNotebookEntry, moduleAppDate=moduleAppDate, elementLongitude=elementLongitude, moduleSizeOfEntry=moduleSizeOfEntry, moduleHwVersion=moduleHwVersion, moduleName=moduleName, repairNameCode=repairNameCode, regIndex=regIndex, productKeyIndex=productKeyIndex, elementLatitude=elementLatitude, moduleAppVersion=moduleAppVersion, moduleTable=moduleTable, receiverPort=receiverPort, moduleMacAddress=moduleMacAddress, productKeyTable=productKeyTable, statusRestartCounter=statusRestartCounter, productKeyNumberOfFeatures=productKeyNumberOfFeatures, repairIndex=repairIndex, productKeyFeatureIndex=productKeyFeatureIndex)
