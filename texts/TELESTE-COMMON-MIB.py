...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Counter64, NotificationType, Unsigned32, TimeTicks, IpAddress, Integer32, Bits, ModuleIdentity, Counter32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Counter64", "NotificationType", "Unsigned32", "TimeTicks", "IpAddress", "Integer32", "Bits", "ModuleIdentity", "Counter32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlTempLimitLo=controlTempLimitLo, elementLongitude=elementLongitude, controlTrapReceiverTable=controlTrapReceiverTable, moduleNotebookEntry=moduleNotebookEntry, moduleRepairLogEntry=moduleRepairLogEntry, statusResetCause=statusResetCause, receiverPort=receiverPort, controlMarkState=controlMarkState, moduleTable=moduleTable, moduleSWUpdateEntry=moduleSWUpdateEntry, statusTemperature=statusTemperature, receiverEntryId=receiverEntryId, moduleBiosVersion=moduleBiosVersion, element=element, moduleRegistryTable=moduleRegistryTable, moduleAppVersion=moduleAppVersion, productKeyEntry=productKeyEntry, moduleRegistry=moduleRegistry, moduleRackNo=moduleRackNo, elementLatitude=elementLatitude, controlLedUsage=controlLedUsage, moduleControlEntry=moduleControlEntry, regName=regName, moduleMacAddress=moduleMacAddress, controlTempLimitHiHi=controlTempLimitHiHi, controlTempLimitHi=controlTempLimitHi, controlResetElement=controlResetElement, statusFan=statusFan, moduleDetailEntry=moduleDetailEntry, moduleSWUpdateTable=moduleSWUpdateTable, statusHardware=statusHardware, regIndex=regIndex, statusLidStatus=statusLidStatus, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapSending=controlTrapSending, statusInternalTemperature=statusInternalTemperature, moduleStatusEntry=moduleStatusEntry, controlTrapDelay=controlTrapDelay, moduleSlotNo=moduleSlotNo, productKeyValue=productKeyValue, moduleStatus=moduleStatus, elementResetCount=elementResetCount, statusLmt=statusLmt, moduleHwVersion=moduleHwVersion, moduleHwType=moduleHwType, elementInformation=elementInformation, moduleDetailTable=moduleDetailTable, sizeOfNotebook=sizeOfNotebook, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureIndex=productKeyFeatureIndex, moduleName=moduleName, moduleStatusTable=moduleStatusTable, receiverAddress=receiverAddress, sWUpdateControl=sWUpdateControl, productKeyFeatureName=productKeyFeatureName, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusRestartCounter=statusRestartCounter, receiverCommunity=receiverCommunity, moduleBiosDate=moduleBiosDate, controlTempLimitLoLo=controlTempLimitLoLo, regValue=regValue, module=module, repairIndex=repairIndex, moduleSizeOfTable=moduleSizeOfTable, elementStatus=elementStatus, productKeyIndex=productKeyIndex, statusRunningSwImage=statusRunningSwImage, statusLid=statusLid, moduleRegistryEntry=moduleRegistryEntry, moduleEntry=moduleEntry, elementControl=elementControl, moduleAppDate=moduleAppDate, sizeOfRegistry=sizeOfRegistry, productKeyMask=productKeyMask, statusBusMaster=statusBusMaster, controlAlarmDetection=controlAlarmDetection, swUpdateURL=swUpdateURL, repairDate=repairDate, moduleSizeOfEntry=moduleSizeOfEntry, controlAlarmOffDelay=controlAlarmOffDelay, productKeyNumberOfFeatures=productKeyNumberOfFeatures, sWUpdateFileName=sWUpdateFileName, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureTable=productKeyFeatureTable, repairComment=repairComment, productKeyNumberOfKeys=productKeyNumberOfKeys, controlTrapReceiverEntry=controlTrapReceiverEntry, elementAltitude=elementAltitude, controlTempDeadBand=controlTempDeadBand, statusSettings=statusSettings, controlInternalAppAccess=controlInternalAppAccess, statusSoftware=statusSoftware, productKeyStatus=productKeyStatus, controlLocalAccess=controlLocalAccess, repairNameCode=repairNameCode, notebookLineText=notebookLineText, moduleHwSerialNumber=moduleHwSerialNumber, controlBusMasterAdminState=controlBusMasterAdminState, elementProductKey=elementProductKey, moduleId=moduleId, moduleRepairLogTable=moduleRepairLogTable, elementTotalUpTime=elementTotalUpTime, productKeyFeatureEnable=productKeyFeatureEnable, elementName=elementName, controlTrapInterval=controlTrapInterval, productKeyCipher=productKeyCipher, controlReset=controlReset, notebookLineNumber=notebookLineNumber, moduleNotebookTable=moduleNotebookTable, sizeOfRepairlog=sizeOfRepairlog, controlTrapLifeTime=controlTrapLifeTime, moduleControl=moduleControl, statusGeneral=statusGeneral, moduleControlTable=moduleControlTable, elementStructure=elementStructure, repairReasonCode=repairReasonCode, moduleBusAddress=moduleBusAddress, productKeyTable=productKeyTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, sWUpdateStatus=sWUpdateStatus, moduleInformation=moduleInformation)
