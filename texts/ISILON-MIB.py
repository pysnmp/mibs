...
iso, ModuleIdentity, IpAddress, Gauge32, Unsigned32, TimeTicks, enterprises, Bits, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "IpAddress", "Gauge32", "Unsigned32", "TimeTicks", "enterprises", "Bits", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("ISILON-MIB", clusterCPUPerf=clusterCPUPerf, clusterCPUSystem=clusterCPUSystem, nodeNetworkInBitsPerSecond=nodeNetworkInBitsPerSecond, clusterCPUPerfGroup=clusterCPUPerfGroup, diskPerfInBitsPerSecond=diskPerfInBitsPerSecond, quotas=quotas, snapshotSize=snapshotSize, powerSensorName=powerSensorName, clusterNetworkPerfGroup=clusterNetworkPerfGroup, nodePerformance=nodePerformance, outStdDevBytes=outStdDevBytes, snapshots=snapshots, diskPerfBay=diskPerfBay, nodeIfsPerfGroup=nodeIfsPerfGroup, latencyMin=latencyMin, quotaSoftThresholdDefined=quotaSoftThresholdDefined, snapshotSettings=snapshotSettings, snapshotScheduleEntry=snapshotScheduleEntry, diskPerfTableGroup=diskPerfTableGroup, powerSensorTableGroup=powerSensorTableGroup, quotaSoftThreshold=quotaSoftThreshold, quotaUsage=quotaUsage, diskBay=diskBay, accessTimeEnabled=accessTimeEnabled, snapshotRootAccessCIFS=snapshotRootAccessCIFS, diskEntry=diskEntry, clusterIfsPerf=clusterIfsPerf, fanDescription=fanDescription, ifsFilesystem=ifsFilesystem, quotaPath=quotaPath, ifsFilesystemGroup=ifsFilesystemGroup, nodeNetworkPerf=nodeNetworkPerf, nodeCPUPerfTable=nodeCPUPerfTable, latencyStdDev=latencyStdDev, isilonCompliance=isilonCompliance, snapshotScheduleSchedule=snapshotScheduleSchedule, inMaxBytes=inMaxBytes, latencyAverage=latencyAverage, snapshotTableGroup=snapshotTableGroup, offlineNodes=offlineNodes, clusterGUID=clusterGUID, outMinBytes=outMinBytes, nodeCPUPerfGroup=nodeCPUPerfGroup, tempSensorName=tempSensorName, inMinBytes=inMinBytes, clusterCPUInterrupt=clusterCPUInterrupt, diskSizeBytes=diskSizeBytes, nodePerCPUInterrupt=nodePerCPUInterrupt, diskPerfEntry=diskPerfEntry, nodePerCPUIdle=nodePerCPUIdle, powerSensorTable=powerSensorTable, licenseExpirationDate=licenseExpirationDate, clusterIfsInBitsPerSecond=clusterIfsInBitsPerSecond, quotaAdvisoryThreshold=quotaAdvisoryThreshold, snapshotScheduleAlias=snapshotScheduleAlias, diskModel=diskModel, licenseIndex=licenseIndex, diskDeviceName=diskDeviceName, snapshotRootVisibilityCIFS=snapshotRootVisibilityCIFS, snapshotPath=snapshotPath, quotaIncludesOverhead=quotaIncludesOverhead, tempSensorValue=tempSensorValue, chassisEntry=chassisEntry, nodeName=nodeName, cluster=cluster, fanName=fanName, isilon=isilon, nodeStatus=nodeStatus, powerSensorNumber=powerSensorNumber, quotaHardThresholdDefined=quotaHardThresholdDefined, snapshotSubdirAccessLocal=snapshotSubdirAccessLocal, ifsTotalBytes=ifsTotalBytes, nodeCPUIdle=nodeCPUIdle, nodeCPUPerfEntry=nodeCPUPerfEntry, nodeStatusGroup=nodeStatusGroup, quotaHardThreshold=quotaHardThreshold, snapshotCreated=snapshotCreated, protocolOpsPerSecond=protocolOpsPerSecond, outBitsPerSecond=outBitsPerSecond, diskPerfDeviceName=diskPerfDeviceName, diskLogicalNumber=diskLogicalNumber, diskChassisNumber=diskChassisNumber, quotaGracePeriod=quotaGracePeriod, nodeNetworkOutBytes=nodeNetworkOutBytes, protocolName=protocolName, quotaType=quotaType, chassisNumber=chassisNumber, clusterGroups=clusterGroups, PYSNMP_MODULE_ID=isilon, local=local, licenseTable=licenseTable, quotaDomainID=quotaDomainID, snapshotName=snapshotName, nodePerCPUNice=nodePerCPUNice, licenseModuleName=licenseModuleName, licenseStatus=licenseStatus, diskStatus=diskStatus, licenses=licenses, credentialBindings=credentialBindings, snapshotScheduledDeleteEnabled=snapshotScheduledDeleteEnabled, fanTableGroup=fanTableGroup, clusterNetworkOutBitsPerSecond=clusterNetworkOutBitsPerSecond, snapshotSettingsGroup=snapshotSettingsGroup, quotaID=quotaID, diskPerfOutBitsPerSecond=diskPerfOutBitsPerSecond, diskTable=diskTable, tempSensorDescription=tempSensorDescription, snapshotLocked=snapshotLocked, latencyMax=latencyMax, nodeIfsPerf=nodeIfsPerf, inStdDevBytes=inStdDevBytes, clusterIfsOutBitsPerSecond=clusterIfsOutBitsPerSecond, nodeHealth=nodeHealth, configuredNodes=configuredNodes, snapshotScheduleTable=snapshotScheduleTable, ifsFreeBytes=ifsFreeBytes, accessTimeGracePeriod=accessTimeGracePeriod, quotaTable=quotaTable, snapshotScheduleTableGroup=snapshotScheduleTableGroup, nodeProtocolPerfTable=nodeProtocolPerfTable, ifsUsedBytes=ifsUsedBytes, powerSensorDescription=powerSensorDescription, snapshotSchedulePath=snapshotSchedulePath, snapshotIndex=snapshotIndex, readOnly=readOnly, snapshotScheduleExpiration=snapshotScheduleExpiration, nodePerCPUSystem=nodePerCPUSystem, nodePerCPUUser=nodePerCPUUser, outAvgBytes=outAvgBytes, chassisUnitIDLEDOn=chassisUnitIDLEDOn, onlineNodes=onlineNodes, clusterStatus=clusterStatus, nodeIfsOutBitsPerSecond=nodeIfsOutBitsPerSecond, diskPerfOpsPerSecond=diskPerfOpsPerSecond, clusterNetworkInBitsPerSecond=clusterNetworkInBitsPerSecond, snapshotReservedPct=snapshotReservedPct, nodeCPUSystem=nodeCPUSystem, clusterNetworkPerf=clusterNetworkPerf, nodeNetworkOutBitsPerSecond=nodeNetworkOutBitsPerSecond, clusterIfsOutBytes=clusterIfsOutBytes, clusterPerformance=clusterPerformance, nodePerformanceGroup=nodePerformanceGroup, nodeGroups=nodeGroups, ifsAvailableBytes=ifsAvailableBytes, nodeCPUUser=nodeCPUUser, protocolOpCount=protocolOpCount, chassisTable=chassisTable, fanTable=fanTable, fanSpeed=fanSpeed, snapshotScheduleNamingPattern=snapshotScheduleNamingPattern, nodeCPUInterrupt=nodeCPUInterrupt, clusterPerformanceGroups=clusterPerformanceGroups, nodeNetworkPerfGroup=nodeNetworkPerfGroup, nodePerCPUID=nodePerCPUID, tempSensorTableGroup=tempSensorTableGroup, clusterName=clusterName, snapshotEntry=snapshotEntry, clusterCPUUser=clusterCPUUser, nodeProtocolPerfEntry=nodeProtocolPerfEntry, snapshotRootAccessLocal=snapshotRootAccessLocal, nodeIfsInBytes=nodeIfsInBytes, snapshotScheduleIndex=snapshotScheduleIndex, chassisTableGroup=chassisTableGroup, powerSensorValue=powerSensorValue, snapshotScheduledCreateEnabled=snapshotScheduledCreateEnabled, snapshotRootVisibilityNFS=snapshotRootVisibilityNFS, licenseEntry=licenseEntry, chassisModel=chassisModel, fanNumber=fanNumber, powerSensorEntry=powerSensorEntry, outMaxBytes=outMaxBytes, quotaUsageWithOverhead=quotaUsageWithOverhead, clusterIfsInBytes=clusterIfsInBytes, snapshotRootVisibilityLocal=snapshotRootVisibilityLocal, diskSerialNumber=diskSerialNumber, nodeNetworkInBytes=nodeNetworkInBytes, nodeIfsInBitsPerSecond=nodeIfsInBitsPerSecond, nodeCPUPerf=nodeCPUPerf, chassisConfigNumber=chassisConfigNumber, quotaIncludesSnapshotUsage=quotaIncludesSnapshotUsage, diskPerfTable=diskPerfTable, nodeType=nodeType, quotaInodeUsage=quotaInodeUsage, inBitsPerSecond=inBitsPerSecond, snapshotSubdirAccessNFS=snapshotSubdirAccessNFS, chassisSerialNumber=chassisSerialNumber, diskFirmwareVersion=diskFirmwareVersion, conformance=conformance, quotaEntry=quotaEntry, inAvgBytes=inAvgBytes, diskTableGroup=diskTableGroup, snapshotsGroup=snapshotsGroup, snapshotAliasFor=snapshotAliasFor, tempSensorTable=tempSensorTable, tempSensorNumber=tempSensorNumber, nodeCount=nodeCount, snapshotTable=snapshotTable, clusterHealth=clusterHealth, tempSensorEntry=tempSensorEntry, nodeProtocolPerfTableGroup=nodeProtocolPerfTableGroup, clusterStatusGroup=clusterStatusGroup, clusterIfsPerfGroup=clusterIfsPerfGroup, nodeCPUNice=nodeCPUNice, node=node, nodeIfsOutBytes=nodeIfsOutBytes, snapshotScheduleName=snapshotScheduleName, licensesGroup=licensesGroup, quotasGroup=quotasGroup, clusterNetworkOutBytes=clusterNetworkOutBytes, snapshotRootAccessNFS=snapshotRootAccessNFS, quotaAdvisoryThresholdDefined=quotaAdvisoryThresholdDefined, fanEntry=fanEntry, clusterCPUIdlePct=clusterCPUIdlePct, snapshotExpires=snapshotExpires, clusterNetworkInBytes=clusterNetworkInBytes, clusterCPUNice=clusterCPUNice, snapshotSubdirAccessCIFS=snapshotSubdirAccessCIFS)
