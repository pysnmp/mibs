...
IpAddress, Counter32, MibIdentifier, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, NotificationType, ModuleIdentity, TimeTicks, Bits, Counter64, Integer32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "MibIdentifier", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "NotificationType", "ModuleIdentity", "TimeTicks", "Bits", "Counter64", "Integer32", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmWriteCommunity=slmWriteCommunity, slmLicenseIndex=slmLicenseIndex, slmAdminCommunity=slmAdminCommunity, slmTrapLogName=slmTrapLogName, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmSysResetPm=slmSysResetPm, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTid=slmTid, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRebootDelay=slmRebootDelay, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDirectory=slmSwRevDirectory, slmAdminLogin=slmAdminLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseEntry=slmLicenseEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmSyslogPort=slmSyslogPort, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAdminStatus=slmSysAdminStatus, slmChPassOldPass=slmChPassOldPass, slmLogin=slmLogin, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmChPassTable=slmChPassTable, slmAdminAccess=slmAdminAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmEdfaNumber=slmEdfaNumber, slmLogFile=slmLogFile, slmLicense=slmLicense, slmTrapPort=slmTrapPort, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevTable=slmSwRevTable, slmNetworkMode=slmNetworkMode, slmOemType=slmOemType, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmSys=slmSys, slmSysLocation=slmSysLocation, slmLicenseTable=slmLicenseTable, slmAdmin=slmAdmin, slmSyslogDestTable=slmSyslogDestTable, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, SoftwareRevision=SoftwareRevision, slmAuth=slmAuth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminTable=slmAdminTable, PYSNMP_MODULE_ID=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevName=slmSwRevName, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserLogin=UserLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmSysMode=slmSysMode, slmSysName=slmSysName, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam6=slmTrapLogParam6, slmBoxSize=slmBoxSize, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmLicenseId=slmLicenseId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPsuNumber=slmPsuNumber, slmMuxNumber=slmMuxNumber, slmConfigFile=slmConfigFile, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmSysSubnetMask=slmSysSubnetMask, slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmSysChassisId=slmSysChassisId, slmSysIpAddr=slmSysIpAddr, slmReadCommunity=slmReadCommunity, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmChPassNewPass=slmChPassNewPass, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, slmSyslogLevel=slmSyslogLevel, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable)
