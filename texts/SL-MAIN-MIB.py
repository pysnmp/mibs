...
ObjectIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, iso, MibIdentifier, NotificationType, Opaque, Counter64, Bits, Gauge32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "iso", "MibIdentifier", "NotificationType", "Opaque", "Counter64", "Bits", "Gauge32", "TimeTicks", "ModuleIdentity")
TruthValue, DateAndTime, DisplayString, TextualConvention, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DateAndTime", "DisplayString", "TextualConvention", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOemType=slmOemType, slmSysOperStatus=slmSysOperStatus, slmWriteCommunity=slmWriteCommunity, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmBoxSize=slmBoxSize, slmAuthTable=slmAuthTable, slmLogFile=slmLogFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, slmAuthCommunity=slmAuthCommunity, slMain=slMain, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthPassword=slmAuthPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, AdminAccess=AdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapLogId=slmTrapLogId, slmTrapCommunity=slmTrapCommunity, slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap, slmSwRevTable=slmSwRevTable, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmSysMode=slmSysMode, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmTrapDestEntry=slmTrapDestEntry, slmTid=slmTid, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmAdminRowStatus=slmAdminRowStatus, UserCommunity=UserCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminPassword=slmAdminPassword, slmSysAlmDeact=slmSysAlmDeact, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTable=slmTrapLogTable, slmChPassLogin=slmChPassLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slmTrapPort=slmTrapPort, slmTopologyEnabled=slmTopologyEnabled, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, PYSNMP_MODULE_ID=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmAuth=slmAuth, slmTrapLogEntry=slmTrapLogEntry, SoftwareRevision=SoftwareRevision, slmAdminAccess=slmAdminAccess, slmConfigFile=slmConfigFile, slmSysLocation=slmSysLocation, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassTable=slmChPassTable, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmReadCommunity=slmReadCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysTemperature=slmSysTemperature, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmSwRevDate=slmSwRevDate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestTable=slmTrapDestTable, slmLogin=slmLogin, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange)
