...
Integer32, NotificationType, TimeTicks, Bits, IpAddress, MibIdentifier, ObjectIdentity, iso, Counter64, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Counter64", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTopologyEnabled=slmTopologyEnabled, slmAuthPassword=slmAuthPassword, slmLogFile=slmLogFile, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestTable=slmTrapDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmWriteCommunity=slmWriteCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmOemType=slmOemType, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slmTid=slmTid, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthEntry=slmAuthEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserPassword=UserPassword, slmSysChassisId=slmSysChassisId, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slMain=slMain, UserCommunity=UserCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmSysName=slmSysName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmDeact=slmSysAlmDeact, slmEdfaNumber=slmEdfaNumber, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmTrapEnable=slmTrapEnable, slm40GConf=slm40GConf, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSyslogPort=slmSyslogPort, slmSwRevStatus=slmSwRevStatus, slmAdminPassword=slmAdminPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassLogin=slmChPassLogin, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthTable=slmAuthTable, slmPortsNumber=slmPortsNumber, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmAct=slmSysAlmAct, slmSwRevDate=slmSwRevDate, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmSysOperStatus=slmSysOperStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, slmSysTemperature=slmSysTemperature, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, AdminAccess=AdminAccess, slmAdminLogin=slmAdminLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminEntry=slmAdminEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserAccess=slmTrapUserAccess, slmSysResetPm=slmSysResetPm, slmSysMode=slmSysMode, slmLicenseTable=slmLicenseTable, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmTrapUserLogin=slmTrapUserLogin)
