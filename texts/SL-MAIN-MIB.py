...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Gauge32, Integer32, IpAddress, ObjectIdentity, Opaque, iso, Counter32, TimeTicks, MibIdentifier, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Gauge32", "Integer32", "IpAddress", "ObjectIdentity", "Opaque", "iso", "Counter32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter64")
TextualConvention, DateAndTime, TruthValue, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "TruthValue", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevEntry=slmSwRevEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmTrapPort=slmTrapPort, slmTrapLogId=slmTrapLogId, slmWriteCommunity=slmWriteCommunity, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmTrapLogParam3=slmTrapLogParam3, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmPortsNumber=slmPortsNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassTable=slmChPassTable, slmPmAvailable=slmPmAvailable, slmSysCalendarTime=slmSysCalendarTime, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, PYSNMP_MODULE_ID=slMain, slmTrapCommunity=slmTrapCommunity, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogName=slmTrapLogName, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slm40GConf=slm40GConf, slmAdminTable=slmAdminTable, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmAdminAccess=slmAdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slMain=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSubnetMask=slmSysSubnetMask, slmChPassLogin=slmChPassLogin, slmAdminLogin=slmAdminLogin, slmTrapLogTable=slmTrapLogTable, slmTrapUserAccess=slmTrapUserAccess, slmLicense=slmLicense, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLocation=slmSysLocation, UserLogin=UserLogin, UserPassword=UserPassword, slmTid=slmTid, slmSysOperStatus=slmSysOperStatus, slmLogin=slmLogin, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDirectory=slmSwRevDirectory, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmTrap=slmTrap, slmSysName=slmSysName, slmSysChassisId=slmSysChassisId, slmSysAlmDeact=slmSysAlmDeact, slmSysMode=slmSysMode, slmTrapLogEntry=slmTrapLogEntry, slmEdfaNumber=slmEdfaNumber, slmAdminCommunity=slmAdminCommunity, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSyslogDestTable=slmSyslogDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmAuthCommunity=slmAuthCommunity, slmAuthPassword=slmAuthPassword, slmTrapLogParam1=slmTrapLogParam1, slmSysEncryptionCapability=slmSysEncryptionCapability)
