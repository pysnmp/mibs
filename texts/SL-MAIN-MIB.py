...
Gauge32, NotificationType, Counter64, iso, MibIdentifier, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Integer32, ObjectIdentity, TimeTicks, Bits, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Counter64", "iso", "MibIdentifier", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Integer32", "ObjectIdentity", "TimeTicks", "Bits", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthCommunity=slmAuthCommunity, slmTrapLogEntry=slmTrapLogEntry, UserPassword=UserPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminTable=slmAdminTable, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmTrapLogId=slmTrapLogId, slmAuthPassword=slmAuthPassword, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Auth=slmSnmpv3Auth, slmTid=slmTid, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Password=slmSnmpv3Password, slmRebootDelay=slmRebootDelay, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmRstpEnabled=slmRstpEnabled, slmSysTemperature=slmSysTemperature, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTable=slmTrapLogTable, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminEntry=slmAdminEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthTable=slmAuthTable, slmTrapCommunity=slmTrapCommunity, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable, slmSysMode=slmSysMode, AdminAccess=AdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmSysCalendarTime=slmSysCalendarTime, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slmTrapDestTable=slmTrapDestTable, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmSyslogLevel=slmSyslogLevel, slmSysResetPm=slmSysResetPm, slmTrapLogParam1=slmTrapLogParam1, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmAdminCommunity=slmAdminCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDate=slmSwRevDate, slmSyslogPort=slmSyslogPort, slmAuthLogin=slmAuthLogin, slmLicenseTable=slmLicenseTable, slmSys=slmSys, slmAuth=slmAuth, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam4=slmTrapLogParam4, slmChPassEntry=slmChPassEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmTrapLogName=slmTrapLogName, slmTrap=slmTrap, slmEdfaNumber=slmEdfaNumber, slmSysIpAddr=slmSysIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassOldPass=slmChPassOldPass, slMain=slMain, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSysNameChange=slmTrapSysNameChange)
