...
Counter64, NotificationType, ObjectIdentity, ModuleIdentity, IpAddress, Opaque, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter32, Unsigned32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Opaque", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "iso")
RowStatus, TextualConvention, DateAndTime, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DateAndTime", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmPortsNumber=slmPortsNumber, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthCommunity=slmAuthCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicense=slmLicense, slmAdminTable=slmAdminTable, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmLogin=slmLogin, slmNetworkMode=slmNetworkMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmReadCommunity=slmReadCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysName=slmSysName, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Password=slmSnmpv3Password, slmAdminEntry=slmAdminEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevEntry=slmSwRevEntry, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseId=slmLicenseId, slmAuthPassword=slmAuthPassword, slmSysMode=slmSysMode, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam6=slmTrapLogParam6, slmVcatDelay=slmVcatDelay, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, PYSNMP_MODULE_ID=slMain, slmSwRevStatus=slmSwRevStatus, slmAuthLogin=slmAuthLogin, slmSysAdminStatus=slmSysAdminStatus, slmAuthEntry=slmAuthEntry, slmTrapEnable=slmTrapEnable, slmAdminLogin=slmAdminLogin, slmTrapDestEntry=slmTrapDestEntry, slmAuthTable=slmAuthTable, slmOemType=slmOemType, slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmChPassEntry=slmChPassEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmPmAvailable=slmPmAvailable, slmTrap=slmTrap, UserLogin=UserLogin, AdminAccess=AdminAccess, slmChPassOldPass=slmChPassOldPass, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmSysLocation=slmSysLocation, slmRebootDelay=slmRebootDelay, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSnmpVersion=slmSysSnmpVersion, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestAddress=slmTrapDestAddress, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam3=slmTrapLogParam3, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapPort=slmTrapPort, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, slmChPassLogin=slmChPassLogin, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmWriteCommunity=slmWriteCommunity, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTemperature=slmSysTemperature, slmSwRevDirectory=slmSwRevDirectory, slmTopologyEnabled=slmTopologyEnabled, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysResetPm=slmSysResetPm, slmSwRevTable=slmSwRevTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserAccess=slmTrapUserAccess)
