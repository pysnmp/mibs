...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmChPassOldPass=slmChPassOldPass, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmSysMode=slmSysMode, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, slmNetworkMode=slmNetworkMode, slmAdminEntry=slmAdminEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassTable=slmChPassTable, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam3=slmTrapLogParam3, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPsuNumber=slmPsuNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmSysResetPm=slmSysResetPm, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmSysLocation=slmSysLocation, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmAdminLogin=slmAdminLogin, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, UserLogin=UserLogin, slMain=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, AdminAccess=AdminAccess, slmTrapLogId=slmTrapLogId, slmSyslogPort=slmSyslogPort, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, slm40GConf=slm40GConf, slmSysTemperature=slmSysTemperature, slmTrapEnable=slmTrapEnable, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmSwRevTable=slmSwRevTable, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam6=slmTrapLogParam6, slmAdminTable=slmAdminTable, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminPassword=slmAdminPassword, slmSwRevStatus=slmSwRevStatus, slmTrapDestTable=slmTrapDestTable, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmTid=slmTid, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmDeact=slmSysAlmDeact, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmReadCommunity=slmReadCommunity, slmSysTrapFormat=slmSysTrapFormat, slmAuthLogin=slmAuthLogin, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSubnetMask=slmSysSubnetMask)
