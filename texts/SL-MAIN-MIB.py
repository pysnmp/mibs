...
Integer32, IpAddress, TimeTicks, iso, NotificationType, Counter32, Unsigned32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, MibIdentifier, Gauge32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "TimeTicks", "iso", "NotificationType", "Counter32", "Unsigned32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "MibIdentifier", "Gauge32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminTable=slmAdminTable, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmSysSubnetMask=slmSysSubnetMask, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmSys=slmSys, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, slmSysCalendarTime=slmSysCalendarTime, slmSyslogPort=slmSyslogPort, slmTrapPort=slmTrapPort, slmSyslogDestEntry=slmSyslogDestEntry, PYSNMP_MODULE_ID=slMain, UserCommunity=UserCommunity, slmPsuNumber=slmPsuNumber, slmChPass=slmChPass, slmTid=slmTid, slmOemType=slmOemType, slmSnmpv3Auth=slmSnmpv3Auth, slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmChPassNewPass=slmChPassNewPass, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmAdminCommunity=slmAdminCommunity, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmLicenseEntry=slmLicenseEntry, slmAdminPassword=slmAdminPassword, slmSnmpv3Password=slmSnmpv3Password, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmTrapEnable=slmTrapEnable, slmLicenseIndex=slmLicenseIndex, slmSysMode=slmSysMode, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmChPassTable=slmChPassTable, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, UserPassword=UserPassword, slmSysTemperature=slmSysTemperature, slmVcatDelay=slmVcatDelay, slmChPassLogin=slmChPassLogin, slmTrapLogEntry=slmTrapLogEntry, slmAdmin=slmAdmin, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmRebootDelay=slmRebootDelay, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmAdminRowStatus=slmAdminRowStatus, slmSysName=slmSysName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthEntry=slmAuthEntry, slmSysAlmAct=slmSysAlmAct, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmLogFile=slmLogFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, UserLogin=UserLogin, slmAdminEntry=slmAdminEntry, slmSwRevTable=slmSwRevTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthTable=slmAuthTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slm40GConf=slm40GConf, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSysOperStatus=slmSysOperStatus, slMain=slMain, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmSwRevEntry=slmSwRevEntry, slmSysChassisId=slmSysChassisId, slmAdminAccess=slmAdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmAuthPassword=slmAuthPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestAddress=slmTrapDestAddress, slmRstpEnabled=slmRstpEnabled, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile)
