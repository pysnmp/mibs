...
Integer32, ModuleIdentity, TimeTicks, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Unsigned32, NotificationType, Gauge32, Counter64, iso, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "TimeTicks", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "iso", "Opaque", "IpAddress")
TextualConvention, DateAndTime, DisplayString, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "DisplayString", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogin=slmLogin, slmLicenseId=slmLicenseId, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmSwRevDirectory=slmSwRevDirectory, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmChPassEntry=slmChPassEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmPsuNumber=slmPsuNumber, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, slmTrapLogName=slmTrapLogName, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevStatus=slmSwRevStatus, slmSysLocation=slmSysLocation, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, slmSysIpAddr=slmSysIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmAdminTable=slmAdminTable, slmTrapEnable=slmTrapEnable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassTable=slmChPassTable, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmTrapDestAddress=slmTrapDestAddress, slmSys=slmSys, slmRebootDelay=slmRebootDelay, slmLicense=slmLicense, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmReadCommunity=slmReadCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmAuthEntry=slmAuthEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask, slmRstpEnabled=slmRstpEnabled, slmConfigFile=slmConfigFile, slmTrapLogParam4=slmTrapLogParam4, slmAdminEntry=slmAdminEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmMuxNumber=slmMuxNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, slmTrapLogTable=slmTrapLogTable, slmAuthLogin=slmAuthLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmWriteCommunity=slmWriteCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevName=slmSwRevName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserAccess=slmTrapUserAccess, slmChPassNewPass=slmChPassNewPass, UserCommunity=UserCommunity, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate, slmSwRevTable=slmSwRevTable, slmTrapLogId=slmTrapLogId, slmTopologyEnabled=slmTopologyEnabled, slmAdminCommunity=slmAdminCommunity, slmSysResetPm=slmSysResetPm, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, AdminAccess=AdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapPort=slmTrapPort, slmAuthCommunity=slmAuthCommunity, slmTrapLogEntry=slmTrapLogEntry)
