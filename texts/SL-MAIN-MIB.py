...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrap=slmTrap, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDirectory=slmSwRevDirectory, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmPsuNumber=slmPsuNumber, slmVcatDelay=slmVcatDelay, slmChPass=slmChPass, AdminAccess=AdminAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysUptime=slmConfigSysUptime, slmAdminTable=slmAdminTable, slmAdminLogin=slmAdminLogin, slmConfigSysSignalType=slmConfigSysSignalType, slm40GConf=slm40GConf, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmTrapPort=slmTrapPort, slmSwRevName=slmSwRevName, slmChPassTable=slmChPassTable, slmLicenseTable=slmLicenseTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmTrapLogParam5=slmTrapLogParam5, slmPortsNumber=slmPortsNumber, slmTrapLogParam2=slmTrapLogParam2, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmSysChassisId=slmSysChassisId, slmTrapLogParam6=slmTrapLogParam6, UserCommunity=UserCommunity, slmAuthPassword=slmAuthPassword, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmAct=slmSysAlmAct, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmDeact=slmSysAlmDeact, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, slmChPassLogin=slmChPassLogin, slmTrapEnable=slmTrapEnable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogName=slmTrapLogName, slmMuxNumber=slmMuxNumber, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmTid=slmTid, slmSnmpv3Priv=slmSnmpv3Priv, slmSysMode=slmSysMode, slmChPassEntry=slmChPassEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthCommunity=slmAuthCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, slmSwRevTable=slmSwRevTable, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, PYSNMP_MODULE_ID=slMain, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysLocation=slmSysLocation, slmNetworkMode=slmNetworkMode, slmSwRevDate=slmSwRevDate, slmRstpEnabled=slmRstpEnabled, slmAdminAccess=slmAdminAccess, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, slmAuthEntry=slmAuthEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminEntry=slmAdminEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseIndex=slmLicenseIndex, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmLicenseExpiration=slmLicenseExpiration, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam1=slmTrapLogParam1)
