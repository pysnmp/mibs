...
Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Unsigned32, Counter64, ModuleIdentity, iso, Integer32, ObjectIdentity, Opaque, Gauge32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Unsigned32", "Counter64", "ModuleIdentity", "iso", "Integer32", "ObjectIdentity", "Opaque", "Gauge32", "NotificationType", "MibIdentifier")
TruthValue, TextualConvention, DateAndTime, RowStatus, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DateAndTime", "RowStatus", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmChPassNewPass=slmChPassNewPass, slmEdfaNumber=slmEdfaNumber, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmAuthEntry=slmAuthEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassOldPass=slmChPassOldPass, slmTrapDestTable=slmTrapDestTable, slmSysAdminStatus=slmSysAdminStatus, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmAdminLogin=slmAdminLogin, slmSwRevTable=slmSwRevTable, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmSysTemperature=slmSysTemperature, slmNetworkMode=slmNetworkMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmAuthTable=slmAuthTable, slmSysChassisId=slmSysChassisId, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam1=slmTrapLogParam1, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmSyslogLevel=slmSyslogLevel, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, AdminAccess=AdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmVcatDelay=slmVcatDelay, slmPmAvailable=slmPmAvailable, slmReadCommunity=slmReadCommunity, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOemType=slmOemType, slmSysName=slmSysName, slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthPassword=slmAuthPassword, slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevName=slmSwRevName, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestTable=slmSyslogDestTable, UserCommunity=UserCommunity, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogin=slmLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slmAdminCommunity=slmAdminCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmTrapEnable=slmTrapEnable, slmTrapLogName=slmTrapLogName, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTid=slmTid, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseExpiration=slmLicenseExpiration, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmSys=slmSys, slmSwRevDate=slmSwRevDate, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmAuth=slmAuth, slmRstpEnabled=slmRstpEnabled, slmSwRevStatus=slmSwRevStatus, slmLicenseTable=slmLicenseTable, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, slmMuxNumber=slmMuxNumber)
