...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, IpAddress, TimeTicks, Counter32, ModuleIdentity, Opaque, Unsigned32, Integer32, iso, NotificationType, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "IpAddress", "TimeTicks", "Counter32", "ModuleIdentity", "Opaque", "Unsigned32", "Integer32", "iso", "NotificationType", "Counter64", "Gauge32")
TextualConvention, TimeStamp, DisplayString, TruthValue, RowStatus, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayAddr=slmSysGatewayAddr, slmLicense=slmLicense, slmSysResetPm=slmSysResetPm, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmAdminCommunity=slmAdminCommunity, slmLicenseIndex=slmLicenseIndex, slmLicenseTable=slmLicenseTable, slmChPass=slmChPass, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmAuthPassword=slmAuthPassword, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmSysLanIpAddr=slmSysLanIpAddr, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmLogFile=slmLogFile, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmTrapCommunity=slmTrapCommunity, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmSysLocation=slmSysLocation, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, PYSNMP_MODULE_ID=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTable=slmTrapLogTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, UserPassword=UserPassword, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysChassisId=slmSysChassisId, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, SoftwareRevision=SoftwareRevision, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam6=slmTrapLogParam6, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysOperStatus=slmSysOperStatus, slmSysMode=slmSysMode, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, AdminAccess=AdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmDeact=slmSysAlmDeact, slmPmAvailable=slmPmAvailable, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmRebootDelay=slmRebootDelay, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassOldPass=slmChPassOldPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassTable=slmChPassTable, slmTrapDestEntry=slmTrapDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmPsuNumber=slmPsuNumber, slmSysTemperature=slmSysTemperature, slmSwRevEntry=slmSwRevEntry, slmTrapLogId=slmTrapLogId, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminEntry=slmAdminEntry, slmTrap=slmTrap, slmAdminTable=slmAdminTable, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmSnmpv3Auth=slmSnmpv3Auth)
