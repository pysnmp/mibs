...
NotificationType, Bits, ModuleIdentity, Gauge32, iso, Counter64, IpAddress, Unsigned32, Counter32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Opaque, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "ModuleIdentity", "Gauge32", "iso", "Counter64", "IpAddress", "Unsigned32", "Counter32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Opaque", "TimeTicks")
RowStatus, DateAndTime, DisplayString, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestTable=slmSyslogDestTable, slmTrapEnable=slmTrapEnable, slmSysSubnetMask=slmSysSubnetMask, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassNewPass=slmChPassNewPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthPassword=slmAuthPassword, slMain=slMain, slmSwRevDate=slmSwRevDate, slmReadCommunity=slmReadCommunity, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmOemType=slmOemType, slmSysAdminStatus=slmSysAdminStatus, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, UserLogin=UserLogin, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmPmAvailable=slmPmAvailable, slmSysIpAddr=slmSysIpAddr, slmSysResetPm=slmSysResetPm, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, UserCommunity=UserCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanIpAddr=slmSysLanIpAddr, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmSysTemperature=slmSysTemperature, slmLicenseId=slmLicenseId, slmSwRevEntry=slmSwRevEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRebootDelay=slmRebootDelay, slmNetworkMode=slmNetworkMode, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDirectory=slmSwRevDirectory, slmSysSnmpVersion=slmSysSnmpVersion, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmTopologyEnabled=slmTopologyEnabled, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmAdmin=slmAdmin, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmSyslogDestEntry=slmSyslogDestEntry, slmChPass=slmChPass, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmChPassLogin=slmChPassLogin, slmSnmpv3Password=slmSnmpv3Password, slmLogFile=slmLogFile, slmTrapLogEntry=slmTrapLogEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam1=slmTrapLogParam1, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSys=slmSys, slmPsuNumber=slmPsuNumber, UserPassword=UserPassword, slmAdminEntry=slmAdminEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmSysLocation=slmSysLocation, slmAuthEntry=slmAuthEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseIndex=slmLicenseIndex, slmMuxNumber=slmMuxNumber, slmChPassEntry=slmChPassEntry, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysName=slmSysName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam5=slmTrapLogParam5, slmLicenseEntry=slmLicenseEntry)
