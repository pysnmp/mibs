...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Integer32, ObjectIdentity, IpAddress, MibIdentifier, Bits, Gauge32, NotificationType, Counter32, ModuleIdentity, Opaque, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Integer32", "ObjectIdentity", "IpAddress", "MibIdentifier", "Bits", "Gauge32", "NotificationType", "Counter32", "ModuleIdentity", "Opaque", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmAdminEntry=slmAdminEntry, slmMuxNumber=slmMuxNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmSysAlmAct=slmSysAlmAct, slmAuth=slmAuth, slmSysMode=slmSysMode, slmTrapDestEntry=slmTrapDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestTable=slmSyslogDestTable, slmConfigSysUptime=slmConfigSysUptime, slMain=slMain, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmPortsNumber=slmPortsNumber, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSysName=slmSysName, slmTrapLogParam2=slmTrapLogParam2, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmSwRevDirectory=slmSwRevDirectory, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRstpEnabled=slmRstpEnabled, slmTrapPort=slmTrapPort, slmAdminCommunity=slmAdminCommunity, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminTable=slmAdminTable, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevEntry=slmSwRevEntry, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmTrapDestCommunity=slmTrapDestCommunity, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapEnable=slmTrapEnable, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigFile=slmConfigFile, UserLogin=UserLogin, slmChPassLogin=slmChPassLogin, slmPmAvailable=slmPmAvailable, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmAdminRowStatus=slmAdminRowStatus, slmAdmin=slmAdmin, slmTid=slmTid, slmSysResetPm=slmSysResetPm, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrap=slmTrap, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassEntry=slmChPassEntry, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmAdminLogin=slmAdminLogin, slmSwRevStatus=slmSwRevStatus, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmSysOperStatus=slmSysOperStatus, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slmChPass=slmChPass, slmBoxSize=slmBoxSize, slmTrapLogParam4=slmTrapLogParam4, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmTrapUserLogin=slmTrapUserLogin, slmAuthLogin=slmAuthLogin, slmSyslogPort=slmSyslogPort, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, slmTrapLogTable=slmTrapLogTable, slmSysIpAddr=slmSysIpAddr, slmRebootDelay=slmRebootDelay, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry)
