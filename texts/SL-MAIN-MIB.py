...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, NotificationType, Counter32, Unsigned32, IpAddress, Bits, Counter64, Gauge32, ObjectIdentity, iso, Opaque, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "Unsigned32", "IpAddress", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "iso", "Opaque", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPmAvailable=slmPmAvailable, slmLicense=slmLicense, slmAdmin=slmAdmin, slmAuthLogin=slmAuthLogin, slMain=slMain, slmTrapPort=slmTrapPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmSwRevStatus=slmSwRevStatus, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassOldPass=slmChPassOldPass, slmAdminAccess=slmAdminAccess, UserLogin=UserLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysIpAddr=slmSysIpAddr, slmChPassTable=slmChPassTable, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmSysMode=slmSysMode, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam4=slmTrapLogParam4, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysName=slmSysName, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmAdminTable=slmAdminTable, slmSyslogDestEntry=slmSyslogDestEntry, slmRebootDelay=slmRebootDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDirectory=slmSwRevDirectory, slmAuth=slmAuth, slmSysLocation=slmSysLocation, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, slmPsuNumber=slmPsuNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSysOperStatus=slmSysOperStatus, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysResetPm=slmSysResetPm, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLogin=slmLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmAuthPassword=slmAuthPassword, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable, slmSyslogLevel=slmSyslogLevel, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapCommunity=slmTrapCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTid=slmTid, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmLicenseEntry=slmLicenseEntry, slmNetworkMode=slmNetworkMode, SoftwareRevision=SoftwareRevision, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam3=slmTrapLogParam3, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmTrapLogTable=slmTrapLogTable, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile)
