...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmLogin=slmLogin, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmTid=slmTid, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmAdmin=slmAdmin, slmConfigFile=slmConfigFile, slmTrapLogParam4=slmTrapLogParam4, slMain=slMain, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevEntry=slmSwRevEntry, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminAccess=slmAdminAccess, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevTable=slmSwRevTable, slmLicenseId=slmLicenseId, slmAuth=slmAuth, slmSwRevDate=slmSwRevDate, slmVcatDelay=slmVcatDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysMode=slmSysMode, slmSysLanIpAddr=slmSysLanIpAddr, slmPsuNumber=slmPsuNumber, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogEntry=slmTrapLogEntry, slmSysUplinkRate=slmSysUplinkRate, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slmSwRevDirectory=slmSwRevDirectory, slmAdminPassword=slmAdminPassword, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmBoxSize=slmBoxSize, slmTrapLogId=slmTrapLogId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTable=slmTrapLogTable, slmLicenseEntry=slmLicenseEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, PYSNMP_MODULE_ID=slMain, slmAdminLogin=slmAdminLogin, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, slmChPass=slmChPass, slmWriteCommunity=slmWriteCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slm40GConf=slm40GConf, slmRebootDelay=slmRebootDelay, SoftwareRevision=SoftwareRevision, slmAdminEntry=slmAdminEntry, slmLicense=slmLicense, slmChPassEntry=slmChPassEntry, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmSys=slmSys, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmPmAvailable=slmPmAvailable, slmSysNetworkPrefix=slmSysNetworkPrefix, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, AdminAccess=AdminAccess, slmLicenseTable=slmLicenseTable, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam1=slmTrapLogParam1, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSwRevStatus=slmSwRevStatus)
