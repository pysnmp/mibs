...
ModuleIdentity, Bits, Counter32, NotificationType, Integer32, Counter64, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, TimeTicks, Opaque, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "NotificationType", "Integer32", "Counter64", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Opaque", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmLogin=slmLogin, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slmMuxNumber=slmMuxNumber, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmChPassTable=slmChPassTable, slmSwRevStatus=slmSwRevStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogFile=slmLogFile, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmAct=slmSysAlmAct, slmReadCommunity=slmReadCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysLocation=slmSysLocation, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmSwRevDate=slmSwRevDate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slMain=slMain, slmAuthPassword=slmAuthPassword, slmAdminTable=slmAdminTable, slmChPassEntry=slmChPassEntry, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmChPass=slmChPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, slmRebootDelay=slmRebootDelay, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassLogin=slmChPassLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTid=slmTid, AdminAccess=AdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminAccess=slmAdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestTable=slmTrapDestTable, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapUserAccess=slmTrapUserAccess, slmSyslogPort=slmSyslogPort, slmLicenseId=slmLicenseId, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmSysResetPm=slmSysResetPm, slmAdminRowStatus=slmAdminRowStatus, slmOemType=slmOemType, slmEdfaNumber=slmEdfaNumber, slmRstpEnabled=slmRstpEnabled, slmWriteCommunity=slmWriteCommunity, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmSys=slmSys, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slmTrapLogTable=slmTrapLogTable, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, slm40GConf=slm40GConf, slmSysAlmDeact=slmSysAlmDeact, slmAdminPassword=slmAdminPassword, slmAdminCommunity=slmAdminCommunity, PYSNMP_MODULE_ID=slMain, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapEnable=slmTrapEnable, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmSnmpv3Auth=slmSnmpv3Auth, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthEntry=slmAuthEntry, slmSysOperStatus=slmSysOperStatus, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmChPassNewPass=slmChPassNewPass, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmChPassOldPass=slmChPassOldPass)
