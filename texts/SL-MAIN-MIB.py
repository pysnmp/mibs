...
IpAddress, Counter32, ObjectIdentity, MibIdentifier, Integer32, TimeTicks, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, NotificationType, Bits, Gauge32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "TimeTicks", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "NotificationType", "Bits", "Gauge32", "iso", "ModuleIdentity")
TimeStamp, DateAndTime, DisplayString, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DateAndTime", "DisplayString", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmSysOperStatus=slmSysOperStatus, slmSwRevTable=slmSwRevTable, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmSyslogLevel=slmSyslogLevel, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassEntry=slmChPassEntry, slmAdmin=slmAdmin, slmLicenseIndex=slmLicenseIndex, slmTrapCommunity=slmTrapCommunity, slmChPass=slmChPass, slmSwRevEntry=slmSwRevEntry, slmSyslogPort=slmSyslogPort, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, slmSysName=slmSysName, slmAuthLogin=slmAuthLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmSysAlmDeact=slmSysAlmDeact, slmSwRevStatus=slmSwRevStatus, slmChPassOldPass=slmChPassOldPass, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmTrapLogParam5=slmTrapLogParam5, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestEntry=slmSyslogDestEntry, UserPassword=UserPassword, UserLogin=UserLogin, slmConfigSysUptime=slmConfigSysUptime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmTrapLogParam4=slmTrapLogParam4, slmRebootDelay=slmRebootDelay, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmConfigFile=slmConfigFile, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogId=slmTrapLogId, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slMain=slMain, slm40GConf=slm40GConf, slmSysChassisId=slmSysChassisId, slmChPassTable=slmChPassTable, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmAdminEntry=slmAdminEntry, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLogFile=slmLogFile, slmWriteCommunity=slmWriteCommunity, slmPmAvailable=slmPmAvailable, slmSys=slmSys, slmPsuNumber=slmPsuNumber, slmAdminTable=slmAdminTable, slmOemType=slmOemType, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmTrapLogParam2=slmTrapLogParam2, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, slmTrap=slmTrap, slmRstpEnabled=slmRstpEnabled, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam6=slmTrapLogParam6, slmSysMode=slmSysMode)
