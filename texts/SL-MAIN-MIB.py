...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress, Opaque, Bits, Gauge32, Counter32, ObjectIdentity, Unsigned32, NotificationType, Integer32, TimeTicks, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress", "Opaque", "Bits", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "NotificationType", "Integer32", "TimeTicks", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmRstpEnabled=slmRstpEnabled, slmSysChassisId=slmSysChassisId, slmTrapSysNameChange=slmTrapSysNameChange, AdminAccess=AdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmLogin=slmLogin, slmSysName=slmSysName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassLogin=slmChPassLogin, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapCommunity=slmTrapCommunity, slmPmAvailable=slmPmAvailable, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, SoftwareRevision=SoftwareRevision, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmConfigFile=slmConfigFile, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogPort=slmSyslogPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmSyslogLevel=slmSyslogLevel, slmAuthEntry=slmAuthEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmSysLocation=slmSysLocation, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Priv=slmSnmpv3Priv, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrap=slmTrap, slmAdminEntry=slmAdminEntry, slmWriteCommunity=slmWriteCommunity, slmChPass=slmChPass, slmOemType=slmOemType, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestTable=slmSyslogDestTable, slmSwRevName=slmSwRevName, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmAuthCommunity=slmAuthCommunity, slmPsuNumber=slmPsuNumber, slmEdfaNumber=slmEdfaNumber, slmSwRevStatus=slmSwRevStatus, slmAdmin=slmAdmin, slmSwRevDate=slmSwRevDate, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slMain=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthPassword=slmAuthPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam1=slmTrapLogParam1, slmTrapEnable=slmTrapEnable, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmTid=slmTid, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, UserPassword=UserPassword, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmTrapLogParam3=slmTrapLogParam3, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAdminStatus=slmSysAdminStatus, slmLicense=slmLicense, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Password=slmSnmpv3Password, slm40GConf=slm40GConf, slmTrapLogParam6=slmTrapLogParam6)
