...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Counter64, Gauge32, ModuleIdentity, Integer32, Opaque, Counter32, iso, Bits, ObjectIdentity, IpAddress, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32", "ModuleIdentity", "Integer32", "Opaque", "Counter32", "iso", "Bits", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysCalendarTime=slmSysCalendarTime, slmSyslogLevel=slmSyslogLevel, slmTrapLogId=slmTrapLogId, slmAuth=slmAuth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicense=slmLicense, slmPsuNumber=slmPsuNumber, slmAdmin=slmAdmin, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Priv=slmSnmpv3Priv, slmRebootDelay=slmRebootDelay, slmSys=slmSys, slmTrapPort=slmTrapPort, slMain=slMain, slmSysTrapFormat=slmSysTrapFormat, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, AdminAccess=AdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmTrapDestTable=slmTrapDestTable, slmSysMode=slmSysMode, slmTrapLogParam3=slmTrapLogParam3, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmSysChassisId=slmSysChassisId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmBoxSize=slmBoxSize, slmMuxNumber=slmMuxNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmAdminCommunity=slmAdminCommunity, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmNetworkMode=slmNetworkMode, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmTid=slmTid, slmTrap=slmTrap, slmWriteCommunity=slmWriteCommunity, UserPassword=UserPassword, slmSyslogPort=slmSyslogPort, slmChPass=slmChPass, SoftwareRevision=SoftwareRevision, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevTable=slmSwRevTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseId=slmLicenseId, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmSysName=slmSysName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassEntry=slmChPassEntry, slmChPassOldPass=slmChPassOldPass, slmAuthLogin=slmAuthLogin, slmAuthCommunity=slmAuthCommunity, slmSysOperStatus=slmSysOperStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysIpAddr=slmSysIpAddr, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, UserCommunity=UserCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminEntry=slmAdminEntry, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmChPassTable=slmChPassTable, slmSysTemperature=slmSysTemperature, slmSysAdminStatus=slmSysAdminStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmAdminAccess=slmAdminAccess, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmSysSnmpVersion=slmSysSnmpVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin)
