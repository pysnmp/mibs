...
iso, NotificationType, Gauge32, ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, TimeTicks, Bits, Unsigned32, MibIdentifier, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "TimeTicks", "Bits", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmSyslogDestIpAddress=slmSyslogDestIpAddress, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmSysSubnetMask=slmSysSubnetMask, slmSyslogLevel=slmSyslogLevel, slmSwRevStatus=slmSwRevStatus, UserLogin=UserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseTable=slmLicenseTable, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogEntry=slmTrapLogEntry, slmTid=slmTid, slmSysName=slmSysName, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevEntry=slmSwRevEntry, slmEdfaNumber=slmEdfaNumber, slmSwRevDate=slmSwRevDate, slmTrapLogParam5=slmTrapLogParam5, slmSwRevName=slmSwRevName, slmTrapLogParam2=slmTrapLogParam2, slmSysAdminStatus=slmSysAdminStatus, UserPassword=UserPassword, slmTrapUserAccess=slmTrapUserAccess, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmSyslogDestTable=slmSyslogDestTable, slmSwRevDirectory=slmSwRevDirectory, slmSysUplinkRate=slmSysUplinkRate, slmSysLanIpAddr=slmSysLanIpAddr, slmSysResetPm=slmSysResetPm, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam6=slmTrapLogParam6, slmRstpEnabled=slmRstpEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmWriteCommunity=slmWriteCommunity, slmLogin=slmLogin, slmTrapPort=slmTrapPort, slmSysChassisId=slmSysChassisId, slmTrapLogParam1=slmTrapLogParam1, slmChPassTable=slmChPassTable, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmConfigFile=slmConfigFile, PYSNMP_MODULE_ID=slMain, slmTrapEnable=slmTrapEnable, slmChPassEntry=slmChPassEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserLogin=slmTrapUserLogin, slmBoxSize=slmBoxSize, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminTable=slmAdminTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmPortsNumber=slmPortsNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthTable=slmAuthTable, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmAuthCommunity=slmAuthCommunity, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmTrapSysLocationChange=slmTrapSysLocationChange, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, slmSysMode=slmSysMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, UserCommunity=UserCommunity, slmLicense=slmLicense, slmTrapLogName=slmTrapLogName, slmSysAlmDeact=slmSysAlmDeact, slmPsuNumber=slmPsuNumber, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmChPassOldPass=slmChPassOldPass, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmChPassNewPass=slmChPassNewPass, slmSysIpAddr=slmSysIpAddr, slmAuth=slmAuth, slmAdminCommunity=slmAdminCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmRebootDelay=slmRebootDelay, slmTrapLogTable=slmTrapLogTable, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLocation=slmSysLocation, slmLogFile=slmLogFile, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask)
