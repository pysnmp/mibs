...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter32, Counter64, ModuleIdentity, Bits, IpAddress, Opaque, ObjectIdentity, TimeTicks, MibIdentifier, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter32", "Counter64", "ModuleIdentity", "Bits", "IpAddress", "Opaque", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSubnetMask=slmSysSubnetMask, slmAdmin=slmAdmin, slmMuxNumber=slmMuxNumber, slm40GConf=slm40GConf, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysName=slmSysName, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminAccess=slmAdminAccess, slmTrapLogParam4=slmTrapLogParam4, slmChPassOldPass=slmChPassOldPass, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestAddress=slmTrapDestAddress, slmAdminCommunity=slmAdminCommunity, slmSwRevName=slmSwRevName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmSwRevTable=slmSwRevTable, slmLogin=slmLogin, slmSyslogLevel=slmSyslogLevel, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slmSnmpv3Password=slmSnmpv3Password, slmRebootDelay=slmRebootDelay, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmWriteCommunity=slmWriteCommunity, slmTrapDestTable=slmTrapDestTable, slmSysAlmDeact=slmSysAlmDeact, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmReadCommunity=slmReadCommunity, slmAdminRowStatus=slmAdminRowStatus, slmAuthPassword=slmAuthPassword, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmAdminEntry=slmAdminEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, PYSNMP_MODULE_ID=slMain, slmConfigFile=slmConfigFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, slmLicenseIndex=slmLicenseIndex, slmTrap=slmTrap, slmTrapDestEntry=slmTrapDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmAuthTable=slmAuthTable, slmSysTrapFormat=slmSysTrapFormat, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmTrapLogName=slmTrapLogName, slmTrapEnable=slmTrapEnable, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmChPassEntry=slmChPassEntry, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slmSyslogDestAddress=slmSyslogDestAddress, slmPsuNumber=slmPsuNumber, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogEntry=slmTrapLogEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmAuthEntry=slmAuthEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, slMain=slMain, slmChPassLogin=slmChPassLogin, slmChPassTable=slmChPassTable, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapPort=slmTrapPort, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmEdfaNumber=slmEdfaNumber, slmSysAlmAct=slmSysAlmAct, slmSysResetPm=slmSysResetPm, slmSyslogPort=slmSyslogPort, SoftwareRevision=SoftwareRevision, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEncryptionCapability=slmSysEncryptionCapability)
