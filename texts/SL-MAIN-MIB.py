...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogId=slmTrapLogId, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmSysAdminStatus=slmSysAdminStatus, slmLicenseId=slmLicenseId, slmTopologyEnabled=slmTopologyEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserLogin=UserLogin, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysCalendarTime=slmSysCalendarTime, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, UserCommunity=UserCommunity, slmTrap=slmTrap, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogName=slmTrapLogName, slmOpticalSwitchExist=slmOpticalSwitchExist, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmAuthEntry=slmAuthEntry, slmChPass=slmChPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmChPassEntry=slmChPassEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmTrapCommunity=slmTrapCommunity, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmPmAvailable=slmPmAvailable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigFile=slmConfigFile, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slm40GConf=slm40GConf, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmSwRevTable=slmSwRevTable, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam4=slmTrapLogParam4, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, AdminAccess=AdminAccess, slmAdminAccess=slmAdminAccess, slmWriteCommunity=slmWriteCommunity, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthTable=slmAuthTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmSysAlmAct=slmSysAlmAct, slmAdmin=slmAdmin, slmTid=slmTid, slmSysTrapFormat=slmSysTrapFormat, slmLicenseEntry=slmLicenseEntry, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, slmLicenseIndex=slmLicenseIndex, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysMode=slmSysMode, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmSysOperStatus=slmSysOperStatus, slmPsuNumber=slmPsuNumber, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmTrapLogTable=slmTrapLogTable, slmAdminEntry=slmAdminEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmEdfaNumber=slmEdfaNumber, slmBoxSize=slmBoxSize, slmSys=slmSys, PYSNMP_MODULE_ID=slMain, slmSwRevEntry=slmSwRevEntry, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmTrapEnable=slmTrapEnable, slmSwRevName=slmSwRevName, slmSysUplinkRate=slmSysUplinkRate)
