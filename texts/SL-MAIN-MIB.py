...
Counter32, Opaque, IpAddress, MibIdentifier, ObjectIdentity, iso, Bits, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, NotificationType, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Opaque", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Bits", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity", "Unsigned32")
DisplayString, TimeStamp, DateAndTime, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "DateAndTime", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmSwRevDirectory=slmSwRevDirectory, slmAdminAccess=slmAdminAccess, slmSysLocation=slmSysLocation, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Password=slmSnmpv3Password, slmPortsNumber=slmPortsNumber, slmSysMode=slmSysMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDate=slmSwRevDate, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmOemType=slmOemType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmLicenseExpiration=slmLicenseExpiration, slmChPassNewPass=slmChPassNewPass, slmWriteCommunity=slmWriteCommunity, slmChPassLogin=slmChPassLogin, slmAuth=slmAuth, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam1=slmTrapLogParam1, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmTrapDestTable=slmTrapDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmSwRevTable=slmSwRevTable, AdminAccess=AdminAccess, slmAuthLogin=slmAuthLogin, slmSysUplinkRate=slmSysUplinkRate, UserCommunity=UserCommunity, slmMuxNumber=slmMuxNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmTrapLogTable=slmTrapLogTable, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmTrapUserAccess=slmTrapUserAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevStatus=slmSwRevStatus, slmNetworkMode=slmNetworkMode, slmTrapPort=slmTrapPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogName=slmTrapLogName, slmChPassEntry=slmChPassEntry, slmAuthPassword=slmAuthPassword, slmSysCalendarTime=slmSysCalendarTime, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysResetPm=slmSysResetPm, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmSysTrapFormat=slmSysTrapFormat, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmEdfaNumber=slmEdfaNumber, slmPsuNumber=slmPsuNumber, slmAdminCommunity=slmAdminCommunity, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmChPass=slmChPass, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmPmAvailable=slmPmAvailable, slmSysTemperature=slmSysTemperature, slmSysLanIpAddr=slmSysLanIpAddr, slMain=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrap=slmTrap, slmConfigFile=slmConfigFile, slmSysAlmDeact=slmSysAlmDeact, slmAdminEntry=slmAdminEntry, slmSysName=slmSysName, slmAdmin=slmAdmin, slmAdminTable=slmAdminTable, slm40GConf=slm40GConf, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestEntry=slmSyslogDestEntry)
