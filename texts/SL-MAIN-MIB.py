...
Counter64, IpAddress, Gauge32, NotificationType, TimeTicks, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, iso, Counter32, ModuleIdentity, Unsigned32, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Gauge32", "NotificationType", "TimeTicks", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "iso", "Counter32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "ObjectIdentity")
DisplayString, DateAndTime, TimeStamp, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevEntry=slmSwRevEntry, slmTrapDestTable=slmTrapDestTable, slmPortsNumber=slmPortsNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthPassword=slmAuthPassword, slmWriteCommunity=slmWriteCommunity, slmPsuNumber=slmPsuNumber, AdminAccess=AdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmChPassNewPass=slmChPassNewPass, slmTrapPort=slmTrapPort, slmSwRevDate=slmSwRevDate, slmLicenseId=slmLicenseId, slmTrapUserLogin=slmTrapUserLogin, slmAuthCommunity=slmAuthCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogPort=slmSyslogPort, slmChPassLogin=slmChPassLogin, slmAdminTable=slmAdminTable, slmLicenseEntry=slmLicenseEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRebootDelay=slmRebootDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmAdminCommunity=slmAdminCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin, slmTrapLogName=slmTrapLogName, slmTrapLogEntry=slmTrapLogEntry, slmLogFile=slmLogFile, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestCommunity=slmTrapDestCommunity, slmMuxNumber=slmMuxNumber, slmTrapLogId=slmTrapLogId, slmAdminPassword=slmAdminPassword, slmSysSnmpVersion=slmSysSnmpVersion, slMain=slMain, slmPmAvailable=slmPmAvailable, slmTrapLogParam4=slmTrapLogParam4, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam5=slmTrapLogParam5, slmTid=slmTid, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapEnable=slmTrapEnable, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmAct=slmSysAlmAct, slmLicense=slmLicense, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmLogin=slmLogin, slmSyslogLevel=slmSyslogLevel, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmSysOperStatus=slmSysOperStatus, slmSysUplinkRate=slmSysUplinkRate, slmEdfaNumber=slmEdfaNumber, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slmSwRevStatus=slmSwRevStatus, slmAdminRowStatus=slmAdminRowStatus, slmSysChassisId=slmSysChassisId, slmOemType=slmOemType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevName=slmSwRevName, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, slmChPassEntry=slmChPassEntry, slmSys=slmSys, slmBoxSize=slmBoxSize, UserLogin=UserLogin, slmSysTrapFormat=slmSysTrapFormat, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmSysSubnetMask=slmSysSubnetMask, slmAdmin=slmAdmin, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmSyslogDestTable=slmSyslogDestTable, slmVcatDelay=slmVcatDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, SoftwareRevision=SoftwareRevision, slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmSysTemperature=slmSysTemperature, slmChPassTable=slmChPassTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable)
