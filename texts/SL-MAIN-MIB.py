...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassTable=slmChPassTable, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLocation=slmSysLocation, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmSwRevName=slmSwRevName, slmSnmpv3Priv=slmSnmpv3Priv, slmSysChassisId=slmSysChassisId, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestTable=slmTrapDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigFile=slmConfigFile, slmTrapLogParam5=slmTrapLogParam5, SoftwareRevision=SoftwareRevision, slmAuthCommunity=slmAuthCommunity, slm40GConf=slm40GConf, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminLogin=slmAdminLogin, slmConfigSysUptime=slmConfigSysUptime, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmReadCommunity=slmReadCommunity, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmVcatDelay=slmVcatDelay, slmLicenseId=slmLicenseId, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevStatus=slmSwRevStatus, slmSysTemperature=slmSysTemperature, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSys=slmSys, slmLicense=slmLicense, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmSwRevTable=slmSwRevTable, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, PYSNMP_MODULE_ID=slMain, slmSysIpAddr=slmSysIpAddr, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmSysMode=slmSysMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmAuthTable=slmAuthTable, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestEntry=slmSyslogDestEntry, slmLogFile=slmLogFile, slmTrapLogName=slmTrapLogName, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmLicenseEntry=slmLicenseEntry, UserLogin=UserLogin, UserCommunity=UserCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmAuthLogin=slmAuthLogin, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmRebootDelay=slmRebootDelay, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmMuxNumber=slmMuxNumber, slmOemType=slmOemType, slmSyslogLevel=slmSyslogLevel, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Password=slmSnmpv3Password, slmPortsNumber=slmPortsNumber, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmTrapDestEntry=slmTrapDestEntry, slmAdminPassword=slmAdminPassword, slmTrapLogId=slmTrapLogId, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity)
