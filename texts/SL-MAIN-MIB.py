...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicense=slmLicense, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmTrapLogParam4=slmTrapLogParam4, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, AdminAccess=AdminAccess, slmTrapPort=slmTrapPort, slmSysChassisId=slmSysChassisId, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmChPassEntry=slmChPassEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam3=slmTrapLogParam3, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmSysCalendarTime=slmSysCalendarTime, slmSysName=slmSysName, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmReadCommunity=slmReadCommunity, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmEdfaNumber=slmEdfaNumber, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmChPassNewPass=slmChPassNewPass, slmSysMode=slmSysMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSys=slmSys, slmPmAvailable=slmPmAvailable, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmAct=slmSysAlmAct, slmAdminTable=slmAdminTable, slmConfigSysSignalType=slmConfigSysSignalType, slmOpticalSwitchExist=slmOpticalSwitchExist, slmRebootDelay=slmRebootDelay, slmSysAdminStatus=slmSysAdminStatus, slmAdminAccess=slmAdminAccess, slmTrapLogTable=slmTrapLogTable, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDate=slmSwRevDate, slmChPass=slmChPass, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevName=slmSwRevName, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmWriteCommunity=slmWriteCommunity, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmLicenseIndex=slmLicenseIndex, slmSysUplinkRate=slmSysUplinkRate, slmSwRevEntry=slmSwRevEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmLicenseId=slmLicenseId, UserPassword=UserPassword, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmAuthEntry=slmAuthEntry, UserCommunity=UserCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRstpEnabled=slmRstpEnabled, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled)
