...
Counter64, Bits, Counter32, IpAddress, Unsigned32, NotificationType, MibIdentifier, Integer32, ObjectIdentity, iso, Opaque, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Counter32", "IpAddress", "Unsigned32", "NotificationType", "MibIdentifier", "Integer32", "ObjectIdentity", "iso", "Opaque", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmLogin=slmLogin, AdminAccess=AdminAccess, slmTrapDestTable=slmTrapDestTable, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam6=slmTrapLogParam6, slmSwRevTable=slmSwRevTable, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, UserLogin=UserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysOperStatus=slmSysOperStatus, slmConfigFile=slmConfigFile, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSys=slmSys, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTemperature=slmSysTemperature, slmAdminPassword=slmAdminPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slm40GConf=slm40GConf, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, slmTrapDestEntry=slmTrapDestEntry, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmTrapPort=slmTrapPort, slmVcatDelay=slmVcatDelay, slmLicenseId=slmLicenseId, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogEntry=slmTrapLogEntry, slmAdminAccess=slmAdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, PYSNMP_MODULE_ID=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmAuthTable=slmAuthTable, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminCommunity=slmAdminCommunity, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slmLicense=slmLicense, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, slmAdminRowStatus=slmAdminRowStatus, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmRebootDelay=slmRebootDelay, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmPmAvailable=slmPmAvailable, slMain=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmAdminEntry=slmAdminEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, slmSysMode=slmSysMode, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmSysUplinkRate=slmSysUplinkRate, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTrapFormat=slmSysTrapFormat, slmSysSubnetMask=slmSysSubnetMask, slmSysChassisId=slmSysChassisId, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmAct=slmSysAlmAct, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
