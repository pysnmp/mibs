...
Counter64, MibIdentifier, Opaque, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Gauge32, iso, Integer32, ModuleIdentity, Unsigned32, NotificationType, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "Opaque", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Gauge32", "iso", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmLicenseEntry=slmLicenseEntry, slmRstpEnabled=slmRstpEnabled, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmTrapEnable=slmTrapEnable, slmChPassOldPass=slmChPassOldPass, slmSwRevTable=slmSwRevTable, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, UserPassword=UserPassword, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayAddr=slmSysGatewayAddr, slmSysResetPm=slmSysResetPm, slmSwRevEntry=slmSwRevEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthPassword=slmAuthPassword, slmSysIpAddr=slmSysIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmSysTemperature=slmSysTemperature, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPmAvailable=slmPmAvailable, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmSysMode=slmSysMode, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmSys=slmSys, slmTrapDestAddress=slmTrapDestAddress, slmTid=slmTid, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPass=slmChPass, slmSyslogLevel=slmSyslogLevel, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmPsuNumber=slmPsuNumber, slmAdmin=slmAdmin, UserCommunity=UserCommunity, slmSysName=slmSysName, slmAuth=slmAuth, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmBoxSize=slmBoxSize, slmTrapLogName=slmTrapLogName, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, slmAdminLogin=slmAdminLogin, slmSysSubnetMask=slmSysSubnetMask, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam3=slmTrapLogParam3, PYSNMP_MODULE_ID=slMain, slmSwRevDirectory=slmSwRevDirectory, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmLicenseTable=slmLicenseTable, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmSysCalendarTime=slmSysCalendarTime, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigFile=slmConfigFile, slmLogin=slmLogin, slmSwRevDate=slmSwRevDate, slmTrapDestEntry=slmTrapDestEntry, slmVcatDelay=slmVcatDelay, slmSwRevStatus=slmSwRevStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmChPassLogin=slmChPassLogin, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmAdminPassword=slmAdminPassword, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmSnmpv3Auth=slmSnmpv3Auth, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr)
