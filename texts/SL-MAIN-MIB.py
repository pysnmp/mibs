...
NotificationType, IpAddress, Counter64, Opaque, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ModuleIdentity, Bits, Unsigned32, ObjectIdentity, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "Opaque", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ModuleIdentity", "Bits", "Unsigned32", "ObjectIdentity", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmEdfaNumber=slmEdfaNumber, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestAddress=slmTrapDestAddress, slmAuth=slmAuth, slmSysEncryptionCapability=slmSysEncryptionCapability, slm40GConf=slm40GConf, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminLogin=slmAdminLogin, slmAuthEntry=slmAuthEntry, slmConfigSysSignalType=slmConfigSysSignalType, AdminAccess=AdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestIpAddress=slmTrapDestIpAddress, slMain=slMain, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmOemType=slmOemType, slmSys=slmSys, slmSyslogLevel=slmSyslogLevel, slmChPassOldPass=slmChPassOldPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserLogin=slmTrapUserLogin, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmTrapLogEntry=slmTrapLogEntry, slmPmAvailable=slmPmAvailable, slmTrapLogName=slmTrapLogName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysNameChange=slmTrapSysNameChange, slmPsuNumber=slmPsuNumber, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmSysLanIpAddr=slmSysLanIpAddr, UserLogin=UserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDate=slmSwRevDate, slmAuthCommunity=slmAuthCommunity, slmLogFile=slmLogFile, slmSysAdminStatus=slmSysAdminStatus, slmAdminEntry=slmAdminEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slmSwRevStatus=slmSwRevStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, slmChPassNewPass=slmChPassNewPass, slmConfigSysUptime=slmConfigSysUptime, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmChPassEntry=slmChPassEntry, slmTopologyEnabled=slmTopologyEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysCalendarTime=slmSysCalendarTime, slmSysTrapFormat=slmSysTrapFormat, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassLogin=slmChPassLogin, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDirectory=slmSwRevDirectory, slmLogin=slmLogin, slmAdminPassword=slmAdminPassword, slmBoxSize=slmBoxSize, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slmSysLocation=slmSysLocation, slmTrapLogParam3=slmTrapLogParam3, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmTrapPort=slmTrapPort, slmTid=slmTid, slmChPass=slmChPass, slmTrapEnable=slmTrapEnable, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmChPassTable=slmChPassTable, slmSysOperStatus=slmSysOperStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdmin=slmAdmin, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmAdminTable=slmAdminTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmRebootDelay=slmRebootDelay, PYSNMP_MODULE_ID=slMain, slmReadCommunity=slmReadCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysName=slmSysName)
