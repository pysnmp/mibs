...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmSwRevStatus=slmSwRevStatus, slmLicenseTable=slmLicenseTable, slmTrapCommunity=slmTrapCommunity, slMain=slMain, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, slmSysIpAddr=slmSysIpAddr, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmAdmin=slmAdmin, slmTrapLogTable=slmTrapLogTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevName=slmSwRevName, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmLogFile=slmLogFile, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmAuthTable=slmAuthTable, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogin=slmLogin, slm40GConf=slm40GConf, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slmTrapLogName=slmTrapLogName, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmSysTrapFormat=slmSysTrapFormat, slmLicenseExpiration=slmLicenseExpiration, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmBoxSize=slmBoxSize, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserAccess=slmTrapUserAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam1=slmTrapLogParam1, slmAuthEntry=slmAuthEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrap=slmTrap, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigFile=slmConfigFile, slmRebootDelay=slmRebootDelay, slmSysResetPm=slmSysResetPm, slmChPassEntry=slmChPassEntry, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapEnable=slmTrapEnable, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminAccess=slmAdminAccess, slmSysLocation=slmSysLocation, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, slmLicenseId=slmLicenseId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPsuNumber=slmPsuNumber, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmNetworkMode=slmNetworkMode, slmSysChassisId=slmSysChassisId, slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmAdminPassword=slmAdminPassword, slmSwRevTable=slmSwRevTable, slmTrapUserLogin=slmTrapUserLogin, slmSysMode=slmSysMode, slmSyslogPort=slmSyslogPort, slmSysOperStatus=slmSysOperStatus, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthPassword=slmAuthPassword, slmAdminEntry=slmAdminEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmTrapSysNameChange=slmTrapSysNameChange, AdminAccess=AdminAccess, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion)
