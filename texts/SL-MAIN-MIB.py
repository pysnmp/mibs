...
Integer32, Unsigned32, MibIdentifier, iso, ModuleIdentity, ObjectIdentity, Gauge32, TimeTicks, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, IpAddress, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity", "ObjectIdentity", "Gauge32", "TimeTicks", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "IpAddress", "Counter64", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysName=slmSysName, slmMuxNumber=slmMuxNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmTrapDestEntry=slmTrapDestEntry, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSysUplinkRate=slmSysUplinkRate, slmChPass=slmChPass, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmAuthTable=slmAuthTable, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseId=slmLicenseId, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmSysAlmAct=slmSysAlmAct, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmSysChassisId=slmSysChassisId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmSysMode=slmSysMode, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassLogin=slmChPassLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmTrapUserLogin=slmTrapUserLogin, slmReadCommunity=slmReadCommunity, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminEntry=slmAdminEntry, slmSwRevStatus=slmSwRevStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmRebootDelay=slmRebootDelay, slmSwRevDirectory=slmSwRevDirectory, slMain=slMain, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmNetworkMode=slmNetworkMode, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmPmAvailable=slmPmAvailable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLocation=slmSysLocation, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, UserLogin=UserLogin, UserPassword=UserPassword, slmTrapLogParam5=slmTrapLogParam5, UserCommunity=UserCommunity, slmAdminLogin=slmAdminLogin, slmAuth=slmAuth, slmTrapEnable=slmTrapEnable, slmTrapCommunity=slmTrapCommunity, slmSyslogLevel=slmSyslogLevel, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmAdminPassword=slmAdminPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseTable=slmLicenseTable, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmSysResetPm=slmSysResetPm, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmAdmin=slmAdmin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam3=slmTrapLogParam3, slmSysIpAddr=slmSysIpAddr, slmAdminTable=slmAdminTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogFile=slmLogFile, slmSwRevDate=slmSwRevDate)
