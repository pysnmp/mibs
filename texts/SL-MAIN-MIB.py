...
iso, MibIdentifier, Opaque, Counter64, ModuleIdentity, Integer32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter32, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Opaque", "Counter64", "ModuleIdentity", "Integer32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "TimeTicks", "IpAddress")
DisplayString, TimeStamp, TextualConvention, RowStatus, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "RowStatus", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevStatus=slmSwRevStatus, slmTrapLogName=slmTrapLogName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, UserPassword=UserPassword, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmTrapLogParam2=slmTrapLogParam2, slmChPassNewPass=slmChPassNewPass, slmSwRevName=slmSwRevName, slmAdminLogin=slmAdminLogin, slmSysOperStatus=slmSysOperStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmSwRevDate=slmSwRevDate, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserLogin=slmTrapUserLogin, slmSysLanIpAddr=slmSysLanIpAddr, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, PYSNMP_MODULE_ID=slMain, slmTrapDestEntry=slmTrapDestEntry, slmSysTemperature=slmSysTemperature, slmSysIpAddr=slmSysIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmLicense=slmLicense, slmVcatDelay=slmVcatDelay, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmChPassLogin=slmChPassLogin, slmTrapLogParam4=slmTrapLogParam4, slmAdminEntry=slmAdminEntry, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, slmSysAdminStatus=slmSysAdminStatus, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmSysLocation=slmSysLocation, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseIndex=slmLicenseIndex, slmSwRevDirectory=slmSwRevDirectory, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmTrapDestAddress=slmTrapDestAddress, slmAuthPassword=slmAuthPassword, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayAddr=slmSysGatewayAddr, slmPsuNumber=slmPsuNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPmAvailable=slmPmAvailable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam3=slmTrapLogParam3, UserLogin=UserLogin, slmSysName=slmSysName, slmAuthLogin=slmAuthLogin, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassEntry=slmChPassEntry, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmTrapLogEntry=slmTrapLogEntry, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, slmSysTrapFormat=slmSysTrapFormat, slmAdminAccess=slmAdminAccess, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmTrapUserAccess=slmTrapUserAccess, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, slmSnmpv3Password=slmSnmpv3Password, slmSyslogPort=slmSyslogPort, slmAdminCommunity=slmAdminCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmTid=slmTid, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthCommunity=slmAuthCommunity)
