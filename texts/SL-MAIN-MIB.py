...
iso, NotificationType, Unsigned32, Counter32, Bits, Counter64, IpAddress, ModuleIdentity, ObjectIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Unsigned32", "Counter32", "Bits", "Counter64", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam4=slmTrapLogParam4, slmLicense=slmLicense, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmAdminEntry=slmAdminEntry, slmAuth=slmAuth, slMain=slMain, slmAuthPassword=slmAuthPassword, slmChPassTable=slmChPassTable, slmSys=slmSys, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, slmSyslogPort=slmSyslogPort, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmAdminTable=slmAdminTable, slmTrapDestEntry=slmTrapDestEntry, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, UserLogin=UserLogin, slmTrapEnable=slmTrapEnable, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTable=slmTrapLogTable, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogEntry=slmTrapLogEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseExpiration=slmLicenseExpiration, slmAdminRowStatus=slmAdminRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminCommunity=slmAdminCommunity, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, SoftwareRevision=SoftwareRevision, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmSysActiveSwVersion=slmSysActiveSwVersion, slmBoxSize=slmBoxSize, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, slmAuthEntry=slmAuthEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLocation=slmSysLocation, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigFile=slmConfigFile, slmTrap=slmTrap, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmAuthTable=slmAuthTable, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthLogin=slmAuthLogin, UserPassword=UserPassword, slmSwRevDate=slmSwRevDate, slmOemType=slmOemType, slmTrapLogParam6=slmTrapLogParam6, AdminAccess=AdminAccess, slmSysIpAddr=slmSysIpAddr, slmSwRevName=slmSwRevName, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysResetPm=slmSysResetPm, slmAdmin=slmAdmin, slmTrapLogName=slmTrapLogName, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassNewPass=slmChPassNewPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slm40GConf=slm40GConf, slmChPass=slmChPass, slmSwRevStatus=slmSwRevStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber)
