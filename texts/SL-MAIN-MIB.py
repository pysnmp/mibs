...
IpAddress, Integer32, TimeTicks, iso, Bits, Counter32, Counter64, MibIdentifier, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "TimeTicks", "iso", "Bits", "Counter32", "Counter64", "MibIdentifier", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slMain=slMain, slmTid=slmTid, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmAct=slmSysAlmAct, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, slmTrapLogTable=slmTrapLogTable, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam3=slmTrapLogParam3, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmAdmin=slmAdmin, slmConfigFile=slmConfigFile, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseId=slmLicenseId, slmAuthCommunity=slmAuthCommunity, slmSwRevName=slmSwRevName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam4=slmTrapLogParam4, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber, slmBoxSize=slmBoxSize, slmSysTrapFormat=slmSysTrapFormat, slmSysAdminStatus=slmSysAdminStatus, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSys=slmSys, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, SoftwareRevision=SoftwareRevision, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmChPassTable=slmChPassTable, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmAuthLogin=slmAuthLogin, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmSysOperStatus=slmSysOperStatus, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, slmReadCommunity=slmReadCommunity, PYSNMP_MODULE_ID=slMain, slmTrapDestTable=slmTrapDestTable, slmTrapUserLogin=slmTrapUserLogin, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmAuthEntry=slmAuthEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogName=slmTrapLogName, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmAdminRowStatus=slmAdminRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevStatus=slmSwRevStatus, UserCommunity=UserCommunity, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPass=slmChPass, slmLicenseIndex=slmLicenseIndex, slmLicenseTable=slmLicenseTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmOpticalSwitchExist=slmOpticalSwitchExist, slmRstpEnabled=slmRstpEnabled, slmAdminPassword=slmAdminPassword, slmSyslogLevel=slmSyslogLevel, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminCommunity=slmAdminCommunity, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapCommunity=slmTrapCommunity, slmSysMode=slmSysMode, slmAdminEntry=slmAdminEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable)
