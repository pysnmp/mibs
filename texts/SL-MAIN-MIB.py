...
ModuleIdentity, MibIdentifier, Counter64, Counter32, Integer32, Opaque, ObjectIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, iso, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Counter64", "Counter32", "Integer32", "Opaque", "ObjectIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "iso", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevName=slmSwRevName, slmTrapLogParam6=slmTrapLogParam6, slmSwRevTable=slmSwRevTable, slmSysOperStatus=slmSysOperStatus, slmTrapLogTable=slmTrapLogTable, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysName=slmSysName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmTrapLogParam1=slmTrapLogParam1, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmSwRevEntry=slmSwRevEntry, slmTrapCommunity=slmTrapCommunity, UserLogin=UserLogin, UserCommunity=UserCommunity, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmChPass=slmChPass, slmSysSubnetMask=slmSysSubnetMask, AdminAccess=AdminAccess, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, PYSNMP_MODULE_ID=slMain, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam2=slmTrapLogParam2, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestTable=slmTrapDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmSysIpAddr=slmSysIpAddr, slmAuth=slmAuth, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmAdminCommunity=slmAdminCommunity, slmTrapPort=slmTrapPort, slmPsuNumber=slmPsuNumber, slmSysLocation=slmSysLocation, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slm40GConf=slm40GConf, slmChPassEntry=slmChPassEntry, slmSysChassisId=slmSysChassisId, slmSyslogDestAddress=slmSyslogDestAddress, slmBoxSize=slmBoxSize, slmTrapUserAccess=slmTrapUserAccess, slmReadCommunity=slmReadCommunity, slmAdminAccess=slmAdminAccess, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogName=slmTrapLogName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmAuthLogin=slmAuthLogin, slmMuxNumber=slmMuxNumber, slmAdminPassword=slmAdminPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicense=slmLicense, slmAuthTable=slmAuthTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmTid=slmTid, slmSysAlmDeact=slmSysAlmDeact, slmAdmin=slmAdmin, slmRstpEnabled=slmRstpEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDate=slmSwRevDate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmOemType=slmOemType, slmSysTemperature=slmSysTemperature, slmTrapUserLogin=slmTrapUserLogin, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmAdminTable=slmAdminTable, slmTrapEnable=slmTrapEnable, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmSysMode=slmSysMode, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogLevel=slmSyslogLevel, slmConfigSysUptime=slmConfigSysUptime, slmAdminLogin=slmAdminLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmNetworkMode=slmNetworkMode, slmLicenseTable=slmLicenseTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask)
