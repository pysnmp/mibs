...
Gauge32, ModuleIdentity, IpAddress, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, MibIdentifier, Opaque, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "MibIdentifier", "Opaque", "Counter32", "Counter64", "Integer32")
DateAndTime, TextualConvention, TruthValue, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "TruthValue", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysChassisId=slmSysChassisId, slmAuthPassword=slmAuthPassword, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthCommunity=slmAuthCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmLicense=slmLicense, slmSysSubnetMask=slmSysSubnetMask, slmSwRevStatus=slmSwRevStatus, slmLicenseIndex=slmLicenseIndex, slmSysIpAddr=slmSysIpAddr, slmAuthLogin=slmAuthLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmTrapLogParam4=slmTrapLogParam4, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassEntry=slmChPassEntry, slmTrapPort=slmTrapPort, slmPmAvailable=slmPmAvailable, slmMuxNumber=slmMuxNumber, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmSys=slmSys, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmAdmin=slmAdmin, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmAdminTable=slmAdminTable, slmTrapEnable=slmTrapEnable, slmTrapDestEntry=slmTrapDestEntry, UserPassword=UserPassword, slmSysResetPm=slmSysResetPm, AdminAccess=AdminAccess, slmSyslogLevel=slmSyslogLevel, UserLogin=UserLogin, slmVcatDelay=slmVcatDelay, slmAdminPassword=slmAdminPassword, slmTrapLogParam3=slmTrapLogParam3, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogName=slmTrapLogName, slmSysOperStatus=slmSysOperStatus, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmSysAlmDeact=slmSysAlmDeact, slmEdfaNumber=slmEdfaNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, PYSNMP_MODULE_ID=slMain, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slMain=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmLogin=slmLogin, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmNetworkMode=slmNetworkMode, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogId=slmTrapLogId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAdminStatus=slmSysAdminStatus, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmReadCommunity=slmReadCommunity, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthTable=slmAuthTable, slmTrapLogParam5=slmTrapLogParam5, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmSyslogPort=slmSyslogPort, slmChPassOldPass=slmChPassOldPass, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Password=slmSnmpv3Password)
