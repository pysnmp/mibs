...
Gauge32, Bits, ObjectIdentity, ModuleIdentity, iso, Counter64, TimeTicks, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Opaque, Counter32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "ObjectIdentity", "ModuleIdentity", "iso", "Counter64", "TimeTicks", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Opaque", "Counter32", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogin=slmLogin, slmSysAdminStatus=slmSysAdminStatus, UserPassword=UserPassword, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam6=slmTrapLogParam6, slmSysSubnetMask=slmSysSubnetMask, slmSwRevName=slmSwRevName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogPort=slmSyslogPort, slmSyslogLevel=slmSyslogLevel, slmSysCalendarTime=slmSysCalendarTime, slmSysIpAddr=slmSysIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestAddress=slmSyslogDestAddress, slmSysChassisId=slmSysChassisId, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slm40GConf=slm40GConf, UserCommunity=UserCommunity, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, PYSNMP_MODULE_ID=slMain, slmLogFile=slmLogFile, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmAdmin=slmAdmin, slMain=slMain, slmPmAvailable=slmPmAvailable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassEntry=slmChPassEntry, slmTrapUserAccess=slmTrapUserAccess, slmLicenseEntry=slmLicenseEntry, slmVcatDelay=slmVcatDelay, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, slmAdminCommunity=slmAdminCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserLogin=UserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestTable=slmSyslogDestTable, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slmReadCommunity=slmReadCommunity, AdminAccess=AdminAccess, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmAuthLogin=slmAuthLogin, slmTrapDestTable=slmTrapDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmEdfaNumber=slmEdfaNumber, slmBoxSize=slmBoxSize, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmTrap=slmTrap, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthPassword=slmAuthPassword, slmSysName=slmSysName, slmSysGatewayAddr=slmSysGatewayAddr, slmLicense=slmLicense, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseIndex=slmLicenseIndex, slmTrapLogId=slmTrapLogId, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmTid=slmTid, slmSwRevTable=slmSwRevTable, slmTrapEnable=slmTrapEnable, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmNetworkMode=slmNetworkMode, slmAuthTable=slmAuthTable, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSys=slmSys, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, SoftwareRevision=SoftwareRevision, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysUptime=slmConfigSysUptime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmAct=slmSysAlmAct)
