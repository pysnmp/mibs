...
Integer32, NotificationType, Counter32, Counter64, Opaque, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Bits, Unsigned32, IpAddress, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter32", "Counter64", "Opaque", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Bits", "Unsigned32", "IpAddress", "iso", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, slmAdminTable=slmAdminTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmSysLocation=slmSysLocation, slmTrapLogId=slmTrapLogId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmAct=slmSysAlmAct, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserAccess=slmTrapUserAccess, slmSyslogLevel=slmSyslogLevel, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestTable=slmTrapDestTable, slmLicenseExpiration=slmLicenseExpiration, slmAuthCommunity=slmAuthCommunity, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slMain=slMain, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmEdfaNumber=slmEdfaNumber, slmSysResetPm=slmSysResetPm, slmAdminCommunity=slmAdminCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slm40GConf=slm40GConf, slmLicense=slmLicense, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, slmNetworkMode=slmNetworkMode, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmPsuNumber=slmPsuNumber, slmTrapLogParam3=slmTrapLogParam3, slmSysSubnetMask=slmSysSubnetMask, slmOemType=slmOemType, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, SoftwareRevision=SoftwareRevision, UserCommunity=UserCommunity, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmTrapSysLocationChange=slmTrapSysLocationChange, PYSNMP_MODULE_ID=slMain, slmAdminLogin=slmAdminLogin, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmSysIpAddr=slmSysIpAddr, slmSysMode=slmSysMode, slmSysName=slmSysName, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmChPassTable=slmChPassTable, slmTrapPort=slmTrapPort, slmSwRevStatus=slmSwRevStatus, slmLicenseId=slmLicenseId, AdminAccess=AdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmChPass=slmChPass, slmAuth=slmAuth, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Password=slmSnmpv3Password, slmAuthLogin=slmAuthLogin, slmRebootDelay=slmRebootDelay, slmAdminEntry=slmAdminEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserLogin=UserLogin, slmTrapLogEntry=slmTrapLogEntry, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmChPassOldPass=slmChPassOldPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevName=slmSwRevName, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmMuxNumber=slmMuxNumber)
