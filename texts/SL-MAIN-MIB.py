...
TimeTicks, MibIdentifier, ObjectIdentity, Integer32, Gauge32, NotificationType, Opaque, ModuleIdentity, Counter64, IpAddress, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "Opaque", "ModuleIdentity", "Counter64", "IpAddress", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
RowStatus, DateAndTime, TruthValue, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseTable=slmLicenseTable, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmChPassOldPass=slmChPassOldPass, slmAuthEntry=slmAuthEntry, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Auth=slmSnmpv3Auth, slmWriteCommunity=slmWriteCommunity, slmChPassEntry=slmChPassEntry, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmSysAlmDeact=slmSysAlmDeact, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmAdminCommunity=slmAdminCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, UserCommunity=UserCommunity, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, slmOemType=slmOemType, slmAuth=slmAuth, slmChPass=slmChPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSysName=slmSysName, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, slmLogFile=slmLogFile, UserPassword=UserPassword, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTemperature=slmSysTemperature, slmChPassTable=slmChPassTable, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestTable=slmTrapDestTable, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmSwRevEntry=slmSwRevEntry, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDirectory=slmSwRevDirectory, slmSysCalendarTime=slmSysCalendarTime, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, AdminAccess=AdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTid=slmTid, slmSysUplinkRate=slmSysUplinkRate, slmSysLanIpAddr=slmSysLanIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam4=slmTrapLogParam4, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmTrapLogParam1=slmTrapLogParam1, slmAdminTable=slmAdminTable, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmTrapLogParam5=slmTrapLogParam5, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestCommunity=slmTrapDestCommunity, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmReadCommunity=slmReadCommunity, slmPortsNumber=slmPortsNumber, slmTrapLogParam6=slmTrapLogParam6, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmVcatDelay=slmVcatDelay, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable)
