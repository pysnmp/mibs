...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicense=slmLicense, slmTrapLogParam2=slmTrapLogParam2, slmTrap=slmTrap, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmChPassEntry=slmChPassEntry, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmOpticalSwitchExist=slmOpticalSwitchExist, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogName=slmTrapLogName, slmTrapUserLogin=slmTrapUserLogin, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmAuth=slmAuth, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevName=slmSwRevName, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmTrapDestAddress=slmTrapDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam5=slmTrapLogParam5, slmAuthTable=slmAuthTable, slmWriteCommunity=slmWriteCommunity, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmSysIpAddr=slmSysIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLocation=slmSysLocation, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassNewPass=slmChPassNewPass, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmSysAdminStatus=slmSysAdminStatus, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmPortsNumber=slmPortsNumber, slmLicenseIndex=slmLicenseIndex, slmAdminTable=slmAdminTable, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSubnetMask=slmSysSubnetMask, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slmTrapPort=slmTrapPort, slmTrapUserAccess=slmTrapUserAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmChPass=slmChPass, slmSysResetPm=slmSysResetPm, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseTable=slmLicenseTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogEntry=slmTrapLogEntry, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSyslogLevel=slmSyslogLevel, slmSysAlmDeact=slmSysAlmDeact, slmSysOperStatus=slmSysOperStatus, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmChPassLogin=slmChPassLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmTrapEnable=slmTrapEnable, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmSysSnmpVersion=slmSysSnmpVersion, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigFile=slmConfigFile, slmSyslogPort=slmSyslogPort, slmSys=slmSys, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmPmAvailable=slmPmAvailable, UserLogin=UserLogin, slmSysTemperature=slmSysTemperature, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthPassword=slmAuthPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserCommunity=UserCommunity, slmTrapCommunity=slmTrapCommunity, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, slmSysName=slmSysName, slmChPassTable=slmChPassTable, slmSwRevStatus=slmSwRevStatus)
