...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, TimeTicks, Gauge32, ObjectIdentity, MibIdentifier, iso, Counter32, ModuleIdentity, Bits, Integer32, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "TimeTicks", "Gauge32", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "ModuleIdentity", "Bits", "Integer32", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmAuthCommunity=slmAuthCommunity, slmVcatDelay=slmVcatDelay, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmLicenseIndex=slmLicenseIndex, slmChPassTable=slmChPassTable, slmConfigFile=slmConfigFile, slmRebootDelay=slmRebootDelay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseId=slmLicenseId, slmMuxNumber=slmMuxNumber, slmTrapLogEntry=slmTrapLogEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmWriteCommunity=slmWriteCommunity, slmSysResetPm=slmSysResetPm, slmChPassNewPass=slmChPassNewPass, slmReadCommunity=slmReadCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminLogin=slmAdminLogin, slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmLogin=slmLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmPsuNumber=slmPsuNumber, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, slmLicense=slmLicense, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmAdminRowStatus=slmAdminRowStatus, slmOemType=slmOemType, slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysUplinkRate=slmSysUplinkRate, slmAuthTable=slmAuthTable, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slmSysTrapFormat=slmSysTrapFormat, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmSysMode=slmSysMode, UserPassword=UserPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmSysSubnetMask=slmSysSubnetMask, UserCommunity=UserCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slMain=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmTrapCommunity=slmTrapCommunity, slmSwRevTable=slmSwRevTable, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName, slmTrapPort=slmTrapPort, slmSysIpAddr=slmSysIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmAdminCommunity=slmAdminCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthPassword=slmAuthPassword, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmAuth=slmAuth, slmSysAlmAct=slmSysAlmAct, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmConfigSysUptime=slmConfigSysUptime, slmSysChassisId=slmSysChassisId, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, AdminAccess=AdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmNetworkMode=slmNetworkMode, slmTrapLogName=slmTrapLogName, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassLogin=slmChPassLogin, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Auth=slmSnmpv3Auth, slmLogFile=slmLogFile, slmAuthEntry=slmAuthEntry)
