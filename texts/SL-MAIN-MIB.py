...
Integer32, Gauge32, ModuleIdentity, IpAddress, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, TimeTicks, Counter32, MibIdentifier, ObjectIdentity, NotificationType, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "IpAddress", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "TimeTicks", "Counter32", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmSyslogLevel=slmSyslogLevel, slmSysMode=slmSysMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassNewPass=slmChPassNewPass, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmChPassOldPass=slmChPassOldPass, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmAdmin=slmAdmin, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slmSyslogPort=slmSyslogPort, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmRebootDelay=slmRebootDelay, UserLogin=UserLogin, slmLicense=slmLicense, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam3=slmTrapLogParam3, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmAdminLogin=slmAdminLogin, slmTrapLogParam5=slmTrapLogParam5, slmLogin=slmLogin, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrap=slmTrap, slmAuthLogin=slmAuthLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapEnable=slmTrapEnable, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmSwRevTable=slmSwRevTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestTable=slmTrapDestTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmNetworkMode=slmNetworkMode, slmSysName=slmSysName, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmWriteCommunity=slmWriteCommunity, slmTrapLogId=slmTrapLogId, slmSys=slmSys, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmLicenseIndex=slmLicenseIndex, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slm40GConf=slm40GConf, slmTrapDestCommunity=slmTrapDestCommunity, slmOemType=slmOemType, slmTrapLogParam4=slmTrapLogParam4, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestEntry=slmTrapDestEntry, slmAuthTable=slmAuthTable, slmPmAvailable=slmPmAvailable, slmVcatDelay=slmVcatDelay, slmTrapCommunity=slmTrapCommunity, slmAuthEntry=slmAuthEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmSwRevDirectory=slmSwRevDirectory, slmChPassEntry=slmChPassEntry, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminEntry=slmAdminEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTid=slmTid, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmSyslogDestEntry=slmSyslogDestEntry)
