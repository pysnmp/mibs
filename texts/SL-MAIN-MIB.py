...
MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, NotificationType, Bits, TimeTicks, Gauge32, Opaque, Counter32, Counter64, iso, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "NotificationType", "Bits", "TimeTicks", "Gauge32", "Opaque", "Counter32", "Counter64", "iso", "Integer32", "ModuleIdentity")
DisplayString, TruthValue, TextualConvention, TimeStamp, DateAndTime, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TextualConvention", "TimeStamp", "DateAndTime", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapPort=slmTrapPort, slmConfigSysUptime=slmConfigSysUptime, slmSysSubnetMask=slmSysSubnetMask, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestCommunity=slmTrapDestCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapEnable=slmTrapEnable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmLicenseEntry=slmLicenseEntry, slmAuthEntry=slmAuthEntry, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrap=slmTrap, slmAuthCommunity=slmAuthCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysChassisId=slmSysChassisId, UserLogin=UserLogin, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRebootDelay=slmRebootDelay, slmSysName=slmSysName, slmConfigSysSignalType=slmConfigSysSignalType, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmAdminPassword=slmAdminPassword, slmTrapLogTable=slmTrapLogTable, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserLogin=slmTrapUserLogin, slmAuthTable=slmAuthTable, slmLicenseId=slmLicenseId, slmTopologyEnabled=slmTopologyEnabled, slmAuth=slmAuth, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmLogFile=slmLogFile, slmSwRevDirectory=slmSwRevDirectory, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseExpiration=slmLicenseExpiration, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Priv=slmSnmpv3Priv, PYSNMP_MODULE_ID=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmLicense=slmLicense, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmAct=slmSysAlmAct, slmSwRevTable=slmSwRevTable, slmChPassNewPass=slmChPassNewPass, slmPsuNumber=slmPsuNumber, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, slmTrapLogParam1=slmTrapLogParam1, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmChPass=slmChPass, slmAuthLogin=slmAuthLogin, slmTrapLogParam5=slmTrapLogParam5, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOemType=slmOemType, slmSysTemperature=slmSysTemperature, slmSysAdminStatus=slmSysAdminStatus, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmLicenseTable=slmLicenseTable, slmPmAvailable=slmPmAvailable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmSys=slmSys, slmSysMode=slmSysMode, slmAuthPassword=slmAuthPassword, slmTrapDestEntry=slmTrapDestEntry, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slMain=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmSysIpAddr=slmSysIpAddr, slmTrapDestTable=slmTrapDestTable, slmLogin=slmLogin, UserPassword=UserPassword, AdminAccess=AdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate)
