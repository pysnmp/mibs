...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmTid=slmTid, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam5=slmTrapLogParam5, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, slmSysResetPm=slmSysResetPm, slmSysMode=slmSysMode, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam2=slmTrapLogParam2, slmSyslogPort=slmSyslogPort, slmSyslogLevel=slmSyslogLevel, slmTrapDestEntry=slmTrapDestEntry, slmSysName=slmSysName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigFile=slmConfigFile, slmPmAvailable=slmPmAvailable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmRstpEnabled=slmRstpEnabled, slmSysAdminStatus=slmSysAdminStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevTable=slmSwRevTable, slmLicenseId=slmLicenseId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmPsuNumber=slmPsuNumber, slmMuxNumber=slmMuxNumber, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmTrap=slmTrap, slmTrapLogId=slmTrapLogId, slmSysAlmAct=slmSysAlmAct, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminLogin=slmAdminLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmChPassNewPass=slmChPassNewPass, slm40GConf=slm40GConf, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam1=slmTrapLogParam1, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slMain=slMain, slmAdminTable=slmAdminTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminCommunity=slmAdminCommunity, slmTrapDestTable=slmTrapDestTable, slmSysIpAddr=slmSysIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmAdmin=slmAdmin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPass=slmChPass, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogFile=slmLogFile, slmChPassEntry=slmChPassEntry, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmTrapEnable=slmTrapEnable, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmPortsNumber=slmPortsNumber, slmAdminRowStatus=slmAdminRowStatus, AdminAccess=AdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminEntry=slmAdminEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapCommunity=slmTrapCommunity, slmTrapLogTable=slmTrapLogTable, slmBoxSize=slmBoxSize, slmAdminAccess=slmAdminAccess, slmTrapPort=slmTrapPort, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmSysAlmDeact=slmSysAlmDeact, slmAuthEntry=slmAuthEntry)
