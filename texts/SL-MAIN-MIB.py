...
MibIdentifier, Integer32, ModuleIdentity, NotificationType, TimeTicks, Counter32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ObjectIdentity, Counter64, IpAddress, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "ModuleIdentity", "NotificationType", "TimeTicks", "Counter32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ObjectIdentity", "Counter64", "IpAddress", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam5=slmTrapLogParam5, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAlmAct=slmSysAlmAct, slmAuthCommunity=slmAuthCommunity, slmSwRevStatus=slmSwRevStatus, slmSysCalendarTime=slmSysCalendarTime, slmLogin=slmLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassNewPass=slmChPassNewPass, slmSyslogDestTable=slmSyslogDestTable, slmSysName=slmSysName, slmWriteCommunity=slmWriteCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmSwRevTable=slmSwRevTable, slmSysUplinkRate=slmSysUplinkRate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmSyslogLevel=slmSyslogLevel, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam4=slmTrapLogParam4, slmAdminLogin=slmAdminLogin, slmEdfaNumber=slmEdfaNumber, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmChPass=slmChPass, slMain=slMain, slmSys=slmSys, slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmAdminCommunity=slmAdminCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserPassword=UserPassword, slmSysMode=slmSysMode, slmTrapDestCommunity=slmTrapDestCommunity, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmAdminPassword=slmAdminPassword, slmTrapEnable=slmTrapEnable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOemType=slmOemType, slmAdmin=slmAdmin, SoftwareRevision=SoftwareRevision, slm40GConf=slm40GConf, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmLicenseTable=slmLicenseTable, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slmSysSnmpVersion=slmSysSnmpVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigFile=slmConfigFile, slmTrapDestTable=slmTrapDestTable, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmSwRevDate=slmSwRevDate, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassOldPass=slmChPassOldPass, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTable=slmTrapLogTable, slmChPassTable=slmChPassTable, slmVcatDelay=slmVcatDelay, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmSysTemperature=slmSysTemperature)
