...
Gauge32, Unsigned32, Counter32, Counter64, Opaque, iso, Bits, NotificationType, ObjectIdentity, Integer32, ModuleIdentity, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Counter32", "Counter64", "Opaque", "iso", "Bits", "NotificationType", "ObjectIdentity", "Integer32", "ModuleIdentity", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPass=slmChPass, slmSys=slmSys, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmChPassLogin=slmChPassLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapPort=slmTrapPort, UserPassword=UserPassword, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, slm40GConf=slm40GConf, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmPmAvailable=slmPmAvailable, slMain=slMain, slmSwRevEntry=slmSwRevEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminLogin=slmAdminLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicense=slmLicense, AdminAccess=AdminAccess, slmChPassOldPass=slmChPassOldPass, slmRstpEnabled=slmRstpEnabled, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmTopologyEnabled=slmTopologyEnabled, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmSysTemperature=slmSysTemperature, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevTable=slmSwRevTable, slmAdminEntry=slmAdminEntry, slmPsuNumber=slmPsuNumber, slmChPassEntry=slmChPassEntry, slmTrapLogParam3=slmTrapLogParam3, slmAuthEntry=slmAuthEntry, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogId=slmTrapLogId, slmSwRevDate=slmSwRevDate, slmSwRevDirectory=slmSwRevDirectory, slmAdminPassword=slmAdminPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, slmTid=slmTid, slmSnmpv3Auth=slmSnmpv3Auth, slmVcatDelay=slmVcatDelay, slmLogin=slmLogin, slmTrapLogTable=slmTrapLogTable, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmSysIpAddr=slmSysIpAddr, slmSysChassisId=slmSysChassisId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSubnetMask=slmSysSubnetMask, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmLicenseId=slmLicenseId, slmSysLocation=slmSysLocation, slmTrapLogParam5=slmTrapLogParam5, slmSysOperStatus=slmSysOperStatus, slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmTrapUserAccess=slmTrapUserAccess, slmPortsNumber=slmPortsNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogFile=slmLogFile, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmOemType=slmOemType, slmTrapLogParam2=slmTrapLogParam2, slmAuthLogin=slmAuthLogin, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, slmSysResetPm=slmSysResetPm, slmSyslogPort=slmSyslogPort, slmLicenseTable=slmLicenseTable, slmSnmpv3Priv=slmSnmpv3Priv, UserCommunity=UserCommunity, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct)
