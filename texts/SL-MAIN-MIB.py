...
iso, Opaque, IpAddress, Bits, Gauge32, Integer32, ObjectIdentity, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, TimeTicks, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Opaque", "IpAddress", "Bits", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "TimeTicks", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTable=slmTrapLogTable, slmChPassOldPass=slmChPassOldPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmWriteCommunity=slmWriteCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, UserCommunity=UserCommunity, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmSyslogPort=slmSyslogPort, slmAdmin=slmAdmin, slmTrapLogEntry=slmTrapLogEntry, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseExpiration=slmLicenseExpiration, slmSwRevTable=slmSwRevTable, slmAuthPassword=slmAuthPassword, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmOemType=slmOemType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmSysAlmDeact=slmSysAlmDeact, slmChPassEntry=slmChPassEntry, slmSys=slmSys, slm40GConf=slm40GConf, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmSwRevStatus=slmSwRevStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmTrapLogName=slmTrapLogName, slmConfigSysSignalType=slmConfigSysSignalType, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, UserPassword=UserPassword, slmAuth=slmAuth, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogFile=slmLogFile, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam4=slmTrapLogParam4, slmConfigFile=slmConfigFile, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmConfigSysUptime=slmConfigSysUptime, slmLicenseId=slmLicenseId, slmPmAvailable=slmPmAvailable, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Auth=slmSnmpv3Auth, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmLicenseIndex=slmLicenseIndex, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmAdminPassword=slmAdminPassword, AdminAccess=AdminAccess, slmChPassLogin=slmChPassLogin, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmPortsNumber=slmPortsNumber, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestTable=slmTrapDestTable, slmTrapLogId=slmTrapLogId, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSysMode=slmSysMode, slmSnmpv3Priv=slmSnmpv3Priv, slmSysIpAddr=slmSysIpAddr)
