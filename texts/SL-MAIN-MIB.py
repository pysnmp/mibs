...
Gauge32, Counter32, Opaque, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, iso, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, Integer32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Opaque", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "iso", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity")
DisplayString, TimeStamp, TextualConvention, DateAndTime, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "DateAndTime", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmAdminTable=slmAdminTable, slmSwRevStatus=slmSwRevStatus, slmAdminEntry=slmAdminEntry, slmOemType=slmOemType, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestEntry=slmSyslogDestEntry, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysTemperature=slmSysTemperature, slmSysName=slmSysName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmSysOperStatus=slmSysOperStatus, slmLicenseTable=slmLicenseTable, PYSNMP_MODULE_ID=slMain, slmSwRevDirectory=slmSwRevDirectory, slmMuxNumber=slmMuxNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmAdminPassword=slmAdminPassword, slmAuthCommunity=slmAuthCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSwRevName=slmSwRevName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam4=slmTrapLogParam4, slmAuthLogin=slmAuthLogin, slmTrapLogParam3=slmTrapLogParam3, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmRebootDelay=slmRebootDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, UserCommunity=UserCommunity, slmConfigFile=slmConfigFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmDeact=slmSysAlmDeact, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmAuthTable=slmAuthTable, slmAdminRowStatus=slmAdminRowStatus, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassOldPass=slmChPassOldPass, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysResetPm=slmSysResetPm, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapCommunity=slmTrapCommunity, slmSyslogLevel=slmSyslogLevel, slMain=slMain, slmAuthEntry=slmAuthEntry, slmVcatDelay=slmVcatDelay, slmEdfaNumber=slmEdfaNumber, slmSyslogDestTable=slmSyslogDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin, SoftwareRevision=SoftwareRevision, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmSysSubnetMask=slmSysSubnetMask, slmChPassLogin=slmChPassLogin, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigSysUptime=slmConfigSysUptime, slmAdmin=slmAdmin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogFile=slmLogFile, slmLicenseId=slmLicenseId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slmSysTrapFormat=slmSysTrapFormat, slmTid=slmTid, slmTrapLogName=slmTrapLogName, slmTrapLogId=slmTrapLogId, slmTrapLogTable=slmTrapLogTable, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmTrapDestTable=slmTrapDestTable, slmLicenseExpiration=slmLicenseExpiration, slmAuthPassword=slmAuthPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, AdminAccess=AdminAccess, slmSyslogDestAddress=slmSyslogDestAddress)
