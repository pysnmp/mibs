...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmLicenseEntry=slmLicenseEntry, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, UserCommunity=UserCommunity, slmSysResetPm=slmSysResetPm, slmLicenseExpiration=slmLicenseExpiration, slmSys=slmSys, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapPort=slmTrapPort, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmAuth=slmAuth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevStatus=slmSwRevStatus, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Auth=slmSnmpv3Auth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmConfigFile=slmConfigFile, slmTrapCommunity=slmTrapCommunity, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam2=slmTrapLogParam2, slmAuthPassword=slmAuthPassword, slmSysTemperature=slmSysTemperature, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmChPassTable=slmChPassTable, slmChPass=slmChPass, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevName=slmSwRevName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Password=slmSnmpv3Password, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseTable=slmLicenseTable, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam3=slmTrapLogParam3, slmAuthEntry=slmAuthEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmBoxSize=slmBoxSize, slmSwRevTable=slmSwRevTable, slMain=slMain, slmTrap=slmTrap, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, AdminAccess=AdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysChassisId=slmSysChassisId, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogPort=slmSyslogPort, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassLogin=slmChPassLogin, slmSysAlmAct=slmSysAlmAct, slmWriteCommunity=slmWriteCommunity, PYSNMP_MODULE_ID=slMain, slmSwRevEntry=slmSwRevEntry, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmAdmin=slmAdmin, slmPmAvailable=slmPmAvailable, slmOemType=slmOemType, slmSysName=slmSysName, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmRstpEnabled=slmRstpEnabled, slmTrapDestEntry=slmTrapDestEntry, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable)
