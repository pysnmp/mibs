...
NotificationType, IpAddress, TimeTicks, iso, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, ModuleIdentity, Counter32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "TimeTicks", "iso", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmSysSubnetMask=slmSysSubnetMask, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, UserLogin=UserLogin, PYSNMP_MODULE_ID=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmSysTemperature=slmSysTemperature, slmSysIpAddr=slmSysIpAddr, slmTrapDestTable=slmTrapDestTable, slmTid=slmTid, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmBoxSize=slmBoxSize, slmLogin=slmLogin, slmAuth=slmAuth, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmVcatDelay=slmVcatDelay, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminPassword=slmAdminPassword, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminCommunity=slmAdminCommunity, slmChPass=slmChPass, slmSys=slmSys, slmChPassLogin=slmChPassLogin, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, SoftwareRevision=SoftwareRevision, slmReadCommunity=slmReadCommunity, slmSyslogDestTable=slmSyslogDestTable, slmRstpEnabled=slmRstpEnabled, slmSwRevEntry=slmSwRevEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevName=slmSwRevName, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slmSysOperStatus=slmSysOperStatus, slmConfigSysUptime=slmConfigSysUptime, slmLicense=slmLicense, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserAccess=slmTrapUserAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapPort=slmTrapPort, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestEntry=slmTrapDestEntry, slmAdminEntry=slmAdminEntry, slmSysLocation=slmSysLocation, slmSysResetPm=slmSysResetPm, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slm40GConf=slm40GConf, slmTrapLogName=slmTrapLogName, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam2=slmTrapLogParam2, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, UserCommunity=UserCommunity, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmEdfaNumber=slmEdfaNumber, slmSwRevDirectory=slmSwRevDirectory, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminTable=slmAdminTable, AdminAccess=AdminAccess, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseIndex=slmLicenseIndex, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthTable=slmAuthTable, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestCommunity=slmTrapDestCommunity, slmWriteCommunity=slmWriteCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmSyslogLevel=slmSyslogLevel, slmTrapLogTable=slmTrapLogTable, UserPassword=UserPassword, slmSysMode=slmSysMode)
