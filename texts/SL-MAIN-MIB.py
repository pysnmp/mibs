...
NotificationType, Bits, iso, Integer32, Counter32, Opaque, Counter64, TimeTicks, Gauge32, ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "iso", "Integer32", "Counter32", "Opaque", "Counter64", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress")
RowStatus, TimeStamp, TextualConvention, TruthValue, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, UserLogin=UserLogin, UserPassword=UserPassword, slmChPassOldPass=slmChPassOldPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmWriteCommunity=slmWriteCommunity, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmSysName=slmSysName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevName=slmSwRevName, slmTrapDestAddress=slmTrapDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmSyslogLevel=slmSyslogLevel, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRebootDelay=slmRebootDelay, slmLicense=slmLicense, slmAdminTable=slmAdminTable, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmSyslogPort=slmSyslogPort, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmBoxSize=slmBoxSize, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmAdminEntry=slmAdminEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestCommunity=slmTrapDestCommunity, slmLogFile=slmLogFile, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmSwRevTable=slmSwRevTable, slmTrap=slmTrap, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSys=slmSys, slmLicenseTable=slmLicenseTable, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmAuthPassword=slmAuthPassword, slmSysLocation=slmSysLocation, slmTrapCommunity=slmTrapCommunity, slmSysMode=slmSysMode, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, slmSysSubnetMask=slmSysSubnetMask, slmAuth=slmAuth, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmChPassNewPass=slmChPassNewPass, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmTrapEnable=slmTrapEnable, slmNetworkMode=slmNetworkMode, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, UserCommunity=UserCommunity, slmTrapLogParam3=slmTrapLogParam3, slmOemType=slmOemType, slmSysCalendarTime=slmSysCalendarTime, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam2=slmTrapLogParam2, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminPassword=slmAdminPassword, slmTrapDestTable=slmTrapDestTable, slmSwRevEntry=slmSwRevEntry, slmConfigFile=slmConfigFile, slmChPass=slmChPass, slmAuthTable=slmAuthTable, slmLicenseId=slmLicenseId, slmChPassEntry=slmChPassEntry, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayAddr=slmSysGatewayAddr)
