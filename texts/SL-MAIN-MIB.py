...
NotificationType, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Integer32, Gauge32, TimeTicks, Counter32, Bits, Counter64, ObjectIdentity, Unsigned32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Integer32", "Gauge32", "TimeTicks", "Counter32", "Bits", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysNameChange=slmTrapSysNameChange, slmNetworkMode=slmNetworkMode, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevName=slmSwRevName, slmSysName=slmSysName, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysMode=slmSysMode, slmSysSubnetMask=slmSysSubnetMask, slmTrapPort=slmTrapPort, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmAuthEntry=slmAuthEntry, slmConfigSysUptime=slmConfigSysUptime, slmChPassLogin=slmChPassLogin, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysChassisId=slmSysChassisId, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestTable=slmSyslogDestTable, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmRstpEnabled=slmRstpEnabled, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmAuthTable=slmAuthTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTable=slmTrapLogTable, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmAdminAccess=slmAdminAccess, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmLicenseIndex=slmLicenseIndex, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestEntry=slmSyslogDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Auth=slmSnmpv3Auth, slmLicense=slmLicense, UserCommunity=UserCommunity, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmSyslogLevel=slmSyslogLevel, slmVcatDelay=slmVcatDelay, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmSwRevStatus=slmSwRevStatus, slmTrapLogName=slmTrapLogName, slmTrapEnable=slmTrapEnable, slmSysCalendarTime=slmSysCalendarTime, slmAdminEntry=slmAdminEntry, slmChPassOldPass=slmChPassOldPass, slmAuthCommunity=slmAuthCommunity, slmMuxNumber=slmMuxNumber, slmTid=slmTid, slmLogFile=slmLogFile, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmRebootDelay=slmRebootDelay, slmTrapLogParam2=slmTrapLogParam2, slmTrap=slmTrap, AdminAccess=AdminAccess, slmAuth=slmAuth, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmChPass=slmChPass, slmWriteCommunity=slmWriteCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTemperature=slmSysTemperature, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, SoftwareRevision=SoftwareRevision, slmSyslogPort=slmSyslogPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slMain=slMain)
