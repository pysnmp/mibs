...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthEntry=slmAuthEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysMode=slmSysMode, slmLicense=slmLicense, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmSwRevDirectory=slmSwRevDirectory, slmWriteCommunity=slmWriteCommunity, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmChPassOldPass=slmChPassOldPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmPmAvailable=slmPmAvailable, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmSysChassisId=slmSysChassisId, slmConfigFile=slmConfigFile, slmTrapEnable=slmTrapEnable, slmSwRevTable=slmSwRevTable, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, slmLicenseId=slmLicenseId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuth=slmAuth, slmLicenseEntry=slmLicenseEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLocation=slmSysLocation, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassTable=slmChPassTable, slmLogFile=slmLogFile, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmAuthCommunity=slmAuthCommunity, slmChPassLogin=slmChPassLogin, slmAdminTable=slmAdminTable, slmTid=slmTid, slmSysResetPm=slmSysResetPm, slmTrapDestCommunity=slmTrapDestCommunity, SoftwareRevision=SoftwareRevision, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slMain=slMain, slmSwRevName=slmSwRevName, slmLicenseIndex=slmLicenseIndex, slmSysTrapFormat=slmSysTrapFormat, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, AdminAccess=AdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestEntry=slmSyslogDestEntry, slmAdmin=slmAdmin, slmSwRevEntry=slmSwRevEntry, slmAuthTable=slmAuthTable, slmTrapLogParam4=slmTrapLogParam4, slmSwRevStatus=slmSwRevStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam2=slmTrapLogParam2, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmConfigSysUptime=slmConfigSysUptime, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmReadCommunity=slmReadCommunity, slmSysIpAddr=slmSysIpAddr)
