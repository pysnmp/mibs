...
Counter32, ObjectIdentity, Gauge32, TimeTicks, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Integer32, Bits, NotificationType, Unsigned32, iso, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Gauge32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Integer32", "Bits", "NotificationType", "Unsigned32", "iso", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysSnmpVersion=slmSysSnmpVersion, slmConfigFile=slmConfigFile, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmChPassOldPass=slmChPassOldPass, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthLogin=slmAuthLogin, slmSysResetPm=slmSysResetPm, slm40GConf=slm40GConf, UserLogin=UserLogin, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmWriteCommunity=slmWriteCommunity, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestAddress=slmTrapDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, UserCommunity=UserCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdmin=slmAdmin, slmSysChassisId=slmSysChassisId, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestEntry=slmSyslogDestEntry, slmRstpEnabled=slmRstpEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysMode=slmSysMode, slmTrapLogEntry=slmTrapLogEntry, slmPmAvailable=slmPmAvailable, slmTrapLogParam6=slmTrapLogParam6, slmLicenseTable=slmLicenseTable, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slmSysLocation=slmSysLocation, slmRebootDelay=slmRebootDelay, slmAuthEntry=slmAuthEntry, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmSysAlmAct=slmSysAlmAct, slmAuthCommunity=slmAuthCommunity, slmChPassLogin=slmChPassLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam5=slmTrapLogParam5, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmTrapLogTable=slmTrapLogTable, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSysName=slmSysName, slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmEdfaNumber=slmEdfaNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmAdminAccess=slmAdminAccess, slmAdminPassword=slmAdminPassword, AdminAccess=AdminAccess, slmTrapLogId=slmTrapLogId, slmTrapEnable=slmTrapEnable, slmAdminEntry=slmAdminEntry, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmAuthPassword=slmAuthPassword, slmLicenseEntry=slmLicenseEntry, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogName=slmTrapLogName, UserPassword=UserPassword, slmSnmpv3Password=slmSnmpv3Password, slmSwRevStatus=slmSwRevStatus, slmConfigSysUptime=slmConfigSysUptime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam1=slmTrapLogParam1, slmSwRevEntry=slmSwRevEntry, slmAdminCommunity=slmAdminCommunity, slmTid=slmTid, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, slmPsuNumber=slmPsuNumber, slmTrapPort=slmTrapPort, slmSyslogDestAddress=slmSyslogDestAddress, slmTrap=slmTrap, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayAddr=slmSysGatewayAddr, slmSys=slmSys, slmMuxNumber=slmMuxNumber, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTopologyEnabled=slmTopologyEnabled, slmAuth=slmAuth, slmSysIpAddr=slmSysIpAddr, slmSwRevTable=slmSwRevTable)
