...
Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Gauge32, ObjectIdentity, TimeTicks, Unsigned32, iso, Opaque, MibIdentifier, Integer32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "Unsigned32", "iso", "Opaque", "MibIdentifier", "Integer32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminEntry=slmAdminEntry, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmChPass=slmChPass, slmOemType=slmOemType, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSyslogPort=slmSyslogPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRebootDelay=slmRebootDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestRowStatus=slmTrapDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmConfigSysUptime=slmConfigSysUptime, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogLevel=slmSyslogLevel, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmEdfaNumber=slmEdfaNumber, slmConfigFile=slmConfigFile, slMain=slMain, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slm40GConf=slm40GConf, slmTrapSysNameChange=slmTrapSysNameChange, slmMuxNumber=slmMuxNumber, slmSysSubnetMask=slmSysSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmLicense=slmLicense, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, AdminAccess=AdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthTable=slmAuthTable, slmNetworkMode=slmNetworkMode, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmTrapLogParam5=slmTrapLogParam5, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogEntry=slmTrapLogEntry, slmLicenseEntry=slmLicenseEntry, UserLogin=UserLogin, SoftwareRevision=SoftwareRevision, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogId=slmTrapLogId, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthPassword=slmAuthPassword, slmRstpEnabled=slmRstpEnabled, slmSysChassisId=slmSysChassisId, slmLogFile=slmLogFile, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevStatus=slmSwRevStatus, slmSysName=slmSysName, slmSysMode=slmSysMode, slmAuth=slmAuth, slmChPassNewPass=slmChPassNewPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmLicenseId=slmLicenseId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable)
