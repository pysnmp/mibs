...
Opaque, NotificationType, iso, ObjectIdentity, Counter64, Gauge32, Integer32, Bits, Unsigned32, MibIdentifier, TimeTicks, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "NotificationType", "iso", "ObjectIdentity", "Counter64", "Gauge32", "Integer32", "Bits", "Unsigned32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevStatus=slmSwRevStatus, slmVcatDelay=slmVcatDelay, slmSysLanIpAddr=slmSysLanIpAddr, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, UserPassword=UserPassword, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogName=slmTrapLogName, slmSysLocation=slmSysLocation, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, UserCommunity=UserCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogTable=slmTrapLogTable, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmChPassTable=slmChPassTable, slmSysCalendarTime=slmSysCalendarTime, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmTrapLogEntry=slmTrapLogEntry, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmLogFile=slmLogFile, slmSwRevEntry=slmSwRevEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmSysIpAddr=slmSysIpAddr, slmAuthTable=slmAuthTable, slmPmAvailable=slmPmAvailable, slm40GConf=slm40GConf, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, SoftwareRevision=SoftwareRevision, slmNetworkMode=slmNetworkMode, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminAccess=slmAdminAccess, slmSwRevName=slmSwRevName, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmChPassNewPass=slmChPassNewPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam2=slmTrapLogParam2, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmSysAdminStatus=slmSysAdminStatus, slmAdminLogin=slmAdminLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogin=slmLogin, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmLicenseTable=slmLicenseTable, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam3=slmTrapLogParam3, slmSysName=slmSysName, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRebootDelay=slmRebootDelay, PYSNMP_MODULE_ID=slMain, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmAdminCommunity=slmAdminCommunity, slmTrap=slmTrap, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserLogin=UserLogin, slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry)
