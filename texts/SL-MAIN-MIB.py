...
ModuleIdentity, Unsigned32, TimeTicks, NotificationType, Gauge32, iso, Counter64, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Opaque, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "TimeTicks", "NotificationType", "Gauge32", "iso", "Counter64", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Opaque", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminAccess=slmAdminAccess, slmMuxNumber=slmMuxNumber, slmEdfaNumber=slmEdfaNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, slmPsuNumber=slmPsuNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmSwRevStatus=slmSwRevStatus, slmChPassNewPass=slmChPassNewPass, slmPortsNumber=slmPortsNumber, slmAuth=slmAuth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, slmAuthLogin=slmAuthLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam6=slmTrapLogParam6, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmSysResetPm=slmSysResetPm, slmLogFile=slmLogFile, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdmin=slmAdmin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam4=slmTrapLogParam4, slmAdminEntry=slmAdminEntry, slmSyslogPort=slmSyslogPort, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmAuthCommunity=slmAuthCommunity, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmSysName=slmSysName, slmTid=slmTid, slmSysTemperature=slmSysTemperature, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmTrapUserAccess=slmTrapUserAccess, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, UserCommunity=UserCommunity, slmSwRevEntry=slmSwRevEntry, slmRebootDelay=slmRebootDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmLicenseTable=slmLicenseTable, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogName=slmTrapLogName, SoftwareRevision=SoftwareRevision, slmTrapLogTable=slmTrapLogTable, slmTrapEnable=slmTrapEnable, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDate=slmSwRevDate, slmTrapPort=slmTrapPort, slmAuthPassword=slmAuthPassword, slmSysCalendarTime=slmSysCalendarTime, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassEntry=slmChPassEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogin=slmLogin, slmLicenseEntry=slmLicenseEntry, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slm40GConf=slm40GConf, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestEntry=slmTrapDestEntry, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmAuthTable=slmAuthTable, slmSys=slmSys, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, PYSNMP_MODULE_ID=slMain, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity)
