...
MibIdentifier, IpAddress, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, TimeTicks, NotificationType, Counter64, Opaque, Integer32, Unsigned32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter64", "Opaque", "Integer32", "Unsigned32", "Bits", "Counter32")
TruthValue, DateAndTime, RowStatus, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DateAndTime", "RowStatus", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmWriteCommunity=slmWriteCommunity, slmSysLocation=slmSysLocation, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, UserPassword=UserPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmAuthLogin=slmAuthLogin, slmSysCalendarTime=slmSysCalendarTime, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestAddress=slmTrapDestAddress, slmSysIpAddr=slmSysIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOemType=slmOemType, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestTable=slmTrapDestTable, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevTable=slmSwRevTable, slmNetworkMode=slmNetworkMode, slmSysName=slmSysName, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmLicenseEntry=slmLicenseEntry, slmSyslogPort=slmSyslogPort, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, slmAuthCommunity=slmAuthCommunity, slmAdmin=slmAdmin, slmAdminCommunity=slmAdminCommunity, slmAdminAccess=slmAdminAccess, slmChPass=slmChPass, slmBoxSize=slmBoxSize, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogName=slmTrapLogName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, SoftwareRevision=SoftwareRevision, slmConfigSysUptime=slmConfigSysUptime, slmSwRevEntry=slmSwRevEntry, slmRstpEnabled=slmRstpEnabled, slmConfigFile=slmConfigFile, slmTid=slmTid, slmAdminTable=slmAdminTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmSysChassisId=slmSysChassisId, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, UserCommunity=UserCommunity, slmSys=slmSys, slmSysTemperature=slmSysTemperature, slmTrapLogParam3=slmTrapLogParam3, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slm40GConf=slm40GConf, slmLogin=slmLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrap=slmTrap, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapEnable=slmTrapEnable, slmPmAvailable=slmPmAvailable, slmSysMode=slmSysMode, slmChPassTable=slmChPassTable, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmAdminLogin=slmAdminLogin, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam2=slmTrapLogParam2)
