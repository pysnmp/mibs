...
TimeTicks, iso, ModuleIdentity, ObjectIdentity, MibIdentifier, Opaque, IpAddress, NotificationType, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Opaque", "IpAddress", "NotificationType", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevStatus=slmSwRevStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogId=slmTrapLogId, slmTrapUserLogin=slmTrapUserLogin, slmSysUplinkRate=slmSysUplinkRate, slmSysTrapFormat=slmSysTrapFormat, UserPassword=UserPassword, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassNewPass=slmChPassNewPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam4=slmTrapLogParam4, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, slmSwRevTable=slmSwRevTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmChPassOldPass=slmChPassOldPass, slmSysChassisId=slmSysChassisId, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogPort=slmSyslogPort, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmAdminRowStatus=slmAdminRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmBoxSize=slmBoxSize, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTemperature=slmSysTemperature, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmTrapPort=slmTrapPort, slmAuthPassword=slmAuthPassword, slmReadCommunity=slmReadCommunity, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmPsuNumber=slmPsuNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmTrapLogParam5=slmTrapLogParam5, slmAdminEntry=slmAdminEntry, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevEntry=slmSwRevEntry, slmTid=slmTid, slmWriteCommunity=slmWriteCommunity, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, UserCommunity=UserCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTable=slmTrapLogTable, slmSyslogDestAddress=slmSyslogDestAddress, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmChPassEntry=slmChPassEntry, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam6=slmTrapLogParam6, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmAuthLogin=slmAuthLogin, slmSwRevName=slmSwRevName, slmSysResetPm=slmSysResetPm, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmLicenseIndex=slmLicenseIndex, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmAuthEntry=slmAuthEntry, slmTrapCommunity=slmTrapCommunity, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmSwRevDirectory=slmSwRevDirectory, slmChPass=slmChPass, slmSysOperStatus=slmSysOperStatus, slmRstpEnabled=slmRstpEnabled, AdminAccess=AdminAccess, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysMode=slmSysMode)
