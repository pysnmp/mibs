...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmSnmpv3Auth=slmSnmpv3Auth, slm40GConf=slm40GConf, slmSwRevDirectory=slmSwRevDirectory, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassOldPass=slmChPassOldPass, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmSwRevEntry=slmSwRevEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmTrapPort=slmTrapPort, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, SoftwareRevision=SoftwareRevision, slmSysName=slmSysName, slmSysActiveSwVersion=slmSysActiveSwVersion, UserLogin=UserLogin, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, slmSnmpv3Password=slmSnmpv3Password, slmChPassEntry=slmChPassEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthPassword=slmAuthPassword, slmChPassTable=slmChPassTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmTid=slmTid, slmReadCommunity=slmReadCommunity, slmAuthCommunity=slmAuthCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminAccess=slmAdminAccess, slmTrapLogName=slmTrapLogName, slmRstpEnabled=slmRstpEnabled, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmTrapUserAccess=slmTrapUserAccess, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmNetworkMode=slmNetworkMode, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDate=slmSwRevDate, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmMuxNumber=slmMuxNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdmin=slmAdmin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysUptime=slmConfigSysUptime, slmSysCalendarTime=slmSysCalendarTime, slmSysTemperature=slmSysTemperature, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRebootDelay=slmRebootDelay, slmAdminLogin=slmAdminLogin, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, UserPassword=UserPassword, slmPmAvailable=slmPmAvailable, slmLicenseEntry=slmLicenseEntry, slmAuth=slmAuth, slmTrapDestTable=slmTrapDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmChPassLogin=slmChPassLogin, slmSys=slmSys, AdminAccess=AdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam4=slmTrapLogParam4, slmChPass=slmChPass, slmOemType=slmOemType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLocation=slmSysLocation, slmLicenseIndex=slmLicenseIndex, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable)
