...
Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Opaque, Integer32, ObjectIdentity, Unsigned32, MibIdentifier, Counter64, iso, NotificationType, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Opaque", "Integer32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64", "iso", "NotificationType", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogId=slmTrapLogId, slmTrapDestAddress=slmTrapDestAddress, slmAdminLogin=slmAdminLogin, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, PYSNMP_MODULE_ID=slMain, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, slmSysLocation=slmSysLocation, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam4=slmTrapLogParam4, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, AdminAccess=AdminAccess, slmSwRevDate=slmSwRevDate, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapEnable=slmTrapEnable, slmAuthCommunity=slmAuthCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmSwRevName=slmSwRevName, slmSysTrapFormat=slmSysTrapFormat, slmSyslogPort=slmSyslogPort, slmSysTemperature=slmSysTemperature, slmChPassOldPass=slmChPassOldPass, slmSysName=slmSysName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmRebootDelay=slmRebootDelay, slmSysLanIpAddr=slmSysLanIpAddr, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmAdminEntry=slmAdminEntry, slmConfigFile=slmConfigFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogFile=slmLogFile, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseId=slmLicenseId, UserCommunity=UserCommunity, slmLogin=slmLogin, slmTrapLogEntry=slmTrapLogEntry, UserLogin=UserLogin, slmAdmin=slmAdmin, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmPsuNumber=slmPsuNumber, slmSysAlmAct=slmSysAlmAct, slmChPassEntry=slmChPassEntry, slmAuthEntry=slmAuthEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, slmSysResetPm=slmSysResetPm, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmReadCommunity=slmReadCommunity, slmAdminRowStatus=slmAdminRowStatus, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmAuthLogin=slmAuthLogin, slmSys=slmSys, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestTable=slmSyslogDestTable, slmSysChassisId=slmSysChassisId, slmAdminCommunity=slmAdminCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmTrapLogTable=slmTrapLogTable, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmVcatDelay=slmVcatDelay, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmAdminAccess=slmAdminAccess, slmLicenseTable=slmLicenseTable, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Priv=slmSnmpv3Priv, slmSysIpAddr=slmSysIpAddr, slmTrapCommunity=slmTrapCommunity, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmTrapLogParam1=slmTrapLogParam1, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slm40GConf=slm40GConf, slmBoxSize=slmBoxSize, slmSysSubnetMask=slmSysSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmChPass=slmChPass)
