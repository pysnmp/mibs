...
Counter64, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Bits, Counter32, Unsigned32, ObjectIdentity, NotificationType, MibIdentifier, TimeTicks, IpAddress, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Bits", "Counter32", "Unsigned32", "ObjectIdentity", "NotificationType", "MibIdentifier", "TimeTicks", "IpAddress", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuth=slmAuth, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmTrapLogTable=slmTrapLogTable, slmChPassNewPass=slmChPassNewPass, slmSysChassisId=slmSysChassisId, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmSyslogPort=slmSyslogPort, slmLicenseId=slmLicenseId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysLocationChange=slmTrapSysLocationChange, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminAccess=slmAdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmChPass=slmChPass, slmSysLocation=slmSysLocation, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmSwRevEntry=slmSwRevEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmRstpEnabled=slmRstpEnabled, slmMuxNumber=slmMuxNumber, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slmTrap=slmTrap, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysTemperature=slmSysTemperature, slmLicenseExpiration=slmLicenseExpiration, slmAdminTable=slmAdminTable, slmNetworkMode=slmNetworkMode, slmPortsNumber=slmPortsNumber, slmAdminPassword=slmAdminPassword, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Password=slmSnmpv3Password, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmTid=slmTid, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, slmOemType=slmOemType, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam6=slmTrapLogParam6, slmSwRevName=slmSwRevName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, UserCommunity=UserCommunity, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmAuthPassword=slmAuthPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, PYSNMP_MODULE_ID=slMain, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicense=slmLicense, slmAdmin=slmAdmin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogName=slmTrapLogName, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
