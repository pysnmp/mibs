...
NotificationType, TimeTicks, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, ObjectIdentity, Opaque, Unsigned32, Bits, MibIdentifier, IpAddress, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "ObjectIdentity", "Opaque", "Unsigned32", "Bits", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysMode=slmSysMode, slmSysTemperature=slmSysTemperature, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicense=slmLicense, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmAdminEntry=slmAdminEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmAdminPassword=slmAdminPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthCommunity=slmAuthCommunity, slmAuthPassword=slmAuthPassword, slmAuth=slmAuth, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmAdminTable=slmAdminTable, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam6=slmTrapLogParam6, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrap=slmTrap, slmChPassLogin=slmChPassLogin, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmAdminAccess=slmAdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmSysName=slmSysName, slmSysLanIpAddr=slmSysLanIpAddr, slmVcatDelay=slmVcatDelay, slmLicenseEntry=slmLicenseEntry, slmTid=slmTid, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, AdminAccess=AdminAccess, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, UserLogin=UserLogin, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmTrapLogName=slmTrapLogName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestTable=slmTrapDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserAccess=slmTrapUserAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassOldPass=slmChPassOldPass, SoftwareRevision=SoftwareRevision, slmSysChassisId=slmSysChassisId, slmAdmin=slmAdmin, slmSysLocation=slmSysLocation, slmSwRevEntry=slmSwRevEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogPort=slmSyslogPort, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, slmReadCommunity=slmReadCommunity, slmTrapLogParam5=slmTrapLogParam5, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPass=slmChPass, slmLogin=slmLogin, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam3=slmTrapLogParam3, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmBoxSize=slmBoxSize, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmAdminCommunity=slmAdminCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, UserCommunity=UserCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthLogin=slmAuthLogin, slmAuthEntry=slmAuthEntry, slmChPassEntry=slmChPassEntry, slmTrapPort=slmTrapPort)
