...
TimeTicks, ObjectIdentity, MibIdentifier, ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Counter32, NotificationType, Gauge32, IpAddress, Bits, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Counter32", "NotificationType", "Gauge32", "IpAddress", "Bits", "iso", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapUserLogin=slmTrapUserLogin, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmNetworkMode=slmNetworkMode, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slmSwRevStatus=slmSwRevStatus, slmLicenseId=slmLicenseId, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmLicenseTable=slmLicenseTable, SoftwareRevision=SoftwareRevision, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTid=slmTid, slmAdminTable=slmAdminTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmReadCommunity=slmReadCommunity, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmVcatDelay=slmVcatDelay, slmSysName=slmSysName, slmConfigFile=slmConfigFile, slmTrapLogParam6=slmTrapLogParam6, slmAuthLogin=slmAuthLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, UserLogin=UserLogin, slmSysMode=slmSysMode, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmPmAvailable=slmPmAvailable, slmPortsNumber=slmPortsNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmSysResetPm=slmSysResetPm, slmAdmin=slmAdmin, slmTrapLogEntry=slmTrapLogEntry, UserPassword=UserPassword, slmSysIpAddr=slmSysIpAddr, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmChPassTable=slmChPassTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam3=slmTrapLogParam3, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmBoxSize=slmBoxSize, slmSwRevTable=slmSwRevTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTrapFormat=slmSysTrapFormat, slmLogFile=slmLogFile, slmAuthPassword=slmAuthPassword, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogName=slmTrapLogName, slmSnmpv3Priv=slmSnmpv3Priv, slmAuth=slmAuth, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Password=slmSnmpv3Password, slmSwRevEntry=slmSwRevEntry, slMain=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmLogin=slmLogin, slmWriteCommunity=slmWriteCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry, slmOemType=slmOemType, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevDate=slmSwRevDate, slmTrapDestTable=slmTrapDestTable, slmSysAdminStatus=slmSysAdminStatus, slmAdminPassword=slmAdminPassword, slmSnmpv3Auth=slmSnmpv3Auth)
