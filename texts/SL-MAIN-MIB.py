...
Gauge32, Opaque, IpAddress, ObjectIdentity, iso, NotificationType, ModuleIdentity, TimeTicks, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "MibIdentifier")
TextualConvention, TruthValue, TimeStamp, RowStatus, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthEntry=slmAuthEntry, slmSwRevDate=slmSwRevDate, slmSysAlmDeact=slmSysAlmDeact, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmChPass=slmChPass, slmTrapLogEntry=slmTrapLogEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmSysChassisId=slmSysChassisId, slmAuthTable=slmAuthTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam5=slmTrapLogParam5, slmTrapPort=slmTrapPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmSysMode=slmSysMode, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam4=slmTrapLogParam4, slmSwRevName=slmSwRevName, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmAuth=slmAuth, slmSysLocation=slmSysLocation, slmSysAdminStatus=slmSysAdminStatus, slmLicenseIndex=slmLicenseIndex, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestTable=slmTrapDestTable, slmAdminLogin=slmAdminLogin, slmLicense=slmLicense, slmTrapLogParam3=slmTrapLogParam3, slmReadCommunity=slmReadCommunity, slmChPassTable=slmChPassTable, slmSyslogPort=slmSyslogPort, slmPsuNumber=slmPsuNumber, slmLicenseEntry=slmLicenseEntry, slmBoxSize=slmBoxSize, slmTrapCommunity=slmTrapCommunity, slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, slmNetworkMode=slmNetworkMode, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slm40GConf=slm40GConf, slmVcatDelay=slmVcatDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogId=slmTrapLogId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmSwRevTable=slmSwRevTable, slMain=slMain, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmAct=slmSysAlmAct, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthLogin=slmAuthLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPmAvailable=slmPmAvailable, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmLicenseTable=slmLicenseTable)
