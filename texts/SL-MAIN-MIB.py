...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmSysTrapFormat=slmSysTrapFormat, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassLogin=slmChPassLogin, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysLocation=slmSysLocation, slmTrapLogEntry=slmTrapLogEntry, slmTrap=slmTrap, slmSysIpAddr=slmSysIpAddr, slmAdmin=slmAdmin, slmSwRevTable=slmSwRevTable, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmSysAlmDeact=slmSysAlmDeact, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmTrapLogTable=slmTrapLogTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevEntry=slmSwRevEntry, slmMuxNumber=slmMuxNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmTrapLogName=slmTrapLogName, slmAuthTable=slmAuthTable, slmTrapLogParam4=slmTrapLogParam4, AdminAccess=AdminAccess, slmSysSubnetMask=slmSysSubnetMask, slmSys=slmSys, slmTrapPort=slmTrapPort, slmPmAvailable=slmPmAvailable, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmTrapUserLogin=slmTrapUserLogin, slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, PYSNMP_MODULE_ID=slMain, slmAuthEntry=slmAuthEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmAuth=slmAuth, slmLicenseIndex=slmLicenseIndex, slmChPassNewPass=slmChPassNewPass, slmSyslogDestAddress=slmSyslogDestAddress, slmNetworkMode=slmNetworkMode, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmLicenseEntry=slmLicenseEntry, slmPsuNumber=slmPsuNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminPassword=slmAdminPassword, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmChPassEntry=slmChPassEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPass=slmChPass, slmSysAlmAct=slmSysAlmAct, UserLogin=UserLogin, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysResetPm=slmSysResetPm, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmChPassTable=slmChPassTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapEnable=slmTrapEnable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRebootDelay=slmRebootDelay, slmTrapLogId=slmTrapLogId, slMain=slMain, slmSysChassisId=slmSysChassisId, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmWriteCommunity=slmWriteCommunity, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmLicense=slmLicense, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminTable=slmAdminTable, slmSysCalendarTime=slmSysCalendarTime)
