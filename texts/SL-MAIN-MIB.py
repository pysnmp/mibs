...
Bits, TimeTicks, iso, IpAddress, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Opaque, ObjectIdentity, Unsigned32, ModuleIdentity, MibIdentifier, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "iso", "IpAddress", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Opaque", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter64", "Gauge32")
RowStatus, TextualConvention, TimeStamp, DisplayString, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmVcatDelay=slmVcatDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassLogin=slmChPassLogin, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmSysUplinkRate=slmSysUplinkRate, slmSysTrapFormat=slmSysTrapFormat, slmAdminTable=slmAdminTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmSysTemperature=slmSysTemperature, slmSwRevDirectory=slmSwRevDirectory, slmSyslogPort=slmSyslogPort, slmAdminEntry=slmAdminEntry, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmBoxSize=slmBoxSize, slmLicense=slmLicense, slmChPassOldPass=slmChPassOldPass, slmTrapUserAccess=slmTrapUserAccess, UserPassword=UserPassword, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysName=slmSysName, slmOemType=slmOemType, slmConfigSysSignalType=slmConfigSysSignalType, slmTopologyEnabled=slmTopologyEnabled, slMain=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysUptime=slmConfigSysUptime, slmSysLocation=slmSysLocation, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, slmAuthCommunity=slmAuthCommunity, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAlmAct=slmSysAlmAct, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slmSysMode=slmSysMode, slmConfigFile=slmConfigFile, slmSnmpv3Password=slmSnmpv3Password, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysOperStatus=slmSysOperStatus, slmAuth=slmAuth, slmChPass=slmChPass, slmTrapCommunity=slmTrapCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmTrapLogParam4=slmTrapLogParam4, slmPmAvailable=slmPmAvailable, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, AdminAccess=AdminAccess, slmTrapEnable=slmTrapEnable, slmSyslogLevel=slmSyslogLevel, slmLicenseTable=slmLicenseTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogin=slmLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysIpAddr=slmSysIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmTrapLogTable=slmTrapLogTable, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmAdminCommunity=slmAdminCommunity, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevEntry=slmSwRevEntry, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmRstpEnabled=slmRstpEnabled)
