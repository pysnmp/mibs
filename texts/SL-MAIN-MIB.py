...
IpAddress, iso, Counter64, Integer32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, Opaque, Unsigned32, MibIdentifier, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Counter64", "Integer32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "Opaque", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysNameChange=slmTrapSysNameChange, slmSysName=slmSysName, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmAdminCommunity=slmAdminCommunity, slmTrapDestTable=slmTrapDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmChPass=slmChPass, slmAdminTable=slmAdminTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, UserCommunity=UserCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmPmAvailable=slmPmAvailable, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam1=slmTrapLogParam1, slmSysUplinkRate=slmSysUplinkRate, slmWriteCommunity=slmWriteCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam3=slmTrapLogParam3, UserPassword=UserPassword, slMain=slMain, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapEnable=slmTrapEnable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicense=slmLicense, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmLogin=slmLogin, slmLicenseIndex=slmLicenseIndex, slmSysActiveSwVersion=slmSysActiveSwVersion, slmReadCommunity=slmReadCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam4=slmTrapLogParam4, slmPortsNumber=slmPortsNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLocation=slmSysLocation, slmChPassTable=slmChPassTable, slmAuthTable=slmAuthTable, slmTrap=slmTrap, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, PYSNMP_MODULE_ID=slMain, slmAdminLogin=slmAdminLogin, AdminAccess=AdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode, slmAuth=slmAuth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevEntry=slmSwRevEntry, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmSysAdminStatus=slmSysAdminStatus, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevStatus=slmSwRevStatus, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slmSysSnmpVersion=slmSysSnmpVersion, UserLogin=UserLogin, slmAuthCommunity=slmAuthCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay, slmSyslogDestTable=slmSyslogDestTable, slmVcatDelay=slmVcatDelay, slmSyslogLevel=slmSyslogLevel, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName)
