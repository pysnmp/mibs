...
Unsigned32, ObjectIdentity, Opaque, NotificationType, Integer32, IpAddress, Bits, Counter32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Opaque", "NotificationType", "Integer32", "IpAddress", "Bits", "Counter32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmSwRevName=slmSwRevName, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmAct=slmSysAlmAct, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysTemperature=slmSysTemperature, slmLicenseExpiration=slmLicenseExpiration, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam6=slmTrapLogParam6, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmSyslogDestEntry=slmSyslogDestEntry, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassTable=slmChPassTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapCommunity=slmTrapCommunity, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmSys=slmSys, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmAuthLogin=slmAuthLogin, slmAdminAccess=slmAdminAccess, slmSysLocation=slmSysLocation, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slm40GConf=slm40GConf, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogId=slmTrapLogId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, PYSNMP_MODULE_ID=slMain, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevEntry=slmSwRevEntry, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmTrapLogParam1=slmTrapLogParam1, slmSysResetPm=slmSysResetPm, slmTrapSysNameChange=slmTrapSysNameChange, SoftwareRevision=SoftwareRevision, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmWriteCommunity=slmWriteCommunity, slmSysChassisId=slmSysChassisId, slmTrapDestAddress=slmTrapDestAddress, slmRebootDelay=slmRebootDelay, slmTrapLogParam2=slmTrapLogParam2, slmSyslogPort=slmSyslogPort, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmOemType=slmOemType, UserPassword=UserPassword, slmLogin=slmLogin, slmSyslogDestTable=slmSyslogDestTable, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slmAuth=slmAuth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPortsNumber=slmPortsNumber, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminEntry=slmAdminEntry, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, slmTrapEnable=slmTrapEnable, slmAuthPassword=slmAuthPassword, slmLicense=slmLicense, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmLicenseIndex=slmLicenseIndex, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slmAdmin=slmAdmin)
