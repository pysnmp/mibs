...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, Counter32, Bits, Unsigned32, Gauge32, TimeTicks, Counter64, Integer32, iso, NotificationType, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter32", "Bits", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "Integer32", "iso", "NotificationType", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthLogin=slmAuthLogin, slmLogFile=slmLogFile, slmAuth=slmAuth, slmSnmpv3Password=slmSnmpv3Password, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserPassword=UserPassword, UserLogin=UserLogin, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmChPassNewPass=slmChPassNewPass, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminRowStatus=slmAdminRowStatus, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmLicense=slmLicense, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmPmAvailable=slmPmAvailable, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmAuthEntry=slmAuthEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, PYSNMP_MODULE_ID=slMain, slmTrapDestAddress=slmTrapDestAddress, slmPsuNumber=slmPsuNumber, slmSysUplinkRate=slmSysUplinkRate, slmSyslogPort=slmSyslogPort, slmTrapLogName=slmTrapLogName, slmAdminEntry=slmAdminEntry, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam2=slmTrapLogParam2, slmRstpEnabled=slmRstpEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogLevel=slmSyslogLevel, slmSysCalendarTime=slmSysCalendarTime, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapCommunity=slmTrapCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevTable=slmSwRevTable, slmAdminLogin=slmAdminLogin, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrap=slmTrap, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseId=slmLicenseId, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmSys=slmSys, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmSwRevStatus=slmSwRevStatus, slmNetworkMode=slmNetworkMode, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysOperStatus=slmSysOperStatus, slmTrapPort=slmTrapPort, slmSysAlmAct=slmSysAlmAct, slmSysLocation=slmSysLocation, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassEntry=slmChPassEntry, slmTopologyEnabled=slmTopologyEnabled, slMain=slMain, slmBoxSize=slmBoxSize, slmAdmin=slmAdmin, AdminAccess=AdminAccess, SoftwareRevision=SoftwareRevision, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigFile=slmConfigFile, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slm40GConf=slm40GConf, slmAdminCommunity=slmAdminCommunity, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmEdfaNumber=slmEdfaNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapEnable=slmTrapEnable)
