...
ModuleIdentity, NotificationType, Bits, Integer32, Gauge32, Counter64, ObjectIdentity, Counter32, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Bits", "Integer32", "Gauge32", "Counter64", "ObjectIdentity", "Counter32", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Opaque", "IpAddress")
DisplayString, TimeStamp, TruthValue, TextualConvention, RowStatus, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmTrapLogParam3=slmTrapLogParam3, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmBoxSize=slmBoxSize, slmSysName=slmSysName, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmSysMode=slmSysMode, slmSysTemperature=slmSysTemperature, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmSysAlmDeact=slmSysAlmDeact, slmAdminRowStatus=slmAdminRowStatus, slmRebootDelay=slmRebootDelay, slmAuthTable=slmAuthTable, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmVcatDelay=slmVcatDelay, slmSyslogDestAddress=slmSyslogDestAddress, slmEdfaNumber=slmEdfaNumber, slmReadCommunity=slmReadCommunity, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmOemType=slmOemType, slmSysCalendarTime=slmSysCalendarTime, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmAct=slmSysAlmAct, UserPassword=UserPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthLogin=slmAuthLogin, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmTid=slmTid, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmAdminCommunity=slmAdminCommunity, slmAuthPassword=slmAuthPassword, slmSwRevDate=slmSwRevDate, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmTrapDestTable=slmTrapDestTable, slmSwRevTable=slmSwRevTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassEntry=slmChPassEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmLicenseIndex=slmLicenseIndex, slmTrapDestEntry=slmTrapDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminPassword=slmAdminPassword, slmAdminLogin=slmAdminLogin, slmSysIpAddr=slmSysIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogEntry=slmTrapLogEntry, slmTrap=slmTrap, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthCommunity=slmAuthCommunity, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapEnable=slmTrapEnable, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, PYSNMP_MODULE_ID=slMain, slmSysResetPm=slmSysResetPm, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmSwRevStatus=slmSwRevStatus, slmLogin=slmLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense)
