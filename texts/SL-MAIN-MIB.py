...
Bits, Unsigned32, iso, Integer32, NotificationType, TimeTicks, Opaque, ModuleIdentity, Counter64, MibIdentifier, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "Integer32", "NotificationType", "TimeTicks", "Opaque", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdmin=slmAdmin, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminEntry=slmAdminEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSys=slmSys, slmReadCommunity=slmReadCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber, slmTrapLogParam4=slmTrapLogParam4, slmBoxSize=slmBoxSize, slmTrapDestCommunity=slmTrapDestCommunity, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory, SoftwareRevision=SoftwareRevision, slmSwRevDate=slmSwRevDate, slmLogin=slmLogin, slmAdminLogin=slmAdminLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminCommunity=slmAdminCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmSysAlmAct=slmSysAlmAct, slmAuthCommunity=slmAuthCommunity, slmLicense=slmLicense, slmAdminPassword=slmAdminPassword, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmTrapLogParam6=slmTrapLogParam6, slmSwRevTable=slmSwRevTable, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevName=slmSwRevName, slm40GConf=slm40GConf, slmAuthPassword=slmAuthPassword, slmLicenseTable=slmLicenseTable, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmAdminRowStatus=slmAdminRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthLogin=slmAuthLogin, slmSysCalendarTime=slmSysCalendarTime, slmConfigFile=slmConfigFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapPort=slmTrapPort, slmTrapUserAccess=slmTrapUserAccess, slmChPassOldPass=slmChPassOldPass, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, slmSyslogLevel=slmSyslogLevel, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOemType=slmOemType, slmLicenseId=slmLicenseId, slmTrapDestTable=slmTrapDestTable, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrap=slmTrap, slmChPassEntry=slmChPassEntry, AdminAccess=AdminAccess, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmChPassTable=slmChPassTable, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmSysChassisId=slmSysChassisId, slmLicenseEntry=slmLicenseEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSwRevStatus=slmSwRevStatus, slmSysAdminStatus=slmSysAdminStatus, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmLicenseExpiration=slmLicenseExpiration, UserCommunity=UserCommunity, slmAdminAccess=slmAdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slMain=slMain, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr)
