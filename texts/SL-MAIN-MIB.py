...
Bits, IpAddress, Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, ObjectIdentity, Integer32, Counter64, NotificationType, ModuleIdentity, Opaque, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "ObjectIdentity", "Integer32", "Counter64", "NotificationType", "ModuleIdentity", "Opaque", "TimeTicks")
TruthValue, TimeStamp, TextualConvention, RowStatus, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOemType=slmOemType, slmAdmin=slmAdmin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmRebootDelay=slmRebootDelay, slmNetworkMode=slmNetworkMode, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmAdminCommunity=slmAdminCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmSysIpAddr=slmSysIpAddr, slmTrap=slmTrap, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmTrapUserAccess=slmTrapUserAccess, slmSwRevTable=slmSwRevTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmChPassLogin=slmChPassLogin, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLocation=slmSysLocation, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmLicense=slmLicense, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmBoxSize=slmBoxSize, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmLogFile=slmLogFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPmAvailable=slmPmAvailable, slmConfigSysSignalType=slmConfigSysSignalType, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassNewPass=slmChPassNewPass, slmLicenseEntry=slmLicenseEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminRowStatus=slmAdminRowStatus, slMain=slMain, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slmChPass=slmChPass, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSysUplinkRate=slmSysUplinkRate, slmLicenseTable=slmLicenseTable, SoftwareRevision=SoftwareRevision, slmLogin=slmLogin, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogId=slmTrapLogId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysChassisId=slmSysChassisId, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam1=slmTrapLogParam1, slmSysMode=slmSysMode, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTemperature=slmSysTemperature, slmTrapUserLogin=slmTrapUserLogin, slmEdfaNumber=slmEdfaNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmAdminAccess=slmAdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmSwRevEntry=slmSwRevEntry, slmVcatDelay=slmVcatDelay, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassTable=slmChPassTable, slmOpticalSwitchExist=slmOpticalSwitchExist)
