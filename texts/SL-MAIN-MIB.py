...
Gauge32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, IpAddress, Unsigned32, MibIdentifier, Integer32, Counter32, Bits, NotificationType, TimeTicks, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "IpAddress", "Unsigned32", "MibIdentifier", "Integer32", "Counter32", "Bits", "NotificationType", "TimeTicks", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogId=slmTrapLogId, slmBoxSize=slmBoxSize, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slmTrapLogTable=slmTrapLogTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthCommunity=slmAuthCommunity, slmPsuNumber=slmPsuNumber, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmAuth=slmAuth, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLogFile=slmLogFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysGatewayAddr=slmSysGatewayAddr, slmPmAvailable=slmPmAvailable, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserLogin=slmTrapUserLogin, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestTable=slmTrapDestTable, slmMuxNumber=slmMuxNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPortsNumber=slmPortsNumber, slmSysMode=slmSysMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, AdminAccess=AdminAccess, slmAdmin=slmAdmin, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmAuthLogin=slmAuthLogin, slmReadCommunity=slmReadCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, SoftwareRevision=SoftwareRevision, slmSysAlmAct=slmSysAlmAct, slmAdminLogin=slmAdminLogin, UserLogin=UserLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmEdfaNumber=slmEdfaNumber, slmLicense=slmLicense, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, UserPassword=UserPassword, slmTrap=slmTrap, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Password=slmSnmpv3Password, slmSwRevName=slmSwRevName, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmTid=slmTid, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, slmChPassTable=slmChPassTable, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmTrapLogName=slmTrapLogName, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmRebootDelay=slmRebootDelay, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Auth=slmSnmpv3Auth, slmSysTemperature=slmSysTemperature, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmSysAlmDeact=slmSysAlmDeact, slmSysActiveSwVersion=slmSysActiveSwVersion, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, UserCommunity=UserCommunity, slmSysCalendarTime=slmSysCalendarTime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysName=slmSysName, slmAdminCommunity=slmAdminCommunity, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
