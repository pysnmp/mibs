...
iso, IpAddress, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, Counter32, TimeTicks, ObjectIdentity, Counter64, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Counter32", "TimeTicks", "ObjectIdentity", "Counter64", "Bits", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", SoftwareRevision=SoftwareRevision, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanIpAddr=slmSysLanIpAddr, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassLogin=slmChPassLogin, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmSyslogLevel=slmSyslogLevel, slmAdminEntry=slmAdminEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTable=slmTrapLogTable, slmTopologyEnabled=slmTopologyEnabled, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmSys=slmSys, slmChPassTable=slmChPassTable, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysName=slmSysName, slmSysIpAddr=slmSysIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmChPassEntry=slmChPassEntry, slmReadCommunity=slmReadCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmSysCalendarTime=slmSysCalendarTime, slmAuthPassword=slmAuthPassword, slmTrapPort=slmTrapPort, slmAdminPassword=slmAdminPassword, slmAdminCommunity=slmAdminCommunity, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmEdfaNumber=slmEdfaNumber, slmSwRevDate=slmSwRevDate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminAccess=slmAdminAccess, slmAuthTable=slmAuthTable, slmOemType=slmOemType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slMain=slMain, slmTid=slmTid, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogName=slmTrapLogName, slmSwRevStatus=slmSwRevStatus, slmSysAdminStatus=slmSysAdminStatus, slmTrapCommunity=slmTrapCommunity, AdminAccess=AdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapEnable=slmTrapEnable, slmVcatDelay=slmVcatDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestTable=slmTrapDestTable, slmLogFile=slmLogFile, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, slmAuth=slmAuth, slmSysTemperature=slmSysTemperature, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmLicenseTable=slmLicenseTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPass=slmChPass, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmTrapLogParam3=slmTrapLogParam3, slmWriteCommunity=slmWriteCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmRstpEnabled=slmRstpEnabled, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysNameChange=slmTrapSysNameChange)
