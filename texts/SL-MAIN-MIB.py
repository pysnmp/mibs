...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmLicenseEntry=slmLicenseEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmAuth=slmAuth, slmTrapDestTable=slmTrapDestTable, slmSysSubnetMask=slmSysSubnetMask, slmLicenseIndex=slmLicenseIndex, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmTrapPort=slmTrapPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, slmBoxSize=slmBoxSize, slmAdminPassword=slmAdminPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Priv=slmSnmpv3Priv, slmSysMode=slmSysMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmSysAlmAct=slmSysAlmAct, PYSNMP_MODULE_ID=slMain, slmSwRevName=slmSwRevName, slmAdminEntry=slmAdminEntry, slmLogin=slmLogin, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmConfigFile=slmConfigFile, slmSysAlmDeact=slmSysAlmDeact, UserCommunity=UserCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseExpiration=slmLicenseExpiration, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam1=slmTrapLogParam1, slmSysIpAddr=slmSysIpAddr, slmAdminAccess=slmAdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmTid=slmTid, slmTrapDestIpAddress=slmTrapDestIpAddress, slMain=slMain, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmAuthEntry=slmAuthEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSys=slmSys, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigSysUptime=slmConfigSysUptime, slmSysResetPm=slmSysResetPm, slmTrapCommunity=slmTrapCommunity, slmSwRevStatus=slmSwRevStatus, slmChPassOldPass=slmChPassOldPass, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogName=slmTrapLogName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmWriteCommunity=slmWriteCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmChPass=slmChPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevTable=slmSwRevTable, slmSwRevEntry=slmSwRevEntry, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmPmAvailable=slmPmAvailable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserLogin=slmTrapUserLogin, UserLogin=UserLogin, slmAuthTable=slmAuthTable, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSysChassisId=slmSysChassisId, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmOemType=slmOemType, slmTrapEnable=slmTrapEnable, slmLogFile=slmLogFile, slmAdmin=slmAdmin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slmLicenseTable=slmLicenseTable, slmTrapDestEntry=slmTrapDestEntry, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmAdminRowStatus=slmAdminRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmLicense=slmLicense)
