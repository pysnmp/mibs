...
NotificationType, Counter64, Opaque, Counter32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ObjectIdentity, IpAddress, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Opaque", "Counter32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ObjectIdentity", "IpAddress", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmSyslogPort=slmSyslogPort, slmAuth=slmAuth, slmTrapLogParam2=slmTrapLogParam2, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmSysUplinkRate=slmSysUplinkRate, slmAuthTable=slmAuthTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam3=slmTrapLogParam3, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmLicenseIndex=slmLicenseIndex, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmSwRevStatus=slmSwRevStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, UserCommunity=UserCommunity, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmSnmpv3Password=slmSnmpv3Password, SoftwareRevision=SoftwareRevision, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slmBoxSize=slmBoxSize, slmSysAlmAct=slmSysAlmAct, slmTrapPort=slmTrapPort, slmSwRevName=slmSwRevName, slmChPass=slmChPass, slmSysChassisId=slmSysChassisId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapUserLogin=slmTrapUserLogin, slmSysName=slmSysName, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmSys=slmSys, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, PYSNMP_MODULE_ID=slMain, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapCommunity=slmTrapCommunity, slmPsuNumber=slmPsuNumber, slmSysTemperature=slmSysTemperature, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmReadCommunity=slmReadCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestTable=slmTrapDestTable, slmSysOperStatus=slmSysOperStatus, slmTrapDestEntry=slmTrapDestEntry, AdminAccess=AdminAccess, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseExpiration=slmLicenseExpiration, slmAdmin=slmAdmin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam4=slmTrapLogParam4, slmLogin=slmLogin, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmTid=slmTid, slmSwRevTable=slmSwRevTable, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmAuthPassword=slmAuthPassword, slmTrapLogTable=slmTrapLogTable, slmAuthLogin=slmAuthLogin, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, UserPassword=UserPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseId=slmLicenseId, slmTrapUserAccess=slmTrapUserAccess)
