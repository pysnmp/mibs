...
iso, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ModuleIdentity, Counter32, Bits, ObjectIdentity, MibIdentifier, IpAddress, Integer32, Counter64, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "IpAddress", "Integer32", "Counter64", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmAuthTable=slmAuthTable, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, AdminAccess=AdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmOemType=slmOemType, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmConfigFile=slmConfigFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthCommunity=slmAuthCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmSysResetPm=slmSysResetPm, slmTrapLogTable=slmTrapLogTable, slmSyslogPort=slmSyslogPort, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slmSysIpAddr=slmSysIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTid=slmTid, slmSysLocation=slmSysLocation, slmTrapEnable=slmTrapEnable, slmSysTemperature=slmSysTemperature, slmBoxSize=slmBoxSize, slmSysName=slmSysName, slmSysLanIpAddr=slmSysLanIpAddr, slmRstpEnabled=slmRstpEnabled, slmMuxNumber=slmMuxNumber, slmSysMode=slmSysMode, UserCommunity=UserCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayAddr=slmSysGatewayAddr, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmVcatDelay=slmVcatDelay, slmTrapPort=slmTrapPort, slmSysTrapFormat=slmSysTrapFormat, slmLicenseId=slmLicenseId, slmTrapLogName=slmTrapLogName, slmChPass=slmChPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserAccess=slmTrapUserAccess, slmSysAdminStatus=slmSysAdminStatus, slmLogFile=slmLogFile, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthEntry=slmAuthEntry, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slMain=slMain, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmSysOperStatus=slmSysOperStatus, SoftwareRevision=SoftwareRevision, slmSnmpv3Password=slmSnmpv3Password, slmLicense=slmLicense, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmAdminLogin=slmAdminLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrap=slmTrap, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPmAvailable=slmPmAvailable, slmAuthLogin=slmAuthLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmEdfaNumber=slmEdfaNumber, slmPsuNumber=slmPsuNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam4=slmTrapLogParam4, slm40GConf=slm40GConf, slmSwRevStatus=slmSwRevStatus, slmTrapLogId=slmTrapLogId, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Priv=slmSnmpv3Priv)
