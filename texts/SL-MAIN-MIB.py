...
Unsigned32, ModuleIdentity, Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Bits, Counter32, iso, Gauge32, Integer32, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Bits", "Counter32", "iso", "Gauge32", "Integer32", "Opaque", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestEntry=slmSyslogDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmPmAvailable=slmPmAvailable, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmConfigFile=slmConfigFile, slmAuthTable=slmAuthTable, slmSysResetPm=slmSysResetPm, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmTrapEnable=slmTrapEnable, slmSwRevStatus=slmSwRevStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrap=slmTrap, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, UserPassword=UserPassword, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSnmpVersion=slmSysSnmpVersion, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, UserLogin=UserLogin, slmLicenseExpiration=slmLicenseExpiration, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmReadCommunity=slmReadCommunity, slmChPassEntry=slmChPassEntry, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmBoxSize=slmBoxSize, slmPortsNumber=slmPortsNumber, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmSysUplinkRate=slmSysUplinkRate, slmAdminCommunity=slmAdminCommunity, slm40GConf=slm40GConf, slmSyslogPort=slmSyslogPort, slmTrapDestAddress=slmTrapDestAddress, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmAdmin=slmAdmin, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassOldPass=slmChPassOldPass, slmAdminAccess=slmAdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Password=slmSnmpv3Password, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slmTrapDestEntry=slmTrapDestEntry, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSys=slmSys, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmAuthLogin=slmAuthLogin, slMain=slMain, slmConfigSysUptime=slmConfigSysUptime, slmSysAdminStatus=slmSysAdminStatus, slmSysLocation=slmSysLocation, slmAuth=slmAuth, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogName=slmTrapLogName, slmAdminEntry=slmAdminEntry, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmEdfaNumber=slmEdfaNumber, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam2=slmTrapLogParam2, slmSyslogLevel=slmSyslogLevel, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRstpEnabled=slmRstpEnabled, slmChPassNewPass=slmChPassNewPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmRebootDelay=slmRebootDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogEntry=slmTrapLogEntry, slmMuxNumber=slmMuxNumber)
