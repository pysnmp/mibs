...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, TimeTicks, MibIdentifier, Integer32, iso, Gauge32, Bits, ObjectIdentity, ModuleIdentity, NotificationType, Unsigned32, Opaque, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "TimeTicks", "MibIdentifier", "Integer32", "iso", "Gauge32", "Bits", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Unsigned32", "Opaque", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmMuxNumber=slmMuxNumber, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, slmSysOperStatus=slmSysOperStatus, slmWriteCommunity=slmWriteCommunity, slmTrap=slmTrap, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminTable=slmAdminTable, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmTid=slmTid, slmLicenseTable=slmLicenseTable, slmSysName=slmSysName, slmLicenseExpiration=slmLicenseExpiration, slmSysTrapFormat=slmSysTrapFormat, slmSysLocation=slmSysLocation, slmConfigSysUptime=slmConfigSysUptime, slmSysIpAddr=slmSysIpAddr, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSwRevStatus=slmSwRevStatus, slmConfigFile=slmConfigFile, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmEdfaNumber=slmEdfaNumber, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthEntry=slmAuthEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmPortsNumber=slmPortsNumber, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmChPassTable=slmChPassTable, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevName=slmSwRevName, slmAdminAccess=slmAdminAccess, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmAuthTable=slmAuthTable, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapPort=slmTrapPort, slmAdminLogin=slmAdminLogin, slmAuthPassword=slmAuthPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, PYSNMP_MODULE_ID=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmSysUplinkRate=slmSysUplinkRate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysResetPm=slmSysResetPm, slMain=slMain, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmTrapLogParam4=slmTrapLogParam4, slmAuth=slmAuth, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmSwRevDate=slmSwRevDate, slmRstpEnabled=slmRstpEnabled, AdminAccess=AdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmChPassOldPass=slmChPassOldPass, slmLogFile=slmLogFile, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmNetworkMode=slmNetworkMode, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass)
