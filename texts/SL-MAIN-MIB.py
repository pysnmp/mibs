...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, iso, IpAddress, Opaque, Bits, Counter64, ObjectIdentity, Unsigned32, Counter32, ModuleIdentity, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "iso", "IpAddress", "Opaque", "Bits", "Counter64", "ObjectIdentity", "Unsigned32", "Counter32", "ModuleIdentity", "NotificationType", "MibIdentifier")
TruthValue, RowStatus, TimeStamp, DateAndTime, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "DateAndTime", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseTable=slmLicenseTable, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapPort=slmTrapPort, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSysCalendarTime=slmSysCalendarTime, slmWriteCommunity=slmWriteCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapLogName=slmTrapLogName, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmReadCommunity=slmReadCommunity, slmSysChassisId=slmSysChassisId, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry, slmRebootDelay=slmRebootDelay, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmChPassNewPass=slmChPassNewPass, slmTrapEnable=slmTrapEnable, slmTrapLogParam6=slmTrapLogParam6, slmTrap=slmTrap, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmSysMode=slmSysMode, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigFile=slmConfigFile, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmChPassEntry=slmChPassEntry, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmLogFile=slmLogFile, slMain=slMain, UserCommunity=UserCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmAct=slmSysAlmAct, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmAdminLogin=slmAdminLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmMuxNumber=slmMuxNumber, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLocation=slmSysLocation, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmBoxSize=slmBoxSize, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDate=slmSwRevDate, slmChPassLogin=slmChPassLogin, UserLogin=UserLogin, slmPortsNumber=slmPortsNumber, slmSwRevTable=slmSwRevTable, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmAdminAccess=slmAdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmSysOperStatus=slmSysOperStatus, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestAddress=slmSyslogDestAddress, AdminAccess=AdminAccess, slmPsuNumber=slmPsuNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmTrapLogParam4=slmTrapLogParam4, slmAuth=slmAuth, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmSys=slmSys, slmAdminCommunity=slmAdminCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysName=slmSysName, UserPassword=UserPassword, slmSwRevEntry=slmSwRevEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthLogin=slmAuthLogin, slmVcatDelay=slmVcatDelay, slmTrapLogId=slmTrapLogId, slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode)
