...
NotificationType, iso, Counter64, ModuleIdentity, ObjectIdentity, Gauge32, MibIdentifier, Bits, Opaque, Unsigned32, Counter32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter64", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibIdentifier", "Bits", "Opaque", "Unsigned32", "Counter32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigFile=slmConfigFile, slmChPassLogin=slmChPassLogin, slmTrapLogName=slmTrapLogName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevName=slmSwRevName, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassNewPass=slmChPassNewPass, slmSysTrapFormat=slmSysTrapFormat, slmSysChassisId=slmSysChassisId, slmSnmpv3Password=slmSnmpv3Password, slmSysName=slmSysName, slmReadCommunity=slmReadCommunity, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmTrapDestAddress=slmTrapDestAddress, slmWriteCommunity=slmWriteCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapEnable=slmTrapEnable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayAddr=slmSysGatewayAddr, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmAct=slmSysAlmAct, slmAuthPassword=slmAuthPassword, slmSysAlmDeact=slmSysAlmDeact, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmTrapLogParam2=slmTrapLogParam2, slmSyslogLevel=slmSyslogLevel, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminCommunity=slmAdminCommunity, slmEdfaNumber=slmEdfaNumber, slmTid=slmTid, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, UserCommunity=UserCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAdminStatus=slmSysAdminStatus, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSys=slmSys, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmAdminRowStatus=slmAdminRowStatus, slmChPass=slmChPass, UserPassword=UserPassword, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassTable=slmChPassTable, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, SoftwareRevision=SoftwareRevision, slmVcatDelay=slmVcatDelay, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmAdminEntry=slmAdminEntry, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slmAdminPassword=slmAdminPassword, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmOemType=slmOemType, slmAdminTable=slmAdminTable, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmLogFile=slmLogFile, slm40GConf=slm40GConf, slmTrapDestTable=slmTrapDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseExpiration=slmLicenseExpiration, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmSysMode=slmSysMode, slmAdmin=slmAdmin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slMain=slMain, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmLicense=slmLicense, slmSysIpAddr=slmSysIpAddr, slmLicenseTable=slmLicenseTable, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmSysOperStatus=slmSysOperStatus, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
