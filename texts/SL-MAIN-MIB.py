...
Gauge32, IpAddress, Integer32, Counter64, Opaque, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Integer32", "Counter64", "Opaque", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter32", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminLogin=slmAdminLogin, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassTable=slmChPassTable, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmTrap=slmTrap, slmTrapEnable=slmTrapEnable, slmAdminPassword=slmAdminPassword, slmConfigSysUptime=slmConfigSysUptime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmTrapLogTable=slmTrapLogTable, slmReadCommunity=slmReadCommunity, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam6=slmTrapLogParam6, slmPmAvailable=slmPmAvailable, slmLicenseExpiration=slmLicenseExpiration, slmSysLocation=slmSysLocation, slmSys=slmSys, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmTrapPort=slmTrapPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogId=slmTrapLogId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthCommunity=slmAuthCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthEntry=slmAuthEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, AdminAccess=AdminAccess, slmSwRevTable=slmSwRevTable, slmTrapDestTable=slmTrapDestTable, slmSyslogLevel=slmSyslogLevel, slmSwRevEntry=slmSwRevEntry, slmSysName=slmSysName, slmPsuNumber=slmPsuNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysMode=slmSysMode, slmChPassNewPass=slmChPassNewPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmTid=slmTid, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmRebootDelay=slmRebootDelay, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmLicenseTable=slmLicenseTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword, slmMuxNumber=slmMuxNumber, slmLicenseEntry=slmLicenseEntry, slm40GConf=slm40GConf, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmAuthTable=slmAuthTable, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysNameChange=slmTrapSysNameChange, slMain=slMain, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogin=slmLogin, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAdminStatus=slmSysAdminStatus, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanIpAddr=slmSysLanIpAddr)
