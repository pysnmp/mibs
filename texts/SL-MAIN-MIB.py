...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmAct=slmSysAlmAct, slmAuthEntry=slmAuthEntry, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmSwRevDirectory=slmSwRevDirectory, slmPmAvailable=slmPmAvailable, slmChPassOldPass=slmChPassOldPass, slmTrapDestEntry=slmTrapDestEntry, slmAuthLogin=slmAuthLogin, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmSysSubnetMask=slmSysSubnetMask, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, PYSNMP_MODULE_ID=slMain, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, AdminAccess=AdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, slmSyslogDestTable=slmSyslogDestTable, slmAdminTable=slmAdminTable, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmSwRevStatus=slmSwRevStatus, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slm40GConf=slm40GConf, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmSysName=slmSysName, slmLogFile=slmLogFile, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmSysChassisId=slmSysChassisId, slmTrapCommunity=slmTrapCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, UserCommunity=UserCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestAddress=slmSyslogDestAddress, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigFile=slmConfigFile, slmChPassNewPass=slmChPassNewPass, slmSysCalendarTime=slmSysCalendarTime, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slmTrapUserAccess=slmTrapUserAccess, slmOemType=slmOemType, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmChPass=slmChPass, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmAdminEntry=slmAdminEntry, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseTable=slmLicenseTable, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmTopologyEnabled=slmTopologyEnabled, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserLogin=UserLogin, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdmin=slmAdmin, slmSysIpAddr=slmSysIpAddr, slmSysLocation=slmSysLocation, slmSysSnmpVersion=slmSysSnmpVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysOperStatus=slmSysOperStatus, slmTrap=slmTrap, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmTrapDestTable=slmTrapDestTable, slmVcatDelay=slmVcatDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassTable=slmChPassTable)
