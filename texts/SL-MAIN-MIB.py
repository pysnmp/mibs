...
Counter32, IpAddress, iso, Opaque, ObjectIdentity, Unsigned32, Gauge32, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, MibIdentifier, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "iso", "Opaque", "ObjectIdentity", "Unsigned32", "Gauge32", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "MibIdentifier", "TimeTicks", "Bits")
DateAndTime, DisplayString, TextualConvention, TruthValue, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmTrap=slmTrap, slmSwRevDate=slmSwRevDate, slmSysLanIpAddr=slmSysLanIpAddr, slmLicense=slmLicense, slmTrapLogId=slmTrapLogId, UserLogin=UserLogin, slMain=slMain, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmOemType=slmOemType, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmAuth=slmAuth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmOpticalSwitchExist=slmOpticalSwitchExist, AdminAccess=AdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysMode=slmSysMode, slmAuthPassword=slmAuthPassword, slmSyslogDestTable=slmSyslogDestTable, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmTrapLogParam3=slmTrapLogParam3, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmAdminTable=slmAdminTable, slmAdminEntry=slmAdminEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmEdfaNumber=slmEdfaNumber, slmChPassOldPass=slmChPassOldPass, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmLogin=slmLogin, slmNetworkMode=slmNetworkMode, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevEntry=slmSwRevEntry, slmAdminCommunity=slmAdminCommunity, slmConfigFile=slmConfigFile, SoftwareRevision=SoftwareRevision, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Password=slmSnmpv3Password, slmWriteCommunity=slmWriteCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmRebootDelay=slmRebootDelay, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmLogFile=slmLogFile, slmAdmin=slmAdmin, slmMuxNumber=slmMuxNumber, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmDeact=slmSysAlmDeact, slmSysLocation=slmSysLocation, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmRstpEnabled=slmRstpEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam2=slmTrapLogParam2, slmChPassLogin=slmChPassLogin, slmLicenseEntry=slmLicenseEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSwRevTable=slmSwRevTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysName=slmSysName, slmChPassTable=slmChPassTable, slmTrapLogParam4=slmTrapLogParam4)
