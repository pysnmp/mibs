...
iso, Integer32, NotificationType, TimeTicks, Counter32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Gauge32, Unsigned32, Bits, IpAddress, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "NotificationType", "TimeTicks", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Gauge32", "Unsigned32", "Bits", "IpAddress", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminTable=slmAdminTable, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmWriteCommunity=slmWriteCommunity, slmRstpEnabled=slmRstpEnabled, UserCommunity=UserCommunity, slmTrapDestAddress=slmTrapDestAddress, slmLogin=slmLogin, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmAct=slmSysAlmAct, slmVcatDelay=slmVcatDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminAccess=slmAdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmBoxSize=slmBoxSize, AdminAccess=AdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevTable=slmSwRevTable, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmSyslogLevel=slmSyslogLevel, slmSysName=slmSysName, slmReadCommunity=slmReadCommunity, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmTrapSysNameChange=slmTrapSysNameChange, slmEdfaNumber=slmEdfaNumber, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmChPass=slmChPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmChPassTable=slmChPassTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmSys=slmSys, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmConfigFile=slmConfigFile, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmTrapUserLogin=slmTrapUserLogin, PYSNMP_MODULE_ID=slMain, slmAuthLogin=slmAuthLogin, slmPsuNumber=slmPsuNumber, slmLicenseIndex=slmLicenseIndex, slmTrapDestTable=slmTrapDestTable, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmAdminCommunity=slmAdminCommunity, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slMain=slMain, slmSwRevDate=slmSwRevDate, slmPmAvailable=slmPmAvailable, slmTrapLogName=slmTrapLogName)
