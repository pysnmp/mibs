...
ModuleIdentity, Unsigned32, Gauge32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, MibIdentifier, Integer32, Counter32, Opaque, Bits, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "Counter32", "Opaque", "Bits", "TimeTicks", "iso")
TextualConvention, TimeStamp, TruthValue, RowStatus, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "RowStatus", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDirectory=slmSwRevDirectory, slmVcatDelay=slmVcatDelay, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSys=slmSys, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmRebootDelay=slmRebootDelay, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, slmTrap=slmTrap, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminPassword=slmAdminPassword, slmAuthEntry=slmAuthEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTid=slmTid, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmSwRevName=slmSwRevName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminLogin=slmAdminLogin, UserLogin=UserLogin, UserPassword=UserPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTable=slmTrapLogTable, slmSwRevStatus=slmSwRevStatus, slmAdminEntry=slmAdminEntry, slmSysTemperature=slmSysTemperature, slmChPassTable=slmChPassTable, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmConfigFile=slmConfigFile, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmMuxNumber=slmMuxNumber, slmLicenseEntry=slmLicenseEntry, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmSysIpAddr=slmSysIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPmAvailable=slmPmAvailable, slmSysMode=slmSysMode, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmLogFile=slmLogFile, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmTrapDestTable=slmTrapDestTable, slmOemType=slmOemType, slmLicenseIndex=slmLicenseIndex, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin)
