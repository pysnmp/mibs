...
Opaque, ObjectIdentity, TimeTicks, NotificationType, Gauge32, Counter64, IpAddress, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, iso, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ObjectIdentity", "TimeTicks", "NotificationType", "Gauge32", "Counter64", "IpAddress", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "iso", "Integer32", "ModuleIdentity")
RowStatus, TimeStamp, DisplayString, TruthValue, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "TruthValue", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminAccess=slmAdminAccess, slmAuthEntry=slmAuthEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmChPass=slmChPass, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmSyslogDestAddress=slmSyslogDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmLogFile=slmLogFile, slmChPassEntry=slmChPassEntry, UserPassword=UserPassword, slmSysMode=slmSysMode, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmWriteCommunity=slmWriteCommunity, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmSysName=slmSysName, slmAuth=slmAuth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry, slmAdmin=slmAdmin, slm40GConf=slm40GConf, slmTrapLogParam3=slmTrapLogParam3, slmChPassTable=slmChPassTable, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Password=slmSnmpv3Password, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmSysLocation=slmSysLocation, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserLogin=slmTrapUserLogin, slmTopologyEnabled=slmTopologyEnabled, slmChPassLogin=slmChPassLogin, slmChPassOldPass=slmChPassOldPass, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmAuthCommunity=slmAuthCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, AdminAccess=AdminAccess, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmTid=slmTid, slmPmAvailable=slmPmAvailable, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigFile=slmConfigFile, slmTrapCommunity=slmTrapCommunity, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmLicense=slmLicense, slmTrapDestTable=slmTrapDestTable, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmTrapUserAccess=slmTrapUserAccess, slmSysIpAddr=slmSysIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmSysTemperature=slmSysTemperature, slmEdfaNumber=slmEdfaNumber)
