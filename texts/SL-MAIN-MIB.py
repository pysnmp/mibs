...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, Gauge32, TimeTicks, Counter64, ModuleIdentity, Counter32, iso, MibIdentifier, NotificationType, IpAddress, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "ModuleIdentity", "Counter32", "iso", "MibIdentifier", "NotificationType", "IpAddress", "Opaque")
TruthValue, TextualConvention, DateAndTime, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DateAndTime", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevDate=slmSwRevDate, slmSysAlmAct=slmSysAlmAct, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTid=slmTid, slmTrapLogParam5=slmTrapLogParam5, slmAuthEntry=slmAuthEntry, slmSysName=slmSysName, slmChPassTable=slmChPassTable, slmTrapCommunity=slmTrapCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmSnmpv3Password=slmSnmpv3Password, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestTable=slmSyslogDestTable, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmTrapUserLogin=slmTrapUserLogin, slmAdminTable=slmAdminTable, slmAuthPassword=slmAuthPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthCommunity=slmAuthCommunity, slmAdminEntry=slmAdminEntry, slmTrapEnable=slmTrapEnable, slmAdminPassword=slmAdminPassword, slmLicenseTable=slmLicenseTable, slmLogin=slmLogin, slmAuth=slmAuth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestAddress=slmTrapDestAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin, slmNetworkMode=slmNetworkMode, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, slmSysAlmDeact=slmSysAlmDeact, slmPsuNumber=slmPsuNumber, slmLicenseExpiration=slmLicenseExpiration, slmMuxNumber=slmMuxNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrap=slmTrap, slmTrapLogParam1=slmTrapLogParam1, slmRstpEnabled=slmRstpEnabled, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slmOemType=slmOemType, slmTrapUserAccess=slmTrapUserAccess, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmSys=slmSys, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdmin=slmAdmin, UserLogin=UserLogin, slmConfigFile=slmConfigFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmTrapLogParam4=slmTrapLogParam4, slmSysIpAddr=slmSysIpAddr, UserCommunity=UserCommunity, slmLicense=slmLicense, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysChassisId=slmSysChassisId, slmLogFile=slmLogFile, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmChPassLogin=slmChPassLogin, slm40GConf=slm40GConf, slmConfigSysUptime=slmConfigSysUptime, slmSysTemperature=slmSysTemperature, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmTrapDestEntry=slmTrapDestEntry, slmSwRevEntry=slmSwRevEntry, slmSwRevDirectory=slmSwRevDirectory, slmVcatDelay=slmVcatDelay, slmWriteCommunity=slmWriteCommunity, slmSwRevName=slmSwRevName, slmSyslogDestEntry=slmSyslogDestEntry, slmPortsNumber=slmPortsNumber, slmSysUplinkRate=slmSysUplinkRate, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAdminStatus=slmSysAdminStatus, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, slMain=slMain)
