...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestEntry=slmTrapDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmPortsNumber=slmPortsNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPass=slmChPass, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, PYSNMP_MODULE_ID=slMain, slmTrapLogParam5=slmTrapLogParam5, slmTid=slmTid, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTable=slmTrapLogTable, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, UserPassword=UserPassword, slmAdminCommunity=slmAdminCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDate=slmSwRevDate, slmChPassLogin=slmChPassLogin, slmChPassOldPass=slmChPassOldPass, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, AdminAccess=AdminAccess, slmAuth=slmAuth, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogPort=slmSyslogPort, slmLicense=slmLicense, slmSyslogLevel=slmSyslogLevel, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmTrapLogName=slmTrapLogName, slmLicenseTable=slmLicenseTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapPort=slmTrapPort, slmSwRevEntry=slmSwRevEntry, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassNewPass=slmChPassNewPass, slmLogin=slmLogin, slm40GConf=slm40GConf, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmAdmin=slmAdmin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, slmLicenseEntry=slmLicenseEntry, slmSwRevTable=slmSwRevTable, slmTrapLogParam2=slmTrapLogParam2, slmTrap=slmTrap, slmSysActiveSwVersion=slmSysActiveSwVersion, slmWriteCommunity=slmWriteCommunity, slmVcatDelay=slmVcatDelay, slmAuthCommunity=slmAuthCommunity, slmPmAvailable=slmPmAvailable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmAdminLogin=slmAdminLogin, slmTopologyEnabled=slmTopologyEnabled, slmSysUplinkRate=slmSysUplinkRate, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserCommunity=UserCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmMuxNumber=slmMuxNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmReadCommunity=slmReadCommunity, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAlmAct=slmSysAlmAct, slmSysMode=slmSysMode, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, slmAdminTable=slmAdminTable, slmTrapUserAccess=slmTrapUserAccess, slmSysTemperature=slmSysTemperature, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestAddress=slmTrapDestAddress, slmConfigFile=slmConfigFile, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, slmSysChassisId=slmSysChassisId)
