...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, slmTid=slmTid, slmTrap=slmTrap, slmPsuNumber=slmPsuNumber, slmAdminCommunity=slmAdminCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmAuth=slmAuth, slmChPassTable=slmChPassTable, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogin=slmLogin, slmSysCalendarTime=slmSysCalendarTime, slmSwRevName=slmSwRevName, slmSysName=slmSysName, slmPmAvailable=slmPmAvailable, slmTrapLogParam3=slmTrapLogParam3, slmSysTrapFormat=slmSysTrapFormat, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassOldPass=slmChPassOldPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Password=slmSnmpv3Password, UserPassword=UserPassword, slmLicenseExpiration=slmLicenseExpiration, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmAuthPassword=slmAuthPassword, slmSysChassisId=slmSysChassisId, slmTrapEnable=slmTrapEnable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmNetworkMode=slmNetworkMode, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassLogin=slmChPassLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPass=slmChPass, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam4=slmTrapLogParam4, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTemperature=slmSysTemperature, slmLicense=slmLicense, slmTrapCommunity=slmTrapCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseEntry=slmLicenseEntry, slmRebootDelay=slmRebootDelay, slmTrapPort=slmTrapPort, slmMuxNumber=slmMuxNumber, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin, slmLicenseTable=slmLicenseTable, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slMain=slMain, slmVcatDelay=slmVcatDelay, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, UserCommunity=UserCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
