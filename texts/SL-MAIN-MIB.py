...
ModuleIdentity, Integer32, Opaque, iso, Unsigned32, Gauge32, TimeTicks, NotificationType, Bits, IpAddress, Counter32, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Opaque", "iso", "Unsigned32", "Gauge32", "TimeTicks", "NotificationType", "Bits", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, RowStatus, DisplayString, TimeStamp, TextualConvention, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogLevel=slmSyslogLevel, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysName=slmSysName, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmTrapLogTable=slmTrapLogTable, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmPmAvailable=slmPmAvailable, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, UserCommunity=UserCommunity, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogId=slmTrapLogId, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseTable=slmLicenseTable, slmSwRevEntry=slmSwRevEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmSwRevTable=slmSwRevTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmPortsNumber=slmPortsNumber, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmTrapLogParam6=slmTrapLogParam6, AdminAccess=AdminAccess, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmChPassLogin=slmChPassLogin, slmChPassTable=slmChPassTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, slmRebootDelay=slmRebootDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmAdminRowStatus=slmAdminRowStatus, slmLogin=slmLogin, slmSysTrapFormat=slmSysTrapFormat, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmSwRevName=slmSwRevName, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmTid=slmTid, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysMode=slmSysMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthTable=slmAuthTable, slmVcatDelay=slmVcatDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmTrapLogParam3=slmTrapLogParam3, slmBoxSize=slmBoxSize, slmAdminTable=slmAdminTable, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmSysOperStatus=slmSysOperStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminCommunity=slmAdminCommunity)
