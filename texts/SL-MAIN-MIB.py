...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter64, Bits, Opaque, iso, NotificationType, Integer32, TimeTicks, IpAddress, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "Opaque", "iso", "NotificationType", "Integer32", "TimeTicks", "IpAddress", "Unsigned32", "Counter32", "Gauge32")
TruthValue, TimeStamp, RowStatus, DateAndTime, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "RowStatus", "DateAndTime", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam3=slmTrapLogParam3, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmLogin=slmLogin, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevStatus=slmSwRevStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmSysResetPm=slmSysResetPm, slmPmAvailable=slmPmAvailable, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, slmSysMode=slmSysMode, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmTrapLogTable=slmTrapLogTable, UserPassword=UserPassword, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmChPassOldPass=slmChPassOldPass, slmNetworkMode=slmNetworkMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrap=slmTrap, slmSysName=slmSysName, slmSyslogPort=slmSyslogPort, slmChPassTable=slmChPassTable, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Priv=slmSnmpv3Priv, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminAccess=slmAdminAccess, slmEdfaNumber=slmEdfaNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam4=slmTrapLogParam4, slmTid=slmTid, slmSysTemperature=slmSysTemperature, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmSyslogLevel=slmSyslogLevel, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmLicense=slmLicense, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmAdminTable=slmAdminTable, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdmin=slmAdmin, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogId=slmTrapLogId, slmSwRevName=slmSwRevName, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLocation=slmSysLocation, slmSysOperStatus=slmSysOperStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, slmBoxSize=slmBoxSize, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmSwRevTable=slmSwRevTable, slmAuthPassword=slmAuthPassword, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmTrapPort=slmTrapPort, slmSysChassisId=slmSysChassisId, slmTrapLogParam2=slmTrapLogParam2, slmSysTrapFormat=slmSysTrapFormat, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmAdminPassword=slmAdminPassword, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminCommunity=slmAdminCommunity)
