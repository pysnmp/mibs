...
iso, NotificationType, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, TimeTicks, ModuleIdentity, MibIdentifier, IpAddress, Counter64, ObjectIdentity, Opaque, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "IpAddress", "Counter64", "ObjectIdentity", "Opaque", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuth=slmAuth, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmNetworkMode=slmNetworkMode, slmTrapLogEntry=slmTrapLogEntry, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmChPassEntry=slmChPassEntry, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmChPassLogin=slmChPassLogin, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct, slmSysChassisId=slmSysChassisId, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, SoftwareRevision=SoftwareRevision, slmRebootDelay=slmRebootDelay, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam5=slmTrapLogParam5, slmLicenseId=slmLicenseId, slmTrapDestTable=slmTrapDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmBoxSize=slmBoxSize, slmSwRevName=slmSwRevName, slmLicenseTable=slmLicenseTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPmAvailable=slmPmAvailable, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmLogin=slmLogin, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, UserLogin=UserLogin, slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapUserLogin=slmTrapUserLogin, slmSysName=slmSysName, slmAdminLogin=slmAdminLogin, slmWriteCommunity=slmWriteCommunity, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmAuthLogin=slmAuthLogin, slmOemType=slmOemType, slmTrapLogId=slmTrapLogId, slmSysResetPm=slmSysResetPm, slmSyslogDestTable=slmSyslogDestTable, slmLicenseEntry=slmLicenseEntry, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmTid=slmTid, slmSysMode=slmSysMode, UserPassword=UserPassword, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmPortsNumber=slmPortsNumber, slmSysCalendarTime=slmSysCalendarTime, slmSwRevEntry=slmSwRevEntry, slmAuthTable=slmAuthTable, slmSyslogLevel=slmSyslogLevel, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminCommunity=slmAdminCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist)
