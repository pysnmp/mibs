...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, iso, TimeTicks, Unsigned32, ModuleIdentity, MibIdentifier, IpAddress, Counter64, Bits, NotificationType, ObjectIdentity, Opaque, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "iso", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Counter64", "Bits", "NotificationType", "ObjectIdentity", "Opaque", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestRowStatus=slmTrapDestRowStatus, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmChPass=slmChPass, slmAuth=slmAuth, slmTrapLogName=slmTrapLogName, UserPassword=UserPassword, slmTrap=slmTrap, slmAuthLogin=slmAuthLogin, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Priv=slmSnmpv3Priv, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmAct=slmSysAlmAct, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmNetworkMode=slmNetworkMode, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmPmAvailable=slmPmAvailable, slm40GConf=slm40GConf, slmReadCommunity=slmReadCommunity, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, slmSysAlmDeact=slmSysAlmDeact, slmSysName=slmSysName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmLicense=slmLicense, slmTrapLogParam5=slmTrapLogParam5, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, PYSNMP_MODULE_ID=slMain, slmLicenseIndex=slmLicenseIndex, slmAdminAccess=slmAdminAccess, slmSysLocation=slmSysLocation, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, slmRstpEnabled=slmRstpEnabled, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminCommunity=slmAdminCommunity, slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassLogin=slmChPassLogin, slmTrapLogParam3=slmTrapLogParam3, slmAdminPassword=slmAdminPassword, slmSwRevStatus=slmSwRevStatus, slmSysTemperature=slmSysTemperature, slmSnmpv3Auth=slmSnmpv3Auth, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserAccess=slmTrapUserAccess, slmTrapEnable=slmTrapEnable, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, UserCommunity=UserCommunity, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmTrapLogTable=slmTrapLogTable, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam1=slmTrapLogParam1, slmOemType=slmOemType, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmPsuNumber=slmPsuNumber, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayAddr=slmSysGatewayAddr, slMain=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmAdmin=slmAdmin, slmSwRevDate=slmSwRevDate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmLogFile=slmLogFile, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassEntry=slmChPassEntry, slmChPassTable=slmChPassTable, slmTrapUserLogin=slmTrapUserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, AdminAccess=AdminAccess, slmSysMode=slmSysMode, slmConfigFile=slmConfigFile, UserLogin=UserLogin, slmConfigSysUptime=slmConfigSysUptime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSys=slmSys, slmSwRevEntry=slmSwRevEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmLogin=slmLogin, slmAdminTable=slmAdminTable)
