...
Opaque, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Unsigned32, Gauge32, TimeTicks, Counter64, MibIdentifier, Bits, ObjectIdentity, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "iso", "Counter32")
RowStatus, TextualConvention, TruthValue, DisplayString, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TruthValue", "DisplayString", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevName=slmSwRevName, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, SoftwareRevision=SoftwareRevision, slmAdminTable=slmAdminTable, slmVcatDelay=slmVcatDelay, slmSysAlmAct=slmSysAlmAct, slmWriteCommunity=slmWriteCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysTemperature=slmSysTemperature, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmBoxSize=slmBoxSize, slmSysTrapFormat=slmSysTrapFormat, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slMain=slMain, slmAuth=slmAuth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminLogin=slmAdminLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmAdminEntry=slmAdminEntry, slmAuthLogin=slmAuthLogin, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmOemType=slmOemType, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDate=slmSwRevDate, slmSysOperStatus=slmSysOperStatus, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysUplinkRate=slmSysUplinkRate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLocation=slmSysLocation, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, UserCommunity=UserCommunity, slmSysIpAddr=slmSysIpAddr, slmPmAvailable=slmPmAvailable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slm40GConf=slm40GConf, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogLevel=slmSyslogLevel, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmSysName=slmSysName, slmTrapEnable=slmTrapEnable, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmPsuNumber=slmPsuNumber, slmSwRevDirectory=slmSwRevDirectory, slmLicense=slmLicense, slmTrapLogParam2=slmTrapLogParam2, slmPortsNumber=slmPortsNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminRowStatus=slmAdminRowStatus, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, UserPassword=UserPassword, slmSyslogDestTable=slmSyslogDestTable, slmSysChassisId=slmSysChassisId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseIndex=slmLicenseIndex, slmSyslogPort=slmSyslogPort, UserLogin=UserLogin, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmLogFile=slmLogFile, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmAdmin=slmAdmin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmTopologyEnabled=slmTopologyEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmAuthPassword=slmAuthPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress)
