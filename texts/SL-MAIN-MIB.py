...
NotificationType, Bits, iso, MibIdentifier, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Opaque, Unsigned32, Gauge32, ModuleIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "iso", "MibIdentifier", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Opaque", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "IpAddress")
TextualConvention, DisplayString, RowStatus, TimeStamp, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmTrapDestEntry=slmTrapDestEntry, slmSysAdminStatus=slmSysAdminStatus, slmLogFile=slmLogFile, slmAdminEntry=slmAdminEntry, slmReadCommunity=slmReadCommunity, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmSysAlmAct=slmSysAlmAct, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmTrapDestTable=slmTrapDestTable, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigFile=slmConfigFile, slmOemType=slmOemType, slmSysChassisId=slmSysChassisId, slmAuthTable=slmAuthTable, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slmLogin=slmLogin, UserPassword=UserPassword, slmTrapCommunity=slmTrapCommunity, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, UserLogin=UserLogin, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber, slmSysOperStatus=slmSysOperStatus, slmSys=slmSys, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSubnetMask=slmSysSubnetMask, slmTid=slmTid, slmSysTemperature=slmSysTemperature, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmSysLanIpAddr=slmSysLanIpAddr, slmSysIpAddr=slmSysIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmAdminLogin=slmAdminLogin, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmRstpEnabled=slmRstpEnabled, slmTrapSysNameChange=slmTrapSysNameChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLocation=slmSysLocation, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmSwRevDate=slmSwRevDate, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmSysGatewayAddr=slmSysGatewayAddr, slmPsuNumber=slmPsuNumber, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slmSysResetPm=slmSysResetPm, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Priv=slmSnmpv3Priv, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmLicenseTable=slmLicenseTable, slmSysMode=slmSysMode, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmChPassLogin=slmChPassLogin, slmChPassTable=slmChPassTable, slmTrapLogParam1=slmTrapLogParam1, slmSwRevTable=slmSwRevTable, slmAdminCommunity=slmAdminCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmSyslogPort=slmSyslogPort, AdminAccess=AdminAccess, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmSysName=slmSysName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Auth=slmSnmpv3Auth)
