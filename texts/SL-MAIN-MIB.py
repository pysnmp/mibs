...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ModuleIdentity, IpAddress, Integer32, Counter64, ObjectIdentity, Unsigned32, Opaque, MibIdentifier, Bits, NotificationType, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "ObjectIdentity", "Unsigned32", "Opaque", "MibIdentifier", "Bits", "NotificationType", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestAddress=slmSyslogDestAddress, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, slmTrap=slmTrap, slmSysActiveSwVersion=slmSysActiveSwVersion, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate, slmEdfaNumber=slmEdfaNumber, slmLicenseIndex=slmLicenseIndex, slmTrapUserLogin=slmTrapUserLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTable=slmTrapLogTable, slmSyslogDestTable=slmSyslogDestTable, slmSwRevEntry=slmSwRevEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseId=slmLicenseId, slmTrapDestIpAddress=slmTrapDestIpAddress, slmReadCommunity=slmReadCommunity, PYSNMP_MODULE_ID=slMain, slmSwRevStatus=slmSwRevStatus, slmPmAvailable=slmPmAvailable, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmLogFile=slmLogFile, slmLicenseTable=slmLicenseTable, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthCommunity=slmAuthCommunity, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserLogin=UserLogin, slmRstpEnabled=slmRstpEnabled, slmAuthPassword=slmAuthPassword, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmTrapSysLocationChange=slmTrapSysLocationChange, slMain=slMain, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapPort=slmTrapPort, slmTrapLogEntry=slmTrapLogEntry, slmTrapEnable=slmTrapEnable, slmSysTemperature=slmSysTemperature, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmWriteCommunity=slmWriteCommunity, slmSysResetPm=slmSysResetPm, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysUptime=slmConfigSysUptime, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmLicense=slmLicense, slmTrapDestTable=slmTrapDestTable, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, slmSwRevDirectory=slmSwRevDirectory, slmChPass=slmChPass, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmSyslogPort=slmSyslogPort, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmChPassOldPass=slmChPassOldPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmSys=slmSys, slmPortsNumber=slmPortsNumber, slmAdminAccess=slmAdminAccess, slmTid=slmTid, slmTrapLogParam3=slmTrapLogParam3, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode)
