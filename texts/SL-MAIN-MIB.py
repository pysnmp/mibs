...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestCommunity=slmTrapDestCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysChassisId=slmSysChassisId, slmSys=slmSys, slmTrapPort=slmTrapPort, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmOemType=slmOemType, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmTrapEnable=slmTrapEnable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmVcatDelay=slmVcatDelay, slmAuthTable=slmAuthTable, slmTrapLogTable=slmTrapLogTable, slmSysSubnetMask=slmSysSubnetMask, AdminAccess=AdminAccess, slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestTable=slmTrapDestTable, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmMuxNumber=slmMuxNumber, slmTrapDestAddress=slmTrapDestAddress, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseTable=slmLicenseTable, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogName=slmTrapLogName, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysMode=slmSysMode, slmTrapLogParam2=slmTrapLogParam2, slmAuth=slmAuth, slmTrapSysNameChange=slmTrapSysNameChange, slmPsuNumber=slmPsuNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevStatus=slmSwRevStatus, slmTrapDestEntry=slmTrapDestEntry, slmReadCommunity=slmReadCommunity, UserCommunity=UserCommunity, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmSysOperStatus=slmSysOperStatus, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserAccess=slmTrapUserAccess, slm40GConf=slm40GConf, slmAuthCommunity=slmAuthCommunity, slmSysName=slmSysName, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Password=slmSnmpv3Password, slmLicenseId=slmLicenseId, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmBoxSize=slmBoxSize, slmLicense=slmLicense, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysCalendarTime=slmSysCalendarTime, slmAuthLogin=slmAuthLogin, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigFile=slmConfigFile, slmRebootDelay=slmRebootDelay, slmTrap=slmTrap, slMain=slMain, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTopologyEnabled=slmTopologyEnabled, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPortsNumber=slmPortsNumber, slmChPassOldPass=slmChPassOldPass, slmSwRevName=slmSwRevName, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmAuthEntry=slmAuthEntry, slmChPass=slmChPass, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, slmTrapLogParam3=slmTrapLogParam3, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, slmChPassTable=slmChPassTable)
