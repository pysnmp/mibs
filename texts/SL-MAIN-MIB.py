...
TextualConvention, TimeStamp, DateAndTime, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DateAndTime", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmTopologyEnabled=slmTopologyEnabled, slMain=slMain, slmChPassTable=slmChPassTable, slmPmAvailable=slmPmAvailable, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmSyslogLevel=slmSyslogLevel, slmTrapLogId=slmTrapLogId, slmSysIpAddr=slmSysIpAddr, slmMuxNumber=slmMuxNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPass=slmChPass, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthPassword=slmAuthPassword, slmSwRevStatus=slmSwRevStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam5=slmTrapLogParam5, slmWriteCommunity=slmWriteCommunity, slmNetworkMode=slmNetworkMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserAccess=slmTrapUserAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdmin=slmAdmin, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogName=slmTrapLogName, slmEdfaNumber=slmEdfaNumber, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmSyslogPort=slmSyslogPort, slmAuth=slmAuth, slmLicenseEntry=slmLicenseEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysChassisId=slmSysChassisId, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmSysAdminStatus=slmSysAdminStatus, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthCommunity=slmAuthCommunity, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseId=slmLicenseId, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmDeact=slmSysAlmDeact, slmAdminCommunity=slmAdminCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmChPassEntry=slmChPassEntry, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmSysMode=slmSysMode, slmSwRevName=slmSwRevName, slmRebootDelay=slmRebootDelay, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmTrap=slmTrap, slmSwRevDate=slmSwRevDate, slmTrapPort=slmTrapPort, slmTrapCommunity=slmTrapCommunity, slm40GConf=slm40GConf, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevTable=slmSwRevTable, slmTrapLogParam1=slmTrapLogParam1, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, slmAuthEntry=slmAuthEntry, slmSwRevDirectory=slmSwRevDirectory, slmReadCommunity=slmReadCommunity, slmSysResetPm=slmSysResetPm, slmAdminLogin=slmAdminLogin, slmLogFile=slmLogFile, slmSysAlmAct=slmSysAlmAct, slmAdminTable=slmAdminTable, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysLocationChange=slmTrapSysLocationChange, PYSNMP_MODULE_ID=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayAddr=slmSysGatewayAddr)
