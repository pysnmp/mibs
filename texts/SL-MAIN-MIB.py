...
Bits, ModuleIdentity, TimeTicks, Unsigned32, Counter64, IpAddress, iso, ObjectIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, MibIdentifier, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "TimeTicks", "Unsigned32", "Counter64", "IpAddress", "iso", "ObjectIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "MibIdentifier", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, slmVcatDelay=slmVcatDelay, UserPassword=UserPassword, slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmTrapCommunity=slmTrapCommunity, slmBoxSize=slmBoxSize, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDirectory=slmSwRevDirectory, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdmin=slmAdmin, slmAuthPassword=slmAuthPassword, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Password=slmSnmpv3Password, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmChPass=slmChPass, slmTrapLogParam6=slmTrapLogParam6, slmTid=slmTid, slmTrapDestTable=slmTrapDestTable, slmTrapLogTable=slmTrapLogTable, slmTrapUserAccess=slmTrapUserAccess, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Priv=slmSnmpv3Priv, slmSysResetPm=slmSysResetPm, slmRstpEnabled=slmRstpEnabled, slmChPassTable=slmChPassTable, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogFile=slmLogFile, slmSysMode=slmSysMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminCommunity=slmAdminCommunity, slmSysName=slmSysName, slmTrapLogId=slmTrapLogId, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, slmAuthCommunity=slmAuthCommunity, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmSyslogLevel=slmSyslogLevel, slmSysOperStatus=slmSysOperStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigFile=slmConfigFile, slmOemType=slmOemType, slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassLogin=slmChPassLogin, slmSys=slmSys, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmLicenseExpiration=slmLicenseExpiration, slmAdminLogin=slmAdminLogin, slmSysTemperature=slmSysTemperature, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmPsuNumber=slmPsuNumber, slmTrapPort=slmTrapPort, slmSysAlmAct=slmSysAlmAct, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanIpAddr=slmSysLanIpAddr, slmEdfaNumber=slmEdfaNumber, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminTable=slmAdminTable, slmWriteCommunity=slmWriteCommunity, slmTrapEnable=slmTrapEnable, slmSysCalendarTime=slmSysCalendarTime, slmSysTrapFormat=slmSysTrapFormat, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, slmReadCommunity=slmReadCommunity, slmNetworkMode=slmNetworkMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseTable=slmLicenseTable, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress)
