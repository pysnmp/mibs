...
Integer32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, Bits, Counter64, ModuleIdentity, IpAddress, MibIdentifier, NotificationType, Opaque, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "Bits", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Opaque", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserLogin=slmTrapUserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminTable=slmAdminTable, UserPassword=UserPassword, slmChPassOldPass=slmChPassOldPass, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmSysCalendarTime=slmSysCalendarTime, slmLicenseEntry=slmLicenseEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminPassword=slmAdminPassword, slm40GConf=slm40GConf, slmChPass=slmChPass, slmSys=slmSys, slmAuthLogin=slmAuthLogin, slmTrapCommunity=slmTrapCommunity, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmTrap=slmTrap, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminEntry=slmAdminEntry, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmSysResetPm=slmSysResetPm, slmSyslogPort=slmSyslogPort, slmSysOperStatus=slmSysOperStatus, slmSysIpAddr=slmSysIpAddr, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmTid=slmTid, slmTrapLogTable=slmTrapLogTable, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmChPassLogin=slmChPassLogin, slmAuthCommunity=slmAuthCommunity, slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmReadCommunity=slmReadCommunity, slmSwRevStatus=slmSwRevStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysUptime=slmConfigSysUptime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmTrapLogParam4=slmTrapLogParam4, slmSysTemperature=slmSysTemperature, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmLicenseTable=slmLicenseTable, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogId=slmTrapLogId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdmin=slmAdmin, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, SoftwareRevision=SoftwareRevision, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmTrapLogParam6=slmTrapLogParam6, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam3=slmTrapLogParam3, slmPmAvailable=slmPmAvailable, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, UserLogin=UserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slMain=slMain)
