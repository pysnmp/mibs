...
iso, ObjectIdentity, IpAddress, NotificationType, MibIdentifier, Bits, ModuleIdentity, Gauge32, TimeTicks, Unsigned32, Opaque, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Bits", "ModuleIdentity", "Gauge32", "TimeTicks", "Unsigned32", "Opaque", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
DateAndTime, DisplayString, TextualConvention, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysCalendarTime=slmSysCalendarTime, slmConfigSysUptime=slmConfigSysUptime, slMain=slMain, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapCommunity=slmTrapCommunity, slmPsuNumber=slmPsuNumber, slmAuthLogin=slmAuthLogin, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, slmChPassTable=slmChPassTable, slmLicenseId=slmLicenseId, slmSyslogPort=slmSyslogPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmAuthTable=slmAuthTable, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Password=slmSnmpv3Password, AdminAccess=AdminAccess, slmTrapLogId=slmTrapLogId, slmSysResetPm=slmSysResetPm, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSys=slmSys, slmTid=slmTid, slmPortsNumber=slmPortsNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmAuthEntry=slmAuthEntry, slmAdminRowStatus=slmAdminRowStatus, slmSysMode=slmSysMode, slmAdminAccess=slmAdminAccess, slmTrapEnable=slmTrapEnable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestTable=slmTrapDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmSysAdminStatus=slmSysAdminStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassEntry=slmChPassEntry, slmAdminPassword=slmAdminPassword, slmPmAvailable=slmPmAvailable, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevTable=slmSwRevTable, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmAdminLogin=slmAdminLogin, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmTrapPort=slmTrapPort, slmLicenseTable=slmLicenseTable, slmTrapUserLogin=slmTrapUserLogin, slmChPass=slmChPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrap=slmTrap, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, slmAuthCommunity=slmAuthCommunity, slmOemType=slmOemType, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogLevel=slmSyslogLevel, slmSysChassisId=slmSysChassisId, slmTrapSysNameChange=slmTrapSysNameChange, UserLogin=UserLogin, slmChPassOldPass=slmChPassOldPass, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmLicenseExpiration=slmLicenseExpiration, slmChPassLogin=slmChPassLogin, UserPassword=UserPassword, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmConfigFile=slmConfigFile, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmAdminCommunity=slmAdminCommunity, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr)
