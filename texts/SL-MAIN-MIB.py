...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Opaque, IpAddress, MibIdentifier, Integer32, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, Gauge32, Unsigned32, NotificationType, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Opaque", "IpAddress", "MibIdentifier", "Integer32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "Gauge32", "Unsigned32", "NotificationType", "iso", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTid=slmTid, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmSwRevEntry=slmSwRevEntry, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, UserPassword=UserPassword, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmNetworkMode=slmNetworkMode, slmSysName=slmSysName, slmReadCommunity=slmReadCommunity, slmTrapLogTable=slmTrapLogTable, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapEnable=slmTrapEnable, slmLicense=slmLicense, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigFile=slmConfigFile, slmSysAlmDeact=slmSysAlmDeact, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmChPass=slmChPass, slmAdminRowStatus=slmAdminRowStatus, slmTrap=slmTrap, slmSyslogDestRowStatus=slmSyslogDestRowStatus, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam1=slmTrapLogParam1, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmMuxNumber=slmMuxNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmBoxSize=slmBoxSize, slmTrapUserLogin=slmTrapUserLogin, slmLicenseIndex=slmLicenseIndex, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slmSysTrapFormat=slmSysTrapFormat, slmRebootDelay=slmRebootDelay, slmConfigSysUptime=slmConfigSysUptime, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmOemType=slmOemType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminCommunity=slmAdminCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSys=slmSys, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogin=slmLogin, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, slMain=slMain, slmLicenseTable=slmLicenseTable, slmEdfaNumber=slmEdfaNumber, slmSysTemperature=slmSysTemperature, UserLogin=UserLogin, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseId=slmLicenseId, slmChPassEntry=slmChPassEntry, PYSNMP_MODULE_ID=slMain, slmAuthTable=slmAuthTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogId=slmTrapLogId, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam4=slmTrapLogParam4, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRstpEnabled=slmRstpEnabled, slmAdminAccess=slmAdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysSignalType=slmConfigSysSignalType, slmAdmin=slmAdmin, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassLogin=slmChPassLogin, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate)
