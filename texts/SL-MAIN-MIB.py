...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseEntry=slmLicenseEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmMuxNumber=slmMuxNumber, slmTrapLogParam3=slmTrapLogParam3, UserCommunity=UserCommunity, slmTrapLogName=slmTrapLogName, slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmChPass=slmChPass, slmTrapEnable=slmTrapEnable, slmPmAvailable=slmPmAvailable, slmRstpEnabled=slmRstpEnabled, slmSwRevName=slmSwRevName, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmChPassLogin=slmChPassLogin, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmDeact=slmSysAlmDeact, slmSysLocation=slmSysLocation, slmConfigFile=slmConfigFile, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmAdminLogin=slmAdminLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slm40GConf=slm40GConf, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAdminStatus=slmSysAdminStatus, slmTid=slmTid, slmLogin=slmLogin, slmSysCalendarTime=slmSysCalendarTime, slmEdfaNumber=slmEdfaNumber, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmSwRevStatus=slmSwRevStatus, slmChPassTable=slmChPassTable, slmAdminAccess=slmAdminAccess, slmTrapDestTable=slmTrapDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmNetworkMode=slmNetworkMode, slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysResetPm=slmSysResetPm, slmOemType=slmOemType, slmAuthLogin=slmAuthLogin, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminPassword=slmAdminPassword, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmTrapCommunity=slmTrapCommunity, slmLicenseIndex=slmLicenseIndex, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseId=slmLicenseId, slmAdminEntry=slmAdminEntry, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmRebootDelay=slmRebootDelay, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmSysEncryptionCapability=slmSysEncryptionCapability, slmVcatDelay=slmVcatDelay, slmSys=slmSys, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserLogin=slmTrapUserLogin, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysUptime=slmConfigSysUptime, slmSyslogLevel=slmSyslogLevel, AdminAccess=AdminAccess, slmSysTemperature=slmSysTemperature, slmPsuNumber=slmPsuNumber, slMain=slMain, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicense=slmLicense, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmReadCommunity=slmReadCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay)
