...
TimeTicks, iso, Integer32, Bits, Counter32, Counter64, Opaque, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Integer32", "Bits", "Counter32", "Counter64", "Opaque", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, SoftwareRevision=SoftwareRevision, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmAuthPassword=slmAuthPassword, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestEntry=slmSyslogDestEntry, slmSysChassisId=slmSysChassisId, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam2=slmTrapLogParam2, slmTrapCommunity=slmTrapCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmSwRevStatus=slmSwRevStatus, slmSysUplinkRate=slmSysUplinkRate, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, PYSNMP_MODULE_ID=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogFile=slmLogFile, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmTrapDestAddress=slmTrapDestAddress, slmLicenseExpiration=slmLicenseExpiration, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmChPassNewPass=slmChPassNewPass, slmLicense=slmLicense, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Priv=slmSnmpv3Priv, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmSwRevName=slmSwRevName, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuth=slmAuth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseId=slmLicenseId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserPassword=UserPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmAdminTable=slmAdminTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogId=slmTrapLogId, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmWriteCommunity=slmWriteCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmSyslogDestTable=slmSyslogDestTable, slmSwRevDirectory=slmSwRevDirectory, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmSysLocation=slmSysLocation, slmLicenseTable=slmLicenseTable, slmOemType=slmOemType, slmTid=slmTid, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogEntry=slmTrapLogEntry, slmPsuNumber=slmPsuNumber, slmVcatDelay=slmVcatDelay, slmChPass=slmChPass, slmSysSubnetMask=slmSysSubnetMask, slmAuthLogin=slmAuthLogin, slmAdminLogin=slmAdminLogin, slmChPassEntry=slmChPassEntry, slmSysMode=slmSysMode, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmReadCommunity=slmReadCommunity, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmSyslogLevel=slmSyslogLevel, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam5=slmTrapLogParam5, slmLicenseIndex=slmLicenseIndex, slmAuthCommunity=slmAuthCommunity, slmSwRevEntry=slmSwRevEntry, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable)
