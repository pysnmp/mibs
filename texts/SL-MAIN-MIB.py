...
Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, IpAddress, Opaque, Gauge32, ObjectIdentity, iso, Unsigned32, Counter64, ModuleIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "IpAddress", "Opaque", "Gauge32", "ObjectIdentity", "iso", "Unsigned32", "Counter64", "ModuleIdentity", "TimeTicks", "Integer32")
RowStatus, TimeStamp, TruthValue, DateAndTime, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TruthValue", "DateAndTime", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slm40GConf=slm40GConf, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmAct=slmSysAlmAct, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicense=slmLicense, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmLogFile=slmLogFile, slmReadCommunity=slmReadCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassNewPass=slmChPassNewPass, slmConfigFile=slmConfigFile, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevTable=slmSwRevTable, slmTrapPort=slmTrapPort, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmSysTemperature=slmSysTemperature, slmTrapLogId=slmTrapLogId, slmOemType=slmOemType, slmSysIpAddr=slmSysIpAddr, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmSysMode=slmSysMode, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Priv=slmSnmpv3Priv, slmPsuNumber=slmPsuNumber, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmSwRevName=slmSwRevName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassLogin=slmChPassLogin, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam1=slmTrapLogParam1, slmAdminPassword=slmAdminPassword, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmAdmin=slmAdmin, slmLicenseEntry=slmLicenseEntry, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmAuthLogin=slmAuthLogin, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, UserLogin=UserLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrap=slmTrap, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminEntry=slmAdminEntry, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmTrapLogParam2=slmTrapLogParam2, slmLicenseIndex=slmLicenseIndex, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSys=slmSys, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam3=slmTrapLogParam3, slmSysChassisId=slmSysChassisId, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, slmLicenseTable=slmLicenseTable, slmTrapDestTable=slmTrapDestTable, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestAddress=slmTrapDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAdminRowStatus=slmAdminRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmConfigSysUptime=slmConfigSysUptime, SoftwareRevision=SoftwareRevision, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogName=slmTrapLogName, slmSyslogDestEntry=slmSyslogDestEntry, slmAuth=slmAuth, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, slmChPassOldPass=slmChPassOldPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress)
