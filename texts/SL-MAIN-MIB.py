...
Integer32, Opaque, TimeTicks, Counter32, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, ModuleIdentity, Gauge32, IpAddress, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Opaque", "TimeTicks", "Counter32", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Gauge32", "IpAddress", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassNewPass=slmChPassNewPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, AdminAccess=AdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmSysGatewayAddr=slmSysGatewayAddr, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slmSysResetPm=slmSysResetPm, slmTid=slmTid, slmAuthPassword=slmAuthPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAdminStatus=slmSysAdminStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigFile=slmConfigFile, slmTrapLogParam2=slmTrapLogParam2, slmSyslogLevel=slmSyslogLevel, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, slmSysIpAddr=slmSysIpAddr, slmTrapLogTable=slmTrapLogTable, slmSysAlmAct=slmSysAlmAct, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdmin=slmAdmin, slmPortsNumber=slmPortsNumber, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmChPassOldPass=slmChPassOldPass, slmSys=slmSys, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogFile=slmLogFile, slmAuthLogin=slmAuthLogin, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestTable=slmSyslogDestTable, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmSwRevName=slmSwRevName, slmEdfaNumber=slmEdfaNumber, slmTrapPort=slmTrapPort, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmSysUplinkRate=slmSysUplinkRate, slmTrapUserAccess=slmTrapUserAccess, slmSysCalendarTime=slmSysCalendarTime, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmOemType=slmOemType, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmAuthCommunity=slmAuthCommunity, slmAuthTable=slmAuthTable, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserCommunity=UserCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapCommunity=slmTrapCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, slmLicenseExpiration=slmLicenseExpiration, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmTrap=slmTrap, slmAuth=slmAuth, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Auth=slmSnmpv3Auth, UserPassword=UserPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogEntry=slmTrapLogEntry, slmWriteCommunity=slmWriteCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slmSwRevStatus=slmSwRevStatus, slmTrapDestTable=slmTrapDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogName=slmTrapLogName, slm40GConf=slm40GConf, slmAuthEntry=slmAuthEntry, slmChPassEntry=slmChPassEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress)
