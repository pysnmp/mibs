...
NotificationType, Bits, Counter32, Unsigned32, ObjectIdentity, Gauge32, TimeTicks, MibIdentifier, iso, IpAddress, Integer32, Counter64, ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks", "MibIdentifier", "iso", "IpAddress", "Integer32", "Counter64", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmAdminLogin=slmAdminLogin, slmSysName=slmSysName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam4=slmTrapLogParam4, slmSysIpAddr=slmSysIpAddr, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmAdminCommunity=slmAdminCommunity, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmLicenseExpiration=slmLicenseExpiration, slmSysUplinkRate=slmSysUplinkRate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAlmAct=slmSysAlmAct, slmSyslogPort=slmSyslogPort, slmSysLocation=slmSysLocation, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmTrapLogEntry=slmTrapLogEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmLicense=slmLicense, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestTable=slmTrapDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmEdfaNumber=slmEdfaNumber, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam3=slmTrapLogParam3, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthEntry=slmAuthEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysResetPm=slmSysResetPm, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Password=slmSnmpv3Password, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmAdminPassword=slmAdminPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseEntry=slmLicenseEntry, slmTrapCommunity=slmTrapCommunity, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmChPassNewPass=slmChPassNewPass, slmTrap=slmTrap, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmVcatDelay=slmVcatDelay, slm40GConf=slm40GConf, slmTid=slmTid, slmNetworkMode=slmNetworkMode, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapPort=slmTrapPort, slmLicenseId=slmLicenseId, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogId=slmTrapLogId, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminRowStatus=slmAdminRowStatus, slmAuth=slmAuth, UserPassword=UserPassword, slmTrapLogParam5=slmTrapLogParam5)
