...
iso, Bits, Unsigned32, Gauge32, IpAddress, MibIdentifier, ObjectIdentity, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, ModuleIdentity, Opaque, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "ObjectIdentity", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "ModuleIdentity", "Opaque", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysLocation=slmSysLocation, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserAccess=slmTrapUserAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDirectory=slmSwRevDirectory, slmLogin=slmLogin, slmSys=slmSys, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassTable=slmChPassTable, slmSysTemperature=slmSysTemperature, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, AdminAccess=AdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseIndex=slmLicenseIndex, slmTrapCommunity=slmTrapCommunity, slmOemType=slmOemType, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmLicenseTable=slmLicenseTable, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmTrapLogParam5=slmTrapLogParam5, slmTopologyEnabled=slmTopologyEnabled, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Priv=slmSnmpv3Priv, slmTrap=slmTrap, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmTrapEnable=slmTrapEnable, slmAuthCommunity=slmAuthCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam4=slmTrapLogParam4, slmAdmin=slmAdmin, slmTrapLogTable=slmTrapLogTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmTid=slmTid, slmTrapLogParam6=slmTrapLogParam6, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, slmRebootDelay=slmRebootDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmMuxNumber=slmMuxNumber, slmAuth=slmAuth, slmChPass=slmChPass, slmAdminTable=slmAdminTable, slm40GConf=slm40GConf, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmDeact=slmSysAlmDeact, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmSysTrapFormat=slmSysTrapFormat, slmAdminPassword=slmAdminPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmAdminLogin=slmAdminLogin, slmConfigFile=slmConfigFile, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogLevel=slmSyslogLevel, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmSyslogDestTable=slmSyslogDestTable, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmLicenseId=slmLicenseId, slmTrapUserLogin=slmTrapUserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogId=slmTrapLogId, slmSysSubnetMask=slmSysSubnetMask, slmPsuNumber=slmPsuNumber, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass)
