...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmAdminAccess=slmAdminAccess, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable, slmRebootDelay=slmRebootDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmMuxNumber=slmMuxNumber, slmSyslogPort=slmSyslogPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDate=slmSwRevDate, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmLogFile=slmLogFile, PYSNMP_MODULE_ID=slMain, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysChassisId=slmSysChassisId, slmSysName=slmSysName, UserCommunity=UserCommunity, slmSwRevEntry=slmSwRevEntry, slmAdminCommunity=slmAdminCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmTrapLogId=slmTrapLogId, slmLicenseIndex=slmLicenseIndex, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRstpEnabled=slmRstpEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassNewPass=slmChPassNewPass, slmLicenseEntry=slmLicenseEntry, slmTrapLogTable=slmTrapLogTable, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminEntry=slmAdminEntry, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, slmSysOperStatus=slmSysOperStatus, slmSysTemperature=slmSysTemperature, slmSnmpv3Password=slmSnmpv3Password, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmChPassLogin=slmChPassLogin, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmSysIpAddr=slmSysIpAddr, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmSysAlmDeact=slmSysAlmDeact, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, SoftwareRevision=SoftwareRevision, slmTrapLogParam4=slmTrapLogParam4, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, slmNetworkMode=slmNetworkMode, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmVcatDelay=slmVcatDelay, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmSwRevStatus=slmSwRevStatus, slmChPassEntry=slmChPassEntry, slmSysMode=slmSysMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSys=slmSys, slmTrapEnable=slmTrapEnable, slmSysUplinkRate=slmSysUplinkRate, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, AdminAccess=AdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmLogin=slmLogin, slmTrapDestEntry=slmTrapDestEntry, slmAdminTable=slmAdminTable, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthLogin=slmAuthLogin, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthTable=slmAuthTable, slmAdminLogin=slmAdminLogin, slmTrapSysNameChange=slmTrapSysNameChange, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay)
