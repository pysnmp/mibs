...
Unsigned32, ObjectIdentity, Gauge32, TimeTicks, Integer32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, NotificationType, Counter32, Counter64, IpAddress, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks", "Integer32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "NotificationType", "Counter32", "Counter64", "IpAddress", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam6=slmTrapLogParam6, AdminAccess=AdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam2=slmTrapLogParam2, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, UserPassword=UserPassword, slmLicenseExpiration=slmLicenseExpiration, slmLicenseIndex=slmLicenseIndex, slmSyslogPort=slmSyslogPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmLogin=slmLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTemperature=slmSysTemperature, UserLogin=UserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmAuthCommunity=slmAuthCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthLogin=slmAuthLogin, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseTable=slmLicenseTable, slmConfigSysSignalType=slmConfigSysSignalType, slmAuth=slmAuth, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogId=slmTrapLogId, slmSwRevStatus=slmSwRevStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, PYSNMP_MODULE_ID=slMain, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDirectory=slmSwRevDirectory, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogName=slmTrapLogName, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, slmAdminCommunity=slmAdminCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, slmSnmpv3Password=slmSnmpv3Password, slMain=slMain, slmSysMode=slmSysMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmTid=slmTid, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdmin=slmAdmin, slmAdminAccess=slmAdminAccess, slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, slmVcatDelay=slmVcatDelay, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrap=slmTrap, slmSyslogLevel=slmSyslogLevel, slmAdminPassword=slmAdminPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam4=slmTrapLogParam4, slmReadCommunity=slmReadCommunity, slmSysIpAddr=slmSysIpAddr, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmSys=slmSys, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminEntry=slmAdminEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysName=slmSysName, slmSwRevTable=slmSwRevTable, slmRebootDelay=slmRebootDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmChPassTable=slmChPassTable)
