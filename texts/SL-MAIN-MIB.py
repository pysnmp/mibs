...
MibIdentifier, Integer32, Bits, Counter64, ObjectIdentity, NotificationType, Opaque, Gauge32, Counter32, ModuleIdentity, IpAddress, TimeTicks, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Bits", "Counter64", "ObjectIdentity", "NotificationType", "Opaque", "Gauge32", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, TextualConvention, DateAndTime, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DateAndTime", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPmAvailable=slmPmAvailable, SoftwareRevision=SoftwareRevision, slmChPassTable=slmChPassTable, AdminAccess=AdminAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam2=slmTrapLogParam2, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmChPassLogin=slmChPassLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevStatus=slmSwRevStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmSyslogLevel=slmSyslogLevel, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmChPassEntry=slmChPassEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmLicense=slmLicense, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmChPass=slmChPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmRebootDelay=slmRebootDelay, slmTrapLogId=slmTrapLogId, slmSwRevName=slmSwRevName, slmSyslogPort=slmSyslogPort, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmAdminEntry=slmAdminEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slmSysResetPm=slmSysResetPm, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slmTrapPort=slmTrapPort, slmTrapUserLogin=slmTrapUserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmBoxSize=slmBoxSize, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam4=slmTrapLogParam4, slmAdminPassword=slmAdminPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmDeact=slmSysAlmDeact, slmAuth=slmAuth, slmWriteCommunity=slmWriteCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmSysIpAddr=slmSysIpAddr, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDate=slmSwRevDate, slmSnmpv3Password=slmSnmpv3Password, slmLicenseId=slmLicenseId, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmPsuNumber=slmPsuNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmPortsNumber=slmPortsNumber, slmChPassOldPass=slmChPassOldPass, slmTrapLogEntry=slmTrapLogEntry, slmLicenseIndex=slmLicenseIndex, slmSys=slmSys, slmTid=slmTid, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmSysOperStatus=slmSysOperStatus, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmAuthEntry=slmAuthEntry, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysMode=slmSysMode, slmSysSubnetMask=slmSysSubnetMask, slMain=slMain)
