...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, TimeTicks, Opaque, Gauge32, Counter32, MibIdentifier, Bits, NotificationType, IpAddress, Unsigned32, ObjectIdentity, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "TimeTicks", "Opaque", "Gauge32", "Counter32", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "Unsigned32", "ObjectIdentity", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, UserLogin=UserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayAddr=slmSysGatewayAddr, AdminAccess=AdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmOemType=slmOemType, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassOldPass=slmChPassOldPass, slmAuthEntry=slmAuthEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, slmConfigFile=slmConfigFile, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserPassword=UserPassword, slmSwRevStatus=slmSwRevStatus, slmLogFile=slmLogFile, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapUserLogin=slmTrapUserLogin, slmVcatDelay=slmVcatDelay, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrap=slmTrap, slmAdminLogin=slmAdminLogin, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysUptime=slmConfigSysUptime, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmTrapCommunity=slmTrapCommunity, slmSysTemperature=slmSysTemperature, slmSysCalendarTime=slmSysCalendarTime, slmBoxSize=slmBoxSize, slmLicenseExpiration=slmLicenseExpiration, slmRebootDelay=slmRebootDelay, slmPsuNumber=slmPsuNumber, slm40GConf=slm40GConf, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, PYSNMP_MODULE_ID=slMain, slmChPassNewPass=slmChPassNewPass, slmTid=slmTid, slMain=slMain, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam2=slmTrapLogParam2, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, SoftwareRevision=SoftwareRevision, slmChPass=slmChPass, slmTrapLogParam1=slmTrapLogParam1, slmAuth=slmAuth, slmSwRevName=slmSwRevName, slmSwRevTable=slmSwRevTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTable=slmTrapLogTable, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmSysOperStatus=slmSysOperStatus, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber)
