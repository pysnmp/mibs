...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Counter64, MibIdentifier, iso, IpAddress, NotificationType, Counter32, ObjectIdentity, Opaque, Gauge32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Counter64", "MibIdentifier", "iso", "IpAddress", "NotificationType", "Counter32", "ObjectIdentity", "Opaque", "Gauge32", "Integer32", "ModuleIdentity")
TextualConvention, RowStatus, TimeStamp, DateAndTime, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TimeStamp", "DateAndTime", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmSys=slmSys, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, slmAdmin=slmAdmin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmPortsNumber=slmPortsNumber, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, UserPassword=UserPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmTrap=slmTrap, slmTrapDestAddress=slmTrapDestAddress, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmTrapEnable=slmTrapEnable, slmChPassTable=slmChPassTable, slmTid=slmTid, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmNetworkMode=slmNetworkMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmSysLocation=slmSysLocation, slmSysCalendarTime=slmSysCalendarTime, slmChPassOldPass=slmChPassOldPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmAct=slmSysAlmAct, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmAuthTable=slmAuthTable, slmLicense=slmLicense, slmSysIpAddr=slmSysIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogTable=slmTrapLogTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmMuxNumber=slmMuxNumber, slmSysSnmpVersion=slmSysSnmpVersion, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysOperStatus=slmSysOperStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, slmSyslogDestTable=slmSyslogDestTable, slmRstpEnabled=slmRstpEnabled, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slmAdminTable=slmAdminTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam3=slmTrapLogParam3, slmPsuNumber=slmPsuNumber, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin, UserCommunity=UserCommunity, slmLicenseId=slmLicenseId, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmVcatDelay=slmVcatDelay, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmSysName=slmSysName, slmTrapLogParam4=slmTrapLogParam4, slmRebootDelay=slmRebootDelay, slmTrapLogId=slmTrapLogId, slmSyslogDestAddress=slmSyslogDestAddress, slmSysMode=slmSysMode, slmAdminLogin=slmAdminLogin)
