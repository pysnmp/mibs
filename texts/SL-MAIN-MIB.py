...
Gauge32, NotificationType, Bits, Integer32, IpAddress, ModuleIdentity, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, TimeTicks, Counter32, iso, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "TimeTicks", "Counter32", "iso", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam1=slmTrapLogParam1, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmSysMode=slmSysMode, slmChPass=slmChPass, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, UserCommunity=UserCommunity, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmTrap=slmTrap, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmPmAvailable=slmPmAvailable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slm40GConf=slm40GConf, slmTrapEnable=slmTrapEnable, slmTrapDestTable=slmTrapDestTable, slmSysUplinkRate=slmSysUplinkRate, slmPortsNumber=slmPortsNumber, slmLogFile=slmLogFile, slmAuth=slmAuth, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmRstpEnabled=slmRstpEnabled, slmWriteCommunity=slmWriteCommunity, slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserPassword=UserPassword, slmAuthTable=slmAuthTable, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthCommunity=slmAuthCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmTrapLogEntry=slmTrapLogEntry, slmLicenseIndex=slmLicenseIndex, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestEntry=slmTrapDestEntry, slmTrapCommunity=slmTrapCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevEntry=slmSwRevEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthEntry=slmAuthEntry, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmBoxSize=slmBoxSize, slmTopologyEnabled=slmTopologyEnabled, slmChPassLogin=slmChPassLogin, slmAuthLogin=slmAuthLogin, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmSysLocation=slmSysLocation, slmAdminTable=slmAdminTable, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassOldPass=slmChPassOldPass, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseEntry=slmLicenseEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevName=slmSwRevName, slmLicenseId=slmLicenseId, slmSysName=slmSysName, slmTrapLogName=slmTrapLogName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, UserLogin=UserLogin, AdminAccess=AdminAccess, slMain=slMain, slmAdminAccess=slmAdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmEdfaNumber=slmEdfaNumber, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, SoftwareRevision=SoftwareRevision, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam4=slmTrapLogParam4, slmAdmin=slmAdmin, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, slmLicense=slmLicense)
