...
Counter64, IpAddress, TimeTicks, iso, Integer32, Opaque, NotificationType, Counter32, ModuleIdentity, Gauge32, Bits, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "TimeTicks", "iso", "Integer32", "Opaque", "NotificationType", "Counter32", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmConfigFile=slmConfigFile, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmAuthCommunity=slmAuthCommunity, slmSysLocation=slmSysLocation, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassNewPass=slmChPassNewPass, slmSysMode=slmSysMode, UserPassword=UserPassword, slmTrapLogName=slmTrapLogName, slMain=slMain, slmSwRevStatus=slmSwRevStatus, slmSys=slmSys, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthPassword=slmAuthPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminTable=slmAdminTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDirectory=slmSwRevDirectory, slmChPass=slmChPass, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminAccess=slmAdminAccess, slmChPassOldPass=slmChPassOldPass, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmReadCommunity=slmReadCommunity, slmTrapCommunity=slmTrapCommunity, slmChPassLogin=slmChPassLogin, slmAuthEntry=slmAuthEntry, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmSysTemperature=slmSysTemperature, slmTrapLogId=slmTrapLogId, slmTrapDestEntry=slmTrapDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmTrapEnable=slmTrapEnable, slmAdminPassword=slmAdminPassword, slmPortsNumber=slmPortsNumber, slmSwRevEntry=slmSwRevEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminEntry=slmAdminEntry, slmOemType=slmOemType, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseTable=slmLicenseTable, UserCommunity=UserCommunity, slmLicenseEntry=slmLicenseEntry, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slmRebootDelay=slmRebootDelay, slmAdmin=slmAdmin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slm40GConf=slm40GConf, slmSwRevTable=slmSwRevTable, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, UserLogin=UserLogin, slmLicenseIndex=slmLicenseIndex, slmNetworkMode=slmNetworkMode, slmSysName=slmSysName, slmTid=slmTid, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmTrap=slmTrap, slmSysSnmpVersion=slmSysSnmpVersion, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, PYSNMP_MODULE_ID=slMain, slmWriteCommunity=slmWriteCommunity, slmSysOperStatus=slmSysOperStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct)
