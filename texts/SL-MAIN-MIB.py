...
Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Bits, ObjectIdentity, Gauge32, Counter64, iso, Counter32, NotificationType, TimeTicks, Unsigned32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Bits", "ObjectIdentity", "Gauge32", "Counter64", "iso", "Counter32", "NotificationType", "TimeTicks", "Unsigned32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSwRevStatus=slmSwRevStatus, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysChassisId=slmSysChassisId, slmAdminAccess=slmAdminAccess, slmChPassOldPass=slmChPassOldPass, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevName=slmSwRevName, slmTrapLogId=slmTrapLogId, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogName=slmTrapLogName, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmLicenseId=slmLicenseId, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmLicenseEntry=slmLicenseEntry, slMain=slMain, slmLicenseExpiration=slmLicenseExpiration, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slmTrap=slmTrap, slmConfigSysSignalType=slmConfigSysSignalType, slmSysOperStatus=slmSysOperStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmSysLocation=slmSysLocation, slmSwRevDirectory=slmSwRevDirectory, slmWriteCommunity=slmWriteCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmSysIpAddr=slmSysIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmSysMode=slmSysMode, slmAuthLogin=slmAuthLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, AdminAccess=AdminAccess, slmPsuNumber=slmPsuNumber, slmOemType=slmOemType, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTable=slmTrapLogTable, UserCommunity=UserCommunity, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmAdminTable=slmAdminTable, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmPortsNumber=slmPortsNumber, slmSysAlmDeact=slmSysAlmDeact, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmVcatDelay=slmVcatDelay, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassTable=slmChPassTable, slmConfigFile=slmConfigFile, slmSyslogDestAddress=slmSyslogDestAddress, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, UserPassword=UserPassword, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthEntry=slmAuthEntry, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmTid=slmTid, slmTrapLogParam1=slmTrapLogParam1, slmLogin=slmLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys)
