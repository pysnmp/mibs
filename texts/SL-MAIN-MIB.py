...
iso, TimeTicks, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Integer32, Counter64, ObjectIdentity, Opaque, Counter32, NotificationType, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Integer32", "Counter64", "ObjectIdentity", "Opaque", "Counter32", "NotificationType", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Password=slmSnmpv3Password, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogName=slmTrapLogName, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam1=slmTrapLogParam1, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDate=slmSwRevDate, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminEntry=slmAdminEntry, slmSysMode=slmSysMode, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmSysResetPm=slmSysResetPm, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigFile=slmConfigFile, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmTrapLogParam3=slmTrapLogParam3, slmSwRevEntry=slmSwRevEntry, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, UserLogin=UserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAdminStatus=slmSysAdminStatus, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmLogFile=slmLogFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmAuthTable=slmAuthTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmChPass=slmChPass, slmLicenseId=slmLicenseId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdmin=slmAdmin, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassTable=slmChPassTable, slmAuthLogin=slmAuthLogin, slmAdminRowStatus=slmAdminRowStatus, slmAuth=slmAuth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTemperature=slmSysTemperature, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTid=slmTid, slmSysIpAddr=slmSysIpAddr, slmAdminLogin=slmAdminLogin, slmMuxNumber=slmMuxNumber, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmAdminPassword=slmAdminPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmSwRevName=slmSwRevName, slmTrap=slmTrap, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthPassword=slmAuthPassword, slMain=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSys=slmSys, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, SoftwareRevision=SoftwareRevision, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmTrapEnable=slmTrapEnable, slmPsuNumber=slmPsuNumber, UserCommunity=UserCommunity, slmTopologyEnabled=slmTopologyEnabled, slmAdminCommunity=slmAdminCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysOperStatus=slmSysOperStatus, slmWriteCommunity=slmWriteCommunity, slmLicenseEntry=slmLicenseEntry, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf)
