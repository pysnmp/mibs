...
Counter32, iso, Gauge32, MibIdentifier, ModuleIdentity, ObjectIdentity, TimeTicks, Opaque, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, IpAddress, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Gauge32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Opaque", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "IpAddress", "Bits", "Integer32")
TruthValue, TextualConvention, DateAndTime, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DateAndTime", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPmAvailable=slmPmAvailable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam3=slmTrapLogParam3, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTid=slmTid, slmAuthTable=slmAuthTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slmReadCommunity=slmReadCommunity, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmPortsNumber=slmPortsNumber, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmAdminTable=slmAdminTable, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTable=slmTrapLogTable, slMain=slMain, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDirectory=slmSwRevDirectory, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmSwRevName=slmSwRevName, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmSysSnmpVersion=slmSysSnmpVersion, slmSysName=slmSysName, slmChPass=slmChPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassEntry=slmChPassEntry, slmWriteCommunity=slmWriteCommunity, slmLogin=slmLogin, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmLicense=slmLicense, slmSysCalendarTime=slmSysCalendarTime, slmSyslogPort=slmSyslogPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmAuth=slmAuth, slmConfigFile=slmConfigFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, SoftwareRevision=SoftwareRevision, slmChPassNewPass=slmChPassNewPass, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmAdminRowStatus=slmAdminRowStatus, slmAdminPassword=slmAdminPassword, slmTrapUserAccess=slmTrapUserAccess, slmLicenseEntry=slmLicenseEntry, slmSwRevDate=slmSwRevDate, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmSysResetPm=slmSysResetPm, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword)
