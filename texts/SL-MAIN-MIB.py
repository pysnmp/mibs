...
Counter64, IpAddress, Counter32, Opaque, Bits, Gauge32, ObjectIdentity, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, ModuleIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Counter32", "Opaque", "Bits", "Gauge32", "ObjectIdentity", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "ModuleIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, slmVcatDelay=slmVcatDelay, slmLogin=slmLogin, UserLogin=UserLogin, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminTable=slmAdminTable, slmOemType=slmOemType, slmLicense=slmLicense, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysUplinkRate=slmSysUplinkRate, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthTable=slmAuthTable, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmChPassOldPass=slmChPassOldPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestTable=slmTrapDestTable, slmTrapCommunity=slmTrapCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysName=slmSysName, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, AdminAccess=AdminAccess, slmMuxNumber=slmMuxNumber, slmReadCommunity=slmReadCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmTrapPort=slmTrapPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysOperStatus=slmSysOperStatus, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmChPassNewPass=slmChPassNewPass, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmChPassTable=slmChPassTable, slmSysMode=slmSysMode, PYSNMP_MODULE_ID=slMain, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogTable=slmTrapLogTable, slmLicenseIndex=slmLicenseIndex, slmSwRevDirectory=slmSwRevDirectory, slm40GConf=slm40GConf, slmLicenseEntry=slmLicenseEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPass=slmChPass, slmSysCalendarTime=slmSysCalendarTime, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmEdfaNumber=slmEdfaNumber, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmAuthPassword=slmAuthPassword, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminCommunity=slmAdminCommunity, slmSysResetPm=slmSysResetPm, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmTrapLogId=slmTrapLogId, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapEnable=slmTrapEnable, slmWriteCommunity=slmWriteCommunity, slmTid=slmTid, slmRebootDelay=slmRebootDelay, slmAuth=slmAuth, slmSysTrapFormat=slmSysTrapFormat, slmSysTemperature=slmSysTemperature, slmSwRevStatus=slmSwRevStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmSysSubnetMask=slmSysSubnetMask, slMain=slMain, slmTrapLogEntry=slmTrapLogEntry, slmSwRevDate=slmSwRevDate, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthEntry=slmAuthEntry)
