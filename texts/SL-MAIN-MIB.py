...
Bits, iso, ModuleIdentity, IpAddress, TimeTicks, Gauge32, MibIdentifier, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ObjectIdentity, Integer32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "ModuleIdentity", "IpAddress", "TimeTicks", "Gauge32", "MibIdentifier", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ObjectIdentity", "Integer32", "Opaque")
RowStatus, DisplayString, DateAndTime, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "DateAndTime", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapCommunity=slmTrapCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam2=slmTrapLogParam2, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmPsuNumber=slmPsuNumber, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestTable=slmTrapDestTable, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseTable=slmLicenseTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slMain=slMain, slmVcatDelay=slmVcatDelay, slmLicenseEntry=slmLicenseEntry, slmAuthEntry=slmAuthEntry, slmConfigFile=slmConfigFile, UserLogin=UserLogin, slmSysName=slmSysName, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmSysAdminStatus=slmSysAdminStatus, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysIpAddr=slmSysIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSwRevTable=slmSwRevTable, slmChPassLogin=slmChPassLogin, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, slmSysLocation=slmSysLocation, slmNetworkMode=slmNetworkMode, slmSyslogPort=slmSyslogPort, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmLogFile=slmLogFile, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmSysCalendarTime=slmSysCalendarTime, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthCommunity=slmAuthCommunity, slmTrapLogId=slmTrapLogId, slmBoxSize=slmBoxSize, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysOperStatus=slmSysOperStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, UserCommunity=UserCommunity, UserPassword=UserPassword, slmAdminTable=slmAdminTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, slmChPassNewPass=slmChPassNewPass, slmAdminRowStatus=slmAdminRowStatus, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestAddress=slmSyslogDestAddress, slmTrap=slmTrap, slmAuthLogin=slmAuthLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmConfigSysUptime=slmConfigSysUptime, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmPmAvailable=slmPmAvailable, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTid=slmTid, slmTrapLogName=slmTrapLogName, slmSwRevName=slmSwRevName, slmOemType=slmOemType, slmEdfaNumber=slmEdfaNumber, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam5=slmTrapLogParam5, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmLogin=slmLogin, slmLicense=slmLicense, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmLicenseIndex=slmLicenseIndex)
