...
MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Counter64, iso, ObjectIdentity, TimeTicks, Bits, Integer32, Gauge32, Opaque, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Counter64", "iso", "ObjectIdentity", "TimeTicks", "Bits", "Integer32", "Gauge32", "Opaque", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigFile=slmConfigFile, slmTrapPort=slmTrapPort, slmLicenseEntry=slmLicenseEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam4=slmTrapLogParam4, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminPassword=slmAdminPassword, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapCommunity=slmTrapCommunity, slmOemType=slmOemType, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, UserPassword=UserPassword, slmAdminCommunity=slmAdminCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRstpEnabled=slmRstpEnabled, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRebootDelay=slmRebootDelay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmVcatDelay=slmVcatDelay, slmSyslogDestAddress=slmSyslogDestAddress, slmAdmin=slmAdmin, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slMain=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, slmTrapEnable=slmTrapEnable, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, slmSysOperStatus=slmSysOperStatus, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDate=slmSwRevDate, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmPortsNumber=slmPortsNumber, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysMode=slmSysMode, slmLogFile=slmLogFile, slmAuthCommunity=slmAuthCommunity, slmTrapLogName=slmTrapLogName, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmSyslogPort=slmSyslogPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLocation=slmSysLocation, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysIpAddr=slmSysIpAddr, AdminAccess=AdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthEntry=slmAuthEntry, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, UserLogin=UserLogin, slm40GConf=slm40GConf, slmTid=slmTid, slmLogin=slmLogin, slmSysUplinkRate=slmSysUplinkRate, slmChPassEntry=slmChPassEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmAct=slmSysAlmAct, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassLogin=slmChPassLogin, slmTrapLogParam6=slmTrapLogParam6, slmSys=slmSys, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmAuthPassword=slmAuthPassword, slmChPassTable=slmChPassTable, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmSyslogDestTable=slmSyslogDestTable, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam2=slmTrapLogParam2, slmChPass=slmChPass, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, UserCommunity=UserCommunity)
