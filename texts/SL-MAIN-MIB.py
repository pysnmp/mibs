...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTemperature=slmSysTemperature, slmTrapDestTable=slmTrapDestTable, slmChPassEntry=slmChPassEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTid=slmTid, slmSysChassisId=slmSysChassisId, slmSysLocation=slmSysLocation, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, UserPassword=UserPassword, slmChPass=slmChPass, SoftwareRevision=SoftwareRevision, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicense=slmLicense, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDirectory=slmSwRevDirectory, slmLogin=slmLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmSwRevEntry=slmSwRevEntry, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmTrapEnable=slmTrapEnable, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSnmpVersion=slmSysSnmpVersion, slMain=slMain, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmTrap=slmTrap, slmSysAlmDeact=slmSysAlmDeact, slmAdminCommunity=slmAdminCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogId=slmTrapLogId, UserCommunity=UserCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPortsNumber=slmPortsNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmNetworkMode=slmNetworkMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapPort=slmTrapPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestAddress=slmTrapDestAddress, slmChPassTable=slmChPassTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmMuxNumber=slmMuxNumber, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRstpEnabled=slmRstpEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSwRevStatus=slmSwRevStatus, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminPassword=slmAdminPassword, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmLicenseExpiration=slmLicenseExpiration, slmWriteCommunity=slmWriteCommunity, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmAdminTable=slmAdminTable, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmSysName=slmSysName, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmTrapLogName=slmTrapLogName, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmChPassNewPass=slmChPassNewPass, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slmEdfaNumber=slmEdfaNumber, slmConfigFile=slmConfigFile, slmSys=slmSys, slmTrapLogParam4=slmTrapLogParam4, slmAuthLogin=slmAuthLogin, slmSysResetPm=slmSysResetPm, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSysMode=slmSysMode)
