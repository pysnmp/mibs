...
NotificationType, Counter64, Bits, Unsigned32, Opaque, Counter32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, iso, ModuleIdentity, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Bits", "Unsigned32", "Opaque", "Counter32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "iso", "ModuleIdentity", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmAuthTable=slmAuthTable, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDate=slmSwRevDate, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSys=slmSys, slmOemType=slmOemType, slmAdminCommunity=slmAdminCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapPort=slmTrapPort, slmTrapEnable=slmTrapEnable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmEdfaNumber=slmEdfaNumber, slmLicenseEntry=slmLicenseEntry, slmRebootDelay=slmRebootDelay, slmLogin=slmLogin, slmTrapLogParam2=slmTrapLogParam2, slmRstpEnabled=slmRstpEnabled, slmChPassTable=slmChPassTable, slmWriteCommunity=slmWriteCommunity, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmSyslogLevel=slmSyslogLevel, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigFile=slmConfigFile, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmTopologyEnabled=slmTopologyEnabled, slmAuthEntry=slmAuthEntry, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserPassword=UserPassword, slmTrapLogParam3=slmTrapLogParam3, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysIpAddr=slmSysIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysOperStatus=slmSysOperStatus, slmSysAdminStatus=slmSysAdminStatus, slmAdminTable=slmAdminTable, slmAdminRowStatus=slmAdminRowStatus, slmPortsNumber=slmPortsNumber, slmChPassOldPass=slmChPassOldPass, slmSwRevTable=slmSwRevTable, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmAdminPassword=slmAdminPassword, slmSwRevStatus=slmSwRevStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode, slmSysMode=slmSysMode, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPass=slmChPass, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestTable=slmTrapDestTable, slmMuxNumber=slmMuxNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmLicenseExpiration=slmLicenseExpiration, slmAdmin=slmAdmin, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, UserCommunity=UserCommunity, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysTemperature=slmSysTemperature, slmTid=slmTid, slmAuthCommunity=slmAuthCommunity, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevName=slmSwRevName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogName=slmTrapLogName, slmTrapLogTable=slmTrapLogTable, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysName=slmSysName, slm40GConf=slm40GConf, slmLicense=slmLicense)
