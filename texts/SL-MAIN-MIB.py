...
DisplayString, TimeStamp, RowStatus, TruthValue, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "TruthValue", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmTrap=slmTrap, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmPsuNumber=slmPsuNumber, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, slmNetworkMode=slmNetworkMode, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassOldPass=slmChPassOldPass, slmSwRevTable=slmSwRevTable, slmVcatDelay=slmVcatDelay, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseId=slmLicenseId, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmTrapEnable=slmTrapEnable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmOemType=slmOemType, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestTable=slmSyslogDestTable, slmChPassTable=slmChPassTable, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevStatus=slmSwRevStatus, slmTrapLogName=slmTrapLogName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmSysIpAddr=slmSysIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, slmSysResetPm=slmSysResetPm, slmLogFile=slmLogFile, slmLicenseExpiration=slmLicenseExpiration, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, slmRstpEnabled=slmRstpEnabled, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmBoxSize=slmBoxSize, UserLogin=UserLogin, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmPmAvailable=slmPmAvailable, slmAdminLogin=slmAdminLogin, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSysTemperature=slmSysTemperature, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAuthTable=slmAuthTable, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmConfigFile=slmConfigFile, slmTid=slmTid, slmAdminAccess=slmAdminAccess, slmChPass=slmChPass, slmSysTrapFormat=slmSysTrapFormat, slmMuxNumber=slmMuxNumber, slmSyslogPort=slmSyslogPort, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmChPassEntry=slmChPassEntry, slmSysAlmAct=slmSysAlmAct, slmAdmin=slmAdmin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTable=slmTrapLogTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysCalendarTime=slmSysCalendarTime, UserPassword=UserPassword, slmLicenseIndex=slmLicenseIndex, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmAuthPassword=slmAuthPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogin=slmLogin, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmTrapLogParam1=slmTrapLogParam1, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange)
