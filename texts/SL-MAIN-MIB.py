...
Bits, Counter64, iso, TimeTicks, Opaque, MibIdentifier, Counter32, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "iso", "TimeTicks", "Opaque", "MibIdentifier", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32")
DateAndTime, TimeStamp, TextualConvention, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysUptime=slmConfigSysUptime, slmSysSubnetMask=slmSysSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminAccess=slmAdminAccess, slmTid=slmTid, slmSysOperStatus=slmSysOperStatus, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmSwRevStatus=slmSwRevStatus, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmSysChassisId=slmSysChassisId, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSysMode=slmSysMode, slmSysIpAddr=slmSysIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthPassword=slmAuthPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, slmLicenseExpiration=slmLicenseExpiration, slmReadCommunity=slmReadCommunity, slmPsuNumber=slmPsuNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmTrapSysNameChange=slmTrapSysNameChange, slmLogin=slmLogin, slmSysTrapFormat=slmSysTrapFormat, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, slmSys=slmSys, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmOemType=slmOemType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogName=slmTrapLogName, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmRebootDelay=slmRebootDelay, slmTrapLogParam4=slmTrapLogParam4, slmSwRevName=slmSwRevName, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthLogin=slmAuthLogin, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogTable=slmTrapLogTable, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmAdminLogin=slmAdminLogin, slMain=slMain, slmAdmin=slmAdmin, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, PYSNMP_MODULE_ID=slMain, slmLicenseId=slmLicenseId, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, SoftwareRevision=SoftwareRevision, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmMuxNumber=slmMuxNumber, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, slmLicenseTable=slmLicenseTable, UserCommunity=UserCommunity, slmTrapDestTable=slmTrapDestTable, slmSwRevDirectory=slmSwRevDirectory, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassLogin=slmChPassLogin, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword)
