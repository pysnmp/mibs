...
ObjectIdentity, NotificationType, Counter64, Unsigned32, Opaque, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, Gauge32, TimeTicks, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter64", "Unsigned32", "Opaque", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "Gauge32", "TimeTicks", "iso", "Counter32")
DisplayString, TextualConvention, DateAndTime, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "DateAndTime", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmMuxNumber=slmMuxNumber, slmSysLocation=slmSysLocation, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmTrapDestTable=slmTrapDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam5=slmTrapLogParam5, slmAdminAccess=slmAdminAccess, slmLicenseIndex=slmLicenseIndex, slmTrap=slmTrap, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmPsuNumber=slmPsuNumber, slmAuthEntry=slmAuthEntry, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmTrapCommunity=slmTrapCommunity, slmBoxSize=slmBoxSize, slmTrapLogId=slmTrapLogId, slmAuthLogin=slmAuthLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmSwRevTable=slmSwRevTable, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseId=slmLicenseId, slmTrapLogParam1=slmTrapLogParam1, slmLogin=slmLogin, slmLogFile=slmLogFile, slmAdmin=slmAdmin, slmSysIpAddr=slmSysIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmLicense=slmLicense, slmAdminEntry=slmAdminEntry, slmTrapLogParam2=slmTrapLogParam2, UserPassword=UserPassword, slmSwRevName=slmSwRevName, slmOemType=slmOemType, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, slmTid=slmTid, slmChPassLogin=slmChPassLogin, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, slmRebootDelay=slmRebootDelay, slmSyslogLevel=slmSyslogLevel, slmSysOperStatus=slmSysOperStatus, slmAuthTable=slmAuthTable, slmReadCommunity=slmReadCommunity, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysResetPm=slmSysResetPm, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, slmChPassOldPass=slmChPassOldPass, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthCommunity=slmAuthCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestEntry=slmTrapDestEntry, slmTrapPort=slmTrapPort, slmSwRevDirectory=slmSwRevDirectory, slmPmAvailable=slmPmAvailable, slmAdminPassword=slmAdminPassword, slmLicenseEntry=slmLicenseEntry, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysMode=slmSysMode, slmSys=slmSys, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmSyslogDestEntry=slmSyslogDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion)
