...
ObjectIdentity, Opaque, Integer32, Bits, Counter32, Gauge32, iso, MibIdentifier, IpAddress, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Opaque", "Integer32", "Bits", "Counter32", "Gauge32", "iso", "MibIdentifier", "IpAddress", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseTable=slmLicenseTable, slmTrapDestTable=slmTrapDestTable, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmBoxSize=slmBoxSize, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminAccess=slmAdminAccess, slmRstpEnabled=slmRstpEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevName=slmSwRevName, slmVcatDelay=slmVcatDelay, slmNetworkMode=slmNetworkMode, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmLogFile=slmLogFile, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmAuthEntry=slmAuthEntry, slmSysTrapFormat=slmSysTrapFormat, slmSysChassisId=slmSysChassisId, slmAuthLogin=slmAuthLogin, slmSwRevTable=slmSwRevTable, slmOemType=slmOemType, slmTrapSysLocationChange=slmTrapSysLocationChange, slMain=slMain, slmSys=slmSys, slmTrapLogParam3=slmTrapLogParam3, slmLicenseIndex=slmLicenseIndex, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmChPassNewPass=slmChPassNewPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmAdmin=slmAdmin, UserCommunity=UserCommunity, PYSNMP_MODULE_ID=slMain, slmTrapDestEntry=slmTrapDestEntry, slmLicenseId=slmLicenseId, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmPsuNumber=slmPsuNumber, slmTrapPort=slmTrapPort, slmTrapEnable=slmTrapEnable, slmTrapLogParam2=slmTrapLogParam2, slmChPassOldPass=slmChPassOldPass, slmSysOperStatus=slmSysOperStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassLogin=slmChPassLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogName=slmTrapLogName, UserPassword=UserPassword, slmSysIpAddr=slmSysIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTable=slmTrapLogTable, slmSwRevEntry=slmSwRevEntry, slmSysMode=slmSysMode, slmTopologyEnabled=slmTopologyEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmSysAdminStatus=slmSysAdminStatus, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, AdminAccess=AdminAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmAuthCommunity=slmAuthCommunity, slmLicense=slmLicense, slmConfigSysUptime=slmConfigSysUptime, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPass=slmChPass, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmAdminTable=slmAdminTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmPmAvailable=slmPmAvailable, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmRebootDelay=slmRebootDelay)
