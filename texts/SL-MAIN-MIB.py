...
Bits, Unsigned32, NotificationType, IpAddress, Opaque, iso, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity, TimeTicks, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "NotificationType", "IpAddress", "Opaque", "iso", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
TextualConvention, TruthValue, RowStatus, TimeStamp, DisplayString, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp", "DisplayString", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminEntry=slmAdminEntry, slmAuth=slmAuth, slmTrap=slmTrap, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmAdminPassword=slmAdminPassword, slmTrapLogParam1=slmTrapLogParam1, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevDate=slmSwRevDate, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, slmLicenseIndex=slmLicenseIndex, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmSysSnmpVersion=slmSysSnmpVersion, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, slmLicenseEntry=slmLicenseEntry, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseTable=slmLicenseTable, slmAuthEntry=slmAuthEntry, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmRebootDelay=slmRebootDelay, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmTrapDestTable=slmTrapDestTable, slmPortsNumber=slmPortsNumber, slmSwRevTable=slmSwRevTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmTrapLogName=slmTrapLogName, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slMain=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slmTrapCommunity=slmTrapCommunity, slmAdminCommunity=slmAdminCommunity, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogFile=slmLogFile, slmTrapLogParam2=slmTrapLogParam2, slmSysTemperature=slmSysTemperature, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmConfigSysUptime=slmConfigSysUptime, slmSysCalendarTime=slmSysCalendarTime, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassNewPass=slmChPassNewPass, slmSwRevDirectory=slmSwRevDirectory, slmMuxNumber=slmMuxNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigFile=slmConfigFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOemType=slmOemType, slm40GConf=slm40GConf, slmSys=slmSys, slmAdminRowStatus=slmAdminRowStatus, slmSwRevStatus=slmSwRevStatus, slmLogin=slmLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmTopologyEnabled=slmTopologyEnabled, UserCommunity=UserCommunity)
