...
Unsigned32, IpAddress, TimeTicks, iso, NotificationType, Opaque, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Gauge32, Counter32, ModuleIdentity, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "TimeTicks", "iso", "NotificationType", "Opaque", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Gauge32", "Counter32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam3=slmTrapLogParam3, slmSwRevName=slmSwRevName, slmSwRevDate=slmSwRevDate, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthTable=slmAuthTable, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTid=slmTid, slmChPassLogin=slmChPassLogin, slmSwRevEntry=slmSwRevEntry, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmAuthLogin=slmAuthLogin, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, UserCommunity=UserCommunity, slmPmAvailable=slmPmAvailable, slmAuth=slmAuth, slmAuthPassword=slmAuthPassword, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSysAdminStatus=slmSysAdminStatus, slmSys=slmSys, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam2=slmTrapLogParam2, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, slmTrapUserAccess=slmTrapUserAccess, slmReadCommunity=slmReadCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmAdminTable=slmAdminTable, slmLicenseId=slmLicenseId, SoftwareRevision=SoftwareRevision, slmChPass=slmChPass, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Auth=slmSnmpv3Auth, slMain=slMain, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, UserPassword=UserPassword, slmWriteCommunity=slmWriteCommunity, slmSysTemperature=slmSysTemperature, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTable=slmTrapLogTable, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmSyslogLevel=slmSyslogLevel, slm40GConf=slm40GConf, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayAddr=slmSysGatewayAddr, UserLogin=UserLogin, slmTrapDestTable=slmTrapDestTable, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmSysLocation=slmSysLocation, slmLicenseTable=slmLicenseTable, slmTrapLogParam6=slmTrapLogParam6, slmSysMode=slmSysMode, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysUptime=slmConfigSysUptime, slmSwRevTable=slmSwRevTable, slmPsuNumber=slmPsuNumber, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slmSyslogPort=slmSyslogPort, slmLogin=slmLogin, PYSNMP_MODULE_ID=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmTrapPort=slmTrapPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDirectory=slmSwRevDirectory, slmAdminAccess=slmAdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysResetPm=slmSysResetPm, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogName=slmTrapLogName, slmSysIpAddr=slmSysIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrap=slmTrap, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmAdminPassword=slmAdminPassword, slmSysTrapFormat=slmSysTrapFormat, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmSysSubnetMask=slmSysSubnetMask)
