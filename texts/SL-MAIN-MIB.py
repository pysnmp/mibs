...
Integer32, ObjectIdentity, Counter64, Counter32, ModuleIdentity, Opaque, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, IpAddress, Bits, TimeTicks, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter64", "Counter32", "ModuleIdentity", "Opaque", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "iso")
TruthValue, TimeStamp, DateAndTime, DisplayString, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DateAndTime", "DisplayString", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseExpiration=slmLicenseExpiration, UserCommunity=UserCommunity, slmSysMode=slmSysMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmAuthLogin=slmAuthLogin, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminTable=slmAdminTable, slmTrapLogEntry=slmTrapLogEntry, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmSwRevDirectory=slmSwRevDirectory, slmAuthEntry=slmAuthEntry, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserAccess=slmTrapUserAccess, slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slm40GConf=slm40GConf, slmTrap=slmTrap, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmSysCalendarTime=slmSysCalendarTime, slmAuthPassword=slmAuthPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapEnable=slmTrapEnable, slmSysTemperature=slmSysTemperature, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmPmAvailable=slmPmAvailable, slmReadCommunity=slmReadCommunity, slmNetworkMode=slmNetworkMode, AdminAccess=AdminAccess, slmAdminPassword=slmAdminPassword, slmTopologyEnabled=slmTopologyEnabled, slmConfigSysUptime=slmConfigSysUptime, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmChPassTable=slmChPassTable, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmSys=slmSys, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, PYSNMP_MODULE_ID=slMain, slmTrapPort=slmTrapPort, slmTrapDestEntry=slmTrapDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassNewPass=slmChPassNewPass, slmEdfaNumber=slmEdfaNumber, slmChPass=slmChPass, slmSysUplinkRate=slmSysUplinkRate, slmAdminLogin=slmAdminLogin, slmTrapDestAddress=slmTrapDestAddress, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmBoxSize=slmBoxSize, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicense=slmLicense, slmRebootDelay=slmRebootDelay, slmSysAlmAct=slmSysAlmAct, slmSyslogDestTable=slmSyslogDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigFile=slmConfigFile, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr)
