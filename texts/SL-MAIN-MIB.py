...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmSyslogDestAddress=slmSyslogDestAddress, slmVcatDelay=slmVcatDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapCommunity=slmTrapCommunity, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmTrapDestRowStatus=slmTrapDestRowStatus, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminAccess=slmAdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestTable=slmTrapDestTable, slmPmAvailable=slmPmAvailable, slmSysCalendarTime=slmSysCalendarTime, slmChPassTable=slmChPassTable, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysSignalType=slmConfigSysSignalType, slmBoxSize=slmBoxSize, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevTable=slmSwRevTable, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmAdminCommunity=slmAdminCommunity, slmLogFile=slmLogFile, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, slmTrapSysNameChange=slmTrapSysNameChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmSyslogDestEntry=slmSyslogDestEntry, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRebootDelay=slmRebootDelay, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, AdminAccess=AdminAccess, slmSwRevDate=slmSwRevDate, slmSyslogLevel=slmSyslogLevel, slmLicenseExpiration=slmLicenseExpiration, slmLicense=slmLicense, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogName=slmTrapLogName, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam5=slmTrapLogParam5, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmChPassLogin=slmChPassLogin, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmAdmin=slmAdmin, slmSysAdminStatus=slmSysAdminStatus, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmNetworkMode=slmNetworkMode, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmTrapEnable=slmTrapEnable, slmTrapLogId=slmTrapLogId, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmAuthTable=slmAuthTable, slmTid=slmTid)
