...
ModuleIdentity, Opaque, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, MibIdentifier, NotificationType, Bits, ObjectIdentity, Unsigned32, IpAddress, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Opaque", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthPassword=slmAuthPassword, slmLicenseEntry=slmLicenseEntry, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmSyslogPort=slmSyslogPort, slmRstpEnabled=slmRstpEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmWriteCommunity=slmWriteCommunity, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, slmAuth=slmAuth, slmTrapPort=slmTrapPort, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmSysName=slmSysName, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable, slmVcatDelay=slmVcatDelay, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmTid=slmTid, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmLogFile=slmLogFile, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmSnmpv3Password=slmSnmpv3Password, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmEdfaNumber=slmEdfaNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmRebootDelay=slmRebootDelay, slmAdminAccess=slmAdminAccess, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmAdminLogin=slmAdminLogin, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmSwRevEntry=slmSwRevEntry, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTable=slmTrapLogTable, slmSysTemperature=slmSysTemperature, slmAdminEntry=slmAdminEntry, slmConfigFile=slmConfigFile, SoftwareRevision=SoftwareRevision, slmSysTrapFormat=slmSysTrapFormat, slmChPassLogin=slmChPassLogin, slmChPassEntry=slmChPassEntry, slmTrap=slmTrap, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmNetworkMode=slmNetworkMode, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmReadCommunity=slmReadCommunity, PYSNMP_MODULE_ID=slMain, UserCommunity=UserCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSysIpAddr=slmSysIpAddr, slmPortsNumber=slmPortsNumber, slmLogin=slmLogin, slmOemType=slmOemType, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmAuthCommunity=slmAuthCommunity, slMain=slMain, slmSys=slmSys, slmTrapLogEntry=slmTrapLogEntry, slmSysLocation=slmSysLocation, slmSwRevName=slmSwRevName, slmSwRevTable=slmSwRevTable, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam3=slmTrapLogParam3, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmAct=slmSysAlmAct, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5)
