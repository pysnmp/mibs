...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmLogFile=slmLogFile, slmSnmpv3Password=slmSnmpv3Password, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmAdmin=slmAdmin, AdminAccess=AdminAccess, slmLicense=slmLicense, slmAdminAccess=slmAdminAccess, slmVcatDelay=slmVcatDelay, slmMuxNumber=slmMuxNumber, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogEntry=slmTrapLogEntry, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDirectory=slmSwRevDirectory, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthPassword=slmAuthPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmPsuNumber=slmPsuNumber, slmRebootDelay=slmRebootDelay, slmSysCalendarTime=slmSysCalendarTime, slmLicenseTable=slmLicenseTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slmTrapEnable=slmTrapEnable, slmAuth=slmAuth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slm40GConf=slm40GConf, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassOldPass=slmChPassOldPass, slmAuthEntry=slmAuthEntry, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapCommunity=slmTrapCommunity, slmTid=slmTid, slmChPassTable=slmChPassTable, slmPortsNumber=slmPortsNumber, slmAuthLogin=slmAuthLogin, slmAdminPassword=slmAdminPassword, slmTrapDestEntry=slmTrapDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmSysName=slmSysName, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmChPassLogin=slmChPassLogin, slmLicenseIndex=slmLicenseIndex, slmSysResetPm=slmSysResetPm, slmLogin=slmLogin, slmSysAlmAct=slmSysAlmAct, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmTrapLogParam2=slmTrapLogParam2, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogName=slmTrapLogName, UserCommunity=UserCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmAdminEntry=slmAdminEntry, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmAdminCommunity=slmAdminCommunity, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmAdminRowStatus=slmAdminRowStatus, slmAdminLogin=slmAdminLogin, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDate=slmSwRevDate, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmTrapLogId=slmTrapLogId, slMain=slMain, slmTrapLogParam1=slmTrapLogParam1, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, slmSysChassisId=slmSysChassisId)
