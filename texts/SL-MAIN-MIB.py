...
TimeTicks, ObjectIdentity, Bits, Counter32, MibIdentifier, ModuleIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter64, Opaque, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Bits", "Counter32", "MibIdentifier", "ModuleIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter64", "Opaque", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestTable=slmSyslogDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmSwRevTable=slmSwRevTable, slmTrapLogName=slmTrapLogName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysIpAddr=slmSysIpAddr, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmAdminAccess=slmAdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassTable=slmChPassTable, slmTrapLogParam6=slmTrapLogParam6, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam4=slmTrapLogParam4, slmAuthEntry=slmAuthEntry, slmSyslogPort=slmSyslogPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapPort=slmTrapPort, slmMuxNumber=slmMuxNumber, slmLogin=slmLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmAuthPassword=slmAuthPassword, UserPassword=UserPassword, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmTrapLogParam1=slmTrapLogParam1, slmLicenseExpiration=slmLicenseExpiration, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmAuth=slmAuth, slmSysTemperature=slmSysTemperature, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminLogin=slmAdminLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmSysMode=slmSysMode, slmAdmin=slmAdmin, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmReadCommunity=slmReadCommunity, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, SoftwareRevision=SoftwareRevision, slmAdminEntry=slmAdminEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmOemType=slmOemType, slmRstpEnabled=slmRstpEnabled, slmChPass=slmChPass, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmSysSubnetMask=slmSysSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTable=slmTrapLogTable, AdminAccess=AdminAccess, slmLicenseTable=slmLicenseTable, slmTrapCommunity=slmTrapCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmSysName=slmSysName, slmLogFile=slmLogFile, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmVcatDelay=slmVcatDelay, slmSysUplinkRate=slmSysUplinkRate, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmTrapLogId=slmTrapLogId, slmChPassEntry=slmChPassEntry, slmConfigFile=slmConfigFile, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevName=slmSwRevName, slmSysResetPm=slmSysResetPm, slmPortsNumber=slmPortsNumber)
