...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmNetworkMode=slmNetworkMode, slm40GConf=slm40GConf, slmTrapLogTable=slmTrapLogTable, slmSysOperStatus=slmSysOperStatus, slmSysChassisId=slmSysChassisId, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevName=slmSwRevName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPass=slmChPass, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseIndex=slmLicenseIndex, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmAdmin=slmAdmin, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmReadCommunity=slmReadCommunity, slmPsuNumber=slmPsuNumber, slmConfigSysUptime=slmConfigSysUptime, slmMuxNumber=slmMuxNumber, slmTrapCommunity=slmTrapCommunity, slmLicense=slmLicense, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmAuthPassword=slmAuthPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmTrapUserLogin=slmTrapUserLogin, slmTrapPort=slmTrapPort, slmAuthEntry=slmAuthEntry, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmAct=slmSysAlmAct, slmLicenseTable=slmLicenseTable, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, slmAdminRowStatus=slmAdminRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysLanIpAddr=slmSysLanIpAddr, slmSysResetPm=slmSysResetPm, slmSysMode=slmSysMode, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, slmChPassLogin=slmChPassLogin, slmAdminAccess=slmAdminAccess, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmSyslogLevel=slmSyslogLevel, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmTrapLogName=slmTrapLogName, slmTrapLogId=slmTrapLogId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminTable=slmAdminTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slMain=slMain, slmChPassOldPass=slmChPassOldPass, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmTrapLogParam4=slmTrapLogParam4, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmSwRevTable=slmSwRevTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmAdminCommunity=slmAdminCommunity, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, SoftwareRevision=SoftwareRevision, slmVcatDelay=slmVcatDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysUplinkRate=slmSysUplinkRate, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmChPassTable=slmChPassTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminLogin=slmAdminLogin, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmConfigFile=slmConfigFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmPortsNumber=slmPortsNumber, slmSysName=slmSysName, slmAuthLogin=slmAuthLogin, slmSysGatewayAddr=slmSysGatewayAddr, AdminAccess=AdminAccess)
