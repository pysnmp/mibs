...
Opaque, Bits, Counter32, MibIdentifier, iso, TimeTicks, IpAddress, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Unsigned32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Bits", "Counter32", "MibIdentifier", "iso", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Unsigned32", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthLogin=slmAuthLogin, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmDeact=slmSysAlmDeact, SoftwareRevision=SoftwareRevision, slmTrapPort=slmTrapPort, slmTrapLogId=slmTrapLogId, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable, slmLogFile=slmLogFile, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmRebootDelay=slmRebootDelay, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDirectory=slmSwRevDirectory, slmSysSubnetMask=slmSysSubnetMask, slmAdminCommunity=slmAdminCommunity, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess, slmNetworkMode=slmNetworkMode, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam5=slmTrapLogParam5, slmSysChassisId=slmSysChassisId, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDate=slmSwRevDate, slmSyslogPort=slmSyslogPort, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slmSysOperStatus=slmSysOperStatus, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapEnable=slmTrapEnable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmReadCommunity=slmReadCommunity, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysCalendarTime=slmSysCalendarTime, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmSysLocation=slmSysLocation, slmSysName=slmSysName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSyslogDestTable=slmSyslogDestTable, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam3=slmTrapLogParam3, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmConfigSysSignalType=slmConfigSysSignalType, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmTrapDestAddress=slmTrapDestAddress, slmAdmin=slmAdmin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthPassword=slmAuthPassword, slmTid=slmTid, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthCommunity=slmAuthCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysUptime=slmConfigSysUptime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevStatus=slmSwRevStatus, slmSwRevEntry=slmSwRevEntry, slmAdminPassword=slmAdminPassword, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmSysMode=slmSysMode, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmConfigFile=slmConfigFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestEntry=slmTrapDestEntry, slmAdminLogin=slmAdminLogin, slmAdminAccess=slmAdminAccess, slmAuthTable=slmAuthTable, slmSys=slmSys)
