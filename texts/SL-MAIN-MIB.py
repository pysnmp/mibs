...
TimeTicks, NotificationType, Counter64, MibIdentifier, ModuleIdentity, iso, Opaque, Integer32, IpAddress, Counter32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Counter64", "MibIdentifier", "ModuleIdentity", "iso", "Opaque", "Integer32", "IpAddress", "Counter32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSys=slmSys, slm40GConf=slm40GConf, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmMuxNumber=slmMuxNumber, slmLicenseEntry=slmLicenseEntry, slmSysOperStatus=slmSysOperStatus, slmTrapDestTable=slmTrapDestTable, slmPmAvailable=slmPmAvailable, slmSysLocation=slmSysLocation, slmTrapEnable=slmTrapEnable, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmSysSubnetMask=slmSysSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmDeact=slmSysAlmDeact, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmAdminLogin=slmAdminLogin, slmLogin=slmLogin, slmChPassTable=slmChPassTable, slmReadCommunity=slmReadCommunity, slmSwRevDate=slmSwRevDate, slmSysTemperature=slmSysTemperature, slmEdfaNumber=slmEdfaNumber, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmRebootDelay=slmRebootDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthLogin=slmAuthLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmAdmin=slmAdmin, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, AdminAccess=AdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmSysName=slmSysName, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmChPassOldPass=slmChPassOldPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmBoxSize=slmBoxSize, slmAuthCommunity=slmAuthCommunity, slmLogFile=slmLogFile, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam4=slmTrapLogParam4, slmLicenseId=slmLicenseId, slmSysIpAddr=slmSysIpAddr, slmSwRevTable=slmSwRevTable, slMain=slMain, slmSysMode=slmSysMode, slmAuthTable=slmAuthTable, UserPassword=UserPassword, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminTable=slmAdminTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogEntry=slmTrapLogEntry, slmLicenseTable=slmLicenseTable, slmTrapLogTable=slmTrapLogTable, slmOemType=slmOemType, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestEntry=slmTrapDestEntry, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmChPassEntry=slmChPassEntry, slmAdminAccess=slmAdminAccess, UserCommunity=UserCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmAuthEntry=slmAuthEntry, slmAdminEntry=slmAdminEntry)
