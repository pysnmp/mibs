...
NotificationType, Unsigned32, iso, Bits, Gauge32, ModuleIdentity, Opaque, Integer32, Counter64, TimeTicks, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "iso", "Bits", "Gauge32", "ModuleIdentity", "Opaque", "Integer32", "Counter64", "TimeTicks", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier")
DisplayString, TimeStamp, TruthValue, RowStatus, TextualConvention, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestEntry=slmSyslogDestEntry, PYSNMP_MODULE_ID=slMain, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slMain=slMain, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmMuxNumber=slmMuxNumber, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, slmSysSubnetMask=slmSysSubnetMask, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmOemType=slmOemType, slmAuthLogin=slmAuthLogin, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysResetPm=slmSysResetPm, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminCommunity=slmAdminCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapDestAddress=slmTrapDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthTable=slmAuthTable, slmAdminLogin=slmAdminLogin, slmSysIpAddr=slmSysIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmTrapLogName=slmTrapLogName, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, UserCommunity=UserCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogPort=slmSyslogPort, slmEdfaNumber=slmEdfaNumber, slmBoxSize=slmBoxSize, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmSys=slmSys, slmPmAvailable=slmPmAvailable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmNetworkMode=slmNetworkMode, slmSnmpv3Auth=slmSnmpv3Auth, slmLicense=slmLicense, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, slmPortsNumber=slmPortsNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmSysAlmAct=slmSysAlmAct, slmChPass=slmChPass, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserLogin=slmTrapUserLogin, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmLicenseEntry=slmLicenseEntry, slmAuthPassword=slmAuthPassword, slmAuthEntry=slmAuthEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmSysMode=slmSysMode, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmLicenseTable=slmLicenseTable, slmAuthCommunity=slmAuthCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword)
