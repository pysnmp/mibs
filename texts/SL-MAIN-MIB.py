...
NotificationType, Gauge32, Integer32, ModuleIdentity, Opaque, ObjectIdentity, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Bits, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Integer32", "ModuleIdentity", "Opaque", "ObjectIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Bits", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthLogin=slmAuthLogin, slmChPassLogin=slmChPassLogin, slmLicenseEntry=slmLicenseEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam3=slmTrapLogParam3, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, SoftwareRevision=SoftwareRevision, slmSys=slmSys, slmTrapUserLogin=slmTrapUserLogin, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam2=slmTrapLogParam2, slmAdminLogin=slmAdminLogin, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmTrapLogId=slmTrapLogId, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmSysTemperature=slmSysTemperature, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapCommunity=slmTrapCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam5=slmTrapLogParam5, AdminAccess=AdminAccess, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmLicenseTable=slmLicenseTable, slmTrapDestEntry=slmTrapDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmPsuNumber=slmPsuNumber, slmSysLocation=slmSysLocation, slmTrapLogTable=slmTrapLogTable, PYSNMP_MODULE_ID=slMain, slmOemType=slmOemType, slmChPassOldPass=slmChPassOldPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmAct=slmSysAlmAct, slmTrapPort=slmTrapPort, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigFile=slmConfigFile, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmTid=slmTid, slmSysMode=slmSysMode, slmSyslogPort=slmSyslogPort, slmAdminAccess=slmAdminAccess, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmSysAdminStatus=slmSysAdminStatus, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slMain=slMain, slmSwRevDate=slmSwRevDate, slmSwRevTable=slmSwRevTable, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, slmAdmin=slmAdmin, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysSubnetMask=slmSysSubnetMask, slmLogFile=slmLogFile, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestTable=slmSyslogDestTable, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmAdminTable=slmAdminTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysName=slmSysName, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysChassisId=slmSysChassisId, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmChPassNewPass=slmChPassNewPass, slmLicenseIndex=slmLicenseIndex)
