...
iso, TimeTicks, MibIdentifier, Integer32, IpAddress, Counter64, ModuleIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Opaque, NotificationType, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibIdentifier", "Integer32", "IpAddress", "Counter64", "ModuleIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Opaque", "NotificationType", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slMain=slMain, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmTrapPort=slmTrapPort, slmTrapLogTable=slmTrapLogTable, slmSyslogPort=slmSyslogPort, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevDirectory=slmSwRevDirectory, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmReadCommunity=slmReadCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmLogin=slmLogin, slmSysName=slmSysName, slmTrapEnable=slmTrapEnable, slmSwRevName=slmSwRevName, slmPortsNumber=slmPortsNumber, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slmVcatDelay=slmVcatDelay, slmSysTrapFormat=slmSysTrapFormat, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrap=slmTrap, slmAdmin=slmAdmin, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slmAdminPassword=slmAdminPassword, slmPmAvailable=slmPmAvailable, slmAuthEntry=slmAuthEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysTemperature=slmSysTemperature, slmSysLanIpAddr=slmSysLanIpAddr, slmNetworkMode=slmNetworkMode, slmChPassNewPass=slmChPassNewPass, slmChPass=slmChPass, slmLicenseId=slmLicenseId, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevTable=slmSwRevTable, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmTid=slmTid, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam2=slmTrapLogParam2, UserPassword=UserPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmSysCalendarTime=slmSysCalendarTime, slmAuthTable=slmAuthTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogName=slmTrapLogName, slmLicenseExpiration=slmLicenseExpiration, slmSysLocation=slmSysLocation, PYSNMP_MODULE_ID=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, AdminAccess=AdminAccess, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminLogin=slmAdminLogin, slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRstpEnabled=slmRstpEnabled, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDate=slmSwRevDate, slmSysMode=slmSysMode, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slmAdminAccess=slmAdminAccess, slmPsuNumber=slmPsuNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slm40GConf=slm40GConf, slmOemType=slmOemType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuth=slmAuth, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmSysResetPm=slmSysResetPm, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmSysAlmAct=slmSysAlmAct, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmSwRevStatus=slmSwRevStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry)
