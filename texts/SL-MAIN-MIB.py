...
NotificationType, Bits, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, TimeTicks, iso, ModuleIdentity, MibIdentifier, Counter32, IpAddress, ObjectIdentity, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "TimeTicks", "iso", "ModuleIdentity", "MibIdentifier", "Counter32", "IpAddress", "ObjectIdentity", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSubnetMask=slmSysSubnetMask, SoftwareRevision=SoftwareRevision, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmOemType=slmOemType, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthCommunity=slmAuthCommunity, slmLicenseIndex=slmLicenseIndex, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmBoxSize=slmBoxSize, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, slmAdminRowStatus=slmAdminRowStatus, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam3=slmTrapLogParam3, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, slmSysResetPm=slmSysResetPm, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmAuth=slmAuth, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmSyslogDestTable=slmSyslogDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmTrapPort=slmTrapPort, slmPortsNumber=slmPortsNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthTable=slmAuthTable, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmSwRevDate=slmSwRevDate, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slMain=slMain, slmAdminAccess=slmAdminAccess, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLocation=slmSysLocation, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapCommunity=slmTrapCommunity, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmSysTrapFormat=slmSysTrapFormat, slmSysChassisId=slmSysChassisId, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogin=slmLogin, slmLicenseExpiration=slmLicenseExpiration, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminPassword=slmAdminPassword, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestTable=slmTrapDestTable, slmTrap=slmTrap, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmPmAvailable=slmPmAvailable, slmSwRevName=slmSwRevName, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam6=slmTrapLogParam6, slmSys=slmSys, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseTable=slmLicenseTable, AdminAccess=AdminAccess, slmTrapLogId=slmTrapLogId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, UserPassword=UserPassword, slmReadCommunity=slmReadCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthLogin=slmAuthLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry, slmTopologyEnabled=slmTopologyEnabled, slm40GConf=slm40GConf, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmAdminEntry=slmAdminEntry, slmNetworkMode=slmNetworkMode, slmLicense=slmLicense, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmChPass=slmChPass, slmLogFile=slmLogFile)
