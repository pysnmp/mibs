...
ModuleIdentity, MibIdentifier, Gauge32, IpAddress, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, Counter64, ObjectIdentity, Bits, Unsigned32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Gauge32", "IpAddress", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "Counter64", "ObjectIdentity", "Bits", "Unsigned32", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, slmBoxSize=slmBoxSize, slmTrapEnable=slmTrapEnable, AdminAccess=AdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserCommunity=UserCommunity, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmAuthLogin=slmAuthLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmTid=slmTid, slmSyslogDestAddress=slmSyslogDestAddress, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmSysIpAddr=slmSysIpAddr, slmAuthCommunity=slmAuthCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, slmSysName=slmSysName, slmTrap=slmTrap, slmTrapLogParam2=slmTrapLogParam2, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserAccess=slmTrapUserAccess, slmReadCommunity=slmReadCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLocation=slmSysLocation, slmChPassEntry=slmChPassEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminAccess=slmAdminAccess, slmSysMode=slmSysMode, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminEntry=slmAdminEntry, slmSwRevDate=slmSwRevDate, slmTrapDestTable=slmTrapDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTemperature=slmSysTemperature, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminCommunity=slmAdminCommunity, slmNetworkMode=slmNetworkMode, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmRebootDelay=slmRebootDelay, slmLogFile=slmLogFile, slmPmAvailable=slmPmAvailable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysChassisId=slmSysChassisId, slmSysLanIpAddr=slmSysLanIpAddr, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogEntry=slmTrapLogEntry, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestAddress=slmTrapDestAddress, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmConfigFile=slmConfigFile, slmOemType=slmOemType, slmTrapLogTable=slmTrapLogTable, slmSwRevName=slmSwRevName, slmAuthPassword=slmAuthPassword, slmSnmpv3Password=slmSnmpv3Password, slmSysNetworkPrefix=slmSysNetworkPrefix, slMain=slMain, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassTable=slmChPassTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmRstpEnabled=slmRstpEnabled, slmEdfaNumber=slmEdfaNumber, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam5=slmTrapLogParam5, UserPassword=UserPassword, slmTrapLogId=slmTrapLogId)
