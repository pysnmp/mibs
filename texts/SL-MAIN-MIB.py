...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogFile=slmLogFile, slmSysResetPm=slmSysResetPm, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmSysAlmDeact=slmSysAlmDeact, PYSNMP_MODULE_ID=slMain, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrap=slmTrap, slmAdminTable=slmAdminTable, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmChPass=slmChPass, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmLicenseEntry=slmLicenseEntry, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevStatus=slmSwRevStatus, slmAdminAccess=slmAdminAccess, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPsuNumber=slmPsuNumber, slmOemType=slmOemType, slmSnmpv3Auth=slmSnmpv3Auth, slmTopologyEnabled=slmTopologyEnabled, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmTrapLogName=slmTrapLogName, slmLicenseId=slmLicenseId, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTrapFormat=slmSysTrapFormat, UserPassword=UserPassword, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Password=slmSnmpv3Password, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmLicenseTable=slmLicenseTable, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthCommunity=slmAuthCommunity, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTemperature=slmSysTemperature, slmSysIpAddr=slmSysIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmTid=slmTid, slm40GConf=slm40GConf, slmLicense=slmLicense, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRebootDelay=slmRebootDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminEntry=slmAdminEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, AdminAccess=AdminAccess, slmWriteCommunity=slmWriteCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapEnable=slmTrapEnable, slmAuthEntry=slmAuthEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysOperStatus=slmSysOperStatus, SoftwareRevision=SoftwareRevision, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPmAvailable=slmPmAvailable, slmSysMode=slmSysMode, slmLicenseExpiration=slmLicenseExpiration, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, slmTrapUserLogin=slmTrapUserLogin, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmLogin=slmLogin, slmAdmin=slmAdmin)
