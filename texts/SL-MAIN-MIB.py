...
Opaque, Bits, MibIdentifier, Counter64, Counter32, Integer32, IpAddress, TimeTicks, ObjectIdentity, iso, ModuleIdentity, NotificationType, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Bits", "MibIdentifier", "Counter64", "Counter32", "Integer32", "IpAddress", "TimeTicks", "ObjectIdentity", "iso", "ModuleIdentity", "NotificationType", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DateAndTime, TimeStamp, DisplayString, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseTable=slmLicenseTable, slmTrapUserLogin=slmTrapUserLogin, slmSysTemperature=slmSysTemperature, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmSyslogLevel=slmSyslogLevel, slmSysResetPm=slmSysResetPm, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmVcatDelay=slmVcatDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, UserCommunity=UserCommunity, slmConfigFile=slmConfigFile, slmLicenseEntry=slmLicenseEntry, slmSysLocation=slmSysLocation, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogId=slmTrapLogId, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmAuthCommunity=slmAuthCommunity, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmSysChassisId=slmSysChassisId, slmSysEncryptionCapability=slmSysEncryptionCapability, SoftwareRevision=SoftwareRevision, slmChPassEntry=slmChPassEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Password=slmSnmpv3Password, slmSwRevStatus=slmSwRevStatus, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, PYSNMP_MODULE_ID=slMain, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmAuthLogin=slmAuthLogin, slmSysSubnetMask=slmSysSubnetMask, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmRebootDelay=slmRebootDelay, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogPort=slmSyslogPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmAdminRowStatus=slmAdminRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmNetworkMode=slmNetworkMode, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevName=slmSwRevName, AdminAccess=AdminAccess, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, UserPassword=UserPassword, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmSysOperStatus=slmSysOperStatus, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmAuth=slmAuth, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmSysName=slmSysName, slmTid=slmTid, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam5=slmTrapLogParam5, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmLicense=slmLicense, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmEdfaNumber=slmEdfaNumber, slmTrapDestEntry=slmTrapDestEntry, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTable=slmTrapLogTable, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminTable=slmAdminTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable)
