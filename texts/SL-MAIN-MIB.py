...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLocation=slmSysLocation, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPortsNumber=slmPortsNumber, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmSysName=slmSysName, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmTrapEnable=slmTrapEnable, slmTrapDestAddress=slmTrapDestAddress, slmBoxSize=slmBoxSize, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmLicense=slmLicense, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminEntry=slmAdminEntry, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogId=slmTrapLogId, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmPmAvailable=slmPmAvailable, slmPsuNumber=slmPsuNumber, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestEntry=slmTrapDestEntry, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, PYSNMP_MODULE_ID=slMain, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmWriteCommunity=slmWriteCommunity, slmTrapLogTable=slmTrapLogTable, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmNetworkMode=slmNetworkMode, slmSyslogPort=slmSyslogPort, slmAdmin=slmAdmin, slmTrapPort=slmTrapPort, slMain=slMain, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysResetPm=slmSysResetPm, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmChPassLogin=slmChPassLogin, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, slmLicenseTable=slmLicenseTable, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserLogin=slmTrapUserLogin, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmAuthCommunity=slmAuthCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassTable=slmChPassTable, slmSwRevStatus=slmSwRevStatus)
