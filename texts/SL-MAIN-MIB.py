...
Opaque, ObjectIdentity, NotificationType, Unsigned32, Counter32, ModuleIdentity, TimeTicks, Bits, Gauge32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "TimeTicks", "Bits", "Gauge32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTid=slmTid, slmSysCalendarTime=slmSysCalendarTime, slmAdminPassword=slmAdminPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuth=slmAuth, slmSwRevEntry=slmSwRevEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmReadCommunity=slmReadCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysAlmAct=slmSysAlmAct, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmLicenseEntry=slmLicenseEntry, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmLicenseIndex=slmLicenseIndex, slmChPassLogin=slmChPassLogin, slmMuxNumber=slmMuxNumber, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmLicense=slmLicense, slmAuthPassword=slmAuthPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestTable=slmTrapDestTable, slmLicenseTable=slmLicenseTable, slMain=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam4=slmTrapLogParam4, slmPsuNumber=slmPsuNumber, UserCommunity=UserCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmSwRevStatus=slmSwRevStatus, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmLogin=slmLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminCommunity=slmAdminCommunity, slmSys=slmSys, slmAdminEntry=slmAdminEntry, slmTrapCommunity=slmTrapCommunity, slmNetworkMode=slmNetworkMode, slmEdfaNumber=slmEdfaNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogLevel=slmSyslogLevel, slmChPassTable=slmChPassTable, slmSyslogPort=slmSyslogPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, slmSysLocation=slmSysLocation, AdminAccess=AdminAccess, slmTrapEnable=slmTrapEnable, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmSysChassisId=slmSysChassisId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmChPass=slmChPass, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmAuthTable=slmAuthTable, slmSyslogDestTable=slmSyslogDestTable, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmRstpEnabled=slmRstpEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam5=slmTrapLogParam5, slmLogFile=slmLogFile, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr)
