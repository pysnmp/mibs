...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmSysAlmAct=slmSysAlmAct, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSnmpVersion=slmSysSnmpVersion, slmBoxSize=slmBoxSize, slmTrap=slmTrap, slmAdminTable=slmAdminTable, slmSysMode=slmSysMode, slmSysIpAddr=slmSysIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmPmAvailable=slmPmAvailable, slmAdminAccess=slmAdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmNetworkMode=slmNetworkMode, slmOemType=slmOemType, slmTid=slmTid, slmLicenseIndex=slmLicenseIndex, slmSysResetPm=slmSysResetPm, slMain=slMain, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmTrapLogParam4=slmTrapLogParam4, slmSys=slmSys, UserPassword=UserPassword, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam5=slmTrapLogParam5, slmTrapPort=slmTrapPort, slmSysAdminStatus=slmSysAdminStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdmin=slmAdmin, slmSwRevTable=slmSwRevTable, slmLogFile=slmLogFile, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogId=slmTrapLogId, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmConfigFile=slmConfigFile, slmChPassEntry=slmChPassEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapEnable=slmTrapEnable, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, UserLogin=UserLogin, slmAdminLogin=slmAdminLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmAdminPassword=slmAdminPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSysOperStatus=slmSysOperStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserAccess=slmTrapUserAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmLicense=slmLicense, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmAdminCommunity=slmAdminCommunity, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmTrapCommunity=slmTrapCommunity, slmReadCommunity=slmReadCommunity, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmPsuNumber=slmPsuNumber, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDate=slmSwRevDate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassLogin=slmChPassLogin, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable)
