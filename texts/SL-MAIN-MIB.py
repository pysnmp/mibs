...
Counter32, Gauge32, ModuleIdentity, NotificationType, Counter64, Integer32, Bits, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity, Opaque, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity", "Opaque", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysResetPm=slmSysResetPm, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmBoxSize=slmBoxSize, slmAuthCommunity=slmAuthCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAdmin=slmAdmin, slmTid=slmTid, slmRstpEnabled=slmRstpEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmSnmpv3Auth=slmSnmpv3Auth, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, slmSwRevDate=slmSwRevDate, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmChPassTable=slmChPassTable, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthEntry=slmAuthEntry, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, UserLogin=UserLogin, slmAdminAccess=slmAdminAccess, slmSysAlmAct=slmSysAlmAct, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmAuthPassword=slmAuthPassword, slmAdminTable=slmAdminTable, slmSysLocation=slmSysLocation, slmSys=slmSys, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmChPassOldPass=slmChPassOldPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseId=slmLicenseId, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseEntry=slmLicenseEntry, slmTrapEnable=slmTrapEnable, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmVcatDelay=slmVcatDelay, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmSwRevStatus=slmSwRevStatus, slmAdminCommunity=slmAdminCommunity, slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigFile=slmConfigFile, slmLogFile=slmLogFile, slmSysName=slmSysName, slmSysMode=slmSysMode, slmTrapLogParam4=slmTrapLogParam4, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam5=slmTrapLogParam5, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, slmEdfaNumber=slmEdfaNumber, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmWriteCommunity=slmWriteCommunity, UserCommunity=UserCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmTrapLogParam1=slmTrapLogParam1, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogEntry=slmTrapLogEntry, slmSyslogLevel=slmSyslogLevel, slmTrapCommunity=slmTrapCommunity, slmOemType=slmOemType, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminLogin=slmAdminLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogName=slmTrapLogName, slmPsuNumber=slmPsuNumber, slmSwRevTable=slmSwRevTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmSwRevName=slmSwRevName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus)
