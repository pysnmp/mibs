...
Gauge32, Opaque, MibIdentifier, Unsigned32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, NotificationType, ModuleIdentity, Integer32, iso, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "MibIdentifier", "Unsigned32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "NotificationType", "ModuleIdentity", "Integer32", "iso", "Bits", "Counter32")
TimeStamp, TruthValue, DateAndTime, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DateAndTime", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmAdminPassword=slmAdminPassword, slmSwRevDirectory=slmSwRevDirectory, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Auth=slmSnmpv3Auth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapPort=slmTrapPort, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmSys=slmSys, slmAdminLogin=slmAdminLogin, slmWriteCommunity=slmWriteCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmAdmin=slmAdmin, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthEntry=slmAuthEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuth=slmAuth, slmTrapLogEntry=slmTrapLogEntry, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmSysOperStatus=slmSysOperStatus, slmLogin=slmLogin, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, UserCommunity=UserCommunity, slmTid=slmTid, slmSysChassisId=slmSysChassisId, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmNetworkMode=slmNetworkMode, SoftwareRevision=SoftwareRevision, slmAuthTable=slmAuthTable, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmSysTemperature=slmSysTemperature, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrap=slmTrap, slmOemType=slmOemType, slmTrapUserAccess=slmTrapUserAccess, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmTrapLogName=slmTrapLogName, slmTrapEnable=slmTrapEnable, slmTrapLogParam1=slmTrapLogParam1, slmVcatDelay=slmVcatDelay, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam6=slmTrapLogParam6, slmSysMode=slmSysMode, slmPortsNumber=slmPortsNumber, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmEdfaNumber=slmEdfaNumber, slmChPassNewPass=slmChPassNewPass, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevEntry=slmSwRevEntry, slmRebootDelay=slmRebootDelay, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysUplinkRate=slmSysUplinkRate, AdminAccess=AdminAccess, slmSysSubnetMask=slmSysSubnetMask, slmBoxSize=slmBoxSize, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slmTrapUserLogin=slmTrapUserLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmSysIpAddr=slmSysIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Password=slmSnmpv3Password, slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmSyslogPort=slmSyslogPort, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmTrapSysNameChange=slmTrapSysNameChange)
