...
Bits, ModuleIdentity, Gauge32, MibIdentifier, Unsigned32, Integer32, TimeTicks, IpAddress, ObjectIdentity, iso, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Gauge32", "MibIdentifier", "Unsigned32", "Integer32", "TimeTicks", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter32")
TruthValue, DisplayString, RowStatus, TextualConvention, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "TextualConvention", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", AdminAccess=AdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrap=slmTrap, slmSysChassisId=slmSysChassisId, slmChPassNewPass=slmChPassNewPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmVcatDelay=slmVcatDelay, slmLicenseEntry=slmLicenseEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTid=slmTid, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmAuthCommunity=slmAuthCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, slmNetworkMode=slmNetworkMode, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTemperature=slmSysTemperature, slmLicenseIndex=slmLicenseIndex, slmConfigSysUptime=slmConfigSysUptime, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmChPassLogin=slmChPassLogin, UserLogin=UserLogin, slmAdmin=slmAdmin, slmTrapUserLogin=slmTrapUserLogin, PYSNMP_MODULE_ID=slMain, slmChPassEntry=slmChPassEntry, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmSysAlmAct=slmSysAlmAct, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysIpAddr=slmSysIpAddr, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmSysMode=slmSysMode, slmLicenseTable=slmLicenseTable, slmLogin=slmLogin, slmAdminAccess=slmAdminAccess, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmOemType=slmOemType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRstpEnabled=slmRstpEnabled, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmReadCommunity=slmReadCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogName=slmTrapLogName, slmTrapLogTable=slmTrapLogTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseId=slmLicenseId, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmSysLocation=slmSysLocation, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmSysGatewayAddr=slmSysGatewayAddr, slMain=slMain, slmPortsNumber=slmPortsNumber, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmTrapDestAddress=slmTrapDestAddress, slmSwRevStatus=slmSwRevStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthTable=slmAuthTable, slmAdminRowStatus=slmAdminRowStatus, slmAuthPassword=slmAuthPassword, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassTable=slmChPassTable, slmTrapLogParam5=slmTrapLogParam5, slmRebootDelay=slmRebootDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapPort=slmTrapPort, slmAdminTable=slmAdminTable)
