...
TimeTicks, IpAddress, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Counter32, Bits, Integer32, Counter64, Gauge32, Unsigned32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Counter32", "Bits", "Integer32", "Counter64", "Gauge32", "Unsigned32", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTemperature=slmSysTemperature, slmTrapDestTable=slmTrapDestTable, slmAuthPassword=slmAuthPassword, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysMode=slmSysMode, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmLicenseEntry=slmLicenseEntry, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmMuxNumber=slmMuxNumber, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, slmSysTrapFormat=slmSysTrapFormat, slmAdminRowStatus=slmAdminRowStatus, slmAdminTable=slmAdminTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmRebootDelay=slmRebootDelay, slmAdminEntry=slmAdminEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthLogin=slmAuthLogin, slmSysIpAddr=slmSysIpAddr, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, UserCommunity=UserCommunity, slmTid=slmTid, slmRstpEnabled=slmRstpEnabled, slmPsuNumber=slmPsuNumber, slmConfigSysUptime=slmConfigSysUptime, slmSwRevTable=slmSwRevTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrap=slmTrap, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogEntry=slmTrapLogEntry, AdminAccess=AdminAccess, slmSysOperStatus=slmSysOperStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slMain=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmTrapLogName=slmTrapLogName, slmSysUplinkRate=slmSysUplinkRate, slmSwRevEntry=slmSwRevEntry, slmChPassTable=slmChPassTable, slmTrapLogTable=slmTrapLogTable, slmTrapCommunity=slmTrapCommunity, slmChPassOldPass=slmChPassOldPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPass=slmChPass, slmLicenseTable=slmLicenseTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmSyslogDestTable=slmSyslogDestTable, slmSys=slmSys, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminPassword=slmAdminPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam5=slmTrapLogParam5, slmChPassLogin=slmChPassLogin, slmChPassEntry=slmChPassEntry, slmAuth=slmAuth, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmAuthEntry=slmAuthEntry, slmSysChassisId=slmSysChassisId, slmSnmpv3Password=slmSnmpv3Password, slmLicense=slmLicense, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmSyslogLevel=slmSyslogLevel, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysName=slmSysName, slmSwRevName=slmSwRevName, UserPassword=UserPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLogFile=slmLogFile, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseExpiration=slmLicenseExpiration, slm40GConf=slm40GConf, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity)
