...
Bits, Opaque, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, IpAddress, Unsigned32, iso, NotificationType, ObjectIdentity, Gauge32, Counter64, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Opaque", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "IpAddress", "Unsigned32", "iso", "NotificationType", "ObjectIdentity", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPass=slmChPass, slmNetworkMode=slmNetworkMode, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmSysAlmDeact=slmSysAlmDeact, slmSyslogPort=slmSyslogPort, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, UserLogin=UserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestTable=slmSyslogDestTable, slmSysTrapFormat=slmSysTrapFormat, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmLicenseId=slmLicenseId, slmSnmpv3Priv=slmSnmpv3Priv, slmMuxNumber=slmMuxNumber, slmAuth=slmAuth, slmAdminTable=slmAdminTable, slmSysResetPm=slmSysResetPm, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSys=slmSys, slmSysUplinkRate=slmSysUplinkRate, slmConfigSysSignalType=slmConfigSysSignalType, slm40GConf=slm40GConf, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmVcatDelay=slmVcatDelay, slmAdmin=slmAdmin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysIpAddr=slmSysIpAddr, slmTrap=slmTrap, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmPsuNumber=slmPsuNumber, slmAuthEntry=slmAuthEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthCommunity=slmAuthCommunity, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmSwRevTable=slmSwRevTable, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmWriteCommunity=slmWriteCommunity, slmTrapDestAddress=slmTrapDestAddress, slmOemType=slmOemType, slmRebootDelay=slmRebootDelay, slmSwRevEntry=slmSwRevEntry, slmAdminPassword=slmAdminPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthTable=slmAuthTable, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmLogin=slmLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, slmSysMode=slmSysMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmLogFile=slmLogFile, slmTrapEnable=slmTrapEnable, slmLicense=slmLicense, slmTid=slmTid, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevStatus=slmSwRevStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogId=slmTrapLogId, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, UserCommunity=UserCommunity, slmTrapUserLogin=slmTrapUserLogin, SoftwareRevision=SoftwareRevision, slmAuthPassword=slmAuthPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseTable=slmLicenseTable, slmChPassOldPass=slmChPassOldPass, slmTrapPort=slmTrapPort, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPortsNumber=slmPortsNumber, slmSysGatewayAddr=slmSysGatewayAddr, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmReadCommunity=slmReadCommunity, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation)
