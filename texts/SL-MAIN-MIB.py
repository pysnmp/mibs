...
Bits, NotificationType, Counter64, Unsigned32, Integer32, iso, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, ModuleIdentity, ObjectIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "Unsigned32", "Integer32", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "ModuleIdentity", "ObjectIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmLicenseId=slmLicenseId, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTid=slmTid, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapCommunity=slmTrapCommunity, slmAdminRowStatus=slmAdminRowStatus, slmConfigFile=slmConfigFile, slmTrapLogParam5=slmTrapLogParam5, slmSysSubnetMask=slmSysSubnetMask, slmTrapPort=slmTrapPort, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmEdfaNumber=slmEdfaNumber, slmPsuNumber=slmPsuNumber, slmSys=slmSys, slmChPassOldPass=slmChPassOldPass, slmTrapUserAccess=slmTrapUserAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, UserCommunity=UserCommunity, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmLicenseTable=slmLicenseTable, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slmSyslogDestTable=slmSyslogDestTable, slmSysCalendarTime=slmSysCalendarTime, slmSysGatewayAddr=slmSysGatewayAddr, slmAuth=slmAuth, slmChPass=slmChPass, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestCommunity=slmTrapDestCommunity, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminEntry=slmAdminEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysTrapFormat=slmSysTrapFormat, slmAuthLogin=slmAuthLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmNetworkMode=slmNetworkMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthTable=slmAuthTable, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminTable=slmAdminTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestProtVersion=slmTrapDestProtVersion, slmBoxSize=slmBoxSize, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmLicense=slmLicense, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrap=slmTrap, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmAuthEntry=slmAuthEntry, slmSyslogLevel=slmSyslogLevel, slmVcatDelay=slmVcatDelay, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmSwRevStatus=slmSwRevStatus, UserLogin=UserLogin, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmSysEncryptionCapability=slmSysEncryptionCapability, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogin=slmLogin, slmAuthCommunity=slmAuthCommunity, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapLogId=slmTrapLogId, slmTrapLogEntry=slmTrapLogEntry, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmRstpEnabled=slmRstpEnabled, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPortsNumber=slmPortsNumber, AdminAccess=AdminAccess, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, slmChPassNewPass=slmChPassNewPass, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmSysOperStatus=slmSysOperStatus, slmAdminCommunity=slmAdminCommunity, slmLicenseIndex=slmLicenseIndex, slmChPassTable=slmChPassTable, slmSwRevDate=slmSwRevDate, slmSysName=slmSysName, slmRebootDelay=slmRebootDelay)
