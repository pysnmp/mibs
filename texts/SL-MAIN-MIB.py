...
Bits, Unsigned32, Gauge32, Counter32, Counter64, MibIdentifier, Integer32, ObjectIdentity, NotificationType, iso, IpAddress, TimeTicks, ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Gauge32", "Counter32", "Counter64", "MibIdentifier", "Integer32", "ObjectIdentity", "NotificationType", "iso", "IpAddress", "TimeTicks", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, DisplayString, RowStatus, TimeStamp, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "TimeStamp", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogPort=slmSyslogPort, slmLicenseExpiration=slmLicenseExpiration, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, AdminAccess=AdminAccess, slmPsuNumber=slmPsuNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassTable=slmChPassTable, slmTrapLogParam6=slmTrapLogParam6, slmLogin=slmLogin, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSys=slmSys, slmOemType=slmOemType, slmTrap=slmTrap, UserPassword=UserPassword, slMain=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSysChassisId=slmSysChassisId, slmAuthLogin=slmAuthLogin, slmReadCommunity=slmReadCommunity, slmTrapLogParam5=slmTrapLogParam5, slmChPass=slmChPass, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmSysIpAddr=slmSysIpAddr, slmAuthTable=slmAuthTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserAccess=slmTrapUserAccess, slmAuth=slmAuth, slmAdminEntry=slmAdminEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmSysLocation=slmSysLocation, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmLicenseIndex=slmLicenseIndex, slmAdminPassword=slmAdminPassword, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogTable=slmTrapLogTable, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassOldPass=slmChPassOldPass, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, slmTrapLogId=slmTrapLogId, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmAdminTable=slmAdminTable, slmAuthPassword=slmAuthPassword, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPortsNumber=slmPortsNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmLogFile=slmLogFile, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmSyslogDestTable=slmSyslogDestTable)
