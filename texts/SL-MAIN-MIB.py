...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Integer32, Opaque, Counter64, Gauge32, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, NotificationType, Bits, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Integer32", "Opaque", "Counter64", "Gauge32", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType", "Bits", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogId=slmTrapLogId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmTrapLogParam2=slmTrapLogParam2, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, slmLicenseId=slmLicenseId, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmRebootDelay=slmRebootDelay, slmLogin=slmLogin, UserCommunity=UserCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmVcatDelay=slmVcatDelay, slmSysLocation=slmSysLocation, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, AdminAccess=AdminAccess, slmAuthEntry=slmAuthEntry, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTemperature=slmSysTemperature, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogPort=slmSyslogPort, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseExpiration=slmLicenseExpiration, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmSysAlmDeact=slmSysAlmDeact, slmSwRevStatus=slmSwRevStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmMuxNumber=slmMuxNumber, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slmOemType=slmOemType, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmAuthLogin=slmAuthLogin, slmTrap=slmTrap, slmAdmin=slmAdmin, slmAuthTable=slmAuthTable, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, slmAdminTable=slmAdminTable, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapEnable=slmTrapEnable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmLicenseEntry=slmLicenseEntry, slmSysOperStatus=slmSysOperStatus, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, slmSwRevDirectory=slmSwRevDirectory, slmTid=slmTid, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysMode=slmSysMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmSwRevTable=slmSwRevTable, slmSysCalendarTime=slmSysCalendarTime, slmReadCommunity=slmReadCommunity, slmWriteCommunity=slmWriteCommunity, slmLicense=slmLicense)
