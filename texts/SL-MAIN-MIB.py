...
TimeTicks, Opaque, Gauge32, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Opaque", "Gauge32", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Integer32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmSysTrapFormat=slmSysTrapFormat, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmTid=slmTid, slmAdminPassword=slmAdminPassword, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysMode=slmSysMode, slmTrapLogParam3=slmTrapLogParam3, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmVcatDelay=slmVcatDelay, slmChPassEntry=slmChPassEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, AdminAccess=AdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogId=slmTrapLogId, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmWriteCommunity=slmWriteCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminCommunity=slmAdminCommunity, slmLogin=slmLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmSwRevTable=slmSwRevTable, slmSysResetPm=slmSysResetPm, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmAdminTable=slmAdminTable, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmAdminLogin=slmAdminLogin, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogLevel=slmSyslogLevel, slmEdfaNumber=slmEdfaNumber, SoftwareRevision=SoftwareRevision, slmSysLocation=slmSysLocation, slmConfigFile=slmConfigFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuth=slmAuth, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevName=slmSwRevName, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slm40GConf=slm40GConf, slmOemType=slmOemType, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmNetworkMode=slmNetworkMode, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestTable=slmTrapDestTable, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Password=slmSnmpv3Password, slmTrapPort=slmTrapPort, slmTrapLogParam1=slmTrapLogParam1, slmSysTemperature=slmSysTemperature, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmAuthLogin=slmAuthLogin, slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthPassword=slmAuthPassword, slMain=slMain, slmRebootDelay=slmRebootDelay, slmSysLanIpAddr=slmSysLanIpAddr, UserCommunity=UserCommunity, slmTrapLogParam2=slmTrapLogParam2, slmMuxNumber=slmMuxNumber, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevEntry=slmSwRevEntry)
