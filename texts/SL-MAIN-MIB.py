...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, MibIdentifier, Unsigned32, Opaque, TimeTicks, ObjectIdentity, Gauge32, NotificationType, Counter32, IpAddress, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "MibIdentifier", "Unsigned32", "Opaque", "TimeTicks", "ObjectIdentity", "Gauge32", "NotificationType", "Counter32", "IpAddress", "iso", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdmin=slmAdmin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDate=slmSwRevDate, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, UserCommunity=UserCommunity, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, slmLicenseEntry=slmLicenseEntry, slmLicenseId=slmLicenseId, AdminAccess=AdminAccess, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSyslogLevel=slmSyslogLevel, UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysEncryptionCapability=slmSysEncryptionCapability, PYSNMP_MODULE_ID=slMain, slmAuth=slmAuth, slmSwRevTable=slmSwRevTable, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry, slmSnmpv3Password=slmSnmpv3Password, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmAuthPassword=slmAuthPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmTrapLogId=slmTrapLogId, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmAdminCommunity=slmAdminCommunity, slmSysTrapFormat=slmSysTrapFormat, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmAdminTable=slmAdminTable, slmSysResetPm=slmSysResetPm, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPsuNumber=slmPsuNumber, slmPmAvailable=slmPmAvailable, slmAuthTable=slmAuthTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmTid=slmTid, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmSys=slmSys, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmEdfaNumber=slmEdfaNumber, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthCommunity=slmAuthCommunity, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmSwRevDirectory=slmSwRevDirectory, slmSyslogPort=slmSyslogPort, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmSysAlmAct=slmSysAlmAct, slmSwRevStatus=slmSwRevStatus, slmTrapEnable=slmTrapEnable, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam2=slmTrapLogParam2, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, slmSysTemperature=slmSysTemperature, slmTrapDestTable=slmTrapDestTable, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam5=slmTrapLogParam5, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassTable=slmChPassTable, slmLogin=slmLogin)
