...
NotificationType, Counter64, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter32, iso, Opaque, MibIdentifier, IpAddress, Gauge32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter32", "iso", "Opaque", "MibIdentifier", "IpAddress", "Gauge32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminRowStatus=slmAdminRowStatus, slmSyslogPort=slmSyslogPort, slmTrapDestTable=slmTrapDestTable, slmTrapCommunity=slmTrapCommunity, UserLogin=UserLogin, slmTrap=slmTrap, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSys=slmSys, slmTrapDestCommunity=slmTrapDestCommunity, slmSysCalendarTime=slmSysCalendarTime, slmTrapEnable=slmTrapEnable, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, slmSysAlmDeact=slmSysAlmDeact, slmSwRevDirectory=slmSwRevDirectory, UserPassword=UserPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminLogin=slmAdminLogin, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmSysTrapFormat=slmSysTrapFormat, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmOemType=slmOemType, AdminAccess=AdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogId=slmTrapLogId, slmChPassLogin=slmChPassLogin, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmLogin=slmLogin, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam6=slmTrapLogParam6, slmSysPmStartOfDay=slmSysPmStartOfDay, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigFile=slmConfigFile, slmSysAdminStatus=slmSysAdminStatus, slmLicense=slmLicense, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmWriteCommunity=slmWriteCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysName=slmSysName, slmSwRevTable=slmSwRevTable, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmTid=slmTid, slmAuthCommunity=slmAuthCommunity, slmTrapLogName=slmTrapLogName, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminTable=slmAdminTable, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmPmAvailable=slmPmAvailable, slmSwRevEntry=slmSwRevEntry, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevName=slmSwRevName, slmSyslogLevel=slmSyslogLevel, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, slmAuthTable=slmAuthTable, slmMuxNumber=slmMuxNumber, slmSnmpv3Priv=slmSnmpv3Priv, SoftwareRevision=SoftwareRevision, slmAdminAccess=slmAdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmSyslogDestTable=slmSyslogDestTable)
