...
ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, IpAddress, Integer32, Opaque, Counter32, TimeTicks, MibIdentifier, Bits, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "IpAddress", "Integer32", "Opaque", "Counter32", "TimeTicks", "MibIdentifier", "Bits", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmPmAvailable=slmPmAvailable, slmSysLocation=slmSysLocation, slmSysChassisId=slmSysChassisId, slmEdfaNumber=slmEdfaNumber, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmBoxSize=slmBoxSize, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmConfigSysUptime=slmConfigSysUptime, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmOemType=slmOemType, slmLogFile=slmLogFile, slmTrapLogParam6=slmTrapLogParam6, slmSysMode=slmSysMode, slmSysCalendarTime=slmSysCalendarTime, slmLicenseEntry=slmLicenseEntry, slmLicenseId=slmLicenseId, slmWriteCommunity=slmWriteCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthTable=slmAuthTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogin=slmLogin, slmSwRevEntry=slmSwRevEntry, slmSysName=slmSysName, slmSysUplinkRate=slmSysUplinkRate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmSyslogDestTable=slmSyslogDestTable, slmSwRevTable=slmSwRevTable, slmMuxNumber=slmMuxNumber, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthPassword=slmAuthPassword, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogTable=slmTrapLogTable, slmTrapLogName=slmTrapLogName, slmSwRevName=slmSwRevName, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapEnable=slmTrapEnable, slmTrap=slmTrap, slmChPass=slmChPass, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmAct=slmSysAlmAct, slmLicenseTable=slmLicenseTable, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminLogin=slmAdminLogin, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysResetPm=slmSysResetPm, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmTrapPort=slmTrapPort, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmSysTemperature=slmSysTemperature, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassOldPass=slmChPassOldPass, slmAuth=slmAuth, slmRstpEnabled=slmRstpEnabled, slmTrapDestAddress=slmTrapDestAddress, slmAuthEntry=slmAuthEntry, slmAuthLogin=slmAuthLogin, slmSys=slmSys, slmTid=slmTid, slmTopologyEnabled=slmTopologyEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassLogin=slmChPassLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTrapFormat=slmSysTrapFormat)
