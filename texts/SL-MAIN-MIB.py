...
Integer32, MibIdentifier, ModuleIdentity, NotificationType, Bits, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Opaque, TimeTicks, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "ModuleIdentity", "NotificationType", "Bits", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Opaque", "TimeTicks", "Unsigned32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, PYSNMP_MODULE_ID=slMain, slmAdminEntry=slmAdminEntry, slmTrapLogId=slmTrapLogId, slmSysSubnetMask=slmSysSubnetMask, slmLogin=slmLogin, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmChPass=slmChPass, UserLogin=UserLogin, slmOemType=slmOemType, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam4=slmTrapLogParam4, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmConfigFile=slmConfigFile, slmSysUplinkRate=slmSysUplinkRate, slmAdminPassword=slmAdminPassword, slmAuthTable=slmAuthTable, slmLogFile=slmLogFile, slMain=slMain, slmAdmin=slmAdmin, slmSwRevTable=slmSwRevTable, slmSwRevStatus=slmSwRevStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, slmChPassEntry=slmChPassEntry, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmLicenseIndex=slmLicenseIndex, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmWriteCommunity=slmWriteCommunity, slmSysAlmDeact=slmSysAlmDeact, slmTid=slmTid, slmSysName=slmSysName, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmLicenseExpiration=slmLicenseExpiration, slmAuthEntry=slmAuthEntry, slmSysMode=slmSysMode, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevEntry=slmSwRevEntry, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogName=slmTrapLogName, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmBoxSize=slmBoxSize, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestEntry=slmSyslogDestEntry, slmPsuNumber=slmPsuNumber, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmAdminTable=slmAdminTable, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmTrapDestTable=slmTrapDestTable, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmRebootDelay=slmRebootDelay, slmSnmpv3Password=slmSnmpv3Password, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, UserCommunity=UserCommunity, slmSysLocation=slmSysLocation, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmPmAvailable=slmPmAvailable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseId=slmLicenseId, slmChPassOldPass=slmChPassOldPass, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminAccess=slmAdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogLevel=slmSyslogLevel, slmSyslogDestTable=slmSyslogDestTable, slmSysCalendarTime=slmSysCalendarTime, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysNetworkPrefix=slmSysNetworkPrefix, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr)
