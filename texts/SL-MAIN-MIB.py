...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigFile=slmConfigFile, slmTrapSysNameChange=slmTrapSysNameChange, slmLogin=slmLogin, slmTrapDestTable=slmTrapDestTable, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmAuthCommunity=slmAuthCommunity, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserCommunity=UserCommunity, slmLicenseIndex=slmLicenseIndex, slmTrapDestEntry=slmTrapDestEntry, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmAdminPassword=slmAdminPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevName=slmSwRevName, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmTrapEnable=slmTrapEnable, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmTrapLogParam2=slmTrapLogParam2, SoftwareRevision=SoftwareRevision, slmMuxNumber=slmMuxNumber, slmTrapLogParam5=slmTrapLogParam5, slmLicenseExpiration=slmLicenseExpiration, slmAuthLogin=slmAuthLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmAdminAccess=slmAdminAccess, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassOldPass=slmChPassOldPass, slmAdminTable=slmAdminTable, slm40GConf=slm40GConf, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmChPass=slmChPass, AdminAccess=AdminAccess, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDirectory=slmSwRevDirectory, slmPsuNumber=slmPsuNumber, PYSNMP_MODULE_ID=slMain, slmAdminCommunity=slmAdminCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Password=slmSnmpv3Password, slMain=slMain, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, slmSnmpv3Auth=slmSnmpv3Auth, slmReadCommunity=slmReadCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmRebootDelay=slmRebootDelay, slmRstpEnabled=slmRstpEnabled, slmLicenseTable=slmLicenseTable, slmWriteCommunity=slmWriteCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestTable=slmSyslogDestTable, slmAuthPassword=slmAuthPassword, slmConfigSysUptime=slmConfigSysUptime, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmSwRevDate=slmSwRevDate, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, slmTrapUserLogin=slmTrapUserLogin, slmSysName=slmSysName, slmTrapLogName=slmTrapLogName, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseEntry=slmLicenseEntry, slmSyslogPort=slmSyslogPort, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmAuthEntry=slmAuthEntry, slmAdminLogin=slmAdminLogin, slmAuthTable=slmAuthTable, slmSysCalendarTime=slmSysCalendarTime, slmSys=slmSys, slmSysTrapFormat=slmSysTrapFormat, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6)
