...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicense=slmLicense, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmReadCommunity=slmReadCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmRebootDelay=slmRebootDelay, slmSwRevDate=slmSwRevDate, slmSysTemperature=slmSysTemperature, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmBoxSize=slmBoxSize, slmSysAdminStatus=slmSysAdminStatus, slmAdminEntry=slmAdminEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapCommunity=slmTrapCommunity, slmAdminPassword=slmAdminPassword, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysCalendarTime=slmSysCalendarTime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysName=slmSysName, slmMuxNumber=slmMuxNumber, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysChassisId=slmSysChassisId, slmSwRevTable=slmSwRevTable, slmAuth=slmAuth, slmTrapPort=slmTrapPort, slmSysLocation=slmSysLocation, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmPsuNumber=slmPsuNumber, slmTrapDestTable=slmTrapDestTable, slmTrap=slmTrap, AdminAccess=AdminAccess, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmTrapEnable=slmTrapEnable, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevName=slmSwRevName, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmTrapLogParam5=slmTrapLogParam5, UserCommunity=UserCommunity, slmAuthTable=slmAuthTable, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmWriteCommunity=slmWriteCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmTrapLogEntry=slmTrapLogEntry, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmLogin=slmLogin, slmTid=slmTid, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogTable=slmTrapLogTable, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam4=slmTrapLogParam4, slmAuthEntry=slmAuthEntry, slmSyslogPort=slmSyslogPort, slmAdmin=slmAdmin, slmAdminCommunity=slmAdminCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword, slmSys=slmSys, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminLogin=slmAdminLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPortsNumber=slmPortsNumber)
