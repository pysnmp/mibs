...
TextualConvention, TruthValue, TimeStamp, DisplayString, RowStatus, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "RowStatus", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slMain=slMain, UserPassword=UserPassword, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmDeact=slmSysAlmDeact, slmTid=slmTid, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmSysLocation=slmSysLocation, slmAdmin=slmAdmin, slmChPassLogin=slmChPassLogin, slmSysOperStatus=slmSysOperStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminEntry=slmAdminEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmChPass=slmChPass, AdminAccess=AdminAccess, slmVcatDelay=slmVcatDelay, slmSysName=slmSysName, slmConfigSysUptime=slmConfigSysUptime, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminPassword=slmAdminPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam2=slmTrapLogParam2, slmSysIpAddr=slmSysIpAddr, slmTrapUserAccess=slmTrapUserAccess, PYSNMP_MODULE_ID=slMain, slmPortsNumber=slmPortsNumber, slmOemType=slmOemType, slmNetworkMode=slmNetworkMode, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmSwRevName=slmSwRevName, slmLicense=slmLicense, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmTrapPort=slmTrapPort, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmSysSubnetMask=slmSysSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDate=slmSwRevDate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmAuthPassword=slmAuthPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmBoxSize=slmBoxSize, slmTopologyEnabled=slmTopologyEnabled, slmAuthCommunity=slmAuthCommunity, slmLogin=slmLogin, slmSysLanIpAddr=slmSysLanIpAddr, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmAdminCommunity=slmAdminCommunity, slmConfigFile=slmConfigFile, slmReadCommunity=slmReadCommunity, slmLicenseId=slmLicenseId, slmTrapEnable=slmTrapEnable, slmAuth=slmAuth, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass)
