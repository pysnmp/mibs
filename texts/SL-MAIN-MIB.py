...
iso, Unsigned32, Opaque, TimeTicks, Counter64, ObjectIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Gauge32, Integer32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Opaque", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Gauge32", "Integer32", "Bits", "MibIdentifier")
DisplayString, DateAndTime, TruthValue, RowStatus, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TruthValue", "RowStatus", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmSysName=slmSysName, slmLicenseIndex=slmLicenseIndex, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysAdminStatus=slmSysAdminStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthTable=slmAuthTable, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmReadCommunity=slmReadCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestTable=slmTrapDestTable, slmSyslogPort=slmSyslogPort, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapPort=slmTrapPort, UserPassword=UserPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmAdminCommunity=slmAdminCommunity, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmAdminEntry=slmAdminEntry, slmMuxNumber=slmMuxNumber, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmTrapDestEntry=slmTrapDestEntry, slmAdminPassword=slmAdminPassword, slmSys=slmSys, slmTrap=slmTrap, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slMain=slMain, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLocation=slmSysLocation, slmLicenseTable=slmLicenseTable, slmEdfaNumber=slmEdfaNumber, slmSwRevDirectory=slmSwRevDirectory, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmSysAlmAct=slmSysAlmAct, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmChPass=slmChPass, slmAuthLogin=slmAuthLogin, slmSyslogDestTable=slmSyslogDestTable, slmPsuNumber=slmPsuNumber, slmOemType=slmOemType, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthPassword=slmAuthPassword, slmTrapLogId=slmTrapLogId, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmSwRevName=slmSwRevName, slmTrapLogName=slmTrapLogName, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysResetPm=slmSysResetPm, slmPmAvailable=slmPmAvailable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysChassisId=slmSysChassisId, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmVcatDelay=slmVcatDelay, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmConfigFile=slmConfigFile, slmTrapSysNameChange=slmTrapSysNameChange, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdmin=slmAdmin, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminRowStatus=slmAdminRowStatus, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmSwRevDate=slmSwRevDate)
