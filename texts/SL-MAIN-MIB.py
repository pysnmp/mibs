...
MibIdentifier, IpAddress, Counter32, Unsigned32, Opaque, ModuleIdentity, iso, TimeTicks, Counter64, NotificationType, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Counter32", "Unsigned32", "Opaque", "ModuleIdentity", "iso", "TimeTicks", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmRstpEnabled=slmRstpEnabled, slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmLicenseTable=slmLicenseTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmChPass=slmChPass, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminLogin=slmAdminLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLocation=slmSysLocation, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSysName=slmSysName, slmSwRevDate=slmSwRevDate, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmConfigFile=slmConfigFile, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmOemType=slmOemType, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestTable=slmSyslogDestTable, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmAuthCommunity=slmAuthCommunity, slmAdminRowStatus=slmAdminRowStatus, slmAdmin=slmAdmin, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminCommunity=slmAdminCommunity, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTemperature=slmSysTemperature, slmChPassEntry=slmChPassEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysCalendarTime=slmSysCalendarTime, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmSyslogLevel=slmSyslogLevel, slmEdfaNumber=slmEdfaNumber, slmSwRevName=slmSwRevName, slmAuthPassword=slmAuthPassword, slmSwRevDirectory=slmSwRevDirectory, slmTrap=slmTrap, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmAuthTable=slmAuthTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmLogin=slmLogin, slmLogFile=slmLogFile, slmTrapLogParam3=slmTrapLogParam3, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmTrapUserLogin=slmTrapUserLogin, UserCommunity=UserCommunity, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmSysSubnetMask=slmSysSubnetMask, slMain=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysOperStatus=slmSysOperStatus, slmSysMode=slmSysMode, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmVcatDelay=slmVcatDelay, slmTrapLogEntry=slmTrapLogEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slmTrapLogParam5=slmTrapLogParam5, AdminAccess=AdminAccess, slmChPassTable=slmChPassTable, slmTid=slmTid, slmConfigSysSignalType=slmConfigSysSignalType)
