...
Opaque, IpAddress, ModuleIdentity, Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, Unsigned32, Gauge32, Bits, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "IpAddress", "ModuleIdentity", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Gauge32", "Bits", "Integer32", "ObjectIdentity")
DisplayString, TimeStamp, TruthValue, DateAndTime, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "DateAndTime", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapCommunity=slmTrapCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDirectory=slmSwRevDirectory, slmPortsNumber=slmPortsNumber, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slMain=slMain, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthCommunity=slmAuthCommunity, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmAdmin=slmAdmin, slmChPassTable=slmChPassTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmAuthEntry=slmAuthEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmRebootDelay=slmRebootDelay, slmLicenseIndex=slmLicenseIndex, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmAdminAccess=slmAdminAccess, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmSysAlmAct=slmSysAlmAct, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogLevel=slmSyslogLevel, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassOldPass=slmChPassOldPass, UserCommunity=UserCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysSubnetMask=slmSysSubnetMask, slmRstpEnabled=slmRstpEnabled, slmAuthPassword=slmAuthPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmMuxNumber=slmMuxNumber, slmTrapDestAddress=slmTrapDestAddress, slmConfigFile=slmConfigFile, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmLicense=slmLicense, UserPassword=UserPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevEntry=slmSwRevEntry, slmOemType=slmOemType, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSysTemperature=slmSysTemperature, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmSysLocation=slmSysLocation, slmSysName=slmSysName, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserAccess=slmTrapUserAccess, slmPmAvailable=slmPmAvailable, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam4=slmTrapLogParam4, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmSysResetPm=slmSysResetPm, slmTrapDestCommunity=slmTrapDestCommunity, slmNetworkMode=slmNetworkMode, slmLicenseId=slmLicenseId, slmTrapLogEntry=slmTrapLogEntry, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmChPassEntry=slmChPassEntry)
