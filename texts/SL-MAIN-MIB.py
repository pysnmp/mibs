...
IpAddress, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, Integer32, NotificationType, Opaque, Counter64, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "Opaque", "Counter64", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminAccess=slmAdminAccess, slmTrapPort=slmTrapPort, UserCommunity=UserCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassEntry=slmChPassEntry, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmLicenseTable=slmLicenseTable, slmSysCalendarTime=slmSysCalendarTime, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmAuthTable=slmAuthTable, slmAdminPassword=slmAdminPassword, slmSysMode=slmSysMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevName=slmSwRevName, slmSyslogDestAddress=slmSyslogDestAddress, slmNetworkMode=slmNetworkMode, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassOldPass=slmChPassOldPass, slmSyslogLevel=slmSyslogLevel, slmConfigSysUptime=slmConfigSysUptime, slmSwRevStatus=slmSwRevStatus, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogEntry=slmTrapLogEntry, slmWriteCommunity=slmWriteCommunity, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmTrapEnable=slmTrapEnable, slmTrap=slmTrap, slmRebootDelay=slmRebootDelay, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmSysUplinkRate=slmSysUplinkRate, slMain=slMain, slmSysLocation=slmSysLocation, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam4=slmTrapLogParam4, slmSysTemperature=slmSysTemperature, slmSysResetPm=slmSysResetPm, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPmAvailable=slmPmAvailable, slmAuthLogin=slmAuthLogin, slmTrapUserAccess=slmTrapUserAccess, slmSysIpAddr=slmSysIpAddr, slmTrapLogName=slmTrapLogName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmTid=slmTid, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmAuthCommunity=slmAuthCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdmin=slmAdmin, AdminAccess=AdminAccess, slmLicenseIndex=slmLicenseIndex, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmLogin=slmLogin, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthEntry=slmAuthEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysLocationChange=slmTrapSysLocationChange, PYSNMP_MODULE_ID=slMain, slmChPassLogin=slmChPassLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSys=slmSys, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmMuxNumber=slmMuxNumber, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysNameChange=slmTrapSysNameChange)
