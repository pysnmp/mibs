...
NotificationType, MibIdentifier, Integer32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, IpAddress, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, Bits, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Integer32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "Unsigned32")
DateAndTime, TruthValue, TextualConvention, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TruthValue", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, slmAdminTable=slmAdminTable, slmSysTemperature=slmSysTemperature, slmTrapDestTable=slmTrapDestTable, slmSysUplinkRate=slmSysUplinkRate, slmWriteCommunity=slmWriteCommunity, slmAuthLogin=slmAuthLogin, slmSysResetPm=slmSysResetPm, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slMain=slMain, slmChPass=slmChPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmSys=slmSys, slmSwRevDate=slmSwRevDate, slmSwRevDirectory=slmSwRevDirectory, slmSyslogLevel=slmSyslogLevel, slmLicense=slmLicense, slmAdminCommunity=slmAdminCommunity, slmSwRevStatus=slmSwRevStatus, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTid=slmTid, slmLicenseId=slmLicenseId, slmMuxNumber=slmMuxNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestTable=slmSyslogDestTable, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmVcatDelay=slmVcatDelay, slmLicenseEntry=slmLicenseEntry, slmSwRevTable=slmSwRevTable, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmAct=slmSysAlmAct, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmAdminPassword=slmAdminPassword, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestAddress=slmSyslogDestAddress, slmSysMode=slmSysMode, slmTrapLogParam5=slmTrapLogParam5, slmTrap=slmTrap, UserCommunity=UserCommunity, slmRebootDelay=slmRebootDelay, slmChPassOldPass=slmChPassOldPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmLicenseTable=slmLicenseTable, slmTrapUserAccess=slmTrapUserAccess, slmOemType=slmOemType, slmTrapCommunity=slmTrapCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanIpAddr=slmSysLanIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmReadCommunity=slmReadCommunity, slmPortsNumber=slmPortsNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminLogin=slmAdminLogin, slmSysName=slmSysName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmAuthTable=slmAuthTable, UserLogin=UserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPmAvailable=slmPmAvailable, slmTrapLogName=slmTrapLogName, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapPort=slmTrapPort, slmEdfaNumber=slmEdfaNumber, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmChPassTable=slmChPassTable, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassNewPass=slmChPassNewPass, slmSysAdminStatus=slmSysAdminStatus, slmChPassEntry=slmChPassEntry, slm40GConf=slm40GConf, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmAuthPassword=slmAuthPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthEntry=slmAuthEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysIpAddr=slmSysIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmTrapUserLogin=slmTrapUserLogin, PYSNMP_MODULE_ID=slMain, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Password=slmSnmpv3Password)
