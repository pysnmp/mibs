...
ModuleIdentity, Gauge32, Opaque, MibIdentifier, Unsigned32, Bits, NotificationType, Counter64, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Opaque", "MibIdentifier", "Unsigned32", "Bits", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmBoxSize=slmBoxSize, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmChPass=slmChPass, slmSysMode=slmSysMode, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmChPassTable=slmChPassTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmPortsNumber=slmPortsNumber, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slmAdminRowStatus=slmAdminRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmAuthLogin=slmAuthLogin, slmTrapCommunity=slmTrapCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, AdminAccess=AdminAccess, slmSysChassisId=slmSysChassisId, slmTid=slmTid, slmAdminEntry=slmAdminEntry, slmAuthCommunity=slmAuthCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmVcatDelay=slmVcatDelay, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTable=slmTrapLogTable, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmTrapLogName=slmTrapLogName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestTable=slmTrapDestTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, UserCommunity=UserCommunity, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmAuthPassword=slmAuthPassword, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmSysResetPm=slmSysResetPm, slmEdfaNumber=slmEdfaNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminAccess=slmAdminAccess, slmTrapEnable=slmTrapEnable, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, UserLogin=UserLogin, SoftwareRevision=SoftwareRevision, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminLogin=slmAdminLogin, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, UserPassword=UserPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam2=slmTrapLogParam2, slmNetworkMode=slmNetworkMode, slmSyslogPort=slmSyslogPort, slmMuxNumber=slmMuxNumber, slmChPassLogin=slmChPassLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, slmOemType=slmOemType, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminCommunity=slmAdminCommunity, slmLogFile=slmLogFile, slmConfigSysSignalType=slmConfigSysSignalType)
