...
Unsigned32, MibIdentifier, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, ModuleIdentity, Counter64, NotificationType, Integer32, Opaque, IpAddress, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "ModuleIdentity", "Counter64", "NotificationType", "Integer32", "Opaque", "IpAddress", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysResetPm=slmSysResetPm, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassOldPass=slmChPassOldPass, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDate=slmSwRevDate, slmTrapEnable=slmTrapEnable, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slmSysChassisId=slmSysChassisId, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmSwRevStatus=slmSwRevStatus, slmSysMode=slmSysMode, slmTrapDestAddress=slmTrapDestAddress, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmNetworkMode=slmNetworkMode, slmSwRevTable=slmSwRevTable, slmTrap=slmTrap, slmSwRevEntry=slmSwRevEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSnmpVersion=slmSysSnmpVersion, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserLogin=UserLogin, slmAuthCommunity=slmAuthCommunity, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogEntry=slmTrapLogEntry, slmAdminRowStatus=slmAdminRowStatus, slmTrapPort=slmTrapPort, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmSyslogLevel=slmSyslogLevel, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam6=slmTrapLogParam6, slmWriteCommunity=slmWriteCommunity, slmReadCommunity=slmReadCommunity, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestEntry=slmTrapDestEntry, slmSys=slmSys, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmChPassNewPass=slmChPassNewPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmSysName=slmSysName, SoftwareRevision=SoftwareRevision, slmConfigSysSignalType=slmConfigSysSignalType, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmLicense=slmLicense, slmChPassLogin=slmChPassLogin, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmDeact=slmSysAlmDeact, slmLicenseExpiration=slmLicenseExpiration, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmBoxSize=slmBoxSize, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmVcatDelay=slmVcatDelay, slmSysSubnetMask=slmSysSubnetMask, slmPmAvailable=slmPmAvailable, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmAdminCommunity=slmAdminCommunity, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysAlmAct=slmSysAlmAct, slmTrapLogName=slmTrapLogName, slmAuthTable=slmAuthTable, slmAdmin=slmAdmin, slmSysUplinkRate=slmSysUplinkRate, slmSysAdminStatus=slmSysAdminStatus, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigFile=slmConfigFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogId=slmTrapLogId, slmLogFile=slmLogFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapCommunity=slmTrapCommunity, slmMuxNumber=slmMuxNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmChPass=slmChPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, UserCommunity=UserCommunity, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable)
