...
ObjectIdentity, Counter32, ModuleIdentity, Integer32, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, Unsigned32, Counter64, Opaque, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "ModuleIdentity", "Integer32", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "Unsigned32", "Counter64", "Opaque", "MibIdentifier", "NotificationType")
DisplayString, TruthValue, RowStatus, TextualConvention, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "TextualConvention", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmChPassEntry=slmChPassEntry, slmAuthLogin=slmAuthLogin, slmSysIpAddr=slmSysIpAddr, slmAdmin=slmAdmin, slmChPass=slmChPass, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, AdminAccess=AdminAccess, slmAdminCommunity=slmAdminCommunity, UserCommunity=UserCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmNetworkMode=slmNetworkMode, slmTrapLogParam1=slmTrapLogParam1, slmLicenseExpiration=slmLicenseExpiration, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmTrapEnable=slmTrapEnable, slmAuth=slmAuth, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmTrapLogParam4=slmTrapLogParam4, UserPassword=UserPassword, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmSyslogDestAddress=slmSyslogDestAddress, slmPsuNumber=slmPsuNumber, slmChPassTable=slmChPassTable, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestRowStatus=slmTrapDestRowStatus, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserAccess=slmTrapUserAccess, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmSnmpv3Priv=slmSnmpv3Priv, slmPortsNumber=slmPortsNumber, slmSysTrapFormat=slmSysTrapFormat, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmAuthEntry=slmAuthEntry, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogin=slmLogin, slmSwRevStatus=slmSwRevStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmChPassNewPass=slmChPassNewPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseTable=slmLicenseTable, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slmSnmpv3Password=slmSnmpv3Password, slmSysTemperature=slmSysTemperature, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmSyslogLevel=slmSyslogLevel, slmSysLanIpAddr=slmSysLanIpAddr, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogName=slmTrapLogName, slmEdfaNumber=slmEdfaNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmOemType=slmOemType, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysName=slmSysName, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestCommunity=slmTrapDestCommunity)
