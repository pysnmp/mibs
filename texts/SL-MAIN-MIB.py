...
Unsigned32, IpAddress, Counter32, Opaque, ModuleIdentity, Gauge32, MibIdentifier, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, TimeTicks, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter32", "Opaque", "ModuleIdentity", "Gauge32", "MibIdentifier", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "TimeTicks", "Counter64", "NotificationType")
TextualConvention, DateAndTime, DisplayString, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "DisplayString", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminAccess=slmAdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, UserCommunity=UserCommunity, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, slmWriteCommunity=slmWriteCommunity, slmConfigSysUptime=slmConfigSysUptime, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestTable=slmSyslogDestTable, slmLogin=slmLogin, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile, slmSysChassisId=slmSysChassisId, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDate=slmSwRevDate, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmConfigFile=slmConfigFile, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmSys=slmSys, AdminAccess=AdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmSysSnmpVersion=slmSysSnmpVersion, slMain=slMain, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slm40GConf=slm40GConf, slmVcatDelay=slmVcatDelay, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmMuxNumber=slmMuxNumber, slmOemType=slmOemType, slmChPassNewPass=slmChPassNewPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevName=slmSwRevName, slmAuthLogin=slmAuthLogin, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapPort=slmTrapPort, slmTopologyEnabled=slmTopologyEnabled, slmEdfaNumber=slmEdfaNumber, slmSysMode=slmSysMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTemperature=slmSysTemperature, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmTid=slmTid, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmAdminRowStatus=slmAdminRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassTable=slmChPassTable, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogEntry=slmTrapLogEntry, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmRebootDelay=slmRebootDelay, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmSnmpv3Priv=slmSnmpv3Priv, slmSysIpAddr=slmSysIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmSyslogLevel=slmSyslogLevel, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmSyslogPort=slmSyslogPort, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr)
