...
ObjectIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter32, Gauge32, ModuleIdentity, IpAddress, Integer32, NotificationType, Unsigned32, iso, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "NotificationType", "Unsigned32", "iso", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, UserCommunity=UserCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmTrapLogId=slmTrapLogId, slmTrapSysNameChange=slmTrapSysNameChange, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmLicenseId=slmLicenseId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminRowStatus=slmAdminRowStatus, slmPsuNumber=slmPsuNumber, slmRebootDelay=slmRebootDelay, slmSysAlmDeact=slmSysAlmDeact, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmSys=slmSys, slmAuthPassword=slmAuthPassword, slmTrapPort=slmTrapPort, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmChPassOldPass=slmChPassOldPass, slmChPassLogin=slmChPassLogin, slmTrapDestTable=slmTrapDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestEntry=slmTrapDestEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysTemperature=slmSysTemperature, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmSwRevName=slmSwRevName, slmTrapLogName=slmTrapLogName, slmAdminCommunity=slmAdminCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAdmin=slmAdmin, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam3=slmTrapLogParam3, slmSysMode=slmSysMode, slmTrapLogParam6=slmTrapLogParam6, slmWriteCommunity=slmWriteCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthTable=slmAuthTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmSwRevEntry=slmSwRevEntry, slmLicenseTable=slmLicenseTable, PYSNMP_MODULE_ID=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmAdminTable=slmAdminTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSubnetMask=slmSysSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmLicenseIndex=slmLicenseIndex, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmLogFile=slmLogFile, slmLicenseEntry=slmLicenseEntry, slmEdfaNumber=slmEdfaNumber, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPortsNumber=slmPortsNumber, UserPassword=UserPassword, slmTrapLogParam2=slmTrapLogParam2, slmAuth=slmAuth, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Password=slmSnmpv3Password, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmChPassTable=slmChPassTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestAddress=slmSyslogDestAddress, slMain=slMain, slmSysLocation=slmSysLocation, slmChPassEntry=slmChPassEntry, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestTable=slmSyslogDestTable, slmLogin=slmLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmAdminLogin=slmAdminLogin, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSysName=slmSysName, slmConfigFile=slmConfigFile, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmSysOperStatus=slmSysOperStatus, slmSysAlmAct=slmSysAlmAct)
