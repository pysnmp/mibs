...
Bits, Counter32, ModuleIdentity, Gauge32, Counter64, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ObjectIdentity, Opaque, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ObjectIdentity", "Opaque", "IpAddress", "TimeTicks")
TimeStamp, RowStatus, TruthValue, DisplayString, TextualConvention, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "DisplayString", "TextualConvention", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevEntry=slmSwRevEntry, slmSysTrapFormat=slmSysTrapFormat, slmSysResetPm=slmSysResetPm, slmSwRevTable=slmSwRevTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmLicenseTable=slmLicenseTable, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmSysAdminStatus=slmSysAdminStatus, slmSwRevStatus=slmSwRevStatus, slmConfigFile=slmConfigFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmAdminAccess=slmAdminAccess, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSysIpAddr=slmSysIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapPort=slmTrapPort, slmTrapLogParam4=slmTrapLogParam4, slmSysName=slmSysName, slmTrapUserAccess=slmTrapUserAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseExpiration=slmLicenseExpiration, slmNetworkMode=slmNetworkMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmAdminCommunity=slmAdminCommunity, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmSysLocation=slmSysLocation, slmAuthLogin=slmAuthLogin, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, slmLicense=slmLicense, slmPmAvailable=slmPmAvailable, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, slmSysUplinkRate=slmSysUplinkRate, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmEdfaNumber=slmEdfaNumber, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmLicenseEntry=slmLicenseEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmSwRevDirectory=slmSwRevDirectory, slmAuthTable=slmAuthTable, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slmLicenseId=slmLicenseId, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmTid=slmTid, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmTopologyEnabled=slmTopologyEnabled, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, UserLogin=UserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin)
