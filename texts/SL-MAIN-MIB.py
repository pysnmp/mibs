...
IpAddress, Unsigned32, Counter32, iso, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, MibIdentifier, Integer32, Opaque, ModuleIdentity, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Counter32", "iso", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Integer32", "Opaque", "ModuleIdentity", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassOldPass=slmChPassOldPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, UserLogin=UserLogin, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slmTrapLogTable=slmTrapLogTable, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, SoftwareRevision=SoftwareRevision, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmAdminLogin=slmAdminLogin, slmLogin=slmLogin, slmSysName=slmSysName, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmChPassTable=slmChPassTable, slmLicenseIndex=slmLicenseIndex, slmSysTrapFormat=slmSysTrapFormat, slmAdminTable=slmAdminTable, slmSwRevName=slmSwRevName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmTrapEnable=slmTrapEnable, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestEntry=slmTrapDestEntry, slmSyslogLevel=slmSyslogLevel, slmSyslogPort=slmSyslogPort, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmTrapDestCommunity=slmTrapDestCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestAddress=slmTrapDestAddress, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slMain=slMain, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthEntry=slmAuthEntry, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmSysChassisId=slmSysChassisId, slmTrapUserAccess=slmTrapUserAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmAdminCommunity=slmAdminCommunity, slmTid=slmTid, slmSysAlmAct=slmSysAlmAct, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmAdminPassword=slmAdminPassword, slmChPassNewPass=slmChPassNewPass, slmPortsNumber=slmPortsNumber, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmVcatDelay=slmVcatDelay, slmAuthPassword=slmAuthPassword, slmSysIpAddr=slmSysIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmSysMode=slmSysMode, slmConfigSysSignalType=slmConfigSysSignalType, slmLicense=slmLicense, slmSys=slmSys, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdmin=slmAdmin, slmBoxSize=slmBoxSize, slmConfigFile=slmConfigFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayAddr=slmSysGatewayAddr, slmSysResetPm=slmSysResetPm, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRstpEnabled=slmRstpEnabled, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthLogin=slmAuthLogin, slmWriteCommunity=slmWriteCommunity, slmPmAvailable=slmPmAvailable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmMuxNumber=slmMuxNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmLicenseTable=slmLicenseTable, slmSysLocation=slmSysLocation, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestEntry=slmSyslogDestEntry)
