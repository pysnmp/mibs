...
Gauge32, Opaque, Integer32, Bits, TimeTicks, ObjectIdentity, Counter32, ModuleIdentity, MibIdentifier, NotificationType, Unsigned32, IpAddress, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "Integer32", "Bits", "TimeTicks", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "IpAddress", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserCommunity=UserCommunity, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmAdmin=slmAdmin, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysUptime=slmConfigSysUptime, slmLogin=slmLogin, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, UserPassword=UserPassword, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPmAvailable=slmPmAvailable, slmSwRevTable=slmSwRevTable, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseIndex=slmLicenseIndex, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTable=slmTrapLogTable, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminTable=slmAdminTable, UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSubnetMask=slmSysSubnetMask, slmChPassTable=slmChPassTable, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmPortsNumber=slmPortsNumber, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmVcatDelay=slmVcatDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRstpEnabled=slmRstpEnabled, slmTrapDestEntry=slmTrapDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmAdminEntry=slmAdminEntry, slmTopologyEnabled=slmTopologyEnabled, slmSysOperStatus=slmSysOperStatus, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmChPass=slmChPass, SoftwareRevision=SoftwareRevision, slmSyslogDestAddress=slmSyslogDestAddress, slMain=slMain, slmTrap=slmTrap, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmAdminLogin=slmAdminLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, slm40GConf=slm40GConf, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserAccess=slmTrapUserAccess, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, slmSysAlmAct=slmSysAlmAct, slmAuthPassword=slmAuthPassword, slmRebootDelay=slmRebootDelay, slmReadCommunity=slmReadCommunity, slmAuthLogin=slmAuthLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestTable=slmSyslogDestTable, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogName=slmTrapLogName, slmSys=slmSys, slmAuthCommunity=slmAuthCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmConfigFile=slmConfigFile, slmSysAdminStatus=slmSysAdminStatus, slmSwRevName=slmSwRevName, slmOemType=slmOemType, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSysName=slmSysName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam6=slmTrapLogParam6)
