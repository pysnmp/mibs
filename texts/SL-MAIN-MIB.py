...
ModuleIdentity, TimeTicks, Integer32, IpAddress, Gauge32, NotificationType, MibIdentifier, iso, Unsigned32, Counter32, Counter64, Opaque, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Integer32", "IpAddress", "Gauge32", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "Counter32", "Counter64", "Opaque", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TimeStamp, DisplayString, RowStatus, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmLicenseExpiration=slmLicenseExpiration, slmTid=slmTid, slmAdmin=slmAdmin, slmRstpEnabled=slmRstpEnabled, slmAuthPassword=slmAuthPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayAddr=slmSysGatewayAddr, slmSysChassisId=slmSysChassisId, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmLicenseIndex=slmLicenseIndex, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmSnmpv3Password=slmSnmpv3Password, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slmMuxNumber=slmMuxNumber, slmSysCalendarTime=slmSysCalendarTime, PYSNMP_MODULE_ID=slMain, slmSysResetPm=slmSysResetPm, slmLicenseId=slmLicenseId, slmTrapPort=slmTrapPort, slmTrapLogParam6=slmTrapLogParam6, slmNetworkMode=slmNetworkMode, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmSwRevDate=slmSwRevDate, slmConfigFile=slmConfigFile, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, UserPassword=UserPassword, slmLicense=slmLicense, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmTrapEnable=slmTrapEnable, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysUptime=slmConfigSysUptime, UserCommunity=UserCommunity, UserLogin=UserLogin, slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmSysName=slmSysName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, AdminAccess=AdminAccess, slmVcatDelay=slmVcatDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmLicenseTable=slmLicenseTable, slmTrapLogId=slmTrapLogId, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmSysAlmAct=slmSysAlmAct, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrap=slmTrap)
