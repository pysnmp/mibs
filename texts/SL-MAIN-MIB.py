...
Opaque, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, IpAddress, Unsigned32, Bits, Gauge32, ModuleIdentity, TimeTicks, Counter64, MibIdentifier, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "IpAddress", "Unsigned32", "Bits", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter64", "MibIdentifier", "iso", "Counter32")
TimeStamp, TextualConvention, DisplayString, RowStatus, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmSysTemperature=slmSysTemperature, slmRebootDelay=slmRebootDelay, slmTrapCommunity=slmTrapCommunity, slmSysName=slmSysName, slmChPassEntry=slmChPassEntry, slmVcatDelay=slmVcatDelay, slmAdminLogin=slmAdminLogin, slmChPassNewPass=slmChPassNewPass, slMain=slMain, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPass=slmChPass, slmAdminAccess=slmAdminAccess, slmTrapLogName=slmTrapLogName, slmAuthEntry=slmAuthEntry, slm40GConf=slm40GConf, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, PYSNMP_MODULE_ID=slMain, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmSysAlmDeact=slmSysAlmDeact, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmReadCommunity=slmReadCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigSysUptime=slmConfigSysUptime, slmSysChassisId=slmSysChassisId, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmSysCalendarTime=slmSysCalendarTime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminPassword=slmAdminPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmLicense=slmLicense, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDate=slmSwRevDate, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmPortsNumber=slmPortsNumber, slmSwRevStatus=slmSwRevStatus, slmOemType=slmOemType, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmChPassLogin=slmChPassLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmPsuNumber=slmPsuNumber, slmSwRevDirectory=slmSwRevDirectory, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevEntry=slmSwRevEntry, slmMuxNumber=slmMuxNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLocation=slmSysLocation, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam1=slmTrapLogParam1, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmConfigFile=slmConfigFile, slmTid=slmTid, slmSysAlmAct=slmSysAlmAct, slmLogin=slmLogin, slmSyslogDestTable=slmSyslogDestTable, AdminAccess=AdminAccess, UserPassword=UserPassword, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrap=slmTrap, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestTable=slmTrapDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserCommunity=UserCommunity, slmAuthPassword=slmAuthPassword, slmSnmpv3Password=slmSnmpv3Password, slmSysResetPm=slmSysResetPm, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmTrapPort=slmTrapPort, slmSyslogPort=slmSyslogPort, slmSyslogLevel=slmSyslogLevel, slmRstpEnabled=slmRstpEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPmAvailable=slmPmAvailable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseId=slmLicenseId)
