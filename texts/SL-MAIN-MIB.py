...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmAuthCommunity=slmAuthCommunity, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmSwRevStatus=slmSwRevStatus, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, UserPassword=UserPassword, slmTrapUserLogin=slmTrapUserLogin, slmAdmin=slmAdmin, UserLogin=UserLogin, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSys=slmSys, slmTrap=slmTrap, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthEntry=slmAuthEntry, slmBoxSize=slmBoxSize, slmVcatDelay=slmVcatDelay, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysName=slmSysName, slmSysAlmAct=slmSysAlmAct, slmChPassNewPass=slmChPassNewPass, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmSnmpv3Password=slmSnmpv3Password, slmLicenseId=slmLicenseId, slmAdminPassword=slmAdminPassword, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmTrapDestEntry=slmTrapDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmSysSubnetMask=slmSysSubnetMask, slmTopologyEnabled=slmTopologyEnabled, slmSysLocation=slmSysLocation, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSwRevTable=slmSwRevTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogFile=slmLogFile, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmAuth=slmAuth, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, slmSysOperStatus=slmSysOperStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmAdminLogin=slmAdminLogin, SoftwareRevision=SoftwareRevision, slmSwRevEntry=slmSwRevEntry, slmSwRevName=slmSwRevName, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmTrapLogName=slmTrapLogName, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmAuthTable=slmAuthTable, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmChPassEntry=slmChPassEntry, slmTrapLogParam1=slmTrapLogParam1, slmLogin=slmLogin, slmRstpEnabled=slmRstpEnabled, slmSysIpAddr=slmSysIpAddr, slmMuxNumber=slmMuxNumber, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicense=slmLicense, slmTrapSysNameChange=slmTrapSysNameChange)
