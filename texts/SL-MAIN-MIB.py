...
Bits, Counter64, NotificationType, iso, TimeTicks, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, MibIdentifier, Integer32, IpAddress, ObjectIdentity, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "iso", "TimeTicks", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "MibIdentifier", "Integer32", "IpAddress", "ObjectIdentity", "Gauge32", "Unsigned32")
TimeStamp, TruthValue, DateAndTime, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DateAndTime", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthPassword=slmAuthPassword, slmSwRevEntry=slmSwRevEntry, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmNetworkMode=slmNetworkMode, slmTrapUserLogin=slmTrapUserLogin, slmTrapEnable=slmTrapEnable, slmSyslogPort=slmSyslogPort, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmAdminEntry=slmAdminEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmSysChassisId=slmSysChassisId, slmSnmpv3Password=slmSnmpv3Password, slmSysSubnetMask=slmSysSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slm40GConf=slm40GConf, slmTid=slmTid, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestTable=slmTrapDestTable, slmSysOperStatus=slmSysOperStatus, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, slmAdminPassword=slmAdminPassword, slmAdminLogin=slmAdminLogin, slmAuthTable=slmAuthTable, slmTrapLogParam3=slmTrapLogParam3, slmMuxNumber=slmMuxNumber, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmAdminTable=slmAdminTable, slmSysName=slmSysName, slmTrapCommunity=slmTrapCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmSysTrapFormat=slmSysTrapFormat, slmPsuNumber=slmPsuNumber, slmWriteCommunity=slmWriteCommunity, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestAddress=slmTrapDestAddress, slmSysUplinkRate=slmSysUplinkRate, UserCommunity=UserCommunity, slmConfigFile=slmConfigFile, slmTrapLogTable=slmTrapLogTable, PYSNMP_MODULE_ID=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, UserLogin=UserLogin, slmTrapLogName=slmTrapLogName, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmChPass=slmChPass, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdmin=slmAdmin, slmChPassNewPass=slmChPassNewPass, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam6=slmTrapLogParam6, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysMode=slmSysMode, slmLicenseId=slmLicenseId, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slMain=slMain, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmTrapPort=slmTrapPort, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmLicenseTable=slmLicenseTable, slmSysGatewayAddr=slmSysGatewayAddr, slmEdfaNumber=slmEdfaNumber, slmPortsNumber=slmPortsNumber, slmLogin=slmLogin, slmLogFile=slmLogFile, AdminAccess=AdminAccess)
