...
ModuleIdentity, TimeTicks, Gauge32, MibIdentifier, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Integer32, iso, Bits, Unsigned32, Counter64, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Gauge32", "MibIdentifier", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Integer32", "iso", "Bits", "Unsigned32", "Counter64", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAdminStatus=slmSysAdminStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmAdminEntry=slmAdminEntry, slmTrapDestEntry=slmTrapDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestEntry=slmSyslogDestEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slMain=slMain, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, PYSNMP_MODULE_ID=slMain, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmAct=slmSysAlmAct, slmSwRevDate=slmSwRevDate, slmLicenseEntry=slmLicenseEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevStatus=slmSwRevStatus, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmOemType=slmOemType, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmReadCommunity=slmReadCommunity, slmSysChassisId=slmSysChassisId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmTrapLogParam6=slmTrapLogParam6, slmAuthEntry=slmAuthEntry, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigFile=slmConfigFile, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmNetworkMode=slmNetworkMode, slmChPassNewPass=slmChPassNewPass, slmLicenseTable=slmLicenseTable, slmPsuNumber=slmPsuNumber, slmSysMode=slmSysMode, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserAccess=slmTrapUserAccess, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, UserLogin=UserLogin, slmLicense=slmLicense, slmTrapCommunity=slmTrapCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmAdminCommunity=slmAdminCommunity, slmSys=slmSys, slmAuth=slmAuth, slmLogFile=slmLogFile, slmTrapEnable=slmTrapEnable, slmSyslogDestTable=slmSyslogDestTable, slmSwRevName=slmSwRevName, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmAdminAccess=slmAdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmLicenseIndex=slmLicenseIndex, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, UserCommunity=UserCommunity, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmWriteCommunity=slmWriteCommunity, slmTrapLogName=slmTrapLogName, slmRebootDelay=slmRebootDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLocation=slmSysLocation, slmSysOperStatus=slmSysOperStatus, slmTrapLogId=slmTrapLogId, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmEdfaNumber=slmEdfaNumber, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmChPass=slmChPass)
