...
Unsigned32, IpAddress, Counter64, ObjectIdentity, MibIdentifier, Gauge32, TimeTicks, Integer32, Bits, NotificationType, iso, ModuleIdentity, Counter32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter64", "ObjectIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "Integer32", "Bits", "NotificationType", "iso", "ModuleIdentity", "Counter32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TimeStamp, TruthValue, DateAndTime, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "DateAndTime", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapPort=slmTrapPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmAuth=slmAuth, slmMuxNumber=slmMuxNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, slmSysMode=slmSysMode, UserLogin=UserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmConfigSysSignalType=slmConfigSysSignalType, slm40GConf=slm40GConf, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestEntry=slmTrapDestEntry, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmSysIpAddr=slmSysIpAddr, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slMain=slMain, AdminAccess=AdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapEnable=slmTrapEnable, slmSwRevStatus=slmSwRevStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam1=slmTrapLogParam1, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminCommunity=slmAdminCommunity, slmAdmin=slmAdmin, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmPmAvailable=slmPmAvailable, slmSwRevName=slmSwRevName, slmAuthCommunity=slmAuthCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthPassword=slmAuthPassword, slmSwRevTable=slmSwRevTable, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam4=slmTrapLogParam4, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysOperStatus=slmSysOperStatus, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, slmEdfaNumber=slmEdfaNumber, slmSyslogPort=slmSyslogPort, slmLicenseTable=slmLicenseTable, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmTrapCommunity=slmTrapCommunity, slmChPassLogin=slmChPassLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysCalendarTime=slmSysCalendarTime, slmTopologyEnabled=slmTopologyEnabled, SoftwareRevision=SoftwareRevision, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSysChassisId=slmSysChassisId, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmAuthEntry=slmAuthEntry, slmAuthTable=slmAuthTable)
