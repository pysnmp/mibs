...
Counter64, Bits, Integer32, ObjectIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ModuleIdentity, TimeTicks, Gauge32, Opaque, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Integer32", "ObjectIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ModuleIdentity", "TimeTicks", "Gauge32", "Opaque", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmTrapLogId=slmTrapLogId, UserLogin=UserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmAdminRowStatus=slmAdminRowStatus, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmSwRevStatus=slmSwRevStatus, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, SoftwareRevision=SoftwareRevision, slmLicenseTable=slmLicenseTable, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam6=slmTrapLogParam6, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDate=slmSwRevDate, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmAct=slmSysAlmAct, slmSysMode=slmSysMode, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmChPass=slmChPass, slmAuthLogin=slmAuthLogin, slmAuthTable=slmAuthTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmLicenseExpiration=slmLicenseExpiration, slmSys=slmSys, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysLocation=slmSysLocation, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserCommunity=UserCommunity, PYSNMP_MODULE_ID=slMain, slmTrap=slmTrap, slmLogin=slmLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam1=slmTrapLogParam1, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmTrapDestAddress=slmTrapDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmEdfaNumber=slmEdfaNumber, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmAuth=slmAuth, slmChPassNewPass=slmChPassNewPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, slmSysUplinkRate=slmSysUplinkRate, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmTid=slmTid, slmSysName=slmSysName, slmSysResetPm=slmSysResetPm, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmOemType=slmOemType, slmTopologyEnabled=slmTopologyEnabled, slmSyslogPort=slmSyslogPort, slmSyslogDestEntry=slmSyslogDestEntry, slmRstpEnabled=slmRstpEnabled, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity)
