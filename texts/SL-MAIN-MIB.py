...
iso, Gauge32, NotificationType, Bits, Unsigned32, Opaque, Counter64, Counter32, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "NotificationType", "Bits", "Unsigned32", "Opaque", "Counter64", "Counter32", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmPortsNumber=slmPortsNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdmin=slmAdmin, slmSysIpAddr=slmSysIpAddr, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, SoftwareRevision=SoftwareRevision, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, AdminAccess=AdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slmSwRevDirectory=slmSwRevDirectory, slmSyslogPort=slmSyslogPort, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmPsuNumber=slmPsuNumber, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRebootDelay=slmRebootDelay, slmChPassLogin=slmChPassLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmWriteCommunity=slmWriteCommunity, slmSysMode=slmSysMode, slmTrapLogParam1=slmTrapLogParam1, slmSys=slmSys, slmAuthPassword=slmAuthPassword, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmTrapUserAccess=slmTrapUserAccess, slmSwRevStatus=slmSwRevStatus, slmReadCommunity=slmReadCommunity, slmTrapLogTable=slmTrapLogTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmAdminAccess=slmAdminAccess, slmChPass=slmChPass, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmAdminPassword=slmAdminPassword, slmSysTrapFormat=slmSysTrapFormat, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmTrapLogParam6=slmTrapLogParam6, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseTable=slmLicenseTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmRstpEnabled=slmRstpEnabled, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmMuxNumber=slmMuxNumber, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysName=slmSysName, slmTrapLogParam3=slmTrapLogParam3, slmTrapPort=slmTrapPort, slmTrapUserLogin=slmTrapUserLogin, slmSysTemperature=slmSysTemperature, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSyslogLevel=slmSyslogLevel, slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmTid=slmTid, slmSysAlmDeact=slmSysAlmDeact, slMain=slMain)
