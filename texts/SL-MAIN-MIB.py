...
ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, Unsigned32, Gauge32, Counter64, ObjectIdentity, Integer32, IpAddress, MibIdentifier, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "Unsigned32", "Gauge32", "Counter64", "ObjectIdentity", "Integer32", "IpAddress", "MibIdentifier", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmChPass=slmChPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysName=slmSysName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, slmSysTemperature=slmSysTemperature, slmSwRevEntry=slmSwRevEntry, slmChPassLogin=slmChPassLogin, slmAuthEntry=slmAuthEntry, slmBoxSize=slmBoxSize, slmLicense=slmLicense, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam4=slmTrapLogParam4, slMain=slMain, UserLogin=UserLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysAdminStatus=slmSysAdminStatus, slmLogin=slmLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmPsuNumber=slmPsuNumber, slmSyslogDestTable=slmSyslogDestTable, slmSwRevTable=slmSwRevTable, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam2=slmTrapLogParam2, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmSwRevDate=slmSwRevDate, slmOemType=slmOemType, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLocation=slmSysLocation, slmNetworkMode=slmNetworkMode, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmPortsNumber=slmPortsNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay, slmChPassNewPass=slmChPassNewPass, slmSysResetPm=slmSysResetPm, slm40GConf=slm40GConf, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmAdminLogin=slmAdminLogin, slmEdfaNumber=slmEdfaNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminRowStatus=slmAdminRowStatus, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmAdminCommunity=slmAdminCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmAdminPassword=slmAdminPassword, slmSysChassisId=slmSysChassisId, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrap=slmTrap, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysTrapFormat=slmSysTrapFormat, slmSysMode=slmSysMode, slmTrapLogName=slmTrapLogName, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Priv=slmSnmpv3Priv, slmVcatDelay=slmVcatDelay, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmWriteCommunity=slmWriteCommunity, slmAuth=slmAuth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevName=slmSwRevName, slmTrapLogParam1=slmTrapLogParam1, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTid=slmTid)
