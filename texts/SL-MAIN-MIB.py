...
Counter32, Bits, IpAddress, MibIdentifier, NotificationType, Counter64, Gauge32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Unsigned32, iso, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Unsigned32", "iso", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassEntry=slmChPassEntry, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysChassisId=slmSysChassisId, slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmSysLocation=slmSysLocation, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slMain=slMain, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseTable=slmLicenseTable, slmLicense=slmLicense, slmChPass=slmChPass, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slm40GConf=slm40GConf, PYSNMP_MODULE_ID=slMain, slmAuthEntry=slmAuthEntry, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmAuth=slmAuth, slmSysLanIpAddr=slmSysLanIpAddr, slmBoxSize=slmBoxSize, slmSysName=slmSysName, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthPassword=slmAuthPassword, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysUptime=slmConfigSysUptime, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevTable=slmSwRevTable, slmSysSnmpVersion=slmSysSnmpVersion, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam6=slmTrapLogParam6, slmAdmin=slmAdmin, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Password=slmSnmpv3Password, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmTrapCommunity=slmTrapCommunity, UserCommunity=UserCommunity, slmPmAvailable=slmPmAvailable, slmSyslogDestTable=slmSyslogDestTable, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevEntry=slmSwRevEntry, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam1=slmTrapLogParam1, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminTable=slmAdminTable, slmTrapPort=slmTrapPort, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmSyslogLevel=slmSyslogLevel, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, slmSyslogPort=slmSyslogPort, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress)
