...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, iso, ObjectIdentity, IpAddress, Integer32, NotificationType, Counter32, Unsigned32, TimeTicks, Counter64, Opaque, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "Integer32", "NotificationType", "Counter32", "Unsigned32", "TimeTicks", "Counter64", "Opaque", "Bits")
TruthValue, DisplayString, DateAndTime, RowStatus, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "DateAndTime", "RowStatus", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogLevel=slmSyslogLevel, slmChPassOldPass=slmChPassOldPass, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmTrapLogParam6=slmTrapLogParam6, slmSysOperStatus=slmSysOperStatus, slmAdmin=slmAdmin, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSys=slmSys, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmLicenseId=slmLicenseId, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmLogFile=slmLogFile, slmAdminCommunity=slmAdminCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmAdminLogin=slmAdminLogin, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmTrapSysNameChange=slmTrapSysNameChange, SoftwareRevision=SoftwareRevision, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmChPassEntry=slmChPassEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestTable=slmTrapDestTable, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserCommunity=UserCommunity, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmChPassTable=slmChPassTable, slmLicenseTable=slmLicenseTable, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDate=slmSwRevDate, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam1=slmTrapLogParam1, slmAuthPassword=slmAuthPassword, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmSysTemperature=slmSysTemperature, slmSysUplinkRate=slmSysUplinkRate, slmLicenseExpiration=slmLicenseExpiration, slmChPassLogin=slmChPassLogin, slmAuthTable=slmAuthTable, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTable=slmTrapLogTable, slmSysResetPm=slmSysResetPm, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmSysName=slmSysName, slmRebootDelay=slmRebootDelay, slmTrapEnable=slmTrapEnable, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slm40GConf=slm40GConf, slmAuth=slmAuth, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLocation=slmSysLocation, slmTopologyEnabled=slmTopologyEnabled, slmSysAdminStatus=slmSysAdminStatus, slmAuthLogin=slmAuthLogin, slmSysIpAddr=slmSysIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicense=slmLicense, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmConfigSysUptime=slmConfigSysUptime, slmSysSnmpVersion=slmSysSnmpVersion, slmWriteCommunity=slmWriteCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogName=slmTrapLogName, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry, slmSwRevName=slmSwRevName)
