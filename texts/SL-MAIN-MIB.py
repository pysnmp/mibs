...
Counter32, Integer32, NotificationType, Opaque, Bits, Counter64, iso, MibIdentifier, TimeTicks, ObjectIdentity, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "Opaque", "Bits", "Counter64", "iso", "MibIdentifier", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, slmTid=slmTid, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmAuthCommunity=slmAuthCommunity, slmTrapPort=slmTrapPort, slMain=slMain, slmAdmin=slmAdmin, slmTrapLogParam3=slmTrapLogParam3, slmPortsNumber=slmPortsNumber, slmOemType=slmOemType, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmPmAvailable=slmPmAvailable, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestIpAddress=slmTrapDestIpAddress, UserLogin=UserLogin, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthLogin=slmAuthLogin, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmSysAlmAct=slmSysAlmAct, slmLicenseEntry=slmLicenseEntry, slmChPassNewPass=slmChPassNewPass, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmAdminTable=slmAdminTable, AdminAccess=AdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogName=slmTrapLogName, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserPassword=UserPassword, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmChPassLogin=slmChPassLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPsuNumber=slmPsuNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmSnmpv3Password=slmSnmpv3Password, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmChPass=slmChPass, slmTrapLogTable=slmTrapLogTable, slmTrap=slmTrap, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmRstpEnabled=slmRstpEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmLogin=slmLogin, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmAuthPassword=slmAuthPassword, slmSyslogPort=slmSyslogPort, slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmReadCommunity=slmReadCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, slmTrapCommunity=slmTrapCommunity, slmAdminEntry=slmAdminEntry, slmWriteCommunity=slmWriteCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmAdminCommunity=slmAdminCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserAccess=slmTrapUserAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmAuthEntry=slmAuthEntry, slmAdminAccess=slmAdminAccess, slmLicenseId=slmLicenseId, slmAuth=slmAuth, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSys=slmSys)
