...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, IpAddress, Counter64, MibIdentifier, Integer32, Opaque, Gauge32, iso, ObjectIdentity, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "Integer32", "Opaque", "Gauge32", "iso", "ObjectIdentity", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmSysUplinkRate=slmSysUplinkRate, slmSwRevStatus=slmSwRevStatus, slmConfigSysUptime=slmConfigSysUptime, slmBoxSize=slmBoxSize, slmSyslogDestEntry=slmSyslogDestEntry, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmAdminLogin=slmAdminLogin, slmChPassTable=slmChPassTable, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam4=slmTrapLogParam4, slmSysLanIpAddr=slmSysLanIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminPassword=slmAdminPassword, slmSwRevTable=slmSwRevTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, slmTrap=slmTrap, slmLicenseTable=slmLicenseTable, slmSys=slmSys, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, slmSysName=slmSysName, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, UserCommunity=UserCommunity, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, PYSNMP_MODULE_ID=slMain, slmPmAvailable=slmPmAvailable, slmRstpEnabled=slmRstpEnabled, slmAuthLogin=slmAuthLogin, slmWriteCommunity=slmWriteCommunity, slmOemType=slmOemType, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmSysChassisId=slmSysChassisId, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, slmTrapPort=slmTrapPort, slmConfigFile=slmConfigFile, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, AdminAccess=AdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuth=slmAuth, slmSysLocation=slmSysLocation, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysIpAddr=slmSysIpAddr, slmAuthCommunity=slmAuthCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPass=slmChPass, slmChPassLogin=slmChPassLogin, slmAdmin=slmAdmin, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysTrapFormat=slmSysTrapFormat, slmSwRevEntry=slmSwRevEntry, slmSyslogPort=slmSyslogPort, slmMuxNumber=slmMuxNumber, slmReadCommunity=slmReadCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr)
