...
Opaque, TimeTicks, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, Counter32, Integer32, Gauge32, Unsigned32, ObjectIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "TimeTicks", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "Counter32", "Integer32", "Gauge32", "Unsigned32", "ObjectIdentity", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", PYSNMP_MODULE_ID=slMain, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestTable=slmTrapDestTable, slmSys=slmSys, slmSwRevTable=slmSwRevTable, slmTrapLogTable=slmTrapLogTable, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmPsuNumber=slmPsuNumber, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminAccess=slmAdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, UserPassword=UserPassword, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmTrapEnable=slmTrapEnable, slmLicenseEntry=slmLicenseEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmTrap=slmTrap, AdminAccess=AdminAccess, slmSyslogPort=slmSyslogPort, slMain=slMain, slmTid=slmTid, slmPmAvailable=slmPmAvailable, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogName=slmTrapLogName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicense=slmLicense, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, slmTrapCommunity=slmTrapCommunity, slmConfigFile=slmConfigFile, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, UserCommunity=UserCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysName=slmSysName, slmLogin=slmLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysIpAddr=slmSysIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmNetworkMode=slmNetworkMode, slmTrapLogParam2=slmTrapLogParam2, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmVcatDelay=slmVcatDelay, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevStatus=slmSwRevStatus, slmAuth=slmAuth, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, slmTrapLogEntry=slmTrapLogEntry, slmChPassEntry=slmChPassEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdmin=slmAdmin, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevEntry=slmSwRevEntry, slmRstpEnabled=slmRstpEnabled, slmSysTemperature=slmSysTemperature, UserLogin=UserLogin, slmTrapDestEntry=slmTrapDestEntry, slmLogFile=slmLogFile, slmLicenseExpiration=slmLicenseExpiration, slmAuthLogin=slmAuthLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmReadCommunity=slmReadCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapPort=slmTrapPort, slmTrapLogId=slmTrapLogId, slmSysOperStatus=slmSysOperStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysChassisId=slmSysChassisId, slmAuthCommunity=slmAuthCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity)
