...
Opaque, Counter32, Gauge32, TimeTicks, iso, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, Integer32, Counter64, Bits, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Counter32", "Gauge32", "TimeTicks", "iso", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "Integer32", "Counter64", "Bits", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmRebootDelay=slmRebootDelay, slmSysOperStatus=slmSysOperStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPass=slmChPass, slmAdminEntry=slmAdminEntry, slmTrapDestAddress=slmTrapDestAddress, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmOemType=slmOemType, slmLogFile=slmLogFile, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTid=slmTid, slmTrapCommunity=slmTrapCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmTrapEnable=slmTrapEnable, slmBoxSize=slmBoxSize, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Priv=slmSnmpv3Priv, SoftwareRevision=SoftwareRevision, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseId=slmLicenseId, slmAdmin=slmAdmin, slmReadCommunity=slmReadCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam6=slmTrapLogParam6, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmLicenseEntry=slmLicenseEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevDate=slmSwRevDate, slmSys=slmSys, slmSysChassisId=slmSysChassisId, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmConfigSysUptime=slmConfigSysUptime, slmEdfaNumber=slmEdfaNumber, slmLicenseExpiration=slmLicenseExpiration, slmLicenseTable=slmLicenseTable, slmAuthEntry=slmAuthEntry, slmSyslogLevel=slmSyslogLevel, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmPortsNumber=slmPortsNumber, slMain=slMain, slmSysLocation=slmSysLocation, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassLogin=slmChPassLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmSyslogPort=slmSyslogPort, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, UserPassword=UserPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, AdminAccess=AdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmTrap=slmTrap, slmTrapLogParam2=slmTrapLogParam2, slmAdminAccess=slmAdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, slmTrapUserAccess=slmTrapUserAccess)
