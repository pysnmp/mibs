...
Bits, IpAddress, MibIdentifier, TimeTicks, iso, NotificationType, Gauge32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "iso", "NotificationType", "Gauge32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "Counter32")
TextualConvention, DisplayString, RowStatus, TruthValue, TimeStamp, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "TimeStamp", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthCommunity=slmAuthCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmChPassTable=slmChPassTable, slmSysName=slmSysName, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmAuthLogin=slmAuthLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminPassword=slmAdminPassword, slmRstpEnabled=slmRstpEnabled, slmSysLocation=slmSysLocation, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysChassisId=slmSysChassisId, slmTrapEnable=slmTrapEnable, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, PYSNMP_MODULE_ID=slMain, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmNetworkMode=slmNetworkMode, slmSys=slmSys, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmSysMode=slmSysMode, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserLogin=slmTrapUserLogin, slmSysTemperature=slmSysTemperature, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam3=slmTrapLogParam3, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slm40GConf=slm40GConf, slmSysAlmDeact=slmSysAlmDeact, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmEdfaNumber=slmEdfaNumber, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserLogin=UserLogin, slmTrapDestTable=slmTrapDestTable, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, SoftwareRevision=SoftwareRevision, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmLogin=slmLogin, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrapUserAccess=slmTrapUserAccess, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysUptime=slmConfigSysUptime, slmSysOperStatus=slmSysOperStatus, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, slmPsuNumber=slmPsuNumber, slmSyslogLevel=slmSyslogLevel, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmChPassOldPass=slmChPassOldPass, slmTrapLogName=slmTrapLogName, slmTrapDestEntry=slmTrapDestEntry, slmLicenseTable=slmLicenseTable, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestEntry=slmSyslogDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmLicenseIndex=slmLicenseIndex, slmTrap=slmTrap, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmVcatDelay=slmVcatDelay, slmTrapLogParam4=slmTrapLogParam4)
