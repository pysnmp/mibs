...
Bits, ModuleIdentity, Gauge32, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, Opaque, TimeTicks, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Gauge32", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "Opaque", "TimeTicks", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter32")
RowStatus, DateAndTime, TimeStamp, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TimeStamp", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTemperature=slmSysTemperature, slmSyslogDestTable=slmSyslogDestTable, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmRstpEnabled=slmRstpEnabled, slmTrapCommunity=slmTrapCommunity, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmLicenseEntry=slmLicenseEntry, slmTrapEnable=slmTrapEnable, slmTrapDestEntry=slmTrapDestEntry, slmBoxSize=slmBoxSize, UserLogin=UserLogin, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmSysAlmDeact=slmSysAlmDeact, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmAuthCommunity=slmAuthCommunity, slmSwRevTable=slmSwRevTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserPassword=UserPassword, slmTrapLogParam6=slmTrapLogParam6, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTable=slmTrapLogTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slmSysAlmAct=slmSysAlmAct, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmTrapUserLogin=slmTrapUserLogin, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmSysUplinkRate=slmSysUplinkRate, slmSys=slmSys, slmAdminCommunity=slmAdminCommunity, slmSwRevEntry=slmSwRevEntry, AdminAccess=AdminAccess, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminEntry=slmAdminEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmTrapLogName=slmTrapLogName, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam5=slmTrapLogParam5, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAdminStatus=slmSysAdminStatus, slmAuthLogin=slmAuthLogin, slmTrapPort=slmTrapPort, slmSyslogPort=slmSyslogPort, slmAuth=slmAuth, slmTrapUserAccess=slmTrapUserAccess, slmOemType=slmOemType, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam3=slmTrapLogParam3, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmSysSubnetMask=slmSysSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassTable=slmChPassTable, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestCommunity=slmTrapDestCommunity, slMain=slMain, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmAdminTable=slmAdminTable, slmAuthTable=slmAuthTable, slmSysIpAddr=slmSysIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDate=slmSwRevDate, slmConfigFile=slmConfigFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminLogin=slmAdminLogin, UserCommunity=UserCommunity)
