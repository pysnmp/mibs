...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysSignalType=slmConfigSysSignalType, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmChPassNewPass=slmChPassNewPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogLevel=slmSyslogLevel, slmAdminCommunity=slmAdminCommunity, slmTrapEnable=slmTrapEnable, slmAuthEntry=slmAuthEntry, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminPassword=slmAdminPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserLogin=slmTrapUserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogId=slmTrapLogId, slmSwRevStatus=slmSwRevStatus, slmLicenseTable=slmLicenseTable, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmConfigSysUptime=slmConfigSysUptime, slmChPass=slmChPass, slmAuthCommunity=slmAuthCommunity, slmTrapUserAccess=slmTrapUserAccess, slmLicenseIndex=slmLicenseIndex, slmSysLanIpAddr=slmSysLanIpAddr, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPmAvailable=slmPmAvailable, slmLicenseExpiration=slmLicenseExpiration, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicense=slmLicense, slMain=slMain, slmSysTrapFormat=slmSysTrapFormat, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmSwRevTable=slmSwRevTable, slmSysUplinkRate=slmSysUplinkRate, slmChPassEntry=slmChPassEntry, slm40GConf=slm40GConf, slmTid=slmTid, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTopologyEnabled=slmTopologyEnabled, slmReadCommunity=slmReadCommunity, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, slmTrapLogName=slmTrapLogName, UserLogin=UserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmSysName=slmSysName, slmAdminTable=slmAdminTable, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysChassisId=slmSysChassisId, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthLogin=slmAuthLogin, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTable=slmTrapLogTable, slmSyslogDestAddress=slmSyslogDestAddress, UserPassword=UserPassword, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmPsuNumber=slmPsuNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysOperStatus=slmSysOperStatus, slmSwRevName=slmSwRevName, slmVcatDelay=slmVcatDelay, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmSysMode=slmSysMode, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminLogin=slmAdminLogin, slmSysLocation=slmSysLocation, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmAuth=slmAuth, slmLogFile=slmLogFile, slmLogin=slmLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmTrapLogParam4=slmTrapLogParam4)
