...
Opaque, Unsigned32, Integer32, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, ObjectIdentity, TimeTicks, MibIdentifier, Counter64, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Unsigned32", "Integer32", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter64", "IpAddress", "ModuleIdentity")
DateAndTime, TimeStamp, TruthValue, RowStatus, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmTid=slmTid, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmSyslogLevel=slmSyslogLevel, slmSwRevStatus=slmSwRevStatus, slmConfigFile=slmConfigFile, slmSysTemperature=slmSysTemperature, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminLogin=slmAdminLogin, slmLicense=slmLicense, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmSysName=slmSysName, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmDeact=slmSysAlmDeact, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam4=slmTrapLogParam4, slmOemType=slmOemType, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmLicenseExpiration=slmLicenseExpiration, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrap=slmTrap, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmSysAlmAct=slmSysAlmAct, slmChPass=slmChPass, slmWriteCommunity=slmWriteCommunity, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess, UserLogin=UserLogin, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmPmAvailable=slmPmAvailable, slmPortsNumber=slmPortsNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestAddress=slmSyslogDestAddress, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminAccess=slmAdminAccess, SoftwareRevision=SoftwareRevision, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmChPassEntry=slmChPassEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapPort=slmTrapPort, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminTable=slmAdminTable, slmTrapLogEntry=slmTrapLogEntry, slmAuthCommunity=slmAuthCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminEntry=slmAdminEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmChPassLogin=slmChPassLogin, slmSysLocation=slmSysLocation, slmSysCalendarTime=slmSysCalendarTime, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmTrapLogName=slmTrapLogName, UserCommunity=UserCommunity, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapEnable=slmTrapEnable, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmAdmin=slmAdmin, slmAuthEntry=slmAuthEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmSyslogPort=slmSyslogPort, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDate=slmSwRevDate)
