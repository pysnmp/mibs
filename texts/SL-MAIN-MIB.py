...
Bits, MibIdentifier, Integer32, Gauge32, iso, Counter32, Unsigned32, Opaque, TimeTicks, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Integer32", "Gauge32", "iso", "Counter32", "Unsigned32", "Opaque", "TimeTicks", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, AdminAccess=AdminAccess, slmChPass=slmChPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmBoxSize=slmBoxSize, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmTrapDestAddress=slmTrapDestAddress, slmAuthCommunity=slmAuthCommunity, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, slmTrapUserLogin=slmTrapUserLogin, slmAdminEntry=slmAdminEntry, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmConfigFile=slmConfigFile, slmNetworkMode=slmNetworkMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmAuth=slmAuth, slmTrapDestEntry=slmTrapDestEntry, slmChPassNewPass=slmChPassNewPass, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmChPassLogin=slmChPassLogin, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slMain=slMain, slmTrapLogName=slmTrapLogName, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapEnable=slmTrapEnable, slmSysTrapFormat=slmSysTrapFormat, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmSysTemperature=slmSysTemperature, slmRebootDelay=slmRebootDelay, slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevDirectory=slmSwRevDirectory, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam6=slmTrapLogParam6, slmOemType=slmOemType, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmTrapLogTable=slmTrapLogTable, slmSysResetPm=slmSysResetPm, slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmSysChassisId=slmSysChassisId, slmAdminCommunity=slmAdminCommunity, slmWriteCommunity=slmWriteCommunity, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysName=slmSysName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmSyslogLevel=slmSyslogLevel, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmAdminTable=slmAdminTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, slmReadCommunity=slmReadCommunity, slmTid=slmTid, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmAdminPassword=slmAdminPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmChPassEntry=slmChPassEntry)
