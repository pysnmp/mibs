...
ObjectIdentity, Unsigned32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Opaque, Integer32, ModuleIdentity, IpAddress, Bits, MibIdentifier, NotificationType, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Opaque", "Integer32", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmVcatDelay=slmVcatDelay, slmAuthCommunity=slmAuthCommunity, slmChPassLogin=slmChPassLogin, slmTrap=slmTrap, slmSwRevDate=slmSwRevDate, slmSysName=slmSysName, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmLicenseTable=slmLicenseTable, slmTrapLogName=slmTrapLogName, slmSysTrapFormat=slmSysTrapFormat, UserLogin=UserLogin, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmSysMode=slmSysMode, slmAdminTable=slmAdminTable, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmSwRevTable=slmSwRevTable, slmAuthTable=slmAuthTable, slmSyslogLevel=slmSyslogLevel, slmAdminAccess=slmAdminAccess, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Priv=slmSnmpv3Priv, slmOpticalSwitchExist=slmOpticalSwitchExist, slmWriteCommunity=slmWriteCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestAddress=slmTrapDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigFile=slmConfigFile, slmNetworkMode=slmNetworkMode, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam4=slmTrapLogParam4, PYSNMP_MODULE_ID=slMain, slmAdminCommunity=slmAdminCommunity, slmOemType=slmOemType, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, UserCommunity=UserCommunity, slmLicenseIndex=slmLicenseIndex, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam5=slmTrapLogParam5, slmAdminLogin=slmAdminLogin, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrapLogEntry=slmTrapLogEntry, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmPortsNumber=slmPortsNumber, slmSysLocation=slmSysLocation, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmPsuNumber=slmPsuNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmTid=slmTid, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassOldPass=slmChPassOldPass, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmTrapLogParam2=slmTrapLogParam2, slmTrapPort=slmTrapPort, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmLogin=slmLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmAdminPassword=slmAdminPassword, slmSwRevEntry=slmSwRevEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapEnable=slmTrapEnable)
