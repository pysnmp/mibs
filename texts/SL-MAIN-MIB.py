...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminCommunity=slmAdminCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmAct=slmSysAlmAct, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmAdminRowStatus=slmAdminRowStatus, slmTrap=slmTrap, slmConfigSysUptime=slmConfigSysUptime, UserPassword=UserPassword, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam5=slmTrapLogParam5, slmSysTrapFormat=slmSysTrapFormat, slmSwRevName=slmSwRevName, slmPmAvailable=slmPmAvailable, slmSysSubnetMask=slmSysSubnetMask, slmAuthPassword=slmAuthPassword, slmTopologyEnabled=slmTopologyEnabled, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, slmChPassEntry=slmChPassEntry, slmChPassOldPass=slmChPassOldPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSysGatewayAddr=slmSysGatewayAddr, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmAuthCommunity=slmAuthCommunity, slmTrapCommunity=slmTrapCommunity, slmLogin=slmLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmRebootDelay=slmRebootDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthTable=slmAuthTable, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserLogin=slmTrapUserLogin, slmAdminLogin=slmAdminLogin, SoftwareRevision=SoftwareRevision, slmLogFile=slmLogFile, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogId=slmTrapLogId, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthEntry=slmAuthEntry, slmMuxNumber=slmMuxNumber, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuth=slmAuth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmWriteCommunity=slmWriteCommunity, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestEntry=slmTrapDestEntry, slmSysTemperature=slmSysTemperature, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSys=slmSys, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmSysMode=slmSysMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapPort=slmTrapPort, slmTid=slmTid, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmAdminTable=slmAdminTable, slm40GConf=slm40GConf, slmChPassLogin=slmChPassLogin, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigFile=slmConfigFile, slmAuthLogin=slmAuthLogin, slmLicenseId=slmLicenseId, slmTrapLogParam2=slmTrapLogParam2)
