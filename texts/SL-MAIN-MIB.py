...
Counter64, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Unsigned32, Bits, Gauge32, Opaque, Integer32, NotificationType, MibIdentifier, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Unsigned32", "Bits", "Gauge32", "Opaque", "Integer32", "NotificationType", "MibIdentifier", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTemperature=slmSysTemperature, slmSwRevDate=slmSwRevDate, slmRebootDelay=slmRebootDelay, slmSwRevName=slmSwRevName, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmTrapLogParam5=slmTrapLogParam5, slmAdminRowStatus=slmAdminRowStatus, slmSysMode=slmSysMode, slmLogFile=slmLogFile, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPmAvailable=slmPmAvailable, slmAuthLogin=slmAuthLogin, slmTrapUserAccess=slmTrapUserAccess, slmSwRevTable=slmSwRevTable, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysChassisId=slmSysChassisId, slmOemType=slmOemType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapEnable=slmTrapEnable, slmAuth=slmAuth, slmSys=slmSys, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTable=slmTrapLogTable, slmSysCalendarTime=slmSysCalendarTime, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, UserCommunity=UserCommunity, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slmSysTrapFormat=slmSysTrapFormat, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassTable=slmChPassTable, slmTrapLogParam1=slmTrapLogParam1, slmLicenseIndex=slmLicenseIndex, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmLicense=slmLicense, slmPsuNumber=slmPsuNumber, slmAdmin=slmAdmin, slmTrapLogName=slmTrapLogName, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, PYSNMP_MODULE_ID=slMain, slMain=slMain, slmAuthEntry=slmAuthEntry, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmSysResetPm=slmSysResetPm, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmBoxSize=slmBoxSize, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmTrap=slmTrap, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmAdminTable=slmAdminTable, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevEntry=slmSwRevEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slmTopologyEnabled=slmTopologyEnabled, slmEdfaNumber=slmEdfaNumber, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmTid=slmTid, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam2=slmTrapLogParam2, slmLicenseEntry=slmLicenseEntry, slmChPassLogin=slmChPassLogin, slmTrapLogEntry=slmTrapLogEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmTrapLogParam4=slmTrapLogParam4, slmChPass=slmChPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, UserPassword=UserPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAlmDeact=slmSysAlmDeact)
