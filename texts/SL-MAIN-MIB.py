...
Integer32, TimeTicks, ObjectIdentity, Bits, Opaque, IpAddress, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Gauge32, Counter64, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "ObjectIdentity", "Bits", "Opaque", "IpAddress", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Gauge32", "Counter64", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysIpAddr=slmSysIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmPsuNumber=slmPsuNumber, slmTrapLogParam2=slmTrapLogParam2, slmSwRevTable=slmSwRevTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAlmDeact=slmSysAlmDeact, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevName=slmSwRevName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmRebootDelay=slmRebootDelay, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserLogin=slmTrapUserLogin, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmTrapLogName=slmTrapLogName, slmAuthCommunity=slmAuthCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmWriteCommunity=slmWriteCommunity, slMain=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDate=slmSwRevDate, slmSysAlmAct=slmSysAlmAct, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminTable=slmAdminTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam1=slmTrapLogParam1, slmAuthLogin=slmAuthLogin, slmPmAvailable=slmPmAvailable, slmSnmpv3Password=slmSnmpv3Password, slmAdmin=slmAdmin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminPassword=slmAdminPassword, slmLicense=slmLicense, slmTrapUserAccess=slmTrapUserAccess, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, PYSNMP_MODULE_ID=slMain, slmTrap=slmTrap, slmTrapDestTable=slmTrapDestTable, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysResetPm=slmSysResetPm, slmLogFile=slmLogFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmSysCalendarTime=slmSysCalendarTime, slmBoxSize=slmBoxSize, slmConfigSysUptime=slmConfigSysUptime, slmConfigFile=slmConfigFile, slmChPass=slmChPass, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmAuthTable=slmAuthTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmTrapCommunity=slmTrapCommunity, slmAuthEntry=slmAuthEntry, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmChPassEntry=slmChPassEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slm40GConf=slm40GConf, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmSysSubnetMask=slmSysSubnetMask, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmTrapEnable=slmTrapEnable, slmVcatDelay=slmVcatDelay, UserLogin=UserLogin, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmLicenseEntry=slmLicenseEntry, slmPortsNumber=slmPortsNumber, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, SoftwareRevision=SoftwareRevision, slmChPassOldPass=slmChPassOldPass, AdminAccess=AdminAccess, slmSysLocation=slmSysLocation, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Auth=slmSnmpv3Auth)
