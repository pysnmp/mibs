...
ObjectIdentity, Opaque, NotificationType, Counter32, IpAddress, ModuleIdentity, Gauge32, Unsigned32, MibIdentifier, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Opaque", "NotificationType", "Counter32", "IpAddress", "ModuleIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam5=slmTrapLogParam5, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysUptime=slmConfigSysUptime, slmChPassLogin=slmChPassLogin, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmLicenseExpiration=slmLicenseExpiration, slmChPassNewPass=slmChPassNewPass, UserCommunity=UserCommunity, slmSwRevStatus=slmSwRevStatus, slmLicenseId=slmLicenseId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, slmRstpEnabled=slmRstpEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmAdminCommunity=slmAdminCommunity, slmChPass=slmChPass, slmAdminLogin=slmAdminLogin, slmSyslogPort=slmSyslogPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassTable=slmChPassTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthCommunity=slmAuthCommunity, slmSysOperStatus=slmSysOperStatus, slmAdminPassword=slmAdminPassword, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmSysName=slmSysName, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, slmOemType=slmOemType, slmTrapLogParam2=slmTrapLogParam2, slmChPassEntry=slmChPassEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmTrapDestTable=slmTrapDestTable, slmAdminAccess=slmAdminAccess, slmWriteCommunity=slmWriteCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAdminStatus=slmSysAdminStatus, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmSysMode=slmSysMode, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigFile=slmConfigFile, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, slmSys=slmSys, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmSwRevEntry=slmSwRevEntry, slmAuth=slmAuth, slmLogFile=slmLogFile, slmTid=slmTid, AdminAccess=AdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmTrapUserAccess=slmTrapUserAccess, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminTable=slmAdminTable, slmPmAvailable=slmPmAvailable, slmTrapDestCommunity=slmTrapDestCommunity, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmAdmin=slmAdmin, slmTrapLogId=slmTrapLogId, slmRebootDelay=slmRebootDelay, slmTrapUserLogin=slmTrapUserLogin, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmAuthEntry=slmAuthEntry)
