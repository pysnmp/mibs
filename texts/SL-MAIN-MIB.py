...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrap=slmTrap, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slmOemType=slmOemType, slmTrapSysNameChange=slmTrapSysNameChange, UserLogin=UserLogin, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseEntry=slmLicenseEntry, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysTrapFormat=slmSysTrapFormat, slmLicenseExpiration=slmLicenseExpiration, slmAdminRowStatus=slmAdminRowStatus, slmTid=slmTid, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmTrapLogEntry=slmTrapLogEntry, slmConfigFile=slmConfigFile, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysOperStatus=slmSysOperStatus, slmSyslogLevel=slmSyslogLevel, slmSysCalendarTime=slmSysCalendarTime, slmAdmin=slmAdmin, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmPsuNumber=slmPsuNumber, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmSwRevDirectory=slmSwRevDirectory, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmNetworkMode=slmNetworkMode, slmSysUplinkRate=slmSysUplinkRate, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmSwRevName=slmSwRevName, AdminAccess=AdminAccess, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmVcatDelay=slmVcatDelay, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevEntry=slmSwRevEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmSysResetPm=slmSysResetPm, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapPort=slmTrapPort, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmLogFile=slmLogFile, slmTrapEnable=slmTrapEnable, slmTrapDestEntry=slmTrapDestEntry, slmAdminLogin=slmAdminLogin, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, PYSNMP_MODULE_ID=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminEntry=slmAdminEntry, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmAuthCommunity=slmAuthCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmTrapLogParam4=slmTrapLogParam4, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmAuth=slmAuth, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmPortsNumber=slmPortsNumber, slmRebootDelay=slmRebootDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmLogin=slmLogin)
