...
Counter64, ModuleIdentity, Gauge32, Unsigned32, ObjectIdentity, Bits, Integer32, Counter32, Opaque, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Gauge32", "Unsigned32", "ObjectIdentity", "Bits", "Integer32", "Counter32", "Opaque", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Priv=slmSnmpv3Priv, PYSNMP_MODULE_ID=slMain, slmSysName=slmSysName, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmTrapDestEntry=slmTrapDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmAdminRowStatus=slmAdminRowStatus, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOemType=slmOemType, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmDeact=slmSysAlmDeact, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDirectory=slmSwRevDirectory, slmRstpEnabled=slmRstpEnabled, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmLicenseId=slmLicenseId, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam2=slmTrapLogParam2, slmAuthEntry=slmAuthEntry, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassTable=slmChPassTable, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, slmSysUplinkRate=slmSysUplinkRate, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slMain=slMain, slmTrapLogName=slmTrapLogName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmSysIpAddr=slmSysIpAddr, slmAuthLogin=slmAuthLogin, slmTid=slmTid, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapPort=slmTrapPort, slmSysTrapFormat=slmSysTrapFormat, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestTable=slmTrapDestTable, slmChPassOldPass=slmChPassOldPass, slmSwRevEntry=slmSwRevEntry, slmAdmin=slmAdmin, slmAdminLogin=slmAdminLogin, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmBoxSize=slmBoxSize, slmAdminPassword=slmAdminPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmSwRevDate=slmSwRevDate, slmLicenseTable=slmLicenseTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminEntry=slmAdminEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmAdminTable=slmAdminTable, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapCommunity=slmTrapCommunity, slmLicenseIndex=slmLicenseIndex, slmAdminCommunity=slmAdminCommunity, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, slmSysResetPm=slmSysResetPm, slmSysOperStatus=slmSysOperStatus, UserCommunity=UserCommunity)
