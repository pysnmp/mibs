...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserCommunity=UserCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slm40GConf=slm40GConf, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysAdminStatus=slmSysAdminStatus, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPsuNumber=slmPsuNumber, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmChPass=slmChPass, PYSNMP_MODULE_ID=slMain, slmTrap=slmTrap, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevTable=slmSwRevTable, slmSyslogPort=slmSyslogPort, slmAuthPassword=slmAuthPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysResetPm=slmSysResetPm, slmLicenseIndex=slmLicenseIndex, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmSysAlmAct=slmSysAlmAct, slmEdfaNumber=slmEdfaNumber, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, slmNetworkMode=slmNetworkMode, slMain=slMain, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRebootDelay=slmRebootDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLocation=slmSysLocation, slmAdminPassword=slmAdminPassword, slmTid=slmTid, slmAuth=slmAuth, slmAdminTable=slmAdminTable, slmTrapLogEntry=slmTrapLogEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmSwRevDirectory=slmSwRevDirectory, slmSwRevName=slmSwRevName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmSnmpv3Password=slmSnmpv3Password, slmAuthCommunity=slmAuthCommunity, slmVcatDelay=slmVcatDelay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmChPassEntry=slmChPassEntry, slmAuthTable=slmAuthTable, slmSysTrapFormat=slmSysTrapFormat, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogId=slmTrapLogId, slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, slmConfigFile=slmConfigFile, slmLicenseEntry=slmLicenseEntry, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmWriteCommunity=slmWriteCommunity, slmRstpEnabled=slmRstpEnabled, slmLicense=slmLicense, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysMode=slmSysMode, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanIpAddr=slmSysLanIpAddr)
