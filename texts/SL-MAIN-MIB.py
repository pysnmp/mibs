...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysResetPm=slmSysResetPm, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapPort=slmTrapPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysChassisId=slmSysChassisId, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogTimeStamp=slmTrapLogTimeStamp, PYSNMP_MODULE_ID=slMain, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmBoxSize=slmBoxSize, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmAdminEntry=slmAdminEntry, slmChPassOldPass=slmChPassOldPass, slmChPass=slmChPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDate=slmSwRevDate, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, slmTrapDestTable=slmTrapDestTable, slm40GConf=slm40GConf, slmSyslogPort=slmSyslogPort, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmLogin=slmLogin, slmLogFile=slmLogFile, slmSysOperStatus=slmSysOperStatus, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmChPassTable=slmChPassTable, slmAdmin=slmAdmin, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmLicenseEntry=slmLicenseEntry, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmTid=slmTid, slmTrapDestEntry=slmTrapDestEntry, slmSysName=slmSysName, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, UserPassword=UserPassword, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthTable=slmAuthTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthPassword=slmAuthPassword, slmSysIpAddr=slmSysIpAddr, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmTrap=slmTrap, UserCommunity=UserCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmSysSubnetMask=slmSysSubnetMask, slmAdminTable=slmAdminTable, slmSysLocation=slmSysLocation, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogId=slmTrapLogId, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogLevel=slmSyslogLevel, slmPsuNumber=slmPsuNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevName=slmSwRevName, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmSwRevTable=slmSwRevTable, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmLicenseId=slmLicenseId, slMain=slMain, slmSysAlmDeact=slmSysAlmDeact, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory)
