...
Bits, IpAddress, MibIdentifier, TimeTicks, Unsigned32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Opaque, Gauge32, Counter64, iso, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "Unsigned32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Opaque", "Gauge32", "Counter64", "iso", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmBoxSize=slmBoxSize, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogId=slmTrapLogId, slmChPassNewPass=slmChPassNewPass, UserCommunity=UserCommunity, slmLicenseEntry=slmLicenseEntry, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmTrapLogName=slmTrapLogName, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogLevel=slmSyslogLevel, slm40GConf=slm40GConf, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, AdminAccess=AdminAccess, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmAuthEntry=slmAuthEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmWriteCommunity=slmWriteCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestAddress=slmTrapDestAddress, slmTrapPort=slmTrapPort, slmSwRevEntry=slmSwRevEntry, slmSysIpAddr=slmSysIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPass=slmChPass, slmAdminEntry=slmAdminEntry, slmPsuNumber=slmPsuNumber, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestTable=slmSyslogDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmSwRevStatus=slmSwRevStatus, slmLicenseTable=slmLicenseTable, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmSysResetPm=slmSysResetPm, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmAuth=slmAuth, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmSwRevName=slmSwRevName, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmNetworkMode=slmNetworkMode, slmSyslogDestRowStatus=slmSyslogDestRowStatus, PYSNMP_MODULE_ID=slMain, slmLicenseIndex=slmLicenseIndex, slmTrapCommunity=slmTrapCommunity, slmChPassOldPass=slmChPassOldPass, slmPortsNumber=slmPortsNumber, slmTrapDestTable=slmTrapDestTable, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDate=slmSwRevDate, slmSnmpv3Priv=slmSnmpv3Priv, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogPort=slmSyslogPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slMain=slMain, slmRstpEnabled=slmRstpEnabled)
