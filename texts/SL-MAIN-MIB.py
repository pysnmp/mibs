...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, iso, Opaque, Counter32, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, Gauge32, Bits, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "iso", "Opaque", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "Gauge32", "Bits", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmRebootDelay=slmRebootDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmSyslogLevel=slmSyslogLevel, slmTrapUserLogin=slmTrapUserLogin, slmAuthCommunity=slmAuthCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmWriteCommunity=slmWriteCommunity, slmSyslogPort=slmSyslogPort, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmLogFile=slmLogFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmReadCommunity=slmReadCommunity, UserLogin=UserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSubnetMask=slmSysSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmOemType=slmOemType, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogName=slmTrapLogName, slmSysName=slmSysName, slmPsuNumber=slmPsuNumber, slmAuthTable=slmAuthTable, slmAdminEntry=slmAdminEntry, slmSyslogDestTable=slmSyslogDestTable, slmChPassNewPass=slmChPassNewPass, slmConfigFile=slmConfigFile, slmTrapLogParam5=slmTrapLogParam5, slmBoxSize=slmBoxSize, slmTrapDestProtVersion=slmTrapDestProtVersion, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevStatus=slmSwRevStatus, slmVcatDelay=slmVcatDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, UserPassword=UserPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestEntry=slmTrapDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmRstpEnabled=slmRstpEnabled, slmEdfaNumber=slmEdfaNumber, slm40GConf=slm40GConf, slmLicenseTable=slmLicenseTable, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmTid=slmTid, slmAdminAccess=slmAdminAccess, slmChPass=slmChPass, slmNetworkMode=slmNetworkMode, slmSysLocation=slmSysLocation, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdmin=slmAdmin, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmTrapUserAccess=slmTrapUserAccess, slmAdminLogin=slmAdminLogin, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSys=slmSys, slmTrapLogParam4=slmTrapLogParam4, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmSwRevDate=slmSwRevDate, slmTrapDestTable=slmTrapDestTable, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmLicenseEntry=slmLicenseEntry, slmChPassOldPass=slmChPassOldPass, slmChPassEntry=slmChPassEntry, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmLicense=slmLicense, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigSysUptime=slmConfigSysUptime, slmLicenseId=slmLicenseId, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmSysOperStatus=slmSysOperStatus, slmSysChassisId=slmSysChassisId, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmSysAlmAct=slmSysAlmAct)
