...
Gauge32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Unsigned32, ModuleIdentity, MibIdentifier, Bits, TimeTicks, Counter64, Opaque, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Bits", "TimeTicks", "Counter64", "Opaque", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthEntry=slmAuthEntry, slm40GConf=slm40GConf, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmSysAlmAct=slmSysAlmAct, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassTable=slmChPassTable, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slmChPassOldPass=slmChPassOldPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, UserLogin=UserLogin, slmReadCommunity=slmReadCommunity, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmAdminAccess=slmAdminAccess, SoftwareRevision=SoftwareRevision, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSwRevName=slmSwRevName, slmSwRevTable=slmSwRevTable, slmAuth=slmAuth, slmTrapEnable=slmTrapEnable, slmAdminPassword=slmAdminPassword, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, slMain=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, slmSyslogDestTable=slmSyslogDestTable, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slmTid=slmTid, slmChPassNewPass=slmChPassNewPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogId=slmTrapLogId, slmSwRevStatus=slmSwRevStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmSysResetPm=slmSysResetPm, slmTrapLogEntry=slmTrapLogEntry, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmLicenseTable=slmLicenseTable, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogin=slmLogin, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysMode=slmSysMode, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmVcatDelay=slmVcatDelay, slmRstpEnabled=slmRstpEnabled, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysTrapFormat=slmSysTrapFormat, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmAdmin=slmAdmin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmAdminCommunity=slmAdminCommunity, slmLicenseId=slmLicenseId, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable)
