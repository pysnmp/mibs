...
TimeTicks, Integer32, ObjectIdentity, IpAddress, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Unsigned32, ModuleIdentity, Counter64, MibIdentifier, Counter32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "ObjectIdentity", "IpAddress", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier", "Counter32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam2=slmTrapLogParam2, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDirectory=slmSwRevDirectory, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmSyslogLevel=slmSyslogLevel, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam1=slmTrapLogParam1, slmWriteCommunity=slmWriteCommunity, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassLogin=slmChPassLogin, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmAdminAccess=slmAdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmTrapLogTable=slmTrapLogTable, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmTrapEnable=slmTrapEnable, slmTrapLogEntry=slmTrapLogEntry, slmChPassNewPass=slmChPassNewPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTemperature=slmSysTemperature, AdminAccess=AdminAccess, slmTid=slmTid, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmMuxNumber=slmMuxNumber, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmConfigSysSignalType=slmConfigSysSignalType, slmAuth=slmAuth, slMain=slMain, slmSysResetPm=slmSysResetPm, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam4=slmTrapLogParam4, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserLogin=slmTrapUserLogin, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmRebootDelay=slmRebootDelay, slmAdminRowStatus=slmAdminRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam3=slmTrapLogParam3, slmOemType=slmOemType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmDeact=slmSysAlmDeact, slmSysLocation=slmSysLocation, slmPsuNumber=slmPsuNumber, slmBoxSize=slmBoxSize, slmSys=slmSys, UserCommunity=UserCommunity, slmTrapCommunity=slmTrapCommunity, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, UserLogin=UserLogin, slmChPassEntry=slmChPassEntry, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmSysSnmpVersion=slmSysSnmpVersion, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmReadCommunity=slmReadCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogFile=slmLogFile, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthTable=slmAuthTable, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, slmSysMode=slmSysMode, slmLicenseExpiration=slmLicenseExpiration)
