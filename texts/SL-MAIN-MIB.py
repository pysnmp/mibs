...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, ModuleIdentity, Counter32, Counter64, Bits, iso, NotificationType, Opaque, Integer32, MibIdentifier, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter32", "Counter64", "Bits", "iso", "NotificationType", "Opaque", "Integer32", "MibIdentifier", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmLogin=slmLogin, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmAuthEntry=slmAuthEntry, slmSysChassisId=slmSysChassisId, slmChPassLogin=slmChPassLogin, slmPmAvailable=slmPmAvailable, slmLicenseTable=slmLicenseTable, slmAuth=slmAuth, slmAdminCommunity=slmAdminCommunity, slmConfigFile=slmConfigFile, slmTrapLogParam5=slmTrapLogParam5, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassEntry=slmChPassEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, AdminAccess=AdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, slmPsuNumber=slmPsuNumber, slmAdminRowStatus=slmAdminRowStatus, slmSys=slmSys, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysLocationChange=slmTrapSysLocationChange, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthTable=slmAuthTable, slmTrapLogParam2=slmTrapLogParam2, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam4=slmTrapLogParam4, slmAuthPassword=slmAuthPassword, slmTrapCommunity=slmTrapCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmAdminPassword=slmAdminPassword, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slmWriteCommunity=slmWriteCommunity, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmChPass=slmChPass, slmSyslogDestTable=slmSyslogDestTable, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDate=slmSwRevDate, slmLogFile=slmLogFile, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogName=slmTrapLogName, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slMain=slMain, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slm40GConf=slm40GConf, slmSysMode=slmSysMode, slmSysIpAddr=slmSysIpAddr, slmAdminEntry=slmAdminEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseId=slmLicenseId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmSysUplinkRate=slmSysUplinkRate, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmNetworkMode=slmNetworkMode, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, SoftwareRevision=SoftwareRevision, slmSnmpv3Priv=slmSnmpv3Priv, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slmVcatDelay=slmVcatDelay, slmTrapLogTable=slmTrapLogTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity, slmAdminAccess=slmAdminAccess, slmTrapEnable=slmTrapEnable, slmOemType=slmOemType, slmLicenseIndex=slmLicenseIndex)
