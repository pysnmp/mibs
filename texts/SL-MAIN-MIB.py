...
Gauge32, Unsigned32, Counter64, Opaque, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, ModuleIdentity, Bits, NotificationType, ObjectIdentity, IpAddress, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Counter64", "Opaque", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "ModuleIdentity", "Bits", "NotificationType", "ObjectIdentity", "IpAddress", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPortsNumber=slmPortsNumber, slmLicenseTable=slmLicenseTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTable=slmTrapLogTable, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmSnmpv3Priv=slmSnmpv3Priv, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, slmSyslogLevel=slmSyslogLevel, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, SoftwareRevision=SoftwareRevision, slmLicenseEntry=slmLicenseEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slmLicenseIndex=slmLicenseIndex, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmBoxSize=slmBoxSize, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogPort=slmSyslogPort, slmMuxNumber=slmMuxNumber, slmTrapEnable=slmTrapEnable, slmTrapCommunity=slmTrapCommunity, slmSysLocation=slmSysLocation, slmSwRevTable=slmSwRevTable, slmSysAlmDeact=slmSysAlmDeact, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmRebootDelay=slmRebootDelay, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, PYSNMP_MODULE_ID=slMain, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevStatus=slmSwRevStatus, slmSwRevEntry=slmSwRevEntry, slmAdminLogin=slmAdminLogin, slmAdminTable=slmAdminTable, slmTrapDestTable=slmTrapDestTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminPassword=slmAdminPassword, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, UserLogin=UserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmAdminEntry=slmAdminEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmTid=slmTid, slmAuthTable=slmAuthTable, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmPsuNumber=slmPsuNumber, slmTrapLogId=slmTrapLogId, slmChPassOldPass=slmChPassOldPass, slmWriteCommunity=slmWriteCommunity, slmSysUplinkRate=slmSysUplinkRate, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry, slmSysIpAddr=slmSysIpAddr, slmChPassLogin=slmChPassLogin, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam2=slmTrapLogParam2, slmSysSnmpVersion=slmSysSnmpVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseId=slmLicenseId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmSysName=slmSysName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Password=slmSnmpv3Password, slmSysSubnetMask=slmSysSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmAdmin=slmAdmin, slmAuthCommunity=slmAuthCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOemType=slmOemType, slmTrapLogName=slmTrapLogName, slmRstpEnabled=slmRstpEnabled, slmTopologyEnabled=slmTopologyEnabled, slmSys=slmSys, slMain=slMain)
