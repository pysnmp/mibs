...
ModuleIdentity, Opaque, IpAddress, ObjectIdentity, MibIdentifier, Integer32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Bits, TimeTicks, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Opaque", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Bits", "TimeTicks", "NotificationType", "Unsigned32")
TimeStamp, RowStatus, TruthValue, DateAndTime, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "DateAndTime", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmRstpEnabled=slmRstpEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmTrapLogTable=slmTrapLogTable, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slmAdminTable=slmAdminTable, slmTrapPort=slmTrapPort, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSyslogDestEntry=slmSyslogDestEntry, slmPortsNumber=slmPortsNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmSyslogPort=slmSyslogPort, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogName=slmTrapLogName, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestTable=slmTrapDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysPmStartOfDay=slmSysPmStartOfDay, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSysOperStatus=slmSysOperStatus, slmAdminCommunity=slmAdminCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmSysTrapFormat=slmSysTrapFormat, slmReadCommunity=slmReadCommunity, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmAuthEntry=slmAuthEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmVcatDelay=slmVcatDelay, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmAuthLogin=slmAuthLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, AdminAccess=AdminAccess, slmTrapLogParam5=slmTrapLogParam5, UserCommunity=UserCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmOemType=slmOemType, slmChPass=slmChPass, slmSysMode=slmSysMode, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestAddress=slmTrapDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmAuthTable=slmAuthTable, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, slmSwRevTable=slmSwRevTable, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slmSysResetPm=slmSysResetPm, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword)
