...
Unsigned32, ModuleIdentity, NotificationType, iso, Counter32, Opaque, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "NotificationType", "iso", "Counter32", "Opaque", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmMuxNumber=slmMuxNumber, slmTrapEnable=slmTrapEnable, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDate=slmSwRevDate, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmAdminEntry=slmAdminEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestTable=slmSyslogDestTable, slmAdminLogin=slmAdminLogin, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmTrap=slmTrap, slmTrapLogParam3=slmTrapLogParam3, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmAdmin=slmAdmin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigFile=slmConfigFile, UserPassword=UserPassword, slmTrapLogParam2=slmTrapLogParam2, slmRstpEnabled=slmRstpEnabled, slmLicenseIndex=slmLicenseIndex, slmSysIpAddr=slmSysIpAddr, slmAdminPassword=slmAdminPassword, slmSyslogLevel=slmSyslogLevel, slmPsuNumber=slmPsuNumber, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmSwRevTable=slmSwRevTable, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmSwRevName=slmSwRevName, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, SoftwareRevision=SoftwareRevision, slmVcatDelay=slmVcatDelay, slmChPass=slmChPass, slmSysLocation=slmSysLocation, slmPortsNumber=slmPortsNumber, slmTrapDestEntry=slmTrapDestEntry, PYSNMP_MODULE_ID=slMain, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmAct=slmSysAlmAct, slmOpticalSwitchExist=slmOpticalSwitchExist, AdminAccess=AdminAccess, slMain=slMain, slmAuthPassword=slmAuthPassword, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapPort=slmTrapPort, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmPmAvailable=slmPmAvailable, slmChPassOldPass=slmChPassOldPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmReadCommunity=slmReadCommunity, slmTid=slmTid, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseTable=slmLicenseTable, slmLogin=slmLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam1=slmTrapLogParam1, slmAuthTable=slmAuthTable, slmTrapLogId=slmTrapLogId, slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity)
