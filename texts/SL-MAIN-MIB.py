...
ModuleIdentity, Integer32, Opaque, TimeTicks, Unsigned32, iso, NotificationType, Counter32, Counter64, Gauge32, MibIdentifier, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Opaque", "TimeTicks", "Unsigned32", "iso", "NotificationType", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPass=slmChPass, slmAuthCommunity=slmAuthCommunity, slmAdminPassword=slmAdminPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysName=slmSysName, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmChPassOldPass=slmChPassOldPass, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, slmMuxNumber=slmMuxNumber, slmTrapCommunity=slmTrapCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTable=slmTrapLogTable, slmConfigSysUptime=slmConfigSysUptime, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, AdminAccess=AdminAccess, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserAccess=slmTrapUserAccess, slmTrapUserLogin=slmTrapUserLogin, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmSysMode=slmSysMode, slmOemType=slmOemType, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, UserPassword=UserPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam1=slmTrapLogParam1, slMain=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmSysSubnetMask=slmSysSubnetMask, slmChPassNewPass=slmChPassNewPass, slmSysAlmAct=slmSysAlmAct, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmSwRevDate=slmSwRevDate, slmTrapLogName=slmTrapLogName, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slmSyslogLevel=slmSyslogLevel, slmEdfaNumber=slmEdfaNumber, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmAdminLogin=slmAdminLogin, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmSysUplinkRate=slmSysUplinkRate, slmSys=slmSys, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPmAvailable=slmPmAvailable, slmLicense=slmLicense, slmLicenseTable=slmLicenseTable, slmAuthEntry=slmAuthEntry, slmTrapLogParam3=slmTrapLogParam3, slmAuthLogin=slmAuthLogin, slmSyslogPort=slmSyslogPort, slmSysIpAddr=slmSysIpAddr, slmSwRevTable=slmSwRevTable, slmAuth=slmAuth, slmTrapLogEntry=slmTrapLogEntry, slmLicenseId=slmLicenseId, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapEnable=slmTrapEnable, slmSysLocation=slmSysLocation, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthPassword=slmAuthPassword, UserCommunity=UserCommunity, slmSwRevName=slmSwRevName)
