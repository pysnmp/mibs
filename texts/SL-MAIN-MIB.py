...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmPsuNumber=slmPsuNumber, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmLogin=slmLogin, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, slmRebootDelay=slmRebootDelay, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmSysAlmAct=slmSysAlmAct, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPmAvailable=slmPmAvailable, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmChPassEntry=slmChPassEntry, slmSyslogDestTable=slmSyslogDestTable, slmAuthPassword=slmAuthPassword, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassOldPass=slmChPassOldPass, slmLicenseTable=slmLicenseTable, slmSysLocation=slmSysLocation, slmEdfaNumber=slmEdfaNumber, slMain=slMain, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmNetworkMode=slmNetworkMode, slmSysName=slmSysName, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, UserLogin=UserLogin, slmTrapLogParam1=slmTrapLogParam1, slmLicenseIndex=slmLicenseIndex, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmTrap=slmTrap, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmWriteCommunity=slmWriteCommunity, slmAdminPassword=slmAdminPassword, slmAdminLogin=slmAdminLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassLogin=slmChPassLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, AdminAccess=AdminAccess, slmAdmin=slmAdmin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthCommunity=slmAuthCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapCommunity=slmTrapCommunity, slmAdminRowStatus=slmAdminRowStatus, slmAdminAccess=slmAdminAccess, slmSysMode=slmSysMode, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogEntry=slmTrapLogEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseExpiration=slmLicenseExpiration, slmSysOperStatus=slmSysOperStatus, slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmMuxNumber=slmMuxNumber, slmAuth=slmAuth, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogId=slmTrapLogId, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slm40GConf=slm40GConf, slmTrapUserAccess=slmTrapUserAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmTrapLogParam5=slmTrapLogParam5, slmChPassTable=slmChPassTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmTopologyEnabled=slmTopologyEnabled, slmSysCalendarTime=slmSysCalendarTime, slmSyslogLevel=slmSyslogLevel, slmSysIpAddr=slmSysIpAddr, slmLicenseEntry=slmLicenseEntry, slmLogFile=slmLogFile, PYSNMP_MODULE_ID=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminEntry=slmAdminEntry)
