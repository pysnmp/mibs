...
NotificationType, Unsigned32, ObjectIdentity, TimeTicks, Integer32, Gauge32, IpAddress, Opaque, iso, Bits, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "ObjectIdentity", "TimeTicks", "Integer32", "Gauge32", "IpAddress", "Opaque", "iso", "Bits", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevStatus=slmSwRevStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmOemType=slmOemType, slmSysResetPm=slmSysResetPm, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmSysMode=slmSysMode, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogTable=slmTrapLogTable, slmSysLocation=slmSysLocation, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmWriteCommunity=slmWriteCommunity, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmTrapUserLogin=slmTrapUserLogin, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slm40GConf=slm40GConf, slmSysName=slmSysName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRebootDelay=slmRebootDelay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogId=slmTrapLogId, slmTrapLogName=slmTrapLogName, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPass=slmChPass, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmAdminCommunity=slmAdminCommunity, SoftwareRevision=SoftwareRevision, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicense=slmLicense, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmAdminTable=slmAdminTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassEntry=slmChPassEntry, slmNetworkMode=slmNetworkMode, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slMain=slMain, slmTrapLogParam2=slmTrapLogParam2, UserPassword=UserPassword, slmTid=slmTid, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmLicenseIndex=slmLicenseIndex, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevName=slmSwRevName, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, UserCommunity=UserCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmAdmin=slmAdmin, slmLicenseTable=slmLicenseTable, slmReadCommunity=slmReadCommunity, slmAuth=slmAuth, slmPsuNumber=slmPsuNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmLicenseExpiration=slmLicenseExpiration, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthTable=slmAuthTable, slmTrapDestTable=slmTrapDestTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, UserLogin=UserLogin, slmSysOperStatus=slmSysOperStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmSwRevDate=slmSwRevDate, slmSys=slmSys, slmLicenseId=slmLicenseId, slmSysSnmpVersion=slmSysSnmpVersion, slmLogin=slmLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus)
