...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysName=slmSysName, slmSysResetPm=slmSysResetPm, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogName=slmTrapLogName, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmAdminAccess=slmAdminAccess, slmTrapLogId=slmTrapLogId, slmTid=slmTid, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmSysAlmDeact=slmSysAlmDeact, slmRebootDelay=slmRebootDelay, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevEntry=slmSwRevEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmTrapDestTable=slmTrapDestTable, slmSys=slmSys, slmReadCommunity=slmReadCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthLogin=slmAuthLogin, slmAuthTable=slmAuthTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmMuxNumber=slmMuxNumber, slmSyslogDestEntry=slmSyslogDestEntry, UserCommunity=UserCommunity, slmSysLocation=slmSysLocation, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmOemType=slmOemType, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmTrap=slmTrap, slmChPassTable=slmChPassTable, slmLogFile=slmLogFile, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmAuth=slmAuth, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmAdminPassword=slmAdminPassword, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminLogin=slmAdminLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogPort=slmSyslogPort, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogTable=slmTrapLogTable, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmSwRevDate=slmSwRevDate, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmAuthCommunity=slmAuthCommunity, slmPortsNumber=slmPortsNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSysMode=slmSysMode, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmNetworkMode=slmNetworkMode, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevTable=slmSwRevTable, slmTrapLogParam1=slmTrapLogParam1)
