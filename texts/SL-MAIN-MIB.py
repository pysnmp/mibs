...
Gauge32, NotificationType, ObjectIdentity, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Opaque, TimeTicks, Bits, Unsigned32, IpAddress, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Opaque", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "Integer32", "iso", "MibIdentifier")
RowStatus, DisplayString, DateAndTime, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "DateAndTime", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmSysUplinkRate=slmSysUplinkRate, slmLogFile=slmLogFile, slmSwRevDate=slmSwRevDate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmAuth=slmAuth, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slmSnmpv3Password=slmSnmpv3Password, slmAdminRowStatus=slmAdminRowStatus, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmPortsNumber=slmPortsNumber, slmSwRevDirectory=slmSwRevDirectory, slmVcatDelay=slmVcatDelay, slmSysLanIpAddr=slmSysLanIpAddr, slmMuxNumber=slmMuxNumber, slmBoxSize=slmBoxSize, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLocation=slmSysLocation, slmLicense=slmLicense, slmAdminPassword=slmAdminPassword, slmTrapLogParam5=slmTrapLogParam5, slmLicenseTable=slmLicenseTable, slmTrapLogEntry=slmTrapLogEntry, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserLogin=slmTrapUserLogin, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogPort=slmSyslogPort, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmTid=slmTid, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmTopologyEnabled=slmTopologyEnabled, slMain=slMain, slmTrapLogId=slmTrapLogId, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, AdminAccess=AdminAccess, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, slmSysAlmAct=slmSysAlmAct, PYSNMP_MODULE_ID=slMain, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmAuthLogin=slmAuthLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmWriteCommunity=slmWriteCommunity, slmAdminTable=slmAdminTable, slmSysSubnetMask=slmSysSubnetMask, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysChassisId=slmSysChassisId, slmLicenseId=slmLicenseId, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassLogin=slmChPassLogin)
