...
NotificationType, Counter32, Counter64, IpAddress, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, TimeTicks, iso, Opaque, Unsigned32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "IpAddress", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "iso", "Opaque", "Unsigned32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, slmAuth=slmAuth, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmRstpEnabled=slmRstpEnabled, slmAdminAccess=slmAdminAccess, slmBoxSize=slmBoxSize, slmChPassTable=slmChPassTable, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam4=slmTrapLogParam4, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmSysName=slmSysName, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam1=slmTrapLogParam1, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmRebootDelay=slmRebootDelay, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmNetworkMode=slmNetworkMode, UserPassword=UserPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysMode=slmSysMode, slmSysAdminStatus=slmSysAdminStatus, slmConfigFile=slmConfigFile, slmLicenseId=slmLicenseId, slmLicense=slmLicense, UserCommunity=UserCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmChPassOldPass=slmChPassOldPass, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogPort=slmSyslogPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogLevel=slmSyslogLevel, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmAdminPassword=slmAdminPassword, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSysIpAddr=slmSysIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysCalendarTime=slmSysCalendarTime, slmSwRevEntry=slmSwRevEntry, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmSysChassisId=slmSysChassisId, slmSysResetPm=slmSysResetPm, slmSwRevTable=slmSwRevTable, slMain=slMain, slmTrapPort=slmTrapPort, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmOemType=slmOemType, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthPassword=slmAuthPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmAuthEntry=slmAuthEntry, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLocation=slmSysLocation, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseIndex=slmLicenseIndex, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmSys=slmSys, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass)
