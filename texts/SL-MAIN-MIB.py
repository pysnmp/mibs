...
Bits, Counter64, iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, ModuleIdentity, Opaque, MibIdentifier, Unsigned32, Integer32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Opaque", "MibIdentifier", "Unsigned32", "Integer32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, AdminAccess=AdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmLicense=slmLicense, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmTid=slmTid, slmTrapLogParam1=slmTrapLogParam1, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogName=slmTrapLogName, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapEnable=slmTrapEnable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSwRevEntry=slmSwRevEntry, slmPsuNumber=slmPsuNumber, slmSyslogDestTable=slmSyslogDestTable, slmRebootDelay=slmRebootDelay, slmSysTrapFormat=slmSysTrapFormat, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmAdmin=slmAdmin, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Password=slmSnmpv3Password, slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthLogin=slmAuthLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmMuxNumber=slmMuxNumber, slmSysOperStatus=slmSysOperStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmSysUplinkRate=slmSysUplinkRate, slmBoxSize=slmBoxSize, slmSysAlmAct=slmSysAlmAct, slmTrapPort=slmTrapPort, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseId=slmLicenseId, PYSNMP_MODULE_ID=slMain, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmLogFile=slmLogFile, slmOemType=slmOemType, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmAuthPassword=slmAuthPassword, slmSysName=slmSysName, SoftwareRevision=SoftwareRevision, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassTable=slmChPassTable, slmSysIpAddr=slmSysIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserLogin=slmTrapUserLogin, slmRstpEnabled=slmRstpEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminAccess=slmAdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, slmAdminLogin=slmAdminLogin, slmTrapUserAccess=slmTrapUserAccess, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogLevel=slmSyslogLevel, slmLicenseIndex=slmLicenseIndex, slMain=slMain, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysLanIpAddr=slmSysLanIpAddr, slmVcatDelay=slmVcatDelay, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmPmAvailable=slmPmAvailable, slmChPassOldPass=slmChPassOldPass, slmNetworkMode=slmNetworkMode, slmTrapCommunity=slmTrapCommunity, slmAdminEntry=slmAdminEntry, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr)
