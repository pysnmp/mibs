...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam6=slmTrapLogParam6, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthTable=slmAuthTable, slmChPassTable=slmChPassTable, slmWriteCommunity=slmWriteCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminEntry=slmAdminEntry, slmLogin=slmLogin, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmSysTemperature=slmSysTemperature, slMain=slMain, slmReadCommunity=slmReadCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, PYSNMP_MODULE_ID=slMain, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTid=slmTid, slmTrapCommunity=slmTrapCommunity, slmChPass=slmChPass, slmTrapLogParam1=slmTrapLogParam1, slmAdminPassword=slmAdminPassword, slmSwRevTable=slmSwRevTable, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmTrap=slmTrap, slmTrapLogParam5=slmTrapLogParam5, slmAdminTable=slmAdminTable, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmAuthCommunity=slmAuthCommunity, slmAdminAccess=slmAdminAccess, slmTrapLogTable=slmTrapLogTable, slmOemType=slmOemType, slmSysGatewayAddr=slmSysGatewayAddr, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmSysChassisId=slmSysChassisId, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, SoftwareRevision=SoftwareRevision, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthLogin=slmAuthLogin, slmSwRevEntry=slmSwRevEntry, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmSwRevStatus=slmSwRevStatus, slmSysAlmAct=slmSysAlmAct, slmSys=slmSys, slmPsuNumber=slmPsuNumber, UserPassword=UserPassword, slmTrapLogName=slmTrapLogName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slmTrapPort=slmTrapPort, slmSysUplinkRate=slmSysUplinkRate, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestAddress=slmTrapDestAddress, slmLogFile=slmLogFile, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmSyslogLevel=slmSyslogLevel, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmConfigFile=slmConfigFile, slmSwRevDate=slmSwRevDate, slmEdfaNumber=slmEdfaNumber, AdminAccess=AdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPmAvailable=slmPmAvailable, slmSysCalendarTime=slmSysCalendarTime, slmSysName=slmSysName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserCommunity=UserCommunity)
