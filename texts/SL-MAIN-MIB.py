...
Integer32, Bits, Opaque, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, IpAddress, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Opaque", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "IpAddress", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Unsigned32", "NotificationType")
DisplayString, DateAndTime, TimeStamp, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TimeStamp", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmAuthTable=slmAuthTable, slmSysGatewayAddr=slmSysGatewayAddr, slmLogFile=slmLogFile, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmTrapUserLogin=slmTrapUserLogin, slmAuthCommunity=slmAuthCommunity, slmMuxNumber=slmMuxNumber, slmLicenseExpiration=slmLicenseExpiration, slmSysUplinkRate=slmSysUplinkRate, slmSyslogLevel=slmSyslogLevel, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminPassword=slmAdminPassword, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicense=slmLicense, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmAdmin=slmAdmin, slmTrap=slmTrap, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmAct=slmSysAlmAct, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevEntry=slmSwRevEntry, slmSysMode=slmSysMode, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogPort=slmSyslogPort, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmChPassOldPass=slmChPassOldPass, slmSys=slmSys, slmLicenseId=slmLicenseId, slmConfigFile=slmConfigFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmChPassLogin=slmChPassLogin, slmEdfaNumber=slmEdfaNumber, slmTrapCommunity=slmTrapCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmNetworkMode=slmNetworkMode, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, UserCommunity=UserCommunity, slmChPassTable=slmChPassTable, slmSysOperStatus=slmSysOperStatus, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTopologyEnabled=slmTopologyEnabled, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestAddress=slmSyslogDestAddress, slmRstpEnabled=slmRstpEnabled, slmRebootDelay=slmRebootDelay, slmTrapLogName=slmTrapLogName, slmAdminTable=slmAdminTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmAdminLogin=slmAdminLogin, slmAdminRowStatus=slmAdminRowStatus, slmLicenseTable=slmLicenseTable, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmLogin=slmLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmAdminAccess=slmAdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmReadCommunity=slmReadCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogId=slmTrapLogId, UserLogin=UserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapPort=slmTrapPort, slmSnmpv3Priv=slmSnmpv3Priv, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysName=slmSysName, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmSysTemperature=slmSysTemperature)
