...
ModuleIdentity, ObjectIdentity, NotificationType, Counter32, Opaque, Gauge32, MibIdentifier, Counter64, iso, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter32", "Opaque", "Gauge32", "MibIdentifier", "Counter64", "iso", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmBoxSize=slmBoxSize, slmTid=slmTid, slmTrapLogName=slmTrapLogName, slmEdfaNumber=slmEdfaNumber, slmLicenseEntry=slmLicenseEntry, slmAdminRowStatus=slmAdminRowStatus, slmPmAvailable=slmPmAvailable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogPort=slmSyslogPort, AdminAccess=AdminAccess, slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmPsuNumber=slmPsuNumber, slmAdminPassword=slmAdminPassword, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmSysChassisId=slmSysChassisId, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmSwRevName=slmSwRevName, slmSysSubnetMask=slmSysSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPass=slmChPass, slmAdminTable=slmAdminTable, UserCommunity=UserCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAdminStatus=slmSysAdminStatus, slmConfigFile=slmConfigFile, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPortsNumber=slmPortsNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestTable=slmSyslogDestTable, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmLicenseTable=slmLicenseTable, slmTrapDestEntry=slmTrapDestEntry, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmRebootDelay=slmRebootDelay, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmWriteCommunity=slmWriteCommunity, slmRstpEnabled=slmRstpEnabled, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmTopologyEnabled=slmTopologyEnabled, slmTrap=slmTrap, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, slmSysLocation=slmSysLocation, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmOemType=slmOemType, slmTrapPort=slmTrapPort, slmConfigSysUptime=slmConfigSysUptime, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogId=slmTrapLogId, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, PYSNMP_MODULE_ID=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmAdminAccess=slmAdminAccess, slmLicenseIndex=slmLicenseIndex, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam4=slmTrapLogParam4, SoftwareRevision=SoftwareRevision, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmAuthPassword=slmAuthPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmNetworkMode=slmNetworkMode, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmSysName=slmSysName, slmSwRevStatus=slmSwRevStatus, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask)
