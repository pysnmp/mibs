...
ObjectIdentity, Bits, Unsigned32, iso, ModuleIdentity, MibIdentifier, TimeTicks, Counter64, Integer32, Gauge32, Counter32, Opaque, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Unsigned32", "iso", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter64", "Integer32", "Gauge32", "Counter32", "Opaque", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseIndex=slmLicenseIndex, slmSyslogDestEntry=slmSyslogDestEntry, slmSysMode=slmSysMode, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmLogFile=slmLogFile, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmAdminAccess=slmAdminAccess, slmPmAvailable=slmPmAvailable, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysUptime=slmConfigSysUptime, AdminAccess=AdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, slmWriteCommunity=slmWriteCommunity, slmSysChassisId=slmSysChassisId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseTable=slmLicenseTable, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slMain=slMain, slmTrapLogTable=slmTrapLogTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmChPassNewPass=slmChPassNewPass, slmSwRevStatus=slmSwRevStatus, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmSysOperStatus=slmSysOperStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminCommunity=slmAdminCommunity, slmSysUplinkRate=slmSysUplinkRate, slmEdfaNumber=slmEdfaNumber, slmSysLocation=slmSysLocation, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmBoxSize=slmBoxSize, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmDeact=slmSysAlmDeact, SoftwareRevision=SoftwareRevision, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDate=slmSwRevDate, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmAuthTable=slmAuthTable, slmSysSnmpVersion=slmSysSnmpVersion, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, UserCommunity=UserCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Password=slmSnmpv3Password, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmSyslogPort=slmSyslogPort, slmRebootDelay=slmRebootDelay, slmAdminTable=slmAdminTable, slmRstpEnabled=slmRstpEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmTrap=slmTrap, slm40GConf=slm40GConf, slmLicense=slmLicense, slmChPass=slmChPass, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmAdmin=slmAdmin, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Priv=slmSnmpv3Priv, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseId=slmLicenseId)
