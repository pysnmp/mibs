...
ObjectIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity, Counter64, Gauge32, IpAddress, Bits, NotificationType, iso, Integer32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity", "Counter64", "Gauge32", "IpAddress", "Bits", "NotificationType", "iso", "Integer32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPass=slmChPass, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, UserLogin=UserLogin, slmAdminAccess=slmAdminAccess, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmAuthEntry=slmAuthEntry, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmNetworkMode=slmNetworkMode, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmChPassOldPass=slmChPassOldPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmChPassLogin=slmChPassLogin, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRebootDelay=slmRebootDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam4=slmTrapLogParam4, slmAdminTable=slmAdminTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, slmSysIpAddr=slmSysIpAddr, slmRstpEnabled=slmRstpEnabled, SoftwareRevision=SoftwareRevision, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDate=slmSwRevDate, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity, slmSys=slmSys, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmLicense=slmLicense, slmTrapLogId=slmTrapLogId, slmSysSnmpVersion=slmSysSnmpVersion, slmSysOperStatus=slmSysOperStatus, slmMuxNumber=slmMuxNumber, slmSysUplinkRate=slmSysUplinkRate, slmAuthPassword=slmAuthPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmConfigFile=slmConfigFile, slmTrapDestProtVersion=slmTrapDestProtVersion, AdminAccess=AdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTid=slmTid, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmTrapDestTable=slmTrapDestTable, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLocation=slmSysLocation, slmAuth=slmAuth, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapCommunity=slmTrapCommunity, slmAdminEntry=slmAdminEntry, slmPortsNumber=slmPortsNumber, slmPmAvailable=slmPmAvailable, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmBoxSize=slmBoxSize, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevName=slmSwRevName, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable)
