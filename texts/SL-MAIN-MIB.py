...
Opaque, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Unsigned32, Gauge32, iso, Integer32, MibIdentifier, Counter32, TimeTicks, ObjectIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Unsigned32", "Gauge32", "iso", "Integer32", "MibIdentifier", "Counter32", "TimeTicks", "ObjectIdentity", "IpAddress", "Bits")
TruthValue, TimeStamp, DisplayString, DateAndTime, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "DateAndTime", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTemperature=slmSysTemperature, slmTopologyEnabled=slmTopologyEnabled, slmAdminEntry=slmAdminEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, UserCommunity=UserCommunity, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slmAuthTable=slmAuthTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysResetPm=slmSysResetPm, slmLogFile=slmLogFile, slmWriteCommunity=slmWriteCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slm40GConf=slm40GConf, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmRstpEnabled=slmRstpEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, AdminAccess=AdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slMain=slMain, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmSys=slmSys, slmPsuNumber=slmPsuNumber, slmTrapLogTable=slmTrapLogTable, slmTrapUserLogin=slmTrapUserLogin, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmPortsNumber=slmPortsNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmAdminTable=slmAdminTable, slmAuthLogin=slmAuthLogin, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slmTrapDestTable=slmTrapDestTable, slmConfigSysSignalType=slmConfigSysSignalType, SoftwareRevision=SoftwareRevision, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmOemType=slmOemType, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassLogin=slmChPassLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPmAvailable=slmPmAvailable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysName=slmSysName, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam2=slmTrapLogParam2, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slmSysUplinkRate=slmSysUplinkRate, slmSysChassisId=slmSysChassisId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseExpiration=slmLicenseExpiration, slmSysTrapFormat=slmSysTrapFormat, slmVcatDelay=slmVcatDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminPassword=slmAdminPassword, slmSysAlmDeact=slmSysAlmDeact, slmAdminAccess=slmAdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmBoxSize=slmBoxSize, UserPassword=UserPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmTrap=slmTrap, slmLogin=slmLogin, slmAuth=slmAuth, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSwRevEntry=slmSwRevEntry)
