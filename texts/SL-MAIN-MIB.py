...
Counter64, MibIdentifier, IpAddress, Opaque, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Integer32, Counter32, iso, ModuleIdentity, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "IpAddress", "Opaque", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Integer32", "Counter32", "iso", "ModuleIdentity", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogName=slmTrapLogName, slmConfigSysSignalType=slmConfigSysSignalType, UserLogin=UserLogin, slmSwRevStatus=slmSwRevStatus, slmSysLocation=slmSysLocation, slmTrapLogTable=slmTrapLogTable, slmTrapEnable=slmTrapEnable, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysName=slmSysName, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmAct=slmSysAlmAct, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmNetworkMode=slmNetworkMode, slmChPassLogin=slmChPassLogin, slmOemType=slmOemType, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmEdfaNumber=slmEdfaNumber, slmAdminTable=slmAdminTable, slmTrapLogId=slmTrapLogId, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassEntry=slmChPassEntry, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam6=slmTrapLogParam6, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseTable=slmLicenseTable, slmAdmin=slmAdmin, slmSyslogPort=slmSyslogPort, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestTable=slmSyslogDestTable, slmSysMode=slmSysMode, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysIpAddr=slmSysIpAddr, PYSNMP_MODULE_ID=slMain, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthPassword=slmAuthPassword, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmSys=slmSys, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmSysChassisId=slmSysChassisId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmAdminPassword=slmAdminPassword, slmSysTemperature=slmSysTemperature, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmSwRevTable=slmSwRevTable, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminEntry=slmAdminEntry, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmLogin=slmLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapPort=slmTrapPort, slmTid=slmTid, slmSwRevName=slmSwRevName, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysOperStatus=slmSysOperStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slm40GConf=slm40GConf, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmLicenseIndex=slmLicenseIndex, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay)
