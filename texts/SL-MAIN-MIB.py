...
TimeTicks, Gauge32, Bits, MibIdentifier, Opaque, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity, Integer32, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Bits", "MibIdentifier", "Opaque", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, slmReadCommunity=slmReadCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassEntry=slmChPassEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSwRevStatus=slmSwRevStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmSysResetPm=slmSysResetPm, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogName=slmTrapLogName, slmAuthEntry=slmAuthEntry, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Password=slmSnmpv3Password, slmChPassNewPass=slmChPassNewPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminLogin=slmAdminLogin, slmLicenseTable=slmLicenseTable, slmBoxSize=slmBoxSize, slmConfigFile=slmConfigFile, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmSysLocation=slmSysLocation, slmTrapEnable=slmTrapEnable, slmTrapDestCommunity=slmTrapDestCommunity, slmAuth=slmAuth, slmSysAdminStatus=slmSysAdminStatus, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam4=slmTrapLogParam4, slmAdminAccess=slmAdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestEntry=slmSyslogDestEntry, slmSysIpAddr=slmSysIpAddr, slmChPassLogin=slmChPassLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam6=slmTrapLogParam6, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmLicenseIndex=slmLicenseIndex, slmAdminTable=slmAdminTable, UserPassword=UserPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSysMode=slmSysMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmAdminEntry=slmAdminEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmChPassOldPass=slmChPassOldPass, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, AdminAccess=AdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmRebootDelay=slmRebootDelay, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSnmpVersion=slmSysSnmpVersion, slMain=slMain, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseId=slmLicenseId, slmVcatDelay=slmVcatDelay, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin, slmSwRevDate=slmSwRevDate, slmWriteCommunity=slmWriteCommunity, slmAdmin=slmAdmin, slmSysSubnetMask=slmSysSubnetMask, slmSysOperStatus=slmSysOperStatus)
