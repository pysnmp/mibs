...
Unsigned32, Counter64, NotificationType, Bits, TimeTicks, Opaque, iso, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "NotificationType", "Bits", "TimeTicks", "Opaque", "iso", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogName=slmTrapLogName, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmSysIpAddr=slmSysIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminCommunity=slmAdminCommunity, slmSysLocation=slmSysLocation, slmTrapDestAddress=slmTrapDestAddress, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, slmSysUplinkRate=slmSysUplinkRate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysChassisId=slmSysChassisId, slmChPassNewPass=slmChPassNewPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmTrapDestRowStatus=slmTrapDestRowStatus, SoftwareRevision=SoftwareRevision, slmAdminEntry=slmAdminEntry, slmLicenseIndex=slmLicenseIndex, slmSwRevStatus=slmSwRevStatus, slmTrapLogEntry=slmTrapLogEntry, slmSyslogLevel=slmSyslogLevel, slmAuthPassword=slmAuthPassword, slmTrapLogParam2=slmTrapLogParam2, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, UserLogin=UserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, UserPassword=UserPassword, slmAdminPassword=slmAdminPassword, slmLicense=slmLicense, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmTopologyEnabled=slmTopologyEnabled, slmOemType=slmOemType, slmTid=slmTid, slmAdmin=slmAdmin, slmChPassEntry=slmChPassEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmAct=slmSysAlmAct, AdminAccess=AdminAccess, slMain=slMain, slmLicenseId=slmLicenseId, slmTrapDestEntry=slmTrapDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmChPass=slmChPass, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slm40GConf=slm40GConf, slmLogin=slmLogin, slmLicenseExpiration=slmLicenseExpiration, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmSysTemperature=slmSysTemperature, slmSys=slmSys, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmDeact=slmSysAlmDeact, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigFile=slmConfigFile, slmAdminAccess=slmAdminAccess, slmSysOperStatus=slmSysOperStatus, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmVcatDelay=slmVcatDelay, slmSysTrapFormat=slmSysTrapFormat, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSysResetPm=slmSysResetPm, slmPsuNumber=slmPsuNumber, slmTrapLogParam6=slmTrapLogParam6, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmSwRevEntry=slmSwRevEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysSubnetMask=slmSysSubnetMask, slmSwRevTable=slmSwRevTable, slmRstpEnabled=slmRstpEnabled, slmSysName=slmSysName, slmAdminLogin=slmAdminLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAdminStatus=slmSysAdminStatus, slmAuthLogin=slmAuthLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, slmPmAvailable=slmPmAvailable)
