...
IpAddress, Integer32, Counter32, ObjectIdentity, Gauge32, Counter64, Bits, TimeTicks, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Counter32", "ObjectIdentity", "Gauge32", "Counter64", "Bits", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque")
DateAndTime, DisplayString, RowStatus, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "RowStatus", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAdminStatus=slmSysAdminStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapCommunity=slmTrapCommunity, slmSys=slmSys, slmLogFile=slmLogFile, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmTrapDestEntry=slmTrapDestEntry, slmSwRevTable=slmSwRevTable, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, slmNetworkMode=slmNetworkMode, slmLicenseId=slmLicenseId, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmChPass=slmChPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmBoxSize=slmBoxSize, slmSyslogLevel=slmSyslogLevel, slMain=slMain, slmAdminLogin=slmAdminLogin, UserPassword=UserPassword, slmSysAlmDeact=slmSysAlmDeact, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmRebootDelay=slmRebootDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmTrapLogId=slmTrapLogId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmLicense=slmLicense, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminPassword=slmAdminPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassOldPass=slmChPassOldPass, slmAuth=slmAuth, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress, slmPmAvailable=slmPmAvailable, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmEdfaNumber=slmEdfaNumber, slmSysOperStatus=slmSysOperStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmSwRevDirectory=slmSwRevDirectory, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysName=slmSysName, slmAuthTable=slmAuthTable, slmOemType=slmOemType, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPortsNumber=slmPortsNumber, slmSysIpAddr=slmSysIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmLicenseIndex=slmLicenseIndex, slmAuthCommunity=slmAuthCommunity, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestTable=slmTrapDestTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmVcatDelay=slmVcatDelay, slmAuthPassword=slmAuthPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminAccess=slmAdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysMode=slmSysMode, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmReadCommunity=slmReadCommunity, slmSysLocation=slmSysLocation, slmPsuNumber=slmPsuNumber, slmTrapEnable=slmTrapEnable, slmLicenseTable=slmLicenseTable, slmChPassNewPass=slmChPassNewPass, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmChPassLogin=slmChPassLogin, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogName=slmTrapLogName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminTable=slmAdminTable, slmTid=slmTid, PYSNMP_MODULE_ID=slMain, slmSnmpv3Password=slmSnmpv3Password, slmAuthEntry=slmAuthEntry, slmTrapLogTable=slmTrapLogTable)
