...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Opaque, ModuleIdentity, Counter64, NotificationType, Bits, Gauge32, TimeTicks, Counter32, Integer32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Opaque", "ModuleIdentity", "Counter64", "NotificationType", "Bits", "Gauge32", "TimeTicks", "Counter32", "Integer32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmAuthPassword=slmAuthPassword, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmAdminAccess=slmAdminAccess, slmAdminEntry=slmAdminEntry, slmSyslogDestTable=slmSyslogDestTable, slmEdfaNumber=slmEdfaNumber, slmTrapDestTable=slmTrapDestTable, slmTrapCommunity=slmTrapCommunity, slmAuth=slmAuth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRebootDelay=slmRebootDelay, AdminAccess=AdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthTable=slmAuthTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmAdminCommunity=slmAdminCommunity, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmChPassTable=slmChPassTable, slmLogFile=slmLogFile, slmReadCommunity=slmReadCommunity, slmSyslogPort=slmSyslogPort, slmSysName=slmSysName, slmSwRevDirectory=slmSwRevDirectory, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserLogin=slmTrapUserLogin, slmSysChassisId=slmSysChassisId, slmAdminLogin=slmAdminLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPass=slmChPass, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, UserLogin=UserLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam2=slmTrapLogParam2, slmNetworkMode=slmNetworkMode, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmAuthEntry=slmAuthEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmBoxSize=slmBoxSize, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmTrapLogParam3=slmTrapLogParam3, slmChPassLogin=slmChPassLogin, slmTrapLogTable=slmTrapLogTable, slmConfigSysUptime=slmConfigSysUptime, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmSysTemperature=slmSysTemperature, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam6=slmTrapLogParam6, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Password=slmSnmpv3Password, slmSysIpAddr=slmSysIpAddr, slmTrap=slmTrap, slmConfigFile=slmConfigFile, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseIndex=slmLicenseIndex, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevName=slmSwRevName, slmMuxNumber=slmMuxNumber, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPsuNumber=slmPsuNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogName=slmTrapLogName, PYSNMP_MODULE_ID=slMain, slmWriteCommunity=slmWriteCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmPmAvailable=slmPmAvailable, slmTrapPort=slmTrapPort, slmChPassEntry=slmChPassEntry, slmLicenseId=slmLicenseId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogEntry=slmTrapLogEntry)
