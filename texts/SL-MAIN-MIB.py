...
iso, ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, Unsigned32, IpAddress, Opaque, Gauge32, Counter32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress", "Opaque", "Gauge32", "Counter32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType")
RowStatus, DisplayString, TextualConvention, TruthValue, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TextualConvention", "TruthValue", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysName=slmSysName, slmAuth=slmAuth, slmLogFile=slmLogFile, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysIpAddr=slmSysIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminAccess=slmAdminAccess, UserCommunity=UserCommunity, slmAdmin=slmAdmin, slmWriteCommunity=slmWriteCommunity, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmAdminCommunity=slmAdminCommunity, slmSwRevDirectory=slmSwRevDirectory, slmPmAvailable=slmPmAvailable, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam5=slmTrapLogParam5, slmSysLocation=slmSysLocation, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSnmpVersion=slmSysSnmpVersion, PYSNMP_MODULE_ID=slMain, slmReadCommunity=slmReadCommunity, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, slmSysTrapFormat=slmSysTrapFormat, slmSysResetPm=slmSysResetPm, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slmPortsNumber=slmPortsNumber, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmAct=slmSysAlmAct, slmTrapEnable=slmTrapEnable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmConfigFile=slmConfigFile, slmSys=slmSys, slmSysAdminStatus=slmSysAdminStatus, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmTrapLogParam1=slmTrapLogParam1, slmSysChassisId=slmSysChassisId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmPsuNumber=slmPsuNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassTable=slmChPassTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmLicense=slmLicense, slmSysSubnetMask=slmSysSubnetMask, slmLicenseId=slmLicenseId, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam2=slmTrapLogParam2, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmSysMode=slmSysMode, slmTid=slmTid, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmTrapLogId=slmTrapLogId, slmAdminPassword=slmAdminPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogin=slmLogin, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmTrap=slmTrap, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, slmEdfaNumber=slmEdfaNumber, slmChPassNewPass=slmChPassNewPass, slmChPassOldPass=slmChPassOldPass, slmAdminRowStatus=slmAdminRowStatus, slmRstpEnabled=slmRstpEnabled, UserLogin=UserLogin, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthPassword=slmAuthPassword, slMain=slMain, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTable=slmTrapLogTable)
