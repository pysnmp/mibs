...
MibIdentifier, IpAddress, Bits, Counter32, Opaque, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Bits", "Counter32", "Opaque", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Integer32")
TruthValue, RowStatus, TextualConvention, DisplayString, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TextualConvention", "DisplayString", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, slmLogFile=slmLogFile, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapPort=slmTrapPort, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slm40GConf=slm40GConf, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, UserPassword=UserPassword, slmSwRevDate=slmSwRevDate, UserCommunity=UserCommunity, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmAdminPassword=slmAdminPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmTrapEnable=slmTrapEnable, slmAdminRowStatus=slmAdminRowStatus, slmNetworkMode=slmNetworkMode, PYSNMP_MODULE_ID=slMain, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, slmSwRevTable=slmSwRevTable, slmVcatDelay=slmVcatDelay, slmSysTrapFormat=slmSysTrapFormat, slmAuthTable=slmAuthTable, slmRebootDelay=slmRebootDelay, slmBoxSize=slmBoxSize, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysResetPm=slmSysResetPm, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogin=slmLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmAuth=slmAuth, slmTrapLogParam1=slmTrapLogParam1, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmTid=slmTid, slmSysMode=slmSysMode, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmLicense=slmLicense, slmReadCommunity=slmReadCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slmConfigSysSignalType=slmConfigSysSignalType, slmEdfaNumber=slmEdfaNumber, slmTrapDestTable=slmTrapDestTable, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmSysUplinkRate=slmSysUplinkRate, slmSysAdminStatus=slmSysAdminStatus, slmAdminLogin=slmAdminLogin, slmAdmin=slmAdmin, SoftwareRevision=SoftwareRevision, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmPortsNumber=slmPortsNumber, slmSysChassisId=slmSysChassisId, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, slmLicenseEntry=slmLicenseEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPmAvailable=slmPmAvailable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmSyslogLevel=slmSyslogLevel, slmLicenseTable=slmLicenseTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmSys=slmSys, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmOemType=slmOemType, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmDeact=slmSysAlmDeact, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPass=slmChPass, slmAdminCommunity=slmAdminCommunity)
