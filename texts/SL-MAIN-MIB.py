...
ModuleIdentity, ObjectIdentity, iso, TimeTicks, Counter64, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Bits, Gauge32, Integer32, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "iso", "TimeTicks", "Counter64", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Bits", "Gauge32", "Integer32", "Opaque", "IpAddress")
DateAndTime, DisplayString, RowStatus, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmMuxNumber=slmMuxNumber, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogLevel=slmSyslogLevel, slmLogFile=slmLogFile, PYSNMP_MODULE_ID=slMain, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmAuthEntry=slmAuthEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmLicenseId=slmLicenseId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysMode=slmSysMode, slmTrapUserLogin=slmTrapUserLogin, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmLicenseTable=slmLicenseTable, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmChPass=slmChPass, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, UserPassword=UserPassword, slmSysUplinkRate=slmSysUplinkRate, slmWriteCommunity=slmWriteCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTable=slmTrapLogTable, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, AdminAccess=AdminAccess, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmTrapPort=slmTrapPort, slmLicense=slmLicense, slmLicenseIndex=slmLicenseIndex, slmSysTemperature=slmSysTemperature, slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminRowStatus=slmAdminRowStatus, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmSnmpv3Password=slmSnmpv3Password, slmAdminPassword=slmAdminPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmBoxSize=slmBoxSize, slmTrapLogParam4=slmTrapLogParam4, slmTrapCommunity=slmTrapCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmPmAvailable=slmPmAvailable, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmAdminTable=slmAdminTable, slmSyslogDestEntry=slmSyslogDestEntry, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, slmTopologyEnabled=slmTopologyEnabled, slmSys=slmSys, slmChPassOldPass=slmChPassOldPass, UserLogin=UserLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysResetPm=slmSysResetPm, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Priv=slmSnmpv3Priv, slMain=slMain, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDate=slmSwRevDate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRstpEnabled=slmRstpEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmAuth=slmAuth, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmSysTrapFormat=slmSysTrapFormat)
