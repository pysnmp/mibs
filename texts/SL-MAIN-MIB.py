...
TimeTicks, ModuleIdentity, Counter32, Counter64, Gauge32, Opaque, Integer32, Unsigned32, NotificationType, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Counter32", "Counter64", "Gauge32", "Opaque", "Integer32", "Unsigned32", "NotificationType", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress")
TruthValue, TextualConvention, TimeStamp, DisplayString, RowStatus, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmSysResetPm=slmSysResetPm, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogId=slmTrapLogId, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSys=slmSys, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slMain=slMain, slmSysTrapFormat=slmSysTrapFormat, slmNetworkMode=slmNetworkMode, slmAuthTable=slmAuthTable, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, UserPassword=UserPassword, slmWriteCommunity=slmWriteCommunity, slmAdminEntry=slmAdminEntry, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmBoxSize=slmBoxSize, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmRstpEnabled=slmRstpEnabled, slmSysTemperature=slmSysTemperature, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysOperStatus=slmSysOperStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevName=slmSwRevName, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, slmLogFile=slmLogFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDate=slmSwRevDate, slmChPassOldPass=slmChPassOldPass, slmChPassEntry=slmChPassEntry, slmSwRevEntry=slmSwRevEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmAdminAccess=slmAdminAccess, slmSysIpAddr=slmSysIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmSysAlmAct=slmSysAlmAct, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam2=slmTrapLogParam2, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmTopologyEnabled=slmTopologyEnabled, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmEdfaNumber=slmEdfaNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapPort=slmTrapPort, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmLicenseEntry=slmLicenseEntry, slmLicense=slmLicense, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPass=slmChPass, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogName=slmTrapLogName, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysChassisId=slmSysChassisId, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthPassword=slmAuthPassword, slmAdminTable=slmAdminTable, SoftwareRevision=SoftwareRevision, slmSwRevDirectory=slmSwRevDirectory, slmSysLanIpAddr=slmSysLanIpAddr, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmLicenseIndex=slmLicenseIndex, slmTrap=slmTrap, slmAuthLogin=slmAuthLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable)
