...
NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, IpAddress, Integer32, iso, Counter32, MibIdentifier, TimeTicks, ModuleIdentity, Counter64, Unsigned32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "IpAddress", "Integer32", "iso", "Counter32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter64", "Unsigned32", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogId=slmTrapLogId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmWriteCommunity=slmWriteCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmVcatDelay=slmVcatDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthTable=slmAuthTable, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestTable=slmTrapDestTable, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysMode=slmSysMode, slmNetworkMode=slmNetworkMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmAdminEntry=slmAdminEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmChPass=slmChPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmChPassNewPass=slmChPassNewPass, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, slmTrapLogName=slmTrapLogName, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmOemType=slmOemType, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysTrapFormat=slmSysTrapFormat, slmSwRevName=slmSwRevName, slmSwRevDate=slmSwRevDate, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, slmAdminPassword=slmAdminPassword, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthPassword=slmAuthPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysSubnetMask=slmSysSubnetMask, AdminAccess=AdminAccess, slmPortsNumber=slmPortsNumber, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestAddress=slmTrapDestAddress, slmAdminLogin=slmAdminLogin, slmAdmin=slmAdmin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slMain=slMain, slmTrapUserAccess=slmTrapUserAccess, slmLicense=slmLicense, UserCommunity=UserCommunity, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigFile=slmConfigFile, slmTrapLogTable=slmTrapLogTable, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmChPassLogin=slmChPassLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slmChPassTable=slmChPassTable)
