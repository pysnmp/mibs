...
ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, Integer32, NotificationType, Counter64, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Opaque, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Opaque", "Counter32", "IpAddress", "MibIdentifier")
DisplayString, TextualConvention, TruthValue, DateAndTime, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "DateAndTime", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmTopologyEnabled=slmTopologyEnabled, slmVcatDelay=slmVcatDelay, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmAuthTable=slmAuthTable, slmTrapLogParam3=slmTrapLogParam3, slmAdminPassword=slmAdminPassword, slmSysChassisId=slmSysChassisId, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay, slmPmAvailable=slmPmAvailable, slmTrapDestEntry=slmTrapDestEntry, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmPortsNumber=slmPortsNumber, slmSwRevStatus=slmSwRevStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminTable=slmAdminTable, slmSysIpAddr=slmSysIpAddr, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmConfigFile=slmConfigFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthEntry=slmAuthEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestCommunity=slmTrapDestCommunity, UserPassword=UserPassword, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, UserLogin=UserLogin, slmLogin=slmLogin, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, AdminAccess=AdminAccess, slmTrapLogName=slmTrapLogName, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmTrapLogParam1=slmTrapLogParam1, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmSysUplinkRate=slmSysUplinkRate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysName=slmSysName, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmDeact=slmSysAlmDeact, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmMuxNumber=slmMuxNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassTable=slmChPassTable, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmTrapCommunity=slmTrapCommunity, slmLicenseId=slmLicenseId, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, slmChPass=slmChPass, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogId=slmTrapLogId, slmSysSnmpVersion=slmSysSnmpVersion, slmSysSubnetMask=slmSysSubnetMask, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestTable=slmTrapDestTable, slmTid=slmTid, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPsuNumber=slmPsuNumber, slmSysLocation=slmSysLocation, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel)
