...
IpAddress, TimeTicks, Bits, Counter64, Unsigned32, Integer32, ObjectIdentity, MibIdentifier, Counter32, iso, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Bits", "Counter64", "Unsigned32", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthPassword=slmAuthPassword, slmAdmin=slmAdmin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseTable=slmLicenseTable, slmChPassNewPass=slmChPassNewPass, slmSysChassisId=slmSysChassisId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPass=slmChPass, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmTrapDestEntry=slmTrapDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSyslogPort=slmSyslogPort, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmLogFile=slmLogFile, slmTrapUserLogin=slmTrapUserLogin, slmOemType=slmOemType, slmTrapPort=slmTrapPort, UserCommunity=UserCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmPortsNumber=slmPortsNumber, slmSysCalendarTime=slmSysCalendarTime, slmSwRevName=slmSwRevName, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmSysLocation=slmSysLocation, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam3=slmTrapLogParam3, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmBoxSize=slmBoxSize, slmSysTemperature=slmSysTemperature, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmAuth=slmAuth, slmConfigFile=slmConfigFile, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, SoftwareRevision=SoftwareRevision, slmSwRevStatus=slmSwRevStatus, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSysName=slmSysName, slmVcatDelay=slmVcatDelay, slmMuxNumber=slmMuxNumber, slmLicenseExpiration=slmLicenseExpiration, slmSys=slmSys, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmSwRevDate=slmSwRevDate, slmLogin=slmLogin, slmSysTrapFormat=slmSysTrapFormat, slmSwRevEntry=slmSwRevEntry, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, PYSNMP_MODULE_ID=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmTrapCommunity=slmTrapCommunity, slmTrapLogId=slmTrapLogId, slmChPassEntry=slmChPassEntry, slmPsuNumber=slmPsuNumber, slmTrapEnable=slmTrapEnable, UserPassword=UserPassword, slmAuthLogin=slmAuthLogin, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, slMain=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestAddress=slmTrapDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthCommunity=slmAuthCommunity, slmSysMode=slmSysMode, slmTrapLogName=slmTrapLogName, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr)
