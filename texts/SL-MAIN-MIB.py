...
Unsigned32, MibIdentifier, iso, Bits, Gauge32, Counter32, Opaque, Counter64, ModuleIdentity, IpAddress, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "iso", "Bits", "Gauge32", "Counter32", "Opaque", "Counter64", "ModuleIdentity", "IpAddress", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
TruthValue, TimeStamp, DateAndTime, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DateAndTime", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmOemType=slmOemType, slmTrapPort=slmTrapPort, slmChPassTable=slmChPassTable, slmSwRevTable=slmSwRevTable, slmSyslogPort=slmSyslogPort, slmEdfaNumber=slmEdfaNumber, slmAdminTable=slmAdminTable, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, AdminAccess=AdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slMain=slMain, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassEntry=slmChPassEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmSys=slmSys, slmRebootDelay=slmRebootDelay, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmAdmin=slmAdmin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmSwRevStatus=slmSwRevStatus, slmMuxNumber=slmMuxNumber, slmAuth=slmAuth, slmSwRevEntry=slmSwRevEntry, slm40GConf=slm40GConf, UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrap=slmTrap, slmTrapDestIpAddress=slmTrapDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmSysCalendarTime=slmSysCalendarTime, slmReadCommunity=slmReadCommunity, slmTid=slmTid, slmSysLocation=slmSysLocation, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmDeact=slmSysAlmDeact, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam2=slmTrapLogParam2, slmAuthCommunity=slmAuthCommunity, slmAuthEntry=slmAuthEntry, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmLogFile=slmLogFile, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmConfigFile=slmConfigFile, slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, SoftwareRevision=SoftwareRevision, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseId=slmLicenseId, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmAuthPassword=slmAuthPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmSyslogDestAddress=slmSyslogDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam3=slmTrapLogParam3, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmAdminPassword=slmAdminPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicense=slmLicense, slmRstpEnabled=slmRstpEnabled, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry)
