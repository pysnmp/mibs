...
ModuleIdentity, Counter32, Bits, NotificationType, Opaque, MibIdentifier, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Unsigned32, iso, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "Opaque", "MibIdentifier", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Unsigned32", "iso", "Counter64", "IpAddress")
TimeStamp, DisplayString, DateAndTime, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "DateAndTime", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysNetworkPrefix=slmSysNetworkPrefix, slmNetworkMode=slmNetworkMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmChPass=slmChPass, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmSwRevStatus=slmSwRevStatus, slmSyslogLevel=slmSyslogLevel, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmConfigFile=slmConfigFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthPassword=slmAuthPassword, slmChPassEntry=slmChPassEntry, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysOperStatus=slmSysOperStatus, slmChPassLogin=slmChPassLogin, slmSysAlmAct=slmSysAlmAct, slmChPassOldPass=slmChPassOldPass, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmSyslogPort=slmSyslogPort, slmRebootDelay=slmRebootDelay, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam1=slmTrapLogParam1, slmOemType=slmOemType, slmLicenseId=slmLicenseId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slm40GConf=slm40GConf, slmLicense=slmLicense, slmChPassTable=slmChPassTable, slmLicenseTable=slmLicenseTable, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmTrapLogParam3=slmTrapLogParam3, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthCommunity=slmAuthCommunity, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapEnable=slmTrapEnable, slmMuxNumber=slmMuxNumber, AdminAccess=AdminAccess, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdmin=slmAdmin, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmPsuNumber=slmPsuNumber, slmLogFile=slmLogFile, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmWriteCommunity=slmWriteCommunity, slmSysCalendarTime=slmSysCalendarTime, UserPassword=UserPassword, slmSyslogDestEntry=slmSyslogDestEntry, slMain=slMain, slmAdminPassword=slmAdminPassword, slmSwRevTable=slmSwRevTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmSys=slmSys, PYSNMP_MODULE_ID=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmVcatDelay=slmVcatDelay, SoftwareRevision=SoftwareRevision, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmPmAvailable=slmPmAvailable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmTrapDestTable=slmTrapDestTable)
