...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmLogFile=slmLogFile, PYSNMP_MODULE_ID=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmSwRevDate=slmSwRevDate, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmSysAdminStatus=slmSysAdminStatus, slmSysOperStatus=slmSysOperStatus, slmBoxSize=slmBoxSize, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmTrap=slmTrap, slmSys=slmSys, slmTrapLogParam4=slmTrapLogParam4, UserPassword=UserPassword, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogName=slmTrapLogName, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuth=slmAuth, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmSwRevName=slmSwRevName, slmEdfaNumber=slmEdfaNumber, slmTid=slmTid, slmLicenseEntry=slmLicenseEntry, slmTrapCommunity=slmTrapCommunity, slmSyslogLevel=slmSyslogLevel, slmSysResetPm=slmSysResetPm, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSysName=slmSysName, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmConfigFile=slmConfigFile, slmMuxNumber=slmMuxNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevTable=slmSwRevTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysMode=slmSysMode, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmAuthPassword=slmAuthPassword, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmLogin=slmLogin, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmSysAlmAct=slmSysAlmAct, slm40GConf=slm40GConf, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicense=slmLicense, slmTrapDestEntry=slmTrapDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseIndex=slmLicenseIndex, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmAdminAccess=slmAdminAccess)
