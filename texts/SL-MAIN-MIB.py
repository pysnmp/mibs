...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, Counter32, NotificationType, Gauge32, ModuleIdentity, TimeTicks, Opaque, iso, ObjectIdentity, IpAddress, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "TimeTicks", "Opaque", "iso", "ObjectIdentity", "IpAddress", "Counter64", "MibIdentifier")
RowStatus, TimeStamp, TruthValue, TextualConvention, DisplayString, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TruthValue", "TextualConvention", "DisplayString", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevDate=slmSwRevDate, slmPsuNumber=slmPsuNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmLicense=slmLicense, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevEntry=slmSwRevEntry, slmRstpEnabled=slmRstpEnabled, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOemType=slmOemType, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, slmSysAdminStatus=slmSysAdminStatus, slmAuth=slmAuth, slmSyslogDestEntry=slmSyslogDestEntry, slmVcatDelay=slmVcatDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPmAvailable=slmPmAvailable, slmAuthTable=slmAuthTable, slmLogFile=slmLogFile, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmNetworkMode=slmNetworkMode, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogName=slmTrapLogName, slmChPassNewPass=slmChPassNewPass, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmEdfaNumber=slmEdfaNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmAuthEntry=slmAuthEntry, slmTrapLogId=slmTrapLogId, slmSysOperStatus=slmSysOperStatus, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmTrapLogParam6=slmTrapLogParam6, slmMuxNumber=slmMuxNumber, slmSwRevStatus=slmSwRevStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTable=slmTrapLogTable, slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry, slmSysTemperature=slmSysTemperature, slmSysName=slmSysName, slmLicenseEntry=slmLicenseEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, PYSNMP_MODULE_ID=slMain, slmSyslogLevel=slmSyslogLevel, slmAdmin=slmAdmin, slmSys=slmSys, slmTrapPort=slmTrapPort, slmSysIpAddr=slmSysIpAddr, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPortsNumber=slmPortsNumber, slmTrapLogParam2=slmTrapLogParam2, slmChPass=slmChPass, UserPassword=UserPassword, slmTrapCommunity=slmTrapCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam5=slmTrapLogParam5, slmSysLocation=slmSysLocation, slmSysMode=slmSysMode, slmSysAlmDeact=slmSysAlmDeact, slmLogin=slmLogin, slMain=slMain, slmSysChassisId=slmSysChassisId, AdminAccess=AdminAccess, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmTrapLogEntry=slmTrapLogEntry, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmTrapUserAccess=slmTrapUserAccess, slmSysCalendarTime=slmSysCalendarTime, slm40GConf=slm40GConf, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminRowStatus=slmAdminRowStatus, slmTrap=slmTrap, slmSwRevName=slmSwRevName, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmBoxSize=slmBoxSize, slmAuthLogin=slmAuthLogin, slmTrapDestAddress=slmTrapDestAddress, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity)
