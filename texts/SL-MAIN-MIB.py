...
Integer32, Gauge32, IpAddress, Opaque, NotificationType, Counter32, Counter64, ObjectIdentity, MibIdentifier, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "IpAddress", "Opaque", "NotificationType", "Counter32", "Counter64", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmSysTemperature=slmSysTemperature, slmSys=slmSys, slmTrapCommunity=slmTrapCommunity, slmSysTrapFormat=slmSysTrapFormat, slmChPass=slmChPass, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmLicenseTable=slmLicenseTable, AdminAccess=AdminAccess, slmAdminPassword=slmAdminPassword, slMain=slMain, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, UserPassword=UserPassword, slmWriteCommunity=slmWriteCommunity, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysLocation=slmSysLocation, slmTrapLogParam2=slmTrapLogParam2, slmLicenseExpiration=slmLicenseExpiration, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSyslogLevel=slmSyslogLevel, slmTrapUserLogin=slmTrapUserLogin, slmLogin=slmLogin, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysName=slmSysName, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassLogin=slmChPassLogin, slmAuthPassword=slmAuthPassword, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmPortsNumber=slmPortsNumber, slmEdfaNumber=slmEdfaNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysChassisId=slmSysChassisId, slmAuth=slmAuth, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminCommunity=slmAdminCommunity, UserCommunity=UserCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmTrap=slmTrap, UserLogin=UserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserAccess=slmTrapUserAccess, slmVcatDelay=slmVcatDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysOperStatus=slmSysOperStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmAct=slmSysAlmAct, slmSysAdminStatus=slmSysAdminStatus, slmAdminTable=slmAdminTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysCalendarTime=slmSysCalendarTime, slmAuthEntry=slmAuthEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmTrapLogEntry=slmTrapLogEntry, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmPsuNumber=slmPsuNumber, slmLicenseEntry=slmLicenseEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmSwRevTable=slmSwRevTable, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, slmTrapLogId=slmTrapLogId, slmSysMode=slmSysMode, slmTrapPort=slmTrapPort, slmChPassEntry=slmChPassEntry, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogTable=slmTrapLogTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
