...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Integer32, ObjectIdentity, Counter64, Opaque, MibIdentifier, TimeTicks, NotificationType, iso, Counter32, Gauge32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Integer32", "ObjectIdentity", "Counter64", "Opaque", "MibIdentifier", "TimeTicks", "NotificationType", "iso", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", AdminAccess=AdminAccess, slmAdminTable=slmAdminTable, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrap=slmTrap, slmSysTemperature=slmSysTemperature, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmReadCommunity=slmReadCommunity, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogId=slmTrapLogId, UserPassword=UserPassword, slmSwRevDirectory=slmSwRevDirectory, slmAuth=slmAuth, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmSys=slmSys, slmConfigSysUptime=slmConfigSysUptime, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmAdmin=slmAdmin, slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, slmLogFile=slmLogFile, slmLicenseExpiration=slmLicenseExpiration, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRebootDelay=slmRebootDelay, slmAuthPassword=slmAuthPassword, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseId=slmLicenseId, slmPortsNumber=slmPortsNumber, slmTrapLogParam4=slmTrapLogParam4, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, SoftwareRevision=SoftwareRevision, slMain=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmAdminLogin=slmAdminLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestTable=slmTrapDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmLicense=slmLicense, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysChassisId=slmSysChassisId, slmAuthEntry=slmAuthEntry, slmPsuNumber=slmPsuNumber, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam2=slmTrapLogParam2, slmAuthTable=slmAuthTable, slmSysCalendarTime=slmSysCalendarTime, slmChPass=slmChPass, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmSysTrapFormat=slmSysTrapFormat, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmSwRevEntry=slmSwRevEntry, slmLicenseEntry=slmLicenseEntry, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmEdfaNumber=slmEdfaNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmSysSubnetMask=slmSysSubnetMask, slmSyslogPort=slmSyslogPort, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Password=slmSnmpv3Password, slmAdminEntry=slmAdminEntry, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled)
