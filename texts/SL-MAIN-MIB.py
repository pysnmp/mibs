...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam3=slmTrapLogParam3, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTid=slmTid, slmSysAlmAct=slmSysAlmAct, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmOpticalSwitchExist=slmOpticalSwitchExist, UserCommunity=UserCommunity, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, slMain=slMain, slmAdmin=slmAdmin, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmBoxSize=slmBoxSize, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmAdminPassword=slmAdminPassword, slmConfigSysUptime=slmConfigSysUptime, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmLogin=slmLogin, slmSysName=slmSysName, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam6=slmTrapLogParam6, slmLicenseId=slmLicenseId, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmChPassTable=slmChPassTable, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmChPassOldPass=slmChPassOldPass, slmSysMode=slmSysMode, slmTrapEnable=slmTrapEnable, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestAddress=slmTrapDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevTable=slmSwRevTable, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmNetworkMode=slmNetworkMode, slmLicenseTable=slmLicenseTable, slmVcatDelay=slmVcatDelay, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, slmTrapPort=slmTrapPort, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmEdfaNumber=slmEdfaNumber, slmSysCalendarTime=slmSysCalendarTime, slmSysAdminStatus=slmSysAdminStatus, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmPmAvailable=slmPmAvailable, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, UserLogin=UserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthPassword=slmAuthPassword, slmLicense=slmLicense, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDate=slmSwRevDate, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmRstpEnabled=slmRstpEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2)
