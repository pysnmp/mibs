...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmAuthEntry=slmAuthEntry, slmChPassLogin=slmChPassLogin, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmSwRevEntry=slmSwRevEntry, slMain=slMain, slmSysChassisId=slmSysChassisId, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber, slm40GConf=slm40GConf, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam2=slmTrapLogParam2, slmTopologyEnabled=slmTopologyEnabled, slmSysOperStatus=slmSysOperStatus, slmTrapLogTable=slmTrapLogTable, slmBoxSize=slmBoxSize, slmAdmin=slmAdmin, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTid=slmTid, slmTrapPort=slmTrapPort, slmReadCommunity=slmReadCommunity, slmSysName=slmSysName, UserCommunity=UserCommunity, slmSyslogPort=slmSyslogPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminRowStatus=slmAdminRowStatus, slmSwRevName=slmSwRevName, slmTrapLogParam4=slmTrapLogParam4, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmChPassNewPass=slmChPassNewPass, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigFile=slmConfigFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminTable=slmAdminTable, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmSyslogLevel=slmSyslogLevel, slmChPassEntry=slmChPassEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmVcatDelay=slmVcatDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogId=slmTrapLogId, slmAuthLogin=slmAuthLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogName=slmTrapLogName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmPsuNumber=slmPsuNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayAddr=slmSysGatewayAddr, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmTrapUserAccess=slmTrapUserAccess, slmLogFile=slmLogFile, slmTrap=slmTrap, slmAdminLogin=slmAdminLogin, slmChPassOldPass=slmChPassOldPass, slmChPass=slmChPass, slmPortsNumber=slmPortsNumber, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapCommunity=slmTrapCommunity, slmRstpEnabled=slmRstpEnabled, slmSysMode=slmSysMode, slmAdminPassword=slmAdminPassword, SoftwareRevision=SoftwareRevision, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmTrapLogParam3=slmTrapLogParam3, UserLogin=UserLogin, slmLicenseId=slmLicenseId, slmOemType=slmOemType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminEntry=slmAdminEntry, slmSwRevTable=slmSwRevTable)
