...
MibIdentifier, Opaque, Bits, Counter32, TimeTicks, Counter64, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, iso, Integer32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Opaque", "Bits", "Counter32", "TimeTicks", "Counter64", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "iso", "Integer32", "Unsigned32", "IpAddress")
TimeStamp, TruthValue, DateAndTime, RowStatus, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DateAndTime", "RowStatus", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slMain=slMain, slmChPassNewPass=slmChPassNewPass, slmAdminAccess=slmAdminAccess, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogFile=slmLogFile, slmAuthPassword=slmAuthPassword, slmRstpEnabled=slmRstpEnabled, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmSysLanIpAddr=slmSysLanIpAddr, slmLogin=slmLogin, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmVcatDelay=slmVcatDelay, slmTrapLogEntry=slmTrapLogEntry, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmTrapEnable=slmTrapEnable, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmLicenseId=slmLicenseId, slmAuthCommunity=slmAuthCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmOemType=slmOemType, AdminAccess=AdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmChPassLogin=slmChPassLogin, slm40GConf=slm40GConf, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Password=slmSnmpv3Password, slmSwRevEntry=slmSwRevEntry, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmAdminLogin=slmAdminLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserAccess=slmTrapUserAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysMode=slmSysMode, slmReadCommunity=slmReadCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdmin=slmAdmin, slmTrapLogId=slmTrapLogId, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmChPass=slmChPass, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRebootDelay=slmRebootDelay, slmAuthTable=slmAuthTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestTable=slmTrapDestTable, slmSys=slmSys, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmConfigSysUptime=slmConfigSysUptime, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogName=slmTrapLogName, slmTid=slmTid, SoftwareRevision=SoftwareRevision, slmAuth=slmAuth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmAct=slmSysAlmAct, slmSwRevName=slmSwRevName, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Priv=slmSnmpv3Priv, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmChPassEntry=slmChPassEntry, slmAuthEntry=slmAuthEntry, slmSyslogPort=slmSyslogPort, slmAdminPassword=slmAdminPassword, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapPort=slmTrapPort, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity, slmLicenseTable=slmLicenseTable, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSysName=slmSysName, slmSysChassisId=slmSysChassisId, slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmConfigFile=slmConfigFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestTable=slmSyslogDestTable, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmSwRevStatus=slmSwRevStatus, slmLicense=slmLicense, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogTimeStamp=slmTrapLogTimeStamp)
