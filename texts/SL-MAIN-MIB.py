...
Opaque, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, Counter64, Integer32, IpAddress, TimeTicks, iso, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32", "IpAddress", "TimeTicks", "iso", "Bits", "NotificationType", "Counter32")
TruthValue, DisplayString, TextualConvention, RowStatus, TimeStamp, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmTrapDestTable=slmTrapDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseTable=slmLicenseTable, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmRebootDelay=slmRebootDelay, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, slmSwRevName=slmSwRevName, slmRstpEnabled=slmRstpEnabled, slmSysSubnetMask=slmSysSubnetMask, slmTrap=slmTrap, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysTemperature=slmSysTemperature, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogId=slmTrapLogId, UserPassword=UserPassword, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapCommunity=slmTrapCommunity, UserCommunity=UserCommunity, slmReadCommunity=slmReadCommunity, slmTrapLogEntry=slmTrapLogEntry, slmLicenseIndex=slmLicenseIndex, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmMuxNumber=slmMuxNumber, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmSysChassisId=slmSysChassisId, slmLicense=slmLicense, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmPortsNumber=slmPortsNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slmSysName=slmSysName, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, slmSwRevTable=slmSwRevTable, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slMain=slMain, slmChPassNewPass=slmChPassNewPass, slmSyslogLevel=slmSyslogLevel, slmBoxSize=slmBoxSize, slmLicenseId=slmLicenseId, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminAccess=slmAdminAccess, slmSwRevStatus=slmSwRevStatus, slmSysLocation=slmSysLocation, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmTrapLogName=slmTrapLogName, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmTid=slmTid, slmTrapLogParam5=slmTrapLogParam5, slmPsuNumber=slmPsuNumber, slmAdminLogin=slmAdminLogin, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam3=slmTrapLogParam3, slmAuthTable=slmAuthTable, slmAuth=slmAuth, slmLogFile=slmLogFile, slmChPassLogin=slmChPassLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, slmChPassTable=slmChPassTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess)
