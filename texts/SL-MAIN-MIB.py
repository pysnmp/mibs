...
Bits, ModuleIdentity, TimeTicks, NotificationType, Counter64, Opaque, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Unsigned32, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter64", "Opaque", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Counter32", "Integer32", "iso")
TextualConvention, DisplayString, DateAndTime, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "DateAndTime", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slMain=slMain, slmVcatDelay=slmVcatDelay, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, slmPortsNumber=slmPortsNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, slmTrapLogParam2=slmTrapLogParam2, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode, slmSwRevStatus=slmSwRevStatus, slmOemType=slmOemType, slmTrapLogId=slmTrapLogId, slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdmin=slmAdmin, slmTrapLogParam3=slmTrapLogParam3, slmSwRevTable=slmSwRevTable, slmSysCalendarTime=slmSysCalendarTime, slmChPass=slmChPass, slmTrapLogName=slmTrapLogName, slmTrapPort=slmTrapPort, PYSNMP_MODULE_ID=slMain, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmAct=slmSysAlmAct, slmChPassEntry=slmChPassEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestEntry=slmTrapDestEntry, slmLicenseTable=slmLicenseTable, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysName=slmSysName, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogin=slmLogin, slmRebootDelay=slmRebootDelay, slmAuthEntry=slmAuthEntry, slmPsuNumber=slmPsuNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDirectory=slmSwRevDirectory, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmAuthTable=slmAuthTable, slmRstpEnabled=slmRstpEnabled, slmAdminAccess=slmAdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestTable=slmTrapDestTable, slmSyslogPort=slmSyslogPort, slmSysChassisId=slmSysChassisId, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmTrapLogParam4=slmTrapLogParam4, slmLicenseIndex=slmLicenseIndex, slmSysIpAddr=slmSysIpAddr, UserCommunity=UserCommunity, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSys=slmSys, slmTrap=slmTrap, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmSysResetPm=slmSysResetPm, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmChPassTable=slmChPassTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, UserPassword=UserPassword, slmSysMode=slmSysMode, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserLogin=slmTrapUserLogin, slmWriteCommunity=slmWriteCommunity, slmLogFile=slmLogFile, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserAccess=slmTrapUserAccess, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange)
