...
iso, Bits, Counter32, MibIdentifier, ObjectIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Gauge32, Unsigned32, Integer32, IpAddress, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Counter32", "MibIdentifier", "ObjectIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Gauge32", "Unsigned32", "Integer32", "IpAddress", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmBoxSize=slmBoxSize, slmTrapEnable=slmTrapEnable, AdminAccess=AdminAccess, slmRebootDelay=slmRebootDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmTrapLogParam4=slmTrapLogParam4, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmAdmin=slmAdmin, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmReadCommunity=slmReadCommunity, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmTrap=slmTrap, slmTopologyEnabled=slmTopologyEnabled, slmSwRevTable=slmSwRevTable, slmLicenseEntry=slmLicenseEntry, slmTid=slmTid, SoftwareRevision=SoftwareRevision, slm40GConf=slm40GConf, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseId=slmLicenseId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminAccess=slmAdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmTrapCommunity=slmTrapCommunity, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slMain=slMain, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPass=slmChPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmAuthTable=slmAuthTable, slmLicenseTable=slmLicenseTable, UserLogin=UserLogin, slmConfigFile=slmConfigFile, slmLogin=slmLogin, slmTrapUserAccess=slmTrapUserAccess, slmChPassLogin=slmChPassLogin, slmSys=slmSys, slmSysMode=slmSysMode, slmVcatDelay=slmVcatDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOemType=slmOemType, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogName=slmTrapLogName, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminPassword=slmAdminPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassTable=slmChPassTable, slmTrapLogTable=slmTrapLogTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevStatus=slmSwRevStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogPort=slmSyslogPort, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminEntry=slmAdminEntry, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestAddress=slmSyslogDestAddress, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam3=slmTrapLogParam3, slmPortsNumber=slmPortsNumber, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam2=slmTrapLogParam2, slmSysTrapFormat=slmSysTrapFormat, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTemperature=slmSysTemperature, slmTrapDestEntry=slmTrapDestEntry, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmEdfaNumber=slmEdfaNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDate=slmSwRevDate, slmSwRevEntry=slmSwRevEntry)
