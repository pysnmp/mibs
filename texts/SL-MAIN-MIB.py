...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSwRevEntry=slmSwRevEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmMuxNumber=slmMuxNumber, slmLicense=slmLicense, slmAdminLogin=slmAdminLogin, slmChPassOldPass=slmChPassOldPass, slmTrapPort=slmTrapPort, slmSwRevStatus=slmSwRevStatus, slmWriteCommunity=slmWriteCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthLogin=slmAuthLogin, slmRstpEnabled=slmRstpEnabled, slmAuthTable=slmAuthTable, slmSyslogLevel=slmSyslogLevel, slmTrap=slmTrap, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmVcatDelay=slmVcatDelay, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogPort=slmSyslogPort, slmTrapDestEntry=slmTrapDestEntry, slmChPassLogin=slmChPassLogin, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysUptime=slmConfigSysUptime, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slmSysTrapFormat=slmSysTrapFormat, UserLogin=UserLogin, slmSysAlmAct=slmSysAlmAct, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOemType=slmOemType, slmSwRevDirectory=slmSwRevDirectory, slmSwRevName=slmSwRevName, slmPsuNumber=slmPsuNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, SoftwareRevision=SoftwareRevision, slmSwRevTable=slmSwRevTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPass=slmChPass, slmSyslogDestTable=slmSyslogDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmSysAdminStatus=slmSysAdminStatus, slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserPassword=UserPassword, slmLicenseTable=slmLicenseTable, PYSNMP_MODULE_ID=slMain, slmSysIpAddr=slmSysIpAddr, slmSysName=slmSysName, slmTrapLogParam2=slmTrapLogParam2, slmChPassEntry=slmChPassEntry, slmAdmin=slmAdmin, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmLicenseExpiration=slmLicenseExpiration, slmAuthEntry=slmAuthEntry, slmSnmpv3Password=slmSnmpv3Password, UserCommunity=UserCommunity, slmReadCommunity=slmReadCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmAdminTable=slmAdminTable, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminAccess=slmAdminAccess, slMain=slMain, AdminAccess=AdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmSys=slmSys, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmLicenseIndex=slmLicenseIndex, slmRebootDelay=slmRebootDelay, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestTable=slmTrapDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysMode=slmSysMode, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slm40GConf=slm40GConf, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmTid=slmTid, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmAuth=slmAuth, slmChPassTable=slmChPassTable)
