...
iso, IpAddress, Opaque, ObjectIdentity, Integer32, NotificationType, Counter64, MibIdentifier, Unsigned32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Opaque", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "MibIdentifier", "Unsigned32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits")
DisplayString, TextualConvention, TruthValue, RowStatus, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "RowStatus", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserCommunity=UserCommunity, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmSysMode=slmSysMode, slmRstpEnabled=slmRstpEnabled, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, UserLogin=UserLogin, slmSysSubnetMask=slmSysSubnetMask, slmTrapEnable=slmTrapEnable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmLogin=slmLogin, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassLogin=slmChPassLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminTable=slmAdminTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmRebootDelay=slmRebootDelay, slmSysOperStatus=slmSysOperStatus, slMain=slMain, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthCommunity=slmAuthCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPsuNumber=slmPsuNumber, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmConfigFile=slmConfigFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevStatus=slmSwRevStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmNetworkMode=slmNetworkMode, slmLicenseIndex=slmLicenseIndex, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDirectory=slmSwRevDirectory, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam3=slmTrapLogParam3, slmAdminEntry=slmAdminEntry, slmTid=slmTid, slmTrapDestAddress=slmTrapDestAddress, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, slmAuthLogin=slmAuthLogin, AdminAccess=AdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserAccess=slmTrapUserAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassTable=slmChPassTable, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmSys=slmSys, slmAdminPassword=slmAdminPassword, slmAdmin=slmAdmin, slmAuthPassword=slmAuthPassword, slmSysName=slmSysName, slmTrapPort=slmTrapPort, slmAuth=slmAuth, slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmDeact=slmSysAlmDeact, slmAdminLogin=slmAdminLogin, slmSwRevDate=slmSwRevDate, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestCommunity=slmTrapDestCommunity, slm40GConf=slm40GConf, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmLicenseTable=slmLicenseTable, slmTrapLogEntry=slmTrapLogEntry, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysSignalType=slmConfigSysSignalType)
