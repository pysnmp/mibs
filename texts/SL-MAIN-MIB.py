...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmAdminPassword=slmAdminPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTid=slmTid, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminAccess=slmAdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapPort=slmTrapPort, slmConfigFile=slmConfigFile, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmSysSubnetMask=slmSysSubnetMask, slmTrapCommunity=slmTrapCommunity, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam5=slmTrapLogParam5, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevEntry=slmSwRevEntry, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmTrapEnable=slmTrapEnable, slmTrapLogId=slmTrapLogId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysChassisId=slmSysChassisId, UserPassword=UserPassword, slmAuthLogin=slmAuthLogin, slmPsuNumber=slmPsuNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassNewPass=slmChPassNewPass, slMain=slMain, slmSyslogLevel=slmSyslogLevel, slmLicenseEntry=slmLicenseEntry, slmSysName=slmSysName, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, PYSNMP_MODULE_ID=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber, slmSysMode=slmSysMode, slmAdminRowStatus=slmAdminRowStatus, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthPassword=slmAuthPassword, slmTrapLogTable=slmTrapLogTable, slmTrapDestCommunity=slmTrapDestCommunity, slmVcatDelay=slmVcatDelay, slmAdminEntry=slmAdminEntry, slmTrapUserLogin=slmTrapUserLogin, slmSys=slmSys, slmSysLocation=slmSysLocation, slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmAdminTable=slmAdminTable, slmLogin=slmLogin, UserLogin=UserLogin, slmWriteCommunity=slmWriteCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmChPass=slmChPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmChPassEntry=slmChPassEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmAdmin=slmAdmin, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysUptime=slmConfigSysUptime, slmTrapUserAccess=slmTrapUserAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmSysAlmAct=slmSysAlmAct, slmAdminLogin=slmAdminLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAdminStatus=slmSysAdminStatus, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability)
