...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmAdmin=slmAdmin, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmEdfaNumber=slmEdfaNumber, slmSysOperStatus=slmSysOperStatus, slmSyslogPort=slmSyslogPort, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestRowStatus=slmSyslogDestRowStatus, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysResetPm=slmSysResetPm, slMain=slMain, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserAccess=slmTrapUserAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmBoxSize=slmBoxSize, slmAuthCommunity=slmAuthCommunity, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmVcatDelay=slmVcatDelay, slmTrapLogId=slmTrapLogId, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassNewPass=slmChPassNewPass, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserLogin=UserLogin, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmSwRevTable=slmSwRevTable, slmAdminRowStatus=slmAdminRowStatus, slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmSysMode=slmSysMode, slmSwRevStatus=slmSwRevStatus, slmSysName=slmSysName, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogLevel=slmSyslogLevel, slmTrapPort=slmTrapPort, slmSysTemperature=slmSysTemperature, slmTrapLogTable=slmTrapLogTable, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmTrapDestAddress=slmTrapDestAddress, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserLogin=slmTrapUserLogin, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmAuthPassword=slmAuthPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseExpiration=slmLicenseExpiration, slmMuxNumber=slmMuxNumber, slmTrapLogName=slmTrapLogName, slmTrapEnable=slmTrapEnable, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmRstpEnabled=slmRstpEnabled, slmTid=slmTid, slmChPass=slmChPass, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, UserPassword=UserPassword, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr)
