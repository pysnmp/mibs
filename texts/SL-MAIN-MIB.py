...
NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Gauge32, iso, Counter64, ObjectIdentity, Counter32, Unsigned32, Integer32, MibIdentifier, TimeTicks, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Gauge32", "iso", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "Integer32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Password=slmSnmpv3Password, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmTrapDestEntry=slmTrapDestEntry, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevName=slmSwRevName, slmAdminLogin=slmAdminLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassEntry=slmChPassEntry, slm40GConf=slm40GConf, slmSysUplinkRate=slmSysUplinkRate, slmAdminAccess=slmAdminAccess, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmSysTrapFormat=slmSysTrapFormat, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmLicenseEntry=slmLicenseEntry, slmSwRevDate=slmSwRevDate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmSysLocation=slmSysLocation, slMain=slMain, slmNetworkMode=slmNetworkMode, slmTrapLogParam5=slmTrapLogParam5, slmSysResetPm=slmSysResetPm, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysUptime=slmConfigSysUptime, slmSysSubnetMask=slmSysSubnetMask, slmTid=slmTid, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slmChPass=slmChPass, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmLicenseTable=slmLicenseTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmConfigFile=slmConfigFile, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmSysAdminStatus=slmSysAdminStatus, slmLicense=slmLicense, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, UserLogin=UserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPsuNumber=slmPsuNumber, slmTrapLogParam1=slmTrapLogParam1, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmSwRevTable=slmSwRevTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogEntry=slmTrapLogEntry, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmSys=slmSys, slmSysMode=slmSysMode, slmAdminPassword=slmAdminPassword, slmTrapLogName=slmTrapLogName, slmSysAlmAct=slmSysAlmAct, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, PYSNMP_MODULE_ID=slMain, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSysIpAddr=slmSysIpAddr, slmLogFile=slmLogFile, slmTrapLogParam6=slmTrapLogParam6, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogId=slmTrapLogId, slmChPassTable=slmChPassTable, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmWriteCommunity=slmWriteCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogPort=slmSyslogPort, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmTrap=slmTrap, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmTrapPort=slmTrapPort, slmTrapCommunity=slmTrapCommunity)
