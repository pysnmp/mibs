...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmVcatDelay=slmVcatDelay, slMain=slMain, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam4=slmTrapLogParam4, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmAuthTable=slmAuthTable, slmTrap=slmTrap, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmTrapLogParam6=slmTrapLogParam6, slmPmAvailable=slmPmAvailable, slmSyslogLevel=slmSyslogLevel, slmAdminTable=slmAdminTable, slmLicenseIndex=slmLicenseIndex, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmWriteCommunity=slmWriteCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminAccess=slmAdminAccess, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassLogin=slmChPassLogin, slmSwRevName=slmSwRevName, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, UserCommunity=UserCommunity, slmSysMode=slmSysMode, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam2=slmTrapLogParam2, slmSwRevStatus=slmSwRevStatus, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, PYSNMP_MODULE_ID=slMain, slmSwRevTable=slmSwRevTable, slmTrapDestAddress=slmTrapDestAddress, slmMuxNumber=slmMuxNumber, slmAdmin=slmAdmin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Priv=slmSnmpv3Priv, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam5=slmTrapLogParam5, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmConfigFile=slmConfigFile, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, slmSysChassisId=slmSysChassisId, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmSysCalendarTime=slmSysCalendarTime, slmSysResetPm=slmSysResetPm, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDirectory=slmSwRevDirectory, slmSysTrapFormat=slmSysTrapFormat, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmLogFile=slmLogFile, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, slmAdminEntry=slmAdminEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysSnmpVersion=slmSysSnmpVersion, slmPsuNumber=slmPsuNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmSysTemperature=slmSysTemperature, UserLogin=UserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmAuth=slmAuth, slmAdminRowStatus=slmAdminRowStatus, slmLicense=slmLicense, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, slmSysAdminStatus=slmSysAdminStatus, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, slmOemType=slmOemType, slmSnmpv3Password=slmSnmpv3Password, slmSysName=slmSysName, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmAuthCommunity=slmAuthCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseEntry=slmLicenseEntry)
