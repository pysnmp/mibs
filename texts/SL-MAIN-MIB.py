...
IpAddress, Gauge32, Counter64, MibIdentifier, ModuleIdentity, ObjectIdentity, Bits, Counter32, TimeTicks, NotificationType, Integer32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter64", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Bits", "Counter32", "TimeTicks", "NotificationType", "Integer32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminAccess=slmAdminAccess, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmSyslogPort=slmSyslogPort, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTemperature=slmSysTemperature, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmSysMode=slmSysMode, slmSysIpAddr=slmSysIpAddr, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, slmSysName=slmSysName, slmAdminPassword=slmAdminPassword, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserLogin=slmTrapUserLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminTable=slmAdminTable, slmChPassLogin=slmChPassLogin, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserCommunity=UserCommunity, slmLicenseIndex=slmLicenseIndex, slmAuthTable=slmAuthTable, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam4=slmTrapLogParam4, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, AdminAccess=AdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevStatus=slmSwRevStatus, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam2=slmTrapLogParam2, slmRebootDelay=slmRebootDelay, slmSyslogLevel=slmSyslogLevel, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestAddress=slmTrapDestAddress, slmTrapEnable=slmTrapEnable, slmTrapLogParam6=slmTrapLogParam6, slmAdminRowStatus=slmAdminRowStatus, slmTid=slmTid, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestCommunity=slmTrapDestCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slMain=slMain, PYSNMP_MODULE_ID=slMain, slmAdminLogin=slmAdminLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevName=slmSwRevName, slmSwRevDirectory=slmSwRevDirectory, slmOemType=slmOemType, slmLicenseTable=slmLicenseTable, slmReadCommunity=slmReadCommunity, slmSysLocation=slmSysLocation, slmTrapLogParam1=slmTrapLogParam1, slmEdfaNumber=slmEdfaNumber, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrap=slmTrap, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPmAvailable=slmPmAvailable, slmSysTrapFormat=slmSysTrapFormat, slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmTrapCommunity=slmTrapCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmMuxNumber=slmMuxNumber, slmSysResetPm=slmSysResetPm, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmLicenseEntry=slmLicenseEntry, slmAuth=slmAuth, UserLogin=UserLogin, slm40GConf=slm40GConf, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, slmChPass=slmChPass)
