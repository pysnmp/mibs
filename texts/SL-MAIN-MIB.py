...
ObjectIdentity, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter32, Integer32, ModuleIdentity, Bits, TimeTicks, NotificationType, Opaque, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter32", "Integer32", "ModuleIdentity", "Bits", "TimeTicks", "NotificationType", "Opaque", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, AdminAccess=AdminAccess, slmSwRevName=slmSwRevName, slmEdfaNumber=slmEdfaNumber, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, slmSysUplinkRate=slmSysUplinkRate, slmPsuNumber=slmPsuNumber, slMain=slMain, slmTrapDestEntry=slmTrapDestEntry, slmAdminPassword=slmAdminPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmLicenseEntry=slmLicenseEntry, slmLicense=slmLicense, slmSysMode=slmSysMode, UserCommunity=UserCommunity, slmChPassEntry=slmChPassEntry, slmLogin=slmLogin, slmAdminCommunity=slmAdminCommunity, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmLogFile=slmLogFile, slmNetworkMode=slmNetworkMode, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanIpAddr=slmSysLanIpAddr, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmAdmin=slmAdmin, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmSysIpAddr=slmSysIpAddr, slmPmAvailable=slmPmAvailable, slmReadCommunity=slmReadCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthPassword=slmAuthPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slm40GConf=slm40GConf, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminLogin=slmAdminLogin, PYSNMP_MODULE_ID=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLocation=slmSysLocation, slmChPassLogin=slmChPassLogin, slmTrapLogParam5=slmTrapLogParam5, slmLicenseTable=slmLicenseTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmMuxNumber=slmMuxNumber, slmLicenseId=slmLicenseId, slmTrapSysNameChange=slmTrapSysNameChange, slmPortsNumber=slmPortsNumber, UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmAuth=slmAuth, slmChPassNewPass=slmChPassNewPass, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmChPassOldPass=slmChPassOldPass, slmTrapDestTable=slmTrapDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, slmTrap=slmTrap, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmSwRevDirectory=slmSwRevDirectory, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysResetPm=slmSysResetPm, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile)
