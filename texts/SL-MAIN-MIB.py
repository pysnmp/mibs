...
TimeTicks, Integer32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Opaque, iso, Bits, Gauge32, Counter64, Unsigned32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Opaque", "iso", "Bits", "Gauge32", "Counter64", "Unsigned32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAdminStatus=slmSysAdminStatus, slmPmAvailable=slmPmAvailable, slmTrapCommunity=slmTrapCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevName=slmSwRevName, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmAdminEntry=slmAdminEntry, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, slmSysResetPm=slmSysResetPm, slmAuthPassword=slmAuthPassword, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmNetworkMode=slmNetworkMode, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam3=slmTrapLogParam3, UserCommunity=UserCommunity, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmSysLanIpAddr=slmSysLanIpAddr, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmTrapDestAddress=slmTrapDestAddress, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminLogin=slmAdminLogin, slmAdminCommunity=slmAdminCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrap=slmTrap, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmTrapPort=slmTrapPort, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseTable=slmLicenseTable, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmWriteCommunity=slmWriteCommunity, slmSwRevStatus=slmSwRevStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, UserLogin=UserLogin, slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slm40GConf=slm40GConf, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogName=slmTrapLogName, slmChPass=slmChPass, slmLogFile=slmLogFile, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysUptime=slmConfigSysUptime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slMain=slMain, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slmTid=slmTid, slmSysChassisId=slmSysChassisId, slmChPassNewPass=slmChPassNewPass, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmSwRevEntry=slmSwRevEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, AdminAccess=AdminAccess, slmSysName=slmSysName, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmTrapLogParam6=slmTrapLogParam6, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmSwRevDirectory=slmSwRevDirectory, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4)
