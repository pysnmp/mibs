...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthEntry=slmAuthEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, slmTid=slmTid, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmAdmin=slmAdmin, slmLicense=slmLicense, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysChassisId=slmSysChassisId, UserPassword=UserPassword, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, PYSNMP_MODULE_ID=slMain, slmLogFile=slmLogFile, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmPmAvailable=slmPmAvailable, slmSysMode=slmSysMode, slmAdminPassword=slmAdminPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserLogin=slmTrapUserLogin, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmConfigFile=slmConfigFile, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam1=slmTrapLogParam1, slmChPassEntry=slmChPassEntry, slmLicenseIndex=slmLicenseIndex, slmMuxNumber=slmMuxNumber, slmTrapLogParam3=slmTrapLogParam3, slmVcatDelay=slmVcatDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, slmChPassLogin=slmChPassLogin, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, UserCommunity=UserCommunity, slmAuth=slmAuth, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmEdfaNumber=slmEdfaNumber, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmAuthCommunity=slmAuthCommunity, slmSwRevTable=slmSwRevTable, slmTrapLogName=slmTrapLogName, slmAuthPassword=slmAuthPassword, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPass=slmChPass, slmSysAlmDeact=slmSysAlmDeact, slmWriteCommunity=slmWriteCommunity, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogTable=slmTrapLogTable, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysUptime=slmConfigSysUptime, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmReadCommunity=slmReadCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, SoftwareRevision=SoftwareRevision, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmSyslogLevel=slmSyslogLevel)
