...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysMode=slmSysMode, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTable=slmTrapLogTable, slmSys=slmSys, slmSysLocation=slmSysLocation, slmTrapCommunity=slmTrapCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminAccess=slmAdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminPassword=slmAdminPassword, slmOemType=slmOemType, slmPortsNumber=slmPortsNumber, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminRowStatus=slmAdminRowStatus, slmBoxSize=slmBoxSize, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmEdfaNumber=slmEdfaNumber, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmWriteCommunity=slmWriteCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevTable=slmSwRevTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmSysUplinkRate=slmSysUplinkRate, slmVcatDelay=slmVcatDelay, slmChPass=slmChPass, slmSnmpv3Priv=slmSnmpv3Priv, slmLogin=slmLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseEntry=slmLicenseEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, UserCommunity=UserCommunity, slmSysTrapFormat=slmSysTrapFormat, slmChPassLogin=slmChPassLogin, slmAuthPassword=slmAuthPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTemperature=slmSysTemperature, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmPsuNumber=slmPsuNumber, slmLicenseExpiration=slmLicenseExpiration, slmAdmin=slmAdmin, slmTopologyEnabled=slmTopologyEnabled, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, slmConfigFile=slmConfigFile, slmSwRevName=slmSwRevName, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmTrapDestTable=slmTrapDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, UserPassword=UserPassword, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmAdminLogin=slmAdminLogin, slmAuth=slmAuth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmTrapLogId=slmTrapLogId, slmSwRevStatus=slmSwRevStatus, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmChPassEntry=slmChPassEntry, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, SoftwareRevision=SoftwareRevision, slmChPassNewPass=slmChPassNewPass, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmLicense=slmLicense, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmSysIpAddr=slmSysIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, AdminAccess=AdminAccess, slmLogFile=slmLogFile, slmOpticalSwitchExist=slmOpticalSwitchExist)
