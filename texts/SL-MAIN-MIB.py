...
MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, ModuleIdentity, IpAddress, Counter32, Bits, Integer32, NotificationType, iso, Counter64, TimeTicks, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "ModuleIdentity", "IpAddress", "Counter32", "Bits", "Integer32", "NotificationType", "iso", "Counter64", "TimeTicks", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmAuthPassword=slmAuthPassword, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, slmSysChassisId=slmSysChassisId, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmPmAvailable=slmPmAvailable, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminAccess=slmAdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam1=slmTrapLogParam1, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmSysTemperature=slmSysTemperature, AdminAccess=AdminAccess, slmConfigFile=slmConfigFile, slmAuth=slmAuth, slmLicenseId=slmLicenseId, slmLicenseTable=slmLicenseTable, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmSysSubnetMask=slmSysSubnetMask, slmTrap=slmTrap, slmAdminEntry=slmAdminEntry, slm40GConf=slm40GConf, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminPassword=slmAdminPassword, slmTrapLogId=slmTrapLogId, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmAct=slmSysAlmAct, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmConfigSysUptime=slmConfigSysUptime, slmPortsNumber=slmPortsNumber, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Priv=slmSnmpv3Priv, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevDirectory=slmSwRevDirectory, UserLogin=UserLogin, UserPassword=UserPassword, slmRebootDelay=slmRebootDelay, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmSysResetPm=slmSysResetPm, slmAuthEntry=slmAuthEntry, slMain=slMain, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSnmpVersion=slmSysSnmpVersion, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slmSysOperStatus=slmSysOperStatus, SoftwareRevision=SoftwareRevision, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmLogFile=slmLogFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmLicense=slmLicense, slmOemType=slmOemType, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmAdminLogin=slmAdminLogin, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayAddr=slmSysGatewayAddr, slmSys=slmSys, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmSysLocation=slmSysLocation, slmReadCommunity=slmReadCommunity, slmTrapLogName=slmTrapLogName, slmChPass=slmChPass, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, slmVcatDelay=slmVcatDelay, slmAdminTable=slmAdminTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth)
