...
TimeTicks, NotificationType, Unsigned32, Bits, ObjectIdentity, Counter64, Gauge32, iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Opaque, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity", "Counter64", "Gauge32", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Opaque", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthLogin=slmAuthLogin, slmSysLocation=slmSysLocation, slmTrapPort=slmTrapPort, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, UserLogin=UserLogin, slm40GConf=slm40GConf, slmRstpEnabled=slmRstpEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTid=slmTid, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassNewPass=slmChPassNewPass, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmAuthTable=slmAuthTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, slmOemType=slmOemType, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmPmAvailable=slmPmAvailable, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, slmReadCommunity=slmReadCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmSysCalendarTime=slmSysCalendarTime, slmAuthEntry=slmAuthEntry, slmAdminAccess=slmAdminAccess, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmVcatDelay=slmVcatDelay, slmTrapLogParam4=slmTrapLogParam4, slmAuthCommunity=slmAuthCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmAdminLogin=slmAdminLogin, slmChPassTable=slmChPassTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmLicenseExpiration=slmLicenseExpiration, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmMuxNumber=slmMuxNumber, slmBoxSize=slmBoxSize, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogName=slmTrapLogName, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogId=slmTrapLogId, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmPortsNumber=slmPortsNumber, slmSwRevTable=slmSwRevTable, slmLicense=slmLicense, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseId=slmLicenseId, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmAdminTable=slmAdminTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmAdminRowStatus=slmAdminRowStatus, slmRebootDelay=slmRebootDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestEntry=slmTrapDestEntry, slmChPassOldPass=slmChPassOldPass, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAdminStatus=slmSysAdminStatus, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmLogFile=slmLogFile, slmAdmin=slmAdmin, slmConfigFile=slmConfigFile, slmAdminEntry=slmAdminEntry, slmNetworkMode=slmNetworkMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysMode=slmSysMode, slmLicenseIndex=slmLicenseIndex, AdminAccess=AdminAccess, slmSysIpAddr=slmSysIpAddr, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
