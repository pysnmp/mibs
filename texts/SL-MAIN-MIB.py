...
TimeTicks, iso, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, ModuleIdentity, IpAddress, Unsigned32, ObjectIdentity, NotificationType, Bits, Counter32, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "ModuleIdentity", "IpAddress", "Unsigned32", "ObjectIdentity", "NotificationType", "Bits", "Counter32", "Gauge32", "Integer32")
TextualConvention, TruthValue, TimeStamp, DateAndTime, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "DateAndTime", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseEntry=slmLicenseEntry, slmTid=slmTid, slmSysTemperature=slmSysTemperature, slmSyslogLevel=slmSyslogLevel, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slmAdminLogin=slmAdminLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPass=slmChPass, slmSyslogPort=slmSyslogPort, slmAdminEntry=slmAdminEntry, slmSysName=slmSysName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, slmConfigFile=slmConfigFile, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Password=slmSnmpv3Password, slmLicenseIndex=slmLicenseIndex, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserAccess=slmTrapUserAccess, slmSysMode=slmSysMode, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slmSys=slmSys, slmLicenseId=slmLicenseId, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTable=slmTrapLogTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmSysAdminStatus=slmSysAdminStatus, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmSwRevDate=slmSwRevDate, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmLicenseTable=slmLicenseTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmLicense=slmLicense, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAuth=slmAuth, slmLogFile=slmLogFile, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmSysIpAddr=slmSysIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmSysOperStatus=slmSysOperStatus, slmChPassTable=slmChPassTable, UserCommunity=UserCommunity, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmTopologyEnabled=slmTopologyEnabled, slmSwRevStatus=slmSwRevStatus, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slMain=slMain, slmConfigSysUptime=slmConfigSysUptime, slmSysLocation=slmSysLocation, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, slmSysResetPm=slmSysResetPm, slmSyslogDestAddress=slmSyslogDestAddress, slm40GConf=slm40GConf, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmSysAlmAct=slmSysAlmAct, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmTrapLogName=slmTrapLogName, slmTrapDestIpAddress=slmTrapDestIpAddress, AdminAccess=AdminAccess, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin)
