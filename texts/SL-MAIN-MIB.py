...
Opaque, Gauge32, ModuleIdentity, NotificationType, iso, IpAddress, Counter32, Bits, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Gauge32", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "Counter32", "Bits", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "MibIdentifier", "Unsigned32")
RowStatus, TextualConvention, TimeStamp, DateAndTime, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "DateAndTime", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysChassisId=slmSysChassisId, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmTrapLogParam6=slmTrapLogParam6, UserCommunity=UserCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestTable=slmTrapDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmTrapPort=slmTrapPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmChPassTable=slmChPassTable, slmChPass=slmChPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassLogin=slmChPassLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmAdminPassword=slmAdminPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminAccess=slmAdminAccess, slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapCommunity=slmTrapCommunity, slmSys=slmSys, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDate=slmSwRevDate, slmLicenseExpiration=slmLicenseExpiration, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmAdminRowStatus=slmAdminRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogEntry=slmTrapLogEntry, slmChPassNewPass=slmChPassNewPass, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmWriteCommunity=slmWriteCommunity, slmSysTemperature=slmSysTemperature, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmPsuNumber=slmPsuNumber, slmTrapLogName=slmTrapLogName, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, UserPassword=UserPassword, slm40GConf=slm40GConf, slmSyslogPort=slmSyslogPort, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthPassword=slmAuthPassword, UserLogin=UserLogin, slmAuthTable=slmAuthTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseTable=slmLicenseTable, slmChPassEntry=slmChPassEntry, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseId=slmLicenseId, slMain=slMain, slmEdfaNumber=slmEdfaNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmRstpEnabled=slmRstpEnabled, slmAdminCommunity=slmAdminCommunity, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmSysCalendarTime=slmSysCalendarTime, slmSysIpAddr=slmSysIpAddr, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slmAdminLogin=slmAdminLogin, slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmSysLocation=slmSysLocation, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestAddress=slmSyslogDestAddress, slmLicense=slmLicense, slmConfigFile=slmConfigFile, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam4=slmTrapLogParam4, slmAdminTable=slmAdminTable, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmAdminEntry=slmAdminEntry)
