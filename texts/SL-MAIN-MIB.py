...
IpAddress, NotificationType, Bits, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Counter32, ModuleIdentity, Opaque, TimeTicks, Gauge32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Bits", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Counter32", "ModuleIdentity", "Opaque", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassNewPass=slmChPassNewPass, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, PYSNMP_MODULE_ID=slMain, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, slmChPassEntry=slmChPassEntry, slmAdminEntry=slmAdminEntry, slmAdmin=slmAdmin, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmLicense=slmLicense, slmAuthEntry=slmAuthEntry, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthPassword=slmAuthPassword, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysName=slmSysName, slmTrapLogParam5=slmTrapLogParam5, slmChPassLogin=slmChPassLogin, slmAdminPassword=slmAdminPassword, slmAuthLogin=slmAuthLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmSysSubnetMask=slmSysSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLocation=slmSysLocation, slmChPassTable=slmChPassTable, AdminAccess=AdminAccess, slMain=slMain, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmLogFile=slmLogFile, slmSysMode=slmSysMode, slmSnmpv3Priv=slmSnmpv3Priv, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slmLogin=slmLogin, slmSyslogPort=slmSyslogPort, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmSysCalendarTime=slmSysCalendarTime, slmPsuNumber=slmPsuNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmAdminRowStatus=slmAdminRowStatus, slmEdfaNumber=slmEdfaNumber, slmAuthCommunity=slmAuthCommunity, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestTable=slmTrapDestTable, slmAdminTable=slmAdminTable, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmReadCommunity=slmReadCommunity, slmAdminAccess=slmAdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmWriteCommunity=slmWriteCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmPmAvailable=slmPmAvailable, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmSwRevDate=slmSwRevDate, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, SoftwareRevision=SoftwareRevision, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slm40GConf=slm40GConf, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogName=slmTrapLogName, slmLicenseEntry=slmLicenseEntry, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserLogin=UserLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogId=slmTrapLogId, slmTrapEnable=slmTrapEnable, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam4=slmTrapLogParam4, slmTid=slmTid, slmLicenseTable=slmLicenseTable, slmSysOperStatus=slmSysOperStatus, slmBoxSize=slmBoxSize, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmAuthTable=slmAuthTable, slmSysAlmAct=slmSysAlmAct, slmChPass=slmChPass, slmSyslogDestEntry=slmSyslogDestEntry, slmTopologyEnabled=slmTopologyEnabled)
