...
Counter64, IpAddress, Bits, Counter32, Unsigned32, Gauge32, NotificationType, Integer32, ObjectIdentity, TimeTicks, iso, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Bits", "Counter32", "Unsigned32", "Gauge32", "NotificationType", "Integer32", "ObjectIdentity", "TimeTicks", "iso", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmOemType=slmOemType, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmSwRevDirectory=slmSwRevDirectory, slmLogFile=slmLogFile, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmDeact=slmSysAlmDeact, slmBoxSize=slmBoxSize, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmTrapPort=slmTrapPort, slmLogin=slmLogin, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, slmRstpEnabled=slmRstpEnabled, slmTrapDestCommunity=slmTrapDestCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmAdminLogin=slmAdminLogin, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmLicenseTable=slmLicenseTable, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmAdmin=slmAdmin, slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, slmAuth=slmAuth, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slmLicense=slmLicense, slmChPassEntry=slmChPassEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevStatus=slmSwRevStatus, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTid=slmTid, slmPmAvailable=slmPmAvailable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmAuthEntry=slmAuthEntry, slmAuthPassword=slmAuthPassword, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmTrapLogTable=slmTrapLogTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, UserCommunity=UserCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysNameChange=slmTrapSysNameChange, slmWriteCommunity=slmWriteCommunity, slmSwRevTable=slmSwRevTable, slmMuxNumber=slmMuxNumber, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam4=slmTrapLogParam4, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmReadCommunity=slmReadCommunity, slmAdminAccess=slmAdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, slMain=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSysChassisId=slmSysChassisId, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmSysResetPm=slmSysResetPm, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogName=slmTrapLogName)
