...
IpAddress, ObjectIdentity, iso, Counter64, Unsigned32, ModuleIdentity, TimeTicks, Opaque, Bits, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "iso", "Counter64", "Unsigned32", "ModuleIdentity", "TimeTicks", "Opaque", "Bits", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32")
TextualConvention, DisplayString, TimeStamp, RowStatus, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "RowStatus", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserCommunity=UserCommunity, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmAuthLogin=slmAuthLogin, slmAdminTable=slmAdminTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, slmAdminLogin=slmAdminLogin, slmTrapLogName=slmTrapLogName, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmSys=slmSys, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseId=slmLicenseId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmSwRevTable=slmSwRevTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam1=slmTrapLogParam1, AdminAccess=AdminAccess, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmWriteCommunity=slmWriteCommunity, slmOemType=slmOemType, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, slmTrapUserLogin=slmTrapUserLogin, slmEdfaNumber=slmEdfaNumber, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysOperStatus=slmSysOperStatus, slmTid=slmTid, slmAdminPassword=slmAdminPassword, slmConfigFile=slmConfigFile, slMain=slMain, slmPsuNumber=slmPsuNumber, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestTable=slmTrapDestTable, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminEntry=slmAdminEntry, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmSwRevDirectory=slmSwRevDirectory, slmSysName=slmSysName, slm40GConf=slm40GConf, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmTrapCommunity=slmTrapCommunity, slmNetworkMode=slmNetworkMode, slmTrapPort=slmTrapPort, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysChassisId=slmSysChassisId, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, slmSysAlmDeact=slmSysAlmDeact, slmChPassOldPass=slmChPassOldPass, slmSyslogDestEntry=slmSyslogDestEntry, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmChPassEntry=slmChPassEntry, slmTrapLogId=slmTrapLogId, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmSysLanIpAddr=slmSysLanIpAddr, slmLicense=slmLicense, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmAuthCommunity=slmAuthCommunity, slmTrapLogTable=slmTrapLogTable, slmChPassTable=slmChPassTable, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmSnmpv3Priv=slmSnmpv3Priv, slmReadCommunity=slmReadCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber, slmSysMode=slmSysMode)
