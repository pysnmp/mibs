...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapPort=slmTrapPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDirectory=slmSwRevDirectory, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slMain=slMain, slmConfigFile=slmConfigFile, slmSysTemperature=slmSysTemperature, slmSwRevEntry=slmSwRevEntry, slmAuth=slmAuth, slmSysSubnetMask=slmSysSubnetMask, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthPassword=slmAuthPassword, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmLogFile=slmLogFile, slmSysMode=slmSysMode, slmChPassEntry=slmChPassEntry, slmTrapUserAccess=slmTrapUserAccess, slmLicenseTable=slmLicenseTable, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmLicenseEntry=slmLicenseEntry, slmAdmin=slmAdmin, slmLicense=slmLicense, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmTid=slmTid, slmChPass=slmChPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, slmRebootDelay=slmRebootDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserCommunity=UserCommunity, slmTrapLogTable=slmTrapLogTable, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, slm40GConf=slm40GConf, slmChPassLogin=slmChPassLogin, slmAdminEntry=slmAdminEntry, slmSysTrapFormat=slmSysTrapFormat, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmWriteCommunity=slmWriteCommunity, slmEdfaNumber=slmEdfaNumber, slmChPassOldPass=slmChPassOldPass, slmSyslogDestTable=slmSyslogDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysUptime=slmConfigSysUptime, slmSwRevStatus=slmSwRevStatus, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogId=slmTrapLogId, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmSwRevName=slmSwRevName, slmOemType=slmOemType, slmPsuNumber=slmPsuNumber, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, AdminAccess=AdminAccess, slmLicenseId=slmLicenseId, slmLogin=slmLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminCommunity=slmAdminCommunity, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmNetworkMode=slmNetworkMode, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysResetPm=slmSysResetPm, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmSysIpAddr=slmSysIpAddr, slmAdminAccess=slmAdminAccess, slmTrapEnable=slmTrapEnable, slmSysAdminStatus=slmSysAdminStatus)
