...
ModuleIdentity, iso, Integer32, Gauge32, NotificationType, IpAddress, Counter32, Opaque, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Integer32", "Gauge32", "NotificationType", "IpAddress", "Counter32", "Opaque", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits")
TextualConvention, RowStatus, DateAndTime, TimeStamp, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DateAndTime", "TimeStamp", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPortsNumber=slmPortsNumber, slmSysChassisId=slmSysChassisId, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapEnable=slmTrapEnable, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, SoftwareRevision=SoftwareRevision, slmSwRevEntry=slmSwRevEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysMode=slmSysMode, slmAuthTable=slmAuthTable, slmSysResetPm=slmSysResetPm, slmSysOperStatus=slmSysOperStatus, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, slmChPassEntry=slmChPassEntry, slmVcatDelay=slmVcatDelay, slmChPassTable=slmChPassTable, slmTrapLogParam2=slmTrapLogParam2, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Priv=slmSnmpv3Priv, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestTable=slmTrapDestTable, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogFile=slmLogFile, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmEdfaNumber=slmEdfaNumber, slmAuthPassword=slmAuthPassword, slmBoxSize=slmBoxSize, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmSysLocation=slmSysLocation, slmLicenseId=slmLicenseId, slmTrapPort=slmTrapPort, slmTrapLogTable=slmTrapLogTable, slmMuxNumber=slmMuxNumber, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmAuthEntry=slmAuthEntry, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slmPmAvailable=slmPmAvailable, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserCommunity=UserCommunity, slmLicense=slmLicense, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmOemType=slmOemType, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmSysTrapFormat=slmSysTrapFormat, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysCalendarTime=slmSysCalendarTime, slmRebootDelay=slmRebootDelay, slmSwRevStatus=slmSwRevStatus, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, slMain=slMain, slmTrapUserLogin=slmTrapUserLogin, slmAuth=slmAuth, UserPassword=UserPassword, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmPsuNumber=slmPsuNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogPort=slmSyslogPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseEntry=slmLicenseEntry, slmLogin=slmLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminPassword=slmAdminPassword, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdmin=slmAdmin, slmTrapDestEntry=slmTrapDestEntry, slmSysSubnetMask=slmSysSubnetMask)
