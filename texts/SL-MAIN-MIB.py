...
ObjectIdentity, ModuleIdentity, Unsigned32, MibIdentifier, Integer32, iso, Bits, IpAddress, Opaque, Counter32, Counter64, TimeTicks, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Integer32", "iso", "Bits", "IpAddress", "Opaque", "Counter32", "Counter64", "TimeTicks", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapCommunity=slmTrapCommunity, UserPassword=UserPassword, slmSwRevDate=slmSwRevDate, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, AdminAccess=AdminAccess, slmRebootDelay=slmRebootDelay, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmTrap=slmTrap, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmTrapLogParam1=slmTrapLogParam1, slmSwRevName=slmSwRevName, slmAuthLogin=slmAuthLogin, slmAuthEntry=slmAuthEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmChPassEntry=slmChPassEntry, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmTid=slmTid, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmSyslogPort=slmSyslogPort, UserCommunity=UserCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseTable=slmLicenseTable, slmSnmpv3Priv=slmSnmpv3Priv, slmPsuNumber=slmPsuNumber, slmSwRevTable=slmSwRevTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysMode=slmSysMode, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseEntry=slmLicenseEntry, slmAdminCommunity=slmAdminCommunity, slmAdminLogin=slmAdminLogin, slmAdmin=slmAdmin, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmLogFile=slmLogFile, slmAdminPassword=slmAdminPassword, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogId=slmTrapLogId, slmTrapDestEntry=slmTrapDestEntry, slmSysLocation=slmSysLocation, slmSysChassisId=slmSysChassisId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestAddress=slmTrapDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysUptime=slmConfigSysUptime, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysIpAddr=slmSysIpAddr, slmRstpEnabled=slmRstpEnabled, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSys=slmSys, slmLicense=slmLicense, slmAdminEntry=slmAdminEntry, slmTrapUserAccess=slmTrapUserAccess, UserLogin=UserLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmMuxNumber=slmMuxNumber, slmLicenseIndex=slmLicenseIndex, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmSysResetPm=slmSysResetPm, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmSnmpv3Auth=slmSnmpv3Auth)
