...
Bits, ObjectIdentity, TimeTicks, ModuleIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Gauge32, MibIdentifier, Opaque, IpAddress, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Gauge32", "MibIdentifier", "Opaque", "IpAddress", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmSysName=slmSysName, slmSwRevTable=slmSwRevTable, slmTrapLogTable=slmTrapLogTable, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPortsNumber=slmPortsNumber, slmPmAvailable=slmPmAvailable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogPort=slmSyslogPort, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmSysOperStatus=slmSysOperStatus, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmSysMode=slmSysMode, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigFile=slmConfigFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, SoftwareRevision=SoftwareRevision, slmReadCommunity=slmReadCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSys=slmSys, slMain=slMain, slmLogin=slmLogin, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmTrapLogParam6=slmTrapLogParam6, slmChPassTable=slmChPassTable, slmLogFile=slmLogFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPsuNumber=slmPsuNumber, slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmAct=slmSysAlmAct, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapEnable=slmTrapEnable, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmAuthEntry=slmAuthEntry, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam5=slmTrapLogParam5, slmAdminTable=slmAdminTable, slmSysUplinkRate=slmSysUplinkRate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthTable=slmAuthTable, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, PYSNMP_MODULE_ID=slMain, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam3=slmTrapLogParam3, slmBoxSize=slmBoxSize, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmNetworkMode=slmNetworkMode, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminEntry=slmAdminEntry, slmOemType=slmOemType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmRebootDelay=slmRebootDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmWriteCommunity=slmWriteCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration)
