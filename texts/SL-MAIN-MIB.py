...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Unsigned32, Gauge32, Opaque, IpAddress, Counter64, iso, ObjectIdentity, TimeTicks, Bits, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Unsigned32", "Gauge32", "Opaque", "IpAddress", "Counter64", "iso", "ObjectIdentity", "TimeTicks", "Bits", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, slmPsuNumber=slmPsuNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigFile=slmConfigFile, slmAuthTable=slmAuthTable, slmChPassTable=slmChPassTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmChPassLogin=slmChPassLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmSysCalendarTime=slmSysCalendarTime, slmLogin=slmLogin, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmAuthCommunity=slmAuthCommunity, slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSwRevDate=slmSwRevDate, slMain=slMain, slmAdminCommunity=slmAdminCommunity, slmTrapPort=slmTrapPort, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmOpticalSwitchExist=slmOpticalSwitchExist, slmVcatDelay=slmVcatDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmAuth=slmAuth, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysMode=slmSysMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmLogFile=slmLogFile, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, slmSnmpv3Password=slmSnmpv3Password, slmBoxSize=slmBoxSize, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysNameChange=slmTrapSysNameChange, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmTrapCommunity=slmTrapCommunity, slmTrapUserLogin=slmTrapUserLogin, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmSwRevStatus=slmSwRevStatus, slmSwRevName=slmSwRevName, UserLogin=UserLogin, slmRstpEnabled=slmRstpEnabled, slmSysChassisId=slmSysChassisId, slmAdminEntry=slmAdminEntry, slmAdminTable=slmAdminTable, UserPassword=UserPassword, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmSysUplinkRate=slmSysUplinkRate, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode)
