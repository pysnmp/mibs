...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, TimeTicks, Counter64, Bits, IpAddress, ObjectIdentity, Counter32, Unsigned32, ModuleIdentity, Opaque, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "TimeTicks", "Counter64", "Bits", "IpAddress", "ObjectIdentity", "Counter32", "Unsigned32", "ModuleIdentity", "Opaque", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmAct=slmSysAlmAct, slmAdmin=slmAdmin, slmAdminEntry=slmAdminEntry, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, slmAuth=slmAuth, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, UserPassword=UserPassword, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmSwRevName=slmSwRevName, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthCommunity=slmAuthCommunity, slm40GConf=slm40GConf, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmSwRevDate=slmSwRevDate, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, SoftwareRevision=SoftwareRevision, slmAdminCommunity=slmAdminCommunity, slmAdminAccess=slmAdminAccess, slmLicenseEntry=slmLicenseEntry, slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, AdminAccess=AdminAccess, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmAuthPassword=slmAuthPassword, slmSysResetPm=slmSysResetPm, slmVcatDelay=slmVcatDelay, slmAuthLogin=slmAuthLogin, slmSwRevTable=slmSwRevTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, slmAuthEntry=slmAuthEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmSysName=slmSysName, slmSwRevStatus=slmSwRevStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicense=slmLicense, slmSysCalendarTime=slmSysCalendarTime, slmTopologyEnabled=slmTopologyEnabled, slmOemType=slmOemType, slmAdminLogin=slmAdminLogin, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassLogin=slmChPassLogin, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam6=slmTrapLogParam6, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmPortsNumber=slmPortsNumber, slmTrapLogName=slmTrapLogName, slmAuthTable=slmAuthTable, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmLogFile=slmLogFile, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserAccess=slmTrapUserAccess, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam3=slmTrapLogParam3, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseTable=slmLicenseTable, slmSyslogLevel=slmSyslogLevel, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmPsuNumber=slmPsuNumber, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmSysOperStatus=slmSysOperStatus, slmAdminPassword=slmAdminPassword)
