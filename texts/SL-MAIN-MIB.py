...
Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, Integer32, IpAddress, iso, NotificationType, Counter32, ObjectIdentity, MibIdentifier, Opaque, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "Integer32", "IpAddress", "iso", "NotificationType", "Counter32", "ObjectIdentity", "MibIdentifier", "Opaque", "Counter64")
TimeStamp, TruthValue, DateAndTime, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DateAndTime", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPortsNumber=slmPortsNumber, slmSwRevEntry=slmSwRevEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogId=slmTrapLogId, slmChPassEntry=slmChPassEntry, slmRstpEnabled=slmRstpEnabled, slmAuthEntry=slmAuthEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogName=slmTrapLogName, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slmChPassNewPass=slmChPassNewPass, slmLicenseExpiration=slmLicenseExpiration, AdminAccess=AdminAccess, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogPort=slmSyslogPort, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDate=slmSwRevDate, slmRebootDelay=slmRebootDelay, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slMain=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuth=slmAuth, slmEdfaNumber=slmEdfaNumber, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmAdminPassword=slmAdminPassword, slmAdminAccess=slmAdminAccess, slmSysTemperature=slmSysTemperature, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmSysIpAddr=slmSysIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmPmAvailable=slmPmAvailable, slmLicenseEntry=slmLicenseEntry, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmAdmin=slmAdmin, UserLogin=UserLogin, slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmSnmpv3Priv=slmSnmpv3Priv, PYSNMP_MODULE_ID=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSysMode=slmSysMode, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLocation=slmSysLocation, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmLicense=slmLicense, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmLogin=slmLogin, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestEntry=slmTrapDestEntry, slmLicenseTable=slmLicenseTable, SoftwareRevision=SoftwareRevision, slmSysChassisId=slmSysChassisId, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, slmVcatDelay=slmVcatDelay, slmSysCalendarTime=slmSysCalendarTime, slmAuthPassword=slmAuthPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, UserPassword=UserPassword, slmOemType=slmOemType, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapCommunity=slmTrapCommunity, slm40GConf=slm40GConf, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmSysUplinkRate=slmSysUplinkRate, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmBoxSize=slmBoxSize, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserCommunity=UserCommunity, slmAdminLogin=slmAdminLogin, slmSysName=slmSysName, slmTrapPort=slmTrapPort, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigFile=slmConfigFile, slmLicenseId=slmLicenseId, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion)
