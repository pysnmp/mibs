...
TimeTicks, Opaque, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, Gauge32, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Opaque", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Counter32", "iso")
DisplayString, DateAndTime, TextualConvention, TruthValue, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, UserLogin=UserLogin, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slmSysTrapFormat=slmSysTrapFormat, slmMuxNumber=slmMuxNumber, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmLicenseEntry=slmLicenseEntry, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigFile=slmConfigFile, slmAuthCommunity=slmAuthCommunity, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmSysResetPm=slmSysResetPm, slmTrapEnable=slmTrapEnable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserLogin=slmTrapUserLogin, slmBoxSize=slmBoxSize, slmWriteCommunity=slmWriteCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmSysOperStatus=slmSysOperStatus, slmLicenseId=slmLicenseId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSnmpVersion=slmSysSnmpVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, UserCommunity=UserCommunity, slmSysName=slmSysName, slmChPassLogin=slmChPassLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, SoftwareRevision=SoftwareRevision, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLocation=slmSysLocation, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmTrapLogParam6=slmTrapLogParam6, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmTrapCommunity=slmTrapCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmLogFile=slmLogFile, slmTrapLogParam5=slmTrapLogParam5, slmAuthEntry=slmAuthEntry, slmTrapLogId=slmTrapLogId, slmChPass=slmChPass, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestTable=slmTrapDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, AdminAccess=AdminAccess, slmAdminTable=slmAdminTable, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmChPassNewPass=slmChPassNewPass, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmSwRevName=slmSwRevName, slmChPassTable=slmChPassTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmNetworkMode=slmNetworkMode, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdmin=slmAdmin, slmRebootDelay=slmRebootDelay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmTopologyEnabled=slmTopologyEnabled, slm40GConf=slm40GConf)
