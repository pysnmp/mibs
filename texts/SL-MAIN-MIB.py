...
Gauge32, Integer32, Opaque, ModuleIdentity, TimeTicks, Bits, IpAddress, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, MibIdentifier, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Opaque", "ModuleIdentity", "TimeTicks", "Bits", "IpAddress", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "MibIdentifier", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmSwRevName=slmSwRevName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, SoftwareRevision=SoftwareRevision, slmAdminTable=slmAdminTable, slmSyslogPort=slmSyslogPort, slmRstpEnabled=slmRstpEnabled, slmChPassLogin=slmChPassLogin, slmEdfaNumber=slmEdfaNumber, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, slmAuthPassword=slmAuthPassword, slmPmAvailable=slmPmAvailable, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassEntry=slmChPassEntry, slmRebootDelay=slmRebootDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogFile=slmLogFile, slmChPass=slmChPass, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmAuth=slmAuth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminCommunity=slmAdminCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmNetworkMode=slmNetworkMode, slmSysAlmDeact=slmSysAlmDeact, slmPsuNumber=slmPsuNumber, slmSysTemperature=slmSysTemperature, slmTrapDestTable=slmTrapDestTable, slmChPassNewPass=slmChPassNewPass, UserPassword=UserPassword, slmLicense=slmLicense, slmSnmpv3Priv=slmSnmpv3Priv, slmBoxSize=slmBoxSize, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, AdminAccess=AdminAccess, slmWriteCommunity=slmWriteCommunity, slMain=slMain, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmReadCommunity=slmReadCommunity, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmSysOperStatus=slmSysOperStatus, slmTrapDestEntry=slmTrapDestEntry, slmLicenseId=slmLicenseId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam4=slmTrapLogParam4, UserCommunity=UserCommunity, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmAct=slmSysAlmAct, slmMuxNumber=slmMuxNumber, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, slmAdminEntry=slmAdminEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, slmTrap=slmTrap, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam2=slmTrapLogParam2, slmLicenseIndex=slmLicenseIndex, slm40GConf=slm40GConf, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogin=slmLogin, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSysMode=slmSysMode, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmSwRevDirectory=slmSwRevDirectory)
