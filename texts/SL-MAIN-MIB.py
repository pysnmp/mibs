...
IpAddress, ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, Opaque, Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "Opaque", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmAdmin=slmAdmin, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmTrapUserAccess=slmTrapUserAccess, slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmSwRevDirectory=slmSwRevDirectory, slmLogin=slmLogin, slmTrapDestEntry=slmTrapDestEntry, slmPsuNumber=slmPsuNumber, PYSNMP_MODULE_ID=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseTable=slmLicenseTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, SoftwareRevision=SoftwareRevision, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, AdminAccess=AdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmSysName=slmSysName, slmChPassLogin=slmChPassLogin, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminAccess=slmAdminAccess, slmAuth=slmAuth, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmSyslogPort=slmSyslogPort, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmChPassTable=slmChPassTable, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slmAdminEntry=slmAdminEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, slmChPassNewPass=slmChPassNewPass, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmLicenseId=slmLicenseId, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserLogin=slmTrapUserLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestTable=slmSyslogDestTable, slmRstpEnabled=slmRstpEnabled, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysSignalType=slmConfigSysSignalType, slmBoxSize=slmBoxSize, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPmAvailable=slmPmAvailable, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmReadCommunity=slmReadCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysNameChange=slmTrapSysNameChange, slMain=slMain, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam1=slmTrapLogParam1, slmAuthPassword=slmAuthPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthCommunity=slmAuthCommunity, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTid=slmTid, slmTrapDestTable=slmTrapDestTable, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, UserCommunity=UserCommunity, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmMuxNumber=slmMuxNumber, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmSysMode=slmSysMode, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmAdminPassword=slmAdminPassword, UserLogin=UserLogin, slmSwRevDate=slmSwRevDate, slmSwRevEntry=slmSwRevEntry, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmAdminTable=slmAdminTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmAdminCommunity=slmAdminCommunity, slmSwRevName=slmSwRevName, slmTrapEnable=slmTrapEnable)
