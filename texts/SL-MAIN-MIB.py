...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTable=slmTrapLogTable, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmOemType=slmOemType, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Password=slmSnmpv3Password, slmAdminTable=slmAdminTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysMode=slmSysMode, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTopologyEnabled=slmTopologyEnabled, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmChPassEntry=slmChPassEntry, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthPassword=slmAuthPassword, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slMain=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTid=slmTid, slmAdminAccess=slmAdminAccess, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmAct=slmSysAlmAct, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthCommunity=slmAuthCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSwRevTable=slmSwRevTable, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmSysOperStatus=slmSysOperStatus, slmAdminPassword=slmAdminPassword, slmTrapLogParam1=slmTrapLogParam1, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevStatus=slmSwRevStatus, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDirectory=slmSwRevDirectory, slmBoxSize=slmBoxSize, slmTrapLogParam2=slmTrapLogParam2, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmAdminCommunity=slmAdminCommunity, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, SoftwareRevision=SoftwareRevision, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserLogin=slmTrapUserLogin, slmLogFile=slmLogFile, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmTrapDestTable=slmTrapDestTable, slmWriteCommunity=slmWriteCommunity, slmMuxNumber=slmMuxNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassLogin=slmChPassLogin, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, slmChPassTable=slmChPassTable, slmSys=slmSys, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, UserPassword=UserPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmLicenseExpiration=slmLicenseExpiration, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminLogin=slmAdminLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseEntry=slmLicenseEntry, slmAuthLogin=slmAuthLogin, slmSysTemperature=slmSysTemperature, slmSysName=slmSysName, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysChassisId=slmSysChassisId)
