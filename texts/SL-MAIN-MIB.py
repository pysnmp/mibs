...
Opaque, Integer32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, TimeTicks, ObjectIdentity, iso, NotificationType, MibIdentifier, Counter64, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Integer32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "iso", "NotificationType", "MibIdentifier", "Counter64", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmPortsNumber=slmPortsNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmSysResetPm=slmSysResetPm, slmChPassTable=slmChPassTable, UserLogin=UserLogin, slmSysName=slmSysName, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slMain=slMain, slmLicenseIndex=slmLicenseIndex, slmNetworkMode=slmNetworkMode, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmTrapDestEntry=slmTrapDestEntry, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestTable=slmSyslogDestTable, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam5=slmTrapLogParam5, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmTrapLogParam6=slmTrapLogParam6, slmAuth=slmAuth, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmSys=slmSys, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmTid=slmTid, slmRebootDelay=slmRebootDelay, slmAdminLogin=slmAdminLogin, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, slmSysOperStatus=slmSysOperStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogEntry=slmTrapLogEntry, slmSwRevTable=slmSwRevTable, slmLogin=slmLogin, slmTrapLogId=slmTrapLogId, slmWriteCommunity=slmWriteCommunity, slmLicenseId=slmLicenseId, slmAuthPassword=slmAuthPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam3=slmTrapLogParam3, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam2=slmTrapLogParam2, slmTrapEnable=slmTrapEnable, slmSwRevEntry=slmSwRevEntry, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogName=slmTrapLogName, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, AdminAccess=AdminAccess, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmLicenseTable=slmLicenseTable, slmTrapLogTable=slmTrapLogTable, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmChPassLogin=slmChPassLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, slmSyslogLevel=slmSyslogLevel, slm40GConf=slm40GConf, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserLogin=slmTrapUserLogin)
