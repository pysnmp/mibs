...
Counter32, Counter64, ObjectIdentity, MibIdentifier, Opaque, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, ModuleIdentity, Gauge32, Unsigned32, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "ObjectIdentity", "MibIdentifier", "Opaque", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "Unsigned32", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTrapFormat=slmSysTrapFormat, slmConfigSysUptime=slmConfigSysUptime, slmAdminCommunity=slmAdminCommunity, slmPmAvailable=slmPmAvailable, slmPortsNumber=slmPortsNumber, slmSysMode=slmSysMode, slMain=slMain, AdminAccess=AdminAccess, slmTrapLogTable=slmTrapLogTable, slmTrapLogName=slmTrapLogName, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthCommunity=slmAuthCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmAdminPassword=slmAdminPassword, slmChPassOldPass=slmChPassOldPass, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmRstpEnabled=slmRstpEnabled, slmSysLocation=slmSysLocation, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam3=slmTrapLogParam3, slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slmChPassLogin=slmChPassLogin, slmPsuNumber=slmPsuNumber, slmConfigFile=slmConfigFile, slmChPassTable=slmChPassTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmEdfaNumber=slmEdfaNumber, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmChPassEntry=slmChPassEntry, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmTid=slmTid, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmSwRevEntry=slmSwRevEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, slmConfigSysSignalType=slmConfigSysSignalType, slmNetworkMode=slmNetworkMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, SoftwareRevision=SoftwareRevision, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmSwRevDirectory=slmSwRevDirectory, slmChPass=slmChPass, slmSysAlmAct=slmSysAlmAct, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmLicense=slmLicense, slmTrapLogParam2=slmTrapLogParam2, slmRebootDelay=slmRebootDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, PYSNMP_MODULE_ID=slMain, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam1=slmTrapLogParam1, slmLogin=slmLogin, slmAdminTable=slmAdminTable, slmSyslogPort=slmSyslogPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam6=slmTrapLogParam6, slmSysIpAddr=slmSysIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmTrapDestAddress=slmTrapDestAddress, slmAdminAccess=slmAdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmLicenseExpiration=slmLicenseExpiration, slmAdmin=slmAdmin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTopologyEnabled=slmTopologyEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmVcatDelay=slmVcatDelay)
