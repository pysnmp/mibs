...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Integer32, Counter32, Bits, Unsigned32, TimeTicks, MibIdentifier, NotificationType, Counter64, IpAddress, Opaque, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Integer32", "Counter32", "Bits", "Unsigned32", "TimeTicks", "MibIdentifier", "NotificationType", "Counter64", "IpAddress", "Opaque", "ModuleIdentity", "iso")
RowStatus, TextualConvention, DisplayString, DateAndTime, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DisplayString", "DateAndTime", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseIndex=slmLicenseIndex, slmAuthCommunity=slmAuthCommunity, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slmAuthPassword=slmAuthPassword, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, slmSyslogLevel=slmSyslogLevel, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmAdminAccess=slmAdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmTrapLogParam5=slmTrapLogParam5, slmAdminCommunity=slmAdminCommunity, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdmin=slmAdmin, slmAuthLogin=slmAuthLogin, slmTrapLogParam3=slmTrapLogParam3, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTid=slmTid, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmLicenseTable=slmLicenseTable, slmLicenseExpiration=slmLicenseExpiration, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmBoxSize=slmBoxSize, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slm40GConf=slm40GConf, slmTopologyEnabled=slmTopologyEnabled, slmPsuNumber=slmPsuNumber, slmTrapLogParam4=slmTrapLogParam4, slmAdminRowStatus=slmAdminRowStatus, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, slmSwRevStatus=slmSwRevStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slMain=slMain, slmChPassEntry=slmChPassEntry, slmSys=slmSys, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevTable=slmSwRevTable, slmTrapDestTable=slmTrapDestTable, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmAdminEntry=slmAdminEntry, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmLicenseId=slmLicenseId, slmWriteCommunity=slmWriteCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin)
