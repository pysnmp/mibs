...
MibIdentifier, iso, Bits, Counter64, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter32, Integer32, IpAddress, Unsigned32, TimeTicks, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Bits", "Counter64", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter32", "Integer32", "IpAddress", "Unsigned32", "TimeTicks", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSwRevStatus=slmSwRevStatus, slmSwRevDirectory=slmSwRevDirectory, slmSysTrapFormat=slmSysTrapFormat, slmSysIpAddr=slmSysIpAddr, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, slmEdfaNumber=slmEdfaNumber, AdminAccess=AdminAccess, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmBoxSize=slmBoxSize, slmVcatDelay=slmVcatDelay, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmTid=slmTid, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slm40GConf=slm40GConf, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseId=slmLicenseId, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysOperStatus=slmSysOperStatus, slmLicenseIndex=slmLicenseIndex, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmAuthEntry=slmAuthEntry, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmPsuNumber=slmPsuNumber, slmTrapDestEntry=slmTrapDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmChPassTable=slmChPassTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevTable=slmSwRevTable, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmSysMode=slmSysMode, slmTrapLogId=slmTrapLogId, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmLicense=slmLicense, slmAdminTable=slmAdminTable, slmLogin=slmLogin, slMain=slMain, slmSys=slmSys, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthPassword=slmAuthPassword, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmRebootDelay=slmRebootDelay, slmTrapLogParam4=slmTrapLogParam4, slmChPassEntry=slmChPassEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, SoftwareRevision=SoftwareRevision, slmAdmin=slmAdmin, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogName=slmTrapLogName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTable=slmTrapLogTable, slmOemType=slmOemType, slmMuxNumber=slmMuxNumber, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrap=slmTrap, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDate=slmSwRevDate, slmSysGatewayAddr=slmSysGatewayAddr, slmPmAvailable=slmPmAvailable, slmSysAlmAct=slmSysAlmAct, slmSysAlmDeact=slmSysAlmDeact, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTemperature=slmSysTemperature, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestTable=slmTrapDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam3=slmTrapLogParam3)
