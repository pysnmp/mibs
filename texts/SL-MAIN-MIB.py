...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, ModuleIdentity, Gauge32, NotificationType, Counter32, ObjectIdentity, Opaque, TimeTicks, Unsigned32, Counter64, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "ModuleIdentity", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "Opaque", "TimeTicks", "Unsigned32", "Counter64", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmRebootDelay=slmRebootDelay, slmSysName=slmSysName, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthCommunity=slmAuthCommunity, slmTrapDestTable=slmTrapDestTable, slmAdminEntry=slmAdminEntry, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogLevel=slmSyslogLevel, slmSysGatewayAddr=slmSysGatewayAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, slmSyslogDestEntry=slmSyslogDestEntry, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigFile=slmConfigFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmLogin=slmLogin, slmSys=slmSys, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseIndex=slmLicenseIndex, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmSysLocation=slmSysLocation, slmLogFile=slmLogFile, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam3=slmTrapLogParam3, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmAdminLogin=slmAdminLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmAct=slmSysAlmAct, slmPmAvailable=slmPmAvailable, UserPassword=UserPassword, slmMuxNumber=slmMuxNumber, PYSNMP_MODULE_ID=slMain, slmTrapLogParam4=slmTrapLogParam4, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmSysTrapFormat=slmSysTrapFormat, slmOemType=slmOemType, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, UserLogin=UserLogin, slmBoxSize=slmBoxSize, slmSysTemperature=slmSysTemperature, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmWriteCommunity=slmWriteCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevTable=slmSwRevTable, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminRowStatus=slmAdminRowStatus, slmAdminTable=slmAdminTable, slmSnmpv3Priv=slmSnmpv3Priv, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapPort=slmTrapPort, slmAuthPassword=slmAuthPassword, slmNetworkMode=slmNetworkMode, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysMode=slmSysMode, slmSysUplinkRate=slmSysUplinkRate, slmAdminAccess=slmAdminAccess, slmAdmin=slmAdmin, slMain=slMain, slmSyslogDestTable=slmSyslogDestTable, slmVcatDelay=slmVcatDelay, slmTrapLogParam1=slmTrapLogParam1)
