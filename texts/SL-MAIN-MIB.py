...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Opaque, ModuleIdentity, MibIdentifier, TimeTicks, Bits, Unsigned32, iso, NotificationType, Counter32, IpAddress, Counter64, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Opaque", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "Unsigned32", "iso", "NotificationType", "Counter32", "IpAddress", "Counter64", "ObjectIdentity", "Integer32")
RowStatus, DateAndTime, TruthValue, TextualConvention, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TruthValue", "TextualConvention", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmSwRevName=slmSwRevName, slmAdminAccess=slmAdminAccess, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmTid=slmTid, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slmAuthCommunity=slmAuthCommunity, slmSysIpAddr=slmSysIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmSysName=slmSysName, slmAuthLogin=slmAuthLogin, slmTrapDestTable=slmTrapDestTable, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminTable=slmAdminTable, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassEntry=slmChPassEntry, SoftwareRevision=SoftwareRevision, slmChPassTable=slmChPassTable, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseId=slmLicenseId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam6=slmTrapLogParam6, slmVcatDelay=slmVcatDelay, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmLicenseIndex=slmLicenseIndex, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTopologyEnabled=slmTopologyEnabled, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapPort=slmTrapPort, slmAdmin=slmAdmin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthEntry=slmAuthEntry, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmAdminRowStatus=slmAdminRowStatus, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slm40GConf=slm40GConf, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmSwRevDate=slmSwRevDate, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, slmSysResetPm=slmSysResetPm, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmOemType=slmOemType, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmLicense=slmLicense, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmConfigFile=slmConfigFile, slmSysMode=slmSysMode, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slMain=slMain, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSys=slmSys)
