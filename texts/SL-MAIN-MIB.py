...
iso, ObjectIdentity, ModuleIdentity, Integer32, Counter32, Unsigned32, Counter64, TimeTicks, Opaque, IpAddress, MibIdentifier, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32", "Counter64", "TimeTicks", "Opaque", "IpAddress", "MibIdentifier", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
TruthValue, TimeStamp, DisplayString, TextualConvention, DateAndTime, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention", "DateAndTime", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmAdminPassword=slmAdminPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, PYSNMP_MODULE_ID=slMain, slmChPassEntry=slmChPassEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDate=slmSwRevDate, slm40GConf=slm40GConf, slmSnmpv3Auth=slmSnmpv3Auth, slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmConfigFile=slmConfigFile, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserLogin=UserLogin, slmTrapLogParam6=slmTrapLogParam6, slmSysChassisId=slmSysChassisId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmAuth=slmAuth, slmLogin=slmLogin, slmAdminAccess=slmAdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmChPassOldPass=slmChPassOldPass, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmTrapLogTable=slmTrapLogTable, slmMuxNumber=slmMuxNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdmin=slmAdmin, slmTrap=slmTrap, slmRebootDelay=slmRebootDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmSysResetPm=slmSysResetPm, slmAuthPassword=slmAuthPassword, slmLicenseEntry=slmLicenseEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmAdminEntry=slmAdminEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmWriteCommunity=slmWriteCommunity, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmSwRevEntry=slmSwRevEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevName=slmSwRevName, slmSysIpAddr=slmSysIpAddr, slmChPass=slmChPass, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, slmTrapEnable=slmTrapEnable, AdminAccess=AdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmLicenseId=slmLicenseId, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmTrapPort=slmTrapPort, UserPassword=UserPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmVcatDelay=slmVcatDelay, slmTrapLogParam2=slmTrapLogParam2, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmConfigSysUptime=slmConfigSysUptime, slmChPassTable=slmChPassTable, UserCommunity=UserCommunity)
