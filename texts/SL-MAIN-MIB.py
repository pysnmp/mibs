...
NotificationType, MibIdentifier, IpAddress, Bits, Counter64, Integer32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Opaque, iso, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "IpAddress", "Bits", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Opaque", "iso", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmReadCommunity=slmReadCommunity, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSwRevName=slmSwRevName, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseExpiration=slmLicenseExpiration, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserPassword=UserPassword, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmLicense=slmLicense, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, slm40GConf=slm40GConf, slmTrapDestTable=slmTrapDestTable, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, SoftwareRevision=SoftwareRevision, slmPsuNumber=slmPsuNumber, slmAdminLogin=slmAdminLogin, slmAdminRowStatus=slmAdminRowStatus, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserLogin=UserLogin, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserAccess=slmTrapUserAccess, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam5=slmTrapLogParam5, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmTrapDestAddress=slmTrapDestAddress, slmChPassTable=slmChPassTable, slmNetworkMode=slmNetworkMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask, slmBoxSize=slmBoxSize, slmSysAlmDeact=slmSysAlmDeact, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmSwRevDate=slmSwRevDate, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, AdminAccess=AdminAccess, slmSnmpv3Password=slmSnmpv3Password, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDirectory=slmSwRevDirectory, slmTrapCommunity=slmTrapCommunity, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmLogFile=slmLogFile, slmSysResetPm=slmSysResetPm, slmTid=slmTid, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, slmAuthTable=slmAuthTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminTable=slmAdminTable, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, slmAdminCommunity=slmAdminCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmMuxNumber=slmMuxNumber, slmConfigSysUptime=slmConfigSysUptime, slmSysLanIpAddr=slmSysLanIpAddr)
