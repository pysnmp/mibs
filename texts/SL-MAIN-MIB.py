...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, TimeTicks, Counter32, ModuleIdentity, iso, Bits, ObjectIdentity, MibIdentifier, IpAddress, Opaque, NotificationType, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "TimeTicks", "Counter32", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "IpAddress", "Opaque", "NotificationType", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmSysActiveSwVersion=slmSysActiveSwVersion, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmChPassTable=slmChPassTable, slmSysMode=slmSysMode, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmAuthLogin=slmAuthLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevStatus=slmSwRevStatus, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam6=slmTrapLogParam6, slmWriteCommunity=slmWriteCommunity, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTemperature=slmSysTemperature, slmTrapLogParam3=slmTrapLogParam3, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysUplinkRate=slmSysUplinkRate, slmAuthEntry=slmAuthEntry, slmAdminAccess=slmAdminAccess, slmAuthTable=slmAuthTable, slMain=slMain, slmTrapUserAccess=slmTrapUserAccess, slmTrapUserLogin=slmTrapUserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmReadCommunity=slmReadCommunity, slmChPassLogin=slmChPassLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestEntry=slmTrapDestEntry, slmChPassNewPass=slmChPassNewPass, slmOemType=slmOemType, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, slmAdminEntry=slmAdminEntry, slmChPassOldPass=slmChPassOldPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRstpEnabled=slmRstpEnabled, slmSyslogLevel=slmSyslogLevel, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrapPort=slmTrapPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogFile=slmLogFile, slmAuthPassword=slmAuthPassword, slmTrapLogTable=slmTrapLogTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogName=slmTrapLogName, slmTrapLogParam5=slmTrapLogParam5, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminLogin=slmAdminLogin, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmChPass=slmChPass, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmTrapLogId=slmTrapLogId, slmSyslogDestEntry=slmSyslogDestEntry, slmSys=slmSys, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, UserCommunity=UserCommunity, slmTrapCommunity=slmTrapCommunity, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmAuth=slmAuth, slmTrapDestTable=slmTrapDestTable, slmRebootDelay=slmRebootDelay, slmSysResetPm=slmSysResetPm, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseTable=slmLicenseTable, slmSysGatewayAddr=slmSysGatewayAddr)
