...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigFile=slmConfigFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmAdminLogin=slmAdminLogin, slmAdminAccess=slmAdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, PYSNMP_MODULE_ID=slMain, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogName=slmTrapLogName, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTid=slmTid, slmRebootDelay=slmRebootDelay, slmLogFile=slmLogFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmBoxSize=slmBoxSize, slm40GConf=slm40GConf, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmAdminPassword=slmAdminPassword, slmPsuNumber=slmPsuNumber, slmTrapLogParam4=slmTrapLogParam4, slMain=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmRstpEnabled=slmRstpEnabled, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmMuxNumber=slmMuxNumber, slmSysResetPm=slmSysResetPm, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSwRevStatus=slmSwRevStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmLicense=slmLicense, slmAuth=slmAuth, slmAuthLogin=slmAuthLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminCommunity=slmAdminCommunity, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapPort=slmTrapPort, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmTrapLogTable=slmTrapLogTable, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevTable=slmSwRevTable, slmLicenseEntry=slmLicenseEntry, slmAuthTable=slmAuthTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmVcatDelay=slmVcatDelay, slmSysName=slmSysName, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmWriteCommunity=slmWriteCommunity, slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmAdmin=slmAdmin, slmSysUplinkRate=slmSysUplinkRate, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTrapCommunity=slmTrapCommunity, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmEdfaNumber=slmEdfaNumber, slmSysOperStatus=slmSysOperStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysNameChange=slmTrapSysNameChange, slmSysIpAddr=slmSysIpAddr, slmAuthPassword=slmAuthPassword, slmSysChassisId=slmSysChassisId)
