...
Gauge32, NotificationType, Unsigned32, ModuleIdentity, Integer32, TimeTicks, Opaque, IpAddress, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Unsigned32", "ModuleIdentity", "Integer32", "TimeTicks", "Opaque", "IpAddress", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "iso", "ObjectIdentity")
TimeStamp, TruthValue, RowStatus, TextualConvention, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmAdminTable=slmAdminTable, slmOemType=slmOemType, slmTrapCommunity=slmTrapCommunity, slmSyslogPort=slmSyslogPort, slmRebootDelay=slmRebootDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmEdfaNumber=slmEdfaNumber, SoftwareRevision=SoftwareRevision, slmSnmpv3Auth=slmSnmpv3Auth, slmSysMode=slmSysMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmSys=slmSys, slmTrapLogParam4=slmTrapLogParam4, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysChassisId=slmSysChassisId, slmPsuNumber=slmPsuNumber, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestTable=slmSyslogDestTable, slmAuth=slmAuth, slmSyslogDestAddress=slmSyslogDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmVcatDelay=slmVcatDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, PYSNMP_MODULE_ID=slMain, slmSysUplinkRate=slmSysUplinkRate, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slm40GConf=slm40GConf, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam3=slmTrapLogParam3, slMain=slMain, slmBoxSize=slmBoxSize, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmAdmin=slmAdmin, slmAdminEntry=slmAdminEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmLogFile=slmLogFile, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysUptime=slmConfigSysUptime, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmPmAvailable=slmPmAvailable, slmTrapLogTable=slmTrapLogTable, slmLogin=slmLogin, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmAuthEntry=slmAuthEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogLevel=slmSyslogLevel, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevStatus=slmSwRevStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmLicenseEntry=slmLicenseEntry, slmSysOperStatus=slmSysOperStatus, slmTid=slmTid, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmTrapLogEntry=slmTrapLogEntry, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestEntry=slmTrapDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysLocation=slmSysLocation, slmTrapLogParam2=slmTrapLogParam2, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity)
