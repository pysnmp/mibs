...
iso, Gauge32, Integer32, ModuleIdentity, ObjectIdentity, Counter64, Opaque, NotificationType, Bits, Unsigned32, IpAddress, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter64", "Opaque", "NotificationType", "Bits", "Unsigned32", "IpAddress", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
TruthValue, TextualConvention, RowStatus, DisplayString, TimeStamp, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogId=slmTrapLogId, slmSysIpAddr=slmSysIpAddr, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapCommunity=slmTrapCommunity, slmTrapLogName=slmTrapLogName, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminLogin=slmAdminLogin, slmLicense=slmLicense, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmChPassLogin=slmChPassLogin, slmSysAdminStatus=slmSysAdminStatus, slmTid=slmTid, SoftwareRevision=SoftwareRevision, slmSysChassisId=slmSysChassisId, slmChPass=slmChPass, slmLogFile=slmLogFile, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigFile=slmConfigFile, slmAuth=slmAuth, slmWriteCommunity=slmWriteCommunity, slmSysMode=slmSysMode, slmOemType=slmOemType, slmTopologyEnabled=slmTopologyEnabled, slmPmAvailable=slmPmAvailable, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysCalendarTime=slmSysCalendarTime, slmReadCommunity=slmReadCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmAdminCommunity=slmAdminCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmEdfaNumber=slmEdfaNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmSysAlmAct=slmSysAlmAct, slmLicenseExpiration=slmLicenseExpiration, slmSysTrapFormat=slmSysTrapFormat, slmAdmin=slmAdmin, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmAdminAccess=slmAdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmChPassEntry=slmChPassEntry, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTrapDestTable=slmTrapDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, AdminAccess=AdminAccess, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTemperature=slmSysTemperature, UserPassword=UserPassword, slmVcatDelay=slmVcatDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmDeact=slmSysAlmDeact, slmPortsNumber=slmPortsNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDirectory=slmSwRevDirectory, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin)
