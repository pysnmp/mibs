...
iso, NotificationType, Counter64, Unsigned32, ModuleIdentity, Counter32, Opaque, IpAddress, TimeTicks, MibIdentifier, Gauge32, Integer32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "Opaque", "IpAddress", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, TruthValue, RowStatus, DisplayString, TextualConvention, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Priv=slmSnmpv3Priv, slmAdminRowStatus=slmAdminRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDate=slmSwRevDate, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthEntry=slmAuthEntry, slmConfigFile=slmConfigFile, slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmSyslogDestAddress=slmSyslogDestAddress, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmLicenseIndex=slmLicenseIndex, slmTrapDestProtVersion=slmTrapDestProtVersion, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmPmAvailable=slmPmAvailable, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestTable=slmTrapDestTable, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmTrapPort=slmTrapPort, slmAdminLogin=slmAdminLogin, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmChPass=slmChPass, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, UserPassword=UserPassword, slmTrapUserLogin=slmTrapUserLogin, slmChPassTable=slmChPassTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapCommunity=slmTrapCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysLanIpAddr=slmSysLanIpAddr, PYSNMP_MODULE_ID=slMain, slmSysSubnetMask=slmSysSubnetMask, slmSysChassisId=slmSysChassisId, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOemType=slmOemType, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmSyslogDestTable=slmSyslogDestTable, slmAdmin=slmAdmin, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmSysLocation=slmSysLocation, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmAuthTable=slmAuthTable, slmNetworkMode=slmNetworkMode, SoftwareRevision=SoftwareRevision, slmSyslogLevel=slmSyslogLevel, slmChPassEntry=slmChPassEntry, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slm40GConf=slm40GConf, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmSyslogPort=slmSyslogPort, slmTrapLogParam3=slmTrapLogParam3, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmAuthCommunity=slmAuthCommunity, slmWriteCommunity=slmWriteCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmAuth=slmAuth, slmChPassOldPass=slmChPassOldPass, slmTopologyEnabled=slmTopologyEnabled, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthLogin=slmAuthLogin, slmLicenseEntry=slmLicenseEntry, slmSysResetPm=slmSysResetPm, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysOperStatus=slmSysOperStatus, slmSys=slmSys, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam5=slmTrapLogParam5, slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName)
