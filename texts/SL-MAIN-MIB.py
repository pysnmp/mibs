...
Opaque, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, ModuleIdentity, Integer32, ObjectIdentity, Gauge32, TimeTicks, MibIdentifier, Unsigned32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "ModuleIdentity", "Integer32", "ObjectIdentity", "Gauge32", "TimeTicks", "MibIdentifier", "Unsigned32", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysChassisId=slmSysChassisId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmLicenseExpiration=slmLicenseExpiration, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthCommunity=slmAuthCommunity, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogId=slmTrapLogId, slmSyslogDestEntry=slmSyslogDestEntry, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmVcatDelay=slmVcatDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapPort=slmTrapPort, slmSyslogDestTable=slmSyslogDestTable, slmSwRevEntry=slmSwRevEntry, slmSysIpAddr=slmSysIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRstpEnabled=slmRstpEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOemType=slmOemType, slmSysTrapFormat=slmSysTrapFormat, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysMode=slmSysMode, slmLicenseEntry=slmLicenseEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmAdminCommunity=slmAdminCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slmTrapLogParam4=slmTrapLogParam4, slmAuthLogin=slmAuthLogin, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, slmTrapDestCommunity=slmTrapDestCommunity, slmWriteCommunity=slmWriteCommunity, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmAuthEntry=slmAuthEntry, slmConfigFile=slmConfigFile, slmTrapLogName=slmTrapLogName, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmSwRevTable=slmSwRevTable, slMain=slMain, slmAuthPassword=slmAuthPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevName=slmSwRevName, slmSysTemperature=slmSysTemperature, slmSys=slmSys, slmTid=slmTid, slmChPassNewPass=slmChPassNewPass, slmSysLocation=slmSysLocation, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmAuthTable=slmAuthTable, slm40GConf=slm40GConf, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassLogin=slmChPassLogin, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmBoxSize=slmBoxSize, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, UserLogin=UserLogin, PYSNMP_MODULE_ID=slMain, UserCommunity=UserCommunity, slmAuth=slmAuth, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress)
