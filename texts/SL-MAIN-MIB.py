...
TextualConvention, TimeStamp, TruthValue, RowStatus, DisplayString, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmConfigFile=slmConfigFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogFile=slmLogFile, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassEntry=slmChPassEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmAdminRowStatus=slmAdminRowStatus, slmChPass=slmChPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTid=slmTid, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminPassword=slmAdminPassword, SoftwareRevision=SoftwareRevision, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestTable=slmTrapDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, UserCommunity=UserCommunity, slmSysLocation=slmSysLocation, slmLicenseExpiration=slmLicenseExpiration, slmTrapPort=slmTrapPort, slmSysEncryptionCapability=slmSysEncryptionCapability, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmRstpEnabled=slmRstpEnabled, slmSysResetPm=slmSysResetPm, slmSysSubnetMask=slmSysSubnetMask, PYSNMP_MODULE_ID=slMain, slmTrapEnable=slmTrapEnable, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminCommunity=slmAdminCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogTable=slmTrapLogTable, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, slmAdminAccess=slmAdminAccess, slMain=slMain, slmWriteCommunity=slmWriteCommunity, slmTrap=slmTrap, slmOpticalSwitchExist=slmOpticalSwitchExist, slmVcatDelay=slmVcatDelay, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayAddr=slmSysGatewayAddr, slmOemType=slmOemType, slmSysMode=slmSysMode, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmPortsNumber=slmPortsNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSysAlmAct=slmSysAlmAct, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmAuthPassword=slmAuthPassword, slmSysChassisId=slmSysChassisId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmSysOperStatus=slmSysOperStatus, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmRebootDelay=slmRebootDelay, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDirectory=slmSwRevDirectory, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassTable=slmChPassTable, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmAdmin=slmAdmin, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSwRevEntry=slmSwRevEntry, slmSwRevDate=slmSwRevDate, slmLicenseTable=slmLicenseTable, slmBoxSize=slmBoxSize, slmTrapCommunity=slmTrapCommunity, slmTrapDestEntry=slmTrapDestEntry)
