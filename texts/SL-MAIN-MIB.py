...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPortsNumber=slmPortsNumber, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserLogin=UserLogin, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmTrapUserLogin=slmTrapUserLogin, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmLogFile=slmLogFile, slm40GConf=slm40GConf, slmSwRevTable=slmSwRevTable, AdminAccess=AdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysOperStatus=slmSysOperStatus, slmSysIpAddr=slmSysIpAddr, slmAuthTable=slmAuthTable, slmSysResetPm=slmSysResetPm, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminLogin=slmAdminLogin, slmChPassLogin=slmChPassLogin, slmLicenseId=slmLicenseId, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogId=slmTrapLogId, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, slmLicenseEntry=slmLicenseEntry, slmPsuNumber=slmPsuNumber, slmReadCommunity=slmReadCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmTrapSysNameChange=slmTrapSysNameChange, slmChPass=slmChPass, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLocation=slmSysLocation, slmConfigFile=slmConfigFile, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseTable=slmLicenseTable, slmTrapLogTable=slmTrapLogTable, slmTopologyEnabled=slmTopologyEnabled, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, slmTrapPort=slmTrapPort, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmRstpEnabled=slmRstpEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, UserCommunity=UserCommunity, slmAuthLogin=slmAuthLogin, slmWriteCommunity=slmWriteCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysName=slmSysName, slmLicenseIndex=slmLicenseIndex, slmSyslogDestTable=slmSyslogDestTable, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmSwRevStatus=slmSwRevStatus, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevEntry=slmSwRevEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogName=slmTrapLogName, SoftwareRevision=SoftwareRevision, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysTemperature=slmSysTemperature, slmSwRevName=slmSwRevName, slmSyslogPort=slmSyslogPort, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseExpiration=slmLicenseExpiration, slmTid=slmTid, slmSyslogLevel=slmSyslogLevel, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmTrapLogParam2=slmTrapLogParam2, slmChPassOldPass=slmChPassOldPass, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassTable=slmChPassTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDate=slmSwRevDate, slmTrapLogParam6=slmTrapLogParam6, slmSysMode=slmSysMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask)
