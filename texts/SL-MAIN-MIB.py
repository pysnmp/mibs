...
iso, MibIdentifier, NotificationType, Counter32, ObjectIdentity, Opaque, TimeTicks, Unsigned32, Gauge32, Bits, Counter64, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "Opaque", "TimeTicks", "Unsigned32", "Gauge32", "Bits", "Counter64", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
TimeStamp, TextualConvention, RowStatus, DisplayString, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam5=slmTrapLogParam5, slmBoxSize=slmBoxSize, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestAddress=slmTrapDestAddress, slmLicenseExpiration=slmLicenseExpiration, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmSysMode=slmSysMode, slmConfigFile=slmConfigFile, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserLogin=slmTrapUserLogin, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmRebootDelay=slmRebootDelay, UserCommunity=UserCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSys=slmSys, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmSysName=slmSysName, slmLogin=slmLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAlmAct=slmSysAlmAct, SoftwareRevision=SoftwareRevision, slmAuth=slmAuth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmSysLocation=slmSysLocation, slmReadCommunity=slmReadCommunity, slmPortsNumber=slmPortsNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogLevel=slmSyslogLevel, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapUserAccess=slmTrapUserAccess, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmAuthCommunity=slmAuthCommunity, slmSysOperStatus=slmSysOperStatus, slmChPassLogin=slmChPassLogin, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, slmSysAdminStatus=slmSysAdminStatus, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmTrapLogParam2=slmTrapLogParam2, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmAdminEntry=slmAdminEntry, slmSysCalendarTime=slmSysCalendarTime, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmMuxNumber=slmMuxNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogName=slmTrapLogName, slmTid=slmTid, slmNetworkMode=slmNetworkMode, slmChPassNewPass=slmChPassNewPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthPassword=slmAuthPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrap=slmTrap, slmAdmin=slmAdmin)
