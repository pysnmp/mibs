...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Counter32, Counter64, Gauge32, ObjectIdentity, iso, ModuleIdentity, Bits, Unsigned32, NotificationType, Opaque, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Counter32", "Counter64", "Gauge32", "ObjectIdentity", "iso", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "Opaque", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmLicenseTable=slmLicenseTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, AdminAccess=AdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmChPassTable=slmChPassTable, slmTrapLogTable=slmTrapLogTable, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAlmDeact=slmSysAlmDeact, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmSysOperStatus=slmSysOperStatus, slmAdminCommunity=slmAdminCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmSysTemperature=slmSysTemperature, slmWriteCommunity=slmWriteCommunity, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogLevel=slmSyslogLevel, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slmPortsNumber=slmPortsNumber, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmTopologyEnabled=slmTopologyEnabled, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmSwRevDirectory=slmSwRevDirectory, slmAuthEntry=slmAuthEntry, slmMuxNumber=slmMuxNumber, slmRstpEnabled=slmRstpEnabled, slmTrapDestEntry=slmTrapDestEntry, slmAuthPassword=slmAuthPassword, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayAddr=slmSysGatewayAddr, slmSysUplinkRate=slmSysUplinkRate, slmSyslogPort=slmSyslogPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmSwRevName=slmSwRevName, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysIpAddr=slmSysIpAddr, slmChPassOldPass=slmChPassOldPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmTrapPort=slmTrapPort, UserPassword=UserPassword, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmTrapCommunity=slmTrapCommunity, slmLicenseId=slmLicenseId, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmSwRevDate=slmSwRevDate, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmReadCommunity=slmReadCommunity)
