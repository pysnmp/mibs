...
Counter32, IpAddress, NotificationType, Opaque, Integer32, Bits, Unsigned32, Counter64, Gauge32, ModuleIdentity, iso, ObjectIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "NotificationType", "Opaque", "Integer32", "Bits", "Unsigned32", "Counter64", "Gauge32", "ModuleIdentity", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, TruthValue, TextualConvention, DisplayString, DateAndTime, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "TextualConvention", "DisplayString", "DateAndTime", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmSyslogDestAddress=slmSyslogDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Priv=slmSnmpv3Priv, PYSNMP_MODULE_ID=slMain, slmChPassTable=slmChPassTable, slmSwRevTable=slmSwRevTable, slmAdminLogin=slmAdminLogin, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmConfigSysUptime=slmConfigSysUptime, slmSwRevStatus=slmSwRevStatus, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmChPassLogin=slmChPassLogin, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysName=slmSysName, slMain=slMain, slmSys=slmSys, slmTid=slmTid, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestRowStatus=slmTrapDestRowStatus, slmWriteCommunity=slmWriteCommunity, UserLogin=UserLogin, slmConfigFile=slmConfigFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevEntry=slmSwRevEntry, slmChPass=slmChPass, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmOemType=slmOemType, slmSysAdminStatus=slmSysAdminStatus, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmBoxSize=slmBoxSize, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmNetworkMode=slmNetworkMode, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmSysSnmpVersion=slmSysSnmpVersion, slmSysMode=slmSysMode, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmSysIpAddr=slmSysIpAddr, slmSysResetPm=slmSysResetPm, slmSnmpv3Password=slmSnmpv3Password, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdmin=slmAdmin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestTable=slmTrapDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmVcatDelay=slmVcatDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmRstpEnabled=slmRstpEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam3=slmTrapLogParam3, AdminAccess=AdminAccess, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmSyslogDestTable=slmSyslogDestTable, UserPassword=UserPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthCommunity=slmAuthCommunity, slmChPassEntry=slmChPassEntry, slmSysAlmAct=slmSysAlmAct, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseIndex=slmLicenseIndex, slmAuthEntry=slmAuthEntry, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDate=slmSwRevDate, slmLicenseTable=slmLicenseTable, slmLicense=slmLicense, slm40GConf=slm40GConf, slmTrapLogParam1=slmTrapLogParam1, slmPmAvailable=slmPmAvailable, slmSysLanSubnetAddr=slmSysLanSubnetAddr)
