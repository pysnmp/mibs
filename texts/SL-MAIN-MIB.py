...
ObjectIdentity, ModuleIdentity, iso, Counter64, Unsigned32, Integer32, TimeTicks, Gauge32, MibIdentifier, Opaque, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "iso", "Counter64", "Unsigned32", "Integer32", "TimeTicks", "Gauge32", "MibIdentifier", "Opaque", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "IpAddress")
DateAndTime, RowStatus, TruthValue, TextualConvention, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdmin=slmAdmin, slmTrapCommunity=slmTrapCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, SoftwareRevision=SoftwareRevision, slmTrap=slmTrap, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmSysMode=slmSysMode, slmLogin=slmLogin, slmSysTemperature=slmSysTemperature, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogId=slmTrapLogId, slmSwRevStatus=slmSwRevStatus, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmPmAvailable=slmPmAvailable, slmChPassTable=slmChPassTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmSyslogLevel=slmSyslogLevel, slmSysTrapFormat=slmSysTrapFormat, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmAuth=slmAuth, slmTrapUserAccess=slmTrapUserAccess, slmTrapEnable=slmTrapEnable, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmAdminRowStatus=slmAdminRowStatus, slmSysName=slmSysName, slmSwRevDate=slmSwRevDate, slmTrapDestEntry=slmTrapDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmSys=slmSys, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmPsuNumber=slmPsuNumber, slmSwRevName=slmSwRevName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmChPassLogin=slmChPassLogin, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmTrapLogParam2=slmTrapLogParam2, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmTrapLogParam5=slmTrapLogParam5, slmSysChassisId=slmSysChassisId, slmTrapDestTable=slmTrapDestTable, slm40GConf=slm40GConf, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysResetPm=slmSysResetPm, slmAuthPassword=slmAuthPassword, slmAdminPassword=slmAdminPassword, slmConfigSysUptime=slmConfigSysUptime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmLicenseEntry=slmLicenseEntry, slmTid=slmTid, slmTrapLogTable=slmTrapLogTable, slmTrapLogName=slmTrapLogName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseExpiration=slmLicenseExpiration, slmAuthTable=slmAuthTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLocation=slmSysLocation, slmTrapUserLogin=slmTrapUserLogin, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, PYSNMP_MODULE_ID=slMain, slmWriteCommunity=slmWriteCommunity, slmConfigFile=slmConfigFile, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmBoxSize=slmBoxSize, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestEntry=slmSyslogDestEntry, slmMuxNumber=slmMuxNumber, slmChPassEntry=slmChPassEntry, slmRebootDelay=slmRebootDelay, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, UserLogin=UserLogin, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmAuthEntry=slmAuthEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmSyslogDestTable=slmSyslogDestTable, slmOemType=slmOemType, slmLicense=slmLicense, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmAdminAccess=slmAdminAccess, slmSysCalendarTime=slmSysCalendarTime)
