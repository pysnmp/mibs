...
ObjectIdentity, Bits, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Integer32, ModuleIdentity, Unsigned32, iso, MibIdentifier, Opaque, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Integer32", "ModuleIdentity", "Unsigned32", "iso", "MibIdentifier", "Opaque", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmVcatDelay=slmVcatDelay, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminPassword=slmAdminPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmAdminLogin=slmAdminLogin, slmSysOperStatus=slmSysOperStatus, slmAdminEntry=slmAdminEntry, slmPortsNumber=slmPortsNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmLicenseTable=slmLicenseTable, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slMain=slMain, slmPmAvailable=slmPmAvailable, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmTrapLogTable=slmTrapLogTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogEntry=slmTrapLogEntry, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserLogin=UserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysCalendarTime=slmSysCalendarTime, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmTrapDestTable=slmTrapDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, slmSwRevName=slmSwRevName, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmAuthLogin=slmAuthLogin, slmConfigFile=slmConfigFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapUserAccess=slmTrapUserAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTid=slmTid, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRebootDelay=slmRebootDelay, slmAuthPassword=slmAuthPassword, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmTrapDestProtVersion=slmTrapDestProtVersion, slmNetworkMode=slmNetworkMode, slmSwRevStatus=slmSwRevStatus, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmSyslogLevel=slmSyslogLevel, slmSysAdminStatus=slmSysAdminStatus, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmConfigSysUptime=slmConfigSysUptime, slmOemType=slmOemType, slmSysName=slmSysName, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmReadCommunity=slmReadCommunity, UserPassword=UserPassword, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmDeact=slmSysAlmDeact, slmChPass=slmChPass, slmAdmin=slmAdmin, slmSys=slmSys, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmLicense=slmLicense, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminAccess=slmAdminAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
