...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmTrapDestRowStatus=slmTrapDestRowStatus, AdminAccess=AdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmReadCommunity=slmReadCommunity, slmBoxSize=slmBoxSize, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysName=slmSysName, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmSysMode=slmSysMode, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmSysChassisId=slmSysChassisId, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, SoftwareRevision=SoftwareRevision, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestTable=slmSyslogDestTable, UserPassword=UserPassword, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmPmAvailable=slmPmAvailable, slmRstpEnabled=slmRstpEnabled, slmTrapEnable=slmTrapEnable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmTrapCommunity=slmTrapCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSwRevName=slmSwRevName, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slmSysUplinkRate=slmSysUplinkRate, slmSys=slmSys, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysOperStatus=slmSysOperStatus, slmAdmin=slmAdmin, slmAdminLogin=slmAdminLogin, slmSyslogPort=slmSyslogPort, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassEntry=slmChPassEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmTid=slmTid, slmNetworkMode=slmNetworkMode, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmAdminCommunity=slmAdminCommunity, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slmSysResetPm=slmSysResetPm, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDirectory=slmSwRevDirectory, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestAddress=slmTrapDestAddress, slmSwRevTable=slmSwRevTable, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmSysTemperature=slmSysTemperature, slmWriteCommunity=slmWriteCommunity, slmPsuNumber=slmPsuNumber, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmSysAlmAct=slmSysAlmAct, slmSwRevDate=slmSwRevDate, slmLicense=slmLicense, slmOemType=slmOemType, slmAuth=slmAuth, slmSysLocation=slmSysLocation, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthCommunity=slmAuthCommunity, slmSysSubnetMask=slmSysSubnetMask, slmAuthLogin=slmAuthLogin, slmSysTrapFormat=slmSysTrapFormat)
