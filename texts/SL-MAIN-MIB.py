...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Opaque, ModuleIdentity, NotificationType, Counter64, Counter32, Gauge32, MibIdentifier, TimeTicks, Bits, Unsigned32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Opaque", "ModuleIdentity", "NotificationType", "Counter64", "Counter32", "Gauge32", "MibIdentifier", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "Integer32")
TextualConvention, TruthValue, DisplayString, DateAndTime, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "DateAndTime", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmLogin=slmLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmReadCommunity=slmReadCommunity, slmTrap=slmTrap, slmLicenseTable=slmLicenseTable, slmRebootDelay=slmRebootDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, slmSwRevDirectory=slmSwRevDirectory, slm40GConf=slm40GConf, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, UserPassword=UserPassword, UserLogin=UserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAlmAct=slmSysAlmAct, PYSNMP_MODULE_ID=slMain, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestEntry=slmTrapDestEntry, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmOpticalSwitchExist=slmOpticalSwitchExist, slmRstpEnabled=slmRstpEnabled, slmTrapDestTable=slmTrapDestTable, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseEntry=slmLicenseEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogName=slmTrapLogName, slmTrapLogParam3=slmTrapLogParam3, slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmSysMode=slmSysMode, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmChPassTable=slmChPassTable, slmAuth=slmAuth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserCommunity=UserCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmTrapEnable=slmTrapEnable, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slmLicense=slmLicense, slmSysResetPm=slmSysResetPm, slmVcatDelay=slmVcatDelay, slmChPassLogin=slmChPassLogin, slmSysName=slmSysName, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminCommunity=slmAdminCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysUplinkRate=slmSysUplinkRate, slmChPassNewPass=slmChPassNewPass, slmAdminEntry=slmAdminEntry, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, SoftwareRevision=SoftwareRevision, slmTopologyEnabled=slmTopologyEnabled, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmMuxNumber=slmMuxNumber, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmTid=slmTid, slmSysIpAddr=slmSysIpAddr, slmPmAvailable=slmPmAvailable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPass=slmChPass, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthTable=slmAuthTable, AdminAccess=AdminAccess)
