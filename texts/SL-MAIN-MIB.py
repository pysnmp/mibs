...
MibIdentifier, Unsigned32, Gauge32, ObjectIdentity, Counter32, Counter64, IpAddress, Opaque, TimeTicks, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "Counter64", "IpAddress", "Opaque", "TimeTicks", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserLogin=UserLogin, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogLevel=slmSyslogLevel, slmAdmin=slmAdmin, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmTrapLogParam4=slmTrapLogParam4, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, slmSwRevDate=slmSwRevDate, slmSysTemperature=slmSysTemperature, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmRebootDelay=slmRebootDelay, slmSwRevEntry=slmSwRevEntry, AdminAccess=AdminAccess, slmPortsNumber=slmPortsNumber, slmSysLocation=slmSysLocation, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserCommunity=UserCommunity, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmSysChassisId=slmSysChassisId, slmChPassNewPass=slmChPassNewPass, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry, UserPassword=UserPassword, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysMode=slmSysMode, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapEnable=slmTrapEnable, slmTrapDestTable=slmTrapDestTable, slmAdminTable=slmAdminTable, slmSwRevTable=slmSwRevTable, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmNetworkMode=slmNetworkMode, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmVcatDelay=slmVcatDelay, slmAuthTable=slmAuthTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmTrapUserAccess=slmTrapUserAccess, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmChPassLogin=slmChPassLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSys=slmSys, slmSysGatewayAddr=slmSysGatewayAddr, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmAdminCommunity=slmAdminCommunity, slmTrap=slmTrap, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmTid=slmTid, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Password=slmSnmpv3Password, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam1=slmTrapLogParam1, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, PYSNMP_MODULE_ID=slMain, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin)
