...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Gauge32, Counter64, Opaque, Integer32, NotificationType, iso, Bits, Counter32, ModuleIdentity, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Gauge32", "Counter64", "Opaque", "Integer32", "NotificationType", "iso", "Bits", "Counter32", "ModuleIdentity", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestAddress=slmSyslogDestAddress, slmSysName=slmSysName, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmLicense=slmLicense, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmSnmpv3Priv=slmSnmpv3Priv, slmOemType=slmOemType, slmSysAlmDeact=slmSysAlmDeact, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, slmChPassOldPass=slmChPassOldPass, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmSysAdminStatus=slmSysAdminStatus, slmReadCommunity=slmReadCommunity, UserLogin=UserLogin, slmChPassEntry=slmChPassEntry, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmLicenseExpiration=slmLicenseExpiration, slmChPassLogin=slmChPassLogin, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, UserPassword=UserPassword, slmPmAvailable=slmPmAvailable, slmConfigFile=slmConfigFile, slmTrapLogName=slmTrapLogName, slmAuth=slmAuth, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseIndex=slmLicenseIndex, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam5=slmTrapLogParam5, slmSwRevTable=slmSwRevTable, slmAdminAccess=slmAdminAccess, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slmSysTemperature=slmSysTemperature, slmTrapLogTable=slmTrapLogTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysLocationChange=slmTrapSysLocationChange, slMain=slMain, slmPortsNumber=slmPortsNumber, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmSys=slmSys, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmAdminPassword=slmAdminPassword, slm40GConf=slm40GConf, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrap=slmTrap, slmTrapLogParam3=slmTrapLogParam3, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmRebootDelay=slmRebootDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseId=slmLicenseId)
