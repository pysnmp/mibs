...
Bits, Gauge32, TimeTicks, ModuleIdentity, NotificationType, ObjectIdentity, MibIdentifier, Integer32, Opaque, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "TimeTicks", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "Opaque", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysUplinkRate=slmSysUplinkRate, slmSyslogLevel=slmSyslogLevel, slmTrap=slmTrap, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmSys=slmSys, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevDate=slmSwRevDate, slmVcatDelay=slmVcatDelay, slmLogin=slmLogin, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmTrapLogName=slmTrapLogName, slmChPassNewPass=slmChPassNewPass, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRstpEnabled=slmRstpEnabled, slmSysAlmAct=slmSysAlmAct, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysMode=slmSysMode, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmOemType=slmOemType, slmLicense=slmLicense, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmChPass=slmChPass, slmTrapLogParam6=slmTrapLogParam6, slmAdminAccess=slmAdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmWriteCommunity=slmWriteCommunity, slmReadCommunity=slmReadCommunity, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminRowStatus=slmAdminRowStatus, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthEntry=slmAuthEntry, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmMuxNumber=slmMuxNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, slmSwRevStatus=slmSwRevStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmChPassTable=slmChPassTable, slmChPassOldPass=slmChPassOldPass, slmEdfaNumber=slmEdfaNumber, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestTable=slmTrapDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, AdminAccess=AdminAccess, slmAuthTable=slmAuthTable, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTemperature=slmSysTemperature, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmSysName=slmSysName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmChPassEntry=slmChPassEntry, slmSysLocation=slmSysLocation, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminPassword=slmAdminPassword, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmTrapEnable=slmTrapEnable, slMain=slMain, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmSysGatewayAddr=slmSysGatewayAddr)
