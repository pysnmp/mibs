...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevTable=slmSwRevTable, slmSysOperStatus=slmSysOperStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, UserPassword=UserPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthLogin=slmAuthLogin, slmSwRevName=slmSwRevName, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Priv=slmSnmpv3Priv, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseId=slmLicenseId, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogPort=slmSyslogPort, slmTrapPort=slmTrapPort, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slMain=slMain, slmSwRevDate=slmSwRevDate, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, UserCommunity=UserCommunity, slmLicense=slmLicense, slmAdminEntry=slmAdminEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmSysTemperature=slmSysTemperature, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogEntry=slmTrapLogEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam6=slmTrapLogParam6, AdminAccess=AdminAccess, slmTrapLogId=slmTrapLogId, slmPmAvailable=slmPmAvailable, slmSysSubnetMask=slmSysSubnetMask, slmPsuNumber=slmPsuNumber, slmAdminTable=slmAdminTable, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmNetworkMode=slmNetworkMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmTid=slmTid, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmLicenseTable=slmLicenseTable, slmAdminCommunity=slmAdminCommunity, slmAdminRowStatus=slmAdminRowStatus, slmConfigFile=slmConfigFile, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmChPass=slmChPass, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmAdminPassword=slmAdminPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmAuthCommunity=slmAuthCommunity, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdmin=slmAdmin, slmAdminAccess=slmAdminAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmWriteCommunity=slmWriteCommunity, PYSNMP_MODULE_ID=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysResetPm=slmSysResetPm, slmLicenseEntry=slmLicenseEntry, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmAuthTable=slmAuthTable, slmSysSnmpVersion=slmSysSnmpVersion, slmSysUplinkRate=slmSysUplinkRate, slmTrap=slmTrap, slmVcatDelay=slmVcatDelay, slmSyslogDestTable=slmSyslogDestTable, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmReadCommunity=slmReadCommunity, UserLogin=UserLogin, slmTopologyEnabled=slmTopologyEnabled, slmChPassEntry=slmChPassEntry, slmSwRevStatus=slmSwRevStatus, slmRstpEnabled=slmRstpEnabled, slmSwRevEntry=slmSwRevEntry, slmTrapLogName=slmTrapLogName, slmTrapDestCommunity=slmTrapDestCommunity)
