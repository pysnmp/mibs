...
IpAddress, ObjectIdentity, ModuleIdentity, Counter64, Integer32, Unsigned32, Gauge32, Opaque, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32", "Gauge32", "Opaque", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "Bits")
TextualConvention, TruthValue, DateAndTime, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DateAndTime", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmEdfaNumber=slmEdfaNumber, slmAdmin=slmAdmin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPmAvailable=slmPmAvailable, slmLicenseIndex=slmLicenseIndex, slmSwRevStatus=slmSwRevStatus, slmLicense=slmLicense, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminEntry=slmAdminEntry, slmSysSubnetMask=slmSysSubnetMask, slmNetworkMode=slmNetworkMode, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmAct=slmSysAlmAct, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, slmSysTemperature=slmSysTemperature, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassNewPass=slmChPassNewPass, slmSysCalendarTime=slmSysCalendarTime, slmLogin=slmLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmConfigSysUptime=slmConfigSysUptime, slmPortsNumber=slmPortsNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slmBoxSize=slmBoxSize, slmConfigFile=slmConfigFile, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam3=slmTrapLogParam3, slmAuthCommunity=slmAuthCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogLevel=slmSyslogLevel, slmChPassLogin=slmChPassLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapCommunity=slmTrapCommunity, slmReadCommunity=slmReadCommunity, slmTrapLogId=slmTrapLogId, slmAuthPassword=slmAuthPassword, slmSwRevName=slmSwRevName, slm40GConf=slm40GConf, slmAuthTable=slmAuthTable, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmSysUplinkRate=slmSysUplinkRate, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSys=slmSys, slmSysName=slmSysName, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmChPassOldPass=slmChPassOldPass, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmChPassTable=slmChPassTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmVcatDelay=slmVcatDelay, slmMuxNumber=slmMuxNumber, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPass=slmChPass, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDirectory=slmSwRevDirectory, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmSysResetPm=slmSysResetPm, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestTable=slmTrapDestTable, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmLicenseEntry=slmLicenseEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slMain=slMain, AdminAccess=AdminAccess, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysNameChange=slmTrapSysNameChange, slmOemType=slmOemType)
