...
Integer32, ModuleIdentity, iso, Counter32, ObjectIdentity, IpAddress, Counter64, Gauge32, NotificationType, TimeTicks, Bits, Unsigned32, Opaque, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "iso", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "Gauge32", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "Opaque", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DateAndTime, DisplayString, TimeStamp, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogId=slmTrapLogId, slmTrapEnable=slmTrapEnable, slmSys=slmSys, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmConfigFile=slmConfigFile, slmSysAlmDeact=slmSysAlmDeact, slmPsuNumber=slmPsuNumber, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmLogin=slmLogin, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmTrapPort=slmTrapPort, slmSysLocation=slmSysLocation, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmAuth=slmAuth, AdminAccess=AdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogFile=slmLogFile, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, slmTid=slmTid, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayAddr=slmSysGatewayAddr, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, slmWriteCommunity=slmWriteCommunity, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam2=slmTrapLogParam2, slmReadCommunity=slmReadCommunity, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSnmpVersion=slmSysSnmpVersion, slm40GConf=slm40GConf, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slmSysTemperature=slmSysTemperature, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseTable=slmLicenseTable, slmTrapDestTable=slmTrapDestTable, slmRstpEnabled=slmRstpEnabled, slmSyslogLevel=slmSyslogLevel, slmAuthCommunity=slmAuthCommunity, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmSwRevName=slmSwRevName, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam3=slmTrapLogParam3, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmAdminEntry=slmAdminEntry, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmRebootDelay=slmRebootDelay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassLogin=slmChPassLogin, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmSwRevTable=slmSwRevTable, slmSyslogPort=slmSyslogPort, UserCommunity=UserCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysMode=slmSysMode, slmChPassEntry=slmChPassEntry, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmSwRevEntry=slmSwRevEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogName=slmTrapLogName, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestTable=slmSyslogDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmLicense=slmLicense, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestEntry=slmTrapDestEntry, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber)
