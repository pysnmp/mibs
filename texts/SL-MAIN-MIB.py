...
Gauge32, IpAddress, iso, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, ObjectIdentity, Bits, Integer32, MibIdentifier, Counter64, ModuleIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "iso", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "ObjectIdentity", "Bits", "Integer32", "MibIdentifier", "Counter64", "ModuleIdentity", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLocation=slmSysLocation, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmNetworkMode=slmNetworkMode, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmSwRevDate=slmSwRevDate, slmSwRevEntry=slmSwRevEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmAdminEntry=slmAdminEntry, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmAuthPassword=slmAuthPassword, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmTid=slmTid, slMain=slMain, slmTrapLogParam3=slmTrapLogParam3, slmTrapUserAccess=slmTrapUserAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slmSysMode=slmSysMode, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, AdminAccess=AdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicense=slmLicense, slmConfigFile=slmConfigFile, slmPmAvailable=slmPmAvailable, slmSysSnmpVersion=slmSysSnmpVersion, UserPassword=UserPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmChPassEntry=slmChPassEntry, slmTrapLogParam5=slmTrapLogParam5, slmAuthLogin=slmAuthLogin, slmLicenseExpiration=slmLicenseExpiration, slmSwRevDirectory=slmSwRevDirectory, slmTrapEnable=slmTrapEnable, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, PYSNMP_MODULE_ID=slMain, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmTrapLogParam1=slmTrapLogParam1, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthTable=slmAuthTable, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, UserCommunity=UserCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapPort=slmTrapPort, slmSysGatewayAddr=slmSysGatewayAddr, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmTrapLogEntry=slmTrapLogEntry, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmSysName=slmSysName, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry)
