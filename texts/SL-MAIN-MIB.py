...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevDate=slmSwRevDate, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam6=slmTrapLogParam6, slmRstpEnabled=slmRstpEnabled, slmPortsNumber=slmPortsNumber, slmTrapUserLogin=slmTrapUserLogin, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmTrapLogName=slmTrapLogName, slmConfigFile=slmConfigFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminAccess=slmAdminAccess, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserCommunity=UserCommunity, slmVcatDelay=slmVcatDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmPsuNumber=slmPsuNumber, slmSysUplinkRate=slmSysUplinkRate, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmMuxNumber=slmMuxNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLocation=slmSysLocation, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmSysAlmDeact=slmSysAlmDeact, slmLicense=slmLicense, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmAdminPassword=slmAdminPassword, slmSwRevStatus=slmSwRevStatus, SoftwareRevision=SoftwareRevision, slmLicenseId=slmLicenseId, UserPassword=UserPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogLevel=slmSyslogLevel, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmAuthLogin=slmAuthLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminTable=slmAdminTable, slmTid=slmTid, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmAdminLogin=slmAdminLogin, slmOemType=slmOemType, slmNetworkMode=slmNetworkMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassLogin=slmChPassLogin, slmAdminRowStatus=slmAdminRowStatus, slmLogFile=slmLogFile, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmSysOperStatus=slmSysOperStatus, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmChPassTable=slmChPassTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogId=slmTrapLogId, slmSysIpAddr=slmSysIpAddr, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmAdminCommunity=slmAdminCommunity, slmSysResetPm=slmSysResetPm, slmSwRevEntry=slmSwRevEntry, slmChPassNewPass=slmChPassNewPass, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry, slmBoxSize=slmBoxSize, slmSwRevDirectory=slmSwRevDirectory, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmChPass=slmChPass, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmSysCalendarTime=slmSysCalendarTime, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix)
