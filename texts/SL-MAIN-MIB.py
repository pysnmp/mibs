...
Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter64, Integer32, IpAddress, iso, ModuleIdentity, Opaque, NotificationType, Unsigned32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter64", "Integer32", "IpAddress", "iso", "ModuleIdentity", "Opaque", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysSnmpVersion=slmSysSnmpVersion, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin, slmRstpEnabled=slmRstpEnabled, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapEnable=slmTrapEnable, slMain=slMain, SoftwareRevision=SoftwareRevision, slmLicenseEntry=slmLicenseEntry, slmWriteCommunity=slmWriteCommunity, slmTrapDestAddress=slmTrapDestAddress, slmPmAvailable=slmPmAvailable, slmSysLocation=slmSysLocation, slmSnmpv3Password=slmSnmpv3Password, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, PYSNMP_MODULE_ID=slMain, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysMode=slmSysMode, slmAdminAccess=slmAdminAccess, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmTrap=slmTrap, slmAuthCommunity=slmAuthCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmVcatDelay=slmVcatDelay, slmSyslogLevel=slmSyslogLevel, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmChPassEntry=slmChPassEntry, slmSysCalendarTime=slmSysCalendarTime, slmOemType=slmOemType, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, slmLicense=slmLicense, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPass=slmChPass, slmMuxNumber=slmMuxNumber, slmAdmin=slmAdmin, slmTrapDestEntry=slmTrapDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmRebootDelay=slmRebootDelay, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysIpAddr=slmSysIpAddr, slmSysOperStatus=slmSysOperStatus, slmSwRevName=slmSwRevName, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmSyslogPort=slmSyslogPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slm40GConf=slm40GConf, slmLicenseTable=slmLicenseTable, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, slmSysChassisId=slmSysChassisId, slmTrapLogParam3=slmTrapLogParam3, slmSysName=slmSysName, slmTrapUserLogin=slmTrapUserLogin, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigFile=slmConfigFile, slmChPassTable=slmChPassTable, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthTable=slmAuthTable, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthEntry=slmAuthEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, AdminAccess=AdminAccess, slmBoxSize=slmBoxSize, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestEntry=slmSyslogDestEntry, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmLicenseId=slmLicenseId, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminRowStatus=slmAdminRowStatus)
