...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmTrapLogParam1=slmTrapLogParam1, UserLogin=UserLogin, slmSysLocation=slmSysLocation, slmSysCalendarTime=slmSysCalendarTime, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmWriteCommunity=slmWriteCommunity, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmLicenseId=slmLicenseId, slmOemType=slmOemType, slmAdminTable=slmAdminTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmAdmin=slmAdmin, slmPmAvailable=slmPmAvailable, slmAdminRowStatus=slmAdminRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmRebootDelay=slmRebootDelay, slmSwRevDate=slmSwRevDate, slmConfigSysUptime=slmConfigSysUptime, slmRstpEnabled=slmRstpEnabled, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysOperStatus=slmSysOperStatus, slmTrapEnable=slmTrapEnable, slmSysChassisId=slmSysChassisId, slmSyslogPort=slmSyslogPort, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, slmEdfaNumber=slmEdfaNumber, slmAuthCommunity=slmAuthCommunity, slmTrapLogId=slmTrapLogId, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmPsuNumber=slmPsuNumber, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmSysSubnetMask=slmSysSubnetMask, slMain=slMain, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, AdminAccess=AdminAccess, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminCommunity=slmAdminCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmAdminLogin=slmAdminLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmAuthPassword=slmAuthPassword, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigFile=slmConfigFile, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseIndex=slmLicenseIndex, slmLogFile=slmLogFile, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, UserCommunity=UserCommunity, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmChPassTable=slmChPassTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmSyslogDestAddress=slmSyslogDestAddress, slmChPass=slmChPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestProtVersion=slmTrapDestProtVersion, slmMuxNumber=slmMuxNumber, slmSwRevName=slmSwRevName, slmTrapUserLogin=slmTrapUserLogin, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, SoftwareRevision=SoftwareRevision, slmTid=slmTid, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmDeact=slmSysAlmDeact, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmSysName=slmSysName, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr)
