...
Integer32, Gauge32, ModuleIdentity, NotificationType, iso, Counter32, ObjectIdentity, MibIdentifier, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Unsigned32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "NotificationType", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Unsigned32", "Opaque")
RowStatus, DateAndTime, TruthValue, DisplayString, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TruthValue", "DisplayString", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam4=slmTrapLogParam4, slmAuthPassword=slmAuthPassword, slmAuth=slmAuth, slmSysAlmAct=slmSysAlmAct, slm40GConf=slm40GConf, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmSysLocation=slmSysLocation, slmSysResetPm=slmSysResetPm, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmRebootDelay=slmRebootDelay, slmLogFile=slmLogFile, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdmin=slmAdmin, slmLogin=slmLogin, slmTrapLogEntry=slmTrapLogEntry, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminAccess=slmAdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestTable=slmTrapDestTable, slmAuthLogin=slmAuthLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogName=slmTrapLogName, slmReadCommunity=slmReadCommunity, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam3=slmTrapLogParam3, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmAdminRowStatus=slmAdminRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmAdminCommunity=slmAdminCommunity, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevName=slmSwRevName, slmTrapPort=slmTrapPort, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassTable=slmChPassTable, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmAuthEntry=slmAuthEntry, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevStatus=slmSwRevStatus, slmChPassOldPass=slmChPassOldPass, slmSysName=slmSysName, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmAuthCommunity=slmAuthCommunity, slmChPassEntry=slmChPassEntry, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogLevel=slmSyslogLevel, slmTrapEnable=slmTrapEnable, slmChPassLogin=slmChPassLogin, slmTrapCommunity=slmTrapCommunity, slmAdminEntry=slmAdminEntry, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber, slmAdminPassword=slmAdminPassword, slmSyslogPort=slmSyslogPort, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, slmSwRevEntry=slmSwRevEntry, UserPassword=UserPassword, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmSys=slmSys, PYSNMP_MODULE_ID=slMain, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, AdminAccess=AdminAccess, slmNetworkMode=slmNetworkMode, slmTrap=slmTrap, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber)
