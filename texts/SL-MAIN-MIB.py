...
ObjectIdentity, ModuleIdentity, MibIdentifier, Unsigned32, Counter64, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, NotificationType, TimeTicks, IpAddress, Counter32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Counter64", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Counter32", "Opaque")
TimeStamp, DisplayString, RowStatus, TruthValue, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "TruthValue", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysSignalType=slmConfigSysSignalType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmAdminTable=slmAdminTable, slmLicenseTable=slmLicenseTable, slmAdminCommunity=slmAdminCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmSwRevEntry=slmSwRevEntry, slmAuthLogin=slmAuthLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmSyslogPort=slmSyslogPort, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogTable=slmTrapLogTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, slmSysChassisId=slmSysChassisId, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, UserPassword=UserPassword, slMain=slMain, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmTrapDestTable=slmTrapDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmTrapEnable=slmTrapEnable, slmPmAvailable=slmPmAvailable, slmSysOperStatus=slmSysOperStatus, slmSwRevDate=slmSwRevDate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmSysMode=slmSysMode, slmLogin=slmLogin, slmAdmin=slmAdmin, slmAuthCommunity=slmAuthCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmTrapLogParam6=slmTrapLogParam6, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevTable=slmSwRevTable, slmTrapLogEntry=slmTrapLogEntry, slmEdfaNumber=slmEdfaNumber, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmAdminPassword=slmAdminPassword, slmSysIpAddr=slmSysIpAddr, slmAuth=slmAuth, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSubnetMask=slmSysSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmOemType=slmOemType, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmSysName=slmSysName, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminEntry=slmAdminEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmMuxNumber=slmMuxNumber, slmSysLocation=slmSysLocation, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmSwRevStatus=slmSwRevStatus, slmRstpEnabled=slmRstpEnabled, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmLicenseId=slmLicenseId, slmSysTemperature=slmSysTemperature, slmTrap=slmTrap, AdminAccess=AdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmLicense=slmLicense, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin)
