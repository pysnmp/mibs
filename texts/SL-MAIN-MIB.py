...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminTable=slmAdminTable, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmLicenseId=slmLicenseId, slmSysCalendarTime=slmSysCalendarTime, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmAuthTable=slmAuthTable, slmSwRevTable=slmSwRevTable, slmAdminEntry=slmAdminEntry, slmPsuNumber=slmPsuNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, slmChPassLogin=slmChPassLogin, slmPortsNumber=slmPortsNumber, slmTid=slmTid, slmOpticalSwitchExist=slmOpticalSwitchExist, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam1=slmTrapLogParam1, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, AdminAccess=AdminAccess, slmLogFile=slmLogFile, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestEntry=slmSyslogDestEntry, UserLogin=UserLogin, slmAuth=slmAuth, SoftwareRevision=SoftwareRevision, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmLicenseIndex=slmLicenseIndex, slmTrapDestCommunity=slmTrapDestCommunity, slmChPass=slmChPass, slmTrapCommunity=slmTrapCommunity, slmSysResetPm=slmSysResetPm, slmRstpEnabled=slmRstpEnabled, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSysLocation=slmSysLocation, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, slmAdminCommunity=slmAdminCommunity, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmLicenseTable=slmLicenseTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminAccess=slmAdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthPassword=slmAuthPassword, slmSyslogPort=slmSyslogPort, slmLicense=slmLicense, slmSysTrapFormat=slmSysTrapFormat, slmWriteCommunity=slmWriteCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthEntry=slmAuthEntry, slmReadCommunity=slmReadCommunity, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogId=slmTrapLogId, slmLogin=slmLogin, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmSysIpAddr=slmSysIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassTable=slmChPassTable, slmSysName=slmSysName, slmTrapLogParam5=slmTrapLogParam5, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, UserCommunity=UserCommunity, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam4=slmTrapLogParam4, slMain=slMain, slmAdminPassword=slmAdminPassword, slmSyslogLevel=slmSyslogLevel, slmSys=slmSys, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevDirectory=slmSwRevDirectory)
