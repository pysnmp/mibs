...
Bits, ModuleIdentity, Counter32, Gauge32, Counter64, MibIdentifier, Opaque, Integer32, iso, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "MibIdentifier", "Opaque", "Integer32", "iso", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysUplinkRate=slmSysUplinkRate, PYSNMP_MODULE_ID=slMain, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmAdmin=slmAdmin, slmAuthEntry=slmAuthEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmLogin=slmLogin, slmSysMode=slmSysMode, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmMuxNumber=slmMuxNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmConfigFile=slmConfigFile, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmLicense=slmLicense, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmSysIpAddr=slmSysIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysAlmDeact=slmSysAlmDeact, slmTrapEnable=slmTrapEnable, slmSwRevStatus=slmSwRevStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmVcatDelay=slmVcatDelay, slmLicenseId=slmLicenseId, slmSysName=slmSysName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevEntry=slmSwRevEntry, slmRebootDelay=slmRebootDelay, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPsuNumber=slmPsuNumber, slmSysTemperature=slmSysTemperature, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmAdminTable=slmAdminTable, slmBoxSize=slmBoxSize, slmTrapLogParam6=slmTrapLogParam6, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, UserCommunity=UserCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, UserLogin=UserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseTable=slmLicenseTable, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysLocation=slmSysLocation, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmTrapLogParam3=slmTrapLogParam3, slmSyslogPort=slmSyslogPort, slmChPassTable=slmChPassTable, slmChPassEntry=slmChPassEntry, slmAdminPassword=slmAdminPassword, slmEdfaNumber=slmEdfaNumber, SoftwareRevision=SoftwareRevision, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmAct=slmSysAlmAct, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogName=slmTrapLogName, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmOpticalSwitchExist=slmOpticalSwitchExist, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmSysOperStatus=slmSysOperStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthLogin=slmAuthLogin, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmAuthPassword=slmAuthPassword, slmChPassNewPass=slmChPassNewPass, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysResetPm=slmSysResetPm)
