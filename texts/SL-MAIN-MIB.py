...
Gauge32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64, Counter32, iso, Unsigned32, TimeTicks, Integer32, ModuleIdentity, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64", "Counter32", "iso", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "Opaque", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmVcatDelay=slmVcatDelay, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmRebootDelay=slmRebootDelay, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmTrapLogId=slmTrapLogId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmSysResetPm=slmSysResetPm, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthLogin=slmAuthLogin, slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmTrapSysNameChange=slmTrapSysNameChange, slmRstpEnabled=slmRstpEnabled, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmAuthTable=slmAuthTable, slmSysChassisId=slmSysChassisId, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmSysMode=slmSysMode, slmSysCalendarTime=slmSysCalendarTime, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmTid=slmTid, UserLogin=UserLogin, slmTrap=slmTrap, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmReadCommunity=slmReadCommunity, slmSyslogDestTable=slmSyslogDestTable, slmPmAvailable=slmPmAvailable, slmSwRevEntry=slmSwRevEntry, slmLicenseTable=slmLicenseTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPass=slmChPass, slmAuth=slmAuth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slMain=slMain, slmWriteCommunity=slmWriteCommunity, AdminAccess=AdminAccess, slmSysTemperature=slmSysTemperature, slmAdminPassword=slmAdminPassword, slmSysName=slmSysName, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, PYSNMP_MODULE_ID=slMain, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminCommunity=slmAdminCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestTable=slmTrapDestTable, slmSwRevStatus=slmSwRevStatus, slmTrapLogName=slmTrapLogName)
