...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, IpAddress, MibIdentifier, Counter64, Opaque, TimeTicks, ObjectIdentity, Integer32, Bits, iso, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "IpAddress", "MibIdentifier", "Counter64", "Opaque", "TimeTicks", "ObjectIdentity", "Integer32", "Bits", "iso", "Unsigned32", "NotificationType")
TimeStamp, DisplayString, TruthValue, RowStatus, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmRstpEnabled=slmRstpEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmSysIpAddr=slmSysIpAddr, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin, slmAuthCommunity=slmAuthCommunity, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam3=slmTrapLogParam3, slmAdmin=slmAdmin, slmReadCommunity=slmReadCommunity, slmLicense=slmLicense, slmChPassOldPass=slmChPassOldPass, slmAuthPassword=slmAuthPassword, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmSysName=slmSysName, slmAuth=slmAuth, slmSwRevTable=slmSwRevTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmAdminEntry=slmAdminEntry, slmSysMode=slmSysMode, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmMuxNumber=slmMuxNumber, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogName=slmTrapLogName, slmSysLocation=slmSysLocation, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPmAvailable=slmPmAvailable, slmRebootDelay=slmRebootDelay, slmVcatDelay=slmVcatDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogFile=slmLogFile, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmTrapEnable=slmTrapEnable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestEntry=slmSyslogDestEntry, slmPortsNumber=slmPortsNumber, slmConfigSysUptime=slmConfigSysUptime, slmSysChassisId=slmSysChassisId, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogin=slmLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmSwRevName=slmSwRevName, slmTrapLogId=slmTrapLogId, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminPassword=slmAdminPassword, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmOemType=slmOemType, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, AdminAccess=AdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmAdminAccess=slmAdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmSyslogLevel=slmSyslogLevel, slMain=slMain, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogEntry=slmTrapLogEntry)
