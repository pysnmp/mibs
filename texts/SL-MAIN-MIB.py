...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseIndex=slmLicenseIndex, slmSysSnmpVersion=slmSysSnmpVersion, slmRstpEnabled=slmRstpEnabled, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, slmSwRevDirectory=slmSwRevDirectory, slmNetworkMode=slmNetworkMode, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Password=slmSnmpv3Password, slm40GConf=slm40GConf, slmLogin=slmLogin, slmSysCalendarTime=slmSysCalendarTime, slmAuthLogin=slmAuthLogin, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPmAvailable=slmPmAvailable, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmLicenseId=slmLicenseId, slmPsuNumber=slmPsuNumber, slmAdminAccess=slmAdminAccess, slmEdfaNumber=slmEdfaNumber, slmAuthCommunity=slmAuthCommunity, slmChPass=slmChPass, slmTrapLogParam4=slmTrapLogParam4, slmConfigFile=slmConfigFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserPassword=UserPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmLicenseEntry=slmLicenseEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, PYSNMP_MODULE_ID=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestAddress=slmSyslogDestAddress, UserLogin=UserLogin, slmChPassLogin=slmChPassLogin, slmAdminTable=slmAdminTable, slmAdminEntry=slmAdminEntry, slmAdminPassword=slmAdminPassword, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmSysAlmDeact=slmSysAlmDeact, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSysAlmAct=slmSysAlmAct, slmChPassOldPass=slmChPassOldPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogId=slmTrapLogId, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmSwRevTable=slmSwRevTable, slmLicenseTable=slmLicenseTable, slMain=slMain, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmAdminLogin=slmAdminLogin, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmTrapLogName=slmTrapLogName, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmWriteCommunity=slmWriteCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam1=slmTrapLogParam1, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmOemType=slmOemType)
