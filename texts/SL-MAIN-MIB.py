...
TimeTicks, Counter64, ModuleIdentity, Bits, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter32, ObjectIdentity, Unsigned32, Integer32, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ModuleIdentity", "Bits", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter32", "ObjectIdentity", "Unsigned32", "Integer32", "Opaque", "IpAddress")
RowStatus, TimeStamp, TextualConvention, DisplayString, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTemperature=slmSysTemperature, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevStatus=slmSwRevStatus, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, AdminAccess=AdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmPsuNumber=slmPsuNumber, slmSwRevEntry=slmSwRevEntry, slmTrapLogName=slmTrapLogName, slmLicenseId=slmLicenseId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrap=slmTrap, slmTrapDestTable=slmTrapDestTable, slmSysCalendarTime=slmSysCalendarTime, slmAuthTable=slmAuthTable, slmAdminEntry=slmAdminEntry, slmTrapLogId=slmTrapLogId, slmTrapLogEntry=slmTrapLogEntry, slmAdminCommunity=slmAdminCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserCommunity=UserCommunity, slmTopologyEnabled=slmTopologyEnabled, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Password=slmSnmpv3Password, SoftwareRevision=SoftwareRevision, slmMuxNumber=slmMuxNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmSysLocation=slmSysLocation, slmTrapDestAddress=slmTrapDestAddress, slmAuthCommunity=slmAuthCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, slmRebootDelay=slmRebootDelay, slmTid=slmTid, slmReadCommunity=slmReadCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmTrapLogParam2=slmTrapLogParam2, slmSysResetPm=slmSysResetPm, slmSysChassisId=slmSysChassisId, slmConfigSysUptime=slmConfigSysUptime, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, PYSNMP_MODULE_ID=slMain, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmSysName=slmSysName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPmAvailable=slmPmAvailable, slmSyslogPort=slmSyslogPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmAdminRowStatus=slmAdminRowStatus, slmLicense=slmLicense, slMain=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmChPass=slmChPass, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDirectory=slmSwRevDirectory, slmTrapCommunity=slmTrapCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmSwRevDate=slmSwRevDate, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable)
