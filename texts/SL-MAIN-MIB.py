...
ModuleIdentity, Unsigned32, ObjectIdentity, IpAddress, Counter32, Opaque, Bits, NotificationType, iso, Integer32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter32", "Opaque", "Bits", "NotificationType", "iso", "Integer32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmAdminTable=slmAdminTable, slmAuthPassword=slmAuthPassword, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmLicenseTable=slmLicenseTable, slmTrapEnable=slmTrapEnable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmAdminLogin=slmAdminLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, SoftwareRevision=SoftwareRevision, slmTid=slmTid, slmSwRevTable=slmSwRevTable, slmTrapLogTable=slmTrapLogTable, slmAuthCommunity=slmAuthCommunity, slmLogFile=slmLogFile, slm40GConf=slm40GConf, slmPortsNumber=slmPortsNumber, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigFile=slmConfigFile, slmSysGatewayAddr=slmSysGatewayAddr, slmVcatDelay=slmVcatDelay, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, slmRstpEnabled=slmRstpEnabled, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmSysLocation=slmSysLocation, slmTrapDestCommunity=slmTrapDestCommunity, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmAuthTable=slmAuthTable, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassOldPass=slmChPassOldPass, slmPmAvailable=slmPmAvailable, slmAdminEntry=slmAdminEntry, slmTrapDestAddress=slmTrapDestAddress, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestIpAddress=slmSyslogDestIpAddress, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, UserCommunity=UserCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevStatus=slmSwRevStatus, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmSysAdminStatus=slmSysAdminStatus, slmTrapPort=slmTrapPort, slmTrap=slmTrap, slmSys=slmSys, slmMuxNumber=slmMuxNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysChassisId=slmSysChassisId, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogName=slmTrapLogName, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevName=slmSwRevName, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapCommunity=slmTrapCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam5=slmTrapLogParam5, slmSyslogLevel=slmSyslogLevel, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmSysCalendarTime=slmSysCalendarTime, slmAuthLogin=slmAuthLogin, slmRebootDelay=slmRebootDelay, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestTable=slmSyslogDestTable, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist)
