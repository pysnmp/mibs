...
NotificationType, Unsigned32, Bits, IpAddress, Gauge32, ObjectIdentity, TimeTicks, Counter64, MibIdentifier, Opaque, iso, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Bits", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "Counter64", "MibIdentifier", "Opaque", "iso", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmChPassOldPass=slmChPassOldPass, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmLicenseId=slmLicenseId, slmMuxNumber=slmMuxNumber, slmSyslogPort=slmSyslogPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmAuth=slmAuth, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmAct=slmSysAlmAct, slmVcatDelay=slmVcatDelay, slmSwRevName=slmSwRevName, slmAdminAccess=slmAdminAccess, slmRebootDelay=slmRebootDelay, slmTrapCommunity=slmTrapCommunity, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmChPass=slmChPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmTopologyEnabled=slmTopologyEnabled, slmAdmin=slmAdmin, slmChPassEntry=slmChPassEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, UserCommunity=UserCommunity, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmSysTrapFormat=slmSysTrapFormat, slmTid=slmTid, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmTrapLogParam4=slmTrapLogParam4, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminEntry=slmAdminEntry, slmAdminPassword=slmAdminPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmTrapLogParam2=slmTrapLogParam2, UserPassword=UserPassword, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseTable=slmLicenseTable, slmSwRevStatus=slmSwRevStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmSwRevTable=slmSwRevTable, AdminAccess=AdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam6=slmTrapLogParam6, SoftwareRevision=SoftwareRevision, slmSyslogLevel=slmSyslogLevel, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmAuthTable=slmAuthTable, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmLicenseIndex=slmLicenseIndex, slmChPassLogin=slmChPassLogin, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmConfigFile=slmConfigFile, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthCommunity=slmAuthCommunity, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, UserLogin=UserLogin, slmWriteCommunity=slmWriteCommunity, slmSysChassisId=slmSysChassisId, slmSysUplinkRate=slmSysUplinkRate, slmLogFile=slmLogFile)
