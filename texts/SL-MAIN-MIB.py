...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Opaque, NotificationType, Counter64, ObjectIdentity, iso, Counter32, MibIdentifier, ModuleIdentity, TimeTicks, Bits, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Opaque", "NotificationType", "Counter64", "ObjectIdentity", "iso", "Counter32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Bits", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmTrapPort=slmTrapPort, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmSysMode=slmSysMode, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, UserPassword=UserPassword, slmTrapDestAddress=slmTrapDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthLogin=slmAuthLogin, slmSysOperStatus=slmSysOperStatus, slmAuthTable=slmAuthTable, slmAdminEntry=slmAdminEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassEntry=slmChPassEntry, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLocation=slmSysLocation, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysUptime=slmConfigSysUptime, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slmSysChassisId=slmSysChassisId, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmSysAlmAct=slmSysAlmAct, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthCommunity=slmAuthCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slmLicense=slmLicense, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmRstpEnabled=slmRstpEnabled, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmAdminAccess=slmAdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam4=slmTrapLogParam4, slmLogin=slmLogin, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmNetworkMode=slmNetworkMode, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmSysName=slmSysName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigFile=slmConfigFile, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDate=slmSwRevDate, slmAdmin=slmAdmin, slmSysSubnetMask=slmSysSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserLogin=slmTrapUserLogin, slmLicenseEntry=slmLicenseEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDirectory=slmSwRevDirectory, slmAuth=slmAuth, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmAdminLogin=slmAdminLogin, slMain=slMain, UserCommunity=UserCommunity, slmChPassTable=slmChPassTable, slmTrapLogParam1=slmTrapLogParam1, slmLogFile=slmLogFile, slmLicenseIndex=slmLicenseIndex, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, slmTrapLogName=slmTrapLogName, slmPsuNumber=slmPsuNumber, slmSysResetPm=slmSysResetPm, slmTrapLogParam5=slmTrapLogParam5)
