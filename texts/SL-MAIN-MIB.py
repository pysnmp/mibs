...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysIpAddr=slmSysIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmConfigFile=slmConfigFile, slmAdminEntry=slmAdminEntry, slmTrapDestAddress=slmTrapDestAddress, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam1=slmTrapLogParam1, slmConfigSysUptime=slmConfigSysUptime, slmChPassLogin=slmChPassLogin, slmVcatDelay=slmVcatDelay, slmAuthTable=slmAuthTable, UserLogin=UserLogin, slmAuthLogin=slmAuthLogin, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, PYSNMP_MODULE_ID=slMain, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSysLocation=slmSysLocation, slmSysActiveSwVersion=slmSysActiveSwVersion, slmEdfaNumber=slmEdfaNumber, slmAdminAccess=slmAdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, UserCommunity=UserCommunity, slmTrapLogName=slmTrapLogName, slmTrapLogParam3=slmTrapLogParam3, slmAuthEntry=slmAuthEntry, slMain=slMain, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmSys=slmSys, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmTrapLogParam4=slmTrapLogParam4, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAlmDeact=slmSysAlmDeact, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmAuthCommunity=slmAuthCommunity, slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserPassword=UserPassword, slmSysTemperature=slmSysTemperature, slmWriteCommunity=slmWriteCommunity, slmNetworkMode=slmNetworkMode, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogLevel=slmSyslogLevel, slmPmAvailable=slmPmAvailable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassEntry=slmChPassEntry, slmChPassTable=slmChPassTable, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmSysMode=slmSysMode, slmTid=slmTid, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogPort=slmSyslogPort, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseEntry=slmLicenseEntry, slmLicenseTable=slmLicenseTable, slmSyslogDestTable=slmSyslogDestTable, slmSwRevDirectory=slmSwRevDirectory, slmSysTrapFormat=slmSysTrapFormat, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmSysCalendarTime=slmSysCalendarTime, slmAuthPassword=slmAuthPassword, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmMuxNumber=slmMuxNumber, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmTrapDestEntry=slmTrapDestEntry, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestIpAddress=slmSyslogDestIpAddress)
