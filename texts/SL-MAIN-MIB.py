...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ObjectIdentity, ModuleIdentity, NotificationType, Integer32, MibIdentifier, Counter64, iso, Counter32, Opaque, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Integer32", "MibIdentifier", "Counter64", "iso", "Counter32", "Opaque", "IpAddress", "Bits")
DateAndTime, TextualConvention, DisplayString, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseTable=slmLicenseTable, slmTrapLogParam6=slmTrapLogParam6, SoftwareRevision=SoftwareRevision, slmSwRevTable=slmSwRevTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthCommunity=slmAuthCommunity, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysUptime=slmConfigSysUptime, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, UserPassword=UserPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam4=slmTrapLogParam4, slmSysIpAddr=slmSysIpAddr, slmAuthPassword=slmAuthPassword, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLocation=slmSysLocation, slmAdminPassword=slmAdminPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmTrapEnable=slmTrapEnable, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmAuthTable=slmAuthTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmAdminRowStatus=slmAdminRowStatus, slmAdminAccess=slmAdminAccess, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminEntry=slmAdminEntry, UserCommunity=UserCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, PYSNMP_MODULE_ID=slMain, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTable=slmTrapLogTable, slmLogFile=slmLogFile, slmAuthLogin=slmAuthLogin, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogName=slmTrapLogName, slmPsuNumber=slmPsuNumber, slmTrapPort=slmTrapPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAdminStatus=slmSysAdminStatus, slmSysChassisId=slmSysChassisId, slmLogin=slmLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, slmLicenseIndex=slmLicenseIndex, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmSwRevStatus=slmSwRevStatus, slmChPassNewPass=slmChPassNewPass, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, slmLicenseEntry=slmLicenseEntry, slmSyslogPort=slmSyslogPort, slmTrapLogParam1=slmTrapLogParam1, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmOemType=slmOemType, slmOpticalSwitchExist=slmOpticalSwitchExist, slmMuxNumber=slmMuxNumber, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slm40GConf=slm40GConf, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmReadCommunity=slmReadCommunity, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slMain=slMain, slmEdfaNumber=slmEdfaNumber, slmSysOperStatus=slmSysOperStatus, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmChPassEntry=slmChPassEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmWriteCommunity=slmWriteCommunity, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm)
