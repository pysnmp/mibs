...
TimeTicks, Bits, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, Gauge32, Counter64, ModuleIdentity, Integer32, IpAddress, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "IpAddress", "Unsigned32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysCalendarTime=slmSysCalendarTime, slmTrapDestAddress=slmTrapDestAddress, UserCommunity=UserCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmAdminAccess=slmAdminAccess, slmRstpEnabled=slmRstpEnabled, slmAdminEntry=slmAdminEntry, slmTrapPort=slmTrapPort, slmSysMode=slmSysMode, slmTopologyEnabled=slmTopologyEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmLicenseId=slmLicenseId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmSysAlmAct=slmSysAlmAct, slmSwRevName=slmSwRevName, slmTrap=slmTrap, slmLogFile=slmLogFile, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmSysLanIpAddr=slmSysLanIpAddr, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmBoxSize=slmBoxSize, slMain=slMain, AdminAccess=AdminAccess, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTable=slmTrapLogTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogPort=slmSyslogPort, slmChPassLogin=slmChPassLogin, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, slmLogin=slmLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmSys=slmSys, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, slmTrapLogParam2=slmTrapLogParam2, slmAuthCommunity=slmAuthCommunity, slmAuthLogin=slmAuthLogin, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevTable=slmSwRevTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmSyslogLevel=slmSyslogLevel, slmAdmin=slmAdmin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmAuthEntry=slmAuthEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam5=slmTrapLogParam5, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, PYSNMP_MODULE_ID=slMain, slmNetworkMode=slmNetworkMode, slmPmAvailable=slmPmAvailable, slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmLicenseTable=slmLicenseTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysNetworkPrefix=slmSysNetworkPrefix, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmAuth=slmAuth, slmSwRevEntry=slmSwRevEntry, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminTable=slmAdminTable, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmSysLocation=slmSysLocation, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestCommunity=slmTrapDestCommunity, UserPassword=UserPassword, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmConfigSysSignalType=slmConfigSysSignalType)
