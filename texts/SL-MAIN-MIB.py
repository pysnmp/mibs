...
iso, Gauge32, MibIdentifier, Counter32, Unsigned32, IpAddress, ObjectIdentity, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, NotificationType, Counter64, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibIdentifier", "Counter32", "Unsigned32", "IpAddress", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "NotificationType", "Counter64", "Opaque")
RowStatus, DateAndTime, DisplayString, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminAccess=slmAdminAccess, slmTrapLogParam4=slmTrapLogParam4, slmTrapEnable=slmTrapEnable, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmWriteCommunity=slmWriteCommunity, slmRebootDelay=slmRebootDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmSysMode=slmSysMode, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmLicenseIndex=slmLicenseIndex, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmSyslogLevel=slmSyslogLevel, slmPmAvailable=slmPmAvailable, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassOldPass=slmChPassOldPass, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, slMain=slMain, slmTrapLogName=slmTrapLogName, slmSysName=slmSysName, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, UserPassword=UserPassword, slmAdminRowStatus=slmAdminRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmNetworkMode=slmNetworkMode, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmLogin=slmLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, UserLogin=UserLogin, slmSwRevName=slmSwRevName, slmAdminEntry=slmAdminEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTid=slmTid, slmSys=slmSys, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthLogin=slmAuthLogin, slmSysSubnetMask=slmSysSubnetMask, slmConfigFile=slmConfigFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slmLogFile=slmLogFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassLogin=slmChPassLogin, slmLicenseEntry=slmLicenseEntry, slmPortsNumber=slmPortsNumber, AdminAccess=AdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseId=slmLicenseId, slmOemType=slmOemType, UserCommunity=UserCommunity, slmVcatDelay=slmVcatDelay, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRstpEnabled=slmRstpEnabled, slmSyslogDestTable=slmSyslogDestTable, SoftwareRevision=SoftwareRevision, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam3=slmTrapLogParam3, slmAuth=slmAuth, slmTrapLogParam5=slmTrapLogParam5, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmChPassEntry=slmChPassEntry, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmSysChassisId=slmSysChassisId, slmAuthTable=slmAuthTable, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmSysIpAddr=slmSysIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmEdfaNumber=slmEdfaNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmAuthPassword=slmAuthPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slm40GConf=slm40GConf, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress)
