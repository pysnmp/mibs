...
Unsigned32, Opaque, Integer32, ModuleIdentity, TimeTicks, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, NotificationType, Counter32, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Opaque", "Integer32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "NotificationType", "Counter32", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogName=slmTrapLogName, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmSys=slmSys, slmSysTemperature=slmSysTemperature, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, AdminAccess=AdminAccess, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmLogFile=slmLogFile, slmChPassOldPass=slmChPassOldPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slMain=slMain, slmTrap=slmTrap, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdmin=slmAdmin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmSwRevDate=slmSwRevDate, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminLogin=slmAdminLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrapEnable=slmTrapEnable, slmSwRevEntry=slmSwRevEntry, slmPmAvailable=slmPmAvailable, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserPassword=UserPassword, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmChPassEntry=slmChPassEntry, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthTable=slmAuthTable, slmRebootDelay=slmRebootDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmWriteCommunity=slmWriteCommunity, slmSyslogPort=slmSyslogPort, slmChPass=slmChPass, slmSysResetPm=slmSysResetPm, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, slmTopologyEnabled=slmTopologyEnabled, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmTrapCommunity=slmTrapCommunity, slmAdminCommunity=slmAdminCommunity, slmAdminRowStatus=slmAdminRowStatus, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmSwRevTable=slmSwRevTable, slmConfigSysUptime=slmConfigSysUptime, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam4=slmTrapLogParam4, slmAdminPassword=slmAdminPassword, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam2=slmTrapLogParam2, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmSysAlmAct=slmSysAlmAct, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserAccess=slmTrapUserAccess, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slmRstpEnabled=slmRstpEnabled)
