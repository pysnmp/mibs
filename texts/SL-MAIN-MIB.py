...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminPassword=slmAdminPassword, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseIndex=slmLicenseIndex, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmRebootDelay=slmRebootDelay, slmMuxNumber=slmMuxNumber, slmSys=slmSys, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slMain=slMain, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestTable=slmSyslogDestTable, slmSysMode=slmSysMode, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmSwRevDate=slmSwRevDate, UserPassword=UserPassword, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmAuth=slmAuth, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmPmAvailable=slmPmAvailable, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmEdfaNumber=slmEdfaNumber, slmSysResetPm=slmSysResetPm, slmSysUplinkRate=slmSysUplinkRate, slmLogin=slmLogin, UserCommunity=UserCommunity, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmBoxSize=slmBoxSize, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapPort=slmTrapPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmAdminAccess=slmAdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthTable=slmAuthTable, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmWriteCommunity=slmWriteCommunity, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLocation=slmSysLocation, PYSNMP_MODULE_ID=slMain, slmLicenseTable=slmLicenseTable, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevName=slmSwRevName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmPortsNumber=slmPortsNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmAdminCommunity=slmAdminCommunity, slmOemType=slmOemType, slmAdminRowStatus=slmAdminRowStatus, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, SoftwareRevision=SoftwareRevision, slmSysOperStatus=slmSysOperStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmTrapDestAddress=slmTrapDestAddress, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity)
