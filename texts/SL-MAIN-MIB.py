...
Bits, Gauge32, Integer32, IpAddress, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Unsigned32, Counter64, iso, NotificationType, MibIdentifier, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Integer32", "IpAddress", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Unsigned32", "Counter64", "iso", "NotificationType", "MibIdentifier", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogId=slmTrapLogId, slmSysAlmDeact=slmSysAlmDeact, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestAddress=slmTrapDestAddress, slmAuthTable=slmAuthTable, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmSysUplinkRate=slmSysUplinkRate, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmPsuNumber=slmPsuNumber, slmTrapDestTable=slmTrapDestTable, slmLicenseId=slmLicenseId, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmAuth=slmAuth, slmAdminLogin=slmAdminLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slmPortsNumber=slmPortsNumber, slmChPassEntry=slmChPassEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmTrapEnable=slmTrapEnable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmSysResetPm=slmSysResetPm, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, slmWriteCommunity=slmWriteCommunity, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmChPassOldPass=slmChPassOldPass, slmSwRevDirectory=slmSwRevDirectory, PYSNMP_MODULE_ID=slMain, slmSysName=slmSysName, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPmAvailable=slmPmAvailable, slmConfigFile=slmConfigFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, AdminAccess=AdminAccess, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmSysOperStatus=slmSysOperStatus, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, UserPassword=UserPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysSignalType=slmConfigSysSignalType, UserLogin=UserLogin, slmSysAlmAct=slmSysAlmAct, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmAdminEntry=slmAdminEntry, slmTrapLogParam1=slmTrapLogParam1, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmTrapLogTable=slmTrapLogTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserAccess=slmTrapUserAccess, SoftwareRevision=SoftwareRevision, slmSwRevEntry=slmSwRevEntry, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmSyslogPort=slmSyslogPort, slmTid=slmTid, slmAdminAccess=slmAdminAccess, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmVcatDelay=slmVcatDelay, slmLicense=slmLicense, slmSysLocation=slmSysLocation, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword)
