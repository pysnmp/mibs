...
Counter32, MibIdentifier, Unsigned32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, iso, Integer32, ObjectIdentity, IpAddress, Counter64, Opaque, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "iso", "Integer32", "ObjectIdentity", "IpAddress", "Counter64", "Opaque", "TimeTicks")
TextualConvention, TruthValue, RowStatus, DateAndTime, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "DateAndTime", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuth=slmAuth, slmSysSubnetMask=slmSysSubnetMask, slmWriteCommunity=slmWriteCommunity, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPsuNumber=slmPsuNumber, slmSysLocation=slmSysLocation, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmTrapLogTable=slmTrapLogTable, slmNetworkMode=slmNetworkMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmRebootDelay=slmRebootDelay, slmAdminPassword=slmAdminPassword, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestTable=slmTrapDestTable, slmTrapDestEntry=slmTrapDestEntry, slmAdminLogin=slmAdminLogin, AdminAccess=AdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmMuxNumber=slmMuxNumber, slmConfigFile=slmConfigFile, slmTopologyEnabled=slmTopologyEnabled, UserCommunity=UserCommunity, slmPmAvailable=slmPmAvailable, slmSysName=slmSysName, slmAuthTable=slmAuthTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmDeact=slmSysAlmDeact, slmChPassEntry=slmChPassEntry, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Password=slmSnmpv3Password, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmSysOperStatus=slmSysOperStatus, slmEdfaNumber=slmEdfaNumber, slmReadCommunity=slmReadCommunity, slmTrapPort=slmTrapPort, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmOemType=slmOemType, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmSysMode=slmSysMode, slmOpticalSwitchExist=slmOpticalSwitchExist, UserPassword=UserPassword, slMain=slMain, slmAuthPassword=slmAuthPassword, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserLogin=slmTrapUserLogin, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmLicenseEntry=slmLicenseEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthEntry=slmAuthEntry, slmSysResetPm=slmSysResetPm, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestAddress=slmTrapDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestTable=slmSyslogDestTable, slmSys=slmSys, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmAdminEntry=slmAdminEntry, slmSwRevDirectory=slmSwRevDirectory, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, slmSysChassisId=slmSysChassisId, slmSwRevStatus=slmSwRevStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, SoftwareRevision=SoftwareRevision, slmSwRevName=slmSwRevName, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassLogin=slmChPassLogin, slmSwRevTable=slmSwRevTable, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled)
