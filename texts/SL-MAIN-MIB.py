...
Opaque, NotificationType, IpAddress, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, MibIdentifier, iso, Unsigned32, ModuleIdentity, Counter32, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "NotificationType", "IpAddress", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "MibIdentifier", "iso", "Unsigned32", "ModuleIdentity", "Counter32", "Gauge32", "Integer32")
DisplayString, DateAndTime, RowStatus, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "RowStatus", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogId=slmTrapLogId, slmLicenseEntry=slmLicenseEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmTrapLogEntry=slmTrapLogEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, UserPassword=UserPassword, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmLicense=slmLicense, slmAdminLogin=slmAdminLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmSnmpv3Password=slmSnmpv3Password, slmChPassEntry=slmChPassEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmAdmin=slmAdmin, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysCalendarTime=slmSysCalendarTime, slmRebootDelay=slmRebootDelay, slmPortsNumber=slmPortsNumber, slmSys=slmSys, PYSNMP_MODULE_ID=slMain, slmSysIpAddr=slmSysIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmTrap=slmTrap, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slMain=slMain, slmChPassLogin=slmChPassLogin, slmSwRevDate=slmSwRevDate, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevName=slmSwRevName, slmSysOperStatus=slmSysOperStatus, slmSysResetPm=slmSysResetPm, slmTid=slmTid, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapUserAccess=slmTrapUserAccess, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuth=slmAuth, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserLogin=slmTrapUserLogin, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmSysLocation=slmSysLocation, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmSysMode=slmSysMode, slmTrapLogName=slmTrapLogName, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassTable=slmChPassTable, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysName=slmSysName, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmSwRevDirectory=slmSwRevDirectory, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmAuthCommunity=slmAuthCommunity, slmTrapLogTable=slmTrapLogTable, slmSwRevEntry=slmSwRevEntry, slmConfigFile=slmConfigFile, slmAdminAccess=slmAdminAccess)
