...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmSys=slmSys, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseTable=slmLicenseTable, slmReadCommunity=slmReadCommunity, slmSysLocation=slmSysLocation, slmLicenseIndex=slmLicenseIndex, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmMuxNumber=slmMuxNumber, slmSnmpv3Password=slmSnmpv3Password, slmAuthTable=slmAuthTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmPsuNumber=slmPsuNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmSysChassisId=slmSysChassisId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogId=slmTrapLogId, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmOemType=slmOemType, slmTrapDestAddress=slmTrapDestAddress, slmTrapPort=slmTrapPort, slmSysMode=slmSysMode, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slm40GConf=slm40GConf, slmSwRevStatus=slmSwRevStatus, slmSwRevName=slmSwRevName, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmAdminAccess=slmAdminAccess, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmPortsNumber=slmPortsNumber, SoftwareRevision=SoftwareRevision, slmConfigSysUptime=slmConfigSysUptime, slmSysAdminStatus=slmSysAdminStatus, slmChPassEntry=slmChPassEntry, slmBoxSize=slmBoxSize, slmAdminRowStatus=slmAdminRowStatus, slmLogin=slmLogin, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, slmSysAlmDeact=slmSysAlmDeact, slmSysIpAddr=slmSysIpAddr, slmRebootDelay=slmRebootDelay, slmSnmpv3Auth=slmSnmpv3Auth, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassLogin=slmChPassLogin, slmSysTemperature=slmSysTemperature, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmSysSnmpVersion=slmSysSnmpVersion, AdminAccess=AdminAccess, slmTrapDestTable=slmTrapDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmNetworkMode=slmNetworkMode, slmChPassOldPass=slmChPassOldPass, slmAuthLogin=slmAuthLogin, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmTrapLogTable=slmTrapLogTable, slmAdmin=slmAdmin, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogName=slmTrapLogName, slmAuthEntry=slmAuthEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmSysName=slmSysName, slmAdminLogin=slmAdminLogin, slmSwRevTable=slmSwRevTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminPassword=slmAdminPassword, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmWriteCommunity=slmWriteCommunity, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogEntry=slmTrapLogEntry, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmSysOperStatus=slmSysOperStatus)
