...
IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, Unsigned32, Bits, Counter64, iso, Integer32, MibIdentifier, Opaque, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "Unsigned32", "Bits", "Counter64", "iso", "Integer32", "MibIdentifier", "Opaque", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmLicenseIndex=slmLicenseIndex, slmTrapUserLogin=slmTrapUserLogin, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmAdmin=slmAdmin, slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, slmTrapCommunity=slmTrapCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysChassisId=slmSysChassisId, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestEntry=slmTrapDestEntry, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slmAuthCommunity=slmAuthCommunity, slmTid=slmTid, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmLogFile=slmLogFile, slmSys=slmSys, slmSyslogPort=slmSyslogPort, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminLogin=slmAdminLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrap=slmTrap, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogEntry=slmTrapLogEntry, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysUptime=slmConfigSysUptime, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, slmSnmpv3Password=slmSnmpv3Password, slmSysUplinkRate=slmSysUplinkRate, slmChPassNewPass=slmChPassNewPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysSignalType=slmConfigSysSignalType, slmSysName=slmSysName, slmSysSnmpVersion=slmSysSnmpVersion, slmSysResetPm=slmSysResetPm, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuth=slmAuth, slmMuxNumber=slmMuxNumber, slmPortsNumber=slmPortsNumber, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigFile=slmConfigFile, slmLicenseTable=slmLicenseTable, slmChPassEntry=slmChPassEntry, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmLicenseEntry=slmLicenseEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapPort=slmTrapPort, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassLogin=slmChPassLogin, slmNetworkMode=slmNetworkMode, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, UserPassword=UserPassword, slmSysAlmDeact=slmSysAlmDeact, slmChPass=slmChPass, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmPsuNumber=slmPsuNumber, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmAdminAccess=slmAdminAccess, slmLicense=slmLicense, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmSwRevStatus=slmSwRevStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, PYSNMP_MODULE_ID=slMain, slmSwRevDate=slmSwRevDate, slmChPassTable=slmChPassTable, slmAuthTable=slmAuthTable, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmPmAvailable=slmPmAvailable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmWriteCommunity=slmWriteCommunity, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmAuthLogin=slmAuthLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmBoxSize=slmBoxSize, slmSwRevTable=slmSwRevTable)
