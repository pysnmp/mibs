...
Integer32, TimeTicks, Unsigned32, Counter64, Opaque, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, IpAddress, ObjectIdentity, NotificationType, Counter32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Unsigned32", "Counter64", "Opaque", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "IpAddress", "ObjectIdentity", "NotificationType", "Counter32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevDate=slmSwRevDate, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Password=slmSnmpv3Password, slmSysTrapFormat=slmSysTrapFormat, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapEnable=slmTrapEnable, slMain=slMain, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTemperature=slmSysTemperature, slmLogFile=slmLogFile, SoftwareRevision=SoftwareRevision, slmPsuNumber=slmPsuNumber, slmSwRevTable=slmSwRevTable, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, PYSNMP_MODULE_ID=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmAdminCommunity=slmAdminCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysOperStatus=slmSysOperStatus, slmOemType=slmOemType, slmSysCalendarTime=slmSysCalendarTime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmAdmin=slmAdmin, slmTrapLogParam6=slmTrapLogParam6, slmConfigFile=slmConfigFile, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmSysAdminStatus=slmSysAdminStatus, slmTrapCommunity=slmTrapCommunity, slmAdminTable=slmAdminTable, slmSys=slmSys, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassEntry=slmChPassEntry, AdminAccess=AdminAccess, slmSysMode=slmSysMode, slmSyslogDestTable=slmSyslogDestTable, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseId=slmLicenseId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmSysUplinkRate=slmSysUplinkRate, slmAuthPassword=slmAuthPassword, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogTable=slmTrapLogTable, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmTid=slmTid, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevName=slmSwRevName, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevEntry=slmSwRevEntry, slmAuthEntry=slmAuthEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogEntry=slmTrapLogEntry, slmTrap=slmTrap, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogin=slmLogin, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassOldPass=slmChPassOldPass, slmAdminEntry=slmAdminEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slmLicense=slmLicense, slmTrapLogParam3=slmTrapLogParam3, slm40GConf=slm40GConf, slmSnmpv3Auth=slmSnmpv3Auth, slmRebootDelay=slmRebootDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmVcatDelay=slmVcatDelay, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserAccess=slmTrapUserAccess, slmLicenseIndex=slmLicenseIndex, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, UserLogin=UserLogin)
