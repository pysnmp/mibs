...
Integer32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, TimeTicks, iso, Gauge32, Counter32, ModuleIdentity, Opaque, Bits, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "TimeTicks", "iso", "Gauge32", "Counter32", "ModuleIdentity", "Opaque", "Bits", "ObjectIdentity", "IpAddress")
TruthValue, TextualConvention, TimeStamp, DateAndTime, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TimeStamp", "DateAndTime", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogName=slmTrapLogName, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, UserLogin=UserLogin, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmSysResetPm=slmSysResetPm, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTemperature=slmSysTemperature, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmAdminEntry=slmAdminEntry, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestTable=slmTrapDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, slmSysAlmAct=slmSysAlmAct, slmSysNetworkPrefix=slmSysNetworkPrefix, UserPassword=UserPassword, slmTid=slmTid, slmSysName=slmSysName, slmSysSubnetMask=slmSysSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmChPass=slmChPass, slmSysOperStatus=slmSysOperStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevName=slmSwRevName, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogEntry=slmTrapLogEntry, slmAuthTable=slmAuthTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLocation=slmSysLocation, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminCommunity=slmAdminCommunity, slm40GConf=slm40GConf, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevTable=slmSwRevTable, UserCommunity=UserCommunity, slmOemType=slmOemType, slmVcatDelay=slmVcatDelay, slMain=slMain, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogId=slmTrapLogId, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmEdfaNumber=slmEdfaNumber, slmTrapCommunity=slmTrapCommunity, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmChPassEntry=slmChPassEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseId=slmLicenseId, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysMode=slmSysMode, PYSNMP_MODULE_ID=slMain, slmTrapLogTable=slmTrapLogTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPsuNumber=slmPsuNumber, slmTrapDestAddress=slmTrapDestAddress, slmSwRevEntry=slmSwRevEntry, SoftwareRevision=SoftwareRevision, slmAuthEntry=slmAuthEntry, slmAdminPassword=slmAdminPassword, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmAuthLogin=slmAuthLogin, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmMuxNumber=slmMuxNumber, slmSwRevDirectory=slmSwRevDirectory, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmLicense=slmLicense, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogFile=slmLogFile, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, AdminAccess=AdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmAuth=slmAuth, slmAdmin=slmAdmin, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, slmTopologyEnabled=slmTopologyEnabled)
