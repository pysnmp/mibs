...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminEntry=slmAdminEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slmBoxSize=slmBoxSize, slmAuthLogin=slmAuthLogin, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmSyslogLevel=slmSyslogLevel, slmEdfaNumber=slmEdfaNumber, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserLogin=slmTrapUserLogin, slmChPassLogin=slmChPassLogin, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmLicenseIndex=slmLicenseIndex, slmSwRevTable=slmSwRevTable, slmSysUplinkRate=slmSysUplinkRate, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmChPassTable=slmChPassTable, slmTrapEnable=slmTrapEnable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, AdminAccess=AdminAccess, slmAuth=slmAuth, slmLicenseExpiration=slmLicenseExpiration, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTable=slmTrapLogTable, slmSysOperStatus=slmSysOperStatus, slmLicenseId=slmLicenseId, slmConfigFile=slmConfigFile, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassOldPass=slmChPassOldPass, slmSysLocation=slmSysLocation, slmTopologyEnabled=slmTopologyEnabled, slmMuxNumber=slmMuxNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmAct=slmSysAlmAct, slmLicense=slmLicense, slmSysTemperature=slmSysTemperature, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogName=slmTrapLogName, slmReadCommunity=slmReadCommunity, slmRebootDelay=slmRebootDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, PYSNMP_MODULE_ID=slMain, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmOemType=slmOemType, slmSwRevEntry=slmSwRevEntry, slmChPassNewPass=slmChPassNewPass, slmSwRevDate=slmSwRevDate, slmPmAvailable=slmPmAvailable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminTable=slmAdminTable, UserCommunity=UserCommunity, UserLogin=UserLogin, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysSignalType=slmConfigSysSignalType, slmPortsNumber=slmPortsNumber, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysResetPm=slmSysResetPm, slmSysName=slmSysName, UserPassword=UserPassword, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapPort=slmTrapPort, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthEntry=slmAuthEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevName=slmSwRevName, slm40GConf=slm40GConf, slmAdminPassword=slmAdminPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestTable=slmSyslogDestTable)
