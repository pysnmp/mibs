...
Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Opaque, Counter32, MibIdentifier, IpAddress, TimeTicks, iso, Counter64, Gauge32, NotificationType, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Opaque", "Counter32", "MibIdentifier", "IpAddress", "TimeTicks", "iso", "Counter64", "Gauge32", "NotificationType", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmSysTrapFormat=slmSysTrapFormat, slmLicenseExpiration=slmLicenseExpiration, slmAuthEntry=slmAuthEntry, AdminAccess=AdminAccess, slmMuxNumber=slmMuxNumber, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmTrap=slmTrap, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, slmWriteCommunity=slmWriteCommunity, slmSysChassisId=slmSysChassisId, slmChPassTable=slmChPassTable, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmAuthPassword=slmAuthPassword, slmSys=slmSys, slmLicenseEntry=slmLicenseEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmPsuNumber=slmPsuNumber, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmTrapPort=slmTrapPort, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmSyslogDestEntry=slmSyslogDestEntry, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmAdminLogin=slmAdminLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOemType=slmOemType, slmTrapLogTable=slmTrapLogTable, slmConfigFile=slmConfigFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmSwRevEntry=slmSwRevEntry, slmVcatDelay=slmVcatDelay, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmAdminAccess=slmAdminAccess, slmRebootDelay=slmRebootDelay, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmTrapSysNameChange=slmTrapSysNameChange, slmRstpEnabled=slmRstpEnabled, slmPortsNumber=slmPortsNumber, slmSysMode=slmSysMode, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthCommunity=slmAuthCommunity, slmTrapDestEntry=slmTrapDestEntry, slmLicenseIndex=slmLicenseIndex, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Password=slmSnmpv3Password, slmLicenseId=slmLicenseId, UserCommunity=UserCommunity, slMain=slMain, slmChPass=slmChPass, slmLicense=slmLicense, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogName=slmTrapLogName, slmAuth=slmAuth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysUptime=slmConfigSysUptime, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminTable=slmAdminTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus)
