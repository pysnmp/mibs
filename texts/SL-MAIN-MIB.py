...
Gauge32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Unsigned32, Bits, Counter32, TimeTicks, ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Unsigned32", "Bits", "Counter32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, UserCommunity=UserCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysResetPm=slmSysResetPm, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, slmMuxNumber=slmMuxNumber, slmSwRevDirectory=slmSwRevDirectory, slmSysTrapFormat=slmSysTrapFormat, slmReadCommunity=slmReadCommunity, slmEdfaNumber=slmEdfaNumber, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmSysCalendarTime=slmSysCalendarTime, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmSwRevStatus=slmSwRevStatus, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTable=slmTrapLogTable, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, slmSys=slmSys, slmAuth=slmAuth, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmTrapLogId=slmTrapLogId, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmTrapEnable=slmTrapEnable, slmSnmpv3Password=slmSnmpv3Password, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmAdmin=slmAdmin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPsuNumber=slmPsuNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRebootDelay=slmRebootDelay, slmAuthEntry=slmAuthEntry, slmSysTemperature=slmSysTemperature, slmSysChassisId=slmSysChassisId, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevName=slmSwRevName, slmChPassLogin=slmChPassLogin, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogName=slmTrapLogName, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmAct=slmSysAlmAct, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmChPass=slmChPass, slmSysLocation=slmSysLocation, slmAuthLogin=slmAuthLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrap=slmTrap, slmWriteCommunity=slmWriteCommunity, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmTrapLogParam4=slmTrapLogParam4, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmAdminCommunity=slmAdminCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmRstpEnabled=slmRstpEnabled, slmTid=slmTid, slmLicenseEntry=slmLicenseEntry, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, PYSNMP_MODULE_ID=slMain, slmVcatDelay=slmVcatDelay, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmTrapPort=slmTrapPort, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
