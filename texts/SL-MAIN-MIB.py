...
Unsigned32, ObjectIdentity, Opaque, Bits, Gauge32, TimeTicks, Counter32, NotificationType, Counter64, MibIdentifier, Integer32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Opaque", "Bits", "Gauge32", "TimeTicks", "Counter32", "NotificationType", "Counter64", "MibIdentifier", "Integer32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseEntry=slmLicenseEntry, slMain=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRebootDelay=slmRebootDelay, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmTrapLogId=slmTrapLogId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigFile=slmConfigFile, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam2=slmTrapLogParam2, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmChPassLogin=slmChPassLogin, slmAuthPassword=slmAuthPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmSysChassisId=slmSysChassisId, slmSysIpAddr=slmSysIpAddr, slmAdminEntry=slmAdminEntry, slmTrapLogParam6=slmTrapLogParam6, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmNetworkMode=slmNetworkMode, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysTemperature=slmSysTemperature, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOemType=slmOemType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmAuthLogin=slmAuthLogin, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmTrapPort=slmTrapPort, slmAdminAccess=slmAdminAccess, slm40GConf=slm40GConf, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmAdmin=slmAdmin, slmLicenseIndex=slmLicenseIndex, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLocation=slmSysLocation, AdminAccess=AdminAccess, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmVcatDelay=slmVcatDelay, slmChPassEntry=slmChPassEntry, slmMuxNumber=slmMuxNumber, slmSysCalendarTime=slmSysCalendarTime, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmAdminPassword=slmAdminPassword, slmTrapUserAccess=slmTrapUserAccess, slmSysAdminStatus=slmSysAdminStatus, UserPassword=UserPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam4=slmTrapLogParam4, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, UserCommunity=UserCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseTable=slmLicenseTable, slmTrapUserLogin=slmTrapUserLogin, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmPortsNumber=slmPortsNumber, slmTrapLogParam5=slmTrapLogParam5, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmChPass=slmChPass, slmTrapDestEntry=slmTrapDestEntry, slmLicenseId=slmLicenseId, slmAuth=slmAuth, slmLogin=slmLogin, slmPmAvailable=slmPmAvailable, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmSwRevDate=slmSwRevDate, slmSysMode=slmSysMode, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
