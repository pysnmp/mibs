...
Opaque, MibIdentifier, ModuleIdentity, ObjectIdentity, Bits, Integer32, TimeTicks, iso, IpAddress, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Bits", "Integer32", "TimeTicks", "iso", "IpAddress", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam6=slmTrapLogParam6, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigFile=slmConfigFile, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuth=slmAuth, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseIndex=slmLicenseIndex, AdminAccess=AdminAccess, slmTrapDestTable=slmTrapDestTable, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmWriteCommunity=slmWriteCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slMain=slMain, slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmAct=slmSysAlmAct, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmTid=slmTid, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRebootDelay=slmRebootDelay, slmLicenseExpiration=slmLicenseExpiration, slmTrapEnable=slmTrapEnable, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmTrapUserLogin=slmTrapUserLogin, slmEdfaNumber=slmEdfaNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmReadCommunity=slmReadCommunity, slmSysIpAddr=slmSysIpAddr, SoftwareRevision=SoftwareRevision, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdmin=slmAdmin, slmChPass=slmChPass, slmSysChassisId=slmSysChassisId, slmSysUplinkRate=slmSysUplinkRate, slmChPassNewPass=slmChPassNewPass, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam3=slmTrapLogParam3, slmVcatDelay=slmVcatDelay, slmRstpEnabled=slmRstpEnabled, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmTrapLogName=slmTrapLogName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam5=slmTrapLogParam5, UserCommunity=UserCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLocation=slmSysLocation, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmTrapLogEntry=slmTrapLogEntry, slmAdminLogin=slmAdminLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmTrapLogTable=slmTrapLogTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmPortsNumber=slmPortsNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapCommunity=slmTrapCommunity, slmSwRevEntry=slmSwRevEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam4=slmTrapLogParam4, slmSysTrapFormat=slmSysTrapFormat, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassEntry=slmChPassEntry, slmSwRevDirectory=slmSwRevDirectory, slmAuthCommunity=slmAuthCommunity, slmSysResetPm=slmSysResetPm, PYSNMP_MODULE_ID=slMain, slmSys=slmSys, slmSnmpv3Password=slmSnmpv3Password, slmAdminEntry=slmAdminEntry, slmSysAlmDeact=slmSysAlmDeact, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slmLogFile=slmLogFile, slmAdminCommunity=slmAdminCommunity, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmTrap=slmTrap, slmConfigSysUptime=slmConfigSysUptime)
