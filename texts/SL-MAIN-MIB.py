...
ObjectIdentity, NotificationType, Gauge32, TimeTicks, ModuleIdentity, IpAddress, Unsigned32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter32, Bits, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Gauge32", "TimeTicks", "ModuleIdentity", "IpAddress", "Unsigned32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter32", "Bits", "MibIdentifier", "Counter64")
DisplayString, DateAndTime, TextualConvention, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserLogin=UserLogin, slmChPassEntry=slmChPassEntry, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestEntry=slmSyslogDestEntry, slmTid=slmTid, slmRebootDelay=slmRebootDelay, slMain=slMain, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, PYSNMP_MODULE_ID=slMain, slmSysName=slmSysName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmAuth=slmAuth, slmMuxNumber=slmMuxNumber, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTemperature=slmSysTemperature, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogTable=slmTrapLogTable, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmTrap=slmTrap, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, slmAdminCommunity=slmAdminCommunity, slmSwRevName=slmSwRevName, slmAdminAccess=slmAdminAccess, slmChPassTable=slmChPassTable, slmSysAdminStatus=slmSysAdminStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseId=slmLicenseId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPortsNumber=slmPortsNumber, slmTrapLogParam4=slmTrapLogParam4, slmSysPmStartOfDay=slmSysPmStartOfDay, slmWriteCommunity=slmWriteCommunity, slmAuthLogin=slmAuthLogin, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthEntry=slmAuthEntry, slmLicense=slmLicense, AdminAccess=AdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmAdminLogin=slmAdminLogin, slmVcatDelay=slmVcatDelay, slmPmAvailable=slmPmAvailable, slmSwRevEntry=slmSwRevEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmAuthPassword=slmAuthPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmSwRevStatus=slmSwRevStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmTrapUserLogin=slmTrapUserLogin, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slmChPassOldPass=slmChPassOldPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmSysMode=slmSysMode, slmSys=slmSys, slmNetworkMode=slmNetworkMode, slmBoxSize=slmBoxSize)
