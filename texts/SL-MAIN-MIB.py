...
Opaque, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, Counter64, TimeTicks, Gauge32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter64", "TimeTicks", "Gauge32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmEdfaNumber=slmEdfaNumber, slmLicenseEntry=slmLicenseEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTrapFormat=slmSysTrapFormat, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, AdminAccess=AdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthPassword=slmAuthPassword, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmChPass=slmChPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam3=slmTrapLogParam3, slmSysActiveSwVersion=slmSysActiveSwVersion, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmSwRevName=slmSwRevName, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmPsuNumber=slmPsuNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmSysOperStatus=slmSysOperStatus, slmSysChassisId=slmSysChassisId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Priv=slmSnmpv3Priv, slmAdmin=slmAdmin, slmTrapLogParam6=slmTrapLogParam6, slmChPassEntry=slmChPassEntry, slmTrapLogEntry=slmTrapLogEntry, slmLicenseId=slmLicenseId, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmTrap=slmTrap, slmAdminEntry=slmAdminEntry, slmLicenseExpiration=slmLicenseExpiration, slmAdminAccess=slmAdminAccess, slmChPassOldPass=slmChPassOldPass, slmReadCommunity=slmReadCommunity, slmConfigFile=slmConfigFile, slmSwRevEntry=slmSwRevEntry, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, SoftwareRevision=SoftwareRevision, slmPmAvailable=slmPmAvailable, slmAdminRowStatus=slmAdminRowStatus, slmSysTemperature=slmSysTemperature, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmSys=slmSys, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevStatus=slmSwRevStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmWriteCommunity=slmWriteCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmLicense=slmLicense, slmSysName=slmSysName, slmTrapDestAddress=slmTrapDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOemType=slmOemType, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate, slmSyslogPort=slmSyslogPort, slmSysLocation=slmSysLocation, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, slmAuthLogin=slmAuthLogin, UserPassword=UserPassword, slmTid=slmTid, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestIpAddress=slmTrapDestIpAddress)
