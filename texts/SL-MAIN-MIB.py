...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, iso, Integer32, Counter32, ModuleIdentity, Bits, Counter64, Opaque, ObjectIdentity, Gauge32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "iso", "Integer32", "Counter32", "ModuleIdentity", "Bits", "Counter64", "Opaque", "ObjectIdentity", "Gauge32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassNewPass=slmChPassNewPass, slMain=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmTrapDestEntry=slmTrapDestEntry, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam2=slmTrapLogParam2, slmLicenseTable=slmLicenseTable, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmVcatDelay=slmVcatDelay, slmAdminTable=slmAdminTable, slmSwRevName=slmSwRevName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmAuthTable=slmAuthTable, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmSysLocation=slmSysLocation, slmTid=slmTid, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestTable=slmTrapDestTable, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmSwRevTable=slmSwRevTable, slmTrapUserAccess=slmTrapUserAccess, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmSysName=slmSysName, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTable=slmTrapLogTable, slmNetworkMode=slmNetworkMode, slmAdminLogin=slmAdminLogin, slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmMuxNumber=slmMuxNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmLicenseEntry=slmLicenseEntry, slmConfigFile=slmConfigFile, slmAdminRowStatus=slmAdminRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmEdfaNumber=slmEdfaNumber, slmTopologyEnabled=slmTopologyEnabled, slmAdmin=slmAdmin, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogEntry=slmTrapLogEntry, slmBoxSize=slmBoxSize, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmSwRevStatus=slmSwRevStatus, slmChPassTable=slmChPassTable, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmAdminCommunity=slmAdminCommunity, slmSysMode=slmSysMode, slmLicense=slmLicense, UserPassword=UserPassword, UserLogin=UserLogin, slmLicenseIndex=slmLicenseIndex, slmTrapLogName=slmTrapLogName, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion)
