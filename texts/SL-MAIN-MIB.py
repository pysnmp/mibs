...
Gauge32, Counter32, NotificationType, Integer32, iso, Opaque, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, TimeTicks, MibIdentifier, Bits, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "NotificationType", "Integer32", "iso", "Opaque", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "TimeTicks", "MibIdentifier", "Bits", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmSyslogDestAddress=slmSyslogDestAddress, slmVcatDelay=slmVcatDelay, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmSysCalendarTime=slmSysCalendarTime, slmSysSubnetMask=slmSysSubnetMask, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserPassword=UserPassword, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slMain=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmSwRevEntry=slmSwRevEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserCommunity=UserCommunity, slmTrapPort=slmTrapPort, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmSysLocation=slmSysLocation, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmSwRevTable=slmSwRevTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmChPassLogin=slmChPassLogin, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSwRevName=slmSwRevName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmPsuNumber=slmPsuNumber, slmChPassEntry=slmChPassEntry, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmAdminTable=slmAdminTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigFile=slmConfigFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmChPassTable=slmChPassTable, AdminAccess=AdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseIndex=slmLicenseIndex, slmSysIpAddr=slmSysIpAddr, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slm40GConf=slm40GConf, slmSysResetPm=slmSysResetPm, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, PYSNMP_MODULE_ID=slMain, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmAuthPassword=slmAuthPassword, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmRstpEnabled=slmRstpEnabled, slmSyslogLevel=slmSyslogLevel, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestEntry=slmTrapDestEntry, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmAdminLogin=slmAdminLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmLogFile=slmLogFile, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmTrapLogId=slmTrapLogId, slmSyslogPort=slmSyslogPort, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, slmTrapCommunity=slmTrapCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmSnmpv3Auth=slmSnmpv3Auth, slmWriteCommunity=slmWriteCommunity)
