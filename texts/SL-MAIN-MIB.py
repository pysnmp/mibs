...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, AdminAccess=AdminAccess, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam2=slmTrapLogParam2, UserPassword=UserPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDate=slmSwRevDate, slmSwRevEntry=slmSwRevEntry, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogName=slmTrapLogName, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam1=slmTrapLogParam1, slmBoxSize=slmBoxSize, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmAdminRowStatus=slmAdminRowStatus, slmTrapPort=slmTrapPort, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogPort=slmSyslogPort, slMain=slMain, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminCommunity=slmAdminCommunity, slmChPassLogin=slmChPassLogin, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slmPortsNumber=slmPortsNumber, slmSysMode=slmSysMode, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestEntry=slmTrapDestEntry, slmVcatDelay=slmVcatDelay, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmReadCommunity=slmReadCommunity, SoftwareRevision=SoftwareRevision, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmAdminAccess=slmAdminAccess, slmLicenseTable=slmLicenseTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSys=slmSys, slmAuthTable=slmAuthTable, slmRebootDelay=slmRebootDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminTable=slmAdminTable, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, PYSNMP_MODULE_ID=slMain, slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserLogin=slmTrapUserLogin, slmSysTemperature=slmSysTemperature, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthLogin=slmAuthLogin, slmConfigFile=slmConfigFile, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmChPass=slmChPass, slmLicenseExpiration=slmLicenseExpiration, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysResetPm=slmSysResetPm, UserLogin=UserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSysSubnetMask=slmSysSubnetMask, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmSwRevTable=slmSwRevTable, slmRstpEnabled=slmRstpEnabled, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmTrap=slmTrap, slmAuth=slmAuth)
