...
IpAddress, ObjectIdentity, ModuleIdentity, TimeTicks, Unsigned32, Gauge32, Opaque, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Unsigned32", "Gauge32", "Opaque", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestTable=slmTrapDestTable, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmSysLocation=slmSysLocation, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmLogFile=slmLogFile, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdmin=slmAdmin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassTable=slmChPassTable, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmAuthLogin=slmAuthLogin, slmTrapLogName=slmTrapLogName, slmAdminTable=slmAdminTable, slmSysTemperature=slmSysTemperature, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmSwRevName=slmSwRevName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuth=slmAuth, slmSysName=slmSysName, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmSysUplinkRate=slmSysUplinkRate, slm40GConf=slm40GConf, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSyslogPort=slmSyslogPort, PYSNMP_MODULE_ID=slMain, slmSwRevEntry=slmSwRevEntry, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmVcatDelay=slmVcatDelay, slmSwRevStatus=slmSwRevStatus, slmMuxNumber=slmMuxNumber, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slMain=slMain, slmReadCommunity=slmReadCommunity, slmTopologyEnabled=slmTopologyEnabled, slmAuthPassword=slmAuthPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam5=slmTrapLogParam5, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmChPassLogin=slmChPassLogin, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevTable=slmSwRevTable, slmSysLanIpAddr=slmSysLanIpAddr, slmNetworkMode=slmNetworkMode, UserCommunity=UserCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, slmTrapEnable=slmTrapEnable, slmLicense=slmLicense, slmOemType=slmOemType, UserPassword=UserPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmPmAvailable=slmPmAvailable, slmAdminCommunity=slmAdminCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmWriteCommunity=slmWriteCommunity, slmLicenseTable=slmLicenseTable, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Priv=slmSnmpv3Priv, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmPortsNumber=slmPortsNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, slmSys=slmSys, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmAdminPassword=slmAdminPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPsuNumber=slmPsuNumber, slmAdminEntry=slmAdminEntry, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmAdminAccess=slmAdminAccess, slmSysIpAddr=slmSysIpAddr, slmRebootDelay=slmRebootDelay, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapCommunity=slmTrapCommunity, slmSysMode=slmSysMode, slmTid=slmTid, slmSwRevDirectory=slmSwRevDirectory, slmAuthTable=slmAuthTable)
