...
Opaque, ObjectIdentity, Integer32, Gauge32, ModuleIdentity, Bits, Counter32, Counter64, IpAddress, iso, MibIdentifier, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ObjectIdentity", "Integer32", "Gauge32", "ModuleIdentity", "Bits", "Counter32", "Counter64", "IpAddress", "iso", "MibIdentifier", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmNetworkMode=slmNetworkMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, UserCommunity=UserCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPsuNumber=slmPsuNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmAuth=slmAuth, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassOldPass=slmChPassOldPass, slmSwRevName=slmSwRevName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmRebootDelay=slmRebootDelay, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestAddress=slmSyslogDestAddress, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, slmSysName=slmSysName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmAdminPassword=slmAdminPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, AdminAccess=AdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slm40GConf=slm40GConf, slmAuthTable=slmAuthTable, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmAct=slmSysAlmAct, slmPortsNumber=slmPortsNumber, slmSwRevDirectory=slmSwRevDirectory, slmSysLocation=slmSysLocation, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam5=slmTrapLogParam5, slmConfigFile=slmConfigFile, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmSyslogLevel=slmSyslogLevel, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestEntry=slmTrapDestEntry, slMain=slMain, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmTrapLogTable=slmTrapLogTable, slmVcatDelay=slmVcatDelay, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, UserLogin=UserLogin, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmAdmin=slmAdmin, slmSysTrapFormat=slmSysTrapFormat, slmSysIpAddr=slmSysIpAddr, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slmTrapUserLogin=slmTrapUserLogin, slmSysTemperature=slmSysTemperature, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanIpAddr=slmSysLanIpAddr, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam4=slmTrapLogParam4, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapPort=slmTrapPort, slmTrapEnable=slmTrapEnable, slmLicenseTable=slmLicenseTable, slmTrapLogId=slmTrapLogId, slmSwRevDate=slmSwRevDate, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmOemType=slmOemType, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmReadCommunity=slmReadCommunity, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmLogFile=slmLogFile, slmLogin=slmLogin, slmChPass=slmChPass, slmSwRevTable=slmSwRevTable)
