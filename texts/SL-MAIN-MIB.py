...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, MibIdentifier, Gauge32, ModuleIdentity, NotificationType, Opaque, ObjectIdentity, Bits, Counter32, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "MibIdentifier", "Gauge32", "ModuleIdentity", "NotificationType", "Opaque", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slm40GConf=slm40GConf, UserLogin=UserLogin, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmVcatDelay=slmVcatDelay, slmAdminEntry=slmAdminEntry, UserCommunity=UserCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmTrapCommunity=slmTrapCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdmin=slmAdmin, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, AdminAccess=AdminAccess, slmSysResetPm=slmSysResetPm, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, slmSyslogDestTable=slmSyslogDestTable, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmSysAlmAct=slmSysAlmAct, slmAdminPassword=slmAdminPassword, slmChPassNewPass=slmChPassNewPass, slmMuxNumber=slmMuxNumber, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseTable=slmLicenseTable, slmAdminLogin=slmAdminLogin, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestProtVersion=slmTrapDestProtVersion, SoftwareRevision=SoftwareRevision, slmSysSnmpVersion=slmSysSnmpVersion, slmSysMode=slmSysMode, slmTrapLogParam6=slmTrapLogParam6, slmLogin=slmLogin, slmTid=slmTid, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, slmAuthPassword=slmAuthPassword, slmTrapDestAddress=slmTrapDestAddress, slmLicenseEntry=slmLicenseEntry, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmEdfaNumber=slmEdfaNumber, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmReadCommunity=slmReadCommunity, slmChPassEntry=slmChPassEntry, slmSysChassisId=slmSysChassisId, slmSysIpAddr=slmSysIpAddr, slmAuthLogin=slmAuthLogin, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmAuth=slmAuth, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, slmPortsNumber=slmPortsNumber, slmConfigFile=slmConfigFile, UserPassword=UserPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmSyslogPort=slmSyslogPort, slmSwRevName=slmSwRevName, slmTrapEnable=slmTrapEnable, slmPsuNumber=slmPsuNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTable=slmTrapLogTable, slmSysTemperature=slmSysTemperature, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmLicenseId=slmLicenseId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmOemType=slmOemType, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmLicense=slmLicense, slmSnmpv3Priv=slmSnmpv3Priv, slmSysOperStatus=slmSysOperStatus, slmLogFile=slmLogFile, slmAuthCommunity=slmAuthCommunity)
