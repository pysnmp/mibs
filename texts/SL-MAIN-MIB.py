...
iso, IpAddress, Counter64, Bits, NotificationType, Gauge32, Integer32, TimeTicks, Unsigned32, Opaque, ObjectIdentity, Counter32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter64", "Bits", "NotificationType", "Gauge32", "Integer32", "TimeTicks", "Unsigned32", "Opaque", "ObjectIdentity", "Counter32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapCommunity=slmTrapCommunity, slmAdminPassword=slmAdminPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, PYSNMP_MODULE_ID=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassTable=slmChPassTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTemperature=slmSysTemperature, slmSwRevDate=slmSwRevDate, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevEntry=slmSwRevEntry, SoftwareRevision=SoftwareRevision, slmLicense=slmLicense, slmSys=slmSys, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmTrapPort=slmTrapPort, slmSysCalendarTime=slmSysCalendarTime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmLicenseIndex=slmLicenseIndex, slmAuthEntry=slmAuthEntry, slmTrapLogParam6=slmTrapLogParam6, slmLogin=slmLogin, slmSyslogPort=slmSyslogPort, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, slmTrapLogParam4=slmTrapLogParam4, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRstpEnabled=slmRstpEnabled, slmSysTrapFormat=slmSysTrapFormat, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogFile=slmLogFile, slmSyslogLevel=slmSyslogLevel, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, AdminAccess=AdminAccess, slmNetworkMode=slmNetworkMode, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmTrap=slmTrap, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminEntry=slmAdminEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevStatus=slmSwRevStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmRebootDelay=slmRebootDelay, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, slmAuthCommunity=slmAuthCommunity, slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmChPassEntry=slmChPassEntry, slmTid=slmTid, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserAccess=slmTrapUserAccess, slmAuthLogin=slmAuthLogin, slmTrapLogTable=slmTrapLogTable, slmChPassOldPass=slmChPassOldPass, slmSysAlmAct=slmSysAlmAct, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmPmAvailable=slmPmAvailable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmSysLocation=slmSysLocation, slMain=slMain, slmWriteCommunity=slmWriteCommunity)
