...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, ObjectIdentity, Unsigned32, Opaque, Counter64, Counter32, TimeTicks, MibIdentifier, IpAddress, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Opaque", "Counter64", "Counter32", "TimeTicks", "MibIdentifier", "IpAddress", "Bits", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, SoftwareRevision=SoftwareRevision, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestCommunity=slmTrapDestCommunity, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmTrapCommunity=slmTrapCommunity, slmLicense=slmLicense, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, UserPassword=UserPassword, slmTrapLogTable=slmTrapLogTable, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmNetworkMode=slmNetworkMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmTopologyEnabled=slmTopologyEnabled, slmAuthPassword=slmAuthPassword, slmSwRevDate=slmSwRevDate, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmSwRevName=slmSwRevName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Password=slmSnmpv3Password, slmSysSnmpVersion=slmSysSnmpVersion, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigFile=slmConfigFile, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevTable=slmSwRevTable, slmTrap=slmTrap, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmChPassTable=slmChPassTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTid=slmTid, slmWriteCommunity=slmWriteCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysIpAddr=slmSysIpAddr, slmAuthTable=slmAuthTable, slmSysAlmAct=slmSysAlmAct, slmSysSubnetMask=slmSysSubnetMask, slmChPassLogin=slmChPassLogin, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysResetPm=slmSysResetPm, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminTable=slmAdminTable, UserCommunity=UserCommunity, slmLicenseIndex=slmLicenseIndex, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slmAdminEntry=slmAdminEntry, slmLicenseTable=slmLicenseTable, slmAuth=slmAuth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay)
