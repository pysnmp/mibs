...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, IpAddress, Counter64, Bits, iso, Counter32, ModuleIdentity, Gauge32, Unsigned32, ObjectIdentity, Opaque, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "IpAddress", "Counter64", "Bits", "iso", "Counter32", "ModuleIdentity", "Gauge32", "Unsigned32", "ObjectIdentity", "Opaque", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevStatus=slmSwRevStatus, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmTrapSysNameChange=slmTrapSysNameChange, slmMuxNumber=slmMuxNumber, slmLicenseId=slmLicenseId, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmSyslogLevel=slmSyslogLevel, slmSysIpAddr=slmSysIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmSwRevTable=slmSwRevTable, slmTid=slmTid, slmAuthTable=slmAuthTable, slmTrapCommunity=slmTrapCommunity, slmTrapLogId=slmTrapLogId, UserCommunity=UserCommunity, UserPassword=UserPassword, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSys=slmSys, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrap=slmTrap, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmTrapLogParam6=slmTrapLogParam6, slmConfigFile=slmConfigFile, slmSysName=slmSysName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slm40GConf=slm40GConf, slmRstpEnabled=slmRstpEnabled, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmSwRevDate=slmSwRevDate, slmSwRevEntry=slmSwRevEntry, slmPsuNumber=slmPsuNumber, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminLogin=slmAdminLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOemType=slmOemType, slmRebootDelay=slmRebootDelay, slmSysAdminStatus=slmSysAdminStatus, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmAdminEntry=slmAdminEntry, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slMain=slMain, slmTrapEnable=slmTrapEnable, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseTable=slmLicenseTable, slmEdfaNumber=slmEdfaNumber, slmSysChassisId=slmSysChassisId, slmLogFile=slmLogFile, slmSysAlmAct=slmSysAlmAct, slmLogin=slmLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmAuthPassword=slmAuthPassword, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthCommunity=slmAuthCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLocation=slmSysLocation, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmTrapUserAccess=slmTrapUserAccess, PYSNMP_MODULE_ID=slMain, slmLicenseIndex=slmLicenseIndex, slmTrapLogName=slmTrapLogName, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmLicense=slmLicense, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTable=slmTrapLogTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
