...
Integer32, MibIdentifier, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Opaque, Bits, Counter32, NotificationType, ObjectIdentity, TimeTicks, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Opaque", "Bits", "Counter32", "NotificationType", "ObjectIdentity", "TimeTicks", "iso", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmTrapLogName=slmTrapLogName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, slmAuthPassword=slmAuthPassword, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Password=slmSnmpv3Password, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSwRevStatus=slmSwRevStatus, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, slmChPassEntry=slmChPassEntry, slmTrapLogParam3=slmTrapLogParam3, slmLicense=slmLicense, PYSNMP_MODULE_ID=slMain, slmConfigFile=slmConfigFile, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmChPass=slmChPass, slmAuth=slmAuth, slmSwRevDate=slmSwRevDate, slmSysChassisId=slmSysChassisId, slmTrapLogParam4=slmTrapLogParam4, slmOpticalSwitchExist=slmOpticalSwitchExist, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseIndex=slmLicenseIndex, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminLogin=slmAdminLogin, UserLogin=UserLogin, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmBoxSize=slmBoxSize, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapEnable=slmTrapEnable, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmTopologyEnabled=slmTopologyEnabled, slmChPassLogin=slmChPassLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmSysIpAddr=slmSysIpAddr, slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdmin=slmAdmin, slmVcatDelay=slmVcatDelay, slmAuthTable=slmAuthTable, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassTable=slmChPassTable, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slm40GConf=slm40GConf, slmTrapUserAccess=slmTrapUserAccess, slmLicenseTable=slmLicenseTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassOldPass=slmChPassOldPass, slmLicenseExpiration=slmLicenseExpiration, slmAuthLogin=slmAuthLogin, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slmTrapDestTable=slmTrapDestTable, slmAdminTable=slmAdminTable, slmLicenseEntry=slmLicenseEntry, slmSwRevEntry=slmSwRevEntry, SoftwareRevision=SoftwareRevision, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmAdminPassword=slmAdminPassword, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmPsuNumber=slmPsuNumber, slMain=slMain, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevTable=slmSwRevTable)
