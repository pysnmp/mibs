...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, MibIdentifier, Opaque, Gauge32, IpAddress, TimeTicks, Counter32, ObjectIdentity, ModuleIdentity, iso, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "MibIdentifier", "Opaque", "Gauge32", "IpAddress", "TimeTicks", "Counter32", "ObjectIdentity", "ModuleIdentity", "iso", "Integer32", "Unsigned32")
DateAndTime, DisplayString, TimeStamp, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmWriteCommunity=slmWriteCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSwRevStatus=slmSwRevStatus, UserCommunity=UserCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmSysResetPm=slmSysResetPm, slmSysOperStatus=slmSysOperStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmChPassLogin=slmChPassLogin, slmLicenseId=slmLicenseId, slmAdmin=slmAdmin, slmAdminPassword=slmAdminPassword, slmTrapDestEntry=slmTrapDestEntry, UserPassword=UserPassword, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthCommunity=slmAuthCommunity, slmSysLocation=slmSysLocation, slmTid=slmTid, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slMain=slMain, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigFile=slmConfigFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmNetworkMode=slmNetworkMode, slmSysAlmDeact=slmSysAlmDeact, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slmSysTemperature=slmSysTemperature, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthTable=slmAuthTable, slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthLogin=slmAuthLogin, slmBoxSize=slmBoxSize, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapCommunity=slmTrapCommunity, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmTrapEnable=slmTrapEnable, slmSysEncryptionCapability=slmSysEncryptionCapability, AdminAccess=AdminAccess, slmAdminLogin=slmAdminLogin, slmSysMode=slmSysMode, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmAdminAccess=slmAdminAccess, slmPsuNumber=slmPsuNumber, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, UserLogin=UserLogin, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmChPassTable=slmChPassTable, slmAuth=slmAuth, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmLogFile=slmLogFile, slmChPassNewPass=slmChPassNewPass, slmRebootDelay=slmRebootDelay, slmTrapPort=slmTrapPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogName=slmTrapLogName, slmSysUplinkRate=slmSysUplinkRate, slmLicense=slmLicense, slmTrapUserLogin=slmTrapUserLogin, slmPmAvailable=slmPmAvailable, slmTrapLogId=slmTrapLogId, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmConfigSysUptime=slmConfigSysUptime, slmOemType=slmOemType, slmAuthPassword=slmAuthPassword, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmSys=slmSys, slm40GConf=slm40GConf, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry)
