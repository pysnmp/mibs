...
DisplayString, TimeStamp, TextualConvention, TruthValue, DateAndTime, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue", "DateAndTime", "RowStatus")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmAct=slmSysAlmAct, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmSys=slmSys, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slm40GConf=slm40GConf, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmSysUplinkRate=slmSysUplinkRate, slmLicenseEntry=slmLicenseEntry, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword, slmLicenseIndex=slmLicenseIndex, slmAuthTable=slmAuthTable, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmSysTemperature=slmSysTemperature, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmLogin=slmLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrap=slmTrap, slmAuth=slmAuth, slmTid=slmTid, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanIpAddr=slmSysLanIpAddr, slmRstpEnabled=slmRstpEnabled, slmConfigFile=slmConfigFile, UserLogin=UserLogin, slmTrapDestAddress=slmTrapDestAddress, slmLogFile=slmLogFile, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmSysMode=slmSysMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysSnmpVersion=slmSysSnmpVersion, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogEntry=slmTrapLogEntry, slmChPassLogin=slmChPassLogin, slmSysAdminStatus=slmSysAdminStatus, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmSyslogLevel=slmSyslogLevel, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmNetworkMode=slmNetworkMode, slmSnmpv3Priv=slmSnmpv3Priv, slmSysResetPm=slmSysResetPm, slmMuxNumber=slmMuxNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogName=slmTrapLogName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanSubnetAddr=slmSysLanSubnetAddr, SoftwareRevision=SoftwareRevision, slmSysName=slmSysName, slmAuthPassword=slmAuthPassword, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmAdminLogin=slmAdminLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmTrapLogId=slmTrapLogId, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmRebootDelay=slmRebootDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicense=slmLicense, slmChPass=slmChPass, slmChPassTable=slmChPassTable, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapPort=slmTrapPort, AdminAccess=AdminAccess, slmOemType=slmOemType, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmSysChassisId=slmSysChassisId, slmVcatDelay=slmVcatDelay, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysLocation=slmSysLocation, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseId=slmLicenseId)
