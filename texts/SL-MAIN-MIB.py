...
MibIdentifier, Opaque, TimeTicks, ModuleIdentity, Counter32, ObjectIdentity, Unsigned32, iso, Bits, Counter64, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Opaque", "TimeTicks", "ModuleIdentity", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "Bits", "Counter64", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
RowStatus, TextualConvention, TimeStamp, DisplayString, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", SoftwareRevision=SoftwareRevision, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestTable=slmSyslogDestTable, slmSwRevDirectory=slmSwRevDirectory, slmLicenseIndex=slmLicenseIndex, slmLicenseExpiration=slmLicenseExpiration, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserCommunity=UserCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysName=slmSysName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevName=slmSwRevName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmSysAlmDeact=slmSysAlmDeact, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, AdminAccess=AdminAccess, slmRebootDelay=slmRebootDelay, slmOemType=slmOemType, slmPortsNumber=slmPortsNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmChPass=slmChPass, slmLogin=slmLogin, slmSysAlmAct=slmSysAlmAct, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmTrapPort=slmTrapPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminEntry=slmAdminEntry, slmConfigFile=slmConfigFile, slmSysChassisId=slmSysChassisId, slmSysCalendarTime=slmSysCalendarTime, PYSNMP_MODULE_ID=slMain, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmAuthPassword=slmAuthPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTopologyEnabled=slmTopologyEnabled, slmEdfaNumber=slmEdfaNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam2=slmTrapLogParam2, slmSwRevEntry=slmSwRevEntry, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmTrapLogName=slmTrapLogName, slmSysLanIpAddr=slmSysLanIpAddr, slmAdmin=slmAdmin, slmSysLocation=slmSysLocation, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysMode=slmSysMode, slmSysResetPm=slmSysResetPm, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slMain=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmTrapEnable=slmTrapEnable, slmAdminAccess=slmAdminAccess, slmLicense=slmLicense, slmSysPmStartOfDay=slmSysPmStartOfDay, UserPassword=UserPassword, slmRstpEnabled=slmRstpEnabled, slmAdminRowStatus=slmAdminRowStatus, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysIpAddr=slmSysIpAddr, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmNetworkMode=slmNetworkMode, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSys=slmSys)
