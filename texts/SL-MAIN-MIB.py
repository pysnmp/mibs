...
NotificationType, Opaque, Bits, Unsigned32, Gauge32, Integer32, Counter64, IpAddress, TimeTicks, ModuleIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Opaque", "Bits", "Unsigned32", "Gauge32", "Integer32", "Counter64", "IpAddress", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmPmAvailable=slmPmAvailable, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmTid=slmTid, slmSysResetPm=slmSysResetPm, slmSysTemperature=slmSysTemperature, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, UserCommunity=UserCommunity, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminEntry=slmAdminEntry, slmTrapDestTable=slmTrapDestTable, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmChPassLogin=slmChPassLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigSysUptime=slmConfigSysUptime, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, slmLicenseId=slmLicenseId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSysMode=slmSysMode, slmSysLocation=slmSysLocation, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassEntry=slmChPassEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmPsuNumber=slmPsuNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmSysSubnetMask=slmSysSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, PYSNMP_MODULE_ID=slMain, slmLogin=slmLogin, AdminAccess=AdminAccess, slmBoxSize=slmBoxSize, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slMain=slMain, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogLevel=slmSyslogLevel, slmSys=slmSys, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmLogFile=slmLogFile, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmDeact=slmSysAlmDeact, SoftwareRevision=SoftwareRevision, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Priv=slmSnmpv3Priv, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminCommunity=slmAdminCommunity, slmAdminTable=slmAdminTable, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slm40GConf=slm40GConf, slmPortsNumber=slmPortsNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevDate=slmSwRevDate, slmAuth=slmAuth, slmAdminAccess=slmAdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, slmChPassTable=slmChPassTable)
