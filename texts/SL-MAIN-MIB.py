...
ModuleIdentity, TimeTicks, Gauge32, NotificationType, iso, Bits, ObjectIdentity, Counter64, Unsigned32, Opaque, MibIdentifier, Counter32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Gauge32", "NotificationType", "iso", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "Opaque", "MibIdentifier", "Counter32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, slMain=slMain, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmRebootDelay=slmRebootDelay, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmSysTrapFormat=slmSysTrapFormat, slmSysSubnetMask=slmSysSubnetMask, UserCommunity=UserCommunity, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminTable=slmAdminTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmChPass=slmChPass, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminEntry=slmAdminEntry, slm40GConf=slm40GConf, slmSysAlmDeact=slmSysAlmDeact, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmTrapDestTable=slmTrapDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmLogin=slmLogin, slmAuthEntry=slmAuthEntry, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseEntry=slmLicenseEntry, slmSwRevDirectory=slmSwRevDirectory, slmSysLocation=slmSysLocation, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseId=slmLicenseId, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysMode=slmSysMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmLicense=slmLicense, slmVcatDelay=slmVcatDelay, slmAuthPassword=slmAuthPassword, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPsuNumber=slmPsuNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthTable=slmAuthTable, slmSwRevStatus=slmSwRevStatus, UserPassword=UserPassword, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminCommunity=slmAdminCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSyslogLevel=slmSyslogLevel, slmChPassEntry=slmChPassEntry, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmOemType=slmOemType, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmTrapLogParam3=slmTrapLogParam3, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmSyslogPort=slmSyslogPort, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable)
