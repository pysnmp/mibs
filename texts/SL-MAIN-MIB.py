...
Counter32, IpAddress, Counter64, Opaque, NotificationType, Bits, ModuleIdentity, Unsigned32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Counter64", "Opaque", "NotificationType", "Bits", "ModuleIdentity", "Unsigned32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "MibIdentifier", "iso")
DateAndTime, TruthValue, RowStatus, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TruthValue", "RowStatus", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmBoxSize=slmBoxSize, slmChPassEntry=slmChPassEntry, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthLogin=slmAuthLogin, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmLicenseId=slmLicenseId, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmChPassOldPass=slmChPassOldPass, slmTrapCommunity=slmTrapCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogTable=slmTrapLogTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmMuxNumber=slmMuxNumber, slm40GConf=slm40GConf, slmSysSnmpVersion=slmSysSnmpVersion, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigFile=slmConfigFile, slmChPassTable=slmChPassTable, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, PYSNMP_MODULE_ID=slMain, slmSwRevName=slmSwRevName, slmLogFile=slmLogFile, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmSysAdminStatus=slmSysAdminStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPsuNumber=slmPsuNumber, slmAuth=slmAuth, slmSysAlmAct=slmSysAlmAct, slmLicenseExpiration=slmLicenseExpiration, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmSys=slmSys, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmSwRevDate=slmSwRevDate, slmAdminAccess=slmAdminAccess, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmSysCalendarTime=slmSysCalendarTime, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRstpEnabled=slmRstpEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam2=slmTrapLogParam2, slmSwRevTable=slmSwRevTable, slmLogin=slmLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTid=slmTid, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmChPassNewPass=slmChPassNewPass, slmPortsNumber=slmPortsNumber, slmTrapLogParam3=slmTrapLogParam3, slmVcatDelay=slmVcatDelay, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminCommunity=slmAdminCommunity, slmTopologyEnabled=slmTopologyEnabled, slmOemType=slmOemType, slmPmAvailable=slmPmAvailable, slmSyslogLevel=slmSyslogLevel, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, UserCommunity=UserCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmChPassLogin=slmChPassLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry)
