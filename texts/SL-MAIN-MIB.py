...
Bits, Integer32, TimeTicks, Counter32, MibIdentifier, ObjectIdentity, Unsigned32, iso, NotificationType, ModuleIdentity, Gauge32, Counter64, Opaque, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "TimeTicks", "Counter32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "NotificationType", "ModuleIdentity", "Gauge32", "Counter64", "Opaque", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseIndex=slmLicenseIndex, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmChPassLogin=slmChPassLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapEnable=slmTrapEnable, UserCommunity=UserCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword, slmSysLocation=slmSysLocation, slmChPassEntry=slmChPassEntry, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmLicense=slmLicense, slmPmAvailable=slmPmAvailable, slmTrapDestTable=slmTrapDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPsuNumber=slmPsuNumber, slmRebootDelay=slmRebootDelay, slmRstpEnabled=slmRstpEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminPassword=slmAdminPassword, UserPassword=UserPassword, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseTable=slmLicenseTable, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseId=slmLicenseId, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSubnetMask=slmSysSubnetMask, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, slmTopologyEnabled=slmTopologyEnabled, slmChPass=slmChPass, slmSysResetPm=slmSysResetPm, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slMain=slMain, slmAuthCommunity=slmAuthCommunity, slmAuthTable=slmAuthTable, slmAuthEntry=slmAuthEntry, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOemType=slmOemType, slmAdminTable=slmAdminTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmSysChassisId=slmSysChassisId, slmTrapDestAddress=slmTrapDestAddress, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmSysSnmpVersion=slmSysSnmpVersion, slmSysOperStatus=slmSysOperStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminLogin=slmAdminLogin, slmSwRevTable=slmSwRevTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogId=slmTrapLogId, SoftwareRevision=SoftwareRevision, slmSysAlmAct=slmSysAlmAct, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, slmTrapUserLogin=slmTrapUserLogin, slmWriteCommunity=slmWriteCommunity, slmTrapPort=slmTrapPort, slmSysMode=slmSysMode, slmEdfaNumber=slmEdfaNumber, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminAccess=slmAdminAccess, slmSwRevName=slmSwRevName, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseEntry=slmLicenseEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmVcatDelay=slmVcatDelay, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain)
