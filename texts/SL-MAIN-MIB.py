...
Gauge32, Counter32, Opaque, ModuleIdentity, Unsigned32, iso, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Opaque", "ModuleIdentity", "Unsigned32", "iso", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam1=slmTrapLogParam1, PYSNMP_MODULE_ID=slMain, slmTrapPort=slmTrapPort, slmTrapDestAddress=slmTrapDestAddress, slm40GConf=slm40GConf, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmAct=slmSysAlmAct, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTable=slmTrapLogTable, slmPortsNumber=slmPortsNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmTid=slmTid, slmRstpEnabled=slmRstpEnabled, slmConfigFile=slmConfigFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysUplinkRate=slmSysUplinkRate, slmSysLocation=slmSysLocation, slmEdfaNumber=slmEdfaNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapEnable=slmTrapEnable, slmLicense=slmLicense, slmChPassLogin=slmChPassLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmBoxSize=slmBoxSize, slmAuthEntry=slmAuthEntry, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserAccess=slmTrapUserAccess, slmSysMode=slmSysMode, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogPort=slmSyslogPort, slmTopologyEnabled=slmTopologyEnabled, slmNetworkMode=slmNetworkMode, slmSyslogDestAddress=slmSyslogDestAddress, AdminAccess=AdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserPassword=UserPassword, slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmSysName=slmSysName, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, slMain=slMain, slmSysCalendarTime=slmSysCalendarTime, slmPsuNumber=slmPsuNumber, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysUptime=slmConfigSysUptime, slmLicenseId=slmLicenseId, slmAdminTable=slmAdminTable, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmSysGatewayAddr=slmSysGatewayAddr, UserLogin=UserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSys=slmSys, slmAdmin=slmAdmin, slmLicenseEntry=slmLicenseEntry, slmAdminCommunity=slmAdminCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmLogin=slmLogin, slmSyslogDestTable=slmSyslogDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Password=slmSnmpv3Password, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmLicenseTable=slmLicenseTable, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapLogName=slmTrapLogName, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, SoftwareRevision=SoftwareRevision, slmTrapDestEntry=slmTrapDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthPassword=slmAuthPassword, slmOpticalSwitchExist=slmOpticalSwitchExist)
