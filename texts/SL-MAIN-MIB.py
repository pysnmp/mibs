...
ObjectIdentity, Integer32, NotificationType, iso, Gauge32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter64, MibIdentifier, TimeTicks, ModuleIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "iso", "Gauge32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter64", "MibIdentifier", "TimeTicks", "ModuleIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestTable=slmSyslogDestTable, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam5=slmTrapLogParam5, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmTrapPort=slmTrapPort, slmLogFile=slmLogFile, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam2=slmTrapLogParam2, slmAdmin=slmAdmin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthCommunity=slmAuthCommunity, slmTrapUserAccess=slmTrapUserAccess, slmChPassOldPass=slmChPassOldPass, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmSysIpAddr=slmSysIpAddr, slmSysTemperature=slmSysTemperature, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevName=slmSwRevName, slmRstpEnabled=slmRstpEnabled, slmReadCommunity=slmReadCommunity, slMain=slMain, slmSysMode=slmSysMode, slmAdminAccess=slmAdminAccess, slmWriteCommunity=slmWriteCommunity, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmOpticalSwitchExist=slmOpticalSwitchExist, slmOemType=slmOemType, slmLogin=slmLogin, slmTid=slmTid, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, UserPassword=UserPassword, slmConfigSysUptime=slmConfigSysUptime, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLocation=slmSysLocation, slmTrapLogParam6=slmTrapLogParam6, slmLicense=slmLicense, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPass=slmChPass, slmAuthTable=slmAuthTable, slmChPassLogin=slmChPassLogin, slmTrapLogParam4=slmTrapLogParam4, slmLicenseEntry=slmLicenseEntry, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmNetworkMode=slmNetworkMode, slmEdfaNumber=slmEdfaNumber, slm40GConf=slm40GConf, slmSwRevTable=slmSwRevTable, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysName=slmSysName, slmLicenseId=slmLicenseId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminCommunity=slmAdminCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSys=slmSys, slmSnmpv3Auth=slmSnmpv3Auth, slmAuth=slmAuth, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmConfigFile=slmConfigFile, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDirectory=slmSwRevDirectory, SoftwareRevision=SoftwareRevision, slmTrapSysNameChange=slmTrapSysNameChange, slmMuxNumber=slmMuxNumber, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slmBoxSize=slmBoxSize, slmAuthPassword=slmAuthPassword, slmSysAdminStatus=slmSysAdminStatus, slmSysChassisId=slmSysChassisId, slmSysSubnetMask=slmSysSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
