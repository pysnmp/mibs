...
IpAddress, ModuleIdentity, NotificationType, iso, Counter64, Integer32, MibIdentifier, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Unsigned32, Opaque, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "NotificationType", "iso", "Counter64", "Integer32", "MibIdentifier", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Unsigned32", "Opaque", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevName=slmSwRevName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapEnable=slmTrapEnable, slMain=slMain, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmNetworkMode=slmNetworkMode, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestTable=slmSyslogDestTable, slmAdmin=slmAdmin, slmAuthPassword=slmAuthPassword, slmAuth=slmAuth, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, SoftwareRevision=SoftwareRevision, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam5=slmTrapLogParam5, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassTable=slmChPassTable, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, slmSysName=slmSysName, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmSys=slmSys, slmSnmpv3Password=slmSnmpv3Password, AdminAccess=AdminAccess, UserLogin=UserLogin, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmTrap=slmTrap, slmChPassOldPass=slmChPassOldPass, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam3=slmTrapLogParam3, PYSNMP_MODULE_ID=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, slmLicenseExpiration=slmLicenseExpiration, slmAdminAccess=slmAdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmSysCalendarTime=slmSysCalendarTime, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmVcatDelay=slmVcatDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slmAuthLogin=slmAuthLogin, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmSysIpAddr=slmSysIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevEntry=slmSwRevEntry, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmWriteCommunity=slmWriteCommunity, slmChPassLogin=slmChPassLogin, slmTrapPort=slmTrapPort, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmTid=slmTid, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, UserPassword=UserPassword, slmAdminPassword=slmAdminPassword, slmConfigFile=slmConfigFile, slmSysUplinkRate=slmSysUplinkRate, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLocation=slmSysLocation, slmSysTrapFormat=slmSysTrapFormat, slmChPass=slmChPass, slmSwRevTable=slmSwRevTable, slmLicenseEntry=slmLicenseEntry, slmBoxSize=slmBoxSize, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, slmSysResetPm=slmSysResetPm, slmTrapUserLogin=slmTrapUserLogin)
