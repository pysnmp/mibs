...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, AdminAccess=AdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogEntry=slmTrapLogEntry, slmRebootDelay=slmRebootDelay, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmTrapSysNameChange=slmTrapSysNameChange, PYSNMP_MODULE_ID=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSysResetPm=slmSysResetPm, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmLogFile=slmLogFile, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserPassword=UserPassword, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTable=slmTrapLogTable, slmConfigFile=slmConfigFile, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmSwRevTable=slmSwRevTable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmLicenseId=slmLicenseId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmPortsNumber=slmPortsNumber, slmLicenseIndex=slmLicenseIndex, slmAuthCommunity=slmAuthCommunity, slmMuxNumber=slmMuxNumber, slmSysName=slmSysName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogName=slmTrapLogName, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmAdminTable=slmAdminTable, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmAdmin=slmAdmin, slmWriteCommunity=slmWriteCommunity, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, SoftwareRevision=SoftwareRevision, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, UserCommunity=UserCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam3=slmTrapLogParam3, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, slmChPassLogin=slmChPassLogin, slmSwRevStatus=slmSwRevStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserAccess=slmTrapUserAccess, slmLicenseTable=slmLicenseTable, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmDeact=slmSysAlmDeact, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmAuthPassword=slmAuthPassword, slmPsuNumber=slmPsuNumber, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmAdminLogin=slmAdminLogin, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmTrapEnable=slmTrapEnable, slmSysMode=slmSysMode, slmSysSubnetMask=slmSysSubnetMask, slmSyslogPort=slmSyslogPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminAccess=slmAdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassOldPass=slmChPassOldPass, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestAddress=slmTrapDestAddress, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmTrap=slmTrap, slmConfigSysSignalType=slmConfigSysSignalType, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmLicense=slmLicense)
