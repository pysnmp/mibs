...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevStatus=slmSwRevStatus, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmSysAdminStatus=slmSysAdminStatus, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, slmAdminLogin=slmAdminLogin, slmSysTrapFormat=slmSysTrapFormat, slmLicenseEntry=slmLicenseEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam1=slmTrapLogParam1, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmAuth=slmAuth, slmReadCommunity=slmReadCommunity, slmAuthCommunity=slmAuthCommunity, slmConfigFile=slmConfigFile, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmAuthTable=slmAuthTable, slmSysOperStatus=slmSysOperStatus, slmPsuNumber=slmPsuNumber, slmMuxNumber=slmMuxNumber, slmTrapLogName=slmTrapLogName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseId=slmLicenseId, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, UserPassword=UserPassword, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmSysGatewayAddr=slmSysGatewayAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysIpAddr=slmSysIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam5=slmTrapLogParam5, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestAddress=slmTrapDestAddress, slmSysChassisId=slmSysChassisId, slMain=slMain, slmSwRevEntry=slmSwRevEntry, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmPmAvailable=slmPmAvailable, slmTid=slmTid, slmTrapLogTable=slmTrapLogTable, slmLicenseIndex=slmLicenseIndex, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam3=slmTrapLogParam3, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, slmChPassNewPass=slmChPassNewPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSys=slmSys, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmAuthPassword=slmAuthPassword, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmLicense=slmLicense, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmSnmpv3Priv=slmSnmpv3Priv, slmWriteCommunity=slmWriteCommunity, slmOemType=slmOemType, slmTrapUserAccess=slmTrapUserAccess, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, UserLogin=UserLogin, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTopologyEnabled=slmTopologyEnabled, slmSyslogPort=slmSyslogPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogin=slmLogin, slmSysSubnetMask=slmSysSubnetMask, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdmin=slmAdmin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserLogin=slmTrapUserLogin, PYSNMP_MODULE_ID=slMain, slmTrapDestEntry=slmTrapDestEntry, slmNetworkMode=slmNetworkMode, slmTrapPort=slmTrapPort, slmChPass=slmChPass, slmTrap=slmTrap, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthLogin=slmAuthLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmVcatDelay=slmVcatDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminPassword=slmAdminPassword, slmSyslogDestAddress=slmSyslogDestAddress)
