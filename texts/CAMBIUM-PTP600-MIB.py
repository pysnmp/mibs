...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:24:45 2021
...
iso, MibIdentifier, Gauge32, Unsigned32, Counter64, Integer32, Bits, ModuleIdentity, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Gauge32", "Unsigned32", "Counter64", "Integer32", "Bits", "ModuleIdentity", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", versionsGroup=versionsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogStateTrap=syslogStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogClientTrap=syslogClientTrap, localPacketFiltering=localPacketFiltering, rxColorCode=rxColorCode, sNTPServerStatus=sNTPServerStatus, sNMPTrapTable=sNMPTrapTable, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, smtpGroup=smtpGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, searchState=searchState, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, managementPortStatus=managementPortStatus, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, dataPortStatus=dataPortStatus, regionCode=regionCode, sNTPServerTableIndex=sNTPServerTableIndex, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, systemReset=systemReset, dfsTableEntry=dfsTableEntry, userTable=userTable, dfsGroup=dfsGroup, channelBLineCode=channelBLineCode, rawReceivePower=rawReceivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, regionCodeTrap=regionCodeTrap, iPv6Address=iPv6Address, latitude=latitude, configurationGroup=configurationGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementary=supplementary, l2CPPriorityTable=l2CPPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableIndex=userTableIndex, remoteInternetAddress=remoteInternetAddress, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, secureModeAlarm=secureModeAlarm, syslogControlGroup=syslogControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, bridge=bridge, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenceGroup=licenceGroup, channelBLoopback=channelBLoopback, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableLoss=cableLoss, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, pubStats=pubStats, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, ethernetBridgingAvailability=ethernetBridgingAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, productName=productName, managementGroup=managementGroup, iPv4Address=iPv4Address, telnetPortNumber=telnetPortNumber, dfsTableIndex=dfsTableIndex, aAAControl=aAAControl, channelALoopback=channelALoopback, ptp600=ptp600, userRole=userRole, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, subnetMask=subnetMask, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelSelection=telecomsChannelSelection, userName=userName, tFTPServerInternetAddress=tFTPServerInternetAddress, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogClient=syslogClient, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitPower=transmitPower, securityLevel=securityLevel, hAZLOCConfiguration=hAZLOCConfiguration, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitDataRate=transmitDataRate, sNTPPrimaryServer=sNTPPrimaryServer, bridgeGroup=bridgeGroup, automaticTxPowerControl=automaticTxPowerControl, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, dataPortAutoMdix=dataPortAutoMdix, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityTable=mPLSTCPriorityTable, installStatus=installStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsMeans=dfsMeans, range=range, systemClock=systemClock, userEnabled=userEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelALineCode=channelALineCode, phyControl=phyControl, sNTPSyncTrap=sNTPSyncTrap, eIRP=eIRP, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, encryptionGroup=encryptionGroup, management=management, ethernet=ethernet, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerRetries=sNTPServerRetries, linkName=linkName, timeZone=timeZone, iPDSCPPriorityTable=iPDSCPPriorityTable, userPassword=userPassword, syslogState=syslogState, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, targetRange=targetRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitModulationMode=transmitModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecom=telecom, iPv6PrefixLength=iPv6PrefixLength, transmitFreqKHz=transmitFreqKHz, receiveDataRate=receiveDataRate, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, qOSPriorityScheme=qOSPriorityScheme, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, byteErrorRatio=byteErrorRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, masterSlaveMode=masterSlaveMode, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, frequencyVariant=frequencyVariant, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogControl=syslogControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secureModeAlarmTrap=secureModeAlarmTrap, receivePower=receivePower, ptmp=ptmp, remoteInternetAddressType=remoteInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitChannel=transmitChannel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatusGroup=phyStatusGroup, ethernetBridgingStatus=ethernetBridgingStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hTTPAccessEnabled=hTTPAccessEnabled, channelACableLength=channelACableLength, gatewayIPAddress=gatewayIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, daylightSaving=daylightSaving, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hardwareVersion=hardwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPVersion=iPVersion, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfs=dfs, alarms=alarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTable=sNTPServerTable, telecomGroup=telecomGroup, dfsTable=dfsTable, sNTPLastSync=sNTPLastSync, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, managementPortStatusTrap=managementPortStatusTrap, pubStatsGroup=pubStatsGroup, ptp=ptp, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBCableLength=channelBCableLength, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, transmitFreqMHz=transmitFreqMHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rangingMode=rangingMode, secondarySoftwareVersion=secondarySoftwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapVersion=sNMPTrapVersion, sNMPv3Enable=sNMPv3Enable, telecomsChannelBStatus=telecomsChannelBStatus, resetGroup=resetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTable=ethernetPriorityTable, linkModeOptimisation=linkModeOptimisation, aggregateDataRate=aggregateDataRate, smtp=smtp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelALoopbackTrap=channelALoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configuration=configuration, encryption=encryption, groupID=groupID)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", versions=versions, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cambium=cambium, phyControlGroup=phyControlGroup, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, dfsPeaks=dfsPeaks, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, productVariant=productVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, longitude=longitude, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, userTableEntry=userTableEntry, dataPortFiberStatus=dataPortFiberStatus, reset=reset, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licence=licence, txColorCode=txColorCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, antennaGain=antennaGain, managementMode=managementMode, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBandwidth=channelBandwidth, sntp=sntp, siteName=siteName)
