...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, encryptionGroup=encryptionGroup, userTable=userTable, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, altitude=altitude, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControl=aAAControl, ethernet=ethernet, regionCode=regionCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, transmitModulationMode=transmitModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp600=ptp600, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecom=telecom, aggregateDataRate=aggregateDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDControl=tDDControl, receiveFreqMHz=receiveFreqMHz, iPv4Address=iPv4Address, hAZLOCConfiguration=hAZLOCConfiguration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, regionCodeTrap=regionCodeTrap, dfsTableIndex=dfsTableIndex, phyControl=phyControl, dfsMeans=dfsMeans, channelBCableLength=channelBCableLength, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userName=userName, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsGroup=dfsGroup, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6GatewayAddress=iPv6GatewayAddress, managementPortStatusTrap=managementPortStatusTrap, systemReset=systemReset, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpCompliance=ptpCompliance, resetGroup=resetGroup, latitude=latitude, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerInternetAddressType=sNTPServerInternetAddressType, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelAStatus=telecomsChannelAStatus, encryption=encryption, dfsTable=dfsTable, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSPortNumber=hTTPSPortNumber, txColorCode=txColorCode, licence=licence, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, byteErrorRatio=byteErrorRatio, channelALoopbackTrap=channelALoopbackTrap, telecomsChannelSelection=telecomsChannelSelection, transmitDataRate=transmitDataRate, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControlGroup=tDDControlGroup, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, eIRP=eIRP, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6Address=iPv6Address, linkSymmetry=linkSymmetry, searchState=searchState, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, versions=versions, management=management, antennaGain=antennaGain, cableLoss=cableLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetGroup=ethernetGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secureModeAlarm=secureModeAlarm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installStatusTrap=installStatusTrap, userRole=userRole, qOSPriorityScheme=qOSPriorityScheme, ptmp=ptmp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rangingMode=rangingMode, managementPortStatus=managementPortStatus, systemClock=systemClock, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, frequencyVariant=frequencyVariant, configurationGroup=configurationGroup, securityLevel=securityLevel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, vLANManagementVID=vLANManagementVID, subnetMask=subnetMask, iPDSCPPriorityTable=iPDSCPPriorityTable, hardwareVersion=hardwareVersion, ethernetBridgingStatus=ethernetBridgingStatus, dfs=dfs, bridgeGroup=bridgeGroup, remoteIPAddress=remoteIPAddress, rxColorCode=rxColorCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtp=smtp, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSyncTrap=sNTPSyncTrap, managementPortDisabledWarning=managementPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTimeout=sNTPServerTimeout, productVariant=productVariant, maximumTransmitPower=maximumTransmitPower, sntpGroup=sntpGroup, userTableEntry=userTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBLineCode=channelBLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, channelChangeTrap=channelChangeTrap, configuration=configuration, ethernetPriorityTable=ethernetPriorityTable, rawReceivePower=rawReceivePower, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, accessMethod=accessMethod, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, dataPortStatus=dataPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, snmpControlGroup=snmpControlGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelALineCode=channelALineCode, licenceGroup=licenceGroup, productName=productName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, localPacketFiltering=localPacketFiltering, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, daylightSaving=daylightSaving, pubStatsGroup=pubStatsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, automaticTxPowerControl=automaticTxPowerControl, supplementary=supplementary, sNTPPollInterval=sNTPPollInterval, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerRetries=sNTPServerRetries, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, channelACableLength=channelACableLength, sMTPEmailAlert=sMTPEmailAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, targetRange=targetRange, dSCPManagementPriority=dSCPManagementPriority, alarmsGroup=alarmsGroup, ptp=ptp, reset=reset, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelALoopback=channelALoopback, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClientTrap=syslogClientTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, installStatus=installStatus, syslogControl=syslogControl, l2CPPriorityTable=l2CPPriorityTable, userTableNumber=userTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, iPVersion=iPVersion, cambium=cambium, sntp=sntp, alarms=alarms, remoteInternetAddressType=remoteInternetAddressType, managementMode=managementMode, linkLoss=linkLoss, sNTPSync=sNTPSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, userPassword=userPassword, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, remoteRxTargetPower=remoteRxTargetPower, bridge=bridge, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, PYSNMP_MODULE_ID=cambium, channelBLoopback=channelBLoopback, groupID=groupID, telecomsInterface=telecomsInterface, remoteInternetAddress=remoteInternetAddress, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, managementGroup=managementGroup, phyControlGroup=phyControlGroup, bootVersion=bootVersion, userEnabled=userEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, sNTPServerTable=sNTPServerTable, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomGroup=telecomGroup, pubStats=pubStats, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBandwidth=channelBandwidth)
