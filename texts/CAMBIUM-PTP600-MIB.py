...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", unitOutOfCalibration=unitOutOfCalibration, tDDControlGroup=tDDControlGroup, linkName=linkName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementMode=managementMode, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementVID=vLANManagementVID, sNTPServerTimeout=sNTPServerTimeout, secureModeAlarmTrap=secureModeAlarmTrap, supplementary=supplementary, iPv6Address=iPv6Address, bridgeGroup=bridgeGroup, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatus=installStatus, notificationsGroup=notificationsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsPeaks=dfsPeaks, rangingMode=rangingMode, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteRxTargetPower=remoteRxTargetPower, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, bandwidthVariant=bandwidthVariant, tDDControl=tDDControl, installArmStateTrap=installArmStateTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarning=dataPortDisabledWarning, transmitChannel=transmitChannel, versions=versions, ptp600=ptp600, sNTPPrimaryServer=sNTPPrimaryServer, telnetAccessEnabled=telnetAccessEnabled, syslogState=syslogState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSyncTrap=sNTPSyncTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptmp=ptmp, dfsTableIndex=dfsTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPEnabledMessages=sMTPEnabledMessages, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPVersion=iPVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, productVariant=productVariant, range=range, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, eIRP=eIRP, systemClock=systemClock, sntpGroup=sntpGroup, remoteInternetAddressType=remoteInternetAddressType, userRole=userRole, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableEntry=dfsTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelALoopback=channelALoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, securityLevel=securityLevel, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityTable=ethernetPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, channelACableLength=channelACableLength, regionCode=regionCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveFreqKHz=receiveFreqKHz, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableIndex=userTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, byteErrorRatio=byteErrorRatio, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, regionCodeTrap=regionCodeTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, alarms=alarms, channelChangeTrap=channelChangeTrap, sNTPServerTableEntry=sNTPServerTableEntry, reset=reset, sMTPEmailAlert=sMTPEmailAlert, channelBLoopbackTrap=channelBLoopbackTrap, transmitPower=transmitPower, ethernetGroup=ethernetGroup, timeZone=timeZone, syslogClient=syslogClient, phyControlGroup=phyControlGroup, licence=licence, sNTPSync=sNTPSync, antennaGain=antennaGain, ethernetBridgingStatus=ethernetBridgingStatus, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, systemReset=systemReset, telecomsInterface=telecomsInterface, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, userTableNumber=userTableNumber, dfs=dfs, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, targetRange=targetRange, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTable=sNTPServerTable, linkModeOptimisation=linkModeOptimisation, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, userPassword=userPassword, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, accessMethod=accessMethod, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, sNTPLastSync=sNTPLastSync, dfsTable=dfsTable, hAZLOCConfiguration=hAZLOCConfiguration, txColorCode=txColorCode, pubStatsGroup=pubStatsGroup, sNMPv3Enable=sNMPv3Enable, cambium=cambium, channelBLoopback=channelBLoopback, resetGroup=resetGroup, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsGroup=dfsGroup, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, iPv6GatewayAddress=iPv6GatewayAddress, vectorError=vectorError, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, secureModeAlarm=secureModeAlarm, userEnabled=userEnabled, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, sNTPServerStatus=sNTPServerStatus, channelBLineCode=channelBLineCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode, tFTPServerInternetAddress=tFTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, dataPortFiberStatus=dataPortFiberStatus, phyControl=phyControl, targetMACAddress=targetMACAddress, siteName=siteName, managementGroup=managementGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTable=userTable, receiveChannel=receiveChannel, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, bootVersion=bootVersion, channelALoopbackTrap=channelALoopbackTrap, hTTPAccessEnabled=hTTPAccessEnabled, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv4Address=iPv4Address, secondarySoftwareVersion=secondarySoftwareVersion, linkSymmetry=linkSymmetry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rawReceivePower=rawReceivePower, incompatibleRegionCodes=incompatibleRegionCodes, userName=userName, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitFreqKHz=transmitFreqKHz, bridge=bridge, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelAStatus=telecomsChannelAStatus, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatus=phyStatus, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelSelection=telecomsChannelSelection, ptpCompliance=ptpCompliance, aAAControl=aAAControl, encryptionGroup=encryptionGroup, receiveFreqMHz=receiveFreqMHz, channelBCableLength=channelBCableLength, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitModulationMode=transmitModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPPortNumber=sNMPPortNumber, pubStats=pubStats, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, latitude=latitude, sMTPServerIPAddress=sMTPServerIPAddress, automaticTxPowerControl=automaticTxPowerControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortDisabledWarning=managementPortDisabledWarning, sntp=sntp, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, managementPortConfigurationMismatch=managementPortConfigurationMismatch, smtp=smtp, telecomsChannelBStatus=telecomsChannelBStatus, ethernet=ethernet, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerIPAddress=tFTPServerIPAddress, remoteInternetAddress=remoteInternetAddress, ptpGroups=ptpGroups, subnetMask=subnetMask, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomGroup=telecomGroup, telecom=telecom, phyStatusGroup=phyStatusGroup, versionsGroup=versionsGroup, rxColorCode=rxColorCode, receiveModulationMode=receiveModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortStatus=managementPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, installStatusTrap=installStatusTrap, hardwareVersion=hardwareVersion, ptpTraps=ptpTraps, ptp=ptp, syslogControlGroup=syslogControlGroup, configuration=configuration, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, telnetPortNumber=telnetPortNumber, dSCPManagementPriority=dSCPManagementPriority, dfsTableNumber=dfsTableNumber, syslogStateTrap=syslogStateTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortStatusTrap=managementPortStatusTrap, userTableEntry=userTableEntry, iPv6PrefixLength=iPv6PrefixLength, dataPortStatus=dataPortStatus, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPPortNumber=hTTPPortNumber, licenceGroup=licenceGroup, alarmsGroup=alarmsGroup, longitude=longitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, channelALineCode=channelALineCode, localPacketFiltering=localPacketFiltering, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, encryption=encryption, ethernetFiberSupport=ethernetFiberSupport, frequencyVariant=frequencyVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
