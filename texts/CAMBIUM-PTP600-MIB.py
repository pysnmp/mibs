...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", reset=reset, iPv4Address=iPv4Address, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, rxColorCode=rxColorCode, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, linkSymmetry=linkSymmetry, range=range, smtp=smtp, targetMACAddress=targetMACAddress, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitModulationMode=transmitModulationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomsChannelSelection=telecomsChannelSelection, transmitPower=transmitPower, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, snmpControl=snmpControl, phyControl=phyControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerIPAddress=sMTPServerIPAddress, channelALoopback=channelALoopback, groupID=groupID, channelALoopbackTrap=channelALoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cambium=cambium, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, dSCPManagementPriority=dSCPManagementPriority, cableLoss=cableLoss, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, regionCode=regionCode, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, productVariant=productVariant, rawReceivePower=rawReceivePower, timeZone=timeZone, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, alarms=alarms, accessMethod=accessMethod, resetGroup=resetGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, supplementaryGroup=supplementaryGroup, altitude=altitude, installStatusTrap=installStatusTrap, linkLoss=linkLoss, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, dfsMeans=dfsMeans, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBLoopback=channelBLoopback, tDDSynchronizationStatus=tDDSynchronizationStatus, userPassword=userPassword, channelChangeTrap=channelChangeTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, targetRange=targetRange, userRole=userRole, signalStrengthRatio=signalStrengthRatio, sNTPLastSync=sNTPLastSync, management=management, syslogClient=syslogClient, sNTPServerIPAddress=sNTPServerIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, securityLevel=securityLevel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, siteName=siteName, telecom=telecom, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, l2CPPriorityTable=l2CPPriorityTable, productName=productName, sNTPSyncTrap=sNTPSyncTrap, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, telecomsChannelAStatus=telecomsChannelAStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bandwidthVariant=bandwidthVariant, iPv6PrefixLength=iPv6PrefixLength, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, snmpControlGroup=snmpControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, regionCodeTrap=regionCodeTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntpGroup=sntpGroup, systemReset=systemReset, latitude=latitude, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userName=userName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableIndex=userTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, dfsTableEntry=dfsTableEntry, managementGroup=managementGroup, managementMode=managementMode, sNTPServerTable=sNTPServerTable, ethernet=ethernet, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, sNTPState=sNTPState, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, vLANManagementVID=vLANManagementVID, ptp600=ptp600, dfsTableNumber=dfsTableNumber, installArmState=installArmState, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, txColorCode=txColorCode, dataPortDisabledWarning=dataPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, localPacketFiltering=localPacketFiltering, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqKHz=receiveFreqKHz, dfsTable=dfsTable, iPVersion=iPVersion, telecomsChannelBStatus=telecomsChannelBStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveChannel=receiveChannel, transmitChannel=transmitChannel, linkName=linkName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secureModeAlarm=secureModeAlarm, sNTPServerTimeout=sNTPServerTimeout, managementPortStatus=managementPortStatus, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, smtpGroup=smtpGroup, eIRP=eIRP, telecomsInterface=telecomsInterface, wirelessLinkStatus=wirelessLinkStatus, vectorError=vectorError, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmStateTrap=installArmStateTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBandwidth=channelBandwidth, dfs=dfs, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, configurationGroup=configurationGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receivePower=receivePower, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, qOSPriorityScheme=qOSPriorityScheme, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityTable=mPLSTCPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBLineCode=channelBLineCode, daylightSaving=daylightSaving, receiveModulationModeDetail=receiveModulationModeDetail, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, encryption=encryption, sNTPPrimaryServer=sNTPPrimaryServer, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp=ptp, rangingMode=rangingMode, longitude=longitude, automaticTxPowerControl=automaticTxPowerControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpGroups=ptpGroups, sntp=sntp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveModulationMode=receiveModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hardwareVersion=hardwareVersion, userTableEntry=userTableEntry, bridge=bridge, configuration=configuration, gatewayIPAddress=gatewayIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteInternetAddress=remoteInternetAddress, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, dfsGroup=dfsGroup, remoteRxTargetPower=remoteRxTargetPower, vLANManagementPriority=vLANManagementPriority, sNMPPortNumber=sNMPPortNumber, hAZLOCConfiguration=hAZLOCConfiguration, versions=versions, managementPortDisabledWarning=managementPortDisabledWarning, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogControl=syslogControl, bridgeGroup=bridgeGroup, phyStatusGroup=phyStatusGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, aggregateDataRate=aggregateDataRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelALineCode=channelALineCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBCableLength=channelBCableLength, secureModeAlarmTrap=secureModeAlarmTrap, iPv6Address=iPv6Address, channelACableLength=channelACableLength, sNTPServerTableEntry=sNTPServerTableEntry, ptpTraps=ptpTraps, sNTPServerStatus=sNTPServerStatus, searchState=searchState, transmitFreqKHz=transmitFreqKHz, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, ptpCompliance=ptpCompliance, phyStatus=phyStatus)
