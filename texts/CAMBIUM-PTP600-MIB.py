...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPVersion=iPVersion, hardwareVersion=hardwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCode=regionCode, telnetPortNumber=telnetPortNumber, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rawReceivePower=rawReceivePower, cambium=cambium, telecomGroup=telecomGroup, sNTPServerTableEntry=sNTPServerTableEntry, rangingMode=rangingMode, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, localPacketFiltering=localPacketFiltering, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, aAAControlGroup=aAAControlGroup, byteErrorRatio=byteErrorRatio, syslogState=syslogState, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimisation=linkModeOptimisation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClientTrap=syslogClientTrap, supplementary=supplementary, sMTPServerInternetAddress=sMTPServerInternetAddress, encryptionAlgorithm=encryptionAlgorithm, searchState=searchState, userPassword=userPassword, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecom=telecom, mPLSTCPriorityTable=mPLSTCPriorityTable, management=management, syslogStateTrap=syslogStateTrap, sNTPServerRetries=sNTPServerRetries, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versionsGroup=versionsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetGroup=ethernetGroup, ptpCompliance=ptpCompliance, bridge=bridge, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxColorCode=rxColorCode, userEnabled=userEnabled, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableNumber=userTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth, ethernetPriorityTable=ethernetPriorityTable, groupID=groupID, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPPortNumber=sNMPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, userTableIndex=userTableIndex, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, supplementaryGroup=supplementaryGroup, sNTPServerTable=sNTPServerTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, receiveChannel=receiveChannel, sNTPServerStatus=sNTPServerStatus, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, dfsTable=dfsTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, masterSlaveMode=masterSlaveMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatus=phyStatus, transmitFreqMHz=transmitFreqMHz, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configuration=configuration, ptmp=ptmp, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDControlGroup=tDDControlGroup, bridgeGroup=bridgeGroup, telecomsChannelAStatus=telecomsChannelAStatus, channelBCableLength=channelBCableLength, sNMPv3Enable=sNMPv3Enable, secureModeAlarm=secureModeAlarm, sNTPPollInterval=sNTPPollInterval, iPv6PrefixLength=iPv6PrefixLength, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, notificationsGroup=notificationsGroup, eIRP=eIRP, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tDDControl=tDDControl, channelBLoopbackTrap=channelBLoopbackTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkName=linkName, frequencyVariant=frequencyVariant, linkLoss=linkLoss, pubStats=pubStats, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hAZLOCConfiguration=hAZLOCConfiguration, hTTPSPortNumber=hTTPSPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, PYSNMP_MODULE_ID=cambium, channelALoopback=channelALoopback, targetRange=targetRange, iPv4Address=iPv4Address, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, channelBLoopback=channelBLoopback, ethernet=ethernet, syslogControlGroup=syslogControlGroup, linkSymmetry=linkSymmetry, automaticTxPowerControl=automaticTxPowerControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licenceGroup=licenceGroup, channelALoopbackTrap=channelALoopbackTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTable=userTable, subnetMask=subnetMask, siteName=siteName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqKHz=transmitFreqKHz, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telecomsChannelBStatus=telecomsChannelBStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, regionCodeTrap=regionCodeTrap, licence=licence, channelACableLength=channelACableLength, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, qOSPriorityScheme=qOSPriorityScheme, transmitDataRate=transmitDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, ptp600=ptp600, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, productName=productName, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, ethernetBridgingStatus=ethernetBridgingStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, dfsGroup=dfsGroup, installArmState=installArmState, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableNumber=ethernetPriorityTableNumber, systemClock=systemClock, daylightSaving=daylightSaving, remoteInternetAddressType=remoteInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, altitude=altitude, sMTPEnabledMessages=sMTPEnabledMessages, channelBLineCode=channelBLineCode, latitude=latitude, alarms=alarms, installStatusTrap=installStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, remoteInternetAddress=remoteInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, transmitChannel=transmitChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vectorError=vectorError, reset=reset, dSCPManagementPriority=dSCPManagementPriority, longitude=longitude, systemReset=systemReset, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, timeZone=timeZone, securityLevel=securityLevel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, dfs=dfs, remoteRxTargetPower=remoteRxTargetPower, dfsMeans=dfsMeans, txColorCode=txColorCode, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementVID=vLANManagementVID, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alarmsGroup=alarmsGroup, l2CPPriorityTable=l2CPPriorityTable, configurationGroup=configurationGroup, bandwidthVariant=bandwidthVariant, dataPortFiberStatus=dataPortFiberStatus, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, managementMode=managementMode, dataPortAutoMdix=dataPortAutoMdix, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receivePower=receivePower, sntp=sntp, sNTPState=sNTPState, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarning=dataPortDisabledWarning, smtpGroup=smtpGroup, dataPortStatus=dataPortStatus, telecomsInterface=telecomsInterface, secondarySoftwareVersion=secondarySoftwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, resetGroup=resetGroup, ptpTraps=ptpTraps, channelALineCode=channelALineCode, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, installStatus=installStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControl=phyControl, managementPortStatus=managementPortStatus, telecomsChannelSelection=telecomsChannelSelection, sNTPSync=sNTPSync, secureModeAlarmTrap=secureModeAlarmTrap, iPv6Address=iPv6Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userRole=userRole, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, ethernetFiberSupport=ethernetFiberSupport, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, dfsTableEntry=dfsTableEntry, bootVersion=bootVersion, phyControlGroup=phyControlGroup, versions=versions)
