...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aggregateDataRate=aggregateDataRate, altitude=altitude, ptmp=ptmp, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPPollInterval=sNTPPollInterval, receiveModulationMode=receiveModulationMode, transmitChannel=transmitChannel, iPv6PrefixLength=iPv6PrefixLength, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, securityLevel=securityLevel, userEnabled=userEnabled, l2CPPriorityTable=l2CPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelALoopbackTrap=channelALoopbackTrap, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, dfsMeans=dfsMeans, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, channelALoopback=channelALoopback, supplementaryGroup=supplementaryGroup, managementGroup=managementGroup, dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, sNTPSync=sNTPSync, systemReset=systemReset, longitude=longitude, configurationGroup=configurationGroup, txColorCode=txColorCode, phyStatus=phyStatus, ptp600=ptp600, transmitFreqMHz=transmitFreqMHz, vLANManagementPriority=vLANManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteRxTargetPower=remoteRxTargetPower, transmitPower=transmitPower, iPv6GatewayAddress=iPv6GatewayAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, secureModeAlarm=secureModeAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPVersion=iPVersion, ethernetGroup=ethernetGroup, sNTPServerPortNumber=sNTPServerPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bridgeGroup=bridgeGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, targetRange=targetRange, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationMode=tDDSynchronizationMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelBStatus=telecomsChannelBStatus, channelACableLength=channelACableLength, supplementary=supplementary, eIRP=eIRP, latitude=latitude, reset=reset, subnetMask=subnetMask, transmitDataRate=transmitDataRate, userPassword=userPassword, rawReceivePower=rawReceivePower, vectorError=vectorError, userTableEntry=userTableEntry, sNTPState=sNTPState, tDDControl=tDDControl, receivePower=receivePower, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, linkLoss=linkLoss, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, unitOutOfCalibration=unitOutOfCalibration, sNTPPrimaryServer=sNTPPrimaryServer, telecomsChannelSelection=telecomsChannelSelection, sNTPServerInternetAddressType=sNTPServerInternetAddressType, groupID=groupID, installArmStateTrap=installArmStateTrap, remoteInternetAddress=remoteInternetAddress, receiveFreqMHz=receiveFreqMHz, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, cambium=cambium, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoMdix=dataPortAutoMdix, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, sNTPServerStatus=sNTPServerStatus, sNMPv3Enable=sNMPv3Enable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, masterSlaveMode=masterSlaveMode, channelBLoopbackTrap=channelBLoopbackTrap, dataPortStatus=dataPortStatus, versions=versions, hardwareVersion=hardwareVersion, telecom=telecom, sNMPTrapTable=sNMPTrapTable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sntpGroup=sntpGroup, configuration=configuration, localPacketFiltering=localPacketFiltering, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelALineCode=channelALineCode, bridge=bridge, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, alarms=alarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelAStatus=telecomsChannelAStatus, maximumTransmitPower=maximumTransmitPower, automaticTxPowerControl=automaticTxPowerControl, sNTPServerRetries=sNTPServerRetries, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTimeout=sNTPServerTimeout, syslogState=syslogState, pubStats=pubStats, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, regionCodeTrap=regionCodeTrap, sNTPServerTableIndex=sNTPServerTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licence=licence, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortStatusTrap=managementPortStatusTrap, snmpControl=snmpControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userName=userName, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerTable=sNTPServerTable, syslogControl=syslogControl, sNTPServerTableEntry=sNTPServerTableEntry, management=management, iPv6Address=iPv6Address, linkModeOptimisation=linkModeOptimisation, byteErrorRatio=byteErrorRatio, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, channelBLineCode=channelBLineCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, resetGroup=resetGroup, rangingMode=rangingMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsGroup=dfsGroup, ethernetPriorityTable=ethernetPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, phyStatusGroup=phyStatusGroup, accessMethod=accessMethod, productVariant=productVariant, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, dfs=dfs, searchState=searchState, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, tFTPServerInternetAddress=tFTPServerInternetAddress, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, siteName=siteName, managementMode=managementMode, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sntp=sntp, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, receiveModulationModeDetail=receiveModulationModeDetail, systemClock=systemClock, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installStatus=installStatus, smtpGroup=smtpGroup, rxColorCode=rxColorCode, ptp=ptp, receiveChannel=receiveChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortStatus=managementPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkAvailability=wirelessLinkAvailability, remoteInternetAddressType=remoteInternetAddressType, smtp=smtp, channelBCableLength=channelBCableLength, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, bootVersion=bootVersion, notificationsGroup=notificationsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopback=channelBLoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetBridgingStatus=ethernetBridgingStatus, linkSymmetry=linkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableIndex=userTableIndex, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, tFTPServerPortNumber=tFTPServerPortNumber, telnetPortNumber=telnetPortNumber, encryption=encryption, sMTPEnabledMessages=sMTPEnabledMessages, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, signalStrengthRatio=signalStrengthRatio, aAAControlGroup=aAAControlGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, timeZone=timeZone, syslogClientTrap=syslogClientTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTable=dfsTable, userTable=userTable, transmitFreqKHz=transmitFreqKHz, hAZLOCConfiguration=hAZLOCConfiguration, versionsGroup=versionsGroup, linkName=linkName, channelBandwidth=channelBandwidth, vLANManagementVID=vLANManagementVID, channelChangeTrap=channelChangeTrap, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernet=ethernet, frequencyVariant=frequencyVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, daylightSaving=daylightSaving, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsTableEntry=dfsTableEntry, ptpTraps=ptpTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, qOSPriorityScheme=qOSPriorityScheme, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, gatewayIPAddress=gatewayIPAddress, iPv4Address=iPv4Address, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex)
