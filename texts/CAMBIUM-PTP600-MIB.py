...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, sNTPSyncTrap=sNTPSyncTrap, receiveFreqMHz=receiveFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogControlGroup=syslogControlGroup, rxColorCode=rxColorCode, byteErrorRatio=byteErrorRatio, userTableNumber=userTableNumber, remoteInternetAddressType=remoteInternetAddressType, systemReset=systemReset, receiveFreqKHz=receiveFreqKHz, signalStrengthRatio=signalStrengthRatio, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, remoteRxTargetPower=remoteRxTargetPower, management=management, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogControl=syslogControl, ethernetBridgingStatus=ethernetBridgingStatus, iPv4Address=iPv4Address, linkLoss=linkLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, incompatibleRegionCodes=incompatibleRegionCodes, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, configurationGroup=configurationGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, daylightSaving=daylightSaving, userPassword=userPassword, groupID=groupID, managementMode=managementMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, automaticTxPowerControl=automaticTxPowerControl, localPacketFiltering=localPacketFiltering, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveDataRate=receiveDataRate, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptmp=ptmp, sntp=sntp, sNTPSync=sNTPSync, sNTPLastSync=sNTPLastSync, l2CPPriorityTableNumber=l2CPPriorityTableNumber, siteName=siteName, dataPortFiberStatus=dataPortFiberStatus, latitude=latitude, tDDControl=tDDControl, antennaGain=antennaGain, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, dfs=dfs, frequencyVariant=frequencyVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receivePower=receivePower, sNTPPrimaryServer=sNTPPrimaryServer, channelALineCode=channelALineCode, channelALoopback=channelALoopback, licenceGroup=licenceGroup, ptpCompliance=ptpCompliance, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, installArmStateTrap=installArmStateTrap, syslogState=syslogState, sNMPPortNumber=sNMPPortNumber, regionCodeTrap=regionCodeTrap, sNTPServerStatus=sNTPServerStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, hTTPPortNumber=hTTPPortNumber, ptp600=ptp600, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetFiberSupport=ethernetFiberSupport, ptp=ptp, sNMPCommunityString=sNMPCommunityString, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDControlGroup=tDDControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, userTableIndex=userTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, cableLoss=cableLoss, qOSPriorityScheme=qOSPriorityScheme, reset=reset, accessMethod=accessMethod, bootVersion=bootVersion, channelBLineCode=channelBLineCode, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, altitude=altitude, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, smtpGroup=smtpGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomGroup=telecomGroup, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, userEnabled=userEnabled, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogStateTrap=syslogStateTrap, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, userName=userName, aAAControl=aAAControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, dfsTable=dfsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, rangingMode=rangingMode, channelChangeTrap=channelChangeTrap, dfsTableEntry=dfsTableEntry, snmpControl=snmpControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installStatusTrap=installStatusTrap, pubStats=pubStats, vectorError=vectorError, rawReceivePower=rawReceivePower, sNTPServerPortNumber=sNTPServerPortNumber, productName=productName, userTable=userTable, iPv6Address=iPv6Address, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlGroup=phyControlGroup, linkSymmetry=linkSymmetry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, transmitPower=transmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licence=licence, subnetMask=subnetMask, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secureModeAlarm=secureModeAlarm, ethernet=ethernet, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, hAZLOCConfiguration=hAZLOCConfiguration, versionsGroup=versionsGroup, sMTPEmailAlert=sMTPEmailAlert, bridge=bridge, ethernetPriorityTable=ethernetPriorityTable, ptpGroups=ptpGroups, telecomsChannelSelection=telecomsChannelSelection, iPVersion=iPVersion, phyStatus=phyStatus, dfsTableNumber=dfsTableNumber, channelBCableLength=channelBCableLength, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, encryption=encryption, alarmsGroup=alarmsGroup, bridgeGroup=bridgeGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableEntry=userTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, txColorCode=txColorCode, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, searchState=searchState, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerTableEntry=sNTPServerTableEntry, pubStatsGroup=pubStatsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsInterface=telecomsInterface, targetMACAddress=targetMACAddress, phyStatusGroup=phyStatusGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTimeout=sNTPServerTimeout, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, longitude=longitude, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, channelBLoopback=channelBLoopback, sNTPServerIPAddress=sNTPServerIPAddress, channelACableLength=channelACableLength, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerTableNumber=sNTPServerTableNumber, PYSNMP_MODULE_ID=cambium, sNTPPollInterval=sNTPPollInterval, securityLevel=securityLevel, targetRange=targetRange, range=range, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementary=supplementary, channelBandwidth=channelBandwidth, linkName=linkName, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, transmitModulationMode=transmitModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, sntpGroup=sntpGroup, sNTPServerRetries=sNTPServerRetries, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", smtp=smtp, managementGroup=managementGroup, installArmState=installArmState, resetGroup=resetGroup, channelBLoopbackTrap=channelBLoopbackTrap, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, managementPortStatus=managementPortStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, notificationsGroup=notificationsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, channelALoopbackTrap=channelALoopbackTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortStatusTrap=managementPortStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableIndex=dfsTableIndex, userRole=userRole, ptpTrapPrefix=ptpTrapPrefix, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, sNTPState=sNTPState, telecom=telecom, ethernetGroup=ethernetGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, wirelessLinkAvailability=wirelessLinkAvailability, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus)
