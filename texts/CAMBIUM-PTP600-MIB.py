...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpCompliance=ptpCompliance, receivePower=receivePower, receiveChannel=receiveChannel, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableNumber=sNMPTrapTableNumber, linkName=linkName, sNTPServerStatus=sNTPServerStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelALoopbackTrap=channelALoopbackTrap, sNTPServerTable=sNTPServerTable, linkModeOptimisation=linkModeOptimisation, masterSlaveMode=masterSlaveMode, iPv4Address=iPv4Address, userRole=userRole, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, securityLevel=securityLevel, productName=productName, channelBLoopback=channelBLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, linkSymmetry=linkSymmetry, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, secureModeAlarm=secureModeAlarm, dfsTableEntry=dfsTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, encryption=encryption, tDDControlGroup=tDDControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTimeout=sNTPServerTimeout, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsInterface=telecomsInterface, bootVersion=bootVersion, antennaGain=antennaGain, alarms=alarms, telecom=telecom, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementGroup=managementGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licence=licence, userTableNumber=userTableNumber, managementPortStatusTrap=managementPortStatusTrap, frequencyVariant=frequencyVariant, ethernetPriorityTable=ethernetPriorityTable, remoteIPAddress=remoteIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, accessMethod=accessMethod, longitude=longitude, management=management, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelBStatus=telecomsChannelBStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, automaticTxPowerControl=automaticTxPowerControl, aAAControl=aAAControl, managementMode=managementMode, receiveDataRate=receiveDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetBridgingStatus=ethernetBridgingStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPServerIPAddress=sMTPServerIPAddress, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, pubStatsGroup=pubStatsGroup, localPacketFiltering=localPacketFiltering, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, searchState=searchState, sNTPServerIPAddress=sNTPServerIPAddress, byteErrorRatio=byteErrorRatio, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBLoopbackTrap=channelBLoopbackTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, licenceGroup=licenceGroup, channelALoopback=channelALoopback, reset=reset, ptp600=ptp600, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsMeans=dfsMeans, dfs=dfs, timeZone=timeZone, userTableEntry=userTableEntry, ethernetGroup=ethernetGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, versions=versions, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, bridge=bridge, sNTPServerTableEntry=sNTPServerTableEntry, syslogState=syslogState, bandwidthVariant=bandwidthVariant, productVariant=productVariant, targetRange=targetRange, wirelessLinkStatus=wirelessLinkStatus, userPassword=userPassword, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetFiberSupport=ethernetFiberSupport, transmitChannel=transmitChannel, cambium=cambium, cableLoss=cableLoss, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, configuration=configuration, vLANManagementPriority=vLANManagementPriority, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, supplementary=supplementary, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerTableIndex=sNTPServerTableIndex, daylightSaving=daylightSaving, resetGroup=resetGroup, iPVersion=iPVersion, ptmp=ptmp, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6PrefixLength=iPv6PrefixLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versionsGroup=versionsGroup, l2CPPriorityTable=l2CPPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, channelALineCode=channelALineCode, sMTPEnabledMessages=sMTPEnabledMessages, dfsTable=dfsTable, rangingMode=rangingMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveFreqKHz=receiveFreqKHz, userName=userName, txColorCode=txColorCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortDisabledWarning=managementPortDisabledWarning, dfsTableNumber=dfsTableNumber, remoteRxTargetPower=remoteRxTargetPower, phyStatus=phyStatus, sNMPTrapTable=sNMPTrapTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDControl=tDDControl, transmitModulationMode=transmitModulationMode, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitDataRate=transmitDataRate, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPSync=sNTPSync, snmpControl=snmpControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, dataPortStatusTrap=dataPortStatusTrap, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, rawReceivePower=rawReceivePower, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptp=ptp, dfsGroup=dfsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetPriorityTableIndex=ethernetPriorityTableIndex, smtp=smtp, vectorError=vectorError, notificationsGroup=notificationsGroup, sMTPServerPortNumber=sMTPServerPortNumber, bridgeGroup=bridgeGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, smtpGroup=smtpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, groupID=groupID, userTable=userTable, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsPeaks=dfsPeaks, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkLoss=linkLoss, sNTPPrimaryServer=sNTPPrimaryServer, userEnabled=userEnabled, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxColorCode=rxColorCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, dataPortStatus=dataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, incompatibleRegionCodes=incompatibleRegionCodes, channelChangeTrap=channelChangeTrap, sntpGroup=sntpGroup, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, dataPortFiberStatus=dataPortFiberStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortStatus=managementPortStatus, sNMPv3Enable=sNMPv3Enable, encryptionGroup=encryptionGroup, installStatus=installStatus, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControlGroup=snmpControlGroup, receiveModulationMode=receiveModulationMode, aAAControlGroup=aAAControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPollInterval=sNTPPollInterval, channelACableLength=channelACableLength, wirelessLinkAvailability=wirelessLinkAvailability, iPv6Address=iPv6Address)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLineCode=channelBLineCode, range=range, sNMPTrapVersion=sNMPTrapVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableIndex=dfsTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, softwareVersion=softwareVersion, sntp=sntp, vLANManagementVID=vLANManagementVID, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, configurationGroup=configurationGroup, channelBCableLength=channelBCableLength, regionCode=regionCode, telecomsChannelAStatus=telecomsChannelAStatus, syslogControl=syslogControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, subnetMask=subnetMask, sNTPServerRetries=sNTPServerRetries, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClient=syslogClient, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogStateTrap=syslogStateTrap, installStatusTrap=installStatusTrap, ethernet=ethernet, ptpTraps=ptpTraps, transmitFreqMHz=transmitFreqMHz, eIRP=eIRP, pubStats=pubStats, aggregateDataRate=aggregateDataRate, remoteInternetAddress=remoteInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogClientTrap=syslogClientTrap, sNTPServerTableNumber=sNTPServerTableNumber, remoteInternetAddressType=remoteInternetAddressType)
