...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLineCode=channelBLineCode, antennaGain=antennaGain, alarms=alarms, userRole=userRole, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, rawReceivePower=rawReceivePower, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomGroup=telecomGroup, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControl=syslogControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkSymmetry=linkSymmetry, receiveDataRate=receiveDataRate, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerInternetAddress=sNTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, syslogClientTrap=syslogClientTrap, bridgeGroup=bridgeGroup, longitude=longitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitModulationMode=transmitModulationMode, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, dataPortStatus=dataPortStatus, rxColorCode=rxColorCode, supplementaryGroup=supplementaryGroup, managementMode=managementMode, securityLevel=securityLevel, sNTPServerRetries=sNTPServerRetries, altitude=altitude, sntpGroup=sntpGroup, iPv4Address=iPv4Address, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, ethernet=ethernet, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, targetRange=targetRange, ptp=ptp, reset=reset, incompatibleRegionCodes=incompatibleRegionCodes, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, encryption=encryption, tDDControl=tDDControl, managementPortStatusTrap=managementPortStatusTrap, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth, searchState=searchState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rangingMode=rangingMode, notificationsGroup=notificationsGroup, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, ptmp=ptmp, snmpControl=snmpControl, ethernetPriorityTable=ethernetPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, userEnabled=userEnabled, licenceGroup=licenceGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, sNTPServerIPAddress=sNTPServerIPAddress, cambium=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, dfsPeaks=dfsPeaks, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, hAZLOCConfiguration=hAZLOCConfiguration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6Address=iPv6Address, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRate=transmitDataRate, iPDSCPPriorityTable=iPDSCPPriorityTable, smtpGroup=smtpGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, channelACableLength=channelACableLength, telecomsChannelSelection=telecomsChannelSelection, sNMPv3Enable=sNMPv3Enable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerStatus=sNTPServerStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, subnetMask=subnetMask, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTable=sNTPServerTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, ptp600=ptp600, iPVersion=iPVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddressType=remoteInternetAddressType, syslogControlGroup=syslogControlGroup, telecomsChannelAStatus=telecomsChannelAStatus, sMTPEnabledMessages=sMTPEnabledMessages, encryptionAlgorithm=encryptionAlgorithm, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, smtp=smtp, regionCode=regionCode, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqKHz=receiveFreqKHz, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, userPassword=userPassword, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, supplementary=supplementary, l2CPPriorityTable=l2CPPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsGroup=dfsGroup, management=management, versions=versions, transmitFreqKHz=transmitFreqKHz, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerInternetAddressType=sMTPServerInternetAddressType, accessMethod=accessMethod, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, channelALoopbackTrap=channelALoopbackTrap, latitude=latitude, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, dfsTable=dfsTable, channelALineCode=channelALineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, timeZone=timeZone, masterSlaveMode=masterSlaveMode, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableIndex=userTableIndex, syslogState=syslogState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPState=sNTPState, channelBCableLength=channelBCableLength, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, hardwareVersion=hardwareVersion, userName=userName, receivePower=receivePower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelALoopback=channelALoopback, txColorCode=txColorCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup, installStatusTrap=installStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, configuration=configuration, managementPortStatus=managementPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, regionCodeTrap=regionCodeTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dfs=dfs, sNTPSync=sNTPSync, secureModeAlarm=secureModeAlarm, sNTPServerTimeout=sNTPServerTimeout, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableEntry=sNTPServerTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, configurationGroup=configurationGroup, remoteRxTargetPower=remoteRxTargetPower, pubStats=pubStats, alarmsGroup=alarmsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortDisabledWarning=managementPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versionsGroup=versionsGroup, sNTPPollInterval=sNTPPollInterval, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, daylightSaving=daylightSaving, bridge=bridge, targetMACAddress=targetMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, automaticTxPowerControl=automaticTxPowerControl, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, licence=licence, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, channelBLoopback=channelBLoopback, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTableNumber=sNTPServerTableNumber, phyControl=phyControl, ethernetBridgingAvailability=ethernetBridgingAvailability, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapVersion=sNMPTrapVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productVariant=productVariant, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, telecomsInterface=telecomsInterface, dfsTableNumber=dfsTableNumber, transmitFreqMHz=transmitFreqMHz, userTable=userTable, linkModeOptimisation=linkModeOptimisation, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerPortNumber=sMTPServerPortNumber, ptpGroups=ptpGroups, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, eIRP=eIRP, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecom=telecom, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTraps=ptpTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, installStatus=installStatus, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatus=dataPortFiberStatus, sNTPServerPortNumber=sNTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, syslogStateTrap=syslogStateTrap, remoteIPAddress=remoteIPAddress, localPacketFiltering=localPacketFiltering, ethernetBridgingStatus=ethernetBridgingStatus, telecomsChannelBStatus=telecomsChannelBStatus)
