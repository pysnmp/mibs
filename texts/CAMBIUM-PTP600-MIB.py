...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapInternetAddress=sNMPTrapInternetAddress, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, phyControlGroup=phyControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, dfsGroup=dfsGroup, userRole=userRole, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetFiberSupport=ethernetFiberSupport, installArmState=installArmState, l2CPPriorityTable=l2CPPriorityTable, userName=userName, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetBridgingStatus=ethernetBridgingStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp600=ptp600, syslogControlGroup=syslogControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, timeZone=timeZone, channelALoopbackTrap=channelALoopbackTrap, rxColorCode=rxColorCode, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortStatus=dataPortStatus, userTableNumber=userTableNumber, regionCode=regionCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, userTable=userTable, configurationGroup=configurationGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptp=ptp, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBCableLength=channelBCableLength, supplementaryGroup=supplementaryGroup, resetGroup=resetGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPSync=sNTPSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, installStatus=installStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetBridgingAvailability=ethernetBridgingAvailability, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementMode=managementMode, secureModeAlarm=secureModeAlarm, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerTimeout=sNTPServerTimeout, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, sMTPEnabledMessages=sMTPEnabledMessages, iPVersion=iPVersion, sNTPServerStatus=sNTPServerStatus, userEnabled=userEnabled, frequencyVariant=frequencyVariant, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, systemClock=systemClock, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, cambium=cambium, channelALoopback=channelALoopback, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, dSCPManagementPriority=dSCPManagementPriority, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTable=sNTPServerTable, phyControl=phyControl, snmpControl=snmpControl, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelALineCode=channelALineCode, siteName=siteName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, reset=reset, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telecomGroup=telecomGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomsChannelBStatus=telecomsChannelBStatus, bridge=bridge, tDDControlGroup=tDDControlGroup, ethernetPriorityTable=ethernetPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, managementPortStatus=managementPortStatus, sntpGroup=sntpGroup, userTableIndex=userTableIndex, hTTPPortNumber=hTTPPortNumber, eIRP=eIRP, hAZLOCConfiguration=hAZLOCConfiguration, smtpGroup=smtpGroup, iPv6PrefixLength=iPv6PrefixLength, telnetPortNumber=telnetPortNumber, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, range=range, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteInternetAddressType=remoteInternetAddressType, dfs=dfs, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rangingMode=rangingMode, transmitChannel=transmitChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, ptpGroups=ptpGroups, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, sNTPPrimaryServer=sNTPPrimaryServer, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortFiberStatus=dataPortFiberStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, management=management, hTTPAccessEnabled=hTTPAccessEnabled, linkName=linkName, telecomsChannelSelection=telecomsChannelSelection, versions=versions, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkSymmetry=linkSymmetry, ptmp=ptmp, targetRange=targetRange, licenceGroup=licenceGroup, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryption=encryption, channelBLineCode=channelBLineCode, syslogState=syslogState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, transmitModulationMode=transmitModulationMode, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, systemReset=systemReset, qOSPriorityScheme=qOSPriorityScheme, bootVersion=bootVersion, byteErrorRatio=byteErrorRatio, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, altitude=altitude, syslogControl=syslogControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6Address=iPv6Address, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteInternetAddress=remoteInternetAddress, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, syslogClient=syslogClient, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsInterface=telecomsInterface, targetMACAddress=targetMACAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, securityLevel=securityLevel, rawReceivePower=rawReceivePower, receiveDataRate=receiveDataRate, latitude=latitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPState=sNTPState, regionCodeTrap=regionCodeTrap, encryptionGroup=encryptionGroup, sNTPServerIPAddress=sNTPServerIPAddress, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, channelBLoopback=channelBLoopback, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, localPacketFiltering=localPacketFiltering, iPv4Address=iPv4Address, groupID=groupID, secureModeAlarmTrap=secureModeAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, sNMPCommunityString=sNMPCommunityString, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPLastSync=sNTPLastSync, searchState=searchState, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntp=sntp, sNTPServerRetries=sNTPServerRetries, receiveModulationModeDetail=receiveModulationModeDetail, managementPortStatusTrap=managementPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableEntry=dfsTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDDControl=tDDControl, ethernetGroup=ethernetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licence=licence, channelACableLength=channelACableLength, transmitDataRate=transmitDataRate, ethernet=ethernet, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userPassword=userPassword, txColorCode=txColorCode, dataPortAutoMdix=dataPortAutoMdix, syslogClientTrap=syslogClientTrap, pubStats=pubStats, accessMethod=accessMethod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, supplementary=supplementary, bridgeGroup=bridgeGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteRxTargetPower=remoteRxTargetPower, dfsTable=dfsTable, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, daylightSaving=daylightSaving, wirelessLinkStatus=wirelessLinkStatus, transmitFreqKHz=transmitFreqKHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, automaticTxPowerControl=automaticTxPowerControl, sNTPSyncTrap=sNTPSyncTrap, telecom=telecom, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, aggregateDataRate=aggregateDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress)
