...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:13:19 2021
...
ModuleIdentity, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, enterprises, Unsigned32, Integer32, Counter64, IpAddress, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "enterprises", "Unsigned32", "Integer32", "Counter64", "IpAddress", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerIPAddress=sNTPServerIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, vLANManagementVID=vLANManagementVID, channelChangeTrap=channelChangeTrap, channelACableLength=channelACableLength, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableNumber=userTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userName=userName, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, dataPortStatus=dataPortStatus, userEnabled=userEnabled, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, frequencyVariant=frequencyVariant, remoteRxTargetPower=remoteRxTargetPower, encryptionAlgorithm=encryptionAlgorithm, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, longitude=longitude, tDDControlGroup=tDDControlGroup, ptpTraps=ptpTraps, productVariant=productVariant, hAZLOCConfiguration=hAZLOCConfiguration, managementPortStatusTrap=managementPortStatusTrap, transmitModulationMode=transmitModulationMode, regionCode=regionCode, sNTPSyncTrap=sNTPSyncTrap, configuration=configuration, ethernetPriorityTable=ethernetPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqKHz=receiveFreqKHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsChannelBStatus=telecomsChannelBStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelALoopbackTrap=channelALoopbackTrap, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, managementPortStatus=managementPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyControl=phyControl, maximumTransmitPower=maximumTransmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, dfs=dfs, hTTPAccessEnabled=hTTPAccessEnabled, versions=versions, iPv6Address=iPv6Address, iPv6PrefixLength=iPv6PrefixLength, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerRetries=sNTPServerRetries, dfsTable=dfsTable, telecomsChannelAStatus=telecomsChannelAStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddress=remoteInternetAddress, userRole=userRole, aAAControlGroup=aAAControlGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bridge=bridge, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installStatus=installStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernet=ethernet, accessMethod=accessMethod, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, telecomsChannelSelection=telecomsChannelSelection, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, snmpControlGroup=snmpControlGroup, dfsMeans=dfsMeans, installStatusTrap=installStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, transmitFreqKHz=transmitFreqKHz, vectorError=vectorError, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, aggregateDataRate=aggregateDataRate, iPv4Address=iPv4Address, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, subnetMask=subnetMask, installArmState=installArmState, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, encryptionGroup=encryptionGroup, sNMPPortNumber=sNMPPortNumber, localPacketFiltering=localPacketFiltering, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rawReceivePower=rawReceivePower, sNTPServerInternetAddress=sNTPServerInternetAddress, masterSlaveMode=masterSlaveMode, ethernetFiberSupport=ethernetFiberSupport, iPv6GatewayAddress=iPv6GatewayAddress, hTTPPortNumber=hTTPPortNumber, daylightSaving=daylightSaving, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, latitude=latitude, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, txColorCode=txColorCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, syslogState=syslogState, syslogStateTrap=syslogStateTrap, syslogControlGroup=syslogControlGroup, sNTPServerTable=sNTPServerTable, sNTPServerTableEntry=sNTPServerTableEntry, remoteInternetAddressType=remoteInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, resetGroup=resetGroup, searchState=searchState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, sNTPServerStatus=sNTPServerStatus, dfsPeaks=dfsPeaks, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementaryGroup=supplementaryGroup, systemClock=systemClock, wirelessLinkStatus=wirelessLinkStatus, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sntp=sntp, sNTPLastSync=sNTPLastSync, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, notificationsGroup=notificationsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementMode=managementMode, tDDControl=tDDControl, channelALineCode=channelALineCode, softwareVersion=softwareVersion, sNTPServerTableNumber=sNTPServerTableNumber, transmitChannel=transmitChannel, snmpControl=snmpControl, targetRange=targetRange, alarms=alarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetGroup=ethernetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, productName=productName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, range=range, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cambium=cambium, antennaGain=antennaGain, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, linkLoss=linkLoss, groupID=groupID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cableLoss=cableLoss, l2CPPriorityTable=l2CPPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, receiveDataRate=receiveDataRate, ethernetBridgingStatus=ethernetBridgingStatus, sNTPState=sNTPState, ptmp=ptmp, gatewayIPAddress=gatewayIPAddress, secureModeAlarm=secureModeAlarm, ptpTrapPrefix=ptpTrapPrefix, smtp=smtp, sNTPPrimaryServer=sNTPPrimaryServer, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, userPassword=userPassword, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelBLineCode=channelBLineCode, altitude=altitude, versionsGroup=versionsGroup, managementPortDisabledWarning=managementPortDisabledWarning, hardwareVersion=hardwareVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regionCodeTrap=regionCodeTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bootVersion=bootVersion, receivePower=receivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodes=incompatibleRegionCodes, dSCPManagementPriority=dSCPManagementPriority, pubStatsGroup=pubStatsGroup, syslogClient=syslogClient, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, targetMACAddress=targetMACAddress, secondarySoftwareVersion=secondarySoftwareVersion, bridgeGroup=bridgeGroup, alarmsGroup=alarmsGroup, ptp=ptp, channelBCableLength=channelBCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, PYSNMP_MODULE_ID=cambium, licence=licence, channelALoopback=channelALoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetPortNumber=telnetPortNumber, telecom=telecom, timeZone=timeZone)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, reset=reset, ptp600=ptp600, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, eIRP=eIRP, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, phyStatus=phyStatus, hTTPSPortNumber=hTTPSPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTable=sNMPTrapTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangingMode=rangingMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarning=dataPortDisabledWarning, pubStats=pubStats, rxColorCode=rxColorCode, dataPortFiberStatus=dataPortFiberStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPv3Enable=sNMPv3Enable, channelBLoopback=channelBLoopback, sNTPServerTimeout=sNTPServerTimeout, managementGroup=managementGroup, dfsGroup=dfsGroup, byteErrorRatio=byteErrorRatio, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sntpGroup=sntpGroup, bandwidthVariant=bandwidthVariant, systemReset=systemReset, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogControl=syslogControl, linkSymmetry=linkSymmetry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, management=management, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, automaticTxPowerControl=automaticTxPowerControl, dfsTableNumber=dfsTableNumber, siteName=siteName, securityLevel=securityLevel)
