...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:56:30 2022
...
Unsigned32, iso, TimeTicks, IpAddress, Gauge32, MibIdentifier, Integer32, ModuleIdentity, Bits, Counter32, enterprises, Counter64, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "TimeTicks", "IpAddress", "Gauge32", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "Counter32", "enterprises", "Counter64", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitPower=transmitPower, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rangingMode=rangingMode, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTable=sNTPServerTable, sMTPServerIPAddress=sMTPServerIPAddress, userRole=userRole, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmsGroup=alarmsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv6GatewayAddress=iPv6GatewayAddress, sNTPPrimaryServer=sNTPPrimaryServer, systemClock=systemClock, byteErrorRatio=byteErrorRatio, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, remoteIPAddress=remoteIPAddress, managementPortStatus=managementPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, versionsGroup=versionsGroup, syslogControl=syslogControl, targetRange=targetRange, dataPortDisabledWarning=dataPortDisabledWarning, searchState=searchState, bridgeGroup=bridgeGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, syslogState=syslogState, licence=licence, signalStrengthRatio=signalStrengthRatio, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsPeaks=dfsPeaks, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, ethernet=ethernet, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, linkLoss=linkLoss, txColorCode=txColorCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecom=telecom, syslogClientTrap=syslogClientTrap, transmitModulationMode=transmitModulationMode, ptp600=ptp600, sNMPTrapVersion=sNMPTrapVersion, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, l2CPPriorityTable=l2CPPriorityTable, sNTPServerIPAddress=sNTPServerIPAddress, userPassword=userPassword, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelAStatus=telecomsChannelAStatus, smtp=smtp, softwareVersion=softwareVersion, altitude=altitude, alarms=alarms, snmpControl=snmpControl, telecomsChannelBStatus=telecomsChannelBStatus, userEnabled=userEnabled, aAAControlGroup=aAAControlGroup, sntp=sntp, hAZLOCConfiguration=hAZLOCConfiguration, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, sNTPSync=sNTPSync, iPv6PrefixLength=iPv6PrefixLength, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, masterSlaveMode=masterSlaveMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, longitude=longitude, sNMPCommunityString=sNMPCommunityString, managementPortStatusTrap=managementPortStatusTrap, dfsMeans=dfsMeans, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetGroup=ethernetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementMode=managementMode, bridge=bridge, configuration=configuration, ptpCompliance=ptpCompliance, syslogControlGroup=syslogControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, syslogClient=syslogClient, channelChangeTrap=channelChangeTrap, syslogStateTrap=syslogStateTrap, userName=userName, sMTPEmailAlert=sMTPEmailAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptmp=ptmp, sNMPTrapPortNumber=sNMPTrapPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, userTableNumber=userTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, dfsTable=dfsTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableLoss=cableLoss, sNTPSyncTrap=sNTPSyncTrap, channelALineCode=channelALineCode, transmitDataRate=transmitDataRate, rawReceivePower=rawReceivePower, ethernetPriorityTable=ethernetPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, secureModeAlarm=secureModeAlarm, vLANManagementVID=vLANManagementVID, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sntpGroup=sntpGroup, remoteInternetAddress=remoteInternetAddress, installArmStateTrap=installArmStateTrap, dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, securityLevel=securityLevel, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, subnetMask=subnetMask, regionCode=regionCode, sNTPServerPortNumber=sNTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, systemReset=systemReset, regionCodeTrap=regionCodeTrap, dataPortFiberStatus=dataPortFiberStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, groupID=groupID, maximumTransmitPower=maximumTransmitPower, bootVersion=bootVersion, receivePower=receivePower, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, aAAControl=aAAControl, channelBLoopbackTrap=channelBLoopbackTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, latitude=latitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp=ptp, pubStats=pubStats, dfsTableEntry=dfsTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, dataPortStatus=dataPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTableEntry=userTableEntry, channelBLoopback=channelBLoopback, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, ptpTrapPrefix=ptpTrapPrefix, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telnetPortNumber=telnetPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDControl=tDDControl, userTable=userTable, sNTPServerRetries=sNTPServerRetries, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, ptpTraps=ptpTraps, userTableIndex=userTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hardwareVersion=hardwareVersion, linkSymmetry=linkSymmetry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsGroup=dfsGroup, managementGroup=managementGroup, encryptionGroup=encryptionGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, antennaGain=antennaGain, sNMPPortNumber=sNMPPortNumber, installArmState=installArmState, channelACableLength=channelACableLength, localPacketFiltering=localPacketFiltering, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, rxColorCode=rxColorCode, sNTPLastSync=sNTPLastSync, iPv4Address=iPv4Address, installStatusTrap=installStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, phyControlGroup=phyControlGroup, productVariant=productVariant, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, automaticTxPowerControl=automaticTxPowerControl, telecomsChannelSelection=telecomsChannelSelection, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveChannel=receiveChannel, versions=versions, targetMACAddress=targetMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingAvailability=ethernetBridgingAvailability, sMTPEnabledMessages=sMTPEnabledMessages, supplementary=supplementary, channelBCableLength=channelBCableLength, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, channelALoopbackTrap=channelALoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTableNumber=sNTPServerTableNumber, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vectorError=vectorError, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, iPv6Address=iPv6Address, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelALoopback=channelALoopback, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANManagementPriority=vLANManagementPriority, remoteRxTargetPower=remoteRxTargetPower, receiveFreqMHz=receiveFreqMHz, sNTPServerTableIndex=sNTPServerTableIndex, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBLineCode=channelBLineCode, management=management, eIRP=eIRP, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, smtpGroup=smtpGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, phyControl=phyControl, configurationGroup=configurationGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryption=encryption, sNMPTrapTable=sNMPTrapTable, range=range, phyStatus=phyStatus, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, reset=reset, ptpGroups=ptpGroups, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitChannel=transmitChannel, sNTPServerTableEntry=sNTPServerTableEntry, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
