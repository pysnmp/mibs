...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationMode=tDDSynchronizationMode, ptpTraps=ptpTraps, mPLSTCPriorityTable=mPLSTCPriorityTable, licenceGroup=licenceGroup, telnetAccessEnabled=telnetAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup, l2CPPriorityTable=l2CPPriorityTable, configuration=configuration, signalStrengthRatio=signalStrengthRatio, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, longitude=longitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableEntry=userTableEntry, sNTPServerStatus=sNTPServerStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, remoteInternetAddress=remoteInternetAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteRxTargetPower=remoteRxTargetPower, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, ptmp=ptmp, iPv4Address=iPv4Address, receiveModulationMode=receiveModulationMode, telecomsChannelAStatus=telecomsChannelAStatus, versionsGroup=versionsGroup, range=range, managementPortStatusTrap=managementPortStatusTrap, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelSelection=telecomsChannelSelection, managementPortStatus=managementPortStatus, channelALoopbackTrap=channelALoopbackTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControlGroup=snmpControlGroup, remoteInternetAddressType=remoteInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, channelBLoopbackTrap=channelBLoopbackTrap, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomGroup=telecomGroup, ptpTrapPrefix=ptpTrapPrefix, tDDControlGroup=tDDControlGroup, dfsTableNumber=dfsTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, ethernetBridgingStatus=ethernetBridgingStatus, aAAControlGroup=aAAControlGroup, sNTPState=sNTPState, vLANManagementVID=vLANManagementVID, dfsGroup=dfsGroup, iPv6PrefixLength=iPv6PrefixLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveChannel=receiveChannel, alarms=alarms, productName=productName, alarmsGroup=alarmsGroup, vectorError=vectorError, sNTPLastSync=sNTPLastSync, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, management=management, maximumTransmitPower=maximumTransmitPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTableEntry=dfsTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, tDDControl=tDDControl, subnetMask=subnetMask, bootVersion=bootVersion, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, phyStatusGroup=phyStatusGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerPortNumber=sNTPServerPortNumber, reset=reset, managementPortDisabledWarning=managementPortDisabledWarning, userPassword=userPassword, syslogState=syslogState, channelACableLength=channelACableLength, tFTPServerInternetAddressType=tFTPServerInternetAddressType, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, channelBLineCode=channelBLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPrimaryServer=sNTPPrimaryServer, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionAlgorithm=encryptionAlgorithm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteIPAddress=remoteIPAddress, smtp=smtp, secureModeAlarm=secureModeAlarm, sNTPServerTable=sNTPServerTable, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetPriorityTable=ethernetPriorityTable, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, targetRange=targetRange, installArmState=installArmState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, altitude=altitude, snmpControl=snmpControl, bridgeGroup=bridgeGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, rxColorCode=rxColorCode, ptp600=ptp600, sntp=sntp, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, bandwidthVariant=bandwidthVariant, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEnabledMessages=sMTPEnabledMessages, rawReceivePower=rawReceivePower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hardwareVersion=hardwareVersion, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, accessMethod=accessMethod, telecomsInterface=telecomsInterface, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelBLoopback=channelBLoopback, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dSCPManagementPriority=dSCPManagementPriority, dataPortAutoMdix=dataPortAutoMdix, targetMACAddress=targetMACAddress, channelALoopback=channelALoopback, userTableNumber=userTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementGroup=managementGroup, resetGroup=resetGroup, notificationsGroup=notificationsGroup, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, installStatus=installStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, userTable=userTable, softwareVersion=softwareVersion, licence=licence, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, automaticTxPowerControl=automaticTxPowerControl, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelALineCode=channelALineCode, encryption=encryption, syslogControl=syslogControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityTableNumber=l2CPPriorityTableNumber, latitude=latitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortStatus=dataPortStatus, iPv6Address=iPv6Address, sNTPServerRetries=sNTPServerRetries, txColorCode=txColorCode, regionCodeTrap=regionCodeTrap, ptp=ptp, systemReset=systemReset, timeZone=timeZone, managementMode=managementMode, phyControlGroup=phyControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelBCableLength=channelBCableLength, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, syslogClient=syslogClient, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6GatewayAddress=iPv6GatewayAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, securityLevel=securityLevel, dfs=dfs, sNTPServerTableNumber=sNTPServerTableNumber, telecom=telecom, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, receiveFreqMHz=receiveFreqMHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkLoss=linkLoss, channelChangeTrap=channelChangeTrap, aAAControl=aAAControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, iPVersion=iPVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortFiberStatus=dataPortFiberStatus, regionCode=regionCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vLANManagementPriority=vLANManagementPriority, transmitModulationMode=transmitModulationMode, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, rangingMode=rangingMode, ethernet=ethernet, groupID=groupID, userRole=userRole, dfsTable=dfsTable, receivePower=receivePower, dfsPeaks=dfsPeaks, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, userName=userName, encryptionGroup=encryptionGroup, localPacketFiltering=localPacketFiltering, installStatusTrap=installStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ethernetFiberSupport=ethernetFiberSupport, cambium=cambium, pubStats=pubStats, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, eIRP=eIRP, searchState=searchState, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
