...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatus=ethernetBridgingStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, management=management, latitude=latitude, transmitChannel=transmitChannel, dataPortStatus=dataPortStatus, receiveFreqMHz=receiveFreqMHz, range=range, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, iPv6Address=iPv6Address, sNTPSyncTrap=sNTPSyncTrap, dataPortFiberStatus=dataPortFiberStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, targetRange=targetRange, dfsTableNumber=dfsTableNumber, channelBCableLength=channelBCableLength, ptmp=ptmp, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, telecomsInterface=telecomsInterface, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatus=managementPortStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, cambium=cambium, accessMethod=accessMethod, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, receiveModulationMode=receiveModulationMode, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsPeaks=dfsPeaks, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTraps=ptpTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, phyControlGroup=phyControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControlGroup=aAAControlGroup, configurationGroup=configurationGroup, qOSPriorityScheme=qOSPriorityScheme, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALoopbackTrap=channelALoopbackTrap, sNTPState=sNTPState, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, syslogClientTrap=syslogClientTrap, longitude=longitude, syslogControl=syslogControl, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, phyStatus=phyStatus, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sntp=sntp, maximumTransmitPower=maximumTransmitPower, channelALineCode=channelALineCode, ethernetFiberSupport=ethernetFiberSupport, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receivePower=receivePower, telecom=telecom, sNTPServerIPAddress=sNTPServerIPAddress, supplementary=supplementary, snmpControlGroup=snmpControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, hAZLOCConfiguration=hAZLOCConfiguration, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, encryptionGroup=encryptionGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelChangeTrap=channelChangeTrap, dfsGroup=dfsGroup, smtp=smtp, regionCode=regionCode, notificationsGroup=notificationsGroup, telecomsChannelSelection=telecomsChannelSelection, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveDataRate=receiveDataRate, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitModulationMode=transmitModulationMode, searchState=searchState, groupID=groupID, channelBLineCode=channelBLineCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTable=sNTPServerTable, rawReceivePower=rawReceivePower, tDDControl=tDDControl, ptpCompliance=ptpCompliance, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelBStatus=telecomsChannelBStatus, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortAutoMdix=dataPortAutoMdix, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, channelBandwidth=channelBandwidth, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSPortNumber=hTTPSPortNumber, eIRP=eIRP, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelACableLength=channelACableLength, userTableEntry=userTableEntry, sNTPSync=sNTPSync, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, sNTPPrimaryServer=sNTPPrimaryServer, syslogState=syslogState, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBLoopback=channelBLoopback, sNTPPollInterval=sNTPPollInterval, dfs=dfs, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, masterSlaveMode=masterSlaveMode, bridge=bridge, alarms=alarms, ethernetGroup=ethernetGroup, managementMode=managementMode, aAAControl=aAAControl, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, telecomsChannelAStatus=telecomsChannelAStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userEnabled=userEnabled, transmitDataRate=transmitDataRate, secureModeAlarm=secureModeAlarm, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxColorCode=rxColorCode, managementPortStatusTrap=managementPortStatusTrap, linkSymmetry=linkSymmetry, localPacketFiltering=localPacketFiltering, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaGain=antennaGain, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, securityLevel=securityLevel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userTableNumber=userTableNumber, iPVersion=iPVersion, l2CPPriorityTable=l2CPPriorityTable, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerTableNumber=sNTPServerTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, userName=userName, regionCodeTrap=regionCodeTrap, transmitFreqMHz=transmitFreqMHz, channelALoopback=channelALoopback, sNTPServerStatus=sNTPServerStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsTable=dfsTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTable=userTable, channelBLoopbackTrap=channelBLoopbackTrap, userTableIndex=userTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, automaticTxPowerControl=automaticTxPowerControl, syslogStateTrap=syslogStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, remoteRxTargetPower=remoteRxTargetPower, wirelessLinkStatus=wirelessLinkStatus, txColorCode=txColorCode, targetMACAddress=targetMACAddress, transmitPower=transmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, configuration=configuration, ptp600=ptp600, userRole=userRole, bridgeGroup=bridgeGroup, sNTPServerTimeout=sNTPServerTimeout, syslogClient=syslogClient, rangingMode=rangingMode, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteInternetAddress=remoteInternetAddress, vLANManagementVID=vLANManagementVID, encryption=encryption, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, hardwareVersion=hardwareVersion, syslogControlGroup=syslogControlGroup, snmpControl=snmpControl, siteName=siteName, installArmState=installArmState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, supplementaryGroup=supplementaryGroup, phyControl=phyControl, licence=licence, licenceGroup=licenceGroup, resetGroup=resetGroup, dfsTableEntry=dfsTableEntry, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, subnetMask=subnetMask, telecomGroup=telecomGroup, sNTPServerTableEntry=sNTPServerTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, systemReset=systemReset, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatus=installStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv4Address=iPv4Address, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANManagementPriority=vLANManagementPriority)
