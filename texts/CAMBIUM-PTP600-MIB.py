...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, timeZone=timeZone, userEnabled=userEnabled, licenceGroup=licenceGroup, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, management=management, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, smtp=smtp, hAZLOCConfiguration=hAZLOCConfiguration, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sntp=sntp, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, managementPortConfigurationMismatch=managementPortConfigurationMismatch, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkSymmetry=linkSymmetry, managementGroup=managementGroup, phyControl=phyControl, qOSPriorityScheme=qOSPriorityScheme, securityLevel=securityLevel, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, phyControlGroup=phyControlGroup, hTTPSPortNumber=hTTPSPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, tDDControl=tDDControl, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, sNTPServerStatus=sNTPServerStatus, userName=userName, searchState=searchState, ptpTraps=ptpTraps, telecomsInterface=telecomsInterface, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBCableLength=channelBCableLength, alarms=alarms, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkLoss=linkLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, snmpControlGroup=snmpControlGroup, rawReceivePower=rawReceivePower, altitude=altitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, bridge=bridge, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, dfsMeans=dfsMeans, rangingMode=rangingMode, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpCompliance=ptpCompliance, configuration=configuration, PYSNMP_MODULE_ID=cambium, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetFiberSupport=ethernetFiberSupport, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteRxTargetPower=remoteRxTargetPower, sNTPState=sNTPState, ptmp=ptmp, productVariant=productVariant, subnetMask=subnetMask, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, groupID=groupID, userTableIndex=userTableIndex, syslogState=syslogState, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, masterSlaveMode=masterSlaveMode, userTable=userTable, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vLANManagementVID=vLANManagementVID, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, cambium=cambium, range=range, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, managementMode=managementMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp600=ptp600, siteName=siteName, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, latitude=latitude, hardwareVersion=hardwareVersion, ptp=ptp, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receiveFreqMHz=receiveFreqMHz, softwareVersion=softwareVersion, bootVersion=bootVersion, telecomsChannelSelection=telecomsChannelSelection, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortFiberStatus=dataPortFiberStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, systemClock=systemClock, byteErrorRatio=byteErrorRatio, longitude=longitude, channelBLoopbackTrap=channelBLoopbackTrap, encryption=encryption, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dSCPManagementPriority=dSCPManagementPriority, iPVersion=iPVersion, managementPortStatus=managementPortStatus, smtpGroup=smtpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, targetRange=targetRange, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aAAControlGroup=aAAControlGroup, sNMPTrapTable=sNMPTrapTable, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, maximumTransmitPower=maximumTransmitPower, regionCodeTrap=regionCodeTrap, alarmsGroup=alarmsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernet=ethernet, wirelessLinkStatus=wirelessLinkStatus, dfsPeaks=dfsPeaks, rxColorCode=rxColorCode, sNTPServerTableEntry=sNTPServerTableEntry, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatus=phyStatus, channelALineCode=channelALineCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, channelBLineCode=channelBLineCode, frequencyVariant=frequencyVariant, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, transmitChannel=transmitChannel, sNTPServerTable=sNTPServerTable, eIRP=eIRP, ethernetBridgingStatus=ethernetBridgingStatus, resetGroup=resetGroup, remoteInternetAddress=remoteInternetAddress, dataPortStatusTrap=dataPortStatusTrap, iPv4Address=iPv4Address, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, versionsGroup=versionsGroup, linkName=linkName, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveChannel=receiveChannel, sNTPServerRetries=sNTPServerRetries, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, userTableNumber=userTableNumber, transmitPower=transmitPower, sNTPServerTableNumber=sNTPServerTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelALoopbackTrap=channelALoopbackTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelACableLength=channelACableLength, channelALoopback=channelALoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableIndex=dfsTableIndex, licence=licence, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityString=sNMPCommunityString, accessMethod=accessMethod, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBLoopback=channelBLoopback, installStatusTrap=installStatusTrap, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, txColorCode=txColorCode, syslogClient=syslogClient, productName=productName, tDDSynchronizationMode=tDDSynchronizationMode, iPv6PrefixLength=iPv6PrefixLength, bridgeGroup=bridgeGroup, vectorError=vectorError, linkModeOptimisation=linkModeOptimisation, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, snmpControl=snmpControl, configurationGroup=configurationGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelBStatus=telecomsChannelBStatus, constantPowerSpectralDensity=constantPowerSpectralDensity)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", signalStrengthRatio=signalStrengthRatio, installArmStateTrap=installArmStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTimeout=sNTPServerTimeout, gatewayIPAddress=gatewayIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, pubStatsGroup=pubStatsGroup, channelChangeTrap=channelChangeTrap, regionCode=regionCode, notificationsGroup=notificationsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, ethernetPriorityTable=ethernetPriorityTable, syslogClientTrap=syslogClientTrap, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, remoteIPAddress=remoteIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableNumber=dfsTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secureModeAlarm=secureModeAlarm, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitDataRate=transmitDataRate, sNTPPrimaryServer=sNTPPrimaryServer, telecomGroup=telecomGroup, localPacketFiltering=localPacketFiltering, userRole=userRole, telecom=telecom, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secondarySoftwareVersion=secondarySoftwareVersion, reset=reset, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogStateTrap=syslogStateTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibration=unitOutOfCalibration)
