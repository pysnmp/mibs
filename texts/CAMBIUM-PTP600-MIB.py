...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptpGroups=ptpGroups, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, licenceGroup=licenceGroup, vectorError=vectorError, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hAZLOCConfiguration=hAZLOCConfiguration, automaticTxPowerControl=automaticTxPowerControl, remoteInternetAddressType=remoteInternetAddressType, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelAStatus=telecomsChannelAStatus, secureModeAlarm=secureModeAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, bootVersion=bootVersion, transmitFreqKHz=transmitFreqKHz, sntp=sntp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkLoss=linkLoss, hardwareVersion=hardwareVersion, dfsPeaks=dfsPeaks, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bandwidthVariant=bandwidthVariant, alarms=alarms, transmitPower=transmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, targetMACAddress=targetMACAddress, configuration=configuration, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTimeout=sNTPServerTimeout, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogControlGroup=syslogControlGroup, targetRange=targetRange, txColorCode=txColorCode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, frequencyVariant=frequencyVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, dfsMeans=dfsMeans, sNTPPollInterval=sNTPPollInterval, userTableNumber=userTableNumber, userTableEntry=userTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, securityLevel=securityLevel, encryptionGroup=encryptionGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, groupID=groupID, ptpTraps=ptpTraps, rxColorCode=rxColorCode, ethernetFiberSupport=ethernetFiberSupport, channelBLoopbackTrap=channelBLoopbackTrap, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEmailAlert=sMTPEmailAlert, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, alarmsGroup=alarmsGroup, altitude=altitude, receiveChannel=receiveChannel, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp600=ptp600, rawReceivePower=rawReceivePower, gatewayIPAddress=gatewayIPAddress, transmitFreqMHz=transmitFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, resetGroup=resetGroup, maximumTransmitPower=maximumTransmitPower, telecomsInterface=telecomsInterface, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, regionCodeTrap=regionCodeTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, aAAControlGroup=aAAControlGroup, productName=productName, dfsTableEntry=dfsTableEntry, linkName=linkName, siteName=siteName, cableLoss=cableLoss, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tDDControlGroup=tDDControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALoopbackTrap=channelALoopbackTrap, transmitDataRate=transmitDataRate, secureModeAlarmTrap=secureModeAlarmTrap, snmpControlGroup=snmpControlGroup, dfsGroup=dfsGroup, wirelessLinkAvailability=wirelessLinkAvailability, configurationGroup=configurationGroup, subnetMask=subnetMask, ethernetGroup=ethernetGroup, dfsTableIndex=dfsTableIndex, installStatus=installStatus, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, telecomsChannelBStatus=telecomsChannelBStatus, l2CPPriorityTable=l2CPPriorityTable, managementPortDisabledWarning=managementPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, aAAControl=aAAControl, dfsTable=dfsTable, bridgeGroup=bridgeGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableIndex=l2CPPriorityTableIndex, installArmState=installArmState, searchState=searchState, managementPortStatusTrap=managementPortStatusTrap, eIRP=eIRP, linkSymmetry=linkSymmetry, sNMPv3Enable=sNMPv3Enable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, daylightSaving=daylightSaving, receivePower=receivePower, iPv6Address=iPv6Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelSelection=telecomsChannelSelection, vLANManagementPriority=vLANManagementPriority, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfs=dfs, dataPortFiberStatus=dataPortFiberStatus, channelBLineCode=channelBLineCode, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, range=range, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegionCodes=incompatibleRegionCodes, sMTPSourceEmailAddress=sMTPSourceEmailAddress, accessMethod=accessMethod, channelACableLength=channelACableLength, channelALoopback=channelALoopback, sNMPTrapTableIndex=sNMPTrapTableIndex, userName=userName, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSync=sNTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, masterSlaveMode=masterSlaveMode, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, bridge=bridge, remoteIPAddress=remoteIPAddress, pubStats=pubStats, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementGroup=managementGroup, transmitChannel=transmitChannel, versions=versions, PYSNMP_MODULE_ID=cambium, phyControl=phyControl, syslogControl=syslogControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortStatus=managementPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, userEnabled=userEnabled, userRole=userRole, hTTPPortNumber=hTTPPortNumber, systemReset=systemReset, dataPortStatus=dataPortStatus, tDDControl=tDDControl, syslogClientTrap=syslogClientTrap, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelBCableLength=channelBCableLength, rangingMode=rangingMode, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTable=sNTPServerTable, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, iPv6PrefixLength=iPv6PrefixLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationMode=tDDSynchronizationMode, dataPortDisabledWarning=dataPortDisabledWarning, userTable=userTable, channelBLoopback=channelBLoopback, telecom=telecom, installStatusTrap=installStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6GatewayAddress=iPv6GatewayAddress, pubStatsGroup=pubStatsGroup, regionCode=regionCode, telnetAccessEnabled=telnetAccessEnabled, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, ptmp=ptmp)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, channelChangeTrap=channelChangeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, softwareVersion=softwareVersion, supplementary=supplementary, iPv4Address=iPv4Address, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, sNTPServerRetries=sNTPServerRetries, encryption=encryption, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, licence=licence, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortAutoMdix=dataPortAutoMdix, byteErrorRatio=byteErrorRatio, ptpCompliance=ptpCompliance, sNTPServerStatus=sNTPServerStatus, tFTPServerIPAddress=tFTPServerIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, sNMPPortNumber=sNMPPortNumber, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerPortNumber=sMTPServerPortNumber, iPVersion=iPVersion, channelALineCode=channelALineCode, cambium=cambium, ptp=ptp, ethernet=ethernet, reset=reset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userPassword=userPassword)
