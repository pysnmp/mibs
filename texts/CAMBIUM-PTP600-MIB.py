...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerStatus=sNTPServerStatus, ethernetFiberSupport=ethernetFiberSupport, automaticTxPowerControl=automaticTxPowerControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridgeGroup=bridgeGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteIPAddress=remoteIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddress=sMTPServerInternetAddress, hardwareVersion=hardwareVersion, productName=productName, ptmp=ptmp, PYSNMP_MODULE_ID=cambium, bandwidthVariant=bandwidthVariant, remoteInternetAddressType=remoteInternetAddressType, dfsPeaks=dfsPeaks, iPv6GatewayAddress=iPv6GatewayAddress, vLANManagementVID=vLANManagementVID, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, receiveDataRate=receiveDataRate, linkLoss=linkLoss, smtp=smtp, sntpGroup=sntpGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, latitude=latitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, installStatus=installStatus, vectorError=vectorError, sNTPServerTimeout=sNTPServerTimeout, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitFreqKHz=transmitFreqKHz, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfs=dfs, ptp600=ptp600, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveChannel=receiveChannel, ptp=ptp, byteErrorRatio=byteErrorRatio, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessLinkStatus=wirelessLinkStatus, dfsTable=dfsTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTable=l2CPPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, hTTPSAccessEnabled=hTTPSAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, signalStrengthRatio=signalStrengthRatio, searchState=searchState, ethernetBridgingStatus=ethernetBridgingStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, pubStatsGroup=pubStatsGroup, iPVersion=iPVersion, notificationsGroup=notificationsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControl=phyControl, dfsTableIndex=dfsTableIndex, receivePower=receivePower, timeZone=timeZone, softwareVersion=softwareVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTableIndex=sNTPServerTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, reset=reset, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, antennaGain=antennaGain, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, configurationGroup=configurationGroup, aAAControlGroup=aAAControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, ethernet=ethernet, telecom=telecom, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpGroups=ptpGroups, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, receiveFreqKHz=receiveFreqKHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, userRole=userRole, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, versionsGroup=versionsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, telecomGroup=telecomGroup, sNTPServerTableEntry=sNTPServerTableEntry, channelBLoopback=channelBLoopback, encryptionGroup=encryptionGroup, channelALoopback=channelALoopback, sNMPEnabledTraps=sNMPEnabledTraps, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPPortNumber=sNMPPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelBStatus=telecomsChannelBStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bootVersion=bootVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsTableNumber=dfsTableNumber, ethernetPriorityTable=ethernetPriorityTable, securityLevel=securityLevel, remoteRxTargetPower=remoteRxTargetPower, receiveFreqMHz=receiveFreqMHz, remoteInternetAddress=remoteInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryption=encryption, telnetPortNumber=telnetPortNumber, systemClock=systemClock, linkName=linkName, configuration=configuration, targetRange=targetRange, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitChannel=transmitChannel, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, bridge=bridge, dfsGroup=dfsGroup, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hAZLOCConfiguration=hAZLOCConfiguration, alarms=alarms, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, syslogControl=syslogControl, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTraps=ptpTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, phyControlGroup=phyControlGroup, userEnabled=userEnabled, rawReceivePower=rawReceivePower, dSCPManagementPriority=dSCPManagementPriority, supplementaryGroup=supplementaryGroup, regionCode=regionCode, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, cableLoss=cableLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementMode=managementMode, channelBLoopbackTrap=channelBLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSPortNumber=hTTPSPortNumber, phyStatusGroup=phyStatusGroup, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxColorCode=rxColorCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogStateTrap=syslogStateTrap, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, resetGroup=resetGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, syslogClientTrap=syslogClientTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelACableLength=channelACableLength, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, channelALoopbackTrap=channelALoopbackTrap, tDDControlGroup=tDDControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitFreqMHz=transmitFreqMHz, managementGroup=managementGroup, longitude=longitude, userName=userName, installArmStateTrap=installArmStateTrap, altitude=altitude, linkModeOptimisation=linkModeOptimisation, ethernetBridgingAvailability=ethernetBridgingAvailability, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemReset=systemReset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, siteName=siteName, sNTPServerRetries=sNTPServerRetries, telecomsChannelSelection=telecomsChannelSelection, iPv4Address=iPv4Address, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationMode=tDDSynchronizationMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetGroup=ethernetGroup, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBLineCode=channelBLineCode, txColorCode=txColorCode, sNMPv3Enable=sNMPv3Enable, aAAControl=aAAControl, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, managementPortStatus=managementPortStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCodeTrap=regionCodeTrap, eIRP=eIRP, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPLastSync=sNTPLastSync, localPacketFiltering=localPacketFiltering, management=management, groupID=groupID, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleRegionCodes=incompatibleRegionCodes, productVariant=productVariant, tDDControl=tDDControl, userPassword=userPassword, maximumTransmitPower=maximumTransmitPower, telecomsChannelAStatus=telecomsChannelAStatus, frequencyVariant=frequencyVariant, dataPortStatus=dataPortStatus, dfsTableEntry=dfsTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, userTable=userTable, installStatusTrap=installStatusTrap, cambium=cambium, licenceGroup=licenceGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBandwidth=channelBandwidth, sntp=sntp, dfsMeans=dfsMeans, rangingMode=rangingMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelALineCode=channelALineCode, managementPortDisabledWarning=managementPortDisabledWarning, channelBCableLength=channelBCableLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licence=licence, supplementary=supplementary, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableIndex=userTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType)
