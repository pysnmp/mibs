...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, sntpGroup=sntpGroup, secureModeAlarm=secureModeAlarm, userTableEntry=userTableEntry, antennaGain=antennaGain, bandwidthVariant=bandwidthVariant, transmitPower=transmitPower, sNMPv3Enable=sNMPv3Enable, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapVersion=sNMPTrapVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, supplementary=supplementary, channelACableLength=channelACableLength, tFTPServerIPAddress=tFTPServerIPAddress, installArmState=installArmState, syslogStateTrap=syslogStateTrap, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPPortNumber=hTTPPortNumber, userTable=userTable, userPassword=userPassword, ptmp=ptmp, managementPortDisabledWarning=managementPortDisabledWarning, configuration=configuration, cableLoss=cableLoss, channelBLoopbackTrap=channelBLoopbackTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveModulationMode=receiveModulationMode, userName=userName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, signalStrengthRatio=signalStrengthRatio, cambium=cambium, linkLoss=linkLoss, sNTPServerTableEntry=sNTPServerTableEntry, txColorCode=txColorCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, sntp=sntp, dfsPeaks=dfsPeaks, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpGroups=ptpGroups, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, transmitModulationMode=transmitModulationMode, sNTPServerStatus=sNTPServerStatus, pubStatsGroup=pubStatsGroup, ptp=ptp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, bridge=bridge, phyControlGroup=phyControlGroup, snmpControlGroup=snmpControlGroup, range=range, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, frequencyVariant=frequencyVariant, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkSymmetry=linkSymmetry, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkModeOptimisation=linkModeOptimisation, channelBLoopback=channelBLoopback, iPv6Address=iPv6Address, bridgeGroup=bridgeGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveChannel=receiveChannel, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, aAAControlGroup=aAAControlGroup, dataPortFiberStatus=dataPortFiberStatus, dfsTable=dfsTable, licence=licence, channelALineCode=channelALineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPSync=sNTPSync, qOSPriorityScheme=qOSPriorityScheme, telecomsInterface=telecomsInterface, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userEnabled=userEnabled, syslogControl=syslogControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALoopback=channelALoopback, hardwareVersion=hardwareVersion, ptp600=ptp600, alarmsGroup=alarmsGroup, dSCPManagementPriority=dSCPManagementPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aggregateDataRate=aggregateDataRate, telecomsChannelBStatus=telecomsChannelBStatus, encryptionAlgorithm=encryptionAlgorithm, rxColorCode=rxColorCode, management=management, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, reset=reset, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, softwareVersion=softwareVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPCommunityString=sNMPCommunityString, telecom=telecom, syslogClient=syslogClient, longitude=longitude, phyStatus=phyStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, searchState=searchState, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDControlGroup=tDDControlGroup, aAAControl=aAAControl, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteIPAddress=remoteIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, sNTPServerTable=sNTPServerTable, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, sNTPPollInterval=sNTPPollInterval, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetBridgingStatus=ethernetBridgingStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALoopbackTrap=channelALoopbackTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBLineCode=channelBLineCode, remoteInternetAddress=remoteInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, remoteRxTargetPower=remoteRxTargetPower, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, iPv4Address=iPv4Address, alarms=alarms, sNTPLastSync=sNTPLastSync, l2CPPriorityTableEntry=l2CPPriorityTableEntry, versionsGroup=versionsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementMode=managementMode, transmitFreqKHz=transmitFreqKHz, maximumTransmitPower=maximumTransmitPower, systemClock=systemClock, syslogClientTrap=syslogClientTrap, siteName=siteName, sNTPState=sNTPState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, smtpGroup=smtpGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, hTTPSAccessEnabled=hTTPSAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, syslogControlGroup=syslogControlGroup, vLANManagementVID=vLANManagementVID, transmitChannel=transmitChannel, installStatusTrap=installStatusTrap, encryption=encryption, notificationsGroup=notificationsGroup, dfs=dfs, daylightSaving=daylightSaving, receiveModulationModeDetail=receiveModulationModeDetail, hAZLOCConfiguration=hAZLOCConfiguration, hTTPAccessEnabled=hTTPAccessEnabled, bootVersion=bootVersion, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementaryGroup=supplementaryGroup, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddressType=remoteInternetAddressType, latitude=latitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerIPAddress=sMTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, altitude=altitude, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortStatus=managementPortStatus, telecomGroup=telecomGroup, licenceGroup=licenceGroup, targetRange=targetRange, sNMPTrapTableNumber=sNMPTrapTableNumber, rangingMode=rangingMode, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, subnetMask=subnetMask, byteErrorRatio=byteErrorRatio, smtp=smtp, pubStats=pubStats, userRole=userRole, telecomsChannelSelection=telecomsChannelSelection, encryptionGroup=encryptionGroup, groupID=groupID, vectorError=vectorError, timeZone=timeZone, securityLevel=securityLevel, sNTPPrimaryServer=sNTPPrimaryServer, automaticTxPowerControl=automaticTxPowerControl, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, productName=productName, resetGroup=resetGroup, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyControl=phyControl, ptpTrapPrefix=ptpTrapPrefix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telnetAccessEnabled=telnetAccessEnabled, transmitDataRate=transmitDataRate, dfsTableIndex=dfsTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, systemReset=systemReset, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, syslogState=syslogState, l2CPPriorityTable=l2CPPriorityTable, accessMethod=accessMethod, sNTPServerIPAddress=sNTPServerIPAddress, installArmStateTrap=installArmStateTrap, dfsMeans=dfsMeans, channelBCableLength=channelBCableLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rawReceivePower=rawReceivePower, ethernetGroup=ethernetGroup, installStatus=installStatus, iPv6PrefixLength=iPv6PrefixLength, ptpCompliance=ptpCompliance, managementGroup=managementGroup, channelBandwidth=channelBandwidth, managementPortStatusTrap=managementPortStatusTrap, snmpControl=snmpControl, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, channelChangeTrap=channelChangeTrap, localPacketFiltering=localPacketFiltering, ethernet=ethernet, targetMACAddress=targetMACAddress, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerRetries=sNTPServerRetries, configurationGroup=configurationGroup, eIRP=eIRP, sMTPEmailAlert=sMTPEmailAlert, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode)
