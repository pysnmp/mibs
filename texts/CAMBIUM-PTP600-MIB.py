...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hAZLOCConfiguration=hAZLOCConfiguration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerStatus=sNTPServerStatus, userTableIndex=userTableIndex, ethernet=ethernet, dataPortFiberStatus=dataPortFiberStatus, encryption=encryption, syslogControl=syslogControl, accessMethod=accessMethod, linkName=linkName, syslogControlGroup=syslogControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerTable=sNTPServerTable, ethernetFiberSupport=ethernetFiberSupport, supplementary=supplementary, tDDControl=tDDControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, channelBCableLength=channelBCableLength, dfs=dfs, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, dfsTableIndex=dfsTableIndex, phyControl=phyControl, tDDControlGroup=tDDControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, subnetMask=subnetMask, remoteIPAddress=remoteIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, searchState=searchState, transmitChannel=transmitChannel, telecomsInterface=telecomsInterface, secureModeAlarm=secureModeAlarm, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, timeZone=timeZone, receiveFreqMHz=receiveFreqMHz, telecom=telecom, remoteRxTargetPower=remoteRxTargetPower, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCodeTrap=regionCodeTrap, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkSymmetry=linkSymmetry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelALoopbackTrap=channelALoopbackTrap, sNTPServerIPAddress=sNTPServerIPAddress, managementPortStatus=managementPortStatus, transmitFreqMHz=transmitFreqMHz, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, sNTPServerInternetAddress=sNTPServerInternetAddress, pubStats=pubStats, alarms=alarms, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installStatus=installStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControlGroup=snmpControlGroup, txColorCode=txColorCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetGroup=ethernetGroup, aAAControl=aAAControl, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv4Address=iPv4Address, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetBridgingStatus=ethernetBridgingStatus, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerIPAddress=tFTPServerIPAddress, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, management=management, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, notificationsGroup=notificationsGroup, versions=versions, unitOutOfCalibration=unitOutOfCalibration, productName=productName, sNTPServerPortNumber=sNTPServerPortNumber, siteName=siteName, transmitDataRate=transmitDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveChannel=receiveChannel, smtpGroup=smtpGroup, range=range, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, qOSPriorityScheme=qOSPriorityScheme, dataPortConfigurationMismatch=dataPortConfigurationMismatch, longitude=longitude, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rxColorCode=rxColorCode, channelALineCode=channelALineCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, encryptionAlgorithm=encryptionAlgorithm, dfsTableNumber=dfsTableNumber, alarmsGroup=alarmsGroup, frequencyVariant=frequencyVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, installStatusTrap=installStatusTrap, cambium=cambium, aAAControlGroup=aAAControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsPeaks=dfsPeaks, iPv6PrefixLength=iPv6PrefixLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, managementPortStatusTrap=managementPortStatusTrap, phyControlGroup=phyControlGroup, transmitModulationMode=transmitModulationMode, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpGroups=ptpGroups, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableLoss=cableLoss, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bridge=bridge, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, groupID=groupID, dfsTableEntry=dfsTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, bootVersion=bootVersion, channelChangeTrap=channelChangeTrap, managementGroup=managementGroup, telecomsChannelBStatus=telecomsChannelBStatus, userTableEntry=userTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, userTable=userTable, daylightSaving=daylightSaving, masterSlaveMode=masterSlaveMode, channelALoopback=channelALoopback, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, sNMPPortNumber=sNMPPortNumber, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, secureModeAlarmTrap=secureModeAlarmTrap, userPassword=userPassword, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, sNTPServerTableEntry=sNTPServerTableEntry, sNTPState=sNTPState, syslogState=syslogState, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, targetMACAddress=targetMACAddress, linkLoss=linkLoss, channelBLineCode=channelBLineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, antennaGain=antennaGain, phyStatus=phyStatus, dSCPManagementPriority=dSCPManagementPriority, automaticTxPowerControl=automaticTxPowerControl, linkModeOptimisation=linkModeOptimisation, channelACableLength=channelACableLength, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, remoteInternetAddress=remoteInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerRetries=sNTPServerRetries, sNTPSync=sNTPSync, resetGroup=resetGroup, rangingMode=rangingMode, receiveModulationModeDetail=receiveModulationModeDetail, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptmp=ptmp, userEnabled=userEnabled, eIRP=eIRP, configuration=configuration, userName=userName, ptp600=ptp600, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, ptp=ptp, dfsMeans=dfsMeans, iPVersion=iPVersion, iPv6Address=iPv6Address, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, securityLevel=securityLevel, syslogClient=syslogClient, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, telecomsChannelSelection=telecomsChannelSelection, localPacketFiltering=localPacketFiltering, regionCode=regionCode, syslogStateTrap=syslogStateTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTableIndex=sNTPServerTableIndex, softwareVersion=softwareVersion, remoteInternetAddressType=remoteInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableIndex=ethernetPriorityTableIndex, targetRange=targetRange, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, versionsGroup=versionsGroup, iPv6GatewayAddress=iPv6GatewayAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelBLoopback=channelBLoopback, dataPortAutoMdix=dataPortAutoMdix, hTTPSPortNumber=hTTPSPortNumber, rawReceivePower=rawReceivePower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productVariant=productVariant, ethernetPriorityTableEntry=ethernetPriorityTableEntry, latitude=latitude, reset=reset, licence=licence, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementMode=managementMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bandwidthVariant=bandwidthVariant)
