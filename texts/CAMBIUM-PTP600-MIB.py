...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogClient=syslogClient, ethernet=ethernet, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, securityLevel=securityLevel, dataPortStatusTrap=dataPortStatusTrap, phyStatusGroup=phyStatusGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, hardwareVersion=hardwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, sNTPServerStatus=sNTPServerStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, daylightSaving=daylightSaving, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, telecomsChannelAStatus=telecomsChannelAStatus, rangingMode=rangingMode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, transmitFreqKHz=transmitFreqKHz, vLANManagementPriority=vLANManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, linkName=linkName, iPv6Address=iPv6Address, groupID=groupID, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, sntp=sntp, antennaGain=antennaGain, versionsGroup=versionsGroup, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, vectorError=vectorError, sNTPServerIPAddress=sNTPServerIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, channelALineCode=channelALineCode, dataPortFiberStatus=dataPortFiberStatus, dfsTableNumber=dfsTableNumber, channelBLineCode=channelBLineCode, productName=productName, targetMACAddress=targetMACAddress, altitude=altitude, eIRP=eIRP, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, ethernetBridgingStatus=ethernetBridgingStatus, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, smtpGroup=smtpGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuration=configuration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, localPacketFiltering=localPacketFiltering, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkSymmetry=linkSymmetry, l2CPPriorityTable=l2CPPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secureModeAlarm=secureModeAlarm, userName=userName, channelBLoopbackTrap=channelBLoopbackTrap, searchState=searchState, dfsTable=dfsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, sNTPPollInterval=sNTPPollInterval, userRole=userRole, mPLSTCPriorityTable=mPLSTCPriorityTable, channelChangeTrap=channelChangeTrap, timeZone=timeZone, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, softwareVersion=softwareVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsMeans=dfsMeans, channelALoopback=channelALoopback, sNTPServerTableIndex=sNTPServerTableIndex, managementMode=managementMode, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqMHz=receiveFreqMHz, supplementary=supplementary, hAZLOCConfiguration=hAZLOCConfiguration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, resetGroup=resetGroup, ptp600=ptp600, syslogControl=syslogControl, receiveDataRate=receiveDataRate, remoteInternetAddress=remoteInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, channelACableLength=channelACableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, subnetMask=subnetMask, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, managementGroup=managementGroup, supplementaryGroup=supplementaryGroup, iPVersion=iPVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqMHz=transmitFreqMHz, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControl=phyControl, sNTPSync=sNTPSync, cableLoss=cableLoss, telnetAccessEnabled=telnetAccessEnabled, regionCode=regionCode, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, managementPortStatusTrap=managementPortStatusTrap, rawReceivePower=rawReceivePower, frequencyVariant=frequencyVariant, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licence=licence, receiveFreqKHz=receiveFreqKHz, channelALoopbackTrap=channelALoopbackTrap, automaticTxPowerControl=automaticTxPowerControl, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsTableIndex=dfsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCodeTrap=regionCodeTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, dfsPeaks=dfsPeaks, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, snmpControlGroup=snmpControlGroup, installArmStateTrap=installArmStateTrap, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, managementPortStatus=managementPortStatus, receiveChannel=receiveChannel, telecomsChannelSelection=telecomsChannelSelection, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configurationGroup=configurationGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfs=dfs, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetPortNumber=telnetPortNumber, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableEntry=userTableEntry, cambium=cambium, sNTPLastSync=sNTPLastSync, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userTableNumber=userTableNumber, bootVersion=bootVersion, ptpTraps=ptpTraps, pubStats=pubStats, ptmp=ptmp, encryptionGroup=encryptionGroup, syslogControlGroup=syslogControlGroup, ptpCompliance=ptpCompliance, smtp=smtp, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelBStatus=telecomsChannelBStatus, secureModeAlarmTrap=secureModeAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, txColorCode=txColorCode, sNTPServerPortNumber=sNTPServerPortNumber, reset=reset, alarms=alarms, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPState=sNTPState, sntpGroup=sntpGroup, targetRange=targetRange, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsGroup=dfsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, syslogState=syslogState, sNTPServerTimeout=sNTPServerTimeout, userTable=userTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aAAControlGroup=aAAControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBandwidth=channelBandwidth, licenceGroup=licenceGroup, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTable=sNTPServerTable, dataPortStatus=dataPortStatus, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, installArmState=installArmState, pubStatsGroup=pubStatsGroup, iPv4Address=iPv4Address, telecomsInterface=telecomsInterface, remoteRxTargetPower=remoteRxTargetPower, transmitDataRate=transmitDataRate, latitude=latitude, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomGroup=telecomGroup, systemClock=systemClock)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecom=telecom, receivePower=receivePower, receiveModulationModeDetail=receiveModulationModeDetail, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, siteName=siteName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vLANManagementVID=vLANManagementVID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelBLoopback=channelBLoopback, userEnabled=userEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPAccessEnabled=hTTPAccessEnabled, iPv6GatewayAddress=iPv6GatewayAddress, sNMPCommunityString=sNMPCommunityString, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, management=management, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPPortNumber=sNMPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkLoss=linkLoss, ethernetPriorityTable=ethernetPriorityTable, channelBCableLength=channelBCableLength, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, rxColorCode=rxColorCode, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, bridge=bridge, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControl=aAAControl, tFTPServerInternetAddress=tFTPServerInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, range=range, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration)
