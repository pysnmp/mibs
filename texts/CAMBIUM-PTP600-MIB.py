...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bandwidthVariant=bandwidthVariant, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, versionsGroup=versionsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementGroup=managementGroup, iPVersion=iPVersion, hAZLOCConfiguration=hAZLOCConfiguration, remoteRxTargetPower=remoteRxTargetPower, receiveChannel=receiveChannel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitPower=transmitPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, installStatus=installStatus, bridge=bridge, altitude=altitude, configuration=configuration, automaticTxPowerControl=automaticTxPowerControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, latitude=latitude, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, groupID=groupID, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatusTrap=installStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, masterSlaveMode=masterSlaveMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerPortNumber=sMTPServerPortNumber, management=management, phyControl=phyControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogState=syslogState, vectorError=vectorError, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsPeaks=dfsPeaks, pubStats=pubStats, txColorCode=txColorCode, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelSelection=telecomsChannelSelection, telecomsChannelAStatus=telecomsChannelAStatus, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ptpGroups=ptpGroups, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, channelALoopback=channelALoopback, dataPortFiberStatusTrap=dataPortFiberStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsMeans=dfsMeans, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTableIndex=sNTPServerTableIndex, transmitFreqKHz=transmitFreqKHz, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelALineCode=channelALineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, systemClock=systemClock, iPv6PrefixLength=iPv6PrefixLength, userRole=userRole, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerRetries=sNTPServerRetries, sNTPSyncTrap=sNTPSyncTrap, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, targetMACAddress=targetMACAddress, installArmState=installArmState, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, dfsTable=dfsTable, licence=licence, receiveModulationMode=receiveModulationMode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetFiberSupport=ethernetFiberSupport, userPassword=userPassword, signalStrengthRatio=signalStrengthRatio, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDControl=tDDControl, smtpGroup=smtpGroup, subnetMask=subnetMask, dataPortWirelessDownAlert=dataPortWirelessDownAlert, qOSPriorityScheme=qOSPriorityScheme, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, tFTPServerInternetAddress=tFTPServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versions=versions, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, configurationGroup=configurationGroup, dSCPManagementPriority=dSCPManagementPriority, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, transmitFreqMHz=transmitFreqMHz, userTable=userTable, managementMode=managementMode, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, dfsTableIndex=dfsTableIndex, sNTPLastSync=sNTPLastSync, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, sNMPv3Enable=sNMPv3Enable, receiveDataRate=receiveDataRate, cambium=cambium, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv4Address=iPv4Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, bootVersion=bootVersion, ethernet=ethernet, phyControlGroup=phyControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, siteName=siteName, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, sNTPServerTimeout=sNTPServerTimeout, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, antennaGain=antennaGain, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfs=dfs, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, bridgeGroup=bridgeGroup, sMTPEmailAlert=sMTPEmailAlert, sntp=sntp, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelBCableLength=channelBCableLength, userEnabled=userEnabled, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, encryption=encryption, telecom=telecom, receiveFreqMHz=receiveFreqMHz, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerTableNumber=sNTPServerTableNumber, channelChangeTrap=channelChangeTrap, rxColorCode=rxColorCode, channelBLoopback=channelBLoopback, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelALoopbackTrap=channelALoopbackTrap, localPacketFiltering=localPacketFiltering, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, ethernetPriorityTable=ethernetPriorityTable, timeZone=timeZone, systemReset=systemReset, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortStatusTrap=dataPortStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClientTrap=syslogClientTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, iPv6Address=iPv6Address, channelBLineCode=channelBLineCode, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aAAControlGroup=aAAControlGroup, longitude=longitude, sNTPServerStatus=sNTPServerStatus, rawReceivePower=rawReceivePower, managementPortStatusTrap=managementPortStatusTrap, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteInternetAddressType=remoteInternetAddressType, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPState=sNTPState, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, channelACableLength=channelACableLength, dfsTableNumber=dfsTableNumber, accessMethod=accessMethod, sNTPServerInternetAddress=sNTPServerInternetAddress, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, regionCodeTrap=regionCodeTrap, iPv6GatewayAddress=iPv6GatewayAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userName=userName, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, notificationsGroup=notificationsGroup, userTableNumber=userTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogClient=syslogClient, sMTPServerIPAddress=sMTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, pubStatsGroup=pubStatsGroup, targetRange=targetRange, eIRP=eIRP, rangingMode=rangingMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, aAAControl=aAAControl, alarmsGroup=alarmsGroup, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortFiberStatus=dataPortFiberStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimisation=linkModeOptimisation, managementPortStatus=managementPortStatus, range=range)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, securityLevel=securityLevel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, frequencyVariant=frequencyVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBandwidth=channelBandwidth, ethernetPriorityTableIndex=ethernetPriorityTableIndex, productName=productName, sNTPServerPortNumber=sNTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, resetGroup=resetGroup, encryptionGroup=encryptionGroup, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, snmpControl=snmpControl, secureModeAlarm=secureModeAlarm, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, transmitModulationMode=transmitModulationMode, telecomGroup=telecomGroup, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsInterface=telecomsInterface, aggregateDataRate=aggregateDataRate, supplementary=supplementary, daylightSaving=daylightSaving, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, PYSNMP_MODULE_ID=cambium, receiveModulationModeDetail=receiveModulationModeDetail, ptp600=ptp600, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTable=l2CPPriorityTable, ptmp=ptmp, ethernetBridgingStatus=ethernetBridgingStatus, receivePower=receivePower, ethernetBridgingAvailability=ethernetBridgingAvailability, ptpTrapPrefix=ptpTrapPrefix, linkLoss=linkLoss)
