...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPollInterval=sNTPPollInterval, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, resetGroup=resetGroup, vectorError=vectorError, userTableNumber=userTableNumber, managementMode=managementMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, sNTPServerRetries=sNTPServerRetries, secureModeAlarmTrap=secureModeAlarmTrap, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, sNMPEnabledTraps=sNMPEnabledTraps, channelBLoopbackTrap=channelBLoopbackTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpTraps=ptpTraps, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxColorCode=rxColorCode, installStatusTrap=installStatusTrap, tDDControl=tDDControl, ptpCompliance=ptpCompliance, managementPortStatusTrap=managementPortStatusTrap, alarms=alarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, versions=versions, telecomGroup=telecomGroup, cableLoss=cableLoss, range=range, ethernetGroup=ethernetGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, telecomsChannelSelection=telecomsChannelSelection, telecomsInterface=telecomsInterface, wirelessLinkAvailability=wirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelALoopbackTrap=channelALoopbackTrap, sNMPPortNumber=sNMPPortNumber, transmitFreqKHz=transmitFreqKHz, dataPortStatusTrap=dataPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsTable=dfsTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableIndex=dfsTableIndex, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleRegionCodes=incompatibleRegionCodes, sNTPSync=sNTPSync, bandwidthVariant=bandwidthVariant, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, encryptionGroup=encryptionGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, smtp=smtp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfs=dfs, rawReceivePower=rawReceivePower, iPv6PrefixLength=iPv6PrefixLength, channelBLoopback=channelBLoopback, encryption=encryption, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, bridge=bridge, syslogControl=syslogControl, hardwareVersion=hardwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, pubStats=pubStats, syslogClient=syslogClient, systemReset=systemReset, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, reset=reset, secureModeAlarm=secureModeAlarm, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyControl=phyControl, ethernetPriorityTable=ethernetPriorityTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityTableNumber=ethernetPriorityTableNumber, smtpGroup=smtpGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerStatus=sNTPServerStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, userRole=userRole, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, versionsGroup=versionsGroup, txColorCode=txColorCode, channelALoopback=channelALoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, notificationsGroup=notificationsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, secondarySoftwareVersion=secondarySoftwareVersion, syslogState=syslogState, targetRange=targetRange, userTableIndex=userTableIndex, ptp600=ptp600, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelAStatus=telecomsChannelAStatus, tDDSynchronizationMode=tDDSynchronizationMode, installArmState=installArmState, latitude=latitude, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTable=l2CPPriorityTable, rangingMode=rangingMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, accessMethod=accessMethod, dfsTableNumber=dfsTableNumber, encryptionAlgorithm=encryptionAlgorithm, longitude=longitude, channelBCableLength=channelBCableLength, syslogStateTrap=syslogStateTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPVersion=iPVersion, receiveModulationModeDetail=receiveModulationModeDetail, automaticTxPowerControl=automaticTxPowerControl, ptp=ptp, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, licence=licence, dfsTableEntry=dfsTableEntry, iPv6Address=iPv6Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv4Address=iPv4Address, channelALineCode=channelALineCode, receivePower=receivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsGroup=dfsGroup, telnetPortNumber=telnetPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitChannel=transmitChannel, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkLoss=linkLoss, phyControlGroup=phyControlGroup, bridgeGroup=bridgeGroup, hAZLOCConfiguration=hAZLOCConfiguration, timeZone=timeZone, syslogClientTrap=syslogClientTrap, remoteInternetAddressType=remoteInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServer=sNTPPrimaryServer, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, securityLevel=securityLevel, vLANManagementPriority=vLANManagementPriority, channelBLineCode=channelBLineCode, linkName=linkName, dSCPManagementPriority=dSCPManagementPriority, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsMeans=dfsMeans, tDDControlGroup=tDDControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetFiberSupport=ethernetFiberSupport, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, userName=userName, pubStatsGroup=pubStatsGroup, channelACableLength=channelACableLength, managementGroup=managementGroup, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, systemClock=systemClock, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTableEntry=sNTPServerTableEntry, management=management, masterSlaveMode=masterSlaveMode, siteName=siteName, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userPassword=userPassword, transmitPower=transmitPower, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, telecom=telecom, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkModeOptimisation=linkModeOptimisation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, sntp=sntp, configurationGroup=configurationGroup, transmitModulationMode=transmitModulationMode, ethernet=ethernet, noWirelessChannelAvailable=noWirelessChannelAvailable, altitude=altitude, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bootVersion=bootVersion, channelBandwidth=channelBandwidth, snmpControl=snmpControl, productName=productName, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, aAAControlGroup=aAAControlGroup, managementPortStatus=managementPortStatus, sNTPState=sNTPState, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, transmitDataRate=transmitDataRate, configuration=configuration, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, eIRP=eIRP, dataPortDisabledWarning=dataPortDisabledWarning, remoteRxTargetPower=remoteRxTargetPower, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, vLANManagementVID=vLANManagementVID, ptmp=ptmp, sMTPEnabledMessages=sMTPEnabledMessages, constantPowerSpectralDensity=constantPowerSpectralDensity, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, hTTPPortNumber=hTTPPortNumber, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, installStatus=installStatus, sntpGroup=sntpGroup, tFTPServerIPAddress=tFTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTable=sNMPTrapTable, dataPortFiberStatus=dataPortFiberStatus, remoteIPAddress=remoteIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, linkSymmetry=linkSymmetry, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, supplementary=supplementary, syslogLocalWrappedTrap=syslogLocalWrappedTrap, regionCodeTrap=regionCodeTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogControlGroup=syslogControlGroup)
