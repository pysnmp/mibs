...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerIPAddress=sNTPServerIPAddress, targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, byteErrorRatio=byteErrorRatio, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, masterSlaveMode=masterSlaveMode, channelBLoopbackTrap=channelBLoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBCableLength=channelBCableLength, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerStatus=sNTPServerStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, securityLevel=securityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableEntry=sNMPTrapTableEntry, bridgeGroup=bridgeGroup, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, productVariant=productVariant, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBLineCode=channelBLineCode, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControl=phyControl, ptpGroups=ptpGroups, sNTPServerTimeout=sNTPServerTimeout, iPv6Address=iPv6Address, resetGroup=resetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, accessMethod=accessMethod, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, rangingMode=rangingMode, ethernet=ethernet, txColorCode=txColorCode, softwareVersion=softwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptp600=ptp600, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerInternetAddress=sMTPServerInternetAddress, pubStats=pubStats, linkName=linkName, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, syslogClientTrap=syslogClientTrap, ptp=ptp, managementMode=managementMode, tDDControl=tDDControl, snmpControl=snmpControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTable=sNTPServerTable, management=management, subnetMask=subnetMask, targetRange=targetRange, supplementaryGroup=supplementaryGroup, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, localPacketFiltering=localPacketFiltering, remoteMaximumTransmitPower=remoteMaximumTransmitPower, signalStrengthRatio=signalStrengthRatio, userTableEntry=userTableEntry, remoteInternetAddressType=remoteInternetAddressType, rxColorCode=rxColorCode, sMTPEnabledMessages=sMTPEnabledMessages, userTable=userTable, groupID=groupID, tDDSynchronizationMode=tDDSynchronizationMode, managementPortStatusTrap=managementPortStatusTrap, gatewayIPAddress=gatewayIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, configuration=configuration, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, altitude=altitude, systemReset=systemReset, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, userRole=userRole, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, dfsMeans=dfsMeans, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, qOSPriorityScheme=qOSPriorityScheme, receiveChannel=receiveChannel, ptpTraps=ptpTraps, ethernetBridgingAvailability=ethernetBridgingAvailability, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, telecomsInterface=telecomsInterface, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, licenceGroup=licenceGroup, secureModeAlarm=secureModeAlarm, installArmState=installArmState, ethernetBridgingStatus=ethernetBridgingStatus, frequencyVariant=frequencyVariant, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelBandwidth=channelBandwidth, timeZone=timeZone, hAZLOCConfiguration=hAZLOCConfiguration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortDisabledWarning=dataPortDisabledWarning, dfsGroup=dfsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bootVersion=bootVersion, channelALoopbackTrap=channelALoopbackTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveDataRate=receiveDataRate, encryptionAlgorithm=encryptionAlgorithm, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, encryptionGroup=encryptionGroup, automaticTxPowerControl=automaticTxPowerControl, sNTPServerInternetAddress=sNTPServerInternetAddress, rawReceivePower=rawReceivePower, syslogControl=syslogControl, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelBLoopback=channelBLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, userPassword=userPassword, ptpCompliance=ptpCompliance, installStatus=installStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, pubStatsGroup=pubStatsGroup, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, userEnabled=userEnabled, range=range, sNTPSyncTrap=sNTPSyncTrap, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTable=ethernetPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelACableLength=channelACableLength, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortStatus=dataPortStatus, l2CPPriorityTable=l2CPPriorityTable, remoteRxTargetPower=remoteRxTargetPower, receiveModulationMode=receiveModulationMode, aAAControl=aAAControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, reset=reset, dfsTableEntry=dfsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, productName=productName, managementPortStatus=managementPortStatus, vectorError=vectorError, phyStatusGroup=phyStatusGroup, iPv4Address=iPv4Address, tFTPServerInternetAddress=tFTPServerInternetAddress, phyControlGroup=phyControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, telecom=telecom, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, linkSymmetry=linkSymmetry, latitude=latitude, sntp=sntp, sNTPState=sNTPState, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementary=supplementary, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelALineCode=channelALineCode, tFTPServerPortNumber=tFTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomGroup=telecomGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, eIRP=eIRP, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableLoss=cableLoss, channelALoopback=channelALoopback, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, antennaGain=antennaGain, transmitChannel=transmitChannel)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", longitude=longitude, phyStatus=phyStatus, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, iPVersion=iPVersion, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, versions=versions, dataPortFiberStatus=dataPortFiberStatus, systemClock=systemClock, hardwareVersion=hardwareVersion, cambium=cambium, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sntpGroup=sntpGroup, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, PYSNMP_MODULE_ID=cambium, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableNumber=sNTPServerTableNumber, userName=userName, encryption=encryption, syslogState=syslogState, sNMPv3Enable=sNMPv3Enable, installStatusTrap=installStatusTrap, telecomsChannelAStatus=telecomsChannelAStatus, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, daylightSaving=daylightSaving, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secureModeAlarmTrap=secureModeAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, alarms=alarms, bridge=bridge, versionsGroup=versionsGroup, ethernetFiberSupport=ethernetFiberSupport)
