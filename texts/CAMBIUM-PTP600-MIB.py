...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableIndex=userTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, cableLoss=cableLoss, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, PYSNMP_MODULE_ID=cambium, accessMethod=accessMethod, signalStrengthRatio=signalStrengthRatio, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, licenceGroup=licenceGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortStatusTrap=managementPortStatusTrap, encryptionGroup=encryptionGroup, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtpGroup=smtpGroup, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, managementPortConfigurationMismatch=managementPortConfigurationMismatch, snmpControl=snmpControl, ptpGroups=ptpGroups, alarmsGroup=alarmsGroup, dataPortFiberStatus=dataPortFiberStatus, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, phyControlGroup=phyControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTable=ethernetPriorityTable, supplementary=supplementary, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, hTTPAccessEnabled=hTTPAccessEnabled, receiveFreqMHz=receiveFreqMHz, sNTPPollInterval=sNTPPollInterval, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, versions=versions, latitude=latitude, bootVersion=bootVersion, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementMode=managementMode, syslogControlGroup=syslogControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernet=ethernet, configuration=configuration, installStatus=installStatus, transmitChannel=transmitChannel, iPv6PrefixLength=iPv6PrefixLength, iPVersion=iPVersion, installStatusTrap=installStatusTrap, l2CPPriorityTable=l2CPPriorityTable, syslogState=syslogState, sNTPSync=sNTPSync, receiveModulationMode=receiveModulationMode, receiveFreqKHz=receiveFreqKHz, transmitDataRate=transmitDataRate, licence=licence, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetFiberSupport=ethernetFiberSupport, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsPeaks=dfsPeaks, subnetMask=subnetMask, secureModeAlarm=secureModeAlarm, systemClock=systemClock, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetRange=targetRange, snmpControlGroup=snmpControlGroup, userRole=userRole, smtp=smtp, iPv6Address=iPv6Address, ethernetBridgingStatus=ethernetBridgingStatus, telnetPortNumber=telnetPortNumber, rangingMode=rangingMode, aAAControl=aAAControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hAZLOCConfiguration=hAZLOCConfiguration, ptpTrapPrefix=ptpTrapPrefix, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, txColorCode=txColorCode, dfsTableNumber=dfsTableNumber, transmitPower=transmitPower, range=range, ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCodeTrap=regionCodeTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, channelALoopback=channelALoopback, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelSelection=telecomsChannelSelection, altitude=altitude, channelChangeTrap=channelChangeTrap, resetGroup=resetGroup, telecomsInterface=telecomsInterface, configurationGroup=configurationGroup, transmitModulationMode=transmitModulationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp600=ptp600, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, phyControl=phyControl, longitude=longitude, maximumTransmitPower=maximumTransmitPower, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDControl=tDDControl, tFTPServerInternetAddress=tFTPServerInternetAddress, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, ptpCompliance=ptpCompliance, syslogControl=syslogControl, receivePower=receivePower, receiveChannel=receiveChannel, userEnabled=userEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomGroup=telecomGroup, vectorError=vectorError, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelBLoopback=channelBLoopback, tFTPServerIPAddress=tFTPServerIPAddress, linkSymmetry=linkSymmetry, supplementaryGroup=supplementaryGroup, alarms=alarms, bridge=bridge, frequencyVariant=frequencyVariant, notificationsGroup=notificationsGroup, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionAlgorithm=encryptionAlgorithm, channelALoopbackTrap=channelALoopbackTrap, vLANManagementVID=vLANManagementVID, siteName=siteName, sntp=sntp, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, encryption=encryption, managementPortDisabledWarning=managementPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, remoteRxTargetPower=remoteRxTargetPower, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTable=sNTPServerTable, productVariant=productVariant, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, userTable=userTable, dfsTableIndex=dfsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, installArmState=installArmState, syslogStateTrap=syslogStateTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, masterSlaveMode=masterSlaveMode, eIRP=eIRP, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, dfsMeans=dfsMeans, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortStatus=managementPortStatus, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rawReceivePower=rawReceivePower, syslogClientTrap=syslogClientTrap, localPacketFiltering=localPacketFiltering, channelBandwidth=channelBandwidth, linkName=linkName, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelALineCode=channelALineCode, dfsGroup=dfsGroup, transmitFreqKHz=transmitFreqKHz, telecomsChannelAStatus=telecomsChannelAStatus, channelBLineCode=channelBLineCode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, searchState=searchState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibration=unitOutOfCalibration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, sNTPServerTableIndex=sNTPServerTableIndex, managementGroup=managementGroup, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStats=pubStats, sNTPServerRetries=sNTPServerRetries, sNTPServerInternetAddressType=sNTPServerInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPPortNumber=sNMPPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelACableLength=channelACableLength, userTableEntry=userTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveDataRate=receiveDataRate, automaticTxPowerControl=automaticTxPowerControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, bridgeGroup=bridgeGroup, transmitFreqMHz=transmitFreqMHz)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatusTrap=dataPortStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sntpGroup=sntpGroup, hardwareVersion=hardwareVersion, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, ptp=ptp, management=management, remoteInternetAddressType=remoteInternetAddressType, iPv4Address=iPv4Address, antennaGain=antennaGain, qOSPriorityScheme=qOSPriorityScheme, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userName=userName, sNTPState=sNTPState, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, securityLevel=securityLevel, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, remoteInternetAddress=remoteInternetAddress, linkModeOptimisation=linkModeOptimisation, rxColorCode=rxColorCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerStatus=sNTPServerStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, targetMACAddress=targetMACAddress, telecomsChannelBStatus=telecomsChannelBStatus, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPrimaryServer=sNTPPrimaryServer, productName=productName, channelBCableLength=channelBCableLength)
