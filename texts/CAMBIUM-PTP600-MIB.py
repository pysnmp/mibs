...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecom=telecom, remoteIPAddress=remoteIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelChangeTrap=channelChangeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, management=management, targetMACAddress=targetMACAddress, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, versionsGroup=versionsGroup, installStatus=installStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCodeTrap=regionCodeTrap, telecomsChannelAStatus=telecomsChannelAStatus, resetGroup=resetGroup, targetRange=targetRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBLoopbackTrap=channelBLoopbackTrap, sntpGroup=sntpGroup, PYSNMP_MODULE_ID=cambium, iPv6Address=iPv6Address, transmitModulationMode=transmitModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, pubStatsGroup=pubStatsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControlGroup=snmpControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, channelALoopback=channelALoopback, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productVariant=productVariant, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelALineCode=channelALineCode, userRole=userRole, remoteInternetAddressType=remoteInternetAddressType, supplementary=supplementary, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortStatusTrap=managementPortStatusTrap, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTable=userTable, transmitFreqKHz=transmitFreqKHz, subnetMask=subnetMask, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteRxTargetPower=remoteRxTargetPower, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userTableEntry=userTableEntry, managementPortStatus=managementPortStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementGroup=managementGroup, ptpTraps=ptpTraps, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsInterface=telecomsInterface, iPv6GatewayAddress=iPv6GatewayAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userPassword=userPassword, l2CPPriorityTableIndex=l2CPPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPollInterval=sNTPPollInterval, altitude=altitude, dfsTableIndex=dfsTableIndex, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortFiberStatus=dataPortFiberStatus, telecomsChannelBStatus=telecomsChannelBStatus, snmpControl=snmpControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveChannel=receiveChannel, syslogClient=syslogClient, smtp=smtp, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productName=productName, ptpCompliance=ptpCompliance, eIRP=eIRP, searchState=searchState, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, userEnabled=userEnabled, tFTPServerPortNumber=tFTPServerPortNumber, channelBLoopback=channelBLoopback, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, secureModeAlarm=secureModeAlarm, licenceGroup=licenceGroup, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, txColorCode=txColorCode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortStatus=dataPortStatus, cableLoss=cableLoss, rawReceivePower=rawReceivePower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, bandwidthVariant=bandwidthVariant, sNTPServerTableNumber=sNTPServerTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarning=dataPortDisabledWarning, channelALoopbackTrap=channelALoopbackTrap, channelBLineCode=channelBLineCode, dfs=dfs, qOSPriorityScheme=qOSPriorityScheme, automaticTxPowerControl=automaticTxPowerControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTableEntry=dfsTableEntry, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, transmitDataRate=transmitDataRate, tDDControl=tDDControl, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, securityLevel=securityLevel, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, channelACableLength=channelACableLength, localPacketFiltering=localPacketFiltering, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, configuration=configuration, phyStatus=phyStatus, notificationsGroup=notificationsGroup, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTable=l2CPPriorityTable, regionCode=regionCode, iPVersion=iPVersion, ptmp=ptmp, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, sNTPServerRetries=sNTPServerRetries, pubStats=pubStats, sNTPServerTimeout=sNTPServerTimeout, encryptionGroup=encryptionGroup, hAZLOCConfiguration=hAZLOCConfiguration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, iPv4Address=iPv4Address, linkSymmetry=linkSymmetry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, versions=versions, installArmStateTrap=installArmStateTrap, encryption=encryption, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBandwidth=channelBandwidth, secureModeAlarmTrap=secureModeAlarmTrap, dfsGroup=dfsGroup, bridge=bridge, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, cambium=cambium, configurationGroup=configurationGroup, aAAControlGroup=aAAControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, daylightSaving=daylightSaving, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEnabledMessages=sMTPEnabledMessages, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTable=dfsTable, syslogClientTrap=syslogClientTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, siteName=siteName, licence=licence, latitude=latitude, ptp=ptp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPAccessEnabled=hTTPAccessEnabled, sNTPPrimaryServer=sNTPPrimaryServer, groupID=groupID, secondarySoftwareVersion=secondarySoftwareVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sntp=sntp, dfsMeans=dfsMeans, hTTPSPortNumber=hTTPSPortNumber, systemClock=systemClock, timeZone=timeZone, transmitFreqMHz=transmitFreqMHz, longitude=longitude, syslogControlGroup=syslogControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, rxColorCode=rxColorCode, transmitChannel=transmitChannel, tDDControlGroup=tDDControlGroup, accessMethod=accessMethod, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEmailAlert=sMTPEmailAlert, systemReset=systemReset, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, bridgeGroup=bridgeGroup, channelBCableLength=channelBCableLength, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rangingMode=rangingMode, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortAutoMdix=dataPortAutoMdix, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpGroups=ptpGroups, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTableIndex=userTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, reset=reset, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, ethernet=ethernet, ethernetGroup=ethernetGroup, tDDSynchronizationMode=tDDSynchronizationMode, antennaGain=antennaGain, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelSelection=telecomsChannelSelection, alarms=alarms, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpTrapPrefix=ptpTrapPrefix, frequencyVariant=frequencyVariant, syslogControl=syslogControl, linkModeOptimisation=linkModeOptimisation, range=range, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingStatus=ethernetBridgingStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userName=userName, ptp600=ptp600, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
