...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkStatus=wirelessLinkStatus, syslogControl=syslogControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelALoopback=channelALoopback, telecomsChannelSelection=telecomsChannelSelection, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, ethernetFiberSupport=ethernetFiberSupport, ptmp=ptmp, installArmState=installArmState, wirelessLinkAvailability=wirelessLinkAvailability, daylightSaving=daylightSaving, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, vectorError=vectorError, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp600=ptp600, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, sNMPTrapVersion=sNMPTrapVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelALineCode=channelALineCode, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, managementPortStatus=managementPortStatus, altitude=altitude, siteName=siteName, smtp=smtp, iPVersion=iPVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableIndex=dfsTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkName=linkName, versions=versions, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, configurationGroup=configurationGroup, sNTPState=sNTPState, syslogClient=syslogClient, cableLoss=cableLoss, sntp=sntp, dfsGroup=dfsGroup, dataPortStatus=dataPortStatus, dfs=dfs, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, transmitModulationMode=transmitModulationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveDataRate=receiveDataRate, remoteInternetAddress=remoteInternetAddress, targetMACAddress=targetMACAddress, installStatus=installStatus, installStatusTrap=installStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, searchState=searchState, sNTPLastSync=sNTPLastSync, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userName=userName, rxColorCode=rxColorCode, sNMPTrapIPAddress=sNMPTrapIPAddress, encryption=encryption, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimisation=linkModeOptimisation, sMTPServerPortNumber=sMTPServerPortNumber, resetGroup=resetGroup, receivePower=receivePower, licenceGroup=licenceGroup, channelBLoopbackTrap=channelBLoopbackTrap, ethernetBridgingStatus=ethernetBridgingStatus, syslogState=syslogState, sNTPServerStatus=sNTPServerStatus, tDDControl=tDDControl, supplementaryGroup=supplementaryGroup, remoteIPAddress=remoteIPAddress, automaticTxPowerControl=automaticTxPowerControl, supplementary=supplementary, alarmsGroup=alarmsGroup, dfsTableEntry=dfsTableEntry, iPv6Address=iPv6Address, channelBLineCode=channelBLineCode, hAZLOCConfiguration=hAZLOCConfiguration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rangingMode=rangingMode, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, dSCPManagementPriority=dSCPManagementPriority, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpCompliance=ptpCompliance, eIRP=eIRP, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTimeout=sNTPServerTimeout, channelALoopbackTrap=channelALoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, txColorCode=txColorCode, frequencyVariant=frequencyVariant, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, bootVersion=bootVersion, versionsGroup=versionsGroup, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, longitude=longitude, constantPowerSpectralDensity=constantPowerSpectralDensity, linkSymmetry=linkSymmetry, snmpControl=snmpControl, groupID=groupID, channelACableLength=channelACableLength, channelBLoopback=channelBLoopback, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userRole=userRole, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatus=dataPortFiberStatus, reset=reset, bridge=bridge, l2CPPriorityTable=l2CPPriorityTable, userTableNumber=userTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, remoteRxTargetPower=remoteRxTargetPower, bridgeGroup=bridgeGroup, vLANManagementVID=vLANManagementVID, iPv4Address=iPv4Address, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, syslogControlGroup=syslogControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortStatusTrap=managementPortStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, secureModeAlarmTrap=secureModeAlarmTrap, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, gatewayIPAddress=gatewayIPAddress, ethernetGroup=ethernetGroup, ptp=ptp, targetRange=targetRange, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsInterface=telecomsInterface, cambium=cambium, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, localPacketFiltering=localPacketFiltering, secondarySoftwareVersion=secondarySoftwareVersion, phyControlGroup=phyControlGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, ethernetPriorityTable=ethernetPriorityTable, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, management=management, softwareVersion=softwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, regionCode=regionCode, securityLevel=securityLevel, managementMode=managementMode, sNTPServerTableIndex=sNTPServerTableIndex, encryptionAlgorithm=encryptionAlgorithm, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, aAAControl=aAAControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, configuration=configuration, hTTPAccessEnabled=hTTPAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableNumber=sNTPServerTableNumber, installArmStateTrap=installArmStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemReset=systemReset, pubStatsGroup=pubStatsGroup, timeZone=timeZone, telecomGroup=telecomGroup, iPv6PrefixLength=iPv6PrefixLength, telecom=telecom, notificationsGroup=notificationsGroup, userTable=userTable, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, range=range, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernet=ethernet, ptpTraps=ptpTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBCableLength=channelBCableLength, telnetAccessEnabled=telnetAccessEnabled, licence=licence, byteErrorRatio=byteErrorRatio, managementGroup=managementGroup, hardwareVersion=hardwareVersion, phyStatus=phyStatus, sNTPServerTable=sNTPServerTable, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, productName=productName, telnetPortNumber=telnetPortNumber, sNTPSync=sNTPSync, remoteInternetAddressType=remoteInternetAddressType, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, userEnabled=userEnabled, sNTPServerRetries=sNTPServerRetries, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPPortNumber=sNMPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, rawReceivePower=rawReceivePower, telecomsChannelBStatus=telecomsChannelBStatus, productVariant=productVariant, alarms=alarms, snmpControlGroup=snmpControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkLoss=linkLoss, secureModeAlarm=secureModeAlarm, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelAStatus=telecomsChannelAStatus, receiveFreqKHz=receiveFreqKHz)
