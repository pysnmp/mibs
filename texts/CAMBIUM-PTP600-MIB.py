...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", pubStats=pubStats, bridge=bridge, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteRxTargetPower=remoteRxTargetPower, phyStatus=phyStatus, vectorError=vectorError, phyStatusGroup=phyStatusGroup, targetMACAddress=targetMACAddress, versions=versions, channelALoopback=channelALoopback, supplementary=supplementary, localPacketFiltering=localPacketFiltering, automaticTxPowerControl=automaticTxPowerControl, receiveFreqMHz=receiveFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, channelBLineCode=channelBLineCode, userTableIndex=userTableIndex, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, ethernetFiberSupport=ethernetFiberSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClient=syslogClient, ptpTrapPrefix=ptpTrapPrefix, channelALineCode=channelALineCode, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, secureModeAlarm=secureModeAlarm, installArmStateTrap=installArmStateTrap, rangingMode=rangingMode, userTable=userTable, sNTPServerTable=sNTPServerTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfs=dfs, bridgeGroup=bridgeGroup, installStatusTrap=installStatusTrap, timeZone=timeZone, daylightSaving=daylightSaving, sNTPServerTableIndex=sNTPServerTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, targetRange=targetRange, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementGroup=managementGroup, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPState=sNTPState, snmpControl=snmpControl, productVariant=productVariant, linkName=linkName, userPassword=userPassword, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBandwidth=channelBandwidth, transmitPower=transmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, supplementaryGroup=supplementaryGroup, iPVersion=iPVersion, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortStatus=dataPortStatus, managementMode=managementMode, ethernetPriorityTable=ethernetPriorityTable, dataPortFiberStatus=dataPortFiberStatus, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hAZLOCConfiguration=hAZLOCConfiguration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, smtp=smtp, bootVersion=bootVersion, txColorCode=txColorCode, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, linkModeOptimisation=linkModeOptimisation, sNTPServerTableEntry=sNTPServerTableEntry, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, transmitFreqMHz=transmitFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, range=range, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, encryption=encryption, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userEnabled=userEnabled, ethernetGroup=ethernetGroup, telecom=telecom, snmpControlGroup=snmpControlGroup, telecomsChannelBStatus=telecomsChannelBStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBLoopbackTrap=channelBLoopbackTrap, telecomGroup=telecomGroup, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, sNTPPrimaryServer=sNTPPrimaryServer, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, iPv6GatewayAddress=iPv6GatewayAddress, cambium=cambium, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, telecomsChannelAStatus=telecomsChannelAStatus, configuration=configuration, iPDSCPPriorityTable=iPDSCPPriorityTable, gatewayIPAddress=gatewayIPAddress, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPPortNumber=hTTPPortNumber, licenceGroup=licenceGroup, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, telnetAccessEnabled=telnetAccessEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationGroup=configurationGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, sNTPServerRetries=sNTPServerRetries, syslogControlGroup=syslogControlGroup, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, managementPortStatusTrap=managementPortStatusTrap, ptp600=ptp600, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv4Address=iPv4Address, signalStrengthRatio=signalStrengthRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userRole=userRole, l2CPPriorityTable=l2CPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, groupID=groupID, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelACableLength=channelACableLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aAAControlGroup=aAAControlGroup, channelBCableLength=channelBCableLength, linkLoss=linkLoss, searchState=searchState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPv3Enable=sNMPv3Enable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoMdix=dataPortAutoMdix, phyControl=phyControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, siteName=siteName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, secureModeAlarmTrap=secureModeAlarmTrap, transmitDataRate=transmitDataRate, eIRP=eIRP, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkSymmetry=linkSymmetry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortStatus=managementPortStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDControl=tDDControl, dfsMeans=dfsMeans, phyControlGroup=phyControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, systemReset=systemReset, receiveChannel=receiveChannel, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, ptpCompliance=ptpCompliance, rxColorCode=rxColorCode, secondarySoftwareVersion=secondarySoftwareVersion, dfsTable=dfsTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, PYSNMP_MODULE_ID=cambium, userTableEntry=userTableEntry, subnetMask=subnetMask, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, channelALoopbackTrap=channelALoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubStatsGroup=pubStatsGroup, remoteInternetAddressType=remoteInternetAddressType, transmitChannel=transmitChannel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPSync=sNTPSync, altitude=altitude, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aAAControl=aAAControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rawReceivePower=rawReceivePower, ptp=ptp, sntpGroup=sntpGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, smtpGroup=smtpGroup, channelBLoopback=channelBLoopback, management=management, ethernet=ethernet, installStatus=installStatus, frequencyVariant=frequencyVariant, tFTPServerPortNumber=tFTPServerPortNumber, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, syslogStateTrap=syslogStateTrap, regionCodeTrap=regionCodeTrap, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, reset=reset, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, accessMethod=accessMethod, productName=productName, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, systemClock=systemClock, vLANManagementVID=vLANManagementVID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomsChannelSelection=telecomsChannelSelection, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitFreqKHz=transmitFreqKHz, remoteIPAddress=remoteIPAddress, syslogControl=syslogControl, ptpGroups=ptpGroups, syslogState=syslogState, latitude=latitude, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receivePower=receivePower, securityLevel=securityLevel, hTTPSPortNumber=hTTPSPortNumber, sNTPServerStatus=sNTPServerStatus, ethernetBridgingStatus=ethernetBridgingStatus, longitude=longitude, remoteInternetAddress=remoteInternetAddress, sNTPSyncTrap=sNTPSyncTrap, licence=licence, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerTableNumber=sNTPServerTableNumber)
