...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userEnabled=userEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteIPAddress=remoteIPAddress, telecom=telecom, ethernetPriorityTable=ethernetPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, dfsTable=dfsTable, vLANManagementPriority=vLANManagementPriority, targetMACAddress=targetMACAddress, automaticTxPowerControl=automaticTxPowerControl, latitude=latitude, managementMode=managementMode, linkLoss=linkLoss, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, longitude=longitude, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, tDDSynchronizationMode=tDDSynchronizationMode, channelChangeTrap=channelChangeTrap, syslogState=syslogState, syslogControlGroup=syslogControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, vLANManagementVID=vLANManagementVID, telecomGroup=telecomGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, userRole=userRole, softwareVersion=softwareVersion, userTableIndex=userTableIndex, vectorError=vectorError, hAZLOCConfiguration=hAZLOCConfiguration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPState=sNTPState, syslogClient=syslogClient, sNTPServerIPAddress=sNTPServerIPAddress, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, targetRange=targetRange, channelALineCode=channelALineCode, incompatibleRegionCodes=incompatibleRegionCodes, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, sNTPServerStatus=sNTPServerStatus, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerRetries=sNTPServerRetries, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddressType=remoteInternetAddressType, localPacketFiltering=localPacketFiltering, productVariant=productVariant, sNTPServerInternetAddress=sNTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsGroup=dfsGroup, managementGroup=managementGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, txColorCode=txColorCode, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, byteErrorRatio=byteErrorRatio, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, userName=userName, alarms=alarms, l2CPPriorityTable=l2CPPriorityTable, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, transmitModulationMode=transmitModulationMode, regionCodeTrap=regionCodeTrap, bootVersion=bootVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTableEntry=l2CPPriorityTableEntry, configurationGroup=configurationGroup, range=range, sntp=sntp, managementPortDisabledWarning=managementPortDisabledWarning, bandwidthVariant=bandwidthVariant, timeZone=timeZone, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, ethernetBridgingStatus=ethernetBridgingStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtp=smtp, sNTPServerTableIndex=sNTPServerTableIndex, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableEntry=userTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, telecomsChannelAStatus=telecomsChannelAStatus, secureModeAlarmTrap=secureModeAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, receiveChannel=receiveChannel, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteInternetAddress=remoteInternetAddress, searchState=searchState, receivePower=receivePower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, phyControl=phyControl, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, rawReceivePower=rawReceivePower, configuration=configuration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogStateTrap=syslogStateTrap, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, rangingMode=rangingMode, phyStatusGroup=phyStatusGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, siteName=siteName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortFiberStatus=dataPortFiberStatus, sNMPPortNumber=sNMPPortNumber, ethernetGroup=ethernetGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, licence=licence, groupID=groupID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, secureModeAlarm=secureModeAlarm, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelBStatus=telecomsChannelBStatus, userTableNumber=userTableNumber, dfs=dfs, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, resetGroup=resetGroup, iPv4Address=iPv4Address, transmitFreqMHz=transmitFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTable=sNMPTrapTable, sNTPServerTable=sNTPServerTable, regionCode=regionCode, telecomsChannelSelection=telecomsChannelSelection, secondarySoftwareVersion=secondarySoftwareVersion, reset=reset, receiveDataRate=receiveDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, cableLoss=cableLoss, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cambium=cambium, sNMPEnabledTraps=sNMPEnabledTraps, syslogControl=syslogControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortStatus=managementPortStatus, transmitFreqKHz=transmitFreqKHz, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptp=ptp, pubStats=pubStats, l2CPPriorityTableNumber=l2CPPriorityTableNumber, daylightSaving=daylightSaving, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsTableNumber=dfsTableNumber, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, accessMethod=accessMethod, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkSymmetry=linkSymmetry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitPower=transmitPower, iPVersion=iPVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, PYSNMP_MODULE_ID=cambium, phyControlGroup=phyControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, sNTPLastSync=sNTPLastSync, iPv6Address=iPv6Address, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetPortNumber=telnetPortNumber, pubStatsGroup=pubStatsGroup, productName=productName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteRxTargetPower=remoteRxTargetPower, dSCPManagementPriority=dSCPManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, bridgeGroup=bridgeGroup, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPPollInterval=sNTPPollInterval, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp600=ptp600, supplementaryGroup=supplementaryGroup, channelACableLength=channelACableLength, channelBLoopback=channelBLoopback, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, encryption=encryption, channelBLineCode=channelBLineCode, userPassword=userPassword, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSync=sNTPSync, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, channelALoopback=channelALoopback, securityLevel=securityLevel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, supplementary=supplementary)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", notificationsGroup=notificationsGroup, installArmState=installArmState, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, alarmsGroup=alarmsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, channelALoopbackTrap=channelALoopbackTrap, ptpGroups=ptpGroups, management=management, tDDControlGroup=tDDControlGroup, linkName=linkName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, frequencyVariant=frequencyVariant, bridge=bridge, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPServerIPAddress=tFTPServerIPAddress, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBLoopbackTrap=channelBLoopbackTrap, iPv6GatewayAddress=iPv6GatewayAddress, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, versionsGroup=versionsGroup, licenceGroup=licenceGroup, installStatus=installStatus, rxColorCode=rxColorCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryptionAlgorithm=encryptionAlgorithm, channelBCableLength=channelBCableLength, sNTPServerTableEntry=sNTPServerTableEntry, subnetMask=subnetMask, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, iPv6PrefixLength=iPv6PrefixLength)
