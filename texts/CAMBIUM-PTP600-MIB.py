...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", accessMethod=accessMethod, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, telecom=telecom, remoteInternetAddressType=remoteInternetAddressType, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, syslogClientTrap=syslogClientTrap, ethernetBridgingStatus=ethernetBridgingStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetAccessEnabled=telnetAccessEnabled, ethernetGroup=ethernetGroup, bootVersion=bootVersion, userRole=userRole, hTTPAccessEnabled=hTTPAccessEnabled, sntpGroup=sntpGroup, configurationGroup=configurationGroup, iPv4Address=iPv4Address, dfsTableEntry=dfsTableEntry, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, longitude=longitude, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsInterface=telecomsInterface, secureModeAlarmTrap=secureModeAlarmTrap, syslogControl=syslogControl, channelBLineCode=channelBLineCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, linkName=linkName, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, reset=reset, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, sNTPServerTableIndex=sNTPServerTableIndex, remoteRxTargetPower=remoteRxTargetPower, sNTPSync=sNTPSync, sNTPServerIPAddress=sNTPServerIPAddress, ptp600=ptp600, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, versions=versions, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, managementPortStatusTrap=managementPortStatusTrap, ptpGroups=ptpGroups, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, range=range, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, bridgeGroup=bridgeGroup, phyControlGroup=phyControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, byteErrorRatio=byteErrorRatio, tDDControl=tDDControl, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, channelBCableLength=channelBCableLength, linkLoss=linkLoss, userTableIndex=userTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, pubStats=pubStats, aAAControlGroup=aAAControlGroup, ethernet=ethernet, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxColorCode=rxColorCode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitDataRate=transmitDataRate, userEnabled=userEnabled, installArmState=installArmState, userName=userName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, ethernetPriorityTable=ethernetPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, automaticTxPowerControl=automaticTxPowerControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, sNTPServerTimeout=sNTPServerTimeout, licenceGroup=licenceGroup, eIRP=eIRP, qOSPriorityScheme=qOSPriorityScheme, sNTPServerTable=sNTPServerTable, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatusTrap=dataPortFiberStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, antennaGain=antennaGain, iPv6Address=iPv6Address, phyControl=phyControl, userTable=userTable, productVariant=productVariant, pubStatsGroup=pubStatsGroup, telecomsChannelAStatus=telecomsChannelAStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, softwareVersion=softwareVersion, sNTPServerTableNumber=sNTPServerTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, channelALoopback=channelALoopback, transmitPower=transmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsPeaks=dfsPeaks, bandwidthVariant=bandwidthVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, daylightSaving=daylightSaving, phyStatusGroup=phyStatusGroup, channelBLoopbackTrap=channelBLoopbackTrap, transmitFreqKHz=transmitFreqKHz, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPVersion=iPVersion, receiveFreqMHz=receiveFreqMHz, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, targetRange=targetRange, channelALineCode=channelALineCode, ptp=ptp, management=management, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetMACAddress=targetMACAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, timeZone=timeZone, dfsMeans=dfsMeans, phyStatus=phyStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteIPAddress=remoteIPAddress, sntp=sntp, receiveChannel=receiveChannel, dfsGroup=dfsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, latitude=latitude, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, productName=productName, rawReceivePower=rawReceivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, managementMode=managementMode, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptpTraps=ptpTraps, localPacketFiltering=localPacketFiltering, transmitChannel=transmitChannel, telecomGroup=telecomGroup, versionsGroup=versionsGroup, smtp=smtp, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetFiberSupport=ethernetFiberSupport, sNTPState=sNTPState, dfs=dfs, vectorError=vectorError, channelBLoopback=channelBLoopback, searchState=searchState, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, channelACableLength=channelACableLength, txColorCode=txColorCode, syslogState=syslogState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap, userPassword=userPassword, licence=licence, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hAZLOCConfiguration=hAZLOCConfiguration, sNTPSyncTrap=sNTPSyncTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bridge=bridge, managementPortDisabledWarning=managementPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, resetGroup=resetGroup, l2CPPriorityTable=l2CPPriorityTable, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, sNMPCommunityString=sNMPCommunityString, cambium=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelALoopbackTrap=channelALoopbackTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryption=encryption, installStatus=installStatus, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receivePower=receivePower, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, managementPortStatus=managementPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, telnetPortNumber=telnetPortNumber, cableLoss=cableLoss, iPv6GatewayAddress=iPv6GatewayAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortFiberStatus=dataPortFiberStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerRetries=sNTPServerRetries, dfsTableNumber=dfsTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, altitude=altitude, encryptionGroup=encryptionGroup, channelBandwidth=channelBandwidth, receiveFreqKHz=receiveFreqKHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, remoteInternetAddress=remoteInternetAddress, systemClock=systemClock, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkSymmetry=linkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, configuration=configuration, siteName=siteName, sNTPServerStatus=sNTPServerStatus, installStatusTrap=installStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqMHz=transmitFreqMHz, secureModeAlarm=secureModeAlarm, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, securityLevel=securityLevel, tDDControlGroup=tDDControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
