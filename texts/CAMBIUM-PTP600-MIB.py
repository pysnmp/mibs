...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxColorCode=rxColorCode, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, channelACableLength=channelACableLength, remoteInternetAddressType=remoteInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, dfsTableIndex=dfsTableIndex, receiveFreqMHz=receiveFreqMHz, syslogControlGroup=syslogControlGroup, telecomGroup=telecomGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, bridge=bridge, sNTPServerTableEntry=sNTPServerTableEntry, supplementary=supplementary, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptpCompliance=ptpCompliance, resetGroup=resetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, aAAControlGroup=aAAControlGroup, userTable=userTable, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, remoteRxTargetPower=remoteRxTargetPower, phyControl=phyControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptp600=ptp600, pubStats=pubStats, ethernetBridgingAvailability=ethernetBridgingAvailability, ethernetGroup=ethernetGroup, channelBCableLength=channelBCableLength, userTableNumber=userTableNumber, regionCodeTrap=regionCodeTrap, hTTPSPortNumber=hTTPSPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTimeout=sNTPServerTimeout, cableLoss=cableLoss, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, productName=productName, automaticTxPowerControl=automaticTxPowerControl, iPv6PrefixLength=iPv6PrefixLength, dfs=dfs, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementMode=managementMode, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementPriority=vLANManagementPriority, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, targetRange=targetRange, sNTPLastSync=sNTPLastSync, tDDSynchronizationMode=tDDSynchronizationMode, phyStatusGroup=phyStatusGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtp=smtp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPVersion=iPVersion, productVariant=productVariant, sNTPServerInternetAddress=sNTPServerInternetAddress, systemReset=systemReset, userTableIndex=userTableIndex, reset=reset, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, accessMethod=accessMethod, subnetMask=subnetMask, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpGroups=ptpGroups, sNTPSyncTrap=sNTPSyncTrap, transmitFreqMHz=transmitFreqMHz, licence=licence, phyStatus=phyStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelSelection=telecomsChannelSelection, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, hTTPSAccessEnabled=hTTPSAccessEnabled, versions=versions, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, rawReceivePower=rawReceivePower, channelChangeTrap=channelChangeTrap, latitude=latitude, cambium=cambium, syslogStateTrap=syslogStateTrap, userTableEntry=userTableEntry, syslogControl=syslogControl, receiveModulationMode=receiveModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoMdix=dataPortAutoMdix, localPacketFiltering=localPacketFiltering, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecomsInterface=telecomsInterface, alarms=alarms, bandwidthVariant=bandwidthVariant, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPState=sNTPState, iPv4Address=iPv4Address, installStatusTrap=installStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, groupID=groupID, tDDControlGroup=tDDControlGroup, remoteIPAddress=remoteIPAddress, channelBLineCode=channelBLineCode, qOSPriorityScheme=qOSPriorityScheme, daylightSaving=daylightSaving, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, dfsTableNumber=dfsTableNumber, ptp=ptp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, txColorCode=txColorCode, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPEnabledTraps=sNMPEnabledTraps, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsTable=dfsTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bridgeGroup=bridgeGroup, iPv6GatewayAddress=iPv6GatewayAddress, hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, longitude=longitude, altitude=altitude, secureModeAlarmTrap=secureModeAlarmTrap, supplementaryGroup=supplementaryGroup, siteName=siteName, ethernet=ethernet, aAAControl=aAAControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, receiveChannel=receiveChannel, iPDSCPPriorityTable=iPDSCPPriorityTable, sntp=sntp, installStatus=installStatus, dfsGroup=dfsGroup, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, userRole=userRole, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpTraps=ptpTraps, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, eIRP=eIRP, l2CPPriorityTable=l2CPPriorityTable, vectorError=vectorError, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, range=range, linkLoss=linkLoss, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionGroup=encryptionGroup, antennaGain=antennaGain, transmitDataRate=transmitDataRate, sMTPServerInternetAddress=sMTPServerInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveDataRate=receiveDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userEnabled=userEnabled, securityLevel=securityLevel, sNTPSync=sNTPSync, managementPortStatusTrap=managementPortStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, remoteInternetAddress=remoteInternetAddress, dataPortFiberStatus=dataPortFiberStatus, dfsTableEntry=dfsTableEntry, userName=userName, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetPortNumber=telnetPortNumber, systemClock=systemClock, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatusTrap=dataPortStatusTrap, ptmp=ptmp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6Address=iPv6Address, sNTPPollInterval=sNTPPollInterval, sNTPServerTable=sNTPServerTable, smtpGroup=smtpGroup, encryption=encryption, managementPortWirelessDownAlert=managementPortWirelessDownAlert, maximumTransmitPower=maximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, transmitChannel=transmitChannel, mPLSTCPriorityTable=mPLSTCPriorityTable, rangingMode=rangingMode, dfsPeaks=dfsPeaks, ethernetPriorityTableEntry=ethernetPriorityTableEntry, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelALoopbackTrap=channelALoopbackTrap, versionsGroup=versionsGroup, sMTPEmailAlert=sMTPEmailAlert, secureModeAlarm=secureModeAlarm, notificationsGroup=notificationsGroup, encryptionAlgorithm=encryptionAlgorithm, channelALoopback=channelALoopback, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, targetMACAddress=targetMACAddress, managementPortDisabledWarning=managementPortDisabledWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPPrimaryServer=sNTPPrimaryServer, ethernetBridgingStatus=ethernetBridgingStatus, syslogClient=syslogClient, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecom=telecom, channelBLoopback=channelBLoopback, pubStatsGroup=pubStatsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, phyControlGroup=phyControlGroup, byteErrorRatio=byteErrorRatio, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, channelBLoopbackTrap=channelBLoopbackTrap, tDDControl=tDDControl, channelALineCode=channelALineCode, dataPortAutoNegotiation=dataPortAutoNegotiation, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, installArmState=installArmState, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, vLANManagementVID=vLANManagementVID, tFTPServerInternetAddress=tFTPServerInternetAddress, licenceGroup=licenceGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsMeans=dfsMeans, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, timeZone=timeZone, telecomsChannelAStatus=telecomsChannelAStatus, managementPortStatus=managementPortStatus, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, receiveFreqKHz=receiveFreqKHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, managementGroup=managementGroup, sNTPServerRetries=sNTPServerRetries, masterSlaveMode=masterSlaveMode)
