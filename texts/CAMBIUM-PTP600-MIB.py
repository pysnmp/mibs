...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortFiberStatus=dataPortFiberStatus, aAAControl=aAAControl, transmitPower=transmitPower, sNTPPollInterval=sNTPPollInterval, channelALoopback=channelALoopback, hTTPSPortNumber=hTTPSPortNumber, channelACableLength=channelACableLength, configurationGroup=configurationGroup, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerTable=sNTPServerTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, management=management, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, bridgeGroup=bridgeGroup, antennaGain=antennaGain, dataPortFiberStatusTrap=dataPortFiberStatusTrap, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, channelALineCode=channelALineCode, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bootVersion=bootVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sntp=sntp, sNMPv3Enable=sNMPv3Enable, alarms=alarms, ptpGroups=ptpGroups, rawReceivePower=rawReceivePower, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, configuration=configuration, managementGroup=managementGroup, resetGroup=resetGroup, supplementaryGroup=supplementaryGroup, masterSlaveMode=masterSlaveMode, transmitChannel=transmitChannel, sntpGroup=sntpGroup, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, dfsMeans=dfsMeans, managementPortStatus=managementPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, bridge=bridge, dfsTableIndex=dfsTableIndex, telnetAccessEnabled=telnetAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, aggregateDataRate=aggregateDataRate, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTableIndex=sNTPServerTableIndex, userTable=userTable, phyStatusGroup=phyStatusGroup, groupID=groupID, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, phyControlGroup=phyControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, telecom=telecom, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, targetRange=targetRange, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, txColorCode=txColorCode, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBLoopback=channelBLoopback, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControlGroup=tDDControlGroup, sNTPSyncTrap=sNTPSyncTrap, channelChangeTrap=channelChangeTrap, secureModeAlarm=secureModeAlarm, sNMPTrapTable=sNMPTrapTable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, userTableEntry=userTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, PYSNMP_MODULE_ID=cambium, sNTPState=sNTPState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, dfsTableEntry=dfsTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelSelection=telecomsChannelSelection, userName=userName, versionsGroup=versionsGroup, cambium=cambium, userTableNumber=userTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, linkName=linkName, iPv6GatewayAddress=iPv6GatewayAddress, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpCompliance=ptpCompliance, supplementary=supplementary, userTableIndex=userTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsPeaks=dfsPeaks, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, tDDControl=tDDControl, constantPowerSpectralDensity=constantPowerSpectralDensity, searchState=searchState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelBCableLength=channelBCableLength, userPassword=userPassword, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, reset=reset, iPVersion=iPVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, qOSPriorityScheme=qOSPriorityScheme, snmpControl=snmpControl, userRole=userRole, dataPortStatusTrap=dataPortStatusTrap, regionCodeTrap=regionCodeTrap, tDDSynchronizationMode=tDDSynchronizationMode, receiveDataRate=receiveDataRate, managementMode=managementMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hardwareVersion=hardwareVersion, telecomsInterface=telecomsInterface, receiveChannel=receiveChannel, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitDataRate=transmitDataRate, syslogControl=syslogControl, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, sNTPServerRetries=sNTPServerRetries, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, byteErrorRatio=byteErrorRatio, channelBLineCode=channelBLineCode, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatus=dataPortStatus, productVariant=productVariant, syslogState=syslogState, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimisation=linkModeOptimisation, remoteIPAddress=remoteIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogControlGroup=syslogControlGroup, channelALoopbackTrap=channelALoopbackTrap, iPv4Address=iPv4Address, frequencyVariant=frequencyVariant, vLANManagementPriority=vLANManagementPriority, channelBLoopbackTrap=channelBLoopbackTrap, licenceGroup=licenceGroup, securityLevel=securityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubStats=pubStats, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, eIRP=eIRP, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, smtp=smtp, gatewayIPAddress=gatewayIPAddress, managementPortStatusTrap=managementPortStatusTrap, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, dataPortDisabledWarning=dataPortDisabledWarning, timeZone=timeZone, altitude=altitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6Address=iPv6Address, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, remoteRxTargetPower=remoteRxTargetPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, longitude=longitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveModulationMode=receiveModulationMode, ethernetGroup=ethernetGroup, syslogClientTrap=syslogClientTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerStatus=sNTPServerStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogClient=syslogClient, phyControl=phyControl, dfsTableNumber=dfsTableNumber, range=range, softwareVersion=softwareVersion, sNTPServerPortNumber=sNTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernet=ethernet, linkSymmetry=linkSymmetry, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTimeout=sNTPServerTimeout, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelAStatus=telecomsChannelAStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rangingMode=rangingMode, snmpControlGroup=snmpControlGroup, remoteInternetAddress=remoteInternetAddress, cableLoss=cableLoss, regionCode=regionCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionGroup=encryptionGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTableEntry=l2CPPriorityTableEntry, localPacketFiltering=localPacketFiltering, channelBandwidth=channelBandwidth, sNTPLastSync=sNTPLastSync, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, sNTPPrimaryServer=sNTPPrimaryServer, vectorError=vectorError, ethernetPriorityTable=ethernetPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, targetMACAddress=targetMACAddress, dfs=dfs, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, bandwidthVariant=bandwidthVariant, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rxColorCode=rxColorCode, sNTPSync=sNTPSync, automaticTxPowerControl=automaticTxPowerControl, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptp=ptp, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddressType=remoteInternetAddressType, productName=productName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, ethernetBridgingAvailability=ethernetBridgingAvailability, userEnabled=userEnabled, installStatus=installStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTable=dfsTable, ptp600=ptp600)
