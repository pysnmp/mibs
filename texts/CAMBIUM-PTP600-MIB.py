...
enterprises, Counter64, Unsigned32, TimeTicks, NotificationType, Integer32, MibIdentifier, Bits, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Unsigned32", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier", "Bits", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", gatewayIPAddress=gatewayIPAddress, managementPortStatus=managementPortStatus, ethernetBridgingStatus=ethernetBridgingStatus, productVariant=productVariant, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6Address=iPv6Address, channelBandwidth=channelBandwidth, txColorCode=txColorCode, sntp=sntp, tFTPServerInternetAddress=tFTPServerInternetAddress, secureModeAlarm=secureModeAlarm, syslogControlGroup=syslogControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, supplementaryGroup=supplementaryGroup, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, sntpGroup=sntpGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNMPPortNumber=sNMPPortNumber, rxColorCode=rxColorCode, encryptionGroup=encryptionGroup, iPv6PrefixLength=iPv6PrefixLength, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, phyControl=phyControl, smtp=smtp, managementPortDisabledWarning=managementPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, ethernetGroup=ethernetGroup, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, alarmsGroup=alarmsGroup, dfsGroup=dfsGroup, sNTPServerTable=sNTPServerTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, targetMACAddress=targetMACAddress, antennaGain=antennaGain, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogState=syslogState, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, configuration=configuration, pubStatsGroup=pubStatsGroup, remoteRxTargetPower=remoteRxTargetPower, channelBCableLength=channelBCableLength, transmitFreqMHz=transmitFreqMHz, installStatus=installStatus, tDDControlGroup=tDDControlGroup, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortStatusTrap=managementPortStatusTrap, securityLevel=securityLevel, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTable=iPDSCPPriorityTable, notificationsGroup=notificationsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, resetGroup=resetGroup, telecomsChannelAStatus=telecomsChannelAStatus, subnetMask=subnetMask, hAZLOCConfiguration=hAZLOCConfiguration, systemClock=systemClock, managementMode=managementMode, siteName=siteName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, eIRP=eIRP, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfs=dfs, receiveChannel=receiveChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBLoopback=channelBLoopback, telecomsChannelSelection=telecomsChannelSelection, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, installArmStateTrap=installArmStateTrap, dfsTable=dfsTable, productName=productName, linkSymmetry=linkSymmetry, channelALineCode=channelALineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bridgeGroup=bridgeGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, alarms=alarms, dataPortFiberStatus=dataPortFiberStatus, sNTPServerPortNumber=sNTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, timeZone=timeZone, ethernetFiberSupport=ethernetFiberSupport, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimisation=linkModeOptimisation, userTable=userTable, versions=versions, sMTPServerInternetAddress=sMTPServerInternetAddress, byteErrorRatio=byteErrorRatio, smtpGroup=smtpGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry, telecomsInterface=telecomsInterface, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, PYSNMP_MODULE_ID=cambium, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userName=userName, sNTPState=sNTPState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, receiveFreqKHz=receiveFreqKHz, receivePower=receivePower, channelALoopback=channelALoopback, tDDControl=tDDControl, encryption=encryption, channelChangeTrap=channelChangeTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerIPAddress=sNTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteInternetAddress=remoteInternetAddress, hTTPSPortNumber=hTTPSPortNumber, transmitModulationMode=transmitModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, bootVersion=bootVersion, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerIPAddress=tFTPServerIPAddress, cambium=cambium, iPv4Address=iPv4Address, sMTPEmailAlert=sMTPEmailAlert, encryptionAlgorithm=encryptionAlgorithm, groupID=groupID, channelALoopbackTrap=channelALoopbackTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, frequencyVariant=frequencyVariant, localPacketFiltering=localPacketFiltering, transmitChannel=transmitChannel, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, sNTPServerTimeout=sNTPServerTimeout, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, longitude=longitude, regionCodeTrap=regionCodeTrap, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetPortNumber=telnetPortNumber, regionCode=regionCode, secureModeAlarmTrap=secureModeAlarmTrap, channelACableLength=channelACableLength, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, telnetAccessEnabled=telnetAccessEnabled, altitude=altitude, dfsMeans=dfsMeans, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, transmitPower=transmitPower, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, reset=reset, ptmp=ptmp, phyControlGroup=phyControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, managementGroup=managementGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubStats=pubStats, linkLoss=linkLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPPortNumber=hTTPPortNumber, iPVersion=iPVersion, userTableNumber=userTableNumber, sNTPServerStatus=sNTPServerStatus, automaticTxPowerControl=automaticTxPowerControl, licence=licence, supplementary=supplementary, bridge=bridge, sNTPPollInterval=sNTPPollInterval, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, userPassword=userPassword, channelBLineCode=channelBLineCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, qOSPriorityScheme=qOSPriorityScheme, userRole=userRole, telecomGroup=telecomGroup, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ptp600=ptp600, range=range, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, dfsTableEntry=dfsTableEntry, ethernet=ethernet, rangingMode=rangingMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecom=telecom, channelBLoopbackTrap=channelBLoopbackTrap, ptpGroups=ptpGroups, targetRange=targetRange, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, managementPortWirelessDownAlert=managementPortWirelessDownAlert)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteInternetAddressType=remoteInternetAddressType, sNMPv3Enable=sNMPv3Enable, ptp=ptp, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, userTableIndex=userTableIndex, latitude=latitude, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, installStatusTrap=installStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSyncTrap=sNTPSyncTrap, remoteIPAddress=remoteIPAddress, vLANManagementPriority=vLANManagementPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bandwidthVariant=bandwidthVariant, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, daylightSaving=daylightSaving, sNTPServerTableEntry=sNTPServerTableEntry, sNTPLastSync=sNTPLastSync, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userEnabled=userEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rawReceivePower=rawReceivePower, sNTPPrimaryServer=sNTPPrimaryServer, syslogClient=syslogClient, snmpControl=snmpControl, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, signalStrengthRatio=signalStrengthRatio, aAAControl=aAAControl, receiveModulationModeDetail=receiveModulationModeDetail, ptpCompliance=ptpCompliance, mPLSTCPriorityTable=mPLSTCPriorityTable, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetBridgingAvailability=ethernetBridgingAvailability, systemReset=systemReset, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, l2CPPriorityTable=l2CPPriorityTable, management=management, sNMPTrapVersion=sNMPTrapVersion)
