...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, automaticTxPowerControl=automaticTxPowerControl, notificationsGroup=notificationsGroup, securityLevel=securityLevel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControlGroup=tDDControlGroup, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelBStatus=telecomsChannelBStatus, iPv6GatewayAddress=iPv6GatewayAddress, hardwareVersion=hardwareVersion, managementMode=managementMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddress=tFTPServerInternetAddress, searchState=searchState, bandwidthVariant=bandwidthVariant, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelALineCode=channelALineCode, configuration=configuration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerIPAddress=sNTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibration=unitOutOfCalibration, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelALoopbackTrap=channelALoopbackTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteInternetAddressType=remoteInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBandwidth=channelBandwidth, dfs=dfs, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCode=regionCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, accessMethod=accessMethod, targetRange=targetRange, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerTableIndex=sNTPServerTableIndex, softwareVersion=softwareVersion, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridge=bridge, receiveModulationMode=receiveModulationMode, regionCodeTrap=regionCodeTrap, phyControlGroup=phyControlGroup, ptp=ptp, userName=userName, telecom=telecom, channelACableLength=channelACableLength, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, snmpControlGroup=snmpControlGroup, systemClock=systemClock, ethernet=ethernet, iPDSCPPriorityTable=iPDSCPPriorityTable, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, syslogControl=syslogControl, dfsTableEntry=dfsTableEntry, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rawReceivePower=rawReceivePower, snmpControl=snmpControl, tDDControl=tDDControl, bridgeGroup=bridgeGroup, dfsTableIndex=dfsTableIndex, productVariant=productVariant, hTTPPortNumber=hTTPPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, linkSymmetry=linkSymmetry, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitChannel=transmitChannel, syslogState=syslogState, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, sntpGroup=sntpGroup, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, byteErrorRatio=byteErrorRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPVersion=iPVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hAZLOCConfiguration=hAZLOCConfiguration, dfsPeaks=dfsPeaks, siteName=siteName, channelBLoopback=channelBLoopback, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userRole=userRole, sNTPServerStatus=sNTPServerStatus, userPassword=userPassword, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, managementPortDisabledWarning=managementPortDisabledWarning, ptpCompliance=ptpCompliance, channelBCableLength=channelBCableLength, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, transmitDataRate=transmitDataRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rangingMode=rangingMode, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveDataRate=receiveDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, management=management, ethernetBridgingStatus=ethernetBridgingStatus, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, installStatus=installStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, sMTPEmailAlert=sMTPEmailAlert, ptp600=ptp600, latitude=latitude, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, rxColorCode=rxColorCode, linkName=linkName, iPv6PrefixLength=iPv6PrefixLength, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableIndex=userTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, linkLoss=linkLoss, ptpGroups=ptpGroups, installArmState=installArmState, receivePower=receivePower, sNTPServerRetries=sNTPServerRetries, remoteIPAddress=remoteIPAddress, sNTPServerTimeout=sNTPServerTimeout, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, productName=productName, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableLoss=cableLoss, groupID=groupID, sNTPServerPortNumber=sNTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, sNTPServerTable=sNTPServerTable, secureModeAlarm=secureModeAlarm, channelChangeTrap=channelChangeTrap, vLANManagementVID=vLANManagementVID, supplementary=supplementary, telecomGroup=telecomGroup, versions=versions, alarms=alarms, linkModeOptimisation=linkModeOptimisation, telecomsChannelAStatus=telecomsChannelAStatus, systemReset=systemReset, remoteRxTargetPower=remoteRxTargetPower, secureModeAlarmTrap=secureModeAlarmTrap, versionsGroup=versionsGroup, aAAControl=aAAControl, encryptionGroup=encryptionGroup, sNTPServerTableNumber=sNTPServerTableNumber, ptpTraps=ptpTraps, telecomsChannelSelection=telecomsChannelSelection, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBLineCode=channelBLineCode, iPv6Address=iPv6Address, cambium=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsGroup=dfsGroup, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, subnetMask=subnetMask, phyStatus=phyStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, daylightSaving=daylightSaving, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, transmitPower=transmitPower, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, remoteInternetAddress=remoteInternetAddress, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, iPv4Address=iPv4Address, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortStatus=dataPortStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPState=sNTPState, installArmStateTrap=installArmStateTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, localPacketFiltering=localPacketFiltering, managementGroup=managementGroup, dfsTable=dfsTable, dfsMeans=dfsMeans, managementPortStatus=managementPortStatus, smtpGroup=smtpGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, txColorCode=txColorCode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTable=userTable, wirelessLinkAvailability=wirelessLinkAvailability, hTTPAccessEnabled=hTTPAccessEnabled, alarmsGroup=alarmsGroup, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTable=ethernetPriorityTable, userTableEntry=userTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALoopback=channelALoopback, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, dataPortConfigurationMismatch=dataPortConfigurationMismatch)
