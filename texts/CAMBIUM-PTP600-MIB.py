...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogClientTrap=syslogClientTrap, ptpCompliance=ptpCompliance, phyStatus=phyStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, subnetMask=subnetMask, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, alarmsGroup=alarmsGroup, sNTPServerRetries=sNTPServerRetries, aAAControlGroup=aAAControlGroup, targetRange=targetRange, txColorCode=txColorCode, hTTPPortNumber=hTTPPortNumber, vLANManagementVID=vLANManagementVID, channelBandwidth=channelBandwidth, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, userName=userName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hardwareVersion=hardwareVersion, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, userRole=userRole, altitude=altitude, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, secureModeAlarm=secureModeAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, licence=licence, searchState=searchState, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALoopbackTrap=channelALoopbackTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitPower=transmitPower, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSync=sNTPSync, rangingMode=rangingMode, linkSymmetry=linkSymmetry, receiveChannel=receiveChannel, userTableEntry=userTableEntry, iPv6Address=iPv6Address, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, tDDControl=tDDControl, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogControl=syslogControl, hTTPSPortNumber=hTTPSPortNumber, timeZone=timeZone, telecomsChannelAStatus=telecomsChannelAStatus, telnetPortNumber=telnetPortNumber, sNTPServerTimeout=sNTPServerTimeout, ethernet=ethernet, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, phyControl=phyControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsChannelSelection=telecomsChannelSelection, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, configuration=configuration, encryption=encryption, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerInternetAddress=sMTPServerInternetAddress, latitude=latitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBLineCode=channelBLineCode, linkLoss=linkLoss, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, sNTPServerStatus=sNTPServerStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cambium=cambium, userTableNumber=userTableNumber, managementPortStatus=managementPortStatus, receiveDataRate=receiveDataRate, systemClock=systemClock, bridgeGroup=bridgeGroup, receiveFreqMHz=receiveFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelACableLength=channelACableLength, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortAutoMdix=dataPortAutoMdix, management=management, managementPortConfigurationMismatch=managementPortConfigurationMismatch, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, configurationGroup=configurationGroup, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, rawReceivePower=rawReceivePower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, channelChangeTrap=channelChangeTrap, reset=reset, signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelBStatus=telecomsChannelBStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, remoteInternetAddress=remoteInternetAddress, telecomsInterface=telecomsInterface, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTable=sNMPTrapTable, userTable=userTable, encryptionGroup=encryptionGroup, dfsTableIndex=dfsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, rxColorCode=rxColorCode, range=range, sNMPv3Enable=sNMPv3Enable, wirelessLinkAvailability=wirelessLinkAvailability, tDDControlGroup=tDDControlGroup, ptmp=ptmp, telecomGroup=telecomGroup, iPVersion=iPVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, dfsGroup=dfsGroup, aggregateDataRate=aggregateDataRate, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, qOSPriorityScheme=qOSPriorityScheme, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortStatusTrap=managementPortStatusTrap, telecom=telecom, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementaryGroup=supplementaryGroup, l2CPPriorityTable=l2CPPriorityTable, targetMACAddress=targetMACAddress, channelALoopback=channelALoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, installArmStateTrap=installArmStateTrap, automaticTxPowerControl=automaticTxPowerControl, tDDSynchronizationStatus=tDDSynchronizationStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementPriority=vLANManagementPriority, transmitDataRate=transmitDataRate, dSCPManagementPriority=dSCPManagementPriority, iPv6PrefixLength=iPv6PrefixLength, remoteRxTargetPower=remoteRxTargetPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp600=ptp600, frequencyVariant=frequencyVariant, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userEnabled=userEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, installStatus=installStatus, dfsPeaks=dfsPeaks, managementPortDisabledWarning=managementPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, localPacketFiltering=localPacketFiltering, resetGroup=resetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, iPv6GatewayAddress=iPv6GatewayAddress, channelBLoopback=channelBLoopback, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, securityLevel=securityLevel, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBCableLength=channelBCableLength, tFTPServerPortNumber=tFTPServerPortNumber, eIRP=eIRP, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, regionCodeTrap=regionCodeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, masterSlaveMode=masterSlaveMode, channelALineCode=channelALineCode, managementMode=managementMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bridge=bridge, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secondarySoftwareVersion=secondarySoftwareVersion, dfsTable=dfsTable, syslogClient=syslogClient, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, transmitModulationMode=transmitModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, receivePower=receivePower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControl=snmpControl, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, dfs=dfs, productVariant=productVariant, ethernetGroup=ethernetGroup, cableLoss=cableLoss, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, phyControlGroup=phyControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatus=ethernetBridgingStatus, longitude=longitude, hAZLOCConfiguration=hAZLOCConfiguration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aAAControl=aAAControl, groupID=groupID, licenceGroup=licenceGroup, syslogControlGroup=syslogControlGroup, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, userPassword=userPassword, sNTPServerTable=sNTPServerTable, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpTraps=ptpTraps, productName=productName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sntpGroup=sntpGroup, tDDSynchronizationMode=tDDSynchronizationMode, installArmState=installArmState)
