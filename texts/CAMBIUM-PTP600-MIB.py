...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableNumber=sNTPServerTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelALoopbackTrap=channelALoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, sMTPEmailAlert=sMTPEmailAlert, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqMHz=receiveFreqMHz, managementPortDisabledWarning=managementPortDisabledWarning, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaGain=antennaGain, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installArmStateTrap=installArmStateTrap, management=management, smtp=smtp, supplementary=supplementary, syslogStateTrap=syslogStateTrap, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, iPVersion=iPVersion, linkModeOptimisation=linkModeOptimisation, ptp=ptp, linkLoss=linkLoss, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerInternetAddress=sNTPServerInternetAddress, managementMode=managementMode, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableEntry=dfsTableEntry, systemReset=systemReset, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, sntp=sntp, tDDControl=tDDControl, licence=licence, sNMPv3Enable=sNMPv3Enable, transmitPower=transmitPower, userPassword=userPassword, rxColorCode=rxColorCode, receiveModulationMode=receiveModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogClientTrap=syslogClientTrap, channelBLoopback=channelBLoopback, dfsPeaks=dfsPeaks, remoteInternetAddressType=remoteInternetAddressType, txColorCode=txColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, linkSymmetry=linkSymmetry, aAAControlGroup=aAAControlGroup, channelALineCode=channelALineCode, iPv6Address=iPv6Address, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, ethernetPriorityTable=ethernetPriorityTable, searchState=searchState, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoMdix=dataPortAutoMdix, ptp600=ptp600, reset=reset, ethernetPriorityTableNumber=ethernetPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, channelBCableLength=channelBCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, encryption=encryption, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, timeZone=timeZone, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, regionCode=regionCode, receiveFreqKHz=receiveFreqKHz, dataPortFiberStatus=dataPortFiberStatus, alarms=alarms, phyStatus=phyStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCodeTrap=regionCodeTrap, userTable=userTable, vLANManagementVID=vLANManagementVID, ptmp=ptmp, channelBLineCode=channelBLineCode, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, bridge=bridge, wirelessLinkStatus=wirelessLinkStatus, installStatusTrap=installStatusTrap, sNTPLastSync=sNTPLastSync, iPv6GatewayAddress=iPv6GatewayAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortAutoNegotiation=dataPortAutoNegotiation, configuration=configuration, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, managementPortStatusTrap=managementPortStatusTrap, securityLevel=securityLevel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, eIRP=eIRP, sNMPTrapIPAddress=sNMPTrapIPAddress, daylightSaving=daylightSaving, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, rawReceivePower=rawReceivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, userEnabled=userEnabled, gatewayIPAddress=gatewayIPAddress, managementPortStatus=managementPortStatus, aggregateDataRate=aggregateDataRate, vLANManagementPriority=vLANManagementPriority, ptpCompliance=ptpCompliance, syslogControl=syslogControl, telecomsChannelAStatus=telecomsChannelAStatus, managementGroup=managementGroup, ethernetGroup=ethernetGroup, channelALoopback=channelALoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, userName=userName, byteErrorRatio=byteErrorRatio, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPCommunityString=sNMPCommunityString, userRole=userRole, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, versionsGroup=versionsGroup, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsGroup=dfsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControlGroup=syslogControlGroup, localPacketFiltering=localPacketFiltering, siteName=siteName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, dfs=dfs, ptpGroups=ptpGroups, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecom=telecom, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableNumber=dfsTableNumber, altitude=altitude, secureModeAlarm=secureModeAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveChannel=receiveChannel, sNTPServerTable=sNTPServerTable, installStatus=installStatus, sNTPServerStatus=sNTPServerStatus, qOSPriorityScheme=qOSPriorityScheme, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod, vectorError=vectorError, phyControlGroup=phyControlGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogState=syslogState, latitude=latitude, telecomsChannelSelection=telecomsChannelSelection, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationModeDetail=receiveModulationModeDetail, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, range=range, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerRetries=sNTPServerRetries, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetMACAddress=targetMACAddress, telecomsInterface=telecomsInterface, bootVersion=bootVersion, telecomsChannelBStatus=telecomsChannelBStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, notificationsGroup=notificationsGroup, groupID=groupID, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, iPv6PrefixLength=iPv6PrefixLength, dfsTableIndex=dfsTableIndex, productName=productName, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogClient=syslogClient, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, receivePower=receivePower, longitude=longitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sntpGroup=sntpGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitChannel=transmitChannel, dfsTable=dfsTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenceGroup=licenceGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, dataPortStatus=dataPortStatus, automaticTxPowerControl=automaticTxPowerControl, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, iPDSCPPriorityTable=iPDSCPPriorityTable, installArmState=installArmState, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, remoteRxTargetPower=remoteRxTargetPower, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerTimeout=sNTPServerTimeout, userTableEntry=userTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, pubStats=pubStats, bridgeGroup=bridgeGroup, cambium=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControl=phyControl, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetRange=targetRange, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, userTableIndex=userTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, PYSNMP_MODULE_ID=cambium, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv4Address=iPv4Address, constantPowerSpectralDensity=constantPowerSpectralDensity, channelACableLength=channelACableLength, tFTPServerInternetAddressType=tFTPServerInternetAddressType)
