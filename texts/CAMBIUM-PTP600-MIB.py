...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", targetMACAddress=targetMACAddress, transmitFreqKHz=transmitFreqKHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv4Address=iPv4Address, phyStatus=phyStatus, supplementary=supplementary, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, telecomsChannelBStatus=telecomsChannelBStatus, rangingMode=rangingMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp600=ptp600, eIRP=eIRP, receiveChannel=receiveChannel, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveModulationModeDetail=receiveModulationModeDetail, ethernetFiberSupport=ethernetFiberSupport, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, sntp=sntp, linkLoss=linkLoss, sNTPServerTableIndex=sNTPServerTableIndex, systemReset=systemReset, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, frequencyVariant=frequencyVariant, channelBCableLength=channelBCableLength, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, txColorCode=txColorCode, secureModeAlarmTrap=secureModeAlarmTrap, sNMPPortNumber=sNMPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cambium=cambium, searchState=searchState, bridge=bridge, localPacketFiltering=localPacketFiltering, userTableIndex=userTableIndex, ptmp=ptmp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkName=linkName, bandwidthVariant=bandwidthVariant, bridgeGroup=bridgeGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, cableLoss=cableLoss, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, productName=productName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configuration=configuration, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, aAAControl=aAAControl, remoteRxTargetPower=remoteRxTargetPower, hardwareVersion=hardwareVersion, rxColorCode=rxColorCode, pubStatsGroup=pubStatsGroup, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, management=management, versions=versions, ptpTraps=ptpTraps, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteInternetAddress=remoteInternetAddress, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, pubStats=pubStats, ethernetGroup=ethernetGroup, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, sNTPLastSync=sNTPLastSync, managementGroup=managementGroup, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, encryption=encryption, tDDControl=tDDControl, bootVersion=bootVersion, dataPortFiberStatus=dataPortFiberStatus, telnetPortNumber=telnetPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, notificationsGroup=notificationsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapVersion=sNMPTrapVersion, telecom=telecom, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecomsChannelSelection=telecomsChannelSelection, sMTPServerInternetAddressType=sMTPServerInternetAddressType, targetRange=targetRange, ethernetPriorityTable=ethernetPriorityTable, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, PYSNMP_MODULE_ID=cambium, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerStatus=sNTPServerStatus, receiveFreqMHz=receiveFreqMHz, subnetMask=subnetMask, sNTPServerRetries=sNTPServerRetries, aAAControlGroup=aAAControlGroup, sNTPSync=sNTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBLoopback=channelBLoopback, managementPortStatusTrap=managementPortStatusTrap, aggregateDataRate=aggregateDataRate, iPVersion=iPVersion, installStatusTrap=installStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelAStatus=telecomsChannelAStatus, channelALoopback=channelALoopback, iPv6Address=iPv6Address, antennaGain=antennaGain, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, groupID=groupID, installArmState=installArmState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetBridgingStatus=ethernetBridgingStatus, secureModeAlarm=secureModeAlarm, receiveModulationMode=receiveModulationMode, managementMode=managementMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfs=dfs, versionsGroup=versionsGroup, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddress=sNTPServerInternetAddress, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLineCode=channelBLineCode, userTable=userTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userRole=userRole, l2CPPriorityTable=l2CPPriorityTable, phyControl=phyControl, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, transmitChannel=transmitChannel, rawReceivePower=rawReceivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, longitude=longitude, transmitFreqMHz=transmitFreqMHz, managementPortStatus=managementPortStatus, tDDControlGroup=tDDControlGroup, altitude=altitude, installArmStateTrap=installArmStateTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, phyStatusGroup=phyStatusGroup, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userEnabled=userEnabled, siteName=siteName, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortDisabledWarning=managementPortDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBandwidth=channelBandwidth, transmitPower=transmitPower, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, syslogControl=syslogControl, ptpCompliance=ptpCompliance, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableIndex=dfsTableIndex, installStatus=installStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, licence=licence, linkSymmetry=linkSymmetry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, encryptionGroup=encryptionGroup, linkModeOptimisation=linkModeOptimisation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogStateTrap=syslogStateTrap, dfsTableNumber=dfsTableNumber, automaticTxPowerControl=automaticTxPowerControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBLoopbackTrap=channelBLoopbackTrap, telnetAccessEnabled=telnetAccessEnabled, securityLevel=securityLevel, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, alarmsGroup=alarmsGroup, syslogClientTrap=syslogClientTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, alarms=alarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsMeans=dfsMeans, hTTPPortNumber=hTTPPortNumber, snmpControl=snmpControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsInterface=telecomsInterface, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, signalStrengthRatio=signalStrengthRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpGroups=ptpGroups, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortWirelessDownAlert=managementPortWirelessDownAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, reset=reset, dfsGroup=dfsGroup, sNTPState=sNTPState, receiveDataRate=receiveDataRate, resetGroup=resetGroup, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, range=range, channelALoopbackTrap=channelALoopbackTrap, channelACableLength=channelACableLength, channelALineCode=channelALineCode, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogClient=syslogClient, dfsTable=dfsTable, softwareVersion=softwareVersion, receivePower=receivePower, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetBridgingAvailability=ethernetBridgingAvailability, regionCodeTrap=regionCodeTrap, dataPortStatusTrap=dataPortStatusTrap, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernet=ethernet, qOSPriorityScheme=qOSPriorityScheme)
