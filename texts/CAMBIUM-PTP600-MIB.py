...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenceGroup=licenceGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, snmpControlGroup=snmpControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPEmailAlert=sMTPEmailAlert, ptpTraps=ptpTraps, sNTPPrimaryServer=sNTPPrimaryServer, notificationsGroup=notificationsGroup, l2CPPriorityTable=l2CPPriorityTable, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, ptp=ptp, systemReset=systemReset, userRole=userRole, userEnabled=userEnabled, cambium=cambium, cableLoss=cableLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSPortNumber=hTTPSPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, channelBCableLength=channelBCableLength, smtp=smtp, iPv6Address=iPv6Address, telecomsChannelSelection=telecomsChannelSelection, linkModeOptimisation=linkModeOptimisation, receiveDataRate=receiveDataRate, automaticTxPowerControl=automaticTxPowerControl, hTTPPortNumber=hTTPPortNumber, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, transmitPower=transmitPower, managementPortStatusTrap=managementPortStatusTrap, vLANManagementVID=vLANManagementVID, licence=licence, longitude=longitude, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerInternetAddress=sNTPServerInternetAddress, channelALoopback=channelALoopback, sntp=sntp, sNTPState=sNTPState, managementPortDisabledWarning=managementPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus, supplementaryGroup=supplementaryGroup, remoteInternetAddressType=remoteInternetAddressType, transmitFreqKHz=transmitFreqKHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelChangeTrap=channelChangeTrap, installStatusTrap=installStatusTrap, telecomGroup=telecomGroup, resetGroup=resetGroup, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementary=supplementary, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortFiberStatus=dataPortFiberStatus, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, rxColorCode=rxColorCode, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, securityLevel=securityLevel, syslogClient=syslogClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControl=aAAControl, linkName=linkName, sMTPServerIPAddress=sMTPServerIPAddress, transmitChannel=transmitChannel, sNMPCommunityString=sNMPCommunityString, regionCodeTrap=regionCodeTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, dfs=dfs, channelBLoopback=channelBLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelACableLength=channelACableLength, secureModeAlarm=secureModeAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorError=vectorError, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, alarms=alarms, configuration=configuration, tDDControl=tDDControl, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, regionCode=regionCode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hardwareVersion=hardwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsGroup=dfsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableIndex=dfsTableIndex, installStatus=installStatus, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bandwidthVariant=bandwidthVariant, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerRetries=sNTPServerRetries, versions=versions, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, sNTPServerIPAddress=sNTPServerIPAddress, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, managementMode=managementMode, dataPortDisabledWarning=dataPortDisabledWarning, linkSymmetry=linkSymmetry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, targetRange=targetRange, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, sNTPSyncTrap=sNTPSyncTrap, userTable=userTable, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, linkLoss=linkLoss, iPVersion=iPVersion, rangingMode=rangingMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userTableIndex=userTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPPollInterval=sNTPPollInterval, sNTPServerTimeout=sNTPServerTimeout, txColorCode=txColorCode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, remoteIPAddress=remoteIPAddress, ptp600=ptp600, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, frequencyVariant=frequencyVariant, sNTPSync=sNTPSync, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, telecomsInterface=telecomsInterface, altitude=altitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALineCode=channelALineCode, dataPortStatusTrap=dataPortStatusTrap, management=management, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetAccessEnabled=telnetAccessEnabled, byteErrorRatio=byteErrorRatio, transmitFreqMHz=transmitFreqMHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, channelALoopbackTrap=channelALoopbackTrap, bridgeGroup=bridgeGroup, iPv4Address=iPv4Address, telecom=telecom, managementPortStatus=managementPortStatus, sNTPServerStatus=sNTPServerStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddress=remoteInternetAddress, channelBLineCode=channelBLineCode, snmpControl=snmpControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, encryptionGroup=encryptionGroup, ptpTrapPrefix=ptpTrapPrefix, bridge=bridge, versionsGroup=versionsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, localPacketFiltering=localPacketFiltering, encryption=encryption, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, iPv6PrefixLength=iPv6PrefixLength, groupID=groupID, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkStatus=wirelessLinkStatus, dfsMeans=dfsMeans, aggregateDataRate=aggregateDataRate, dfsPeaks=dfsPeaks, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, secureModeAlarmTrap=secureModeAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementGroup=managementGroup, range=range, receiveChannel=receiveChannel)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, qOSPriorityScheme=qOSPriorityScheme, channelBLoopbackTrap=channelBLoopbackTrap, installArmStateTrap=installArmStateTrap, transmitDataRate=transmitDataRate, syslogStateTrap=syslogStateTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClientTrap=syslogClientTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationModeDetail=receiveModulationModeDetail, syslogState=syslogState, systemClock=systemClock, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, subnetMask=subnetMask, telnetPortNumber=telnetPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, rawReceivePower=rawReceivePower, channelBandwidth=channelBandwidth, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress, latitude=latitude, productVariant=productVariant, receiveModulationMode=receiveModulationMode, telecomsChannelBStatus=telecomsChannelBStatus, daylightSaving=daylightSaving, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, signalStrengthRatio=signalStrengthRatio, reset=reset, ethernetPriorityTable=ethernetPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubStats=pubStats)
