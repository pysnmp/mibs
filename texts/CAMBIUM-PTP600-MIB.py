...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vectorError=vectorError, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, management=management, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, dfsTable=dfsTable, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, userPassword=userPassword, installStatusTrap=installStatusTrap, iPVersion=iPVersion, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControlGroup=syslogControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, phyStatus=phyStatus, telecomGroup=telecomGroup, sNTPPrimaryServer=sNTPPrimaryServer, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, userTableIndex=userTableIndex, latitude=latitude, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelALineCode=channelALineCode, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, maximumTransmitPower=maximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, cableLoss=cableLoss, ptp600=ptp600, timeZone=timeZone, syslogState=syslogState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpGroups=ptpGroups, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetPriorityTableNumber=ethernetPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, telecom=telecom, telecomsChannelSelection=telecomsChannelSelection, sNTPServerStatus=sNTPServerStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptmp=ptmp, channelBLoopback=channelBLoopback, txColorCode=txColorCode, groupID=groupID, configuration=configuration, syslogControl=syslogControl, sNTPServerRetries=sNTPServerRetries, sNTPServerIPAddress=sNTPServerIPAddress, localPacketFiltering=localPacketFiltering, telecomsInterface=telecomsInterface, rxColorCode=rxColorCode, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, range=range, ethernetGroup=ethernetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, productName=productName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableIndex=dfsTableIndex, bandwidthVariant=bandwidthVariant, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, iPv6GatewayAddress=iPv6GatewayAddress, systemClock=systemClock, dataPortFiberStatus=dataPortFiberStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, dfsPeaks=dfsPeaks, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, versionsGroup=versionsGroup, regionCode=regionCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, tDDControl=tDDControl, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, unitOutOfCalibration=unitOutOfCalibration, channelBLineCode=channelBLineCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, remoteInternetAddress=remoteInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, sNTPServerTableNumber=sNTPServerTableNumber, snmpControl=snmpControl, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rangingMode=rangingMode, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, licence=licence, channelALoopbackTrap=channelALoopbackTrap, telecomsChannelBStatus=telecomsChannelBStatus, secureModeAlarm=secureModeAlarm, remoteRxTargetPower=remoteRxTargetPower, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernet=ethernet, tFTPServerInternetAddress=tFTPServerInternetAddress, dfs=dfs, versions=versions, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, altitude=altitude, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, userTableEntry=userTableEntry, hTTPPortNumber=hTTPPortNumber, softwareVersion=softwareVersion, iPv6PrefixLength=iPv6PrefixLength, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBCableLength=channelBCableLength, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelACableLength=channelACableLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTimeout=sNTPServerTimeout, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsGroup=dfsGroup, securityLevel=securityLevel, vLANManagementVID=vLANManagementVID, accessMethod=accessMethod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogClient=syslogClient, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, managementPortStatus=managementPortStatus, remoteInternetAddressType=remoteInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, phyControlGroup=phyControlGroup, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, automaticTxPowerControl=automaticTxPowerControl, frequencyVariant=frequencyVariant, sntp=sntp, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, hTTPAccessEnabled=hTTPAccessEnabled, receiveFreqMHz=receiveFreqMHz, encryption=encryption, eIRP=eIRP, resetGroup=resetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitFreqMHz=transmitFreqMHz, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelAStatus=telecomsChannelAStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, syslogStateTrap=syslogStateTrap, licenceGroup=licenceGroup, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelChangeTrap=channelChangeTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNMPPortNumber=sNMPPortNumber, searchState=searchState, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableEntry=dfsTableEntry, sNTPState=sNTPState, ptpTraps=ptpTraps, encryptionAlgorithm=encryptionAlgorithm, remoteIPAddress=remoteIPAddress, cambium=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, hardwareVersion=hardwareVersion, dSCPManagementPriority=dSCPManagementPriority, linkName=linkName, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, reset=reset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, transmitPower=transmitPower, l2CPPriorityTable=l2CPPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTable=sNTPServerTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, regionCodeTrap=regionCodeTrap, installArmStateTrap=installArmStateTrap, phyControl=phyControl)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, installArmState=installArmState, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, linkLoss=linkLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPSyncTrap=sNTPSyncTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, targetRange=targetRange, sNMPCommunityString=sNMPCommunityString, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementMode=managementMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, secureModeAlarmTrap=secureModeAlarmTrap, supplementary=supplementary, iPv6Address=iPv6Address, bridge=bridge, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, snmpControlGroup=snmpControlGroup, installStatus=installStatus, hTTPSPortNumber=hTTPSPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, managementPortConfigurationMismatch=managementPortConfigurationMismatch, channelALoopback=channelALoopback, aAAControl=aAAControl, userTable=userTable, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoMdix=dataPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemReset=systemReset, bridgeGroup=bridgeGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPv4Address=iPv4Address, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex)
