...
enterprises, Counter64, TimeTicks, IpAddress, ObjectIdentity, Bits, ModuleIdentity, MibIdentifier, iso, Gauge32, NotificationType, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "TimeTicks", "IpAddress", "ObjectIdentity", "Bits", "ModuleIdentity", "MibIdentifier", "iso", "Gauge32", "NotificationType", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, accessMethod=accessMethod, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVID=vLANManagementVID, dfsPeaks=dfsPeaks, localPacketFiltering=localPacketFiltering, cambium=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptp600=ptp600, managementPortStatus=managementPortStatus, snmpControl=snmpControl, telecomsChannelAStatus=telecomsChannelAStatus, automaticTxPowerControl=automaticTxPowerControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTable=sNTPServerTable, alarms=alarms, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, daylightSaving=daylightSaving, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, encryptionAlgorithm=encryptionAlgorithm, configurationGroup=configurationGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, smtpGroup=smtpGroup, reset=reset, l2CPPriorityTable=l2CPPriorityTable, dfsTable=dfsTable, licenceGroup=licenceGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rangingMode=rangingMode, sNMPv3Enable=sNMPv3Enable, dataPortFiberStatusTrap=dataPortFiberStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationMode=receiveModulationMode, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receivePower=receivePower, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userRole=userRole, userTable=userTable, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, frequencyVariant=frequencyVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfs=dfs, linkName=linkName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, sntp=sntp, sMTPServerInternetAddressType=sMTPServerInternetAddressType, productName=productName, searchState=searchState, sNTPSync=sNTPSync, pubStats=pubStats, channelBLoopback=channelBLoopback, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableEntry=userTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, subnetMask=subnetMask, targetRange=targetRange, sNMPTrapVersion=sNMPTrapVersion, linkSymmetry=linkSymmetry, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, sntpGroup=sntpGroup, bridge=bridge, installArmState=installArmState, txColorCode=txColorCode, transmitChannel=transmitChannel, sNTPServerStatus=sNTPServerStatus, encryptionGroup=encryptionGroup, installStatusTrap=installStatusTrap, hAZLOCConfiguration=hAZLOCConfiguration, aAAControl=aAAControl, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, versions=versions, configuration=configuration, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBLineCode=channelBLineCode, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPVersion=iPVersion, hTTPAccessEnabled=hTTPAccessEnabled, linkLoss=linkLoss, phyStatusGroup=phyStatusGroup, channelChangeTrap=channelChangeTrap, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, dataPortFiberStatus=dataPortFiberStatus, targetMACAddress=targetMACAddress, transmitFreqKHz=transmitFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, syslogControlGroup=syslogControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, altitude=altitude, masterSlaveMode=masterSlaveMode, iPv6PrefixLength=iPv6PrefixLength, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsChannelSelection=telecomsChannelSelection, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, iPv6Address=iPv6Address, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, sNTPState=sNTPState, sNTPServerTableEntry=sNTPServerTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cableLoss=cableLoss, range=range, channelBLoopbackTrap=channelBLoopbackTrap, channelACableLength=channelACableLength, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, siteName=siteName, vectorError=vectorError, ptpTraps=ptpTraps, ethernetPriorityTableIndex=ethernetPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, management=management, sNTPServerInternetAddress=sNTPServerInternetAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogControl=syslogControl, transmitModulationMode=transmitModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, qOSPriorityScheme=qOSPriorityScheme, userTableNumber=userTableNumber, tDDControl=tDDControl, managementMode=managementMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, userTableIndex=userTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, encryption=encryption, mPLSTCPriorityTable=mPLSTCPriorityTable, linkModeOptimisation=linkModeOptimisation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelALineCode=channelALineCode, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptp=ptp, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveChannel=receiveChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, regionCodeTrap=regionCodeTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, managementPortStatusTrap=managementPortStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, securityLevel=securityLevel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, managementPortDisabledWarning=managementPortDisabledWarning, PYSNMP_MODULE_ID=cambium, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementary=supplementary, remoteInternetAddress=remoteInternetAddress, versionsGroup=versionsGroup, dfsTableNumber=dfsTableNumber, transmitPower=transmitPower, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, latitude=latitude, channelBCableLength=channelBCableLength, softwareVersion=softwareVersion, channelALoopbackTrap=channelALoopbackTrap, rawReceivePower=rawReceivePower, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsGroup=dfsGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxColorCode=rxColorCode, incompatibleRegionCodes=incompatibleRegionCodes, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, userName=userName, userEnabled=userEnabled, ptmp=ptmp)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernet=ethernet, syslogState=syslogState, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecom=telecom, channelALoopback=channelALoopback, sNTPServerTimeout=sNTPServerTimeout, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, systemReset=systemReset, userPassword=userPassword, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dSCPManagementPriority=dSCPManagementPriority, smtp=smtp, ethernetPriorityTable=ethernetPriorityTable, licence=licence, productVariant=productVariant, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv4Address=iPv4Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatus=dataPortStatus, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, bridgeGroup=bridgeGroup, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, resetGroup=resetGroup, installStatus=installStatus, phyStatus=phyStatus, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelBStatus=telecomsChannelBStatus, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqKHz=receiveFreqKHz, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hardwareVersion=hardwareVersion, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyControlGroup=phyControlGroup)
