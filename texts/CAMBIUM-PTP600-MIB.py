...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", cambium=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, installArmState=installArmState, sNTPServerTableNumber=sNTPServerTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStats=pubStats, transmitPower=transmitPower, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, sNTPServerTable=sNTPServerTable, txColorCode=txColorCode, receiveModulationMode=receiveModulationMode, userTableNumber=userTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, sNTPServerTimeout=sNTPServerTimeout, sNMPEnabledTraps=sNMPEnabledTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, licence=licence, ethernetPriorityTable=ethernetPriorityTable, ptp600=ptp600, installStatus=installStatus, hTTPSPortNumber=hTTPSPortNumber, phyControl=phyControl, productVariant=productVariant, channelALoopbackTrap=channelALoopbackTrap, versions=versions, licenceGroup=licenceGroup, ptpTraps=ptpTraps, dfsPeaks=dfsPeaks, iPVersion=iPVersion, altitude=altitude, encryption=encryption, receiveModulationModeDetail=receiveModulationModeDetail, telecomsInterface=telecomsInterface, ethernetBridgingAvailability=ethernetBridgingAvailability, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, remoteIPAddress=remoteIPAddress, userPassword=userPassword, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkName=linkName, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telecomsChannelSelection=telecomsChannelSelection, managementMode=managementMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6Address=iPv6Address, tDDControlGroup=tDDControlGroup, rxColorCode=rxColorCode, sNMPTrapTableIndex=sNMPTrapTableIndex, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, telecomGroup=telecomGroup, groupID=groupID, alarms=alarms, systemClock=systemClock, dfsGroup=dfsGroup, linkModeOptimisation=linkModeOptimisation, alarmsGroup=alarmsGroup, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, systemReset=systemReset, sMTPEmailAlert=sMTPEmailAlert, syslogState=syslogState, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, dfsTableNumber=dfsTableNumber, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatus=phyStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, transmitDataRate=transmitDataRate, iPv4Address=iPv4Address, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, latitude=latitude, dfsTableIndex=dfsTableIndex, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, configuration=configuration, ptpGroups=ptpGroups, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkLoss=linkLoss, sNTPState=sNTPState, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableLoss=cableLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortFiberStatus=dataPortFiberStatus, automaticTxPowerControl=automaticTxPowerControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANManagementPriority=vLANManagementPriority, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, supplementaryGroup=supplementaryGroup, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, receivePower=receivePower, channelBCableLength=channelBCableLength, userName=userName, managementGroup=managementGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userRole=userRole, hTTPSAccessEnabled=hTTPSAccessEnabled, channelACableLength=channelACableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPSync=sNTPSync, sNTPPrimaryServer=sNTPPrimaryServer, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBLineCode=channelBLineCode, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortStatus=managementPortStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, PYSNMP_MODULE_ID=cambium, eIRP=eIRP, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, syslogControl=syslogControl, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, ethernet=ethernet, transmitFreqKHz=transmitFreqKHz, userTable=userTable, subnetMask=subnetMask, daylightSaving=daylightSaving, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPollInterval=sNTPPollInterval, syslogClient=syslogClient, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, dfs=dfs, receiveFreqMHz=receiveFreqMHz, sNTPServerStatus=sNTPServerStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortStatus=dataPortStatus, channelChangeTrap=channelChangeTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, localPacketFiltering=localPacketFiltering, dfsTableEntry=dfsTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, aggregateDataRate=aggregateDataRate, sntp=sntp, sNMPCommunityString=sNMPCommunityString, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteRxTargetPower=remoteRxTargetPower, hardwareVersion=hardwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productName=productName, range=range, channelALoopback=channelALoopback, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTable=sNMPTrapTable, searchState=searchState, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, installArmStateTrap=installArmStateTrap, transmitChannel=transmitChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogClientTrap=syslogClientTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, frequencyVariant=frequencyVariant, maximumTransmitPower=maximumTransmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTableEntry=userTableEntry, securityLevel=securityLevel, ptpTrapPrefix=ptpTrapPrefix, managementPortStatusTrap=managementPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntpGroup=sntpGroup, sNMPv3Enable=sNMPv3Enable, smtp=smtp, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, secureModeAlarm=secureModeAlarm, userEnabled=userEnabled, tDDControl=tDDControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetRange=targetRange, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dSCPManagementPriority=dSCPManagementPriority, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPSyncTrap=sNTPSyncTrap, targetMACAddress=targetMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, secureModeAlarmTrap=secureModeAlarmTrap, sNMPPortNumber=sNMPPortNumber, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, userTableIndex=userTableIndex, sNMPTrapVersion=sNMPTrapVersion, dfsTable=dfsTable)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, linkSymmetry=linkSymmetry, bridge=bridge, l2CPPriorityTableNumber=l2CPPriorityTableNumber, supplementary=supplementary, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, telecom=telecom, iPv6PrefixLength=iPv6PrefixLength, ethernetFiberSupport=ethernetFiberSupport, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, rawReceivePower=rawReceivePower, notificationsGroup=notificationsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALineCode=channelALineCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBLoopback=channelBLoopback, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortDisabledWarning=managementPortDisabledWarning, hAZLOCConfiguration=hAZLOCConfiguration, phyStatusGroup=phyStatusGroup, sNTPServerTableIndex=sNTPServerTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, resetGroup=resetGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, management=management, masterSlaveMode=masterSlaveMode, vectorError=vectorError, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, softwareVersion=softwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableEntry=sNTPServerTableEntry)
