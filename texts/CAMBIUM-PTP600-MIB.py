...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, rxColorCode=rxColorCode, ethernetGroup=ethernetGroup, installArmState=installArmState, dfsTable=dfsTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetRange=targetRange, reset=reset, siteName=siteName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, snmpControlGroup=snmpControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receivePower=receivePower, transmitModulationMode=transmitModulationMode, ethernetFiberSupport=ethernetFiberSupport, systemReset=systemReset, userName=userName, userRole=userRole, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configuration=configuration, rawReceivePower=rawReceivePower, userTableNumber=userTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPVersion=iPVersion, ethernetBridgingStatus=ethernetBridgingStatus, bridgeGroup=bridgeGroup, range=range, supplementaryGroup=supplementaryGroup, secureModeAlarm=secureModeAlarm, remoteInternetAddressType=remoteInternetAddressType, ethernetBridgingAvailability=ethernetBridgingAvailability, supplementary=supplementary, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, telecomsChannelBStatus=telecomsChannelBStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, managementPortDisabledWarning=managementPortDisabledWarning, altitude=altitude, installStatusTrap=installStatusTrap, linkSymmetry=linkSymmetry, receiveFreqKHz=receiveFreqKHz, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, smtpGroup=smtpGroup, dfsTableNumber=dfsTableNumber, securityLevel=securityLevel, frequencyVariant=frequencyVariant, alarmsGroup=alarmsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPState=sNTPState, userEnabled=userEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, dfsTableEntry=dfsTableEntry, l2CPPriorityTable=l2CPPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableEntry=userTableEntry, channelALineCode=channelALineCode, phyControl=phyControl, sNTPServerStatus=sNTPServerStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyStatus=phyStatus, accessMethod=accessMethod, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerTable=sNTPServerTable, managementPortStatusTrap=managementPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatus=installStatus, dfsPeaks=dfsPeaks, dfsGroup=dfsGroup, telecomsChannelAStatus=telecomsChannelAStatus, rangingMode=rangingMode, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, telnetPortNumber=telnetPortNumber, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bandwidthVariant=bandwidthVariant, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, channelBCableLength=channelBCableLength, managementPortConfigurationMismatch=managementPortConfigurationMismatch, automaticTxPowerControl=automaticTxPowerControl, iPv6Address=iPv6Address, managementPortStatus=managementPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, ptp600=ptp600, channelALoopback=channelALoopback, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, searchState=searchState, byteErrorRatio=byteErrorRatio, syslogControl=syslogControl, phyControlGroup=phyControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bridge=bridge, pubStats=pubStats, receiveModulationMode=receiveModulationMode, sNTPServerTimeout=sNTPServerTimeout, cableLoss=cableLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, ptmp=ptmp, wirelessLinkAvailability=wirelessLinkAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, snmpControl=snmpControl, sNTPPrimaryServer=sNTPPrimaryServer, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControl=tDDControl, dataPortStatus=dataPortStatus, syslogClientTrap=syslogClientTrap, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTableIndex=sNTPServerTableIndex, ethernet=ethernet, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTableEntry=sNTPServerTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpGroups=ptpGroups, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, latitude=latitude, sNMPTrapTable=sNMPTrapTable, remoteInternetAddress=remoteInternetAddress, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, txColorCode=txColorCode, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, tDDControlGroup=tDDControlGroup, versions=versions, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, userTable=userTable, hAZLOCConfiguration=hAZLOCConfiguration, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, dataPortDisabledWarning=dataPortDisabledWarning, subnetMask=subnetMask, sNTPSync=sNTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitChannel=transmitChannel, channelALoopbackTrap=channelALoopbackTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ptp=ptp, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, resetGroup=resetGroup, vectorError=vectorError, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userTableIndex=userTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTable=mPLSTCPriorityTable, versionsGroup=versionsGroup, dfs=dfs, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, longitude=longitude, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerRetries=sNTPServerRetries, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsMeans=dfsMeans, receiveModulationModeDetail=receiveModulationModeDetail, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, channelBandwidth=channelBandwidth, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, alarms=alarms, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, sntp=sntp, aAAControl=aAAControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, channelBLoopback=channelBLoopback, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCodeTrap=regionCodeTrap, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, incompatibleRegionCodes=incompatibleRegionCodes, localPacketFiltering=localPacketFiltering, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, remoteIPAddress=remoteIPAddress, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, remoteRxTargetPower=remoteRxTargetPower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomGroup=telecomGroup, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, managementMode=managementMode, groupID=groupID, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, channelACableLength=channelACableLength, linkLoss=linkLoss, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, receiveChannel=receiveChannel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelSelection=telecomsChannelSelection, managementGroup=managementGroup, iPv4Address=iPv4Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpCompliance=ptpCompliance, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitPower=transmitPower, linkModeOptimisation=linkModeOptimisation, transmitDataRate=transmitDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveDataRate=receiveDataRate, dfsTableIndex=dfsTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPCommunityString=sNMPCommunityString, cambium=cambium, targetMACAddress=targetMACAddress, channelBLineCode=channelBLineCode, sNTPSyncTrap=sNTPSyncTrap, receiveFreqMHz=receiveFreqMHz, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, encryption=encryption)
