...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyControl=phyControl, ethernetPriorityTable=ethernetPriorityTable, dfsPeaks=dfsPeaks, sMTPEnabledMessages=sMTPEnabledMessages, syslogStateTrap=syslogStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, securityLevel=securityLevel, bootVersion=bootVersion, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, secureModeAlarmTrap=secureModeAlarmTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, remoteRxTargetPower=remoteRxTargetPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANManagementVID=vLANManagementVID, linkLoss=linkLoss, dataPortAutoMdix=dataPortAutoMdix, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, dataPortStatusTrap=dataPortStatusTrap, eIRP=eIRP, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelBStatus=telecomsChannelBStatus, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userPassword=userPassword, syslogState=syslogState, dfsTable=dfsTable, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerIPAddress=sNTPServerIPAddress, iPv6PrefixLength=iPv6PrefixLength, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsInterface=telecomsInterface, alarmsGroup=alarmsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableNumber=dfsTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, supplementaryGroup=supplementaryGroup, txColorCode=txColorCode, transmitModulationMode=transmitModulationMode, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sntp=sntp, qOSPriorityScheme=qOSPriorityScheme, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, phyControlGroup=phyControlGroup, userTableEntry=userTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, bridgeGroup=bridgeGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, channelBandwidth=channelBandwidth, dataPortFiberStatusTrap=dataPortFiberStatusTrap, systemClock=systemClock, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, channelACableLength=channelACableLength, hAZLOCConfiguration=hAZLOCConfiguration, receiveChannel=receiveChannel, smtp=smtp, telecom=telecom, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, cambium=cambium, ethernetGroup=ethernetGroup, userRole=userRole, channelALoopbackTrap=channelALoopbackTrap, sNMPCommunityString=sNMPCommunityString, management=management, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelAStatus=telecomsChannelAStatus, siteName=siteName, telecomsChannelSelection=telecomsChannelSelection, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableEntry=sNTPServerTableEntry, sNTPSyncTrap=sNTPSyncTrap, channelALoopback=channelALoopback, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, sNTPServerTable=sNTPServerTable, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, versionsGroup=versionsGroup, sntpGroup=sntpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, alarms=alarms, tDDSynchronizationMode=tDDSynchronizationMode, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, iPVersion=iPVersion, sNMPv3Enable=sNMPv3Enable, aAAControl=aAAControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, softwareVersion=softwareVersion, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, rxColorCode=rxColorCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelALineCode=channelALineCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableEntry=dfsTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, altitude=altitude, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, sMTPEmailAlert=sMTPEmailAlert, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, encryptionGroup=encryptionGroup, remoteInternetAddressType=remoteInternetAddressType, managementPortStatus=managementPortStatus, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, secureModeAlarm=secureModeAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortFiberStatus=dataPortFiberStatus, receiveFreqKHz=receiveFreqKHz, syslogClientTrap=syslogClientTrap, transmitFreqKHz=transmitFreqKHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPSync=sNTPSync, channelBLoopback=channelBLoopback, versions=versions, iPv6Address=iPv6Address, frequencyVariant=frequencyVariant, ethernetPriorityTableEntry=ethernetPriorityTableEntry, bandwidthVariant=bandwidthVariant, hTTPPortNumber=hTTPPortNumber, linkSymmetry=linkSymmetry, accessMethod=accessMethod, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, targetRange=targetRange, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, supplementary=supplementary, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, localPacketFiltering=localPacketFiltering, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, configuration=configuration, ptpTraps=ptpTraps, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControl=tDDControl, regionCodeTrap=regionCodeTrap, configurationGroup=configurationGroup, iPv4Address=iPv4Address, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkName=linkName, PYSNMP_MODULE_ID=cambium, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, longitude=longitude, latitude=latitude, ethernetBridgingAvailability=ethernetBridgingAvailability, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, notificationsGroup=notificationsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitPower=transmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, daylightSaving=daylightSaving, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTable=userTable, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBCableLength=channelBCableLength, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, timeZone=timeZone, rawReceivePower=rawReceivePower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerRetries=sNTPServerRetries, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortStatusTrap=managementPortStatusTrap, targetMACAddress=targetMACAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", automaticTxPowerControl=automaticTxPowerControl, userEnabled=userEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptp600=ptp600, bridge=bridge, productVariant=productVariant, gatewayIPAddress=gatewayIPAddress, userName=userName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productName=productName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPState=sNTPState, ethernet=ethernet, syslogClient=syslogClient, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rangingMode=rangingMode, phyStatusGroup=phyStatusGroup, managementMode=managementMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBLineCode=channelBLineCode, ptpGroups=ptpGroups, reset=reset, sNMPPortNumber=sNMPPortNumber)
