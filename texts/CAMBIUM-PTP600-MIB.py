...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmState=installArmState, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, remoteRxTargetPower=remoteRxTargetPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, notificationsGroup=notificationsGroup, ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, productVariant=productVariant, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, rawReceivePower=rawReceivePower, sNTPState=sNTPState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, rxColorCode=rxColorCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBLoopbackTrap=channelBLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPVersion=iPVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, receiveFreqKHz=receiveFreqKHz, syslogClientTrap=syslogClientTrap, supplementary=supplementary, smtpGroup=smtpGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTrapPrefix=ptpTrapPrefix, range=range, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerInternetAddress=sNTPServerInternetAddress, linkSymmetry=linkSymmetry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, automaticTxPowerControl=automaticTxPowerControl, configuration=configuration, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, iPv6PrefixLength=iPv6PrefixLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControl=aAAControl, smtp=smtp, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, rangingMode=rangingMode, hTTPAccessEnabled=hTTPAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, syslogClient=syslogClient, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelBCableLength=channelBCableLength, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetBridgingAvailability=ethernetBridgingAvailability, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTable=ethernetPriorityTable, installArmStateTrap=installArmStateTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hardwareVersion=hardwareVersion, reset=reset, configurationGroup=configurationGroup, eIRP=eIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTable=sNTPServerTable, sNTPServerStatus=sNTPServerStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelChangeTrap=channelChangeTrap, sNTPServerTableNumber=sNTPServerTableNumber, ethernetFiberSupport=ethernetFiberSupport, syslogControlGroup=syslogControlGroup, channelALoopback=channelALoopback, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBLoopback=channelBLoopback, groupID=groupID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, iPv6GatewayAddress=iPv6GatewayAddress, supplementaryGroup=supplementaryGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitPower=transmitPower, phyStatus=phyStatus, timeZone=timeZone, sNTPPrimaryServer=sNTPPrimaryServer, telecomsChannelSelection=telecomsChannelSelection, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveFreqMHz=receiveFreqMHz, secureModeAlarm=secureModeAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, encryptionGroup=encryptionGroup, channelACableLength=channelACableLength, dfsPeaks=dfsPeaks, userPassword=userPassword, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTraps=ptpTraps, sNTPLastSync=sNTPLastSync, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installStatusTrap=installStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, securityLevel=securityLevel, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, versionsGroup=versionsGroup, hAZLOCConfiguration=hAZLOCConfiguration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementMode=managementMode, maximumTransmitPower=maximumTransmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, managementPortDisabledWarning=managementPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, bandwidthVariant=bandwidthVariant, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, productName=productName, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cambium=cambium, ptmp=ptmp, syslogStateTrap=syslogStateTrap, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, masterSlaveMode=masterSlaveMode, vLANManagementVID=vLANManagementVID, versions=versions, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelBStatus=telecomsChannelBStatus, systemClock=systemClock, bridgeGroup=bridgeGroup, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, resetGroup=resetGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatusTrap=dataPortFiberStatusTrap, softwareVersion=softwareVersion, sntp=sntp, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementGroup=managementGroup, regionCode=regionCode, secureModeAlarmTrap=secureModeAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelALoopbackTrap=channelALoopbackTrap, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBandwidth=channelBandwidth, sNTPSync=sNTPSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp600=ptp600, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, userRole=userRole, syslogState=syslogState, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, installStatus=installStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortStatus=managementPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, linkLoss=linkLoss, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibration=unitOutOfCalibration, telnetPortNumber=telnetPortNumber, receiveDataRate=receiveDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetGroup=ethernetGroup, longitude=longitude, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEmailAlert=sMTPEmailAlert, telecomsInterface=telecomsInterface, channelBLineCode=channelBLineCode, receivePower=receivePower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarms=alarms, txColorCode=txColorCode, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, l2CPPriorityTable=l2CPPriorityTable, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridge=bridge, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, altitude=altitude, snmpControlGroup=snmpControlGroup, sNTPServerTimeout=sNTPServerTimeout, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userName=userName, iPv4Address=iPv4Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, phyControl=phyControl, vectorError=vectorError, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, targetRange=targetRange)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControl=tDDControl, accessMethod=accessMethod, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTable=iPDSCPPriorityTable, signalStrengthRatio=signalStrengthRatio, dataPortFiberStatus=dataPortFiberStatus, iPv6Address=iPv6Address, managementPortStatusTrap=managementPortStatusTrap, wirelessLinkStatus=wirelessLinkStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, sNTPServerRetries=sNTPServerRetries, pubStats=pubStats, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, regionCodeTrap=regionCodeTrap, userEnabled=userEnabled, byteErrorRatio=byteErrorRatio, telecomsChannelAStatus=telecomsChannelAStatus, remoteInternetAddressType=remoteInternetAddressType, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, dfsTableIndex=dfsTableIndex, searchState=searchState, remoteIPAddress=remoteIPAddress, latitude=latitude, phyControlGroup=phyControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, aggregateDataRate=aggregateDataRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, syslogControl=syslogControl, dfsGroup=dfsGroup, channelALineCode=channelALineCode, transmitChannel=transmitChannel, dataPortDisabledWarning=dataPortDisabledWarning, licenceGroup=licenceGroup)
