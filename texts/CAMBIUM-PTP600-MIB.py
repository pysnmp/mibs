...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDControlGroup=tDDControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTable=mPLSTCPriorityTable, installStatus=installStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationMode=receiveModulationMode, sNMPTrapTable=sNMPTrapTable, syslogClient=syslogClient, productName=productName, channelALoopback=channelALoopback, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, searchState=searchState, altitude=altitude, sNTPServerIPAddress=sNTPServerIPAddress, iPv6Address=iPv6Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, installStatusTrap=installStatusTrap, management=management, ethernetBridgingAvailability=ethernetBridgingAvailability, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteIPAddress=remoteIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, encryption=encryption, telecomsChannelSelection=telecomsChannelSelection, transmitFreqMHz=transmitFreqMHz, automaticTxPowerControl=automaticTxPowerControl, bandwidthVariant=bandwidthVariant, groupID=groupID, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, ptmp=ptmp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogControlGroup=syslogControlGroup, dfsTableEntry=dfsTableEntry, maximumTransmitPower=maximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, supplementary=supplementary, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBCableLength=channelBCableLength, sNTPLastSync=sNTPLastSync, syslogClientTrap=syslogClientTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingStatus=ethernetBridgingStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPState=sNTPState, userEnabled=userEnabled, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelALoopbackTrap=channelALoopbackTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsTableNumber=dfsTableNumber, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, userRole=userRole, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, systemClock=systemClock, managementPortStatusTrap=managementPortStatusTrap, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, range=range, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, licence=licence, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableIndex=userTableIndex, ptpGroups=ptpGroups, channelBLoopback=channelBLoopback, syslogState=syslogState, notificationsGroup=notificationsGroup, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPv4Address=iPv4Address, sntpGroup=sntpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortDisabledWarning=managementPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, byteErrorRatio=byteErrorRatio, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, channelBLineCode=channelBLineCode, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsPeaks=dfsPeaks, dSCPManagementPriority=dSCPManagementPriority, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, txColorCode=txColorCode, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxColorCode=rxColorCode, softwareVersion=softwareVersion, channelACableLength=channelACableLength, dataPortAutoMdix=dataPortAutoMdix, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControl=aAAControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBLoopbackTrap=channelBLoopbackTrap, dataPortStatus=dataPortStatus, dataPortDisabledWarning=dataPortDisabledWarning, syslogControl=syslogControl, channelALineCode=channelALineCode, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, hTTPAccessEnabled=hTTPAccessEnabled, receiveChannel=receiveChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementGroup=managementGroup, dfsTable=dfsTable, hAZLOCConfiguration=hAZLOCConfiguration, dfsTableIndex=dfsTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsMeans=dfsMeans, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortFiberStatus=dataPortFiberStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, securityLevel=securityLevel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, smtp=smtp, ptp600=ptp600, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, latitude=latitude, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, linkModeOptimisation=linkModeOptimisation, rawReceivePower=rawReceivePower, sNTPPrimaryServer=sNTPPrimaryServer, regionCodeTrap=regionCodeTrap, remoteInternetAddress=remoteInternetAddress, dfsGroup=dfsGroup, linkSymmetry=linkSymmetry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bridgeGroup=bridgeGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetFiberSupport=ethernetFiberSupport, cableLoss=cableLoss, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, eIRP=eIRP, transmitChannel=transmitChannel, secureModeAlarmTrap=secureModeAlarmTrap, subnetMask=subnetMask, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, pubStats=pubStats, sNTPServerTable=sNTPServerTable, targetMACAddress=targetMACAddress, antennaGain=antennaGain, telecomsChannelBStatus=telecomsChannelBStatus, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerStatus=sNTPServerStatus, smtpGroup=smtpGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, reset=reset, phyControlGroup=phyControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableEntry=sNTPServerTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomGroup=telecomGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, signalStrengthRatio=signalStrengthRatio, linkName=linkName, telecomsChannelAStatus=telecomsChannelAStatus, iPv6GatewayAddress=iPv6GatewayAddress, iPVersion=iPVersion, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecom=telecom, supplementaryGroup=supplementaryGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, channelBandwidth=channelBandwidth, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, accessMethod=accessMethod, managementMode=managementMode, remoteRxTargetPower=remoteRxTargetPower, vectorError=vectorError, ptpCompliance=ptpCompliance, targetRange=targetRange, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapVersion=sNMPTrapVersion, userTableEntry=userTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfs=dfs, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTimeout=sNTPServerTimeout, managementPortConfigurationMismatch=managementPortConfigurationMismatch, timeZone=timeZone, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, receivePower=receivePower, versions=versions, encryptionGroup=encryptionGroup, vLANManagementVID=vLANManagementVID, tDDControl=tDDControl, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, l2CPPriorityTable=l2CPPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, longitude=longitude, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEmailAlert=sMTPEmailAlert, managementPortStatus=managementPortStatus, cambium=cambium, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, alarmsGroup=alarmsGroup, bridge=bridge, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, vLANManagementPriority=vLANManagementPriority, userName=userName, licenceGroup=licenceGroup, resetGroup=resetGroup, linkLoss=linkLoss, siteName=siteName, productVariant=productVariant, localPacketFiltering=localPacketFiltering, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, aAAControlGroup=aAAControlGroup)
