...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", groupID=groupID, iPv6Address=iPv6Address, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, snmpControl=snmpControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerStatus=sNTPServerStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANManagementVID=vLANManagementVID, ptpCompliance=ptpCompliance, localPacketFiltering=localPacketFiltering, channelBLineCode=channelBLineCode, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetBridgingStatus=ethernetBridgingStatus, ethernet=ethernet, versions=versions, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableNumber=userTableNumber, encryption=encryption, supplementaryGroup=supplementaryGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRate=receiveDataRate, phyControl=phyControl, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, phyStatus=phyStatus, sntpGroup=sntpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPCommunityString=sNMPCommunityString, hAZLOCConfiguration=hAZLOCConfiguration, eIRP=eIRP, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hardwareVersion=hardwareVersion, dfsMeans=dfsMeans, ptpGroups=ptpGroups, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPollInterval=sNTPPollInterval, pubStats=pubStats, altitude=altitude, telecom=telecom, telecomsChannelAStatus=telecomsChannelAStatus, frequencyVariant=frequencyVariant, channelACableLength=channelACableLength, sNMPTrapTable=sNMPTrapTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableIndex=userTableIndex, dataPortAutoMdix=dataPortAutoMdix, telecomsInterface=telecomsInterface, ptp=ptp, signalStrengthRatio=signalStrengthRatio, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, secureModeAlarm=secureModeAlarm, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveChannel=receiveChannel, managementPortStatusTrap=managementPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userEnabled=userEnabled, userTable=userTable, remoteIPAddress=remoteIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerRetries=sNTPServerRetries, reset=reset, encryptionGroup=encryptionGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsTableEntry=dfsTableEntry, siteName=siteName, alarms=alarms, phyStatusGroup=phyStatusGroup, channelBLoopback=channelBLoopback, bridge=bridge, rangingMode=rangingMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortStatus=managementPortStatus, installArmState=installArmState, sNTPServerTableIndex=sNTPServerTableIndex, dfs=dfs, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogControlGroup=syslogControlGroup, sNTPServerTable=sNTPServerTable, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, qOSPriorityScheme=qOSPriorityScheme, hTTPSAccessEnabled=hTTPSAccessEnabled, channelChangeTrap=channelChangeTrap, linkName=linkName, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementMode=managementMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, aggregateDataRate=aggregateDataRate, vectorError=vectorError, softwareVersion=softwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, iPVersion=iPVersion, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, syslogState=syslogState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsGroup=dfsGroup, installArmStateTrap=installArmStateTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkModeOptimisation=linkModeOptimisation, transmitChannel=transmitChannel, regionCodeTrap=regionCodeTrap, licence=licence, linkSymmetry=linkSymmetry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telnetPortNumber=telnetPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configuration=configuration, sNMPv3Enable=sNMPv3Enable, phyControlGroup=phyControlGroup, cambium=cambium, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, l2CPPriorityTable=l2CPPriorityTable, sNMPPortNumber=sNMPPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarmsGroup=alarmsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, telecomGroup=telecomGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, installStatusTrap=installStatusTrap, accessMethod=accessMethod, managementGroup=managementGroup, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPState=sNTPState, smtp=smtp, syslogClient=syslogClient, targetMACAddress=targetMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, daylightSaving=daylightSaving, versionsGroup=versionsGroup, dataPortStatus=dataPortStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, automaticTxPowerControl=automaticTxPowerControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, aAAControlGroup=aAAControlGroup, dfsPeaks=dfsPeaks, securityLevel=securityLevel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, syslogStateTrap=syslogStateTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userPassword=userPassword, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddress=sMTPServerInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelALineCode=channelALineCode, tDDControl=tDDControl, channelALoopback=channelALoopback, transmitDataRate=transmitDataRate, sNTPServerTimeout=sNTPServerTimeout, receiveModulationModeDetail=receiveModulationModeDetail, masterSlaveMode=masterSlaveMode, latitude=latitude, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, receiveFreqMHz=receiveFreqMHz, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, targetRange=targetRange, ethernetFiberSupport=ethernetFiberSupport, subnetMask=subnetMask, sNTPServerIPAddress=sNTPServerIPAddress, userRole=userRole, managementPortConfigurationMismatch=managementPortConfigurationMismatch, smtpGroup=smtpGroup, txColorCode=txColorCode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableIndex=dfsTableIndex, installStatus=installStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitFreqMHz=transmitFreqMHz, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, supplementary=supplementary, tFTPServerInternetAddress=tFTPServerInternetAddress, management=management, configurationGroup=configurationGroup, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodes=incompatibleRegionCodes, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, bridgeGroup=bridgeGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receivePower=receivePower, ptp600=ptp600, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, licenceGroup=licenceGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableNumber=dfsTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", gatewayIPAddress=gatewayIPAddress, channelBCableLength=channelBCableLength, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, telecomsChannelSelection=telecomsChannelSelection, channelBLoopbackTrap=channelBLoopbackTrap, ethernetPriorityTable=ethernetPriorityTable, sntp=sntp, vLANManagementPriority=vLANManagementPriority, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, resetGroup=resetGroup, aAAControl=aAAControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productName=productName, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogControl=syslogControl, sMTPEnabledMessages=sMTPEnabledMessages, rxColorCode=rxColorCode, hTTPPortNumber=hTTPPortNumber, channelALoopbackTrap=channelALoopbackTrap, remoteInternetAddressType=remoteInternetAddressType, systemReset=systemReset, sNTPSyncTrap=sNTPSyncTrap, channelBandwidth=channelBandwidth, transmitPower=transmitPower, longitude=longitude, sMTPServerIPAddress=sMTPServerIPAddress, timeZone=timeZone, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortFiberStatus=dataPortFiberStatus, userName=userName, regionCode=regionCode, rawReceivePower=rawReceivePower, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSync=sNTPSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteInternetAddress=remoteInternetAddress)
