...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmState=installArmState, sNTPServerRetries=sNTPServerRetries, sntp=sntp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ptpTraps=ptpTraps, configuration=configuration, dfsTableEntry=dfsTableEntry, timeZone=timeZone, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALoopback=channelALoopback, telecomsChannelSelection=telecomsChannelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPState=sNTPState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, smtpGroup=smtpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEmailAlert=sMTPEmailAlert, rxColorCode=rxColorCode, hTTPSPortNumber=hTTPSPortNumber, telecomsInterface=telecomsInterface, installStatus=installStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, managementMode=managementMode, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userPassword=userPassword, sNTPServerStatus=sNTPServerStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, altitude=altitude, linkModeOptimisation=linkModeOptimisation, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, regionCodeTrap=regionCodeTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALineCode=channelALineCode, linkName=linkName, tFTPServerInternetAddress=tFTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, automaticTxPowerControl=automaticTxPowerControl, syslogState=syslogState, smtp=smtp, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, channelBCableLength=channelBCableLength, dataPortFiberStatus=dataPortFiberStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetRange=targetRange, versionsGroup=versionsGroup, vLANManagementVID=vLANManagementVID, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelALoopbackTrap=channelALoopbackTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, txColorCode=txColorCode, channelBLoopback=channelBLoopback, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secureModeAlarm=secureModeAlarm, receiveFreqKHz=receiveFreqKHz, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, antennaGain=antennaGain, ptpCompliance=ptpCompliance, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rangingMode=rangingMode, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelChangeTrap=channelChangeTrap, userTableIndex=userTableIndex, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTable=sNTPServerTable, aAAControl=aAAControl, channelBLineCode=channelBLineCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableNumber=dfsTableNumber, productName=productName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortStatus=managementPortStatus, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, bridge=bridge, snmpControl=snmpControl, pubStats=pubStats, receiveModulationMode=receiveModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, ethernet=ethernet, telecomsChannelBStatus=telecomsChannelBStatus, wirelessLinkAvailability=wirelessLinkAvailability, ethernetGroup=ethernetGroup, rawReceivePower=rawReceivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteInternetAddress=remoteInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, frequencyVariant=frequencyVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, licenceGroup=licenceGroup, systemReset=systemReset, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, systemClock=systemClock, securityLevel=securityLevel, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, reset=reset, userTableEntry=userTableEntry, alarms=alarms, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, ptp600=ptp600, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, incompatibleRegionCodes=incompatibleRegionCodes, syslogClientTrap=syslogClientTrap, phyControlGroup=phyControlGroup, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, syslogControlGroup=syslogControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortStatusTrap=managementPortStatusTrap, iPv4Address=iPv4Address, sNTPServerPortNumber=sNTPServerPortNumber, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, sNTPSync=sNTPSync, notificationsGroup=notificationsGroup, targetMACAddress=targetMACAddress, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, bridgeGroup=bridgeGroup, phyControl=phyControl, telecomsChannelAStatus=telecomsChannelAStatus, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, tDDControl=tDDControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, masterSlaveMode=masterSlaveMode, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, telecom=telecom, eIRP=eIRP, qOSPriorityScheme=qOSPriorityScheme, tFTPServerIPAddress=tFTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, range=range, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerPortNumber=sMTPServerPortNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, byteErrorRatio=byteErrorRatio, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTableIndex=ethernetPriorityTableIndex, transmitModulationMode=transmitModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, vectorError=vectorError, resetGroup=resetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, bandwidthVariant=bandwidthVariant, iPv6GatewayAddress=iPv6GatewayAddress, accessMethod=accessMethod, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitPower=transmitPower, ptp=ptp, iPv6Address=iPv6Address, iPVersion=iPVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, subnetMask=subnetMask, syslogClient=syslogClient, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, sNTPPrimaryServer=sNTPPrimaryServer, dfs=dfs, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, management=management, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSyncTrap=sNTPSyncTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteIPAddress=remoteIPAddress, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, syslogControl=syslogControl, dSCPManagementPriority=dSCPManagementPriority, channelACableLength=channelACableLength, sNMPTrapVersion=sNMPTrapVersion, iPv6PrefixLength=iPv6PrefixLength, installStatusTrap=installStatusTrap, ptmp=ptmp, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, alarmsGroup=alarmsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpGroups=ptpGroups, dfsMeans=dfsMeans, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, localPacketFiltering=localPacketFiltering, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, tDDControlGroup=tDDControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTable=sNMPTrapTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configurationGroup=configurationGroup, l2CPPriorityTable=l2CPPriorityTable, userTable=userTable, userTableNumber=userTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, licence=licence)
