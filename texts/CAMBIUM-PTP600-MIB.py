...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpCompliance=ptpCompliance, resetGroup=resetGroup, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerTableEntry=sNTPServerTableEntry, channelBLineCode=channelBLineCode, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, pubStats=pubStats, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALineCode=channelALineCode, longitude=longitude, ptmp=ptmp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitDataRate=transmitDataRate, managementPortStatus=managementPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, userTableEntry=userTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelALoopback=channelALoopback, notificationsGroup=notificationsGroup, targetRange=targetRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, transmitChannel=transmitChannel, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, licenceGroup=licenceGroup, secureModeAlarmTrap=secureModeAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, management=management, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelBandwidth=channelBandwidth, sntpGroup=sntpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTable=sNMPTrapTable, ethernet=ethernet, ethernetBridgingStatus=ethernetBridgingStatus, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerRetries=sNTPServerRetries, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatus=phyStatus, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteInternetAddressType=remoteInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, versionsGroup=versionsGroup, channelBCableLength=channelBCableLength, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userTable=userTable, byteErrorRatio=byteErrorRatio, productVariant=productVariant, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptpGroups=ptpGroups, smtp=smtp, telecomsChannelBStatus=telecomsChannelBStatus, bandwidthVariant=bandwidthVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPPortNumber=sNMPPortNumber, receiveFreqKHz=receiveFreqKHz, userTableIndex=userTableIndex, syslogClient=syslogClient, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveModulationMode=receiveModulationMode, productName=productName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableIndex=dfsTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarning=dataPortDisabledWarning, telecom=telecom, configurationGroup=configurationGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsPeaks=dfsPeaks, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, sNTPServerIPAddress=sNTPServerIPAddress, supplementary=supplementary, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsTable=dfsTable, iPDSCPPriorityTable=iPDSCPPriorityTable, hAZLOCConfiguration=hAZLOCConfiguration, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBLoopbackTrap=channelBLoopbackTrap, securityLevel=securityLevel, rxColorCode=rxColorCode, transmitFreqKHz=transmitFreqKHz, userName=userName, channelALoopbackTrap=channelALoopbackTrap, systemClock=systemClock, mPLSTCPriorityTable=mPLSTCPriorityTable, regionCodeTrap=regionCodeTrap, userRole=userRole, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortFiberStatusTrap=dataPortFiberStatusTrap, PYSNMP_MODULE_ID=cambium, sNTPServerTableNumber=sNTPServerTableNumber, syslogStateTrap=syslogStateTrap, channelBLoopback=channelBLoopback, txColorCode=txColorCode, sntp=sntp, dfsGroup=dfsGroup, managementGroup=managementGroup, groupID=groupID, sNTPSync=sNTPSync, tFTPServerInternetAddress=tFTPServerInternetAddress, dfs=dfs, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANManagementPriority=vLANManagementPriority, ethernetGroup=ethernetGroup, encryptionGroup=encryptionGroup, snmpControl=snmpControl, iPv4Address=iPv4Address, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versions=versions, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, sNTPSyncTrap=sNTPSyncTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, aggregateDataRate=aggregateDataRate, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, configuration=configuration, snmpControlGroup=snmpControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, userTableNumber=userTableNumber, tDDControlGroup=tDDControlGroup, range=range, rawReceivePower=rawReceivePower, rangingMode=rangingMode, managementPortStatusTrap=managementPortStatusTrap, localPacketFiltering=localPacketFiltering, sNMPTrapIPAddress=sNMPTrapIPAddress, iPv6PrefixLength=iPv6PrefixLength, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementMode=managementMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userPassword=userPassword, dataPortStatus=dataPortStatus, dfsTableNumber=dfsTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bridgeGroup=bridgeGroup, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, ptp600=ptp600, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkLoss=linkLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarmsGroup=alarmsGroup, bridge=bridge, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptp=ptp, channelChangeTrap=channelChangeTrap, aAAControl=aAAControl, iPv6Address=iPv6Address, smtpGroup=smtpGroup, bootVersion=bootVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installArmState=installArmState, signalStrengthRatio=signalStrengthRatio, reset=reset, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, remoteRxTargetPower=remoteRxTargetPower, dfsMeans=dfsMeans, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortFiberStatus=dataPortFiberStatus, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortAutoMdix=dataPortAutoMdix, receiveChannel=receiveChannel, secureModeAlarm=secureModeAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDControl=tDDControl, incompatibleRegionCodes=incompatibleRegionCodes, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, vLANManagementVID=vLANManagementVID, remoteIPAddress=remoteIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, targetMACAddress=targetMACAddress, syslogClientTrap=syslogClientTrap, masterSlaveMode=masterSlaveMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, telecomGroup=telecomGroup, iPv6GatewayAddress=iPv6GatewayAddress, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, syslogState=syslogState, regionCode=regionCode, antennaGain=antennaGain, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, linkName=linkName, sNTPServerTable=sNTPServerTable, eIRP=eIRP)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, telecomsInterface=telecomsInterface, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationMode=transmitModulationMode, altitude=altitude, installStatusTrap=installStatusTrap, subnetMask=subnetMask, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, searchState=searchState, userEnabled=userEnabled, sNTPLastSync=sNTPLastSync, timeZone=timeZone, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitPower=transmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, channelACableLength=channelACableLength, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secondarySoftwareVersion=secondarySoftwareVersion, encryption=encryption, tFTPServerInternetAddressType=tFTPServerInternetAddressType, latitude=latitude, telecomsChannelSelection=telecomsChannelSelection, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, installStatus=installStatus, automaticTxPowerControl=automaticTxPowerControl, cambium=cambium, tDDSynchronizationMode=tDDSynchronizationMode, phyControlGroup=phyControlGroup, iPVersion=iPVersion, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPv3Enable=sNMPv3Enable)
