...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTimeout=sNTPServerTimeout, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqMHz=transmitFreqMHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerRetries=sNTPServerRetries, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptpGroups=ptpGroups, dfsTableIndex=dfsTableIndex, remoteInternetAddressType=remoteInternetAddressType, userTableEntry=userTableEntry, automaticTxPowerControl=automaticTxPowerControl, supplementary=supplementary, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControl=phyControl, dfsPeaks=dfsPeaks, sNTPSyncTrap=sNTPSyncTrap, phyControlGroup=phyControlGroup, pubStatsGroup=pubStatsGroup, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, sNTPServerTableIndex=sNTPServerTableIndex, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, dataPortFiberStatus=dataPortFiberStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, txColorCode=txColorCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, supplementaryGroup=supplementaryGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hAZLOCConfiguration=hAZLOCConfiguration, sMTPServerIPAddress=sMTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPVersion=iPVersion, regionCodeTrap=regionCodeTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementMode=managementMode, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTable=sNMPTrapTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, ptpCompliance=ptpCompliance, configurationGroup=configurationGroup, smtp=smtp, versionsGroup=versionsGroup, sMTPEmailAlert=sMTPEmailAlert, securityLevel=securityLevel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, dataPortFiberStatusTrap=dataPortFiberStatusTrap, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, syslogClientTrap=syslogClientTrap, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, altitude=altitude, userRole=userRole, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetBridgingStatus=ethernetBridgingStatus, regionCode=regionCode, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, channelALoopback=channelALoopback, dfs=dfs, sMTPServerPortNumber=sMTPServerPortNumber, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, timeZone=timeZone, sNTPServerTableNumber=sNTPServerTableNumber, installArmState=installArmState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableNumber=userTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsGroup=dfsGroup, managementGroup=managementGroup, aAAControl=aAAControl, searchState=searchState, managementPortStatus=managementPortStatus, dataPortStatus=dataPortStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, targetRange=targetRange, tFTPServerInternetAddress=tFTPServerInternetAddress, systemReset=systemReset, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerInternetAddress=sNTPServerInternetAddress, userName=userName, syslogState=syslogState, userPassword=userPassword, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableEntry=sNMPTrapTableEntry, userTable=userTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTable=sNTPServerTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerStatus=sNTPServerStatus, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenceGroup=licenceGroup, cambium=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteIPAddress=remoteIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, channelChangeTrap=channelChangeTrap, telecomsChannelAStatus=telecomsChannelAStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveFreqMHz=receiveFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, qOSPriorityScheme=qOSPriorityScheme, gatewayIPAddress=gatewayIPAddress, iPv6Address=iPv6Address, eIRP=eIRP, channelBCableLength=channelBCableLength, groupID=groupID, hTTPAccessEnabled=hTTPAccessEnabled, channelBLineCode=channelBLineCode, secureModeAlarm=secureModeAlarm, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, antennaGain=antennaGain, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogControl=syslogControl, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetBridgingAvailability=ethernetBridgingAvailability, versions=versions, cableLoss=cableLoss, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBLoopbackTrap=channelBLoopbackTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsChannelSelection=telecomsChannelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, ptp600=ptp600, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, telecomGroup=telecomGroup, targetMACAddress=targetMACAddress, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, linkLoss=linkLoss, encryption=encryption, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveDataRate=receiveDataRate, ethernet=ethernet, l2CPPriorityTable=l2CPPriorityTable, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, encryptionGroup=encryptionGroup, telecomsInterface=telecomsInterface, aAAControlGroup=aAAControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, encryptionAlgorithm=encryptionAlgorithm, channelACableLength=channelACableLength, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, tDDControlGroup=tDDControlGroup, configuration=configuration, telnetPortNumber=telnetPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptpTrapPrefix=ptpTrapPrefix, channelALineCode=channelALineCode, wirelessLinkStatus=wirelessLinkStatus, masterSlaveMode=masterSlaveMode, sNTPServerPortNumber=sNTPServerPortNumber, managementPortStatusTrap=managementPortStatusTrap, localPacketFiltering=localPacketFiltering, sNMPPortNumber=sNMPPortNumber, rawReceivePower=rawReceivePower, remoteInternetAddress=remoteInternetAddress, installArmStateTrap=installArmStateTrap, productName=productName, rxColorCode=rxColorCode, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPSync=sNTPSync, linkModeOptimisation=linkModeOptimisation, dfsTableNumber=dfsTableNumber, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, transmitChannel=transmitChannel, hTTPPortNumber=hTTPPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogClient=syslogClient, channelBLoopback=channelBLoopback, sNTPPrimaryServer=sNTPPrimaryServer, snmpControl=snmpControl, notificationsGroup=notificationsGroup, dfsTableEntry=dfsTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, linkSymmetry=linkSymmetry, sNMPTrapIPAddress=sNMPTrapIPAddress, channelALoopbackTrap=channelALoopbackTrap, frequencyVariant=frequencyVariant, sNTPLastSync=sNTPLastSync, receiveChannel=receiveChannel, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, dataPortAutoMdix=dataPortAutoMdix, productVariant=productVariant, unitOutOfCalibration=unitOutOfCalibration, signalStrengthRatio=signalStrengthRatio, tDDControl=tDDControl, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, bridge=bridge, receivePower=receivePower, accessMethod=accessMethod, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rangingMode=rangingMode, installStatus=installStatus, phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, longitude=longitude, dfsTable=dfsTable, iPv6PrefixLength=iPv6PrefixLength, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerPortNumber=tFTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, resetGroup=resetGroup, subnetMask=subnetMask, receiveModulationMode=receiveModulationMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licence=licence, sntpGroup=sntpGroup, reset=reset, sNMPTrapInternetAddress=sNMPTrapInternetAddress)
