...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userEnabled=userEnabled, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, targetRange=targetRange, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, sNMPv3Enable=sNMPv3Enable, sNMPCommunityString=sNMPCommunityString, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTable=sNMPTrapTable, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableLoss=cableLoss, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableIndex=sNTPServerTableIndex, dfsMeans=dfsMeans, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, sNTPServerTable=sNTPServerTable, localPacketFiltering=localPacketFiltering, regionCode=regionCode, receiveFreqKHz=receiveFreqKHz, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, ethernetBridgingStatus=ethernetBridgingStatus, linkName=linkName, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPv6Address=iPv6Address, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, ethernet=ethernet, pubStats=pubStats, iPVersion=iPVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, channelBLoopback=channelBLoopback, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqMHz=transmitFreqMHz, transmitDataRate=transmitDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, supplementary=supplementary, vLANManagementVID=vLANManagementVID, phyStatus=phyStatus, installStatus=installStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, telecomsInterface=telecomsInterface, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, hAZLOCConfiguration=hAZLOCConfiguration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, byteErrorRatio=byteErrorRatio, ptmp=ptmp, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, alarms=alarms, l2CPPriorityTable=l2CPPriorityTable, productVariant=productVariant, dfs=dfs, accessMethod=accessMethod, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp600=ptp600, phyControlGroup=phyControlGroup, managementPortStatusTrap=managementPortStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, bandwidthVariant=bandwidthVariant, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortStatus=dataPortStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortStatusTrap=dataPortStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, smtp=smtp, managementMode=managementMode, channelBCableLength=channelBCableLength, remoteRxTargetPower=remoteRxTargetPower, securityLevel=securityLevel, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPollInterval=sNTPPollInterval, automaticTxPowerControl=automaticTxPowerControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogClient=syslogClient, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, sntpGroup=sntpGroup, receiveChannel=receiveChannel, timeZone=timeZone, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, rxColorCode=rxColorCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomGroup=telecomGroup, dfsGroup=dfsGroup, tDDControl=tDDControl, supplementaryGroup=supplementaryGroup, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, snmpControl=snmpControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, dataPortAutoMdix=dataPortAutoMdix, rangingMode=rangingMode, dataPortFiberStatus=dataPortFiberStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, pubStatsGroup=pubStatsGroup, channelBLineCode=channelBLineCode, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, channelALoopbackTrap=channelALoopbackTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortStatus=managementPortStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableNumber=sNTPServerTableNumber, rawReceivePower=rawReceivePower, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, sNTPServerPortNumber=sNTPServerPortNumber, channelChangeTrap=channelChangeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, eIRP=eIRP, syslogClientTrap=syslogClientTrap, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, channelALineCode=channelALineCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, reset=reset, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableNumber=userTableNumber, configurationGroup=configurationGroup, channelACableLength=channelACableLength, vectorError=vectorError, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpTraps=ptpTraps, aAAControl=aAAControl, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteInternetAddress=remoteInternetAddress, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTable=ethernetPriorityTable, ptpCompliance=ptpCompliance, phyControl=phyControl, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetPortNumber=telnetPortNumber, channelALoopback=channelALoopback, targetMACAddress=targetMACAddress, transmitPower=transmitPower, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, secureModeAlarm=secureModeAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, userRole=userRole, sNMPEnabledTraps=sNMPEnabledTraps, longitude=longitude, receiveFreqMHz=receiveFreqMHz, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, management=management, sMTPEnabledMessages=sMTPEnabledMessages, telecom=telecom, systemClock=systemClock, ptpGroups=ptpGroups, userPassword=userPassword, siteName=siteName, versions=versions, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, channelBLoopbackTrap=channelBLoopbackTrap, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, userTableEntry=userTableEntry, ptp=ptp, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, telecomsChannelSelection=telecomsChannelSelection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, dfsTable=dfsTable, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, iPv4Address=iPv4Address, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, range=range, sMTPServerInternetAddressType=sMTPServerInternetAddressType, bootVersion=bootVersion, userName=userName, sNTPServerStatus=sNTPServerStatus, subnetMask=subnetMask, configuration=configuration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, receiveModulationMode=receiveModulationMode, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, managementGroup=managementGroup, dfsTableEntry=dfsTableEntry, productName=productName, encryptionGroup=encryptionGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogState=syslogState, telecomsChannelBStatus=telecomsChannelBStatus, resetGroup=resetGroup, transmitChannel=transmitChannel, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapIPAddress=sNMPTrapIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", smtpGroup=smtpGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, bridgeGroup=bridgeGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogControl=syslogControl, ethernetGroup=ethernetGroup, sNTPServerRetries=sNTPServerRetries, receivePower=receivePower, systemReset=systemReset, searchState=searchState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveDataRate=receiveDataRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPState=sNTPState, sntp=sntp, tFTPServerInternetAddress=tFTPServerInternetAddress, encryption=encryption, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPSync=sNTPSync, txColorCode=txColorCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddressType=remoteInternetAddressType, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, transmitFreqKHz=transmitFreqKHz, licence=licence, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerIPAddress=sMTPServerIPAddress, bridge=bridge, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, userTable=userTable, sNTPPrimaryServer=sNTPPrimaryServer, managementPortConfigurationMismatch=managementPortConfigurationMismatch)
