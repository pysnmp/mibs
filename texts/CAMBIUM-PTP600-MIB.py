...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, channelACableLength=channelACableLength, productVariant=productVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, siteName=siteName, phyControl=phyControl, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, resetGroup=resetGroup, regionCode=regionCode, sNTPState=sNTPState, sNTPLastSync=sNTPLastSync, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerTableNumber=sNTPServerTableNumber, iPv4Address=iPv4Address, rxColorCode=rxColorCode, antennaGain=antennaGain, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControl=aAAControl, frequencyVariant=frequencyVariant, sNMPEnabledTraps=sNMPEnabledTraps, dataPortFiberStatus=dataPortFiberStatus, userTable=userTable, bandwidthVariant=bandwidthVariant, ptpGroups=ptpGroups, bridge=bridge, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, longitude=longitude, telecom=telecom, dfsTableEntry=dfsTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, userTableEntry=userTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receivePower=receivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, tDDControlGroup=tDDControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLoopback=channelBLoopback, telnetPortNumber=telnetPortNumber, searchState=searchState, snmpControlGroup=snmpControlGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, licenceGroup=licenceGroup, telecomsChannelBStatus=telecomsChannelBStatus, dfsGroup=dfsGroup, sNMPv3Enable=sNMPv3Enable, sNTPServerRetries=sNTPServerRetries, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogState=syslogState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBandwidth=channelBandwidth, ethernetPriorityTableIndex=ethernetPriorityTableIndex, systemClock=systemClock, eIRP=eIRP, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, rangingMode=rangingMode, syslogClientTrap=syslogClientTrap, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, versions=versions, softwareVersion=softwareVersion, sNTPSyncTrap=sNTPSyncTrap, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTableEntry=sNTPServerTableEntry, ptp600=ptp600, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTable=sNTPServerTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerStatus=sNTPServerStatus, ethernetBridgingStatus=ethernetBridgingStatus, latitude=latitude, targetMACAddress=targetMACAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALineCode=channelALineCode, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBCableLength=channelBCableLength, dfsTable=dfsTable, configurationGroup=configurationGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, cableLoss=cableLoss, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetBridgingAvailability=ethernetBridgingAvailability, smtpGroup=smtpGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, PYSNMP_MODULE_ID=cambium, dfsPeaks=dfsPeaks, iPVersion=iPVersion, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, sNTPSync=sNTPSync, receiveFreqMHz=receiveFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, ethernetFiberSupport=ethernetFiberSupport, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, iPv6Address=iPv6Address, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, ethernet=ethernet, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, aAAControlGroup=aAAControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, syslogStateTrap=syslogStateTrap, channelBLineCode=channelBLineCode, transmitDataRate=transmitDataRate, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStats=pubStats, vectorError=vectorError, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, localPacketFiltering=localPacketFiltering, userName=userName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsChannelSelection=telecomsChannelSelection, installStatusTrap=installStatusTrap, smtp=smtp, vLANManagementVID=vLANManagementVID, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortStatus=managementPortStatus, dfsTableIndex=dfsTableIndex, linkSymmetry=linkSymmetry, phyControlGroup=phyControlGroup, receiveChannel=receiveChannel, regionCodeTrap=regionCodeTrap, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, receiveDataRate=receiveDataRate, ptpCompliance=ptpCompliance, snmpControl=snmpControl, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telnetAccessEnabled=telnetAccessEnabled, phyStatusGroup=phyStatusGroup, systemReset=systemReset, sNTPServerTimeout=sNTPServerTimeout, maximumTransmitPower=maximumTransmitPower, groupID=groupID, qOSPriorityScheme=qOSPriorityScheme, management=management, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, byteErrorRatio=byteErrorRatio, syslogControlGroup=syslogControlGroup, licence=licence, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, syslogControl=syslogControl, ptp=ptp, userTableIndex=userTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelALoopbackTrap=channelALoopbackTrap, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, remoteInternetAddressType=remoteInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, managementPortStatusTrap=managementPortStatusTrap, ptpTraps=ptpTraps, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimisation=linkModeOptimisation, userEnabled=userEnabled, encryptionGroup=encryptionGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, channelALoopback=channelALoopback, securityLevel=securityLevel, accessMethod=accessMethod, encryption=encryption, targetRange=targetRange, tDDSynchronizationMode=tDDSynchronizationMode, iPv6PrefixLength=iPv6PrefixLength, telecomsInterface=telecomsInterface, range=range, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, linkLoss=linkLoss, cambium=cambium, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rawReceivePower=rawReceivePower, telecomGroup=telecomGroup, txColorCode=txColorCode, bridgeGroup=bridgeGroup, installArmStateTrap=installArmStateTrap, managementMode=managementMode, remoteRxTargetPower=remoteRxTargetPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortStatus=dataPortStatus, altitude=altitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secureModeAlarmTrap=secureModeAlarmTrap, reset=reset, sntp=sntp)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPPortNumber=hTTPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versionsGroup=versionsGroup, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, dfs=dfs, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secureModeAlarm=secureModeAlarm, productName=productName, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, remoteInternetAddress=remoteInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerPortNumber=sMTPServerPortNumber, phyStatus=phyStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsMeans=dfsMeans, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, iPv6GatewayAddress=iPv6GatewayAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, syslogClient=syslogClient)
