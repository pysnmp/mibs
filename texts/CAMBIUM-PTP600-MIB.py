...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aAAControl=aAAControl, ptpTraps=ptpTraps, subnetMask=subnetMask, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortDisabledWarning=dataPortDisabledWarning, syslogState=syslogState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxColorCode=rxColorCode, channelBLineCode=channelBLineCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerInternetAddress=sMTPServerInternetAddress, licenceGroup=licenceGroup, hTTPPortNumber=hTTPPortNumber, userEnabled=userEnabled, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortFiberStatus=dataPortFiberStatus, versions=versions, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, resetGroup=resetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveFreqMHz=receiveFreqMHz, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, remoteRxTargetPower=remoteRxTargetPower, iPv6Address=iPv6Address, wirelessLinkAvailability=wirelessLinkAvailability, userTableNumber=userTableNumber, dfsTableNumber=dfsTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, range=range, ptp600=ptp600, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptmp=ptmp, supplementaryGroup=supplementaryGroup, rangingMode=rangingMode, antennaGain=antennaGain, alarms=alarms, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, transmitFreqKHz=transmitFreqKHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv4Address=iPv4Address, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, transmitChannel=transmitChannel, softwareVersion=softwareVersion, telecom=telecom, supplementary=supplementary, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, localPacketFiltering=localPacketFiltering, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, remoteIPAddress=remoteIPAddress, versionsGroup=versionsGroup, userTable=userTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemReset=systemReset, channelBLoopback=channelBLoopback, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, ptpGroups=ptpGroups, sNTPServerIPAddress=sNTPServerIPAddress, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsChannelSelection=telecomsChannelSelection, bridgeGroup=bridgeGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, sNTPServerTableEntry=sNTPServerTableEntry, dfsTableIndex=dfsTableIndex, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userRole=userRole, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, channelALoopback=channelALoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, smtpGroup=smtpGroup, eIRP=eIRP, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBandwidth=channelBandwidth, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogControl=syslogControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsTableEntry=dfsTableEntry, phyControl=phyControl, installStatus=installStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, siteName=siteName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsGroup=dfsGroup, longitude=longitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPLastSync=sNTPLastSync, installStatusTrap=installStatusTrap, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCode=regionCode, pubStatsGroup=pubStatsGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, targetRange=targetRange, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, latitude=latitude, remoteInternetAddress=remoteInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, dataPortAutoMdix=dataPortAutoMdix, configuration=configuration, installArmState=installArmState, sntpGroup=sntpGroup, dfs=dfs, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, channelACableLength=channelACableLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePower=receivePower, syslogClientTrap=syslogClientTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, transmitDataRate=transmitDataRate, pubStats=pubStats, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControlGroup=syslogControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, wirelessLinkStatus=wirelessLinkStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, secondarySoftwareVersion=secondarySoftwareVersion, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelAStatus=telecomsChannelAStatus, txColorCode=txColorCode, tFTPServerIPAddress=tFTPServerIPAddress, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, secureModeAlarmTrap=secureModeAlarmTrap, bridge=bridge, managementGroup=managementGroup, altitude=altitude, syslogClient=syslogClient, managementMode=managementMode, linkSymmetry=linkSymmetry, aAAControlGroup=aAAControlGroup, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, secureModeAlarm=secureModeAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDControl=tDDControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, hAZLOCConfiguration=hAZLOCConfiguration, dataPortAutoNegotiation=dataPortAutoNegotiation, rawReceivePower=rawReceivePower, cambium=cambium, telecomsInterface=telecomsInterface, syslogStateTrap=syslogStateTrap, sNTPServerRetries=sNTPServerRetries, channelChangeTrap=channelChangeTrap, byteErrorRatio=byteErrorRatio, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, accessMethod=accessMethod, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, gatewayIPAddress=gatewayIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, securityLevel=securityLevel, sNTPSyncTrap=sNTPSyncTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveDataRate=receiveDataRate, dSCPManagementPriority=dSCPManagementPriority, signalStrengthRatio=signalStrengthRatio, linkName=linkName, dfsPeaks=dfsPeaks, channelBCableLength=channelBCableLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, frequencyVariant=frequencyVariant, qOSPriorityScheme=qOSPriorityScheme, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTable=sNTPServerTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, productName=productName, encryptionAlgorithm=encryptionAlgorithm, configurationGroup=configurationGroup, userPassword=userPassword, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, managementPortStatus=managementPortStatus, managementPortStatusTrap=managementPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, vLANManagementPriority=vLANManagementPriority, linkModeOptimisation=linkModeOptimisation)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelALoopbackTrap=channelALoopbackTrap, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableLoss=cableLoss, dfsTable=dfsTable, iPv6PrefixLength=iPv6PrefixLength, channelALineCode=channelALineCode, sNMPEnabledTraps=sNMPEnabledTraps, iPVersion=iPVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableNumber=sNTPServerTableNumber, telnetPortNumber=telnetPortNumber, daylightSaving=daylightSaving, automaticTxPowerControl=automaticTxPowerControl, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, searchState=searchState, snmpControlGroup=snmpControlGroup, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, userName=userName, maximumTransmitPower=maximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyStatusGroup=phyStatusGroup, remoteInternetAddressType=remoteInternetAddressType, bandwidthVariant=bandwidthVariant, telecomsChannelBStatus=telecomsChannelBStatus, ethernetPriorityTable=ethernetPriorityTable, userTableEntry=userTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, dfsMeans=dfsMeans, sNTPServerPortNumber=sNTPServerPortNumber, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableNumber=sNMPTrapTableNumber)
