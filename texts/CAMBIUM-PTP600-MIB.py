...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, sNTPLastSync=sNTPLastSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerStatus=sNTPServerStatus, targetRange=targetRange, smtpGroup=smtpGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecomsChannelSelection=telecomsChannelSelection, sNMPCommunityString=sNMPCommunityString, sNTPServerTableEntry=sNTPServerTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, daylightSaving=daylightSaving, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, snmpControl=snmpControl, aggregateDataRate=aggregateDataRate, dfsTableNumber=dfsTableNumber, channelBLoopback=channelBLoopback, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, syslogClient=syslogClient, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, gatewayIPAddress=gatewayIPAddress, localPacketFiltering=localPacketFiltering, managementMode=managementMode, rawReceivePower=rawReceivePower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableIndex=sNMPTrapTableIndex, rxColorCode=rxColorCode, groupID=groupID, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, configuration=configuration, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secureModeAlarm=secureModeAlarm, channelACableLength=channelACableLength, bootVersion=bootVersion, bandwidthVariant=bandwidthVariant, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, txColorCode=txColorCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementGroup=managementGroup, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, phyStatus=phyStatus, encryption=encryption, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelBCableLength=channelBCableLength, sNTPServerTimeout=sNTPServerTimeout, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, iPv6PrefixLength=iPv6PrefixLength, phyControl=phyControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, searchState=searchState, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControl=tDDControl, telnetPortNumber=telnetPortNumber, sNTPServerRetries=sNTPServerRetries, encryptionAlgorithm=encryptionAlgorithm, channelBLoopbackTrap=channelBLoopbackTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, iPv6Address=iPv6Address, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogStateTrap=syslogStateTrap, linkSymmetry=linkSymmetry, iPv6GatewayAddress=iPv6GatewayAddress, receiveModulationModeDetail=receiveModulationModeDetail, rangingMode=rangingMode, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableIndex=dfsTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, smtp=smtp, dfsPeaks=dfsPeaks, syslogControlGroup=syslogControlGroup, telecomsChannelBStatus=telecomsChannelBStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveChannel=receiveChannel, bridge=bridge, bridgeGroup=bridgeGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, altitude=altitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sntp=sntp, ethernetPriorityTable=ethernetPriorityTable, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernet=ethernet, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, telnetAccessEnabled=telnetAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, transmitFreqKHz=transmitFreqKHz, ptpTraps=ptpTraps, dfsGroup=dfsGroup, channelChangeTrap=channelChangeTrap, sntpGroup=sntpGroup, ptp600=ptp600, channelBLineCode=channelBLineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, masterSlaveMode=masterSlaveMode, userRole=userRole, telecomsChannelAStatus=telecomsChannelAStatus, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, automaticTxPowerControl=automaticTxPowerControl, alarms=alarms, pubStats=pubStats, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, productName=productName, dfsMeans=dfsMeans, sMTPEmailAlert=sMTPEmailAlert, range=range, userPassword=userPassword, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, installStatusTrap=installStatusTrap, l2CPPriorityTable=l2CPPriorityTable, iPVersion=iPVersion, channelALineCode=channelALineCode, dfsTableEntry=dfsTableEntry, ptpGroups=ptpGroups, managementPortDisabledWarning=managementPortDisabledWarning, snmpControlGroup=snmpControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, userTableEntry=userTableEntry, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNTPSync=sNTPSync, ethernetBridgingAvailability=ethernetBridgingAvailability, installArmStateTrap=installArmStateTrap, regionCodeTrap=regionCodeTrap, eIRP=eIRP, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitPower=transmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, constantPowerSpectralDensity=constantPowerSpectralDensity, userTable=userTable, longitude=longitude, tFTPServerPortNumber=tFTPServerPortNumber, remoteRxTargetPower=remoteRxTargetPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, sNTPServerIPAddress=sNTPServerIPAddress, dataPortFiberStatus=dataPortFiberStatus, ptp=ptp, receiveFreqMHz=receiveFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetBridgingStatus=ethernetBridgingStatus, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, configurationGroup=configurationGroup, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cambium=cambium, versionsGroup=versionsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, sNMPv3Enable=sNMPv3Enable, PYSNMP_MODULE_ID=cambium, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecom=telecom, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionGroup=encryptionGroup, subnetMask=subnetMask, dSCPManagementPriority=dSCPManagementPriority, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vLANManagementPriority=vLANManagementPriority, sNTPServerTableIndex=sNTPServerTableIndex, cableLoss=cableLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, sNTPState=sNTPState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, byteErrorRatio=byteErrorRatio, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTable=sNTPServerTable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, phyControlGroup=phyControlGroup, dataPortAutoMdix=dataPortAutoMdix, licence=licence, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALoopbackTrap=channelALoopbackTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsTable=dfsTable, securityLevel=securityLevel, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, supplementary=supplementary, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hardwareVersion=hardwareVersion, dfs=dfs, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortStatus=managementPortStatus, resetGroup=resetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, installStatus=installStatus, userName=userName, latitude=latitude, channelALoopback=channelALoopback, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, receivePower=receivePower)
