...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", versions=versions, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, phyStatusGroup=phyStatusGroup, userTableIndex=userTableIndex, phyStatus=phyStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPSPortNumber=hTTPSPortNumber, ptpTrapPrefix=ptpTrapPrefix, receiveModulationMode=receiveModulationMode, receiveFreqKHz=receiveFreqKHz, pubStatsGroup=pubStatsGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, daylightSaving=daylightSaving, latitude=latitude, supplementary=supplementary, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, configuration=configuration, telecomsInterface=telecomsInterface, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aAAControl=aAAControl, tDDControlGroup=tDDControlGroup, management=management, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatus=installStatus, transmitFreqKHz=transmitFreqKHz, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementMode=managementMode, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelACableLength=channelACableLength, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBCableLength=channelBCableLength, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, securityLevel=securityLevel, sNTPServerPortNumber=sNTPServerPortNumber, targetMACAddress=targetMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, sMTPServerPortNumber=sMTPServerPortNumber, phyControlGroup=phyControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, dataPortFiberStatus=dataPortFiberStatus, rxColorCode=rxColorCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userRole=userRole, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteIPAddress=remoteIPAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControl=phyControl, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTable=l2CPPriorityTable, localPacketFiltering=localPacketFiltering, telecomGroup=telecomGroup, telecomsChannelBStatus=telecomsChannelBStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sntp=sntp, managementGroup=managementGroup, bridgeGroup=bridgeGroup, antennaGain=antennaGain, ptpCompliance=ptpCompliance, channelChangeTrap=channelChangeTrap, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, sNTPServerTableEntry=sNTPServerTableEntry, qOSPriorityScheme=qOSPriorityScheme, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSyncTrap=sNTPSyncTrap, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, userName=userName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpGroups=ptpGroups, dfsMeans=dfsMeans, licenceGroup=licenceGroup, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, secureModeAlarmTrap=secureModeAlarmTrap, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, PYSNMP_MODULE_ID=cambium, linkSymmetry=linkSymmetry, range=range, systemReset=systemReset, vectorError=vectorError, searchState=searchState, iPv4Address=iPv4Address, alarms=alarms, bootVersion=bootVersion, supplementaryGroup=supplementaryGroup, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControlGroup=aAAControlGroup, secureModeAlarm=secureModeAlarm, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTable=ethernetPriorityTable, installArmStateTrap=installArmStateTrap, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVID=vLANManagementVID, receiveModulationModeDetail=receiveModulationModeDetail, channelALoopbackTrap=channelALoopbackTrap, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telnetPortNumber=telnetPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, frequencyVariant=frequencyVariant, configurationGroup=configurationGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, dfs=dfs, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveChannel=receiveChannel, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableEntry=userTableEntry, pubStats=pubStats, dfsGroup=dfsGroup, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSync=sNTPSync, sNTPPrimaryServer=sNTPPrimaryServer, telnetAccessEnabled=telnetAccessEnabled, sNTPState=sNTPState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecom=telecom, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitChannel=transmitChannel, systemClock=systemClock, syslogClient=syslogClient, l2CPPriorityTableEntry=l2CPPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, encryption=encryption, encryptionGroup=encryptionGroup, linkModeOptimisation=linkModeOptimisation, iPv6GatewayAddress=iPv6GatewayAddress, ethernet=ethernet, channelALoopback=channelALoopback, smtp=smtp, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableNumber=dfsTableNumber, notificationsGroup=notificationsGroup, managementPortDisabledWarning=managementPortDisabledWarning, productVariant=productVariant, channelALineCode=channelALineCode, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, accessMethod=accessMethod, cambium=cambium, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, linkName=linkName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, resetGroup=resetGroup, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, hAZLOCConfiguration=hAZLOCConfiguration, dSCPManagementPriority=dSCPManagementPriority, bridge=bridge, subnetMask=subnetMask, hTTPAccessEnabled=hTTPAccessEnabled, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogStateTrap=syslogStateTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptp600=ptp600, channelBLoopbackTrap=channelBLoopbackTrap, dfsTableEntry=dfsTableEntry, iPv6Address=iPv6Address, maximumTransmitPower=maximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangingMode=rangingMode, telecomsChannelSelection=telecomsChannelSelection, eIRP=eIRP, hardwareVersion=hardwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, siteName=siteName, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, transmitDataRate=transmitDataRate, txColorCode=txColorCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, byteErrorRatio=byteErrorRatio, channelBLineCode=channelBLineCode, sNTPServerTableNumber=sNTPServerTableNumber, rawReceivePower=rawReceivePower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, targetRange=targetRange, incompatibleRegionCodes=incompatibleRegionCodes)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installStatusTrap=installStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, channelBLoopback=channelBLoopback, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aggregateDataRate=aggregateDataRate, userTable=userTable, bandwidthVariant=bandwidthVariant, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, managementPortStatus=managementPortStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userPassword=userPassword, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licence=licence, regionCodeTrap=regionCodeTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableIndex=dfsTableIndex, iPVersion=iPVersion, ptp=ptp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, longitude=longitude, reset=reset, sNMPPortNumber=sNMPPortNumber, iPv6PrefixLength=iPv6PrefixLength, receiveFreqMHz=receiveFreqMHz, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, timeZone=timeZone, altitude=altitude, telecomsChannelAStatus=telecomsChannelAStatus, sntpGroup=sntpGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap)
