...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, securityLevel=securityLevel, bridgeGroup=bridgeGroup, sNMPPortNumber=sNMPPortNumber, sNTPPollInterval=sNTPPollInterval, ptmp=ptmp, secureModeAlarm=secureModeAlarm, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, management=management, ptpCompliance=ptpCompliance, phyControlGroup=phyControlGroup, cableLoss=cableLoss, iPv6PrefixLength=iPv6PrefixLength, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelALineCode=channelALineCode, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBLineCode=channelBLineCode, incompatibleRegionCodes=incompatibleRegionCodes, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, remoteRxTargetPower=remoteRxTargetPower, syslogStateTrap=syslogStateTrap, ptp600=ptp600, sMTPEnabledMessages=sMTPEnabledMessages, iPv6Address=iPv6Address, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, sNMPEnabledTraps=sNMPEnabledTraps, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapTable=sNMPTrapTable, linkModeOptimisation=linkModeOptimisation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, channelALoopbackTrap=channelALoopbackTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableIndex=dfsTableIndex, telecomsInterface=telecomsInterface, receiveModulationModeDetail=receiveModulationModeDetail, localPacketFiltering=localPacketFiltering, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, transmitPower=transmitPower, userName=userName, userRole=userRole, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, reset=reset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementVID=vLANManagementVID, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, targetRange=targetRange, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, daylightSaving=daylightSaving, receivePower=receivePower, receiveModulationMode=receiveModulationMode, syslogControlGroup=syslogControlGroup, iPVersion=iPVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTable=iPDSCPPriorityTable, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, telecomsChannelBStatus=telecomsChannelBStatus, dataPortFiberStatus=dataPortFiberStatus, linkLoss=linkLoss, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogControl=syslogControl, installStatus=installStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelSelection=telecomsChannelSelection, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveDataRate=receiveDataRate, timeZone=timeZone, secondarySoftwareVersion=secondarySoftwareVersion, ethernet=ethernet, supplementaryGroup=supplementaryGroup, sNTPSync=sNTPSync, sntp=sntp, dataPortFiberStatusTrap=dataPortFiberStatusTrap, maximumTransmitPower=maximumTransmitPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTable=dfsTable, gatewayIPAddress=gatewayIPAddress, dfsTableEntry=dfsTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, regionCode=regionCode, managementGroup=managementGroup, bandwidthVariant=bandwidthVariant, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBLoopback=channelBLoopback, telecomGroup=telecomGroup, rangingMode=rangingMode, channelACableLength=channelACableLength, aAAControlGroup=aAAControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, managementMode=managementMode, transmitChannel=transmitChannel, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortAutoMdix=dataPortAutoMdix, searchState=searchState, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, channelBCableLength=channelBCableLength, tDDControlGroup=tDDControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, smtp=smtp, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, secureModeAlarmTrap=secureModeAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, sNTPServerRetries=sNTPServerRetries, channelChangeTrap=channelChangeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetMACAddress=targetMACAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTable=sNTPServerTable, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, versions=versions, channelBandwidth=channelBandwidth, syslogState=syslogState, range=range, bootVersion=bootVersion, managementPortStatusTrap=managementPortStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, linkSymmetry=linkSymmetry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, siteName=siteName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPSPortNumber=hTTPSPortNumber, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, notificationsGroup=notificationsGroup, l2CPPriorityTable=l2CPPriorityTable, snmpControlGroup=snmpControlGroup, sNTPServerStatus=sNTPServerStatus, channelBLoopbackTrap=channelBLoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, ethernetBridgingAvailability=ethernetBridgingAvailability, productName=productName, alarmsGroup=alarmsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, syslogClient=syslogClient, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, byteErrorRatio=byteErrorRatio, masterSlaveMode=masterSlaveMode, remoteInternetAddress=remoteInternetAddress, rxColorCode=rxColorCode, installArmStateTrap=installArmStateTrap, automaticTxPowerControl=automaticTxPowerControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, phyStatus=phyStatus, syslogClientTrap=syslogClientTrap, ethernetBridgingStatus=ethernetBridgingStatus, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, licence=licence, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitDataRate=transmitDataRate, ethernetPriorityTable=ethernetPriorityTable, sNTPServerIPAddress=sNTPServerIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryption=encryption, dfsMeans=dfsMeans, tFTPServerInternetAddress=tFTPServerInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, dataPortStatusTrap=dataPortStatusTrap, sNTPState=sNTPState, licenceGroup=licenceGroup, tDDControl=tDDControl, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, pubStatsGroup=pubStatsGroup, sNTPServerPortNumber=sNTPServerPortNumber, frequencyVariant=frequencyVariant, managementPortStatus=managementPortStatus, ptp=ptp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpGroups=ptpGroups, configurationGroup=configurationGroup, regionCodeTrap=regionCodeTrap, txColorCode=txColorCode, cambium=cambium, channelALoopback=channelALoopback, resetGroup=resetGroup, antennaGain=antennaGain)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmState=installArmState, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telecom=telecom, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vectorError=vectorError, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsGroup=dfsGroup, configuration=configuration, accessMethod=accessMethod, hAZLOCConfiguration=hAZLOCConfiguration, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, userPassword=userPassword, groupID=groupID, ethernetGroup=ethernetGroup, userTable=userTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPPrimaryServer=sNTPPrimaryServer, rawReceivePower=rawReceivePower, systemClock=systemClock, softwareVersion=softwareVersion, bridge=bridge, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, eIRP=eIRP, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitFreqKHz=transmitFreqKHz, sNTPServerTimeout=sNTPServerTimeout, iPv4Address=iPv4Address, dfsPeaks=dfsPeaks, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, installStatusTrap=installStatusTrap)
