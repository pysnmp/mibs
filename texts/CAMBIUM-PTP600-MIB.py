...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelACableLength=channelACableLength, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, phyControl=phyControl, smtp=smtp, channelALoopbackTrap=channelALoopbackTrap, iPVersion=iPVersion, sNTPServerTable=sNTPServerTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rxColorCode=rxColorCode, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetBridgingStatus=ethernetBridgingStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installArmState=installArmState, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, softwareVersion=softwareVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsTable=dfsTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntpGroup=sntpGroup, managementPortStatus=managementPortStatus, supplementaryGroup=supplementaryGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityTable=l2CPPriorityTable, linkLoss=linkLoss, channelBLoopbackTrap=channelBLoopbackTrap, bridgeGroup=bridgeGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfs=dfs, licence=licence, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, bridge=bridge, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userEnabled=userEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, versionsGroup=versionsGroup, automaticTxPowerControl=automaticTxPowerControl, linkSymmetry=linkSymmetry, localPacketFiltering=localPacketFiltering, sNTPSyncTrap=sNTPSyncTrap, telnetPortNumber=telnetPortNumber, ptp=ptp, sNTPSync=sNTPSync, alarms=alarms, resetGroup=resetGroup, dfsMeans=dfsMeans, telecomGroup=telecomGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelBStatus=telecomsChannelBStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, maximumTransmitPower=maximumTransmitPower, remoteInternetAddress=remoteInternetAddress, linkModeOptimisation=linkModeOptimisation, sNMPCommunityString=sNMPCommunityString, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTableNumber=sNTPServerTableNumber, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rangingMode=rangingMode, dataPortStatusTrap=dataPortStatusTrap, hAZLOCConfiguration=hAZLOCConfiguration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortDisabledWarning=managementPortDisabledWarning, managementGroup=managementGroup, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPv4Address=iPv4Address, sMTPServerIPAddress=sMTPServerIPAddress, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableNumber=dfsTableNumber, phyControlGroup=phyControlGroup, ptpCompliance=ptpCompliance, sNMPTrapTableIndex=sNMPTrapTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, alarmsGroup=alarmsGroup, groupID=groupID, configuration=configuration, dfsTableIndex=dfsTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, telnetAccessEnabled=telnetAccessEnabled, userName=userName, timeZone=timeZone, channelALoopback=channelALoopback, channelChangeTrap=channelChangeTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, latitude=latitude, channelBLineCode=channelBLineCode, ptp600=ptp600, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, sntp=sntp, masterSlaveMode=masterSlaveMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementary=supplementary, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPState=sNTPState, versions=versions, aAAControlGroup=aAAControlGroup, longitude=longitude, sNTPServerStatus=sNTPServerStatus, syslogState=syslogState, productName=productName, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rawReceivePower=rawReceivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPv6Address=iPv6Address, iPDSCPPriorityTable=iPDSCPPriorityTable, qOSPriorityScheme=qOSPriorityScheme, secondarySoftwareVersion=secondarySoftwareVersion, syslogControlGroup=syslogControlGroup, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, bootVersion=bootVersion, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernet=ethernet, systemReset=systemReset, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, encryption=encryption, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, encryptionGroup=encryptionGroup, systemClock=systemClock, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userPassword=userPassword, tDDControl=tDDControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveChannel=receiveChannel, vectorError=vectorError, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortFiberStatus=dataPortFiberStatus, receiveDataRate=receiveDataRate, linkName=linkName, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, sNTPServerRetries=sNTPServerRetries, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementMode=managementMode, secureModeAlarmTrap=secureModeAlarmTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerIPAddress=sNTPServerIPAddress, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, receiveFreqMHz=receiveFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecom=telecom, ethernetGroup=ethernetGroup, tDDControlGroup=tDDControlGroup, management=management, eIRP=eIRP, frequencyVariant=frequencyVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, secureModeAlarm=secureModeAlarm, sNTPServerPortNumber=sNTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, byteErrorRatio=byteErrorRatio, managementPortStatusTrap=managementPortStatusTrap, dfsPeaks=dfsPeaks, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, regionCodeTrap=regionCodeTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, syslogClient=syslogClient, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatus=installStatus, gatewayIPAddress=gatewayIPAddress, aggregateDataRate=aggregateDataRate, siteName=siteName, ethernetPriorityTable=ethernetPriorityTable, accessMethod=accessMethod, targetMACAddress=targetMACAddress, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, userTableIndex=userTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, sNTPServerTableEntry=sNTPServerTableEntry, configurationGroup=configurationGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, sNTPPrimaryServer=sNTPPrimaryServer, dfsTableEntry=dfsTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelBCableLength=channelBCableLength, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, ptpGroups=ptpGroups, range=range, transmitModulationMode=transmitModulationMode, productVariant=productVariant, syslogControl=syslogControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, targetRange=targetRange, receiveFreqKHz=receiveFreqKHz)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecomsChannelSelection=telecomsChannelSelection, telecomsInterface=telecomsInterface, pubStatsGroup=pubStatsGroup, regionCode=regionCode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, altitude=altitude, txColorCode=txColorCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBLoopback=channelBLoopback, cambium=cambium, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, signalStrengthRatio=signalStrengthRatio, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptmp=ptmp, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingAvailability=ethernetBridgingAvailability, vLANManagementPriority=vLANManagementPriority, phyStatusGroup=phyStatusGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTableEntry=userTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telecomsChannelAStatus=telecomsChannelAStatus, antennaGain=antennaGain, sNMPv3Enable=sNMPv3Enable, remoteInternetAddressType=remoteInternetAddressType, PYSNMP_MODULE_ID=cambium, tDDSynchronizationMode=tDDSynchronizationMode, syslogClientTrap=syslogClientTrap, reset=reset, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, securityLevel=securityLevel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALineCode=channelALineCode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vLANManagementVID=vLANManagementVID, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState)
