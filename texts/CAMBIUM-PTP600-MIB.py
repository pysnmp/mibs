...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernet=ethernet, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableEntry=sNTPServerTableEntry, cableLoss=cableLoss, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, vLANManagementVID=vLANManagementVID, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyControlGroup=phyControlGroup, iPv6Address=iPv6Address, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, syslogControlGroup=syslogControlGroup, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortFiberStatus=dataPortFiberStatus, sMTPServerIPAddress=sMTPServerIPAddress, userEnabled=userEnabled, userRole=userRole, constantPowerSpectralDensity=constantPowerSpectralDensity, productName=productName, installStatusTrap=installStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, syslogClient=syslogClient, longitude=longitude, telnetAccessEnabled=telnetAccessEnabled, securityLevel=securityLevel, ethernetPriorityTable=ethernetPriorityTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, softwareVersion=softwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, telnetPortNumber=telnetPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPLastSync=sNTPLastSync, sNMPTrapTable=sNMPTrapTable, ptp=ptp, txColorCode=txColorCode, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimisation=linkModeOptimisation, sNTPPollInterval=sNTPPollInterval, receiveChannel=receiveChannel, sNTPServerRetries=sNTPServerRetries, iPv6PrefixLength=iPv6PrefixLength, range=range, linkLoss=linkLoss, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, sNTPServerInternetAddress=sNTPServerInternetAddress, systemReset=systemReset, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, latitude=latitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, regionCode=regionCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, subnetMask=subnetMask, telecomsChannelAStatus=telecomsChannelAStatus, phyStatus=phyStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANManagementPriority=vLANManagementPriority, channelBLoopback=channelBLoopback, rxColorCode=rxColorCode, userTableEntry=userTableEntry, accessMethod=accessMethod, managementMode=managementMode, bridgeGroup=bridgeGroup, licence=licence, transmitDataRate=transmitDataRate, syslogControl=syslogControl, timeZone=timeZone, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versions=versions, ethernetBridgingStatus=ethernetBridgingStatus, phyStatusGroup=phyStatusGroup, channelALoopback=channelALoopback, targetRange=targetRange, managementPortDisabledWarning=managementPortDisabledWarning, syslogClientTrap=syslogClientTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptmp=ptmp, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsInterface=telecomsInterface, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkAvailability=wirelessLinkAvailability, transmitPower=transmitPower, supplementary=supplementary, eIRP=eIRP, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bootVersion=bootVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, management=management, ethernetPriorityTableNumber=ethernetPriorityTableNumber, productVariant=productVariant, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, localPacketFiltering=localPacketFiltering, channelBandwidth=channelBandwidth, secureModeAlarmTrap=secureModeAlarmTrap, systemClock=systemClock, aAAControlGroup=aAAControlGroup, tDDControl=tDDControl, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptpGroups=ptpGroups, pubStats=pubStats, tDDControlGroup=tDDControlGroup, telecomsChannelSelection=telecomsChannelSelection, hTTPPortNumber=hTTPPortNumber, installStatus=installStatus, frequencyVariant=frequencyVariant, managementGroup=managementGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, encryptionGroup=encryptionGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerStatus=sNTPServerStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableIndex=dfsTableIndex, pubStatsGroup=pubStatsGroup, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServer=sNTPPrimaryServer, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, dfsTable=dfsTable, receiveModulationMode=receiveModulationMode, altitude=altitude, alarms=alarms, ptp600=ptp600, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsMeans=dfsMeans, channelBLoopbackTrap=channelBLoopbackTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryption=encryption, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, receivePower=receivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, incompatibleRegionCodes=incompatibleRegionCodes, userTableIndex=userTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelALoopbackTrap=channelALoopbackTrap, sNTPServerPortNumber=sNTPServerPortNumber, ptpTraps=ptpTraps, receiveModulationModeDetail=receiveModulationModeDetail, remoteIPAddress=remoteIPAddress, syslogState=syslogState, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPVersion=iPVersion, userName=userName, regionCodeTrap=regionCodeTrap, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, daylightSaving=daylightSaving, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, siteName=siteName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bridge=bridge, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBCableLength=channelBCableLength, unitOutOfCalibration=unitOutOfCalibration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTableNumber=sNTPServerTableNumber, cambium=cambium, ptpCompliance=ptpCompliance, managementPortStatus=managementPortStatus, resetGroup=resetGroup, antennaGain=antennaGain, dSCPManagementPriority=dSCPManagementPriority, rangingMode=rangingMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, qOSPriorityScheme=qOSPriorityScheme, telecom=telecom, searchState=searchState, channelACableLength=channelACableLength, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitChannel=transmitChannel, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableNumber=dfsTableNumber, snmpControl=snmpControl, smtp=smtp, dataPortStatus=dataPortStatus, reset=reset, iPDSCPPriorityTable=iPDSCPPriorityTable)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", notificationsGroup=notificationsGroup, dfsGroup=dfsGroup, phyControl=phyControl, installArmState=installArmState, vectorError=vectorError, sNTPSync=sNTPSync, l2CPPriorityTable=l2CPPriorityTable, groupID=groupID, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, dfs=dfs, ptpTrapPrefix=ptpTrapPrefix, remoteRxTargetPower=remoteRxTargetPower, sNTPServerTable=sNTPServerTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, byteErrorRatio=byteErrorRatio, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hAZLOCConfiguration=hAZLOCConfiguration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkName=linkName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelBStatus=telecomsChannelBStatus, telecomGroup=telecomGroup, channelBLineCode=channelBLineCode, rawReceivePower=rawReceivePower, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, userPassword=userPassword, iPv4Address=iPv4Address, channelChangeTrap=channelChangeTrap, channelALineCode=channelALineCode, iPv6GatewayAddress=iPv6GatewayAddress, sntp=sntp, masterSlaveMode=masterSlaveMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap)
