...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTable=sNTPServerTable, telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBandwidth=channelBandwidth, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, resetGroup=resetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, phyControlGroup=phyControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, iPv4Address=iPv4Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, accessMethod=accessMethod, telecomsChannelBStatus=telecomsChannelBStatus, transmitFreqKHz=transmitFreqKHz, latitude=latitude, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortDisabledWarning=managementPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, timeZone=timeZone, targetMACAddress=targetMACAddress, dfsTableEntry=dfsTableEntry, automaticTxPowerControl=automaticTxPowerControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveFreqMHz=receiveFreqMHz, ptp=ptp, channelALoopbackTrap=channelALoopbackTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSPortNumber=hTTPSPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxColorCode=rxColorCode, rawReceivePower=rawReceivePower, syslogStateTrap=syslogStateTrap, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, groupID=groupID, channelACableLength=channelACableLength, regionCodeTrap=regionCodeTrap, productVariant=productVariant, licence=licence, sNTPLastSync=sNTPLastSync, daylightSaving=daylightSaving, linkSymmetry=linkSymmetry, transmitChannel=transmitChannel, eIRP=eIRP, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userPassword=userPassword, phyStatusGroup=phyStatusGroup, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, tDDControl=tDDControl, ptpGroups=ptpGroups, wirelessLinkStatus=wirelessLinkStatus, txColorCode=txColorCode, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, installStatus=installStatus, ptpTraps=ptpTraps, dataPortFiberStatus=dataPortFiberStatus, ethernetBridgingStatus=ethernetBridgingStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, telnetPortNumber=telnetPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, installArmState=installArmState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, frequencyVariant=frequencyVariant, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyControl=phyControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userName=userName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLoopback=channelBLoopback, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, longitude=longitude, syslogControlGroup=syslogControlGroup, smtp=smtp, dSCPManagementPriority=dSCPManagementPriority, syslogClientTrap=syslogClientTrap, userRole=userRole, secureModeAlarmTrap=secureModeAlarmTrap, bridge=bridge, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, userEnabled=userEnabled, productName=productName, sNMPTrapTableNumber=sNMPTrapTableNumber, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, cableLoss=cableLoss, dfsTableIndex=dfsTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, management=management, securityLevel=securityLevel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, ptmp=ptmp, qOSPriorityScheme=qOSPriorityScheme, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelAStatus=telecomsChannelAStatus, userTableEntry=userTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp600=ptp600, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBLineCode=channelBLineCode, managementPortStatus=managementPortStatus, versionsGroup=versionsGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, sntpGroup=sntpGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTable=userTable, managementGroup=managementGroup, searchState=searchState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelSelection=telecomsChannelSelection, licenceGroup=licenceGroup, iPVersion=iPVersion, sNTPServerPortNumber=sNTPServerPortNumber, configuration=configuration, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, sntp=sntp, ptpCompliance=ptpCompliance, antennaGain=antennaGain, sNTPSync=sNTPSync, vectorError=vectorError, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarm=secureModeAlarm, encryption=encryption, sNTPPrimaryServer=sNTPPrimaryServer, dfsTableNumber=dfsTableNumber, sNTPServerStatus=sNTPServerStatus, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, notificationsGroup=notificationsGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortStatus=dataPortStatus, altitude=altitude, syslogControl=syslogControl, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomGroup=telecomGroup, alarmsGroup=alarmsGroup, sNTPServerTableEntry=sNTPServerTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, linkLoss=linkLoss, rangingMode=rangingMode, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, managementPortStatusTrap=managementPortStatusTrap, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, cambium=cambium, receiveChannel=receiveChannel, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPPortNumber=sNMPPortNumber, syslogState=syslogState, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versions=versions, remoteInternetAddressType=remoteInternetAddressType, sNTPServerRetries=sNTPServerRetries, gatewayIPAddress=gatewayIPAddress, telecom=telecom, linkName=linkName, pubStats=pubStats, channelALoopback=channelALoopback, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, dfsGroup=dfsGroup, sNTPServerTimeout=sNTPServerTimeout, bridgeGroup=bridgeGroup, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPollInterval=sNTPPollInterval, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, localPacketFiltering=localPacketFiltering, configurationGroup=configurationGroup, channelBCableLength=channelBCableLength, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsTable=dfsTable, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, hAZLOCConfiguration=hAZLOCConfiguration)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveDataRate=receiveDataRate, managementMode=managementMode, snmpControlGroup=snmpControlGroup, range=range, unitOutOfCalibration=unitOutOfCalibration, softwareVersion=softwareVersion, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, channelALineCode=channelALineCode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetRange=targetRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, hardwareVersion=hardwareVersion, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, remoteRxTargetPower=remoteRxTargetPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTable=sNMPTrapTable, reset=reset, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bandwidthVariant=bandwidthVariant, dfs=dfs, alarms=alarms, iPv6PrefixLength=iPv6PrefixLength, iPv6Address=iPv6Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, hTTPPortNumber=hTTPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime)
