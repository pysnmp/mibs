...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationModeDetail=receiveModulationModeDetail, channelBandwidth=channelBandwidth, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, sNTPServerTableIndex=sNTPServerTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, qOSPriorityScheme=qOSPriorityScheme, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, bridge=bridge, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortAutoMdix=dataPortAutoMdix, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, channelALoopback=channelALoopback, managementPortStatus=managementPortStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, pubStatsGroup=pubStatsGroup, smtpGroup=smtpGroup, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, longitude=longitude, sMTPServerPortNumber=sMTPServerPortNumber, phyControl=phyControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionAlgorithm=encryptionAlgorithm, ethernet=ethernet, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, antennaGain=antennaGain, iPv4Address=iPv4Address, bootVersion=bootVersion, tDDControlGroup=tDDControlGroup, rxColorCode=rxColorCode, configurationGroup=configurationGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, managementGroup=managementGroup, systemClock=systemClock, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogState=syslogState, channelBLoopback=channelBLoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, latitude=latitude, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, rawReceivePower=rawReceivePower, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, productVariant=productVariant, remoteRxTargetPower=remoteRxTargetPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkStatus=wirelessLinkStatus, channelBCableLength=channelBCableLength, managementPortDisabledWarning=managementPortDisabledWarning, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANManagementPriority=vLANManagementPriority, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, configuration=configuration, telecom=telecom, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, installArmState=installArmState, aAAControl=aAAControl, iPVersion=iPVersion, searchState=searchState, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationStatus=tDDSynchronizationStatus, subnetMask=subnetMask, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userEnabled=userEnabled, receiveFreqMHz=receiveFreqMHz, linkName=linkName, transmitModulationMode=transmitModulationMode, sNTPSyncTrap=sNTPSyncTrap, aAAControlGroup=aAAControlGroup, range=range, regionCodeTrap=regionCodeTrap, encryption=encryption, ethernetBridgingStatus=ethernetBridgingStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, timeZone=timeZone, ptpGroups=ptpGroups, altitude=altitude, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomGroup=telecomGroup, userName=userName, dfs=dfs, installStatusTrap=installStatusTrap, licenceGroup=licenceGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePower=receivePower, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, ptmp=ptmp, automaticTxPowerControl=automaticTxPowerControl, sNMPPortNumber=sNMPPortNumber, secureModeAlarm=secureModeAlarm, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, dfsTable=dfsTable, frequencyVariant=frequencyVariant, channelBLineCode=channelBLineCode, receiveChannel=receiveChannel, sNTPServerTimeout=sNTPServerTimeout, sntp=sntp, regionCode=regionCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableNumber=sNTPServerTableNumber, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelBStatus=telecomsChannelBStatus, dataPortFiberStatus=dataPortFiberStatus, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodes=incompatibleRegionCodes, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogControl=syslogControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rangingMode=rangingMode, smtp=smtp, dSCPManagementPriority=dSCPManagementPriority, transmitFreqMHz=transmitFreqMHz, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, resetGroup=resetGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, productName=productName, syslogControlGroup=syslogControlGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, cableLoss=cableLoss, phyControlGroup=phyControlGroup, bridgeGroup=bridgeGroup, channelALineCode=channelALineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSync=sNTPSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, txColorCode=txColorCode, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTraps=ptpTraps, sNTPServerTableEntry=sNTPServerTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userTableNumber=userTableNumber, pubStats=pubStats, channelACableLength=channelACableLength, securityLevel=securityLevel, snmpControlGroup=snmpControlGroup, sNTPPollInterval=sNTPPollInterval, targetMACAddress=targetMACAddress, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, versions=versions, telecomsChannelAStatus=telecomsChannelAStatus, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, supplementary=supplementary, localPacketFiltering=localPacketFiltering, phyStatus=phyStatus, ptp600=ptp600, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, siteName=siteName, syslogStateTrap=syslogStateTrap, accessMethod=accessMethod, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPv6Address=iPv6Address, softwareVersion=softwareVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, telecomsInterface=telecomsInterface, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsPeaks=dfsPeaks, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userPassword=userPassword, dfsGroup=dfsGroup, eIRP=eIRP, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, dfsTableEntry=dfsTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTableIndex=sNMPTrapTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, remoteInternetAddress=remoteInternetAddress, dfsMeans=dfsMeans, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, targetRange=targetRange, alarms=alarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPState=sNTPState, sntpGroup=sntpGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPv6PrefixLength=iPv6PrefixLength, channelALoopbackTrap=channelALoopbackTrap, encryptionGroup=encryptionGroup, userTable=userTable, noWirelessChannelAvailable=noWirelessChannelAvailable, reset=reset, secureModeAlarmTrap=secureModeAlarmTrap, masterSlaveMode=masterSlaveMode, sNTPServerIPAddress=sNTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cambium=cambium, sNTPServerStatus=sNTPServerStatus, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, managementPortStatusTrap=managementPortStatusTrap, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddressType=remoteInternetAddressType, transmitChannel=transmitChannel, ethernetPriorityTable=ethernetPriorityTable, remoteIPAddress=remoteIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, dataPortStatus=dataPortStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTable=sNTPServerTable, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress)
