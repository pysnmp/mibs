...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bandwidthVariant=bandwidthVariant, eIRP=eIRP, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTableEntry=userTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receivePower=receivePower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, localPacketFiltering=localPacketFiltering, ethernetGroup=ethernetGroup, encryptionGroup=encryptionGroup, targetMACAddress=targetMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, smtpGroup=smtpGroup, ethernetBridgingStatus=ethernetBridgingStatus, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, management=management, sNTPServerTableEntry=sNTPServerTableEntry, dataPortAutoMdix=dataPortAutoMdix, remoteRxTargetPower=remoteRxTargetPower, sNTPPollInterval=sNTPPollInterval, dfsTable=dfsTable, channelBLineCode=channelBLineCode, syslogControlGroup=syslogControlGroup, userName=userName, channelBLoopbackTrap=channelBLoopbackTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, antennaGain=antennaGain, incompatibleRegionCodes=incompatibleRegionCodes, installArmState=installArmState, remoteInternetAddress=remoteInternetAddress, channelBLoopback=channelBLoopback, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productVariant=productVariant, receiveFreqKHz=receiveFreqKHz, dataPortFiberStatus=dataPortFiberStatus, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerTimeout=sNTPServerTimeout, groupID=groupID, systemReset=systemReset, transmitChannel=transmitChannel, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, sNTPPrimaryServer=sNTPPrimaryServer, timeZone=timeZone, channelChangeTrap=channelChangeTrap, channelALoopback=channelALoopback, pubStats=pubStats, gatewayIPAddress=gatewayIPAddress, searchState=searchState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerInternetAddressType=tFTPServerInternetAddressType, productName=productName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPPortNumber=hTTPPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, secureModeAlarmTrap=secureModeAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsInterface=telecomsInterface, managementPortDisabledWarning=managementPortDisabledWarning, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, ptpCompliance=ptpCompliance, channelACableLength=channelACableLength, userTableNumber=userTableNumber, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, daylightSaving=daylightSaving, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelBStatus=telecomsChannelBStatus, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, ethernet=ethernet, aAAControl=aAAControl, masterSlaveMode=masterSlaveMode, iPv4Address=iPv4Address, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, qOSPriorityScheme=qOSPriorityScheme, licence=licence, linkSymmetry=linkSymmetry, transmitFreqKHz=transmitFreqKHz, supplementary=supplementary, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, regionCode=regionCode, reset=reset, tDDControl=tDDControl, latitude=latitude, dfsMeans=dfsMeans, dfsPeaks=dfsPeaks, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpGroups=ptpGroups, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDControlGroup=tDDControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, dfs=dfs, notificationsGroup=notificationsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, dfsTableIndex=dfsTableIndex, resetGroup=resetGroup, ptp600=ptp600, vLANManagementVID=vLANManagementVID, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, hTTPSPortNumber=hTTPSPortNumber, smtp=smtp, pubStatsGroup=pubStatsGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, accessMethod=accessMethod, versionsGroup=versionsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, automaticTxPowerControl=automaticTxPowerControl, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, telecom=telecom, subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, iPv6Address=iPv6Address, phyControl=phyControl, userEnabled=userEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetRange=targetRange, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, userTableIndex=userTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, rangingMode=rangingMode, siteName=siteName, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, altitude=altitude, phyControlGroup=phyControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, iPVersion=iPVersion, syslogState=syslogState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTable=userTable, userRole=userRole, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, alarmsGroup=alarmsGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, sMTPEnabledMessages=sMTPEnabledMessages, alarms=alarms, aAAControlGroup=aAAControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerRetries=sNTPServerRetries, ptp=ptp, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, installStatus=installStatus, licenceGroup=licenceGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, softwareVersion=softwareVersion, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, sNTPSyncTrap=sNTPSyncTrap, managementPortStatusTrap=managementPortStatusTrap, snmpControlGroup=snmpControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationMode=tDDSynchronizationMode, sntp=sntp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, userPassword=userPassword, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, sNTPState=sNTPState, systemClock=systemClock, channelALoopbackTrap=channelALoopbackTrap, syslogControl=syslogControl, bridge=bridge, rawReceivePower=rawReceivePower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelBCableLength=channelBCableLength, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, iPv6PrefixLength=iPv6PrefixLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cambium=cambium, receiveDataRate=receiveDataRate, sNTPServerStatus=sNTPServerStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sntpGroup=sntpGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTable=sNTPServerTable, txColorCode=txColorCode, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelALineCode=channelALineCode, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, bridgeGroup=bridgeGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerInternetAddress=sNTPServerInternetAddress, rxColorCode=rxColorCode, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityTable=ethernetPriorityTable, telecomGroup=telecomGroup, versions=versions, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, range=range, signalStrengthRatio=signalStrengthRatio, encryption=encryption, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatusTrap=installStatusTrap, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteIPAddress=remoteIPAddress, supplementaryGroup=supplementaryGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, longitude=longitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementMode=managementMode, configurationGroup=configurationGroup, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveModulationMode=receiveModulationMode, securityLevel=securityLevel, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, managementPortStatus=managementPortStatus, receiveChannel=receiveChannel, syslogClientTrap=syslogClientTrap)
