...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", txColorCode=txColorCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControlGroup=tDDControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerIPAddress=tFTPServerIPAddress, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, antennaGain=antennaGain, bootVersion=bootVersion, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapTable=sNMPTrapTable, hTTPPortNumber=hTTPPortNumber, versions=versions, ethernetGroup=ethernetGroup, secureModeAlarm=secureModeAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, reset=reset, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bandwidthVariant=bandwidthVariant, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, receivePower=receivePower, snmpControl=snmpControl, syslogControlGroup=syslogControlGroup, targetRange=targetRange, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableNumber=userTableNumber, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, ethernet=ethernet, range=range, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userRole=userRole, systemClock=systemClock, rangingMode=rangingMode, sntpGroup=sntpGroup, configurationGroup=configurationGroup, remoteRxTargetPower=remoteRxTargetPower, sMTPEmailAlert=sMTPEmailAlert, iPv6Address=iPv6Address, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telnetPortNumber=telnetPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, userTableIndex=userTableIndex, rxColorCode=rxColorCode, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, vLANManagementVID=vLANManagementVID, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDControl=tDDControl, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bridgeGroup=bridgeGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecom=telecom, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, encryptionGroup=encryptionGroup, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPv3Enable=sNMPv3Enable, alarms=alarms, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, cableLoss=cableLoss, pubStats=pubStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, longitude=longitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitModulationMode=transmitModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTableIndex=dfsTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTableIndex=sNTPServerTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, iPv6PrefixLength=iPv6PrefixLength, telecomGroup=telecomGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogClient=syslogClient, vectorError=vectorError, daylightSaving=daylightSaving, softwareVersion=softwareVersion, sNTPServerTimeout=sNTPServerTimeout, licence=licence, remoteIPAddress=remoteIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, resetGroup=resetGroup, hAZLOCConfiguration=hAZLOCConfiguration, bridge=bridge, linkName=linkName, altitude=altitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortDisabledWarning=managementPortDisabledWarning, versionsGroup=versionsGroup, wirelessLinkStatus=wirelessLinkStatus, ethernetBridgingStatus=ethernetBridgingStatus, channelBCableLength=channelBCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfs=dfs, userPassword=userPassword, iPVersion=iPVersion, pubStatsGroup=pubStatsGroup, supplementaryGroup=supplementaryGroup, productName=productName, receiveFreqMHz=receiveFreqMHz, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installStatusTrap=installStatusTrap, sNTPServerTable=sNTPServerTable, hTTPSPortNumber=hTTPSPortNumber, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, dfsTableNumber=dfsTableNumber, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBandwidth=channelBandwidth, ethernetPriorityTable=ethernetPriorityTable, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, dSCPManagementPriority=dSCPManagementPriority, automaticTxPowerControl=automaticTxPowerControl, eIRP=eIRP, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, userTable=userTable, installArmStateTrap=installArmStateTrap, userEnabled=userEnabled, receiveChannel=receiveChannel, userTableEntry=userTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, channelBLineCode=channelBLineCode, channelChangeTrap=channelChangeTrap, supplementary=supplementary, managementGroup=managementGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpGroups=ptpGroups, linkLoss=linkLoss, sNMPCommunityString=sNMPCommunityString, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelACableLength=channelACableLength, ptp=ptp, maximumTransmitPower=maximumTransmitPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetFiberSupport=ethernetFiberSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aAAControl=aAAControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, dfsTable=dfsTable, telecomsInterface=telecomsInterface, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemReset=systemReset, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityTable=l2CPPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortFiberStatus=dataPortFiberStatus, encryption=encryption, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, productVariant=productVariant, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatus=phyStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimisation=linkModeOptimisation, sNTPState=sNTPState, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cambium=cambium, telnetAccessEnabled=telnetAccessEnabled, dfsGroup=dfsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, latitude=latitude, channelALineCode=channelALineCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitChannel=transmitChannel, channelALoopbackTrap=channelALoopbackTrap, channelBLoopback=channelBLoopback, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, telecomsChannelAStatus=telecomsChannelAStatus, sNTPSync=sNTPSync, managementPortStatus=managementPortStatus, licenceGroup=licenceGroup, linkSymmetry=linkSymmetry, sntp=sntp, syslogControl=syslogControl, wirelessLinkAvailability=wirelessLinkAvailability, targetMACAddress=targetMACAddress, byteErrorRatio=byteErrorRatio, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptp600=ptp600, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelALoopback=channelALoopback, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerStatus=sNTPServerStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortStatusTrap=managementPortStatusTrap, ptmp=ptmp, managementMode=managementMode, hTTPAccessEnabled=hTTPAccessEnabled, accessMethod=accessMethod, phyControl=phyControl, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv4Address=iPv4Address, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddressType=remoteInternetAddressType, sNTPServerRetries=sNTPServerRetries, notificationsGroup=notificationsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, regionCode=regionCode, securityLevel=securityLevel, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, telecomsChannelSelection=telecomsChannelSelection, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitDataRate=transmitDataRate, siteName=siteName, dfsTableEntry=dfsTableEntry, rawReceivePower=rawReceivePower)
