...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntpGroup=sntpGroup, sNTPServerTableNumber=sNTPServerTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cableLoss=cableLoss, telecomsChannelAStatus=telecomsChannelAStatus, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, masterSlaveMode=masterSlaveMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, productName=productName, linkLoss=linkLoss, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, securityLevel=securityLevel, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hAZLOCConfiguration=hAZLOCConfiguration, linkModeOptimisation=linkModeOptimisation, rxColorCode=rxColorCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, channelChangeTrap=channelChangeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userRole=userRole, aAAControl=aAAControl, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelALineCode=channelALineCode, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortStatusTrap=managementPortStatusTrap, dfsTable=dfsTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerRetries=sNTPServerRetries, localPacketFiltering=localPacketFiltering, licence=licence, sNTPServerTableEntry=sNTPServerTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, cambium=cambium, smtp=smtp, subnetMask=subnetMask, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBLineCode=channelBLineCode, timeZone=timeZone, aggregateDataRate=aggregateDataRate, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryption=encryption, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, targetMACAddress=targetMACAddress, bridge=bridge, alarms=alarms, iPVersion=iPVersion, supplementaryGroup=supplementaryGroup, ethernetBridgingStatus=ethernetBridgingStatus, rawReceivePower=rawReceivePower, sNTPServerPortNumber=sNTPServerPortNumber, groupID=groupID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, targetRange=targetRange, installStatus=installStatus, ptp=ptp, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, encryptionAlgorithm=encryptionAlgorithm, remoteInternetAddress=remoteInternetAddress, ethernet=ethernet, supplementary=supplementary, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomGroup=telecomGroup, receiveModulationMode=receiveModulationMode, txColorCode=txColorCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, vLANManagementPriority=vLANManagementPriority, wirelessLinkAvailability=wirelessLinkAvailability, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsMeans=dfsMeans, pubStats=pubStats, managementPortStatus=managementPortStatus, transmitFreqMHz=transmitFreqMHz, regionCodeTrap=regionCodeTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetail=receiveModulationModeDetail, dataPortDisabledWarning=dataPortDisabledWarning, daylightSaving=daylightSaving, configuration=configuration, notificationsGroup=notificationsGroup, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, systemClock=systemClock, siteName=siteName, signalStrengthRatio=signalStrengthRatio, phyControlGroup=phyControlGroup, userPassword=userPassword, iPv4Address=iPv4Address, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteIPAddress=remoteIPAddress, transmitFreqKHz=transmitFreqKHz, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServer=sNTPPrimaryServer, encryptionGroup=encryptionGroup, ptpTrapPrefix=ptpTrapPrefix, userTableIndex=userTableIndex, installStatusTrap=installStatusTrap, managementMode=managementMode, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, tDDControlGroup=tDDControlGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, secureModeAlarm=secureModeAlarm, management=management, linkSymmetry=linkSymmetry, tDDControl=tDDControl, syslogControlGroup=syslogControlGroup, channelACableLength=channelACableLength, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPPortNumber=hTTPPortNumber, smtpGroup=smtpGroup, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfs=dfs, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, l2CPPriorityTable=l2CPPriorityTable, telecomsChannelSelection=telecomsChannelSelection, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, telecom=telecom, phyControl=phyControl, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatusGroup=phyStatusGroup, vectorError=vectorError, receivePower=receivePower, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerStatus=sNTPServerStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, ptmp=ptmp, ptp600=ptp600, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, transmitPower=transmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTable=mPLSTCPriorityTable, accessMethod=accessMethod, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, range=range, dfsTableEntry=dfsTableEntry, configurationGroup=configurationGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, bootVersion=bootVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpCompliance=ptpCompliance, dataPortAutoMdix=dataPortAutoMdix, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userEnabled=userEnabled, byteErrorRatio=byteErrorRatio, sNTPSync=sNTPSync, licenceGroup=licenceGroup, linkName=linkName, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, dataPortStatusTrap=dataPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, telnetPortNumber=telnetPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, regionCode=regionCode, resetGroup=resetGroup, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, versions=versions, receiveFreqKHz=receiveFreqKHz, syslogControl=syslogControl, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, rangingMode=rangingMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableEntry=userTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, receiveFreqMHz=receiveFreqMHz, userTable=userTable, channelBLoopback=channelBLoopback, versionsGroup=versionsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelALoopbackTrap=channelALoopbackTrap, remoteInternetAddressType=remoteInternetAddressType, bridgeGroup=bridgeGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, ethernetPriorityTableIndex=ethernetPriorityTableIndex, productVariant=productVariant, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, secureModeAlarmTrap=secureModeAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelALoopback=channelALoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTable=sNTPServerTable, incompatibleRegionCodes=incompatibleRegionCodes, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, bandwidthVariant=bandwidthVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPState=sNTPState, tFTPServerInternetAddress=tFTPServerInternetAddress, qOSPriorityScheme=qOSPriorityScheme, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelBCableLength=channelBCableLength, syslogClientTrap=syslogClientTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsInterface=telecomsInterface, telecomsChannelBStatus=telecomsChannelBStatus, sNTPLastSync=sNTPLastSync, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogStateTrap=syslogStateTrap, snmpControlGroup=snmpControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, dfsPeaks=dfsPeaks, altitude=altitude, automaticTxPowerControl=automaticTxPowerControl, iPv6Address=iPv6Address, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortFiberStatus=dataPortFiberStatus, sNTPServerTableIndex=sNTPServerTableIndex, syslogClient=syslogClient, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installArmState=installArmState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteRxTargetPower=remoteRxTargetPower, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel)
