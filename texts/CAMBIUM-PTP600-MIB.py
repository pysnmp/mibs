...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", notificationsGroup=notificationsGroup, iPv4Address=iPv4Address, bridge=bridge, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, bandwidthVariant=bandwidthVariant, frequencyVariant=frequencyVariant, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rxColorCode=rxColorCode, transmitDataRate=transmitDataRate, channelChangeTrap=channelChangeTrap, hTTPPortNumber=hTTPPortNumber, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControl=snmpControl, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemReset=systemReset, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, targetRange=targetRange, smtpGroup=smtpGroup, txColorCode=txColorCode, wirelessLinkStatus=wirelessLinkStatus, reset=reset, receiveFreqMHz=receiveFreqMHz, qOSPriorityScheme=qOSPriorityScheme, vectorError=vectorError, installStatus=installStatus, ptmp=ptmp, accessMethod=accessMethod, pubStats=pubStats, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsTableNumber=dfsTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, hTTPSPortNumber=hTTPSPortNumber, signalStrengthRatio=signalStrengthRatio, userPassword=userPassword, phyStatus=phyStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDControlGroup=tDDControlGroup, rangingMode=rangingMode, sntp=sntp, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, userTableEntry=userTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelACableLength=channelACableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, PYSNMP_MODULE_ID=cambium, siteName=siteName, telnetPortNumber=telnetPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, channelBLoopback=channelBLoopback, telecom=telecom, channelALineCode=channelALineCode, dataPortStatus=dataPortStatus, ethernet=ethernet, linkLoss=linkLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementGroup=managementGroup, rawReceivePower=rawReceivePower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitPower=transmitPower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, supplementaryGroup=supplementaryGroup, syslogState=syslogState, receiveModulationModeDetail=receiveModulationModeDetail, managementPortStatusTrap=managementPortStatusTrap, systemClock=systemClock, installArmState=installArmState, tDDControl=tDDControl, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, phyStatusGroup=phyStatusGroup, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, sNTPServerStatus=sNTPServerStatus, ptp600=ptp600, telecomsChannelAStatus=telecomsChannelAStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, automaticTxPowerControl=automaticTxPowerControl, ethernetPriorityTable=ethernetPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, productVariant=productVariant, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, resetGroup=resetGroup, hAZLOCConfiguration=hAZLOCConfiguration, groupID=groupID, dataPortFiberStatus=dataPortFiberStatus, receiveDataRate=receiveDataRate, configurationGroup=configurationGroup, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, cableLoss=cableLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPVersion=iPVersion, searchState=searchState, phyControl=phyControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelBStatus=telecomsChannelBStatus, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, alarms=alarms, sNTPState=sNTPState, daylightSaving=daylightSaving, userTableIndex=userTableIndex, transmitModulationMode=transmitModulationMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableIndex=dfsTableIndex, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, telecomGroup=telecomGroup, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryptionAlgorithm=encryptionAlgorithm, management=management, vLANManagementVID=vLANManagementVID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, sNTPServerIPAddress=sNTPServerIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, dSCPManagementPriority=dSCPManagementPriority, altitude=altitude, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, bridgeGroup=bridgeGroup, syslogClientTrap=syslogClientTrap, bootVersion=bootVersion, channelALoopback=channelALoopback, syslogControlGroup=syslogControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, supplementary=supplementary, smtp=smtp, channelBCableLength=channelBCableLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receivePower=receivePower, remoteRxTargetPower=remoteRxTargetPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, telecomsInterface=telecomsInterface, encryption=encryption, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, cambium=cambium, tFTPServerInternetAddressType=tFTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, remoteIPAddress=remoteIPAddress, dfsPeaks=dfsPeaks, iPv6GatewayAddress=iPv6GatewayAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, gatewayIPAddress=gatewayIPAddress, targetMACAddress=targetMACAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortStatus=managementPortStatus, dfs=dfs, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installArmStateTrap=installArmStateTrap, linkModeOptimisation=linkModeOptimisation, sNTPServerTimeout=sNTPServerTimeout, telecomsChannelSelection=telecomsChannelSelection, tDDSynchronizationStatus=tDDSynchronizationStatus, productName=productName, channelALoopbackTrap=channelALoopbackTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, iPv6Address=iPv6Address, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPrimaryServer=sNTPPrimaryServer, sNMPv3Enable=sNMPv3Enable, sNTPServerRetries=sNTPServerRetries, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, versionsGroup=versionsGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveChannel=receiveChannel, latitude=latitude, vLANManagementPriority=vLANManagementPriority, pubStatsGroup=pubStatsGroup, sNTPServerTable=sNTPServerTable, ethernetBridgingStatus=ethernetBridgingStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, antennaGain=antennaGain, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, versions=versions, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatusTrap=installStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPCommunityString=sNMPCommunityString, userTable=userTable, licenceGroup=licenceGroup, localPacketFiltering=localPacketFiltering, subnetMask=subnetMask, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, secureModeAlarm=secureModeAlarm, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelBLineCode=channelBLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkName=linkName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptp=ptp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortDisabledWarning=managementPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, ptpGroups=ptpGroups, sNTPServerTableEntry=sNTPServerTableEntry, iPv6PrefixLength=iPv6PrefixLength, ethernetBridgingAvailability=ethernetBridgingAvailability, managementMode=managementMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, eIRP=eIRP, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userName=userName, remoteInternetAddress=remoteInternetAddress, sntpGroup=sntpGroup, syslogControl=syslogControl, sNMPTrapPortNumber=sNMPTrapPortNumber, securityLevel=securityLevel, aAAControlGroup=aAAControlGroup, remoteInternetAddressType=remoteInternetAddressType, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, dfsMeans=dfsMeans, sNTPSync=sNTPSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userTableNumber=userTableNumber, dfsGroup=dfsGroup)
