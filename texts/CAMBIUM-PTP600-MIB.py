...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secureModeAlarm=secureModeAlarm, bridgeGroup=bridgeGroup, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, ptp=ptp, syslogControl=syslogControl, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, userTableIndex=userTableIndex, sntp=sntp, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelSelection=telecomsChannelSelection, txColorCode=txColorCode, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatus=telecomsChannelAStatus, configuration=configuration, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, sNTPServerRetries=sNTPServerRetries, timeZone=timeZone, iPv6Address=iPv6Address, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, maximumTransmitPower=maximumTransmitPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vectorError=vectorError, ethernetFiberSupport=ethernetFiberSupport, syslogControlGroup=syslogControlGroup, range=range, dataPortFiberStatus=dataPortFiberStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, channelALoopback=channelALoopback, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, secondarySoftwareVersion=secondarySoftwareVersion, telecomsInterface=telecomsInterface, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, dfsTableNumber=dfsTableNumber, snmpControlGroup=snmpControlGroup, syslogState=syslogState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rawReceivePower=rawReceivePower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationMode=receiveModulationMode, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteInternetAddressType=remoteInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, userPassword=userPassword, managementGroup=managementGroup, phyControl=phyControl, versions=versions, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installArmState=installArmState, ethernetBridgingAvailability=ethernetBridgingAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, channelACableLength=channelACableLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receivePower=receivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPrimaryServer=sNTPPrimaryServer, systemReset=systemReset, iPv6PrefixLength=iPv6PrefixLength, sNTPPollInterval=sNTPPollInterval, frequencyVariant=frequencyVariant, transmitPower=transmitPower, ethernetGroup=ethernetGroup, sNTPServerTable=sNTPServerTable, licenceGroup=licenceGroup, productVariant=productVariant, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpGroups=ptpGroups, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveChannel=receiveChannel, dfs=dfs, supplementaryGroup=supplementaryGroup, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationMode=transmitModulationMode, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, eIRP=eIRP, channelBandwidth=channelBandwidth, rxColorCode=rxColorCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hardwareVersion=hardwareVersion, phyStatus=phyStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationMode=tDDSynchronizationMode, userEnabled=userEnabled, dfsTable=dfsTable, linkSymmetry=linkSymmetry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPv4Address=iPv4Address, managementPortConfigurationMismatch=managementPortConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, encryptionGroup=encryptionGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ethernet=ethernet, dfsGroup=dfsGroup, sNMPPortNumber=sNMPPortNumber, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userTableEntry=userTableEntry, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, remoteInternetAddress=remoteInternetAddress, productName=productName, bridge=bridge, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, searchState=searchState, sNMPCommunityString=sNMPCommunityString, sNTPServerStatus=sNTPServerStatus, cableLoss=cableLoss, reset=reset, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, targetRange=targetRange, latitude=latitude, regionCode=regionCode, sNTPSync=sNTPSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dSCPManagementPriority=dSCPManagementPriority, channelALineCode=channelALineCode, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, channelBLoopbackTrap=channelBLoopbackTrap, licence=licence, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTraps=ptpTraps, subnetMask=subnetMask, receiveFreqKHz=receiveFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, smtp=smtp, antennaGain=antennaGain, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rangingMode=rangingMode, sNTPServerTableIndex=sNTPServerTableIndex, receiveDataRate=receiveDataRate, longitude=longitude, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, managementPortStatus=managementPortStatus, channelBLineCode=channelBLineCode, encryption=encryption, groupID=groupID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, userName=userName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, localPacketFiltering=localPacketFiltering, iPVersion=iPVersion, ethernetPriorityTable=ethernetPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, securityLevel=securityLevel, channelALoopbackTrap=channelALoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, qOSPriorityScheme=qOSPriorityScheme, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, iPv6GatewayAddress=iPv6GatewayAddress, aAAControl=aAAControl, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortStatus=dataPortStatus, sNTPState=sNTPState, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, channelBCableLength=channelBCableLength, pubStatsGroup=pubStatsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteRxTargetPower=remoteRxTargetPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, vLANManagementPriority=vLANManagementPriority, sNTPSyncTrap=sNTPSyncTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptp600=ptp600)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, telnetAccessEnabled=telnetAccessEnabled, linkLoss=linkLoss, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDControl=tDDControl, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, supplementary=supplementary, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telnetPortNumber=telnetPortNumber, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, encryptionAlgorithm=encryptionAlgorithm, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, channelBLoopback=channelBLoopback, regionCodeTrap=regionCodeTrap, managementPortStatusTrap=managementPortStatusTrap, automaticTxPowerControl=automaticTxPowerControl, syslogClient=syslogClient, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementMode=managementMode, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetBridgingStatus=ethernetBridgingStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogClientTrap=syslogClientTrap, bandwidthVariant=bandwidthVariant, byteErrorRatio=byteErrorRatio, softwareVersion=softwareVersion, siteName=siteName, installArmStateTrap=installArmStateTrap, l2CPPriorityTable=l2CPPriorityTable, phyControlGroup=phyControlGroup, sNTPServerTimeout=sNTPServerTimeout)
