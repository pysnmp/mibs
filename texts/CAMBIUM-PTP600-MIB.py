...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPSyncTrap=sNTPSyncTrap, regionCode=regionCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rxColorCode=rxColorCode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, telecomsInterface=telecomsInterface, userPassword=userPassword, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControl=aAAControl, receivePower=receivePower, sntp=sntp, phyControlGroup=phyControlGroup, phyStatus=phyStatus, gatewayIPAddress=gatewayIPAddress, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, timeZone=timeZone, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelALoopback=channelALoopback, ethernetGroup=ethernetGroup, sNTPState=sNTPState, channelBCableLength=channelBCableLength, dfs=dfs, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortStatusTrap=managementPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerRetries=sNTPServerRetries, txColorCode=txColorCode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsMeans=dfsMeans, channelACableLength=channelACableLength, supplementaryGroup=supplementaryGroup, sNMPTrapVersion=sNMPTrapVersion, iPv6PrefixLength=iPv6PrefixLength, targetRange=targetRange, secureModeAlarm=secureModeAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityTable=l2CPPriorityTable, sNMPPortNumber=sNMPPortNumber, range=range, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyControl=phyControl, ethernetBridgingStatus=ethernetBridgingStatus, bridge=bridge, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, bootVersion=bootVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, accessMethod=accessMethod, userTable=userTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControlGroup=tDDControlGroup, ptp=ptp, bandwidthVariant=bandwidthVariant, installArmStateTrap=installArmStateTrap, iPv6Address=iPv6Address, ethernet=ethernet, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPLastSync=sNTPLastSync, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, alarms=alarms, snmpControl=snmpControl, smtpGroup=smtpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, alarmsGroup=alarmsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userName=userName, userEnabled=userEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogClientTrap=syslogClientTrap, syslogStateTrap=syslogStateTrap, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, ethernetFiberSupport=ethernetFiberSupport, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, ethernetPriorityTable=ethernetPriorityTable, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenceGroup=licenceGroup, searchState=searchState, channelBLoopbackTrap=channelBLoopbackTrap, vectorError=vectorError, sNTPServerTableEntry=sNTPServerTableEntry, transmitModulationMode=transmitModulationMode, incompatibleRegionCodes=incompatibleRegionCodes, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, ptp600=ptp600, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddressType=tFTPServerInternetAddressType, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aggregateDataRate=aggregateDataRate, syslogControl=syslogControl, qOSPriorityScheme=qOSPriorityScheme, channelALoopbackTrap=channelALoopbackTrap, reset=reset, sntpGroup=sntpGroup, iPVersion=iPVersion, dfsTableIndex=dfsTableIndex, maximumTransmitPower=maximumTransmitPower, altitude=altitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, installStatus=installStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, rangingMode=rangingMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, dfsTableNumber=dfsTableNumber, encryptionGroup=encryptionGroup, pubStats=pubStats, dfsTable=dfsTable, siteName=siteName, iPv6GatewayAddress=iPv6GatewayAddress, channelBLoopback=channelBLoopback, receiveFreqKHz=receiveFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitPower=transmitPower, resetGroup=resetGroup, telecomsChannelAStatus=telecomsChannelAStatus, targetMACAddress=targetMACAddress, installArmState=installArmState, userRole=userRole, managementGroup=managementGroup, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, channelALineCode=channelALineCode, managementMode=managementMode, systemReset=systemReset, supplementary=supplementary, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, localPacketFiltering=localPacketFiltering, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimisation=linkModeOptimisation, smtp=smtp, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, regionCodeTrap=regionCodeTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, latitude=latitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteRxTargetPower=remoteRxTargetPower, cambium=cambium, vLANManagementPriority=vLANManagementPriority, linkLoss=linkLoss, configurationGroup=configurationGroup, remoteInternetAddressType=remoteInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, dfsGroup=dfsGroup, transmitChannel=transmitChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerTableIndex=sNTPServerTableIndex, channelBLineCode=channelBLineCode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableEntry=userTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarning=dataPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, sNTPServerStatus=sNTPServerStatus, managementPortStatus=managementPortStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, subnetMask=subnetMask, sNTPServerTable=sNTPServerTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPv4Address=iPv4Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, daylightSaving=daylightSaving, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPSync=sNTPSync, constantPowerSpectralDensity=constantPowerSpectralDensity, automaticTxPowerControl=automaticTxPowerControl, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecom=telecom, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, tDDControl=tDDControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, versions=versions, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, longitude=longitude, byteErrorRatio=byteErrorRatio, channelBandwidth=channelBandwidth, syslogControlGroup=syslogControlGroup, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveChannel=receiveChannel, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelSelection=telecomsChannelSelection, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, configuration=configuration, receiveFreqMHz=receiveFreqMHz, transmitFreqKHz=transmitFreqKHz, rawReceivePower=rawReceivePower, sNMPTrapTable=sNMPTrapTable, management=management, receiveDataRate=receiveDataRate, securityLevel=securityLevel, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, snmpControlGroup=snmpControlGroup, eIRP=eIRP, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installStatusTrap=installStatusTrap, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bridgeGroup=bridgeGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, transmitDataRate=transmitDataRate, telecomGroup=telecomGroup, groupID=groupID, sNTPServerTimeout=sNTPServerTimeout, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionAlgorithm=encryptionAlgorithm, dfsPeaks=dfsPeaks, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, dataPortStatus=dataPortStatus, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, softwareVersion=softwareVersion)
