...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", supplementaryGroup=supplementaryGroup, sNMPv3Enable=sNMPv3Enable, sntp=sntp, pubStats=pubStats, channelALineCode=channelALineCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bridge=bridge, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitFreqMHz=transmitFreqMHz, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpCompliance=ptpCompliance, remoteInternetAddressType=remoteInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementGroup=managementGroup, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, maximumTransmitPower=maximumTransmitPower, ethernetBridgingStatus=ethernetBridgingStatus, transmitDataRate=transmitDataRate, unitOutOfCalibration=unitOutOfCalibration, searchState=searchState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, dataPortFiberStatusTrap=dataPortFiberStatusTrap, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, rangingMode=rangingMode, securityLevel=securityLevel, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telnetPortNumber=telnetPortNumber, versions=versions, remoteInternetAddress=remoteInternetAddress, phyControl=phyControl, subnetMask=subnetMask, ptpGroups=ptpGroups, snmpControl=snmpControl, cambium=cambium, eIRP=eIRP, txColorCode=txColorCode, linkName=linkName, range=range, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, syslogStateTrap=syslogStateTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelAStatus=telecomsChannelAStatus, ethernetGroup=ethernetGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerTableIndex=sNTPServerTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp=ptp, sNTPServerRetries=sNTPServerRetries, gatewayIPAddress=gatewayIPAddress, qOSPriorityScheme=qOSPriorityScheme, ptpTraps=ptpTraps, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementMode=managementMode, managementPortStatus=managementPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, management=management, channelBLoopback=channelBLoopback, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, vLANManagementPriority=vLANManagementPriority, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, installArmState=installArmState, receiveFreqMHz=receiveFreqMHz, alarmsGroup=alarmsGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableEntry=userTableEntry, daylightSaving=daylightSaving, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, masterSlaveMode=masterSlaveMode, ethernetPriorityTable=ethernetPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configuration=configuration, sNTPServerTimeout=sNTPServerTimeout, channelChangeTrap=channelChangeTrap, aAAControlGroup=aAAControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDControl=tDDControl, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPState=sNTPState, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBLoopbackTrap=channelBLoopbackTrap, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productVariant=productVariant, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, automaticTxPowerControl=automaticTxPowerControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBLineCode=channelBLineCode, sNTPServerTable=sNTPServerTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, dfs=dfs, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, channelACableLength=channelACableLength, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, linkLoss=linkLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, telecom=telecom, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControl=aAAControl, dfsTableNumber=dfsTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsGroup=dfsGroup, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, dataPortStatus=dataPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBandwidth=channelBandwidth, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControlGroup=snmpControlGroup, dataPortAutoMdix=dataPortAutoMdix, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, PYSNMP_MODULE_ID=cambium, hTTPSPortNumber=hTTPSPortNumber, dataPortFiberStatus=dataPortFiberStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPServerPortNumber=tFTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6Address=iPv6Address, licence=licence, dfsPeaks=dfsPeaks, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTable=sNMPTrapTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bandwidthVariant=bandwidthVariant, reset=reset, ptmp=ptmp, groupID=groupID, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, telecomsChannelSelection=telecomsChannelSelection, configurationGroup=configurationGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, sNTPServerStatus=sNTPServerStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptp600=ptp600, telecomsInterface=telecomsInterface, latitude=latitude, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogControlGroup=syslogControlGroup, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, dSCPManagementPriority=dSCPManagementPriority, licenceGroup=licenceGroup, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqKHz=transmitFreqKHz, syslogClient=syslogClient, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortAutoNegotiation=dataPortAutoNegotiation, iPv6GatewayAddress=iPv6GatewayAddress, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, byteErrorRatio=byteErrorRatio, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, syslogClientTrap=syslogClientTrap, softwareVersion=softwareVersion, userPassword=userPassword, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, productName=productName, iPv4Address=iPv4Address, rawReceivePower=rawReceivePower, ethernet=ethernet, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, linkModeOptimisation=linkModeOptimisation, channelBCableLength=channelBCableLength, rxColorCode=rxColorCode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitChannel=transmitChannel, syslogState=syslogState, channelALoopbackTrap=channelALoopbackTrap, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, localPacketFiltering=localPacketFiltering, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", longitude=longitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, userTable=userTable, dfsTable=dfsTable, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, telecomGroup=telecomGroup, dfsTableIndex=dfsTableIndex, resetGroup=resetGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, timeZone=timeZone, iPVersion=iPVersion, dfsMeans=dfsMeans, hAZLOCConfiguration=hAZLOCConfiguration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, channelALoopback=channelALoopback, sNTPPollInterval=sNTPPollInterval, userRole=userRole, systemClock=systemClock, syslogControl=syslogControl, sNMPPortNumber=sNMPPortNumber, altitude=altitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, regionCodeTrap=regionCodeTrap, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, targetMACAddress=targetMACAddress, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, bridgeGroup=bridgeGroup, secureModeAlarm=secureModeAlarm, managementPortDisabledWarning=managementPortDisabledWarning, targetRange=targetRange, telnetAccessEnabled=telnetAccessEnabled, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, installStatus=installStatus, sNTPServerTableEntry=sNTPServerTableEntry)
