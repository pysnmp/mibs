...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableIndex=dfsTableIndex, bootVersion=bootVersion, licenceGroup=licenceGroup, latitude=latitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, regionCode=regionCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, groupID=groupID, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, transmitModulationMode=transmitModulationMode, cambium=cambium, altitude=altitude, syslogControl=syslogControl, channelChangeTrap=channelChangeTrap, ptmp=ptmp, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableNumber=dfsTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDControl=tDDControl, masterSlaveMode=masterSlaveMode, encryption=encryption, secureModeAlarm=secureModeAlarm, dfsTable=dfsTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aggregateDataRate=aggregateDataRate, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntpGroup=sntpGroup, channelALoopback=channelALoopback, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, sNTPLastSync=sNTPLastSync, userPassword=userPassword, syslogClientTrap=syslogClientTrap, channelALineCode=channelALineCode, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, bridgeGroup=bridgeGroup, sNTPServerTable=sNTPServerTable, rawReceivePower=rawReceivePower, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServer=sNTPPrimaryServer, remoteIPAddress=remoteIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userName=userName, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPPortNumber=hTTPPortNumber, receiveDataRate=receiveDataRate, cableLoss=cableLoss, versions=versions, installArmStateTrap=installArmStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatus=installStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rangingMode=rangingMode, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptpTraps=ptpTraps, receiveChannel=receiveChannel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, reset=reset, dfs=dfs, txColorCode=txColorCode, sntp=sntp, userTableIndex=userTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, daylightSaving=daylightSaving, dataPortStatus=dataPortStatus, managementPortStatus=managementPortStatus, transmitDataRate=transmitDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, transmitChannel=transmitChannel, targetMACAddress=targetMACAddress, dataPortStatusTrap=dataPortStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configuration=configuration, ethernetBridgingStatus=ethernetBridgingStatus, sMTPEnabledMessages=sMTPEnabledMessages, supplementaryGroup=supplementaryGroup, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetGroup=ethernetGroup, dfsPeaks=dfsPeaks, systemClock=systemClock, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, systemReset=systemReset, phyStatusGroup=phyStatusGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPState=sNTPState, sNTPServerRetries=sNTPServerRetries, aAAControlGroup=aAAControlGroup, antennaGain=antennaGain, channelBandwidth=channelBandwidth, telnetPortNumber=telnetPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6Address=iPv6Address, tFTPServerIPAddress=tFTPServerIPAddress, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, management=management, bridge=bridge, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBLoopback=channelBLoopback, phyControl=phyControl, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTable=ethernetPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, frequencyVariant=frequencyVariant, sNMPTrapVersion=sNMPTrapVersion, ethernetFiberSupport=ethernetFiberSupport, licence=licence, ethernetPriorityTableIndex=ethernetPriorityTableIndex, searchState=searchState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, pubStats=pubStats, dSCPManagementPriority=dSCPManagementPriority, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelACableLength=channelACableLength, range=range, softwareVersion=softwareVersion, remoteRxTargetPower=remoteRxTargetPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTable=l2CPPriorityTable, userTable=userTable, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productName=productName, iPv6GatewayAddress=iPv6GatewayAddress, eIRP=eIRP, remoteInternetAddressType=remoteInternetAddressType, linkLoss=linkLoss, receiveFreqMHz=receiveFreqMHz, vLANManagementPriority=vLANManagementPriority, channelBLineCode=channelBLineCode, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secureModeAlarmTrap=secureModeAlarmTrap, aAAControl=aAAControl, managementGroup=managementGroup, syslogClient=syslogClient, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, tDDControlGroup=tDDControlGroup, ptpCompliance=ptpCompliance, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControl=snmpControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableNumber=userTableNumber, linkSymmetry=linkSymmetry, unitOutOfCalibration=unitOutOfCalibration, longitude=longitude, channelBCableLength=channelBCableLength, sNTPSync=sNTPSync, supplementary=supplementary, phyStatus=phyStatus, channelALoopbackTrap=channelALoopbackTrap, resetGroup=resetGroup, hardwareVersion=hardwareVersion, ptp=ptp, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, automaticTxPowerControl=automaticTxPowerControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementMode=managementMode, phyControlGroup=phyControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versionsGroup=versionsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarms=alarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecom=telecom, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, managementPortStatusTrap=managementPortStatusTrap, transmitFreqKHz=transmitFreqKHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", alarmsGroup=alarmsGroup, iPv4Address=iPv4Address, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, userTableEntry=userTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubStatsGroup=pubStatsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsMeans=dfsMeans, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, securityLevel=securityLevel, iPVersion=iPVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoMdix=dataPortAutoMdix, qOSPriorityScheme=qOSPriorityScheme, ptp600=ptp600, targetRange=targetRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelSelection=telecomsChannelSelection, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBLoopbackTrap=channelBLoopbackTrap, remoteInternetAddress=remoteInternetAddress, smtp=smtp, rxColorCode=rxColorCode, sNTPServerTableIndex=sNTPServerTableIndex, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, accessMethod=accessMethod, PYSNMP_MODULE_ID=cambium)
