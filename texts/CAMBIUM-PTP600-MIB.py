...
TimeTicks, Integer32, Gauge32, ObjectIdentity, NotificationType, Bits, ModuleIdentity, Counter32, IpAddress, Counter64, iso, Unsigned32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Gauge32", "ObjectIdentity", "NotificationType", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "Counter64", "iso", "Unsigned32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortStatus=managementPortStatus, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, rangingMode=rangingMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, bridge=bridge, sNTPServerTable=sNTPServerTable, channelALoopback=channelALoopback, hAZLOCConfiguration=hAZLOCConfiguration, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerRetries=sNTPServerRetries, smtp=smtp, dfsTableIndex=dfsTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, installArmState=installArmState, latitude=latitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortStatus=dataPortStatus, dfs=dfs, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptmp=ptmp, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, configuration=configuration, userRole=userRole, dfsTableNumber=dfsTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel, phyControl=phyControl, managementMode=managementMode, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, iPv6Address=iPv6Address, licenceGroup=licenceGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogClient=syslogClient, eIRP=eIRP, secureModeAlarm=secureModeAlarm, ethernet=ethernet, sNTPLastSync=sNTPLastSync, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, versions=versions, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, licence=licence, dfsTable=dfsTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, installStatusTrap=installStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cambium=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapTable=sNMPTrapTable, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, sNTPServerTimeout=sNTPServerTimeout, pubStatsGroup=pubStatsGroup, siteName=siteName, sntp=sntp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetFiberSupport=ethernetFiberSupport, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, ptp=ptp, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, qOSPriorityScheme=qOSPriorityScheme, transmitFreqKHz=transmitFreqKHz, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, installStatus=installStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsMeans=dfsMeans, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortDisabledWarning=managementPortDisabledWarning, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtpGroup=smtpGroup, phyStatus=phyStatus, linkModeOptimisation=linkModeOptimisation, telecomsChannelAStatus=telecomsChannelAStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, longitude=longitude, channelALoopbackTrap=channelALoopbackTrap, ptpTraps=ptpTraps, remoteInternetAddressType=remoteInternetAddressType, supplementary=supplementary, userTableEntry=userTableEntry, securityLevel=securityLevel, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelSelection=telecomsChannelSelection, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, remoteIPAddress=remoteIPAddress, range=range, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, timeZone=timeZone, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, bridgeGroup=bridgeGroup, snmpControl=snmpControl, syslogStateTrap=syslogStateTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, automaticTxPowerControl=automaticTxPowerControl, syslogState=syslogState, sNTPServerStatus=sNTPServerStatus, syslogControl=syslogControl, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTable=ethernetPriorityTable, productName=productName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, linkSymmetry=linkSymmetry, txColorCode=txColorCode, tDDControl=tDDControl, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, rawReceivePower=rawReceivePower, linkName=linkName, telecom=telecom, groupID=groupID, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, syslogControlGroup=syslogControlGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, pubStats=pubStats, subnetMask=subnetMask, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6PrefixLength=iPv6PrefixLength, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableIndex=userTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, systemClock=systemClock, hardwareVersion=hardwareVersion, notificationsGroup=notificationsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerTableIndex=sNTPServerTableIndex, channelBLoopback=channelBLoopback, rxColorCode=rxColorCode, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControl=aAAControl, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, phyStatusGroup=phyStatusGroup, remoteRxTargetPower=remoteRxTargetPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortFiberStatus=dataPortFiberStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, ptpCompliance=ptpCompliance, remoteInternetAddress=remoteInternetAddress, channelALineCode=channelALineCode, alarms=alarms, sntpGroup=sntpGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNMPPortNumber=sNMPPortNumber, channelBCableLength=channelBCableLength, sNTPSync=sNTPSync, l2CPPriorityTable=l2CPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryption=encryption, iPv4Address=iPv4Address, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoMdix=dataPortAutoMdix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, altitude=altitude, channelBLoopbackTrap=channelBLoopbackTrap, bootVersion=bootVersion, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionAlgorithm=encryptionAlgorithm, supplementaryGroup=supplementaryGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBLineCode=channelBLineCode, managementPortStatusTrap=managementPortStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsGroup=dfsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, frequencyVariant=frequencyVariant, userName=userName, regionCodeTrap=regionCodeTrap, receivePower=receivePower, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, ptp600=ptp600, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, userPassword=userPassword, management=management, gatewayIPAddress=gatewayIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomGroup=telecomGroup, channelACableLength=channelACableLength, dataPortDisabledWarning=dataPortDisabledWarning, transmitFreqMHz=transmitFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, systemReset=systemReset, sNTPState=sNTPState, resetGroup=resetGroup, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, ethernetGroup=ethernetGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, accessMethod=accessMethod, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetRange=targetRange, iPVersion=iPVersion)
