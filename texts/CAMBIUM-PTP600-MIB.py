...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, sNTPServerTableNumber=sNTPServerTableNumber, vLANManagementPriority=vLANManagementPriority, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsTable=dfsTable, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, productName=productName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp600=ptp600, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelALoopbackTrap=channelALoopbackTrap, remoteInternetAddress=remoteInternetAddress, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, securityLevel=securityLevel, remoteRxTargetPower=remoteRxTargetPower, encryptionAlgorithm=encryptionAlgorithm, ethernetBridgingAvailability=ethernetBridgingAvailability, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, subnetMask=subnetMask, channelACableLength=channelACableLength, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPPortNumber=sNMPPortNumber, dSCPManagementPriority=dSCPManagementPriority, sNTPPollInterval=sNTPPollInterval, regionCodeTrap=regionCodeTrap, sNTPSyncTrap=sNTPSyncTrap, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetBridgingStatus=ethernetBridgingStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLineCode=channelBLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, channelBLoopback=channelBLoopback, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, channelALineCode=channelALineCode, iPVersion=iPVersion, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, linkName=linkName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, phyStatusGroup=phyStatusGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, channelBandwidth=channelBandwidth, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, rxColorCode=rxColorCode, wirelessLinkAvailability=wirelessLinkAvailability, cambium=cambium, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, sNTPServerTable=sNTPServerTable, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, supplementaryGroup=supplementaryGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userTable=userTable, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerRetries=sNTPServerRetries, encryption=encryption, dataPortStatus=dataPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, configuration=configuration, sntp=sntp, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, gatewayIPAddress=gatewayIPAddress, targetRange=targetRange, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, range=range, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licence=licence, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddressType=sNTPServerInternetAddressType, supplementary=supplementary, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationMode=receiveModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPv3Enable=sNMPv3Enable, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, dfsTableEntry=dfsTableEntry, transmitDataRate=transmitDataRate, syslogClient=syslogClient, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityTable=ethernetPriorityTable, dfsTableNumber=dfsTableNumber, snmpControl=snmpControl, hardwareVersion=hardwareVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, ethernet=ethernet, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, bandwidthVariant=bandwidthVariant, ptpGroups=ptpGroups, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopback=channelALoopback, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vLANManagementVID=vLANManagementVID, telecomsChannelBStatus=telecomsChannelBStatus, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkSymmetry=linkSymmetry, telecom=telecom, daylightSaving=daylightSaving, txColorCode=txColorCode, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelChangeTrap=channelChangeTrap, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerPortNumber=sNTPServerPortNumber, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, productVariant=productVariant, ptmp=ptmp, timeZone=timeZone, secureModeAlarm=secureModeAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aAAControlGroup=aAAControlGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqMHz=transmitFreqMHz, bridge=bridge, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, rangingMode=rangingMode, managementPortStatus=managementPortStatus, iPv4Address=iPv4Address, resetGroup=resetGroup, localPacketFiltering=localPacketFiltering, userEnabled=userEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, installArmState=installArmState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, bridgeGroup=bridgeGroup, eIRP=eIRP, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv6Address=iPv6Address, secureModeAlarmTrap=secureModeAlarmTrap, accessMethod=accessMethod, encryptionGroup=encryptionGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSPortNumber=hTTPSPortNumber, phyControl=phyControl, tDDControl=tDDControl, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, userTableIndex=userTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userPassword=userPassword, alarmsGroup=alarmsGroup, managementPortStatusTrap=managementPortStatusTrap, versionsGroup=versionsGroup, rawReceivePower=rawReceivePower, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, smtpGroup=smtpGroup, phyStatus=phyStatus, ptpTraps=ptpTraps, managementMode=managementMode, transmitModulationMode=transmitModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, alarms=alarms, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerPortNumber=tFTPServerPortNumber, dfs=dfs, signalStrengthRatio=signalStrengthRatio, latitude=latitude, altitude=altitude, telnetPortNumber=telnetPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, ethernetPriorityTableNumber=ethernetPriorityTableNumber, installStatus=installStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", searchState=searchState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, userTableNumber=userTableNumber, receiveFreqKHz=receiveFreqKHz, linkLoss=linkLoss, userTableEntry=userTableEntry, telecomsChannelSelection=telecomsChannelSelection, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTable=l2CPPriorityTable, transmitChannel=transmitChannel, userRole=userRole, management=management, syslogState=syslogState, syslogControl=syslogControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsMeans=dfsMeans, receiveChannel=receiveChannel, sNTPSync=sNTPSync, automaticTxPowerControl=automaticTxPowerControl, groupID=groupID, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsGroup=dfsGroup, remoteInternetAddressType=remoteInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitPower=transmitPower, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, installArmStateTrap=installArmStateTrap, dfsTableIndex=dfsTableIndex, ptp=ptp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, iPv6GatewayAddress=iPv6GatewayAddress, channelBCableLength=channelBCableLength, regionCode=regionCode, sNTPServerInternetAddress=sNTPServerInternetAddress, byteErrorRatio=byteErrorRatio, reset=reset, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTableIndex=sNTPServerTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
