...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementMode=managementMode, configurationGroup=configurationGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerStatus=sNTPServerStatus, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALoopbackTrap=channelALoopbackTrap, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, aAAControl=aAAControl, altitude=altitude, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installArmState=installArmState, cambium=cambium, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingStatus=ethernetBridgingStatus, regionCode=regionCode, linkName=linkName, pubStats=pubStats, txColorCode=txColorCode, sNTPLastSync=sNTPLastSync, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteRxTargetPower=remoteRxTargetPower, sNTPSync=sNTPSync, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, targetRange=targetRange, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBLoopback=channelBLoopback, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, syslogControlGroup=syslogControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, transmitFreqKHz=transmitFreqKHz, bootVersion=bootVersion, hardwareVersion=hardwareVersion, productVariant=productVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, ptmp=ptmp, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveDataRate=receiveDataRate, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, installStatus=installStatus, versions=versions, userTableIndex=userTableIndex, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, tFTPServerIPAddress=tFTPServerIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, bridge=bridge, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, transmitDataRate=transmitDataRate, configuration=configuration, installArmStateTrap=installArmStateTrap, automaticTxPowerControl=automaticTxPowerControl, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, channelBCableLength=channelBCableLength, longitude=longitude, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, ptp600=ptp600, range=range, channelALineCode=channelALineCode, userTable=userTable, telecom=telecom, managementPortStatusTrap=managementPortStatusTrap, iPVersion=iPVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogControl=syslogControl, bandwidthVariant=bandwidthVariant, licence=licence, aAAControlGroup=aAAControlGroup, userRole=userRole, dfsTable=dfsTable, productName=productName, systemClock=systemClock, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6PrefixLength=iPv6PrefixLength, syslogStateTrap=syslogStateTrap, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, ptpGroups=ptpGroups, vLANManagementPriority=vLANManagementPriority, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, versionsGroup=versionsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBLineCode=channelBLineCode, telecomsChannelBStatus=telecomsChannelBStatus, secureModeAlarmTrap=secureModeAlarmTrap, dfsPeaks=dfsPeaks, snmpControl=snmpControl, cableLoss=cableLoss, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTable=sNTPServerTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyStatus=phyStatus, remoteInternetAddress=remoteInternetAddress, ptpTraps=ptpTraps, managementPortDisabledWarning=managementPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, userEnabled=userEnabled, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, smtpGroup=smtpGroup, incompatibleRegionCodes=incompatibleRegionCodes, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerRetries=sNTPServerRetries, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelAStatus=telecomsChannelAStatus, channelACableLength=channelACableLength, PYSNMP_MODULE_ID=cambium, phyControlGroup=phyControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry, receiveFreqKHz=receiveFreqKHz, daylightSaving=daylightSaving, alarms=alarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, management=management, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, tFTPServerPortNumber=tFTPServerPortNumber, rxColorCode=rxColorCode, transmitModulationMode=transmitModulationMode, secureModeAlarm=secureModeAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortStatus=managementPortStatus, smtp=smtp, sntp=sntp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerTableIndex=sNTPServerTableIndex, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationModeDetail=receiveModulationModeDetail, receiveFreqMHz=receiveFreqMHz, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telnetPortNumber=telnetPortNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, securityLevel=securityLevel, phyControl=phyControl, supplementary=supplementary, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, telecomsInterface=telecomsInterface, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, ethernet=ethernet, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelALoopback=channelALoopback, byteErrorRatio=byteErrorRatio, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetFiberSupport=ethernetFiberSupport, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, dfs=dfs, installStatusTrap=installStatusTrap, syslogClient=syslogClient, dfsMeans=dfsMeans, iPv6Address=iPv6Address, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, masterSlaveMode=masterSlaveMode, sNMPv3Enable=sNMPv3Enable, resetGroup=resetGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitPower=transmitPower, tDDControlGroup=tDDControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, snmpControlGroup=snmpControlGroup, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangingMode=rangingMode, receiveChannel=receiveChannel, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTableEntry=sNTPServerTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetGroup=ethernetGroup, telecomsChannelSelection=telecomsChannelSelection, sNTPState=sNTPState)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", groupID=groupID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, userPassword=userPassword, channelBLoopbackTrap=channelBLoopbackTrap, reset=reset, telecomGroup=telecomGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBandwidth=channelBandwidth, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hAZLOCConfiguration=hAZLOCConfiguration, alarmsGroup=alarmsGroup, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bridgeGroup=bridgeGroup, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, iPv4Address=iPv4Address, remoteIPAddress=remoteIPAddress, systemReset=systemReset, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, dfsGroup=dfsGroup, userTableNumber=userTableNumber, rawReceivePower=rawReceivePower, pubStatsGroup=pubStatsGroup, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, localPacketFiltering=localPacketFiltering, sNTPServerTableNumber=sNTPServerTableNumber, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, encryptionGroup=encryptionGroup)
