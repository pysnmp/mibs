...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:57:46 2022
...
ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, MibIdentifier, enterprises, iso, Counter32, Gauge32, Integer32, Counter64, NotificationType, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "MibIdentifier", "enterprises", "iso", "Counter32", "Gauge32", "Integer32", "Counter64", "NotificationType", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, telecomGroup=telecomGroup, transmitPower=transmitPower, sNTPServerRetries=sNTPServerRetries, management=management, reset=reset, managementPortStatusTrap=managementPortStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv6PrefixLength=iPv6PrefixLength, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ptmp=ptmp, linkSymmetry=linkSymmetry, gatewayIPAddress=gatewayIPAddress, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableIndex=dfsTableIndex, dataPortStatus=dataPortStatus, incompatibleRegionCodes=incompatibleRegionCodes, snmpControlGroup=snmpControlGroup, sNTPLastSync=sNTPLastSync, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, ethernet=ethernet, PYSNMP_MODULE_ID=cambium, installStatusTrap=installStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarm=tDDSynchronizationAlarm, txColorCode=txColorCode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALoopback=channelALoopback, receivePower=receivePower, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, ptp600=ptp600, timeZone=timeZone, smtpGroup=smtpGroup, aAAControl=aAAControl, wirelessLinkAvailability=wirelessLinkAvailability, iPv6GatewayAddress=iPv6GatewayAddress, channelBLoopbackTrap=channelBLoopbackTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, alarmsGroup=alarmsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBCableLength=channelBCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cambium=cambium, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelALoopbackTrap=channelALoopbackTrap, userTableEntry=userTableEntry, userPassword=userPassword, dfsPeaks=dfsPeaks, encryption=encryption, ethernetBridgingAvailability=ethernetBridgingAvailability, bridgeGroup=bridgeGroup, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, latitude=latitude, iPv4Address=iPv4Address, supplementary=supplementary, configuration=configuration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogClient=syslogClient, aAAControlGroup=aAAControlGroup, automaticTxPowerControl=automaticTxPowerControl, tDDSynchronizationStatus=tDDSynchronizationStatus, bandwidthVariant=bandwidthVariant, phyControl=phyControl, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDControl=tDDControl, phyControlGroup=phyControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, remoteRxTargetPower=remoteRxTargetPower, transmitFreqMHz=transmitFreqMHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, secureModeAlarmTrap=secureModeAlarmTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sntpGroup=sntpGroup, dataPortAutoMdix=dataPortAutoMdix, localPacketFiltering=localPacketFiltering, accessMethod=accessMethod, targetRange=targetRange, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableIndex=sNMPTrapTableIndex, telecom=telecom, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxColorCode=rxColorCode, sNTPSyncTrap=sNTPSyncTrap, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, notificationsGroup=notificationsGroup, antennaGain=antennaGain, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, softwareVersion=softwareVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, sNTPServerTableNumber=sNTPServerTableNumber, dfsTableNumber=dfsTableNumber, hTTPSPortNumber=hTTPSPortNumber, telecomsInterface=telecomsInterface, receiveFreqKHz=receiveFreqKHz, tDDControlGroup=tDDControlGroup, dfsGroup=dfsGroup, userName=userName, pubStats=pubStats, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, searchState=searchState, managementPortDisabledWarning=managementPortDisabledWarning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSAccessEnabled=hTTPSAccessEnabled, regionCodeTrap=regionCodeTrap, resetGroup=resetGroup, sNMPTrapTable=sNMPTrapTable, phyStatus=phyStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementMode=managementMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, masterSlaveMode=masterSlaveMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, versions=versions, hAZLOCConfiguration=hAZLOCConfiguration, secureModeAlarm=secureModeAlarm, linkModeOptimisation=linkModeOptimisation, dSCPManagementPriority=dSCPManagementPriority, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPVersion=iPVersion, licenceGroup=licenceGroup, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, siteName=siteName, channelChangeTrap=channelChangeTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, alarms=alarms, channelBandwidth=channelBandwidth, snmpControl=snmpControl, sNTPServerTableEntry=sNTPServerTableEntry, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTable=sNTPServerTable, altitude=altitude, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogControl=syslogControl, sMTPServerIPAddress=sMTPServerIPAddress, linkName=linkName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsMeans=dfsMeans, productVariant=productVariant, channelBLineCode=channelBLineCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTable=userTable, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, ethernetBridgingStatus=ethernetBridgingStatus, sMTPServerPortNumber=sMTPServerPortNumber, syslogStateTrap=syslogStateTrap, dfs=dfs, ptpTraps=ptpTraps, userRole=userRole, rawReceivePower=rawReceivePower, vLANManagementVID=vLANManagementVID, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortStatusTrap=dataPortStatusTrap, installStatus=installStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBLoopback=channelBLoopback, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTableNumber=ethernetPriorityTableNumber, productName=productName, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, bootVersion=bootVersion, channelACableLength=channelACableLength, sNTPServerStatus=sNTPServerStatus, vectorError=vectorError, ethernetPriorityTable=ethernetPriorityTable, ptpTrapPrefix=ptpTrapPrefix, systemReset=systemReset, licence=licence, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteIPAddress=remoteIPAddress, remoteInternetAddress=remoteInternetAddress, channelALineCode=channelALineCode, signalStrengthRatio=signalStrengthRatio, iPv6Address=iPv6Address, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpGroups=ptpGroups, targetMACAddress=targetMACAddress, l2CPPriorityTable=l2CPPriorityTable, dfsTable=dfsTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationMode=tDDSynchronizationMode, encryptionGroup=encryptionGroup, receiveDataRate=receiveDataRate, managementPortStatus=managementPortStatus, dfsTableEntry=dfsTableEntry, bridge=bridge, supplementaryGroup=supplementaryGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, userEnabled=userEnabled, qOSPriorityScheme=qOSPriorityScheme, dataPortFiberStatus=dataPortFiberStatus, installArmStateTrap=installArmStateTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptp=ptp, longitude=longitude, telnetAccessEnabled=telnetAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementGroup=managementGroup, hTTPAccessEnabled=hTTPAccessEnabled, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, receiveChannel=receiveChannel, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, linkLoss=linkLoss, ptpCompliance=ptpCompliance, syslogControlGroup=syslogControlGroup, securityLevel=securityLevel, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerTableIndex=sNTPServerTableIndex, sMTPEmailAlert=sMTPEmailAlert, ethernetFiberSupport=ethernetFiberSupport, sNTPPollInterval=sNTPPollInterval, regionCode=regionCode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, daylightSaving=daylightSaving, receiveFreqMHz=receiveFreqMHz, range=range, telecomsChannelSelection=telecomsChannelSelection, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping)
