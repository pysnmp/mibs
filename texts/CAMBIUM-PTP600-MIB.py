...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitChannel=transmitChannel, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secondarySoftwareVersion=secondarySoftwareVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, phyStatus=phyStatus, rawReceivePower=rawReceivePower, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortStatusTrap=dataPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, telecomsChannelBStatus=telecomsChannelBStatus, sNMPPortNumber=sNMPPortNumber, channelChangeTrap=channelChangeTrap, sNTPServerTableEntry=sNTPServerTableEntry, regionCode=regionCode, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, linkModeOptimisation=linkModeOptimisation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userEnabled=userEnabled, channelALoopbackTrap=channelALoopbackTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortDisabledWarning=managementPortDisabledWarning, aAAControl=aAAControl, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productVariant=productVariant, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPSync=sNTPSync, ethernetBridgingStatus=ethernetBridgingStatus, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, txColorCode=txColorCode, channelACableLength=channelACableLength, hAZLOCConfiguration=hAZLOCConfiguration, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, latitude=latitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerIPAddress=sMTPServerIPAddress, userTable=userTable, sMTPEnabledMessages=sMTPEnabledMessages, cambium=cambium, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, iPVersion=iPVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, regionCodeTrap=regionCodeTrap, remoteRxTargetPower=remoteRxTargetPower, mPLSTCPriorityTable=mPLSTCPriorityTable, bandwidthVariant=bandwidthVariant, linkSymmetry=linkSymmetry, sNTPServerTimeout=sNTPServerTimeout, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogClient=syslogClient, l2CPPriorityTable=l2CPPriorityTable, transmitDataRate=transmitDataRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddress=remoteInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, managementPortStatus=managementPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, vLANManagementPriority=vLANManagementPriority, syslogControl=syslogControl, userTableNumber=userTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, targetRange=targetRange, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALineCode=channelALineCode, receivePower=receivePower, smtpGroup=smtpGroup, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, sNTPPollInterval=sNTPPollInterval, subnetMask=subnetMask, dSCPManagementPriority=dSCPManagementPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, supplementaryGroup=supplementaryGroup, phyControlGroup=phyControlGroup, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vectorError=vectorError, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receiveChannel=receiveChannel, transmitFreqMHz=transmitFreqMHz, transmitFreqKHz=transmitFreqKHz, siteName=siteName, iPv6PrefixLength=iPv6PrefixLength, targetMACAddress=targetMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secureModeAlarmTrap=secureModeAlarmTrap, resetGroup=resetGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, licenceGroup=licenceGroup, dfsMeans=dfsMeans, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, ptp600=ptp600, altitude=altitude, ptmp=ptmp, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, ptpCompliance=ptpCompliance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernet=ethernet, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, ptpTraps=ptpTraps, receiveModulationModeDetail=receiveModulationModeDetail, channelBLoopbackTrap=channelBLoopbackTrap, hTTPSPortNumber=hTTPSPortNumber, configuration=configuration, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecom=telecom, longitude=longitude, userTableEntry=userTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, sntp=sntp, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, syslogState=syslogState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, accessMethod=accessMethod, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, automaticTxPowerControl=automaticTxPowerControl, receiveModulationMode=receiveModulationMode, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licence=licence, channelBCableLength=channelBCableLength, hardwareVersion=hardwareVersion, snmpControl=snmpControl, systemClock=systemClock, ethernetPriorityTableIndex=ethernetPriorityTableIndex, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, remoteInternetAddressType=remoteInternetAddressType, timeZone=timeZone, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, iPv6Address=iPv6Address, reset=reset, managementGroup=managementGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerTable=sNTPServerTable, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installStatus=installStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, telnetAccessEnabled=telnetAccessEnabled, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, systemReset=systemReset, configurationGroup=configurationGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsChannelAStatus=telecomsChannelAStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv4Address=iPv4Address, ptpGroups=ptpGroups, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, range=range, eIRP=eIRP, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync, localPacketFiltering=localPacketFiltering, aAAControlGroup=aAAControlGroup, sNTPServerStatus=sNTPServerStatus, pubStatsGroup=pubStatsGroup, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTable=dfsTable, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatusTrap=installStatusTrap, rxColorCode=rxColorCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtp=smtp, alarms=alarms, channelALoopback=channelALoopback, dfsTableNumber=dfsTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmStateTrap=installArmStateTrap, productName=productName, installArmState=installArmState, encryptionAlgorithm=encryptionAlgorithm, antennaGain=antennaGain, phyControl=phyControl, sNTPState=sNTPState, qOSPriorityScheme=qOSPriorityScheme, userPassword=userPassword, sNMPCommunityString=sNMPCommunityString, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfs=dfs, rangingMode=rangingMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secureModeAlarm=secureModeAlarm, pubStats=pubStats, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, management=management, vLANManagementVID=vLANManagementVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, securityLevel=securityLevel, tDDSynchronizationMode=tDDSynchronizationMode, dataPortFiberStatus=dataPortFiberStatus, ptp=ptp, telecomGroup=telecomGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableIndex=dfsTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogStateTrap=syslogStateTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, channelBLoopback=channelBLoopback, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBLineCode=channelBLineCode, encryptionGroup=encryptionGroup, phyStatusGroup=phyStatusGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, bridgeGroup=bridgeGroup, syslogClientTrap=syslogClientTrap)
