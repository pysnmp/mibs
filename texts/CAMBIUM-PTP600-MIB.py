...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", licence=licence, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatus=phyStatus, cableLoss=cableLoss, userName=userName, longitude=longitude, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, encryption=encryption, l2CPPriorityTable=l2CPPriorityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, sntp=sntp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControlGroup=syslogControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatus=installStatus, sMTPServerIPAddress=sMTPServerIPAddress, targetMACAddress=targetMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, localPacketFiltering=localPacketFiltering, ethernetFiberSupport=ethernetFiberSupport, managementPortDisabledWarning=managementPortDisabledWarning, ptp600=ptp600, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hAZLOCConfiguration=hAZLOCConfiguration, installArmStateTrap=installArmStateTrap, sNMPPortNumber=sNMPPortNumber, dfsTableIndex=dfsTableIndex, transmitDataRate=transmitDataRate, bandwidthVariant=bandwidthVariant, secureModeAlarm=secureModeAlarm, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, alarms=alarms, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionGroup=encryptionGroup, userTable=userTable, remoteInternetAddress=remoteInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionAlgorithm=encryptionAlgorithm, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementPortStatus=managementPortStatus, securityLevel=securityLevel, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTable=sNTPServerTable, licenceGroup=licenceGroup, masterSlaveMode=masterSlaveMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, timeZone=timeZone, accessMethod=accessMethod, userTableNumber=userTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, latitude=latitude, hardwareVersion=hardwareVersion, sNTPPrimaryServer=sNTPPrimaryServer, transmitFreqMHz=transmitFreqMHz, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, siteName=siteName, telecomsChannelBStatus=telecomsChannelBStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, dfsTableNumber=dfsTableNumber, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqMHz=receiveFreqMHz, systemClock=systemClock, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, antennaGain=antennaGain, channelBLoopback=channelBLoopback, ptpGroups=ptpGroups, dfs=dfs, searchState=searchState, remoteRxTargetPower=remoteRxTargetPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, configurationGroup=configurationGroup, byteErrorRatio=byteErrorRatio, vLANManagementVID=vLANManagementVID, sNTPState=sNTPState, receiveChannel=receiveChannel, iPv6PrefixLength=iPv6PrefixLength, dfsTableEntry=dfsTableEntry, groupID=groupID, syslogClientTrap=syslogClientTrap, snmpControl=snmpControl, softwareVersion=softwareVersion, ethernet=ethernet, bridge=bridge, supplementary=supplementary, versionsGroup=versionsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, cambium=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, eIRP=eIRP, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, l2CPPriorityTableNumber=l2CPPriorityTableNumber, txColorCode=txColorCode, sNMPTrapVersion=sNMPTrapVersion, subnetMask=subnetMask, linkSymmetry=linkSymmetry, channelBCableLength=channelBCableLength, pubStats=pubStats, targetRange=targetRange, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, sNTPServerStatus=sNTPServerStatus, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, aggregateDataRate=aggregateDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, dataPortAutoMdix=dataPortAutoMdix, syslogControl=syslogControl, transmitFreqKHz=transmitFreqKHz, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNTPSyncTrap=sNTPSyncTrap, productName=productName, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, transmitChannel=transmitChannel, management=management, receiveDataRate=receiveDataRate, tDDControl=tDDControl, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortFiberStatus=dataPortFiberStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemReset=systemReset, tDDSynchronizationMode=tDDSynchronizationMode, ptpCompliance=ptpCompliance, channelBLineCode=channelBLineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bridgeGroup=bridgeGroup, reset=reset, rawReceivePower=rawReceivePower, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, channelALoopbackTrap=channelALoopbackTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, ptpTraps=ptpTraps, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, sNMPv3Enable=sNMPv3Enable, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, aAAControlGroup=aAAControlGroup, sNTPLastSync=sNTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, installStatusTrap=installStatusTrap, qOSPriorityScheme=qOSPriorityScheme, gatewayIPAddress=gatewayIPAddress, channelACableLength=channelACableLength, hTTPPortNumber=hTTPPortNumber, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rangingMode=rangingMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userPassword=userPassword, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsGroup=dfsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, iPv4Address=iPv4Address, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, telecom=telecom, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, supplementaryGroup=supplementaryGroup, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, versions=versions, daylightSaving=daylightSaving, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, dataPortStatus=dataPortStatus, channelALineCode=channelALineCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, productVariant=productVariant, dataPortStatusTrap=dataPortStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveModulationMode=receiveModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingAvailability=ethernetBridgingAvailability, telecomGroup=telecomGroup, receivePower=receivePower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aAAControl=aAAControl, pubStatsGroup=pubStatsGroup, resetGroup=resetGroup, smtpGroup=smtpGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, managementMode=managementMode, configuration=configuration, telnetPortNumber=telnetPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rxColorCode=rxColorCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitPower=transmitPower, sMTPEmailAlert=sMTPEmailAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerTimeout=sNTPServerTimeout, syslogClient=syslogClient, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControlGroup=phyControlGroup, channelALoopback=channelALoopback, hTTPSPortNumber=hTTPSPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, userTableIndex=userTableIndex, dfsMeans=dfsMeans, telecomsChannelSelection=telecomsChannelSelection, automaticTxPowerControl=automaticTxPowerControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, frequencyVariant=frequencyVariant, altitude=altitude, managementPortStatusTrap=managementPortStatusTrap, phyControl=phyControl, PYSNMP_MODULE_ID=cambium, sntpGroup=sntpGroup, dfsTable=dfsTable, linkLoss=linkLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTableNumber=sNTPServerTableNumber, managementGroup=managementGroup, syslogState=syslogState, unitOutOfCalibration=unitOutOfCalibration, ptpTrapPrefix=ptpTrapPrefix, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alarmsGroup=alarmsGroup, smtp=smtp, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry)
