...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerInternetAddress=sNTPServerInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, ethernetGroup=ethernetGroup, management=management, syslogState=syslogState, smtp=smtp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, telecomsChannelAStatus=telecomsChannelAStatus, aAAControl=aAAControl, telecomsChannelBStatus=telecomsChannelBStatus, signalStrengthRatio=signalStrengthRatio, sNTPServerTableNumber=sNTPServerTableNumber, pubStatsGroup=pubStatsGroup, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerInternetAddressType=tFTPServerInternetAddressType, productVariant=productVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsInterface=telecomsInterface, channelBLoopbackTrap=channelBLoopbackTrap, installArmState=installArmState, pubStats=pubStats, sNTPServerTable=sNTPServerTable, syslogControlGroup=syslogControlGroup, dataPortAutoMdix=dataPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, smtpGroup=smtpGroup, userRole=userRole, bridge=bridge, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, subnetMask=subnetMask, ethernet=ethernet, channelALoopbackTrap=channelALoopbackTrap, receiveFreqMHz=receiveFreqMHz, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, userEnabled=userEnabled, localPacketFiltering=localPacketFiltering, accessMethod=accessMethod, installStatus=installStatus, tFTPServerIPAddress=tFTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelACableLength=channelACableLength, dfsMeans=dfsMeans, phyStatus=phyStatus, productName=productName, sMTPEmailAlert=sMTPEmailAlert, channelBLoopback=channelBLoopback, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteRxTargetPower=remoteRxTargetPower, userTableNumber=userTableNumber, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerRetries=sNTPServerRetries, systemReset=systemReset, ethernetFiberSupport=ethernetFiberSupport, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, timeZone=timeZone, dfsTableIndex=dfsTableIndex, latitude=latitude, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortFiberStatus=dataPortFiberStatus, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, mPLSTCPriorityTable=mPLSTCPriorityTable, supplementary=supplementary, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimisation=linkModeOptimisation, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bandwidthVariant=bandwidthVariant, channelBCableLength=channelBCableLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, licence=licence, channelChangeTrap=channelChangeTrap, ptmp=ptmp, PYSNMP_MODULE_ID=cambium, ptpCompliance=ptpCompliance, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, transmitPower=transmitPower, txColorCode=txColorCode, remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPSyncTrap=sNTPSyncTrap, syslogClient=syslogClient, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, transmitFreqKHz=transmitFreqKHz, channelBandwidth=channelBandwidth, transmitDataRate=transmitDataRate, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, versionsGroup=versionsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex, siteName=siteName, cambium=cambium, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, phyControl=phyControl, receiveDataRate=receiveDataRate, userName=userName, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPollInterval=sNTPPollInterval, telecomGroup=telecomGroup, securityLevel=securityLevel, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTableEntry=dfsTableEntry, phyStatusGroup=phyStatusGroup, l2CPPriorityTable=l2CPPriorityTable, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelALineCode=channelALineCode, wirelessLinkStatus=wirelessLinkStatus, managementMode=managementMode, bootVersion=bootVersion, phyControlGroup=phyControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, configurationGroup=configurationGroup, userTable=userTable, vLANManagementVID=vLANManagementVID, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPVersion=iPVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, daylightSaving=daylightSaving, hAZLOCConfiguration=hAZLOCConfiguration, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDControlGroup=tDDControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secureModeAlarm=secureModeAlarm, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelSelection=telecomsChannelSelection, softwareVersion=softwareVersion, rangingMode=rangingMode, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userPassword=userPassword, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, qOSPriorityScheme=qOSPriorityScheme, channelBLineCode=channelBLineCode, sNTPSync=sNTPSync, systemClock=systemClock, channelALoopback=channelALoopback, resetGroup=resetGroup, hTTPSPortNumber=hTTPSPortNumber, managementGroup=managementGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, altitude=altitude, dSCPManagementPriority=dSCPManagementPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp600=ptp600, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, rxColorCode=rxColorCode, sNTPServerTimeout=sNTPServerTimeout, transmitFreqMHz=transmitFreqMHz, transmitChannel=transmitChannel, iPv4Address=iPv4Address, byteErrorRatio=byteErrorRatio, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, syslogControl=syslogControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tDDControl=tDDControl, dfsPeaks=dfsPeaks, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, encryptionAlgorithm=encryptionAlgorithm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, configuration=configuration, syslogClientTrap=syslogClientTrap, automaticTxPowerControl=automaticTxPowerControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, bridgeGroup=bridgeGroup, linkName=linkName, sNMPCommunityString=sNMPCommunityString, ptp=ptp, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsGroup=dfsGroup, vectorError=vectorError, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, syslogStateTrap=syslogStateTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, linkLoss=linkLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsTableNumber=dfsTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, supplementaryGroup=supplementaryGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, alarmsGroup=alarmsGroup, aAAControlGroup=aAAControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpGroups=ptpGroups, managementPortStatus=managementPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, userTableEntry=userTableEntry, groupID=groupID, sntp=sntp, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, eIRP=eIRP, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerStatus=sNTPServerStatus, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, longitude=longitude, targetRange=targetRange, snmpControl=snmpControl, rawReceivePower=rawReceivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, dfsTable=dfsTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sntpGroup=sntpGroup, iPv6GatewayAddress=iPv6GatewayAddress)
