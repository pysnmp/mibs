...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortStatusTrap=managementPortStatusTrap, frequencyVariant=frequencyVariant, managementGroup=managementGroup, cableLoss=cableLoss, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, userName=userName, reset=reset, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveFreqMHz=receiveFreqMHz, channelBLineCode=channelBLineCode, dSCPManagementPriority=dSCPManagementPriority, versionsGroup=versionsGroup, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsPeaks=dfsPeaks, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelALineCode=channelALineCode, vLANManagementVID=vLANManagementVID, channelBLoopbackTrap=channelBLoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerInternetAddress=tFTPServerInternetAddress, ptp=ptp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, byteErrorRatio=byteErrorRatio, dataPortAutoMdix=dataPortAutoMdix, transmitChannel=transmitChannel, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, rxColorCode=rxColorCode, userTableIndex=userTableIndex, sNMPTrapVersion=sNMPTrapVersion, accessMethod=accessMethod, sNTPServerTableIndex=sNTPServerTableIndex, receiveChannel=receiveChannel, telecom=telecom, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, channelALoopbackTrap=channelALoopbackTrap, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, automaticTxPowerControl=automaticTxPowerControl, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetBridgingStatus=ethernetBridgingStatus, managementPortStatus=managementPortStatus, encryption=encryption, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, pubStatsGroup=pubStatsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, rawReceivePower=rawReceivePower, vectorError=vectorError, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetPriorityTable=ethernetPriorityTable, latitude=latitude, userTableEntry=userTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, cambium=cambium, qOSPriorityScheme=qOSPriorityScheme, rangingMode=rangingMode, localPacketFiltering=localPacketFiltering, antennaGain=antennaGain, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetGroup=ethernetGroup, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, syslogState=syslogState, regionCodeTrap=regionCodeTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6Address=iPv6Address, ptp600=ptp600, smtp=smtp, telecomsChannelAStatus=telecomsChannelAStatus, telecomsChannelBStatus=telecomsChannelBStatus, ethernetFiberSupport=ethernetFiberSupport, hAZLOCConfiguration=hAZLOCConfiguration, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dfs=dfs, ethernetBridgingAvailability=ethernetBridgingAvailability, siteName=siteName, telecomsChannelSelection=telecomsChannelSelection, sNTPPrimaryServer=sNTPPrimaryServer, channelACableLength=channelACableLength, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPState=sNTPState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, range=range, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkAvailability=wirelessLinkAvailability, telecomsInterface=telecomsInterface, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, userEnabled=userEnabled, systemClock=systemClock, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, versions=versions, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarning=dataPortDisabledWarning, userPassword=userPassword, sNMPEnabledTraps=sNMPEnabledTraps, ptpGroups=ptpGroups, licence=licence, mPLSTCPriorityTable=mPLSTCPriorityTable, hardwareVersion=hardwareVersion, channelALoopback=channelALoopback, sNTPServerTableEntry=sNTPServerTableEntry, sNMPCommunityString=sNMPCommunityString, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, txColorCode=txColorCode, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, aAAControlGroup=aAAControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, bridgeGroup=bridgeGroup, sNMPTrapTable=sNMPTrapTable, remoteInternetAddressType=remoteInternetAddressType, supplementaryGroup=supplementaryGroup, signalStrengthRatio=signalStrengthRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableNumber=dfsTableNumber, configuration=configuration, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddress=remoteInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenceGroup=licenceGroup, alarms=alarms, sNMPTrapInternetAddress=sNMPTrapInternetAddress, softwareVersion=softwareVersion, linkSymmetry=linkSymmetry, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, channelBCableLength=channelBCableLength, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, PYSNMP_MODULE_ID=cambium, bandwidthVariant=bandwidthVariant, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, targetRange=targetRange, phyStatus=phyStatus, tDDControl=tDDControl, installArmStateTrap=installArmStateTrap, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, altitude=altitude, eIRP=eIRP, productName=productName, iPv4Address=iPv4Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, iPDSCPPriorityTable=iPDSCPPriorityTable, searchState=searchState, regionCode=regionCode, sNTPLastSync=sNTPLastSync, notificationsGroup=notificationsGroup, subnetMask=subnetMask, l2CPPriorityTable=l2CPPriorityTable, transmitModulationMode=transmitModulationMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv6PrefixLength=iPv6PrefixLength, iPVersion=iPVersion, linkLoss=linkLoss, phyStatusGroup=phyStatusGroup, iPv6GatewayAddress=iPv6GatewayAddress, sNMPPortNumber=sNMPPortNumber, transmitDataRate=transmitDataRate, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, transmitFreqMHz=transmitFreqMHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, telnetAccessEnabled=telnetAccessEnabled, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, daylightSaving=daylightSaving, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementMode=managementMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerPortNumber=tFTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", unitOutOfCalibration=unitOutOfCalibration, securityLevel=securityLevel, phyControl=phyControl, managementPortDisabledWarning=managementPortDisabledWarning, groupID=groupID, supplementary=supplementary, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerInternetAddress=sMTPServerInternetAddress, userTable=userTable, phyControlGroup=phyControlGroup, telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveFreqKHz=receiveFreqKHz, sNTPPollInterval=sNTPPollInterval, syslogClient=syslogClient, secureModeAlarmTrap=secureModeAlarmTrap, tDDControlGroup=tDDControlGroup, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortFiberStatus=dataPortFiberStatus, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userTableNumber=userTableNumber, secureModeAlarm=secureModeAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitPower=transmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, dfsTable=dfsTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsMeans=dfsMeans, channelBLoopback=channelBLoopback, installArmState=installArmState, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatusTrap=installStatusTrap, dfsTableIndex=dfsTableIndex)
