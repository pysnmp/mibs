...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", localPacketFiltering=localPacketFiltering, sNTPPrimaryServer=sNTPPrimaryServer, configurationGroup=configurationGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatus=ethernetBridgingStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv4Address=iPv4Address, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, frequencyVariant=frequencyVariant, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, siteName=siteName, searchState=searchState, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, sNTPServerStatus=sNTPServerStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetPortNumber=telnetPortNumber, automaticTxPowerControl=automaticTxPowerControl, noWirelessChannelAvailable=noWirelessChannelAvailable, eIRP=eIRP, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, systemClock=systemClock, PYSNMP_MODULE_ID=cambium, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALoopback=channelALoopback, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, accessMethod=accessMethod, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, encryption=encryption, tFTPServerIPAddress=tFTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTable=ethernetPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableEntry=dfsTableEntry, managementPortStatus=managementPortStatus, phyStatus=phyStatus, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, channelALoopbackTrap=channelALoopbackTrap, channelACableLength=channelACableLength, transmitFreqKHz=transmitFreqKHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userTable=userTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntp=sntp, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, linkSymmetry=linkSymmetry, notificationsGroup=notificationsGroup, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpTraps=ptpTraps, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, daylightSaving=daylightSaving, dSCPManagementPriority=dSCPManagementPriority, groupID=groupID, configuration=configuration, syslogControlGroup=syslogControlGroup, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, userPassword=userPassword, managementPortStatusTrap=managementPortStatusTrap, ptpCompliance=ptpCompliance, altitude=altitude, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDControlGroup=tDDControlGroup, sNMPCommunityString=sNMPCommunityString, sNTPServerTableEntry=sNTPServerTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, userTableIndex=userTableIndex, timeZone=timeZone, txColorCode=txColorCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, rangingMode=rangingMode, ptp=ptp, bootVersion=bootVersion, cambium=cambium, dfsTableIndex=dfsTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hardwareVersion=hardwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, installStatus=installStatus, userTableEntry=userTableEntry, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, ptp600=ptp600, secureModeAlarm=secureModeAlarm, managementMode=managementMode, qOSPriorityScheme=qOSPriorityScheme, installStatusTrap=installStatusTrap, aAAControlGroup=aAAControlGroup, supplementary=supplementary, pubStatsGroup=pubStatsGroup, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, vLANManagementPriority=vLANManagementPriority, remoteRxTargetPower=remoteRxTargetPower, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, managementPortWirelessDownAlert=managementPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBLineCode=channelBLineCode, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, transmitPower=transmitPower, antennaGain=antennaGain, ptmp=ptmp, linkLoss=linkLoss, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddressType=remoteInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vectorError=vectorError, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSPortNumber=hTTPSPortNumber, productName=productName, telecomsChannelBStatus=telecomsChannelBStatus, userTableNumber=userTableNumber, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimisation=linkModeOptimisation, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, management=management, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, versions=versions, reset=reset, productVariant=productVariant, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dfsMeans=dfsMeans, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelBCableLength=channelBCableLength, managementPortDisabledWarning=managementPortDisabledWarning, channelALineCode=channelALineCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, ethernetBridgingAvailability=ethernetBridgingAvailability, userName=userName, dfsTable=dfsTable, managementGroup=managementGroup, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClient=syslogClient, systemReset=systemReset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, channelBLoopback=channelBLoopback, dfsGroup=dfsGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsPeaks=dfsPeaks, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, latitude=latitude, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, dfs=dfs, range=range, encryptionGroup=encryptionGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubStats=pubStats, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, targetRange=targetRange, sNTPServerTableNumber=sNTPServerTableNumber, iPv6Address=iPv6Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitDataRate=transmitDataRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aggregateDataRate=aggregateDataRate, userEnabled=userEnabled, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCodeTrap=regionCodeTrap, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, secureModeAlarmTrap=secureModeAlarmTrap, licence=licence, telecomsChannelAStatus=telecomsChannelAStatus, dataPortDisabledWarning=dataPortDisabledWarning, ethernet=ethernet, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, channelBLoopbackTrap=channelBLoopbackTrap, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteIPAddress=remoteIPAddress, rawReceivePower=rawReceivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", gatewayIPAddress=gatewayIPAddress, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, targetMACAddress=targetMACAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, smtp=smtp, phyControlGroup=phyControlGroup, signalStrengthRatio=signalStrengthRatio, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatch=dataPortConfigurationMismatch, securityLevel=securityLevel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bridge=bridge, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, channelChangeTrap=channelChangeTrap, dfsTableNumber=dfsTableNumber, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsInterface=telecomsInterface, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetFiberSupport=ethernetFiberSupport, receiveModulationMode=receiveModulationMode, dataPortFiberStatus=dataPortFiberStatus, rxColorCode=rxColorCode, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, telecom=telecom, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower)
