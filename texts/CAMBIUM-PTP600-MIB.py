...
iso, TimeTicks, Integer32, ModuleIdentity, enterprises, Bits, Counter32, Counter64, NotificationType, Unsigned32, MibIdentifier, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises", "Bits", "Counter32", "Counter64", "NotificationType", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortDisabledWarning=dataPortDisabledWarning, pubStats=pubStats, sNTPPrimaryServer=sNTPPrimaryServer, channelALoopback=channelALoopback, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, telecomsInterface=telecomsInterface, telecomsChannelBStatus=telecomsChannelBStatus, frequencyVariant=frequencyVariant, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelChangeTrap=channelChangeTrap, receiveFreqMHz=receiveFreqMHz, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoMdix=dataPortAutoMdix, cambium=cambium, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPv6Address=iPv6Address, managementPortDisabledWarning=managementPortDisabledWarning, managementPortStatusTrap=managementPortStatusTrap, phyStatus=phyStatus, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryption=encryption, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, supplementaryGroup=supplementaryGroup, pubStatsGroup=pubStatsGroup, telecomsChannelAStatus=telecomsChannelAStatus, eIRP=eIRP, sNTPServerTable=sNTPServerTable, userTableEntry=userTableEntry, channelBCableLength=channelBCableLength, dataPortStatusTrap=dataPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelACableLength=channelACableLength, ptpCompliance=ptpCompliance, bandwidthVariant=bandwidthVariant, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControl=phyControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetGroup=ethernetGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementGroup=managementGroup, vectorError=vectorError, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerStatus=sNTPServerStatus, sNTPServerTableNumber=sNTPServerTableNumber, receiveDataRate=receiveDataRate, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, userName=userName, channelBLoopback=channelBLoopback, snmpControl=snmpControl, receiveChannel=receiveChannel, remoteRxTargetPower=remoteRxTargetPower, userEnabled=userEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, rangingMode=rangingMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, timeZone=timeZone, siteName=siteName, targetMACAddress=targetMACAddress, sNMPTrapVersion=sNMPTrapVersion, productName=productName, sMTPServerPortNumber=sMTPServerPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, syslogStateTrap=syslogStateTrap, systemClock=systemClock, systemReset=systemReset, transmitModulationMode=transmitModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionGroup=encryptionGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, channelBLineCode=channelBLineCode, telnetPortNumber=telnetPortNumber, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, tFTPServerIPAddress=tFTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, managementPortStatus=managementPortStatus, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, alarms=alarms, linkModeOptimisation=linkModeOptimisation, rxColorCode=rxColorCode, sNMPPortNumber=sNMPPortNumber, channelALineCode=channelALineCode, userTableNumber=userTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetRange=targetRange, l2CPPriorityTable=l2CPPriorityTable, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, securityLevel=securityLevel, userTableIndex=userTableIndex, syslogClientTrap=syslogClientTrap, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsPeaks=dfsPeaks, hTTPAccessEnabled=hTTPAccessEnabled, installStatusTrap=installStatusTrap, telnetAccessEnabled=telnetAccessEnabled, installArmStateTrap=installArmStateTrap, altitude=altitude, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelALoopbackTrap=channelALoopbackTrap, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpGroups=ptpGroups, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licence=licence, sntpGroup=sntpGroup, syslogClient=syslogClient, longitude=longitude, dfsMeans=dfsMeans, receiveFreqKHz=receiveFreqKHz, telecom=telecom, ptp=ptp, smtp=smtp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versions=versions, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, softwareVersion=softwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkLoss=linkLoss, phyStatusGroup=phyStatusGroup, telecomsChannelSelection=telecomsChannelSelection, ethernetFiberSupport=ethernetFiberSupport, masterSlaveMode=masterSlaveMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDControl=tDDControl, sNMPTrapTable=sNMPTrapTable, userTable=userTable, accessMethod=accessMethod, supplementary=supplementary, qOSPriorityScheme=qOSPriorityScheme, iPv6PrefixLength=iPv6PrefixLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, automaticTxPowerControl=automaticTxPowerControl, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitDataRate=transmitDataRate, secureModeAlarmTrap=secureModeAlarmTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userPassword=userPassword, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkName=linkName, remoteInternetAddress=remoteInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, regionCode=regionCode, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelBandwidth=channelBandwidth, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementMode=managementMode, dfs=dfs, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogState=syslogState, versionsGroup=versionsGroup, sntp=sntp, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortFiberStatus=dataPortFiberStatus, unitOutOfCalibration=unitOutOfCalibration, ptp600=ptp600, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, dSCPManagementPriority=dSCPManagementPriority, transmitChannel=transmitChannel, secureModeAlarm=secureModeAlarm, sMTPEnabledMessages=sMTPEnabledMessages, antennaGain=antennaGain, subnetMask=subnetMask, syslogControlGroup=syslogControlGroup, rawReceivePower=rawReceivePower, sNTPServerRetries=sNTPServerRetries, noWirelessChannelAvailable=noWirelessChannelAvailable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, management=management, telecomGroup=telecomGroup, alarmsGroup=alarmsGroup, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPVersion=iPVersion, hAZLOCConfiguration=hAZLOCConfiguration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteInternetAddressType=remoteInternetAddressType, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddressType=sNTPServerInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTableIndex=sNTPServerTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, ethernetBridgingStatus=ethernetBridgingStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, configuration=configuration, bridgeGroup=bridgeGroup, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, range=range, iPv4Address=iPv4Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitPower=transmitPower, phyControlGroup=phyControlGroup, installStatus=installStatus, aAAControl=aAAControl, resetGroup=resetGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableNumber=dfsTableNumber, productVariant=productVariant, vLANManagementVID=vLANManagementVID, bridge=bridge, daylightSaving=daylightSaving, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, txColorCode=txColorCode, latitude=latitude, reset=reset, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsGroup=dfsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, ptmp=ptmp, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch)
