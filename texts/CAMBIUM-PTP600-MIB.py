...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBCableLength=channelBCableLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bootVersion=bootVersion, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, sNTPServerTimeout=sNTPServerTimeout, linkSymmetry=linkSymmetry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, unitOutOfCalibration=unitOutOfCalibration, tDDControlGroup=tDDControlGroup, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortStatusTrap=managementPortStatusTrap, dfsGroup=dfsGroup, l2CPPriorityTable=l2CPPriorityTable, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, dataPortFiberStatus=dataPortFiberStatus, regionCodeTrap=regionCodeTrap, resetGroup=resetGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelBLineCode=channelBLineCode, syslogStateTrap=syslogStateTrap, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, dfsTableNumber=dfsTableNumber, supplementaryGroup=supplementaryGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, installStatusTrap=installStatusTrap, management=management, hAZLOCConfiguration=hAZLOCConfiguration, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, iPv6PrefixLength=iPv6PrefixLength, snmpControl=snmpControl, telecomsChannelSelection=telecomsChannelSelection, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, channelALineCode=channelALineCode, range=range, phyControl=phyControl, ptpGroups=ptpGroups, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableEntry=dfsTableEntry, snmpControlGroup=snmpControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, vectorError=vectorError, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptp=ptp, transmitDataRate=transmitDataRate, dfsTableIndex=dfsTableIndex, bridge=bridge, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTableIndex=userTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, latitude=latitude, phyStatus=phyStatus, configurationGroup=configurationGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitPower=transmitPower, cambium=cambium, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, sNTPPrimaryServer=sNTPPrimaryServer, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, frequencyVariant=frequencyVariant, managementGroup=managementGroup, aggregateDataRate=aggregateDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, receiveDataRate=receiveDataRate, userPassword=userPassword, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomGroup=telecomGroup, versions=versions, pubStatsGroup=pubStatsGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, bridgeGroup=bridgeGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, timeZone=timeZone, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogState=syslogState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangingMode=rangingMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfs=dfs, channelBLoopback=channelBLoopback, alarmsGroup=alarmsGroup, telecom=telecom, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, encryption=encryption, installArmState=installArmState, userEnabled=userEnabled, longitude=longitude, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptp600=ptp600, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, bandwidthVariant=bandwidthVariant, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerStatus=sNTPServerStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, regionCode=regionCode, telecomsInterface=telecomsInterface, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPPortNumber=hTTPPortNumber, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, sNTPServerTable=sNTPServerTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, sMTPServerIPAddress=sMTPServerIPAddress, iPv4Address=iPv4Address, rxColorCode=rxColorCode, vLANManagementPriority=vLANManagementPriority, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPv3Enable=sNMPv3Enable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, txColorCode=txColorCode, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTable=ethernetPriorityTable, masterSlaveMode=masterSlaveMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatus=dataPortStatus, syslogControl=syslogControl, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, remoteInternetAddressType=remoteInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, smtp=smtp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, userTable=userTable, dfsMeans=dfsMeans, ptmp=ptmp, targetMACAddress=targetMACAddress, managementMode=managementMode, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortDisabledWarning=managementPortDisabledWarning, alarms=alarms, supplementary=supplementary, ptpCompliance=ptpCompliance, dfsTable=dfsTable, daylightSaving=daylightSaving, linkName=linkName, transmitChannel=transmitChannel, dataPortAutoMdix=dataPortAutoMdix, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortStatus=managementPortStatus, installStatus=installStatus, remoteRxTargetPower=remoteRxTargetPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerIPAddress=tFTPServerIPAddress, groupID=groupID, secureModeAlarmTrap=secureModeAlarmTrap, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, ethernetBridgingAvailability=ethernetBridgingAvailability, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, dSCPManagementPriority=dSCPManagementPriority, automaticTxPowerControl=automaticTxPowerControl, userName=userName, sNTPSync=sNTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, aAAControlGroup=aAAControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, iPv6Address=iPv6Address, licence=licence, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPEmailAlert=sMTPEmailAlert, hardwareVersion=hardwareVersion, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableEntry=sNTPServerTableEntry, channelBandwidth=channelBandwidth, sNTPServerPortNumber=sNTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyStatusGroup=phyStatusGroup, secureModeAlarm=secureModeAlarm, hTTPSPortNumber=hTTPSPortNumber, channelChangeTrap=channelChangeTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetBridgingStatus=ethernetBridgingStatus, receivePower=receivePower, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopback=channelALoopback, rawReceivePower=rawReceivePower, telecomsChannelAStatus=telecomsChannelAStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, productName=productName, targetRange=targetRange, smtpGroup=smtpGroup, subnetMask=subnetMask, accessMethod=accessMethod, iPVersion=iPVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, channelALoopbackTrap=channelALoopbackTrap, remoteInternetAddress=remoteInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, securityLevel=securityLevel, versionsGroup=versionsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsPeaks=dfsPeaks, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBLoopbackTrap=channelBLoopbackTrap, channelACableLength=channelACableLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveFreqMHz=receiveFreqMHz, notificationsGroup=notificationsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6GatewayAddress=iPv6GatewayAddress, softwareVersion=softwareVersion, altitude=altitude, sNTPServerRetries=sNTPServerRetries, sntpGroup=sntpGroup, linkLoss=linkLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, localPacketFiltering=localPacketFiltering)
