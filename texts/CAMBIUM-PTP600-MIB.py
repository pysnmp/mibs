...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsPeaks=dfsPeaks, dfsTableNumber=dfsTableNumber, l2CPPriorityTable=l2CPPriorityTable, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, l2CPPriorityTableIndex=l2CPPriorityTableIndex, localPacketFiltering=localPacketFiltering, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsInterface=telecomsInterface, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, range=range, ptmp=ptmp, userTableIndex=userTableIndex, channelBLoopback=channelBLoopback, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6Address=iPv6Address, transmitDataRate=transmitDataRate, configuration=configuration, alarmsGroup=alarmsGroup, regionCode=regionCode, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableIndex=dfsTableIndex, licenceGroup=licenceGroup, channelALineCode=channelALineCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, txColorCode=txColorCode, secureModeAlarm=secureModeAlarm, telnetAccessEnabled=telnetAccessEnabled, managementGroup=managementGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogStateTrap=syslogStateTrap, tDDControl=tDDControl, resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, siteName=siteName, signalStrengthRatio=signalStrengthRatio, daylightSaving=daylightSaving, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, subnetMask=subnetMask, sNTPServerRetries=sNTPServerRetries, sNTPServerIPAddress=sNTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelBCableLength=channelBCableLength, ptpCompliance=ptpCompliance, supplementary=supplementary, channelACableLength=channelACableLength, softwareVersion=softwareVersion, phyControl=phyControl, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, timeZone=timeZone, aAAControl=aAAControl, installStatusTrap=installStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, telecomGroup=telecomGroup, incompatibleRegionCodes=incompatibleRegionCodes, PYSNMP_MODULE_ID=cambium, vLANManagementPriority=vLANManagementPriority, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, phyControlGroup=phyControlGroup, sNTPState=sNTPState, searchState=searchState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetGroup=ethernetGroup, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rangingMode=rangingMode, transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, hAZLOCConfiguration=hAZLOCConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, installArmState=installArmState, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, pubStats=pubStats, linkSymmetry=linkSymmetry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableEntry=sNTPServerTableEntry, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPSync=sNTPSync, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, hardwareVersion=hardwareVersion, userEnabled=userEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTable=sNTPServerTable, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, telecomsChannelSelection=telecomsChannelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hTTPSAccessEnabled=hTTPSAccessEnabled, vectorError=vectorError, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, bootVersion=bootVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, managementMode=managementMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, telecom=telecom, dfsTableEntry=dfsTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerStatus=sNTPServerStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkName=linkName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortStatus=managementPortStatus, sNMPPortNumber=sNMPPortNumber, syslogClientTrap=syslogClientTrap, syslogControl=syslogControl, ethernetFiberSupport=ethernetFiberSupport, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsGroup=dfsGroup, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rawReceivePower=rawReceivePower, telecomsChannelAStatus=telecomsChannelAStatus, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationStatus=tDDSynchronizationStatus, ptp=ptp, qOSPriorityScheme=qOSPriorityScheme, encryptionAlgorithm=encryptionAlgorithm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp600=ptp600, secureModeAlarmTrap=secureModeAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, securityLevel=securityLevel, installStatus=installStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, licence=licence, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, linkLoss=linkLoss, configurationGroup=configurationGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxColorCode=rxColorCode, ethernetBridgingStatus=ethernetBridgingStatus, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, userTableNumber=userTableNumber, transmitChannel=transmitChannel, managementPortDisabledWarning=managementPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, userPassword=userPassword, accessMethod=accessMethod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, bridge=bridge, dataPortAutoMdix=dataPortAutoMdix, vLANManagementVID=vLANManagementVID, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, cambium=cambium, userTableEntry=userTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, groupID=groupID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementaryGroup=supplementaryGroup, targetRange=targetRange, versionsGroup=versionsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv6GatewayAddress=iPv6GatewayAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, aggregateDataRate=aggregateDataRate, dataPortFiberStatus=dataPortFiberStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationMode=tDDSynchronizationMode, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogClient=syslogClient, channelALoopback=channelALoopback, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv4Address=iPv4Address, telecomsChannelBStatus=telecomsChannelBStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, channelALoopbackTrap=channelALoopbackTrap, receivePower=receivePower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, altitude=altitude, sMTPServerInternetAddress=sMTPServerInternetAddress, bridgeGroup=bridgeGroup, smtp=smtp, reset=reset, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, eIRP=eIRP, remoteRxTargetPower=remoteRxTargetPower, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapVersion=sNMPTrapVersion, sntpGroup=sntpGroup, receiveDataRate=receiveDataRate, sntp=sntp, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, masterSlaveMode=masterSlaveMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, tDDControlGroup=tDDControlGroup, aAAControlGroup=aAAControlGroup, iPVersion=iPVersion, syslogState=syslogState, smtpGroup=smtpGroup, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, productName=productName, dataPortStatus=dataPortStatus, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, iPDSCPPriorityTable=iPDSCPPriorityTable, automaticTxPowerControl=automaticTxPowerControl, sNTPSyncTrap=sNTPSyncTrap, ethernet=ethernet, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTable=userTable, dfs=dfs, byteErrorRatio=byteErrorRatio, userName=userName, sNMPCommunityString=sNMPCommunityString, secondarySoftwareVersion=secondarySoftwareVersion, dSCPManagementPriority=dSCPManagementPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, bandwidthVariant=bandwidthVariant, transmitFreqKHz=transmitFreqKHz, syslogControlGroup=syslogControlGroup, channelBLineCode=channelBLineCode)
