...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receivePower=receivePower, tFTPServerInternetAddress=tFTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsGroup=dfsGroup, telecom=telecom, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPPrimaryServer=sNTPPrimaryServer, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControl=snmpControl, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, ptpGroups=ptpGroups, telecomsChannelSelection=telecomsChannelSelection, telecomsChannelAStatus=telecomsChannelAStatus, transmitModulationMode=transmitModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, transmitFreqKHz=transmitFreqKHz, cambium=cambium, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, dfsTable=dfsTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, dfs=dfs, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, txColorCode=txColorCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, sNTPServerStatus=sNTPServerStatus, userRole=userRole, linkLoss=linkLoss, userTable=userTable, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, encryptionAlgorithm=encryptionAlgorithm, secureModeAlarmTrap=secureModeAlarmTrap, managementGroup=managementGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodes=incompatibleRegionCodes, smtpGroup=smtpGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, sNTPServerTableIndex=sNTPServerTableIndex, daylightSaving=daylightSaving, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, licenceGroup=licenceGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, bandwidthVariant=bandwidthVariant, localPacketFiltering=localPacketFiltering, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userName=userName, versionsGroup=versionsGroup, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelACableLength=channelACableLength, managementPortDisabledWarning=managementPortDisabledWarning, iPVersion=iPVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitChannel=transmitChannel, byteErrorRatio=byteErrorRatio, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, rxColorCode=rxColorCode, receiveDataRate=receiveDataRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortStatus=managementPortStatus, groupID=groupID, vLANManagementVID=vLANManagementVID, hAZLOCConfiguration=hAZLOCConfiguration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelBandwidth=channelBandwidth, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableEntry=l2CPPriorityTableEntry, notificationsGroup=notificationsGroup, channelBCableLength=channelBCableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityTable=l2CPPriorityTable, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelALineCode=channelALineCode, transmitDataRate=transmitDataRate, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, regionCode=regionCode, ptp600=ptp600, pubStats=pubStats, receiveModulationMode=receiveModulationMode, vectorError=vectorError, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, aAAControlGroup=aAAControlGroup, remoteIPAddress=remoteIPAddress, eIRP=eIRP, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installStatus=installStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTable=ethernetPriorityTable, telnetAccessEnabled=telnetAccessEnabled, dfsMeans=dfsMeans, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, gatewayIPAddress=gatewayIPAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogControl=syslogControl, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBLineCode=channelBLineCode, managementPortStatusTrap=managementPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, ptpCompliance=ptpCompliance, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, remoteRxTargetPower=remoteRxTargetPower, syslogState=syslogState, smtp=smtp, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, range=range, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetGroup=ethernetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatus=phyStatus, channelBLoopback=channelBLoopback, userEnabled=userEnabled, receiveFreqMHz=receiveFreqMHz, targetRange=targetRange, dataPortFiberStatus=dataPortFiberStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPSync=sNTPSync, subnetMask=subnetMask, phyControlGroup=phyControlGroup, remoteInternetAddress=remoteInternetAddress, dataPortStatus=dataPortStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementMode=managementMode, sNMPTrapPortNumber=sNMPTrapPortNumber, systemReset=systemReset, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, supplementary=supplementary, sNTPServerRetries=sNTPServerRetries, dfsPeaks=dfsPeaks, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPState=sNTPState, accessMethod=accessMethod, tDDControl=tDDControl, iPv6Address=iPv6Address, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomGroup=telecomGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, productName=productName, bridge=bridge, management=management, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, licence=licence, sNTPServerTable=sNTPServerTable, cableLoss=cableLoss, userPassword=userPassword, latitude=latitude, iPv4Address=iPv4Address, receiveFreqKHz=receiveFreqKHz, qOSPriorityScheme=qOSPriorityScheme, sMTPServerPortNumber=sMTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, productVariant=productVariant, configuration=configuration, resetGroup=resetGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableNumber=dfsTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, rangingMode=rangingMode, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, aAAControl=aAAControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitPower=transmitPower, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, altitude=altitude, sNTPLastSync=sNTPLastSync, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rawReceivePower=rawReceivePower, ethernetFiberSupport=ethernetFiberSupport, remoteInternetAddressType=remoteInternetAddressType, softwareVersion=softwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBLoopbackTrap=channelBLoopbackTrap, receiveChannel=receiveChannel, systemClock=systemClock, ethernetBridgingStatus=ethernetBridgingStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, userTableEntry=userTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, channelALoopback=channelALoopback, installArmState=installArmState, secureModeAlarm=secureModeAlarm, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationGroup=configurationGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, automaticTxPowerControl=automaticTxPowerControl, userTableNumber=userTableNumber, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, reset=reset, ethernet=ethernet)
