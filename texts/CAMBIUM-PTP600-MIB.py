...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortAutoMdix=dataPortAutoMdix, telecomsChannelBStatus=telecomsChannelBStatus, syslogControlGroup=syslogControlGroup, txColorCode=txColorCode, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, pubStatsGroup=pubStatsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, receiveModulationModeDetail=receiveModulationModeDetail, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, timeZone=timeZone, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, byteErrorRatio=byteErrorRatio, channelACableLength=channelACableLength, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, bridgeGroup=bridgeGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenceGroup=licenceGroup, phyControlGroup=phyControlGroup, rawReceivePower=rawReceivePower, bootVersion=bootVersion, snmpControl=snmpControl, ptpCompliance=ptpCompliance, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelAStatus=telecomsChannelAStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versions=versions, softwareVersion=softwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyStatusGroup=phyStatusGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, range=range, telnetPortNumber=telnetPortNumber, userTableIndex=userTableIndex, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, rangingMode=rangingMode, syslogControl=syslogControl, channelBandwidth=channelBandwidth, configuration=configuration, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, phyControl=phyControl, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkName=linkName, supplementary=supplementary, transmitChannel=transmitChannel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementGroup=managementGroup, ptp=ptp, transmitFreqMHz=transmitFreqMHz, telecomsChannelSelection=telecomsChannelSelection, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, dfsTableNumber=dfsTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, sNTPState=sNTPState, sMTPServerIPAddress=sMTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, securityLevel=securityLevel, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bridge=bridge, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, installArmState=installArmState, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, channelBLineCode=channelBLineCode, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, qOSPriorityScheme=qOSPriorityScheme, managementMode=managementMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receivePower=receivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTable=userTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vectorError=vectorError, sntpGroup=sntpGroup, channelALoopbackTrap=channelALoopbackTrap, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, sNTPServerTableNumber=sNTPServerTableNumber, ptpTraps=ptpTraps, localPacketFiltering=localPacketFiltering, searchState=searchState, userTableNumber=userTableNumber, dfsTableEntry=dfsTableEntry, resetGroup=resetGroup, channelALoopback=channelALoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, encryptionGroup=encryptionGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, frequencyVariant=frequencyVariant, remoteRxTargetPower=remoteRxTargetPower, encryptionAlgorithm=encryptionAlgorithm, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv4Address=iPv4Address, userName=userName, syslogStateTrap=syslogStateTrap, dfsTable=dfsTable, groupID=groupID, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, incompatibleRegionCodes=incompatibleRegionCodes, remoteInternetAddress=remoteInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, systemReset=systemReset, versionsGroup=versionsGroup, dSCPManagementPriority=dSCPManagementPriority, ptmp=ptmp, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, userEnabled=userEnabled, ptpTrapPrefix=ptpTrapPrefix, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetGroup=ethernetGroup, dfsMeans=dfsMeans, bandwidthVariant=bandwidthVariant, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, iPv6Address=iPv6Address, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerRetries=sNTPServerRetries, l2CPPriorityTable=l2CPPriorityTable, pubStats=pubStats, sNTPServerInternetAddress=sNTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, encryption=encryption, rxColorCode=rxColorCode, ethernetPriorityTable=ethernetPriorityTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsGroup=dfsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, subnetMask=subnetMask, secureModeAlarm=secureModeAlarm, signalStrengthRatio=signalStrengthRatio, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, productVariant=productVariant, telecomGroup=telecomGroup, daylightSaving=daylightSaving, altitude=altitude, dataPortFiberStatus=dataPortFiberStatus, linkSymmetry=linkSymmetry, sNTPServerStatus=sNTPServerStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessLinkAvailability=wirelessLinkAvailability, telecom=telecom, channelBLoopback=channelBLoopback, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, aAAControl=aAAControl, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, productName=productName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, gatewayIPAddress=gatewayIPAddress, accessMethod=accessMethod, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPVersion=iPVersion, systemClock=systemClock, tDDControl=tDDControl, channelBCableLength=channelBCableLength, receiveDataRate=receiveDataRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userRole=userRole, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, eIRP=eIRP, snmpControlGroup=snmpControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogState=syslogState, siteName=siteName, managementPortStatus=managementPortStatus, ethernetBridgingStatus=ethernetBridgingStatus, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installStatusTrap=installStatusTrap, channelALineCode=channelALineCode, reset=reset, notificationsGroup=notificationsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, sNTPServerTableIndex=sNTPServerTableIndex, syslogClientTrap=syslogClientTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hardwareVersion=hardwareVersion, supplementaryGroup=supplementaryGroup, sNTPServerTable=sNTPServerTable, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtp=smtp, tDDControlGroup=tDDControlGroup, automaticTxPowerControl=automaticTxPowerControl, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licence=licence, iPv6PrefixLength=iPv6PrefixLength, sNTPSyncTrap=sNTPSyncTrap, dfs=dfs, installArmStateTrap=installArmStateTrap, cambium=cambium, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, ptp600=ptp600, hAZLOCConfiguration=hAZLOCConfiguration, targetRange=targetRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitModulationMode=transmitModulationMode, ethernet=ethernet)
