...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, installStatusTrap=installStatusTrap, sNTPServerStatus=sNTPServerStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, rangingMode=rangingMode, dfsTableNumber=dfsTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receivePower=receivePower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelALineCode=channelALineCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, installArmStateTrap=installArmStateTrap, channelBCableLength=channelBCableLength, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sntp=sntp, sNMPTrapTable=sNMPTrapTable, channelALoopback=channelALoopback, linkName=linkName, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPState=sNTPState, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerIPAddress=sNTPServerIPAddress, softwareVersion=softwareVersion, configurationGroup=configurationGroup, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, linkSymmetry=linkSymmetry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, accessMethod=accessMethod, dataPortDisabledWarning=dataPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemReset=systemReset, ptmp=ptmp, versions=versions, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, aAAControl=aAAControl, phyStatusGroup=phyStatusGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortStatus=managementPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogStateTrap=syslogStateTrap, securityLevel=securityLevel, ethernetPriorityTableEntry=ethernetPriorityTableEntry, notificationsGroup=notificationsGroup, siteName=siteName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, phyControl=phyControl, snmpControlGroup=snmpControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userEnabled=userEnabled, telecomsChannelAStatus=telecomsChannelAStatus, sNMPv3Enable=sNMPv3Enable, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoMdix=dataPortAutoMdix, configuration=configuration, bandwidthVariant=bandwidthVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveFreqKHz=receiveFreqKHz, management=management, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, aggregateDataRate=aggregateDataRate, ethernetFiberSupport=ethernetFiberSupport, altitude=altitude, sNTPServerTable=sNTPServerTable, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, groupID=groupID, supplementary=supplementary, vLANManagementVID=vLANManagementVID, smtp=smtp, sNTPPollInterval=sNTPPollInterval, telecomsChannelSelection=telecomsChannelSelection, userTableIndex=userTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, iPv6Address=iPv6Address, productVariant=productVariant, dataPortFiberStatus=dataPortFiberStatus, tDDControl=tDDControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPSync=sNTPSync, pubStats=pubStats, alarms=alarms, ptpGroups=ptpGroups, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, iPv4Address=iPv4Address, dfsTableIndex=dfsTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, dfsMeans=dfsMeans, ethernetBridgingAvailability=ethernetBridgingAvailability, transmitFreqMHz=transmitFreqMHz, sNTPServerTableEntry=sNTPServerTableEntry, ethernetGroup=ethernetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, transmitPower=transmitPower, linkModeOptimisation=linkModeOptimisation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, pubStatsGroup=pubStatsGroup, productName=productName, range=range, sNMPEnabledTraps=sNMPEnabledTraps, supplementaryGroup=supplementaryGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatus=phyStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALoopbackTrap=channelALoopbackTrap, resetGroup=resetGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, daylightSaving=daylightSaving, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, systemClock=systemClock, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, remoteRxTargetPower=remoteRxTargetPower, ptpCompliance=ptpCompliance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subnetMask=subnetMask, tDDSynchronizationMode=tDDSynchronizationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, frequencyVariant=frequencyVariant, searchState=searchState, managementPortStatusTrap=managementPortStatusTrap, iPVersion=iPVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userTableEntry=userTableEntry, localPacketFiltering=localPacketFiltering, managementMode=managementMode, sNMPTrapVersion=sNMPTrapVersion, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, secureModeAlarmTrap=secureModeAlarmTrap, remoteIPAddress=remoteIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPPortNumber=sNMPPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, rawReceivePower=rawReceivePower, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, managementGroup=managementGroup, remoteInternetAddress=remoteInternetAddress, telecom=telecom, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, channelBLineCode=channelBLineCode, bootVersion=bootVersion, eIRP=eIRP, dfs=dfs, targetRange=targetRange, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, channelChangeTrap=channelChangeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernet=ethernet, dataPortStatus=dataPortStatus, transmitFreqKHz=transmitFreqKHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableLoss=cableLoss, automaticTxPowerControl=automaticTxPowerControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerTimeout=sNTPServerTimeout, PYSNMP_MODULE_ID=cambium, sNTPSyncTrap=sNTPSyncTrap, masterSlaveMode=masterSlaveMode, bridge=bridge, channelACableLength=channelACableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, bridgeGroup=bridgeGroup, ptpTrapPrefix=ptpTrapPrefix, telecomsInterface=telecomsInterface, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, secureModeAlarm=secureModeAlarm, userTableNumber=userTableNumber, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userRole=userRole, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, noWirelessChannelAvailable=noWirelessChannelAvailable, longitude=longitude, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, channelBLoopbackTrap=channelBLoopbackTrap, dfsGroup=dfsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, channelBLoopback=channelBLoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTable=dfsTable, sntpGroup=sntpGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, dSCPManagementPriority=dSCPManagementPriority, syslogState=syslogState, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, txColorCode=txColorCode, installArmState=installArmState, syslogClient=syslogClient, remoteInternetAddressType=remoteInternetAddressType, rxColorCode=rxColorCode, userName=userName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptp600=ptp600, encryption=encryption, transmitModulationMode=transmitModulationMode, timeZone=timeZone, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetMACAddress=targetMACAddress, cambium=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerRetries=sNTPServerRetries, licence=licence, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, l2CPPriorityTable=l2CPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, installStatus=installStatus, linkLoss=linkLoss, sNTPPrimaryServer=sNTPPrimaryServer, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, telecomGroup=telecomGroup)
