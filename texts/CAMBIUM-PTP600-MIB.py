...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", groupID=groupID, l2CPPriorityTableEntry=l2CPPriorityTableEntry, secureModeAlarm=secureModeAlarm, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, altitude=altitude, bridge=bridge, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv6PrefixLength=iPv6PrefixLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, sNMPv3Enable=sNMPv3Enable, frequencyVariant=frequencyVariant, linkName=linkName, daylightSaving=daylightSaving, userTableEntry=userTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, eIRP=eIRP, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsPeaks=dfsPeaks, transmitFreqKHz=transmitFreqKHz, encryption=encryption, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, systemReset=systemReset, tDDControlGroup=tDDControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveModulationMode=receiveModulationMode, ethernet=ethernet, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerTableNumber=sNTPServerTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortStatusTrap=dataPortStatusTrap, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, bridgeGroup=bridgeGroup, notificationsGroup=notificationsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, installStatus=installStatus, ethernetPriorityTable=ethernetPriorityTable, rangingMode=rangingMode, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBandwidth=channelBandwidth, receiveModulationModeDetail=receiveModulationModeDetail, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelALoopback=channelALoopback, alarmsGroup=alarmsGroup, hAZLOCConfiguration=hAZLOCConfiguration, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, automaticTxPowerControl=automaticTxPowerControl, userEnabled=userEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp600=ptp600, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dSCPManagementPriority=dSCPManagementPriority, ptpCompliance=ptpCompliance, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, transmitModulationMode=transmitModulationMode, telecomsChannelBStatus=telecomsChannelBStatus, ptpTraps=ptpTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cambium=cambium, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortDisabledWarning=managementPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, range=range, linkModeOptimisation=linkModeOptimisation, ethernetGroup=ethernetGroup, ethernetBridgingStatus=ethernetBridgingStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, management=management, smtp=smtp, dfsTableEntry=dfsTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlGroup=phyControlGroup, userName=userName, vLANManagementVID=vLANManagementVID, channelBLineCode=channelBLineCode, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, targetRange=targetRange, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, dfsTableNumber=dfsTableNumber, userRole=userRole, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productVariant=productVariant, dataPortFiberStatus=dataPortFiberStatus, versions=versions, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxColorCode=rxColorCode, receiveFreqMHz=receiveFreqMHz, reset=reset, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, userTableIndex=userTableIndex, sntpGroup=sntpGroup, dataPortAutoMdix=dataPortAutoMdix, constantPowerSpectralDensity=constantPowerSpectralDensity, longitude=longitude, productName=productName, accessMethod=accessMethod, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, localPacketFiltering=localPacketFiltering, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configuration=configuration, telecom=telecom, telecomGroup=telecomGroup, maximumTransmitPower=maximumTransmitPower, ptpGroups=ptpGroups, txColorCode=txColorCode, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitPower=transmitPower, targetMACAddress=targetMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitChannel=transmitChannel, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPPrimaryServer=sNTPPrimaryServer, licence=licence, cableLoss=cableLoss, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, sNTPLastSync=sNTPLastSync, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, latitude=latitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rawReceivePower=rawReceivePower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControl=syslogControl, encryptionGroup=encryptionGroup, channelBLoopback=channelBLoopback, sNTPServerTable=sNTPServerTable, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, phyStatusGroup=phyStatusGroup, sNTPSync=sNTPSync, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv4Address=iPv4Address, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sntp=sntp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, iPv6Address=iPv6Address, managementMode=managementMode, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, searchState=searchState, mPLSTCPriorityTable=mPLSTCPriorityTable, userTable=userTable, transmitDataRate=transmitDataRate, syslogControlGroup=syslogControlGroup, userPassword=userPassword, syslogStateTrap=syslogStateTrap, dataPortStatus=dataPortStatus, remoteRxTargetPower=remoteRxTargetPower, dfsMeans=dfsMeans, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, linkLoss=linkLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEnabledMessages=sMTPEnabledMessages, siteName=siteName, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsInterface=telecomsInterface, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTimeout=sNTPServerTimeout, telecomsChannelAStatus=telecomsChannelAStatus, hTTPSPortNumber=hTTPSPortNumber, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, receiveChannel=receiveChannel, dataPortFiberStatusTrap=dataPortFiberStatusTrap, channelACableLength=channelACableLength, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPVersion=iPVersion, channelBCableLength=channelBCableLength, supplementary=supplementary, subnetMask=subnetMask, incompatibleRegionCodes=incompatibleRegionCodes, securityLevel=securityLevel, signalStrengthRatio=signalStrengthRatio, qOSPriorityScheme=qOSPriorityScheme, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, vectorError=vectorError, receiveFreqKHz=receiveFreqKHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPollInterval=sNTPPollInterval, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, managementPortStatus=managementPortStatus, tDDControl=tDDControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelSelection=telecomsChannelSelection, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, sNTPServerStatus=sNTPServerStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, ptp=ptp, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyControl=phyControl, softwareVersion=softwareVersion, channelALoopbackTrap=channelALoopbackTrap, channelBLoopbackTrap=channelBLoopbackTrap, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, linkSymmetry=linkSymmetry, sNTPServerTableIndex=sNTPServerTableIndex, bootVersion=bootVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerRetries=sNTPServerRetries, secureModeAlarmTrap=secureModeAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteInternetAddressType=remoteInternetAddressType, channelALineCode=channelALineCode, vLANManagementPriority=vLANManagementPriority, masterSlaveMode=masterSlaveMode, regionCodeTrap=regionCodeTrap, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, resetGroup=resetGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, alarms=alarms, installArmState=installArmState, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping)
