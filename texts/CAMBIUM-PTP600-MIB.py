...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", secureModeAlarmTrap=secureModeAlarmTrap, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, ethernetFiberSupport=ethernetFiberSupport, syslogControl=syslogControl, range=range, syslogClient=syslogClient, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hAZLOCConfiguration=hAZLOCConfiguration, dataPortFiberStatus=dataPortFiberStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, subnetMask=subnetMask, tDDControl=tDDControl, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogState=syslogState, linkLoss=linkLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, dfs=dfs, supplementaryGroup=supplementaryGroup, ethernetBridgingStatus=ethernetBridgingStatus, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqKHz=transmitFreqKHz, channelBLoopbackTrap=channelBLoopbackTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxColorCode=rxColorCode, sNTPSync=sNTPSync, channelBLineCode=channelBLineCode, alarms=alarms, telecomsInterface=telecomsInterface, hardwareVersion=hardwareVersion, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, smtpGroup=smtpGroup, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, targetRange=targetRange, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6Address=iPv6Address, installArmState=installArmState, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, securityLevel=securityLevel, iPv4Address=iPv4Address, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortStatusTrap=managementPortStatusTrap, automaticTxPowerControl=automaticTxPowerControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, productVariant=productVariant, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, channelALoopbackTrap=channelALoopbackTrap, targetMACAddress=targetMACAddress, sNTPLastSync=sNTPLastSync, smtp=smtp, ptpCompliance=ptpCompliance, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installStatus=installStatus, userTable=userTable, remoteInternetAddress=remoteInternetAddress, sNTPServerRetries=sNTPServerRetries, accessMethod=accessMethod, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, bridgeGroup=bridgeGroup, channelBLoopback=channelBLoopback, dfsTable=dfsTable, phyStatusGroup=phyStatusGroup, sNMPTrapVersion=sNMPTrapVersion, userTableNumber=userTableNumber, transmitPower=transmitPower, managementPortDisabledWarning=managementPortDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, installStatusTrap=installStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTable=sNTPServerTable, snmpControl=snmpControl, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPPortNumber=sNMPPortNumber, userName=userName, cableLoss=cableLoss, telecomsChannelAStatus=telecomsChannelAStatus, iPv6GatewayAddress=iPv6GatewayAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alarmsGroup=alarmsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPCommunityString=sNMPCommunityString, encryption=encryption, sNTPPrimaryServer=sNTPPrimaryServer, userPassword=userPassword, telnetAccessEnabled=telnetAccessEnabled, localPacketFiltering=localPacketFiltering, channelALineCode=channelALineCode, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerStatus=sNTPServerStatus, sNTPServerTimeout=sNTPServerTimeout, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, syslogClientTrap=syslogClientTrap, phyControlGroup=phyControlGroup, configuration=configuration, pubStats=pubStats, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, iPVersion=iPVersion, receiveModulationMode=receiveModulationMode, latitude=latitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridge=bridge, channelACableLength=channelACableLength, systemReset=systemReset, sNMPTrapInternetAddress=sNMPTrapInternetAddress, siteName=siteName, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTableIndex=dfsTableIndex, rangingMode=rangingMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernet=ethernet, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, sNTPServerTableNumber=sNTPServerTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, supplementary=supplementary, receivePower=receivePower, wirelessLinkAvailability=wirelessLinkAvailability, qOSPriorityScheme=qOSPriorityScheme, tDDControlGroup=tDDControlGroup, syslogControlGroup=syslogControlGroup, dSCPManagementPriority=dSCPManagementPriority, receiveFreqMHz=receiveFreqMHz, managementGroup=managementGroup, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, softwareVersion=softwareVersion, byteErrorRatio=byteErrorRatio, userTableIndex=userTableIndex, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, searchState=searchState, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, signalStrengthRatio=signalStrengthRatio, dataPortStatus=dataPortStatus, versions=versions, telecomsChannelSelection=telecomsChannelSelection, productName=productName, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, sNTPServerPortNumber=sNTPServerPortNumber, installArmStateTrap=installArmStateTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, regionCode=regionCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteRxTargetPower=remoteRxTargetPower, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableIndex=sNTPServerTableIndex, licenceGroup=licenceGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableNumber=dfsTableNumber, ptp=ptp, sNMPv3Enable=sNMPv3Enable, frequencyVariant=frequencyVariant, reset=reset, encryptionGroup=encryptionGroup, rawReceivePower=rawReceivePower, phyStatus=phyStatus, managementPortStatus=managementPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, daylightSaving=daylightSaving, dfsTableEntry=dfsTableEntry, eIRP=eIRP, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetPriorityTable=ethernetPriorityTable, notificationsGroup=notificationsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vectorError=vectorError, sMTPServerInternetAddress=sMTPServerInternetAddress, timeZone=timeZone, bootVersion=bootVersion, sNTPSyncTrap=sNTPSyncTrap, channelBCableLength=channelBCableLength, ptp600=ptp600, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementMode=managementMode, sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, dfsGroup=dfsGroup, channelALoopback=channelALoopback, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, secureModeAlarm=secureModeAlarm, txColorCode=txColorCode, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, versionsGroup=versionsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomGroup=telecomGroup, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
