...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelALoopback=channelALoopback, sMTPServerPortNumber=sMTPServerPortNumber, smtpGroup=smtpGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, productVariant=productVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv6PrefixLength=iPv6PrefixLength, installArmStateTrap=installArmStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, eIRP=eIRP, supplementaryGroup=supplementaryGroup, channelACableLength=channelACableLength, hTTPPortNumber=hTTPPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, latitude=latitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementMode=managementMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, telecom=telecom, sNTPState=sNTPState, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, ptp=ptp, vLANManagementPriority=vLANManagementPriority, transmitModulationMode=transmitModulationMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetFiberSupport=ethernetFiberSupport, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, encryption=encryption, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPLastSync=sNTPLastSync, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, userPassword=userPassword, channelBCableLength=channelBCableLength, sNTPPollInterval=sNTPPollInterval, transmitDataRate=transmitDataRate, rawReceivePower=rawReceivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, userTableNumber=userTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, alarmsGroup=alarmsGroup, userTable=userTable, ethernetBridgingStatus=ethernetBridgingStatus, phyStatus=phyStatus, regionCode=regionCode, automaticTxPowerControl=automaticTxPowerControl, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerTableNumber=sNTPServerTableNumber, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, accessMethod=accessMethod, sNTPServerStatus=sNTPServerStatus, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, cableLoss=cableLoss, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, telecomsChannelBStatus=telecomsChannelBStatus, userEnabled=userEnabled, ptpGroups=ptpGroups, rangingMode=rangingMode, receiveFreqMHz=receiveFreqMHz, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, versions=versions, syslogControl=syslogControl, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, hAZLOCConfiguration=hAZLOCConfiguration, targetRange=targetRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortDisabledWarning=managementPortDisabledWarning, management=management, dataPortDisabledWarning=dataPortDisabledWarning, sntp=sntp, rxColorCode=rxColorCode, channelALoopbackTrap=channelALoopbackTrap, snmpControl=snmpControl, secureModeAlarm=secureModeAlarm, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyControl=phyControl, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, managementPortStatusTrap=managementPortStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, securityLevel=securityLevel, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationMode=tDDSynchronizationMode, altitude=altitude, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortAutoMdix=dataPortAutoMdix, dfsPeaks=dfsPeaks, telecomsInterface=telecomsInterface, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitPower=transmitPower, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, channelBLoopback=channelBLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControlGroup=snmpControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, resetGroup=resetGroup, remoteIPAddress=remoteIPAddress, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqMHz=transmitFreqMHz, daylightSaving=daylightSaving, sNMPv3Enable=sNMPv3Enable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vectorError=vectorError, receiveChannel=receiveChannel, systemClock=systemClock, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, productName=productName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, syslogClientTrap=syslogClientTrap, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv4Address=iPv4Address, configurationGroup=configurationGroup, licenceGroup=licenceGroup, phyControlGroup=phyControlGroup, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableEntry=dfsTableEntry, installStatus=installStatus, localPacketFiltering=localPacketFiltering, linkLoss=linkLoss, licence=licence, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableIndex=sNMPTrapTableIndex, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, aAAControlGroup=aAAControlGroup, l2CPPriorityTable=l2CPPriorityTable, telnetAccessEnabled=telnetAccessEnabled, syslogState=syslogState, syslogClient=syslogClient, signalStrengthRatio=signalStrengthRatio, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, ptp600=ptp600, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRate=receiveDataRate, longitude=longitude, bridgeGroup=bridgeGroup, tDDControlGroup=tDDControlGroup, channelALineCode=channelALineCode, sNTPServerPortNumber=sNTPServerPortNumber, managementGroup=managementGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, dfsMeans=dfsMeans, installStatusTrap=installStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelBLineCode=channelBLineCode, bootVersion=bootVersion, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSync=sNTPSync, tDDControl=tDDControl, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, installArmState=installArmState, telecomsChannelSelection=telecomsChannelSelection, tFTPServerIPAddress=tFTPServerIPAddress, bridge=bridge, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, reset=reset, sNMPTrapTable=sNMPTrapTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryptionGroup=encryptionGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, dataPortFiberStatus=dataPortFiberStatus, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, iPv6GatewayAddress=iPv6GatewayAddress, alarms=alarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqKHz=receiveFreqKHz, sNTPServerTableEntry=sNTPServerTableEntry, searchState=searchState, remoteRxTargetPower=remoteRxTargetPower, telnetPortNumber=telnetPortNumber, supplementary=supplementary)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6Address=iPv6Address, remoteInternetAddress=remoteInternetAddress, ptpCompliance=ptpCompliance, txColorCode=txColorCode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, hardwareVersion=hardwareVersion, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNMPPortNumber=sNMPPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cambium=cambium, pubStatsGroup=pubStatsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, linkSymmetry=linkSymmetry, managementPortStatus=managementPortStatus, versionsGroup=versionsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfs=dfs, dSCPManagementPriority=dSCPManagementPriority, byteErrorRatio=byteErrorRatio, receivePower=receivePower, notificationsGroup=notificationsGroup, sntpGroup=sntpGroup, siteName=siteName, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkName=linkName, aggregateDataRate=aggregateDataRate)
