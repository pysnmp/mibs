...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, daylightSaving=daylightSaving, vLANManagementVID=vLANManagementVID, sNTPServerStatus=sNTPServerStatus, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, snmpControl=snmpControl, txColorCode=txColorCode, receiveFreqMHz=receiveFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, cableLoss=cableLoss, timeZone=timeZone, bridgeGroup=bridgeGroup, siteName=siteName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, management=management, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpTraps=ptpTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTable=userTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, receivePower=receivePower, encryption=encryption, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControl=syslogControl, l2CPPriorityTable=l2CPPriorityTable, installArmStateTrap=installArmStateTrap, telnetAccessEnabled=telnetAccessEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, bridge=bridge, configuration=configuration, phyStatusGroup=phyStatusGroup, regionCodeTrap=regionCodeTrap, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPVersion=iPVersion, telecomsChannelSelection=telecomsChannelSelection, sntpGroup=sntpGroup, linkName=linkName, dfsMeans=dfsMeans, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, reset=reset, telecom=telecom, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, eIRP=eIRP, unitOutOfCalibration=unitOutOfCalibration, dfsTableIndex=dfsTableIndex, iPv6Address=iPv6Address, sNTPServerTimeout=sNTPServerTimeout, transmitFreqKHz=transmitFreqKHz, userTableEntry=userTableEntry, encryptionAlgorithm=encryptionAlgorithm, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPower=transmitPower, aAAControl=aAAControl, transmitChannel=transmitChannel, dfsTableNumber=dfsTableNumber, remoteRxTargetPower=remoteRxTargetPower, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sntp=sntp, receiveDataRate=receiveDataRate, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productName=productName, userTableNumber=userTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, byteErrorRatio=byteErrorRatio, notificationsGroup=notificationsGroup, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, ptpCompliance=ptpCompliance, resetGroup=resetGroup, ethernetPriorityTable=ethernetPriorityTable, alarmsGroup=alarmsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkSymmetry=linkSymmetry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteInternetAddressType=remoteInternetAddressType, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, dfs=dfs, installStatusTrap=installStatusTrap, smtp=smtp, dataPortStatus=dataPortStatus, dataPortAutoMdix=dataPortAutoMdix, managementPortConfigurationMismatch=managementPortConfigurationMismatch, latitude=latitude, channelBandwidth=channelBandwidth, snmpControlGroup=snmpControlGroup, channelACableLength=channelACableLength, ethernetGroup=ethernetGroup, bootVersion=bootVersion, rxColorCode=rxColorCode, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, vectorError=vectorError, sMTPEmailAlert=sMTPEmailAlert, receiveModulationMode=receiveModulationMode, targetRange=targetRange, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, iPv4Address=iPv4Address, phyControl=phyControl, secureModeAlarm=secureModeAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteInternetAddress=remoteInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTable=sNTPServerTable, telecomsChannelBStatus=telecomsChannelBStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, productVariant=productVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsTable=dfsTable, userName=userName, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBCableLength=channelBCableLength, sNTPServerRetries=sNTPServerRetries, syslogState=syslogState, regionCode=regionCode, automaticTxPowerControl=automaticTxPowerControl, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, ethernetPriorityTableIndex=ethernetPriorityTableIndex, supplementary=supplementary, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, userRole=userRole, searchState=searchState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPLastSync=sNTPLastSync, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, channelBLoopback=channelBLoopback, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv6GatewayAddress=iPv6GatewayAddress, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, altitude=altitude, secondarySoftwareVersion=secondarySoftwareVersion, ptp600=ptp600, wirelessLinkAvailability=wirelessLinkAvailability, managementMode=managementMode, signalStrengthRatio=signalStrengthRatio, sNTPServerPortNumber=sNTPServerPortNumber, channelALoopbackTrap=channelALoopbackTrap, hTTPPortNumber=hTTPPortNumber, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, tDDControlGroup=tDDControlGroup, rangingMode=rangingMode, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, securityLevel=securityLevel, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, rawReceivePower=rawReceivePower, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, hAZLOCConfiguration=hAZLOCConfiguration, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableIndex=sNTPServerTableIndex, ptp=ptp, systemReset=systemReset, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secureModeAlarmTrap=secureModeAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, frequencyVariant=frequencyVariant, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSync=sNTPSync, systemClock=systemClock, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBLineCode=channelBLineCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, subnetMask=subnetMask, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, accessMethod=accessMethod, managementPortWirelessDownAlert=managementPortWirelessDownAlert, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, pubStatsGroup=pubStatsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, range=range, receiveChannel=receiveChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", groupID=groupID, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortFiberStatus=dataPortFiberStatus, ethernetFiberSupport=ethernetFiberSupport, longitude=longitude, ethernetBridgingAvailability=ethernetBridgingAvailability, channelALoopback=channelALoopback, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortStatus=managementPortStatus, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, channelALineCode=channelALineCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dfsPeaks=dfsPeaks, sNTPState=sNTPState, iPDSCPPriorityTable=iPDSCPPriorityTable, telecomsChannelAStatus=telecomsChannelAStatus, channelChangeTrap=channelChangeTrap, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, supplementaryGroup=supplementaryGroup, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, cambium=cambium, tDDControl=tDDControl, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bandwidthVariant=bandwidthVariant, ptpGroups=ptpGroups, userTableIndex=userTableIndex, userPassword=userPassword, installStatus=installStatus, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
