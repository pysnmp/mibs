...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitFreqMHz=transmitFreqMHz, management=management, ptp=ptp, frequencyVariant=frequencyVariant, licence=licence, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, iPv6PrefixLength=iPv6PrefixLength, phyControlGroup=phyControlGroup, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hardwareVersion=hardwareVersion, channelBLoopbackTrap=channelBLoopbackTrap, transmitDataRate=transmitDataRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, versions=versions, remoteInternetAddress=remoteInternetAddress, telecomGroup=telecomGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6Address=iPv6Address, linkModeOptimisation=linkModeOptimisation, maximumTransmitPower=maximumTransmitPower, remoteRxTargetPower=remoteRxTargetPower, linkName=linkName, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementGroup=managementGroup, range=range, secureModeAlarm=secureModeAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, transmitPower=transmitPower, linkLoss=linkLoss, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, dataPortAutoMdix=dataPortAutoMdix, vLANManagementVID=vLANManagementVID, installStatus=installStatus, sNTPState=sNTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveChannel=receiveChannel, transmitChannel=transmitChannel, pubStatsGroup=pubStatsGroup, sMTPEmailAlert=sMTPEmailAlert, productVariant=productVariant, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, channelChangeTrap=channelChangeTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptpGroups=ptpGroups, dfsPeaks=dfsPeaks, phyStatus=phyStatus, antennaGain=antennaGain, channelACableLength=channelACableLength, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, vectorError=vectorError, userPassword=userPassword, telecomsChannelAStatus=telecomsChannelAStatus, groupID=groupID, dfsTableIndex=dfsTableIndex, ptp600=ptp600, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, targetMACAddress=targetMACAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receivePower=receivePower, transmitFreqKHz=transmitFreqKHz, sNTPPollInterval=sNTPPollInterval, userName=userName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, dfs=dfs, cambium=cambium, rawReceivePower=rawReceivePower, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, reset=reset, aAAControlGroup=aAAControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, localPacketFiltering=localPacketFiltering, resetGroup=resetGroup, iPv6GatewayAddress=iPv6GatewayAddress, dfsMeans=dfsMeans, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productName=productName, bridgeGroup=bridgeGroup, gatewayIPAddress=gatewayIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBLoopback=channelBLoopback, cableLoss=cableLoss, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userRole=userRole, systemClock=systemClock, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPSync=sNTPSync, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTableEntry=sNTPServerTableEntry, ethernet=ethernet, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, channelBCableLength=channelBCableLength, tDDControl=tDDControl, securityLevel=securityLevel, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, eIRP=eIRP, tDDSynchronizationMode=tDDSynchronizationMode, installArmStateTrap=installArmStateTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTimeout=sNTPServerTimeout, sntp=sntp, supplementaryGroup=supplementaryGroup, aAAControl=aAAControl, iPv4Address=iPv4Address, txColorCode=txColorCode, siteName=siteName, managementPortStatus=managementPortStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelBLineCode=channelBLineCode, targetRange=targetRange, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, regionCodeTrap=regionCodeTrap, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, managementMode=managementMode, pubStats=pubStats, alarms=alarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, accessMethod=accessMethod, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, softwareVersion=softwareVersion, latitude=latitude, sNTPServerRetries=sNTPServerRetries, aggregateDataRate=aggregateDataRate, rxColorCode=rxColorCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, daylightSaving=daylightSaving, sNTPServerTable=sNTPServerTable, dataPortDisabledWarning=dataPortDisabledWarning, telecomsInterface=telecomsInterface, ethernetPriorityTableIndex=ethernetPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, regionCode=regionCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, channelBandwidth=channelBandwidth, syslogClientTrap=syslogClientTrap, channelALoopback=channelALoopback, dataPortStatus=dataPortStatus, ethernetBridgingStatus=ethernetBridgingStatus, sNMPEnabledTraps=sNMPEnabledTraps, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, altitude=altitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptmp=ptmp, iPVersion=iPVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, dfsGroup=dfsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versionsGroup=versionsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, dSCPManagementPriority=dSCPManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelSelection=telecomsChannelSelection, byteErrorRatio=byteErrorRatio, licenceGroup=licenceGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityTable=l2CPPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecom=telecom, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, userEnabled=userEnabled, automaticTxPowerControl=automaticTxPowerControl, sNTPServerInternetAddress=sNTPServerInternetAddress, configurationGroup=configurationGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControl=phyControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPPortNumber=hTTPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, channelALineCode=channelALineCode, qOSPriorityScheme=qOSPriorityScheme, receiveFreqMHz=receiveFreqMHz, signalStrengthRatio=signalStrengthRatio, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, secondarySoftwareVersion=secondarySoftwareVersion, bootVersion=bootVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, receiveFreqKHz=receiveFreqKHz, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, telnetPortNumber=telnetPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsTable=dfsTable, sNTPServerStatus=sNTPServerStatus, masterSlaveMode=masterSlaveMode, snmpControlGroup=snmpControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, bridge=bridge, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rangingMode=rangingMode, channelALoopbackTrap=channelALoopbackTrap, sNMPPortNumber=sNMPPortNumber, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, encryption=encryption, syslogClient=syslogClient, tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
