...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapTable=sNMPTrapTable, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsMeans=dfsMeans, linkModeOptimizationMismatch=linkModeOptimizationMismatch, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, telnetPortNumber=telnetPortNumber, userPassword=userPassword, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveFreqMHz=receiveFreqMHz, iPv4Address=iPv4Address, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, rxColorCode=rxColorCode, byteErrorRatio=byteErrorRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp=ptp, bandwidthVariant=bandwidthVariant, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimisation=linkModeOptimisation, installStatus=installStatus, ptpTrapPrefix=ptpTrapPrefix, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, dfs=dfs, telecomsChannelBStatus=telecomsChannelBStatus, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveFreqKHz=receiveFreqKHz, sNTPServerStatus=sNTPServerStatus, transmitFreqKHz=transmitFreqKHz, managementGroup=managementGroup, smtpGroup=smtpGroup, reset=reset, supplementaryGroup=supplementaryGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBLineCode=channelBLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, dataPortStatus=dataPortStatus, phyStatus=phyStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetGroup=ethernetGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, aAAControlGroup=aAAControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, ptp600=ptp600, ethernetBridgingStatus=ethernetBridgingStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTimeout=sNTPServerTimeout, systemReset=systemReset, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtp=smtp, tDDControlGroup=tDDControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, daylightSaving=daylightSaving, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALoopback=channelALoopback, transmitFreqMHz=transmitFreqMHz, sNTPServerTable=sNTPServerTable, transmitDataRate=transmitDataRate, managementPortStatusTrap=managementPortStatusTrap, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, targetRange=targetRange, hAZLOCConfiguration=hAZLOCConfiguration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, txColorCode=txColorCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, vLANManagementVID=vLANManagementVID, bootVersion=bootVersion, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secureModeAlarmTrap=secureModeAlarmTrap, syslogState=syslogState, phyStatusGroup=phyStatusGroup, productVariant=productVariant, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomGroup=telecomGroup, telecom=telecom, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, productName=productName, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNTPState=sNTPState, channelALineCode=channelALineCode, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, cableLoss=cableLoss, vLANManagementPriority=vLANManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, sMTPEmailAlert=sMTPEmailAlert, subnetMask=subnetMask, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelBCableLength=channelBCableLength, hardwareVersion=hardwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBLoopback=channelBLoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, sNMPPortNumber=sNMPPortNumber, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatus=telecomsChannelAStatus, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, targetMACAddress=targetMACAddress, altitude=altitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rangingMode=rangingMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomsInterface=telecomsInterface, iPVersion=iPVersion, sNMPv3Enable=sNMPv3Enable, sNTPServerRetries=sNTPServerRetries, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, dSCPManagementPriority=dSCPManagementPriority, receiveChannel=receiveChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, masterSlaveMode=masterSlaveMode, sntpGroup=sntpGroup, latitude=latitude, channelBLoopbackTrap=channelBLoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPrimaryServer=sNTPPrimaryServer, channelACableLength=channelACableLength, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControl=syslogControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, accessMethod=accessMethod, managementMode=managementMode, frequencyVariant=frequencyVariant, encryptionGroup=encryptionGroup, aAAControl=aAAControl, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, automaticTxPowerControl=automaticTxPowerControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, configuration=configuration, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, vectorError=vectorError, tDDControl=tDDControl, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControl=snmpControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelBandwidth=channelBandwidth, dfsPeaks=dfsPeaks, supplementary=supplementary, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, longitude=longitude, channelALoopbackTrap=channelALoopbackTrap, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogStateTrap=syslogStateTrap, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, hTTPAccessEnabled=hTTPAccessEnabled, licence=licence, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, softwareVersion=softwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, range=range, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, management=management, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortAutoMdix=dataPortAutoMdix, dataPortFiberStatus=dataPortFiberStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkSymmetry=linkSymmetry, rawReceivePower=rawReceivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, regionCodeTrap=regionCodeTrap, searchState=searchState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, groupID=groupID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, receiveModulationMode=receiveModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, secureModeAlarm=secureModeAlarm, channelChangeTrap=channelChangeTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, alarmsGroup=alarmsGroup, managementPortStatus=managementPortStatus, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, bridge=bridge, ptpTraps=ptpTraps, remoteInternetAddressType=remoteInternetAddressType, securityLevel=securityLevel, iPv6Address=iPv6Address, systemClock=systemClock, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsGroup=dfsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", versionsGroup=versionsGroup, linkName=linkName, sNTPServerTableIndex=sNTPServerTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userRole=userRole, installArmState=installArmState, siteName=siteName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, localPacketFiltering=localPacketFiltering, syslogClient=syslogClient, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, userName=userName, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, notificationsGroup=notificationsGroup, antennaGain=antennaGain, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteRxTargetPower=remoteRxTargetPower, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryption=encryption, userTable=userTable, ptpCompliance=ptpCompliance, remoteInternetAddress=remoteInternetAddress, telecomsChannelSelection=telecomsChannelSelection, pubStats=pubStats, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, versions=versions, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, bridgeGroup=bridgeGroup, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityTable=ethernetPriorityTable, gatewayIPAddress=gatewayIPAddress, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControl=phyControl)
