...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, remoteRxTargetPower=remoteRxTargetPower, softwareVersion=softwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, linkLoss=linkLoss, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, siteName=siteName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelBLoopbackTrap=channelBLoopbackTrap, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, linkModeOptimisation=linkModeOptimisation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementGroup=managementGroup, tDDControlGroup=tDDControlGroup, rangingMode=rangingMode, licence=licence, sntp=sntp, iPv4Address=iPv4Address, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTable=sNTPServerTable, telnetPortNumber=telnetPortNumber, reset=reset, encryption=encryption, targetRange=targetRange, hardwareVersion=hardwareVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBLoopback=channelBLoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bridgeGroup=bridgeGroup, channelALoopback=channelALoopback, wirelessLinkAvailability=wirelessLinkAvailability, ethernetGroup=ethernetGroup, aggregateDataRate=aggregateDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, phyStatusGroup=phyStatusGroup, iPv6PrefixLength=iPv6PrefixLength, ethernetFiberSupport=ethernetFiberSupport, smtpGroup=smtpGroup, groupID=groupID, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, sNMPPortNumber=sNMPPortNumber, vectorError=vectorError, managementPortDisabledWarning=managementPortDisabledWarning, snmpControl=snmpControl, automaticTxPowerControl=automaticTxPowerControl, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, dfsMeans=dfsMeans, dfsTableIndex=dfsTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitPower=transmitPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableLoss=cableLoss, telecomsChannelSelection=telecomsChannelSelection, productName=productName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitDataRate=transmitDataRate, txColorCode=txColorCode, channelBCableLength=channelBCableLength, snmpControlGroup=snmpControlGroup, l2CPPriorityTable=l2CPPriorityTable, userTable=userTable, syslogControl=syslogControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv6GatewayAddress=iPv6GatewayAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, alarms=alarms, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, byteErrorRatio=byteErrorRatio, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, masterSlaveMode=masterSlaveMode, channelBLineCode=channelBLineCode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telnetAccessEnabled=telnetAccessEnabled, configuration=configuration, tDDSynchronizationStatus=tDDSynchronizationStatus, daylightSaving=daylightSaving, installStatus=installStatus, regionCode=regionCode, receivePower=receivePower, phyStatus=phyStatus, sntpGroup=sntpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptp=ptp, eIRP=eIRP, hTTPPortNumber=hTTPPortNumber, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortStatus=dataPortStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userName=userName, userEnabled=userEnabled, phyControl=phyControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, securityLevel=securityLevel, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, versions=versions, receiveChannel=receiveChannel, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPState=sNTPState, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerStatus=sNTPServerStatus, userTableIndex=userTableIndex, iPv6Address=iPv6Address, ethernet=ethernet, dfsTableEntry=dfsTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, ptp600=ptp600, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitModulationMode=transmitModulationMode, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, cambium=cambium, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, management=management, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityTable=mPLSTCPriorityTable, gatewayIPAddress=gatewayIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, licenceGroup=licenceGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyControlGroup=phyControlGroup, timeZone=timeZone, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelAStatus=telecomsChannelAStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSync=sNTPSync, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, bridge=bridge, sNMPEnabledTraps=sNMPEnabledTraps, channelACableLength=channelACableLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, smtp=smtp, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDControl=tDDControl, dfsPeaks=dfsPeaks, channelBandwidth=channelBandwidth, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPLastSync=sNTPLastSync, sNTPServerTimeout=sNTPServerTimeout, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installArmState=installArmState, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, managementMode=managementMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, dfs=dfs, pubStats=pubStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxColorCode=rxColorCode, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarm=secureModeAlarm, bootVersion=bootVersion, remoteInternetAddressType=remoteInternetAddressType, sNTPPollInterval=sNTPPollInterval, accessMethod=accessMethod, managementPortStatusTrap=managementPortStatusTrap, dataPortStatusTrap=dataPortStatusTrap, managementPortStatus=managementPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, syslogClient=syslogClient, remoteIPAddress=remoteIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, syslogState=syslogState, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, sNTPServerRetries=sNTPServerRetries, transmitFreqKHz=transmitFreqKHz, ptpGroups=ptpGroups, userRole=userRole, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsInterface=telecomsInterface, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, rawReceivePower=rawReceivePower, resetGroup=resetGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, localPacketFiltering=localPacketFiltering, channelALineCode=channelALineCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", pubStatsGroup=pubStatsGroup, frequencyVariant=frequencyVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomGroup=telecomGroup, userPassword=userPassword, syslogClientTrap=syslogClientTrap, bandwidthVariant=bandwidthVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, receiveModulationMode=receiveModulationMode, vLANManagementVID=vLANManagementVID, dataPortFiberStatus=dataPortFiberStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkSymmetry=linkSymmetry, sNTPServerTableEntry=sNTPServerTableEntry, ptpTrapPrefix=ptpTrapPrefix, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, range=range, sNTPServerTableNumber=sNTPServerTableNumber, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, alarmsGroup=alarmsGroup, userTableEntry=userTableEntry, supplementaryGroup=supplementaryGroup, aAAControlGroup=aAAControlGroup, receiveDataRate=receiveDataRate, searchState=searchState, altitude=altitude, qOSPriorityScheme=qOSPriorityScheme, dfsTable=dfsTable, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkName=linkName, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityTable=ethernetPriorityTable, systemClock=systemClock)
