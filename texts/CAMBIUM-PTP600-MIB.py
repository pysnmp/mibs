...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableEntry=userTableEntry, timeZone=timeZone, channelBLineCode=channelBLineCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPPrimaryServer=sNTPPrimaryServer, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortStatus=managementPortStatus, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableIndex=userTableIndex, licenceGroup=licenceGroup, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secureModeAlarm=secureModeAlarm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPSync=sNTPSync, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, encryptionAlgorithm=encryptionAlgorithm, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, cableLoss=cableLoss, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, productName=productName, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, management=management, sMTPServerIPAddress=sMTPServerIPAddress, channelBCableLength=channelBCableLength, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6PrefixLength=iPv6PrefixLength, sNMPv3Enable=sNMPv3Enable, ptpGroups=ptpGroups, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, rawReceivePower=rawReceivePower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerIPAddress=tFTPServerIPAddress, remoteRxTargetPower=remoteRxTargetPower, installArmStateTrap=installArmStateTrap, telecomsChannelBStatus=telecomsChannelBStatus, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogStateTrap=syslogStateTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, linkLoss=linkLoss, configuration=configuration, transmitChannel=transmitChannel, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, sNTPSyncTrap=sNTPSyncTrap, secureModeAlarmTrap=secureModeAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, txColorCode=txColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, channelALoopbackTrap=channelALoopbackTrap, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6Address=iPv6Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, ptpTrapPrefix=ptpTrapPrefix, receiveFreqKHz=receiveFreqKHz, sNTPState=sNTPState, encryptionGroup=encryptionGroup, sNTPServerRetries=sNTPServerRetries, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, userTable=userTable, bridge=bridge, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, ptpTraps=ptpTraps, masterSlaveMode=masterSlaveMode, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, syslogState=syslogState, sMTPServerPortNumber=sMTPServerPortNumber, encryption=encryption, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, managementPortStatusTrap=managementPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, notificationsGroup=notificationsGroup, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationMode=tDDSynchronizationMode, pubStatsGroup=pubStatsGroup, dfs=dfs, subnetMask=subnetMask, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, channelBLoopbackTrap=channelBLoopbackTrap, ethernet=ethernet, remoteInternetAddressType=remoteInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, telecomsChannelSelection=telecomsChannelSelection, incompatibleRegionCodes=incompatibleRegionCodes, qOSPriorityScheme=qOSPriorityScheme, dataPortAutoMdix=dataPortAutoMdix, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, userEnabled=userEnabled, ethernetPriorityTable=ethernetPriorityTable, ptpCompliance=ptpCompliance, dataPortFiberStatusTrap=dataPortFiberStatusTrap, channelBandwidth=channelBandwidth, remoteIPAddress=remoteIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveChannel=receiveChannel, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsTable=dfsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, altitude=altitude, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControlGroup=phyControlGroup, alarmsGroup=alarmsGroup, ptp600=ptp600, phyStatus=phyStatus, configurationGroup=configurationGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecom=telecom, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, hTTPPortNumber=hTTPPortNumber, rxColorCode=rxColorCode, supplementaryGroup=supplementaryGroup, vLANManagementPriority=vLANManagementPriority, snmpControl=snmpControl, channelALineCode=channelALineCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userRole=userRole, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, byteErrorRatio=byteErrorRatio, automaticTxPowerControl=automaticTxPowerControl, latitude=latitude, regionCodeTrap=regionCodeTrap, syslogClient=syslogClient, userPassword=userPassword, alarms=alarms, channelBLoopback=channelBLoopback, dfsTableIndex=dfsTableIndex, remoteInternetAddress=remoteInternetAddress, gatewayIPAddress=gatewayIPAddress, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, hardwareVersion=hardwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, securityLevel=securityLevel, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bridgeGroup=bridgeGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitPower=transmitPower, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, phyControl=phyControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, groupID=groupID, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, ethernetBridgingAvailability=ethernetBridgingAvailability, installArmState=installArmState, localPacketFiltering=localPacketFiltering, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemClock=systemClock, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPVersion=iPVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, siteName=siteName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, sntp=sntp, antennaGain=antennaGain, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, transmitDataRate=transmitDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, pubStats=pubStats, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bandwidthVariant=bandwidthVariant, rangingMode=rangingMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomGroup=telecomGroup, iPv4Address=iPv4Address, sntpGroup=sntpGroup, linkName=linkName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogControl=syslogControl, searchState=searchState, ptmp=ptmp, channelALoopback=channelALoopback, managementMode=managementMode, dataPortFiberStatus=dataPortFiberStatus, phyStatusGroup=phyStatusGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, resetGroup=resetGroup, regionCode=regionCode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableNumber=userTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, reset=reset, accessMethod=accessMethod, vectorError=vectorError)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveModulationModeDetail=receiveModulationModeDetail, range=range, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, licence=licence, dfsPeaks=dfsPeaks, receivePower=receivePower, wirelessLinkAvailability=wirelessLinkAvailability, targetMACAddress=targetMACAddress, linkModeOptimisation=linkModeOptimisation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, sNTPServerTable=sNTPServerTable, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, l2CPPriorityTableIndex=l2CPPriorityTableIndex, smtpGroup=smtpGroup, channelACableLength=channelACableLength, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelAStatus=telecomsChannelAStatus, userName=userName, aggregateDataRate=aggregateDataRate, targetRange=targetRange, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, systemReset=systemReset, daylightSaving=daylightSaving, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, versionsGroup=versionsGroup, installStatus=installStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aAAControl=aAAControl, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode)
