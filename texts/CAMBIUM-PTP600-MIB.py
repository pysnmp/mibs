...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxColorCode=rxColorCode, userTableNumber=userTableNumber, sNTPServerTable=sNTPServerTable, targetMACAddress=targetMACAddress, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, dfsTableEntry=dfsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, masterSlaveMode=masterSlaveMode, userName=userName, sNTPServerIPAddress=sNTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, ethernetGroup=ethernetGroup, PYSNMP_MODULE_ID=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, receiveDataRate=receiveDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetBridgingAvailability=ethernetBridgingAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, regionCodeTrap=regionCodeTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, vLANManagementVID=vLANManagementVID, wirelessLinkStatus=wirelessLinkStatus, licence=licence, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitDataRate=transmitDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userRole=userRole, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, altitude=altitude, alarmsGroup=alarmsGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControl=syslogControl, cambium=cambium, txColorCode=txColorCode, notificationsGroup=notificationsGroup, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, siteName=siteName, range=range, channelBandwidth=channelBandwidth, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, frequencyVariant=frequencyVariant, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementMode=managementMode, channelACableLength=channelACableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveChannel=receiveChannel, ethernetPriorityTable=ethernetPriorityTable, userTableEntry=userTableEntry, channelALineCode=channelALineCode, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, sNTPServerStatus=sNTPServerStatus, aAAControlGroup=aAAControlGroup, dataPortStatus=dataPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, iPv4Address=iPv4Address, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelALoopbackTrap=channelALoopbackTrap, installStatus=installStatus, managementPortStatusTrap=managementPortStatusTrap, accessMethod=accessMethod, telecom=telecom, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv6Address=iPv6Address, userPassword=userPassword, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, bridgeGroup=bridgeGroup, receiveFreqKHz=receiveFreqKHz, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, managementPortStatus=managementPortStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, management=management, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableEntry=sNTPServerTableEntry, smtp=smtp, cableLoss=cableLoss, rangingMode=rangingMode, alarms=alarms, securityLevel=securityLevel, automaticTxPowerControl=automaticTxPowerControl, syslogClient=syslogClient, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, productVariant=productVariant, l2CPPriorityTable=l2CPPriorityTable, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControl=aAAControl, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, targetRange=targetRange, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpTraps=ptpTraps, dfsTable=dfsTable, managementPortDisabledWarning=managementPortDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, userTableIndex=userTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, channelBLoopback=channelBLoopback, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimisation=linkModeOptimisation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, productName=productName, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, reset=reset, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, versions=versions, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPv6PrefixLength=iPv6PrefixLength, longitude=longitude, dSCPManagementPriority=dSCPManagementPriority, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, channelBLoopbackTrap=channelBLoopbackTrap, sNMPv3Enable=sNMPv3Enable, dfs=dfs, telecomsChannelSelection=telecomsChannelSelection, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, eIRP=eIRP, installArmState=installArmState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, secureModeAlarm=secureModeAlarm, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, l2CPPriorityTableNumber=l2CPPriorityTableNumber, pubStats=pubStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, linkLoss=linkLoss, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, sntpGroup=sntpGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, ethernetBridgingStatus=ethernetBridgingStatus, telecomsInterface=telecomsInterface, channelBLineCode=channelBLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenceGroup=licenceGroup, userTable=userTable, transmitModulationMode=transmitModulationMode, syslogControlGroup=syslogControlGroup, sNTPPrimaryServer=sNTPPrimaryServer, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, sNMPTrapTable=sNMPTrapTable, syslogClientTrap=syslogClientTrap, groupID=groupID, hAZLOCConfiguration=hAZLOCConfiguration, ptp=ptp, telecomsChannelBStatus=telecomsChannelBStatus, sNMPEnabledTraps=sNMPEnabledTraps, dfsMeans=dfsMeans, bridge=bridge, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, dataPortFiberStatus=dataPortFiberStatus, regionCode=regionCode, localPacketFiltering=localPacketFiltering, tDDControl=tDDControl, rawReceivePower=rawReceivePower, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryption=encryption, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALoopback=channelALoopback, telecomsChannelAStatus=telecomsChannelAStatus, snmpControlGroup=snmpControlGroup, transmitChannel=transmitChannel, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, searchState=searchState, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, vectorError=vectorError)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBCableLength=channelBCableLength, configurationGroup=configurationGroup, telecomGroup=telecomGroup, linkSymmetry=linkSymmetry, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDDControlGroup=tDDControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp600=ptp600, transmitFreqKHz=transmitFreqKHz, dfsTableIndex=dfsTableIndex, iPVersion=iPVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secureModeAlarmTrap=secureModeAlarmTrap, phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteInternetAddress=remoteInternetAddress, remoteRxTargetPower=remoteRxTargetPower, linkName=linkName, phyStatusGroup=phyStatusGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, subnetMask=subnetMask, resetGroup=resetGroup, qOSPriorityScheme=qOSPriorityScheme, sNMPPortNumber=sNMPPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, byteErrorRatio=byteErrorRatio, channelChangeTrap=channelChangeTrap, ethernet=ethernet)
