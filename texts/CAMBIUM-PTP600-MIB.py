...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:53:21 2021
...
ObjectIdentity, Counter64, Bits, Unsigned32, enterprises, Counter32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, IpAddress, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "enterprises", "Counter32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, receiveFreqMHz=receiveFreqMHz, securityLevel=securityLevel, ptmp=ptmp, snmpControl=snmpControl, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, siteName=siteName, qOSPriorityScheme=qOSPriorityScheme, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsChannelBStatus=telecomsChannelBStatus, phyStatus=phyStatus, telecomGroup=telecomGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, tDDControlGroup=tDDControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, supplementary=supplementary, unitOutOfCalibration=unitOutOfCalibration, secondarySoftwareVersion=secondarySoftwareVersion, bandwidthVariant=bandwidthVariant, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, configurationGroup=configurationGroup, longitude=longitude, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, notificationsGroup=notificationsGroup, dfsGroup=dfsGroup, ptpTraps=ptpTraps, transmitModulationMode=transmitModulationMode, ethernetBridgingStatus=ethernetBridgingStatus, regionCodeTrap=regionCodeTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, syslogState=syslogState, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, reset=reset, dfsMeans=dfsMeans, cambium=cambium, aAAControl=aAAControl, dfsTableIndex=dfsTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, automaticTxPowerControl=automaticTxPowerControl, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, installArmStateTrap=installArmStateTrap, managementPortStatusTrap=managementPortStatusTrap, remoteInternetAddressType=remoteInternetAddressType, sNTPPollInterval=sNTPPollInterval, ethernetGroup=ethernetGroup, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelSelection=telecomsChannelSelection, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bootVersion=bootVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userName=userName, sNTPServerTimeout=sNTPServerTimeout, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, remoteIPAddress=remoteIPAddress, channelALoopback=channelALoopback, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licence=licence, dataPortStatus=dataPortStatus, maximumTransmitPower=maximumTransmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, transmitChannel=transmitChannel, secureModeAlarm=secureModeAlarm, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, bridgeGroup=bridgeGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6GatewayAddress=iPv6GatewayAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarms=alarms, userTable=userTable, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSyncTrap=sNTPSyncTrap, daylightSaving=daylightSaving, userTableNumber=userTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenceGroup=licenceGroup, vLANManagementVID=vLANManagementVID, smtp=smtp, l2CPPriorityTable=l2CPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, sNTPState=sNTPState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqKHz=transmitFreqKHz, iPv6PrefixLength=iPv6PrefixLength, byteErrorRatio=byteErrorRatio, configuration=configuration, channelChangeTrap=channelChangeTrap, resetGroup=resetGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBLoopback=channelBLoopback, ptp600=ptp600, productName=productName, vectorError=vectorError, telecom=telecom, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, installStatusTrap=installStatusTrap, sNTPServerStatus=sNTPServerStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsPeaks=dfsPeaks, transmitFreqMHz=transmitFreqMHz, versions=versions, searchState=searchState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, pubStats=pubStats, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernet=ethernet, managementPortStatus=managementPortStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoMdix=dataPortAutoMdix, hTTPSPortNumber=hTTPSPortNumber, aAAControlGroup=aAAControlGroup, iPv4Address=iPv4Address, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyControlGroup=phyControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, hAZLOCConfiguration=hAZLOCConfiguration, latitude=latitude, dfsTable=dfsTable, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, telecomsChannelAStatus=telecomsChannelAStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, PYSNMP_MODULE_ID=cambium, syslogClient=syslogClient, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPAccessEnabled=hTTPAccessEnabled, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, bridge=bridge, eIRP=eIRP, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, encryptionGroup=encryptionGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelBCableLength=channelBCableLength, versionsGroup=versionsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, subnetMask=subnetMask, ptpCompliance=ptpCompliance, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, management=management, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, sntpGroup=sntpGroup, antennaGain=antennaGain, receiveDataRate=receiveDataRate, channelBLoopbackTrap=channelBLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, targetRange=targetRange, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableIndex=userTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, rxColorCode=rxColorCode, secureModeAlarmTrap=secureModeAlarmTrap, encryption=encryption, channelALineCode=channelALineCode, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntp=sntp, sNTPServerTable=sNTPServerTable, txColorCode=txColorCode, groupID=groupID, userPassword=userPassword, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, sNTPPrimaryServer=sNTPPrimaryServer, sNMPv3Enable=sNMPv3Enable, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSync=sNTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, localPacketFiltering=localPacketFiltering, sNTPServerTableNumber=sNTPServerTableNumber, dfsTableNumber=dfsTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, dataPortFiberStatus=dataPortFiberStatus, altitude=altitude, receivePower=receivePower, sNTPServerRetries=sNTPServerRetries, sNMPPortNumber=sNMPPortNumber, rangingMode=rangingMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6Address=iPv6Address, tDDControl=tDDControl, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControl=phyControl, rawReceivePower=rawReceivePower, accessMethod=accessMethod, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, softwareVersion=softwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveChannel=receiveChannel)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userRole=userRole, dfs=dfs, telecomsInterface=telecomsInterface, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, transmitPower=transmitPower, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPVersion=iPVersion, phyStatusGroup=phyStatusGroup, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleRegionCodes=incompatibleRegionCodes, systemReset=systemReset, channelACableLength=channelACableLength, telnetAccessEnabled=telnetAccessEnabled, syslogStateTrap=syslogStateTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelALoopbackTrap=channelALoopbackTrap, linkSymmetry=linkSymmetry, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, dataPortDisabledWarning=dataPortDisabledWarning, targetMACAddress=targetMACAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteInternetAddress=remoteInternetAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelBLineCode=channelBLineCode, range=range, receiveFreqKHz=receiveFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogControl=syslogControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, installStatus=installStatus, channelBandwidth=channelBandwidth, pubStatsGroup=pubStatsGroup, managementMode=managementMode, ethernetFiberSupport=ethernetFiberSupport)
