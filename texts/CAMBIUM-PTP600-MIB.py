...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, localPacketFiltering=localPacketFiltering, ethernetGroup=ethernetGroup, installStatus=installStatus, ptp=ptp, regionCode=regionCode, dataPortAutoMdix=dataPortAutoMdix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, sNMPv3Enable=sNMPv3Enable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, channelALineCode=channelALineCode, channelACableLength=channelACableLength, remoteRxTargetPower=remoteRxTargetPower, sNTPServerTableNumber=sNTPServerTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userTableNumber=userTableNumber, dfs=dfs, sNTPServerTable=sNTPServerTable, sNTPServerRetries=sNTPServerRetries, userRole=userRole, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, masterSlaveMode=masterSlaveMode, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDControl=tDDControl, dfsTableEntry=dfsTableEntry, ethernet=ethernet, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, ptp600=ptp600, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, bootVersion=bootVersion, transmitChannel=transmitChannel, bridgeGroup=bridgeGroup, syslogState=syslogState, managementMode=managementMode, telecomsChannelSelection=telecomsChannelSelection, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveFreqKHz=receiveFreqKHz, channelBCableLength=channelBCableLength, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogStateTrap=syslogStateTrap, telnetPortNumber=telnetPortNumber, targetRange=targetRange, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6Address=iPv6Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, rawReceivePower=rawReceivePower, linkName=linkName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, productVariant=productVariant, dfsGroup=dfsGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogClientTrap=syslogClientTrap, userTable=userTable, reset=reset, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, encryptionGroup=encryptionGroup, groupID=groupID, configurationGroup=configurationGroup, sNTPServerTableEntry=sNTPServerTableEntry, transmitFreqMHz=transmitFreqMHz, ptmp=ptmp, versionsGroup=versionsGroup, remoteInternetAddressType=remoteInternetAddressType, sMTPServerIPAddress=sMTPServerIPAddress, altitude=altitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, dfsTable=dfsTable, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, aAAControl=aAAControl, ethernetPriorityTable=ethernetPriorityTable, systemReset=systemReset, installStatusTrap=installStatusTrap, dSCPManagementPriority=dSCPManagementPriority, sntpGroup=sntpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, userEnabled=userEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, licence=licence, receivePower=receivePower, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, latitude=latitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, vLANManagementVID=vLANManagementVID, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveDataRate=receiveDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANManagementPriority=vLANManagementPriority, management=management, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPState=sNTPState, longitude=longitude, secureModeAlarm=secureModeAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingStatus=ethernetBridgingStatus, channelALoopbackTrap=channelALoopbackTrap, bridge=bridge, timeZone=timeZone, resetGroup=resetGroup, versions=versions, sMTPServerInternetAddress=sMTPServerInternetAddress, telecom=telecom, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, licenceGroup=licenceGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, linkModeOptimisation=linkModeOptimisation, syslogClient=syslogClient, userName=userName, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPv4Address=iPv4Address, range=range, dataPortDisabledWarning=dataPortDisabledWarning, ptpGroups=ptpGroups, supplementaryGroup=supplementaryGroup, userTableIndex=userTableIndex, syslogControl=syslogControl, channelBLoopbackTrap=channelBLoopbackTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomGroup=telecomGroup, sNMPEnabledTraps=sNMPEnabledTraps, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelBStatus=telecomsChannelBStatus, hAZLOCConfiguration=hAZLOCConfiguration, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, regionCodeTrap=regionCodeTrap, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, pubStatsGroup=pubStatsGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, tDDControlGroup=tDDControlGroup, phyStatus=phyStatus, daylightSaving=daylightSaving, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, l2CPPriorityTable=l2CPPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower, ptpTraps=ptpTraps, dfsMeans=dfsMeans, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, eIRP=eIRP, sNTPServerInternetAddressType=sNTPServerInternetAddressType, bandwidthVariant=bandwidthVariant, dataPortFiberStatus=dataPortFiberStatus, managementPortDisabledWarning=managementPortDisabledWarning, automaticTxPowerControl=automaticTxPowerControl, configuration=configuration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, accessMethod=accessMethod, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsPeaks=dfsPeaks, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryption=encryption, syslogControlGroup=syslogControlGroup, installArmState=installArmState, receiveModulationMode=receiveModulationMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cableLoss=cableLoss, securityLevel=securityLevel, rxColorCode=rxColorCode, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hardwareVersion=hardwareVersion, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBLineCode=channelBLineCode, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteInternetAddress=remoteInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receiveFreqMHz=receiveFreqMHz, iPVersion=iPVersion, secureModeAlarmTrap=secureModeAlarmTrap, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, targetMACAddress=targetMACAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6PrefixLength=iPv6PrefixLength, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, alarms=alarms, managementPortStatus=managementPortStatus, alarmsGroup=alarmsGroup, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, rangingMode=rangingMode, productName=productName, sNMPTrapVersion=sNMPTrapVersion, sNTPServerStatus=sNTPServerStatus, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, siteName=siteName, channelBLoopback=channelBLoopback, telecomsChannelAStatus=telecomsChannelAStatus, channelALoopback=channelALoopback, managementGroup=managementGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementary=supplementary, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControl=phyControl, ptpTrapPrefix=ptpTrapPrefix, txColorCode=txColorCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError)
