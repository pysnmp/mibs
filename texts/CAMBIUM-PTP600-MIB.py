...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, userTableNumber=userTableNumber, sNTPLastSync=sNTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortStatusTrap=dataPortStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, longitude=longitude, frequencyVariant=frequencyVariant, userTableIndex=userTableIndex, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelBStatus=telecomsChannelBStatus, channelBLoopback=channelBLoopback, targetRange=targetRange, linkLoss=linkLoss, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarning=dataPortDisabledWarning, userPassword=userPassword, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userTableEntry=userTableEntry, encryption=encryption, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, automaticTxPowerControl=automaticTxPowerControl, transmitFreqMHz=transmitFreqMHz, localPacketFiltering=localPacketFiltering, dataPortFiberStatusTrap=dataPortFiberStatusTrap, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, eIRP=eIRP, managementPortDisabledWarning=managementPortDisabledWarning, tDDControlGroup=tDDControlGroup, subnetMask=subnetMask, phyStatus=phyStatus, qOSPriorityScheme=qOSPriorityScheme, configuration=configuration, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogState=syslogState, licenceGroup=licenceGroup, smtpGroup=smtpGroup, groupID=groupID, iPVersion=iPVersion, hTTPSPortNumber=hTTPSPortNumber, configurationGroup=configurationGroup, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, resetGroup=resetGroup, remoteRxTargetPower=remoteRxTargetPower, dfsPeaks=dfsPeaks, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, syslogControl=syslogControl, altitude=altitude, management=management, syslogStateTrap=syslogStateTrap, snmpControlGroup=snmpControlGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, bootVersion=bootVersion, supplementaryGroup=supplementaryGroup, versions=versions, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, alarms=alarms, sNTPServerTableEntry=sNTPServerTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteInternetAddressType=remoteInternetAddressType, latitude=latitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, linkSymmetry=linkSymmetry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarmsGroup=alarmsGroup, transmitChannel=transmitChannel, supplementary=supplementary, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, bridge=bridge, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapVersion=sNMPTrapVersion, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, managementPortStatus=managementPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, dfs=dfs, telnetPortNumber=telnetPortNumber, ethernet=ethernet, encryptionAlgorithm=encryptionAlgorithm, dSCPManagementPriority=dSCPManagementPriority, licence=licence, channelACableLength=channelACableLength, ptpTraps=ptpTraps, versionsGroup=versionsGroup, channelALoopbackTrap=channelALoopbackTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bridgeGroup=bridgeGroup, telecomsChannelSelection=telecomsChannelSelection, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, rxColorCode=rxColorCode, daylightSaving=daylightSaving, snmpControl=snmpControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementMode=managementMode, secureModeAlarm=secureModeAlarm, systemReset=systemReset, aAAControlGroup=aAAControlGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, siteName=siteName, cambium=cambium, sntpGroup=sntpGroup, reset=reset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortFiberStatus=dataPortFiberStatus, systemClock=systemClock, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, sNTPServerTableIndex=sNTPServerTableIndex, targetMACAddress=targetMACAddress, ptpGroups=ptpGroups, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, bandwidthVariant=bandwidthVariant, channelALineCode=channelALineCode, regionCodeTrap=regionCodeTrap, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, range=range, receivePower=receivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBCableLength=channelBCableLength, mPLSTCPriorityTable=mPLSTCPriorityTable, notificationsGroup=notificationsGroup, antennaGain=antennaGain, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTable=userTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTrapPrefix=ptpTrapPrefix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTable=dfsTable, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, secureModeAlarmTrap=secureModeAlarmTrap, channelALoopback=channelALoopback, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, sNMPPortNumber=sNMPPortNumber, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityTable=ethernetPriorityTable, rawReceivePower=rawReceivePower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, pubStatsGroup=pubStatsGroup, sNTPServerRetries=sNTPServerRetries, ptp=ptp, encryptionGroup=encryptionGroup, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableNumber=dfsTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStats=pubStats, receiveDataRate=receiveDataRate, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv4Address=iPv4Address, searchState=searchState, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, userName=userName, dfsGroup=dfsGroup, installStatus=installStatus, vLANManagementVID=vLANManagementVID, l2CPPriorityTableEntry=l2CPPriorityTableEntry, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, telecomsInterface=telecomsInterface, sNTPServerStatus=sNTPServerStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSync=sNTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rangingMode=rangingMode, ethernetBridgingStatus=ethernetBridgingStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBLoopbackTrap=channelBLoopbackTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitDataRate=transmitDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telnetAccessEnabled=telnetAccessEnabled, smtp=smtp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, vectorError=vectorError, remoteIPAddress=remoteIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, securityLevel=securityLevel, txColorCode=txColorCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControl=tDDControl, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hAZLOCConfiguration=hAZLOCConfiguration, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp600=ptp600, accessMethod=accessMethod, sNMPTrapTable=sNMPTrapTable, receiveFreqMHz=receiveFreqMHz, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, productName=productName, timeZone=timeZone, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, sNTPPrimaryServer=sNTPPrimaryServer, managementGroup=managementGroup, userEnabled=userEnabled, channelBLineCode=channelBLineCode, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveFreqKHz=receiveFreqKHz, aggregateDataRate=aggregateDataRate, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState)
