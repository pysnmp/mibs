...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmState=installArmState, targetRange=targetRange, receiveChannel=receiveChannel, securityLevel=securityLevel, ptmp=ptmp, iPv6PrefixLength=iPv6PrefixLength, pubStatsGroup=pubStatsGroup, aAAControl=aAAControl, sntpGroup=sntpGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, subnetMask=subnetMask, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, frequencyVariant=frequencyVariant, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, ethernet=ethernet, channelALoopback=channelALoopback, userTableNumber=userTableNumber, transmitChannel=transmitChannel, hardwareVersion=hardwareVersion, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, qOSPriorityScheme=qOSPriorityScheme, versionsGroup=versionsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteInternetAddressType=remoteInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userEnabled=userEnabled, iPv6Address=iPv6Address, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, txColorCode=txColorCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, eIRP=eIRP, managementPortStatus=managementPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userRole=userRole, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, channelALineCode=channelALineCode, secureModeAlarmTrap=secureModeAlarmTrap, remoteIPAddress=remoteIPAddress, dataPortFiberStatus=dataPortFiberStatus, installStatus=installStatus, iPVersion=iPVersion, syslogClientTrap=syslogClientTrap, ethernetBridgingStatus=ethernetBridgingStatus, cambium=cambium, dfsMeans=dfsMeans, bridge=bridge, transmitPower=transmitPower, bridgeGroup=bridgeGroup, hTTPAccessEnabled=hTTPAccessEnabled, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, channelBLoopback=channelBLoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkSymmetry=linkSymmetry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTable=l2CPPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControl=tDDControl, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, telecomsChannelSelection=telecomsChannelSelection, searchState=searchState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, bootVersion=bootVersion, dfsTableEntry=dfsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqMHz=transmitFreqMHz, aAAControlGroup=aAAControlGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTableIndex=sNTPServerTableIndex, licenceGroup=licenceGroup, supplementaryGroup=supplementaryGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableNumber=sNTPServerTableNumber, phyStatus=phyStatus, phyControlGroup=phyControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, syslogStateTrap=syslogStateTrap, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, resetGroup=resetGroup, managementPortDisabledWarning=managementPortDisabledWarning, sntp=sntp, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, dfs=dfs, signalStrengthRatio=signalStrengthRatio, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, sNTPServerTimeout=sNTPServerTimeout, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, snmpControlGroup=snmpControlGroup, encryptionAlgorithm=encryptionAlgorithm, maximumTransmitPower=maximumTransmitPower, transmitFreqKHz=transmitFreqKHz, dataPortStatus=dataPortStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, smtp=smtp, pubStats=pubStats, masterSlaveMode=masterSlaveMode, vectorError=vectorError, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelACableLength=channelACableLength, tDDControlGroup=tDDControlGroup, sNTPServerTable=sNTPServerTable, ptp600=ptp600, telnetPortNumber=telnetPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, longitude=longitude, iPv6GatewayAddress=iPv6GatewayAddress, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, telnetAccessEnabled=telnetAccessEnabled, encryptionGroup=encryptionGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dSCPManagementPriority=dSCPManagementPriority, channelBCableLength=channelBCableLength, alarmsGroup=alarmsGroup, accessMethod=accessMethod, sNTPServerStatus=sNTPServerStatus, channelBLoopbackTrap=channelBLoopbackTrap, altitude=altitude, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBLineCode=channelBLineCode, receiveFreqKHz=receiveFreqKHz, bandwidthVariant=bandwidthVariant, timeZone=timeZone, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, ptpGroups=ptpGroups, hAZLOCConfiguration=hAZLOCConfiguration, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveDataRate=receiveDataRate, sNTPPrimaryServer=sNTPPrimaryServer, sNTPState=sNTPState, snmpControl=snmpControl, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleRegionCodes=incompatibleRegionCodes, telecom=telecom, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPEmailAlert=sMTPEmailAlert, syslogClient=syslogClient, managementGroup=managementGroup, remoteInternetAddress=remoteInternetAddress, productName=productName, sNMPTrapTable=sNMPTrapTable, sNTPSyncTrap=sNTPSyncTrap, ptpCompliance=ptpCompliance, receiveModulationMode=receiveModulationMode, linkModeOptimisation=linkModeOptimisation, telecomGroup=telecomGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, channelBandwidth=channelBandwidth, telecomsChannelAStatus=telecomsChannelAStatus, receiveFreqMHz=receiveFreqMHz, syslogControlGroup=syslogControlGroup, ptp=ptp, reset=reset, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, localPacketFiltering=localPacketFiltering, userPassword=userPassword, daylightSaving=daylightSaving, syslogControl=syslogControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, rawReceivePower=rawReceivePower, latitude=latitude, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, alarms=alarms, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkLoss=linkLoss, managementMode=managementMode, dfsPeaks=dfsPeaks, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, rangingMode=rangingMode, systemReset=systemReset, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelALoopbackTrap=channelALoopbackTrap, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rxColorCode=rxColorCode, licence=licence, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkAvailability=wirelessLinkAvailability, phyControl=phyControl, iPv4Address=iPv4Address, siteName=siteName, range=range, dfsTableIndex=dfsTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsInterface=telecomsInterface, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, userTable=userTable, secureModeAlarm=secureModeAlarm, dfsGroup=dfsGroup, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, automaticTxPowerControl=automaticTxPowerControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityTable=ethernetPriorityTable, userTableIndex=userTableIndex, management=management, ethernetGroup=ethernetGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerRetries=sNTPServerRetries, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps)
