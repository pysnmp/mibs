...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, targetRange=targetRange, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, encryptionAlgorithm=encryptionAlgorithm, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerStatus=sNTPServerStatus, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, iPv6GatewayAddress=iPv6GatewayAddress, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPState=sNTPState, linkSymmetry=linkSymmetry, installArmState=installArmState, syslogState=syslogState, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsPeaks=dfsPeaks, reset=reset, ptpGroups=ptpGroups, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelALineCode=channelALineCode, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelALoopback=channelALoopback, smtp=smtp, syslogClient=syslogClient, linkName=linkName, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsInterface=telecomsInterface, channelBCableLength=channelBCableLength, regionCode=regionCode, ethernetFiberSupport=ethernetFiberSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, noWirelessChannelAvailable=noWirelessChannelAvailable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClientTrap=syslogClientTrap, versions=versions, aAAControl=aAAControl, frequencyVariant=frequencyVariant, linkLoss=linkLoss, ethernetBridgingAvailability=ethernetBridgingAvailability, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, range=range, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, daylightSaving=daylightSaving, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, iPVersion=iPVersion, localPacketFiltering=localPacketFiltering, sNTPSync=sNTPSync, iPv6Address=iPv6Address, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, rxColorCode=rxColorCode, syslogStateTrap=syslogStateTrap, dSCPManagementPriority=dSCPManagementPriority, encryptionGroup=encryptionGroup, byteErrorRatio=byteErrorRatio, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControlGroup=aAAControlGroup, userName=userName, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, l2CPPriorityTable=l2CPPriorityTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTimeout=sNTPServerTimeout, phyControlGroup=phyControlGroup, bridgeGroup=bridgeGroup, configurationGroup=configurationGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, bridge=bridge, productVariant=productVariant, ptpCompliance=ptpCompliance, syslogControl=syslogControl, alarmsGroup=alarmsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, siteName=siteName, remoteInternetAddress=remoteInternetAddress, remoteRxTargetPower=remoteRxTargetPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortStatus=dataPortStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetBridgingStatus=ethernetBridgingStatus, transmitChannel=transmitChannel, constantPowerSpectralDensity=constantPowerSpectralDensity, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rawReceivePower=rawReceivePower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpTraps=ptpTraps, channelBLoopback=channelBLoopback, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, dfsTableEntry=dfsTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableNumber=dfsTableNumber, userTable=userTable, licence=licence, channelBLineCode=channelBLineCode, securityLevel=securityLevel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, latitude=latitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementMode=managementMode, installArmStateTrap=installArmStateTrap, userPassword=userPassword, channelBLoopbackTrap=channelBLoopbackTrap, sMTPEmailAlert=sMTPEmailAlert, installStatusTrap=installStatusTrap, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, management=management, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemReset=systemReset, telecomsChannelBStatus=telecomsChannelBStatus, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, groupID=groupID, receiveModulationMode=receiveModulationMode, smtpGroup=smtpGroup, remoteInternetAddressType=remoteInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, telecomGroup=telecomGroup, sntp=sntp, rangingMode=rangingMode, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementGroup=managementGroup, notificationsGroup=notificationsGroup, sNTPPollInterval=sNTPPollInterval, iPv6PrefixLength=iPv6PrefixLength, telnetPortNumber=telnetPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cambium=cambium, eIRP=eIRP, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, tDDControl=tDDControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTable=dfsTable, dfsMeans=dfsMeans, masterSlaveMode=masterSlaveMode, managementPortStatus=managementPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationMode=tDDSynchronizationMode, resetGroup=resetGroup, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, supplementary=supplementary, productName=productName, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, tDDControlGroup=tDDControlGroup, vLANManagementPriority=vLANManagementPriority, receiveFreqMHz=receiveFreqMHz, sNTPServerTableNumber=sNTPServerTableNumber, transmitDataRate=transmitDataRate, telecomsChannelSelection=telecomsChannelSelection, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, configuration=configuration, longitude=longitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hAZLOCConfiguration=hAZLOCConfiguration, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityTable=ethernetPriorityTable, hardwareVersion=hardwareVersion, searchState=searchState, secureModeAlarmTrap=secureModeAlarmTrap, PYSNMP_MODULE_ID=cambium, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptmp=ptmp, licenceGroup=licenceGroup, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, iPDSCPPriorityTable=iPDSCPPriorityTable, softwareVersion=softwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTable=sNMPTrapTable, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, sNTPServerTable=sNTPServerTable, snmpControl=snmpControl, targetMACAddress=targetMACAddress, versionsGroup=versionsGroup, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, vectorError=vectorError, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernet=ethernet, accessMethod=accessMethod, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelACableLength=channelACableLength, txColorCode=txColorCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, altitude=altitude, sntpGroup=sntpGroup, ptp600=ptp600, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitModulationMode=transmitModulationMode, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, timeZone=timeZone, ptp=ptp, supplementaryGroup=supplementaryGroup, secureModeAlarm=secureModeAlarm, tFTPServerPortNumber=tFTPServerPortNumber, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, encryption=encryption, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, mPLSTCPriorityTable=mPLSTCPriorityTable)
