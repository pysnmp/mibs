...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, encryptionGroup=encryptionGroup, transmitModulationMode=transmitModulationMode, sNTPServerRetries=sNTPServerRetries, receiveModulationModeDetail=receiveModulationModeDetail, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, smtp=smtp, dSCPManagementPriority=dSCPManagementPriority, linkLoss=linkLoss, dfsPeaks=dfsPeaks, securityLevel=securityLevel, softwareVersion=softwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, rxColorCode=rxColorCode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteRxTargetPower=remoteRxTargetPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, secureModeAlarmTrap=secureModeAlarmTrap, telecomsInterface=telecomsInterface, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, localPacketFiltering=localPacketFiltering, sNTPServerIPAddress=sNTPServerIPAddress, smtpGroup=smtpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryption=encryption, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementPortDisabledWarning=managementPortDisabledWarning, receiveModulationMode=receiveModulationMode, syslogState=syslogState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receivePower=receivePower, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelChangeTrap=channelChangeTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPState=sNTPState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTable=dfsTable, sNTPServerInternetAddress=sNTPServerInternetAddress, telecomGroup=telecomGroup, transmitPower=transmitPower, rangingMode=rangingMode, sNTPServerTable=sNTPServerTable, hTTPSPortNumber=hTTPSPortNumber, ethernetFiberSupport=ethernetFiberSupport, channelALineCode=channelALineCode, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControlGroup=syslogControlGroup, transmitChannel=transmitChannel, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, dataPortStatusTrap=dataPortStatusTrap, ptp600=ptp600, licence=licence, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsMeans=dfsMeans, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSync=sNTPSync, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetPortNumber=telnetPortNumber, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, tDDControlGroup=tDDControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetGroup=ethernetGroup, productVariant=productVariant, targetRange=targetRange, installArmState=installArmState, ethernetPriorityTableIndex=ethernetPriorityTableIndex, masterSlaveMode=masterSlaveMode, vectorError=vectorError, userTable=userTable, channelBLoopback=channelBLoopback, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, range=range, channelALoopbackTrap=channelALoopbackTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsChannelAStatus=telecomsChannelAStatus, sNMPv3Enable=sNMPv3Enable, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkName=linkName, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6Address=iPv6Address, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBLineCode=channelBLineCode, antennaGain=antennaGain, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userTableEntry=userTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPv4Address=iPv4Address, syslogControl=syslogControl, reset=reset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, latitude=latitude, ethernetPriorityTable=ethernetPriorityTable, managementPortStatus=managementPortStatus, linkSymmetry=linkSymmetry, ethernet=ethernet, byteErrorRatio=byteErrorRatio, subnetMask=subnetMask, bridge=bridge, syslogClient=syslogClient, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sntp=sntp, telecomsChannelSelection=telecomsChannelSelection, installStatusTrap=installStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerInternetAddressType=sNTPServerInternetAddressType, accessMethod=accessMethod, userRole=userRole, dfsTableIndex=dfsTableIndex, snmpControl=snmpControl, sNTPLastSync=sNTPLastSync, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementMode=managementMode, sNTPPollInterval=sNTPPollInterval, channelALoopback=channelALoopback, ethernetBridgingAvailability=ethernetBridgingAvailability, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecom=telecom, rawReceivePower=rawReceivePower, phyControl=phyControl, remoteInternetAddress=remoteInternetAddress, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dfs=dfs, dfsTableEntry=dfsTableEntry, channelBandwidth=channelBandwidth, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, systemReset=systemReset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configurationGroup=configurationGroup, ptp=ptp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBCableLength=channelBCableLength, phyControlGroup=phyControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTable=l2CPPriorityTable, userName=userName, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, syslogClientTrap=syslogClientTrap, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, receiveFreqMHz=receiveFreqMHz, cambium=cambium, tFTPServerInternetAddress=tFTPServerInternetAddress, longitude=longitude, ptpGroups=ptpGroups, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerStatus=sNTPServerStatus, secondarySoftwareVersion=secondarySoftwareVersion, bridgeGroup=bridgeGroup, tDDControl=tDDControl, userEnabled=userEnabled, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, eIRP=eIRP, sNMPEnabledTraps=sNMPEnabledTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, remoteInternetAddressType=remoteInternetAddressType, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, installStatus=installStatus, PYSNMP_MODULE_ID=cambium, dataPortAutoMdix=dataPortAutoMdix, aAAControl=aAAControl, configuration=configuration, ptmp=ptmp, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, regionCode=regionCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, daylightSaving=daylightSaving, aAAControlGroup=aAAControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyStatus=phyStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, supplementaryGroup=supplementaryGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableIndex=sNTPServerTableIndex, pubStats=pubStats, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, dataPortDisabledWarning=dataPortDisabledWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCodeTrap=regionCodeTrap, dataPortFiberStatus=dataPortFiberStatus, installArmStateTrap=installArmStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, txColorCode=txColorCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, pubStatsGroup=pubStatsGroup, channelACableLength=channelACableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitFreqKHz=transmitFreqKHz, automaticTxPowerControl=automaticTxPowerControl, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, phyStatusGroup=phyStatusGroup, versions=versions, iPVersion=iPVersion, iPv6PrefixLength=iPv6PrefixLength, qOSPriorityScheme=qOSPriorityScheme, management=management, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, channelBLoopbackTrap=channelBLoopbackTrap, dfsGroup=dfsGroup, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, transmitDataRate=transmitDataRate, hAZLOCConfiguration=hAZLOCConfiguration, timeZone=timeZone, bootVersion=bootVersion, alarms=alarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementGroup=managementGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelBStatus=telecomsChannelBStatus, telnetAccessEnabled=telnetAccessEnabled)
