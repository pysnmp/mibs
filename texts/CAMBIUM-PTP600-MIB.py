...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", productName=productName, rawReceivePower=rawReceivePower, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, timeZone=timeZone, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionAlgorithm=encryptionAlgorithm, phyStatus=phyStatus, telecomsChannelBStatus=telecomsChannelBStatus, dfsTableNumber=dfsTableNumber, iPv6Address=iPv6Address, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBCableLength=channelBCableLength, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, configuration=configuration, installStatus=installStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTable=ethernetPriorityTable, snmpControlGroup=snmpControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, targetRange=targetRange, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, managementPortStatusTrap=managementPortStatusTrap, pubStatsGroup=pubStatsGroup, altitude=altitude, aAAControl=aAAControl, remoteInternetAddressType=remoteInternetAddressType, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyStatusGroup=phyStatusGroup, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptp=ptp, sNTPPrimaryServer=sNTPPrimaryServer, longitude=longitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBLoopbackTrap=channelBLoopbackTrap, versionsGroup=versionsGroup, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteRxTargetPower=remoteRxTargetPower, cambium=cambium, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, securityLevel=securityLevel, telecomGroup=telecomGroup, automaticTxPowerControl=automaticTxPowerControl, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelALineCode=channelALineCode, syslogStateTrap=syslogStateTrap, sMTPEmailAlert=sMTPEmailAlert, secureModeAlarmTrap=secureModeAlarmTrap, groupID=groupID, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTimeout=sNTPServerTimeout, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, telecom=telecom, channelBandwidth=channelBandwidth, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, channelBLineCode=channelBLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableIndex=sNTPServerTableIndex, smtp=smtp, dfsTableIndex=dfsTableIndex, dSCPManagementPriority=dSCPManagementPriority, alarmsGroup=alarmsGroup, sMTPServerIPAddress=sMTPServerIPAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, frequencyVariant=frequencyVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogControl=syslogControl, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, ptmp=ptmp, siteName=siteName, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, managementMode=managementMode, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelBLoopback=channelBLoopback, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, bootVersion=bootVersion, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, aAAControlGroup=aAAControlGroup, subnetMask=subnetMask, eIRP=eIRP, transmitPower=transmitPower, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, channelALoopback=channelALoopback, dfsGroup=dfsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, transmitFreqKHz=transmitFreqKHz, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, txColorCode=txColorCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, ethernet=ethernet, cableLoss=cableLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, productVariant=productVariant, receiveChannel=receiveChannel, syslogState=syslogState, receiveModulationMode=receiveModulationMode, iPv6GatewayAddress=iPv6GatewayAddress, alarms=alarms, reset=reset, incompatibleRegionCodes=incompatibleRegionCodes, userEnabled=userEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hardwareVersion=hardwareVersion, tDDControlGroup=tDDControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtpGroup=smtpGroup, qOSPriorityScheme=qOSPriorityScheme, channelACableLength=channelACableLength, hTTPSPortNumber=hTTPSPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, syslogClient=syslogClient, ptp600=ptp600, sNMPTrapTable=sNMPTrapTable, remoteIPAddress=remoteIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, telnetPortNumber=telnetPortNumber, phyControl=phyControl, regionCode=regionCode, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, userTableNumber=userTableNumber, sNTPServerTable=sNTPServerTable, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerRetries=sNTPServerRetries, licence=licence, ptpTrapPrefix=ptpTrapPrefix, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, managementPortStatus=managementPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelAStatus=telecomsChannelAStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, ethernetBridgingStatus=ethernetBridgingStatus, userTableEntry=userTableEntry, installArmStateTrap=installArmStateTrap, supplementaryGroup=supplementaryGroup, userName=userName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, channelALoopbackTrap=channelALoopbackTrap, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, hAZLOCConfiguration=hAZLOCConfiguration, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCodeTrap=regionCodeTrap, targetMACAddress=targetMACAddress, sNTPSync=sNTPSync, searchState=searchState, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitChannel=transmitChannel, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDControl=tDDControl, ptpGroups=ptpGroups, softwareVersion=softwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rangingMode=rangingMode, telecomsChannelSelection=telecomsChannelSelection, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, sntp=sntp, secureModeAlarm=secureModeAlarm, daylightSaving=daylightSaving, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteInternetAddress=remoteInternetAddress, encryption=encryption, vectorError=vectorError, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, rxColorCode=rxColorCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerStatus=sNTPServerStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenceGroup=licenceGroup, localPacketFiltering=localPacketFiltering, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqMHz=receiveFreqMHz, management=management, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, bridgeGroup=bridgeGroup, dfsTable=dfsTable, userTable=userTable, iPVersion=iPVersion, managementGroup=managementGroup, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, bandwidthVariant=bandwidthVariant, range=range, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTable=l2CPPriorityTable, encryptionGroup=encryptionGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bridge=bridge, managementPortDisabledWarning=managementPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, linkName=linkName, systemReset=systemReset, hTTPPortNumber=hTTPPortNumber, userPassword=userPassword, dataPortFiberStatus=dataPortFiberStatus, phyControlGroup=phyControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receivePower=receivePower, dfsTableEntry=dfsTableEntry, syslogControlGroup=syslogControlGroup, iPv4Address=iPv4Address, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType)
