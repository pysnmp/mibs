...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsMeans=dfsMeans, alarms=alarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatus=dataPortFiberStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteRxTargetPower=remoteRxTargetPower, rxColorCode=rxColorCode, userTableNumber=userTableNumber, ptp=ptp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, ethernetBridgingStatus=ethernetBridgingStatus, eIRP=eIRP, dataPortAutoMdix=dataPortAutoMdix, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, channelBLineCode=channelBLineCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6Address=iPv6Address, telnetPortNumber=telnetPortNumber, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, channelACableLength=channelACableLength, linkSymmetry=linkSymmetry, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, supplementaryGroup=supplementaryGroup, versions=versions, installStatus=installStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerPortNumber=sNTPServerPortNumber, regionCode=regionCode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelAStatus=telecomsChannelAStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControl=syslogControl, ptmp=ptmp, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, sNTPState=sNTPState, userPassword=userPassword, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogClient=syslogClient, sntpGroup=sntpGroup, telecomsChannelSelection=telecomsChannelSelection, syslogClientTrap=syslogClientTrap, groupID=groupID, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, localPacketFiltering=localPacketFiltering, receiveChannel=receiveChannel, frequencyVariant=frequencyVariant, sNTPPrimaryServer=sNTPPrimaryServer, channelBLoopbackTrap=channelBLoopbackTrap, managementPortStatusTrap=managementPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, managementMode=managementMode, channelALoopback=channelALoopback, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogState=syslogState, sNTPSyncTrap=sNTPSyncTrap, iPVersion=iPVersion, encryption=encryption, sNMPCommunityString=sNMPCommunityString, channelBCableLength=channelBCableLength, bridge=bridge, secureModeAlarm=secureModeAlarm, sNMPPortNumber=sNMPPortNumber, targetRange=targetRange, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bootVersion=bootVersion, txColorCode=txColorCode, transmitChannel=transmitChannel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, snmpControl=snmpControl, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControl=aAAControl, installStatusTrap=installStatusTrap, sntp=sntp, telecomsInterface=telecomsInterface, supplementary=supplementary, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpCompliance=ptpCompliance, sNMPTrapVersion=sNMPTrapVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemReset=systemReset, sNTPServerTimeout=sNTPServerTimeout, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, encryptionGroup=encryptionGroup, telecomGroup=telecomGroup, cableLoss=cableLoss, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, accessMethod=accessMethod, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableEntry=sNTPServerTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, userTable=userTable, dataPortDisabledWarning=dataPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rangingMode=rangingMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogControlGroup=syslogControlGroup, managementGroup=managementGroup, dfsTable=dfsTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, ethernetPriorityTable=ethernetPriorityTable, qOSPriorityScheme=qOSPriorityScheme, dfsTableIndex=dfsTableIndex, signalStrengthRatio=signalStrengthRatio, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6PrefixLength=iPv6PrefixLength, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cambium=cambium, incompatibleRegionCodes=incompatibleRegionCodes, searchState=searchState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, licence=licence, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, dfsPeaks=dfsPeaks, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, bandwidthVariant=bandwidthVariant, versionsGroup=versionsGroup, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, aggregateDataRate=aggregateDataRate, userName=userName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, hAZLOCConfiguration=hAZLOCConfiguration, ethernetGroup=ethernetGroup, subnetMask=subnetMask, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rawReceivePower=rawReceivePower, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerIPAddress=sNTPServerIPAddress, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aAAControlGroup=aAAControlGroup, targetMACAddress=targetMACAddress, hTTPPortNumber=hTTPPortNumber, automaticTxPowerControl=automaticTxPowerControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStatsGroup=pubStatsGroup, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, altitude=altitude, receiveModulationModeDetail=receiveModulationModeDetail, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogStateTrap=syslogStateTrap, channelBLoopback=channelBLoopback, receiveFreqKHz=receiveFreqKHz, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, linkName=linkName, managementPortStatus=managementPortStatus, userEnabled=userEnabled, sNTPSync=sNTPSync, dfsGroup=dfsGroup, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDControl=tDDControl, sNTPServerRetries=sNTPServerRetries, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, secureModeAlarmTrap=secureModeAlarmTrap, channelALineCode=channelALineCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPollInterval=sNTPPollInterval, latitude=latitude, channelALoopbackTrap=channelALoopbackTrap, bridgeGroup=bridgeGroup, userTableEntry=userTableEntry, productVariant=productVariant, dfs=dfs, productName=productName, ptp600=ptp600, noWirelessChannelAvailable=noWirelessChannelAvailable, channelChangeTrap=channelChangeTrap, phyStatus=phyStatus, resetGroup=resetGroup, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerStatus=sNTPServerStatus, sNTPServerTable=sNTPServerTable, antennaGain=antennaGain, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, regionCodeTrap=regionCodeTrap, installArmState=installArmState, ptpTraps=ptpTraps, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, notificationsGroup=notificationsGroup, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, iPv4Address=iPv4Address, ethernet=ethernet, linkModeOptimisation=linkModeOptimisation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortStatus=dataPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, systemClock=systemClock, phyControlGroup=phyControlGroup, longitude=longitude, securityLevel=securityLevel, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, vectorError=vectorError)
