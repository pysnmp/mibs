...
iso, Unsigned32, Bits, MibIdentifier, ObjectIdentity, Gauge32, IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, TimeTicks, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Bits", "MibIdentifier", "ObjectIdentity", "Gauge32", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "TimeTicks", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, reset=reset, installArmState=installArmState, snmpControlGroup=snmpControlGroup, localPacketFiltering=localPacketFiltering, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versions=versions, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, systemReset=systemReset, syslogControl=syslogControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, configuration=configuration, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortStatusTrap=managementPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerIPAddress=tFTPServerIPAddress, qOSPriorityScheme=qOSPriorityScheme, userName=userName, sNTPState=sNTPState, supplementary=supplementary, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, encryption=encryption, userEnabled=userEnabled, tDDSynchronizationMode=tDDSynchronizationMode, tDDControl=tDDControl, resetGroup=resetGroup, bootVersion=bootVersion, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTable=sNTPServerTable, bridgeGroup=bridgeGroup, cableLoss=cableLoss, iPVersion=iPVersion, wirelessLinkAvailability=wirelessLinkAvailability, syslogControlGroup=syslogControlGroup, remoteInternetAddressType=remoteInternetAddressType, telecomGroup=telecomGroup, managementPortStatus=managementPortStatus, telecomsChannelAStatus=telecomsChannelAStatus, productName=productName, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alarms=alarms, ethernetGroup=ethernetGroup, vectorError=vectorError, range=range, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, userPassword=userPassword, dfsGroup=dfsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, txColorCode=txColorCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemClock=systemClock, vLANManagementPriority=vLANManagementPriority, telecom=telecom, sntpGroup=sntpGroup, timeZone=timeZone, sNTPSyncTrap=sNTPSyncTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, userTable=userTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxColorCode=rxColorCode, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTableNumber=sNTPServerTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, tDDControlGroup=tDDControlGroup, automaticTxPowerControl=automaticTxPowerControl, dfsPeaks=dfsPeaks, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelSelection=telecomsChannelSelection, syslogState=syslogState, aAAControlGroup=aAAControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, regionCode=regionCode, iPv6GatewayAddress=iPv6GatewayAddress, rangingMode=rangingMode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, aggregateDataRate=aggregateDataRate, unitOutOfCalibration=unitOutOfCalibration, ptp600=ptp600, sNMPTrapTable=sNMPTrapTable, ethernetBridgingAvailability=ethernetBridgingAvailability, snmpControl=snmpControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetBridgingStatus=ethernetBridgingStatus, byteErrorRatio=byteErrorRatio, channelChangeTrap=channelChangeTrap, syslogStateTrap=syslogStateTrap, smtp=smtp, antennaGain=antennaGain, receiveFreqKHz=receiveFreqKHz, sntp=sntp, hAZLOCConfiguration=hAZLOCConfiguration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfs=dfs, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBLoopback=channelBLoopback, transmitPower=transmitPower, longitude=longitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTraps=ptpTraps, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userRole=userRole, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6Address=iPv6Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, sNTPServerIPAddress=sNTPServerIPAddress, installStatusTrap=installStatusTrap, managementMode=managementMode, tDDSynchronizationStatus=tDDSynchronizationStatus, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTable=dfsTable, transmitDataRate=transmitDataRate, channelBandwidth=channelBandwidth, userTableNumber=userTableNumber, dfsMeans=dfsMeans, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyStatusGroup=phyStatusGroup, siteName=siteName, ethernetFiberSupport=ethernetFiberSupport, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userTableEntry=userTableEntry, channelACableLength=channelACableLength, dfsTableNumber=dfsTableNumber, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerRetries=sNTPServerRetries, sNTPServerPortNumber=sNTPServerPortNumber, phyControl=phyControl, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableIndex=dfsTableIndex, PYSNMP_MODULE_ID=cambium, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteRxTargetPower=remoteRxTargetPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmStateTrap=installArmStateTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, phyControlGroup=phyControlGroup, supplementaryGroup=supplementaryGroup, installStatus=installStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, latitude=latitude, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versionsGroup=versionsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, productVariant=productVariant, syslogClientTrap=syslogClientTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, daylightSaving=daylightSaving, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANManagementVID=vLANManagementVID, channelBLineCode=channelBLineCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receivePower=receivePower, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, receiveModulationMode=receiveModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, bridge=bridge, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, eIRP=eIRP, sNTPServerTableEntry=sNTPServerTableEntry, bandwidthVariant=bandwidthVariant, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetRange=targetRange, groupID=groupID, management=management, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteInternetAddress=remoteInternetAddress, channelALineCode=channelALineCode, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerTimeout=sNTPServerTimeout, licence=licence, accessMethod=accessMethod, transmitChannel=transmitChannel, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, secondarySoftwareVersion=secondarySoftwareVersion, targetMACAddress=targetMACAddress, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, hTTPAccessEnabled=hTTPAccessEnabled, rawReceivePower=rawReceivePower, frequencyVariant=frequencyVariant, linkModeOptimisation=linkModeOptimisation, receiveFreqMHz=receiveFreqMHz, channelBCableLength=channelBCableLength, aAAControl=aAAControl, smtpGroup=smtpGroup, sNMPv3Enable=sNMPv3Enable, hTTPSPortNumber=hTTPSPortNumber, regionCodeTrap=regionCodeTrap, telecomsChannelBStatus=telecomsChannelBStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPPortNumber=sNMPPortNumber, configurationGroup=configurationGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, securityLevel=securityLevel, channelALoopbackTrap=channelALoopbackTrap, ptpCompliance=ptpCompliance, syslogClient=syslogClient, hTTPPortNumber=hTTPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteIPAddress=remoteIPAddress, ptmp=ptmp, iPv4Address=iPv4Address, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, sNTPSync=sNTPSync, telecomsInterface=telecomsInterface, userTableIndex=userTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenceGroup=licenceGroup, cambium=cambium, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALoopback=channelALoopback, channelBLoopbackTrap=channelBLoopbackTrap, ethernet=ethernet, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, searchState=searchState, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup)
