...
Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Gauge32, ObjectIdentity, IpAddress, enterprises, Bits, Unsigned32, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Gauge32", "ObjectIdentity", "IpAddress", "enterprises", "Bits", "Unsigned32", "Counter32", "Integer32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitPower=transmitPower, channelBandwidth=channelBandwidth, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, sNTPSync=sNTPSync, hTTPPortNumber=hTTPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBLoopback=channelBLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerTableNumber=sNTPServerTableNumber, userTableEntry=userTableEntry, cableLoss=cableLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv6Address=iPv6Address, telecomsChannelSelection=telecomsChannelSelection, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bridge=bridge, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogClientTrap=syslogClientTrap, dSCPManagementPriority=dSCPManagementPriority, aAAControl=aAAControl, installStatusTrap=installStatusTrap, telecomGroup=telecomGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelALoopbackTrap=channelALoopbackTrap, userTable=userTable, ptp=ptp, bandwidthVariant=bandwidthVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, masterSlaveMode=masterSlaveMode, iPv6PrefixLength=iPv6PrefixLength, channelACableLength=channelACableLength, receiveModulationMode=receiveModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userPassword=userPassword, frequencyVariant=frequencyVariant, targetMACAddress=targetMACAddress, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerStatus=sNTPServerStatus, dataPortAutoMdix=dataPortAutoMdix, managementPortStatus=managementPortStatus, telecom=telecom, licenceGroup=licenceGroup, range=range, transmitDataRate=transmitDataRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secureModeAlarm=secureModeAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableIndex=dfsTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, linkSymmetry=linkSymmetry, receivePower=receivePower, byteErrorRatio=byteErrorRatio, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogClient=syslogClient, rawReceivePower=rawReceivePower, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, remoteIPAddress=remoteIPAddress, transmitFreqKHz=transmitFreqKHz, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkStatus=wirelessLinkStatus, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, sNTPServerTable=sNTPServerTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, iPVersion=iPVersion, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, tDDControlGroup=tDDControlGroup, dataPortStatusTrap=dataPortStatusTrap, hardwareVersion=hardwareVersion, alarms=alarms, remoteRxTargetPower=remoteRxTargetPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, latitude=latitude, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, timeZone=timeZone, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitModulationMode=transmitModulationMode, sntpGroup=sntpGroup, wirelessLinkAvailability=wirelessLinkAvailability, regionCodeTrap=regionCodeTrap, receiveFreqKHz=receiveFreqKHz, channelALoopback=channelALoopback, dfsTableEntry=dfsTableEntry, channelALineCode=channelALineCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapTable=sNMPTrapTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, channelBCableLength=channelBCableLength, sMTPServerIPAddress=sMTPServerIPAddress, sntp=sntp, sNTPServerTableIndex=sNTPServerTableIndex, snmpControl=snmpControl, configuration=configuration, longitude=longitude, encryption=encryption, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, regionCode=regionCode, syslogState=syslogState, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsInterface=telecomsInterface, management=management, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernet=ethernet, linkName=linkName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogControl=syslogControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, rangingMode=rangingMode, dfsTableNumber=dfsTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, ptp600=ptp600, sMTPServerPortNumber=sMTPServerPortNumber, accessMethod=accessMethod, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, securityLevel=securityLevel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPState=sNTPState, smtp=smtp, productName=productName, sNTPServerRetries=sNTPServerRetries, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortStatusTrap=managementPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, receiveChannel=receiveChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, siteName=siteName, systemReset=systemReset, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPPortNumber=sNMPPortNumber, txColorCode=txColorCode, sNMPEnabledTraps=sNMPEnabledTraps, altitude=altitude, reset=reset, sNMPv3Enable=sNMPv3Enable, telnetAccessEnabled=telnetAccessEnabled, versions=versions, iPv4Address=iPv4Address, cambium=cambium, eIRP=eIRP, sMTPServerInternetAddress=sMTPServerInternetAddress, channelChangeTrap=channelChangeTrap, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelAStatus=telecomsChannelAStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqMHz=receiveFreqMHz, alarmsGroup=alarmsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, resetGroup=resetGroup, ptpCompliance=ptpCompliance, licence=licence, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, softwareVersion=softwareVersion, bootVersion=bootVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementPriority=vLANManagementPriority, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, supplementary=supplementary, dfs=dfs, targetRange=targetRange, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, supplementaryGroup=supplementaryGroup, groupID=groupID, dfsMeans=dfsMeans, dataPortStatus=dataPortStatus, ethernetGroup=ethernetGroup, sNTPPrimaryServer=sNTPPrimaryServer, telnetPortNumber=telnetPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemClock=systemClock, pubStats=pubStats, localPacketFiltering=localPacketFiltering, phyStatusGroup=phyStatusGroup, pubStatsGroup=pubStatsGroup, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aggregateDataRate=aggregateDataRate, transmitChannel=transmitChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementGroup=managementGroup, notificationsGroup=notificationsGroup, channelBLineCode=channelBLineCode, syslogControlGroup=syslogControlGroup, phyStatus=phyStatus, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, linkModeOptimisation=linkModeOptimisation, managementPortDisabledWarning=managementPortDisabledWarning, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, maximumTransmitPower=maximumTransmitPower, bridgeGroup=bridgeGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, l2CPPriorityTableIndex=l2CPPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", encryptionAlgorithm=encryptionAlgorithm, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerTimeout=sNTPServerTimeout, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddress=remoteInternetAddress, automaticTxPowerControl=automaticTxPowerControl, linkLoss=linkLoss, daylightSaving=daylightSaving, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementMode=managementMode, dataPortFiberStatus=dataPortFiberStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorError=vectorError, dfsPeaks=dfsPeaks, vLANManagementVID=vLANManagementVID, rxColorCode=rxColorCode, searchState=searchState, hTTPAccessEnabled=hTTPAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, installStatus=installStatus, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfsGroup=dfsGroup, ptpTraps=ptpTraps, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTable=dfsTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptpGroups=ptpGroups, tDDControl=tDDControl, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, l2CPPriorityTable=l2CPPriorityTable, antennaGain=antennaGain, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableNumber=userTableNumber)
