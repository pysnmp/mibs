...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aggregateDataRate=aggregateDataRate, groupID=groupID, iPVersion=iPVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, secureModeAlarm=secureModeAlarm, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, managementPortStatusTrap=managementPortStatusTrap, siteName=siteName, txColorCode=txColorCode, ethernetPriorityTable=ethernetPriorityTable, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, snmpControl=snmpControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, systemReset=systemReset, remoteIPAddress=remoteIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaGain=antennaGain, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sntpGroup=sntpGroup, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, management=management, dfsTableEntry=dfsTableEntry, dfsTableNumber=dfsTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, automaticTxPowerControl=automaticTxPowerControl, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, encryptionAlgorithm=encryptionAlgorithm, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, pubStats=pubStats, tDDControl=tDDControl, iPv6PrefixLength=iPv6PrefixLength, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, range=range, sNTPState=sNTPState, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementGroup=managementGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rxColorCode=rxColorCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBLineCode=channelBLineCode, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, rangingMode=rangingMode, userEnabled=userEnabled, encryptionGroup=encryptionGroup, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, channelALoopback=channelALoopback, sNMPTrapTable=sNMPTrapTable, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelSelection=telecomsChannelSelection, sNTPSyncTrap=sNTPSyncTrap, alarms=alarms, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, bridgeGroup=bridgeGroup, hAZLOCConfiguration=hAZLOCConfiguration, iPv6GatewayAddress=iPv6GatewayAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBCableLength=channelBCableLength, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, linkName=linkName, transmitFreqKHz=transmitFreqKHz, smtp=smtp, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv6Address=iPv6Address, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, byteErrorRatio=byteErrorRatio, receiveModulationModeDetail=receiveModulationModeDetail, productName=productName, channelALoopbackTrap=channelALoopbackTrap, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPv3Enable=sNMPv3Enable, dfsPeaks=dfsPeaks, tDDControlGroup=tDDControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, gatewayIPAddress=gatewayIPAddress, alarmsGroup=alarmsGroup, sNTPPrimaryServer=sNTPPrimaryServer, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bandwidthVariant=bandwidthVariant, secureModeAlarmTrap=secureModeAlarmTrap, transmitChannel=transmitChannel, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortAutoMdix=dataPortAutoMdix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTable=sNTPServerTable, linkModeOptimisation=linkModeOptimisation, sNTPServerTimeout=sNTPServerTimeout, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, tDDSynchronizationMode=tDDSynchronizationMode, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelBStatus=telecomsChannelBStatus, resetGroup=resetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTableIndex=sNTPServerTableIndex, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, sNTPSync=sNTPSync, pubStatsGroup=pubStatsGroup, sNMPPortNumber=sNMPPortNumber, hTTPPortNumber=hTTPPortNumber, installStatusTrap=installStatusTrap, accessMethod=accessMethod, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, maximumTransmitPower=maximumTransmitPower, bridge=bridge, signalStrengthRatio=signalStrengthRatio, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogState=syslogState, channelALineCode=channelALineCode, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, configurationGroup=configurationGroup, syslogControl=syslogControl, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, eIRP=eIRP, securityLevel=securityLevel, ethernetGroup=ethernetGroup, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerRetries=sNTPServerRetries, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, phyControl=phyControl, licence=licence, regionCode=regionCode, dfs=dfs, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installArmState=installArmState, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, latitude=latitude, ethernet=ethernet, ptpCompliance=ptpCompliance, installStatus=installStatus, longitude=longitude, userTable=userTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelACableLength=channelACableLength, smtpGroup=smtpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetBridgingStatus=ethernetBridgingStatus, vLANManagementVID=vLANManagementVID, receiveChannel=receiveChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rawReceivePower=rawReceivePower, secondarySoftwareVersion=secondarySoftwareVersion, cableLoss=cableLoss, sNTPServerStatus=sNTPServerStatus, ptp600=ptp600, managementPortDisabledWarning=managementPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, userName=userName, userTableNumber=userTableNumber, telecom=telecom, altitude=altitude, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomGroup=telecomGroup, remoteInternetAddressType=remoteInternetAddressType, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkSymmetry=linkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortStatus=dataPortStatus, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTable=l2CPPriorityTable, softwareVersion=softwareVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsGroup=dfsGroup, dfsMeans=dfsMeans, daylightSaving=daylightSaving, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, targetRange=targetRange, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClient=syslogClient, sNTPLastSync=sNTPLastSync, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptmp=ptmp, phyStatus=phyStatus, transmitDataRate=transmitDataRate, frequencyVariant=frequencyVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv4Address=iPv4Address, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, supplementary=supplementary, channelChangeTrap=channelChangeTrap, productVariant=productVariant, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, remoteRxTargetPower=remoteRxTargetPower, managementPortStatus=managementPortStatus, receiveFreqKHz=receiveFreqKHz, managementMode=managementMode, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, channelBLoopback=channelBLoopback, notificationsGroup=notificationsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, telecomsChannelAStatus=telecomsChannelAStatus, sntp=sntp, localPacketFiltering=localPacketFiltering, regionCodeTrap=regionCodeTrap, vectorError=vectorError, timeZone=timeZone, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, supplementaryGroup=supplementaryGroup, ptp=ptp, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, dSCPManagementPriority=dSCPManagementPriority)
