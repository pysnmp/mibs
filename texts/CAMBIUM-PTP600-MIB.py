...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLineCode=channelBLineCode, sNTPServerTimeout=sNTPServerTimeout, userEnabled=userEnabled, userTableNumber=userTableNumber, maximumTransmitPower=maximumTransmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPv3Enable=sNMPv3Enable, bridgeGroup=bridgeGroup, channelALoopback=channelALoopback, snmpControlGroup=snmpControlGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerStatus=sNTPServerStatus, rxColorCode=rxColorCode, encryption=encryption, sNTPServerRetries=sNTPServerRetries, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCode=regionCode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDControlGroup=tDDControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALineCode=channelALineCode, iPVersion=iPVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableIndex=l2CPPriorityTableIndex, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sntp=sntp, channelBLoopbackTrap=channelBLoopbackTrap, frequencyVariant=frequencyVariant, remoteRxTargetPower=remoteRxTargetPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, timeZone=timeZone, sNTPSyncTrap=sNTPSyncTrap, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelBCableLength=channelBCableLength, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelACableLength=channelACableLength, sNTPServerTableIndex=sNTPServerTableIndex, subnetMask=subnetMask, dSCPManagementPriority=dSCPManagementPriority, managementPortStatus=managementPortStatus, alarmsGroup=alarmsGroup, sNTPServerTableEntry=sNTPServerTableEntry, ptmp=ptmp, sNTPServerIPAddress=sNTPServerIPAddress, automaticTxPowerControl=automaticTxPowerControl, longitude=longitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenceGroup=licenceGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock, ptp=ptp, linkSymmetry=linkSymmetry, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hAZLOCConfiguration=hAZLOCConfiguration, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, ptpCompliance=ptpCompliance, telecomsChannelBStatus=telecomsChannelBStatus, eIRP=eIRP, iPv6Address=iPv6Address, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, userRole=userRole, regionCodeTrap=regionCodeTrap, productVariant=productVariant, installArmStateTrap=installArmStateTrap, channelChangeTrap=channelChangeTrap, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControlGroup=syslogControlGroup, configuration=configuration, sNTPServerPortNumber=sNTPServerPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTable=sNTPServerTable, antennaGain=antennaGain, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, sNTPState=sNTPState, management=management, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, targetRange=targetRange, userPassword=userPassword, syslogState=syslogState, managementMode=managementMode, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, remoteInternetAddressType=remoteInternetAddressType, sNTPPollInterval=sNTPPollInterval, dfs=dfs, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, bridge=bridge, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptpGroups=ptpGroups, iPDSCPPriorityTable=iPDSCPPriorityTable, searchState=searchState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rawReceivePower=rawReceivePower, bandwidthVariant=bandwidthVariant, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, smtp=smtp, sNMPCommunityString=sNMPCommunityString, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecomsInterface=telecomsInterface, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, softwareVersion=softwareVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, encryptionGroup=encryptionGroup, ptp600=ptp600, securityLevel=securityLevel, ethernetGroup=ethernetGroup, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, userTableEntry=userTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, localPacketFiltering=localPacketFiltering, accessMethod=accessMethod, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, reset=reset, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rangingMode=rangingMode, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPSAccessEnabled=hTTPSAccessEnabled, altitude=altitude, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPv6PrefixLength=iPv6PrefixLength, sNTPSync=sNTPSync, pubStatsGroup=pubStatsGroup, targetMACAddress=targetMACAddress, supplementary=supplementary, resetGroup=resetGroup, dataPortFiberStatus=dataPortFiberStatus, sntpGroup=sntpGroup, hardwareVersion=hardwareVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogControl=syslogControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, channelBLoopback=channelBLoopback, installStatusTrap=installStatusTrap, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteInternetAddress=remoteInternetAddress, unitOutOfCalibration=unitOutOfCalibration, dfsMeans=dfsMeans, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetFiberSupport=ethernetFiberSupport, channelALoopbackTrap=channelALoopbackTrap, userTable=userTable, cableLoss=cableLoss, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimisation=linkModeOptimisation, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, syslogClient=syslogClient, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receiveModulationMode=receiveModulationMode, telecom=telecom, managementGroup=managementGroup, managementPortStatusTrap=managementPortStatusTrap, phyStatus=phyStatus, dfsTableNumber=dfsTableNumber, versionsGroup=versionsGroup, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, telnetAccessEnabled=telnetAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitModulationMode=transmitModulationMode, ethernet=ethernet, telecomsChannelSelection=telecomsChannelSelection, transmitChannel=transmitChannel, ethernetBridgingAvailability=ethernetBridgingAvailability, secondarySoftwareVersion=secondarySoftwareVersion, configurationGroup=configurationGroup, daylightSaving=daylightSaving, range=range)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", smtpGroup=smtpGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, latitude=latitude, supplementaryGroup=supplementaryGroup, channelBandwidth=channelBandwidth, noWirelessChannelAvailable=noWirelessChannelAvailable, txColorCode=txColorCode, phyStatusGroup=phyStatusGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmState=installArmState, managementPortWirelessDownAlert=managementPortWirelessDownAlert, secureModeAlarm=secureModeAlarm, pubStats=pubStats, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatus=telecomsChannelAStatus, versions=versions, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, tDDControl=tDDControl, ptpTraps=ptpTraps, sMTPServerInternetAddress=sMTPServerInternetAddress, bootVersion=bootVersion, dfsPeaks=dfsPeaks, licence=licence, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveChannel=receiveChannel, aAAControl=aAAControl, l2CPPriorityTable=l2CPPriorityTable, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableIndex=userTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex)
