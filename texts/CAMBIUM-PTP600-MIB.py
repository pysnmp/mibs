...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, cambium=cambium, bridgeGroup=bridgeGroup, channelBandwidth=channelBandwidth, sNTPServerTableNumber=sNTPServerTableNumber, syslogClient=syslogClient, dfsGroup=dfsGroup, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, dfsTableEntry=dfsTableEntry, phyControl=phyControl, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, sNTPServerStatus=sNTPServerStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationModeDetail=receiveModulationModeDetail, snmpControl=snmpControl, ethernet=ethernet, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerInternetAddress=tFTPServerInternetAddress, supplementaryGroup=supplementaryGroup, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPPortNumber=sNMPPortNumber, configurationGroup=configurationGroup, sNTPServerTableIndex=sNTPServerTableIndex, syslogState=syslogState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, supplementary=supplementary, smtpGroup=smtpGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteInternetAddressType=remoteInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptp=ptp, userName=userName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versionsGroup=versionsGroup, syslogClientTrap=syslogClientTrap, softwareVersion=softwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, iPVersion=iPVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteInternetAddress=remoteInternetAddress, telecomsChannelSelection=telecomsChannelSelection, productName=productName, sNTPServerTable=sNTPServerTable, telecomsInterface=telecomsInterface, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6Address=iPv6Address, sNMPTrapVersion=sNMPTrapVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBLoopback=channelBLoopback, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, channelALoopback=channelALoopback, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, eIRP=eIRP, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableIndex=dfsTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, regionCodeTrap=regionCodeTrap, rangingMode=rangingMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyStatusGroup=phyStatusGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelAStatus=telecomsChannelAStatus, tDDControl=tDDControl, channelACableLength=channelACableLength, dfsMeans=dfsMeans, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, sntpGroup=sntpGroup, siteName=siteName, transmitFreqMHz=transmitFreqMHz, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, qOSPriorityScheme=qOSPriorityScheme, ptpCompliance=ptpCompliance, productVariant=productVariant, userPassword=userPassword, vectorError=vectorError, receiveModulationMode=receiveModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, longitude=longitude, notificationsGroup=notificationsGroup, userTableEntry=userTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridge=bridge, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, bootVersion=bootVersion, frequencyVariant=frequencyVariant, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, groupID=groupID, dfsPeaks=dfsPeaks, sNTPPrimaryServer=sNTPPrimaryServer, dfsTable=dfsTable, localPacketFiltering=localPacketFiltering, sNTPSyncTrap=sNTPSyncTrap, versions=versions, alarms=alarms, resetGroup=resetGroup, linkModeOptimisation=linkModeOptimisation, hAZLOCConfiguration=hAZLOCConfiguration, encryptionGroup=encryptionGroup, channelALineCode=channelALineCode, dfs=dfs, masterSlaveMode=masterSlaveMode, searchState=searchState, range=range, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, targetMACAddress=targetMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, ptp600=ptp600, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subnetMask=subnetMask, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aAAControl=aAAControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTimeout=sNTPServerTimeout, alarmsGroup=alarmsGroup, channelALoopbackTrap=channelALoopbackTrap, timeZone=timeZone, securityLevel=securityLevel, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, installStatusTrap=installStatusTrap, managementPortStatusTrap=managementPortStatusTrap, userTableIndex=userTableIndex, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, rawReceivePower=rawReceivePower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelBCableLength=channelBCableLength, txColorCode=txColorCode, linkSymmetry=linkSymmetry, dSCPManagementPriority=dSCPManagementPriority, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, rxColorCode=rxColorCode, userRole=userRole, managementPortStatus=managementPortStatus, configuration=configuration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, iPv6PrefixLength=iPv6PrefixLength, targetRange=targetRange, managementPortDisabledWarning=managementPortDisabledWarning, byteErrorRatio=byteErrorRatio, smtp=smtp, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, installArmState=installArmState, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStatsGroup=pubStatsGroup, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, licence=licence, dfsTableNumber=dfsTableNumber, automaticTxPowerControl=automaticTxPowerControl, altitude=altitude, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, reset=reset, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementVID=vLANManagementVID, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, management=management, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, sNMPTrapTable=sNMPTrapTable, installStatus=installStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, ptpTraps=ptpTraps, receivePower=receivePower, cableLoss=cableLoss, encryption=encryption, managementMode=managementMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerRetries=sNTPServerRetries, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqMHz=receiveFreqMHz, signalStrengthRatio=signalStrengthRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortFiberStatusTrap=dataPortFiberStatusTrap, channelBLineCode=channelBLineCode, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetBridgingAvailability=ethernetBridgingAvailability, telecom=telecom, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitFreqKHz=transmitFreqKHz, l2CPPriorityTable=l2CPPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkAvailability=wirelessLinkAvailability, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveChannel=receiveChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, sNTPServerTableEntry=sNTPServerTableEntry, syslogControlGroup=syslogControlGroup, linkName=linkName, antennaGain=antennaGain, sNTPState=sNTPState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync)
