...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerInternetAddress=sNTPServerInternetAddress, searchState=searchState, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, dfsTable=dfsTable, dfs=dfs, daylightSaving=daylightSaving, configurationGroup=configurationGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetail=receiveModulationModeDetail, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, pubStats=pubStats, managementPortStatusTrap=managementPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userEnabled=userEnabled, linkModeOptimisation=linkModeOptimisation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, versions=versions, dfsTableEntry=dfsTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rxColorCode=rxColorCode, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetGroup=ethernetGroup, channelALineCode=channelALineCode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPVersion=iPVersion, receivePower=receivePower, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControlGroup=tDDControlGroup, sNTPServerRetries=sNTPServerRetries, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, userTableEntry=userTableEntry, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTraps=ptpTraps, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, targetRange=targetRange, signalStrengthRatio=signalStrengthRatio, reset=reset, longitude=longitude, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoMdix=dataPortAutoMdix, cableLoss=cableLoss, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, smtp=smtp, ptmp=ptmp, bridgeGroup=bridgeGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyStatusGroup=phyStatusGroup, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, channelBCableLength=channelBCableLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, automaticTxPowerControl=automaticTxPowerControl, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelACableLength=channelACableLength, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, qOSPriorityScheme=qOSPriorityScheme, managementPortStatus=managementPortStatus, telecomsInterface=telecomsInterface, remoteIPAddress=remoteIPAddress, regionCode=regionCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, siteName=siteName, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControl=snmpControl, rawReceivePower=rawReceivePower, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, vectorError=vectorError, channelALoopbackTrap=channelALoopbackTrap, antennaGain=antennaGain, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatus=dataPortStatus, configuration=configuration, sNTPServerStatus=sNTPServerStatus, managementMode=managementMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTable=userTable, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, receiveChannel=receiveChannel, bootVersion=bootVersion, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, sNTPPrimaryServer=sNTPPrimaryServer, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, rangingMode=rangingMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecom=telecom, smtpGroup=smtpGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, range=range, productVariant=productVariant, iPv4Address=iPv4Address, eIRP=eIRP, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, tDDControl=tDDControl, hTTPPortNumber=hTTPPortNumber, regionCodeTrap=regionCodeTrap, aAAControl=aAAControl, groupID=groupID, channelBLoopbackTrap=channelBLoopbackTrap, telecomsChannelAStatus=telecomsChannelAStatus, installArmState=installArmState, hAZLOCConfiguration=hAZLOCConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, systemClock=systemClock, ethernetBridgingStatus=ethernetBridgingStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveFreqMHz=receiveFreqMHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBLoopback=channelBLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptp=ptp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsTableIndex=dfsTableIndex, ethernet=ethernet, productName=productName, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsMeans=dfsMeans, managementPortDisabledWarning=managementPortDisabledWarning, syslogState=syslogState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenceGroup=licenceGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControlGroup=syslogControlGroup, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, syslogClient=syslogClient, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, syslogClientTrap=syslogClientTrap, ptp600=ptp600, sNMPTrapVersion=sNMPTrapVersion, softwareVersion=softwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, securityLevel=securityLevel, pubStatsGroup=pubStatsGroup, bridge=bridge, alarms=alarms, telecomsChannelSelection=telecomsChannelSelection, accessMethod=accessMethod, frequencyVariant=frequencyVariant, encryption=encryption, iPDSCPPriorityTable=iPDSCPPriorityTable, txColorCode=txColorCode, bandwidthVariant=bandwidthVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPollInterval=sNTPPollInterval, channelALoopback=channelALoopback, dfsPeaks=dfsPeaks, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, installStatus=installStatus, alarmsGroup=alarmsGroup, byteErrorRatio=byteErrorRatio, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licence=licence, phyControlGroup=phyControlGroup, remoteInternetAddressType=remoteInternetAddressType, remoteInternetAddress=remoteInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPState=sNTPState, secondarySoftwareVersion=secondarySoftwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, telnetPortNumber=telnetPortNumber, iPv6Address=iPv6Address, timeZone=timeZone, remoteRxTargetPower=remoteRxTargetPower, dfsGroup=dfsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, ptpCompliance=ptpCompliance, syslogControl=syslogControl, secureModeAlarm=secureModeAlarm, userPassword=userPassword, management=management, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelBLineCode=channelBLineCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, syslogStateTrap=syslogStateTrap, cambium=cambium, linkSymmetry=linkSymmetry, phyStatus=phyStatus, managementGroup=managementGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, sntpGroup=sntpGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTableEntry=sNTPServerTableEntry, sntp=sntp, sNTPServerPortNumber=sNTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, supplementary=supplementary, supplementaryGroup=supplementaryGroup, iPv6PrefixLength=iPv6PrefixLength, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationStatus=tDDSynchronizationStatus, altitude=altitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userName=userName, resetGroup=resetGroup, localPacketFiltering=localPacketFiltering, channelBandwidth=channelBandwidth)
