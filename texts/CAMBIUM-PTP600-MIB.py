...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", encryption=encryption, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelALoopback=channelALoopback, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, channelBLineCode=channelBLineCode, remoteIPAddress=remoteIPAddress, channelChangeTrap=channelChangeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, longitude=longitude, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, timeZone=timeZone, ethernetGroup=ethernetGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userName=userName, userEnabled=userEnabled, telecomGroup=telecomGroup, iPv6PrefixLength=iPv6PrefixLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetPortNumber=telnetPortNumber, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, cableLoss=cableLoss, managementMode=managementMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, latitude=latitude, pubStatsGroup=pubStatsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetRange=targetRange, bridgeGroup=bridgeGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteRxTargetPower=remoteRxTargetPower, rawReceivePower=rawReceivePower, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, syslogState=syslogState, userTableEntry=userTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regionCodeTrap=regionCodeTrap, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableNumber=dfsTableNumber, vLANManagementPriority=vLANManagementPriority, managementPortStatusTrap=managementPortStatusTrap, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, txColorCode=txColorCode, managementGroup=managementGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptmp=ptmp, ptp600=ptp600, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsPeaks=dfsPeaks, dfsTableEntry=dfsTableEntry, ptp=ptp, productVariant=productVariant, vectorError=vectorError, systemReset=systemReset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationMode=tDDSynchronizationMode, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, secureModeAlarm=secureModeAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDDControlGroup=tDDControlGroup, userTable=userTable, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, rangingMode=rangingMode, transmitPower=transmitPower, syslogControl=syslogControl, receiveDataRate=receiveDataRate, installStatus=installStatus, receivePower=receivePower, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortStatusTrap=dataPortStatusTrap, searchState=searchState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, antennaGain=antennaGain, rxColorCode=rxColorCode, telecomsInterface=telecomsInterface, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityTable=mPLSTCPriorityTable, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, pubStats=pubStats, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSPortNumber=hTTPSPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userRole=userRole, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, sNTPServerTable=sNTPServerTable, iPv6GatewayAddress=iPv6GatewayAddress, dataPortStatus=dataPortStatus, linkLoss=linkLoss, wirelessLinkAvailability=wirelessLinkAvailability, channelALoopbackTrap=channelALoopbackTrap, channelBLoopbackTrap=channelBLoopbackTrap, managementPortDisabledWarning=managementPortDisabledWarning, bootVersion=bootVersion, subnetMask=subnetMask, dSCPManagementPriority=dSCPManagementPriority, qOSPriorityScheme=qOSPriorityScheme, alarms=alarms, sNTPServerTableEntry=sNTPServerTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, localPacketFiltering=localPacketFiltering, regionCode=regionCode, unitOutOfCalibration=unitOutOfCalibration, linkSymmetry=linkSymmetry, telecomsChannelBStatus=telecomsChannelBStatus, smtp=smtp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteInternetAddress=remoteInternetAddress, sMTPServerIPAddress=sMTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, hardwareVersion=hardwareVersion, channelBLoopback=channelBLoopback, altitude=altitude, ptpGroups=ptpGroups, dfs=dfs, useVLANForManagementInterfaces=useVLANForManagementInterfaces, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerStatus=sNTPServerStatus, phyControlGroup=phyControlGroup, securityLevel=securityLevel, transmitChannel=transmitChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, iPVersion=iPVersion, signalStrengthRatio=signalStrengthRatio, ethernetPriorityTable=ethernetPriorityTable, sNTPLastSync=sNTPLastSync, ethernetBridgingAvailability=ethernetBridgingAvailability, eIRP=eIRP, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, notificationsGroup=notificationsGroup, syslogClient=syslogClient, sNMPv3Enable=sNMPv3Enable, l2CPPriorityTable=l2CPPriorityTable, dfsTable=dfsTable, channelBandwidth=channelBandwidth, telecom=telecom, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aAAControlGroup=aAAControlGroup, maximumTransmitPower=maximumTransmitPower, sNTPState=sNTPState, syslogStateTrap=syslogStateTrap, versions=versions, automaticTxPowerControl=automaticTxPowerControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, aggregateDataRate=aggregateDataRate, dfsGroup=dfsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, frequencyVariant=frequencyVariant, byteErrorRatio=byteErrorRatio, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, phyControl=phyControl, incompatibleRegionCodes=incompatibleRegionCodes, sntpGroup=sntpGroup, versionsGroup=versionsGroup, reset=reset, supplementaryGroup=supplementaryGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVID=vLANManagementVID, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementary=supplementary, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmStateTrap=installArmStateTrap, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, accessMethod=accessMethod, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortStatus=managementPortStatus, sNTPPollInterval=sNTPPollInterval, telecomsChannelSelection=telecomsChannelSelection, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userTableIndex=userTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, management=management, receiveChannel=receiveChannel, ethernetFiberSupport=ethernetFiberSupport, licence=licence, ptpCompliance=ptpCompliance, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, tDDControl=tDDControl, smtpGroup=smtpGroup, groupID=groupID, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, range=range, sNTPServerRetries=sNTPServerRetries, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelALineCode=channelALineCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryptionAlgorithm=encryptionAlgorithm)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", productName=productName, telecomsChannelAStatus=telecomsChannelAStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControlGroup=snmpControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hAZLOCConfiguration=hAZLOCConfiguration, transmitModulationMode=transmitModulationMode, receiveFreqMHz=receiveFreqMHz, userPassword=userPassword, dataPortFiberStatus=dataPortFiberStatus, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, systemClock=systemClock, sNTPServerPortNumber=sNTPServerPortNumber, aAAControl=aAAControl, sNTPServerTableIndex=sNTPServerTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv4Address=iPv4Address, dfsMeans=dfsMeans, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6Address=iPv6Address, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, phyStatus=phyStatus, channelACableLength=channelACableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, gatewayIPAddress=gatewayIPAddress, channelBCableLength=channelBCableLength)
