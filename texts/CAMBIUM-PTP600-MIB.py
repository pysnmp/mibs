...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpGroups=ptpGroups, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTable=userTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableEntry=dfsTableEntry, channelBLoopback=channelBLoopback, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, dataPortStatusTrap=dataPortStatusTrap, channelBLineCode=channelBLineCode, sNTPSync=sNTPSync, ptp=ptp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelSelection=telecomsChannelSelection, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, vLANManagementVID=vLANManagementVID, remoteInternetAddressType=remoteInternetAddressType, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regionCode=regionCode, vectorError=vectorError, receiveChannel=receiveChannel, installStatusTrap=installStatusTrap, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, management=management, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptp600=ptp600, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receivePower=receivePower, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPEnabledTraps=sNMPEnabledTraps, phyControl=phyControl, ethernetBridgingStatus=ethernetBridgingStatus, phyStatus=phyStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, telecomsInterface=telecomsInterface, transmitPower=transmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControlGroup=phyControlGroup, bridge=bridge, configuration=configuration, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, siteName=siteName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerInternetAddress=sMTPServerInternetAddress, altitude=altitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryption=encryption, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomGroup=telecomGroup, cambium=cambium, dataPortFiberStatusTrap=dataPortFiberStatusTrap, subnetMask=subnetMask, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNTPPollInterval=sNTPPollInterval, rxColorCode=rxColorCode, sNTPServerRetries=sNTPServerRetries, userName=userName, localPacketFiltering=localPacketFiltering, productName=productName, ethernetFiberSupport=ethernetFiberSupport, targetRange=targetRange, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveDataRate=receiveDataRate, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aAAControl=aAAControl, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, gatewayIPAddress=gatewayIPAddress, userTableEntry=userTableEntry, dfsTable=dfsTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secureModeAlarmTrap=secureModeAlarmTrap, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, alarmsGroup=alarmsGroup, bridgeGroup=bridgeGroup, linkName=linkName, dataPortFiberStatus=dataPortFiberStatus, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionAlgorithm=encryptionAlgorithm, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortWirelessDownAlert=managementPortWirelessDownAlert, antennaGain=antennaGain, groupID=groupID, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, supplementary=supplementary, targetMACAddress=targetMACAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, txColorCode=txColorCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, transmitFreqMHz=transmitFreqMHz, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelChangeTrap=channelChangeTrap, regionCodeTrap=regionCodeTrap, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatus=dataPortStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelBStatus=telecomsChannelBStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerTable=sNTPServerTable, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, reset=reset, syslogControl=syslogControl, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkLoss=linkLoss, licence=licence, userTableIndex=userTableIndex, encryptionGroup=encryptionGroup, syslogClient=syslogClient, sNTPServerTimeout=sNTPServerTimeout, channelBCableLength=channelBCableLength, syslogControlGroup=syslogControlGroup, l2CPPriorityTable=l2CPPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, ptpCompliance=ptpCompliance, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, hardwareVersion=hardwareVersion, iPv6Address=iPv6Address, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecom=telecom, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, telnetPortNumber=telnetPortNumber, systemClock=systemClock, receiveModulationMode=receiveModulationMode, timeZone=timeZone, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTableEntry=sNTPServerTableEntry, userTableNumber=userTableNumber, unitOutOfCalibration=unitOutOfCalibration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, accessMethod=accessMethod, PYSNMP_MODULE_ID=cambium, syslogClientTrap=syslogClientTrap, alarms=alarms, sntp=sntp, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, supplementaryGroup=supplementaryGroup, tDDControl=tDDControl, systemReset=systemReset, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, qOSPriorityScheme=qOSPriorityScheme, daylightSaving=daylightSaving, receiveFreqMHz=receiveFreqMHz, channelBLoopbackTrap=channelBLoopbackTrap, searchState=searchState, vLANManagementPriority=vLANManagementPriority, rawReceivePower=rawReceivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALineCode=channelALineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBandwidth=channelBandwidth, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, iPVersion=iPVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitModulationMode=transmitModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv4Address=iPv4Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, securityLevel=securityLevel, versions=versions, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, pubStats=pubStats, managementGroup=managementGroup, resetGroup=resetGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitFreqKHz=transmitFreqKHz, eIRP=eIRP)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelALoopback=channelALoopback, productVariant=productVariant, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, rangingMode=rangingMode, receiveFreqKHz=receiveFreqKHz, secureModeAlarm=secureModeAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptmp=ptmp, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, sNTPPrimaryServer=sNTPPrimaryServer, sNMPCommunityString=sNMPCommunityString, managementMode=managementMode, linkSymmetry=linkSymmetry, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, licenceGroup=licenceGroup, sNTPServerTableIndex=sNTPServerTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelALoopbackTrap=channelALoopbackTrap, bandwidthVariant=bandwidthVariant, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, configurationGroup=configurationGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, snmpControl=snmpControl, managementPortStatus=managementPortStatus, frequencyVariant=frequencyVariant, sNMPv3Enable=sNMPv3Enable, telecomsChannelAStatus=telecomsChannelAStatus, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, installArmState=installArmState, userEnabled=userEnabled, channelACableLength=channelACableLength, latitude=latitude, automaticTxPowerControl=automaticTxPowerControl, installArmStateTrap=installArmStateTrap)
