...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfs=dfs, sNTPServerTableNumber=sNTPServerTableNumber, channelALoopbackTrap=channelALoopbackTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, aggregateDataRate=aggregateDataRate, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, dfsTableIndex=dfsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSyncTrap=sNTPSyncTrap, dfsMeans=dfsMeans, sntp=sntp, aAAControlGroup=aAAControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, rxColorCode=rxColorCode, dSCPManagementPriority=dSCPManagementPriority, bandwidthVariant=bandwidthVariant, syslogState=syslogState, transmitPower=transmitPower, hardwareVersion=hardwareVersion, txColorCode=txColorCode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, regionCode=regionCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptpCompliance=ptpCompliance, daylightSaving=daylightSaving, pubStats=pubStats, alarmsGroup=alarmsGroup, encryption=encryption, ethernetPriorityTable=ethernetPriorityTable, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleRegionCodes=incompatibleRegionCodes, installArmState=installArmState, vLANManagementVID=vLANManagementVID, sNTPServerRetries=sNTPServerRetries, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, pubStatsGroup=pubStatsGroup, localPacketFiltering=localPacketFiltering, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, qOSPriorityScheme=qOSPriorityScheme, dataPortStatus=dataPortStatus, rawReceivePower=rawReceivePower, regionCodeTrap=regionCodeTrap, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, configuration=configuration, iPDSCPPriorityTable=iPDSCPPriorityTable, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPv4Address=iPv4Address, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, installArmStateTrap=installArmStateTrap, installStatus=installStatus, dfsTableNumber=dfsTableNumber, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, eIRP=eIRP, licenceGroup=licenceGroup, versions=versions, dfsGroup=dfsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, longitude=longitude, installStatusTrap=installStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bridgeGroup=bridgeGroup, ptp=ptp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetBridgingAvailability=ethernetBridgingAvailability, linkLoss=linkLoss, transmitFreqKHz=transmitFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, sntpGroup=sntpGroup, dataPortFiberStatus=dataPortFiberStatus, l2CPPriorityTable=l2CPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, groupID=groupID, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, receiveChannel=receiveChannel, sMTPServerInternetAddress=sMTPServerInternetAddress, userName=userName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, sNTPServerTableEntry=sNTPServerTableEntry, productName=productName, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapTable=sNMPTrapTable, channelBLoopbackTrap=channelBLoopbackTrap, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPLastSync=sNTPLastSync, userEnabled=userEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, siteName=siteName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telnetPortNumber=telnetPortNumber, timeZone=timeZone, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsInterface=telecomsInterface, management=management, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtpGroup=smtpGroup, alarms=alarms, cambium=cambium, linkSymmetry=linkSymmetry, versionsGroup=versionsGroup, sNMPCommunityString=sNMPCommunityString, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsPeaks=dfsPeaks, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBLineCode=channelBLineCode, ptmp=ptmp, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelBStatus=telecomsChannelBStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, iPv6GatewayAddress=iPv6GatewayAddress, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelAStatus=telecomsChannelAStatus, maximumTransmitPower=maximumTransmitPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableIndex=userTableIndex, subnetMask=subnetMask, managementPortDisabledWarning=managementPortDisabledWarning, syslogStateTrap=syslogStateTrap, range=range, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unitOutOfCalibration=unitOutOfCalibration, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControl=phyControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configurationGroup=configurationGroup, secureModeAlarm=secureModeAlarm, dfsTable=dfsTable, cableLoss=cableLoss, linkModeOptimisation=linkModeOptimisation, sNTPSync=sNTPSync, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClient=syslogClient, managementGroup=managementGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, sMTPEnabledMessages=sMTPEnabledMessages, securityLevel=securityLevel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableNumber=userTableNumber, userPassword=userPassword, userTableEntry=userTableEntry, channelACableLength=channelACableLength, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkName=linkName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, userTable=userTable, sNTPServerTableIndex=sNTPServerTableIndex, encryptionAlgorithm=encryptionAlgorithm, ptp600=ptp600, byteErrorRatio=byteErrorRatio, bridge=bridge, sNTPState=sNTPState, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, masterSlaveMode=masterSlaveMode, targetRange=targetRange, aAAControl=aAAControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, searchState=searchState, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControlGroup=phyControlGroup, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, tDDControl=tDDControl, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, reset=reset, antennaGain=antennaGain, automaticTxPowerControl=automaticTxPowerControl, receiveFreqMHz=receiveFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTable=sNTPServerTable, telecomsChannelSelection=telecomsChannelSelection, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerPortNumber=sNTPServerPortNumber, remoteIPAddress=remoteIPAddress, hTTPPortNumber=hTTPPortNumber, resetGroup=resetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortStatus=managementPortStatus, iPv6Address=iPv6Address, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, targetMACAddress=targetMACAddress, supplementary=supplementary, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementMode=managementMode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelALineCode=channelALineCode, channelBCableLength=channelBCableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBLoopback=channelBLoopback, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rangingMode=rangingMode, sNTPServerStatus=sNTPServerStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userRole=userRole, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, secondarySoftwareVersion=secondarySoftwareVersion, channelALoopback=channelALoopback, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersion=softwareVersion, tDDControlGroup=tDDControlGroup, systemClock=systemClock, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, ethernet=ethernet, phyStatus=phyStatus, channelBandwidth=channelBandwidth, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetBridgingStatus=ethernetBridgingStatus, hTTPSPortNumber=hTTPSPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receiveDataRate=receiveDataRate, sNTPPollInterval=sNTPPollInterval)
