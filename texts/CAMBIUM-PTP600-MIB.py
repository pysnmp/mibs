...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:54:42 2022
...
Unsigned32, ModuleIdentity, MibIdentifier, Bits, iso, enterprises, NotificationType, Integer32, Gauge32, Counter32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Bits", "iso", "enterprises", "NotificationType", "Integer32", "Gauge32", "Counter32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkModeOptimisation=linkModeOptimisation, rxColorCode=rxColorCode, sNTPPrimaryServer=sNTPPrimaryServer, userTable=userTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, installArmState=installArmState, sNTPState=sNTPState, timeZone=timeZone, telnetPortNumber=telnetPortNumber, aggregateDataRate=aggregateDataRate, rawReceivePower=rawReceivePower, sNMPTrapTableNumber=sNMPTrapTableNumber, userPassword=userPassword, longitude=longitude, sNMPPortNumber=sNMPPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, channelALoopback=channelALoopback, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secureModeAlarm=secureModeAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alarms=alarms, managementPortConfigurationMismatch=managementPortConfigurationMismatch, channelBCableLength=channelBCableLength, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, syslogState=syslogState, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetFiberSupport=ethernetFiberSupport, sNTPLastSync=sNTPLastSync, sMTPEmailAlert=sMTPEmailAlert, dfsMeans=dfsMeans, rangingMode=rangingMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkSymmetry=linkSymmetry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, channelALoopbackTrap=channelALoopbackTrap, bridge=bridge, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTableEntry=sNTPServerTableEntry, transmitFreqMHz=transmitFreqMHz, syslogStateTrap=syslogStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStats=pubStats, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, installStatusTrap=installStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelACableLength=channelACableLength, sNMPv3Enable=sNMPv3Enable, vLANManagementPriority=vLANManagementPriority, reset=reset, signalStrengthRatio=signalStrengthRatio, sNTPServerStatus=sNTPServerStatus, dataPortStatus=dataPortStatus, dfs=dfs, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, hTTPPortNumber=hTTPPortNumber, sNMPTrapTable=sNMPTrapTable, sNMPTrapVersion=sNMPTrapVersion, userName=userName, channelBandwidth=channelBandwidth, targetMACAddress=targetMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, sNTPSync=sNTPSync, syslogControlGroup=syslogControlGroup, linkName=linkName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerIPAddress=sNTPServerIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementMode=managementMode, encryption=encryption, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, searchState=searchState, receiveFreqKHz=receiveFreqKHz, versions=versions, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelSelection=telecomsChannelSelection, phyControlGroup=phyControlGroup, installStatus=installStatus, targetRange=targetRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomGroup=telecomGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, smtpGroup=smtpGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, systemClock=systemClock, latitude=latitude, iPVersion=iPVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, securityLevel=securityLevel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userEnabled=userEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6Address=iPv6Address, channelBLineCode=channelBLineCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitDataRate=transmitDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, receiveFreqMHz=receiveFreqMHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, masterSlaveMode=masterSlaveMode, sMTPServerInternetAddress=sMTPServerInternetAddress, hTTPSPortNumber=hTTPSPortNumber, transmitModulationMode=transmitModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, dataPortStatusTrap=dataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, configuration=configuration, pubStatsGroup=pubStatsGroup, txColorCode=txColorCode, smtp=smtp, accessMethod=accessMethod, managementPortStatus=managementPortStatus, sNTPServerRetries=sNTPServerRetries, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, localPacketFiltering=localPacketFiltering, supplementaryGroup=supplementaryGroup, ethernetPriorityTable=ethernetPriorityTable, daylightSaving=daylightSaving, versionsGroup=versionsGroup, receiveDataRate=receiveDataRate, automaticTxPowerControl=automaticTxPowerControl, ptpTraps=ptpTraps, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, management=management, remoteRxTargetPower=remoteRxTargetPower, range=range, secondarySoftwareVersion=secondarySoftwareVersion, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkStatus=wirelessLinkStatus, managementPortStatusTrap=managementPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntp=sntp, phyControl=phyControl, licence=licence, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLoopback=channelBLoopback, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogControl=syslogControl, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, channelChangeTrap=channelChangeTrap, dfsTableEntry=dfsTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddress=remoteInternetAddress, productName=productName, systemReset=systemReset, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, receivePower=receivePower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, frequencyVariant=frequencyVariant, managementGroup=managementGroup, altitude=altitude, phyStatus=phyStatus, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, telecomsInterface=telecomsInterface, wirelessLinkAvailability=wirelessLinkAvailability, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControl=aAAControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, qOSPriorityScheme=qOSPriorityScheme, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, hAZLOCConfiguration=hAZLOCConfiguration, snmpControl=snmpControl, userTableIndex=userTableIndex, installArmStateTrap=installArmStateTrap, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, dfsGroup=dfsGroup, sNTPServerPortNumber=sNTPServerPortNumber, transmitChannel=transmitChannel, dfsTableNumber=dfsTableNumber, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTableNumber=ethernetPriorityTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, bridgeGroup=bridgeGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, transmitPower=transmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, siteName=siteName, ethernetBridgingStatus=ethernetBridgingStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv4Address=iPv4Address, remoteInternetAddressType=remoteInternetAddressType, hardwareVersion=hardwareVersion, ptp600=ptp600, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sntpGroup=sntpGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, maximumTransmitPower=maximumTransmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptp=ptp, ptpGroups=ptpGroups, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, sNTPServerTable=sNTPServerTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration, dfsPeaks=dfsPeaks, mPLSTCPriorityTable=mPLSTCPriorityTable, linkLoss=linkLoss, alarmsGroup=alarmsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, regionCodeTrap=regionCodeTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTable=l2CPPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableNumber=userTableNumber, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, antennaGain=antennaGain, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptpCompliance=ptpCompliance, tDDControl=tDDControl, encryptionGroup=encryptionGroup, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, userRole=userRole, cambium=cambium, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALineCode=channelALineCode, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion)
