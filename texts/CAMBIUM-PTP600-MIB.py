...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingAvailability=ethernetBridgingAvailability, targetMACAddress=targetMACAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sntp=sntp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6Address=iPv6Address, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, installStatus=installStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, sNTPServerTableNumber=sNTPServerTableNumber, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelALoopbackTrap=channelALoopbackTrap, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, configuration=configuration, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, bridgeGroup=bridgeGroup, bootVersion=bootVersion, ptmp=ptmp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, channelALineCode=channelALineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, bridge=bridge, sntpGroup=sntpGroup, channelBLineCode=channelBLineCode, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortStatus=managementPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hAZLOCConfiguration=hAZLOCConfiguration, latitude=latitude, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetGroup=ethernetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSyncTrap=sNTPSyncTrap, remoteInternetAddress=remoteInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configurationGroup=configurationGroup, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, userTable=userTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, groupID=groupID, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, securityLevel=securityLevel, ptp=ptp, linkName=linkName, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortDisabledWarning=managementPortDisabledWarning, byteErrorRatio=byteErrorRatio, alarmsGroup=alarmsGroup, tDDSynchronizationMode=tDDSynchronizationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, timeZone=timeZone, productVariant=productVariant, automaticTxPowerControl=automaticTxPowerControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerStatus=sNTPServerStatus, installArmState=installArmState, ptpTraps=ptpTraps, hTTPPortNumber=hTTPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, ethernet=ethernet, dfsPeaks=dfsPeaks, range=range, channelBandwidth=channelBandwidth, supplementary=supplementary, smtp=smtp, ptpCompliance=ptpCompliance, sNTPPrimaryServer=sNTPPrimaryServer, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimisation=linkModeOptimisation, secureModeAlarmTrap=secureModeAlarmTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableEntry=userTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, txColorCode=txColorCode, secureModeAlarm=secureModeAlarm, searchState=searchState, receiveFreqKHz=receiveFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, dataPortAutoMdix=dataPortAutoMdix, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBCableLength=channelBCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecom=telecom, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsInterface=telecomsInterface, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, resetGroup=resetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, frequencyVariant=frequencyVariant, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveChannel=receiveChannel, transmitChannel=transmitChannel, longitude=longitude, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rangingMode=rangingMode, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, alarms=alarms, dSCPManagementPriority=dSCPManagementPriority, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControlGroup=phyControlGroup, vectorError=vectorError, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, ethernetBridgingStatus=ethernetBridgingStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, rawReceivePower=rawReceivePower, channelACableLength=channelACableLength, ethernetFiberSupport=ethernetFiberSupport, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, systemClock=systemClock, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsTableNumber=dfsTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableNumber=userTableNumber, tDDControl=tDDControl, dfsGroup=dfsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, productName=productName, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, maximumTransmitPower=maximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteInternetAddressType=remoteInternetAddressType, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkSymmetry=linkSymmetry, rxColorCode=rxColorCode, sNTPServerTableIndex=sNTPServerTableIndex, userRole=userRole, channelALoopback=channelALoopback, userEnabled=userEnabled, dfsMeans=dfsMeans, phyControl=phyControl, telecomsChannelSelection=telecomsChannelSelection, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aggregateDataRate=aggregateDataRate, sNTPServerTable=sNTPServerTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPv3Enable=sNMPv3Enable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, localPacketFiltering=localPacketFiltering, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPVersion=iPVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, iPv4Address=iPv4Address, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptp600=ptp600, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogClient=syslogClient, incompatibleRegionCodes=incompatibleRegionCodes, l2CPPriorityTable=l2CPPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, accessMethod=accessMethod, eIRP=eIRP, sNTPState=sNTPState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementMode=managementMode, regionCodeTrap=regionCodeTrap, sNMPTrapVersion=sNMPTrapVersion, iPv6GatewayAddress=iPv6GatewayAddress, targetRange=targetRange, channelChangeTrap=channelChangeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, dataPortFiberStatus=dataPortFiberStatus, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsTableIndex=dfsTableIndex, reset=reset, channelBLoopback=channelBLoopback, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, ethernetPriorityTableIndex=ethernetPriorityTableIndex, versions=versions, versionsGroup=versionsGroup, systemReset=systemReset, softwareVersion=softwareVersion, ethernetPriorityTable=ethernetPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, masterSlaveMode=masterSlaveMode, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogControlGroup=syslogControlGroup, sNMPPortNumber=sNMPPortNumber, management=management, vLANManagementPriority=vLANManagementPriority, managementGroup=managementGroup, syslogStateTrap=syslogStateTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogState=syslogState, telecomsChannelBStatus=telecomsChannelBStatus, qOSPriorityScheme=qOSPriorityScheme, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, phyStatusGroup=phyStatusGroup, aAAControl=aAAControl, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, encryption=encryption)
