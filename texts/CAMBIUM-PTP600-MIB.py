...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsMeans=dfsMeans, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, dfsTableNumber=dfsTableNumber, sNMPTrapTable=sNMPTrapTable, accessMethod=accessMethod, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTimeout=sNTPServerTimeout, automaticTxPowerControl=automaticTxPowerControl, bandwidthVariant=bandwidthVariant, transmitChannel=transmitChannel, ptp=ptp, pubStats=pubStats, pubStatsGroup=pubStatsGroup, productVariant=productVariant, linkLoss=linkLoss, userEnabled=userEnabled, managementPortStatusTrap=managementPortStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, managementGroup=managementGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, versionsGroup=versionsGroup, cambium=cambium, mPLSTCPriorityTable=mPLSTCPriorityTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, frequencyVariant=frequencyVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, notificationsGroup=notificationsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, softwareVersion=softwareVersion, telecomsChannelSelection=telecomsChannelSelection, productName=productName, managementMode=managementMode, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTable=dfsTable, userName=userName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerStatus=sNTPServerStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installStatusTrap=installStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, txColorCode=txColorCode, hardwareVersion=hardwareVersion, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, userTable=userTable, channelBLoopback=channelBLoopback, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRate=aggregateDataRate, telnetPortNumber=telnetPortNumber, bridge=bridge, dfsTableEntry=dfsTableEntry, iPv6PrefixLength=iPv6PrefixLength, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitPower=transmitPower, transmitFreqMHz=transmitFreqMHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tDDControl=tDDControl, reset=reset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBLoopbackTrap=channelBLoopbackTrap, linkSymmetry=linkSymmetry, installStatus=installStatus, linkName=linkName, bridgeGroup=bridgeGroup, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, vectorError=vectorError, bootVersion=bootVersion, sNTPState=sNTPState, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteRxTargetPower=remoteRxTargetPower, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, dfsGroup=dfsGroup, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, configuration=configuration, secureModeAlarm=secureModeAlarm, dfsTableIndex=dfsTableIndex, groupID=groupID, sNTPSyncTrap=sNTPSyncTrap, qOSPriorityScheme=qOSPriorityScheme, alarmsGroup=alarmsGroup, supplementaryGroup=supplementaryGroup, channelChangeTrap=channelChangeTrap, PYSNMP_MODULE_ID=cambium, transmitFreqKHz=transmitFreqKHz, syslogClient=syslogClient, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortStatus=managementPortStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, rangingMode=rangingMode, iPv6GatewayAddress=iPv6GatewayAddress, snmpControl=snmpControl, encryptionGroup=encryptionGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, syslogControl=syslogControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userPassword=userPassword, dataPortFiberStatusTrap=dataPortFiberStatusTrap, phyStatusGroup=phyStatusGroup, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteIPAddress=remoteIPAddress, sNTPLastSync=sNTPLastSync, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomGroup=telecomGroup, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableIndex=sNTPServerTableIndex, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, installArmState=installArmState, hTTPSPortNumber=hTTPSPortNumber, sNTPServerRetries=sNTPServerRetries, targetMACAddress=targetMACAddress, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDControlGroup=tDDControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, userRole=userRole, l2CPPriorityTableNumber=l2CPPriorityTableNumber, smtp=smtp, securityLevel=securityLevel, ethernetPriorityTable=ethernetPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, userTableEntry=userTableEntry, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, receiveFreqMHz=receiveFreqMHz, wirelessLinkStatus=wirelessLinkStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, altitude=altitude, channelALoopback=channelALoopback, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, rxColorCode=rxColorCode, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortStatus=dataPortStatus, channelALoopbackTrap=channelALoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dSCPManagementPriority=dSCPManagementPriority, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfs=dfs, sNTPServerTableNumber=sNTPServerTableNumber, syslogState=syslogState, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptpGroups=ptpGroups, supplementary=supplementary, cableLoss=cableLoss, dfsPeaks=dfsPeaks, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alarms=alarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsInterface=telecomsInterface, iPv4Address=iPv4Address, receivePower=receivePower, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, channelBCableLength=channelBCableLength, management=management, vLANManagementVID=vLANManagementVID, searchState=searchState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, dataPortFiberStatus=dataPortFiberStatus, channelBandwidth=channelBandwidth, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptpTraps=ptpTraps, regionCode=regionCode, ethernetGroup=ethernetGroup, rawReceivePower=rawReceivePower, versions=versions, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, gatewayIPAddress=gatewayIPAddress, systemClock=systemClock, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, phyControlGroup=phyControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelACableLength=channelACableLength, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, syslogClientTrap=syslogClientTrap, hAZLOCConfiguration=hAZLOCConfiguration, ptp600=ptp600, phyControl=phyControl, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6Address=iPv6Address, latitude=latitude, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, resetGroup=resetGroup, sMTPEmailAlert=sMTPEmailAlert, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, licenceGroup=licenceGroup, phyStatus=phyStatus, ethernetBridgingStatus=ethernetBridgingStatus, targetRange=targetRange, channelALineCode=channelALineCode, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, eIRP=eIRP, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, channelBLineCode=channelBLineCode, receiveModulationMode=receiveModulationMode, encryption=encryption, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, range=range, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControl=aAAControl, sNTPServerTableEntry=sNTPServerTableEntry, managementPortDisabledWarning=managementPortDisabledWarning, linkModeOptimisation=linkModeOptimisation, sNTPServerIPAddress=sNTPServerIPAddress, iPVersion=iPVersion)
