...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:25:57 2021
...
MibIdentifier, enterprises, Bits, Gauge32, Counter32, TimeTicks, iso, Unsigned32, Counter64, ModuleIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Bits", "Gauge32", "Counter32", "TimeTicks", "iso", "Unsigned32", "Counter64", "ModuleIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortWirelessDownAlert=dataPortWirelessDownAlert, softwareVersion=softwareVersion, systemClock=systemClock, linkLoss=linkLoss, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatus=phyStatus, dfsTableIndex=dfsTableIndex, vLANManagementPriority=vLANManagementPriority, linkSymmetry=linkSymmetry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatusTrap=installStatusTrap, secureModeAlarm=secureModeAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsInterface=telecomsInterface, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClientTrap=syslogClientTrap, sNTPServerTable=sNTPServerTable, sNMPTrapTableNumber=sNMPTrapTableNumber, managementGroup=managementGroup, targetRange=targetRange, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, management=management, phyControl=phyControl, masterSlaveMode=masterSlaveMode, channelBLineCode=channelBLineCode, ethernetBridgingStatus=ethernetBridgingStatus, remoteRxTargetPower=remoteRxTargetPower, ethernetFiberSupport=ethernetFiberSupport, userEnabled=userEnabled, syslogControl=syslogControl, userTable=userTable, telecomsChannelAStatus=telecomsChannelAStatus, configuration=configuration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitDataRate=transmitDataRate, telecom=telecom, dfsTable=dfsTable, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, rxColorCode=rxColorCode, sNTPLastSync=sNTPLastSync, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, hAZLOCConfiguration=hAZLOCConfiguration, automaticTxPowerControl=automaticTxPowerControl, unitOutOfCalibration=unitOutOfCalibration, channelBandwidth=channelBandwidth, syslogState=syslogState, regionCodeTrap=regionCodeTrap, userTableEntry=userTableEntry, rangingMode=rangingMode, tDDControl=tDDControl, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telnetPortNumber=telnetPortNumber, tDDControlGroup=tDDControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptmp=ptmp, telecomsChannelBStatus=telecomsChannelBStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, rawReceivePower=rawReceivePower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingAvailability=ethernetBridgingAvailability, installArmState=installArmState, frequencyVariant=frequencyVariant, sNMPv3Enable=sNMPv3Enable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkModeOptimisation=linkModeOptimisation, dataPortFiberStatus=dataPortFiberStatus, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, snmpControlGroup=snmpControlGroup, dataPortStatus=dataPortStatus, productVariant=productVariant, receivePower=receivePower, sNTPSync=sNTPSync, userRole=userRole, PYSNMP_MODULE_ID=cambium, userName=userName, qOSPriorityScheme=qOSPriorityScheme, systemReset=systemReset, transmitPower=transmitPower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, altitude=altitude, searchState=searchState, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomGroup=telecomGroup, versionsGroup=versionsGroup, managementMode=managementMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, productName=productName, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveChannel=receiveChannel, groupID=groupID, securityLevel=securityLevel, alarmsGroup=alarmsGroup, txColorCode=txColorCode, daylightSaving=daylightSaving, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, syslogClient=syslogClient, sntp=sntp, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, incompatibleRegionCodes=incompatibleRegionCodes, userPassword=userPassword, accessMethod=accessMethod, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControlGroup=phyControlGroup, eIRP=eIRP, sMTPServerIPAddress=sMTPServerIPAddress, ptpGroups=ptpGroups, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hTTPSPortNumber=hTTPSPortNumber, channelALoopbackTrap=channelALoopbackTrap, sntpGroup=sntpGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridge=bridge, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aggregateDataRate=aggregateDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, aAAControlGroup=aAAControlGroup, vectorError=vectorError, managementPortDisabledWarning=managementPortDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, supplementary=supplementary, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, channelACableLength=channelACableLength, syslogStateTrap=syslogStateTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTableEntry=sNTPServerTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableNumber=dfsTableNumber, versions=versions, channelALineCode=channelALineCode, pubStats=pubStats, reset=reset, configurationGroup=configurationGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSyncTrap=sNTPSyncTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, bootVersion=bootVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsMeans=dfsMeans, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6PrefixLength=iPv6PrefixLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerStatus=sNTPServerStatus, iPv6Address=iPv6Address, sNMPPortNumber=sNMPPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTable=sNMPTrapTable, secureModeAlarmTrap=secureModeAlarmTrap, siteName=siteName, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableEntry=dfsTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, sNTPPrimaryServer=sNTPPrimaryServer, encryptionAlgorithm=encryptionAlgorithm, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bandwidthVariant=bandwidthVariant, managementPortStatus=managementPortStatus, dataPortAutoMdix=dataPortAutoMdix, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, latitude=latitude, sNTPState=sNTPState, channelALoopback=channelALoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsGroup=dfsGroup, receiveModulationMode=receiveModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, localPacketFiltering=localPacketFiltering, userTableIndex=userTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, byteErrorRatio=byteErrorRatio, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenceGroup=licenceGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsChannelSelection=telecomsChannelSelection, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, sNTPServerRetries=sNTPServerRetries, smtp=smtp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTableIndex=sNTPServerTableIndex, alarms=alarms, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetMACAddress=targetMACAddress, bridgeGroup=bridgeGroup, syslogControlGroup=syslogControlGroup, hardwareVersion=hardwareVersion, remoteInternetAddressType=remoteInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPVersion=iPVersion, transmitChannel=transmitChannel, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vLANManagementVID=vLANManagementVID, pubStatsGroup=pubStatsGroup, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, iPv4Address=iPv4Address, sNMPCommunityString=sNMPCommunityString, channelBLoopbackTrap=channelBLoopbackTrap, encryptionGroup=encryptionGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteInternetAddress=remoteInternetAddress, licence=licence, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, cableLoss=cableLoss, cambium=cambium, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, userTableNumber=userTableNumber, sNTPServerTimeout=sNTPServerTimeout, channelChangeTrap=channelChangeTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBCableLength=channelBCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableEntry=l2CPPriorityTableEntry, range=range, ptp600=ptp600, sMTPEmailAlert=sMTPEmailAlert, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyStatusGroup=phyStatusGroup, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveFreqMHz=receiveFreqMHz, longitude=longitude, aAAControl=aAAControl, transmitFreqKHz=transmitFreqKHz, channelBLoopback=channelBLoopback, encryption=encryption, sNMPTrapTableIndex=sNMPTrapTableIndex)
