...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:12:17 2021
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, ModuleIdentity, TimeTicks, Counter32, Unsigned32, MibIdentifier, Gauge32, iso, ObjectIdentity, NotificationType, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "ModuleIdentity", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity", "NotificationType", "Bits", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, targetRange=targetRange, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, sNTPServerRetries=sNTPServerRetries, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsGroup=dfsGroup, telnetAccessEnabled=telnetAccessEnabled, longitude=longitude, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, phyStatusGroup=phyStatusGroup, tFTPServerIPAddress=tFTPServerIPAddress, managementPortStatus=managementPortStatus, sntp=sntp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenceGroup=licenceGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteRxTargetPower=remoteRxTargetPower, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, ptpTraps=ptpTraps, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerTable=sNTPServerTable, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, management=management, versionsGroup=versionsGroup, sNTPServerStatus=sNTPServerStatus, cambium=cambium, configuration=configuration, tDDControlGroup=tDDControlGroup, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, hardwareVersion=hardwareVersion, txColorCode=txColorCode, timeZone=timeZone, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogState=syslogState, sNTPServerTimeout=sNTPServerTimeout, ptp=ptp, transmitDataRate=transmitDataRate, versions=versions, phyControl=phyControl, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, resetGroup=resetGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, transmitFreqMHz=transmitFreqMHz, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, groupID=groupID, regionCodeTrap=regionCodeTrap, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTableNumber=dfsTableNumber, userTable=userTable, ethernetGroup=ethernetGroup, ethernetBridgingStatus=ethernetBridgingStatus, smtp=smtp, reset=reset, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, bridge=bridge, iPv4Address=iPv4Address, alarmsGroup=alarmsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelALoopback=channelALoopback, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, siteName=siteName, cableLoss=cableLoss, channelBandwidth=channelBandwidth, channelBLoopback=channelBLoopback, channelBCableLength=channelBCableLength, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, sNTPLastSync=sNTPLastSync, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, telecomsChannelAStatus=telecomsChannelAStatus, receiveFreqKHz=receiveFreqKHz, bandwidthVariant=bandwidthVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, subnetMask=subnetMask, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, aAAControl=aAAControl, transmitChannel=transmitChannel, userPassword=userPassword, telecomsChannelSelection=telecomsChannelSelection, telecomsInterface=telecomsInterface, iPv6Address=iPv6Address, securityLevel=securityLevel, installArmState=installArmState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, automaticTxPowerControl=automaticTxPowerControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, pubStats=pubStats, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userName=userName, installArmStateTrap=installArmStateTrap, systemClock=systemClock, managementMode=managementMode, syslogControlGroup=syslogControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsPeaks=dfsPeaks, iPv6GatewayAddress=iPv6GatewayAddress, managementPortDisabledWarning=managementPortDisabledWarning, accessMethod=accessMethod, smtpGroup=smtpGroup, aAAControlGroup=aAAControlGroup, userTableNumber=userTableNumber, linkSymmetry=linkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogClientTrap=syslogClientTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernet=ethernet, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpGroups=ptpGroups, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, altitude=altitude, rangingMode=rangingMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteIPAddress=remoteIPAddress, bridgeGroup=bridgeGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkLoss=linkLoss, vLANManagementVID=vLANManagementVID, sNMPPortNumber=sNMPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, managementPortStatusTrap=managementPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rxColorCode=rxColorCode, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, installStatus=installStatus, latitude=latitude, eIRP=eIRP, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, channelALineCode=channelALineCode, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, hTTPAccessEnabled=hTTPAccessEnabled, userRole=userRole, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortFiberStatus=dataPortFiberStatus, gatewayIPAddress=gatewayIPAddress, systemReset=systemReset, receiveChannel=receiveChannel, iPv6PrefixLength=iPv6PrefixLength, channelALoopbackTrap=channelALoopbackTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, transmitModulationMode=transmitModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, byteErrorRatio=byteErrorRatio, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productName=productName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleMasterAndSlave=incompatibleMasterAndSlave, masterSlaveMode=masterSlaveMode, licence=licence, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hAZLOCConfiguration=hAZLOCConfiguration, telecomGroup=telecomGroup, tDDControl=tDDControl, remoteInternetAddress=remoteInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, vectorError=vectorError, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableIndex=dfsTableIndex, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, targetMACAddress=targetMACAddress, secondarySoftwareVersion=secondarySoftwareVersion, dfsMeans=dfsMeans, channelBLineCode=channelBLineCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPv3Enable=sNMPv3Enable, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, maximumTransmitPower=maximumTransmitPower, sNTPServerTableIndex=sNTPServerTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatusTrap=installStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secureModeAlarm=secureModeAlarm, dataPortDisabledWarning=dataPortDisabledWarning, constantPowerSpectralDensity=constantPowerSpectralDensity, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, range=range, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, searchState=searchState, dfsTable=dfsTable, telecomsChannelBStatus=telecomsChannelBStatus, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, userTableEntry=userTableEntry, supplementary=supplementary, phyControlGroup=phyControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, userEnabled=userEnabled, ptp600=ptp600, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, encryptionGroup=encryptionGroup, syslogControl=syslogControl, dfsTableEntry=dfsTableEntry, channelACableLength=channelACableLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPState=sNTPState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rawReceivePower=rawReceivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetFiberSupport=ethernetFiberSupport, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, encryption=encryption, vLANManagementPriority=vLANManagementPriority, secureModeAlarmTrap=secureModeAlarmTrap, sNTPSyncTrap=sNTPSyncTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyStatus=phyStatus, syslogStateTrap=syslogStateTrap, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntpGroup=sntpGroup, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpCompliance=ptpCompliance, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, localPacketFiltering=localPacketFiltering, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress)
