...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:35:46 2022
...
TimeTicks, enterprises, Integer32, IpAddress, NotificationType, ModuleIdentity, Bits, Counter32, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Integer32", "IpAddress", "NotificationType", "ModuleIdentity", "Bits", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortFiberStatus=dataPortFiberStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, encryptionGroup=encryptionGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userPassword=userPassword, tDDControl=tDDControl, installArmState=installArmState, dfsTableIndex=dfsTableIndex, rawReceivePower=rawReceivePower, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, frequencyVariant=frequencyVariant, sNMPCommunityString=sNMPCommunityString, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelAStatus=telecomsChannelAStatus, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, installArmStateTrap=installArmStateTrap, alarmsGroup=alarmsGroup, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelALineCode=channelALineCode, syslogClientTrap=syslogClientTrap, remoteIPAddress=remoteIPAddress, eIRP=eIRP, productName=productName, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, hAZLOCConfiguration=hAZLOCConfiguration, subnetMask=subnetMask, dfsPeaks=dfsPeaks, sNTPSync=sNTPSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, resetGroup=resetGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableIndex=userTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, encryption=encryption, receiveModulationMode=receiveModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, altitude=altitude, versionsGroup=versionsGroup, bridgeGroup=bridgeGroup, regionCode=regionCode, range=range, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, sntpGroup=sntpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, timeZone=timeZone, pubStats=pubStats, tDDSynchronizationMode=tDDSynchronizationMode, telnetPortNumber=telnetPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rxColorCode=rxColorCode, receiveModulationModeDetail=receiveModulationModeDetail, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsMeans=dfsMeans, sMTPServerInternetAddressType=sMTPServerInternetAddressType, configuration=configuration, ethernetPriorityTableNumber=ethernetPriorityTableNumber, configurationGroup=configurationGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rangingMode=rangingMode, channelBandwidth=channelBandwidth, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementPortStatus=managementPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsInterface=telecomsInterface, receivePower=receivePower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, automaticTxPowerControl=automaticTxPowerControl, cambium=cambium, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, management=management, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortDisabledWarning=managementPortDisabledWarning, bootVersion=bootVersion, phyControlGroup=phyControlGroup, userTable=userTable, ptpGroups=ptpGroups, userEnabled=userEnabled, ptmp=ptmp, telecom=telecom, transmitPower=transmitPower, installStatus=installStatus, sntp=sntp, sNMPTrapTable=sNMPTrapTable, targetRange=targetRange, longitude=longitude, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, receiveDataRate=receiveDataRate, encryptionAlgorithm=encryptionAlgorithm, accessMethod=accessMethod, sNTPServerIPAddress=sNTPServerIPAddress, groupID=groupID, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBLoopback=channelBLoopback, systemReset=systemReset, byteErrorRatio=byteErrorRatio, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, receiveChannel=receiveChannel, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, userTableEntry=userTableEntry, dfsTableEntry=dfsTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dSCPManagementPriority=dSCPManagementPriority, sNTPState=sNTPState, vLANManagementVID=vLANManagementVID, sNTPServerTableIndex=sNTPServerTableIndex, installStatusTrap=installStatusTrap, channelALoopbackTrap=channelALoopbackTrap, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, siteName=siteName, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, userName=userName, telecomGroup=telecomGroup, dfsGroup=dfsGroup, phyControl=phyControl, linkSymmetry=linkSymmetry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, supplementaryGroup=supplementaryGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, targetMACAddress=targetMACAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, vLANManagementPriority=vLANManagementPriority, remoteInternetAddressType=remoteInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, notificationsGroup=notificationsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, smtpGroup=smtpGroup, smtp=smtp, syslogState=syslogState, linkLoss=linkLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, pubStatsGroup=pubStatsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, vectorError=vectorError, securityLevel=securityLevel, incompatibleRegionCodes=incompatibleRegionCodes, secureModeAlarm=secureModeAlarm, managementMode=managementMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogControl=syslogControl, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTable=iPDSCPPriorityTable, ptp600=ptp600, iPv6PrefixLength=iPv6PrefixLength, tFTPServerIPAddress=tFTPServerIPAddress, ethernetGroup=ethernetGroup, channelACableLength=channelACableLength, transmitDataRate=transmitDataRate, remoteInternetAddress=remoteInternetAddress, linkName=linkName, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, localPacketFiltering=localPacketFiltering, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, tFTPServerInternetAddressType=tFTPServerInternetAddressType, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerPortNumber=sNTPServerPortNumber, channelChangeTrap=channelChangeTrap, txColorCode=txColorCode, aAAControlGroup=aAAControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortStatus=dataPortStatus, l2CPPriorityTable=l2CPPriorityTable, ptp=ptp, managementGroup=managementGroup, licenceGroup=licenceGroup, qOSPriorityScheme=qOSPriorityScheme, alarms=alarms, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, phyStatus=phyStatus, sNTPServerTimeout=sNTPServerTimeout, ethernetBridgingStatus=ethernetBridgingStatus, softwareVersion=softwareVersion, userRole=userRole, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsTableNumber=dfsTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bridge=bridge, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hardwareVersion=hardwareVersion, ethernet=ethernet, channelBCableLength=channelBCableLength, snmpControlGroup=snmpControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, cableLoss=cableLoss, receiveFreqKHz=receiveFreqKHz, tDDControlGroup=tDDControlGroup, versions=versions, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarning=dataPortDisabledWarning, licence=licence, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBLineCode=channelBLineCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, sNTPServerStatus=sNTPServerStatus, reset=reset, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelALoopback=channelALoopback, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, syslogStateTrap=syslogStateTrap, remoteRxTargetPower=remoteRxTargetPower, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPLastSync=sNTPLastSync, telecomsChannelSelection=telecomsChannelSelection, aAAControl=aAAControl, antennaGain=antennaGain, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTable=mPLSTCPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium)
