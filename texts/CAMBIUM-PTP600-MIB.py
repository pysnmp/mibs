...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userRole=userRole, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPPrimaryServer=sNTPPrimaryServer, pubStatsGroup=pubStatsGroup, syslogClient=syslogClient, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, longitude=longitude, transmitFreqKHz=transmitFreqKHz, dfsTable=dfsTable, aAAControl=aAAControl, daylightSaving=daylightSaving, dataPortAutoMdix=dataPortAutoMdix, sNTPServerTableNumber=sNTPServerTableNumber, bridge=bridge, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPVersion=iPVersion, bandwidthVariant=bandwidthVariant, remoteRxTargetPower=remoteRxTargetPower, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, linkLoss=linkLoss, userName=userName, channelBLoopbackTrap=channelBLoopbackTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userTableNumber=userTableNumber, remoteInternetAddressType=remoteInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTable=l2CPPriorityTable, cambium=cambium, syslogState=syslogState, secureModeAlarmTrap=secureModeAlarmTrap, ethernetBridgingStatus=ethernetBridgingStatus, sNTPSyncTrap=sNTPSyncTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogControl=syslogControl, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecomsInterface=telecomsInterface, localPacketFiltering=localPacketFiltering, incompatibleRegionCodes=incompatibleRegionCodes, resetGroup=resetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6Address=iPv6Address, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, installArmStateTrap=installArmStateTrap, targetRange=targetRange, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteInternetAddress=remoteInternetAddress, hAZLOCConfiguration=hAZLOCConfiguration, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, receiveFreqKHz=receiveFreqKHz, sNMPPortNumber=sNMPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, supplementary=supplementary, ethernet=ethernet, telecomGroup=telecomGroup, siteName=siteName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, telecom=telecom, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, securityLevel=securityLevel, phyControlGroup=phyControlGroup, dfsGroup=dfsGroup, channelALineCode=channelALineCode, accessMethod=accessMethod, dfsTableIndex=dfsTableIndex, channelBLoopback=channelBLoopback, productName=productName, vLANManagementVID=vLANManagementVID, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, sNTPServerTable=sNTPServerTable, smtpGroup=smtpGroup, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, dfs=dfs, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, systemClock=systemClock, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, byteErrorRatio=byteErrorRatio, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveChannel=receiveChannel, versionsGroup=versionsGroup, iPv4Address=iPv4Address, regionCode=regionCode, transmitPower=transmitPower, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, subnetMask=subnetMask, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, telecomsChannelBStatus=telecomsChannelBStatus, altitude=altitude, sntp=sntp, vectorError=vectorError, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, sNMPv3Enable=sNMPv3Enable, automaticTxPowerControl=automaticTxPowerControl, ptp600=ptp600, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStats=pubStats, sNTPState=sNTPState, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, timeZone=timeZone, receiveModulationModeDetail=receiveModulationModeDetail, ethernetBridgingAvailability=ethernetBridgingAvailability, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, dfsTableNumber=dfsTableNumber, transmitChannel=transmitChannel, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBLineCode=channelBLineCode, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, antennaGain=antennaGain, channelBandwidth=channelBandwidth, rawReceivePower=rawReceivePower, dataPortAutoNegotiation=dataPortAutoNegotiation, userPassword=userPassword, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelBCableLength=channelBCableLength, linkName=linkName, licenceGroup=licenceGroup, telecomsChannelSelection=telecomsChannelSelection, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryption=encryption, sNTPServerStatus=sNTPServerStatus, sNTPSync=sNTPSync, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, txColorCode=txColorCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortFiberStatus=dataPortFiberStatus, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, transmitModulationMode=transmitModulationMode, sNTPServerRetries=sNTPServerRetries, rxColorCode=rxColorCode, management=management, snmpControlGroup=snmpControlGroup, groupID=groupID, channelALoopback=channelALoopback, sNTPServerTableIndex=sNTPServerTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, channelALoopbackTrap=channelALoopbackTrap, bridgeGroup=bridgeGroup, tDDControl=tDDControl, sntpGroup=sntpGroup, ptmp=ptmp, ptpCompliance=ptpCompliance, phyControl=phyControl, targetMACAddress=targetMACAddress, productVariant=productVariant, installStatusTrap=installStatusTrap, userEnabled=userEnabled, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTimeout=sNTPServerTimeout, dataPortStatus=dataPortStatus, range=range, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, encryptionGroup=encryptionGroup, rangingMode=rangingMode, ptp=ptp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableEntry=dfsTableEntry, dataPortStatusTrap=dataPortStatusTrap, supplementaryGroup=supplementaryGroup, licence=licence, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyStatusGroup=phyStatusGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, latitude=latitude, userTableEntry=userTableEntry, installStatus=installStatus, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPPollInterval=sNTPPollInterval, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, regionCodeTrap=regionCodeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortDisabledWarning=managementPortDisabledWarning, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, managementPortStatus=managementPortStatus, syslogControlGroup=syslogControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configuration=configuration, managementMode=managementMode, telecomsChannelAStatus=telecomsChannelAStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, ptpTraps=ptpTraps, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, bootVersion=bootVersion, tDDSynchronizationMode=tDDSynchronizationMode, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, dfsPeaks=dfsPeaks, reset=reset, channelACableLength=channelACableLength, telnetPortNumber=telnetPortNumber, tDDControlGroup=tDDControlGroup, managementGroup=managementGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap)
