...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", licence=licence, bridgeGroup=bridgeGroup, receivePower=receivePower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClient=syslogClient, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, phyStatusGroup=phyStatusGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetBridgingAvailability=ethernetBridgingAvailability, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPPrimaryServer=sNTPPrimaryServer, sNMPv3Enable=sNMPv3Enable, productName=productName, userName=userName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, channelALoopbackTrap=channelALoopbackTrap, licenceGroup=licenceGroup, rxColorCode=rxColorCode, sNTPLastSync=sNTPLastSync, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, managementPortStatus=managementPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, userEnabled=userEnabled, altitude=altitude, dfsTableEntry=dfsTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, productVariant=productVariant, dataPortFiberStatus=dataPortFiberStatus, configurationGroup=configurationGroup, iPv6Address=iPv6Address, dfsTable=dfsTable, dfsPeaks=dfsPeaks, tDDControl=tDDControl, l2CPPriorityTable=l2CPPriorityTable, targetMACAddress=targetMACAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, rawReceivePower=rawReceivePower, ptpCompliance=ptpCompliance, ethernet=ethernet, tDDControlGroup=tDDControlGroup, sNTPServerStatus=sNTPServerStatus, userTableNumber=userTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitModulationMode=transmitModulationMode, ethernetPriorityTable=ethernetPriorityTable, userPassword=userPassword, userTableEntry=userTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitChannel=transmitChannel, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSPortNumber=hTTPSPortNumber, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTable=sNMPTrapTable, regionCodeTrap=regionCodeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rangingMode=rangingMode, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, dfsMeans=dfsMeans, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerRetries=sNTPServerRetries, sNTPServerTable=sNTPServerTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, alarms=alarms, sNMPPortNumber=sNMPPortNumber, regionCode=regionCode, sNTPSync=sNTPSync, syslogState=syslogState, sNTPServerTableEntry=sNTPServerTableEntry, remoteInternetAddress=remoteInternetAddress, encryptionGroup=encryptionGroup, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarm=secureModeAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyStatus=phyStatus, timeZone=timeZone, userRole=userRole, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, cableLoss=cableLoss, aAAControl=aAAControl, dfsGroup=dfsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, daylightSaving=daylightSaving, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, resetGroup=resetGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, management=management, longitude=longitude, siteName=siteName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitFreqKHz=transmitFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBLineCode=channelBLineCode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, dfs=dfs, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSAccessEnabled=hTTPSAccessEnabled, linkSymmetry=linkSymmetry, iPv4Address=iPv4Address, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, hAZLOCConfiguration=hAZLOCConfiguration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, eIRP=eIRP, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecomsInterface=telecomsInterface, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, supplementaryGroup=supplementaryGroup, transmitFreqMHz=transmitFreqMHz, wirelessLinkStatus=wirelessLinkStatus, smtp=smtp, dfsTableNumber=dfsTableNumber, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sntpGroup=sntpGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bridge=bridge, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, snmpControl=snmpControl, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementMode=managementMode, iPv6GatewayAddress=iPv6GatewayAddress, telecomsChannelSelection=telecomsChannelSelection, receiveModulationMode=receiveModulationMode, securityLevel=securityLevel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, range=range, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, ptp=ptp, ptpTraps=ptpTraps, channelBCableLength=channelBCableLength, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarmsGroup=alarmsGroup, telecomsChannelBStatus=telecomsChannelBStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sntp=sntp, receiveDataRate=receiveDataRate, dataPortStatus=dataPortStatus, pubStats=pubStats, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, installStatus=installStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, bandwidthVariant=bandwidthVariant, automaticTxPowerControl=automaticTxPowerControl, ptmp=ptmp, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableIndex=dfsTableIndex, ptp600=ptp600, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, latitude=latitude, sNTPState=sNTPState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, antennaGain=antennaGain, transmitDataRate=transmitDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vectorError=vectorError, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkName=linkName, managementGroup=managementGroup, iPv6PrefixLength=iPv6PrefixLength, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, iPVersion=iPVersion, searchState=searchState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortStatusTrap=managementPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, managementPortConfigurationMismatch=managementPortConfigurationMismatch, channelBLoopbackTrap=channelBLoopbackTrap, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, syslogStateTrap=syslogStateTrap, installArmStateTrap=installArmStateTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, encryption=encryption, channelALoopback=channelALoopback, channelACableLength=channelACableLength, softwareVersion=softwareVersion, bootVersion=bootVersion, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, channelALineCode=channelALineCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, ptpGroups=ptpGroups, txColorCode=txColorCode, sNMPCommunityString=sNMPCommunityString, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopback=channelBLoopback, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, groupID=groupID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, frequencyVariant=frequencyVariant, receiveChannel=receiveChannel, telnetAccessEnabled=telnetAccessEnabled, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, installStatusTrap=installStatusTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, aggregateDataRate=aggregateDataRate, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, qOSPriorityScheme=qOSPriorityScheme, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteRxTargetPower=remoteRxTargetPower, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, syslogControl=syslogControl, targetRange=targetRange, syslogControlGroup=syslogControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, transmitPower=transmitPower, hardwareVersion=hardwareVersion, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarning=dataPortDisabledWarning, systemClock=systemClock, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerIPAddress=sMTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup)
