...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, iPv4Address=iPv4Address, receivePower=receivePower, sNTPPrimaryServer=sNTPPrimaryServer, receiveFreqMHz=receiveFreqMHz, supplementaryGroup=supplementaryGroup, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, productVariant=productVariant, managementPortDisabledWarning=managementPortDisabledWarning, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, syslogState=syslogState, channelBandwidth=channelBandwidth, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, targetRange=targetRange, encryptionGroup=encryptionGroup, secureModeAlarmTrap=secureModeAlarmTrap, alarms=alarms, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPv6GatewayAddress=iPv6GatewayAddress, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, configuration=configuration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, syslogClient=syslogClient, telecomsChannelBStatus=telecomsChannelBStatus, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, bridge=bridge, ptpCompliance=ptpCompliance, dfsTableIndex=dfsTableIndex, iPv6PrefixLength=iPv6PrefixLength, bandwidthVariant=bandwidthVariant, range=range, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, userTableNumber=userTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, aAAControl=aAAControl, channelBLoopbackTrap=channelBLoopbackTrap, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerStatus=sNTPServerStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, l2CPPriorityTable=l2CPPriorityTable, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, frequencyVariant=frequencyVariant, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, automaticTxPowerControl=automaticTxPowerControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementary=supplementary, telecomGroup=telecomGroup, syslogClientTrap=syslogClientTrap, longitude=longitude, versions=versions, hardwareVersion=hardwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetMACAddress=targetMACAddress, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoMdix=dataPortAutoMdix, securityLevel=securityLevel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, remoteRxTargetPower=remoteRxTargetPower, ptp=ptp, management=management, timeZone=timeZone, channelBLoopback=channelBLoopback, byteErrorRatio=byteErrorRatio, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ptpGroups=ptpGroups, tDDControlGroup=tDDControlGroup, iPv6Address=iPv6Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configurationGroup=configurationGroup, vLANManagementVID=vLANManagementVID, cambium=cambium, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, aAAControlGroup=aAAControlGroup, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, groupID=groupID, dSCPManagementPriority=dSCPManagementPriority, receiveChannel=receiveChannel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, productName=productName, signalStrengthRatio=signalStrengthRatio, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveDataRate=receiveDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPPortNumber=sNMPPortNumber, altitude=altitude, masterSlaveMode=masterSlaveMode, rawReceivePower=rawReceivePower, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, userTableEntry=userTableEntry, phyControl=phyControl, channelChangeTrap=channelChangeTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortStatus=dataPortStatus, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelBCableLength=channelBCableLength, licenceGroup=licenceGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, qOSPriorityScheme=qOSPriorityScheme, sNTPState=sNTPState, userName=userName, channelBLineCode=channelBLineCode, channelALoopback=channelALoopback, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licence=licence, transmitChannel=transmitChannel, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, telecom=telecom, sntpGroup=sntpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, bridgeGroup=bridgeGroup, syslogStateTrap=syslogStateTrap, hAZLOCConfiguration=hAZLOCConfiguration, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, localPacketFiltering=localPacketFiltering, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPPortNumber=hTTPPortNumber, dfsTable=dfsTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sntp=sntp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsPeaks=dfsPeaks, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, reset=reset, phyControlGroup=phyControlGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, siteName=siteName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, telecomsChannelSelection=telecomsChannelSelection, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, gatewayIPAddress=gatewayIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkSymmetry=linkSymmetry, ethernetBridgingAvailability=ethernetBridgingAvailability, installStatusTrap=installStatusTrap, sNTPLastSync=sNTPLastSync, channelALoopbackTrap=channelALoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerTable=sNTPServerTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, encryption=encryption, antennaGain=antennaGain, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, regionCodeTrap=regionCodeTrap, accessMethod=accessMethod, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxColorCode=rxColorCode, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableNumber=sNTPServerTableNumber, notificationsGroup=notificationsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitModulationMode=transmitModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteInternetAddressType=remoteInternetAddressType, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, channelACableLength=channelACableLength, linkLoss=linkLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", systemReset=systemReset, dfsTableNumber=dfsTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerRetries=sNTPServerRetries, alarmsGroup=alarmsGroup, phyStatus=phyStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, sNTPServerInternetAddress=sNTPServerInternetAddress, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, rangingMode=rangingMode, mPLSTCPriorityTable=mPLSTCPriorityTable, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSync=sNTPSync, dfsGroup=dfsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTable=userTable, sNTPServerTableIndex=sNTPServerTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelALineCode=channelALineCode, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, managementPortStatusTrap=managementPortStatusTrap, transmitPower=transmitPower, smtpGroup=smtpGroup, dfs=dfs, ethernetPriorityTable=ethernetPriorityTable, bootVersion=bootVersion, ptp600=ptp600, managementPortStatus=managementPortStatus, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, latitude=latitude, sNMPTrapTableIndex=sNMPTrapTableIndex, txColorCode=txColorCode, iPVersion=iPVersion, managementMode=managementMode, transmitFreqMHz=transmitFreqMHz)
