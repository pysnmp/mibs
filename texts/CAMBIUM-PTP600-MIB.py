...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", systemReset=systemReset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, channelBLineCode=channelBLineCode, telecom=telecom, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz, telecomsChannelAStatus=telecomsChannelAStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aggregateDataRate=aggregateDataRate, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, management=management, cableLoss=cableLoss, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, altitude=altitude, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, iPVersion=iPVersion, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, eIRP=eIRP, ethernetBridgingAvailability=ethernetBridgingAvailability, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, iPv6GatewayAddress=iPv6GatewayAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptp=ptp, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPEmailAlert=sMTPEmailAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementMode=managementMode, telnetPortNumber=telnetPortNumber, hTTPPortNumber=hTTPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, configurationGroup=configurationGroup, resetGroup=resetGroup, bridge=bridge, sNMPEnabledTraps=sNMPEnabledTraps, targetMACAddress=targetMACAddress, dSCPManagementPriority=dSCPManagementPriority, syslogClient=syslogClient, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, localPacketFiltering=localPacketFiltering, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerStatus=sNTPServerStatus, sNTPPollInterval=sNTPPollInterval, secureModeAlarm=secureModeAlarm, telecomGroup=telecomGroup, unitOutOfCalibration=unitOutOfCalibration, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, bridgeGroup=bridgeGroup, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userName=userName, notificationsGroup=notificationsGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDControlGroup=tDDControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, systemClock=systemClock, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, txColorCode=txColorCode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, hAZLOCConfiguration=hAZLOCConfiguration, rangingMode=rangingMode, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, rawReceivePower=rawReceivePower, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, syslogControlGroup=syslogControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, accessMethod=accessMethod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsPeaks=dfsPeaks, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpGroups=ptpGroups, linkSymmetry=linkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerIPAddress=sNTPServerIPAddress, aAAControlGroup=aAAControlGroup, phyControlGroup=phyControlGroup, ptp600=ptp600, frequencyVariant=frequencyVariant, byteErrorRatio=byteErrorRatio, syslogState=syslogState, telecomsChannelSelection=telecomsChannelSelection, ethernetGroup=ethernetGroup, sNTPServerTable=sNTPServerTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelChangeTrap=channelChangeTrap, automaticTxPowerControl=automaticTxPowerControl, userTableEntry=userTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, channelBCableLength=channelBCableLength, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityTable=ethernetPriorityTable, channelACableLength=channelACableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, softwareVersion=softwareVersion, sntpGroup=sntpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortStatusTrap=managementPortStatusTrap, licenceGroup=licenceGroup, dataPortAutoMdix=dataPortAutoMdix, smtp=smtp, remoteInternetAddress=remoteInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBLoopback=channelBLoopback, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, managementPortStatus=managementPortStatus, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, ptpTraps=ptpTraps, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodes=incompatibleRegionCodes, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, securityLevel=securityLevel, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, linkLoss=linkLoss, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6Address=iPv6Address, productVariant=productVariant, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, channelBLoopbackTrap=channelBLoopbackTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, siteName=siteName, aAAControl=aAAControl, installStatus=installStatus, installStatusTrap=installStatusTrap, bootVersion=bootVersion, pubStats=pubStats, dfsTableNumber=dfsTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, regionCodeTrap=regionCodeTrap, ethernetFiberSupport=ethernetFiberSupport, encryption=encryption, telecomsInterface=telecomsInterface, remoteRxTargetPower=remoteRxTargetPower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelALoopback=channelALoopback, versions=versions, snmpControlGroup=snmpControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, managementGroup=managementGroup, iPv4Address=iPv4Address, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, versionsGroup=versionsGroup, sNTPServerRetries=sNTPServerRetries, userEnabled=userEnabled, ethernet=ethernet, channelALoopbackTrap=channelALoopbackTrap, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, encryptionGroup=encryptionGroup, groupID=groupID, regionCode=regionCode, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, searchState=searchState, timeZone=timeZone, daylightSaving=daylightSaving, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortFiberStatus=dataPortFiberStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsMeans=dfsMeans, targetRange=targetRange, subnetMask=subnetMask, rxColorCode=rxColorCode, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, dfsTable=dfsTable, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsGroup=dfsGroup, PYSNMP_MODULE_ID=cambium, longitude=longitude, l2CPPriorityTable=l2CPPriorityTable, snmpControl=snmpControl, receiveChannel=receiveChannel, remoteInternetAddressType=remoteInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelALineCode=channelALineCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, licence=licence, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementPriority=vLANManagementPriority, hardwareVersion=hardwareVersion, sNTPSync=sNTPSync, linkName=linkName, sNTPPrimaryServer=sNTPPrimaryServer, configuration=configuration, productName=productName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfs=dfs, smtpGroup=smtpGroup, userTable=userTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPLastSync=sNTPLastSync, alarms=alarms, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth)
