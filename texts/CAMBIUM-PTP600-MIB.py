...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTable=sNMPTrapTable, dataPortFiberStatus=dataPortFiberStatus, dfsTable=dfsTable, sNTPServerTable=sNTPServerTable, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bridgeGroup=bridgeGroup, localPacketFiltering=localPacketFiltering, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, versionsGroup=versionsGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, iPVersion=iPVersion, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogState=syslogState, configuration=configuration, ptpGroups=ptpGroups, vLANManagementPriority=vLANManagementPriority, managementPortDisabledWarning=managementPortDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, supplementary=supplementary, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, dfs=dfs, sNMPTrapIPAddress=sNMPTrapIPAddress, reset=reset, searchState=searchState, dataPortAutoMdix=dataPortAutoMdix, remoteRxTargetPower=remoteRxTargetPower, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, eIRP=eIRP, dataPortStatus=dataPortStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, PYSNMP_MODULE_ID=cambium, dfsTableIndex=dfsTableIndex, userTable=userTable, iPv4Address=iPv4Address, wirelessLinkStatus=wirelessLinkStatus, telecomGroup=telecomGroup, channelALoopback=channelALoopback, sNTPServerStatus=sNTPServerStatus, aggregateDataRate=aggregateDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitFreqMHz=transmitFreqMHz, syslogStateTrap=syslogStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableEntry=dfsTableEntry, configurationGroup=configurationGroup, cambium=cambium, telecomsInterface=telecomsInterface, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPPortNumber=sNMPPortNumber, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userPassword=userPassword, managementMode=managementMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableIndex=userTableIndex, telnetPortNumber=telnetPortNumber, licence=licence, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelALineCode=channelALineCode, transmitChannel=transmitChannel, receiveChannel=receiveChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTableIndex=sNTPServerTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, channelACableLength=channelACableLength, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, cableLoss=cableLoss, ethernetPriorityTable=ethernetPriorityTable, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, phyControl=phyControl, managementGroup=managementGroup, remoteInternetAddress=remoteInternetAddress, installArmState=installArmState, regionCode=regionCode, secureModeAlarm=secureModeAlarm, sNTPLastSync=sNTPLastSync, channelALoopbackTrap=channelALoopbackTrap, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBLoopback=channelBLoopback, altitude=altitude, sMTPServerIPAddress=sMTPServerIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, vectorError=vectorError, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsMeans=dfsMeans, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapVersion=sNMPTrapVersion, managementPortStatusTrap=managementPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, encryptionAlgorithm=encryptionAlgorithm, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, productName=productName, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortStatus=managementPortStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemClock=systemClock, tDDControlGroup=tDDControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteInternetAddressType=remoteInternetAddressType, smtpGroup=smtpGroup, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, ethernetGroup=ethernetGroup, telecom=telecom, sNTPSyncTrap=sNTPSyncTrap, daylightSaving=daylightSaving, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerRetries=sNTPServerRetries, subnetMask=subnetMask, frequencyVariant=frequencyVariant, antennaGain=antennaGain, transmitFreqKHz=transmitFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, qOSPriorityScheme=qOSPriorityScheme, tDDControl=tDDControl, alarmsGroup=alarmsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableNumber=l2CPPriorityTableNumber, longitude=longitude, targetRange=targetRange, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpCompliance=ptpCompliance, latitude=latitude, groupID=groupID, channelBLineCode=channelBLineCode, channelBandwidth=channelBandwidth, range=range, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClient=syslogClient, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, pubStats=pubStats, ptpTraps=ptpTraps, ethernetBridgingAvailability=ethernetBridgingAvailability, linkSymmetry=linkSymmetry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptp600=ptp600, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelBCableLength=channelBCableLength, sMTPEmailAlert=sMTPEmailAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelChangeTrap=channelChangeTrap, rangingMode=rangingMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatus=phyStatus, unitOutOfCalibration=unitOutOfCalibration, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, snmpControl=snmpControl, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkLoss=linkLoss, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installStatus=installStatus, installStatusTrap=installStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxColorCode=rxColorCode, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, siteName=siteName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rawReceivePower=rawReceivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, management=management, telecomsChannelBStatus=telecomsChannelBStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hardwareVersion=hardwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, encryption=encryption, telecomsChannelAStatus=telecomsChannelAStatus, hAZLOCConfiguration=hAZLOCConfiguration, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementaryGroup=supplementaryGroup, userRole=userRole, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, sntp=sntp, automaticTxPowerControl=automaticTxPowerControl)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", signalStrengthRatio=signalStrengthRatio, securityLevel=securityLevel, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, txColorCode=txColorCode, bridge=bridge, pubStatsGroup=pubStatsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, bootVersion=bootVersion, versions=versions, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, encryptionGroup=encryptionGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6PrefixLength=iPv6PrefixLength, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6Address=iPv6Address, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, aAAControl=aAAControl, telecomsChannelSelection=telecomsChannelSelection, sNTPPollInterval=sNTPPollInterval, constantPowerSpectralDensity=constantPowerSpectralDensity, accessMethod=accessMethod, sNMPv3Enable=sNMPv3Enable, dfsGroup=dfsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, bandwidthVariant=bandwidthVariant, sNMPCommunityString=sNMPCommunityString, userName=userName, resetGroup=resetGroup, installArmStateTrap=installArmStateTrap, secureModeAlarmTrap=secureModeAlarmTrap, timeZone=timeZone, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, userTableEntry=userTableEntry)
