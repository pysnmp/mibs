...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:56:20 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPrimaryServer=sNTPPrimaryServer, accessMethod=accessMethod, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableEntry=dfsTableEntry, managementMode=managementMode, dfsTableIndex=dfsTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, versions=versions, securityLevel=securityLevel, wirelessLinkStatus=wirelessLinkStatus, rangingMode=rangingMode, installArmState=installArmState, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, encryptionAlgorithm=encryptionAlgorithm, channelALineCode=channelALineCode, syslogClientTrap=syslogClientTrap, channelALoopback=channelALoopback, dataPortAutoNegotiation=dataPortAutoNegotiation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, vectorError=vectorError, userTableNumber=userTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPAccessEnabled=hTTPAccessEnabled, phyControlGroup=phyControlGroup, systemClock=systemClock, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, userName=userName, receiveModulationMode=receiveModulationMode, channelBLoopbackTrap=channelBLoopbackTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, qOSPriorityScheme=qOSPriorityScheme, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatus=installStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfs=dfs, receiveFreqMHz=receiveFreqMHz, phyControl=phyControl, transmitModulationMode=transmitModulationMode, latitude=latitude, managementGroup=managementGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelBLineCode=channelBLineCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, eIRP=eIRP, phyStatusGroup=phyStatusGroup, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitChannel=transmitChannel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, antennaGain=antennaGain, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, bootVersion=bootVersion, dfsGroup=dfsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementPriority=vLANManagementPriority, transmitFreqKHz=transmitFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, altitude=altitude, reset=reset, snmpControlGroup=snmpControlGroup, txColorCode=txColorCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsMeans=dfsMeans, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, longitude=longitude, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBLoopback=channelBLoopback, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userTableEntry=userTableEntry, sNTPState=sNTPState, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, iPv6PrefixLength=iPv6PrefixLength, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogState=syslogState, syslogStateTrap=syslogStateTrap, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, sntpGroup=sntpGroup, receiveChannel=receiveChannel, transmitPower=transmitPower, rxColorCode=rxColorCode, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, smtp=smtp, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, sNTPServerTableIndex=sNTPServerTableIndex, managementPortStatus=managementPortStatus, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelBCableLength=channelBCableLength, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, configuration=configuration, telnetPortNumber=telnetPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, productVariant=productVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelACableLength=channelACableLength, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerIPAddress=sNTPServerIPAddress, dfsPeaks=dfsPeaks, iPv4Address=iPv4Address, masterSlaveMode=masterSlaveMode, rawReceivePower=rawReceivePower, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, searchState=searchState, range=range, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configurationGroup=configurationGroup, telecomsChannelSelection=telecomsChannelSelection, linkSymmetry=linkSymmetry, cambium=cambium, alarmsGroup=alarmsGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomGroup=telecomGroup, userRole=userRole, phyStatus=phyStatus, smtpGroup=smtpGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, remoteInternetAddressType=remoteInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerRetries=sNTPServerRetries, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installStatusTrap=installStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTraps=ptpTraps, encryptionGroup=encryptionGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPSync=sNTPSync, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sntp=sntp, groupID=groupID, automaticTxPowerControl=automaticTxPowerControl, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, telecomsInterface=telecomsInterface, sNTPServerTable=sNTPServerTable, channelChangeTrap=channelChangeTrap, ptp600=ptp600, remoteInternetAddress=remoteInternetAddress, telecomsChannelBStatus=telecomsChannelBStatus, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetGroup=ethernetGroup, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, productName=productName, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelALoopbackTrap=channelALoopbackTrap, systemReset=systemReset, regionCode=regionCode, ethernetPriorityTable=ethernetPriorityTable, secondarySoftwareVersion=secondarySoftwareVersion, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibration=unitOutOfCalibration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementary=supplementary, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, iPVersion=iPVersion, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, licence=licence, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, ptmp=ptmp, aAAControl=aAAControl, tFTPServerIPAddress=tFTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", softwareVersion=softwareVersion, syslogClient=syslogClient, localPacketFiltering=localPacketFiltering, remoteRxTargetPower=remoteRxTargetPower, managementPortConfigurationMismatch=managementPortConfigurationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerStatus=sNTPServerStatus, dataPortStatus=dataPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bridge=bridge, telnetAccessEnabled=telnetAccessEnabled, iPv6Address=iPv6Address, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, frequencyVariant=frequencyVariant, tDDControl=tDDControl, ptpTrapPrefix=ptpTrapPrefix, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, licenceGroup=licenceGroup, l2CPPriorityTable=l2CPPriorityTable, secureModeAlarm=secureModeAlarm, resetGroup=resetGroup, targetRange=targetRange, sMTPEmailAlert=sMTPEmailAlert, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTableEntry=sNTPServerTableEntry, receivePower=receivePower, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTable=userTable, ptp=ptp, pubStatsGroup=pubStatsGroup, ethernetBridgingStatus=ethernetBridgingStatus, bandwidthVariant=bandwidthVariant, transmitDataRate=transmitDataRate, tFTPServerInternetAddress=tFTPServerInternetAddress, aggregateDataRate=aggregateDataRate, pubStats=pubStats)
