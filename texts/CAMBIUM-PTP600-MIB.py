...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptpTraps=ptpTraps, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementGroup=managementGroup, l2CPPriorityTable=l2CPPriorityTable, transmitFreqKHz=transmitFreqKHz, ethernet=ethernet, masterSlaveMode=masterSlaveMode, configuration=configuration, maximumTransmitPower=maximumTransmitPower, sNMPPortNumber=sNMPPortNumber, pubStats=pubStats, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, remoteInternetAddressType=remoteInternetAddressType, licenceGroup=licenceGroup, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecom=telecom, alarms=alarms, syslogControl=syslogControl, phyControlGroup=phyControlGroup, encryptionGroup=encryptionGroup, gatewayIPAddress=gatewayIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsMeans=dfsMeans, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, encryption=encryption, receiveChannel=receiveChannel, channelALineCode=channelALineCode, receiveFreqKHz=receiveFreqKHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, siteName=siteName, bootVersion=bootVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControlGroup=snmpControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, antennaGain=antennaGain, ptpCompliance=ptpCompliance, groupID=groupID, dataPortAutoMdix=dataPortAutoMdix, cableLoss=cableLoss, rangingMode=rangingMode, receivePower=receivePower, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyStatus=phyStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogClient=syslogClient, telecomsInterface=telecomsInterface, productVariant=productVariant, bandwidthVariant=bandwidthVariant, installArmStateTrap=installArmStateTrap, sNTPPrimaryServer=sNTPPrimaryServer, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, dfsTableIndex=dfsTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSyncTrap=sNTPSyncTrap, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, frequencyVariant=frequencyVariant, linkLoss=linkLoss, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPLastSync=sNTPLastSync, remoteInternetAddress=remoteInternetAddress, channelACableLength=channelACableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, rawReceivePower=rawReceivePower, syslogControlGroup=syslogControlGroup, versionsGroup=versionsGroup, transmitDataRate=transmitDataRate, iPv6GatewayAddress=iPv6GatewayAddress, hTTPSPortNumber=hTTPSPortNumber, iPv6Address=iPv6Address, reset=reset, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEmailAlert=sMTPEmailAlert, userEnabled=userEnabled, installStatus=installStatus, userRole=userRole, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, smtpGroup=smtpGroup, channelALoopback=channelALoopback, tDDControlGroup=tDDControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBLoopback=channelBLoopback, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dSCPManagementPriority=dSCPManagementPriority, configurationGroup=configurationGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, securityLevel=securityLevel, transmitFreqMHz=transmitFreqMHz, managementPortStatus=managementPortStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerPortNumber=sNTPServerPortNumber, managementPortStatusTrap=managementPortStatusTrap, userTableEntry=userTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerStatus=sNTPServerStatus, versions=versions, dataPortDisabledWarning=dataPortDisabledWarning, rxColorCode=rxColorCode, transmitChannel=transmitChannel, ethernetGroup=ethernetGroup, sNTPState=sNTPState, bridgeGroup=bridgeGroup, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv4Address=iPv4Address, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarm=secureModeAlarm, sNTPServerTimeout=sNTPServerTimeout, vectorError=vectorError, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, receiveDataRate=receiveDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerRetries=sNTPServerRetries, subnetMask=subnetMask, dfsGroup=dfsGroup, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, linkModeOptimisation=linkModeOptimisation, dfs=dfs, iPVersion=iPVersion, phyStatusGroup=phyStatusGroup, syslogClientTrap=syslogClientTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementVID=vLANManagementVID, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userName=userName, iPv6PrefixLength=iPv6PrefixLength, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, vLANManagementPriority=vLANManagementPriority, encryptionAlgorithm=encryptionAlgorithm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, management=management, licence=licence, managementMode=managementMode, bridge=bridge, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, syslogState=syslogState, softwareVersion=softwareVersion, altitude=altitude, ptpGroups=ptpGroups, automaticTxPowerControl=automaticTxPowerControl, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelSelection=telecomsChannelSelection, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, smtp=smtp, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteIPAddress=remoteIPAddress, receiveFreqMHz=receiveFreqMHz, transmitModulationMode=transmitModulationMode, ethernetFiberSupport=ethernetFiberSupport, productName=productName, sntpGroup=sntpGroup, localPacketFiltering=localPacketFiltering, hTTPPortNumber=hTTPPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, txColorCode=txColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, tDDControl=tDDControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, resetGroup=resetGroup, ptp600=ptp600, ptp=ptp, channelALoopbackTrap=channelALoopbackTrap, sNTPServerTable=sNTPServerTable, channelBLoopbackTrap=channelBLoopbackTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableNumber=userTableNumber, ptmp=ptmp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelAStatus=telecomsChannelAStatus, sNTPSync=sNTPSync, eIRP=eIRP, latitude=latitude, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, channelBCableLength=channelBCableLength, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTable=userTable, mPLSTCPriorityTable=mPLSTCPriorityTable, alarmsGroup=alarmsGroup, regionCode=regionCode, targetRange=targetRange, telecomsChannelBStatus=telecomsChannelBStatus, channelChangeTrap=channelChangeTrap, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap, accessMethod=accessMethod, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBLineCode=channelBLineCode, hAZLOCConfiguration=hAZLOCConfiguration, supplementaryGroup=supplementaryGroup, linkSymmetry=linkSymmetry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, snmpControl=snmpControl, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetBridgingStatus=ethernetBridgingStatus, searchState=searchState, longitude=longitude, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex)
