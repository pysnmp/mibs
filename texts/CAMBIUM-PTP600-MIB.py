...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptpCompliance=ptpCompliance, dataPortDisabledWarning=dataPortDisabledWarning, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsMeans=dfsMeans, sMTPEmailAlert=sMTPEmailAlert, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, rxColorCode=rxColorCode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsTableNumber=dfsTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPVersion=iPVersion, ptp600=ptp600, licenceGroup=licenceGroup, channelALoopback=channelALoopback, snmpControl=snmpControl, telecomsChannelSelection=telecomsChannelSelection, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitModulationMode=transmitModulationMode, managementPortDisabledWarning=managementPortDisabledWarning, channelBLoopback=channelBLoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, bridge=bridge, constantPowerSpectralDensity=constantPowerSpectralDensity, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptpGroups=ptpGroups, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControlGroup=aAAControlGroup, configuration=configuration, reset=reset, vLANManagementVID=vLANManagementVID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, dfsTable=dfsTable, dataPortFiberStatus=dataPortFiberStatus, managementGroup=managementGroup, encryptionGroup=encryptionGroup, sNMPv3Enable=sNMPv3Enable, automaticTxPowerControl=automaticTxPowerControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, subnetMask=subnetMask, systemReset=systemReset, channelBandwidth=channelBandwidth, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableEntry=userTableEntry, ptmp=ptmp, sNTPServerTableIndex=sNTPServerTableIndex, supplementary=supplementary, localPacketFiltering=localPacketFiltering, sNMPTrapTable=sNMPTrapTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsGroup=dfsGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, management=management, aAAControl=aAAControl, versionsGroup=versionsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkLoss=linkLoss, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, daylightSaving=daylightSaving, receiveModulationMode=receiveModulationMode, iPv6GatewayAddress=iPv6GatewayAddress, transmitDataRate=transmitDataRate, regionCode=regionCode, syslogClient=syslogClient, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsTableEntry=dfsTableEntry, tDDControl=tDDControl, phyControlGroup=phyControlGroup, syslogControl=syslogControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, ptp=ptp, searchState=searchState, hardwareVersion=hardwareVersion, ethernetPriorityTable=ethernetPriorityTable, iPv6Address=iPv6Address, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, syslogClientTrap=syslogClientTrap, telecomsChannelAStatus=telecomsChannelAStatus, sNTPSync=sNTPSync, regionCodeTrap=regionCodeTrap, installArmStateTrap=installArmStateTrap, timeZone=timeZone, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecom=telecom, userTable=userTable, ptpTraps=ptpTraps, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dSCPManagementPriority=dSCPManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, remoteInternetAddressType=remoteInternetAddressType, receiveChannel=receiveChannel, sNTPServerStatus=sNTPServerStatus, sntpGroup=sntpGroup, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingAvailability=ethernetBridgingAvailability, frequencyVariant=frequencyVariant, ethernet=ethernet, iPv4Address=iPv4Address, channelBLoopbackTrap=channelBLoopbackTrap, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, licence=licence, securityLevel=securityLevel, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, latitude=latitude, configurationGroup=configurationGroup, rawReceivePower=rawReceivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, transmitFreqMHz=transmitFreqMHz, supplementaryGroup=supplementaryGroup, phyStatus=phyStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, installStatusTrap=installStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, channelALineCode=channelALineCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, PYSNMP_MODULE_ID=cambium, encryption=encryption, managementMode=managementMode, productVariant=productVariant, bandwidthVariant=bandwidthVariant, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetBridgingStatus=ethernetBridgingStatus, userTableIndex=userTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, secureModeAlarm=secureModeAlarm, userName=userName, snmpControlGroup=snmpControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, channelChangeTrap=channelChangeTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, secureModeAlarmTrap=secureModeAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPrimaryServer=sNTPPrimaryServer, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, channelALoopbackTrap=channelALoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, productName=productName, ethernetFiberSupport=ethernetFiberSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, receivePower=receivePower, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomGroup=telecomGroup, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, txColorCode=txColorCode, eIRP=eIRP, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerTable=sNTPServerTable, channelBCableLength=channelBCableLength, alarms=alarms, targetRange=targetRange, wirelessLinkStatus=wirelessLinkStatus, altitude=altitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userEnabled=userEnabled, remoteRxTargetPower=remoteRxTargetPower, accessMethod=accessMethod, transmitChannel=transmitChannel, telecomsInterface=telecomsInterface, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortStatus=dataPortStatus, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz, siteName=siteName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtp=smtp, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, sNTPServerInternetAddressType=sNTPServerInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerRetries=sNTPServerRetries, masterSlaveMode=masterSlaveMode, sntp=sntp, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoMdix=dataPortAutoMdix, channelACableLength=channelACableLength, sMTPEnabledMessages=sMTPEnabledMessages, installStatus=installStatus, remoteInternetAddress=remoteInternetAddress, systemClock=systemClock, bridgeGroup=bridgeGroup, syslogControlGroup=syslogControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rangingMode=rangingMode, phyControl=phyControl, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelBStatus=telecomsChannelBStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableIndex=dfsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfs=dfs, softwareVersion=softwareVersion, pubStats=pubStats, cambium=cambium, range=range, hAZLOCConfiguration=hAZLOCConfiguration, managementPortStatus=managementPortStatus, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, groupID=groupID, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, channelBLineCode=channelBLineCode, syslogState=syslogState, iPDSCPPriorityTable=iPDSCPPriorityTable)
