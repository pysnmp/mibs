...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionGroup=encryptionGroup, remoteInternetAddress=remoteInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogClientTrap=syslogClientTrap, syslogControlGroup=syslogControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLineCode=channelBLineCode, smtp=smtp, timeZone=timeZone, qOSPriorityScheme=qOSPriorityScheme, accessMethod=accessMethod, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, byteErrorRatio=byteErrorRatio, syslogStateTrap=syslogStateTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, cableLoss=cableLoss, channelBandwidth=channelBandwidth, iPv6Address=iPv6Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, aAAControlGroup=aAAControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, versionsGroup=versionsGroup, groupID=groupID, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, sNTPServerRetries=sNTPServerRetries, range=range, encryptionAlgorithm=encryptionAlgorithm, iPv4Address=iPv4Address, sNMPCommunityString=sNMPCommunityString, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelALoopbackTrap=channelALoopbackTrap, dataPortStatus=dataPortStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, localPacketFiltering=localPacketFiltering, regionCodeTrap=regionCodeTrap, sNTPSyncTrap=sNTPSyncTrap, channelBLoopbackTrap=channelBLoopbackTrap, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogState=syslogState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, licenceGroup=licenceGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installStatusTrap=installStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, managementPortStatusTrap=managementPortStatusTrap, rangingMode=rangingMode, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, txColorCode=txColorCode, hardwareVersion=hardwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfs=dfs, tDDControlGroup=tDDControlGroup, ptp=ptp, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementMode=managementMode, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, sNTPServerTableIndex=sNTPServerTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTimeout=sNTPServerTimeout, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, encryption=encryption, receivePower=receivePower, dfsMeans=dfsMeans, sMTPServerPortNumber=sMTPServerPortNumber, installStatus=installStatus, dfsTable=dfsTable, pubStats=pubStats, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, sNTPLastSync=sNTPLastSync, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpGroups=ptpGroups, sntp=sntp, installArmState=installArmState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, resetGroup=resetGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDControl=tDDControl, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPv3Enable=sNMPv3Enable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsGroup=dfsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, softwareVersion=softwareVersion, smtpGroup=smtpGroup, iPVersion=iPVersion, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, securityLevel=securityLevel, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, userRole=userRole, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, remoteRxTargetPower=remoteRxTargetPower, syslogClient=syslogClient, alarmsGroup=alarmsGroup, automaticTxPowerControl=automaticTxPowerControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTable=l2CPPriorityTable, eIRP=eIRP, sNTPServerTableEntry=sNTPServerTableEntry, transmitFreqMHz=transmitFreqMHz, vectorError=vectorError, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, productName=productName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, longitude=longitude, frequencyVariant=frequencyVariant, subnetMask=subnetMask, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, aAAControl=aAAControl, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, installArmStateTrap=installArmStateTrap, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, supplementaryGroup=supplementaryGroup, sntpGroup=sntpGroup, iPv6PrefixLength=iPv6PrefixLength, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, ptp600=ptp600, telecomsChannelSelection=telecomsChannelSelection, transmitDataRate=transmitDataRate, ethernetBridgingStatus=ethernetBridgingStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, ptpTraps=ptpTraps, channelALoopback=channelALoopback, latitude=latitude, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, dfsTableEntry=dfsTableEntry, rawReceivePower=rawReceivePower, receiveFreqMHz=receiveFreqMHz, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTable=ethernetPriorityTable, sNTPState=sNTPState, sNTPPrimaryServer=sNTPPrimaryServer, dSCPManagementPriority=dSCPManagementPriority, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, ethernet=ethernet, syslogControl=syslogControl, dataPortAutoMdix=dataPortAutoMdix, channelBCableLength=channelBCableLength, regionCode=regionCode, reset=reset, configuration=configuration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rxColorCode=rxColorCode, channelACableLength=channelACableLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, snmpControl=snmpControl, channelBLoopback=channelBLoopback, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitChannel=transmitChannel, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, notificationsGroup=notificationsGroup, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, telecomsChannelBStatus=telecomsChannelBStatus, daylightSaving=daylightSaving, telecom=telecom, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, configurationGroup=configurationGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, pubStatsGroup=pubStatsGroup, userTableEntry=userTableEntry, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelAStatus=telecomsChannelAStatus, linkModeOptimisation=linkModeOptimisation)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hAZLOCConfiguration=hAZLOCConfiguration, vLANManagementVID=vLANManagementVID, bridgeGroup=bridgeGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, remoteInternetAddressType=remoteInternetAddressType, targetMACAddress=targetMACAddress, transmitPower=transmitPower, hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, wirelessLinkAvailability=wirelessLinkAvailability, searchState=searchState, userTable=userTable, userName=userName, receiveDataRate=receiveDataRate, targetRange=targetRange, antennaGain=antennaGain, dataPortFiberStatus=dataPortFiberStatus, managementPortStatus=managementPortStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelALineCode=channelALineCode, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, sNMPEnabledTraps=sNMPEnabledTraps, telecomGroup=telecomGroup, siteName=siteName, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bridge=bridge, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, maximumTransmitPower=maximumTransmitPower, dfsPeaks=dfsPeaks, sNTPServerStatus=sNTPServerStatus, bandwidthVariant=bandwidthVariant, ptmp=ptmp, versions=versions, hTTPPortNumber=hTTPPortNumber)
