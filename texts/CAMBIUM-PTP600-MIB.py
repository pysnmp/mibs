...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:36:09 2021
...
Bits, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, enterprises, IpAddress, ModuleIdentity, Unsigned32, TimeTicks, Gauge32, NotificationType, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "enterprises", "IpAddress", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "NotificationType", "iso", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControlGroup=phyControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, smtp=smtp, encryption=encryption, linkLoss=linkLoss, localPacketFiltering=localPacketFiltering, wirelessLinkStatus=wirelessLinkStatus, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortDisabledWarning=dataPortDisabledWarning, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6Address=iPv6Address, productVariant=productVariant, telnetPortNumber=telnetPortNumber, systemReset=systemReset, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernet=ethernet, snmpControl=snmpControl, ethernetGroup=ethernetGroup, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, remoteInternetAddressType=remoteInternetAddressType, sNMPv3Enable=sNMPv3Enable, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, securityLevel=securityLevel, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, transmitFreqKHz=transmitFreqKHz, management=management, timeZone=timeZone, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, sNTPLastSync=sNTPLastSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, txColorCode=txColorCode, sMTPEmailAlert=sMTPEmailAlert, userName=userName, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, qOSPriorityScheme=qOSPriorityScheme, ptp600=ptp600, sNTPServerTableEntry=sNTPServerTableEntry, channelALineCode=channelALineCode, searchState=searchState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv4Address=iPv4Address, configuration=configuration, phyStatus=phyStatus, bridgeGroup=bridgeGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsTable=dfsTable, ptpCompliance=ptpCompliance, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementary=supplementary, dfsPeaks=dfsPeaks, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, sNTPPrimaryServer=sNTPPrimaryServer, automaticTxPowerControl=automaticTxPowerControl, dfsTableNumber=dfsTableNumber, userTableEntry=userTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerRetries=sNTPServerRetries, linkName=linkName, dataPortStatusTrap=dataPortStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dSCPManagementPriority=dSCPManagementPriority, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, linkSymmetry=linkSymmetry, installArmStateTrap=installArmStateTrap, systemClock=systemClock, phyControl=phyControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, ptpTraps=ptpTraps, managementPortStatus=managementPortStatus, sNMPTrapVersion=sNMPTrapVersion, smtpGroup=smtpGroup, cableLoss=cableLoss, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridge=bridge, syslogControl=syslogControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secureModeAlarm=secureModeAlarm, channelChangeTrap=channelChangeTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, masterSlaveMode=masterSlaveMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, aggregateDataRate=aggregateDataRate, telecomsChannelAStatus=telecomsChannelAStatus, regionCode=regionCode, dataPortStatus=dataPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetRange=targetRange, sNTPServerStatus=sNTPServerStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, managementGroup=managementGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPSync=sNTPSync, installArmState=installArmState, rxColorCode=rxColorCode, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, receiveFreqKHz=receiveFreqKHz, remoteRxTargetPower=remoteRxTargetPower, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, channelALoopback=channelALoopback, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, accessMethod=accessMethod, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, productName=productName, receivePower=receivePower, eIRP=eIRP, sMTPServerIPAddress=sMTPServerIPAddress, telecomGroup=telecomGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveChannel=receiveChannel, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp=ptp, ptpGroups=ptpGroups, userPassword=userPassword, unitOutOfCalibration=unitOutOfCalibration, byteErrorRatio=byteErrorRatio, subnetMask=subnetMask, userEnabled=userEnabled, range=range, channelBLineCode=channelBLineCode, licenceGroup=licenceGroup, dfsMeans=dfsMeans, channelBandwidth=channelBandwidth, iPVersion=iPVersion, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTable=ethernetPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDControl=tDDControl, ethernetBridgingStatus=ethernetBridgingStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTable=sNMPTrapTable, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, regionCodeTrap=regionCodeTrap, alarms=alarms, longitude=longitude, targetMACAddress=targetMACAddress, altitude=altitude, hTTPSPortNumber=hTTPSPortNumber, installStatusTrap=installStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableIndex=dfsTableIndex, hardwareVersion=hardwareVersion, bootVersion=bootVersion, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, userTable=userTable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, latitude=latitude, telecomsInterface=telecomsInterface, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, ptmp=ptmp, channelBLoopback=channelBLoopback, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecom=telecom, configurationGroup=configurationGroup, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, dataPortFiberStatus=dataPortFiberStatus, iPv6GatewayAddress=iPv6GatewayAddress, userTableNumber=userTableNumber, l2CPPriorityTable=l2CPPriorityTable, iPv6PrefixLength=iPv6PrefixLength, frequencyVariant=frequencyVariant, syslogState=syslogState, ptpTrapPrefix=ptpTrapPrefix, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBCableLength=channelBCableLength, l2CPPriorityTableEntry=l2CPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, telnetAccessEnabled=telnetAccessEnabled, resetGroup=resetGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetFiberSupport=ethernetFiberSupport, rawReceivePower=rawReceivePower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, notificationsGroup=notificationsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitModulationMode=transmitModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, softwareVersion=softwareVersion, reset=reset, dfsGroup=dfsGroup, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, sNMPPortNumber=sNMPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTable=sNTPServerTable, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licence=licence, channelALoopbackTrap=channelALoopbackTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, cambium=cambium, sNTPServerTableIndex=sNTPServerTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secureModeAlarmTrap=secureModeAlarmTrap, remoteInternetAddress=remoteInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitPower=transmitPower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementPriority=vLANManagementPriority, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelACableLength=channelACableLength, receiveModulationMode=receiveModulationMode, sNTPState=sNTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap)
