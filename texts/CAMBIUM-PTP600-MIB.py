...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatus=ethernetBridgingStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, dataPortAutoMdix=dataPortAutoMdix, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortStatusTrap=managementPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenceGroup=licenceGroup, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, qOSPriorityScheme=qOSPriorityScheme, vectorError=vectorError, transmitModulationMode=transmitModulationMode, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, securityLevel=securityLevel, telecomsChannelBStatus=telecomsChannelBStatus, installStatusTrap=installStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBCableLength=channelBCableLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installArmStateTrap=installArmStateTrap, sntp=sntp, managementMode=managementMode, channelBandwidth=channelBandwidth, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpGroups=ptpGroups, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rxColorCode=rxColorCode, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortStatus=managementPortStatus, transmitFreqMHz=transmitFreqMHz, dataPortFiberStatusTrap=dataPortFiberStatusTrap, accessMethod=accessMethod, syslogStateTrap=syslogStateTrap, sNTPServerTable=sNTPServerTable, dfs=dfs, telecomsChannelSelection=telecomsChannelSelection, systemReset=systemReset, remoteRxTargetPower=remoteRxTargetPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, ptp600=ptp600, ptpTraps=ptpTraps, userEnabled=userEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimisation=linkModeOptimisation, licence=licence, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSync=sNTPSync, hTTPSPortNumber=hTTPSPortNumber, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, daylightSaving=daylightSaving, linkSymmetry=linkSymmetry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClientTrap=syslogClientTrap, incompatibleRegionCodes=incompatibleRegionCodes, signalStrengthRatio=signalStrengthRatio, receiveFreqMHz=receiveFreqMHz, masterSlaveMode=masterSlaveMode, syslogClient=syslogClient, snmpControlGroup=snmpControlGroup, localPacketFiltering=localPacketFiltering, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, telecom=telecom, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsMeans=dfsMeans, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, cambium=cambium, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aggregateDataRate=aggregateDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receivePower=receivePower, dataPortFiberStatus=dataPortFiberStatus, userTableEntry=userTableEntry, versions=versions, dfsTableIndex=dfsTableIndex, automaticTxPowerControl=automaticTxPowerControl, userTableIndex=userTableIndex, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, channelACableLength=channelACableLength, phyControl=phyControl, alarmsGroup=alarmsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTable=userTable, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, iPv4Address=iPv4Address, ptmp=ptmp, productName=productName, sNTPServerTimeout=sNTPServerTimeout, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPState=sNTPState, phyStatusGroup=phyStatusGroup, channelChangeTrap=channelChangeTrap, dSCPManagementPriority=dSCPManagementPriority, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, installStatus=installStatus, dfsTableEntry=dfsTableEntry, sNTPSyncTrap=sNTPSyncTrap, ptp=ptp, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rawReceivePower=rawReceivePower, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, channelALoopback=channelALoopback, remoteInternetAddress=remoteInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPPrimaryServer=sNTPPrimaryServer, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, longitude=longitude, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, managementPortDisabledWarning=managementPortDisabledWarning, phyControlGroup=phyControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, encryption=encryption, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryptionAlgorithm=encryptionAlgorithm, bandwidthVariant=bandwidthVariant, syslogState=syslogState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userPassword=userPassword, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBLoopback=channelBLoopback, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, reset=reset, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, encryptionGroup=encryptionGroup, supplementary=supplementary, sNMPTrapTableEntry=sNMPTrapTableEntry, phyStatus=phyStatus, iPVersion=iPVersion, range=range, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetFiberSupport=ethernetFiberSupport, rangingMode=rangingMode, dataPortAutoNegotiation=dataPortAutoNegotiation, productVariant=productVariant, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCode=regionCode, ethernet=ethernet, channelALineCode=channelALineCode, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkName=linkName, snmpControl=snmpControl, channelALoopbackTrap=channelALoopbackTrap, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpCompliance=ptpCompliance, channelBLoopbackTrap=channelBLoopbackTrap, timeZone=timeZone, supplementaryGroup=supplementaryGroup, userRole=userRole, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, dataPortStatus=dataPortStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogControl=syslogControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, sNTPServerStatus=sNTPServerStatus, latitude=latitude, secureModeAlarmTrap=secureModeAlarmTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bootVersion=bootVersion, siteName=siteName, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, smtp=smtp, ptpTrapPrefix=ptpTrapPrefix, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, cableLoss=cableLoss, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, targetRange=targetRange, ethernetBridgingAvailability=ethernetBridgingAvailability, configuration=configuration, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, iPv6Address=iPv6Address, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsGroup=dfsGroup, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, sNTPServerTableNumber=sNTPServerTableNumber, bridge=bridge, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bridgeGroup=bridgeGroup, transmitPower=transmitPower, hAZLOCConfiguration=hAZLOCConfiguration, dataPortStatusTrap=dataPortStatusTrap, remoteInternetAddressType=remoteInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, searchState=searchState, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userName=userName, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, smtpGroup=smtpGroup, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, channelBLineCode=channelBLineCode, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, management=management, transmitChannel=transmitChannel, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, txColorCode=txColorCode, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, receiveChannel=receiveChannel, dfsPeaks=dfsPeaks, ethernetGroup=ethernetGroup, frequencyVariant=frequencyVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap)
