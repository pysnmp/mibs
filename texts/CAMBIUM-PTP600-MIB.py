...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hAZLOCConfiguration=hAZLOCConfiguration, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarmTrap=secureModeAlarmTrap, dfsGroup=dfsGroup, syslogState=syslogState, productVariant=productVariant, remoteIPAddress=remoteIPAddress, rawReceivePower=rawReceivePower, sNTPServerTable=sNTPServerTable, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, userRole=userRole, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBCableLength=channelBCableLength, sNMPPortNumber=sNMPPortNumber, sntp=sntp, transmitFreqMHz=transmitFreqMHz, versions=versions, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelALoopback=channelALoopback, sNTPServerStatus=sNTPServerStatus, userPassword=userPassword, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configuration=configuration, masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClient=syslogClient, bridgeGroup=bridgeGroup, receiveFreqKHz=receiveFreqKHz, channelALoopbackTrap=channelALoopbackTrap, syslogControl=syslogControl, tDDControlGroup=tDDControlGroup, subnetMask=subnetMask, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, bridge=bridge, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelBLoopback=channelBLoopback, dSCPManagementPriority=dSCPManagementPriority, dfsTableIndex=dfsTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, ethernetPriorityTable=ethernetPriorityTable, hTTPSPortNumber=hTTPSPortNumber, supplementary=supplementary, qOSPriorityScheme=qOSPriorityScheme, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, management=management, pubStatsGroup=pubStatsGroup, rxColorCode=rxColorCode, receiveChannel=receiveChannel, l2CPPriorityTableIndex=l2CPPriorityTableIndex, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementMode=managementMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteInternetAddress=remoteInternetAddress, managementPortStatus=managementPortStatus, securityLevel=securityLevel, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, channelACableLength=channelACableLength, ethernet=ethernet, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, targetMACAddress=targetMACAddress, softwareVersion=softwareVersion, ptp=ptp, telecomsChannelSelection=telecomsChannelSelection, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, ptpGroups=ptpGroups, latitude=latitude, sMTPServerInternetAddress=sMTPServerInternetAddress, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, secureModeAlarm=secureModeAlarm, userTableIndex=userTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, linkModeOptimisation=linkModeOptimisation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sntpGroup=sntpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTable=dfsTable, telecomGroup=telecomGroup, managementGroup=managementGroup, dfsPeaks=dfsPeaks, encryptionGroup=encryptionGroup, channelALineCode=channelALineCode, daylightSaving=daylightSaving, remoteRxTargetPower=remoteRxTargetPower, dataPortFiberStatus=dataPortFiberStatus, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, localPacketFiltering=localPacketFiltering, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoMdix=dataPortAutoMdix, sNMPv3Enable=sNMPv3Enable, iPv6GatewayAddress=iPv6GatewayAddress, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTable=sNMPTrapTable, receiveModulationMode=receiveModulationMode, iPv6Address=iPv6Address, sNTPServerInternetAddress=sNTPServerInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableLoss=cableLoss, alarms=alarms, pubStats=pubStats, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkAvailability=wirelessLinkAvailability, cambium=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, groupID=groupID, regionCode=regionCode, systemClock=systemClock, bandwidthVariant=bandwidthVariant, rangingMode=rangingMode, txColorCode=txColorCode, targetRange=targetRange, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, PYSNMP_MODULE_ID=cambium, smtp=smtp, frequencyVariant=frequencyVariant, syslogStateTrap=syslogStateTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, dfs=dfs, syslogClientTrap=syslogClientTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receivePower=receivePower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddressType=tFTPServerInternetAddressType, range=range, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortStatusTrap=dataPortStatusTrap, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, reset=reset, phyControl=phyControl, telecomsChannelBStatus=telecomsChannelBStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, systemReset=systemReset, userTableNumber=userTableNumber, ptp600=ptp600, receiveDataRate=receiveDataRate, aAAControl=aAAControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, tDDControl=tDDControl, installArmState=installArmState, dfsTableNumber=dfsTableNumber, userTable=userTable, sNMPTrapVersion=sNMPTrapVersion, transmitChannel=transmitChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, sNTPServerIPAddress=sNTPServerIPAddress, iPv4Address=iPv4Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bootVersion=bootVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installArmStateTrap=installArmStateTrap, ptmp=ptmp, syslogControlGroup=syslogControlGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, altitude=altitude, alarmsGroup=alarmsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, installStatusTrap=installStatusTrap, hardwareVersion=hardwareVersion, dfsTableEntry=dfsTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licence=licence, telecom=telecom, iPv6PrefixLength=iPv6PrefixLength, dfsMeans=dfsMeans, linkSymmetry=linkSymmetry, channelBLineCode=channelBLineCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableEntry=userTableEntry, channelBandwidth=channelBandwidth, siteName=siteName, installStatus=installStatus, byteErrorRatio=byteErrorRatio, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, iPVersion=iPVersion, sNTPServerTableIndex=sNTPServerTableIndex, signalStrengthRatio=signalStrengthRatio, tFTPServerIPAddress=tFTPServerIPAddress, eIRP=eIRP, encryption=encryption, sNTPSync=sNTPSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup)
