...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkName=linkName, receiveModulationModeDetail=receiveModulationModeDetail, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelACableLength=channelACableLength, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, automaticTxPowerControl=automaticTxPowerControl, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTimeout=sNTPServerTimeout, sNMPPortNumber=sNMPPortNumber, timeZone=timeZone, sNTPServerTableIndex=sNTPServerTableIndex, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, configuration=configuration, vectorError=vectorError, range=range, bridgeGroup=bridgeGroup, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitDataRate=transmitDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, linkSymmetry=linkSymmetry, systemClock=systemClock, managementPortStatus=managementPortStatus, phyControlGroup=phyControlGroup, dataPortFiberStatus=dataPortFiberStatus, remoteInternetAddress=remoteInternetAddress, receiveModulationMode=receiveModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, latitude=latitude, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleRegionCodes=incompatibleRegionCodes, iPv6PrefixLength=iPv6PrefixLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortStatusTrap=dataPortStatusTrap, ptp600=ptp600, receivePower=receivePower, transmitChannel=transmitChannel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsMeans=dfsMeans, systemReset=systemReset, bandwidthVariant=bandwidthVariant, userPassword=userPassword, licence=licence, gatewayIPAddress=gatewayIPAddress, channelBandwidth=channelBandwidth, iPv6Address=iPv6Address, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfs=dfs, configurationGroup=configurationGroup, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, reset=reset, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, cableLoss=cableLoss, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, siteName=siteName, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsTableEntry=dfsTableEntry, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, antennaGain=antennaGain, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, longitude=longitude, iPVersion=iPVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, encryptionAlgorithm=encryptionAlgorithm, tDDControl=tDDControl, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, regionCode=regionCode, sNTPServerTableEntry=sNTPServerTableEntry, userTableEntry=userTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, remoteRxTargetPower=remoteRxTargetPower, transmitFreqMHz=transmitFreqMHz, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, accessMethod=accessMethod, syslogControl=syslogControl, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, frequencyVariant=frequencyVariant, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, installStatus=installStatus, channelBLineCode=channelBLineCode, aAAControlGroup=aAAControlGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, linkModeOptimisation=linkModeOptimisation, userEnabled=userEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortStatusTrap=managementPortStatusTrap, targetMACAddress=targetMACAddress, channelALoopback=channelALoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, resetGroup=resetGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, rawReceivePower=rawReceivePower, managementMode=managementMode, l2CPPriorityTable=l2CPPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, userTable=userTable, userName=userName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, telecomsInterface=telecomsInterface, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secureModeAlarm=secureModeAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sntpGroup=sntpGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTable=sNTPServerTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, dfsPeaks=dfsPeaks, eIRP=eIRP, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, dataPortStatus=dataPortStatus, targetRange=targetRange, localPacketFiltering=localPacketFiltering, dfsTableNumber=dfsTableNumber, channelALoopbackTrap=channelALoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveChannel=receiveChannel, sNTPSync=sNTPSync, sNTPState=sNTPState, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBCableLength=channelBCableLength, ethernetBridgingStatus=ethernetBridgingStatus, sNTPLastSync=sNTPLastSync, management=management, iPv4Address=iPv4Address, installArmState=installArmState, transmitModulationMode=transmitModulationMode, securityLevel=securityLevel, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userRole=userRole, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, ethernetFiberSupport=ethernetFiberSupport, PYSNMP_MODULE_ID=cambium, byteErrorRatio=byteErrorRatio, sNTPServerRetries=sNTPServerRetries, ptmp=ptmp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernet=ethernet, masterSlaveMode=masterSlaveMode, secureModeAlarmTrap=secureModeAlarmTrap, altitude=altitude, versionsGroup=versionsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, telecom=telecom, notificationsGroup=notificationsGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, alarms=alarms, dfsTableIndex=dfsTableIndex, ptpTrapPrefix=ptpTrapPrefix, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, regionCodeTrap=regionCodeTrap, txColorCode=txColorCode, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityTable=ethernetPriorityTable, cambium=cambium, telecomsChannelAStatus=telecomsChannelAStatus, rangingMode=rangingMode, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionGroup=encryptionGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControl=aAAControl, bootVersion=bootVersion, smtpGroup=smtpGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubStats=pubStats, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyControl=phyControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, vLANManagementVID=vLANManagementVID, channelBLoopback=channelBLoopback, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, wirelessLinkAvailability=wirelessLinkAvailability, productName=productName, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopbackTrap=channelBLoopbackTrap, installArmStateTrap=installArmStateTrap, aggregateDataRate=aggregateDataRate, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hAZLOCConfiguration=hAZLOCConfiguration, remoteInternetAddressType=remoteInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, daylightSaving=daylightSaving, rxColorCode=rxColorCode, ethernetBridgingAvailability=ethernetBridgingAvailability, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, bridge=bridge, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoMdix=dataPortAutoMdix, channelALineCode=channelALineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogControlGroup=syslogControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetPortNumber=telnetPortNumber, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, ptp=ptp, productVariant=productVariant, sNTPServerStatus=sNTPServerStatus, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, ptpTraps=ptpTraps, syslogClient=syslogClient, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
