...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDSynchronizationMode=tDDSynchronizationMode, accessMethod=accessMethod, dataPortStatus=dataPortStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementGroup=managementGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, linkSymmetry=linkSymmetry, userTableNumber=userTableNumber, latitude=latitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBCableLength=channelBCableLength, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerRetries=sNTPServerRetries, sntpGroup=sntpGroup, transmitPower=transmitPower, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelBStatus=telecomsChannelBStatus, remoteRxTargetPower=remoteRxTargetPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, altitude=altitude, managementMode=managementMode, iPv4Address=iPv4Address, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemClock=systemClock, snmpControl=snmpControl, channelBLineCode=channelBLineCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, groupID=groupID, remoteInternetAddress=remoteInternetAddress, targetRange=targetRange, channelALoopbackTrap=channelALoopbackTrap, installArmStateTrap=installArmStateTrap, rxColorCode=rxColorCode, bridge=bridge, dSCPManagementPriority=dSCPManagementPriority, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, syslogClientTrap=syslogClientTrap, phyControl=phyControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStatsGroup=pubStatsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, siteName=siteName, smtpGroup=smtpGroup, regionCodeTrap=regionCodeTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntp=sntp, ethernetBridgingAvailability=ethernetBridgingAvailability, receivePower=receivePower, telecom=telecom, ptpGroups=ptpGroups, linkName=linkName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTableEntry=sNTPServerTableEntry, alarms=alarms, range=range, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, txColorCode=txColorCode, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTrapPrefix=ptpTrapPrefix, secureModeAlarm=secureModeAlarm, ethernetPriorityTable=ethernetPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, qOSPriorityScheme=qOSPriorityScheme, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionGroup=encryptionGroup, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetGroup=ethernetGroup, syslogClient=syslogClient, supplementary=supplementary, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, iPVersion=iPVersion, hAZLOCConfiguration=hAZLOCConfiguration, transmitFreqKHz=transmitFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableIndex=userTableIndex, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, telecomGroup=telecomGroup, tDDControl=tDDControl, dfs=dfs, ptpCompliance=ptpCompliance, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTable=sNTPServerTable, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelSelection=telecomsChannelSelection, sMTPServerIPAddress=sMTPServerIPAddress, iPv6PrefixLength=iPv6PrefixLength, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, tDDControlGroup=tDDControlGroup, ptp600=ptp600, managementPortStatusTrap=managementPortStatusTrap, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, telecomsChannelAStatus=telecomsChannelAStatus, timeZone=timeZone, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, iPv6Address=iPv6Address, rawReceivePower=rawReceivePower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, versionsGroup=versionsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bridgeGroup=bridgeGroup, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hardwareVersion=hardwareVersion, userRole=userRole, vectorError=vectorError, daylightSaving=daylightSaving, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogControlGroup=syslogControlGroup, installStatusTrap=installStatusTrap, phyControlGroup=phyControlGroup, longitude=longitude, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsTableIndex=dfsTableIndex, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, managementPortStatus=managementPortStatus, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName, vLANManagementVID=vLANManagementVID, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelALoopback=channelALoopback, userTableEntry=userTableEntry, aggregateDataRate=aggregateDataRate, dfsTable=dfsTable, linkModeOptimisation=linkModeOptimisation, receiveModulationModeDetail=receiveModulationModeDetail, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, sNTPServerTableIndex=sNTPServerTableIndex, automaticTxPowerControl=automaticTxPowerControl, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, transmitDataRate=transmitDataRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsTableNumber=dfsTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleRegionCodes=incompatibleRegionCodes, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, constantPowerSpectralDensity=constantPowerSpectralDensity, signalStrengthRatio=signalStrengthRatio, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, configurationGroup=configurationGroup, dataPortFiberStatus=dataPortFiberStatus, localPacketFiltering=localPacketFiltering, l2CPPriorityTableIndex=l2CPPriorityTableIndex, productVariant=productVariant, sMTPServerInternetAddress=sMTPServerInternetAddress, antennaGain=antennaGain, l2CPPriorityTable=l2CPPriorityTable, syslogState=syslogState, dataPortAutoMdix=dataPortAutoMdix, installArmState=installArmState, channelBLoopbackTrap=channelBLoopbackTrap, supplementaryGroup=supplementaryGroup, telnetPortNumber=telnetPortNumber, frequencyVariant=frequencyVariant, sNMPCommunityString=sNMPCommunityString, channelBLoopback=channelBLoopback, enabledDiagnosticAlarms=enabledDiagnosticAlarms, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rangingMode=rangingMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userPassword=userPassword, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, channelBandwidth=channelBandwidth, channelALineCode=channelALineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsMeans=dfsMeans, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, installStatus=installStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTimeout=sNTPServerTimeout, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aAAControl=aAAControl, bandwidthVariant=bandwidthVariant, subnetMask=subnetMask, channelACableLength=channelACableLength, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortDisabledWarning=managementPortDisabledWarning, receiveFreqKHz=receiveFreqKHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userName=userName, targetMACAddress=targetMACAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, sNTPSync=sNTPSync, smtp=smtp, sNTPSyncTrap=sNTPSyncTrap, securityLevel=securityLevel, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, byteErrorRatio=byteErrorRatio, userTable=userTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, receiveDataRate=receiveDataRate, configuration=configuration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveChannel=receiveChannel)
