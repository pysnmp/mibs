...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTable=l2CPPriorityTable, targetMACAddress=targetMACAddress, hTTPSPortNumber=hTTPSPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, rangingMode=rangingMode, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, sNTPPrimaryServer=sNTPPrimaryServer, channelALoopback=channelALoopback, telecomsChannelBStatus=telecomsChannelBStatus, telecomsChannelAStatus=telecomsChannelAStatus, hAZLOCConfiguration=hAZLOCConfiguration, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userTableEntry=userTableEntry, channelBCableLength=channelBCableLength, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityTable=ethernetPriorityTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secureModeAlarmTrap=secureModeAlarmTrap, managementGroup=managementGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hardwareVersion=hardwareVersion, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, sNMPv3Enable=sNMPv3Enable, pubStatsGroup=pubStatsGroup, channelChangeTrap=channelChangeTrap, rawReceivePower=rawReceivePower, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, targetRange=targetRange, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, reset=reset, iPVersion=iPVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, siteName=siteName, managementPortDisabledWarning=managementPortDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, groupID=groupID, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sntpGroup=sntpGroup, hTTPPortNumber=hTTPPortNumber, userTableIndex=userTableIndex, searchState=searchState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, range=range, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, smtp=smtp, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, resetGroup=resetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, pubStats=pubStats, ethernetGroup=ethernetGroup, antennaGain=antennaGain, installStatus=installStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, installStatusTrap=installStatusTrap, accessMethod=accessMethod, ethernet=ethernet, ptp600=ptp600, encryption=encryption, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, telecomsInterface=telecomsInterface, dfsMeans=dfsMeans, transmitPower=transmitPower, syslogState=syslogState, versions=versions, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkName=linkName, sntp=sntp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, altitude=altitude, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, softwareVersion=softwareVersion, systemClock=systemClock, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALineCode=channelALineCode, iPv6Address=iPv6Address, txColorCode=txColorCode, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTable=sNTPServerTable, sMTPServerIPAddress=sMTPServerIPAddress, transmitChannel=transmitChannel, ethernetFiberSupport=ethernetFiberSupport, productName=productName, subnetMask=subnetMask, sNTPSync=sNTPSync, channelACableLength=channelACableLength, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, regionCode=regionCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDDControlGroup=tDDControlGroup, userTableNumber=userTableNumber, unitOutOfCalibration=unitOutOfCalibration, dfsGroup=dfsGroup, remoteIPAddress=remoteIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, automaticTxPowerControl=automaticTxPowerControl, licenceGroup=licenceGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, eIRP=eIRP, PYSNMP_MODULE_ID=cambium, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsPeaks=dfsPeaks, ptmp=ptmp, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, licence=licence, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receivePower=receivePower, alarms=alarms, telecom=telecom, bridge=bridge, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vectorError=vectorError, incompatibleRegionCodes=incompatibleRegionCodes, bridgeGroup=bridgeGroup, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, remoteInternetAddress=remoteInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, longitude=longitude, syslogControl=syslogControl, encryptionGroup=encryptionGroup, managementPortStatus=managementPortStatus, systemReset=systemReset, remoteRxTargetPower=remoteRxTargetPower, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, securityLevel=securityLevel, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, userEnabled=userEnabled, userPassword=userPassword, phyStatus=phyStatus, supplementary=supplementary, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, managementPortStatusTrap=managementPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelALoopbackTrap=channelALoopbackTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, maximumTransmitPower=maximumTransmitPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsTable=dfsTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerInternetAddress=sMTPServerInternetAddress, timeZone=timeZone, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogControlGroup=syslogControlGroup, bootVersion=bootVersion, syslogClientTrap=syslogClientTrap, userName=userName, sNTPServerTableEntry=sNTPServerTableEntry, snmpControl=snmpControl, latitude=latitude, signalStrengthRatio=signalStrengthRatio, management=management, tDDControl=tDDControl, telecomsChannelSelection=telecomsChannelSelection, userRole=userRole, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, transmitFreqMHz=transmitFreqMHz, ptpGroups=ptpGroups, secureModeAlarm=secureModeAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, qOSPriorityScheme=qOSPriorityScheme, cambium=cambium, channelBLineCode=channelBLineCode, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerStatus=sNTPServerStatus, productVariant=productVariant, sNTPSyncTrap=sNTPSyncTrap, dfsTableNumber=dfsTableNumber, sNMPCommunityString=sNMPCommunityString, configuration=configuration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6GatewayAddress=iPv6GatewayAddress, tFTPServerPortNumber=tFTPServerPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, vLANManagementPriority=vLANManagementPriority, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", cableLoss=cableLoss, ethernetBridgingAvailability=ethernetBridgingAvailability, configurationGroup=configurationGroup, localPacketFiltering=localPacketFiltering, sNMPTrapVersion=sNMPTrapVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPv4Address=iPv4Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, channelBLoopback=channelBLoopback, telnetAccessEnabled=telnetAccessEnabled, rxColorCode=rxColorCode, managementMode=managementMode, dataPortFiberStatus=dataPortFiberStatus, sNMPPortNumber=sNMPPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomGroup=telecomGroup, wirelessLinkStatus=wirelessLinkStatus, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, gatewayIPAddress=gatewayIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, linkSymmetry=linkSymmetry, aAAControlGroup=aAAControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyControl=phyControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableEntry=dfsTableEntry, sNTPServerIPAddress=sNTPServerIPAddress)
