...
Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, enterprises, Gauge32, Bits, Unsigned32, iso, MibIdentifier, IpAddress, Integer32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "enterprises", "Gauge32", "Bits", "Unsigned32", "iso", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", secureModeAlarmTrap=secureModeAlarmTrap, snmpControl=snmpControl, versions=versions, bridgeGroup=bridgeGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetBridgingStatus=ethernetBridgingStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntp=sntp, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, sMTPEnabledMessages=sMTPEnabledMessages, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, altitude=altitude, versionsGroup=versionsGroup, transmitPower=transmitPower, range=range, licence=licence, userTable=userTable, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarning=dataPortDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerStatus=sNTPServerStatus, bootVersion=bootVersion, sNTPPollInterval=sNTPPollInterval, userTableNumber=userTableNumber, userPassword=userPassword, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerRetries=sNTPServerRetries, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, dfsTableIndex=dfsTableIndex, ptmp=ptmp, searchState=searchState, reset=reset, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelBLoopback=channelBLoopback, accessMethod=accessMethod, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, bridge=bridge, dfsTableEntry=dfsTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, smtp=smtp, systemClock=systemClock, daylightSaving=daylightSaving, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, txColorCode=txColorCode, channelALineCode=channelALineCode, transmitChannel=transmitChannel, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, bandwidthVariant=bandwidthVariant, dfs=dfs, licenceGroup=licenceGroup, hTTPSPortNumber=hTTPSPortNumber, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, receivePower=receivePower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitModulationMode=transmitModulationMode, channelACableLength=channelACableLength, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, userName=userName, userEnabled=userEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBLineCode=channelBLineCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControl=phyControl, targetMACAddress=targetMACAddress, installStatus=installStatus, dataPortStatusTrap=dataPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6GatewayAddress=iPv6GatewayAddress, sNMPv3Enable=sNMPv3Enable, dataPortAutoMdix=dataPortAutoMdix, secureModeAlarm=secureModeAlarm, byteErrorRatio=byteErrorRatio, receiveModulationModeDetail=receiveModulationModeDetail, longitude=longitude, resetGroup=resetGroup, phyStatusGroup=phyStatusGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortStatusTrap=managementPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTable=l2CPPriorityTable, productName=productName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, userRole=userRole, telecomsChannelAStatus=telecomsChannelAStatus, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmState=installArmState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, latitude=latitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptpCompliance=ptpCompliance, receiveChannel=receiveChannel, alarms=alarms, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, ptp=ptp, rangingMode=rangingMode, localPacketFiltering=localPacketFiltering, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapVersion=sNMPTrapVersion, userTableIndex=userTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPPortNumber=hTTPPortNumber, maximumTransmitPower=maximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, softwareVersion=softwareVersion, telnetAccessEnabled=telnetAccessEnabled, sNTPSync=sNTPSync, telecomsChannelSelection=telecomsChannelSelection, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityTable=ethernetPriorityTable, tFTPServerInternetAddress=tFTPServerInternetAddress, encryption=encryption, vectorError=vectorError, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, frequencyVariant=frequencyVariant, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, iPVersion=iPVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEmailAlert=sMTPEmailAlert, gatewayIPAddress=gatewayIPAddress, receiveFreqKHz=receiveFreqKHz, hardwareVersion=hardwareVersion, cableLoss=cableLoss, dfsTable=dfsTable, receiveModulationMode=receiveModulationMode, managementPortStatus=managementPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, siteName=siteName, dSCPManagementPriority=dSCPManagementPriority, installArmStateTrap=installArmStateTrap, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernet=ethernet, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqMHz=receiveFreqMHz, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, channelALoopbackTrap=channelALoopbackTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetRange=targetRange, iPv6Address=iPv6Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, syslogState=syslogState, supplementaryGroup=supplementaryGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, linkModeOptimisation=linkModeOptimisation, qOSPriorityScheme=qOSPriorityScheme, managementGroup=managementGroup, telecomGroup=telecomGroup, sNTPServerTableEntry=sNTPServerTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, management=management, syslogClient=syslogClient, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, productVariant=productVariant, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControlGroup=aAAControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, encryptionGroup=encryptionGroup, syslogClientTrap=syslogClientTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBCableLength=channelBCableLength, dataPortFiberStatus=dataPortFiberStatus, userTableEntry=userTableEntry, ptp600=ptp600, iPv4Address=iPv4Address, timeZone=timeZone, configuration=configuration, dfsMeans=dfsMeans, dfsTableNumber=dfsTableNumber, eIRP=eIRP, securityLevel=securityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxColorCode=rxColorCode, rawReceivePower=rawReceivePower, subnetMask=subnetMask, automaticTxPowerControl=automaticTxPowerControl, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, remoteInternetAddress=remoteInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTable=sNTPServerTable, systemReset=systemReset, wirelessLinkAvailability=wirelessLinkAvailability, snmpControlGroup=snmpControlGroup, dfsGroup=dfsGroup, aAAControl=aAAControl, groupID=groupID, iPDSCPPriorityTable=iPDSCPPriorityTable, telecomsInterface=telecomsInterface, channelALoopback=channelALoopback, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, regionCode=regionCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, channelChangeTrap=channelChangeTrap, channelBLoopbackTrap=channelBLoopbackTrap, unitOutOfCalibration=unitOutOfCalibration, linkSymmetry=linkSymmetry, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementMode=managementMode, alarmsGroup=alarmsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, linkName=linkName, ptpGroups=ptpGroups, sNTPPrimaryServer=sNTPPrimaryServer, transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTable=mPLSTCPriorityTable, aggregateDataRate=aggregateDataRate, encryptionAlgorithm=encryptionAlgorithm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, sNTPServerTableIndex=sNTPServerTableIndex, sntpGroup=sntpGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave)
