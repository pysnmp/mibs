...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortStatusTrap=dataPortStatusTrap, smtp=smtp, sNTPServerTableNumber=sNTPServerTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, dfsGroup=dfsGroup, encryptionAlgorithm=encryptionAlgorithm, managementPortStatusTrap=managementPortStatusTrap, dfsTable=dfsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, sNMPPortNumber=sNMPPortNumber, supplementary=supplementary, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTable=sNTPServerTable, sNTPState=sNTPState, regionCode=regionCode, hTTPSPortNumber=hTTPSPortNumber, encryption=encryption, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sntpGroup=sntpGroup, txColorCode=txColorCode, receiveDataRate=receiveDataRate, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, dfs=dfs, sNTPServerInternetAddress=sNTPServerInternetAddress, siteName=siteName, sNTPServerStatus=sNTPServerStatus, sntp=sntp, dfsPeaks=dfsPeaks, productName=productName, remoteRxTargetPower=remoteRxTargetPower, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, qOSPriorityScheme=qOSPriorityScheme, installStatusTrap=installStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelBStatus=telecomsChannelBStatus, localPacketFiltering=localPacketFiltering, sNTPPrimaryServer=sNTPPrimaryServer, managementPortStatus=managementPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, longitude=longitude, userTable=userTable, sNTPServerTimeout=sNTPServerTimeout, encryptionGroup=encryptionGroup, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, syslogClient=syslogClient, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cambium=cambium, receiveChannel=receiveChannel, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, rangingMode=rangingMode, secureModeAlarm=secureModeAlarm, pubStats=pubStats, syslogStateTrap=syslogStateTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, configuration=configuration, reset=reset, resetGroup=resetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsInterface=telecomsInterface, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, management=management, signalStrengthRatio=signalStrengthRatio, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, snmpControl=snmpControl, channelBCableLength=channelBCableLength, snmpControlGroup=snmpControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, installStatus=installStatus, ethernetGroup=ethernetGroup, remoteInternetAddress=remoteInternetAddress, transmitModulationMode=transmitModulationMode, sNTPServerRetries=sNTPServerRetries, remoteInternetAddressType=remoteInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bandwidthVariant=bandwidthVariant, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, syslogState=syslogState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetRange=targetRange, dataPortStatus=dataPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, alarmsGroup=alarmsGroup, receiveFreqKHz=receiveFreqKHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, systemReset=systemReset, linkSymmetry=linkSymmetry, searchState=searchState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, syslogControlGroup=syslogControlGroup, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receivePower=receivePower, channelBLineCode=channelBLineCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, userTableNumber=userTableNumber, userEnabled=userEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, sNTPPollInterval=sNTPPollInterval, notificationsGroup=notificationsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, aAAControl=aAAControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, range=range, dfsTableNumber=dfsTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTable=ethernetPriorityTable, userTableIndex=userTableIndex, channelALoopback=channelALoopback, ethernet=ethernet, alarms=alarms, telecomGroup=telecomGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower, managementMode=managementMode, frequencyVariant=frequencyVariant, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, eIRP=eIRP, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteIPAddress=remoteIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, supplementaryGroup=supplementaryGroup, telecomsChannelAStatus=telecomsChannelAStatus, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBLoopbackTrap=channelBLoopbackTrap, smtpGroup=smtpGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, syslogControl=syslogControl, ptpTraps=ptpTraps, sNTPServerPortNumber=sNTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, antennaGain=antennaGain, subnetMask=subnetMask, securityLevel=securityLevel, channelBLoopback=channelBLoopback, iPv6PrefixLength=iPv6PrefixLength, ptpGroups=ptpGroups, hAZLOCConfiguration=hAZLOCConfiguration, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, hardwareVersion=hardwareVersion, linkName=linkName, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, channelChangeTrap=channelChangeTrap, systemClock=systemClock, ethernetBridgingStatus=ethernetBridgingStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, dfsTableEntry=dfsTableEntry, bridgeGroup=bridgeGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userName=userName, targetMACAddress=targetMACAddress, cableLoss=cableLoss, sNTPSyncTrap=sNTPSyncTrap, iPv4Address=iPv4Address, phyControlGroup=phyControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, phyStatusGroup=phyStatusGroup, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetPriorityTableIndex=ethernetPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqMHz=transmitFreqMHz, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBandwidth=channelBandwidth, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, groupID=groupID, managementPortDisabledWarning=managementPortDisabledWarning, vLANManagementVID=vLANManagementVID, telecomsChannelSelection=telecomsChannelSelection, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rxColorCode=rxColorCode, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installArmStateTrap=installArmStateTrap, sNTPServerTableIndex=sNTPServerTableIndex, channelALoopbackTrap=channelALoopbackTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsTableIndex=dfsTableIndex, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPSync=sNTPSync, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, softwareVersion=softwareVersion, userRole=userRole)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, byteErrorRatio=byteErrorRatio, iPv6Address=iPv6Address, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, automaticTxPowerControl=automaticTxPowerControl, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, transmitFreqKHz=transmitFreqKHz, bridge=bridge, phyControl=phyControl, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, wirelessLinkStatus=wirelessLinkStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rawReceivePower=rawReceivePower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelALineCode=channelALineCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, channelACableLength=channelACableLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp600=ptp600, installArmState=installArmState, syslogClientTrap=syslogClientTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving, dfsMeans=dfsMeans, tDDControlGroup=tDDControlGroup, licenceGroup=licenceGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpCompliance=ptpCompliance, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibration=unitOutOfCalibration, managementGroup=managementGroup)
