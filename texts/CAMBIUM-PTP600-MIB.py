...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortStatusTrap=managementPortStatusTrap, sNMPCommunityString=sNMPCommunityString, sNTPPrimaryServer=sNTPPrimaryServer, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, timeZone=timeZone, channelBandwidth=channelBandwidth, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelChangeTrap=channelChangeTrap, userTable=userTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receiveModulationMode=receiveModulationMode, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteInternetAddress=remoteInternetAddress, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, userName=userName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkName=linkName, linkLoss=linkLoss, searchState=searchState, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, alarms=alarms, channelBLoopbackTrap=channelBLoopbackTrap, smtpGroup=smtpGroup, sntp=sntp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, remoteInternetAddressType=remoteInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, supplementaryGroup=supplementaryGroup, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, dfsGroup=dfsGroup, sNTPServerTable=sNTPServerTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelAStatus=telecomsChannelAStatus, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPSyncTrap=sNTPSyncTrap, managementMode=managementMode, encryption=encryption, phyStatus=phyStatus, cableLoss=cableLoss, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, qOSPriorityScheme=qOSPriorityScheme, tFTPServerIPAddress=tFTPServerIPAddress, dfsTableEntry=dfsTableEntry, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, channelBCableLength=channelBCableLength, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPv3Enable=sNMPv3Enable, range=range, configuration=configuration, transmitModulationMode=transmitModulationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, licenceGroup=licenceGroup, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, accessMethod=accessMethod, iPv6Address=iPv6Address, sNTPServerTimeout=sNTPServerTimeout, channelACableLength=channelACableLength, managementGroup=managementGroup, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, systemClock=systemClock, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoMdix=dataPortAutoMdix, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptpGroups=ptpGroups, localPacketFiltering=localPacketFiltering, latitude=latitude, regionCodeTrap=regionCodeTrap, dfs=dfs, dSCPManagementPriority=dSCPManagementPriority, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, iPv6GatewayAddress=iPv6GatewayAddress, productName=productName, channelBLineCode=channelBLineCode, automaticTxPowerControl=automaticTxPowerControl, telecomsChannelSelection=telecomsChannelSelection, syslogControl=syslogControl, hardwareVersion=hardwareVersion, managementPortStatus=managementPortStatus, transmitFreqKHz=transmitFreqKHz, rxColorCode=rxColorCode, encryptionGroup=encryptionGroup, telecomGroup=telecomGroup, phyStatusGroup=phyStatusGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, antennaGain=antennaGain, channelBLoopback=channelBLoopback, telecomsInterface=telecomsInterface, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelALoopbackTrap=channelALoopbackTrap, sMTPEnabledMessages=sMTPEnabledMessages, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, phyControl=phyControl, groupID=groupID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, systemReset=systemReset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, aggregateDataRate=aggregateDataRate, sNTPServerPortNumber=sNTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerInternetAddress=tFTPServerInternetAddress, txColorCode=txColorCode, masterSlaveMode=masterSlaveMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteRxTargetPower=remoteRxTargetPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsMeans=dfsMeans, byteErrorRatio=byteErrorRatio, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarmTrap=secureModeAlarmTrap, securityLevel=securityLevel, channelALoopback=channelALoopback, ethernetBridgingAvailability=ethernetBridgingAvailability, subnetMask=subnetMask, sNTPServerTableIndex=sNTPServerTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveChannel=receiveChannel, ptpTraps=ptpTraps, dfsTable=dfsTable, aAAControl=aAAControl, ethernetPriorityTable=ethernetPriorityTable, dfsTableNumber=dfsTableNumber, regionCode=regionCode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, targetRange=targetRange, syslogControlGroup=syslogControlGroup, installStatus=installStatus, resetGroup=resetGroup, rawReceivePower=rawReceivePower, receiveModulationModeDetail=receiveModulationModeDetail, PYSNMP_MODULE_ID=cambium, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyControlGroup=phyControlGroup, sNTPServerRetries=sNTPServerRetries, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, sMTPServerIPAddress=sMTPServerIPAddress, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, longitude=longitude, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, licence=licence, l2CPPriorityTable=l2CPPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, syslogClientTrap=syslogClientTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, ptp=ptp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, linkModeOptimisation=linkModeOptimisation, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, channelALineCode=channelALineCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, productVariant=productVariant, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, daylightSaving=daylightSaving, sMTPEmailAlert=sMTPEmailAlert, bootVersion=bootVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, sNTPServerTableEntry=sNTPServerTableEntry, userEnabled=userEnabled, bandwidthVariant=bandwidthVariant, receivePower=receivePower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, versions=versions)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, targetMACAddress=targetMACAddress, ptp600=ptp600, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkSymmetry=linkSymmetry, sntpGroup=sntpGroup, ethernetFiberSupport=ethernetFiberSupport, pubStats=pubStats, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerStatus=sNTPServerStatus, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, rangingMode=rangingMode, signalStrengthRatio=signalStrengthRatio, bridge=bridge, ethernetGroup=ethernetGroup, dfsTableIndex=dfsTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, siteName=siteName, incompatibleRegionCodes=incompatibleRegionCodes, dataPortFiberStatus=dataPortFiberStatus, secureModeAlarm=secureModeAlarm, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, syslogState=syslogState, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, installStatusTrap=installStatusTrap, telecom=telecom, bridgeGroup=bridgeGroup, aAAControlGroup=aAAControlGroup, snmpControl=snmpControl, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
