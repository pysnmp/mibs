...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vLANManagementVID=vLANManagementVID, managementPortStatus=managementPortStatus, ptp600=ptp600, channelBandwidth=channelBandwidth, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, managementPortStatusTrap=managementPortStatusTrap, aAAControlGroup=aAAControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, dfsTable=dfsTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, resetGroup=resetGroup, phyStatus=phyStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bridgeGroup=bridgeGroup, automaticTxPowerControl=automaticTxPowerControl, versionsGroup=versionsGroup, antennaGain=antennaGain, syslogState=syslogState, sNTPServerTableIndex=sNTPServerTableIndex, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTable=userTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, telecom=telecom, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rangingMode=rangingMode, tFTPServerIPAddress=tFTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, iPv4Address=iPv4Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, timeZone=timeZone, encryptionGroup=encryptionGroup, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, supplementaryGroup=supplementaryGroup, iPv6PrefixLength=iPv6PrefixLength, vLANManagementPriority=vLANManagementPriority, telecomGroup=telecomGroup, phyControl=phyControl, txColorCode=txColorCode, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, systemClock=systemClock, latitude=latitude, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tDDControlGroup=tDDControlGroup, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCode=regionCode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, alarms=alarms, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configuration=configuration, aAAControl=aAAControl, dfsTableEntry=dfsTableEntry, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, remoteInternetAddressType=remoteInternetAddressType, channelACableLength=channelACableLength, tDDSynchronizationMode=tDDSynchronizationMode, hardwareVersion=hardwareVersion, longitude=longitude, licenceGroup=licenceGroup, userTableEntry=userTableEntry, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBLoopback=channelBLoopback, smtp=smtp, remoteRxTargetPower=remoteRxTargetPower, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, installArmState=installArmState, phyControlGroup=phyControlGroup, sNTPServerTable=sNTPServerTable, frequencyVariant=frequencyVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, telecomsChannelSelection=telecomsChannelSelection, cambium=cambium, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapVersion=sNMPTrapVersion, encryptionAlgorithm=encryptionAlgorithm, bridge=bridge, secureModeAlarm=secureModeAlarm, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, dfsMeans=dfsMeans, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelAStatus=telecomsChannelAStatus, remoteInternetAddress=remoteInternetAddress, bandwidthVariant=bandwidthVariant, licence=licence, managementPortDisabledWarning=managementPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userPassword=userPassword, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSync=sNTPSync, securityLevel=securityLevel, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, reset=reset, eIRP=eIRP, daylightSaving=daylightSaving, productName=productName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerRetries=sNTPServerRetries, sNMPCommunityString=sNMPCommunityString, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, accessMethod=accessMethod, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, supplementary=supplementary, receiveDataRate=receiveDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, secureModeAlarmTrap=secureModeAlarmTrap, range=range, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBLineCode=channelBLineCode, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddress=sNTPServerInternetAddress, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, dataPortAutoMdix=dataPortAutoMdix, groupID=groupID, syslogClient=syslogClient, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, localPacketFiltering=localPacketFiltering, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTraps=ptpTraps, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryption=encryption, l2CPPriorityTable=l2CPPriorityTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogControl=syslogControl, iPVersion=iPVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPPortNumber=sNMPPortNumber, systemReset=systemReset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopbackTrap=channelALoopbackTrap, receiveModulationModeDetail=receiveModulationModeDetail, syslogControlGroup=syslogControlGroup, sNMPv3Enable=sNMPv3Enable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, qOSPriorityScheme=qOSPriorityScheme, sNMPEnabledTraps=sNMPEnabledTraps, ptpTrapPrefix=ptpTrapPrefix, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versions=versions, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetBridgingStatus=ethernetBridgingStatus, linkModeOptimisation=linkModeOptimisation, dfsTableIndex=dfsTableIndex, telnetPortNumber=telnetPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityTable=ethernetPriorityTable, transmitFreqKHz=transmitFreqKHz, rxColorCode=rxColorCode, telecomsChannelBStatus=telecomsChannelBStatus, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, managementMode=managementMode, incompatibleRegionCodes=incompatibleRegionCodes, targetRange=targetRange, receiveModulationMode=receiveModulationMode, installStatus=installStatus, channelALineCode=channelALineCode, receiveFreqMHz=receiveFreqMHz, searchState=searchState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bootVersion=bootVersion, smtpGroup=smtpGroup, telecomsInterface=telecomsInterface, receivePower=receivePower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, regionCodeTrap=regionCodeTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, phyStatusGroup=phyStatusGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBCableLength=channelBCableLength, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, ptpGroups=ptpGroups, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, siteName=siteName, dataPortDisabledWarning=dataPortDisabledWarning, rawReceivePower=rawReceivePower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vectorError=vectorError, iPv6Address=iPv6Address, notificationsGroup=notificationsGroup, transmitFreqMHz=transmitFreqMHz, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBLoopbackTrap=channelBLoopbackTrap, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, alarmsGroup=alarmsGroup, management=management, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitPower=transmitPower, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, altitude=altitude, userRole=userRole, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, ptp=ptp, sNMPTrapTable=sNMPTrapTable, dataPortFiberStatus=dataPortFiberStatus, channelALoopback=channelALoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap)
