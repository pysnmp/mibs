...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopback=channelBLoopback, receiveModulationMode=receiveModulationMode, sMTPEmailAlert=sMTPEmailAlert, syslogControl=syslogControl, frequencyVariant=frequencyVariant, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, dfsTable=dfsTable, sNTPSync=sNTPSync, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, rawReceivePower=rawReceivePower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6Address=iPv6Address, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPAccessEnabled=hTTPAccessEnabled, latitude=latitude, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, antennaGain=antennaGain, hAZLOCConfiguration=hAZLOCConfiguration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, longitude=longitude, sNMPTrapTable=sNMPTrapTable, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfs=dfs, sNTPServerTableEntry=sNTPServerTableEntry, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPPollInterval=sNTPPollInterval, phyStatus=phyStatus, ptpGroups=ptpGroups, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, ptmp=ptmp, pubStatsGroup=pubStatsGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPVersion=iPVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, searchState=searchState, iPDSCPPriorityTable=iPDSCPPriorityTable, channelALineCode=channelALineCode, configurationGroup=configurationGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, receiveChannel=receiveChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptp=ptp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, managementPortDisabledWarning=managementPortDisabledWarning, telnetPortNumber=telnetPortNumber, sNTPServerRetries=sNTPServerRetries, telecomsChannelBStatus=telecomsChannelBStatus, dfsPeaks=dfsPeaks, l2CPPriorityTable=l2CPPriorityTable, dSCPManagementPriority=dSCPManagementPriority, sNTPServerStatus=sNTPServerStatus, altitude=altitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, notificationsGroup=notificationsGroup, bandwidthVariant=bandwidthVariant, groupID=groupID, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, phyStatusGroup=phyStatusGroup, transmitChannel=transmitChannel, channelBCableLength=channelBCableLength, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, configuration=configuration, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, rangingMode=rangingMode, alarmsGroup=alarmsGroup, siteName=siteName, channelBLoopbackTrap=channelBLoopbackTrap, receivePower=receivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtpGroup=smtpGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelAStatus=telecomsChannelAStatus, sNTPState=sNTPState, managementPortStatusTrap=managementPortStatusTrap, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, qOSPriorityScheme=qOSPriorityScheme, tDDControl=tDDControl, sNTPServerTableIndex=sNTPServerTableIndex, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteInternetAddressType=remoteInternetAddressType, aAAControl=aAAControl, productName=productName, supplementary=supplementary, phyControl=phyControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomsInterface=telecomsInterface, txColorCode=txColorCode, accessMethod=accessMethod, ptp600=ptp600, tDDSynchronizationMode=tDDSynchronizationMode, sNMPPortNumber=sNMPPortNumber, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntpGroup=sntpGroup, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsTableIndex=dfsTableIndex, hTTPPortNumber=hTTPPortNumber, linkSymmetry=linkSymmetry, alarms=alarms, installStatusTrap=installStatusTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPServerIPAddress=sNTPServerIPAddress, userRole=userRole, ethernet=ethernet, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortDisabledWarning=dataPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, byteErrorRatio=byteErrorRatio, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, ethernetGroup=ethernetGroup, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, sntp=sntp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, reset=reset, eIRP=eIRP, managementMode=managementMode, sNTPSyncTrap=sNTPSyncTrap, iPv4Address=iPv4Address, managementPortStatus=managementPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bridge=bridge, channelBLineCode=channelBLineCode, sNTPServerTable=sNTPServerTable, channelACableLength=channelACableLength, targetRange=targetRange, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogClient=syslogClient, transmitPower=transmitPower, snmpControl=snmpControl, vLANManagementVID=vLANManagementVID, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, productVariant=productVariant, installArmState=installArmState, ptpTraps=ptpTraps, encryptionGroup=encryptionGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, PYSNMP_MODULE_ID=cambium, bridgeGroup=bridgeGroup, aggregateDataRate=aggregateDataRate, userPassword=userPassword, cableLoss=cableLoss, dfsMeans=dfsMeans, installStatus=installStatus, timeZone=timeZone, userTableIndex=userTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, userTableEntry=userTableEntry, licenceGroup=licenceGroup, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkStatus=wirelessLinkStatus, remoteRxTargetPower=remoteRxTargetPower, hTTPSPortNumber=hTTPSPortNumber, dfsGroup=dfsGroup, rxColorCode=rxColorCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogClientTrap=syslogClientTrap, telecom=telecom, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelSelection=telecomsChannelSelection, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPrimaryServer=sNTPPrimaryServer, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, userEnabled=userEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelALoopback=channelALoopback, channelBandwidth=channelBandwidth, tDDControlGroup=tDDControlGroup, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, userName=userName, sNMPTrapTableEntry=sNMPTrapTableEntry, versions=versions, encryption=encryption, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, systemClock=systemClock, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelALoopbackTrap=channelALoopbackTrap, masterSlaveMode=masterSlaveMode, ethernetBridgingStatus=ethernetBridgingStatus, phyControlGroup=phyControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortFiberStatus=dataPortFiberStatus, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerInternetAddress=tFTPServerInternetAddress, supplementaryGroup=supplementaryGroup, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, vectorError=vectorError, management=management, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, securityLevel=securityLevel, iPv6PrefixLength=iPv6PrefixLength, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap)
