...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", encryption=encryption, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, userName=userName, vLANManagementVID=vLANManagementVID, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telecomsChannelBStatus=telecomsChannelBStatus, installArmState=installArmState, dfs=dfs, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, systemClock=systemClock, dfsTableEntry=dfsTableEntry, syslogClientTrap=syslogClientTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBCableLength=channelBCableLength, securityLevel=securityLevel, userTableNumber=userTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, configuration=configuration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, targetRange=targetRange, transmitModulationMode=transmitModulationMode, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationMode=tDDSynchronizationMode, iPv6GatewayAddress=iPv6GatewayAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTable=l2CPPriorityTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerStatus=sNTPServerStatus, licenceGroup=licenceGroup, telecomsChannelSelection=telecomsChannelSelection, syslogControl=syslogControl, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userPassword=userPassword, hTTPAccessEnabled=hTTPAccessEnabled, sNTPLastSync=sNTPLastSync, sMTPServerInternetAddress=sMTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude, licence=licence, sNTPState=sNTPState, dataPortFiberStatus=dataPortFiberStatus, tDDControlGroup=tDDControlGroup, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, transmitPower=transmitPower, channelALoopbackTrap=channelALoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, telecom=telecom, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, automaticTxPowerControl=automaticTxPowerControl, rawReceivePower=rawReceivePower, managementPortDisabledWarning=managementPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTableEntry=sNTPServerTableEntry, timeZone=timeZone, syslogStateTrap=syslogStateTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBLoopback=channelBLoopback, transmitFreqKHz=transmitFreqKHz, sntp=sntp, dfsGroup=dfsGroup, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, altitude=altitude, tFTPServerInternetAddress=tFTPServerInternetAddress, telnetAccessEnabled=telnetAccessEnabled, iPv4Address=iPv4Address, linkName=linkName, dataPortStatusTrap=dataPortStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, managementPortStatus=managementPortStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarm=secureModeAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, configurationGroup=configurationGroup, bridgeGroup=bridgeGroup, hTTPSPortNumber=hTTPSPortNumber, userTableEntry=userTableEntry, supplementary=supplementary, ptpGroups=ptpGroups, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDDControl=tDDControl, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPollInterval=sNTPPollInterval, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelALoopback=channelALoopback, dataPortStatus=dataPortStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelAStatus=telecomsChannelAStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productName=productName, dfsTableNumber=dfsTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, rangingMode=rangingMode, incompatibleRegionCodes=incompatibleRegionCodes, accessMethod=accessMethod, pubStats=pubStats, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerIPAddress=sMTPServerIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secureModeAlarmTrap=secureModeAlarmTrap, alarms=alarms, remoteInternetAddress=remoteInternetAddress, bandwidthVariant=bandwidthVariant, versions=versions, iPVersion=iPVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, transmitChannel=transmitChannel, sntpGroup=sntpGroup, phyControlGroup=phyControlGroup, dfsPeaks=dfsPeaks, managementMode=managementMode, sNMPv3Enable=sNMPv3Enable, managementGroup=managementGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userRole=userRole, longitude=longitude, management=management, txColorCode=txColorCode, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, receiveChannel=receiveChannel, pubStatsGroup=pubStatsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, syslogState=syslogState, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTable=sNMPTrapTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, remoteInternetAddressType=remoteInternetAddressType, transmitFreqMHz=transmitFreqMHz, bridge=bridge, sMTPServerPortNumber=sMTPServerPortNumber, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortAutoMdix=dataPortAutoMdix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsInterface=telecomsInterface, reset=reset, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortStatusTrap=managementPortStatusTrap, phyStatusGroup=phyStatusGroup, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTimeout=sNTPServerTimeout, ethernetBridgingStatus=ethernetBridgingStatus, smtp=smtp, secondarySoftwareVersion=secondarySoftwareVersion, range=range, tFTPServerPortNumber=tFTPServerPortNumber, ptp600=ptp600, receiveFreqMHz=receiveFreqMHz, userEnabled=userEnabled, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, softwareVersion=softwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, PYSNMP_MODULE_ID=cambium, cambium=cambium, regionCode=regionCode, remoteRxTargetPower=remoteRxTargetPower, channelChangeTrap=channelChangeTrap, installArmStateTrap=installArmStateTrap, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelACableLength=channelACableLength)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6Address=iPv6Address, installStatusTrap=installStatusTrap, phyControl=phyControl, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, systemReset=systemReset, wirelessLinkStatus=wirelessLinkStatus, snmpControl=snmpControl, hTTPPortNumber=hTTPPortNumber, rxColorCode=rxColorCode, transmitDataRate=transmitDataRate, syslogClient=syslogClient, channelALineCode=channelALineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerPortNumber=sNTPServerPortNumber, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveModulationMode=receiveModulationMode, targetMACAddress=targetMACAddress, resetGroup=resetGroup, iPv6PrefixLength=iPv6PrefixLength, vectorError=vectorError, receiveDataRate=receiveDataRate, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, sNTPServerTable=sNTPServerTable, linkSymmetry=linkSymmetry, dfsMeans=dfsMeans, tFTPServerIPAddress=tFTPServerIPAddress, notificationsGroup=notificationsGroup, receivePower=receivePower, hardwareVersion=hardwareVersion, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBLineCode=channelBLineCode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userTable=userTable)
