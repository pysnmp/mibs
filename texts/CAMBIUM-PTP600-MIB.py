...
IpAddress, NotificationType, Unsigned32, ModuleIdentity, Counter64, Bits, MibIdentifier, TimeTicks, Integer32, enterprises, Counter32, Gauge32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter64", "Bits", "MibIdentifier", "TimeTicks", "Integer32", "enterprises", "Counter32", "Gauge32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", cableLoss=cableLoss, range=range, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementary=supplementary, resetGroup=resetGroup, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementVID=vLANManagementVID, ptpGroups=ptpGroups, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, management=management, rawReceivePower=rawReceivePower, phyControl=phyControl, channelALoopback=channelALoopback, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTable=sNMPTrapTable, channelBLineCode=channelBLineCode, transmitPower=transmitPower, receiveChannel=receiveChannel, remoteRxTargetPower=remoteRxTargetPower, sMTPEmailAlert=sMTPEmailAlert, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, phyStatusGroup=phyStatusGroup, sNTPServerTableIndex=sNTPServerTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPAccessEnabled=hTTPAccessEnabled, txColorCode=txColorCode, dfsTable=dfsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telecomsInterface=telecomsInterface, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, latitude=latitude, dfs=dfs, ptp600=ptp600, smtpGroup=smtpGroup, ethernetPriorityTable=ethernetPriorityTable, sntpGroup=sntpGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, systemClock=systemClock, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configuration=configuration, syslogControlGroup=syslogControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, longitude=longitude, gatewayIPAddress=gatewayIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licence=licence, versions=versions, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerIPAddress=sNTPServerIPAddress, userRole=userRole, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, snmpControlGroup=snmpControlGroup, supplementaryGroup=supplementaryGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPLastSync=sNTPLastSync, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, telecom=telecom, dfsTableEntry=dfsTableEntry, localPacketFiltering=localPacketFiltering, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, versionsGroup=versionsGroup, sNTPSyncTrap=sNTPSyncTrap, userTableEntry=userTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, snmpControl=snmpControl, ptpCompliance=ptpCompliance, iPv4Address=iPv4Address, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, rangingMode=rangingMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableIndex=userTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tDDControl=tDDControl, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, notificationsGroup=notificationsGroup, telnetPortNumber=telnetPortNumber, linkModeOptimisation=linkModeOptimisation, productVariant=productVariant, aggregateDataRate=aggregateDataRate, timeZone=timeZone, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerInternetAddress=sNTPServerInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, alarmsGroup=alarmsGroup, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelSelection=telecomsChannelSelection, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkLoss=linkLoss, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPSync=sNTPSync, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, maximumTransmitPower=maximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, automaticTxPowerControl=automaticTxPowerControl, bridge=bridge, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogControl=syslogControl, configurationGroup=configurationGroup, qOSPriorityScheme=qOSPriorityScheme, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, telecomsChannelBStatus=telecomsChannelBStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, remoteInternetAddress=remoteInternetAddress, reset=reset, managementPortStatus=managementPortStatus, bootVersion=bootVersion, userTable=userTable, installArmState=installArmState, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControlGroup=aAAControlGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTableEntry=sNTPServerTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, eIRP=eIRP, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userPassword=userPassword, channelChangeTrap=channelChangeTrap, dataPortAutoMdix=dataPortAutoMdix, managementMode=managementMode, dfsTableNumber=dfsTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, syslogClientTrap=syslogClientTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitChannel=transmitChannel, smtp=smtp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPState=sNTPState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableNumber=userTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cambium=cambium, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secureModeAlarm=secureModeAlarm, dfsMeans=dfsMeans, channelALineCode=channelALineCode, iPv6Address=iPv6Address, encryption=encryption, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelACableLength=channelACableLength, sNMPTrapVersion=sNMPTrapVersion, daylightSaving=daylightSaving, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetFiberSupport=ethernetFiberSupport, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, bandwidthVariant=bandwidthVariant, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, securityLevel=securityLevel, dataPortStatus=dataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, telecomGroup=telecomGroup, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, siteName=siteName, syslogClient=syslogClient, installStatus=installStatus, incompatibleRegionCodes=incompatibleRegionCodes, rxColorCode=rxColorCode, subnetMask=subnetMask, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelALoopbackTrap=channelALoopbackTrap, ptpTrapPrefix=ptpTrapPrefix, iPVersion=iPVersion, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, bridgeGroup=bridgeGroup, unitOutOfCalibration=unitOutOfCalibration, syslogStateTrap=syslogStateTrap, channelBLoopback=channelBLoopback, sNMPPortNumber=sNMPPortNumber, searchState=searchState, dSCPManagementPriority=dSCPManagementPriority, sNMPCommunityString=sNMPCommunityString, ethernetBridgingStatus=ethernetBridgingStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receivePower=receivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerRetries=sNTPServerRetries, channelBLoopbackTrap=channelBLoopbackTrap, installArmStateTrap=installArmStateTrap, linkName=linkName, phyControlGroup=phyControlGroup, ptp=ptp, iPv6GatewayAddress=iPv6GatewayAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteInternetAddressType=remoteInternetAddressType, dfsGroup=dfsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, productName=productName, pubStatsGroup=pubStatsGroup, sNTPServerStatus=sNTPServerStatus, groupID=groupID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPv6PrefixLength=iPv6PrefixLength, regionCodeTrap=regionCodeTrap, l2CPPriorityTable=l2CPPriorityTable, targetMACAddress=targetMACAddress, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, userEnabled=userEnabled, telecomsChannelAStatus=telecomsChannelAStatus, dfsPeaks=dfsPeaks, channelBCableLength=channelBCableLength, regionCode=regionCode, hAZLOCConfiguration=hAZLOCConfiguration, targetRange=targetRange, sntp=sntp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatus=phyStatus, installStatusTrap=installStatusTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernet=ethernet, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkSymmetry=linkSymmetry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, alarms=alarms, encryptionAlgorithm=encryptionAlgorithm)
