...
ModuleIdentity, Gauge32, MibIdentifier, Integer32, IpAddress, enterprises, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, ObjectIdentity, Bits, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "IpAddress", "enterprises", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "ObjectIdentity", "Bits", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", systemReset=systemReset, configuration=configuration, txColorCode=txColorCode, rxColorCode=rxColorCode, rawReceivePower=rawReceivePower, telecomsChannelAStatus=telecomsChannelAStatus, syslogControlGroup=syslogControlGroup, transmitModulationMode=transmitModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, hardwareVersion=hardwareVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitChannel=transmitChannel, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTableIndex=sNTPServerTableIndex, receiveFreqMHz=receiveFreqMHz, supplementaryGroup=supplementaryGroup, hTTPAccessEnabled=hTTPAccessEnabled, hTTPPortNumber=hTTPPortNumber, installStatusTrap=installStatusTrap, aggregateDataRate=aggregateDataRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, smtpGroup=smtpGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, pubStatsGroup=pubStatsGroup, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, antennaGain=antennaGain, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, receivePower=receivePower, regionCodeTrap=regionCodeTrap, telecomsChannelBStatus=telecomsChannelBStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, vLANManagementVID=vLANManagementVID, ethernetFiberSupport=ethernetFiberSupport, syslogClient=syslogClient, ptpTraps=ptpTraps, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installStatus=installStatus, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, productVariant=productVariant, phyStatus=phyStatus, receiveDataRate=receiveDataRate, ethernetBridgingStatus=ethernetBridgingStatus, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, linkLoss=linkLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitPower=transmitPower, sntpGroup=sntpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteIPAddress=remoteIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, secureModeAlarm=secureModeAlarm, ptp=ptp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, cambium=cambium, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, telnetPortNumber=telnetPortNumber, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, iPv4Address=iPv4Address, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPSync=sNTPSync, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, searchState=searchState, dSCPManagementPriority=dSCPManagementPriority, receiveModulationMode=receiveModulationMode, daylightSaving=daylightSaving, encryptionAlgorithm=encryptionAlgorithm, channelALoopback=channelALoopback, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, encryption=encryption, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTableEntry=dfsTableEntry, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, longitude=longitude, sNMPTrapTable=sNMPTrapTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp600=ptp600, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyControl=phyControl, remoteInternetAddressType=remoteInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, byteErrorRatio=byteErrorRatio, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, bridgeGroup=bridgeGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPState=sNTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogStateTrap=syslogStateTrap, tDDControl=tDDControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, pubStats=pubStats, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarms=alarms, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, phyControlGroup=phyControlGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, accessMethod=accessMethod, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secureModeAlarmTrap=secureModeAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelALoopbackTrap=channelALoopbackTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, remoteInternetAddress=remoteInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveChannel=receiveChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogState=syslogState, managementGroup=managementGroup, targetRange=targetRange, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenceGroup=licenceGroup, siteName=siteName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveModulationModeDetail=receiveModulationModeDetail, iPVersion=iPVersion, dataPortFiberStatus=dataPortFiberStatus, sMTPEnabledMessages=sMTPEnabledMessages, dfsPeaks=dfsPeaks, altitude=altitude, resetGroup=resetGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, dfsTable=dfsTable, channelACableLength=channelACableLength, sNTPServerTableEntry=sNTPServerTableEntry, channelChangeTrap=channelChangeTrap, channelBLoopbackTrap=channelBLoopbackTrap, syslogClientTrap=syslogClientTrap, tFTPServerIPAddress=tFTPServerIPAddress, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, telecomsInterface=telecomsInterface, telecomsChannelSelection=telecomsChannelSelection, dfs=dfs, localPacketFiltering=localPacketFiltering, channelALineCode=channelALineCode, iPDSCPPriorityTable=iPDSCPPriorityTable, managementMode=managementMode, eIRP=eIRP, reset=reset, ptmp=ptmp, productName=productName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpCompliance=ptpCompliance, receiveFreqKHz=receiveFreqKHz, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, dfsGroup=dfsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aAAControl=aAAControl, ptpTrapPrefix=ptpTrapPrefix, groupID=groupID, alarmsGroup=alarmsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTable=mPLSTCPriorityTable, softwareVersion=softwareVersion, managementPortStatus=managementPortStatus, installArmStateTrap=installArmStateTrap, automaticTxPowerControl=automaticTxPowerControl, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, bootVersion=bootVersion, channelBCableLength=channelBCableLength, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteRxTargetPower=remoteRxTargetPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTable=l2CPPriorityTable, ethernet=ethernet, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetGroup=ethernetGroup, channelBLineCode=channelBLineCode, channelBLoopback=channelBLoopback, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerInternetAddress=tFTPServerInternetAddress, hAZLOCConfiguration=hAZLOCConfiguration, PYSNMP_MODULE_ID=cambium, frequencyVariant=frequencyVariant, configurationGroup=configurationGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, management=management, installArmState=installArmState, bridge=bridge)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, securityLevel=securityLevel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, regionCode=regionCode, sNTPServerPortNumber=sNTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, supplementary=supplementary, dfsTableNumber=dfsTableNumber, iPv6Address=iPv6Address, sNTPServerTable=sNTPServerTable, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userTable=userTable, userTableIndex=userTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, timeZone=timeZone, sNTPPrimaryServer=sNTPPrimaryServer, iPv6PrefixLength=iPv6PrefixLength, linkName=linkName, latitude=latitude, cableLoss=cableLoss, sNTPServerRetries=sNTPServerRetries, userRole=userRole, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomGroup=telecomGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, tFTPServerPortNumber=tFTPServerPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, licence=licence, sNTPPollInterval=sNTPPollInterval, rangingMode=rangingMode, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, telecom=telecom, encryptionGroup=encryptionGroup, dataPortStatus=dataPortStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, range=range)
