...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, installStatus=installStatus, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, transmitChannel=transmitChannel, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPVersion=iPVersion, sNTPSyncTrap=sNTPSyncTrap, automaticTxPowerControl=automaticTxPowerControl, sntpGroup=sntpGroup, dfsGroup=dfsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vectorError=vectorError, accessMethod=accessMethod, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, transmitDataRate=transmitDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelChangeTrap=channelChangeTrap, userTableEntry=userTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, timeZone=timeZone, dfsTableEntry=dfsTableEntry, rxColorCode=rxColorCode, telecomGroup=telecomGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, searchState=searchState, ptpGroups=ptpGroups, range=range, syslogState=syslogState, remoteIPAddress=remoteIPAddress, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, snmpControl=snmpControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, securityLevel=securityLevel, licenceGroup=licenceGroup, cambium=cambium, telecomsChannelBStatus=telecomsChannelBStatus, aAAControlGroup=aAAControlGroup, ptpCompliance=ptpCompliance, signalStrengthRatio=signalStrengthRatio, longitude=longitude, sMTPEnabledMessages=sMTPEnabledMessages, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, sNMPCommunityString=sNMPCommunityString, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveDataRate=receiveDataRate, sNTPServerTableEntry=sNTPServerTableEntry, smtp=smtp, licence=licence, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hAZLOCConfiguration=hAZLOCConfiguration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteInternetAddressType=remoteInternetAddressType, sMTPServerInternetAddressType=sMTPServerInternetAddressType, altitude=altitude, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsTableIndex=dfsTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, dataPortAutoMdix=dataPortAutoMdix, receivePower=receivePower, transmitFreqMHz=transmitFreqMHz, sNTPServerStatus=sNTPServerStatus, hTTPSPortNumber=hTTPSPortNumber, encryptionGroup=encryptionGroup, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableNumber=ethernetPriorityTableNumber, regionCode=regionCode, ptp=ptp, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, sNTPState=sNTPState, userName=userName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, targetMACAddress=targetMACAddress, linkLoss=linkLoss, ptpTraps=ptpTraps, ptp600=ptp600, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPrimaryServer=sNTPPrimaryServer, iPv6PrefixLength=iPv6PrefixLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, channelALoopbackTrap=channelALoopbackTrap, syslogStateTrap=syslogStateTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, telecomsInterface=telecomsInterface, supplementary=supplementary, dataPortFiberStatus=dataPortFiberStatus, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetRange=targetRange, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitPower=transmitPower, siteName=siteName, subnetMask=subnetMask, vLANManagementVID=vLANManagementVID, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, telecomsChannelSelection=telecomsChannelSelection, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, pubStats=pubStats, dfs=dfs, receiveChannel=receiveChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitModulationMode=transmitModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimisation=linkModeOptimisation, txColorCode=txColorCode, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, ethernetPriorityTable=ethernetPriorityTable, phyControl=phyControl, managementMode=managementMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTimeout=sNTPServerTimeout, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPAccessEnabled=hTTPAccessEnabled, channelBCableLength=channelBCableLength, softwareVersion=softwareVersion, rawReceivePower=rawReceivePower, aAAControl=aAAControl, sNTPServerTableIndex=sNTPServerTableIndex, secureModeAlarm=secureModeAlarm, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryption=encryption, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemReset=systemReset, channelBLineCode=channelBLineCode, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelAStatus=telecomsChannelAStatus, versionsGroup=versionsGroup, syslogControl=syslogControl, bridgeGroup=bridgeGroup, channelALineCode=channelALineCode, sNMPPortNumber=sNMPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatus=phyStatus, dfsMeans=dfsMeans, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, versions=versions, sNTPServerRetries=sNTPServerRetries, userPassword=userPassword, channelBLoopback=channelBLoopback, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPPollInterval=sNTPPollInterval, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapVersion=sNMPTrapVersion, managementPortStatusTrap=managementPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, qOSPriorityScheme=qOSPriorityScheme, iPv4Address=iPv4Address, supplementaryGroup=supplementaryGroup, sNTPServerTable=sNTPServerTable, sntp=sntp, userTableNumber=userTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, channelALoopback=channelALoopback, rangingMode=rangingMode, management=management, transmitFreqKHz=transmitFreqKHz, maximumTransmitPower=maximumTransmitPower, remoteRxTargetPower=remoteRxTargetPower, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingAvailability=ethernetBridgingAvailability, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptmp=ptmp, userTable=userTable, daylightSaving=daylightSaving, managementPortStatus=managementPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productName=productName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, hardwareVersion=hardwareVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, reset=reset, dataPortStatus=dataPortStatus, bridge=bridge, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, latitude=latitude, installArmStateTrap=installArmStateTrap, incompatibleRegionCodes=incompatibleRegionCodes, iPv6Address=iPv6Address, sNTPServerPortNumber=sNTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, frequencyVariant=frequencyVariant, channelACableLength=channelACableLength, dataPortFiberStatusTrap=dataPortFiberStatusTrap, resetGroup=resetGroup, syslogClient=syslogClient, localPacketFiltering=localPacketFiltering, tDDControl=tDDControl, iPv6GatewayAddress=iPv6GatewayAddress, PYSNMP_MODULE_ID=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, eIRP=eIRP, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableLoss=cableLoss, userTableIndex=userTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecom=telecom)
