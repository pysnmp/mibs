...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, constantPowerSpectralDensity=constantPowerSpectralDensity, linkLoss=linkLoss, telecomsChannelAStatus=telecomsChannelAStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receivePower=receivePower, ptmp=ptmp, regionCode=regionCode, cambium=cambium, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, resetGroup=resetGroup, iPv4Address=iPv4Address, groupID=groupID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, siteName=siteName, vectorError=vectorError, encryption=encryption, receiveDataRate=receiveDataRate, ethernet=ethernet, managementPortStatus=managementPortStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelACableLength=channelACableLength, targetMACAddress=targetMACAddress, sNTPServerTableEntry=sNTPServerTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userPassword=userPassword, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfs=dfs, tFTPServerIPAddress=tFTPServerIPAddress, accessMethod=accessMethod, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServer=sNTPPrimaryServer, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortStatusTrap=managementPortStatusTrap, pubStatsGroup=pubStatsGroup, iPv6Address=iPv6Address, telecomGroup=telecomGroup, sNMPPortNumber=sNMPPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, phyStatusGroup=phyStatusGroup, dfsTableEntry=dfsTableEntry, qOSPriorityScheme=qOSPriorityScheme, receiveFreqMHz=receiveFreqMHz, rawReceivePower=rawReceivePower, channelALineCode=channelALineCode, userRole=userRole, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, softwareVersion=softwareVersion, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsInterface=telecomsInterface, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityTable=ethernetPriorityTable, userEnabled=userEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatus=dataPortFiberStatus, dataPortAutoMdix=dataPortAutoMdix, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTable=mPLSTCPriorityTable, licenceGroup=licenceGroup, receiveFreqKHz=receiveFreqKHz, sNTPServerTimeout=sNTPServerTimeout, productVariant=productVariant, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTable=sNTPServerTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, l2CPPriorityTable=l2CPPriorityTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licence=licence, management=management, ptp600=ptp600, configuration=configuration, sNTPSync=sNTPSync, bridge=bridge, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hAZLOCConfiguration=hAZLOCConfiguration, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddress=tFTPServerInternetAddress, aAAControl=aAAControl, dfsTable=dfsTable, userTableEntry=userTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userTable=userTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerRetries=sNTPServerRetries, secureModeAlarmTrap=secureModeAlarmTrap, sntpGroup=sntpGroup, transmitChannel=transmitChannel, ptp=ptp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, systemReset=systemReset, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitDataRate=transmitDataRate, installArmStateTrap=installArmStateTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, ethernetBridgingStatus=ethernetBridgingStatus, antennaGain=antennaGain, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapIPAddress=sNMPTrapIPAddress, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, longitude=longitude, sNMPCommunityString=sNMPCommunityString, bandwidthVariant=bandwidthVariant, bootVersion=bootVersion, dataPortDisabledWarning=dataPortDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userTableIndex=userTableIndex, ethernetFiberSupport=ethernetFiberSupport, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetGroup=ethernetGroup, reset=reset, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerStatus=sNTPServerStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, productName=productName, dfsTableNumber=dfsTableNumber, smtpGroup=smtpGroup, telnetPortNumber=telnetPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveChannel=receiveChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, hTTPSPortNumber=hTTPSPortNumber, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, linkSymmetry=linkSymmetry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteInternetAddressType=remoteInternetAddressType, supplementaryGroup=supplementaryGroup, iPVersion=iPVersion, ptpCompliance=ptpCompliance, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, range=range, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, dfsPeaks=dfsPeaks, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, subnetMask=subnetMask, linkName=linkName, bridgeGroup=bridgeGroup, aAAControlGroup=aAAControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, rangingMode=rangingMode, installStatus=installStatus, remoteRxTargetPower=remoteRxTargetPower, syslogControlGroup=syslogControlGroup, cableLoss=cableLoss, channelALoopback=channelALoopback, securityLevel=securityLevel, notificationsGroup=notificationsGroup, syslogClientTrap=syslogClientTrap, sNTPServerTableIndex=sNTPServerTableIndex, installStatusTrap=installStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortDisabledWarning=managementPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, localPacketFiltering=localPacketFiltering, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, remoteInternetAddress=remoteInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, eIRP=eIRP, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telnetAccessEnabled=telnetAccessEnabled, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, installArmState=installArmState, alarms=alarms, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControl=snmpControl, managementMode=managementMode, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, searchState=searchState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelBCableLength=channelBCableLength, aggregateDataRate=aggregateDataRate, channelALoopbackTrap=channelALoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetRange=targetRange, supplementary=supplementary, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userName=userName)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsMeans=dfsMeans, managementPortWirelessDownAlert=managementPortWirelessDownAlert, automaticTxPowerControl=automaticTxPowerControl, sMTPEmailAlert=sMTPEmailAlert, transmitFreqMHz=transmitFreqMHz, txColorCode=txColorCode, secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, versions=versions, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, rxColorCode=rxColorCode, sMTPServerPortNumber=sMTPServerPortNumber, channelBLineCode=channelBLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelSelection=telecomsChannelSelection, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, phyControl=phyControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, latitude=latitude, sNTPState=sNTPState, tDDControl=tDDControl, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortStatus=dataPortStatus, channelBLoopback=channelBLoopback, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, timeZone=timeZone, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitModulationMode=transmitModulationMode, telecom=telecom, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementGroup=managementGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secureModeAlarm=secureModeAlarm, userTableNumber=userTableNumber)
