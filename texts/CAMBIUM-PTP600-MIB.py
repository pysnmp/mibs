...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:59:35 2021
...
ObjectIdentity, Counter32, enterprises, MibIdentifier, IpAddress, Unsigned32, NotificationType, Bits, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "enterprises", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType", "Bits", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkLoss=linkLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsTableIndex=dfsTableIndex, installStatus=installStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hAZLOCConfiguration=hAZLOCConfiguration, dfsTable=dfsTable, dfsPeaks=dfsPeaks, sNTPServerRetries=sNTPServerRetries, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBLineCode=channelBLineCode, l2CPPriorityTable=l2CPPriorityTable, channelALoopbackTrap=channelALoopbackTrap, bridgeGroup=bridgeGroup, iPv6Address=iPv6Address, telecomsChannelBStatus=telecomsChannelBStatus, licence=licence, sNTPServerTableIndex=sNTPServerTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, longitude=longitude, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, latitude=latitude, licenceGroup=licenceGroup, ethernetBridgingStatus=ethernetBridgingStatus, pubStatsGroup=pubStatsGroup, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, userName=userName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControlGroup=snmpControlGroup, channelBandwidth=channelBandwidth, sNTPServerTableEntry=sNTPServerTableEntry, dfsGroup=dfsGroup, sMTPServerPortNumber=sMTPServerPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, ethernetPriorityTable=ethernetPriorityTable, securityLevel=securityLevel, sNMPTrapTableEntry=sNMPTrapTableEntry, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqMHz=transmitFreqMHz, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, bootVersion=bootVersion, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoMdix=dataPortAutoMdix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, daylightSaving=daylightSaving, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, ptpGroups=ptpGroups, aAAControl=aAAControl, aAAControlGroup=aAAControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, management=management, byteErrorRatio=byteErrorRatio, bridge=bridge, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelSelection=telecomsChannelSelection, remoteInternetAddress=remoteInternetAddress, regionCode=regionCode, configuration=configuration, cableLoss=cableLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkName=linkName, userTableEntry=userTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatusTrap=installStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControl=phyControl, syslogState=syslogState, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetRange=targetRange, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, linkSymmetry=linkSymmetry, iPVersion=iPVersion, managementGroup=managementGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, ptpTraps=ptpTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, snmpControl=snmpControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, targetMACAddress=targetMACAddress, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, phyStatus=phyStatus, rxColorCode=rxColorCode, channelBLoopback=channelBLoopback, receiveFreqKHz=receiveFreqKHz, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, sMTPEnabledMessages=sMTPEnabledMessages, receiveChannel=receiveChannel, rangingMode=rangingMode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionGroup=encryptionGroup, secureModeAlarm=secureModeAlarm, sNTPServerStatus=sNTPServerStatus, altitude=altitude, eIRP=eIRP, transmitChannel=transmitChannel, channelALoopback=channelALoopback, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsTableEntry=dfsTableEntry, iPv6PrefixLength=iPv6PrefixLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPState=sNTPState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelBLoopbackTrap=channelBLoopbackTrap, telecomGroup=telecomGroup, systemReset=systemReset, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPSync=sNTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, alarms=alarms, dfsTableNumber=dfsTableNumber, dataPortStatus=dataPortStatus, telecomsInterface=telecomsInterface, telnetAccessEnabled=telnetAccessEnabled, regionCodeTrap=regionCodeTrap, maximumTransmitPower=maximumTransmitPower, smtpGroup=smtpGroup, pubStats=pubStats, bandwidthVariant=bandwidthVariant, receivePower=receivePower, productName=productName, syslogControl=syslogControl, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, dfsMeans=dfsMeans, wirelessLinkStatus=wirelessLinkStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClientTrap=syslogClientTrap, userRole=userRole, tDDControl=tDDControl, remoteInternetAddressType=remoteInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, remoteIPAddress=remoteIPAddress, searchState=searchState, telecom=telecom, range=range, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelACableLength=channelACableLength, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementMode=managementMode, remoteRxTargetPower=remoteRxTargetPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, phyStatusGroup=phyStatusGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfs=dfs, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rawReceivePower=rawReceivePower, tDDSynchronizationMode=tDDSynchronizationMode, vLANManagementVID=vLANManagementVID, smtp=smtp, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, dataPortFiberStatus=dataPortFiberStatus, timeZone=timeZone, vectorError=vectorError, masterSlaveMode=masterSlaveMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp600=ptp600, l2CPPriorityTableIndex=l2CPPriorityTableIndex, frequencyVariant=frequencyVariant, iPv4Address=iPv4Address, secureModeAlarmTrap=secureModeAlarmTrap, resetGroup=resetGroup, sNTPServerTimeout=sNTPServerTimeout, txColorCode=txColorCode, versionsGroup=versionsGroup, alarmsGroup=alarmsGroup, antennaGain=antennaGain, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPLastSync=sNTPLastSync, softwareVersion=softwareVersion, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sntp=sntp, channelBCableLength=channelBCableLength, transmitFreqKHz=transmitFreqKHz, sMTPServerInternetAddress=sMTPServerInternetAddress, aggregateDataRate=aggregateDataRate, systemClock=systemClock, userTableNumber=userTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, accessMethod=accessMethod, sNTPPrimaryServer=sNTPPrimaryServer, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, configurationGroup=configurationGroup, sNTPServerTableNumber=sNTPServerTableNumber, syslogControlGroup=syslogControlGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userPassword=userPassword, transmitDataRate=transmitDataRate)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogStateTrap=syslogStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, ptp=ptp, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userTableIndex=userTableIndex, channelALineCode=channelALineCode, ethernetBridgingAvailability=ethernetBridgingAvailability, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptmp=ptmp, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryption=encryption, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortStatus=managementPortStatus, cambium=cambium, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClient=syslogClient, telecomsChannelAStatus=telecomsChannelAStatus, tDDControlGroup=tDDControlGroup, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, notificationsGroup=notificationsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortStatusTrap=managementPortStatusTrap, versions=versions, subnetMask=subnetMask, hTTPAccessEnabled=hTTPAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetGroup=ethernetGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, supplementaryGroup=supplementaryGroup, siteName=siteName)
