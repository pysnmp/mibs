...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyStatus=phyStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPSync=sNTPSync, aAAControlGroup=aAAControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, hTTPSPortNumber=hTTPSPortNumber, range=range, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkStatus=wirelessLinkStatus, iPv6Address=iPv6Address, channelALineCode=channelALineCode, alarmsGroup=alarmsGroup, ptp600=ptp600, rxColorCode=rxColorCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableNumber=sNTPServerTableNumber, dfsTable=dfsTable, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, sNTPPollInterval=sNTPPollInterval, linkName=linkName, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, userRole=userRole, bridge=bridge, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, dataPortFiberStatus=dataPortFiberStatus, dfsGroup=dfsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitModulationMode=transmitModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogState=syslogState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, dfs=dfs, versions=versions, management=management, dSCPManagementPriority=dSCPManagementPriority, sMTPServerIPAddress=sMTPServerIPAddress, channelALoopbackTrap=channelALoopbackTrap, targetMACAddress=targetMACAddress, remoteRxTargetPower=remoteRxTargetPower, receiveModulationModeDetail=receiveModulationModeDetail, gatewayIPAddress=gatewayIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsInterface=telecomsInterface, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPState=sNTPState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatusGroup=phyStatusGroup, transmitFreqKHz=transmitFreqKHz, telecomGroup=telecomGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBCableLength=channelBCableLength, resetGroup=resetGroup, eIRP=eIRP, iPVersion=iPVersion, managementGroup=managementGroup, sntp=sntp, regionCode=regionCode, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, installStatus=installStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementVID=vLANManagementVID, sntpGroup=sntpGroup, securityLevel=securityLevel, rangingMode=rangingMode, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsTableIndex=dfsTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, targetRange=targetRange, ethernetBridgingAvailability=ethernetBridgingAvailability, iPv4Address=iPv4Address, transmitPower=transmitPower, hAZLOCConfiguration=hAZLOCConfiguration, syslogControl=syslogControl, searchState=searchState, txColorCode=txColorCode, subnetMask=subnetMask, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBandwidth=channelBandwidth, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarm=secureModeAlarm, snmpControl=snmpControl, syslogClientTrap=syslogClientTrap, configuration=configuration, l2CPPriorityTable=l2CPPriorityTable, qOSPriorityScheme=qOSPriorityScheme, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableNumber=userTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, groupID=groupID, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, siteName=siteName, tFTPServerInternetAddress=tFTPServerInternetAddress, signalStrengthRatio=signalStrengthRatio, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userTable=userTable, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, supplementaryGroup=supplementaryGroup, channelBLoopbackTrap=channelBLoopbackTrap, userPassword=userPassword, sNMPPortNumber=sNMPPortNumber, encryptionAlgorithm=encryptionAlgorithm, userTableEntry=userTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, softwareVersion=softwareVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, noWirelessChannelAvailable=noWirelessChannelAvailable, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementary=supplementary, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, sNTPSyncTrap=sNTPSyncTrap, managementPortStatus=managementPortStatus, dataPortAutoMdix=dataPortAutoMdix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rawReceivePower=rawReceivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementMode=managementMode, channelBLineCode=channelBLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerPortNumber=sNTPServerPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableNumber=dfsTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, receiveFreqMHz=receiveFreqMHz, localPacketFiltering=localPacketFiltering, iPv6PrefixLength=iPv6PrefixLength, unitOutOfCalibration=unitOutOfCalibration, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationMode=tDDSynchronizationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userName=userName, tDDControl=tDDControl, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, ethernetGroup=ethernetGroup, secureModeAlarmTrap=secureModeAlarmTrap, managementPortDisabledWarning=managementPortDisabledWarning, telecomsChannelAStatus=telecomsChannelAStatus, dataPortStatus=dataPortStatus, latitude=latitude, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, smtp=smtp, sNMPCommunityString=sNMPCommunityString, alarms=alarms, tDDControlGroup=tDDControlGroup, ethernet=ethernet, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelSelection=telecomsChannelSelection, channelALoopback=channelALoopback, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, ptp=ptp, encryption=encryption, channelACableLength=channelACableLength, licence=licence, byteErrorRatio=byteErrorRatio, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, userTableIndex=userTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClient=syslogClient, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, linkSymmetry=linkSymmetry, sNTPServerTable=sNTPServerTable, versionsGroup=versionsGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelChangeTrap=channelChangeTrap, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, altitude=altitude, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatus=telecomsChannelBStatus, ptmp=ptmp, aAAControl=aAAControl, automaticTxPowerControl=automaticTxPowerControl, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, timeZone=timeZone, longitude=longitude, dfsTableEntry=dfsTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, installArmStateTrap=installArmStateTrap, bridgeGroup=bridgeGroup, daylightSaving=daylightSaving, reset=reset, accessMethod=accessMethod, cambium=cambium)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortStatusTrap=managementPortStatusTrap, antennaGain=antennaGain, phyControl=phyControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptpGroups=ptpGroups, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userEnabled=userEnabled, sNTPServerTimeout=sNTPServerTimeout, pubStats=pubStats, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPLastSync=sNTPLastSync, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogControlGroup=syslogControlGroup, dfsMeans=dfsMeans, iPv6GatewayAddress=iPv6GatewayAddress, channelBLoopback=channelBLoopback, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveFreqKHz=receiveFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, systemClock=systemClock, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, receiveDataRate=receiveDataRate, frequencyVariant=frequencyVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddressType=remoteInternetAddressType, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry)
