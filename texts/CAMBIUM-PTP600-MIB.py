...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetPriorityTable=ethernetPriorityTable, alarms=alarms, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, altitude=altitude, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, hAZLOCConfiguration=hAZLOCConfiguration, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, sNTPPrimaryServer=sNTPPrimaryServer, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitModulationMode=transmitModulationMode, phyStatusGroup=phyStatusGroup, sNMPCommunityString=sNMPCommunityString, range=range, telecomsChannelAStatus=telecomsChannelAStatus, channelALoopbackTrap=channelALoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, snmpControl=snmpControl, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, longitude=longitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, targetRange=targetRange, wirelessLinkAvailability=wirelessLinkAvailability, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerStatus=sNTPServerStatus, hTTPSPortNumber=hTTPSPortNumber, aAAControl=aAAControl, transmitPower=transmitPower, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, dfsGroup=dfsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configuration=configuration, syslogControl=syslogControl, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, regionCode=regionCode, softwareVersion=softwareVersion, managementPortStatusTrap=managementPortStatusTrap, dfsTableEntry=dfsTableEntry, telecomGroup=telecomGroup, telecomsInterface=telecomsInterface, dfsPeaks=dfsPeaks, sntpGroup=sntpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerInternetAddressType=sMTPServerInternetAddressType, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptmp=ptmp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALoopback=channelALoopback, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, channelACableLength=channelACableLength, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, sNTPServerRetries=sNTPServerRetries, remoteInternetAddressType=remoteInternetAddressType, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, daylightSaving=daylightSaving, channelBLineCode=channelBLineCode, rangingMode=rangingMode, managementPortDisabledWarning=managementPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, userTableIndex=userTableIndex, ptpCompliance=ptpCompliance, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, userEnabled=userEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, targetMACAddress=targetMACAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelBCableLength=channelBCableLength, bandwidthVariant=bandwidthVariant, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkLoss=linkLoss, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, timeZone=timeZone, securityLevel=securityLevel, sNTPServerTableEntry=sNTPServerTableEntry, tDDControlGroup=tDDControlGroup, sNMPPortNumber=sNMPPortNumber, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemClock=systemClock, sNTPServerTableIndex=sNTPServerTableIndex, frequencyVariant=frequencyVariant, channelBLoopback=channelBLoopback, ptp=ptp, bootVersion=bootVersion, sntp=sntp, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, licence=licence, managementGroup=managementGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteIPAddress=remoteIPAddress, qOSPriorityScheme=qOSPriorityScheme, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, managementMode=managementMode, userName=userName, sNTPServerTable=sNTPServerTable, channelChangeTrap=channelChangeTrap, supplementary=supplementary, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, bridge=bridge, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vectorError=vectorError, userTableEntry=userTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, rawReceivePower=rawReceivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, iPv6GatewayAddress=iPv6GatewayAddress, iPv4Address=iPv4Address, sNTPState=sNTPState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, vLANManagementVID=vLANManagementVID, channelALineCode=channelALineCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernet=ethernet, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsTableIndex=dfsTableIndex, rxColorCode=rxColorCode, sNTPServerTableNumber=sNTPServerTableNumber, cableLoss=cableLoss, eIRP=eIRP, tFTPServerInternetAddress=tFTPServerInternetAddress, groupID=groupID, iPv6Address=iPv6Address, siteName=siteName, dfsMeans=dfsMeans, aAAControlGroup=aAAControlGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, txColorCode=txColorCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, ethernetPriorityTableNumber=ethernetPriorityTableNumber, installStatus=installStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, alarmsGroup=alarmsGroup, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, pubStatsGroup=pubStatsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPVersion=iPVersion, automaticTxPowerControl=automaticTxPowerControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitDataRate=transmitDataRate, secureModeAlarmTrap=secureModeAlarmTrap, remoteInternetAddress=remoteInternetAddress, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, syslogClientTrap=syslogClientTrap, ptp600=ptp600, pubStats=pubStats, ptpGroups=ptpGroups, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, linkSymmetry=linkSymmetry, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetPortNumber=telnetPortNumber, reset=reset, sNTPServerTimeout=sNTPServerTimeout, installStatusTrap=installStatusTrap, smtp=smtp, encryption=encryption, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogState=syslogState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerInternetAddress=sNTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableNumber=dfsTableNumber, bridgeGroup=bridgeGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versions=versions, phyControl=phyControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, dataPortFiberStatus=dataPortFiberStatus, phyControlGroup=phyControlGroup, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, managementPortStatus=managementPortStatus, hardwareVersion=hardwareVersion, telecom=telecom, telecomsChannelSelection=telecomsChannelSelection, secureModeAlarm=secureModeAlarm, management=management, receiveChannel=receiveChannel, sNTPSyncTrap=sNTPSyncTrap, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatus=ethernetBridgingStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, localPacketFiltering=localPacketFiltering, phyStatus=phyStatus, l2CPPriorityTable=l2CPPriorityTable, maximumTransmitPower=maximumTransmitPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailable=noWirelessChannelAvailable, dfs=dfs, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cambium=cambium, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, productVariant=productVariant, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortStatus=dataPortStatus)
