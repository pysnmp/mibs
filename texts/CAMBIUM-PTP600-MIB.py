...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", versions=versions, ethernetPriorityTableEntry=ethernetPriorityTableEntry, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableEntry=dfsTableEntry, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, channelBLoopback=channelBLoopback, receiveChannel=receiveChannel, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, managementPortStatus=managementPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, rawReceivePower=rawReceivePower, dfsTable=dfsTable, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, qOSPriorityScheme=qOSPriorityScheme, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableEntry=userTableEntry, syslogClientTrap=syslogClientTrap, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, l2CPPriorityTableIndex=l2CPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, latitude=latitude, installArmState=installArmState, snmpControlGroup=snmpControlGroup, sntpGroup=sntpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxColorCode=rxColorCode, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, altitude=altitude, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, receivePower=receivePower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, PYSNMP_MODULE_ID=cambium, receiveModulationMode=receiveModulationMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, daylightSaving=daylightSaving, useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarms=alarms, managementPortConfigurationMismatch=managementPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTableEntry=l2CPPriorityTableEntry, alarmsGroup=alarmsGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, siteName=siteName, searchState=searchState, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTable=sNTPServerTable, receiveFreqMHz=receiveFreqMHz, smtpGroup=smtpGroup, telecomsInterface=telecomsInterface, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, ethernetGroup=ethernetGroup, targetMACAddress=targetMACAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatus=ethernetBridgingStatus, licence=licence, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, installStatus=installStatus, linkSymmetry=linkSymmetry, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, remoteRxTargetPower=remoteRxTargetPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bridgeGroup=bridgeGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, txColorCode=txColorCode, management=management, dfsPeaks=dfsPeaks, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTableNumber=sNTPServerTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, sNTPServerTableIndex=sNTPServerTableIndex, dfs=dfs, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rangingMode=rangingMode, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatus=dataPortFiberStatus, managementPortDisabledWarning=managementPortDisabledWarning, configuration=configuration, productName=productName, constantPowerSpectralDensity=constantPowerSpectralDensity, wirelessLinkAvailability=wirelessLinkAvailability, channelALoopback=channelALoopback, hTTPSPortNumber=hTTPSPortNumber, vLANManagementPriority=vLANManagementPriority, groupID=groupID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, channelACableLength=channelACableLength, tFTPServerPortNumber=tFTPServerPortNumber, userTableNumber=userTableNumber, remoteInternetAddress=remoteInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, masterSlaveMode=masterSlaveMode, iPv4Address=iPv4Address, managementMode=managementMode, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControl=tDDControl, receiveDataRate=receiveDataRate, subnetMask=subnetMask, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerRetries=sNTPServerRetries, userEnabled=userEnabled, iPVersion=iPVersion, versionsGroup=versionsGroup, encryption=encryption, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, channelBLoopbackTrap=channelBLoopbackTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, ethernetPriorityTableIndex=ethernetPriorityTableIndex, securityLevel=securityLevel, tFTPServerIPAddress=tFTPServerIPAddress, range=range, linkName=linkName, sNMPCommunityString=sNMPCommunityString, systemClock=systemClock, telecomsChannelAStatus=telecomsChannelAStatus, sntp=sntp, installArmStateTrap=installArmStateTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, dfsTableNumber=dfsTableNumber, iPv6Address=iPv6Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomGroup=telecomGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBCableLength=channelBCableLength, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, regionCodeTrap=regionCodeTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userName=userName, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, systemReset=systemReset, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptp=ptp, dfsMeans=dfsMeans, cambium=cambium, channelBandwidth=channelBandwidth, syslogStateTrap=syslogStateTrap, targetRange=targetRange, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, notificationsGroup=notificationsGroup, iPv6PrefixLength=iPv6PrefixLength, regionCode=regionCode, ptmp=ptmp, transmitFreqKHz=transmitFreqKHz, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, syslogControl=syslogControl, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, syslogClient=syslogClient, longitude=longitude, transmitPower=transmitPower, channelChangeTrap=channelChangeTrap, ethernet=ethernet, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementary=supplementary, resetGroup=resetGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTable=sNMPTrapTable, channelBLineCode=channelBLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerStatus=sNTPServerStatus, channelALineCode=channelALineCode, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, cableLoss=cableLoss, ptp600=ptp600, eIRP=eIRP, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, channelALoopbackTrap=channelALoopbackTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatus=phyStatus, userRole=userRole, hardwareVersion=hardwareVersion, l2CPPriorityTable=l2CPPriorityTable, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDControlGroup=tDDControlGroup, transmitChannel=transmitChannel, sNTPServerTableEntry=sNTPServerTableEntry, reset=reset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsChannelSelection=telecomsChannelSelection, dataPortDisabledWarning=dataPortDisabledWarning, aAAControlGroup=aAAControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyStatusGroup=phyStatusGroup, phyControlGroup=phyControlGroup, localPacketFiltering=localPacketFiltering, sNMPEnabledTraps=sNMPEnabledTraps, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, automaticTxPowerControl=automaticTxPowerControl)
