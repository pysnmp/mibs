...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmState=installArmState, secureModeAlarm=secureModeAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPLastSync=sNTPLastSync, transmitChannel=transmitChannel, ptmp=ptmp, channelALoopback=channelALoopback, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerIPAddress=sMTPServerIPAddress, management=management, ethernetBridgingAvailability=ethernetBridgingAvailability, ptpGroups=ptpGroups, snmpControl=snmpControl, automaticTxPowerControl=automaticTxPowerControl, iPv6PrefixLength=iPv6PrefixLength, userTableEntry=userTableEntry, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitPower=transmitPower, hTTPSPortNumber=hTTPSPortNumber, userTableIndex=userTableIndex, dSCPManagementPriority=dSCPManagementPriority, syslogStateTrap=syslogStateTrap, sNTPSyncTrap=sNTPSyncTrap, vLANManagementVID=vLANManagementVID, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitFreqMHz=transmitFreqMHz, rawReceivePower=rawReceivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveDataRate=receiveDataRate, remoteInternetAddressType=remoteInternetAddressType, securityLevel=securityLevel, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetAccessEnabled=telnetAccessEnabled, channelBCableLength=channelBCableLength, managementPortDisabledWarning=managementPortDisabledWarning, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, sntp=sntp, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receivePower=receivePower, dataPortAutoMdix=dataPortAutoMdix, softwareVersion=softwareVersion, syslogClient=syslogClient, ethernet=ethernet, dfsTableEntry=dfsTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsChannelBStatus=telecomsChannelBStatus, wirelessLinkAvailability=wirelessLinkAvailability, byteErrorRatio=byteErrorRatio, daylightSaving=daylightSaving, sNTPServerRetries=sNTPServerRetries, antennaGain=antennaGain, supplementary=supplementary, tFTPServerIPAddress=tFTPServerIPAddress, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, groupID=groupID, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpCompliance=ptpCompliance, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatus=ethernetBridgingStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPState=sNTPState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, PYSNMP_MODULE_ID=cambium, receiveModulationMode=receiveModulationMode, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dfsTable=dfsTable, bridgeGroup=bridgeGroup, l2CPPriorityTable=l2CPPriorityTable, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, systemReset=systemReset, latitude=latitude, dfsTableNumber=dfsTableNumber, iPv4Address=iPv4Address, channelChangeTrap=channelChangeTrap, syslogControl=syslogControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelALoopbackTrap=channelALoopbackTrap, sNTPPrimaryServer=sNTPPrimaryServer, ptp600=ptp600, resetGroup=resetGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, telecomsChannelSelection=telecomsChannelSelection, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, targetMACAddress=targetMACAddress, dataPortFiberStatus=dataPortFiberStatus, managementPortStatusTrap=managementPortStatusTrap, channelALineCode=channelALineCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, channelACableLength=channelACableLength, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, managementPortStatus=managementPortStatus, sNTPServerStatus=sNTPServerStatus, receiveChannel=receiveChannel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, subnetMask=subnetMask, altitude=altitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyControlGroup=phyControlGroup, productVariant=productVariant, sNTPServerTimeout=sNTPServerTimeout, hAZLOCConfiguration=hAZLOCConfiguration, licenceGroup=licenceGroup, versions=versions, transmitDataRate=transmitDataRate, smtp=smtp, phyStatusGroup=phyStatusGroup, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, configurationGroup=configurationGroup, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControl=tDDControl, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, linkLoss=linkLoss, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, dfsGroup=dfsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, qOSPriorityScheme=qOSPriorityScheme, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptp=ptp, sNTPServerTableIndex=sNTPServerTableIndex, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, localPacketFiltering=localPacketFiltering, channelBLoopbackTrap=channelBLoopbackTrap, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, encryptionGroup=encryptionGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsInterface=telecomsInterface, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licence=licence, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableIndex=sNMPTrapTableIndex, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, rangingMode=rangingMode, systemClock=systemClock, sNTPSync=sNTPSync, constantPowerSpectralDensity=constantPowerSpectralDensity, encryption=encryption, regionCodeTrap=regionCodeTrap, phyStatus=phyStatus, cambium=cambium, supplementaryGroup=supplementaryGroup, telecomGroup=telecomGroup, txColorCode=txColorCode, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, eIRP=eIRP, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, userName=userName, ethernetPriorityTable=ethernetPriorityTable, phyControl=phyControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsPeaks=dfsPeaks, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6Address=iPv6Address, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionAlgorithm=encryptionAlgorithm, masterSlaveMode=masterSlaveMode, secureModeAlarmTrap=secureModeAlarmTrap, managementMode=managementMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bridge=bridge, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatus=installStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, rxColorCode=rxColorCode, sNTPServerTable=sNTPServerTable, pubStats=pubStats, timeZone=timeZone, linkName=linkName, configuration=configuration, telecomsChannelAStatus=telecomsChannelAStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBLineCode=channelBLineCode, longitude=longitude, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarm=tDDSynchronizationAlarm, targetRange=targetRange, searchState=searchState, frequencyVariant=frequencyVariant, aAAControlGroup=aAAControlGroup, iPVersion=iPVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTable=userTable, channelBLoopback=channelBLoopback, cableLoss=cableLoss, userTableNumber=userTableNumber, bandwidthVariant=bandwidthVariant, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, range=range, managementGroup=managementGroup, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, accessMethod=accessMethod, alarms=alarms, syslogState=syslogState, sntpGroup=sntpGroup, telecom=telecom, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress)
