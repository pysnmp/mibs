...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyStatus=phyStatus, timeZone=timeZone, dataPortStatus=dataPortStatus, aggregateDataRate=aggregateDataRate, rangingMode=rangingMode, accessMethod=accessMethod, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, remoteRxTargetPower=remoteRxTargetPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, installArmState=installArmState, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelALineCode=channelALineCode, ethernet=ethernet, dSCPManagementPriority=dSCPManagementPriority, installStatusTrap=installStatusTrap, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, productName=productName, transmitPower=transmitPower, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, rawReceivePower=rawReceivePower, sMTPServerPortNumber=sMTPServerPortNumber, regionCodeTrap=regionCodeTrap, dfs=dfs, tFTPServerInternetAddress=tFTPServerInternetAddress, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerStatus=sNTPServerStatus, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, sntpGroup=sntpGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, sNTPPrimaryServer=sNTPPrimaryServer, linkSymmetry=linkSymmetry, userName=userName, sNTPPollInterval=sNTPPollInterval, dfsTable=dfsTable, localPacketFiltering=localPacketFiltering, hardwareVersion=hardwareVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, automaticTxPowerControl=automaticTxPowerControl, installStatus=installStatus, sNTPServerTableIndex=sNTPServerTableIndex, encryptionAlgorithm=encryptionAlgorithm, managementPortStatus=managementPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetBridgingAvailability=ethernetBridgingAvailability, txColorCode=txColorCode, latitude=latitude, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, dataPortFiberStatusTrap=dataPortFiberStatusTrap, versions=versions, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptp=ptp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, managementPortStatusTrap=managementPortStatusTrap, userPassword=userPassword, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, supplementary=supplementary, linkName=linkName, bandwidthVariant=bandwidthVariant, transmitChannel=transmitChannel, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, groupID=groupID, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControl=aAAControl, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetMACAddress=targetMACAddress, sNTPServerTableNumber=sNTPServerTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, reset=reset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secureModeAlarm=secureModeAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, receivePower=receivePower, sNTPServerRetries=sNTPServerRetries, telecomsInterface=telecomsInterface, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, telnetAccessEnabled=telnetAccessEnabled, userEnabled=userEnabled, sNTPServerTimeout=sNTPServerTimeout, dfsMeans=dfsMeans, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPSync=sNTPSync, sNTPServerTableEntry=sNTPServerTableEntry, userRole=userRole, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortDisabledWarning=managementPortDisabledWarning, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelACableLength=channelACableLength, sntp=sntp, phyControl=phyControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, softwareVersion=softwareVersion, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, iPv6Address=iPv6Address, pubStats=pubStats, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, incompatibleRegionCodes=incompatibleRegionCodes, channelChangeTrap=channelChangeTrap, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogControl=syslogControl, systemClock=systemClock, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelALoopbackTrap=channelALoopbackTrap, telecom=telecom, tDDControl=tDDControl, vectorError=vectorError, phyControlGroup=phyControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelSelection=telecomsChannelSelection, eIRP=eIRP, mPLSTCPriorityTable=mPLSTCPriorityTable, cableLoss=cableLoss, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPState=sNTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, managementMode=managementMode, syslogClientTrap=syslogClientTrap, channelBLoopbackTrap=channelBLoopbackTrap, vLANManagementVID=vLANManagementVID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, byteErrorRatio=byteErrorRatio, transmitDataRate=transmitDataRate, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, targetRange=targetRange, sNMPPortNumber=sNMPPortNumber, sNTPSyncTrap=sNTPSyncTrap, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelBCableLength=channelBCableLength, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, securityLevel=securityLevel, smtp=smtp, userTableIndex=userTableIndex, bridgeGroup=bridgeGroup, channelALoopback=channelALoopback, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, channelBLineCode=channelBLineCode, snmpControl=snmpControl, syslogControlGroup=syslogControlGroup, licence=licence, dataPortConfigurationMismatch=dataPortConfigurationMismatch, longitude=longitude, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, iPv4Address=iPv4Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, snmpControlGroup=snmpControlGroup, altitude=altitude, encryptionGroup=encryptionGroup, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsTableEntry=dfsTableEntry, remoteInternetAddressType=remoteInternetAddressType, ptp600=ptp600, telecomsChannelAStatus=telecomsChannelAStatus, alarmsGroup=alarmsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpGroups=ptpGroups, channelBLoopback=channelBLoopback, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, dfsPeaks=dfsPeaks, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, bridge=bridge, dataPortDisabledWarning=dataPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, rxColorCode=rxColorCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerIPAddress=sMTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, cambium=cambium, management=management, phyStatusGroup=phyStatusGroup, iPVersion=iPVersion, hAZLOCConfiguration=hAZLOCConfiguration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userTable=userTable, iPv6GatewayAddress=iPv6GatewayAddress, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, range=range, dfsTableNumber=dfsTableNumber, alarms=alarms, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, frequencyVariant=frequencyVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup)
