...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClient=syslogClient, secondarySoftwareVersion=secondarySoftwareVersion, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, altitude=altitude, ethernet=ethernet, userTable=userTable, ethernetFiberSupport=ethernetFiberSupport, iPv6PrefixLength=iPv6PrefixLength, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, l2CPPriorityTable=l2CPPriorityTable, latitude=latitude, managementMode=managementMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortStatus=managementPortStatus, sNTPServerRetries=sNTPServerRetries, secureModeAlarm=secureModeAlarm, syslogClientTrap=syslogClientTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, rawReceivePower=rawReceivePower, managementPortStatusTrap=managementPortStatusTrap, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, management=management, channelACableLength=channelACableLength, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerTimeout=sNTPServerTimeout, bridgeGroup=bridgeGroup, userPassword=userPassword, range=range, sMTPEmailAlert=sMTPEmailAlert, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitDataRate=transmitDataRate, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddressType=remoteInternetAddressType, maximumTransmitPower=maximumTransmitPower, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, channelBLoopback=channelBLoopback, daylightSaving=daylightSaving, phyControl=phyControl, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, aggregateDataRate=aggregateDataRate, bandwidthVariant=bandwidthVariant, productName=productName, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, phyControlGroup=phyControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBCableLength=channelBCableLength, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, vectorError=vectorError, l2CPPriorityTableEntry=l2CPPriorityTableEntry, securityLevel=securityLevel, sNTPPollInterval=sNTPPollInterval, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyStatusGroup=phyStatusGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveChannel=receiveChannel, channelALoopbackTrap=channelALoopbackTrap, alarmsGroup=alarmsGroup, phyStatus=phyStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPLastSync=sNTPLastSync, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, telecomGroup=telecomGroup, managementGroup=managementGroup, telecomsChannelAStatus=telecomsChannelAStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, smtp=smtp, remoteInternetAddress=remoteInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, accessMethod=accessMethod, notificationsGroup=notificationsGroup, userTableNumber=userTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, ptpCompliance=ptpCompliance, encryption=encryption, systemClock=systemClock, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, encryptionAlgorithm=encryptionAlgorithm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, dfsTable=dfsTable, telecomsChannelSelection=telecomsChannelSelection, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortDisabledWarning=managementPortDisabledWarning, dataPortStatus=dataPortStatus, ethernetGroup=ethernetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALoopback=channelALoopback, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userTableEntry=userTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, reset=reset, productVariant=productVariant, tDDControlGroup=tDDControlGroup, resetGroup=resetGroup, syslogControlGroup=syslogControlGroup, supplementary=supplementary, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpGroups=ptpGroups, telecomsChannelBStatus=telecomsChannelBStatus, transmitModulationMode=transmitModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, dataPortFiberStatus=dataPortFiberStatus, bootVersion=bootVersion, groupID=groupID, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, antennaGain=antennaGain, ptp=ptp, eIRP=eIRP, versions=versions, dataPortAutoNegotiation=dataPortAutoNegotiation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, userName=userName, licence=licence, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, sntp=sntp, automaticTxPowerControl=automaticTxPowerControl, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, syslogState=syslogState, signalStrengthRatio=signalStrengthRatio, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, systemReset=systemReset, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, sNMPPortNumber=sNMPPortNumber, iPv6Address=iPv6Address, telecomsInterface=telecomsInterface, sNTPPrimaryServer=sNTPPrimaryServer, hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, rxColorCode=rxColorCode, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, encryptionGroup=encryptionGroup, iPv6GatewayAddress=iPv6GatewayAddress, pubStats=pubStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp600=ptp600, remoteIPAddress=remoteIPAddress, installArmState=installArmState, channelBLineCode=channelBLineCode, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableIndex=dfsTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, rangingMode=rangingMode, pubStatsGroup=pubStatsGroup, tFTPServerIPAddress=tFTPServerIPAddress, longitude=longitude, sMTPServerInternetAddress=sMTPServerInternetAddress, dfs=dfs, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, remoteRxTargetPower=remoteRxTargetPower, regionCode=regionCode, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecom=telecom, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitFreqKHz=transmitFreqKHz, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, unitOutOfCalibration=unitOutOfCalibration, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receivePower=receivePower, transmitChannel=transmitChannel, ptmp=ptmp, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, regionCodeTrap=regionCodeTrap, licenceGroup=licenceGroup, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementVID=vLANManagementVID, hTTPAccessEnabled=hTTPAccessEnabled, txColorCode=txColorCode, channelBandwidth=channelBandwidth, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, versionsGroup=versionsGroup, sNTPServerStatus=sNTPServerStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetBridgingStatus=ethernetBridgingStatus, localPacketFiltering=localPacketFiltering, sNTPServerTable=sNTPServerTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDControl=tDDControl, targetRange=targetRange, snmpControl=snmpControl)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableNumber=dfsTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, bridge=bridge, alarms=alarms, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, softwareVersion=softwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTableEntry=sNTPServerTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, managementPortWirelessDownAlert=managementPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, searchState=searchState, qOSPriorityScheme=qOSPriorityScheme, configuration=configuration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, sntpGroup=sntpGroup, dataPortAutoMdix=dataPortAutoMdix, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, channelBLoopbackTrap=channelBLoopbackTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPState=sNTPState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, masterSlaveMode=masterSlaveMode, channelALineCode=channelALineCode, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, linkLoss=linkLoss, dfsPeaks=dfsPeaks, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv4Address=iPv4Address, aAAControl=aAAControl)
