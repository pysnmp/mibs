...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, sNTPServerTableEntry=sNTPServerTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, dfsMeans=dfsMeans, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, productVariant=productVariant, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userName=userName, aggregateDataRate=aggregateDataRate, channelALoopback=channelALoopback, channelALoopbackTrap=channelALoopbackTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableIndex=userTableIndex, phyStatusGroup=phyStatusGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelBandwidth=channelBandwidth, siteName=siteName, managementMode=managementMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, altitude=altitude, antennaGain=antennaGain, systemClock=systemClock, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCodeTrap=regionCodeTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecom=telecom, maximumTransmitPower=maximumTransmitPower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPPortNumber=sNMPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, installStatus=installStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPServerIPAddress=tFTPServerIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDControlGroup=tDDControlGroup, telecomsChannelAStatus=telecomsChannelAStatus, userPassword=userPassword, bandwidthVariant=bandwidthVariant, dSCPManagementPriority=dSCPManagementPriority, pubStats=pubStats, iPv4Address=iPv4Address, softwareVersion=softwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, remoteInternetAddress=remoteInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, receiveFreqMHz=receiveFreqMHz, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, dfsTable=dfsTable, linkSymmetry=linkSymmetry, ethernet=ethernet, licenceGroup=licenceGroup, sntpGroup=sntpGroup, hAZLOCConfiguration=hAZLOCConfiguration, receiveDataRate=receiveDataRate, userEnabled=userEnabled, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemReset=systemReset, syslogControl=syslogControl, userTableEntry=userTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, telecomsInterface=telecomsInterface, localPacketFiltering=localPacketFiltering, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsGroup=dfsGroup, wirelessLinkStatus=wirelessLinkStatus, byteErrorRatio=byteErrorRatio, alarmsGroup=alarmsGroup, installArmState=installArmState, smtp=smtp, configuration=configuration, channelALineCode=channelALineCode, frequencyVariant=frequencyVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rangingMode=rangingMode, sNMPCommunityString=sNMPCommunityString, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimisation=linkModeOptimisation, licence=licence, linkLoss=linkLoss, channelBCableLength=channelBCableLength, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, dataPortStatus=dataPortStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, managementPortStatus=managementPortStatus, sNTPServerTimeout=sNTPServerTimeout, receivePower=receivePower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, channelACableLength=channelACableLength, mPLSTCPriorityTable=mPLSTCPriorityTable, vLANManagementVID=vLANManagementVID, telecomsChannelSelection=telecomsChannelSelection, managementPortDisabledWarning=managementPortDisabledWarning, alarms=alarms, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, management=management, remoteInternetAddressType=remoteInternetAddressType, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, channelBLoopbackTrap=channelBLoopbackTrap, signalStrengthRatio=signalStrengthRatio, reset=reset, bridge=bridge, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps, telecomGroup=telecomGroup, eIRP=eIRP, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, sNTPState=sNTPState, range=range, hardwareVersion=hardwareVersion, phyStatus=phyStatus, aAAControlGroup=aAAControlGroup, userTable=userTable, ptmp=ptmp, transmitChannel=transmitChannel, syslogClient=syslogClient, ethernetBridgingStatus=ethernetBridgingStatus, managementGroup=managementGroup, encryption=encryption, bridgeGroup=bridgeGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkName=linkName, dfs=dfs, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, sNTPServerStatus=sNTPServerStatus, iPVersion=iPVersion, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarm=secureModeAlarm, rawReceivePower=rawReceivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, qOSPriorityScheme=qOSPriorityScheme, regionCode=regionCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsTableEntry=dfsTableEntry, groupID=groupID, aAAControl=aAAControl, sNTPServerTable=sNTPServerTable, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogState=syslogState, ptp=ptp, pubStatsGroup=pubStatsGroup, channelChangeTrap=channelChangeTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelBStatus=telecomsChannelBStatus, phyControlGroup=phyControlGroup, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, subnetMask=subnetMask, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, resetGroup=resetGroup, productName=productName, sNMPTrapTable=sNMPTrapTable, targetRange=targetRange, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, channelBLineCode=channelBLineCode, iPv6Address=iPv6Address, automaticTxPowerControl=automaticTxPowerControl, ethernetGroup=ethernetGroup, transmitPower=transmitPower, iPv6GatewayAddress=iPv6GatewayAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, sntp=sntp, remoteIPAddress=remoteIPAddress, txColorCode=txColorCode, ethernetBridgingAvailability=ethernetBridgingAvailability, longitude=longitude, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpGroups=ptpGroups, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortConfigurationMismatch=managementPortConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPEmailAlert=sMTPEmailAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, managementPortStatusTrap=managementPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogStateTrap=syslogStateTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBLoopback=channelBLoopback, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, timeZone=timeZone, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableNumber=dfsTableNumber, syslogControlGroup=syslogControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, ptp600=ptp600, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rxColorCode=rxColorCode, sNTPLastSync=sNTPLastSync, l2CPPriorityTable=l2CPPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, cableLoss=cableLoss, notificationsGroup=notificationsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, accessMethod=accessMethod, iPv6PrefixLength=iPv6PrefixLength)
