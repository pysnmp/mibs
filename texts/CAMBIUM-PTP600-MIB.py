...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:10:58 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", maximumTransmitPower=maximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, remoteInternetAddressType=remoteInternetAddressType, sNMPv3Enable=sNMPv3Enable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, bandwidthVariant=bandwidthVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPSourceEmailAddress=sMTPSourceEmailAddress, groupID=groupID, dfsTableNumber=dfsTableNumber, unitOutOfCalibration=unitOutOfCalibration, localPacketFiltering=localPacketFiltering, sNMPTrapVersion=sNMPTrapVersion, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, hTTPPortNumber=hTTPPortNumber, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPrimaryServer=sNTPPrimaryServer, syslogClientTrap=syslogClientTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, securityLevel=securityLevel, supplementaryGroup=supplementaryGroup, rawReceivePower=rawReceivePower, pubStatsGroup=pubStatsGroup, bridge=bridge, channelALoopback=channelALoopback, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerStatus=sNTPServerStatus, sNTPServerPortNumber=sNTPServerPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, telecomsInterface=telecomsInterface, ethernetPriorityTable=ethernetPriorityTable, systemReset=systemReset, sMTPServerPortNumber=sMTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, licence=licence, managementMode=managementMode, ptp=ptp, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, systemClock=systemClock, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, channelALoopbackTrap=channelALoopbackTrap, reset=reset, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteRxTargetPower=remoteRxTargetPower, channelBLineCode=channelBLineCode, encryption=encryption, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarning=dataPortDisabledWarning, subnetMask=subnetMask, installStatus=installStatus, searchState=searchState, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, timeZone=timeZone, userTable=userTable, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, frequencyVariant=frequencyVariant, channelBLoopback=channelBLoopback, ethernet=ethernet, longitude=longitude, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementary=supplementary, dfsMeans=dfsMeans, smtp=smtp, iPVersion=iPVersion, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alarms=alarms, wirelessLinkAvailability=wirelessLinkAvailability, syslogStateTrap=syslogStateTrap, userPassword=userPassword, phyControlGroup=phyControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortStatusTrap=managementPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitChannel=transmitChannel, altitude=altitude, regionCode=regionCode, sntpGroup=sntpGroup, encryptionAlgorithm=encryptionAlgorithm, syslogState=syslogState, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rangingMode=rangingMode, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, ethernetBridgingStatus=ethernetBridgingStatus, transmitDataRate=transmitDataRate, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, byteErrorRatio=byteErrorRatio, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, versions=versions, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTable=sNMPTrapTable, siteName=siteName, targetRange=targetRange, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, cableLoss=cableLoss, dataPortAutoMdix=dataPortAutoMdix, configuration=configuration, channelALineCode=channelALineCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, syslogClient=syslogClient, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTimeout=sNTPServerTimeout, tFTPServerPortNumber=tFTPServerPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, versionsGroup=versionsGroup, dSCPManagementPriority=dSCPManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, qOSPriorityScheme=qOSPriorityScheme, management=management, vectorError=vectorError, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, userTableEntry=userTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationMode=tDDSynchronizationMode, rxColorCode=rxColorCode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBCableLength=channelBCableLength, sNTPSync=sNTPSync, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsPeaks=dfsPeaks, encryptionGroup=encryptionGroup, installArmState=installArmState, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelSelection=telecomsChannelSelection, ptmp=ptmp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTable=sNTPServerTable, wirelessLinkStatus=wirelessLinkStatus, productName=productName, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hAZLOCConfiguration=hAZLOCConfiguration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortFiberStatus=dataPortFiberStatus, phyStatusGroup=phyStatusGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptpCompliance=ptpCompliance, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, telnetPortNumber=telnetPortNumber, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, latitude=latitude, channelChangeTrap=channelChangeTrap, transmitFreqMHz=transmitFreqMHz, userRole=userRole, channelBandwidth=channelBandwidth, vLANManagementVID=vLANManagementVID, receiveModulationMode=receiveModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsGroup=dfsGroup, managementGroup=managementGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelACableLength=channelACableLength, hTTPSPortNumber=hTTPSPortNumber, dfs=dfs, receivePower=receivePower, transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, txColorCode=txColorCode, syslogControlGroup=syslogControlGroup, telecomsChannelAStatus=telecomsChannelAStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteIPAddress=remoteIPAddress, accessMethod=accessMethod, snmpControl=snmpControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, range=range, receiveChannel=receiveChannel, signalStrengthRatio=signalStrengthRatio, secureModeAlarm=secureModeAlarm, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, productVariant=productVariant, ptpGroups=ptpGroups, installStatusTrap=installStatusTrap, remoteInternetAddress=remoteInternetAddress, dataPortStatus=dataPortStatus, sNTPServerTableEntry=sNTPServerTableEntry, daylightSaving=daylightSaving, secureModeAlarmTrap=secureModeAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, iPv4Address=iPv4Address, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, regionCodeTrap=regionCodeTrap, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, receiveFreqKHz=receiveFreqKHz, dfsTableIndex=dfsTableIndex, licenceGroup=licenceGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTable=dfsTable, targetMACAddress=targetMACAddress, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, userEnabled=userEnabled, sNTPServerTableIndex=sNTPServerTableIndex, configurationGroup=configurationGroup, telecomsChannelBStatus=telecomsChannelBStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatus=managementPortStatus, ptp600=ptp600, bridgeGroup=bridgeGroup, linkSymmetry=linkSymmetry, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, notificationsGroup=notificationsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, cambium=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, iPv6Address=iPv6Address, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControl=phyControl, linkName=linkName, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecom=telecom, l2CPPriorityTable=l2CPPriorityTable, userName=userName, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPCommunityString=sNMPCommunityString, resetGroup=resetGroup, tDDControlGroup=tDDControlGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receiveModulationModeDetail=receiveModulationModeDetail)
