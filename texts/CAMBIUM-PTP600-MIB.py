...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPSPortNumber=hTTPSPortNumber, range=range, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, sNTPPollInterval=sNTPPollInterval, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, syslogState=syslogState, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, sNTPServerTableIndex=sNTPServerTableIndex, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, iPVersion=iPVersion, telecomGroup=telecomGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelSelection=telecomsChannelSelection, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelBStatus=telecomsChannelBStatus, hTTPPortNumber=hTTPPortNumber, supplementaryGroup=supplementaryGroup, aAAControlGroup=aAAControlGroup, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, userPassword=userPassword, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, rawReceivePower=rawReceivePower, cableLoss=cableLoss, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, encryption=encryption, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, alarms=alarms, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, ptp=ptp, smtp=smtp, ptpGroups=ptpGroups, dfsPeaks=dfsPeaks, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv6PrefixLength=iPv6PrefixLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerIPAddress=sNTPServerIPAddress, localPacketFiltering=localPacketFiltering, sNTPServerStatus=sNTPServerStatus, regionCodeTrap=regionCodeTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetAccessEnabled=telnetAccessEnabled, syslogControl=syslogControl, telnetPortNumber=telnetPortNumber, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, iPv6GatewayAddress=iPv6GatewayAddress, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, managementPortStatusTrap=managementPortStatusTrap, sNTPServerRetries=sNTPServerRetries, sNTPPrimaryServer=sNTPPrimaryServer, secureModeAlarm=secureModeAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTableIndex=dfsTableIndex, bridge=bridge, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelACableLength=channelACableLength, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBCableLength=channelBCableLength, userTableNumber=userTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityTable=l2CPPriorityTable, management=management, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerInternetAddress=tFTPServerInternetAddress, rangingMode=rangingMode, syslogClient=syslogClient, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPEmailAlert=sMTPEmailAlert, snmpControl=snmpControl, tFTPServerInternetAddressType=tFTPServerInternetAddressType, timeZone=timeZone, dfsTable=dfsTable, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, dataPortStatus=dataPortStatus, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userRole=userRole, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitDataRate=transmitDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitModulationMode=transmitModulationMode, remoteInternetAddress=remoteInternetAddress, notificationsGroup=notificationsGroup, receivePower=receivePower, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productVariant=productVariant, frequencyVariant=frequencyVariant, resetGroup=resetGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, hardwareVersion=hardwareVersion, channelBLoopback=channelBLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, byteErrorRatio=byteErrorRatio, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableNumber=dfsTableNumber, channelBLineCode=channelBLineCode, dataPortDisabledWarning=dataPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteInternetAddressType=remoteInternetAddressType, tDDControlGroup=tDDControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerTableEntry=sNTPServerTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitChannel=transmitChannel, secureModeAlarmTrap=secureModeAlarmTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, targetRange=targetRange, channelALineCode=channelALineCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cambium=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, dataPortFiberStatus=dataPortFiberStatus, sNTPServerTimeout=sNTPServerTimeout, userEnabled=userEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, reset=reset, installArmStateTrap=installArmStateTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, longitude=longitude, phyControlGroup=phyControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, antennaGain=antennaGain, userTable=userTable, telecomsInterface=telecomsInterface, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteIPAddress=remoteIPAddress, accessMethod=accessMethod, txColorCode=txColorCode, transmitFreqKHz=transmitFreqKHz, dfs=dfs, daylightSaving=daylightSaving, licence=licence, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, channelALoopbackTrap=channelALoopbackTrap, productName=productName, bridgeGroup=bridgeGroup, rxColorCode=rxColorCode, ptpCompliance=ptpCompliance, telecomsChannelAStatus=telecomsChannelAStatus, linkName=linkName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, sNMPPortNumber=sNMPPortNumber, iPv6Address=iPv6Address, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, remoteRxTargetPower=remoteRxTargetPower, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, bandwidthVariant=bandwidthVariant, sNTPServerTable=sNTPServerTable, receiveModulationMode=receiveModulationMode, regionCode=regionCode, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, wirelessLinkStatus=wirelessLinkStatus, securityLevel=securityLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, latitude=latitude, managementMode=managementMode, sNTPServerTableNumber=sNTPServerTableNumber, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, telecom=telecom)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, licenceGroup=licenceGroup, iPv4Address=iPv4Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, eIRP=eIRP, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, siteName=siteName, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, syslogStateTrap=syslogStateTrap, altitude=altitude, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControl=tDDControl, channelALoopback=channelALoopback, ethernetBridgingStatus=ethernetBridgingStatus, groupID=groupID, installStatus=installStatus, encryptionGroup=encryptionGroup, managementPortStatus=managementPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, dfsGroup=dfsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, systemReset=systemReset, ptp600=ptp600, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementGroup=managementGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configurationGroup=configurationGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPSync=sNTPSync, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, vectorError=vectorError)
