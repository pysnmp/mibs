...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:34:34 2021
...
enterprises, iso, ModuleIdentity, Counter32, ObjectIdentity, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Bits, TimeTicks, MibIdentifier, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Bits", "TimeTicks", "MibIdentifier", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPCommunityString=sNMPCommunityString, ptpCompliance=ptpCompliance, telecomsInterface=telecomsInterface, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptmp=ptmp, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, ptp=ptp, systemClock=systemClock, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secureModeAlarm=secureModeAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, accessMethod=accessMethod, dfsTable=dfsTable, dataPortStatus=dataPortStatus, sNTPServerTable=sNTPServerTable, ptp600=ptp600, syslogClient=syslogClient, iPDSCPPriorityTable=iPDSCPPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, subnetMask=subnetMask, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, configuration=configuration, receiveModulationMode=receiveModulationMode, systemReset=systemReset, sntp=sntp, targetMACAddress=targetMACAddress, remoteInternetAddress=remoteInternetAddress, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, phyControlGroup=phyControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControlGroup=snmpControlGroup, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, snmpControl=snmpControl, userTableIndex=userTableIndex, dfsTableNumber=dfsTableNumber, channelALineCode=channelALineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSync=sNTPSync, productVariant=productVariant, channelBandwidth=channelBandwidth, linkName=linkName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rangingMode=rangingMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userPassword=userPassword, sNTPServerPortNumber=sNTPServerPortNumber, phyStatusGroup=phyStatusGroup, telecomsChannelAStatus=telecomsChannelAStatus, dfs=dfs, management=management, range=range, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimisation=linkModeOptimisation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, secondarySoftwareVersion=secondarySoftwareVersion, qOSPriorityScheme=qOSPriorityScheme, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementMode=managementMode, l2CPPriorityTable=l2CPPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDControlGroup=tDDControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, siteName=siteName, iPv6Address=iPv6Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, transmitPower=transmitPower, searchState=searchState, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, altitude=altitude, syslogClientTrap=syslogClientTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, receivePower=receivePower, secureModeAlarmTrap=secureModeAlarmTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, masterSlaveMode=masterSlaveMode, pubStatsGroup=pubStatsGroup, dfsMeans=dfsMeans, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomGroup=telecomGroup, iPv4Address=iPv4Address, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, txColorCode=txColorCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveFreqMHz=receiveFreqMHz, sNTPServerTableNumber=sNTPServerTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, supplementary=supplementary, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortStatus=managementPortStatus, syslogState=syslogState, regionCodeTrap=regionCodeTrap, installStatus=installStatus, licence=licence, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bandwidthVariant=bandwidthVariant, ethernetBridgingStatus=ethernetBridgingStatus, phyControl=phyControl, syslogControlGroup=syslogControlGroup, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteIPAddress=remoteIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationMode=tDDSynchronizationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogStateTrap=syslogStateTrap, userEnabled=userEnabled, telnetAccessEnabled=telnetAccessEnabled, hardwareVersion=hardwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, incompatibleRegionCodes=incompatibleRegionCodes, userTableEntry=userTableEntry, telnetPortNumber=telnetPortNumber, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, rawReceivePower=rawReceivePower, userTable=userTable, rxColorCode=rxColorCode, unitOutOfCalibration=unitOutOfCalibration, softwareVersion=softwareVersion, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelSelection=telecomsChannelSelection, cambium=cambium, channelALoopback=channelALoopback, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveChannel=receiveChannel, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, eIRP=eIRP, sNMPv3Enable=sNMPv3Enable, aAAControlGroup=aAAControlGroup, configurationGroup=configurationGroup, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, managementPortDisabledWarning=managementPortDisabledWarning, userTableNumber=userTableNumber, userName=userName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versionsGroup=versionsGroup, supplementaryGroup=supplementaryGroup, channelBLoopback=channelBLoopback, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerRetries=sNTPServerRetries, channelBLoopbackTrap=channelBLoopbackTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelALoopbackTrap=channelALoopbackTrap, targetRange=targetRange, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortAutoNegotiation=dataPortAutoNegotiation, iPv6PrefixLength=iPv6PrefixLength, sMTPServerInternetAddress=sMTPServerInternetAddress, versions=versions, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecom=telecom, channelBLineCode=channelBLineCode, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableIndex=dfsTableIndex, sNMPPortNumber=sNMPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus, bridge=bridge, ethernetGroup=ethernetGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, dataPortFiberStatusTrap=dataPortFiberStatusTrap, latitude=latitude, sMTPServerIPAddress=sMTPServerIPAddress, installStatusTrap=installStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vLANManagementVID=vLANManagementVID, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, installArmStateTrap=installArmStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, resetGroup=resetGroup, syslogControl=syslogControl, alarmsGroup=alarmsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPVersion=iPVersion, dfsGroup=dfsGroup, automaticTxPowerControl=automaticTxPowerControl, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, timeZone=timeZone, managementGroup=managementGroup, reset=reset, installArmState=installArmState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, alarms=alarms, frequencyVariant=frequencyVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsPeaks=dfsPeaks, channelBCableLength=channelBCableLength, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, regionCode=regionCode, transmitFreqMHz=transmitFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, securityLevel=securityLevel, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNTPSyncTrap=sNTPSyncTrap, bridgeGroup=bridgeGroup, channelACableLength=channelACableLength, linkSymmetry=linkSymmetry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortStatusTrap=managementPortStatusTrap, gatewayIPAddress=gatewayIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenceGroup=licenceGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDControl=tDDControl, dfsTableEntry=dfsTableEntry)
