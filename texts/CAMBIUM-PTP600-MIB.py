...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", smtp=smtp, sMTPEmailAlert=sMTPEmailAlert, dataPortDisabledWarning=dataPortDisabledWarning, eIRP=eIRP, linkLoss=linkLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomGroup=telecomGroup, dfsTableNumber=dfsTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, gatewayIPAddress=gatewayIPAddress, installStatus=installStatus, sNTPServerTable=sNTPServerTable, vectorError=vectorError, bootVersion=bootVersion, iPv4Address=iPv4Address, ptpGroups=ptpGroups, channelACableLength=channelACableLength, sNTPPrimaryServer=sNTPPrimaryServer, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, phyStatus=phyStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibration=unitOutOfCalibration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, sNTPServerPortNumber=sNTPServerPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatch=linkModeOptimizationMismatch, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, alarms=alarms, tDDControlGroup=tDDControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkName=linkName, longitude=longitude, secondarySoftwareVersion=secondarySoftwareVersion, channelBLoopbackTrap=channelBLoopbackTrap, transmitFreqMHz=transmitFreqMHz, iPv6GatewayAddress=iPv6GatewayAddress, ethernetBridgingStatus=ethernetBridgingStatus, productName=productName, versions=versions, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelSelection=telecomsChannelSelection, dfsPeaks=dfsPeaks, ethernetFiberSupport=ethernetFiberSupport, iPv6Address=iPv6Address, remoteMaximumTransmitPower=remoteMaximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableIndex=dfsTableIndex, installArmState=installArmState, ptp600=ptp600, hardwareVersion=hardwareVersion, sNMPTrapTable=sNMPTrapTable, supplementaryGroup=supplementaryGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, ptpTraps=ptpTraps, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsGroup=dfsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, bridge=bridge, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortStatusTrap=managementPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, licence=licence, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableIndex=ethernetPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, range=range, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTable=ethernetPriorityTable, channelChangeTrap=channelChangeTrap, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, rangingMode=rangingMode, systemReset=systemReset, sNTPState=sNTPState, receiveModulationModeDetail=receiveModulationModeDetail, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptmp=ptmp, sNTPServerRetries=sNTPServerRetries, userName=userName, aAAControlGroup=aAAControlGroup, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userPassword=userPassword, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControl=tDDControl, sNMPTrapTableNumber=sNMPTrapTableNumber, frequencyVariant=frequencyVariant, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, supplementary=supplementary, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsTableEntry=dfsTableEntry, ptpCompliance=ptpCompliance, transmitFreqKHz=transmitFreqKHz, ethernetGroup=ethernetGroup, managementMode=managementMode, userEnabled=userEnabled, softwareVersion=softwareVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfs=dfs, dataPortFiberStatus=dataPortFiberStatus, cableLoss=cableLoss, syslogState=syslogState, encryptionGroup=encryptionGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, signalStrengthRatio=signalStrengthRatio, automaticTxPowerControl=automaticTxPowerControl, dataPortAutoMdix=dataPortAutoMdix, ptpTrapPrefix=ptpTrapPrefix, aAAControl=aAAControl, sntpGroup=sntpGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVID=vLANManagementVID, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernet=ethernet, masterSlaveMode=masterSlaveMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBLineCode=channelBLineCode, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopbackTrap=channelALoopbackTrap, antennaGain=antennaGain, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, syslogControlGroup=syslogControlGroup, channelALoopback=channelALoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryption=encryption, subnetMask=subnetMask, bridgeGroup=bridgeGroup, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, remoteRxTargetPower=remoteRxTargetPower, phyControl=phyControl, receivePower=receivePower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sntp=sntp, snmpControl=snmpControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secureModeAlarmTrap=secureModeAlarmTrap, productVariant=productVariant, targetRange=targetRange, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, sNTPSyncTrap=sNTPSyncTrap, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, transmitChannel=transmitChannel, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteIPAddress=remoteIPAddress, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, hAZLOCConfiguration=hAZLOCConfiguration, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, transmitPower=transmitPower, sNTPLastSync=sNTPLastSync, txColorCode=txColorCode, tDDSynchronizationStatus=tDDSynchronizationStatus, secureModeAlarm=secureModeAlarm, phyControlGroup=phyControlGroup, PYSNMP_MODULE_ID=cambium, iPv6PrefixLength=iPv6PrefixLength, smtpGroup=smtpGroup, userTableNumber=userTableNumber, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelBStatus=telecomsChannelBStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemClock=systemClock, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, accessMethod=accessMethod, cambium=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, searchState=searchState, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationMode=tDDSynchronizationMode, dfsMeans=dfsMeans, channelALineCode=channelALineCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bandwidthVariant=bandwidthVariant, configuration=configuration, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortStatus=managementPortStatus, qOSPriorityScheme=qOSPriorityScheme, regionCodeTrap=regionCodeTrap, groupID=groupID)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortStatus=dataPortStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteInternetAddress=remoteInternetAddress, telnetPortNumber=telnetPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, securityLevel=securityLevel, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rawReceivePower=rawReceivePower, sNMPv3Enable=sNMPv3Enable, licenceGroup=licenceGroup, installStatusTrap=installStatusTrap, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, syslogControl=syslogControl, channelBCableLength=channelBCableLength, channelBLoopback=channelBLoopback, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, syslogClient=syslogClient, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, userTable=userTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, altitude=altitude, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, rxColorCode=rxColorCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, iPVersion=iPVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkModeOptimisation=linkModeOptimisation)
