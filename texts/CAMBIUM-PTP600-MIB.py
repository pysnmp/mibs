...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBLineCode=channelBLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, userName=userName, dataPortFiberStatus=dataPortFiberStatus, sMTPEnabledMessages=sMTPEnabledMessages, targetRange=targetRange, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControlGroup=syslogControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationMode=receiveModulationMode, eIRP=eIRP, groupID=groupID, userTableEntry=userTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, bridgeGroup=bridgeGroup, secureModeAlarm=secureModeAlarm, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, telecomsChannelAStatus=telecomsChannelAStatus, transmitPower=transmitPower, sNTPPrimaryServer=sNTPPrimaryServer, userTableIndex=userTableIndex, longitude=longitude, altitude=altitude, ptpGroups=ptpGroups, managementPortStatusTrap=managementPortStatusTrap, snmpControlGroup=snmpControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoMdix=dataPortAutoMdix, sNTPServerTable=sNTPServerTable, phyControl=phyControl, ethernet=ethernet, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, hAZLOCConfiguration=hAZLOCConfiguration, remoteRxTargetPower=remoteRxTargetPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerStatus=sNTPServerStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogState=syslogState, ethernetBridgingAvailability=ethernetBridgingAvailability, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortWirelessDownAlert=managementPortWirelessDownAlert, smtp=smtp, dfsMeans=dfsMeans, subnetMask=subnetMask, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, dfsTableNumber=dfsTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, maximumTransmitPower=maximumTransmitPower, ptpTraps=ptpTraps, sNTPSync=sNTPSync, encryptionAlgorithm=encryptionAlgorithm, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, siteName=siteName, txColorCode=txColorCode, accessMethod=accessMethod, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, dfsTableIndex=dfsTableIndex, productName=productName, telecomsInterface=telecomsInterface, iPv6Address=iPv6Address, regionCodeTrap=regionCodeTrap, ethernetBridgingStatus=ethernetBridgingStatus, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqKHz=receiveFreqKHz, iPv6PrefixLength=iPv6PrefixLength, cambium=cambium, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, cableLoss=cableLoss, managementMode=managementMode, channelACableLength=channelACableLength, tDDControl=tDDControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userPassword=userPassword, ptp=ptp, sNTPServerTableEntry=sNTPServerTableEntry, signalStrengthRatio=signalStrengthRatio, management=management, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installStatus=installStatus, regionCode=regionCode, range=range, aAAControl=aAAControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rangingMode=rangingMode, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, licence=licence, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, supplementary=supplementary, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, frequencyVariant=frequencyVariant, hardwareVersion=hardwareVersion, dSCPManagementPriority=dSCPManagementPriority, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemClock=systemClock, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecom=telecom, sNTPServerPortNumber=sNTPServerPortNumber, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogClientTrap=syslogClientTrap, alarmsGroup=alarmsGroup, encryption=encryption, localPacketFiltering=localPacketFiltering, iPv4Address=iPv4Address, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, bridge=bridge, automaticTxPowerControl=automaticTxPowerControl, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, sNTPServerIPAddress=sNTPServerIPAddress, linkLoss=linkLoss, ethernetPriorityTable=ethernetPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, ptmp=ptmp, versions=versions, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, searchState=searchState, linkName=linkName, channelBCableLength=channelBCableLength, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityTable=mPLSTCPriorityTable, timeZone=timeZone, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productVariant=productVariant, securityLevel=securityLevel, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddressType=remoteInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelChangeTrap=channelChangeTrap, syslogClient=syslogClient, userTable=userTable, userEnabled=userEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, managementPortStatus=managementPortStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, linkModeOptimisation=linkModeOptimisation, channelALoopbackTrap=channelALoopbackTrap, iPVersion=iPVersion, ptp600=ptp600, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, sntp=sntp, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, telecomGroup=telecomGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, managementPortConfigurationMismatch=managementPortConfigurationMismatch, channelBLoopback=channelBLoopback, secureModeAlarmTrap=secureModeAlarmTrap, versionsGroup=versionsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsPeaks=dfsPeaks, receiveModulationModeDetail=receiveModulationModeDetail, dfsTable=dfsTable, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, configurationGroup=configurationGroup, userRole=userRole, phyControlGroup=phyControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, bootVersion=bootVersion, syslogControl=syslogControl, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, supplementaryGroup=supplementaryGroup, channelBLoopbackTrap=channelBLoopbackTrap, rxColorCode=rxColorCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelALoopback=channelALoopback, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, vectorError=vectorError, systemReset=systemReset, telecomsChannelBStatus=telecomsChannelBStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPState=sNTPState, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rawReceivePower=rawReceivePower, ptpTrapPrefix=ptpTrapPrefix, byteErrorRatio=byteErrorRatio, transmitFreqKHz=transmitFreqKHz, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, remoteMaximumTransmitPower=remoteMaximumTransmitPower, qOSPriorityScheme=qOSPriorityScheme, channelALineCode=channelALineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPv3Enable=sNMPv3Enable, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsGroup=dfsGroup, sNTPServerRetries=sNTPServerRetries, installStatusTrap=installStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, tDDControlGroup=tDDControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelSelection=telecomsChannelSelection, smtpGroup=smtpGroup, dfs=dfs, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState)
