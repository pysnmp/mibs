...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTableIndex=l2CPPriorityTableIndex, accessMethod=accessMethod, sNTPLastSync=sNTPLastSync, searchState=searchState, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, securityLevel=securityLevel, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, syslogStateTrap=syslogStateTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, channelACableLength=channelACableLength, dfsTableNumber=dfsTableNumber, ptpGroups=ptpGroups, management=management, syslogClientTrap=syslogClientTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, longitude=longitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, aAAControlGroup=aAAControlGroup, managementPortStatus=managementPortStatus, sNTPSync=sNTPSync, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBLoopback=channelBLoopback, sNTPServerTableIndex=sNTPServerTableIndex, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bandwidthVariant=bandwidthVariant, alarmsGroup=alarmsGroup, localPacketFiltering=localPacketFiltering, syslogClient=syslogClient, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyStatus=phyStatus, telecom=telecom, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, dfsPeaks=dfsPeaks, linkSymmetry=linkSymmetry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, PYSNMP_MODULE_ID=cambium, sNTPPollInterval=sNTPPollInterval, altitude=altitude, dataPortFiberStatus=dataPortFiberStatus, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableIndex=dfsTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userPassword=userPassword, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, iPDSCPPriorityTable=iPDSCPPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTable=sNTPServerTable, remoteInternetAddress=remoteInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerTimeout=sNTPServerTimeout, installStatusTrap=installStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, daylightSaving=daylightSaving, pubStats=pubStats, telecomsChannelSelection=telecomsChannelSelection, remoteRxTargetPower=remoteRxTargetPower, linkName=linkName, tDDControl=tDDControl, subnetMask=subnetMask, managementPortStatusTrap=managementPortStatusTrap, managementGroup=managementGroup, smtpGroup=smtpGroup, supplementaryGroup=supplementaryGroup, masterSlaveMode=masterSlaveMode, phyControlGroup=phyControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, rangingMode=rangingMode, automaticTxPowerControl=automaticTxPowerControl, iPv4Address=iPv4Address, ethernetBridgingStatus=ethernetBridgingStatus, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, versions=versions, dfsTableEntry=dfsTableEntry, antennaGain=antennaGain, channelBLineCode=channelBLineCode, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, installArmState=installArmState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rawReceivePower=rawReceivePower, regionCode=regionCode, aAAControl=aAAControl, smtp=smtp, userTableEntry=userTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveDataRate=receiveDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptp=ptp, linkLoss=linkLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configuration=configuration, dataPortAutoMdix=dataPortAutoMdix, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, eIRP=eIRP, userTableIndex=userTableIndex, channelALoopbackTrap=channelALoopbackTrap, sNTPSyncTrap=sNTPSyncTrap, hTTPPortNumber=hTTPPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp600=ptp600, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerStatus=sNTPServerStatus, range=range, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, softwareVersion=softwareVersion, telecomsInterface=telecomsInterface, receiveChannel=receiveChannel, managementMode=managementMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, configurationGroup=configurationGroup, transmitPower=transmitPower, hAZLOCConfiguration=hAZLOCConfiguration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, rxColorCode=rxColorCode, phyControl=phyControl, sNMPEnabledTraps=sNMPEnabledTraps, userName=userName, targetMACAddress=targetMACAddress, ethernet=ethernet, sNTPServerRetries=sNTPServerRetries, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, channelBCableLength=channelBCableLength, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, transmitDataRate=transmitDataRate, channelChangeTrap=channelChangeTrap, regionCodeTrap=regionCodeTrap, ptmp=ptmp, vLANManagementPriority=vLANManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, dfsGroup=dfsGroup, ethernetPriorityTable=ethernetPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatus=telecomsChannelBStatus, secureModeAlarmTrap=secureModeAlarmTrap, bridgeGroup=bridgeGroup, channelALoopback=channelALoopback, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapVersion=sNMPTrapVersion, userTable=userTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, encryptionGroup=encryptionGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, versionsGroup=versionsGroup, installArmStateTrap=installArmStateTrap, receivePower=receivePower, dfs=dfs, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, syslogState=syslogState, channelBLoopbackTrap=channelBLoopbackTrap, snmpControlGroup=snmpControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntp=sntp, remoteInternetAddressType=remoteInternetAddressType, channelALineCode=channelALineCode, phyStatusGroup=phyStatusGroup, pubStatsGroup=pubStatsGroup, targetRange=targetRange, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, syslogControl=syslogControl, ptpCompliance=ptpCompliance, groupID=groupID, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bridge=bridge, dfsMeans=dfsMeans, iPVersion=iPVersion, siteName=siteName, txColorCode=txColorCode, encryptionAlgorithm=encryptionAlgorithm, sNMPCommunityString=sNMPCommunityString, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTable=sNMPTrapTable, sNMPv3Enable=sNMPv3Enable, iPv6Address=iPv6Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, userEnabled=userEnabled, resetGroup=resetGroup, aggregateDataRate=aggregateDataRate, tFTPServerInternetAddress=tFTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", qOSPriorityScheme=qOSPriorityScheme, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpTraps=ptpTraps, userTableNumber=userTableNumber, telecomGroup=telecomGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTable=dfsTable, receiveFreqKHz=receiveFreqKHz, sMTPServerInternetAddress=sMTPServerInternetAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControl=snmpControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, latitude=latitude, productVariant=productVariant, cambium=cambium, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarms=alarms, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitChannel=transmitChannel, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, reset=reset, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, sNTPPrimaryServer=sNTPPrimaryServer, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortStatus=dataPortStatus, secureModeAlarm=secureModeAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber)
