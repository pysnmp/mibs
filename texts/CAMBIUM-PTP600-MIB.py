...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableEntry=userTableEntry, management=management, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerIPAddress=sMTPServerIPAddress, tDDControl=tDDControl, dataPortAutoNegotiation=dataPortAutoNegotiation, productVariant=productVariant, linkName=linkName, rxColorCode=rxColorCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortStatusTrap=managementPortStatusTrap, masterSlaveMode=masterSlaveMode, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPServerPortNumber=tFTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, userRole=userRole, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveFreqKHz=receiveFreqKHz, channelACableLength=channelACableLength, ptpTrapPrefix=ptpTrapPrefix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitFreqMHz=transmitFreqMHz, ptp600=ptp600, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, dfsGroup=dfsGroup, qOSPriorityScheme=qOSPriorityScheme, transmitPower=transmitPower, licenceGroup=licenceGroup, hTTPPortNumber=hTTPPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bootVersion=bootVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hAZLOCConfiguration=hAZLOCConfiguration, managementMode=managementMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installStatus=installStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControlGroup=tDDControlGroup, syslogClientTrap=syslogClientTrap, bridgeGroup=bridgeGroup, searchState=searchState, telecomsInterface=telecomsInterface, installStatusTrap=installStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogStateTrap=syslogStateTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetGroup=ethernetGroup, dSCPManagementPriority=dSCPManagementPriority, resetGroup=resetGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, ptp=ptp, ptmp=ptmp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPSync=sNTPSync, productName=productName, userName=userName, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, latitude=latitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteInternetAddress=remoteInternetAddress, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, rawReceivePower=rawReceivePower, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelAStatus=telecomsChannelAStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, automaticTxPowerControl=automaticTxPowerControl, constantPowerSpectralDensity=constantPowerSpectralDensity, longitude=longitude, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEmailAlert=sMTPEmailAlert, receiveChannel=receiveChannel, aAAControl=aAAControl, alarms=alarms, iPv4Address=iPv4Address, groupID=groupID, regionCodeTrap=regionCodeTrap, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, supplementary=supplementary, versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, systemReset=systemReset, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityString=sNMPCommunityString, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, pubStats=pubStats, sNTPLastSync=sNTPLastSync, transmitChannel=transmitChannel, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, l2CPPriorityTable=l2CPPriorityTable, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, targetRange=targetRange, cambium=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, localPacketFiltering=localPacketFiltering, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveModulationModeDetail=receiveModulationModeDetail, secureModeAlarmTrap=secureModeAlarmTrap, aggregateDataRate=aggregateDataRate, rangingMode=rangingMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, accessMethod=accessMethod, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receivePower=receivePower, encryptionAlgorithm=encryptionAlgorithm, syslogState=syslogState, managementPortDisabledWarning=managementPortDisabledWarning, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsMeans=dfsMeans, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, versionsGroup=versionsGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPPortNumber=sNMPPortNumber, dfsTable=dfsTable, sNTPServerTableNumber=sNTPServerTableNumber, bridge=bridge, dataPortFiberStatus=dataPortFiberStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, sNTPServerRetries=sNTPServerRetries, securityLevel=securityLevel, receiveFreqMHz=receiveFreqMHz, channelBLoopback=channelBLoopback, snmpControl=snmpControl, configurationGroup=configurationGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, sNMPTrapTable=sNMPTrapTable, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, channelBCableLength=channelBCableLength, phyStatusGroup=phyStatusGroup, phyControl=phyControl, licence=licence, transmitModulationMode=transmitModulationMode, bandwidthVariant=bandwidthVariant, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, channelALineCode=channelALineCode, channelALoopback=channelALoopback, range=range, ptpGroups=ptpGroups, channelALoopbackTrap=channelALoopbackTrap, installArmStateTrap=installArmStateTrap, telecomsChannelBStatus=telecomsChannelBStatus, channelBandwidth=channelBandwidth, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, userTable=userTable, linkModeOptimisation=linkModeOptimisation, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, vectorError=vectorError, altitude=altitude, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, ethernetBridgingStatus=ethernetBridgingStatus, regionCode=regionCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTimeout=sNTPServerTimeout, encryption=encryption, reset=reset, antennaGain=antennaGain, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, supplementaryGroup=supplementaryGroup, managementGroup=managementGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vLANManagementVID=vLANManagementVID, smtp=smtp, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, phyControlGroup=phyControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, targetMACAddress=targetMACAddress, userEnabled=userEnabled, dataPortStatus=dataPortStatus, dfsTableIndex=dfsTableIndex, aAAControlGroup=aAAControlGroup, sNTPServerTable=sNTPServerTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, systemClock=systemClock, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userTableNumber=userTableNumber, linkSymmetry=linkSymmetry, iPVersion=iPVersion, linkLoss=linkLoss, channelBLoopbackTrap=channelBLoopbackTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpCompliance=ptpCompliance, managementPortStatus=managementPortStatus, wirelessLinkAvailability=wirelessLinkAvailability)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", configuration=configuration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, daylightSaving=daylightSaving, txColorCode=txColorCode, iPv6GatewayAddress=iPv6GatewayAddress, softwareVersion=softwareVersion, sNTPServerStatus=sNTPServerStatus, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClient=syslogClient, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, iPv6PrefixLength=iPv6PrefixLength, ethernet=ethernet, dfs=dfs, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPv6Address=iPv6Address, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableIndex=userTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, cableLoss=cableLoss, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, telecom=telecom, channelBLineCode=channelBLineCode, eIRP=eIRP, timeZone=timeZone, hardwareVersion=hardwareVersion, telecomsChannelSelection=telecomsChannelSelection, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, sNTPServerTableIndex=sNTPServerTableIndex)
