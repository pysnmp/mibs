...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemReset=systemReset, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, frequencyVariant=frequencyVariant, vectorError=vectorError, snmpControl=snmpControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, automaticTxPowerControl=automaticTxPowerControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, productName=productName, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, localPacketFiltering=localPacketFiltering, iPv6PrefixLength=iPv6PrefixLength, userEnabled=userEnabled, bridgeGroup=bridgeGroup, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, licence=licence, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsTableNumber=dfsTableNumber, receiveFreqKHz=receiveFreqKHz, sNMPTrapVersion=sNMPTrapVersion, installStatusTrap=installStatusTrap, iPv6Address=iPv6Address, aAAControlGroup=aAAControlGroup, altitude=altitude, gatewayIPAddress=gatewayIPAddress, eIRP=eIRP, hardwareVersion=hardwareVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, latitude=latitude, sNMPv3Enable=sNMPv3Enable, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, notificationsGroup=notificationsGroup, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteInternetAddress=remoteInternetAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, linkLoss=linkLoss, siteName=siteName, channelALineCode=channelALineCode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rawReceivePower=rawReceivePower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, searchState=searchState, rxColorCode=rxColorCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerRetries=sNTPServerRetries, sNTPServerTableEntry=sNTPServerTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, encryptionGroup=encryptionGroup, managementMode=managementMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCode=regionCode, channelBLoopback=channelBLoopback, smtpGroup=smtpGroup, sntp=sntp, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatus=ethernetBridgingStatus, channelACableLength=channelACableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, alarmsGroup=alarmsGroup, daylightSaving=daylightSaving, userPassword=userPassword, telecomsInterface=telecomsInterface, channelBCableLength=channelBCableLength, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, targetMACAddress=targetMACAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, accessMethod=accessMethod, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, dataPortFiberStatus=dataPortFiberStatus, configuration=configuration, sNTPSyncTrap=sNTPSyncTrap, aggregateDataRate=aggregateDataRate, userRole=userRole, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userTable=userTable, productVariant=productVariant, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, cambium=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installStatus=installStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, secureModeAlarmTrap=secureModeAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsMeans=dfsMeans, timeZone=timeZone, management=management, telecomGroup=telecomGroup, antennaGain=antennaGain, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveChannel=receiveChannel, encryptionAlgorithm=encryptionAlgorithm, iPv4Address=iPv4Address, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, dfsPeaks=dfsPeaks, syslogControlGroup=syslogControlGroup, ptpTrapPrefix=ptpTrapPrefix, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControl=tDDControl, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, vLANManagementVID=vLANManagementVID, securityLevel=securityLevel, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTableNumber=userTableNumber, resetGroup=resetGroup, phyControl=phyControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installArmState=installArmState, bandwidthVariant=bandwidthVariant, sNTPServerTable=sNTPServerTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernet=ethernet, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortDisabledWarning=managementPortDisabledWarning, dfs=dfs, receiveFreqMHz=receiveFreqMHz, dataPortStatus=dataPortStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, range=range, qOSPriorityScheme=qOSPriorityScheme, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableEntry=userTableEntry, longitude=longitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementGroup=managementGroup, linkSymmetry=linkSymmetry, telnetAccessEnabled=telnetAccessEnabled, dfsTableIndex=dfsTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, l2CPPriorityTable=l2CPPriorityTable, telecomsChannelAStatus=telecomsChannelAStatus, syslogState=syslogState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, PYSNMP_MODULE_ID=cambium, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, hAZLOCConfiguration=hAZLOCConfiguration, syslogControl=syslogControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, receiveDataRate=receiveDataRate, secureModeAlarm=secureModeAlarm, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNTPState=sNTPState, sNTPServerStatus=sNTPServerStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, iPVersion=iPVersion, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, dfsGroup=dfsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDControlGroup=tDDControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenceGroup=licenceGroup, targetRange=targetRange, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPLastSync=sNTPLastSync, bridge=bridge, mPLSTCPriorityTable=mPLSTCPriorityTable, txColorCode=txColorCode, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBLineCode=channelBLineCode, managementPortStatus=managementPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelALoopbackTrap=channelALoopbackTrap, supplementary=supplementary, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, supplementaryGroup=supplementaryGroup, telecom=telecom, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableIndex=sNTPServerTableIndex, rangingMode=rangingMode, phyStatus=phyStatus, dataPortAutoMdix=dataPortAutoMdix, receiveModulationModeDetail=receiveModulationModeDetail)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteRxTargetPower=remoteRxTargetPower, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitChannel=transmitChannel, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, aAAControl=aAAControl, phyControlGroup=phyControlGroup, versions=versions, ethernetGroup=ethernetGroup, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkName=linkName, ptmp=ptmp, reset=reset, telecomsChannelBStatus=telecomsChannelBStatus, channelALoopback=channelALoopback, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogStateTrap=syslogStateTrap, ptp=ptp, cableLoss=cableLoss, telecomsChannelSelection=telecomsChannelSelection, ptp600=ptp600, sNTPSync=sNTPSync, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationMode=receiveModulationMode, systemClock=systemClock, userName=userName, sNMPCommunityString=sNMPCommunityString, alarms=alarms, ethernetPriorityTable=ethernetPriorityTable, bootVersion=bootVersion)
