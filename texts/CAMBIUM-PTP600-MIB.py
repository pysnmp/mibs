...
IpAddress, Gauge32, iso, NotificationType, MibIdentifier, enterprises, ModuleIdentity, Counter32, TimeTicks, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "iso", "NotificationType", "MibIdentifier", "enterprises", "ModuleIdentity", "Counter32", "TimeTicks", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyControl=phyControl, aAAControl=aAAControl, phyControlGroup=phyControlGroup, userName=userName, userEnabled=userEnabled, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, sntp=sntp, telecom=telecom, PYSNMP_MODULE_ID=cambium, smtp=smtp, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, installArmState=installArmState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelACableLength=channelACableLength, ethernet=ethernet, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelALoopback=channelALoopback, transmitChannel=transmitChannel, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPPortNumber=sNMPPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, regionCodeTrap=regionCodeTrap, pubStats=pubStats, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, ptpTraps=ptpTraps, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, dfsTableIndex=dfsTableIndex, productName=productName, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, ptpGroups=ptpGroups, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddress=remoteInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, dataPortAutoMdix=dataPortAutoMdix, tDDControl=tDDControl, hTTPSPortNumber=hTTPSPortNumber, linkName=linkName, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBCableLength=channelBCableLength, softwareVersion=softwareVersion, dfsPeaks=dfsPeaks, channelBandwidth=channelBandwidth, receiveChannel=receiveChannel, alarms=alarms, ptmp=ptmp, userRole=userRole, dfsTable=dfsTable, managementPortStatus=managementPortStatus, supplementary=supplementary, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, masterSlaveMode=masterSlaveMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, range=range, sNMPCommunityString=sNMPCommunityString, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogControlGroup=syslogControlGroup, bandwidthVariant=bandwidthVariant, systemReset=systemReset, snmpControlGroup=snmpControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPSync=sNTPSync, ptpCompliance=ptpCompliance, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secureModeAlarm=secureModeAlarm, iPVersion=iPVersion, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableIndex=sNTPServerTableIndex, securityLevel=securityLevel, receiveFreqMHz=receiveFreqMHz, daylightSaving=daylightSaving, localPacketFiltering=localPacketFiltering, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelALineCode=channelALineCode, sNTPState=sNTPState, hAZLOCConfiguration=hAZLOCConfiguration, channelChangeTrap=channelChangeTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bridge=bridge, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6GatewayAddress=iPv6GatewayAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, managementGroup=managementGroup, vLANManagementVID=vLANManagementVID, iPv4Address=iPv4Address, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationMode=receiveModulationMode, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControl=snmpControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, altitude=altitude, cambium=cambium, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, groupID=groupID, eIRP=eIRP, siteName=siteName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, alarmsGroup=alarmsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, installStatusTrap=installStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, userTable=userTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productVariant=productVariant, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkSymmetry=linkSymmetry, iPv6Address=iPv6Address, aAAControlGroup=aAAControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsInterface=telecomsInterface, supplementaryGroup=supplementaryGroup, ethernetPriorityTable=ethernetPriorityTable, accessMethod=accessMethod, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogClient=syslogClient, l2CPPriorityTableIndex=l2CPPriorityTableIndex, subnetMask=subnetMask, rxColorCode=rxColorCode, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, versions=versions, smtpGroup=smtpGroup, installStatus=installStatus, automaticTxPowerControl=automaticTxPowerControl, receivePower=receivePower, bootVersion=bootVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, syslogControl=syslogControl, configuration=configuration, telecomsChannelAStatus=telecomsChannelAStatus, remoteRxTargetPower=remoteRxTargetPower, byteErrorRatio=byteErrorRatio, dfsTableNumber=dfsTableNumber, linkLoss=linkLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBLineCode=channelBLineCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortStatus=dataPortStatus, channelBLoopbackTrap=channelBLoopbackTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, ptp600=ptp600, phyStatus=phyStatus, antennaGain=antennaGain, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, rangingMode=rangingMode, managementPortStatusTrap=managementPortStatusTrap, managementMode=managementMode, sNTPLastSync=sNTPLastSync, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomGroup=telecomGroup, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelSelection=telecomsChannelSelection, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationStatus=tDDSynchronizationStatus, searchState=searchState, sNTPServerTableEntry=sNTPServerTableEntry, management=management, userPassword=userPassword, licenceGroup=licenceGroup, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, constantPowerSpectralDensity=constantPowerSpectralDensity, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelALoopbackTrap=channelALoopbackTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, resetGroup=resetGroup, sNTPPrimaryServer=sNTPPrimaryServer, dfsMeans=dfsMeans)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatus=ethernetBridgingStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntpGroup=sntpGroup, remoteInternetAddressType=remoteInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetRange=targetRange, systemClock=systemClock, dfsGroup=dfsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPv3Enable=sNMPv3Enable, secondarySoftwareVersion=secondarySoftwareVersion, userTableEntry=userTableEntry, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, iPv6PrefixLength=iPv6PrefixLength, sNTPServerRetries=sNTPServerRetries, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerStatus=sNTPServerStatus, latitude=latitude, rawReceivePower=rawReceivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogStateTrap=syslogStateTrap, dfs=dfs, telecomsChannelBStatus=telecomsChannelBStatus, channelBLoopback=channelBLoopback, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPPortNumber=hTTPPortNumber, l2CPPriorityTable=l2CPPriorityTable, dataPortFiberStatus=dataPortFiberStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, txColorCode=txColorCode, vLANManagementPriority=vLANManagementPriority, aggregateDataRate=aggregateDataRate, sNTPServerIPAddress=sNTPServerIPAddress)
