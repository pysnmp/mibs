...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userEnabled=userEnabled, iPv6PrefixLength=iPv6PrefixLength, configuration=configuration, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementaryGroup=supplementaryGroup, linkName=linkName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, managementMode=managementMode, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPv3Enable=sNMPv3Enable, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServer=sNTPPrimaryServer, targetMACAddress=targetMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelAStatus=telecomsChannelAStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatus=wirelessLinkStatus, latitude=latitude, receiveDataRate=receiveDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, userTable=userTable, siteName=siteName, iPDSCPPriorityTable=iPDSCPPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingStatus=ethernetBridgingStatus, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, sNTPServerTableIndex=sNTPServerTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, licence=licence, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, cableLoss=cableLoss, rawReceivePower=rawReceivePower, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, managementPortStatus=managementPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sntp=sntp, range=range, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, vectorError=vectorError, l2CPPriorityTable=l2CPPriorityTable, hardwareVersion=hardwareVersion, ethernetPriorityTable=ethernetPriorityTable, installArmState=installArmState, transmitChannel=transmitChannel, sNMPPortNumber=sNMPPortNumber, daylightSaving=daylightSaving, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsInterface=telecomsInterface, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBLineCode=channelBLineCode, snmpControlGroup=snmpControlGroup, eIRP=eIRP, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, byteErrorRatio=byteErrorRatio, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortStatus=dataPortStatus, sNTPServerTable=sNTPServerTable, managementPortDisabledWarning=managementPortDisabledWarning, tDDControlGroup=tDDControlGroup, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, automaticTxPowerControl=automaticTxPowerControl, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatus=telecomsChannelBStatus, signalStrengthRatio=signalStrengthRatio, sNTPLastSync=sNTPLastSync, timeZone=timeZone, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, syslogState=syslogState, ptpTraps=ptpTraps, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, rangingMode=rangingMode, supplementary=supplementary, sNMPTrapInternetAddress=sNMPTrapInternetAddress, securityLevel=securityLevel, notificationsGroup=notificationsGroup, dSCPManagementPriority=dSCPManagementPriority, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, regionCodeTrap=regionCodeTrap, syslogControl=syslogControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, sNTPServerPortNumber=sNTPServerPortNumber, alarmsGroup=alarmsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, targetRange=targetRange, telecomGroup=telecomGroup, managementGroup=managementGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, smtp=smtp, encryption=encryption, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelALineCode=channelALineCode, iPv4Address=iPv4Address, transmitModulationMode=transmitModulationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, groupID=groupID, receiveChannel=receiveChannel, phyControlGroup=phyControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productVariant=productVariant, aAAControlGroup=aAAControlGroup, dfsTableIndex=dfsTableIndex, txColorCode=txColorCode, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, phyControl=phyControl, versionsGroup=versionsGroup, bootVersion=bootVersion, userRole=userRole, altitude=altitude, ethernetGroup=ethernetGroup, remoteInternetAddressType=remoteInternetAddressType, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, qOSPriorityScheme=qOSPriorityScheme, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelBandwidth=channelBandwidth, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, remoteInternetAddress=remoteInternetAddress, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, channelChangeTrap=channelChangeTrap, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp=ptp, dfsGroup=dfsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpGroups=ptpGroups, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsPeaks=dfsPeaks, ptmp=ptmp, dfs=dfs, receiveFreqKHz=receiveFreqKHz, dataPortStatusTrap=dataPortStatusTrap, userTableNumber=userTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, managementPortStatusTrap=managementPortStatusTrap, installStatusTrap=installStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortAutoMdix=dataPortAutoMdix, transmitFreqKHz=transmitFreqKHz, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, systemReset=systemReset, aAAControl=aAAControl, licenceGroup=licenceGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, channelBCableLength=channelBCableLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, alarms=alarms, smtpGroup=smtpGroup, userTableEntry=userTableEntry, installStatus=installStatus, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, management=management, iPv6Address=iPv6Address, snmpControl=snmpControl, telecom=telecom, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelALoopbackTrap=channelALoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, iPVersion=iPVersion, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryptionAlgorithm=encryptionAlgorithm)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bridgeGroup=bridgeGroup, localPacketFiltering=localPacketFiltering, receiveModulationMode=receiveModulationMode, userName=userName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpCompliance=ptpCompliance, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, sNTPServerRetries=sNTPServerRetries, cambium=cambium, channelALoopback=channelALoopback, sNTPSync=sNTPSync, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerTimeout=sNTPServerTimeout, channelBLoopbackTrap=channelBLoopbackTrap, configurationGroup=configurationGroup, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bridge=bridge, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, ptp600=ptp600, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6GatewayAddress=iPv6GatewayAddress, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, syslogClient=syslogClient, sNTPServerTableEntry=sNTPServerTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aggregateDataRate=aggregateDataRate, channelBLoopback=channelBLoopback, pubStats=pubStats, sNTPServerStatus=sNTPServerStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, channelACableLength=channelACableLength)
