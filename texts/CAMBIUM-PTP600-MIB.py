...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, wirelessLinkAvailability=wirelessLinkAvailability, phyControl=phyControl, dfsMeans=dfsMeans, managementPortStatusTrap=managementPortStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, groupID=groupID, automaticTxPowerControl=automaticTxPowerControl, licence=licence, managementGroup=managementGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridgeGroup=bridgeGroup, channelBLoopback=channelBLoopback, userPassword=userPassword, range=range, telecomGroup=telecomGroup, versionsGroup=versionsGroup, transmitFreqMHz=transmitFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALoopback=channelALoopback, signalStrengthRatio=signalStrengthRatio, managementPortStatus=managementPortStatus, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptp=ptp, sntp=sntp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, bandwidthVariant=bandwidthVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPv3Enable=sNMPv3Enable, dataPortFiberStatusTrap=dataPortFiberStatusTrap, siteName=siteName, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatus=installStatus, qOSPriorityScheme=qOSPriorityScheme, rxColorCode=rxColorCode, userEnabled=userEnabled, iPv6GatewayAddress=iPv6GatewayAddress, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, hAZLOCConfiguration=hAZLOCConfiguration, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, sNTPServerTable=sNTPServerTable, targetMACAddress=targetMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementMode=managementMode, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerRetries=sNTPServerRetries, linkLoss=linkLoss, ptmp=ptmp, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, channelALoopbackTrap=channelALoopbackTrap, cambium=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortAutoMdix=dataPortAutoMdix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfs=dfs, accessMethod=accessMethod, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveFreqKHz=receiveFreqKHz, dataPortAutoNegotiation=dataPortAutoNegotiation, dSCPManagementPriority=dSCPManagementPriority, constantPowerSpectralDensity=constantPowerSpectralDensity, secureModeAlarm=secureModeAlarm, gatewayIPAddress=gatewayIPAddress, tDDControl=tDDControl, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClientTrap=syslogClientTrap, encryptionGroup=encryptionGroup, l2CPPriorityTable=l2CPPriorityTable, remoteIPAddress=remoteIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, hTTPSPortNumber=hTTPSPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, telecom=telecom, phyStatus=phyStatus, remoteInternetAddressType=remoteInternetAddressType, targetRange=targetRange, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPState=sNTPState, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, transmitFreqKHz=transmitFreqKHz, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, sNTPSync=sNTPSync, userTableNumber=userTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, cableLoss=cableLoss, localPacketFiltering=localPacketFiltering, vectorError=vectorError, timeZone=timeZone, encryption=encryption, systemReset=systemReset, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp600=ptp600, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTableNumber=dfsTableNumber, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, bridge=bridge, reset=reset, rangingMode=rangingMode, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableEntry=dfsTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, syslogControl=syslogControl, dataPortFiberStatus=dataPortFiberStatus, dfsPeaks=dfsPeaks, telnetPortNumber=telnetPortNumber, iPv4Address=iPv4Address, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aAAControl=aAAControl, dfsGroup=dfsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, remoteInternetAddress=remoteInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, securityLevel=securityLevel, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, sNTPLastSync=sNTPLastSync, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, txColorCode=txColorCode, management=management, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, sntpGroup=sntpGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, channelBCableLength=channelBCableLength, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, regionCode=regionCode, channelACableLength=channelACableLength, remoteRxTargetPower=remoteRxTargetPower, searchState=searchState, iPVersion=iPVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsTableIndex=dfsTableIndex, smtp=smtp, snmpControl=snmpControl, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, productName=productName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, byteErrorRatio=byteErrorRatio, channelALineCode=channelALineCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, ptpTraps=ptpTraps, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, alarms=alarms, masterSlaveMode=masterSlaveMode, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBLineCode=channelBLineCode, supplementaryGroup=supplementaryGroup, notificationsGroup=notificationsGroup, userRole=userRole, systemClock=systemClock, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, transmitDataRate=transmitDataRate, versions=versions, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePower=receivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClient=syslogClient, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernet=ethernet, configuration=configuration, rawReceivePower=rawReceivePower, linkSymmetry=linkSymmetry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, syslogState=syslogState, latitude=latitude, telecomsChannelBStatus=telecomsChannelBStatus, ethernetBridgingStatus=ethernetBridgingStatus, sNTPSyncTrap=sNTPSyncTrap, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, sNTPPrimaryServer=sNTPPrimaryServer, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, syslogControlGroup=syslogControlGroup, iPv6PrefixLength=iPv6PrefixLength, resetGroup=resetGroup, userTableIndex=userTableIndex, subnetMask=subnetMask, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelSelection=telecomsChannelSelection, channelBLoopbackTrap=channelBLoopbackTrap, softwareVersion=softwareVersion, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, licenceGroup=licenceGroup, longitude=longitude, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6Address=iPv6Address, transmitChannel=transmitChannel)
