...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableNumber=userTableNumber, sNMPPortNumber=sNMPPortNumber, bridge=bridge, configuration=configuration, telecomsChannelAStatus=telecomsChannelAStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteRxTargetPower=remoteRxTargetPower, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, qOSPriorityScheme=qOSPriorityScheme, channelBLoopbackTrap=channelBLoopbackTrap, pubStatsGroup=pubStatsGroup, searchState=searchState, secureModeAlarm=secureModeAlarm, systemReset=systemReset, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, ethernetGroup=ethernetGroup, siteName=siteName, channelBLineCode=channelBLineCode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyStatus=phyStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerStatus=sNTPServerStatus, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, channelBLoopback=channelBLoopback, range=range, receiveModulationMode=receiveModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernet=ethernet, versionsGroup=versionsGroup, telecomGroup=telecomGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortStatus=managementPortStatus, userPassword=userPassword, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelBStatus=telecomsChannelBStatus, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, resetGroup=resetGroup, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, pubStats=pubStats, telecomsInterface=telecomsInterface, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, transmitDataRate=transmitDataRate, userEnabled=userEnabled, management=management, managementPortWirelessDownAlert=managementPortWirelessDownAlert, accessMethod=accessMethod, ptpTraps=ptpTraps, localPacketFiltering=localPacketFiltering, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarmTrap=secureModeAlarmTrap, smtp=smtp, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, aAAControlGroup=aAAControlGroup, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPEmailAlert=sMTPEmailAlert, dfsTable=dfsTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelALoopbackTrap=channelALoopbackTrap, receiveFreqKHz=receiveFreqKHz, ptpCompliance=ptpCompliance, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPLastSync=sNTPLastSync, sNTPServerTimeout=sNTPServerTimeout, iPv4Address=iPv4Address, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatus=dataPortStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secondarySoftwareVersion=secondarySoftwareVersion, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, longitude=longitude, alarmsGroup=alarmsGroup, latitude=latitude, phyControl=phyControl, sNTPSync=sNTPSync, txColorCode=txColorCode, dfsTableIndex=dfsTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, l2CPPriorityTable=l2CPPriorityTable, receivePower=receivePower, transmitFreqMHz=transmitFreqMHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hardwareVersion=hardwareVersion, productName=productName, tDDControl=tDDControl, versions=versions, sNTPServerRetries=sNTPServerRetries, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPState=sNTPState, sMTPServerInternetAddress=sMTPServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, securityLevel=securityLevel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsMeans=dfsMeans, userTableEntry=userTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, reset=reset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, snmpControl=snmpControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dSCPManagementPriority=dSCPManagementPriority, regionCodeTrap=regionCodeTrap, sNTPServerTable=sNTPServerTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, eIRP=eIRP, remoteInternetAddress=remoteInternetAddress, syslogStateTrap=syslogStateTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6Address=iPv6Address, supplementaryGroup=supplementaryGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogControl=syslogControl, receiveDataRate=receiveDataRate, managementGroup=managementGroup, targetRange=targetRange, managementPortStatusTrap=managementPortStatusTrap, sntp=sntp, phyControlGroup=phyControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp600=ptp600, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, transmitFreqKHz=transmitFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, channelALoopback=channelALoopback, wirelessLinkAvailability=wirelessLinkAvailability, installStatusTrap=installStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, channelBCableLength=channelBCableLength, hAZLOCConfiguration=hAZLOCConfiguration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, encryption=encryption, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, groupID=groupID, vLANManagementVID=vLANManagementVID, rangingMode=rangingMode, telecom=telecom, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableIndex=userTableIndex, ptp=ptp, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv6GatewayAddress=iPv6GatewayAddress, regionCode=regionCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, vLANManagementPriority=vLANManagementPriority, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, automaticTxPowerControl=automaticTxPowerControl, rawReceivePower=rawReceivePower, installArmStateTrap=installArmStateTrap, remoteInternetAddressType=remoteInternetAddressType, altitude=altitude, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, syslogClient=syslogClient, installStatus=installStatus, cambium=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, productVariant=productVariant, bridgeGroup=bridgeGroup, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rxColorCode=rxColorCode, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", masterSlaveMode=masterSlaveMode, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, sntpGroup=sntpGroup, transmitChannel=transmitChannel, tDDSynchronizationMode=tDDSynchronizationMode, maximumTransmitPower=maximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTable=ethernetPriorityTable, iPVersion=iPVersion, cableLoss=cableLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementary=supplementary, gatewayIPAddress=gatewayIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, managementMode=managementMode, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableEntry=sNTPServerTableEntry, systemClock=systemClock, aAAControl=aAAControl, dataPortFiberStatus=dataPortFiberStatus, channelALineCode=channelALineCode, dataPortDisabledWarning=dataPortDisabledWarning, syslogState=syslogState, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, transmitPower=transmitPower, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelACableLength=channelACableLength, userTable=userTable, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, userName=userName, dfs=dfs, receiveChannel=receiveChannel, installArmState=installArmState)
