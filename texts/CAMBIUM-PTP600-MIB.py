...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClient=syslogClient, timeZone=timeZone, pubStats=pubStats, smtp=smtp, phyControlGroup=phyControlGroup, receiveChannel=receiveChannel, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, receiveDataRate=receiveDataRate, receiveFreqKHz=receiveFreqKHz, userPassword=userPassword, configuration=configuration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, targetRange=targetRange, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, receiveFreqMHz=receiveFreqMHz, supplementary=supplementary, channelBandwidth=channelBandwidth, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, resetGroup=resetGroup, dfsPeaks=dfsPeaks, reset=reset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelALineCode=channelALineCode, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, smtpGroup=smtpGroup, phyStatus=phyStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, securityLevel=securityLevel, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPLastSync=sNTPLastSync, tDDControl=tDDControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTable=sNTPServerTable, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, masterSlaveMode=masterSlaveMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitPower=transmitPower, sNTPServerTableNumber=sNTPServerTableNumber, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, productName=productName, channelALoopback=channelALoopback, sNMPTrapTableEntry=sNMPTrapTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installArmState=installArmState, sNTPSyncTrap=sNTPSyncTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, dfs=dfs, PYSNMP_MODULE_ID=cambium, ethernetPriorityTable=ethernetPriorityTable, channelALoopbackTrap=channelALoopbackTrap, searchState=searchState, antennaGain=antennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptp=ptp, bandwidthVariant=bandwidthVariant, telecomsChannelAStatus=telecomsChannelAStatus, encryption=encryption, sNTPServerRetries=sNTPServerRetries, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitChannel=transmitChannel, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, vectorError=vectorError, telecomGroup=telecomGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, byteErrorRatio=byteErrorRatio, l2CPPriorityTable=l2CPPriorityTable, tFTPServerInternetAddress=tFTPServerInternetAddress, versionsGroup=versionsGroup, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, linkLoss=linkLoss, remoteInternetAddress=remoteInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitModulationMode=transmitModulationMode, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, alarms=alarms, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, managementPortDisabledWarning=managementPortDisabledWarning, ethernetBridgingStatus=ethernetBridgingStatus, sNTPState=sNTPState, userEnabled=userEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, iPVersion=iPVersion, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, syslogState=syslogState, dfsMeans=dfsMeans, sntpGroup=sntpGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, channelBLoopback=channelBLoopback, localPacketFiltering=localPacketFiltering, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementPriority=vLANManagementPriority, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementMode=managementMode, sNTPServerIPAddress=sNTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelSelection=telecomsChannelSelection, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, hTTPPortNumber=hTTPPortNumber, encryptionAlgorithm=encryptionAlgorithm, sNTPSync=sNTPSync, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationMode=receiveModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, userRole=userRole, remoteIPAddress=remoteIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortStatus=managementPortStatus, rawReceivePower=rawReceivePower, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogControlGroup=syslogControlGroup, gatewayIPAddress=gatewayIPAddress, aAAControl=aAAControl, managementGroup=managementGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, bootVersion=bootVersion, phyControl=phyControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortStatus=dataPortStatus, channelBCableLength=channelBCableLength, sNTPPrimaryServer=sNTPPrimaryServer, management=management, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelACableLength=channelACableLength, linkName=linkName, ethernetGroup=ethernetGroup, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, installArmStateTrap=installArmStateTrap, dfsTableEntry=dfsTableEntry, remoteRxTargetPower=remoteRxTargetPower, iPv4Address=iPv4Address, ptp600=ptp600, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, rangingMode=rangingMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, rxColorCode=rxColorCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, licence=licence, ethernet=ethernet, txColorCode=txColorCode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDDControlGroup=tDDControlGroup, accessMethod=accessMethod, regionCode=regionCode, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableEntry=sNTPServerTableEntry, telecom=telecom, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, sntp=sntp, range=range, daylightSaving=daylightSaving, remoteInternetAddressType=remoteInternetAddressType, systemClock=systemClock, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bridgeGroup=bridgeGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, systemReset=systemReset, cableLoss=cableLoss, incompatibleRegionCodes=incompatibleRegionCodes, dataPortFiberStatus=dataPortFiberStatus, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, notificationsGroup=notificationsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityTable=mPLSTCPriorityTable, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelBLineCode=channelBLineCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, versions=versions, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimisation=linkModeOptimisation, longitude=longitude, latitude=latitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, userName=userName, secureModeAlarm=secureModeAlarm, userTableIndex=userTableIndex, qOSPriorityScheme=qOSPriorityScheme, noWirelessChannelAvailable=noWirelessChannelAvailable, channelChangeTrap=channelChangeTrap, sNTPServerStatus=sNTPServerStatus, dataPortAutoMdix=dataPortAutoMdix, eIRP=eIRP, bridge=bridge, telecomsInterface=telecomsInterface, aggregateDataRate=aggregateDataRate, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerInternetAddress=sNTPServerInternetAddress, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTimeout=sNTPServerTimeout, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, aAAControlGroup=aAAControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, iPv6Address=iPv6Address, sNMPEnabledTraps=sNMPEnabledTraps)
