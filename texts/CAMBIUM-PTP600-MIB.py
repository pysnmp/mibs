...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", range=range, rawReceivePower=rawReceivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userRole=userRole, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetGroup=ethernetGroup, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, signalStrengthRatio=signalStrengthRatio, sNTPServerInternetAddress=sNTPServerInternetAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelChangeTrap=channelChangeTrap, PYSNMP_MODULE_ID=cambium, receiveModulationModeDetail=receiveModulationModeDetail, linkName=linkName, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, channelALineCode=channelALineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitChannel=transmitChannel, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, softwareVersion=softwareVersion, productVariant=productVariant, sntp=sntp, smtp=smtp, sNTPPrimaryServer=sNTPPrimaryServer, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsGroup=dfsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, notificationsGroup=notificationsGroup, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, rangingMode=rangingMode, telecomsInterface=telecomsInterface, telecomGroup=telecomGroup, sNTPSyncTrap=sNTPSyncTrap, installStatus=installStatus, hTTPSPortNumber=hTTPSPortNumber, securityLevel=securityLevel, licence=licence, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerTimeout=sNTPServerTimeout, vLANManagementVID=vLANManagementVID, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, installStatusTrap=installStatusTrap, telecom=telecom, supplementary=supplementary, dfs=dfs, managementMode=managementMode, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, versionsGroup=versionsGroup, managementPortStatus=managementPortStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptpTraps=ptpTraps, iPv4Address=iPv4Address, userPassword=userPassword, managementPortDisabledWarning=managementPortDisabledWarning, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, pubStats=pubStats, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, aAAControl=aAAControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bridge=bridge, channelBLoopbackTrap=channelBLoopbackTrap, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, userTableEntry=userTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitFreqMHz=transmitFreqMHz, channelBCableLength=channelBCableLength, channelBandwidth=channelBandwidth, dfsTable=dfsTable, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerStatus=sNTPServerStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, resetGroup=resetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, dataPortStatus=dataPortStatus, management=management, alarms=alarms, qOSPriorityScheme=qOSPriorityScheme, incompatibleRegionCodes=incompatibleRegionCodes, latitude=latitude, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, channelALoopback=channelALoopback, txColorCode=txColorCode, sNTPServerTableIndex=sNTPServerTableIndex, eIRP=eIRP, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALoopbackTrap=channelALoopbackTrap, receiveFreqKHz=receiveFreqKHz, ptpGroups=ptpGroups, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, channelBLineCode=channelBLineCode, bandwidthVariant=bandwidthVariant, ethernetBridgingAvailability=ethernetBridgingAvailability, encryptionAlgorithm=encryptionAlgorithm, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, telecomsChannelSelection=telecomsChannelSelection, longitude=longitude, automaticTxPowerControl=automaticTxPowerControl, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, altitude=altitude, userEnabled=userEnabled, channelBLoopback=channelBLoopback, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridgeGroup=bridgeGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, installArmState=installArmState, sNTPServerPortNumber=sNTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, configuration=configuration, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, tDDControlGroup=tDDControlGroup, targetMACAddress=targetMACAddress, systemReset=systemReset, secureModeAlarmTrap=secureModeAlarmTrap, userTable=userTable, maximumTransmitPower=maximumTransmitPower, iPVersion=iPVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitDataRate=transmitDataRate, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, remoteRxTargetPower=remoteRxTargetPower, phyControlGroup=phyControlGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, userName=userName, installArmStateTrap=installArmStateTrap, transmitFreqKHz=transmitFreqKHz, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyStatusGroup=phyStatusGroup, iPv6Address=iPv6Address, ptpTrapPrefix=ptpTrapPrefix, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkModeOptimisation=linkModeOptimisation, vectorError=vectorError, ethernet=ethernet, remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtpGroup=smtpGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomsChannelBStatus=telecomsChannelBStatus, receiveChannel=receiveChannel, reset=reset, syslogClient=syslogClient, ptpCompliance=ptpCompliance, ptp=ptp, cambium=cambium, transmitModulationMode=transmitModulationMode, systemClock=systemClock, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, rxColorCode=rxColorCode, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, aggregateDataRate=aggregateDataRate, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hardwareVersion=hardwareVersion, dfsTableNumber=dfsTableNumber, encryptionGroup=encryptionGroup, constantPowerSpectralDensity=constantPowerSpectralDensity)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", alarmsGroup=alarmsGroup, byteErrorRatio=byteErrorRatio, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, daylightSaving=daylightSaving, sNTPServerRetries=sNTPServerRetries, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, siteName=siteName, groupID=groupID, secureModeAlarm=secureModeAlarm, hTTPPortNumber=hTTPPortNumber, channelACableLength=channelACableLength, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, ptmp=ptmp, dfsMeans=dfsMeans, sNTPSync=sNTPSync, snmpControl=snmpControl, l2CPPriorityTable=l2CPPriorityTable, iPv6PrefixLength=iPv6PrefixLength, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyStatus=phyStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp600=ptp600, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteInternetAddressType=remoteInternetAddressType, targetRange=targetRange, licenceGroup=licenceGroup, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, syslogState=syslogState, localPacketFiltering=localPacketFiltering, sNTPServerTable=sNTPServerTable, sNMPCommunityString=sNMPCommunityString, dfsPeaks=dfsPeaks)
