...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecom=telecom, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtp=smtp, transmitFreqMHz=transmitFreqMHz, PYSNMP_MODULE_ID=cambium, ptp=ptp, installArmState=installArmState, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTable=sNTPServerTable, channelBLoopbackTrap=channelBLoopbackTrap, syslogState=syslogState, encryption=encryption, managementPortStatus=managementPortStatus, softwareVersion=softwareVersion, byteErrorRatio=byteErrorRatio, dataPortStatus=dataPortStatus, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, licenceGroup=licenceGroup, ethernetBridgingStatus=ethernetBridgingStatus, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, userName=userName, tDDControl=tDDControl, frequencyVariant=frequencyVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, hTTPSPortNumber=hTTPSPortNumber, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, resetGroup=resetGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, dSCPManagementPriority=dSCPManagementPriority, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, searchState=searchState, sNTPServerTableNumber=sNTPServerTableNumber, channelALineCode=channelALineCode, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, eIRP=eIRP, productName=productName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, daylightSaving=daylightSaving, userTable=userTable, transmitChannel=transmitChannel, managementMode=managementMode, longitude=longitude, tDDSynchronizationMode=tDDSynchronizationMode, phyControl=phyControl, userTableNumber=userTableNumber, bridge=bridge, alarms=alarms, configurationGroup=configurationGroup, regionCode=regionCode, receivePower=receivePower, bridgeGroup=bridgeGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, rangingMode=rangingMode, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, encryptionGroup=encryptionGroup, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, management=management, qOSPriorityScheme=qOSPriorityScheme, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, phyStatus=phyStatus, ptmp=ptmp, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPSync=sNTPSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTableNumber=dfsTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, iPVersion=iPVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, reset=reset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userPassword=userPassword, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableLoss=cableLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomGroup=telecomGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, txColorCode=txColorCode, transmitPower=transmitPower, remoteInternetAddress=remoteInternetAddress, remoteIPAddress=remoteIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, accessMethod=accessMethod, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, remoteRxTargetPower=remoteRxTargetPower, installArmStateTrap=installArmStateTrap, telnetAccessEnabled=telnetAccessEnabled, transmitFreqKHz=transmitFreqKHz, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, altitude=altitude, dfsGroup=dfsGroup, bootVersion=bootVersion, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, bandwidthVariant=bandwidthVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerStatus=sNTPServerStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationMode=receiveModulationMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versionsGroup=versionsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqMHz=receiveFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, snmpControl=snmpControl, hardwareVersion=hardwareVersion, latitude=latitude, smtpGroup=smtpGroup, localPacketFiltering=localPacketFiltering, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, secondarySoftwareVersion=secondarySoftwareVersion, channelBLineCode=channelBLineCode, userTableIndex=userTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, installStatus=installStatus, ptpTraps=ptpTraps, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, encryptionAlgorithm=encryptionAlgorithm, sNTPServerIPAddress=sNTPServerIPAddress, channelBLoopback=channelBLoopback, cambium=cambium, secureModeAlarm=secureModeAlarm, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, systemReset=systemReset, subnetMask=subnetMask, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptp600=ptp600, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, linkSymmetry=linkSymmetry, timeZone=timeZone, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelALoopback=channelALoopback, rxColorCode=rxColorCode, rawReceivePower=rawReceivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsMeans=dfsMeans, groupID=groupID, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, dfsTableIndex=dfsTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapTable=sNMPTrapTable, dfsTable=dfsTable, receiveChannel=receiveChannel, licence=licence, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, iPv6Address=iPv6Address, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteInternetAddressType=remoteInternetAddressType, securityLevel=securityLevel, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsInterface=telecomsInterface, secureModeAlarmTrap=secureModeAlarmTrap, linkLoss=linkLoss, targetRange=targetRange, telecomsChannelSelection=telecomsChannelSelection, managementPortStatusTrap=managementPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, managementGroup=managementGroup, sNTPServerPortNumber=sNTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, hTTPSAccessEnabled=hTTPSAccessEnabled, channelALoopbackTrap=channelALoopbackTrap, userEnabled=userEnabled, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, iPv4Address=iPv4Address, iPv6PrefixLength=iPv6PrefixLength, hAZLOCConfiguration=hAZLOCConfiguration, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBCableLength=channelBCableLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelACableLength=channelACableLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetFiberSupport=ethernetFiberSupport, configuration=configuration, snmpControlGroup=snmpControlGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementary=supplementary, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, sNTPServerTimeout=sNTPServerTimeout, syslogClient=syslogClient, userTableEntry=userTableEntry, telecomsChannelAStatus=telecomsChannelAStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogStateTrap=syslogStateTrap, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup)
