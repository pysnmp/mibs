...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, dfs=dfs, channelALoopbackTrap=channelALoopbackTrap, phyControl=phyControl, telecomsChannelSelection=telecomsChannelSelection, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerRetries=sNTPServerRetries, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetFiberSupport=ethernetFiberSupport, targetMACAddress=targetMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, transmitPower=transmitPower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6Address=iPv6Address, tDDControlGroup=tDDControlGroup, eIRP=eIRP, automaticTxPowerControl=automaticTxPowerControl, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, sntp=sntp, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, productName=productName, bootVersion=bootVersion, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALoopback=channelALoopback, siteName=siteName, sNMPTrapTable=sNMPTrapTable, pubStatsGroup=pubStatsGroup, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntpGroup=sntpGroup, sNTPServerIPAddress=sNTPServerIPAddress, latitude=latitude, channelALineCode=channelALineCode, systemReset=systemReset, bandwidthVariant=bandwidthVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControl=syslogControl, telnetPortNumber=telnetPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, transmitChannel=transmitChannel, receivePower=receivePower, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortFiberStatus=dataPortFiberStatus, channelBLineCode=channelBLineCode, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelChangeTrap=channelChangeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, altitude=altitude, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetRange=targetRange, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, subnetMask=subnetMask, telecomsChannelBStatus=telecomsChannelBStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, managementMode=managementMode, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, securityLevel=securityLevel, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, iPv4Address=iPv4Address, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerTableNumber=sNTPServerTableNumber, byteErrorRatio=byteErrorRatio, syslogState=syslogState, syslogClientTrap=syslogClientTrap, telecomsChannelAStatus=telecomsChannelAStatus, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, ethernet=ethernet, mPLSTCPriorityTable=mPLSTCPriorityTable, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, telecomsInterface=telecomsInterface, qOSPriorityScheme=qOSPriorityScheme, remoteInternetAddress=remoteInternetAddress, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyStatusGroup=phyStatusGroup, dfsTableIndex=dfsTableIndex, channelACableLength=channelACableLength, receiveFreqMHz=receiveFreqMHz, ptp600=ptp600, syslogStateTrap=syslogStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, localPacketFiltering=localPacketFiltering, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, reset=reset, receiveDataRate=receiveDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, aAAControl=aAAControl, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, rawReceivePower=rawReceivePower, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkStatus=wirelessLinkStatus, hAZLOCConfiguration=hAZLOCConfiguration, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerInternetAddressType=sMTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, installArmStateTrap=installArmStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, linkName=linkName, channelBCableLength=channelBCableLength, ethernetBridgingStatus=ethernetBridgingStatus, cambium=cambium, hardwareVersion=hardwareVersion, managementPortStatus=managementPortStatus, dfsGroup=dfsGroup, iPv6PrefixLength=iPv6PrefixLength, ptp=ptp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, sNTPServerTableEntry=sNTPServerTableEntry, frequencyVariant=frequencyVariant, managementGroup=managementGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerInternetAddress=tFTPServerInternetAddress, rxColorCode=rxColorCode, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, sNMPCommunityString=sNMPCommunityString, managementPortDisabledWarning=managementPortDisabledWarning, ptpGroups=ptpGroups, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, licence=licence, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, txColorCode=txColorCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDControl=tDDControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, channelBLoopback=channelBLoopback, ethernetPriorityTableEntry=ethernetPriorityTableEntry, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, secondarySoftwareVersion=secondarySoftwareVersion, telecom=telecom, sNMPTrapTableNumber=sNMPTrapTableNumber, accessMethod=accessMethod, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, dfsTableEntry=dfsTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, enabledDiagnosticAlarms=enabledDiagnosticAlarms, masterSlaveMode=masterSlaveMode, ptmp=ptmp, sNTPPrimaryServer=sNTPPrimaryServer, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, userEnabled=userEnabled, transmitFreqKHz=transmitFreqKHz, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerStatus=sNTPServerStatus, userRole=userRole, dfsMeans=dfsMeans, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, syslogControlGroup=syslogControlGroup, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userName=userName, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTable=userTable, alarms=alarms, longitude=longitude, supplementary=supplementary, ethernetPriorityTableIndex=ethernetPriorityTableIndex, pubStats=pubStats, phyControlGroup=phyControlGroup, phyStatus=phyStatus, versions=versions, encryption=encryption, resetGroup=resetGroup, dSCPManagementPriority=dSCPManagementPriority, rangingMode=rangingMode, vectorError=vectorError, dfsTable=dfsTable, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bridgeGroup=bridgeGroup, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, secureModeAlarm=secureModeAlarm, tFTPServerIPAddress=tFTPServerIPAddress, supplementaryGroup=supplementaryGroup, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPVersion=iPVersion, antennaGain=antennaGain, sNTPServerTable=sNTPServerTable, userTableEntry=userTableEntry, groupID=groupID)
