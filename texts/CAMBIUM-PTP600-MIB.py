...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, antennaGain=antennaGain, transmitFreqMHz=transmitFreqMHz, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsPeaks=dfsPeaks, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, dataPortFiberStatus=dataPortFiberStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveDataRate=receiveDataRate, channelACableLength=channelACableLength, iPVersion=iPVersion, pubStatsGroup=pubStatsGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vectorError=vectorError, versions=versions, versionsGroup=versionsGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, iPv4Address=iPv4Address, sNTPServerTableNumber=sNTPServerTableNumber, productVariant=productVariant, rangingMode=rangingMode, regionCodeTrap=regionCodeTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerPortNumber=sNTPServerPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelALoopback=channelALoopback, bridge=bridge, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, management=management, telecom=telecom, aAAControl=aAAControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelBLineCode=channelBLineCode, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetBridgingAvailability=ethernetBridgingAvailability, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTable=sNTPServerTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementVID=vLANManagementVID, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receivePower=receivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimisation=linkModeOptimisation, txColorCode=txColorCode, aggregateDataRate=aggregateDataRate, rawReceivePower=rawReceivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, phyControl=phyControl, cableLoss=cableLoss, userPassword=userPassword, frequencyVariant=frequencyVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableIndex=sNTPServerTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPPollInterval=sNTPPollInterval, masterSlaveMode=masterSlaveMode, unitOutOfCalibration=unitOutOfCalibration, productName=productName, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetFiberSupport=ethernetFiberSupport, tDDControl=tDDControl, remoteRxTargetPower=remoteRxTargetPower, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, ptpTrapPrefix=ptpTrapPrefix, ptp600=ptp600, ptpCompliance=ptpCompliance, installArmState=installArmState, channelChangeTrap=channelChangeTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, groupID=groupID, searchState=searchState, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkSymmetry=linkSymmetry, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, latitude=latitude, accessMethod=accessMethod, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTable=userTable, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, altitude=altitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, dfs=dfs, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rxColorCode=rxColorCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, targetRange=targetRange, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqKHz=receiveFreqKHz, phyStatus=phyStatus, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingStatus=ethernetBridgingStatus, securityLevel=securityLevel, signalStrengthRatio=signalStrengthRatio, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, sntp=sntp, dfsGroup=dfsGroup, sNTPPrimaryServer=sNTPPrimaryServer, range=range, subnetMask=subnetMask, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, dfsTable=dfsTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, userName=userName, channelALineCode=channelALineCode, syslogStateTrap=syslogStateTrap, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitPower=transmitPower, linkLoss=linkLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementaryGroup=supplementaryGroup, sNTPSyncTrap=sNTPSyncTrap, bootVersion=bootVersion, userRole=userRole, dataPortDisabledWarning=dataPortDisabledWarning, channelBLoopbackTrap=channelBLoopbackTrap, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, channelBCableLength=channelBCableLength, smtp=smtp, receiveFreqMHz=receiveFreqMHz, ptpGroups=ptpGroups, smtpGroup=smtpGroup, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, reset=reset, systemClock=systemClock, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, telecomsChannelSelection=telecomsChannelSelection, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitChannel=transmitChannel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, timeZone=timeZone, telecomGroup=telecomGroup, managementMode=managementMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControl=snmpControl, telecomsChannelBStatus=telecomsChannelBStatus, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteInternetAddress=remoteInternetAddress, hAZLOCConfiguration=hAZLOCConfiguration, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortStatus=managementPortStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortStatus=dataPortStatus, channelALoopbackTrap=channelALoopbackTrap, managementGroup=managementGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, vLANManagementPriority=vLANManagementPriority, ethernetGroup=ethernetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernet=ethernet, sNMPCommunityString=sNMPCommunityString, syslogClient=syslogClient, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLoopback=channelBLoopback, iPv6GatewayAddress=iPv6GatewayAddress, regionCode=regionCode, bridgeGroup=bridgeGroup, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDControlGroup=tDDControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteInternetAddressType=remoteInternetAddressType, hardwareVersion=hardwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, eIRP=eIRP, longitude=longitude, dfsTableNumber=dfsTableNumber, syslogControl=syslogControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, automaticTxPowerControl=automaticTxPowerControl, supplementary=supplementary, telecomsInterface=telecomsInterface)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTimeout=sNTPServerTimeout, syslogControlGroup=syslogControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, alarms=alarms, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, dfsTableIndex=dfsTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPState=sNTPState, byteErrorRatio=byteErrorRatio, dataPortStatusTrap=dataPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dfsMeans=dfsMeans, installStatusTrap=installStatusTrap, sNMPTrapTable=sNMPTrapTable, pubStats=pubStats, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, userTableNumber=userTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, ptp=ptp, alarmsGroup=alarmsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, l2CPPriorityTable=l2CPPriorityTable, iPv6Address=iPv6Address, targetMACAddress=targetMACAddress, dSCPManagementPriority=dSCPManagementPriority, sNMPPortNumber=sNMPPortNumber, userEnabled=userEnabled, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelAStatus=telecomsChannelAStatus, receiveChannel=receiveChannel, licence=licence, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControlGroup=aAAControlGroup)
