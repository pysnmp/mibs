...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerInternetAddress=sNTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, channelALoopbackTrap=channelALoopbackTrap, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, channelBandwidth=channelBandwidth, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsGroup=dfsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelACableLength=channelACableLength, dfsMeans=dfsMeans, syslogStateTrap=syslogStateTrap, linkName=linkName, automaticTxPowerControl=automaticTxPowerControl, pubStatsGroup=pubStatsGroup, userTableEntry=userTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortDisabledWarning=managementPortDisabledWarning, managementPortStatus=managementPortStatus, bandwidthVariant=bandwidthVariant, telecomsChannelSelection=telecomsChannelSelection, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTable=dfsTable, accessMethod=accessMethod, securityLevel=securityLevel, rangingMode=rangingMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, iPv4Address=iPv4Address, encryptionGroup=encryptionGroup, sNTPPollInterval=sNTPPollInterval, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, management=management, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userName=userName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, alarms=alarms, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, smtpGroup=smtpGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerStatus=sNTPServerStatus, ptp=ptp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, managementMode=managementMode, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, userTableNumber=userTableNumber, softwareVersion=softwareVersion, productVariant=productVariant, ethernetBridgingAvailability=ethernetBridgingAvailability, antennaGain=antennaGain, syslogState=syslogState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, byteErrorRatio=byteErrorRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationMode=receiveModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, ethernetGroup=ethernetGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogClient=syslogClient, sNMPTrapVersion=sNMPTrapVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, searchState=searchState, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBCableLength=channelBCableLength, telnetAccessEnabled=telnetAccessEnabled, syslogControlGroup=syslogControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, reset=reset, txColorCode=txColorCode, sNTPServerTableIndex=sNTPServerTableIndex, managementGroup=managementGroup, dataPortFiberStatus=dataPortFiberStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLineCode=channelBLineCode, sNMPCommunityString=sNMPCommunityString, latitude=latitude, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementVID=vLANManagementVID, phyControl=phyControl, encryption=encryption, remoteInternetAddress=remoteInternetAddress, ptpTraps=ptpTraps, telecomsInterface=telecomsInterface, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, configurationGroup=configurationGroup, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, linkSymmetry=linkSymmetry, smtp=smtp, dfsPeaks=dfsPeaks, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptpCompliance=ptpCompliance, notificationsGroup=notificationsGroup, bridgeGroup=bridgeGroup, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, userEnabled=userEnabled, installArmState=installArmState, pubStats=pubStats, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerRetries=sNTPServerRetries, userRole=userRole, ptmp=ptmp, eIRP=eIRP, snmpControlGroup=snmpControlGroup, dfsTableIndex=dfsTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTimeout=sNTPServerTimeout, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTable=iPDSCPPriorityTable, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, constantPowerSpectralDensity=constantPowerSpectralDensity, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlGroup=phyControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, range=range, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatus=dataPortStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, ptpGroups=ptpGroups, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitChannel=transmitChannel, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsChannelAStatus=telecomsChannelAStatus, licence=licence, bootVersion=bootVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, qOSPriorityScheme=qOSPriorityScheme, siteName=siteName, installStatus=installStatus, phyStatusGroup=phyStatusGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, systemClock=systemClock, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControlGroup=aAAControlGroup, aAAControl=aAAControl, linkModeOptimisation=linkModeOptimisation, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rawReceivePower=rawReceivePower, secureModeAlarmTrap=secureModeAlarmTrap, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPAccessEnabled=hTTPAccessEnabled, resetGroup=resetGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControl=syslogControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, telecom=telecom, ptp600=ptp600, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkStatus=wirelessLinkStatus, channelBLoopbackTrap=channelBLoopbackTrap, versionsGroup=versionsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenceGroup=licenceGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, channelALineCode=channelALineCode, receiveFreqKHz=receiveFreqKHz, transmitFreqKHz=transmitFreqKHz, l2CPPriorityTable=l2CPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv6GatewayAddress=iPv6GatewayAddress, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPVersion=iPVersion, longitude=longitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telecomGroup=telecomGroup, channelALoopback=channelALoopback, frequencyVariant=frequencyVariant, dSCPManagementPriority=dSCPManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxColorCode=rxColorCode, remoteRxTargetPower=remoteRxTargetPower, timeZone=timeZone, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, targetRange=targetRange, configuration=configuration, bridge=bridge, l2CPPriorityTableEntry=l2CPPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, channelBLoopback=channelBLoopback, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, iPv6PrefixLength=iPv6PrefixLength, sntp=sntp, sNTPSync=sNTPSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, installStatusTrap=installStatusTrap, ethernet=ethernet, aggregateDataRate=aggregateDataRate, iPv6Address=iPv6Address, supplementaryGroup=supplementaryGroup, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap)
