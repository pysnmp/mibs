...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerIPAddress=sNTPServerIPAddress, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementGroup=managementGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogControl=syslogControl, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, managementMode=managementMode, aAAControlGroup=aAAControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, licenceGroup=licenceGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, byteErrorRatio=byteErrorRatio, receiveChannel=receiveChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, tDDControl=tDDControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsTableIndex=dfsTableIndex, range=range, dataPortStatus=dataPortStatus, sNTPState=sNTPState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, installStatusTrap=installStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, pubStatsGroup=pubStatsGroup, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, ethernetBridgingStatus=ethernetBridgingStatus, ptpTrapPrefix=ptpTrapPrefix, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, vLANManagementPriority=vLANManagementPriority, channelALoopback=channelALoopback, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarm=secureModeAlarm, ptp=ptp, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, dataPortFiberStatus=dataPortFiberStatus, bridge=bridge, userRole=userRole, bandwidthVariant=bandwidthVariant, aAAControl=aAAControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, installArmState=installArmState, ethernetPriorityTable=ethernetPriorityTable, transmitFreqMHz=transmitFreqMHz, vLANManagementVID=vLANManagementVID, ethernet=ethernet, channelALoopbackTrap=channelALoopbackTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, iPv6Address=iPv6Address, receiveDataRate=receiveDataRate, managementPortStatusTrap=managementPortStatusTrap, alarmsGroup=alarmsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptp600=ptp600, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, channelALineCode=channelALineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTimeout=sNTPServerTimeout, ptpGroups=ptpGroups, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, altitude=altitude, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, securityLevel=securityLevel, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyControl=phyControl, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogClient=syslogClient, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitChannel=transmitChannel, sMTPServerPortNumber=sMTPServerPortNumber, installArmStateTrap=installArmStateTrap, channelBLineCode=channelBLineCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptpCompliance=ptpCompliance, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, groupID=groupID, regionCodeTrap=regionCodeTrap, managementPortStatus=managementPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelACableLength=channelACableLength, dataPortDisabledWarning=dataPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, timeZone=timeZone, sNTPLastSync=sNTPLastSync, linkSymmetry=linkSymmetry, automaticTxPowerControl=automaticTxPowerControl, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, supplementary=supplementary, encryptionGroup=encryptionGroup, remoteIPAddress=remoteIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, userTable=userTable, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelAStatus=telecomsChannelAStatus, dataPortStatusTrap=dataPortStatusTrap, targetRange=targetRange, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, vectorError=vectorError, snmpControl=snmpControl, managementPortDisabledWarning=managementPortDisabledWarning, telecomGroup=telecomGroup, accessMethod=accessMethod, dfsGroup=dfsGroup, subnetMask=subnetMask, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTable=sNTPServerTable, management=management, iPv6GatewayAddress=iPv6GatewayAddress, productName=productName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, configurationGroup=configurationGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, resetGroup=resetGroup, ethernetGroup=ethernetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, txColorCode=txColorCode, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyStatus=phyStatus, userTableEntry=userTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteRxTargetPower=remoteRxTargetPower, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsInterface=telecomsInterface, l2CPPriorityTableEntry=l2CPPriorityTableEntry, smtp=smtp, encryption=encryption, hTTPAccessEnabled=hTTPAccessEnabled, sntp=sntp, iPVersion=iPVersion, syslogControlGroup=syslogControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userName=userName, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveFreqKHz=receiveFreqKHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, syslogState=syslogState, supplementaryGroup=supplementaryGroup, transmitDataRate=transmitDataRate, dfsTableEntry=dfsTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, iPv6PrefixLength=iPv6PrefixLength, iPv4Address=iPv4Address, configuration=configuration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPCommunityString=sNMPCommunityString, phyControlGroup=phyControlGroup, rangingMode=rangingMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerStatus=sNTPServerStatus, sNTPSyncTrap=sNTPSyncTrap, cambium=cambium, receivePower=receivePower, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, channelChangeTrap=channelChangeTrap, telecom=telecom, dfsPeaks=dfsPeaks, hAZLOCConfiguration=hAZLOCConfiguration, softwareVersion=softwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCode=regionCode, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, reset=reset, ptpTraps=ptpTraps, transmitPower=transmitPower, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerRetries=sNTPServerRetries, channelBLoopback=channelBLoopback, siteName=siteName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, searchState=searchState, daylightSaving=daylightSaving, sNMPTrapTable=sNMPTrapTable, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, maximumTransmitPower=maximumTransmitPower, linkName=linkName, installStatus=installStatus, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rawReceivePower=rawReceivePower, remoteInternetAddress=remoteInternetAddress, productVariant=productVariant, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfs=dfs, targetMACAddress=targetMACAddress, tDDControlGroup=tDDControlGroup, channelBCableLength=channelBCableLength, tFTPServerPortNumber=tFTPServerPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bridgeGroup=bridgeGroup, hardwareVersion=hardwareVersion, linkLoss=linkLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelSelection=telecomsChannelSelection, pubStats=pubStats)
