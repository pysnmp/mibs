...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hAZLOCConfiguration=hAZLOCConfiguration, channelBLoopback=channelBLoopback, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, regionCode=regionCode, bridgeGroup=bridgeGroup, telecomsInterface=telecomsInterface, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEnabledMessages=sMTPEnabledMessages, dfsGroup=dfsGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, softwareVersion=softwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, installStatus=installStatus, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, vLANManagementVID=vLANManagementVID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, userPassword=userPassword, remoteRxTargetPower=remoteRxTargetPower, channelBandwidth=channelBandwidth, linkLoss=linkLoss, timeZone=timeZone, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, installStatusTrap=installStatusTrap, dfsMeans=dfsMeans, phyStatusGroup=phyStatusGroup, remoteInternetAddress=remoteInternetAddress, ethernetBridgingStatus=ethernetBridgingStatus, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aggregateDataRate=aggregateDataRate, encryptionAlgorithm=encryptionAlgorithm, byteErrorRatio=byteErrorRatio, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyControlGroup=phyControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rawReceivePower=rawReceivePower, ethernetPriorityTable=ethernetPriorityTable, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, sntp=sntp, range=range, userTableEntry=userTableEntry, dataPortStatusTrap=dataPortStatusTrap, systemReset=systemReset, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6Address=iPv6Address, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTable=sNTPServerTable, managementPortStatus=managementPortStatus, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, ptpTraps=ptpTraps, sNTPSyncTrap=sNTPSyncTrap, channelChangeTrap=channelChangeTrap, versions=versions, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStats=pubStats, sNTPServerIPAddress=sNTPServerIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPState=sNTPState, latitude=latitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, remoteIPAddress=remoteIPAddress, regionCodeTrap=regionCodeTrap, rangingMode=rangingMode, channelBLoopbackTrap=channelBLoopbackTrap, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerRetries=sNTPServerRetries, telecomsChannelAStatus=telecomsChannelAStatus, transmitModulationMode=transmitModulationMode, smtpGroup=smtpGroup, bandwidthVariant=bandwidthVariant, channelALoopback=channelALoopback, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClientTrap=syslogClientTrap, sNMPv3Enable=sNMPv3Enable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteInternetAddressType=remoteInternetAddressType, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, dataPortAutoNegotiation=dataPortAutoNegotiation, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, channelALineCode=channelALineCode, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, userName=userName, channelBCableLength=channelBCableLength, dfsTableEntry=dfsTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp600=ptp600, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bridge=bridge, telecomGroup=telecomGroup, ethernetGroup=ethernetGroup, supplementary=supplementary, secureModeAlarm=secureModeAlarm, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, subnetMask=subnetMask, productName=productName, targetRange=targetRange, phyStatus=phyStatus, phyControl=phyControl, vLANManagementPriority=vLANManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, telnetPortNumber=telnetPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsPeaks=dfsPeaks, transmitFreqKHz=transmitFreqKHz, smtp=smtp, vectorError=vectorError, receiveChannel=receiveChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, licence=licence, longitude=longitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, altitude=altitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, frequencyVariant=frequencyVariant, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv4Address=iPv4Address, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, resetGroup=resetGroup, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementMode=managementMode, maximumTransmitPower=maximumTransmitPower, ethernet=ethernet, dfs=dfs, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkSymmetry=linkSymmetry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClient=syslogClient, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, channelBLineCode=channelBLineCode, cambium=cambium, managementGroup=managementGroup, searchState=searchState, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receivePower=receivePower, localPacketFiltering=localPacketFiltering, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, licenceGroup=licenceGroup, groupID=groupID, qOSPriorityScheme=qOSPriorityScheme, securityLevel=securityLevel, telnetAccessEnabled=telnetAccessEnabled, channelALoopbackTrap=channelALoopbackTrap, versionsGroup=versionsGroup, txColorCode=txColorCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, secureModeAlarmTrap=secureModeAlarmTrap, receiveFreqKHz=receiveFreqKHz, telecom=telecom, iPv6PrefixLength=iPv6PrefixLength, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableIndex=userTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogState=syslogState, alarms=alarms, rxColorCode=rxColorCode, userTable=userTable, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, management=management, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, channelACableLength=channelACableLength, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, antennaGain=antennaGain, syslogControlGroup=syslogControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogControl=syslogControl, telecomsChannelBStatus=telecomsChannelBStatus, transmitFreqMHz=transmitFreqMHz, receiveDataRate=receiveDataRate, dfsTableNumber=dfsTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, installArmState=installArmState, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, iPVersion=iPVersion, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, linkName=linkName, daylightSaving=daylightSaving, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, sNTPServerStatus=sNTPServerStatus, transmitChannel=transmitChannel, managementPortDisabledWarning=managementPortDisabledWarning, configuration=configuration, reset=reset, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelSelection=telecomsChannelSelection, l2CPPriorityTable=l2CPPriorityTable, eIRP=eIRP)
