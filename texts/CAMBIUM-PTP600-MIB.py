...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkSymmetry=linkSymmetry, sNTPPrimaryServer=sNTPPrimaryServer, userName=userName, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionAlgorithm=encryptionAlgorithm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerStatus=sNTPServerStatus, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, channelChangeTrap=channelChangeTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerInternetAddress=sMTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatus=dataPortStatus, aAAControl=aAAControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, notificationsGroup=notificationsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatus=installStatus, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, telecom=telecom, productName=productName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpTraps=ptpTraps, managementMode=managementMode, receiveModulationModeDetail=receiveModulationModeDetail, qOSPriorityScheme=qOSPriorityScheme, syslogControlGroup=syslogControlGroup, alarmsGroup=alarmsGroup, dfsTable=dfsTable, installArmState=installArmState, transmitModulationMode=transmitModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, resetGroup=resetGroup, antennaGain=antennaGain, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuration=configuration, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licence=licence, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, rangingMode=rangingMode, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, dfsPeaks=dfsPeaks, encryption=encryption, receiveFreqKHz=receiveFreqKHz, rawReceivePower=rawReceivePower, bandwidthVariant=bandwidthVariant, versions=versions, channelBCableLength=channelBCableLength, softwareVersion=softwareVersion, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, securityLevel=securityLevel, sNTPSyncTrap=sNTPSyncTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenceGroup=licenceGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTimeout=sNTPServerTimeout, hardwareVersion=hardwareVersion, syslogState=syslogState, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsInterface=telecomsInterface, range=range, hTTPPortNumber=hTTPPortNumber, dfs=dfs, syslogControl=syslogControl, ethernetBridgingAvailability=ethernetBridgingAvailability, groupID=groupID, transmitDataRate=transmitDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, managementGroup=managementGroup, channelBLoopback=channelBLoopback, remoteRxTargetPower=remoteRxTargetPower, targetRange=targetRange, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortWirelessDownAlert=dataPortWirelessDownAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpCompliance=ptpCompliance, ptp600=ptp600, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, vectorError=vectorError, snmpControlGroup=snmpControlGroup, iPv6PrefixLength=iPv6PrefixLength, subnetMask=subnetMask, sntp=sntp, ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, bridgeGroup=bridgeGroup, vLANManagementPriority=vLANManagementPriority, hAZLOCConfiguration=hAZLOCConfiguration, smtpGroup=smtpGroup, localPacketFiltering=localPacketFiltering, userRole=userRole, userTable=userTable, searchState=searchState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, ptpTrapPrefix=ptpTrapPrefix, alarms=alarms, sNTPState=sNTPState, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, timeZone=timeZone, receiveDataRate=receiveDataRate, ptp=ptp, smtp=smtp, cambium=cambium, regionCode=regionCode, receiveFreqMHz=receiveFreqMHz, gatewayIPAddress=gatewayIPAddress, userEnabled=userEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, daylightSaving=daylightSaving, tDDControl=tDDControl, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, channelBLoopbackTrap=channelBLoopbackTrap, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, altitude=altitude, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsGroup=dfsGroup, sNTPServerTableNumber=sNTPServerTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, secureModeAlarm=secureModeAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, channelALineCode=channelALineCode, supplementaryGroup=supplementaryGroup, channelALoopback=channelALoopback, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, remoteInternetAddress=remoteInternetAddress, remoteInternetAddressType=remoteInternetAddressType, systemClock=systemClock, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerTableEntry=sNTPServerTableEntry, dataPortFiberStatus=dataPortFiberStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetGroup=ethernetGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortAutoMdix=dataPortAutoMdix, regionCodeTrap=regionCodeTrap, telecomsChannelSelection=telecomsChannelSelection, ethernet=ethernet, ethernetFiberSupport=ethernetFiberSupport, hTTPAccessEnabled=hTTPAccessEnabled, linkLoss=linkLoss, channelBandwidth=channelBandwidth, userPassword=userPassword, secureModeAlarmTrap=secureModeAlarmTrap, syslogStateTrap=syslogStateTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityTableIndex=ethernetPriorityTableIndex, automaticTxPowerControl=automaticTxPowerControl, encryptionGroup=encryptionGroup, dfsTableIndex=dfsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTable=sNTPServerTable, telnetPortNumber=telnetPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsMeans=dfsMeans, managementPortStatusTrap=managementPortStatusTrap, unitOutOfCalibration=unitOutOfCalibration, rxColorCode=rxColorCode, sNTPLastSync=sNTPLastSync, dfsTableNumber=dfsTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ptmp=ptmp, masterSlaveMode=masterSlaveMode, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsChannelAStatus=telecomsChannelAStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, managementPortStatus=managementPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installArmStateTrap=installArmStateTrap, sNTPSync=sNTPSync, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, siteName=siteName, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, l2CPPriorityTable=l2CPPriorityTable, iPVersion=iPVersion, transmitFreqMHz=transmitFreqMHz)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDControlGroup=tDDControlGroup, sntpGroup=sntpGroup, dataPortStatusTrap=dataPortStatusTrap, channelACableLength=channelACableLength, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, iPv6Address=iPv6Address, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetAccessEnabled=telnetAccessEnabled, maximumTransmitPower=maximumTransmitPower, userTableNumber=userTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, ptpGroups=ptpGroups, longitude=longitude, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, snmpControl=snmpControl, cableLoss=cableLoss, linkName=linkName, txColorCode=txColorCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerTableIndex=sNTPServerTableIndex, reset=reset, latitude=latitude, channelALoopbackTrap=channelALoopbackTrap, iPv4Address=iPv4Address, installStatusTrap=installStatusTrap, bridge=bridge, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBLineCode=channelBLineCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup)
