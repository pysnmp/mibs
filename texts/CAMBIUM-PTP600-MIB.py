...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, installArmStateTrap=installArmStateTrap, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ptpGroups=ptpGroups, sNTPServerTableEntry=sNTPServerTableEntry, txColorCode=txColorCode, snmpControl=snmpControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteRxTargetPower=remoteRxTargetPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortFiberStatus=dataPortFiberStatus, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, ethernet=ethernet, telecom=telecom, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortDisabledWarning=managementPortDisabledWarning, cableLoss=cableLoss, dfsGroup=dfsGroup, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, ethernetPriorityTableEntry=ethernetPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementPriority=vLANManagementPriority, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveFreqMHz=receiveFreqMHz, ethernetBridgingStatus=ethernetBridgingStatus, sMTPEmailAlert=sMTPEmailAlert, channelACableLength=channelACableLength, receivePower=receivePower, encryption=encryption, phyControl=phyControl, hAZLOCConfiguration=hAZLOCConfiguration, rangingMode=rangingMode, unitOutOfCalibration=unitOutOfCalibration, encryptionGroup=encryptionGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetRange=targetRange, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomGroup=telecomGroup, receiveDataRate=receiveDataRate, productVariant=productVariant, iPv4Address=iPv4Address, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, alarms=alarms, dfsTableIndex=dfsTableIndex, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, vectorError=vectorError, licenceGroup=licenceGroup, sntpGroup=sntpGroup, telecomsChannelSelection=telecomsChannelSelection, rxColorCode=rxColorCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userTableNumber=userTableNumber, softwareVersion=softwareVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, targetMACAddress=targetMACAddress, userTableIndex=userTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, channelALoopbackTrap=channelALoopbackTrap, managementMode=managementMode, userTable=userTable, phyStatus=phyStatus, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControlGroup=aAAControlGroup, installStatus=installStatus, qOSPriorityScheme=qOSPriorityScheme, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControl=aAAControl, localPacketFiltering=localPacketFiltering, bridgeGroup=bridgeGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, accessMethod=accessMethod, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, siteName=siteName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsInterface=telecomsInterface, installStatusTrap=installStatusTrap, channelBCableLength=channelBCableLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBandwidth=channelBandwidth, sNTPState=sNTPState, byteErrorRatio=byteErrorRatio, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, channelBLoopback=channelBLoopback, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatusTrap=dataPortStatusTrap, channelBLineCode=channelBLineCode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bridge=bridge, sNMPCommunityString=sNMPCommunityString, tDDControl=tDDControl, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, PYSNMP_MODULE_ID=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, maximumTransmitPower=maximumTransmitPower, securityLevel=securityLevel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, rawReceivePower=rawReceivePower, ptp=ptp, systemReset=systemReset, notificationsGroup=notificationsGroup, transmitFreqKHz=transmitFreqKHz, latitude=latitude, ethernetGroup=ethernetGroup, regionCodeTrap=regionCodeTrap, regionCode=regionCode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptp600=ptp600, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, sntp=sntp, dfsPeaks=dfsPeaks, dfsMeans=dfsMeans, transmitFreqMHz=transmitFreqMHz, syslogControlGroup=syslogControlGroup, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTable=sNTPServerTable, managementPortStatusTrap=managementPortStatusTrap, receiveChannel=receiveChannel, ptmp=ptmp, sNTPPollInterval=sNTPPollInterval, altitude=altitude, automaticTxPowerControl=automaticTxPowerControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteIPAddress=remoteIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, iPVersion=iPVersion, iPv6Address=iPv6Address, supplementary=supplementary, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, managementPortStatus=managementPortStatus, timeZone=timeZone, dfs=dfs, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configuration=configuration, channelALoopback=channelALoopback, ethernetPriorityTableNumber=ethernetPriorityTableNumber, vLANManagementVID=vLANManagementVID, phyControlGroup=phyControlGroup, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, channelALineCode=channelALineCode, receiveModulationMode=receiveModulationMode, remoteInternetAddress=remoteInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, ptpCompliance=ptpCompliance, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, masterSlaveMode=masterSlaveMode, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, channelBLoopbackTrap=channelBLoopbackTrap, userName=userName, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userTableEntry=userTableEntry, dataPortStatus=dataPortStatus, syslogControl=syslogControl, transmitChannel=transmitChannel, daylightSaving=daylightSaving, resetGroup=resetGroup, managementGroup=managementGroup, remoteInternetAddressType=remoteInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, longitude=longitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, management=management, bandwidthVariant=bandwidthVariant, dfsTable=dfsTable, iPv6GatewayAddress=iPv6GatewayAddress, receiveFreqKHz=receiveFreqKHz, encryptionAlgorithm=encryptionAlgorithm, iPv6PrefixLength=iPv6PrefixLength, channelChangeTrap=channelChangeTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, secureModeAlarm=secureModeAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, systemClock=systemClock, tDDControlGroup=tDDControlGroup, groupID=groupID, sNMPPortNumber=sNMPPortNumber, hTTPSPortNumber=hTTPSPortNumber, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, reset=reset)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userEnabled=userEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkModeOptimisation=linkModeOptimisation, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, sNTPServerRetries=sNTPServerRetries, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkSymmetry=linkSymmetry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, userRole=userRole, smtpGroup=smtpGroup, sNTPLastSync=sNTPLastSync, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTableIndex=sNTPServerTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, frequencyVariant=frequencyVariant, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licence=licence, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, searchState=searchState, installArmState=installArmState, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType)
