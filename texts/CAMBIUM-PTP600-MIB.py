...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dSCPManagementPriority=dSCPManagementPriority, telecomsChannelAStatus=telecomsChannelAStatus, channelBLoopback=channelBLoopback, receiveFreqKHz=receiveFreqKHz, management=management, bootVersion=bootVersion, userPassword=userPassword, ethernetBridgingStatus=ethernetBridgingStatus, ptpCompliance=ptpCompliance, syslogControl=syslogControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableNumber=dfsTableNumber, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementPortStatusTrap=managementPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, hTTPPortNumber=hTTPPortNumber, iPVersion=iPVersion, systemClock=systemClock, siteName=siteName, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryptionGroup=encryptionGroup, managementPortStatus=managementPortStatus, syslogControlGroup=syslogControlGroup, sNTPServerStatus=sNTPServerStatus, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyStatusGroup=phyStatusGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, installStatus=installStatus, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, txColorCode=txColorCode, managementMode=managementMode, telnetPortNumber=telnetPortNumber, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, remoteInternetAddress=remoteInternetAddress, channelBCableLength=channelBCableLength, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogState=syslogState, eIRP=eIRP, userTable=userTable, iPv4Address=iPv4Address, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, bridgeGroup=bridgeGroup, dfsPeaks=dfsPeaks, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryption=encryption, mPLSTCPriorityTable=mPLSTCPriorityTable, productName=productName, managementGroup=managementGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimisation=linkModeOptimisation, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, userName=userName, telecomsInterface=telecomsInterface, userTableEntry=userTableEntry, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, dataPortStatus=dataPortStatus, linkSymmetry=linkSymmetry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelChangeTrap=channelChangeTrap, dataPortDisabledWarning=dataPortDisabledWarning, bridge=bridge, phyControlGroup=phyControlGroup, snmpControl=snmpControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, supplementaryGroup=supplementaryGroup, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogClient=syslogClient, telecomGroup=telecomGroup, dfsTable=dfsTable, iPv6GatewayAddress=iPv6GatewayAddress, transmitModulationMode=transmitModulationMode, rawReceivePower=rawReceivePower, dfs=dfs, linkLoss=linkLoss, searchState=searchState, configuration=configuration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, latitude=latitude, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, licence=licence, PYSNMP_MODULE_ID=cambium, range=range, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPollInterval=sNTPPollInterval, channelALineCode=channelALineCode, iPv6PrefixLength=iPv6PrefixLength, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationMode=tDDSynchronizationMode, softwareVersion=softwareVersion, accessMethod=accessMethod, secureModeAlarm=secureModeAlarm, sNTPServerTable=sNTPServerTable, dataPortAutoMdix=dataPortAutoMdix, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, dataPortFiberStatus=dataPortFiberStatus, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenceGroup=licenceGroup, transmitFreqMHz=transmitFreqMHz, channelALoopbackTrap=channelALoopbackTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableIndex=userTableIndex, smtp=smtp, subnetMask=subnetMask, sNTPServerTimeout=sNTPServerTimeout, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerIPAddress=sNTPServerIPAddress, hAZLOCConfiguration=hAZLOCConfiguration, maximumTransmitPower=maximumTransmitPower, qOSPriorityScheme=qOSPriorityScheme, antennaGain=antennaGain, channelACableLength=channelACableLength, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsGroup=dfsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, alarmsGroup=alarmsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, versions=versions, localPacketFiltering=localPacketFiltering, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configurationGroup=configurationGroup, transmitChannel=transmitChannel, l2CPPriorityTable=l2CPPriorityTable, sNMPCommunityString=sNMPCommunityString, receiveModulationMode=receiveModulationMode, ethernet=ethernet, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBandwidth=channelBandwidth, regionCode=regionCode, ptp=ptp, targetRange=targetRange, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, channelBLoopbackTrap=channelBLoopbackTrap, cableLoss=cableLoss, rangingMode=rangingMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, pubStats=pubStats, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetBridgingAvailability=ethernetBridgingAvailability, telecomsChannelSelection=telecomsChannelSelection, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, systemReset=systemReset, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerRetries=sNTPServerRetries, dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, ptp600=ptp600, dataPortStatusTrap=dataPortStatusTrap, userEnabled=userEnabled, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, cambium=cambium, tDDControl=tDDControl, masterSlaveMode=masterSlaveMode, sntp=sntp, linkName=linkName, remoteInternetAddressType=remoteInternetAddressType, productVariant=productVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, receivePower=receivePower, sNTPServerTableIndex=sNTPServerTableIndex, supplementary=supplementary, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleRegionCodes=incompatibleRegionCodes, phyStatus=phyStatus, smtpGroup=smtpGroup, vectorError=vectorError, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, securityLevel=securityLevel, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControl=phyControl, automaticTxPowerControl=automaticTxPowerControl, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, groupID=groupID, daylightSaving=daylightSaving, userRole=userRole, channelALoopback=channelALoopback, telecom=telecom, managementPortDisabledWarning=managementPortDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rxColorCode=rxColorCode, sntpGroup=sntpGroup, sNTPServerTableEntry=sNTPServerTableEntry, dfsMeans=dfsMeans, channelBLineCode=channelBLineCode, sNTPSync=sNTPSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControlGroup=tDDControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetFiberSupport=ethernetFiberSupport, vLANManagementPriority=vLANManagementPriority, frequencyVariant=frequencyVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, ptmp=ptmp, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, reset=reset, iPv6Address=iPv6Address)
