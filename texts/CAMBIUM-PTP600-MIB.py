...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:46:42 2021
...
Unsigned32, IpAddress, enterprises, Integer32, Counter64, Bits, ModuleIdentity, iso, ObjectIdentity, MibIdentifier, Counter32, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "enterprises", "Integer32", "Counter64", "Bits", "ModuleIdentity", "iso", "ObjectIdentity", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", txColorCode=txColorCode, sNTPServerRetries=sNTPServerRetries, rangingMode=rangingMode, linkLoss=linkLoss, bootVersion=bootVersion, userTableNumber=userTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, frequencyVariant=frequencyVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelALoopbackTrap=channelALoopbackTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, hAZLOCConfiguration=hAZLOCConfiguration, ethernetBridgingAvailability=ethernetBridgingAvailability, phyStatus=phyStatus, userTableEntry=userTableEntry, transmitChannel=transmitChannel, maximumTransmitPower=maximumTransmitPower, ethernetBridgingStatus=ethernetBridgingStatus, securityLevel=securityLevel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rawReceivePower=rawReceivePower, dfs=dfs, sNMPCommunityString=sNMPCommunityString, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, bandwidthVariant=bandwidthVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, latitude=latitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerInternetAddress=tFTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, transmitDataRate=transmitDataRate, syslogState=syslogState, ptpGroups=ptpGroups, vLANManagementVID=vLANManagementVID, localPacketFiltering=localPacketFiltering, linkModeOptimisation=linkModeOptimisation, remoteRxTargetPower=remoteRxTargetPower, dataPortDisabledWarning=dataPortDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsGroup=dfsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyStatusGroup=phyStatusGroup, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, altitude=altitude, tDDControl=tDDControl, sNTPServerTableIndex=sNTPServerTableIndex, snmpControl=snmpControl, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, syslogControlGroup=syslogControlGroup, secureModeAlarm=secureModeAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, wirelessLinkAvailability=wirelessLinkAvailability, userEnabled=userEnabled, sNTPSyncTrap=sNTPSyncTrap, ethernetFiberSupport=ethernetFiberSupport, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, sntpGroup=sntpGroup, gatewayIPAddress=gatewayIPAddress, qOSPriorityScheme=qOSPriorityScheme, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteInternetAddress=remoteInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveModulationMode=receiveModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsMeans=dfsMeans, channelChangeTrap=channelChangeTrap, hTTPPortNumber=hTTPPortNumber, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityTable=ethernetPriorityTable, regionCode=regionCode, installStatus=installStatus, syslogClient=syslogClient, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, reset=reset, dfsTable=dfsTable, iPv4Address=iPv4Address, constantPowerSpectralDensity=constantPowerSpectralDensity, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, bridgeGroup=bridgeGroup, installStatusTrap=installStatusTrap, telecomsChannelBStatus=telecomsChannelBStatus, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, timeZone=timeZone, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userPassword=userPassword, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortStatusTrap=dataPortStatusTrap, supplementary=supplementary, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, searchState=searchState, configurationGroup=configurationGroup, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelSelection=telecomsChannelSelection, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableIndex=dfsTableIndex, telecomGroup=telecomGroup, phyControl=phyControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTable=userTable, remoteIPAddress=remoteIPAddress, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, snmpControlGroup=snmpControlGroup, dataPortFiberStatus=dataPortFiberStatus, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPv6Address=iPv6Address, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, installArmStateTrap=installArmStateTrap, managementPortStatusTrap=managementPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServer=sNTPPrimaryServer, notificationsGroup=notificationsGroup, linkName=linkName, ethernet=ethernet, iPVersion=iPVersion, alarmsGroup=alarmsGroup, ptp=ptp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, configuration=configuration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receivePower=receivePower, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsPeaks=dfsPeaks, dataPortAutoMdix=dataPortAutoMdix, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleRegionCodes=incompatibleRegionCodes, hTTPAccessEnabled=hTTPAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqKHz=transmitFreqKHz, automaticTxPowerControl=automaticTxPowerControl, managementMode=managementMode, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userRole=userRole, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, vLANManagementPriority=vLANManagementPriority, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, channelACableLength=channelACableLength, encryption=encryption, remoteInternetAddressType=remoteInternetAddressType, channelALineCode=channelALineCode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, managementPortStatus=managementPortStatus, alarms=alarms, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerTableEntry=sNTPServerTableEntry, ptmp=ptmp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, versionsGroup=versionsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, productVariant=productVariant, ptp600=ptp600, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, accessMethod=accessMethod, bridge=bridge, eIRP=eIRP, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableNumber=dfsTableNumber, sNTPState=sNTPState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, targetMACAddress=targetMACAddress, channelBCableLength=channelBCableLength, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userName=userName, groupID=groupID, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, aAAControl=aAAControl, tDDControlGroup=tDDControlGroup, ptpTraps=ptpTraps, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, longitude=longitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, byteErrorRatio=byteErrorRatio, channelALoopback=channelALoopback, encryptionGroup=encryptionGroup, tDDSynchronizationMode=tDDSynchronizationMode, antennaGain=antennaGain, ethernetGroup=ethernetGroup, telecomsChannelAStatus=telecomsChannelAStatus, aAAControlGroup=aAAControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopback=channelBLoopback, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cambium=cambium, rxColorCode=rxColorCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortDisabledWarning=managementPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTimeout=sNTPServerTimeout, telecom=telecom, l2CPPriorityTable=l2CPPriorityTable, targetRange=targetRange, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBLineCode=channelBLineCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerStatus=sNTPServerStatus, sNTPServerPortNumber=sNTPServerPortNumber, management=management, systemReset=systemReset, regionCodeTrap=regionCodeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, productName=productName, phyControlGroup=phyControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveFreqKHz=receiveFreqKHz, sNTPServerTableNumber=sNTPServerTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, pubStats=pubStats, sntp=sntp, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsInterface=telecomsInterface, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, resetGroup=resetGroup, siteName=siteName)
