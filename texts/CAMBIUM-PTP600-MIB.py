...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", secureModeAlarmTrap=secureModeAlarmTrap, ethernet=ethernet, accessMethod=accessMethod, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userRole=userRole, iPDSCPPriorityTable=iPDSCPPriorityTable, groupID=groupID, linkName=linkName, sNMPPortNumber=sNMPPortNumber, rangingMode=rangingMode, securityLevel=securityLevel, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTable=mPLSTCPriorityTable, management=management, automaticTxPowerControl=automaticTxPowerControl, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, sntpGroup=sntpGroup, ptpCompliance=ptpCompliance, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTable=sNTPServerTable, dfsMeans=dfsMeans, targetMACAddress=targetMACAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpGroups=ptpGroups, userTableEntry=userTableEntry, versionsGroup=versionsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkSymmetry=linkSymmetry, ptp=ptp, sNTPServerPortNumber=sNTPServerPortNumber, masterSlaveMode=masterSlaveMode, telecomsChannelAStatus=telecomsChannelAStatus, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, channelBCableLength=channelBCableLength, regionCode=regionCode, managementPortStatusTrap=managementPortStatusTrap, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, encryptionAlgorithm=encryptionAlgorithm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, syslogState=syslogState, linkModeOptimisation=linkModeOptimisation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, bridge=bridge, managementMode=managementMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, eIRP=eIRP, vLANManagementVID=vLANManagementVID, supplementary=supplementary, ethernetBridgingStatus=ethernetBridgingStatus, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, byteErrorRatio=byteErrorRatio, channelALoopbackTrap=channelALoopbackTrap, userTableNumber=userTableNumber, sNMPTrapVersion=sNMPTrapVersion, bootVersion=bootVersion, cableLoss=cableLoss, rxColorCode=rxColorCode, licence=licence, syslogControl=syslogControl, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTable=ethernetPriorityTable, vectorError=vectorError, notificationsGroup=notificationsGroup, range=range, productVariant=productVariant, supplementaryGroup=supplementaryGroup, remoteRxTargetPower=remoteRxTargetPower, userName=userName, transmitChannel=transmitChannel, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, channelALoopback=channelALoopback, sNMPEnabledTraps=sNMPEnabledTraps, syslogStateTrap=syslogStateTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, iPv6Address=iPv6Address, daylightSaving=daylightSaving, telecomGroup=telecomGroup, aggregateDataRate=aggregateDataRate, receiveFreqKHz=receiveFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatus=dataPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, alarms=alarms, remoteInternetAddress=remoteInternetAddress, channelBLineCode=channelBLineCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, PYSNMP_MODULE_ID=cambium, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTable=dfsTable, phyStatus=phyStatus, transmitPower=transmitPower, telecomsChannelSelection=telecomsChannelSelection, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsGroup=dfsGroup, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerStatus=sNTPServerStatus, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsPeaks=dfsPeaks, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, installArmStateTrap=installArmStateTrap, ptp600=ptp600, iPVersion=iPVersion, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControl=phyControl, installArmState=installArmState, rawReceivePower=rawReceivePower, resetGroup=resetGroup, sNTPPollInterval=sNTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, siteName=siteName, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTableEntry=sNTPServerTableEntry, tDDControl=tDDControl, frequencyVariant=frequencyVariant, searchState=searchState, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarning=dataPortDisabledWarning, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementGroup=managementGroup, userPassword=userPassword, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptmp=ptmp, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receivePower=receivePower, installStatus=installStatus, managementPortStatus=managementPortStatus, smtpGroup=smtpGroup, sNTPPrimaryServer=sNTPPrimaryServer, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, channelALineCode=channelALineCode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptpTraps=ptpTraps, managementPortDisabledWarning=managementPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableNumber=sNTPServerTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsTableEntry=dfsTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveChannel=receiveChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableIndex=sNTPServerTableIndex, txColorCode=txColorCode, channelBLoopback=channelBLoopback, regionCodeTrap=regionCodeTrap, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userEnabled=userEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subnetMask=subnetMask, dfs=dfs, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, tDDControlGroup=tDDControlGroup, l2CPPriorityTable=l2CPPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, hardwareVersion=hardwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, snmpControlGroup=snmpControlGroup, channelACableLength=channelACableLength, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortFiberStatus=dataPortFiberStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, userTableIndex=userTableIndex, sNTPServerRetries=sNTPServerRetries, systemClock=systemClock, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, longitude=longitude, receiveModulationMode=receiveModulationMode, pubStatsGroup=pubStatsGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userTable=userTable, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodes=incompatibleRegionCodes, sntp=sntp, localPacketFiltering=localPacketFiltering, telnetPortNumber=telnetPortNumber, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBLoopbackTrap=channelBLoopbackTrap, syslogClient=syslogClient, syslogControlGroup=syslogControlGroup, telecomsInterface=telecomsInterface)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStats=pubStats, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dSCPManagementPriority=dSCPManagementPriority, configuration=configuration, smtp=smtp, softwareVersion=softwareVersion, sNTPServerTimeout=sNTPServerTimeout, altitude=altitude, telnetAccessEnabled=telnetAccessEnabled, phyControlGroup=phyControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, productName=productName, versions=versions, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, targetRange=targetRange, secureModeAlarm=secureModeAlarm, licenceGroup=licenceGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, aAAControlGroup=aAAControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, timeZone=timeZone, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatusTrap=dataPortStatusTrap, aAAControl=aAAControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
