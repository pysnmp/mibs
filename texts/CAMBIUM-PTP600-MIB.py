...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPState=sNTPState, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogClient=syslogClient, telecom=telecom, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsChannelBStatus=telecomsChannelBStatus, installStatus=installStatus, dfs=dfs, ethernetBridgingStatus=ethernetBridgingStatus, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControlGroup=tDDControlGroup, snmpControlGroup=snmpControlGroup, userPassword=userPassword, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsChannelAStatus=telecomsChannelAStatus, linkSymmetry=linkSymmetry, userTableNumber=userTableNumber, phyStatusGroup=phyStatusGroup, linkName=linkName, managementGroup=managementGroup, sNTPServerRetries=sNTPServerRetries, hAZLOCConfiguration=hAZLOCConfiguration, syslogClientTrap=syslogClientTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licence=licence, phyControlGroup=phyControlGroup, altitude=altitude, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPollInterval=sNTPPollInterval, channelALoopbackTrap=channelALoopbackTrap, productName=productName, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, supplementary=supplementary, linkModeOptimisation=linkModeOptimisation, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPVersion=iPVersion, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, configuration=configuration, groupID=groupID, sNTPLastSync=sNTPLastSync, sNTPServerTableIndex=sNTPServerTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, configurationGroup=configurationGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsTableNumber=dfsTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoMdix=dataPortAutoMdix, pubStatsGroup=pubStatsGroup, sNMPPortNumber=sNMPPortNumber, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, frequencyVariant=frequencyVariant, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, receivePower=receivePower, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, aggregateDataRate=aggregateDataRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, eIRP=eIRP, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALineCode=channelALineCode, userTable=userTable, daylightSaving=daylightSaving, ethernetFiberSupport=ethernetFiberSupport, regionCode=regionCode, managementPortStatus=managementPortStatus, channelBLineCode=channelBLineCode, qOSPriorityScheme=qOSPriorityScheme, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecomsInterface=telecomsInterface, channelBLoopback=channelBLoopback, receiveFreqMHz=receiveFreqMHz, sntp=sntp, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rangingMode=rangingMode, receiveChannel=receiveChannel, userTableIndex=userTableIndex, sNTPServerTimeout=sNTPServerTimeout, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, encryption=encryption, channelBCableLength=channelBCableLength, ethernetPriorityTable=ethernetPriorityTable, bridgeGroup=bridgeGroup, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpGroups=ptpGroups, ethernetPriorityTableIndex=ethernetPriorityTableIndex, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementMode=managementMode, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitChannel=transmitChannel, iPv6Address=iPv6Address, vLANManagementPriority=vLANManagementPriority, smtp=smtp, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveModulationMode=receiveModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPv3Enable=sNMPv3Enable, remoteInternetAddressType=remoteInternetAddressType, subnetMask=subnetMask, transmitPower=transmitPower, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, ptmp=ptmp, telecomGroup=telecomGroup, channelBandwidth=channelBandwidth, rawReceivePower=rawReceivePower, dataPortFiberStatus=dataPortFiberStatus, syslogStateTrap=syslogStateTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsTable=dfsTable, alarms=alarms, range=range, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, syslogControl=syslogControl, rxColorCode=rxColorCode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, bridge=bridge, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, automaticTxPowerControl=automaticTxPowerControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, licenceGroup=licenceGroup, aAAControlGroup=aAAControlGroup, iPv4Address=iPv4Address, securityLevel=securityLevel, tFTPServerInternetAddress=tFTPServerInternetAddress, sntpGroup=sntpGroup, cableLoss=cableLoss, remoteRxTargetPower=remoteRxTargetPower, phyControl=phyControl, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, maximumTransmitPower=maximumTransmitPower, userRole=userRole, userName=userName, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerTable=sNTPServerTable, antennaGain=antennaGain, targetRange=targetRange, ptp=ptp, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, softwareVersion=softwareVersion, cambium=cambium, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, channelACableLength=channelACableLength, searchState=searchState, bootVersion=bootVersion, encryptionGroup=encryptionGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, ptp600=ptp600, ethernetGroup=ethernetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, remoteInternetAddress=remoteInternetAddress, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTable=l2CPPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, ethernet=ethernet, iPv6PrefixLength=iPv6PrefixLength, txColorCode=txColorCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkLoss=linkLoss, userTableEntry=userTableEntry, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, transmitModulationMode=transmitModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dfsMeans=dfsMeans, encryptionAlgorithm=encryptionAlgorithm, hTTPPortNumber=hTTPPortNumber, sNTPServerStatus=sNTPServerStatus, managementPortDisabledWarning=managementPortDisabledWarning, regionCodeTrap=regionCodeTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, systemReset=systemReset, localPacketFiltering=localPacketFiltering, notificationsGroup=notificationsGroup, channelALoopback=channelALoopback, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, byteErrorRatio=byteErrorRatio, versions=versions, targetMACAddress=targetMACAddress, installStatusTrap=installStatusTrap, secureModeAlarm=secureModeAlarm, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
