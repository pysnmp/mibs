...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, sntp=sntp, sNTPState=sNTPState, licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, range=range, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, telnetAccessEnabled=telnetAccessEnabled, receiveFreqMHz=receiveFreqMHz, userTableIndex=userTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCodeTrap=regionCodeTrap, tDDControl=tDDControl, iPv6GatewayAddress=iPv6GatewayAddress, managementGroup=managementGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, managementMode=managementMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkName=linkName, supplementary=supplementary, gatewayIPAddress=gatewayIPAddress, dataPortAutoMdix=dataPortAutoMdix, receivePower=receivePower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, securityLevel=securityLevel, sNTPServerInternetAddress=sNTPServerInternetAddress, userEnabled=userEnabled, ptpGroups=ptpGroups, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, sNTPLastSync=sNTPLastSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, longitude=longitude, groupID=groupID, userPassword=userPassword, automaticTxPowerControl=automaticTxPowerControl, targetRange=targetRange, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, pubStats=pubStats, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, ptp=ptp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelALoopbackTrap=channelALoopbackTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, hTTPPortNumber=hTTPPortNumber, systemReset=systemReset, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, subnetMask=subnetMask, telecomsChannelAStatus=telecomsChannelAStatus, signalStrengthRatio=signalStrengthRatio, latitude=latitude, userTable=userTable, iPv6PrefixLength=iPv6PrefixLength, versionsGroup=versionsGroup, sNTPServerRetries=sNTPServerRetries, pubStatsGroup=pubStatsGroup, sNTPPrimaryServer=sNTPPrimaryServer, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, dfsTable=dfsTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, siteName=siteName, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControl=phyControl, dataPortAutoNegotiation=dataPortAutoNegotiation, versions=versions, sNTPServerPortNumber=sNTPServerPortNumber, eIRP=eIRP, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelACableLength=channelACableLength, aAAControlGroup=aAAControlGroup, sNTPServerStatus=sNTPServerStatus, installArmStateTrap=installArmStateTrap, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteInternetAddressType=remoteInternetAddressType, txColorCode=txColorCode, secureModeAlarm=secureModeAlarm, bootVersion=bootVersion, linkSymmetry=linkSymmetry, ethernetBridgingAvailability=ethernetBridgingAvailability, userName=userName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryption=encryption, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productName=productName, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveChannel=receiveChannel, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatch=linkModeOptimizationMismatch, PYSNMP_MODULE_ID=cambium, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfs=dfs, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPEnabledTraps=sNMPEnabledTraps, secureModeAlarmTrap=secureModeAlarmTrap, sNMPv3Enable=sNMPv3Enable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, alarmsGroup=alarmsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, productVariant=productVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsInterface=telecomsInterface, smtp=smtp, linkLoss=linkLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, channelBCableLength=channelBCableLength, managementPortStatus=managementPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyStatusGroup=phyStatusGroup, bridgeGroup=bridgeGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, sMTPEmailAlert=sMTPEmailAlert, hAZLOCConfiguration=hAZLOCConfiguration, ethernetPriorityTable=ethernetPriorityTable, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, sNTPServerTableIndex=sNTPServerTableIndex, localPacketFiltering=localPacketFiltering, receiveDataRate=receiveDataRate, regionCode=regionCode, rawReceivePower=rawReceivePower, sNTPSync=sNTPSync, softwareVersion=softwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, hardwareVersion=hardwareVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecom=telecom, encryptionGroup=encryptionGroup, dSCPManagementPriority=dSCPManagementPriority, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogClientTrap=syslogClientTrap, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetGroup=ethernetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomGroup=telecomGroup, dfsTableIndex=dfsTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, channelBLoopback=channelBLoopback, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userRole=userRole, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationModeDetail=receiveModulationModeDetail, phyStatus=phyStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, notificationsGroup=notificationsGroup, rangingMode=rangingMode, channelChangeTrap=channelChangeTrap, ptpTraps=ptpTraps, sNTPServerTimeout=sNTPServerTimeout, reset=reset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, configuration=configuration, ptp600=ptp600, installStatusTrap=installStatusTrap, management=management, altitude=altitude, syslogControl=syslogControl, sNTPServerIPAddress=sNTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, channelALoopback=channelALoopback, syslogClient=syslogClient, byteErrorRatio=byteErrorRatio, dataPortStatusTrap=dataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelALineCode=channelALineCode, ptpCompliance=ptpCompliance, telnetPortNumber=telnetPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, snmpControlGroup=snmpControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, transmitFreqKHz=transmitFreqKHz, dfsMeans=dfsMeans, ptmp=ptmp, resetGroup=resetGroup, linkModeOptimisation=linkModeOptimisation, supplementaryGroup=supplementaryGroup, transmitChannel=transmitChannel, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv4Address=iPv4Address, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, rxColorCode=rxColorCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControlGroup=phyControlGroup, installArmState=installArmState, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, dataPortStatus=dataPortStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", secondarySoftwareVersion=secondarySoftwareVersion, qOSPriorityScheme=qOSPriorityScheme, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, accessMethod=accessMethod, sNTPServerTable=sNTPServerTable, vLANManagementVID=vLANManagementVID, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alarms=alarms, remoteIPAddress=remoteIPAddress, dataPortFiberStatus=dataPortFiberStatus, sNTPServerTableNumber=sNTPServerTableNumber, dfsGroup=dfsGroup, channelBLoopbackTrap=channelBLoopbackTrap, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableNumber=userTableNumber, userTableEntry=userTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, telecomsChannelSelection=telecomsChannelSelection, channelBLineCode=channelBLineCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPSyncTrap=sNTPSyncTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv6Address=iPv6Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, syslogControlGroup=syslogControlGroup, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, vectorError=vectorError, bridge=bridge, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, syslogStateTrap=syslogStateTrap)
