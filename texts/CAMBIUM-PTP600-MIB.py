...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTableEntry=sNTPServerTableEntry, pubStatsGroup=pubStatsGroup, syslogState=syslogState, searchState=searchState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, channelBandwidth=channelBandwidth, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogClient=syslogClient, reset=reset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryptionGroup=encryptionGroup, telecomsChannelSelection=telecomsChannelSelection, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarms=alarms, tDDControl=tDDControl, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, userRole=userRole, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryption=encryption, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableNumber=dfsTableNumber, channelBLoopback=channelBLoopback, sNTPServerStatus=sNTPServerStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, telnetPortNumber=telnetPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, phyStatusGroup=phyStatusGroup, tDDControlGroup=tDDControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, licence=licence, sNMPTrapTable=sNMPTrapTable, ptp600=ptp600, targetRange=targetRange, bridge=bridge, systemReset=systemReset, ethernetGroup=ethernetGroup, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, userPassword=userPassword, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, installStatus=installStatus, dfsTable=dfsTable, transmitPower=transmitPower, bootVersion=bootVersion, phyControlGroup=phyControlGroup, l2CPPriorityTable=l2CPPriorityTable, telecomsInterface=telecomsInterface, secondarySoftwareVersion=secondarySoftwareVersion, managementGroup=managementGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, productVariant=productVariant, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sntp=sntp, antennaGain=antennaGain, sNTPServerTableNumber=sNTPServerTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPEnabledTraps=sNMPEnabledTraps, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, securityLevel=securityLevel, iPDSCPPriorityTable=iPDSCPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, groupID=groupID, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, receivePower=receivePower, linkName=linkName, dfsTableIndex=dfsTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, telecomsChannelAStatus=telecomsChannelAStatus, ptpCompliance=ptpCompliance, accessMethod=accessMethod, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, rawReceivePower=rawReceivePower, versions=versions, ethernetPriorityTable=ethernetPriorityTable, sNMPPortNumber=sNMPPortNumber, dfsGroup=dfsGroup, transmitFreqMHz=transmitFreqMHz, localPacketFiltering=localPacketFiltering, bandwidthVariant=bandwidthVariant, iPv4Address=iPv4Address, sNTPServerTimeout=sNTPServerTimeout, encryptionAlgorithm=encryptionAlgorithm, bridgeGroup=bridgeGroup, iPVersion=iPVersion, channelACableLength=channelACableLength, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, userTable=userTable, channelBCableLength=channelBCableLength, receiveFreqKHz=receiveFreqKHz, sNTPServerTableIndex=sNTPServerTableIndex, userTableNumber=userTableNumber, qOSPriorityScheme=qOSPriorityScheme, cableLoss=cableLoss, incompatibleRegionCodes=incompatibleRegionCodes, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, channelBLineCode=channelBLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, systemClock=systemClock, frequencyVariant=frequencyVariant, licenceGroup=licenceGroup, iPv6GatewayAddress=iPv6GatewayAddress, managementMode=managementMode, sMTPEmailAlert=sMTPEmailAlert, sNMPv3Enable=sNMPv3Enable, latitude=latitude, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, linkLoss=linkLoss, ethernet=ethernet, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelALoopback=channelALoopback, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, telecomGroup=telecomGroup, userName=userName, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarmsGroup=alarmsGroup, dfsMeans=dfsMeans, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogClientTrap=syslogClientTrap, remoteInternetAddressType=remoteInternetAddressType, syslogControlGroup=syslogControlGroup, channelALineCode=channelALineCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkModeOptimisation=linkModeOptimisation, aAAControlGroup=aAAControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, syslogControl=syslogControl, management=management, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, iPv6Address=iPv6Address, signalStrengthRatio=signalStrengthRatio, telnetAccessEnabled=telnetAccessEnabled, managementPortStatus=managementPortStatus, automaticTxPowerControl=automaticTxPowerControl, sNTPState=sNTPState, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configurationGroup=configurationGroup, userTableEntry=userTableEntry, txColorCode=txColorCode, rxColorCode=rxColorCode, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableIndex=ethernetPriorityTableIndex, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableEntry=dfsTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementVID=vLANManagementVID, resetGroup=resetGroup, eIRP=eIRP, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsPeaks=dfsPeaks, remoteRxTargetPower=remoteRxTargetPower, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableIndex=userTableIndex, dataPortStatusTrap=dataPortStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControl=snmpControl, managementPortDisabledWarning=managementPortDisabledWarning, range=range, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, installArmStateTrap=installArmStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rangingMode=rangingMode, receiveChannel=receiveChannel, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, managementPortStatusTrap=managementPortStatusTrap, softwareVersion=softwareVersion, smtp=smtp, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTable=sNTPServerTable, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, transmitModulationMode=transmitModulationMode, supplementaryGroup=supplementaryGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCodeTrap=regionCodeTrap, aAAControl=aAAControl, dataPortStatus=dataPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, mPLSTCPriorityTable=mPLSTCPriorityTable, targetMACAddress=targetMACAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, longitude=longitude, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, transmitChannel=transmitChannel, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dSCPManagementPriority=dSCPManagementPriority, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationModeDetail=receiveModulationModeDetail, iPv6PrefixLength=iPv6PrefixLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddress=remoteInternetAddress, productName=productName, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPollInterval=sNTPPollInterval, channelALoopbackTrap=channelALoopbackTrap, hTTPPortNumber=hTTPPortNumber, byteErrorRatio=byteErrorRatio, dfs=dfs, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, phyStatus=phyStatus, ptpGroups=ptpGroups, supplementary=supplementary, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, sNTPSync=sNTPSync, installArmState=installArmState, hTTPAccessEnabled=hTTPAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, subnetMask=subnetMask, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoMdix=dataPortAutoMdix)
