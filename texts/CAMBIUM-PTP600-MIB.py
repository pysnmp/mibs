...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", encryption=encryption, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, searchState=searchState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClient=syslogClient, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatus=phyStatus, channelACableLength=channelACableLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, productVariant=productVariant, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableIndex=sNTPServerTableIndex, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBCableLength=channelBCableLength, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationMode=receiveModulationMode, ptmp=ptmp, supplementary=supplementary, channelALineCode=channelALineCode, frequencyVariant=frequencyVariant, sNTPSyncTrap=sNTPSyncTrap, range=range, telecomsInterface=telecomsInterface, dfsPeaks=dfsPeaks, telecomsChannelSelection=telecomsChannelSelection, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryptionGroup=encryptionGroup, smtpGroup=smtpGroup, receivePower=receivePower, automaticTxPowerControl=automaticTxPowerControl, userPassword=userPassword, pubStatsGroup=pubStatsGroup, ethernetBridgingStatus=ethernetBridgingStatus, regionCodeTrap=regionCodeTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, antennaGain=antennaGain, userName=userName, iPv6PrefixLength=iPv6PrefixLength, systemClock=systemClock, installArmStateTrap=installArmStateTrap, transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, userRole=userRole, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, eIRP=eIRP, installStatus=installStatus, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bridgeGroup=bridgeGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxColorCode=rxColorCode, hTTPPortNumber=hTTPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStats=pubStats, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, resetGroup=resetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveChannel=receiveChannel, sNMPPortNumber=sNMPPortNumber, telecomsChannelAStatus=telecomsChannelAStatus, signalStrengthRatio=signalStrengthRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, linkLoss=linkLoss, qOSPriorityScheme=qOSPriorityScheme, receiveFreqKHz=receiveFreqKHz, managementPortDisabledWarning=managementPortDisabledWarning, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogControlGroup=syslogControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, latitude=latitude, telecom=telecom, versions=versions, transmitDataRate=transmitDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, dfsMeans=dfsMeans, tDDControl=tDDControl, ethernetGroup=ethernetGroup, linkSymmetry=linkSymmetry, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, bridge=bridge, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, sNTPState=sNTPState, ptp=ptp, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, snmpControl=snmpControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, groupID=groupID, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, transmitFreqKHz=transmitFreqKHz, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, securityLevel=securityLevel, sNMPTrapTableNumber=sNMPTrapTableNumber, targetRange=targetRange, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelBStatus=telecomsChannelBStatus, regionCode=regionCode, dfsTableNumber=dfsTableNumber, ethernetPriorityTable=ethernetPriorityTable, licence=licence, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, dfs=dfs, telecomGroup=telecomGroup, bootVersion=bootVersion, sNTPServerTableEntry=sNTPServerTableEntry, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, syslogState=syslogState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortFiberStatusTrap=dataPortFiberStatusTrap, versionsGroup=versionsGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sntp=sntp, linkName=linkName, iPVersion=iPVersion, dataPortStatus=dataPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernet=ethernet, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogStateTrap=syslogStateTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangingMode=rangingMode, ptpTraps=ptpTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, cambium=cambium, transmitChannel=transmitChannel, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTable=sNTPServerTable, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, channelALoopbackTrap=channelALoopbackTrap, aAAControlGroup=aAAControlGroup, secureModeAlarm=secureModeAlarm, ethernetFiberSupport=ethernetFiberSupport, dfsTable=dfsTable, targetMACAddress=targetMACAddress, installArmState=installArmState, managementMode=managementMode, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBLineCode=channelBLineCode, l2CPPriorityTable=l2CPPriorityTable, ptp600=ptp600, phyControl=phyControl, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, alarms=alarms, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv4Address=iPv4Address, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, sNTPLastSync=sNTPLastSync, dataPortFiberStatus=dataPortFiberStatus, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, longitude=longitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableIndex=userTableIndex, aggregateDataRate=aggregateDataRate, sNTPServerStatus=sNTPServerStatus, phyControlGroup=phyControlGroup, managementGroup=managementGroup, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, remoteRxTargetPower=remoteRxTargetPower, userTableNumber=userTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vectorError=vectorError, altitude=altitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelALoopback=channelALoopback, management=management, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteInternetAddress=remoteInternetAddress, managementPortStatusTrap=managementPortStatusTrap, sNTPPollInterval=sNTPPollInterval, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hardwareVersion=hardwareVersion, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, reset=reset, remoteInternetAddressType=remoteInternetAddressType, configuration=configuration, telnetAccessEnabled=telnetAccessEnabled, txColorCode=txColorCode, channelBLoopbackTrap=channelBLoopbackTrap, rawReceivePower=rawReceivePower, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, dfsTableIndex=dfsTableIndex, managementPortStatus=managementPortStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBLoopback=channelBLoopback, sNTPServerTimeout=sNTPServerTimeout, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerRetries=sNTPServerRetries, channelBandwidth=channelBandwidth, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimisation=linkModeOptimisation, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, ptpGroups=ptpGroups)
