...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installStatusTrap=installStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableEntry=sNTPServerTableEntry, transmitModulationMode=transmitModulationMode, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTable=sNTPServerTable, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementPriority=vLANManagementPriority, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPCommunityString=sNMPCommunityString, productName=productName, sntpGroup=sntpGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, mPLSTCPriorityTable=mPLSTCPriorityTable, daylightSaving=daylightSaving, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, telnetPortNumber=telnetPortNumber, ptmp=ptmp, rangingMode=rangingMode, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortStatusTrap=managementPortStatusTrap, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortStatus=managementPortStatus, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, iPv6Address=iPv6Address, channelALineCode=channelALineCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, transmitPower=transmitPower, dSCPManagementPriority=dSCPManagementPriority, channelALoopbackTrap=channelALoopbackTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, vLANManagementVID=vLANManagementVID, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, configurationGroup=configurationGroup, tDDControl=tDDControl, userTableNumber=userTableNumber, range=range, linkModeOptimisation=linkModeOptimisation, snmpControlGroup=snmpControlGroup, receiveFreqMHz=receiveFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTimeout=sNTPServerTimeout, dataPortConfigurationMismatch=dataPortConfigurationMismatch, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, alarms=alarms, dataPortDisabledWarning=dataPortDisabledWarning, telecomsInterface=telecomsInterface, cambium=cambium, sNTPPollInterval=sNTPPollInterval, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, channelChangeTrap=channelChangeTrap, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, sNTPSyncTrap=sNTPSyncTrap, hAZLOCConfiguration=hAZLOCConfiguration, txColorCode=txColorCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, dfsGroup=dfsGroup, iPv6PrefixLength=iPv6PrefixLength, vectorError=vectorError, phyStatusGroup=phyStatusGroup, iPVersion=iPVersion, sNTPServerStatus=sNTPServerStatus, latitude=latitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licence=licence, sMTPEmailAlert=sMTPEmailAlert, linkLoss=linkLoss, versions=versions, targetMACAddress=targetMACAddress, siteName=siteName, bandwidthVariant=bandwidthVariant, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, reset=reset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, securityLevel=securityLevel, linkSymmetry=linkSymmetry, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerIPAddress=sNTPServerIPAddress, ptp600=ptp600, longitude=longitude, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernet=ethernet, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, channelBLoopbackTrap=channelBLoopbackTrap, snmpControl=snmpControl, automaticTxPowerControl=automaticTxPowerControl, telnetAccessEnabled=telnetAccessEnabled, aAAControl=aAAControl, transmitFreqKHz=transmitFreqKHz, sNMPTrapPortNumber=sNMPTrapPortNumber, userTable=userTable, ptpCompliance=ptpCompliance, aAAControlGroup=aAAControlGroup, receiveDataRate=receiveDataRate, bridge=bridge, sNMPTrapTableNumber=sNMPTrapTableNumber, userEnabled=userEnabled, telecomsChannelSelection=telecomsChannelSelection, receiveChannel=receiveChannel, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, encryption=encryption, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerTableNumber=sNTPServerTableNumber, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, dfsMeans=dfsMeans, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, eIRP=eIRP, searchState=searchState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtp=smtp, cableLoss=cableLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configuration=configuration, userName=userName, syslogState=syslogState, management=management, hTTPSPortNumber=hTTPSPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, regionCode=regionCode, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSync=sNTPSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPPortNumber=hTTPPortNumber, notificationsGroup=notificationsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTable=l2CPPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomGroup=telecomGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntp=sntp, transmitChannel=transmitChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp=ptp, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, remoteInternetAddressType=remoteInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServer=sNTPPrimaryServer, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarmsGroup=alarmsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, localPacketFiltering=localPacketFiltering, accessMethod=accessMethod, receivePower=receivePower, subnetMask=subnetMask, telecom=telecom, systemClock=systemClock, timeZone=timeZone, ptpTraps=ptpTraps, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, dataPortStatusTrap=dataPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBLoopback=channelBLoopback, transmitDataRate=transmitDataRate, userPassword=userPassword, licenceGroup=licenceGroup, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, antennaGain=antennaGain, telecomsChannelAStatus=telecomsChannelAStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCodeTrap=regionCodeTrap, rxColorCode=rxColorCode, qOSPriorityScheme=qOSPriorityScheme, hardwareVersion=hardwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBCableLength=channelBCableLength, supplementary=supplementary, pubStatsGroup=pubStatsGroup, targetRange=targetRange, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteRxTargetPower=remoteRxTargetPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, channelACableLength=channelACableLength, rawReceivePower=rawReceivePower, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bootVersion=bootVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapVersion=sNMPTrapVersion, resetGroup=resetGroup, sNTPServerTableIndex=sNTPServerTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, managementMode=managementMode, ethernetBridgingAvailability=ethernetBridgingAvailability, dfs=dfs, dataPortFiberStatus=dataPortFiberStatus, dfsTable=dfsTable, channelBLineCode=channelBLineCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelALoopback=channelALoopback, transmitFreqMHz=transmitFreqMHz, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableIndex=dfsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, frequencyVariant=frequencyVariant)
