...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receivePower=receivePower, resetGroup=resetGroup, ptpCompliance=ptpCompliance, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapVersion=sNMPTrapVersion, vLANManagementPriority=vLANManagementPriority, receiveFreqMHz=receiveFreqMHz, ethernetPriorityTable=ethernetPriorityTable, versions=versions, reset=reset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userName=userName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telnetPortNumber=telnetPortNumber, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, PYSNMP_MODULE_ID=cambium, installArmState=installArmState, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControl=syslogControl, transmitPower=transmitPower, tDDSynchronizationMode=tDDSynchronizationMode, sNTPState=sNTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, secureModeAlarm=secureModeAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBandwidth=channelBandwidth, ethernetGroup=ethernetGroup, rxColorCode=rxColorCode, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, remoteRxTargetPower=remoteRxTargetPower, sNTPLastSync=sNTPLastSync, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, supplementary=supplementary, ptp600=ptp600, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bridge=bridge, licenceGroup=licenceGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableIndex=sNTPServerTableIndex, telecomGroup=telecomGroup, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, phyControlGroup=phyControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetBridgingStatus=ethernetBridgingStatus, configurationGroup=configurationGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, vectorError=vectorError, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, dfs=dfs, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPPortNumber=sNMPPortNumber, managementMode=managementMode, channelBLineCode=channelBLineCode, telecomsInterface=telecomsInterface, syslogClientTrap=syslogClientTrap, antennaGain=antennaGain, licence=licence, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, gatewayIPAddress=gatewayIPAddress, supplementaryGroup=supplementaryGroup, installStatus=installStatus, receiveFreqKHz=receiveFreqKHz, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveChannel=receiveChannel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTable=dfsTable, smtpGroup=smtpGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, sntpGroup=sntpGroup, timeZone=timeZone, channelACableLength=channelACableLength, secureModeAlarmTrap=secureModeAlarmTrap, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, syslogState=syslogState, encryptionGroup=encryptionGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControl=aAAControl, remoteInternetAddress=remoteInternetAddress, range=range, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, notificationsGroup=notificationsGroup, linkSymmetry=linkSymmetry, rawReceivePower=rawReceivePower, transmitChannel=transmitChannel, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, userTableNumber=userTableNumber, channelALineCode=channelALineCode, longitude=longitude, transmitModulationMode=transmitModulationMode, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatus=dataPortFiberStatus, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableLoss=cableLoss, managementPortStatus=managementPortStatus, targetMACAddress=targetMACAddress, productName=productName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTimeout=sNTPServerTimeout, linkName=linkName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aAAControlGroup=aAAControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, userRole=userRole, ptpTraps=ptpTraps, channelBCableLength=channelBCableLength, iPv6Address=iPv6Address, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControl=phyControl, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, searchState=searchState, transmitFreqKHz=transmitFreqKHz, iPv4Address=iPv4Address, localPacketFiltering=localPacketFiltering, userEnabled=userEnabled, pubStatsGroup=pubStatsGroup, vLANManagementVID=vLANManagementVID, eIRP=eIRP, tDDControl=tDDControl, telecomsChannelSelection=telecomsChannelSelection, sNTPServerStatus=sNTPServerStatus, bridgeGroup=bridgeGroup, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, bandwidthVariant=bandwidthVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerTableEntry=sNTPServerTableEntry, sMTPEmailAlert=sMTPEmailAlert, hTTPAccessEnabled=hTTPAccessEnabled, snmpControlGroup=snmpControlGroup, installStatusTrap=installStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpGroups=ptpGroups, linkModeOptimisation=linkModeOptimisation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, installArmStateTrap=installArmStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, targetRange=targetRange, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTable=userTable, l2CPPriorityTable=l2CPPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCodeTrap=regionCodeTrap, hTTPPortNumber=hTTPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, sNTPPrimaryServer=sNTPPrimaryServer, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsGroup=dfsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, pubStats=pubStats, sNTPSync=sNTPSync, telecom=telecom, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, channelChangeTrap=channelChangeTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, channelALoopback=channelALoopback, sNMPCommunityString=sNMPCommunityString, regionCode=regionCode, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapTable=sNMPTrapTable, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telnetAccessEnabled=telnetAccessEnabled, securityLevel=securityLevel, dfsMeans=dfsMeans, hTTPSAccessEnabled=hTTPSAccessEnabled, groupID=groupID, dataPortStatusTrap=dataPortStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortStatusTrap=managementPortStatusTrap, sNTPServerTable=sNTPServerTable, rangingMode=rangingMode, managementPortDisabledWarning=managementPortDisabledWarning, ptmp=ptmp, phyStatus=phyStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, cambium=cambium, dataPortAutoMdix=dataPortAutoMdix, txColorCode=txColorCode, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableEntry=userTableEntry, transmitFreqMHz=transmitFreqMHz, sNTPServerIPAddress=sNTPServerIPAddress, subnetMask=subnetMask, encryption=encryption, linkLoss=linkLoss, sntp=sntp, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hAZLOCConfiguration=hAZLOCConfiguration, receiveModulationMode=receiveModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", qOSPriorityScheme=qOSPriorityScheme, iPv6GatewayAddress=iPv6GatewayAddress, alarmsGroup=alarmsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBLoopback=channelBLoopback, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, remoteInternetAddressType=remoteInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, phyStatusGroup=phyStatusGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6PrefixLength=iPv6PrefixLength, channelALoopbackTrap=channelALoopbackTrap, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerIPAddress=sMTPServerIPAddress, byteErrorRatio=byteErrorRatio, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, sNMPv3Enable=sNMPv3Enable, hardwareVersion=hardwareVersion, userPassword=userPassword, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, incompatibleRegionCodes=incompatibleRegionCodes, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, altitude=altitude, receiveDataRate=receiveDataRate, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, ptp=ptp, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup)
