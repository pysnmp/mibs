...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vLANManagementPriority=vLANManagementPriority, bootVersion=bootVersion, channelBLoopbackTrap=channelBLoopbackTrap, dfs=dfs, linkLoss=linkLoss, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, licenceGroup=licenceGroup, sntp=sntp, ptpTraps=ptpTraps, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, smtpGroup=smtpGroup, l2CPPriorityTable=l2CPPriorityTable, versions=versions, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionGroup=encryptionGroup, userTable=userTable, channelACableLength=channelACableLength, channelBCableLength=channelBCableLength, sNTPSync=sNTPSync, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, userName=userName, tDDControlGroup=tDDControlGroup, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, localPacketFiltering=localPacketFiltering, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, linkSymmetry=linkSymmetry, range=range, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, managementGroup=managementGroup, automaticTxPowerControl=automaticTxPowerControl, sNTPPollInterval=sNTPPollInterval, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, timeZone=timeZone, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPState=sNTPState, resetGroup=resetGroup, tDDSynchronizationMode=tDDSynchronizationMode, versionsGroup=versionsGroup, txColorCode=txColorCode, syslogControlGroup=syslogControlGroup, ptpCompliance=ptpCompliance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelALoopback=channelALoopback, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, channelBLoopback=channelBLoopback, sNTPServerStatus=sNTPServerStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, groupID=groupID, productName=productName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecomGroup=telecomGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortStatusTrap=managementPortStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, phyStatus=phyStatus, userTableEntry=userTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, altitude=altitude, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, rawReceivePower=rawReceivePower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteIPAddress=remoteIPAddress, telecom=telecom, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, gatewayIPAddress=gatewayIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableEntry=sNTPServerTableEntry, bridge=bridge, targetRange=targetRange, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installArmStateTrap=installArmStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, iPv6PrefixLength=iPv6PrefixLength, configurationGroup=configurationGroup, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, pubStats=pubStats, dfsTable=dfsTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, eIRP=eIRP, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, daylightSaving=daylightSaving, supplementary=supplementary, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatus=telecomsChannelBStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatus=installStatus, ethernetBridgingStatus=ethernetBridgingStatus, alarms=alarms, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitDataRate=transmitDataRate, managementPortStatus=managementPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryption=encryption, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, siteName=siteName, hAZLOCConfiguration=hAZLOCConfiguration, configuration=configuration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userTableNumber=userTableNumber, phyControl=phyControl, dataPortStatus=dataPortStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, receiveChannel=receiveChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTable=sNTPServerTable, cambium=cambium, remoteInternetAddress=remoteInternetAddress, dfsTableEntry=dfsTableEntry, subnetMask=subnetMask, channelALineCode=channelALineCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteRxTargetPower=remoteRxTargetPower, transmitModulationMode=transmitModulationMode, syslogClient=syslogClient, ptp=ptp, supplementaryGroup=supplementaryGroup, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, telecomsInterface=telecomsInterface, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, channelBLineCode=channelBLineCode, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, sNMPv3Enable=sNMPv3Enable, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, ptp600=ptp600, aAAControl=aAAControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, ethernet=ethernet, accessMethod=accessMethod, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, reset=reset, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, installStatusTrap=installStatusTrap, rxColorCode=rxColorCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementMode=managementMode, qOSPriorityScheme=qOSPriorityScheme, frequencyVariant=frequencyVariant, phyControlGroup=phyControlGroup, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, securityLevel=securityLevel, searchState=searchState, regionCodeTrap=regionCodeTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bridgeGroup=bridgeGroup, smtp=smtp, systemReset=systemReset, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimisation=linkModeOptimisation, rangingMode=rangingMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementVID=vLANManagementVID, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, sNTPServerTimeout=sNTPServerTimeout, dataPortAutoMdix=dataPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, sNMPCommunityString=sNMPCommunityString, sNTPLastSync=sNTPLastSync, management=management, aAAControlGroup=aAAControlGroup, byteErrorRatio=byteErrorRatio, longitude=longitude, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelAStatus=telecomsChannelAStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, licence=licence, sNMPTrapTable=sNMPTrapTable, transmitFreqMHz=transmitFreqMHz, dfsMeans=dfsMeans, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vectorError=vectorError, channelALoopbackTrap=channelALoopbackTrap, iPv6Address=iPv6Address, transmitPower=transmitPower, tDDControl=tDDControl, iPv4Address=iPv4Address, productVariant=productVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, sNTPServerTableNumber=sNTPServerTableNumber, receiveFreqKHz=receiveFreqKHz, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, userRole=userRole, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsPeaks=dfsPeaks)
