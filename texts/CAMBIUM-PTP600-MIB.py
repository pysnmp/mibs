...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:13:36 2021
...
IpAddress, ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, NotificationType, Unsigned32, Counter32, Counter64, enterprises, Gauge32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter32", "Counter64", "enterprises", "Gauge32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hAZLOCConfiguration=hAZLOCConfiguration, configurationGroup=configurationGroup, bandwidthVariant=bandwidthVariant, latitude=latitude, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, bridgeGroup=bridgeGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogClient=syslogClient, channelBCableLength=channelBCableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSPortNumber=hTTPSPortNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, txColorCode=txColorCode, alarmsGroup=alarmsGroup, bootVersion=bootVersion, tDDSynchronizationMode=tDDSynchronizationMode, securityLevel=securityLevel, targetRange=targetRange, telecomGroup=telecomGroup, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, installStatus=installStatus, searchState=searchState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, iPv4Address=iPv4Address, siteName=siteName, reset=reset, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, installStatusTrap=installStatusTrap, dfsTable=dfsTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitPower=transmitPower, encryptionAlgorithm=encryptionAlgorithm, antennaGain=antennaGain, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, bridge=bridge, supplementary=supplementary, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, userTableEntry=userTableEntry, iPv6Address=iPv6Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveModulationMode=receiveModulationMode, masterSlaveMode=masterSlaveMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, versionsGroup=versionsGroup, userRole=userRole, l2CPPriorityTableNumber=l2CPPriorityTableNumber, versions=versions, cableLoss=cableLoss, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptpCompliance=ptpCompliance, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, range=range, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secureModeAlarm=secureModeAlarm, dataPortAutoMdix=dataPortAutoMdix, smtpGroup=smtpGroup, iPv6GatewayAddress=iPv6GatewayAddress, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rawReceivePower=rawReceivePower, userTableIndex=userTableIndex, installArmStateTrap=installArmStateTrap, pubStatsGroup=pubStatsGroup, altitude=altitude, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, sNMPTrapTable=sNMPTrapTable, sNTPPrimaryServer=sNTPPrimaryServer, channelALoopbackTrap=channelALoopbackTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangingMode=rangingMode, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsPeaks=dfsPeaks, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfs=dfs, aAAControl=aAAControl, sNTPSync=sNTPSync, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPState=sNTPState, channelBLineCode=channelBLineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, systemClock=systemClock, dfsTableEntry=dfsTableEntry, receiveChannel=receiveChannel, sNTPServerTable=sNTPServerTable, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, accessMethod=accessMethod, sNTPServerInternetAddress=sNTPServerInternetAddress, systemReset=systemReset, telecomsChannelAStatus=telecomsChannelAStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementGroup=managementGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userPassword=userPassword, phyStatus=phyStatus, ptpGroups=ptpGroups, receivePower=receivePower, transmitModulationMode=transmitModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControlGroup=syslogControlGroup, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPSyncTrap=sNTPSyncTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, unitOutOfCalibration=unitOutOfCalibration, localPacketFiltering=localPacketFiltering, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementPriority=vLANManagementPriority, dfsTableIndex=dfsTableIndex, ptp=ptp, tDDControl=tDDControl, ethernetBridgingStatus=ethernetBridgingStatus, regionCode=regionCode, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortStatus=managementPortStatus, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, snmpControlGroup=snmpControlGroup, regionCodeTrap=regionCodeTrap, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, tFTPServerIPAddress=tFTPServerIPAddress, ptpTraps=ptpTraps, channelALoopback=channelALoopback, sNTPServerTableEntry=sNTPServerTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, snmpControl=snmpControl, userTable=userTable, frequencyVariant=frequencyVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptmp=ptmp, timeZone=timeZone, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVID=vLANManagementVID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, licenceGroup=licenceGroup, groupID=groupID, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configuration=configuration, telecomsChannelSelection=telecomsChannelSelection, sNTPServerTimeout=sNTPServerTimeout, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionGroup=encryptionGroup, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, ptp600=ptp600, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBLoopback=channelBLoopback, linkLoss=linkLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortDisabledWarning=managementPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveModulationModeDetail=receiveModulationModeDetail, notificationsGroup=notificationsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, vectorError=vectorError, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, receiveDataRate=receiveDataRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogControl=syslogControl, dataPortStatus=dataPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTable=ethernetPriorityTable, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, PYSNMP_MODULE_ID=cambium, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntp=sntp, sNTPServerStatus=sNTPServerStatus, telecom=telecom, secureModeAlarmTrap=secureModeAlarmTrap, channelBandwidth=channelBandwidth)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecomsInterface=telecomsInterface, channelALineCode=channelALineCode, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTableEntry=ethernetPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, licence=licence, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, managementPortStatusTrap=managementPortStatusTrap, tDDControlGroup=tDDControlGroup, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxColorCode=rxColorCode, ethernet=ethernet, managementMode=managementMode, linkModeOptimisation=linkModeOptimisation, sNMPCommunityString=sNMPCommunityString, management=management, productVariant=productVariant, dfsTableNumber=dfsTableNumber, receiveFreqMHz=receiveFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aggregateDataRate=aggregateDataRate, iPVersion=iPVersion, userEnabled=userEnabled, resetGroup=resetGroup, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, installArmState=installArmState, channelACableLength=channelACableLength, hTTPAccessEnabled=hTTPAccessEnabled, signalStrengthRatio=signalStrengthRatio, phyControl=phyControl, dfsGroup=dfsGroup, telecomsChannelBStatus=telecomsChannelBStatus, qOSPriorityScheme=qOSPriorityScheme, transmitDataRate=transmitDataRate, targetMACAddress=targetMACAddress, longitude=longitude, alarms=alarms, remoteInternetAddress=remoteInternetAddress, subnetMask=subnetMask, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
