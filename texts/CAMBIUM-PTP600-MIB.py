...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", eIRP=eIRP, sNMPTrapTable=sNMPTrapTable, management=management, installStatusTrap=installStatusTrap, supplementaryGroup=supplementaryGroup, installArmStateTrap=installArmStateTrap, qOSPriorityScheme=qOSPriorityScheme, sntp=sntp, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTableEntry=dfsTableEntry, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licence=licence, ptp=ptp, remoteIPAddress=remoteIPAddress, telecomsChannelSelection=telecomsChannelSelection, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, smtp=smtp, supplementary=supplementary, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimisation=linkModeOptimisation, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, masterSlaveMode=masterSlaveMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, receiveModulationMode=receiveModulationMode, searchState=searchState, userRole=userRole, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userEnabled=userEnabled, bridgeGroup=bridgeGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyControlGroup=phyControlGroup, dfsPeaks=dfsPeaks, transmitChannel=transmitChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, secureModeAlarmTrap=secureModeAlarmTrap, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, ptp600=ptp600, dataPortDisabledWarning=dataPortDisabledWarning, regionCodeTrap=regionCodeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTableNumber=userTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6Address=iPv6Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rawReceivePower=rawReceivePower, systemReset=systemReset, altitude=altitude, iPVersion=iPVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatus=ethernetBridgingStatus, remoteInternetAddress=remoteInternetAddress, userName=userName, userTable=userTable, cableLoss=cableLoss, txColorCode=txColorCode, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, syslogControl=syslogControl, mPLSTCPriorityTable=mPLSTCPriorityTable, byteErrorRatio=byteErrorRatio, sNTPServerTableIndex=sNTPServerTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, gatewayIPAddress=gatewayIPAddress, telnetPortNumber=telnetPortNumber, telecomGroup=telecomGroup, receiveModulationModeDetail=receiveModulationModeDetail, userTableIndex=userTableIndex, channelACableLength=channelACableLength, ethernetFiberSupport=ethernetFiberSupport, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortStatus=managementPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, hAZLOCConfiguration=hAZLOCConfiguration, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, rxColorCode=rxColorCode, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, reset=reset, linkLoss=linkLoss, encryption=encryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userPassword=userPassword, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpCompliance=ptpCompliance, alarms=alarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, antennaGain=antennaGain, linkName=linkName, telecomsInterface=telecomsInterface, remoteInternetAddressType=remoteInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, aAAControlGroup=aAAControlGroup, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, managementGroup=managementGroup, channelBandwidth=channelBandwidth, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelAStatus=telecomsChannelAStatus, remoteRxTargetPower=remoteRxTargetPower, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDControlGroup=tDDControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, daylightSaving=daylightSaving, channelALineCode=channelALineCode, syslogClient=syslogClient, configuration=configuration, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, frequencyVariant=frequencyVariant, sNTPState=sNTPState, encryptionGroup=encryptionGroup, sNTPPollInterval=sNTPPollInterval, latitude=latitude, syslogState=syslogState, managementMode=managementMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, localPacketFiltering=localPacketFiltering, versionsGroup=versionsGroup, hTTPPortNumber=hTTPPortNumber, channelBCableLength=channelBCableLength, iPv6PrefixLength=iPv6PrefixLength, dfsTableNumber=dfsTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, groupID=groupID, sNTPServerTimeout=sNTPServerTimeout, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, signalStrengthRatio=signalStrengthRatio, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, dfs=dfs, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogClientTrap=syslogClientTrap, dfsGroup=dfsGroup, resetGroup=resetGroup, syslogControlGroup=syslogControlGroup, userTableEntry=userTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, installArmState=installArmState, longitude=longitude, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, sNTPSync=sNTPSync, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, targetRange=targetRange, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rangingMode=rangingMode, bridge=bridge, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBLineCode=channelBLineCode, sntpGroup=sntpGroup, systemClock=systemClock, siteName=siteName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, cambium=cambium, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, installStatus=installStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsMeans=dfsMeans, dataPortFiberStatusTrap=dataPortFiberStatusTrap, channelBLoopback=channelBLoopback)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecom=telecom, telecomsChannelBStatus=telecomsChannelBStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, productName=productName, phyControl=phyControl, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, securityLevel=securityLevel, notificationsGroup=notificationsGroup, dfsTable=dfsTable, l2CPPriorityTable=l2CPPriorityTable, subnetMask=subnetMask, targetMACAddress=targetMACAddress, iPv4Address=iPv4Address, productVariant=productVariant, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpTraps=ptpTraps, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenceGroup=licenceGroup, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, PYSNMP_MODULE_ID=cambium, sNMPv3Enable=sNMPv3Enable, automaticTxPowerControl=automaticTxPowerControl, linkSymmetry=linkSymmetry, ethernetPriorityTable=ethernetPriorityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, channelALoopbackTrap=channelALoopbackTrap, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, dataPortFiberStatus=dataPortFiberStatus, channelALoopback=channelALoopback, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTableIndex=dfsTableIndex, dataPortStatusTrap=dataPortStatusTrap, ptmp=ptmp, versions=versions)
