...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vectorError=vectorError, sNMPPortNumber=sNMPPortNumber, telecomsChannelSelection=telecomsChannelSelection, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimisation=linkModeOptimisation, sMTPServerInternetAddress=sMTPServerInternetAddress, range=range, wirelessLinkAvailability=wirelessLinkAvailability, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, targetMACAddress=targetMACAddress, localPacketFiltering=localPacketFiltering, cableLoss=cableLoss, receiveModulationMode=receiveModulationMode, managementPortStatusTrap=managementPortStatusTrap, resetGroup=resetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, pubStats=pubStats, sNTPServerStatus=sNTPServerStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userTableNumber=userTableNumber, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, searchState=searchState, timeZone=timeZone, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitPower=transmitPower, ethernetGroup=ethernetGroup, telecomGroup=telecomGroup, systemClock=systemClock, ptp=ptp, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, channelALoopbackTrap=channelALoopbackTrap, channelALoopback=channelALoopback, l2CPPriorityTableIndex=l2CPPriorityTableIndex, smtpGroup=smtpGroup, bootVersion=bootVersion, txColorCode=txColorCode, sMTPServerPortNumber=sMTPServerPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerIPAddress=sNTPServerIPAddress, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, antennaGain=antennaGain, rangingMode=rangingMode, reset=reset, aAAControl=aAAControl, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, l2CPPriorityTable=l2CPPriorityTable, encryption=encryption, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, ptpTraps=ptpTraps, tDDControl=tDDControl, dfsPeaks=dfsPeaks, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, frequencyVariant=frequencyVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsInterface=telecomsInterface, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteInternetAddressType=remoteInternetAddressType, syslogStateTrap=syslogStateTrap, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, rxColorCode=rxColorCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementMode=managementMode, licence=licence, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, hTTPAccessEnabled=hTTPAccessEnabled, phyStatusGroup=phyStatusGroup, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, softwareVersion=softwareVersion, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapVersion=sNMPTrapVersion, userName=userName, encryptionAlgorithm=encryptionAlgorithm, targetRange=targetRange, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortStatus=dataPortStatus, altitude=altitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, configurationGroup=configurationGroup, channelALineCode=channelALineCode, transmitChannel=transmitChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, sNTPServerRetries=sNTPServerRetries, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelACableLength=channelACableLength, dfs=dfs, userTable=userTable, dfsGroup=dfsGroup, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hAZLOCConfiguration=hAZLOCConfiguration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerTable=sNTPServerTable, channelBCableLength=channelBCableLength, siteName=siteName, userTableEntry=userTableEntry, alarmsGroup=alarmsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementGroup=managementGroup, iPv4Address=iPv4Address, dataPortWirelessDownAlert=dataPortWirelessDownAlert, qOSPriorityScheme=qOSPriorityScheme, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, unitOutOfCalibration=unitOutOfCalibration, managementPortStatus=managementPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dSCPManagementPriority=dSCPManagementPriority, byteErrorRatio=byteErrorRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSync=sNTPSync, iPDSCPPriorityTable=iPDSCPPriorityTable, sntpGroup=sntpGroup, telnetAccessEnabled=telnetAccessEnabled, regionCodeTrap=regionCodeTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionGroup=encryptionGroup, subnetMask=subnetMask, pubStatsGroup=pubStatsGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementVID=vLANManagementVID, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, transmitDataRate=transmitDataRate, linkName=linkName, alarms=alarms, telecomsChannelAStatus=telecomsChannelAStatus, syslogState=syslogState, bridgeGroup=bridgeGroup, userTableIndex=userTableIndex, ptmp=ptmp, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, systemReset=systemReset, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sntp=sntp, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, phyControl=phyControl, linkLoss=linkLoss, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, dfsTableNumber=dfsTableNumber, installStatus=installStatus, sNTPServerTimeout=sNTPServerTimeout, phyStatus=phyStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, groupID=groupID, syslogClientTrap=syslogClientTrap, accessMethod=accessMethod, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bridge=bridge, channelBLineCode=channelBLineCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPVersion=iPVersion, tFTPServerIPAddress=tFTPServerIPAddress, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPollInterval=sNTPPollInterval, iPv6PrefixLength=iPv6PrefixLength, transmitModulationMode=transmitModulationMode, rawReceivePower=rawReceivePower, installStatusTrap=installStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTable=sNMPTrapTable, bandwidthVariant=bandwidthVariant, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableIndex=sNTPServerTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, ptp600=ptp600, dataPortAutoMdix=dataPortAutoMdix, productName=productName, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, ptpCompliance=ptpCompliance, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementary=supplementary, secureModeAlarmTrap=secureModeAlarmTrap, iPv6Address=iPv6Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTableNumber=sNTPServerTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableEntry=dfsTableEntry, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, management=management, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelChangeTrap=channelChangeTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecom=telecom, smtp=smtp, channelBLoopback=channelBLoopback, latitude=latitude, dataPortFiberStatus=dataPortFiberStatus, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, productVariant=productVariant, managementPortDisabledWarning=managementPortDisabledWarning, installArmStateTrap=installArmStateTrap, versions=versions, userRole=userRole, syslogControlGroup=syslogControlGroup, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, automaticTxPowerControl=automaticTxPowerControl, vLANManagementPriority=vLANManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, eIRP=eIRP, secureModeAlarm=secureModeAlarm, securityLevel=securityLevel, ethernetPriorityTable=ethernetPriorityTable, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync)
