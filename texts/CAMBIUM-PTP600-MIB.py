...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogControl=syslogControl, channelBCableLength=channelBCableLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTableIndex=userTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControl=tDDControl, ptp600=ptp600, dfsMeans=dfsMeans, aAAControl=aAAControl, telecomGroup=telecomGroup, latitude=latitude, syslogControlGroup=syslogControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControlGroup=snmpControlGroup, targetRange=targetRange, hAZLOCConfiguration=hAZLOCConfiguration, receiveFreqMHz=receiveFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licence=licence, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installStatus=installStatus, phyStatus=phyStatus, versions=versions, managementMode=managementMode, rawReceivePower=rawReceivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, localPacketFiltering=localPacketFiltering, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelALoopback=channelALoopback, wirelessLinkAvailability=wirelessLinkAvailability, dfs=dfs, sNTPServerRetries=sNTPServerRetries, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, transmitPower=transmitPower, sNTPServerTableEntry=sNTPServerTableEntry, userEnabled=userEnabled, systemReset=systemReset, tDDControlGroup=tDDControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPSyncTrap=sNTPSyncTrap, iPv6PrefixLength=iPv6PrefixLength, aggregateDataRate=aggregateDataRate, ethernetBridgingStatus=ethernetBridgingStatus, ethernetFiberSupport=ethernetFiberSupport, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, unitOutOfCalibration=unitOutOfCalibration, reset=reset, phyControlGroup=phyControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, productVariant=productVariant, userTable=userTable, telecomsChannelAStatus=telecomsChannelAStatus, telecomsChannelSelection=telecomsChannelSelection, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogClientTrap=syslogClientTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, phyControl=phyControl, tFTPServerInternetAddress=tFTPServerInternetAddress, channelALoopbackTrap=channelALoopbackTrap, resetGroup=resetGroup, bootVersion=bootVersion, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, sNTPServerTimeout=sNTPServerTimeout, ethernet=ethernet, iPv4Address=iPv4Address, gatewayIPAddress=gatewayIPAddress, configuration=configuration, linkName=linkName, siteName=siteName, telecomsInterface=telecomsInterface, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sntp=sntp, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, notificationsGroup=notificationsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBLineCode=channelBLineCode, channelACableLength=channelACableLength, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteRxTargetPower=remoteRxTargetPower, dataPortDisabledWarning=dataPortDisabledWarning, management=management, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, daylightSaving=daylightSaving, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPVersion=iPVersion, rxColorCode=rxColorCode, dfsPeaks=dfsPeaks, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cambium=cambium, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, wirelessLinkStatus=wirelessLinkStatus, longitude=longitude, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, sNTPSync=sNTPSync, sNTPPrimaryServer=sNTPPrimaryServer, productName=productName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, securityLevel=securityLevel, receivePower=receivePower, receiveChannel=receiveChannel, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, dSCPManagementPriority=dSCPManagementPriority, transmitFreqKHz=transmitFreqKHz, sNMPv3Enable=sNMPv3Enable, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6Address=iPv6Address, qOSPriorityScheme=qOSPriorityScheme, rangingMode=rangingMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, linkSymmetry=linkSymmetry, channelALineCode=channelALineCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableIndex=dfsTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, managementGroup=managementGroup, versionsGroup=versionsGroup, iPv6GatewayAddress=iPv6GatewayAddress, remoteInternetAddress=remoteInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, receiveFreqKHz=receiveFreqKHz, smtpGroup=smtpGroup, accessMethod=accessMethod, remoteInternetAddressType=remoteInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatus=dataPortStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, aAAControlGroup=aAAControlGroup, linkLoss=linkLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelChangeTrap=channelChangeTrap, sNTPServerTable=sNTPServerTable, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, timeZone=timeZone, managementPortStatus=managementPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, managementPortStatusTrap=managementPortStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, sNTPServerStatus=sNTPServerStatus, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitFreqMHz=transmitFreqMHz, secureModeAlarm=secureModeAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogState=syslogState, receiveModulationMode=receiveModulationMode, eIRP=eIRP, ptpGroups=ptpGroups, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, channelBLoopbackTrap=channelBLoopbackTrap, sNTPState=sNTPState, alarmsGroup=alarmsGroup, dfsTableNumber=dfsTableNumber, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, sNMPTrapVersion=sNMPTrapVersion, encryptionAlgorithm=encryptionAlgorithm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, sntpGroup=sntpGroup, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, txColorCode=txColorCode, encryption=encryption, hTTPPortNumber=hTTPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortConfigurationMismatch=dataPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, automaticTxPowerControl=automaticTxPowerControl, dataPortFiberStatus=dataPortFiberStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimisation=linkModeOptimisation, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, smtp=smtp, maximumTransmitPower=maximumTransmitPower, installStatusTrap=installStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus, l2CPPriorityTable=l2CPPriorityTable, syslogClient=syslogClient, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridge=bridge, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userRole=userRole, subnetMask=subnetMask, sMTPServerInternetAddress=sMTPServerInternetAddress, alarms=alarms, bridgeGroup=bridgeGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTable=ethernetPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTable=sNMPTrapTable, bandwidthVariant=bandwidthVariant, byteErrorRatio=byteErrorRatio, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, vLANManagementVID=vLANManagementVID, telecomsChannelBStatus=telecomsChannelBStatus, dfsGroup=dfsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitChannel=transmitChannel, channelBLoopback=channelBLoopback, ptmp=ptmp)
