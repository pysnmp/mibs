...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBCableLength=channelBCableLength, regionCode=regionCode, installStatus=installStatus, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, ethernetGroup=ethernetGroup, managementGroup=managementGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userName=userName, snmpControl=snmpControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBandwidth=channelBandwidth, ptp600=ptp600, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, ptp=ptp, hTTPPortNumber=hTTPPortNumber, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, linkName=linkName, targetMACAddress=targetMACAddress, range=range, subnetMask=subnetMask, productName=productName, linkSymmetry=linkSymmetry, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, userTableEntry=userTableEntry, qOSPriorityScheme=qOSPriorityScheme, frequencyVariant=frequencyVariant, installArmState=installArmState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSPortNumber=hTTPSPortNumber, automaticTxPowerControl=automaticTxPowerControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userTableIndex=userTableIndex, dataPortStatusTrap=dataPortStatusTrap, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cambium=cambium, sNMPPortNumber=sNMPPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, installStatusTrap=installStatusTrap, configuration=configuration, versionsGroup=versionsGroup, dfsPeaks=dfsPeaks, tDDControl=tDDControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, alarmsGroup=alarmsGroup, telecomsChannelBStatus=telecomsChannelBStatus, dSCPManagementPriority=dSCPManagementPriority, sNMPv3Enable=sNMPv3Enable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, sNTPServerTableEntry=sNTPServerTableEntry, channelBLineCode=channelBLineCode, iPVersion=iPVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userTable=userTable, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, telecom=telecom, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, dfsTable=dfsTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rawReceivePower=rawReceivePower, sNTPServerPortNumber=sNTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitDataRate=transmitDataRate, iPv4Address=iPv4Address, resetGroup=resetGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, dfs=dfs, channelACableLength=channelACableLength, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsInterface=telecomsInterface, channelALoopback=channelALoopback, daylightSaving=daylightSaving, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bootVersion=bootVersion, syslogControlGroup=syslogControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelALineCode=channelALineCode, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, phyControl=phyControl, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelAStatus=telecomsChannelAStatus, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTable=sNMPTrapTable, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, receivePower=receivePower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortStatusTrap=managementPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementaryGroup=supplementaryGroup, managementMode=managementMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, cableLoss=cableLoss, managementPortStatus=managementPortStatus, aAAControl=aAAControl, ptpGroups=ptpGroups, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userEnabled=userEnabled, syslogState=syslogState, antennaGain=antennaGain, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, smtpGroup=smtpGroup, reset=reset, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, txColorCode=txColorCode, alarms=alarms, channelChangeTrap=channelChangeTrap, channelALoopbackTrap=channelALoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, userTableNumber=userTableNumber, dfsTableNumber=dfsTableNumber, telecomsChannelSelection=telecomsChannelSelection, hAZLOCConfiguration=hAZLOCConfiguration, sntp=sntp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyStatusGroup=phyStatusGroup, sNTPServerTable=sNTPServerTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, rxColorCode=rxColorCode, transmitFreqMHz=transmitFreqMHz, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, bridge=bridge, managementPortDisabledWarning=managementPortDisabledWarning, installArmStateTrap=installArmStateTrap, remoteInternetAddress=remoteInternetAddress, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, licence=licence, targetRange=targetRange, ethernet=ethernet, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingStatus=ethernetBridgingStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, softwareVersion=softwareVersion, secureModeAlarmTrap=secureModeAlarmTrap, configurationGroup=configurationGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSync=sNTPSync, bridgeGroup=bridgeGroup, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, userRole=userRole, encryptionGroup=encryptionGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsGroup=dfsGroup, licenceGroup=licenceGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, accessMethod=accessMethod, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsMeans=dfsMeans, tDDSynchronizationStatus=tDDSynchronizationStatus, secureModeAlarm=secureModeAlarm, byteErrorRatio=byteErrorRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveChannel=receiveChannel, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTimeout=sNTPServerTimeout, groupID=groupID, eIRP=eIRP, sNTPServerTableNumber=sNTPServerTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerIPAddress=sMTPServerIPAddress, securityLevel=securityLevel, sNTPServerIPAddress=sNTPServerIPAddress, syslogClient=syslogClient, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, encryption=encryption, remoteIPAddress=remoteIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControlGroup=tDDControlGroup, systemClock=systemClock, management=management)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPrimaryServer=sNTPPrimaryServer, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, timeZone=timeZone, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveFreqMHz=receiveFreqMHz, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSyncTrap=sNTPSyncTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogControl=syslogControl, sNTPServerRetries=sNTPServerRetries, channelBLoopback=channelBLoopback, aAAControlGroup=aAAControlGroup, siteName=siteName, vLANManagementVID=vLANManagementVID, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, rangingMode=rangingMode, telnetAccessEnabled=telnetAccessEnabled, sNTPServerStatus=sNTPServerStatus, transmitChannel=transmitChannel, versions=versions, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6Address=iPv6Address, latitude=latitude, syslogClientTrap=syslogClientTrap, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, systemReset=systemReset, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, localPacketFiltering=localPacketFiltering, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower)
