...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", configurationGroup=configurationGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, qOSPriorityScheme=qOSPriorityScheme, bootVersion=bootVersion, syslogClient=syslogClient, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, sNTPServerRetries=sNTPServerRetries, secureModeAlarmTrap=secureModeAlarmTrap, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTableIndex=l2CPPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, alarms=alarms, smtpGroup=smtpGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, phyStatusGroup=phyStatusGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxColorCode=rxColorCode, managementPortStatus=managementPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, latitude=latitude, transmitFreqKHz=transmitFreqKHz, iPv6PrefixLength=iPv6PrefixLength, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, sntp=sntp, vLANManagementVID=vLANManagementVID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPv3Enable=sNMPv3Enable, wirelessLinkAvailability=wirelessLinkAvailability, dfsGroup=dfsGroup, snmpControl=snmpControl, dataPortStatus=dataPortStatus, telecomsChannelBStatus=telecomsChannelBStatus, securityLevel=securityLevel, installStatusTrap=installStatusTrap, maximumTransmitPower=maximumTransmitPower, range=range, dSCPManagementPriority=dSCPManagementPriority, dfsTable=dfsTable, antennaGain=antennaGain, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, txColorCode=txColorCode, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetRange=targetRange, linkName=linkName, ptpCompliance=ptpCompliance, iPv6GatewayAddress=iPv6GatewayAddress, altitude=altitude, cambium=cambium, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableNumber=dfsTableNumber, secureModeAlarm=secureModeAlarm, targetMACAddress=targetMACAddress, managementGroup=managementGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receiveDataRate=receiveDataRate, syslogState=syslogState, automaticTxPowerControl=automaticTxPowerControl, rangingMode=rangingMode, sMTPEnabledMessages=sMTPEnabledMessages, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortStatusTrap=managementPortStatusTrap, tDDControl=tDDControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, encryptionGroup=encryptionGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, dataPortFiberStatus=dataPortFiberStatus, syslogControlGroup=syslogControlGroup, sNTPServerTable=sNTPServerTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapVersion=sNMPTrapVersion, sMTPServerPortNumber=sMTPServerPortNumber, channelALoopbackTrap=channelALoopbackTrap, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTraps=ptpTraps, siteName=siteName, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPLastSync=sNTPLastSync, telecom=telecom, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPSPortNumber=hTTPSPortNumber, channelBandwidth=channelBandwidth, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, transmitFreqMHz=transmitFreqMHz, regionCodeTrap=regionCodeTrap, dfsTableEntry=dfsTableEntry, transmitDataRate=transmitDataRate, supplementaryGroup=supplementaryGroup, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, ethernet=ethernet, aAAControl=aAAControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, bridgeGroup=bridgeGroup, ethernetBridgingStatus=ethernetBridgingStatus, channelACableLength=channelACableLength, receiveChannel=receiveChannel, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, aAAControlGroup=aAAControlGroup, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, longitude=longitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationMode=receiveModulationMode, encryptionAlgorithm=encryptionAlgorithm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, versions=versions, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBLoopbackTrap=channelBLoopbackTrap, managementPortDisabledWarning=managementPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBLoopback=channelBLoopback, channelALoopback=channelALoopback, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitPower=transmitPower, iPv6Address=iPv6Address, channelBCableLength=channelBCableLength, sNMPTrapTable=sNMPTrapTable, ethernetPriorityTable=ethernetPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsPeaks=dfsPeaks, sMTPEmailAlert=sMTPEmailAlert, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogStateTrap=syslogStateTrap, phyControlGroup=phyControlGroup, receivePower=receivePower, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, smtp=smtp, licenceGroup=licenceGroup, remoteInternetAddress=remoteInternetAddress, frequencyVariant=frequencyVariant, vectorError=vectorError, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, productName=productName, eIRP=eIRP, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, configuration=configuration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelALineCode=channelALineCode, channelChangeTrap=channelChangeTrap, hAZLOCConfiguration=hAZLOCConfiguration, encryption=encryption, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, groupID=groupID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, ptp600=ptp600, receiveFreqMHz=receiveFreqMHz, userName=userName, iPDSCPPriorityTable=iPDSCPPriorityTable, regionCode=regionCode, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, l2CPPriorityTableEntry=l2CPPriorityTableEntry, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, bridge=bridge, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, userTableEntry=userTableEntry, userPassword=userPassword, pubStatsGroup=pubStatsGroup, productVariant=productVariant, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, supplementary=supplementary, systemReset=systemReset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, vLANManagementPriority=vLANManagementPriority, userRole=userRole, syslogControl=syslogControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPState=sNTPState, remoteRxTargetPower=remoteRxTargetPower, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelSelection=telecomsChannelSelection, snmpControlGroup=snmpControlGroup, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelAStatus=telecomsChannelAStatus, sNMPCommunityString=sNMPCommunityString)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", byteErrorRatio=byteErrorRatio, licence=licence, resetGroup=resetGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerPortNumber=tFTPServerPortNumber, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, dfsMeans=dfsMeans, sNTPServerTableNumber=sNTPServerTableNumber, channelBLineCode=channelBLineCode, hTTPPortNumber=hTTPPortNumber, sNMPPortNumber=sNMPPortNumber, iPVersion=iPVersion, sNTPPrimaryServer=sNTPPrimaryServer, syslogClientTrap=syslogClientTrap, l2CPPriorityTable=l2CPPriorityTable, receiveFreqKHz=receiveFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv4Address=iPv4Address, transmitModulationMode=transmitModulationMode, userTable=userTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetGroup=ethernetGroup, dfs=dfs, management=management, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableIndex=userTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, accessMethod=accessMethod, sNTPSync=sNTPSync, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installArmStateTrap=installArmStateTrap, managementMode=managementMode)
