...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTable=l2CPPriorityTable, installStatus=installStatus, sNTPPrimaryServer=sNTPPrimaryServer, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitDataRate=transmitDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelALoopbackTrap=channelALoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp=ptp, sNTPServerRetries=sNTPServerRetries, managementGroup=managementGroup, groupID=groupID, telecomsChannelAStatus=telecomsChannelAStatus, siteName=siteName, telecom=telecom, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userPassword=userPassword, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerTimeout=sNTPServerTimeout, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, linkName=linkName, sNTPSync=sNTPSync, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, phyStatus=phyStatus, userTableIndex=userTableIndex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, hardwareVersion=hardwareVersion, linkSymmetry=linkSymmetry, telecomsChannelBStatus=telecomsChannelBStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, receivePower=receivePower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, longitude=longitude, rxColorCode=rxColorCode, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, dfsTable=dfsTable, hTTPAccessEnabled=hTTPAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPSyncTrap=sNTPSyncTrap, userTableEntry=userTableEntry, txColorCode=txColorCode, hAZLOCConfiguration=hAZLOCConfiguration, channelBLineCode=channelBLineCode, aAAControl=aAAControl, iPv6PrefixLength=iPv6PrefixLength, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernet=ethernet, frequencyVariant=frequencyVariant, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, maximumTransmitPower=maximumTransmitPower, transmitFreqKHz=transmitFreqKHz, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelALoopback=channelALoopback, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, management=management, ethernetBridgingAvailability=ethernetBridgingAvailability, latitude=latitude, bridgeGroup=bridgeGroup, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortFiberStatus=dataPortFiberStatus, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableNumber=dfsTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogState=syslogState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryption=encryption, userTable=userTable, bridge=bridge, iPv6Address=iPv6Address, ptpTrapPrefix=ptpTrapPrefix, ptp600=ptp600, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, configurationGroup=configurationGroup, accessMethod=accessMethod, timeZone=timeZone, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, channelACableLength=channelACableLength, ptpGroups=ptpGroups, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDControl=tDDControl, dataPortAutoMdix=dataPortAutoMdix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, subnetMask=subnetMask, targetRange=targetRange, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableNumber=userTableNumber, sNTPServerStatus=sNTPServerStatus, PYSNMP_MODULE_ID=cambium, sNTPServerTable=sNTPServerTable, phyControl=phyControl, supplementary=supplementary, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogClient=syslogClient, softwareVersion=softwareVersion, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, channelBLoopback=channelBLoopback, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelSelection=telecomsChannelSelection, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, range=range, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, syslogControlGroup=syslogControlGroup, alarms=alarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, securityLevel=securityLevel, transmitChannel=transmitChannel, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, sMTPEmailAlert=sMTPEmailAlert, receiveFreqMHz=receiveFreqMHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, snmpControlGroup=snmpControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, tDDControlGroup=tDDControlGroup, remoteInternetAddress=remoteInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bandwidthVariant=bandwidthVariant, rangingMode=rangingMode, linkLoss=linkLoss, channelBLoopbackTrap=channelBLoopbackTrap, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALineCode=channelALineCode, sNTPState=sNTPState, searchState=searchState, syslogStateTrap=syslogStateTrap, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, managementPortStatus=managementPortStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rawReceivePower=rawReceivePower, antennaGain=antennaGain, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, automaticTxPowerControl=automaticTxPowerControl, dfsGroup=dfsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userEnabled=userEnabled, installArmState=installArmState, channelBCableLength=channelBCableLength, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, iPv4Address=iPv4Address, userRole=userRole, receiveChannel=receiveChannel, systemClock=systemClock, dfs=dfs, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, telecomsInterface=telecomsInterface, dSCPManagementPriority=dSCPManagementPriority, receiveModulationMode=receiveModulationMode, sntp=sntp, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, regionCodeTrap=regionCodeTrap, sntpGroup=sntpGroup, secondarySoftwareVersion=secondarySoftwareVersion, licenceGroup=licenceGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, ethernetGroup=ethernetGroup, iPVersion=iPVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, alarmsGroup=alarmsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarm=secureModeAlarm, smtp=smtp, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetBridgingStatus=ethernetBridgingStatus, regionCode=regionCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, productName=productName, sMTPServerInternetAddress=sMTPServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, snmpControl=snmpControl, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, telnetAccessEnabled=telnetAccessEnabled, smtpGroup=smtpGroup, cambium=cambium, remoteIPAddress=remoteIPAddress, byteErrorRatio=byteErrorRatio, localPacketFiltering=localPacketFiltering, installStatusTrap=installStatusTrap, altitude=altitude, qOSPriorityScheme=qOSPriorityScheme, phyControlGroup=phyControlGroup, reset=reset, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubStats=pubStats)
