...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:45:29 2021
...
Counter32, MibIdentifier, NotificationType, IpAddress, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, enterprises, Gauge32, ModuleIdentity, Unsigned32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "NotificationType", "IpAddress", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "enterprises", "Gauge32", "ModuleIdentity", "Unsigned32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsChannelAStatus=telecomsChannelAStatus, syslogClient=syslogClient, ethernetPriorityTable=ethernetPriorityTable, targetRange=targetRange, telecom=telecom, dfsTableIndex=dfsTableIndex, iPv6PrefixLength=iPv6PrefixLength, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secondarySoftwareVersion=secondarySoftwareVersion, searchState=searchState, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, smtpGroup=smtpGroup, tDDControlGroup=tDDControlGroup, PYSNMP_MODULE_ID=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteIPAddress=remoteIPAddress, syslogControl=syslogControl, syslogControlGroup=syslogControlGroup, managementMode=managementMode, bandwidthVariant=bandwidthVariant, linkName=linkName, receivePower=receivePower, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsGroup=dfsGroup, vectorError=vectorError, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatusTrap=installStatusTrap, supplementary=supplementary, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, txColorCode=txColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rxColorCode=rxColorCode, dataPortFiberStatus=dataPortFiberStatus, iPVersion=iPVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptmp=ptmp, sNMPTrapPortNumber=sNMPTrapPortNumber, userPassword=userPassword, systemReset=systemReset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableNumber=sNTPServerTableNumber, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, dataPortStatus=dataPortStatus, automaticTxPowerControl=automaticTxPowerControl, tFTPServerPortNumber=tFTPServerPortNumber, channelBCableLength=channelBCableLength, installStatus=installStatus, dfsTableNumber=dfsTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rawReceivePower=rawReceivePower, dfsTable=dfsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, versionsGroup=versionsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimisation=linkModeOptimisation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDControl=tDDControl, channelALoopbackTrap=channelALoopbackTrap, productName=productName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, incompatibleRegionCodes=incompatibleRegionCodes, channelALoopback=channelALoopback, smtp=smtp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, siteName=siteName, configuration=configuration, licenceGroup=licenceGroup, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, unitOutOfCalibration=unitOutOfCalibration, sNMPPortNumber=sNMPPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versions=versions, sNMPv3Enable=sNMPv3Enable, receiveDataRate=receiveDataRate, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, sNTPPrimaryServer=sNTPPrimaryServer, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarmsGroup=alarmsGroup, ptp=ptp, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBLoopback=channelBLoopback, sNTPServerTimeout=sNTPServerTimeout, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, reset=reset, l2CPPriorityTable=l2CPPriorityTable, cambium=cambium, telnetPortNumber=telnetPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControlGroup=snmpControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogState=syslogState, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerPortNumber=sNTPServerPortNumber, targetMACAddress=targetMACAddress, secureModeAlarm=secureModeAlarm, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkSymmetry=linkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableNumber=userTableNumber, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelBLineCode=channelBLineCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, pubStatsGroup=pubStatsGroup, localPacketFiltering=localPacketFiltering, regionCodeTrap=regionCodeTrap, accessMethod=accessMethod, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatusGroup=phyStatusGroup, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, userName=userName, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, pubStats=pubStats, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptpTrapPrefix=ptpTrapPrefix, ethernet=ethernet, phyControlGroup=phyControlGroup, notificationsGroup=notificationsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitChannel=transmitChannel, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitDataRate=transmitDataRate, altitude=altitude, userEnabled=userEnabled, cableLoss=cableLoss, ethernetFiberSupport=ethernetFiberSupport, hAZLOCConfiguration=hAZLOCConfiguration, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortStatus=managementPortStatus, qOSPriorityScheme=qOSPriorityScheme, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, sNTPServerInternetAddress=sNTPServerInternetAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmStateTrap=installArmStateTrap, sNTPServerRetries=sNTPServerRetries, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetBridgingAvailability=ethernetBridgingAvailability, range=range, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, securityLevel=securityLevel, vLANManagementVID=vLANManagementVID, managementPortDisabledWarning=managementPortDisabledWarning, dfsMeans=dfsMeans, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPv6Address=iPv6Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsChannelSelection=telecomsChannelSelection, hardwareVersion=hardwareVersion, ptpCompliance=ptpCompliance, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, licence=licence, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, longitude=longitude, aAAControl=aAAControl, groupID=groupID, channelALineCode=channelALineCode, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPSync=sNTPSync, latitude=latitude, bridge=bridge, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap, antennaGain=antennaGain, managementPortStatusTrap=managementPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, dataPortDisabledWarning=dataPortDisabledWarning, systemClock=systemClock, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteRxTargetPower=remoteRxTargetPower, transmitFreqMHz=transmitFreqMHz, rangingMode=rangingMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTable=sNTPServerTable, ptpGroups=ptpGroups, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bootVersion=bootVersion, receiveModulationMode=receiveModulationMode, bridgeGroup=bridgeGroup, ptp600=ptp600, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortAutoMdix=dataPortAutoMdix, sMTPServerPortNumber=sMTPServerPortNumber, snmpControl=snmpControl, encryptionGroup=encryptionGroup, iPv4Address=iPv4Address, transmitPower=transmitPower, iPv6GatewayAddress=iPv6GatewayAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetBridgingStatus=ethernetBridgingStatus, receiveChannel=receiveChannel, sMTPEmailAlert=sMTPEmailAlert, sNTPServerStatus=sNTPServerStatus, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationStatus=tDDSynchronizationStatus, userRole=userRole, phyControl=phyControl, channelBandwidth=channelBandwidth, dfs=dfs, channelACableLength=channelACableLength, eIRP=eIRP, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, receiveFreqKHz=receiveFreqKHz, ptpTraps=ptpTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sntp=sntp, configurationGroup=configurationGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, daylightSaving=daylightSaving, encryption=encryption, alarms=alarms, remoteInternetAddress=remoteInternetAddress, sNTPState=sNTPState, resetGroup=resetGroup, transmitFreqKHz=transmitFreqKHz)
