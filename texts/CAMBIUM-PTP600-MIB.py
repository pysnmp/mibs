...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", management=management, sMTPServerIPAddress=sMTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsInterface=telecomsInterface, targetMACAddress=targetMACAddress, resetGroup=resetGroup, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, aggregateDataRate=aggregateDataRate, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBLoopback=channelBLoopback, bandwidthVariant=bandwidthVariant, installStatus=installStatus, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, sNTPServerPortNumber=sNTPServerPortNumber, installArmStateTrap=installArmStateTrap, telecom=telecom, pubStats=pubStats, cableLoss=cableLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, groupID=groupID, sNTPSync=sNTPSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityTable=ethernetPriorityTable, userTableEntry=userTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTable=sNTPServerTable, dfsMeans=dfsMeans, vectorError=vectorError, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelALineCode=channelALineCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rawReceivePower=rawReceivePower, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, sNTPServerTableEntry=sNTPServerTableEntry, dataPortStatus=dataPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, smtp=smtp, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopback=channelALoopback, masterSlaveMode=masterSlaveMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, iPv6Address=iPv6Address, antennaGain=antennaGain, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBCableLength=channelBCableLength, frequencyVariant=frequencyVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, ethernetBridgingStatus=ethernetBridgingStatus, dataPortDisabledWarning=dataPortDisabledWarning, configuration=configuration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, licenceGroup=licenceGroup, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, channelBLineCode=channelBLineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userPassword=userPassword, telnetPortNumber=telnetPortNumber, sNMPCommunityString=sNMPCommunityString, sNTPLastSync=sNTPLastSync, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, phyControlGroup=phyControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, txColorCode=txColorCode, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, iPv6PrefixLength=iPv6PrefixLength, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, range=range, syslogStateTrap=syslogStateTrap, licence=licence, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userName=userName, iPv4Address=iPv4Address, snmpControl=snmpControl, userTableIndex=userTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, receivePower=receivePower, channelBLoopbackTrap=channelBLoopbackTrap, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelBStatus=telecomsChannelBStatus, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, channelChangeTrap=channelChangeTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, linkModeOptimisation=linkModeOptimisation, qOSPriorityScheme=qOSPriorityScheme, sMTPEnabledMessages=sMTPEnabledMessages, dfs=dfs, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitFreqKHz=transmitFreqKHz, supplementary=supplementary, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, encryption=encryption, systemClock=systemClock, dfsTable=dfsTable, iPVersion=iPVersion, supplementaryGroup=supplementaryGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntpGroup=sntpGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableEntry=dfsTableEntry, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, remoteInternetAddress=remoteInternetAddress, channelACableLength=channelACableLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpGroups=ptpGroups, secureModeAlarm=secureModeAlarm, ptpCompliance=ptpCompliance, syslogControlGroup=syslogControlGroup, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerStatus=sNTPServerStatus, hAZLOCConfiguration=hAZLOCConfiguration, automaticTxPowerControl=automaticTxPowerControl, sMTPServerInternetAddress=sMTPServerInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkSymmetry=linkSymmetry, aAAControl=aAAControl, ethernetGroup=ethernetGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, systemReset=systemReset, bridgeGroup=bridgeGroup, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, rangingMode=rangingMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogState=syslogState, dfsPeaks=dfsPeaks, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, receiveModulationModeDetail=receiveModulationModeDetail, receiveDataRate=receiveDataRate, dfsGroup=dfsGroup, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, managementPortStatusTrap=managementPortStatusTrap, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, transmitChannel=transmitChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userEnabled=userEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, snmpControlGroup=snmpControlGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, l2CPPriorityTable=l2CPPriorityTable, telecomsChannelSelection=telecomsChannelSelection, subnetMask=subnetMask, installStatusTrap=installStatusTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTableNumber=sNTPServerTableNumber, telecomGroup=telecomGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetAccessEnabled=telnetAccessEnabled, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControlGroup=aAAControlGroup, phyControl=phyControl, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitDataRate=transmitDataRate, notificationsGroup=notificationsGroup, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, versions=versions, managementPortStatus=managementPortStatus, receiveFreqMHz=receiveFreqMHz, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpTraps=ptpTraps, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatus=wirelessLinkStatus, sNTPPrimaryServer=sNTPPrimaryServer, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelALoopbackTrap=channelALoopbackTrap, linkName=linkName, productName=productName, targetRange=targetRange, bridge=bridge, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableIndex=sNMPTrapTableIndex, sntp=sntp, cambium=cambium, tFTPServerIPAddress=tFTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", securityLevel=securityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortDisabledWarning=managementPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, tDDControl=tDDControl, tFTPServerInternetAddress=tFTPServerInternetAddress, accessMethod=accessMethod, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableIndex=dfsTableIndex, ptp=ptp, siteName=siteName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteIPAddress=remoteIPAddress, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp600=ptp600, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, sNTPServerRetries=sNTPServerRetries, alarms=alarms, longitude=longitude, transmitModulationMode=transmitModulationMode, productVariant=productVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptmp=ptmp, remoteInternetAddressType=remoteInternetAddressType, altitude=altitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, telecomsChannelAStatus=telecomsChannelAStatus, sNTPState=sNTPState, bootVersion=bootVersion, latitude=latitude, receiveChannel=receiveChannel, maximumTransmitPower=maximumTransmitPower, managementMode=managementMode, sNMPTrapTable=sNMPTrapTable, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersion=softwareVersion, secureModeAlarmTrap=secureModeAlarmTrap, rxColorCode=rxColorCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap)
