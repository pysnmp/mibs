...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installStatusTrap=installStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, receiveFreqKHz=receiveFreqKHz, ptp600=ptp600, iPDSCPPriorityTable=iPDSCPPriorityTable, accessMethod=accessMethod, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, telecomsChannelSelection=telecomsChannelSelection, managementMode=managementMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCodeTrap=regionCodeTrap, PYSNMP_MODULE_ID=cambium, transmitFreqKHz=transmitFreqKHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, productName=productName, txColorCode=txColorCode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkModeOptimisation=linkModeOptimisation, automaticTxPowerControl=automaticTxPowerControl, sNMPCommunityString=sNMPCommunityString, ptp=ptp, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, managementPortStatus=managementPortStatus, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsPeaks=dfsPeaks, receiveChannel=receiveChannel, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, sNTPServerStatus=sNTPServerStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpGroups=ptpGroups, regionCode=regionCode, hAZLOCConfiguration=hAZLOCConfiguration, management=management, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, systemClock=systemClock, managementPortDisabledWarning=managementPortDisabledWarning, configurationGroup=configurationGroup, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, transmitFreqMHz=transmitFreqMHz, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDControl=tDDControl, channelALoopback=channelALoopback, channelBLineCode=channelBLineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogStateTrap=syslogStateTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, supplementary=supplementary, wirelessLinkStatus=wirelessLinkStatus, dfsTable=dfsTable, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSyncTrap=sNTPSyncTrap, phyControlGroup=phyControlGroup, softwareVersion=softwareVersion, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkAvailability=wirelessLinkAvailability, cableLoss=cableLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, channelBLoopbackTrap=channelBLoopbackTrap, l2CPPriorityTable=l2CPPriorityTable, sNMPv3Enable=sNMPv3Enable, hTTPAccessEnabled=hTTPAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, dfsTableIndex=dfsTableIndex, ethernetFiberSupport=ethernetFiberSupport, targetRange=targetRange, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, daylightSaving=daylightSaving, iPv6GatewayAddress=iPv6GatewayAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecom=telecom, syslogClient=syslogClient, latitude=latitude, sNMPPortNumber=sNMPPortNumber, iPVersion=iPVersion, vLANManagementVID=vLANManagementVID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, linkSymmetry=linkSymmetry, phyStatus=phyStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, timeZone=timeZone, dataPortStatus=dataPortStatus, telecomGroup=telecomGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, eIRP=eIRP, subnetMask=subnetMask, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogControl=syslogControl, ethernetBridgingStatus=ethernetBridgingStatus, groupID=groupID, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, searchState=searchState, userEnabled=userEnabled, sNTPServerRetries=sNTPServerRetries, tFTPServerIPAddress=tFTPServerIPAddress, syslogControlGroup=syslogControlGroup, dfs=dfs, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, linkLoss=linkLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, resetGroup=resetGroup, alarms=alarms, ethernetPriorityTableNumber=ethernetPriorityTableNumber, longitude=longitude, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmState=installArmState, range=range, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userName=userName, bridge=bridge, hTTPSAccessEnabled=hTTPSAccessEnabled, ptmp=ptmp, sntpGroup=sntpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTable=ethernetPriorityTable, encryption=encryption, ethernetBridgingAvailability=ethernetBridgingAvailability, phyControl=phyControl, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementGroup=managementGroup, gatewayIPAddress=gatewayIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, dfsGroup=dfsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALineCode=channelALineCode, dfsTableEntry=dfsTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, channelACableLength=channelACableLength, masterSlaveMode=masterSlaveMode, vectorError=vectorError, channelChangeTrap=channelChangeTrap, iPv6PrefixLength=iPv6PrefixLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, maximumTransmitPower=maximumTransmitPower, sNTPServerTableIndex=sNTPServerTableIndex, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, hardwareVersion=hardwareVersion, iPv6Address=iPv6Address, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsChannelBStatus=telecomsChannelBStatus, ethernet=ethernet, altitude=altitude, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, installStatus=installStatus, licence=licence, rawReceivePower=rawReceivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dSCPManagementPriority=dSCPManagementPriority, installArmStateTrap=installArmStateTrap, rangingMode=rangingMode, reset=reset, smtp=smtp, secureModeAlarm=secureModeAlarm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenceGroup=licenceGroup, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, configuration=configuration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, telnetPortNumber=telnetPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelBLoopback=channelBLoopback, encryptionGroup=encryptionGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userPassword=userPassword, dfsMeans=dfsMeans, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, channelBCableLength=channelBCableLength, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, productVariant=productVariant, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementPortStatusTrap=managementPortStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sntp=sntp, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, smtpGroup=smtpGroup, antennaGain=antennaGain, userTable=userTable, localPacketFiltering=localPacketFiltering, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rxColorCode=rxColorCode, remoteRxTargetPower=remoteRxTargetPower, transmitChannel=transmitChannel, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, phyStatusGroup=phyStatusGroup, sNTPServerTable=sNTPServerTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bridgeGroup=bridgeGroup, iPv4Address=iPv4Address, securityLevel=securityLevel, receiveDataRate=receiveDataRate, dataPortFiberStatus=dataPortFiberStatus, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, frequencyVariant=frequencyVariant, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogState=syslogState, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, hTTPSPortNumber=hTTPSPortNumber)
