...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitFreqMHz=transmitFreqMHz, rxColorCode=rxColorCode, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, vLANManagementVID=vLANManagementVID, accessMethod=accessMethod, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, ethernetPriorityTable=ethernetPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, telnetPortNumber=telnetPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, regionCode=regionCode, frequencyVariant=frequencyVariant, ptp600=ptp600, sntp=sntp, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configurationGroup=configurationGroup, versionsGroup=versionsGroup, systemReset=systemReset, targetMACAddress=targetMACAddress, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, channelBLineCode=channelBLineCode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableNumber=dfsTableNumber, syslogControl=syslogControl, cableLoss=cableLoss, versions=versions, channelBCableLength=channelBCableLength, linkName=linkName, syslogStateTrap=syslogStateTrap, l2CPPriorityTable=l2CPPriorityTable, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, sMTPEmailAlert=sMTPEmailAlert, dfsPeaks=dfsPeaks, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, reset=reset, ethernetBridgingStatus=ethernetBridgingStatus, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControlGroup=tDDControlGroup, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, channelALoopbackTrap=channelALoopbackTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, channelALoopback=channelALoopback, sNTPState=sNTPState, licenceGroup=licenceGroup, cambium=cambium, automaticTxPowerControl=automaticTxPowerControl, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, sNTPServerTableIndex=sNTPServerTableIndex, receiveDataRate=receiveDataRate, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, rawReceivePower=rawReceivePower, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, altitude=altitude, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, phyStatus=phyStatus, ptmp=ptmp, systemClock=systemClock, mPLSTCPriorityTable=mPLSTCPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, userTable=userTable, phyControl=phyControl, bandwidthVariant=bandwidthVariant, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, dfs=dfs, aAAControl=aAAControl, iPv6PrefixLength=iPv6PrefixLength, hardwareVersion=hardwareVersion, channelBLoopback=channelBLoopback, softwareVersion=softwareVersion, smtp=smtp, receiveFreqKHz=receiveFreqKHz, channelChangeTrap=channelChangeTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, latitude=latitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, management=management, dataPortAutoMdix=dataPortAutoMdix, tDDSynchronizationStatus=tDDSynchronizationStatus, alarmsGroup=alarmsGroup, eIRP=eIRP, iPv6Address=iPv6Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, productVariant=productVariant, supplementary=supplementary, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelAStatus=telecomsChannelAStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortFiberStatus=dataPortFiberStatus, userPassword=userPassword, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, smtpGroup=smtpGroup, subnetMask=subnetMask, sNTPSync=sNTPSync, transmitModulationMode=transmitModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, installArmState=installArmState, bridge=bridge, ptpGroups=ptpGroups, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBandwidth=channelBandwidth, sNTPServerTable=sNTPServerTable, remoteRxTargetPower=remoteRxTargetPower, userName=userName, iPVersion=iPVersion, syslogState=syslogState, longitude=longitude, managementPortStatusTrap=managementPortStatusTrap, phyStatusGroup=phyStatusGroup, receiveFreqMHz=receiveFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, encryptionGroup=encryptionGroup, ptpTraps=ptpTraps, aAAControlGroup=aAAControlGroup, syslogClient=syslogClient, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv4Address=iPv4Address, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, configuration=configuration, sNMPEnabledTraps=sNMPEnabledTraps, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, timeZone=timeZone, qOSPriorityScheme=qOSPriorityScheme, sNTPServerRetries=sNTPServerRetries, licence=licence, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, range=range, channelALineCode=channelALineCode, channelACableLength=channelACableLength, tFTPServerIPAddress=tFTPServerIPAddress, dfsGroup=dfsGroup, dfsMeans=dfsMeans, antennaGain=antennaGain, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, dfsTable=dfsTable, channelBLoopbackTrap=channelBLoopbackTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridgeGroup=bridgeGroup, hAZLOCConfiguration=hAZLOCConfiguration, telecomsInterface=telecomsInterface, vectorError=vectorError, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, hTTPAccessEnabled=hTTPAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecom=telecom, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, ptpCompliance=ptpCompliance, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelSelection=telecomsChannelSelection, securityLevel=securityLevel, targetRange=targetRange, ptp=ptp, transmitPower=transmitPower, receiveChannel=receiveChannel, managementPortStatus=managementPortStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, encryption=encryption, sNTPServerStatus=sNTPServerStatus, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControlGroup=phyControlGroup, syslogClientTrap=syslogClientTrap, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTableNumber=sNTPServerTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, remoteInternetAddressType=remoteInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, dataPortStatus=dataPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, txColorCode=txColorCode, ethernetFiberSupport=ethernetFiberSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, rangingMode=rangingMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, managementMode=managementMode, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, sNTPPrimaryServer=sNTPPrimaryServer, alarms=alarms, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableIndex=userTableIndex, ethernet=ethernet, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, iPv6GatewayAddress=iPv6GatewayAddress, transmitChannel=transmitChannel, userRole=userRole, sNTPServerPortNumber=sNTPServerPortNumber, pubStats=pubStats, masterSlaveMode=masterSlaveMode, groupID=groupID, userEnabled=userEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubStatsGroup=pubStatsGroup)
