...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableNumber=userTableNumber, latitude=latitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, transmitFreqKHz=transmitFreqKHz, telecomGroup=telecomGroup, l2CPPriorityTable=l2CPPriorityTable, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, syslogControl=syslogControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsGroup=dfsGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoMdix=dataPortAutoMdix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableNumber=dfsTableNumber, configuration=configuration, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerStatus=sNTPServerStatus, tDDControl=tDDControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPState=sNTPState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, channelALoopback=channelALoopback, transmitModulationMode=transmitModulationMode, sNTPLastSync=sNTPLastSync, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveDataRate=receiveDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelALoopbackTrap=channelALoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCode=regionCode, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTraps=ptpTraps, softwareVersion=softwareVersion, ptp600=ptp600, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telnetPortNumber=telnetPortNumber, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, sNTPServerTableEntry=sNTPServerTableEntry, channelBCableLength=channelBCableLength, alarmsGroup=alarmsGroup, userName=userName, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTable=sNTPServerTable, rangingMode=rangingMode, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, timeZone=timeZone, hAZLOCConfiguration=hAZLOCConfiguration, localPacketFiltering=localPacketFiltering, dataPortFiberStatus=dataPortFiberStatus, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemClock=systemClock, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, alarms=alarms, ptp=ptp, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, secureModeAlarm=secureModeAlarm, sNMPEnabledTraps=sNMPEnabledTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetBridgingAvailability=ethernetBridgingAvailability, userPassword=userPassword, aAAControl=aAAControl, pubStats=pubStats, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, sNMPTrapTable=sNMPTrapTable, qOSPriorityScheme=qOSPriorityScheme, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, ptpGroups=ptpGroups, rawReceivePower=rawReceivePower, phyControlGroup=phyControlGroup, userRole=userRole, linkModeOptimisation=linkModeOptimisation, channelBandwidth=channelBandwidth, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, range=range, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, bridge=bridge, targetRange=targetRange, sNTPServerTimeout=sNTPServerTimeout, automaticTxPowerControl=automaticTxPowerControl, iPVersion=iPVersion, secureModeAlarmTrap=secureModeAlarmTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementPriority=vLANManagementPriority, antennaGain=antennaGain, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, channelACableLength=channelACableLength, vectorError=vectorError, hTTPSPortNumber=hTTPSPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, dataPortStatusTrap=dataPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, encryption=encryption, groupID=groupID, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, managementGroup=managementGroup, management=management, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomsChannelSelection=telecomsChannelSelection, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licence=licence, receivePower=receivePower, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTable=userTable, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveModulationMode=receiveModulationMode, iPv4Address=iPv4Address, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, sNTPServerIPAddress=sNTPServerIPAddress, channelBLineCode=channelBLineCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, frequencyVariant=frequencyVariant, reset=reset, transmitPower=transmitPower, sNTPSync=sNTPSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, targetMACAddress=targetMACAddress, siteName=siteName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, txColorCode=txColorCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsInterface=telecomsInterface, remoteInternetAddress=remoteInternetAddress, dfsTableEntry=dfsTableEntry, dfsPeaks=dfsPeaks, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, linkName=linkName, versions=versions, ethernetPriorityTableNumber=ethernetPriorityTableNumber, altitude=altitude, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmStateTrap=installArmStateTrap, managementPortStatus=managementPortStatus, ethernetGroup=ethernetGroup, channelBLoopback=channelBLoopback, linkLoss=linkLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, daylightSaving=daylightSaving, iPv6Address=iPv6Address, channelALineCode=channelALineCode, mPLSTCPriorityTable=mPLSTCPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, bridgeGroup=bridgeGroup, tDDControlGroup=tDDControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, supplementaryGroup=supplementaryGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, resetGroup=resetGroup, dfs=dfs, licenceGroup=licenceGroup, rxColorCode=rxColorCode, longitude=longitude, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, phyControl=phyControl, userTableEntry=userTableEntry, gatewayIPAddress=gatewayIPAddress, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatus=installStatus, syslogControlGroup=syslogControlGroup, managementPortStatusTrap=managementPortStatusTrap, receiveChannel=receiveChannel, searchState=searchState, dfsMeans=dfsMeans, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, regionCodeTrap=regionCodeTrap, sNTPPrimaryServer=sNTPPrimaryServer, ethernetBridgingStatus=ethernetBridgingStatus, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, masterSlaveMode=masterSlaveMode, installArmState=installArmState, versionsGroup=versionsGroup, iPv6PrefixLength=iPv6PrefixLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, iPv6GatewayAddress=iPv6GatewayAddress, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClient=syslogClient, productName=productName, securityLevel=securityLevel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPPollInterval=sNTPPollInterval, remoteInternetAddressType=remoteInternetAddressType, dataPortStatus=dataPortStatus, systemReset=systemReset, managementMode=managementMode, dfsTable=dfsTable, telecomsChannelAStatus=telecomsChannelAStatus, aAAControlGroup=aAAControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelChangeTrap=channelChangeTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex)
