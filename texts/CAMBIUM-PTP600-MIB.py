...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:49:37 2021
...
TimeTicks, enterprises, ObjectIdentity, Counter64, Integer32, NotificationType, MibIdentifier, Counter32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "ObjectIdentity", "Counter64", "Integer32", "NotificationType", "MibIdentifier", "Counter32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelChangeTrap=channelChangeTrap, aAAControl=aAAControl, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBCableLength=channelBCableLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, reset=reset, encryptionAlgorithm=encryptionAlgorithm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, siteName=siteName, pubStatsGroup=pubStatsGroup, versionsGroup=versionsGroup, smtpGroup=smtpGroup, dataPortDisabledWarning=dataPortDisabledWarning, installArmState=installArmState, tFTPServerPortNumber=tFTPServerPortNumber, configuration=configuration, sNMPTrapVersion=sNMPTrapVersion, searchState=searchState, targetMACAddress=targetMACAddress, linkName=linkName, userTableEntry=userTableEntry, rxColorCode=rxColorCode, byteErrorRatio=byteErrorRatio, txColorCode=txColorCode, subnetMask=subnetMask, receivePower=receivePower, phyControl=phyControl, tDDSynchronizationStatus=tDDSynchronizationStatus, accessMethod=accessMethod, ptpGroups=ptpGroups, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, localPacketFiltering=localPacketFiltering, signalStrengthRatio=signalStrengthRatio, dataPortAutoMdix=dataPortAutoMdix, ptpCompliance=ptpCompliance, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsMeans=dfsMeans, telecomsChannelBStatus=telecomsChannelBStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, frequencyVariant=frequencyVariant, management=management, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, altitude=altitude, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, channelALineCode=channelALineCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, supplementary=supplementary, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecomGroup=telecomGroup, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, syslogClient=syslogClient, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, bandwidthVariant=bandwidthVariant, regionCode=regionCode, syslogClientTrap=syslogClientTrap, wirelessLinkStatus=wirelessLinkStatus, sntp=sntp, userTable=userTable, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, smtp=smtp, alarmsGroup=alarmsGroup, channelALoopback=channelALoopback, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPv4Address=iPv4Address, linkSymmetry=linkSymmetry, sNTPServerRetries=sNTPServerRetries, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, remoteIPAddress=remoteIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, ptpTraps=ptpTraps, resetGroup=resetGroup, iPv6Address=iPv6Address, aAAControlGroup=aAAControlGroup, systemClock=systemClock, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationMode=receiveModulationMode, vectorError=vectorError, l2CPPriorityTableIndex=l2CPPriorityTableIndex, systemReset=systemReset, sNTPServerStatus=sNTPServerStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, linkLoss=linkLoss, hardwareVersion=hardwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelACableLength=channelACableLength, constantPowerSpectralDensity=constantPowerSpectralDensity, maximumTransmitPower=maximumTransmitPower, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetPortNumber=telnetPortNumber, phyStatus=phyStatus, daylightSaving=daylightSaving, sNMPTrapTableNumber=sNMPTrapTableNumber, userPassword=userPassword, bridgeGroup=bridgeGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, latitude=latitude, versions=versions, range=range, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsTable=dfsTable, userName=userName, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, dfsTableNumber=dfsTableNumber, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cambium=cambium, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTable=sNTPServerTable, syslogState=syslogState, dfs=dfs, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogStateTrap=syslogStateTrap, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, dataPortFiberStatus=dataPortFiberStatus, sNMPPortNumber=sNMPPortNumber, licenceGroup=licenceGroup, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installStatus=installStatus, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitChannel=transmitChannel, productVariant=productVariant, managementPortDisabledWarning=managementPortDisabledWarning, incompatibleRegionCodes=incompatibleRegionCodes, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveChannel=receiveChannel, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, rawReceivePower=rawReceivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptp=ptp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptp600=ptp600, ethernetBridgingStatus=ethernetBridgingStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, qOSPriorityScheme=qOSPriorityScheme, rangingMode=rangingMode, channelBLoopbackTrap=channelBLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, masterSlaveMode=masterSlaveMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsTableIndex=dfsTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsChannelSelection=telecomsChannelSelection, sNTPSync=sNTPSync, receiveFreqKHz=receiveFreqKHz, automaticTxPowerControl=automaticTxPowerControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortStatusTrap=managementPortStatusTrap, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableNumber=sNTPServerTableNumber, remoteInternetAddressType=remoteInternetAddressType, sNTPState=sNTPState, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, iPVersion=iPVersion, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityTable=ethernetPriorityTable, syslogControl=syslogControl, userRole=userRole, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridge=bridge, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitModulationMode=transmitModulationMode, sNTPServerTableEntry=sNTPServerTableEntry, encryption=encryption, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableIndex=sNTPServerTableIndex, channelBLoopback=channelBLoopback, hTTPPortNumber=hTTPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aggregateDataRate=aggregateDataRate, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, dfsGroup=dfsGroup, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortStatus=managementPortStatus, targetRange=targetRange, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, securityLevel=securityLevel, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, pubStats=pubStats, secureModeAlarm=secureModeAlarm, installStatusTrap=installStatusTrap, channelALoopbackTrap=channelALoopbackTrap, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, tDDSynchronizationMode=tDDSynchronizationMode, transmitFreqKHz=transmitFreqKHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, regionCodeTrap=regionCodeTrap, telecom=telecom, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, channelBLineCode=channelBLineCode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementMode=managementMode, linkModeOptimisation=linkModeOptimisation, productName=productName, dfsPeaks=dfsPeaks, gatewayIPAddress=gatewayIPAddress, groupID=groupID, encryptionGroup=encryptionGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber)
