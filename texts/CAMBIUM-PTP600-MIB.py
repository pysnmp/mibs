...
NotificationType, ObjectIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Unsigned32, MibIdentifier, Gauge32, Bits, enterprises, ModuleIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "Gauge32", "Bits", "enterprises", "ModuleIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", alarms=alarms, softwareVersion=softwareVersion, productName=productName, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, syslogControlGroup=syslogControlGroup, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, userTable=userTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTimeout=sNTPServerTimeout, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, installArmStateTrap=installArmStateTrap, vLANManagementPriority=vLANManagementPriority, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, supplementaryGroup=supplementaryGroup, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, aggregateDataRate=aggregateDataRate, dfsGroup=dfsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionGroup=encryptionGroup, l2CPPriorityTable=l2CPPriorityTable, localPacketFiltering=localPacketFiltering, ethernet=ethernet, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, dfsTable=dfsTable, syslogStateTrap=syslogStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, remoteInternetAddress=remoteInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, dfs=dfs, transmitFreqKHz=transmitFreqKHz, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, maximumTransmitPower=maximumTransmitPower, iPv6GatewayAddress=iPv6GatewayAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPrimaryServer=sNTPPrimaryServer, cambium=cambium, ethernetPriorityTable=ethernetPriorityTable, sNTPServerTableEntry=sNTPServerTableEntry, daylightSaving=daylightSaving, phyStatus=phyStatus, receiveChannel=receiveChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, searchState=searchState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitPower=transmitPower, securityLevel=securityLevel, channelACableLength=channelACableLength, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyControl=phyControl, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, userName=userName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, tDDControlGroup=tDDControlGroup, channelBLoopback=channelBLoopback, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, syslogClient=syslogClient, smtpGroup=smtpGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, dataPortStatus=dataPortStatus, dfsPeaks=dfsPeaks, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, latitude=latitude, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, smtp=smtp, hAZLOCConfiguration=hAZLOCConfiguration, txColorCode=txColorCode, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, siteName=siteName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, hardwareVersion=hardwareVersion, sNTPState=sNTPState, receiveDataRate=receiveDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, range=range, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, qOSPriorityScheme=qOSPriorityScheme, sntpGroup=sntpGroup, dSCPManagementPriority=dSCPManagementPriority, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, reset=reset, dataPortFiberStatus=dataPortFiberStatus, rawReceivePower=rawReceivePower, ptpTrapPrefix=ptpTrapPrefix, rangingMode=rangingMode, configurationGroup=configurationGroup, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, linkSymmetry=linkSymmetry, frequencyVariant=frequencyVariant, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telnetPortNumber=telnetPortNumber, telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementMode=managementMode, userRole=userRole, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, secureModeAlarmTrap=secureModeAlarmTrap, userTableEntry=userTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubStats=pubStats, licenceGroup=licenceGroup, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, bridge=bridge, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, bridgeGroup=bridgeGroup, sNTPServerTable=sNTPServerTable, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteInternetAddressType=remoteInternetAddressType, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryption=encryption, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingAvailability=ethernetBridgingAvailability, ptp=ptp, dataPortDisabledWarning=dataPortDisabledWarning, phyControlGroup=phyControlGroup, configuration=configuration, linkLoss=linkLoss, iPv6Address=iPv6Address, hTTPPortNumber=hTTPPortNumber, aAAControl=aAAControl, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimisation=linkModeOptimisation, ethernetBridgingStatus=ethernetBridgingStatus, systemClock=systemClock, iPv6PrefixLength=iPv6PrefixLength, remoteIPAddress=remoteIPAddress, channelALoopback=channelALoopback, sNTPServerTableNumber=sNTPServerTableNumber, encryptionAlgorithm=encryptionAlgorithm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, channelChangeTrap=channelChangeTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, groupID=groupID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, channelALineCode=channelALineCode, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, sNTPServerRetries=sNTPServerRetries, userPassword=userPassword, syslogState=syslogState, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, licence=licence, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv4Address=iPv4Address, incompatibleRegionCodes=incompatibleRegionCodes, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, altitude=altitude, sNTPSync=sNTPSync, hTTPSPortNumber=hTTPSPortNumber, ptpCompliance=ptpCompliance, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, longitude=longitude, alarmsGroup=alarmsGroup, notificationsGroup=notificationsGroup, linkName=linkName, managementPortStatus=managementPortStatus, targetRange=targetRange, dfsTableIndex=dfsTableIndex, iPVersion=iPVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerStatus=sNTPServerStatus, bootVersion=bootVersion, rxColorCode=rxColorCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, secureModeAlarm=secureModeAlarm, channelBLoopbackTrap=channelBLoopbackTrap, channelBCableLength=channelBCableLength, receiveModulationMode=receiveModulationMode, ptp600=ptp600, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortStatusTrap=managementPortStatusTrap, transmitChannel=transmitChannel)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortDisabledWarning=managementPortDisabledWarning, installArmState=installArmState, sNTPServerInternetAddress=sNTPServerInternetAddress, regionCode=regionCode, telecomGroup=telecomGroup, sntp=sntp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vLANManagementVID=vLANManagementVID, sNMPTrapTableIndex=sNMPTrapTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, management=management, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTable=sNMPTrapTable, transmitFreqMHz=transmitFreqMHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBLineCode=channelBLineCode, targetMACAddress=targetMACAddress, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTableNumber=userTableNumber, resetGroup=resetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, cableLoss=cableLoss, sMTPEnabledMessages=sMTPEnabledMessages, channelALoopbackTrap=channelALoopbackTrap, telecom=telecom, systemReset=systemReset, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDControl=tDDControl)
