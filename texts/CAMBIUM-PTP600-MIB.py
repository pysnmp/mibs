...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, configurationGroup=configurationGroup, rangingMode=rangingMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hardwareVersion=hardwareVersion, channelALoopbackTrap=channelALoopbackTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPVersion=iPVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, masterSlaveMode=masterSlaveMode, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveDataRate=receiveDataRate, resetGroup=resetGroup, ethernetPriorityTable=ethernetPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, timeZone=timeZone, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, sNMPv3Enable=sNMPv3Enable, syslogControlGroup=syslogControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bridgeGroup=bridgeGroup, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerIPAddress=tFTPServerIPAddress, range=range, sNTPPollInterval=sNTPPollInterval, telecomGroup=telecomGroup, syslogControl=syslogControl, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatus=phyStatus, iPv4Address=iPv4Address, channelALoopback=channelALoopback, versionsGroup=versionsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBLineCode=channelBLineCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, localPacketFiltering=localPacketFiltering, tDDControlGroup=tDDControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, linkSymmetry=linkSymmetry, altitude=altitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortFiberStatus=dataPortFiberStatus, dfsTable=dfsTable, userName=userName, sNTPPrimaryServer=sNTPPrimaryServer, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarm=secureModeAlarm, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, dfsTableNumber=dfsTableNumber, automaticTxPowerControl=automaticTxPowerControl, productName=productName, sNTPSync=sNTPSync, phyControl=phyControl, dataPortStatus=dataPortStatus, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, reset=reset, hAZLOCConfiguration=hAZLOCConfiguration, userTableIndex=userTableIndex, syslogState=syslogState, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitDataRate=transmitDataRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, snmpControl=snmpControl, sNTPSyncTrap=sNTPSyncTrap, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, bridge=bridge, ethernet=ethernet, productVariant=productVariant, searchState=searchState, managementPortStatus=managementPortStatus, notificationsGroup=notificationsGroup, phyControlGroup=phyControlGroup, sNTPServerStatus=sNTPServerStatus, iPv6PrefixLength=iPv6PrefixLength, versions=versions, iPv6Address=iPv6Address, ethernetFiberSupport=ethernetFiberSupport, alarms=alarms, userTableNumber=userTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, vLANManagementVID=vLANManagementVID, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, telecom=telecom, dfs=dfs, transmitPower=transmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, bootVersion=bootVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, smtpGroup=smtpGroup, secondarySoftwareVersion=secondarySoftwareVersion, targetRange=targetRange, longitude=longitude, PYSNMP_MODULE_ID=cambium, ptp=ptp, encryptionGroup=encryptionGroup, dfsGroup=dfsGroup, hTTPSPortNumber=hTTPSPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, securityLevel=securityLevel, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, syslogClient=syslogClient, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, management=management, cambium=cambium, systemReset=systemReset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, siteName=siteName, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableIndex=sNTPServerTableIndex, txColorCode=txColorCode, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerIPAddress=sMTPServerIPAddress, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError, daylightSaving=daylightSaving, rawReceivePower=rawReceivePower, dfsTableIndex=dfsTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerPortNumber=sMTPServerPortNumber, encryption=encryption, gatewayIPAddress=gatewayIPAddress, userRole=userRole, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, telecomsInterface=telecomsInterface, transmitFreqMHz=transmitFreqMHz, managementPortStatusTrap=managementPortStatusTrap, channelBCableLength=channelBCableLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, telecomsChannelSelection=telecomsChannelSelection, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userPassword=userPassword, accessMethod=accessMethod, remoteInternetAddressType=remoteInternetAddressType, latitude=latitude, channelBLoopback=channelBLoopback, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, ethernetBridgingStatus=ethernetBridgingStatus, remoteInternetAddress=remoteInternetAddress, bandwidthVariant=bandwidthVariant, sNTPServerIPAddress=sNTPServerIPAddress, sntp=sntp, alarmsGroup=alarmsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpTraps=ptpTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTableEntry=userTableEntry, installStatusTrap=installStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetBridgingAvailability=ethernetBridgingAvailability, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, sNTPLastSync=sNTPLastSync, constantPowerSpectralDensity=constantPowerSpectralDensity, dSCPManagementPriority=dSCPManagementPriority, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, aggregateDataRate=aggregateDataRate, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, configuration=configuration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, systemClock=systemClock, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", groupID=groupID, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telnetPortNumber=telnetPortNumber, remoteRxTargetPower=remoteRxTargetPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortDisabledWarning=dataPortDisabledWarning, ptpCompliance=ptpCompliance, linkModeOptimisation=linkModeOptimisation, eIRP=eIRP, licence=licence, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, licenceGroup=licenceGroup, sNTPServerTable=sNTPServerTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelACableLength=channelACableLength, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptp600=ptp600, tDDControl=tDDControl, channelALineCode=channelALineCode, encryptionAlgorithm=encryptionAlgorithm, rxColorCode=rxColorCode, incompatibleRegionCodes=incompatibleRegionCodes, targetMACAddress=targetMACAddress, managementMode=managementMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userEnabled=userEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, frequencyVariant=frequencyVariant, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoMdix=dataPortAutoMdix, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTimeout=sNTPServerTimeout, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap)
