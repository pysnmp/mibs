...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerIPAddress=tFTPServerIPAddress, longitude=longitude, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, securityLevel=securityLevel, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, linkName=linkName, dfsTableNumber=dfsTableNumber, bootVersion=bootVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, phyStatus=phyStatus, dfsPeaks=dfsPeaks, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, secondarySoftwareVersion=secondarySoftwareVersion, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, linkModeOptimisation=linkModeOptimisation, sNTPServerStatus=sNTPServerStatus, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, userTableNumber=userTableNumber, searchState=searchState, sNTPSync=sNTPSync, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, targetMACAddress=targetMACAddress, dataPortStatusTrap=dataPortStatusTrap, bandwidthVariant=bandwidthVariant, sntp=sntp, hTTPSPortNumber=hTTPSPortNumber, productVariant=productVariant, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, transmitChannel=transmitChannel, dSCPManagementPriority=dSCPManagementPriority, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configuration=configuration, channelBLoopback=channelBLoopback, receiveDataRate=receiveDataRate, regionCodeTrap=regionCodeTrap, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, dfsTable=dfsTable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, groupID=groupID, managementPortDisabledWarning=managementPortDisabledWarning, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, sNTPServerTable=sNTPServerTable, rangingMode=rangingMode, sNMPTrapVersion=sNMPTrapVersion, receiveFreqMHz=receiveFreqMHz, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsMeans=dfsMeans, dataPortAutoNegotiation=dataPortAutoNegotiation, dfs=dfs, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPEnabledMessages=sMTPEnabledMessages, targetRange=targetRange, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, management=management, iPv4Address=iPv4Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, supplementaryGroup=supplementaryGroup, userRole=userRole, syslogControl=syslogControl, iPv6GatewayAddress=iPv6GatewayAddress, transmitFreqKHz=transmitFreqKHz, userTableIndex=userTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTable=l2CPPriorityTable, secureModeAlarm=secureModeAlarm, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerIPAddress=sNTPServerIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPLastSync=sNTPLastSync, telecomsInterface=telecomsInterface, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelALoopbackTrap=channelALoopbackTrap, systemClock=systemClock, sNTPServerTableIndex=sNTPServerTableIndex, aggregateDataRate=aggregateDataRate, siteName=siteName, cambium=cambium, sNTPPollInterval=sNTPPollInterval, syslogState=syslogState, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv6Address=iPv6Address, telecomsChannelSelection=telecomsChannelSelection, automaticTxPowerControl=automaticTxPowerControl, transmitFreqMHz=transmitFreqMHz, sNTPPrimaryServer=sNTPPrimaryServer, encryptionGroup=encryptionGroup, supplementary=supplementary, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ptp=ptp, regionCode=regionCode, tDDSynchronizationMode=tDDSynchronizationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortStatusTrap=managementPortStatusTrap, receivePower=receivePower, phyControl=phyControl, installStatus=installStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableIndex=dfsTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userEnabled=userEnabled, latitude=latitude, dataPortFiberStatus=dataPortFiberStatus, eIRP=eIRP, sMTPServerIPAddress=sMTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, telecomsChannelAStatus=telecomsChannelAStatus, txColorCode=txColorCode, incompatibleRegionCodes=incompatibleRegionCodes, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, dataPortStatus=dataPortStatus, subnetMask=subnetMask, altitude=altitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aAAControl=aAAControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, softwareVersion=softwareVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBandwidth=channelBandwidth, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, iPVersion=iPVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, userPassword=userPassword, rawReceivePower=rawReceivePower, antennaGain=antennaGain, managementMode=managementMode, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPState=sNTPState, hTTPAccessEnabled=hTTPAccessEnabled, daylightSaving=daylightSaving, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, versions=versions, channelBCableLength=channelBCableLength, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licence=licence, telnetAccessEnabled=telnetAccessEnabled, systemReset=systemReset, syslogStateTrap=syslogStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, range=range, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteInternetAddress=remoteInternetAddress, ethernet=ethernet, bridgeGroup=bridgeGroup, smtp=smtp, rxColorCode=rxColorCode, receiveFreqKHz=receiveFreqKHz, pubStatsGroup=pubStatsGroup, telecomsChannelBStatus=telecomsChannelBStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelChangeTrap=channelChangeTrap, sNTPServerTimeout=sNTPServerTimeout, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, frequencyVariant=frequencyVariant, resetGroup=resetGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, maximumTransmitPower=maximumTransmitPower, bridge=bridge, configurationGroup=configurationGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPv3Enable=sNMPv3Enable, timeZone=timeZone, channelALoopback=channelALoopback, telecomGroup=telecomGroup, linkLoss=linkLoss, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, wirelessLinkAvailability=wirelessLinkAvailability, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, syslogClient=syslogClient, snmpControl=snmpControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, smtpGroup=smtpGroup, productName=productName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableNumber=sNTPServerTableNumber, userName=userName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteRxTargetPower=remoteRxTargetPower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPEmailAlert=sMTPEmailAlert, channelBLineCode=channelBLineCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, syslogClientTrap=syslogClientTrap, channelACableLength=channelACableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, alarms=alarms, cableLoss=cableLoss, encryption=encryption, hAZLOCConfiguration=hAZLOCConfiguration, installArmState=installArmState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkSymmetry=linkSymmetry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecom=telecom, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlGroup=phyControlGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, managementPortStatus=managementPortStatus, vLANManagementPriority=vLANManagementPriority, managementPortWirelessDownAlert=managementPortWirelessDownAlert, aAAControlGroup=aAAControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelBLoopbackTrap=channelBLoopbackTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarmTrap=secureModeAlarmTrap, accessMethod=accessMethod, l2CPPriorityTableNumber=l2CPPriorityTableNumber, pubStats=pubStats, transmitPower=transmitPower, channelALineCode=channelALineCode, ptpCompliance=ptpCompliance, reset=reset, ptp600=ptp600, vLANManagementVID=vLANManagementVID)
