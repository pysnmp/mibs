...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptmp=ptmp, productName=productName, sNMPv3Enable=sNMPv3Enable, userRole=userRole, linkLoss=linkLoss, ethernetGroup=ethernetGroup, regionCodeTrap=regionCodeTrap, longitude=longitude, sntp=sntp, maximumTransmitPower=maximumTransmitPower, syslogStateTrap=syslogStateTrap, channelALoopbackTrap=channelALoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPPrimaryServer=sNTPPrimaryServer, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, vLANManagementVID=vLANManagementVID, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, bootVersion=bootVersion, PYSNMP_MODULE_ID=cambium, supplementaryGroup=supplementaryGroup, localPacketFiltering=localPacketFiltering, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControl=phyControl, cableLoss=cableLoss, range=range, snmpControl=snmpControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveModulationMode=receiveModulationMode, sNMPPortNumber=sNMPPortNumber, sNTPServerTimeout=sNTPServerTimeout, securityLevel=securityLevel, ethernetBridgingAvailability=ethernetBridgingAvailability, secondarySoftwareVersion=secondarySoftwareVersion, channelALoopback=channelALoopback, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, smtp=smtp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, sNTPServerTable=sNTPServerTable, configuration=configuration, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, iPv4Address=iPv4Address, tDDControlGroup=tDDControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, receivePower=receivePower, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, telnetAccessEnabled=telnetAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, aAAControlGroup=aAAControlGroup, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, linkName=linkName, productVariant=productVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerRetries=sNTPServerRetries, encryptionAlgorithm=encryptionAlgorithm, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, transmitFreqMHz=transmitFreqMHz, sNMPTrapVersion=sNMPTrapVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelBLineCode=channelBLineCode, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp=ptp, sNTPState=sNTPState, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerStatus=sNTPServerStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bridgeGroup=bridgeGroup, dataPortAutoMdix=dataPortAutoMdix, managementMode=managementMode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, targetMACAddress=targetMACAddress, latitude=latitude, management=management, telecom=telecom, pubStatsGroup=pubStatsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCode=regionCode, ptpGroups=ptpGroups, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableIndex=dfsTableIndex, ethernetPriorityTable=ethernetPriorityTable, encryption=encryption, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, targetRange=targetRange, iPVersion=iPVersion, managementPortStatus=managementPortStatus, altitude=altitude, snmpControlGroup=snmpControlGroup, remoteInternetAddress=remoteInternetAddress, ethernetFiberSupport=ethernetFiberSupport, userEnabled=userEnabled, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, dfsPeaks=dfsPeaks, alarms=alarms, licenceGroup=licenceGroup, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomGroup=telecomGroup, ptp600=ptp600, dfsTableNumber=dfsTableNumber, installArmState=installArmState, channelBCableLength=channelBCableLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatus=installStatus, linkSymmetry=linkSymmetry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, qOSPriorityScheme=qOSPriorityScheme, telecomsInterface=telecomsInterface, tDDControl=tDDControl, dfsTable=dfsTable, sNMPTrapTable=sNMPTrapTable, sNTPServerTableIndex=sNTPServerTableIndex, masterSlaveMode=masterSlaveMode, byteErrorRatio=byteErrorRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, siteName=siteName, daylightSaving=daylightSaving, accessMethod=accessMethod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBLoopback=channelBLoopback, sNMPEnabledTraps=sNMPEnabledTraps, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, dfsMeans=dfsMeans, secureModeAlarmTrap=secureModeAlarmTrap, resetGroup=resetGroup, dfsGroup=dfsGroup, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, eIRP=eIRP, remoteIPAddress=remoteIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelALineCode=channelALineCode, iPv6Address=iPv6Address, dataPortFiberStatus=dataPortFiberStatus, channelACableLength=channelACableLength, syslogState=syslogState, supplementary=supplementary, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, managementPortStatusTrap=managementPortStatusTrap, reset=reset, managementGroup=managementGroup, groupID=groupID, signalStrengthRatio=signalStrengthRatio, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bandwidthVariant=bandwidthVariant, userTableEntry=userTableEntry, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, transmitPower=transmitPower, dSCPManagementPriority=dSCPManagementPriority, remoteRxTargetPower=remoteRxTargetPower, receiveFreqKHz=receiveFreqKHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installStatusTrap=installStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus, aAAControl=aAAControl, sNTPPollInterval=sNTPPollInterval, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, cambium=cambium, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, txColorCode=txColorCode, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, transmitChannel=transmitChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, telecomsChannelSelection=telecomsChannelSelection)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelAStatus=telecomsChannelAStatus, transmitDataRate=transmitDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rangingMode=rangingMode, ptpCompliance=ptpCompliance, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telnetPortNumber=telnetPortNumber, gatewayIPAddress=gatewayIPAddress, bridge=bridge, automaticTxPowerControl=automaticTxPowerControl, receiveFreqMHz=receiveFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitModulationMode=transmitModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaGain=antennaGain, sMTPServerIPAddress=sMTPServerIPAddress, rawReceivePower=rawReceivePower, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, userPassword=userPassword, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, sNTPServerTableEntry=sNTPServerTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarning=managementPortDisabledWarning, sntpGroup=sntpGroup, syslogControl=syslogControl, ethernet=ethernet, rxColorCode=rxColorCode, dataPortAutoNegotiation=dataPortAutoNegotiation, secureModeAlarm=secureModeAlarm)
