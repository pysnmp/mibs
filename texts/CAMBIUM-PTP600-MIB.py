...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", cambium=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, siteName=siteName, sNMPPortNumber=sNMPPortNumber, snmpControlGroup=snmpControlGroup, managementMode=managementMode, txColorCode=txColorCode, syslogStateTrap=syslogStateTrap, channelALineCode=channelALineCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfs=dfs, sntp=sntp, aAAControl=aAAControl, ethernetPriorityTable=ethernetPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, managementPortDisabledWarning=managementPortDisabledWarning, sNTPSync=sNTPSync, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionGroup=encryptionGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelSelection=telecomsChannelSelection, vLANManagementPriority=vLANManagementPriority, telnetAccessEnabled=telnetAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, localPacketFiltering=localPacketFiltering, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, ptpGroups=ptpGroups, configurationGroup=configurationGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitChannel=transmitChannel, alarms=alarms, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsInterface=telecomsInterface, frequencyVariant=frequencyVariant, smtp=smtp, transmitModulationMode=transmitModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, secureModeAlarm=secureModeAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, latitude=latitude, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, versionsGroup=versionsGroup, telecomGroup=telecomGroup, remoteInternetAddress=remoteInternetAddress, licence=licence, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, unitOutOfCalibration=unitOutOfCalibration, ptp=ptp, syslogControlGroup=syslogControlGroup, groupID=groupID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, userTableEntry=userTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelBLineCode=channelBLineCode, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, tDDSynchronizationStatus=tDDSynchronizationStatus, iPVersion=iPVersion, telnetPortNumber=telnetPortNumber, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, cableLoss=cableLoss, receivePower=receivePower, hardwareVersion=hardwareVersion, alarmsGroup=alarmsGroup, channelALoopback=channelALoopback, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, transmitFreqKHz=transmitFreqKHz, userName=userName, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, dfsTable=dfsTable, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rxColorCode=rxColorCode, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementary=supplementary, dfsTableNumber=dfsTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, iPv4Address=iPv4Address, channelACableLength=channelACableLength, sMTPServerInternetAddressType=sMTPServerInternetAddressType, searchState=searchState, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, reset=reset, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, configuration=configuration, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, byteErrorRatio=byteErrorRatio, channelBLoopback=channelBLoopback, dfsTableIndex=dfsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClientTrap=syslogClientTrap, channelALoopbackTrap=channelALoopbackTrap, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkName=linkName, telecomsChannelBStatus=telecomsChannelBStatus, productVariant=productVariant, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, daylightSaving=daylightSaving, syslogState=syslogState, dfsPeaks=dfsPeaks, eIRP=eIRP, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortFiberStatus=dataPortFiberStatus, sNTPLastSync=sNTPLastSync, iPv6PrefixLength=iPv6PrefixLength, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, dSCPManagementPriority=dSCPManagementPriority, ethernetPriorityTableEntry=ethernetPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, pubStatsGroup=pubStatsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogControl=syslogControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bridgeGroup=bridgeGroup, targetMACAddress=targetMACAddress, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkSymmetry=linkSymmetry, management=management, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTable=l2CPPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptmp=ptmp, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTable=sNTPServerTable, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerStatus=sNTPServerStatus, transmitFreqMHz=transmitFreqMHz, dfsMeans=dfsMeans, timeZone=timeZone, aAAControlGroup=aAAControlGroup, receiveFreqKHz=receiveFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecom=telecom, sNMPCommunityString=sNMPCommunityString, iPv6Address=iPv6Address, sNTPServerTableIndex=sNTPServerTableIndex, regionCodeTrap=regionCodeTrap, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPDSCPPriorityTable=iPDSCPPriorityTable, rangingMode=rangingMode, dataPortStatusTrap=dataPortStatusTrap, longitude=longitude, encryptionAlgorithm=encryptionAlgorithm, managementPortStatusTrap=managementPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpTraps=ptpTraps, masterSlaveMode=masterSlaveMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, ptp600=ptp600, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sntpGroup=sntpGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridge=bridge, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, receiveChannel=receiveChannel)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPSPortNumber=hTTPSPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernet=ethernet, softwareVersion=softwareVersion, userTable=userTable, range=range, productName=productName, channelBCableLength=channelBCableLength, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortStatus=managementPortStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, managementPortConfigurationMismatch=managementPortConfigurationMismatch, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, phyControl=phyControl, sNTPPrimaryServer=sNTPPrimaryServer, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, regionCode=regionCode, targetRange=targetRange, rawReceivePower=rawReceivePower, phyStatusGroup=phyStatusGroup, altitude=altitude, securityLevel=securityLevel, dataPortAutoMdix=dataPortAutoMdix, hTTPPortNumber=hTTPPortNumber, installStatus=installStatus, userRole=userRole, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyControlGroup=phyControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, sNMPv3Enable=sNMPv3Enable, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, bandwidthVariant=bandwidthVariant, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, ptpCompliance=ptpCompliance)
