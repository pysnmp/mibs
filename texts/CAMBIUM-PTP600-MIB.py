...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingAvailability=ethernetBridgingAvailability, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTable=ethernetPriorityTable, encryption=encryption, remoteInternetAddressType=remoteInternetAddressType, syslogClient=syslogClient, smtpGroup=smtpGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dfsTableEntry=dfsTableEntry, transmitModulationMode=transmitModulationMode, bridgeGroup=bridgeGroup, wirelessLinkAvailability=wirelessLinkAvailability, managementGroup=managementGroup, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, secureModeAlarm=secureModeAlarm, supplementaryGroup=supplementaryGroup, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userRole=userRole, userTableEntry=userTableEntry, qOSPriorityScheme=qOSPriorityScheme, channelBLineCode=channelBLineCode, tFTPServerPortNumber=tFTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, productVariant=productVariant, pubStatsGroup=pubStatsGroup, securityLevel=securityLevel, sNMPTrapVersion=sNMPTrapVersion, tDDControl=tDDControl, transmitChannel=transmitChannel, linkSymmetry=linkSymmetry, sNTPServerRetries=sNTPServerRetries, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableNumber=userTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, resetGroup=resetGroup, iPVersion=iPVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, siteName=siteName, supplementary=supplementary, iPv6PrefixLength=iPv6PrefixLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userName=userName, installArmStateTrap=installArmStateTrap, rangingMode=rangingMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, masterSlaveMode=masterSlaveMode, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarning=managementPortDisabledWarning, installStatus=installStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALoopback=channelALoopback, sNTPServerInternetAddressType=sNTPServerInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, linkModeOptimisation=linkModeOptimisation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aAAControlGroup=aAAControlGroup, l2CPPriorityTable=l2CPPriorityTable, telnetAccessEnabled=telnetAccessEnabled, maximumTransmitPower=maximumTransmitPower, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, smtp=smtp, linkLoss=linkLoss, ethernetBridgingStatus=ethernetBridgingStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, altitude=altitude, managementMode=managementMode, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsMeans=dfsMeans, hardwareVersion=hardwareVersion, channelALineCode=channelALineCode, ptpGroups=ptpGroups, sNTPServerTimeout=sNTPServerTimeout, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptp=ptp, searchState=searchState, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyStatusGroup=phyStatusGroup, sNTPServerIPAddress=sNTPServerIPAddress, localPacketFiltering=localPacketFiltering, tDDControlGroup=tDDControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, snmpControl=snmpControl, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryptionGroup=encryptionGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTable=sNTPServerTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyControl=phyControl, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, remoteRxTargetPower=remoteRxTargetPower, channelBLoopback=channelBLoopback, bootVersion=bootVersion, bridge=bridge, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, regionCode=regionCode, timeZone=timeZone, remoteInternetAddress=remoteInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, configuration=configuration, rxColorCode=rxColorCode, ethernet=ethernet, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aAAControl=aAAControl, hAZLOCConfiguration=hAZLOCConfiguration, linkName=linkName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelBStatus=telecomsChannelBStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerPortNumber=sNTPServerPortNumber, syslogClientTrap=syslogClientTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, cableLoss=cableLoss, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, dfs=dfs, syslogState=syslogState, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, automaticTxPowerControl=automaticTxPowerControl, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, sMTPEmailAlert=sMTPEmailAlert, iPv4Address=iPv4Address, systemClock=systemClock, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, dataPortFiberStatusTrap=dataPortFiberStatusTrap, range=range, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableNumber=sNTPServerTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, alarmsGroup=alarmsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userEnabled=userEnabled, channelALoopbackTrap=channelALoopbackTrap, antennaGain=antennaGain, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecomsChannelAStatus=telecomsChannelAStatus, reset=reset, rawReceivePower=rawReceivePower, managementPortStatusTrap=managementPortStatusTrap, receiveFreqKHz=receiveFreqKHz, snmpControlGroup=snmpControlGroup, versions=versions, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userTableIndex=userTableIndex, subnetMask=subnetMask, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, systemReset=systemReset, dataPortAutoMdix=dataPortAutoMdix, accessMethod=accessMethod, pubStats=pubStats, telecomsInterface=telecomsInterface, sNMPTrapInternetAddress=sNMPTrapInternetAddress, longitude=longitude, targetMACAddress=targetMACAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dfsTableIndex=dfsTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, ptp600=ptp600, txColorCode=txColorCode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, sNTPServerStatus=sNTPServerStatus, sntp=sntp, management=management, ptpCompliance=ptpCompliance, eIRP=eIRP, userPassword=userPassword, transmitPower=transmitPower, receiveChannel=receiveChannel, dSCPManagementPriority=dSCPManagementPriority, sNTPSyncTrap=sNTPSyncTrap, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPPrimaryServer=sNTPPrimaryServer, managementPortStatus=managementPortStatus, sNTPPollInterval=sNTPPollInterval, iPv6Address=iPv6Address, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, licence=licence, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteIPAddress=remoteIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortDisabledWarning=dataPortDisabledWarning, channelACableLength=channelACableLength, installStatusTrap=installStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBandwidth=channelBandwidth, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, targetRange=targetRange, sNTPServerTableEntry=sNTPServerTableEntry, receiveModulationMode=receiveModulationMode, latitude=latitude, secureModeAlarmTrap=secureModeAlarmTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, groupID=groupID, dfsTable=dfsTable, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, notificationsGroup=notificationsGroup, syslogControl=syslogControl, channelBCableLength=channelBCableLength, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, userTable=userTable, installArmState=installArmState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, softwareVersion=softwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, ethernetGroup=ethernetGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarms=alarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry)
