...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBCableLength=channelBCableLength, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productName=productName, rawReceivePower=rawReceivePower, userTableIndex=userTableIndex, iPVersion=iPVersion, reset=reset, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsInterface=telecomsInterface, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntp=sntp, tDDControl=tDDControl, dataPortStatus=dataPortStatus, sNMPv3Enable=sNMPv3Enable, ethernetFiberSupport=ethernetFiberSupport, managementPortStatus=managementPortStatus, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTable=ethernetPriorityTable, installArmState=installArmState, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, ethernet=ethernet, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, userPassword=userPassword, sNTPServerRetries=sNTPServerRetries, bridgeGroup=bridgeGroup, telecomsChannelSelection=telecomsChannelSelection, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp=ptp, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarning=dataPortDisabledWarning, channelBLoopbackTrap=channelBLoopbackTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userName=userName, transmitFreqKHz=transmitFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, rxColorCode=rxColorCode, transmitModulationMode=transmitModulationMode, smtp=smtp, l2CPPriorityTable=l2CPPriorityTable, management=management, remoteInternetAddressType=remoteInternetAddressType, sNTPSync=sNTPSync, sMTPServerInternetAddressType=sMTPServerInternetAddressType, accessMethod=accessMethod, ethernetGroup=ethernetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerInternetAddress=sMTPServerInternetAddress, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6PrefixLength=iPv6PrefixLength, range=range, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productVariant=productVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPPortNumber=sNMPPortNumber, vLANManagementPriority=vLANManagementPriority, installStatus=installStatus, sMTPEmailAlert=sMTPEmailAlert, remoteIPAddress=remoteIPAddress, dataPortAutoMdix=dataPortAutoMdix, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, channelALoopback=channelALoopback, supplementaryGroup=supplementaryGroup, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, managementPortStatusTrap=managementPortStatusTrap, systemReset=systemReset, channelBLoopback=channelBLoopback, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, channelBLineCode=channelBLineCode, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfs=dfs, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userRole=userRole, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, configuration=configuration, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, frequencyVariant=frequencyVariant, timeZone=timeZone, sNTPServerIPAddress=sNTPServerIPAddress, masterSlaveMode=masterSlaveMode, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableIndex=dfsTableIndex, ptp600=ptp600, remoteRxTargetPower=remoteRxTargetPower, byteErrorRatio=byteErrorRatio, altitude=altitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStatsGroup=pubStatsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, encryption=encryption, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsTable=dfsTable, antennaGain=antennaGain, sNTPServerStatus=sNTPServerStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, ethernetBridgingStatus=ethernetBridgingStatus, ptmp=ptmp, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, smtpGroup=smtpGroup, eIRP=eIRP, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, targetRange=targetRange, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogControlGroup=syslogControlGroup, channelALineCode=channelALineCode, syslogClientTrap=syslogClientTrap, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secureModeAlarm=secureModeAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerInternetAddress=sNTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, unitOutOfCalibration=unitOutOfCalibration, remoteInternetAddress=remoteInternetAddress, receiveChannel=receiveChannel, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelACableLength=channelACableLength, dSCPManagementPriority=dSCPManagementPriority, automaticTxPowerControl=automaticTxPowerControl, snmpControl=snmpControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, aAAControl=aAAControl, pubStats=pubStats, syslogControl=syslogControl, sNMPTrapTable=sNMPTrapTable, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControlGroup=phyControlGroup, sNTPServerTable=sNTPServerTable, tDDSynchronizationMode=tDDSynchronizationMode, phyControl=phyControl, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, telecomsChannelAStatus=telecomsChannelAStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, channelBandwidth=channelBandwidth, dataPortFiberStatus=dataPortFiberStatus, managementGroup=managementGroup, localPacketFiltering=localPacketFiltering, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTraps=ptpTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, versionsGroup=versionsGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, qOSPriorityScheme=qOSPriorityScheme, ptpCompliance=ptpCompliance, hTTPAccessEnabled=hTTPAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, securityLevel=securityLevel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecom=telecom, sNTPServerTimeout=sNTPServerTimeout, alarmsGroup=alarmsGroup, phyStatus=phyStatus, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, encryptionGroup=encryptionGroup, dataPortStatusTrap=dataPortStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, txColorCode=txColorCode, bootVersion=bootVersion, cableLoss=cableLoss, iPv4Address=iPv4Address, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, alarms=alarms, licence=licence, telecomGroup=telecomGroup, userTable=userTable, hAZLOCConfiguration=hAZLOCConfiguration, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPServerPortNumber=tFTPServerPortNumber, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6Address=iPv6Address, cambium=cambium, syslogClient=syslogClient, linkLoss=linkLoss, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemClock=systemClock, regionCodeTrap=regionCodeTrap, secureModeAlarmTrap=secureModeAlarmTrap, sNMPCommunityString=sNMPCommunityString, searchState=searchState, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, encryptionAlgorithm=encryptionAlgorithm, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bridge=bridge, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, siteName=siteName, ptpGroups=ptpGroups, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subnetMask=subnetMask, phyStatusGroup=phyStatusGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogState=syslogState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, rangingMode=rangingMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveDataRate=receiveDataRate, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerTableNumber=sNTPServerTableNumber, dfsPeaks=dfsPeaks, longitude=longitude, targetMACAddress=targetMACAddress, transmitDataRate=transmitDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableEntry=sNTPServerTableEntry, groupID=groupID)
