...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTable=l2CPPriorityTable, userTable=userTable, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, installArmStateTrap=installArmStateTrap, dfsMeans=dfsMeans, siteName=siteName, receiveModulationModeDetail=receiveModulationModeDetail, targetRange=targetRange, channelBandwidth=channelBandwidth, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveChannel=receiveChannel, bootVersion=bootVersion, subnetMask=subnetMask, groupID=groupID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernet=ethernet, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteRxTargetPower=remoteRxTargetPower, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, bridge=bridge, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerRetries=sNTPServerRetries, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, linkLoss=linkLoss, incompatibleRegionCodes=incompatibleRegionCodes, licence=licence, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, encryption=encryption, installArmState=installArmState, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, antennaGain=antennaGain, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsInterface=telecomsInterface, signalStrengthRatio=signalStrengthRatio, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, transmitFreqMHz=transmitFreqMHz, aAAControl=aAAControl, maximumTransmitPower=maximumTransmitPower, ethernetBridgingAvailability=ethernetBridgingAvailability, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, vLANManagementVID=vLANManagementVID, managementPortStatusTrap=managementPortStatusTrap, dfs=dfs, configuration=configuration, installStatus=installStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDControl=tDDControl, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelSelection=telecomsChannelSelection, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, encryptionAlgorithm=encryptionAlgorithm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPCommunityString=sNMPCommunityString, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControlGroup=phyControlGroup, ethernetPriorityTable=ethernetPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomGroup=telecomGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productVariant=productVariant, secondarySoftwareVersion=secondarySoftwareVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp600=ptp600, targetMACAddress=targetMACAddress, ptmp=ptmp, securityLevel=securityLevel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntpGroup=sntpGroup, sMTPEmailAlert=sMTPEmailAlert, phyStatus=phyStatus, rangingMode=rangingMode, snmpControlGroup=snmpControlGroup, channelACableLength=channelACableLength, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, sNMPv3Enable=sNMPv3Enable, timeZone=timeZone, bridgeGroup=bridgeGroup, rawReceivePower=rawReceivePower, phyStatusGroup=phyStatusGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, localPacketFiltering=localPacketFiltering, hTTPAccessEnabled=hTTPAccessEnabled, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, supplementaryGroup=supplementaryGroup, userRole=userRole, sNTPServerTableNumber=sNTPServerTableNumber, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, userTableNumber=userTableNumber, longitude=longitude, remoteInternetAddressType=remoteInternetAddressType, productName=productName, systemReset=systemReset, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, altitude=altitude, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6Address=iPv6Address, channelBLineCode=channelBLineCode, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTimeout=sNTPServerTimeout, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, iPVersion=iPVersion, softwareVersion=softwareVersion, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogState=syslogState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementMode=managementMode, automaticTxPowerControl=automaticTxPowerControl, managementPortDisabledWarning=managementPortDisabledWarning, sNTPLastSync=sNTPLastSync, channelBLoopback=channelBLoopback, channelALineCode=channelALineCode, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, userName=userName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPPollInterval=sNTPPollInterval, cambium=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, pubStats=pubStats, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, resetGroup=resetGroup, daylightSaving=daylightSaving, versions=versions, telnetPortNumber=telnetPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, reset=reset, txColorCode=txColorCode, dfsTableIndex=dfsTableIndex, cableLoss=cableLoss, userPassword=userPassword, regionCodeTrap=regionCodeTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secureModeAlarm=secureModeAlarm, iPv4Address=iPv4Address, channelALoopback=channelALoopback, receiveDataRate=receiveDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubStatsGroup=pubStatsGroup, range=range, sNTPSync=sNTPSync, telecomsChannelAStatus=telecomsChannelAStatus, secureModeAlarmTrap=secureModeAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hardwareVersion=hardwareVersion, receiveFreqKHz=receiveFreqKHz, dfsTableNumber=dfsTableNumber, latitude=latitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoMdix=dataPortAutoMdix, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, sntp=sntp, dataPortFiberStatus=dataPortFiberStatus, telecom=telecom, mPLSTCPriorityTable=mPLSTCPriorityTable, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTable=sNTPServerTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, channelBCableLength=channelBCableLength, tFTPServerInternetAddress=tFTPServerInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, channelBLoopbackTrap=channelBLoopbackTrap, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, channelALoopbackTrap=channelALoopbackTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitChannel=transmitChannel, systemClock=systemClock, rxColorCode=rxColorCode, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, supplementary=supplementary, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, qOSPriorityScheme=qOSPriorityScheme, receiveModulationMode=receiveModulationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, eIRP=eIRP, managementPortStatus=managementPortStatus, syslogStateTrap=syslogStateTrap, smtp=smtp, ptpTraps=ptpTraps, linkName=linkName, syslogControl=syslogControl, hAZLOCConfiguration=hAZLOCConfiguration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteIPAddress=remoteIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, notificationsGroup=notificationsGroup, dfsGroup=dfsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCode=regionCode, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, encryptionGroup=encryptionGroup, sNMPPortNumber=sNMPPortNumber, accessMethod=accessMethod)
