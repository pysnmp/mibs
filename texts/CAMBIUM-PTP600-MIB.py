...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:23:58 2021
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveDataRate=receiveDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, regionCode=regionCode, telnetPortNumber=telnetPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelACableLength=channelACableLength, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, frequencyVariant=frequencyVariant, managementGroup=managementGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkStatus=wirelessLinkStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, ethernetBridgingAvailability=ethernetBridgingAvailability, secureModeAlarm=secureModeAlarm, phyControlGroup=phyControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableNumber=dfsTableNumber, ethernet=ethernet, daylightSaving=daylightSaving, txColorCode=txColorCode, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, telecomsChannelBStatus=telecomsChannelBStatus, tDDControlGroup=tDDControlGroup, dSCPManagementPriority=dSCPManagementPriority, sNTPPrimaryServer=sNTPPrimaryServer, sMTPEnabledMessages=sMTPEnabledMessages, remoteInternetAddressType=remoteInternetAddressType, channelALoopbackTrap=channelALoopbackTrap, productName=productName, pubStats=pubStats, sNMPCommunityString=sNMPCommunityString, altitude=altitude, telecomsInterface=telecomsInterface, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTable=mPLSTCPriorityTable, securityLevel=securityLevel, masterSlaveMode=masterSlaveMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControlGroup=aAAControlGroup, subnetMask=subnetMask, remoteInternetAddress=remoteInternetAddress, installArmState=installArmState, channelALineCode=channelALineCode, ptpGroups=ptpGroups, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleRegionCodes=incompatibleRegionCodes, byteErrorRatio=byteErrorRatio, syslogState=syslogState, siteName=siteName, channelALoopback=channelALoopback, channelBCableLength=channelBCableLength, linkName=linkName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortStatus=managementPortStatus, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtpGroup=smtpGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, eIRP=eIRP, bridge=bridge, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortStatusTrap=managementPortStatusTrap, dataPortStatusTrap=dataPortStatusTrap, vLANManagementPriority=vLANManagementPriority, syslogControlGroup=syslogControlGroup, dataPortFiberStatus=dataPortFiberStatus, alarms=alarms, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, reset=reset, range=range, latitude=latitude, ptpCompliance=ptpCompliance, channelBLoopbackTrap=channelBLoopbackTrap, vectorError=vectorError, systemReset=systemReset, wirelessLinkAvailability=wirelessLinkAvailability, productVariant=productVariant, dfs=dfs, phyStatus=phyStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, aAAControl=aAAControl, versions=versions, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, automaticTxPowerControl=automaticTxPowerControl, receiveChannel=receiveChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSyncTrap=sNTPSyncTrap, encryptionGroup=encryptionGroup, transmitDataRate=transmitDataRate, sNTPServerStatus=sNTPServerStatus, sNMPTrapTable=sNMPTrapTable, sNTPLastSync=sNTPLastSync, supplementaryGroup=supplementaryGroup, dfsGroup=dfsGroup, transmitFreqKHz=transmitFreqKHz, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, ethernetPriorityTable=ethernetPriorityTable, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsChannelAStatus=telecomsChannelAStatus, bootVersion=bootVersion, phyControl=phyControl, localPacketFiltering=localPacketFiltering, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelSelection=telecomsChannelSelection, cambium=cambium, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, qOSPriorityScheme=qOSPriorityScheme, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteIPAddress=remoteIPAddress, dataPortStatus=dataPortStatus, resetGroup=resetGroup, remoteRxTargetPower=remoteRxTargetPower, installStatusTrap=installStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveModulationMode=receiveModulationMode, constantPowerSpectralDensity=constantPowerSpectralDensity, iPVersion=iPVersion, receiveFreqMHz=receiveFreqMHz, syslogClientTrap=syslogClientTrap, dataPortAutoMdix=dataPortAutoMdix, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTable=dfsTable, iPv4Address=iPv4Address, channelBLoopback=channelBLoopback, licenceGroup=licenceGroup, ethernetBridgingStatus=ethernetBridgingStatus, telecomGroup=telecomGroup, userTableNumber=userTableNumber, rangingMode=rangingMode, ptp600=ptp600, channelBandwidth=channelBandwidth, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementMode=managementMode, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsPeaks=dfsPeaks, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, secureModeAlarmTrap=secureModeAlarmTrap, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecom=telecom, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, searchState=searchState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryption=encryption, cableLoss=cableLoss, dfsTableIndex=dfsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelBLineCode=channelBLineCode, hardwareVersion=hardwareVersion, licence=licence, pubStatsGroup=pubStatsGroup, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, dataPortAutoNegotiation=dataPortAutoNegotiation, management=management, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerTable=sNTPServerTable, targetRange=targetRange, rxColorCode=rxColorCode, groupID=groupID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntpGroup=sntpGroup, snmpControl=snmpControl, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, longitude=longitude, sNTPServerRetries=sNTPServerRetries, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortDisabledWarning=managementPortDisabledWarning, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, linkLoss=linkLoss, antennaGain=antennaGain, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPPortNumber=sNMPPortNumber, userName=userName, syslogStateTrap=syslogStateTrap, phyStatusGroup=phyStatusGroup, sNTPState=sNTPState, iPv6PrefixLength=iPv6PrefixLength, sNTPServerIPAddress=sNTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, configuration=configuration, bridgeGroup=bridgeGroup, snmpControlGroup=snmpControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, configurationGroup=configurationGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, rawReceivePower=rawReceivePower, userTable=userTable, versionsGroup=versionsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, regionCodeTrap=regionCodeTrap, hTTPAccessEnabled=hTTPAccessEnabled, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsMeans=dfsMeans, smtp=smtp, tDDControl=tDDControl, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, transmitChannel=transmitChannel, iPv6Address=iPv6Address, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning)
