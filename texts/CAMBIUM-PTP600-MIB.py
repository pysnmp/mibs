...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTable=dfsTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, securityLevel=securityLevel, hTTPSPortNumber=hTTPSPortNumber, receivePower=receivePower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, altitude=altitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitChannel=transmitChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, localPacketFiltering=localPacketFiltering, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, secureModeAlarmTrap=secureModeAlarmTrap, supplementary=supplementary, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, syslogState=syslogState, siteName=siteName, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBLoopback=channelBLoopback, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, latitude=latitude, userTableNumber=userTableNumber, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelALineCode=channelALineCode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hTTPPortNumber=hTTPPortNumber, alarms=alarms, configurationGroup=configurationGroup, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, ptpGroups=ptpGroups, phyControl=phyControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, channelBCableLength=channelBCableLength, versions=versions, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetGroup=ethernetGroup, regionCode=regionCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, userRole=userRole, channelBLoopbackTrap=channelBLoopbackTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogLocalWrappedTrap=syslogLocalWrappedTrap, snmpControl=snmpControl, tDDControl=tDDControl, systemReset=systemReset, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, transmitPower=transmitPower, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aggregateDataRate=aggregateDataRate, encryptionAlgorithm=encryptionAlgorithm, channelChangeTrap=channelChangeTrap, vectorError=vectorError, bridgeGroup=bridgeGroup, dfs=dfs, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, channelALoopback=channelALoopback, userTableIndex=userTableIndex, rawReceivePower=rawReceivePower, sNMPTrapVersion=sNMPTrapVersion, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, snmpControlGroup=snmpControlGroup, txColorCode=txColorCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortStatusTrap=managementPortStatusTrap, licenceGroup=licenceGroup, channelBLineCode=channelBLineCode, sNTPServerStatus=sNTPServerStatus, iPv4Address=iPv4Address, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingAvailability=ethernetBridgingAvailability, encryption=encryption, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBandwidth=channelBandwidth, transmitFreqKHz=transmitFreqKHz, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControlGroup=phyControlGroup, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogClient=syslogClient, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptpTraps=ptpTraps, configuration=configuration, pubStatsGroup=pubStatsGroup, targetRange=targetRange, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortFiberStatus=dataPortFiberStatus, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userTable=userTable, ptmp=ptmp, installStatusTrap=installStatusTrap, managementMode=managementMode, iPv6GatewayAddress=iPv6GatewayAddress, syslogStateTrap=syslogStateTrap, productVariant=productVariant, installArmState=installArmState, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptpCompliance=ptpCompliance, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsInterface=telecomsInterface, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableEntry=sNTPServerTableEntry, channelALoopbackTrap=channelALoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, targetMACAddress=targetMACAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableIndex=dfsTableIndex, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, groupID=groupID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, bootVersion=bootVersion, vLANManagementVID=vLANManagementVID, sNTPSync=sNTPSync, remoteRxTargetPower=remoteRxTargetPower, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, range=range, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, telecomsChannelAStatus=telecomsChannelAStatus, userEnabled=userEnabled, installArmStateTrap=installArmStateTrap, receiveFreqKHz=receiveFreqKHz, transmitDataRate=transmitDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, frequencyVariant=frequencyVariant, telecom=telecom, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6PrefixLength=iPv6PrefixLength, systemClock=systemClock, daylightSaving=daylightSaving, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNMPCommunityString=sNMPCommunityString, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aAAControl=aAAControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6Address=iPv6Address, maximumTransmitPower=maximumTransmitPower, telecomsChannelSelection=telecomsChannelSelection, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTable=ethernetPriorityTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerPortNumber=sMTPServerPortNumber, linkName=linkName, eIRP=eIRP, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, sNTPSyncTrap=sNTPSyncTrap, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyStatusGroup=phyStatusGroup, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, byteErrorRatio=byteErrorRatio, userPassword=userPassword, subnetMask=subnetMask, PYSNMP_MODULE_ID=cambium, licence=licence, iPVersion=iPVersion, productName=productName, hardwareVersion=hardwareVersion, syslogControlGroup=syslogControlGroup, dSCPManagementPriority=dSCPManagementPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTable=l2CPPriorityTable, masterSlaveMode=masterSlaveMode, sNTPPrimaryServer=sNTPPrimaryServer, remoteInternetAddressType=remoteInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatus=managementPortStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibration=unitOutOfCalibration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteInternetAddress=remoteInternetAddress, management=management, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerTable=sNTPServerTable, cambium=cambium, linkLoss=linkLoss, linkSymmetry=linkSymmetry, dfsMeans=dfsMeans, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, reset=reset, receiveChannel=receiveChannel, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, managementGroup=managementGroup, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, rangingMode=rangingMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsGroup=dfsGroup, bridge=bridge, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp600=ptp600, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, accessMethod=accessMethod, hAZLOCConfiguration=hAZLOCConfiguration, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, bandwidthVariant=bandwidthVariant, channelACableLength=channelACableLength, userTableEntry=userTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomGroup=telecomGroup, smtp=smtp, rxColorCode=rxColorCode, sNTPServerRetries=sNTPServerRetries, dfsTableNumber=dfsTableNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, regionCodeTrap=regionCodeTrap, smtpGroup=smtpGroup)
