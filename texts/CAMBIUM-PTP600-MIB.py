...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkAvailability=wirelessLinkAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelALoopbackTrap=channelALoopbackTrap, channelBLoopbackTrap=channelBLoopbackTrap, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTable=l2CPPriorityTable, bridge=bridge, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsTableNumber=dfsTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vLANManagementVID=vLANManagementVID, bandwidthVariant=bandwidthVariant, hAZLOCConfiguration=hAZLOCConfiguration, softwareVersion=softwareVersion, management=management, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapVersion=sNMPTrapVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp600=ptp600, txColorCode=txColorCode, managementPortDisabledWarning=managementPortDisabledWarning, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, hardwareVersion=hardwareVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rangingMode=rangingMode, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, dataPortStatus=dataPortStatus, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, reset=reset, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, timeZone=timeZone, ptmp=ptmp, vectorError=vectorError, syslogClientTrap=syslogClientTrap, snmpControlGroup=snmpControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, userTable=userTable, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6Address=iPv6Address, telecomsChannelSelection=telecomsChannelSelection, receiveFreqMHz=receiveFreqMHz, dfsGroup=dfsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveDataRate=receiveDataRate, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, pubStatsGroup=pubStatsGroup, sNTPServerTable=sNTPServerTable, channelBLineCode=channelBLineCode, channelChangeTrap=channelChangeTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsMeans=dfsMeans, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapTable=sNMPTrapTable, groupID=groupID, signalStrengthRatio=signalStrengthRatio, sNMPv3Enable=sNMPv3Enable, transmitPower=transmitPower, tDDControl=tDDControl, phyStatus=phyStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6PrefixLength=iPv6PrefixLength, ethernet=ethernet, telecomsInterface=telecomsInterface, licence=licence, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerTimeout=sNTPServerTimeout, userPassword=userPassword, cableLoss=cableLoss, linkName=linkName, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, alarms=alarms, linkModeOptimisation=linkModeOptimisation, maximumTransmitPower=maximumTransmitPower, automaticTxPowerControl=automaticTxPowerControl, eIRP=eIRP, localPacketFiltering=localPacketFiltering, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secureModeAlarm=secureModeAlarm, sNTPServerIPAddress=sNTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, channelBLoopback=channelBLoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, userRole=userRole, syslogClient=syslogClient, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogState=syslogState, installArmState=installArmState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, ethernetFiberSupport=ethernetFiberSupport, remoteInternetAddress=remoteInternetAddress, bridgeGroup=bridgeGroup, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, byteErrorRatio=byteErrorRatio, aAAControlGroup=aAAControlGroup, sNTPServerStatus=sNTPServerStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, encryptionGroup=encryptionGroup, sNTPServerTableEntry=sNTPServerTableEntry, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkSymmetry=linkSymmetry, gatewayIPAddress=gatewayIPAddress, telecom=telecom, syslogControlGroup=syslogControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, userTableEntry=userTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, resetGroup=resetGroup, regionCodeTrap=regionCodeTrap, ptpGroups=ptpGroups, telnetPortNumber=telnetPortNumber, channelALineCode=channelALineCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, PYSNMP_MODULE_ID=cambium, sNTPPollInterval=sNTPPollInterval, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, supplementary=supplementary, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, userName=userName, productVariant=productVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemClock=systemClock, ptp=ptp, securityLevel=securityLevel, installStatus=installStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfs=dfs, sNTPState=sNTPState, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomGroup=telecomGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv4Address=iPv4Address, sNTPSync=sNTPSync, systemReset=systemReset, rawReceivePower=rawReceivePower, ptpCompliance=ptpCompliance, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, managementGroup=managementGroup, sNTPServerPortNumber=sNTPServerPortNumber, longitude=longitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, regionCode=regionCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, accessMethod=accessMethod, sMTPServerIPAddress=sMTPServerIPAddress, cambium=cambium, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetGroup=ethernetGroup, targetRange=targetRange, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelACableLength=channelACableLength, transmitChannel=transmitChannel, dfsTableIndex=dfsTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTraps=ptpTraps, dfsTable=dfsTable, userEnabled=userEnabled, alarmsGroup=alarmsGroup, antennaGain=antennaGain, siteName=siteName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatus=telecomsChannelBStatus, iPVersion=iPVersion, iPv6GatewayAddress=iPv6GatewayAddress, managementPortStatus=managementPortStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, aAAControl=aAAControl, ethernetBridgingStatus=ethernetBridgingStatus, encryption=encryption, installStatusTrap=installStatusTrap, smtp=smtp, sntpGroup=sntpGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDControlGroup=tDDControlGroup, channelBCableLength=channelBCableLength, configuration=configuration, installArmStateTrap=installArmStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, latitude=latitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, licenceGroup=licenceGroup, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANManagementPriority=vLANManagementPriority, dSCPManagementPriority=dSCPManagementPriority, rxColorCode=rxColorCode, versionsGroup=versionsGroup, dfsPeaks=dfsPeaks, channelALoopback=channelALoopback, receivePower=receivePower, remoteRxTargetPower=remoteRxTargetPower, targetMACAddress=targetMACAddress, transmitModulationMode=transmitModulationMode, sntp=sntp, range=range, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, subnetMask=subnetMask, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, altitude=altitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, userTableIndex=userTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, sNMPPortNumber=sNMPPortNumber, dataPortFiberStatus=dataPortFiberStatus)
