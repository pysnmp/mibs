...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPServerInternetAddress=sMTPServerInternetAddress, licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBLoopback=channelBLoopback, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, txColorCode=txColorCode, siteName=siteName, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, accessMethod=accessMethod, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, eIRP=eIRP, sNTPLastSync=sNTPLastSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, targetRange=targetRange, pubStats=pubStats, configurationGroup=configurationGroup, vectorError=vectorError, automaticTxPowerControl=automaticTxPowerControl, ptpGroups=ptpGroups, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, cambium=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, sNTPPrimaryServer=sNTPPrimaryServer, softwareVersion=softwareVersion, receiveChannel=receiveChannel, tDDControl=tDDControl, ptpTraps=ptpTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, range=range, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sntpGroup=sntpGroup, ethernetBridgingStatus=ethernetBridgingStatus, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBLineCode=channelBLineCode, dataPortStatus=dataPortStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBCableLength=channelBCableLength, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, installArmState=installArmState, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableNumber=sNTPServerTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, timeZone=timeZone, syslogClientTrap=syslogClientTrap, channelACableLength=channelACableLength, encryptionGroup=encryptionGroup, userRole=userRole, smtpGroup=smtpGroup, userTableNumber=userTableNumber, ptp=ptp, notificationsGroup=notificationsGroup, targetMACAddress=targetMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, pubStatsGroup=pubStatsGroup, ptp600=ptp600, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, remoteInternetAddress=remoteInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerStatus=sNTPServerStatus, dfs=dfs, qOSPriorityScheme=qOSPriorityScheme, transmitFreqKHz=transmitFreqKHz, rangingMode=rangingMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, securityLevel=securityLevel, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, secureModeAlarm=secureModeAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkLoss=linkLoss, alarms=alarms, dataPortFiberStatus=dataPortFiberStatus, channelChangeTrap=channelChangeTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hAZLOCConfiguration=hAZLOCConfiguration, tFTPServerPortNumber=tFTPServerPortNumber, linkSymmetry=linkSymmetry, management=management, licence=licence, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClient=syslogClient, syslogState=syslogState, bridge=bridge, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitPower=transmitPower, supplementary=supplementary, incompatibleRegionCodes=incompatibleRegionCodes, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, versions=versions, sNTPServerTable=sNTPServerTable, userTableEntry=userTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, bootVersion=bootVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPEnabledMessages=sMTPEnabledMessages, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, iPVersion=iPVersion, wirelessLinkAvailability=wirelessLinkAvailability, resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installStatusTrap=installStatusTrap, phyStatusGroup=phyStatusGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsPeaks=dfsPeaks, bridgeGroup=bridgeGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, snmpControl=snmpControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTableIndex=ethernetPriorityTableIndex, altitude=altitude, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, phyControl=phyControl, sNTPServerTableEntry=sNTPServerTableEntry, dfsGroup=dfsGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSync=sNTPSync, regionCode=regionCode, transmitChannel=transmitChannel, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, channelBLoopbackTrap=channelBLoopbackTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, channelALoopbackTrap=channelALoopbackTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, groupID=groupID, syslogControl=syslogControl, subnetMask=subnetMask, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteRxTargetPower=remoteRxTargetPower, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rawReceivePower=rawReceivePower, supplementaryGroup=supplementaryGroup, productVariant=productVariant, channelALineCode=channelALineCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortDisabledWarning=managementPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, userTableIndex=userTableIndex, latitude=latitude, managementPortStatusTrap=managementPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, encryption=encryption, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, secureModeAlarmTrap=secureModeAlarmTrap, iPv4Address=iPv4Address, maximumTransmitPower=maximumTransmitPower, dSCPManagementPriority=dSCPManagementPriority, dfsTable=dfsTable, dfsMeans=dfsMeans, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptmp=ptmp, userTable=userTable, localPacketFiltering=localPacketFiltering, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortStatus=managementPortStatus, regionCodeTrap=regionCodeTrap, sMTPServerIPAddress=sMTPServerIPAddress, userName=userName, dfsTableIndex=dfsTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, dataPortAutoMdix=dataPortAutoMdix, telnetAccessEnabled=telnetAccessEnabled, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, telecom=telecom, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementMode=managementMode, ethernetPriorityTable=ethernetPriorityTable)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsInterface=telecomsInterface, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControlGroup=snmpControlGroup, userEnabled=userEnabled, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, sNTPServerRetries=sNTPServerRetries, tFTPServerInternetAddress=tFTPServerInternetAddress, sntp=sntp, rxColorCode=rxColorCode, cableLoss=cableLoss, ethernetGroup=ethernetGroup, linkName=linkName, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpCompliance=ptpCompliance, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecomsChannelSelection=telecomsChannelSelection, systemReset=systemReset, aAAControlGroup=aAAControlGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, aAAControl=aAAControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementGroup=managementGroup, channelALoopback=channelALoopback, iPv6Address=iPv6Address, alarmsGroup=alarmsGroup, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, ethernetFiberSupport=ethernetFiberSupport, installArmStateTrap=installArmStateTrap, remoteInternetAddressType=remoteInternetAddressType, aggregateDataRate=aggregateDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsTableNumber=dfsTableNumber)
