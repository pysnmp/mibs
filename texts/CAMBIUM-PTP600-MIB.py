...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyStatusGroup=phyStatusGroup, cambium=cambium, l2CPPriorityTableNumber=l2CPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, accessMethod=accessMethod, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, groupID=groupID, bridge=bridge, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPLastSync=sNTPLastSync, ethernet=ethernet, vLANManagementVID=vLANManagementVID, sNTPServerTableIndex=sNTPServerTableIndex, telecomsInterface=telecomsInterface, hardwareVersion=hardwareVersion, channelBCableLength=channelBCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, configurationGroup=configurationGroup, dfsTableNumber=dfsTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, iPVersion=iPVersion, pubStatsGroup=pubStatsGroup, userRole=userRole, encryption=encryption, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, alarmsGroup=alarmsGroup, linkSymmetry=linkSymmetry, configuration=configuration, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, receivePower=receivePower, telecomsChannelAStatus=telecomsChannelAStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, searchState=searchState, snmpControl=snmpControl, sNTPPrimaryServer=sNTPPrimaryServer, encryptionAlgorithm=encryptionAlgorithm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPSPortNumber=hTTPSPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, latitude=latitude, receiveModulationMode=receiveModulationMode, softwareVersion=softwareVersion, receiveChannel=receiveChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteInternetAddress=remoteInternetAddress, localPacketFiltering=localPacketFiltering, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerTable=sNTPServerTable, dfsMeans=dfsMeans, ptp=ptp, ptpCompliance=ptpCompliance, iPDSCPPriorityTable=iPDSCPPriorityTable, channelALoopback=channelALoopback, aAAControlGroup=aAAControlGroup, txColorCode=txColorCode, telnetPortNumber=telnetPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, channelBLoopbackTrap=channelBLoopbackTrap, productName=productName, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfs=dfs, sNTPServerInternetAddressType=sNTPServerInternetAddressType, productVariant=productVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, subnetMask=subnetMask, targetRange=targetRange, sNTPServerTableEntry=sNTPServerTableEntry, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, targetMACAddress=targetMACAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, frequencyVariant=frequencyVariant, ptp600=ptp600, sNTPSyncTrap=sNTPSyncTrap, notificationsGroup=notificationsGroup, channelALoopbackTrap=channelALoopbackTrap, eIRP=eIRP, userEnabled=userEnabled, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, telnetAccessEnabled=telnetAccessEnabled, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, dfsPeaks=dfsPeaks, telecomsChannelSelection=telecomsChannelSelection, gatewayIPAddress=gatewayIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtpGroup=smtpGroup, iPv6GatewayAddress=iPv6GatewayAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkName=linkName, bridgeGroup=bridgeGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementPortStatus=managementPortStatus, syslogClientTrap=syslogClientTrap, supplementary=supplementary, supplementaryGroup=supplementaryGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, rxColorCode=rxColorCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, ethernetPriorityTable=ethernetPriorityTable, iPv6PrefixLength=iPv6PrefixLength, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, telecomGroup=telecomGroup, userPassword=userPassword, remoteIPAddress=remoteIPAddress, transmitChannel=transmitChannel, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, channelACableLength=channelACableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, tDDControl=tDDControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBandwidth=channelBandwidth, channelALineCode=channelALineCode, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, reset=reset, securityLevel=securityLevel, aAAControl=aAAControl, vectorError=vectorError, byteErrorRatio=byteErrorRatio, versionsGroup=versionsGroup, sNMPPortNumber=sNMPPortNumber, userTable=userTable, sNTPState=sNTPState, altitude=altitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userTableIndex=userTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, secureModeAlarmTrap=secureModeAlarmTrap, longitude=longitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv4Address=iPv4Address, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkLoss=linkLoss, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rawReceivePower=rawReceivePower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installArmState=installArmState, tDDSynchronizationMode=tDDSynchronizationMode, tDDControlGroup=tDDControlGroup, dataPortStatus=dataPortStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementMode=managementMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatus=telecomsChannelBStatus, systemClock=systemClock, linkModeOptimisation=linkModeOptimisation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, ethernetBridgingStatus=ethernetBridgingStatus, bandwidthVariant=bandwidthVariant, dfsGroup=dfsGroup, secureModeAlarm=secureModeAlarm, managementPortStatusTrap=managementPortStatusTrap, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, sNTPServerRetries=sNTPServerRetries, ethernetGroup=ethernetGroup, receiveModulationModeDetail=receiveModulationModeDetail, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBLoopback=channelBLoopback, phyControl=phyControl, transmitModulationMode=transmitModulationMode, syslogStateTrap=syslogStateTrap, ptmp=ptmp, phyControlGroup=phyControlGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleRegionCodes=incompatibleRegionCodes, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, snmpControlGroup=snmpControlGroup, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveDataRate=receiveDataRate, syslogControl=syslogControl, dataPortDisabledWarning=dataPortDisabledWarning, installStatusTrap=installStatusTrap, hAZLOCConfiguration=hAZLOCConfiguration, channelBLineCode=channelBLineCode, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerIPAddress=tFTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortConfigurationMismatch=managementPortConfigurationMismatch, resetGroup=resetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bootVersion=bootVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, timeZone=timeZone, ptpTraps=ptpTraps, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, systemReset=systemReset, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licence=licence, ptpGroups=ptpGroups, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, transmitDataRate=transmitDataRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, automaticTxPowerControl=automaticTxPowerControl, dataPortFiberStatus=dataPortFiberStatus, iPv6Address=iPv6Address, installStatus=installStatus, userName=userName, daylightSaving=daylightSaving, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rangingMode=rangingMode, sntp=sntp, management=management, remoteRxTargetPower=remoteRxTargetPower, range=range, sNTPServerTableNumber=sNTPServerTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, regionCode=regionCode, channelChangeTrap=channelChangeTrap)
