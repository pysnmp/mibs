...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", rxColorCode=rxColorCode, transmitFreqKHz=transmitFreqKHz, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, syslogControl=syslogControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveChannel=receiveChannel, dfsGroup=dfsGroup, iPVersion=iPVersion, iPv6Address=iPv6Address, remoteInternetAddress=remoteInternetAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receivePower=receivePower, bridgeGroup=bridgeGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, txColorCode=txColorCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveModulationMode=receiveModulationMode, syslogState=syslogState, secureModeAlarm=secureModeAlarm, userName=userName, qOSPriorityScheme=qOSPriorityScheme, securityLevel=securityLevel, unitOutOfCalibration=unitOutOfCalibration, iPv4Address=iPv4Address, targetRange=targetRange, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configuration=configuration, productName=productName, groupID=groupID, hAZLOCConfiguration=hAZLOCConfiguration, siteName=siteName, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, timeZone=timeZone, dataPortStatus=dataPortStatus, iPv6PrefixLength=iPv6PrefixLength, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelBStatus=telecomsChannelBStatus, sNTPSync=sNTPSync, management=management, supplementary=supplementary, syslogClientTrap=syslogClientTrap, supplementaryGroup=supplementaryGroup, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsTable=dfsTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, longitude=longitude, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPv3Enable=sNMPv3Enable, sNMPTrapTable=sNMPTrapTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemReset=systemReset, cambium=cambium, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmState=installArmState, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, accessMethod=accessMethod, aAAControlGroup=aAAControlGroup, syslogControlGroup=syslogControlGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, softwareVersion=softwareVersion, dSCPManagementPriority=dSCPManagementPriority, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, managementMode=managementMode, frequencyVariant=frequencyVariant, channelBLoopbackTrap=channelBLoopbackTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBLineCode=channelBLineCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, bandwidthVariant=bandwidthVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableIndex=sNTPServerTableIndex, channelALineCode=channelALineCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aAAControl=aAAControl, dfs=dfs, dfsTableEntry=dfsTableEntry, transmitPower=transmitPower, secondarySoftwareVersion=secondarySoftwareVersion, channelALoopbackTrap=channelALoopbackTrap, eIRP=eIRP, channelBCableLength=channelBCableLength, sNMPCommunityString=sNMPCommunityString, userRole=userRole, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenceGroup=licenceGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, latitude=latitude, userTableNumber=userTableNumber, snmpControl=snmpControl, telecom=telecom, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelAStatus=telecomsChannelAStatus, telecomsChannelSelection=telecomsChannelSelection, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableNumber=sNTPServerTableNumber, vectorError=vectorError, byteErrorRatio=byteErrorRatio, alarms=alarms, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, notificationsGroup=notificationsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, ptp600=ptp600, aggregateDataRate=aggregateDataRate, resetGroup=resetGroup, managementGroup=managementGroup, remoteRxTargetPower=remoteRxTargetPower, sMTPServerInternetAddress=sMTPServerInternetAddress, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDControlGroup=tDDControlGroup, encryption=encryption, linkModeOptimisation=linkModeOptimisation, dfsPeaks=dfsPeaks, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkSymmetry=linkSymmetry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, versionsGroup=versionsGroup, cableLoss=cableLoss, rawReceivePower=rawReceivePower, hardwareVersion=hardwareVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDControl=tDDControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, regionCode=regionCode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, channelBLoopback=channelBLoopback, phyControlGroup=phyControlGroup, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitModulationMode=transmitModulationMode, altitude=altitude, pubStats=pubStats, phyControl=phyControl, iPv6GatewayAddress=iPv6GatewayAddress, syslogClient=syslogClient, channelALoopback=channelALoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetGroup=ethernetGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, transmitDataRate=transmitDataRate, ethernet=ethernet, versions=versions, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, PYSNMP_MODULE_ID=cambium, telnetAccessEnabled=telnetAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, automaticTxPowerControl=automaticTxPowerControl, userTable=userTable, snmpControlGroup=snmpControlGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTimeout=sNTPServerTimeout, sNTPServerStatus=sNTPServerStatus, sNTPLastSync=sNTPLastSync, remoteIPAddress=remoteIPAddress, userPassword=userPassword, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTableIndex=dfsTableIndex, installStatus=installStatus, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, dataPortStatusTrap=dataPortStatusTrap, telecomGroup=telecomGroup, receiveFreqMHz=receiveFreqMHz, sntp=sntp, managementPortStatus=managementPortStatus, ptp=ptp, vLANManagementVID=vLANManagementVID, ptpTrapPrefix=ptpTrapPrefix, channelACableLength=channelACableLength, noWirelessChannelAvailable=noWirelessChannelAvailable, bridge=bridge, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rangingMode=rangingMode, dfsMeans=dfsMeans, sNMPTrapTableNumber=sNMPTrapTableNumber, gatewayIPAddress=gatewayIPAddress, transmitChannel=transmitChannel, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, phyStatus=phyStatus)
