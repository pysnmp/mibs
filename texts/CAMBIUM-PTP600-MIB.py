...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, syslogStateTrap=syslogStateTrap, subnetMask=subnetMask, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv4Address=iPv4Address, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, masterSlaveMode=masterSlaveMode, dSCPManagementPriority=dSCPManagementPriority, receivePower=receivePower, siteName=siteName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, encryption=encryption, encryptionAlgorithm=encryptionAlgorithm, dfsTableNumber=dfsTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, configuration=configuration, telecomsChannelSelection=telecomsChannelSelection, iPv6PrefixLength=iPv6PrefixLength, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, searchState=searchState, dataPortStatus=dataPortStatus, bandwidthVariant=bandwidthVariant, userName=userName, secureModeAlarmTrap=secureModeAlarmTrap, channelBandwidth=channelBandwidth, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, managementMode=managementMode, channelBLoopbackTrap=channelBLoopbackTrap, versionsGroup=versionsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, timeZone=timeZone, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitDataRate=transmitDataRate, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, frequencyVariant=frequencyVariant, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, licenceGroup=licenceGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptp600=ptp600, alarms=alarms, remoteInternetAddress=remoteInternetAddress, channelALineCode=channelALineCode, rawReceivePower=rawReceivePower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelAStatus=telecomsChannelAStatus, channelACableLength=channelACableLength, altitude=altitude, userTable=userTable, linkName=linkName, smtp=smtp, hTTPAccessEnabled=hTTPAccessEnabled, sNMPPortNumber=sNMPPortNumber, iPv6Address=iPv6Address, sNTPServerTableIndex=sNTPServerTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecom=telecom, iPVersion=iPVersion, hTTPPortNumber=hTTPPortNumber, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, receiveModulationMode=receiveModulationMode, licence=licence, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, dataPortFiberStatus=dataPortFiberStatus, channelBCableLength=channelBCableLength, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, productVariant=productVariant, ethernetFiberSupport=ethernetFiberSupport, ethernet=ethernet, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, range=range, ethernetGroup=ethernetGroup, automaticTxPowerControl=automaticTxPowerControl, phyStatusGroup=phyStatusGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, snmpControlGroup=snmpControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, daylightSaving=daylightSaving, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPollInterval=sNTPPollInterval, antennaGain=antennaGain, receiveDataRate=receiveDataRate, sNMPv3Enable=sNMPv3Enable, remoteIPAddress=remoteIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationStatus=tDDSynchronizationStatus, cableLoss=cableLoss, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsPeaks=dfsPeaks, vectorError=vectorError, linkLoss=linkLoss, eIRP=eIRP, managementPortStatus=managementPortStatus, sNTPServerTableEntry=sNTPServerTableEntry, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, productName=productName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, telecomsInterface=telecomsInterface, regionCode=regionCode, transmitChannel=transmitChannel, phyControlGroup=phyControlGroup, channelBLineCode=channelBLineCode, sNTPPrimaryServer=sNTPPrimaryServer, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, remoteRxTargetPower=remoteRxTargetPower, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtpGroup=smtpGroup, longitude=longitude, l2CPPriorityTable=l2CPPriorityTable, transmitFreqKHz=transmitFreqKHz, tDDControlGroup=tDDControlGroup, management=management, syslogControl=syslogControl, userTableEntry=userTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, ptpCompliance=ptpCompliance, userPassword=userPassword, installStatusTrap=installStatusTrap, cambium=cambium, remoteInternetAddressType=remoteInternetAddressType, versions=versions, managementPortStatusTrap=managementPortStatusTrap, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsGroup=dfsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userRole=userRole, targetMACAddress=targetMACAddress, resetGroup=resetGroup, installStatus=installStatus, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, ptpGroups=ptpGroups, dfsTableIndex=dfsTableIndex, dfs=dfs, regionCodeTrap=regionCodeTrap, transmitModulationMode=transmitModulationMode, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSync=sNTPSync, byteErrorRatio=byteErrorRatio, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, sNTPServerTable=sNTPServerTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelALoopback=channelALoopback, tDDControl=tDDControl, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelALoopbackTrap=channelALoopbackTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, securityLevel=securityLevel, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, latitude=latitude, installArmState=installArmState, syslogState=syslogState, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, dfsTable=dfsTable, syslogControlGroup=syslogControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hAZLOCConfiguration=hAZLOCConfiguration, pubStats=pubStats, bridgeGroup=bridgeGroup, targetRange=targetRange, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableEntry=dfsTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsMeans=dfsMeans, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, sNMPCommunityString=sNMPCommunityString, sNTPServerRetries=sNTPServerRetries, dataPortStatusTrap=dataPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapTable=sNMPTrapTable, phyStatus=phyStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableNumber=userTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telnetPortNumber=telnetPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementVID=vLANManagementVID, sNTPServerStatus=sNTPServerStatus, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableIndex=userTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTraps=ptpTraps, sNTPState=sNTPState, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerPortNumber=tFTPServerPortNumber, bridge=bridge, reset=reset, managementGroup=managementGroup, encryptionGroup=encryptionGroup, channelBLoopback=channelBLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, txColorCode=txColorCode, rangingMode=rangingMode, rxColorCode=rxColorCode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptp=ptp, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, alarmsGroup=alarmsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, bootVersion=bootVersion, groupID=groupID)
