...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subnetMask=subnetMask, configurationGroup=configurationGroup, dfsMeans=dfsMeans, licence=licence, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClientTrap=syslogClientTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, localPacketFiltering=localPacketFiltering, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, byteErrorRatio=byteErrorRatio, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveModulationMode=receiveModulationMode, automaticTxPowerControl=automaticTxPowerControl, targetRange=targetRange, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, ethernetFiberSupport=ethernetFiberSupport, channelALoopbackTrap=channelALoopbackTrap, sNTPState=sNTPState, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementVID=vLANManagementVID, installArmStateTrap=installArmStateTrap, userTable=userTable, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteInternetAddressType=remoteInternetAddressType, resetGroup=resetGroup, alarmsGroup=alarmsGroup, userPassword=userPassword, hTTPAccessEnabled=hTTPAccessEnabled, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, managementPortStatus=managementPortStatus, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionAlgorithm=encryptionAlgorithm, bridge=bridge, antennaGain=antennaGain, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelBLineCode=channelBLineCode, receivePower=receivePower, tFTPServerInternetAddress=tFTPServerInternetAddress, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, tDDControl=tDDControl, iPv6GatewayAddress=iPv6GatewayAddress, softwareVersion=softwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installStatusTrap=installStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecomsInterface=telecomsInterface, telecomsChannelBStatus=telecomsChannelBStatus, systemClock=systemClock, encryption=encryption, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, eIRP=eIRP, range=range, bootVersion=bootVersion, dfsTable=dfsTable, linkSymmetry=linkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecom=telecom, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveChannel=receiveChannel, ptp600=ptp600, managementPortConfigurationMismatch=managementPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntpGroup=sntpGroup, ethernetBridgingStatus=ethernetBridgingStatus, syslogControlGroup=syslogControlGroup, telecomGroup=telecomGroup, telecomsChannelSelection=telecomsChannelSelection, receiveModulationModeDetail=receiveModulationModeDetail, groupID=groupID, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, syslogStateTrap=syslogStateTrap, smtp=smtp, receiveFreqMHz=receiveFreqMHz, phyStatus=phyStatus, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControlGroup=phyControlGroup, sNMPTrapVersion=sNMPTrapVersion, dfsGroup=dfsGroup, sNTPSync=sNTPSync, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, iPVersion=iPVersion, dataPortAutoMdix=dataPortAutoMdix, managementMode=managementMode, sNTPServerTimeout=sNTPServerTimeout, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bandwidthVariant=bandwidthVariant, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortStatusTrap=managementPortStatusTrap, securityLevel=securityLevel, versions=versions, tDDControlGroup=tDDControlGroup, accessMethod=accessMethod, transmitChannel=transmitChannel, rxColorCode=rxColorCode, userTableNumber=userTableNumber, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, maximumTransmitPower=maximumTransmitPower, targetMACAddress=targetMACAddress, cambium=cambium, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, dfsTableEntry=dfsTableEntry, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hTTPSPortNumber=hTTPSPortNumber, userEnabled=userEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, sNTPPollInterval=sNTPPollInterval, ethernet=ethernet, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, cableLoss=cableLoss, sNTPServerTableNumber=sNTPServerTableNumber, regionCode=regionCode, vectorError=vectorError, systemReset=systemReset, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userName=userName, productVariant=productVariant, phyStatusGroup=phyStatusGroup, rangingMode=rangingMode, dSCPManagementPriority=dSCPManagementPriority, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, remoteInternetAddress=remoteInternetAddress, userTableEntry=userTableEntry, channelALoopback=channelALoopback, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, reset=reset, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetBridgingAvailability=ethernetBridgingAvailability, longitude=longitude, rawReceivePower=rawReceivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBCableLength=channelBCableLength, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntp=sntp, iPv4Address=iPv4Address, snmpControl=snmpControl, dfsPeaks=dfsPeaks, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, latitude=latitude, signalStrengthRatio=signalStrengthRatio, txColorCode=txColorCode, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, masterSlaveMode=masterSlaveMode, searchState=searchState, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelALineCode=channelALineCode, transmitPower=transmitPower, dataPortDisabledWarning=dataPortDisabledWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerRetries=sNTPServerRetries, sMTPEnabledMessages=sMTPEnabledMessages, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, ptpGroups=ptpGroups, sNTPServerStatus=sNTPServerStatus, iPv6Address=iPv6Address, secureModeAlarmTrap=secureModeAlarmTrap, managementGroup=managementGroup, hAZLOCConfiguration=hAZLOCConfiguration, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, tDDSynchronizationMode=tDDSynchronizationMode, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, linkName=linkName, sNMPEnabledTraps=sNMPEnabledTraps)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBLoopback=channelBLoopback, dfsTableNumber=dfsTableNumber, installArmState=installArmState, telecomsChannelAStatus=telecomsChannelAStatus, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortStatus=dataPortStatus, dfs=dfs, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogControl=syslogControl, sNTPPrimaryServer=sNTPPrimaryServer, alarms=alarms, incompatibleRegionCodes=incompatibleRegionCodes, altitude=altitude, bridgeGroup=bridgeGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, sNMPv3Enable=sNMPv3Enable, syslogState=syslogState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteRxTargetPower=remoteRxTargetPower, licenceGroup=licenceGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelACableLength=channelACableLength, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarm=secureModeAlarm, notificationsGroup=notificationsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
