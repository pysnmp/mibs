...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, bandwidthVariant=bandwidthVariant, accessMethod=accessMethod, daylightSaving=daylightSaving, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, reset=reset, linkName=linkName, telecomsChannelSelection=telecomsChannelSelection, phyStatusGroup=phyStatusGroup, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, ptp600=ptp600, ethernetGroup=ethernetGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementGroup=managementGroup, versionsGroup=versionsGroup, syslogClient=syslogClient, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogStateTrap=syslogStateTrap, telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bootVersion=bootVersion, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, vLANManagementVID=vLANManagementVID, userTable=userTable, channelBLoopback=channelBLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityTable=ethernetPriorityTable, supplementary=supplementary, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelALoopback=channelALoopback, managementPortConfigurationMismatch=managementPortConfigurationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, bridgeGroup=bridgeGroup, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv6GatewayAddress=iPv6GatewayAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, versions=versions, smtpGroup=smtpGroup, tDDControl=tDDControl, productName=productName, rxColorCode=rxColorCode, receiveModulationModeDetail=receiveModulationModeDetail, l2CPPriorityTableEntry=l2CPPriorityTableEntry, subnetMask=subnetMask, remoteRxTargetPower=remoteRxTargetPower, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, syslogControl=syslogControl, userTableNumber=userTableNumber, sNTPServerRetries=sNTPServerRetries, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, groupID=groupID, alarms=alarms, phyControl=phyControl, sNMPPortNumber=sNMPPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTableEntry=dfsTableEntry, configuration=configuration, ethernetFiberSupport=ethernetFiberSupport, userName=userName, syslogState=syslogState, channelALoopbackTrap=channelALoopbackTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, sntp=sntp, automaticTxPowerControl=automaticTxPowerControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, channelChangeTrap=channelChangeTrap, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveDataRate=receiveDataRate, managementPortStatus=managementPortStatus, dfs=dfs, aAAControl=aAAControl, l2CPPriorityTable=l2CPPriorityTable, secureModeAlarm=secureModeAlarm, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, channelBandwidth=channelBandwidth, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, regionCodeTrap=regionCodeTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableIndex=dfsTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkSymmetry=linkSymmetry, syslogClientTrap=syslogClientTrap, hardwareVersion=hardwareVersion, cambium=cambium, receiveFreqMHz=receiveFreqMHz, iPv6PrefixLength=iPv6PrefixLength, masterSlaveMode=masterSlaveMode, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionGroup=encryptionGroup, targetRange=targetRange, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTable=sNTPServerTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, localPacketFiltering=localPacketFiltering, qOSPriorityScheme=qOSPriorityScheme, sNTPPollInterval=sNTPPollInterval, hTTPSAccessEnabled=hTTPSAccessEnabled, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, bridge=bridge, tDDSynchronizationStatus=tDDSynchronizationStatus, antennaGain=antennaGain, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, telnetAccessEnabled=telnetAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapVersion=sNMPTrapVersion, regionCode=regionCode, ptpTraps=ptpTraps, systemClock=systemClock, transmitChannel=transmitChannel, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPVersion=iPVersion, ptpCompliance=ptpCompliance, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, installArmState=installArmState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPv4Address=iPv4Address, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, licence=licence, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableLoss=cableLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelACableLength=channelACableLength, timeZone=timeZone, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, dataPortStatus=dataPortStatus, iPv6Address=iPv6Address, dataPortFiberStatus=dataPortFiberStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userEnabled=userEnabled, telecomsChannelBStatus=telecomsChannelBStatus, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, telecomsChannelAStatus=telecomsChannelAStatus, installStatusTrap=installStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rawReceivePower=rawReceivePower, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, encryption=encryption, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableEntry=sNTPServerTableEntry, unitOutOfCalibration=unitOutOfCalibration, transmitFreqMHz=transmitFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, ethernetBridgingAvailability=ethernetBridgingAvailability, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, longitude=longitude, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, softwareVersion=softwareVersion, syslogControlGroup=syslogControlGroup, installStatus=installStatus, siteName=siteName, transmitPower=transmitPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, productVariant=productVariant, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerStatus=sNTPServerStatus, txColorCode=txColorCode, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenceGroup=licenceGroup, remoteInternetAddress=remoteInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, receivePower=receivePower, dfsGroup=dfsGroup, vectorError=vectorError, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, channelBLineCode=channelBLineCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secureModeAlarmTrap=secureModeAlarmTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableEntry=userTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, searchState=searchState, configurationGroup=configurationGroup, rangingMode=rangingMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPCommunityString=sNMPCommunityString, sNTPSyncTrap=sNTPSyncTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, channelBCableLength=channelBCableLength, tDDSynchronizationMode=tDDSynchronizationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPSync=sNTPSync, dataPortAutoMdix=dataPortAutoMdix, ethernetBridgingStatus=ethernetBridgingStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userPassword=userPassword, dfsTableNumber=dfsTableNumber, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, supplementaryGroup=supplementaryGroup, eIRP=eIRP, channelBLoopbackTrap=channelBLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, altitude=altitude, phyControlGroup=phyControlGroup, pubStats=pubStats, channelALineCode=channelALineCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkModeOptimisation=linkModeOptimisation, receiveFreqKHz=receiveFreqKHz, sntpGroup=sntpGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpGroups=ptpGroups, constantPowerSpectralDensity=constantPowerSpectralDensity, management=management, resetGroup=resetGroup, range=range, telecom=telecom, transmitFreqKHz=transmitFreqKHz, managementMode=managementMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
