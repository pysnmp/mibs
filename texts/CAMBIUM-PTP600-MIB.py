...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPPortNumber=hTTPPortNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, sNTPServerTable=sNTPServerTable, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sntp=sntp, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, phyControlGroup=phyControlGroup, groupID=groupID, telecomsChannelAStatus=telecomsChannelAStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, aggregateDataRate=aggregateDataRate, wirelessLinkStatus=wirelessLinkStatus, rawReceivePower=rawReceivePower, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, telecomGroup=telecomGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelALoopback=channelALoopback, userTableNumber=userTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecom=telecom, phyControl=phyControl, telnetPortNumber=telnetPortNumber, telecomsChannelSelection=telecomsChannelSelection, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, channelACableLength=channelACableLength, targetRange=targetRange, reset=reset, PYSNMP_MODULE_ID=cambium, rangingMode=rangingMode, channelALineCode=channelALineCode, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, timeZone=timeZone, subnetMask=subnetMask, dfsMeans=dfsMeans, remoteInternetAddress=remoteInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, hAZLOCConfiguration=hAZLOCConfiguration, range=range, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTable=l2CPPriorityTable, aAAControl=aAAControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv4Address=iPv4Address, sMTPEnabledMessages=sMTPEnabledMessages, managementMode=managementMode, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, ptmp=ptmp, supplementary=supplementary, sntpGroup=sntpGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementGroup=managementGroup, ethernetFiberSupport=ethernetFiberSupport, securityLevel=securityLevel, hTTPSPortNumber=hTTPSPortNumber, userTable=userTable, userEnabled=userEnabled, ethernetPriorityTable=ethernetPriorityTable, dSCPManagementPriority=dSCPManagementPriority, installStatus=installStatus, channelChangeTrap=channelChangeTrap, localPacketFiltering=localPacketFiltering, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenceGroup=licenceGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementVID=vLANManagementVID, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarmsGroup=alarmsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, management=management, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, alarms=alarms, bridgeGroup=bridgeGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptp=ptp, snmpControl=snmpControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortFiberStatus=dataPortFiberStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, longitude=longitude, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableEntry=userTableEntry, dfsTableEntry=dfsTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBLineCode=channelBLineCode, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, notificationsGroup=notificationsGroup, configuration=configuration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogState=syslogState, tDDControl=tDDControl, dataPortStatusTrap=dataPortStatusTrap, userName=userName, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, targetMACAddress=targetMACAddress, channelBCableLength=channelBCableLength, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, regionCode=regionCode, linkLoss=linkLoss, dfsTable=dfsTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBLoopback=channelBLoopback, iPv6Address=iPv6Address, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, productVariant=productVariant, iPVersion=iPVersion, sNMPTrapTable=sNMPTrapTable, linkName=linkName, channelBandwidth=channelBandwidth, iPv6GatewayAddress=iPv6GatewayAddress, remoteRxTargetPower=remoteRxTargetPower, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, rxColorCode=rxColorCode, transmitChannel=transmitChannel, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTimeout=sNTPServerTimeout, siteName=siteName, syslogStateTrap=syslogStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptpCompliance=ptpCompliance, licence=licence, installArmStateTrap=installArmStateTrap, sNTPServerRetries=sNTPServerRetries, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, eIRP=eIRP, versions=versions, resetGroup=resetGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, iPv6PrefixLength=iPv6PrefixLength, ethernetBridgingStatus=ethernetBridgingStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, bridge=bridge, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, transmitFreqKHz=transmitFreqKHz, receivePower=receivePower, sNMPv3Enable=sNMPv3Enable, installArmState=installArmState, sNTPPrimaryServer=sNTPPrimaryServer, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, qOSPriorityScheme=qOSPriorityScheme, linkSymmetry=linkSymmetry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptp600=ptp600, smtp=smtp, supplementaryGroup=supplementaryGroup, userPassword=userPassword, channelBLoopbackTrap=channelBLoopbackTrap, managementPortStatus=managementPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfs=dfs, transmitFreqMHz=transmitFreqMHz, bootVersion=bootVersion, userTableIndex=userTableIndex, automaticTxPowerControl=automaticTxPowerControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, sNTPServerTableNumber=sNTPServerTableNumber, masterSlaveMode=masterSlaveMode, txColorCode=txColorCode, vectorError=vectorError, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bandwidthVariant=bandwidthVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableNumber=dfsTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClient=syslogClient, cambium=cambium, phyStatus=phyStatus, syslogControl=syslogControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteIPAddress=remoteIPAddress, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerInternetAddress=sNTPServerInternetAddress, hardwareVersion=hardwareVersion, remoteInternetAddressType=remoteInternetAddressType, daylightSaving=daylightSaving, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsGroup=dfsGroup, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, secureModeAlarmTrap=secureModeAlarmTrap, receiveModulationMode=receiveModulationMode, dataPortStatus=dataPortStatus, linkModeOptimisation=linkModeOptimisation, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortStatusTrap=managementPortStatusTrap, encryptionGroup=encryptionGroup, configurationGroup=configurationGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, latitude=latitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
