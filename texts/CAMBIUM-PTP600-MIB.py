...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatus=phyStatus, dataPortStatus=dataPortStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsMeans=dfsMeans, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, encryption=encryption, subnetMask=subnetMask, userRole=userRole, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, rxColorCode=rxColorCode, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, sntpGroup=sntpGroup, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSync=sNTPSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, timeZone=timeZone, versions=versions, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteInternetAddress=remoteInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, transmitChannel=transmitChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv6Address=iPv6Address, dataPortDisabledWarning=dataPortDisabledWarning, pubStats=pubStats, dataPortAutoMdix=dataPortAutoMdix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatusTrap=dataPortStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, secureModeAlarm=secureModeAlarm, smtpGroup=smtpGroup, byteErrorRatio=byteErrorRatio, resetGroup=resetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, supplementary=supplementary, managementPortStatusTrap=managementPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, securityLevel=securityLevel, syslogClient=syslogClient, remoteRxTargetPower=remoteRxTargetPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpGroups=ptpGroups, bridge=bridge, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, masterSlaveMode=masterSlaveMode, receiveFreqMHz=receiveFreqMHz, configurationGroup=configurationGroup, channelALoopbackTrap=channelALoopbackTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, hardwareVersion=hardwareVersion, receiveFreqKHz=receiveFreqKHz, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telnetPortNumber=telnetPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveDataRate=receiveDataRate, localPacketFiltering=localPacketFiltering, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, eIRP=eIRP, iPv4Address=iPv4Address, dfsPeaks=dfsPeaks, regionCodeTrap=regionCodeTrap, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortDisabledWarning=managementPortDisabledWarning, daylightSaving=daylightSaving, syslogState=syslogState, systemReset=systemReset, range=range, rangingMode=rangingMode, latitude=latitude, sNMPTrapPortNumber=sNMPTrapPortNumber, managementMode=managementMode, alarms=alarms, sNTPServerTableIndex=sNTPServerTableIndex, vectorError=vectorError, ethernetPriorityTable=ethernetPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, longitude=longitude, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptmp=ptmp, channelACableLength=channelACableLength, channelBCableLength=channelBCableLength, txColorCode=txColorCode, dfs=dfs, reset=reset, ethernetBridgingStatus=ethernetBridgingStatus, targetRange=targetRange, cambium=cambium, dfsTableIndex=dfsTableIndex, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsTableEntry=dfsTableEntry, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, encryptionAlgorithm=encryptionAlgorithm, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTable=sNTPServerTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyControlGroup=phyControlGroup, snmpControl=snmpControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBLoopback=channelBLoopback, phyControl=phyControl, automaticTxPowerControl=automaticTxPowerControl, userPassword=userPassword, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelAStatus=telecomsChannelAStatus, iPVersion=iPVersion, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveChannel=receiveChannel, dfsGroup=dfsGroup, dataPortFiberStatus=dataPortFiberStatus, productVariant=productVariant, sNTPServerTimeout=sNTPServerTimeout, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, notificationsGroup=notificationsGroup, licence=licence, tDDControlGroup=tDDControlGroup, supplementaryGroup=supplementaryGroup, siteName=siteName, channelALoopback=channelALoopback, antennaGain=antennaGain, management=management, regionCode=regionCode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPv3Enable=sNMPv3Enable, ptp600=ptp600, configuration=configuration, searchState=searchState, licenceGroup=licenceGroup, altitude=altitude, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, productName=productName, versionsGroup=versionsGroup, receivePower=receivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntp=sntp, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, sNTPServerTableNumber=sNTPServerTableNumber, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBandwidth=channelBandwidth, channelALineCode=channelALineCode, sNTPPollInterval=sNTPPollInterval, userTable=userTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rawReceivePower=rawReceivePower, accessMethod=accessMethod, installArmStateTrap=installArmStateTrap, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, channelBLineCode=channelBLineCode, telecom=telecom, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, ethernet=ethernet, encryptionGroup=encryptionGroup, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, hAZLOCConfiguration=hAZLOCConfiguration, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerStatus=sNTPServerStatus, bandwidthVariant=bandwidthVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementGroup=managementGroup, transmitPower=transmitPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerTableEntry=sNTPServerTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, userName=userName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, l2CPPriorityTable=l2CPPriorityTable, vLANManagementVID=vLANManagementVID, sNTPLastSync=sNTPLastSync, telecomsInterface=telecomsInterface, userTableEntry=userTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, softwareVersion=softwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installStatus=installStatus, channelChangeTrap=channelChangeTrap, sNTPState=sNTPState, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelSelection=telecomsChannelSelection, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomGroup=telecomGroup, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapTable=sNMPTrapTable, managementPortStatus=managementPortStatus, ptp=ptp, tDDControl=tDDControl, ethernetFiberSupport=ethernetFiberSupport, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelBStatus=telecomsChannelBStatus, alarmsGroup=alarmsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages)
