...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, syslogControlGroup=syslogControlGroup, configuration=configuration, notificationsGroup=notificationsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receivePower=receivePower, versionsGroup=versionsGroup, txColorCode=txColorCode, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptmp=ptmp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControlGroup=snmpControlGroup, dataPortStatusTrap=dataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, qOSPriorityScheme=qOSPriorityScheme, smtpGroup=smtpGroup, channelBLoopback=channelBLoopback, installStatus=installStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, transmitModulationMode=transmitModulationMode, ethernetPriorityTable=ethernetPriorityTable, systemReset=systemReset, regionCodeTrap=regionCodeTrap, sNMPTrapTable=sNMPTrapTable, ethernetBridgingStatus=ethernetBridgingStatus, encryption=encryption, snmpControl=snmpControl, ptpTraps=ptpTraps, managementPortStatus=managementPortStatus, managementMode=managementMode, sNTPServerTableNumber=sNTPServerTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteInternetAddress=remoteInternetAddress, searchState=searchState, dSCPManagementPriority=dSCPManagementPriority, receiveChannel=receiveChannel, transmitChannel=transmitChannel, altitude=altitude, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, productName=productName, rangingMode=rangingMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEnabledMessages=sMTPEnabledMessages, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTable=l2CPPriorityTable, dfsPeaks=dfsPeaks, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, pubStats=pubStats, bootVersion=bootVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, range=range, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTableIndex=userTableIndex, reset=reset, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, management=management, tDDControl=tDDControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingAvailability=ethernetBridgingAvailability, linkSymmetry=linkSymmetry, pubStatsGroup=pubStatsGroup, phyControlGroup=phyControlGroup, phyStatus=phyStatus, groupID=groupID, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimisation=linkModeOptimisation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, timeZone=timeZone, softwareVersion=softwareVersion, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp600=ptp600, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogState=syslogState, incompatibleRegionCodes=incompatibleRegionCodes, eIRP=eIRP, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sntp=sntp, dfsMeans=dfsMeans, remoteRxTargetPower=remoteRxTargetPower, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPSync=sNTPSync, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licence=licence, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, sNTPServerTableIndex=sNTPServerTableIndex, encryptionAlgorithm=encryptionAlgorithm, targetRange=targetRange, gatewayIPAddress=gatewayIPAddress, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelBStatus=telecomsChannelBStatus, dfsGroup=dfsGroup, bridgeGroup=bridgeGroup, dataPortStatus=dataPortStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync, ptpCompliance=ptpCompliance, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, userTable=userTable, aggregateDataRate=aggregateDataRate, userRole=userRole, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, PYSNMP_MODULE_ID=cambium, sNTPServerInternetAddress=sNTPServerInternetAddress, regionCode=regionCode, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, alarmsGroup=alarmsGroup, userEnabled=userEnabled, tFTPServerPortNumber=tFTPServerPortNumber, remoteInternetAddressType=remoteInternetAddressType, vLANManagementPriority=vLANManagementPriority, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, iPv6Address=iPv6Address, frequencyVariant=frequencyVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv6PrefixLength=iPv6PrefixLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, rawReceivePower=rawReceivePower, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, localPacketFiltering=localPacketFiltering, telecom=telecom, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyControl=phyControl, managementGroup=managementGroup, channelALineCode=channelALineCode, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, alarms=alarms, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, dfsTableIndex=dfsTableIndex, latitude=latitude, securityLevel=securityLevel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, daylightSaving=daylightSaving, aAAControlGroup=aAAControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelBLineCode=channelBLineCode, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqMHz=receiveFreqMHz, smtp=smtp, sNTPServerStatus=sNTPServerStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernet=ethernet, managementPortStatusTrap=managementPortStatusTrap, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, syslogStateTrap=syslogStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetGroup=ethernetGroup, iPv4Address=iPv4Address, telecomsInterface=telecomsInterface, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPVersion=iPVersion, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, bridge=bridge, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, sntpGroup=sntpGroup, channelBCableLength=channelBCableLength, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTableEntry=ethernetPriorityTableEntry, installArmState=installArmState, channelBLoopbackTrap=channelBLoopbackTrap, antennaGain=antennaGain, iPv6GatewayAddress=iPv6GatewayAddress, channelALoopback=channelALoopback, userName=userName, vectorError=vectorError, sNTPServerIPAddress=sNTPServerIPAddress, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControl=aAAControl, versions=versions, receiveFreqKHz=receiveFreqKHz, telnetPortNumber=telnetPortNumber, userTableEntry=userTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkName=linkName, sNTPServerRetries=sNTPServerRetries, transmitFreqMHz=transmitFreqMHz, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, byteErrorRatio=byteErrorRatio, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, installStatusTrap=installStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelACableLength=channelACableLength, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, automaticTxPowerControl=automaticTxPowerControl, supplementary=supplementary, licenceGroup=licenceGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium, rxColorCode=rxColorCode, secureModeAlarm=secureModeAlarm, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, longitude=longitude, bandwidthVariant=bandwidthVariant, channelALoopbackTrap=channelALoopbackTrap, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryptionGroup=encryptionGroup, telnetAccessEnabled=telnetAccessEnabled, configurationGroup=configurationGroup, userPassword=userPassword, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelAStatus=telecomsChannelAStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPPortNumber=sNMPPortNumber, syslogClient=syslogClient, dfsTable=dfsTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus)
