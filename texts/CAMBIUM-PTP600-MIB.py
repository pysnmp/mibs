...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelALoopbackTrap=channelALoopbackTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetRange=targetRange, pubStats=pubStats, ptmp=ptmp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPLastSync=sNTPLastSync, iPDSCPPriorityTable=iPDSCPPriorityTable, channelALoopback=channelALoopback, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPollInterval=sNTPPollInterval, sNTPServerStatus=sNTPServerStatus, syslogState=syslogState, transmitDataRate=transmitDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, userTableIndex=userTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, phyControlGroup=phyControlGroup, supplementary=supplementary, bridgeGroup=bridgeGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, localPacketFiltering=localPacketFiltering, managementPortDisabledWarning=managementPortDisabledWarning, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, userRole=userRole, licence=licence, supplementaryGroup=supplementaryGroup, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEnabledMessages=sMTPEnabledMessages, tDDControl=tDDControl, ethernetGroup=ethernetGroup, antennaGain=antennaGain, channelBLoopback=channelBLoopback, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPVersion=iPVersion, receiveFreqKHz=receiveFreqKHz, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, syslogClient=syslogClient, phyStatus=phyStatus, managementPortStatus=managementPortStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, bandwidthVariant=bandwidthVariant, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, PYSNMP_MODULE_ID=cambium, channelBCableLength=channelBCableLength, rawReceivePower=rawReceivePower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControlGroup=snmpControlGroup, managementPortStatusTrap=managementPortStatusTrap, installArmState=installArmState, securityLevel=securityLevel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, configuration=configuration, groupID=groupID, sNTPServerTable=sNTPServerTable, telecomsInterface=telecomsInterface, dataPortFiberStatus=dataPortFiberStatus, cableLoss=cableLoss, reset=reset, sNTPServerRetries=sNTPServerRetries, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, txColorCode=txColorCode, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptp600=ptp600, linkName=linkName, transmitFreqKHz=transmitFreqKHz, telecom=telecom, mPLSTCPriorityTable=mPLSTCPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomGroup=telecomGroup, channelALineCode=channelALineCode, eIRP=eIRP, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secureModeAlarm=secureModeAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, altitude=altitude, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitPower=transmitPower, iPv6Address=iPv6Address, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, automaticTxPowerControl=automaticTxPowerControl, linkLoss=linkLoss, receiveFreqMHz=receiveFreqMHz, userTableNumber=userTableNumber, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapIPAddress=sNMPTrapIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, dfs=dfs, searchState=searchState, channelACableLength=channelACableLength, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClientTrap=syslogClientTrap, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, telecomsChannelBStatus=telecomsChannelBStatus, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, versions=versions, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatus=wirelessLinkStatus, sMTPEmailAlert=sMTPEmailAlert, sNMPv3Enable=sNMPv3Enable, smtp=smtp, telecomsChannelAStatus=telecomsChannelAStatus, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteRxTargetPower=remoteRxTargetPower, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, dfsTableEntry=dfsTableEntry, syslogControl=syslogControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, systemReset=systemReset, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernet=ethernet, dfsTableIndex=dfsTableIndex, systemClock=systemClock, tDDControlGroup=tDDControlGroup, vLANManagementVID=vLANManagementVID, range=range, transmitModulationMode=transmitModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, dfsTableNumber=dfsTableNumber, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bridge=bridge, siteName=siteName, configurationGroup=configurationGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, userName=userName, management=management, linkSymmetry=linkSymmetry, l2CPPriorityTable=l2CPPriorityTable, userEnabled=userEnabled, ethernetPriorityTable=ethernetPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, sNTPSync=sNTPSync, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, vectorError=vectorError, dfsGroup=dfsGroup, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, rangingMode=rangingMode, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, versionsGroup=versionsGroup, accessMethod=accessMethod, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, alarmsGroup=alarmsGroup, receiveChannel=receiveChannel, byteErrorRatio=byteErrorRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteInternetAddress=remoteInternetAddress, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, masterSlaveMode=masterSlaveMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsTable=dfsTable, ethernetBridgingStatus=ethernetBridgingStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, sntp=sntp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogControlGroup=syslogControlGroup, rxColorCode=rxColorCode, channelBLineCode=channelBLineCode, dfsMeans=dfsMeans, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelChangeTrap=channelChangeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, latitude=latitude, ethernetBridgingAvailability=ethernetBridgingAvailability, ptpTrapPrefix=ptpTrapPrefix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPState=sNTPState, daylightSaving=daylightSaving, constantPowerSpectralDensity=constantPowerSpectralDensity, userPassword=userPassword, cambium=cambium, smtpGroup=smtpGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCodeTrap=regionCodeTrap, alarms=alarms, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, receivePower=receivePower, longitude=longitude, telecomsChannelSelection=telecomsChannelSelection, userTableEntry=userTableEntry, qOSPriorityScheme=qOSPriorityScheme, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, bootVersion=bootVersion, managementMode=managementMode, subnetMask=subnetMask, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryption=encryption)
