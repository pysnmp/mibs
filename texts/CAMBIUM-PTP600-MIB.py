...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitFreqKHz=transmitFreqKHz, sNTPServerRetries=sNTPServerRetries, ethernetGroup=ethernetGroup, txColorCode=txColorCode, range=range, ptpGroups=ptpGroups, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelACableLength=channelACableLength, bootVersion=bootVersion, configuration=configuration, longitude=longitude, hAZLOCConfiguration=hAZLOCConfiguration, softwareVersion=softwareVersion, phyControlGroup=phyControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBCableLength=channelBCableLength, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogClient=syslogClient, iPVersion=iPVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelSelection=telecomsChannelSelection, sNTPSyncTrap=sNTPSyncTrap, transmitChannel=transmitChannel, dfsGroup=dfsGroup, linkLoss=linkLoss, latitude=latitude, ptp=ptp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBLineCode=channelBLineCode, licence=licence, wirelessLinkStatus=wirelessLinkStatus, smtp=smtp, wirelessLinkAvailability=wirelessLinkAvailability, groupID=groupID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogClientTrap=syslogClientTrap, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, userTable=userTable, systemReset=systemReset, rxColorCode=rxColorCode, searchState=searchState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, installArmStateTrap=installArmStateTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, sNMPCommunityString=sNMPCommunityString, rawReceivePower=rawReceivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptmp=ptmp, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelBStatus=telecomsChannelBStatus, userPassword=userPassword, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogState=syslogState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userRole=userRole, sNTPServerTable=sNTPServerTable, productVariant=productVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, phyStatusGroup=phyStatusGroup, managementMode=managementMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, siteName=siteName, dfsTable=dfsTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sntp=sntp, userTableIndex=userTableIndex, channelALoopback=channelALoopback, management=management, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, transmitFreqMHz=transmitFreqMHz, receivePower=receivePower, receiveDataRate=receiveDataRate, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNTPLastSync=sNTPLastSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, localPacketFiltering=localPacketFiltering, reset=reset, targetRange=targetRange, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPState=sNTPState, sNTPServerTableNumber=sNTPServerTableNumber, managementPortStatusTrap=managementPortStatusTrap, receiveFreqKHz=receiveFreqKHz, dataPortAutoMdix=dataPortAutoMdix, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, regionCodeTrap=regionCodeTrap, qOSPriorityScheme=qOSPriorityScheme, remoteInternetAddress=remoteInternetAddress, regionCode=regionCode, ptpCompliance=ptpCompliance, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogControl=syslogControl, ptpTrapPrefix=ptpTrapPrefix, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userName=userName, aAAControlGroup=aAAControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyStatus=phyStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, PYSNMP_MODULE_ID=cambium, pubStats=pubStats, dfs=dfs, smtpGroup=smtpGroup, installArmState=installArmState, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vLANManagementPriority=vLANManagementPriority, dataPortFiberStatusTrap=dataPortFiberStatusTrap, systemClock=systemClock, syslogStateTrap=syslogStateTrap, linkSymmetry=linkSymmetry, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installStatusTrap=installStatusTrap, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTableEntry=sNTPServerTableEntry, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernet=ethernet, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, snmpControl=snmpControl, telecomsChannelAStatus=telecomsChannelAStatus, telecomGroup=telecomGroup, iPv6Address=iPv6Address, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, antennaGain=antennaGain, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, iPDSCPPriorityTable=iPDSCPPriorityTable, bridge=bridge, sNTPServerStatus=sNTPServerStatus, licenceGroup=licenceGroup, userEnabled=userEnabled, bandwidthVariant=bandwidthVariant, dfsPeaks=dfsPeaks, telecom=telecom, bridgeGroup=bridgeGroup, alarmsGroup=alarmsGroup, productName=productName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatusTrap=dataPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, ethernetPriorityTable=ethernetPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitPower=transmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, userTableNumber=userTableNumber, resetGroup=resetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, alarms=alarms, ethernetFiberSupport=ethernetFiberSupport, securityLevel=securityLevel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, sNTPSync=sNTPSync, encryption=encryption, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, installStatus=installStatus, encryptionGroup=encryptionGroup, channelBLoopback=channelBLoopback, targetMACAddress=targetMACAddress, dSCPManagementPriority=dSCPManagementPriority, ptp600=ptp600, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rangingMode=rangingMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, altitude=altitude, channelALoopbackTrap=channelALoopbackTrap, sntpGroup=sntpGroup, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, constantPowerSpectralDensity=constantPowerSpectralDensity, linkName=linkName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortStatus=managementPortStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, subnetMask=subnetMask, iPv4Address=iPv4Address)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", accessMethod=accessMethod, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, frequencyVariant=frequencyVariant, eIRP=eIRP, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTraps=ptpTraps, aAAControl=aAAControl, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableIndex=dfsTableIndex, telecomsInterface=telecomsInterface, managementGroup=managementGroup, remoteRxTargetPower=remoteRxTargetPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALineCode=channelALineCode, ethernetBridgingStatus=ethernetBridgingStatus, aggregateDataRate=aggregateDataRate, versions=versions, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, cableLoss=cableLoss, supplementary=supplementary, supplementaryGroup=supplementaryGroup, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, receiveChannel=receiveChannel, iPv6GatewayAddress=iPv6GatewayAddress, tDDControl=tDDControl, secureModeAlarm=secureModeAlarm)
