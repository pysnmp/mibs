...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitFreqKHz=transmitFreqKHz, ptp=ptp, productName=productName, aAAControl=aAAControl, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsInterface=telecomsInterface, channelACableLength=channelACableLength, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, managementPortDisabledWarning=managementPortDisabledWarning, licence=licence, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, reset=reset, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userEnabled=userEnabled, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDDControlGroup=tDDControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, userTableNumber=userTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp600=ptp600, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, cambium=cambium, remoteInternetAddressType=remoteInternetAddressType, telnetPortNumber=telnetPortNumber, sntp=sntp, txColorCode=txColorCode, vLANManagementVID=vLANManagementVID, linkName=linkName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortFiberStatus=dataPortFiberStatus, dfsPeaks=dfsPeaks, subnetMask=subnetMask, systemClock=systemClock, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, bandwidthVariant=bandwidthVariant, management=management, ptmp=ptmp, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTable=sNTPServerTable, ptpGroups=ptpGroups, securityLevel=securityLevel, eIRP=eIRP, automaticTxPowerControl=automaticTxPowerControl, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpTraps=ptpTraps, iPv6GatewayAddress=iPv6GatewayAddress, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, secureModeAlarm=secureModeAlarm, latitude=latitude, ethernetBridgingStatus=ethernetBridgingStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telnetAccessEnabled=telnetAccessEnabled, remoteRxTargetPower=remoteRxTargetPower, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarms=alarms, receiveChannel=receiveChannel, iPVersion=iPVersion, encryptionAlgorithm=encryptionAlgorithm, channelALineCode=channelALineCode, PYSNMP_MODULE_ID=cambium, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, searchState=searchState, userTable=userTable, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, iPv4Address=iPv4Address, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, timeZone=timeZone, bridgeGroup=bridgeGroup, frequencyVariant=frequencyVariant, dataPortFiberStatusTrap=dataPortFiberStatusTrap, antennaGain=antennaGain, smtpGroup=smtpGroup, ptpCompliance=ptpCompliance, channelBCableLength=channelBCableLength, managementMode=managementMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userName=userName, dfsTableIndex=dfsTableIndex, telecom=telecom, masterSlaveMode=masterSlaveMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configuration=configuration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, targetMACAddress=targetMACAddress, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, sNTPState=sNTPState, channelALoopbackTrap=channelALoopbackTrap, syslogClientTrap=syslogClientTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, rxColorCode=rxColorCode, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerRetries=sNTPServerRetries, accessMethod=accessMethod, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dfsTableEntry=dfsTableEntry, ethernetGroup=ethernetGroup, linkLoss=linkLoss, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapVersion=sNMPTrapVersion, bootVersion=bootVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridge=bridge, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPSPortNumber=hTTPSPortNumber, sNTPServerStatus=sNTPServerStatus, channelBLoopbackTrap=channelBLoopbackTrap, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rawReceivePower=rawReceivePower, aggregateDataRate=aggregateDataRate, sNTPServerTableIndex=sNTPServerTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, snmpControl=snmpControl, sNTPPrimaryServer=sNTPPrimaryServer, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatus=installStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, vectorError=vectorError, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, sMTPEmailAlert=sMTPEmailAlert, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, dfsMeans=dfsMeans, licenceGroup=licenceGroup, regionCode=regionCode, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogControlGroup=syslogControlGroup, targetRange=targetRange, sNTPServerTableEntry=sNTPServerTableEntry, iPv6PrefixLength=iPv6PrefixLength, sNMPv3Enable=sNMPv3Enable, dfsTableNumber=dfsTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, cableLoss=cableLoss, channelBLineCode=channelBLineCode, dataPortStatusTrap=dataPortStatusTrap, vLANManagementPriority=vLANManagementPriority, phyControl=phyControl, syslogControl=syslogControl, rangingMode=rangingMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmStateTrap=installArmStateTrap, syslogState=syslogState, phyControlGroup=phyControlGroup, linkModeOptimisation=linkModeOptimisation, qOSPriorityScheme=qOSPriorityScheme, userTableEntry=userTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6Address=iPv6Address, smtp=smtp, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, dfsGroup=dfsGroup, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, channelALoopback=channelALoopback, telecomsChannelBStatus=telecomsChannelBStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, telecomsChannelSelection=telecomsChannelSelection, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, syslogClient=syslogClient, hTTPPortNumber=hTTPPortNumber, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoMdix=dataPortAutoMdix, sNTPServerTimeout=sNTPServerTimeout, telecomGroup=telecomGroup, sNTPServerTableNumber=sNTPServerTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPLastSync=sNTPLastSync, resetGroup=resetGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementPortStatus=managementPortStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, daylightSaving=daylightSaving, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, encryption=encryption, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, productVariant=productVariant, transmitFreqMHz=transmitFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, range=range, localPacketFiltering=localPacketFiltering, snmpControlGroup=snmpControlGroup, dfsTable=dfsTable, remoteIPAddress=remoteIPAddress, altitude=altitude, phyStatusGroup=phyStatusGroup, channelBLoopback=channelBLoopback, receiveFreqMHz=receiveFreqMHz, phyStatus=phyStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, systemReset=systemReset)
