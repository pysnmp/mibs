...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfs=dfs, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, accessMethod=accessMethod, iPv4Address=iPv4Address, regionCode=regionCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableEntry=userTableEntry, iPVersion=iPVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, aggregateDataRate=aggregateDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, l2CPPriorityTable=l2CPPriorityTable, telecomsChannelAStatus=telecomsChannelAStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, notificationsGroup=notificationsGroup, eIRP=eIRP, productVariant=productVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, telnetPortNumber=telnetPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, supplementaryGroup=supplementaryGroup, securityLevel=securityLevel, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rawReceivePower=rawReceivePower, ptpCompliance=ptpCompliance, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationModeDetail=receiveModulationModeDetail, channelBandwidth=channelBandwidth, sNTPPrimaryServer=sNTPPrimaryServer, receiveChannel=receiveChannel, receiveFreqMHz=receiveFreqMHz, ptpTrapPrefix=ptpTrapPrefix, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, targetMACAddress=targetMACAddress, systemReset=systemReset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userPassword=userPassword, syslogState=syslogState, userRole=userRole, receiveFreqKHz=receiveFreqKHz, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, maximumTransmitPower=maximumTransmitPower, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenceGroup=licenceGroup, linkLoss=linkLoss, management=management, sNMPPortNumber=sNMPPortNumber, bridgeGroup=bridgeGroup, channelChangeTrap=channelChangeTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, softwareVersion=softwareVersion, frequencyVariant=frequencyVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, searchState=searchState, vLANManagementVID=vLANManagementVID, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPState=sNTPState, timeZone=timeZone, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, sNTPSyncTrap=sNTPSyncTrap, rangingMode=rangingMode, telecomsChannelBStatus=telecomsChannelBStatus, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, iPDSCPPriorityTable=iPDSCPPriorityTable, smtpGroup=smtpGroup, channelBLoopback=channelBLoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, masterSlaveMode=masterSlaveMode, txColorCode=txColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, sNTPServerTimeout=sNTPServerTimeout, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsInterface=telecomsInterface, ptpGroups=ptpGroups, installStatusTrap=installStatusTrap, cambium=cambium, licence=licence, telecomsChannelSelection=telecomsChannelSelection, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, userEnabled=userEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortStatus=managementPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, siteName=siteName, sNTPSync=sNTPSync, linkName=linkName, regionCodeTrap=regionCodeTrap, secureModeAlarmTrap=secureModeAlarmTrap, sntpGroup=sntpGroup, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, targetRange=targetRange, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkSymmetry=linkSymmetry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, bridge=bridge, resetGroup=resetGroup, alarms=alarms, dfsTable=dfsTable, sNMPEnabledTraps=sNMPEnabledTraps, aAAControl=aAAControl, ethernetGroup=ethernetGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelALoopbackTrap=channelALoopbackTrap, ptp600=ptp600, secureModeAlarm=secureModeAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerPortNumber=tFTPServerPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, localPacketFiltering=localPacketFiltering, managementPortStatusTrap=managementPortStatusTrap, dfsPeaks=dfsPeaks, syslogControl=syslogControl, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALoopback=channelALoopback, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, sNTPLastSync=sNTPLastSync, channelBLineCode=channelBLineCode, automaticTxPowerControl=automaticTxPowerControl, dataPortAutoMdix=dataPortAutoMdix, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, latitude=latitude, signalStrengthRatio=signalStrengthRatio, dfsMeans=dfsMeans, antennaGain=antennaGain, dataPortDisabledWarning=dataPortDisabledWarning, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelACableLength=channelACableLength, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerStatus=sNTPServerStatus, installStatus=installStatus, systemClock=systemClock, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, channelBCableLength=channelBCableLength, ethernet=ethernet, sNTPServerTableIndex=sNTPServerTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, productName=productName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqKHz=transmitFreqKHz, longitude=longitude, ptp=ptp, reset=reset, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, ptpTraps=ptpTraps, sNTPServerTable=sNTPServerTable, dfsTableIndex=dfsTableIndex, userName=userName, dataPortStatusTrap=dataPortStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, dSCPManagementPriority=dSCPManagementPriority, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitChannel=transmitChannel, bandwidthVariant=bandwidthVariant, range=range, tDDControl=tDDControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitPower=transmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, snmpControlGroup=snmpControlGroup, groupID=groupID, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, remoteInternetAddress=remoteInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClientTrap=syslogClientTrap, receiveDataRate=receiveDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, dataPortFiberStatus=dataPortFiberStatus, hAZLOCConfiguration=hAZLOCConfiguration, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDControlGroup=tDDControlGroup, versionsGroup=versionsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecom=telecom, iPv6PrefixLength=iPv6PrefixLength, rxColorCode=rxColorCode, altitude=altitude, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsGroup=dfsGroup, installArmState=installArmState, iPv6Address=iPv6Address, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, vLANManagementPriority=vLANManagementPriority, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelALineCode=channelALineCode, managementMode=managementMode, sNTPPollInterval=sNTPPollInterval, sNTPServerRetries=sNTPServerRetries, versions=versions, phyStatusGroup=phyStatusGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex)
