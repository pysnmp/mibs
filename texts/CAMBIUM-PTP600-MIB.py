...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:12:14 2022
...
Counter32, Counter64, Unsigned32, iso, MibIdentifier, TimeTicks, NotificationType, IpAddress, Bits, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "iso", "MibIdentifier", "TimeTicks", "NotificationType", "IpAddress", "Bits", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControlGroup=aAAControlGroup, maximumTransmitPower=maximumTransmitPower, ptpCompliance=ptpCompliance, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, byteErrorRatio=byteErrorRatio, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, groupID=groupID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, receiveDataRate=receiveDataRate, userTable=userTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, timeZone=timeZone, installArmStateTrap=installArmStateTrap, versions=versions, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, reset=reset, dataPortFiberStatus=dataPortFiberStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, rxColorCode=rxColorCode, channelBLoopbackTrap=channelBLoopbackTrap, dfsGroup=dfsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTableIndex=sNTPServerTableIndex, management=management, syslogClient=syslogClient, alarmsGroup=alarmsGroup, managementMode=managementMode, txColorCode=txColorCode, searchState=searchState, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortStatusTrap=managementPortStatusTrap, encryptionGroup=encryptionGroup, phyControlGroup=phyControlGroup, vLANManagementPriority=vLANManagementPriority, sNMPTrapVersion=sNMPTrapVersion, syslogControlGroup=syslogControlGroup, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStats=pubStats, secondarySoftwareVersion=secondarySoftwareVersion, userEnabled=userEnabled, dfsTableIndex=dfsTableIndex, sNTPServerTimeout=sNTPServerTimeout, transmitFreqKHz=transmitFreqKHz, managementPortStatus=managementPortStatus, notificationsGroup=notificationsGroup, iPv4Address=iPv4Address, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptp600=ptp600, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerRetries=sNTPServerRetries, licenceGroup=licenceGroup, installStatus=installStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, telecomsInterface=telecomsInterface, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, snmpControlGroup=snmpControlGroup, channelALoopback=channelALoopback, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, receivePower=receivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTable=sNTPServerTable, channelACableLength=channelACableLength, sNMPTrapTable=sNMPTrapTable, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, siteName=siteName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelALoopbackTrap=channelALoopbackTrap, softwareVersion=softwareVersion, dfsTable=dfsTable, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, sNTPServerIPAddress=sNTPServerIPAddress, latitude=latitude, aAAControl=aAAControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfs=dfs, cableLoss=cableLoss, systemClock=systemClock, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, receiveFreqMHz=receiveFreqMHz, userTableNumber=userTableNumber, accessMethod=accessMethod, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv6PrefixLength=iPv6PrefixLength, iPVersion=iPVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licence=licence, telnetPortNumber=telnetPortNumber, systemReset=systemReset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, ethernetPriorityTable=ethernetPriorityTable, targetRange=targetRange, altitude=altitude, tFTPServerIPAddress=tFTPServerIPAddress, linkLoss=linkLoss, productName=productName, longitude=longitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sntp=sntp, telecomGroup=telecomGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, versionsGroup=versionsGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPv3Enable=sNMPv3Enable, ptmp=ptmp, channelBLineCode=channelBLineCode, hTTPAccessEnabled=hTTPAccessEnabled, dfsPeaks=dfsPeaks, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ptpGroups=ptpGroups, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPPortNumber=sNMPPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, sNTPPollInterval=sNTPPollInterval, ptpTraps=ptpTraps, channelBLoopback=channelBLoopback, remoteRxTargetPower=remoteRxTargetPower, telecom=telecom, phyStatus=phyStatus, receiveFreqKHz=receiveFreqKHz, remoteIPAddress=remoteIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerStatus=sNTPServerStatus, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, range=range, hAZLOCConfiguration=hAZLOCConfiguration, managementPortDisabledWarning=managementPortDisabledWarning, sntpGroup=sntpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableEntry=dfsTableEntry, subnetMask=subnetMask, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogState=syslogState, ptp=ptp, snmpControl=snmpControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, ethernet=ethernet, managementGroup=managementGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userName=userName, hardwareVersion=hardwareVersion, smtp=smtp, ethernetGroup=ethernetGroup, targetMACAddress=targetMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installStatusTrap=installStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, linkSymmetry=linkSymmetry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, dfsTableNumber=dfsTableNumber, installArmState=installArmState, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, localPacketFiltering=localPacketFiltering, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, bridgeGroup=bridgeGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, transmitPower=transmitPower, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, securityLevel=securityLevel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarms=alarms, frequencyVariant=frequencyVariant, channelBCableLength=channelBCableLength, supplementary=supplementary, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex, phyStatusGroup=phyStatusGroup, iPv6Address=iPv6Address, bridge=bridge, supplementaryGroup=supplementaryGroup, telecomsChannelAStatus=telecomsChannelAStatus, productVariant=productVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, userRole=userRole, dataPortConfigurationMismatch=dataPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, l2CPPriorityTable=l2CPPriorityTable, dfsMeans=dfsMeans, sNMPTrapTableEntry=sNMPTrapTableEntry, linkName=linkName, automaticTxPowerControl=automaticTxPowerControl, rawReceivePower=rawReceivePower, secureModeAlarm=secureModeAlarm, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClientTrap=syslogClientTrap, signalStrengthRatio=signalStrengthRatio, tDDControlGroup=tDDControlGroup, vLANManagementVID=vLANManagementVID, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, syslogStateTrap=syslogStateTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cambium=cambium, sNTPSync=sNTPSync, remoteInternetAddressType=remoteInternetAddressType, pubStatsGroup=pubStatsGroup, rangingMode=rangingMode, receiveChannel=receiveChannel, hTTPSPortNumber=hTTPSPortNumber, receiveModulationMode=receiveModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelChangeTrap=channelChangeTrap, userTableEntry=userTableEntry, eIRP=eIRP, resetGroup=resetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, daylightSaving=daylightSaving, tDDControl=tDDControl, dataPortStatus=dataPortStatus, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTable=iPDSCPPriorityTable, channelALineCode=channelALineCode, secureModeAlarmTrap=secureModeAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTableEntry=ethernetPriorityTableEntry, configuration=configuration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail)
