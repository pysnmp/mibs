...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", rawReceivePower=rawReceivePower, sntp=sntp, channelBLoopbackTrap=channelBLoopbackTrap, bridgeGroup=bridgeGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCodeTrap=regionCodeTrap, channelBCableLength=channelBCableLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, management=management, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetBridgingStatus=ethernetBridgingStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, targetMACAddress=targetMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, supplementary=supplementary, iPDSCPPriorityTable=iPDSCPPriorityTable, smtpGroup=smtpGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBLineCode=channelBLineCode, userTableNumber=userTableNumber, sNTPServerStatus=sNTPServerStatus, latitude=latitude, remoteIPAddress=remoteIPAddress, bridge=bridge, channelALineCode=channelALineCode, licence=licence, receiveModulationModeDetail=receiveModulationModeDetail, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rangingMode=rangingMode, installStatusTrap=installStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sntpGroup=sntpGroup, channelBLoopback=channelBLoopback, longitude=longitude, phyStatusGroup=phyStatusGroup, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, l2CPPriorityTable=l2CPPriorityTable, securityLevel=securityLevel, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, dataPortFiberStatus=dataPortFiberStatus, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configuration=configuration, tDDSynchronizationMode=tDDSynchronizationMode, sNTPPrimaryServer=sNTPPrimaryServer, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, linkLoss=linkLoss, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, sNTPServerRetries=sNTPServerRetries, cableLoss=cableLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitPower=transmitPower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receiveModulationMode=receiveModulationMode, targetRange=targetRange, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secureModeAlarmTrap=secureModeAlarmTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBandwidth=channelBandwidth, managementPortStatus=managementPortStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitModulationMode=transmitModulationMode, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, managementPortDisabledWarning=managementPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userName=userName, alarmsGroup=alarmsGroup, iPv4Address=iPv4Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, reset=reset, pubStats=pubStats, resetGroup=resetGroup, sNTPState=sNTPState, daylightSaving=daylightSaving, sNTPServerInternetAddress=sNTPServerInternetAddress, managementGroup=managementGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, dataPortStatus=dataPortStatus, syslogClient=syslogClient, installStatus=installStatus, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, siteName=siteName, sNTPServerTable=sNTPServerTable, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, systemReset=systemReset, ptp=ptp, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpGroups=ptpGroups, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, supplementaryGroup=supplementaryGroup, linkName=linkName, channelACableLength=channelACableLength, vLANManagementVID=vLANManagementVID, searchState=searchState, smtp=smtp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTimeout=sNTPServerTimeout, sNTPServerIPAddress=sNTPServerIPAddress, transmitDataRate=transmitDataRate, syslogState=syslogState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelChangeTrap=channelChangeTrap, syslogClientTrap=syslogClientTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, transmitFreqKHz=transmitFreqKHz, txColorCode=txColorCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, receiveFreqKHz=receiveFreqKHz, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, dfsTableIndex=dfsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, userTableIndex=userTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelALoopback=channelALoopback, installArmStateTrap=installArmStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, versions=versions, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, byteErrorRatio=byteErrorRatio, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, localPacketFiltering=localPacketFiltering, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, encryption=encryption, altitude=altitude, dfsTable=dfsTable, channelALoopbackTrap=channelALoopbackTrap, hAZLOCConfiguration=hAZLOCConfiguration, sNMPv3Enable=sNMPv3Enable, iPv6Address=iPv6Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernet=ethernet, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPVersion=iPVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDControlGroup=tDDControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptmp=ptmp, snmpControlGroup=snmpControlGroup, userTable=userTable, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteInternetAddress=remoteInternetAddress, regionCode=regionCode, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelBStatus=telecomsChannelBStatus, userEnabled=userEnabled, remoteInternetAddressType=remoteInternetAddressType, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, telecomsInterface=telecomsInterface, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, ptp600=ptp600, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveChannel=receiveChannel, ptpTraps=ptpTraps, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControlGroup=aAAControlGroup, licenceGroup=licenceGroup, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, frequencyVariant=frequencyVariant, tDDControl=tDDControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", automaticTxPowerControl=automaticTxPowerControl, sNTPLastSync=sNTPLastSync, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, ethernetFiberSupport=ethernetFiberSupport, phyControl=phyControl, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControl=snmpControl, sNMPTrapVersion=sNMPTrapVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, qOSPriorityScheme=qOSPriorityScheme, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoMdix=dataPortAutoMdix, managementPortStatusTrap=managementPortStatusTrap, syslogStateTrap=syslogStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, managementMode=managementMode, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControl=aAAControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rxColorCode=rxColorCode, productName=productName, vectorError=vectorError, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogControl=syslogControl, groupID=groupID, syslogControlGroup=syslogControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, PYSNMP_MODULE_ID=cambium, remoteRxTargetPower=remoteRxTargetPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, dfsPeaks=dfsPeaks, dfs=dfs, receiveFreqMHz=receiveFreqMHz, alarms=alarms)
