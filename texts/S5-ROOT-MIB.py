...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, s5EnTop=s5EnTop, PYSNMP_MODULE_ID=s5RootMib, s5ComTrap=s5ComTrap, s5Com=s5Com, atmTraps=atmTraps, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, s5TrTop=s5TrTop, s5AtmTop=s5AtmTop, s5ChaTrap=s5ChaTrap, s5Chassis=s5Chassis, s5RootMib=s5RootMib, s5reg=s5reg, s5EthTrap=s5EthTrap, s5IfExt=s5IfExt, remoteLoginTrap=remoteLoginTrap, stpChangeTrap=stpChangeTrap, s5FdTop=s5FdTop, s5Tok=s5Tok, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, s5Fddi=s5Fddi, s5Traps=s5Traps, s5EnMsTop=s5EnMsTop, s5Agent=s5Agent, s5FddTrap=s5FddTrap)
