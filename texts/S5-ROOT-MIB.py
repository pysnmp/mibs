...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Agent=s5Agent, s5Tcs=s5Tcs, remoteLoginTrap=remoteLoginTrap, bnLogMsg=bnLogMsg, PYSNMP_MODULE_ID=s5RootMib, s5Eth=s5Eth, stpChangeTrap=stpChangeTrap, s5Fddi=s5Fddi, s5Tok=s5Tok, s5FdTop=s5FdTop, s5AtmTop=s5AtmTop, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, s5Com=s5Com, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5RootMib=s5RootMib, s5EthTrap=s5EthTrap, s5TokTrap=s5TokTrap, s5EnMsTop=s5EnMsTop, s5FddTrap=s5FddTrap, s5ComTrap=s5ComTrap, s5Traps=s5Traps, s5reg=s5reg, s5EcellTrap=s5EcellTrap, s5IfExt=s5IfExt, atmTraps=atmTraps)
