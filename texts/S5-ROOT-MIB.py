...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EthTrap=s5EthTrap, s5Traps=s5Traps, stpChangeTrap=stpChangeTrap, s5Eth=s5Eth, PYSNMP_MODULE_ID=s5RootMib, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, s5ChaTrap=s5ChaTrap, s5RootMib=s5RootMib, s5Com=s5Com, s5IfExt=s5IfExt, s5FddTrap=s5FddTrap, bnLogMsg=bnLogMsg, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, s5Tcs=s5Tcs, s5Agent=s5Agent, s5AtmTop=s5AtmTop, atmTraps=atmTraps, s5TokTrap=s5TokTrap, s5FdTop=s5FdTop, s5EcellTrap=s5EcellTrap, s5Tok=s5Tok, s5EnMsTop=s5EnMsTop, s5reg=s5reg, s5Fddi=s5Fddi, s5Chassis=s5Chassis)
