...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5IfExt=s5IfExt, s5FddTrap=s5FddTrap, s5ChaTrap=s5ChaTrap, s5Tok=s5Tok, s5ComTrap=s5ComTrap, s5TokTrap=s5TokTrap, bnLogMsg=bnLogMsg, s5Com=s5Com, s5Chassis=s5Chassis, atmTraps=atmTraps, s5Traps=s5Traps, PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, s5Fddi=s5Fddi, s5AtmTop=s5AtmTop, s5RootMib=s5RootMib, s5EnTop=s5EnTop, s5TrTop=s5TrTop, s5Eth=s5Eth, s5Agent=s5Agent, s5EnMsTop=s5EnMsTop, s5Tcs=s5Tcs, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, s5FdTop=s5FdTop, remoteLoginTrap=remoteLoginTrap, s5reg=s5reg)
