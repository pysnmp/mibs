...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tcs=s5Tcs, s5EnMsTop=s5EnMsTop, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5TokTrap=s5TokTrap, remoteLoginTrap=remoteLoginTrap, atmTraps=atmTraps, s5RootMib=s5RootMib, s5Fddi=s5Fddi, s5Traps=s5Traps, s5reg=s5reg, s5Tok=s5Tok, s5AtmTop=s5AtmTop, s5Chassis=s5Chassis, s5EthTrap=s5EthTrap, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, PYSNMP_MODULE_ID=s5RootMib, s5ComTrap=s5ComTrap, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5IfExt=s5IfExt, bnLogMsg=bnLogMsg, s5Eth=s5Eth, s5EnTop=s5EnTop, s5EcellTrap=s5EcellTrap, s5Com=s5Com)
