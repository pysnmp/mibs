...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EcellTrap=s5EcellTrap, s5FddTrap=s5FddTrap, s5TrTop=s5TrTop, s5ChaTrap=s5ChaTrap, s5ComTrap=s5ComTrap, bnLogMsg=bnLogMsg, s5Traps=s5Traps, s5EthTrap=s5EthTrap, stpChangeTrap=stpChangeTrap, s5AtmTop=s5AtmTop, s5Com=s5Com, s5EnMsTop=s5EnMsTop, s5Eth=s5Eth, PYSNMP_MODULE_ID=s5RootMib, s5FdTop=s5FdTop, s5Chassis=s5Chassis, s5IfExt=s5IfExt, s5Tok=s5Tok, s5EnTop=s5EnTop, remoteLoginTrap=remoteLoginTrap, s5RootMib=s5RootMib, s5Agent=s5Agent, s5reg=s5reg, s5Tcs=s5Tcs, s5Fddi=s5Fddi, atmTraps=atmTraps, s5TokTrap=s5TokTrap)
