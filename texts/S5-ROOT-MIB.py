...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5reg=s5reg, s5Chassis=s5Chassis, s5Eth=s5Eth, s5EnTop=s5EnTop, s5IfExt=s5IfExt, s5EthTrap=s5EthTrap, s5ComTrap=s5ComTrap, s5Com=s5Com, s5Fddi=s5Fddi, s5RootMib=s5RootMib, s5FddTrap=s5FddTrap, s5TokTrap=s5TokTrap, PYSNMP_MODULE_ID=s5RootMib, s5TrTop=s5TrTop, s5EnMsTop=s5EnMsTop, atmTraps=atmTraps, s5FdTop=s5FdTop, s5Tok=s5Tok, s5EcellTrap=s5EcellTrap, s5Agent=s5Agent, stpChangeTrap=stpChangeTrap, bnLogMsg=bnLogMsg, s5ChaTrap=s5ChaTrap, s5Tcs=s5Tcs, remoteLoginTrap=remoteLoginTrap, s5AtmTop=s5AtmTop, s5Traps=s5Traps)
