...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, stpChangeTrap=stpChangeTrap, s5Com=s5Com, s5EnMsTop=s5EnMsTop, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5Tcs=s5Tcs, atmTraps=atmTraps, s5TokTrap=s5TokTrap, s5AtmTop=s5AtmTop, s5EcellTrap=s5EcellTrap, s5reg=s5reg, s5Chassis=s5Chassis, s5Agent=s5Agent, s5FddTrap=s5FddTrap, s5Eth=s5Eth, s5RootMib=s5RootMib, s5ChaTrap=s5ChaTrap, s5Tok=s5Tok, s5ComTrap=s5ComTrap, s5IfExt=s5IfExt, s5EnTop=s5EnTop, s5Fddi=s5Fddi, s5Traps=s5Traps)
