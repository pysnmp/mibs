...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tok=s5Tok, s5TokTrap=s5TokTrap, s5ChaTrap=s5ChaTrap, s5Com=s5Com, s5reg=s5reg, s5Tcs=s5Tcs, s5Traps=s5Traps, s5AtmTop=s5AtmTop, s5Eth=s5Eth, s5EnMsTop=s5EnMsTop, s5ComTrap=s5ComTrap, s5EcellTrap=s5EcellTrap, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5FddTrap=s5FddTrap, PYSNMP_MODULE_ID=s5RootMib, s5EnTop=s5EnTop, atmTraps=atmTraps, remoteLoginTrap=remoteLoginTrap, s5EthTrap=s5EthTrap, s5RootMib=s5RootMib, s5IfExt=s5IfExt, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5Fddi=s5Fddi, s5Agent=s5Agent, stpChangeTrap=stpChangeTrap)
