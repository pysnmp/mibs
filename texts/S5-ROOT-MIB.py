...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Chassis=s5Chassis, s5Traps=s5Traps, remoteLoginTrap=remoteLoginTrap, s5AtmTop=s5AtmTop, s5Tok=s5Tok, s5TokTrap=s5TokTrap, s5Eth=s5Eth, s5Tcs=s5Tcs, atmTraps=atmTraps, PYSNMP_MODULE_ID=s5RootMib, s5Fddi=s5Fddi, s5EnTop=s5EnTop, s5reg=s5reg, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5RootMib=s5RootMib, s5Agent=s5Agent, s5EthTrap=s5EthTrap, s5EnMsTop=s5EnMsTop, stpChangeTrap=stpChangeTrap, s5TrTop=s5TrTop, s5IfExt=s5IfExt, s5ComTrap=s5ComTrap, s5ChaTrap=s5ChaTrap, s5EcellTrap=s5EcellTrap, s5FddTrap=s5FddTrap, s5Com=s5Com)
