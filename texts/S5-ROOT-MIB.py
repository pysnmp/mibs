...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, s5AtmTop=s5AtmTop, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5ComTrap=s5ComTrap, remoteLoginTrap=remoteLoginTrap, s5EcellTrap=s5EcellTrap, s5Traps=s5Traps, s5Tok=s5Tok, s5Fddi=s5Fddi, s5Agent=s5Agent, s5FdTop=s5FdTop, PYSNMP_MODULE_ID=s5RootMib, atmTraps=atmTraps, s5TokTrap=s5TokTrap, s5Com=s5Com, s5EnMsTop=s5EnMsTop, s5Tcs=s5Tcs, s5Eth=s5Eth, s5ChaTrap=s5ChaTrap, bnLogMsg=bnLogMsg, stpChangeTrap=stpChangeTrap, s5IfExt=s5IfExt, s5EnTop=s5EnTop, s5reg=s5reg, s5RootMib=s5RootMib)
