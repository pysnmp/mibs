...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tok=s5Tok, s5Fddi=s5Fddi, stpChangeTrap=stpChangeTrap, s5EthTrap=s5EthTrap, s5EnTop=s5EnTop, s5EcellTrap=s5EcellTrap, bnLogMsg=bnLogMsg, s5TokTrap=s5TokTrap, s5Traps=s5Traps, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis, s5Eth=s5Eth, s5EnMsTop=s5EnMsTop, atmTraps=atmTraps, s5ChaTrap=s5ChaTrap, s5FdTop=s5FdTop, s5Com=s5Com, s5Agent=s5Agent, s5Tcs=s5Tcs, s5AtmTop=s5AtmTop, s5IfExt=s5IfExt, s5TrTop=s5TrTop, s5ComTrap=s5ComTrap, PYSNMP_MODULE_ID=s5RootMib, s5FddTrap=s5FddTrap, s5reg=s5reg)
