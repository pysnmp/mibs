...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5reg=s5reg, s5Agent=s5Agent, s5Traps=s5Traps, s5TokTrap=s5TokTrap, s5FddTrap=s5FddTrap, s5FdTop=s5FdTop, s5Com=s5Com, s5IfExt=s5IfExt, s5Chassis=s5Chassis, s5AtmTop=s5AtmTop, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, s5TrTop=s5TrTop, s5RootMib=s5RootMib, s5EnMsTop=s5EnMsTop, s5EthTrap=s5EthTrap, remoteLoginTrap=remoteLoginTrap, bnLogMsg=bnLogMsg, s5Tcs=s5Tcs, PYSNMP_MODULE_ID=s5RootMib, s5EnTop=s5EnTop, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5Eth=s5Eth, s5Fddi=s5Fddi, s5ComTrap=s5ComTrap, s5Tok=s5Tok)
