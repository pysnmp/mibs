...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5RootMib=s5RootMib, s5FdTop=s5FdTop, s5Chassis=s5Chassis, s5IfExt=s5IfExt, s5Traps=s5Traps, bnLogMsg=bnLogMsg, s5EthTrap=s5EthTrap, s5EnMsTop=s5EnMsTop, s5Eth=s5Eth, s5TrTop=s5TrTop, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5EnTop=s5EnTop, s5Fddi=s5Fddi, s5Tok=s5Tok, s5ChaTrap=s5ChaTrap, s5TokTrap=s5TokTrap, s5Agent=s5Agent, s5reg=s5reg, s5Com=s5Com, s5AtmTop=s5AtmTop, s5Tcs=s5Tcs, s5ComTrap=s5ComTrap, atmTraps=atmTraps, s5FddTrap=s5FddTrap, s5EcellTrap=s5EcellTrap, remoteLoginTrap=remoteLoginTrap)
