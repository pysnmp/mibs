...
mibBuilder.exportSymbols("S5-ROOT-MIB", stpChangeTrap=stpChangeTrap, s5FdTop=s5FdTop, s5EnMsTop=s5EnMsTop, s5EthTrap=s5EthTrap, s5ComTrap=s5ComTrap, s5Tok=s5Tok, atmTraps=atmTraps, s5ChaTrap=s5ChaTrap, s5Com=s5Com, s5EnTop=s5EnTop, s5FddTrap=s5FddTrap, s5EcellTrap=s5EcellTrap, s5reg=s5reg, s5IfExt=s5IfExt, s5Traps=s5Traps, bnLogMsg=bnLogMsg, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5TrTop=s5TrTop, s5Eth=s5Eth, s5RootMib=s5RootMib, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, s5Chassis=s5Chassis, remoteLoginTrap=remoteLoginTrap, s5Agent=s5Agent, PYSNMP_MODULE_ID=s5RootMib)
