...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EcellTrap=s5EcellTrap, s5Traps=s5Traps, s5Tok=s5Tok, s5IfExt=s5IfExt, s5Com=s5Com, s5Eth=s5Eth, s5Chassis=s5Chassis, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, s5RootMib=s5RootMib, atmTraps=atmTraps, s5EnTop=s5EnTop, PYSNMP_MODULE_ID=s5RootMib, s5TrTop=s5TrTop, s5ComTrap=s5ComTrap, s5EthTrap=s5EthTrap, s5ChaTrap=s5ChaTrap, s5FdTop=s5FdTop, s5TokTrap=s5TokTrap, stpChangeTrap=stpChangeTrap, s5reg=s5reg, remoteLoginTrap=remoteLoginTrap, bnLogMsg=bnLogMsg, s5EnMsTop=s5EnMsTop, s5Tcs=s5Tcs, s5Agent=s5Agent, s5Fddi=s5Fddi)
