...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5RootMib=s5RootMib, s5TrTop=s5TrTop, s5Com=s5Com, s5Tok=s5Tok, bnLogMsg=bnLogMsg, s5Tcs=s5Tcs, atmTraps=atmTraps, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, s5TokTrap=s5TokTrap, PYSNMP_MODULE_ID=s5RootMib, s5Traps=s5Traps, s5Eth=s5Eth, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, s5FdTop=s5FdTop, s5EnMsTop=s5EnMsTop, s5EthTrap=s5EthTrap, s5IfExt=s5IfExt, s5Chassis=s5Chassis, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, remoteLoginTrap=remoteLoginTrap, s5reg=s5reg, s5FddTrap=s5FddTrap)
