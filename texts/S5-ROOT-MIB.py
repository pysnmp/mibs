...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5Tok=s5Tok, bnLogMsg=bnLogMsg, s5AtmTop=s5AtmTop, s5Agent=s5Agent, s5TokTrap=s5TokTrap, s5RootMib=s5RootMib, atmTraps=atmTraps, s5IfExt=s5IfExt, s5Fddi=s5Fddi, s5Chassis=s5Chassis, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, s5reg=s5reg, stpChangeTrap=stpChangeTrap, s5EnTop=s5EnTop, s5FdTop=s5FdTop, s5EthTrap=s5EthTrap, s5Eth=s5Eth, s5Traps=s5Traps, s5ChaTrap=s5ChaTrap, s5Com=s5Com, s5EnMsTop=s5EnMsTop, s5FddTrap=s5FddTrap, s5ComTrap=s5ComTrap, s5Tcs=s5Tcs, s5EcellTrap=s5EcellTrap)
