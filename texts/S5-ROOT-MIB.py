...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, s5TrTop=s5TrTop, s5Eth=s5Eth, s5FddTrap=s5FddTrap, s5Com=s5Com, s5Chassis=s5Chassis, stpChangeTrap=stpChangeTrap, s5Tok=s5Tok, s5reg=s5reg, s5EnTop=s5EnTop, s5EcellTrap=s5EcellTrap, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, s5EnMsTop=s5EnMsTop, s5ChaTrap=s5ChaTrap, s5EthTrap=s5EthTrap, s5RootMib=s5RootMib, s5ComTrap=s5ComTrap, s5Traps=s5Traps, s5Tcs=s5Tcs, PYSNMP_MODULE_ID=s5RootMib, atmTraps=atmTraps, bnLogMsg=bnLogMsg, s5Agent=s5Agent, s5FdTop=s5FdTop)
