...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, s5Com=s5Com, s5ComTrap=s5ComTrap, s5IfExt=s5IfExt, s5EcellTrap=s5EcellTrap, stpChangeTrap=stpChangeTrap, s5EnTop=s5EnTop, s5Tcs=s5Tcs, remoteLoginTrap=remoteLoginTrap, s5Eth=s5Eth, s5reg=s5reg, s5EnMsTop=s5EnMsTop, s5Agent=s5Agent, atmTraps=atmTraps, s5FddTrap=s5FddTrap, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5TrTop=s5TrTop, PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, s5RootMib=s5RootMib, s5Traps=s5Traps, s5Tok=s5Tok, s5ChaTrap=s5ChaTrap, bnLogMsg=bnLogMsg, s5Chassis=s5Chassis, s5FdTop=s5FdTop)
