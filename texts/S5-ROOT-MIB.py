...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EnTop=s5EnTop, s5Traps=s5Traps, bnLogMsg=bnLogMsg, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, s5EthTrap=s5EthTrap, s5RootMib=s5RootMib, s5TokTrap=s5TokTrap, stpChangeTrap=stpChangeTrap, PYSNMP_MODULE_ID=s5RootMib, s5Com=s5Com, s5ChaTrap=s5ChaTrap, s5EnMsTop=s5EnMsTop, s5reg=s5reg, s5Tok=s5Tok, s5Tcs=s5Tcs, atmTraps=atmTraps, s5TrTop=s5TrTop, s5Fddi=s5Fddi, s5FdTop=s5FdTop, s5IfExt=s5IfExt, s5Agent=s5Agent, s5ComTrap=s5ComTrap, remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis)
