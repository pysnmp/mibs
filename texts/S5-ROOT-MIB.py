...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Traps=s5Traps, s5EnTop=s5EnTop, s5Tcs=s5Tcs, s5ComTrap=s5ComTrap, s5Tok=s5Tok, s5Eth=s5Eth, s5EthTrap=s5EthTrap, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, s5RootMib=s5RootMib, s5EcellTrap=s5EcellTrap, s5Fddi=s5Fddi, bnLogMsg=bnLogMsg, s5TokTrap=s5TokTrap, s5Agent=s5Agent, remoteLoginTrap=remoteLoginTrap, s5Com=s5Com, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5EnMsTop=s5EnMsTop, PYSNMP_MODULE_ID=s5RootMib, s5reg=s5reg, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5Chassis=s5Chassis)
