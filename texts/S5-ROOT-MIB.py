...
mibBuilder.exportSymbols("S5-ROOT-MIB", remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis, s5Com=s5Com, s5TrTop=s5TrTop, s5Traps=s5Traps, s5Eth=s5Eth, s5EnMsTop=s5EnMsTop, s5IfExt=s5IfExt, s5FdTop=s5FdTop, s5EnTop=s5EnTop, s5RootMib=s5RootMib, s5Tok=s5Tok, bnLogMsg=bnLogMsg, s5EcellTrap=s5EcellTrap, atmTraps=atmTraps, PYSNMP_MODULE_ID=s5RootMib, s5reg=s5reg, s5AtmTop=s5AtmTop, s5Tcs=s5Tcs, s5FddTrap=s5FddTrap, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, s5ComTrap=s5ComTrap, s5Fddi=s5Fddi, s5EthTrap=s5EthTrap, stpChangeTrap=stpChangeTrap, s5TokTrap=s5TokTrap)
