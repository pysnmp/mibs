...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5FdTop=s5FdTop, s5EnMsTop=s5EnMsTop, stpChangeTrap=stpChangeTrap, s5reg=s5reg, s5Eth=s5Eth, atmTraps=atmTraps, s5AtmTop=s5AtmTop, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, remoteLoginTrap=remoteLoginTrap, s5EthTrap=s5EthTrap, s5IfExt=s5IfExt, s5FddTrap=s5FddTrap, s5EcellTrap=s5EcellTrap, s5Agent=s5Agent, s5Com=s5Com, s5Fddi=s5Fddi, s5TrTop=s5TrTop, s5Traps=s5Traps, s5Chassis=s5Chassis, bnLogMsg=bnLogMsg, s5TokTrap=s5TokTrap, s5ChaTrap=s5ChaTrap, s5RootMib=s5RootMib, s5Tcs=s5Tcs, s5Tok=s5Tok)
