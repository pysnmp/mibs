...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5Traps=s5Traps, s5AtmTop=s5AtmTop, s5Com=s5Com, remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis, atmTraps=atmTraps, s5Agent=s5Agent, s5FdTop=s5FdTop, s5Tcs=s5Tcs, s5TokTrap=s5TokTrap, stpChangeTrap=stpChangeTrap, s5RootMib=s5RootMib, s5Tok=s5Tok, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, s5EnTop=s5EnTop, s5Fddi=s5Fddi, s5EthTrap=s5EthTrap, s5TrTop=s5TrTop, s5reg=s5reg, s5ComTrap=s5ComTrap, s5EnMsTop=s5EnMsTop, s5IfExt=s5IfExt, bnLogMsg=bnLogMsg, s5FddTrap=s5FddTrap, s5ChaTrap=s5ChaTrap)
