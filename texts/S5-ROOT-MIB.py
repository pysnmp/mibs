...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5reg=s5reg, s5EthTrap=s5EthTrap, atmTraps=atmTraps, s5AtmTop=s5AtmTop, s5ComTrap=s5ComTrap, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5RootMib=s5RootMib, s5Com=s5Com, s5EcellTrap=s5EcellTrap, PYSNMP_MODULE_ID=s5RootMib, s5TokTrap=s5TokTrap, s5Traps=s5Traps, s5EnMsTop=s5EnMsTop, s5TrTop=s5TrTop, s5EnTop=s5EnTop, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5FddTrap=s5FddTrap, remoteLoginTrap=remoteLoginTrap, s5Tok=s5Tok, s5Chassis=s5Chassis, s5Fddi=s5Fddi, s5Tcs=s5Tcs, s5Eth=s5Eth, s5IfExt=s5IfExt, stpChangeTrap=stpChangeTrap)
