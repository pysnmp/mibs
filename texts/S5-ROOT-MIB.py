...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tok=s5Tok, s5ComTrap=s5ComTrap, stpChangeTrap=stpChangeTrap, s5EthTrap=s5EthTrap, bnLogMsg=bnLogMsg, s5FddTrap=s5FddTrap, s5IfExt=s5IfExt, s5Traps=s5Traps, s5reg=s5reg, s5Eth=s5Eth, s5TrTop=s5TrTop, s5Com=s5Com, s5RootMib=s5RootMib, s5Fddi=s5Fddi, s5EnTop=s5EnTop, remoteLoginTrap=remoteLoginTrap, s5ChaTrap=s5ChaTrap, s5EnMsTop=s5EnMsTop, s5EcellTrap=s5EcellTrap, s5AtmTop=s5AtmTop, s5Chassis=s5Chassis, s5Tcs=s5Tcs, s5Agent=s5Agent, s5TokTrap=s5TokTrap, s5FdTop=s5FdTop, PYSNMP_MODULE_ID=s5RootMib, atmTraps=atmTraps)
