...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, s5EnTop=s5EnTop, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, s5Eth=s5Eth, PYSNMP_MODULE_ID=s5RootMib, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, s5EnMsTop=s5EnMsTop, s5TrTop=s5TrTop, s5EcellTrap=s5EcellTrap, s5reg=s5reg, s5Tok=s5Tok, atmTraps=atmTraps, s5FdTop=s5FdTop, s5EthTrap=s5EthTrap, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, s5RootMib=s5RootMib, s5Chassis=s5Chassis, s5ComTrap=s5ComTrap, s5IfExt=s5IfExt, s5Com=s5Com, bnLogMsg=bnLogMsg, s5Tcs=s5Tcs)
