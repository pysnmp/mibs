...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5AtmTop=s5AtmTop, s5Eth=s5Eth, s5Tcs=s5Tcs, atmTraps=atmTraps, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, s5EthTrap=s5EthTrap, bnLogMsg=bnLogMsg, s5reg=s5reg, s5Tok=s5Tok, s5EcellTrap=s5EcellTrap, s5FddTrap=s5FddTrap, s5Fddi=s5Fddi, s5ChaTrap=s5ChaTrap, s5FdTop=s5FdTop, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, PYSNMP_MODULE_ID=s5RootMib, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5IfExt=s5IfExt, s5EnMsTop=s5EnMsTop, s5Agent=s5Agent, s5Chassis=s5Chassis, s5Com=s5Com, s5TrTop=s5TrTop, s5TokTrap=s5TokTrap)
