...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TrTop=s5TrTop, s5AtmTop=s5AtmTop, s5Tcs=s5Tcs, s5Com=s5Com, s5EthTrap=s5EthTrap, s5RootMib=s5RootMib, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5TokTrap=s5TokTrap, s5FddTrap=s5FddTrap, s5reg=s5reg, s5Eth=s5Eth, bnLogMsg=bnLogMsg, remoteLoginTrap=remoteLoginTrap, s5Tok=s5Tok, PYSNMP_MODULE_ID=s5RootMib, s5Fddi=s5Fddi, s5Chassis=s5Chassis, s5Traps=s5Traps, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, s5IfExt=s5IfExt, s5Agent=s5Agent, s5FdTop=s5FdTop, s5EnTop=s5EnTop, s5ComTrap=s5ComTrap, s5EnMsTop=s5EnMsTop)
