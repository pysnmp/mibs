...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tok=s5Tok, atmTraps=atmTraps, s5reg=s5reg, PYSNMP_MODULE_ID=s5RootMib, s5IfExt=s5IfExt, s5EthTrap=s5EthTrap, bnLogMsg=bnLogMsg, s5Traps=s5Traps, s5Agent=s5Agent, s5Com=s5Com, s5ChaTrap=s5ChaTrap, s5AtmTop=s5AtmTop, s5EnMsTop=s5EnMsTop, s5RootMib=s5RootMib, s5Fddi=s5Fddi, s5Chassis=s5Chassis, s5FddTrap=s5FddTrap, s5EcellTrap=s5EcellTrap, s5Eth=s5Eth, s5EnTop=s5EnTop, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, s5ComTrap=s5ComTrap, stpChangeTrap=stpChangeTrap, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, s5FdTop=s5FdTop)
