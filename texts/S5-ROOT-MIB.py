...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EthTrap=s5EthTrap, s5Chassis=s5Chassis, s5Eth=s5Eth, s5EnTop=s5EnTop, s5Tcs=s5Tcs, s5EcellTrap=s5EcellTrap, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5TrTop=s5TrTop, stpChangeTrap=stpChangeTrap, bnLogMsg=bnLogMsg, s5ComTrap=s5ComTrap, s5Tok=s5Tok, s5IfExt=s5IfExt, PYSNMP_MODULE_ID=s5RootMib, s5FddTrap=s5FddTrap, s5Agent=s5Agent, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5ChaTrap=s5ChaTrap, s5reg=s5reg, s5EnMsTop=s5EnMsTop, s5FdTop=s5FdTop, s5TokTrap=s5TokTrap, atmTraps=atmTraps, s5Traps=s5Traps, s5Com=s5Com)
