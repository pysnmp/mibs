...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5Traps=s5Traps, s5Agent=s5Agent, s5EnTop=s5EnTop, s5Fddi=s5Fddi, s5ComTrap=s5ComTrap, s5EnMsTop=s5EnMsTop, s5FdTop=s5FdTop, s5Tcs=s5Tcs, s5RootMib=s5RootMib, s5reg=s5reg, s5AtmTop=s5AtmTop, remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis, bnLogMsg=bnLogMsg, atmTraps=atmTraps, s5FddTrap=s5FddTrap, s5Eth=s5Eth, s5IfExt=s5IfExt, s5Tok=s5Tok, s5ChaTrap=s5ChaTrap, s5EthTrap=s5EthTrap, stpChangeTrap=stpChangeTrap, s5Com=s5Com, s5EcellTrap=s5EcellTrap, s5TokTrap=s5TokTrap, s5TrTop=s5TrTop)
