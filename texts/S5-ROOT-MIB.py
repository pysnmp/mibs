...
mibBuilder.exportSymbols("S5-ROOT-MIB", stpChangeTrap=stpChangeTrap, s5reg=s5reg, PYSNMP_MODULE_ID=s5RootMib, s5IfExt=s5IfExt, s5Tok=s5Tok, s5Fddi=s5Fddi, s5FdTop=s5FdTop, s5FddTrap=s5FddTrap, remoteLoginTrap=remoteLoginTrap, s5ChaTrap=s5ChaTrap, s5Eth=s5Eth, s5TokTrap=s5TokTrap, s5EnMsTop=s5EnMsTop, s5ComTrap=s5ComTrap, bnLogMsg=bnLogMsg, s5EcellTrap=s5EcellTrap, s5TrTop=s5TrTop, s5Tcs=s5Tcs, s5Chassis=s5Chassis, s5EthTrap=s5EthTrap, s5RootMib=s5RootMib, s5EnTop=s5EnTop, s5Agent=s5Agent, atmTraps=atmTraps, s5AtmTop=s5AtmTop, s5Com=s5Com, s5Traps=s5Traps)
