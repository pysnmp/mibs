...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EnTop=s5EnTop, s5Chassis=s5Chassis, s5reg=s5reg, stpChangeTrap=stpChangeTrap, s5Tok=s5Tok, atmTraps=atmTraps, s5ComTrap=s5ComTrap, s5Tcs=s5Tcs, s5Com=s5Com, s5EthTrap=s5EthTrap, s5TokTrap=s5TokTrap, s5Traps=s5Traps, s5FddTrap=s5FddTrap, s5IfExt=s5IfExt, s5EcellTrap=s5EcellTrap, s5Eth=s5Eth, s5TrTop=s5TrTop, s5EnMsTop=s5EnMsTop, s5Agent=s5Agent, s5FdTop=s5FdTop, s5ChaTrap=s5ChaTrap, s5AtmTop=s5AtmTop, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, PYSNMP_MODULE_ID=s5RootMib, bnLogMsg=bnLogMsg)
