...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5ComTrap=s5ComTrap, s5Eth=s5Eth, s5EnMsTop=s5EnMsTop, s5Traps=s5Traps, s5Fddi=s5Fddi, bnLogMsg=bnLogMsg, s5reg=s5reg, atmTraps=atmTraps, s5Agent=s5Agent, s5Com=s5Com, s5EcellTrap=s5EcellTrap, s5TokTrap=s5TokTrap, s5IfExt=s5IfExt, s5Tcs=s5Tcs, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, s5Chassis=s5Chassis, s5EthTrap=s5EthTrap, s5AtmTop=s5AtmTop, PYSNMP_MODULE_ID=s5RootMib, s5Tok=s5Tok, stpChangeTrap=stpChangeTrap, s5RootMib=s5RootMib, s5FddTrap=s5FddTrap, s5FdTop=s5FdTop, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap)
