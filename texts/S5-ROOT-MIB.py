...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5Tok=s5Tok, s5TrTop=s5TrTop, s5Chassis=s5Chassis, s5EcellTrap=s5EcellTrap, s5FddTrap=s5FddTrap, s5Eth=s5Eth, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5EnTop=s5EnTop, s5EnMsTop=s5EnMsTop, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5IfExt=s5IfExt, s5Fddi=s5Fddi, s5Traps=s5Traps, s5Com=s5Com, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5Tcs=s5Tcs, s5reg=s5reg, s5EthTrap=s5EthTrap, s5Agent=s5Agent, s5ComTrap=s5ComTrap, s5AtmTop=s5AtmTop, s5TokTrap=s5TokTrap)
