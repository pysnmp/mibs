...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, s5reg=s5reg, remoteLoginTrap=remoteLoginTrap, s5TokTrap=s5TokTrap, s5EnTop=s5EnTop, s5EnMsTop=s5EnMsTop, s5EcellTrap=s5EcellTrap, s5Eth=s5Eth, s5Fddi=s5Fddi, s5Chassis=s5Chassis, s5RootMib=s5RootMib, s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5IfExt=s5IfExt, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, PYSNMP_MODULE_ID=s5RootMib, s5Traps=s5Traps, s5AtmTop=s5AtmTop, s5Agent=s5Agent, s5Tok=s5Tok, s5Tcs=s5Tcs, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5Com=s5Com, s5TrTop=s5TrTop, s5EthTrap=s5EthTrap)
