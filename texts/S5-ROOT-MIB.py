...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5Tok=s5Tok, s5EcellTrap=s5EcellTrap, s5Eth=s5Eth, s5EnTop=s5EnTop, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5TokTrap=s5TokTrap, PYSNMP_MODULE_ID=s5RootMib, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, s5FddTrap=s5FddTrap, s5Traps=s5Traps, s5Chassis=s5Chassis, s5AtmTop=s5AtmTop, s5reg=s5reg, s5TrTop=s5TrTop, stpChangeTrap=stpChangeTrap, bnLogMsg=bnLogMsg, s5EnMsTop=s5EnMsTop, s5EthTrap=s5EthTrap, s5IfExt=s5IfExt, s5Tcs=s5Tcs, s5RootMib=s5RootMib, atmTraps=atmTraps, s5Com=s5Com)
