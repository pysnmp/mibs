...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EcellTrap=s5EcellTrap, s5EnTop=s5EnTop, s5ComTrap=s5ComTrap, s5Eth=s5Eth, s5IfExt=s5IfExt, s5reg=s5reg, s5EthTrap=s5EthTrap, s5Traps=s5Traps, stpChangeTrap=stpChangeTrap, remoteLoginTrap=remoteLoginTrap, s5Com=s5Com, s5AtmTop=s5AtmTop, s5TokTrap=s5TokTrap, s5Tok=s5Tok, s5EnMsTop=s5EnMsTop, atmTraps=atmTraps, s5RootMib=s5RootMib, s5Agent=s5Agent, s5Chassis=s5Chassis, bnLogMsg=bnLogMsg, s5FdTop=s5FdTop, s5ChaTrap=s5ChaTrap, s5TrTop=s5TrTop, s5FddTrap=s5FddTrap, s5Tcs=s5Tcs, s5Fddi=s5Fddi, PYSNMP_MODULE_ID=s5RootMib)
