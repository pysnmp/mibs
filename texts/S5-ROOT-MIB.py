...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EnMsTop=s5EnMsTop, s5ChaTrap=s5ChaTrap, s5FdTop=s5FdTop, s5Fddi=s5Fddi, s5Agent=s5Agent, PYSNMP_MODULE_ID=s5RootMib, bnLogMsg=bnLogMsg, s5EcellTrap=s5EcellTrap, remoteLoginTrap=remoteLoginTrap, s5EnTop=s5EnTop, s5ComTrap=s5ComTrap, s5Com=s5Com, s5Chassis=s5Chassis, s5reg=s5reg, s5EthTrap=s5EthTrap, s5Eth=s5Eth, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, atmTraps=atmTraps, s5TrTop=s5TrTop, s5Tcs=s5Tcs, s5Traps=s5Traps, s5TokTrap=s5TokTrap, s5Tok=s5Tok, s5RootMib=s5RootMib, s5IfExt=s5IfExt)
