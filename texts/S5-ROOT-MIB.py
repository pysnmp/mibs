...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5ComTrap=s5ComTrap, s5Fddi=s5Fddi, s5FddTrap=s5FddTrap, s5FdTop=s5FdTop, s5EthTrap=s5EthTrap, s5Traps=s5Traps, atmTraps=atmTraps, remoteLoginTrap=remoteLoginTrap, s5Tok=s5Tok, s5Agent=s5Agent, s5reg=s5reg, s5Chassis=s5Chassis, s5EnMsTop=s5EnMsTop, s5Com=s5Com, s5RootMib=s5RootMib, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5Eth=s5Eth, s5EnTop=s5EnTop, s5AtmTop=s5AtmTop, bnLogMsg=bnLogMsg, s5TrTop=s5TrTop, s5Tcs=s5Tcs, s5EcellTrap=s5EcellTrap, s5ChaTrap=s5ChaTrap, s5IfExt=s5IfExt, s5TokTrap=s5TokTrap)
