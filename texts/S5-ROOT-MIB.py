...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5RootMib=s5RootMib, bnLogMsg=bnLogMsg, s5ChaTrap=s5ChaTrap, s5EthTrap=s5EthTrap, s5FdTop=s5FdTop, s5ComTrap=s5ComTrap, s5Agent=s5Agent, s5EnMsTop=s5EnMsTop, atmTraps=atmTraps, s5Tcs=s5Tcs, s5TokTrap=s5TokTrap, s5Fddi=s5Fddi, s5FddTrap=s5FddTrap, s5EnTop=s5EnTop, remoteLoginTrap=remoteLoginTrap, s5TrTop=s5TrTop, s5Chassis=s5Chassis, s5Traps=s5Traps, s5Eth=s5Eth, s5reg=s5reg, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, s5IfExt=s5IfExt, s5Tok=s5Tok, s5AtmTop=s5AtmTop)
