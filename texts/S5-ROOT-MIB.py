...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5EthTrap=s5EthTrap, s5TokTrap=s5TokTrap, s5Eth=s5Eth, s5Tcs=s5Tcs, s5EnMsTop=s5EnMsTop, s5EcellTrap=s5EcellTrap, stpChangeTrap=stpChangeTrap, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, PYSNMP_MODULE_ID=s5RootMib, s5Traps=s5Traps, s5Agent=s5Agent, s5Tok=s5Tok, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5Chassis=s5Chassis, s5IfExt=s5IfExt, s5FddTrap=s5FddTrap, bnLogMsg=bnLogMsg, s5ChaTrap=s5ChaTrap, s5reg=s5reg, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, atmTraps=atmTraps, s5RootMib=s5RootMib)
