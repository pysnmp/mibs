...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EcellTrap=s5EcellTrap, stpChangeTrap=stpChangeTrap, s5reg=s5reg, s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, s5ComTrap=s5ComTrap, s5Fddi=s5Fddi, s5Com=s5Com, s5AtmTop=s5AtmTop, bnLogMsg=bnLogMsg, s5Tok=s5Tok, s5TrTop=s5TrTop, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5Traps=s5Traps, atmTraps=atmTraps, s5EnMsTop=s5EnMsTop, s5IfExt=s5IfExt, s5FdTop=s5FdTop, s5TokTrap=s5TokTrap, s5RootMib=s5RootMib, s5Tcs=s5Tcs, remoteLoginTrap=remoteLoginTrap, s5Eth=s5Eth)
