...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, s5Tok=s5Tok, s5Tcs=s5Tcs, s5TokTrap=s5TokTrap, s5Eth=s5Eth, s5Com=s5Com, s5RootMib=s5RootMib, s5Traps=s5Traps, s5ComTrap=s5ComTrap, s5Chassis=s5Chassis, s5reg=s5reg, stpChangeTrap=stpChangeTrap, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5EthTrap=s5EthTrap, s5EcellTrap=s5EcellTrap, s5Agent=s5Agent, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, s5FdTop=s5FdTop, s5EnMsTop=s5EnMsTop, s5FddTrap=s5FddTrap, s5IfExt=s5IfExt, s5EnTop=s5EnTop, PYSNMP_MODULE_ID=s5RootMib)
