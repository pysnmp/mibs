...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tcs=s5Tcs, s5RootMib=s5RootMib, s5EnMsTop=s5EnMsTop, remoteLoginTrap=remoteLoginTrap, s5TrTop=s5TrTop, s5FddTrap=s5FddTrap, s5ChaTrap=s5ChaTrap, s5reg=s5reg, s5Tok=s5Tok, s5EnTop=s5EnTop, s5AtmTop=s5AtmTop, PYSNMP_MODULE_ID=s5RootMib, s5TokTrap=s5TokTrap, s5EcellTrap=s5EcellTrap, s5ComTrap=s5ComTrap, s5Chassis=s5Chassis, s5FdTop=s5FdTop, s5Agent=s5Agent, s5EthTrap=s5EthTrap, s5Com=s5Com, atmTraps=atmTraps, s5Eth=s5Eth, bnLogMsg=bnLogMsg, s5IfExt=s5IfExt, s5Traps=s5Traps, stpChangeTrap=stpChangeTrap, s5Fddi=s5Fddi)
