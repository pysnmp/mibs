...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5AtmTop=s5AtmTop, s5IfExt=s5IfExt, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, s5TrTop=s5TrTop, s5EnTop=s5EnTop, s5Com=s5Com, atmTraps=atmTraps, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, s5ComTrap=s5ComTrap, s5RootMib=s5RootMib, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5TokTrap=s5TokTrap, PYSNMP_MODULE_ID=s5RootMib, s5FddTrap=s5FddTrap, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, s5EthTrap=s5EthTrap, s5Chassis=s5Chassis, s5Tok=s5Tok, s5Tcs=s5Tcs, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, s5reg=s5reg, s5EnMsTop=s5EnMsTop)
