...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5Agent=s5Agent, s5EnTop=s5EnTop, s5FdTop=s5FdTop, s5Eth=s5Eth, s5Tcs=s5Tcs, s5RootMib=s5RootMib, s5FddTrap=s5FddTrap, s5TrTop=s5TrTop, atmTraps=atmTraps, remoteLoginTrap=remoteLoginTrap, s5IfExt=s5IfExt, s5EcellTrap=s5EcellTrap, s5EthTrap=s5EthTrap, s5Fddi=s5Fddi, s5EnMsTop=s5EnMsTop, s5Chassis=s5Chassis, s5AtmTop=s5AtmTop, s5TokTrap=s5TokTrap, s5Com=s5Com, s5Tok=s5Tok, s5reg=s5reg, s5ChaTrap=s5ChaTrap, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, s5ComTrap=s5ComTrap, bnLogMsg=bnLogMsg)
