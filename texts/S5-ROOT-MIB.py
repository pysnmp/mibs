...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5EcellTrap=s5EcellTrap, s5EnTop=s5EnTop, s5EnMsTop=s5EnMsTop, PYSNMP_MODULE_ID=s5RootMib, bnLogMsg=bnLogMsg, s5Traps=s5Traps, s5Tok=s5Tok, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, s5FddTrap=s5FddTrap, s5RootMib=s5RootMib, s5reg=s5reg, atmTraps=atmTraps, s5Chassis=s5Chassis, s5Eth=s5Eth, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, stpChangeTrap=stpChangeTrap, s5EthTrap=s5EthTrap, s5ChaTrap=s5ChaTrap, s5Fddi=s5Fddi, s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5Agent=s5Agent)
