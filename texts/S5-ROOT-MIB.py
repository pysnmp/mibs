...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EcellTrap=s5EcellTrap, s5Com=s5Com, s5TrTop=s5TrTop, s5Traps=s5Traps, s5AtmTop=s5AtmTop, stpChangeTrap=stpChangeTrap, PYSNMP_MODULE_ID=s5RootMib, s5reg=s5reg, s5TokTrap=s5TokTrap, s5Agent=s5Agent, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, s5Tok=s5Tok, s5EthTrap=s5EthTrap, s5Chassis=s5Chassis, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, s5ComTrap=s5ComTrap, s5RootMib=s5RootMib, s5FddTrap=s5FddTrap, s5Tcs=s5Tcs, s5IfExt=s5IfExt, s5Eth=s5Eth, s5EnMsTop=s5EnMsTop, atmTraps=atmTraps)
