...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5reg=s5reg, s5EnTop=s5EnTop, s5RootMib=s5RootMib, bnLogMsg=bnLogMsg, s5ChaTrap=s5ChaTrap, s5Tcs=s5Tcs, s5Agent=s5Agent, s5Com=s5Com, s5FdTop=s5FdTop, s5Tok=s5Tok, s5TrTop=s5TrTop, s5EcellTrap=s5EcellTrap, s5Traps=s5Traps, s5Eth=s5Eth, s5TokTrap=s5TokTrap, atmTraps=atmTraps, s5EnMsTop=s5EnMsTop, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, s5FddTrap=s5FddTrap, s5ComTrap=s5ComTrap, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, stpChangeTrap=stpChangeTrap, s5EthTrap=s5EthTrap, s5Chassis=s5Chassis, PYSNMP_MODULE_ID=s5RootMib)
