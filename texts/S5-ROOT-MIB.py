...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Traps=s5Traps, PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, s5ComTrap=s5ComTrap, s5reg=s5reg, atmTraps=atmTraps, s5AtmTop=s5AtmTop, s5RootMib=s5RootMib, s5Eth=s5Eth, s5Fddi=s5Fddi, s5EnTop=s5EnTop, s5Com=s5Com, s5Tok=s5Tok, s5TokTrap=s5TokTrap, s5Agent=s5Agent, s5EnMsTop=s5EnMsTop, bnLogMsg=bnLogMsg, s5Chassis=s5Chassis, stpChangeTrap=stpChangeTrap, s5IfExt=s5IfExt, s5EcellTrap=s5EcellTrap, s5ChaTrap=s5ChaTrap, s5TrTop=s5TrTop, s5FdTop=s5FdTop, s5Tcs=s5Tcs, s5FddTrap=s5FddTrap, remoteLoginTrap=remoteLoginTrap)
