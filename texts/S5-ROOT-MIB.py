...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tcs=s5Tcs, s5EthTrap=s5EthTrap, s5AtmTop=s5AtmTop, s5Tok=s5Tok, s5ComTrap=s5ComTrap, s5ChaTrap=s5ChaTrap, s5reg=s5reg, s5TrTop=s5TrTop, remoteLoginTrap=remoteLoginTrap, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, s5EcellTrap=s5EcellTrap, PYSNMP_MODULE_ID=s5RootMib, s5Fddi=s5Fddi, bnLogMsg=bnLogMsg, atmTraps=atmTraps, s5RootMib=s5RootMib, s5FdTop=s5FdTop, s5EnTop=s5EnTop, s5Agent=s5Agent, s5Com=s5Com, s5TokTrap=s5TokTrap, s5IfExt=s5IfExt, s5Eth=s5Eth, s5Chassis=s5Chassis, s5FddTrap=s5FddTrap, s5EnMsTop=s5EnMsTop)
