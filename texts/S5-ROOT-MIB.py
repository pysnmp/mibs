...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Traps=s5Traps, s5EnMsTop=s5EnMsTop, bnLogMsg=bnLogMsg, s5FdTop=s5FdTop, s5EnTop=s5EnTop, s5Eth=s5Eth, s5reg=s5reg, s5Tok=s5Tok, s5EthTrap=s5EthTrap, remoteLoginTrap=remoteLoginTrap, s5RootMib=s5RootMib, s5TokTrap=s5TokTrap, atmTraps=atmTraps, stpChangeTrap=stpChangeTrap, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, s5TrTop=s5TrTop, s5ComTrap=s5ComTrap, s5EcellTrap=s5EcellTrap, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5Fddi=s5Fddi, s5IfExt=s5IfExt, s5Com=s5Com, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5Tcs=s5Tcs)
