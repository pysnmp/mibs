...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5IfExt=s5IfExt, remoteLoginTrap=remoteLoginTrap, s5Com=s5Com, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5Traps=s5Traps, s5Chassis=s5Chassis, s5EnMsTop=s5EnMsTop, s5Eth=s5Eth, s5reg=s5reg, s5EcellTrap=s5EcellTrap, s5TokTrap=s5TokTrap, s5AtmTop=s5AtmTop, s5ComTrap=s5ComTrap, bnLogMsg=bnLogMsg, s5Tcs=s5Tcs, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5Tok=s5Tok, PYSNMP_MODULE_ID=s5RootMib, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5RootMib=s5RootMib, s5EnTop=s5EnTop, s5Fddi=s5Fddi, s5EthTrap=s5EthTrap, atmTraps=atmTraps)
