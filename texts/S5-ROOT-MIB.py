...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5RootMib=s5RootMib, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5TokTrap=s5TokTrap, s5FddTrap=s5FddTrap, s5Fddi=s5Fddi, s5FdTop=s5FdTop, s5Traps=s5Traps, remoteLoginTrap=remoteLoginTrap, s5Agent=s5Agent, s5IfExt=s5IfExt, s5ComTrap=s5ComTrap, stpChangeTrap=stpChangeTrap, s5Eth=s5Eth, s5EnTop=s5EnTop, bnLogMsg=bnLogMsg, s5EcellTrap=s5EcellTrap, s5Tcs=s5Tcs, s5ChaTrap=s5ChaTrap, s5Tok=s5Tok, s5EthTrap=s5EthTrap, atmTraps=atmTraps, s5EnMsTop=s5EnMsTop, s5reg=s5reg, PYSNMP_MODULE_ID=s5RootMib, s5AtmTop=s5AtmTop)
