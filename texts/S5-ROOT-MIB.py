...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Agent=s5Agent, s5EnMsTop=s5EnMsTop, s5AtmTop=s5AtmTop, s5IfExt=s5IfExt, s5TokTrap=s5TokTrap, s5Fddi=s5Fddi, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5FddTrap=s5FddTrap, s5EnTop=s5EnTop, s5FdTop=s5FdTop, s5ChaTrap=s5ChaTrap, s5Tok=s5Tok, s5Tcs=s5Tcs, s5Com=s5Com, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, bnLogMsg=bnLogMsg, s5ComTrap=s5ComTrap, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, s5reg=s5reg, s5EthTrap=s5EthTrap, atmTraps=atmTraps)
