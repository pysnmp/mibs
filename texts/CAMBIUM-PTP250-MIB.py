...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", cambium=cambium, siteName=siteName, snmpControlGroup=snmpControlGroup, vlanPriority=vlanPriority, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, dualPayload=dualPayload, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableIndex=sNMPCommunityTableIndex, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, antennaGain=antennaGain, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPSync=nTPSync, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, ptpGroups=ptpGroups, configurationGroup=configurationGroup, vlanTagging=vlanTagging, alarms=alarms, smtp=smtp, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, versionsGroup=versionsGroup, licence=licence, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, band=band, ptp=ptp, channelSelection=channelSelection, vectorError=vectorError, sNMPCommunityAccess=sNMPCommunityAccess, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, hardwareVersion=hardwareVersion, iPAddress=iPAddress, cableLoss=cableLoss, receivePower=receivePower, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, systemClock=systemClock, nTPServerIp=nTPServerIp, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, sMTPServerPortNumber=sMTPServerPortNumber, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTable=sNMPCommunityTable, ntp=ntp, remoteMACAddress=remoteMACAddress, configuredRange=configuredRange, searchState=searchState, smtpGroup=smtpGroup, nTPState=nTPState, ethernetGroup=ethernetGroup, configuration=configuration, nTPLastSync=nTPLastSync, currentFreqMHz=currentFreqMHz, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant, linkName=linkName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapVersion=sNMPTrapVersion, noiseFloor=noiseFloor, measuredRange=measuredRange, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, fixedModMode=fixedModMode, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, timeZone=timeZone, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radarDetectChannel=radarDetectChannel, configuredModulationMode=configuredModulationMode, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, ptp250=ptp250, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, versions=versions, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, ethernet=ethernet, softwareVersion=softwareVersion, radarDetectTrap=radarDetectTrap, productName=productName, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, nTPPollInterval=nTPPollInterval, notificationsGroup=notificationsGroup, transmitPower=transmitPower, regionCode=regionCode, linkStatusTrap=linkStatusTrap, phyStatusGroup=phyStatusGroup, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStats=pubStats, vlanId=vlanId, ptpCompliance=ptpCompliance)
