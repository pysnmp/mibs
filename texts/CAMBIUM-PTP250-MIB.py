...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", measuredRange=measuredRange, receiveModulationMode=receiveModulationMode, sNMPTrapTable=sNMPTrapTable, remoteMACAddress=remoteMACAddress, productName=productName, currentChannel=currentChannel, searchState=searchState, phyStatus=phyStatus, sNMPTrapCommunity=sNMPTrapCommunity, management=management, radarDetectChannel=radarDetectChannel, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, fixedModMode=fixedModMode, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, ptmp=ptmp, vlanTagging=vlanTagging, ethernet=ethernet, linkStatusTrap=linkStatusTrap, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, currentFreqMHz=currentFreqMHz, ptp250=ptp250, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, nTPSync=nTPSync, ptpTraps=ptpTraps, systemClock=systemClock, ptp=ptp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versionsGroup=versionsGroup, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, licence=licence, ptpGroups=ptpGroups, noiseFloor=noiseFloor, notificationsGroup=notificationsGroup, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, ntp=ntp, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, vlanId=vlanId, configuredRange=configuredRange, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredModulationMode=configuredModulationMode, dualPayload=dualPayload, softwareVersion=softwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, band=band, channelSelection=channelSelection, dataPortStatus=dataPortStatus, nTPState=nTPState, regionCode=regionCode, sNMPCommunityTable=sNMPCommunityTable, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, vlanPriority=vlanPriority, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, aggregateDataRate=aggregateDataRate, subnetMask=subnetMask, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStats=pubStats, antennaGain=antennaGain, smtpGroup=smtpGroup, extendedChannel=extendedChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, signalStrengthRatio=signalStrengthRatio, linkName=linkName, ntpGroup=ntpGroup, nTPPollInterval=nTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBandwidth=channelBandwidth, vectorError=vectorError, ptpCompliance=ptpCompliance, nTPLastSync=nTPLastSync, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, installArmStateTrap=installArmStateTrap, receivePower=receivePower, versions=versions, sNMPCommunityAccess=sNMPCommunityAccess, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, radarDetectTrap=radarDetectTrap, cambium=cambium, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, linkLoss=linkLoss, siteName=siteName, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant)
