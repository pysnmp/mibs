...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, hardwareVersion=hardwareVersion, currentFreqMHz=currentFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, extendedChannel=extendedChannel, sNMPTrapVersion=sNMPTrapVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, antennaGain=antennaGain, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, channelBandwidth=channelBandwidth, timeZone=timeZone, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, currentChannel=currentChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitModulationMode=transmitModulationMode, extendedFreqMHz=extendedFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, phyStatus=phyStatus, versionsGroup=versionsGroup, vlanPriority=vlanPriority, sNMPTrapCommunity=sNMPTrapCommunity, ntpGroup=ntpGroup, subnetMask=subnetMask, remoteMACAddress=remoteMACAddress, productName=productName, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, snmpControl=snmpControl, pubStats=pubStats, radarDetectTrap=radarDetectTrap, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, productVariant=productVariant, searchState=searchState, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, versions=versions, linkStatusTrap=linkStatusTrap, alarms=alarms, ptpGroups=ptpGroups, bootVersion=bootVersion, transmitPower=transmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTable=sNMPTrapTable, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, band=band, PYSNMP_MODULE_ID=cambium, ptp=ptp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, receiveModulationMode=receiveModulationMode, management=management, cambium=cambium, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dualPayload=dualPayload, sMTPServerIPAddress=sMTPServerIPAddress, nTPServerIp=nTPServerIp, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPServerPortNumber=nTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, snmpControlGroup=snmpControlGroup, radarDetectChannel=radarDetectChannel, configuredRange=configuredRange, nTPState=nTPState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanTagging=vlanTagging, ptp250=ptp250, nTPPollInterval=nTPPollInterval, iPAddress=iPAddress, alarmsGroup=alarmsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTraps=ptpTraps, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, smtp=smtp, nTPSync=nTPSync, measuredRange=measuredRange, aggregateDataRate=aggregateDataRate, pubStatsGroup=pubStatsGroup, ntp=ntp, managementGroup=managementGroup, configuration=configuration, sNMPCommunityTable=sNMPCommunityTable, vlanId=vlanId, systemClock=systemClock, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, fixedModMode=fixedModMode, ptpCompliance=ptpCompliance, noiseFloor=noiseFloor, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState)
