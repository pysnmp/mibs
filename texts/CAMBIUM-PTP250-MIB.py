...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanId=vlanId, configuration=configuration, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTable=sNMPCommunityTable, pubStatsGroup=pubStatsGroup, searchState=searchState, nTPState=nTPState, ethernetGroup=ethernetGroup, siteName=siteName, phyStatus=phyStatus, radarDetectChannel=radarDetectChannel, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, receiveModulationMode=receiveModulationMode, ethernet=ethernet, versionsGroup=versionsGroup, configuredRange=configuredRange, nTPServerPortNumber=nTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, pubStats=pubStats, channelBandwidth=channelBandwidth, extendedChannel=extendedChannel, transmitDataRate=transmitDataRate, management=management, iPAddress=iPAddress, ptpTraps=ptpTraps, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapCommunity=sNMPTrapCommunity, sMTPEnabledMessages=sMTPEnabledMessages, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, licenceGroup=licenceGroup, noiseFloor=noiseFloor, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, fixedModMode=fixedModMode, alarmsGroup=alarmsGroup, currentChannel=currentChannel, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hardwareVersion=hardwareVersion, receivePower=receivePower, productName=productName, measuredRange=measuredRange, versions=versions, ptp250=ptp250, aggregateDataRate=aggregateDataRate, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntp=ntp, vectorError=vectorError, configuredModulationMode=configuredModulationMode, subnetMask=subnetMask, band=band, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControl=snmpControl, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection, receiveDataRate=receiveDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, currentFreqMHz=currentFreqMHz, radarDetectTrap=radarDetectTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityOid=sNMPCommunityOid, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, vlanPriority=vlanPriority, regionCode=regionCode, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, vlanTagging=vlanTagging, installArmStateTrap=installArmStateTrap, nTPSync=nTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, linkName=linkName, ntpGroup=ntpGroup, productVariant=productVariant, wirelessLinkStatus=wirelessLinkStatus, extendedFreqMHz=extendedFreqMHz, linkStatusTrap=linkStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, gatewayIPAddress=gatewayIPAddress, nTPServerIp=nTPServerIp, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, systemClock=systemClock, remoteMACAddress=remoteMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, transmitPower=transmitPower, ptmp=ptmp, snmpControlGroup=snmpControlGroup, nTPLastSync=nTPLastSync, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState)
