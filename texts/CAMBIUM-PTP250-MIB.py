...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, dualPayload=dualPayload, searchState=searchState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, ntp=ntp, channelBandwidth=channelBandwidth, channelSelection=channelSelection, alarms=alarms, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, currentChannel=currentChannel, licence=licence, sNMPTrapTable=sNMPTrapTable, noiseFloor=noiseFloor, vlanId=vlanId, nTPSync=nTPSync, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, transmitPower=transmitPower, measuredRange=measuredRange, managementGroup=managementGroup, extendedChannel=extendedChannel, productVariant=productVariant, nTPServerIp=nTPServerIp, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, regionCode=regionCode, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, receivePower=receivePower, vlanPriority=vlanPriority, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, nTPState=nTPState, fixedModMode=fixedModMode, sNMPCommunityAccess=sNMPCommunityAccess, versions=versions, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, sNMPTrapCommunity=sNMPTrapCommunity, vlanTagging=vlanTagging, iPAddress=iPAddress, remoteMACAddress=remoteMACAddress, cableLoss=cableLoss, systemClock=systemClock, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, linkLoss=linkLoss, nTPLastSync=nTPLastSync, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, alarmsGroup=alarmsGroup, band=band, sNMPCommunityOid=sNMPCommunityOid, management=management, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, radarDetectChannel=radarDetectChannel, configurationGroup=configurationGroup, subnetMask=subnetMask, extendedFreqMHz=extendedFreqMHz, configuredRange=configuredRange, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aggregateDataRate=aggregateDataRate, ptp250=ptp250, configuration=configuration, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, configuredModulationMode=configuredModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, softwareVersion=softwareVersion, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, transmitModulationMode=transmitModulationMode, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, ntpGroup=ntpGroup, currentFreqMHz=currentFreqMHz, radarDetectTrap=radarDetectTrap, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, ptmp=ptmp, phyStatus=phyStatus, ptpGroups=ptpGroups, installArmState=installArmState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, sNMPCommunityTableIndex=sNMPCommunityTableIndex)
