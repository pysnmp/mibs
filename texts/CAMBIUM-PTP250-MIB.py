...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPPollInterval=nTPPollInterval, snmpControl=snmpControl, sNMPTrapCommunity=sNMPTrapCommunity, timeZone=timeZone, cableLoss=cableLoss, siteName=siteName, vlanTagging=vlanTagging, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, management=management, ptpTraps=ptpTraps, iPAddress=iPAddress, receivePower=receivePower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, configuration=configuration, phyStatusGroup=phyStatusGroup, ntp=ntp, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, fixedModMode=fixedModMode, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedFreqMHz=extendedFreqMHz, ntpGroup=ntpGroup, sNMPCommunityOid=sNMPCommunityOid, vlanPriority=vlanPriority, nTPSync=nTPSync, configuredModulationMode=configuredModulationMode, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, nTPState=nTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, sNMPCommunityAccess=sNMPCommunityAccess, productName=productName, band=band, notificationsGroup=notificationsGroup, linkLoss=linkLoss, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTable=sNMPTrapTable, ptpCompliance=ptpCompliance, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, configuredRange=configuredRange, alarms=alarms, radarDetectChannel=radarDetectChannel, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, noiseFloor=noiseFloor, smtp=smtp, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControlGroup=snmpControlGroup, remoteMACAddress=remoteMACAddress, bootVersion=bootVersion, ethernetGroup=ethernetGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, phyStatus=phyStatus, vectorError=vectorError, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, radarDetectTrap=radarDetectTrap, nTPLastSync=nTPLastSync, tFTPServerPortNumber=tFTPServerPortNumber, productVariant=productVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, vlanId=vlanId, regionCode=regionCode, currentChannel=currentChannel, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, searchState=searchState, sNMPCommunityTable=sNMPCommunityTable, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, ptp250=ptp250, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, nTPServerIp=nTPServerIp, PYSNMP_MODULE_ID=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, systemClock=systemClock, subnetMask=subnetMask, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, softwareVersion=softwareVersion, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, channelSelection=channelSelection, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, cambium=cambium, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, measuredRange=measuredRange)
