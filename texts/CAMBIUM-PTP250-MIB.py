...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, alarms=alarms, installArmState=installArmState, currentFreqMHz=currentFreqMHz, timeZone=timeZone, vlanTagging=vlanTagging, dataPortStatus=dataPortStatus, regionCode=regionCode, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, ptp=ptp, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, linkStatusTrap=linkStatusTrap, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, cambium=cambium, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, sNMPTrapVersion=sNMPTrapVersion, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, configuredRange=configuredRange, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, measuredRange=measuredRange, siteName=siteName, versionsGroup=versionsGroup, sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noiseFloor=noiseFloor, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, nTPPollInterval=nTPPollInterval, tFTPServerPortNumber=tFTPServerPortNumber, ptp250=ptp250, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, ptpGroups=ptpGroups, sNMPCommunityAccess=sNMPCommunityAccess, smtp=smtp, dualPayload=dualPayload, management=management, linkName=linkName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, radarDetectTrap=radarDetectTrap, versions=versions, extendedChannel=extendedChannel, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, band=band, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, productName=productName, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPSync=nTPSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, receiveDataRate=receiveDataRate, alarmsGroup=alarmsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, notificationsGroup=notificationsGroup, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailable=noWirelessChannelAvailable, vlanPriority=vlanPriority, sNMPCommunityString=sNMPCommunityString, searchState=searchState, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectChannel=radarDetectChannel, currentChannel=currentChannel, ethernetGroup=ethernetGroup, nTPServerIp=nTPServerIp, licence=licence, ntp=ntp, transmitDataRate=transmitDataRate, nTPLastSync=nTPLastSync, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, nTPState=nTPState, pubStats=pubStats, phyStatus=phyStatus, sNMPCommunityTable=sNMPCommunityTable, configuredModulationMode=configuredModulationMode, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate)
