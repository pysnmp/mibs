...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelBandwidth=channelBandwidth, nTPSync=nTPSync, masterSlaveMode=masterSlaveMode, remoteMACAddress=remoteMACAddress, nTPPollInterval=nTPPollInterval, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitPower=transmitPower, timeZone=timeZone, sNMPCommunityOid=sNMPCommunityOid, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, ntp=ntp, nTPState=nTPState, productVariant=productVariant, licence=licence, noiseFloor=noiseFloor, sNMPCommunityTable=sNMPCommunityTable, fixedModMode=fixedModMode, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups, sNMPCommunityTableEntry=sNMPCommunityTableEntry, wirelessLinkStatus=wirelessLinkStatus, linkStatusTrap=linkStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, ptpTraps=ptpTraps, currentFreqMHz=currentFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanPriority=vlanPriority, smtp=smtp, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, productName=productName, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, configuredModulationMode=configuredModulationMode, management=management, installArmStateTrap=installArmStateTrap, radarDetectTrap=radarDetectTrap, measuredRange=measuredRange, transmitModulationMode=transmitModulationMode, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, currentChannel=currentChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatus=phyStatus, searchState=searchState, managementGroup=managementGroup, ptp250=ptp250, licenceGroup=licenceGroup, configuration=configuration, sNMPTrapCommunity=sNMPTrapCommunity, PYSNMP_MODULE_ID=cambium, ptpCompliance=ptpCompliance, antennaGain=antennaGain, vectorError=vectorError, vlanTagging=vlanTagging, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, notificationsGroup=notificationsGroup, sNMPCommunityAccess=sNMPCommunityAccess, dataPortStatus=dataPortStatus, channelSelection=channelSelection, ntpGroup=ntpGroup, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, snmpControl=snmpControl, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, cambium=cambium, extendedFreqMHz=extendedFreqMHz, ptpTrapPrefix=ptpTrapPrefix, systemClock=systemClock, versions=versions, gatewayIPAddress=gatewayIPAddress, iPAddress=iPAddress, linkName=linkName, pubStats=pubStats, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aggregateDataRate=aggregateDataRate, band=band, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, softwareVersion=softwareVersion, extendedChannel=extendedChannel, radarDetectChannel=radarDetectChannel, configuredRange=configuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTable=sNMPTrapTable, dualPayload=dualPayload, vlanId=vlanId, alarms=alarms, nTPServerPortNumber=nTPServerPortNumber)
