...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityAccess=sNMPCommunityAccess, noiseFloor=noiseFloor, alarmsGroup=alarmsGroup, smtp=smtp, PYSNMP_MODULE_ID=cambium, ptp=ptp, installArmState=installArmState, sNMPEnabledTraps=sNMPEnabledTraps, ntpGroup=ntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, dataPortStatus=dataPortStatus, licenceGroup=licenceGroup, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, extendedChannel=extendedChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, vlanPriority=vlanPriority, signalStrengthRatio=signalStrengthRatio, searchState=searchState, notificationsGroup=notificationsGroup, productName=productName, gatewayIPAddress=gatewayIPAddress, alarms=alarms, configurationGroup=configurationGroup, regionCode=regionCode, receivePower=receivePower, timeZone=timeZone, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, nTPSync=nTPSync, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, productVariant=productVariant, vlanTagging=vlanTagging, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatus=phyStatus, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, nTPServerIp=nTPServerIp, sNMPCommunityTable=sNMPCommunityTable, dualPayload=dualPayload, sNMPCommunityTableEntry=sNMPCommunityTableEntry, cableLoss=cableLoss, transmitPower=transmitPower, linkStatusTrap=linkStatusTrap, remoteIPAddress=remoteIPAddress, installArmStateTrap=installArmStateTrap, configuredRange=configuredRange, currentChannel=currentChannel, bootVersion=bootVersion, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, transmitModulationMode=transmitModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControl=snmpControl, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, ptp250=ptp250, remoteMACAddress=remoteMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vectorError=vectorError, measuredRange=measuredRange, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanId=vlanId, sNMPTrapTable=sNMPTrapTable, fixedModMode=fixedModMode, licence=licence, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPState=nTPState, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuredModulationMode=configuredModulationMode, managementGroup=managementGroup, masterSlaveMode=masterSlaveMode, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, receiveDataRate=receiveDataRate, radarDetectChannel=radarDetectChannel, channelSelection=channelSelection, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, currentFreqMHz=currentFreqMHz, ntp=ntp, nTPLastSync=nTPLastSync, configuration=configuration, snmpControlGroup=snmpControlGroup, nTPPollInterval=nTPPollInterval, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityString=sNMPCommunityString, versions=versions, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedFreqMHz=extendedFreqMHz, linkLoss=linkLoss)
