...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableEntry=sNMPCommunityTableEntry, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanPriority=vlanPriority, management=management, ntpGroup=ntpGroup, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, dualPayload=dualPayload, transmitDataRate=transmitDataRate, configuration=configuration, alarmsGroup=alarmsGroup, regionCode=regionCode, nTPPollInterval=nTPPollInterval, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, licenceGroup=licenceGroup, nTPServerIp=nTPServerIp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementGroup=managementGroup, phyStatus=phyStatus, sNMPCommunityOid=sNMPCommunityOid, siteName=siteName, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTable=sNMPCommunityTable, subnetMask=subnetMask, ptp250=ptp250, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, configuredModulationMode=configuredModulationMode, timeZone=timeZone, vlanId=vlanId, PYSNMP_MODULE_ID=cambium, searchState=searchState, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, installArmState=installArmState, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, pubStats=pubStats, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, nTPLastSync=nTPLastSync, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, versions=versions, currentChannel=currentChannel, bootVersion=bootVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectTrap=radarDetectTrap, nTPSync=nTPSync, linkName=linkName, radarDetectChannel=radarDetectChannel, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptp=ptp, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, band=band, sNMPCommunityAccess=sNMPCommunityAccess, productVariant=productVariant, licence=licence, linkLoss=linkLoss, configurationGroup=configurationGroup, currentFreqMHz=currentFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, cambium=cambium, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, snmpControl=snmpControl, channelSelection=channelSelection, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredRange=configuredRange, versionsGroup=versionsGroup, iPAddress=iPAddress, aggregateDataRate=aggregateDataRate, noiseFloor=noiseFloor, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, channelBandwidth=channelBandwidth, fixedModMode=fixedModMode, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, receiveDataRate=receiveDataRate, measuredRange=measuredRange, masterSlaveMode=masterSlaveMode, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedFreqMHz=extendedFreqMHz, smtpGroup=smtpGroup, ptpGroups=ptpGroups, nTPState=nTPState, productName=productName, vlanTagging=vlanTagging, dataPortStatus=dataPortStatus, ethernet=ethernet, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, extendedChannel=extendedChannel, ntp=ntp)
