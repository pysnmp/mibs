...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vectorError=vectorError, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteMACAddress=remoteMACAddress, ptp250=ptp250, cableLoss=cableLoss, radarDetectTrap=radarDetectTrap, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectChannel=radarDetectChannel, pubStats=pubStats, searchState=searchState, timeZone=timeZone, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, transmitPower=transmitPower, ethernetGroup=ethernetGroup, systemClock=systemClock, ptp=ptp, smtpGroup=smtpGroup, bootVersion=bootVersion, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, receiveDataRate=receiveDataRate, configuredModulationMode=configuredModulationMode, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, softwareVersion=softwareVersion, phyStatusGroup=phyStatusGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatus=dataPortStatus, dualPayload=dualPayload, currentFreqMHz=currentFreqMHz, hardwareVersion=hardwareVersion, vlanId=vlanId, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, vlanTagging=vlanTagging, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, fixedModMode=fixedModMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ntp=ntp, siteName=siteName, alarmsGroup=alarmsGroup, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noiseFloor=noiseFloor, band=band, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, pubStatsGroup=pubStatsGroup, remoteIPAddress=remoteIPAddress, nTPLastSync=nTPLastSync, transmitDataRate=transmitDataRate, linkName=linkName, alarms=alarms, sNMPTrapCommunity=sNMPTrapCommunity, ptmp=ptmp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPPollInterval=nTPPollInterval, configuredRange=configuredRange, linkLoss=linkLoss, nTPSync=nTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, vlanPriority=vlanPriority, phyStatus=phyStatus, currentChannel=currentChannel, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, measuredRange=measuredRange, sMTPServerIPAddress=sMTPServerIPAddress, transmitModulationMode=transmitModulationMode, nTPState=nTPState, nTPServerIp=nTPServerIp, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, extendedChannel=extendedChannel, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityAccess=sNMPCommunityAccess, configuration=configuration, productName=productName, ptpCompliance=ptpCompliance, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, signalStrengthRatio=signalStrengthRatio, linkStatusTrap=linkStatusTrap, extendedFreqMHz=extendedFreqMHz, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, cambium=cambium, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, nTPServerPortNumber=nTPServerPortNumber, productVariant=productVariant, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, channelSelection=channelSelection, versions=versions, installArmState=installArmState, receivePower=receivePower, ntpGroup=ntpGroup)
