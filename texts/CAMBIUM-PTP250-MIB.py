...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", remoteIPAddress=remoteIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, versionsGroup=versionsGroup, currentChannel=currentChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControlGroup=snmpControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, productVariant=productVariant, vlanTagging=vlanTagging, radarDetectTrap=radarDetectTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelSelection=channelSelection, subnetMask=subnetMask, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, managementGroup=managementGroup, ptpTraps=ptpTraps, ntp=ntp, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, measuredRange=measuredRange, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControl=snmpControl, smtp=smtp, linkLoss=linkLoss, sNMPCommunityTable=sNMPCommunityTable, extendedChannel=extendedChannel, productName=productName, ptpCompliance=ptpCompliance, searchState=searchState, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, vlanId=vlanId, licenceGroup=licenceGroup, radarDetectChannel=radarDetectChannel, sNMPCommunityAccess=sNMPCommunityAccess, dataPortStatus=dataPortStatus, cableLoss=cableLoss, nTPServerIp=nTPServerIp, nTPSync=nTPSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredModulationMode=configuredModulationMode, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, extendedFreqMHz=extendedFreqMHz, maximumTransmitPower=maximumTransmitPower, sNMPCommunityOid=sNMPCommunityOid, dualPayload=dualPayload, configuration=configuration, phyStatus=phyStatus, notificationsGroup=notificationsGroup, band=band, regionCode=regionCode, ptmp=ptmp, receivePower=receivePower, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, versions=versions, channelBandwidth=channelBandwidth, cambium=cambium, configurationGroup=configurationGroup, currentFreqMHz=currentFreqMHz, dataPortStatusTrap=dataPortStatusTrap, vlanPriority=vlanPriority, sNMPTrapTableIndex=sNMPTrapTableIndex, ntpGroup=ntpGroup, siteName=siteName, licence=licence, ptp=ptp, systemClock=systemClock, timeZone=timeZone, nTPLastSync=nTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, ptp250=ptp250, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, aggregateDataRate=aggregateDataRate, sNMPCommunityTableNumber=sNMPCommunityTableNumber, hardwareVersion=hardwareVersion, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, linkName=linkName, fixedModMode=fixedModMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, iPAddress=iPAddress, ptpGroups=ptpGroups, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernet=ethernet, configuredRange=configuredRange, ethernetGroup=ethernetGroup, antennaGain=antennaGain, alarms=alarms, nTPPollInterval=nTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, nTPState=nTPState, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkStatusTrap=linkStatusTrap, installArmStateTrap=installArmStateTrap)
