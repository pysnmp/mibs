...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, management=management, configuredRange=configuredRange, installArmStateTrap=installArmStateTrap, hardwareVersion=hardwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, licence=licence, ptp=ptp, ntp=ntp, remoteIPAddress=remoteIPAddress, radarDetectTrap=radarDetectTrap, transmitPower=transmitPower, vlanTagging=vlanTagging, transmitModulationMode=transmitModulationMode, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, nTPServerPortNumber=nTPServerPortNumber, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, vlanId=vlanId, receiveModulationMode=receiveModulationMode, searchState=searchState, radarDetectChannel=radarDetectChannel, currentChannel=currentChannel, wirelessLinkStatus=wirelessLinkStatus, channelSelection=channelSelection, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityAccess=sNMPCommunityAccess, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPLastSync=nTPLastSync, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, nTPServerIp=nTPServerIp, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanPriority=vlanPriority, gatewayIPAddress=gatewayIPAddress, iPAddress=iPAddress, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, currentFreqMHz=currentFreqMHz, transmitDataRate=transmitDataRate, extendedChannel=extendedChannel, measuredRange=measuredRange, linkLoss=linkLoss, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dualPayload=dualPayload, ptpCompliance=ptpCompliance, alarms=alarms, linkName=linkName, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, channelBandwidth=channelBandwidth, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuration=configuration, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, band=band, installArmState=installArmState, nTPSync=nTPSync, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, snmpControl=snmpControl, ptp250=ptp250, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPState=nTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configurationGroup=configurationGroup, systemClock=systemClock, siteName=siteName, receiveDataRate=receiveDataRate, cambium=cambium, fixedModMode=fixedModMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, notificationsGroup=notificationsGroup, subnetMask=subnetMask, productVariant=productVariant, sNMPCommunityOid=sNMPCommunityOid, configuredModulationMode=configuredModulationMode, ptpTraps=ptpTraps, sNMPCommunityTable=sNMPCommunityTable, licenceGroup=licenceGroup, PYSNMP_MODULE_ID=cambium, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, ntpGroup=ntpGroup, dataPortStatusTrap=dataPortStatusTrap, ptmp=ptmp, versions=versions, nTPPollInterval=nTPPollInterval)
