...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, currentFreqMHz=currentFreqMHz, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, linkName=linkName, vectorError=vectorError, versionsGroup=versionsGroup, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, currentChannel=currentChannel, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, configuration=configuration, notificationsGroup=notificationsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, searchState=searchState, sNMPCommunityTable=sNMPCommunityTable, timeZone=timeZone, ntpGroup=ntpGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableIndex=sNMPTrapTableIndex, productVariant=productVariant, softwareVersion=softwareVersion, vlanTagging=vlanTagging, ptpTrapPrefix=ptpTrapPrefix, nTPServerPortNumber=nTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, subnetMask=subnetMask, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, ntp=ntp, nTPState=nTPState, ptp250=ptp250, licence=licence, measuredRange=measuredRange, sNMPCommunityOid=sNMPCommunityOid, extendedChannel=extendedChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, snmpControlGroup=snmpControlGroup, alarmsGroup=alarmsGroup, configuredModulationMode=configuredModulationMode, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityAccess=sNMPCommunityAccess, remoteMACAddress=remoteMACAddress, cambium=cambium, bootVersion=bootVersion, ptpTraps=ptpTraps, pubStats=pubStats, ptmp=ptmp, ptpCompliance=ptpCompliance, smtp=smtp, linkStatusTrap=linkStatusTrap, vlanId=vlanId, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, dualPayload=dualPayload, versions=versions, sNMPCommunityTableIndex=sNMPCommunityTableIndex, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, channelBandwidth=channelBandwidth, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmState=installArmState, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, band=band, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, radarDetectTrap=radarDetectTrap, systemClock=systemClock, nTPSync=nTPSync, receivePower=receivePower, radarDetectChannel=radarDetectChannel, nTPServerIp=nTPServerIp, siteName=siteName, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, nTPPollInterval=nTPPollInterval, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, management=management, dataPortAutoNegotiation=dataPortAutoNegotiation, linkLoss=linkLoss, nTPLastSync=nTPLastSync, channelSelection=channelSelection, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, noiseFloor=noiseFloor, transmitPower=transmitPower, vlanPriority=vlanPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, fixedModMode=fixedModMode)
