...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", noiseFloor=noiseFloor, sMTPServerPortNumber=sMTPServerPortNumber, receivePower=receivePower, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, ntp=ntp, sNMPTrapTable=sNMPTrapTable, linkName=linkName, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, configurationGroup=configurationGroup, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, radarDetectTrap=radarDetectTrap, dualPayload=dualPayload, channelSelection=channelSelection, iPAddress=iPAddress, ptmp=ptmp, versions=versions, phyStatusGroup=phyStatusGroup, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, siteName=siteName, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, configuration=configuration, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTable=sNMPCommunityTable, management=management, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, smtp=smtp, currentChannel=currentChannel, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, nTPSync=nTPSync, vlanTagging=vlanTagging, vlanPriority=vlanPriority, sMTPServerIPAddress=sMTPServerIPAddress, pubStats=pubStats, alarms=alarms, ptpGroups=ptpGroups, remoteMACAddress=remoteMACAddress, ptp250=ptp250, ethernetGroup=ethernetGroup, transmitPower=transmitPower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPState=nTPState, pubStatsGroup=pubStatsGroup, nTPLastSync=nTPLastSync, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, fixedModMode=fixedModMode, nTPServerPortNumber=nTPServerPortNumber, regionCode=regionCode, systemClock=systemClock, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredRange=configuredRange, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, subnetMask=subnetMask, nTPPollInterval=nTPPollInterval, searchState=searchState, configuredModulationMode=configuredModulationMode, sNMPTrapVersion=sNMPTrapVersion, sMTPEnabledMessages=sMTPEnabledMessages, linkStatusTrap=linkStatusTrap, remoteIPAddress=remoteIPAddress, vlanId=vlanId, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPServerIp=nTPServerIp, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, signalStrengthRatio=signalStrengthRatio, bootVersion=bootVersion, currentFreqMHz=currentFreqMHz, ptpTraps=ptpTraps, extendedFreqMHz=extendedFreqMHz, ethernet=ethernet, dataPortStatus=dataPortStatus, cableLoss=cableLoss, PYSNMP_MODULE_ID=cambium, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTrapPrefix=ptpTrapPrefix, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailable=noWirelessChannelAvailable, band=band, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedChannel=extendedChannel, versionsGroup=versionsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, measuredRange=measuredRange, transmitModulationMode=transmitModulationMode, timeZone=timeZone, receiveDataRate=receiveDataRate, cambium=cambium, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, ptp=ptp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, ntpGroup=ntpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
