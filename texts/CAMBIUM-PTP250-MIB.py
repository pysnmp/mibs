...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, sNMPTrapVersion=sNMPTrapVersion, sMTPEnabledMessages=sMTPEnabledMessages, nTPSync=nTPSync, sNMPEnabledTraps=sNMPEnabledTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, phyStatus=phyStatus, iPAddress=iPAddress, currentFreqMHz=currentFreqMHz, vectorError=vectorError, siteName=siteName, band=band, vlanTagging=vlanTagging, linkName=linkName, masterSlaveMode=masterSlaveMode, measuredRange=measuredRange, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, cableLoss=cableLoss, ptp=ptp, currentChannel=currentChannel, ptpTraps=ptpTraps, receiveModulationMode=receiveModulationMode, hardwareVersion=hardwareVersion, installArmStateTrap=installArmStateTrap, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, sNMPTrapCommunity=sNMPTrapCommunity, alarmsGroup=alarmsGroup, productName=productName, bootVersion=bootVersion, PYSNMP_MODULE_ID=cambium, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, nTPServerPortNumber=nTPServerPortNumber, systemClock=systemClock, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatusTrap=dataPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPServerIp=nTPServerIp, remoteIPAddress=remoteIPAddress, ntpGroup=ntpGroup, radarDetectTrap=radarDetectTrap, linkLoss=linkLoss, managementGroup=managementGroup, vlanPriority=vlanPriority, snmpControl=snmpControl, ntp=ntp, tFTPServerPortNumber=tFTPServerPortNumber, aggregateDataRate=aggregateDataRate, extendedChannel=extendedChannel, ptpCompliance=ptpCompliance, vlanId=vlanId, licenceGroup=licenceGroup, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitModulationMode=transmitModulationMode, nTPState=nTPState, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernet=ethernet, configuredRange=configuredRange, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, configuration=configuration, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, ptmp=ptmp, dataPortStatus=dataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, ptp250=ptp250, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, searchState=searchState, versions=versions, signalStrengthRatio=signalStrengthRatio, pubStats=pubStats, licence=licence, phyStatusGroup=phyStatusGroup, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, sNMPCommunityOid=sNMPCommunityOid, nTPLastSync=nTPLastSync, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkStatusTrap=linkStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelSelection=channelSelection, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, dualPayload=dualPayload, remoteMACAddress=remoteMACAddress, receiveDataRate=receiveDataRate, management=management, noiseFloor=noiseFloor, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredModulationMode=configuredModulationMode, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, wirelessLinkStatus=wirelessLinkStatus, versionsGroup=versionsGroup)
