...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, radarDetectTrap=radarDetectTrap, sMTPEnabledMessages=sMTPEnabledMessages, nTPState=nTPState, phyStatus=phyStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationMode=receiveModulationMode, remoteMACAddress=remoteMACAddress, configuredModulationMode=configuredModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, vlanTagging=vlanTagging, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, transmitPower=transmitPower, ptpGroups=ptpGroups, snmpControlGroup=snmpControlGroup, ethernet=ethernet, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectChannel=radarDetectChannel, noiseFloor=noiseFloor, smtp=smtp, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, ptpTraps=ptpTraps, nTPPollInterval=nTPPollInterval, siteName=siteName, managementGroup=managementGroup, productName=productName, ptp250=ptp250, cambium=cambium, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatusTrap=dataPortStatusTrap, pubStats=pubStats, cableLoss=cableLoss, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, signalStrengthRatio=signalStrengthRatio, management=management, sNMPCommunityTable=sNMPCommunityTable, dualPayload=dualPayload, sMTPServerPortNumber=sMTPServerPortNumber, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, licence=licence, ntpGroup=ntpGroup, pubStatsGroup=pubStatsGroup, currentChannel=currentChannel, hardwareVersion=hardwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, configuredRange=configuredRange, alarmsGroup=alarmsGroup, gatewayIPAddress=gatewayIPAddress, extendedChannel=extendedChannel, channelSelection=channelSelection, linkLoss=linkLoss, alarms=alarms, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, ptmp=ptmp, versions=versions, sNMPTrapCommunity=sNMPTrapCommunity, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, searchState=searchState, linkName=linkName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, timeZone=timeZone, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPSync=nTPSync, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitModulationMode=transmitModulationMode, vlanPriority=vlanPriority, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, currentFreqMHz=currentFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, PYSNMP_MODULE_ID=cambium, bootVersion=bootVersion, nTPServerPortNumber=nTPServerPortNumber, iPAddress=iPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, measuredRange=measuredRange, sNMPCommunityOid=sNMPCommunityOid, nTPServerIp=nTPServerIp, vectorError=vectorError, ntp=ntp, ptpTrapPrefix=ptpTrapPrefix, linkStatusTrap=linkStatusTrap, installArmStateTrap=installArmStateTrap, vlanId=vlanId, channelBandwidth=channelBandwidth, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, installArmState=installArmState)
