...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, nTPPollInterval=nTPPollInterval, linkName=linkName, phyStatusGroup=phyStatusGroup, nTPSync=nTPSync, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedChannel=extendedChannel, ethernetGroup=ethernetGroup, managementGroup=managementGroup, versionsGroup=versionsGroup, bootVersion=bootVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, currentFreqMHz=currentFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, smtp=smtp, sNMPTrapCommunity=sNMPTrapCommunity, versions=versions, vlanPriority=vlanPriority, smtpGroup=smtpGroup, productName=productName, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, alarms=alarms, currentChannel=currentChannel, configuration=configuration, measuredRange=measuredRange, nTPState=nTPState, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBandwidth=channelBandwidth, dualPayload=dualPayload, extendedFreqMHz=extendedFreqMHz, cambium=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, nTPServerPortNumber=nTPServerPortNumber, linkStatusTrap=linkStatusTrap, vlanId=vlanId, antennaGain=antennaGain, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, sNMPTrapVersion=sNMPTrapVersion, regionCode=regionCode, ptpTraps=ptpTraps, systemClock=systemClock, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, channelSelection=channelSelection, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radarDetectChannel=radarDetectChannel, licence=licence, cableLoss=cableLoss, timeZone=timeZone, snmpControlGroup=snmpControlGroup, dataPortStatus=dataPortStatus, noiseFloor=noiseFloor, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, radarDetectTrap=radarDetectTrap, sNMPEnabledTraps=sNMPEnabledTraps, signalStrengthRatio=signalStrengthRatio, nTPLastSync=nTPLastSync, installArmStateTrap=installArmStateTrap, softwareVersion=softwareVersion, iPAddress=iPAddress, siteName=siteName, transmitPower=transmitPower, productVariant=productVariant, configuredModulationMode=configuredModulationMode, ntp=ntp, maximumTransmitPower=maximumTransmitPower, ntpGroup=ntpGroup, licenceGroup=licenceGroup, ptp250=ptp250, receivePower=receivePower, vectorError=vectorError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, searchState=searchState, sNMPCommunityString=sNMPCommunityString, configurationGroup=configurationGroup, sNMPCommunityOid=sNMPCommunityOid, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, band=band, receiveModulationMode=receiveModulationMode, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, fixedModMode=fixedModMode, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hardwareVersion=hardwareVersion, configuredRange=configuredRange)
