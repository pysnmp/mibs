...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelSelection=channelSelection, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, ntp=ntp, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, softwareVersion=softwareVersion, ptp250=ptp250, ntpGroup=ntpGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkLoss=linkLoss, nTPPollInterval=nTPPollInterval, licence=licence, sNMPCommunityAccess=sNMPCommunityAccess, currentChannel=currentChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, versionsGroup=versionsGroup, linkStatusTrap=linkStatusTrap, ptp=ptp, alarms=alarms, nTPServerPortNumber=nTPServerPortNumber, configuredRange=configuredRange, sNMPCommunityString=sNMPCommunityString, maximumTransmitPower=maximumTransmitPower, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, hardwareVersion=hardwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, currentFreqMHz=currentFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, band=band, channelBandwidth=channelBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpCompliance=ptpCompliance, ptpTrapPrefix=ptpTrapPrefix, alarmsGroup=alarmsGroup, configuration=configuration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, timeZone=timeZone, fixedModMode=fixedModMode, iPAddress=iPAddress, vlanPriority=vlanPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, versions=versions, productName=productName, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, phyStatus=phyStatus, bootVersion=bootVersion, transmitDataRate=transmitDataRate, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, systemClock=systemClock, sNMPCommunityOid=sNMPCommunityOid, vectorError=vectorError, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, linkName=linkName, licenceGroup=licenceGroup, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControlGroup=snmpControlGroup, nTPSync=nTPSync, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, pubStats=pubStats, dataPortStatus=dataPortStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerIp=nTPServerIp, sNMPTrapCommunity=sNMPTrapCommunity, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, management=management, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, siteName=siteName, vlanTagging=vlanTagging, cableLoss=cableLoss, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, nTPLastSync=nTPLastSync, sNMPTrapVersion=sNMPTrapVersion, nTPState=nTPState, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, productVariant=productVariant, regionCode=regionCode, pubStatsGroup=pubStatsGroup, cambium=cambium, signalStrengthRatio=signalStrengthRatio, extendedFreqMHz=extendedFreqMHz, ptmp=ptmp, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatusGroup=phyStatusGroup, noiseFloor=noiseFloor, measuredRange=measuredRange, antennaGain=antennaGain, radarDetectChannel=radarDetectChannel, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuredModulationMode=configuredModulationMode, dualPayload=dualPayload, searchState=searchState)
