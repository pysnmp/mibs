...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, vlanPriority=vlanPriority, sNMPCommunityTable=sNMPCommunityTable, measuredRange=measuredRange, dualPayload=dualPayload, antennaGain=antennaGain, installArmStateTrap=installArmStateTrap, management=management, smtp=smtp, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, ntpGroup=ntpGroup, phyStatusGroup=phyStatusGroup, ptp=ptp, linkLoss=linkLoss, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, licence=licence, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, linkStatusTrap=linkStatusTrap, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, productVariant=productVariant, nTPSync=nTPSync, searchState=searchState, nTPPollInterval=nTPPollInterval, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp250=ptp250, ethernet=ethernet, channelSelection=channelSelection, sNMPCommunityOid=sNMPCommunityOid, dataPortStatusTrap=dataPortStatusTrap, timeZone=timeZone, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, regionCode=regionCode, alarms=alarms, phyStatus=phyStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, configuration=configuration, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, radarDetectTrap=radarDetectTrap, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, managementGroup=managementGroup, ethernetGroup=ethernetGroup, receiveDataRate=receiveDataRate, currentChannel=currentChannel, sNMPCommunityString=sNMPCommunityString, band=band, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, radarDetectChannel=radarDetectChannel, siteName=siteName, configuredRange=configuredRange, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, configurationGroup=configurationGroup, currentFreqMHz=currentFreqMHz, maximumTransmitPower=maximumTransmitPower, vectorError=vectorError, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, nTPServerPortNumber=nTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, systemClock=systemClock, notificationsGroup=notificationsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, productName=productName, subnetMask=subnetMask, configuredModulationMode=configuredModulationMode, receivePower=receivePower, licenceGroup=licenceGroup, fixedModMode=fixedModMode, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, ntp=ntp, remoteMACAddress=remoteMACAddress, installArmState=installArmState, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedChannel=extendedChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPLastSync=nTPLastSync, nTPState=nTPState, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, cambium=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, vlanId=vlanId, noiseFloor=noiseFloor, PYSNMP_MODULE_ID=cambium)
