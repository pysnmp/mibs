...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityOid=sNMPCommunityOid, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntp=ntp, linkStatusTrap=linkStatusTrap, bootVersion=bootVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, productVariant=productVariant, band=band, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPServerPortNumber=nTPServerPortNumber, noiseFloor=noiseFloor, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, siteName=siteName, antennaGain=antennaGain, systemClock=systemClock, sNMPCommunityAccess=sNMPCommunityAccess, channelSelection=channelSelection, notificationsGroup=notificationsGroup, tFTPServerPortNumber=tFTPServerPortNumber, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPAddress=iPAddress, fixedModMode=fixedModMode, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, searchState=searchState, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStats=pubStats, softwareVersion=softwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, vlanTagging=vlanTagging, ethernet=ethernet, licenceGroup=licenceGroup, receiveDataRate=receiveDataRate, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectChannel=radarDetectChannel, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, installArmState=installArmState, smtp=smtp, configuration=configuration, currentChannel=currentChannel, extendedChannel=extendedChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, extendedFreqMHz=extendedFreqMHz, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, licence=licence, linkLoss=linkLoss, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, vectorError=vectorError, receivePower=receivePower, vlanId=vlanId, alarms=alarms, ptp250=ptp250, snmpControl=snmpControl, management=management, nTPState=nTPState, ntpGroup=ntpGroup, signalStrengthRatio=signalStrengthRatio, nTPSync=nTPSync, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapCommunity=sNMPTrapCommunity, ptpCompliance=ptpCompliance, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, hardwareVersion=hardwareVersion, phyStatus=phyStatus, ptmp=ptmp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, managementGroup=managementGroup, linkName=linkName, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, configuredRange=configuredRange, regionCode=regionCode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, pubStatsGroup=pubStatsGroup, nTPLastSync=nTPLastSync, dataPortAutoNegotiation=dataPortAutoNegotiation, vlanPriority=vlanPriority, sNMPCommunityTable=sNMPCommunityTable, subnetMask=subnetMask, productName=productName, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, transmitPower=transmitPower, dualPayload=dualPayload, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, masterSlaveMode=masterSlaveMode)
