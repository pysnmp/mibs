...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitModulationMode=transmitModulationMode, vectorError=vectorError, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dualPayload=dualPayload, sNMPTrapVersion=sNMPTrapVersion, management=management, systemClock=systemClock, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPLastSync=nTPLastSync, cableLoss=cableLoss, remoteMACAddress=remoteMACAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, bootVersion=bootVersion, radarDetectChannel=radarDetectChannel, notificationsGroup=notificationsGroup, extendedFreqMHz=extendedFreqMHz, currentFreqMHz=currentFreqMHz, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, measuredRange=measuredRange, softwareVersion=softwareVersion, radarDetectTrap=radarDetectTrap, vlanTagging=vlanTagging, fixedModMode=fixedModMode, ptmp=ptmp, nTPServerPortNumber=nTPServerPortNumber, extendedChannel=extendedChannel, regionCode=regionCode, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, configuredModulationMode=configuredModulationMode, linkLoss=linkLoss, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, currentChannel=currentChannel, signalStrengthRatio=signalStrengthRatio, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, band=band, linkStatusTrap=linkStatusTrap, remoteIPAddress=remoteIPAddress, managementGroup=managementGroup, subnetMask=subnetMask, vlanPriority=vlanPriority, sMTPServerPortNumber=sMTPServerPortNumber, smtpGroup=smtpGroup, alarms=alarms, ntp=ntp, configuredRange=configuredRange, timeZone=timeZone, ntpGroup=ntpGroup, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTable=sNMPTrapTable, vlanId=vlanId, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPPollInterval=nTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp250=ptp250, pubStats=pubStats, ptpCompliance=ptpCompliance, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, sNMPCommunityAccess=sNMPCommunityAccess, productName=productName, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, licence=licence, aggregateDataRate=aggregateDataRate, nTPSync=nTPSync, searchState=searchState, pubStatsGroup=pubStatsGroup, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, licenceGroup=licenceGroup, linkName=linkName, iPAddress=iPAddress, ethernet=ethernet, receiveModulationMode=receiveModulationMode, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, snmpControlGroup=snmpControlGroup, siteName=siteName, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerIp=nTPServerIp, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPEnabledTraps=sNMPEnabledTraps, ptpGroups=ptpGroups, transmitDataRate=transmitDataRate, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noiseFloor=noiseFloor)
