...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", receivePower=receivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, remoteIPAddress=remoteIPAddress, siteName=siteName, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTable=sNMPCommunityTable, currentChannel=currentChannel, nTPServerPortNumber=nTPServerPortNumber, alarms=alarms, configurationGroup=configurationGroup, linkStatusTrap=linkStatusTrap, versionsGroup=versionsGroup, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versions=versions, nTPState=nTPState, ethernetGroup=ethernetGroup, regionCode=regionCode, configuredRange=configuredRange, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, receiveModulationMode=receiveModulationMode, ntpGroup=ntpGroup, snmpControl=snmpControl, nTPSync=nTPSync, ptpTrapPrefix=ptpTrapPrefix, channelSelection=channelSelection, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, remoteMACAddress=remoteMACAddress, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanTagging=vlanTagging, fixedModMode=fixedModMode, vlanPriority=vlanPriority, sNMPTrapVersion=sNMPTrapVersion, ptp250=ptp250, snmpControlGroup=snmpControlGroup, licenceGroup=licenceGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, dualPayload=dualPayload, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, channelBandwidth=channelBandwidth, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, configuredModulationMode=configuredModulationMode, ptpTraps=ptpTraps, configuration=configuration, pubStatsGroup=pubStatsGroup, ethernet=ethernet, ntp=ntp, ptmp=ptmp, productVariant=productVariant, installArmState=installArmState, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, searchState=searchState, vlanId=vlanId, bootVersion=bootVersion, iPAddress=iPAddress, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, timeZone=timeZone, transmitDataRate=transmitDataRate, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, sNMPEnabledTraps=sNMPEnabledTraps, maximumTransmitPower=maximumTransmitPower, currentFreqMHz=currentFreqMHz, radarDetectChannel=radarDetectChannel, sMTPServerPortNumber=sMTPServerPortNumber, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, PYSNMP_MODULE_ID=cambium, licence=licence, productName=productName, hardwareVersion=hardwareVersion, extendedChannel=extendedChannel, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, band=band, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, sNMPCommunityTableEntry=sNMPCommunityTableEntry, cambium=cambium, linkLoss=linkLoss, measuredRange=measuredRange, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, sNMPTrapCommunity=sNMPTrapCommunity, nTPServerIp=nTPServerIp, radarDetectTrap=radarDetectTrap, nTPLastSync=nTPLastSync, receiveDataRate=receiveDataRate, smtp=smtp, smtpGroup=smtpGroup, sNMPCommunityOid=sNMPCommunityOid)
