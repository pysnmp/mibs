...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, searchState=searchState, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dualPayload=dualPayload, ntpGroup=ntpGroup, licence=licence, transmitPower=transmitPower, gatewayIPAddress=gatewayIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, nTPPollInterval=nTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, productName=productName, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, dataPortStatus=dataPortStatus, extendedChannel=extendedChannel, timeZone=timeZone, sNMPCommunityTableIndex=sNMPCommunityTableIndex, band=band, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, linkStatusTrap=linkStatusTrap, productVariant=productVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, currentFreqMHz=currentFreqMHz, systemClock=systemClock, sMTPEnabledMessages=sMTPEnabledMessages, ptp250=ptp250, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, bootVersion=bootVersion, management=management, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, iPAddress=iPAddress, nTPSync=nTPSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerPortNumber=sMTPServerPortNumber, nTPServerIp=nTPServerIp, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, currentChannel=currentChannel, regionCode=regionCode, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, configuration=configuration, sNMPTrapCommunity=sNMPTrapCommunity, alarms=alarms, receivePower=receivePower, phyStatus=phyStatus, cableLoss=cableLoss, vlanTagging=vlanTagging, linkName=linkName, pubStats=pubStats, vectorError=vectorError, linkLoss=linkLoss, softwareVersion=softwareVersion, installArmState=installArmState, ptp=ptp, cambium=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernetGroup=ethernetGroup, vlanId=vlanId, vlanPriority=vlanPriority, noiseFloor=noiseFloor, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, pubStatsGroup=pubStatsGroup, extendedFreqMHz=extendedFreqMHz, measuredRange=measuredRange, ntp=ntp, channelSelection=channelSelection, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, fixedModMode=fixedModMode, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, radarDetectChannel=radarDetectChannel, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuredRange=configuredRange, remoteMACAddress=remoteMACAddress, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, receiveModulationMode=receiveModulationMode, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, snmpControl=snmpControl, configuredModulationMode=configuredModulationMode)
