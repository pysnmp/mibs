...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortStatusTrap=dataPortStatusTrap, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, transmitPower=transmitPower, regionCode=regionCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, extendedChannel=extendedChannel, receiveDataRate=receiveDataRate, siteName=siteName, productName=productName, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedFreqMHz=extendedFreqMHz, cambium=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, pubStats=pubStats, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, management=management, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControlGroup=snmpControlGroup, nTPLastSync=nTPLastSync, linkStatusTrap=linkStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, ethernetGroup=ethernetGroup, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatus=dataPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, alarmsGroup=alarmsGroup, searchState=searchState, channelSelection=channelSelection, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, ntp=ntp, notificationsGroup=notificationsGroup, sNMPCommunityOid=sNMPCommunityOid, band=band, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, alarms=alarms, nTPSync=nTPSync, radarDetectTrap=radarDetectTrap, ptp=ptp, maximumTransmitPower=maximumTransmitPower, radarDetectChannel=radarDetectChannel, sNMPEnabledTraps=sNMPEnabledTraps, remoteMACAddress=remoteMACAddress, remoteIPAddress=remoteIPAddress, ptp250=ptp250, ntpGroup=ntpGroup, currentChannel=currentChannel, nTPServerIp=nTPServerIp, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, ptpTraps=ptpTraps, sNMPTrapCommunity=sNMPTrapCommunity, nTPState=nTPState, antennaGain=antennaGain, subnetMask=subnetMask, ptpGroups=ptpGroups, hardwareVersion=hardwareVersion, linkName=linkName, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, cableLoss=cableLoss, phyStatus=phyStatus, nTPServerPortNumber=nTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, sNMPCommunityAccess=sNMPCommunityAccess, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPPollInterval=nTPPollInterval, dualPayload=dualPayload, iPAddress=iPAddress, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, vlanPriority=vlanPriority, installArmStateTrap=installArmStateTrap, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, sNMPCommunityTable=sNMPCommunityTable, receiveModulationMode=receiveModulationMode, softwareVersion=softwareVersion, configuredModulationMode=configuredModulationMode, vlanId=vlanId, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, measuredRange=measuredRange, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, currentFreqMHz=currentFreqMHz, installArmState=installArmState, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, ptpCompliance=ptpCompliance, noiseFloor=noiseFloor, configuredRange=configuredRange, vlanTagging=vlanTagging)
