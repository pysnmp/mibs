...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitPower=transmitPower, versions=versions, licence=licence, PYSNMP_MODULE_ID=cambium, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, noiseFloor=noiseFloor, configuredRange=configuredRange, management=management, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkStatusTrap=linkStatusTrap, alarms=alarms, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerIp=nTPServerIp, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, linkLoss=linkLoss, nTPPollInterval=nTPPollInterval, receiveModulationMode=receiveModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, signalStrengthRatio=signalStrengthRatio, extendedFreqMHz=extendedFreqMHz, aggregateDataRate=aggregateDataRate, timeZone=timeZone, configuredModulationMode=configuredModulationMode, pubStatsGroup=pubStatsGroup, dualPayload=dualPayload, sNMPCommunityTable=sNMPCommunityTable, vlanPriority=vlanPriority, nTPSync=nTPSync, channelBandwidth=channelBandwidth, installArmState=installArmState, band=band, notificationsGroup=notificationsGroup, cambium=cambium, productVariant=productVariant, ntp=ntp, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPAddress=iPAddress, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelSelection=channelSelection, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, nTPState=nTPState, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, siteName=siteName, remoteIPAddress=remoteIPAddress, nTPLastSync=nTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMACAddress=remoteMACAddress, ptmp=ptmp, bootVersion=bootVersion, cableLoss=cableLoss, currentChannel=currentChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, ntpGroup=ntpGroup, ptp=ptp, subnetMask=subnetMask, softwareVersion=softwareVersion, smtpGroup=smtpGroup, productName=productName, maximumTransmitPower=maximumTransmitPower, sNMPTrapCommunity=sNMPTrapCommunity, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, installArmStateTrap=installArmStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, regionCode=regionCode, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, vlanTagging=vlanTagging, masterSlaveMode=masterSlaveMode, ethernet=ethernet, receiveDataRate=receiveDataRate, ptp250=ptp250, snmpControlGroup=snmpControlGroup, nTPServerPortNumber=nTPServerPortNumber, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, sNMPCommunityAccess=sNMPCommunityAccess, configurationGroup=configurationGroup, transmitDataRate=transmitDataRate, alarmsGroup=alarmsGroup, radarDetectChannel=radarDetectChannel, phyStatus=phyStatus, hardwareVersion=hardwareVersion, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetGroup=ethernetGroup, measuredRange=measuredRange, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, radarDetectTrap=radarDetectTrap, ptpTraps=ptpTraps, searchState=searchState, transmitModulationMode=transmitModulationMode, sNMPCommunityOid=sNMPCommunityOid, managementGroup=managementGroup, configuration=configuration, extendedChannel=extendedChannel, ptpGroups=ptpGroups, receivePower=receivePower)
