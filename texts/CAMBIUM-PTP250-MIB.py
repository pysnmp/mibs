...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityTable=sNMPCommunityTable, smtpGroup=smtpGroup, transmitModulationMode=transmitModulationMode, managementGroup=managementGroup, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, extendedChannel=extendedChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, vlanPriority=vlanPriority, tFTPServerPortNumber=tFTPServerPortNumber, productVariant=productVariant, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, siteName=siteName, productName=productName, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, currentChannel=currentChannel, channelSelection=channelSelection, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, vectorError=vectorError, noiseFloor=noiseFloor, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, smtp=smtp, linkLoss=linkLoss, radarDetectChannel=radarDetectChannel, hardwareVersion=hardwareVersion, nTPServerPortNumber=nTPServerPortNumber, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, ptp=ptp, searchState=searchState, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, snmpControl=snmpControl, ptmp=ptmp, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, bootVersion=bootVersion, regionCode=regionCode, timeZone=timeZone, nTPServerIp=nTPServerIp, configuration=configuration, fixedModMode=fixedModMode, ethernet=ethernet, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableLoss=cableLoss, ptp250=ptp250, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, transmitDataRate=transmitDataRate, systemClock=systemClock, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vlanTagging=vlanTagging, antennaGain=antennaGain, snmpControlGroup=snmpControlGroup, versions=versions, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dualPayload=dualPayload, subnetMask=subnetMask, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpCompliance=ptpCompliance, management=management, ntp=ntp, transmitPower=transmitPower, radarDetectTrap=radarDetectTrap, cambium=cambium, nTPState=nTPState, dataPortStatusTrap=dataPortStatusTrap, measuredRange=measuredRange, ntpGroup=ntpGroup, licence=licence, remoteIPAddress=remoteIPAddress, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, configuredModulationMode=configuredModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, receivePower=receivePower, notificationsGroup=notificationsGroup, nTPPollInterval=nTPPollInterval, band=band, installArmState=installArmState, vlanId=vlanId, configuredRange=configuredRange, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, iPAddress=iPAddress, ethernetGroup=ethernetGroup, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, linkStatusTrap=linkStatusTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableEntry=sNMPTrapTableEntry)
