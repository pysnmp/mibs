...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", managementGroup=managementGroup, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedChannel=extendedChannel, channelSelection=channelSelection, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noiseFloor=noiseFloor, ptp=ptp, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, fixedModMode=fixedModMode, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapVersion=sNMPTrapVersion, ptp250=ptp250, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuredModulationMode=configuredModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanTagging=vlanTagging, nTPServerIp=nTPServerIp, pubStatsGroup=pubStatsGroup, extendedFreqMHz=extendedFreqMHz, vectorError=vectorError, cambium=cambium, radarDetectTrap=radarDetectTrap, antennaGain=antennaGain, ethernetGroup=ethernetGroup, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, measuredRange=measuredRange, siteName=siteName, nTPState=nTPState, productVariant=productVariant, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, radarDetectChannel=radarDetectChannel, masterSlaveMode=masterSlaveMode, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityOid=sNMPCommunityOid, linkName=linkName, systemClock=systemClock, versions=versions, remoteMACAddress=remoteMACAddress, receivePower=receivePower, sNMPEnabledTraps=sNMPEnabledTraps, ptpGroups=ptpGroups, licence=licence, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPSync=nTPSync, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, sNMPCommunityAccess=sNMPCommunityAccess, nTPLastSync=nTPLastSync, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, nTPServerPortNumber=nTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, configuredRange=configuredRange, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, configuration=configuration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, licenceGroup=licenceGroup, alarms=alarms, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, productName=productName, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, searchState=searchState, regionCode=regionCode, notificationsGroup=notificationsGroup, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, vlanPriority=vlanPriority, currentChannel=currentChannel, linkLoss=linkLoss, phyStatusGroup=phyStatusGroup, transmitDataRate=transmitDataRate, band=band, dualPayload=dualPayload, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, smtpGroup=smtpGroup, nTPPollInterval=nTPPollInterval, remoteIPAddress=remoteIPAddress, vlanId=vlanId, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, ntp=ntp, ntpGroup=ntpGroup, transmitPower=transmitPower, alarmsGroup=alarmsGroup, installArmState=installArmState)
