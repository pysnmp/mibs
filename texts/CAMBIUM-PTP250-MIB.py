...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortStatus=dataPortStatus, remoteMACAddress=remoteMACAddress, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, transmitPower=transmitPower, systemClock=systemClock, snmpControl=snmpControl, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, iPAddress=iPAddress, ptp250=ptp250, pubStatsGroup=pubStatsGroup, fixedModMode=fixedModMode, nTPSync=nTPSync, siteName=siteName, smtpGroup=smtpGroup, band=band, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, nTPServerPortNumber=nTPServerPortNumber, vlanPriority=vlanPriority, receivePower=receivePower, linkName=linkName, ptpGroups=ptpGroups, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, nTPLastSync=nTPLastSync, configuredModulationMode=configuredModulationMode, notificationsGroup=notificationsGroup, vlanTagging=vlanTagging, maximumTransmitPower=maximumTransmitPower, sNMPCommunityOid=sNMPCommunityOid, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, cambium=cambium, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityAccess=sNMPCommunityAccess, nTPPollInterval=nTPPollInterval, timeZone=timeZone, versionsGroup=versionsGroup, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, vectorError=vectorError, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedFreqMHz=extendedFreqMHz, aggregateDataRate=aggregateDataRate, currentChannel=currentChannel, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, searchState=searchState, ntpGroup=ntpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, channelSelection=channelSelection, sNMPEnabledTraps=sNMPEnabledTraps, vlanId=vlanId, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, extendedChannel=extendedChannel, versions=versions, configurationGroup=configurationGroup, productVariant=productVariant, sNMPCommunityTableNumber=sNMPCommunityTableNumber, antennaGain=antennaGain, installArmState=installArmState, radarDetectChannel=radarDetectChannel, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, linkLoss=linkLoss, channelBandwidth=channelBandwidth, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, measuredRange=measuredRange, bootVersion=bootVersion, nTPState=nTPState, configuredRange=configuredRange, pubStats=pubStats, subnetMask=subnetMask, linkStatusTrap=linkStatusTrap, smtp=smtp, ntp=ntp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, dualPayload=dualPayload, receiveDataRate=receiveDataRate, configuration=configuration, ptmp=ptmp, noiseFloor=noiseFloor)
