...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, channelSelection=channelSelection, hardwareVersion=hardwareVersion, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, bootVersion=bootVersion, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, transmitDataRate=transmitDataRate, ethernetGroup=ethernetGroup, linkName=linkName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receivePower=receivePower, productName=productName, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, ethernet=ethernet, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, configuredRange=configuredRange, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, dualPayload=dualPayload, vlanTagging=vlanTagging, phyStatus=phyStatus, linkLoss=linkLoss, noiseFloor=noiseFloor, radarDetectChannel=radarDetectChannel, vlanPriority=vlanPriority, iPAddress=iPAddress, smtp=smtp, nTPServerPortNumber=nTPServerPortNumber, radarDetectTrap=radarDetectTrap, configurationGroup=configurationGroup, subnetMask=subnetMask, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, searchState=searchState, ptpTrapPrefix=ptpTrapPrefix, timeZone=timeZone, band=band, fixedModMode=fixedModMode, snmpControl=snmpControl, smtpGroup=smtpGroup, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, receiveModulationMode=receiveModulationMode, ptp250=ptp250, sNMPCommunityTableNumber=sNMPCommunityTableNumber, regionCode=regionCode, managementGroup=managementGroup, sNMPCommunityAccess=sNMPCommunityAccess, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemClock=systemClock, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPPollInterval=nTPPollInterval, transmitPower=transmitPower, nTPServerIp=nTPServerIp, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, configuredModulationMode=configuredModulationMode, nTPSync=nTPSync, currentChannel=currentChannel, licence=licence, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPState=nTPState, ntp=ntp, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, ntpGroup=ntpGroup, currentFreqMHz=currentFreqMHz, measuredRange=measuredRange, dataPortStatus=dataPortStatus, alarms=alarms, siteName=siteName, productVariant=productVariant, linkStatusTrap=linkStatusTrap, vlanId=vlanId, aggregateDataRate=aggregateDataRate, management=management, ptpGroups=ptpGroups, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, extendedChannel=extendedChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, configuration=configuration)
