...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", remoteMACAddress=remoteMACAddress, ptpCompliance=ptpCompliance, nTPState=nTPState, pubStats=pubStats, ptmp=ptmp, transmitDataRate=transmitDataRate, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, licenceGroup=licenceGroup, extendedChannel=extendedChannel, management=management, vectorError=vectorError, ptp250=ptp250, maximumTransmitPower=maximumTransmitPower, currentChannel=currentChannel, vlanPriority=vlanPriority, sNMPTrapTable=sNMPTrapTable, ethernet=ethernet, softwareVersion=softwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, versionsGroup=versionsGroup, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection, productVariant=productVariant, ptpGroups=ptpGroups, smtp=smtp, ntpGroup=ntpGroup, receiveModulationMode=receiveModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, productName=productName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, band=band, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, noiseFloor=noiseFloor, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vlanTagging=vlanTagging, systemClock=systemClock, sNMPTrapCommunity=sNMPTrapCommunity, PYSNMP_MODULE_ID=cambium, radarDetectChannel=radarDetectChannel, managementGroup=managementGroup, ethernetGroup=ethernetGroup, sMTPServerPortNumber=sMTPServerPortNumber, snmpControl=snmpControl, versions=versions, aggregateDataRate=aggregateDataRate, vlanId=vlanId, nTPSync=nTPSync, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, snmpControlGroup=snmpControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, sNMPCommunityAccess=sNMPCommunityAccess, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, currentFreqMHz=currentFreqMHz, linkLoss=linkLoss, alarmsGroup=alarmsGroup, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, smtpGroup=smtpGroup, bootVersion=bootVersion, installArmState=installArmState, signalStrengthRatio=signalStrengthRatio, ntp=ntp, pubStatsGroup=pubStatsGroup, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, masterSlaveMode=masterSlaveMode, dualPayload=dualPayload, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, iPAddress=iPAddress, hardwareVersion=hardwareVersion, regionCode=regionCode, antennaGain=antennaGain, linkName=linkName, nTPServerIp=nTPServerIp, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, measuredRange=measuredRange, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, searchState=searchState, timeZone=timeZone, transmitPower=transmitPower, sNMPCommunityOid=sNMPCommunityOid, radarDetectTrap=radarDetectTrap, configuredRange=configuredRange, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, fixedModMode=fixedModMode, linkStatusTrap=linkStatusTrap, configuredModulationMode=configuredModulationMode, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth)
