...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, nTPLastSync=nTPLastSync, ntp=ntp, linkStatusTrap=linkStatusTrap, band=band, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, ptpGroups=ptpGroups, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, pubStats=pubStats, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licence=licence, aggregateDataRate=aggregateDataRate, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, maximumTransmitPower=maximumTransmitPower, currentChannel=currentChannel, siteName=siteName, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, versions=versions, sNMPCommunityOid=sNMPCommunityOid, remoteMACAddress=remoteMACAddress, installArmStateTrap=installArmStateTrap, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, productName=productName, snmpControl=snmpControl, dualPayload=dualPayload, nTPState=nTPState, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, sNMPEnabledTraps=sNMPEnabledTraps, configuredModulationMode=configuredModulationMode, alarmsGroup=alarmsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, radarDetectTrap=radarDetectTrap, extendedChannel=extendedChannel, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, linkLoss=linkLoss, smtp=smtp, vlanPriority=vlanPriority, phyStatusGroup=phyStatusGroup, searchState=searchState, receiveDataRate=receiveDataRate, fixedModMode=fixedModMode, regionCode=regionCode, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, noiseFloor=noiseFloor, ptp250=ptp250, nTPSync=nTPSync, transmitModulationMode=transmitModulationMode, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatus=phyStatus, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, ptpTraps=ptpTraps, configuration=configuration, management=management, nTPServerIp=nTPServerIp, sNMPCommunityAccess=sNMPCommunityAccess, dataPortStatusTrap=dataPortStatusTrap, nTPPollInterval=nTPPollInterval, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerIPAddress=tFTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, installArmState=installArmState, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, radarDetectChannel=radarDetectChannel, alarms=alarms, remoteIPAddress=remoteIPAddress, vlanId=vlanId, measuredRange=measuredRange, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, ntpGroup=ntpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredRange=configuredRange, channelSelection=channelSelection, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable)
