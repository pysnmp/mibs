...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStats=pubStats, nTPSync=nTPSync, extendedChannel=extendedChannel, remoteMACAddress=remoteMACAddress, ptpCompliance=ptpCompliance, sNMPCommunityTableEntry=sNMPCommunityTableEntry, managementGroup=managementGroup, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, searchState=searchState, extendedFreqMHz=extendedFreqMHz, sNMPCommunityString=sNMPCommunityString, versions=versions, vlanTagging=vlanTagging, ptpGroups=ptpGroups, snmpControl=snmpControl, subnetMask=subnetMask, nTPState=nTPState, cambium=cambium, linkName=linkName, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, nTPServerIp=nTPServerIp, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp=ptp, gatewayIPAddress=gatewayIPAddress, radarDetectChannel=radarDetectChannel, ptpTraps=ptpTraps, radarDetectTrap=radarDetectTrap, management=management, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanId=vlanId, installArmState=installArmState, alarmsGroup=alarmsGroup, ntpGroup=ntpGroup, sNMPCommunityTable=sNMPCommunityTable, ntp=ntp, masterSlaveMode=masterSlaveMode, configuration=configuration, ptp250=ptp250, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuredRange=configuredRange, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, tFTPServerPortNumber=tFTPServerPortNumber, linkStatusTrap=linkStatusTrap, antennaGain=antennaGain, measuredRange=measuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, currentChannel=currentChannel, licence=licence, sNMPTrapTable=sNMPTrapTable, ptmp=ptmp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, smtp=smtp, versionsGroup=versionsGroup, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, fixedModMode=fixedModMode, configuredModulationMode=configuredModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, noiseFloor=noiseFloor, dataPortAutoNegotiation=dataPortAutoNegotiation, band=band, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, softwareVersion=softwareVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, productName=productName, ethernet=ethernet, nTPLastSync=nTPLastSync, installArmStateTrap=installArmStateTrap, sNMPCommunityAccess=sNMPCommunityAccess, notificationsGroup=notificationsGroup, bootVersion=bootVersion, vlanPriority=vlanPriority, nTPServerPortNumber=nTPServerPortNumber, regionCode=regionCode, timeZone=timeZone, iPAddress=iPAddress, sNMPCommunityOid=sNMPCommunityOid, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, nTPPollInterval=nTPPollInterval, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, channelSelection=channelSelection, currentFreqMHz=currentFreqMHz, pubStatsGroup=pubStatsGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vectorError=vectorError)
