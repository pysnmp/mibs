...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptp=ptp, configuration=configuration, nTPState=nTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, band=band, radarDetectTrap=radarDetectTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, receiveModulationMode=receiveModulationMode, configuredRange=configuredRange, ntpGroup=ntpGroup, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, measuredRange=measuredRange, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, vlanTagging=vlanTagging, sNMPCommunityTable=sNMPCommunityTable, bootVersion=bootVersion, snmpControlGroup=snmpControlGroup, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, vlanId=vlanId, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, ntp=ntp, smtp=smtp, extendedChannel=extendedChannel, siteName=siteName, management=management, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, extendedFreqMHz=extendedFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, channelSelection=channelSelection, vectorError=vectorError, nTPServerPortNumber=nTPServerPortNumber, receivePower=receivePower, installArmState=installArmState, licenceGroup=licenceGroup, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, sMTPServerIPAddress=sMTPServerIPAddress, ethernet=ethernet, currentChannel=currentChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, dualPayload=dualPayload, systemClock=systemClock, radarDetectChannel=radarDetectChannel, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, configurationGroup=configurationGroup, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, fixedModMode=fixedModMode, installArmStateTrap=installArmStateTrap, sNMPCommunityOid=sNMPCommunityOid, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, pubStats=pubStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noiseFloor=noiseFloor, softwareVersion=softwareVersion, timeZone=timeZone, signalStrengthRatio=signalStrengthRatio, currentFreqMHz=currentFreqMHz, productName=productName, maximumTransmitPower=maximumTransmitPower, nTPPollInterval=nTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapCommunity=sNMPTrapCommunity, ptpGroups=ptpGroups, configuredModulationMode=configuredModulationMode, ptpCompliance=ptpCompliance, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, gatewayIPAddress=gatewayIPAddress, nTPSync=nTPSync, ptp250=ptp250, managementGroup=managementGroup, linkStatusTrap=linkStatusTrap, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, searchState=searchState, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMACAddress=remoteMACAddress, sNMPCommunityAccess=sNMPCommunityAccess, aggregateDataRate=aggregateDataRate, ptmp=ptmp, cambium=cambium, regionCode=regionCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, phyStatusGroup=phyStatusGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkLoss=linkLoss)
