...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", gatewayIPAddress=gatewayIPAddress, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, extendedFreqMHz=extendedFreqMHz, nTPSync=nTPSync, hardwareVersion=hardwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cableLoss=cableLoss, regionCode=regionCode, aggregateDataRate=aggregateDataRate, ptmp=ptmp, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, vectorError=vectorError, channelSelection=channelSelection, wirelessLinkStatus=wirelessLinkStatus, radarDetectTrap=radarDetectTrap, notificationsGroup=notificationsGroup, productVariant=productVariant, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, iPAddress=iPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, currentFreqMHz=currentFreqMHz, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableEntry=sNMPCommunityTableEntry, fixedModMode=fixedModMode, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, licenceGroup=licenceGroup, radarDetectChannel=radarDetectChannel, linkLoss=linkLoss, management=management, nTPServerIp=nTPServerIp, noiseFloor=noiseFloor, softwareVersion=softwareVersion, vlanId=vlanId, snmpControl=snmpControl, searchState=searchState, ntp=ntp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, timeZone=timeZone, phyStatus=phyStatus, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, vlanPriority=vlanPriority, configuredModulationMode=configuredModulationMode, smtpGroup=smtpGroup, masterSlaveMode=masterSlaveMode, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, cambium=cambium, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, dualPayload=dualPayload, alarms=alarms, sNMPEnabledTraps=sNMPEnabledTraps, ethernetGroup=ethernetGroup, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatus=dataPortStatus, configuredRange=configuredRange, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bootVersion=bootVersion, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, band=band, ethernet=ethernet, nTPPollInterval=nTPPollInterval, productName=productName, measuredRange=measuredRange, ptp=ptp, managementGroup=managementGroup, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, currentChannel=currentChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, receiveDataRate=receiveDataRate, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, installArmState=installArmState, nTPState=nTPState, versions=versions, phyStatusGroup=phyStatusGroup)
