...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanPriority=vlanPriority, ptmp=ptmp, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, aggregateDataRate=aggregateDataRate, productName=productName, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, cableLoss=cableLoss, smtp=smtp, siteName=siteName, nTPSync=nTPSync, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, iPAddress=iPAddress, nTPLastSync=nTPLastSync, regionCode=regionCode, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuration=configuration, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, antennaGain=antennaGain, currentChannel=currentChannel, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTable=sNMPCommunityTable, linkName=linkName, systemClock=systemClock, receiveModulationMode=receiveModulationMode, management=management, fixedModMode=fixedModMode, vlanTagging=vlanTagging, subnetMask=subnetMask, configuredRange=configuredRange, tFTPServerIPAddress=tFTPServerIPAddress, configuredModulationMode=configuredModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtpGroup=smtpGroup, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, timeZone=timeZone, dataPortStatus=dataPortStatus, versions=versions, linkStatusTrap=linkStatusTrap, ptp250=ptp250, alarms=alarms, sNMPTrapTable=sNMPTrapTable, sMTPEnabledMessages=sMTPEnabledMessages, ptpTraps=ptpTraps, ptp=ptp, cambium=cambium, vlanId=vlanId, installArmState=installArmState, sNMPCommunityAccess=sNMPCommunityAccess, sMTPServerIPAddress=sMTPServerIPAddress, linkLoss=linkLoss, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, band=band, bootVersion=bootVersion, snmpControl=snmpControl, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, channelSelection=channelSelection, notificationsGroup=notificationsGroup, dualPayload=dualPayload, licence=licence, nTPState=nTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, searchState=searchState, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, alarmsGroup=alarmsGroup, ethernet=ethernet, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, vectorError=vectorError, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPPollInterval=nTPPollInterval, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, dataPortStatusTrap=dataPortStatusTrap, versionsGroup=versionsGroup, configurationGroup=configurationGroup, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, sNMPCommunityOid=sNMPCommunityOid, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, radarDetectChannel=radarDetectChannel, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, managementGroup=managementGroup, ntpGroup=ntpGroup, noiseFloor=noiseFloor, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, PYSNMP_MODULE_ID=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, ntp=ntp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
