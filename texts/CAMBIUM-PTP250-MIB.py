...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configurationGroup=configurationGroup, nTPSync=nTPSync, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, installArmState=installArmState, cambium=cambium, regionCode=regionCode, linkName=linkName, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, fixedModMode=fixedModMode, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, ntpGroup=ntpGroup, configuredRange=configuredRange, licenceGroup=licenceGroup, radarDetectTrap=radarDetectTrap, signalStrengthRatio=signalStrengthRatio, nTPServerIp=nTPServerIp, hardwareVersion=hardwareVersion, bootVersion=bootVersion, productVariant=productVariant, searchState=searchState, ptmp=ptmp, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, transmitDataRate=transmitDataRate, gatewayIPAddress=gatewayIPAddress, configuration=configuration, sNMPCommunityTableEntry=sNMPCommunityTableEntry, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, channelSelection=channelSelection, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, configuredModulationMode=configuredModulationMode, currentFreqMHz=currentFreqMHz, sNMPCommunityTable=sNMPCommunityTable, productName=productName, systemClock=systemClock, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, ntp=ntp, versionsGroup=versionsGroup, snmpControl=snmpControl, cableLoss=cableLoss, noiseFloor=noiseFloor, maximumTransmitPower=maximumTransmitPower, phyStatus=phyStatus, ptpTraps=ptpTraps, smtpGroup=smtpGroup, vlanTagging=vlanTagging, aggregateDataRate=aggregateDataRate, vlanPriority=vlanPriority, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, measuredRange=measuredRange, dualPayload=dualPayload, ptp250=ptp250, alarms=alarms, sNMPEnabledTraps=sNMPEnabledTraps, managementGroup=managementGroup, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapCommunity=sNMPTrapCommunity, nTPLastSync=nTPLastSync, extendedChannel=extendedChannel, vectorError=vectorError, radarDetectChannel=radarDetectChannel, ethernet=ethernet, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, linkStatusTrap=linkStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableNumber=sNMPCommunityTableNumber, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, vlanId=vlanId, sNMPCommunityOid=sNMPCommunityOid, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, remoteMACAddress=remoteMACAddress, masterSlaveMode=masterSlaveMode, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, nTPState=nTPState, ethernetGroup=ethernetGroup, channelBandwidth=channelBandwidth, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, siteName=siteName, remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, nTPPollInterval=nTPPollInterval, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
