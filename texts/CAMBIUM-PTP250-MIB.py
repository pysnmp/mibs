...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", licence=licence, phyStatus=phyStatus, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectTrap=radarDetectTrap, sMTPServerIPAddress=sMTPServerIPAddress, currentChannel=currentChannel, installArmStateTrap=installArmStateTrap, transmitDataRate=transmitDataRate, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, channelSelection=channelSelection, configuredRange=configuredRange, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, masterSlaveMode=masterSlaveMode, timeZone=timeZone, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPSync=nTPSync, dualPayload=dualPayload, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, ntpGroup=ntpGroup, radarDetectChannel=radarDetectChannel, systemClock=systemClock, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, nTPServerIp=nTPServerIp, bootVersion=bootVersion, antennaGain=antennaGain, ptpGroups=ptpGroups, searchState=searchState, configurationGroup=configurationGroup, snmpControl=snmpControl, softwareVersion=softwareVersion, ethernet=ethernet, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, vectorError=vectorError, cambium=cambium, nTPServerPortNumber=nTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapVersion=sNMPTrapVersion, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, ptp=ptp, snmpControlGroup=snmpControlGroup, productName=productName, nTPState=nTPState, management=management, receiveDataRate=receiveDataRate, linkName=linkName, ptpCompliance=ptpCompliance, ntp=ntp, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPAddress=iPAddress, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, currentFreqMHz=currentFreqMHz, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, gatewayIPAddress=gatewayIPAddress, vlanId=vlanId, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, linkStatusTrap=linkStatusTrap, noiseFloor=noiseFloor, vlanTagging=vlanTagging, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, versions=versions, dataPortStatus=dataPortStatus, productVariant=productVariant, dataPortStatusTrap=dataPortStatusTrap, receiveModulationMode=receiveModulationMode, ptp250=ptp250, receivePower=receivePower, pubStatsGroup=pubStatsGroup, smtpGroup=smtpGroup, extendedFreqMHz=extendedFreqMHz, configuration=configuration, transmitPower=transmitPower, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPLastSync=nTPLastSync, extendedChannel=extendedChannel, wirelessLinkStatus=wirelessLinkStatus, remoteMACAddress=remoteMACAddress, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, vlanPriority=vlanPriority, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, sMTPEnabledMessages=sMTPEnabledMessages, band=band, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementGroup=managementGroup, ptpTrapPrefix=ptpTrapPrefix, alarmsGroup=alarmsGroup, smtp=smtp, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber)
