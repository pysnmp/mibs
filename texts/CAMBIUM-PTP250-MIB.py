...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanPriority=vlanPriority, transmitDataRate=transmitDataRate, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, currentChannel=currentChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp250=ptp250, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, iPAddress=iPAddress, managementGroup=managementGroup, siteName=siteName, notificationsGroup=notificationsGroup, ntp=ntp, licence=licence, linkName=linkName, versions=versions, currentFreqMHz=currentFreqMHz, phyStatus=phyStatus, hardwareVersion=hardwareVersion, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, receivePower=receivePower, sNMPCommunityAccess=sNMPCommunityAccess, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, radarDetectChannel=radarDetectChannel, management=management, nTPSync=nTPSync, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, channelSelection=channelSelection, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedChannel=extendedChannel, linkStatusTrap=linkStatusTrap, ptpTrapPrefix=ptpTrapPrefix, nTPPollInterval=nTPPollInterval, configurationGroup=configurationGroup, timeZone=timeZone, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, dualPayload=dualPayload, ptpGroups=ptpGroups, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, subnetMask=subnetMask, ntpGroup=ntpGroup, PYSNMP_MODULE_ID=cambium, configuredRange=configuredRange, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, vlanTagging=vlanTagging, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, nTPState=nTPState, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, snmpControlGroup=snmpControlGroup, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, fixedModMode=fixedModMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, radarDetectTrap=radarDetectTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, noiseFloor=noiseFloor, masterSlaveMode=masterSlaveMode, vlanId=vlanId, versionsGroup=versionsGroup, antennaGain=antennaGain, productVariant=productVariant, installArmState=installArmState, configuredModulationMode=configuredModulationMode, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, ptpTraps=ptpTraps, band=band, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, extendedFreqMHz=extendedFreqMHz, measuredRange=measuredRange, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, smtp=smtp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatus=dataPortStatus, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMACAddress=remoteMACAddress, snmpControl=snmpControl, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, cambium=cambium, remoteIPAddress=remoteIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, pubStats=pubStats)
