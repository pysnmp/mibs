...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanTagging=vlanTagging, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, nTPSync=nTPSync, nTPServerPortNumber=nTPServerPortNumber, versions=versions, vlanId=vlanId, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkName=linkName, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, nTPLastSync=nTPLastSync, ntpGroup=ntpGroup, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, extendedChannel=extendedChannel, ptp250=ptp250, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, noiseFloor=noiseFloor, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, alarms=alarms, band=band, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, extendedFreqMHz=extendedFreqMHz, ptp=ptp, measuredRange=measuredRange, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, productVariant=productVariant, antennaGain=antennaGain, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, snmpControl=snmpControl, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, fixedModMode=fixedModMode, configuredRange=configuredRange, currentFreqMHz=currentFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, sNMPCommunityString=sNMPCommunityString, radarDetectTrap=radarDetectTrap, tFTPServerIPAddress=tFTPServerIPAddress, ptpTraps=ptpTraps, configurationGroup=configurationGroup, remoteIPAddress=remoteIPAddress, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPPollInterval=nTPPollInterval, ptpCompliance=ptpCompliance, nTPState=nTPState, notificationsGroup=notificationsGroup, dualPayload=dualPayload, installArmState=installArmState, pubStats=pubStats, transmitPower=transmitPower, ptmp=ptmp, snmpControlGroup=snmpControlGroup, sNMPCommunityTable=sNMPCommunityTable, vlanPriority=vlanPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, receivePower=receivePower, dataPortStatus=dataPortStatus, nTPServerIp=nTPServerIp, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, licence=licence, bootVersion=bootVersion, currentChannel=currentChannel, radarDetectChannel=radarDetectChannel, siteName=siteName, sNMPCommunityAccess=sNMPCommunityAccess, phyStatusGroup=phyStatusGroup, systemClock=systemClock, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntp=ntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, versionsGroup=versionsGroup, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, phyStatus=phyStatus, remoteMACAddress=remoteMACAddress, subnetMask=subnetMask, productName=productName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, configuredModulationMode=configuredModulationMode, cambium=cambium, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, linkStatusTrap=linkStatusTrap, configuration=configuration, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailable=noWirelessChannelAvailable, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, sNMPCommunityOid=sNMPCommunityOid, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber)
