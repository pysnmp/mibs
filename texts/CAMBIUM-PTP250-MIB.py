...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", softwareVersion=softwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, wirelessLinkStatus=wirelessLinkStatus, measuredRange=measuredRange, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, radarDetectChannel=radarDetectChannel, regionCode=regionCode, linkName=linkName, currentFreqMHz=currentFreqMHz, linkStatusTrap=linkStatusTrap, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, vlanTagging=vlanTagging, linkLoss=linkLoss, ethernet=ethernet, pubStats=pubStats, configuredModulationMode=configuredModulationMode, remoteMACAddress=remoteMACAddress, transmitDataRate=transmitDataRate, phyStatus=phyStatus, vlanPriority=vlanPriority, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, nTPState=nTPState, ptmp=ptmp, productVariant=productVariant, alarms=alarms, dualPayload=dualPayload, nTPServerPortNumber=nTPServerPortNumber, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTable=sNMPCommunityTable, snmpControl=snmpControl, gatewayIPAddress=gatewayIPAddress, ntpGroup=ntpGroup, extendedChannel=extendedChannel, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, channelSelection=channelSelection, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, configurationGroup=configurationGroup, vectorError=vectorError, ptpTraps=ptpTraps, extendedFreqMHz=extendedFreqMHz, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, ptp250=ptp250, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, systemClock=systemClock, management=management, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, siteName=siteName, versions=versions, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, ptp=ptp, nTPPollInterval=nTPPollInterval, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, radarDetectTrap=radarDetectTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, bootVersion=bootVersion, configuredRange=configuredRange, subnetMask=subnetMask, configuration=configuration, receiveModulationMode=receiveModulationMode, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPServerIp=nTPServerIp, managementGroup=managementGroup, productName=productName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, currentChannel=currentChannel, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, receivePower=receivePower, searchState=searchState, noiseFloor=noiseFloor, receiveDataRate=receiveDataRate, vlanId=vlanId, nTPLastSync=nTPLastSync, band=band, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, sNMPCommunityOid=sNMPCommunityOid, ntp=ntp, sNMPCommunityTableNumber=sNMPCommunityTableNumber)
