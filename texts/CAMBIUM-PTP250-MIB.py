...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configurationGroup=configurationGroup, iPAddress=iPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, extendedChannel=extendedChannel, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup, dualPayload=dualPayload, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatus=phyStatus, radarDetectChannel=radarDetectChannel, noiseFloor=noiseFloor, dataPortStatus=dataPortStatus, snmpControl=snmpControl, sNMPCommunityTableNumber=sNMPCommunityTableNumber, maximumTransmitPower=maximumTransmitPower, configuredModulationMode=configuredModulationMode, antennaGain=antennaGain, cableLoss=cableLoss, vlanTagging=vlanTagging, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, linkName=linkName, ptpCompliance=ptpCompliance, cambium=cambium, ntpGroup=ntpGroup, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, receiveDataRate=receiveDataRate, sMTPEnabledMessages=sMTPEnabledMessages, timeZone=timeZone, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, sNMPTrapVersion=sNMPTrapVersion, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTraps=ptpTraps, siteName=siteName, nTPSync=nTPSync, ntp=ntp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, channelBandwidth=channelBandwidth, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, ethernet=ethernet, vlanPriority=vlanPriority, currentChannel=currentChannel, extendedFreqMHz=extendedFreqMHz, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationMode=receiveModulationMode, versions=versions, nTPLastSync=nTPLastSync, fixedModMode=fixedModMode, linkStatusTrap=linkStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, band=band, measuredRange=measuredRange, receivePower=receivePower, masterSlaveMode=masterSlaveMode, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, smtp=smtp, licenceGroup=licenceGroup, vectorError=vectorError, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, alarmsGroup=alarmsGroup, configuration=configuration, nTPPollInterval=nTPPollInterval, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, subnetMask=subnetMask, regionCode=regionCode, installArmState=installArmState, channelSelection=channelSelection, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, pubStatsGroup=pubStatsGroup, sNMPTrapCommunity=sNMPTrapCommunity, productVariant=productVariant, configuredRange=configuredRange, hardwareVersion=hardwareVersion, remoteMACAddress=remoteMACAddress, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, radarDetectTrap=radarDetectTrap, sNMPCommunityString=sNMPCommunityString, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, nTPState=nTPState, transmitModulationMode=transmitModulationMode, nTPServerIp=nTPServerIp, ethernetGroup=ethernetGroup, management=management, ptp250=ptp250, pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmStateTrap=installArmStateTrap)
