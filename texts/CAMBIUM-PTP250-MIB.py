...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerPortNumber=nTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, snmpControlGroup=snmpControlGroup, sNMPCommunityTable=sNMPCommunityTable, licence=licence, phyStatus=phyStatus, versions=versions, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hardwareVersion=hardwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ntp=ntp, configuredRange=configuredRange, transmitPower=transmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedChannel=extendedChannel, aggregateDataRate=aggregateDataRate, vlanId=vlanId, sNMPCommunityTableNumber=sNMPCommunityTableNumber, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, tFTPServerIPAddress=tFTPServerIPAddress, configuredModulationMode=configuredModulationMode, productVariant=productVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, ntpGroup=ntpGroup, vlanPriority=vlanPriority, nTPState=nTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, bootVersion=bootVersion, nTPServerIp=nTPServerIp, ethernet=ethernet, configuration=configuration, gatewayIPAddress=gatewayIPAddress, linkName=linkName, siteName=siteName, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, radarDetectChannel=radarDetectChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, notificationsGroup=notificationsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noiseFloor=noiseFloor, management=management, nTPSync=nTPSync, channelSelection=channelSelection, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, cambium=cambium, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, productName=productName, receivePower=receivePower, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPPollInterval=nTPPollInterval, systemClock=systemClock, band=band, ptp250=ptp250, installArmState=installArmState, vectorError=vectorError, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectTrap=radarDetectTrap, measuredRange=measuredRange, ethernetGroup=ethernetGroup, managementGroup=managementGroup, versionsGroup=versionsGroup, currentChannel=currentChannel, ptpTraps=ptpTraps, currentFreqMHz=currentFreqMHz, ptp=ptp, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatus=dataPortStatus, linkLoss=linkLoss, linkStatusTrap=linkStatusTrap, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, dualPayload=dualPayload, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, ptpGroups=ptpGroups, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, phyStatusGroup=phyStatusGroup, vlanTagging=vlanTagging, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, maximumTransmitPower=maximumTransmitPower, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, extendedFreqMHz=extendedFreqMHz, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, nTPLastSync=nTPLastSync, fixedModMode=fixedModMode, ptmp=ptmp)
