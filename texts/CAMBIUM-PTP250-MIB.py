...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, radarDetectTrap=radarDetectTrap, cableLoss=cableLoss, smtp=smtp, linkLoss=linkLoss, softwareVersion=softwareVersion, ntp=ntp, nTPServerIp=nTPServerIp, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityOid=sNMPCommunityOid, smtpGroup=smtpGroup, receiveModulationMode=receiveModulationMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanTagging=vlanTagging, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, linkStatusTrap=linkStatusTrap, sNMPTrapCommunity=sNMPTrapCommunity, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, currentChannel=currentChannel, ethernetGroup=ethernetGroup, installArmState=installArmState, radarDetectChannel=radarDetectChannel, vectorError=vectorError, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernet=ethernet, fixedModMode=fixedModMode, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, wirelessLinkStatus=wirelessLinkStatus, remoteMACAddress=remoteMACAddress, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp250=ptp250, tFTPServerPortNumber=tFTPServerPortNumber, channelSelection=channelSelection, siteName=siteName, channelBandwidth=channelBandwidth, sNMPCommunityAccess=sNMPCommunityAccess, configurationGroup=configurationGroup, ptp=ptp, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, cambium=cambium, nTPState=nTPState, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, dualPayload=dualPayload, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, configuration=configuration, ptmp=ptmp, productName=productName, phyStatus=phyStatus, iPAddress=iPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, currentFreqMHz=currentFreqMHz, systemClock=systemClock, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, configuredModulationMode=configuredModulationMode, vlanPriority=vlanPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapVersion=sNMPTrapVersion, installArmStateTrap=installArmStateTrap, nTPServerPortNumber=nTPServerPortNumber, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, pubStatsGroup=pubStatsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, configuredRange=configuredRange, phyStatusGroup=phyStatusGroup, versions=versions, nTPLastSync=nTPLastSync, management=management, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, band=band, searchState=searchState, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, nTPSync=nTPSync, receiveDataRate=receiveDataRate, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, timeZone=timeZone, bootVersion=bootVersion, alarms=alarms, extendedChannel=extendedChannel, managementGroup=managementGroup, measuredRange=measuredRange)
