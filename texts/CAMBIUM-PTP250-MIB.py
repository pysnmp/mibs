...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", productName=productName, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, phyStatus=phyStatus, configuration=configuration, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, configuredModulationMode=configuredModulationMode, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, ptp=ptp, versionsGroup=versionsGroup, pubStats=pubStats, channelSelection=channelSelection, systemClock=systemClock, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, vlanTagging=vlanTagging, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, extendedChannel=extendedChannel, channelBandwidth=channelBandwidth, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, band=band, alarmsGroup=alarmsGroup, sMTPServerIPAddress=sMTPServerIPAddress, vlanId=vlanId, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, ptmp=ptmp, siteName=siteName, nTPPollInterval=nTPPollInterval, bootVersion=bootVersion, ethernetGroup=ethernetGroup, subnetMask=subnetMask, transmitPower=transmitPower, PYSNMP_MODULE_ID=cambium, configuredRange=configuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, nTPState=nTPState, fixedModMode=fixedModMode, ntpGroup=ntpGroup, notificationsGroup=notificationsGroup, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, ethernet=ethernet, cableLoss=cableLoss, productVariant=productVariant, receiveModulationMode=receiveModulationMode, noiseFloor=noiseFloor, alarms=alarms, hardwareVersion=hardwareVersion, radarDetectChannel=radarDetectChannel, smtpGroup=smtpGroup, ptp250=ptp250, radarDetectTrap=radarDetectTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, remoteIPAddress=remoteIPAddress, dataPortStatusTrap=dataPortStatusTrap, regionCode=regionCode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, remoteMACAddress=remoteMACAddress, licence=licence, ptpTrapPrefix=ptpTrapPrefix, signalStrengthRatio=signalStrengthRatio, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, installArmStateTrap=installArmStateTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dualPayload=dualPayload, vlanPriority=vlanPriority, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ntp=ntp, licenceGroup=licenceGroup, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, linkStatusTrap=linkStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, managementGroup=managementGroup, ptpTraps=ptpTraps, sNMPCommunityTableIndex=sNMPCommunityTableIndex, measuredRange=measuredRange, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, linkName=linkName, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, currentFreqMHz=currentFreqMHz)
