...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noiseFloor=noiseFloor, smtp=smtp, timeZone=timeZone, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, ntp=ntp, radarDetectChannel=radarDetectChannel, channelBandwidth=channelBandwidth, configuredRange=configuredRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityOid=sNMPCommunityOid, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, dataPortStatus=dataPortStatus, band=band, licenceGroup=licenceGroup, managementGroup=managementGroup, ntpGroup=ntpGroup, hardwareVersion=hardwareVersion, ptp=ptp, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, vlanTagging=vlanTagging, measuredRange=measuredRange, nTPState=nTPState, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpGroups=ptpGroups, installArmState=installArmState, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, currentChannel=currentChannel, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, fixedModMode=fixedModMode, linkName=linkName, softwareVersion=softwareVersion, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, channelSelection=channelSelection, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, alarmsGroup=alarmsGroup, vectorError=vectorError, vlanPriority=vlanPriority, licence=licence, productName=productName, subnetMask=subnetMask, ptp250=ptp250, nTPLastSync=nTPLastSync, systemClock=systemClock, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpTraps=ptpTraps, currentFreqMHz=currentFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, nTPServerIp=nTPServerIp, ethernet=ethernet, regionCode=regionCode, configuration=configuration, snmpControl=snmpControl, extendedFreqMHz=extendedFreqMHz, remoteMACAddress=remoteMACAddress, iPAddress=iPAddress, notificationsGroup=notificationsGroup, cambium=cambium, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatusGroup=phyStatusGroup, pubStatsGroup=pubStatsGroup, configuredModulationMode=configuredModulationMode, nTPSync=nTPSync, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, searchState=searchState, receiveDataRate=receiveDataRate, antennaGain=antennaGain, vlanId=vlanId, sNMPEnabledTraps=sNMPEnabledTraps, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, maximumTransmitPower=maximumTransmitPower, linkStatusTrap=linkStatusTrap, ptmp=ptmp, versions=versions)
