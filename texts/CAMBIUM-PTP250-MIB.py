...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", alarms=alarms, configurationGroup=configurationGroup, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, noiseFloor=noiseFloor, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, PYSNMP_MODULE_ID=cambium, sNMPCommunityString=sNMPCommunityString, transmitModulationMode=transmitModulationMode, phyStatusGroup=phyStatusGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControl=snmpControl, channelBandwidth=channelBandwidth, nTPLastSync=nTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitPower=transmitPower, configuration=configuration, softwareVersion=softwareVersion, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTable=sNMPCommunityTable, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, linkStatusTrap=linkStatusTrap, extendedChannel=extendedChannel, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vlanId=vlanId, receiveDataRate=receiveDataRate, channelSelection=channelSelection, fixedModMode=fixedModMode, currentFreqMHz=currentFreqMHz, linkLoss=linkLoss, snmpControlGroup=snmpControlGroup, dualPayload=dualPayload, timeZone=timeZone, iPAddress=iPAddress, systemClock=systemClock, nTPState=nTPState, vlanTagging=vlanTagging, ptp=ptp, bootVersion=bootVersion, nTPServerPortNumber=nTPServerPortNumber, ptpTraps=ptpTraps, radarDetectChannel=radarDetectChannel, licence=licence, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, extendedFreqMHz=extendedFreqMHz, ptp250=ptp250, nTPServerIp=nTPServerIp, vlanPriority=vlanPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernet=ethernet, currentChannel=currentChannel, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, siteName=siteName, nTPSync=nTPSync, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapCommunity=sNMPTrapCommunity, alarmsGroup=alarmsGroup, antennaGain=antennaGain, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, pubStats=pubStats, ptpGroups=ptpGroups, remoteMACAddress=remoteMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radarDetectTrap=radarDetectTrap, productName=productName, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, smtp=smtp, band=band, versions=versions, nTPPollInterval=nTPPollInterval, configuredModulationMode=configuredModulationMode, ntpGroup=ntpGroup, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, ntp=ntp, management=management, measuredRange=measuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, cambium=cambium, sNMPCommunityAccess=sNMPCommunityAccess, productVariant=productVariant, dataPortStatus=dataPortStatus)
