...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", band=band, remoteMACAddress=remoteMACAddress, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, dualPayload=dualPayload, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityString=sNMPCommunityString, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, linkName=linkName, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatus=phyStatus, extendedChannel=extendedChannel, radarDetectTrap=radarDetectTrap, transmitPower=transmitPower, vlanId=vlanId, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityOid=sNMPCommunityOid, configurationGroup=configurationGroup, channelSelection=channelSelection, noiseFloor=noiseFloor, nTPSync=nTPSync, snmpControlGroup=snmpControlGroup, nTPServerIp=nTPServerIp, nTPServerPortNumber=nTPServerPortNumber, alarms=alarms, cambium=cambium, configuredModulationMode=configuredModulationMode, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp250=ptp250, vectorError=vectorError, phyStatusGroup=phyStatusGroup, licence=licence, linkLoss=linkLoss, versions=versions, siteName=siteName, remoteIPAddress=remoteIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, currentChannel=currentChannel, maximumTransmitPower=maximumTransmitPower, sNMPTrapCommunity=sNMPTrapCommunity, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, ntpGroup=ntpGroup, snmpControl=snmpControl, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, fixedModMode=fixedModMode, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, smtp=smtp, cableLoss=cableLoss, configuration=configuration, management=management, sNMPCommunityTableIndex=sNMPCommunityTableIndex, regionCode=regionCode, tFTPServerPortNumber=tFTPServerPortNumber, nTPState=nTPState, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radarDetectChannel=radarDetectChannel, installArmState=installArmState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp=ptp, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, receivePower=receivePower, subnetMask=subnetMask, timeZone=timeZone, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, versionsGroup=versionsGroup, vlanPriority=vlanPriority, nTPPollInterval=nTPPollInterval, sNMPCommunityAccess=sNMPCommunityAccess, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, antennaGain=antennaGain, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, vlanTagging=vlanTagging, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, measuredRange=measuredRange, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, configuredRange=configuredRange, sMTPServerPortNumber=sMTPServerPortNumber, iPAddress=iPAddress, ntp=ntp, nTPLastSync=nTPLastSync)
