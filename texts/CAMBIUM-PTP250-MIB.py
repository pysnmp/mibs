...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTable=sNMPCommunityTable, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementGroup=managementGroup, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, sNMPTrapTableNumber=sNMPTrapTableNumber, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, sNMPTrapCommunity=sNMPTrapCommunity, snmpControlGroup=snmpControlGroup, ptp250=ptp250, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, management=management, versionsGroup=versionsGroup, softwareVersion=softwareVersion, linkStatusTrap=linkStatusTrap, radarDetectTrap=radarDetectTrap, sMTPServerIPAddress=sMTPServerIPAddress, pubStats=pubStats, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPAddress=iPAddress, subnetMask=subnetMask, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName, receiveModulationMode=receiveModulationMode, cambium=cambium, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, siteName=siteName, transmitPower=transmitPower, nTPState=nTPState, productVariant=productVariant, configuredModulationMode=configuredModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, nTPPollInterval=nTPPollInterval, fixedModMode=fixedModMode, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanPriority=vlanPriority, currentFreqMHz=currentFreqMHz, nTPSync=nTPSync, PYSNMP_MODULE_ID=cambium, remoteMACAddress=remoteMACAddress, noiseFloor=noiseFloor, timeZone=timeZone, antennaGain=antennaGain, nTPServerIp=nTPServerIp, configuredRange=configuredRange, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, channelBandwidth=channelBandwidth, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, licence=licence, versions=versions, sNMPCommunityOid=sNMPCommunityOid, systemClock=systemClock, extendedFreqMHz=extendedFreqMHz, vlanId=vlanId, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, configurationGroup=configurationGroup, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, ntp=ntp, ptp=ptp, dataPortStatus=dataPortStatus, measuredRange=measuredRange, smtp=smtp, dataPortStatusTrap=dataPortStatusTrap, channelSelection=channelSelection, vlanTagging=vlanTagging, installArmStateTrap=installArmStateTrap, receivePower=receivePower, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityTableEntry=sNMPCommunityTableEntry, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, pubStatsGroup=pubStatsGroup, sNMPCommunityAccess=sNMPCommunityAccess, licenceGroup=licenceGroup, alarmsGroup=alarmsGroup, extendedChannel=extendedChannel, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, cableLoss=cableLoss, dualPayload=dualPayload, ethernet=ethernet, linkName=linkName, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, signalStrengthRatio=signalStrengthRatio, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, alarms=alarms, radarDetectChannel=radarDetectChannel, phyStatus=phyStatus)
