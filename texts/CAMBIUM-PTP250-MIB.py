...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dualPayload=dualPayload, nTPSync=nTPSync, transmitPower=transmitPower, timeZone=timeZone, sNMPCommunityAccess=sNMPCommunityAccess, gatewayIPAddress=gatewayIPAddress, subnetMask=subnetMask, alarmsGroup=alarmsGroup, ptmp=ptmp, band=band, vlanId=vlanId, ntp=ntp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapIPAddress=sNMPTrapIPAddress, licenceGroup=licenceGroup, systemClock=systemClock, ptp=ptp, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPPollInterval=nTPPollInterval, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, installArmStateTrap=installArmStateTrap, linkName=linkName, nTPServerPortNumber=nTPServerPortNumber, productVariant=productVariant, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuration=configuration, radarDetectChannel=radarDetectChannel, antennaGain=antennaGain, remoteIPAddress=remoteIPAddress, management=management, notificationsGroup=notificationsGroup, nTPServerIp=nTPServerIp, fixedModMode=fixedModMode, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTable=sNMPCommunityTable, ptpGroups=ptpGroups, searchState=searchState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, smtp=smtp, sNMPCommunityString=sNMPCommunityString, nTPLastSync=nTPLastSync, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, extendedChannel=extendedChannel, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, sMTPServerPortNumber=sMTPServerPortNumber, measuredRange=measuredRange, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, ntpGroup=ntpGroup, nTPState=nTPState, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, noiseFloor=noiseFloor, cableLoss=cableLoss, channelSelection=channelSelection, vlanPriority=vlanPriority, receiveDataRate=receiveDataRate, configuredRange=configuredRange, receiveModulationMode=receiveModulationMode, managementGroup=managementGroup, vlanTagging=vlanTagging, sNMPTrapCommunity=sNMPTrapCommunity, phyStatus=phyStatus, versionsGroup=versionsGroup, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, transmitModulationMode=transmitModulationMode, ethernet=ethernet, configurationGroup=configurationGroup, smtpGroup=smtpGroup, extendedFreqMHz=extendedFreqMHz, channelBandwidth=channelBandwidth, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, remoteMACAddress=remoteMACAddress, sNMPTrapVersion=sNMPTrapVersion, versions=versions, ptpTraps=ptpTraps, snmpControl=snmpControl, ptp250=ptp250, bootVersion=bootVersion, currentChannel=currentChannel, licence=licence, vectorError=vectorError, siteName=siteName, linkStatusTrap=linkStatusTrap, PYSNMP_MODULE_ID=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex)
