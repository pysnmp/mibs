...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanPriority=vlanPriority, productVariant=productVariant, nTPState=nTPState, remoteMACAddress=remoteMACAddress, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedFreqMHz=extendedFreqMHz, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, iPAddress=iPAddress, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, ptpGroups=ptpGroups, subnetMask=subnetMask, vlanId=vlanId, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, searchState=searchState, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, licenceGroup=licenceGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectTrap=radarDetectTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBandwidth=channelBandwidth, systemClock=systemClock, timeZone=timeZone, configuredRange=configuredRange, pubStatsGroup=pubStatsGroup, alarms=alarms, versions=versions, softwareVersion=softwareVersion, band=band, currentFreqMHz=currentFreqMHz, sNMPTrapVersion=sNMPTrapVersion, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, currentChannel=currentChannel, configurationGroup=configurationGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, cableLoss=cableLoss, extendedChannel=extendedChannel, vlanTagging=vlanTagging, smtpGroup=smtpGroup, ptp250=ptp250, PYSNMP_MODULE_ID=cambium, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernet=ethernet, measuredRange=measuredRange, transmitDataRate=transmitDataRate, linkName=linkName, pubStats=pubStats, vectorError=vectorError, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPPollInterval=nTPPollInterval, smtp=smtp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, receiveDataRate=receiveDataRate, linkStatusTrap=linkStatusTrap, configuredModulationMode=configuredModulationMode, ptpCompliance=ptpCompliance, snmpControl=snmpControl, noiseFloor=noiseFloor, phyStatusGroup=phyStatusGroup, fixedModMode=fixedModMode, maximumTransmitPower=maximumTransmitPower, management=management, remoteIPAddress=remoteIPAddress, sNMPCommunityOid=sNMPCommunityOid, licence=licence, ntpGroup=ntpGroup, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPLastSync=nTPLastSync, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, cambium=cambium, installArmStateTrap=installArmStateTrap, dualPayload=dualPayload, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, versionsGroup=versionsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmsGroup=alarmsGroup, ntp=ntp, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerPortNumber=sMTPServerPortNumber, phyStatus=phyStatus, transmitPower=transmitPower, ptmp=ptmp)
