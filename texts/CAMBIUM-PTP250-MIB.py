...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", currentFreqMHz=currentFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, vlanId=vlanId, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, configuration=configuration, ntp=ntp, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, bootVersion=bootVersion, ptmp=ptmp, snmpControl=snmpControl, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, dualPayload=dualPayload, extendedChannel=extendedChannel, sNMPCommunityAccess=sNMPCommunityAccess, configurationGroup=configurationGroup, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp=ptp, linkName=linkName, alarmsGroup=alarmsGroup, timeZone=timeZone, sNMPTrapCommunity=sNMPTrapCommunity, productVariant=productVariant, nTPServerPortNumber=nTPServerPortNumber, radarDetectChannel=radarDetectChannel, installArmState=installArmState, ptpTraps=ptpTraps, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, ethernet=ethernet, channelBandwidth=channelBandwidth, smtp=smtp, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, measuredRange=measuredRange, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTable=sNMPCommunityTable, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, currentChannel=currentChannel, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, alarms=alarms, iPAddress=iPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, vectorError=vectorError, smtpGroup=smtpGroup, nTPServerIp=nTPServerIp, fixedModMode=fixedModMode, nTPState=nTPState, pubStatsGroup=pubStatsGroup, systemClock=systemClock, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, vlanPriority=vlanPriority, aggregateDataRate=aggregateDataRate, tFTPServerPortNumber=tFTPServerPortNumber, vlanTagging=vlanTagging, sNMPTrapIPAddress=sNMPTrapIPAddress, extendedFreqMHz=extendedFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, radarDetectTrap=radarDetectTrap, noiseFloor=noiseFloor, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, channelSelection=channelSelection, nTPPollInterval=nTPPollInterval, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, configuredModulationMode=configuredModulationMode, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, ptpGroups=ptpGroups, versions=versions, versionsGroup=versionsGroup, softwareVersion=softwareVersion, masterSlaveMode=masterSlaveMode, nTPSync=nTPSync, management=management, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatusGroup=phyStatusGroup, configuredRange=configuredRange, ptp250=ptp250, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable)
