...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatus=phyStatus, remoteMACAddress=remoteMACAddress, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, cableLoss=cableLoss, linkName=linkName, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, vlanPriority=vlanPriority, currentChannel=currentChannel, smtpGroup=smtpGroup, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versions=versions, management=management, sMTPServerIPAddress=sMTPServerIPAddress, measuredRange=measuredRange, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, dualPayload=dualPayload, nTPPollInterval=nTPPollInterval, managementGroup=managementGroup, nTPLastSync=nTPLastSync, ntpGroup=ntpGroup, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatusTrap=dataPortStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, vlanId=vlanId, searchState=searchState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ntp=ntp, subnetMask=subnetMask, extendedChannel=extendedChannel, channelBandwidth=channelBandwidth, snmpControl=snmpControl, configuration=configuration, nTPSync=nTPSync, sNMPTrapTable=sNMPTrapTable, channelSelection=channelSelection, ptp250=ptp250, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, siteName=siteName, signalStrengthRatio=signalStrengthRatio, noiseFloor=noiseFloor, sMTPServerPortNumber=sMTPServerPortNumber, iPAddress=iPAddress, softwareVersion=softwareVersion, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, PYSNMP_MODULE_ID=cambium, configurationGroup=configurationGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableIndex=sNMPCommunityTableIndex, productVariant=productVariant, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, fixedModMode=fixedModMode, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkStatusTrap=linkStatusTrap, ethernetGroup=ethernetGroup, dataPortStatus=dataPortStatus, smtp=smtp, sNMPCommunityString=sNMPCommunityString, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernet=ethernet, ptpCompliance=ptpCompliance, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, ptp=ptp, licence=licence, ptpTrapPrefix=ptpTrapPrefix, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, ptmp=ptmp, sNMPCommunityOid=sNMPCommunityOid, linkLoss=linkLoss, timeZone=timeZone, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, nTPState=nTPState, radarDetectTrap=radarDetectTrap, cambium=cambium, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpGroups=ptpGroups, pubStats=pubStats, vectorError=vectorError, band=band, systemClock=systemClock, receiveDataRate=receiveDataRate, configuredRange=configuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, currentFreqMHz=currentFreqMHz, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableEntry=sNMPTrapTableEntry)
