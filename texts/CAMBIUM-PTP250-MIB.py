...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", regionCode=regionCode, extendedFreqMHz=extendedFreqMHz, configuration=configuration, configuredRange=configuredRange, sMTPServerIPAddress=sMTPServerIPAddress, ntp=ntp, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, transmitPower=transmitPower, snmpControl=snmpControl, configuredModulationMode=configuredModulationMode, productName=productName, sNMPTrapCommunity=sNMPTrapCommunity, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPPollInterval=nTPPollInterval, siteName=siteName, bootVersion=bootVersion, sNMPTrapTable=sNMPTrapTable, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, radarDetectChannel=radarDetectChannel, measuredRange=measuredRange, alarmsGroup=alarmsGroup, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, sNMPCommunityTableIndex=sNMPCommunityTableIndex, notificationsGroup=notificationsGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControlGroup=snmpControlGroup, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, vlanId=vlanId, currentFreqMHz=currentFreqMHz, softwareVersion=softwareVersion, channelSelection=channelSelection, sNMPCommunityTable=sNMPCommunityTable, extendedChannel=extendedChannel, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, noiseFloor=noiseFloor, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, currentChannel=currentChannel, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, timeZone=timeZone, nTPLastSync=nTPLastSync, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, ntpGroup=ntpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, linkStatusTrap=linkStatusTrap, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, installArmStateTrap=installArmStateTrap, linkName=linkName, cambium=cambium, hardwareVersion=hardwareVersion, ptp250=ptp250, ptp=ptp, vlanTagging=vlanTagging, remoteMACAddress=remoteMACAddress, nTPState=nTPState, managementGroup=managementGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerIp=nTPServerIp, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, licence=licence, vlanPriority=vlanPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, configurationGroup=configurationGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, channelBandwidth=channelBandwidth, band=band, masterSlaveMode=masterSlaveMode, ptmp=ptmp, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectTrap=radarDetectTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarms=alarms, pubStats=pubStats, nTPSync=nTPSync, phyStatus=phyStatus, versions=versions, vectorError=vectorError, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, dualPayload=dualPayload, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain)
