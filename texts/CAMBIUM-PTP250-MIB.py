...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, sNMPCommunityTable=sNMPCommunityTable, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, alarms=alarms, configuration=configuration, ptpGroups=ptpGroups, smtp=smtp, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ntpGroup=ntpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatus=dataPortStatus, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableNumber=sNMPCommunityTableNumber, wirelessLinkStatus=wirelessLinkStatus, extendedChannel=extendedChannel, aggregateDataRate=aggregateDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPServerPortNumber=nTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, configurationGroup=configurationGroup, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, measuredRange=measuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPState=nTPState, nTPServerIp=nTPServerIp, licence=licence, currentFreqMHz=currentFreqMHz, remoteMACAddress=remoteMACAddress, productVariant=productVariant, cableLoss=cableLoss, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, managementGroup=managementGroup, installArmState=installArmState, regionCode=regionCode, channelSelection=channelSelection, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredModulationMode=configuredModulationMode, productName=productName, linkName=linkName, systemClock=systemClock, smtpGroup=smtpGroup, configuredRange=configuredRange, snmpControlGroup=snmpControlGroup, dualPayload=dualPayload, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, subnetMask=subnetMask, receiveDataRate=receiveDataRate, antennaGain=antennaGain, sNMPTrapCommunity=sNMPTrapCommunity, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, vlanId=vlanId, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, pubStats=pubStats, ptpTraps=ptpTraps, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, extendedFreqMHz=extendedFreqMHz, linkLoss=linkLoss, vlanPriority=vlanPriority, ptp250=ptp250, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectTrap=radarDetectTrap, nTPLastSync=nTPLastSync, radarDetectChannel=radarDetectChannel, transmitDataRate=transmitDataRate, siteName=siteName, management=management, noiseFloor=noiseFloor, hardwareVersion=hardwareVersion, fixedModMode=fixedModMode, sNMPCommunityAccess=sNMPCommunityAccess, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, iPAddress=iPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, linkStatusTrap=linkStatusTrap, signalStrengthRatio=signalStrengthRatio, vlanTagging=vlanTagging, pubStatsGroup=pubStatsGroup, bootVersion=bootVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, versions=versions, nTPPollInterval=nTPPollInterval, nTPSync=nTPSync, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, sNMPCommunityOid=sNMPCommunityOid, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityString=sNMPCommunityString, band=band, ntp=ntp, timeZone=timeZone, currentChannel=currentChannel)
