...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", timeZone=timeZone, pubStats=pubStats, smtp=smtp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, receiveDataRate=receiveDataRate, configuration=configuration, sNMPCommunityOid=sNMPCommunityOid, channelSelection=channelSelection, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, vlanId=vlanId, sMTPServerPortNumber=sMTPServerPortNumber, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredRange=configuredRange, smtpGroup=smtpGroup, phyStatus=phyStatus, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, ptp250=ptp250, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, masterSlaveMode=masterSlaveMode, band=band, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmState=installArmState, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPPollInterval=nTPPollInterval, PYSNMP_MODULE_ID=cambium, searchState=searchState, vlanPriority=vlanPriority, antennaGain=antennaGain, ptp=ptp, radarDetectChannel=radarDetectChannel, vectorError=vectorError, ntp=ntp, sNMPTrapCommunity=sNMPTrapCommunity, radarDetectTrap=radarDetectTrap, versionsGroup=versionsGroup, ptmp=ptmp, nTPServerIp=nTPServerIp, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanTagging=vlanTagging, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, measuredRange=measuredRange, ntpGroup=ntpGroup, extendedChannel=extendedChannel, configuredModulationMode=configuredModulationMode, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, nTPLastSync=nTPLastSync, receiveModulationMode=receiveModulationMode, remoteIPAddress=remoteIPAddress, currentChannel=currentChannel, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, currentFreqMHz=currentFreqMHz, gatewayIPAddress=gatewayIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, managementGroup=managementGroup, bootVersion=bootVersion, remoteMACAddress=remoteMACAddress, dataPortStatus=dataPortStatus, management=management, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkStatusTrap=linkStatusTrap, linkName=linkName, ethernetGroup=ethernetGroup, siteName=siteName, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, nTPState=nTPState, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, licence=licence, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, systemClock=systemClock, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, fixedModMode=fixedModMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableLoss=cableLoss, notificationsGroup=notificationsGroup, subnetMask=subnetMask, sMTPServerIPAddress=sMTPServerIPAddress, noiseFloor=noiseFloor, versions=versions, iPAddress=iPAddress, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, aggregateDataRate=aggregateDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, nTPSync=nTPSync, extendedFreqMHz=extendedFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, sNMPEnabledTraps=sNMPEnabledTraps)
