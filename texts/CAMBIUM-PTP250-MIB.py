...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", versions=versions, phyStatusGroup=phyStatusGroup, configuredModulationMode=configuredModulationMode, measuredRange=measuredRange, phyStatus=phyStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, ptpTrapPrefix=ptpTrapPrefix, nTPSync=nTPSync, nTPServerIp=nTPServerIp, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp250=ptp250, band=band, channelSelection=channelSelection, transmitPower=transmitPower, iPAddress=iPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, configuration=configuration, radarDetectChannel=radarDetectChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, management=management, ethernetGroup=ethernetGroup, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, ntp=ntp, ntpGroup=ntpGroup, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteIPAddress=remoteIPAddress, managementGroup=managementGroup, antennaGain=antennaGain, extendedFreqMHz=extendedFreqMHz, noiseFloor=noiseFloor, ptpCompliance=ptpCompliance, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, vlanPriority=vlanPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, ptpGroups=ptpGroups, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vectorError=vectorError, searchState=searchState, bootVersion=bootVersion, alarms=alarms, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityAccess=sNMPCommunityAccess, installArmStateTrap=installArmStateTrap, nTPState=nTPState, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configurationGroup=configurationGroup, vlanId=vlanId, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, snmpControlGroup=snmpControlGroup, nTPLastSync=nTPLastSync, pubStats=pubStats, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, installArmState=installArmState, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, systemClock=systemClock, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, ethernet=ethernet, smtp=smtp, notificationsGroup=notificationsGroup, linkStatusTrap=linkStatusTrap, productVariant=productVariant, currentFreqMHz=currentFreqMHz, radarDetectTrap=radarDetectTrap, fixedModMode=fixedModMode, cambium=cambium, linkName=linkName, dualPayload=dualPayload, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, siteName=siteName, transmitDataRate=transmitDataRate, snmpControl=snmpControl, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredRange=configuredRange, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, currentChannel=currentChannel, aggregateDataRate=aggregateDataRate, tFTPServerIPAddress=tFTPServerIPAddress, vlanTagging=vlanTagging, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, licence=licence, ptp=ptp, sNMPCommunityTable=sNMPCommunityTable, regionCode=regionCode, timeZone=timeZone)
