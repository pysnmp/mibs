...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", management=management, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, band=band, fixedModMode=fixedModMode, configuredModulationMode=configuredModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, ntpGroup=ntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, extendedChannel=extendedChannel, installArmStateTrap=installArmStateTrap, vectorError=vectorError, nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, smtp=smtp, masterSlaveMode=masterSlaveMode, vlanTagging=vlanTagging, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, currentChannel=currentChannel, configuration=configuration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, hardwareVersion=hardwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp250=ptp250, sNMPCommunityString=sNMPCommunityString, nTPServerIp=nTPServerIp, currentFreqMHz=currentFreqMHz, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, licence=licence, sNMPCommunityAccess=sNMPCommunityAccess, dualPayload=dualPayload, nTPPollInterval=nTPPollInterval, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, receivePower=receivePower, radarDetectTrap=radarDetectTrap, sMTPEnabledMessages=sMTPEnabledMessages, vlanPriority=vlanPriority, iPAddress=iPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, systemClock=systemClock, configuredRange=configuredRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, sNMPCommunityTable=sNMPCommunityTable, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, remoteMACAddress=remoteMACAddress, extendedFreqMHz=extendedFreqMHz, ptpGroups=ptpGroups, ptpCompliance=ptpCompliance, linkLoss=linkLoss, nTPLastSync=nTPLastSync, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, managementGroup=managementGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, gatewayIPAddress=gatewayIPAddress, measuredRange=measuredRange, linkStatusTrap=linkStatusTrap, snmpControlGroup=snmpControlGroup, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, subnetMask=subnetMask, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, notificationsGroup=notificationsGroup, channelSelection=channelSelection, nTPServerPortNumber=nTPServerPortNumber, installArmState=installArmState, ntp=ntp, versions=versions, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkName=linkName, productName=productName, tFTPServerIPAddress=tFTPServerIPAddress, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, ptp=ptp, siteName=siteName, nTPState=nTPState, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, alarms=alarms, sNMPCommunityOid=sNMPCommunityOid, transmitModulationMode=transmitModulationMode, productVariant=productVariant, ptmp=ptmp, vlanId=vlanId, noiseFloor=noiseFloor, radarDetectChannel=radarDetectChannel, bootVersion=bootVersion, maximumTransmitPower=maximumTransmitPower, sNMPTrapTable=sNMPTrapTable, softwareVersion=softwareVersion)
