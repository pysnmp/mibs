...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, timeZone=timeZone, ptpTraps=ptpTraps, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntpGroup=ntpGroup, smtpGroup=smtpGroup, extendedChannel=extendedChannel, vlanPriority=vlanPriority, gatewayIPAddress=gatewayIPAddress, radarDetectTrap=radarDetectTrap, managementGroup=managementGroup, linkName=linkName, smtp=smtp, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, nTPPollInterval=nTPPollInterval, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus, currentChannel=currentChannel, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, ptpCompliance=ptpCompliance, sNMPTrapPortNumber=sNMPTrapPortNumber, dualPayload=dualPayload, extendedFreqMHz=extendedFreqMHz, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, linkStatusTrap=linkStatusTrap, vlanId=vlanId, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, productName=productName, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPState=nTPState, pubStats=pubStats, snmpControl=snmpControl, receiveModulationMode=receiveModulationMode, ptp250=ptp250, ethernet=ethernet, ethernetGroup=ethernetGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, bootVersion=bootVersion, licenceGroup=licenceGroup, systemClock=systemClock, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTrapPrefix=ptpTrapPrefix, currentFreqMHz=currentFreqMHz, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerIp=nTPServerIp, channelBandwidth=channelBandwidth, measuredRange=measuredRange, nTPSync=nTPSync, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, band=band, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, aggregateDataRate=aggregateDataRate, notificationsGroup=notificationsGroup, receivePower=receivePower, ntp=ntp, sNMPCommunityString=sNMPCommunityString, nTPServerPortNumber=nTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, versions=versions, channelSelection=channelSelection, noiseFloor=noiseFloor, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitModulationMode=transmitModulationMode, cambium=cambium, vectorError=vectorError, iPAddress=iPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, transmitPower=transmitPower, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, subnetMask=subnetMask, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, vlanTagging=vlanTagging, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, management=management, configuredModulationMode=configuredModulationMode, remoteIPAddress=remoteIPAddress, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, configuredRange=configuredRange, fixedModMode=fixedModMode, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, transmitDataRate=transmitDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence)
