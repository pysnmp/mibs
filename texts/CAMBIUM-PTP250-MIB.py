...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelSelection=channelSelection, receivePower=receivePower, currentFreqMHz=currentFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, noiseFloor=noiseFloor, currentChannel=currentChannel, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControl=snmpControl, remoteMACAddress=remoteMACAddress, antennaGain=antennaGain, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, nTPSync=nTPSync, cambium=cambium, configuredModulationMode=configuredModulationMode, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkStatusTrap=linkStatusTrap, iPAddress=iPAddress, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, linkLoss=linkLoss, measuredRange=measuredRange, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptmp=ptmp, sNMPCommunityAccess=sNMPCommunityAccess, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, licenceGroup=licenceGroup, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, nTPServerIp=nTPServerIp, bootVersion=bootVersion, versionsGroup=versionsGroup, nTPLastSync=nTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, band=band, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectTrap=radarDetectTrap, linkName=linkName, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, radarDetectChannel=radarDetectChannel, notificationsGroup=notificationsGroup, siteName=siteName, fixedModMode=fixedModMode, nTPServerPortNumber=nTPServerPortNumber, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, regionCode=regionCode, pubStats=pubStats, receiveModulationMode=receiveModulationMode, vectorError=vectorError, ptp250=ptp250, remoteIPAddress=remoteIPAddress, extendedChannel=extendedChannel, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, sNMPTrapTable=sNMPTrapTable, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, pubStatsGroup=pubStatsGroup, ethernetGroup=ethernetGroup, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, phyStatus=phyStatus, configuredRange=configuredRange, subnetMask=subnetMask, sNMPCommunityTable=sNMPCommunityTable, dataPortStatus=dataPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpTraps=ptpTraps, ntp=ntp, extendedFreqMHz=extendedFreqMHz, vlanId=vlanId, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, ntpGroup=ntpGroup, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, management=management, licence=licence, cableLoss=cableLoss, nTPState=nTPState, sMTPServerPortNumber=sMTPServerPortNumber, productVariant=productVariant, configuration=configuration, PYSNMP_MODULE_ID=cambium, transmitPower=transmitPower, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPPollInterval=nTPPollInterval, installArmState=installArmState, versions=versions, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, ethernet=ethernet)
