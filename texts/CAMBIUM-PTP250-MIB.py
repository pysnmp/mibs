...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ntpGroup=ntpGroup, nTPPollInterval=nTPPollInterval, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedFreqMHz=extendedFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, sMTPServerPortNumber=sMTPServerPortNumber, extendedChannel=extendedChannel, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, measuredRange=measuredRange, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, band=band, phyStatus=phyStatus, currentChannel=currentChannel, vlanPriority=vlanPriority, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, linkStatusTrap=linkStatusTrap, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityAccess=sNMPCommunityAccess, cambium=cambium, bootVersion=bootVersion, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatusGroup=phyStatusGroup, productVariant=productVariant, radarDetectTrap=radarDetectTrap, ntp=ntp, productName=productName, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, sNMPCommunityOid=sNMPCommunityOid, cableLoss=cableLoss, subnetMask=subnetMask, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, vlanTagging=vlanTagging, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, iPAddress=iPAddress, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, masterSlaveMode=masterSlaveMode, configuredModulationMode=configuredModulationMode, sNMPCommunityTable=sNMPCommunityTable, ptpGroups=ptpGroups, ethernet=ethernet, currentFreqMHz=currentFreqMHz, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPState=nTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, configuration=configuration, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControl=snmpControl, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, nTPServerPortNumber=nTPServerPortNumber, pubStatsGroup=pubStatsGroup, timeZone=timeZone, dualPayload=dualPayload, licenceGroup=licenceGroup, fixedModMode=fixedModMode, licence=licence, remoteIPAddress=remoteIPAddress, softwareVersion=softwareVersion, configuredRange=configuredRange, management=management, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, noiseFloor=noiseFloor, ptmp=ptmp, receiveModulationMode=receiveModulationMode, nTPServerIp=nTPServerIp, alarmsGroup=alarmsGroup, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, systemClock=systemClock, versionsGroup=versionsGroup, linkName=linkName, installArmState=installArmState, siteName=siteName, nTPSync=nTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityString=sNMPCommunityString, notificationsGroup=notificationsGroup, antennaGain=antennaGain, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, nTPLastSync=nTPLastSync, pubStats=pubStats, ptp250=ptp250, versions=versions, vlanId=vlanId, sNMPTrapCommunity=sNMPTrapCommunity, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, channelSelection=channelSelection)
