...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", regionCode=regionCode, sNMPTrapTableEntry=sNMPTrapTableEntry, vlanPriority=vlanPriority, channelSelection=channelSelection, ntpGroup=ntpGroup, receivePower=receivePower, timeZone=timeZone, gatewayIPAddress=gatewayIPAddress, phyStatus=phyStatus, linkName=linkName, noiseFloor=noiseFloor, ethernetGroup=ethernetGroup, ptp250=ptp250, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, measuredRange=measuredRange, nTPPollInterval=nTPPollInterval, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, bootVersion=bootVersion, nTPSync=nTPSync, installArmStateTrap=installArmStateTrap, ptp=ptp, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, cableLoss=cableLoss, alarms=alarms, snmpControl=snmpControl, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, productName=productName, systemClock=systemClock, licenceGroup=licenceGroup, searchState=searchState, vectorError=vectorError, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, extendedFreqMHz=extendedFreqMHz, aggregateDataRate=aggregateDataRate, radarDetectTrap=radarDetectTrap, dualPayload=dualPayload, maximumTransmitPower=maximumTransmitPower, extendedChannel=extendedChannel, sNMPTrapCommunity=sNMPTrapCommunity, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, siteName=siteName, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitPower=transmitPower, installArmState=installArmState, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, nTPState=nTPState, phyStatusGroup=phyStatusGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, band=band, radarDetectChannel=radarDetectChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, cambium=cambium, linkLoss=linkLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configurationGroup=configurationGroup, fixedModMode=fixedModMode, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, subnetMask=subnetMask, sNMPTrapTableIndex=sNMPTrapTableIndex, PYSNMP_MODULE_ID=cambium, currentChannel=currentChannel, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, notificationsGroup=notificationsGroup, versions=versions, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, configuration=configuration, sNMPTrapTable=sNMPTrapTable, management=management, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, configuredModulationMode=configuredModulationMode, snmpControlGroup=snmpControlGroup, sNMPCommunityAccess=sNMPCommunityAccess, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteIPAddress=remoteIPAddress, vlanTagging=vlanTagging, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanId=vlanId, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, dataPortStatus=dataPortStatus, linkStatusTrap=linkStatusTrap, configuredRange=configuredRange, masterSlaveMode=masterSlaveMode, ntp=ntp, softwareVersion=softwareVersion)
