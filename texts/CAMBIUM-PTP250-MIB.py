...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, phyStatus=phyStatus, dataPortStatus=dataPortStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedChannel=extendedChannel, linkLoss=linkLoss, subnetMask=subnetMask, radarDetectChannel=radarDetectChannel, nTPState=nTPState, vlanTagging=vlanTagging, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp250=ptp250, timeZone=timeZone, versions=versions, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanPriority=vlanPriority, pubStats=pubStats, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, hardwareVersion=hardwareVersion, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, currentChannel=currentChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitModulationMode=transmitModulationMode, vlanId=vlanId, sNMPCommunityTableEntry=sNMPCommunityTableEntry, installArmState=installArmState, iPAddress=iPAddress, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, band=band, nTPLastSync=nTPLastSync, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapPortNumber=sNMPTrapPortNumber, alarms=alarms, currentFreqMHz=currentFreqMHz, vectorError=vectorError, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPSync=nTPSync, ptmp=ptmp, sMTPEnabledMessages=sMTPEnabledMessages, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerPortNumber=nTPServerPortNumber, snmpControl=snmpControl, configuredModulationMode=configuredModulationMode, nTPServerIp=nTPServerIp, sNMPTrapCommunity=sNMPTrapCommunity, transmitDataRate=transmitDataRate, productVariant=productVariant, notificationsGroup=notificationsGroup, licence=licence, siteName=siteName, antennaGain=antennaGain, management=management, regionCode=regionCode, searchState=searchState, configuration=configuration, dualPayload=dualPayload, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, productName=productName, versionsGroup=versionsGroup, receivePower=receivePower, measuredRange=measuredRange, receiveModulationMode=receiveModulationMode, ntp=ntp, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtp=smtp, noiseFloor=noiseFloor, channelBandwidth=channelBandwidth, installArmStateTrap=installArmStateTrap, linkStatusTrap=linkStatusTrap, radarDetectTrap=radarDetectTrap, sNMPTrapVersion=sNMPTrapVersion, ethernet=ethernet, managementGroup=managementGroup, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, channelSelection=channelSelection, sNMPCommunityTable=sNMPCommunityTable, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, ptp=ptp, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, fixedModMode=fixedModMode)
