...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, vlanTagging=vlanTagging, nTPServerIp=nTPServerIp, nTPPollInterval=nTPPollInterval, transmitPower=transmitPower, ptmp=ptmp, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableEntry=sNMPTrapTableEntry, channelSelection=channelSelection, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productVariant=productVariant, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCode=regionCode, ptpGroups=ptpGroups, extendedChannel=extendedChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, aggregateDataRate=aggregateDataRate, ptp250=ptp250, transmitModulationMode=transmitModulationMode, ethernet=ethernet, softwareVersion=softwareVersion, pubStats=pubStats, linkName=linkName, vlanId=vlanId, ptp=ptp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, measuredRange=measuredRange, snmpControl=snmpControl, currentFreqMHz=currentFreqMHz, alarmsGroup=alarmsGroup, management=management, subnetMask=subnetMask, siteName=siteName, vlanPriority=vlanPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, gatewayIPAddress=gatewayIPAddress, configuration=configuration, sNMPTrapCommunity=sNMPTrapCommunity, smtpGroup=smtpGroup, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, licence=licence, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentChannel=currentChannel, sNMPTrapVersion=sNMPTrapVersion, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, licenceGroup=licenceGroup, configuredModulationMode=configuredModulationMode, installArmState=installArmState, channelBandwidth=channelBandwidth, timeZone=timeZone, bootVersion=bootVersion, dualPayload=dualPayload, receiveDataRate=receiveDataRate, radarDetectTrap=radarDetectTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, radarDetectChannel=radarDetectChannel, smtp=smtp, fixedModMode=fixedModMode, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, nTPState=nTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, band=band, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, iPAddress=iPAddress, installArmStateTrap=installArmStateTrap, nTPLastSync=nTPLastSync, productName=productName, vectorError=vectorError, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, configuredRange=configuredRange, linkLoss=linkLoss, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, maximumTransmitPower=maximumTransmitPower, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPSync=nTPSync, cableLoss=cableLoss, antennaGain=antennaGain, phyStatus=phyStatus, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, versions=versions, hardwareVersion=hardwareVersion, cambium=cambium, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, ntp=ntp, receivePower=receivePower, linkStatusTrap=linkStatusTrap, alarms=alarms, versionsGroup=versionsGroup, noiseFloor=noiseFloor)
