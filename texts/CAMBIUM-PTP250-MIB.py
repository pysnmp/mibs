...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPSync=nTPSync, alarms=alarms, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanPriority=vlanPriority, ptpCompliance=ptpCompliance, dataPortStatus=dataPortStatus, smtp=smtp, ptpTrapPrefix=ptpTrapPrefix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControlGroup=snmpControlGroup, remoteMACAddress=remoteMACAddress, extendedFreqMHz=extendedFreqMHz, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, hardwareVersion=hardwareVersion, iPAddress=iPAddress, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, licenceGroup=licenceGroup, channelSelection=channelSelection, ptp250=ptp250, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, band=band, subnetMask=subnetMask, configuredRange=configuredRange, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityAccess=sNMPCommunityAccess, snmpControl=snmpControl, managementGroup=managementGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, regionCode=regionCode, vectorError=vectorError, installArmState=installArmState, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTable=sNMPCommunityTable, configuration=configuration, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, channelBandwidth=channelBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, radarDetectTrap=radarDetectTrap, receivePower=receivePower, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPLastSync=nTPLastSync, timeZone=timeZone, fixedModMode=fixedModMode, sNMPTrapPortNumber=sNMPTrapPortNumber, bootVersion=bootVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, currentChannel=currentChannel, notificationsGroup=notificationsGroup, alarmsGroup=alarmsGroup, phyStatus=phyStatus, radarDetectChannel=radarDetectChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noiseFloor=noiseFloor, nTPServerPortNumber=nTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, extendedChannel=extendedChannel, nTPState=nTPState, cambium=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanId=vlanId, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, aggregateDataRate=aggregateDataRate, licence=licence, vlanTagging=vlanTagging, masterSlaveMode=masterSlaveMode, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, productName=productName, ptmp=ptmp, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, configuredModulationMode=configuredModulationMode, currentFreqMHz=currentFreqMHz, siteName=siteName, sNMPTrapCommunity=sNMPTrapCommunity, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, ntp=ntp, ptp=ptp, remoteIPAddress=remoteIPAddress, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, management=management, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, versions=versions)
