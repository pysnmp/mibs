...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelSelection=channelSelection, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, extendedChannel=extendedChannel, noiseFloor=noiseFloor, sMTPServerPortNumber=sMTPServerPortNumber, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerIPAddress=sMTPServerIPAddress, remoteMACAddress=remoteMACAddress, radarDetectChannel=radarDetectChannel, transmitPower=transmitPower, nTPServerPortNumber=nTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, channelBandwidth=channelBandwidth, linkLoss=linkLoss, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, nTPServerIp=nTPServerIp, phyStatusGroup=phyStatusGroup, sNMPCommunityOid=sNMPCommunityOid, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, configuredRange=configuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, linkStatusTrap=linkStatusTrap, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPPollInterval=nTPPollInterval, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, ptpTraps=ptpTraps, ntpGroup=ntpGroup, versions=versions, pubStats=pubStats, remoteIPAddress=remoteIPAddress, sNMPCommunityTable=sNMPCommunityTable, currentFreqMHz=currentFreqMHz, transmitModulationMode=transmitModulationMode, smtpGroup=smtpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPSync=nTPSync, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, ethernetGroup=ethernetGroup, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, subnetMask=subnetMask, productName=productName, band=band, phyStatus=phyStatus, configuredModulationMode=configuredModulationMode, ntp=ntp, measuredRange=measuredRange, smtp=smtp, vectorError=vectorError, ptmp=ptmp, licence=licence, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, extendedFreqMHz=extendedFreqMHz, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, currentChannel=currentChannel, maximumTransmitPower=maximumTransmitPower, ethernet=ethernet, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPLastSync=nTPLastSync, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, vlanPriority=vlanPriority, cambium=cambium, managementGroup=managementGroup, searchState=searchState, receivePower=receivePower, snmpControl=snmpControl, licenceGroup=licenceGroup, ptp250=ptp250, versionsGroup=versionsGroup, vlanId=vlanId, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarms=alarms, management=management, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, dualPayload=dualPayload, antennaGain=antennaGain, receiveDataRate=receiveDataRate, sNMPTrapCommunity=sNMPTrapCommunity, installArmState=installArmState, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectTrap=radarDetectTrap, configuration=configuration, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion)
