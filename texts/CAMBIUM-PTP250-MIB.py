...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", bootVersion=bootVersion, remoteMACAddress=remoteMACAddress, vlanId=vlanId, linkLoss=linkLoss, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerIp=nTPServerIp, licenceGroup=licenceGroup, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, versions=versions, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapPortNumber=sNMPTrapPortNumber, radarDetectTrap=radarDetectTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, managementGroup=managementGroup, ntpGroup=ntpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, timeZone=timeZone, channelSelection=channelSelection, versionsGroup=versionsGroup, sNMPTrapCommunity=sNMPTrapCommunity, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, vlanPriority=vlanPriority, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntp=ntp, measuredRange=measuredRange, productName=productName, sNMPCommunityTable=sNMPCommunityTable, phyStatus=phyStatus, linkStatusTrap=linkStatusTrap, snmpControlGroup=snmpControlGroup, ptp250=ptp250, remoteIPAddress=remoteIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, ptmp=ptmp, configurationGroup=configurationGroup, nTPSync=nTPSync, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, pubStats=pubStats, ptpGroups=ptpGroups, sNMPCommunityOid=sNMPCommunityOid, transmitDataRate=transmitDataRate, alarms=alarms, regionCode=regionCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuration=configuration, dataPortStatus=dataPortStatus, extendedFreqMHz=extendedFreqMHz, configuredRange=configuredRange, currentChannel=currentChannel, cambium=cambium, subnetMask=subnetMask, noiseFloor=noiseFloor, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, ptp=ptp, fixedModMode=fixedModMode, systemClock=systemClock, nTPServerPortNumber=nTPServerPortNumber, configuredModulationMode=configuredModulationMode, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, ethernet=ethernet, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, currentFreqMHz=currentFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, radarDetectChannel=radarDetectChannel, iPAddress=iPAddress, band=band, dualPayload=dualPayload, dataPortStatusTrap=dataPortStatusTrap, nTPLastSync=nTPLastSync, sNMPCommunityString=sNMPCommunityString, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, licence=licence, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, nTPState=nTPState, transmitPower=transmitPower, extendedChannel=extendedChannel, productVariant=productVariant, linkName=linkName, hardwareVersion=hardwareVersion)
