...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, sNMPCommunityTable=sNMPCommunityTable, linkLoss=linkLoss, transmitDataRate=transmitDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPSync=nTPSync, softwareVersion=softwareVersion, vectorError=vectorError, channelSelection=channelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, extendedChannel=extendedChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, productVariant=productVariant, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntp=ntp, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, sNMPCommunityAccess=sNMPCommunityAccess, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, timeZone=timeZone, hardwareVersion=hardwareVersion, smtp=smtp, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPServerPortNumber=nTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, vlanId=vlanId, ptpTraps=ptpTraps, searchState=searchState, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, signalStrengthRatio=signalStrengthRatio, sNMPTrapCommunity=sNMPTrapCommunity, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuration=configuration, currentFreqMHz=currentFreqMHz, ethernet=ethernet, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, phyStatusGroup=phyStatusGroup, siteName=siteName, sNMPCommunityOid=sNMPCommunityOid, ethernetGroup=ethernetGroup, nTPState=nTPState, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, fixedModMode=fixedModMode, dualPayload=dualPayload, sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, extendedFreqMHz=extendedFreqMHz, regionCode=regionCode, receiveDataRate=receiveDataRate, cableLoss=cableLoss, cambium=cambium, sNMPEnabledTraps=sNMPEnabledTraps, currentChannel=currentChannel, noiseFloor=noiseFloor, ptp=ptp, pubStats=pubStats, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkStatusTrap=linkStatusTrap, antennaGain=antennaGain, channelBandwidth=channelBandwidth, nTPServerIp=nTPServerIp, receiveModulationMode=receiveModulationMode, transmitPower=transmitPower, PYSNMP_MODULE_ID=cambium, ntpGroup=ntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, band=band, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, productName=productName, radarDetectChannel=radarDetectChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, installArmState=installArmState, ptp250=ptp250, alarmsGroup=alarmsGroup, nTPPollInterval=nTPPollInterval, ptpGroups=ptpGroups, management=management, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, measuredRange=measuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkStatus=wirelessLinkStatus, versionsGroup=versionsGroup, licenceGroup=licenceGroup, vlanPriority=vlanPriority, vlanTagging=vlanTagging, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress)
