...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectTrap=radarDetectTrap, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, configuredModulationMode=configuredModulationMode, regionCode=regionCode, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, ntpGroup=ntpGroup, ptp250=ptp250, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, vlanPriority=vlanPriority, remoteMACAddress=remoteMACAddress, linkStatusTrap=linkStatusTrap, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, radarDetectChannel=radarDetectChannel, ptpCompliance=ptpCompliance, siteName=siteName, fixedModMode=fixedModMode, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTable=sNMPCommunityTable, snmpControl=snmpControl, licence=licence, nTPPollInterval=nTPPollInterval, transmitDataRate=transmitDataRate, noiseFloor=noiseFloor, nTPState=nTPState, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, timeZone=timeZone, versions=versions, management=management, antennaGain=antennaGain, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, band=band, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPAddress=iPAddress, phyStatus=phyStatus, currentFreqMHz=currentFreqMHz, systemClock=systemClock, configurationGroup=configurationGroup, subnetMask=subnetMask, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, extendedChannel=extendedChannel, smtp=smtp, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, channelSelection=channelSelection, productVariant=productVariant, measuredRange=measuredRange, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanTagging=vlanTagging, installArmState=installArmState, configuration=configuration, currentChannel=currentChannel, gatewayIPAddress=gatewayIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, ntp=ntp, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, linkName=linkName, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, snmpControlGroup=snmpControlGroup, licenceGroup=licenceGroup, productName=productName, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarmsGroup=alarmsGroup, ptp=ptp, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, cambium=cambium, alarms=alarms, linkLoss=linkLoss, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, vectorError=vectorError, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, managementGroup=managementGroup, bootVersion=bootVersion, vlanId=vlanId, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, channelBandwidth=channelBandwidth)
