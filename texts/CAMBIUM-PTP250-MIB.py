...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, extendedFreqMHz=extendedFreqMHz, productName=productName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapCommunity=sNMPTrapCommunity, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectTrap=radarDetectTrap, bootVersion=bootVersion, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ntp=ntp, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, linkName=linkName, nTPLastSync=nTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, ntpGroup=ntpGroup, channelSelection=channelSelection, cambium=cambium, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, ptp250=ptp250, sNMPEnabledTraps=sNMPEnabledTraps, nTPServerIp=nTPServerIp, dataPortStatus=dataPortStatus, licenceGroup=licenceGroup, configuration=configuration, gatewayIPAddress=gatewayIPAddress, ethernetGroup=ethernetGroup, licence=licence, receiveModulationMode=receiveModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, hardwareVersion=hardwareVersion, ethernet=ethernet, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, extendedChannel=extendedChannel, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, noiseFloor=noiseFloor, pubStatsGroup=pubStatsGroup, productVariant=productVariant, ptmp=ptmp, vlanId=vlanId, band=band, timeZone=timeZone, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, currentChannel=currentChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, linkStatusTrap=linkStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState, remoteMACAddress=remoteMACAddress, PYSNMP_MODULE_ID=cambium, tFTPServerIPAddress=tFTPServerIPAddress, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, smtpGroup=smtpGroup, transmitModulationMode=transmitModulationMode, phyStatus=phyStatus, ptpTraps=ptpTraps, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, configuredRange=configuredRange, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, currentFreqMHz=currentFreqMHz, measuredRange=measuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, searchState=searchState, linkLoss=linkLoss, vlanPriority=vlanPriority, vlanTagging=vlanTagging, management=management, radarDetectChannel=radarDetectChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPState=nTPState, iPAddress=iPAddress, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, fixedModMode=fixedModMode, nTPServerPortNumber=nTPServerPortNumber, transmitPower=transmitPower, configuredModulationMode=configuredModulationMode, installArmStateTrap=installArmStateTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPPollInterval=nTPPollInterval, ptp=ptp, regionCode=regionCode, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, dualPayload=dualPayload)
