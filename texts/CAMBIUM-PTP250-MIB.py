...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTable=sNMPCommunityTable, notificationsGroup=notificationsGroup, configuration=configuration, receivePower=receivePower, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, vlanPriority=vlanPriority, snmpControlGroup=snmpControlGroup, ptp250=ptp250, nTPPollInterval=nTPPollInterval, ntpGroup=ntpGroup, ntp=ntp, ptp=ptp, smtpGroup=smtpGroup, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitModulationMode=transmitModulationMode, nTPServerIp=nTPServerIp, sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, snmpControl=snmpControl, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, searchState=searchState, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, vlanTagging=vlanTagging, nTPServerPortNumber=nTPServerPortNumber, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, pubStats=pubStats, bootVersion=bootVersion, nTPLastSync=nTPLastSync, linkStatusTrap=linkStatusTrap, subnetMask=subnetMask, channelSelection=channelSelection, nTPState=nTPState, management=management, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpGroups=ptpGroups, timeZone=timeZone, linkLoss=linkLoss, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, fixedModMode=fixedModMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, dualPayload=dualPayload, siteName=siteName, licence=licence, radarDetectChannel=radarDetectChannel, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, sNMPCommunityOid=sNMPCommunityOid, transmitDataRate=transmitDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, aggregateDataRate=aggregateDataRate, vlanId=vlanId, extendedChannel=extendedChannel, PYSNMP_MODULE_ID=cambium, measuredRange=measuredRange, regionCode=regionCode, alarmsGroup=alarmsGroup, sNMPCommunityAccess=sNMPCommunityAccess, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, radarDetectTrap=radarDetectTrap, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, alarms=alarms, nTPSync=nTPSync, configuredModulationMode=configuredModulationMode, smtp=smtp, ethernet=ethernet, sNMPTrapPortNumber=sNMPTrapPortNumber, noiseFloor=noiseFloor, ethernetGroup=ethernetGroup, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, masterSlaveMode=masterSlaveMode, band=band, currentChannel=currentChannel, installArmState=installArmState, antennaGain=antennaGain, currentFreqMHz=currentFreqMHz, vectorError=vectorError, versions=versions, systemClock=systemClock, linkName=linkName, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
