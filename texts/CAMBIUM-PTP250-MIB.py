...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, subnetMask=subnetMask, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, versions=versions, measuredRange=measuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, productVariant=productVariant, currentChannel=currentChannel, configuredRange=configuredRange, ptmp=ptmp, antennaGain=antennaGain, alarms=alarms, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, vlanPriority=vlanPriority, ptp=ptp, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, versionsGroup=versionsGroup, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, ntpGroup=ntpGroup, ptpGroups=ptpGroups, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, linkLoss=linkLoss, timeZone=timeZone, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, installArmStateTrap=installArmStateTrap, channelSelection=channelSelection, smtpGroup=smtpGroup, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectChannel=radarDetectChannel, siteName=siteName, ethernetGroup=ethernetGroup, dualPayload=dualPayload, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCode=regionCode, pubStatsGroup=pubStatsGroup, nTPLastSync=nTPLastSync, radarDetectTrap=radarDetectTrap, nTPPollInterval=nTPPollInterval, notificationsGroup=notificationsGroup, configuration=configuration, installArmState=installArmState, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, transmitDataRate=transmitDataRate, pubStats=pubStats, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, iPAddress=iPAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, cambium=cambium, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkStatusTrap=linkStatusTrap, management=management, currentFreqMHz=currentFreqMHz, sNMPCommunityOid=sNMPCommunityOid, receiveDataRate=receiveDataRate, vlanId=vlanId, ntp=ntp, signalStrengthRatio=signalStrengthRatio, linkName=linkName, extendedChannel=extendedChannel, productName=productName, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, sNMPEnabledTraps=sNMPEnabledTraps, PYSNMP_MODULE_ID=cambium, nTPState=nTPState, phyStatus=phyStatus, searchState=searchState, nTPSync=nTPSync, snmpControlGroup=snmpControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, vlanTagging=vlanTagging, transmitPower=transmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber)
