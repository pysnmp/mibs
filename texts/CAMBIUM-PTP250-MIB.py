...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, band=band, configuredModulationMode=configuredModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, installArmState=installArmState, nTPServerIp=nTPServerIp, nTPServerPortNumber=nTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, hardwareVersion=hardwareVersion, transmitPower=transmitPower, linkLoss=linkLoss, currentChannel=currentChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPLastSync=nTPLastSync, sNMPTrapCommunity=sNMPTrapCommunity, softwareVersion=softwareVersion, subnetMask=subnetMask, phyStatus=phyStatus, configuration=configuration, licenceGroup=licenceGroup, smtpGroup=smtpGroup, radarDetectChannel=radarDetectChannel, configurationGroup=configurationGroup, measuredRange=measuredRange, management=management, snmpControlGroup=snmpControlGroup, vlanTagging=vlanTagging, ntp=ntp, bootVersion=bootVersion, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, alarms=alarms, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, productVariant=productVariant, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, nTPState=nTPState, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTable=sNMPCommunityTable, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, ethernet=ethernet, licence=licence, ptpTraps=ptpTraps, versionsGroup=versionsGroup, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, fixedModMode=fixedModMode, currentFreqMHz=currentFreqMHz, siteName=siteName, cambium=cambium, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityOid=sNMPCommunityOid, cableLoss=cableLoss, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, vlanId=vlanId, receivePower=receivePower, antennaGain=antennaGain, notificationsGroup=notificationsGroup, extendedChannel=extendedChannel, ptpTrapPrefix=ptpTrapPrefix, iPAddress=iPAddress, PYSNMP_MODULE_ID=cambium, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, ptp=ptp, pubStats=pubStats, receiveDataRate=receiveDataRate, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredRange=configuredRange, sNMPTrapPortNumber=sNMPTrapPortNumber, channelSelection=channelSelection, nTPSync=nTPSync, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, linkStatusTrap=linkStatusTrap, smtp=smtp, ptp250=ptp250, vectorError=vectorError, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, ntpGroup=ntpGroup, productName=productName, timeZone=timeZone, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, sNMPCommunityAccess=sNMPCommunityAccess, aggregateDataRate=aggregateDataRate)
