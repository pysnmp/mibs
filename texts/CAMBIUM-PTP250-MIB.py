...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", measuredRange=measuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, currentFreqMHz=currentFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, vlanPriority=vlanPriority, nTPLastSync=nTPLastSync, subnetMask=subnetMask, linkLoss=linkLoss, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, sNMPCommunityAccess=sNMPCommunityAccess, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPState=nTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp250=ptp250, alarms=alarms, sNMPCommunityTable=sNMPCommunityTable, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, channelBandwidth=channelBandwidth, installArmState=installArmState, configurationGroup=configurationGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, productVariant=productVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, smtp=smtp, ptpCompliance=ptpCompliance, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, band=band, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, dualPayload=dualPayload, snmpControl=snmpControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, nTPServerIp=nTPServerIp, alarmsGroup=alarmsGroup, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptmp=ptmp, ethernetGroup=ethernetGroup, remoteMACAddress=remoteMACAddress, configuration=configuration, vlanTagging=vlanTagging, pubStats=pubStats, ptpGroups=ptpGroups, receiveModulationMode=receiveModulationMode, noiseFloor=noiseFloor, radarDetectTrap=radarDetectTrap, siteName=siteName, linkStatusTrap=linkStatusTrap, management=management, ethernet=ethernet, fixedModMode=fixedModMode, nTPPollInterval=nTPPollInterval, receivePower=receivePower, ntpGroup=ntpGroup, extendedChannel=extendedChannel, configuredRange=configuredRange, nTPServerPortNumber=nTPServerPortNumber, systemClock=systemClock, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, searchState=searchState, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, vlanId=vlanId, dataPortStatus=dataPortStatus, versions=versions, productName=productName, sNMPTrapTable=sNMPTrapTable, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, regionCode=regionCode, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, extendedFreqMHz=extendedFreqMHz, channelSelection=channelSelection, iPAddress=iPAddress, ptp=ptp, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, ntp=ntp, vectorError=vectorError, notificationsGroup=notificationsGroup, timeZone=timeZone, bootVersion=bootVersion, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry)
