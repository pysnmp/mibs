...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", band=band, transmitPower=transmitPower, fixedModMode=fixedModMode, configurationGroup=configurationGroup, management=management, phyStatus=phyStatus, sNMPCommunityTable=sNMPCommunityTable, wirelessLinkStatus=wirelessLinkStatus, antennaGain=antennaGain, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, vlanId=vlanId, maximumTransmitPower=maximumTransmitPower, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, noiseFloor=noiseFloor, ptp250=ptp250, alarms=alarms, ptpGroups=ptpGroups, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, managementGroup=managementGroup, configuration=configuration, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, linkStatusTrap=linkStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, radarDetectChannel=radarDetectChannel, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, sNMPCommunityOid=sNMPCommunityOid, radarDetectTrap=radarDetectTrap, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, cambium=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, linkName=linkName, ptpCompliance=ptpCompliance, sNMPTrapCommunity=sNMPTrapCommunity, configuredModulationMode=configuredModulationMode, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ntpGroup=ntpGroup, searchState=searchState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, measuredRange=measuredRange, receiveDataRate=receiveDataRate, hardwareVersion=hardwareVersion, dualPayload=dualPayload, transmitDataRate=transmitDataRate, linkLoss=linkLoss, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemClock=systemClock, dataPortStatus=dataPortStatus, productVariant=productVariant, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanTagging=vlanTagging, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, ntp=ntp, licenceGroup=licenceGroup, pubStats=pubStats, nTPSync=nTPSync, smtp=smtp, channelSelection=channelSelection, gatewayIPAddress=gatewayIPAddress, nTPServerIp=nTPServerIp, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPAddress=iPAddress, extendedChannel=extendedChannel, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationMode=receiveModulationMode, ethernetGroup=ethernetGroup, configuredRange=configuredRange, sNMPTrapTableEntry=sNMPTrapTableEntry, softwareVersion=softwareVersion, ethernet=ethernet, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, regionCode=regionCode, cableLoss=cableLoss, channelBandwidth=channelBandwidth, ptmp=ptmp, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vlanPriority=vlanPriority, nTPLastSync=nTPLastSync, currentChannel=currentChannel, nTPServerPortNumber=nTPServerPortNumber, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptp=ptp, pubStatsGroup=pubStatsGroup, productName=productName, remoteMACAddress=remoteMACAddress, nTPState=nTPState)
