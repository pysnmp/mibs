...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, installArmStateTrap=installArmStateTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, subnetMask=subnetMask, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuration=configuration, sNMPCommunityAccess=sNMPCommunityAccess, ptmp=ptmp, searchState=searchState, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, timeZone=timeZone, transmitDataRate=transmitDataRate, nTPState=nTPState, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, alarms=alarms, radarDetectTrap=radarDetectTrap, linkName=linkName, currentFreqMHz=currentFreqMHz, smtp=smtp, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, vlanPriority=vlanPriority, receiveModulationMode=receiveModulationMode, licence=licence, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vlanTagging=vlanTagging, notificationsGroup=notificationsGroup, productVariant=productVariant, ethernet=ethernet, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, configuredModulationMode=configuredModulationMode, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, fixedModMode=fixedModMode, remoteIPAddress=remoteIPAddress, ntpGroup=ntpGroup, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkLoss=linkLoss, vectorError=vectorError, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, productName=productName, regionCode=regionCode, iPAddress=iPAddress, dualPayload=dualPayload, PYSNMP_MODULE_ID=cambium, vlanId=vlanId, smtpGroup=smtpGroup, configuredRange=configuredRange, management=management, ptpCompliance=ptpCompliance, cambium=cambium, versions=versions, radarDetectChannel=radarDetectChannel, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapCommunity=sNMPTrapCommunity, ptpGroups=ptpGroups, noiseFloor=noiseFloor, transmitModulationMode=transmitModulationMode, measuredRange=measuredRange, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, configurationGroup=configurationGroup, transmitPower=transmitPower, nTPLastSync=nTPLastSync, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp250=ptp250, ptpTrapPrefix=ptpTrapPrefix, installArmState=installArmState, aggregateDataRate=aggregateDataRate, sNMPCommunityTableNumber=sNMPCommunityTableNumber, currentChannel=currentChannel, sNMPEnabledTraps=sNMPEnabledTraps, band=band, pubStats=pubStats, ntp=ntp, sNMPCommunityString=sNMPCommunityString, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTable=sNMPTrapTable, phyStatus=phyStatus, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, remoteMACAddress=remoteMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp=ptp, nTPSync=nTPSync, alarmsGroup=alarmsGroup, bootVersion=bootVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, channelSelection=channelSelection)
