...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", radarDetectTrap=radarDetectTrap, aggregateDataRate=aggregateDataRate, ptmp=ptmp, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRate=receiveDataRate, nTPServerIp=nTPServerIp, installArmState=installArmState, channelSelection=channelSelection, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptp250=ptp250, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControlGroup=snmpControlGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, subnetMask=subnetMask, transmitDataRate=transmitDataRate, vectorError=vectorError, receivePower=receivePower, band=band, ptpCompliance=ptpCompliance, linkLoss=linkLoss, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, installArmStateTrap=installArmStateTrap, ntp=ntp, cambium=cambium, sNMPCommunityTable=sNMPCommunityTable, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, dataPortStatus=dataPortStatus, versions=versions, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, alarms=alarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectChannel=radarDetectChannel, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerPortNumber=nTPServerPortNumber, nTPPollInterval=nTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentFreqMHz=currentFreqMHz, licence=licence, snmpControl=snmpControl, management=management, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, configuredRange=configuredRange, phyStatusGroup=phyStatusGroup, productVariant=productVariant, currentChannel=currentChannel, searchState=searchState, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, softwareVersion=softwareVersion, PYSNMP_MODULE_ID=cambium, iPAddress=iPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, siteName=siteName, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, smtpGroup=smtpGroup, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, ntpGroup=ntpGroup, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, measuredRange=measuredRange, notificationsGroup=notificationsGroup, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, nTPState=nTPState, antennaGain=antennaGain, vlanId=vlanId, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, signalStrengthRatio=signalStrengthRatio, timeZone=timeZone, versionsGroup=versionsGroup, linkName=linkName, channelBandwidth=channelBandwidth, extendedChannel=extendedChannel, vlanTagging=vlanTagging, configuredModulationMode=configuredModulationMode, fixedModMode=fixedModMode, vlanPriority=vlanPriority, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, nTPSync=nTPSync, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress)
