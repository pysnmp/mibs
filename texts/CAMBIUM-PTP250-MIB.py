...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", management=management, extendedChannel=extendedChannel, cambium=cambium, productVariant=productVariant, vlanPriority=vlanPriority, extendedFreqMHz=extendedFreqMHz, dataPortStatusTrap=dataPortStatusTrap, versionsGroup=versionsGroup, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, licence=licence, nTPPollInterval=nTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, ntpGroup=ntpGroup, configuredRange=configuredRange, phyStatusGroup=phyStatusGroup, nTPState=nTPState, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuration=configuration, fixedModMode=fixedModMode, linkLoss=linkLoss, cableLoss=cableLoss, transmitPower=transmitPower, ntp=ntp, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, linkStatusTrap=linkStatusTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, configuredModulationMode=configuredModulationMode, pubStats=pubStats, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, channelSelection=channelSelection, dataPortStatus=dataPortStatus, sNMPTrapCommunity=sNMPTrapCommunity, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, radarDetectTrap=radarDetectTrap, siteName=siteName, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, ptp=ptp, nTPServerIp=nTPServerIp, ptpGroups=ptpGroups, band=band, sNMPCommunityTable=sNMPCommunityTable, iPAddress=iPAddress, linkName=linkName, searchState=searchState, smtp=smtp, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, versions=versions, dualPayload=dualPayload, ptpCompliance=ptpCompliance, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vlanId=vlanId, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, measuredRange=measuredRange, ptmp=ptmp, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, vlanTagging=vlanTagging, masterSlaveMode=masterSlaveMode, sNMPCommunityOid=sNMPCommunityOid, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, ptpTraps=ptpTraps, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPSync=nTPSync, currentChannel=currentChannel, radarDetectChannel=radarDetectChannel, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, sNMPTrapVersion=sNMPTrapVersion, currentFreqMHz=currentFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, productName=productName, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPServerPortNumber=nTPServerPortNumber, PYSNMP_MODULE_ID=cambium, bootVersion=bootVersion, nTPLastSync=nTPLastSync, remoteMACAddress=remoteMACAddress, alarms=alarms)
