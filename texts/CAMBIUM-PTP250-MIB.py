...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", smtp=smtp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkLoss=linkLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, gatewayIPAddress=gatewayIPAddress, vectorError=vectorError, bootVersion=bootVersion, measuredRange=measuredRange, ptpGroups=ptpGroups, dualPayload=dualPayload, phyStatus=phyStatus, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, vlanId=vlanId, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, fixedModMode=fixedModMode, alarms=alarms, sNMPCommunityTableIndex=sNMPCommunityTableIndex, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, nTPServerPortNumber=nTPServerPortNumber, productName=productName, versions=versions, radarDetectTrap=radarDetectTrap, iPAddress=iPAddress, radarDetectChannel=radarDetectChannel, hardwareVersion=hardwareVersion, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, ntpGroup=ntpGroup, ptpTraps=ptpTraps, vlanTagging=vlanTagging, licence=licence, sNMPCommunityTable=sNMPCommunityTable, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, receiveDataRate=receiveDataRate, currentFreqMHz=currentFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, configuredRange=configuredRange, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityOid=sNMPCommunityOid, ptp250=ptp250, remoteMACAddress=remoteMACAddress, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityAccess=sNMPCommunityAccess, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ntp=ntp, band=band, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, ethernet=ethernet, antennaGain=antennaGain, vlanPriority=vlanPriority, nTPState=nTPState, snmpControlGroup=snmpControlGroup, noiseFloor=noiseFloor, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, currentChannel=currentChannel, subnetMask=subnetMask, channelBandwidth=channelBandwidth, pubStatsGroup=pubStatsGroup, receivePower=receivePower, extendedChannel=extendedChannel, snmpControl=snmpControl, productVariant=productVariant, nTPLastSync=nTPLastSync, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, extendedFreqMHz=extendedFreqMHz, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, configuredModulationMode=configuredModulationMode, cambium=cambium, searchState=searchState, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerIp=nTPServerIp, installArmStateTrap=installArmStateTrap, dataPortStatus=dataPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelSelection=channelSelection, licenceGroup=licenceGroup, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, nTPPollInterval=nTPPollInterval, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, phyStatusGroup=phyStatusGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone)
