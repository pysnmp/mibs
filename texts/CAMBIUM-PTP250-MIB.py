...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", managementGroup=managementGroup, licenceGroup=licenceGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityOid=sNMPCommunityOid, ptmp=ptmp, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, siteName=siteName, antennaGain=antennaGain, cambium=cambium, searchState=searchState, noiseFloor=noiseFloor, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, extendedFreqMHz=extendedFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, nTPLastSync=nTPLastSync, sNMPCommunityString=sNMPCommunityString, ptp=ptp, channelSelection=channelSelection, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPState=nTPState, nTPSync=nTPSync, versions=versions, timeZone=timeZone, nTPServerPortNumber=nTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, vlanTagging=vlanTagging, dataPortStatus=dataPortStatus, pubStats=pubStats, transmitDataRate=transmitDataRate, currentFreqMHz=currentFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, configuredModulationMode=configuredModulationMode, configuration=configuration, signalStrengthRatio=signalStrengthRatio, nTPPollInterval=nTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityAccess=sNMPCommunityAccess, linkStatusTrap=linkStatusTrap, licence=licence, vlanId=vlanId, ntpGroup=ntpGroup, dataPortStatusTrap=dataPortStatusTrap, remoteMACAddress=remoteMACAddress, band=band, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, ntp=ntp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receiveModulationMode=receiveModulationMode, dualPayload=dualPayload, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, measuredRange=measuredRange, productName=productName, currentChannel=currentChannel, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, aggregateDataRate=aggregateDataRate, ptp250=ptp250, snmpControl=snmpControl, nTPServerIp=nTPServerIp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpGroups=ptpGroups, vlanPriority=vlanPriority, cableLoss=cableLoss, receivePower=receivePower, bootVersion=bootVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, hardwareVersion=hardwareVersion, alarms=alarms, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, smtp=smtp, ptpTraps=ptpTraps, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, vectorError=vectorError, radarDetectTrap=radarDetectTrap, linkName=linkName, versionsGroup=versionsGroup, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, systemClock=systemClock, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, fixedModMode=fixedModMode, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, subnetMask=subnetMask, alarmsGroup=alarmsGroup)
