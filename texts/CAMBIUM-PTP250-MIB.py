...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatus=phyStatus, remoteMACAddress=remoteMACAddress, channelSelection=channelSelection, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, radarDetectChannel=radarDetectChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedChannel=extendedChannel, vlanId=vlanId, linkLoss=linkLoss, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, radarDetectTrap=radarDetectTrap, cambium=cambium, iPAddress=iPAddress, searchState=searchState, ntp=ntp, ptmp=ptmp, linkName=linkName, cableLoss=cableLoss, productName=productName, configuration=configuration, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, management=management, versions=versions, ptpTraps=ptpTraps, nTPPollInterval=nTPPollInterval, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, pubStats=pubStats, ethernetGroup=ethernetGroup, vectorError=vectorError, managementGroup=managementGroup, nTPSync=nTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, configuredRange=configuredRange, notificationsGroup=notificationsGroup, ntpGroup=ntpGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, currentFreqMHz=currentFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, antennaGain=antennaGain, smtpGroup=smtpGroup, ptp=ptp, sNMPCommunityAccess=sNMPCommunityAccess, installArmState=installArmState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPServerIp=nTPServerIp, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailable=noWirelessChannelAvailable, fixedModMode=fixedModMode, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, sNMPTrapCommunity=sNMPTrapCommunity, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, channelBandwidth=channelBandwidth, transmitPower=transmitPower, band=band, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, licence=licence, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPLastSync=nTPLastSync, alarmsGroup=alarmsGroup, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, linkStatusTrap=linkStatusTrap, alarms=alarms, snmpControl=snmpControl, signalStrengthRatio=signalStrengthRatio, ptpGroups=ptpGroups, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp250=ptp250, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityOid=sNMPCommunityOid, ptpTrapPrefix=ptpTrapPrefix, currentChannel=currentChannel, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, nTPState=nTPState, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanPriority=vlanPriority, softwareVersion=softwareVersion, receivePower=receivePower, nTPServerPortNumber=nTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, measuredRange=measuredRange, noiseFloor=noiseFloor, ethernet=ethernet)
