...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanId=vlanId, nTPServerIp=nTPServerIp, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableEntry=sNMPCommunityTableEntry, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitDataRate=transmitDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, radarDetectChannel=radarDetectChannel, siteName=siteName, radarDetectTrap=radarDetectTrap, ntpGroup=ntpGroup, searchState=searchState, smtp=smtp, vlanTagging=vlanTagging, installArmState=installArmState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, antennaGain=antennaGain, pubStats=pubStats, ethernetGroup=ethernetGroup, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitPower=transmitPower, versions=versions, linkName=linkName, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, softwareVersion=softwareVersion, systemClock=systemClock, ptp=ptp, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, ptp250=ptp250, remoteMACAddress=remoteMACAddress, productName=productName, subnetMask=subnetMask, dualPayload=dualPayload, aggregateDataRate=aggregateDataRate, currentChannel=currentChannel, regionCode=regionCode, nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, band=band, PYSNMP_MODULE_ID=cambium, vlanPriority=vlanPriority, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptmp=ptmp, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, licence=licence, receivePower=receivePower, alarms=alarms, vectorError=vectorError, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkStatusTrap=linkStatusTrap, fixedModMode=fixedModMode, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, extendedChannel=extendedChannel, measuredRange=measuredRange, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, maximumTransmitPower=maximumTransmitPower, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelSelection=channelSelection, timeZone=timeZone, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, noiseFloor=noiseFloor, bootVersion=bootVersion, extendedFreqMHz=extendedFreqMHz, snmpControl=snmpControl, signalStrengthRatio=signalStrengthRatio, management=management, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, currentFreqMHz=currentFreqMHz, configuredRange=configuredRange, cambium=cambium, nTPServerPortNumber=nTPServerPortNumber, productVariant=productVariant, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityString=sNMPCommunityString, configuration=configuration, tFTPServerPortNumber=tFTPServerPortNumber, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPLastSync=nTPLastSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, gatewayIPAddress=gatewayIPAddress, nTPState=nTPState, dataPortStatusTrap=dataPortStatusTrap, ntp=ntp, iPAddress=iPAddress, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, sNMPTrapCommunity=sNMPTrapCommunity, remoteIPAddress=remoteIPAddress)
