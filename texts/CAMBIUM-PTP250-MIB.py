...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", antennaGain=antennaGain, currentFreqMHz=currentFreqMHz, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanPriority=vlanPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, noiseFloor=noiseFloor, nTPState=nTPState, pubStatsGroup=pubStatsGroup, vectorError=vectorError, versions=versions, versionsGroup=versionsGroup, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTable=sNMPCommunityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, management=management, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, receivePower=receivePower, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, radarDetectChannel=radarDetectChannel, masterSlaveMode=masterSlaveMode, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, installArmState=installArmState, searchState=searchState, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, configuredModulationMode=configuredModulationMode, softwareVersion=softwareVersion, nTPServerIp=nTPServerIp, linkStatusTrap=linkStatusTrap, ntpGroup=ntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, dualPayload=dualPayload, extendedChannel=extendedChannel, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, nTPServerPortNumber=nTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, configuredRange=configuredRange, band=band, iPAddress=iPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, subnetMask=subnetMask, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, transmitPower=transmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPLastSync=nTPLastSync, bootVersion=bootVersion, configuration=configuration, smtp=smtp, ptpGroups=ptpGroups, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, siteName=siteName, cambium=cambium, timeZone=timeZone, snmpControl=snmpControl, nTPSync=nTPSync, channelSelection=channelSelection, dataPortStatus=dataPortStatus, managementGroup=managementGroup, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, ethernet=ethernet, ntp=ntp, regionCode=regionCode, ptp250=ptp250, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityOid=sNMPCommunityOid, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, hardwareVersion=hardwareVersion, vlanId=vlanId, dataPortAutoNegotiation=dataPortAutoNegotiation, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTable=sNMPTrapTable, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, measuredRange=measuredRange, ptp=ptp, alarmsGroup=alarmsGroup, licence=licence, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, currentChannel=currentChannel)
