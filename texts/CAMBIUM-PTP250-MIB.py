...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, licenceGroup=licenceGroup, extendedChannel=extendedChannel, vlanId=vlanId, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup, dualPayload=dualPayload, configuration=configuration, signalStrengthRatio=signalStrengthRatio, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, band=band, ntp=ntp, nTPPollInterval=nTPPollInterval, vlanTagging=vlanTagging, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, ptmp=ptmp, radarDetectTrap=radarDetectTrap, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, systemClock=systemClock, vlanPriority=vlanPriority, ptp250=ptp250, alarms=alarms, productName=productName, alarmsGroup=alarmsGroup, vectorError=vectorError, nTPLastSync=nTPLastSync, maximumTransmitPower=maximumTransmitPower, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, subnetMask=subnetMask, bootVersion=bootVersion, phyStatusGroup=phyStatusGroup, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, remoteIPAddress=remoteIPAddress, smtp=smtp, nTPState=nTPState, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, configuredModulationMode=configuredModulationMode, installArmState=installArmState, smtpGroup=smtpGroup, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, nTPServerIp=nTPServerIp, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, softwareVersion=softwareVersion, licence=licence, currentChannel=currentChannel, channelSelection=channelSelection, dataPortStatusTrap=dataPortStatusTrap, ntpGroup=ntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, dataPortStatus=dataPortStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, timeZone=timeZone, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, iPAddress=iPAddress, noiseFloor=noiseFloor, radarDetectChannel=radarDetectChannel, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, remoteMACAddress=remoteMACAddress, ethernet=ethernet, measuredRange=measuredRange, receivePower=receivePower, nTPSync=nTPSync, gatewayIPAddress=gatewayIPAddress, linkStatusTrap=linkStatusTrap, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, cambium=cambium, configuredRange=configuredRange, pubStats=pubStats, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, searchState=searchState, sNMPCommunityAccess=sNMPCommunityAccess, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber)
