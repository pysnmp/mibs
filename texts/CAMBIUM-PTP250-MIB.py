...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableIndex=sNMPCommunityTableIndex, productVariant=productVariant, ntpGroup=ntpGroup, configuredModulationMode=configuredModulationMode, signalStrengthRatio=signalStrengthRatio, sNMPCommunityOid=sNMPCommunityOid, hardwareVersion=hardwareVersion, management=management, linkLoss=linkLoss, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, receiveDataRate=receiveDataRate, ptmp=ptmp, extendedFreqMHz=extendedFreqMHz, siteName=siteName, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, licenceGroup=licenceGroup, ptpCompliance=ptpCompliance, remoteMACAddress=remoteMACAddress, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, ptp=ptp, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkStatusTrap=linkStatusTrap, smtpGroup=smtpGroup, softwareVersion=softwareVersion, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, nTPLastSync=nTPLastSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, nTPState=nTPState, snmpControl=snmpControl, pubStats=pubStats, vectorError=vectorError, productName=productName, extendedChannel=extendedChannel, measuredRange=measuredRange, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTable=sNMPCommunityTable, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerIp=nTPServerIp, transmitPower=transmitPower, licence=licence, subnetMask=subnetMask, vlanPriority=vlanPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, vlanId=vlanId, versionsGroup=versionsGroup, radarDetectTrap=radarDetectTrap, ptpGroups=ptpGroups, phyStatus=phyStatus, nTPPollInterval=nTPPollInterval, currentChannel=currentChannel, radarDetectChannel=radarDetectChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, ntp=ntp, nTPSync=nTPSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, band=band, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, sNMPEnabledTraps=sNMPEnabledTraps, iPAddress=iPAddress, cambium=cambium, fixedModMode=fixedModMode, channelSelection=channelSelection, PYSNMP_MODULE_ID=cambium, channelBandwidth=channelBandwidth, linkName=linkName, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, managementGroup=managementGroup, installArmState=installArmState, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, ptpTrapPrefix=ptpTrapPrefix, configuredRange=configuredRange, sNMPTrapCommunity=sNMPTrapCommunity, ethernetGroup=ethernetGroup, dualPayload=dualPayload, nTPServerPortNumber=nTPServerPortNumber, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, dataPortStatusTrap=dataPortStatusTrap, vlanTagging=vlanTagging)
