...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", signalStrengthRatio=signalStrengthRatio, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTable=sNMPCommunityTable, vlanTagging=vlanTagging, dualPayload=dualPayload, currentFreqMHz=currentFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, subnetMask=subnetMask, versionsGroup=versionsGroup, sMTPEnabledMessages=sMTPEnabledMessages, nTPSync=nTPSync, noiseFloor=noiseFloor, ptmp=ptmp, managementGroup=managementGroup, radarDetectTrap=radarDetectTrap, licenceGroup=licenceGroup, remoteMACAddress=remoteMACAddress, radarDetectChannel=radarDetectChannel, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, management=management, sNMPTrapCommunity=sNMPTrapCommunity, alarms=alarms, ptp=ptp, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, cableLoss=cableLoss, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection, notificationsGroup=notificationsGroup, configuration=configuration, ntp=ntp, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, nTPServerIp=nTPServerIp, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, extendedFreqMHz=extendedFreqMHz, regionCode=regionCode, linkLoss=linkLoss, band=band, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, nTPLastSync=nTPLastSync, sNMPTrapTable=sNMPTrapTable, linkName=linkName, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, ptpCompliance=ptpCompliance, licence=licence, installArmStateTrap=installArmStateTrap, currentChannel=currentChannel, versions=versions, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, fixedModMode=fixedModMode, smtpGroup=smtpGroup, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuredModulationMode=configuredModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, sNMPCommunityTableNumber=sNMPCommunityTableNumber, receivePower=receivePower, installArmState=installArmState, vlanId=vlanId, smtp=smtp, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, measuredRange=measuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, bootVersion=bootVersion, nTPState=nTPState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp250=ptp250, vlanPriority=vlanPriority, cambium=cambium, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, configuredRange=configuredRange, hardwareVersion=hardwareVersion, iPAddress=iPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, receiveModulationMode=receiveModulationMode, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, sNMPCommunityOid=sNMPCommunityOid)
