...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, receivePower=receivePower, snmpControl=snmpControl, productVariant=productVariant, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth, nTPPollInterval=nTPPollInterval, alarms=alarms, sNMPCommunityTableEntry=sNMPCommunityTableEntry, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, configuration=configuration, nTPState=nTPState, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, ethernetGroup=ethernetGroup, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCode=regionCode, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, linkName=linkName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, versions=versions, hardwareVersion=hardwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, management=management, timeZone=timeZone, ptpGroups=ptpGroups, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, iPAddress=iPAddress, currentChannel=currentChannel, cambium=cambium, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, vlanPriority=vlanPriority, dualPayload=dualPayload, productName=productName, signalStrengthRatio=signalStrengthRatio, radarDetectChannel=radarDetectChannel, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, receiveDataRate=receiveDataRate, currentFreqMHz=currentFreqMHz, masterSlaveMode=masterSlaveMode, systemClock=systemClock, extendedChannel=extendedChannel, sNMPCommunityOid=sNMPCommunityOid, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, fixedModMode=fixedModMode, licenceGroup=licenceGroup, licence=licence, nTPServerIp=nTPServerIp, sNMPCommunityTable=sNMPCommunityTable, radarDetectTrap=radarDetectTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityAccess=sNMPCommunityAccess, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPSync=nTPSync, vectorError=vectorError, noiseFloor=noiseFloor, siteName=siteName, gatewayIPAddress=gatewayIPAddress, ntpGroup=ntpGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, nTPLastSync=nTPLastSync, band=band, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, measuredRange=measuredRange, notificationsGroup=notificationsGroup, smtp=smtp, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, ntp=ntp, transmitModulationMode=transmitModulationMode, ethernet=ethernet, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, phyStatus=phyStatus, linkStatusTrap=linkStatusTrap, remoteMACAddress=remoteMACAddress, ptp250=ptp250, configuredRange=configuredRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, vlanId=vlanId, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, smtpGroup=smtpGroup, bootVersion=bootVersion, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, sNMPTrapTableIndex=sNMPTrapTableIndex, channelSelection=channelSelection)
