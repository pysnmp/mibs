...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerIPAddress=sMTPServerIPAddress, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTable=sNMPCommunityTable, linkName=linkName, measuredRange=measuredRange, receiveModulationMode=receiveModulationMode, ethernet=ethernet, dualPayload=dualPayload, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatusTrap=dataPortStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, notificationsGroup=notificationsGroup, iPAddress=iPAddress, regionCode=regionCode, channelBandwidth=channelBandwidth, alarmsGroup=alarmsGroup, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, fixedModMode=fixedModMode, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, nTPSync=nTPSync, cambium=cambium, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, management=management, smtp=smtp, configuredModulationMode=configuredModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productVariant=productVariant, versions=versions, remoteMACAddress=remoteMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, extendedFreqMHz=extendedFreqMHz, systemClock=systemClock, currentFreqMHz=currentFreqMHz, radarDetectTrap=radarDetectTrap, ntp=ntp, productName=productName, configuration=configuration, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, gatewayIPAddress=gatewayIPAddress, transmitPower=transmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp250=ptp250, licence=licence, sNMPCommunityAccess=sNMPCommunityAccess, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, vlanId=vlanId, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, sNMPTrapVersion=sNMPTrapVersion, nTPState=nTPState, phyStatus=phyStatus, searchState=searchState, transmitDataRate=transmitDataRate, sNMPCommunityOid=sNMPCommunityOid, dataPortStatus=dataPortStatus, nTPServerIp=nTPServerIp, linkLoss=linkLoss, sMTPEnabledMessages=sMTPEnabledMessages, siteName=siteName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, noiseFloor=noiseFloor, signalStrengthRatio=signalStrengthRatio, nTPServerPortNumber=nTPServerPortNumber, vectorError=vectorError, sNMPTrapCommunity=sNMPTrapCommunity, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, pubStats=pubStats, extendedChannel=extendedChannel, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, ptp=ptp, softwareVersion=softwareVersion, vlanPriority=vlanPriority, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, vlanTagging=vlanTagging, bootVersion=bootVersion, currentChannel=currentChannel, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, installArmState=installArmState, managementGroup=managementGroup)
