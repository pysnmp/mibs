...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, receivePower=receivePower, noiseFloor=noiseFloor, ntpGroup=ntpGroup, vlanPriority=vlanPriority, nTPState=nTPState, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, licence=licence, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, installArmStateTrap=installArmStateTrap, searchState=searchState, nTPServerPortNumber=nTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, ntp=ntp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dualPayload=dualPayload, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkLoss=linkLoss, configuredRange=configuredRange, vlanTagging=vlanTagging, sMTPEnabledMessages=sMTPEnabledMessages, ptpTraps=ptpTraps, currentFreqMHz=currentFreqMHz, pubStats=pubStats, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectChannel=radarDetectChannel, hardwareVersion=hardwareVersion, smtp=smtp, configurationGroup=configurationGroup, ptpGroups=ptpGroups, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, ethernet=ethernet, nTPServerIp=nTPServerIp, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, configuredModulationMode=configuredModulationMode, remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, snmpControlGroup=snmpControlGroup, nTPSync=nTPSync, productName=productName, channelSelection=channelSelection, productVariant=productVariant, configuration=configuration, phyStatus=phyStatus, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, gatewayIPAddress=gatewayIPAddress, management=management, transmitPower=transmitPower, versionsGroup=versionsGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, installArmState=installArmState, nTPPollInterval=nTPPollInterval, ptmp=ptmp, versions=versions, wirelessLinkStatus=wirelessLinkStatus, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, nTPLastSync=nTPLastSync, currentChannel=currentChannel, systemClock=systemClock, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, sNMPCommunityOid=sNMPCommunityOid, bootVersion=bootVersion, sNMPTrapCommunity=sNMPTrapCommunity, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, linkStatusTrap=linkStatusTrap, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, measuredRange=measuredRange, sNMPCommunityString=sNMPCommunityString, siteName=siteName, extendedFreqMHz=extendedFreqMHz, extendedChannel=extendedChannel, sNMPCommunityTable=sNMPCommunityTable, smtpGroup=smtpGroup, vlanId=vlanId, sMTPServerIPAddress=sMTPServerIPAddress, transmitModulationMode=transmitModulationMode, softwareVersion=softwareVersion, antennaGain=antennaGain, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptp250=ptp250, regionCode=regionCode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptp=ptp, radarDetectTrap=radarDetectTrap, snmpControl=snmpControl, band=band, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, PYSNMP_MODULE_ID=cambium)
