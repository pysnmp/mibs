...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", cambium=cambium, channelBandwidth=channelBandwidth, tFTPServerIPAddress=tFTPServerIPAddress, linkLoss=linkLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, channelSelection=channelSelection, regionCode=regionCode, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControl=snmpControl, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, ntp=ntp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, band=band, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, nTPLastSync=nTPLastSync, nTPSync=nTPSync, dataPortStatus=dataPortStatus, versionsGroup=versionsGroup, softwareVersion=softwareVersion, productName=productName, sNMPTrapVersion=sNMPTrapVersion, measuredRange=measuredRange, extendedChannel=extendedChannel, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, noiseFloor=noiseFloor, phyStatusGroup=phyStatusGroup, vlanTagging=vlanTagging, maximumTransmitPower=maximumTransmitPower, siteName=siteName, linkStatusTrap=linkStatusTrap, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, nTPPollInterval=nTPPollInterval, ptpCompliance=ptpCompliance, productVariant=productVariant, vectorError=vectorError, receiveModulationMode=receiveModulationMode, nTPServerPortNumber=nTPServerPortNumber, radarDetectChannel=radarDetectChannel, notificationsGroup=notificationsGroup, currentFreqMHz=currentFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptmp=ptmp, bootVersion=bootVersion, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, currentChannel=currentChannel, configuredModulationMode=configuredModulationMode, versions=versions, alarms=alarms, sNMPTrapCommunity=sNMPTrapCommunity, searchState=searchState, masterSlaveMode=masterSlaveMode, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, extendedFreqMHz=extendedFreqMHz, subnetMask=subnetMask, alarmsGroup=alarmsGroup, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, vlanPriority=vlanPriority, nTPServerIp=nTPServerIp, configuration=configuration, ntpGroup=ntpGroup, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, nTPState=nTPState, transmitModulationMode=transmitModulationMode, licence=licence, ptp250=ptp250, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, iPAddress=iPAddress, management=management, sNMPTrapTable=sNMPTrapTable, receivePower=receivePower, ptpTraps=ptpTraps, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, fixedModMode=fixedModMode, signalStrengthRatio=signalStrengthRatio, vlanId=vlanId, dualPayload=dualPayload, sNMPCommunityOid=sNMPCommunityOid, configuredRange=configuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, linkName=linkName, antennaGain=antennaGain, systemClock=systemClock)
