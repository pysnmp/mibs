...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptmp=ptmp, productName=productName, linkLoss=linkLoss, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, subnetMask=subnetMask, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, bootVersion=bootVersion, radarDetectChannel=radarDetectChannel, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, cableLoss=cableLoss, sNMPTrapCommunity=sNMPTrapCommunity, snmpControl=snmpControl, receiveModulationMode=receiveModulationMode, noiseFloor=noiseFloor, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, measuredRange=measuredRange, configuration=configuration, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, band=band, hardwareVersion=hardwareVersion, linkName=linkName, productVariant=productVariant, linkStatusTrap=linkStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp=ptp, vlanTagging=vlanTagging, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp250=ptp250, nTPLastSync=nTPLastSync, management=management, pubStatsGroup=pubStatsGroup, regionCode=regionCode, ptpGroups=ptpGroups, snmpControlGroup=snmpControlGroup, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarms=alarms, licenceGroup=licenceGroup, dualPayload=dualPayload, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, ntpGroup=ntpGroup, receiveDataRate=receiveDataRate, extendedFreqMHz=extendedFreqMHz, ntp=ntp, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, fixedModMode=fixedModMode, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, sNMPEnabledTraps=sNMPEnabledTraps, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, remoteIPAddress=remoteIPAddress, smtpGroup=smtpGroup, iPAddress=iPAddress, currentFreqMHz=currentFreqMHz, nTPServerIp=nTPServerIp, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, nTPState=nTPState, ptpTraps=ptpTraps, nTPServerPortNumber=nTPServerPortNumber, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableNumber=sNMPCommunityTableNumber, channelBandwidth=channelBandwidth, sNMPCommunityTable=sNMPCommunityTable, transmitPower=transmitPower, configuredModulationMode=configuredModulationMode, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus, radarDetectTrap=radarDetectTrap, vlanPriority=vlanPriority, configuredRange=configuredRange, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, versions=versions, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, vlanId=vlanId, ptpCompliance=ptpCompliance, timeZone=timeZone, sNMPCommunityTableEntry=sNMPCommunityTableEntry, licence=licence, channelSelection=channelSelection, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, nTPSync=nTPSync, antennaGain=antennaGain, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, currentChannel=currentChannel, ethernet=ethernet, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegotiation=dataPortAutoNegotiation)
