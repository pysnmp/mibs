...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, ethernet=ethernet, cableLoss=cableLoss, PYSNMP_MODULE_ID=cambium, sNMPCommunityAccess=sNMPCommunityAccess, sMTPServerIPAddress=sMTPServerIPAddress, productName=productName, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationGroup=configurationGroup, nTPPollInterval=nTPPollInterval, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, measuredRange=measuredRange, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, band=band, wirelessLinkStatus=wirelessLinkStatus, ntp=ntp, sNMPTrapTable=sNMPTrapTable, ptp=ptp, fixedModMode=fixedModMode, linkLoss=linkLoss, vlanPriority=vlanPriority, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, regionCode=regionCode, subnetMask=subnetMask, phyStatus=phyStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configuredModulationMode=configuredModulationMode, licence=licence, transmitDataRate=transmitDataRate, timeZone=timeZone, sNMPCommunityString=sNMPCommunityString, versions=versions, extendedFreqMHz=extendedFreqMHz, phyStatusGroup=phyStatusGroup, dualPayload=dualPayload, ptmp=ptmp, remoteMACAddress=remoteMACAddress, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, management=management, productVariant=productVariant, sNMPCommunityTableEntry=sNMPCommunityTableEntry, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, vlanId=vlanId, systemClock=systemClock, ptpGroups=ptpGroups, pubStats=pubStats, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, managementGroup=managementGroup, configuredRange=configuredRange, pubStatsGroup=pubStatsGroup, nTPServerPortNumber=nTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, radarDetectTrap=radarDetectTrap, alarms=alarms, nTPState=nTPState, channelSelection=channelSelection, linkStatusTrap=linkStatusTrap, configuration=configuration, currentFreqMHz=currentFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, receivePower=receivePower, ptpTraps=ptpTraps, radarDetectChannel=radarDetectChannel, sNMPCommunityOid=sNMPCommunityOid, remoteIPAddress=remoteIPAddress, nTPLastSync=nTPLastSync, nTPSync=nTPSync, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerIp=nTPServerIp, alarmsGroup=alarmsGroup, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, cambium=cambium, ptpCompliance=ptpCompliance, ntpGroup=ntpGroup, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, currentChannel=currentChannel, searchState=searchState, vlanTagging=vlanTagging, snmpControl=snmpControl, dataPortStatus=dataPortStatus, smtp=smtp, installArmState=installArmState, notificationsGroup=notificationsGroup, vectorError=vectorError, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, iPAddress=iPAddress, linkName=linkName, noiseFloor=noiseFloor, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode)
