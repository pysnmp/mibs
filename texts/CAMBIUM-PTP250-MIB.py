...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedFreqMHz=extendedFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, dualPayload=dualPayload, dataPortStatus=dataPortStatus, notificationsGroup=notificationsGroup, measuredRange=measuredRange, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanTagging=vlanTagging, productName=productName, ptpTraps=ptpTraps, sNMPCommunityTableIndex=sNMPCommunityTableIndex, alarmsGroup=alarmsGroup, installArmState=installArmState, transmitModulationMode=transmitModulationMode, ntp=ntp, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectChannel=radarDetectChannel, nTPServerPortNumber=nTPServerPortNumber, configuration=configuration, extendedChannel=extendedChannel, licence=licence, sNMPCommunityAccess=sNMPCommunityAccess, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, remoteMACAddress=remoteMACAddress, versions=versions, linkStatusTrap=linkStatusTrap, noiseFloor=noiseFloor, radarDetectTrap=radarDetectTrap, softwareVersion=softwareVersion, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanId=vlanId, licenceGroup=licenceGroup, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, channelSelection=channelSelection, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, ptp250=ptp250, vectorError=vectorError, nTPState=nTPState, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, sNMPCommunityTableNumber=sNMPCommunityTableNumber, currentChannel=currentChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, nTPServerIp=nTPServerIp, smtpGroup=smtpGroup, searchState=searchState, nTPPollInterval=nTPPollInterval, transmitPower=transmitPower, configuredModulationMode=configuredModulationMode, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, timeZone=timeZone, receiveDataRate=receiveDataRate, ptp=ptp, smtp=smtp, cambium=cambium, regionCode=regionCode, gatewayIPAddress=gatewayIPAddress, nTPSync=nTPSync, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, systemClock=systemClock, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, band=band, ethernetGroup=ethernetGroup, ethernet=ethernet, linkLoss=linkLoss, channelBandwidth=channelBandwidth, sNMPCommunityTable=sNMPCommunityTable, ptmp=ptmp, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, installArmStateTrap=installArmStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, siteName=siteName, configuredRange=configuredRange, dataPortStatusTrap=dataPortStatusTrap, ntpGroup=ntpGroup, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, ptpGroups=ptpGroups, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, iPAddress=iPAddress, snmpControl=snmpControl, cableLoss=cableLoss, linkName=linkName, vlanPriority=vlanPriority, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, fixedModMode=fixedModMode, sNMPCommunityOid=sNMPCommunityOid, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup)
