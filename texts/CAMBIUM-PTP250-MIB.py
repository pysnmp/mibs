...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", band=band, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, sNMPCommunityTableIndex=sNMPCommunityTableIndex, remoteIPAddress=remoteIPAddress, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, timeZone=timeZone, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, vlanTagging=vlanTagging, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, remoteMACAddress=remoteMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, currentChannel=currentChannel, linkName=linkName, vlanPriority=vlanPriority, managementGroup=managementGroup, ptmp=ptmp, productVariant=productVariant, vectorError=vectorError, ptp=ptp, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, dualPayload=dualPayload, transmitPower=transmitPower, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, receivePower=receivePower, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPLastSync=nTPLastSync, dataPortStatusTrap=dataPortStatusTrap, searchState=searchState, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, nTPState=nTPState, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, ntpGroup=ntpGroup, nTPPollInterval=nTPPollInterval, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, linkStatusTrap=linkStatusTrap, currentFreqMHz=currentFreqMHz, dataPortStatus=dataPortStatus, linkLoss=linkLoss, bootVersion=bootVersion, subnetMask=subnetMask, noiseFloor=noiseFloor, regionCode=regionCode, alarms=alarms, sMTPServerIPAddress=sMTPServerIPAddress, ntp=ntp, smtp=smtp, hardwareVersion=hardwareVersion, nTPSync=nTPSync, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, signalStrengthRatio=signalStrengthRatio, extendedFreqMHz=extendedFreqMHz, radarDetectChannel=radarDetectChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, sNMPCommunityTable=sNMPCommunityTable, maximumTransmitPower=maximumTransmitPower, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, versionsGroup=versionsGroup, configuredModulationMode=configuredModulationMode, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, fixedModMode=fixedModMode, management=management, radarDetectTrap=radarDetectTrap, extendedChannel=extendedChannel, licence=licence, ptpCompliance=ptpCompliance, sNMPCommunityOid=sNMPCommunityOid, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuredRange=configuredRange, productName=productName, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, systemClock=systemClock, nTPServerIp=nTPServerIp, channelSelection=channelSelection, cambium=cambium, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, iPAddress=iPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, phyStatus=phyStatus, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableIndex=sNMPTrapTableIndex, gatewayIPAddress=gatewayIPAddress)
