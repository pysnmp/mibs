...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, timeZone=timeZone, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, fixedModMode=fixedModMode, configuration=configuration, vectorError=vectorError, ptpGroups=ptpGroups, linkStatusTrap=linkStatusTrap, transmitDataRate=transmitDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectChannel=radarDetectChannel, systemClock=systemClock, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, receivePower=receivePower, licence=licence, gatewayIPAddress=gatewayIPAddress, channelBandwidth=channelBandwidth, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, ntp=ntp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, siteName=siteName, nTPState=nTPState, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, antennaGain=antennaGain, searchState=searchState, vlanPriority=vlanPriority, dataPortAutoNegotiation=dataPortAutoNegotiation, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, regionCode=regionCode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp250=ptp250, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedChannel=extendedChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanId=vlanId, nTPServerPortNumber=nTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, versions=versions, transmitPower=transmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentChannel=currentChannel, nTPServerIp=nTPServerIp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, remoteMACAddress=remoteMACAddress, management=management, ntpGroup=ntpGroup, installArmState=installArmState, transmitModulationMode=transmitModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, ethernet=ethernet, masterSlaveMode=masterSlaveMode, configuredRange=configuredRange, sNMPTrapCommunity=sNMPTrapCommunity, versionsGroup=versionsGroup, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPSync=nTPSync, cambium=cambium, bootVersion=bootVersion, smtpGroup=smtpGroup, pubStats=pubStats, productName=productName, installArmStateTrap=installArmStateTrap, aggregateDataRate=aggregateDataRate, sNMPCommunityAccess=sNMPCommunityAccess, nTPLastSync=nTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, extendedFreqMHz=extendedFreqMHz, dualPayload=dualPayload, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, vlanTagging=vlanTagging, iPAddress=iPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityOid=sNMPCommunityOid, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, ptp=ptp, productVariant=productVariant, smtp=smtp, band=band, measuredRange=measuredRange, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
