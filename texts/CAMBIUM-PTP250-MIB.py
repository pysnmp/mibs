...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, snmpControl=snmpControl, noiseFloor=noiseFloor, vlanId=vlanId, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, nTPServerIp=nTPServerIp, vectorError=vectorError, versions=versions, band=band, ptpGroups=ptpGroups, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, configuration=configuration, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, nTPLastSync=nTPLastSync, subnetMask=subnetMask, channelBandwidth=channelBandwidth, ptmp=ptmp, sNMPTrapTable=sNMPTrapTable, measuredRange=measuredRange, management=management, versionsGroup=versionsGroup, fixedModMode=fixedModMode, sNMPTrapVersion=sNMPTrapVersion, bootVersion=bootVersion, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, regionCode=regionCode, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkName=linkName, ptp=ptp, searchState=searchState, hardwareVersion=hardwareVersion, sNMPCommunityTable=sNMPCommunityTable, timeZone=timeZone, installArmStateTrap=installArmStateTrap, currentChannel=currentChannel, ptpTraps=ptpTraps, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, extendedFreqMHz=extendedFreqMHz, nTPPollInterval=nTPPollInterval, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, licence=licence, channelSelection=channelSelection, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetGroup=ethernetGroup, configuredModulationMode=configuredModulationMode, currentFreqMHz=currentFreqMHz, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, phyStatus=phyStatus, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPState=nTPState, nTPSync=nTPSync, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productName=productName, receivePower=receivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, vlanTagging=vlanTagging, aggregateDataRate=aggregateDataRate, dualPayload=dualPayload, alarms=alarms, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, linkStatusTrap=linkStatusTrap, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, transmitPower=transmitPower, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, iPAddress=iPAddress, cableLoss=cableLoss, sNMPCommunityAccess=sNMPCommunityAccess, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedChannel=extendedChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radarDetectTrap=radarDetectTrap, sNMPTrapCommunity=sNMPTrapCommunity, pubStats=pubStats, cambium=cambium, ntp=ntp, maximumTransmitPower=maximumTransmitPower, sNMPCommunityOid=sNMPCommunityOid, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuredRange=configuredRange)
