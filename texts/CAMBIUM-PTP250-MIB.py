...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, channelBandwidth=channelBandwidth, nTPState=nTPState, receiveModulationMode=receiveModulationMode, radarDetectTrap=radarDetectTrap, management=management, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkName=linkName, linkLoss=linkLoss, searchState=searchState, alarms=alarms, nTPServerPortNumber=nTPServerPortNumber, smtpGroup=smtpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTable=sNMPCommunityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, phyStatus=phyStatus, cableLoss=cableLoss, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, configuration=configuration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenceGroup=licenceGroup, cambium=cambium, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, dualPayload=dualPayload, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkStatusTrap=linkStatusTrap, nTPSync=nTPSync, ptpGroups=ptpGroups, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, transmitPower=transmitPower, channelSelection=channelSelection, productName=productName, hardwareVersion=hardwareVersion, radarDetectChannel=radarDetectChannel, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanPriority=vlanPriority, sMTPEnabledMessages=sMTPEnabledMessages, iPAddress=iPAddress, vlanId=vlanId, sNMPTrapIPAddress=sNMPTrapIPAddress, aggregateDataRate=aggregateDataRate, ntp=ntp, masterSlaveMode=masterSlaveMode, currentChannel=currentChannel, fixedModMode=fixedModMode, subnetMask=subnetMask, ptpTraps=ptpTraps, configuredModulationMode=configuredModulationMode, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, ptp=ptp, sNMPCommunityAccess=sNMPCommunityAccess, vectorError=vectorError, ptp250=ptp250, extendedFreqMHz=extendedFreqMHz, ntpGroup=ntpGroup, configuredRange=configuredRange, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, extendedChannel=extendedChannel, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, receivePower=receivePower, vlanTagging=vlanTagging, versions=versions, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, remoteIPAddress=remoteIPAddress, noiseFloor=noiseFloor, sMTPServerPortNumber=sMTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, siteName=siteName, installArmStateTrap=installArmStateTrap, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, snmpControl=snmpControl, sNMPTrapCommunity=sNMPTrapCommunity)
