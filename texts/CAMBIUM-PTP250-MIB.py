...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedChannel=extendedChannel, transmitDataRate=transmitDataRate, ptp=ptp, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, band=band, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, remoteMACAddress=remoteMACAddress, configuration=configuration, sNMPCommunityTableEntry=sNMPCommunityTableEntry, timeZone=timeZone, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, currentFreqMHz=currentFreqMHz, maximumTransmitPower=maximumTransmitPower, vectorError=vectorError, nTPState=nTPState, configuredRange=configuredRange, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, pubStats=pubStats, snmpControlGroup=snmpControlGroup, notificationsGroup=notificationsGroup, measuredRange=measuredRange, vlanTagging=vlanTagging, configuredModulationMode=configuredModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationMode=receiveModulationMode, cambium=cambium, ptp250=ptp250, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, managementGroup=managementGroup, currentChannel=currentChannel, versions=versions, installArmState=installArmState, receivePower=receivePower, ntpGroup=ntpGroup, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, transmitPower=transmitPower, ethernetGroup=ethernetGroup, productVariant=productVariant, licenceGroup=licenceGroup, ptpGroups=ptpGroups, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, transmitModulationMode=transmitModulationMode, radarDetectTrap=radarDetectTrap, iPAddress=iPAddress, channelBandwidth=channelBandwidth, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, fixedModMode=fixedModMode, productName=productName, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, sNMPCommunityString=sNMPCommunityString, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, licence=licence, channelSelection=channelSelection, noiseFloor=noiseFloor, alarms=alarms, ptpTraps=ptpTraps, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, smtp=smtp, antennaGain=antennaGain, receiveDataRate=receiveDataRate, configurationGroup=configurationGroup, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, dataPortStatus=dataPortStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, linkLoss=linkLoss, extendedFreqMHz=extendedFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, sNMPCommunityTable=sNMPCommunityTable, nTPSync=nTPSync, sNMPCommunityTableNumber=sNMPCommunityTableNumber, bootVersion=bootVersion, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, vlanId=vlanId, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTrapPrefix=ptpTrapPrefix, nTPServerIp=nTPServerIp, smtpGroup=smtpGroup, linkStatusTrap=linkStatusTrap, softwareVersion=softwareVersion, siteName=siteName, installArmStateTrap=installArmStateTrap)
