...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStats=pubStats, phyStatus=phyStatus, vectorError=vectorError, phyStatusGroup=phyStatusGroup, measuredRange=measuredRange, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableNumber=sNMPCommunityTableNumber, remoteMACAddress=remoteMACAddress, extendedChannel=extendedChannel, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, band=band, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, radarDetectTrap=radarDetectTrap, timeZone=timeZone, vlanPriority=vlanPriority, sMTPServerPortNumber=sMTPServerPortNumber, configuredRange=configuredRange, managementGroup=managementGroup, transmitModulationMode=transmitModulationMode, sNMPCommunityTable=sNMPCommunityTable, nTPServerIp=nTPServerIp, snmpControl=snmpControl, productVariant=productVariant, linkName=linkName, currentChannel=currentChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, transmitPower=transmitPower, nTPLastSync=nTPLastSync, cableLoss=cableLoss, ntpGroup=ntpGroup, ptp250=ptp250, dataPortStatus=dataPortStatus, configuredModulationMode=configuredModulationMode, notificationsGroup=notificationsGroup, smtp=smtp, bootVersion=bootVersion, dualPayload=dualPayload, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, fixedModMode=fixedModMode, nTPSync=nTPSync, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, sNMPCommunityAccess=sNMPCommunityAccess, installArmState=installArmState, receiveModulationMode=receiveModulationMode, antennaGain=antennaGain, vlanTagging=vlanTagging, aggregateDataRate=aggregateDataRate, cambium=cambium, ptmp=ptmp, configuration=configuration, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, configurationGroup=configurationGroup, noiseFloor=noiseFloor, regionCode=regionCode, linkStatusTrap=linkStatusTrap, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanId=vlanId, signalStrengthRatio=signalStrengthRatio, channelSelection=channelSelection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, nTPState=nTPState, iPAddress=iPAddress, searchState=searchState, linkLoss=linkLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableEntry=sNMPCommunityTableEntry, extendedFreqMHz=extendedFreqMHz, radarDetectChannel=radarDetectChannel, sNMPTrapTable=sNMPTrapTable, siteName=siteName, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, currentFreqMHz=currentFreqMHz, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, versionsGroup=versionsGroup, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, ntp=ntp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, tFTPServerPortNumber=tFTPServerPortNumber, smtpGroup=smtpGroup, management=management, ethernet=ethernet, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, systemClock=systemClock, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, receivePower=receivePower, licence=licence)
