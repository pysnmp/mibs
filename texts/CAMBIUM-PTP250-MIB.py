...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptp=ptp, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentChannel=currentChannel, sNMPCommunityString=sNMPCommunityString, licence=licence, nTPServerIp=nTPServerIp, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, cambium=cambium, extendedChannel=extendedChannel, nTPState=nTPState, linkName=linkName, nTPPollInterval=nTPPollInterval, subnetMask=subnetMask, systemClock=systemClock, management=management, ptmp=ptmp, currentFreqMHz=currentFreqMHz, ptpGroups=ptpGroups, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, ntpGroup=ntpGroup, noiseFloor=noiseFloor, configuredModulationMode=configuredModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, configuredRange=configuredRange, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, ptp250=ptp250, sNMPCommunityTableIndex=sNMPCommunityTableIndex, alarms=alarms, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, searchState=searchState, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableNumber=sNMPCommunityTableNumber, timeZone=timeZone, antennaGain=antennaGain, smtpGroup=smtpGroup, ptpCompliance=ptpCompliance, radarDetectChannel=radarDetectChannel, masterSlaveMode=masterSlaveMode, configuration=configuration, installArmState=installArmState, receivePower=receivePower, vlanTagging=vlanTagging, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, nTPSync=nTPSync, notificationsGroup=notificationsGroup, measuredRange=measuredRange, sNMPTrapTableEntry=sNMPTrapTableEntry, channelSelection=channelSelection, nTPServerPortNumber=nTPServerPortNumber, ethernetGroup=ethernetGroup, linkLoss=linkLoss, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanId=vlanId, aggregateDataRate=aggregateDataRate, vlanPriority=vlanPriority, snmpControl=snmpControl, vectorError=vectorError, nTPLastSync=nTPLastSync, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernet=ethernet, linkStatusTrap=linkStatusTrap, licenceGroup=licenceGroup, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, band=band, sNMPCommunityAccess=sNMPCommunityAccess, installArmStateTrap=installArmStateTrap, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, radarDetectTrap=radarDetectTrap, smtp=smtp, iPAddress=iPAddress, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, remoteMACAddress=remoteMACAddress, fixedModMode=fixedModMode, alarmsGroup=alarmsGroup, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, extendedFreqMHz=extendedFreqMHz, signalStrengthRatio=signalStrengthRatio, ntp=ntp, sNMPCommunityTable=sNMPCommunityTable, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dualPayload=dualPayload)
