...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerIp=nTPServerIp, softwareVersion=softwareVersion, management=management, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTable=sNMPCommunityTable, fixedModMode=fixedModMode, remoteIPAddress=remoteIPAddress, hardwareVersion=hardwareVersion, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, configuredRange=configuredRange, channelSelection=channelSelection, timeZone=timeZone, ptmp=ptmp, vectorError=vectorError, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControlGroup=snmpControlGroup, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRate=receiveDataRate, vlanTagging=vlanTagging, pubStatsGroup=pubStatsGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTable=sNMPTrapTable, nTPServerPortNumber=nTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, transmitPower=transmitPower, phyStatus=phyStatus, ethernet=ethernet, licence=licence, cableLoss=cableLoss, linkName=linkName, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, alarms=alarms, linkStatusTrap=linkStatusTrap, maximumTransmitPower=maximumTransmitPower, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, extendedChannel=extendedChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, configuredModulationMode=configuredModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, band=band, dualPayload=dualPayload, sNMPCommunityTableEntry=sNMPCommunityTableEntry, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, radarDetectChannel=radarDetectChannel, ptpGroups=ptpGroups, PYSNMP_MODULE_ID=cambium, ptp250=ptp250, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, ntp=ntp, systemClock=systemClock, ptp=ptp, vlanId=vlanId, nTPState=nTPState, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noiseFloor=noiseFloor, vlanPriority=vlanPriority, pubStats=pubStats, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, managementGroup=managementGroup, versions=versions, regionCode=regionCode, remoteMACAddress=remoteMACAddress, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, ptpTraps=ptpTraps, antennaGain=antennaGain, alarmsGroup=alarmsGroup, siteName=siteName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, sNMPCommunityAccess=sNMPCommunityAccess, smtp=smtp, nTPPollInterval=nTPPollInterval, configuration=configuration, installArmStateTrap=installArmStateTrap, radarDetectTrap=radarDetectTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, currentFreqMHz=currentFreqMHz, versionsGroup=versionsGroup, receivePower=receivePower, transmitModulationMode=transmitModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, subnetMask=subnetMask, measuredRange=measuredRange, sNMPCommunityOid=sNMPCommunityOid, nTPSync=nTPSync, iPAddress=iPAddress, extendedFreqMHz=extendedFreqMHz, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString)
