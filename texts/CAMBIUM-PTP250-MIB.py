...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, currentFreqMHz=currentFreqMHz, radarDetectTrap=radarDetectTrap, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, notificationsGroup=notificationsGroup, band=band, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPSync=nTPSync, receivePower=receivePower, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmStateTrap=installArmStateTrap, extendedFreqMHz=extendedFreqMHz, versions=versions, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp250=ptp250, ptmp=ptmp, sNMPCommunityOid=sNMPCommunityOid, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPLastSync=nTPLastSync, regionCode=regionCode, measuredRange=measuredRange, sNMPCommunityTable=sNMPCommunityTable, noiseFloor=noiseFloor, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, alarms=alarms, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitPower=transmitPower, ethernetGroup=ethernetGroup, timeZone=timeZone, radarDetectChannel=radarDetectChannel, licence=licence, antennaGain=antennaGain, nTPState=nTPState, snmpControlGroup=snmpControlGroup, configuredRange=configuredRange, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, softwareVersion=softwareVersion, extendedChannel=extendedChannel, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, configuredModulationMode=configuredModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, cambium=cambium, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanId=vlanId, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, vectorError=vectorError, vlanPriority=vlanPriority, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, managementGroup=managementGroup, nTPPollInterval=nTPPollInterval, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, channelSelection=channelSelection, ptpCompliance=ptpCompliance, bootVersion=bootVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, linkStatusTrap=linkStatusTrap, smtp=smtp, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, subnetMask=subnetMask, sNMPTrapCommunity=sNMPTrapCommunity, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, ntpGroup=ntpGroup, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableNumber=sNMPCommunityTableNumber, hardwareVersion=hardwareVersion, ptpTraps=ptpTraps, fixedModMode=fixedModMode, ptp=ptp, configuration=configuration, maximumTransmitPower=maximumTransmitPower, smtpGroup=smtpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntp=ntp, currentChannel=currentChannel, licenceGroup=licenceGroup, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, dualPayload=dualPayload, linkLoss=linkLoss, management=management, iPAddress=iPAddress)
