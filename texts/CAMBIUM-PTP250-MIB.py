...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", hardwareVersion=hardwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCode=regionCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cambium=cambium, sNMPCommunityTable=sNMPCommunityTable, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, ntp=ntp, searchState=searchState, vlanTagging=vlanTagging, management=management, nTPSync=nTPSync, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, ptpCompliance=ptpCompliance, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth, smtp=smtp, radarDetectChannel=radarDetectChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, ntpGroup=ntpGroup, extendedChannel=extendedChannel, channelSelection=channelSelection, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, configuration=configuration, ptmp=ptmp, iPAddress=iPAddress, notificationsGroup=notificationsGroup, linkName=linkName, linkLoss=linkLoss, pubStats=pubStats, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, sNMPTrapCommunity=sNMPTrapCommunity, vlanId=vlanId, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, dualPayload=dualPayload, PYSNMP_MODULE_ID=cambium, nTPPollInterval=nTPPollInterval, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, ethernet=ethernet, noiseFloor=noiseFloor, licenceGroup=licenceGroup, subnetMask=subnetMask, siteName=siteName, antennaGain=antennaGain, remoteMACAddress=remoteMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, configuredRange=configuredRange, productName=productName, sNMPCommunityAccess=sNMPCommunityAccess, linkStatusTrap=linkStatusTrap, installArmState=installArmState, ptp250=ptp250, systemClock=systemClock, sMTPEnabledMessages=sMTPEnabledMessages, alarms=alarms, receiveModulationMode=receiveModulationMode, nTPServerIp=nTPServerIp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, extendedFreqMHz=extendedFreqMHz, vectorError=vectorError, remoteIPAddress=remoteIPAddress, configuredModulationMode=configuredModulationMode, currentChannel=currentChannel, measuredRange=measuredRange, timeZone=timeZone, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, tFTPServerPortNumber=tFTPServerPortNumber, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, receivePower=receivePower, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, dataPortStatus=dataPortStatus, band=band, ptpTraps=ptpTraps, nTPLastSync=nTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, radarDetectTrap=radarDetectTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, vlanPriority=vlanPriority, bootVersion=bootVersion, versions=versions)
