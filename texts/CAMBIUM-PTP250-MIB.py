...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanId=vlanId, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, configurationGroup=configurationGroup, versionsGroup=versionsGroup, band=band, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, versions=versions, linkName=linkName, configuredRange=configuredRange, ntpGroup=ntpGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanPriority=vlanPriority, nTPServerIp=nTPServerIp, currentFreqMHz=currentFreqMHz, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, cambium=cambium, snmpControl=snmpControl, searchState=searchState, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, transmitDataRate=transmitDataRate, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, fixedModMode=fixedModMode, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, phyStatus=phyStatus, ptmp=ptmp, systemClock=systemClock, siteName=siteName, iPAddress=iPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTable=sNMPCommunityTable, management=management, vlanTagging=vlanTagging, currentChannel=currentChannel, alarmsGroup=alarmsGroup, productVariant=productVariant, ntp=ntp, radarDetectChannel=radarDetectChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPSync=nTPSync, remoteIPAddress=remoteIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, radarDetectTrap=radarDetectTrap, smtpGroup=smtpGroup, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, installArmState=installArmState, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, dualPayload=dualPayload, phyStatusGroup=phyStatusGroup, ptpTraps=ptpTraps, ptp250=ptp250, sNMPTrapTableNumber=sNMPTrapTableNumber, noiseFloor=noiseFloor, configuration=configuration, sNMPEnabledTraps=sNMPEnabledTraps, nTPLastSync=nTPLastSync, timeZone=timeZone, licence=licence, configuredModulationMode=configuredModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, antennaGain=antennaGain, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, vectorError=vectorError, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpCompliance=ptpCompliance, channelSelection=channelSelection, measuredRange=measuredRange, nTPServerPortNumber=nTPServerPortNumber, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityAccess=sNMPCommunityAccess, extendedChannel=extendedChannel, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernet=ethernet, pubStats=pubStats, masterSlaveMode=masterSlaveMode, installArmStateTrap=installArmStateTrap, pubStatsGroup=pubStatsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry)
