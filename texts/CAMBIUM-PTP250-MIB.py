...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerPortNumber=nTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, ethernetGroup=ethernetGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControl=snmpControl, searchState=searchState, currentChannel=currentChannel, ptpCompliance=ptpCompliance, ntp=ntp, ethernet=ethernet, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapCommunity=sNMPTrapCommunity, fixedModMode=fixedModMode, receiveDataRate=receiveDataRate, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, extendedChannel=extendedChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, hardwareVersion=hardwareVersion, radarDetectTrap=radarDetectTrap, ptpGroups=ptpGroups, pubStats=pubStats, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, nTPSync=nTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptp=ptp, signalStrengthRatio=signalStrengthRatio, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, vlanId=vlanId, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, radarDetectChannel=radarDetectChannel, configuredModulationMode=configuredModulationMode, ntpGroup=ntpGroup, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerIp=nTPServerIp, sNMPCommunityOid=sNMPCommunityOid, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, siteName=siteName, alarms=alarms, phyStatusGroup=phyStatusGroup, installArmState=installArmState, dualPayload=dualPayload, noiseFloor=noiseFloor, pubStatsGroup=pubStatsGroup, ptp250=ptp250, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, vectorError=vectorError, softwareVersion=softwareVersion, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, currentFreqMHz=currentFreqMHz, nTPState=nTPState, installArmStateTrap=installArmStateTrap, licence=licence, configuration=configuration, extendedFreqMHz=extendedFreqMHz, cambium=cambium, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, alarmsGroup=alarmsGroup, measuredRange=measuredRange, managementGroup=managementGroup, smtp=smtp, versionsGroup=versionsGroup, dataPortStatus=dataPortStatus, systemClock=systemClock, antennaGain=antennaGain, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPPollInterval=nTPPollInterval, subnetMask=subnetMask, smtpGroup=smtpGroup, configuredRange=configuredRange, management=management, configurationGroup=configurationGroup, vlanPriority=vlanPriority, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, ptmp=ptmp, licenceGroup=licenceGroup, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, band=band, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, productName=productName, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityAccess=sNMPCommunityAccess, channelBandwidth=channelBandwidth, transmitPower=transmitPower, sMTPServerIPAddress=sMTPServerIPAddress, timeZone=timeZone, regionCode=regionCode, sMTPServerPortNumber=sMTPServerPortNumber)
