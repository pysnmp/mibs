...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmState=installArmState, nTPServerIp=nTPServerIp, ptmp=ptmp, sNMPCommunityOid=sNMPCommunityOid, sMTPServerIPAddress=sMTPServerIPAddress, management=management, ptpGroups=ptpGroups, snmpControl=snmpControl, dataPortStatusTrap=dataPortStatusTrap, nTPServerPortNumber=nTPServerPortNumber, transmitPower=transmitPower, ntpGroup=ntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, receiveDataRate=receiveDataRate, ntp=ntp, sNMPTrapCommunity=sNMPTrapCommunity, nTPSync=nTPSync, configuredRange=configuredRange, smtpGroup=smtpGroup, receivePower=receivePower, softwareVersion=softwareVersion, ethernet=ethernet, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, tFTPServerIPAddress=tFTPServerIPAddress, currentFreqMHz=currentFreqMHz, ptpCompliance=ptpCompliance, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectTrap=radarDetectTrap, vlanPriority=vlanPriority, PYSNMP_MODULE_ID=cambium, sNMPCommunityAccess=sNMPCommunityAccess, vlanId=vlanId, receiveModulationMode=receiveModulationMode, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, channelSelection=channelSelection, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPState=nTPState, subnetMask=subnetMask, productVariant=productVariant, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, versions=versions, smtp=smtp, phyStatusGroup=phyStatusGroup, installArmStateTrap=installArmStateTrap, fixedModMode=fixedModMode, configurationGroup=configurationGroup, hardwareVersion=hardwareVersion, sNMPCommunityTable=sNMPCommunityTable, ptpTraps=ptpTraps, nTPLastSync=nTPLastSync, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkLoss=linkLoss, vectorError=vectorError, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, dualPayload=dualPayload, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, aggregateDataRate=aggregateDataRate, radarDetectChannel=radarDetectChannel, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, linkStatusTrap=linkStatusTrap, phyStatus=phyStatus, cambium=cambium, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, measuredRange=measuredRange, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noiseFloor=noiseFloor, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, masterSlaveMode=masterSlaveMode, currentChannel=currentChannel, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredModulationMode=configuredModulationMode, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, remoteMACAddress=remoteMACAddress, timeZone=timeZone, pubStats=pubStats, linkName=linkName, configuration=configuration, iPAddress=iPAddress, band=band, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, cableLoss=cableLoss, ptp250=ptp250, managementGroup=managementGroup, gatewayIPAddress=gatewayIPAddress, alarms=alarms, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress)
