...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ntpGroup=ntpGroup, ethernetGroup=ethernetGroup, ptpGroups=ptpGroups, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, configuration=configuration, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, radarDetectTrap=radarDetectTrap, configuredRange=configuredRange, linkLoss=linkLoss, ptp=ptp, wirelessLinkStatus=wirelessLinkStatus, licence=licence, smtp=smtp, ntp=ntp, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedChannel=extendedChannel, searchState=searchState, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, sNMPCommunityTable=sNMPCommunityTable, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, fixedModMode=fixedModMode, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, cambium=cambium, phyStatusGroup=phyStatusGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, nTPSync=nTPSync, sNMPTrapTable=sNMPTrapTable, siteName=siteName, vlanTagging=vlanTagging, management=management, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, receivePower=receivePower, measuredRange=measuredRange, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noiseFloor=noiseFloor, sNMPCommunityOid=sNMPCommunityOid, band=band, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, nTPState=nTPState, channelSelection=channelSelection, regionCode=regionCode, ptpCompliance=ptpCompliance, sMTPServerPortNumber=sMTPServerPortNumber, nTPServerIp=nTPServerIp, ptpTrapPrefix=ptpTrapPrefix, nTPServerPortNumber=nTPServerPortNumber, hardwareVersion=hardwareVersion, phyStatus=phyStatus, extendedFreqMHz=extendedFreqMHz, PYSNMP_MODULE_ID=cambium, pubStats=pubStats, linkStatusTrap=linkStatusTrap, smtpGroup=smtpGroup, installArmState=installArmState, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernet=ethernet, iPAddress=iPAddress, snmpControl=snmpControl, antennaGain=antennaGain, licenceGroup=licenceGroup, radarDetectChannel=radarDetectChannel, alarmsGroup=alarmsGroup, dualPayload=dualPayload, productName=productName, dataPortStatusTrap=dataPortStatusTrap, currentChannel=currentChannel, transmitPower=transmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, currentFreqMHz=currentFreqMHz, configuredModulationMode=configuredModulationMode, nTPPollInterval=nTPPollInterval, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableNumber=sNMPCommunityTableNumber, signalStrengthRatio=signalStrengthRatio, vlanId=vlanId, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, remoteIPAddress=remoteIPAddress, ptp250=ptp250, ptpTraps=ptpTraps, remoteMACAddress=remoteMACAddress, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanPriority=vlanPriority, managementGroup=managementGroup, nTPLastSync=nTPLastSync, aggregateDataRate=aggregateDataRate, versions=versions, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, cableLoss=cableLoss, sNMPCommunityAccess=sNMPCommunityAccess, channelBandwidth=channelBandwidth)
