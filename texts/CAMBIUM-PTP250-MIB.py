...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableIndex=sNMPTrapTableIndex, extendedChannel=extendedChannel, wirelessLinkStatus=wirelessLinkStatus, nTPSync=nTPSync, currentFreqMHz=currentFreqMHz, dataPortStatusTrap=dataPortStatusTrap, management=management, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, nTPServerPortNumber=nTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, vlanPriority=vlanPriority, receiveModulationMode=receiveModulationMode, channelSelection=channelSelection, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpGroups=ptpGroups, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, fixedModMode=fixedModMode, remoteMACAddress=remoteMACAddress, sNMPCommunityTable=sNMPCommunityTable, nTPServerIp=nTPServerIp, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControlGroup=snmpControlGroup, vectorError=vectorError, ptp=ptp, transmitDataRate=transmitDataRate, extendedFreqMHz=extendedFreqMHz, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp250=ptp250, phyStatus=phyStatus, configurationGroup=configurationGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitPower=transmitPower, cambium=cambium, remoteIPAddress=remoteIPAddress, radarDetectChannel=radarDetectChannel, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, sNMPCommunityAccess=sNMPCommunityAccess, managementGroup=managementGroup, aggregateDataRate=aggregateDataRate, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, versions=versions, pubStatsGroup=pubStatsGroup, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, installArmState=installArmState, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, band=band, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, ethernet=ethernet, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanId=vlanId, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatus=dataPortStatus, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, installArmStateTrap=installArmStateTrap, smtp=smtp, ptmp=ptmp, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, antennaGain=antennaGain, alarms=alarms, ptpCompliance=ptpCompliance, currentChannel=currentChannel, configuredRange=configuredRange, linkName=linkName, ntp=ntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerIPAddress=tFTPServerIPAddress, measuredRange=measuredRange, nTPState=nTPState, signalStrengthRatio=signalStrengthRatio, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectTrap=radarDetectTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, licence=licence, hardwareVersion=hardwareVersion, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, ntpGroup=ntpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, sNMPCommunityOid=sNMPCommunityOid, nTPLastSync=nTPLastSync, maximumTransmitPower=maximumTransmitPower, productName=productName, smtpGroup=smtpGroup, subnetMask=subnetMask, dualPayload=dualPayload, dataPortAutoNegotiation=dataPortAutoNegotiation, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, iPAddress=iPAddress, linkLoss=linkLoss, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging)
