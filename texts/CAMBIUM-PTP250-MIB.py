...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, pubStats=pubStats, band=band, linkStatusTrap=linkStatusTrap, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, fixedModMode=fixedModMode, ptpTraps=ptpTraps, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatusGroup=phyStatusGroup, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, iPAddress=iPAddress, noiseFloor=noiseFloor, nTPLastSync=nTPLastSync, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, configurationGroup=configurationGroup, installArmState=installArmState, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, ntpGroup=ntpGroup, nTPServerIp=nTPServerIp, extendedChannel=extendedChannel, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, timeZone=timeZone, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, extendedFreqMHz=extendedFreqMHz, ethernetGroup=ethernetGroup, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, nTPState=nTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dualPayload=dualPayload, nTPSync=nTPSync, smtp=smtp, versionsGroup=versionsGroup, measuredRange=measuredRange, cableLoss=cableLoss, radarDetectChannel=radarDetectChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, noWirelessChannelAvailable=noWirelessChannelAvailable, currentFreqMHz=currentFreqMHz, ptp250=ptp250, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, alarms=alarms, configuredModulationMode=configuredModulationMode, configuredRange=configuredRange, snmpControl=snmpControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, nTPPollInterval=nTPPollInterval, management=management, channelBandwidth=channelBandwidth, cambium=cambium, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, radarDetectTrap=radarDetectTrap, channelSelection=channelSelection, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityString=sNMPCommunityString, versions=versions, sNMPCommunityTableEntry=sNMPCommunityTableEntry, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapCommunity=sNMPTrapCommunity, ntp=ntp, nTPServerPortNumber=nTPServerPortNumber, phyStatus=phyStatus, licence=licence, receivePower=receivePower, sNMPCommunityTable=sNMPCommunityTable, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, transmitModulationMode=transmitModulationMode, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, currentChannel=currentChannel, vectorError=vectorError, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, sNMPTrapTableIndex=sNMPTrapTableIndex, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress, configuration=configuration, sNMPCommunityOid=sNMPCommunityOid, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup)
