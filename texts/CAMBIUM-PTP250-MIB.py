...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, management=management, cableLoss=cableLoss, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, nTPServerPortNumber=nTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmState=installArmState, sNMPCommunityTable=sNMPCommunityTable, wirelessLinkStatus=wirelessLinkStatus, extendedChannel=extendedChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configurationGroup=configurationGroup, configuredModulationMode=configuredModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, nTPState=nTPState, remoteMACAddress=remoteMACAddress, configuredRange=configuredRange, currentFreqMHz=currentFreqMHz, sNMPCommunityOid=sNMPCommunityOid, noiseFloor=noiseFloor, phyStatus=phyStatus, notificationsGroup=notificationsGroup, channelSelection=channelSelection, systemClock=systemClock, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, ptpGroups=ptpGroups, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernetGroup=ethernetGroup, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, softwareVersion=softwareVersion, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenceGroup=licenceGroup, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, receiveModulationMode=receiveModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, antennaGain=antennaGain, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, radarDetectTrap=radarDetectTrap, masterSlaveMode=masterSlaveMode, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, band=band, nTPPollInterval=nTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityString=sNMPCommunityString, linkLoss=linkLoss, vlanPriority=vlanPriority, productVariant=productVariant, radarDetectChannel=radarDetectChannel, siteName=siteName, currentChannel=currentChannel, vlanId=vlanId, bootVersion=bootVersion, pubStats=pubStats, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp250=ptp250, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, ethernet=ethernet, ntp=ntp, vectorError=vectorError, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, linkStatusTrap=linkStatusTrap, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber, searchState=searchState, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, subnetMask=subnetMask, vlanTagging=vlanTagging, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, nTPServerIp=nTPServerIp, alarmsGroup=alarmsGroup, fixedModMode=fixedModMode, licence=licence, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, nTPSync=nTPSync, linkName=linkName, configuration=configuration, iPAddress=iPAddress, productName=productName, ntpGroup=ntpGroup, smtpGroup=smtpGroup, alarms=alarms, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth)
