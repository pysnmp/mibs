...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernetGroup=ethernetGroup, installArmState=installArmState, receivePower=receivePower, transmitModulationMode=transmitModulationMode, sNMPCommunityOid=sNMPCommunityOid, siteName=siteName, snmpControlGroup=snmpControlGroup, currentChannel=currentChannel, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, vlanTagging=vlanTagging, configurationGroup=configurationGroup, noiseFloor=noiseFloor, smtpGroup=smtpGroup, alarmsGroup=alarmsGroup, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, nTPLastSync=nTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, dualPayload=dualPayload, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, measuredRange=measuredRange, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vlanId=vlanId, fixedModMode=fixedModMode, timeZone=timeZone, hardwareVersion=hardwareVersion, nTPState=nTPState, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, ptp250=ptp250, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, extendedChannel=extendedChannel, pubStats=pubStats, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, cableLoss=cableLoss, ptmp=ptmp, nTPServerPortNumber=nTPServerPortNumber, snmpControl=snmpControl, dataPortStatus=dataPortStatus, wirelessLinkStatus=wirelessLinkStatus, vlanPriority=vlanPriority, ethernet=ethernet, band=band, extendedFreqMHz=extendedFreqMHz, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, sNMPTrapCommunity=sNMPTrapCommunity, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableIndex=sNMPCommunityTableIndex, gatewayIPAddress=gatewayIPAddress, versions=versions, bootVersion=bootVersion, licenceGroup=licenceGroup, nTPSync=nTPSync, radarDetectTrap=radarDetectTrap, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp=ptp, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, systemClock=systemClock, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, channelBandwidth=channelBandwidth, linkStatusTrap=linkStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, configuredRange=configuredRange, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapVersion=sNMPTrapVersion, ntpGroup=ntpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, smtp=smtp, tFTPServerIPAddress=tFTPServerIPAddress, channelSelection=channelSelection, remoteIPAddress=remoteIPAddress, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, remoteMACAddress=remoteMACAddress, linkLoss=linkLoss, managementGroup=managementGroup, ptpCompliance=ptpCompliance, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, configuredModulationMode=configuredModulationMode, cambium=cambium, nTPServerIp=nTPServerIp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, ntp=ntp, radarDetectChannel=radarDetectChannel)
