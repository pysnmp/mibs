...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, phyStatus=phyStatus, siteName=siteName, subnetMask=subnetMask, alarmsGroup=alarmsGroup, band=band, channelBandwidth=channelBandwidth, hardwareVersion=hardwareVersion, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, extendedFreqMHz=extendedFreqMHz, nTPLastSync=nTPLastSync, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, licence=licence, searchState=searchState, nTPState=nTPState, currentFreqMHz=currentFreqMHz, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, alarms=alarms, linkStatusTrap=linkStatusTrap, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, timeZone=timeZone, ethernet=ethernet, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, extendedChannel=extendedChannel, pubStatsGroup=pubStatsGroup, nTPServerPortNumber=nTPServerPortNumber, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, maximumTransmitPower=maximumTransmitPower, configuration=configuration, sNMPCommunityOid=sNMPCommunityOid, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkLoss=linkLoss, smtp=smtp, vlanId=vlanId, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, cambium=cambium, receiveDataRate=receiveDataRate, systemClock=systemClock, dualPayload=dualPayload, management=management, configurationGroup=configurationGroup, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, signalStrengthRatio=signalStrengthRatio, fixedModMode=fixedModMode, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, configuredRange=configuredRange, ptmp=ptmp, aggregateDataRate=aggregateDataRate, noiseFloor=noiseFloor, measuredRange=measuredRange, nTPServerIp=nTPServerIp, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, ntp=ntp, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, transmitDataRate=transmitDataRate, ntpGroup=ntpGroup, nTPPollInterval=nTPPollInterval, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanPriority=vlanPriority, configuredModulationMode=configuredModulationMode, nTPSync=nTPSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, sNMPCommunityTable=sNMPCommunityTable, radarDetectChannel=radarDetectChannel, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableEntry=sNMPCommunityTableEntry, masterSlaveMode=masterSlaveMode, vlanTagging=vlanTagging, transmitModulationMode=transmitModulationMode, ptp250=ptp250, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, iPAddress=iPAddress, remoteMACAddress=remoteMACAddress, snmpControl=snmpControl, smtpGroup=smtpGroup, receivePower=receivePower, productVariant=productVariant, ethernetGroup=ethernetGroup, channelSelection=channelSelection, sNMPCommunityAccess=sNMPCommunityAccess, cableLoss=cableLoss, licenceGroup=licenceGroup, ptpTraps=ptpTraps, productName=productName, currentChannel=currentChannel, installArmState=installArmState)
