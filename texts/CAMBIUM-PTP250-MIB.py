...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, channelSelection=channelSelection, ptmp=ptmp, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, sNMPCommunityTableNumber=sNMPCommunityTableNumber, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, ethernet=ethernet, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, ptp250=ptp250, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityOid=sNMPCommunityOid, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteIPAddress=remoteIPAddress, band=band, transmitPower=transmitPower, cambium=cambium, PYSNMP_MODULE_ID=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanPriority=vlanPriority, dataPortStatusTrap=dataPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, searchState=searchState, bootVersion=bootVersion, fixedModMode=fixedModMode, ntp=ntp, licenceGroup=licenceGroup, phyStatus=phyStatus, vlanTagging=vlanTagging, softwareVersion=softwareVersion, currentChannel=currentChannel, notificationsGroup=notificationsGroup, signalStrengthRatio=signalStrengthRatio, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber, nTPLastSync=nTPLastSync, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControlGroup=snmpControlGroup, maximumTransmitPower=maximumTransmitPower, nTPState=nTPState, dataPortStatus=dataPortStatus, iPAddress=iPAddress, smtp=smtp, pubStats=pubStats, masterSlaveMode=masterSlaveMode, vectorError=vectorError, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMACAddress=remoteMACAddress, extendedFreqMHz=extendedFreqMHz, radarDetectChannel=radarDetectChannel, sNMPCommunityAccess=sNMPCommunityAccess, smtpGroup=smtpGroup, systemClock=systemClock, nTPPollInterval=nTPPollInterval, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, timeZone=timeZone, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityString=sNMPCommunityString, sNMPTrapCommunity=sNMPTrapCommunity, ptpGroups=ptpGroups, ntpGroup=ntpGroup, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, snmpControl=snmpControl, noiseFloor=noiseFloor, ptpTraps=ptpTraps, dualPayload=dualPayload, managementGroup=managementGroup, productName=productName, sNMPTrapTable=sNMPTrapTable, ptpCompliance=ptpCompliance, configuredRange=configuredRange, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, ptp=ptp, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, alarms=alarms, linkLoss=linkLoss, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, linkStatusTrap=linkStatusTrap, nTPSync=nTPSync, radarDetectTrap=radarDetectTrap, licence=licence, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerIp=nTPServerIp, management=management, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, linkName=linkName, vlanId=vlanId, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps)
