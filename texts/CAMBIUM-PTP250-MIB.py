...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPLastSync=nTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, linkName=linkName, managementGroup=managementGroup, productVariant=productVariant, extendedChannel=extendedChannel, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanPriority=vlanPriority, productName=productName, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuredRange=configuredRange, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, sNMPCommunityTable=sNMPCommunityTable, receivePower=receivePower, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, ntp=ntp, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, configuredModulationMode=configuredModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, noiseFloor=noiseFloor, measuredRange=measuredRange, smtp=smtp, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, timeZone=timeZone, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, nTPState=nTPState, sNMPTrapVersion=sNMPTrapVersion, radarDetectTrap=radarDetectTrap, transmitPower=transmitPower, ptp250=ptp250, subnetMask=subnetMask, ptmp=ptmp, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, alarms=alarms, band=band, sMTPServerIPAddress=sMTPServerIPAddress, channelSelection=channelSelection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, systemClock=systemClock, nTPServerPortNumber=nTPServerPortNumber, cableLoss=cableLoss, linkStatusTrap=linkStatusTrap, currentFreqMHz=currentFreqMHz, maximumTransmitPower=maximumTransmitPower, sNMPCommunityAccess=sNMPCommunityAccess, antennaGain=antennaGain, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, searchState=searchState, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, iPAddress=iPAddress, vlanId=vlanId, sNMPTrapTable=sNMPTrapTable, nTPServerIp=nTPServerIp, ethernet=ethernet, fixedModMode=fixedModMode, installArmState=installArmState, linkLoss=linkLoss, vlanTagging=vlanTagging, siteName=siteName, sNMPTrapCommunity=sNMPTrapCommunity, transmitModulationMode=transmitModulationMode, nTPSync=nTPSync, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, smtpGroup=smtpGroup, currentChannel=currentChannel, dataPortStatusTrap=dataPortStatusTrap, dualPayload=dualPayload, notificationsGroup=notificationsGroup, ntpGroup=ntpGroup, pubStats=pubStats, installArmStateTrap=installArmStateTrap, versions=versions, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
