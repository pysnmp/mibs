...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerPortNumber=sMTPServerPortNumber, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productVariant=productVariant, nTPServerIp=nTPServerIp, installArmStateTrap=installArmStateTrap, band=band, masterSlaveMode=masterSlaveMode, ptp=ptp, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectTrap=radarDetectTrap, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPAddress=iPAddress, alarmsGroup=alarmsGroup, phyStatus=phyStatus, regionCode=regionCode, cableLoss=cableLoss, nTPSync=nTPSync, ptpGroups=ptpGroups, measuredRange=measuredRange, versions=versions, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, sNMPCommunityTable=sNMPCommunityTable, snmpControl=snmpControl, radarDetectChannel=radarDetectChannel, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPState=nTPState, nTPPollInterval=nTPPollInterval, sNMPTrapCommunity=sNMPTrapCommunity, PYSNMP_MODULE_ID=cambium, fixedModMode=fixedModMode, ptp250=ptp250, nTPLastSync=nTPLastSync, extendedFreqMHz=extendedFreqMHz, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, vectorError=vectorError, systemClock=systemClock, ntp=ntp, channelSelection=channelSelection, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, configurationGroup=configurationGroup, licenceGroup=licenceGroup, dataPortStatusTrap=dataPortStatusTrap, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, nTPServerPortNumber=nTPServerPortNumber, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, managementGroup=managementGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vlanPriority=vlanPriority, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, installArmState=installArmState, noiseFloor=noiseFloor, vlanId=vlanId, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, sNMPTrapTable=sNMPTrapTable, extendedChannel=extendedChannel, currentChannel=currentChannel, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, softwareVersion=softwareVersion, configuration=configuration, alarms=alarms, ethernetGroup=ethernetGroup, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, vlanTagging=vlanTagging, timeZone=timeZone, hardwareVersion=hardwareVersion, cambium=cambium, pubStatsGroup=pubStatsGroup, pubStats=pubStats, configuredRange=configuredRange, linkStatusTrap=linkStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, versionsGroup=versionsGroup, subnetMask=subnetMask, ntpGroup=ntpGroup, configuredModulationMode=configuredModulationMode, receivePower=receivePower, notificationsGroup=notificationsGroup, siteName=siteName, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityAccess=sNMPCommunityAccess, dualPayload=dualPayload, aggregateDataRate=aggregateDataRate)
