...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, nTPPollInterval=nTPPollInterval, sNMPCommunityOid=sNMPCommunityOid, ptp250=ptp250, bootVersion=bootVersion, sNMPCommunityAccess=sNMPCommunityAccess, linkLoss=linkLoss, band=band, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, remoteMACAddress=remoteMACAddress, alarmsGroup=alarmsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanTagging=vlanTagging, pubStats=pubStats, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, channelBandwidth=channelBandwidth, extendedChannel=extendedChannel, systemClock=systemClock, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, ntpGroup=ntpGroup, smtp=smtp, extendedFreqMHz=extendedFreqMHz, maximumTransmitPower=maximumTransmitPower, cambium=cambium, ethernetGroup=ethernetGroup, measuredRange=measuredRange, sNMPCommunityString=sNMPCommunityString, management=management, configuredModulationMode=configuredModulationMode, transmitDataRate=transmitDataRate, siteName=siteName, vlanId=vlanId, linkStatusTrap=linkStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, ntp=ntp, antennaGain=antennaGain, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, alarms=alarms, snmpControl=snmpControl, configuredRange=configuredRange, phyStatus=phyStatus, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTable=sNMPCommunityTable, nTPLastSync=nTPLastSync, versions=versions, radarDetectChannel=radarDetectChannel, currentFreqMHz=currentFreqMHz, wirelessLinkStatus=wirelessLinkStatus, noiseFloor=noiseFloor, installArmState=installArmState, nTPSync=nTPSync, sNMPTrapTable=sNMPTrapTable, nTPState=nTPState, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, nTPServerIp=nTPServerIp, vlanPriority=vlanPriority, configuration=configuration, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup, ptmp=ptmp, linkName=linkName, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, transmitPower=transmitPower, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpCompliance=ptpCompliance, remoteIPAddress=remoteIPAddress, nTPServerPortNumber=nTPServerPortNumber, licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dualPayload=dualPayload, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, currentChannel=currentChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, ptp=ptp, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, productVariant=productVariant, gatewayIPAddress=gatewayIPAddress, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, productName=productName, ethernet=ethernet, phyStatusGroup=phyStatusGroup, radarDetectTrap=radarDetectTrap, ptpGroups=ptpGroups)
