...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dualPayload=dualPayload, nTPPollInterval=nTPPollInterval, pubStats=pubStats, alarmsGroup=alarmsGroup, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, radarDetectTrap=radarDetectTrap, aggregateDataRate=aggregateDataRate, productName=productName, sNMPCommunityString=sNMPCommunityString, ptp=ptp, configuredModulationMode=configuredModulationMode, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, fixedModMode=fixedModMode, ptpGroups=ptpGroups, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, management=management, systemClock=systemClock, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, iPAddress=iPAddress, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapCommunity=sNMPTrapCommunity, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, extendedChannel=extendedChannel, ntp=ntp, softwareVersion=softwareVersion, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bootVersion=bootVersion, cambium=cambium, timeZone=timeZone, phyStatus=phyStatus, ntpGroup=ntpGroup, dataPortStatus=dataPortStatus, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, measuredRange=measuredRange, searchState=searchState, vlanId=vlanId, sNMPCommunityAccess=sNMPCommunityAccess, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerPortNumber=nTPServerPortNumber, linkLoss=linkLoss, alarms=alarms, installArmState=installArmState, ptmp=ptmp, nTPSync=nTPSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, currentFreqMHz=currentFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, managementGroup=managementGroup, band=band, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, vectorError=vectorError, vlanPriority=vlanPriority, sNMPCommunityOid=sNMPCommunityOid, noiseFloor=noiseFloor, maximumTransmitPower=maximumTransmitPower, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, hardwareVersion=hardwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernet=ethernet, licence=licence, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmStateTrap=installArmStateTrap, smtp=smtp, licenceGroup=licenceGroup, currentChannel=currentChannel, ptpTraps=ptpTraps, transmitPower=transmitPower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailable=noWirelessChannelAvailable, configuration=configuration, transmitDataRate=transmitDataRate, remoteMACAddress=remoteMACAddress, pubStatsGroup=pubStatsGroup, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, channelSelection=channelSelection, linkStatusTrap=linkStatusTrap, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, antennaGain=antennaGain, sNMPCommunityTable=sNMPCommunityTable, phyStatusGroup=phyStatusGroup, receivePower=receivePower, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveDataRate=receiveDataRate, configuredRange=configuredRange, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, radarDetectChannel=radarDetectChannel)
