...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTable=sNMPCommunityTable, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, sMTPEnabledMessages=sMTPEnabledMessages, ptpCompliance=ptpCompliance, sNMPTrapCommunity=sNMPTrapCommunity, versions=versions, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, nTPPollInterval=nTPPollInterval, nTPServerIp=nTPServerIp, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntpGroup=ntpGroup, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, measuredRange=measuredRange, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitModulationMode=transmitModulationMode, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, alarms=alarms, nTPSync=nTPSync, ptp250=ptp250, management=management, dataPortStatusTrap=dataPortStatusTrap, vlanId=vlanId, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, bootVersion=bootVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, radarDetectChannel=radarDetectChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, configuredRange=configuredRange, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, smtp=smtp, hardwareVersion=hardwareVersion, extendedFreqMHz=extendedFreqMHz, configuration=configuration, radarDetectTrap=radarDetectTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControl=snmpControl, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, currentChannel=currentChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntp=ntp, searchState=searchState, configurationGroup=configurationGroup, cambium=cambium, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatus=phyStatus, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, linkStatusTrap=linkStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpTraps=ptpTraps, channelSelection=channelSelection, dualPayload=dualPayload, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, ethernetGroup=ethernetGroup, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, productName=productName, band=band, regionCode=regionCode, sNMPCommunityAccess=sNMPCommunityAccess, extendedChannel=extendedChannel, remoteIPAddress=remoteIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, nTPState=nTPState, remoteMACAddress=remoteMACAddress, sNMPCommunityOid=sNMPCommunityOid, fixedModMode=fixedModMode, licence=licence, configuredModulationMode=configuredModulationMode, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, vlanTagging=vlanTagging, softwareVersion=softwareVersion, vlanPriority=vlanPriority, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noiseFloor=noiseFloor, installArmStateTrap=installArmStateTrap, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, receivePower=receivePower, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, pubStats=pubStats)
