...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vectorError=vectorError, management=management, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, configuredModulationMode=configuredModulationMode, sNMPCommunityTable=sNMPCommunityTable, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPState=nTPState, currentFreqMHz=currentFreqMHz, channelSelection=channelSelection, nTPServerPortNumber=nTPServerPortNumber, phyStatus=phyStatus, vlanId=vlanId, receivePower=receivePower, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, timeZone=timeZone, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptmp=ptmp, configuredRange=configuredRange, dualPayload=dualPayload, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, sNMPCommunityAccess=sNMPCommunityAccess, ethernetGroup=ethernetGroup, productName=productName, systemClock=systemClock, radarDetectTrap=radarDetectTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPPollInterval=nTPPollInterval, pubStats=pubStats, nTPLastSync=nTPLastSync, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, nTPSync=nTPSync, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, linkStatusTrap=linkStatusTrap, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControl=snmpControl, fixedModMode=fixedModMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, channelBandwidth=channelBandwidth, currentChannel=currentChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, licence=licence, transmitModulationMode=transmitModulationMode, ethernet=ethernet, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, measuredRange=measuredRange, radarDetectChannel=radarDetectChannel, sNMPCommunityOid=sNMPCommunityOid, tFTPServerIPAddress=tFTPServerIPAddress, extendedChannel=extendedChannel, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp250=ptp250, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, antennaGain=antennaGain, licenceGroup=licenceGroup, remoteMACAddress=remoteMACAddress, searchState=searchState, ptpTraps=ptpTraps, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, cambium=cambium, vlanPriority=vlanPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, linkName=linkName, nTPServerIp=nTPServerIp, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, vlanTagging=vlanTagging, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, subnetMask=subnetMask, dataPortStatusTrap=dataPortStatusTrap, noiseFloor=noiseFloor, installArmState=installArmState, configurationGroup=configurationGroup, ntp=ntp, linkLoss=linkLoss, band=band, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, sNMPTrapCommunity=sNMPTrapCommunity, snmpControlGroup=snmpControlGroup, ptpTrapPrefix=ptpTrapPrefix, extendedFreqMHz=extendedFreqMHz, softwareVersion=softwareVersion, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber)
