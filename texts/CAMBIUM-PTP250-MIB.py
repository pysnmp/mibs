...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, band=band, vlanTagging=vlanTagging, smtp=smtp, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, nTPSync=nTPSync, transmitPower=transmitPower, iPAddress=iPAddress, measuredRange=measuredRange, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, productName=productName, nTPLastSync=nTPLastSync, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, ptpGroups=ptpGroups, versions=versions, extendedChannel=extendedChannel, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, radarDetectTrap=radarDetectTrap, pubStats=pubStats, channelSelection=channelSelection, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dualPayload=dualPayload, alarmsGroup=alarmsGroup, nTPPollInterval=nTPPollInterval, ptp250=ptp250, configurationGroup=configurationGroup, ntpGroup=ntpGroup, currentChannel=currentChannel, subnetMask=subnetMask, nTPState=nTPState, sNMPEnabledTraps=sNMPEnabledTraps, linkLoss=linkLoss, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configuredRange=configuredRange, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, licence=licence, cableLoss=cableLoss, configuredModulationMode=configuredModulationMode, vlanPriority=vlanPriority, systemClock=systemClock, sNMPCommunityTableEntry=sNMPCommunityTableEntry, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, remoteMACAddress=remoteMACAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, alarms=alarms, ptmp=ptmp, currentFreqMHz=currentFreqMHz, noiseFloor=noiseFloor, ntp=ntp, vlanId=vlanId, ptpCompliance=ptpCompliance, sNMPTrapCommunity=sNMPTrapCommunity, configuration=configuration, siteName=siteName, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPServerIp=nTPServerIp, sNMPCommunityOid=sNMPCommunityOid, searchState=searchState, fixedModMode=fixedModMode, vectorError=vectorError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, management=management, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, snmpControl=snmpControl, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, productVariant=productVariant, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, sNMPCommunityAccess=sNMPCommunityAccess, ptp=ptp, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelBandwidth=channelBandwidth, installArmState=installArmState, softwareVersion=softwareVersion, nTPServerPortNumber=nTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, radarDetectChannel=radarDetectChannel, sNMPCommunityTable=sNMPCommunityTable, signalStrengthRatio=signalStrengthRatio, linkName=linkName, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber)
