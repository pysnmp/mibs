...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, fixedModMode=fixedModMode, extendedFreqMHz=extendedFreqMHz, vectorError=vectorError, productVariant=productVariant, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, measuredRange=measuredRange, radarDetectTrap=radarDetectTrap, timeZone=timeZone, searchState=searchState, ptpGroups=ptpGroups, remoteIPAddress=remoteIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, snmpControl=snmpControl, remoteMACAddress=remoteMACAddress, nTPServerIp=nTPServerIp, ntp=ntp, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityAccess=sNMPCommunityAccess, licenceGroup=licenceGroup, cambium=cambium, ptpCompliance=ptpCompliance, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, smtp=smtp, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, linkStatusTrap=linkStatusTrap, receivePower=receivePower, vlanTagging=vlanTagging, ntpGroup=ntpGroup, regionCode=regionCode, currentFreqMHz=currentFreqMHz, ptp=ptp, bootVersion=bootVersion, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPAddress=iPAddress, linkLoss=linkLoss, ptpTraps=ptpTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPSync=nTPSync, systemClock=systemClock, vlanId=vlanId, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dualPayload=dualPayload, receiveModulationMode=receiveModulationMode, ethernet=ethernet, radarDetectChannel=radarDetectChannel, transmitPower=transmitPower, siteName=siteName, subnetMask=subnetMask, tFTPServerIPAddress=tFTPServerIPAddress, alarms=alarms, configuredModulationMode=configuredModulationMode, managementGroup=managementGroup, noiseFloor=noiseFloor, pubStats=pubStats, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, nTPState=nTPState, transmitModulationMode=transmitModulationMode, nTPLastSync=nTPLastSync, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp250=ptp250, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, sNMPCommunityOid=sNMPCommunityOid, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versions=versions, phyStatusGroup=phyStatusGroup, extendedChannel=extendedChannel, sNMPTrapVersion=sNMPTrapVersion, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, configuredRange=configuredRange, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, management=management, maximumTransmitPower=maximumTransmitPower, configurationGroup=configurationGroup, currentChannel=currentChannel, channelBandwidth=channelBandwidth, ptmp=ptmp, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, antennaGain=antennaGain, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, dataPortStatus=dataPortStatus, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, nTPServerPortNumber=nTPServerPortNumber, band=band, PYSNMP_MODULE_ID=cambium, productName=productName, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
