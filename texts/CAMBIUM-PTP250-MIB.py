...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpGroups=ptpGroups, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, noiseFloor=noiseFloor, radarDetectChannel=radarDetectChannel, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, regionCode=regionCode, vectorError=vectorError, vlanId=vlanId, ntpGroup=ntpGroup, nTPServerPortNumber=nTPServerPortNumber, management=management, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapIPAddress=sNMPTrapIPAddress, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, configuration=configuration, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, siteName=siteName, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, nTPSync=nTPSync, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, linkName=linkName, ntp=ntp, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, softwareVersion=softwareVersion, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, remoteMACAddress=remoteMACAddress, band=band, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, licence=licence, vlanPriority=vlanPriority, nTPLastSync=nTPLastSync, ptpCompliance=ptpCompliance, hardwareVersion=hardwareVersion, measuredRange=measuredRange, systemClock=systemClock, configuredRange=configuredRange, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, timeZone=timeZone, vlanTagging=vlanTagging, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, PYSNMP_MODULE_ID=cambium, alarms=alarms, nTPServerIp=nTPServerIp, currentChannel=currentChannel, nTPState=nTPState, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, configuredModulationMode=configuredModulationMode, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, versions=versions, channelSelection=channelSelection, pubStats=pubStats, managementGroup=managementGroup, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productVariant=productVariant, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, currentFreqMHz=currentFreqMHz, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, dualPayload=dualPayload, configurationGroup=configurationGroup, snmpControl=snmpControl, sNMPCommunityTable=sNMPCommunityTable, phyStatusGroup=phyStatusGroup, installArmState=installArmState, iPAddress=iPAddress, fixedModMode=fixedModMode, installArmStateTrap=installArmStateTrap)
