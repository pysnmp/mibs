...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", management=management, ptp=ptp, licence=licence, notificationsGroup=notificationsGroup, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernetGroup=ethernetGroup, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, versions=versions, ntp=ntp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, currentChannel=currentChannel, fixedModMode=fixedModMode, maximumTransmitPower=maximumTransmitPower, linkName=linkName, managementGroup=managementGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedChannel=extendedChannel, band=band, transmitPower=transmitPower, linkLoss=linkLoss, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectChannel=radarDetectChannel, receiveDataRate=receiveDataRate, nTPPollInterval=nTPPollInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentFreqMHz=currentFreqMHz, pubStatsGroup=pubStatsGroup, productVariant=productVariant, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, nTPServerPortNumber=nTPServerPortNumber, ptpGroups=ptpGroups, vlanPriority=vlanPriority, phyStatus=phyStatus, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, remoteMACAddress=remoteMACAddress, cambium=cambium, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, productName=productName, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, systemClock=systemClock, configuredModulationMode=configuredModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, subnetMask=subnetMask, channelSelection=channelSelection, installArmStateTrap=installArmStateTrap, siteName=siteName, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, alarms=alarms, ntpGroup=ntpGroup, dataPortStatusTrap=dataPortStatusTrap, noiseFloor=noiseFloor, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, sNMPCommunityOid=sNMPCommunityOid, iPAddress=iPAddress, regionCode=regionCode, channelBandwidth=channelBandwidth, dataPortStatus=dataPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, nTPSync=nTPSync, ptmp=ptmp, configuredRange=configuredRange, configuration=configuration, vlanTagging=vlanTagging, versionsGroup=versionsGroup, licenceGroup=licenceGroup, ptpTraps=ptpTraps, installArmState=installArmState, dualPayload=dualPayload, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, measuredRange=measuredRange, linkStatusTrap=linkStatusTrap, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, configurationGroup=configurationGroup, vlanId=vlanId, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTable=sNMPCommunityTable, ptp250=ptp250, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, nTPState=nTPState, radarDetectTrap=radarDetectTrap, tFTPServerIPAddress=tFTPServerIPAddress, nTPLastSync=nTPLastSync, transmitModulationMode=transmitModulationMode)
