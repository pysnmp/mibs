...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerIp=nTPServerIp, ptpGroups=ptpGroups, configuredModulationMode=configuredModulationMode, radarDetectChannel=radarDetectChannel, licenceGroup=licenceGroup, vectorError=vectorError, linkStatusTrap=linkStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuredRange=configuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, linkLoss=linkLoss, vlanPriority=vlanPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, transmitPower=transmitPower, extendedFreqMHz=extendedFreqMHz, alarms=alarms, currentFreqMHz=currentFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPPollInterval=nTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, configuration=configuration, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, dualPayload=dualPayload, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, noiseFloor=noiseFloor, ptpTraps=ptpTraps, sNMPCommunityTable=sNMPCommunityTable, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, alarmsGroup=alarmsGroup, gatewayIPAddress=gatewayIPAddress, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPSync=nTPSync, sNMPTrapTable=sNMPTrapTable, productName=productName, linkName=linkName, siteName=siteName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, cableLoss=cableLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, subnetMask=subnetMask, ethernetGroup=ethernetGroup, nTPLastSync=nTPLastSync, ptp250=ptp250, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, extendedChannel=extendedChannel, ptpTrapPrefix=ptpTrapPrefix, installArmState=installArmState, searchState=searchState, nTPState=nTPState, radarDetectTrap=radarDetectTrap, receivePower=receivePower, channelSelection=channelSelection, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, measuredRange=measuredRange, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, masterSlaveMode=masterSlaveMode, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, systemClock=systemClock, pubStats=pubStats, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, nTPServerPortNumber=nTPServerPortNumber, versions=versions, band=band, PYSNMP_MODULE_ID=cambium, hardwareVersion=hardwareVersion, dataPortStatus=dataPortStatus, fixedModMode=fixedModMode, receiveDataRate=receiveDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, regionCode=regionCode, installArmStateTrap=installArmStateTrap, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, ptmp=ptmp, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanTagging=vlanTagging, management=management, sNMPTrapCommunity=sNMPTrapCommunity, currentChannel=currentChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, licence=licence, vlanId=vlanId, ptpCompliance=ptpCompliance, iPAddress=iPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, ntpGroup=ntpGroup, ntp=ntp, cambium=cambium, ptp=ptp, ethernet=ethernet, sNMPCommunityAccess=sNMPCommunityAccess, bootVersion=bootVersion)
