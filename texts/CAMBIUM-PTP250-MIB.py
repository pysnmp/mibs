...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, dualPayload=dualPayload, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, ntp=ntp, productVariant=productVariant, gatewayIPAddress=gatewayIPAddress, band=band, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, transmitDataRate=transmitDataRate, linkName=linkName, smtp=smtp, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, siteName=siteName, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityOid=sNMPCommunityOid, linkStatusTrap=linkStatusTrap, measuredRange=measuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, phyStatus=phyStatus, timeZone=timeZone, radarDetectTrap=radarDetectTrap, phyStatusGroup=phyStatusGroup, configuredModulationMode=configuredModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, remoteMACAddress=remoteMACAddress, vlanId=vlanId, vlanPriority=vlanPriority, ptp250=ptp250, ptpTraps=ptpTraps, sNMPCommunityTable=sNMPCommunityTable, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, productName=productName, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPServerIp=nTPServerIp, cambium=cambium, ptmp=ptmp, ethernet=ethernet, radarDetectChannel=radarDetectChannel, masterSlaveMode=masterSlaveMode, versions=versions, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, alarmsGroup=alarmsGroup, softwareVersion=softwareVersion, managementGroup=managementGroup, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, bootVersion=bootVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, noiseFloor=noiseFloor, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, extendedFreqMHz=extendedFreqMHz, fixedModMode=fixedModMode, nTPState=nTPState, nTPLastSync=nTPLastSync, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, licence=licence, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, extendedChannel=extendedChannel, snmpControlGroup=snmpControlGroup, vlanTagging=vlanTagging, vectorError=vectorError, currentChannel=currentChannel, channelSelection=channelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerPortNumber=nTPServerPortNumber, pubStats=pubStats, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, ntpGroup=ntpGroup, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, searchState=searchState, remoteIPAddress=remoteIPAddress, iPAddress=iPAddress, configuredRange=configuredRange, aggregateDataRate=aggregateDataRate, currentFreqMHz=currentFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, licenceGroup=licenceGroup)
