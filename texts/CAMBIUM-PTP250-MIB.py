...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelBandwidth=channelBandwidth, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, extendedChannel=extendedChannel, phyStatus=phyStatus, fixedModMode=fixedModMode, versionsGroup=versionsGroup, antennaGain=antennaGain, sNMPCommunityTable=sNMPCommunityTable, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, ntp=ntp, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, maximumTransmitPower=maximumTransmitPower, extendedFreqMHz=extendedFreqMHz, systemClock=systemClock, sNMPCommunityTableNumber=sNMPCommunityTableNumber, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, alarms=alarms, nTPSync=nTPSync, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, licenceGroup=licenceGroup, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, vlanPriority=vlanPriority, pubStats=pubStats, currentFreqMHz=currentFreqMHz, ntpGroup=ntpGroup, smtp=smtp, installArmState=installArmState, sNMPCommunityOid=sNMPCommunityOid, nTPLastSync=nTPLastSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, vlanId=vlanId, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, configuredModulationMode=configuredModulationMode, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanTagging=vlanTagging, licence=licence, nTPServerIp=nTPServerIp, productName=productName, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, measuredRange=measuredRange, ptpTraps=ptpTraps, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, ptp250=ptp250, linkStatusTrap=linkStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, dualPayload=dualPayload, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, nTPState=nTPState, ptpTrapPrefix=ptpTrapPrefix, versions=versions, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, currentChannel=currentChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, iPAddress=iPAddress, sNMPTrapCommunity=sNMPTrapCommunity, receiveModulationMode=receiveModulationMode, searchState=searchState, configurationGroup=configurationGroup, bootVersion=bootVersion, smtpGroup=smtpGroup, band=band, receivePower=receivePower, nTPPollInterval=nTPPollInterval, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, channelSelection=channelSelection, ptpGroups=ptpGroups, siteName=siteName, noiseFloor=noiseFloor, radarDetectTrap=radarDetectTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vectorError=vectorError, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, cableLoss=cableLoss, alarmsGroup=alarmsGroup, configuredRange=configuredRange, management=management, linkName=linkName, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, sNMPTrapTable=sNMPTrapTable)
