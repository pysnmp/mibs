...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerIp=nTPServerIp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, phyStatus=phyStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitPower=transmitPower, sNMPCommunityTable=sNMPCommunityTable, dataPortStatusTrap=dataPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, regionCode=regionCode, remoteIPAddress=remoteIPAddress, nTPState=nTPState, sNMPCommunityAccess=sNMPCommunityAccess, ethernetGroup=ethernetGroup, ptp250=ptp250, productVariant=productVariant, versionsGroup=versionsGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, cambium=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vlanPriority=vlanPriority, versions=versions, sNMPTrapVersion=sNMPTrapVersion, notificationsGroup=notificationsGroup, configuredRange=configuredRange, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectTrap=radarDetectTrap, searchState=searchState, masterSlaveMode=masterSlaveMode, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, smtpGroup=smtpGroup, ntp=ntp, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityOid=sNMPCommunityOid, nTPSync=nTPSync, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkLoss=linkLoss, vectorError=vectorError, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, ptmp=ptmp, bootVersion=bootVersion, ptpCompliance=ptpCompliance, aggregateDataRate=aggregateDataRate, ethernet=ethernet, ptpTraps=ptpTraps, configuration=configuration, currentChannel=currentChannel, channelSelection=channelSelection, channelBandwidth=channelBandwidth, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, hardwareVersion=hardwareVersion, snmpControl=snmpControl, systemClock=systemClock, band=band, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, dualPayload=dualPayload, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, fixedModMode=fixedModMode, managementGroup=managementGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, ntpGroup=ntpGroup, alarmsGroup=alarmsGroup, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, measuredRange=measuredRange, ptpGroups=ptpGroups, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, pubStatsGroup=pubStatsGroup, linkName=linkName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanId=vlanId, smtp=smtp, alarms=alarms, nTPLastSync=nTPLastSync, installArmStateTrap=installArmStateTrap, productName=productName, installArmState=installArmState, antennaGain=antennaGain, extendedChannel=extendedChannel, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, sNMPCommunityString=sNMPCommunityString, linkStatusTrap=linkStatusTrap, extendedFreqMHz=extendedFreqMHz, pubStats=pubStats, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, management=management, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noiseFloor=noiseFloor, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup)
