...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, ntp=ntp, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, nTPSync=nTPSync, remoteMACAddress=remoteMACAddress, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, transmitDataRate=transmitDataRate, vectorError=vectorError, pubStats=pubStats, configurationGroup=configurationGroup, vlanPriority=vlanPriority, ptpGroups=ptpGroups, cambium=cambium, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, ptpTraps=ptpTraps, configuredModulationMode=configuredModulationMode, systemClock=systemClock, dataPortStatus=dataPortStatus, installArmState=installArmState, nTPState=nTPState, measuredRange=measuredRange, currentChannel=currentChannel, timeZone=timeZone, channelSelection=channelSelection, smtpGroup=smtpGroup, ptp=ptp, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, ptp250=ptp250, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, nTPServerIp=nTPServerIp, radarDetectTrap=radarDetectTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkLoss=linkLoss, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, management=management, licence=licence, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, versions=versions, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, radarDetectChannel=radarDetectChannel, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, snmpControl=snmpControl, sNMPEnabledTraps=sNMPEnabledTraps, iPAddress=iPAddress, phyStatus=phyStatus, ntpGroup=ntpGroup, regionCode=regionCode, vlanTagging=vlanTagging, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPPollInterval=nTPPollInterval, versionsGroup=versionsGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPLastSync=nTPLastSync, dataPortStatusTrap=dataPortStatusTrap, subnetMask=subnetMask, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant, noiseFloor=noiseFloor, extendedChannel=extendedChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, sNMPCommunityTable=sNMPCommunityTable, maximumTransmitPower=maximumTransmitPower, fixedModMode=fixedModMode, ptmp=ptmp, band=band, searchState=searchState, configuredRange=configuredRange, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitModulationMode=transmitModulationMode, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, linkStatusTrap=linkStatusTrap, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, dualPayload=dualPayload, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, ethernetGroup=ethernetGroup, linkName=linkName, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpCompliance=ptpCompliance, remoteIPAddress=remoteIPAddress, currentFreqMHz=currentFreqMHz, vlanId=vlanId, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, alarmsGroup=alarmsGroup, smtp=smtp, noWirelessChannelAvailable=noWirelessChannelAvailable, aggregateDataRate=aggregateDataRate)
