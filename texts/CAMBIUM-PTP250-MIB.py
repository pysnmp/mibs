...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelSelection=channelSelection, cambium=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPServerIp=nTPServerIp, remoteIPAddress=remoteIPAddress, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityAccess=sNMPCommunityAccess, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, nTPPollInterval=nTPPollInterval, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vlanId=vlanId, pubStats=pubStats, systemClock=systemClock, ptpCompliance=ptpCompliance, vlanPriority=vlanPriority, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dualPayload=dualPayload, transmitDataRate=transmitDataRate, receivePower=receivePower, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, remoteMACAddress=remoteMACAddress, ntp=ntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, noiseFloor=noiseFloor, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, nTPServerPortNumber=nTPServerPortNumber, phyStatusGroup=phyStatusGroup, ntpGroup=ntpGroup, linkName=linkName, snmpControl=snmpControl, ptp250=ptp250, dataPortAutoNegotiation=dataPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, licence=licence, configuration=configuration, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, linkStatusTrap=linkStatusTrap, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, siteName=siteName, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, extendedChannel=extendedChannel, vlanTagging=vlanTagging, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPSync=nTPSync, currentChannel=currentChannel, phyStatus=phyStatus, regionCode=regionCode, smtpGroup=smtpGroup, channelBandwidth=channelBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, transmitPower=transmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, nTPLastSync=nTPLastSync, sMTPServerIPAddress=sMTPServerIPAddress, radarDetectChannel=radarDetectChannel, sNMPEnabledTraps=sNMPEnabledTraps, measuredRange=measuredRange, ethernet=ethernet, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, currentFreqMHz=currentFreqMHz, management=management, timeZone=timeZone, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEnabledMessages=sMTPEnabledMessages, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, ptp=ptp, productVariant=productVariant, iPAddress=iPAddress, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, band=band, hardwareVersion=hardwareVersion, configuredRange=configuredRange, configuredModulationMode=configuredModulationMode, nTPState=nTPState, sNMPCommunityTable=sNMPCommunityTable, installArmState=installArmState, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, ptmp=ptmp, ptpGroups=ptpGroups, productName=productName, fixedModMode=fixedModMode, sNMPTrapCommunity=sNMPTrapCommunity, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, versions=versions)
