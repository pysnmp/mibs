...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, measuredRange=measuredRange, dataPortAutoNegotiation=dataPortAutoNegotiation, bootVersion=bootVersion, ethernetGroup=ethernetGroup, channelSelection=channelSelection, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanPriority=vlanPriority, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkName=linkName, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPLastSync=nTPLastSync, fixedModMode=fixedModMode, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, versions=versions, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, ptmp=ptmp, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, configuredModulationMode=configuredModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp250=ptp250, configuredRange=configuredRange, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, nTPState=nTPState, nTPServerIp=nTPServerIp, ethernet=ethernet, radarDetectTrap=radarDetectTrap, transmitDataRate=transmitDataRate, installArmState=installArmState, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, licenceGroup=licenceGroup, linkStatusTrap=linkStatusTrap, radarDetectChannel=radarDetectChannel, regionCode=regionCode, antennaGain=antennaGain, productVariant=productVariant, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, transmitPower=transmitPower, nTPPollInterval=nTPPollInterval, currentChannel=currentChannel, dualPayload=dualPayload, phyStatusGroup=phyStatusGroup, band=band, ntp=ntp, ptp=ptp, management=management, timeZone=timeZone, transmitModulationMode=transmitModulationMode, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, productName=productName, vlanId=vlanId, extendedChannel=extendedChannel, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, versionsGroup=versionsGroup, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, searchState=searchState, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, licence=licence, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, sNMPCommunityString=sNMPCommunityString, cambium=cambium, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntpGroup=ntpGroup, iPAddress=iPAddress, receivePower=receivePower, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, vlanTagging=vlanTagging, cableLoss=cableLoss, managementGroup=managementGroup, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, extendedFreqMHz=extendedFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuration=configuration, siteName=siteName, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
