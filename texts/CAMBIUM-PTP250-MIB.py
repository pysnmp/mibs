...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", noiseFloor=noiseFloor, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, snmpControlGroup=snmpControlGroup, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, ntpGroup=ntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, ptmp=ptmp, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, installArmState=installArmState, ptp250=ptp250, ethernet=ethernet, vlanId=vlanId, receiveDataRate=receiveDataRate, sNMPCommunityTable=sNMPCommunityTable, alarmsGroup=alarmsGroup, radarDetectChannel=radarDetectChannel, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, currentChannel=currentChannel, vlanTagging=vlanTagging, extendedChannel=extendedChannel, nTPSync=nTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityAccess=sNMPCommunityAccess, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, sNMPTrapCommunity=sNMPTrapCommunity, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, radarDetectTrap=radarDetectTrap, currentFreqMHz=currentFreqMHz, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, snmpControl=snmpControl, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, management=management, productName=productName, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationGroup=configurationGroup, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, extendedFreqMHz=extendedFreqMHz, phyStatus=phyStatus, nTPPollInterval=nTPPollInterval, transmitDataRate=transmitDataRate, smtp=smtp, noWirelessChannelAvailable=noWirelessChannelAvailable, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPState=nTPState, versions=versions, nTPLastSync=nTPLastSync, configuration=configuration, measuredRange=measuredRange, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vlanPriority=vlanPriority, cambium=cambium, receivePower=receivePower, channelBandwidth=channelBandwidth, sNMPCommunityTableIndex=sNMPCommunityTableIndex, softwareVersion=softwareVersion, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTraps=ptpTraps, configuredModulationMode=configuredModulationMode, transmitPower=transmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, searchState=searchState, siteName=siteName, sNMPTrapTable=sNMPTrapTable, dualPayload=dualPayload, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, linkName=linkName, fixedModMode=fixedModMode, productVariant=productVariant, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, band=band, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, linkStatusTrap=linkStatusTrap, ntp=ntp, linkLoss=linkLoss, pubStats=pubStats)
