...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ntpGroup=ntpGroup, productName=productName, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, installArmState=installArmState, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTable=sNMPCommunityTable, nTPState=nTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp=ptp, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, noiseFloor=noiseFloor, linkStatusTrap=linkStatusTrap, nTPSync=nTPSync, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, smtp=smtp, management=management, ntp=ntp, extendedFreqMHz=extendedFreqMHz, ethernetGroup=ethernetGroup, hardwareVersion=hardwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, remoteIPAddress=remoteIPAddress, channelSelection=channelSelection, radarDetectChannel=radarDetectChannel, regionCode=regionCode, vectorError=vectorError, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControlGroup=snmpControlGroup, currentFreqMHz=currentFreqMHz, configuration=configuration, sMTPServerPortNumber=sMTPServerPortNumber, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, remoteMACAddress=remoteMACAddress, masterSlaveMode=masterSlaveMode, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, measuredRange=measuredRange, band=band, extendedChannel=extendedChannel, pubStatsGroup=pubStatsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, antennaGain=antennaGain, gatewayIPAddress=gatewayIPAddress, sNMPCommunityOid=sNMPCommunityOid, configuredRange=configuredRange, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, radarDetectTrap=radarDetectTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapCommunity=sNMPTrapCommunity, vlanTagging=vlanTagging, snmpControl=snmpControl, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, configuredModulationMode=configuredModulationMode, currentChannel=currentChannel, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, sNMPTrapTableNumber=sNMPTrapTableNumber, managementGroup=managementGroup, ptpTraps=ptpTraps, versions=versions, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, phyStatus=phyStatus, sMTPServerIPAddress=sMTPServerIPAddress, vlanPriority=vlanPriority, bootVersion=bootVersion, cableLoss=cableLoss, dualPayload=dualPayload, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerPortNumber=nTPServerPortNumber, alarms=alarms, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, nTPPollInterval=nTPPollInterval, cambium=cambium, linkLoss=linkLoss, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, searchState=searchState, ptpTrapPrefix=ptpTrapPrefix, vlanId=vlanId, sNMPCommunityTableNumber=sNMPCommunityTableNumber, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, ptpGroups=ptpGroups, subnetMask=subnetMask, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, nTPServerIp=nTPServerIp, sNMPCommunityAccess=sNMPCommunityAccess, receiveDataRate=receiveDataRate, ptp250=ptp250, transmitDataRate=transmitDataRate)
