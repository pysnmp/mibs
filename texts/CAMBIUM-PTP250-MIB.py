...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noiseFloor=noiseFloor, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, fixedModMode=fixedModMode, transmitDataRate=transmitDataRate, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, vlanTagging=vlanTagging, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, band=band, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedChannel=extendedChannel, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuration=configuration, receiveDataRate=receiveDataRate, ntp=ntp, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, sNMPTrapCommunity=sNMPTrapCommunity, ethernetGroup=ethernetGroup, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, sMTPEnabledMessages=sMTPEnabledMessages, management=management, channelSelection=channelSelection, currentChannel=currentChannel, measuredRange=measuredRange, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, configuredRange=configuredRange, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, aggregateDataRate=aggregateDataRate, siteName=siteName, cambium=cambium, nTPState=nTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, regionCode=regionCode, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, dataPortStatus=dataPortStatus, subnetMask=subnetMask, nTPLastSync=nTPLastSync, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, nTPSync=nTPSync, remoteMACAddress=remoteMACAddress, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, versions=versions, currentFreqMHz=currentFreqMHz, licence=licence, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernet=ethernet, smtp=smtp, pubStatsGroup=pubStatsGroup, sNMPCommunityTable=sNMPCommunityTable, installArmStateTrap=installArmStateTrap, ptp250=ptp250, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, maximumTransmitPower=maximumTransmitPower, configurationGroup=configurationGroup, timeZone=timeZone, linkLoss=linkLoss, sNMPCommunityTableEntry=sNMPCommunityTableEntry, masterSlaveMode=masterSlaveMode, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, smtpGroup=smtpGroup, radarDetectTrap=radarDetectTrap, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPAddress=iPAddress, ptpTrapPrefix=ptpTrapPrefix, vlanId=vlanId, vlanPriority=vlanPriority, configuredModulationMode=configuredModulationMode, pubStats=pubStats, sNMPCommunityAccess=sNMPCommunityAccess, transmitPower=transmitPower, ptpCompliance=ptpCompliance)
