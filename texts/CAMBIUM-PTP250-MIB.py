...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, vlanPriority=vlanPriority, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, band=band, ptpCompliance=ptpCompliance, signalStrengthRatio=signalStrengthRatio, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, ethernetGroup=ethernetGroup, vlanTagging=vlanTagging, iPAddress=iPAddress, cableLoss=cableLoss, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, productName=productName, remoteMACAddress=remoteMACAddress, extendedChannel=extendedChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitModulationMode=transmitModulationMode, radarDetectChannel=radarDetectChannel, phyStatusGroup=phyStatusGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtp=smtp, channelSelection=channelSelection, productVariant=productVariant, nTPServerIp=nTPServerIp, configuredModulationMode=configuredModulationMode, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, ptpGroups=ptpGroups, licence=licence, phyStatus=phyStatus, configuredRange=configuredRange, versions=versions, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, alarms=alarms, vlanId=vlanId, remoteIPAddress=remoteIPAddress, ntpGroup=ntpGroup, ptp=ptp, sNMPTrapVersion=sNMPTrapVersion, snmpControlGroup=snmpControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityOid=sNMPCommunityOid, hardwareVersion=hardwareVersion, nTPLastSync=nTPLastSync, measuredRange=measuredRange, siteName=siteName, nTPState=nTPState, ethernet=ethernet, nTPPollInterval=nTPPollInterval, noiseFloor=noiseFloor, ptp250=ptp250, sMTPEnabledMessages=sMTPEnabledMessages, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, linkLoss=linkLoss, transmitDataRate=transmitDataRate, vectorError=vectorError, extendedFreqMHz=extendedFreqMHz, antennaGain=antennaGain, radarDetectTrap=radarDetectTrap, receiveDataRate=receiveDataRate, currentFreqMHz=currentFreqMHz, ntp=ntp, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, nTPServerPortNumber=nTPServerPortNumber, snmpControl=snmpControl, currentChannel=currentChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, nTPSync=nTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, installArmState=installArmState, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, sNMPTrapPortNumber=sNMPTrapPortNumber, timeZone=timeZone, licenceGroup=licenceGroup, linkStatusTrap=linkStatusTrap, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementGroup=managementGroup, masterSlaveMode=masterSlaveMode)
