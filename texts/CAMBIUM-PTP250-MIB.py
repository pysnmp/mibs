...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, sNMPEnabledTraps=sNMPEnabledTraps, signalStrengthRatio=signalStrengthRatio, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpCompliance=ptpCompliance, alarms=alarms, versions=versions, cableLoss=cableLoss, ethernetGroup=ethernetGroup, dataPortStatusTrap=dataPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, ntp=ntp, band=band, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, smtp=smtp, fixedModMode=fixedModMode, gatewayIPAddress=gatewayIPAddress, vlanPriority=vlanPriority, hardwareVersion=hardwareVersion, pubStats=pubStats, nTPServerPortNumber=nTPServerPortNumber, nTPLastSync=nTPLastSync, ntpGroup=ntpGroup, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapCommunity=sNMPTrapCommunity, radarDetectTrap=radarDetectTrap, phyStatus=phyStatus, nTPPollInterval=nTPPollInterval, smtpGroup=smtpGroup, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, noiseFloor=noiseFloor, notificationsGroup=notificationsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmState=installArmState, sNMPCommunityOid=sNMPCommunityOid, regionCode=regionCode, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging, vlanId=vlanId, ptp=ptp, licence=licence, ptp250=ptp250, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, currentChannel=currentChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, timeZone=timeZone, measuredRange=measuredRange, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, systemClock=systemClock, management=management, masterSlaveMode=masterSlaveMode, siteName=siteName, transmitPower=transmitPower, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, configurationGroup=configurationGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernet=ethernet, channelBandwidth=channelBandwidth, snmpControl=snmpControl, configuredRange=configuredRange, productName=productName, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, productVariant=productVariant, PYSNMP_MODULE_ID=cambium, nTPServerIp=nTPServerIp, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dualPayload=dualPayload, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, ptmp=ptmp, channelSelection=channelSelection, radarDetectChannel=radarDetectChannel, nTPState=nTPState, remoteMACAddress=remoteMACAddress, sNMPCommunityTable=sNMPCommunityTable, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPSync=nTPSync, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, remoteIPAddress=remoteIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, linkName=linkName)
