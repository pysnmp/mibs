...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPSync=nTPSync, remoteIPAddress=remoteIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, maximumTransmitPower=maximumTransmitPower, vectorError=vectorError, snmpControl=snmpControl, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, productName=productName, versionsGroup=versionsGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanTagging=vlanTagging, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, noiseFloor=noiseFloor, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, radarDetectChannel=radarDetectChannel, notificationsGroup=notificationsGroup, channelSelection=channelSelection, nTPServerIp=nTPServerIp, ptpTraps=ptpTraps, linkLoss=linkLoss, siteName=siteName, sMTPEnabledMessages=sMTPEnabledMessages, extendedFreqMHz=extendedFreqMHz, ntpGroup=ntpGroup, searchState=searchState, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, vlanId=vlanId, smtpGroup=smtpGroup, dualPayload=dualPayload, alarmsGroup=alarmsGroup, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, configuration=configuration, aggregateDataRate=aggregateDataRate, productVariant=productVariant, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPAddress=iPAddress, timeZone=timeZone, management=management, antennaGain=antennaGain, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControlGroup=snmpControlGroup, installArmState=installArmState, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, ethernet=ethernet, nTPPollInterval=nTPPollInterval, currentFreqMHz=currentFreqMHz, dataPortStatus=dataPortStatus, extendedChannel=extendedChannel, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, ntp=ntp, nTPState=nTPState, PYSNMP_MODULE_ID=cambium, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp250=ptp250, band=band, configuredRange=configuredRange, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, sNMPCommunityTable=sNMPCommunityTable, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, radarDetectTrap=radarDetectTrap, smtp=smtp, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, fixedModMode=fixedModMode, ptpCompliance=ptpCompliance, receivePower=receivePower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, phyStatus=phyStatus, currentChannel=currentChannel, masterSlaveMode=masterSlaveMode, nTPLastSync=nTPLastSync, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredModulationMode=configuredModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityOid=sNMPCommunityOid, versions=versions, ethernetGroup=ethernetGroup, linkName=linkName, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanPriority=vlanPriority, ptp=ptp, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, alarms=alarms, remoteMACAddress=remoteMACAddress, bootVersion=bootVersion)
