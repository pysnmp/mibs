...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatus=phyStatus, timeZone=timeZone, dataPortStatus=dataPortStatus, aggregateDataRate=aggregateDataRate, ptp250=ptp250, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableEntry=sNMPCommunityTableEntry, installArmState=installArmState, channelSelection=channelSelection, ethernet=ethernet, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, productName=productName, vlanPriority=vlanPriority, masterSlaveMode=masterSlaveMode, sMTPServerPortNumber=sMTPServerPortNumber, nTPServerIp=nTPServerIp, sNMPTrapTableNumber=sNMPTrapTableNumber, fixedModMode=fixedModMode, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, ntp=ntp, configuration=configuration, hardwareVersion=hardwareVersion, nTPState=nTPState, band=band, sNMPCommunityTable=sNMPCommunityTable, searchState=searchState, linkStatusTrap=linkStatusTrap, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, currentChannel=currentChannel, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, ptp=ptp, PYSNMP_MODULE_ID=cambium, siteName=siteName, sNMPCommunityString=sNMPCommunityString, linkName=linkName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, currentFreqMHz=currentFreqMHz, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, radarDetectChannel=radarDetectChannel, bootVersion=bootVersion, nTPServerPortNumber=nTPServerPortNumber, configuredRange=configuredRange, noiseFloor=noiseFloor, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityAccess=sNMPCommunityAccess, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, ptmp=ptmp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, systemClock=systemClock, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityOid=sNMPCommunityOid, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanId=vlanId, tFTPServerPortNumber=tFTPServerPortNumber, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, transmitDataRate=transmitDataRate, nTPPollInterval=nTPPollInterval, nTPSync=nTPSync, nTPLastSync=nTPLastSync, dualPayload=dualPayload, smtp=smtp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, snmpControl=snmpControl, licence=licence, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, radarDetectTrap=radarDetectTrap, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, cambium=cambium, management=management, phyStatusGroup=phyStatusGroup, configuredModulationMode=configuredModulationMode, linkLoss=linkLoss, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, ethernetGroup=ethernetGroup, vlanTagging=vlanTagging, alarms=alarms, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, measuredRange=measuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup)
