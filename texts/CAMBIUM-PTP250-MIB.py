...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPState=nTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, snmpControl=snmpControl, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, ptp250=ptp250, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, cableLoss=cableLoss, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, currentChannel=currentChannel, regionCode=regionCode, productVariant=productVariant, timeZone=timeZone, alarms=alarms, bootVersion=bootVersion, sNMPCommunityTable=sNMPCommunityTable, linkLoss=linkLoss, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, sNMPTrapTable=sNMPTrapTable, currentFreqMHz=currentFreqMHz, signalStrengthRatio=signalStrengthRatio, management=management, configuredModulationMode=configuredModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, siteName=siteName, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, remoteMACAddress=remoteMACAddress, productName=productName, extendedChannel=extendedChannel, masterSlaveMode=masterSlaveMode, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, snmpControlGroup=snmpControlGroup, measuredRange=measuredRange, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredRange=configuredRange, sNMPTrapPortNumber=sNMPTrapPortNumber, managementGroup=managementGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPPollInterval=nTPPollInterval, ethernet=ethernet, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, installArmState=installArmState, systemClock=systemClock, sNMPTrapCommunity=sNMPTrapCommunity, pubStatsGroup=pubStatsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, nTPServerIp=nTPServerIp, vlanTagging=vlanTagging, ethernetGroup=ethernetGroup, subnetMask=subnetMask, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, vectorError=vectorError, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, vlanId=vlanId, channelSelection=channelSelection, configurationGroup=configurationGroup, PYSNMP_MODULE_ID=cambium, fixedModMode=fixedModMode, dualPayload=dualPayload, receivePower=receivePower, nTPLastSync=nTPLastSync, radarDetectTrap=radarDetectTrap, tFTPServerIPAddress=tFTPServerIPAddress, alarmsGroup=alarmsGroup, sNMPCommunityOid=sNMPCommunityOid, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, ptp=ptp, ptpGroups=ptpGroups, receiveModulationMode=receiveModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, configuration=configuration, gatewayIPAddress=gatewayIPAddress, nTPSync=nTPSync, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, iPAddress=iPAddress, linkStatusTrap=linkStatusTrap, radarDetectChannel=radarDetectChannel, versions=versions, phyStatusGroup=phyStatusGroup, ntp=ntp, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, searchState=searchState, vlanPriority=vlanPriority, band=band, ntpGroup=ntpGroup, ptpCompliance=ptpCompliance, phyStatus=phyStatus)
