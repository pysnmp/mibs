...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, ntpGroup=ntpGroup, transmitDataRate=transmitDataRate, snmpControl=snmpControl, aggregateDataRate=aggregateDataRate, nTPState=nTPState, sNMPCommunityTableIndex=sNMPCommunityTableIndex, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, configuration=configuration, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, managementGroup=managementGroup, linkName=linkName, phyStatus=phyStatus, vlanPriority=vlanPriority, sNMPCommunityOid=sNMPCommunityOid, currentChannel=currentChannel, nTPServerIp=nTPServerIp, vlanId=vlanId, searchState=searchState, channelSelection=channelSelection, ptpCompliance=ptpCompliance, ntp=ntp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMACAddress=remoteMACAddress, ptp250=ptp250, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, currentFreqMHz=currentFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, band=band, smtp=smtp, measuredRange=measuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, ethernet=ethernet, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, pubStats=pubStats, transmitModulationMode=transmitModulationMode, versions=versions, productName=productName, configuredRange=configuredRange, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuredModulationMode=configuredModulationMode, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, noiseFloor=noiseFloor, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radarDetectChannel=radarDetectChannel, installArmStateTrap=installArmStateTrap, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, extendedFreqMHz=extendedFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, transmitPower=transmitPower, nTPPollInterval=nTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, siteName=siteName, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, configurationGroup=configurationGroup, cambium=cambium, versionsGroup=versionsGroup, extendedChannel=extendedChannel, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, nTPSync=nTPSync, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging, noWirelessChannelAvailable=noWirelessChannelAvailable, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, cableLoss=cableLoss, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, radarDetectTrap=radarDetectTrap, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, receivePower=receivePower, fixedModMode=fixedModMode)
