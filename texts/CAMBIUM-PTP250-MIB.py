...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", PYSNMP_MODULE_ID=cambium, tFTPServerPortNumber=tFTPServerPortNumber, channelSelection=channelSelection, nTPState=nTPState, remoteMACAddress=remoteMACAddress, antennaGain=antennaGain, configuredRange=configuredRange, productName=productName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, fixedModMode=fixedModMode, pubStats=pubStats, vectorError=vectorError, currentFreqMHz=currentFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, alarms=alarms, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, linkLoss=linkLoss, wirelessLinkStatus=wirelessLinkStatus, nTPSync=nTPSync, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableEntry=sNMPTrapTableEntry, notificationsGroup=notificationsGroup, linkStatusTrap=linkStatusTrap, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, currentChannel=currentChannel, dataPortStatusTrap=dataPortStatusTrap, searchState=searchState, radarDetectTrap=radarDetectTrap, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, sNMPTrapTable=sNMPTrapTable, transmitDataRate=transmitDataRate, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, installArmState=installArmState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, extendedChannel=extendedChannel, configuration=configuration, vlanTagging=vlanTagging, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, ptpTraps=ptpTraps, vlanId=vlanId, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, ptp250=ptp250, measuredRange=measuredRange, nTPPollInterval=nTPPollInterval, systemClock=systemClock, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, ethernet=ethernet, ptmp=ptmp, gatewayIPAddress=gatewayIPAddress, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, ntp=ntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCode=regionCode, ethernetGroup=ethernetGroup, management=management, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, timeZone=timeZone, ptpCompliance=ptpCompliance, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStatsGroup=pubStatsGroup, sNMPCommunityTable=sNMPCommunityTable, configuredModulationMode=configuredModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectChannel=radarDetectChannel, remoteIPAddress=remoteIPAddress, siteName=siteName, smtp=smtp, configurationGroup=configurationGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noiseFloor=noiseFloor, dualPayload=dualPayload, bootVersion=bootVersion, dataPortStatus=dataPortStatus, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, sNMPCommunityTableIndex=sNMPCommunityTableIndex, productVariant=productVariant, iPAddress=iPAddress, managementGroup=managementGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanPriority=vlanPriority, ntpGroup=ntpGroup, extendedFreqMHz=extendedFreqMHz, cambium=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, nTPServerIp=nTPServerIp, sNMPTrapVersion=sNMPTrapVersion, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, transmitPower=transmitPower)
