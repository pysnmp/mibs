...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", versions=versions, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, softwareVersion=softwareVersion, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanPriority=vlanPriority, measuredRange=measuredRange, ptpGroups=ptpGroups, sNMPCommunityTable=sNMPCommunityTable, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, nTPSync=nTPSync, maximumTransmitPower=maximumTransmitPower, vlanId=vlanId, iPAddress=iPAddress, installArmState=installArmState, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredRange=configuredRange, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radarDetectTrap=radarDetectTrap, receivePower=receivePower, sNMPTrapCommunity=sNMPTrapCommunity, ptpTraps=ptpTraps, nTPServerIp=nTPServerIp, PYSNMP_MODULE_ID=cambium, receiveModulationMode=receiveModulationMode, alarms=alarms, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, siteName=siteName, searchState=searchState, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, licence=licence, channelSelection=channelSelection, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, radarDetectChannel=radarDetectChannel, management=management, nTPLastSync=nTPLastSync, ptpTrapPrefix=ptpTrapPrefix, ntp=ntp, configuration=configuration, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, masterSlaveMode=masterSlaveMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, subnetMask=subnetMask, dualPayload=dualPayload, versionsGroup=versionsGroup, signalStrengthRatio=signalStrengthRatio, currentChannel=currentChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPServerPortNumber=nTPServerPortNumber, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, installArmStateTrap=installArmStateTrap, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanTagging=vlanTagging, band=band, configuredModulationMode=configuredModulationMode, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, vectorError=vectorError, ptp=ptp, channelBandwidth=channelBandwidth, cambium=cambium, fixedModMode=fixedModMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, regionCode=regionCode, ptmp=ptmp, extendedChannel=extendedChannel, managementGroup=managementGroup, transmitPower=transmitPower, ethernet=ethernet, pubStatsGroup=pubStatsGroup, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, ntpGroup=ntpGroup, snmpControl=snmpControl, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationGroup=configurationGroup, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, remoteMACAddress=remoteMACAddress, phyStatus=phyStatus, sNMPCommunityOid=sNMPCommunityOid, hardwareVersion=hardwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPState=nTPState, phyStatusGroup=phyStatusGroup, noiseFloor=noiseFloor, sNMPEnabledTraps=sNMPEnabledTraps, extendedFreqMHz=extendedFreqMHz, currentFreqMHz=currentFreqMHz)
