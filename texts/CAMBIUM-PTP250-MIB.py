...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPState=nTPState, noiseFloor=noiseFloor, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, ptp=ptp, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, masterSlaveMode=masterSlaveMode, nTPSync=nTPSync, vlanPriority=vlanPriority, bootVersion=bootVersion, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, vlanTagging=vlanTagging, ptp250=ptp250, sNMPCommunityOid=sNMPCommunityOid, radarDetectChannel=radarDetectChannel, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredRange=configuredRange, ntpGroup=ntpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuredModulationMode=configuredModulationMode, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkName=linkName, productVariant=productVariant, channelSelection=channelSelection, extendedFreqMHz=extendedFreqMHz, dualPayload=dualPayload, configurationGroup=configurationGroup, ptmp=ptmp, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpCompliance=ptpCompliance, receivePower=receivePower, licence=licence, sNMPCommunityAccess=sNMPCommunityAccess, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, iPAddress=iPAddress, linkStatusTrap=linkStatusTrap, wirelessLinkStatus=wirelessLinkStatus, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, measuredRange=measuredRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, management=management, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, currentChannel=currentChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMACAddress=remoteMACAddress, timeZone=timeZone, versions=versions, fixedModMode=fixedModMode, licenceGroup=licenceGroup, cambium=cambium, ntp=ntp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectTrap=radarDetectTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTable=sNMPCommunityTable, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, systemClock=systemClock, transmitPower=transmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTraps=ptpTraps, configuration=configuration, dataPortAutoNegotiation=dataPortAutoNegotiation, band=band, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, installArmState=installArmState, cableLoss=cableLoss, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, extendedChannel=extendedChannel, vlanId=vlanId, nTPLastSync=nTPLastSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, alarms=alarms, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, aggregateDataRate=aggregateDataRate, productName=productName, siteName=siteName, managementGroup=managementGroup, nTPServerIp=nTPServerIp, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, currentFreqMHz=currentFreqMHz, nTPPollInterval=nTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError)
