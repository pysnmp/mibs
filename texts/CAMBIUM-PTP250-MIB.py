...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, channelBandwidth=channelBandwidth, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, pubStatsGroup=pubStatsGroup, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernet=ethernet, antennaGain=antennaGain, radarDetectChannel=radarDetectChannel, bootVersion=bootVersion, configurationGroup=configurationGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemClock=systemClock, managementGroup=managementGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, productVariant=productVariant, ntpGroup=ntpGroup, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, vlanPriority=vlanPriority, configuration=configuration, searchState=searchState, notificationsGroup=notificationsGroup, installArmState=installArmState, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, linkName=linkName, transmitModulationMode=transmitModulationMode, vlanId=vlanId, linkStatusTrap=linkStatusTrap, nTPState=nTPState, nTPServerIp=nTPServerIp, currentChannel=currentChannel, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, management=management, nTPServerPortNumber=nTPServerPortNumber, timeZone=timeZone, radarDetectTrap=radarDetectTrap, ptpGroups=ptpGroups, licenceGroup=licenceGroup, sNMPCommunityAccess=sNMPCommunityAccess, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp250=ptp250, PYSNMP_MODULE_ID=cambium, remoteMACAddress=remoteMACAddress, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, fixedModMode=fixedModMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, extendedFreqMHz=extendedFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, measuredRange=measuredRange, band=band, nTPSync=nTPSync, linkLoss=linkLoss, smtp=smtp, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, dualPayload=dualPayload, productName=productName, noiseFloor=noiseFloor, cableLoss=cableLoss, nTPLastSync=nTPLastSync, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStats=pubStats, configuredRange=configuredRange, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, versions=versions, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, configuredModulationMode=configuredModulationMode, snmpControl=snmpControl, siteName=siteName, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, nTPPollInterval=nTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ntp=ntp, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitPower=transmitPower, sNMPCommunityOid=sNMPCommunityOid, channelSelection=channelSelection, alarms=alarms, extendedChannel=extendedChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, cambium=cambium, installArmStateTrap=installArmStateTrap, sNMPCommunityTable=sNMPCommunityTable, ptp=ptp, remoteIPAddress=remoteIPAddress, vlanTagging=vlanTagging, ptpCompliance=ptpCompliance, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress)
