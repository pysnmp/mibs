...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuredModulationMode=configuredModulationMode, sNMPTrapVersion=sNMPTrapVersion, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, nTPSync=nTPSync, masterSlaveMode=masterSlaveMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, fixedModMode=fixedModMode, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, nTPState=nTPState, timeZone=timeZone, currentFreqMHz=currentFreqMHz, ethernetGroup=ethernetGroup, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, nTPPollInterval=nTPPollInterval, licence=licence, sNMPCommunityTable=sNMPCommunityTable, transmitDataRate=transmitDataRate, vlanTagging=vlanTagging, alarmsGroup=alarmsGroup, noiseFloor=noiseFloor, cambium=cambium, notificationsGroup=notificationsGroup, signalStrengthRatio=signalStrengthRatio, siteName=siteName, channelBandwidth=channelBandwidth, vlanId=vlanId, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, iPAddress=iPAddress, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, systemClock=systemClock, remoteIPAddress=remoteIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, managementGroup=managementGroup, sNMPCommunityAccess=sNMPCommunityAccess, ptpGroups=ptpGroups, linkStatusTrap=linkStatusTrap, configuration=configuration, management=management, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, cableLoss=cableLoss, alarms=alarms, currentChannel=currentChannel, productVariant=productVariant, radarDetectChannel=radarDetectChannel, band=band, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPLastSync=nTPLastSync, productName=productName, measuredRange=measuredRange, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, ntpGroup=ntpGroup, installArmState=installArmState, vlanPriority=vlanPriority, ntp=ntp, radarDetectTrap=radarDetectTrap, smtpGroup=smtpGroup, pubStatsGroup=pubStatsGroup, pubStats=pubStats, linkLoss=linkLoss, channelSelection=channelSelection, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, sNMPTrapTable=sNMPTrapTable, ptp250=ptp250, ptp=ptp, remoteMACAddress=remoteMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, regionCode=regionCode, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, searchState=searchState, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, extendedFreqMHz=extendedFreqMHz, configuredRange=configuredRange, tFTPServerIPAddress=tFTPServerIPAddress, extendedChannel=extendedChannel, antennaGain=antennaGain, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, linkName=linkName, phyStatusGroup=phyStatusGroup, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, subnetMask=subnetMask, ethernet=ethernet)
