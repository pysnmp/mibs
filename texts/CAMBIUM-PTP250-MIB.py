...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", searchState=searchState, ptpGroups=ptpGroups, management=management, fixedModMode=fixedModMode, ptpTrapPrefix=ptpTrapPrefix, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, dataPortStatusTrap=dataPortStatusTrap, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, PYSNMP_MODULE_ID=cambium, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, linkName=linkName, subnetMask=subnetMask, sNMPCommunityTableIndex=sNMPCommunityTableIndex, managementGroup=managementGroup, smtpGroup=smtpGroup, masterSlaveMode=masterSlaveMode, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, versions=versions, ntpGroup=ntpGroup, antennaGain=antennaGain, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPState=nTPState, installArmState=installArmState, sNMPCommunityTableNumber=sNMPCommunityTableNumber, regionCode=regionCode, smtp=smtp, vlanPriority=vlanPriority, nTPServerIp=nTPServerIp, ntp=ntp, receiveDataRate=receiveDataRate, linkLoss=linkLoss, ptp=ptp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuration=configuration, extendedFreqMHz=extendedFreqMHz, signalStrengthRatio=signalStrengthRatio, sNMPCommunityAccess=sNMPCommunityAccess, noiseFloor=noiseFloor, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapCommunity=sNMPTrapCommunity, softwareVersion=softwareVersion, band=band, transmitPower=transmitPower, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, measuredRange=measuredRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, vectorError=vectorError, ptmp=ptmp, cableLoss=cableLoss, nTPLastSync=nTPLastSync, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, configuredRange=configuredRange, sNMPCommunityTable=sNMPCommunityTable, currentChannel=currentChannel, versionsGroup=versionsGroup, installArmStateTrap=installArmStateTrap, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, snmpControlGroup=snmpControlGroup, configuredModulationMode=configuredModulationMode, phyStatusGroup=phyStatusGroup, pubStatsGroup=pubStatsGroup, licence=licence, sNMPCommunityOid=sNMPCommunityOid, vlanTagging=vlanTagging, ptpCompliance=ptpCompliance, extendedChannel=extendedChannel, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, radarDetectTrap=radarDetectTrap, siteName=siteName, dualPayload=dualPayload, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPPollInterval=nTPPollInterval, radarDetectChannel=radarDetectChannel, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, ptp250=ptp250, ptpTraps=ptpTraps, iPAddress=iPAddress, nTPSync=nTPSync, channelBandwidth=channelBandwidth, snmpControl=snmpControl, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkStatusTrap=linkStatusTrap, vlanId=vlanId, cambium=cambium, productVariant=productVariant, alarms=alarms, currentFreqMHz=currentFreqMHz, wirelessLinkStatus=wirelessLinkStatus, nTPServerPortNumber=nTPServerPortNumber, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber)
