...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, nTPPollInterval=nTPPollInterval, linkName=linkName, nTPServerPortNumber=nTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, configuredModulationMode=configuredModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, management=management, vlanPriority=vlanPriority, ptpCompliance=ptpCompliance, noiseFloor=noiseFloor, ptpGroups=ptpGroups, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, sNMPTrapTable=sNMPTrapTable, ptp=ptp, masterSlaveMode=masterSlaveMode, ptp250=ptp250, extendedFreqMHz=extendedFreqMHz, sNMPCommunityOid=sNMPCommunityOid, linkStatusTrap=linkStatusTrap, regionCode=regionCode, signalStrengthRatio=signalStrengthRatio, nTPState=nTPState, alarmsGroup=alarmsGroup, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, sNMPTrapVersion=sNMPTrapVersion, nTPLastSync=nTPLastSync, cableLoss=cableLoss, bootVersion=bootVersion, radarDetectTrap=radarDetectTrap, licence=licence, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, notificationsGroup=notificationsGroup, productVariant=productVariant, measuredRange=measuredRange, sNMPCommunityAccess=sNMPCommunityAccess, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, vlanId=vlanId, dataPortStatus=dataPortStatus, alarms=alarms, PYSNMP_MODULE_ID=cambium, ntpGroup=ntpGroup, iPAddress=iPAddress, phyStatus=phyStatus, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, band=band, ptpTrapPrefix=ptpTrapPrefix, snmpControl=snmpControl, installArmStateTrap=installArmStateTrap, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, installArmState=installArmState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, siteName=siteName, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, fixedModMode=fixedModMode, managementGroup=managementGroup, ptmp=ptmp, receivePower=receivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, radarDetectChannel=radarDetectChannel, dualPayload=dualPayload, remoteMACAddress=remoteMACAddress, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, systemClock=systemClock, vlanTagging=vlanTagging, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, ntp=ntp, receiveModulationMode=receiveModulationMode, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, sNMPTrapCommunity=sNMPTrapCommunity, cambium=cambium, extendedChannel=extendedChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuration=configuration, smtp=smtp, softwareVersion=softwareVersion, channelSelection=channelSelection, productName=productName, versions=versions, licenceGroup=licenceGroup, timeZone=timeZone, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPSync=nTPSync, configuredRange=configuredRange, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitDataRate=transmitDataRate, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
