...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityAccess=sNMPCommunityAccess, ptmp=ptmp, vlanPriority=vlanPriority, fixedModMode=fixedModMode, management=management, ptpCompliance=ptpCompliance, cableLoss=cableLoss, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, band=band, remoteMACAddress=remoteMACAddress, linkName=linkName, sNMPCommunityString=sNMPCommunityString, transmitPower=transmitPower, versionsGroup=versionsGroup, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPState=nTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, extendedChannel=extendedChannel, receivePower=receivePower, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, nTPServerIp=nTPServerIp, currentChannel=currentChannel, phyStatusGroup=phyStatusGroup, iPAddress=iPAddress, subnetMask=subnetMask, ntp=ntp, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, timeZone=timeZone, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, configuredRange=configuredRange, regionCode=regionCode, managementGroup=managementGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, configuredModulationMode=configuredModulationMode, searchState=searchState, channelSelection=channelSelection, sMTPServerPortNumber=sMTPServerPortNumber, nTPSync=nTPSync, smtp=smtp, nTPServerPortNumber=nTPServerPortNumber, ntpGroup=ntpGroup, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, ptp250=ptp250, ptpTrapPrefix=ptpTrapPrefix, versions=versions, channelBandwidth=channelBandwidth, dualPayload=dualPayload, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, sNMPTrapTableNumber=sNMPTrapTableNumber, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productName=productName, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, masterSlaveMode=masterSlaveMode, nTPPollInterval=nTPPollInterval, smtpGroup=smtpGroup, phyStatus=phyStatus, licence=licence, wirelessLinkStatus=wirelessLinkStatus, transmitDataRate=transmitDataRate, vlanTagging=vlanTagging, signalStrengthRatio=signalStrengthRatio, radarDetectTrap=radarDetectTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, measuredRange=measuredRange, nTPLastSync=nTPLastSync, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, ptp=ptp, ptpGroups=ptpGroups, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, extendedFreqMHz=extendedFreqMHz, antennaGain=antennaGain, installArmState=installArmState, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkStatusTrap=linkStatusTrap, vectorError=vectorError, configuration=configuration, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, systemClock=systemClock, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex)
