...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, phyStatus=phyStatus, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentFreqMHz=currentFreqMHz, maximumTransmitPower=maximumTransmitPower, receiveDataRate=receiveDataRate, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanTagging=vlanTagging, channelSelection=channelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, systemClock=systemClock, softwareVersion=softwareVersion, alarmsGroup=alarmsGroup, linkStatusTrap=linkStatusTrap, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, vectorError=vectorError, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, siteName=siteName, extendedChannel=extendedChannel, transmitPower=transmitPower, licenceGroup=licenceGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, versionsGroup=versionsGroup, cambium=cambium, extendedFreqMHz=extendedFreqMHz, ptp=ptp, ntp=ntp, configuredRange=configuredRange, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, currentChannel=currentChannel, ethernetGroup=ethernetGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, pubStatsGroup=pubStatsGroup, searchState=searchState, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableIndex=sNMPCommunityTableIndex, management=management, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredModulationMode=configuredModulationMode, nTPState=nTPState, versions=versions, signalStrengthRatio=signalStrengthRatio, smtp=smtp, antennaGain=antennaGain, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, productName=productName, subnetMask=subnetMask, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityOid=sNMPCommunityOid, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, measuredRange=measuredRange, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, nTPServerPortNumber=nTPServerPortNumber, vlanId=vlanId, sNMPEnabledTraps=sNMPEnabledTraps, iPAddress=iPAddress, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, noiseFloor=noiseFloor, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radarDetectChannel=radarDetectChannel, configuration=configuration, licence=licence, timeZone=timeZone, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance, phyStatusGroup=phyStatusGroup, installArmStateTrap=installArmStateTrap, hardwareVersion=hardwareVersion, vlanPriority=vlanPriority, linkName=linkName, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productVariant=productVariant, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, receivePower=receivePower, transmitModulationMode=transmitModulationMode, radarDetectTrap=radarDetectTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPSync=nTPSync, tFTPServerIPAddress=tFTPServerIPAddress, installArmState=installArmState, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, alarms=alarms, remoteMACAddress=remoteMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, fixedModMode=fixedModMode, sMTPServerIPAddress=sMTPServerIPAddress, ptp250=ptp250, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dualPayload=dualPayload, ntpGroup=ntpGroup)
