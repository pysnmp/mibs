...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuredModulationMode=configuredModulationMode, vlanId=vlanId, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, sNMPCommunityTableNumber=sNMPCommunityTableNumber, channelSelection=channelSelection, currentFreqMHz=currentFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitPower=transmitPower, hardwareVersion=hardwareVersion, regionCode=regionCode, ptpCompliance=ptpCompliance, nTPLastSync=nTPLastSync, pubStats=pubStats, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, iPAddress=iPAddress, installArmState=installArmState, sNMPCommunityOid=sNMPCommunityOid, pubStatsGroup=pubStatsGroup, configuredRange=configuredRange, dataPortStatus=dataPortStatus, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, notificationsGroup=notificationsGroup, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTable=sNMPCommunityTable, ptp=ptp, nTPSync=nTPSync, linkLoss=linkLoss, radarDetectTrap=radarDetectTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, sNMPTrapTable=sNMPTrapTable, radarDetectChannel=radarDetectChannel, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, siteName=siteName, timeZone=timeZone, measuredRange=measuredRange, management=management, smtpGroup=smtpGroup, alarms=alarms, cambium=cambium, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, ntpGroup=ntpGroup, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, bootVersion=bootVersion, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, subnetMask=subnetMask, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, cableLoss=cableLoss, vlanTagging=vlanTagging, managementGroup=managementGroup, sNMPCommunityAccess=sNMPCommunityAccess, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, nTPPollInterval=nTPPollInterval, nTPState=nTPState, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableEntry=sNMPCommunityTableEntry, fixedModMode=fixedModMode, linkStatusTrap=linkStatusTrap, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, smtp=smtp, band=band, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, currentChannel=currentChannel, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dualPayload=dualPayload, softwareVersion=softwareVersion, noiseFloor=noiseFloor, systemClock=systemClock, vlanPriority=vlanPriority, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, ethernet=ethernet, phyStatus=phyStatus, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, ntp=ntp)
