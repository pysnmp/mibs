...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", bootVersion=bootVersion, licenceGroup=licenceGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, regionCode=regionCode, transmitModulationMode=transmitModulationMode, cambium=cambium, ptmp=ptmp, masterSlaveMode=masterSlaveMode, aggregateDataRate=aggregateDataRate, fixedModMode=fixedModMode, ethernet=ethernet, snmpControlGroup=snmpControlGroup, linkName=linkName, extendedChannel=extendedChannel, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, receiveDataRate=receiveDataRate, cableLoss=cableLoss, versions=versions, installArmStateTrap=installArmStateTrap, sNMPCommunityOid=sNMPCommunityOid, linkStatusTrap=linkStatusTrap, ptpTraps=ptpTraps, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, ptp250=ptp250, sNMPCommunityAccess=sNMPCommunityAccess, configuredModulationMode=configuredModulationMode, dataPortStatus=dataPortStatus, ntpGroup=ntpGroup, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, vectorError=vectorError, configuration=configuration, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, ethernetGroup=ethernetGroup, systemClock=systemClock, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, radarDetectChannel=radarDetectChannel, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, management=management, currentFreqMHz=currentFreqMHz, sNMPTrapVersion=sNMPTrapVersion, measuredRange=measuredRange, licence=licence, searchState=searchState, nTPState=nTPState, noiseFloor=noiseFloor, radarDetectTrap=radarDetectTrap, pubStats=pubStats, vlanId=vlanId, transmitPower=transmitPower, extendedFreqMHz=extendedFreqMHz, softwareVersion=softwareVersion, band=band, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productName=productName, linkLoss=linkLoss, dualPayload=dualPayload, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, ptpCompliance=ptpCompliance, snmpControl=snmpControl, nTPServerIp=nTPServerIp, phyStatus=phyStatus, hardwareVersion=hardwareVersion, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, vlanPriority=vlanPriority, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, versionsGroup=versionsGroup, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, subnetMask=subnetMask, configuredRange=configuredRange, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, iPAddress=iPAddress, nTPSync=nTPSync, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ntp=ntp, currentChannel=currentChannel, smtp=smtp, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTable=sNMPCommunityTable, PYSNMP_MODULE_ID=cambium)
