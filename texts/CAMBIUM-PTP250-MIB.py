...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerPortNumber=nTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenceGroup=licenceGroup, smtpGroup=smtpGroup, snmpControl=snmpControl, productVariant=productVariant, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, configuredRange=configuredRange, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, smtp=smtp, sNMPCommunityOid=sNMPCommunityOid, aggregateDataRate=aggregateDataRate, vectorError=vectorError, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, currentFreqMHz=currentFreqMHz, fixedModMode=fixedModMode, notificationsGroup=notificationsGroup, channelSelection=channelSelection, cambium=cambium, productName=productName, hardwareVersion=hardwareVersion, configuration=configuration, transmitPower=transmitPower, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, nTPSync=nTPSync, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, measuredRange=measuredRange, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanTagging=vlanTagging, remoteMACAddress=remoteMACAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTable=sNMPTrapTable, currentChannel=currentChannel, noiseFloor=noiseFloor, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, dualPayload=dualPayload, sMTPEnabledMessages=sMTPEnabledMessages, nTPLastSync=nTPLastSync, sNMPCommunityTable=sNMPCommunityTable, alarmsGroup=alarmsGroup, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, linkName=linkName, linkStatusTrap=linkStatusTrap, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, ptpTraps=ptpTraps, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, iPAddress=iPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableLoss=cableLoss, receivePower=receivePower, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, searchState=searchState, pubStatsGroup=pubStatsGroup, maximumTransmitPower=maximumTransmitPower, vlanId=vlanId, radarDetectChannel=radarDetectChannel, nTPServerIp=nTPServerIp, ethernet=ethernet, ptmp=ptmp, regionCode=regionCode, bootVersion=bootVersion, configuredModulationMode=configuredModulationMode, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, ntp=ntp, sNMPTrapCommunity=sNMPTrapCommunity, channelBandwidth=channelBandwidth, ptpCompliance=ptpCompliance, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp250=ptp250, nTPState=nTPState, vlanPriority=vlanPriority, linkLoss=linkLoss, dataPortStatus=dataPortStatus, band=band, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, extendedChannel=extendedChannel, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, subnetMask=subnetMask, licence=licence, wirelessLinkStatus=wirelessLinkStatus, extendedFreqMHz=extendedFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, nTPPollInterval=nTPPollInterval, configurationGroup=configurationGroup, ntpGroup=ntpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityAccess=sNMPCommunityAccess, phyStatusGroup=phyStatusGroup)
