...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkLoss=linkLoss, dualPayload=dualPayload, pubStatsGroup=pubStatsGroup, remoteMACAddress=remoteMACAddress, receiveModulationMode=receiveModulationMode, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedFreqMHz=extendedFreqMHz, configurationGroup=configurationGroup, vlanTagging=vlanTagging, timeZone=timeZone, PYSNMP_MODULE_ID=cambium, licenceGroup=licenceGroup, currentChannel=currentChannel, bootVersion=bootVersion, snmpControl=snmpControl, ptpCompliance=ptpCompliance, nTPSync=nTPSync, versions=versions, softwareVersion=softwareVersion, sNMPCommunityOid=sNMPCommunityOid, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, nTPState=nTPState, channelBandwidth=channelBandwidth, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, linkName=linkName, managementGroup=managementGroup, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, vlanPriority=vlanPriority, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpGroups=ptpGroups, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, management=management, alarmsGroup=alarmsGroup, dataPortStatusTrap=dataPortStatusTrap, measuredRange=measuredRange, band=band, receivePower=receivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPServerIp=nTPServerIp, vectorError=vectorError, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, searchState=searchState, noiseFloor=noiseFloor, radarDetectTrap=radarDetectTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, ptp250=ptp250, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanId=vlanId, masterSlaveMode=masterSlaveMode, channelSelection=channelSelection, versionsGroup=versionsGroup, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, ntpGroup=ntpGroup, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, currentFreqMHz=currentFreqMHz, iPAddress=iPAddress, productName=productName, gatewayIPAddress=gatewayIPAddress, systemClock=systemClock, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, sNMPCommunityTable=sNMPCommunityTable, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, ntp=ntp, fixedModMode=fixedModMode, snmpControlGroup=snmpControlGroup, sNMPTrapCommunity=sNMPTrapCommunity, siteName=siteName, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityString=sNMPCommunityString, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, smtp=smtp, nTPLastSync=nTPLastSync, licence=licence, installArmStateTrap=installArmStateTrap, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, extendedChannel=extendedChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, transmitModulationMode=transmitModulationMode, ethernet=ethernet)
