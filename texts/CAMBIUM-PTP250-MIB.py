...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, sNMPCommunityAccess=sNMPCommunityAccess, managementGroup=managementGroup, ethernet=ethernet, masterSlaveMode=masterSlaveMode, configuration=configuration, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, alarms=alarms, gatewayIPAddress=gatewayIPAddress, siteName=siteName, bootVersion=bootVersion, radarDetectChannel=radarDetectChannel, snmpControlGroup=snmpControlGroup, antennaGain=antennaGain, ptpCompliance=ptpCompliance, receivePower=receivePower, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, installArmState=installArmState, vlanId=vlanId, phyStatus=phyStatus, productVariant=productVariant, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, nTPServerIp=nTPServerIp, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, noiseFloor=noiseFloor, sNMPTrapTableIndex=sNMPTrapTableIndex, versionsGroup=versionsGroup, transmitDataRate=transmitDataRate, remoteMACAddress=remoteMACAddress, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtpGroup=smtpGroup, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, configurationGroup=configurationGroup, versions=versions, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentChannel=currentChannel, vectorError=vectorError, receiveDataRate=receiveDataRate, timeZone=timeZone, nTPSync=nTPSync, linkStatusTrap=linkStatusTrap, band=band, subnetMask=subnetMask, channelSelection=channelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentFreqMHz=currentFreqMHz, vlanPriority=vlanPriority, sMTPServerIPAddress=sMTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ptp250=ptp250, sNMPTrapVersion=sNMPTrapVersion, radarDetectTrap=radarDetectTrap, sNMPCommunityOid=sNMPCommunityOid, management=management, licence=licence, signalStrengthRatio=signalStrengthRatio, configuredModulationMode=configuredModulationMode, softwareVersion=softwareVersion, ptpGroups=ptpGroups, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hardwareVersion=hardwareVersion, smtp=smtp, systemClock=systemClock, dualPayload=dualPayload, remoteIPAddress=remoteIPAddress, transmitModulationMode=transmitModulationMode, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, ntp=ntp, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp=ptp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ntpGroup=ntpGroup, ptmp=ptmp, dataPortStatus=dataPortStatus, sNMPTrapCommunity=sNMPTrapCommunity, regionCode=regionCode, alarmsGroup=alarmsGroup, sMTPEnabledMessages=sMTPEnabledMessages, vlanTagging=vlanTagging, extendedChannel=extendedChannel, configuredRange=configuredRange, sNMPCommunityTable=sNMPCommunityTable, nTPState=nTPState, snmpControl=snmpControl, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, measuredRange=measuredRange, searchState=searchState, nTPLastSync=nTPLastSync)
