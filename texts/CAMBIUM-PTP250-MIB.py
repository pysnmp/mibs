...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, bootVersion=bootVersion, vlanPriority=vlanPriority, sNMPTrapTable=sNMPTrapTable, versions=versions, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, installArmState=installArmState, receivePower=receivePower, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, nTPLastSync=nTPLastSync, radarDetectChannel=radarDetectChannel, iPAddress=iPAddress, vlanId=vlanId, sNMPCommunityAccess=sNMPCommunityAccess, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, receiveModulationMode=receiveModulationMode, dataPortStatus=dataPortStatus, systemClock=systemClock, ntp=ntp, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, ntpGroup=ntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, nTPServerPortNumber=nTPServerPortNumber, transmitPower=transmitPower, alarms=alarms, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, pubStats=pubStats, measuredRange=measuredRange, transmitModulationMode=transmitModulationMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, sNMPTrapCommunity=sNMPTrapCommunity, currentChannel=currentChannel, softwareVersion=softwareVersion, licence=licence, remoteIPAddress=remoteIPAddress, linkName=linkName, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, noiseFloor=noiseFloor, pubStatsGroup=pubStatsGroup, productName=productName, timeZone=timeZone, channelBandwidth=channelBandwidth, extendedChannel=extendedChannel, installArmStateTrap=installArmStateTrap, channelSelection=channelSelection, managementGroup=managementGroup, linkLoss=linkLoss, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, nTPSync=nTPSync, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPPollInterval=nTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, radarDetectTrap=radarDetectTrap, configuredRange=configuredRange, dualPayload=dualPayload, remoteMACAddress=remoteMACAddress, productVariant=productVariant, sNMPCommunityOid=sNMPCommunityOid, nTPState=nTPState, phyStatus=phyStatus, configuredModulationMode=configuredModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, cambium=cambium, vlanTagging=vlanTagging, extendedFreqMHz=extendedFreqMHz, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, currentFreqMHz=currentFreqMHz, licenceGroup=licenceGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkStatusTrap=linkStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp250=ptp250, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerIp=nTPServerIp, dataPortStatusTrap=dataPortStatusTrap, notificationsGroup=notificationsGroup, regionCode=regionCode, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, siteName=siteName)
