...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, nTPLastSync=nTPLastSync, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vlanPriority=vlanPriority, dualPayload=dualPayload, productVariant=productVariant, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, receiveModulationMode=receiveModulationMode, ptmp=ptmp, siteName=siteName, currentChannel=currentChannel, smtpGroup=smtpGroup, receivePower=receivePower, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, channelSelection=channelSelection, systemClock=systemClock, installArmStateTrap=installArmStateTrap, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, nTPPollInterval=nTPPollInterval, timeZone=timeZone, sNMPCommunityTableNumber=sNMPCommunityTableNumber, subnetMask=subnetMask, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, extendedChannel=extendedChannel, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityAccess=sNMPCommunityAccess, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, ntpGroup=ntpGroup, remoteMACAddress=remoteMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp250=ptp250, fixedModMode=fixedModMode, nTPState=nTPState, versions=versions, noiseFloor=noiseFloor, transmitDataRate=transmitDataRate, ethernetGroup=ethernetGroup, transmitPower=transmitPower, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp=ptp, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCode=regionCode, nTPSync=nTPSync, licence=licence, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, ntp=ntp, extendedFreqMHz=extendedFreqMHz, versionsGroup=versionsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkName=linkName, vlanTagging=vlanTagging, dataPortStatus=dataPortStatus, ethernet=ethernet, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpTraps=ptpTraps, softwareVersion=softwareVersion, currentFreqMHz=currentFreqMHz, cambium=cambium, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, installArmState=installArmState, configuredModulationMode=configuredModulationMode, ptpCompliance=ptpCompliance, band=band, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectChannel=radarDetectChannel, cableLoss=cableLoss, measuredRange=measuredRange, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanId=vlanId, configuredRange=configuredRange, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, vectorError=vectorError, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, configuration=configuration, radarDetectTrap=radarDetectTrap, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, nTPServerPortNumber=nTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBandwidth=channelBandwidth, sNMPTrapCommunity=sNMPTrapCommunity, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups)
