...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licence=licence, currentFreqMHz=currentFreqMHz, vlanPriority=vlanPriority, extendedChannel=extendedChannel, fixedModMode=fixedModMode, receivePower=receivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, smtpGroup=smtpGroup, nTPPollInterval=nTPPollInterval, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, productName=productName, siteName=siteName, timeZone=timeZone, dataPortStatus=dataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, nTPSync=nTPSync, management=management, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, currentChannel=currentChannel, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMACAddress=remoteMACAddress, cambium=cambium, installArmState=installArmState, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveDataRate=receiveDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptp250=ptp250, sNMPCommunityAccess=sNMPCommunityAccess, band=band, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, nTPLastSync=nTPLastSync, softwareVersion=softwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, dualPayload=dualPayload, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerIp=nTPServerIp, channelSelection=channelSelection, radarDetectChannel=radarDetectChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, transmitPower=transmitPower, sNMPCommunityString=sNMPCommunityString, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, licenceGroup=licenceGroup, sNMPCommunityOid=sNMPCommunityOid, snmpControl=snmpControl, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, ntpGroup=ntpGroup, vectorError=vectorError, alarms=alarms, sNMPTrapCommunity=sNMPTrapCommunity, linkLoss=linkLoss, linkStatusTrap=linkStatusTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, versionsGroup=versionsGroup, cableLoss=cableLoss, radarDetectTrap=radarDetectTrap, hardwareVersion=hardwareVersion, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, sNMPCommunityTable=sNMPCommunityTable, signalStrengthRatio=signalStrengthRatio, searchState=searchState, measuredRange=measuredRange, transmitModulationMode=transmitModulationMode, pubStats=pubStats, noiseFloor=noiseFloor, nTPState=nTPState, configuredModulationMode=configuredModulationMode, ethernetGroup=ethernetGroup, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, ethernet=ethernet, versions=versions, PYSNMP_MODULE_ID=cambium, sMTPEnabledMessages=sMTPEnabledMessages, snmpControlGroup=snmpControlGroup, configuredRange=configuredRange, ntp=ntp, remoteIPAddress=remoteIPAddress, vlanTagging=vlanTagging, antennaGain=antennaGain, ptmp=ptmp, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, vlanId=vlanId, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, nTPServerPortNumber=nTPServerPortNumber, phyStatus=phyStatus)
