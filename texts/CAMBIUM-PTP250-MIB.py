...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuration=configuration, linkName=linkName, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, iPAddress=iPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatus=wirelessLinkStatus, receiveDataRate=receiveDataRate, siteName=siteName, currentChannel=currentChannel, measuredRange=measuredRange, radarDetectTrap=radarDetectTrap, sNMPTrapCommunity=sNMPTrapCommunity, masterSlaveMode=masterSlaveMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, cableLoss=cableLoss, vlanTagging=vlanTagging, configuredRange=configuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerIp=nTPServerIp, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, pubStatsGroup=pubStatsGroup, radarDetectChannel=radarDetectChannel, vectorError=vectorError, hardwareVersion=hardwareVersion, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, receivePower=receivePower, ntpGroup=ntpGroup, snmpControlGroup=snmpControlGroup, searchState=searchState, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPPollInterval=nTPPollInterval, sNMPCommunityTable=sNMPCommunityTable, remoteMACAddress=remoteMACAddress, dataPortStatus=dataPortStatus, linkStatusTrap=linkStatusTrap, vlanPriority=vlanPriority, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, noiseFloor=noiseFloor, dualPayload=dualPayload, timeZone=timeZone, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, nTPState=nTPState, notificationsGroup=notificationsGroup, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, fixedModMode=fixedModMode, alarmsGroup=alarmsGroup, managementGroup=managementGroup, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, ptp250=ptp250, channelSelection=channelSelection, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, band=band, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, bootVersion=bootVersion, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, configuredModulationMode=configuredModulationMode, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityString=sNMPCommunityString, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp=ptp, ptpGroups=ptpGroups, ethernet=ethernet, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, sNMPCommunityOid=sNMPCommunityOid, ptmp=ptmp, dataPortStatusTrap=dataPortStatusTrap, nTPSync=nTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, regionCode=regionCode, vlanId=vlanId, alarms=alarms, smtpGroup=smtpGroup, nTPLastSync=nTPLastSync, management=management, snmpControl=snmpControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, ntp=ntp, ptpCompliance=ptpCompliance, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, cambium=cambium, extendedChannel=extendedChannel, configurationGroup=configurationGroup, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, pubStats=pubStats, phyStatus=phyStatus)
