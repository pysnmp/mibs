...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitPower=transmitPower, management=management, bootVersion=bootVersion, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemClock=systemClock, siteName=siteName, notificationsGroup=notificationsGroup, currentFreqMHz=currentFreqMHz, receiveDataRate=receiveDataRate, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, ptpTraps=ptpTraps, ntpGroup=ntpGroup, sNMPCommunityAccess=sNMPCommunityAccess, installArmState=installArmState, fixedModMode=fixedModMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, measuredRange=measuredRange, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp250=ptp250, sNMPCommunityOid=sNMPCommunityOid, productName=productName, managementGroup=managementGroup, transmitDataRate=transmitDataRate, gatewayIPAddress=gatewayIPAddress, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, snmpControl=snmpControl, vlanId=vlanId, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapIPAddress=sNMPTrapIPAddress, alarms=alarms, vlanTagging=vlanTagging, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitModulationMode=transmitModulationMode, searchState=searchState, linkLoss=linkLoss, configuration=configuration, licence=licence, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, band=band, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableEntry=sNMPCommunityTableEntry, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, configuredRange=configuredRange, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, ntp=ntp, licenceGroup=licenceGroup, noiseFloor=noiseFloor, smtp=smtp, subnetMask=subnetMask, nTPLastSync=nTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, versions=versions, pubStatsGroup=pubStatsGroup, sNMPCommunityTable=sNMPCommunityTable, configurationGroup=configurationGroup, sNMPCommunityString=sNMPCommunityString, receiveModulationMode=receiveModulationMode, ethernet=ethernet, channelBandwidth=channelBandwidth, regionCode=regionCode, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, linkStatusTrap=linkStatusTrap, pubStats=pubStats, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapVersion=sNMPTrapVersion, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, cambium=cambium, masterSlaveMode=masterSlaveMode, linkName=linkName, iPAddress=iPAddress, productVariant=productVariant, receivePower=receivePower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, currentChannel=currentChannel, nTPState=nTPState, phyStatus=phyStatus, smtpGroup=smtpGroup, vectorError=vectorError, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, nTPPollInterval=nTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, configuredModulationMode=configuredModulationMode, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, dualPayload=dualPayload, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, ptmp=ptmp, channelSelection=channelSelection)
