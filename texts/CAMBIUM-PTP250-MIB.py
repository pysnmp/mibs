...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", PYSNMP_MODULE_ID=cambium, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPSync=nTPSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, nTPServerIp=nTPServerIp, cableLoss=cableLoss, smtpGroup=smtpGroup, fixedModMode=fixedModMode, transmitPower=transmitPower, noiseFloor=noiseFloor, alarms=alarms, subnetMask=subnetMask, ptp=ptp, smtp=smtp, ptpGroups=ptpGroups, vlanId=vlanId, nTPState=nTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, sNMPTrapTableNumber=sNMPTrapTableNumber, ntpGroup=ntpGroup, versionsGroup=versionsGroup, signalStrengthRatio=signalStrengthRatio, nTPServerPortNumber=nTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, measuredRange=measuredRange, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, configuredModulationMode=configuredModulationMode, snmpControl=snmpControl, channelSelection=channelSelection, timeZone=timeZone, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, dataPortStatus=dataPortStatus, sNMPTrapCommunity=sNMPTrapCommunity, ntp=ntp, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, receivePower=receivePower, notificationsGroup=notificationsGroup, remoteMACAddress=remoteMACAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, searchState=searchState, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, productVariant=productVariant, ptp250=ptp250, dataPortStatusTrap=dataPortStatusTrap, hardwareVersion=hardwareVersion, phyStatus=phyStatus, vlanTagging=vlanTagging, iPAddress=iPAddress, extendedChannel=extendedChannel, linkStatusTrap=linkStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanPriority=vlanPriority, cambium=cambium, nTPPollInterval=nTPPollInterval, installArmStateTrap=installArmStateTrap, extendedFreqMHz=extendedFreqMHz, antennaGain=antennaGain, currentChannel=currentChannel, remoteIPAddress=remoteIPAddress, radarDetectChannel=radarDetectChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, licence=licence, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, productName=productName, sNMPCommunityAccess=sNMPCommunityAccess, ptpCompliance=ptpCompliance, linkName=linkName, systemClock=systemClock, pubStats=pubStats, receiveModulationMode=receiveModulationMode, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityOid=sNMPCommunityOid, band=band, configuredRange=configuredRange, licenceGroup=licenceGroup, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, siteName=siteName, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPLastSync=nTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, managementGroup=managementGroup, configurationGroup=configurationGroup, bootVersion=bootVersion, vectorError=vectorError)
