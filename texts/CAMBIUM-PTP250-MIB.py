...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", management=management, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, productVariant=productVariant, linkName=linkName, nTPState=nTPState, masterSlaveMode=masterSlaveMode, vlanPriority=vlanPriority, tFTPServerPortNumber=tFTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, measuredRange=measuredRange, bootVersion=bootVersion, currentChannel=currentChannel, transmitPower=transmitPower, licenceGroup=licenceGroup, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityOid=sNMPCommunityOid, searchState=searchState, ethernetGroup=ethernetGroup, fixedModMode=fixedModMode, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, ptmp=ptmp, productName=productName, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, configuredModulationMode=configuredModulationMode, nTPServerIp=nTPServerIp, versions=versions, linkStatusTrap=linkStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityString=sNMPCommunityString, pubStats=pubStats, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, ptpTraps=ptpTraps, cambium=cambium, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, receivePower=receivePower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, versionsGroup=versionsGroup, extendedChannel=extendedChannel, sNMPCommunityAccess=sNMPCommunityAccess, nTPPollInterval=nTPPollInterval, radarDetectTrap=radarDetectTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPSync=nTPSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControl=snmpControl, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, ptp250=ptp250, extendedFreqMHz=extendedFreqMHz, sNMPTrapTable=sNMPTrapTable, iPAddress=iPAddress, siteName=siteName, phyStatusGroup=phyStatusGroup, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, licence=licence, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, installArmStateTrap=installArmStateTrap, nTPLastSync=nTPLastSync, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, channelSelection=channelSelection, transmitDataRate=transmitDataRate, configuredRange=configuredRange, vectorError=vectorError, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCode=regionCode, ntpGroup=ntpGroup, antennaGain=antennaGain, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, smtp=smtp, noWirelessChannelAvailable=noWirelessChannelAvailable, noiseFloor=noiseFloor, receiveDataRate=receiveDataRate, dataPortStatus=dataPortStatus, ntp=ntp, systemClock=systemClock, linkLoss=linkLoss, vlanTagging=vlanTagging, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpCompliance=ptpCompliance, configuration=configuration, softwareVersion=softwareVersion, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, ethernet=ethernet, remoteIPAddress=remoteIPAddress, remoteMACAddress=remoteMACAddress, vlanId=vlanId, cableLoss=cableLoss, timeZone=timeZone, hardwareVersion=hardwareVersion, band=band)
