...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectTrap=radarDetectTrap, fixedModMode=fixedModMode, ptpGroups=ptpGroups, sNMPCommunityAccess=sNMPCommunityAccess, ntp=ntp, pubStatsGroup=pubStatsGroup, nTPServerPortNumber=nTPServerPortNumber, management=management, vectorError=vectorError, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, linkStatusTrap=linkStatusTrap, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerIPAddress=sMTPServerIPAddress, band=band, currentChannel=currentChannel, sNMPTrapTable=sNMPTrapTable, ptpCompliance=ptpCompliance, configurationGroup=configurationGroup, smtp=smtp, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, dualPayload=dualPayload, regionCode=regionCode, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, timeZone=timeZone, installArmState=installArmState, vlanPriority=vlanPriority, managementGroup=managementGroup, searchState=searchState, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, ptp=ptp, nTPState=nTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredModulationMode=configuredModulationMode, ethernetGroup=ethernetGroup, currentFreqMHz=currentFreqMHz, softwareVersion=softwareVersion, licenceGroup=licenceGroup, cambium=cambium, remoteMACAddress=remoteMACAddress, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, configuredRange=configuredRange, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapCommunity=sNMPTrapCommunity, antennaGain=antennaGain, extendedChannel=extendedChannel, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versions=versions, vlanId=vlanId, cableLoss=cableLoss, radarDetectChannel=radarDetectChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityOid=sNMPCommunityOid, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, ptmp=ptmp, channelBandwidth=channelBandwidth, linkLoss=linkLoss, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, receiveDataRate=receiveDataRate, ethernet=ethernet, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, measuredRange=measuredRange, sNMPCommunityTable=sNMPCommunityTable, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, masterSlaveMode=masterSlaveMode, noiseFloor=noiseFloor, installArmStateTrap=installArmStateTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, productName=productName, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, nTPSync=nTPSync, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, channelSelection=channelSelection, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, nTPServerIp=nTPServerIp, vlanTagging=vlanTagging, snmpControl=snmpControl, ntpGroup=ntpGroup, notificationsGroup=notificationsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp250=ptp250, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveModulationMode=receiveModulationMode, subnetMask=subnetMask, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licence=licence, systemClock=systemClock)
