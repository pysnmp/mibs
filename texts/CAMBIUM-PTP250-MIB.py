...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", aggregateDataRate=aggregateDataRate, phyStatusGroup=phyStatusGroup, nTPServerIp=nTPServerIp, siteName=siteName, nTPSync=nTPSync, transmitDataRate=transmitDataRate, snmpControl=snmpControl, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, vlanTagging=vlanTagging, wirelessLinkStatus=wirelessLinkStatus, subnetMask=subnetMask, management=management, dualPayload=dualPayload, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, pubStats=pubStats, ntpGroup=ntpGroup, receiveDataRate=receiveDataRate, noiseFloor=noiseFloor, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTable=sNMPTrapTable, vlanId=vlanId, alarms=alarms, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityOid=sNMPCommunityOid, linkName=linkName, nTPServerPortNumber=nTPServerPortNumber, smtp=smtp, masterSlaveMode=masterSlaveMode, nTPState=nTPState, tFTPServerIPAddress=tFTPServerIPAddress, nTPPollInterval=nTPPollInterval, currentFreqMHz=currentFreqMHz, productName=productName, sNMPCommunityAccess=sNMPCommunityAccess, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, configuredModulationMode=configuredModulationMode, ntp=ntp, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, band=band, remoteMACAddress=remoteMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, maximumTransmitPower=maximumTransmitPower, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPLastSync=nTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, configurationGroup=configurationGroup, fixedModMode=fixedModMode, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityString=sNMPCommunityString, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, licence=licence, regionCode=regionCode, installArmState=installArmState, systemClock=systemClock, ethernet=ethernet, ptpCompliance=ptpCompliance, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, smtpGroup=smtpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, configuredRange=configuredRange, currentChannel=currentChannel, transmitPower=transmitPower, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, phyStatus=phyStatus, radarDetectChannel=radarDetectChannel, radarDetectTrap=radarDetectTrap, configuration=configuration, extendedChannel=extendedChannel, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, measuredRange=measuredRange, channelBandwidth=channelBandwidth, linkStatusTrap=linkStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, versions=versions, ptp250=ptp250, vectorError=vectorError, timeZone=timeZone, ptp=ptp, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix)
