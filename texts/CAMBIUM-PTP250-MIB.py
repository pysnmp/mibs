...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, linkLoss=linkLoss, tFTPServerPortNumber=tFTPServerPortNumber, configuredModulationMode=configuredModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, extendedFreqMHz=extendedFreqMHz, sNMPTrapTable=sNMPTrapTable, siteName=siteName, configurationGroup=configurationGroup, managementGroup=managementGroup, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, nTPPollInterval=nTPPollInterval, hardwareVersion=hardwareVersion, extendedChannel=extendedChannel, ntpGroup=ntpGroup, ethernetGroup=ethernetGroup, aggregateDataRate=aggregateDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatusGroup=phyStatusGroup, sNMPCommunityTable=sNMPCommunityTable, vlanId=vlanId, smtpGroup=smtpGroup, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, sNMPTrapCommunity=sNMPTrapCommunity, nTPSync=nTPSync, vectorError=vectorError, snmpControl=snmpControl, measuredRange=measuredRange, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectChannel=radarDetectChannel, transmitPower=transmitPower, configuredRange=configuredRange, cableLoss=cableLoss, productName=productName, transmitDataRate=transmitDataRate, ptp250=ptp250, snmpControlGroup=snmpControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, alarms=alarms, masterSlaveMode=masterSlaveMode, configuration=configuration, regionCode=regionCode, receivePower=receivePower, phyStatus=phyStatus, ptp=ptp, noiseFloor=noiseFloor, ptmp=ptmp, dataPortStatus=dataPortStatus, currentChannel=currentChannel, nTPServerIp=nTPServerIp, sMTPEnabledMessages=sMTPEnabledMessages, nTPState=nTPState, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, radarDetectTrap=radarDetectTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cambium=cambium, management=management, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, licenceGroup=licenceGroup, linkStatusTrap=linkStatusTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, timeZone=timeZone, remoteMACAddress=remoteMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtp=smtp, sNMPCommunityAccess=sNMPCommunityAccess, channelBandwidth=channelBandwidth, dualPayload=dualPayload, channelSelection=channelSelection, installArmState=installArmState, nTPLastSync=nTPLastSync, subnetMask=subnetMask, vlanPriority=vlanPriority, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, nTPServerPortNumber=nTPServerPortNumber, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, band=band, currentFreqMHz=currentFreqMHz, pubStatsGroup=pubStatsGroup, ntp=ntp, vlanTagging=vlanTagging, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, sNMPCommunityOid=sNMPCommunityOid, receiveDataRate=receiveDataRate, searchState=searchState, linkName=linkName, tFTPServerIPAddress=tFTPServerIPAddress, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, systemClock=systemClock)
