...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableIndex=sNMPCommunityTableIndex, fixedModMode=fixedModMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receivePower=receivePower, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, management=management, nTPServerIp=nTPServerIp, nTPPollInterval=nTPPollInterval, snmpControl=snmpControl, vlanTagging=vlanTagging, antennaGain=antennaGain, installArmState=installArmState, measuredRange=measuredRange, productVariant=productVariant, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, timeZone=timeZone, pubStats=pubStats, ptp250=ptp250, gatewayIPAddress=gatewayIPAddress, searchState=searchState, productName=productName, radarDetectTrap=radarDetectTrap, dataPortStatus=dataPortStatus, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, ethernet=ethernet, masterSlaveMode=masterSlaveMode, linkName=linkName, licence=licence, nTPSync=nTPSync, extendedChannel=extendedChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanId=vlanId, vectorError=vectorError, radarDetectChannel=radarDetectChannel, regionCode=regionCode, ptpGroups=ptpGroups, linkLoss=linkLoss, notificationsGroup=notificationsGroup, ptmp=ptmp, transmitDataRate=transmitDataRate, nTPLastSync=nTPLastSync, smtp=smtp, pubStatsGroup=pubStatsGroup, vlanPriority=vlanPriority, versionsGroup=versionsGroup, band=band, transmitPower=transmitPower, remoteMACAddress=remoteMACAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, subnetMask=subnetMask, hardwareVersion=hardwareVersion, channelSelection=channelSelection, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTable=sNMPCommunityTable, configuredRange=configuredRange, currentFreqMHz=currentFreqMHz, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, linkStatusTrap=linkStatusTrap, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, cableLoss=cableLoss, sMTPEnabledMessages=sMTPEnabledMessages, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, sNMPCommunityOid=sNMPCommunityOid, tFTPServerPortNumber=tFTPServerPortNumber, noiseFloor=noiseFloor, snmpControlGroup=snmpControlGroup, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredModulationMode=configuredModulationMode, dualPayload=dualPayload, systemClock=systemClock, nTPState=nTPState, currentChannel=currentChannel, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ntpGroup=ntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, ntp=ntp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, sNMPTrapCommunity=sNMPTrapCommunity, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTrapPrefix=ptpTrapPrefix)
