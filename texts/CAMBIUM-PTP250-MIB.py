...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanTagging=vlanTagging, dataPortStatusTrap=dataPortStatusTrap, installArmStateTrap=installArmStateTrap, siteName=siteName, channelBandwidth=channelBandwidth, nTPLastSync=nTPLastSync, bootVersion=bootVersion, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, sNMPCommunityAccess=sNMPCommunityAccess, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, currentFreqMHz=currentFreqMHz, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, linkLoss=linkLoss, licence=licence, installArmState=installArmState, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, configuration=configuration, band=band, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, transmitPower=transmitPower, snmpControl=snmpControl, smtpGroup=smtpGroup, sNMPCommunityString=sNMPCommunityString, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanId=vlanId, productVariant=productVariant, ptmp=ptmp, ptp=ptp, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, channelSelection=channelSelection, timeZone=timeZone, phyStatusGroup=phyStatusGroup, management=management, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, nTPPollInterval=nTPPollInterval, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, productName=productName, configuredModulationMode=configuredModulationMode, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, dualPayload=dualPayload, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, ntpGroup=ntpGroup, managementGroup=managementGroup, measuredRange=measuredRange, nTPSync=nTPSync, cambium=cambium, pubStats=pubStats, noiseFloor=noiseFloor, nTPState=nTPState, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, fixedModMode=fixedModMode, cableLoss=cableLoss, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, alarmsGroup=alarmsGroup, radarDetectChannel=radarDetectChannel, iPAddress=iPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredRange=configuredRange, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, ptp250=ptp250, versionsGroup=versionsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, systemClock=systemClock, extendedChannel=extendedChannel, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, nTPServerPortNumber=nTPServerPortNumber, ntp=ntp, smtp=smtp, ptpTraps=ptpTraps, linkName=linkName, vlanPriority=vlanPriority, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, linkStatusTrap=linkStatusTrap, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex)
