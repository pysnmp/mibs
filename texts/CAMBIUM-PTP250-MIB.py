...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStatsGroup=pubStatsGroup, ntpGroup=ntpGroup, configuredModulationMode=configuredModulationMode, sNMPCommunityTable=sNMPCommunityTable, configuredRange=configuredRange, sNMPTrapVersion=sNMPTrapVersion, installArmState=installArmState, dualPayload=dualPayload, nTPSync=nTPSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStats=pubStats, subnetMask=subnetMask, vlanId=vlanId, smtp=smtp, linkName=linkName, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, linkLoss=linkLoss, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, channelSelection=channelSelection, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMACAddress=remoteMACAddress, configurationGroup=configurationGroup, productVariant=productVariant, ptpCompliance=ptpCompliance, alarmsGroup=alarmsGroup, siteName=siteName, sNMPCommunityOid=sNMPCommunityOid, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, band=band, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPPollInterval=nTPPollInterval, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, vlanTagging=vlanTagging, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, vlanPriority=vlanPriority, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, management=management, nTPState=nTPState, measuredRange=measuredRange, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, receiveModulationMode=receiveModulationMode, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, managementGroup=managementGroup, notificationsGroup=notificationsGroup, cambium=cambium, radarDetectTrap=radarDetectTrap, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, productName=productName, transmitDataRate=transmitDataRate, sNMPTrapCommunity=sNMPTrapCommunity, ptpTrapPrefix=ptpTrapPrefix, nTPServerIp=nTPServerIp, gatewayIPAddress=gatewayIPAddress, configuration=configuration, ptp250=ptp250, hardwareVersion=hardwareVersion, searchState=searchState, PYSNMP_MODULE_ID=cambium, fixedModMode=fixedModMode, ptmp=ptmp, licenceGroup=licenceGroup, noiseFloor=noiseFloor, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPLastSync=nTPLastSync, alarms=alarms, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, versionsGroup=versionsGroup, vectorError=vectorError, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityAccess=sNMPCommunityAccess, ntp=ntp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedChannel=extendedChannel, systemClock=systemClock, currentChannel=currentChannel, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitModulationMode=transmitModulationMode, timeZone=timeZone, ptp=ptp, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectChannel=radarDetectChannel, receiveDataRate=receiveDataRate)
