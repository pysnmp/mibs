...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, ethernetGroup=ethernetGroup, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, linkName=linkName, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, softwareVersion=softwareVersion, productVariant=productVariant, currentFreqMHz=currentFreqMHz, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPSync=nTPSync, notificationsGroup=notificationsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, vlanId=vlanId, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licence=licence, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTable=sNMPTrapTable, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, extendedChannel=extendedChannel, channelSelection=channelSelection, versionsGroup=versionsGroup, configuredModulationMode=configuredModulationMode, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, band=band, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, vlanPriority=vlanPriority, linkStatusTrap=linkStatusTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, channelBandwidth=channelBandwidth, nTPState=nTPState, remoteIPAddress=remoteIPAddress, measuredRange=measuredRange, bootVersion=bootVersion, fixedModMode=fixedModMode, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, management=management, alarms=alarms, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredRange=configuredRange, ptpGroups=ptpGroups, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedFreqMHz=extendedFreqMHz, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, iPAddress=iPAddress, sMTPServerPortNumber=sMTPServerPortNumber, installArmState=installArmState, radarDetectTrap=radarDetectTrap, configuration=configuration, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, sMTPServerIPAddress=sMTPServerIPAddress, ntpGroup=ntpGroup, installArmStateTrap=installArmStateTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, timeZone=timeZone, phyStatusGroup=phyStatusGroup, dataPortStatusTrap=dataPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, vectorError=vectorError, ethernet=ethernet, vlanTagging=vlanTagging, sNMPCommunityAccess=sNMPCommunityAccess, smtpGroup=smtpGroup, nTPServerIp=nTPServerIp, ptpCompliance=ptpCompliance, ptp=ptp, cambium=cambium, transmitModulationMode=transmitModulationMode, ptp250=ptp250, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, radarDetectChannel=radarDetectChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, versions=versions, hardwareVersion=hardwareVersion, alarmsGroup=alarmsGroup, nTPLastSync=nTPLastSync, noiseFloor=noiseFloor, cableLoss=cableLoss, siteName=siteName, receivePower=receivePower, ptmp=ptmp, dualPayload=dualPayload, snmpControl=snmpControl, ntp=ntp, phyStatus=phyStatus, sNMPTrapCommunity=sNMPTrapCommunity, licenceGroup=licenceGroup, snmpControlGroup=snmpControlGroup, sNMPCommunityString=sNMPCommunityString)
