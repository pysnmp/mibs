...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", alarms=alarms, linkStatusTrap=linkStatusTrap, remoteMACAddress=remoteMACAddress, ptp=ptp, nTPPollInterval=nTPPollInterval, phyStatusGroup=phyStatusGroup, noiseFloor=noiseFloor, sNMPCommunityAccess=sNMPCommunityAccess, snmpControlGroup=snmpControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, ptmp=ptmp, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, nTPServerIp=nTPServerIp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, fixedModMode=fixedModMode, measuredRange=measuredRange, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, radarDetectTrap=radarDetectTrap, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, snmpControl=snmpControl, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptp250=ptp250, ptpCompliance=ptpCompliance, sNMPTrapVersion=sNMPTrapVersion, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPLastSync=nTPLastSync, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, cableLoss=cableLoss, siteName=siteName, radarDetectChannel=radarDetectChannel, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPSync=nTPSync, extendedFreqMHz=extendedFreqMHz, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, extendedChannel=extendedChannel, cambium=cambium, iPAddress=iPAddress, searchState=searchState, vlanId=vlanId, remoteIPAddress=remoteIPAddress, licence=licence, band=band, configuredRange=configuredRange, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, currentChannel=currentChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, ethernetGroup=ethernetGroup, subnetMask=subnetMask, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, transmitDataRate=transmitDataRate, configuredModulationMode=configuredModulationMode, sNMPCommunityOid=sNMPCommunityOid, vlanTagging=vlanTagging, channelSelection=channelSelection, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTable=sNMPCommunityTable, currentFreqMHz=currentFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, pubStatsGroup=pubStatsGroup, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ntpGroup=ntpGroup, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, linkName=linkName, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, sNMPCommunityTableIndex=sNMPCommunityTableIndex, productVariant=productVariant, productName=productName, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, transmitPower=transmitPower, antennaGain=antennaGain, vlanPriority=vlanPriority, receiveDataRate=receiveDataRate, installArmState=installArmState, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, notificationsGroup=notificationsGroup, receivePower=receivePower, ethernet=ethernet, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, systemClock=systemClock, vectorError=vectorError)
