...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", radarDetectTrap=radarDetectTrap, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, dualPayload=dualPayload, searchState=searchState, transmitDataRate=transmitDataRate, radarDetectChannel=radarDetectChannel, extendedChannel=extendedChannel, dataPortStatus=dataPortStatus, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, nTPSync=nTPSync, regionCode=regionCode, signalStrengthRatio=signalStrengthRatio, sNMPCommunityAccess=sNMPCommunityAccess, nTPState=nTPState, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMACAddress=remoteMACAddress, cableLoss=cableLoss, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkStatusTrap=linkStatusTrap, antennaGain=antennaGain, sNMPTrapTable=sNMPTrapTable, siteName=siteName, ptpCompliance=ptpCompliance, pubStats=pubStats, sNMPCommunityOid=sNMPCommunityOid, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vlanPriority=vlanPriority, configuredRange=configuredRange, nTPPollInterval=nTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, nTPLastSync=nTPLastSync, ptmp=ptmp, linkLoss=linkLoss, vlanId=vlanId, currentFreqMHz=currentFreqMHz, systemClock=systemClock, maximumTransmitPower=maximumTransmitPower, ptp250=ptp250, installArmState=installArmState, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, fixedModMode=fixedModMode, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, licenceGroup=licenceGroup, currentChannel=currentChannel, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTable=sNMPCommunityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, transmitPower=transmitPower, hardwareVersion=hardwareVersion, productName=productName, notificationsGroup=notificationsGroup, timeZone=timeZone, aggregateDataRate=aggregateDataRate, nTPServerPortNumber=nTPServerPortNumber, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, productVariant=productVariant, receivePower=receivePower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptp=ptp, management=management, transmitModulationMode=transmitModulationMode, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanTagging=vlanTagging, gatewayIPAddress=gatewayIPAddress, snmpControl=snmpControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, noiseFloor=noiseFloor, channelSelection=channelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, measuredRange=measuredRange, configurationGroup=configurationGroup, ntpGroup=ntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, linkName=linkName, configuredModulationMode=configuredModulationMode, ntp=ntp, extendedFreqMHz=extendedFreqMHz, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
