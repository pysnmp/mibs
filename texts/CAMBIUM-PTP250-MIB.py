...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernetGroup=ethernetGroup, management=management, smtp=smtp, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, productVariant=productVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, pubStats=pubStats, nTPSync=nTPSync, ptp250=ptp250, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, smtpGroup=smtpGroup, subnetMask=subnetMask, ethernet=ethernet, vlanId=vlanId, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, phyStatus=phyStatus, productName=productName, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, nTPPollInterval=nTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, measuredRange=measuredRange, versions=versions, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, iPAddress=iPAddress, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, linkStatusTrap=linkStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licence=licence, ptmp=ptmp, PYSNMP_MODULE_ID=cambium, currentChannel=currentChannel, ptpCompliance=ptpCompliance, transmitPower=transmitPower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, channelBandwidth=channelBandwidth, transmitDataRate=transmitDataRate, ntp=ntp, fixedModMode=fixedModMode, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, siteName=siteName, cambium=cambium, extendedFreqMHz=extendedFreqMHz, receiveDataRate=receiveDataRate, ntpGroup=ntpGroup, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteMACAddress=remoteMACAddress, remoteIPAddress=remoteIPAddress, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, noiseFloor=noiseFloor, wirelessLinkStatus=wirelessLinkStatus, vlanTagging=vlanTagging, bootVersion=bootVersion, configurationGroup=configurationGroup, channelSelection=channelSelection, configuredRange=configuredRange, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, configuredModulationMode=configuredModulationMode, radarDetectTrap=radarDetectTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, dualPayload=dualPayload, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanPriority=vlanPriority, nTPState=nTPState, aggregateDataRate=aggregateDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, licenceGroup=licenceGroup, sNMPCommunityTable=sNMPCommunityTable, configuration=configuration, linkName=linkName, sNMPCommunityString=sNMPCommunityString, ptp=ptp, vectorError=vectorError, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, alarms=alarms, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControl=snmpControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPLastSync=nTPLastSync, extendedChannel=extendedChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, band=band, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectChannel=radarDetectChannel)
