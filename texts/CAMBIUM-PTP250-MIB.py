...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configurationGroup=configurationGroup, ntp=ntp, extendedChannel=extendedChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, radarDetectChannel=radarDetectChannel, versionsGroup=versionsGroup, siteName=siteName, searchState=searchState, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, currentChannel=currentChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, vlanId=vlanId, nTPPollInterval=nTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, currentFreqMHz=currentFreqMHz, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerIp=nTPServerIp, sNMPCommunityOid=sNMPCommunityOid, phyStatus=phyStatus, snmpControl=snmpControl, extendedFreqMHz=extendedFreqMHz, band=band, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, notificationsGroup=notificationsGroup, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, installArmState=installArmState, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, radarDetectTrap=radarDetectTrap, configuration=configuration, sNMPCommunityTable=sNMPCommunityTable, fixedModMode=fixedModMode, ptpCompliance=ptpCompliance, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, softwareVersion=softwareVersion, ptpGroups=ptpGroups, ptp=ptp, bootVersion=bootVersion, cambium=cambium, hardwareVersion=hardwareVersion, linkName=linkName, pubStatsGroup=pubStatsGroup, channelSelection=channelSelection, antennaGain=antennaGain, ptmp=ptmp, vlanTagging=vlanTagging, linkLoss=linkLoss, vectorError=vectorError, productName=productName, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, management=management, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, versions=versions, productVariant=productVariant, iPAddress=iPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMACAddress=remoteMACAddress, managementGroup=managementGroup, nTPState=nTPState, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCode=regionCode, pubStats=pubStats, vlanPriority=vlanPriority, ethernetGroup=ethernetGroup, ptp250=ptp250, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, configuredModulationMode=configuredModulationMode, dualPayload=dualPayload, aggregateDataRate=aggregateDataRate, noiseFloor=noiseFloor, ntpGroup=ntpGroup, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, licence=licence, ethernet=ethernet, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, measuredRange=measuredRange, configuredRange=configuredRange, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkStatusTrap=linkStatusTrap, smtp=smtp, signalStrengthRatio=signalStrengthRatio, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPServerPortNumber=nTPServerPortNumber, nTPLastSync=nTPLastSync, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower)
