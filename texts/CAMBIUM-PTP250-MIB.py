...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", radarDetectChannel=radarDetectChannel, sNMPCommunityTable=sNMPCommunityTable, notificationsGroup=notificationsGroup, vlanId=vlanId, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, vlanTagging=vlanTagging, snmpControl=snmpControl, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, vectorError=vectorError, ptmp=ptmp, pubStats=pubStats, configuredRange=configuredRange, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, currentFreqMHz=currentFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, ntp=ntp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentChannel=currentChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, siteName=siteName, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, nTPServerIp=nTPServerIp, nTPSync=nTPSync, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatus=dataPortStatus, ethernet=ethernet, managementGroup=managementGroup, transmitPower=transmitPower, regionCode=regionCode, vlanPriority=vlanPriority, ptp250=ptp250, installArmState=installArmState, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, iPAddress=iPAddress, configuration=configuration, phyStatusGroup=phyStatusGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ntpGroup=ntpGroup, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, band=band, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, receiveDataRate=receiveDataRate, configurationGroup=configurationGroup, cableLoss=cableLoss, measuredRange=measuredRange, sNMPTrapIPAddress=sNMPTrapIPAddress, linkStatusTrap=linkStatusTrap, searchState=searchState, ethernetGroup=ethernetGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, alarms=alarms, sNMPCommunityAccess=sNMPCommunityAccess, transmitModulationMode=transmitModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectTrap=radarDetectTrap, snmpControlGroup=snmpControlGroup, configuredModulationMode=configuredModulationMode, management=management, nTPLastSync=nTPLastSync, bootVersion=bootVersion, smtp=smtp, receivePower=receivePower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, nTPPollInterval=nTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPState=nTPState, sNMPTrapTable=sNMPTrapTable, cambium=cambium, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, nTPServerPortNumber=nTPServerPortNumber, fixedModMode=fixedModMode, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, channelBandwidth=channelBandwidth, versions=versions, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, ptpGroups=ptpGroups, sNMPCommunityOid=sNMPCommunityOid, channelSelection=channelSelection, noiseFloor=noiseFloor, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedFreqMHz=extendedFreqMHz, extendedChannel=extendedChannel)
