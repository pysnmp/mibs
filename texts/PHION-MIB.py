...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Gauge32, Integer32, Unsigned32, MibIdentifier, TimeTicks, IpAddress, Counter64, enterprises, iso, NotificationType, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Gauge32", "Integer32", "Unsigned32", "MibIdentifier", "TimeTicks", "IpAddress", "Counter64", "enterprises", "iso", "NotificationType", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", class2Drop=class2Drop, ServiceState=ServiceState, eventLayerDescription=eventLayerDescription, serverServices=serverServices, raidEventsEntry=raidEventsEntry, SensorType=SensorType, boxServiceState=boxServiceState, firewall=firewall, hwGroups=hwGroups, class3Pakets=class3Pakets, hwSensorValue=hwSensorValue, packetThroughput=packetThroughput, bgpGroup=bgpGroup, partitionFreeSpace=partitionFreeSpace, bgpNeighborAddress=bgpNeighborAddress, raidGroup=raidGroup, RaidEventSeverity=RaidEventSeverity, ospfNeighborId=ospfNeighborId, noDelayTotal=noDelayTotal, trafficShape=trafficShape, hwSensorsEntry=hwSensorsEntry, notificationGroup=notificationGroup, ripNeighborsEntry=ripNeighborsEntry, firewallSessions64=firewallSessions64, fwCompliances=fwCompliances, serviceGroups=serviceGroups, vpnTunnels=vpnTunnels, bgpNeighborState=bgpNeighborState, vpnName=vpnName, VpnStates=VpnStates, hotfixInstallTime=hotfixInstallTime, class3Total=class3Total, vpnGroup=vpnGroup, hotfixGroup=hotfixGroup, ospfNeighborInterface=ospfNeighborInterface, bgpNeighborsEntry=bgpNeighborsEntry, serverGroup=serverGroup, ospfGroup=ospfGroup, firewallSessions=firewallSessions, eventTrap=eventTrap, eventGroups=eventGroups, eventAlarmTime=eventAlarmTime, boxServiceName=boxServiceName, diskSpace=diskSpace, raidEventSev=raidEventSev, vpnusersGroup=vpnusersGroup, firmwareGroups=firmwareGroups, packetThroughput64=packetThroughput64, class2Total=class2Total, hotfixName=hotfixName, bgpNeighbors=bgpNeighbors, raidEvents=raidEvents, eventGroup=eventGroup, class1Total=class1Total, connectorName=connectorName, ripNeighborState=ripNeighborState, eventIDDescription=eventIDDescription, boxServices=boxServices, raidEventTime=raidEventTime, raidEventText=raidEventText, class1Drop=class1Drop, fwCompliance=fwCompliance, releaseGroup=releaseGroup, serverServicesEntry=serverServicesEntry, hwSensorType=hwSensorType, trafficShapeEntry=trafficShapeEntry, fwstatsGroup=fwstatsGroup, class2Pakets=class2Pakets, phion=phion, PYSNMP_MODULE_ID=phion, eventID=eventID, diskSpaceEntry=diskSpaceEntry, trafficshapeGroup=trafficshapeGroup, eventType=eventType, boxServicesEntry=boxServicesEntry, dataThroughput64=dataThroughput64, noDelayPakets=noDelayPakets, hwSensors=hwSensors, rate=rate, hwSensorName=hwSensorName, vpnUsers=vpnUsers, partitionName=partitionName, fwStatsEntry=fwStatsEntry, phionHotfixes=phionHotfixes, ospfNeighborsEntry=ospfNeighborsEntry, serverServiceName=serverServiceName, raidEventIndex=raidEventIndex, ospfNeighborAddress=ospfNeighborAddress, partitionUsedSpacePercent=partitionUsedSpacePercent, ospfNeighbors=ospfNeighbors, fwGroups=fwGroups, diskspaceGroup=diskspaceGroup, eventSeverity=eventSeverity, partitionUsedSpace=partitionUsedSpace, hwGroup=hwGroup, eventClassification=eventClassification, netGroups=netGroups, ospfNeighborStatus=ospfNeighborStatus, vpnTunnelsEntry=vpnTunnelsEntry, partitionMaxSpace=partitionMaxSpace, sessions=sessions, noDelayDrop=noDelayDrop, vpnState=vpnState, ripNeighborAddress=ripNeighborAddress, phionHotfixesEntry=phionHotfixesEntry, event=event, serverServiceState=serverServiceState, fwStats=fwStats, ripGroup=ripGroup, class3Drop=class3Drop, boxGroup=boxGroup, dataThroughput=dataThroughput, ripNeighbors=ripNeighbors, eventRepresentation=eventRepresentation, class1Pakets=class1Pakets, phionRelease=phionRelease)
