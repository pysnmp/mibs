...
Bits, ObjectIdentity, MibIdentifier, NotificationType, iso, Unsigned32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Gauge32, Counter64, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Gauge32", "Counter64", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("PHION-MIB", hwSensorValue=hwSensorValue, class3Pakets=class3Pakets, bgpNeighbors=bgpNeighbors, fwGroups=fwGroups, boxServiceState=boxServiceState, raidGroup=raidGroup, eventAlarmTime=eventAlarmTime, vpnusersGroup=vpnusersGroup, class1Drop=class1Drop, ospfNeighborId=ospfNeighborId, raidEvents=raidEvents, eventLayerDescription=eventLayerDescription, boxServicesEntry=boxServicesEntry, hwSensorType=hwSensorType, eventClassification=eventClassification, ripNeighbors=ripNeighbors, class2Total=class2Total, hotfixName=hotfixName, class1Total=class1Total, fwStatsEntry=fwStatsEntry, vpnTunnelsEntry=vpnTunnelsEntry, hwSensors=hwSensors, connectorName=connectorName, rate=rate, class2Pakets=class2Pakets, vpnState=vpnState, eventGroup=eventGroup, ripNeighborState=ripNeighborState, noDelayDrop=noDelayDrop, class1Pakets=class1Pakets, firmwareGroups=firmwareGroups, eventGroups=eventGroups, fwstatsGroup=fwstatsGroup, firewallSessions64=firewallSessions64, bgpGroup=bgpGroup, raidEventIndex=raidEventIndex, ripNeighborsEntry=ripNeighborsEntry, eventSeverity=eventSeverity, packetThroughput64=packetThroughput64, phionHotfixesEntry=phionHotfixesEntry, fwCompliances=fwCompliances, SensorType=SensorType, serverServices=serverServices, class3Drop=class3Drop, phionRelease=phionRelease, VpnStates=VpnStates, vpnTunnels=vpnTunnels, partitionMaxSpace=partitionMaxSpace, raidEventsEntry=raidEventsEntry, partitionUsedSpace=partitionUsedSpace, boxGroup=boxGroup, hwSensorsEntry=hwSensorsEntry, noDelayTotal=noDelayTotal, ospfNeighborInterface=ospfNeighborInterface, eventTrap=eventTrap, fwCompliance=fwCompliance, dataThroughput64=dataThroughput64, bgpNeighborAddress=bgpNeighborAddress, firewallSessions=firewallSessions, hotfixInstallTime=hotfixInstallTime, ospfNeighborAddress=ospfNeighborAddress, dataThroughput=dataThroughput, boxServiceName=boxServiceName, eventRepresentation=eventRepresentation, hwGroup=hwGroup, boxServices=boxServices, trafficShapeEntry=trafficShapeEntry, fwStats=fwStats, raidEventSev=raidEventSev, phion=phion, eventIDDescription=eventIDDescription, diskSpaceEntry=diskSpaceEntry, class3Total=class3Total, notificationGroup=notificationGroup, vpnName=vpnName, serverServicesEntry=serverServicesEntry, partitionName=partitionName, diskspaceGroup=diskspaceGroup, PYSNMP_MODULE_ID=phion, bgpNeighborState=bgpNeighborState, serverGroup=serverGroup, trafficshapeGroup=trafficshapeGroup, diskSpace=diskSpace, trafficShape=trafficShape, ripNeighborAddress=ripNeighborAddress, raidEventText=raidEventText, serverServiceState=serverServiceState, ospfNeighborsEntry=ospfNeighborsEntry, ospfGroup=ospfGroup, ospfNeighbors=ospfNeighbors, ospfNeighborStatus=ospfNeighborStatus, partitionUsedSpacePercent=partitionUsedSpacePercent, ServiceState=ServiceState, netGroups=netGroups, raidEventTime=raidEventTime, eventType=eventType, RaidEventSeverity=RaidEventSeverity, firewall=firewall, bgpNeighborsEntry=bgpNeighborsEntry, partitionFreeSpace=partitionFreeSpace, serverServiceName=serverServiceName, eventID=eventID, vpnGroup=vpnGroup, event=event, hotfixGroup=hotfixGroup, hwSensorName=hwSensorName, packetThroughput=packetThroughput, noDelayPakets=noDelayPakets, hwGroups=hwGroups, serviceGroups=serviceGroups, releaseGroup=releaseGroup, ripGroup=ripGroup, class2Drop=class2Drop, vpnUsers=vpnUsers, phionHotfixes=phionHotfixes, sessions=sessions)
