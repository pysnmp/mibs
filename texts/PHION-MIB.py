...
ModuleIdentity, Integer32, Gauge32, Unsigned32, Counter32, TimeTicks, IpAddress, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, iso, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "Unsigned32", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "iso", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", partitionName=partitionName, diskspaceGroup=diskspaceGroup, eventIDDescription=eventIDDescription, SensorType=SensorType, serverServiceState=serverServiceState, trafficShapeEntry=trafficShapeEntry, eventSeverity=eventSeverity, hwSensorName=hwSensorName, ripNeighborAddress=ripNeighborAddress, serverServiceName=serverServiceName, hotfixName=hotfixName, packetThroughput64=packetThroughput64, diskSpace=diskSpace, phion=phion, boxServicesEntry=boxServicesEntry, ripNeighbors=ripNeighbors, serverGroup=serverGroup, connectorName=connectorName, eventGroup=eventGroup, class1Pakets=class1Pakets, eventID=eventID, raidEventsEntry=raidEventsEntry, class3Total=class3Total, fwStats=fwStats, partitionFreeSpace=partitionFreeSpace, notificationGroup=notificationGroup, firewallSessions64=firewallSessions64, bgpNeighborState=bgpNeighborState, diskSpaceEntry=diskSpaceEntry, ospfNeighborAddress=ospfNeighborAddress, hwGroups=hwGroups, raidEvents=raidEvents, PYSNMP_MODULE_ID=phion, firewall=firewall, eventTrap=eventTrap, firmwareGroups=firmwareGroups, hwGroup=hwGroup, fwStatsEntry=fwStatsEntry, phionHotfixesEntry=phionHotfixesEntry, hwSensorValue=hwSensorValue, noDelayTotal=noDelayTotal, dataThroughput=dataThroughput, raidEventSev=raidEventSev, vpnusersGroup=vpnusersGroup, eventGroups=eventGroups, vpnTunnelsEntry=vpnTunnelsEntry, partitionMaxSpace=partitionMaxSpace, ServiceState=ServiceState, hwSensorType=hwSensorType, hotfixGroup=hotfixGroup, ospfNeighborsEntry=ospfNeighborsEntry, class1Drop=class1Drop, vpnState=vpnState, serviceGroups=serviceGroups, ospfNeighbors=ospfNeighbors, fwCompliances=fwCompliances, class3Pakets=class3Pakets, dataThroughput64=dataThroughput64, ripNeighborState=ripNeighborState, ospfNeighborInterface=ospfNeighborInterface, serverServicesEntry=serverServicesEntry, rate=rate, netGroups=netGroups, boxServices=boxServices, raidEventIndex=raidEventIndex, bgpNeighborAddress=bgpNeighborAddress, class1Total=class1Total, VpnStates=VpnStates, eventType=eventType, ospfNeighborId=ospfNeighborId, partitionUsedSpacePercent=partitionUsedSpacePercent, vpnGroup=vpnGroup, vpnTunnels=vpnTunnels, vpnName=vpnName, eventRepresentation=eventRepresentation, vpnUsers=vpnUsers, eventAlarmTime=eventAlarmTime, partitionUsedSpace=partitionUsedSpace, class2Pakets=class2Pakets, ospfNeighborStatus=ospfNeighborStatus, class3Drop=class3Drop, hwSensorsEntry=hwSensorsEntry, hwSensors=hwSensors, bgpGroup=bgpGroup, RaidEventSeverity=RaidEventSeverity, boxServiceState=boxServiceState, fwstatsGroup=fwstatsGroup, hotfixInstallTime=hotfixInstallTime, raidGroup=raidGroup, ripGroup=ripGroup, raidEventText=raidEventText, noDelayDrop=noDelayDrop, packetThroughput=packetThroughput, class2Drop=class2Drop, bgpNeighbors=bgpNeighbors, firewallSessions=firewallSessions, class2Total=class2Total, releaseGroup=releaseGroup, phionHotfixes=phionHotfixes, eventClassification=eventClassification, bgpNeighborsEntry=bgpNeighborsEntry, eventLayerDescription=eventLayerDescription, phionRelease=phionRelease, fwCompliance=fwCompliance, boxServiceName=boxServiceName, trafficshapeGroup=trafficshapeGroup, raidEventTime=raidEventTime, boxGroup=boxGroup, sessions=sessions, ripNeighborsEntry=ripNeighborsEntry, ospfGroup=ospfGroup, event=event, fwGroups=fwGroups, serverServices=serverServices, noDelayPakets=noDelayPakets, trafficShape=trafficShape)
