...
enterprises, MibIdentifier, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, ModuleIdentity, IpAddress, Integer32, ObjectIdentity, iso, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "ModuleIdentity", "IpAddress", "Integer32", "ObjectIdentity", "iso", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("PHION-MIB", eventIDDescription=eventIDDescription, ospfGroup=ospfGroup, eventClassification=eventClassification, serverServiceState=serverServiceState, noDelayTotal=noDelayTotal, vpnGroup=vpnGroup, boxServiceState=boxServiceState, partitionName=partitionName, raidGroup=raidGroup, eventType=eventType, fwCompliance=fwCompliance, VpnStates=VpnStates, packetThroughput=packetThroughput, class3Drop=class3Drop, partitionUsedSpace=partitionUsedSpace, hwSensorType=hwSensorType, boxServiceName=boxServiceName, bgpGroup=bgpGroup, class3Total=class3Total, diskSpaceEntry=diskSpaceEntry, trafficshapeGroup=trafficshapeGroup, hwSensorName=hwSensorName, dataThroughput=dataThroughput, noDelayDrop=noDelayDrop, boxServices=boxServices, raidEventSev=raidEventSev, raidEventTime=raidEventTime, class1Drop=class1Drop, dataThroughput64=dataThroughput64, class2Drop=class2Drop, diskSpace=diskSpace, partitionMaxSpace=partitionMaxSpace, sessions=sessions, ripNeighborAddress=ripNeighborAddress, vpnName=vpnName, hotfixGroup=hotfixGroup, rate=rate, vpnTunnels=vpnTunnels, raidEventsEntry=raidEventsEntry, notificationGroup=notificationGroup, noDelayPakets=noDelayPakets, eventAlarmTime=eventAlarmTime, hwGroups=hwGroups, ospfNeighborInterface=ospfNeighborInterface, SensorType=SensorType, eventGroups=eventGroups, ripNeighbors=ripNeighbors, fwStats=fwStats, partitionFreeSpace=partitionFreeSpace, eventID=eventID, firewall=firewall, boxGroup=boxGroup, RaidEventSeverity=RaidEventSeverity, fwGroups=fwGroups, netGroups=netGroups, vpnUsers=vpnUsers, releaseGroup=releaseGroup, firewallSessions64=firewallSessions64, ospfNeighborAddress=ospfNeighborAddress, eventGroup=eventGroup, vpnTunnelsEntry=vpnTunnelsEntry, trafficShapeEntry=trafficShapeEntry, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborsEntry=ospfNeighborsEntry, connectorName=connectorName, phionHotfixes=phionHotfixes, ripNeighborState=ripNeighborState, diskspaceGroup=diskspaceGroup, eventRepresentation=eventRepresentation, trafficShape=trafficShape, hwSensors=hwSensors, raidEventIndex=raidEventIndex, hwSensorValue=hwSensorValue, ripGroup=ripGroup, fwstatsGroup=fwstatsGroup, hotfixInstallTime=hotfixInstallTime, serverServicesEntry=serverServicesEntry, ospfNeighborId=ospfNeighborId, serverServiceName=serverServiceName, phion=phion, hwSensorsEntry=hwSensorsEntry, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighbors=ospfNeighbors, vpnusersGroup=vpnusersGroup, firmwareGroups=firmwareGroups, eventTrap=eventTrap, eventSeverity=eventSeverity, class1Pakets=class1Pakets, raidEvents=raidEvents, serviceGroups=serviceGroups, serverGroup=serverGroup, eventLayerDescription=eventLayerDescription, boxServicesEntry=boxServicesEntry, ospfNeighborStatus=ospfNeighborStatus, class2Pakets=class2Pakets, bgpNeighbors=bgpNeighbors, phionRelease=phionRelease, bgpNeighborAddress=bgpNeighborAddress, ServiceState=ServiceState, vpnState=vpnState, firewallSessions=firewallSessions, event=event, fwCompliances=fwCompliances, bgpNeighborState=bgpNeighborState, fwStatsEntry=fwStatsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, class2Total=class2Total, PYSNMP_MODULE_ID=phion, ripNeighborsEntry=ripNeighborsEntry, class1Total=class1Total, class3Pakets=class3Pakets, hwGroup=hwGroup, serverServices=serverServices, raidEventText=raidEventText, packetThroughput64=packetThroughput64, hotfixName=hotfixName)
