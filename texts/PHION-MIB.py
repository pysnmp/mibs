...
NotificationType, TimeTicks, Counter32, Integer32, Counter64, ModuleIdentity, IpAddress, MibIdentifier, ObjectIdentity, iso, Unsigned32, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "Integer32", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Unsigned32", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("PHION-MIB", boxServiceState=boxServiceState, hwSensorName=hwSensorName, bgpGroup=bgpGroup, class3Pakets=class3Pakets, notificationGroup=notificationGroup, eventID=eventID, VpnStates=VpnStates, partitionFreeSpace=partitionFreeSpace, noDelayTotal=noDelayTotal, partitionMaxSpace=partitionMaxSpace, phion=phion, class2Drop=class2Drop, SensorType=SensorType, serverServiceState=serverServiceState, hwGroup=hwGroup, ospfNeighborAddress=ospfNeighborAddress, eventTrap=eventTrap, eventGroups=eventGroups, partitionUsedSpacePercent=partitionUsedSpacePercent, vpnName=vpnName, ripNeighbors=ripNeighbors, phionRelease=phionRelease, serviceGroups=serviceGroups, ripGroup=ripGroup, hotfixName=hotfixName, RaidEventSeverity=RaidEventSeverity, fwGroups=fwGroups, partitionName=partitionName, hwSensors=hwSensors, ospfNeighborStatus=ospfNeighborStatus, trafficShape=trafficShape, ospfNeighbors=ospfNeighbors, packetThroughput64=packetThroughput64, ripNeighborsEntry=ripNeighborsEntry, ospfNeighborId=ospfNeighborId, vpnState=vpnState, eventClassification=eventClassification, fwStats=fwStats, hwGroups=hwGroups, vpnTunnelsEntry=vpnTunnelsEntry, bgpNeighborState=bgpNeighborState, connectorName=connectorName, class2Pakets=class2Pakets, class3Total=class3Total, serverServices=serverServices, vpnUsers=vpnUsers, class1Pakets=class1Pakets, fwCompliance=fwCompliance, raidEventsEntry=raidEventsEntry, raidEvents=raidEvents, ospfGroup=ospfGroup, class3Drop=class3Drop, fwCompliances=fwCompliances, ServiceState=ServiceState, boxServiceName=boxServiceName, trafficShapeEntry=trafficShapeEntry, sessions=sessions, ospfNeighborsEntry=ospfNeighborsEntry, noDelayDrop=noDelayDrop, diskspaceGroup=diskspaceGroup, raidEventSev=raidEventSev, hwSensorsEntry=hwSensorsEntry, serverServicesEntry=serverServicesEntry, bgpNeighbors=bgpNeighbors, bgpNeighborAddress=bgpNeighborAddress, raidEventTime=raidEventTime, eventType=eventType, vpnusersGroup=vpnusersGroup, firewall=firewall, fwStatsEntry=fwStatsEntry, phionHotfixes=phionHotfixes, raidGroup=raidGroup, ospfNeighborInterface=ospfNeighborInterface, firmwareGroups=firmwareGroups, eventGroup=eventGroup, eventIDDescription=eventIDDescription, partitionUsedSpace=partitionUsedSpace, boxGroup=boxGroup, vpnTunnels=vpnTunnels, hotfixGroup=hotfixGroup, event=event, eventSeverity=eventSeverity, diskSpaceEntry=diskSpaceEntry, dataThroughput64=dataThroughput64, hotfixInstallTime=hotfixInstallTime, boxServicesEntry=boxServicesEntry, vpnGroup=vpnGroup, packetThroughput=packetThroughput, bgpNeighborsEntry=bgpNeighborsEntry, fwstatsGroup=fwstatsGroup, eventLayerDescription=eventLayerDescription, dataThroughput=dataThroughput, diskSpace=diskSpace, serverGroup=serverGroup, PYSNMP_MODULE_ID=phion, firewallSessions64=firewallSessions64, rate=rate, ripNeighborState=ripNeighborState, raidEventText=raidEventText, trafficshapeGroup=trafficshapeGroup, boxServices=boxServices, serverServiceName=serverServiceName, noDelayPakets=noDelayPakets, class1Drop=class1Drop, releaseGroup=releaseGroup, raidEventIndex=raidEventIndex, class2Total=class2Total, netGroups=netGroups, firewallSessions=firewallSessions, class1Total=class1Total, eventRepresentation=eventRepresentation, hwSensorValue=hwSensorValue, hwSensorType=hwSensorType, phionHotfixesEntry=phionHotfixesEntry, eventAlarmTime=eventAlarmTime, ripNeighborAddress=ripNeighborAddress)
