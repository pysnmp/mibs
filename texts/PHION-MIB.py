...
Bits, IpAddress, enterprises, Counter64, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter32, ObjectIdentity, TimeTicks, iso, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "enterprises", "Counter64", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("PHION-MIB", ospfNeighbors=ospfNeighbors, vpnGroup=vpnGroup, netGroups=netGroups, sessions=sessions, hotfixInstallTime=hotfixInstallTime, class3Total=class3Total, trafficShapeEntry=trafficShapeEntry, partitionUsedSpace=partitionUsedSpace, firewallSessions64=firewallSessions64, dataThroughput=dataThroughput, noDelayTotal=noDelayTotal, hotfixName=hotfixName, eventRepresentation=eventRepresentation, vpnTunnels=vpnTunnels, class2Total=class2Total, boxGroup=boxGroup, class2Drop=class2Drop, noDelayPakets=noDelayPakets, fwStats=fwStats, serverGroup=serverGroup, fwstatsGroup=fwstatsGroup, ospfGroup=ospfGroup, eventType=eventType, packetThroughput64=packetThroughput64, SensorType=SensorType, serviceGroups=serviceGroups, partitionUsedSpacePercent=partitionUsedSpacePercent, bgpNeighborsEntry=bgpNeighborsEntry, RaidEventSeverity=RaidEventSeverity, eventTrap=eventTrap, raidEventText=raidEventText, boxServiceName=boxServiceName, eventGroups=eventGroups, class1Drop=class1Drop, eventSeverity=eventSeverity, hotfixGroup=hotfixGroup, class3Pakets=class3Pakets, ospfNeighborsEntry=ospfNeighborsEntry, class1Total=class1Total, eventAlarmTime=eventAlarmTime, partitionName=partitionName, serverServiceName=serverServiceName, hwSensorsEntry=hwSensorsEntry, hwSensorValue=hwSensorValue, hwSensors=hwSensors, bgpNeighborState=bgpNeighborState, bgpNeighbors=bgpNeighbors, eventClassification=eventClassification, serverServicesEntry=serverServicesEntry, fwCompliance=fwCompliance, notificationGroup=notificationGroup, raidEventsEntry=raidEventsEntry, connectorName=connectorName, vpnTunnelsEntry=vpnTunnelsEntry, partitionFreeSpace=partitionFreeSpace, ospfNeighborStatus=ospfNeighborStatus, vpnUsers=vpnUsers, class2Pakets=class2Pakets, phion=phion, ospfNeighborInterface=ospfNeighborInterface, bgpGroup=bgpGroup, hwSensorType=hwSensorType, partitionMaxSpace=partitionMaxSpace, boxServicesEntry=boxServicesEntry, hwSensorName=hwSensorName, vpnusersGroup=vpnusersGroup, raidEvents=raidEvents, hwGroups=hwGroups, raidEventSev=raidEventSev, noDelayDrop=noDelayDrop, PYSNMP_MODULE_ID=phion, boxServiceState=boxServiceState, serverServiceState=serverServiceState, fwCompliances=fwCompliances, diskSpace=diskSpace, ospfNeighborId=ospfNeighborId, releaseGroup=releaseGroup, fwGroups=fwGroups, ripNeighborState=ripNeighborState, phionRelease=phionRelease, raidGroup=raidGroup, firewall=firewall, phionHotfixesEntry=phionHotfixesEntry, firmwareGroups=firmwareGroups, dataThroughput64=dataThroughput64, VpnStates=VpnStates, ripNeighborsEntry=ripNeighborsEntry, eventID=eventID, trafficshapeGroup=trafficshapeGroup, rate=rate, packetThroughput=packetThroughput, ripNeighbors=ripNeighbors, raidEventTime=raidEventTime, eventGroup=eventGroup, eventLayerDescription=eventLayerDescription, vpnName=vpnName, bgpNeighborAddress=bgpNeighborAddress, ospfNeighborAddress=ospfNeighborAddress, ripNeighborAddress=ripNeighborAddress, phionHotfixes=phionHotfixes, hwGroup=hwGroup, serverServices=serverServices, ripGroup=ripGroup, boxServices=boxServices, eventIDDescription=eventIDDescription, vpnState=vpnState, diskSpaceEntry=diskSpaceEntry, trafficShape=trafficShape, class3Drop=class3Drop, raidEventIndex=raidEventIndex, firewallSessions=firewallSessions, event=event, fwStatsEntry=fwStatsEntry, ServiceState=ServiceState, diskspaceGroup=diskspaceGroup, class1Pakets=class1Pakets)
