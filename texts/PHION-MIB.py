...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, IpAddress, iso, MibIdentifier, Bits, Unsigned32, Counter32, ObjectIdentity, Gauge32, enterprises, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "IpAddress", "iso", "MibIdentifier", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "Gauge32", "enterprises", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("PHION-MIB", raidEventsEntry=raidEventsEntry, eventIDDescription=eventIDDescription, dataThroughput=dataThroughput, vpnState=vpnState, partitionUsedSpace=partitionUsedSpace, eventAlarmTime=eventAlarmTime, diskspaceGroup=diskspaceGroup, partitionMaxSpace=partitionMaxSpace, firewallSessions=firewallSessions, rate=rate, ospfNeighborAddress=ospfNeighborAddress, fwGroups=fwGroups, firmwareGroups=firmwareGroups, dataThroughput64=dataThroughput64, partitionName=partitionName, fwstatsGroup=fwstatsGroup, raidEventIndex=raidEventIndex, ospfNeighborInterface=ospfNeighborInterface, RaidEventSeverity=RaidEventSeverity, serverGroup=serverGroup, eventClassification=eventClassification, class3Drop=class3Drop, eventType=eventType, class3Pakets=class3Pakets, hwGroup=hwGroup, ripGroup=ripGroup, ripNeighbors=ripNeighbors, packetThroughput64=packetThroughput64, fwStats=fwStats, fwStatsEntry=fwStatsEntry, ripNeighborState=ripNeighborState, ospfNeighborStatus=ospfNeighborStatus, serverServices=serverServices, releaseGroup=releaseGroup, firewall=firewall, eventLayerDescription=eventLayerDescription, eventGroups=eventGroups, bgpNeighborAddress=bgpNeighborAddress, fwCompliance=fwCompliance, sessions=sessions, hwSensorName=hwSensorName, eventGroup=eventGroup, class2Drop=class2Drop, vpnusersGroup=vpnusersGroup, trafficShapeEntry=trafficShapeEntry, phionHotfixesEntry=phionHotfixesEntry, ospfGroup=ospfGroup, class2Total=class2Total, event=event, fwCompliances=fwCompliances, serviceGroups=serviceGroups, eventID=eventID, SensorType=SensorType, boxGroup=boxGroup, diskSpace=diskSpace, diskSpaceEntry=diskSpaceEntry, ripNeighborsEntry=ripNeighborsEntry, trafficShape=trafficShape, ripNeighborAddress=ripNeighborAddress, raidEventTime=raidEventTime, bgpGroup=bgpGroup, partitionFreeSpace=partitionFreeSpace, vpnUsers=vpnUsers, notificationGroup=notificationGroup, connectorName=connectorName, eventSeverity=eventSeverity, raidEventText=raidEventText, raidEvents=raidEvents, raidGroup=raidGroup, class1Pakets=class1Pakets, partitionUsedSpacePercent=partitionUsedSpacePercent, ospfNeighbors=ospfNeighbors, netGroups=netGroups, noDelayTotal=noDelayTotal, bgpNeighborsEntry=bgpNeighborsEntry, raidEventSev=raidEventSev, packetThroughput=packetThroughput, phionRelease=phionRelease, hwSensorsEntry=hwSensorsEntry, vpnGroup=vpnGroup, firewallSessions64=firewallSessions64, class1Total=class1Total, noDelayDrop=noDelayDrop, vpnName=vpnName, ospfNeighborId=ospfNeighborId, vpnTunnels=vpnTunnels, serverServiceName=serverServiceName, class3Total=class3Total, VpnStates=VpnStates, hwSensors=hwSensors, boxServiceState=boxServiceState, phion=phion, hotfixInstallTime=hotfixInstallTime, serverServicesEntry=serverServicesEntry, eventTrap=eventTrap, bgpNeighbors=bgpNeighbors, hwSensorType=hwSensorType, serverServiceState=serverServiceState, class2Pakets=class2Pakets, eventRepresentation=eventRepresentation, boxServicesEntry=boxServicesEntry, PYSNMP_MODULE_ID=phion, boxServiceName=boxServiceName, hotfixGroup=hotfixGroup, vpnTunnelsEntry=vpnTunnelsEntry, hwSensorValue=hwSensorValue, bgpNeighborState=bgpNeighborState, hotfixName=hotfixName, boxServices=boxServices, noDelayPakets=noDelayPakets, class1Drop=class1Drop, phionHotfixes=phionHotfixes, ServiceState=ServiceState, trafficshapeGroup=trafficshapeGroup, hwGroups=hwGroups, ospfNeighborsEntry=ospfNeighborsEntry)
