...
Integer32, Gauge32, enterprises, NotificationType, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, IpAddress, MibIdentifier, Unsigned32, Bits, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "enterprises", "NotificationType", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "Bits", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", vpnUsers=vpnUsers, boxGroup=boxGroup, raidEvents=raidEvents, hwSensorName=hwSensorName, hwSensorValue=hwSensorValue, hwGroups=hwGroups, ripNeighborsEntry=ripNeighborsEntry, vpnTunnels=vpnTunnels, ospfNeighborsEntry=ospfNeighborsEntry, raidEventIndex=raidEventIndex, vpnusersGroup=vpnusersGroup, notificationGroup=notificationGroup, hwSensors=hwSensors, releaseGroup=releaseGroup, ripNeighborAddress=ripNeighborAddress, eventGroups=eventGroups, PYSNMP_MODULE_ID=phion, phionRelease=phionRelease, vpnTunnelsEntry=vpnTunnelsEntry, trafficShape=trafficShape, ospfNeighbors=ospfNeighbors, RaidEventSeverity=RaidEventSeverity, ripGroup=ripGroup, eventClassification=eventClassification, eventRepresentation=eventRepresentation, netGroups=netGroups, ripNeighborState=ripNeighborState, eventAlarmTime=eventAlarmTime, fwCompliances=fwCompliances, serverServices=serverServices, ospfNeighborStatus=ospfNeighborStatus, eventLayerDescription=eventLayerDescription, vpnState=vpnState, connectorName=connectorName, eventType=eventType, partitionUsedSpacePercent=partitionUsedSpacePercent, hwGroup=hwGroup, ospfNeighborAddress=ospfNeighborAddress, boxServiceName=boxServiceName, firmwareGroups=firmwareGroups, ServiceState=ServiceState, boxServices=boxServices, serviceGroups=serviceGroups, vpnName=vpnName, bgpNeighborState=bgpNeighborState, ospfGroup=ospfGroup, serverServicesEntry=serverServicesEntry, class1Drop=class1Drop, hwSensorType=hwSensorType, SensorType=SensorType, firewall=firewall, raidEventTime=raidEventTime, raidGroup=raidGroup, fwStats=fwStats, class1Pakets=class1Pakets, class3Total=class3Total, fwStatsEntry=fwStatsEntry, phion=phion, noDelayTotal=noDelayTotal, noDelayPakets=noDelayPakets, class3Pakets=class3Pakets, partitionMaxSpace=partitionMaxSpace, class2Pakets=class2Pakets, fwGroups=fwGroups, bgpGroup=bgpGroup, serverServiceName=serverServiceName, firewallSessions=firewallSessions, partitionUsedSpace=partitionUsedSpace, hotfixName=hotfixName, firewallSessions64=firewallSessions64, noDelayDrop=noDelayDrop, dataThroughput64=dataThroughput64, packetThroughput=packetThroughput, diskSpace=diskSpace, bgpNeighborAddress=bgpNeighborAddress, phionHotfixes=phionHotfixes, class1Total=class1Total, eventSeverity=eventSeverity, partitionFreeSpace=partitionFreeSpace, eventGroup=eventGroup, boxServiceState=boxServiceState, event=event, serverServiceState=serverServiceState, partitionName=partitionName, ospfNeighborInterface=ospfNeighborInterface, ospfNeighborId=ospfNeighborId, sessions=sessions, bgpNeighborsEntry=bgpNeighborsEntry, raidEventSev=raidEventSev, fwstatsGroup=fwstatsGroup, hotfixGroup=hotfixGroup, hwSensorsEntry=hwSensorsEntry, trafficshapeGroup=trafficshapeGroup, ripNeighbors=ripNeighbors, VpnStates=VpnStates, raidEventsEntry=raidEventsEntry, serverGroup=serverGroup, rate=rate, phionHotfixesEntry=phionHotfixesEntry, diskspaceGroup=diskspaceGroup, eventIDDescription=eventIDDescription, raidEventText=raidEventText, hotfixInstallTime=hotfixInstallTime, vpnGroup=vpnGroup, class2Drop=class2Drop, trafficShapeEntry=trafficShapeEntry, eventID=eventID, fwCompliance=fwCompliance, class2Total=class2Total, packetThroughput64=packetThroughput64, boxServicesEntry=boxServicesEntry, class3Drop=class3Drop, dataThroughput=dataThroughput, bgpNeighbors=bgpNeighbors, diskSpaceEntry=diskSpaceEntry, eventTrap=eventTrap)
