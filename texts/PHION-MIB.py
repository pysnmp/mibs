...
enterprises, ModuleIdentity, Counter32, Integer32, iso, Unsigned32, Gauge32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, TimeTicks, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Counter32", "Integer32", "iso", "Unsigned32", "Gauge32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "TimeTicks", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", partitionName=partitionName, eventIDDescription=eventIDDescription, dataThroughput64=dataThroughput64, raidEvents=raidEvents, releaseGroup=releaseGroup, trafficshapeGroup=trafficshapeGroup, ripGroup=ripGroup, partitionMaxSpace=partitionMaxSpace, firewall=firewall, class1Total=class1Total, ripNeighborAddress=ripNeighborAddress, class3Pakets=class3Pakets, raidGroup=raidGroup, noDelayTotal=noDelayTotal, eventGroups=eventGroups, fwStatsEntry=fwStatsEntry, packetThroughput=packetThroughput, firmwareGroups=firmwareGroups, eventClassification=eventClassification, netGroups=netGroups, vpnusersGroup=vpnusersGroup, RaidEventSeverity=RaidEventSeverity, boxServicesEntry=boxServicesEntry, class2Total=class2Total, class2Pakets=class2Pakets, diskSpace=diskSpace, sessions=sessions, ospfNeighborInterface=ospfNeighborInterface, hwSensors=hwSensors, raidEventText=raidEventText, ServiceState=ServiceState, ospfNeighborId=ospfNeighborId, packetThroughput64=packetThroughput64, eventGroup=eventGroup, ospfGroup=ospfGroup, phionHotfixes=phionHotfixes, serverServices=serverServices, firewallSessions=firewallSessions, vpnUsers=vpnUsers, ospfNeighborsEntry=ospfNeighborsEntry, SensorType=SensorType, phion=phion, class2Drop=class2Drop, hwSensorType=hwSensorType, eventTrap=eventTrap, ripNeighborState=ripNeighborState, bgpNeighborAddress=bgpNeighborAddress, fwstatsGroup=fwstatsGroup, fwCompliance=fwCompliance, serverGroup=serverGroup, fwGroups=fwGroups, raidEventIndex=raidEventIndex, hotfixName=hotfixName, connectorName=connectorName, serverServiceState=serverServiceState, vpnState=vpnState, phionRelease=phionRelease, vpnGroup=vpnGroup, firewallSessions64=firewallSessions64, class3Drop=class3Drop, raidEventsEntry=raidEventsEntry, eventAlarmTime=eventAlarmTime, notificationGroup=notificationGroup, vpnName=vpnName, eventSeverity=eventSeverity, raidEventSev=raidEventSev, ripNeighborsEntry=ripNeighborsEntry, PYSNMP_MODULE_ID=phion, boxGroup=boxGroup, dataThroughput=dataThroughput, diskSpaceEntry=diskSpaceEntry, diskspaceGroup=diskspaceGroup, bgpGroup=bgpGroup, partitionFreeSpace=partitionFreeSpace, hotfixInstallTime=hotfixInstallTime, hotfixGroup=hotfixGroup, eventLayerDescription=eventLayerDescription, class3Total=class3Total, serverServicesEntry=serverServicesEntry, eventRepresentation=eventRepresentation, fwCompliances=fwCompliances, hwGroups=hwGroups, bgpNeighbors=bgpNeighbors, eventID=eventID, trafficShapeEntry=trafficShapeEntry, hwSensorsEntry=hwSensorsEntry, event=event, ripNeighbors=ripNeighbors, trafficShape=trafficShape, class1Pakets=class1Pakets, hwSensorValue=hwSensorValue, VpnStates=VpnStates, partitionUsedSpacePercent=partitionUsedSpacePercent, boxServiceName=boxServiceName, phionHotfixesEntry=phionHotfixesEntry, boxServiceState=boxServiceState, fwStats=fwStats, serverServiceName=serverServiceName, bgpNeighborState=bgpNeighborState, vpnTunnels=vpnTunnels, noDelayPakets=noDelayPakets, ospfNeighborStatus=ospfNeighborStatus, ospfNeighbors=ospfNeighbors, rate=rate, raidEventTime=raidEventTime, serviceGroups=serviceGroups, noDelayDrop=noDelayDrop, hwGroup=hwGroup, class1Drop=class1Drop, partitionUsedSpace=partitionUsedSpace, bgpNeighborsEntry=bgpNeighborsEntry, hwSensorName=hwSensorName, boxServices=boxServices, eventType=eventType, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighborAddress=ospfNeighborAddress)
