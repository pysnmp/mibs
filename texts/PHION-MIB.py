...
Gauge32, ModuleIdentity, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Counter64, Bits, ObjectIdentity, Unsigned32, enterprises, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Counter64", "Bits", "ObjectIdentity", "Unsigned32", "enterprises", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", raidEventText=raidEventText, eventClassification=eventClassification, partitionUsedSpacePercent=partitionUsedSpacePercent, class2Pakets=class2Pakets, trafficShape=trafficShape, VpnStates=VpnStates, partitionMaxSpace=partitionMaxSpace, boxGroup=boxGroup, noDelayTotal=noDelayTotal, vpnusersGroup=vpnusersGroup, diskSpaceEntry=diskSpaceEntry, ospfNeighborStatus=ospfNeighborStatus, SensorType=SensorType, ospfNeighbors=ospfNeighbors, phionHotfixes=phionHotfixes, packetThroughput64=packetThroughput64, netGroups=netGroups, partitionName=partitionName, hotfixGroup=hotfixGroup, raidEventIndex=raidEventIndex, hwSensorValue=hwSensorValue, ripNeighbors=ripNeighbors, vpnUsers=vpnUsers, class1Total=class1Total, boxServiceName=boxServiceName, eventID=eventID, ospfGroup=ospfGroup, fwStats=fwStats, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborsEntry=ospfNeighborsEntry, fwGroups=fwGroups, eventIDDescription=eventIDDescription, class3Drop=class3Drop, noDelayDrop=noDelayDrop, notificationGroup=notificationGroup, diskspaceGroup=diskspaceGroup, ripNeighborState=ripNeighborState, phion=phion, dataThroughput=dataThroughput, eventGroup=eventGroup, class1Pakets=class1Pakets, hotfixInstallTime=hotfixInstallTime, class3Total=class3Total, firewallSessions=firewallSessions, fwCompliances=fwCompliances, eventType=eventType, ServiceState=ServiceState, eventTrap=eventTrap, raidEventTime=raidEventTime, raidEvents=raidEvents, hwGroup=hwGroup, fwstatsGroup=fwstatsGroup, RaidEventSeverity=RaidEventSeverity, fwCompliance=fwCompliance, vpnGroup=vpnGroup, partitionUsedSpace=partitionUsedSpace, ripNeighborsEntry=ripNeighborsEntry, partitionFreeSpace=partitionFreeSpace, releaseGroup=releaseGroup, class2Drop=class2Drop, event=event, raidEventSev=raidEventSev, trafficshapeGroup=trafficshapeGroup, firewallSessions64=firewallSessions64, eventSeverity=eventSeverity, ospfNeighborAddress=ospfNeighborAddress, bgpNeighborsEntry=bgpNeighborsEntry, dataThroughput64=dataThroughput64, bgpGroup=bgpGroup, eventGroups=eventGroups, rate=rate, serviceGroups=serviceGroups, diskSpace=diskSpace, vpnState=vpnState, noDelayPakets=noDelayPakets, vpnTunnelsEntry=vpnTunnelsEntry, vpnName=vpnName, boxServiceState=boxServiceState, ospfNeighborId=ospfNeighborId, sessions=sessions, hwSensorType=hwSensorType, ripGroup=ripGroup, boxServices=boxServices, ripNeighborAddress=ripNeighborAddress, bgpNeighborState=bgpNeighborState, serverServices=serverServices, firewall=firewall, trafficShapeEntry=trafficShapeEntry, eventAlarmTime=eventAlarmTime, boxServicesEntry=boxServicesEntry, raidEventsEntry=raidEventsEntry, hwGroups=hwGroups, serverGroup=serverGroup, class1Drop=class1Drop, serverServiceState=serverServiceState, eventRepresentation=eventRepresentation, serverServiceName=serverServiceName, eventLayerDescription=eventLayerDescription, bgpNeighborAddress=bgpNeighborAddress, connectorName=connectorName, hwSensorsEntry=hwSensorsEntry, raidGroup=raidGroup, vpnTunnels=vpnTunnels, ospfNeighborInterface=ospfNeighborInterface, PYSNMP_MODULE_ID=phion, fwStatsEntry=fwStatsEntry, bgpNeighbors=bgpNeighbors, hwSensorName=hwSensorName, hotfixName=hotfixName, hwSensors=hwSensors, packetThroughput=packetThroughput, class2Total=class2Total, class3Pakets=class3Pakets, phionRelease=phionRelease, serverServicesEntry=serverServicesEntry, firmwareGroups=firmwareGroups)
