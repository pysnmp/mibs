...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType, Counter64, ObjectIdentity, ModuleIdentity, enterprises, iso, TimeTicks, Integer32, Bits, Counter32, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "ObjectIdentity", "ModuleIdentity", "enterprises", "iso", "TimeTicks", "Integer32", "Bits", "Counter32", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("PHION-MIB", hwSensors=hwSensors, packetThroughput64=packetThroughput64, serverServicesEntry=serverServicesEntry, trafficshapeGroup=trafficshapeGroup, fwGroups=fwGroups, vpnusersGroup=vpnusersGroup, hotfixName=hotfixName, rate=rate, fwCompliance=fwCompliance, class3Total=class3Total, hwGroup=hwGroup, vpnTunnels=vpnTunnels, raidEventTime=raidEventTime, dataThroughput=dataThroughput, releaseGroup=releaseGroup, event=event, boxGroup=boxGroup, firewall=firewall, hwSensorValue=hwSensorValue, SensorType=SensorType, serverServices=serverServices, bgpGroup=bgpGroup, eventClassification=eventClassification, eventType=eventType, notificationGroup=notificationGroup, class1Total=class1Total, hwSensorsEntry=hwSensorsEntry, vpnUsers=vpnUsers, fwStats=fwStats, eventGroups=eventGroups, ospfNeighborId=ospfNeighborId, firewallSessions64=firewallSessions64, phionHotfixes=phionHotfixes, phionHotfixesEntry=phionHotfixesEntry, hotfixInstallTime=hotfixInstallTime, ospfNeighborStatus=ospfNeighborStatus, vpnName=vpnName, ripNeighborsEntry=ripNeighborsEntry, ripGroup=ripGroup, noDelayPakets=noDelayPakets, ospfNeighbors=ospfNeighbors, hwSensorName=hwSensorName, phionRelease=phionRelease, serverServiceState=serverServiceState, partitionName=partitionName, class2Drop=class2Drop, trafficShape=trafficShape, firmwareGroups=firmwareGroups, partitionFreeSpace=partitionFreeSpace, diskspaceGroup=diskspaceGroup, hwSensorType=hwSensorType, ripNeighbors=ripNeighbors, netGroups=netGroups, bgpNeighborAddress=bgpNeighborAddress, serverServiceName=serverServiceName, connectorName=connectorName, raidEvents=raidEvents, bgpNeighborsEntry=bgpNeighborsEntry, eventAlarmTime=eventAlarmTime, boxServicesEntry=boxServicesEntry, raidGroup=raidGroup, noDelayDrop=noDelayDrop, sessions=sessions, class1Drop=class1Drop, dataThroughput64=dataThroughput64, fwStatsEntry=fwStatsEntry, serviceGroups=serviceGroups, noDelayTotal=noDelayTotal, hotfixGroup=hotfixGroup, PYSNMP_MODULE_ID=phion, partitionUsedSpacePercent=partitionUsedSpacePercent, partitionMaxSpace=partitionMaxSpace, ospfNeighborsEntry=ospfNeighborsEntry, bgpNeighborState=bgpNeighborState, VpnStates=VpnStates, fwCompliances=fwCompliances, raidEventsEntry=raidEventsEntry, serverGroup=serverGroup, fwstatsGroup=fwstatsGroup, eventIDDescription=eventIDDescription, boxServiceName=boxServiceName, boxServices=boxServices, ospfNeighborAddress=ospfNeighborAddress, diskSpaceEntry=diskSpaceEntry, class2Total=class2Total, partitionUsedSpace=partitionUsedSpace, eventTrap=eventTrap, class3Pakets=class3Pakets, eventGroup=eventGroup, eventID=eventID, ospfGroup=ospfGroup, raidEventText=raidEventText, ospfNeighborInterface=ospfNeighborInterface, hwGroups=hwGroups, packetThroughput=packetThroughput, ripNeighborAddress=ripNeighborAddress, vpnState=vpnState, class3Drop=class3Drop, phion=phion, bgpNeighbors=bgpNeighbors, diskSpace=diskSpace, RaidEventSeverity=RaidEventSeverity, raidEventIndex=raidEventIndex, firewallSessions=firewallSessions, raidEventSev=raidEventSev, class1Pakets=class1Pakets, ripNeighborState=ripNeighborState, eventLayerDescription=eventLayerDescription, boxServiceState=boxServiceState, vpnTunnelsEntry=vpnTunnelsEntry, trafficShapeEntry=trafficShapeEntry, eventSeverity=eventSeverity, vpnGroup=vpnGroup, class2Pakets=class2Pakets, ServiceState=ServiceState, eventRepresentation=eventRepresentation)
