...
iso, Bits, Counter32, Gauge32, MibIdentifier, TimeTicks, ModuleIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Integer32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Counter32", "Gauge32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Integer32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", netGroups=netGroups, class3Pakets=class3Pakets, diskSpace=diskSpace, PYSNMP_MODULE_ID=phion, vpnUsers=vpnUsers, diskspaceGroup=diskspaceGroup, firmwareGroups=firmwareGroups, VpnStates=VpnStates, hwGroups=hwGroups, sessions=sessions, class2Total=class2Total, serviceGroups=serviceGroups, ripNeighbors=ripNeighbors, dataThroughput=dataThroughput, class1Drop=class1Drop, partitionUsedSpace=partitionUsedSpace, ospfNeighborAddress=ospfNeighborAddress, fwStatsEntry=fwStatsEntry, connectorName=connectorName, boxServices=boxServices, vpnTunnelsEntry=vpnTunnelsEntry, vpnusersGroup=vpnusersGroup, phionRelease=phionRelease, raidEventText=raidEventText, raidEvents=raidEvents, boxGroup=boxGroup, bgpNeighborsEntry=bgpNeighborsEntry, eventLayerDescription=eventLayerDescription, ServiceState=ServiceState, phionHotfixes=phionHotfixes, bgpGroup=bgpGroup, hotfixName=hotfixName, hwSensors=hwSensors, notificationGroup=notificationGroup, hwSensorValue=hwSensorValue, diskSpaceEntry=diskSpaceEntry, raidEventTime=raidEventTime, ripNeighborsEntry=ripNeighborsEntry, firewallSessions64=firewallSessions64, raidEventSev=raidEventSev, vpnTunnels=vpnTunnels, releaseGroup=releaseGroup, eventIDDescription=eventIDDescription, eventTrap=eventTrap, noDelayDrop=noDelayDrop, fwstatsGroup=fwstatsGroup, eventAlarmTime=eventAlarmTime, serverGroup=serverGroup, class2Pakets=class2Pakets, bgpNeighborAddress=bgpNeighborAddress, partitionName=partitionName, raidEventIndex=raidEventIndex, ospfNeighborsEntry=ospfNeighborsEntry, RaidEventSeverity=RaidEventSeverity, hotfixInstallTime=hotfixInstallTime, serverServiceName=serverServiceName, eventRepresentation=eventRepresentation, hwSensorsEntry=hwSensorsEntry, eventGroup=eventGroup, eventGroups=eventGroups, phionHotfixesEntry=phionHotfixesEntry, class3Total=class3Total, hwSensorName=hwSensorName, class3Drop=class3Drop, ospfNeighborStatus=ospfNeighborStatus, vpnGroup=vpnGroup, ospfNeighborId=ospfNeighborId, rate=rate, partitionMaxSpace=partitionMaxSpace, trafficShape=trafficShape, ospfNeighbors=ospfNeighbors, serverServices=serverServices, firewall=firewall, packetThroughput64=packetThroughput64, class1Pakets=class1Pakets, phion=phion, SensorType=SensorType, ospfGroup=ospfGroup, hotfixGroup=hotfixGroup, raidEventsEntry=raidEventsEntry, ripNeighborAddress=ripNeighborAddress, partitionUsedSpacePercent=partitionUsedSpacePercent, packetThroughput=packetThroughput, boxServiceState=boxServiceState, event=event, trafficShapeEntry=trafficShapeEntry, fwGroups=fwGroups, ripNeighborState=ripNeighborState, eventClassification=eventClassification, ripGroup=ripGroup, class2Drop=class2Drop, hwSensorType=hwSensorType, eventSeverity=eventSeverity, serverServicesEntry=serverServicesEntry, vpnName=vpnName, ospfNeighborInterface=ospfNeighborInterface, bgpNeighborState=bgpNeighborState, vpnState=vpnState, fwCompliance=fwCompliance, fwStats=fwStats, firewallSessions=firewallSessions, boxServicesEntry=boxServicesEntry, eventID=eventID, raidGroup=raidGroup, hwGroup=hwGroup, class1Total=class1Total, serverServiceState=serverServiceState, noDelayTotal=noDelayTotal, eventType=eventType, trafficshapeGroup=trafficshapeGroup, boxServiceName=boxServiceName, noDelayPakets=noDelayPakets, fwCompliances=fwCompliances, partitionFreeSpace=partitionFreeSpace, dataThroughput64=dataThroughput64, bgpNeighbors=bgpNeighbors)
