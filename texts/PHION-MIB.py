...
TimeTicks, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, ModuleIdentity, Bits, Unsigned32, MibIdentifier, NotificationType, iso, Gauge32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "Gauge32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("PHION-MIB", sessions=sessions, fwGroups=fwGroups, boxServicesEntry=boxServicesEntry, ospfNeighborId=ospfNeighborId, trafficshapeGroup=trafficshapeGroup, class2Total=class2Total, noDelayPakets=noDelayPakets, serverServices=serverServices, eventGroups=eventGroups, raidGroup=raidGroup, bgpGroup=bgpGroup, hwGroup=hwGroup, ripNeighbors=ripNeighbors, PYSNMP_MODULE_ID=phion, vpnGroup=vpnGroup, firewallSessions=firewallSessions, dataThroughput=dataThroughput, class1Total=class1Total, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Drop=class3Drop, phionHotfixesEntry=phionHotfixesEntry, VpnStates=VpnStates, partitionFreeSpace=partitionFreeSpace, connectorName=connectorName, fwCompliance=fwCompliance, vpnState=vpnState, class3Pakets=class3Pakets, RaidEventSeverity=RaidEventSeverity, vpnUsers=vpnUsers, dataThroughput64=dataThroughput64, serverServicesEntry=serverServicesEntry, bgpNeighbors=bgpNeighbors, bgpNeighborState=bgpNeighborState, ospfNeighbors=ospfNeighbors, hwSensorValue=hwSensorValue, fwStatsEntry=fwStatsEntry, ripNeighborAddress=ripNeighborAddress, vpnusersGroup=vpnusersGroup, raidEventText=raidEventText, eventSeverity=eventSeverity, ripNeighborState=ripNeighborState, class1Drop=class1Drop, hotfixGroup=hotfixGroup, eventRepresentation=eventRepresentation, rate=rate, noDelayTotal=noDelayTotal, phionHotfixes=phionHotfixes, serverServiceState=serverServiceState, serverGroup=serverGroup, ospfGroup=ospfGroup, eventClassification=eventClassification, ServiceState=ServiceState, releaseGroup=releaseGroup, ripGroup=ripGroup, SensorType=SensorType, diskSpaceEntry=diskSpaceEntry, firewall=firewall, hwSensorsEntry=hwSensorsEntry, phionRelease=phionRelease, boxServiceName=boxServiceName, ospfNeighborStatus=ospfNeighborStatus, fwStats=fwStats, raidEvents=raidEvents, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighborAddress=ospfNeighborAddress, hotfixName=hotfixName, serviceGroups=serviceGroups, vpnName=vpnName, eventGroup=eventGroup, netGroups=netGroups, firewallSessions64=firewallSessions64, eventType=eventType, ospfNeighborsEntry=ospfNeighborsEntry, event=event, partitionName=partitionName, boxGroup=boxGroup, eventAlarmTime=eventAlarmTime, notificationGroup=notificationGroup, packetThroughput64=packetThroughput64, phion=phion, firmwareGroups=firmwareGroups, class3Total=class3Total, serverServiceName=serverServiceName, fwCompliances=fwCompliances, raidEventIndex=raidEventIndex, eventID=eventID, vpnTunnels=vpnTunnels, partitionUsedSpace=partitionUsedSpace, fwstatsGroup=fwstatsGroup, class2Drop=class2Drop, class1Pakets=class1Pakets, diskspaceGroup=diskspaceGroup, trafficShapeEntry=trafficShapeEntry, eventIDDescription=eventIDDescription, hotfixInstallTime=hotfixInstallTime, eventTrap=eventTrap, vpnTunnelsEntry=vpnTunnelsEntry, hwSensorType=hwSensorType, boxServiceState=boxServiceState, raidEventTime=raidEventTime, raidEventsEntry=raidEventsEntry, diskSpace=diskSpace, noDelayDrop=noDelayDrop, ripNeighborsEntry=ripNeighborsEntry, partitionMaxSpace=partitionMaxSpace, hwSensorName=hwSensorName, trafficShape=trafficShape, eventLayerDescription=eventLayerDescription, packetThroughput=packetThroughput, ospfNeighborInterface=ospfNeighborInterface, raidEventSev=raidEventSev, bgpNeighborAddress=bgpNeighborAddress, hwGroups=hwGroups, boxServices=boxServices, class2Pakets=class2Pakets, hwSensors=hwSensors)
