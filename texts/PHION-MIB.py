...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, Integer32, Unsigned32, IpAddress, iso, ObjectIdentity, Bits, NotificationType, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "Integer32", "Unsigned32", "IpAddress", "iso", "ObjectIdentity", "Bits", "NotificationType", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", trafficShape=trafficShape, boxServiceName=boxServiceName, phionHotfixesEntry=phionHotfixesEntry, serverServicesEntry=serverServicesEntry, noDelayDrop=noDelayDrop, eventType=eventType, vpnState=vpnState, class2Drop=class2Drop, hotfixInstallTime=hotfixInstallTime, hwGroup=hwGroup, hotfixGroup=hotfixGroup, vpnGroup=vpnGroup, ospfNeighborsEntry=ospfNeighborsEntry, trafficshapeGroup=trafficshapeGroup, serverServiceState=serverServiceState, eventGroup=eventGroup, ospfNeighborId=ospfNeighborId, fwstatsGroup=fwstatsGroup, class1Drop=class1Drop, partitionUsedSpacePercent=partitionUsedSpacePercent, partitionFreeSpace=partitionFreeSpace, firewall=firewall, phionRelease=phionRelease, connectorName=connectorName, boxGroup=boxGroup, raidGroup=raidGroup, ripNeighborState=ripNeighborState, vpnTunnelsEntry=vpnTunnelsEntry, netGroups=netGroups, hwSensorName=hwSensorName, fwCompliance=fwCompliance, ospfNeighborAddress=ospfNeighborAddress, firewallSessions=firewallSessions, rate=rate, diskSpaceEntry=diskSpaceEntry, partitionUsedSpace=partitionUsedSpace, eventSeverity=eventSeverity, class1Pakets=class1Pakets, hwSensors=hwSensors, SensorType=SensorType, class3Drop=class3Drop, raidEventsEntry=raidEventsEntry, bgpNeighborsEntry=bgpNeighborsEntry, fwCompliances=fwCompliances, diskspaceGroup=diskspaceGroup, boxServices=boxServices, ospfNeighbors=ospfNeighbors, serverServices=serverServices, dataThroughput64=dataThroughput64, serviceGroups=serviceGroups, bgpNeighbors=bgpNeighbors, dataThroughput=dataThroughput, eventID=eventID, trafficShapeEntry=trafficShapeEntry, partitionMaxSpace=partitionMaxSpace, boxServicesEntry=boxServicesEntry, eventTrap=eventTrap, serverGroup=serverGroup, fwStatsEntry=fwStatsEntry, packetThroughput64=packetThroughput64, ospfGroup=ospfGroup, vpnusersGroup=vpnusersGroup, sessions=sessions, class2Pakets=class2Pakets, bgpNeighborState=bgpNeighborState, firmwareGroups=firmwareGroups, firewallSessions64=firewallSessions64, class3Total=class3Total, ripNeighborAddress=ripNeighborAddress, ospfNeighborStatus=ospfNeighborStatus, hotfixName=hotfixName, hwSensorValue=hwSensorValue, notificationGroup=notificationGroup, eventLayerDescription=eventLayerDescription, PYSNMP_MODULE_ID=phion, raidEventIndex=raidEventIndex, eventIDDescription=eventIDDescription, ServiceState=ServiceState, noDelayPakets=noDelayPakets, eventClassification=eventClassification, raidEvents=raidEvents, eventAlarmTime=eventAlarmTime, boxServiceState=boxServiceState, vpnName=vpnName, class3Pakets=class3Pakets, ripGroup=ripGroup, raidEventTime=raidEventTime, raidEventText=raidEventText, bgpNeighborAddress=bgpNeighborAddress, ospfNeighborInterface=ospfNeighborInterface, noDelayTotal=noDelayTotal, eventRepresentation=eventRepresentation, hwGroups=hwGroups, diskSpace=diskSpace, class1Total=class1Total, packetThroughput=packetThroughput, phionHotfixes=phionHotfixes, hwSensorType=hwSensorType, ripNeighbors=ripNeighbors, releaseGroup=releaseGroup, event=event, RaidEventSeverity=RaidEventSeverity, fwStats=fwStats, vpnUsers=vpnUsers, VpnStates=VpnStates, class2Total=class2Total, hwSensorsEntry=hwSensorsEntry, vpnTunnels=vpnTunnels, eventGroups=eventGroups, phion=phion, ripNeighborsEntry=ripNeighborsEntry, bgpGroup=bgpGroup, raidEventSev=raidEventSev, serverServiceName=serverServiceName, partitionName=partitionName, fwGroups=fwGroups)
