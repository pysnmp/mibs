...
ModuleIdentity, enterprises, ObjectIdentity, Unsigned32, Counter64, iso, TimeTicks, Integer32, NotificationType, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "ObjectIdentity", "Unsigned32", "Counter64", "iso", "TimeTicks", "Integer32", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("PHION-MIB", bgpNeighborAddress=bgpNeighborAddress, fwStatsEntry=fwStatsEntry, eventSeverity=eventSeverity, class1Drop=class1Drop, class2Total=class2Total, packetThroughput64=packetThroughput64, eventLayerDescription=eventLayerDescription, ospfNeighborInterface=ospfNeighborInterface, firewallSessions=firewallSessions, raidEventSev=raidEventSev, trafficshapeGroup=trafficshapeGroup, raidEventIndex=raidEventIndex, ospfNeighborStatus=ospfNeighborStatus, vpnTunnels=vpnTunnels, serviceGroups=serviceGroups, class3Pakets=class3Pakets, serverGroup=serverGroup, partitionUsedSpace=partitionUsedSpace, trafficShapeEntry=trafficShapeEntry, raidEventText=raidEventText, phionRelease=phionRelease, dataThroughput64=dataThroughput64, hwSensorType=hwSensorType, noDelayDrop=noDelayDrop, boxServices=boxServices, fwStats=fwStats, fwCompliance=fwCompliance, vpnGroup=vpnGroup, hwGroups=hwGroups, firewallSessions64=firewallSessions64, boxServiceState=boxServiceState, diskSpaceEntry=diskSpaceEntry, ospfNeighborId=ospfNeighborId, bgpGroup=bgpGroup, partitionFreeSpace=partitionFreeSpace, firmwareGroups=firmwareGroups, bgpNeighborState=bgpNeighborState, releaseGroup=releaseGroup, eventGroup=eventGroup, event=event, serverServices=serverServices, boxServiceName=boxServiceName, ripNeighborsEntry=ripNeighborsEntry, eventType=eventType, fwstatsGroup=fwstatsGroup, dataThroughput=dataThroughput, RaidEventSeverity=RaidEventSeverity, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Drop=class3Drop, firewall=firewall, packetThroughput=packetThroughput, rate=rate, boxServicesEntry=boxServicesEntry, diskSpace=diskSpace, ospfNeighbors=ospfNeighbors, raidEventsEntry=raidEventsEntry, phionHotfixesEntry=phionHotfixesEntry, vpnState=vpnState, eventClassification=eventClassification, ripNeighborState=ripNeighborState, raidEventTime=raidEventTime, ospfGroup=ospfGroup, boxGroup=boxGroup, fwGroups=fwGroups, phionHotfixes=phionHotfixes, serverServiceState=serverServiceState, vpnTunnelsEntry=vpnTunnelsEntry, ripGroup=ripGroup, hwSensors=hwSensors, VpnStates=VpnStates, hwSensorsEntry=hwSensorsEntry, class3Total=class3Total, hotfixGroup=hotfixGroup, hwSensorValue=hwSensorValue, vpnusersGroup=vpnusersGroup, hotfixInstallTime=hotfixInstallTime, class2Pakets=class2Pakets, connectorName=connectorName, SensorType=SensorType, eventTrap=eventTrap, PYSNMP_MODULE_ID=phion, phion=phion, fwCompliances=fwCompliances, notificationGroup=notificationGroup, eventIDDescription=eventIDDescription, eventID=eventID, hotfixName=hotfixName, trafficShape=trafficShape, hwSensorName=hwSensorName, class1Total=class1Total, hwGroup=hwGroup, serverServicesEntry=serverServicesEntry, partitionMaxSpace=partitionMaxSpace, ripNeighborAddress=ripNeighborAddress, ripNeighbors=ripNeighbors, netGroups=netGroups, sessions=sessions, class1Pakets=class1Pakets, class2Drop=class2Drop, ServiceState=ServiceState, noDelayPakets=noDelayPakets, diskspaceGroup=diskspaceGroup, partitionName=partitionName, vpnName=vpnName, raidEvents=raidEvents, eventGroups=eventGroups, vpnUsers=vpnUsers, eventAlarmTime=eventAlarmTime, eventRepresentation=eventRepresentation, noDelayTotal=noDelayTotal, bgpNeighborsEntry=bgpNeighborsEntry, serverServiceName=serverServiceName, ospfNeighborAddress=ospfNeighborAddress, bgpNeighbors=bgpNeighbors, raidGroup=raidGroup, ospfNeighborsEntry=ospfNeighborsEntry)
