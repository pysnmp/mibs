...
ModuleIdentity, Gauge32, IpAddress, MibIdentifier, Counter64, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Integer32, NotificationType, enterprises, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Integer32", "NotificationType", "enterprises", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("PHION-MIB", hotfixName=hotfixName, sessions=sessions, firewallSessions64=firewallSessions64, raidEventsEntry=raidEventsEntry, raidEventIndex=raidEventIndex, class2Total=class2Total, dataThroughput64=dataThroughput64, eventGroup=eventGroup, bgpGroup=bgpGroup, ripNeighborAddress=ripNeighborAddress, diskSpace=diskSpace, vpnTunnels=vpnTunnels, class1Pakets=class1Pakets, ripNeighborState=ripNeighborState, packetThroughput=packetThroughput, ospfGroup=ospfGroup, eventLayerDescription=eventLayerDescription, raidEventSev=raidEventSev, hwSensorsEntry=hwSensorsEntry, boxGroup=boxGroup, boxServiceState=boxServiceState, ospfNeighborAddress=ospfNeighborAddress, eventGroups=eventGroups, phionHotfixes=phionHotfixes, serverServices=serverServices, ospfNeighbors=ospfNeighbors, noDelayPakets=noDelayPakets, partitionUsedSpacePercent=partitionUsedSpacePercent, diskspaceGroup=diskspaceGroup, hotfixGroup=hotfixGroup, boxServices=boxServices, serviceGroups=serviceGroups, hwSensorType=hwSensorType, eventID=eventID, fwCompliance=fwCompliance, hwSensors=hwSensors, raidGroup=raidGroup, serverServiceName=serverServiceName, ripGroup=ripGroup, class2Drop=class2Drop, partitionMaxSpace=partitionMaxSpace, class3Pakets=class3Pakets, hotfixInstallTime=hotfixInstallTime, vpnusersGroup=vpnusersGroup, vpnName=vpnName, fwstatsGroup=fwstatsGroup, phionHotfixesEntry=phionHotfixesEntry, bgpNeighborsEntry=bgpNeighborsEntry, vpnState=vpnState, raidEventText=raidEventText, eventClassification=eventClassification, hwSensorValue=hwSensorValue, fwCompliances=fwCompliances, class2Pakets=class2Pakets, class3Total=class3Total, vpnTunnelsEntry=vpnTunnelsEntry, noDelayTotal=noDelayTotal, phion=phion, ospfNeighborInterface=ospfNeighborInterface, RaidEventSeverity=RaidEventSeverity, netGroups=netGroups, noDelayDrop=noDelayDrop, ospfNeighborStatus=ospfNeighborStatus, firewall=firewall, ospfNeighborId=ospfNeighborId, phionRelease=phionRelease, connectorName=connectorName, vpnUsers=vpnUsers, diskSpaceEntry=diskSpaceEntry, class3Drop=class3Drop, serverGroup=serverGroup, releaseGroup=releaseGroup, trafficShapeEntry=trafficShapeEntry, notificationGroup=notificationGroup, boxServiceName=boxServiceName, bgpNeighborAddress=bgpNeighborAddress, PYSNMP_MODULE_ID=phion, vpnGroup=vpnGroup, boxServicesEntry=boxServicesEntry, SensorType=SensorType, eventTrap=eventTrap, VpnStates=VpnStates, packetThroughput64=packetThroughput64, trafficshapeGroup=trafficshapeGroup, fwGroups=fwGroups, class1Total=class1Total, firewallSessions=firewallSessions, eventType=eventType, fwStats=fwStats, eventIDDescription=eventIDDescription, raidEvents=raidEvents, serverServiceState=serverServiceState, ripNeighbors=ripNeighbors, eventRepresentation=eventRepresentation, ripNeighborsEntry=ripNeighborsEntry, event=event, eventAlarmTime=eventAlarmTime, ServiceState=ServiceState, hwGroups=hwGroups, dataThroughput=dataThroughput, serverServicesEntry=serverServicesEntry, hwSensorName=hwSensorName, rate=rate, partitionUsedSpace=partitionUsedSpace, partitionName=partitionName, hwGroup=hwGroup, firmwareGroups=firmwareGroups, ospfNeighborsEntry=ospfNeighborsEntry, partitionFreeSpace=partitionFreeSpace, bgpNeighborState=bgpNeighborState, class1Drop=class1Drop, fwStatsEntry=fwStatsEntry, trafficShape=trafficShape, raidEventTime=raidEventTime, bgpNeighbors=bgpNeighbors, eventSeverity=eventSeverity)
