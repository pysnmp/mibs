...
enterprises, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, MibIdentifier, TimeTicks, Gauge32, Counter32, Counter64, Integer32, iso, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Gauge32", "Counter32", "Counter64", "Integer32", "iso", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", class3Total=class3Total, hwSensorName=hwSensorName, raidGroup=raidGroup, vpnState=vpnState, bgpNeighbors=bgpNeighbors, ospfGroup=ospfGroup, ripNeighbors=ripNeighbors, firewall=firewall, noDelayDrop=noDelayDrop, raidEvents=raidEvents, ospfNeighborsEntry=ospfNeighborsEntry, serverServices=serverServices, ripNeighborState=ripNeighborState, fwStats=fwStats, hotfixInstallTime=hotfixInstallTime, vpnGroup=vpnGroup, vpnusersGroup=vpnusersGroup, boxServiceState=boxServiceState, netGroups=netGroups, ospfNeighbors=ospfNeighbors, eventGroups=eventGroups, boxGroup=boxGroup, class2Pakets=class2Pakets, eventRepresentation=eventRepresentation, raidEventsEntry=raidEventsEntry, serverGroup=serverGroup, hwSensors=hwSensors, serverServiceState=serverServiceState, ripNeighborsEntry=ripNeighborsEntry, class1Drop=class1Drop, class3Drop=class3Drop, serverServicesEntry=serverServicesEntry, fwStatsEntry=fwStatsEntry, fwstatsGroup=fwstatsGroup, class2Drop=class2Drop, eventTrap=eventTrap, PYSNMP_MODULE_ID=phion, partitionName=partitionName, hwGroups=hwGroups, eventType=eventType, partitionUsedSpace=partitionUsedSpace, dataThroughput64=dataThroughput64, trafficshapeGroup=trafficshapeGroup, class2Total=class2Total, packetThroughput=packetThroughput, phionHotfixes=phionHotfixes, noDelayTotal=noDelayTotal, noDelayPakets=noDelayPakets, eventIDDescription=eventIDDescription, eventGroup=eventGroup, boxServiceName=boxServiceName, hotfixGroup=hotfixGroup, diskSpace=diskSpace, sessions=sessions, trafficShapeEntry=trafficShapeEntry, rate=rate, class1Total=class1Total, serviceGroups=serviceGroups, vpnTunnels=vpnTunnels, ServiceState=ServiceState, class1Pakets=class1Pakets, bgpNeighborState=bgpNeighborState, vpnName=vpnName, hotfixName=hotfixName, diskSpaceEntry=diskSpaceEntry, phionHotfixesEntry=phionHotfixesEntry, hwGroup=hwGroup, eventAlarmTime=eventAlarmTime, vpnUsers=vpnUsers, hwSensorType=hwSensorType, boxServices=boxServices, bgpGroup=bgpGroup, firewallSessions=firewallSessions, firmwareGroups=firmwareGroups, vpnTunnelsEntry=vpnTunnelsEntry, eventSeverity=eventSeverity, firewallSessions64=firewallSessions64, ospfNeighborAddress=ospfNeighborAddress, RaidEventSeverity=RaidEventSeverity, dataThroughput=dataThroughput, ripGroup=ripGroup, raidEventSev=raidEventSev, notificationGroup=notificationGroup, partitionMaxSpace=partitionMaxSpace, class3Pakets=class3Pakets, raidEventTime=raidEventTime, fwCompliances=fwCompliances, event=event, SensorType=SensorType, serverServiceName=serverServiceName, VpnStates=VpnStates, eventClassification=eventClassification, boxServicesEntry=boxServicesEntry, raidEventIndex=raidEventIndex, partitionFreeSpace=partitionFreeSpace, ospfNeighborInterface=ospfNeighborInterface, ripNeighborAddress=ripNeighborAddress, hwSensorsEntry=hwSensorsEntry, trafficShape=trafficShape, eventLayerDescription=eventLayerDescription, ospfNeighborStatus=ospfNeighborStatus, fwCompliance=fwCompliance, phion=phion, fwGroups=fwGroups, releaseGroup=releaseGroup, raidEventText=raidEventText, eventID=eventID, connectorName=connectorName, phionRelease=phionRelease, ospfNeighborId=ospfNeighborId, bgpNeighborsEntry=bgpNeighborsEntry, diskspaceGroup=diskspaceGroup, hwSensorValue=hwSensorValue, bgpNeighborAddress=bgpNeighborAddress, partitionUsedSpacePercent=partitionUsedSpacePercent, packetThroughput64=packetThroughput64)
