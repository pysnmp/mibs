...
Integer32, IpAddress, Counter64, iso, Bits, ObjectIdentity, MibIdentifier, Unsigned32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter64", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("PHION-MIB", hotfixName=hotfixName, boxServices=boxServices, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighborStatus=ospfNeighborStatus, partitionName=partitionName, phionHotfixes=phionHotfixes, bgpGroup=bgpGroup, vpnUsers=vpnUsers, diskspaceGroup=diskspaceGroup, notificationGroup=notificationGroup, serverGroup=serverGroup, class1Pakets=class1Pakets, raidEventText=raidEventText, fwStats=fwStats, packetThroughput=packetThroughput, serverServices=serverServices, VpnStates=VpnStates, fwstatsGroup=fwstatsGroup, hwSensorName=hwSensorName, vpnusersGroup=vpnusersGroup, firewall=firewall, partitionFreeSpace=partitionFreeSpace, hwGroup=hwGroup, hwSensorsEntry=hwSensorsEntry, ospfNeighborInterface=ospfNeighborInterface, eventGroups=eventGroups, trafficshapeGroup=trafficshapeGroup, fwCompliances=fwCompliances, vpnTunnels=vpnTunnels, eventClassification=eventClassification, raidEventSev=raidEventSev, bgpNeighbors=bgpNeighbors, ospfGroup=ospfGroup, hwSensorType=hwSensorType, netGroups=netGroups, ospfNeighbors=ospfNeighbors, dataThroughput=dataThroughput, class2Total=class2Total, partitionMaxSpace=partitionMaxSpace, partitionUsedSpacePercent=partitionUsedSpacePercent, firewallSessions=firewallSessions, eventID=eventID, packetThroughput64=packetThroughput64, class1Total=class1Total, vpnTunnelsEntry=vpnTunnelsEntry, bgpNeighborState=bgpNeighborState, bgpNeighborAddress=bgpNeighborAddress, ripGroup=ripGroup, firmwareGroups=firmwareGroups, vpnGroup=vpnGroup, ripNeighborAddress=ripNeighborAddress, vpnName=vpnName, boxServiceState=boxServiceState, ripNeighborState=ripNeighborState, eventIDDescription=eventIDDescription, ospfNeighborId=ospfNeighborId, boxServicesEntry=boxServicesEntry, class2Drop=class2Drop, partitionUsedSpace=partitionUsedSpace, sessions=sessions, eventSeverity=eventSeverity, phionRelease=phionRelease, firewallSessions64=firewallSessions64, raidEventsEntry=raidEventsEntry, dataThroughput64=dataThroughput64, class3Pakets=class3Pakets, noDelayDrop=noDelayDrop, RaidEventSeverity=RaidEventSeverity, SensorType=SensorType, fwGroups=fwGroups, vpnState=vpnState, eventTrap=eventTrap, boxServiceName=boxServiceName, hotfixInstallTime=hotfixInstallTime, trafficShape=trafficShape, diskSpace=diskSpace, class3Total=class3Total, eventGroup=eventGroup, phionHotfixesEntry=phionHotfixesEntry, serverServicesEntry=serverServicesEntry, phion=phion, ripNeighbors=ripNeighbors, class1Drop=class1Drop, raidEvents=raidEvents, noDelayTotal=noDelayTotal, raidGroup=raidGroup, eventType=eventType, event=event, raidEventIndex=raidEventIndex, rate=rate, eventLayerDescription=eventLayerDescription, noDelayPakets=noDelayPakets, raidEventTime=raidEventTime, diskSpaceEntry=diskSpaceEntry, PYSNMP_MODULE_ID=phion, hwSensors=hwSensors, trafficShapeEntry=trafficShapeEntry, ripNeighborsEntry=ripNeighborsEntry, connectorName=connectorName, hwSensorValue=hwSensorValue, eventRepresentation=eventRepresentation, boxGroup=boxGroup, serverServiceName=serverServiceName, fwCompliance=fwCompliance, class3Drop=class3Drop, serverServiceState=serverServiceState, ospfNeighborAddress=ospfNeighborAddress, eventAlarmTime=eventAlarmTime, ServiceState=ServiceState, class2Pakets=class2Pakets, hotfixGroup=hotfixGroup, fwStatsEntry=fwStatsEntry, releaseGroup=releaseGroup, ospfNeighborsEntry=ospfNeighborsEntry, hwGroups=hwGroups, serviceGroups=serviceGroups)
