...
TimeTicks, Integer32, Unsigned32, Bits, enterprises, Counter64, NotificationType, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Unsigned32", "Bits", "enterprises", "Counter64", "NotificationType", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("PHION-MIB", firewall=firewall, serverServicesEntry=serverServicesEntry, hwGroups=hwGroups, dataThroughput64=dataThroughput64, phion=phion, netGroups=netGroups, PYSNMP_MODULE_ID=phion, ospfNeighborInterface=ospfNeighborInterface, class3Pakets=class3Pakets, diskspaceGroup=diskspaceGroup, SensorType=SensorType, vpnName=vpnName, trafficShapeEntry=trafficShapeEntry, ripNeighborState=ripNeighborState, bgpGroup=bgpGroup, partitionMaxSpace=partitionMaxSpace, event=event, fwCompliance=fwCompliance, phionHotfixes=phionHotfixes, serverServices=serverServices, firewallSessions=firewallSessions, eventID=eventID, hwGroup=hwGroup, serverGroup=serverGroup, vpnState=vpnState, hwSensorsEntry=hwSensorsEntry, class1Total=class1Total, sessions=sessions, connectorName=connectorName, raidEvents=raidEvents, raidEventSev=raidEventSev, class1Pakets=class1Pakets, hwSensors=hwSensors, trafficShape=trafficShape, eventLayerDescription=eventLayerDescription, vpnTunnels=vpnTunnels, bgpNeighborsEntry=bgpNeighborsEntry, phionRelease=phionRelease, vpnusersGroup=vpnusersGroup, ospfNeighbors=ospfNeighbors, hwSensorValue=hwSensorValue, class1Drop=class1Drop, vpnUsers=vpnUsers, class3Total=class3Total, class2Drop=class2Drop, boxGroup=boxGroup, serverServiceState=serverServiceState, hwSensorType=hwSensorType, diskSpaceEntry=diskSpaceEntry, RaidEventSeverity=RaidEventSeverity, ripNeighborAddress=ripNeighborAddress, bgpNeighborState=bgpNeighborState, eventType=eventType, VpnStates=VpnStates, raidGroup=raidGroup, eventTrap=eventTrap, releaseGroup=releaseGroup, raidEventIndex=raidEventIndex, bgpNeighbors=bgpNeighbors, class2Total=class2Total, eventClassification=eventClassification, boxServices=boxServices, hotfixGroup=hotfixGroup, ripGroup=ripGroup, vpnGroup=vpnGroup, ospfGroup=ospfGroup, eventAlarmTime=eventAlarmTime, fwstatsGroup=fwstatsGroup, partitionFreeSpace=partitionFreeSpace, trafficshapeGroup=trafficshapeGroup, fwGroups=fwGroups, ospfNeighborAddress=ospfNeighborAddress, fwStatsEntry=fwStatsEntry, eventGroups=eventGroups, diskSpace=diskSpace, ripNeighbors=ripNeighbors, hotfixName=hotfixName, ospfNeighborsEntry=ospfNeighborsEntry, dataThroughput=dataThroughput, eventSeverity=eventSeverity, ripNeighborsEntry=ripNeighborsEntry, noDelayDrop=noDelayDrop, packetThroughput64=packetThroughput64, raidEventTime=raidEventTime, bgpNeighborAddress=bgpNeighborAddress, boxServicesEntry=boxServicesEntry, firmwareGroups=firmwareGroups, fwStats=fwStats, firewallSessions64=firewallSessions64, rate=rate, ospfNeighborId=ospfNeighborId, serverServiceName=serverServiceName, ServiceState=ServiceState, boxServiceState=boxServiceState, partitionUsedSpacePercent=partitionUsedSpacePercent, serviceGroups=serviceGroups, eventGroup=eventGroup, partitionName=partitionName, hotfixInstallTime=hotfixInstallTime, ospfNeighborStatus=ospfNeighborStatus, class2Pakets=class2Pakets, hwSensorName=hwSensorName, packetThroughput=packetThroughput, eventRepresentation=eventRepresentation, class3Drop=class3Drop, raidEventsEntry=raidEventsEntry, raidEventText=raidEventText, noDelayTotal=noDelayTotal, partitionUsedSpace=partitionUsedSpace, boxServiceName=boxServiceName, eventIDDescription=eventIDDescription, noDelayPakets=noDelayPakets, fwCompliances=fwCompliances, phionHotfixesEntry=phionHotfixesEntry, vpnTunnelsEntry=vpnTunnelsEntry, notificationGroup=notificationGroup)
