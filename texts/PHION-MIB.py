...
TimeTicks, enterprises, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64, Integer32, iso, ModuleIdentity, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64", "Integer32", "iso", "ModuleIdentity", "Unsigned32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("PHION-MIB", vpnGroup=vpnGroup, fwStats=fwStats, class3Drop=class3Drop, fwCompliances=fwCompliances, partitionFreeSpace=partitionFreeSpace, raidEventIndex=raidEventIndex, class2Total=class2Total, vpnName=vpnName, hwSensors=hwSensors, trafficshapeGroup=trafficshapeGroup, eventTrap=eventTrap, sessions=sessions, ripNeighbors=ripNeighbors, notificationGroup=notificationGroup, ospfNeighborId=ospfNeighborId, partitionName=partitionName, raidEventsEntry=raidEventsEntry, ospfNeighborsEntry=ospfNeighborsEntry, event=event, bgpNeighborsEntry=bgpNeighborsEntry, bgpNeighbors=bgpNeighbors, fwstatsGroup=fwstatsGroup, hwSensorType=hwSensorType, raidEventTime=raidEventTime, eventLayerDescription=eventLayerDescription, packetThroughput=packetThroughput, noDelayDrop=noDelayDrop, hotfixInstallTime=hotfixInstallTime, raidEventSev=raidEventSev, dataThroughput=dataThroughput, class1Drop=class1Drop, raidGroup=raidGroup, vpnTunnelsEntry=vpnTunnelsEntry, eventGroup=eventGroup, ripNeighborState=ripNeighborState, serverServiceName=serverServiceName, serverGroup=serverGroup, phion=phion, diskSpaceEntry=diskSpaceEntry, hwSensorName=hwSensorName, boxGroup=boxGroup, vpnTunnels=vpnTunnels, boxServices=boxServices, class3Pakets=class3Pakets, firmwareGroups=firmwareGroups, class2Drop=class2Drop, firewallSessions64=firewallSessions64, packetThroughput64=packetThroughput64, ospfNeighborAddress=ospfNeighborAddress, class1Total=class1Total, bgpNeighborState=bgpNeighborState, noDelayTotal=noDelayTotal, ospfNeighbors=ospfNeighbors, phionRelease=phionRelease, ServiceState=ServiceState, raidEventText=raidEventText, eventType=eventType, fwStatsEntry=fwStatsEntry, boxServiceState=boxServiceState, vpnusersGroup=vpnusersGroup, partitionMaxSpace=partitionMaxSpace, dataThroughput64=dataThroughput64, ripGroup=ripGroup, class3Total=class3Total, serverServiceState=serverServiceState, diskspaceGroup=diskspaceGroup, firewallSessions=firewallSessions, eventIDDescription=eventIDDescription, serverServices=serverServices, bgpNeighborAddress=bgpNeighborAddress, connectorName=connectorName, eventGroups=eventGroups, serverServicesEntry=serverServicesEntry, vpnState=vpnState, ospfNeighborStatus=ospfNeighborStatus, raidEvents=raidEvents, fwCompliance=fwCompliance, eventSeverity=eventSeverity, diskSpace=diskSpace, vpnUsers=vpnUsers, ospfNeighborInterface=ospfNeighborInterface, hwSensorValue=hwSensorValue, VpnStates=VpnStates, partitionUsedSpacePercent=partitionUsedSpacePercent, class2Pakets=class2Pakets, ripNeighborAddress=ripNeighborAddress, PYSNMP_MODULE_ID=phion, firewall=firewall, phionHotfixesEntry=phionHotfixesEntry, bgpGroup=bgpGroup, trafficShapeEntry=trafficShapeEntry, eventRepresentation=eventRepresentation, boxServiceName=boxServiceName, class1Pakets=class1Pakets, releaseGroup=releaseGroup, rate=rate, phionHotfixes=phionHotfixes, noDelayPakets=noDelayPakets, RaidEventSeverity=RaidEventSeverity, boxServicesEntry=boxServicesEntry, hotfixName=hotfixName, hwSensorsEntry=hwSensorsEntry, partitionUsedSpace=partitionUsedSpace, netGroups=netGroups, ripNeighborsEntry=ripNeighborsEntry, fwGroups=fwGroups, hotfixGroup=hotfixGroup, eventClassification=eventClassification, eventAlarmTime=eventAlarmTime, trafficShape=trafficShape, ospfGroup=ospfGroup, eventID=eventID, hwGroups=hwGroups, SensorType=SensorType, hwGroup=hwGroup, serviceGroups=serviceGroups)
