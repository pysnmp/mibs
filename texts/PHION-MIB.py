...
TimeTicks, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter64, Integer32, MibIdentifier, Bits, Gauge32, ModuleIdentity, Unsigned32, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter64", "Integer32", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "Unsigned32", "iso", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", vpnName=vpnName, noDelayTotal=noDelayTotal, boxGroup=boxGroup, boxServiceName=boxServiceName, firewallSessions=firewallSessions, class1Total=class1Total, phionRelease=phionRelease, connectorName=connectorName, eventSeverity=eventSeverity, diskspaceGroup=diskspaceGroup, fwGroups=fwGroups, bgpNeighborAddress=bgpNeighborAddress, hwGroups=hwGroups, fwStats=fwStats, hwSensorValue=hwSensorValue, partitionUsedSpacePercent=partitionUsedSpacePercent, fwstatsGroup=fwstatsGroup, ospfNeighborAddress=ospfNeighborAddress, event=event, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighbors=ospfNeighbors, boxServiceState=boxServiceState, bgpNeighborState=bgpNeighborState, vpnTunnels=vpnTunnels, class2Total=class2Total, bgpNeighbors=bgpNeighbors, hotfixInstallTime=hotfixInstallTime, vpnState=vpnState, partitionName=partitionName, phionHotfixes=phionHotfixes, ripGroup=ripGroup, eventAlarmTime=eventAlarmTime, ospfNeighborsEntry=ospfNeighborsEntry, class2Drop=class2Drop, raidEventTime=raidEventTime, dataThroughput=dataThroughput, eventClassification=eventClassification, eventTrap=eventTrap, boxServicesEntry=boxServicesEntry, fwCompliance=fwCompliance, serverGroup=serverGroup, raidGroup=raidGroup, ospfNeighborStatus=ospfNeighborStatus, raidEventIndex=raidEventIndex, eventType=eventType, ServiceState=ServiceState, vpnGroup=vpnGroup, eventID=eventID, bgpGroup=bgpGroup, releaseGroup=releaseGroup, PYSNMP_MODULE_ID=phion, hwSensorType=hwSensorType, boxServices=boxServices, diskSpaceEntry=diskSpaceEntry, noDelayPakets=noDelayPakets, firewall=firewall, serverServiceState=serverServiceState, eventRepresentation=eventRepresentation, eventLayerDescription=eventLayerDescription, firewallSessions64=firewallSessions64, partitionUsedSpace=partitionUsedSpace, hwSensorsEntry=hwSensorsEntry, trafficshapeGroup=trafficshapeGroup, serverServiceName=serverServiceName, phion=phion, partitionMaxSpace=partitionMaxSpace, trafficShapeEntry=trafficShapeEntry, serverServicesEntry=serverServicesEntry, ospfNeighborId=ospfNeighborId, serviceGroups=serviceGroups, ripNeighborAddress=ripNeighborAddress, hwGroup=hwGroup, serverServices=serverServices, fwStatsEntry=fwStatsEntry, hotfixName=hotfixName, packetThroughput64=packetThroughput64, eventIDDescription=eventIDDescription, phionHotfixesEntry=phionHotfixesEntry, class2Pakets=class2Pakets, class1Pakets=class1Pakets, trafficShape=trafficShape, class3Pakets=class3Pakets, netGroups=netGroups, ospfGroup=ospfGroup, raidEventSev=raidEventSev, ripNeighborsEntry=ripNeighborsEntry, hwSensors=hwSensors, noDelayDrop=noDelayDrop, SensorType=SensorType, fwCompliances=fwCompliances, packetThroughput=packetThroughput, vpnUsers=vpnUsers, ripNeighborState=ripNeighborState, firmwareGroups=firmwareGroups, ripNeighbors=ripNeighbors, class3Total=class3Total, raidEvents=raidEvents, class3Drop=class3Drop, raidEventsEntry=raidEventsEntry, sessions=sessions, partitionFreeSpace=partitionFreeSpace, dataThroughput64=dataThroughput64, hotfixGroup=hotfixGroup, rate=rate, notificationGroup=notificationGroup, RaidEventSeverity=RaidEventSeverity, eventGroups=eventGroups, raidEventText=raidEventText, ospfNeighborInterface=ospfNeighborInterface, diskSpace=diskSpace, vpnusersGroup=vpnusersGroup, VpnStates=VpnStates, hwSensorName=hwSensorName, class1Drop=class1Drop, vpnTunnelsEntry=vpnTunnelsEntry, eventGroup=eventGroup)
