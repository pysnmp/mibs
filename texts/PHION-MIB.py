...
TimeTicks, Gauge32, iso, Integer32, enterprises, Bits, Counter32, NotificationType, MibIdentifier, ModuleIdentity, Unsigned32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "iso", "Integer32", "enterprises", "Bits", "Counter32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("PHION-MIB", serviceGroups=serviceGroups, eventAlarmTime=eventAlarmTime, ripNeighbors=ripNeighbors, hwGroups=hwGroups, boxServiceState=boxServiceState, ospfNeighborAddress=ospfNeighborAddress, diskSpaceEntry=diskSpaceEntry, hwSensorType=hwSensorType, raidEventText=raidEventText, vpnState=vpnState, bgpNeighborsEntry=bgpNeighborsEntry, class1Pakets=class1Pakets, trafficShape=trafficShape, vpnName=vpnName, rate=rate, SensorType=SensorType, fwCompliances=fwCompliances, boxServices=boxServices, trafficShapeEntry=trafficShapeEntry, class1Drop=class1Drop, eventTrap=eventTrap, diskSpace=diskSpace, eventLayerDescription=eventLayerDescription, vpnTunnelsEntry=vpnTunnelsEntry, class2Drop=class2Drop, fwStatsEntry=fwStatsEntry, serverServicesEntry=serverServicesEntry, netGroups=netGroups, noDelayDrop=noDelayDrop, packetThroughput64=packetThroughput64, ospfNeighbors=ospfNeighbors, releaseGroup=releaseGroup, ospfNeighborInterface=ospfNeighborInterface, fwstatsGroup=fwstatsGroup, bgpGroup=bgpGroup, noDelayPakets=noDelayPakets, firewall=firewall, class3Total=class3Total, hwSensorName=hwSensorName, bgpNeighbors=bgpNeighbors, class1Total=class1Total, raidEventTime=raidEventTime, phion=phion, ospfNeighborId=ospfNeighborId, trafficshapeGroup=trafficshapeGroup, raidGroup=raidGroup, partitionFreeSpace=partitionFreeSpace, ripNeighborState=ripNeighborState, eventID=eventID, boxServiceName=boxServiceName, noDelayTotal=noDelayTotal, partitionMaxSpace=partitionMaxSpace, vpnTunnels=vpnTunnels, serverServiceName=serverServiceName, bgpNeighborState=bgpNeighborState, partitionUsedSpace=partitionUsedSpace, ospfGroup=ospfGroup, class2Pakets=class2Pakets, ospfNeighborsEntry=ospfNeighborsEntry, dataThroughput=dataThroughput, hotfixGroup=hotfixGroup, class3Drop=class3Drop, eventGroups=eventGroups, dataThroughput64=dataThroughput64, hwSensors=hwSensors, RaidEventSeverity=RaidEventSeverity, hwGroup=hwGroup, ospfNeighborStatus=ospfNeighborStatus, firewallSessions64=firewallSessions64, raidEvents=raidEvents, phionHotfixesEntry=phionHotfixesEntry, hwSensorValue=hwSensorValue, ripNeighborsEntry=ripNeighborsEntry, boxServicesEntry=boxServicesEntry, ripNeighborAddress=ripNeighborAddress, hotfixInstallTime=hotfixInstallTime, event=event, raidEventsEntry=raidEventsEntry, eventSeverity=eventSeverity, serverServices=serverServices, class2Total=class2Total, phionRelease=phionRelease, sessions=sessions, eventIDDescription=eventIDDescription, firewallSessions=firewallSessions, hwSensorsEntry=hwSensorsEntry, raidEventSev=raidEventSev, packetThroughput=packetThroughput, eventGroup=eventGroup, ServiceState=ServiceState, hotfixName=hotfixName, eventRepresentation=eventRepresentation, serverGroup=serverGroup, fwGroups=fwGroups, VpnStates=VpnStates, bgpNeighborAddress=bgpNeighborAddress, class3Pakets=class3Pakets, boxGroup=boxGroup, partitionName=partitionName, diskspaceGroup=diskspaceGroup, eventType=eventType, phionHotfixes=phionHotfixes, serverServiceState=serverServiceState, notificationGroup=notificationGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, vpnUsers=vpnUsers, fwCompliance=fwCompliance, ripGroup=ripGroup, fwStats=fwStats, raidEventIndex=raidEventIndex, eventClassification=eventClassification, vpnGroup=vpnGroup, firmwareGroups=firmwareGroups, vpnusersGroup=vpnusersGroup, connectorName=connectorName, PYSNMP_MODULE_ID=phion)
