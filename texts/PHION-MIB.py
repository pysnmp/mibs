...
NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, MibIdentifier, IpAddress, Bits, Counter64, enterprises, iso, Gauge32, Unsigned32, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "Counter64", "enterprises", "iso", "Gauge32", "Unsigned32", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", bgpNeighbors=bgpNeighbors, hwSensors=hwSensors, vpnTunnelsEntry=vpnTunnelsEntry, eventGroups=eventGroups, boxServiceName=boxServiceName, notificationGroup=notificationGroup, sessions=sessions, eventAlarmTime=eventAlarmTime, eventGroup=eventGroup, fwCompliances=fwCompliances, VpnStates=VpnStates, hwSensorName=hwSensorName, serverServices=serverServices, ospfNeighborInterface=ospfNeighborInterface, phion=phion, diskSpaceEntry=diskSpaceEntry, connectorName=connectorName, ospfNeighborId=ospfNeighborId, dataThroughput64=dataThroughput64, boxServicesEntry=boxServicesEntry, boxServiceState=boxServiceState, vpnState=vpnState, firewallSessions64=firewallSessions64, raidEventText=raidEventText, partitionName=partitionName, SensorType=SensorType, partitionMaxSpace=partitionMaxSpace, bgpGroup=bgpGroup, hwGroups=hwGroups, diskspaceGroup=diskspaceGroup, eventIDDescription=eventIDDescription, vpnName=vpnName, serviceGroups=serviceGroups, class2Drop=class2Drop, firewall=firewall, fwStatsEntry=fwStatsEntry, bgpNeighborState=bgpNeighborState, eventSeverity=eventSeverity, trafficshapeGroup=trafficshapeGroup, vpnUsers=vpnUsers, firewallSessions=firewallSessions, partitionUsedSpacePercent=partitionUsedSpacePercent, rate=rate, vpnTunnels=vpnTunnels, partitionFreeSpace=partitionFreeSpace, phionRelease=phionRelease, eventClassification=eventClassification, ospfNeighbors=ospfNeighbors, fwCompliance=fwCompliance, raidEventSev=raidEventSev, hwSensorsEntry=hwSensorsEntry, serverServiceState=serverServiceState, class1Pakets=class1Pakets, firmwareGroups=firmwareGroups, event=event, phionHotfixesEntry=phionHotfixesEntry, vpnGroup=vpnGroup, ripNeighborState=ripNeighborState, hwSensorType=hwSensorType, serverServicesEntry=serverServicesEntry, trafficShape=trafficShape, eventLayerDescription=eventLayerDescription, eventTrap=eventTrap, packetThroughput=packetThroughput, eventType=eventType, diskSpace=diskSpace, trafficShapeEntry=trafficShapeEntry, bgpNeighborAddress=bgpNeighborAddress, hwGroup=hwGroup, boxServices=boxServices, class3Total=class3Total, ospfGroup=ospfGroup, fwGroups=fwGroups, hotfixName=hotfixName, raidEvents=raidEvents, dataThroughput=dataThroughput, ServiceState=ServiceState, partitionUsedSpace=partitionUsedSpace, class2Total=class2Total, ospfNeighborsEntry=ospfNeighborsEntry, packetThroughput64=packetThroughput64, raidEventIndex=raidEventIndex, fwStats=fwStats, ripNeighbors=ripNeighbors, boxGroup=boxGroup, noDelayTotal=noDelayTotal, releaseGroup=releaseGroup, phionHotfixes=phionHotfixes, ripNeighborAddress=ripNeighborAddress, class1Drop=class1Drop, class3Drop=class3Drop, ospfNeighborAddress=ospfNeighborAddress, serverServiceName=serverServiceName, ospfNeighborStatus=ospfNeighborStatus, RaidEventSeverity=RaidEventSeverity, class2Pakets=class2Pakets, raidEventsEntry=raidEventsEntry, serverGroup=serverGroup, eventRepresentation=eventRepresentation, fwstatsGroup=fwstatsGroup, hotfixGroup=hotfixGroup, hotfixInstallTime=hotfixInstallTime, eventID=eventID, noDelayDrop=noDelayDrop, noDelayPakets=noDelayPakets, ripNeighborsEntry=ripNeighborsEntry, netGroups=netGroups, class1Total=class1Total, vpnusersGroup=vpnusersGroup, PYSNMP_MODULE_ID=phion, raidGroup=raidGroup, raidEventTime=raidEventTime, class3Pakets=class3Pakets, hwSensorValue=hwSensorValue, bgpNeighborsEntry=bgpNeighborsEntry, ripGroup=ripGroup)
