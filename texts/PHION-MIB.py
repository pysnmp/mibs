...
iso, IpAddress, Counter64, Counter32, MibIdentifier, Integer32, NotificationType, ModuleIdentity, TimeTicks, Gauge32, Unsigned32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter64", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "Gauge32", "Unsigned32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", phionRelease=phionRelease, SensorType=SensorType, class2Pakets=class2Pakets, boxServicesEntry=boxServicesEntry, fwStatsEntry=fwStatsEntry, hwGroups=hwGroups, boxServiceName=boxServiceName, vpnusersGroup=vpnusersGroup, raidEventText=raidEventText, bgpGroup=bgpGroup, bgpNeighborState=bgpNeighborState, hwSensorType=hwSensorType, connectorName=connectorName, VpnStates=VpnStates, ripNeighborState=ripNeighborState, class1Total=class1Total, raidEventSev=raidEventSev, eventGroup=eventGroup, firewallSessions=firewallSessions, fwStats=fwStats, serverServices=serverServices, class1Pakets=class1Pakets, partitionFreeSpace=partitionFreeSpace, ripNeighborAddress=ripNeighborAddress, vpnTunnelsEntry=vpnTunnelsEntry, notificationGroup=notificationGroup, vpnGroup=vpnGroup, packetThroughput=packetThroughput, raidEventTime=raidEventTime, noDelayPakets=noDelayPakets, RaidEventSeverity=RaidEventSeverity, eventClassification=eventClassification, hwSensorsEntry=hwSensorsEntry, packetThroughput64=packetThroughput64, partitionUsedSpace=partitionUsedSpace, eventSeverity=eventSeverity, eventType=eventType, diskspaceGroup=diskspaceGroup, ripGroup=ripGroup, serverGroup=serverGroup, phionHotfixes=phionHotfixes, dataThroughput=dataThroughput, fwCompliance=fwCompliance, bgpNeighborsEntry=bgpNeighborsEntry, event=event, phionHotfixesEntry=phionHotfixesEntry, class2Total=class2Total, raidEvents=raidEvents, vpnUsers=vpnUsers, ServiceState=ServiceState, class1Drop=class1Drop, ospfNeighborAddress=ospfNeighborAddress, trafficShape=trafficShape, releaseGroup=releaseGroup, ripNeighborsEntry=ripNeighborsEntry, raidEventIndex=raidEventIndex, diskSpace=diskSpace, dataThroughput64=dataThroughput64, ospfNeighborId=ospfNeighborId, bgpNeighbors=bgpNeighbors, eventGroups=eventGroups, hotfixGroup=hotfixGroup, partitionMaxSpace=partitionMaxSpace, boxServiceState=boxServiceState, serverServiceName=serverServiceName, raidGroup=raidGroup, ospfGroup=ospfGroup, fwstatsGroup=fwstatsGroup, hotfixInstallTime=hotfixInstallTime, class3Total=class3Total, hwSensorValue=hwSensorValue, boxGroup=boxGroup, noDelayTotal=noDelayTotal, eventTrap=eventTrap, firewall=firewall, hotfixName=hotfixName, PYSNMP_MODULE_ID=phion, raidEventsEntry=raidEventsEntry, sessions=sessions, serverServicesEntry=serverServicesEntry, trafficShapeEntry=trafficShapeEntry, vpnState=vpnState, phion=phion, bgpNeighborAddress=bgpNeighborAddress, class2Drop=class2Drop, vpnName=vpnName, noDelayDrop=noDelayDrop, rate=rate, class3Pakets=class3Pakets, fwCompliances=fwCompliances, diskSpaceEntry=diskSpaceEntry, serverServiceState=serverServiceState, ripNeighbors=ripNeighbors, fwGroups=fwGroups, hwSensors=hwSensors, eventAlarmTime=eventAlarmTime, firmwareGroups=firmwareGroups, trafficshapeGroup=trafficshapeGroup, firewallSessions64=firewallSessions64, ospfNeighborsEntry=ospfNeighborsEntry, eventID=eventID, class3Drop=class3Drop, eventLayerDescription=eventLayerDescription, partitionName=partitionName, hwGroup=hwGroup, eventIDDescription=eventIDDescription, ospfNeighborInterface=ospfNeighborInterface, ospfNeighborStatus=ospfNeighborStatus, netGroups=netGroups, ospfNeighbors=ospfNeighbors, serviceGroups=serviceGroups, vpnTunnels=vpnTunnels, boxServices=boxServices, partitionUsedSpacePercent=partitionUsedSpacePercent, hwSensorName=hwSensorName, eventRepresentation=eventRepresentation)
