...
Bits, ObjectIdentity, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, enterprises, Gauge32, Unsigned32, TimeTicks, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "enterprises", "Gauge32", "Unsigned32", "TimeTicks", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("PHION-MIB", bgpNeighborsEntry=bgpNeighborsEntry, class1Total=class1Total, raidEventText=raidEventText, serverServiceName=serverServiceName, vpnusersGroup=vpnusersGroup, diskspaceGroup=diskspaceGroup, vpnGroup=vpnGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, releaseGroup=releaseGroup, partitionUsedSpace=partitionUsedSpace, hwSensorType=hwSensorType, trafficShape=trafficShape, ServiceState=ServiceState, ospfNeighborsEntry=ospfNeighborsEntry, dataThroughput=dataThroughput, raidEvents=raidEvents, fwStats=fwStats, eventGroups=eventGroups, hwSensorsEntry=hwSensorsEntry, firewall=firewall, dataThroughput64=dataThroughput64, hotfixInstallTime=hotfixInstallTime, partitionName=partitionName, raidEventIndex=raidEventIndex, bgpGroup=bgpGroup, vpnName=vpnName, packetThroughput64=packetThroughput64, sessions=sessions, firewallSessions64=firewallSessions64, ospfNeighborAddress=ospfNeighborAddress, boxServiceState=boxServiceState, partitionMaxSpace=partitionMaxSpace, serverServicesEntry=serverServicesEntry, fwGroups=fwGroups, eventSeverity=eventSeverity, SensorType=SensorType, eventID=eventID, event=event, packetThroughput=packetThroughput, serverServices=serverServices, serviceGroups=serviceGroups, vpnTunnels=vpnTunnels, boxServicesEntry=boxServicesEntry, eventTrap=eventTrap, boxServices=boxServices, RaidEventSeverity=RaidEventSeverity, diskSpace=diskSpace, eventType=eventType, partitionFreeSpace=partitionFreeSpace, serverGroup=serverGroup, class3Pakets=class3Pakets, trafficShapeEntry=trafficShapeEntry, vpnTunnelsEntry=vpnTunnelsEntry, ospfGroup=ospfGroup, bgpNeighborAddress=bgpNeighborAddress, firmwareGroups=firmwareGroups, ospfNeighborInterface=ospfNeighborInterface, PYSNMP_MODULE_ID=phion, ospfNeighborStatus=ospfNeighborStatus, ripNeighbors=ripNeighbors, ripGroup=ripGroup, eventRepresentation=eventRepresentation, hwSensors=hwSensors, class2Total=class2Total, eventAlarmTime=eventAlarmTime, fwCompliance=fwCompliance, vpnState=vpnState, bgpNeighborState=bgpNeighborState, raidGroup=raidGroup, class3Drop=class3Drop, eventClassification=eventClassification, hotfixName=hotfixName, fwstatsGroup=fwstatsGroup, raidEventsEntry=raidEventsEntry, eventLayerDescription=eventLayerDescription, raidEventTime=raidEventTime, bgpNeighbors=bgpNeighbors, noDelayDrop=noDelayDrop, class2Drop=class2Drop, eventGroup=eventGroup, rate=rate, fwStatsEntry=fwStatsEntry, netGroups=netGroups, ospfNeighborId=ospfNeighborId, phionHotfixes=phionHotfixes, class1Pakets=class1Pakets, ripNeighborAddress=ripNeighborAddress, class1Drop=class1Drop, trafficshapeGroup=trafficshapeGroup, noDelayTotal=noDelayTotal, firewallSessions=firewallSessions, hwGroups=hwGroups, diskSpaceEntry=diskSpaceEntry, hwGroup=hwGroup, serverServiceState=serverServiceState, ripNeighborState=ripNeighborState, connectorName=connectorName, ripNeighborsEntry=ripNeighborsEntry, ospfNeighbors=ospfNeighbors, phionHotfixesEntry=phionHotfixesEntry, phion=phion, class3Total=class3Total, VpnStates=VpnStates, hotfixGroup=hotfixGroup, eventIDDescription=eventIDDescription, raidEventSev=raidEventSev, phionRelease=phionRelease, hwSensorValue=hwSensorValue, vpnUsers=vpnUsers, class2Pakets=class2Pakets, boxGroup=boxGroup, fwCompliances=fwCompliances, notificationGroup=notificationGroup, hwSensorName=hwSensorName, noDelayPakets=noDelayPakets, boxServiceName=boxServiceName)
