...
Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, enterprises, IpAddress, Gauge32, MibIdentifier, Integer32, TimeTicks, Counter64, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "enterprises", "IpAddress", "Gauge32", "MibIdentifier", "Integer32", "TimeTicks", "Counter64", "ModuleIdentity", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("PHION-MIB", eventTrap=eventTrap, trafficshapeGroup=trafficshapeGroup, releaseGroup=releaseGroup, eventRepresentation=eventRepresentation, ospfNeighbors=ospfNeighbors, partitionUsedSpacePercent=partitionUsedSpacePercent, noDelayPakets=noDelayPakets, partitionName=partitionName, vpnusersGroup=vpnusersGroup, firmwareGroups=firmwareGroups, phionHotfixesEntry=phionHotfixesEntry, vpnTunnelsEntry=vpnTunnelsEntry, partitionFreeSpace=partitionFreeSpace, raidEventText=raidEventText, hwSensorValue=hwSensorValue, eventGroups=eventGroups, VpnStates=VpnStates, netGroups=netGroups, eventGroup=eventGroup, SensorType=SensorType, hwSensorType=hwSensorType, noDelayTotal=noDelayTotal, serverServiceName=serverServiceName, hwGroups=hwGroups, vpnGroup=vpnGroup, boxServicesEntry=boxServicesEntry, class1Pakets=class1Pakets, packetThroughput64=packetThroughput64, boxServiceState=boxServiceState, eventID=eventID, hwGroup=hwGroup, ripNeighborState=ripNeighborState, ripNeighborAddress=ripNeighborAddress, ospfNeighborInterface=ospfNeighborInterface, ServiceState=ServiceState, boxGroup=boxGroup, class1Drop=class1Drop, raidEventIndex=raidEventIndex, fwstatsGroup=fwstatsGroup, firewall=firewall, hwSensorName=hwSensorName, RaidEventSeverity=RaidEventSeverity, fwCompliance=fwCompliance, fwGroups=fwGroups, diskSpaceEntry=diskSpaceEntry, phion=phion, PYSNMP_MODULE_ID=phion, eventAlarmTime=eventAlarmTime, hotfixGroup=hotfixGroup, serverGroup=serverGroup, hwSensors=hwSensors, ospfNeighborsEntry=ospfNeighborsEntry, serverServiceState=serverServiceState, serverServices=serverServices, connectorName=connectorName, raidEventSev=raidEventSev, ripNeighborsEntry=ripNeighborsEntry, diskSpace=diskSpace, noDelayDrop=noDelayDrop, bgpNeighborsEntry=bgpNeighborsEntry, boxServices=boxServices, class2Total=class2Total, vpnUsers=vpnUsers, hotfixInstallTime=hotfixInstallTime, bgpNeighborState=bgpNeighborState, ospfNeighborAddress=ospfNeighborAddress, ospfNeighborStatus=ospfNeighborStatus, serverServicesEntry=serverServicesEntry, vpnState=vpnState, class2Pakets=class2Pakets, notificationGroup=notificationGroup, fwStatsEntry=fwStatsEntry, vpnTunnels=vpnTunnels, ripGroup=ripGroup, packetThroughput=packetThroughput, bgpGroup=bgpGroup, class1Total=class1Total, bgpNeighbors=bgpNeighbors, class3Total=class3Total, hwSensorsEntry=hwSensorsEntry, phionHotfixes=phionHotfixes, partitionMaxSpace=partitionMaxSpace, eventClassification=eventClassification, firewallSessions=firewallSessions, raidGroup=raidGroup, raidEventsEntry=raidEventsEntry, boxServiceName=boxServiceName, class2Drop=class2Drop, eventIDDescription=eventIDDescription, fwStats=fwStats, eventLayerDescription=eventLayerDescription, ripNeighbors=ripNeighbors, serviceGroups=serviceGroups, partitionUsedSpace=partitionUsedSpace, eventSeverity=eventSeverity, rate=rate, class3Pakets=class3Pakets, firewallSessions64=firewallSessions64, ospfNeighborId=ospfNeighborId, raidEvents=raidEvents, dataThroughput64=dataThroughput64, phionRelease=phionRelease, bgpNeighborAddress=bgpNeighborAddress, class3Drop=class3Drop, raidEventTime=raidEventTime, diskspaceGroup=diskspaceGroup, hotfixName=hotfixName, event=event, eventType=eventType, trafficShapeEntry=trafficShapeEntry, sessions=sessions, dataThroughput=dataThroughput, trafficShape=trafficShape, vpnName=vpnName, fwCompliances=fwCompliances, ospfGroup=ospfGroup)
