...
ModuleIdentity, Counter64, Bits, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, enterprises, ObjectIdentity, iso, Gauge32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "enterprises", "ObjectIdentity", "iso", "Gauge32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("PHION-MIB", dataThroughput64=dataThroughput64, bgpGroup=bgpGroup, raidEventTime=raidEventTime, raidEventText=raidEventText, partitionName=partitionName, class2Drop=class2Drop, eventAlarmTime=eventAlarmTime, class1Drop=class1Drop, class3Total=class3Total, rate=rate, hotfixGroup=hotfixGroup, class3Pakets=class3Pakets, SensorType=SensorType, bgpNeighborAddress=bgpNeighborAddress, vpnUsers=vpnUsers, boxServiceState=boxServiceState, partitionMaxSpace=partitionMaxSpace, ospfNeighborStatus=ospfNeighborStatus, boxServiceName=boxServiceName, boxServicesEntry=boxServicesEntry, eventLayerDescription=eventLayerDescription, fwStats=fwStats, diskSpace=diskSpace, ospfNeighborId=ospfNeighborId, trafficshapeGroup=trafficshapeGroup, vpnTunnelsEntry=vpnTunnelsEntry, ripGroup=ripGroup, eventTrap=eventTrap, class2Pakets=class2Pakets, class1Total=class1Total, phionRelease=phionRelease, vpnName=vpnName, partitionFreeSpace=partitionFreeSpace, fwCompliances=fwCompliances, serverServiceName=serverServiceName, serverServiceState=serverServiceState, raidEventsEntry=raidEventsEntry, dataThroughput=dataThroughput, netGroups=netGroups, eventGroup=eventGroup, bgpNeighborState=bgpNeighborState, firewallSessions=firewallSessions, vpnGroup=vpnGroup, vpnTunnels=vpnTunnels, class3Drop=class3Drop, fwstatsGroup=fwstatsGroup, connectorName=connectorName, releaseGroup=releaseGroup, VpnStates=VpnStates, packetThroughput=packetThroughput, vpnusersGroup=vpnusersGroup, PYSNMP_MODULE_ID=phion, raidGroup=raidGroup, fwGroups=fwGroups, raidEventSev=raidEventSev, sessions=sessions, eventIDDescription=eventIDDescription, ripNeighborState=ripNeighborState, hwSensorType=hwSensorType, partitionUsedSpace=partitionUsedSpace, ospfNeighbors=ospfNeighbors, raidEvents=raidEvents, fwStatsEntry=fwStatsEntry, class1Pakets=class1Pakets, ospfNeighborsEntry=ospfNeighborsEntry, diskSpaceEntry=diskSpaceEntry, hwSensorValue=hwSensorValue, eventRepresentation=eventRepresentation, diskspaceGroup=diskspaceGroup, serverGroup=serverGroup, noDelayPakets=noDelayPakets, hwSensorName=hwSensorName, trafficShape=trafficShape, raidEventIndex=raidEventIndex, noDelayTotal=noDelayTotal, eventGroups=eventGroups, hwGroups=hwGroups, ospfGroup=ospfGroup, serviceGroups=serviceGroups, eventID=eventID, bgpNeighbors=bgpNeighbors, firewall=firewall, notificationGroup=notificationGroup, trafficShapeEntry=trafficShapeEntry, packetThroughput64=packetThroughput64, phionHotfixesEntry=phionHotfixesEntry, vpnState=vpnState, class2Total=class2Total, firewallSessions64=firewallSessions64, ServiceState=ServiceState, bgpNeighborsEntry=bgpNeighborsEntry, phion=phion, hwSensorsEntry=hwSensorsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, ospfNeighborInterface=ospfNeighborInterface, ripNeighbors=ripNeighbors, eventClassification=eventClassification, hwSensors=hwSensors, ospfNeighborAddress=ospfNeighborAddress, noDelayDrop=noDelayDrop, phionHotfixes=phionHotfixes, fwCompliance=fwCompliance, hwGroup=hwGroup, ripNeighborsEntry=ripNeighborsEntry, RaidEventSeverity=RaidEventSeverity, eventSeverity=eventSeverity, ripNeighborAddress=ripNeighborAddress, boxServices=boxServices, eventType=eventType, firmwareGroups=firmwareGroups, event=event, hotfixName=hotfixName, boxGroup=boxGroup, serverServicesEntry=serverServicesEntry, hotfixInstallTime=hotfixInstallTime, serverServices=serverServices)
