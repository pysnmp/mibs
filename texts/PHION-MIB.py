...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, IpAddress, Bits, Unsigned32, Counter64, ObjectIdentity, Counter32, Integer32, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "IpAddress", "Bits", "Unsigned32", "Counter64", "ObjectIdentity", "Counter32", "Integer32", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("PHION-MIB", class1Pakets=class1Pakets, trafficShape=trafficShape, class3Pakets=class3Pakets, fwStatsEntry=fwStatsEntry, diskspaceGroup=diskspaceGroup, SensorType=SensorType, fwGroups=fwGroups, firmwareGroups=firmwareGroups, phionHotfixes=phionHotfixes, ripNeighborsEntry=ripNeighborsEntry, hwSensors=hwSensors, VpnStates=VpnStates, serverServiceName=serverServiceName, fwCompliances=fwCompliances, boxServices=boxServices, diskSpace=diskSpace, raidEventTime=raidEventTime, notificationGroup=notificationGroup, vpnUsers=vpnUsers, ospfNeighborId=ospfNeighborId, raidEventIndex=raidEventIndex, ospfNeighborInterface=ospfNeighborInterface, eventType=eventType, serviceGroups=serviceGroups, ospfNeighborAddress=ospfNeighborAddress, raidEventText=raidEventText, hwSensorsEntry=hwSensorsEntry, vpnTunnels=vpnTunnels, partitionMaxSpace=partitionMaxSpace, noDelayTotal=noDelayTotal, phion=phion, ripNeighbors=ripNeighbors, firewallSessions=firewallSessions, bgpNeighborAddress=bgpNeighborAddress, partitionName=partitionName, phionRelease=phionRelease, vpnusersGroup=vpnusersGroup, noDelayPakets=noDelayPakets, boxServiceName=boxServiceName, packetThroughput64=packetThroughput64, eventAlarmTime=eventAlarmTime, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighbors=ospfNeighbors, dataThroughput64=dataThroughput64, eventID=eventID, boxServicesEntry=boxServicesEntry, fwStats=fwStats, connectorName=connectorName, noDelayDrop=noDelayDrop, eventGroups=eventGroups, dataThroughput=dataThroughput, class3Total=class3Total, class1Total=class1Total, trafficShapeEntry=trafficShapeEntry, vpnTunnelsEntry=vpnTunnelsEntry, serverServiceState=serverServiceState, vpnState=vpnState, partitionFreeSpace=partitionFreeSpace, ServiceState=ServiceState, hotfixName=hotfixName, phionHotfixesEntry=phionHotfixesEntry, class2Drop=class2Drop, hwSensorValue=hwSensorValue, netGroups=netGroups, hotfixInstallTime=hotfixInstallTime, RaidEventSeverity=RaidEventSeverity, hotfixGroup=hotfixGroup, serverServicesEntry=serverServicesEntry, packetThroughput=packetThroughput, serverServices=serverServices, ripGroup=ripGroup, ospfGroup=ospfGroup, trafficshapeGroup=trafficshapeGroup, fwstatsGroup=fwstatsGroup, class3Drop=class3Drop, bgpGroup=bgpGroup, hwSensorType=hwSensorType, releaseGroup=releaseGroup, hwGroup=hwGroup, vpnName=vpnName, eventIDDescription=eventIDDescription, class1Drop=class1Drop, bgpNeighbors=bgpNeighbors, serverGroup=serverGroup, eventRepresentation=eventRepresentation, boxGroup=boxGroup, PYSNMP_MODULE_ID=phion, rate=rate, eventGroup=eventGroup, firewallSessions64=firewallSessions64, hwGroups=hwGroups, hwSensorName=hwSensorName, eventLayerDescription=eventLayerDescription, ospfNeighborsEntry=ospfNeighborsEntry, diskSpaceEntry=diskSpaceEntry, class2Pakets=class2Pakets, sessions=sessions, eventClassification=eventClassification, raidEvents=raidEvents, ripNeighborAddress=ripNeighborAddress, partitionUsedSpace=partitionUsedSpace, raidEventsEntry=raidEventsEntry, eventTrap=eventTrap, raidEventSev=raidEventSev, vpnGroup=vpnGroup, ospfNeighborStatus=ospfNeighborStatus, partitionUsedSpacePercent=partitionUsedSpacePercent, event=event, boxServiceState=boxServiceState, firewall=firewall, fwCompliance=fwCompliance, bgpNeighborState=bgpNeighborState, raidGroup=raidGroup, ripNeighborState=ripNeighborState, eventSeverity=eventSeverity, class2Total=class2Total)
