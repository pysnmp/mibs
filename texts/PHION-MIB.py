...
Bits, iso, IpAddress, ModuleIdentity, Unsigned32, TimeTicks, Counter32, ObjectIdentity, Counter64, MibIdentifier, Integer32, Gauge32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "IpAddress", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter32", "ObjectIdentity", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PHION-MIB", class2Pakets=class2Pakets, raidEvents=raidEvents, packetThroughput=packetThroughput, partitionMaxSpace=partitionMaxSpace, fwCompliances=fwCompliances, serverServicesEntry=serverServicesEntry, vpnusersGroup=vpnusersGroup, dataThroughput64=dataThroughput64, diskSpaceEntry=diskSpaceEntry, ospfNeighborAddress=ospfNeighborAddress, ripNeighbors=ripNeighbors, serverServiceName=serverServiceName, class3Pakets=class3Pakets, bgpNeighborsEntry=bgpNeighborsEntry, bgpNeighborState=bgpNeighborState, raidEventIndex=raidEventIndex, hotfixInstallTime=hotfixInstallTime, eventID=eventID, fwStats=fwStats, rate=rate, trafficShapeEntry=trafficShapeEntry, notificationGroup=notificationGroup, netGroups=netGroups, hwGroup=hwGroup, eventTrap=eventTrap, class3Total=class3Total, eventAlarmTime=eventAlarmTime, boxServices=boxServices, class2Drop=class2Drop, boxServicesEntry=boxServicesEntry, ospfGroup=ospfGroup, hwGroups=hwGroups, ripNeighborAddress=ripNeighborAddress, vpnGroup=vpnGroup, ospfNeighborId=ospfNeighborId, partitionUsedSpace=partitionUsedSpace, boxServiceState=boxServiceState, VpnStates=VpnStates, firewallSessions=firewallSessions, vpnName=vpnName, trafficshapeGroup=trafficshapeGroup, partitionFreeSpace=partitionFreeSpace, raidEventTime=raidEventTime, hwSensorName=hwSensorName, raidEventSev=raidEventSev, ospfNeighborInterface=ospfNeighborInterface, eventRepresentation=eventRepresentation, bgpNeighborAddress=bgpNeighborAddress, event=event, hwSensorType=hwSensorType, phionHotfixesEntry=phionHotfixesEntry, phionRelease=phionRelease, ospfNeighbors=ospfNeighbors, serviceGroups=serviceGroups, vpnState=vpnState, eventClassification=eventClassification, vpnTunnels=vpnTunnels, class1Drop=class1Drop, eventGroups=eventGroups, releaseGroup=releaseGroup, SensorType=SensorType, noDelayDrop=noDelayDrop, hwSensorsEntry=hwSensorsEntry, hotfixGroup=hotfixGroup, ripGroup=ripGroup, noDelayTotal=noDelayTotal, dataThroughput=dataThroughput, fwGroups=fwGroups, boxServiceName=boxServiceName, serverServiceState=serverServiceState, hwSensorValue=hwSensorValue, eventIDDescription=eventIDDescription, bgpGroup=bgpGroup, firewallSessions64=firewallSessions64, PYSNMP_MODULE_ID=phion, eventGroup=eventGroup, serverServices=serverServices, diskSpace=diskSpace, firmwareGroups=firmwareGroups, firewall=firewall, eventLayerDescription=eventLayerDescription, bgpNeighbors=bgpNeighbors, raidEventsEntry=raidEventsEntry, phionHotfixes=phionHotfixes, packetThroughput64=packetThroughput64, trafficShape=trafficShape, sessions=sessions, ospfNeighborsEntry=ospfNeighborsEntry, eventType=eventType, vpnTunnelsEntry=vpnTunnelsEntry, raidGroup=raidGroup, ospfNeighborStatus=ospfNeighborStatus, class2Total=class2Total, raidEventText=raidEventText, class1Total=class1Total, ripNeighborsEntry=ripNeighborsEntry, fwCompliance=fwCompliance, diskspaceGroup=diskspaceGroup, ServiceState=ServiceState, hwSensors=hwSensors, serverGroup=serverGroup, eventSeverity=eventSeverity, partitionUsedSpacePercent=partitionUsedSpacePercent, ripNeighborState=ripNeighborState, vpnUsers=vpnUsers, class3Drop=class3Drop, phion=phion, noDelayPakets=noDelayPakets, RaidEventSeverity=RaidEventSeverity, boxGroup=boxGroup, hotfixName=hotfixName, connectorName=connectorName, fwstatsGroup=fwstatsGroup, class1Pakets=class1Pakets, fwStatsEntry=fwStatsEntry, partitionName=partitionName)
