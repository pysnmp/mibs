...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, ObjectIdentity, TimeTicks, ModuleIdentity, Bits, Integer32, NotificationType, Gauge32, Unsigned32, enterprises, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Bits", "Integer32", "NotificationType", "Gauge32", "Unsigned32", "enterprises", "IpAddress", "iso")
...
mibBuilder.exportSymbols("PHION-MIB", connectorName=connectorName, vpnTunnelsEntry=vpnTunnelsEntry, trafficshapeGroup=trafficshapeGroup, hwSensorsEntry=hwSensorsEntry, ospfNeighborsEntry=ospfNeighborsEntry, partitionUsedSpace=partitionUsedSpace, vpnusersGroup=vpnusersGroup, boxGroup=boxGroup, ospfGroup=ospfGroup, vpnTunnels=vpnTunnels, hotfixInstallTime=hotfixInstallTime, class1Drop=class1Drop, diskSpaceEntry=diskSpaceEntry, bgpNeighborsEntry=bgpNeighborsEntry, notificationGroup=notificationGroup, hotfixName=hotfixName, hwSensors=hwSensors, ripGroup=ripGroup, ServiceState=ServiceState, raidEventTime=raidEventTime, RaidEventSeverity=RaidEventSeverity, netGroups=netGroups, boxServiceState=boxServiceState, SensorType=SensorType, releaseGroup=releaseGroup, trafficShape=trafficShape, hotfixGroup=hotfixGroup, dataThroughput64=dataThroughput64, class2Drop=class2Drop, partitionUsedSpacePercent=partitionUsedSpacePercent, fwCompliance=fwCompliance, eventGroup=eventGroup, VpnStates=VpnStates, raidEventIndex=raidEventIndex, phionHotfixesEntry=phionHotfixesEntry, partitionFreeSpace=partitionFreeSpace, eventLayerDescription=eventLayerDescription, ripNeighborState=ripNeighborState, dataThroughput=dataThroughput, vpnName=vpnName, fwCompliances=fwCompliances, ripNeighbors=ripNeighbors, raidEventSev=raidEventSev, class3Total=class3Total, boxServicesEntry=boxServicesEntry, eventID=eventID, noDelayPakets=noDelayPakets, ospfNeighborInterface=ospfNeighborInterface, noDelayDrop=noDelayDrop, bgpNeighborState=bgpNeighborState, eventSeverity=eventSeverity, class1Total=class1Total, eventAlarmTime=eventAlarmTime, ripNeighborsEntry=ripNeighborsEntry, class2Pakets=class2Pakets, ospfNeighborStatus=ospfNeighborStatus, rate=rate, partitionMaxSpace=partitionMaxSpace, eventClassification=eventClassification, hwGroups=hwGroups, eventIDDescription=eventIDDescription, boxServiceName=boxServiceName, serverServiceState=serverServiceState, eventRepresentation=eventRepresentation, raidGroup=raidGroup, hwGroup=hwGroup, phionHotfixes=phionHotfixes, ospfNeighbors=ospfNeighbors, ospfNeighborAddress=ospfNeighborAddress, event=event, fwStatsEntry=fwStatsEntry, ospfNeighborId=ospfNeighborId, raidEvents=raidEvents, eventGroups=eventGroups, hwSensorName=hwSensorName, serviceGroups=serviceGroups, eventType=eventType, class1Pakets=class1Pakets, firewallSessions=firewallSessions, bgpNeighborAddress=bgpNeighborAddress, bgpGroup=bgpGroup, vpnState=vpnState, sessions=sessions, packetThroughput64=packetThroughput64, firewallSessions64=firewallSessions64, hwSensorValue=hwSensorValue, serverGroup=serverGroup, class3Pakets=class3Pakets, phion=phion, vpnGroup=vpnGroup, fwstatsGroup=fwstatsGroup, class3Drop=class3Drop, ripNeighborAddress=ripNeighborAddress, packetThroughput=packetThroughput, trafficShapeEntry=trafficShapeEntry, noDelayTotal=noDelayTotal, serverServiceName=serverServiceName, boxServices=boxServices, fwStats=fwStats, vpnUsers=vpnUsers, diskspaceGroup=diskspaceGroup, raidEventsEntry=raidEventsEntry, serverServicesEntry=serverServicesEntry, firmwareGroups=firmwareGroups, diskSpace=diskSpace, firewall=firewall, fwGroups=fwGroups, bgpNeighbors=bgpNeighbors, serverServices=serverServices, PYSNMP_MODULE_ID=phion, raidEventText=raidEventText, class2Total=class2Total, phionRelease=phionRelease, eventTrap=eventTrap, partitionName=partitionName, hwSensorType=hwSensorType)
