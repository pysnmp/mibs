...
mibBuilder.exportSymbols("RAY3-MIB", useLogStorage=useLogStorage, ifEth=ifEth, useMemory=useMemory, speed=speed, alarmWifiOn=alarmWifiOn, ethOutThroughput=ethOutThroughput, interface=interface, ServiceState=ServiceState, swVer=swVer, alarmEth1Down=alarmEth1Down, timeAllConnect=timeAllConnect, systemStatus=systemStatus, alarmNetBitrate=alarmNetBitrate, productName=productName, tr3AirDisconnect=tr3AirDisconnect, eth2InThroughput=eth2InThroughput, timeAllDisconnect=timeAllDisconnect, eth2Link=eth2Link, ray3=ray3, voltageUnit=voltageUnit, rxChannel=rxChannel, rxModulationIndex=rxModulationIndex, rxFreq=rxFreq, tr3NetBitrate=tr3NetBitrate, Thousandths=Thousandths, useCpu=useCpu, securePeerMode=securePeerMode, numDisconnect=numDisconnect, txFreq=txFreq, chassis=chassis, txModulation=txModulation, duplex=duplex, PhysAddressRaw=PhysAddressRaw, Hundredths=Hundredths, alarmVoltageHigh=alarmVoltageHigh, rxModulation=rxModulation, tr3VoltageLowAlarm=tr3VoltageLowAlarm, alarmPeerDisconnected=alarmPeerDisconnected, speedGuard=speedGuard, managementVlan=managementVlan, ip=ip, DisplayStringRaw=DisplayStringRaw, Tenths=Tenths, temperatureModem=temperatureModem, alarmTemperature=alarmTemperature, alarmRss=alarmRss, netBitrate=netBitrate, frequencyTable=frequencyTable, rfPowerConfigured=rfPowerConfigured, timeMaxDisconnect=timeMaxDisconnect, status=status, peerNumber=peerNumber, txChannel=txChannel, statistic=statistic, egressQueue=egressQueue, telnetd=telnetd, autonego=autonego, alarm=alarm, ethernet=ethernet, rfPowerCurrent=rfPowerCurrent, access=access, sshd=sshd, ifEthEntry=ifEthEntry, tr3AirConnect=tr3AirConnect, ModulationList=ModulationList, voltageSource=voltageSource, maxNetBitrate=maxNetBitrate, alarmMse=alarmMse, unitType=unitType, mac=mac, linkUptime=linkUptime, txModulationIndex=txModulationIndex, alarmBer=alarmBer, flowControl=flowControl, tr3Eth21LinkDown=tr3Eth21LinkDown, tr3TemperatureAlarm=tr3TemperatureAlarm, station=station, tr3BerAlarm=tr3BerAlarm, ray3TrapsPrefix=ray3TrapsPrefix, alarmVoltageLow=alarmVoltageLow, alarmEth2Down=alarmEth2Down, atpc=atpc, managementVlanId=managementVlanId, temperatureRadio=temperatureRadio, ray3Traps=ray3Traps, channelArrangement=channelArrangement, eth2OutThroughput=eth2OutThroughput, tr3EventAirCapacity=tr3EventAirCapacity, tr3VoltageHighAlarm=tr3VoltageHighAlarm, tr3RssAlarm=tr3RssAlarm, tr3MseAlarm=tr3MseAlarm, serialNumber=serialNumber, OptionSetting=OptionSetting, info=info, tr3WifiOn=tr3WifiOn, ifRadio=ifRadio, ber=ber, ethInThroughput=ethInThroughput, tr3Eth1LinkDown=tr3Eth1LinkDown, deviceName=deviceName, system=system, matching=matching, httpd=httpd, switch=switch, lineStatusII=lineStatusII, txBandwidthKHz=txBandwidthKHz, wifiHAP=wifiHAP, PYSNMP_MODULE_ID=racom, rss=rss, racom=racom, product=product, AlarmState=AlarmState, ifEthTable=ifEthTable, radio=radio, rxBandwidthKHz=rxBandwidthKHz, reliability=reliability, mse=mse, mdix=mdix, eth1Link=eth1Link, acm=acm, swVerRadio=swVerRadio)
