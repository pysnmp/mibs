...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", ceccLogDatetime=ceccLogDatetime, memTotalWidth=memTotalWidth, raidVDStripSize=raidVDStripSize, raidVDIndex=raidVDIndex, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapBbpStatusWarning=trapBbpStatusWarning, raidPDDeviceSpeed=raidPDDeviceSpeed, trapFanNormal=trapFanNormal, raidVDCached=raidVDCached, diskSerialNumber=diskSerialNumber, postLogInfo=postLogInfo, cpuThreadCount=cpuThreadCount, sysBIOSTable=sysBIOSTable, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, osTable=osTable, raidPDSerialNumber=raidPDSerialNumber, raidIsBBUAbsent=raidIsBBUAbsent, mbSerialNumber=mbSerialNumber, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDSlotNumber=raidPDSlotNumber, raidPDOtherErrorCount=raidPDOtherErrorCount, raidAdapterFWVersion=raidAdapterFWVersion, trapMemoryUeccWarning=trapMemoryUeccWarning, raidAdapterSubVendorId=raidAdapterSubVendorId, trapBatteryStatusCritical=trapBatteryStatusCritical, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidBBUIndex=raidBBUIndex, raidAdapterId_BBU=raidAdapterId_BBU, sysBIOSIndex=sysBIOSIndex, raidBBUStatus=raidBBUStatus, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDState=raidVDState, raidAdapterId_VD=raidAdapterId_VD, raidPDPort1Status=raidPDPort1Status, osManufacturer=osManufacturer, raidDiskGroupId=raidDiskGroupId, diskSize=diskSize, trapCpuFaultNormal=trapCpuFaultNormal, raidVDName=raidVDName, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sd5Idx=sd5Idx, raidVDNumDrives=raidVDNumDrives, raidBBUAllinoneStatus=raidBBUAllinoneStatus, memDescription=memDescription, cpuEntry=cpuEntry, cpuLogTable=cpuLogTable, trapFanCritical=trapFanCritical, diskTable=diskTable, sd5MIBVersion=sd5MIBVersion, raidPDLinkSpeed=raidPDLinkSpeed, diskSmartStatus=diskSmartStatus, trapChassisIntrusion=trapChassisIntrusion, cpuCurrentSpeed=cpuCurrentSpeed, cpuDeviceID=cpuDeviceID, raidVDId=raidVDId, ueccLogIndex=ueccLogIndex, raidPDOpProgress=raidPDOpProgress, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuManufacturer=cpuManufacturer, ueccLogDatetime=ueccLogDatetime, raidVDBadBlocksExist=raidVDBadBlocksExist, cpuLoadingPercentage=cpuLoadingPercentage, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidAdapterTable=raidAdapterTable, raidPDSpan=raidPDSpan, trapMemoryCeccCritical=trapMemoryCeccCritical, memDeviceLocator=memDeviceLocator, osSerialNumber=osSerialNumber, cpuCoreEnabled=cpuCoreEnabled, ceccLogInfo=ceccLogInfo, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapPowerSupplyCritical=trapPowerSupplyCritical, osCSDVersion=osCSDVersion, raidPDPort0Status=raidPDPort0Status, diskController=diskController, sd5Entry=sd5Entry, raidPDEntry=raidPDEntry, memErrorCount=memErrorCount, raidDiskGroupId_PD=raidDiskGroupId_PD, memTag=memTag, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapGenericNormal=trapGenericNormal, memPartNumber=memPartNumber, raidPDPredFailCount=raidPDPredFailCount, cpuLogDatetime=cpuLogDatetime, raidVDTargetId=raidVDTargetId, raidAdapterId_PD=raidAdapterId_PD, raidPDAllinoneMsg=raidPDAllinoneMsg, trapMemoryUeccNormal=trapMemoryUeccNormal, mbEntry=mbEntry, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memDeviceStatus=memDeviceStatus, trapGenericCritical=trapGenericCritical, cpuTable=cpuTable, raidAdapterId=raidAdapterId, raidAdapterSerialNumber=raidAdapterSerialNumber, cpuMaxSpeed=cpuMaxSpeed, diskEntry=diskEntry, sd5Version=sd5Version, ceccLogTable=ceccLogTable, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDSupportT10Power=raidVDSupportT10Power, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDRaidLevel=raidVDRaidLevel, raidPDRawSize=raidPDRawSize, raidPDPort0Linkspeed=raidPDPort0Linkspeed, postLogTable=postLogTable, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDMediaType=raidPDMediaType, osIndex=osIndex, dmiLogTable=dmiLogTable, cpuLogIndex=cpuLogIndex, raidAdapterEntry=raidAdapterEntry, raidAdapterIndex=raidAdapterIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, mbIndex=mbIndex, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidBBUTable=raidBBUTable, raidAdapterGroup_PD=raidAdapterGroup_PD, mbTable=mbTable, raidVDAllinoneStatus=raidVDAllinoneStatus, memManufacturer=memManufacturer, memTable=memTable, raidPDPort1Linkspeed=raidPDPort1Linkspeed, postLogDatetime=postLogDatetime, raidPDInquiryData=raidPDInquiryData, raidPDFirmwareRevision=raidPDFirmwareRevision, mbProductName=mbProductName, trapMemoryCeccNormal=trapMemoryCeccNormal, mbAssetTag=mbAssetTag, raidAdapterGroup=raidAdapterGroup, memEntry=memEntry, trapGenericWarning=trapGenericWarning, diskMediaType=diskMediaType, mbManufacturer=mbManufacturer, trapTemperatureCritical=trapTemperatureCritical, cpuDeviceStatus=cpuDeviceStatus, diskSlotID=diskSlotID, cpuLogEntry=cpuLogEntry, osEntry=osEntry, raidAdapterVendorId=raidAdapterVendorId, raidBBUEntry=raidBBUEntry, sysBIOSManufacturer=sysBIOSManufacturer, raidPDIndex=raidPDIndex, raidAdapterProductName=raidAdapterProductName, raidAdapterGroup_VD=raidAdapterGroup_VD, postLogEntry=postLogEntry, raidAdapterDeviceId=raidAdapterDeviceId, trapMemoryUeccCritical=trapMemoryUeccCritical, postLogIndex=postLogIndex, diskInterfaceType=diskInterfaceType, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, sysBIOSVersion=sysBIOSVersion, mbVersionName=mbVersionName, trapVoltageCritical=trapVoltageCritical, trapVoltageWarning=trapVoltageWarning, trapFanWarning=trapFanWarning, raidPDWriteCache=raidPDWriteCache, raidPDModel=raidPDModel, diskVendor=diskVendor, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDAllinoneStatus=raidPDAllinoneStatus, cpuLogInfo=cpuLogInfo, diskName=diskName, raidBBUAllinoneMsg=raidBBUAllinoneMsg, trapCpuFaultCritical=trapCpuFaultCritical, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, memModel=memModel, sysBIOSEntry=sysBIOSEntry, osName=osName, smSD5TrapMIB=smSD5TrapMIB, ceccLogEntry=ceccLogEntry, raidPDNCQSetting=raidPDNCQSetting, ueccLogTable=ueccLogTable, trapBatteryStatusWarning=trapBatteryStatusWarning, memSerialNumber=memSerialNumber, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, cpuID=cpuID, raidVDTable=raidVDTable, raidVDSpanDepth=raidVDSpanDepth, sysBIOSReleaseDate=sysBIOSReleaseDate, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidVDSize=raidVDSize, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapVoltageNormal=trapVoltageNormal, memLabeledBank=memLabeledBank, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDEncryptionType=raidVDEncryptionType, ceccLogIndex=ceccLogIndex, memDataWidth=memDataWidth, trapTemperatureWarning=trapTemperatureWarning, memCapacity=memCapacity, raidPDTable=raidPDTable, cpuDeviceVersion=cpuDeviceVersion, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuIndex=cpuIndex, trapBbpStatusCritical=trapBbpStatusCritical, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuSocketDesignation=cpuSocketDesignation, memECCErrorCount=memECCErrorCount, cpuCoreCount=cpuCoreCount, cpuName=cpuName, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDEntry=raidVDEntry, raidPDMediaErrorCount=raidPDMediaErrorCount, trapTemperatureNormal=trapTemperatureNormal, ueccLogInfo=ueccLogInfo, trapChassisIntrusionCleared=trapChassisIntrusionCleared, sd5Table=sd5Table, raidPDFirmwareState=raidPDFirmwareState, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuDescription=cpuDescription, trapBbpStatusNormal=trapBbpStatusNormal, trapCpuFaultWarning=trapCpuFaultWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, ueccLogEntry=ueccLogEntry, trapMemoryCeccWarning=trapMemoryCeccWarning, memUECCErrorCount=memUECCErrorCount, osVersion=osVersion, diskModel=diskModel)
