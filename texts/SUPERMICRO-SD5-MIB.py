...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", mbTable=mbTable, raidPDMediaErrorCount=raidPDMediaErrorCount, postLogInfo=postLogInfo, raidAdapterGroup=raidAdapterGroup, cpuEntry=cpuEntry, memCapacity=memCapacity, memTotalWidth=memTotalWidth, mbIndex=mbIndex, ueccLogIndex=ueccLogIndex, raidDiskGroupId=raidDiskGroupId, trapTemperatureWarning=trapTemperatureWarning, raidPDRawSize=raidPDRawSize, raidVDEntry=raidVDEntry, ueccLogTable=ueccLogTable, raidAdapterId=raidAdapterId, diskTable=diskTable, diskSize=diskSize, trapBbpStatusCritical=trapBbpStatusCritical, ueccLogEntry=ueccLogEntry, raidDiskGroupId_PD=raidDiskGroupId_PD, trapPowerSupplyWarning=trapPowerSupplyWarning, memECCErrorCount=memECCErrorCount, raidBBUAllinoneStatus=raidBBUAllinoneStatus, mbVersionName=mbVersionName, raidVDSize=raidVDSize, raidPDInquiryData=raidPDInquiryData, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuDeviceVersion=cpuDeviceVersion, diskSlotID=diskSlotID, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDRaidLevel=raidVDRaidLevel, trapPowerSupplyNormal=trapPowerSupplyNormal, cpuDescription=cpuDescription, cpuSocketDesignation=cpuSocketDesignation, osTable=osTable, raidIsBBUAbsent=raidIsBBUAbsent, memEntry=memEntry, memPartNumber=memPartNumber, raidAdapterTable=raidAdapterTable, raidBBUEntry=raidBBUEntry, trapCpuFaultCritical=trapCpuFaultCritical, raidPDPredFailCount=raidPDPredFailCount, diskEntry=diskEntry, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDStripSize=raidVDStripSize, raidVDMirrorDataSize=raidVDMirrorDataSize, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuID=cpuID, cpuLogInfo=cpuLogInfo, raidVDCached=raidVDCached, raidAdapterIndex=raidAdapterIndex, raidAdapterSerialNumber=raidAdapterSerialNumber, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDTable=raidVDTable, diskMediaType=diskMediaType, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapGenericCritical=trapGenericCritical, raidVDSpanDepth=raidVDSpanDepth, smSD5TrapMIB=smSD5TrapMIB, mbSerialNumber=mbSerialNumber, raidPDIndex=raidPDIndex, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDMediaType=raidPDMediaType, raidPDOpProgress=raidPDOpProgress, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidPDTable=raidPDTable, raidVDTargetId=raidVDTargetId, diskVendor=diskVendor, memLabeledBank=memLabeledBank, mbProductName=mbProductName, raidAdapterEntry=raidAdapterEntry, sysBIOSReleaseDate=sysBIOSReleaseDate, raidBBUIndex=raidBBUIndex, cpuLogEntry=cpuLogEntry, osSerialNumber=osSerialNumber, ceccLogInfo=ceccLogInfo, trapFanCritical=trapFanCritical, raidVDBadBlocksExist=raidVDBadBlocksExist, trapFanWarning=trapFanWarning, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuTable=cpuTable, raidPDModel=raidPDModel, diskInterfaceType=diskInterfaceType, raidAdapterSubVendorId=raidAdapterSubVendorId, sd5MIBVersion=sd5MIBVersion, memTable=memTable, osName=osName, raidAdapterVendorId=raidAdapterVendorId, postLogTable=postLogTable, postLogIndex=postLogIndex, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapTemperatureNormal=trapTemperatureNormal, diskModel=diskModel, cpuLogDatetime=cpuLogDatetime, sysBIOSVersion=sysBIOSVersion, raidAdapterGroup_PD=raidAdapterGroup_PD, ceccLogEntry=ceccLogEntry, raidPDNCQSetting=raidPDNCQSetting, cpuCoreEnabled=cpuCoreEnabled, sysBIOSManufacturer=sysBIOSManufacturer, memUECCErrorCount=memUECCErrorCount, osEntry=osEntry, sysBIOSTable=sysBIOSTable, osCSDVersion=osCSDVersion, raidPDWriteCache=raidPDWriteCache, trapGenericNormal=trapGenericNormal, PYSNMP_MODULE_ID=smSuperDoctor5MIB, cpuLogIndex=cpuLogIndex, trapBatteryStatusWarning=trapBatteryStatusWarning, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, diskSerialNumber=diskSerialNumber, raidPDPort0Linkspeed=raidPDPort0Linkspeed, cpuCurrentSpeed=cpuCurrentSpeed, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, memDeviceLocator=memDeviceLocator, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, cpuThreadCount=cpuThreadCount, sysBIOSIndex=sysBIOSIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, cpuDeviceID=cpuDeviceID, ceccLogTable=ceccLogTable, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, osVersion=osVersion, raidPDOtherErrorCount=raidPDOtherErrorCount, sysBIOSEntry=sysBIOSEntry, memDataWidth=memDataWidth, ueccLogDatetime=ueccLogDatetime, raidAdapterId_PD=raidAdapterId_PD, cpuCoreCount=cpuCoreCount, ceccLogDatetime=ceccLogDatetime, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuMaxSpeed=cpuMaxSpeed, raidVDName=raidVDName, mbManufacturer=mbManufacturer, cpuName=cpuName, raidPDPort0Status=raidPDPort0Status, trapCpuFaultWarning=trapCpuFaultWarning, raidAdapterFWVersion=raidAdapterFWVersion, trapPowerSupplyCritical=trapPowerSupplyCritical, sd5Idx=sd5Idx, osIndex=osIndex, raidBBUTable=raidBBUTable, trapBbpStatusWarning=trapBbpStatusWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDAllinoneMsg=raidPDAllinoneMsg, trapFanNormal=trapFanNormal, memModel=memModel, raidVDId=raidVDId, trapVoltageNormal=trapVoltageNormal, raidPDPort1Status=raidPDPort1Status, memErrorCount=memErrorCount, osManufacturer=osManufacturer, ueccLogInfo=ueccLogInfo, trapCpuFaultNormal=trapCpuFaultNormal, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDSpan=raidPDSpan, raidAdapterProductName=raidAdapterProductName, raidVDNumDrives=raidVDNumDrives, trapMemoryCeccWarning=trapMemoryCeccWarning, raidAdapterId_VD=raidAdapterId_VD, mbAssetTag=mbAssetTag, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memDescription=memDescription, raidVDState=raidVDState, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDAllinoneStatus=raidVDAllinoneStatus, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapBatteryStatusNormal=trapBatteryStatusNormal, postLogEntry=postLogEntry, cpuLoadingPercentage=cpuLoadingPercentage, diskController=diskController, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterSubDeviceId=raidAdapterSubDeviceId, diskName=diskName, raidPDFirmwareState=raidPDFirmwareState, raidPDSerialNumber=raidPDSerialNumber, trapVoltageWarning=trapVoltageWarning, trapMemoryUeccWarning=trapMemoryUeccWarning, sd5Version=sd5Version, postLogDatetime=postLogDatetime, trapBbpStatusNormal=trapBbpStatusNormal, trapVoltageCritical=trapVoltageCritical, raidBBUStatus=raidBBUStatus, memDeviceStatus=memDeviceStatus, raidPDSlotNumber=raidPDSlotNumber, trapMemoryCeccCritical=trapMemoryCeccCritical, sd5Entry=sd5Entry, mbEntry=mbEntry, diskSmartStatus=diskSmartStatus, trapGenericWarning=trapGenericWarning, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapChassisIntrusion=trapChassisIntrusion, memSerialNumber=memSerialNumber, dmiLogTable=dmiLogTable, memManufacturer=memManufacturer, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDLinkSpeed=raidPDLinkSpeed, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, cpuDeviceStatus=cpuDeviceStatus, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, cpuManufacturer=cpuManufacturer, sd5Table=sd5Table, cpuIndex=cpuIndex, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuLogTable=cpuLogTable, memTag=memTag, ceccLogIndex=ceccLogIndex, raidPDEntry=raidPDEntry, raidVDSupportT10Power=raidVDSupportT10Power, trapTemperatureCritical=trapTemperatureCritical, raidVDIndex=raidVDIndex, raidVDEncryptionType=raidVDEncryptionType, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo)
