...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuLogDatetime=cpuLogDatetime, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, cpuDeviceStatus=cpuDeviceStatus, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDOpProgress=raidPDOpProgress, ueccLogInfo=ueccLogInfo, raidPDDeviceSpeed=raidPDDeviceSpeed, raidAdapterSubVendorId=raidAdapterSubVendorId, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapFanCritical=trapFanCritical, dmiLogTable=dmiLogTable, sysBIOSIndex=sysBIOSIndex, raidPDWriteCache=raidPDWriteCache, memEntry=memEntry, diskSlotID=diskSlotID, cpuLogEntry=cpuLogEntry, cpuID=cpuID, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapTemperatureCritical=trapTemperatureCritical, raidAdapterVendorId=raidAdapterVendorId, cpuCurrentSpeed=cpuCurrentSpeed, diskName=diskName, raidAdapterId_BBU=raidAdapterId_BBU, trapVoltageCritical=trapVoltageCritical, raidIsBBUAbsent=raidIsBBUAbsent, cpuDeviceVersion=cpuDeviceVersion, memSerialNumber=memSerialNumber, raidPDPort1Status=raidPDPort1Status, trapBbpStatusWarning=trapBbpStatusWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, osSerialNumber=osSerialNumber, trapBatteryStatusNormal=trapBatteryStatusNormal, memTable=memTable, raidAdapterId_PD=raidAdapterId_PD, sysBIOSTable=sysBIOSTable, cpuLogTable=cpuLogTable, trapTemperatureWarning=trapTemperatureWarning, raidPDEntry=raidPDEntry, raidAdapterDeviceId=raidAdapterDeviceId, trapBbpStatusNormal=trapBbpStatusNormal, cpuMaxSpeed=cpuMaxSpeed, mbProductName=mbProductName, osTable=osTable, trapPowerSupplyWarning=trapPowerSupplyWarning, sd5Entry=sd5Entry, cpuSocketDesignation=cpuSocketDesignation, memDeviceLocator=memDeviceLocator, cpuName=cpuName, raidVDIndex=raidVDIndex, postLogTable=postLogTable, raidVDDiskCachePolicy=raidVDDiskCachePolicy, sd5Version=sd5Version, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, postLogIndex=postLogIndex, raidAdapterEntry=raidAdapterEntry, raidVDTargetId=raidVDTargetId, cpuLogInfo=cpuLogInfo, memErrorCount=memErrorCount, trapVoltageNormal=trapVoltageNormal, trapFanWarning=trapFanWarning, sysBIOSVersion=sysBIOSVersion, ueccLogIndex=ueccLogIndex, raidPDPredFailCount=raidPDPredFailCount, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuLogIndex=cpuLogIndex, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidDiskGroupId=raidDiskGroupId, sysBIOSManufacturer=sysBIOSManufacturer, osName=osName, mbAssetTag=mbAssetTag, raidAdapterId_VD=raidAdapterId_VD, raidPDAllinoneMsg=raidPDAllinoneMsg, diskMediaType=diskMediaType, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, mbTable=mbTable, sysBIOSReleaseDate=sysBIOSReleaseDate, osEntry=osEntry, raidVDNumDrives=raidVDNumDrives, diskController=diskController, raidVDRaidLevel=raidVDRaidLevel, cpuEntry=cpuEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, cpuManufacturer=cpuManufacturer, diskTable=diskTable, raidPDInquiryData=raidPDInquiryData, diskSerialNumber=diskSerialNumber, trapGenericNormal=trapGenericNormal, diskSmartStatus=diskSmartStatus, ceccLogEntry=ceccLogEntry, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuLoadingPercentage=cpuLoadingPercentage, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, sd5MIBVersion=sd5MIBVersion, trapMemoryCeccWarning=trapMemoryCeccWarning, trapGenericCritical=trapGenericCritical, ceccLogIndex=ceccLogIndex, trapGenericWarning=trapGenericWarning, raidVDState=raidVDState, mbEntry=mbEntry, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidBBUTable=raidBBUTable, raidPDLinkSpeed=raidPDLinkSpeed, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memManufacturer=memManufacturer, ueccLogTable=ueccLogTable, cpuDeviceID=cpuDeviceID, raidAdapterProductName=raidAdapterProductName, osManufacturer=osManufacturer, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, diskEntry=diskEntry, trapCpuFaultWarning=trapCpuFaultWarning, memCapacity=memCapacity, trapFanNormal=trapFanNormal, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDPort0Status=raidPDPort0Status, memTotalWidth=memTotalWidth, memECCErrorCount=memECCErrorCount, mbManufacturer=mbManufacturer, raidVDSpanDepth=raidVDSpanDepth, ceccLogInfo=ceccLogInfo, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, smSuperDoctor5MIB=smSuperDoctor5MIB, trapVoltageWarning=trapVoltageWarning, osVersion=osVersion, trapTemperatureNormal=trapTemperatureNormal, ceccLogDatetime=ceccLogDatetime, raidPDFirmwareRevision=raidPDFirmwareRevision, memDeviceStatus=memDeviceStatus, trapChassisIntrusion=trapChassisIntrusion, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterBIOSVersion=raidAdapterBIOSVersion, memDescription=memDescription, raidPDFirmwareState=raidPDFirmwareState, cpuIndex=cpuIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, raidAdapterFWVersion=raidAdapterFWVersion, raidVDStripSize=raidVDStripSize, cpuDescription=cpuDescription, mbVersionName=mbVersionName, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDMediaType=raidPDMediaType, raidPDIndex=raidPDIndex, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDTable=raidPDTable, osCSDVersion=osCSDVersion, raidVDMirrorDataSize=raidVDMirrorDataSize, memUECCErrorCount=memUECCErrorCount, raidAdapterIndex=raidAdapterIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidPDModel=raidPDModel, cpuCoreCount=cpuCoreCount, trapMemoryCeccNormal=trapMemoryCeccNormal, raidBBUIndex=raidBBUIndex, diskModel=diskModel, trapCpuFaultNormal=trapCpuFaultNormal, ueccLogDatetime=ueccLogDatetime, postLogEntry=postLogEntry, raidPDNCQSetting=raidPDNCQSetting, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDEntry=raidVDEntry, cpuCoreEnabled=cpuCoreEnabled, trapBbpStatusCritical=trapBbpStatusCritical, raidVDSupportT10Power=raidVDSupportT10Power, raidAdapterGroup=raidAdapterGroup, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapCpuFaultCritical=trapCpuFaultCritical, cpuTable=cpuTable, raidVDTable=raidVDTable, raidBBUEntry=raidBBUEntry, raidPDSpan=raidPDSpan, raidVDId=raidVDId, smSD5TrapMIB=smSD5TrapMIB, osIndex=osIndex, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, diskInterfaceType=diskInterfaceType, raidVDAllinoneMsg=raidVDAllinoneMsg, diskSize=diskSize, diskVendor=diskVendor, trapPowerSupplyNormal=trapPowerSupplyNormal, trapMemoryUeccNormal=trapMemoryUeccNormal, mbSerialNumber=mbSerialNumber, raidVDSize=raidVDSize, memLabeledBank=memLabeledBank, raidAdapterTable=raidAdapterTable, memModel=memModel, raidPDOtherErrorCount=raidPDOtherErrorCount, sd5Table=sd5Table, ceccLogTable=ceccLogTable, raidVDCached=raidVDCached, raidAdapterId=raidAdapterId, trapBatteryStatusWarning=trapBatteryStatusWarning, memPartNumber=memPartNumber, trapMemoryUeccWarning=trapMemoryUeccWarning, raidPDSlotNumber=raidPDSlotNumber, postLogInfo=postLogInfo, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuThreadCount=cpuThreadCount, raidVDBadBlocksExist=raidVDBadBlocksExist, memTag=memTag, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, ueccLogEntry=ueccLogEntry, raidAdapterSubDeviceId=raidAdapterSubDeviceId, mbIndex=mbIndex, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, memDataWidth=memDataWidth, postLogDatetime=postLogDatetime, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDRawSize=raidPDRawSize, raidVDName=raidVDName, sysBIOSEntry=sysBIOSEntry, raidPDSerialNumber=raidPDSerialNumber, raidBBUStatus=raidBBUStatus, sd5Idx=sd5Idx, raidVDEncryptionType=raidVDEncryptionType)
