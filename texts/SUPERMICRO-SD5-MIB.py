...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", diskModel=diskModel, raidAdapterSubDeviceId=raidAdapterSubDeviceId, sysBIOSTable=sysBIOSTable, diskTable=diskTable, dmiLogTable=dmiLogTable, postLogTable=postLogTable, raidAdapterProductName=raidAdapterProductName, raidVDIndex=raidVDIndex, raidVDNumDrives=raidVDNumDrives, cpuSocketDesignation=cpuSocketDesignation, memDescription=memDescription, ceccLogTable=ceccLogTable, raidPDAllinoneStatus=raidPDAllinoneStatus, raidPDFirmwareState=raidPDFirmwareState, raidBBUStatus=raidBBUStatus, raidPDPredFailCount=raidPDPredFailCount, raidPDLinkSpeed=raidPDLinkSpeed, raidPDOpProgress=raidPDOpProgress, trapTemperatureWarning=trapTemperatureWarning, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, osVersion=osVersion, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuEntry=cpuEntry, cpuManufacturer=cpuManufacturer, sd5Table=sd5Table, cpuIndex=cpuIndex, memCapacity=memCapacity, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterDeviceId=raidAdapterDeviceId, trapTemperatureNormal=trapTemperatureNormal, diskEntry=diskEntry, mbVersionName=mbVersionName, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, sysBIOSManufacturer=sysBIOSManufacturer, raidAdapterEntry=raidAdapterEntry, raidDiskGroupId_PD=raidDiskGroupId_PD, raidAdapterIndex=raidAdapterIndex, cpuThreadCount=cpuThreadCount, memECCErrorCount=memECCErrorCount, cpuDescription=cpuDescription, diskInterfaceType=diskInterfaceType, memDeviceLocator=memDeviceLocator, cpuLogIndex=cpuLogIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidBBUAllinoneStatus=raidBBUAllinoneStatus, diskName=diskName, diskSize=diskSize, raidVDRaidLevel=raidVDRaidLevel, raidVDSupportT10Power=raidVDSupportT10Power, raidPDWriteCache=raidPDWriteCache, memTable=memTable, raidBBUTable=raidBBUTable, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDMirrorDataSize=raidVDMirrorDataSize, diskSlotID=diskSlotID, trapVoltageNormal=trapVoltageNormal, raidAdapterId=raidAdapterId, cpuMaxSpeed=cpuMaxSpeed, raidVDAllinoneMsg=raidVDAllinoneMsg, memSerialNumber=memSerialNumber, mbTable=mbTable, ueccLogTable=ueccLogTable, ceccLogIndex=ceccLogIndex, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, mbProductName=mbProductName, sd5MIBVersion=sd5MIBVersion, raidVDName=raidVDName, cpuName=cpuName, diskVendor=diskVendor, raidPDPort0Status=raidPDPort0Status, trapBbpStatusWarning=trapBbpStatusWarning, raidAdapterSerialNumber=raidAdapterSerialNumber, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidVDAllinoneStatus=raidVDAllinoneStatus, diskMediaType=diskMediaType, cpuCoreCount=cpuCoreCount, raidPDSerialNumber=raidPDSerialNumber, raidVDCached=raidVDCached, ceccLogInfo=ceccLogInfo, osEntry=osEntry, trapFanNormal=trapFanNormal, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapBbpStatusCritical=trapBbpStatusCritical, raidPDPort1Status=raidPDPort1Status, raidAdapterGroup=raidAdapterGroup, raidBBUAllinoneMsg=raidBBUAllinoneMsg, ueccLogDatetime=ueccLogDatetime, sd5Version=sd5Version, sysBIOSEntry=sysBIOSEntry, cpuTable=cpuTable, cpuDeviceVersion=cpuDeviceVersion, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDModel=raidPDModel, raidPDOtherErrorCount=raidPDOtherErrorCount, sysBIOSReleaseDate=sysBIOSReleaseDate, cpuDeviceStatus=cpuDeviceStatus, osName=osName, raidVDSpanDepth=raidVDSpanDepth, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, trapCpuFaultCritical=trapCpuFaultCritical, smSD5TrapMIB=smSD5TrapMIB, raidPDIndex=raidPDIndex, cpuCoreEnabled=cpuCoreEnabled, trapMemoryUeccWarning=trapMemoryUeccWarning, trapVoltageWarning=trapVoltageWarning, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidPDInquiryData=raidPDInquiryData, trapBatteryStatusNormal=trapBatteryStatusNormal, cpuCurrentSpeed=cpuCurrentSpeed, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapPowerSupplyNormal=trapPowerSupplyNormal, memManufacturer=memManufacturer, diskSerialNumber=diskSerialNumber, trapGenericCritical=trapGenericCritical, memEntry=memEntry, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterId_VD=raidAdapterId_VD, trapMemoryCeccCritical=trapMemoryCeccCritical, trapVoltageCritical=trapVoltageCritical, memUECCErrorCount=memUECCErrorCount, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidVDId=raidVDId, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidBBUEntry=raidBBUEntry, raidVDEncryptionType=raidVDEncryptionType, trapTemperatureCritical=trapTemperatureCritical, diskController=diskController, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapGenericNormal=trapGenericNormal, osSerialNumber=osSerialNumber, raidVDEntry=raidVDEntry, mbManufacturer=mbManufacturer, memTotalWidth=memTotalWidth, osIndex=osIndex, diskSmartStatus=diskSmartStatus, raidBBUIndex=raidBBUIndex, raidVDBadBlocksExist=raidVDBadBlocksExist, trapFanWarning=trapFanWarning, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, ueccLogInfo=ueccLogInfo, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDRawSize=raidPDRawSize, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, cpuID=cpuID, raidDiskGroupId=raidDiskGroupId, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDEntry=raidPDEntry, raidPDMediaType=raidPDMediaType, raidPDFirmwareRevision=raidPDFirmwareRevision, memDeviceStatus=memDeviceStatus, osCSDVersion=osCSDVersion, postLogIndex=postLogIndex, trapPowerSupplyCritical=trapPowerSupplyCritical, memLabeledBank=memLabeledBank, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapMemoryCeccNormal=trapMemoryCeccNormal, ueccLogEntry=ueccLogEntry, trapFanCritical=trapFanCritical, osManufacturer=osManufacturer, raidPDSpan=raidPDSpan, cpuLogTable=cpuLogTable, raidVDStripSize=raidVDStripSize, trapGenericWarning=trapGenericWarning, raidAdapterVendorId=raidAdapterVendorId, memPartNumber=memPartNumber, trapBatteryStatusWarning=trapBatteryStatusWarning, ueccLogIndex=ueccLogIndex, raidPDSlotNumber=raidPDSlotNumber, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, postLogDatetime=postLogDatetime, trapPowerSupplyWarning=trapPowerSupplyWarning, mbIndex=mbIndex, ceccLogEntry=ceccLogEntry, mbSerialNumber=mbSerialNumber, raidAdapterTable=raidAdapterTable, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, mbEntry=mbEntry, memErrorCount=memErrorCount, ceccLogDatetime=ceccLogDatetime, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapBatteryStatusCritical=trapBatteryStatusCritical, cpuDeviceID=cpuDeviceID, memDataWidth=memDataWidth, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDDeviceSpeed=raidPDDeviceSpeed, trapChassisIntrusion=trapChassisIntrusion, trapMemoryUeccNormal=trapMemoryUeccNormal, postLogInfo=postLogInfo, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, sd5Idx=sd5Idx, osTable=osTable, mbAssetTag=mbAssetTag, raidVDTargetId=raidVDTargetId, raidVDSize=raidVDSize, PYSNMP_MODULE_ID=smSuperDoctor5MIB, memTag=memTag, raidVDTable=raidVDTable, postLogEntry=postLogEntry, sd5Entry=sd5Entry, raidAdapterGroup_PD=raidAdapterGroup_PD, cpuLogDatetime=cpuLogDatetime, sysBIOSIndex=sysBIOSIndex, raidAdapterId_PD=raidAdapterId_PD, raidAdapterId_BBU=raidAdapterId_BBU, trapCpuFaultNormal=trapCpuFaultNormal, trapBbpStatusNormal=trapBbpStatusNormal, raidPDTable=raidPDTable, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDNCQSetting=raidPDNCQSetting, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuLoadingPercentage=cpuLoadingPercentage, sysBIOSVersion=sysBIOSVersion, cpuLogEntry=cpuLogEntry, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, memModel=memModel, cpuLogInfo=cpuLogInfo, raidVDState=raidVDState, trapCpuFaultWarning=trapCpuFaultWarning)
