...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuMaxSpeed=cpuMaxSpeed, ueccLogDatetime=ueccLogDatetime, raidVDNumDrives=raidVDNumDrives, sd5Idx=sd5Idx, cpuCoreCount=cpuCoreCount, diskController=diskController, postLogTable=postLogTable, cpuDeviceStatus=cpuDeviceStatus, cpuManufacturer=cpuManufacturer, raidPDSlotNumber=raidPDSlotNumber, raidPDPort1Status=raidPDPort1Status, trapFanNormal=trapFanNormal, memModel=memModel, sysBIOSTable=sysBIOSTable, postLogInfo=postLogInfo, trapFanCritical=trapFanCritical, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDTargetId=raidVDTargetId, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidVDStripSize=raidVDStripSize, memSerialNumber=memSerialNumber, raidPDSerialNumber=raidPDSerialNumber, cpuID=cpuID, memTable=memTable, osTable=osTable, trapMemoryUeccNormal=trapMemoryUeccNormal, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, memDeviceStatus=memDeviceStatus, raidVDTable=raidVDTable, raidPDEntry=raidPDEntry, osManufacturer=osManufacturer, raidVDSpanDepth=raidVDSpanDepth, raidAdapterSubDeviceId=raidAdapterSubDeviceId, mbTable=mbTable, diskModel=diskModel, mbIndex=mbIndex, cpuCurrentSpeed=cpuCurrentSpeed, cpuSocketDesignation=cpuSocketDesignation, raidBBUStatus=raidBBUStatus, ceccLogTable=ceccLogTable, trapGenericNormal=trapGenericNormal, raidAdapterIndex=raidAdapterIndex, sysBIOSEntry=sysBIOSEntry, trapCpuFaultNormal=trapCpuFaultNormal, dmiLogTable=dmiLogTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidAdapterId_PD=raidAdapterId_PD, raidDiskGroupId_PD=raidDiskGroupId_PD, postLogEntry=postLogEntry, smSD5TrapMIB=smSD5TrapMIB, raidPDAllinoneMsg=raidPDAllinoneMsg, raidBBUEntry=raidBBUEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, smSuperDoctor5MIB=smSuperDoctor5MIB, mbEntry=mbEntry, PYSNMP_MODULE_ID=smSuperDoctor5MIB, ueccLogEntry=ueccLogEntry, diskEntry=diskEntry, raidVDBadBlocksExist=raidVDBadBlocksExist, raidAdapterSerialNumber=raidAdapterSerialNumber, memDescription=memDescription, trapBatteryStatusCritical=trapBatteryStatusCritical, cpuLogInfo=cpuLogInfo, sysBIOSVersion=sysBIOSVersion, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDRawSize=raidPDRawSize, raidPDFirmwareRevision=raidPDFirmwareRevision, trapBbpStatusWarning=trapBbpStatusWarning, trapBbpStatusNormal=trapBbpStatusNormal, diskName=diskName, cpuCoreEnabled=cpuCoreEnabled, sd5Entry=sd5Entry, memECCErrorCount=memECCErrorCount, diskInterfaceType=diskInterfaceType, mbSerialNumber=mbSerialNumber, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapPowerSupplyNormal=trapPowerSupplyNormal, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDEntry=raidVDEntry, memDataWidth=memDataWidth, trapTemperatureCritical=trapTemperatureCritical, trapBatteryStatusWarning=trapBatteryStatusWarning, cpuName=cpuName, osCSDVersion=osCSDVersion, cpuLogEntry=cpuLogEntry, trapChassisIntrusion=trapChassisIntrusion, ueccLogTable=ueccLogTable, memLabeledBank=memLabeledBank, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapGenericWarning=trapGenericWarning, cpuLoadingPercentage=cpuLoadingPercentage, raidVDName=raidVDName, raidAdapterGroup_PD=raidAdapterGroup_PD, trapBbpStatusCritical=trapBbpStatusCritical, cpuDeviceVersion=cpuDeviceVersion, cpuDeviceID=cpuDeviceID, ueccLogInfo=ueccLogInfo, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidVDSupportsMaxPS=raidVDSupportsMaxPS, cpuTable=cpuTable, memUECCErrorCount=memUECCErrorCount, postLogIndex=postLogIndex, sd5Version=sd5Version, diskVendor=diskVendor, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDCached=raidVDCached, raidPDMediaType=raidPDMediaType, cpuLogIndex=cpuLogIndex, mbAssetTag=mbAssetTag, raidAdapterDeviceId=raidAdapterDeviceId, cpuIndex=cpuIndex, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapCpuFaultWarning=trapCpuFaultWarning, raidAdapterId=raidAdapterId, trapMemoryCeccWarning=trapMemoryCeccWarning, memPartNumber=memPartNumber, diskSize=diskSize, raidAdapterId_BBU=raidAdapterId_BBU, raidVDEncryptionType=raidVDEncryptionType, raidVDState=raidVDState, mbManufacturer=mbManufacturer, raidVDIndex=raidVDIndex, raidAdapterGroup=raidAdapterGroup, trapVoltageNormal=trapVoltageNormal, mbProductName=mbProductName, cpuDescription=cpuDescription, memDeviceLocator=memDeviceLocator, sysBIOSManufacturer=sysBIOSManufacturer, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDPort0Status=raidPDPort0Status, sd5MIBVersion=sd5MIBVersion, raidPDTable=raidPDTable, memCapacity=memCapacity, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDRaidLevel=raidVDRaidLevel, raidIsBBUAbsent=raidIsBBUAbsent, ceccLogIndex=ceccLogIndex, raidPDIndex=raidPDIndex, raidPDDeviceSpeed=raidPDDeviceSpeed, postLogDatetime=postLogDatetime, cpuLogDatetime=cpuLogDatetime, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskSlotID=diskSlotID, cpuThreadCount=cpuThreadCount, raidDiskGroupId=raidDiskGroupId, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapTemperatureNormal=trapTemperatureNormal, raidPDSpan=raidPDSpan, raidPDNCQSetting=raidPDNCQSetting, trapVoltageWarning=trapVoltageWarning, sysBIOSIndex=sysBIOSIndex, raidAdapterGroup_VD=raidAdapterGroup_VD, diskSerialNumber=diskSerialNumber, raidAdapterSubVendorId=raidAdapterSubVendorId, osName=osName, diskTable=diskTable, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterEntry=raidAdapterEntry, raidPDFirmwareState=raidPDFirmwareState, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDSupportT10Power=raidVDSupportT10Power, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapCpuFaultCritical=trapCpuFaultCritical, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, memTotalWidth=memTotalWidth, memEntry=memEntry, memErrorCount=memErrorCount, raidAdapterProductName=raidAdapterProductName, raidPDWriteCache=raidPDWriteCache, sysBIOSReleaseDate=sysBIOSReleaseDate, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDSize=raidVDSize, ceccLogDatetime=ceccLogDatetime, raidPDPredFailCount=raidPDPredFailCount, diskSmartStatus=diskSmartStatus, memTag=memTag, osSerialNumber=osSerialNumber, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapFanWarning=trapFanWarning, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterId_VD=raidAdapterId_VD, raidVDId=raidVDId, raidBBUIndex=raidBBUIndex, raidPDOpProgress=raidPDOpProgress, sd5Table=sd5Table, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDMediaErrorCount=raidPDMediaErrorCount, mbVersionName=mbVersionName, cpuEntry=cpuEntry, raidPDInquiryData=raidPDInquiryData, trapPowerSupplyWarning=trapPowerSupplyWarning, osIndex=osIndex, raidAdapterTable=raidAdapterTable, osVersion=osVersion, trapVoltageCritical=trapVoltageCritical, trapTemperatureWarning=trapTemperatureWarning, ueccLogIndex=ueccLogIndex, diskMediaType=diskMediaType, ceccLogEntry=ceccLogEntry, osEntry=osEntry, raidVDMirrorDataSize=raidVDMirrorDataSize, raidBBUTable=raidBBUTable, cpuLogTable=cpuLogTable, raidAdapterVendorId=raidAdapterVendorId, trapGenericCritical=trapGenericCritical, memManufacturer=memManufacturer, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidPDModel=raidPDModel, trapMemoryUeccWarning=trapMemoryUeccWarning, trapMemoryUeccCritical=trapMemoryUeccCritical, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, ceccLogInfo=ceccLogInfo)
