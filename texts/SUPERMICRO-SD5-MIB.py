...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memPartNumber=memPartNumber, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDTable=raidPDTable, trapGenericNormal=trapGenericNormal, trapBatteryStatusCritical=trapBatteryStatusCritical, trapMemoryCeccCritical=trapMemoryCeccCritical, raidAdapterFWVersion=raidAdapterFWVersion, memDescription=memDescription, raidAdapterId_BBU=raidAdapterId_BBU, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDCached=raidVDCached, raidDiskGroupId=raidDiskGroupId, diskController=diskController, raidAdapterId_PD=raidAdapterId_PD, raidPDRawSize=raidPDRawSize, trapVoltageCritical=trapVoltageCritical, raidVDStripSize=raidVDStripSize, trapTemperatureWarning=trapTemperatureWarning, cpuLogTable=cpuLogTable, raidPDWriteCache=raidPDWriteCache, trapGenericCritical=trapGenericCritical, raidPDMediaType=raidPDMediaType, raidPDAllinoneStatus=raidPDAllinoneStatus, trapVoltageWarning=trapVoltageWarning, mbAssetTag=mbAssetTag, raidPDSerialNumber=raidPDSerialNumber, raidVDNumDrives=raidVDNumDrives, memUECCErrorCount=memUECCErrorCount, memSerialNumber=memSerialNumber, diskSmartStatus=diskSmartStatus, raidAdapterSubVendorId=raidAdapterSubVendorId, ceccLogEntry=ceccLogEntry, raidVDState=raidVDState, PYSNMP_MODULE_ID=smSuperDoctor5MIB, mbProductName=mbProductName, cpuDescription=cpuDescription, ceccLogTable=ceccLogTable, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDModel=raidPDModel, sysBIOSTable=sysBIOSTable, mbIndex=mbIndex, raidVDBadBlocksExist=raidVDBadBlocksExist, postLogTable=postLogTable, osCSDVersion=osCSDVersion, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDAllinoneStatus=raidVDAllinoneStatus, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuCoreCount=cpuCoreCount, osName=osName, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidAdapterId_VD=raidAdapterId_VD, raidVDSpanDepth=raidVDSpanDepth, sysBIOSIndex=sysBIOSIndex, memLabeledBank=memLabeledBank, raidPDPredFailCount=raidPDPredFailCount, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapFanWarning=trapFanWarning, cpuManufacturer=cpuManufacturer, raidAdapterIndex=raidAdapterIndex, memDeviceLocator=memDeviceLocator, ueccLogIndex=ueccLogIndex, raidAdapterDeviceId=raidAdapterDeviceId, raidVDName=raidVDName, cpuID=cpuID, trapCpuFaultWarning=trapCpuFaultWarning, raidVDTable=raidVDTable, cpuIndex=cpuIndex, trapFanCritical=trapFanCritical, trapPowerSupplyNormal=trapPowerSupplyNormal, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, ueccLogEntry=ueccLogEntry, raidVDEntry=raidVDEntry, memDeviceStatus=memDeviceStatus, memTable=memTable, sysBIOSManufacturer=sysBIOSManufacturer, raidBBUTable=raidBBUTable, raidDiskGroupId_PD=raidDiskGroupId_PD, trapChassisIntrusion=trapChassisIntrusion, diskTable=diskTable, osManufacturer=osManufacturer, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapBbpStatusCritical=trapBbpStatusCritical, diskSlotID=diskSlotID, trapBbpStatusNormal=trapBbpStatusNormal, raidBBUStatus=raidBBUStatus, mbEntry=mbEntry, mbTable=mbTable, memDataWidth=memDataWidth, sd5Version=sd5Version, cpuLoadingPercentage=cpuLoadingPercentage, diskName=diskName, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterProductName=raidAdapterProductName, ceccLogInfo=ceccLogInfo, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, diskModel=diskModel, trapVoltageNormal=trapVoltageNormal, sd5MIBVersion=sd5MIBVersion, smSD5TrapMIB=smSD5TrapMIB, diskVendor=diskVendor, trapCpuFaultNormal=trapCpuFaultNormal, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDSlotNumber=raidPDSlotNumber, cpuLogEntry=cpuLogEntry, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuName=cpuName, trapCpuFaultCritical=trapCpuFaultCritical, raidPDOpProgress=raidPDOpProgress, osVersion=osVersion, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDPort0Linkspeed=raidPDPort0Linkspeed, memTag=memTag, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDSize=raidVDSize, memECCErrorCount=memECCErrorCount, diskSize=diskSize, diskMediaType=diskMediaType, raidPDInquiryData=raidPDInquiryData, trapTemperatureCritical=trapTemperatureCritical, cpuCoreEnabled=cpuCoreEnabled, cpuDeviceID=cpuDeviceID, raidAdapterTable=raidAdapterTable, raidPDEntry=raidPDEntry, cpuDeviceVersion=cpuDeviceVersion, raidPDMediaErrorCount=raidPDMediaErrorCount, trapMemoryUeccNormal=trapMemoryUeccNormal, mbManufacturer=mbManufacturer, raidVDDiskCachePolicy=raidVDDiskCachePolicy, osEntry=osEntry, raidVDIndex=raidVDIndex, cpuLogInfo=cpuLogInfo, cpuSocketDesignation=cpuSocketDesignation, trapBatteryStatusWarning=trapBatteryStatusWarning, trapTemperatureNormal=trapTemperatureNormal, postLogDatetime=postLogDatetime, mbVersionName=mbVersionName, memEntry=memEntry, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDEncryptionType=raidVDEncryptionType, memErrorCount=memErrorCount, trapMemoryUeccCritical=trapMemoryUeccCritical, osSerialNumber=osSerialNumber, sd5Entry=sd5Entry, memTotalWidth=memTotalWidth, osIndex=osIndex, trapMemoryUeccWarning=trapMemoryUeccWarning, ceccLogIndex=ceccLogIndex, diskSerialNumber=diskSerialNumber, raidAdapterId=raidAdapterId, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDAllinoneMsg=raidPDAllinoneMsg, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuCurrentSpeed=cpuCurrentSpeed, raidPDPort1Linkspeed=raidPDPort1Linkspeed, ueccLogDatetime=ueccLogDatetime, sd5Idx=sd5Idx, cpuDeviceStatus=cpuDeviceStatus, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, diskInterfaceType=diskInterfaceType, raidVDId=raidVDId, raidPDFirmwareState=raidPDFirmwareState, dmiLogTable=dmiLogTable, raidBBUIndex=raidBBUIndex, raidVDTargetId=raidVDTargetId, raidPDNCQSetting=raidPDNCQSetting, memModel=memModel, mbSerialNumber=mbSerialNumber, trapFanNormal=trapFanNormal, raidAdapterSerialNumber=raidAdapterSerialNumber, cpuEntry=cpuEntry, cpuThreadCount=cpuThreadCount, sd5Table=sd5Table, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuTable=cpuTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuLogIndex=cpuLogIndex, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidAdapterGroup_VD=raidAdapterGroup_VD, memManufacturer=memManufacturer, memCapacity=memCapacity, raidPDSpan=raidPDSpan, cpuLogDatetime=cpuLogDatetime, raidIsBBUAbsent=raidIsBBUAbsent, trapPowerSupplyCritical=trapPowerSupplyCritical, raidVDSupportT10Power=raidVDSupportT10Power, postLogIndex=postLogIndex, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, postLogInfo=postLogInfo, ueccLogTable=ueccLogTable, sysBIOSEntry=sysBIOSEntry, raidPDIndex=raidPDIndex, trapGenericWarning=trapGenericWarning, raidPDPort1Status=raidPDPort1Status, osTable=osTable, raidAdapterEntry=raidAdapterEntry, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, cpuMaxSpeed=cpuMaxSpeed, postLogEntry=postLogEntry, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, ceccLogDatetime=ceccLogDatetime, raidVDRaidLevel=raidVDRaidLevel, smSuperDoctor5MIB=smSuperDoctor5MIB, trapBatteryStatusNormal=trapBatteryStatusNormal, sysBIOSReleaseDate=sysBIOSReleaseDate, trapBbpStatusWarning=trapBbpStatusWarning, diskEntry=diskEntry, raidAdapterGroup=raidAdapterGroup, ueccLogInfo=ueccLogInfo, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterVendorId=raidAdapterVendorId, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDPort0Status=raidPDPort0Status, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDMirrorDataSize=raidVDMirrorDataSize, raidBBUEntry=raidBBUEntry, sysBIOSVersion=sysBIOSVersion)
