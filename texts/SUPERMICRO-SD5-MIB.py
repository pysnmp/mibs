...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapBbpStatusNormal=trapBbpStatusNormal, cpuName=cpuName, diskController=diskController, raidVDEncryptionType=raidVDEncryptionType, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDName=raidVDName, raidPDDeviceSpeed=raidPDDeviceSpeed, osVersion=osVersion, cpuDeviceStatus=cpuDeviceStatus, trapTemperatureNormal=trapTemperatureNormal, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDPort0Status=raidPDPort0Status, raidPDOtherErrorCount=raidPDOtherErrorCount, trapVoltageWarning=trapVoltageWarning, trapMemoryCeccWarning=trapMemoryCeccWarning, trapBbpStatusWarning=trapBbpStatusWarning, osIndex=osIndex, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidVDBadBlocksExist=raidVDBadBlocksExist, raidPDIndex=raidPDIndex, trapChassisIntrusion=trapChassisIntrusion, raidAdapterIndex=raidAdapterIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, dmiLogTable=dmiLogTable, raidPDRawSize=raidPDRawSize, smSuperDoctor5MIB=smSuperDoctor5MIB, diskMediaType=diskMediaType, raidVDEntry=raidVDEntry, ceccLogEntry=ceccLogEntry, raidVDStripSize=raidVDStripSize, smSD5TrapMIB=smSD5TrapMIB, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDInquiryData=raidPDInquiryData, cpuCurrentSpeed=cpuCurrentSpeed, sysBIOSIndex=sysBIOSIndex, sd5Idx=sd5Idx, memCapacity=memCapacity, sysBIOSTable=sysBIOSTable, memTotalWidth=memTotalWidth, trapTemperatureCritical=trapTemperatureCritical, raidDiskGroupId_PD=raidDiskGroupId_PD, memManufacturer=memManufacturer, mbProductName=mbProductName, raidVDId=raidVDId, trapGenericCritical=trapGenericCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDFirmwareState=raidPDFirmwareState, memPartNumber=memPartNumber, cpuLogTable=cpuLogTable, postLogTable=postLogTable, raidAdapterSubVendorId=raidAdapterSubVendorId, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, ueccLogTable=ueccLogTable, trapMemoryUeccNormal=trapMemoryUeccNormal, raidIsBBUAbsent=raidIsBBUAbsent, osCSDVersion=osCSDVersion, memModel=memModel, raidPDTable=raidPDTable, diskName=diskName, raidBBUStatus=raidBBUStatus, cpuLogIndex=cpuLogIndex, trapBatteryStatusCritical=trapBatteryStatusCritical, memDeviceStatus=memDeviceStatus, raidPDOpProgress=raidPDOpProgress, raidVDTargetId=raidVDTargetId, trapBatteryStatusWarning=trapBatteryStatusWarning, trapMemoryCeccCritical=trapMemoryCeccCritical, trapBatteryStatusNormal=trapBatteryStatusNormal, cpuCoreCount=cpuCoreCount, raidPDModel=raidPDModel, cpuLogEntry=cpuLogEntry, trapMemoryUeccWarning=trapMemoryUeccWarning, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapPowerSupplyWarning=trapPowerSupplyWarning, ueccLogIndex=ueccLogIndex, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuCoreEnabled=cpuCoreEnabled, PYSNMP_MODULE_ID=smSuperDoctor5MIB, diskEntry=diskEntry, cpuSocketDesignation=cpuSocketDesignation, osSerialNumber=osSerialNumber, mbVersionName=mbVersionName, raidAdapterId_VD=raidAdapterId_VD, trapCpuFaultWarning=trapCpuFaultWarning, raidVDTable=raidVDTable, trapFanWarning=trapFanWarning, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterTable=raidAdapterTable, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, sd5Version=sd5Version, raidAdapterId_BBU=raidAdapterId_BBU, raidPDLinkSpeed=raidPDLinkSpeed, mbManufacturer=mbManufacturer, diskSmartStatus=diskSmartStatus, trapTemperatureWarning=trapTemperatureWarning, sd5Entry=sd5Entry, cpuIndex=cpuIndex, raidVDNumDrives=raidVDNumDrives, trapVoltageNormal=trapVoltageNormal, memDataWidth=memDataWidth, trapCpuFaultNormal=trapCpuFaultNormal, trapFanCritical=trapFanCritical, cpuManufacturer=cpuManufacturer, memEntry=memEntry, raidPDSlotNumber=raidPDSlotNumber, raidVDIndex=raidVDIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterGroup_VD=raidAdapterGroup_VD, raidBBUTable=raidBBUTable, sysBIOSManufacturer=sysBIOSManufacturer, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterDeviceId=raidAdapterDeviceId, raidPDAllinoneMsg=raidPDAllinoneMsg, cpuDescription=cpuDescription, sd5Table=sd5Table, memDeviceLocator=memDeviceLocator, osTable=osTable, trapFanNormal=trapFanNormal, raidAdapterEntry=raidAdapterEntry, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapGenericWarning=trapGenericWarning, raidPDPort1Status=raidPDPort1Status, diskSlotID=diskSlotID, osEntry=osEntry, cpuLoadingPercentage=cpuLoadingPercentage, raidAdapterProductName=raidAdapterProductName, raidVDState=raidVDState, cpuDeviceID=cpuDeviceID, ueccLogDatetime=ueccLogDatetime, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapMemoryUeccCritical=trapMemoryUeccCritical, postLogIndex=postLogIndex, postLogInfo=postLogInfo, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, sysBIOSReleaseDate=sysBIOSReleaseDate, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, sysBIOSEntry=sysBIOSEntry, mbTable=mbTable, raidPDPredFailCount=raidPDPredFailCount, diskSize=diskSize, sd5MIBVersion=sd5MIBVersion, memErrorCount=memErrorCount, raidPDNCQSetting=raidPDNCQSetting, memLabeledBank=memLabeledBank, raidPDWriteCache=raidPDWriteCache, diskTable=diskTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, ceccLogTable=ceccLogTable, raidVDCached=raidVDCached, raidAdapterSerialNumber=raidAdapterSerialNumber, raidVDRaidLevel=raidVDRaidLevel, trapGenericNormal=trapGenericNormal, raidBBUAllinoneMsg=raidBBUAllinoneMsg, cpuThreadCount=cpuThreadCount, ueccLogEntry=ueccLogEntry, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapBbpStatusCritical=trapBbpStatusCritical, memTable=memTable, mbIndex=mbIndex, mbEntry=mbEntry, diskInterfaceType=diskInterfaceType, ceccLogDatetime=ceccLogDatetime, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDMediaType=raidPDMediaType, cpuID=cpuID, mbSerialNumber=mbSerialNumber, trapPowerSupplyNormal=trapPowerSupplyNormal, raidAdapterId=raidAdapterId, cpuTable=cpuTable, cpuDeviceVersion=cpuDeviceVersion, raidVDSupportT10Power=raidVDSupportT10Power, diskModel=diskModel, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDSpanDepth=raidVDSpanDepth, raidAdapterId_PD=raidAdapterId_PD, osName=osName, raidPDMediaErrorCount=raidPDMediaErrorCount, postLogEntry=postLogEntry, raidPDSpan=raidPDSpan, trapCpuFaultCritical=trapCpuFaultCritical, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidBBUEntry=raidBBUEntry, ceccLogInfo=ceccLogInfo, diskVendor=diskVendor, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, ceccLogIndex=ceccLogIndex, raidVDSize=raidVDSize, raidPDPort0Linkspeed=raidPDPort0Linkspeed, cpuLogDatetime=cpuLogDatetime, raidAdapterSubDeviceId=raidAdapterSubDeviceId, memECCErrorCount=memECCErrorCount, raidPDFirmwareRevision=raidPDFirmwareRevision, memUECCErrorCount=memUECCErrorCount, cpuEntry=cpuEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDSerialNumber=raidPDSerialNumber, trapVoltageCritical=trapVoltageCritical, raidVDAllinoneStatus=raidVDAllinoneStatus, raidAdapterGroup=raidAdapterGroup, raidPDEntry=raidPDEntry, diskSerialNumber=diskSerialNumber, memSerialNumber=memSerialNumber, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterVendorId=raidAdapterVendorId, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidBBUIndex=raidBBUIndex, memDescription=memDescription, cpuMaxSpeed=cpuMaxSpeed, raidDiskGroupId=raidDiskGroupId, sysBIOSVersion=sysBIOSVersion, osManufacturer=osManufacturer, cpuLogInfo=cpuLogInfo, postLogDatetime=postLogDatetime, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, ueccLogInfo=ueccLogInfo, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDDiskCachePolicy=raidVDDiskCachePolicy, mbAssetTag=mbAssetTag, memTag=memTag)
