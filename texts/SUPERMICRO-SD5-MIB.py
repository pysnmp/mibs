...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuThreadCount=cpuThreadCount, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDSerialNumber=raidPDSerialNumber, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDState=raidVDState, sd5Entry=sd5Entry, diskSmartStatus=diskSmartStatus, memPartNumber=memPartNumber, cpuDeviceVersion=cpuDeviceVersion, raidPDMediaErrorCount=raidPDMediaErrorCount, smSD5TrapMIB=smSD5TrapMIB, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDEncryptionType=raidVDEncryptionType, raidPDIndex=raidPDIndex, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuTable=cpuTable, cpuCoreEnabled=cpuCoreEnabled, raidAdapterEntry=raidAdapterEntry, raidVDSize=raidVDSize, sd5MIBVersion=sd5MIBVersion, raidAdapterTable=raidAdapterTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, cpuLogInfo=cpuLogInfo, sysBIOSReleaseDate=sysBIOSReleaseDate, raidBBUAllinoneMsg=raidBBUAllinoneMsg, trapVoltageWarning=trapVoltageWarning, cpuMaxSpeed=cpuMaxSpeed, osTable=osTable, ueccLogEntry=ueccLogEntry, trapFanNormal=trapFanNormal, ceccLogIndex=ceccLogIndex, cpuName=cpuName, raidVDTable=raidVDTable, diskSize=diskSize, trapFanCritical=trapFanCritical, raidAdapterId_BBU=raidAdapterId_BBU, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, memDescription=memDescription, raidAdapterId=raidAdapterId, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapPowerSupplyCritical=trapPowerSupplyCritical, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapBatteryStatusWarning=trapBatteryStatusWarning, raidIsBBUAbsent=raidIsBBUAbsent, raidVDTargetId=raidVDTargetId, raidVDIndex=raidVDIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDTable=raidPDTable, raidPDEntry=raidPDEntry, raidPDFirmwareState=raidPDFirmwareState, raidPDRawSize=raidPDRawSize, mbEntry=mbEntry, raidAdapterSerialNumber=raidAdapterSerialNumber, trapBatteryStatusCritical=trapBatteryStatusCritical, cpuIndex=cpuIndex, memECCErrorCount=memECCErrorCount, raidAdapterId_VD=raidAdapterId_VD, trapGenericWarning=trapGenericWarning, raidVDName=raidVDName, raidAdapterIndex=raidAdapterIndex, cpuSocketDesignation=cpuSocketDesignation, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDPort0Status=raidPDPort0Status, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapMemoryUeccCritical=trapMemoryUeccCritical, raidDiskGroupId=raidDiskGroupId, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, ceccLogDatetime=ceccLogDatetime, memDataWidth=memDataWidth, raidVDEntry=raidVDEntry, raidBBUEntry=raidBBUEntry, ceccLogInfo=ceccLogInfo, cpuLogDatetime=cpuLogDatetime, trapTemperatureCritical=trapTemperatureCritical, mbProductName=mbProductName, memTable=memTable, raidVDSupportT10Power=raidVDSupportT10Power, postLogEntry=postLogEntry, trapVoltageNormal=trapVoltageNormal, memTag=memTag, trapBbpStatusNormal=trapBbpStatusNormal, memEntry=memEntry, diskController=diskController, trapGenericCritical=trapGenericCritical, cpuDescription=cpuDescription, raidVDDiskCachePolicy=raidVDDiskCachePolicy, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapMemoryCeccWarning=trapMemoryCeccWarning, sysBIOSEntry=sysBIOSEntry, mbTable=mbTable, osName=osName, raidPDSpan=raidPDSpan, raidBBUTable=raidBBUTable, trapVoltageCritical=trapVoltageCritical, sysBIOSTable=sysBIOSTable, diskModel=diskModel, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memUECCErrorCount=memUECCErrorCount, raidAdapterGroup_PD=raidAdapterGroup_PD, trapTemperatureWarning=trapTemperatureWarning, raidDiskGroupId_PD=raidDiskGroupId_PD, diskVendor=diskVendor, mbManufacturer=mbManufacturer, memLabeledBank=memLabeledBank, raidBBUStatus=raidBBUStatus, smSuperDoctor5MIB=smSuperDoctor5MIB, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidBBUIndex=raidBBUIndex, raidVDSpanDepth=raidVDSpanDepth, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDMediaType=raidPDMediaType, raidAdapterVendorId=raidAdapterVendorId, cpuLogTable=cpuLogTable, ueccLogDatetime=ueccLogDatetime, diskSerialNumber=diskSerialNumber, sd5Version=sd5Version, cpuManufacturer=cpuManufacturer, ueccLogTable=ueccLogTable, cpuLogEntry=cpuLogEntry, raidVDId=raidVDId, raidVDNumDrives=raidVDNumDrives, raidPDPort0Linkspeed=raidPDPort0Linkspeed, sd5Idx=sd5Idx, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuEntry=cpuEntry, cpuCurrentSpeed=cpuCurrentSpeed, memErrorCount=memErrorCount, osEntry=osEntry, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidAdapterFWVersion=raidAdapterFWVersion, raidPDPredFailCount=raidPDPredFailCount, cpuLogIndex=cpuLogIndex, raidPDPort1Status=raidPDPort1Status, raidPDOpProgress=raidPDOpProgress, diskTable=diskTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidPDModel=raidPDModel, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, cpuDeviceID=cpuDeviceID, osVersion=osVersion, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapMemoryCeccCritical=trapMemoryCeccCritical, memCapacity=memCapacity, trapChassisIntrusion=trapChassisIntrusion, memManufacturer=memManufacturer, diskInterfaceType=diskInterfaceType, postLogDatetime=postLogDatetime, osManufacturer=osManufacturer, trapBbpStatusWarning=trapBbpStatusWarning, mbSerialNumber=mbSerialNumber, raidPDLinkSpeed=raidPDLinkSpeed, trapCpuFaultWarning=trapCpuFaultWarning, raidPDAllinoneStatus=raidPDAllinoneStatus, sysBIOSIndex=sysBIOSIndex, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDStripSize=raidVDStripSize, cpuDeviceStatus=cpuDeviceStatus, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDBadBlocksExist=raidVDBadBlocksExist, memDeviceStatus=memDeviceStatus, diskSlotID=diskSlotID, trapFanWarning=trapFanWarning, trapPowerSupplyNormal=trapPowerSupplyNormal, postLogInfo=postLogInfo, diskName=diskName, raidPDInquiryData=raidPDInquiryData, mbIndex=mbIndex, osSerialNumber=osSerialNumber, diskMediaType=diskMediaType, raidPDAllinoneMsg=raidPDAllinoneMsg, trapTemperatureNormal=trapTemperatureNormal, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDSupportsMaxPS=raidVDSupportsMaxPS, ceccLogTable=ceccLogTable, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuLoadingPercentage=cpuLoadingPercentage, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDSlotNumber=raidPDSlotNumber, memTotalWidth=memTotalWidth, raidPDWriteCache=raidPDWriteCache, raidPDNCQSetting=raidPDNCQSetting, ueccLogInfo=ueccLogInfo, raidVDCached=raidVDCached, raidAdapterId_PD=raidAdapterId_PD, trapCpuFaultNormal=trapCpuFaultNormal, trapPowerSupplyWarning=trapPowerSupplyWarning, raidAdapterProductName=raidAdapterProductName, osCSDVersion=osCSDVersion, postLogIndex=postLogIndex, raidAdapterDeviceId=raidAdapterDeviceId, mbVersionName=mbVersionName, trapMemoryCeccNormal=trapMemoryCeccNormal, ueccLogIndex=ueccLogIndex, raidPDFirmwareRevision=raidPDFirmwareRevision, cpuID=cpuID, raidVDRaidLevel=raidVDRaidLevel, mbAssetTag=mbAssetTag, dmiLogTable=dmiLogTable, memSerialNumber=memSerialNumber, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapGenericNormal=trapGenericNormal, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sd5Table=sd5Table, postLogTable=postLogTable, raidPDOtherErrorCount=raidPDOtherErrorCount, diskEntry=diskEntry, osIndex=osIndex, raidAdapterGroup=raidAdapterGroup, cpuCoreCount=cpuCoreCount, sysBIOSManufacturer=sysBIOSManufacturer, trapBbpStatusCritical=trapBbpStatusCritical, trapCpuFaultCritical=trapCpuFaultCritical, sysBIOSVersion=sysBIOSVersion, memDeviceLocator=memDeviceLocator, ceccLogEntry=ceccLogEntry, raidVDAllinoneMsg=raidVDAllinoneMsg, memModel=memModel, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical)
