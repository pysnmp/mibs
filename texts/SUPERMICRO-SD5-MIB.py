...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", diskEntry=diskEntry, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuLogIndex=cpuLogIndex, ceccLogIndex=ceccLogIndex, sd5MIBVersion=sd5MIBVersion, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDPort0Status=raidPDPort0Status, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuLogEntry=cpuLogEntry, raidAdapterId_VD=raidAdapterId_VD, cpuDeviceVersion=cpuDeviceVersion, ceccLogTable=ceccLogTable, diskSlotID=diskSlotID, trapBbpStatusWarning=trapBbpStatusWarning, sd5Table=sd5Table, trapGenericNormal=trapGenericNormal, memErrorCount=memErrorCount, raidBBUIndex=raidBBUIndex, sysBIOSIndex=sysBIOSIndex, raidBBUEntry=raidBBUEntry, memDeviceLocator=memDeviceLocator, raidPDPort1Status=raidPDPort1Status, raidPDOpProgress=raidPDOpProgress, diskSmartStatus=diskSmartStatus, osName=osName, postLogIndex=postLogIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, ceccLogEntry=ceccLogEntry, trapVoltageCritical=trapVoltageCritical, smSuperDoctor5MIB=smSuperDoctor5MIB, memDataWidth=memDataWidth, trapCpuFaultCritical=trapCpuFaultCritical, raidAdapterSubDeviceId=raidAdapterSubDeviceId, ueccLogIndex=ueccLogIndex, cpuMaxSpeed=cpuMaxSpeed, raidPDInquiryData=raidPDInquiryData, raidVDIndex=raidVDIndex, raidPDPort0Linkspeed=raidPDPort0Linkspeed, sd5Entry=sd5Entry, cpuID=cpuID, raidPDPort1Linkspeed=raidPDPort1Linkspeed, mbAssetTag=mbAssetTag, smSD5TrapMIB=smSD5TrapMIB, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDOtherErrorCount=raidPDOtherErrorCount, trapMemoryUeccCritical=trapMemoryUeccCritical, raidPDLinkSpeed=raidPDLinkSpeed, memCapacity=memCapacity, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, cpuName=cpuName, trapChassisIntrusionCleared=trapChassisIntrusionCleared, osManufacturer=osManufacturer, cpuCoreCount=cpuCoreCount, ueccLogTable=ueccLogTable, cpuLoadingPercentage=cpuLoadingPercentage, diskVendor=diskVendor, raidVDTargetId=raidVDTargetId, memDeviceStatus=memDeviceStatus, ceccLogDatetime=ceccLogDatetime, cpuLogDatetime=cpuLogDatetime, ueccLogDatetime=ueccLogDatetime, raidAdapterFWVersion=raidAdapterFWVersion, cpuDeviceStatus=cpuDeviceStatus, memModel=memModel, raidPDWriteCache=raidPDWriteCache, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuThreadCount=cpuThreadCount, raidPDNCQSetting=raidPDNCQSetting, trapVoltageWarning=trapVoltageWarning, sysBIOSManufacturer=sysBIOSManufacturer, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, postLogTable=postLogTable, raidPDSlotNumber=raidPDSlotNumber, raidAdapterEntry=raidAdapterEntry, raidPDMediaType=raidPDMediaType, trapVoltageNormal=trapVoltageNormal, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDFirmwareState=raidPDFirmwareState, raidVDNumDrives=raidVDNumDrives, raidVDSpanDepth=raidVDSpanDepth, raidAdapterDeviceId=raidAdapterDeviceId, trapCpuFaultWarning=trapCpuFaultWarning, memDescription=memDescription, raidPDTable=raidPDTable, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuManufacturer=cpuManufacturer, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, cpuTable=cpuTable, cpuLogTable=cpuLogTable, cpuSocketDesignation=cpuSocketDesignation, raidAdapterId_BBU=raidAdapterId_BBU, diskName=diskName, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDStripSize=raidVDStripSize, cpuDeviceID=cpuDeviceID, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuIndex=cpuIndex, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuEntry=cpuEntry, raidDiskGroupId=raidDiskGroupId, raidVDId=raidVDId, raidVDAllinoneStatus=raidVDAllinoneStatus, raidBBUStatus=raidBBUStatus, memEntry=memEntry, mbIndex=mbIndex, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapTemperatureWarning=trapTemperatureWarning, cpuCurrentSpeed=cpuCurrentSpeed, memTotalWidth=memTotalWidth, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDCached=raidVDCached, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterId_PD=raidAdapterId_PD, raidVDRaidLevel=raidVDRaidLevel, trapPowerSupplyWarning=trapPowerSupplyWarning, raidBBUTable=raidBBUTable, postLogDatetime=postLogDatetime, raidPDFirmwareRevision=raidPDFirmwareRevision, sysBIOSEntry=sysBIOSEntry, memUECCErrorCount=memUECCErrorCount, postLogEntry=postLogEntry, sysBIOSReleaseDate=sysBIOSReleaseDate, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuDescription=cpuDescription, diskSize=diskSize, sysBIOSTable=sysBIOSTable, sysBIOSVersion=sysBIOSVersion, raidVDSize=raidVDSize, raidVDSupportT10Power=raidVDSupportT10Power, trapChassisIntrusion=trapChassisIntrusion, osSerialNumber=osSerialNumber, mbManufacturer=mbManufacturer, diskSerialNumber=diskSerialNumber, trapFanWarning=trapFanWarning, sd5Version=sd5Version, raidVDEncryptionType=raidVDEncryptionType, memECCErrorCount=memECCErrorCount, trapPowerSupplyNormal=trapPowerSupplyNormal, trapFanNormal=trapFanNormal, trapCpuFaultNormal=trapCpuFaultNormal, raidPDRawSize=raidPDRawSize, memPartNumber=memPartNumber, raidAdapterId=raidAdapterId, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, mbTable=mbTable, trapPowerSupplyCritical=trapPowerSupplyCritical, diskModel=diskModel, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapBbpStatusCritical=trapBbpStatusCritical, raidIsBBUAbsent=raidIsBBUAbsent, dmiLogTable=dmiLogTable, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDDeviceSpeed=raidPDDeviceSpeed, trapGenericCritical=trapGenericCritical, cpuCoreEnabled=cpuCoreEnabled, raidPDAllinoneMsg=raidPDAllinoneMsg, raidAdapterGroup_BBU=raidAdapterGroup_BBU, memSerialNumber=memSerialNumber, raidPDPredFailCount=raidPDPredFailCount, raidVDAllinoneMsg=raidVDAllinoneMsg, osTable=osTable, diskMediaType=diskMediaType, ueccLogEntry=ueccLogEntry, trapTemperatureNormal=trapTemperatureNormal, trapBatteryStatusWarning=trapBatteryStatusWarning, memTag=memTag, sd5Idx=sd5Idx, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDTable=raidVDTable, diskInterfaceType=diskInterfaceType, raidVDEntry=raidVDEntry, memLabeledBank=memLabeledBank, raidPDSerialNumber=raidPDSerialNumber, mbVersionName=mbVersionName, mbProductName=mbProductName, raidAdapterSerialNumber=raidAdapterSerialNumber, cpuLogInfo=cpuLogInfo, trapTemperatureCritical=trapTemperatureCritical, raidPDAllinoneStatus=raidPDAllinoneStatus, osCSDVersion=osCSDVersion, raidAdapterGroup=raidAdapterGroup, raidAdapterVendorId=raidAdapterVendorId, memManufacturer=memManufacturer, ceccLogInfo=ceccLogInfo, osIndex=osIndex, raidVDName=raidVDName, osVersion=osVersion, trapBbpStatusNormal=trapBbpStatusNormal, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, diskController=diskController, trapGenericWarning=trapGenericWarning, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidVDState=raidVDState, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, osEntry=osEntry, raidPDSpan=raidPDSpan, raidPDModel=raidPDModel, diskTable=diskTable, memTable=memTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidPDMediaErrorCount=raidPDMediaErrorCount, trapFanCritical=trapFanCritical, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDIndex=raidPDIndex, mbSerialNumber=mbSerialNumber, raidVDMirrorDataSize=raidVDMirrorDataSize, ueccLogInfo=ueccLogInfo, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDEntry=raidPDEntry, trapBatteryStatusCritical=trapBatteryStatusCritical, raidDiskGroupId_PD=raidDiskGroupId_PD, raidAdapterIndex=raidAdapterIndex, raidAdapterTable=raidAdapterTable, raidAdapterProductName=raidAdapterProductName, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, mbEntry=mbEntry, postLogInfo=postLogInfo)
