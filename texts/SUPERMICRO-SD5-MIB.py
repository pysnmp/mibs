...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", osIndex=osIndex, memDataWidth=memDataWidth, ceccLogIndex=ceccLogIndex, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDNCQSetting=raidPDNCQSetting, trapBbpStatusNormal=trapBbpStatusNormal, cpuLoadingPercentage=cpuLoadingPercentage, raidPDPredFailCount=raidPDPredFailCount, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapGenericWarning=trapGenericWarning, diskSlotID=diskSlotID, raidVDMirrorDataSize=raidVDMirrorDataSize, trapCpuFaultCritical=trapCpuFaultCritical, memCapacity=memCapacity, sysBIOSIndex=sysBIOSIndex, trapBbpStatusCritical=trapBbpStatusCritical, memDeviceLocator=memDeviceLocator, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapVoltageWarning=trapVoltageWarning, trapTemperatureWarning=trapTemperatureWarning, mbManufacturer=mbManufacturer, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidIsBBUAbsent=raidIsBBUAbsent, mbAssetTag=mbAssetTag, diskEntry=diskEntry, raidVDBadBlocksExist=raidVDBadBlocksExist, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapPowerSupplyCritical=trapPowerSupplyCritical, mbSerialNumber=mbSerialNumber, ueccLogInfo=ueccLogInfo, osVersion=osVersion, raidVDStripSize=raidVDStripSize, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapTemperatureNormal=trapTemperatureNormal, cpuLogTable=cpuLogTable, raidVDTargetId=raidVDTargetId, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDSerialNumber=raidPDSerialNumber, raidPDIndex=raidPDIndex, raidAdapterGroup=raidAdapterGroup, osCSDVersion=osCSDVersion, cpuDeviceStatus=cpuDeviceStatus, memErrorCount=memErrorCount, raidVDTable=raidVDTable, raidPDOtherErrorCount=raidPDOtherErrorCount, trapMemoryUeccWarning=trapMemoryUeccWarning, osName=osName, postLogIndex=postLogIndex, osManufacturer=osManufacturer, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, diskModel=diskModel, memSerialNumber=memSerialNumber, ceccLogDatetime=ceccLogDatetime, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDAllinoneStatus=raidPDAllinoneStatus, memEntry=memEntry, trapBbpStatusWarning=trapBbpStatusWarning, ceccLogEntry=ceccLogEntry, raidBBUTable=raidBBUTable, raidAdapterIndex=raidAdapterIndex, raidBBUStatus=raidBBUStatus, sd5Version=sd5Version, trapCpuFaultWarning=trapCpuFaultWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidVDNumDrives=raidVDNumDrives, osTable=osTable, cpuLogEntry=cpuLogEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, mbIndex=mbIndex, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapCpuFaultNormal=trapCpuFaultNormal, mbTable=mbTable, postLogInfo=postLogInfo, cpuSocketDesignation=cpuSocketDesignation, cpuCoreEnabled=cpuCoreEnabled, cpuID=cpuID, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapGenericCritical=trapGenericCritical, cpuIndex=cpuIndex, cpuCurrentSpeed=cpuCurrentSpeed, raidDiskGroupId_PD=raidDiskGroupId_PD, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuEntry=cpuEntry, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDInquiryData=raidPDInquiryData, cpuMaxSpeed=cpuMaxSpeed, trapChassisIntrusionCleared=trapChassisIntrusionCleared, memUECCErrorCount=memUECCErrorCount, raidDiskGroupId=raidDiskGroupId, cpuName=cpuName, sysBIOSVersion=sysBIOSVersion, diskMediaType=diskMediaType, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, sd5Idx=sd5Idx, postLogDatetime=postLogDatetime, trapFanWarning=trapFanWarning, ueccLogTable=ueccLogTable, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, sd5Table=sd5Table, smSuperDoctor5MIB=smSuperDoctor5MIB, raidAdapterId_PD=raidAdapterId_PD, sysBIOSReleaseDate=sysBIOSReleaseDate, raidVDRaidLevel=raidVDRaidLevel, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterId_BBU=raidAdapterId_BBU, dmiLogTable=dmiLogTable, raidPDPort1Status=raidPDPort1Status, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDIndex=raidVDIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDDeviceSpeed=raidPDDeviceSpeed, raidVDEncryptionType=raidVDEncryptionType, cpuDeviceVersion=cpuDeviceVersion, cpuCoreCount=cpuCoreCount, cpuLogDatetime=cpuLogDatetime, trapChassisIntrusion=trapChassisIntrusion, diskTable=diskTable, raidPDOpProgress=raidPDOpProgress, raidVDCached=raidVDCached, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, cpuDescription=cpuDescription, cpuThreadCount=cpuThreadCount, raidVDEntry=raidVDEntry, raidPDLinkSpeed=raidPDLinkSpeed, raidPDTable=raidPDTable, raidPDRawSize=raidPDRawSize, diskController=diskController, trapVoltageCritical=trapVoltageCritical, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, postLogTable=postLogTable, raidBBUIndex=raidBBUIndex, raidVDState=raidVDState, raidBBUAllinoneMsg=raidBBUAllinoneMsg, smSD5TrapMIB=smSD5TrapMIB, raidPDEntry=raidPDEntry, diskSmartStatus=diskSmartStatus, trapVoltageNormal=trapVoltageNormal, cpuDeviceID=cpuDeviceID, trapFanNormal=trapFanNormal, ceccLogTable=ceccLogTable, raidPDSpan=raidPDSpan, raidAdapterProductName=raidAdapterProductName, raidAdapterId_VD=raidAdapterId_VD, raidPDWriteCache=raidPDWriteCache, raidVDSpanDepth=raidVDSpanDepth, sysBIOSManufacturer=sysBIOSManufacturer, memTag=memTag, raidPDFirmwareState=raidPDFirmwareState, memModel=memModel, trapPowerSupplyNormal=trapPowerSupplyNormal, raidPDMediaType=raidPDMediaType, diskSize=diskSize, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, diskVendor=diskVendor, sd5MIBVersion=sd5MIBVersion, ceccLogInfo=ceccLogInfo, memManufacturer=memManufacturer, cpuLogInfo=cpuLogInfo, sysBIOSTable=sysBIOSTable, raidVDSupportT10Power=raidVDSupportT10Power, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, PYSNMP_MODULE_ID=smSuperDoctor5MIB, diskName=diskName, raidAdapterId=raidAdapterId, raidPDPort0Status=raidPDPort0Status, cpuManufacturer=cpuManufacturer, diskSerialNumber=diskSerialNumber, mbProductName=mbProductName, raidPDSlotNumber=raidPDSlotNumber, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, ueccLogIndex=ueccLogIndex, trapPowerSupplyWarning=trapPowerSupplyWarning, memDeviceStatus=memDeviceStatus, osEntry=osEntry, sysBIOSEntry=sysBIOSEntry, raidVDSupportsMaxPS=raidVDSupportsMaxPS, memTable=memTable, trapFanCritical=trapFanCritical, raidVDName=raidVDName, trapGenericNormal=trapGenericNormal, cpuLogIndex=cpuLogIndex, sd5Entry=sd5Entry, memPartNumber=memPartNumber, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDModel=raidPDModel, trapBatteryStatusWarning=trapBatteryStatusWarning, raidAdapterEntry=raidAdapterEntry, raidAdapterDeviceId=raidAdapterDeviceId, mbEntry=mbEntry, raidBBUEntry=raidBBUEntry, memTotalWidth=memTotalWidth, ueccLogDatetime=ueccLogDatetime, raidAdapterTable=raidAdapterTable, raidVDId=raidVDId, raidVDSize=raidVDSize, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, ueccLogEntry=ueccLogEntry, postLogEntry=postLogEntry, memLabeledBank=memLabeledBank, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuTable=cpuTable, memECCErrorCount=memECCErrorCount, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDAllinoneMsg=raidPDAllinoneMsg, raidAdapterSubVendorId=raidAdapterSubVendorId, trapTemperatureCritical=trapTemperatureCritical, memDescription=memDescription, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapMemoryCeccNormal=trapMemoryCeccNormal, trapMemoryCeccCritical=trapMemoryCeccCritical, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, osSerialNumber=osSerialNumber, diskInterfaceType=diskInterfaceType, raidAdapterVendorId=raidAdapterVendorId, mbVersionName=mbVersionName)
