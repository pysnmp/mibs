...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDFirmwareRevision=raidPDFirmwareRevision, osManufacturer=osManufacturer, memSerialNumber=memSerialNumber, diskModel=diskModel, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, smSD5TrapMIB=smSD5TrapMIB, memPartNumber=memPartNumber, postLogEntry=postLogEntry, memDataWidth=memDataWidth, trapBatteryStatusWarning=trapBatteryStatusWarning, cpuDeviceStatus=cpuDeviceStatus, trapTemperatureWarning=trapTemperatureWarning, sd5MIBVersion=sd5MIBVersion, trapGenericCritical=trapGenericCritical, cpuMaxSpeed=cpuMaxSpeed, cpuSocketDesignation=cpuSocketDesignation, sd5Table=sd5Table, ueccLogTable=ueccLogTable, raidVDSpanDepth=raidVDSpanDepth, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapCpuFaultWarning=trapCpuFaultWarning, cpuCoreCount=cpuCoreCount, osSerialNumber=osSerialNumber, raidVDTargetId=raidVDTargetId, trapFanNormal=trapFanNormal, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidPDTable=raidPDTable, diskSize=diskSize, trapChassisIntrusion=trapChassisIntrusion, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDIndex=raidVDIndex, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidAdapterDeviceId=raidAdapterDeviceId, diskInterfaceType=diskInterfaceType, trapBbpStatusNormal=trapBbpStatusNormal, memModel=memModel, trapPowerSupplyNormal=trapPowerSupplyNormal, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidBBUEntry=raidBBUEntry, raidPDSerialNumber=raidPDSerialNumber, raidBBUIndex=raidBBUIndex, trapFanWarning=trapFanWarning, raidBBUTable=raidBBUTable, cpuCoreEnabled=cpuCoreEnabled, PYSNMP_MODULE_ID=smSuperDoctor5MIB, sysBIOSTable=sysBIOSTable, ceccLogIndex=ceccLogIndex, postLogInfo=postLogInfo, trapPowerSupplyCritical=trapPowerSupplyCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, cpuLogTable=cpuLogTable, cpuDescription=cpuDescription, raidDiskGroupId=raidDiskGroupId, raidPDModel=raidPDModel, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDPort1Status=raidPDPort1Status, cpuDeviceID=cpuDeviceID, ueccLogInfo=ueccLogInfo, cpuLogDatetime=cpuLogDatetime, raidVDEntry=raidVDEntry, raidAdapterId_VD=raidAdapterId_VD, postLogDatetime=postLogDatetime, raidPDFirmwareState=raidPDFirmwareState, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapBbpStatusCritical=trapBbpStatusCritical, cpuManufacturer=cpuManufacturer, raidVDEncryptionType=raidVDEncryptionType, memManufacturer=memManufacturer, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapBatteryStatusNormal=trapBatteryStatusNormal, osEntry=osEntry, ceccLogEntry=ceccLogEntry, raidDiskGroupId_PD=raidDiskGroupId_PD, sysBIOSManufacturer=sysBIOSManufacturer, trapMemoryUeccNormal=trapMemoryUeccNormal, trapCpuFaultCritical=trapCpuFaultCritical, memECCErrorCount=memECCErrorCount, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDInquiryData=raidPDInquiryData, cpuLogInfo=cpuLogInfo, diskVendor=diskVendor, memTotalWidth=memTotalWidth, raidAdapterIndex=raidAdapterIndex, raidPDIndex=raidPDIndex, trapFanCritical=trapFanCritical, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapGenericNormal=trapGenericNormal, ueccLogIndex=ueccLogIndex, diskController=diskController, raidPDNCQSetting=raidPDNCQSetting, memTable=memTable, diskMediaType=diskMediaType, memCapacity=memCapacity, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapVoltageNormal=trapVoltageNormal, trapTemperatureNormal=trapTemperatureNormal, memEntry=memEntry, osVersion=osVersion, raidVDSize=raidVDSize, cpuThreadCount=cpuThreadCount, cpuID=cpuID, trapBbpStatusWarning=trapBbpStatusWarning, cpuDeviceVersion=cpuDeviceVersion, sysBIOSReleaseDate=sysBIOSReleaseDate, osIndex=osIndex, ueccLogDatetime=ueccLogDatetime, raidVDAllinoneStatus=raidVDAllinoneStatus, sysBIOSEntry=sysBIOSEntry, raidAdapterGroup=raidAdapterGroup, raidAdapterId_BBU=raidAdapterId_BBU, memErrorCount=memErrorCount, postLogTable=postLogTable, raidPDLinkSpeed=raidPDLinkSpeed, raidVDBadBlocksExist=raidVDBadBlocksExist, raidAdapterSubVendorId=raidAdapterSubVendorId, ceccLogInfo=ceccLogInfo, memTag=memTag, trapGenericWarning=trapGenericWarning, raidBBUAllinoneMsg=raidBBUAllinoneMsg, diskTable=diskTable, mbIndex=mbIndex, osName=osName, raidAdapterSubDeviceId=raidAdapterSubDeviceId, diskSlotID=diskSlotID, osCSDVersion=osCSDVersion, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, cpuLoadingPercentage=cpuLoadingPercentage, cpuCurrentSpeed=cpuCurrentSpeed, mbManufacturer=mbManufacturer, raidVDMirrorDataSize=raidVDMirrorDataSize, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDDeviceFwLevel=raidPDDeviceFwLevel, memUECCErrorCount=memUECCErrorCount, sd5Version=sd5Version, raidPDRawSize=raidPDRawSize, trapMemoryUeccCritical=trapMemoryUeccCritical, raidPDMediaErrorCount=raidPDMediaErrorCount, sd5Idx=sd5Idx, ceccLogDatetime=ceccLogDatetime, raidPDEntry=raidPDEntry, raidPDSpan=raidPDSpan, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterTable=raidAdapterTable, cpuEntry=cpuEntry, raidPDOpProgress=raidPDOpProgress, cpuIndex=cpuIndex, raidPDPort0Status=raidPDPort0Status, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDOtherErrorCount=raidPDOtherErrorCount, mbTable=mbTable, raidVDName=raidVDName, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, sd5Entry=sd5Entry, raidPDPredFailCount=raidPDPredFailCount, raidAdapterSerialNumber=raidAdapterSerialNumber, sysBIOSVersion=sysBIOSVersion, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidAdapterProductName=raidAdapterProductName, raidBBUStatus=raidBBUStatus, memDescription=memDescription, raidAdapterId=raidAdapterId, mbAssetTag=mbAssetTag, cpuLogIndex=cpuLogIndex, trapVoltageWarning=trapVoltageWarning, mbEntry=mbEntry, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapMemoryCeccCritical=trapMemoryCeccCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDMediaType=raidPDMediaType, raidPDAllinoneMsg=raidPDAllinoneMsg, trapMemoryUeccWarning=trapMemoryUeccWarning, raidVDId=raidVDId, raidVDState=raidVDState, raidVDSupportT10Power=raidVDSupportT10Power, memLabeledBank=memLabeledBank, raidVDSupportsMaxPS=raidVDSupportsMaxPS, diskName=diskName, mbSerialNumber=mbSerialNumber, cpuName=cpuName, raidVDRaidLevel=raidVDRaidLevel, raidAdapterBIOSVersion=raidAdapterBIOSVersion, postLogIndex=postLogIndex, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapCpuFaultNormal=trapCpuFaultNormal, diskEntry=diskEntry, diskSmartStatus=diskSmartStatus, raidBBUAllinoneStatus=raidBBUAllinoneStatus, cpuTable=cpuTable, raidPDSlotNumber=raidPDSlotNumber, trapVoltageCritical=trapVoltageCritical, osTable=osTable, raidVDCached=raidVDCached, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDTable=raidVDTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDNumDrives=raidVDNumDrives, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memDeviceStatus=memDeviceStatus, memDeviceLocator=memDeviceLocator, raidAdapterFWVersion=raidAdapterFWVersion, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, mbProductName=mbProductName, ueccLogEntry=ueccLogEntry, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, ceccLogTable=ceccLogTable, cpuLogEntry=cpuLogEntry, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterId_PD=raidAdapterId_PD, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskSerialNumber=diskSerialNumber, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDDeviceSpeed=raidPDDeviceSpeed, dmiLogTable=dmiLogTable, trapTemperatureCritical=trapTemperatureCritical, raidPDWriteCache=raidPDWriteCache, raidAdapterVendorId=raidAdapterVendorId, sysBIOSIndex=sysBIOSIndex, raidPDAllinoneStatus=raidPDAllinoneStatus, mbVersionName=mbVersionName, raidVDStripSize=raidVDStripSize, raidAdapterEntry=raidAdapterEntry, smSuperDoctor5MIB=smSuperDoctor5MIB)
