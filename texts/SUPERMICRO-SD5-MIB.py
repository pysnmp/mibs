...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDEntry=raidVDEntry, raidPDEntry=raidPDEntry, memDescription=memDescription, raidAdapterGroup=raidAdapterGroup, osManufacturer=osManufacturer, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDLinkSpeed=raidPDLinkSpeed, raidPDOpProgress=raidPDOpProgress, trapTemperatureNormal=trapTemperatureNormal, raidPDIndex=raidPDIndex, sd5MIBVersion=sd5MIBVersion, diskMediaType=diskMediaType, osSerialNumber=osSerialNumber, raidPDPort1Status=raidPDPort1Status, raidPDRawSize=raidPDRawSize, memSerialNumber=memSerialNumber, raidVDTable=raidVDTable, cpuCoreCount=cpuCoreCount, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, ueccLogTable=ueccLogTable, trapMemoryUeccWarning=trapMemoryUeccWarning, diskSmartStatus=diskSmartStatus, cpuLogDatetime=cpuLogDatetime, raidPDOtherErrorCount=raidPDOtherErrorCount, trapBatteryStatusNormal=trapBatteryStatusNormal, postLogIndex=postLogIndex, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapPowerSupplyNormal=trapPowerSupplyNormal, ceccLogTable=ceccLogTable, raidVDStripSize=raidVDStripSize, ueccLogEntry=ueccLogEntry, raidAdapterSubVendorId=raidAdapterSubVendorId, raidAdapterIndex=raidAdapterIndex, trapMemoryCeccWarning=trapMemoryCeccWarning, trapTemperatureWarning=trapTemperatureWarning, postLogInfo=postLogInfo, diskModel=diskModel, trapBatteryStatusWarning=trapBatteryStatusWarning, diskEntry=diskEntry, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapVoltageNormal=trapVoltageNormal, raidPDSlotNumber=raidPDSlotNumber, cpuCurrentSpeed=cpuCurrentSpeed, mbManufacturer=mbManufacturer, trapPowerSupplyCritical=trapPowerSupplyCritical, osEntry=osEntry, raidPDNCQSetting=raidPDNCQSetting, cpuLogInfo=cpuLogInfo, raidPDWriteCache=raidPDWriteCache, memECCErrorCount=memECCErrorCount, trapGenericWarning=trapGenericWarning, raidAdapterTable=raidAdapterTable, mbAssetTag=mbAssetTag, trapPowerSupplyWarning=trapPowerSupplyWarning, osIndex=osIndex, cpuLogIndex=cpuLogIndex, raidPDSerialNumber=raidPDSerialNumber, raidAdapterSerialNumber=raidAdapterSerialNumber, osVersion=osVersion, memErrorCount=memErrorCount, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDEncryptionType=raidVDEncryptionType, raidVDSupportT10Power=raidVDSupportT10Power, trapFanCritical=trapFanCritical, sysBIOSManufacturer=sysBIOSManufacturer, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memTable=memTable, postLogDatetime=postLogDatetime, raidPDFirmwareState=raidPDFirmwareState, memDataWidth=memDataWidth, raidVDDiskCachePolicy=raidVDDiskCachePolicy, ueccLogIndex=ueccLogIndex, raidPDPort0Status=raidPDPort0Status, trapFanWarning=trapFanWarning, cpuDescription=cpuDescription, sysBIOSIndex=sysBIOSIndex, raidVDBadBlocksExist=raidVDBadBlocksExist, sysBIOSVersion=sysBIOSVersion, raidAdapterVendorId=raidAdapterVendorId, postLogTable=postLogTable, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, cpuDeviceStatus=cpuDeviceStatus, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDSpan=raidPDSpan, raidVDIndex=raidVDIndex, raidPDPort1Linkspeed=raidPDPort1Linkspeed, osName=osName, trapBbpStatusCritical=trapBbpStatusCritical, memLabeledBank=memLabeledBank, raidAdapterSubDeviceId=raidAdapterSubDeviceId, diskTable=diskTable, raidAdapterProductName=raidAdapterProductName, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapCpuFaultWarning=trapCpuFaultWarning, diskSlotID=diskSlotID, sysBIOSReleaseDate=sysBIOSReleaseDate, trapMemoryUeccCritical=trapMemoryUeccCritical, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDSize=raidVDSize, trapCpuFaultNormal=trapCpuFaultNormal, sd5Version=sd5Version, trapChassisIntrusion=trapChassisIntrusion, mbIndex=mbIndex, diskName=diskName, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterDeviceId=raidAdapterDeviceId, ueccLogInfo=ueccLogInfo, raidBBUIndex=raidBBUIndex, raidVDCached=raidVDCached, postLogEntry=postLogEntry, trapTemperatureCritical=trapTemperatureCritical, raidAdapterId_VD=raidAdapterId_VD, memTag=memTag, mbTable=mbTable, memManufacturer=memManufacturer, diskVendor=diskVendor, smSD5TrapMIB=smSD5TrapMIB, cpuSocketDesignation=cpuSocketDesignation, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidAdapterId=raidAdapterId, ueccLogDatetime=ueccLogDatetime, raidVDNumDrives=raidVDNumDrives, sd5Idx=sd5Idx, cpuLoadingPercentage=cpuLoadingPercentage, memModel=memModel, sd5Entry=sd5Entry, memUECCErrorCount=memUECCErrorCount, raidAdapterFWVersion=raidAdapterFWVersion, memCapacity=memCapacity, raidPDModel=raidPDModel, trapFanNormal=trapFanNormal, smSuperDoctor5MIB=smSuperDoctor5MIB, trapGenericNormal=trapGenericNormal, raidVDSupportsMaxPS=raidVDSupportsMaxPS, diskController=diskController, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, memEntry=memEntry, mbVersionName=mbVersionName, trapGenericCritical=trapGenericCritical, raidVDTargetId=raidVDTargetId, trapVoltageWarning=trapVoltageWarning, raidIsBBUAbsent=raidIsBBUAbsent, osCSDVersion=osCSDVersion, cpuDeviceVersion=cpuDeviceVersion, diskSize=diskSize, mbEntry=mbEntry, sysBIOSTable=sysBIOSTable, raidBBUEntry=raidBBUEntry, trapBbpStatusWarning=trapBbpStatusWarning, ceccLogEntry=ceccLogEntry, diskSerialNumber=diskSerialNumber, diskInterfaceType=diskInterfaceType, ceccLogDatetime=ceccLogDatetime, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, memTotalWidth=memTotalWidth, trapBbpStatusNormal=trapBbpStatusNormal, raidVDAllinoneStatus=raidVDAllinoneStatus, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuLogEntry=cpuLogEntry, cpuIndex=cpuIndex, dmiLogTable=dmiLogTable, cpuThreadCount=cpuThreadCount, raidPDAllinoneStatus=raidPDAllinoneStatus, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterId_PD=raidAdapterId_PD, raidAdapterEntry=raidAdapterEntry, raidVDState=raidVDState, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDId=raidVDId, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuDeviceID=cpuDeviceID, mbProductName=mbProductName, trapVoltageCritical=trapVoltageCritical, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, memDeviceLocator=memDeviceLocator, cpuID=cpuID, trapCpuFaultCritical=trapCpuFaultCritical, raidPDMediaErrorCount=raidPDMediaErrorCount, osTable=osTable, sd5Table=sd5Table, raidPDTable=raidPDTable, raidBBUTable=raidBBUTable, raidAdapterGroup_PD=raidAdapterGroup_PD, raidBBUStatus=raidBBUStatus, cpuName=cpuName, ceccLogIndex=ceccLogIndex, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidPDInquiryData=raidPDInquiryData, sysBIOSEntry=sysBIOSEntry, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDSpanDepth=raidVDSpanDepth, cpuLogTable=cpuLogTable, cpuTable=cpuTable, cpuMaxSpeed=cpuMaxSpeed, memPartNumber=memPartNumber, raidVDName=raidVDName, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuCoreEnabled=cpuCoreEnabled, raidPDPredFailCount=raidPDPredFailCount, ceccLogInfo=ceccLogInfo, raidAdapterGroup_BBU=raidAdapterGroup_BBU, mbSerialNumber=mbSerialNumber, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDMediaType=raidPDMediaType, memDeviceStatus=memDeviceStatus, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidDiskGroupId=raidDiskGroupId, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidVDRaidLevel=raidVDRaidLevel, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuManufacturer=cpuManufacturer, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterId_BBU=raidAdapterId_BBU, cpuEntry=cpuEntry)
