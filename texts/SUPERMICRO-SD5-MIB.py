...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", ceccLogTable=ceccLogTable, osCSDVersion=osCSDVersion, raidPDTable=raidPDTable, sysBIOSReleaseDate=sysBIOSReleaseDate, sd5Entry=sd5Entry, ceccLogDatetime=ceccLogDatetime, raidBBUEntry=raidBBUEntry, trapPowerSupplyCritical=trapPowerSupplyCritical, trapGenericCritical=trapGenericCritical, raidVDSize=raidVDSize, diskMediaType=diskMediaType, cpuEntry=cpuEntry, postLogIndex=postLogIndex, trapFanNormal=trapFanNormal, trapFanCritical=trapFanCritical, memUECCErrorCount=memUECCErrorCount, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDModel=raidPDModel, diskName=diskName, raidPDPort1Status=raidPDPort1Status, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, ueccLogInfo=ueccLogInfo, cpuCoreEnabled=cpuCoreEnabled, memDescription=memDescription, raidPDNCQSetting=raidPDNCQSetting, mbAssetTag=mbAssetTag, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDAllinoneMsg=raidPDAllinoneMsg, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDIndex=raidVDIndex, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterFWVersion=raidAdapterFWVersion, diskVendor=diskVendor, osIndex=osIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, diskTable=diskTable, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDSpanDepth=raidVDSpanDepth, trapBatteryStatusCritical=trapBatteryStatusCritical, cpuMaxSpeed=cpuMaxSpeed, trapCpuFaultNormal=trapCpuFaultNormal, trapBbpStatusWarning=trapBbpStatusWarning, osName=osName, memDataWidth=memDataWidth, ceccLogInfo=ceccLogInfo, cpuCurrentSpeed=cpuCurrentSpeed, raidAdapterProductName=raidAdapterProductName, mbIndex=mbIndex, postLogEntry=postLogEntry, memEntry=memEntry, trapMemoryCeccWarning=trapMemoryCeccWarning, cpuID=cpuID, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapChassisIntrusion=trapChassisIntrusion, sd5Version=sd5Version, diskSize=diskSize, memLabeledBank=memLabeledBank, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDSpan=raidPDSpan, postLogInfo=postLogInfo, raidVDNumDrives=raidVDNumDrives, raidAdapterSerialNumber=raidAdapterSerialNumber, diskController=diskController, memSerialNumber=memSerialNumber, raidVDName=raidVDName, raidAdapterSubDeviceId=raidAdapterSubDeviceId, ueccLogIndex=ueccLogIndex, raidIsBBUAbsent=raidIsBBUAbsent, raidVDTargetId=raidVDTargetId, cpuLogIndex=cpuLogIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, memTotalWidth=memTotalWidth, cpuDescription=cpuDescription, raidBBUStatus=raidBBUStatus, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapMemoryUeccWarning=trapMemoryUeccWarning, raidDiskGroupId=raidDiskGroupId, raidAdapterId_VD=raidAdapterId_VD, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDTable=raidVDTable, sd5Table=sd5Table, sysBIOSVersion=sysBIOSVersion, raidPDOpProgress=raidPDOpProgress, trapMemoryCeccNormal=trapMemoryCeccNormal, memCapacity=memCapacity, raidPDIndex=raidPDIndex, raidBBUIndex=raidBBUIndex, ceccLogEntry=ceccLogEntry, cpuName=cpuName, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDAllinoneMsg=raidVDAllinoneMsg, trapBatteryStatusNormal=trapBatteryStatusNormal, postLogDatetime=postLogDatetime, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapFanWarning=trapFanWarning, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapBbpStatusCritical=trapBbpStatusCritical, trapVoltageCritical=trapVoltageCritical, trapVoltageNormal=trapVoltageNormal, memTag=memTag, raidPDWriteCache=raidPDWriteCache, cpuDeviceVersion=cpuDeviceVersion, osTable=osTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ueccLogEntry=ueccLogEntry, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, ceccLogIndex=ceccLogIndex, trapTemperatureWarning=trapTemperatureWarning, cpuDeviceStatus=cpuDeviceStatus, osEntry=osEntry, memErrorCount=memErrorCount, sysBIOSManufacturer=sysBIOSManufacturer, smSD5TrapMIB=smSD5TrapMIB, raidAdapterEntry=raidAdapterEntry, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidPDFirmwareState=raidPDFirmwareState, ueccLogTable=ueccLogTable, raidAdapterId_PD=raidAdapterId_PD, cpuIndex=cpuIndex, raidAdapterDeviceId=raidAdapterDeviceId, memDeviceLocator=memDeviceLocator, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuManufacturer=cpuManufacturer, memModel=memModel, cpuDeviceID=cpuDeviceID, cpuLogTable=cpuLogTable, raidAdapterId_BBU=raidAdapterId_BBU, raidVDSupportsMaxPS=raidVDSupportsMaxPS, cpuCoreCount=cpuCoreCount, cpuSocketDesignation=cpuSocketDesignation, raidPDFirmwareRevision=raidPDFirmwareRevision, diskSmartStatus=diskSmartStatus, diskInterfaceType=diskInterfaceType, raidAdapterVendorId=raidAdapterVendorId, raidAdapterId=raidAdapterId, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDMediaType=raidPDMediaType, postLogTable=postLogTable, raidVDStripSize=raidVDStripSize, osVersion=osVersion, raidVDSupportT10Power=raidVDSupportT10Power, diskSlotID=diskSlotID, trapTemperatureCritical=trapTemperatureCritical, trapMemoryUeccCritical=trapMemoryUeccCritical, memPartNumber=memPartNumber, raidPDDeviceSpeed=raidPDDeviceSpeed, memManufacturer=memManufacturer, trapMemoryCeccCritical=trapMemoryCeccCritical, raidBBUAllinoneMsg=raidBBUAllinoneMsg, mbEntry=mbEntry, cpuLogInfo=cpuLogInfo, raidAdapterTable=raidAdapterTable, trapGenericWarning=trapGenericWarning, osSerialNumber=osSerialNumber, memECCErrorCount=memECCErrorCount, cpuTable=cpuTable, cpuThreadCount=cpuThreadCount, diskModel=diskModel, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDInquiryData=raidPDInquiryData, raidVDEntry=raidVDEntry, trapPowerSupplyWarning=trapPowerSupplyWarning, raidPDSlotNumber=raidPDSlotNumber, diskEntry=diskEntry, osManufacturer=osManufacturer, raidAdapterGroup=raidAdapterGroup, raidVDEncryptionType=raidVDEncryptionType, trapTemperatureNormal=trapTemperatureNormal, sysBIOSEntry=sysBIOSEntry, mbSerialNumber=mbSerialNumber, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sysBIOSIndex=sysBIOSIndex, cpuLoadingPercentage=cpuLoadingPercentage, raidPDPredFailCount=raidPDPredFailCount, trapCpuFaultCritical=trapCpuFaultCritical, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDEntry=raidPDEntry, trapBbpStatusNormal=trapBbpStatusNormal, dmiLogTable=dmiLogTable, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidBBUTable=raidBBUTable, memDeviceStatus=memDeviceStatus, trapVoltageWarning=trapVoltageWarning, mbProductName=mbProductName, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, mbVersionName=mbVersionName, raidAdapterBIOSVersion=raidAdapterBIOSVersion, mbTable=mbTable, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDBadBlocksExist=raidVDBadBlocksExist, memTable=memTable, sd5MIBVersion=sd5MIBVersion, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDPort0Status=raidPDPort0Status, ueccLogDatetime=ueccLogDatetime, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapCpuFaultWarning=trapCpuFaultWarning, diskSerialNumber=diskSerialNumber, raidVDId=raidVDId, raidVDState=raidVDState, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDAllinoneStatus=raidPDAllinoneStatus, sysBIOSTable=sysBIOSTable, sd5Idx=sd5Idx, raidAdapterIndex=raidAdapterIndex, cpuLogEntry=cpuLogEntry, trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDRaidLevel=raidVDRaidLevel, trapGenericNormal=trapGenericNormal, mbManufacturer=mbManufacturer, raidPDRawSize=raidPDRawSize, raidPDSerialNumber=raidPDSerialNumber, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuLogDatetime=cpuLogDatetime, raidVDCached=raidVDCached)
