...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuName=cpuName, diskTable=diskTable, trapMemoryCeccNormal=trapMemoryCeccNormal, trapPowerSupplyNormal=trapPowerSupplyNormal, raidVDStripSize=raidVDStripSize, cpuSocketDesignation=cpuSocketDesignation, cpuID=cpuID, sysBIOSTable=sysBIOSTable, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDMediaType=raidPDMediaType, trapTemperatureCritical=trapTemperatureCritical, raidPDSerialNumber=raidPDSerialNumber, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDPort0Status=raidPDPort0Status, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDCached=raidVDCached, memDeviceLocator=memDeviceLocator, memErrorCount=memErrorCount, cpuMaxSpeed=cpuMaxSpeed, memDataWidth=memDataWidth, memUECCErrorCount=memUECCErrorCount, raidPDEntry=raidPDEntry, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, mbVersionName=mbVersionName, sd5Idx=sd5Idx, raidAdapterBIOSVersion=raidAdapterBIOSVersion, osVersion=osVersion, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterId_VD=raidAdapterId_VD, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, mbSerialNumber=mbSerialNumber, sd5MIBVersion=sd5MIBVersion, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuLogIndex=cpuLogIndex, trapChassisIntrusionCleared=trapChassisIntrusionCleared, diskName=diskName, osEntry=osEntry, raidVDTargetId=raidVDTargetId, trapFanWarning=trapFanWarning, osSerialNumber=osSerialNumber, trapPowerSupplyWarning=trapPowerSupplyWarning, cpuEntry=cpuEntry, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDBadBlocksExist=raidVDBadBlocksExist, osManufacturer=osManufacturer, mbTable=mbTable, trapCpuFaultCritical=trapCpuFaultCritical, diskSlotID=diskSlotID, cpuCoreCount=cpuCoreCount, cpuIndex=cpuIndex, raidAdapterId_PD=raidAdapterId_PD, raidAdapterProductName=raidAdapterProductName, ceccLogEntry=ceccLogEntry, trapVoltageNormal=trapVoltageNormal, raidAdapterId_BBU=raidAdapterId_BBU, ceccLogTable=ceccLogTable, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDAllinoneMsg=raidVDAllinoneMsg, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, ueccLogIndex=ueccLogIndex, raidPDFirmwareState=raidPDFirmwareState, raidVDSupportT10Power=raidVDSupportT10Power, cpuCoreEnabled=cpuCoreEnabled, memPartNumber=memPartNumber, raidAdapterVendorId=raidAdapterVendorId, memSerialNumber=memSerialNumber, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidAdapterSubDeviceId=raidAdapterSubDeviceId, cpuManufacturer=cpuManufacturer, postLogEntry=postLogEntry, trapGenericWarning=trapGenericWarning, PYSNMP_MODULE_ID=smSuperDoctor5MIB, cpuDeviceID=cpuDeviceID, raidBBUTable=raidBBUTable, diskController=diskController, cpuLoadingPercentage=cpuLoadingPercentage, cpuLogTable=cpuLogTable, raidAdapterTable=raidAdapterTable, raidPDPredFailCount=raidPDPredFailCount, smSD5TrapMIB=smSD5TrapMIB, sysBIOSManufacturer=sysBIOSManufacturer, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuLogEntry=cpuLogEntry, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapPowerSupplyCritical=trapPowerSupplyCritical, osName=osName, trapVoltageWarning=trapVoltageWarning, trapVoltageCritical=trapVoltageCritical, cpuDeviceVersion=cpuDeviceVersion, raidAdapterGroup=raidAdapterGroup, raidPDAllinoneMsg=raidPDAllinoneMsg, postLogInfo=postLogInfo, memCapacity=memCapacity, trapCpuFaultNormal=trapCpuFaultNormal, ceccLogDatetime=ceccLogDatetime, ueccLogEntry=ueccLogEntry, raidVDState=raidVDState, trapTemperatureNormal=trapTemperatureNormal, mbManufacturer=mbManufacturer, postLogIndex=postLogIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapBatteryStatusWarning=trapBatteryStatusWarning, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDAllinoneStatus=raidPDAllinoneStatus, ueccLogInfo=ueccLogInfo, raidAdapterId=raidAdapterId, raidBBUIndex=raidBBUIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, raidPDPort1Linkspeed=raidPDPort1Linkspeed, diskInterfaceType=diskInterfaceType, memTotalWidth=memTotalWidth, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDRawSize=raidPDRawSize, diskSerialNumber=diskSerialNumber, raidAdapterIndex=raidAdapterIndex, raidPDMediaErrorCount=raidPDMediaErrorCount, raidBBUAllinoneStatus=raidBBUAllinoneStatus, osCSDVersion=osCSDVersion, raidAdapterDeviceId=raidAdapterDeviceId, cpuLogInfo=cpuLogInfo, diskEntry=diskEntry, trapGenericNormal=trapGenericNormal, trapFanCritical=trapFanCritical, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, mbIndex=mbIndex, raidPDOpProgress=raidPDOpProgress, cpuDeviceStatus=cpuDeviceStatus, raidVDMirrorDataSize=raidVDMirrorDataSize, memManufacturer=memManufacturer, cpuCurrentSpeed=cpuCurrentSpeed, diskVendor=diskVendor, raidPDFirmwareRevision=raidPDFirmwareRevision, diskModel=diskModel, cpuTable=cpuTable, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, memTable=memTable, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDNumDrives=raidVDNumDrives, raidPDLinkSpeed=raidPDLinkSpeed, raidVDEntry=raidVDEntry, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, memDescription=memDescription, diskSize=diskSize, raidVDName=raidVDName, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapGenericCritical=trapGenericCritical, cpuDescription=cpuDescription, dmiLogTable=dmiLogTable, raidBBUEntry=raidBBUEntry, raidPDNCQSetting=raidPDNCQSetting, sd5Table=sd5Table, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, sysBIOSReleaseDate=sysBIOSReleaseDate, raidBBUStatus=raidBBUStatus, trapMemoryUeccWarning=trapMemoryUeccWarning, mbEntry=mbEntry, ueccLogTable=ueccLogTable, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidIsBBUAbsent=raidIsBBUAbsent, raidVDTable=raidVDTable, osTable=osTable, memDeviceStatus=memDeviceStatus, raidPDModel=raidPDModel, raidVDAllinoneStatus=raidVDAllinoneStatus, smSuperDoctor5MIB=smSuperDoctor5MIB, sysBIOSEntry=sysBIOSEntry, raidDiskGroupId=raidDiskGroupId, ueccLogDatetime=ueccLogDatetime, trapMemoryUeccNormal=trapMemoryUeccNormal, trapCpuFaultWarning=trapCpuFaultWarning, memTag=memTag, raidPDTable=raidPDTable, raidVDSpanDepth=raidVDSpanDepth, sysBIOSVersion=sysBIOSVersion, raidPDPort1Status=raidPDPort1Status, raidVDSize=raidVDSize, trapBbpStatusWarning=trapBbpStatusWarning, osIndex=osIndex, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapBbpStatusNormal=trapBbpStatusNormal, mbProductName=mbProductName, sd5Entry=sd5Entry, diskSmartStatus=diskSmartStatus, memEntry=memEntry, diskMediaType=diskMediaType, raidVDId=raidVDId, raidPDIndex=raidPDIndex, raidPDSlotNumber=raidPDSlotNumber, trapMemoryCeccWarning=trapMemoryCeccWarning, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memLabeledBank=memLabeledBank, sysBIOSIndex=sysBIOSIndex, mbAssetTag=mbAssetTag, ceccLogIndex=ceccLogIndex, cpuThreadCount=cpuThreadCount, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDIndex=raidVDIndex, raidVDRaidLevel=raidVDRaidLevel, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDInquiryData=raidPDInquiryData, sd5Version=sd5Version, cpuLogDatetime=cpuLogDatetime, memModel=memModel, trapFanNormal=trapFanNormal, raidAdapterGroup_VD=raidAdapterGroup_VD, ceccLogInfo=ceccLogInfo, raidAdapterSerialNumber=raidAdapterSerialNumber, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDEncryptionType=raidVDEncryptionType, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapBbpStatusCritical=trapBbpStatusCritical, raidPDSpan=raidPDSpan, memECCErrorCount=memECCErrorCount, postLogTable=postLogTable, trapTemperatureWarning=trapTemperatureWarning, postLogDatetime=postLogDatetime, raidAdapterEntry=raidAdapterEntry, raidPDWriteCache=raidPDWriteCache, trapChassisIntrusion=trapChassisIntrusion, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min)
