...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", diskInterfaceType=diskInterfaceType, diskMediaType=diskMediaType, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDIndex=raidVDIndex, raidPDEntry=raidPDEntry, trapFanWarning=trapFanWarning, raidVDState=raidVDState, memTag=memTag, mbAssetTag=mbAssetTag, raidBBUIndex=raidBBUIndex, mbTable=mbTable, diskController=diskController, diskEntry=diskEntry, raidAdapterVendorId=raidAdapterVendorId, memLabeledBank=memLabeledBank, raidAdapterSubDeviceId=raidAdapterSubDeviceId, memTotalWidth=memTotalWidth, diskSlotID=diskSlotID, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterGroup=raidAdapterGroup, cpuDeviceVersion=cpuDeviceVersion, cpuIndex=cpuIndex, ueccLogTable=ueccLogTable, raidPDMediaErrorCount=raidPDMediaErrorCount, mbIndex=mbIndex, raidAdapterGroup_PD=raidAdapterGroup_PD, osTable=osTable, smSD5TrapMIB=smSD5TrapMIB, trapBatteryStatusWarning=trapBatteryStatusWarning, sysBIOSEntry=sysBIOSEntry, trapVoltageCritical=trapVoltageCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDDiskCachePolicy=raidVDDiskCachePolicy, memErrorCount=memErrorCount, raidAdapterIndex=raidAdapterIndex, sysBIOSTable=sysBIOSTable, cpuSocketDesignation=cpuSocketDesignation, raidPDSlotNumber=raidPDSlotNumber, ceccLogInfo=ceccLogInfo, sd5Version=sd5Version, mbSerialNumber=mbSerialNumber, sd5MIBVersion=sd5MIBVersion, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, diskName=diskName, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapMemoryCeccCritical=trapMemoryCeccCritical, sd5Idx=sd5Idx, raidPDSpan=raidPDSpan, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDRaidLevel=raidVDRaidLevel, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterSerialNumber=raidAdapterSerialNumber, memSerialNumber=memSerialNumber, osIndex=osIndex, raidPDOtherErrorCount=raidPDOtherErrorCount, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, PYSNMP_MODULE_ID=smSuperDoctor5MIB, memDeviceLocator=memDeviceLocator, ueccLogDatetime=ueccLogDatetime, raidAdapterId_PD=raidAdapterId_PD, raidPDFirmwareState=raidPDFirmwareState, sysBIOSVersion=sysBIOSVersion, raidPDTable=raidPDTable, ueccLogEntry=ueccLogEntry, raidAdapterFWVersion=raidAdapterFWVersion, cpuThreadCount=cpuThreadCount, diskModel=diskModel, cpuLogInfo=cpuLogInfo, trapGenericCritical=trapGenericCritical, osSerialNumber=osSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, osName=osName, raidIsBBUAbsent=raidIsBBUAbsent, memEntry=memEntry, sysBIOSReleaseDate=sysBIOSReleaseDate, diskSmartStatus=diskSmartStatus, postLogDatetime=postLogDatetime, raidBBUStatus=raidBBUStatus, dmiLogTable=dmiLogTable, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDEncryptionType=raidVDEncryptionType, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidAdapterId=raidAdapterId, cpuMaxSpeed=cpuMaxSpeed, memUECCErrorCount=memUECCErrorCount, memECCErrorCount=memECCErrorCount, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterId_BBU=raidAdapterId_BBU, cpuName=cpuName, ueccLogIndex=ueccLogIndex, memPartNumber=memPartNumber, raidBBUTable=raidBBUTable, trapFanNormal=trapFanNormal, diskSize=diskSize, memTable=memTable, raidPDOpProgress=raidPDOpProgress, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, mbEntry=mbEntry, raidBBUAllinoneMsg=raidBBUAllinoneMsg, postLogIndex=postLogIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDSize=raidVDSize, osVersion=osVersion, trapCpuFaultWarning=trapCpuFaultWarning, cpuCoreCount=cpuCoreCount, trapVoltageNormal=trapVoltageNormal, cpuCurrentSpeed=cpuCurrentSpeed, raidPDModel=raidPDModel, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDBadBlocksExist=raidVDBadBlocksExist, cpuID=cpuID, memCapacity=memCapacity, trapChassisIntrusionCleared=trapChassisIntrusionCleared, postLogInfo=postLogInfo, ceccLogIndex=ceccLogIndex, raidPDSerialNumber=raidPDSerialNumber, raidVDTable=raidVDTable, raidVDAllinoneMsg=raidVDAllinoneMsg, raidAdapterProductName=raidAdapterProductName, cpuTable=cpuTable, raidVDCached=raidVDCached, raidPDIndex=raidPDIndex, memManufacturer=memManufacturer, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDSpanDepth=raidVDSpanDepth, trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDNumDrives=raidVDNumDrives, raidPDInquiryData=raidPDInquiryData, raidPDPort0Status=raidPDPort0Status, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidAdapterEntry=raidAdapterEntry, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidAdapterGroup_VD=raidAdapterGroup_VD, memDescription=memDescription, raidPDPredFailCount=raidPDPredFailCount, trapBbpStatusWarning=trapBbpStatusWarning, trapTemperatureNormal=trapTemperatureNormal, memDataWidth=memDataWidth, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterId_VD=raidAdapterId_VD, raidPDWriteCache=raidPDWriteCache, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, memDeviceStatus=memDeviceStatus, trapCpuFaultCritical=trapCpuFaultCritical, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuDeviceStatus=cpuDeviceStatus, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, mbVersionName=mbVersionName, raidVDMirrorDataSize=raidVDMirrorDataSize, sysBIOSIndex=sysBIOSIndex, memModel=memModel, postLogTable=postLogTable, trapGenericWarning=trapGenericWarning, raidPDAllinoneMsg=raidPDAllinoneMsg, trapCpuFaultNormal=trapCpuFaultNormal, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuLogIndex=cpuLogIndex, trapChassisIntrusion=trapChassisIntrusion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDId=raidVDId, diskSerialNumber=diskSerialNumber, sysBIOSManufacturer=sysBIOSManufacturer, raidBBUAllinoneStatus=raidBBUAllinoneStatus, mbProductName=mbProductName, raidVDStripSize=raidVDStripSize, trapBbpStatusCritical=trapBbpStatusCritical, ceccLogEntry=ceccLogEntry, cpuManufacturer=cpuManufacturer, postLogEntry=postLogEntry, cpuLogTable=cpuLogTable, raidPDAllinoneStatus=raidPDAllinoneStatus, raidDiskGroupId_PD=raidDiskGroupId_PD, trapTemperatureCritical=trapTemperatureCritical, ceccLogTable=ceccLogTable, trapMemoryUeccCritical=trapMemoryUeccCritical, diskTable=diskTable, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidDiskGroupId=raidDiskGroupId, cpuEntry=cpuEntry, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidVDTargetId=raidVDTargetId, raidVDEntry=raidVDEntry, trapFanCritical=trapFanCritical, ceccLogDatetime=ceccLogDatetime, cpuDeviceID=cpuDeviceID, cpuCoreEnabled=cpuCoreEnabled, raidVDSupportT10Power=raidVDSupportT10Power, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterTable=raidAdapterTable, trapBbpStatusNormal=trapBbpStatusNormal, raidVDAllinoneStatus=raidVDAllinoneStatus, trapGenericNormal=trapGenericNormal, raidPDNCQSetting=raidPDNCQSetting, trapVoltageWarning=trapVoltageWarning, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidAdapterSubVendorId=raidAdapterSubVendorId, trapTemperatureWarning=trapTemperatureWarning, mbManufacturer=mbManufacturer, raidBBUEntry=raidBBUEntry, sd5Entry=sd5Entry, osCSDVersion=osCSDVersion, ueccLogInfo=ueccLogInfo, raidPDRawSize=raidPDRawSize, raidPDMediaType=raidPDMediaType, trapMemoryUeccWarning=trapMemoryUeccWarning, sd5Table=sd5Table, diskVendor=diskVendor, raidPDFirmwareRevision=raidPDFirmwareRevision, osEntry=osEntry, raidPDDeviceSpeed=raidPDDeviceSpeed, trapBatteryStatusCritical=trapBatteryStatusCritical, cpuLoadingPercentage=cpuLoadingPercentage, osManufacturer=osManufacturer, raidVDName=raidVDName, raidPDPort1Status=raidPDPort1Status, cpuLogEntry=cpuLogEntry, cpuDescription=cpuDescription, cpuLogDatetime=cpuLogDatetime)
