...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memDeviceLocator=memDeviceLocator, ceccLogInfo=ceccLogInfo, trapBatteryStatusNormal=trapBatteryStatusNormal, diskModel=diskModel, raidVDSize=raidVDSize, cpuMaxSpeed=cpuMaxSpeed, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapCpuFaultWarning=trapCpuFaultWarning, cpuID=cpuID, raidPDInquiryData=raidPDInquiryData, raidPDIndex=raidPDIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDSpan=raidPDSpan, sd5Version=sd5Version, sysBIOSReleaseDate=sysBIOSReleaseDate, trapPowerSupplyCritical=trapPowerSupplyCritical, trapPowerSupplyNormal=trapPowerSupplyNormal, sysBIOSEntry=sysBIOSEntry, memErrorCount=memErrorCount, mbEntry=mbEntry, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuCoreEnabled=cpuCoreEnabled, raidPDEntry=raidPDEntry, raidPDMediaErrorCount=raidPDMediaErrorCount, trapFanNormal=trapFanNormal, ueccLogEntry=ueccLogEntry, raidPDTable=raidPDTable, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, cpuDescription=cpuDescription, trapChassisIntrusion=trapChassisIntrusion, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, ueccLogDatetime=ueccLogDatetime, smSuperDoctor5MIB=smSuperDoctor5MIB, mbProductName=mbProductName, raidPDAllinoneStatus=raidPDAllinoneStatus, trapBatteryStatusWarning=trapBatteryStatusWarning, raidPDRawSize=raidPDRawSize, trapBbpStatusNormal=trapBbpStatusNormal, cpuLogDatetime=cpuLogDatetime, cpuCoreCount=cpuCoreCount, memTag=memTag, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, mbTable=mbTable, ceccLogIndex=ceccLogIndex, raidAdapterEntry=raidAdapterEntry, raidPDFirmwareState=raidPDFirmwareState, raidVDSupportT10Power=raidVDSupportT10Power, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidPDNCQSetting=raidPDNCQSetting, memSerialNumber=memSerialNumber, mbVersionName=mbVersionName, smSD5TrapMIB=smSD5TrapMIB, cpuManufacturer=cpuManufacturer, cpuDeviceStatus=cpuDeviceStatus, raidAdapterSerialNumber=raidAdapterSerialNumber, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapVoltageWarning=trapVoltageWarning, trapTemperatureWarning=trapTemperatureWarning, cpuLogInfo=cpuLogInfo, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterDeviceId=raidAdapterDeviceId, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterIndex=raidAdapterIndex, raidVDTargetId=raidVDTargetId, postLogEntry=postLogEntry, sd5Table=sd5Table, raidAdapterId_VD=raidAdapterId_VD, sd5Idx=sd5Idx, raidBBUTable=raidBBUTable, sysBIOSManufacturer=sysBIOSManufacturer, raidVDMirrorDataSize=raidVDMirrorDataSize, trapTemperatureNormal=trapTemperatureNormal, cpuLoadingPercentage=cpuLoadingPercentage, raidVDSpanDepth=raidVDSpanDepth, cpuIndex=cpuIndex, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDPort1Status=raidPDPort1Status, cpuName=cpuName, raidPDSerialNumber=raidPDSerialNumber, memTable=memTable, postLogInfo=postLogInfo, ueccLogTable=ueccLogTable, cpuCurrentSpeed=cpuCurrentSpeed, cpuTable=cpuTable, raidBBUEntry=raidBBUEntry, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDNumDrives=raidVDNumDrives, raidPDSlotNumber=raidPDSlotNumber, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDAllinoneMsg=raidPDAllinoneMsg, trapMemoryUeccCritical=trapMemoryUeccCritical, memDeviceStatus=memDeviceStatus, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterGroup=raidAdapterGroup, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDEncryptionType=raidVDEncryptionType, raidAdapterId=raidAdapterId, trapMemoryCeccCritical=trapMemoryCeccCritical, postLogIndex=postLogIndex, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuLogEntry=cpuLogEntry, osName=osName, memDataWidth=memDataWidth, raidAdapterVendorId=raidAdapterVendorId, raidPDPredFailCount=raidPDPredFailCount, raidVDIndex=raidVDIndex, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidVDEntry=raidVDEntry, cpuDeviceID=cpuDeviceID, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidAdapterTable=raidAdapterTable, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, diskInterfaceType=diskInterfaceType, cpuLogTable=cpuLogTable, raidPDWriteCache=raidPDWriteCache, raidVDId=raidVDId, raidAdapterFWVersion=raidAdapterFWVersion, raidVDCached=raidVDCached, diskMediaType=diskMediaType, raidVDTable=raidVDTable, memEntry=memEntry, diskSlotID=diskSlotID, mbIndex=mbIndex, ueccLogIndex=ueccLogIndex, raidVDName=raidVDName, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidAdapterId_PD=raidAdapterId_PD, diskSerialNumber=diskSerialNumber, diskVendor=diskVendor, cpuLogIndex=cpuLogIndex, raidPDDeviceFwLevel=raidPDDeviceFwLevel, ceccLogEntry=ceccLogEntry, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, diskController=diskController, trapPowerSupplyWarning=trapPowerSupplyWarning, memECCErrorCount=memECCErrorCount, raidAdapterId_BBU=raidAdapterId_BBU, sysBIOSVersion=sysBIOSVersion, trapGenericNormal=trapGenericNormal, osVersion=osVersion, sd5MIBVersion=sd5MIBVersion, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDBadBlocksExist=raidVDBadBlocksExist, dmiLogTable=dmiLogTable, sd5Entry=sd5Entry, raidPDLinkSpeed=raidPDLinkSpeed, raidDiskGroupId_PD=raidDiskGroupId_PD, raidIsBBUAbsent=raidIsBBUAbsent, diskSize=diskSize, raidPDPort0Status=raidPDPort0Status, osTable=osTable, ueccLogInfo=ueccLogInfo, diskName=diskName, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDDeviceSpeed=raidPDDeviceSpeed, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDOtherErrorCount=raidPDOtherErrorCount, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, postLogDatetime=postLogDatetime, trapFanCritical=trapFanCritical, trapVoltageNormal=trapVoltageNormal, cpuDeviceVersion=cpuDeviceVersion, osManufacturer=osManufacturer, trapFanWarning=trapFanWarning, trapGenericCritical=trapGenericCritical, mbAssetTag=mbAssetTag, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, diskTable=diskTable, trapCpuFaultCritical=trapCpuFaultCritical, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDModel=raidPDModel, PYSNMP_MODULE_ID=smSuperDoctor5MIB, memTotalWidth=memTotalWidth, memLabeledBank=memLabeledBank, raidBBUStatus=raidBBUStatus, memCapacity=memCapacity, osCSDVersion=osCSDVersion, ceccLogDatetime=ceccLogDatetime, raidPDMediaType=raidPDMediaType, memDescription=memDescription, raidVDRaidLevel=raidVDRaidLevel, trapGenericWarning=trapGenericWarning, postLogTable=postLogTable, trapBbpStatusCritical=trapBbpStatusCritical, memUECCErrorCount=memUECCErrorCount, raidDiskGroupId=raidDiskGroupId, raidPDOpProgress=raidPDOpProgress, trapVoltageCritical=trapVoltageCritical, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sysBIOSIndex=sysBIOSIndex, ceccLogTable=ceccLogTable, mbManufacturer=mbManufacturer, osEntry=osEntry, osSerialNumber=osSerialNumber, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidBBUIndex=raidBBUIndex, cpuThreadCount=cpuThreadCount, memPartNumber=memPartNumber, cpuEntry=cpuEntry, sysBIOSTable=sysBIOSTable, diskEntry=diskEntry, raidAdapterProductName=raidAdapterProductName, trapBbpStatusWarning=trapBbpStatusWarning, trapTemperatureCritical=trapTemperatureCritical, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuSocketDesignation=cpuSocketDesignation, raidVDState=raidVDState, memModel=memModel, mbSerialNumber=mbSerialNumber, diskSmartStatus=diskSmartStatus, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, osIndex=osIndex, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDStripSize=raidVDStripSize, memManufacturer=memManufacturer, trapCpuFaultNormal=trapCpuFaultNormal, trapMemoryCeccWarning=trapMemoryCeccWarning)
