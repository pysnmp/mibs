...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memCapacity=memCapacity, trapChassisIntrusion=trapChassisIntrusion, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDModel=raidPDModel, ceccLogEntry=ceccLogEntry, smSuperDoctor5MIB=smSuperDoctor5MIB, trapVoltageNormal=trapVoltageNormal, mbIndex=mbIndex, cpuDeviceVersion=cpuDeviceVersion, sd5Entry=sd5Entry, diskSlotID=diskSlotID, trapPowerSupplyCritical=trapPowerSupplyCritical, sysBIOSEntry=sysBIOSEntry, raidAdapterDeviceId=raidAdapterDeviceId, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidVDName=raidVDName, postLogTable=postLogTable, raidVDEncryptionType=raidVDEncryptionType, diskVendor=diskVendor, mbManufacturer=mbManufacturer, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, memDataWidth=memDataWidth, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDId=raidVDId, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDRawSize=raidPDRawSize, memTable=memTable, trapPowerSupplyNormal=trapPowerSupplyNormal, diskEntry=diskEntry, diskInterfaceType=diskInterfaceType, mbAssetTag=mbAssetTag, mbSerialNumber=mbSerialNumber, cpuLogInfo=cpuLogInfo, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterId_VD=raidAdapterId_VD, trapGenericNormal=trapGenericNormal, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, memTotalWidth=memTotalWidth, raidAdapterIndex=raidAdapterIndex, raidPDTable=raidPDTable, trapBatteryStatusWarning=trapBatteryStatusWarning, cpuLoadingPercentage=cpuLoadingPercentage, raidVDBadBlocksExist=raidVDBadBlocksExist, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDOpProgress=raidPDOpProgress, cpuCoreCount=cpuCoreCount, raidVDEntry=raidVDEntry, memErrorCount=memErrorCount, cpuDescription=cpuDescription, sysBIOSReleaseDate=sysBIOSReleaseDate, memEntry=memEntry, diskMediaType=diskMediaType, ueccLogInfo=ueccLogInfo, trapBbpStatusCritical=trapBbpStatusCritical, trapBatteryStatusNormal=trapBatteryStatusNormal, memDescription=memDescription, memECCErrorCount=memECCErrorCount, osName=osName, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDDeviceSpeed=raidPDDeviceSpeed, memSerialNumber=memSerialNumber, sd5Table=sd5Table, cpuDeviceStatus=cpuDeviceStatus, raidPDIndex=raidPDIndex, smSD5TrapMIB=smSD5TrapMIB, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidDiskGroupId_PD=raidDiskGroupId_PD, raidPDSpan=raidPDSpan, diskController=diskController, raidVDSpanDepth=raidVDSpanDepth, ceccLogInfo=ceccLogInfo, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapTemperatureWarning=trapTemperatureWarning, diskTable=diskTable, raidVDCached=raidVDCached, raidAdapterId_PD=raidAdapterId_PD, trapPowerSupplyWarning=trapPowerSupplyWarning, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuDeviceID=cpuDeviceID, raidPDLinkSpeed=raidPDLinkSpeed, sysBIOSManufacturer=sysBIOSManufacturer, raidAdapterTable=raidAdapterTable, raidVDTargetId=raidVDTargetId, raidPDMediaErrorCount=raidPDMediaErrorCount, trapBatteryStatusCritical=trapBatteryStatusCritical, diskSize=diskSize, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, postLogIndex=postLogIndex, trapCpuFaultCritical=trapCpuFaultCritical, ceccLogIndex=ceccLogIndex, osSerialNumber=osSerialNumber, diskModel=diskModel, raidDiskGroupId=raidDiskGroupId, cpuEntry=cpuEntry, memModel=memModel, cpuLogTable=cpuLogTable, raidBBUTable=raidBBUTable, trapCpuFaultWarning=trapCpuFaultWarning, mbEntry=mbEntry, raidVDSize=raidVDSize, raidVDDiskCachePolicy=raidVDDiskCachePolicy, ueccLogTable=ueccLogTable, raidVDTable=raidVDTable, osCSDVersion=osCSDVersion, cpuLogEntry=cpuLogEntry, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDMediaType=raidPDMediaType, cpuID=cpuID, raidPDNCQSetting=raidPDNCQSetting, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDSlotNumber=raidPDSlotNumber, diskSerialNumber=diskSerialNumber, osVersion=osVersion, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapGenericCritical=trapGenericCritical, raidVDNumDrives=raidVDNumDrives, trapBbpStatusNormal=trapBbpStatusNormal, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDPort1Linkspeed=raidPDPort1Linkspeed, mbVersionName=mbVersionName, osManufacturer=osManufacturer, memDeviceStatus=memDeviceStatus, raidVDIndex=raidVDIndex, memTag=memTag, raidAdapterProductName=raidAdapterProductName, cpuTable=cpuTable, memPartNumber=memPartNumber, sysBIOSVersion=sysBIOSVersion, ceccLogTable=ceccLogTable, trapFanCritical=trapFanCritical, cpuManufacturer=cpuManufacturer, trapVoltageCritical=trapVoltageCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDPort0Status=raidPDPort0Status, raidAdapterGroup_VD=raidAdapterGroup_VD, cpuMaxSpeed=cpuMaxSpeed, raidVDState=raidVDState, dmiLogTable=dmiLogTable, sysBIOSTable=sysBIOSTable, raidPDOtherErrorCount=raidPDOtherErrorCount, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidBBUStatus=raidBBUStatus, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuLogDatetime=cpuLogDatetime, trapBbpStatusWarning=trapBbpStatusWarning, postLogDatetime=postLogDatetime, cpuThreadCount=cpuThreadCount, raidAdapterFWVersion=raidAdapterFWVersion, trapCpuFaultNormal=trapCpuFaultNormal, memLabeledBank=memLabeledBank, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, sd5MIBVersion=sd5MIBVersion, raidPDPredFailCount=raidPDPredFailCount, postLogEntry=postLogEntry, raidPDAllinoneStatus=raidPDAllinoneStatus, trapMemoryUeccNormal=trapMemoryUeccNormal, ceccLogDatetime=ceccLogDatetime, raidVDSupportT10Power=raidVDSupportT10Power, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterId=raidAdapterId, raidPDSerialNumber=raidPDSerialNumber, cpuSocketDesignation=cpuSocketDesignation, raidPDInquiryData=raidPDInquiryData, trapMemoryUeccWarning=trapMemoryUeccWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sd5Version=sd5Version, trapFanWarning=trapFanWarning, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuName=cpuName, cpuLogIndex=cpuLogIndex, raidBBUIndex=raidBBUIndex, postLogInfo=postLogInfo, mbProductName=mbProductName, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidVDStripSize=raidVDStripSize, raidAdapterBIOSVersion=raidAdapterBIOSVersion, osEntry=osEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDPort1Status=raidPDPort1Status, memUECCErrorCount=memUECCErrorCount, cpuIndex=cpuIndex, sd5Idx=sd5Idx, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, diskName=diskName, raidAdapterVendorId=raidAdapterVendorId, osTable=osTable, raidPDEntry=raidPDEntry, ueccLogEntry=ueccLogEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidVDRaidLevel=raidVDRaidLevel, trapTemperatureNormal=trapTemperatureNormal, trapTemperatureCritical=trapTemperatureCritical, raidAdapterEntry=raidAdapterEntry, raidPDPort0Linkspeed=raidPDPort0Linkspeed, cpuCoreEnabled=cpuCoreEnabled, ueccLogIndex=ueccLogIndex, trapFanNormal=trapFanNormal, diskSmartStatus=diskSmartStatus, osIndex=osIndex, raidAdapterGroup=raidAdapterGroup, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, cpuCurrentSpeed=cpuCurrentSpeed, raidPDFirmwareRevision=raidPDFirmwareRevision, trapChassisIntrusionCleared=trapChassisIntrusionCleared, memManufacturer=memManufacturer, memDeviceLocator=memDeviceLocator, sysBIOSIndex=sysBIOSIndex, raidPDFirmwareState=raidPDFirmwareState, raidVDAllinoneStatus=raidVDAllinoneStatus, trapVoltageWarning=trapVoltageWarning, raidAdapterId_BBU=raidAdapterId_BBU, trapGenericWarning=trapGenericWarning, ueccLogDatetime=ueccLogDatetime, mbTable=mbTable, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDWriteCache=raidPDWriteCache, raidBBUEntry=raidBBUEntry)
