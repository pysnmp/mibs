...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapCpuFaultCritical=trapCpuFaultCritical, raidPDOpProgress=raidPDOpProgress, raidAdapterIndex=raidAdapterIndex, raidVDCached=raidVDCached, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, memModel=memModel, trapBatteryStatusNormal=trapBatteryStatusNormal, cpuDeviceStatus=cpuDeviceStatus, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapPowerSupplyCritical=trapPowerSupplyCritical, cpuManufacturer=cpuManufacturer, cpuName=cpuName, trapBbpStatusCritical=trapBbpStatusCritical, raidAdapterId=raidAdapterId, cpuSocketDesignation=cpuSocketDesignation, raidAdapterGroup_VD=raidAdapterGroup_VD, diskSize=diskSize, osCSDVersion=osCSDVersion, cpuLogTable=cpuLogTable, raidPDAllinoneMsg=raidPDAllinoneMsg, cpuThreadCount=cpuThreadCount, raidVDEntry=raidVDEntry, trapCpuFaultWarning=trapCpuFaultWarning, memUECCErrorCount=memUECCErrorCount, mbEntry=mbEntry, raidAdapterBIOSVersion=raidAdapterBIOSVersion, memErrorCount=memErrorCount, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDDeviceFwLevel=raidPDDeviceFwLevel, diskName=diskName, raidVDEncryptionType=raidVDEncryptionType, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuDeviceID=cpuDeviceID, raidVDSize=raidVDSize, raidPDTable=raidPDTable, raidAdapterSubVendorId=raidAdapterSubVendorId, osSerialNumber=osSerialNumber, memTable=memTable, diskEntry=diskEntry, ceccLogInfo=ceccLogInfo, trapBbpStatusWarning=trapBbpStatusWarning, memPartNumber=memPartNumber, smSuperDoctor5MIB=smSuperDoctor5MIB, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapTemperatureNormal=trapTemperatureNormal, memTotalWidth=memTotalWidth, raidBBUAllinoneMsg=raidBBUAllinoneMsg, sysBIOSReleaseDate=sysBIOSReleaseDate, sd5Table=sd5Table, trapGenericNormal=trapGenericNormal, cpuLoadingPercentage=cpuLoadingPercentage, raidPDDeviceSpeed=raidPDDeviceSpeed, raidBBUIndex=raidBBUIndex, cpuCoreCount=cpuCoreCount, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapTemperatureCritical=trapTemperatureCritical, raidVDDiskCachePolicy=raidVDDiskCachePolicy, sysBIOSEntry=sysBIOSEntry, trapCpuFaultNormal=trapCpuFaultNormal, cpuLogEntry=cpuLogEntry, raidPDLinkSpeed=raidPDLinkSpeed, sd5Entry=sd5Entry, raidAdapterFWVersion=raidAdapterFWVersion, cpuID=cpuID, raidAdapterGroup=raidAdapterGroup, sysBIOSVersion=sysBIOSVersion, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidAdapterDeviceId=raidAdapterDeviceId, memLabeledBank=memLabeledBank, raidVDTargetId=raidVDTargetId, raidAdapterId_PD=raidAdapterId_PD, raidPDSerialNumber=raidPDSerialNumber, trapTemperatureWarning=trapTemperatureWarning, memTag=memTag, diskSmartStatus=diskSmartStatus, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDPort0Linkspeed=raidPDPort0Linkspeed, mbVersionName=mbVersionName, raidPDPredFailCount=raidPDPredFailCount, raidPDPort0Status=raidPDPort0Status, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, postLogTable=postLogTable, trapMemoryCeccCritical=trapMemoryCeccCritical, memDeviceLocator=memDeviceLocator, memManufacturer=memManufacturer, diskMediaType=diskMediaType, mbTable=mbTable, trapVoltageWarning=trapVoltageWarning, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, ceccLogIndex=ceccLogIndex, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidAdapterGroup_BBU=raidAdapterGroup_BBU, osIndex=osIndex, raidVDRaidLevel=raidVDRaidLevel, raidBBUStatus=raidBBUStatus, raidVDIndex=raidVDIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, memEntry=memEntry, memSerialNumber=memSerialNumber, trapChassisIntrusion=trapChassisIntrusion, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterTable=raidAdapterTable, raidIsBBUAbsent=raidIsBBUAbsent, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, diskModel=diskModel, trapPowerSupplyWarning=trapPowerSupplyWarning, cpuCurrentSpeed=cpuCurrentSpeed, raidPDModel=raidPDModel, PYSNMP_MODULE_ID=smSuperDoctor5MIB, cpuEntry=cpuEntry, mbIndex=mbIndex, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, osTable=osTable, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDFirmwareRevision=raidPDFirmwareRevision, postLogDatetime=postLogDatetime, sysBIOSManufacturer=sysBIOSManufacturer, ueccLogTable=ueccLogTable, trapFanCritical=trapFanCritical, raidAdapterGroup_PD=raidAdapterGroup_PD, ceccLogEntry=ceccLogEntry, cpuMaxSpeed=cpuMaxSpeed, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, memCapacity=memCapacity, raidVDStripSize=raidVDStripSize, raidPDOtherErrorCount=raidPDOtherErrorCount, sd5Idx=sd5Idx, raidVDNumDrives=raidVDNumDrives, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, mbAssetTag=mbAssetTag, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ueccLogDatetime=ueccLogDatetime, raidAdapterVendorId=raidAdapterVendorId, cpuTable=cpuTable, raidVDSpanDepth=raidVDSpanDepth, memDataWidth=memDataWidth, raidAdapterSerialNumber=raidAdapterSerialNumber, smSD5TrapMIB=smSD5TrapMIB, raidVDSupportT10Power=raidVDSupportT10Power, trapVoltageCritical=trapVoltageCritical, raidVDState=raidVDState, trapFanWarning=trapFanWarning, trapBbpStatusNormal=trapBbpStatusNormal, sysBIOSTable=sysBIOSTable, trapMemoryCeccNormal=trapMemoryCeccNormal, trapVoltageNormal=trapVoltageNormal, raidVDId=raidVDId, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuCoreEnabled=cpuCoreEnabled, diskSerialNumber=diskSerialNumber, raidVDName=raidVDName, ueccLogInfo=ueccLogInfo, raidPDIndex=raidPDIndex, raidPDMediaType=raidPDMediaType, raidAdapterId_VD=raidAdapterId_VD, postLogInfo=postLogInfo, diskVendor=diskVendor, cpuIndex=cpuIndex, raidPDNCQSetting=raidPDNCQSetting, trapPowerSupplyNormal=trapPowerSupplyNormal, diskInterfaceType=diskInterfaceType, trapMemoryUeccWarning=trapMemoryUeccWarning, raidBBUAllinoneStatus=raidBBUAllinoneStatus, osManufacturer=osManufacturer, raidAdapterEntry=raidAdapterEntry, ueccLogEntry=ueccLogEntry, mbManufacturer=mbManufacturer, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, cpuLogDatetime=cpuLogDatetime, raidPDWriteCache=raidPDWriteCache, trapMemoryUeccCritical=trapMemoryUeccCritical, trapBatteryStatusWarning=trapBatteryStatusWarning, memECCErrorCount=memECCErrorCount, postLogIndex=postLogIndex, raidDiskGroupId=raidDiskGroupId, raidPDFirmwareState=raidPDFirmwareState, raidPDPort1Status=raidPDPort1Status, raidPDSlotNumber=raidPDSlotNumber, postLogEntry=postLogEntry, ueccLogIndex=ueccLogIndex, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDTable=raidVDTable, trapGenericCritical=trapGenericCritical, raidBBUTable=raidBBUTable, trapFanNormal=trapFanNormal, memDeviceStatus=memDeviceStatus, cpuLogIndex=cpuLogIndex, osEntry=osEntry, raidBBUEntry=raidBBUEntry, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidAdapterId_BBU=raidAdapterId_BBU, raidPDEntry=raidPDEntry, raidPDRawSize=raidPDRawSize, trapGenericWarning=trapGenericWarning, ceccLogDatetime=ceccLogDatetime, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDSpan=raidPDSpan, ceccLogTable=ceccLogTable, raidAdapterProductName=raidAdapterProductName, raidPDInquiryData=raidPDInquiryData, mbProductName=mbProductName, osVersion=osVersion, cpuDescription=cpuDescription, osName=osName, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidDiskGroupId_PD=raidDiskGroupId_PD, diskTable=diskTable, sd5Version=sd5Version, diskController=diskController, raidVDMirrorDataSize=raidVDMirrorDataSize, mbSerialNumber=mbSerialNumber, raidPDMediaErrorCount=raidPDMediaErrorCount, diskSlotID=diskSlotID, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, dmiLogTable=dmiLogTable, sd5MIBVersion=sd5MIBVersion, cpuDeviceVersion=cpuDeviceVersion, cpuLogInfo=cpuLogInfo, memDescription=memDescription, sysBIOSIndex=sysBIOSIndex)
