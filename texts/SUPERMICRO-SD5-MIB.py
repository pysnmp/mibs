...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memTotalWidth=memTotalWidth, raidBBUIndex=raidBBUIndex, trapVoltageCritical=trapVoltageCritical, mbTable=mbTable, cpuID=cpuID, trapVoltageNormal=trapVoltageNormal, trapGenericWarning=trapGenericWarning, diskName=diskName, raidAdapterVendorId=raidAdapterVendorId, cpuTable=cpuTable, trapTemperatureCritical=trapTemperatureCritical, sd5MIBVersion=sd5MIBVersion, raidVDNumDrives=raidVDNumDrives, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapTemperatureWarning=trapTemperatureWarning, raidBBUStatus=raidBBUStatus, raidPDIndex=raidPDIndex, diskController=diskController, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sd5Idx=sd5Idx, raidVDMirrorDataSize=raidVDMirrorDataSize, diskInterfaceType=diskInterfaceType, trapPowerSupplyNormal=trapPowerSupplyNormal, raidAdapterGroup_PD=raidAdapterGroup_PD, diskSerialNumber=diskSerialNumber, postLogInfo=postLogInfo, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDSize=raidVDSize, raidAdapterTable=raidAdapterTable, cpuSocketDesignation=cpuSocketDesignation, smSD5TrapMIB=smSD5TrapMIB, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidAdapterSerialNumber=raidAdapterSerialNumber, raidDiskGroupId_PD=raidDiskGroupId_PD, trapFanWarning=trapFanWarning, raidPDNCQSetting=raidPDNCQSetting, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, ueccLogIndex=ueccLogIndex, sysBIOSTable=sysBIOSTable, raidAdapterEntry=raidAdapterEntry, raidPDFirmwareRevision=raidPDFirmwareRevision, trapBatteryStatusWarning=trapBatteryStatusWarning, ceccLogInfo=ceccLogInfo, diskEntry=diskEntry, osEntry=osEntry, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDSlotNumber=raidPDSlotNumber, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapChassisIntrusion=trapChassisIntrusion, trapPowerSupplyWarning=trapPowerSupplyWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDSpanDepth=raidVDSpanDepth, trapBatteryStatusNormal=trapBatteryStatusNormal, mbSerialNumber=mbSerialNumber, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapGenericNormal=trapGenericNormal, trapCpuFaultCritical=trapCpuFaultCritical, memSerialNumber=memSerialNumber, memUECCErrorCount=memUECCErrorCount, raidPDMediaErrorCount=raidPDMediaErrorCount, osVersion=osVersion, raidBBUEntry=raidBBUEntry, raidVDCached=raidVDCached, diskVendor=diskVendor, diskMediaType=diskMediaType, diskSize=diskSize, osTable=osTable, trapBbpStatusWarning=trapBbpStatusWarning, trapCpuFaultWarning=trapCpuFaultWarning, diskSlotID=diskSlotID, memCapacity=memCapacity, cpuMaxSpeed=cpuMaxSpeed, osName=osName, raidAdapterIndex=raidAdapterIndex, raidPDPredFailCount=raidPDPredFailCount, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, cpuLogTable=cpuLogTable, diskModel=diskModel, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDPort0Status=raidPDPort0Status, mbIndex=mbIndex, memPartNumber=memPartNumber, memLabeledBank=memLabeledBank, ceccLogTable=ceccLogTable, diskTable=diskTable, raidPDPort1Status=raidPDPort1Status, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, osManufacturer=osManufacturer, trapCpuFaultNormal=trapCpuFaultNormal, dmiLogTable=dmiLogTable, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDBadBlocksExist=raidVDBadBlocksExist, trapMemoryUeccWarning=trapMemoryUeccWarning, postLogTable=postLogTable, raidPDAllinoneStatus=raidPDAllinoneStatus, trapMemoryUeccNormal=trapMemoryUeccNormal, sysBIOSEntry=sysBIOSEntry, cpuDeviceID=cpuDeviceID, mbManufacturer=mbManufacturer, memECCErrorCount=memECCErrorCount, cpuDeviceVersion=cpuDeviceVersion, raidAdapterSubVendorId=raidAdapterSubVendorId, postLogDatetime=postLogDatetime, raidVDSupportsMaxPS=raidVDSupportsMaxPS, memTable=memTable, diskSmartStatus=diskSmartStatus, mbVersionName=mbVersionName, postLogEntry=postLogEntry, raidPDInquiryData=raidPDInquiryData, raidVDAllinoneStatus=raidVDAllinoneStatus, raidVDId=raidVDId, trapGenericCritical=trapGenericCritical, ceccLogIndex=ceccLogIndex, raidPDTable=raidPDTable, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidPDSerialNumber=raidPDSerialNumber, trapFanCritical=trapFanCritical, sysBIOSVersion=sysBIOSVersion, trapMemoryCeccWarning=trapMemoryCeccWarning, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDTargetId=raidVDTargetId, raidPDRawSize=raidPDRawSize, memTag=memTag, raidPDOtherErrorCount=raidPDOtherErrorCount, cpuName=cpuName, raidPDModel=raidPDModel, sd5Table=sd5Table, osIndex=osIndex, memDeviceLocator=memDeviceLocator, memManufacturer=memManufacturer, cpuIndex=cpuIndex, trapBbpStatusNormal=trapBbpStatusNormal, osSerialNumber=osSerialNumber, raidAdapterGroup=raidAdapterGroup, mbProductName=mbProductName, raidVDIndex=raidVDIndex, raidDiskGroupId=raidDiskGroupId, raidPDOpProgress=raidPDOpProgress, postLogIndex=postLogIndex, memErrorCount=memErrorCount, mbAssetTag=mbAssetTag, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapBbpStatusCritical=trapBbpStatusCritical, trapTemperatureNormal=trapTemperatureNormal, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidAdapterFWVersion=raidAdapterFWVersion, osCSDVersion=osCSDVersion, cpuLogDatetime=cpuLogDatetime, mbEntry=mbEntry, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidVDStripSize=raidVDStripSize, trapMemoryCeccCritical=trapMemoryCeccCritical, trapPowerSupplyCritical=trapPowerSupplyCritical, cpuCoreEnabled=cpuCoreEnabled, raidAdapterId_PD=raidAdapterId_PD, raidVDAllinoneMsg=raidVDAllinoneMsg, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuLogInfo=cpuLogInfo, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuCoreCount=cpuCoreCount, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterSubDeviceId=raidAdapterSubDeviceId, cpuThreadCount=cpuThreadCount, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDName=raidVDName, cpuDeviceStatus=cpuDeviceStatus, raidVDTable=raidVDTable, ueccLogEntry=ueccLogEntry, raidPDLinkSpeed=raidPDLinkSpeed, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidIsBBUAbsent=raidIsBBUAbsent, memDataWidth=memDataWidth, raidVDSupportT10Power=raidVDSupportT10Power, memDeviceStatus=memDeviceStatus, sysBIOSIndex=sysBIOSIndex, ueccLogDatetime=ueccLogDatetime, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuLogEntry=cpuLogEntry, cpuCurrentSpeed=cpuCurrentSpeed, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, cpuLogIndex=cpuLogIndex, raidPDWriteCache=raidPDWriteCache, trapFanNormal=trapFanNormal, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ueccLogInfo=ueccLogInfo, cpuDescription=cpuDescription, ceccLogEntry=ceccLogEntry, memEntry=memEntry, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidAdapterProductName=raidAdapterProductName, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidVDEncryptionType=raidVDEncryptionType, PYSNMP_MODULE_ID=smSuperDoctor5MIB, ueccLogTable=ueccLogTable, raidAdapterId=raidAdapterId, trapVoltageWarning=trapVoltageWarning, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidVDEntry=raidVDEntry, raidPDEntry=raidPDEntry, raidPDFirmwareState=raidPDFirmwareState, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidAdapterDeviceId=raidAdapterDeviceId, memModel=memModel, ceccLogDatetime=ceccLogDatetime, cpuManufacturer=cpuManufacturer, cpuEntry=cpuEntry, cpuLoadingPercentage=cpuLoadingPercentage, sd5Version=sd5Version, sysBIOSManufacturer=sysBIOSManufacturer, raidVDRaidLevel=raidVDRaidLevel, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, sd5Entry=sd5Entry, raidVDState=raidVDState, raidPDSpan=raidPDSpan, memDescription=memDescription, sysBIOSReleaseDate=sysBIOSReleaseDate, raidBBUTable=raidBBUTable, raidPDMediaType=raidPDMediaType, raidAdapterId_VD=raidAdapterId_VD)
