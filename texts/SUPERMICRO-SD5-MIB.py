...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memTag=memTag, raidPDOtherErrorCount=raidPDOtherErrorCount, mbManufacturer=mbManufacturer, raidAdapterGroup=raidAdapterGroup, trapPowerSupplyWarning=trapPowerSupplyWarning, trapFanWarning=trapFanWarning, trapBbpStatusNormal=trapBbpStatusNormal, mbTable=mbTable, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuMaxSpeed=cpuMaxSpeed, diskName=diskName, raidVDNumDrives=raidVDNumDrives, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memDeviceLocator=memDeviceLocator, cpuLogTable=cpuLogTable, sysBIOSIndex=sysBIOSIndex, raidAdapterFWVersion=raidAdapterFWVersion, cpuDeviceStatus=cpuDeviceStatus, memModel=memModel, diskModel=diskModel, memTotalWidth=memTotalWidth, sysBIOSTable=sysBIOSTable, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDId=raidVDId, trapTemperatureNormal=trapTemperatureNormal, trapChassisIntrusionCleared=trapChassisIntrusionCleared, diskTable=diskTable, raidVDSupportT10Power=raidVDSupportT10Power, mbSerialNumber=mbSerialNumber, sd5MIBVersion=sd5MIBVersion, raidBBUStatus=raidBBUStatus, sysBIOSEntry=sysBIOSEntry, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDName=raidVDName, raidVDState=raidVDState, raidPDMediaErrorCount=raidPDMediaErrorCount, memECCErrorCount=memECCErrorCount, raidBBUEntry=raidBBUEntry, trapVoltageCritical=trapVoltageCritical, trapTemperatureWarning=trapTemperatureWarning, ceccLogTable=ceccLogTable, ceccLogInfo=ceccLogInfo, smSD5TrapMIB=smSD5TrapMIB, raidVDIndex=raidVDIndex, raidAdapterId_PD=raidAdapterId_PD, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, mbVersionName=mbVersionName, raidVDEncryptionType=raidVDEncryptionType, sd5Entry=sd5Entry, memTable=memTable, raidVDAllinoneStatus=raidVDAllinoneStatus, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, memManufacturer=memManufacturer, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidVDMirrorDataSize=raidVDMirrorDataSize, smSuperDoctor5MIB=smSuperDoctor5MIB, sysBIOSManufacturer=sysBIOSManufacturer, raidPDPort0Status=raidPDPort0Status, raidPDFirmwareRevision=raidPDFirmwareRevision, ueccLogInfo=ueccLogInfo, raidPDDeviceSpeed=raidPDDeviceSpeed, trapGenericWarning=trapGenericWarning, mbProductName=mbProductName, cpuCoreEnabled=cpuCoreEnabled, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, diskVendor=diskVendor, osCSDVersion=osCSDVersion, raidPDEntry=raidPDEntry, dmiLogTable=dmiLogTable, cpuName=cpuName, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, ueccLogDatetime=ueccLogDatetime, mbEntry=mbEntry, raidPDTable=raidPDTable, cpuSocketDesignation=cpuSocketDesignation, raidPDOpProgress=raidPDOpProgress, trapVoltageNormal=trapVoltageNormal, memCapacity=memCapacity, osManufacturer=osManufacturer, mbIndex=mbIndex, memDataWidth=memDataWidth, raidAdapterDeviceId=raidAdapterDeviceId, raidVDRaidLevel=raidVDRaidLevel, trapMemoryUeccWarning=trapMemoryUeccWarning, ueccLogIndex=ueccLogIndex, cpuDeviceID=cpuDeviceID, sd5Table=sd5Table, ueccLogTable=ueccLogTable, postLogInfo=postLogInfo, cpuThreadCount=cpuThreadCount, trapCpuFaultCritical=trapCpuFaultCritical, raidBBUTable=raidBBUTable, osTable=osTable, raidAdapterIndex=raidAdapterIndex, trapBbpStatusWarning=trapBbpStatusWarning, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDDeviceFwLevel=raidPDDeviceFwLevel, osEntry=osEntry, memEntry=memEntry, diskSmartStatus=diskSmartStatus, trapTemperatureCritical=trapTemperatureCritical, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterProductName=raidAdapterProductName, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, postLogEntry=postLogEntry, trapPowerSupplyNormal=trapPowerSupplyNormal, memDescription=memDescription, diskSlotID=diskSlotID, raidPDPort1Status=raidPDPort1Status, diskInterfaceType=diskInterfaceType, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, cpuLogEntry=cpuLogEntry, trapPowerSupplyCritical=trapPowerSupplyCritical, memLabeledBank=memLabeledBank, trapMemoryCeccWarning=trapMemoryCeccWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDIndex=raidPDIndex, ceccLogDatetime=ceccLogDatetime, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapChassisIntrusion=trapChassisIntrusion, cpuIndex=cpuIndex, raidAdapterSerialNumber=raidAdapterSerialNumber, osName=osName, cpuCurrentSpeed=cpuCurrentSpeed, diskMediaType=diskMediaType, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterTable=raidAdapterTable, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidDiskGroupId=raidDiskGroupId, sysBIOSReleaseDate=sysBIOSReleaseDate, memSerialNumber=memSerialNumber, raidPDRawSize=raidPDRawSize, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDMediaType=raidPDMediaType, trapMemoryUeccNormal=trapMemoryUeccNormal, trapCpuFaultNormal=trapCpuFaultNormal, raidPDLinkSpeed=raidPDLinkSpeed, ueccLogEntry=ueccLogEntry, raidPDInquiryData=raidPDInquiryData, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuLoadingPercentage=cpuLoadingPercentage, trapMemoryCeccNormal=trapMemoryCeccNormal, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDFirmwareState=raidPDFirmwareState, trapFanCritical=trapFanCritical, memDeviceStatus=memDeviceStatus, sysBIOSVersion=sysBIOSVersion, raidAdapterId_VD=raidAdapterId_VD, memErrorCount=memErrorCount, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDCached=raidVDCached, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidVDTable=raidVDTable, trapVoltageWarning=trapVoltageWarning, cpuEntry=cpuEntry, raidPDWriteCache=raidPDWriteCache, raidPDNCQSetting=raidPDNCQSetting, cpuLogInfo=cpuLogInfo, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDModel=raidPDModel, cpuLogDatetime=cpuLogDatetime, osVersion=osVersion, cpuLogIndex=cpuLogIndex, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapCpuFaultWarning=trapCpuFaultWarning, raidVDSpanDepth=raidVDSpanDepth, cpuCoreCount=cpuCoreCount, raidVDStripSize=raidVDStripSize, raidAdapterVendorId=raidAdapterVendorId, raidVDEntry=raidVDEntry, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDAllinoneMsg=raidPDAllinoneMsg, raidIsBBUAbsent=raidIsBBUAbsent, memPartNumber=memPartNumber, ceccLogEntry=ceccLogEntry, cpuTable=cpuTable, cpuDeviceVersion=cpuDeviceVersion, diskSerialNumber=diskSerialNumber, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, postLogIndex=postLogIndex, cpuID=cpuID, sd5Idx=sd5Idx, mbAssetTag=mbAssetTag, trapGenericNormal=trapGenericNormal, raidVDTargetId=raidVDTargetId, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuDescription=cpuDescription, cpuManufacturer=cpuManufacturer, raidPDSlotNumber=raidPDSlotNumber, postLogDatetime=postLogDatetime, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDSpan=raidPDSpan, raidPDSerialNumber=raidPDSerialNumber, memUECCErrorCount=memUECCErrorCount, ceccLogIndex=ceccLogIndex, diskEntry=diskEntry, osSerialNumber=osSerialNumber, sd5Version=sd5Version, postLogTable=postLogTable, raidVDSize=raidVDSize, raidBBUIndex=raidBBUIndex, raidPDPredFailCount=raidPDPredFailCount, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, diskController=diskController, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterId_BBU=raidAdapterId_BBU, raidVDBadBlocksExist=raidVDBadBlocksExist, trapBbpStatusCritical=trapBbpStatusCritical, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterEntry=raidAdapterEntry, osIndex=osIndex, raidAdapterId=raidAdapterId, trapFanNormal=trapFanNormal, diskSize=diskSize, trapBatteryStatusCritical=trapBatteryStatusCritical, trapGenericCritical=trapGenericCritical)
