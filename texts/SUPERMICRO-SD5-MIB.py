...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memLabeledBank=memLabeledBank, diskSerialNumber=diskSerialNumber, cpuCoreCount=cpuCoreCount, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuDeviceID=cpuDeviceID, sd5MIBVersion=sd5MIBVersion, sysBIOSTable=sysBIOSTable, postLogDatetime=postLogDatetime, raidPDAllinoneStatus=raidPDAllinoneStatus, diskSmartStatus=diskSmartStatus, postLogTable=postLogTable, cpuLogDatetime=cpuLogDatetime, trapMemoryUeccWarning=trapMemoryUeccWarning, diskVendor=diskVendor, cpuCoreEnabled=cpuCoreEnabled, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDRaidLevel=raidVDRaidLevel, trapFanNormal=trapFanNormal, sysBIOSEntry=sysBIOSEntry, diskInterfaceType=diskInterfaceType, cpuDescription=cpuDescription, trapBbpStatusWarning=trapBbpStatusWarning, mbEntry=mbEntry, dmiLogTable=dmiLogTable, raidPDNCQSetting=raidPDNCQSetting, raidAdapterId_PD=raidAdapterId_PD, cpuSocketDesignation=cpuSocketDesignation, raidPDSpan=raidPDSpan, memPartNumber=memPartNumber, raidPDEntry=raidPDEntry, osCSDVersion=osCSDVersion, osIndex=osIndex, raidVDTable=raidVDTable, raidPDWriteCache=raidPDWriteCache, raidPDMediaErrorCount=raidPDMediaErrorCount, raidAdapterProductName=raidAdapterProductName, ueccLogEntry=ueccLogEntry, raidIsBBUAbsent=raidIsBBUAbsent, raidVDName=raidVDName, cpuIndex=cpuIndex, cpuDeviceStatus=cpuDeviceStatus, memUECCErrorCount=memUECCErrorCount, ueccLogDatetime=ueccLogDatetime, raidVDMirrorDataSize=raidVDMirrorDataSize, memDeviceStatus=memDeviceStatus, raidPDSerialNumber=raidPDSerialNumber, ceccLogInfo=ceccLogInfo, trapFanCritical=trapFanCritical, trapBbpStatusNormal=trapBbpStatusNormal, cpuMaxSpeed=cpuMaxSpeed, mbVersionName=mbVersionName, raidAdapterId_BBU=raidAdapterId_BBU, trapMemoryCeccNormal=trapMemoryCeccNormal, trapMemoryUeccCritical=trapMemoryUeccCritical, trapPowerSupplyWarning=trapPowerSupplyWarning, trapGenericWarning=trapGenericWarning, raidBBUAllinoneStatus=raidBBUAllinoneStatus, diskName=diskName, cpuName=cpuName, raidPDIndex=raidPDIndex, trapTemperatureNormal=trapTemperatureNormal, trapTemperatureCritical=trapTemperatureCritical, trapBbpStatusCritical=trapBbpStatusCritical, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, diskController=diskController, osTable=osTable, ceccLogDatetime=ceccLogDatetime, raidAdapterId=raidAdapterId, diskEntry=diskEntry, raidBBUIndex=raidBBUIndex, sd5Entry=sd5Entry, raidAdapterId_VD=raidAdapterId_VD, diskModel=diskModel, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapFanWarning=trapFanWarning, raidAdapterGroup_PD=raidAdapterGroup_PD, memCapacity=memCapacity, cpuEntry=cpuEntry, sysBIOSIndex=sysBIOSIndex, raidPDPort0Linkspeed=raidPDPort0Linkspeed, osVersion=osVersion, mbManufacturer=mbManufacturer, osManufacturer=osManufacturer, cpuLogIndex=cpuLogIndex, memErrorCount=memErrorCount, diskTable=diskTable, cpuLogTable=cpuLogTable, raidPDOpProgress=raidPDOpProgress, mbTable=mbTable, raidVDCached=raidVDCached, trapMemoryCeccCritical=trapMemoryCeccCritical, raidAdapterTable=raidAdapterTable, raidVDNumDrives=raidVDNumDrives, raidPDRawSize=raidPDRawSize, ueccLogInfo=ueccLogInfo, raidVDStripSize=raidVDStripSize, raidDiskGroupId_PD=raidDiskGroupId_PD, postLogIndex=postLogIndex, memSerialNumber=memSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDSupportsMaxPS=raidVDSupportsMaxPS, cpuLoadingPercentage=cpuLoadingPercentage, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, memDataWidth=memDataWidth, trapBatteryStatusWarning=trapBatteryStatusWarning, memManufacturer=memManufacturer, ueccLogTable=ueccLogTable, raidAdapterGroup=raidAdapterGroup, diskMediaType=diskMediaType, raidVDIndex=raidVDIndex, raidPDLinkSpeed=raidPDLinkSpeed, raidDiskGroupId=raidDiskGroupId, ceccLogTable=ceccLogTable, raidBBUEntry=raidBBUEntry, osName=osName, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterSerialNumber=raidAdapterSerialNumber, trapCpuFaultNormal=trapCpuFaultNormal, smSD5TrapMIB=smSD5TrapMIB, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, osEntry=osEntry, cpuID=cpuID, mbProductName=mbProductName, raidAdapterVendorId=raidAdapterVendorId, trapTemperatureWarning=trapTemperatureWarning, cpuDeviceVersion=cpuDeviceVersion, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDBadBlocksExist=raidVDBadBlocksExist, sd5Version=sd5Version, raidAdapterDeviceId=raidAdapterDeviceId, raidPDPort0Status=raidPDPort0Status, trapMemoryUeccNormal=trapMemoryUeccNormal, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, cpuLogEntry=cpuLogEntry, sd5Table=sd5Table, sysBIOSVersion=sysBIOSVersion, raidAdapterIndex=raidAdapterIndex, raidVDEntry=raidVDEntry, raidPDFirmwareState=raidPDFirmwareState, postLogEntry=postLogEntry, raidPDInquiryData=raidPDInquiryData, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidVDState=raidVDState, ueccLogIndex=ueccLogIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, raidPDPredFailCount=raidPDPredFailCount, raidAdapterSubVendorId=raidAdapterSubVendorId, diskSlotID=diskSlotID, raidVDTargetId=raidVDTargetId, cpuTable=cpuTable, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDMediaType=raidPDMediaType, smSuperDoctor5MIB=smSuperDoctor5MIB, trapChassisIntrusionCleared=trapChassisIntrusionCleared, mbAssetTag=mbAssetTag, ceccLogEntry=ceccLogEntry, raidVDEncryptionType=raidVDEncryptionType, sd5Idx=sd5Idx, raidPDDeviceSpeed=raidPDDeviceSpeed, memTag=memTag, raidVDSize=raidVDSize, trapVoltageCritical=trapVoltageCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, ceccLogIndex=ceccLogIndex, raidBBUTable=raidBBUTable, sysBIOSManufacturer=sysBIOSManufacturer, osSerialNumber=osSerialNumber, memModel=memModel, raidVDSpanDepth=raidVDSpanDepth, raidVDId=raidVDId, memECCErrorCount=memECCErrorCount, raidPDModel=raidPDModel, cpuLogInfo=cpuLogInfo, raidAdapterEntry=raidAdapterEntry, memTable=memTable, cpuThreadCount=cpuThreadCount, PYSNMP_MODULE_ID=smSuperDoctor5MIB, mbSerialNumber=mbSerialNumber, memDeviceLocator=memDeviceLocator, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapGenericCritical=trapGenericCritical, raidVDSupportT10Power=raidVDSupportT10Power, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDTable=raidPDTable, trapGenericNormal=trapGenericNormal, raidPDDeviceFwLevel=raidPDDeviceFwLevel, mbIndex=mbIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDAllinoneMsg=raidVDAllinoneMsg, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapVoltageNormal=trapVoltageNormal, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDPort1Status=raidPDPort1Status, trapChassisIntrusion=trapChassisIntrusion, memDescription=memDescription, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidBBUStatus=raidBBUStatus, cpuCurrentSpeed=cpuCurrentSpeed, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuManufacturer=cpuManufacturer, trapCpuFaultCritical=trapCpuFaultCritical, raidPDSlotNumber=raidPDSlotNumber, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memTotalWidth=memTotalWidth, trapCpuFaultWarning=trapCpuFaultWarning, diskSize=diskSize, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapVoltageWarning=trapVoltageWarning, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapBatteryStatusCritical=trapBatteryStatusCritical, postLogInfo=postLogInfo, raidPDAllinoneMsg=raidPDAllinoneMsg, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, memEntry=memEntry, raidAdapterGroup_BBU=raidAdapterGroup_BBU)
