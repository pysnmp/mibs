...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDAllinoneStatus=raidVDAllinoneStatus, trapFanCritical=trapFanCritical, raidVDMirrorDataSize=raidVDMirrorDataSize, memTable=memTable, cpuDeviceID=cpuDeviceID, trapGenericNormal=trapGenericNormal, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDAllinoneMsg=raidVDAllinoneMsg, trapCpuFaultCritical=trapCpuFaultCritical, raidVDSupportT10Power=raidVDSupportT10Power, raidVDTargetId=raidVDTargetId, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDStripSize=raidVDStripSize, raidVDEncryptionType=raidVDEncryptionType, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, smSuperDoctor5MIB=smSuperDoctor5MIB, mbManufacturer=mbManufacturer, diskController=diskController, mbProductName=mbProductName, raidPDLinkSpeed=raidPDLinkSpeed, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDSerialNumber=raidPDSerialNumber, osIndex=osIndex, raidAdapterGroup_PD=raidAdapterGroup_PD, ueccLogDatetime=ueccLogDatetime, memModel=memModel, raidAdapterFWVersion=raidAdapterFWVersion, raidPDPredFailCount=raidPDPredFailCount, raidVDEntry=raidVDEntry, trapTemperatureWarning=trapTemperatureWarning, ueccLogInfo=ueccLogInfo, raidVDRaidLevel=raidVDRaidLevel, postLogEntry=postLogEntry, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, diskInterfaceType=diskInterfaceType, raidPDMediaType=raidPDMediaType, sd5Idx=sd5Idx, cpuLogTable=cpuLogTable, raidVDCached=raidVDCached, memDeviceStatus=memDeviceStatus, memDeviceLocator=memDeviceLocator, memDescription=memDescription, raidPDSlotNumber=raidPDSlotNumber, raidPDFirmwareState=raidPDFirmwareState, trapBatteryStatusWarning=trapBatteryStatusWarning, sysBIOSEntry=sysBIOSEntry, raidAdapterTable=raidAdapterTable, diskSize=diskSize, trapBbpStatusWarning=trapBbpStatusWarning, trapCpuFaultWarning=trapCpuFaultWarning, cpuMaxSpeed=cpuMaxSpeed, sysBIOSManufacturer=sysBIOSManufacturer, diskModel=diskModel, diskMediaType=diskMediaType, memTag=memTag, cpuLogInfo=cpuLogInfo, mbAssetTag=mbAssetTag, raidPDAllinoneMsg=raidPDAllinoneMsg, raidAdapterId_PD=raidAdapterId_PD, sysBIOSIndex=sysBIOSIndex, raidBBUAllinoneStatus=raidBBUAllinoneStatus, sd5Table=sd5Table, raidBBUIndex=raidBBUIndex, raidAdapterId_VD=raidAdapterId_VD, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, ceccLogEntry=ceccLogEntry, ceccLogTable=ceccLogTable, osName=osName, dmiLogTable=dmiLogTable, diskSmartStatus=diskSmartStatus, cpuTable=cpuTable, memLabeledBank=memLabeledBank, raidPDPort0Linkspeed=raidPDPort0Linkspeed, memDataWidth=memDataWidth, trapChassisIntrusion=trapChassisIntrusion, osManufacturer=osManufacturer, trapGenericWarning=trapGenericWarning, raidPDWriteCache=raidPDWriteCache, raidVDState=raidVDState, raidAdapterGroup_VD=raidAdapterGroup_VD, raidDiskGroupId=raidDiskGroupId, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuLogDatetime=cpuLogDatetime, raidPDSpan=raidPDSpan, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidAdapterProductName=raidAdapterProductName, cpuLogEntry=cpuLogEntry, raidPDDeviceSpeed=raidPDDeviceSpeed, osCSDVersion=osCSDVersion, ueccLogIndex=ueccLogIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, raidAdapterId_BBU=raidAdapterId_BBU, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidVDId=raidVDId, PYSNMP_MODULE_ID=smSuperDoctor5MIB, osEntry=osEntry, trapCpuFaultNormal=trapCpuFaultNormal, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuCurrentSpeed=cpuCurrentSpeed, raidPDModel=raidPDModel, cpuCoreEnabled=cpuCoreEnabled, mbTable=mbTable, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, mbIndex=mbIndex, trapMemoryUeccCritical=trapMemoryUeccCritical, ceccLogIndex=ceccLogIndex, sysBIOSVersion=sysBIOSVersion, diskName=diskName, raidBBUStatus=raidBBUStatus, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, mbVersionName=mbVersionName, raidIsBBUAbsent=raidIsBBUAbsent, osSerialNumber=osSerialNumber, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapGenericCritical=trapGenericCritical, sysBIOSTable=sysBIOSTable, raidPDInquiryData=raidPDInquiryData, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterDeviceId=raidAdapterDeviceId, diskVendor=diskVendor, memErrorCount=memErrorCount, diskSlotID=diskSlotID, ceccLogInfo=ceccLogInfo, trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDTable=raidVDTable, mbEntry=mbEntry, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, smSD5TrapMIB=smSD5TrapMIB, trapMemoryUeccWarning=trapMemoryUeccWarning, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuDeviceStatus=cpuDeviceStatus, diskTable=diskTable, trapTemperatureCritical=trapTemperatureCritical, diskSerialNumber=diskSerialNumber, memCapacity=memCapacity, memTotalWidth=memTotalWidth, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidBBUEntry=raidBBUEntry, trapBatteryStatusNormal=trapBatteryStatusNormal, ueccLogEntry=ueccLogEntry, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDIndex=raidPDIndex, cpuSocketDesignation=cpuSocketDesignation, trapVoltageNormal=trapVoltageNormal, memManufacturer=memManufacturer, cpuID=cpuID, raidVDSize=raidVDSize, raidPDOpProgress=raidPDOpProgress, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidAdapterGroup=raidAdapterGroup, memEntry=memEntry, ueccLogTable=ueccLogTable, raidAdapterEntry=raidAdapterEntry, cpuName=cpuName, raidAdapterVendorId=raidAdapterVendorId, raidPDPort0Status=raidPDPort0Status, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidVDName=raidVDName, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDNumDrives=raidVDNumDrives, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapMemoryCeccNormal=trapMemoryCeccNormal, memUECCErrorCount=memUECCErrorCount, cpuEntry=cpuEntry, raidPDEntry=raidPDEntry, raidPDRawSize=raidPDRawSize, mbSerialNumber=mbSerialNumber, trapBbpStatusNormal=trapBbpStatusNormal, cpuLoadingPercentage=cpuLoadingPercentage, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, memSerialNumber=memSerialNumber, postLogIndex=postLogIndex, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapVoltageCritical=trapVoltageCritical, sd5Version=sd5Version, raidBBUTable=raidBBUTable, raidVDIndex=raidVDIndex, sd5Entry=sd5Entry, raidVDSpanDepth=raidVDSpanDepth, trapPowerSupplyWarning=trapPowerSupplyWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, sysBIOSReleaseDate=sysBIOSReleaseDate, ceccLogDatetime=ceccLogDatetime, trapFanNormal=trapFanNormal, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDFirmwareRevision=raidPDFirmwareRevision, cpuDeviceVersion=cpuDeviceVersion, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, cpuDescription=cpuDescription, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapBbpStatusCritical=trapBbpStatusCritical, sd5MIBVersion=sd5MIBVersion, osTable=osTable, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memECCErrorCount=memECCErrorCount, cpuManufacturer=cpuManufacturer, cpuLogIndex=cpuLogIndex, raidPDPort1Status=raidPDPort1Status, cpuIndex=cpuIndex, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDBadBlocksExist=raidVDBadBlocksExist, trapFanWarning=trapFanWarning, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapTemperatureNormal=trapTemperatureNormal, cpuCoreCount=cpuCoreCount, cpuThreadCount=cpuThreadCount, postLogTable=postLogTable, memPartNumber=memPartNumber, raidAdapterId=raidAdapterId, raidPDMediaErrorCount=raidPDMediaErrorCount, raidPDNCQSetting=raidPDNCQSetting, diskEntry=diskEntry, raidAdapterGroup_BBU=raidAdapterGroup_BBU, osVersion=osVersion, trapVoltageWarning=trapVoltageWarning, raidPDTable=raidPDTable, postLogInfo=postLogInfo, raidAdapterIndex=raidAdapterIndex, postLogDatetime=postLogDatetime, raidPDOtherErrorCount=raidPDOtherErrorCount)
