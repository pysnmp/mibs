...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapVoltageNormal=trapVoltageNormal, sd5MIBVersion=sd5MIBVersion, trapCpuFaultNormal=trapCpuFaultNormal, raidAdapterVendorId=raidAdapterVendorId, raidVDSpanDepth=raidVDSpanDepth, cpuLogTable=cpuLogTable, diskVendor=diskVendor, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDIndex=raidPDIndex, cpuMaxSpeed=cpuMaxSpeed, cpuLogEntry=cpuLogEntry, raidPDSerialNumber=raidPDSerialNumber, raidPDAllinoneStatus=raidPDAllinoneStatus, trapTemperatureCritical=trapTemperatureCritical, trapGenericWarning=trapGenericWarning, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, cpuIndex=cpuIndex, raidPDDeviceSpeed=raidPDDeviceSpeed, diskTable=diskTable, cpuLogDatetime=cpuLogDatetime, osSerialNumber=osSerialNumber, raidPDFirmwareRevision=raidPDFirmwareRevision, raidPDEntry=raidPDEntry, cpuName=cpuName, raidVDRaidLevel=raidVDRaidLevel, raidAdapterIndex=raidAdapterIndex, smSD5TrapMIB=smSD5TrapMIB, diskMediaType=diskMediaType, ceccLogInfo=ceccLogInfo, memModel=memModel, ceccLogEntry=ceccLogEntry, raidVDSize=raidVDSize, trapFanWarning=trapFanWarning, trapFanCritical=trapFanCritical, mbSerialNumber=mbSerialNumber, postLogDatetime=postLogDatetime, trapMemoryUeccNormal=trapMemoryUeccNormal, osCSDVersion=osCSDVersion, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidVDStripSize=raidVDStripSize, memDescription=memDescription, ceccLogIndex=ceccLogIndex, raidAdapterSubVendorId=raidAdapterSubVendorId, sd5Entry=sd5Entry, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, osManufacturer=osManufacturer, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuSocketDesignation=cpuSocketDesignation, ueccLogIndex=ueccLogIndex, raidVDNumDrives=raidVDNumDrives, ueccLogDatetime=ueccLogDatetime, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDTable=raidPDTable, memTag=memTag, raidPDSlotNumber=raidPDSlotNumber, raidAdapterId_BBU=raidAdapterId_BBU, raidDiskGroupId=raidDiskGroupId, raidVDId=raidVDId, raidVDEntry=raidVDEntry, cpuTable=cpuTable, diskSmartStatus=diskSmartStatus, memUECCErrorCount=memUECCErrorCount, osTable=osTable, trapBbpStatusNormal=trapBbpStatusNormal, cpuDeviceVersion=cpuDeviceVersion, ueccLogEntry=ueccLogEntry, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDSupportT10Power=raidVDSupportT10Power, trapMemoryCeccWarning=trapMemoryCeccWarning, raidAdapterGroup=raidAdapterGroup, trapFanNormal=trapFanNormal, trapMemoryCeccCritical=trapMemoryCeccCritical, osEntry=osEntry, raidPDOpProgress=raidPDOpProgress, raidPDRawSize=raidPDRawSize, raidVDEncryptionType=raidVDEncryptionType, diskName=diskName, raidIsBBUAbsent=raidIsBBUAbsent, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDAllinoneMsg=raidVDAllinoneMsg, mbManufacturer=mbManufacturer, raidPDNCQSetting=raidPDNCQSetting, raidVDTargetId=raidVDTargetId, raidPDOtherErrorCount=raidPDOtherErrorCount, trapBatteryStatusNormal=trapBatteryStatusNormal, postLogTable=postLogTable, postLogEntry=postLogEntry, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDAllinoneStatus=raidVDAllinoneStatus, raidAdapterProductName=raidAdapterProductName, raidVDName=raidVDName, trapBatteryStatusWarning=trapBatteryStatusWarning, raidPDMediaErrorCount=raidPDMediaErrorCount, diskEntry=diskEntry, raidPDInquiryData=raidPDInquiryData, memDeviceLocator=memDeviceLocator, mbTable=mbTable, raidBBUIndex=raidBBUIndex, memLabeledBank=memLabeledBank, memTotalWidth=memTotalWidth, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDCached=raidVDCached, raidVDBadBlocksExist=raidVDBadBlocksExist, diskInterfaceType=diskInterfaceType, ueccLogInfo=ueccLogInfo, mbProductName=mbProductName, trapMemoryUeccCritical=trapMemoryUeccCritical, memTable=memTable, raidPDFirmwareState=raidPDFirmwareState, diskSerialNumber=diskSerialNumber, trapVoltageCritical=trapVoltageCritical, raidBBUTable=raidBBUTable, sysBIOSEntry=sysBIOSEntry, ceccLogDatetime=ceccLogDatetime, cpuDescription=cpuDescription, postLogIndex=postLogIndex, raidAdapterId_PD=raidAdapterId_PD, cpuCoreEnabled=cpuCoreEnabled, trapBatteryStatusCritical=trapBatteryStatusCritical, mbEntry=mbEntry, raidPDMediaType=raidPDMediaType, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, osName=osName, raidBBUEntry=raidBBUEntry, cpuEntry=cpuEntry, sd5Table=sd5Table, diskSize=diskSize, raidAdapterSerialNumber=raidAdapterSerialNumber, ueccLogTable=ueccLogTable, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sysBIOSReleaseDate=sysBIOSReleaseDate, sd5Idx=sd5Idx, trapPowerSupplyCritical=trapPowerSupplyCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, raidBBUStatus=raidBBUStatus, raidPDPort1Status=raidPDPort1Status, trapCpuFaultCritical=trapCpuFaultCritical, sysBIOSIndex=sysBIOSIndex, mbIndex=mbIndex, raidPDDeviceFwLevel=raidPDDeviceFwLevel, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDWriteCache=raidPDWriteCache, cpuDeviceID=cpuDeviceID, trapTemperatureWarning=trapTemperatureWarning, raidVDIndex=raidVDIndex, cpuLogIndex=cpuLogIndex, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDModel=raidPDModel, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, cpuCoreCount=cpuCoreCount, memPartNumber=memPartNumber, trapBbpStatusWarning=trapBbpStatusWarning, ceccLogTable=ceccLogTable, dmiLogTable=dmiLogTable, trapVoltageWarning=trapVoltageWarning, trapPowerSupplyNormal=trapPowerSupplyNormal, memDeviceStatus=memDeviceStatus, memManufacturer=memManufacturer, trapGenericNormal=trapGenericNormal, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, cpuID=cpuID, raidVDTable=raidVDTable, trapTemperatureNormal=trapTemperatureNormal, raidPDPort1Linkspeed=raidPDPort1Linkspeed, mbVersionName=mbVersionName, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapCpuFaultWarning=trapCpuFaultWarning, raidVDMirrorDataSize=raidVDMirrorDataSize, cpuLogInfo=cpuLogInfo, memCapacity=memCapacity, sd5Version=sd5Version, trapMemoryUeccWarning=trapMemoryUeccWarning, raidAdapterTable=raidAdapterTable, cpuThreadCount=cpuThreadCount, sysBIOSManufacturer=sysBIOSManufacturer, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapGenericCritical=trapGenericCritical, raidPDLinkSpeed=raidPDLinkSpeed, cpuCurrentSpeed=cpuCurrentSpeed, raidAdapterGroup_PD=raidAdapterGroup_PD, diskSlotID=diskSlotID, osVersion=osVersion, raidPDSpan=raidPDSpan, raidPDPort0Status=raidPDPort0Status, cpuDeviceStatus=cpuDeviceStatus, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapPowerSupplyWarning=trapPowerSupplyWarning, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapBbpStatusCritical=trapBbpStatusCritical, raidAdapterId=raidAdapterId, memECCErrorCount=memECCErrorCount, memDataWidth=memDataWidth, diskModel=diskModel, raidAdapterId_VD=raidAdapterId_VD, memSerialNumber=memSerialNumber, cpuLoadingPercentage=cpuLoadingPercentage, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterEntry=raidAdapterEntry, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDPredFailCount=raidPDPredFailCount, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, cpuManufacturer=cpuManufacturer, trapChassisIntrusion=trapChassisIntrusion, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, sysBIOSTable=sysBIOSTable, raidVDState=raidVDState, postLogInfo=postLogInfo, sysBIOSVersion=sysBIOSVersion, memErrorCount=memErrorCount, memEntry=memEntry, raidAdapterFWVersion=raidAdapterFWVersion, osIndex=osIndex, mbAssetTag=mbAssetTag, diskController=diskController)
