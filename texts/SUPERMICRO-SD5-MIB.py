...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidIsBBUAbsent=raidIsBBUAbsent, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterProductName=raidAdapterProductName, memManufacturer=memManufacturer, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapMemoryCeccWarning=trapMemoryCeccWarning, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapMemoryUeccNormal=trapMemoryUeccNormal, diskEntry=diskEntry, raidAdapterDeviceId=raidAdapterDeviceId, cpuManufacturer=cpuManufacturer, sd5Version=sd5Version, trapTemperatureCritical=trapTemperatureCritical, cpuCoreEnabled=cpuCoreEnabled, postLogInfo=postLogInfo, sysBIOSVersion=sysBIOSVersion, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDSupportsMaxPS=raidVDSupportsMaxPS, osManufacturer=osManufacturer, trapVoltageNormal=trapVoltageNormal, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDAllinoneStatus=raidVDAllinoneStatus, raidAdapterGroup_BBU=raidAdapterGroup_BBU, cpuLoadingPercentage=cpuLoadingPercentage, raidVDId=raidVDId, raidAdapterGroup=raidAdapterGroup, raidBBUEntry=raidBBUEntry, diskSize=diskSize, ueccLogEntry=ueccLogEntry, ueccLogTable=ueccLogTable, cpuTable=cpuTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ueccLogInfo=ueccLogInfo, raidAdapterId_BBU=raidAdapterId_BBU, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDCached=raidVDCached, trapBbpStatusNormal=trapBbpStatusNormal, trapCpuFaultCritical=trapCpuFaultCritical, raidAdapterVendorId=raidAdapterVendorId, memDeviceStatus=memDeviceStatus, sd5MIBVersion=sd5MIBVersion, ueccLogDatetime=ueccLogDatetime, raidDiskGroupId=raidDiskGroupId, trapBatteryStatusNormal=trapBatteryStatusNormal, ceccLogInfo=ceccLogInfo, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidVDRaidLevel=raidVDRaidLevel, ceccLogIndex=ceccLogIndex, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, cpuDescription=cpuDescription, memCapacity=memCapacity, raidVDNumDrives=raidVDNumDrives, cpuDeviceVersion=cpuDeviceVersion, trapTemperatureNormal=trapTemperatureNormal, cpuThreadCount=cpuThreadCount, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDDiskCachePolicy=raidVDDiskCachePolicy, diskName=diskName, smSD5TrapMIB=smSD5TrapMIB, raidBBUAllinoneMsg=raidBBUAllinoneMsg, postLogIndex=postLogIndex, raidPDInquiryData=raidPDInquiryData, trapFanNormal=trapFanNormal, trapVoltageCritical=trapVoltageCritical, cpuDeviceStatus=cpuDeviceStatus, trapBbpStatusCritical=trapBbpStatusCritical, osSerialNumber=osSerialNumber, diskVendor=diskVendor, raidVDStripSize=raidVDStripSize, diskSerialNumber=diskSerialNumber, raidVDSpanDepth=raidVDSpanDepth, cpuCoreCount=cpuCoreCount, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDSpan=raidPDSpan, diskMediaType=diskMediaType, trapPowerSupplyNormal=trapPowerSupplyNormal, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, osCSDVersion=osCSDVersion, raidPDSlotNumber=raidPDSlotNumber, cpuLogEntry=cpuLogEntry, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDFirmwareRevision=raidPDFirmwareRevision, memEntry=memEntry, trapChassisIntrusion=trapChassisIntrusion, memLabeledBank=memLabeledBank, trapPowerSupplyCritical=trapPowerSupplyCritical, sd5Entry=sd5Entry, cpuLogDatetime=cpuLogDatetime, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterSubVendorId=raidAdapterSubVendorId, memModel=memModel, diskInterfaceType=diskInterfaceType, mbAssetTag=mbAssetTag, postLogTable=postLogTable, raidAdapterFWVersion=raidAdapterFWVersion, postLogEntry=postLogEntry, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDSerialNumber=raidPDSerialNumber, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterGroup_PD=raidAdapterGroup_PD, diskTable=diskTable, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidVDEntry=raidVDEntry, cpuMaxSpeed=cpuMaxSpeed, raidPDPort1Linkspeed=raidPDPort1Linkspeed, smSuperDoctor5MIB=smSuperDoctor5MIB, mbVersionName=mbVersionName, raidPDDeviceSpeed=raidPDDeviceSpeed, trapVoltageWarning=trapVoltageWarning, trapTemperatureWarning=trapTemperatureWarning, raidVDEncryptionType=raidVDEncryptionType, sd5Idx=sd5Idx, memTag=memTag, diskModel=diskModel, cpuLogInfo=cpuLogInfo, raidPDFirmwareState=raidPDFirmwareState, dmiLogTable=dmiLogTable, trapFanCritical=trapFanCritical, memPartNumber=memPartNumber, cpuLogTable=cpuLogTable, trapBatteryStatusWarning=trapBatteryStatusWarning, cpuName=cpuName, sd5Table=sd5Table, raidPDPort0Status=raidPDPort0Status, diskController=diskController, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, osIndex=osIndex, osEntry=osEntry, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDMirrorDataSize=raidVDMirrorDataSize, trapFanWarning=trapFanWarning, memErrorCount=memErrorCount, raidVDBadBlocksExist=raidVDBadBlocksExist, raidPDPort1Status=raidPDPort1Status, memTotalWidth=memTotalWidth, mbTable=mbTable, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, mbManufacturer=mbManufacturer, sysBIOSTable=sysBIOSTable, raidVDTargetId=raidVDTargetId, osVersion=osVersion, trapPowerSupplyWarning=trapPowerSupplyWarning, trapCpuFaultWarning=trapCpuFaultWarning, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDIndex=raidVDIndex, sysBIOSManufacturer=sysBIOSManufacturer, osTable=osTable, raidAdapterId=raidAdapterId, sysBIOSIndex=sysBIOSIndex, raidPDTable=raidPDTable, ceccLogEntry=ceccLogEntry, memTable=memTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDTable=raidVDTable, mbEntry=mbEntry, diskSlotID=diskSlotID, raidAdapterEntry=raidAdapterEntry, raidBBUStatus=raidBBUStatus, raidPDIndex=raidPDIndex, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidBBUTable=raidBBUTable, raidAdapterId_VD=raidAdapterId_VD, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterTable=raidAdapterTable, memECCErrorCount=memECCErrorCount, mbSerialNumber=mbSerialNumber, raidPDOpProgress=raidPDOpProgress, cpuLogIndex=cpuLogIndex, cpuSocketDesignation=cpuSocketDesignation, mbIndex=mbIndex, osName=osName, raidAdapterIndex=raidAdapterIndex, raidPDMediaType=raidPDMediaType, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuEntry=cpuEntry, raidAdapterSerialNumber=raidAdapterSerialNumber, raidAdapterId_PD=raidAdapterId_PD, trapGenericNormal=trapGenericNormal, raidVDSize=raidVDSize, memSerialNumber=memSerialNumber, postLogDatetime=postLogDatetime, cpuIndex=cpuIndex, raidVDName=raidVDName, memUECCErrorCount=memUECCErrorCount, memDeviceLocator=memDeviceLocator, trapBbpStatusWarning=trapBbpStatusWarning, trapCpuFaultNormal=trapCpuFaultNormal, raidPDModel=raidPDModel, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, diskSmartStatus=diskSmartStatus, cpuDeviceID=cpuDeviceID, raidVDState=raidVDState, raidPDRawSize=raidPDRawSize, trapMemoryUeccWarning=trapMemoryUeccWarning, raidPDPredFailCount=raidPDPredFailCount, mbProductName=mbProductName, raidPDNCQSetting=raidPDNCQSetting, memDataWidth=memDataWidth, raidBBUIndex=raidBBUIndex, sysBIOSEntry=sysBIOSEntry, cpuCurrentSpeed=cpuCurrentSpeed, raidPDWriteCache=raidPDWriteCache, cpuID=cpuID, trapGenericCritical=trapGenericCritical, ueccLogIndex=ueccLogIndex, raidVDSupportT10Power=raidVDSupportT10Power, trapGenericWarning=trapGenericWarning, memDescription=memDescription, ceccLogDatetime=ceccLogDatetime, ceccLogTable=ceccLogTable, raidPDEntry=raidPDEntry, raidAdapterGroup_VD=raidAdapterGroup_VD)
