...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidVDMirrorDataSize=raidVDMirrorDataSize, raidBBUStatus=raidBBUStatus, raidAdapterId_PD=raidAdapterId_PD, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidPDMediaType=raidPDMediaType, sysBIOSTable=sysBIOSTable, diskMediaType=diskMediaType, memDataWidth=memDataWidth, raidPDPort1Linkspeed=raidPDPort1Linkspeed, diskSerialNumber=diskSerialNumber, raidAdapterEntry=raidAdapterEntry, raidVDTargetId=raidVDTargetId, raidPDIndex=raidPDIndex, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuDeviceVersion=cpuDeviceVersion, cpuLogInfo=cpuLogInfo, ueccLogIndex=ueccLogIndex, diskSize=diskSize, ceccLogIndex=ceccLogIndex, raidAdapterTable=raidAdapterTable, raidPDSpan=raidPDSpan, memUECCErrorCount=memUECCErrorCount, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterId_BBU=raidAdapterId_BBU, raidPDSerialNumber=raidPDSerialNumber, cpuLoadingPercentage=cpuLoadingPercentage, mbManufacturer=mbManufacturer, postLogInfo=postLogInfo, trapPowerSupplyNormal=trapPowerSupplyNormal, osEntry=osEntry, mbIndex=mbIndex, raidPDTable=raidPDTable, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuThreadCount=cpuThreadCount, memSerialNumber=memSerialNumber, cpuCurrentSpeed=cpuCurrentSpeed, osCSDVersion=osCSDVersion, postLogIndex=postLogIndex, raidAdapterSerialNumber=raidAdapterSerialNumber, trapCpuFaultNormal=trapCpuFaultNormal, raidAdapterIndex=raidAdapterIndex, cpuTable=cpuTable, raidVDSpanDepth=raidVDSpanDepth, memErrorCount=memErrorCount, ueccLogEntry=ueccLogEntry, trapFanNormal=trapFanNormal, sysBIOSReleaseDate=sysBIOSReleaseDate, raidVDNumDrives=raidVDNumDrives, sysBIOSEntry=sysBIOSEntry, raidIsBBUAbsent=raidIsBBUAbsent, trapFanCritical=trapFanCritical, osVersion=osVersion, trapVoltageCritical=trapVoltageCritical, raidPDOtherErrorCount=raidPDOtherErrorCount, sd5Idx=sd5Idx, trapBbpStatusCritical=trapBbpStatusCritical, mbSerialNumber=mbSerialNumber, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDOpProgress=raidPDOpProgress, diskSlotID=diskSlotID, raidAdapterSubVendorId=raidAdapterSubVendorId, diskModel=diskModel, raidAdapterGroup_BBU=raidAdapterGroup_BBU, cpuCoreEnabled=cpuCoreEnabled, cpuID=cpuID, ceccLogTable=ceccLogTable, mbEntry=mbEntry, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDDeviceSpeed=raidPDDeviceSpeed, raidAdapterId=raidAdapterId, raidAdapterProductName=raidAdapterProductName, sd5Version=sd5Version, raidVDState=raidVDState, dmiLogTable=dmiLogTable, raidPDEntry=raidPDEntry, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, osManufacturer=osManufacturer, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, memManufacturer=memManufacturer, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, cpuLogDatetime=cpuLogDatetime, trapGenericCritical=trapGenericCritical, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memDescription=memDescription, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, sd5MIBVersion=sd5MIBVersion, cpuMaxSpeed=cpuMaxSpeed, trapPowerSupplyCritical=trapPowerSupplyCritical, diskVendor=diskVendor, raidPDModel=raidPDModel, raidPDSlotNumber=raidPDSlotNumber, raidPDPredFailCount=raidPDPredFailCount, trapGenericWarning=trapGenericWarning, raidVDStripSize=raidVDStripSize, raidVDCached=raidVDCached, raidVDTable=raidVDTable, cpuLogEntry=cpuLogEntry, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDIndex=raidVDIndex, raidAdapterGroup_PD=raidAdapterGroup_PD, memTable=memTable, ceccLogEntry=ceccLogEntry, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuDescription=cpuDescription, raidAdapterId_VD=raidAdapterId_VD, osTable=osTable, memPartNumber=memPartNumber, diskController=diskController, postLogEntry=postLogEntry, cpuSocketDesignation=cpuSocketDesignation, cpuDeviceID=cpuDeviceID, sd5Table=sd5Table, sysBIOSIndex=sysBIOSIndex, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidDiskGroupId_PD=raidDiskGroupId_PD, trapChassisIntrusion=trapChassisIntrusion, raidBBUTable=raidBBUTable, trapBatteryStatusWarning=trapBatteryStatusWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, diskSmartStatus=diskSmartStatus, ueccLogTable=ueccLogTable, postLogDatetime=postLogDatetime, cpuCoreCount=cpuCoreCount, ceccLogDatetime=ceccLogDatetime, trapMemoryUeccCritical=trapMemoryUeccCritical, smSuperDoctor5MIB=smSuperDoctor5MIB, mbProductName=mbProductName, ueccLogDatetime=ueccLogDatetime, ueccLogInfo=ueccLogInfo, trapTemperatureNormal=trapTemperatureNormal, trapBbpStatusNormal=trapBbpStatusNormal, cpuName=cpuName, trapCpuFaultWarning=trapCpuFaultWarning, raidBBUEntry=raidBBUEntry, trapFanWarning=trapFanWarning, memDeviceLocator=memDeviceLocator, raidPDPort1Status=raidPDPort1Status, raidVDEntry=raidVDEntry, raidVDDiskCachePolicy=raidVDDiskCachePolicy, diskTable=diskTable, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidDiskGroupId=raidDiskGroupId, trapMemoryUeccWarning=trapMemoryUeccWarning, raidVDRaidLevel=raidVDRaidLevel, raidPDInquiryData=raidPDInquiryData, trapTemperatureWarning=trapTemperatureWarning, memECCErrorCount=memECCErrorCount, postLogTable=postLogTable, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterGroup=raidAdapterGroup, trapVoltageWarning=trapVoltageWarning, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDBadBlocksExist=raidVDBadBlocksExist, memModel=memModel, raidVDEncryptionType=raidVDEncryptionType, diskInterfaceType=diskInterfaceType, trapBatteryStatusNormal=trapBatteryStatusNormal, mbTable=mbTable, raidPDMediaErrorCount=raidPDMediaErrorCount, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterVendorId=raidAdapterVendorId, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, diskEntry=diskEntry, raidVDSize=raidVDSize, osIndex=osIndex, sd5Entry=sd5Entry, cpuEntry=cpuEntry, raidVDId=raidVDId, raidBBUIndex=raidBBUIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, cpuManufacturer=cpuManufacturer, memEntry=memEntry, memTag=memTag, mbVersionName=mbVersionName, raidBBUAllinoneStatus=raidBBUAllinoneStatus, memCapacity=memCapacity, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, sysBIOSVersion=sysBIOSVersion, memLabeledBank=memLabeledBank, raidPDFirmwareState=raidPDFirmwareState, osName=osName, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDAllinoneStatus=raidVDAllinoneStatus, memTotalWidth=memTotalWidth, raidPDAllinoneStatus=raidPDAllinoneStatus, osSerialNumber=osSerialNumber, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, smSD5TrapMIB=smSD5TrapMIB, raidPDAllinoneMsg=raidPDAllinoneMsg, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, diskName=diskName, raidPDNCQSetting=raidPDNCQSetting, mbAssetTag=mbAssetTag, ceccLogInfo=ceccLogInfo, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDSupportT10Power=raidVDSupportT10Power, raidPDWriteCache=raidPDWriteCache, trapTemperatureCritical=trapTemperatureCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, trapMemoryUeccNormal=trapMemoryUeccNormal, trapBbpStatusWarning=trapBbpStatusWarning, trapCpuFaultCritical=trapCpuFaultCritical, cpuDeviceStatus=cpuDeviceStatus, raidPDPort0Status=raidPDPort0Status, raidVDName=raidVDName, raidAdapterFWVersion=raidAdapterFWVersion, cpuIndex=cpuIndex, memDeviceStatus=memDeviceStatus, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapVoltageNormal=trapVoltageNormal, trapGenericNormal=trapGenericNormal, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, cpuLogTable=cpuLogTable, trapPowerSupplyWarning=trapPowerSupplyWarning, cpuLogIndex=cpuLogIndex, raidPDRawSize=raidPDRawSize, sysBIOSManufacturer=sysBIOSManufacturer)
