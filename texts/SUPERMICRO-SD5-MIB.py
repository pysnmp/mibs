...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuCoreEnabled=cpuCoreEnabled, trapFanWarning=trapFanWarning, memDeviceStatus=memDeviceStatus, raidPDAllinoneStatus=raidPDAllinoneStatus, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, sysBIOSManufacturer=sysBIOSManufacturer, trapVoltageWarning=trapVoltageWarning, memDataWidth=memDataWidth, cpuIndex=cpuIndex, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, osSerialNumber=osSerialNumber, trapFanCritical=trapFanCritical, mbAssetTag=mbAssetTag, raidVDId=raidVDId, raidPDLinkSpeed=raidPDLinkSpeed, trapCpuFaultCritical=trapCpuFaultCritical, ceccLogTable=ceccLogTable, sysBIOSEntry=sysBIOSEntry, raidPDTable=raidPDTable, diskSize=diskSize, trapPowerSupplyCritical=trapPowerSupplyCritical, sd5Table=sd5Table, osTable=osTable, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidAdapterVendorId=raidAdapterVendorId, raidVDIndex=raidVDIndex, osManufacturer=osManufacturer, ueccLogDatetime=ueccLogDatetime, cpuThreadCount=cpuThreadCount, sysBIOSReleaseDate=sysBIOSReleaseDate, raidBBUStatus=raidBBUStatus, raidPDAllinoneMsg=raidPDAllinoneMsg, osVersion=osVersion, trapFanNormal=trapFanNormal, cpuLogTable=cpuLogTable, memManufacturer=memManufacturer, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapGenericNormal=trapGenericNormal, raidPDInquiryData=raidPDInquiryData, cpuLogDatetime=cpuLogDatetime, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, memDeviceLocator=memDeviceLocator, diskTable=diskTable, postLogInfo=postLogInfo, raidDiskGroupId_PD=raidDiskGroupId_PD, trapMemoryUeccCritical=trapMemoryUeccCritical, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDEncryptionType=raidVDEncryptionType, raidPDMediaType=raidPDMediaType, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDPort0Status=raidPDPort0Status, raidAdapterId=raidAdapterId, diskEntry=diskEntry, raidVDName=raidVDName, memCapacity=memCapacity, ueccLogInfo=ueccLogInfo, raidPDDeviceFwLevel=raidPDDeviceFwLevel, memTotalWidth=memTotalWidth, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDSupportsMaxPS=raidVDSupportsMaxPS, sd5Entry=sd5Entry, raidPDSpan=raidPDSpan, raidPDFirmwareState=raidPDFirmwareState, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDSlotNumber=raidPDSlotNumber, raidPDPort0Linkspeed=raidPDPort0Linkspeed, postLogDatetime=postLogDatetime, cpuMaxSpeed=cpuMaxSpeed, cpuName=cpuName, cpuLoadingPercentage=cpuLoadingPercentage, diskName=diskName, dmiLogTable=dmiLogTable, ceccLogDatetime=ceccLogDatetime, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, ceccLogEntry=ceccLogEntry, raidBBUTable=raidBBUTable, raidPDFirmwareRevision=raidPDFirmwareRevision, cpuTable=cpuTable, mbProductName=mbProductName, osEntry=osEntry, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDEntry=raidVDEntry, raidPDOpProgress=raidPDOpProgress, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDRawSize=raidPDRawSize, cpuSocketDesignation=cpuSocketDesignation, osIndex=osIndex, memErrorCount=memErrorCount, memECCErrorCount=memECCErrorCount, raidAdapterBIOSVersion=raidAdapterBIOSVersion, ueccLogEntry=ueccLogEntry, raidAdapterSubDeviceId=raidAdapterSubDeviceId, smSuperDoctor5MIB=smSuperDoctor5MIB, cpuDescription=cpuDescription, cpuLogInfo=cpuLogInfo, trapTemperatureWarning=trapTemperatureWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuDeviceID=cpuDeviceID, raidAdapterGroup_VD=raidAdapterGroup_VD, diskSerialNumber=diskSerialNumber, memPartNumber=memPartNumber, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidBBUEntry=raidBBUEntry, postLogIndex=postLogIndex, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, memLabeledBank=memLabeledBank, raidBBUIndex=raidBBUIndex, raidPDIndex=raidPDIndex, trapTemperatureNormal=trapTemperatureNormal, smSD5TrapMIB=smSD5TrapMIB, raidVDTable=raidVDTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memEntry=memEntry, cpuLogIndex=cpuLogIndex, cpuManufacturer=cpuManufacturer, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDPredFailCount=raidPDPredFailCount, sd5Idx=sd5Idx, raidPDOtherErrorCount=raidPDOtherErrorCount, raidAdapterId_VD=raidAdapterId_VD, mbVersionName=mbVersionName, raidAdapterIndex=raidAdapterIndex, trapBbpStatusWarning=trapBbpStatusWarning, memUECCErrorCount=memUECCErrorCount, trapMemoryUeccWarning=trapMemoryUeccWarning, raidAdapterProductName=raidAdapterProductName, postLogEntry=postLogEntry, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, sysBIOSVersion=sysBIOSVersion, diskModel=diskModel, raidPDWriteCache=raidPDWriteCache, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sd5MIBVersion=sd5MIBVersion, raidPDModel=raidPDModel, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidVDSpanDepth=raidVDSpanDepth, trapPowerSupplyWarning=trapPowerSupplyWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDCached=raidVDCached, trapPowerSupplyNormal=trapPowerSupplyNormal, trapTemperatureCritical=trapTemperatureCritical, trapMemoryCeccCritical=trapMemoryCeccCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, mbManufacturer=mbManufacturer, ceccLogIndex=ceccLogIndex, raidAdapterEntry=raidAdapterEntry, mbIndex=mbIndex, diskController=diskController, trapGenericWarning=trapGenericWarning, raidAdapterSubVendorId=raidAdapterSubVendorId, diskVendor=diskVendor, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDState=raidVDState, memSerialNumber=memSerialNumber, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterTable=raidAdapterTable, raidDiskGroupId=raidDiskGroupId, raidVDNumDrives=raidVDNumDrives, cpuCoreCount=cpuCoreCount, raidAdapterId_BBU=raidAdapterId_BBU, raidPDEntry=raidPDEntry, raidVDDiskCachePolicy=raidVDDiskCachePolicy, mbSerialNumber=mbSerialNumber, raidPDNCQSetting=raidPDNCQSetting, trapCpuFaultWarning=trapCpuFaultWarning, diskSmartStatus=diskSmartStatus, osCSDVersion=osCSDVersion, cpuLogEntry=cpuLogEntry, memModel=memModel, raidAdapterSerialNumber=raidAdapterSerialNumber, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, ueccLogIndex=ueccLogIndex, raidAdapterDeviceId=raidAdapterDeviceId, mbEntry=mbEntry, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, PYSNMP_MODULE_ID=smSuperDoctor5MIB, ceccLogInfo=ceccLogInfo, raidAdapterFWVersion=raidAdapterFWVersion, raidVDAllinoneMsg=raidVDAllinoneMsg, trapBbpStatusNormal=trapBbpStatusNormal, diskMediaType=diskMediaType, raidAdapterId_PD=raidAdapterId_PD, raidPDPort1Status=raidPDPort1Status, raidIsBBUAbsent=raidIsBBUAbsent, raidVDTargetId=raidVDTargetId, trapVoltageCritical=trapVoltageCritical, trapBbpStatusCritical=trapBbpStatusCritical, postLogTable=postLogTable, trapCpuFaultNormal=trapCpuFaultNormal, raidVDSupportT10Power=raidVDSupportT10Power, memTag=memTag, raidVDStripSize=raidVDStripSize, memDescription=memDescription, sysBIOSIndex=sysBIOSIndex, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuDeviceStatus=cpuDeviceStatus, ueccLogTable=ueccLogTable, trapChassisIntrusion=trapChassisIntrusion, trapMemoryCeccNormal=trapMemoryCeccNormal, diskInterfaceType=diskInterfaceType, raidAdapterGroup_BBU=raidAdapterGroup_BBU, sysBIOSTable=sysBIOSTable, memTable=memTable, raidVDSize=raidVDSize, sd5Version=sd5Version, osName=osName, cpuEntry=cpuEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, trapVoltageNormal=trapVoltageNormal, diskSlotID=diskSlotID, mbTable=mbTable, raidPDSerialNumber=raidPDSerialNumber, raidVDRaidLevel=raidVDRaidLevel, cpuCurrentSpeed=cpuCurrentSpeed, raidAdapterGroup=raidAdapterGroup, trapGenericCritical=trapGenericCritical, cpuID=cpuID, cpuDeviceVersion=cpuDeviceVersion)
