...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapCpuFaultCritical=trapCpuFaultCritical, raidPDPort0Linkspeed=raidPDPort0Linkspeed, memDeviceLocator=memDeviceLocator, raidAdapterFWVersion=raidAdapterFWVersion, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, smSuperDoctor5MIB=smSuperDoctor5MIB, sysBIOSVersion=sysBIOSVersion, cpuLogDatetime=cpuLogDatetime, cpuDeviceStatus=cpuDeviceStatus, trapPowerSupplyNormal=trapPowerSupplyNormal, ceccLogIndex=ceccLogIndex, smSD5TrapMIB=smSD5TrapMIB, sd5Version=sd5Version, cpuTable=cpuTable, mbEntry=mbEntry, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterTable=raidAdapterTable, memTotalWidth=memTotalWidth, memSerialNumber=memSerialNumber, sysBIOSReleaseDate=sysBIOSReleaseDate, raidAdapterVendorId=raidAdapterVendorId, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuCoreCount=cpuCoreCount, raidPDEntry=raidPDEntry, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterGroup=raidAdapterGroup, memEntry=memEntry, postLogEntry=postLogEntry, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuMaxSpeed=cpuMaxSpeed, osTable=osTable, cpuSocketDesignation=cpuSocketDesignation, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, osManufacturer=osManufacturer, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidVDAllinoneMsg=raidVDAllinoneMsg, trapMemoryUeccWarning=trapMemoryUeccWarning, memDeviceStatus=memDeviceStatus, diskMediaType=diskMediaType, raidVDName=raidVDName, raidVDEncryptionType=raidVDEncryptionType, raidVDState=raidVDState, raidPDPort1Status=raidPDPort1Status, memUECCErrorCount=memUECCErrorCount, memTable=memTable, raidPDSlotNumber=raidPDSlotNumber, raidPDSpan=raidPDSpan, diskName=diskName, trapChassisIntrusion=trapChassisIntrusion, trapGenericNormal=trapGenericNormal, raidAdapterSerialNumber=raidAdapterSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, mbAssetTag=mbAssetTag, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDFirmwareState=raidPDFirmwareState, cpuCoreEnabled=cpuCoreEnabled, diskTable=diskTable, cpuLogIndex=cpuLogIndex, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDLinkSpeed=raidPDLinkSpeed, mbIndex=mbIndex, raidDiskGroupId=raidDiskGroupId, raidPDModel=raidPDModel, diskSize=diskSize, ceccLogEntry=ceccLogEntry, raidPDIndex=raidPDIndex, raidAdapterId_VD=raidAdapterId_VD, cpuDescription=cpuDescription, sd5MIBVersion=sd5MIBVersion, mbManufacturer=mbManufacturer, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidBBUEntry=raidBBUEntry, memECCErrorCount=memECCErrorCount, raidVDSpanDepth=raidVDSpanDepth, raidVDTargetId=raidVDTargetId, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterId=raidAdapterId, raidPDInquiryData=raidPDInquiryData, raidPDRawSize=raidPDRawSize, diskModel=diskModel, raidBBUStatus=raidBBUStatus, cpuID=cpuID, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterSubVendorId=raidAdapterSubVendorId, ceccLogInfo=ceccLogInfo, raidPDAllinoneMsg=raidPDAllinoneMsg, sysBIOSTable=sysBIOSTable, mbVersionName=mbVersionName, cpuLogInfo=cpuLogInfo, raidBBUAllinoneStatus=raidBBUAllinoneStatus, sysBIOSManufacturer=sysBIOSManufacturer, osVersion=osVersion, osCSDVersion=osCSDVersion, postLogIndex=postLogIndex, raidVDId=raidVDId, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuIndex=cpuIndex, raidVDTable=raidVDTable, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuThreadCount=cpuThreadCount, trapTemperatureCritical=trapTemperatureCritical, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDNumDrives=raidVDNumDrives, mbTable=mbTable, raidPDPort0Status=raidPDPort0Status, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterIndex=raidAdapterIndex, raidVDStripSize=raidVDStripSize, trapBatteryStatusNormal=trapBatteryStatusNormal, dmiLogTable=dmiLogTable, raidPDAllinoneStatus=raidPDAllinoneStatus, sd5Table=sd5Table, cpuDeviceVersion=cpuDeviceVersion, ueccLogIndex=ueccLogIndex, cpuEntry=cpuEntry, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapMemoryUeccCritical=trapMemoryUeccCritical, diskController=diskController, trapGenericCritical=trapGenericCritical, osSerialNumber=osSerialNumber, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidBBUTable=raidBBUTable, sd5Idx=sd5Idx, trapTemperatureWarning=trapTemperatureWarning, raidAdapterId_PD=raidAdapterId_PD, raidVDMirrorDataSize=raidVDMirrorDataSize, cpuManufacturer=cpuManufacturer, ceccLogDatetime=ceccLogDatetime, trapFanNormal=trapFanNormal, cpuDeviceID=cpuDeviceID, memCapacity=memCapacity, cpuCurrentSpeed=cpuCurrentSpeed, osName=osName, raidVDCached=raidVDCached, raidPDFirmwareRevision=raidPDFirmwareRevision, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, diskInterfaceType=diskInterfaceType, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDTable=raidPDTable, trapTemperatureNormal=trapTemperatureNormal, trapGenericWarning=trapGenericWarning, trapVoltageWarning=trapVoltageWarning, diskVendor=diskVendor, cpuLoadingPercentage=cpuLoadingPercentage, sd5Entry=sd5Entry, mbProductName=mbProductName, trapBbpStatusWarning=trapBbpStatusWarning, trapBbpStatusCritical=trapBbpStatusCritical, memDataWidth=memDataWidth, diskEntry=diskEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, ueccLogDatetime=ueccLogDatetime, postLogInfo=postLogInfo, ueccLogInfo=ueccLogInfo, raidVDSize=raidVDSize, sysBIOSEntry=sysBIOSEntry, ceccLogTable=ceccLogTable, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, memManufacturer=memManufacturer, raidPDNCQSetting=raidPDNCQSetting, raidAdapterProductName=raidAdapterProductName, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuName=cpuName, raidVDRaidLevel=raidVDRaidLevel, diskSerialNumber=diskSerialNumber, raidPDMediaErrorCount=raidPDMediaErrorCount, raidPDMediaType=raidPDMediaType, raidPDPredFailCount=raidPDPredFailCount, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDOpProgress=raidPDOpProgress, trapMemoryUeccNormal=trapMemoryUeccNormal, ueccLogTable=ueccLogTable, memTag=memTag, mbSerialNumber=mbSerialNumber, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapMemoryCeccNormal=trapMemoryCeccNormal, trapBatteryStatusWarning=trapBatteryStatusWarning, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDIndex=raidVDIndex, cpuLogTable=cpuLogTable, memDescription=memDescription, raidVDSupportT10Power=raidVDSupportT10Power, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidAdapterEntry=raidAdapterEntry, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapVoltageCritical=trapVoltageCritical, cpuLogEntry=cpuLogEntry, trapMemoryCeccCritical=trapMemoryCeccCritical, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapBbpStatusNormal=trapBbpStatusNormal, trapCpuFaultNormal=trapCpuFaultNormal, memErrorCount=memErrorCount, diskSmartStatus=diskSmartStatus, raidPDWriteCache=raidPDWriteCache, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, memPartNumber=memPartNumber, trapCpuFaultWarning=trapCpuFaultWarning, raidPDSerialNumber=raidPDSerialNumber, raidVDEntry=raidVDEntry, trapPowerSupplyCritical=trapPowerSupplyCritical, trapFanCritical=trapFanCritical, diskSlotID=diskSlotID, trapFanWarning=trapFanWarning, memLabeledBank=memLabeledBank, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, osIndex=osIndex, ueccLogEntry=ueccLogEntry, trapVoltageNormal=trapVoltageNormal, postLogTable=postLogTable, trapMemoryCeccWarning=trapMemoryCeccWarning, memModel=memModel, osEntry=osEntry, trapPowerSupplyWarning=trapPowerSupplyWarning, sysBIOSIndex=sysBIOSIndex, raidBBUIndex=raidBBUIndex, raidVDDiskCachePolicy=raidVDDiskCachePolicy, postLogDatetime=postLogDatetime)
