...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidVDId=raidVDId, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDModel=raidPDModel, postLogEntry=postLogEntry, ueccLogDatetime=ueccLogDatetime, cpuLogDatetime=cpuLogDatetime, raidAdapterId_VD=raidAdapterId_VD, raidAdapterVendorId=raidAdapterVendorId, trapChassisIntrusion=trapChassisIntrusion, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDEncryptionType=raidVDEncryptionType, memDeviceLocator=memDeviceLocator, trapCpuFaultWarning=trapCpuFaultWarning, diskTable=diskTable, ueccLogIndex=ueccLogIndex, raidBBUTable=raidBBUTable, cpuMaxSpeed=cpuMaxSpeed, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDSpanDepth=raidVDSpanDepth, raidAdapterId_BBU=raidAdapterId_BBU, postLogIndex=postLogIndex, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDBadBlocksExist=raidVDBadBlocksExist, cpuSocketDesignation=cpuSocketDesignation, postLogTable=postLogTable, raidVDIndex=raidVDIndex, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidVDName=raidVDName, memEntry=memEntry, cpuCoreCount=cpuCoreCount, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDDiskCachePolicy=raidVDDiskCachePolicy, osName=osName, sysBIOSTable=sysBIOSTable, cpuLogInfo=cpuLogInfo, raidPDSpan=raidPDSpan, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDOtherErrorCount=raidPDOtherErrorCount, diskSmartStatus=diskSmartStatus, cpuCurrentSpeed=cpuCurrentSpeed, raidVDState=raidVDState, sysBIOSVersion=sysBIOSVersion, raidPDEntry=raidPDEntry, sd5Entry=sd5Entry, raidAdapterIndex=raidAdapterIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidIsBBUAbsent=raidIsBBUAbsent, trapBbpStatusCritical=trapBbpStatusCritical, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, mbSerialNumber=mbSerialNumber, osEntry=osEntry, raidVDSupportT10Power=raidVDSupportT10Power, raidVDStripSize=raidVDStripSize, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, memSerialNumber=memSerialNumber, raidPDPredFailCount=raidPDPredFailCount, trapBatteryStatusNormal=trapBatteryStatusNormal, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memErrorCount=memErrorCount, memLabeledBank=memLabeledBank, trapMemoryCeccWarning=trapMemoryCeccWarning, cpuName=cpuName, cpuIndex=cpuIndex, mbProductName=mbProductName, sd5Table=sd5Table, osTable=osTable, raidVDMirrorDataSize=raidVDMirrorDataSize, cpuEntry=cpuEntry, osManufacturer=osManufacturer, sysBIOSReleaseDate=sysBIOSReleaseDate, trapGenericCritical=trapGenericCritical, osIndex=osIndex, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidDiskGroupId_PD=raidDiskGroupId_PD, raidAdapterId=raidAdapterId, raidDiskGroupId=raidDiskGroupId, raidPDAllinoneStatus=raidPDAllinoneStatus, raidBBUStatus=raidBBUStatus, raidPDWriteCache=raidPDWriteCache, cpuDeviceVersion=cpuDeviceVersion, mbAssetTag=mbAssetTag, cpuManufacturer=cpuManufacturer, ueccLogTable=ueccLogTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidPDInquiryData=raidPDInquiryData, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDEntry=raidVDEntry, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, memUECCErrorCount=memUECCErrorCount, raidPDTable=raidPDTable, cpuDeviceStatus=cpuDeviceStatus, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidAdapterEntry=raidAdapterEntry, raidPDPort1Status=raidPDPort1Status, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDTable=raidVDTable, ceccLogEntry=ceccLogEntry, smSuperDoctor5MIB=smSuperDoctor5MIB, diskInterfaceType=diskInterfaceType, osSerialNumber=osSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, memDataWidth=memDataWidth, trapTemperatureNormal=trapTemperatureNormal, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapPowerSupplyWarning=trapPowerSupplyWarning, trapGenericWarning=trapGenericWarning, diskController=diskController, diskName=diskName, raidAdapterId_PD=raidAdapterId_PD, raidVDRaidLevel=raidVDRaidLevel, memECCErrorCount=memECCErrorCount, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterSerialNumber=raidAdapterSerialNumber, trapVoltageCritical=trapVoltageCritical, cpuCoreEnabled=cpuCoreEnabled, memTable=memTable, mbIndex=mbIndex, mbVersionName=mbVersionName, raidVDCached=raidVDCached, raidPDPort0Linkspeed=raidPDPort0Linkspeed, memModel=memModel, raidPDIndex=raidPDIndex, trapFanWarning=trapFanWarning, memTag=memTag, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuDeviceID=cpuDeviceID, osVersion=osVersion, diskMediaType=diskMediaType, trapVoltageNormal=trapVoltageNormal, diskSize=diskSize, ceccLogIndex=ceccLogIndex, ceccLogDatetime=ceccLogDatetime, ueccLogInfo=ueccLogInfo, raidPDNCQSetting=raidPDNCQSetting, smSD5TrapMIB=smSD5TrapMIB, cpuID=cpuID, raidPDSlotNumber=raidPDSlotNumber, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDAllinoneStatus=raidVDAllinoneStatus, dmiLogTable=dmiLogTable, trapMemoryUeccNormal=trapMemoryUeccNormal, diskSlotID=diskSlotID, cpuDescription=cpuDescription, sd5MIBVersion=sd5MIBVersion, postLogInfo=postLogInfo, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDDeviceSpeed=raidPDDeviceSpeed, trapFanCritical=trapFanCritical, raidPDSerialNumber=raidPDSerialNumber, raidAdapterGroup_PD=raidAdapterGroup_PD, trapCpuFaultCritical=trapCpuFaultCritical, sysBIOSEntry=sysBIOSEntry, ueccLogEntry=ueccLogEntry, trapFanNormal=trapFanNormal, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidAdapterGroup=raidAdapterGroup, raidVDSize=raidVDSize, raidPDAllinoneMsg=raidPDAllinoneMsg, trapPowerSupplyNormal=trapPowerSupplyNormal, trapPowerSupplyCritical=trapPowerSupplyCritical, trapTemperatureCritical=trapTemperatureCritical, mbManufacturer=mbManufacturer, trapBbpStatusWarning=trapBbpStatusWarning, raidVDTargetId=raidVDTargetId, sd5Idx=sd5Idx, raidPDRawSize=raidPDRawSize, diskEntry=diskEntry, trapBbpStatusNormal=trapBbpStatusNormal, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuLoadingPercentage=cpuLoadingPercentage, cpuLogTable=cpuLogTable, memManufacturer=memManufacturer, memPartNumber=memPartNumber, diskSerialNumber=diskSerialNumber, memDeviceStatus=memDeviceStatus, diskModel=diskModel, raidBBUEntry=raidBBUEntry, ceccLogTable=ceccLogTable, sysBIOSManufacturer=sysBIOSManufacturer, memTotalWidth=memTotalWidth, raidPDFirmwareState=raidPDFirmwareState, postLogDatetime=postLogDatetime, diskVendor=diskVendor, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDMediaType=raidPDMediaType, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapCpuFaultNormal=trapCpuFaultNormal, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDMediaErrorCount=raidPDMediaErrorCount, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDLinkSpeed=raidPDLinkSpeed, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sd5Version=sd5Version, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDPort0Status=raidPDPort0Status, sysBIOSIndex=sysBIOSIndex, raidVDNumDrives=raidVDNumDrives, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDOpProgress=raidPDOpProgress, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapGenericNormal=trapGenericNormal, cpuThreadCount=cpuThreadCount, trapVoltageWarning=trapVoltageWarning, memDescription=memDescription, cpuTable=cpuTable, osCSDVersion=osCSDVersion, mbTable=mbTable, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDFirmwareRevision=raidPDFirmwareRevision, raidBBUIndex=raidBBUIndex, trapTemperatureWarning=trapTemperatureWarning, raidAdapterTable=raidAdapterTable, memCapacity=memCapacity, cpuLogEntry=cpuLogEntry, cpuLogIndex=cpuLogIndex, raidAdapterProductName=raidAdapterProductName, raidVDSupportsMaxPS=raidVDSupportsMaxPS, ceccLogInfo=ceccLogInfo, raidPDDeviceFwLevel=raidPDDeviceFwLevel, mbEntry=mbEntry)
