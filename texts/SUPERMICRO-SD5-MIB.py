...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidPDInquiryData=raidPDInquiryData, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, diskSerialNumber=diskSerialNumber, raidVDTable=raidVDTable, trapBbpStatusCritical=trapBbpStatusCritical, mbEntry=mbEntry, memECCErrorCount=memECCErrorCount, memUECCErrorCount=memUECCErrorCount, raidAdapterId_VD=raidAdapterId_VD, trapFanWarning=trapFanWarning, memSerialNumber=memSerialNumber, osTable=osTable, raidPDMediaType=raidPDMediaType, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDPredFailCount=raidPDPredFailCount, raidAdapterId=raidAdapterId, mbVersionName=mbVersionName, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDPort0Status=raidPDPort0Status, sd5Idx=sd5Idx, trapCpuFaultWarning=trapCpuFaultWarning, raidAdapterIndex=raidAdapterIndex, diskMediaType=diskMediaType, osEntry=osEntry, trapGenericWarning=trapGenericWarning, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidBBUTable=raidBBUTable, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDSupportsMaxPS=raidVDSupportsMaxPS, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, cpuID=cpuID, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuThreadCount=cpuThreadCount, raidPDRawSize=raidPDRawSize, raidPDDeviceFwLevel=raidPDDeviceFwLevel, ceccLogIndex=ceccLogIndex, raidAdapterProductName=raidAdapterProductName, raidAdapterTable=raidAdapterTable, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDTargetId=raidVDTargetId, memTotalWidth=memTotalWidth, diskTable=diskTable, cpuLogDatetime=cpuLogDatetime, raidVDRaidLevel=raidVDRaidLevel, memLabeledBank=memLabeledBank, raidAdapterSubVendorId=raidAdapterSubVendorId, raidAdapterBIOSVersion=raidAdapterBIOSVersion, osCSDVersion=osCSDVersion, memModel=memModel, osManufacturer=osManufacturer, memTable=memTable, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDSerialNumber=raidPDSerialNumber, osSerialNumber=osSerialNumber, trapBbpStatusNormal=trapBbpStatusNormal, cpuLogIndex=cpuLogIndex, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidIsBBUAbsent=raidIsBBUAbsent, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidAdapterGroup=raidAdapterGroup, trapPowerSupplyWarning=trapPowerSupplyWarning, diskName=diskName, raidVDSize=raidVDSize, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDEncryptionType=raidVDEncryptionType, postLogInfo=postLogInfo, osName=osName, ceccLogDatetime=ceccLogDatetime, raidVDBadBlocksExist=raidVDBadBlocksExist, sd5Entry=sd5Entry, mbTable=mbTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, sd5Version=sd5Version, cpuName=cpuName, cpuIndex=cpuIndex, sysBIOSReleaseDate=sysBIOSReleaseDate, raidVDState=raidVDState, raidPDIndex=raidPDIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, trapVoltageCritical=trapVoltageCritical, trapChassisIntrusionCleared=trapChassisIntrusionCleared, sysBIOSTable=sysBIOSTable, ueccLogTable=ueccLogTable, raidPDAllinoneStatus=raidPDAllinoneStatus, sd5MIBVersion=sd5MIBVersion, cpuMaxSpeed=cpuMaxSpeed, sysBIOSVersion=sysBIOSVersion, ceccLogTable=ceccLogTable, raidPDOpProgress=raidPDOpProgress, trapTemperatureNormal=trapTemperatureNormal, sd5Table=sd5Table, diskSlotID=diskSlotID, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterFWVersion=raidAdapterFWVersion, raidDiskGroupId=raidDiskGroupId, memCapacity=memCapacity, raidBBUIndex=raidBBUIndex, trapTemperatureCritical=trapTemperatureCritical, cpuDescription=cpuDescription, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDName=raidVDName, cpuDeviceID=cpuDeviceID, ueccLogDatetime=ueccLogDatetime, ceccLogInfo=ceccLogInfo, ueccLogIndex=ueccLogIndex, ueccLogEntry=ueccLogEntry, memPartNumber=memPartNumber, memDataWidth=memDataWidth, raidDiskGroupId_PD=raidDiskGroupId_PD, mbManufacturer=mbManufacturer, diskVendor=diskVendor, raidVDId=raidVDId, raidBBUStatus=raidBBUStatus, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapCpuFaultNormal=trapCpuFaultNormal, raidPDEntry=raidPDEntry, dmiLogTable=dmiLogTable, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDSlotNumber=raidPDSlotNumber, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDPort1Status=raidPDPort1Status, raidAdapterEntry=raidAdapterEntry, osIndex=osIndex, raidVDCached=raidVDCached, diskController=diskController, diskSize=diskSize, cpuCoreCount=cpuCoreCount, memEntry=memEntry, trapTemperatureWarning=trapTemperatureWarning, memManufacturer=memManufacturer, ueccLogInfo=ueccLogInfo, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sysBIOSManufacturer=sysBIOSManufacturer, raidAdapterId_BBU=raidAdapterId_BBU, memErrorCount=memErrorCount, mbAssetTag=mbAssetTag, trapVoltageWarning=trapVoltageWarning, diskModel=diskModel, raidPDNCQSetting=raidPDNCQSetting, postLogIndex=postLogIndex, diskSmartStatus=diskSmartStatus, raidPDAllinoneMsg=raidPDAllinoneMsg, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapPowerSupplyCritical=trapPowerSupplyCritical, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, sysBIOSEntry=sysBIOSEntry, cpuLogTable=cpuLogTable, raidPDPort0Linkspeed=raidPDPort0Linkspeed, cpuLogInfo=cpuLogInfo, memDeviceStatus=memDeviceStatus, raidAdapterSerialNumber=raidAdapterSerialNumber, raidVDIndex=raidVDIndex, raidAdapterId_PD=raidAdapterId_PD, trapBbpStatusWarning=trapBbpStatusWarning, raidAdapterDeviceId=raidAdapterDeviceId, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDFirmwareState=raidPDFirmwareState, cpuTable=cpuTable, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuCurrentSpeed=cpuCurrentSpeed, raidVDSpanDepth=raidVDSpanDepth, cpuCoreEnabled=cpuCoreEnabled, ceccLogEntry=ceccLogEntry, trapVoltageNormal=trapVoltageNormal, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapChassisIntrusion=trapChassisIntrusion, raidPDOtherErrorCount=raidPDOtherErrorCount, raidAdapterGroup_PD=raidAdapterGroup_PD, trapFanNormal=trapFanNormal, cpuDeviceStatus=cpuDeviceStatus, diskInterfaceType=diskInterfaceType, raidPDTable=raidPDTable, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDSupportT10Power=raidVDSupportT10Power, raidBBUAllinoneStatus=raidBBUAllinoneStatus, osVersion=osVersion, memDeviceLocator=memDeviceLocator, cpuDeviceVersion=cpuDeviceVersion, cpuManufacturer=cpuManufacturer, raidPDSpan=raidPDSpan, raidPDWriteCache=raidPDWriteCache, trapGenericCritical=trapGenericCritical, trapGenericNormal=trapGenericNormal, raidAdapterGroup_BBU=raidAdapterGroup_BBU, mbSerialNumber=mbSerialNumber, cpuLogEntry=cpuLogEntry, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapBatteryStatusWarning=trapBatteryStatusWarning, memTag=memTag, diskEntry=diskEntry, trapFanCritical=trapFanCritical, cpuSocketDesignation=cpuSocketDesignation, smSD5TrapMIB=smSD5TrapMIB, cpuEntry=cpuEntry, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, postLogEntry=postLogEntry, postLogTable=postLogTable, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDEntry=raidVDEntry, postLogDatetime=postLogDatetime, mbIndex=mbIndex, raidPDMediaErrorCount=raidPDMediaErrorCount, sysBIOSIndex=sysBIOSIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, raidBBUEntry=raidBBUEntry, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuLoadingPercentage=cpuLoadingPercentage, raidAdapterVendorId=raidAdapterVendorId, raidVDNumDrives=raidVDNumDrives, raidVDStripSize=raidVDStripSize, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, mbProductName=mbProductName, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDModel=raidPDModel, trapCpuFaultCritical=trapCpuFaultCritical, raidPDLinkSpeed=raidPDLinkSpeed, memDescription=memDescription)
