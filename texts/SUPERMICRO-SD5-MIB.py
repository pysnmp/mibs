...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", osEntry=osEntry, memUECCErrorCount=memUECCErrorCount, raidDiskGroupId=raidDiskGroupId, raidAdapterId_BBU=raidAdapterId_BBU, cpuName=cpuName, cpuDescription=cpuDescription, raidVDAllinoneStatus=raidVDAllinoneStatus, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDModel=raidPDModel, raidVDEntry=raidVDEntry, smSD5TrapMIB=smSD5TrapMIB, trapTemperatureWarning=trapTemperatureWarning, trapVoltageWarning=trapVoltageWarning, diskMediaType=diskMediaType, trapBatteryStatusWarning=trapBatteryStatusWarning, memTag=memTag, cpuMaxSpeed=cpuMaxSpeed, cpuThreadCount=cpuThreadCount, cpuID=cpuID, raidVDSupportT10Power=raidVDSupportT10Power, trapChassisIntrusion=trapChassisIntrusion, cpuSocketDesignation=cpuSocketDesignation, postLogDatetime=postLogDatetime, trapBatteryStatusCritical=trapBatteryStatusCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuCurrentSpeed=cpuCurrentSpeed, raidVDAllinoneMsg=raidVDAllinoneMsg, trapMemoryUeccNormal=trapMemoryUeccNormal, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidAdapterEntry=raidAdapterEntry, raidIsBBUAbsent=raidIsBBUAbsent, cpuLogInfo=cpuLogInfo, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidVDEncryptionType=raidVDEncryptionType, memLabeledBank=memLabeledBank, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDTable=raidVDTable, memDeviceLocator=memDeviceLocator, raidVDTargetId=raidVDTargetId, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, memPartNumber=memPartNumber, cpuDeviceID=cpuDeviceID, raidBBUEntry=raidBBUEntry, ueccLogInfo=ueccLogInfo, sd5Table=sd5Table, trapBbpStatusCritical=trapBbpStatusCritical, cpuLogEntry=cpuLogEntry, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, mbAssetTag=mbAssetTag, raidPDOpProgress=raidPDOpProgress, sd5Entry=sd5Entry, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, osSerialNumber=osSerialNumber, raidVDState=raidVDState, cpuIndex=cpuIndex, memCapacity=memCapacity, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapFanCritical=trapFanCritical, postLogEntry=postLogEntry, raidAdapterGroup=raidAdapterGroup, trapBatteryStatusNormal=trapBatteryStatusNormal, memErrorCount=memErrorCount, trapGenericCritical=trapGenericCritical, raidPDNCQSetting=raidPDNCQSetting, raidVDMirrorDataSize=raidVDMirrorDataSize, sd5Version=sd5Version, diskVendor=diskVendor, cpuCoreCount=cpuCoreCount, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidVDNumDrives=raidVDNumDrives, trapGenericNormal=trapGenericNormal, raidPDWriteCache=raidPDWriteCache, trapMemoryUeccWarning=trapMemoryUeccWarning, diskName=diskName, raidAdapterId_VD=raidAdapterId_VD, ceccLogIndex=ceccLogIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, memTable=memTable, raidVDRaidLevel=raidVDRaidLevel, memECCErrorCount=memECCErrorCount, raidPDPredFailCount=raidPDPredFailCount, raidPDPort0Status=raidPDPort0Status, trapFanNormal=trapFanNormal, sysBIOSVersion=sysBIOSVersion, memModel=memModel, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapPowerSupplyWarning=trapPowerSupplyWarning, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapVoltageNormal=trapVoltageNormal, raidPDFirmwareState=raidPDFirmwareState, cpuEntry=cpuEntry, cpuLoadingPercentage=cpuLoadingPercentage, mbManufacturer=mbManufacturer, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDName=raidVDName, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDSize=raidVDSize, trapGenericWarning=trapGenericWarning, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDOtherErrorCount=raidPDOtherErrorCount, mbSerialNumber=mbSerialNumber, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, mbEntry=mbEntry, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapPowerSupplyNormal=trapPowerSupplyNormal, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDAllinoneMsg=raidPDAllinoneMsg, diskEntry=diskEntry, raidPDLinkSpeed=raidPDLinkSpeed, memDeviceStatus=memDeviceStatus, raidPDEntry=raidPDEntry, cpuCoreEnabled=cpuCoreEnabled, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterProductName=raidAdapterProductName, mbIndex=mbIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, postLogIndex=postLogIndex, raidVDIndex=raidVDIndex, raidPDSpan=raidPDSpan, trapTemperatureNormal=trapTemperatureNormal, sysBIOSIndex=sysBIOSIndex, raidBBUIndex=raidBBUIndex, memSerialNumber=memSerialNumber, raidAdapterIndex=raidAdapterIndex, ceccLogInfo=ceccLogInfo, diskModel=diskModel, raidPDInquiryData=raidPDInquiryData, raidBBUStatus=raidBBUStatus, sysBIOSReleaseDate=sysBIOSReleaseDate, trapTemperatureCritical=trapTemperatureCritical, raidPDIndex=raidPDIndex, ueccLogDatetime=ueccLogDatetime, trapPowerSupplyCritical=trapPowerSupplyCritical, diskTable=diskTable, mbProductName=mbProductName, osTable=osTable, raidAdapterDeviceId=raidAdapterDeviceId, raidBBUAllinoneMsg=raidBBUAllinoneMsg, trapCpuFaultCritical=trapCpuFaultCritical, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidVDId=raidVDId, cpuTable=cpuTable, osCSDVersion=osCSDVersion, raidVDBadBlocksExist=raidVDBadBlocksExist, trapBbpStatusNormal=trapBbpStatusNormal, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapBbpStatusWarning=trapBbpStatusWarning, smSuperDoctor5MIB=smSuperDoctor5MIB, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuDeviceStatus=cpuDeviceStatus, mbVersionName=mbVersionName, ueccLogEntry=ueccLogEntry, sysBIOSTable=sysBIOSTable, sd5Idx=sd5Idx, raidAdapterSerialNumber=raidAdapterSerialNumber, sysBIOSEntry=sysBIOSEntry, ueccLogIndex=ueccLogIndex, raidBBUTable=raidBBUTable, raidAdapterId=raidAdapterId, raidVDSpanDepth=raidVDSpanDepth, raidPDDeviceFwLevel=raidPDDeviceFwLevel, sd5MIBVersion=sd5MIBVersion, cpuDeviceVersion=cpuDeviceVersion, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, osVersion=osVersion, trapCpuFaultNormal=trapCpuFaultNormal, memTotalWidth=memTotalWidth, raidPDSerialNumber=raidPDSerialNumber, trapMemoryCeccWarning=trapMemoryCeccWarning, ueccLogTable=ueccLogTable, dmiLogTable=dmiLogTable, raidPDRawSize=raidPDRawSize, diskSmartStatus=diskSmartStatus, mbTable=mbTable, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuLogDatetime=cpuLogDatetime, trapFanWarning=trapFanWarning, memEntry=memEntry, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDStripSize=raidVDStripSize, trapVoltageCritical=trapVoltageCritical, diskSerialNumber=diskSerialNumber, raidAdapterGroup_VD=raidAdapterGroup_VD, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, diskInterfaceType=diskInterfaceType, raidVDCached=raidVDCached, raidAdapterVendorId=raidAdapterVendorId, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, osIndex=osIndex, memDescription=memDescription, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterId_PD=raidAdapterId_PD, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDPort1Status=raidPDPort1Status, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDMediaType=raidPDMediaType, cpuManufacturer=cpuManufacturer, ceccLogDatetime=ceccLogDatetime, osName=osName, raidPDSlotNumber=raidPDSlotNumber, raidPDDeviceSpeed=raidPDDeviceSpeed, diskController=diskController, cpuLogIndex=cpuLogIndex, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuLogTable=cpuLogTable, raidPDPort0Linkspeed=raidPDPort0Linkspeed, osManufacturer=osManufacturer, raidAdapterSubDeviceId=raidAdapterSubDeviceId, memManufacturer=memManufacturer, ceccLogEntry=ceccLogEntry, postLogTable=postLogTable, postLogInfo=postLogInfo, raidAdapterTable=raidAdapterTable, memDataWidth=memDataWidth, trapCpuFaultWarning=trapCpuFaultWarning, ceccLogTable=ceccLogTable, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, diskSlotID=diskSlotID, raidPDTable=raidPDTable, diskSize=diskSize, sysBIOSManufacturer=sysBIOSManufacturer)
