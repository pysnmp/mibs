...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memPartNumber=memPartNumber, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterDeviceId=raidAdapterDeviceId, trapMemoryUeccCritical=trapMemoryUeccCritical, diskVendor=diskVendor, trapVoltageNormal=trapVoltageNormal, memEntry=memEntry, sysBIOSVersion=sysBIOSVersion, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, mbVersionName=mbVersionName, cpuLogEntry=cpuLogEntry, raidPDModel=raidPDModel, raidPDLinkSpeed=raidPDLinkSpeed, memCapacity=memCapacity, osTable=osTable, diskEntry=diskEntry, raidBBUIndex=raidBBUIndex, raidPDWriteCache=raidPDWriteCache, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDState=raidVDState, cpuName=cpuName, raidAdapterId_VD=raidAdapterId_VD, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapPowerSupplyWarning=trapPowerSupplyWarning, memDeviceStatus=memDeviceStatus, smSuperDoctor5MIB=smSuperDoctor5MIB, memECCErrorCount=memECCErrorCount, trapVoltageWarning=trapVoltageWarning, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ceccLogInfo=ceccLogInfo, raidPDOtherErrorCount=raidPDOtherErrorCount, mbIndex=mbIndex, trapVoltageCritical=trapVoltageCritical, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDFirmwareState=raidPDFirmwareState, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDEntry=raidPDEntry, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDNCQSetting=raidPDNCQSetting, cpuLoadingPercentage=cpuLoadingPercentage, memManufacturer=memManufacturer, diskSlotID=diskSlotID, mbManufacturer=mbManufacturer, mbTable=mbTable, dmiLogTable=dmiLogTable, ueccLogTable=ueccLogTable, postLogDatetime=postLogDatetime, sysBIOSManufacturer=sysBIOSManufacturer, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuSocketDesignation=cpuSocketDesignation, trapCpuFaultWarning=trapCpuFaultWarning, raidAdapterGroup=raidAdapterGroup, trapCpuFaultCritical=trapCpuFaultCritical, osIndex=osIndex, memDeviceLocator=memDeviceLocator, raidVDSpanDepth=raidVDSpanDepth, memTag=memTag, raidVDEncryptionType=raidVDEncryptionType, cpuDeviceVersion=cpuDeviceVersion, memDataWidth=memDataWidth, memSerialNumber=memSerialNumber, trapTemperatureNormal=trapTemperatureNormal, raidPDMediaType=raidPDMediaType, raidVDRaidLevel=raidVDRaidLevel, raidAdapterId_PD=raidAdapterId_PD, postLogEntry=postLogEntry, sysBIOSTable=sysBIOSTable, trapTemperatureCritical=trapTemperatureCritical, trapBbpStatusNormal=trapBbpStatusNormal, cpuLogDatetime=cpuLogDatetime, raidVDTargetId=raidVDTargetId, PYSNMP_MODULE_ID=smSuperDoctor5MIB, osName=osName, trapFanWarning=trapFanWarning, smSD5TrapMIB=smSD5TrapMIB, trapCpuFaultNormal=trapCpuFaultNormal, cpuID=cpuID, diskSmartStatus=diskSmartStatus, raidVDSize=raidVDSize, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuIndex=cpuIndex, sd5Entry=sd5Entry, diskController=diskController, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapGenericWarning=trapGenericWarning, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, osEntry=osEntry, cpuLogInfo=cpuLogInfo, raidVDEntry=raidVDEntry, raidBBUEntry=raidBBUEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapPowerSupplyNormal=trapPowerSupplyNormal, memUECCErrorCount=memUECCErrorCount, diskMediaType=diskMediaType, raidPDTable=raidPDTable, raidVDNumDrives=raidVDNumDrives, sd5Idx=sd5Idx, mbProductName=mbProductName, raidVDTable=raidVDTable, trapBbpStatusWarning=trapBbpStatusWarning, raidVDId=raidVDId, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDOpProgress=raidPDOpProgress, trapBbpStatusCritical=trapBbpStatusCritical, trapGenericCritical=trapGenericCritical, diskSize=diskSize, trapBatteryStatusNormal=trapBatteryStatusNormal, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDPort1Status=raidPDPort1Status, raidPDPort0Status=raidPDPort0Status, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDIndex=raidPDIndex, trapBatteryStatusWarning=trapBatteryStatusWarning, raidPDSerialNumber=raidPDSerialNumber, mbAssetTag=mbAssetTag, memLabeledBank=memLabeledBank, raidPDSpan=raidPDSpan, cpuThreadCount=cpuThreadCount, cpuDeviceID=cpuDeviceID, ueccLogDatetime=ueccLogDatetime, cpuLogIndex=cpuLogIndex, sysBIOSEntry=sysBIOSEntry, raidAdapterId=raidAdapterId, sd5MIBVersion=sd5MIBVersion, trapFanCritical=trapFanCritical, ceccLogEntry=ceccLogEntry, raidAdapterSerialNumber=raidAdapterSerialNumber, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, cpuTable=cpuTable, trapChassisIntrusion=trapChassisIntrusion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDAllinoneStatus=raidPDAllinoneStatus, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDFirmwareRevision=raidPDFirmwareRevision, cpuMaxSpeed=cpuMaxSpeed, diskInterfaceType=diskInterfaceType, mbEntry=mbEntry, raidAdapterTable=raidAdapterTable, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, cpuManufacturer=cpuManufacturer, trapTemperatureWarning=trapTemperatureWarning, raidPDSlotNumber=raidPDSlotNumber, ueccLogIndex=ueccLogIndex, raidPDRawSize=raidPDRawSize, ceccLogDatetime=ceccLogDatetime, trapMemoryUeccWarning=trapMemoryUeccWarning, raidBBUAllinoneMsg=raidBBUAllinoneMsg, cpuDeviceStatus=cpuDeviceStatus, raidVDDiskCachePolicy=raidVDDiskCachePolicy, mbSerialNumber=mbSerialNumber, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDIndex=raidVDIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidVDAllinoneStatus=raidVDAllinoneStatus, cpuEntry=cpuEntry, memDescription=memDescription, raidBBUTable=raidBBUTable, raidBBUStatus=raidBBUStatus, raidAdapterIndex=raidAdapterIndex, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDSupportT10Power=raidVDSupportT10Power, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, memTotalWidth=memTotalWidth, osVersion=osVersion, memErrorCount=memErrorCount, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDName=raidVDName, diskName=diskName, memTable=memTable, postLogIndex=postLogIndex, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDAllinoneMsg=raidPDAllinoneMsg, raidAdapterSubVendorId=raidAdapterSubVendorId, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuCoreEnabled=cpuCoreEnabled, sysBIOSIndex=sysBIOSIndex, ueccLogEntry=ueccLogEntry, postLogTable=postLogTable, raidAdapterEntry=raidAdapterEntry, raidIsBBUAbsent=raidIsBBUAbsent, raidVDCached=raidVDCached, diskSerialNumber=diskSerialNumber, diskModel=diskModel, osSerialNumber=osSerialNumber, memModel=memModel, raidPDInquiryData=raidPDInquiryData, trapFanNormal=trapFanNormal, ueccLogInfo=ueccLogInfo, trapMemoryCeccWarning=trapMemoryCeccWarning, sysBIOSReleaseDate=sysBIOSReleaseDate, ceccLogTable=ceccLogTable, raidPDPredFailCount=raidPDPredFailCount, sd5Table=sd5Table, raidVDStripSize=raidVDStripSize, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuLogTable=cpuLogTable, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterVendorId=raidAdapterVendorId, diskTable=diskTable, raidDiskGroupId=raidDiskGroupId, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapGenericNormal=trapGenericNormal, osCSDVersion=osCSDVersion, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterProductName=raidAdapterProductName, cpuDescription=cpuDescription, cpuCoreCount=cpuCoreCount, sd5Version=sd5Version, postLogInfo=postLogInfo, raidVDBadBlocksExist=raidVDBadBlocksExist, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuCurrentSpeed=cpuCurrentSpeed, ceccLogIndex=ceccLogIndex, raidPDMediaErrorCount=raidPDMediaErrorCount, osManufacturer=osManufacturer)
