...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memTotalWidth=memTotalWidth, cpuLogIndex=cpuLogIndex, raidVDEncryptionType=raidVDEncryptionType, cpuDeviceStatus=cpuDeviceStatus, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, mbManufacturer=mbManufacturer, trapBbpStatusWarning=trapBbpStatusWarning, trapCpuFaultCritical=trapCpuFaultCritical, cpuCurrentSpeed=cpuCurrentSpeed, postLogIndex=postLogIndex, ueccLogEntry=ueccLogEntry, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, memSerialNumber=memSerialNumber, raidPDEntry=raidPDEntry, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDRaidLevel=raidVDRaidLevel, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterId_BBU=raidAdapterId_BBU, memECCErrorCount=memECCErrorCount, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDLinkSpeed=raidPDLinkSpeed, memModel=memModel, cpuMaxSpeed=cpuMaxSpeed, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, mbProductName=mbProductName, cpuCoreCount=cpuCoreCount, ueccLogDatetime=ueccLogDatetime, trapFanWarning=trapFanWarning, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidAdapterId_VD=raidAdapterId_VD, memPartNumber=memPartNumber, mbIndex=mbIndex, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memLabeledBank=memLabeledBank, trapMemoryUeccWarning=trapMemoryUeccWarning, raidVDCached=raidVDCached, raidIsBBUAbsent=raidIsBBUAbsent, raidBBUIndex=raidBBUIndex, cpuLogInfo=cpuLogInfo, raidVDName=raidVDName, sysBIOSIndex=sysBIOSIndex, trapGenericWarning=trapGenericWarning, raidVDNumDrives=raidVDNumDrives, diskSerialNumber=diskSerialNumber, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDId=raidVDId, raidVDEntry=raidVDEntry, cpuIndex=cpuIndex, ceccLogEntry=ceccLogEntry, memManufacturer=memManufacturer, raidAdapterProductName=raidAdapterProductName, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, mbVersionName=mbVersionName, diskInterfaceType=diskInterfaceType, ueccLogInfo=ueccLogInfo, raidPDPort0Status=raidPDPort0Status, memUECCErrorCount=memUECCErrorCount, trapMemoryCeccCritical=trapMemoryCeccCritical, raidBBUTable=raidBBUTable, memErrorCount=memErrorCount, raidPDFirmwareRevision=raidPDFirmwareRevision, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuCoreEnabled=cpuCoreEnabled, sysBIOSEntry=sysBIOSEntry, diskMediaType=diskMediaType, raidPDNCQSetting=raidPDNCQSetting, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDSupportsMaxPS=raidVDSupportsMaxPS, diskVendor=diskVendor, trapChassisIntrusionCleared=trapChassisIntrusionCleared, sysBIOSVersion=sysBIOSVersion, raidAdapterIndex=raidAdapterIndex, trapCpuFaultNormal=trapCpuFaultNormal, diskSlotID=diskSlotID, raidPDAllinoneMsg=raidPDAllinoneMsg, trapVoltageWarning=trapVoltageWarning, trapPowerSupplyWarning=trapPowerSupplyWarning, cpuEntry=cpuEntry, raidPDDeviceSpeed=raidPDDeviceSpeed, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, sd5Idx=sd5Idx, trapCpuFaultWarning=trapCpuFaultWarning, diskTable=diskTable, osCSDVersion=osCSDVersion, ceccLogTable=ceccLogTable, ceccLogDatetime=ceccLogDatetime, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDTable=raidVDTable, memDeviceStatus=memDeviceStatus, ceccLogInfo=ceccLogInfo, raidPDTable=raidPDTable, cpuLogDatetime=cpuLogDatetime, raidPDAllinoneStatus=raidPDAllinoneStatus, sysBIOSReleaseDate=sysBIOSReleaseDate, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuLogEntry=cpuLogEntry, raidPDSlotNumber=raidPDSlotNumber, memTag=memTag, raidPDOpProgress=raidPDOpProgress, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, memCapacity=memCapacity, cpuDeviceID=cpuDeviceID, diskSmartStatus=diskSmartStatus, raidPDPredFailCount=raidPDPredFailCount, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDSpanDepth=raidVDSpanDepth, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidVDSize=raidVDSize, cpuID=cpuID, postLogTable=postLogTable, raidPDModel=raidPDModel, trapBatteryStatusWarning=trapBatteryStatusWarning, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidAdapterGroup_PD=raidAdapterGroup_PD, trapFanNormal=trapFanNormal, raidDiskGroupId_PD=raidDiskGroupId_PD, trapChassisIntrusion=trapChassisIntrusion, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, cpuLogTable=cpuLogTable, raidPDWriteCache=raidPDWriteCache, trapBbpStatusNormal=trapBbpStatusNormal, cpuTable=cpuTable, smSD5TrapMIB=smSD5TrapMIB, sysBIOSTable=sysBIOSTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidAdapterId_PD=raidAdapterId_PD, trapPowerSupplyCritical=trapPowerSupplyCritical, cpuDeviceVersion=cpuDeviceVersion, trapGenericCritical=trapGenericCritical, memDataWidth=memDataWidth, mbEntry=mbEntry, osIndex=osIndex, trapVoltageNormal=trapVoltageNormal, diskSize=diskSize, raidAdapterId=raidAdapterId, raidVDSupportT10Power=raidVDSupportT10Power, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDSerialNumber=raidPDSerialNumber, ueccLogIndex=ueccLogIndex, raidPDInquiryData=raidPDInquiryData, memDescription=memDescription, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterEntry=raidAdapterEntry, raidVDMirrorDataSize=raidVDMirrorDataSize, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapVoltageCritical=trapVoltageCritical, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, sd5Entry=sd5Entry, raidBBUEntry=raidBBUEntry, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapBatteryStatusCritical=trapBatteryStatusCritical, diskEntry=diskEntry, diskName=diskName, osName=osName, cpuName=cpuName, postLogEntry=postLogEntry, postLogDatetime=postLogDatetime, sd5Version=sd5Version, raidAdapterTable=raidAdapterTable, raidDiskGroupId=raidDiskGroupId, trapFanCritical=trapFanCritical, osEntry=osEntry, raidPDSpan=raidPDSpan, raidAdapterFWVersion=raidAdapterFWVersion, sd5Table=sd5Table, trapPowerSupplyNormal=trapPowerSupplyNormal, memDeviceLocator=memDeviceLocator, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterSubVendorId=raidAdapterSubVendorId, trapGenericNormal=trapGenericNormal, diskModel=diskModel, memEntry=memEntry, mbAssetTag=mbAssetTag, osSerialNumber=osSerialNumber, mbSerialNumber=mbSerialNumber, raidAdapterGroup=raidAdapterGroup, raidVDStripSize=raidVDStripSize, sysBIOSManufacturer=sysBIOSManufacturer, raidPDMediaType=raidPDMediaType, cpuLoadingPercentage=cpuLoadingPercentage, diskController=diskController, osTable=osTable, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDFirmwareState=raidPDFirmwareState, trapBbpStatusCritical=trapBbpStatusCritical, sd5MIBVersion=sd5MIBVersion, ceccLogIndex=ceccLogIndex, raidPDDeviceFwLevel=raidPDDeviceFwLevel, osVersion=osVersion, mbTable=mbTable, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapTemperatureNormal=trapTemperatureNormal, raidPDPort1Status=raidPDPort1Status, raidVDAllinoneStatus=raidVDAllinoneStatus, smSuperDoctor5MIB=smSuperDoctor5MIB, memTable=memTable, postLogInfo=postLogInfo, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, cpuManufacturer=cpuManufacturer, raidVDState=raidVDState, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, dmiLogTable=dmiLogTable, raidAdapterDeviceId=raidAdapterDeviceId, raidVDTargetId=raidVDTargetId, raidPDRawSize=raidPDRawSize, cpuSocketDesignation=cpuSocketDesignation, raidAdapterVendorId=raidAdapterVendorId, raidPDMediaErrorCount=raidPDMediaErrorCount, trapTemperatureWarning=trapTemperatureWarning, cpuThreadCount=cpuThreadCount, ueccLogTable=ueccLogTable, raidPDIndex=raidPDIndex, cpuDescription=cpuDescription, raidVDBadBlocksExist=raidVDBadBlocksExist, raidBBUStatus=raidBBUStatus, raidVDIndex=raidVDIndex, osManufacturer=osManufacturer, raidPDOtherErrorCount=raidPDOtherErrorCount, trapTemperatureCritical=trapTemperatureCritical)
