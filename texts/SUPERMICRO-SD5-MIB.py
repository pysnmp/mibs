...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", smSD5TrapMIB=smSD5TrapMIB, diskInterfaceType=diskInterfaceType, smSuperDoctor5MIB=smSuperDoctor5MIB, sd5MIBVersion=sd5MIBVersion, cpuCurrentSpeed=cpuCurrentSpeed, osEntry=osEntry, osTable=osTable, raidPDPredFailCount=raidPDPredFailCount, raidPDIndex=raidPDIndex, memEntry=memEntry, ueccLogDatetime=ueccLogDatetime, cpuLogDatetime=cpuLogDatetime, cpuIndex=cpuIndex, memTable=memTable, memDeviceLocator=memDeviceLocator, raidPDNCQSetting=raidPDNCQSetting, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDSpanDepth=raidVDSpanDepth, trapMemoryUeccNormal=trapMemoryUeccNormal, trapGenericWarning=trapGenericWarning, diskSerialNumber=diskSerialNumber, ueccLogTable=ueccLogTable, mbTable=mbTable, trapVoltageWarning=trapVoltageWarning, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, trapCpuFaultCritical=trapCpuFaultCritical, ceccLogIndex=ceccLogIndex, diskTable=diskTable, cpuLogTable=cpuLogTable, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDId=raidVDId, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidAdapterSerialNumber=raidAdapterSerialNumber, memErrorCount=memErrorCount, memDataWidth=memDataWidth, trapVoltageNormal=trapVoltageNormal, raidAdapterBIOSVersion=raidAdapterBIOSVersion, diskSmartStatus=diskSmartStatus, trapGenericNormal=trapGenericNormal, sd5Idx=sd5Idx, cpuCoreEnabled=cpuCoreEnabled, raidIsBBUAbsent=raidIsBBUAbsent, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuTable=cpuTable, trapVoltageCritical=trapVoltageCritical, memPartNumber=memPartNumber, raidVDEntry=raidVDEntry, raidPDMediaType=raidPDMediaType, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDLinkSpeed=raidPDLinkSpeed, sd5Table=sd5Table, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuLogInfo=cpuLogInfo, cpuLogIndex=cpuLogIndex, trapCpuFaultWarning=trapCpuFaultWarning, memDescription=memDescription, memModel=memModel, raidVDNumDrives=raidVDNumDrives, ceccLogInfo=ceccLogInfo, raidPDDeviceSpeed=raidPDDeviceSpeed, raidBBUIndex=raidBBUIndex, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDInquiryData=raidPDInquiryData, trapGenericCritical=trapGenericCritical, trapBatteryStatusWarning=trapBatteryStatusWarning, sysBIOSTable=sysBIOSTable, trapBbpStatusWarning=trapBbpStatusWarning, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidVDCached=raidVDCached, postLogInfo=postLogInfo, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, ueccLogInfo=ueccLogInfo, cpuLoadingPercentage=cpuLoadingPercentage, mbAssetTag=mbAssetTag, raidDiskGroupId_PD=raidDiskGroupId_PD, memTag=memTag, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, diskEntry=diskEntry, raidVDSupportT10Power=raidVDSupportT10Power, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDPort1Status=raidPDPort1Status, memTotalWidth=memTotalWidth, cpuDeviceStatus=cpuDeviceStatus, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, diskSize=diskSize, raidVDTable=raidVDTable, sysBIOSIndex=sysBIOSIndex, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, diskName=diskName, trapBatteryStatusNormal=trapBatteryStatusNormal, trapCpuFaultNormal=trapCpuFaultNormal, raidAdapterSubVendorId=raidAdapterSubVendorId, dmiLogTable=dmiLogTable, memCapacity=memCapacity, trapPowerSupplyNormal=trapPowerSupplyNormal, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDDiskCachePolicy=raidVDDiskCachePolicy, osIndex=osIndex, memSerialNumber=memSerialNumber, cpuSocketDesignation=cpuSocketDesignation, memECCErrorCount=memECCErrorCount, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapTemperatureCritical=trapTemperatureCritical, trapMemoryUeccCritical=trapMemoryUeccCritical, osCSDVersion=osCSDVersion, osName=osName, raidPDPort0Status=raidPDPort0Status, trapMemoryCeccWarning=trapMemoryCeccWarning, raidBBUAllinoneStatus=raidBBUAllinoneStatus, ueccLogIndex=ueccLogIndex, diskVendor=diskVendor, ueccLogEntry=ueccLogEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuLogEntry=cpuLogEntry, raidBBUTable=raidBBUTable, mbEntry=mbEntry, raidBBUStatus=raidBBUStatus, raidPDOtherErrorCount=raidPDOtherErrorCount, osManufacturer=osManufacturer, trapTemperatureNormal=trapTemperatureNormal, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterGroup_PD=raidAdapterGroup_PD, trapFanWarning=trapFanWarning, raidPDSlotNumber=raidPDSlotNumber, raidAdapterEntry=raidAdapterEntry, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDModel=raidPDModel, raidPDFirmwareState=raidPDFirmwareState, raidAdapterIndex=raidAdapterIndex, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDAllinoneStatus=raidVDAllinoneStatus, sd5Entry=sd5Entry, raidPDFirmwareRevision=raidPDFirmwareRevision, raidPDOpProgress=raidPDOpProgress, trapPowerSupplyCritical=trapPowerSupplyCritical, postLogDatetime=postLogDatetime, trapBbpStatusCritical=trapBbpStatusCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ceccLogDatetime=ceccLogDatetime, memManufacturer=memManufacturer, raidAdapterId_VD=raidAdapterId_VD, raidPDTable=raidPDTable, cpuMaxSpeed=cpuMaxSpeed, postLogTable=postLogTable, raidPDSerialNumber=raidPDSerialNumber, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapPowerSupplyWarning=trapPowerSupplyWarning, raidAdapterTable=raidAdapterTable, raidPDPort0Linkspeed=raidPDPort0Linkspeed, diskSlotID=diskSlotID, ceccLogTable=ceccLogTable, sd5Version=sd5Version, diskMediaType=diskMediaType, memUECCErrorCount=memUECCErrorCount, raidAdapterProductName=raidAdapterProductName, postLogIndex=postLogIndex, raidVDRaidLevel=raidVDRaidLevel, trapFanCritical=trapFanCritical, raidVDEncryptionType=raidVDEncryptionType, mbSerialNumber=mbSerialNumber, sysBIOSVersion=sysBIOSVersion, sysBIOSManufacturer=sysBIOSManufacturer, raidPDWriteCache=raidPDWriteCache, mbProductName=mbProductName, raidAdapterId_PD=raidAdapterId_PD, raidVDState=raidVDState, raidDiskGroupId=raidDiskGroupId, raidPDAllinoneMsg=raidPDAllinoneMsg, osSerialNumber=osSerialNumber, raidVDSize=raidVDSize, mbManufacturer=mbManufacturer, cpuName=cpuName, trapChassisIntrusion=trapChassisIntrusion, sysBIOSEntry=sysBIOSEntry, diskModel=diskModel, raidAdapterVendorId=raidAdapterVendorId, raidBBUEntry=raidBBUEntry, raidVDName=raidVDName, cpuManufacturer=cpuManufacturer, raidVDIndex=raidVDIndex, ceccLogEntry=ceccLogEntry, raidAdapterId=raidAdapterId, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuCoreCount=cpuCoreCount, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDRawSize=raidPDRawSize, cpuThreadCount=cpuThreadCount, raidVDStripSize=raidVDStripSize, trapFanNormal=trapFanNormal, cpuDescription=cpuDescription, mbVersionName=mbVersionName, raidAdapterGroup=raidAdapterGroup, memDeviceStatus=memDeviceStatus, cpuDeviceVersion=cpuDeviceVersion, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, diskController=diskController, raidAdapterId_BBU=raidAdapterId_BBU, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memLabeledBank=memLabeledBank, cpuID=cpuID, trapTemperatureWarning=trapTemperatureWarning, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapBbpStatusNormal=trapBbpStatusNormal, raidAdapterDeviceId=raidAdapterDeviceId, raidVDTargetId=raidVDTargetId, cpuDeviceID=cpuDeviceID, postLogEntry=postLogEntry, raidPDEntry=raidPDEntry, cpuEntry=cpuEntry, raidAdapterFWVersion=raidAdapterFWVersion, mbIndex=mbIndex, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sysBIOSReleaseDate=sysBIOSReleaseDate, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, osVersion=osVersion, raidPDSpan=raidPDSpan, raidVDBadBlocksExist=raidVDBadBlocksExist)
