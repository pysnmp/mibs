...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", sd5Version=sd5Version, cpuManufacturer=cpuManufacturer, ceccLogIndex=ceccLogIndex, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDDeviceSpeed=raidPDDeviceSpeed, mbEntry=mbEntry, memDeviceStatus=memDeviceStatus, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDLinkSpeed=raidPDLinkSpeed, trapTemperatureNormal=trapTemperatureNormal, trapFanCritical=trapFanCritical, cpuTable=cpuTable, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapCpuFaultCritical=trapCpuFaultCritical, memDescription=memDescription, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDInquiryData=raidPDInquiryData, ceccLogEntry=ceccLogEntry, postLogDatetime=postLogDatetime, diskSlotID=diskSlotID, osTable=osTable, raidPDRawSize=raidPDRawSize, raidBBUStatus=raidBBUStatus, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memPartNumber=memPartNumber, sd5MIBVersion=sd5MIBVersion, raidVDNumDrives=raidVDNumDrives, ueccLogIndex=ueccLogIndex, cpuCurrentSpeed=cpuCurrentSpeed, dmiLogTable=dmiLogTable, mbSerialNumber=mbSerialNumber, raidBBUEntry=raidBBUEntry, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapPowerSupplyCritical=trapPowerSupplyCritical, mbManufacturer=mbManufacturer, trapFanWarning=trapFanWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDMediaType=raidPDMediaType, mbVersionName=mbVersionName, raidVDSupportT10Power=raidVDSupportT10Power, trapCpuFaultNormal=trapCpuFaultNormal, sd5Table=sd5Table, mbTable=mbTable, raidAdapterProductName=raidAdapterProductName, diskEntry=diskEntry, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapVoltageNormal=trapVoltageNormal, raidPDSerialNumber=raidPDSerialNumber, raidVDAllinoneMsg=raidVDAllinoneMsg, trapGenericNormal=trapGenericNormal, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidVDName=raidVDName, raidPDWriteCache=raidPDWriteCache, postLogEntry=postLogEntry, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, sysBIOSManufacturer=sysBIOSManufacturer, sysBIOSIndex=sysBIOSIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDStripSize=raidVDStripSize, ceccLogDatetime=ceccLogDatetime, ueccLogInfo=ueccLogInfo, cpuDescription=cpuDescription, raidAdapterVendorId=raidAdapterVendorId, mbAssetTag=mbAssetTag, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterGroup_BBU=raidAdapterGroup_BBU, smSD5TrapMIB=smSD5TrapMIB, trapMemoryCeccWarning=trapMemoryCeccWarning, trapGenericCritical=trapGenericCritical, trapChassisIntrusion=trapChassisIntrusion, osManufacturer=osManufacturer, PYSNMP_MODULE_ID=smSuperDoctor5MIB, memECCErrorCount=memECCErrorCount, sysBIOSReleaseDate=sysBIOSReleaseDate, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDMediaErrorCount=raidPDMediaErrorCount, raidPDModel=raidPDModel, sd5Idx=sd5Idx, cpuDeviceID=cpuDeviceID, raidBBUAllinoneStatus=raidBBUAllinoneStatus, diskInterfaceType=diskInterfaceType, cpuDeviceVersion=cpuDeviceVersion, cpuLogTable=cpuLogTable, cpuCoreEnabled=cpuCoreEnabled, raidVDId=raidVDId, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memModel=memModel, raidAdapterSerialNumber=raidAdapterSerialNumber, cpuLogIndex=cpuLogIndex, raidPDEntry=raidPDEntry, diskName=diskName, raidPDAllinoneStatus=raidPDAllinoneStatus, postLogIndex=postLogIndex, raidVDRaidLevel=raidVDRaidLevel, raidPDSpan=raidPDSpan, sd5Entry=sd5Entry, raidDiskGroupId=raidDiskGroupId, raidAdapterId_VD=raidAdapterId_VD, raidPDOpProgress=raidPDOpProgress, memEntry=memEntry, raidPDPort1Status=raidPDPort1Status, raidBBUTable=raidBBUTable, sysBIOSVersion=sysBIOSVersion, raidBBUIndex=raidBBUIndex, memDeviceLocator=memDeviceLocator, memErrorCount=memErrorCount, diskSize=diskSize, raidPDFirmwareState=raidPDFirmwareState, trapBbpStatusCritical=trapBbpStatusCritical, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuName=cpuName, trapMemoryUeccWarning=trapMemoryUeccWarning, trapVoltageCritical=trapVoltageCritical, raidVDEncryptionType=raidVDEncryptionType, raidVDDiskCachePolicy=raidVDDiskCachePolicy, cpuSocketDesignation=cpuSocketDesignation, memManufacturer=memManufacturer, osVersion=osVersion, osEntry=osEntry, raidVDIndex=raidVDIndex, osName=osName, memTable=memTable, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuEntry=cpuEntry, ceccLogInfo=ceccLogInfo, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDFirmwareRevision=raidPDFirmwareRevision, raidPDTable=raidPDTable, postLogTable=postLogTable, raidAdapterDeviceId=raidAdapterDeviceId, cpuIndex=cpuIndex, diskSerialNumber=diskSerialNumber, trapBatteryStatusWarning=trapBatteryStatusWarning, raidPDIndex=raidPDIndex, diskVendor=diskVendor, cpuMaxSpeed=cpuMaxSpeed, mbProductName=mbProductName, raidAdapterId_BBU=raidAdapterId_BBU, cpuLoadingPercentage=cpuLoadingPercentage, diskModel=diskModel, cpuThreadCount=cpuThreadCount, raidAdapterId=raidAdapterId, raidVDMirrorDataSize=raidVDMirrorDataSize, sysBIOSTable=sysBIOSTable, trapGenericWarning=trapGenericWarning, smSuperDoctor5MIB=smSuperDoctor5MIB, osIndex=osIndex, trapTemperatureWarning=trapTemperatureWarning, cpuCoreCount=cpuCoreCount, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidAdapterEntry=raidAdapterEntry, raidAdapterIndex=raidAdapterIndex, ceccLogTable=ceccLogTable, trapFanNormal=trapFanNormal, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterId_PD=raidAdapterId_PD, raidVDAllinoneStatus=raidVDAllinoneStatus, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDSlotNumber=raidPDSlotNumber, cpuLogDatetime=cpuLogDatetime, memLabeledBank=memLabeledBank, raidVDSize=raidVDSize, raidVDState=raidVDState, cpuDeviceStatus=cpuDeviceStatus, cpuID=cpuID, raidDiskGroupId_PD=raidDiskGroupId_PD, trapBbpStatusNormal=trapBbpStatusNormal, mbIndex=mbIndex, ueccLogEntry=ueccLogEntry, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapTemperatureCritical=trapTemperatureCritical, memSerialNumber=memSerialNumber, cpuLogEntry=cpuLogEntry, memTag=memTag, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, diskTable=diskTable, memUECCErrorCount=memUECCErrorCount, ueccLogTable=ueccLogTable, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterGroup_VD=raidAdapterGroup_VD, diskSmartStatus=diskSmartStatus, trapVoltageWarning=trapVoltageWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidVDCached=raidVDCached, raidPDPort0Status=raidPDPort0Status, memCapacity=memCapacity, cpuLogInfo=cpuLogInfo, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterGroup=raidAdapterGroup, raidPDPredFailCount=raidPDPredFailCount, postLogInfo=postLogInfo, raidAdapterTable=raidAdapterTable, diskMediaType=diskMediaType, raidVDBadBlocksExist=raidVDBadBlocksExist, trapPowerSupplyNormal=trapPowerSupplyNormal, trapCpuFaultWarning=trapCpuFaultWarning, memTotalWidth=memTotalWidth, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapPowerSupplyWarning=trapPowerSupplyWarning, osCSDVersion=osCSDVersion, raidAdapterFWVersion=raidAdapterFWVersion, raidVDEntry=raidVDEntry, diskController=diskController, osSerialNumber=osSerialNumber, raidVDSpanDepth=raidVDSpanDepth, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDTable=raidVDTable, raidAdapterGroup_PD=raidAdapterGroup_PD, trapMemoryCeccCritical=trapMemoryCeccCritical, sysBIOSEntry=sysBIOSEntry, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, trapBbpStatusWarning=trapBbpStatusWarning, raidVDTargetId=raidVDTargetId, raidPDNCQSetting=raidPDNCQSetting, ueccLogDatetime=ueccLogDatetime, memDataWidth=memDataWidth)
