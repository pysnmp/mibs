...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidVDNumDrives=raidVDNumDrives, trapCpuFaultWarning=trapCpuFaultWarning, trapFanWarning=trapFanWarning, cpuDescription=cpuDescription, raidAdapterId=raidAdapterId, ueccLogInfo=ueccLogInfo, cpuLogInfo=cpuLogInfo, trapVoltageCritical=trapVoltageCritical, sysBIOSTable=sysBIOSTable, trapMemoryUeccCritical=trapMemoryUeccCritical, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapCpuFaultCritical=trapCpuFaultCritical, cpuDeviceVersion=cpuDeviceVersion, trapCpuFaultNormal=trapCpuFaultNormal, trapTemperatureNormal=trapTemperatureNormal, raidAdapterDeviceId=raidAdapterDeviceId, raidVDName=raidVDName, diskEntry=diskEntry, sd5MIBVersion=sd5MIBVersion, dmiLogTable=dmiLogTable, raidVDTargetId=raidVDTargetId, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterSubDeviceId=raidAdapterSubDeviceId, mbManufacturer=mbManufacturer, trapPowerSupplyNormal=trapPowerSupplyNormal, memECCErrorCount=memECCErrorCount, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sysBIOSManufacturer=sysBIOSManufacturer, raidPDDeviceFwLevel=raidPDDeviceFwLevel, mbProductName=mbProductName, raidPDTable=raidPDTable, raidPDEntry=raidPDEntry, raidVDEncryptionType=raidVDEncryptionType, diskTable=diskTable, raidPDMediaErrorCount=raidPDMediaErrorCount, trapBbpStatusWarning=trapBbpStatusWarning, osVersion=osVersion, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDPort1Status=raidPDPort1Status, cpuSocketDesignation=cpuSocketDesignation, raidAdapterFWVersion=raidAdapterFWVersion, raidVDIndex=raidVDIndex, raidVDAllinoneMsg=raidVDAllinoneMsg, diskModel=diskModel, diskInterfaceType=diskInterfaceType, raidVDEntry=raidVDEntry, raidPDSerialNumber=raidPDSerialNumber, cpuEntry=cpuEntry, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapFanCritical=trapFanCritical, mbVersionName=mbVersionName, memTag=memTag, trapGenericCritical=trapGenericCritical, ceccLogInfo=ceccLogInfo, sd5Entry=sd5Entry, cpuDeviceID=cpuDeviceID, ueccLogDatetime=ueccLogDatetime, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memErrorCount=memErrorCount, memUECCErrorCount=memUECCErrorCount, trapFanNormal=trapFanNormal, raidVDTable=raidVDTable, cpuTable=cpuTable, raidVDMirrorDataSize=raidVDMirrorDataSize, trapPowerSupplyWarning=trapPowerSupplyWarning, raidBBUEntry=raidBBUEntry, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskSmartStatus=diskSmartStatus, sd5Idx=sd5Idx, memTable=memTable, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDIndex=raidPDIndex, cpuLogTable=cpuLogTable, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDRawSize=raidPDRawSize, memDataWidth=memDataWidth, memTotalWidth=memTotalWidth, diskSize=diskSize, raidPDSlotNumber=raidPDSlotNumber, raidVDId=raidVDId, smSD5TrapMIB=smSD5TrapMIB, trapVoltageNormal=trapVoltageNormal, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidVDBadBlocksExist=raidVDBadBlocksExist, raidPDInquiryData=raidPDInquiryData, trapMemoryCeccWarning=trapMemoryCeccWarning, mbEntry=mbEntry, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapChassisIntrusionCleared=trapChassisIntrusionCleared, postLogIndex=postLogIndex, cpuCoreCount=cpuCoreCount, mbSerialNumber=mbSerialNumber, memDescription=memDescription, memManufacturer=memManufacturer, osCSDVersion=osCSDVersion, postLogDatetime=postLogDatetime, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDMediaType=raidPDMediaType, raidBBUAllinoneStatus=raidBBUAllinoneStatus, cpuThreadCount=cpuThreadCount, raidDiskGroupId_PD=raidDiskGroupId_PD, ueccLogEntry=ueccLogEntry, diskSerialNumber=diskSerialNumber, memCapacity=memCapacity, osIndex=osIndex, ueccLogTable=ueccLogTable, cpuCoreEnabled=cpuCoreEnabled, sysBIOSEntry=sysBIOSEntry, raidAdapterGroup_VD=raidAdapterGroup_VD, ueccLogIndex=ueccLogIndex, sysBIOSReleaseDate=sysBIOSReleaseDate, diskSlotID=diskSlotID, trapGenericWarning=trapGenericWarning, mbIndex=mbIndex, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterTable=raidAdapterTable, trapMemoryCeccCritical=trapMemoryCeccCritical, diskController=diskController, ceccLogDatetime=ceccLogDatetime, smSuperDoctor5MIB=smSuperDoctor5MIB, sysBIOSIndex=sysBIOSIndex, postLogEntry=postLogEntry, raidPDFirmwareRevision=raidPDFirmwareRevision, diskName=diskName, raidPDAllinoneStatus=raidPDAllinoneStatus, cpuDeviceStatus=cpuDeviceStatus, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, ceccLogTable=ceccLogTable, cpuLogEntry=cpuLogEntry, raidVDSize=raidVDSize, raidBBUTable=raidBBUTable, trapTemperatureCritical=trapTemperatureCritical, cpuMaxSpeed=cpuMaxSpeed, cpuName=cpuName, raidVDSupportT10Power=raidVDSupportT10Power, cpuID=cpuID, diskMediaType=diskMediaType, osName=osName, cpuLogIndex=cpuLogIndex, ceccLogEntry=ceccLogEntry, raidAdapterEntry=raidAdapterEntry, raidAdapterId_BBU=raidAdapterId_BBU, trapMemoryUeccNormal=trapMemoryUeccNormal, trapBatteryStatusWarning=trapBatteryStatusWarning, sd5Table=sd5Table, raidVDCached=raidVDCached, raidAdapterGroup=raidAdapterGroup, raidPDPort0Status=raidPDPort0Status, trapVoltageWarning=trapVoltageWarning, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidIsBBUAbsent=raidIsBBUAbsent, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, diskVendor=diskVendor, memSerialNumber=memSerialNumber, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidVDState=raidVDState, raidVDSpanDepth=raidVDSpanDepth, memLabeledBank=memLabeledBank, memEntry=memEntry, raidPDPredFailCount=raidPDPredFailCount, cpuCurrentSpeed=cpuCurrentSpeed, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDNCQSetting=raidPDNCQSetting, raidPDModel=raidPDModel, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, postLogTable=postLogTable, raidVDStripSize=raidVDStripSize, osTable=osTable, raidBBUStatus=raidBBUStatus, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterProductName=raidAdapterProductName, trapBbpStatusNormal=trapBbpStatusNormal, raidPDOpProgress=raidPDOpProgress, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, memDeviceStatus=memDeviceStatus, raidPDSpan=raidPDSpan, raidPDWriteCache=raidPDWriteCache, osSerialNumber=osSerialNumber, raidDiskGroupId=raidDiskGroupId, raidVDRaidLevel=raidVDRaidLevel, raidPDDeviceSpeed=raidPDDeviceSpeed, raidAdapterIndex=raidAdapterIndex, trapBatteryStatusNormal=trapBatteryStatusNormal, ceccLogIndex=ceccLogIndex, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memPartNumber=memPartNumber, raidAdapterSubVendorId=raidAdapterSubVendorId, raidAdapterId_VD=raidAdapterId_VD, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapGenericNormal=trapGenericNormal, postLogInfo=postLogInfo, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDFirmwareState=raidPDFirmwareState, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterSerialNumber=raidAdapterSerialNumber, trapMemoryUeccWarning=trapMemoryUeccWarning, memDeviceLocator=memDeviceLocator, cpuLoadingPercentage=cpuLoadingPercentage, mbTable=mbTable, raidAdapterVendorId=raidAdapterVendorId, cpuManufacturer=cpuManufacturer, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDLinkSpeed=raidPDLinkSpeed, trapBbpStatusCritical=trapBbpStatusCritical, osManufacturer=osManufacturer, cpuLogDatetime=cpuLogDatetime, raidAdapterGroup_PD=raidAdapterGroup_PD, sysBIOSVersion=sysBIOSVersion, raidAdapterId_PD=raidAdapterId_PD, cpuIndex=cpuIndex, trapTemperatureWarning=trapTemperatureWarning, osEntry=osEntry, mbAssetTag=mbAssetTag, trapChassisIntrusion=trapChassisIntrusion, raidBBUIndex=raidBBUIndex, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, sd5Version=sd5Version, memModel=memModel)
