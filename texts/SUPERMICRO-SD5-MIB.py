...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", osSerialNumber=osSerialNumber, cpuLogTable=cpuLogTable, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, diskSize=diskSize, raidPDDeviceSpeed=raidPDDeviceSpeed, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapTemperatureWarning=trapTemperatureWarning, trapCpuFaultWarning=trapCpuFaultWarning, trapFanCritical=trapFanCritical, raidPDPort0Status=raidPDPort0Status, postLogInfo=postLogInfo, sysBIOSManufacturer=sysBIOSManufacturer, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidVDSupportT10Power=raidVDSupportT10Power, cpuMaxSpeed=cpuMaxSpeed, osIndex=osIndex, cpuTable=cpuTable, diskTable=diskTable, trapFanWarning=trapFanWarning, raidAdapterDeviceId=raidAdapterDeviceId, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapGenericWarning=trapGenericWarning, mbTable=mbTable, memManufacturer=memManufacturer, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDIndex=raidVDIndex, diskVendor=diskVendor, raidAdapterProductName=raidAdapterProductName, trapPowerSupplyCritical=trapPowerSupplyCritical, memPartNumber=memPartNumber, cpuDeviceID=cpuDeviceID, memErrorCount=memErrorCount, raidPDInquiryData=raidPDInquiryData, raidVDEntry=raidVDEntry, cpuLogIndex=cpuLogIndex, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterId_PD=raidAdapterId_PD, cpuDeviceVersion=cpuDeviceVersion, sd5Idx=sd5Idx, osManufacturer=osManufacturer, memModel=memModel, diskModel=diskModel, memDescription=memDescription, memECCErrorCount=memECCErrorCount, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDPredFailCount=raidPDPredFailCount, sd5Table=sd5Table, mbVersionName=mbVersionName, postLogIndex=postLogIndex, sd5Entry=sd5Entry, memDataWidth=memDataWidth, trapFanNormal=trapFanNormal, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDSpanDepth=raidVDSpanDepth, cpuDescription=cpuDescription, mbSerialNumber=mbSerialNumber, raidVDAllinoneMsg=raidVDAllinoneMsg, diskEntry=diskEntry, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, sysBIOSVersion=sysBIOSVersion, raidAdapterId=raidAdapterId, raidBBUStatus=raidBBUStatus, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDId=raidVDId, trapBbpStatusWarning=trapBbpStatusWarning, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDSize=raidVDSize, raidPDMediaType=raidPDMediaType, cpuCoreCount=cpuCoreCount, mbIndex=mbIndex, osTable=osTable, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, osEntry=osEntry, diskSerialNumber=diskSerialNumber, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterGroup_PD=raidAdapterGroup_PD, trapPowerSupplyNormal=trapPowerSupplyNormal, osCSDVersion=osCSDVersion, raidDiskGroupId=raidDiskGroupId, cpuSocketDesignation=cpuSocketDesignation, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memEntry=memEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, trapMemoryUeccWarning=trapMemoryUeccWarning, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapVoltageWarning=trapVoltageWarning, trapCpuFaultNormal=trapCpuFaultNormal, trapBatteryStatusWarning=trapBatteryStatusWarning, trapMemoryCeccWarning=trapMemoryCeccWarning, memCapacity=memCapacity, raidVDEncryptionType=raidVDEncryptionType, ceccLogTable=ceccLogTable, trapChassisIntrusion=trapChassisIntrusion, diskMediaType=diskMediaType, raidPDMediaErrorCount=raidPDMediaErrorCount, memSerialNumber=memSerialNumber, trapBatteryStatusCritical=trapBatteryStatusCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuCurrentSpeed=cpuCurrentSpeed, memUECCErrorCount=memUECCErrorCount, cpuIndex=cpuIndex, raidVDRaidLevel=raidVDRaidLevel, postLogEntry=postLogEntry, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, osVersion=osVersion, raidAdapterVendorId=raidAdapterVendorId, cpuID=cpuID, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDStripSize=raidVDStripSize, sysBIOSReleaseDate=sysBIOSReleaseDate, trapVoltageNormal=trapVoltageNormal, trapCpuFaultCritical=trapCpuFaultCritical, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDAllinoneStatus=raidPDAllinoneStatus, trapGenericCritical=trapGenericCritical, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapVoltageCritical=trapVoltageCritical, diskSlotID=diskSlotID, ceccLogDatetime=ceccLogDatetime, memTag=memTag, cpuLoadingPercentage=cpuLoadingPercentage, cpuLogDatetime=cpuLogDatetime, raidPDLinkSpeed=raidPDLinkSpeed, postLogTable=postLogTable, raidAdapterTable=raidAdapterTable, trapTemperatureCritical=trapTemperatureCritical, raidPDSerialNumber=raidPDSerialNumber, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDSpan=raidPDSpan, raidDiskGroupId_PD=raidDiskGroupId_PD, trapTemperatureNormal=trapTemperatureNormal, raidAdapterBIOSVersion=raidAdapterBIOSVersion, cpuDeviceStatus=cpuDeviceStatus, raidAdapterIndex=raidAdapterIndex, memTable=memTable, memDeviceLocator=memDeviceLocator, trapPowerSupplyWarning=trapPowerSupplyWarning, diskSmartStatus=diskSmartStatus, diskController=diskController, sd5Version=sd5Version, mbManufacturer=mbManufacturer, raidBBUEntry=raidBBUEntry, raidAdapterId_VD=raidAdapterId_VD, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDWriteCache=raidPDWriteCache, cpuEntry=cpuEntry, ueccLogInfo=ueccLogInfo, raidAdapterEntry=raidAdapterEntry, raidPDPort1Status=raidPDPort1Status, trapMemoryCeccCritical=trapMemoryCeccCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapBbpStatusCritical=trapBbpStatusCritical, cpuName=cpuName, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDPort0Linkspeed=raidPDPort0Linkspeed, dmiLogTable=dmiLogTable, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidIsBBUAbsent=raidIsBBUAbsent, memTotalWidth=memTotalWidth, raidPDEntry=raidPDEntry, raidPDTable=raidPDTable, raidVDNumDrives=raidVDNumDrives, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuThreadCount=cpuThreadCount, raidAdapterSerialNumber=raidAdapterSerialNumber, raidBBUIndex=raidBBUIndex, raidPDModel=raidPDModel, memDeviceStatus=memDeviceStatus, trapGenericNormal=trapGenericNormal, trapBbpStatusNormal=trapBbpStatusNormal, sysBIOSTable=sysBIOSTable, diskInterfaceType=diskInterfaceType, cpuManufacturer=cpuManufacturer, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDIndex=raidPDIndex, raidPDFirmwareRevision=raidPDFirmwareRevision, trapMemoryUeccNormal=trapMemoryUeccNormal, mbEntry=mbEntry, ueccLogDatetime=ueccLogDatetime, raidPDFirmwareState=raidPDFirmwareState, ceccLogInfo=ceccLogInfo, sysBIOSIndex=sysBIOSIndex, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidAdapterGroup=raidAdapterGroup, ceccLogEntry=ceccLogEntry, smSD5TrapMIB=smSD5TrapMIB, cpuCoreEnabled=cpuCoreEnabled, memLabeledBank=memLabeledBank, mbProductName=mbProductName, raidVDTable=raidVDTable, raidPDRawSize=raidPDRawSize, ueccLogTable=ueccLogTable, ueccLogIndex=ueccLogIndex, raidBBUTable=raidBBUTable, raidPDSlotNumber=raidPDSlotNumber, raidPDNCQSetting=raidPDNCQSetting, ceccLogIndex=ceccLogIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, sysBIOSEntry=sysBIOSEntry, postLogDatetime=postLogDatetime, cpuLogInfo=cpuLogInfo, raidPDOpProgress=raidPDOpProgress, raidVDCached=raidVDCached, trapChassisIntrusionCleared=trapChassisIntrusionCleared, sd5MIBVersion=sd5MIBVersion, raidVDState=raidVDState, raidVDName=raidVDName, ueccLogEntry=ueccLogEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, osName=osName, diskName=diskName, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDTargetId=raidVDTargetId, raidPDAllinoneMsg=raidPDAllinoneMsg, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidAdapterFWVersion=raidAdapterFWVersion, cpuLogEntry=cpuLogEntry, mbAssetTag=mbAssetTag)
