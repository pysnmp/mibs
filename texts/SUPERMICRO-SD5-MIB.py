...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", sysBIOSIndex=sysBIOSIndex, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterGroup_PD=raidAdapterGroup_PD, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapFanCritical=trapFanCritical, raidPDMediaType=raidPDMediaType, raidPDTable=raidPDTable, diskModel=diskModel, raidPDOpProgress=raidPDOpProgress, cpuSocketDesignation=cpuSocketDesignation, sysBIOSManufacturer=sysBIOSManufacturer, sysBIOSVersion=sysBIOSVersion, memSerialNumber=memSerialNumber, cpuDeviceStatus=cpuDeviceStatus, diskController=diskController, diskSlotID=diskSlotID, trapGenericNormal=trapGenericNormal, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDSize=raidVDSize, mbManufacturer=mbManufacturer, memModel=memModel, sysBIOSEntry=sysBIOSEntry, mbTable=mbTable, osManufacturer=osManufacturer, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDOtherErrorCount=raidPDOtherErrorCount, cpuCoreCount=cpuCoreCount, trapTemperatureWarning=trapTemperatureWarning, raidVDRaidLevel=raidVDRaidLevel, raidPDPort1Linkspeed=raidPDPort1Linkspeed, trapChassisIntrusion=trapChassisIntrusion, memDescription=memDescription, osEntry=osEntry, raidVDSpanDepth=raidVDSpanDepth, sd5Table=sd5Table, mbEntry=mbEntry, raidPDPredFailCount=raidPDPredFailCount, osName=osName, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuIndex=cpuIndex, sd5Idx=sd5Idx, memDeviceLocator=memDeviceLocator, trapCpuFaultWarning=trapCpuFaultWarning, trapCpuFaultNormal=trapCpuFaultNormal, postLogDatetime=postLogDatetime, raidPDSpan=raidPDSpan, cpuLogTable=cpuLogTable, trapGenericWarning=trapGenericWarning, raidVDState=raidVDState, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDIndex=raidPDIndex, diskVendor=diskVendor, raidPDMediaErrorCount=raidPDMediaErrorCount, raidBBUStatus=raidBBUStatus, raidBBUTable=raidBBUTable, raidAdapterId_PD=raidAdapterId_PD, trapBbpStatusNormal=trapBbpStatusNormal, raidPDModel=raidPDModel, memPartNumber=memPartNumber, postLogIndex=postLogIndex, trapGenericCritical=trapGenericCritical, raidVDNumDrives=raidVDNumDrives, cpuEntry=cpuEntry, sysBIOSReleaseDate=sysBIOSReleaseDate, trapMemoryCeccCritical=trapMemoryCeccCritical, diskEntry=diskEntry, raidPDDeviceSpeed=raidPDDeviceSpeed, dmiLogTable=dmiLogTable, sysBIOSTable=sysBIOSTable, mbSerialNumber=mbSerialNumber, raidDiskGroupId_PD=raidDiskGroupId_PD, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDEntry=raidVDEntry, mbProductName=mbProductName, ceccLogInfo=ceccLogInfo, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapTemperatureNormal=trapTemperatureNormal, raidVDIndex=raidVDIndex, osCSDVersion=osCSDVersion, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidPDPort0Status=raidPDPort0Status, memECCErrorCount=memECCErrorCount, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDMirrorDataSize=raidVDMirrorDataSize, trapPowerSupplyNormal=trapPowerSupplyNormal, memTag=memTag, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memDeviceStatus=memDeviceStatus, diskSize=diskSize, ceccLogDatetime=ceccLogDatetime, raidVDStripSize=raidVDStripSize, osTable=osTable, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDEncryptionType=raidVDEncryptionType, diskSmartStatus=diskSmartStatus, raidPDEntry=raidPDEntry, raidAdapterTable=raidAdapterTable, cpuLogEntry=cpuLogEntry, cpuTable=cpuTable, memErrorCount=memErrorCount, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapFanWarning=trapFanWarning, cpuMaxSpeed=cpuMaxSpeed, raidAdapterProductName=raidAdapterProductName, trapTemperatureCritical=trapTemperatureCritical, trapFanNormal=trapFanNormal, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDWriteCache=raidPDWriteCache, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapBbpStatusCritical=trapBbpStatusCritical, raidVDDiskCachePolicy=raidVDDiskCachePolicy, memLabeledBank=memLabeledBank, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuDescription=cpuDescription, raidPDSerialNumber=raidPDSerialNumber, raidBBUIndex=raidBBUIndex, raidVDTargetId=raidVDTargetId, sd5Version=sd5Version, raidBBUAllinoneMsg=raidBBUAllinoneMsg, ceccLogIndex=ceccLogIndex, cpuDeviceVersion=cpuDeviceVersion, ueccLogTable=ueccLogTable, trapPowerSupplyCritical=trapPowerSupplyCritical, osVersion=osVersion, memDataWidth=memDataWidth, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDAllinoneStatus=raidPDAllinoneStatus, cpuCurrentSpeed=cpuCurrentSpeed, raidPDNCQSetting=raidPDNCQSetting, memTable=memTable, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidVDBadBlocksExist=raidVDBadBlocksExist, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidDiskGroupId=raidDiskGroupId, postLogEntry=postLogEntry, ueccLogInfo=ueccLogInfo, raidAdapterEntry=raidAdapterEntry, raidPDFirmwareState=raidPDFirmwareState, raidPDInquiryData=raidPDInquiryData, diskName=diskName, ueccLogDatetime=ueccLogDatetime, raidVDCached=raidVDCached, osSerialNumber=osSerialNumber, raidAdapterDeviceId=raidAdapterDeviceId, mbAssetTag=mbAssetTag, sd5MIBVersion=sd5MIBVersion, raidAdapterIndex=raidAdapterIndex, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, mbVersionName=mbVersionName, raidVDSupportT10Power=raidVDSupportT10Power, trapPowerSupplyWarning=trapPowerSupplyWarning, trapMemoryUeccCritical=trapMemoryUeccCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, PYSNMP_MODULE_ID=smSuperDoctor5MIB, cpuLogDatetime=cpuLogDatetime, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapVoltageNormal=trapVoltageNormal, raidPDAllinoneMsg=raidPDAllinoneMsg, trapCpuFaultCritical=trapCpuFaultCritical, osIndex=osIndex, memManufacturer=memManufacturer, diskTable=diskTable, ceccLogTable=ceccLogTable, trapVoltageCritical=trapVoltageCritical, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidBBUEntry=raidBBUEntry, memUECCErrorCount=memUECCErrorCount, postLogInfo=postLogInfo, raidPDDeviceFwLevel=raidPDDeviceFwLevel, ueccLogIndex=ueccLogIndex, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDPort1Status=raidPDPort1Status, cpuID=cpuID, raidAdapterGroup=raidAdapterGroup, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidAdapterId_VD=raidAdapterId_VD, sd5Entry=sd5Entry, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuCoreEnabled=cpuCoreEnabled, cpuLogInfo=cpuLogInfo, ueccLogEntry=ueccLogEntry, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, memCapacity=memCapacity, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDSlotNumber=raidPDSlotNumber, cpuDeviceID=cpuDeviceID, raidVDAllinoneStatus=raidVDAllinoneStatus, memEntry=memEntry, ceccLogEntry=ceccLogEntry, postLogTable=postLogTable, cpuLoadingPercentage=cpuLoadingPercentage, trapBbpStatusWarning=trapBbpStatusWarning, diskMediaType=diskMediaType, raidVDTable=raidVDTable, raidVDName=raidVDName, raidAdapterFWVersion=raidAdapterFWVersion, cpuThreadCount=cpuThreadCount, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDRawSize=raidPDRawSize, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidAdapterVendorId=raidAdapterVendorId, trapBatteryStatusWarning=trapBatteryStatusWarning, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidAdapterId=raidAdapterId, diskSerialNumber=diskSerialNumber, raidVDId=raidVDId, smSuperDoctor5MIB=smSuperDoctor5MIB, cpuLogIndex=cpuLogIndex, trapMemoryCeccNormal=trapMemoryCeccNormal, trapMemoryUeccWarning=trapMemoryUeccWarning, diskInterfaceType=diskInterfaceType, cpuManufacturer=cpuManufacturer, mbIndex=mbIndex, memTotalWidth=memTotalWidth, smSD5TrapMIB=smSD5TrapMIB, cpuName=cpuName, trapVoltageWarning=trapVoltageWarning)
