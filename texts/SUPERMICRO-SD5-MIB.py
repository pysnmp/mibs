...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapBatteryStatusNormal=trapBatteryStatusNormal, trapFanCritical=trapFanCritical, raidPDPort0Status=raidPDPort0Status, osIndex=osIndex, cpuThreadCount=cpuThreadCount, diskName=diskName, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDOpProgress=raidPDOpProgress, cpuMaxSpeed=cpuMaxSpeed, raidVDMirrorDataSize=raidVDMirrorDataSize, cpuID=cpuID, memDeviceLocator=memDeviceLocator, trapCpuFaultNormal=trapCpuFaultNormal, raidIsBBUAbsent=raidIsBBUAbsent, postLogTable=postLogTable, trapFanNormal=trapFanNormal, memDeviceStatus=memDeviceStatus, postLogDatetime=postLogDatetime, trapVoltageCritical=trapVoltageCritical, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidVDEncryptionType=raidVDEncryptionType, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidBBUStatus=raidBBUStatus, raidVDAllinoneMsg=raidVDAllinoneMsg, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterId=raidAdapterId, trapTemperatureNormal=trapTemperatureNormal, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sd5Idx=sd5Idx, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidDiskGroupId=raidDiskGroupId, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDMediaType=raidPDMediaType, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterProductName=raidAdapterProductName, raidPDRawSize=raidPDRawSize, raidPDWriteCache=raidPDWriteCache, mbProductName=mbProductName, trapTemperatureWarning=trapTemperatureWarning, mbTable=mbTable, diskModel=diskModel, raidVDSpanDepth=raidVDSpanDepth, cpuLogTable=cpuLogTable, cpuLoadingPercentage=cpuLoadingPercentage, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapBatteryStatusWarning=trapBatteryStatusWarning, trapBbpStatusWarning=trapBbpStatusWarning, raidDiskGroupId_PD=raidDiskGroupId_PD, diskSerialNumber=diskSerialNumber, trapGenericNormal=trapGenericNormal, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDAllinoneMsg=raidPDAllinoneMsg, ceccLogTable=ceccLogTable, ueccLogInfo=ueccLogInfo, raidAdapterFWVersion=raidAdapterFWVersion, raidPDTable=raidPDTable, raidAdapterGroup=raidAdapterGroup, diskController=diskController, raidPDNCQSetting=raidPDNCQSetting, raidAdapterIndex=raidAdapterIndex, raidPDPort1Status=raidPDPort1Status, trapMemoryUeccWarning=trapMemoryUeccWarning, cpuDeviceID=cpuDeviceID, diskSlotID=diskSlotID, raidVDTargetId=raidVDTargetId, raidVDAllinoneStatus=raidVDAllinoneStatus, cpuCurrentSpeed=cpuCurrentSpeed, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterId_PD=raidAdapterId_PD, raidPDSlotNumber=raidPDSlotNumber, memECCErrorCount=memECCErrorCount, osVersion=osVersion, memTable=memTable, memDescription=memDescription, mbEntry=mbEntry, memLabeledBank=memLabeledBank, raidPDDeviceSpeed=raidPDDeviceSpeed, raidVDStripSize=raidVDStripSize, mbVersionName=mbVersionName, raidVDTable=raidVDTable, memDataWidth=memDataWidth, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDFirmwareState=raidPDFirmwareState, raidPDLinkSpeed=raidPDLinkSpeed, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuEntry=cpuEntry, raidAdapterVendorId=raidAdapterVendorId, PYSNMP_MODULE_ID=smSuperDoctor5MIB, ueccLogTable=ueccLogTable, cpuName=cpuName, osCSDVersion=osCSDVersion, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, sysBIOSManufacturer=sysBIOSManufacturer, trapFanWarning=trapFanWarning, raidPDSpan=raidPDSpan, sd5Entry=sd5Entry, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapBbpStatusCritical=trapBbpStatusCritical, trapPowerSupplyCritical=trapPowerSupplyCritical, mbAssetTag=mbAssetTag, cpuDescription=cpuDescription, sd5MIBVersion=sd5MIBVersion, cpuDeviceVersion=cpuDeviceVersion, diskInterfaceType=diskInterfaceType, raidAdapterId_BBU=raidAdapterId_BBU, raidVDCached=raidVDCached, raidPDInquiryData=raidPDInquiryData, memEntry=memEntry, diskTable=diskTable, trapMemoryUeccNormal=trapMemoryUeccNormal, memCapacity=memCapacity, raidAdapterId_VD=raidAdapterId_VD, trapGenericCritical=trapGenericCritical, cpuDeviceStatus=cpuDeviceStatus, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, osName=osName, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, memPartNumber=memPartNumber, raidPDModel=raidPDModel, postLogIndex=postLogIndex, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, osManufacturer=osManufacturer, trapGenericWarning=trapGenericWarning, memTag=memTag, memErrorCount=memErrorCount, ceccLogInfo=ceccLogInfo, raidAdapterTable=raidAdapterTable, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, diskMediaType=diskMediaType, sysBIOSVersion=sysBIOSVersion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDFirmwareRevision=raidPDFirmwareRevision, osTable=osTable, raidAdapterSerialNumber=raidAdapterSerialNumber, sysBIOSEntry=sysBIOSEntry, raidVDState=raidVDState, raidVDRaidLevel=raidVDRaidLevel, trapVoltageWarning=trapVoltageWarning, raidPDIndex=raidPDIndex, sd5Table=sd5Table, ceccLogIndex=ceccLogIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidVDName=raidVDName, trapTemperatureCritical=trapTemperatureCritical, memSerialNumber=memSerialNumber, mbIndex=mbIndex, memUECCErrorCount=memUECCErrorCount, sysBIOSReleaseDate=sysBIOSReleaseDate, raidBBUTable=raidBBUTable, raidVDId=raidVDId, raidPDPredFailCount=raidPDPredFailCount, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, diskSmartStatus=diskSmartStatus, raidPDPort0Linkspeed=raidPDPort0Linkspeed, osSerialNumber=osSerialNumber, cpuSocketDesignation=cpuSocketDesignation, smSD5TrapMIB=smSD5TrapMIB, trapVoltageNormal=trapVoltageNormal, trapCpuFaultCritical=trapCpuFaultCritical, cpuTable=cpuTable, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDEntry=raidVDEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, cpuIndex=cpuIndex, raidPDSerialNumber=raidPDSerialNumber, trapMemoryUeccCritical=trapMemoryUeccCritical, sd5Version=sd5Version, sysBIOSTable=sysBIOSTable, raidPDAllinoneStatus=raidPDAllinoneStatus, ueccLogDatetime=ueccLogDatetime, cpuCoreEnabled=cpuCoreEnabled, ueccLogEntry=ueccLogEntry, raidVDSize=raidVDSize, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidAdapterSubDeviceId=raidAdapterSubDeviceId, mbSerialNumber=mbSerialNumber, raidVDNumDrives=raidVDNumDrives, raidPDEntry=raidPDEntry, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuLogEntry=cpuLogEntry, mbManufacturer=mbManufacturer, ceccLogEntry=ceccLogEntry, raidAdapterEntry=raidAdapterEntry, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapChassisIntrusion=trapChassisIntrusion, cpuManufacturer=cpuManufacturer, raidVDSupportT10Power=raidVDSupportT10Power, memTotalWidth=memTotalWidth, raidVDIndex=raidVDIndex, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuLogIndex=cpuLogIndex, raidBBUIndex=raidBBUIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, sysBIOSIndex=sysBIOSIndex, trapPowerSupplyWarning=trapPowerSupplyWarning, ceccLogDatetime=ceccLogDatetime, postLogInfo=postLogInfo, raidPDOtherErrorCount=raidPDOtherErrorCount, osEntry=osEntry, memModel=memModel, cpuLogInfo=cpuLogInfo, memManufacturer=memManufacturer, trapBbpStatusNormal=trapBbpStatusNormal, diskSize=diskSize, trapCpuFaultWarning=trapCpuFaultWarning, diskVendor=diskVendor, diskEntry=diskEntry, ueccLogIndex=ueccLogIndex, dmiLogTable=dmiLogTable, cpuLogDatetime=cpuLogDatetime, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, postLogEntry=postLogEntry, raidBBUEntry=raidBBUEntry, cpuCoreCount=cpuCoreCount, raidVDBadBlocksExist=raidVDBadBlocksExist)
