...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidVDSize=raidVDSize, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDOpProgress=raidPDOpProgress, raidPDPort0Status=raidPDPort0Status, cpuLoadingPercentage=cpuLoadingPercentage, raidVDAllinoneStatus=raidVDAllinoneStatus, diskSerialNumber=diskSerialNumber, trapTemperatureNormal=trapTemperatureNormal, osManufacturer=osManufacturer, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, ueccLogIndex=ueccLogIndex, raidVDName=raidVDName, trapMemoryUeccWarning=trapMemoryUeccWarning, mbSerialNumber=mbSerialNumber, trapChassisIntrusion=trapChassisIntrusion, raidVDSpanDepth=raidVDSpanDepth, mbIndex=mbIndex, raidVDCached=raidVDCached, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapBatteryStatusWarning=trapBatteryStatusWarning, ueccLogTable=ueccLogTable, memSerialNumber=memSerialNumber, ueccLogInfo=ueccLogInfo, raidPDTable=raidPDTable, memDeviceLocator=memDeviceLocator, diskEntry=diskEntry, raidVDEncryptionType=raidVDEncryptionType, trapPowerSupplyCritical=trapPowerSupplyCritical, sysBIOSReleaseDate=sysBIOSReleaseDate, cpuLogInfo=cpuLogInfo, cpuDeviceVersion=cpuDeviceVersion, ceccLogTable=ceccLogTable, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDSerialNumber=raidPDSerialNumber, trapGenericWarning=trapGenericWarning, postLogInfo=postLogInfo, raidPDRawSize=raidPDRawSize, raidPDPort1Status=raidPDPort1Status, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, sysBIOSIndex=sysBIOSIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterSerialNumber=raidAdapterSerialNumber, trapBbpStatusNormal=trapBbpStatusNormal, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDAllinoneMsg=raidVDAllinoneMsg, diskSize=diskSize, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapPowerSupplyNormal=trapPowerSupplyNormal, cpuEntry=cpuEntry, raidPDAllinoneMsg=raidPDAllinoneMsg, memTotalWidth=memTotalWidth, postLogEntry=postLogEntry, ueccLogEntry=ueccLogEntry, postLogIndex=postLogIndex, raidAdapterGroup=raidAdapterGroup, raidPDSlotNumber=raidPDSlotNumber, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDInquiryData=raidPDInquiryData, trapMemoryUeccNormal=trapMemoryUeccNormal, memDescription=memDescription, cpuCurrentSpeed=cpuCurrentSpeed, raidPDMediaType=raidPDMediaType, raidVDSupportT10Power=raidVDSupportT10Power, osName=osName, sysBIOSVersion=sysBIOSVersion, memTag=memTag, ceccLogDatetime=ceccLogDatetime, diskMediaType=diskMediaType, diskTable=diskTable, raidVDTargetId=raidVDTargetId, diskController=diskController, trapTemperatureCritical=trapTemperatureCritical, diskInterfaceType=diskInterfaceType, memManufacturer=memManufacturer, osCSDVersion=osCSDVersion, trapGenericCritical=trapGenericCritical, diskVendor=diskVendor, trapVoltageNormal=trapVoltageNormal, raidPDFirmwareRevision=raidPDFirmwareRevision, mbManufacturer=mbManufacturer, cpuDescription=cpuDescription, raidPDSpan=raidPDSpan, cpuSocketDesignation=cpuSocketDesignation, postLogTable=postLogTable, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memECCErrorCount=memECCErrorCount, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidBBUTable=raidBBUTable, raidPDFirmwareState=raidPDFirmwareState, sd5Table=sd5Table, mbProductName=mbProductName, ceccLogInfo=ceccLogInfo, raidAdapterFWVersion=raidAdapterFWVersion, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterVendorId=raidAdapterVendorId, raidAdapterEntry=raidAdapterEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, sysBIOSEntry=sysBIOSEntry, raidVDMirrorDataSize=raidVDMirrorDataSize, cpuDeviceStatus=cpuDeviceStatus, trapTemperatureWarning=trapTemperatureWarning, raidVDNumDrives=raidVDNumDrives, trapPowerSupplyWarning=trapPowerSupplyWarning, sd5MIBVersion=sd5MIBVersion, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDWriteCache=raidPDWriteCache, memEntry=memEntry, raidAdapterTable=raidAdapterTable, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapFanCritical=trapFanCritical, mbAssetTag=mbAssetTag, raidBBUEntry=raidBBUEntry, raidBBUIndex=raidBBUIndex, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, cpuName=cpuName, cpuID=cpuID, memPartNumber=memPartNumber, raidVDIndex=raidVDIndex, memModel=memModel, raidPDEntry=raidPDEntry, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDAllinoneStatus=raidPDAllinoneStatus, trapBbpStatusCritical=trapBbpStatusCritical, cpuIndex=cpuIndex, raidAdapterGroup_BBU=raidAdapterGroup_BBU, cpuThreadCount=cpuThreadCount, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, osIndex=osIndex, cpuLogTable=cpuLogTable, raidAdapterIndex=raidAdapterIndex, cpuTable=cpuTable, cpuMaxSpeed=cpuMaxSpeed, trapGenericNormal=trapGenericNormal, raidVDStripSize=raidVDStripSize, raidVDDiskCachePolicy=raidVDDiskCachePolicy, sysBIOSManufacturer=sysBIOSManufacturer, diskModel=diskModel, raidPDPredFailCount=raidPDPredFailCount, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidVDTable=raidVDTable, raidAdapterId_VD=raidAdapterId_VD, diskName=diskName, raidAdapterGroup_PD=raidAdapterGroup_PD, trapVoltageCritical=trapVoltageCritical, smSuperDoctor5MIB=smSuperDoctor5MIB, trapFanWarning=trapFanWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, dmiLogTable=dmiLogTable, trapMemoryCeccWarning=trapMemoryCeccWarning, diskSmartStatus=diskSmartStatus, trapFanNormal=trapFanNormal, cpuLogEntry=cpuLogEntry, osTable=osTable, trapCpuFaultCritical=trapCpuFaultCritical, memDeviceStatus=memDeviceStatus, trapBbpStatusWarning=trapBbpStatusWarning, raidDiskGroupId=raidDiskGroupId, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDEntry=raidVDEntry, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDRaidLevel=raidVDRaidLevel, postLogDatetime=postLogDatetime, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDPort0Linkspeed=raidPDPort0Linkspeed, memDataWidth=memDataWidth, raidPDDeviceSpeed=raidPDDeviceSpeed, ceccLogIndex=ceccLogIndex, raidAdapterId=raidAdapterId, raidAdapterSubVendorId=raidAdapterSubVendorId, raidIsBBUAbsent=raidIsBBUAbsent, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuCoreCount=cpuCoreCount, sd5Version=sd5Version, memErrorCount=memErrorCount, raidPDNCQSetting=raidPDNCQSetting, trapCpuFaultWarning=trapCpuFaultWarning, memLabeledBank=memLabeledBank, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuCoreEnabled=cpuCoreEnabled, mbVersionName=mbVersionName, diskSlotID=diskSlotID, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDModel=raidPDModel, raidAdapterId_PD=raidAdapterId_PD, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, memUECCErrorCount=memUECCErrorCount, osSerialNumber=osSerialNumber, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, mbEntry=mbEntry, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDBadBlocksExist=raidVDBadBlocksExist, osEntry=osEntry, raidPDLinkSpeed=raidPDLinkSpeed, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuDeviceID=cpuDeviceID, sysBIOSTable=sysBIOSTable, raidVDState=raidVDState, raidPDOtherErrorCount=raidPDOtherErrorCount, memTable=memTable, cpuLogIndex=cpuLogIndex, raidAdapterProductName=raidAdapterProductName, memCapacity=memCapacity, smSD5TrapMIB=smSD5TrapMIB, mbTable=mbTable, cpuLogDatetime=cpuLogDatetime, trapVoltageWarning=trapVoltageWarning, cpuManufacturer=cpuManufacturer, osVersion=osVersion, raidVDId=raidVDId, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidPDIndex=raidPDIndex, trapBatteryStatusNormal=trapBatteryStatusNormal, sd5Entry=sd5Entry, raidAdapterDeviceId=raidAdapterDeviceId, ceccLogEntry=ceccLogEntry, raidBBUStatus=raidBBUStatus, ueccLogDatetime=ueccLogDatetime, trapCpuFaultNormal=trapCpuFaultNormal, sd5Idx=sd5Idx)
