...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapCpuFaultNormal=trapCpuFaultNormal, raidPDDeviceSpeed=raidPDDeviceSpeed, diskEntry=diskEntry, trapFanCritical=trapFanCritical, memModel=memModel, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapFanWarning=trapFanWarning, trapBbpStatusCritical=trapBbpStatusCritical, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDOpProgress=raidPDOpProgress, mbAssetTag=mbAssetTag, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidAdapterDeviceId=raidAdapterDeviceId, raidVDAllinoneStatus=raidVDAllinoneStatus, osManufacturer=osManufacturer, raidPDDeviceFwLevel=raidPDDeviceFwLevel, memCapacity=memCapacity, cpuDescription=cpuDescription, cpuCurrentSpeed=cpuCurrentSpeed, raidPDAllinoneStatus=raidPDAllinoneStatus, cpuLogDatetime=cpuLogDatetime, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterSerialNumber=raidAdapterSerialNumber, trapFanNormal=trapFanNormal, raidVDTable=raidVDTable, trapVoltageNormal=trapVoltageNormal, trapCpuFaultCritical=trapCpuFaultCritical, raidPDModel=raidPDModel, sysBIOSIndex=sysBIOSIndex, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memErrorCount=memErrorCount, mbSerialNumber=mbSerialNumber, raidAdapterFWVersion=raidAdapterFWVersion, raidVDAllinoneMsg=raidVDAllinoneMsg, diskSlotID=diskSlotID, trapTemperatureWarning=trapTemperatureWarning, raidPDFirmwareState=raidPDFirmwareState, sd5MIBVersion=sd5MIBVersion, memUECCErrorCount=memUECCErrorCount, raidPDEntry=raidPDEntry, postLogTable=postLogTable, cpuSocketDesignation=cpuSocketDesignation, trapChassisIntrusion=trapChassisIntrusion, cpuLoadingPercentage=cpuLoadingPercentage, raidPDLinkSpeed=raidPDLinkSpeed, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterEntry=raidAdapterEntry, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, PYSNMP_MODULE_ID=smSuperDoctor5MIB, cpuMaxSpeed=cpuMaxSpeed, ueccLogTable=ueccLogTable, memManufacturer=memManufacturer, osVersion=osVersion, raidPDPort1Status=raidPDPort1Status, trapMemoryUeccWarning=trapMemoryUeccWarning, memEntry=memEntry, osSerialNumber=osSerialNumber, raidVDEntry=raidVDEntry, ueccLogInfo=ueccLogInfo, raidVDStripSize=raidVDStripSize, raidDiskGroupId=raidDiskGroupId, mbEntry=mbEntry, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterId_PD=raidAdapterId_PD, sd5Table=sd5Table, osName=osName, trapTemperatureCritical=trapTemperatureCritical, trapCpuFaultWarning=trapCpuFaultWarning, memPartNumber=memPartNumber, diskTable=diskTable, smSD5TrapMIB=smSD5TrapMIB, diskSize=diskSize, trapPowerSupplyNormal=trapPowerSupplyNormal, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDMediaErrorCount=raidPDMediaErrorCount, postLogInfo=postLogInfo, diskInterfaceType=diskInterfaceType, raidPDWriteCache=raidPDWriteCache, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapPowerSupplyWarning=trapPowerSupplyWarning, memDescription=memDescription, osTable=osTable, raidVDEncryptionType=raidVDEncryptionType, raidVDSupportsMaxPS=raidVDSupportsMaxPS, diskSerialNumber=diskSerialNumber, sysBIOSManufacturer=sysBIOSManufacturer, diskSmartStatus=diskSmartStatus, diskMediaType=diskMediaType, raidPDIndex=raidPDIndex, mbManufacturer=mbManufacturer, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, cpuCoreCount=cpuCoreCount, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapPowerSupplyCritical=trapPowerSupplyCritical, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterId_VD=raidAdapterId_VD, cpuName=cpuName, raidVDSize=raidVDSize, trapGenericNormal=trapGenericNormal, trapVoltageCritical=trapVoltageCritical, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuManufacturer=cpuManufacturer, memTag=memTag, cpuDeviceStatus=cpuDeviceStatus, diskName=diskName, raidAdapterId=raidAdapterId, sd5Version=sd5Version, raidAdapterProductName=raidAdapterProductName, trapMemoryCeccWarning=trapMemoryCeccWarning, memDeviceStatus=memDeviceStatus, raidPDFirmwareRevision=raidPDFirmwareRevision, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidAdapterGroup=raidAdapterGroup, raidPDRawSize=raidPDRawSize, memECCErrorCount=memECCErrorCount, raidVDId=raidVDId, memTotalWidth=memTotalWidth, raidBBUTable=raidBBUTable, raidVDCached=raidVDCached, raidVDNumDrives=raidVDNumDrives, smSuperDoctor5MIB=smSuperDoctor5MIB, trapGenericCritical=trapGenericCritical, memDataWidth=memDataWidth, raidBBUAllinoneMsg=raidBBUAllinoneMsg, mbTable=mbTable, memLabeledBank=memLabeledBank, cpuCoreEnabled=cpuCoreEnabled, diskVendor=diskVendor, raidVDTargetId=raidVDTargetId, ceccLogIndex=ceccLogIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidBBUIndex=raidBBUIndex, trapBbpStatusWarning=trapBbpStatusWarning, raidPDSlotNumber=raidPDSlotNumber, raidPDPort1Linkspeed=raidPDPort1Linkspeed, ceccLogTable=ceccLogTable, raidPDSpan=raidPDSpan, diskController=diskController, mbIndex=mbIndex, raidPDNCQSetting=raidPDNCQSetting, postLogIndex=postLogIndex, raidVDSupportT10Power=raidVDSupportT10Power, trapGenericWarning=trapGenericWarning, raidPDMediaType=raidPDMediaType, raidBBUEntry=raidBBUEntry, mbVersionName=mbVersionName, osIndex=osIndex, osCSDVersion=osCSDVersion, dmiLogTable=dmiLogTable, raidVDName=raidVDName, raidPDAllinoneMsg=raidPDAllinoneMsg, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidPDInquiryData=raidPDInquiryData, sd5Idx=sd5Idx, raidAdapterTable=raidAdapterTable, sd5Entry=sd5Entry, cpuLogIndex=cpuLogIndex, raidPDPredFailCount=raidPDPredFailCount, sysBIOSTable=sysBIOSTable, raidAdapterIndex=raidAdapterIndex, raidVDSpanDepth=raidVDSpanDepth, cpuDeviceVersion=cpuDeviceVersion, raidAdapterGroup_VD=raidAdapterGroup_VD, raidBBUStatus=raidBBUStatus, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDTable=raidPDTable, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDRaidLevel=raidVDRaidLevel, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, memTable=memTable, trapVoltageWarning=trapVoltageWarning, cpuIndex=cpuIndex, trapBbpStatusNormal=trapBbpStatusNormal, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDSerialNumber=raidPDSerialNumber, ueccLogIndex=ueccLogIndex, cpuEntry=cpuEntry, ceccLogDatetime=ceccLogDatetime, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapTemperatureNormal=trapTemperatureNormal, cpuID=cpuID, raidPDOtherErrorCount=raidPDOtherErrorCount, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, ceccLogInfo=ceccLogInfo, ueccLogEntry=ueccLogEntry, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDPort0Status=raidPDPort0Status, ueccLogDatetime=ueccLogDatetime, memDeviceLocator=memDeviceLocator, raidBBUAllinoneStatus=raidBBUAllinoneStatus, sysBIOSVersion=sysBIOSVersion, cpuLogTable=cpuLogTable, raidVDState=raidVDState, memSerialNumber=memSerialNumber, osEntry=osEntry, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuThreadCount=cpuThreadCount, ceccLogEntry=ceccLogEntry, sysBIOSEntry=sysBIOSEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapBatteryStatusWarning=trapBatteryStatusWarning, postLogEntry=postLogEntry, mbProductName=mbProductName, cpuLogEntry=cpuLogEntry, trapBatteryStatusCritical=trapBatteryStatusCritical, raidAdapterVendorId=raidAdapterVendorId, cpuDeviceID=cpuDeviceID, cpuLogInfo=cpuLogInfo, raidAdapterId_BBU=raidAdapterId_BBU, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDIndex=raidVDIndex, sysBIOSReleaseDate=sysBIOSReleaseDate, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuTable=cpuTable, postLogDatetime=postLogDatetime, diskModel=diskModel)
