...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapTemperatureWarning=trapTemperatureWarning, raidVDAllinoneStatus=raidVDAllinoneStatus, mbManufacturer=mbManufacturer, diskModel=diskModel, trapFanWarning=trapFanWarning, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapTemperatureNormal=trapTemperatureNormal, raidAdapterFWVersion=raidAdapterFWVersion, raidVDState=raidVDState, osSerialNumber=osSerialNumber, mbIndex=mbIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, ceccLogInfo=ceccLogInfo, memModel=memModel, ueccLogIndex=ueccLogIndex, cpuCurrentSpeed=cpuCurrentSpeed, memTag=memTag, memLabeledBank=memLabeledBank, raidBBUEntry=raidBBUEntry, raidIsBBUAbsent=raidIsBBUAbsent, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sysBIOSVersion=sysBIOSVersion, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapMemoryUeccWarning=trapMemoryUeccWarning, trapBbpStatusWarning=trapBbpStatusWarning, memECCErrorCount=memECCErrorCount, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidPDMediaType=raidPDMediaType, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, postLogIndex=postLogIndex, raidAdapterId_BBU=raidAdapterId_BBU, trapVoltageNormal=trapVoltageNormal, memDeviceStatus=memDeviceStatus, memDeviceLocator=memDeviceLocator, raidPDSerialNumber=raidPDSerialNumber, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDStripSize=raidVDStripSize, dmiLogTable=dmiLogTable, cpuDeviceStatus=cpuDeviceStatus, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterBIOSVersion=raidAdapterBIOSVersion, smSuperDoctor5MIB=smSuperDoctor5MIB, sysBIOSEntry=sysBIOSEntry, raidPDDeviceSpeed=raidPDDeviceSpeed, trapFanNormal=trapFanNormal, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDCached=raidVDCached, sysBIOSIndex=sysBIOSIndex, cpuCoreEnabled=cpuCoreEnabled, raidPDOtherErrorCount=raidPDOtherErrorCount, mbTable=mbTable, trapMemoryCeccWarning=trapMemoryCeccWarning, cpuDeviceID=cpuDeviceID, ceccLogDatetime=ceccLogDatetime, trapBbpStatusNormal=trapBbpStatusNormal, raidPDInquiryData=raidPDInquiryData, cpuName=cpuName, raidBBUTable=raidBBUTable, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuLogDatetime=cpuLogDatetime, trapFanCritical=trapFanCritical, diskSlotID=diskSlotID, cpuSocketDesignation=cpuSocketDesignation, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, memPartNumber=memPartNumber, cpuID=cpuID, cpuLoadingPercentage=cpuLoadingPercentage, diskVendor=diskVendor, raidVDSpanDepth=raidVDSpanDepth, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapCpuFaultCritical=trapCpuFaultCritical, mbSerialNumber=mbSerialNumber, cpuThreadCount=cpuThreadCount, raidPDRawSize=raidPDRawSize, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapPowerSupplyCritical=trapPowerSupplyCritical, diskTable=diskTable, raidVDEncryptionType=raidVDEncryptionType, raidAdapterGroup_PD=raidAdapterGroup_PD, trapGenericWarning=trapGenericWarning, raidVDSupportT10Power=raidVDSupportT10Power, raidPDFirmwareState=raidPDFirmwareState, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskName=diskName, diskSerialNumber=diskSerialNumber, raidBBUStatus=raidBBUStatus, raidVDTable=raidVDTable, sysBIOSManufacturer=sysBIOSManufacturer, raidVDDiskCachePolicy=raidVDDiskCachePolicy, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterEntry=raidAdapterEntry, memTable=memTable, raidAdapterDeviceId=raidAdapterDeviceId, cpuMaxSpeed=cpuMaxSpeed, raidBBUIndex=raidBBUIndex, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDAllinoneMsg=raidPDAllinoneMsg, postLogDatetime=postLogDatetime, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, diskInterfaceType=diskInterfaceType, memEntry=memEntry, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapBbpStatusCritical=trapBbpStatusCritical, sd5Entry=sd5Entry, raidVDRaidLevel=raidVDRaidLevel, ueccLogTable=ueccLogTable, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterId=raidAdapterId, trapChassisIntrusion=trapChassisIntrusion, trapPowerSupplyNormal=trapPowerSupplyNormal, ceccLogTable=ceccLogTable, smSD5TrapMIB=smSD5TrapMIB, trapCpuFaultWarning=trapCpuFaultWarning, diskSize=diskSize, cpuManufacturer=cpuManufacturer, osIndex=osIndex, cpuLogEntry=cpuLogEntry, raidAdapterId_VD=raidAdapterId_VD, raidVDId=raidVDId, trapChassisIntrusionCleared=trapChassisIntrusionCleared, memDescription=memDescription, sysBIOSTable=sysBIOSTable, sd5Idx=sd5Idx, cpuDeviceVersion=cpuDeviceVersion, ceccLogEntry=ceccLogEntry, raidAdapterSerialNumber=raidAdapterSerialNumber, mbEntry=mbEntry, raidPDIndex=raidPDIndex, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memCapacity=memCapacity, raidVDEntry=raidVDEntry, cpuLogInfo=cpuLogInfo, postLogEntry=postLogEntry, memTotalWidth=memTotalWidth, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidAdapterTable=raidAdapterTable, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDFirmwareRevision=raidPDFirmwareRevision, diskSmartStatus=diskSmartStatus, cpuLogTable=cpuLogTable, raidBBUAllinoneMsg=raidBBUAllinoneMsg, diskMediaType=diskMediaType, raidPDSpan=raidPDSpan, trapPowerSupplyWarning=trapPowerSupplyWarning, diskController=diskController, diskEntry=diskEntry, raidAdapterIndex=raidAdapterIndex, raidDiskGroupId=raidDiskGroupId, trapBatteryStatusWarning=trapBatteryStatusWarning, mbVersionName=mbVersionName, raidPDModel=raidPDModel, trapVoltageCritical=trapVoltageCritical, cpuLogIndex=cpuLogIndex, raidVDIndex=raidVDIndex, sd5Version=sd5Version, ueccLogEntry=ueccLogEntry, cpuIndex=cpuIndex, raidPDPort0Status=raidPDPort0Status, postLogTable=postLogTable, raidPDWriteCache=raidPDWriteCache, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuCoreCount=cpuCoreCount, cpuDescription=cpuDescription, sd5MIBVersion=sd5MIBVersion, memUECCErrorCount=memUECCErrorCount, osEntry=osEntry, mbProductName=mbProductName, raidPDEntry=raidPDEntry, raidAdapterProductName=raidAdapterProductName, raidAdapterId_PD=raidAdapterId_PD, raidPDPort1Status=raidPDPort1Status, trapCpuFaultNormal=trapCpuFaultNormal, mbAssetTag=mbAssetTag, raidAdapterVendorId=raidAdapterVendorId, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDTargetId=raidVDTargetId, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDPredFailCount=raidPDPredFailCount, raidVDNumDrives=raidVDNumDrives, raidPDPort1Linkspeed=raidPDPort1Linkspeed, ueccLogDatetime=ueccLogDatetime, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, memErrorCount=memErrorCount, raidPDNCQSetting=raidPDNCQSetting, raidPDAllinoneStatus=raidPDAllinoneStatus, raidPDOpProgress=raidPDOpProgress, cpuTable=cpuTable, osManufacturer=osManufacturer, memManufacturer=memManufacturer, trapGenericNormal=trapGenericNormal, osVersion=osVersion, raidAdapterGroup=raidAdapterGroup, memDataWidth=memDataWidth, osName=osName, ueccLogInfo=ueccLogInfo, cpuEntry=cpuEntry, raidPDLinkSpeed=raidPDLinkSpeed, raidVDName=raidVDName, raidPDSlotNumber=raidPDSlotNumber, trapBatteryStatusCritical=trapBatteryStatusCritical, postLogInfo=postLogInfo, ceccLogIndex=ceccLogIndex, trapTemperatureCritical=trapTemperatureCritical, trapGenericCritical=trapGenericCritical, osCSDVersion=osCSDVersion, raidVDSize=raidVDSize, trapVoltageWarning=trapVoltageWarning, sd5Table=sd5Table, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDMirrorDataSize=raidVDMirrorDataSize, osTable=osTable, memSerialNumber=memSerialNumber, raidPDTable=raidPDTable)
