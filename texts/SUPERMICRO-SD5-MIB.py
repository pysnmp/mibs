...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuID=cpuID, raidPDPredFailCount=raidPDPredFailCount, raidPDOtherErrorCount=raidPDOtherErrorCount, sd5Version=sd5Version, cpuCurrentSpeed=cpuCurrentSpeed, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, diskMediaType=diskMediaType, cpuCoreEnabled=cpuCoreEnabled, sysBIOSTable=sysBIOSTable, trapVoltageCritical=trapVoltageCritical, ueccLogInfo=ueccLogInfo, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidPDInquiryData=raidPDInquiryData, raidVDMirrorDataSize=raidVDMirrorDataSize, osSerialNumber=osSerialNumber, raidVDAllinoneStatus=raidVDAllinoneStatus, ueccLogTable=ueccLogTable, trapBbpStatusCritical=trapBbpStatusCritical, raidAdapterVendorId=raidAdapterVendorId, diskVendor=diskVendor, diskSize=diskSize, postLogInfo=postLogInfo, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, mbIndex=mbIndex, raidPDLinkSpeed=raidPDLinkSpeed, trapCpuFaultCritical=trapCpuFaultCritical, postLogDatetime=postLogDatetime, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapVoltageNormal=trapVoltageNormal, raidPDDeviceFwLevel=raidPDDeviceFwLevel, sd5MIBVersion=sd5MIBVersion, memDescription=memDescription, raidVDEncryptionType=raidVDEncryptionType, trapGenericNormal=trapGenericNormal, raidPDSpan=raidPDSpan, raidAdapterGroup_PD=raidAdapterGroup_PD, trapVoltageWarning=trapVoltageWarning, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuName=cpuName, ceccLogIndex=ceccLogIndex, raidBBUEntry=raidBBUEntry, raidDiskGroupId_PD=raidDiskGroupId_PD, trapTemperatureNormal=trapTemperatureNormal, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDCached=raidVDCached, smSuperDoctor5MIB=smSuperDoctor5MIB, trapFanCritical=trapFanCritical, raidBBUAllinoneMsg=raidBBUAllinoneMsg, osName=osName, raidVDState=raidVDState, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDPort0Status=raidPDPort0Status, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDMediaErrorCount=raidPDMediaErrorCount, mbVersionName=mbVersionName, raidAdapterProductName=raidAdapterProductName, sysBIOSManufacturer=sysBIOSManufacturer, memDataWidth=memDataWidth, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskModel=diskModel, diskSlotID=diskSlotID, mbEntry=mbEntry, memManufacturer=memManufacturer, raidPDTable=raidPDTable, smSD5TrapMIB=smSD5TrapMIB, raidDiskGroupId=raidDiskGroupId, trapCpuFaultWarning=trapCpuFaultWarning, memSerialNumber=memSerialNumber, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuIndex=cpuIndex, sd5Table=sd5Table, trapMemoryUeccWarning=trapMemoryUeccWarning, raidVDName=raidVDName, mbProductName=mbProductName, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDEntry=raidVDEntry, raidAdapterId=raidAdapterId, sysBIOSVersion=sysBIOSVersion, raidPDIndex=raidPDIndex, raidAdapterIndex=raidAdapterIndex, raidPDSlotNumber=raidPDSlotNumber, sd5Idx=sd5Idx, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidAdapterGroup=raidAdapterGroup, raidVDTargetId=raidVDTargetId, cpuDeviceID=cpuDeviceID, sysBIOSReleaseDate=sysBIOSReleaseDate, postLogTable=postLogTable, cpuDescription=cpuDescription, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDRawSize=raidPDRawSize, raidPDFirmwareState=raidPDFirmwareState, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterId_BBU=raidAdapterId_BBU, cpuDeviceVersion=cpuDeviceVersion, osCSDVersion=osCSDVersion, cpuDeviceStatus=cpuDeviceStatus, memDeviceStatus=memDeviceStatus, memPartNumber=memPartNumber, raidIsBBUAbsent=raidIsBBUAbsent, raidBBUIndex=raidBBUIndex, ueccLogEntry=ueccLogEntry, raidVDSize=raidVDSize, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDAllinoneMsg=raidPDAllinoneMsg, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, ueccLogDatetime=ueccLogDatetime, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapTemperatureWarning=trapTemperatureWarning, cpuThreadCount=cpuThreadCount, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, dmiLogTable=dmiLogTable, raidBBUAllinoneStatus=raidBBUAllinoneStatus, diskName=diskName, postLogIndex=postLogIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapMemoryCeccWarning=trapMemoryCeccWarning, cpuManufacturer=cpuManufacturer, raidAdapterDeviceId=raidAdapterDeviceId, raidBBUStatus=raidBBUStatus, trapPowerSupplyWarning=trapPowerSupplyWarning, raidAdapterSubVendorId=raidAdapterSubVendorId, ueccLogIndex=ueccLogIndex, cpuLogEntry=cpuLogEntry, ceccLogInfo=ceccLogInfo, raidPDMediaType=raidPDMediaType, diskSerialNumber=diskSerialNumber, diskTable=diskTable, ceccLogDatetime=ceccLogDatetime, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapPowerSupplyNormal=trapPowerSupplyNormal, osIndex=osIndex, osVersion=osVersion, trapChassisIntrusion=trapChassisIntrusion, diskSmartStatus=diskSmartStatus, mbManufacturer=mbManufacturer, raidBBUTable=raidBBUTable, osManufacturer=osManufacturer, cpuLogTable=cpuLogTable, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDFirmwareRevision=raidPDFirmwareRevision, trapFanWarning=trapFanWarning, trapGenericCritical=trapGenericCritical, raidAdapterId_VD=raidAdapterId_VD, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapGenericWarning=trapGenericWarning, raidPDModel=raidPDModel, raidPDWriteCache=raidPDWriteCache, memErrorCount=memErrorCount, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDIndex=raidVDIndex, memDeviceLocator=memDeviceLocator, mbAssetTag=mbAssetTag, raidVDTable=raidVDTable, raidVDStripSize=raidVDStripSize, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDSpanDepth=raidVDSpanDepth, trapCpuFaultNormal=trapCpuFaultNormal, osTable=osTable, diskEntry=diskEntry, mbSerialNumber=mbSerialNumber, memModel=memModel, trapBbpStatusNormal=trapBbpStatusNormal, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidVDId=raidVDId, memUECCErrorCount=memUECCErrorCount, raidPDNCQSetting=raidPDNCQSetting, trapTemperatureCritical=trapTemperatureCritical, cpuSocketDesignation=cpuSocketDesignation, cpuEntry=cpuEntry, cpuCoreCount=cpuCoreCount, raidVDNumDrives=raidVDNumDrives, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidPDEntry=raidPDEntry, sysBIOSEntry=sysBIOSEntry, raidPDOpProgress=raidPDOpProgress, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterEntry=raidAdapterEntry, raidVDSupportT10Power=raidVDSupportT10Power, cpuMaxSpeed=cpuMaxSpeed, trapMemoryCeccNormal=trapMemoryCeccNormal, trapMemoryCeccCritical=trapMemoryCeccCritical, cpuLoadingPercentage=cpuLoadingPercentage, memCapacity=memCapacity, sysBIOSIndex=sysBIOSIndex, memLabeledBank=memLabeledBank, ceccLogEntry=ceccLogEntry, memTotalWidth=memTotalWidth, sd5Entry=sd5Entry, cpuLogIndex=cpuLogIndex, raidAdapterGroup_VD=raidAdapterGroup_VD, diskController=diskController, cpuLogInfo=cpuLogInfo, diskInterfaceType=diskInterfaceType, osEntry=osEntry, memTable=memTable, cpuTable=cpuTable, raidAdapterTable=raidAdapterTable, raidPDSerialNumber=raidPDSerialNumber, memECCErrorCount=memECCErrorCount, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, memEntry=memEntry, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapBbpStatusWarning=trapBbpStatusWarning, trapMemoryUeccNormal=trapMemoryUeccNormal, trapPowerSupplyCritical=trapPowerSupplyCritical, postLogEntry=postLogEntry, raidAdapterId_PD=raidAdapterId_PD, cpuLogDatetime=cpuLogDatetime, raidVDRaidLevel=raidVDRaidLevel, memTag=memTag, ceccLogTable=ceccLogTable, trapFanNormal=trapFanNormal, mbTable=mbTable, raidPDPort1Status=raidPDPort1Status)
