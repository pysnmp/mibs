...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", sd5Table=sd5Table, memTable=memTable, raidAdapterProductName=raidAdapterProductName, osSerialNumber=osSerialNumber, postLogIndex=postLogIndex, diskSlotID=diskSlotID, cpuLogInfo=cpuLogInfo, osEntry=osEntry, cpuSocketDesignation=cpuSocketDesignation, ceccLogIndex=ceccLogIndex, sysBIOSTable=sysBIOSTable, sysBIOSIndex=sysBIOSIndex, raidVDStripSize=raidVDStripSize, raidPDTable=raidPDTable, trapPowerSupplyNormal=trapPowerSupplyNormal, trapGenericWarning=trapGenericWarning, memDeviceStatus=memDeviceStatus, trapCpuFaultWarning=trapCpuFaultWarning, raidPDWriteCache=raidPDWriteCache, raidVDCached=raidVDCached, cpuIndex=cpuIndex, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDModel=raidPDModel, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDLinkSpeed=raidPDLinkSpeed, raidPDPort0Status=raidPDPort0Status, ueccLogDatetime=ueccLogDatetime, raidPDMediaType=raidPDMediaType, trapFanNormal=trapFanNormal, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, memManufacturer=memManufacturer, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDSize=raidVDSize, diskSize=diskSize, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, memLabeledBank=memLabeledBank, mbVersionName=mbVersionName, sd5MIBVersion=sd5MIBVersion, trapTemperatureWarning=trapTemperatureWarning, trapBbpStatusNormal=trapBbpStatusNormal, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDSlotNumber=raidPDSlotNumber, osManufacturer=osManufacturer, sysBIOSReleaseDate=sysBIOSReleaseDate, mbTable=mbTable, raidAdapterSerialNumber=raidAdapterSerialNumber, raidAdapterSubVendorId=raidAdapterSubVendorId, osCSDVersion=osCSDVersion, trapVoltageNormal=trapVoltageNormal, trapMemoryUeccNormal=trapMemoryUeccNormal, mbProductName=mbProductName, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDMediaErrorCount=raidPDMediaErrorCount, postLogDatetime=postLogDatetime, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapGenericCritical=trapGenericCritical, mbIndex=mbIndex, raidPDInquiryData=raidPDInquiryData, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuEntry=cpuEntry, raidAdapterTable=raidAdapterTable, raidBBUAllinoneMsg=raidBBUAllinoneMsg, diskController=diskController, trapVoltageWarning=trapVoltageWarning, memModel=memModel, ueccLogEntry=ueccLogEntry, cpuDeviceID=cpuDeviceID, memTotalWidth=memTotalWidth, trapVoltageCritical=trapVoltageCritical, raidPDSpan=raidPDSpan, trapPowerSupplyWarning=trapPowerSupplyWarning, raidAdapterId_VD=raidAdapterId_VD, ueccLogIndex=ueccLogIndex, raidAdapterId_BBU=raidAdapterId_BBU, trapMemoryUeccCritical=trapMemoryUeccCritical, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, ueccLogInfo=ueccLogInfo, raidPDSerialNumber=raidPDSerialNumber, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuLoadingPercentage=cpuLoadingPercentage, osTable=osTable, cpuMaxSpeed=cpuMaxSpeed, cpuManufacturer=cpuManufacturer, memECCErrorCount=memECCErrorCount, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterGroup_VD=raidAdapterGroup_VD, sd5Entry=sd5Entry, raidPDOpProgress=raidPDOpProgress, raidVDSpanDepth=raidVDSpanDepth, raidVDAllinoneStatus=raidVDAllinoneStatus, memErrorCount=memErrorCount, cpuCoreCount=cpuCoreCount, diskEntry=diskEntry, raidBBUStatus=raidBBUStatus, mbEntry=mbEntry, raidPDFirmwareRevision=raidPDFirmwareRevision, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, memDescription=memDescription, cpuDeviceStatus=cpuDeviceStatus, trapFanCritical=trapFanCritical, memPartNumber=memPartNumber, memCapacity=memCapacity, PYSNMP_MODULE_ID=smSuperDoctor5MIB, diskVendor=diskVendor, trapTemperatureNormal=trapTemperatureNormal, raidVDMirrorDataSize=raidVDMirrorDataSize, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, cpuCurrentSpeed=cpuCurrentSpeed, cpuID=cpuID, trapTemperatureCritical=trapTemperatureCritical, postLogTable=postLogTable, raidBBUEntry=raidBBUEntry, raidAdapterGroup=raidAdapterGroup, cpuLogIndex=cpuLogIndex, trapFanWarning=trapFanWarning, raidVDIndex=raidVDIndex, raidAdapterId=raidAdapterId, ceccLogTable=ceccLogTable, osVersion=osVersion, cpuLogDatetime=cpuLogDatetime, raidPDFirmwareState=raidPDFirmwareState, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidVDRaidLevel=raidVDRaidLevel, raidAdapterBIOSVersion=raidAdapterBIOSVersion, mbSerialNumber=mbSerialNumber, postLogInfo=postLogInfo, cpuLogTable=cpuLogTable, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDTable=raidVDTable, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sd5Version=sd5Version, diskName=diskName, trapBbpStatusCritical=trapBbpStatusCritical, raidAdapterVendorId=raidAdapterVendorId, trapChassisIntrusion=trapChassisIntrusion, trapMemoryCeccCritical=trapMemoryCeccCritical, raidAdapterEntry=raidAdapterEntry, sysBIOSVersion=sysBIOSVersion, diskModel=diskModel, raidVDName=raidVDName, raidPDPort1Status=raidPDPort1Status, trapGenericNormal=trapGenericNormal, cpuDeviceVersion=cpuDeviceVersion, memSerialNumber=memSerialNumber, mbManufacturer=mbManufacturer, osName=osName, ceccLogInfo=ceccLogInfo, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sd5Idx=sd5Idx, trapCpuFaultNormal=trapCpuFaultNormal, trapBatteryStatusCritical=trapBatteryStatusCritical, memUECCErrorCount=memUECCErrorCount, raidPDOtherErrorCount=raidPDOtherErrorCount, raidBBUTable=raidBBUTable, cpuLogEntry=cpuLogEntry, raidVDBadBlocksExist=raidVDBadBlocksExist, trapMemoryUeccWarning=trapMemoryUeccWarning, raidVDSupportsMaxPS=raidVDSupportsMaxPS, ceccLogEntry=ceccLogEntry, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, postLogEntry=postLogEntry, dmiLogTable=dmiLogTable, diskInterfaceType=diskInterfaceType, raidIsBBUAbsent=raidIsBBUAbsent, diskMediaType=diskMediaType, ueccLogTable=ueccLogTable, memTag=memTag, cpuName=cpuName, raidVDDiskCachePolicy=raidVDDiskCachePolicy, diskSmartStatus=diskSmartStatus, raidVDTargetId=raidVDTargetId, raidVDState=raidVDState, cpuDescription=cpuDescription, sysBIOSManufacturer=sysBIOSManufacturer, cpuCoreEnabled=cpuCoreEnabled, raidAdapterGroup_BBU=raidAdapterGroup_BBU, cpuThreadCount=cpuThreadCount, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterDeviceId=raidAdapterDeviceId, raidPDPredFailCount=raidPDPredFailCount, cpuTable=cpuTable, raidVDNumDrives=raidVDNumDrives, raidAdapterFWVersion=raidAdapterFWVersion, raidPDAllinoneMsg=raidPDAllinoneMsg, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDEntry=raidVDEntry, raidVDId=raidVDId, raidPDEntry=raidPDEntry, ceccLogDatetime=ceccLogDatetime, osIndex=osIndex, trapCpuFaultCritical=trapCpuFaultCritical, trapBatteryStatusWarning=trapBatteryStatusWarning, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDRawSize=raidPDRawSize, memEntry=memEntry, sysBIOSEntry=sysBIOSEntry, raidDiskGroupId=raidDiskGroupId, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memDeviceLocator=memDeviceLocator, smSuperDoctor5MIB=smSuperDoctor5MIB, raidAdapterId_PD=raidAdapterId_PD, raidPDIndex=raidPDIndex, raidPDNCQSetting=raidPDNCQSetting, raidAdapterIndex=raidAdapterIndex, smSD5TrapMIB=smSD5TrapMIB, trapBbpStatusWarning=trapBbpStatusWarning, diskTable=diskTable, raidVDAllinoneMsg=raidVDAllinoneMsg, diskSerialNumber=diskSerialNumber, raidVDSupportT10Power=raidVDSupportT10Power, raidBBUIndex=raidBBUIndex, mbAssetTag=mbAssetTag, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidVDEncryptionType=raidVDEncryptionType, memDataWidth=memDataWidth)
