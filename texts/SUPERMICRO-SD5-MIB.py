...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuThreadCount=cpuThreadCount, trapMemoryUeccNormal=trapMemoryUeccNormal, ceccLogIndex=ceccLogIndex, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterId_PD=raidAdapterId_PD, raidPDPort1Status=raidPDPort1Status, cpuLogIndex=cpuLogIndex, sd5MIBVersion=sd5MIBVersion, trapMemoryUeccWarning=trapMemoryUeccWarning, raidBBUIndex=raidBBUIndex, memPartNumber=memPartNumber, trapGenericWarning=trapGenericWarning, raidPDDeviceSpeed=raidPDDeviceSpeed, trapChassisIntrusion=trapChassisIntrusion, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterId_BBU=raidAdapterId_BBU, raidPDSlotNumber=raidPDSlotNumber, trapFanNormal=trapFanNormal, cpuLogTable=cpuLogTable, memTable=memTable, raidVDSpanDepth=raidVDSpanDepth, raidVDName=raidVDName, memSerialNumber=memSerialNumber, trapTemperatureNormal=trapTemperatureNormal, raidPDOpProgress=raidPDOpProgress, raidDiskGroupId=raidDiskGroupId, diskInterfaceType=diskInterfaceType, diskTable=diskTable, ceccLogDatetime=ceccLogDatetime, trapMemoryCeccNormal=trapMemoryCeccNormal, memUECCErrorCount=memUECCErrorCount, raidAdapterGroup=raidAdapterGroup, osEntry=osEntry, diskModel=diskModel, raidPDSerialNumber=raidPDSerialNumber, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, ceccLogTable=ceccLogTable, memModel=memModel, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDSupportsMaxPS=raidVDSupportsMaxPS, cpuID=cpuID, diskEntry=diskEntry, mbIndex=mbIndex, memDeviceLocator=memDeviceLocator, diskSize=diskSize, postLogTable=postLogTable, raidVDEncryptionType=raidVDEncryptionType, cpuDeviceVersion=cpuDeviceVersion, osManufacturer=osManufacturer, mbProductName=mbProductName, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidAdapterGroup_VD=raidAdapterGroup_VD, memECCErrorCount=memECCErrorCount, memLabeledBank=memLabeledBank, raidPDNCQSetting=raidPDNCQSetting, postLogEntry=postLogEntry, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, diskSerialNumber=diskSerialNumber, mbEntry=mbEntry, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuDeviceStatus=cpuDeviceStatus, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuName=cpuName, raidVDState=raidVDState, memDeviceStatus=memDeviceStatus, trapBatteryStatusNormal=trapBatteryStatusNormal, trapBbpStatusWarning=trapBbpStatusWarning, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterTable=raidAdapterTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, ceccLogInfo=ceccLogInfo, raidVDId=raidVDId, raidVDMirrorDataSize=raidVDMirrorDataSize, trapMemoryCeccCritical=trapMemoryCeccCritical, ceccLogEntry=ceccLogEntry, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDSupportT10Power=raidVDSupportT10Power, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuSocketDesignation=cpuSocketDesignation, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapBbpStatusNormal=trapBbpStatusNormal, osName=osName, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, diskSlotID=diskSlotID, raidAdapterFWVersion=raidAdapterFWVersion, raidPDMediaType=raidPDMediaType, memEntry=memEntry, raidAdapterProductName=raidAdapterProductName, raidBBUTable=raidBBUTable, raidPDAllinoneMsg=raidPDAllinoneMsg, memTotalWidth=memTotalWidth, diskSmartStatus=diskSmartStatus, diskVendor=diskVendor, trapFanCritical=trapFanCritical, trapGenericNormal=trapGenericNormal, raidPDAllinoneStatus=raidPDAllinoneStatus, osIndex=osIndex, diskName=diskName, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, postLogIndex=postLogIndex, osVersion=osVersion, raidPDOtherErrorCount=raidPDOtherErrorCount, trapBbpStatusCritical=trapBbpStatusCritical, raidVDIndex=raidVDIndex, cpuManufacturer=cpuManufacturer, raidPDLinkSpeed=raidPDLinkSpeed, cpuTable=cpuTable, memCapacity=memCapacity, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterSubDeviceId=raidAdapterSubDeviceId, cpuCoreCount=cpuCoreCount, raidPDTable=raidPDTable, trapMemoryUeccCritical=trapMemoryUeccCritical, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapCpuFaultNormal=trapCpuFaultNormal, trapFanWarning=trapFanWarning, raidAdapterId_VD=raidAdapterId_VD, trapVoltageNormal=trapVoltageNormal, sysBIOSReleaseDate=sysBIOSReleaseDate, sysBIOSManufacturer=sysBIOSManufacturer, raidAdapterId=raidAdapterId, raidVDRaidLevel=raidVDRaidLevel, trapTemperatureCritical=trapTemperatureCritical, raidDiskGroupId_PD=raidDiskGroupId_PD, ueccLogEntry=ueccLogEntry, raidPDRawSize=raidPDRawSize, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuDescription=cpuDescription, cpuMaxSpeed=cpuMaxSpeed, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDTable=raidVDTable, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDAllinoneStatus=raidVDAllinoneStatus, cpuEntry=cpuEntry, raidPDEntry=raidPDEntry, raidPDPort0Status=raidPDPort0Status, postLogDatetime=postLogDatetime, raidBBUEntry=raidBBUEntry, sd5Version=sd5Version, raidAdapterGroup_PD=raidAdapterGroup_PD, sysBIOSIndex=sysBIOSIndex, osTable=osTable, cpuIndex=cpuIndex, raidBBUStatus=raidBBUStatus, sd5Idx=sd5Idx, mbTable=mbTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapBatteryStatusWarning=trapBatteryStatusWarning, ueccLogDatetime=ueccLogDatetime, raidBBUAllinoneStatus=raidBBUAllinoneStatus, smSD5TrapMIB=smSD5TrapMIB, ueccLogIndex=ueccLogIndex, trapCpuFaultCritical=trapCpuFaultCritical, osCSDVersion=osCSDVersion, cpuLogEntry=cpuLogEntry, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterSubVendorId=raidAdapterSubVendorId, trapTemperatureWarning=trapTemperatureWarning, raidPDFirmwareState=raidPDFirmwareState, cpuLogInfo=cpuLogInfo, sysBIOSTable=sysBIOSTable, trapVoltageWarning=trapVoltageWarning, memDataWidth=memDataWidth, cpuLogDatetime=cpuLogDatetime, mbManufacturer=mbManufacturer, sysBIOSEntry=sysBIOSEntry, raidVDSize=raidVDSize, raidPDSpan=raidPDSpan, osSerialNumber=osSerialNumber, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDTargetId=raidVDTargetId, diskController=diskController, trapCpuFaultWarning=trapCpuFaultWarning, cpuDeviceID=cpuDeviceID, raidPDWriteCache=raidPDWriteCache, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapBatteryStatusCritical=trapBatteryStatusCritical, memDescription=memDescription, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, mbSerialNumber=mbSerialNumber, raidAdapterEntry=raidAdapterEntry, raidPDFirmwareRevision=raidPDFirmwareRevision, raidPDPredFailCount=raidPDPredFailCount, trapPowerSupplyNormal=trapPowerSupplyNormal, sd5Entry=sd5Entry, raidVDNumDrives=raidVDNumDrives, memManufacturer=memManufacturer, raidPDModel=raidPDModel, raidVDStripSize=raidVDStripSize, raidPDIndex=raidPDIndex, memTag=memTag, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDBadBlocksExist=raidVDBadBlocksExist, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, PYSNMP_MODULE_ID=smSuperDoctor5MIB, ueccLogTable=ueccLogTable, raidVDAllinoneMsg=raidVDAllinoneMsg, trapPowerSupplyWarning=trapPowerSupplyWarning, sd5Table=sd5Table, trapGenericCritical=trapGenericCritical, cpuCurrentSpeed=cpuCurrentSpeed, raidAdapterIndex=raidAdapterIndex, mbVersionName=mbVersionName, memErrorCount=memErrorCount, cpuCoreEnabled=cpuCoreEnabled, cpuLoadingPercentage=cpuLoadingPercentage, trapVoltageCritical=trapVoltageCritical, raidAdapterVendorId=raidAdapterVendorId, ueccLogInfo=ueccLogInfo, raidVDCached=raidVDCached, diskMediaType=diskMediaType, mbAssetTag=mbAssetTag, sysBIOSVersion=sysBIOSVersion, raidPDInquiryData=raidPDInquiryData, raidVDEntry=raidVDEntry, postLogInfo=postLogInfo, raidAdapterBIOSVersion=raidAdapterBIOSVersion, dmiLogTable=dmiLogTable)
