...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memTable=memTable, postLogTable=postLogTable, trapMemoryUeccWarning=trapMemoryUeccWarning, raidPDFirmwareRevision=raidPDFirmwareRevision, memSerialNumber=memSerialNumber, raidPDWriteCache=raidPDWriteCache, raidVDName=raidVDName, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuEntry=cpuEntry, cpuDeviceVersion=cpuDeviceVersion, raidAdapterFWVersion=raidAdapterFWVersion, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, diskSize=diskSize, raidPDNCQSetting=raidPDNCQSetting, cpuMaxSpeed=cpuMaxSpeed, raidAdapterId_PD=raidAdapterId_PD, postLogDatetime=postLogDatetime, cpuDeviceStatus=cpuDeviceStatus, memDescription=memDescription, raidVDAllinoneStatus=raidVDAllinoneStatus, sysBIOSVersion=sysBIOSVersion, raidBBUEntry=raidBBUEntry, memDeviceStatus=memDeviceStatus, trapGenericCritical=trapGenericCritical, diskVendor=diskVendor, cpuDeviceID=cpuDeviceID, raidVDNumDrives=raidVDNumDrives, postLogEntry=postLogEntry, memLabeledBank=memLabeledBank, cpuManufacturer=cpuManufacturer, cpuCurrentSpeed=cpuCurrentSpeed, osVersion=osVersion, diskController=diskController, cpuLogEntry=cpuLogEntry, cpuTable=cpuTable, raidAdapterId_VD=raidAdapterId_VD, mbTable=mbTable, cpuLogIndex=cpuLogIndex, memCapacity=memCapacity, raidVDId=raidVDId, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidDiskGroupId_PD=raidDiskGroupId_PD, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, osSerialNumber=osSerialNumber, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterProductName=raidAdapterProductName, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDMediaType=raidPDMediaType, sd5Table=sd5Table, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDState=raidVDState, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, mbVersionName=mbVersionName, trapBbpStatusWarning=trapBbpStatusWarning, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapGenericWarning=trapGenericWarning, raidPDPort0Linkspeed=raidPDPort0Linkspeed, osIndex=osIndex, cpuDescription=cpuDescription, dmiLogTable=dmiLogTable, osCSDVersion=osCSDVersion, diskSerialNumber=diskSerialNumber, mbIndex=mbIndex, raidBBUTable=raidBBUTable, raidVDStripSize=raidVDStripSize, cpuLoadingPercentage=cpuLoadingPercentage, postLogInfo=postLogInfo, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, sd5Entry=sd5Entry, trapFanWarning=trapFanWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, ueccLogIndex=ueccLogIndex, mbEntry=mbEntry, raidPDAllinoneStatus=raidPDAllinoneStatus, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, smSD5TrapMIB=smSD5TrapMIB, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, diskModel=diskModel, osTable=osTable, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDPort0Status=raidPDPort0Status, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDDeviceSpeed=raidPDDeviceSpeed, diskEntry=diskEntry, ceccLogEntry=ceccLogEntry, diskTable=diskTable, raidAdapterTable=raidAdapterTable, diskInterfaceType=diskInterfaceType, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDTable=raidVDTable, trapCpuFaultNormal=trapCpuFaultNormal, trapBbpStatusNormal=trapBbpStatusNormal, ceccLogInfo=ceccLogInfo, diskName=diskName, trapTemperatureWarning=trapTemperatureWarning, raidVDEntry=raidVDEntry, trapVoltageNormal=trapVoltageNormal, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidIsBBUAbsent=raidIsBBUAbsent, raidPDIndex=raidPDIndex, cpuCoreEnabled=cpuCoreEnabled, trapCpuFaultWarning=trapCpuFaultWarning, memErrorCount=memErrorCount, raidDiskGroupId=raidDiskGroupId, raidVDSize=raidVDSize, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, osEntry=osEntry, raidPDSpan=raidPDSpan, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDFirmwareState=raidPDFirmwareState, cpuSocketDesignation=cpuSocketDesignation, diskSlotID=diskSlotID, diskSmartStatus=diskSmartStatus, raidAdapterVendorId=raidAdapterVendorId, ceccLogDatetime=ceccLogDatetime, cpuLogTable=cpuLogTable, raidAdapterId_BBU=raidAdapterId_BBU, trapTemperatureNormal=trapTemperatureNormal, memTotalWidth=memTotalWidth, trapBbpStatusCritical=trapBbpStatusCritical, diskMediaType=diskMediaType, memModel=memModel, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDMirrorDataSize=raidVDMirrorDataSize, trapBatteryStatusWarning=trapBatteryStatusWarning, ueccLogInfo=ueccLogInfo, raidAdapterDeviceId=raidAdapterDeviceId, trapVoltageCritical=trapVoltageCritical, memECCErrorCount=memECCErrorCount, cpuName=cpuName, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDSupportT10Power=raidVDSupportT10Power, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDRaidLevel=raidVDRaidLevel, trapPowerSupplyNormal=trapPowerSupplyNormal, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapPowerSupplyCritical=trapPowerSupplyCritical, cpuLogDatetime=cpuLogDatetime, raidVDCached=raidVDCached, raidPDSerialNumber=raidPDSerialNumber, memEntry=memEntry, sysBIOSTable=sysBIOSTable, ueccLogDatetime=ueccLogDatetime, trapMemoryUeccCritical=trapMemoryUeccCritical, cpuThreadCount=cpuThreadCount, cpuID=cpuID, memDeviceLocator=memDeviceLocator, raidAdapterEntry=raidAdapterEntry, osManufacturer=osManufacturer, ceccLogTable=ceccLogTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidPDTable=raidPDTable, raidPDRawSize=raidPDRawSize, raidAdapterId=raidAdapterId, osName=osName, raidAdapterSerialNumber=raidAdapterSerialNumber, ceccLogIndex=ceccLogIndex, smSuperDoctor5MIB=smSuperDoctor5MIB, trapTemperatureCritical=trapTemperatureCritical, raidAdapterIndex=raidAdapterIndex, ueccLogEntry=ueccLogEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDSpanDepth=raidVDSpanDepth, trapChassisIntrusion=trapChassisIntrusion, cpuIndex=cpuIndex, trapFanNormal=trapFanNormal, sd5Version=sd5Version, memManufacturer=memManufacturer, raidPDInquiryData=raidPDInquiryData, memTag=memTag, cpuLogInfo=cpuLogInfo, raidBBUStatus=raidBBUStatus, raidPDModel=raidPDModel, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapPowerSupplyWarning=trapPowerSupplyWarning, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, sysBIOSEntry=sysBIOSEntry, mbSerialNumber=mbSerialNumber, sd5Idx=sd5Idx, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDPort1Status=raidPDPort1Status, raidPDMediaErrorCount=raidPDMediaErrorCount, sysBIOSManufacturer=sysBIOSManufacturer, raidPDPredFailCount=raidPDPredFailCount, trapVoltageWarning=trapVoltageWarning, raidAdapterGroup=raidAdapterGroup, memPartNumber=memPartNumber, raidPDOtherErrorCount=raidPDOtherErrorCount, trapMemoryCeccCritical=trapMemoryCeccCritical, trapGenericNormal=trapGenericNormal, trapFanCritical=trapFanCritical, raidVDIndex=raidVDIndex, raidVDDiskCachePolicy=raidVDDiskCachePolicy, postLogIndex=postLogIndex, memDataWidth=memDataWidth, sysBIOSIndex=sysBIOSIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDOpProgress=raidPDOpProgress, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapCpuFaultCritical=trapCpuFaultCritical, raidVDEncryptionType=raidVDEncryptionType, sd5MIBVersion=sd5MIBVersion, memUECCErrorCount=memUECCErrorCount, mbAssetTag=mbAssetTag, ueccLogTable=ueccLogTable, raidBBUIndex=raidBBUIndex, raidPDSlotNumber=raidPDSlotNumber, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDEntry=raidPDEntry, PYSNMP_MODULE_ID=smSuperDoctor5MIB, mbProductName=mbProductName, raidVDTargetId=raidVDTargetId, mbManufacturer=mbManufacturer, cpuCoreCount=cpuCoreCount, raidBBUAllinoneMsg=raidBBUAllinoneMsg)
