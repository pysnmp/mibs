...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidIsBBUAbsent=raidIsBBUAbsent, cpuDescription=cpuDescription, raidVDIndex=raidVDIndex, trapBatteryStatusWarning=trapBatteryStatusWarning, sysBIOSIndex=sysBIOSIndex, sysBIOSReleaseDate=sysBIOSReleaseDate, raidVDMirrorDataSize=raidVDMirrorDataSize, ueccLogDatetime=ueccLogDatetime, raidPDMediaType=raidPDMediaType, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidAdapterSerialNumber=raidAdapterSerialNumber, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidBBUAllinoneStatus=raidBBUAllinoneStatus, ueccLogTable=ueccLogTable, trapMemoryCeccCritical=trapMemoryCeccCritical, memPartNumber=memPartNumber, cpuLogIndex=cpuLogIndex, raidBBUTable=raidBBUTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memEntry=memEntry, cpuLogEntry=cpuLogEntry, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidAdapterGroup_PD=raidAdapterGroup_PD, trapMemoryCeccNormal=trapMemoryCeccNormal, diskSerialNumber=diskSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidDiskGroupId=raidDiskGroupId, ceccLogIndex=ceccLogIndex, raidPDIndex=raidPDIndex, ueccLogEntry=ueccLogEntry, cpuMaxSpeed=cpuMaxSpeed, memCapacity=memCapacity, raidPDPredFailCount=raidPDPredFailCount, raidPDSerialNumber=raidPDSerialNumber, memManufacturer=memManufacturer, memUECCErrorCount=memUECCErrorCount, postLogIndex=postLogIndex, raidVDSpanDepth=raidVDSpanDepth, trapVoltageCritical=trapVoltageCritical, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuTable=cpuTable, trapVoltageWarning=trapVoltageWarning, sysBIOSManufacturer=sysBIOSManufacturer, raidPDTable=raidPDTable, osManufacturer=osManufacturer, postLogDatetime=postLogDatetime, raidVDSize=raidVDSize, cpuEntry=cpuEntry, mbSerialNumber=mbSerialNumber, trapMemoryCeccWarning=trapMemoryCeccWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, osEntry=osEntry, raidAdapterId=raidAdapterId, trapMemoryUeccNormal=trapMemoryUeccNormal, diskSmartStatus=diskSmartStatus, sysBIOSEntry=sysBIOSEntry, trapFanWarning=trapFanWarning, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, postLogEntry=postLogEntry, osIndex=osIndex, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterTable=raidAdapterTable, memTag=memTag, mbAssetTag=mbAssetTag, trapPowerSupplyNormal=trapPowerSupplyNormal, raidAdapterGroup=raidAdapterGroup, raidPDOtherErrorCount=raidPDOtherErrorCount, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapTemperatureNormal=trapTemperatureNormal, raidPDOpProgress=raidPDOpProgress, raidAdapterEntry=raidAdapterEntry, sd5Version=sd5Version, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, diskEntry=diskEntry, memErrorCount=memErrorCount, diskSize=diskSize, trapPowerSupplyCritical=trapPowerSupplyCritical, trapFanCritical=trapFanCritical, memSerialNumber=memSerialNumber, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDInquiryData=raidPDInquiryData, trapChassisIntrusion=trapChassisIntrusion, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, trapBbpStatusWarning=trapBbpStatusWarning, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, ceccLogTable=ceccLogTable, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDPort0Status=raidPDPort0Status, postLogInfo=postLogInfo, raidPDMediaErrorCount=raidPDMediaErrorCount, raidPDDeviceSpeed=raidPDDeviceSpeed, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapTemperatureWarning=trapTemperatureWarning, cpuIndex=cpuIndex, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDTable=raidVDTable, raidPDNCQSetting=raidPDNCQSetting, memDeviceLocator=memDeviceLocator, memTable=memTable, raidAdapterGroup_BBU=raidAdapterGroup_BBU, diskInterfaceType=diskInterfaceType, trapFanNormal=trapFanNormal, memDataWidth=memDataWidth, raidVDStripSize=raidVDStripSize, raidVDEncryptionType=raidVDEncryptionType, postLogTable=postLogTable, diskSlotID=diskSlotID, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapGenericWarning=trapGenericWarning, raidPDRawSize=raidPDRawSize, sd5MIBVersion=sd5MIBVersion, raidDiskGroupId_PD=raidDiskGroupId_PD, raidBBUIndex=raidBBUIndex, raidBBUEntry=raidBBUEntry, raidAdapterDeviceId=raidAdapterDeviceId, osSerialNumber=osSerialNumber, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapCpuFaultNormal=trapCpuFaultNormal, trapVoltageNormal=trapVoltageNormal, cpuCurrentSpeed=cpuCurrentSpeed, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapGenericCritical=trapGenericCritical, sd5Entry=sd5Entry, raidVDDiskCachePolicy=raidVDDiskCachePolicy, cpuDeviceID=cpuDeviceID, sysBIOSTable=sysBIOSTable, raidAdapterGroup_VD=raidAdapterGroup_VD, raidBBUStatus=raidBBUStatus, dmiLogTable=dmiLogTable, raidPDPort0Linkspeed=raidPDPort0Linkspeed, diskMediaType=diskMediaType, ueccLogInfo=ueccLogInfo, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDAllinoneStatus=raidPDAllinoneStatus, ceccLogInfo=ceccLogInfo, sd5Idx=sd5Idx, memTotalWidth=memTotalWidth, raidPDWriteCache=raidPDWriteCache, mbTable=mbTable, diskTable=diskTable, trapTemperatureCritical=trapTemperatureCritical, cpuLoadingPercentage=cpuLoadingPercentage, cpuLogTable=cpuLogTable, raidPDLinkSpeed=raidPDLinkSpeed, sysBIOSVersion=sysBIOSVersion, mbProductName=mbProductName, trapMemoryUeccWarning=trapMemoryUeccWarning, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDSupportT10Power=raidVDSupportT10Power, mbManufacturer=mbManufacturer, raidAdapterIndex=raidAdapterIndex, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDEntry=raidVDEntry, ceccLogDatetime=ceccLogDatetime, cpuCoreEnabled=cpuCoreEnabled, sd5Table=sd5Table, cpuLogDatetime=cpuLogDatetime, osName=osName, trapBatteryStatusNormal=trapBatteryStatusNormal, diskModel=diskModel, trapMemoryUeccCritical=trapMemoryUeccCritical, raidVDAllinoneMsg=raidVDAllinoneMsg, ceccLogEntry=ceccLogEntry, raidAdapterId_PD=raidAdapterId_PD, cpuManufacturer=cpuManufacturer, memModel=memModel, raidVDCached=raidVDCached, raidVDAllinoneStatus=raidVDAllinoneStatus, memDeviceStatus=memDeviceStatus, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterProductName=raidAdapterProductName, raidVDRaidLevel=raidVDRaidLevel, raidVDId=raidVDId, raidPDEntry=raidPDEntry, cpuName=cpuName, memECCErrorCount=memECCErrorCount, smSD5TrapMIB=smSD5TrapMIB, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, ueccLogIndex=ueccLogIndex, smSuperDoctor5MIB=smSuperDoctor5MIB, raidAdapterVendorId=raidAdapterVendorId, mbIndex=mbIndex, cpuThreadCount=cpuThreadCount, mbEntry=mbEntry, memLabeledBank=memLabeledBank, mbVersionName=mbVersionName, memDescription=memDescription, trapCpuFaultWarning=trapCpuFaultWarning, cpuID=cpuID, cpuCoreCount=cpuCoreCount, raidAdapterFWVersion=raidAdapterFWVersion, raidVDState=raidVDState, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDName=raidVDName, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuDeviceStatus=cpuDeviceStatus, diskVendor=diskVendor, diskController=diskController, osVersion=osVersion, raidAdapterSubVendorId=raidAdapterSubVendorId, raidAdapterId_VD=raidAdapterId_VD, cpuSocketDesignation=cpuSocketDesignation, cpuLogInfo=cpuLogInfo, raidVDNumDrives=raidVDNumDrives, raidPDSpan=raidPDSpan, trapBbpStatusNormal=trapBbpStatusNormal, osTable=osTable, trapBbpStatusCritical=trapBbpStatusCritical, trapCpuFaultCritical=trapCpuFaultCritical, osCSDVersion=osCSDVersion, raidPDModel=raidPDModel, cpuDeviceVersion=cpuDeviceVersion, raidPDPort1Status=raidPDPort1Status, raidVDTargetId=raidVDTargetId, raidPDFirmwareState=raidPDFirmwareState, trapGenericNormal=trapGenericNormal, diskName=diskName, raidPDSlotNumber=raidPDSlotNumber, raidVDBadBlocksExist=raidVDBadBlocksExist)
