...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapBatteryStatusCritical=trapBatteryStatusCritical, osCSDVersion=osCSDVersion, raidPDRawSize=raidPDRawSize, sysBIOSManufacturer=sysBIOSManufacturer, trapCpuFaultNormal=trapCpuFaultNormal, trapVoltageWarning=trapVoltageWarning, raidAdapterDeviceId=raidAdapterDeviceId, cpuLogEntry=cpuLogEntry, raidVDRaidLevel=raidVDRaidLevel, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDPort1Status=raidPDPort1Status, raidBBUStatus=raidBBUStatus, raidAdapterVendorId=raidAdapterVendorId, sd5Version=sd5Version, raidAdapterId_VD=raidAdapterId_VD, trapBbpStatusNormal=trapBbpStatusNormal, memTable=memTable, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDAllinoneMsg=raidPDAllinoneMsg, memEntry=memEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, memPartNumber=memPartNumber, raidPDWriteCache=raidPDWriteCache, memTag=memTag, trapTemperatureWarning=trapTemperatureWarning, diskSlotID=diskSlotID, trapChassisIntrusion=trapChassisIntrusion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, memECCErrorCount=memECCErrorCount, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, ueccLogEntry=ueccLogEntry, raidPDSpan=raidPDSpan, cpuLogInfo=cpuLogInfo, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuDeviceVersion=cpuDeviceVersion, memDeviceStatus=memDeviceStatus, raidPDDeviceSpeed=raidPDDeviceSpeed, trapMemoryCeccCritical=trapMemoryCeccCritical, diskName=diskName, osSerialNumber=osSerialNumber, raidBBUEntry=raidBBUEntry, trapGenericCritical=trapGenericCritical, memSerialNumber=memSerialNumber, memModel=memModel, cpuTable=cpuTable, raidAdapterProductName=raidAdapterProductName, ueccLogInfo=ueccLogInfo, cpuEntry=cpuEntry, raidPDPredFailCount=raidPDPredFailCount, raidPDMediaType=raidPDMediaType, raidAdapterSerialNumber=raidAdapterSerialNumber, cpuCoreCount=cpuCoreCount, ueccLogTable=ueccLogTable, trapFanWarning=trapFanWarning, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuID=cpuID, raidBBUTable=raidBBUTable, raidVDNumDrives=raidVDNumDrives, raidVDDiskCachePolicy=raidVDDiskCachePolicy, mbSerialNumber=mbSerialNumber, trapFanNormal=trapFanNormal, trapPowerSupplyCritical=trapPowerSupplyCritical, cpuCurrentSpeed=cpuCurrentSpeed, raidBBUAllinoneStatus=raidBBUAllinoneStatus, cpuLogTable=cpuLogTable, raidVDState=raidVDState, raidAdapterEntry=raidAdapterEntry, raidVDName=raidVDName, sysBIOSTable=sysBIOSTable, raidVDEncryptionType=raidVDEncryptionType, raidVDTargetId=raidVDTargetId, raidPDIndex=raidPDIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, trapVoltageNormal=trapVoltageNormal, mbEntry=mbEntry, trapMemoryUeccWarning=trapMemoryUeccWarning, sd5MIBVersion=sd5MIBVersion, cpuMaxSpeed=cpuMaxSpeed, trapGenericNormal=trapGenericNormal, diskMediaType=diskMediaType, mbVersionName=mbVersionName, trapGenericWarning=trapGenericWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, sysBIOSReleaseDate=sysBIOSReleaseDate, mbIndex=mbIndex, raidDiskGroupId=raidDiskGroupId, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDOpProgress=raidPDOpProgress, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuLogIndex=cpuLogIndex, memDeviceLocator=memDeviceLocator, raidVDId=raidVDId, raidIsBBUAbsent=raidIsBBUAbsent, ceccLogInfo=ceccLogInfo, raidVDEntry=raidVDEntry, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, sysBIOSEntry=sysBIOSEntry, cpuLogDatetime=cpuLogDatetime, mbTable=mbTable, trapPowerSupplyWarning=trapPowerSupplyWarning, diskModel=diskModel, trapBbpStatusWarning=trapBbpStatusWarning, raidVDStripSize=raidVDStripSize, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapMemoryUeccNormal=trapMemoryUeccNormal, memManufacturer=memManufacturer, diskSize=diskSize, raidVDSize=raidVDSize, raidPDInquiryData=raidPDInquiryData, cpuDescription=cpuDescription, ceccLogDatetime=ceccLogDatetime, cpuCoreEnabled=cpuCoreEnabled, raidVDTable=raidVDTable, raidVDAllinoneMsg=raidVDAllinoneMsg, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, smSuperDoctor5MIB=smSuperDoctor5MIB, diskInterfaceType=diskInterfaceType, memErrorCount=memErrorCount, raidPDEntry=raidPDEntry, ceccLogEntry=ceccLogEntry, raidPDFirmwareState=raidPDFirmwareState, trapMemoryUeccCritical=trapMemoryUeccCritical, diskEntry=diskEntry, raidAdapterGroup_VD=raidAdapterGroup_VD, ceccLogTable=ceccLogTable, cpuManufacturer=cpuManufacturer, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDDeviceFwLevel=raidPDDeviceFwLevel, cpuName=cpuName, postLogDatetime=postLogDatetime, memCapacity=memCapacity, raidAdapterIndex=raidAdapterIndex, sd5Table=sd5Table, PYSNMP_MODULE_ID=smSuperDoctor5MIB, osIndex=osIndex, diskSmartStatus=diskSmartStatus, raidVDSpanDepth=raidVDSpanDepth, diskSerialNumber=diskSerialNumber, trapCpuFaultWarning=trapCpuFaultWarning, ceccLogIndex=ceccLogIndex, diskTable=diskTable, raidPDNCQSetting=raidPDNCQSetting, cpuLoadingPercentage=cpuLoadingPercentage, raidVDIndex=raidVDIndex, smSD5TrapMIB=smSD5TrapMIB, raidPDTable=raidPDTable, raidAdapterGroup=raidAdapterGroup, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuThreadCount=cpuThreadCount, raidAdapterTable=raidAdapterTable, raidPDPort1Linkspeed=raidPDPort1Linkspeed, osVersion=osVersion, diskVendor=diskVendor, raidAdapterId=raidAdapterId, osTable=osTable, memDataWidth=memDataWidth, memTotalWidth=memTotalWidth, raidPDLinkSpeed=raidPDLinkSpeed, raidPDPort0Status=raidPDPort0Status, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, trapFanCritical=trapFanCritical, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapPowerSupplyNormal=trapPowerSupplyNormal, raidPDSlotNumber=raidPDSlotNumber, trapBatteryStatusWarning=trapBatteryStatusWarning, trapTemperatureNormal=trapTemperatureNormal, memDescription=memDescription, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, memUECCErrorCount=memUECCErrorCount, ueccLogDatetime=ueccLogDatetime, mbAssetTag=mbAssetTag, raidVDSupportT10Power=raidVDSupportT10Power, postLogEntry=postLogEntry, raidVDCached=raidVDCached, cpuSocketDesignation=cpuSocketDesignation, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDOtherErrorCount=raidPDOtherErrorCount, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, memLabeledBank=memLabeledBank, mbManufacturer=mbManufacturer, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, trapCpuFaultCritical=trapCpuFaultCritical, raidPDSerialNumber=raidPDSerialNumber, trapVoltageCritical=trapVoltageCritical, postLogTable=postLogTable, raidBBUAllinoneMsg=raidBBUAllinoneMsg, diskController=diskController, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterSubDeviceId=raidAdapterSubDeviceId, mbProductName=mbProductName, sd5Idx=sd5Idx, dmiLogTable=dmiLogTable, sysBIOSVersion=sysBIOSVersion, cpuIndex=cpuIndex, raidVDBadBlocksExist=raidVDBadBlocksExist, raidAdapterId_PD=raidAdapterId_PD, sd5Entry=sd5Entry, raidPDFirmwareRevision=raidPDFirmwareRevision, osEntry=osEntry, cpuDeviceID=cpuDeviceID, osManufacturer=osManufacturer, trapTemperatureCritical=trapTemperatureCritical, raidBBUIndex=raidBBUIndex, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, sysBIOSIndex=sysBIOSIndex, osName=osName, trapBbpStatusCritical=trapBbpStatusCritical, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDModel=raidPDModel, postLogIndex=postLogIndex, postLogInfo=postLogInfo, ueccLogIndex=ueccLogIndex, cpuDeviceStatus=cpuDeviceStatus, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus)
