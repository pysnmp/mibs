...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:21:31 2023
...
ModuleIdentity, Unsigned32, IpAddress, Gauge32, Integer32, NotificationType, NotificationType, Bits, iso, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "IpAddress", "Gauge32", "Integer32", "NotificationType", "NotificationType", "Bits", "iso", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEntry=modemEntry, product=product, ethTXPauseFrames=ethTXPauseFrames, hostname=hostname, e1t1StatEntry=e1t1StatEntry, modemErroredBlock=modemErroredBlock, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioMgmt=ipRadioMgmt, vlanTable=vlanTable, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, modemAcqStatus=modemAcqStatus, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, modemGeneralStatus=modemGeneralStatus, licenseMask=licenseMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStatistics=modemStatistics, pointToPoint=pointToPoint, modemACMengine=modemACMengine, radioTable=radioTable, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, radioDuplexShift=radioDuplexShift, restartcpu=restartcpu, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxMute=radioTxMute, modemACMmodulationMax=modemACMmodulationMax, loopbacks=loopbacks, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, ipRadio=ipRadio, ethTXCollisions=ethTXCollisions, ethRXPauseFrames=ethRXPauseFrames, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, vlanRowStatus=vlanRowStatus, ipRadioStat=ipRadioStat, tehnika=tehnika, ethRXDribleNibbles=ethRXDribleNibbles, radioTxPower=radioTxPower, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, vlanPortmap=vlanPortmap, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioEntry=radioEntry, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, license=license, sysDateAndTime=sysDateAndTime, vlansEnabled=vlansEnabled, modemTable=modemTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, ethRXPrevPktDropped=ethRXPrevPktDropped, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, ethRXMulticasts=ethRXMulticasts, modemEthernetCapacity=modemEthernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfg=ipRadioCfg, ethRXDvEvent=ethRXDvEvent, ethRXBroadcasts=ethRXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, radioRxLevel=radioRxLevel, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecond=modemErroredSecond, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, remoteIp=remoteIp, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, radioTxFrequency=radioTxFrequency, radioLoopback=radioLoopback, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ethRXCRCErrors=ethRXCRCErrors, ethTXGiants=ethTXGiants, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateRx=modemSymbolRateRx, vlanNumber=vlanNumber, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, ethRXControlFrames=ethRXControlFrames, radioRxFrequency=radioRxFrequency, localIp=localIp, radioIndex=radioIndex, radioSide=radioSide, modemUnavailtime=modemUnavailtime, saf=saf, modemModulation=modemModulation, description=description, loopback_tributary_mask=loopback_tributary_mask)
