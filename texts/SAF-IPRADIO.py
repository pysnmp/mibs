...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:23:07 2024
...
enterprises, ObjectIdentity, Gauge32, Bits, Counter64, Unsigned32, TimeTicks, Integer32, ModuleIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Gauge32", "Bits", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask, ethTXBackpresEvents=ethTXBackpresEvents, modemStatistics=modemStatistics, radioTxMute=radioTxMute, sysDateAndTime=sysDateAndTime, ethRXCodeErrors=ethRXCodeErrors, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, tehnika=tehnika, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemCarrierOffset=modemCarrierOffset, radioSide=radioSide, modemInternalAGCgain=modemInternalAGCgain, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateTx=modemSymbolRateTx, modemUnavailtime=modemUnavailtime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysTemperature=sysTemperature, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, e1t1AIS=e1t1AIS, vlanEntry=vlanEntry, ethRXDones=ethRXDones, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatTable=e1t1StatTable, loopbacks=loopbacks, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, vlanRowStatus=vlanRowStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, restartcpu=restartcpu, ethRXByteCounterHi=ethRXByteCounterHi, modemTable=modemTable, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, modemAcqStatus=modemAcqStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, saf=saf, modemLastAcqError=modemLastAcqError, radioTxPower=radioTxPower, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStandard=modemStandard, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, remoteIp=remoteIp, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredSecond=modemErroredSecond, radioIndex=radioIndex, ethGFPDropedFrames=ethGFPDropedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, product=product, radioRxFrequency=radioRxFrequency, modemUptime=modemUptime, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, ethRXMulticasts=ethRXMulticasts, description=description, ipRadioCfgNetwork=ipRadioCfgNetwork, modemModulation=modemModulation, ethQOSTXFrames=ethQOSTXFrames, radioEntry=radioEntry, radioTable=radioTable, vlanCfgStat=vlanCfgStat, vlanPortType=vlanPortType, modemE1T1Channels=modemE1T1Channels, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, radioGenStatus=radioGenStatus, ethRXBroadcasts=ethRXBroadcasts, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, vlanTable=vlanTable, modemEntry=modemEntry, modemACMmodulationMax=modemACMmodulationMax, modemEthernetCapacity=modemEthernetCapacity, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, modemRadialMSE=modemRadialMSE, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemCountTime=modemCountTime, aTPCTable=aTPCTable, license=license, ethTXByteCounterHi=ethTXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, safip=safip, ipRadio=ipRadio, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, localIp=localIp, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateRx=modemSymbolRateRx, modemIndex=modemIndex, ethTXDones=ethTXDones, modemACMengine=modemACMengine, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, modemErroredBlock=modemErroredBlock, ethTXBroadcasts=ethTXBroadcasts, ethTXGiants=ethTXGiants, modemRowStatus=modemRowStatus)
