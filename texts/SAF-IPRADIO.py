...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:54:13 2024
...
TimeTicks, Unsigned32, Counter32, ObjectIdentity, enterprises, Counter64, NotificationType, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, MibIdentifier, IpAddress, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "ObjectIdentity", "enterprises", "Counter64", "NotificationType", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "MibIdentifier", "IpAddress", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEntry=modemEntry, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, tehnika=tehnika, licenseUpdateStatus=licenseUpdateStatus, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, modemUnavailtime=modemUnavailtime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioMgmt=ipRadioMgmt, ethRXCRCErrors=ethRXCRCErrors, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, modemE1T1Channels=modemE1T1Channels, vlansEnabled=vlansEnabled, writeConfig=writeConfig, restartcpu=restartcpu, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMax=modemACMmodulationMax, ethTXPauseFrames=ethTXPauseFrames, ethRXMulticasts=ethRXMulticasts, ethRXDvEvent=ethRXDvEvent, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity, remoteIp=remoteIp, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, ethTXUnderruns=ethTXUnderruns, radioRxLevel=radioRxLevel, modemAcqStatus=modemAcqStatus, ipRadioCfg=ipRadioCfg, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, loopbacks=loopbacks, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, description=description, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCRCErrors=ethTXCRCErrors, ipRadioStatEth=ipRadioStatEth, ethRXByteCounterHi=ethRXByteCounterHi, pointToPoint=pointToPoint, ethTXDones=ethTXDones, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, vlanTable=vlanTable, ethTXVlanTags=ethTXVlanTags, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, modemSeverelyErroredSecond=modemSeverelyErroredSecond, sysDateAndTime=sysDateAndTime, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, modemStatistics=modemStatistics, ethTXCollisions=ethTXCollisions, modemTable=modemTable, modemRadialMSE=modemRadialMSE, modemErroredSecondRatio=modemErroredSecondRatio, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanEntry=vlanEntry, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, modemIndex=modemIndex, modemUptime=modemUptime, radioTable=radioTable, aTPCEntry=aTPCEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, radioSide=radioSide, hostname=hostname, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, product=product, ethQOSTXFrames=ethQOSTXFrames, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, vlanNumber=vlanNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, modemBandwith=modemBandwith, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortType=vlanPortType, localIp=localIp, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBackpresEvents=ethTXBackpresEvents, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf, e1t1StatTable=e1t1StatTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, microwaveRadio=microwaveRadio, ipRadio=ipRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, modemCountTime=modemCountTime, ethTXMulticasts=ethTXMulticasts, license=license)
