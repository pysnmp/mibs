...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:17:01 2024
...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Unsigned32, MibIdentifier, Bits, ModuleIdentity, Counter32, iso, enterprises, ObjectIdentity, IpAddress, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Unsigned32", "MibIdentifier", "Bits", "ModuleIdentity", "Counter32", "iso", "enterprises", "ObjectIdentity", "IpAddress", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortmap=vlanPortmap, licenseMask=licenseMask, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, localIpMask=localIpMask, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStat=ipRadioStat, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxPower=radioTxPower, modemStandard=modemStandard, modemEthernetCapacity=modemEthernetCapacity, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadio=ipRadio, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, ethRXBroadcasts=ethRXBroadcasts, e1t1AIS=e1t1AIS, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, pointToPoint=pointToPoint, loopback_tributary_mask=loopback_tributary_mask, sysTemperature=sysTemperature, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, atpcTxPowerCorrection=atpcTxPowerCorrection, restartcpu=restartcpu, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, e1t1StatTable=e1t1StatTable, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfg=ipRadioCfg, vlanNumber=vlanNumber, ethGFPDropedFrames=ethGFPDropedFrames, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, radioLoopback=radioLoopback, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, aTPCTable=aTPCTable, modemCarrierOffset=modemCarrierOffset, writeConfig=writeConfig, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, modemIndex=modemIndex, modemUptime=modemUptime, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanRowStatus=vlanRowStatus, modemErroredSecond=modemErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterHi=ethRXByteCounterHi, localIp=localIp, radioTable=radioTable, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, modemStatistics=modemStatistics, hostname=hostname, ethTXDones=ethTXDones, radioSide=radioSide, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, ethQOSTXDropped=ethQOSTXDropped, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, ethTXUnderruns=ethTXUnderruns, license=license, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, modemTable=modemTable, ipRadioMgmt=ipRadioMgmt, radioTxMute=radioTxMute, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, e1t1ChannelNr=e1t1ChannelNr, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanTable=vlanTable, tehnika=tehnika, product=product, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredBlock=modemErroredBlock, modemRowStatus=modemRowStatus, radioGenStatus=radioGenStatus, saf=saf, ethQOSTXFrames=ethQOSTXFrames, loopbacks=loopbacks, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemAcqStatus=modemAcqStatus, ethTXBroadcasts=ethTXBroadcasts, vlanPortType=vlanPortType, radioTxFrequency=radioTxFrequency, ethRXCodeErrors=ethRXCodeErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSymbolRateRx=modemSymbolRateRx, description=description, modemModulation=modemModulation, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, atpcEnabled=atpcEnabled, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDones=ethRXDones, atpcIndex=atpcIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanEntry=vlanEntry, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid)
