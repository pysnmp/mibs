...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:27:30 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, MibIdentifier, NotificationType, enterprises, TimeTicks, Counter32, Bits, IpAddress, iso, Unsigned32, NotificationType, Gauge32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "MibIdentifier", "NotificationType", "enterprises", "TimeTicks", "Counter32", "Bits", "IpAddress", "iso", "Unsigned32", "NotificationType", "Gauge32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1AIS=e1t1AIS, vlansEnabled=vlansEnabled, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, e1t1StatEntry=e1t1StatEntry, vlanRowStatus=vlanRowStatus, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortType=vlanPortType, ethRXDvEvent=ethRXDvEvent, e1t1ChannelNr=e1t1ChannelNr, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, restartcpu=restartcpu, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, description=description, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, e1t1LOS=e1t1LOS, modemRowStatus=modemRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMin=modemACMmodulationMin, safip=safip, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, loopbacks=loopbacks, ethRXPrevPktDropped=ethRXPrevPktDropped, radioSide=radioSide, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, modemACMtotalCapacity=modemACMtotalCapacity, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, radioTxMute=radioTxMute, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateTx=modemSymbolRateTx, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, hostname=hostname, radioGenStatus=radioGenStatus, atpcIndex=atpcIndex, radioEntry=radioEntry, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, modemTable=modemTable, licenseUpdateStatus=licenseUpdateStatus, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, ethRXDones=ethRXDones, modemACMengine=modemACMengine, ethQOSTXDropped=ethQOSTXDropped, ipRadioMgmt=ipRadioMgmt, product=product, modemBackgroundBlockErrror=modemBackgroundBlockErrror, licenseMask=licenseMask, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemIndex=modemIndex, modemStatistics=modemStatistics, ethTXLengthCheckErrors=ethTXLengthCheckErrors, aTPCEntry=aTPCEntry, ethTXLateCollisions=ethTXLateCollisions, radioTable=radioTable, ipRadio=ipRadio, localIpMask=localIpMask, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, radioTxFrequency=radioTxFrequency, tehnika=tehnika, modemEntry=modemEntry, aTPCTable=aTPCTable, vlanTable=vlanTable, modemAcqStatus=modemAcqStatus, ipRadioCfg=ipRadioCfg, modemACMmodulationMax=modemACMmodulationMax, ethRXControlFrames=ethRXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStandard=modemStandard, sysTemperature=sysTemperature, ipRadioStat=ipRadioStat, ethRXCodeErrors=ethRXCodeErrors, saf=saf, localIp=localIp, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, atpcEnabled=atpcEnabled, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalBlockNumber=modemTotalBlockNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioLoopback=radioLoopback, modemE1T1Channels=modemE1T1Channels, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCountTime=modemCountTime, license=license, radioRxLevel=radioRxLevel, modemModulation=modemModulation, modemBandwith=modemBandwith, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXVlanTags=ethTXVlanTags)
