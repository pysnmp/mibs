...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:22:44 2021
...
Bits, Unsigned32, ObjectIdentity, Counter32, NotificationType, Counter64, ModuleIdentity, iso, MibIdentifier, TimeTicks, enterprises, Integer32, IpAddress, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "TimeTicks", "enterprises", "Integer32", "IpAddress", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, aTPCEntry=aTPCEntry, ethRXCRCErrors=ethRXCRCErrors, description=description, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, product=product, ethRXByteCounterLow=ethRXByteCounterLow, ethTXControlFrames=ethTXControlFrames, modemErroredBlock=modemErroredBlock, atpcEnabled=atpcEnabled, tehnika=tehnika, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, licenseUpdateStatus=licenseUpdateStatus, radioDuplexShift=radioDuplexShift, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, modemTable=modemTable, ipRadio=ipRadio, ethRXControlFrames=ethRXControlFrames, ipRadioStat=ipRadioStat, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXDropped=ethQOSTXDropped, writeConfig=writeConfig, loopback_tributary_mask=loopback_tributary_mask, ethTXDones=ethTXDones, modemStandard=modemStandard, loopbacks=loopbacks, licenseMask=licenseMask, modemRadialMSE=modemRadialMSE, radioSide=radioSide, modemACMmodulationMin=modemACMmodulationMin, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfg=ipRadioCfg, modemErroredSecondRatio=modemErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, localIp=localIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, vlanCfgStat=vlanCfgStat, ipRadioMgmt=ipRadioMgmt, modemRowStatus=modemRowStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSTXFrames=ethQOSTXFrames, vlanTable=vlanTable, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, ethTXUnderruns=ethTXUnderruns, ethTXGiants=ethTXGiants, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCodeErrors=ethRXCodeErrors, modemUptime=modemUptime, radioTxMute=radioTxMute, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, radioIndex=radioIndex, modemIndex=modemIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPauseFrames=ethRXPauseFrames, license=license, vlanNumber=vlanNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanRowStatus=vlanRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, e1t1LOS=e1t1LOS, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, radioRxLevel=radioRxLevel, saf=saf, microwaveRadio=microwaveRadio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, radioTable=radioTable, modemBandwith=modemBandwith, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStatistics=modemStatistics, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXByteCounterLow=ethTXByteCounterLow, vlanEntry=vlanEntry, sysTemperature=sysTemperature, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, ipRadioStatEth=ipRadioStatEth, atpcIndex=atpcIndex, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, localIpMask=localIpMask, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, modemACMtotalCapacity=modemACMtotalCapacity, vlanFid=vlanFid, radioLoopback=radioLoopback, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, vlanPortType=vlanPortType, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatTable=e1t1StatTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxPower=radioTxPower, safip=safip)
