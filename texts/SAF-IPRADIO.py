...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:37:02 2022
...
NotificationType, ModuleIdentity, Unsigned32, IpAddress, Counter32, Gauge32, TimeTicks, Counter64, ObjectIdentity, Bits, MibIdentifier, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter32", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "Bits", "MibIdentifier", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanFid=vlanFid, modemIndex=modemIndex, vlanNumber=vlanNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, radioDuplexShift=radioDuplexShift, description=description, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXPauseFrames=ethTXPauseFrames, vlanEntry=vlanEntry, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioGenStatus=radioGenStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, tehnika=tehnika, modemBandwith=modemBandwith, modemACMengine=modemACMengine, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, safip=safip, radioTxPower=radioTxPower, radioTxMute=radioTxMute, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalCapacity=modemTotalCapacity, ethRXDones=ethRXDones, localIpMask=localIpMask, product=product, ethTXDones=ethTXDones, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, atpcEnabled=atpcEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, loopback_tributary_mask=loopback_tributary_mask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatEntry=e1t1StatEntry, modemEthernetCapacity=modemEthernetCapacity, radioTable=radioTable, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, loopbacks=loopbacks, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterHi=ethTXByteCounterHi, aTPCTable=aTPCTable, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStat=ipRadioStat, ipRadioStatEth=ipRadioStatEth, modemUnavailtime=modemUnavailtime, vlanPortmap=vlanPortmap, remoteIp=remoteIp, saf=saf, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, ethTXBroadcasts=ethTXBroadcasts, writeConfig=writeConfig, vlanRowStatus=vlanRowStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, ethRXCRCErrors=ethRXCRCErrors, radioRxFrequency=radioRxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCarrierOffset=modemCarrierOffset, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, radioLoopback=radioLoopback, ethRXControlFrames=ethRXControlFrames, ethRXCodeErrors=ethRXCodeErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, ethRXLongEvents=ethRXLongEvents, vlanTable=vlanTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, modemInternalAGCgain=modemInternalAGCgain, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, sysDateAndTime=sysDateAndTime, ethRXMulticasts=ethRXMulticasts, sysTemperature=sysTemperature, hostname=hostname, vlanCfgStat=vlanCfgStat, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, microwaveRadio=microwaveRadio, restartcpu=restartcpu, radioRxLevel=radioRxLevel, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortType=vlanPortType, ethRXByteCounterHi=ethRXByteCounterHi, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, licenseMask=licenseMask, ethTXUnderruns=ethTXUnderruns, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStandard=modemStandard, modemSymbolRateRx=modemSymbolRateRx, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioSide=radioSide, modemErroredBlock=modemErroredBlock, ethQOSTXDropped=ethQOSTXDropped, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, e1t1StatTable=e1t1StatTable, licenseUpdateStatus=licenseUpdateStatus, modemTable=modemTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, localIp=localIp, e1t1LOS=e1t1LOS)
