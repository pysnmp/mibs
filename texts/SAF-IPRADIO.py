...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:03:46 2024
...
NotificationType, TimeTicks, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter32, ObjectIdentity, MibIdentifier, Gauge32, Integer32, Counter64, Unsigned32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter32", "ObjectIdentity", "MibIdentifier", "Gauge32", "Integer32", "Counter64", "Unsigned32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, vlansEnabled=vlansEnabled, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, modemACMmodulationMin=modemACMmodulationMin, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, modemUptime=modemUptime, vlanEntry=vlanEntry, e1t1LOS=e1t1LOS, ipRadioStatEth=ipRadioStatEth, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, modemErroredSecondRatio=modemErroredSecondRatio, ethTXGiants=ethTXGiants, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, ipRadioStat=ipRadioStat, modemSymbolRateRx=modemSymbolRateRx, ethTXMaxCollisions=ethTXMaxCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, description=description, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, atpcEnabled=atpcEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxPower=radioTxPower, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, tehnika=tehnika, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, modemEntry=modemEntry, modemStatistics=modemStatistics, ethTXUnderruns=ethTXUnderruns, localIpMask=localIpMask, ethRXDones=ethRXDones, sysTemperature=sysTemperature, modemCountTime=modemCountTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortmap=vlanPortmap, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, radioIndex=radioIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMax=modemACMmodulationMax, product=product, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, aTPCEntry=aTPCEntry, ethTXCRCErrors=ethTXCRCErrors, modemACMengine=modemACMengine, radioSide=radioSide, vlanFid=vlanFid, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRadialMSE=modemRadialMSE, modemACMethernetCapacity=modemACMethernetCapacity, vlanTable=vlanTable, loopbacks=loopbacks, localIp=localIp, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, modemBandwith=modemBandwith, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, modemACMtotalCapacity=modemACMtotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, hostname=hostname, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ethTXControlFrames=ethTXControlFrames, licenseMask=licenseMask, pointToPoint=pointToPoint, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcIndex=atpcIndex, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, vlanPortType=vlanPortType, modemE1T1Channels=modemE1T1Channels, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, ipRadioCfg=ipRadioCfg, restartcpu=restartcpu, aTPCTable=aTPCTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, ethGFPCHECErrors=ethGFPCHECErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, modemTotalBlockNumber=modemTotalBlockNumber, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, ipRadio=ipRadio, modemIndex=modemIndex, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, license=license, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecond=modemErroredSecond, ethQOSTXFrames=ethQOSTXFrames, saf=saf, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, safip=safip)
