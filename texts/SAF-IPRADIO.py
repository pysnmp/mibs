...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:20:34 2023
...
enterprises, MibIdentifier, Counter64, NotificationType, Counter32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, ModuleIdentity, ObjectIdentity, Integer32, IpAddress, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Counter64", "NotificationType", "Counter32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "ModuleIdentity", "ObjectIdentity", "Integer32", "IpAddress", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortType=vlanPortType, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, modemACMmodulationMax=modemACMmodulationMax, localIpMask=localIpMask, ethTXGiants=ethTXGiants, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, modemEntry=modemEntry, ethRXDvEvent=ethRXDvEvent, description=description, ethQOSTXDropped=ethQOSTXDropped, aTPCEntry=aTPCEntry, ethTXBackpresEvents=ethTXBackpresEvents, e1t1ChannelNr=e1t1ChannelNr, modemBandwith=modemBandwith, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, vlanTable=vlanTable, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, localIp=localIp, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ipRadioStatEth=ipRadioStatEth, radioTxMute=radioTxMute, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, modemRowStatus=modemRowStatus, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, radioTxPower=radioTxPower, atpcEnabled=atpcEnabled, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, modemGeneralStatus=modemGeneralStatus, safip=safip, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMin=modemACMmodulationMin, ethGFPDropedFrames=ethGFPDropedFrames, vlanFid=vlanFid, product=product, radioTable=radioTable, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStatistics=modemStatistics, ethTXBroadcasts=ethTXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, microwaveRadio=microwaveRadio, radioSide=radioSide, ethGFPCHECErrors=ethGFPCHECErrors, ethTXControlFrames=ethTXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, modemUnavailtime=modemUnavailtime, modemModulation=modemModulation, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, ethTXMulticasts=ethTXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, sysTemperature=sysTemperature, ethTXVlanTags=ethTXVlanTags, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, sysDateAndTime=sysDateAndTime, ethRXDones=ethRXDones, radioDuplexShift=radioDuplexShift, modemACMtotalCapacity=modemACMtotalCapacity, saf=saf, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ipRadio=ipRadio, radioRxLevel=radioRxLevel, writeConfig=writeConfig, e1t1AIS=e1t1AIS, modemACMengine=modemACMengine, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, modemStandard=modemStandard, ethRXDribleNibbles=ethRXDribleNibbles, modemTable=modemTable, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterLow=ethRXByteCounterLow, aTPCTable=aTPCTable, ethTXCRCErrors=ethTXCRCErrors, modemIndex=modemIndex, loopbacks=loopbacks, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxFrequency=radioRxFrequency, radioGenStatus=radioGenStatus, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, radioTxFrequency=radioTxFrequency, modemSymbolRateRx=modemSymbolRateRx)
