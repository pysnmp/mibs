...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:22:10 2023
...
Integer32, ModuleIdentity, Counter64, enterprises, TimeTicks, NotificationType, IpAddress, NotificationType, MibIdentifier, Gauge32, iso, ObjectIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter64", "enterprises", "TimeTicks", "NotificationType", "IpAddress", "NotificationType", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterLow=ethTXByteCounterLow, hostname=hostname, radioSide=radioSide, modemInternalAGCgain=modemInternalAGCgain, vlanFid=vlanFid, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCTable=aTPCTable, ethTXLateCollisions=ethTXLateCollisions, license=license, ethTXCRCErrors=ethTXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, saf=saf, product=product, e1t1StatTable=e1t1StatTable, tehnika=tehnika, loopbacks=loopbacks, modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcEnabled=atpcEnabled, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXControlFrames=ethRXControlFrames, radioTable=radioTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, pointToPoint=pointToPoint, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortmap=vlanPortmap, modemACMmodulationMin=modemACMmodulationMin, vlansEnabled=vlansEnabled, vlanTable=vlanTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxLevel=radioRxLevel, modemEntry=modemEntry, ethQOSTXFrames=ethQOSTXFrames, modemEthernetCapacity=modemEthernetCapacity, e1t1LOS=e1t1LOS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, licenseMask=licenseMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIp=localIp, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXDones=ethTXDones, modemGeneralStatus=modemGeneralStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, atpcIndex=atpcIndex, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, ipRadioStatEth=ipRadioStatEth, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, modemRadialMSE=modemRadialMSE, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCEntry=aTPCEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfg=ipRadioCfg, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns, ipRadio=ipRadio, remoteIp=remoteIp, ethRXCodeErrors=ethRXCodeErrors, vlanRowStatus=vlanRowStatus, ethRXDones=ethRXDones, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, writeConfig=writeConfig, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, sysTemperature=sysTemperature, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredBlock=modemErroredBlock, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateRx=modemSymbolRateRx, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioLoopback=radioLoopback, vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, localIpMask=localIpMask, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, modemTotalCapacity=modemTotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, modemCountTime=modemCountTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSymbolRateTx=modemSymbolRateTx, ethTXPauseFrames=ethTXPauseFrames, ethRXMulticasts=ethRXMulticasts, modemBandwith=modemBandwith, modemRowStatus=modemRowStatus, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, radioTxPower=radioTxPower, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, description=description, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioIndex=radioIndex, radioDuplexShift=radioDuplexShift, ethRXPauseFrames=ethRXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, radioTxMute=radioTxMute, safip=safip, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSTXDropped=ethQOSTXDropped, radioGenStatus=radioGenStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt)
