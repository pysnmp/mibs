...
# Produced by pysmi-1.1.8 at Mon Jan 17 21:49:16 2022
...
NotificationType, iso, Integer32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter64, ModuleIdentity, NotificationType, ObjectIdentity, Unsigned32, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Integer32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter64", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioEntry=radioEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysTemperature=sysTemperature, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemIndex=modemIndex, ethRXPauseFrames=ethRXPauseFrames, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, ethTXCollisions=ethTXCollisions, saf=saf, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1LOS=e1t1LOS, radioDuplexShift=radioDuplexShift, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatEntry=e1t1StatEntry, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, localIp=localIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEthernetCapacity=modemEthernetCapacity, safip=safip, radioSide=radioSide, vlanEntry=vlanEntry, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, radioTxFrequency=radioTxFrequency, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXVlanTags=ethTXVlanTags, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterLow=ethRXByteCounterLow, tehnika=tehnika, radioIndex=radioIndex, modemModulation=modemModulation, modemBandwith=modemBandwith, restartcpu=restartcpu, sysDateAndTime=sysDateAndTime, ethRXBroadcasts=ethRXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, modemUptime=modemUptime, ethTXUnderruns=ethTXUnderruns, modemTable=modemTable, remoteIp=remoteIp, ipRadioStatEth=ipRadioStatEth, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, ethRXCRCErrors=ethRXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanTable=vlanTable, product=product, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCRCErrors=ethTXCRCErrors, ethRXMulticasts=ethRXMulticasts, ethRXDvEvent=ethRXDvEvent, localIpMask=localIpMask, modemStandard=modemStandard, ethTXGiants=ethTXGiants, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, modemACMengine=modemACMengine, aTPCEntry=aTPCEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, e1t1StatTable=e1t1StatTable, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, description=description, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, modemGeneralStatus=modemGeneralStatus, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, licenseMask=licenseMask, modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, modemUnavailtime=modemUnavailtime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, modemCarrierOffset=modemCarrierOffset, ethGFPFCSErrors=ethGFPFCSErrors, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, ipRadioCfg=ipRadioCfg, ethRXDones=ethRXDones, hostname=hostname, atpcIndex=atpcIndex, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMulticasts=ethTXMulticasts, modemCountTime=modemCountTime, ethTXExcessiveDefers=ethTXExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber)
