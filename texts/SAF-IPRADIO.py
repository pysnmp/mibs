...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:41:05 2024
...
ObjectIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, NotificationType, Counter64, Bits, enterprises, Unsigned32, MibIdentifier, iso, NotificationType, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "NotificationType", "Counter64", "Bits", "enterprises", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, radioIndex=radioIndex, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, radioSide=radioSide, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortmap=vlanPortmap, safip=safip, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, modemSymbolRateTx=modemSymbolRateTx, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, modemStatistics=modemStatistics, loopbacks=loopbacks, ipRadioMgmt=ipRadioMgmt, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, ethTXControlFrames=ethTXControlFrames, tehnika=tehnika, modemSymbolRateRx=modemSymbolRateRx, ethRXBroadcasts=ethRXBroadcasts, license=license, modemIndex=modemIndex, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, hostname=hostname, licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, localIpMask=localIpMask, remoteIp=remoteIp, atpcEnabled=atpcEnabled, product=product, radioDuplexShift=radioDuplexShift, ethTXLateCollisions=ethTXLateCollisions, writeConfig=writeConfig, ethGFPDelineationErrors=ethGFPDelineationErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, modemEntry=modemEntry, vlanPortType=vlanPortType, ethQOSTXDropped=ethQOSTXDropped, vlanTable=vlanTable, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, e1t1StatEntry=e1t1StatEntry, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterLow=ethRXByteCounterLow, saf=saf, pointToPoint=pointToPoint, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemModulation=modemModulation, ethTXBackpresEvents=ethTXBackpresEvents, radioLoopback=radioLoopback, radioTxPower=radioTxPower, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, ethTXPauseFrames=ethTXPauseFrames, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, modemBandwith=modemBandwith, aTPCEntry=aTPCEntry, modemRowStatus=modemRowStatus, description=description, e1t1AIS=e1t1AIS, vlanCfgStat=vlanCfgStat, atpcIndex=atpcIndex, modemErroredBlock=modemErroredBlock, radioTable=radioTable, ethRXMulticasts=ethRXMulticasts, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMax=modemACMmodulationMax, vlanNumber=vlanNumber, ipRadioCfg=ipRadioCfg, ethRXControlFrames=ethRXControlFrames, radioRxLevel=radioRxLevel, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMaxCollisions=ethTXMaxCollisions, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, e1t1LOS=e1t1LOS, modemTable=modemTable, e1t1ChannelNr=e1t1ChannelNr, licenseUpdateStatus=licenseUpdateStatus, ethTXDones=ethTXDones, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStat=ipRadioStat, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxFrequency=radioTxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, ipRadio=ipRadio, e1t1StatTable=e1t1StatTable, vlanEntry=vlanEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE)
