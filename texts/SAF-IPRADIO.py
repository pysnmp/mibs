...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:29:48 2022
...
NotificationType, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, IpAddress, Bits, Counter32, Gauge32, Integer32, Counter64, Unsigned32, MibIdentifier, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "IpAddress", "Bits", "Counter32", "Gauge32", "Integer32", "Counter64", "Unsigned32", "MibIdentifier", "enterprises", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, radioIndex=radioIndex, vlanTable=vlanTable, modemACMengine=modemACMengine, vlanFid=vlanFid, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredBlock=modemErroredBlock, vlanNumber=vlanNumber, restartcpu=restartcpu, vlanCfgStat=vlanCfgStat, description=description, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, modemTotalCapacity=modemTotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateRx=modemSymbolRateRx, writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, ethTXMulticasts=ethTXMulticasts, ethTXCollisions=ethTXCollisions, modemUptime=modemUptime, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, radioRxLevel=radioRxLevel, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, modemBandwith=modemBandwith, modemACMmodulationMin=modemACMmodulationMin, modemACMmodulationMax=modemACMmodulationMax, sysDateAndTime=sysDateAndTime, radioTxMute=radioTxMute, vlanPortType=vlanPortType, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseMask=licenseMask, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, radioTxPower=radioTxPower, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTable=modemTable, radioTxFrequency=radioTxFrequency, ethTXPauseFrames=ethTXPauseFrames, e1t1StatTable=e1t1StatTable, safip=safip, localIpMask=localIpMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, saf=saf, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, ethGFPCHECErrors=ethGFPCHECErrors, hostname=hostname, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecond=modemErroredSecond, loopback_tributary_mask=loopback_tributary_mask, ethTXGiants=ethTXGiants, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, ethRXMulticasts=ethRXMulticasts, localIp=localIp, ethTXBroadcasts=ethTXBroadcasts, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, modemRadialMSE=modemRadialMSE, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTable=radioTable, ethRXCRCErrors=ethRXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemInternalAGCgain=modemInternalAGCgain, modemLastAcqError=modemLastAcqError, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDones=ethRXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysTemperature=sysTemperature, ethTXDones=ethTXDones, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, radioGenStatus=radioGenStatus, remoteIp=remoteIp, ipRadio=ipRadio, radioLoopback=radioLoopback, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCEntry=aTPCEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCRCErrors=ethTXCRCErrors, e1t1LOS=e1t1LOS, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, license=license, loopbacks=loopbacks, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfg=ipRadioCfg, vlanEntry=vlanEntry, aTPCTable=aTPCTable, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, vlansEnabled=vlansEnabled, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemAcqStatus=modemAcqStatus, product=product, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
