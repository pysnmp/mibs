...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:18:25 2022
...
MibIdentifier, Bits, Counter64, Unsigned32, Integer32, enterprises, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, IpAddress, TimeTicks, Counter32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter64", "Unsigned32", "Integer32", "enterprises", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxMute=radioTxMute, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadio=ipRadio, pointToPoint=pointToPoint, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecond=modemErroredSecond, modemRowStatus=modemRowStatus, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemAcqStatus=modemAcqStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXGiants=ethTXGiants, modemStatistics=modemStatistics, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXBroadcasts=ethTXBroadcasts, e1t1StatTable=e1t1StatTable, product=product, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, vlanEntry=vlanEntry, localIp=localIp, ipRadioCfgGeneral=ipRadioCfgGeneral, radioIndex=radioIndex, sysDateAndTime=sysDateAndTime, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDvEvent=ethRXDvEvent, tehnika=tehnika, radioLoopback=radioLoopback, modemCarrierOffset=modemCarrierOffset, ethGFPCHECErrors=ethGFPCHECErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, radioDuplexShift=radioDuplexShift, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanCfgStat=vlanCfgStat, licenseUpdateStatus=licenseUpdateStatus, loopbacks=loopbacks, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioGenStatus=radioGenStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, ethTXMaxCollisions=ethTXMaxCollisions, modemACMengine=modemACMengine, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, writeConfig=writeConfig, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDones=ethRXDones, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, remoteIp=remoteIp, vlanPortmap=vlanPortmap, ethRXControlFrames=ethRXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, localIpMask=localIpMask, vlanNumber=vlanNumber, modemEntry=modemEntry, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, aTPCTable=aTPCTable, modemStandard=modemStandard, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, modemACMmodulationMin=modemACMmodulationMin, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStat=ipRadioStat, ethTXUnderruns=ethTXUnderruns, license=license, vlanRowStatus=vlanRowStatus, atpcEnabled=atpcEnabled, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, restartcpu=restartcpu, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, safip=safip, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, modemInternalAGCgain=modemInternalAGCgain, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, saf=saf, modemModulation=modemModulation, radioTable=radioTable, atpcIndex=atpcIndex, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, description=description, modemGeneralStatus=modemGeneralStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxPower=radioTxPower, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMulticasts=ethTXMulticasts)
