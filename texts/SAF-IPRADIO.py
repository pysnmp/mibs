...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:25:54 2024
...
Gauge32, Counter32, ObjectIdentity, Bits, NotificationType, TimeTicks, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Unsigned32, Counter64, ModuleIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ObjectIdentity", "Bits", "NotificationType", "TimeTicks", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Unsigned32", "Counter64", "ModuleIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, e1t1StatTable=e1t1StatTable, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, modemTable=modemTable, modemErroredBlock=modemErroredBlock, localIpMask=localIpMask, radioEntry=radioEntry, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfg=ipRadioCfg, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, ethTXMaxCollisions=ethTXMaxCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxPower=radioTxPower, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, vlanPortType=vlanPortType, radioRxLevel=radioRxLevel, ethTXBackpresEvents=ethTXBackpresEvents, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, radioGenStatus=radioGenStatus, localIp=localIp, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry, modemUnavailtime=modemUnavailtime, product=product, description=description, writeConfig=writeConfig, licenseMask=licenseMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEthernetCapacity=modemEthernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanEntry=vlanEntry, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, license=license, modemModulation=modemModulation, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, modemACMmodulationMax=modemACMmodulationMax, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXDones=ethTXDones, ethTXCollisions=ethTXCollisions, saf=saf, modemCountTime=modemCountTime, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanTable=vlanTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, atpcEnabled=atpcEnabled, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, radioSide=radioSide, ethRXCRCErrors=ethRXCRCErrors, ipRadio=ipRadio, microwaveRadio=microwaveRadio, loopbacks=loopbacks, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, vlanCfgStat=vlanCfgStat, pointToPoint=pointToPoint, ethGFPCHECErrors=ethGFPCHECErrors, ethTXVlanTags=ethTXVlanTags, modemBandwith=modemBandwith, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortmap=vlanPortmap, ethRXDones=ethRXDones, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecondRatio=modemErroredSecondRatio, sysDateAndTime=sysDateAndTime, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, safip=safip, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, ethRXByteCounterLow=ethRXByteCounterLow, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, atpcIndex=atpcIndex, e1t1StatEntry=e1t1StatEntry, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, tehnika=tehnika, modemCarrierOffset=modemCarrierOffset, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemStandard=modemStandard, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, vlanNumber=vlanNumber, sysTemperature=sysTemperature)
