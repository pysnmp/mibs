...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:04:05 2023
...
iso, Counter32, Integer32, NotificationType, ObjectIdentity, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ModuleIdentity, enterprises, Unsigned32, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ModuleIdentity", "enterprises", "Unsigned32", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, modemEntry=modemEntry, ethRXControlFrames=ethRXControlFrames, localIpMask=localIpMask, radioRxLevel=radioRxLevel, modemIndex=modemIndex, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, vlanPortmap=vlanPortmap, modemBandwith=modemBandwith, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, safip=safip, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfg=ipRadioCfg, hostname=hostname, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseMask=licenseMask, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, radioSide=radioSide, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, modemErroredBlock=modemErroredBlock, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDropedFrames=ethGFPDropedFrames, radioRxFrequency=radioRxFrequency, ethTXMulticasts=ethTXMulticasts, vlanTable=vlanTable, modemACMmodulationMin=modemACMmodulationMin, radioLoopback=radioLoopback, pointToPoint=pointToPoint, aTPCEntry=aTPCEntry, ethTXMaxCollisions=ethTXMaxCollisions, localIp=localIp, vlanNumber=vlanNumber, modemACMethernetCapacity=modemACMethernetCapacity, modemTable=modemTable, ethTXByteCounterLow=ethTXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, radioDuplexShift=radioDuplexShift, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemAcqStatus=modemAcqStatus, modemE1T1Channels=modemE1T1Channels, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, product=product, modemACMtotalCapacity=modemACMtotalCapacity, license=license, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, modemModulation=modemModulation, radioGenStatus=radioGenStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, modemInternalAGCgain=modemInternalAGCgain, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, modemUptime=modemUptime, loopbacks=loopbacks, ethTXBackpresEvents=ethTXBackpresEvents, saf=saf, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStat=ipRadioStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, ipRadio=ipRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortType=vlanPortType, ethRXDones=ethRXDones, ethRXPauseFrames=ethRXPauseFrames, vlanCfgStat=vlanCfgStat, e1t1StatEntry=e1t1StatEntry, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, ethTXGiants=ethTXGiants, atpcIndex=atpcIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, vlanRowStatus=vlanRowStatus, remoteIp=remoteIp, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, description=description, ethRXLongEvents=ethRXLongEvents, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, modemSymbolRateRx=modemSymbolRateRx, aTPCTable=aTPCTable)
