...
enterprises, Integer32, Bits, Unsigned32, NotificationType, Gauge32, NotificationType, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Bits", "Unsigned32", "NotificationType", "Gauge32", "NotificationType", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlansEnabled=vlansEnabled, modemE1T1Channels=modemE1T1Channels, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLongEvents=ethRXLongEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXByteCounterHi=ethTXByteCounterHi, safip=safip, ethTXBackpresEvents=ethTXBackpresEvents, ethTXGiants=ethTXGiants, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, vlanCfgStat=vlanCfgStat, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, modemTotalBlockNumber=modemTotalBlockNumber, ethTXDones=ethTXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, aTPCEntry=aTPCEntry, radioTxMute=radioTxMute, modemIndex=modemIndex, modemTable=modemTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMengine=modemACMengine, modemErroredBlock=modemErroredBlock, localIp=localIp, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfg=ipRadioCfg, modemACMmodulationMax=modemACMmodulationMax, pointToPoint=pointToPoint, ethTXControlFrames=ethTXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, radioTxPower=radioTxPower, writeConfig=writeConfig, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, modemStatistics=modemStatistics, modemACMethernetCapacity=modemACMethernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecond=modemErroredSecond, ethRXDones=ethRXDones, sysDateAndTime=sysDateAndTime, modemBandwith=modemBandwith, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, modemEntry=modemEntry, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, modemRadialMSE=modemRadialMSE, ethRXByteCounterHi=ethRXByteCounterHi, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt, e1t1StatEntry=e1t1StatEntry, radioTxFrequency=radioTxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxFrequency=radioRxFrequency, ipRadio=ipRadio, vlanFid=vlanFid, vlanRowStatus=vlanRowStatus, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1LOS=e1t1LOS, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, saf=saf, product=product, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, vlanEntry=vlanEntry, modemModulation=modemModulation, description=description, loopback_tributary_mask=loopback_tributary_mask, tehnika=tehnika, vlanTable=vlanTable, vlanPortmap=vlanPortmap, radioTable=radioTable, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortType=vlanPortType, radioIndex=radioIndex, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, ethTXCRCErrors=ethTXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, license=license, modemEthernetCapacity=modemEthernetCapacity, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, ethRXMulticasts=ethRXMulticasts, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, remoteIp=remoteIp, ethQOSTXFrames=ethQOSTXFrames, ethRXBroadcasts=ethRXBroadcasts, radioSide=radioSide, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, ethTXUnderruns=ethTXUnderruns, ethGFPDropedFrames=ethGFPDropedFrames, modemCarrierOffset=modemCarrierOffset)
