...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:31:58 2024
...
TimeTicks, ObjectIdentity, MibIdentifier, ModuleIdentity, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, NotificationType, NotificationType, Bits, Unsigned32, enterprises, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "NotificationType", "NotificationType", "Bits", "Unsigned32", "enterprises", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", restartcpu=restartcpu, licenseMask=licenseMask, modemTotalCapacity=modemTotalCapacity, product=product, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, modemIndex=modemIndex, hostname=hostname, modemStatistics=modemStatistics, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, writeConfig=writeConfig, vlanPortmap=vlanPortmap, ipRadio=ipRadio, modemAcqStatus=modemAcqStatus, radioEntry=radioEntry, ethRXPauseFrames=ethRXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, modemSymbolRateTx=modemSymbolRateTx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxLevel=radioRxLevel, ethTXMulticasts=ethTXMulticasts, ethRXControlFrames=ethRXControlFrames, ethQOSTXDropped=ethQOSTXDropped, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, vlanRowStatus=vlanRowStatus, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, loopbacks=loopbacks, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, ipRadioStat=ipRadioStat, e1t1StatTable=e1t1StatTable, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, ethRXCRCErrors=ethRXCRCErrors, ethTXUnderruns=ethTXUnderruns, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, modemACMethernetCapacity=modemACMethernetCapacity, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, description=description, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBandwith=modemBandwith, ethTXLateCollisions=ethTXLateCollisions, radioLoopback=radioLoopback, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, radioTable=radioTable, e1t1StatEntry=e1t1StatEntry, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, ethTXVlanTags=ethTXVlanTags, vlanEntry=vlanEntry, radioDuplexShift=radioDuplexShift, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRadialMSE=modemRadialMSE, ethRXDribleNibbles=ethRXDribleNibbles, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDones=ethRXDones, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxMute=radioTxMute, safip=safip, atpcIndex=atpcIndex, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanNumber=vlanNumber, modemACMengine=modemACMengine, radioRxFrequency=radioRxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, sysTemperature=sysTemperature, modemStandard=modemStandard, microwaveRadio=microwaveRadio, ethTXGiants=ethTXGiants, vlansEnabled=vlansEnabled, tehnika=tehnika, modemTable=modemTable, atpcTxPowerCorrection=atpcTxPowerCorrection)
