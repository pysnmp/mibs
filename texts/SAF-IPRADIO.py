...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:17:04 2023
...
Gauge32, NotificationType, TimeTicks, ObjectIdentity, Counter64, enterprises, Integer32, Counter32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Unsigned32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "enterprises", "Integer32", "Counter32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Unsigned32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, ipRadioStatEth=ipRadioStatEth, modemErroredSecond=modemErroredSecond, modemModulation=modemModulation, ipRadioStat=ipRadioStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, modemSymbolRateRx=modemSymbolRateRx, modemCarrierOffset=modemCarrierOffset, radioTxMute=radioTxMute, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, modemAcqStatus=modemAcqStatus, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemInternalAGCgain=modemInternalAGCgain, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, modemACMengine=modemACMengine, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, modemUptime=modemUptime, modemStatistics=modemStatistics, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, safip=safip, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfg=ipRadioCfg, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks, writeConfig=writeConfig, hostname=hostname, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, modemEthernetCapacity=modemEthernetCapacity, radioIndex=radioIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanEntry=vlanEntry, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, radioEntry=radioEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemIndex=modemIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, atpcEnabled=atpcEnabled, ethTXLateCollisions=ethTXLateCollisions, aTPCEntry=aTPCEntry, radioSide=radioSide, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, modemRowStatus=modemRowStatus, modemE1T1Channels=modemE1T1Channels, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, radioRxLevel=radioRxLevel, ethTXCollisions=ethTXCollisions, ethTXGiants=ethTXGiants, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, modemStandard=modemStandard, description=description, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIpMask=localIpMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlansEnabled=vlansEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXBroadcasts=ethRXBroadcasts, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, radioTable=radioTable, radioTxFrequency=radioTxFrequency, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, radioGenStatus=radioGenStatus, saf=saf, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, radioTxPower=radioTxPower, ethTXCRCErrors=ethTXCRCErrors, product=product, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, ethRXPrevPktDropped=ethRXPrevPktDropped, license=license, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterLow=ethTXWireByteCounterLow)
