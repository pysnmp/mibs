...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:39:00 2021
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, TimeTicks, NotificationType, iso, IpAddress, ModuleIdentity, Integer32, Unsigned32, NotificationType, Counter32, Bits, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "TimeTicks", "NotificationType", "iso", "IpAddress", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType", "Counter32", "Bits", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioIndex=radioIndex, modemACMmodulationMin=modemACMmodulationMin, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStandard=modemStandard, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, ethTXMulticasts=ethTXMulticasts, modemBandwith=modemBandwith, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXFrames=ethQOSTXFrames, ethRXMulticasts=ethRXMulticasts, description=description, ethGFPDropedFrames=ethGFPDropedFrames, licenseMask=licenseMask, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalCapacity=modemTotalCapacity, loopbacks=loopbacks, ethTXDones=ethTXDones, modemCountTime=modemCountTime, radioTable=radioTable, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, vlanPortmap=vlanPortmap, localIpMask=localIpMask, vlanNumber=vlanNumber, writeConfig=writeConfig, licenseUpdateStatus=licenseUpdateStatus, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, pointToPoint=pointToPoint, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, restartcpu=restartcpu, vlansEnabled=vlansEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBackpresEvents=ethTXBackpresEvents, atpcEnabled=atpcEnabled, modemE1T1Channels=modemE1T1Channels, ipRadio=ipRadio, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, radioLoopback=radioLoopback, license=license, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopback_tributary_mask=loopback_tributary_mask, localIp=localIp, radioTxMute=radioTxMute, ethTXGiants=ethTXGiants, atpcIndex=atpcIndex, aTPCEntry=aTPCEntry, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, hostname=hostname, product=product, modemErroredSecondRatio=modemErroredSecondRatio, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, vlanCfgStat=vlanCfgStat, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, ethGFPFCSErrors=ethGFPFCSErrors, microwaveRadio=microwaveRadio, modemRowStatus=modemRowStatus, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortType=vlanPortType, saf=saf, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, modemLastAcqError=modemLastAcqError, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, ethTXBroadcasts=ethTXBroadcasts, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDones=ethRXDones, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, ethRXByteCounterLow=ethRXByteCounterLow, vlanTable=vlanTable, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, e1t1StatEntry=e1t1StatEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemAcqStatus=modemAcqStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXPauseFrames=ethTXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, remoteIp=remoteIp, vlanRowStatus=vlanRowStatus, tehnika=tehnika, modemErroredBlock=modemErroredBlock, modemTable=modemTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysTemperature=sysTemperature, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, modemRadialMSE=modemRadialMSE, modemIndex=modemIndex, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanFid=vlanFid, modemSymbolRateTx=modemSymbolRateTx, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethTXVlanTags=ethTXVlanTags, radioTxPower=radioTxPower)
