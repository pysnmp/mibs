...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:34:19 2023
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMin=modemACMmodulationMin, modemUnavailtime=modemUnavailtime, ethGFPFCSErrors=ethGFPFCSErrors, radioRxFrequency=radioRxFrequency, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, radioEntry=radioEntry, e1t1ChannelNr=e1t1ChannelNr, modemEntry=modemEntry, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, modemModulation=modemModulation, modemRadialMSE=modemRadialMSE, modemE1T1ChannelMask=modemE1T1ChannelMask, modemE1T1Channels=modemE1T1Channels, loopbacks=loopbacks, restartcpu=restartcpu, vlanRowStatus=vlanRowStatus, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, radioTable=radioTable, ethRXMulticasts=ethRXMulticasts, atpcIndex=atpcIndex, safip=safip, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxLevel=radioRxLevel, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanNumber=vlanNumber, license=license, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfg=ipRadioCfg, ethTXBroadcasts=ethTXBroadcasts, modemLastAcqError=modemLastAcqError, radioLoopback=radioLoopback, ethRXControlFrames=ethRXControlFrames, ethTXUnderruns=ethTXUnderruns, vlansEnabled=vlansEnabled, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, modemCarrierOffset=modemCarrierOffset, modemEthernetCapacity=modemEthernetCapacity, ethRXLongEvents=ethRXLongEvents, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanTable=vlanTable, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecondRatio=modemErroredSecondRatio, radioSide=radioSide, ethGFPDropedFrames=ethGFPDropedFrames, ethTXControlFrames=ethTXControlFrames, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, ethTXGiants=ethTXGiants, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, sysTemperature=sysTemperature, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, e1t1StatTable=e1t1StatTable, saf=saf, modemTable=modemTable, aTPCTable=aTPCTable, radioTxPower=radioTxPower, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCEntry=aTPCEntry, modemAcqStatus=modemAcqStatus, vlanPortType=vlanPortType, ipRadioStat=ipRadioStat, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, product=product, pointToPoint=pointToPoint, ethTXMaxCollisions=ethTXMaxCollisions, description=description, modemACMengine=modemACMengine, ethRXByteCounterHi=ethRXByteCounterHi, radioDuplexShift=radioDuplexShift, licenseUpdateStatus=licenseUpdateStatus, atpcEnabled=atpcEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanCfgStat=vlanCfgStat, writeConfig=writeConfig, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, ethTXPauseFrames=ethTXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, localIp=localIp, localIpMask=localIpMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1LOS=e1t1LOS, ipRadio=ipRadio, modemIndex=modemIndex, tehnika=tehnika, vlanEntry=vlanEntry, modemTotalBlockNumber=modemTotalBlockNumber, hostname=hostname, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStatistics=modemStatistics, e1t1AIS=e1t1AIS)
