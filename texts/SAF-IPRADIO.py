...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:07:45 2024
...
Gauge32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, IpAddress, Integer32, Unsigned32, Bits, Counter32, NotificationType, NotificationType, enterprises, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "IpAddress", "Integer32", "Unsigned32", "Bits", "Counter32", "NotificationType", "NotificationType", "enterprises", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, aTPCTable=aTPCTable, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXCollisions=ethTXCollisions, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, sysTemperature=sysTemperature, modemIndex=modemIndex, e1t1StatEntry=e1t1StatEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, saf=saf, radioEntry=radioEntry, ipRadioCfg=ipRadioCfg, ipRadioMgmt=ipRadioMgmt, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadio=ipRadio, e1t1ChannelNr=e1t1ChannelNr, radioSide=radioSide, modemACMtotalCapacity=modemACMtotalCapacity, modemInternalAGCgain=modemInternalAGCgain, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, ethQOSTXFrames=ethQOSTXFrames, ethTXDones=ethTXDones, remoteIp=remoteIp, vlanRowStatus=vlanRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTotalCapacity=modemTotalCapacity, radioTable=radioTable, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, localIpMask=localIpMask, ethRXControlFrames=ethRXControlFrames, modemRadialMSE=modemRadialMSE, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseUpdateStatus=licenseUpdateStatus, vlanPortType=vlanPortType, modemACMmodulationMax=modemACMmodulationMax, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, modemCountTime=modemCountTime, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, ipRadioStat=ipRadioStat, modemACMethernetCapacity=modemACMethernetCapacity, atpcEnabled=atpcEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMulticasts=ethTXMulticasts, modemUnavailtime=modemUnavailtime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, e1t1AIS=e1t1AIS, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRowStatus=modemRowStatus, modemStatistics=modemStatistics, hostname=hostname, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, description=description, pointToPoint=pointToPoint, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXPauseFrames=ethTXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemAcqStatus=modemAcqStatus, ethRXBroadcasts=ethRXBroadcasts, radioGenStatus=radioGenStatus, modemStandard=modemStandard, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBroadcasts=ethTXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, modemEntry=modemEntry, writeConfig=writeConfig, modemErroredBlock=modemErroredBlock, product=product, vlanTable=vlanTable, ethTXByteCounterLow=ethTXByteCounterLow, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, loopback_tributary_mask=loopback_tributary_mask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, modemErroredSecond=modemErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, modemUptime=modemUptime, e1t1LOS=e1t1LOS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, vlansEnabled=vlansEnabled, aTPCEntry=aTPCEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, modemTable=modemTable, ipRadioStatEth=ipRadioStatEth, ethTXUnderruns=ethTXUnderruns, e1t1StatTable=e1t1StatTable, localIp=localIp, ethGFPFCSErrors=ethGFPFCSErrors, restartcpu=restartcpu, license=license, modemModulation=modemModulation, modemSymbolRateTx=modemSymbolRateTx, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortmap=vlanPortmap, ethRXDones=ethRXDones)
