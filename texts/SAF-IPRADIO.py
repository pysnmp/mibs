...
# Produced by pysmi-1.1.10 at Thu Oct 26 12:37:38 2023
...
iso, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, IpAddress, TimeTicks, Counter32, ObjectIdentity, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "TimeTicks", "Counter32", "ObjectIdentity", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, vlanFid=vlanFid, ethRXDones=ethRXDones, vlanEntry=vlanEntry, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, radioTxFrequency=radioTxFrequency, radioGenStatus=radioGenStatus, ipRadioStatEth=ipRadioStatEth, license=license, ethRXDribleNibbles=ethRXDribleNibbles, radioIndex=radioIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, product=product, modemTotalCapacity=modemTotalCapacity, restartcpu=restartcpu, ethRXByteCounterHi=ethRXByteCounterHi, modemModulation=modemModulation, safip=safip, ethRXControlFrames=ethRXControlFrames, ethTXGiants=ethTXGiants, modemACMengine=modemACMengine, modemRadialMSE=modemRadialMSE, microwaveRadio=microwaveRadio, radioDuplexShift=radioDuplexShift, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXControlFrames=ethTXControlFrames, radioTable=radioTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, loopbacks=loopbacks, ipRadioStat=ipRadioStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCarrierOffset=modemCarrierOffset, modemTable=modemTable, pointToPoint=pointToPoint, localIp=localIp, aTPCEntry=aTPCEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, saf=saf, modemIndex=modemIndex, radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, ethTXDones=ethTXDones, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, modemACMmodulationMax=modemACMmodulationMax, licenseUpdateStatus=licenseUpdateStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDvEvent=ethRXDvEvent, writeConfig=writeConfig, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, description=description, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCodeErrors=ethRXCodeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortmap=vlanPortmap, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, e1t1LOS=e1t1LOS, hostname=hostname, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, remoteIp=remoteIp, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, radioLoopback=radioLoopback, ethRXBroadcasts=ethRXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, e1t1AIS=e1t1AIS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, modemErroredSecond=modemErroredSecond, localIpMask=localIpMask, vlanCfgStat=vlanCfgStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, modemACMtotalCapacity=modemACMtotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanRowStatus=vlanRowStatus, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanTable=vlanTable, modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, vlansEnabled=vlansEnabled, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, ethTXUnderruns=ethTXUnderruns, modemStatistics=modemStatistics, modemStandard=modemStandard, loopback_tributary_mask=loopback_tributary_mask)
