...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:25:14 2021
...
TimeTicks, Counter32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, enterprises, iso, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, Bits, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "enterprises", "iso", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "Bits", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt, ethQOSTXDropped=ethQOSTXDropped, description=description, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, vlanEntry=vlanEntry, saf=saf, modemSymbolRateRx=modemSymbolRateRx, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortType=vlanPortType, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemGeneralStatus=modemGeneralStatus, ethTXCRCErrors=ethTXCRCErrors, writeConfig=writeConfig, vlanNumber=vlanNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, localIp=localIp, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, aTPCTable=aTPCTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXBroadcasts=ethRXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, e1t1ChannelNr=e1t1ChannelNr, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, modemCountTime=modemCountTime, modemModulation=modemModulation, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, microwaveRadio=microwaveRadio, modemRadialMSE=modemRadialMSE, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, license=license, modemBandwith=modemBandwith, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, ethTXUnderruns=ethTXUnderruns, modemSymbolRateTx=modemSymbolRateTx, ethTXLateCollisions=ethTXLateCollisions, ipRadioStatEth=ipRadioStatEth, e1t1AIS=e1t1AIS, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, modemUptime=modemUptime, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDvEvent=ethRXDvEvent, licenseMask=licenseMask, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, radioTable=radioTable, sysDateAndTime=sysDateAndTime, e1t1StatTable=e1t1StatTable, ipRadioStat=ipRadioStat, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, safip=safip, ethGFPFCSErrors=ethGFPFCSErrors, remoteIp=remoteIp, radioTxPower=radioTxPower, vlanFid=vlanFid, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, product=product, vlanPortmap=vlanPortmap, radioTxFrequency=radioTxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, tehnika=tehnika, sysTemperature=sysTemperature, localIpMask=localIpMask, modemTable=modemTable, modemEntry=modemEntry, aTPCEntry=aTPCEntry, atpcIndex=atpcIndex, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, radioIndex=radioIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatEntry=e1t1StatEntry, ethTXMulticasts=ethTXMulticasts, e1t1LOS=e1t1LOS, ethRXLongEvents=ethRXLongEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioSide=radioSide, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ipRadio=ipRadio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow)
