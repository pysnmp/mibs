...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:32:22 2023
...
enterprises, ObjectIdentity, ModuleIdentity, Integer32, iso, Gauge32, Counter64, TimeTicks, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Unsigned32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "ModuleIdentity", "Integer32", "iso", "Gauge32", "Counter64", "TimeTicks", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Unsigned32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, aTPCTable=aTPCTable, loopbacks=loopbacks, ethRXCRCErrors=ethRXCRCErrors, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioLoopback=radioLoopback, vlanFid=vlanFid, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, ethTXDones=ethTXDones, ipRadio=ipRadio, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, radioDuplexShift=radioDuplexShift, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, localIp=localIp, ethRXBroadcasts=ethRXBroadcasts, modemAcqStatus=modemAcqStatus, writeConfig=writeConfig, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDones=ethRXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCarrierOffset=modemCarrierOffset, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfg=ipRadioCfg, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMax=modemACMmodulationMax, radioTxPower=radioTxPower, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanTable=vlanTable, radioGenStatus=radioGenStatus, loopback_tributary_mask=loopback_tributary_mask, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, ethRXLongEvents=ethRXLongEvents, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredBlock=modemErroredBlock, vlanPortmap=vlanPortmap, e1t1ChannelNr=e1t1ChannelNr, description=description, modemGeneralStatus=modemGeneralStatus, radioRxLevel=radioRxLevel, atpcEnabled=atpcEnabled, restartcpu=restartcpu, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLateCollisions=ethTXLateCollisions, modemIndex=modemIndex, e1t1StatEntry=e1t1StatEntry, ethTXUnderruns=ethTXUnderruns, radioIndex=radioIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, atpcIndex=atpcIndex, ethRXPauseFrames=ethRXPauseFrames, radioSide=radioSide, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, vlanPortType=vlanPortType, modemErroredSecondRatio=modemErroredSecondRatio, microwaveRadio=microwaveRadio, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStat=ipRadioStat, ipRadioStatEth=ipRadioStatEth, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, sysTemperature=sysTemperature, licenseMask=licenseMask, ethTXVlanTags=ethTXVlanTags, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, ipRadioCfgGeneral=ipRadioCfgGeneral, radioEntry=radioEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemModulation=modemModulation, ethTXPauseFrames=ethTXPauseFrames, modemBandwith=modemBandwith, modemStandard=modemStandard, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, e1t1LOS=e1t1LOS, modemUptime=modemUptime, saf=saf, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, vlanNumber=vlanNumber, license=license, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanCfgStat=vlanCfgStat, modemSymbolRateTx=modemSymbolRateTx, radioRxFrequency=radioRxFrequency, modemRowStatus=modemRowStatus, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, vlanEntry=vlanEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemRadialMSE=modemRadialMSE, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, safip=safip, modemInternalAGCgain=modemInternalAGCgain, ethTXControlFrames=ethTXControlFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPCHECErrors=ethGFPCHECErrors)
