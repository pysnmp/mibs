...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:54:02 2023
...
Counter64, Gauge32, NotificationType, enterprises, NotificationType, ObjectIdentity, IpAddress, Bits, ModuleIdentity, MibIdentifier, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "NotificationType", "enterprises", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, modemBandwith=modemBandwith, radioTxPower=radioTxPower, saf=saf, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, restartcpu=restartcpu, modemACMmodulationMax=modemACMmodulationMax, modemInternalAGCgain=modemInternalAGCgain, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, radioLoopback=radioLoopback, radioIndex=radioIndex, modemSymbolRateTx=modemSymbolRateTx, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, modemEntry=modemEntry, description=description, modemGeneralStatus=modemGeneralStatus, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDones=ethRXDones, ethTXByteCounterHi=ethTXByteCounterHi, radioTable=radioTable, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioStatEth=ipRadioStatEth, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, safip=safip, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatEntry=e1t1StatEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, product=product, modemSymbolRateRx=modemSymbolRateRx, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, modemTable=modemTable, radioGenStatus=radioGenStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, hostname=hostname, radioTxMute=radioTxMute, remoteIp=remoteIp, ethTXVlanTags=ethTXVlanTags, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, ipRadio=ipRadio, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, modemIndex=modemIndex, aTPCTable=aTPCTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, vlanFid=vlanFid, modemStatistics=modemStatistics, localIpMask=localIpMask, atpcIndex=atpcIndex, ipRadioCfg=ipRadioCfg, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, microwaveRadio=microwaveRadio, e1t1ChannelNr=e1t1ChannelNr, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCarrierOffset=modemCarrierOffset, aTPCEntry=aTPCEntry, ethQOSTXDropped=ethQOSTXDropped, license=license, modemStandard=modemStandard, vlanEntry=vlanEntry, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, e1t1StatTable=e1t1StatTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIp=localIp, modemUptime=modemUptime, modemModulation=modemModulation, sysTemperature=sysTemperature, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, ethRXLongEvents=ethRXLongEvents, modemErroredBlock=modemErroredBlock, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, ethTXBroadcasts=ethTXBroadcasts, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, ethRXCodeErrors=ethRXCodeErrors, writeConfig=writeConfig, modemErroredSecond=modemErroredSecond, ethTXLateCollisions=ethTXLateCollisions, ipRadioStat=ipRadioStat, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, e1t1LOS=e1t1LOS, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped)
