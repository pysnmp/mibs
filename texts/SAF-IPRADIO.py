...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, MibIdentifier, IpAddress, NotificationType, Counter64, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, Bits, enterprises, iso, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "MibIdentifier", "IpAddress", "NotificationType", "Counter64", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Bits", "enterprises", "iso", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, radioDuplexShift=radioDuplexShift, modemEntry=modemEntry, radioTable=radioTable, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioStat=ipRadioStat, e1t1LOS=e1t1LOS, ipRadioCfgNetwork=ipRadioCfgNetwork, modemModulation=modemModulation, radioSide=radioSide, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, license=license, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, description=description, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecond=modemErroredSecond, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, writeConfig=writeConfig, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXDropped=ethQOSTXDropped, vlanTable=vlanTable, radioTxFrequency=radioTxFrequency, safip=safip, radioGenStatus=radioGenStatus, ethTXDones=ethTXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, restartcpu=restartcpu, ethRXMulticasts=ethRXMulticasts, vlanNumber=vlanNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, loopback_tributary_mask=loopback_tributary_mask, modemBandwith=modemBandwith, modemACMmodulationMax=modemACMmodulationMax, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents, modemCarrierOffset=modemCarrierOffset, localIpMask=localIpMask, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, radioIndex=radioIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStatEth=ipRadioStatEth, microwaveRadio=microwaveRadio, modemStatistics=modemStatistics, atpcIndex=atpcIndex, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, product=product, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, hostname=hostname, modemGeneralStatus=modemGeneralStatus, loopbacks=loopbacks, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, modemTotalCapacity=modemTotalCapacity, modemUptime=modemUptime, radioTxPower=radioTxPower, sysTemperature=sysTemperature, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, ethRXDones=ethRXDones, modemTable=modemTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlansEnabled=vlansEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfg=ipRadioCfg, radioEntry=radioEntry, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, e1t1AIS=e1t1AIS, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, ethTXLateCollisions=ethTXLateCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioLoopback=radioLoopback, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, vlanPortmap=vlanPortmap, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, ethTXUnderruns=ethTXUnderruns, modemLastAcqError=modemLastAcqError, atpcTxPowerCorrection=atpcTxPowerCorrection, remoteIp=remoteIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, modemSymbolRateRx=modemSymbolRateRx, modemEthernetCapacity=modemEthernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, ipRadio=ipRadio, aTPCTable=aTPCTable, ethRXDribleNibbles=ethRXDribleNibbles, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, saf=saf)
