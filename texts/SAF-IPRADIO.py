...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:19:54 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Counter32, iso, Gauge32, Bits, MibIdentifier, TimeTicks, Unsigned32, Integer32, ModuleIdentity, NotificationType, NotificationType, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Counter32", "iso", "Gauge32", "Bits", "MibIdentifier", "TimeTicks", "Unsigned32", "Integer32", "ModuleIdentity", "NotificationType", "NotificationType", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterLow=ethTXWireByteCounterLow, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXGiants=ethTXGiants, writeConfig=writeConfig, atpcEnabled=atpcEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterLow=ethTXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, license=license, radioTxPower=radioTxPower, ethTXLateCollisions=ethTXLateCollisions, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, ethTXCRCErrors=ethTXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterHi=ethTXByteCounterHi, e1t1LOS=e1t1LOS, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, vlanTable=vlanTable, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, loopback_tributary_mask=loopback_tributary_mask, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, vlanPortType=vlanPortType, ethRXByteCounterLow=ethRXByteCounterLow, licenseMask=licenseMask, tehnika=tehnika, modemStandard=modemStandard, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, saf=saf, sysDateAndTime=sysDateAndTime, localIpMask=localIpMask, modemEthernetCapacity=modemEthernetCapacity, modemTotalCapacity=modemTotalCapacity, e1t1StatTable=e1t1StatTable, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, radioTxFrequency=radioTxFrequency, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, atpcIndex=atpcIndex, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXFrames=ethQOSTXFrames, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, radioTable=radioTable, radioDuplexShift=radioDuplexShift, modemCountTime=modemCountTime, ethGFPCHECErrors=ethGFPCHECErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemIndex=modemIndex, vlanEntry=vlanEntry, ipRadioMgmt=ipRadioMgmt, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadio=ipRadio, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXBroadcasts=ethRXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, product=product, ethRXDribleNibbles=ethRXDribleNibbles, localIp=localIp, ethTXPauseFrames=ethTXPauseFrames, e1t1StatEntry=e1t1StatEntry, hostname=hostname, modemEntry=modemEntry, radioRxLevel=radioRxLevel, e1t1AIS=e1t1AIS, modemUptime=modemUptime, radioEntry=radioEntry, ipRadioStat=ipRadioStat, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrror=modemBackgroundBlockErrror, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, vlanPortmap=vlanPortmap, safip=safip, modemACMengine=modemACMengine, ipRadioCfg=ipRadioCfg, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioLoopback=radioLoopback, radioTxMute=radioTxMute, ethTXVlanTags=ethTXVlanTags, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXLongEvents=ethRXLongEvents, ethTXDones=ethTXDones, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, description=description, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, radioSide=radioSide, radioIndex=radioIndex)
