...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:22:49 2024
...
Integer32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, NotificationType, ModuleIdentity, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, Bits, Counter64, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "Bits", "Counter64", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioSide=radioSide, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemRowStatus=modemRowStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanEntry=vlanEntry, product=product, ethTXByteCounterLow=ethTXByteCounterLow, localIp=localIp, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, loopback_tributary_mask=loopback_tributary_mask, license=license, e1t1LOS=e1t1LOS, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, modemBandwith=modemBandwith, vlanNumber=vlanNumber, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, modemAcqStatus=modemAcqStatus, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, modemStandard=modemStandard, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, vlanPortmap=vlanPortmap, ethTXWireByteCounterLow=ethTXWireByteCounterLow, description=description, restartcpu=restartcpu, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower, modemACMethernetCapacity=modemACMethernetCapacity, modemEthernetCapacity=modemEthernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, remoteIp=remoteIp, vlanRowStatus=vlanRowStatus, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, e1t1AIS=e1t1AIS, licenseMask=licenseMask, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, sysTemperature=sysTemperature, sysDateAndTime=sysDateAndTime, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCRCErrors=ethRXCRCErrors, ipRadioStatEth=ipRadioStatEth, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, modemUnavailtime=modemUnavailtime, radioTxFrequency=radioTxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, ethRXLongEvents=ethRXLongEvents, licenseUpdateStatus=licenseUpdateStatus, localIpMask=localIpMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, modemLastAcqError=modemLastAcqError, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, saf=saf, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, modemErroredBlock=modemErroredBlock, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, vlanPortType=vlanPortType, ethRXDones=ethRXDones, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1Channels=modemE1T1Channels, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioIndex=radioIndex, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, aTPCTable=aTPCTable, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfg=ipRadioCfg, ethTXMulticasts=ethTXMulticasts, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, ipRadioMgmt=ipRadioMgmt, ipRadio=ipRadio, ethQOSTXFrames=ethQOSTXFrames, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, ethGFPFCSErrors=ethGFPFCSErrors, modemIndex=modemIndex, atpcEnabled=atpcEnabled, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanTable=vlanTable, modemACMengine=modemACMengine, modemModulation=modemModulation, loopbacks=loopbacks, ipRadioCfgNetwork=ipRadioCfgNetwork, radioEntry=radioEntry, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMin=modemACMmodulationMin)
