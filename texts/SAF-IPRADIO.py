...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:19:20 2022
...
IpAddress, Counter64, iso, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, NotificationType, NotificationType, enterprises, Gauge32, ModuleIdentity, Bits, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "iso", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "NotificationType", "NotificationType", "enterprises", "Gauge32", "ModuleIdentity", "Bits", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXByteCounterHi=ethTXByteCounterHi, tehnika=tehnika, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS, modemModulation=modemModulation, modemGeneralStatus=modemGeneralStatus, ipRadioCfg=ipRadioCfg, modemErroredSecondRatio=modemErroredSecondRatio, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, vlanFid=vlanFid, ethTXCollisions=ethTXCollisions, aTPCTable=aTPCTable, modemIndex=modemIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEntry=modemEntry, ethRXByteCounterLow=ethRXByteCounterLow, microwaveRadio=microwaveRadio, product=product, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, ethTXBackpresEvents=ethTXBackpresEvents, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, localIpMask=localIpMask, ethTXVlanTags=ethTXVlanTags, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioEntry=radioEntry, ethTXGiants=ethTXGiants, radioGenStatus=radioGenStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, hostname=hostname, e1t1StatTable=e1t1StatTable, aTPCEntry=aTPCEntry, ethRXDones=ethRXDones, modemSymbolRateRx=modemSymbolRateRx, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, radioTxPower=radioTxPower, ethTXMaxCollisions=ethTXMaxCollisions, radioTxFrequency=radioTxFrequency, radioTxMute=radioTxMute, loopback_tributary_mask=loopback_tributary_mask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, vlanEntry=vlanEntry, licenseUpdateStatus=licenseUpdateStatus, safip=safip, loopbacks=loopbacks, e1t1LOS=e1t1LOS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, modemACMethernetCapacity=modemACMethernetCapacity, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, ethRXCodeErrors=ethRXCodeErrors, e1t1StatEntry=e1t1StatEntry, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXUnderruns=ethTXUnderruns, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, ethTXPauseFrames=ethTXPauseFrames, restartcpu=restartcpu, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, radioRxFrequency=radioRxFrequency, atpcEnabled=atpcEnabled, writeConfig=writeConfig, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, saf=saf, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1Channels=modemE1T1Channels, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPFCSErrors=ethGFPFCSErrors, license=license, ethTXLateCollisions=ethTXLateCollisions, vlanTable=vlanTable, radioRxLevel=radioRxLevel, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanNumber=vlanNumber, radioIndex=radioIndex, modemLastAcqError=modemLastAcqError, ethTXMulticasts=ethTXMulticasts, modemRowStatus=modemRowStatus, vlanRowStatus=vlanRowStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, description=description, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, radioLoopback=radioLoopback, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, remoteIp=remoteIp, modemTable=modemTable, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortmap=vlanPortmap, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped)
