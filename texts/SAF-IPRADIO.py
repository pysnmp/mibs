...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:04:32 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ModuleIdentity, iso, NotificationType, ObjectIdentity, enterprises, NotificationType, Unsigned32, MibIdentifier, TimeTicks, Integer32, Bits, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ModuleIdentity", "iso", "NotificationType", "ObjectIdentity", "enterprises", "NotificationType", "Unsigned32", "MibIdentifier", "TimeTicks", "Integer32", "Bits", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanNumber=vlanNumber, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, e1t1LOS=e1t1LOS, modemACMtotalCapacity=modemACMtotalCapacity, modemCountTime=modemCountTime, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDvEvent=ethRXDvEvent, tehnika=tehnika, restartcpu=restartcpu, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBroadcasts=ethTXBroadcasts, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, ethTXUnderruns=ethTXUnderruns, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1Channels=modemE1T1Channels, radioDuplexShift=radioDuplexShift, e1t1StatEntry=e1t1StatEntry, aTPCTable=aTPCTable, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, vlanTable=vlanTable, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUptime=modemUptime, radioEntry=radioEntry, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortmap=vlanPortmap, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, modemTable=modemTable, modemCarrierOffset=modemCarrierOffset, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecondRatio=modemErroredSecondRatio, writeConfig=writeConfig, e1t1AIS=e1t1AIS, product=product, localIpMask=localIpMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, ethRXPauseFrames=ethRXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStandard=modemStandard, ethRXBroadcasts=ethRXBroadcasts, license=license, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, sysTemperature=sysTemperature, radioLoopback=radioLoopback, vlanEntry=vlanEntry, saf=saf, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, safip=safip, description=description, ethRXDones=ethRXDones, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLongEvents=ethRXLongEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, modemInternalAGCgain=modemInternalAGCgain, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, pointToPoint=pointToPoint, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, modemUnavailtime=modemUnavailtime, localIp=localIp, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioGenStatus=radioGenStatus, modemEntry=modemEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseUpdateStatus=licenseUpdateStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, remoteIp=remoteIp, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, ipRadioStatEth=ipRadioStatEth, radioIndex=radioIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, hostname=hostname, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, modemACMethernetCapacity=modemACMethernetCapacity, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXDropped=ethQOSTXDropped, ethTXGiants=ethTXGiants, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterHi=ethTXByteCounterHi, vlanCfgStat=vlanCfgStat, radioTable=radioTable, modemLastAcqError=modemLastAcqError, ipRadioCfg=ipRadioCfg, ethTXMulticasts=ethTXMulticasts, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, modemBandwith=modemBandwith, ethTXControlFrames=ethTXControlFrames)
