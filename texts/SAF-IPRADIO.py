...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:01:01 2024
...
TimeTicks, NotificationType, enterprises, Integer32, iso, Gauge32, ModuleIdentity, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "enterprises", "Integer32", "iso", "Gauge32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, vlanNumber=vlanNumber, modemRadialMSE=modemRadialMSE, ipRadioCfg=ipRadioCfg, radioTable=radioTable, modemCountTime=modemCountTime, vlanTable=vlanTable, safip=safip, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, ethTXGiants=ethTXGiants, localIp=localIp, saf=saf, atpcIndex=atpcIndex, ethTXPauseFrames=ethTXPauseFrames, tehnika=tehnika, ethQOSRXQ2Frames=ethQOSRXQ2Frames, remoteIp=remoteIp, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBroadcasts=ethTXBroadcasts, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, modemSymbolRateRx=modemSymbolRateRx, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioSide=radioSide, aTPCEntry=aTPCEntry, modemGeneralStatus=modemGeneralStatus, vlanFid=vlanFid, radioRxLevel=radioRxLevel, radioIndex=radioIndex, ipRadio=ipRadio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, description=description, product=product, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxPower=radioTxPower, modemACMmodulationMin=modemACMmodulationMin, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXControlFrames=ethRXControlFrames, ethRXCodeErrors=ethRXCodeErrors, modemEthernetCapacity=modemEthernetCapacity, writeConfig=writeConfig, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortType=vlanPortType, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, modemCarrierOffset=modemCarrierOffset, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemUnavailtime=modemUnavailtime, ethRXDvEvent=ethRXDvEvent, licenseUpdateStatus=licenseUpdateStatus, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, modemUptime=modemUptime, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, vlanEntry=vlanEntry, modemSymbolRateTx=modemSymbolRateTx, vlanRowStatus=vlanRowStatus, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime, licenseMask=licenseMask, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, e1t1StatEntry=e1t1StatEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMax=modemACMmodulationMax, e1t1LOS=e1t1LOS, modemModulation=modemModulation, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, pointToPoint=pointToPoint, microwaveRadio=microwaveRadio, vlansEnabled=vlansEnabled, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStat=ipRadioStat, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, modemTotalCapacity=modemTotalCapacity, license=license, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap)
