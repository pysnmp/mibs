...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:08:52 2023
...
Unsigned32, Bits, Gauge32, enterprises, TimeTicks, Integer32, Counter64, iso, NotificationType, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Gauge32", "enterprises", "TimeTicks", "Integer32", "Counter64", "iso", "NotificationType", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLongEvents=ethRXLongEvents, ethRXDribleNibbles=ethRXDribleNibbles, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, safip=safip, restartcpu=restartcpu, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, modemEthernetCapacity=modemEthernetCapacity, ipRadio=ipRadio, modemTotalCapacity=modemTotalCapacity, microwaveRadio=microwaveRadio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, modemModulation=modemModulation, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortType=vlanPortType, ipRadioMgmt=ipRadioMgmt, radioGenStatus=radioGenStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecondRatio=modemErroredSecondRatio, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatTable=e1t1StatTable, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, ethGFPCHECErrors=ethGFPCHECErrors, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled, ethTXLateCollisions=ethTXLateCollisions, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, aTPCEntry=aTPCEntry, ipRadioStat=ipRadioStat, ethTXPauseFrames=ethTXPauseFrames, writeConfig=writeConfig, modemACMethernetCapacity=modemACMethernetCapacity, description=description, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, modemLastAcqError=modemLastAcqError, modemIndex=modemIndex, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, ethTXCollisions=ethTXCollisions, modemSymbolRateRx=modemSymbolRateRx, modemGeneralStatus=modemGeneralStatus, modemStandard=modemStandard, vlanFid=vlanFid, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, ethRXDones=ethRXDones, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXBroadcasts=ethTXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, aTPCTable=aTPCTable, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, license=license, radioTable=radioTable, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxFrequency=radioRxFrequency, localIp=localIp, localIpMask=localIpMask, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, saf=saf, radioEntry=radioEntry, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, modemCarrierOffset=modemCarrierOffset, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, modemStatistics=modemStatistics, modemACMtotalCapacity=modemACMtotalCapacity, radioTxPower=radioTxPower, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterHi=ethRXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDvEvent=ethRXDvEvent, radioRxLevel=radioRxLevel, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXCRCErrors=ethRXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, hostname=hostname, loopback_tributary_mask=loopback_tributary_mask, product=product, radioIndex=radioIndex, modemUnavailtime=modemUnavailtime, loopbacks=loopbacks, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors)
