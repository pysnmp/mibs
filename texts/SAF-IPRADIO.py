...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:35:29 2023
...
MibIdentifier, iso, Gauge32, NotificationType, Counter32, Bits, Counter64, NotificationType, TimeTicks, enterprises, IpAddress, ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Gauge32", "NotificationType", "Counter32", "Bits", "Counter64", "NotificationType", "TimeTicks", "enterprises", "IpAddress", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXDones=ethTXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, ipRadio=ipRadio, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, radioTxFrequency=radioTxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemAcqStatus=modemAcqStatus, modemIndex=modemIndex, product=product, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioDuplexShift=radioDuplexShift, saf=saf, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, localIp=localIp, radioTable=radioTable, ethRXLongEvents=ethRXLongEvents, e1t1LOS=e1t1LOS, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, radioSide=radioSide, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, ethGFPFCSErrors=ethGFPFCSErrors, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, radioRxFrequency=radioRxFrequency, modemRowStatus=modemRowStatus, e1t1StatTable=e1t1StatTable, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysDateAndTime=sysDateAndTime, modemRadialMSE=modemRadialMSE, ethRXPauseFrames=ethRXPauseFrames, ethRXBroadcasts=ethRXBroadcasts, aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, ipRadioMgmt=ipRadioMgmt, modemEntry=modemEntry, modemTable=modemTable, radioTxMute=radioTxMute, ethRXCodeErrors=ethRXCodeErrors, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, safip=safip, ethRXTruncatedFrames=ethRXTruncatedFrames, modemUptime=modemUptime, ethGFPCHECErrors=ethGFPCHECErrors, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, radioTxPower=radioTxPower, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, modemEthernetCapacity=modemEthernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCollisions=ethTXCollisions, modemTotalCapacity=modemTotalCapacity, modemInternalAGCgain=modemInternalAGCgain, vlanPortType=vlanPortType, radioEntry=radioEntry, ethTXControlFrames=ethTXControlFrames, description=description, modemStandard=modemStandard, ethTXMulticasts=ethTXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, e1t1StatEntry=e1t1StatEntry, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMax=modemACMmodulationMax, vlanTable=vlanTable, radioLoopback=radioLoopback, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, ipRadioStat=ipRadioStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMengine=modemACMengine, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUnavailtime=modemUnavailtime, ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, sysTemperature=sysTemperature, radioIndex=radioIndex, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, loopback_tributary_mask=loopback_tributary_mask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemGeneralStatus=modemGeneralStatus, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, vlanCfgStat=vlanCfgStat, vlanFid=vlanFid, license=license, modemACMtotalCapacity=modemACMtotalCapacity, restartcpu=restartcpu, writeConfig=writeConfig, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcIndex=atpcIndex, hostname=hostname, licenseMask=licenseMask, loopbacks=loopbacks, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXPauseFrames=ethTXPauseFrames)
