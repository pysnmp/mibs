...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:21:10 2023
...
NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, iso, NotificationType, Unsigned32, Integer32, Counter32, ModuleIdentity, ObjectIdentity, TimeTicks, MibIdentifier, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "iso", "NotificationType", "Unsigned32", "Integer32", "Counter32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Bits", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMin=modemACMmodulationMin, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalCapacity=modemTotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfg=ipRadioCfg, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, aTPCTable=aTPCTable, radioEntry=radioEntry, ipRadioStatEth=ipRadioStatEth, radioTable=radioTable, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDones=ethRXDones, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemAcqStatus=modemAcqStatus, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, ethRXMulticasts=ethRXMulticasts, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, modemModulation=modemModulation, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, ethRXPauseFrames=ethRXPauseFrames, radioSide=radioSide, atpcEnabled=atpcEnabled, radioGenStatus=radioGenStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, modemTotalBlockNumber=modemTotalBlockNumber, loopback_tributary_mask=loopback_tributary_mask, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, modemLastAcqError=modemLastAcqError, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, sysDateAndTime=sysDateAndTime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, description=description, aTPCEntry=aTPCEntry, loopbacks=loopbacks, radioDuplexShift=radioDuplexShift, ethTXPauseFrames=ethTXPauseFrames, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, radioLoopback=radioLoopback, ethTXGiants=ethTXGiants, modemInternalAGCgain=modemInternalAGCgain, ipRadioStat=ipRadioStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRadialMSE=modemRadialMSE, radioIndex=radioIndex, modemErroredSecond=modemErroredSecond, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, radioTxFrequency=radioTxFrequency, e1t1AIS=e1t1AIS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateRx=modemSymbolRateRx, vlanFid=vlanFid, modemTable=modemTable, microwaveRadio=microwaveRadio, safip=safip, modemE1T1Channels=modemE1T1Channels, vlansEnabled=vlansEnabled, restartcpu=restartcpu, modemEntry=modemEntry, ethRXByteCounterLow=ethRXByteCounterLow, licenseMask=licenseMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXControlFrames=ethTXControlFrames, localIp=localIp, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, ipRadio=ipRadio, atpcIndex=atpcIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, radioRxLevel=radioRxLevel, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, modemUptime=modemUptime, modemRowStatus=modemRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredBlock=modemErroredBlock, product=product, vlanCfgStat=vlanCfgStat, vlanPortType=vlanPortType, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, writeConfig=writeConfig, modemStatistics=modemStatistics, hostname=hostname, modemStandard=modemStandard, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXControlFrames=ethRXControlFrames, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, e1t1ChannelNr=e1t1ChannelNr, ethTXMulticasts=ethTXMulticasts, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethTXDones=ethTXDones, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxMute=radioTxMute, ethRXByteCounterHi=ethRXByteCounterHi)
