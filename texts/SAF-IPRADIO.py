...
# Produced by pysmi-1.1.8 at Fri Jan 14 00:00:28 2022
...
IpAddress, Counter64, MibIdentifier, enterprises, Integer32, TimeTicks, NotificationType, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "NotificationType", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanFid=vlanFid, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, ethGFPFCSErrors=ethGFPFCSErrors, radioTxFrequency=radioTxFrequency, modemUptime=modemUptime, modemACMethernetCapacity=modemACMethernetCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioSide=radioSide, modemIndex=modemIndex, radioTxPower=radioTxPower, modemLDPCdecoderStress=modemLDPCdecoderStress, loopbacks=loopbacks, modemStandard=modemStandard, sysTemperature=sysTemperature, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, e1t1AIS=e1t1AIS, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, modemTotalCapacity=modemTotalCapacity, saf=saf, vlanCfgStat=vlanCfgStat, modemEntry=modemEntry, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLateCollisions=ethTXLateCollisions, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, description=description, ipRadioMgmt=ipRadioMgmt, modemE1T1ChannelMask=modemE1T1ChannelMask, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCountTime=modemCountTime, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDones=ethRXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, ethGFPDropedFrames=ethGFPDropedFrames, vlanEntry=vlanEntry, microwaveRadio=microwaveRadio, modemTable=modemTable, modemACMmodulationMax=modemACMmodulationMax, ethTXVlanTags=ethTXVlanTags, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIp=localIp, tehnika=tehnika, vlanNumber=vlanNumber, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, license=license, modemACMengine=modemACMengine, vlanPortmap=vlanPortmap, radioIndex=radioIndex, vlansEnabled=vlansEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatEntry=e1t1StatEntry, ethRXMulticasts=ethRXMulticasts, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, modemTotalBlockNumber=modemTotalBlockNumber, aTPCTable=aTPCTable, pointToPoint=pointToPoint, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEthernetCapacity=modemEthernetCapacity, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1ChannelNr=e1t1ChannelNr, vlanPortType=vlanPortType, ipRadio=ipRadio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, ethTXMulticasts=ethTXMulticasts, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, hostname=hostname, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemLastAcqError=modemLastAcqError, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanTable=vlanTable, ethTXBackpresEvents=ethTXBackpresEvents, licenseUpdateStatus=licenseUpdateStatus, safip=safip, product=product, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredBlock=modemErroredBlock, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioGenStatus=radioGenStatus, modemBandwith=modemBandwith, ethTXGiants=ethTXGiants, modemE1T1Channels=modemE1T1Channels, radioRxLevel=radioRxLevel, radioTable=radioTable, radioEntry=radioEntry, radioRxFrequency=radioRxFrequency, licenseMask=licenseMask, atpcEnabled=atpcEnabled)
