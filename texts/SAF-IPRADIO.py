...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:37:25 2022
...
NotificationType, Integer32, Unsigned32, Counter64, ModuleIdentity, NotificationType, MibIdentifier, IpAddress, enterprises, TimeTicks, ObjectIdentity, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Unsigned32", "Counter64", "ModuleIdentity", "NotificationType", "MibIdentifier", "IpAddress", "enterprises", "TimeTicks", "ObjectIdentity", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateTx=modemSymbolRateTx, vlanFid=vlanFid, ethTXControlFrames=ethTXControlFrames, ethRXPauseFrames=ethRXPauseFrames, vlanNumber=vlanNumber, hostname=hostname, localIp=localIp, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterHi=ethTXByteCounterHi, modemACMengine=modemACMengine, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanCfgStat=vlanCfgStat, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, saf=saf, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, modemEntry=modemEntry, ipRadioStatEth=ipRadioStatEth, licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, vlanTable=vlanTable, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, modemBandwith=modemBandwith, ipRadio=ipRadio, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, radioIndex=radioIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioSide=radioSide, e1t1LOS=e1t1LOS, ethTXCollisions=ethTXCollisions, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, ethRXBroadcasts=ethRXBroadcasts, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, radioTable=radioTable, modemStandard=modemStandard, pointToPoint=pointToPoint, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, ethRXCRCErrors=ethRXCRCErrors, ethTXUnderruns=ethTXUnderruns, modemUnavailtime=modemUnavailtime, ethRXDones=ethRXDones, ethRXLongEvents=ethRXLongEvents, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMax=modemACMmodulationMax, radioTxPower=radioTxPower, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, ethRXDribleNibbles=ethRXDribleNibbles, aTPCEntry=aTPCEntry, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioEntry=radioEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, loopbacks=loopbacks, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, ethRXDvEvent=ethRXDvEvent, localIpMask=localIpMask, product=product, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, ipRadioMgmt=ipRadioMgmt, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, description=description, microwaveRadio=microwaveRadio, ethRXMulticasts=ethRXMulticasts, modemEthernetCapacity=modemEthernetCapacity, safip=safip, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStat=ipRadioStat, vlanPortmap=vlanPortmap, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1AIS=e1t1AIS, ethQOSTXFrames=ethQOSTXFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRowStatus=modemRowStatus, vlanRowStatus=vlanRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemIndex=modemIndex, atpcIndex=atpcIndex, atpcEnabled=atpcEnabled, modemTable=modemTable, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi)
