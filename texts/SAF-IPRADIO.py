...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:38:50 2022
...
iso, Unsigned32, ModuleIdentity, MibIdentifier, enterprises, Bits, NotificationType, Gauge32, TimeTicks, Counter32, NotificationType, Counter64, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "ModuleIdentity", "MibIdentifier", "enterprises", "Bits", "NotificationType", "Gauge32", "TimeTicks", "Counter32", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIp=localIp, safip=safip, license=license, radioLoopback=radioLoopback, ethGFPFCSErrors=ethGFPFCSErrors, description=description, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecond=modemErroredSecond, modemACMengine=modemACMengine, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, modemRadialMSE=modemRadialMSE, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, e1t1StatEntry=e1t1StatEntry, microwaveRadio=microwaveRadio, vlansEnabled=vlansEnabled, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanEntry=vlanEntry, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadio=ipRadio, ethTXByteCounterHi=ethTXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanCfgStat=vlanCfgStat, hostname=hostname, aTPCTable=aTPCTable, vlanPortType=vlanPortType, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, ethRXDones=ethRXDones, modemCountTime=modemCountTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, modemInternalAGCgain=modemInternalAGCgain, pointToPoint=pointToPoint, localIpMask=localIpMask, ethRXByteCounterLow=ethRXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, modemTable=modemTable, atpcTxPowerCorrection=atpcTxPowerCorrection, writeConfig=writeConfig, radioTxFrequency=radioTxFrequency, modemIndex=modemIndex, ethTXMulticasts=ethTXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, e1t1LOS=e1t1LOS, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, e1t1AIS=e1t1AIS, modemSymbolRateRx=modemSymbolRateRx, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, modemErroredBlock=modemErroredBlock, saf=saf, modemE1T1Channels=modemE1T1Channels, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, ethTXCollisions=ethTXCollisions, product=product, ipRadioStat=ipRadioStat, loopbacks=loopbacks, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, radioTxPower=radioTxPower, radioGenStatus=radioGenStatus, ethRXDvEvent=ethRXDvEvent, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXGiants=ethTXGiants, modemModulation=modemModulation, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, atpcIndex=atpcIndex, ethTXVlanTags=ethTXVlanTags, ethQOSTXFrames=ethQOSTXFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, tehnika=tehnika, radioSide=radioSide, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcEnabled=atpcEnabled, radioEntry=radioEntry, vlanPortmap=vlanPortmap, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, modemEntry=modemEntry, licenseMask=licenseMask, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatTable=e1t1StatTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, ethRXTruncatedFrames=ethRXTruncatedFrames)
