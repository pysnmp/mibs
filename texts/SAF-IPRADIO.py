...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:40:29 2024
...
TimeTicks, IpAddress, Counter64, enterprises, Counter32, Integer32, ObjectIdentity, NotificationType, Unsigned32, MibIdentifier, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter64", "enterprises", "Counter32", "Integer32", "ObjectIdentity", "NotificationType", "Unsigned32", "MibIdentifier", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioGenStatus=radioGenStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, sysDateAndTime=sysDateAndTime, ethTXCRCErrors=ethTXCRCErrors, ipRadioMgmt=ipRadioMgmt, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseUpdateStatus=licenseUpdateStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanNumber=vlanNumber, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, ethRXDvEvent=ethRXDvEvent, e1t1AIS=e1t1AIS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, modemRowStatus=modemRowStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, saf=saf, localIp=localIp, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, vlanCfgStat=vlanCfgStat, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalCapacity=modemTotalCapacity, ipRadio=ipRadio, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, vlansEnabled=vlansEnabled, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPCHECErrors=ethGFPCHECErrors, atpcEnabled=atpcEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, microwaveRadio=microwaveRadio, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, ethRXTruncatedFrames=ethRXTruncatedFrames, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, remoteIp=remoteIp, modemErroredBlock=modemErroredBlock, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, modemACMtotalCapacity=modemACMtotalCapacity, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxMute=radioTxMute, ethTXBroadcasts=ethTXBroadcasts, safip=safip, ethTXLateCollisions=ethTXLateCollisions, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemEntry=modemEntry, hostname=hostname, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, modemTable=modemTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, ethRXLongEvents=ethRXLongEvents, ethTXGiants=ethTXGiants, e1t1StatTable=e1t1StatTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTable=radioTable, radioEntry=radioEntry, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, vlanFid=vlanFid, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, ethTXByteCounterLow=ethTXByteCounterLow, modemRadialMSE=modemRadialMSE, modemCountTime=modemCountTime, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, modemAcqStatus=modemAcqStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, modemStandard=modemStandard, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, ethQOSTXDropped=ethQOSTXDropped, license=license, pointToPoint=pointToPoint, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBandwith=modemBandwith, vlanRowStatus=vlanRowStatus, product=product, e1t1ChannelNr=e1t1ChannelNr, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, ethTXPauseFrames=ethTXPauseFrames, modemACMengine=modemACMengine, ethTXDones=ethTXDones, licenseMask=licenseMask, aTPCTable=aTPCTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStatEth=ipRadioStatEth, vlanEntry=vlanEntry, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi)
