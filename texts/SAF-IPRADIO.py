...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:11:21 2021
...
Gauge32, NotificationType, Integer32, Counter32, Bits, Unsigned32, IpAddress, ModuleIdentity, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, NotificationType, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Integer32", "Counter32", "Bits", "Unsigned32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "NotificationType", "Counter64", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, modemRowStatus=modemRowStatus, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStatistics=modemStatistics, atpcEnabled=atpcEnabled, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateRx=modemSymbolRateRx, modemEntry=modemEntry, pointToPoint=pointToPoint, modemLastAcqError=modemLastAcqError, modemModulation=modemModulation, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCodeErrors=ethRXCodeErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMin=modemACMmodulationMin, ipRadioStatEth=ipRadioStatEth, ipRadioCfg=ipRadioCfg, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, radioRxFrequency=radioRxFrequency, remoteIp=remoteIp, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioMgmt=ipRadioMgmt, modemInternalAGCgain=modemInternalAGCgain, modemAcqStatus=modemAcqStatus, modemSymbolRateTx=modemSymbolRateTx, license=license, loopbacks=loopbacks, ethTXMulticasts=ethTXMulticasts, description=description, hostname=hostname, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXDones=ethTXDones, product=product, modemIndex=modemIndex, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, e1t1LOS=e1t1LOS, safip=safip, microwaveRadio=microwaveRadio, modemGeneralStatus=modemGeneralStatus, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDones=ethRXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCountTime=modemCountTime, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, vlanRowStatus=vlanRowStatus, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTable=radioTable, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, sysTemperature=sysTemperature, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, licenseMask=licenseMask, radioEntry=radioEntry, ethTXGiants=ethTXGiants, vlanPortmap=vlanPortmap, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, tehnika=tehnika, ethRXDvEvent=ethRXDvEvent, aTPCEntry=aTPCEntry, modemRadialMSE=modemRadialMSE, ethRXBroadcasts=ethRXBroadcasts, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXControlFrames=ethRXControlFrames, modemEthernetCapacity=modemEthernetCapacity, radioTxPower=radioTxPower, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLongEvents=ethRXLongEvents, e1t1StatTable=e1t1StatTable, ethTXControlFrames=ethTXControlFrames, modemUptime=modemUptime, modemBandwith=modemBandwith, radioDuplexShift=radioDuplexShift, radioTxMute=radioTxMute, vlanFid=vlanFid, ethTXCRCErrors=ethTXCRCErrors, localIp=localIp, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrror=modemBackgroundBlockErrror, localIpMask=localIpMask, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, sysDateAndTime=sysDateAndTime)
