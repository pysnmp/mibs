...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:54:52 2024
...
iso, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, Counter32, NotificationType, Bits, Integer32, Counter64, MibIdentifier, ModuleIdentity, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "Bits", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, modemRowStatus=modemRowStatus, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, aTPCTable=aTPCTable, ethRXTruncatedFrames=ethRXTruncatedFrames, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemModulation=modemModulation, radioTxFrequency=radioTxFrequency, radioDuplexShift=radioDuplexShift, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, ethGFPDropedFrames=ethGFPDropedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, pointToPoint=pointToPoint, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, description=description, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, license=license, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPCHECErrors=ethGFPCHECErrors, vlanEntry=vlanEntry, modemStandard=modemStandard, e1t1AIS=e1t1AIS, modemBandwith=modemBandwith, ethQOSTXDropped=ethQOSTXDropped, ethRXPauseFrames=ethRXPauseFrames, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, vlanRowStatus=vlanRowStatus, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, radioIndex=radioIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateRx=modemSymbolRateRx, restartcpu=restartcpu, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ipRadio=ipRadio, vlanFid=vlanFid, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateTx=modemSymbolRateTx, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, product=product, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, remoteIp=remoteIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXControlFrames=ethTXControlFrames, localIp=localIp, hostname=hostname, vlanTable=vlanTable, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, modemAcqStatus=modemAcqStatus, licenseUpdateStatus=licenseUpdateStatus, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterLow=ethRXByteCounterLow, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemIndex=modemIndex, modemErroredSecond=modemErroredSecond, radioTable=radioTable, ethTXByteCounterHi=ethTXByteCounterHi, vlanNumber=vlanNumber, ethTXMaxCollisions=ethTXMaxCollisions, e1t1LOS=e1t1LOS, radioTxPower=radioTxPower, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, ipRadioStatEth=ipRadioStatEth, vlanCfgStat=vlanCfgStat, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXFrames=ethQOSTXFrames, ethTXBroadcasts=ethTXBroadcasts, modemCountTime=modemCountTime, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, safip=safip, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, localIpMask=localIpMask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUnavailtime=modemUnavailtime, saf=saf, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMengine=modemACMengine)
