...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:14:12 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier, Bits, Counter64, ModuleIdentity, iso, Gauge32, ObjectIdentity, Counter32, IpAddress, Integer32, NotificationType, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier", "Bits", "Counter64", "ModuleIdentity", "iso", "Gauge32", "ObjectIdentity", "Counter32", "IpAddress", "Integer32", "NotificationType", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecondRatio=modemErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, ethTXGiants=ethTXGiants, modemTotalBlockNumber=modemTotalBlockNumber, modemUptime=modemUptime, description=description, radioGenStatus=radioGenStatus, vlanFid=vlanFid, ethRXControlFrames=ethRXControlFrames, ipRadio=ipRadio, vlanPortmap=vlanPortmap, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, radioSide=radioSide, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDvEvent=ethRXDvEvent, modemInternalAGCgain=modemInternalAGCgain, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, ethTXPauseFrames=ethTXPauseFrames, ethRXBroadcasts=ethRXBroadcasts, radioEntry=radioEntry, vlansEnabled=vlansEnabled, radioIndex=radioIndex, sysTemperature=sysTemperature, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, sysDateAndTime=sysDateAndTime, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioRxFrequency=radioRxFrequency, e1t1AIS=e1t1AIS, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxPower=radioTxPower, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, modemCountTime=modemCountTime, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, safip=safip, localIp=localIp, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortType=vlanPortType, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatTable=e1t1StatTable, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMengine=modemACMengine, ipRadioStatEth=ipRadioStatEth, tehnika=tehnika, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, ethQOSTXDropped=ethQOSTXDropped, vlanEntry=vlanEntry, modemTotalCapacity=modemTotalCapacity, ethRXDones=ethRXDones, aTPCEntry=aTPCEntry, modemIndex=modemIndex, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, product=product, ethTXUnderruns=ethTXUnderruns, modemTable=modemTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCRCErrors=ethRXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPauseFrames=ethRXPauseFrames, modemModulation=modemModulation, vlanTable=vlanTable, licenseMask=licenseMask, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, ethTXLateCollisions=ethTXLateCollisions, ipRadioMgmt=ipRadioMgmt, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBandwith=modemBandwith, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, microwaveRadio=microwaveRadio, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, modemRowStatus=modemRowStatus, license=license, vlanNumber=vlanNumber, ethQOSTXFrames=ethQOSTXFrames, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMin=modemACMmodulationMin, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStat=ipRadioStat, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, saf=saf, localIpMask=localIpMask, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute)
