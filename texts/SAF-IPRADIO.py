...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:50:57 2024
...
NotificationType, Gauge32, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, iso, TimeTicks, MibIdentifier, Counter32, ModuleIdentity, Unsigned32, enterprises, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "iso", "TimeTicks", "MibIdentifier", "Counter32", "ModuleIdentity", "Unsigned32", "enterprises", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", localIp=localIp, ethTXGiants=ethTXGiants, modemRowStatus=modemRowStatus, ethRXPauseFrames=ethRXPauseFrames, ethTXControlFrames=ethTXControlFrames, modemE1T1Channels=modemE1T1Channels, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemBandwith=modemBandwith, ethRXDones=ethRXDones, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, sysDateAndTime=sysDateAndTime, modemCountTime=modemCountTime, ethRXCodeErrors=ethRXCodeErrors, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, licenseMask=licenseMask, localIpMask=localIpMask, modemACMengine=modemACMengine, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, vlanPortmap=vlanPortmap, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, vlansEnabled=vlansEnabled, ipRadioStat=ipRadioStat, vlanNumber=vlanNumber, modemStandard=modemStandard, e1t1AIS=e1t1AIS, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, writeConfig=writeConfig, radioTable=radioTable, ipRadio=ipRadio, ethRXControlFrames=ethRXControlFrames, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, microwaveRadio=microwaveRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemUptime=modemUptime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, saf=saf, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, modemStatistics=modemStatistics, remoteIp=remoteIp, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemGeneralStatus=modemGeneralStatus, ipRadioStatEth=ipRadioStatEth, ethQOSTXDropped=ethQOSTXDropped, radioIndex=radioIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcIndex=atpcIndex, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, pointToPoint=pointToPoint, ethQOSTXFrames=ethQOSTXFrames, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, product=product, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemTotalBlockNumber=modemTotalBlockNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, license=license, radioDuplexShift=radioDuplexShift, ipRadioMgmt=ipRadioMgmt, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, e1t1StatTable=e1t1StatTable, description=description, modemErroredSecond=modemErroredSecond, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortType=vlanPortType, hostname=hostname, ethTXDones=ethTXDones, vlanEntry=vlanEntry, tehnika=tehnika, radioTxMute=radioTxMute, radioLoopback=radioLoopback, modemErroredBlock=modemErroredBlock, ethRXMulticasts=ethRXMulticasts, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemModulation=modemModulation, ethRXBroadcasts=ethRXBroadcasts, vlanTable=vlanTable, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, ethTXByteCounterHi=ethTXByteCounterHi, modemTable=modemTable, ethTXPauseFrames=ethTXPauseFrames, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, ethRXCRCErrors=ethRXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, loopbacks=loopbacks, e1t1ChannelNr=e1t1ChannelNr, ethTXExcessiveDefers=ethTXExcessiveDefers, aTPCTable=aTPCTable, e1t1StatEntry=e1t1StatEntry, modemEthernetCapacity=modemEthernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, ipRadioCfg=ipRadioCfg, vlanRowStatus=vlanRowStatus, modemEntry=modemEntry, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio)
