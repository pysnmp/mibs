...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:07:28 2021
...
Counter32, TimeTicks, iso, ObjectIdentity, NotificationType, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Unsigned32, Gauge32, Integer32, ModuleIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "iso", "ObjectIdentity", "NotificationType", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Unsigned32", "Gauge32", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, vlanTable=vlanTable, writeConfig=writeConfig, vlanPortmap=vlanPortmap, restartcpu=restartcpu, pointToPoint=pointToPoint, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCollisions=ethTXCollisions, modemModulation=modemModulation, ipRadioCfgNetwork=ipRadioCfgNetwork, radioIndex=radioIndex, modemTotalBlockNumber=modemTotalBlockNumber, licenseMask=licenseMask, ethRXTruncatedFrames=ethRXTruncatedFrames, modemUnavailtime=modemUnavailtime, vlanEntry=vlanEntry, ipRadioCfg=ipRadioCfg, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXGiants=ethTXGiants, microwaveRadio=microwaveRadio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxFrequency=radioTxFrequency, ethQOSTXDropped=ethQOSTXDropped, modemCountTime=modemCountTime, modemStandard=modemStandard, modemStatistics=modemStatistics, product=product, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, modemErroredBlock=modemErroredBlock, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDvEvent=ethRXDvEvent, ethGFPDropedFrames=ethGFPDropedFrames, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, remoteIp=remoteIp, localIp=localIp, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioLoopback=radioLoopback, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, e1t1AIS=e1t1AIS, modemEntry=modemEntry, ethTXLateCollisions=ethTXLateCollisions, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, radioEntry=radioEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, license=license, safip=safip, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, sysTemperature=sysTemperature, ethTXDones=ethTXDones, ethTXMulticasts=ethTXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, radioGenStatus=radioGenStatus, modemErroredSecond=modemErroredSecond, e1t1LOS=e1t1LOS, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMin=modemACMmodulationMin, localIpMask=localIpMask, ipRadioMgmt=ipRadioMgmt, vlansEnabled=vlansEnabled, ethGFPCHECErrors=ethGFPCHECErrors, licenseUpdateStatus=licenseUpdateStatus, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRowStatus=modemRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXUnderruns=ethTXUnderruns, radioTable=radioTable, atpcIndex=atpcIndex, vlanCfgStat=vlanCfgStat, ethRXDones=ethRXDones, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, modemBandwith=modemBandwith, ethRXPauseFrames=ethRXPauseFrames, vlanNumber=vlanNumber, modemCarrierOffset=modemCarrierOffset, radioTxMute=radioTxMute, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, description=description, tehnika=tehnika, ethTXMaxCollisions=ethTXMaxCollisions, ipRadio=ipRadio, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemTable=modemTable, ethTXControlFrames=ethTXControlFrames, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, ethRXMulticasts=ethRXMulticasts, modemIndex=modemIndex, aTPCEntry=aTPCEntry, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUptime=modemUptime)
