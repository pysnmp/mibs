...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:56:52 2024
...
NotificationType, Unsigned32, enterprises, MibIdentifier, Integer32, ObjectIdentity, Bits, TimeTicks, Counter32, Counter64, ModuleIdentity, IpAddress, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "enterprises", "MibIdentifier", "Integer32", "ObjectIdentity", "Bits", "TimeTicks", "Counter32", "Counter64", "ModuleIdentity", "IpAddress", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterLow=ethRXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioLoopback=radioLoopback, ethTXUnderruns=ethTXUnderruns, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemModulation=modemModulation, licenseMask=licenseMask, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, ethTXExcessiveDefers=ethTXExcessiveDefers, loopbacks=loopbacks, ethTXVlanTags=ethTXVlanTags, sysTemperature=sysTemperature, ethTXBroadcasts=ethTXBroadcasts, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, modemBandwith=modemBandwith, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, radioSide=radioSide, license=license, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, modemInternalAGCgain=modemInternalAGCgain, remoteIp=remoteIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1Channels=modemE1T1Channels, modemEthernetCapacity=modemEthernetCapacity, ethTXMulticasts=ethTXMulticasts, tehnika=tehnika, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, radioTxPower=radioTxPower, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, vlanPortmap=vlanPortmap, vlanFid=vlanFid, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, modemRowStatus=modemRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, ethRXCRCErrors=ethRXCRCErrors, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, sysDateAndTime=sysDateAndTime, localIp=localIp, ethRXMulticasts=ethRXMulticasts, ipRadioCfg=ipRadioCfg, radioRxFrequency=radioRxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, safip=safip, atpcEnabled=atpcEnabled, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, hostname=hostname, e1t1LOS=e1t1LOS, radioTable=radioTable, ethRXLongEvents=ethRXLongEvents, description=description, e1t1ChannelNr=e1t1ChannelNr, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, radioIndex=radioIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, restartcpu=restartcpu, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, modemGeneralStatus=modemGeneralStatus, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethRXByteCounterHi=ethRXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, modemStandard=modemStandard, modemEntry=modemEntry, vlanTable=vlanTable, modemRadialMSE=modemRadialMSE, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, saf=saf, modemUnavailtime=modemUnavailtime, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, product=product, modemErroredSecondRatio=modemErroredSecondRatio, ipRadio=ipRadio, e1t1AIS=e1t1AIS)
