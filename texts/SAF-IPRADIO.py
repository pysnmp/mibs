...
# Produced by pysmi-1.1.8 at Thu Sep 29 09:00:28 2022
...
enterprises, Gauge32, Integer32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, IpAddress, iso, ModuleIdentity, ObjectIdentity, NotificationType, NotificationType, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Integer32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "IpAddress", "iso", "ModuleIdentity", "ObjectIdentity", "NotificationType", "NotificationType", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxLevel=radioRxLevel, vlanEntry=vlanEntry, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcIndex=atpcIndex, modemEntry=modemEntry, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, ethTXCRCErrors=ethTXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, saf=saf, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXUnderruns=ethTXUnderruns, product=product, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemStandard=modemStandard, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, radioSide=radioSide, ethRXMulticasts=ethRXMulticasts, ethRXCRCErrors=ethRXCRCErrors, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXLongEvents=ethRXLongEvents, modemEthernetCapacity=modemEthernetCapacity, ethRXDvEvent=ethRXDvEvent, license=license, modemTotalCapacity=modemTotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCodeErrors=ethRXCodeErrors, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, modemTable=modemTable, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBroadcasts=ethTXBroadcasts, radioEntry=radioEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPrevPktDropped=ethRXPrevPktDropped, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, e1t1StatTable=e1t1StatTable, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemCountTime=modemCountTime, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, ipRadio=ipRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, modemAcqStatus=modemAcqStatus, radioLoopback=radioLoopback, ethQOSTXFrames=ethQOSTXFrames, ipRadioMgmt=ipRadioMgmt, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, safip=safip, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, restartcpu=restartcpu, modemLDPCdecoderStress=modemLDPCdecoderStress, description=description, e1t1LOS=e1t1LOS, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortType=vlanPortType, licenseUpdateStatus=licenseUpdateStatus, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, modemACMmodulationMin=modemACMmodulationMin, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterLow=ethRXByteCounterLow, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, vlanFid=vlanFid, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, radioGenStatus=radioGenStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxPower=radioTxPower, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, hostname=hostname, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, e1t1AIS=e1t1AIS, atpcTxPowerCorrection=atpcTxPowerCorrection, tehnika=tehnika, microwaveRadio=microwaveRadio, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, ethQOSTXDropped=ethQOSTXDropped, ethTXDones=ethTXDones, ethRXPauseFrames=ethRXPauseFrames, licenseMask=licenseMask, sysTemperature=sysTemperature, aTPCTable=aTPCTable, modemIndex=modemIndex, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber)
