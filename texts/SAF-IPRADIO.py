...
# Produced by pysmi-1.1.12 at Tue Jun  4 09:35:23 2024
...
Gauge32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, enterprises, Integer32, MibIdentifier, Counter64, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "enterprises", "Integer32", "MibIdentifier", "Counter64", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanPortType=vlanPortType, ethTXWireByteCounterHi=ethTXWireByteCounterHi, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, modemStandard=modemStandard, localIp=localIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMengine=modemACMengine, ethRXDribleNibbles=ethRXDribleNibbles, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseUpdateStatus=licenseUpdateStatus, ethRXCRCErrors=ethRXCRCErrors, radioTable=radioTable, licenseMask=licenseMask, vlanPortmap=vlanPortmap, atpcIndex=atpcIndex, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPFCSErrors=ethGFPFCSErrors, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, radioIndex=radioIndex, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, ethTXGiants=ethTXGiants, ethRXControlFrames=ethRXControlFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalCapacity=modemTotalCapacity, radioEntry=radioEntry, ethRXPauseFrames=ethRXPauseFrames, radioRxLevel=radioRxLevel, e1t1AIS=e1t1AIS, radioTxPower=radioTxPower, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxMute=radioTxMute, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfg=ipRadioCfg, vlanNumber=vlanNumber, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanTable=vlanTable, radioLoopback=radioLoopback, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCEntry=aTPCEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecond=modemErroredSecond, modemACMmodulationMax=modemACMmodulationMax, saf=saf, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXTruncatedFrames=ethRXTruncatedFrames, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, description=description, radioSide=radioSide, modemAcqStatus=modemAcqStatus, ethTXMaxCollisions=ethTXMaxCollisions, modemUptime=modemUptime, ipRadio=ipRadio, loopbacks=loopbacks, ethRXDones=ethRXDones, modemCountTime=modemCountTime, ethRXDvEvent=ethRXDvEvent, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, modemTotalBlockNumber=modemTotalBlockNumber, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMulticasts=ethTXMulticasts, modemBandwith=modemBandwith, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanRowStatus=vlanRowStatus, localIpMask=localIpMask, atpcEnabled=atpcEnabled, modemErroredSecondRatio=modemErroredSecondRatio, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, e1t1LOS=e1t1LOS, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, modemUnavailtime=modemUnavailtime, e1t1StatTable=e1t1StatTable, ethTXBroadcasts=ethTXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, ethTXUnderruns=ethTXUnderruns, ipRadioMgmt=ipRadioMgmt, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, modemACMtotalCapacity=modemACMtotalCapacity, product=product, ethQOSTXFrames=ethQOSTXFrames, ipRadioStatEth=ipRadioStatEth, e1t1StatEntry=e1t1StatEntry, modemIndex=modemIndex, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat)
