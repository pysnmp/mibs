...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:01:50 2022
...
ObjectIdentity, TimeTicks, iso, NotificationType, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, enterprises, Gauge32, Counter64, Unsigned32, Bits, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "iso", "NotificationType", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "enterprises", "Gauge32", "Counter64", "Unsigned32", "Bits", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXMulticasts=ethRXMulticasts, atpcEnabled=atpcEnabled, vlanPortType=vlanPortType, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXLongEvents=ethRXLongEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemUnavailtime=modemUnavailtime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRowStatus=modemRowStatus, license=license, modemStandard=modemStandard, ethRXByteCounterHi=ethRXByteCounterHi, radioTxPower=radioTxPower, ethTXUnderruns=ethTXUnderruns, pointToPoint=pointToPoint, radioGenStatus=radioGenStatus, modemE1T1Channels=modemE1T1Channels, saf=saf, ethTXControlFrames=ethTXControlFrames, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTable=modemTable, ethTXCRCErrors=ethTXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, ethTXVlanTags=ethTXVlanTags, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatTable=e1t1StatTable, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, product=product, ethGFPCHECErrors=ethGFPCHECErrors, tehnika=tehnika, modemStatistics=modemStatistics, radioSide=radioSide, modemErroredSecondRatio=modemErroredSecondRatio, restartcpu=restartcpu, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, localIpMask=localIpMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxMute=radioTxMute, modemEntry=modemEntry, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredBlock=modemErroredBlock, ethQOSTXFrames=ethQOSTXFrames, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, modemLastAcqError=modemLastAcqError, vlanNumber=vlanNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, loopbacks=loopbacks, ethRXDones=ethRXDones, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, ethTXCollisions=ethTXCollisions, ethTXBroadcasts=ethTXBroadcasts, ipRadioStatEth=ipRadioStatEth, licenseMask=licenseMask, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, remoteIp=remoteIp, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemIndex=modemIndex, aTPCTable=aTPCTable, radioRxLevel=radioRxLevel, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecond=modemErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, vlanTable=vlanTable, localIp=localIp, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, ipRadioStat=ipRadioStat, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, radioLoopback=radioLoopback, description=description, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, modemCountTime=modemCountTime, modemRadialMSE=modemRadialMSE, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXGiants=ethTXGiants, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxFrequency=radioRxFrequency, radioTxFrequency=radioTxFrequency, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, safip=safip, modemUptime=modemUptime, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, modemAcqStatus=modemAcqStatus, ethRXDvEvent=ethRXDvEvent, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTable=radioTable, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames)
