...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:10:08 2023
...
IpAddress, ObjectIdentity, Integer32, Bits, Gauge32, TimeTicks, Counter64, enterprises, iso, ModuleIdentity, Counter32, MibIdentifier, NotificationType, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Integer32", "Bits", "Gauge32", "TimeTicks", "Counter64", "enterprises", "iso", "ModuleIdentity", "Counter32", "MibIdentifier", "NotificationType", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDribleNibbles=ethRXDribleNibbles, modemLDPCdecoderStress=modemLDPCdecoderStress, radioLoopback=radioLoopback, modemErroredSecondRatio=modemErroredSecondRatio, radioEntry=radioEntry, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime, ethTXMaxCollisions=ethTXMaxCollisions, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, vlanNumber=vlanNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioIndex=radioIndex, ethTXByteCounterHi=ethTXByteCounterHi, license=license, ethTXGiants=ethTXGiants, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStandard=modemStandard, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBandwith=modemBandwith, ethTXLateCollisions=ethTXLateCollisions, modemSymbolRateTx=modemSymbolRateTx, ipRadioMgmt=ipRadioMgmt, modemErroredSecond=modemErroredSecond, e1t1ChannelNr=e1t1ChannelNr, ethTXBroadcasts=ethTXBroadcasts, radioRxLevel=radioRxLevel, modemIndex=modemIndex, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, radioTxMute=radioTxMute, modemTable=modemTable, aTPCTable=aTPCTable, ethRXDvEvent=ethRXDvEvent, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLastAcqError=modemLastAcqError, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEntry=modemEntry, product=product, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, ipRadio=ipRadio, localIp=localIp, modemCarrierOffset=modemCarrierOffset, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, ipRadioStat=ipRadioStat, ethRXControlFrames=ethRXControlFrames, radioGenStatus=radioGenStatus, ethRXMulticasts=ethRXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, ethTXControlFrames=ethTXControlFrames, restartcpu=restartcpu, hostname=hostname, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLongEvents=ethRXLongEvents, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, e1t1StatEntry=e1t1StatEntry, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, microwaveRadio=microwaveRadio, modemTotalBlockNumber=modemTotalBlockNumber, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, radioSide=radioSide, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, safip=safip, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfg=ipRadioCfg, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, e1t1StatTable=e1t1StatTable, vlanPortmap=vlanPortmap, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, saf=saf, vlanFid=vlanFid, sysTemperature=sysTemperature, ethTXPauseFrames=ethTXPauseFrames, pointToPoint=pointToPoint, ethTXUnderruns=ethTXUnderruns, modemUptime=modemUptime, description=description, vlansEnabled=vlansEnabled, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUnavailtime=modemUnavailtime, modemACMengine=modemACMengine, modemRadialMSE=modemRadialMSE, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, ethTXByteCounterLow=ethTXByteCounterLow)
