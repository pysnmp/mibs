...
ModuleIdentity, enterprises, TimeTicks, MibIdentifier, NotificationType, Counter32, Counter64, ObjectIdentity, Bits, Integer32, Unsigned32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "ObjectIdentity", "Bits", "Integer32", "Unsigned32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatEntry=e1t1StatEntry, radioIndex=radioIndex, e1t1LOS=e1t1LOS, modemStandard=modemStandard, ethTXMaxCollisions=ethTXMaxCollisions, product=product, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, modemModulation=modemModulation, vlanEntry=vlanEntry, modemACMengine=modemACMengine, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, vlanPortType=vlanPortType, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, radioTxMute=radioTxMute, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlansEnabled=vlansEnabled, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemIndex=modemIndex, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateTx=modemSymbolRateTx, loopback_tributary_mask=loopback_tributary_mask, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUptime=modemUptime, safip=safip, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, ethQOSRXQ1Frames=ethQOSRXQ1Frames, hostname=hostname, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, modemAcqStatus=modemAcqStatus, radioTable=radioTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStatEth=ipRadioStatEth, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCRCErrors=ethTXCRCErrors, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, writeConfig=writeConfig, radioGenStatus=radioGenStatus, e1t1AIS=e1t1AIS, ethRXBroadcasts=ethRXBroadcasts, ethTXDones=ethTXDones, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, atpcEnabled=atpcEnabled, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, licenseMask=licenseMask, atpcIndex=atpcIndex, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethTXVlanTags=ethTXVlanTags, radioDuplexShift=radioDuplexShift, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, pointToPoint=pointToPoint, vlanFid=vlanFid, ethRXUnsupOpcodes=ethRXUnsupOpcodes, remoteIp=remoteIp, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, radioEntry=radioEntry, e1t1ChannelNr=e1t1ChannelNr, license=license, modemSymbolRateRx=modemSymbolRateRx, ethTXCollisions=ethTXCollisions, localIp=localIp, ethGFPDropedFrames=ethGFPDropedFrames, description=description, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMtotalCapacity=modemACMtotalCapacity, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, loopbacks=loopbacks, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, ethRXCodeErrors=ethRXCodeErrors, saf=saf, modemErroredSecond=modemErroredSecond, tehnika=tehnika, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, vlanNumber=vlanNumber, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, restartcpu=restartcpu, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatTable=e1t1StatTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBackpresEvents=ethTXBackpresEvents, modemBandwith=modemBandwith, vlanCfgStat=vlanCfgStat, ethTXControlFrames=ethTXControlFrames, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStat=ipRadioStat, sysTemperature=sysTemperature, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi)
