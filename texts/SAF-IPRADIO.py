...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:19:08 2021
...
Counter64, Bits, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Integer32, ModuleIdentity, NotificationType, MibIdentifier, ObjectIdentity, Counter32, Unsigned32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Integer32", "ModuleIdentity", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32", "Unsigned32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, modemModulation=modemModulation, pointToPoint=pointToPoint, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, e1t1LOS=e1t1LOS, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLateCollisions=ethTXLateCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanCfgStat=vlanCfgStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, description=description, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecond=modemErroredSecond, radioRxLevel=radioRxLevel, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, radioLoopback=radioLoopback, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, modemBandwith=modemBandwith, radioRxFrequency=radioRxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, localIpMask=localIpMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCountTime=modemCountTime, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanFid=vlanFid, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopbacks=loopbacks, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, ethRXCodeErrors=ethRXCodeErrors, ethRXBroadcasts=ethRXBroadcasts, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, ethRXLongEvents=ethRXLongEvents, modemRowStatus=modemRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterHi=ethTXByteCounterHi, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, safip=safip, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateTx=modemSymbolRateTx, modemACMtotalCapacity=modemACMtotalCapacity, microwaveRadio=microwaveRadio, modemLastAcqError=modemLastAcqError, radioTable=radioTable, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, vlanNumber=vlanNumber, saf=saf, atpcIndex=atpcIndex, ethTXUnderruns=ethTXUnderruns, aTPCTable=aTPCTable, ipRadioCfg=ipRadioCfg, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDones=ethRXDones, ipRadioMgmt=ipRadioMgmt, modemTotalCapacity=modemTotalCapacity, licenseMask=licenseMask, radioTxFrequency=radioTxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredBlock=modemErroredBlock, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1ChannelNr=e1t1ChannelNr, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, writeConfig=writeConfig, remoteIp=remoteIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, vlanTable=vlanTable, ipRadioStat=ipRadioStat, product=product, modemStatistics=modemStatistics, ethGFPCHECErrors=ethGFPCHECErrors, ethRXMulticasts=ethRXMulticasts, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, atpcEnabled=atpcEnabled, radioEntry=radioEntry, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, modemCarrierOffset=modemCarrierOffset, radioTxMute=radioTxMute, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, radioIndex=radioIndex, ipRadioStatEth=ipRadioStatEth, licenseUpdateStatus=licenseUpdateStatus, modemACMengine=modemACMengine, ipRadio=ipRadio, ethRXByteCounterLow=ethRXByteCounterLow, localIp=localIp, modemUnavailtime=modemUnavailtime, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioSide=radioSide, sysDateAndTime=sysDateAndTime, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu)
