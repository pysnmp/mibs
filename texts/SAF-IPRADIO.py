...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:15:41 2022
...
MibIdentifier, ModuleIdentity, NotificationType, iso, Bits, NotificationType, TimeTicks, Unsigned32, Counter64, ObjectIdentity, Counter32, enterprises, Gauge32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "iso", "Bits", "NotificationType", "TimeTicks", "Unsigned32", "Counter64", "ObjectIdentity", "Counter32", "enterprises", "Gauge32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", writeConfig=writeConfig, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, ethRXBroadcasts=ethRXBroadcasts, tehnika=tehnika, modemErroredSecond=modemErroredSecond, ethTXGiants=ethTXGiants, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, ethRXPauseFrames=ethRXPauseFrames, e1t1LOS=e1t1LOS, radioDuplexShift=radioDuplexShift, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, hostname=hostname, saf=saf, radioTxFrequency=radioTxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, modemModulation=modemModulation, modemACMmodulationMax=modemACMmodulationMax, modemGeneralStatus=modemGeneralStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseUpdateStatus=licenseUpdateStatus, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, safip=safip, radioRxLevel=radioRxLevel, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, radioEntry=radioEntry, ipRadioCfg=ipRadioCfg, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, modemRadialMSE=modemRadialMSE, e1t1StatEntry=e1t1StatEntry, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, localIp=localIp, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalBlockNumber=modemTotalBlockNumber, aTPCTable=aTPCTable, radioTable=radioTable, ethTXCollisions=ethTXCollisions, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMethernetCapacity=modemACMethernetCapacity, licenseMask=licenseMask, vlanPortmap=vlanPortmap, modemEntry=modemEntry, ethTXBackpresEvents=ethTXBackpresEvents, modemBandwith=modemBandwith, ethRXControlFrames=ethRXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanRowStatus=vlanRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, vlanTable=vlanTable, ethTXExcessiveDefers=ethTXExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStandard=modemStandard, ethRXLongEvents=ethRXLongEvents, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, modemUptime=modemUptime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, ethTXByteCounterHi=ethTXByteCounterHi, radioLoopback=radioLoopback, ipRadio=ipRadio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXCodeErrors=ethRXCodeErrors, pointToPoint=pointToPoint, ethGFPCHECErrors=ethGFPCHECErrors, modemACMengine=modemACMengine, modemErroredBlock=modemErroredBlock, ipRadioMgmt=ipRadioMgmt, ethQOSTXDropped=ethQOSTXDropped, restartcpu=restartcpu, modemIndex=modemIndex, atpcIndex=atpcIndex, description=description, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, license=license, ethRXDvEvent=ethRXDvEvent, modemRowStatus=modemRowStatus, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, ethTXVlanTags=ethTXVlanTags, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, product=product, vlansEnabled=vlansEnabled)
