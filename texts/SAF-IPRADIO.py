...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:30:19 2022
...
Unsigned32, IpAddress, Gauge32, Integer32, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, enterprises, Bits, Counter64, Counter32, ModuleIdentity, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Gauge32", "Integer32", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "enterprises", "Bits", "Counter64", "Counter32", "ModuleIdentity", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", loopbacks=loopbacks, writeConfig=writeConfig, ethRXLongEvents=ethRXLongEvents, radioDuplexShift=radioDuplexShift, localIp=localIp, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, modemCarrierOffset=modemCarrierOffset, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, modemACMmodulationMax=modemACMmodulationMax, tehnika=tehnika, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, ipRadioStatEth=ipRadioStatEth, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, modemStatistics=modemStatistics, radioEntry=radioEntry, vlanCfgStat=vlanCfgStat, e1t1StatEntry=e1t1StatEntry, ipRadioStat=ipRadioStat, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, ethRXBroadcasts=ethRXBroadcasts, modemBandwith=modemBandwith, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, aTPCTable=aTPCTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemLastAcqError=modemLastAcqError, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, sysDateAndTime=sysDateAndTime, remoteIp=remoteIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, saf=saf, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, ethQOSTXFrames=ethQOSTXFrames, ethRXMulticasts=ethRXMulticasts, modemIndex=modemIndex, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCEntry=aTPCEntry, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredBlock=modemErroredBlock, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, ethTXPauseFrames=ethTXPauseFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxLevel=radioRxLevel, vlanNumber=vlanNumber, license=license, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, licenseMask=licenseMask, modemModulation=modemModulation, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, microwaveRadio=microwaveRadio, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, safip=safip, radioTable=radioTable, licenseUpdateStatus=licenseUpdateStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXVlanTags=ethTXVlanTags, modemEthernetCapacity=modemEthernetCapacity, vlanFid=vlanFid, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, modemStandard=modemStandard, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBroadcasts=ethTXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, ethTXDones=ethTXDones, ethRXDones=ethRXDones, modemTable=modemTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemEntry=modemEntry, vlansEnabled=vlansEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMethernetCapacity=modemACMethernetCapacity, radioIndex=radioIndex, description=description, vlanTable=vlanTable, product=product, modemAcqStatus=modemAcqStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1AIS=e1t1AIS, restartcpu=restartcpu, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, radioTxMute=radioTxMute, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, radioSide=radioSide, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxFrequency=radioTxFrequency, radioGenStatus=radioGenStatus, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower)
