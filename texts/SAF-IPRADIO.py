...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:24:51 2022
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, TimeTicks, Unsigned32, ObjectIdentity, iso, ModuleIdentity, NotificationType, Gauge32, Counter32, NotificationType, MibIdentifier, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "NotificationType", "MibIdentifier", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, ethTXCollisions=ethTXCollisions, ethTXDones=ethTXDones, ipRadioCfg=ipRadioCfg, description=description, ipRadio=ipRadio, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCarrierOffset=modemCarrierOffset, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, microwaveRadio=microwaveRadio, ipRadioStatEth=ipRadioStatEth, radioTable=radioTable, modemUptime=modemUptime, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, ipRadioStat=ipRadioStat, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, radioGenStatus=radioGenStatus, modemTotalCapacity=modemTotalCapacity, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, license=license, modemEthernetCapacity=modemEthernetCapacity, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, modemStatistics=modemStatistics, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, sysTemperature=sysTemperature, vlanEntry=vlanEntry, modemModulation=modemModulation, vlanPortType=vlanPortType, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseUpdateStatus=licenseUpdateStatus, atpcEnabled=atpcEnabled, e1t1AIS=e1t1AIS, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, localIp=localIp, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBackpresEvents=ethTXBackpresEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, radioDuplexShift=radioDuplexShift, sysDateAndTime=sysDateAndTime, localIpMask=localIpMask, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, modemEntry=modemEntry, loopbacks=loopbacks, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, safip=safip, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, e1t1StatEntry=e1t1StatEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, radioEntry=radioEntry, pointToPoint=pointToPoint, vlanNumber=vlanNumber, hostname=hostname, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, modemAcqStatus=modemAcqStatus, ethRXLongEvents=ethRXLongEvents, product=product, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMengine=modemACMengine, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDropedFrames=ethGFPDropedFrames, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, ethTXControlFrames=ethTXControlFrames, modemE1T1Channels=modemE1T1Channels, ethRXPauseFrames=ethRXPauseFrames, modemBandwith=modemBandwith, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, vlanCfgStat=vlanCfgStat, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDvEvent=ethRXDvEvent, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, radioIndex=radioIndex, e1t1LOS=e1t1LOS, radioTxPower=radioTxPower, modemCountTime=modemCountTime, ethTXCRCErrors=ethTXCRCErrors, modemLastAcqError=modemLastAcqError, ethGFPFCSErrors=ethGFPFCSErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, licenseMask=licenseMask, ethGFPCHECErrors=ethGFPCHECErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers)
