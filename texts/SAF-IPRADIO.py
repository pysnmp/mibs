...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:32:39 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, MibIdentifier, Counter32, Gauge32, ModuleIdentity, Counter64, Unsigned32, IpAddress, Integer32, ObjectIdentity, iso, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "MibIdentifier", "Counter32", "Gauge32", "ModuleIdentity", "Counter64", "Unsigned32", "IpAddress", "Integer32", "ObjectIdentity", "iso", "enterprises", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfg=ipRadioCfg, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, radioTable=radioTable, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, tehnika=tehnika, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, pointToPoint=pointToPoint, sysTemperature=sysTemperature, ipRadioStat=ipRadioStat, writeConfig=writeConfig, atpcIndex=atpcIndex, ethRXDvEvent=ethRXDvEvent, vlanNumber=vlanNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioIndex=radioIndex, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, e1t1AIS=e1t1AIS, modemErroredSecondRatio=modemErroredSecondRatio, modemBandwith=modemBandwith, e1t1LOS=e1t1LOS, ethTXByteCounterLow=ethTXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, radioTxMute=radioTxMute, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatEntry=e1t1StatEntry, modemLastAcqError=modemLastAcqError, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanEntry=vlanEntry, radioTxPower=radioTxPower, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, modemE1T1Channels=modemE1T1Channels, ethTXMulticasts=ethTXMulticasts, modemRowStatus=modemRowStatus, ethTXDones=ethTXDones, modemEntry=modemEntry, modemModulation=modemModulation, radioTxFrequency=radioTxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUptime=modemUptime, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, ethRXByteCounterHi=ethRXByteCounterHi, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, description=description, radioLoopback=radioLoopback, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxFrequency=radioRxFrequency, radioGenStatus=radioGenStatus, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, radioEntry=radioEntry, ipRadio=ipRadio, vlansEnabled=vlansEnabled, sysDateAndTime=sysDateAndTime, loopback_tributary_mask=loopback_tributary_mask, ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStandard=modemStandard, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemEthernetCapacity=modemEthernetCapacity, license=license, ethQOSTXFrames=ethQOSTXFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXUnderruns=ethTXUnderruns, modemTotalCapacity=modemTotalCapacity, product=product, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemIndex=modemIndex, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, modemStatistics=modemStatistics, modemErroredSecond=modemErroredSecond, localIp=localIp, ethRXMulticasts=ethRXMulticasts, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, modemSymbolRateRx=modemSymbolRateRx, safip=safip, e1t1StatTable=e1t1StatTable, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateTx=modemSymbolRateTx, vlanCfgStat=vlanCfgStat, ethRXCRCErrors=ethRXCRCErrors, modemErroredBlock=modemErroredBlock, ethQOSTXDropped=ethQOSTXDropped, loopbacks=loopbacks, modemInternalAGCgain=modemInternalAGCgain, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, modemRadialMSE=modemRadialMSE, ethTXBackpresEvents=ethTXBackpresEvents, saf=saf, e1t1ChannelNr=e1t1ChannelNr, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioSide=radioSide)
