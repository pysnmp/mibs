...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:28:34 2021
...
NotificationType, Gauge32, ObjectIdentity, NotificationType, iso, Unsigned32, Bits, TimeTicks, Counter64, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "NotificationType", "iso", "Unsigned32", "Bits", "TimeTicks", "Counter64", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, tehnika=tehnika, loopbacks=loopbacks, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemLastAcqError=modemLastAcqError, radioEntry=radioEntry, product=product, modemInternalAGCgain=modemInternalAGCgain, radioIndex=radioIndex, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXBroadcasts=ethTXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, loopback_tributary_mask=loopback_tributary_mask, e1t1StatTable=e1t1StatTable, vlanFid=vlanFid, ethTXByteCounterHi=ethTXByteCounterHi, description=description, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioMgmt=ipRadioMgmt, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, modemACMethernetCapacity=modemACMethernetCapacity, ethRXControlFrames=ethRXControlFrames, ethRXPauseFrames=ethRXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, licenseUpdateStatus=licenseUpdateStatus, license=license, e1t1StatEntry=e1t1StatEntry, localIpMask=localIpMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, sysDateAndTime=sysDateAndTime, modemIndex=modemIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, modemTable=modemTable, vlanPortType=vlanPortType, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, vlanPortmap=vlanPortmap, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStat=ipRadioStat, modemBandwith=modemBandwith, ethTXPauseFrames=ethTXPauseFrames, radioTxMute=radioTxMute, e1t1ChannelNr=e1t1ChannelNr, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, modemModulation=modemModulation, modemACMengine=modemACMengine, vlanTable=vlanTable, ethGFPCHECErrors=ethGFPCHECErrors, writeConfig=writeConfig, vlanNumber=vlanNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, atpcEnabled=atpcEnabled, vlansEnabled=vlansEnabled, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, safip=safip, modemUptime=modemUptime, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanRowStatus=vlanRowStatus, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioSide=radioSide, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, remoteIp=remoteIp, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, radioTable=radioTable, ethTXCollisions=ethTXCollisions, modemStandard=modemStandard, radioLoopback=radioLoopback, vlanCfgStat=vlanCfgStat, licenseMask=licenseMask, localIp=localIp, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, modemStatistics=modemStatistics, restartcpu=restartcpu, ethTXMulticasts=ethTXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, modemAcqStatus=modemAcqStatus, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXControlFrames=ethTXControlFrames, ethTXGiants=ethTXGiants)
