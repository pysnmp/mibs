...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:13:48 2021
...
MibIdentifier, iso, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Gauge32, Unsigned32, Counter32, enterprises, NotificationType, ObjectIdentity, TimeTicks, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Gauge32", "Unsigned32", "Counter32", "enterprises", "NotificationType", "ObjectIdentity", "TimeTicks", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMengine=modemACMengine, modemTotalCapacity=modemTotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterHi=ethTXByteCounterHi, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, ipRadioMgmt=ipRadioMgmt, licenseUpdateStatus=licenseUpdateStatus, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, radioRxFrequency=radioRxFrequency, radioTable=radioTable, microwaveRadio=microwaveRadio, modemTable=modemTable, radioDuplexShift=radioDuplexShift, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, radioTxFrequency=radioTxFrequency, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateTx=modemSymbolRateTx, loopback_tributary_mask=loopback_tributary_mask, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, radioTxPower=radioTxPower, pointToPoint=pointToPoint, ethGFPDropedFrames=ethGFPDropedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioEntry=radioEntry, radioRxLevel=radioRxLevel, aTPCTable=aTPCTable, ethRXDones=ethRXDones, ethTXGiants=ethTXGiants, license=license, ethGFPCHECErrors=ethGFPCHECErrors, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, modemLastAcqError=modemLastAcqError, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, ethGFPFCSErrors=ethGFPFCSErrors, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, saf=saf, ethTXCollisions=ethTXCollisions, vlanCfgStat=vlanCfgStat, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanNumber=vlanNumber, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUptime=modemUptime, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMax=modemACMmodulationMax, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, ethTXBackpresEvents=ethTXBackpresEvents, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCRCErrors=ethRXCRCErrors, remoteIp=remoteIp, vlanPortType=vlanPortType, hostname=hostname, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDvEvent=ethRXDvEvent, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, product=product, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, modemSymbolRateRx=modemSymbolRateRx, atpcIndex=atpcIndex, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMethernetCapacity=modemACMethernetCapacity, restartcpu=restartcpu, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, ethQOSTXFrames=ethQOSTXFrames, sysTemperature=sysTemperature, ethTXMaxCollisions=ethTXMaxCollisions, ipRadio=ipRadio, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, loopbacks=loopbacks, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBandwith=modemBandwith, ethTXPauseFrames=ethTXPauseFrames, description=description, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStandard=modemStandard, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, radioSide=radioSide, modemRowStatus=modemRowStatus, modemIndex=modemIndex, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin)
