...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:48:43 2023
...
Integer32, Counter64, MibIdentifier, ObjectIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, enterprises, Counter32, IpAddress, TimeTicks, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "enterprises", "Counter32", "IpAddress", "TimeTicks", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, radioGenStatus=radioGenStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMaxCollisions=ethTXMaxCollisions, radioDuplexShift=radioDuplexShift, radioSide=radioSide, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, restartcpu=restartcpu, ethRXDones=ethRXDones, remoteIp=remoteIp, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanTable=vlanTable, localIp=localIp, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, ethRXByteCounterHi=ethRXByteCounterHi, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopback_tributary_mask=loopback_tributary_mask, tehnika=tehnika, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, ethTXGiants=ethTXGiants, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanEntry=vlanEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, safip=safip, ethTXBroadcasts=ethTXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, ethTXDones=ethTXDones, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, aTPCTable=aTPCTable, description=description, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1AIS=e1t1AIS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRadialMSE=modemRadialMSE, ethRXControlFrames=ethRXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, radioTable=radioTable, modemRowStatus=modemRowStatus, vlanFid=vlanFid, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBackpresEvents=ethTXBackpresEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, licenseMask=licenseMask, radioRxFrequency=radioRxFrequency, vlanRowStatus=vlanRowStatus, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMax=modemACMmodulationMax, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXMulticasts=ethRXMulticasts, loopbacks=loopbacks, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, ethGFPDropedFrames=ethGFPDropedFrames, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, hostname=hostname, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, radioIndex=radioIndex, modemIndex=modemIndex, e1t1StatEntry=e1t1StatEntry, aTPCEntry=aTPCEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXUnderruns=ethTXUnderruns, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, modemModulation=modemModulation, modemTable=modemTable, ethQOSTXDropped=ethQOSTXDropped, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioEntry=radioEntry, ethTXControlFrames=ethTXControlFrames, atpcIndex=atpcIndex, ethTXCRCErrors=ethTXCRCErrors, saf=saf, modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXFrames=ethQOSTXFrames, modemEntry=modemEntry, product=product, license=license, atpcEnabled=atpcEnabled, localIpMask=localIpMask)
