...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:21:51 2021
...
ModuleIdentity, TimeTicks, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, NotificationType, ObjectIdentity, iso, Unsigned32, MibIdentifier, Counter64, IpAddress, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "NotificationType", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "Counter64", "IpAddress", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, ethTXMaxCollisions=ethTXMaxCollisions, e1t1LOS=e1t1LOS, e1t1ChannelNr=e1t1ChannelNr, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, vlanEntry=vlanEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMethernetCapacity=modemACMethernetCapacity, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, modemGeneralStatus=modemGeneralStatus, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, ethTXByteCounterHi=ethTXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, loopbacks=loopbacks, modemCarrierOffset=modemCarrierOffset, modemTotalCapacity=modemTotalCapacity, atpcEnabled=atpcEnabled, vlanCfgStat=vlanCfgStat, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, modemUptime=modemUptime, modemTable=modemTable, modemErroredBlock=modemErroredBlock, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCountTime=modemCountTime, modemBandwith=modemBandwith, ipRadioStat=ipRadioStat, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, licenseUpdateStatus=licenseUpdateStatus, microwaveRadio=microwaveRadio, modemACMengine=modemACMengine, radioSide=radioSide, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTable=radioTable, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, modemStandard=modemStandard, license=license, restartcpu=restartcpu, modemIndex=modemIndex, localIp=localIp, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, radioGenStatus=radioGenStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfg=ipRadioCfg, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, modemE1T1Channels=modemE1T1Channels, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, radioTxMute=radioTxMute, modemStatistics=modemStatistics, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseMask=licenseMask, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, modemEntry=modemEntry, vlansEnabled=vlansEnabled, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXControlFrames=ethRXControlFrames, modemLastAcqError=modemLastAcqError, saf=saf, pointToPoint=pointToPoint, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXGiants=ethTXGiants, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDvEvent=ethRXDvEvent, radioTxPower=radioTxPower, vlanPortType=vlanPortType, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPFCSErrors=ethGFPFCSErrors, e1t1AIS=e1t1AIS, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortmap=vlanPortmap, ethRXLongEvents=ethRXLongEvents, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxFrequency=radioRxFrequency, ipRadioStatEth=ipRadioStatEth, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, radioLoopback=radioLoopback, atpcIndex=atpcIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, description=description, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, radioRxLevel=radioRxLevel, safip=safip, ethTXCRCErrors=ethTXCRCErrors)
