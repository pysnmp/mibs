...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:00:15 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Integer32, NotificationType, ObjectIdentity, MibIdentifier, ModuleIdentity, enterprises, Unsigned32, Gauge32, TimeTicks, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "enterprises", "Unsigned32", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanRowStatus=vlanRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemModulation=modemModulation, radioRxLevel=radioRxLevel, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, modemStandard=modemStandard, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, tehnika=tehnika, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, remoteIp=remoteIp, radioIndex=radioIndex, ethTXGiants=ethTXGiants, ethTXByteCounterHi=ethTXByteCounterHi, modemACMengine=modemACMengine, atpcIndex=atpcIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxFrequency=radioRxFrequency, modemCarrierOffset=modemCarrierOffset, modemGeneralStatus=modemGeneralStatus, safip=safip, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, radioLoopback=radioLoopback, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCEntry=aTPCEntry, modemUptime=modemUptime, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioMgmt=ipRadioMgmt, radioGenStatus=radioGenStatus, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, vlanCfgStat=vlanCfgStat, localIp=localIp, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMin=modemACMmodulationMin, ethRXCRCErrors=ethRXCRCErrors, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, modemRowStatus=modemRowStatus, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, restartcpu=restartcpu, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, modemIndex=modemIndex, hostname=hostname, modemAcqStatus=modemAcqStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, ethTXMulticasts=ethTXMulticasts, ethRXCodeErrors=ethRXCodeErrors, localIpMask=localIpMask, ethTXVlanTags=ethTXVlanTags, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, description=description, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, radioTxFrequency=radioTxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, ethRXByteCounterHi=ethRXByteCounterHi, sysTemperature=sysTemperature, vlanTable=vlanTable, e1t1StatEntry=e1t1StatEntry, ethTXUnderruns=ethTXUnderruns, modemTable=modemTable, license=license, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, saf=saf, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBandwith=modemBandwith, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterLow=ethRXByteCounterLow, vlanFid=vlanFid, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanNumber=vlanNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxPower=radioTxPower, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, radioTxMute=radioTxMute, licenseMask=licenseMask, ethRXControlFrames=ethRXControlFrames, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTotalCapacity=modemTotalCapacity, radioEntry=radioEntry, ethRXDones=ethRXDones, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, radioSide=radioSide, modemStatistics=modemStatistics, product=product, modemEntry=modemEntry)
