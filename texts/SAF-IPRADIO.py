...
# Produced by pysmi-1.1.12 at Mon Sep 16 15:00:36 2024
...
Gauge32, Integer32, NotificationType, NotificationType, TimeTicks, enterprises, Unsigned32, Counter64, IpAddress, MibIdentifier, Counter32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "NotificationType", "NotificationType", "TimeTicks", "enterprises", "Unsigned32", "Counter64", "IpAddress", "MibIdentifier", "Counter32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, radioTxMute=radioTxMute, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, e1t1LOS=e1t1LOS, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanTable=vlanTable, ethRXDones=ethRXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, licenseUpdateStatus=licenseUpdateStatus, radioRxFrequency=radioRxFrequency, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, localIp=localIp, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, product=product, modemAcqStatus=modemAcqStatus, modemModulation=modemModulation, modemErroredSecondRatio=modemErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, restartcpu=restartcpu, ethRXLongEvents=ethRXLongEvents, sysDateAndTime=sysDateAndTime, aTPCTable=aTPCTable, modemStatistics=modemStatistics, modemACMengine=modemACMengine, modemSymbolRateTx=modemSymbolRateTx, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, radioIndex=radioIndex, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, modemACMethernetCapacity=modemACMethernetCapacity, remoteIp=remoteIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioMgmt=ipRadioMgmt, radioLoopback=radioLoopback, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ethRXBroadcasts=ethRXBroadcasts, license=license, ethRXDribleNibbles=ethRXDribleNibbles, modemEntry=modemEntry, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXByteCounterHi=ethTXByteCounterHi, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxPower=radioTxPower, radioEntry=radioEntry, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortmap=vlanPortmap, ethRXByteCounterHi=ethRXByteCounterHi, loopbacks=loopbacks, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, vlanPortType=vlanPortType, vlanEntry=vlanEntry, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, modemTable=modemTable, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStatEth=ipRadioStatEth, modemRadialMSE=modemRadialMSE, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMin=modemACMmodulationMin, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, ethTXVlanTags=ethTXVlanTags, modemBandwith=modemBandwith, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioDuplexShift=radioDuplexShift, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCRCErrors=ethRXCRCErrors, localIpMask=localIpMask, modemCarrierOffset=modemCarrierOffset, modemErroredSecond=modemErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanRowStatus=vlanRowStatus, radioSide=radioSide, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, saf=saf, atpcIndex=atpcIndex, e1t1StatEntry=e1t1StatEntry, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStat=ipRadioStat, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, radioTable=radioTable, e1t1StatTable=e1t1StatTable, modemACMtotalCapacity=modemACMtotalCapacity, description=description, writeConfig=writeConfig)
