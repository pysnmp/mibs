...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:28:39 2022
...
NotificationType, iso, Integer32, ObjectIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Integer32", "ObjectIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMulticasts=ethTXMulticasts, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecond=modemErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, ethTXLateCollisions=ethTXLateCollisions, vlanPortType=vlanPortType, ethTXCollisions=ethTXCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, ethTXBroadcasts=ethTXBroadcasts, modemTotalCapacity=modemTotalCapacity, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, remoteIp=remoteIp, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1ChannelNr=e1t1ChannelNr, radioTxPower=radioTxPower, modemUptime=modemUptime, ethRXPauseFrames=ethRXPauseFrames, localIp=localIp, e1t1AIS=e1t1AIS, modemACMengine=modemACMengine, licenseMask=licenseMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, ethGFPDropedFrames=ethGFPDropedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterHi=ethRXByteCounterHi, radioTxMute=radioTxMute, writeConfig=writeConfig, saf=saf, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, restartcpu=restartcpu, vlansEnabled=vlansEnabled, radioEntry=radioEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanRowStatus=vlanRowStatus, ipRadioCfg=ipRadioCfg, ethTXBackpresEvents=ethTXBackpresEvents, radioRxFrequency=radioRxFrequency, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMmodulationMax=modemACMmodulationMax, modemEntry=modemEntry, vlanFid=vlanFid, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStatEth=ipRadioStatEth, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, loopback_tributary_mask=loopback_tributary_mask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, ipRadioMgmt=ipRadioMgmt, license=license, hostname=hostname, tehnika=tehnika, vlanCfgStat=vlanCfgStat, ethQOSTXDropped=ethQOSTXDropped, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, description=description, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, sysDateAndTime=sysDateAndTime, product=product, modemStatistics=modemStatistics, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, modemErroredSecondRatio=modemErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, modemStandard=modemStandard, pointToPoint=pointToPoint, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, radioSide=radioSide, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, vlanEntry=vlanEntry, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, modemCountTime=modemCountTime, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, modemErroredBlock=modemErroredBlock, modemE1T1Channels=modemE1T1Channels, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, radioIndex=radioIndex, radioRxLevel=radioRxLevel, modemModulation=modemModulation, modemSymbolRateRx=modemSymbolRateRx, e1t1LOS=e1t1LOS, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMethernetCapacity=modemACMethernetCapacity, safip=safip, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, radioDuplexShift=radioDuplexShift, ethQOSTXFrames=ethQOSTXFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemAcqStatus=modemAcqStatus, aTPCEntry=aTPCEntry, ipRadio=ipRadio, ipRadioStat=ipRadioStat, vlanTable=vlanTable, ethRXDones=ethRXDones, ethTXDones=ethTXDones)
