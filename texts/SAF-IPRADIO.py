...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:06:41 2023
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, radioRxLevel=radioRxLevel, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterLow=ethRXByteCounterLow, modemLastAcqError=modemLastAcqError, vlanRowStatus=vlanRowStatus, ipRadioStat=ipRadioStat, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, vlanFid=vlanFid, loopback_tributary_mask=loopback_tributary_mask, e1t1AIS=e1t1AIS, modemCarrierOffset=modemCarrierOffset, safip=safip, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, modemInternalAGCgain=modemInternalAGCgain, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, modemIndex=modemIndex, e1t1LOS=e1t1LOS, radioTxPower=radioTxPower, radioEntry=radioEntry, ipRadio=ipRadio, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPauseFrames=ethRXPauseFrames, ipRadioStatEth=ipRadioStatEth, ethRXCRCErrors=ethRXCRCErrors, modemTable=modemTable, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, aTPCEntry=aTPCEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredSecond=modemErroredSecond, product=product, vlansEnabled=vlansEnabled, ethRXBroadcasts=ethRXBroadcasts, licenseMask=licenseMask, modemE1T1Channels=modemE1T1Channels, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, ethTXGiants=ethTXGiants, ethTXDones=ethTXDones, ethRXMulticasts=ethRXMulticasts, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, microwaveRadio=microwaveRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatEntry=e1t1StatEntry, modemCountTime=modemCountTime, modemACMethernetCapacity=modemACMethernetCapacity, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, modemBandwith=modemBandwith, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, ethRXCodeErrors=ethRXCodeErrors, hostname=hostname, radioTxMute=radioTxMute, modemRowStatus=modemRowStatus, modemEntry=modemEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemGeneralStatus=modemGeneralStatus, ethRXControlFrames=ethRXControlFrames, localIpMask=localIpMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, modemStatistics=modemStatistics, ethGFPDelineationErrors=ethGFPDelineationErrors, radioDuplexShift=radioDuplexShift, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXUnderruns=ethTXUnderruns, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, localIp=localIp, modemRadialMSE=modemRadialMSE, sysTemperature=sysTemperature, restartcpu=restartcpu, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcEnabled=atpcEnabled, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMax=modemACMmodulationMax, modemACMengine=modemACMengine, license=license, pointToPoint=pointToPoint, remoteIp=remoteIp, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, ethTXControlFrames=ethTXControlFrames, ethTXCRCErrors=ethTXCRCErrors, radioTable=radioTable, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterHi=ethRXByteCounterHi, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemUptime=modemUptime, radioLoopback=radioLoopback)
