...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:13:36 2023
...
Counter32, Integer32, NotificationType, MibIdentifier, IpAddress, Counter64, TimeTicks, enterprises, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, iso, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "MibIdentifier", "IpAddress", "Counter64", "TimeTicks", "enterprises", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "iso", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCarrierOffset=modemCarrierOffset, vlansEnabled=vlansEnabled, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, ethTXMulticasts=ethTXMulticasts, radioTxPower=radioTxPower, vlanTable=vlanTable, vlanCfgStat=vlanCfgStat, radioRxLevel=radioRxLevel, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, aTPCEntry=aTPCEntry, saf=saf, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, restartcpu=restartcpu, ethTXGiants=ethTXGiants, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalCapacity=modemTotalCapacity, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, remoteIp=remoteIp, ethRXByteCounterLow=ethRXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, vlanPortmap=vlanPortmap, modemEthernetCapacity=modemEthernetCapacity, product=product, ipRadioStat=ipRadioStat, e1t1StatTable=e1t1StatTable, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, vlanEntry=vlanEntry, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, radioGenStatus=radioGenStatus, e1t1LOS=e1t1LOS, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, writeConfig=writeConfig, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterHi=ethRXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1ChannelNr=e1t1ChannelNr, radioEntry=radioEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXDones=ethRXDones, radioLoopback=radioLoopback, modemCountTime=modemCountTime, localIp=localIp, hostname=hostname, safip=safip, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, atpcEnabled=atpcEnabled, modemACMethernetCapacity=modemACMethernetCapacity, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBandwith=modemBandwith, modemACMmodulationMax=modemACMmodulationMax, modemLastAcqError=modemLastAcqError, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXDones=ethTXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCTable=aTPCTable, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, description=description, radioIndex=radioIndex, ethTXByteCounterHi=ethTXByteCounterHi, localIpMask=localIpMask, loopbacks=loopbacks, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, vlanNumber=vlanNumber, license=license, modemTable=modemTable, tehnika=tehnika, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemAcqStatus=modemAcqStatus, modemSymbolRateRx=modemSymbolRateRx, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, modemStatistics=modemStatistics, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, radioSide=radioSide, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, radioTxFrequency=radioTxFrequency, atpcIndex=atpcIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, modemIndex=modemIndex, modemModulation=modemModulation, modemErroredSecondRatio=modemErroredSecondRatio, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, modemUnavailtime=modemUnavailtime, ethRXCodeErrors=ethRXCodeErrors, sysDateAndTime=sysDateAndTime, ethTXControlFrames=ethTXControlFrames)
