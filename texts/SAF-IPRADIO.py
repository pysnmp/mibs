...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:47:32 2024
...
Bits, MibIdentifier, Counter64, NotificationType, Counter32, NotificationType, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, enterprises, iso, TimeTicks, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Counter64", "NotificationType", "Counter32", "NotificationType", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "enterprises", "iso", "TimeTicks", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioDuplexShift=radioDuplexShift, licenseUpdateStatus=licenseUpdateStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEntry=modemEntry, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxPower=radioTxPower, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, radioRxLevel=radioRxLevel, vlanCfgStat=vlanCfgStat, ethRXControlFrames=ethRXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, ipRadio=ipRadio, modemGeneralStatus=modemGeneralStatus, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, aTPCTable=aTPCTable, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, tehnika=tehnika, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, ethTXControlFrames=ethTXControlFrames, modemIndex=modemIndex, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, modemCountTime=modemCountTime, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, modemStatistics=modemStatistics, sysTemperature=sysTemperature, modemACMmodulationMax=modemACMmodulationMax, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCEntry=aTPCEntry, hostname=hostname, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, license=license, radioSide=radioSide, ethQOSTXDropped=ethQOSTXDropped, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDribleNibbles=ethRXDribleNibbles, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, ethRXLongEvents=ethRXLongEvents, ethRXDvEvent=ethRXDvEvent, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanFid=vlanFid, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, product=product, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, loopbacks=loopbacks, ipRadioCfg=ipRadioCfg, modemStandard=modemStandard, vlanEntry=vlanEntry, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanTable=vlanTable, ipRadioStat=ipRadioStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, safip=safip, vlansEnabled=vlansEnabled, atpcEnabled=atpcEnabled, modemACMengine=modemACMengine, modemErroredSecondRatio=modemErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, remoteIp=remoteIp, modemTable=modemTable, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, ethGFPDropedFrames=ethGFPDropedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioEntry=radioEntry, radioIndex=radioIndex, licenseMask=licenseMask, radioTable=radioTable, radioTxFrequency=radioTxFrequency, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDones=ethRXDones, description=description, saf=saf)
