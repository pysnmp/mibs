...
# Produced by pysmi-1.1.10 at Fri Nov 10 11:16:51 2023
...
ModuleIdentity, Counter64, iso, NotificationType, Integer32, Unsigned32, Counter32, IpAddress, ObjectIdentity, TimeTicks, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "iso", "NotificationType", "Integer32", "Unsigned32", "Counter32", "IpAddress", "ObjectIdentity", "TimeTicks", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, radioTxMute=radioTxMute, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, vlanTable=vlanTable, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStatistics=modemStatistics, modemErroredSecond=modemErroredSecond, radioTable=radioTable, radioGenStatus=radioGenStatus, license=license, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, aTPCTable=aTPCTable, localIp=localIp, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, ethRXDvEvent=ethRXDvEvent, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanNumber=vlanNumber, ethTXLateCollisions=ethTXLateCollisions, ethRXCRCErrors=ethRXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, vlansEnabled=vlansEnabled, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, modemAcqStatus=modemAcqStatus, remoteIp=remoteIp, vlanEntry=vlanEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, ethTXBroadcasts=ethTXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity, modemIndex=modemIndex, ethTXVlanTags=ethTXVlanTags, radioTxFrequency=radioTxFrequency, ethTXPauseFrames=ethTXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, radioRxFrequency=radioRxFrequency, vlanRowStatus=vlanRowStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioMgmt=ipRadioMgmt, description=description, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysTemperature=sysTemperature, vlanCfgStat=vlanCfgStat, modemACMengine=modemACMengine, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, ethTXCRCErrors=ethTXCRCErrors, modemE1T1Channels=modemE1T1Channels, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, radioTxPower=radioTxPower, modemEntry=modemEntry, modemRadialMSE=modemRadialMSE, modemEthernetCapacity=modemEthernetCapacity, modemCarrierOffset=modemCarrierOffset, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, aTPCEntry=aTPCEntry, microwaveRadio=microwaveRadio, loopbacks=loopbacks, safip=safip, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioEntry=radioEntry, ethTXDones=ethTXDones, ethGFPCHECErrors=ethGFPCHECErrors, ipRadio=ipRadio, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1AIS=e1t1AIS, ethRXCodeErrors=ethRXCodeErrors, modemErroredBlock=modemErroredBlock, radioSide=radioSide, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, product=product, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, modemStandard=modemStandard, loopback_tributary_mask=loopback_tributary_mask, licenseUpdateStatus=licenseUpdateStatus, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioIndex=radioIndex, modemUptime=modemUptime, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateRx=modemSymbolRateRx, radioLoopback=radioLoopback)
