...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:49:50 2022
...
Counter32, Gauge32, NotificationType, Bits, IpAddress, TimeTicks, ModuleIdentity, Integer32, iso, ObjectIdentity, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "NotificationType", "Bits", "IpAddress", "TimeTicks", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE, radioTxFrequency=radioTxFrequency, sysTemperature=sysTemperature, vlanTable=vlanTable, ipRadioStat=ipRadioStat, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, remoteIp=remoteIp, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, modemInternalAGCgain=modemInternalAGCgain, safip=safip, e1t1AIS=e1t1AIS, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, radioLoopback=radioLoopback, ethGFPCHECErrors=ethGFPCHECErrors, radioTxMute=radioTxMute, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, ethTXVlanTags=ethTXVlanTags, ethRXCodeErrors=ethRXCodeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, product=product, modemEntry=modemEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemIndex=modemIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterHi=ethRXByteCounterHi, vlansEnabled=vlansEnabled, hostname=hostname, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, radioSide=radioSide, modemTable=modemTable, radioTxPower=radioTxPower, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, microwaveRadio=microwaveRadio, license=license, localIpMask=localIpMask, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBroadcasts=ethTXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXPauseFrames=ethRXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, e1t1ChannelNr=e1t1ChannelNr, writeConfig=writeConfig, loopbacks=loopbacks, licenseMask=licenseMask, vlanPortmap=vlanPortmap, modemStandard=modemStandard, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecondRatio=modemErroredSecondRatio, e1t1LOS=e1t1LOS, modemStatistics=modemStatistics, aTPCEntry=aTPCEntry, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecond=modemErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, modemSymbolRateRx=modemSymbolRateRx, pointToPoint=pointToPoint, radioIndex=radioIndex, vlanFid=vlanFid, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDones=ethRXDones, modemModulation=modemModulation, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, saf=saf, modemRowStatus=modemRowStatus, ethTXGiants=ethTXGiants, modemErroredBlock=modemErroredBlock, vlanNumber=vlanNumber, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, localIp=localIp, description=description, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, tehnika=tehnika, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCollisions=ethTXCollisions, ipRadio=ipRadio, ethRXDvEvent=ethRXDvEvent, vlanRowStatus=vlanRowStatus, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioMgmt=ipRadioMgmt, aTPCTable=aTPCTable, radioDuplexShift=radioDuplexShift, restartcpu=restartcpu, ethGFPDropedFrames=ethGFPDropedFrames, radioTable=radioTable, loopback_tributary_mask=loopback_tributary_mask, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg, modemBandwith=modemBandwith, ethTXDones=ethTXDones, modemUnavailtime=modemUnavailtime, ethQOSTXDropped=ethQOSTXDropped)
