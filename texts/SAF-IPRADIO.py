...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:58:28 2021
...
Integer32, enterprises, IpAddress, NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, Bits, Gauge32, Counter32, Counter64, iso, TimeTicks, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "IpAddress", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Bits", "Gauge32", "Counter32", "Counter64", "iso", "TimeTicks", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, modemEntry=modemEntry, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMax=modemACMmodulationMax, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, localIp=localIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterHi=ethRXByteCounterHi, modemBandwith=modemBandwith, radioLoopback=radioLoopback, ethRXMulticasts=ethRXMulticasts, ethTXLateCollisions=ethTXLateCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, modemModulation=modemModulation, ipRadioCfgNetwork=ipRadioCfgNetwork, modemIndex=modemIndex, ethRXPauseFrames=ethRXPauseFrames, tehnika=tehnika, vlanEntry=vlanEntry, licenseUpdateStatus=licenseUpdateStatus, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXDropped=ethQOSTXDropped, modemEthernetCapacity=modemEthernetCapacity, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, vlanFid=vlanFid, ipRadio=ipRadio, restartcpu=restartcpu, radioTable=radioTable, ethRXDones=ethRXDones, sysTemperature=sysTemperature, aTPCTable=aTPCTable, radioDuplexShift=radioDuplexShift, modemUnavailtime=modemUnavailtime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, modemTable=modemTable, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, description=description, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanTable=vlanTable, radioTxMute=radioTxMute, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, modemInternalAGCgain=modemInternalAGCgain, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, vlansEnabled=vlansEnabled, microwaveRadio=microwaveRadio, ipRadioStat=ipRadioStat, modemCarrierOffset=modemCarrierOffset, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUptime=modemUptime, hostname=hostname, ipRadioStatEth=ipRadioStatEth, ethRXBroadcasts=ethRXBroadcasts, atpcEnabled=atpcEnabled, ethTXGiants=ethTXGiants, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1AIS=e1t1AIS, ethRXByteCounterLow=ethRXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxFrequency=radioTxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, radioTxPower=radioTxPower, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, radioIndex=radioIndex, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, product=product, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMtotalCapacity=modemACMtotalCapacity, ethTXControlFrames=ethTXControlFrames, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, radioEntry=radioEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemAcqStatus=modemAcqStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1Channels=modemE1T1Channels, modemStatistics=modemStatistics, ethGFPCHECErrors=ethGFPCHECErrors, loopbacks=loopbacks, radioGenStatus=radioGenStatus, vlanPortType=vlanPortType, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, ipRadioMgmt=ipRadioMgmt, vlanPortmap=vlanPortmap, radioSide=radioSide, pointToPoint=pointToPoint, ethTXBroadcasts=ethTXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanCfgStat=vlanCfgStat, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, license=license, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, aTPCEntry=aTPCEntry)
