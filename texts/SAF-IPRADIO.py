...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:34:47 2023
...
Integer32, IpAddress, Gauge32, ObjectIdentity, ModuleIdentity, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, MibIdentifier, enterprises, Counter64, NotificationType, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Gauge32", "ObjectIdentity", "ModuleIdentity", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "MibIdentifier", "enterprises", "Counter64", "NotificationType", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, radioDuplexShift=radioDuplexShift, ipRadioCfg=ipRadioCfg, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, modemEthernetCapacity=modemEthernetCapacity, e1t1AIS=e1t1AIS, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, atpcEnabled=atpcEnabled, ethRXControlFrames=ethRXControlFrames, ethTXBroadcasts=ethTXBroadcasts, tehnika=tehnika, safip=safip, ethQOSTXFrames=ethQOSTXFrames, ethTXMulticasts=ethTXMulticasts, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, ethTXGiants=ethTXGiants, atpcIndex=atpcIndex, vlanPortType=vlanPortType, aTPCEntry=aTPCEntry, vlanFid=vlanFid, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, modemEntry=modemEntry, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, modemIndex=modemIndex, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioSide=radioSide, ipRadioStatEth=ipRadioStatEth, vlanTable=vlanTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, vlansEnabled=vlansEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, modemGeneralStatus=modemGeneralStatus, e1t1LOS=e1t1LOS, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, microwaveRadio=microwaveRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, modemAcqStatus=modemAcqStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, vlanEntry=vlanEntry, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxFrequency=radioTxFrequency, radioTxPower=radioTxPower, radioEntry=radioEntry, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, writeConfig=writeConfig, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXVlanTags=ethTXVlanTags, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioIndex=radioIndex, modemStatistics=modemStatistics, loopbacks=loopbacks, pointToPoint=pointToPoint, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, description=description, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, e1t1ChannelNr=e1t1ChannelNr, vlanRowStatus=vlanRowStatus, modemModulation=modemModulation, ethRXLongEvents=ethRXLongEvents, restartcpu=restartcpu, localIp=localIp, ethRXBroadcasts=ethRXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, ethGFPFCSErrors=ethGFPFCSErrors, radioRxFrequency=radioRxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, licenseUpdateStatus=licenseUpdateStatus, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, hostname=hostname, radioTable=radioTable, aTPCTable=aTPCTable, sysDateAndTime=sysDateAndTime, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMengine=modemACMengine, modemUnavailtime=modemUnavailtime, loopback_tributary_mask=loopback_tributary_mask, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIpMask=localIpMask, licenseMask=licenseMask, ipRadio=ipRadio)
