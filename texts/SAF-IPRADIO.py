...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:32:01 2023
...
NotificationType, TimeTicks, Gauge32, IpAddress, iso, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, NotificationType, Counter32, ObjectIdentity, Bits, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Gauge32", "IpAddress", "iso", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "Bits", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", product=product, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt, hostname=hostname, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStat=ipRadioStat, ipRadioCfg=ipRadioCfg, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1Channels=modemE1T1Channels, ethTXMaxCollisions=ethTXMaxCollisions, radioDuplexShift=radioDuplexShift, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, modemStandard=modemStandard, ethRXMulticasts=ethRXMulticasts, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, modemTable=modemTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMin=modemACMmodulationMin, sysTemperature=sysTemperature, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, vlanTable=vlanTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, safip=safip, radioSide=radioSide, ethRXByteCounterLow=ethRXByteCounterLow, radioTxMute=radioTxMute, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanEntry=vlanEntry, remoteIp=remoteIp, modemSymbolRateRx=modemSymbolRateRx, vlanFid=vlanFid, ethTXControlFrames=ethTXControlFrames, modemRowStatus=modemRowStatus, ipRadio=ipRadio, vlanPortType=vlanPortType, modemACMtotalCapacity=modemACMtotalCapacity, saf=saf, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterHi=ethRXByteCounterHi, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, ethTXGiants=ethTXGiants, ethRXPauseFrames=ethRXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, modemBandwith=modemBandwith, license=license, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, ethRXBroadcasts=ethRXBroadcasts, description=description, modemIndex=modemIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, licenseMask=licenseMask, tehnika=tehnika, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, ethTXLateCollisions=ethTXLateCollisions, ethQOSTXDropped=ethQOSTXDropped, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, loopbacks=loopbacks, radioTable=radioTable, modemUnavailtime=modemUnavailtime, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCEntry=aTPCEntry, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanRowStatus=vlanRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, localIp=localIp, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCountTime=modemCountTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, modemCarrierOffset=modemCarrierOffset, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, e1t1ChannelNr=e1t1ChannelNr, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, modemACMethernetCapacity=modemACMethernetCapacity)
