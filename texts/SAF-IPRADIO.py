...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:52:47 2022
...
Bits, IpAddress, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, MibIdentifier, ObjectIdentity, enterprises, Gauge32, Counter32, iso, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "MibIdentifier", "ObjectIdentity", "enterprises", "Gauge32", "Counter32", "iso", "ModuleIdentity", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBackpresEvents=ethTXBackpresEvents, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, radioTxPower=radioTxPower, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, radioRxFrequency=radioRxFrequency, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXFrames=ethQOSTXFrames, radioIndex=radioIndex, tehnika=tehnika, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, license=license, ethRXCodeErrors=ethRXCodeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalCapacity=modemTotalCapacity, sysDateAndTime=sysDateAndTime, modemE1T1Channels=modemE1T1Channels, radioSide=radioSide, vlanEntry=vlanEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1AIS=e1t1AIS, product=product, writeConfig=writeConfig, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCountTime=modemCountTime, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, ethTXBroadcasts=ethTXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, licenseMask=licenseMask, modemModulation=modemModulation, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, modemACMethernetCapacity=modemACMethernetCapacity, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, description=description, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLongEvents=ethRXLongEvents, localIpMask=localIpMask, modemEthernetCapacity=modemEthernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXBroadcasts=ethRXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStandard=modemStandard, e1t1StatEntry=e1t1StatEntry, modemACMengine=modemACMengine, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatTable=e1t1StatTable, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, modemUptime=modemUptime, restartcpu=restartcpu, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, ethRXCRCErrors=ethRXCRCErrors, ethTXGiants=ethTXGiants, saf=saf, ethRXControlFrames=ethRXControlFrames, radioLoopback=radioLoopback, ethTXDones=ethTXDones, ethTXPauseFrames=ethTXPauseFrames, vlanPortType=vlanPortType, modemErroredSecond=modemErroredSecond, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, modemStatistics=modemStatistics, modemErroredSecondRatio=modemErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, ethGFPCHECErrors=ethGFPCHECErrors, modemUnavailtime=modemUnavailtime, ethTXByteCounterHi=ethTXByteCounterHi, modemLastAcqError=modemLastAcqError, vlanFid=vlanFid, radioRxLevel=radioRxLevel, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadio=ipRadio, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredBlock=modemErroredBlock, modemEntry=modemEntry, aTPCTable=aTPCTable, safip=safip, radioEntry=radioEntry, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, sysTemperature=sysTemperature)
