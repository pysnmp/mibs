...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:22:57 2022
...
ObjectIdentity, Counter64, iso, Bits, ModuleIdentity, MibIdentifier, IpAddress, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Unsigned32, enterprises, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "iso", "Bits", "ModuleIdentity", "MibIdentifier", "IpAddress", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Unsigned32", "enterprises", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfg=ipRadioCfg, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, ethRXMulticasts=ethRXMulticasts, vlansEnabled=vlansEnabled, safip=safip, loopbacks=loopbacks, ethTXUnderruns=ethTXUnderruns, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, atpcEnabled=atpcEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, radioDuplexShift=radioDuplexShift, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, ethTXMaxCollisions=ethTXMaxCollisions, ethTXDones=ethTXDones, license=license, e1t1LOS=e1t1LOS, modemTable=modemTable, ipRadioStatEth=ipRadioStatEth, radioRxLevel=radioRxLevel, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalBlockNumber=modemTotalBlockNumber, modemCarrierOffset=modemCarrierOffset, vlanTable=vlanTable, radioSide=radioSide, radioTxMute=radioTxMute, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, ipRadio=ipRadio, ethQOSTXDropped=ethQOSTXDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, saf=saf, radioIndex=radioIndex, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, ethGFPCHECErrors=ethGFPCHECErrors, radioRxFrequency=radioRxFrequency, modemLastAcqError=modemLastAcqError, ethQOSTXFrames=ethQOSTXFrames, vlanFid=vlanFid, ethTXExcessiveDefers=ethTXExcessiveDefers, radioGenStatus=radioGenStatus, ethTXPauseFrames=ethTXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortType=vlanPortType, ethRXBroadcasts=ethRXBroadcasts, ethTXCollisions=ethTXCollisions, description=description, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, radioLoopback=radioLoopback, ethTXByteCounterLow=ethTXByteCounterLow, modemStatistics=modemStatistics, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, modemTotalCapacity=modemTotalCapacity, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, modemRadialMSE=modemRadialMSE, modemSymbolRateTx=modemSymbolRateTx, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMulticasts=ethTXMulticasts, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, product=product, ethTXControlFrames=ethTXControlFrames, vlanEntry=vlanEntry, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, writeConfig=writeConfig, ethGFPDelineationErrors=ethGFPDelineationErrors, modemIndex=modemIndex, modemModulation=modemModulation, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, restartcpu=restartcpu, modemEntry=modemEntry, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, modemErroredBlock=modemErroredBlock, loopback_tributary_mask=loopback_tributary_mask, modemGeneralStatus=modemGeneralStatus, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, modemACMengine=modemACMengine, vlanCfgStat=vlanCfgStat, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecondRatio=modemErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, modemErroredSecond=modemErroredSecond, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, modemUnavailtime=modemUnavailtime, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatTable=e1t1StatTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxFrequency=radioTxFrequency, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, radioTable=radioTable, vlanNumber=vlanNumber, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
