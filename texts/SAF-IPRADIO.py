...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:37:48 2021
...
NotificationType, ModuleIdentity, Integer32, Unsigned32, Gauge32, IpAddress, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, MibIdentifier, TimeTicks, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMin=modemACMmodulationMin, ipRadioStat=ipRadioStat, ethGFPFCSErrors=ethGFPFCSErrors, modemCountTime=modemCountTime, e1t1LOS=e1t1LOS, radioIndex=radioIndex, localIpMask=localIpMask, ethRXCRCErrors=ethRXCRCErrors, tehnika=tehnika, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, sysTemperature=sysTemperature, ethTXPauseFrames=ethTXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioGenStatus=radioGenStatus, description=description, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, license=license, modemUptime=modemUptime, vlanCfgStat=vlanCfgStat, modemStatistics=modemStatistics, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, safip=safip, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, modemIndex=modemIndex, modemACMengine=modemACMengine, modemSymbolRateRx=modemSymbolRateRx, ipRadio=ipRadio, vlansEnabled=vlansEnabled, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, ethRXCodeErrors=ethRXCodeErrors, modemEthernetCapacity=modemEthernetCapacity, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, radioDuplexShift=radioDuplexShift, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBroadcasts=ethTXBroadcasts, remoteIp=remoteIp, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcIndex=atpcIndex, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, microwaveRadio=microwaveRadio, ethTXDones=ethTXDones, vlanPortmap=vlanPortmap, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, radioLoopback=radioLoopback, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, radioSide=radioSide, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, licenseMask=licenseMask, product=product, sysDateAndTime=sysDateAndTime, hostname=hostname, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemStandard=modemStandard, saf=saf, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterLow=ethRXByteCounterLow, vlanRowStatus=vlanRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, aTPCTable=aTPCTable, ethGFPCHECErrors=ethGFPCHECErrors, modemRowStatus=modemRowStatus, ethRXLongEvents=ethRXLongEvents, modemE1T1Channels=modemE1T1Channels, localIp=localIp, radioTxPower=radioTxPower, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, radioTxMute=radioTxMute, loopback_tributary_mask=loopback_tributary_mask, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, pointToPoint=pointToPoint, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxFrequency=radioRxFrequency, writeConfig=writeConfig, e1t1StatTable=e1t1StatTable, vlanFid=vlanFid, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, radioEntry=radioEntry, modemTable=modemTable, modemModulation=modemModulation)
