...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:52:31 2023
...
Counter32, Gauge32, ObjectIdentity, NotificationType, NotificationType, ModuleIdentity, enterprises, IpAddress, iso, Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "NotificationType", "ModuleIdentity", "enterprises", "IpAddress", "iso", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStatistics=modemStatistics, ethTXVlanTags=ethTXVlanTags, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, tehnika=tehnika, e1t1ChannelNr=e1t1ChannelNr, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, vlanEntry=vlanEntry, sysDateAndTime=sysDateAndTime, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, license=license, ethTXGiants=ethTXGiants, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEthernetCapacity=modemEthernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, modemEntry=modemEntry, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, licenseUpdateStatus=licenseUpdateStatus, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSTXDropped=ethQOSTXDropped, atpcIndex=atpcIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXUnderruns=ethTXUnderruns, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCRCErrors=ethTXCRCErrors, ipRadio=ipRadio, hostname=hostname, description=description, modemSymbolRateTx=modemSymbolRateTx, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, radioSide=radioSide, radioDuplexShift=radioDuplexShift, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, aTPCTable=aTPCTable, modemStandard=modemStandard, modemUptime=modemUptime, ipRadioCfgGeneral=ipRadioCfgGeneral, localIp=localIp, ethTXLateCollisions=ethTXLateCollisions, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, saf=saf, modemGeneralStatus=modemGeneralStatus, remoteIp=remoteIp, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanTable=vlanTable, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, modemTotalCapacity=modemTotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, restartcpu=restartcpu, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, ethRXCodeErrors=ethRXCodeErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfg=ipRadioCfg, product=product, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIpMask=localIpMask, ethTXControlFrames=ethTXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxMute=radioTxMute, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, loopbacks=loopbacks, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, radioTxFrequency=radioTxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBroadcasts=ethTXBroadcasts, ethTXDones=ethTXDones, sysTemperature=sysTemperature, ipRadioMgmt=ipRadioMgmt, vlanNumber=vlanNumber, ethRXMulticasts=ethRXMulticasts, radioEntry=radioEntry, modemIndex=modemIndex, ipRadioStat=ipRadioStat, modemBandwith=modemBandwith, vlanPortmap=vlanPortmap, ethTXByteCounterLow=ethTXByteCounterLow, atpcEnabled=atpcEnabled, modemACMmodulationMax=modemACMmodulationMax)
