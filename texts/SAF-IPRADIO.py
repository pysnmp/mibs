...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDones=ethRXDones, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, e1t1LOS=e1t1LOS, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecond=modemErroredSecond, modemSymbolRateTx=modemSymbolRateTx, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStat=ipRadioStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxPower=radioTxPower, ethQOSTXFrames=ethQOSTXFrames, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, pointToPoint=pointToPoint, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxMute=radioTxMute, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioLoopback=radioLoopback, vlanPortType=vlanPortType, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemIndex=modemIndex, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, safip=safip, localIp=localIp, ethRXDvEvent=ethRXDvEvent, ethTXPauseFrames=ethTXPauseFrames, radioTxFrequency=radioTxFrequency, modemStandard=modemStandard, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, radioSide=radioSide, atpcEnabled=atpcEnabled, modemSymbolRateRx=modemSymbolRateRx, modemUptime=modemUptime, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, modemACMengine=modemACMengine, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, localIpMask=localIpMask, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMax=modemACMmodulationMax, e1t1StatEntry=e1t1StatEntry, modemStatistics=modemStatistics, ethTXCRCErrors=ethTXCRCErrors, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ipRadioStatEth=ipRadioStatEth, microwaveRadio=microwaveRadio, product=product, radioRxLevel=radioRxLevel, ethTXMaxCollisions=ethTXMaxCollisions, vlanNumber=vlanNumber, ethRXDribleNibbles=ethRXDribleNibbles, modemCarrierOffset=modemCarrierOffset, restartcpu=restartcpu, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, remoteIp=remoteIp, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, saf=saf, vlanFid=vlanFid, modemErroredBlock=modemErroredBlock, loopbacks=loopbacks, description=description, radioIndex=radioIndex, tehnika=tehnika, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXMulticasts=ethRXMulticasts, ethRXPauseFrames=ethRXPauseFrames, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseMask=licenseMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioDuplexShift=radioDuplexShift, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRowStatus=modemRowStatus, vlanEntry=vlanEntry, license=license, ethTXByteCounterHi=ethTXByteCounterHi, modemCountTime=modemCountTime, ethGFPCHECErrors=ethGFPCHECErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXDones=ethTXDones, aTPCTable=aTPCTable, sysDateAndTime=sysDateAndTime, sysTemperature=sysTemperature, ethRXControlFrames=ethRXControlFrames, ipRadio=ipRadio, writeConfig=writeConfig, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, ethTXLateCollisions=ethTXLateCollisions)
