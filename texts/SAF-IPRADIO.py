...
# Produced by pysmi-1.1.12 at Mon May 13 02:43:22 2024
...
Bits, NotificationType, ObjectIdentity, ModuleIdentity, iso, TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, IpAddress, MibIdentifier, enterprises, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ObjectIdentity", "ModuleIdentity", "iso", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioLoopback=radioLoopback, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, radioTable=radioTable, e1t1AIS=e1t1AIS, radioTxMute=radioTxMute, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, localIpMask=localIpMask, modemLastAcqError=modemLastAcqError, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, e1t1LOS=e1t1LOS, radioGenStatus=radioGenStatus, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, modemSymbolRateRx=modemSymbolRateRx, microwaveRadio=microwaveRadio, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, loopback_tributary_mask=loopback_tributary_mask, hostname=hostname, ipRadioCfg=ipRadioCfg, modemACMtotalCapacity=modemACMtotalCapacity, vlanEntry=vlanEntry, safip=safip, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, modemTotalCapacity=modemTotalCapacity, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, ipRadioStat=ipRadioStat, ethQOSTXFrames=ethQOSTXFrames, pointToPoint=pointToPoint, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, modemUptime=modemUptime, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateTx=modemSymbolRateTx, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, radioTxFrequency=radioTxFrequency, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, modemTable=modemTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMulticasts=ethTXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemModulation=modemModulation, ethRXDones=ethRXDones, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanNumber=vlanNumber, saf=saf, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPauseFrames=ethRXPauseFrames, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, ethTXCRCErrors=ethTXCRCErrors, ethTXCollisions=ethTXCollisions, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDvEvent=ethRXDvEvent, radioSide=radioSide, ethRXCodeErrors=ethRXCodeErrors, license=license, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterLow=ethRXByteCounterLow, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, modemStandard=modemStandard, description=description, modemEntry=modemEntry, ethRXControlFrames=ethRXControlFrames, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, modemStatistics=modemStatistics, modemACMethernetCapacity=modemACMethernetCapacity, modemACMengine=modemACMengine, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, e1t1StatEntry=e1t1StatEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, ethRXMulticasts=ethRXMulticasts, writeConfig=writeConfig, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanFid=vlanFid)
