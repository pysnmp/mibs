...
# Produced by pysmi-1.1.8 at Mon Jan  9 11:09:49 2023
...
enterprises, Integer32, ObjectIdentity, Counter32, Counter64, TimeTicks, Gauge32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Bits, ModuleIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "ObjectIdentity", "Counter32", "Counter64", "TimeTicks", "Gauge32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Bits", "ModuleIdentity", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", restartcpu=restartcpu, hostname=hostname, modemLastAcqError=modemLastAcqError, microwaveRadio=microwaveRadio, ethRXCodeErrors=ethRXCodeErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDribleNibbles=ethRXDribleNibbles, modemEthernetCapacity=modemEthernetCapacity, modemACMmodulationMax=modemACMmodulationMax, modemUptime=modemUptime, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, vlanEntry=vlanEntry, sysDateAndTime=sysDateAndTime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRadialMSE=modemRadialMSE, ethTXMulticasts=ethTXMulticasts, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, radioIndex=radioIndex, modemEntry=modemEntry, ethRXByteCounterHi=ethRXByteCounterHi, radioDuplexShift=radioDuplexShift, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, radioTxMute=radioTxMute, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, ethTXControlFrames=ethTXControlFrames, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanPortmap=vlanPortmap, vlanPortType=vlanPortType, ethRXDvEvent=ethRXDvEvent, writeConfig=writeConfig, modemStatistics=modemStatistics, product=product, ipRadio=ipRadio, saf=saf, modemErroredBlock=modemErroredBlock, localIpMask=localIpMask, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPCHECErrors=ethGFPCHECErrors, vlanRowStatus=vlanRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCountTime=modemCountTime, radioGenStatus=radioGenStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, description=description, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatTable=e1t1StatTable, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterLow=ethTXByteCounterLow, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, pointToPoint=pointToPoint, ethTXGiants=ethTXGiants, modemSymbolRateTx=modemSymbolRateTx, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTable=modemTable, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXFrames=ethQOSTXFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemACMtotalCapacity=modemACMtotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateRx=modemSymbolRateRx, aTPCTable=aTPCTable, ethRXPauseFrames=ethRXPauseFrames, radioTable=radioTable, localIp=localIp, ethRXDones=ethRXDones, ethTXLateCollisions=ethTXLateCollisions, vlanTable=vlanTable, licenseMask=licenseMask, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXDones=ethTXDones, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioSide=radioSide, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecond=modemErroredSecond, safip=safip, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopback_tributary_mask=loopback_tributary_mask, license=license, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, sysTemperature=sysTemperature, licenseUpdateStatus=licenseUpdateStatus, vlanNumber=vlanNumber, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1LOS=e1t1LOS, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXBroadcasts=ethRXBroadcasts, tehnika=tehnika, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors)
