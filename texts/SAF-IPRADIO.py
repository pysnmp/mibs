...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:58:29 2022
...
Gauge32, MibIdentifier, Counter32, iso, Integer32, Unsigned32, enterprises, TimeTicks, IpAddress, NotificationType, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Counter32", "iso", "Integer32", "Unsigned32", "enterprises", "TimeTicks", "IpAddress", "NotificationType", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, sysTemperature=sysTemperature, ethTXVlanTags=ethTXVlanTags, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, e1t1LOS=e1t1LOS, radioTable=radioTable, ethRXDones=ethRXDones, pointToPoint=pointToPoint, safip=safip, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, ethTXMaxCollisions=ethTXMaxCollisions, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, vlanEntry=vlanEntry, ethRXCodeErrors=ethRXCodeErrors, modemLastAcqError=modemLastAcqError, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, localIp=localIp, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, radioIndex=radioIndex, radioRxLevel=radioRxLevel, radioTxPower=radioTxPower, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, description=description, vlanCfgStat=vlanCfgStat, modemIndex=modemIndex, ethTXCollisions=ethTXCollisions, writeConfig=writeConfig, modemUnavailtime=modemUnavailtime, license=license, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioGenStatus=radioGenStatus, vlanPortType=vlanPortType, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStatistics=modemStatistics, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, remoteIp=remoteIp, ethTXDones=ethTXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEntry=modemEntry, ethTXGiants=ethTXGiants, restartcpu=restartcpu, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, modemRadialMSE=modemRadialMSE, vlanTable=vlanTable, ethRXPauseFrames=ethRXPauseFrames, modemTable=modemTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemModulation=modemModulation, microwaveRadio=microwaveRadio, modemACMmodulationMin=modemACMmodulationMin, ipRadioStat=ipRadioStat, radioSide=radioSide, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStatEth=ipRadioStatEth, modemUptime=modemUptime, product=product, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, modemTotalCapacity=modemTotalCapacity, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, localIpMask=localIpMask, modemErroredSecondRatio=modemErroredSecondRatio, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgGeneral=ipRadioCfgGeneral, saf=saf, e1t1StatTable=e1t1StatTable, licenseMask=licenseMask, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXFrames=ethQOSTXFrames, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, e1t1ChannelNr=e1t1ChannelNr, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCTable=aTPCTable, radioLoopback=radioLoopback, radioTxMute=radioTxMute, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxFrequency=radioTxFrequency, modemACMengine=modemACMengine)
