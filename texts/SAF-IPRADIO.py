...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:51:49 2023
...
NotificationType, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, Counter32, Integer32, Counter64, Gauge32, IpAddress, NotificationType, enterprises, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter32", "Integer32", "Counter64", "Gauge32", "IpAddress", "NotificationType", "enterprises", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, atpcIndex=atpcIndex, license=license, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateTx=modemSymbolRateTx, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, licenseUpdateStatus=licenseUpdateStatus, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, sysDateAndTime=sysDateAndTime, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, modemCountTime=modemCountTime, ethTXBackpresEvents=ethTXBackpresEvents, radioGenStatus=radioGenStatus, ethRXBroadcasts=ethRXBroadcasts, modemAcqStatus=modemAcqStatus, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, vlansEnabled=vlansEnabled, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, radioIndex=radioIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, e1t1AIS=e1t1AIS, ethTXCRCErrors=ethTXCRCErrors, radioTable=radioTable, saf=saf, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXLongEvents=ethRXLongEvents, modemGeneralStatus=modemGeneralStatus, hostname=hostname, vlanCfgStat=vlanCfgStat, modemUptime=modemUptime, modemStandard=modemStandard, radioSide=radioSide, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, modemLastAcqError=modemLastAcqError, ethRXPauseFrames=ethRXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredSecondRatio=modemErroredSecondRatio, tehnika=tehnika, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, writeConfig=writeConfig, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, licenseMask=licenseMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCEntry=aTPCEntry, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1ChannelNr=e1t1ChannelNr, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, ethTXVlanTags=ethTXVlanTags, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, sysTemperature=sysTemperature, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, ethTXGiants=ethTXGiants, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, microwaveRadio=microwaveRadio, modemEntry=modemEntry, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, product=product, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, restartcpu=restartcpu, description=description, pointToPoint=pointToPoint, modemACMmodulationMax=modemACMmodulationMax, e1t1StatTable=e1t1StatTable, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, radioLoopback=radioLoopback, ethRXDones=ethRXDones, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, safip=safip, modemRadialMSE=modemRadialMSE, modemACMengine=modemACMengine, radioTxFrequency=radioTxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, modemACMethernetCapacity=modemACMethernetCapacity)
