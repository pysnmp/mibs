...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:21:17 2021
...
Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, IpAddress, Bits, ModuleIdentity, MibIdentifier, Counter32, Counter64, Integer32, Unsigned32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "IpAddress", "Bits", "ModuleIdentity", "MibIdentifier", "Counter32", "Counter64", "Integer32", "Unsigned32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateTx=modemSymbolRateTx, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCountTime=modemCountTime, localIpMask=localIpMask, vlanRowStatus=vlanRowStatus, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, radioTable=radioTable, radioRxLevel=radioRxLevel, loopbacks=loopbacks, ipRadio=ipRadio, ethQOSTXDropped=ethQOSTXDropped, ethTXMulticasts=ethTXMulticasts, ethRXDvEvent=ethRXDvEvent, radioLoopback=radioLoopback, vlansEnabled=vlansEnabled, vlanNumber=vlanNumber, vlanPortmap=vlanPortmap, radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, modemACMethernetCapacity=modemACMethernetCapacity, radioSide=radioSide, ethTXVlanTags=ethTXVlanTags, microwaveRadio=microwaveRadio, radioTxFrequency=radioTxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, pointToPoint=pointToPoint, modemErroredBlock=modemErroredBlock, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, description=description, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, modemUptime=modemUptime, atpcIndex=atpcIndex, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, writeConfig=writeConfig, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, saf=saf, modemCarrierOffset=modemCarrierOffset, modemACMtotalCapacity=modemACMtotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, radioIndex=radioIndex, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterLow=ethRXByteCounterLow, hostname=hostname, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, modemStatistics=modemStatistics, ethRXControlFrames=ethRXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, product=product, modemRadialMSE=modemRadialMSE, ethTXBroadcasts=ethTXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, safip=safip, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, ethTXCRCErrors=ethTXCRCErrors, radioTxPower=radioTxPower, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, restartcpu=restartcpu, vlanTable=vlanTable, remoteIp=remoteIp, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ethTXMaxCollisions=ethTXMaxCollisions, modemLastAcqError=modemLastAcqError, e1t1AIS=e1t1AIS, ethTXDones=ethTXDones, modemUnavailtime=modemUnavailtime, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, aTPCEntry=aTPCEntry, license=license, ethRXBroadcasts=ethRXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMengine=modemACMengine, ethTXLateCollisions=ethTXLateCollisions, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, modemRowStatus=modemRowStatus, vlanEntry=vlanEntry, e1t1ChannelNr=e1t1ChannelNr, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEthernetCapacity=modemEthernetCapacity, modemStandard=modemStandard, ethGFPCHECErrors=ethGFPCHECErrors, modemInternalAGCgain=modemInternalAGCgain)
