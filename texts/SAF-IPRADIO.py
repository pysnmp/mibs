...
# Produced by pysmi-1.1.8 at Tue Jan 18 15:15:57 2022
...
Unsigned32, IpAddress, ModuleIdentity, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Integer32, Counter32, Bits, NotificationType, NotificationType, MibIdentifier, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Integer32", "Counter32", "Bits", "NotificationType", "NotificationType", "MibIdentifier", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUnavailtime=modemUnavailtime, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemIndex=modemIndex, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, hostname=hostname, modemSeverelyErroredSecond=modemSeverelyErroredSecond, pointToPoint=pointToPoint, writeConfig=writeConfig, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, ethQOSTXFrames=ethQOSTXFrames, licenseUpdateStatus=licenseUpdateStatus, vlanCfgStat=vlanCfgStat, radioSide=radioSide, ethTXBroadcasts=ethTXBroadcasts, modemCarrierOffset=modemCarrierOffset, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, modemACMmodulationMin=modemACMmodulationMin, ethRXControlFrames=ethRXControlFrames, radioTxMute=radioTxMute, vlanEntry=vlanEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStat=ipRadioStat, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, modemCountTime=modemCountTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, aTPCEntry=aTPCEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXPrevPktDropped=ethRXPrevPktDropped, product=product, ethTXCRCErrors=ethTXCRCErrors, saf=saf, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, modemSymbolRateTx=modemSymbolRateTx, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemGeneralStatus=modemGeneralStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemRadialMSE=modemRadialMSE, ethRXBroadcasts=ethRXBroadcasts, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, restartcpu=restartcpu, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, license=license, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, atpcIndex=atpcIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, localIp=localIp, description=description, sysTemperature=sysTemperature, vlanRowStatus=vlanRowStatus, e1t1StatEntry=e1t1StatEntry, ethTXGiants=ethTXGiants, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, sysDateAndTime=sysDateAndTime, vlanPortType=vlanPortType, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcEnabled=atpcEnabled, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, ipRadio=ipRadio, modemRowStatus=modemRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, ethTXUnderruns=ethTXUnderruns, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, safip=safip, tehnika=tehnika, ethRXDones=ethRXDones, radioGenStatus=radioGenStatus, modemTotalCapacity=modemTotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDvEvent=ethRXDvEvent, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxPower=radioTxPower, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, vlanTable=vlanTable, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers)
