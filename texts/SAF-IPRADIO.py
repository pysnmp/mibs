...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:06:06 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, TimeTicks, Counter64, Unsigned32, MibIdentifier, Gauge32, IpAddress, Integer32, ObjectIdentity, Bits, NotificationType, NotificationType, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "TimeTicks", "Counter64", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "Integer32", "ObjectIdentity", "Bits", "NotificationType", "NotificationType", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTable=radioTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMax=modemACMmodulationMax, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, hostname=hostname, e1t1StatTable=e1t1StatTable, tehnika=tehnika, ethGFPFCSErrors=ethGFPFCSErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRadialMSE=modemRadialMSE, radioSide=radioSide, radioTxFrequency=radioTxFrequency, microwaveRadio=microwaveRadio, ipRadio=ipRadio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXVlanTags=ethTXVlanTags, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, modemBandwith=modemBandwith, radioGenStatus=radioGenStatus, vlanPortType=vlanPortType, modemTable=modemTable, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1Channels=modemE1T1Channels, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, sysTemperature=sysTemperature, modemGeneralStatus=modemGeneralStatus, ethRXLongEvents=ethRXLongEvents, vlanEntry=vlanEntry, saf=saf, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, radioTxPower=radioTxPower, ethRXControlFrames=ethRXControlFrames, product=product, remoteIp=remoteIp, vlansEnabled=vlansEnabled, modemUnavailtime=modemUnavailtime, license=license, sysDateAndTime=sysDateAndTime, ethTXLateCollisions=ethTXLateCollisions, ethTXMulticasts=ethTXMulticasts, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, safip=safip, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXDropped=ethQOSTXDropped, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, radioLoopback=radioLoopback, radioRxLevel=radioRxLevel, ipRadioCfg=ipRadioCfg, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, atpcEnabled=atpcEnabled, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, modemRowStatus=modemRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXDones=ethTXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, modemEntry=modemEntry, radioIndex=radioIndex, atpcIndex=atpcIndex, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1LOS=e1t1LOS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethTXGiants=ethTXGiants, vlanTable=vlanTable, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, modemStatistics=modemStatistics, ipRadioStat=ipRadioStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1AIS=e1t1AIS, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, vlanPortmap=vlanPortmap, loopbacks=loopbacks, modemStandard=modemStandard, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, modemErroredBlock=modemErroredBlock, ethTXBroadcasts=ethTXBroadcasts, licenseMask=licenseMask, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, vlanFid=vlanFid, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, description=description, modemSymbolRateTx=modemSymbolRateTx, radioTxMute=radioTxMute, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemIndex=modemIndex, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, modemCountTime=modemCountTime, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCTable=aTPCTable, modemInternalAGCgain=modemInternalAGCgain, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond)
