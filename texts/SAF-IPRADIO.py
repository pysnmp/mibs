...
NotificationType, MibIdentifier, Counter64, Integer32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Counter32, enterprises, Gauge32, Bits, NotificationType, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter64", "Integer32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Counter32", "enterprises", "Gauge32", "Bits", "NotificationType", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXPauseFrames=ethTXPauseFrames, radioDuplexShift=radioDuplexShift, modemCarrierOffset=modemCarrierOffset, description=description, modemStandard=modemStandard, radioLoopback=radioLoopback, atpcEnabled=atpcEnabled, product=product, modemErroredBlock=modemErroredBlock, ethRXByteCounterLow=ethRXByteCounterLow, atpcIndex=atpcIndex, ethRXMulticasts=ethRXMulticasts, pointToPoint=pointToPoint, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, modemModulation=modemModulation, modemInternalAGCgain=modemInternalAGCgain, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, modemACMethernetCapacity=modemACMethernetCapacity, modemStatistics=modemStatistics, ethGFPDropedFrames=ethGFPDropedFrames, radioTxMute=radioTxMute, aTPCTable=aTPCTable, radioSide=radioSide, modemACMmodulationMax=modemACMmodulationMax, e1t1ChannelNr=e1t1ChannelNr, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, restartcpu=restartcpu, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, licenseMask=licenseMask, ipRadio=ipRadio, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, modemSymbolRateRx=modemSymbolRateRx, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBandwith=modemBandwith, modemRadialMSE=modemRadialMSE, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, writeConfig=writeConfig, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, safip=safip, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatTable=e1t1StatTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, ethRXCodeErrors=ethRXCodeErrors, vlanRowStatus=vlanRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, e1t1StatEntry=e1t1StatEntry, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, modemACMengine=modemACMengine, modemAcqStatus=modemAcqStatus, localIp=localIp, tehnika=tehnika, hostname=hostname, ethTXControlFrames=ethTXControlFrames, ethTXUnderruns=ethTXUnderruns, ethTXDones=ethTXDones, e1t1LOS=e1t1LOS, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCountTime=modemCountTime, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTable=radioTable, ethQOSTXFrames=ethQOSTXFrames, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMulticasts=ethTXMulticasts, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, remoteIp=remoteIp, ethTXCollisions=ethTXCollisions, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIpMask=localIpMask, radioEntry=radioEntry, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, vlanFid=vlanFid, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, modemTable=modemTable, ethTXByteCounterHi=ethTXByteCounterHi, saf=saf, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, radioTxPower=radioTxPower, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXGiants=ethTXGiants)
