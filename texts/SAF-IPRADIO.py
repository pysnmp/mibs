...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:08:44 2024
...
Counter32, IpAddress, ObjectIdentity, MibIdentifier, Unsigned32, NotificationType, Counter64, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, enterprises, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "ObjectIdentity", "MibIdentifier", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "enterprises", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXDropped=ethQOSTXDropped, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCollisions=ethTXCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, microwaveRadio=microwaveRadio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBroadcasts=ethTXBroadcasts, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, hostname=hostname, ethTXLateCollisions=ethTXLateCollisions, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, vlanCfgStat=vlanCfgStat, radioIndex=radioIndex, atpcIndex=atpcIndex, modemACMmodulationMax=modemACMmodulationMax, radioGenStatus=radioGenStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, atpcEnabled=atpcEnabled, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, product=product, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUptime=modemUptime, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUnavailtime=modemUnavailtime, ethRXPauseFrames=ethRXPauseFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, description=description, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, modemStatistics=modemStatistics, modemRowStatus=modemRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, licenseMask=licenseMask, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, localIpMask=localIpMask, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTable=radioTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, vlanFid=vlanFid, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanTable=vlanTable, ipRadioStat=ipRadioStat, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, vlanEntry=vlanEntry, modemACMengine=modemACMengine, modemIndex=modemIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, ethTXUnderruns=ethTXUnderruns, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, ethTXGiants=ethTXGiants, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopbacks=loopbacks, modemACMethernetCapacity=modemACMethernetCapacity, modemAcqStatus=modemAcqStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortType=vlanPortType, ethTXDones=ethTXDones, remoteIp=remoteIp, radioTxFrequency=radioTxFrequency, safip=safip, ethRXDvEvent=ethRXDvEvent, localIp=localIp, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, vlanNumber=vlanNumber, radioSide=radioSide, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, radioRxLevel=radioRxLevel, ethQOSTXFrames=ethQOSTXFrames, license=license, saf=saf, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, ethRXControlFrames=ethRXControlFrames, radioTxMute=radioTxMute, modemCountTime=modemCountTime)
