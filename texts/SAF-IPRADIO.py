...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:46:20 2023
...
ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, TimeTicks, Gauge32, MibIdentifier, Counter64, Counter32, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "TimeTicks", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIp=localIp, radioGenStatus=radioGenStatus, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, modemE1T1Channels=modemE1T1Channels, e1t1LOS=e1t1LOS, modemInternalAGCgain=modemInternalAGCgain, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, ipRadioStat=ipRadioStat, modemSymbolRateRx=modemSymbolRateRx, aTPCEntry=aTPCEntry, loopback_tributary_mask=loopback_tributary_mask, ethRXTruncatedFrames=ethRXTruncatedFrames, vlansEnabled=vlansEnabled, description=description, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfg=ipRadioCfg, vlanEntry=vlanEntry, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, radioTxFrequency=radioTxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, writeConfig=writeConfig, e1t1StatTable=e1t1StatTable, radioTxMute=radioTxMute, vlanFid=vlanFid, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, modemUptime=modemUptime, modemACMmodulationMin=modemACMmodulationMin, modemStatistics=modemStatistics, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, ethQOSTXDropped=ethQOSTXDropped, modemACMethernetCapacity=modemACMethernetCapacity, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, ethTXMulticasts=ethTXMulticasts, ethRXLongEvents=ethRXLongEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMengine=modemACMengine, modemModulation=modemModulation, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateTx=modemSymbolRateTx, localIpMask=localIpMask, vlanPortmap=vlanPortmap, vlanNumber=vlanNumber, radioTxPower=radioTxPower, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, modemStandard=modemStandard, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortType=vlanPortType, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, e1t1ChannelNr=e1t1ChannelNr, ipRadioMgmt=ipRadioMgmt, ethRXMulticasts=ethRXMulticasts, ethRXControlFrames=ethRXControlFrames, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, radioRxLevel=radioRxLevel, modemIndex=modemIndex, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadio=ipRadio, license=license, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, modemTable=modemTable, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxFrequency=radioRxFrequency, radioLoopback=radioLoopback, modemAcqStatus=modemAcqStatus, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCodeErrors=ethRXCodeErrors, sysTemperature=sysTemperature, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEntry=modemEntry, ipRadioStatEth=ipRadioStatEth, atpcIndex=atpcIndex, e1t1StatEntry=e1t1StatEntry, licenseMask=licenseMask, radioEntry=radioEntry, atpcEnabled=atpcEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXVlanTags=ethTXVlanTags, e1t1AIS=e1t1AIS, modemUnavailtime=modemUnavailtime, vlanTable=vlanTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterLow=ethRXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecond=modemErroredSecond, ethTXGiants=ethTXGiants, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethTXLateCollisions=ethTXLateCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, product=product, safip=safip, microwaveRadio=microwaveRadio, ethTXControlFrames=ethTXControlFrames, radioTable=radioTable, modemLastAcqError=modemLastAcqError, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, hostname=hostname, ethRXDones=ethRXDones, loopbacks=loopbacks, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEthernetCapacity=modemEthernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber)
