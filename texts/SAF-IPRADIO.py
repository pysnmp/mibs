...
Gauge32, Integer32, IpAddress, Bits, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, NotificationType, ModuleIdentity, Counter64, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "IpAddress", "Bits", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "NotificationType", "ModuleIdentity", "Counter64", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, hostname=hostname, licenseUpdateStatus=licenseUpdateStatus, writeConfig=writeConfig, vlanPortType=vlanPortType, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlansEnabled=vlansEnabled, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemModulation=modemModulation, ethTXByteCounterLow=ethTXByteCounterLow, atpcEnabled=atpcEnabled, safip=safip, modemErroredBlock=modemErroredBlock, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, ethRXCodeErrors=ethRXCodeErrors, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, localIp=localIp, ethTXBroadcasts=ethTXBroadcasts, modemBandwith=modemBandwith, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, modemStandard=modemStandard, modemUnavailtime=modemUnavailtime, radioIndex=radioIndex, modemErroredSecond=modemErroredSecond, ipRadio=ipRadio, tehnika=tehnika, e1t1AIS=e1t1AIS, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemIndex=modemIndex, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterHi=ethTXByteCounterHi, modemE1T1Channels=modemE1T1Channels, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecondRatio=modemErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, vlanNumber=vlanNumber, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCollisions=ethTXCollisions, modemTable=modemTable, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXGiants=ethTXGiants, ethTXUnderruns=ethTXUnderruns, radioDuplexShift=radioDuplexShift, ethTXMaxCollisions=ethTXMaxCollisions, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, license=license, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, radioSide=radioSide, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, ethRXCRCErrors=ethRXCRCErrors, radioLoopback=radioLoopback, ethRXByteCounterHi=ethRXByteCounterHi, radioGenStatus=radioGenStatus, ethTXVlanTags=ethTXVlanTags, pointToPoint=pointToPoint, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, remoteIp=remoteIp, vlanFid=vlanFid, modemCarrierOffset=modemCarrierOffset, vlanTable=vlanTable, modemEntry=modemEntry, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, microwaveRadio=microwaveRadio, radioRxFrequency=radioRxFrequency, modemStatistics=modemStatistics, ethTXDones=ethTXDones, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfg=ipRadioCfg, description=description, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, modemACMethernetCapacity=modemACMethernetCapacity, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, vlanEntry=vlanEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, radioRxLevel=radioRxLevel, radioTxPower=radioTxPower, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopback_tributary_mask=loopback_tributary_mask, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, vlanCfgStat=vlanCfgStat, ipRadioStat=ipRadioStat, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXFrames=ethQOSTXFrames, product=product)
