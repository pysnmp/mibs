...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:27:59 2023
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Unsigned32, Counter32, ObjectIdentity, TimeTicks, enterprises, ModuleIdentity, Integer32, IpAddress, MibIdentifier, NotificationType, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "TimeTicks", "enterprises", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadio=ipRadio, modemRowStatus=modemRowStatus, modemErroredBlock=modemErroredBlock, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents, ethTXLateCollisions=ethTXLateCollisions, radioLoopback=radioLoopback, modemEntry=modemEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, product=product, radioRxLevel=radioRxLevel, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, licenseMask=licenseMask, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, localIp=localIp, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, modemInternalAGCgain=modemInternalAGCgain, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, vlanFid=vlanFid, modemErroredSecond=modemErroredSecond, pointToPoint=pointToPoint, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, modemStatistics=modemStatistics, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcEnabled=atpcEnabled, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, modemAcqStatus=modemAcqStatus, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTable=radioTable, saf=saf, vlansEnabled=vlansEnabled, modemLastAcqError=modemLastAcqError, modemE1T1Channels=modemE1T1Channels, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalCapacity=modemTotalCapacity, vlanPortType=vlanPortType, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, ethGFPDropedFrames=ethGFPDropedFrames, vlanCfgStat=vlanCfgStat, ethTXPauseFrames=ethTXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, e1t1AIS=e1t1AIS, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, vlanTable=vlanTable, modemCarrierOffset=modemCarrierOffset, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, ipRadioStatEth=ipRadioStatEth, ethRXMulticasts=ethRXMulticasts, vlanEntry=vlanEntry, radioRxFrequency=radioRxFrequency, modemRadialMSE=modemRadialMSE, tehnika=tehnika, radioTxMute=radioTxMute, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, writeConfig=writeConfig, loopbacks=loopbacks, localIpMask=localIpMask, ethRXByteCounterLow=ethRXByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, description=description, vlanNumber=vlanNumber, hostname=hostname, restartcpu=restartcpu, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, modemIndex=modemIndex, aTPCTable=aTPCTable, safip=safip, radioSide=radioSide, ethQOSTXDropped=ethQOSTXDropped, modemGeneralStatus=modemGeneralStatus, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, modemEthernetCapacity=modemEthernetCapacity, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, e1t1StatTable=e1t1StatTable, ethRXDones=ethRXDones, modemCountTime=modemCountTime, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1LOS=e1t1LOS, radioIndex=radioIndex, ethRXCodeErrors=ethRXCodeErrors)
