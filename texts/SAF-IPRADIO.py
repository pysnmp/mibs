...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:37:52 2023
...
Unsigned32, Counter64, Bits, MibIdentifier, Counter32, TimeTicks, ModuleIdentity, IpAddress, enterprises, NotificationType, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "Bits", "MibIdentifier", "Counter32", "TimeTicks", "ModuleIdentity", "IpAddress", "enterprises", "NotificationType", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemInternalAGCgain=modemInternalAGCgain, ethTXLateCollisions=ethTXLateCollisions, e1t1StatTable=e1t1StatTable, radioTxPower=radioTxPower, radioIndex=radioIndex, ethRXControlFrames=ethRXControlFrames, radioSide=radioSide, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, atpcEnabled=atpcEnabled, modemEntry=modemEntry, ipRadioStat=ipRadioStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, ipRadio=ipRadio, e1t1ChannelNr=e1t1ChannelNr, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, hostname=hostname, modemRadialMSE=modemRadialMSE, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCRCErrors=ethRXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, ethRXDvEvent=ethRXDvEvent, description=description, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, licenseMask=licenseMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, modemBandwith=modemBandwith, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEthernetCapacity=modemEthernetCapacity, modemStatistics=modemStatistics, modemErroredSecondRatio=modemErroredSecondRatio, radioDuplexShift=radioDuplexShift, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, localIp=localIp, restartcpu=restartcpu, radioTxMute=radioTxMute, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBroadcasts=ethTXBroadcasts, license=license, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDones=ethRXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxLevel=radioRxLevel, ethTXMulticasts=ethTXMulticasts, vlanCfgStat=vlanCfgStat, ethGFPDropedFrames=ethGFPDropedFrames, radioEntry=radioEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMin=modemACMmodulationMin, vlanPortType=vlanPortType, modemACMengine=modemACMengine, vlanEntry=vlanEntry, saf=saf, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, loopbacks=loopbacks, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLongEvents=ethRXLongEvents, remoteIp=remoteIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIpMask=localIpMask, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, tehnika=tehnika, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, ethQOSTXFrames=ethQOSTXFrames, modemTotalCapacity=modemTotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, vlansEnabled=vlansEnabled, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXDropped=ethQOSTXDropped, radioTable=radioTable, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, product=product, modemSymbolRateTx=modemSymbolRateTx, e1t1LOS=e1t1LOS, modemTable=modemTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStatEth=ipRadioStatEth, ipRadioMgmt=ipRadioMgmt, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, vlanFid=vlanFid, sysTemperature=sysTemperature, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, ethTXGiants=ethTXGiants, microwaveRadio=microwaveRadio, ipRadioCfg=ipRadioCfg, modemIndex=modemIndex, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateRx=modemSymbolRateRx)
