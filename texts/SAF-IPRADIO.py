...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:11:25 2024
...
Integer32, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, NotificationType, Counter32, Counter64, ModuleIdentity, iso, enterprises, Unsigned32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "NotificationType", "Counter32", "Counter64", "ModuleIdentity", "iso", "enterprises", "Unsigned32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, description=description, ipRadioCfgGeneral=ipRadioCfgGeneral, microwaveRadio=microwaveRadio, modemE1T1ChannelMask=modemE1T1ChannelMask, product=product, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, radioRxFrequency=radioRxFrequency, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUptime=modemUptime, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, remoteIp=remoteIp, modemACMengine=modemACMengine, ethTXCollisions=ethTXCollisions, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopbacks=loopbacks, licenseMask=licenseMask, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBroadcasts=ethTXBroadcasts, ethRXBroadcasts=ethRXBroadcasts, e1t1LOS=e1t1LOS, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, modemRowStatus=modemRowStatus, radioTxPower=radioTxPower, radioLoopback=radioLoopback, ethRXDones=ethRXDones, pointToPoint=pointToPoint, safip=safip, ipRadioCfg=ipRadioCfg, ipRadio=ipRadio, modemModulation=modemModulation, aTPCTable=aTPCTable, restartcpu=restartcpu, modemSymbolRateTx=modemSymbolRateTx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredBlock=modemErroredBlock, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatTable=e1t1StatTable, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDribleNibbles=ethRXDribleNibbles, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, ethRXDvEvent=ethRXDvEvent, ethTXUnderruns=ethTXUnderruns, localIp=localIp, modemBandwith=modemBandwith, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, vlanPortType=vlanPortType, ethTXControlFrames=ethTXControlFrames, tehnika=tehnika, ipRadioStatEth=ipRadioStatEth, modemIndex=modemIndex, radioTable=radioTable, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, ethTXPauseFrames=ethTXPauseFrames, aTPCEntry=aTPCEntry, localIpMask=localIpMask, modemAcqStatus=modemAcqStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, vlanFid=vlanFid, modemStandard=modemStandard, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredSecondRatio=modemErroredSecondRatio, ethTXGiants=ethTXGiants, ethTXMulticasts=ethTXMulticasts, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, vlansEnabled=vlansEnabled, e1t1StatEntry=e1t1StatEntry, vlanPortmap=vlanPortmap, ipRadioStat=ipRadioStat, ethTXByteCounterLow=ethTXByteCounterLow, vlanEntry=vlanEntry, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, sysTemperature=sysTemperature, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, radioRxLevel=radioRxLevel, saf=saf, vlanTable=vlanTable, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecond=modemErroredSecond, radioTxFrequency=radioTxFrequency, ethGFPCHECErrors=ethGFPCHECErrors, license=license, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXLateCollisions=ethTXLateCollisions, ethQOSTXDropped=ethQOSTXDropped, ethGFPFCSErrors=ethGFPFCSErrors, modemCarrierOffset=modemCarrierOffset, radioSide=radioSide, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped)
