...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:52:43 2022
...
iso, ObjectIdentity, NotificationType, MibIdentifier, NotificationType, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Unsigned32, enterprises, Counter64, Bits, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "NotificationType", "MibIdentifier", "NotificationType", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Unsigned32", "enterprises", "Counter64", "Bits", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxPower=radioTxPower, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, ethTXMulticasts=ethTXMulticasts, ethRXCodeErrors=ethRXCodeErrors, radioRxFrequency=radioRxFrequency, vlanPortType=vlanPortType, ethTXCollisions=ethTXCollisions, ethRXCRCErrors=ethRXCRCErrors, vlanPortmap=vlanPortmap, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXControlFrames=ethRXControlFrames, ipRadioMgmt=ipRadioMgmt, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMax=modemACMmodulationMax, radioTxFrequency=radioTxFrequency, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, licenseMask=licenseMask, radioDuplexShift=radioDuplexShift, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, remoteIp=remoteIp, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, radioIndex=radioIndex, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, ipRadioCfg=ipRadioCfg, ethTXBroadcasts=ethTXBroadcasts, vlanNumber=vlanNumber, ethRXDribleNibbles=ethRXDribleNibbles, tehnika=tehnika, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanFid=vlanFid, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, restartcpu=restartcpu, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, modemSymbolRateRx=modemSymbolRateRx, modemBandwith=modemBandwith, ipRadio=ipRadio, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXVlanTags=ethTXVlanTags, localIp=localIp, ethTXGiants=ethTXGiants, e1t1StatTable=e1t1StatTable, radioRxLevel=radioRxLevel, modemACMmodulationMin=modemACMmodulationMin, ethTXUnderruns=ethTXUnderruns, safip=safip, product=product, modemACMethernetCapacity=modemACMethernetCapacity, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, modemRadialMSE=modemRadialMSE, modemRowStatus=modemRowStatus, writeConfig=writeConfig, modemTotalBlockNumber=modemTotalBlockNumber, modemUptime=modemUptime, description=description, radioSide=radioSide, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, saf=saf, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, e1t1AIS=e1t1AIS, modemModulation=modemModulation, radioLoopback=radioLoopback, aTPCTable=aTPCTable, modemEntry=modemEntry, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDones=ethRXDones, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, ethTXMaxCollisions=ethTXMaxCollisions, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, ethRXByteCounterHi=ethRXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, loopbacks=loopbacks, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, license=license, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, modemStandard=modemStandard, radioEntry=radioEntry, hostname=hostname, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemACMengine=modemACMengine, vlanCfgStat=vlanCfgStat, atpcIndex=atpcIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, modemStatistics=modemStatistics, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow)
