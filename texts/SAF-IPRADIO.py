...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:34:24 2023
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, vlanPortType=vlanPortType, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, safip=safip, sysDateAndTime=sysDateAndTime, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, ipRadioCfg=ipRadioCfg, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, license=license, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemIndex=modemIndex, e1t1StatEntry=e1t1StatEntry, radioTable=radioTable, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMulticasts=ethTXMulticasts, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, remoteIp=remoteIp, radioIndex=radioIndex, ethTXControlFrames=ethTXControlFrames, modemModulation=modemModulation, radioTxPower=radioTxPower, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, aTPCEntry=aTPCEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, restartcpu=restartcpu, ipRadioStat=ipRadioStat, modemE1T1ChannelMask=modemE1T1ChannelMask, description=description, modemE1T1Channels=modemE1T1Channels, ethGFPFCSErrors=ethGFPFCSErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioSide=radioSide, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, modemStandard=modemStandard, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, writeConfig=writeConfig, modemTable=modemTable, radioRxFrequency=radioRxFrequency, radioTxMute=radioTxMute, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, saf=saf, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, localIpMask=localIpMask, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, pointToPoint=pointToPoint, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, loopbacks=loopbacks, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlansEnabled=vlansEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, product=product, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, vlanFid=vlanFid, ethTXByteCounterHi=ethTXByteCounterHi, modemUptime=modemUptime, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, modemGeneralStatus=modemGeneralStatus, hostname=hostname, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMengine=modemACMengine, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, modemBandwith=modemBandwith, ipRadioStatEth=ipRadioStatEth, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, modemCarrierOffset=modemCarrierOffset, modemErroredSecondRatio=modemErroredSecondRatio, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, modemLastAcqError=modemLastAcqError, e1t1ChannelNr=e1t1ChannelNr, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXDropped=ethQOSTXDropped, modemTotalCapacity=modemTotalCapacity, ethRXPauseFrames=ethRXPauseFrames)
