...
# Produced by pysmi-1.1.12 at Wed Dec  4 17:59:28 2024
...
Integer32, iso, enterprises, Unsigned32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, ModuleIdentity, NotificationType, TimeTicks, IpAddress, MibIdentifier, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "enterprises", "Unsigned32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "ModuleIdentity", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioDuplexShift=radioDuplexShift, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, loopback_tributary_mask=loopback_tributary_mask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, ethTXUnderruns=ethTXUnderruns, ethTXMulticasts=ethTXMulticasts, modemEntry=modemEntry, ipRadio=ipRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, safip=safip, modemRowStatus=modemRowStatus, ethRXCRCErrors=ethRXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, modemE1T1Channels=modemE1T1Channels, loopbacks=loopbacks, modemACMmodulationMax=modemACMmodulationMax, product=product, modemEthernetCapacity=modemEthernetCapacity, modemLastAcqError=modemLastAcqError, e1t1AIS=e1t1AIS, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterHi=ethTXByteCounterHi, license=license, ethRXLongEvents=ethRXLongEvents, ethRXDones=ethRXDones, atpcIndex=atpcIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, microwaveRadio=microwaveRadio, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, ethRXBroadcasts=ethRXBroadcasts, ethRXDvEvent=ethRXDvEvent, tehnika=tehnika, vlanEntry=vlanEntry, ethTXDones=ethTXDones, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, vlanCfgStat=vlanCfgStat, vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, sysTemperature=sysTemperature, hostname=hostname, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, ipRadioCfg=ipRadioCfg, writeConfig=writeConfig, ethTXGiants=ethTXGiants, modemStatistics=modemStatistics, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXFrames=ethQOSTXFrames, radioEntry=radioEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, modemInternalAGCgain=modemInternalAGCgain, restartcpu=restartcpu, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPCHECErrors=ethGFPCHECErrors, saf=saf, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, e1t1LOS=e1t1LOS, localIpMask=localIpMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, modemTotalCapacity=modemTotalCapacity, ipRadioStat=ipRadioStat, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, aTPCTable=aTPCTable, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMmodulationMin=modemACMmodulationMin, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, radioIndex=radioIndex, licenseUpdateStatus=licenseUpdateStatus, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlansEnabled=vlansEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseMask=licenseMask, ethRXPauseFrames=ethRXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, radioRxFrequency=radioRxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, atpcEnabled=atpcEnabled, remoteIp=remoteIp, localIp=localIp, radioTable=radioTable, vlanNumber=vlanNumber, modemRadialMSE=modemRadialMSE, modemErroredSecond=modemErroredSecond, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, ipRadioCfgGeneral=ipRadioCfgGeneral, modemStandard=modemStandard, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, radioTxMute=radioTxMute, e1t1StatEntry=e1t1StatEntry)
