...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:10:27 2021
...
iso, TimeTicks, NotificationType, enterprises, IpAddress, ModuleIdentity, NotificationType, Gauge32, ObjectIdentity, Bits, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "enterprises", "IpAddress", "ModuleIdentity", "NotificationType", "Gauge32", "ObjectIdentity", "Bits", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, product=product, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, microwaveRadio=microwaveRadio, saf=saf, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemGeneralStatus=modemGeneralStatus, ethTXVlanTags=ethTXVlanTags, ethQOSTXFrames=ethQOSTXFrames, modemStatistics=modemStatistics, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXBroadcasts=ethRXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, localIpMask=localIpMask, ethTXByteCounterHi=ethTXByteCounterHi, radioDuplexShift=radioDuplexShift, ethTXPauseFrames=ethTXPauseFrames, atpcIndex=atpcIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortType=vlanPortType, description=description, modemE1T1Channels=modemE1T1Channels, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, ipRadioMgmt=ipRadioMgmt, ethRXCRCErrors=ethRXCRCErrors, ethRXControlFrames=ethRXControlFrames, radioTxPower=radioTxPower, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMin=modemACMmodulationMin, modemACMtotalCapacity=modemACMtotalCapacity, safip=safip, ipRadioStat=ipRadioStat, e1t1LOS=e1t1LOS, modemUptime=modemUptime, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, writeConfig=writeConfig, modemTable=modemTable, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCodeErrors=ethRXCodeErrors, modemUnavailtime=modemUnavailtime, ethTXUnderruns=ethTXUnderruns, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, vlansEnabled=vlansEnabled, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, ethRXLongEvents=ethRXLongEvents, modemRowStatus=modemRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, e1t1StatEntry=e1t1StatEntry, hostname=hostname, modemCarrierOffset=modemCarrierOffset, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, modemEntry=modemEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemStandard=modemStandard, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, e1t1StatTable=e1t1StatTable, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfg=ipRadioCfg, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, radioTable=radioTable, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, radioLoopback=radioLoopback, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, vlanEntry=vlanEntry, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, restartcpu=restartcpu, aTPCTable=aTPCTable, loopbacks=loopbacks, licenseMask=licenseMask, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBackpresEvents=ethTXBackpresEvents, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLastAcqError=modemLastAcqError, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, remoteIp=remoteIp, vlanTable=vlanTable, modemIndex=modemIndex, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors)
