...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:43:24 2021
...
Bits, ObjectIdentity, Counter64, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Integer32, NotificationType, IpAddress, Gauge32, ModuleIdentity, Unsigned32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter64", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Integer32", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatEntry=e1t1StatEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, aTPCEntry=aTPCEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, radioSide=radioSide, vlanPortType=vlanPortType, hostname=hostname, modemUptime=modemUptime, sysTemperature=sysTemperature, ipRadio=ipRadio, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, vlanEntry=vlanEntry, license=license, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfg=ipRadioCfg, ethTXMaxCollisions=ethTXMaxCollisions, modemRowStatus=modemRowStatus, modemAcqStatus=modemAcqStatus, ethGFPCHECErrors=ethGFPCHECErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalBlockNumber=modemTotalBlockNumber, atpcEnabled=atpcEnabled, radioLoopback=radioLoopback, safip=safip, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, restartcpu=restartcpu, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRadialMSE=modemRadialMSE, tehnika=tehnika, ethTXMulticasts=ethTXMulticasts, modemBandwith=modemBandwith, e1t1AIS=e1t1AIS, modemSymbolRateTx=modemSymbolRateTx, aTPCTable=aTPCTable, vlanNumber=vlanNumber, modemCarrierOffset=modemCarrierOffset, ethRXBroadcasts=ethRXBroadcasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemModulation=modemModulation, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, modemE1T1Channels=modemE1T1Channels, remoteIp=remoteIp, loopback_tributary_mask=loopback_tributary_mask, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethTXVlanTags=ethTXVlanTags, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXUnderruns=ethTXUnderruns, vlanCfgStat=vlanCfgStat, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, microwaveRadio=microwaveRadio, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanFid=vlanFid, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, writeConfig=writeConfig, ethGFPFCSErrors=ethGFPFCSErrors, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, modemTable=modemTable, loopbacks=loopbacks, modemStatistics=modemStatistics, modemStandard=modemStandard, ipRadioStat=ipRadioStat, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, localIp=localIp, modemLastAcqError=modemLastAcqError, ipRadioStatEth=ipRadioStatEth, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, description=description, product=product, radioTable=radioTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, saf=saf, modemTotalCapacity=modemTotalCapacity, vlansEnabled=vlansEnabled, ethTXBroadcasts=ethTXBroadcasts, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, vlanTable=vlanTable, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCollisions=ethTXCollisions, ethRXDones=ethRXDones, radioTxPower=radioTxPower, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatTable=e1t1StatTable, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, vlanRowStatus=vlanRowStatus, modemCountTime=modemCountTime, atpcIndex=atpcIndex, modemInternalAGCgain=modemInternalAGCgain, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency)
