...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:11:30 2021
...
TimeTicks, Bits, iso, Unsigned32, enterprises, NotificationType, ModuleIdentity, IpAddress, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Integer32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "iso", "Unsigned32", "enterprises", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Integer32", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, radioTxMute=radioTxMute, modemTotalBlockNumber=modemTotalBlockNumber, modemLastAcqError=modemLastAcqError, vlanPortmap=vlanPortmap, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, localIp=localIp, radioSide=radioSide, vlanFid=vlanFid, radioTxFrequency=radioTxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, modemCountTime=modemCountTime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStatistics=modemStatistics, radioRxFrequency=radioRxFrequency, ethTXGiants=ethTXGiants, safip=safip, ipRadio=ipRadio, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, ipRadioCfg=ipRadioCfg, restartcpu=restartcpu, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, loopbacks=loopbacks, modemACMtotalCapacity=modemACMtotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr, modemErroredBlock=modemErroredBlock, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, microwaveRadio=microwaveRadio, atpcEnabled=atpcEnabled, radioLoopback=radioLoopback, radioRxLevel=radioRxLevel, ethRXDvEvent=ethRXDvEvent, radioGenStatus=radioGenStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, ethQOSTXDropped=ethQOSTXDropped, atpcIndex=atpcIndex, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXControlFrames=ethTXControlFrames, license=license, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, remoteIp=remoteIp, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMmodulationMax=modemACMmodulationMax, ethTXCollisions=ethTXCollisions, modemRowStatus=modemRowStatus, modemUptime=modemUptime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCEntry=aTPCEntry, modemACMmodulationMin=modemACMmodulationMin, ipRadioMgmt=ipRadioMgmt, modemRadialMSE=modemRadialMSE, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDribleNibbles=ethRXDribleNibbles, ethTXDones=ethTXDones, modemTable=modemTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, aTPCTable=aTPCTable, radioTable=radioTable, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseUpdateStatus=licenseUpdateStatus, description=description, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, ethGFPCHECErrors=ethGFPCHECErrors, modemModulation=modemModulation, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortType=vlanPortType, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, vlanTable=vlanTable, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCRCErrors=ethRXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXVlanTags=ethTXVlanTags, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioStatEth=ipRadioStatEth, ethTXLateCollisions=ethTXLateCollisions, sysTemperature=sysTemperature, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMaxCollisions=ethTXMaxCollisions, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, sysDateAndTime=sysDateAndTime, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, radioIndex=radioIndex, ethGFPDropedFrames=ethGFPDropedFrames, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, writeConfig=writeConfig, modemIndex=modemIndex, product=product, radioEntry=radioEntry)
