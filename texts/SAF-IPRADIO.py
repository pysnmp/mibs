...
Counter32, Unsigned32, IpAddress, NotificationType, Bits, MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ObjectIdentity, enterprises, Gauge32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "IpAddress", "NotificationType", "Bits", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ObjectIdentity", "enterprises", "Gauge32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", safip=safip, e1t1ChannelNr=e1t1ChannelNr, product=product, modemACMmodulationMin=modemACMmodulationMin, ethTXMulticasts=ethTXMulticasts, radioRxLevel=radioRxLevel, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortmap=vlanPortmap, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, e1t1AIS=e1t1AIS, vlanPortType=vlanPortType, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, radioGenStatus=radioGenStatus, loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, microwaveRadio=microwaveRadio, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTable=modemTable, aTPCEntry=aTPCEntry, ethRXCodeErrors=ethRXCodeErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, radioEntry=radioEntry, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, localIp=localIp, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, modemACMengine=modemACMengine, pointToPoint=pointToPoint, ipRadioStatEth=ipRadioStatEth, e1t1StatEntry=e1t1StatEntry, vlanCfgStat=vlanCfgStat, writeConfig=writeConfig, remoteIp=remoteIp, ethTXGiants=ethTXGiants, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, localIpMask=localIpMask, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, vlanFid=vlanFid, radioTable=radioTable, hostname=hostname, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, modemStatistics=modemStatistics, ethTXDones=ethTXDones, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPrevPktDropped=ethRXPrevPktDropped, saf=saf, radioLoopback=radioLoopback, ethRXControlFrames=ethRXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCRCErrors=ethTXCRCErrors, modemUnavailtime=modemUnavailtime, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, ethTXUnderruns=ethTXUnderruns, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemGeneralStatus=modemGeneralStatus, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalBlockNumber=modemTotalBlockNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfg=ipRadioCfg, radioSide=radioSide, modemModulation=modemModulation, ethRXDones=ethRXDones, modemBandwith=modemBandwith, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, atpcIndex=atpcIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, tehnika=tehnika, modemCarrierOffset=modemCarrierOffset, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, sysTemperature=sysTemperature, description=description, ipRadio=ipRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanRowStatus=vlanRowStatus, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled)
