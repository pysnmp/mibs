...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:44:23 2024
...
Bits, Counter64, Integer32, Gauge32, MibIdentifier, NotificationType, TimeTicks, enterprises, IpAddress, ObjectIdentity, Unsigned32, Counter32, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Integer32", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "enterprises", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCarrierOffset=modemCarrierOffset, sysTemperature=sysTemperature, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanFid=vlanFid, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, modemEntry=modemEntry, vlansEnabled=vlansEnabled, modemUptime=modemUptime, loopbacks=loopbacks, radioRxLevel=radioRxLevel, ethRXCodeErrors=ethRXCodeErrors, radioRxFrequency=radioRxFrequency, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethRXControlFrames=ethRXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLateCollisions=ethTXLateCollisions, e1t1AIS=e1t1AIS, modemInternalAGCgain=modemInternalAGCgain, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, ethRXCRCErrors=ethRXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecond=modemErroredSecond, product=product, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMengine=modemACMengine, licenseMask=licenseMask, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi, aTPCEntry=aTPCEntry, ethQOSTXDropped=ethQOSTXDropped, modemTable=modemTable, modemUnavailtime=modemUnavailtime, ethTXDones=ethTXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMaxCollisions=ethTXMaxCollisions, saf=saf, description=description, modemStatistics=modemStatistics, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLongEvents=ethRXLongEvents, hostname=hostname, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, loopback_tributary_mask=loopback_tributary_mask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemModulation=modemModulation, e1t1LOS=e1t1LOS, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredSecondRatio=modemErroredSecondRatio, radioGenStatus=radioGenStatus, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, vlanEntry=vlanEntry, modemE1T1Channels=modemE1T1Channels, radioDuplexShift=radioDuplexShift, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatTable=e1t1StatTable, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, radioTxFrequency=radioTxFrequency, ethRXDones=ethRXDones, modemEthernetCapacity=modemEthernetCapacity, atpcIndex=atpcIndex, safip=safip, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, license=license, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStat=ipRadioStat, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, atpcEnabled=atpcEnabled, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethTXMulticasts=ethTXMulticasts, modemCountTime=modemCountTime, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethRXMulticasts=ethRXMulticasts, ethRXPauseFrames=ethRXPauseFrames, modemRowStatus=modemRowStatus, tehnika=tehnika, radioTxMute=radioTxMute, writeConfig=writeConfig, radioEntry=radioEntry, localIpMask=localIpMask, pointToPoint=pointToPoint, modemBandwith=modemBandwith, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfg=ipRadioCfg, ipRadioMgmt=ipRadioMgmt, ethTXUnderruns=ethTXUnderruns, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanNumber=vlanNumber, localIp=localIp, modemACMmodulationMin=modemACMmodulationMin, modemTotalBlockNumber=modemTotalBlockNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, ipRadio=ipRadio, vlanTable=vlanTable, vlanPortmap=vlanPortmap, ethTXCRCErrors=ethTXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXGiants=ethTXGiants)
