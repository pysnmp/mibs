...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:50:26 2023
...
Gauge32, TimeTicks, iso, MibIdentifier, IpAddress, Counter32, NotificationType, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Bits, NotificationType, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "iso", "MibIdentifier", "IpAddress", "Counter32", "NotificationType", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Bits", "NotificationType", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioLoopback=radioLoopback, ethRXCRCErrors=ethRXCRCErrors, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, microwaveRadio=microwaveRadio, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, sysTemperature=sysTemperature, radioSide=radioSide, e1t1StatTable=e1t1StatTable, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, radioIndex=radioIndex, modemInternalAGCgain=modemInternalAGCgain, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcTxPowerCorrection=atpcTxPowerCorrection, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatEntry=e1t1StatEntry, saf=saf, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxLevel=radioRxLevel, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi, vlanCfgStat=vlanCfgStat, localIp=localIp, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDones=ethRXDones, ethTXCRCErrors=ethTXCRCErrors, modemACMengine=modemACMengine, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, modemBandwith=modemBandwith, ethGFPCHECErrors=ethGFPCHECErrors, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, ethTXPauseFrames=ethTXPauseFrames, hostname=hostname, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseMask=licenseMask, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, ipRadio=ipRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXDropped=ethQOSTXDropped, radioDuplexShift=radioDuplexShift, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, ipRadioCfg=ipRadioCfg, modemModulation=modemModulation, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, modemTable=modemTable, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, modemE1T1Channels=modemE1T1Channels, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, localIpMask=localIpMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredSecond=modemErroredSecond, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, aTPCTable=aTPCTable, description=description, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, remoteIp=remoteIp, ethTXControlFrames=ethTXControlFrames, modemSymbolRateRx=modemSymbolRateRx, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, radioTxPower=radioTxPower, radioEntry=radioEntry, writeConfig=writeConfig, ethRXBroadcasts=ethRXBroadcasts, loopbacks=loopbacks, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemGeneralStatus=modemGeneralStatus, vlanTable=vlanTable, license=license, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, safip=safip, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXFrames=ethQOSTXFrames, vlanEntry=vlanEntry, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, ipRadioMgmt=ipRadioMgmt, modemLDPCdecoderStress=modemLDPCdecoderStress, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterHi=ethRXByteCounterHi, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxMute=radioTxMute, product=product, radioTable=radioTable, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns)
