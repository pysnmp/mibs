...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:26:21 2024
...
Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, NotificationType, Counter32, ModuleIdentity, ObjectIdentity, Counter64, NotificationType, MibIdentifier, TimeTicks, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "NotificationType", "Counter32", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "TimeTicks", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", microwaveRadio=microwaveRadio, radioTxFrequency=radioTxFrequency, radioTxPower=radioTxPower, e1t1ChannelNr=e1t1ChannelNr, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStat=ipRadioStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, loopbacks=loopbacks, e1t1StatEntry=e1t1StatEntry, licenseMask=licenseMask, product=product, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStatistics=modemStatistics, writeConfig=writeConfig, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, modemStandard=modemStandard, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioSide=radioSide, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, modemUptime=modemUptime, vlanPortmap=vlanPortmap, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, atpcEnabled=atpcEnabled, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, loopback_tributary_mask=loopback_tributary_mask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, tehnika=tehnika, modemRowStatus=modemRowStatus, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, vlanTable=vlanTable, vlanEntry=vlanEntry, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, modemE1T1Channels=modemE1T1Channels, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, radioRxLevel=radioRxLevel, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, modemCountTime=modemCountTime, radioIndex=radioIndex, radioTable=radioTable, modemGeneralStatus=modemGeneralStatus, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, description=description, modemIndex=modemIndex, ethGFPDropedFrames=ethGFPDropedFrames, ethTXGiants=ethTXGiants, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSTXDropped=ethQOSTXDropped, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, e1t1LOS=e1t1LOS, sysDateAndTime=sysDateAndTime, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, license=license, atpcIndex=atpcIndex, modemACMtotalCapacity=modemACMtotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemModulation=modemModulation, modemACMethernetCapacity=modemACMethernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, remoteIp=remoteIp, vlanPortType=vlanPortType, modemSymbolRateRx=modemSymbolRateRx, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, ethRXControlFrames=ethRXControlFrames, ethRXPauseFrames=ethRXPauseFrames, modemACMengine=modemACMengine, ipRadio=ipRadio, radioTxMute=radioTxMute, ethGFPCHECErrors=ethGFPCHECErrors, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, localIp=localIp, pointToPoint=pointToPoint, radioLoopback=radioLoopback, sysTemperature=sysTemperature, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones)
