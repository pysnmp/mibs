...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:45:09 2024
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, NotificationType, Unsigned32, IpAddress, TimeTicks, iso, MibIdentifier, Integer32, Counter32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "NotificationType", "Unsigned32", "IpAddress", "TimeTicks", "iso", "MibIdentifier", "Integer32", "Counter32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", writeConfig=writeConfig, ethRXCodeErrors=ethRXCodeErrors, radioIndex=radioIndex, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMax=modemACMmodulationMax, vlanRowStatus=vlanRowStatus, ethRXDones=ethRXDones, ethRXMulticasts=ethRXMulticasts, tehnika=tehnika, localIp=localIp, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi, localIpMask=localIpMask, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, modemErroredBlock=modemErroredBlock, ethRXDribleNibbles=ethRXDribleNibbles, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, modemModulation=modemModulation, radioTxMute=radioTxMute, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, modemTable=modemTable, modemRowStatus=modemRowStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemRadialMSE=modemRadialMSE, aTPCTable=aTPCTable, vlanFid=vlanFid, ethTXBackpresEvents=ethTXBackpresEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStatistics=modemStatistics, e1t1AIS=e1t1AIS, ipRadio=ipRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, restartcpu=restartcpu, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, radioRxLevel=radioRxLevel, radioEntry=radioEntry, vlanPortmap=vlanPortmap, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, modemTotalCapacity=modemTotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, radioGenStatus=radioGenStatus, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, ethTXExcessiveDefers=ethTXExcessiveDefers, description=description, safip=safip, vlanNumber=vlanNumber, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, saf=saf, e1t1LOS=e1t1LOS, sysDateAndTime=sysDateAndTime, radioTable=radioTable, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEthernetCapacity=modemEthernetCapacity, pointToPoint=pointToPoint, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, modemE1T1Channels=modemE1T1Channels, product=product, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMin=modemACMmodulationMin, ethRXDvEvent=ethRXDvEvent, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateRx=modemSymbolRateRx, vlanEntry=vlanEntry, radioDuplexShift=radioDuplexShift, ethRXControlFrames=ethRXControlFrames, modemGeneralStatus=modemGeneralStatus, modemACMengine=modemACMengine, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, modemLastAcqError=modemLastAcqError, ethRXLongEvents=ethRXLongEvents, remoteIp=remoteIp, sysTemperature=sysTemperature, vlanPortType=vlanPortType, ethTXCRCErrors=ethTXCRCErrors, hostname=hostname, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, modemAcqStatus=modemAcqStatus, license=license, ethTXGiants=ethTXGiants, ethRXByteCounterLow=ethRXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, ethTXMaxCollisions=ethTXMaxCollisions)
