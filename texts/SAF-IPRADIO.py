...
# Produced by pysmi-1.1.12 at Wed Jun 26 13:39:07 2024
...
NotificationType, Integer32, IpAddress, Counter64, enterprises, ModuleIdentity, NotificationType, Counter32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, TimeTicks, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "Counter64", "enterprises", "ModuleIdentity", "NotificationType", "Counter32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "TimeTicks", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxMute=radioTxMute, vlanTable=vlanTable, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, modemACMengine=modemACMengine, e1t1StatEntry=e1t1StatEntry, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, ipRadioCfg=ipRadioCfg, ethRXCRCErrors=ethRXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateRx=modemSymbolRateRx, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, ethQOSTXDropped=ethQOSTXDropped, radioIndex=radioIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMulticasts=ethTXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, modemSymbolRateTx=modemSymbolRateTx, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxFrequency=radioRxFrequency, atpcEnabled=atpcEnabled, tehnika=tehnika, atpcTxPowerCorrection=atpcTxPowerCorrection, sysDateAndTime=sysDateAndTime, licenseUpdateStatus=licenseUpdateStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseMask=licenseMask, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, e1t1AIS=e1t1AIS, aTPCTable=aTPCTable, ethTXVlanTags=ethTXVlanTags, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, description=description, modemACMethernetCapacity=modemACMethernetCapacity, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXFrames=ethQOSTXFrames, loopback_tributary_mask=loopback_tributary_mask, saf=saf, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanFid=vlanFid, writeConfig=writeConfig, hostname=hostname, radioEntry=radioEntry, modemInternalAGCgain=modemInternalAGCgain, safip=safip, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatTable=e1t1StatTable, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadio=ipRadio, modemEntry=modemEntry, loopbacks=loopbacks, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioSide=radioSide, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, modemTable=modemTable, vlansEnabled=vlansEnabled, microwaveRadio=microwaveRadio, modemStatistics=modemStatistics, ethRXPauseFrames=ethRXPauseFrames, product=product, ethGFPDropedFrames=ethGFPDropedFrames, license=license, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXMulticasts=ethRXMulticasts, modemAcqStatus=modemAcqStatus, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, modemGeneralStatus=modemGeneralStatus, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, ethTXGiants=ethTXGiants, localIp=localIp, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUptime=modemUptime, vlanNumber=vlanNumber, vlanCfgStat=vlanCfgStat, ethTXLateCollisions=ethTXLateCollisions, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, modemRowStatus=modemRowStatus, restartcpu=restartcpu, modemModulation=modemModulation, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanEntry=vlanEntry)
