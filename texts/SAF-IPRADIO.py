...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:17:46 2021
...
Bits, NotificationType, ModuleIdentity, Counter32, enterprises, ObjectIdentity, Unsigned32, Integer32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Gauge32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ModuleIdentity", "Counter32", "enterprises", "ObjectIdentity", "Unsigned32", "Integer32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Gauge32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, modemACMmodulationMax=modemACMmodulationMax, modemTable=modemTable, ethRXTruncatedFrames=ethRXTruncatedFrames, radioSide=radioSide, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, loopbacks=loopbacks, modemIndex=modemIndex, vlanEntry=vlanEntry, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, saf=saf, atpcIndex=atpcIndex, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, e1t1AIS=e1t1AIS, ethQOSTXFrames=ethQOSTXFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlansEnabled=vlansEnabled, ipRadio=ipRadio, writeConfig=writeConfig, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, vlanFid=vlanFid, modemStandard=modemStandard, radioLoopback=radioLoopback, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanTable=vlanTable, modemStatistics=modemStatistics, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, modemACMengine=modemACMengine, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCodeErrors=ethRXCodeErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXLateCollisions=ethTXLateCollisions, vlanPortmap=vlanPortmap, modemErroredSecondRatio=modemErroredSecondRatio, description=description, modemACMmodulationMin=modemACMmodulationMin, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, licenseUpdateStatus=licenseUpdateStatus, vlanNumber=vlanNumber, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, modemRowStatus=modemRowStatus, ethTXCollisions=ethTXCollisions, modemRadialMSE=modemRadialMSE, hostname=hostname, licenseMask=licenseMask, ethRXControlFrames=ethRXControlFrames, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, sysDateAndTime=sysDateAndTime, radioIndex=radioIndex, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXVlanTags=ethTXVlanTags, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, product=product, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, aTPCEntry=aTPCEntry, microwaveRadio=microwaveRadio, ethTXMulticasts=ethTXMulticasts, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterLow=ethTXByteCounterLow, ethTXGiants=ethTXGiants, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTable=radioTable, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, ethRXDones=ethRXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatEntry=e1t1StatEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioMgmt=ipRadioMgmt, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalCapacity=modemTotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUnavailtime=modemUnavailtime, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, radioTxFrequency=radioTxFrequency, localIp=localIp, modemCountTime=modemCountTime, modemUptime=modemUptime, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, modemModulation=modemModulation, vlanPortType=vlanPortType, ethRXMulticasts=ethRXMulticasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, license=license, atpcEnabled=atpcEnabled)
