...
# Produced by pysmi-1.1.12 at Tue May 28 13:13:54 2024
...
iso, Unsigned32, IpAddress, TimeTicks, NotificationType, NotificationType, ModuleIdentity, Counter32, Integer32, ObjectIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "IpAddress", "TimeTicks", "NotificationType", "NotificationType", "ModuleIdentity", "Counter32", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, loopbacks=loopbacks, radioRxFrequency=radioRxFrequency, ipRadioStat=ipRadioStat, writeConfig=writeConfig, modemErroredSecond=modemErroredSecond, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXBroadcasts=ethRXBroadcasts, pointToPoint=pointToPoint, modemEntry=modemEntry, modemEthernetCapacity=modemEthernetCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioIndex=radioIndex, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCodeErrors=ethRXCodeErrors, ipRadio=ipRadio, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, radioTxFrequency=radioTxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, vlansEnabled=vlansEnabled, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemIndex=modemIndex, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, radioRxLevel=radioRxLevel, safip=safip, ethTXCollisions=ethTXCollisions, radioTxPower=radioTxPower, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, modemInternalAGCgain=modemInternalAGCgain, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, ethRXByteCounterHi=ethRXByteCounterHi, modemCarrierOffset=modemCarrierOffset, modemTable=modemTable, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTable=radioTable, microwaveRadio=microwaveRadio, ethGFPDropedFrames=ethGFPDropedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDones=ethRXDones, aTPCEntry=aTPCEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcIndex=atpcIndex, vlanFid=vlanFid, modemRadialMSE=modemRadialMSE, radioGenStatus=radioGenStatus, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, ethQOSTXFrames=ethQOSTXFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethTXDones=ethTXDones, description=description, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, product=product, restartcpu=restartcpu, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, vlanCfgStat=vlanCfgStat, e1t1ChannelNr=e1t1ChannelNr, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXUnderruns=ethTXUnderruns, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLongEvents=ethRXLongEvents, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, remoteIp=remoteIp, loopback_tributary_mask=loopback_tributary_mask, modemStandard=modemStandard, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, sysTemperature=sysTemperature, radioLoopback=radioLoopback, ethTXBackpresEvents=ethTXBackpresEvents, radioSide=radioSide, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, radioTxMute=radioTxMute, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortType=vlanPortType, modemSymbolRateRx=modemSymbolRateRx, ethRXControlFrames=ethRXControlFrames, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, modemACMmodulationMin=modemACMmodulationMin, modemRowStatus=modemRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, modemACMethernetCapacity=modemACMethernetCapacity, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, modemUnavailtime=modemUnavailtime, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, licenseUpdateStatus=licenseUpdateStatus, sysDateAndTime=sysDateAndTime, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, license=license, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanEntry=vlanEntry)
