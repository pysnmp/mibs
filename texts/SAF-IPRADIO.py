...
# Produced by pysmi-1.1.0 at Tue Nov 16 12:12:49 2021
...
Integer32, ObjectIdentity, Counter32, NotificationType, MibIdentifier, TimeTicks, NotificationType, enterprises, ModuleIdentity, Counter64, Unsigned32, Bits, IpAddress, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "MibIdentifier", "TimeTicks", "NotificationType", "enterprises", "ModuleIdentity", "Counter64", "Unsigned32", "Bits", "IpAddress", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStatistics=modemStatistics, modemTable=modemTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, vlansEnabled=vlansEnabled, localIp=localIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxPower=radioTxPower, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortmap=vlanPortmap, ethRXCodeErrors=ethRXCodeErrors, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUnavailtime=modemUnavailtime, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMulticasts=ethTXMulticasts, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, safip=safip, restartcpu=restartcpu, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, vlanRowStatus=vlanRowStatus, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXDropped=ethQOSTXDropped, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, ethTXByteCounterHi=ethTXByteCounterHi, radioRxLevel=radioRxLevel, product=product, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, atpcIndex=atpcIndex, modemStandard=modemStandard, ipRadio=ipRadio, modemErroredSecond=modemErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, radioSide=radioSide, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, aTPCEntry=aTPCEntry, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, ethRXCRCErrors=ethRXCRCErrors, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemAcqStatus=modemAcqStatus, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, modemRowStatus=modemRowStatus, radioEntry=radioEntry, loopbacks=loopbacks, licenseMask=licenseMask, radioTable=radioTable, e1t1StatEntry=e1t1StatEntry, radioIndex=radioIndex, vlanEntry=vlanEntry, ethTXDones=ethTXDones, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, e1t1ChannelNr=e1t1ChannelNr, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, licenseUpdateStatus=licenseUpdateStatus, ipRadioStat=ipRadioStat, ethTXLateCollisions=ethTXLateCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxMute=radioTxMute, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIpMask=localIpMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, description=description, modemEntry=modemEntry, ethTXGiants=ethTXGiants, modemBandwith=modemBandwith, atpcEnabled=atpcEnabled, modemACMengine=modemACMengine, ipRadioCfg=ipRadioCfg, license=license, radioGenStatus=radioGenStatus, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXFrames=ethQOSTXFrames, modemTotalCapacity=modemTotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateTx=modemSymbolRateTx, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, modemACMtotalCapacity=modemACMtotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemModulation=modemModulation, vlanNumber=vlanNumber, modemRadialMSE=modemRadialMSE, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXMulticasts=ethRXMulticasts, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, hostname=hostname, modemCarrierOffset=modemCarrierOffset, modemLastAcqError=modemLastAcqError)
