...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:06:09 2023
...
ObjectIdentity, Counter32, enterprises, NotificationType, ModuleIdentity, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Integer32, TimeTicks, NotificationType, Counter64, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "enterprises", "NotificationType", "ModuleIdentity", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Integer32", "TimeTicks", "NotificationType", "Counter64", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", localIp=localIp, radioLoopback=radioLoopback, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlansEnabled=vlansEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, modemStandard=modemStandard, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, radioDuplexShift=radioDuplexShift, atpcIndex=atpcIndex, safip=safip, radioTxPower=radioTxPower, ethGFPFCSErrors=ethGFPFCSErrors, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCTable=aTPCTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, ipRadio=ipRadio, e1t1StatEntry=e1t1StatEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, vlanEntry=vlanEntry, remoteIp=remoteIp, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, saf=saf, modemCarrierOffset=modemCarrierOffset, ethTXLateCollisions=ethTXLateCollisions, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, modemAcqStatus=modemAcqStatus, ethTXDones=ethTXDones, ipRadioMgmt=ipRadioMgmt, modemTotalCapacity=modemTotalCapacity, modemStatistics=modemStatistics, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMulticasts=ethTXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, ethRXPauseFrames=ethRXPauseFrames, tehnika=tehnika, modemModulation=modemModulation, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, hostname=hostname, license=license, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, product=product, loopbacks=loopbacks, radioTxMute=radioTxMute, radioGenStatus=radioGenStatus, modemLastAcqError=modemLastAcqError, ethRXDones=ethRXDones, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortmap=vlanPortmap, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanRowStatus=vlanRowStatus, radioRxFrequency=radioRxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, ethQOSTXDropped=ethQOSTXDropped, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioSide=radioSide, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, modemIndex=modemIndex, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBackpresEvents=ethTXBackpresEvents, modemGeneralStatus=modemGeneralStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, pointToPoint=pointToPoint, modemCountTime=modemCountTime, ethRXCodeErrors=ethRXCodeErrors, radioEntry=radioEntry, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, ethRXBroadcasts=ethRXBroadcasts, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, aTPCEntry=aTPCEntry, ethTXGiants=ethTXGiants, e1t1AIS=e1t1AIS, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRowStatus=modemRowStatus, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow)
