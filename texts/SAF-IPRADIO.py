...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:25:27 2023
...
ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Unsigned32, MibIdentifier, Counter64, NotificationType, Integer32, NotificationType, TimeTicks, Gauge32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Unsigned32", "MibIdentifier", "Counter64", "NotificationType", "Integer32", "NotificationType", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, ethRXLongEvents=ethRXLongEvents, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, microwaveRadio=microwaveRadio, localIpMask=localIpMask, radioTxMute=radioTxMute, ethGFPCHECErrors=ethGFPCHECErrors, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, pointToPoint=pointToPoint, loopback_tributary_mask=loopback_tributary_mask, radioTxPower=radioTxPower, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, atpcIndex=atpcIndex, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, modemModulation=modemModulation, modemCarrierOffset=modemCarrierOffset, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXPauseFrames=ethTXPauseFrames, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatTable=e1t1StatTable, modemACMethernetCapacity=modemACMethernetCapacity, licenseMask=licenseMask, ethRXDones=ethRXDones, ethTXMaxCollisions=ethTXMaxCollisions, ipRadio=ipRadio, ethGFPFCSErrors=ethGFPFCSErrors, vlanCfgStat=vlanCfgStat, ethTXByteCounterHi=ethTXByteCounterHi, restartcpu=restartcpu, modemEntry=modemEntry, ethTXUnderruns=ethTXUnderruns, modemIndex=modemIndex, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxFrequency=radioTxFrequency, tehnika=tehnika, licenseUpdateStatus=licenseUpdateStatus, product=product, ethRXDribleNibbles=ethRXDribleNibbles, writeConfig=writeConfig, modemACMengine=modemACMengine, radioEntry=radioEntry, ethTXDones=ethTXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxFrequency=radioRxFrequency, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, loopbacks=loopbacks, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, localIp=localIp, modemUptime=modemUptime, modemErroredSecondRatio=modemErroredSecondRatio, modemTable=modemTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, radioTable=radioTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStandard=modemStandard, remoteIp=remoteIp, ethTXVlanTags=ethTXVlanTags, ethRXDvEvent=ethRXDvEvent, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMax=modemACMmodulationMax, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, modemAcqStatus=modemAcqStatus, vlanEntry=vlanEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, modemEthernetCapacity=modemEthernetCapacity, license=license, modemErroredSecond=modemErroredSecond, sysTemperature=sysTemperature, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBandwith=modemBandwith, modemRadialMSE=modemRadialMSE, modemStatistics=modemStatistics, modemE1T1Channels=modemE1T1Channels, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, safip=safip, vlanTable=vlanTable, modemCountTime=modemCountTime, vlanNumber=vlanNumber, ethRXPauseFrames=ethRXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, saf=saf, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, ipRadioMgmt=ipRadioMgmt, radioSide=radioSide, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, radioLoopback=radioLoopback, ethRXPrevPktDropped=ethRXPrevPktDropped, modemUnavailtime=modemUnavailtime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, radioIndex=radioIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterLow=ethRXByteCounterLow)
