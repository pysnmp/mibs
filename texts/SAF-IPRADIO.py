...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:23:38 2024
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, enterprises, NotificationType, NotificationType, MibIdentifier, Counter32, IpAddress, ModuleIdentity, Counter64, ObjectIdentity, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "enterprises", "NotificationType", "NotificationType", "MibIdentifier", "Counter32", "IpAddress", "ModuleIdentity", "Counter64", "ObjectIdentity", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfg=ipRadioCfg, modemACMethernetCapacity=modemACMethernetCapacity, ethTXControlFrames=ethTXControlFrames, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMulticasts=ethTXMulticasts, radioEntry=radioEntry, loopback_tributary_mask=loopback_tributary_mask, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, tehnika=tehnika, ipRadio=ipRadio, modemACMengine=modemACMengine, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, vlanTable=vlanTable, modemSymbolRateRx=modemSymbolRateRx, radioLoopback=radioLoopback, modemRowStatus=modemRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, safip=safip, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCollisions=ethTXCollisions, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, localIpMask=localIpMask, e1t1StatEntry=e1t1StatEntry, microwaveRadio=microwaveRadio, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, modemErroredBlock=modemErroredBlock, radioIndex=radioIndex, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, description=description, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask, hostname=hostname, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcTxPowerCorrection=atpcTxPowerCorrection, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecond=modemErroredSecond, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCodeErrors=ethRXCodeErrors, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUptime=modemUptime, radioSide=radioSide, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLongEvents=ethRXLongEvents, restartcpu=restartcpu, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, modemRadialMSE=modemRadialMSE, ethRXDvEvent=ethRXDvEvent, radioGenStatus=radioGenStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, saf=saf, loopbacks=loopbacks, sysTemperature=sysTemperature, modemBandwith=modemBandwith, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, pointToPoint=pointToPoint, product=product, atpcEnabled=atpcEnabled, e1t1StatTable=e1t1StatTable, radioRxLevel=radioRxLevel, license=license, ethTXVlanTags=ethTXVlanTags, remoteIp=remoteIp, radioTxFrequency=radioTxFrequency, ethRXControlFrames=ethRXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStatistics=modemStatistics, ethTXByteCounterLow=ethTXByteCounterLow, radioRxFrequency=radioRxFrequency, vlanEntry=vlanEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, modemModulation=modemModulation, modemE1T1Channels=modemE1T1Channels, ethTXGiants=ethTXGiants, modemEntry=modemEntry, ipRadioMgmt=ipRadioMgmt, e1t1LOS=e1t1LOS, vlanFid=vlanFid, localIp=localIp)
