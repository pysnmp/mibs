...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:16:39 2024
...
ModuleIdentity, iso, Integer32, TimeTicks, Counter64, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter32, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Integer32", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter32", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredSecond=modemErroredSecond, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateRx=modemSymbolRateRx, ethTXLengthCheckErrors=ethTXLengthCheckErrors, license=license, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, writeConfig=writeConfig, tehnika=tehnika, modemIndex=modemIndex, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLongEvents=ethRXLongEvents, modemEntry=modemEntry, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, licenseUpdateStatus=licenseUpdateStatus, e1t1LOS=e1t1LOS, sysTemperature=sysTemperature, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTable=radioTable, loopback_tributary_mask=loopback_tributary_mask, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStatistics=modemStatistics, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, ethRXCodeErrors=ethRXCodeErrors, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, localIp=localIp, vlanCfgStat=vlanCfgStat, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, loopbacks=loopbacks, ethGFPCHECErrors=ethGFPCHECErrors, ethTXGiants=ethTXGiants, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxLevel=radioRxLevel, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, ethTXVlanTags=ethTXVlanTags, modemModulation=modemModulation, ethTXByteCounterLow=ethTXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, restartcpu=restartcpu, e1t1StatEntry=e1t1StatEntry, aTPCEntry=aTPCEntry, vlanFid=vlanFid, modemACMethernetCapacity=modemACMethernetCapacity, vlanEntry=vlanEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, radioIndex=radioIndex, atpcEnabled=atpcEnabled, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, localIpMask=localIpMask, ethTXMulticasts=ethTXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, microwaveRadio=microwaveRadio, modemRowStatus=modemRowStatus, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, aTPCTable=aTPCTable, radioLoopback=radioLoopback, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMin=modemACMmodulationMin, modemEthernetCapacity=modemEthernetCapacity, safip=safip, ethRXByteCounterLow=ethRXByteCounterLow, modemStandard=modemStandard, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, modemTable=modemTable, vlanTable=vlanTable, radioSide=radioSide, ethRXDribleNibbles=ethRXDribleNibbles, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, product=product, e1t1ChannelNr=e1t1ChannelNr, ipRadioMgmt=ipRadioMgmt, licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, ethRXDvEvent=ethRXDvEvent, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, saf=saf, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, hostname=hostname, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, modemACMengine=modemACMengine, modemUptime=modemUptime, ethTXByteCounterHi=ethTXByteCounterHi, modemE1T1Channels=modemE1T1Channels, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth)
