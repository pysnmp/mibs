...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStatistics=modemStatistics, modemACMmodulationMax=modemACMmodulationMax, modemBandwith=modemBandwith, ipRadioCfg=ipRadioCfg, loopback_tributary_mask=loopback_tributary_mask, radioIndex=radioIndex, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, modemACMtotalCapacity=modemACMtotalCapacity, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemGeneralStatus=modemGeneralStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, ethTXCRCErrors=ethTXCRCErrors, tehnika=tehnika, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxPower=radioTxPower, vlanCfgStat=vlanCfgStat, ethTXGiants=ethTXGiants, product=product, ethRXDvEvent=ethRXDvEvent, saf=saf, modemLastAcqError=modemLastAcqError, aTPCTable=aTPCTable, modemModulation=modemModulation, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBroadcasts=ethTXBroadcasts, ethTXCollisions=ethTXCollisions, writeConfig=writeConfig, aTPCEntry=aTPCEntry, atpcEnabled=atpcEnabled, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, vlanTable=vlanTable, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioMgmt=ipRadioMgmt, restartcpu=restartcpu, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, atpcIndex=atpcIndex, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, ipRadio=ipRadio, licenseMask=licenseMask, loopbacks=loopbacks, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIp=localIp, radioRxFrequency=radioRxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, safip=safip, modemErroredSecond=modemErroredSecond, modemStandard=modemStandard, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMengine=modemACMengine, vlanRowStatus=vlanRowStatus, hostname=hostname, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseUpdateStatus=licenseUpdateStatus, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, ethRXCodeErrors=ethRXCodeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXVlanTags=ethTXVlanTags, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, ethRXDones=ethRXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIpMask=localIpMask, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortmap=vlanPortmap, radioTxFrequency=radioTxFrequency, modemTable=modemTable, sysDateAndTime=sysDateAndTime, radioEntry=radioEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, modemCountTime=modemCountTime, radioSide=radioSide, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanFid=vlanFid, ethRXControlFrames=ethRXControlFrames, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, sysTemperature=sysTemperature, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, description=description, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDribleNibbles=ethRXDribleNibbles, modemEntry=modemEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, radioGenStatus=radioGenStatus, radioLoopback=radioLoopback, modemIndex=modemIndex, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMin=modemACMmodulationMin, license=license, modemEthernetCapacity=modemEthernetCapacity, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, vlanEntry=vlanEntry, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS)
