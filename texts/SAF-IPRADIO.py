...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:50:34 2023
...
Counter32, NotificationType, iso, ObjectIdentity, Counter64, Bits, Unsigned32, IpAddress, NotificationType, Gauge32, MibIdentifier, Integer32, enterprises, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "iso", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "IpAddress", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "enterprises", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, ipRadioMgmt=ipRadioMgmt, vlanPortmap=vlanPortmap, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, license=license, vlanCfgStat=vlanCfgStat, ethTXMaxCollisions=ethTXMaxCollisions, ethTXMulticasts=ethTXMulticasts, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, radioEntry=radioEntry, modemBandwith=modemBandwith, modemGeneralStatus=modemGeneralStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, vlanPortType=vlanPortType, ethRXByteCounterLow=ethRXByteCounterLow, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, remoteIp=remoteIp, description=description, licenseMask=licenseMask, modemRadialMSE=modemRadialMSE, modemSymbolRateTx=modemSymbolRateTx, ethTXCollisions=ethTXCollisions, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDropedFrames=ethGFPDropedFrames, radioGenStatus=radioGenStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIp=localIp, aTPCTable=aTPCTable, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, modemLDPCdecoderStress=modemLDPCdecoderStress, hostname=hostname, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, product=product, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, pointToPoint=pointToPoint, modemTable=modemTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalBlockNumber=modemTotalBlockNumber, vlanTable=vlanTable, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, radioTxPower=radioTxPower, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1Channels=modemE1T1Channels, radioDuplexShift=radioDuplexShift, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, radioIndex=radioIndex, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, safip=safip, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, e1t1AIS=e1t1AIS, loopbacks=loopbacks, ethTXGiants=ethTXGiants, modemStandard=modemStandard, modemUptime=modemUptime, vlanRowStatus=vlanRowStatus, modemCountTime=modemCountTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, modemSymbolRateRx=modemSymbolRateRx, modemRowStatus=modemRowStatus, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, e1t1StatTable=e1t1StatTable, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1StatEntry=e1t1StatEntry, saf=saf, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, licenseUpdateStatus=licenseUpdateStatus, modemAcqStatus=modemAcqStatus, ethTXDones=ethTXDones, modemTotalCapacity=modemTotalCapacity, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1LOS=e1t1LOS)
