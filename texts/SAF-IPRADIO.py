...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:31:32 2023
...
NotificationType, ObjectIdentity, MibIdentifier, Gauge32, Counter32, enterprises, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter64, Bits, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "Gauge32", "Counter32", "enterprises", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter64", "Bits", "TimeTicks", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMmodulationMin=modemACMmodulationMin, radioEntry=radioEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, vlanCfgStat=vlanCfgStat, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxPower=radioTxPower, vlanTable=vlanTable, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames, restartcpu=restartcpu, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioDuplexShift=radioDuplexShift, saf=saf, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, modemStatistics=modemStatistics, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTable=radioTable, ipRadioStatEth=ipRadioStatEth, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, localIp=localIp, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMax=modemACMmodulationMax, e1t1AIS=e1t1AIS, aTPCEntry=aTPCEntry, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, ethTXCollisions=ethTXCollisions, modemE1T1Channels=modemE1T1Channels, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat, ethRXDribleNibbles=ethRXDribleNibbles, hostname=hostname, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, ethRXLongEvents=ethRXLongEvents, modemIndex=modemIndex, ethTXLateCollisions=ethTXLateCollisions, ethTXPauseFrames=ethTXPauseFrames, description=description, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, modemAcqStatus=modemAcqStatus, modemACMethernetCapacity=modemACMethernetCapacity, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioIndex=radioIndex, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanNumber=vlanNumber, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemErroredBlock=modemErroredBlock, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, safip=safip, modemEthernetCapacity=modemEthernetCapacity, pointToPoint=pointToPoint, e1t1StatEntry=e1t1StatEntry, vlanFid=vlanFid, sysDateAndTime=sysDateAndTime, ethRXControlFrames=ethRXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, ipRadioCfg=ipRadioCfg, loopbacks=loopbacks, ipRadioMgmt=ipRadioMgmt, modemCarrierOffset=modemCarrierOffset, license=license, radioTxMute=radioTxMute, ipRadioCfgGeneral=ipRadioCfgGeneral, radioSide=radioSide, ethTXGiants=ethTXGiants, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, modemCountTime=modemCountTime, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXCodeErrors=ethRXCodeErrors, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, ethRXDvEvent=ethRXDvEvent, modemTable=modemTable, ethTXCRCErrors=ethTXCRCErrors, product=product, remoteIp=remoteIp, e1t1ChannelNr=e1t1ChannelNr, ethRXPauseFrames=ethRXPauseFrames, radioTxFrequency=radioTxFrequency, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, tehnika=tehnika, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, radioGenStatus=radioGenStatus, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, e1t1LOS=e1t1LOS, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames)
