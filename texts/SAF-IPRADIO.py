...
# Produced by pysmi-1.1.8 at Mon Jan 17 10:09:31 2022
...
Unsigned32, iso, Counter64, Gauge32, NotificationType, ModuleIdentity, MibIdentifier, TimeTicks, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ObjectIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter64", "Gauge32", "NotificationType", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ObjectIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXUnderruns=ethTXUnderruns, ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, vlansEnabled=vlansEnabled, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalCapacity=modemTotalCapacity, safip=safip, ethRXCRCErrors=ethRXCRCErrors, radioDuplexShift=radioDuplexShift, hostname=hostname, radioSide=radioSide, modemIndex=modemIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxMute=radioTxMute, restartcpu=restartcpu, description=description, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, modemSymbolRateTx=modemSymbolRateTx, writeConfig=writeConfig, modemStandard=modemStandard, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanRowStatus=vlanRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, ipRadio=ipRadio, modemACMengine=modemACMengine, modemEntry=modemEntry, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, modemRadialMSE=modemRadialMSE, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, modemEthernetCapacity=modemEthernetCapacity, saf=saf, modemAcqStatus=modemAcqStatus, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethTXPauseFrames=ethTXPauseFrames, tehnika=tehnika, remoteIp=remoteIp, vlanFid=vlanFid, atpcEnabled=atpcEnabled, modemACMmodulationMax=modemACMmodulationMax, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, localIpMask=localIpMask, radioIndex=radioIndex, ipRadioCfg=ipRadioCfg, radioTxPower=radioTxPower, radioGenStatus=radioGenStatus, modemErroredSecondRatio=modemErroredSecondRatio, modemStatistics=modemStatistics, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatTable=e1t1StatTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, modemCountTime=modemCountTime, modemACMtotalCapacity=modemACMtotalCapacity, vlanEntry=vlanEntry, vlanPortType=vlanPortType, radioTable=radioTable, modemTable=modemTable, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXVlanTags=ethTXVlanTags, modemACMethernetCapacity=modemACMethernetCapacity, radioLoopback=radioLoopback, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUnavailtime=modemUnavailtime, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, ipRadioCfgNetwork=ipRadioCfgNetwork, product=product, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanNumber=vlanNumber, sysDateAndTime=sysDateAndTime, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCollisions=ethTXCollisions, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, modemE1T1Channels=modemE1T1Channels, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, license=license, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, ethTXGiants=ethTXGiants, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, e1t1LOS=e1t1LOS, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStatEth=ipRadioStatEth, licenseMask=licenseMask, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, vlanTable=vlanTable, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanCfgStat=vlanCfgStat, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, ethRXCodeErrors=ethRXCodeErrors, loopbacks=loopbacks, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors)
