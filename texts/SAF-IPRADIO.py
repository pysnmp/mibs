...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:18:54 2022
...
Unsigned32, NotificationType, Integer32, Counter32, Bits, enterprises, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, IpAddress, Counter64, ObjectIdentity, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Integer32", "Counter32", "Bits", "enterprises", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "IpAddress", "Counter64", "ObjectIdentity", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, e1t1ChannelNr=e1t1ChannelNr, vlansEnabled=vlansEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, ethTXDones=ethTXDones, modemE1T1Channels=modemE1T1Channels, radioTxMute=radioTxMute, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, modemLastAcqError=modemLastAcqError, ethRXByteCounterLow=ethRXByteCounterLow, remoteIp=remoteIp, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, loopbacks=loopbacks, ethTXUnderruns=ethTXUnderruns, ipRadio=ipRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateRx=modemSymbolRateRx, modemRowStatus=modemRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, writeConfig=writeConfig, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, microwaveRadio=microwaveRadio, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, atpcIndex=atpcIndex, license=license, modemEntry=modemEntry, ethRXBroadcasts=ethRXBroadcasts, modemRadialMSE=modemRadialMSE, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, product=product, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, radioRxLevel=radioRxLevel, modemInternalAGCgain=modemInternalAGCgain, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, modemEthernetCapacity=modemEthernetCapacity, ethTXMulticasts=ethTXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMengine=modemACMengine, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, modemErroredBlock=modemErroredBlock, tehnika=tehnika, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterHi=ethRXByteCounterHi, radioIndex=radioIndex, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, radioGenStatus=radioGenStatus, restartcpu=restartcpu, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalCapacity=modemTotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ethQOSTXDropped=ethQOSTXDropped, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, aTPCEntry=aTPCEntry, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMaxCollisions=ethTXMaxCollisions, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTable=radioTable, radioDuplexShift=radioDuplexShift, e1t1AIS=e1t1AIS, modemStatistics=modemStatistics, localIp=localIp, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, modemUnavailtime=modemUnavailtime, description=description, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBandwith=modemBandwith, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg)
