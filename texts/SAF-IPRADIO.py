...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:08:28 2023
...
iso, NotificationType, Gauge32, ModuleIdentity, Unsigned32, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, Counter32, IpAddress, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "Counter32", "IpAddress", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcIndex=atpcIndex, aTPCTable=aTPCTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, loopbacks=loopbacks, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, ethTXUnderruns=ethTXUnderruns, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, remoteIp=remoteIp, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, sysDateAndTime=sysDateAndTime, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioRxFrequency=radioRxFrequency, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, ethTXMulticasts=ethTXMulticasts, radioEntry=radioEntry, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ipRadioStatEth=ipRadioStatEth, license=license, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, restartcpu=restartcpu, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, radioIndex=radioIndex, vlanPortmap=vlanPortmap, modemErroredSecond=modemErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfg=ipRadioCfg, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, description=description, ethQOSTXDropped=ethQOSTXDropped, modemErroredBlock=modemErroredBlock, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxMute=radioTxMute, product=product, modemEntry=modemEntry, loopback_tributary_mask=loopback_tributary_mask, ethTXDones=ethTXDones, radioRxLevel=radioRxLevel, modemStatistics=modemStatistics, writeConfig=writeConfig, radioTable=radioTable, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, radioGenStatus=radioGenStatus, safip=safip, ethRXLongEvents=ethRXLongEvents, ethTXControlFrames=ethTXControlFrames, vlanFid=vlanFid, modemSymbolRateRx=modemSymbolRateRx, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1Channels=modemE1T1Channels, radioSide=radioSide, ethGFPFCSErrors=ethGFPFCSErrors, vlanCfgStat=vlanCfgStat, ethRXDones=ethRXDones, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, modemRadialMSE=modemRadialMSE, licenseUpdateStatus=licenseUpdateStatus, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCarrierOffset=modemCarrierOffset, modemACMtotalCapacity=modemACMtotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, modemBandwith=modemBandwith, vlansEnabled=vlansEnabled, modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, ethTXCRCErrors=ethTXCRCErrors, vlanPortType=vlanPortType, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXPauseFrames=ethRXPauseFrames, radioLoopback=radioLoopback, e1t1StatTable=e1t1StatTable, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, modemInternalAGCgain=modemInternalAGCgain, ethGFPCHECErrors=ethGFPCHECErrors, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseMask=licenseMask, saf=saf, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTable=modemTable, radioTxPower=radioTxPower)
