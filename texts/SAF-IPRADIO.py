...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:25:22 2022
...
Integer32, Unsigned32, Gauge32, IpAddress, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, NotificationType, TimeTicks, Bits, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "NotificationType", "TimeTicks", "Bits", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1LOS=e1t1LOS, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, ethTXVlanTags=ethTXVlanTags, loopbacks=loopbacks, ipRadioStat=ipRadioStat, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxFrequency=radioRxFrequency, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, vlanPortType=vlanPortType, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalCapacity=modemTotalCapacity, modemUptime=modemUptime, vlansEnabled=vlansEnabled, modemE1T1Channels=modemE1T1Channels, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, aTPCEntry=aTPCEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, localIpMask=localIpMask, ethQOSTXDropped=ethQOSTXDropped, license=license, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, ipRadioCfgGeneral=ipRadioCfgGeneral, radioSide=radioSide, ipRadio=ipRadio, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, ethTXMulticasts=ethTXMulticasts, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, ethRXDvEvent=ethRXDvEvent, ethTXBackpresEvents=ethTXBackpresEvents, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTable=modemTable, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, ethTXDones=ethTXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBroadcasts=ethTXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, ethGFPDropedFrames=ethGFPDropedFrames, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, hostname=hostname, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, radioDuplexShift=radioDuplexShift, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, remoteIp=remoteIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXBroadcasts=ethRXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, radioTxPower=radioTxPower, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, modemIndex=modemIndex, loopback_tributary_mask=loopback_tributary_mask, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, vlanTable=vlanTable, radioEntry=radioEntry, description=description, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, tehnika=tehnika, ethTXGiants=ethTXGiants, modemRadialMSE=modemRadialMSE, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, radioTxMute=radioTxMute, ethTXLengthCheckErrors=ethTXLengthCheckErrors, restartcpu=restartcpu, ethRXByteCounterHi=ethRXByteCounterHi, vlanEntry=vlanEntry, vlanRowStatus=vlanRowStatus, ipRadioCfg=ipRadioCfg, safip=safip, modemCarrierOffset=modemCarrierOffset, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, modemCountTime=modemCountTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, saf=saf, radioTxFrequency=radioTxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemModulation=modemModulation, modemStandard=modemStandard, vlanPortmap=vlanPortmap, vlanFid=vlanFid, ethQOSTXFrames=ethQOSTXFrames)
