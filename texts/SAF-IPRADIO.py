...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:07:49 2024
...
Gauge32, NotificationType, ModuleIdentity, enterprises, Counter64, iso, MibIdentifier, TimeTicks, Bits, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ModuleIdentity", "enterprises", "Counter64", "iso", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", localIpMask=localIpMask, modemStatistics=modemStatistics, modemUnavailtime=modemUnavailtime, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, modemE1T1Channels=modemE1T1Channels, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, license=license, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, modemErroredBlock=modemErroredBlock, tehnika=tehnika, radioTxPower=radioTxPower, e1t1StatTable=e1t1StatTable, vlanEntry=vlanEntry, ethRXLongEvents=ethRXLongEvents, ethTXCRCErrors=ethTXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, e1t1ChannelNr=e1t1ChannelNr, product=product, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRowStatus=modemRowStatus, radioTable=radioTable, aTPCEntry=aTPCEntry, radioIndex=radioIndex, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, localIp=localIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, modemEntry=modemEntry, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, restartcpu=restartcpu, ethRXByteCounterLow=ethRXByteCounterLow, modemBandwith=modemBandwith, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, licenseMask=licenseMask, ethTXBackpresEvents=ethTXBackpresEvents, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, modemCarrierOffset=modemCarrierOffset, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadio=ipRadio, ipRadioMgmt=ipRadioMgmt, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMax=modemACMmodulationMax, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, atpcIndex=atpcIndex, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, pointToPoint=pointToPoint, e1t1LOS=e1t1LOS, ipRadioStat=ipRadioStat, writeConfig=writeConfig, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, modemInternalAGCgain=modemInternalAGCgain, radioSide=radioSide, radioEntry=radioEntry, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, safip=safip, saf=saf, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, hostname=hostname, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, remoteIp=remoteIp, loopbacks=loopbacks, vlanPortmap=vlanPortmap, description=description, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, radioGenStatus=radioGenStatus, vlanTable=vlanTable, modemStandard=modemStandard, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalCapacity=modemTotalCapacity, modemTable=modemTable, aTPCTable=aTPCTable, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXDones=ethTXDones, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, modemACMengine=modemACMengine, modemModulation=modemModulation)
