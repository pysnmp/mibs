...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:39:13 2022
...
NotificationType, Counter32, MibIdentifier, Counter64, TimeTicks, Bits, Unsigned32, IpAddress, Integer32, ModuleIdentity, iso, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "MibIdentifier", "Counter64", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity", "iso", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioIndex=radioIndex, ethTXUnderruns=ethTXUnderruns, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatTable=e1t1StatTable, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, modemACMengine=modemACMengine, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMulticasts=ethTXMulticasts, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, hostname=hostname, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortType=vlanPortType, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, radioTxFrequency=radioTxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanRowStatus=vlanRowStatus, ethTXCollisions=ethTXCollisions, modemRowStatus=modemRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, modemLastAcqError=modemLastAcqError, radioEntry=radioEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, radioTxPower=radioTxPower, ipRadioStat=ipRadioStat, ethTXControlFrames=ethTXControlFrames, tehnika=tehnika, license=license, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, licenseMask=licenseMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxMute=radioTxMute, modemStandard=modemStandard, safip=safip, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateRx=modemSymbolRateRx, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxFrequency=radioRxFrequency, atpcIndex=atpcIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLongEvents=ethRXLongEvents, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCRCErrors=ethRXCRCErrors, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredBlock=modemErroredBlock, modemCarrierOffset=modemCarrierOffset, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStatistics=modemStatistics, remoteIp=remoteIp, modemEntry=modemEntry, ethTXDones=ethTXDones, vlanCfgStat=vlanCfgStat, pointToPoint=pointToPoint, ethRXByteCounterLow=ethRXByteCounterLow, radioTable=radioTable, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, restartcpu=restartcpu, modemTotalBlockNumber=modemTotalBlockNumber, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, ethRXBroadcasts=ethRXBroadcasts, ethRXMulticasts=ethRXMulticasts, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, aTPCEntry=aTPCEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEthernetCapacity=modemEthernetCapacity, sysTemperature=sysTemperature, radioSide=radioSide, ethTXVlanTags=ethTXVlanTags, ethRXCodeErrors=ethRXCodeErrors, modemBandwith=modemBandwith, modemModulation=modemModulation, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, vlanTable=vlanTable, ipRadioMgmt=ipRadioMgmt, modemInternalAGCgain=modemInternalAGCgain, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, saf=saf, description=description, ipRadioCfg=ipRadioCfg, modemACMmodulationMax=modemACMmodulationMax, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCTable=aTPCTable, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, modemCountTime=modemCountTime, ipRadio=ipRadio, product=product, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin)
