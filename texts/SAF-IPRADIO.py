...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:07:36 2023
...
NotificationType, Integer32, TimeTicks, ObjectIdentity, Counter32, enterprises, NotificationType, Gauge32, IpAddress, Bits, ModuleIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "TimeTicks", "ObjectIdentity", "Counter32", "enterprises", "NotificationType", "Gauge32", "IpAddress", "Bits", "ModuleIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, ethTXByteCounterHi=ethTXByteCounterHi, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, radioTxMute=radioTxMute, licenseMask=licenseMask, loopback_tributary_mask=loopback_tributary_mask, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, product=product, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, remoteIp=remoteIp, modemEthernetCapacity=modemEthernetCapacity, aTPCEntry=aTPCEntry, vlanFid=vlanFid, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, ethTXExcessiveDefers=ethTXExcessiveDefers, radioEntry=radioEntry, ipRadioCfg=ipRadioCfg, ethQOSTXDropped=ethQOSTXDropped, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, radioIndex=radioIndex, modemRadialMSE=modemRadialMSE, modemErroredBlock=modemErroredBlock, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, modemModulation=modemModulation, ethTXMaxCollisions=ethTXMaxCollisions, ethTXPauseFrames=ethTXPauseFrames, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, e1t1ChannelNr=e1t1ChannelNr, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, microwaveRadio=microwaveRadio, ethTXCRCErrors=ethTXCRCErrors, radioTxFrequency=radioTxFrequency, hostname=hostname, ethTXBroadcasts=ethTXBroadcasts, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, modemInternalAGCgain=modemInternalAGCgain, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, modemStatistics=modemStatistics, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, license=license, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, ethTXVlanTags=ethTXVlanTags, sysTemperature=sysTemperature, atpcIndex=atpcIndex, ethTXUnderruns=ethTXUnderruns, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, pointToPoint=pointToPoint, saf=saf, ethRXBroadcasts=ethRXBroadcasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopbacks=loopbacks, e1t1StatEntry=e1t1StatEntry, vlanTable=vlanTable, ethRXByteCounterHi=ethRXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, restartcpu=restartcpu, modemIndex=modemIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStatEth=ipRadioStatEth, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, modemUptime=modemUptime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateTx=modemSymbolRateTx, atpcEnabled=atpcEnabled, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCTable=aTPCTable, ethRXPauseFrames=ethRXPauseFrames, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPFCSErrors=ethGFPFCSErrors, description=description, ethRXCRCErrors=ethRXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlansEnabled=vlansEnabled, modemEntry=modemEntry, ethTXCollisions=ethTXCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, writeConfig=writeConfig, radioGenStatus=radioGenStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, localIpMask=localIpMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanEntry=vlanEntry, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, ipRadio=ipRadio, radioRxFrequency=radioRxFrequency, ethRXLongEvents=ethRXLongEvents, radioTable=radioTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIp=localIp, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPrevPktDropped=ethRXPrevPktDropped)
