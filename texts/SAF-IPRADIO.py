...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:50:50 2024
...
NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Integer32, ModuleIdentity, enterprises, Unsigned32, IpAddress, ObjectIdentity, Counter32, TimeTicks, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Integer32", "ModuleIdentity", "enterprises", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter32", "TimeTicks", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, radioEntry=radioEntry, radioRxFrequency=radioRxFrequency, radioTable=radioTable, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, modemModulation=modemModulation, radioTxMute=radioTxMute, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, modemErroredBlock=modemErroredBlock, modemACMengine=modemACMengine, sysTemperature=sysTemperature, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, ipRadioStat=ipRadioStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortType=vlanPortType, ethRXDones=ethRXDones, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, ipRadio=ipRadio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCRCErrors=ethTXCRCErrors, ipRadioMgmt=ipRadioMgmt, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, modemE1T1ChannelMask=modemE1T1ChannelMask, restartcpu=restartcpu, e1t1LOS=e1t1LOS, ethTXDones=ethTXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanFid=vlanFid, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMin=modemACMmodulationMin, atpcEnabled=atpcEnabled, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, hostname=hostname, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ipRadioStatEth=ipRadioStatEth, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCEntry=aTPCEntry, localIp=localIp, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemIndex=modemIndex, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, radioTxPower=radioTxPower, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, tehnika=tehnika, remoteIp=remoteIp, vlanRowStatus=vlanRowStatus, product=product, vlanTable=vlanTable, ethTXMaxCollisions=ethTXMaxCollisions, ethTXUnderruns=ethTXUnderruns, modemBandwith=modemBandwith, radioIndex=radioIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, writeConfig=writeConfig, modemErroredSecond=modemErroredSecond, ethRXControlFrames=ethRXControlFrames, radioSide=radioSide, safip=safip, modemLastAcqError=modemLastAcqError, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, ethRXByteCounterHi=ethRXByteCounterHi, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, license=license, loopbacks=loopbacks, radioRxLevel=radioRxLevel, modemTotalBlockNumber=modemTotalBlockNumber, vlanNumber=vlanNumber, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, modemRadialMSE=modemRadialMSE, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, description=description, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, modemStatistics=modemStatistics, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, modemStandard=modemStandard, vlanPortmap=vlanPortmap, ethGFPCHECErrors=ethGFPCHECErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPauseFrames=ethRXPauseFrames, vlanCfgStat=vlanCfgStat, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateRx=modemSymbolRateRx, modemGeneralStatus=modemGeneralStatus, ethTXControlFrames=ethTXControlFrames, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, saf=saf, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, modemRowStatus=modemRowStatus, licenseMask=licenseMask, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, ethTXVlanTags=ethTXVlanTags, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, atpcIndex=atpcIndex)
