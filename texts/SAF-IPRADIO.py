...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:48:52 2022
...
enterprises, MibIdentifier, Counter32, NotificationType, Integer32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, TimeTicks, Gauge32, Unsigned32, Bits, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Counter32", "NotificationType", "Integer32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "Bits", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, vlanEntry=vlanEntry, modemStatistics=modemStatistics, licenseMask=licenseMask, vlanPortmap=vlanPortmap, modemCarrierOffset=modemCarrierOffset, product=product, radioDuplexShift=radioDuplexShift, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTable=modemTable, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, modemUptime=modemUptime, ethRXControlFrames=ethRXControlFrames, modemEntry=modemEntry, modemStandard=modemStandard, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, radioLoopback=radioLoopback, modemEthernetCapacity=modemEthernetCapacity, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, pointToPoint=pointToPoint, modemBandwith=modemBandwith, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTable=radioTable, sysDateAndTime=sysDateAndTime, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, loopback_tributary_mask=loopback_tributary_mask, ethRXLongEvents=ethRXLongEvents, modemSymbolRateTx=modemSymbolRateTx, ipRadioMgmt=ipRadioMgmt, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, modemACMengine=modemACMengine, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, vlanCfgStat=vlanCfgStat, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, safip=safip, ipRadio=ipRadio, vlanPortType=vlanPortType, ethTXBroadcasts=ethTXBroadcasts, writeConfig=writeConfig, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxPower=radioTxPower, modemUnavailtime=modemUnavailtime, modemACMmodulationMax=modemACMmodulationMax, e1t1StatEntry=e1t1StatEntry, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, aTPCTable=aTPCTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, remoteIp=remoteIp, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1Channels=modemE1T1Channels, saf=saf, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, description=description, loopbacks=loopbacks, radioSide=radioSide, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, modemRowStatus=modemRowStatus, ethRXDvEvent=ethRXDvEvent, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, license=license, radioRxFrequency=radioRxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, tehnika=tehnika, modemIndex=modemIndex, ethTXMaxCollisions=ethTXMaxCollisions, hostname=hostname, modemModulation=modemModulation, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioStat=ipRadioStat, restartcpu=restartcpu, atpcIndex=atpcIndex, radioIndex=radioIndex, atpcEnabled=atpcEnabled, modemACMmodulationMin=modemACMmodulationMin, localIpMask=localIpMask)
