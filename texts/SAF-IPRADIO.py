...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:21:04 2023
...
Bits, Unsigned32, iso, Integer32, NotificationType, TimeTicks, IpAddress, Gauge32, MibIdentifier, ObjectIdentity, NotificationType, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Gauge32", "MibIdentifier", "ObjectIdentity", "NotificationType", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ethTXCRCErrors=ethTXCRCErrors, e1t1AIS=e1t1AIS, ethRXMulticasts=ethRXMulticasts, radioDuplexShift=radioDuplexShift, radioTxPower=radioTxPower, radioSide=radioSide, radioTable=radioTable, aTPCTable=aTPCTable, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, modemUptime=modemUptime, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, ethGFPCHECErrors=ethGFPCHECErrors, microwaveRadio=microwaveRadio, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemStatistics=modemStatistics, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, modemLastAcqError=modemLastAcqError, radioIndex=radioIndex, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, tehnika=tehnika, sysDateAndTime=sysDateAndTime, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, ethRXDones=ethRXDones, modemEntry=modemEntry, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUnavailtime=modemUnavailtime, description=description, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPauseFrames=ethRXPauseFrames, radioTxMute=radioTxMute, e1t1StatEntry=e1t1StatEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, saf=saf, vlanPortmap=vlanPortmap, ethTXPauseFrames=ethTXPauseFrames, safip=safip, ethTXCollisions=ethTXCollisions, license=license, licenseUpdateStatus=licenseUpdateStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, modemErroredSecond=modemErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, radioTxFrequency=radioTxFrequency, pointToPoint=pointToPoint, radioGenStatus=radioGenStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, ipRadioStat=ipRadioStat, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioMgmt=ipRadioMgmt, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, licenseMask=licenseMask, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, modemSymbolRateRx=modemSymbolRateRx, product=product, radioEntry=radioEntry, vlanFid=vlanFid, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, modemTable=modemTable, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, ipRadio=ipRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxFrequency=radioRxFrequency, radioLoopback=radioLoopback, modemAcqStatus=modemAcqStatus, modemErroredBlock=modemErroredBlock, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanTable=vlanTable, writeConfig=writeConfig, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanRowStatus=vlanRowStatus, hostname=hostname, localIp=localIp, modemTotalBlockNumber=modemTotalBlockNumber, sysTemperature=sysTemperature, loopbacks=loopbacks, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi)
