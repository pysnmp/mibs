...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:12:36 2021
...
ObjectIdentity, Gauge32, Integer32, NotificationType, IpAddress, NotificationType, Bits, enterprises, Counter32, iso, Unsigned32, Counter64, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Integer32", "NotificationType", "IpAddress", "NotificationType", "Bits", "enterprises", "Counter32", "iso", "Unsigned32", "Counter64", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLateCollisions=ethTXLateCollisions, modemErroredSecondRatio=modemErroredSecondRatio, modemTable=modemTable, ethGFPCHECErrors=ethGFPCHECErrors, description=description, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDones=ethRXDones, modemEntry=modemEntry, radioTxPower=radioTxPower, ethTXCRCErrors=ethTXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPDropedFrames=ethGFPDropedFrames, ethTXVlanTags=ethTXVlanTags, modemRowStatus=modemRowStatus, modemRadialMSE=modemRadialMSE, localIpMask=localIpMask, vlanRowStatus=vlanRowStatus, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, licenseUpdateStatus=licenseUpdateStatus, vlanEntry=vlanEntry, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, modemAcqStatus=modemAcqStatus, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStatEth=ipRadioStatEth, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, radioLoopback=radioLoopback, pointToPoint=pointToPoint, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethTXPauseFrames=ethTXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxMute=radioTxMute, ethGFPDelineationErrors=ethGFPDelineationErrors, license=license, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortmap=vlanPortmap, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcEnabled=atpcEnabled, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, ethRXLongEvents=ethRXLongEvents, radioEntry=radioEntry, product=product, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, e1t1ChannelNr=e1t1ChannelNr, sysDateAndTime=sysDateAndTime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, licenseMask=licenseMask, modemModulation=modemModulation, vlanNumber=vlanNumber, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, radioTxFrequency=radioTxFrequency, modemInternalAGCgain=modemInternalAGCgain, saf=saf, radioRxLevel=radioRxLevel, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, remoteIp=remoteIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUptime=modemUptime, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfg=ipRadioCfg, e1t1StatTable=e1t1StatTable, safip=safip, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, e1t1StatEntry=e1t1StatEntry, loopback_tributary_mask=loopback_tributary_mask, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterHi=ethTXByteCounterHi, modemStandard=modemStandard, modemACMtotalCapacity=modemACMtotalCapacity, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStatistics=modemStatistics, modemACMengine=modemACMengine, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, ethTXLengthCheckErrors=ethTXLengthCheckErrors, writeConfig=writeConfig, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanFid=vlanFid, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioSide=radioSide, microwaveRadio=microwaveRadio, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, modemUnavailtime=modemUnavailtime, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, modemErroredSecond=modemErroredSecond, e1t1AIS=e1t1AIS, hostname=hostname, localIp=localIp, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat)
