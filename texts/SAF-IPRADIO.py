...
# Produced by pysmi-1.1.12 at Fri Nov 22 16:48:19 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, NotificationType, iso, Unsigned32, enterprises, IpAddress, Counter32, TimeTicks, MibIdentifier, Gauge32, Integer32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "NotificationType", "iso", "Unsigned32", "enterprises", "IpAddress", "Counter32", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, pointToPoint=pointToPoint, radioDuplexShift=radioDuplexShift, modemModulation=modemModulation, localIpMask=localIpMask, modemErroredBlock=modemErroredBlock, vlanRowStatus=vlanRowStatus, aTPCTable=aTPCTable, radioGenStatus=radioGenStatus, radioTxPower=radioTxPower, licenseMask=licenseMask, radioRxFrequency=radioRxFrequency, vlanPortmap=vlanPortmap, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, e1t1LOS=e1t1LOS, ethTXLateCollisions=ethTXLateCollisions, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, description=description, ethRXCRCErrors=ethRXCRCErrors, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, ipRadio=ipRadio, modemStatistics=modemStatistics, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMax=modemACMmodulationMax, modemBandwith=modemBandwith, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, e1t1StatTable=e1t1StatTable, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, microwaveRadio=microwaveRadio, modemErroredSecondRatio=modemErroredSecondRatio, ethTXCollisions=ethTXCollisions, modemTable=modemTable, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEntry=modemEntry, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, vlansEnabled=vlansEnabled, product=product, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, modemTotalBlockNumber=modemTotalBlockNumber, vlanCfgStat=vlanCfgStat, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, radioRxLevel=radioRxLevel, aTPCEntry=aTPCEntry, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXPauseFrames=ethRXPauseFrames, modemStandard=modemStandard, remoteIp=remoteIp, ipRadioCfg=ipRadioCfg, ethTXDones=ethTXDones, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, ethGFPFCSErrors=ethGFPFCSErrors, writeConfig=writeConfig, modemACMengine=modemACMengine, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, sysTemperature=sysTemperature, radioEntry=radioEntry, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, ethQOSTXDropped=ethQOSTXDropped, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, vlanPortType=vlanPortType, restartcpu=restartcpu, safip=safip, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateRx=modemSymbolRateRx, ipRadioMgmt=ipRadioMgmt, modemIndex=modemIndex, ethRXControlFrames=ethRXControlFrames, radioTable=radioTable, ipRadioStatEth=ipRadioStatEth, e1t1ChannelNr=e1t1ChannelNr, modemACMtotalCapacity=modemACMtotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXVlanTags=ethTXVlanTags, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, radioIndex=radioIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, ethRXTruncatedFrames=ethRXTruncatedFrames, saf=saf, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp, vlanNumber=vlanNumber, ethTXUnderruns=ethTXUnderruns, loopbacks=loopbacks, sysDateAndTime=sysDateAndTime, license=license, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, hostname=hostname)
