...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:39:24 2024
...
ObjectIdentity, iso, Unsigned32, TimeTicks, ModuleIdentity, Gauge32, Integer32, Counter64, Bits, IpAddress, MibIdentifier, NotificationType, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Unsigned32", "TimeTicks", "ModuleIdentity", "Gauge32", "Integer32", "Counter64", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioMgmt=ipRadioMgmt, description=description, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, modemEthernetCapacity=modemEthernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, radioRxFrequency=radioRxFrequency, aTPCEntry=aTPCEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcEnabled=atpcEnabled, sysDateAndTime=sysDateAndTime, modemGeneralStatus=modemGeneralStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXMulticasts=ethRXMulticasts, sysTemperature=sysTemperature, localIpMask=localIpMask, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMax=modemACMmodulationMax, modemACMethernetCapacity=modemACMethernetCapacity, modemRowStatus=modemRowStatus, vlanRowStatus=vlanRowStatus, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatEntry=e1t1StatEntry, remoteIp=remoteIp, modemCountTime=modemCountTime, ethTXPauseFrames=ethTXPauseFrames, ethTXControlFrames=ethTXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, localIp=localIp, licenseMask=licenseMask, license=license, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, radioTable=radioTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxPower=radioTxPower, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, ethTXMulticasts=ethTXMulticasts, radioIndex=radioIndex, vlanPortType=vlanPortType, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemACMtotalCapacity=modemACMtotalCapacity, product=product, modemUnavailtime=modemUnavailtime, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemInternalAGCgain=modemInternalAGCgain, ethRXDribleNibbles=ethRXDribleNibbles, loopbacks=loopbacks, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, loopback_tributary_mask=loopback_tributary_mask, radioLoopback=radioLoopback, modemEntry=modemEntry, radioEntry=radioEntry, vlanTable=vlanTable, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, modemACMmodulationMin=modemACMmodulationMin, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanFid=vlanFid, radioRxLevel=radioRxLevel, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, modemE1T1Channels=modemE1T1Channels, ethRXDones=ethRXDones, writeConfig=writeConfig, safip=safip, microwaveRadio=microwaveRadio, atpcIndex=atpcIndex, e1t1LOS=e1t1LOS, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXBroadcasts=ethRXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemStandard=modemStandard, hostname=hostname, vlanNumber=vlanNumber, modemTable=modemTable, ethRXCRCErrors=ethRXCRCErrors, vlanPortmap=vlanPortmap, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, ethRXLongEvents=ethRXLongEvents, pointToPoint=pointToPoint, ethTXByteCounterHi=ethTXByteCounterHi, tehnika=tehnika, vlansEnabled=vlansEnabled, modemModulation=modemModulation, vlanEntry=vlanEntry, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, e1t1AIS=e1t1AIS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants)
