...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:13:18 2024
...
MibIdentifier, Gauge32, iso, ModuleIdentity, Counter64, TimeTicks, Unsigned32, NotificationType, ObjectIdentity, NotificationType, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "iso", "ModuleIdentity", "Counter64", "TimeTicks", "Unsigned32", "NotificationType", "ObjectIdentity", "NotificationType", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatEntry=e1t1StatEntry, product=product, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, modemIndex=modemIndex, localIp=localIp, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, radioSide=radioSide, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxPower=radioTxPower, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, ethRXPauseFrames=ethRXPauseFrames, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXControlFrames=ethRXControlFrames, vlanTable=vlanTable, ethTXPauseFrames=ethTXPauseFrames, ethTXCollisions=ethTXCollisions, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopbacks=loopbacks, aTPCTable=aTPCTable, pointToPoint=pointToPoint, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, ipRadio=ipRadio, radioRxFrequency=radioRxFrequency, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, ethRXMulticasts=ethRXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalCapacity=modemTotalCapacity, modemErroredSecond=modemErroredSecond, ethRXCRCErrors=ethRXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMengine=modemACMengine, modemStandard=modemStandard, vlanPortmap=vlanPortmap, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, safip=safip, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredBlock=modemErroredBlock, localIpMask=localIpMask, vlanFid=vlanFid, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, modemEntry=modemEntry, ethTXMulticasts=ethTXMulticasts, writeConfig=writeConfig, modemGeneralStatus=modemGeneralStatus, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortType=vlanPortType, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCodeErrors=ethRXCodeErrors, loopback_tributary_mask=loopback_tributary_mask, saf=saf, radioLoopback=radioLoopback, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, modemUptime=modemUptime, modemModulation=modemModulation, modemRowStatus=modemRowStatus, ipRadioCfg=ipRadioCfg, ethRXByteCounterLow=ethRXByteCounterLow, modemBandwith=modemBandwith, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, ethRXDones=ethRXDones, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, sysDateAndTime=sysDateAndTime, description=description, radioTxFrequency=radioTxFrequency, modemACMmodulationMin=modemACMmodulationMin, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, radioTable=radioTable, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, license=license, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, e1t1StatTable=e1t1StatTable, vlanRowStatus=vlanRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1ChannelNr=e1t1ChannelNr, ethTXGiants=ethTXGiants, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames)
