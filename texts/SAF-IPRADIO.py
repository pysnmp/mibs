...
# Produced by pysmi-1.1.12 at Wed Sep 18 06:50:42 2024
...
Bits, Counter64, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Gauge32, TimeTicks, NotificationType, Unsigned32, ObjectIdentity, iso, MibIdentifier, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Gauge32", "TimeTicks", "NotificationType", "Unsigned32", "ObjectIdentity", "iso", "MibIdentifier", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDones=ethRXDones, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, vlanEntry=vlanEntry, modemLastAcqError=modemLastAcqError, modemModulation=modemModulation, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEthernetCapacity=modemEthernetCapacity, ethRXPauseFrames=ethRXPauseFrames, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, radioLoopback=radioLoopback, ethTXMaxCollisions=ethTXMaxCollisions, license=license, modemSymbolRateTx=modemSymbolRateTx, product=product, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, ethRXBroadcasts=ethRXBroadcasts, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, pointToPoint=pointToPoint, modemSymbolRateRx=modemSymbolRateRx, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, modemTable=modemTable, modemAcqStatus=modemAcqStatus, atpcIndex=atpcIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, e1t1ChannelNr=e1t1ChannelNr, hostname=hostname, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBroadcasts=ethTXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterLow=ethRXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, licenseMask=licenseMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, restartcpu=restartcpu, description=description, radioTxMute=radioTxMute, saf=saf, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, modemStandard=modemStandard, ethQOSTXFrames=ethQOSTXFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, ethTXDones=ethTXDones, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, modemE1T1Channels=modemE1T1Channels, ethRXCRCErrors=ethRXCRCErrors, vlanCfgStat=vlanCfgStat, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, ethTXExcessiveDefers=ethTXExcessiveDefers, aTPCEntry=aTPCEntry, modemACMengine=modemACMengine, radioSide=radioSide, modemRowStatus=modemRowStatus, modemACMmodulationMin=modemACMmodulationMin, radioTxPower=radioTxPower, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, modemBandwith=modemBandwith, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, radioTxFrequency=radioTxFrequency, radioTable=radioTable, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, ethRXLongEvents=ethRXLongEvents, loopbacks=loopbacks, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, ethRXCodeErrors=ethRXCodeErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, localIpMask=localIpMask, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, ethTXByteCounterHi=ethTXByteCounterHi, atpcEnabled=atpcEnabled, ethRXByteCounterHi=ethRXByteCounterHi, ethTXUnderruns=ethTXUnderruns, ethTXWireByteCounterLow=ethTXWireByteCounterLow, safip=safip, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, vlanNumber=vlanNumber, ipRadio=ipRadio, modemIndex=modemIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, radioEntry=radioEntry, e1t1LOS=e1t1LOS, modemStatistics=modemStatistics, vlanPortmap=vlanPortmap, ethGFPCHECErrors=ethGFPCHECErrors, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, modemCarrierOffset=modemCarrierOffset, ipRadioStatEth=ipRadioStatEth, writeConfig=writeConfig)
