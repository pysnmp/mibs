...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:26:00 2022
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPFCSErrors=ethGFPFCSErrors, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, ethRXDones=ethRXDones, ethTXMaxCollisions=ethTXMaxCollisions, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, modemCountTime=modemCountTime, license=license, hostname=hostname, safip=safip, modemTable=modemTable, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMengine=modemACMengine, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, radioGenStatus=radioGenStatus, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, restartcpu=restartcpu, vlanFid=vlanFid, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, saf=saf, ethRXDvEvent=ethRXDvEvent, modemE1T1Channels=modemE1T1Channels, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, ethRXControlFrames=ethRXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemUptime=modemUptime, radioTxPower=radioTxPower, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXDones=ethTXDones, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, radioEntry=radioEntry, modemBandwith=modemBandwith, licenseUpdateStatus=licenseUpdateStatus, vlanPortType=vlanPortType, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDribleNibbles=ethRXDribleNibbles, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadio=ipRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, localIp=localIp, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, ethTXGiants=ethTXGiants, vlanNumber=vlanNumber, modemSymbolRateTx=modemSymbolRateTx, radioDuplexShift=radioDuplexShift, ipRadioStat=ipRadioStat, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioLoopback=radioLoopback, modemLastAcqError=modemLastAcqError, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, vlanEntry=vlanEntry, vlanPortmap=vlanPortmap, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBroadcasts=ethTXBroadcasts, remoteIp=remoteIp, modemGeneralStatus=modemGeneralStatus, e1t1LOS=e1t1LOS, modemEntry=modemEntry, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, modemRadialMSE=modemRadialMSE, modemCarrierOffset=modemCarrierOffset, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, radioTable=radioTable, modemModulation=modemModulation, modemACMethernetCapacity=modemACMethernetCapacity, aTPCEntry=aTPCEntry, modemStandard=modemStandard, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXCollisions=ethTXCollisions, e1t1ChannelNr=e1t1ChannelNr, description=description, modemSymbolRateRx=modemSymbolRateRx, modemUnavailtime=modemUnavailtime, licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCodeErrors=ethRXCodeErrors, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCRCErrors=ethTXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection)
