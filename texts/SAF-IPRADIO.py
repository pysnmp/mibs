...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:51:34 2022
...
IpAddress, Bits, Counter32, TimeTicks, ModuleIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, MibIdentifier, Integer32, Counter64, ObjectIdentity, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Counter32", "TimeTicks", "ModuleIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "MibIdentifier", "Integer32", "Counter64", "ObjectIdentity", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXGiants=ethTXGiants, ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, vlanPortmap=vlanPortmap, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, microwaveRadio=microwaveRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, radioLoopback=radioLoopback, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioDuplexShift=radioDuplexShift, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, saf=saf, e1t1LOS=e1t1LOS, radioTxFrequency=radioTxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, modemUptime=modemUptime, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, modemTotalBlockNumber=modemTotalBlockNumber, radioIndex=radioIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames, aTPCTable=aTPCTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, vlanEntry=vlanEntry, ipRadioStat=ipRadioStat, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXUnderruns=ethTXUnderruns, modemErroredSecond=modemErroredSecond, modemGeneralStatus=modemGeneralStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, description=description, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, aTPCEntry=aTPCEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, ethGFPDropedFrames=ethGFPDropedFrames, hostname=hostname, modemUnavailtime=modemUnavailtime, safip=safip, ipRadioCfg=ipRadioCfg, modemEthernetCapacity=modemEthernetCapacity, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethRXCodeErrors=ethRXCodeErrors, loopbacks=loopbacks, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, modemIndex=modemIndex, tehnika=tehnika, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, modemBandwith=modemBandwith, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, sysTemperature=sysTemperature, product=product, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTable=radioTable, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, ethTXDones=ethTXDones, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysDateAndTime=sysDateAndTime, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, radioEntry=radioEntry, ethTXByteCounterLow=ethTXByteCounterLow, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateTx=modemSymbolRateTx, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXDropped=ethQOSTXDropped, license=license, e1t1AIS=e1t1AIS, localIpMask=localIpMask, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIp=localIp, ipRadio=ipRadio, radioRxLevel=radioRxLevel, modemAcqStatus=modemAcqStatus, modemE1T1Channels=modemE1T1Channels, modemStatistics=modemStatistics, modemEntry=modemEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, modemTable=modemTable, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask)
