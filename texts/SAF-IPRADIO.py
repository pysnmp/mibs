...
Integer32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, IpAddress, NotificationType, MibIdentifier, TimeTicks, Counter64, enterprises, ObjectIdentity, Counter32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier", "TimeTicks", "Counter64", "enterprises", "ObjectIdentity", "Counter32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, modemACMengine=modemACMengine, modemBandwith=modemBandwith, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, product=product, aTPCTable=aTPCTable, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, tehnika=tehnika, sysTemperature=sysTemperature, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, loopbacks=loopbacks, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1LOS=e1t1LOS, radioRxFrequency=radioRxFrequency, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, modemStatistics=modemStatistics, license=license, modemGeneralStatus=modemGeneralStatus, saf=saf, ipRadioCfg=ipRadioCfg, modemRowStatus=modemRowStatus, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanNumber=vlanNumber, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemUnavailtime=modemUnavailtime, modemIndex=modemIndex, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, licenseUpdateStatus=licenseUpdateStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1Channels=modemE1T1Channels, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatTable=e1t1StatTable, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, modemModulation=modemModulation, aTPCEntry=aTPCEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcIndex=atpcIndex, description=description, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, writeConfig=writeConfig, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, restartcpu=restartcpu, ethTXMulticasts=ethTXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemUptime=modemUptime, modemErroredSecond=modemErroredSecond, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, modemInternalAGCgain=modemInternalAGCgain, localIpMask=localIpMask, radioTxPower=radioTxPower, vlanPortmap=vlanPortmap, radioTable=radioTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, ethTXUnderruns=ethTXUnderruns, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, safip=safip, ethRXDvEvent=ethRXDvEvent, radioSide=radioSide, vlanPortType=vlanPortType, localIp=localIp, ethTXCRCErrors=ethTXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterLow=ethTXByteCounterLow, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMin=modemACMmodulationMin, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, ethTXGiants=ethTXGiants, ipRadioStatEth=ipRadioStatEth, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLongEvents=ethRXLongEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, radioRxLevel=radioRxLevel, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, ethRXByteCounterLow=ethRXByteCounterLow, radioTxMute=radioTxMute, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, vlanFid=vlanFid, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, modemRadialMSE=modemRadialMSE, ipRadioStat=ipRadioStat, vlansEnabled=vlansEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredBlock=modemErroredBlock, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, radioIndex=radioIndex, ethGFPFCSErrors=ethGFPFCSErrors)
