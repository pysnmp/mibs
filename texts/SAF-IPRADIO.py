...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:33:20 2023
...
TimeTicks, NotificationType, Integer32, IpAddress, Bits, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Counter64, Gauge32, NotificationType, Unsigned32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Integer32", "IpAddress", "Bits", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Counter64", "Gauge32", "NotificationType", "Unsigned32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, vlanNumber=vlanNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStandard=modemStandard, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalCapacity=modemTotalCapacity, modemUptime=modemUptime, ethRXBroadcasts=ethRXBroadcasts, safip=safip, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDvEvent=ethRXDvEvent, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioEntry=radioEntry, radioGenStatus=radioGenStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, licenseUpdateStatus=licenseUpdateStatus, radioIndex=radioIndex, radioLoopback=radioLoopback, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCodeErrors=ethRXCodeErrors, radioTxMute=radioTxMute, modemUnavailtime=modemUnavailtime, ethTXCollisions=ethTXCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDones=ethRXDones, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanTable=vlanTable, ethTXCRCErrors=ethTXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, sysDateAndTime=sysDateAndTime, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXUnderruns=ethTXUnderruns, modemAcqStatus=modemAcqStatus, localIp=localIp, modemIndex=modemIndex, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, ethRXPauseFrames=ethRXPauseFrames, tehnika=tehnika, product=product, ipRadio=ipRadio, ethTXGiants=ethTXGiants, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry, radioTable=radioTable, radioTxPower=radioTxPower, hostname=hostname, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanFid=vlanFid, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, saf=saf, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, modemModulation=modemModulation, writeConfig=writeConfig, ethTXBackpresEvents=ethTXBackpresEvents, aTPCEntry=aTPCEntry, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMax=modemACMmodulationMax, radioTxFrequency=radioTxFrequency, vlansEnabled=vlansEnabled, modemTable=modemTable, vlanPortType=vlanPortType, vlanCfgStat=vlanCfgStat, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, modemRadialMSE=modemRadialMSE, e1t1StatEntry=e1t1StatEntry, ethTXControlFrames=ethTXControlFrames, remoteIp=remoteIp, radioDuplexShift=radioDuplexShift, modemEntry=modemEntry, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, license=license, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, vlanRowStatus=vlanRowStatus, microwaveRadio=microwaveRadio, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, radioRxLevel=radioRxLevel, e1t1StatTable=e1t1StatTable, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCRCErrors=ethRXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, loopbacks=loopbacks, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortmap=vlanPortmap, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMin=modemACMmodulationMin, description=description, pointToPoint=pointToPoint, sysTemperature=sysTemperature, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, modemACMengine=modemACMengine, radioSide=radioSide, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, ethTXMulticasts=ethTXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPFCSErrors=ethGFPFCSErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers)
