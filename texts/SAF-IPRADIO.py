...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:02:48 2024
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Frames=ethQOSRXQ1Frames, writeConfig=writeConfig, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, modemUptime=modemUptime, localIpMask=localIpMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDvEvent=ethRXDvEvent, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, modemGeneralStatus=modemGeneralStatus, modemStatistics=modemStatistics, ipRadioMgmt=ipRadioMgmt, modemLDPCdecoderStress=modemLDPCdecoderStress, description=description, ethTXWireByteCounterHi=ethTXWireByteCounterHi, saf=saf, hostname=hostname, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemTable=modemTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateTx=modemSymbolRateTx, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, vlansEnabled=vlansEnabled, vlanPortmap=vlanPortmap, modemSeverelyErroredSecond=modemSeverelyErroredSecond, license=license, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, safip=safip, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStandard=modemStandard, vlanFid=vlanFid, ethTXByteCounterHi=ethTXByteCounterHi, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, ethTXGiants=ethTXGiants, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, loopbacks=loopbacks, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames, e1t1LOS=e1t1LOS, radioTable=radioTable, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, product=product, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, radioLoopback=radioLoopback, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCTable=aTPCTable, tehnika=tehnika, radioTxFrequency=radioTxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, e1t1StatEntry=e1t1StatEntry, sysTemperature=sysTemperature, modemBandwith=modemBandwith, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ethTXDones=ethTXDones, modemTotalCapacity=modemTotalCapacity, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanRowStatus=vlanRowStatus, radioEntry=radioEntry, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, ipRadioStat=ipRadioStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, ethRXCodeErrors=ethRXCodeErrors, modemACMethernetCapacity=modemACMethernetCapacity, pointToPoint=pointToPoint, vlanTable=vlanTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDropedFrames=ethGFPDropedFrames, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfg=ipRadioCfg, localIp=localIp, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDones=ethRXDones, aTPCEntry=aTPCEntry, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, modemEntry=modemEntry)
