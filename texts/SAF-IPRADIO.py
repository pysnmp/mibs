...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:16:29 2023
...
NotificationType, ObjectIdentity, Counter64, Integer32, Counter32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, MibIdentifier, Bits, ModuleIdentity, Unsigned32, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Counter64", "Integer32", "Counter32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "MibIdentifier", "Bits", "ModuleIdentity", "Unsigned32", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcEnabled=atpcEnabled, modemStatistics=modemStatistics, radioTable=radioTable, vlanTable=vlanTable, modemACMmodulationMax=modemACMmodulationMax, microwaveRadio=microwaveRadio, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, restartcpu=restartcpu, safip=safip, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemLastAcqError=modemLastAcqError, localIp=localIp, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDvEvent=ethRXDvEvent, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXControlFrames=ethTXControlFrames, modemACMengine=modemACMengine, radioRxFrequency=radioRxFrequency, modemStandard=modemStandard, radioRxLevel=radioRxLevel, ethGFPDelineationErrors=ethGFPDelineationErrors, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, radioLoopback=radioLoopback, aTPCEntry=aTPCEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, description=description, radioGenStatus=radioGenStatus, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, saf=saf, radioTxFrequency=radioTxFrequency, ipRadio=ipRadio, ethTXMulticasts=ethTXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, aTPCTable=aTPCTable, ethRXDones=ethRXDones, ethQOSTXDropped=ethQOSTXDropped, ipRadioStat=ipRadioStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, ethTXPauseFrames=ethTXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, vlanCfgStat=vlanCfgStat, ethRXCodeErrors=ethRXCodeErrors, licenseMask=licenseMask, modemAcqStatus=modemAcqStatus, license=license, vlanEntry=vlanEntry, sysDateAndTime=sysDateAndTime, ethRXByteCounterLow=ethRXByteCounterLow, modemBandwith=modemBandwith, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, licenseUpdateStatus=licenseUpdateStatus, localIpMask=localIpMask, vlansEnabled=vlansEnabled, modemEthernetCapacity=modemEthernetCapacity, radioSide=radioSide, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, vlanFid=vlanFid, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopbacks=loopbacks, ethTXByteCounterHi=ethTXByteCounterHi, modemUptime=modemUptime, e1t1ChannelNr=e1t1ChannelNr, ethGFPCHECErrors=ethGFPCHECErrors, ethRXControlFrames=ethRXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, tehnika=tehnika, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, modemInternalAGCgain=modemInternalAGCgain, modemIndex=modemIndex, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, modemACMmodulationMin=modemACMmodulationMin, writeConfig=writeConfig, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemEntry=modemEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, loopback_tributary_mask=loopback_tributary_mask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, e1t1AIS=e1t1AIS, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex)
