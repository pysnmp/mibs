...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:00:15 2022
...
NotificationType, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, MibIdentifier, NotificationType, iso, Counter64, Gauge32, Unsigned32, ObjectIdentity, enterprises, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "iso", "Counter64", "Gauge32", "Unsigned32", "ObjectIdentity", "enterprises", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgNetwork=ipRadioCfgNetwork, remoteIp=remoteIp, e1t1AIS=e1t1AIS, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalCapacity=modemTotalCapacity, ethTXBroadcasts=ethTXBroadcasts, vlansEnabled=vlansEnabled, radioTable=radioTable, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, radioSide=radioSide, vlanTable=vlanTable, modemEthernetCapacity=modemEthernetCapacity, modemRowStatus=modemRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, ethTXControlFrames=ethTXControlFrames, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseMask=licenseMask, modemStatistics=modemStatistics, ipRadioCfg=ipRadioCfg, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, ethRXCodeErrors=ethRXCodeErrors, vlanEntry=vlanEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredBlock=modemErroredBlock, e1t1StatTable=e1t1StatTable, radioDuplexShift=radioDuplexShift, safip=safip, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, saf=saf, ipRadio=ipRadio, ipRadioStat=ipRadioStat, vlanPortmap=vlanPortmap, ipRadioStatEth=ipRadioStatEth, sysTemperature=sysTemperature, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemBandwith=modemBandwith, writeConfig=writeConfig, ethRXLongEvents=ethRXLongEvents, loopback_tributary_mask=loopback_tributary_mask, ethRXControlFrames=ethRXControlFrames, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, aTPCTable=aTPCTable, loopbacks=loopbacks, description=description, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Frames=ethQOSRXQ2Frames, microwaveRadio=microwaveRadio, ipRadioMgmt=ipRadioMgmt, modemLastAcqError=modemLastAcqError, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, e1t1LOS=e1t1LOS, restartcpu=restartcpu, modemCountTime=modemCountTime, ethQOSTXFrames=ethQOSTXFrames, license=license, ethRXDribleNibbles=ethRXDribleNibbles, product=product, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, modemCarrierOffset=modemCarrierOffset, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, modemErroredSecond=modemErroredSecond, radioRxLevel=radioRxLevel, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXDropped=ethQOSTXDropped, ethTXPauseFrames=ethTXPauseFrames, modemACMengine=modemACMengine, modemModulation=modemModulation, tehnika=tehnika, radioTxPower=radioTxPower, atpcIndex=atpcIndex, vlanRowStatus=vlanRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLateCollisions=ethTXLateCollisions, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, modemEntry=modemEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, localIpMask=localIpMask, modemACMmodulationMax=modemACMmodulationMax, ethRXDones=ethRXDones, licenseUpdateStatus=licenseUpdateStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemAcqStatus=modemAcqStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTable=modemTable, modemLDPCdecoderStress=modemLDPCdecoderStress, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, vlanNumber=vlanNumber, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRadialMSE=modemRadialMSE, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, modemStandard=modemStandard, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, ethRXByteCounterHi=ethRXByteCounterHi, aTPCEntry=aTPCEntry, modemACMmodulationMin=modemACMmodulationMin, vlanFid=vlanFid, ethTXMaxCollisions=ethTXMaxCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemIndex=modemIndex)
