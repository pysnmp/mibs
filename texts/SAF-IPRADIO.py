...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXExcessiveDefers=ethTXExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, modemUnavailtime=modemUnavailtime, ethTXPauseFrames=ethTXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, restartcpu=restartcpu, radioEntry=radioEntry, radioTxPower=radioTxPower, modemRowStatus=modemRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanFid=vlanFid, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, atpcEnabled=atpcEnabled, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, modemTotalCapacity=modemTotalCapacity, ethTXCollisions=ethTXCollisions, modemBandwith=modemBandwith, ethTXDones=ethTXDones, ethTXVlanTags=ethTXVlanTags, ethRXBroadcasts=ethRXBroadcasts, safip=safip, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1Channels=modemE1T1Channels, vlanNumber=vlanNumber, vlanPortmap=vlanPortmap, localIp=localIp, modemErroredSecondRatio=modemErroredSecondRatio, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredBlock=modemErroredBlock, modemSymbolRateRx=modemSymbolRateRx, e1t1StatTable=e1t1StatTable, ethQOSTXDropped=ethQOSTXDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCountTime=modemCountTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, ethTXLateCollisions=ethTXLateCollisions, radioRxFrequency=radioRxFrequency, vlanRowStatus=vlanRowStatus, licenseUpdateStatus=licenseUpdateStatus, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, aTPCTable=aTPCTable, ethRXDones=ethRXDones, radioSide=radioSide, ethGFPDropedFrames=ethGFPDropedFrames, modemUptime=modemUptime, atpcIndex=atpcIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTable=modemTable, e1t1LOS=e1t1LOS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXCRCErrors=ethTXCRCErrors, ethRXCRCErrors=ethRXCRCErrors, radioIndex=radioIndex, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, license=license, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, writeConfig=writeConfig, ipRadioMgmt=ipRadioMgmt, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, ethTXMaxCollisions=ethTXMaxCollisions, modemRadialMSE=modemRadialMSE, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, product=product, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortType=vlanPortType, modemIndex=modemIndex, description=description, ethTXBackpresEvents=ethTXBackpresEvents, tehnika=tehnika, ipRadio=ipRadio, hostname=hostname, modemStandard=modemStandard, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, vlanTable=vlanTable, radioTable=radioTable, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStatistics=modemStatistics, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, vlansEnabled=vlansEnabled, loopbacks=loopbacks, radioGenStatus=radioGenStatus, ethRXMulticasts=ethRXMulticasts, radioLoopback=radioLoopback, vlanEntry=vlanEntry, modemACMengine=modemACMengine, pointToPoint=pointToPoint)
