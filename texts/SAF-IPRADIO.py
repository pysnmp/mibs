...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:09:41 2022
...
Counter32, Integer32, NotificationType, NotificationType, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Unsigned32, IpAddress, iso, ObjectIdentity, enterprises, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "NotificationType", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "iso", "ObjectIdentity", "enterprises", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1ChannelNr=e1t1ChannelNr, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, modemACMmodulationMin=modemACMmodulationMin, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLateCollisions=ethTXLateCollisions, ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, modemACMengine=modemACMengine, radioGenStatus=radioGenStatus, atpcIndex=atpcIndex, ethGFPDropedFrames=ethGFPDropedFrames, sysTemperature=sysTemperature, product=product, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, safip=safip, ethRXCRCErrors=ethRXCRCErrors, radioLoopback=radioLoopback, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1LOS=e1t1LOS, ethTXCollisions=ethTXCollisions, ethTXCRCErrors=ethTXCRCErrors, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, modemUnavailtime=modemUnavailtime, localIpMask=localIpMask, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecond=modemErroredSecond, vlanPortType=vlanPortType, radioTxFrequency=radioTxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRadialMSE=modemRadialMSE, ethTXDones=ethTXDones, localIp=localIp, e1t1AIS=e1t1AIS, modemUptime=modemUptime, pointToPoint=pointToPoint, ethTXMulticasts=ethTXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioRxLevel=radioRxLevel, loopbacks=loopbacks, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, description=description, modemBandwith=modemBandwith, hostname=hostname, modemEntry=modemEntry, vlanRowStatus=vlanRowStatus, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXFrames=ethQOSTXFrames, ethRXControlFrames=ethRXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, modemACMmodulationMax=modemACMmodulationMax, vlanTable=vlanTable, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, e1t1StatTable=e1t1StatTable, modemTotalCapacity=modemTotalCapacity, ethRXPauseFrames=ethRXPauseFrames, vlanFid=vlanFid, modemE1T1Channels=modemE1T1Channels, radioTable=radioTable, radioSide=radioSide, writeConfig=writeConfig, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, vlanEntry=vlanEntry, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, modemIndex=modemIndex, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, atpcEnabled=atpcEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, saf=saf, license=license, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateTx=modemSymbolRateTx, e1t1StatEntry=e1t1StatEntry, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredBlock=modemErroredBlock, radioTxPower=radioTxPower, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, remoteIp=remoteIp, vlansEnabled=vlansEnabled, modemCarrierOffset=modemCarrierOffset)
