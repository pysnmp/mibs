...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:01:59 2024
...
Gauge32, enterprises, MibIdentifier, NotificationType, Integer32, ModuleIdentity, TimeTicks, Counter32, iso, Unsigned32, IpAddress, Counter64, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "NotificationType", "Integer32", "ModuleIdentity", "TimeTicks", "Counter32", "iso", "Unsigned32", "IpAddress", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", localIp=localIp, pointToPoint=pointToPoint, ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemBandwith=modemBandwith, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, e1t1StatTable=e1t1StatTable, ethQOSTXFrames=ethQOSTXFrames, microwaveRadio=microwaveRadio, vlanEntry=vlanEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, modemRowStatus=modemRowStatus, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, modemACMengine=modemACMengine, ethTXLateCollisions=ethTXLateCollisions, modemSymbolRateRx=modemSymbolRateRx, description=description, sysTemperature=sysTemperature, ethTXPauseFrames=ethTXPauseFrames, ethTXGiants=ethTXGiants, ethRXMulticasts=ethRXMulticasts, ethTXBroadcasts=ethTXBroadcasts, ethTXDones=ethTXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCRCErrors=ethRXCRCErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, safip=safip, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLastAcqError=modemLastAcqError, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, writeConfig=writeConfig, vlanRowStatus=vlanRowStatus, license=license, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, ethQOSTXDropped=ethQOSTXDropped, radioRxFrequency=radioRxFrequency, radioRxLevel=radioRxLevel, ethTXMulticasts=ethTXMulticasts, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, modemInternalAGCgain=modemInternalAGCgain, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, modemStandard=modemStandard, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopbacks=loopbacks, ipRadioStat=ipRadioStat, sysDateAndTime=sysDateAndTime, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, modemTotalCapacity=modemTotalCapacity, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, remoteIp=remoteIp, vlanPortmap=vlanPortmap, vlanPortType=vlanPortType, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, radioTable=radioTable, atpcIndex=atpcIndex, vlanCfgStat=vlanCfgStat, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, radioIndex=radioIndex, saf=saf, ipRadioMgmt=ipRadioMgmt, radioLoopback=radioLoopback, tehnika=tehnika, product=product, radioTxMute=radioTxMute, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, ipRadio=ipRadio, atpcEnabled=atpcEnabled, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, vlanTable=vlanTable, modemRadialMSE=modemRadialMSE, licenseUpdateStatus=licenseUpdateStatus, e1t1AIS=e1t1AIS, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, radioDuplexShift=radioDuplexShift, ethTXCRCErrors=ethTXCRCErrors, vlansEnabled=vlansEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemIndex=modemIndex, modemEntry=modemEntry, modemErroredSecond=modemErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecondRatio=modemErroredSecondRatio)
