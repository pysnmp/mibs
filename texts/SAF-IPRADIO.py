...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:14:45 2022
...
ObjectIdentity, ModuleIdentity, Gauge32, TimeTicks, Counter32, Bits, NotificationType, Counter64, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, iso, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter32", "Bits", "NotificationType", "Counter64", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "iso", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1LOS=e1t1LOS, modemRadialMSE=modemRadialMSE, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, radioDuplexShift=radioDuplexShift, ipRadioStatEth=ipRadioStatEth, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEntry=modemEntry, modemStatistics=modemStatistics, licenseMask=licenseMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, atpcEnabled=atpcEnabled, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemUnavailtime=modemUnavailtime, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, ethTXMulticasts=ethTXMulticasts, hostname=hostname, e1t1StatTable=e1t1StatTable, modemRowStatus=modemRowStatus, microwaveRadio=microwaveRadio, vlanPortmap=vlanPortmap, radioTxMute=radioTxMute, localIp=localIp, vlanRowStatus=vlanRowStatus, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, radioLoopback=radioLoopback, modemErroredBlock=modemErroredBlock, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, ethGFPCHECErrors=ethGFPCHECErrors, modemACMmodulationMin=modemACMmodulationMin, loopbacks=loopbacks, saf=saf, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTable=radioTable, ethRXPauseFrames=ethRXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1Channels=modemE1T1Channels, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLateCollisions=ethTXLateCollisions, license=license, radioIndex=radioIndex, ethTXCollisions=ethTXCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, product=product, localIpMask=localIpMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDones=ethRXDones, remoteIp=remoteIp, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, radioSide=radioSide, e1t1StatEntry=e1t1StatEntry, ethTXBroadcasts=ethTXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, modemIndex=modemIndex, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, modemE1T1ChannelMask=modemE1T1ChannelMask, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, vlanTable=vlanTable, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, modemTotalBlockNumber=modemTotalBlockNumber, radioEntry=radioEntry, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, atpcIndex=atpcIndex, radioTxFrequency=radioTxFrequency, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, ipRadioMgmt=ipRadioMgmt, modemSymbolRateRx=modemSymbolRateRx, vlanEntry=vlanEntry, modemCarrierOffset=modemCarrierOffset, modemGeneralStatus=modemGeneralStatus, modemModulation=modemModulation, modemEthernetCapacity=modemEthernetCapacity, modemTable=modemTable, ethRXControlFrames=ethRXControlFrames, licenseUpdateStatus=licenseUpdateStatus, pointToPoint=pointToPoint, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, vlanFid=vlanFid, vlanNumber=vlanNumber, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, modemLastAcqError=modemLastAcqError, modemStandard=modemStandard, ethQOSTXFrames=ethQOSTXFrames, restartcpu=restartcpu, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBandwith=modemBandwith, ethGFPDropedFrames=ethGFPDropedFrames, ethTXByteCounterLow=ethTXByteCounterLow, description=description, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCRCErrors=ethRXCRCErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDvEvent=ethRXDvEvent)
