...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:33:58 2022
...
MibIdentifier, ObjectIdentity, ModuleIdentity, Unsigned32, IpAddress, iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, NotificationType, Counter32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "IpAddress", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "NotificationType", "Counter32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, ethGFPFCSErrors=ethGFPFCSErrors, modemUptime=modemUptime, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, radioRxFrequency=radioRxFrequency, hostname=hostname, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, vlanTable=vlanTable, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, saf=saf, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEntry=modemEntry, vlanNumber=vlanNumber, license=license, modemE1T1Channels=modemE1T1Channels, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXTruncatedFrames=ethRXTruncatedFrames, modemIndex=modemIndex, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDribleNibbles=ethRXDribleNibbles, radioGenStatus=radioGenStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcEnabled=atpcEnabled, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, ethRXDones=ethRXDones, ethRXLongEvents=ethRXLongEvents, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, ethTXLateCollisions=ethTXLateCollisions, restartcpu=restartcpu, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, sysTemperature=sysTemperature, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, tehnika=tehnika, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanCfgStat=vlanCfgStat, radioSide=radioSide, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, radioTxPower=radioTxPower, pointToPoint=pointToPoint, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, loopbacks=loopbacks, vlanEntry=vlanEntry, modemACMmodulationMax=modemACMmodulationMax, aTPCEntry=aTPCEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, vlansEnabled=vlansEnabled, vlanPortType=vlanPortType, ipRadio=ipRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanRowStatus=vlanRowStatus, modemErroredSecond=modemErroredSecond, localIp=localIp, ethTXControlFrames=ethTXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, product=product, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, radioRxLevel=radioRxLevel, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, modemStandard=modemStandard, ethRXControlFrames=ethRXControlFrames, modemACMengine=modemACMengine, safip=safip, radioTxMute=radioTxMute, e1t1AIS=e1t1AIS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, remoteIp=remoteIp, modemInternalAGCgain=modemInternalAGCgain, ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCodeErrors=ethRXCodeErrors, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, radioTxFrequency=radioTxFrequency, modemErroredBlock=modemErroredBlock, licenseMask=licenseMask, ethTXCollisions=ethTXCollisions, modemTotalCapacity=modemTotalCapacity, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, writeConfig=writeConfig, modemACMmodulationMin=modemACMmodulationMin, ethTXMulticasts=ethTXMulticasts, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, aTPCTable=aTPCTable)
