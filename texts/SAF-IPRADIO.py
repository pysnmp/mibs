...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:13:41 2023
...
enterprises, TimeTicks, Counter32, IpAddress, Integer32, iso, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, ModuleIdentity, MibIdentifier, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Counter32", "IpAddress", "Integer32", "iso", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXControlFrames=ethRXControlFrames, modemACMengine=modemACMengine, ipRadioStat=ipRadioStat, product=product, pointToPoint=pointToPoint, ethTXByteCounterHi=ethTXByteCounterHi, tehnika=tehnika, radioTxMute=radioTxMute, modemUptime=modemUptime, description=description, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcIndex=atpcIndex, modemEthernetCapacity=modemEthernetCapacity, vlanPortmap=vlanPortmap, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, modemACMethernetCapacity=modemACMethernetCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, vlanEntry=vlanEntry, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, ethRXMulticasts=ethRXMulticasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDvEvent=ethRXDvEvent, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, saf=saf, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, vlanNumber=vlanNumber, vlanCfgStat=vlanCfgStat, ethGFPFCSErrors=ethGFPFCSErrors, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, aTPCEntry=aTPCEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, modemE1T1Channels=modemE1T1Channels, ethRXPauseFrames=ethRXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopbacks=loopbacks, modemBandwith=modemBandwith, vlansEnabled=vlansEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanTable=vlanTable, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, ethRXBroadcasts=ethRXBroadcasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxPower=radioTxPower, loopback_tributary_mask=loopback_tributary_mask, radioEntry=radioEntry, modemErroredSecondRatio=modemErroredSecondRatio, ethTXGiants=ethTXGiants, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCodeErrors=ethRXCodeErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, modemRadialMSE=modemRadialMSE, e1t1AIS=e1t1AIS, vlanPortType=vlanPortType, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXFrames=ethQOSTXFrames, modemLastAcqError=modemLastAcqError, radioLoopback=radioLoopback, licenseMask=licenseMask, localIpMask=localIpMask, modemAcqStatus=modemAcqStatus, modemModulation=modemModulation, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatEntry=e1t1StatEntry, atpcEnabled=atpcEnabled, radioRxFrequency=radioRxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, microwaveRadio=microwaveRadio, radioRxLevel=radioRxLevel, aTPCTable=aTPCTable, safip=safip, remoteIp=remoteIp, radioTxFrequency=radioTxFrequency, license=license, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUnavailtime=modemUnavailtime, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, modemRowStatus=modemRowStatus, writeConfig=writeConfig, modemSymbolRateTx=modemSymbolRateTx, vlanFid=vlanFid, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMin=modemACMmodulationMin, ethTXLateCollisions=ethTXLateCollisions, hostname=hostname, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXByteCounterHi=ethRXByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, modemStatistics=modemStatistics)
