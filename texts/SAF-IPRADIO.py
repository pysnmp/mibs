...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:20:58 2021
...
Bits, iso, NotificationType, TimeTicks, NotificationType, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Gauge32, enterprises, Counter64, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "NotificationType", "TimeTicks", "NotificationType", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Gauge32", "enterprises", "Counter64", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemAcqStatus=modemAcqStatus, vlanFid=vlanFid, ethGFPFCSErrors=ethGFPFCSErrors, modemUptime=modemUptime, modemIndex=modemIndex, ethRXDones=ethRXDones, ethTXVlanTags=ethTXVlanTags, saf=saf, ethRXBroadcasts=ethRXBroadcasts, vlanNumber=vlanNumber, ethTXBackpresEvents=ethTXBackpresEvents, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, ethRXDvEvent=ethRXDvEvent, restartcpu=restartcpu, modemACMmodulationMin=modemACMmodulationMin, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemModulation=modemModulation, modemE1T1Channels=modemE1T1Channels, ethTXDones=ethTXDones, modemTotalCapacity=modemTotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXCRCErrors=ethTXCRCErrors, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, e1t1StatEntry=e1t1StatEntry, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXMulticasts=ethRXMulticasts, ethRXCRCErrors=ethRXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, radioSide=radioSide, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, vlansEnabled=vlansEnabled, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, modemLastAcqError=modemLastAcqError, modemCarrierOffset=modemCarrierOffset, localIp=localIp, ethTXMulticasts=ethTXMulticasts, modemEntry=modemEntry, license=license, sysTemperature=sysTemperature, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioGenStatus=radioGenStatus, tehnika=tehnika, ethTXMaxCollisions=ethTXMaxCollisions, modemRowStatus=modemRowStatus, modemBandwith=modemBandwith, radioIndex=radioIndex, ethGFPCHECErrors=ethGFPCHECErrors, modemACMtotalCapacity=modemACMtotalCapacity, aTPCEntry=aTPCEntry, writeConfig=writeConfig, ethTXControlFrames=ethTXControlFrames, ethQOSTXDropped=ethQOSTXDropped, modemErroredBlock=modemErroredBlock, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopback_tributary_mask=loopback_tributary_mask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXControlFrames=ethRXControlFrames, radioTxPower=radioTxPower, modemSymbolRateTx=modemSymbolRateTx, vlanCfgStat=vlanCfgStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStat=ipRadioStat, modemInternalAGCgain=modemInternalAGCgain, modemTotalBlockNumber=modemTotalBlockNumber, e1t1LOS=e1t1LOS, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopbacks=loopbacks, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, modemTable=modemTable, microwaveRadio=microwaveRadio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, product=product, radioTable=radioTable, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterHi=ethTXByteCounterHi, ethTXCollisions=ethTXCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcEnabled=atpcEnabled, ethTXByteCounterLow=ethTXByteCounterLow, radioLoopback=radioLoopback, ethRXUnsupOpcodes=ethRXUnsupOpcodes, safip=safip, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, modemStandard=modemStandard, atpcIndex=atpcIndex, vlanEntry=vlanEntry, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, modemRadialMSE=modemRadialMSE, radioRxFrequency=radioRxFrequency, ipRadio=ipRadio, radioDuplexShift=radioDuplexShift, vlanPortmap=vlanPortmap, modemEthernetCapacity=modemEthernetCapacity, licenseUpdateStatus=licenseUpdateStatus, modemStatistics=modemStatistics, description=description, hostname=hostname, ethTXLateCollisions=ethTXLateCollisions, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus)
