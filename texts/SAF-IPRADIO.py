...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:48:18 2022
...
NotificationType, NotificationType, Gauge32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, iso, Bits, TimeTicks, Counter32, Counter64, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Gauge32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "iso", "Bits", "TimeTicks", "Counter32", "Counter64", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, modemLastAcqError=modemLastAcqError, atpcIndex=atpcIndex, modemSymbolRateRx=modemSymbolRateRx, licenseMask=licenseMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCTable=aTPCTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, ethRXDvEvent=ethRXDvEvent, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, description=description, ethTXVlanTags=ethTXVlanTags, ethGFPFCSErrors=ethGFPFCSErrors, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, radioSide=radioSide, vlanFid=vlanFid, ethRXCRCErrors=ethRXCRCErrors, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, modemTable=modemTable, ethTXUnderruns=ethTXUnderruns, modemUptime=modemUptime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXLongEvents=ethRXLongEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, modemCountTime=modemCountTime, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcEnabled=atpcEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStandard=modemStandard, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, ipRadioStatEth=ipRadioStatEth, saf=saf, modemACMmodulationMax=modemACMmodulationMax, radioLoopback=radioLoopback, modemAcqStatus=modemAcqStatus, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortmap=vlanPortmap, localIp=localIp, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, writeConfig=writeConfig, e1t1LOS=e1t1LOS, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, localIpMask=localIpMask, e1t1StatEntry=e1t1StatEntry, vlanTable=vlanTable, aTPCEntry=aTPCEntry, ethQOSTXFrames=ethQOSTXFrames, modemEntry=modemEntry, vlanCfgStat=vlanCfgStat, product=product, microwaveRadio=microwaveRadio, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalBlockNumber=modemTotalBlockNumber, hostname=hostname, tehnika=tehnika, vlanRowStatus=vlanRowStatus, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, modemACMethernetCapacity=modemACMethernetCapacity, vlansEnabled=vlansEnabled, modemE1T1Channels=modemE1T1Channels, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateTx=modemSymbolRateTx, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, restartcpu=restartcpu, ipRadio=ipRadio, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, ethTXMulticasts=ethTXMulticasts, ethRXMulticasts=ethRXMulticasts, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, radioRxFrequency=radioRxFrequency, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, radioDuplexShift=radioDuplexShift, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint)
