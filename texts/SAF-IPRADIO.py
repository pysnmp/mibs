...
# Produced by pysmi-1.1.12 at Sat Jul  6 01:13:37 2024
...
TimeTicks, iso, NotificationType, MibIdentifier, IpAddress, Integer32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, ObjectIdentity, Counter32, NotificationType, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers, aTPCTable=aTPCTable, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, modemRowStatus=modemRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, modemErroredBlock=modemErroredBlock, ethTXUnderruns=ethTXUnderruns, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, vlanFid=vlanFid, localIpMask=localIpMask, saf=saf, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStatistics=modemStatistics, product=product, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTable=radioTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxMute=radioTxMute, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, ipRadioStat=ipRadioStat, modemStandard=modemStandard, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS, vlanCfgStat=vlanCfgStat, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemGeneralStatus=modemGeneralStatus, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, modemBandwith=modemBandwith, radioRxLevel=radioRxLevel, vlanEntry=vlanEntry, radioIndex=radioIndex, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDones=ethRXDones, atpcEnabled=atpcEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, remoteIp=remoteIp, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, hostname=hostname, atpcIndex=atpcIndex, ethRXCRCErrors=ethRXCRCErrors, description=description, modemCarrierOffset=modemCarrierOffset, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, pointToPoint=pointToPoint, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, restartcpu=restartcpu, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, ethTXControlFrames=ethTXControlFrames, modemModulation=modemModulation, ethTXMaxCollisions=ethTXMaxCollisions, ethRXByteCounterHi=ethRXByteCounterHi, license=license, radioSide=radioSide, vlanRowStatus=vlanRowStatus, ethTXDones=ethTXDones, ethTXGiants=ethTXGiants, licenseMask=licenseMask, localIp=localIp, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, modemEthernetCapacity=modemEthernetCapacity, sysDateAndTime=sysDateAndTime, ethRXByteCounterLow=ethRXByteCounterLow, vlanNumber=vlanNumber, ethTXLateCollisions=ethTXLateCollisions, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, ethTXBackpresEvents=ethTXBackpresEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, radioLoopback=radioLoopback, ipRadioCfg=ipRadioCfg, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, vlanPortmap=vlanPortmap, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXDropped=ethQOSTXDropped, modemInternalAGCgain=modemInternalAGCgain, modemACMethernetCapacity=modemACMethernetCapacity, safip=safip, radioTxPower=radioTxPower, loopbacks=loopbacks, vlanTable=vlanTable, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, ethTXVlanTags=ethTXVlanTags, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMulticasts=ethTXMulticasts)
