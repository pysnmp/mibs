...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:41:56 2024
...
Unsigned32, IpAddress, ObjectIdentity, TimeTicks, MibIdentifier, enterprises, iso, Counter32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, Integer32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ObjectIdentity", "TimeTicks", "MibIdentifier", "enterprises", "iso", "Counter32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "Integer32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, modemLastAcqError=modemLastAcqError, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatEntry=e1t1StatEntry, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, ethRXPauseFrames=ethRXPauseFrames, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, vlanPortType=vlanPortType, vlanTable=vlanTable, product=product, atpcIndex=atpcIndex, loopbacks=loopbacks, ethRXByteCounterLow=ethRXByteCounterLow, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, ethTXCollisions=ethTXCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPrevPktDropped=ethRXPrevPktDropped, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, ethRXCodeErrors=ethRXCodeErrors, ethRXMulticasts=ethRXMulticasts, localIpMask=localIpMask, saf=saf, ethRXDvEvent=ethRXDvEvent, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, pointToPoint=pointToPoint, ethTXExcessiveDefers=ethTXExcessiveDefers, description=description, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, vlansEnabled=vlansEnabled, licenseMask=licenseMask, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, sysTemperature=sysTemperature, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, modemACMtotalCapacity=modemACMtotalCapacity, aTPCEntry=aTPCEntry, ipRadio=ipRadio, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones, localIp=localIp, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, ethQOSTXDropped=ethQOSTXDropped, licenseUpdateStatus=licenseUpdateStatus, license=license, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, radioSide=radioSide, ethRXControlFrames=ethRXControlFrames, vlanNumber=vlanNumber, tehnika=tehnika, modemErroredBlock=modemErroredBlock, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, ethTXMaxCollisions=ethTXMaxCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, radioEntry=radioEntry, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, modemIndex=modemIndex, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, radioGenStatus=radioGenStatus, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLateCollisions=ethTXLateCollisions, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, modemSymbolRateRx=modemSymbolRateRx, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, radioTable=radioTable, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, e1t1ChannelNr=e1t1ChannelNr, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, modemEntry=modemEntry, writeConfig=writeConfig, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, hostname=hostname, modemRadialMSE=modemRadialMSE, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond)
