...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:40:08 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, enterprises, Bits, Counter64, Gauge32, iso, IpAddress, ModuleIdentity, NotificationType, NotificationType, Counter32, TimeTicks, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "enterprises", "Bits", "Counter64", "Gauge32", "iso", "IpAddress", "ModuleIdentity", "NotificationType", "NotificationType", "Counter32", "TimeTicks", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, modemACMmodulationMax=modemACMmodulationMax, product=product, pointToPoint=pointToPoint, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, licenseMask=licenseMask, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterLow=ethRXByteCounterLow, microwaveRadio=microwaveRadio, radioIndex=radioIndex, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanFid=vlanFid, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEthernetCapacity=modemEthernetCapacity, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, modemUptime=modemUptime, modemModulation=modemModulation, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, ethRXControlFrames=ethRXControlFrames, modemCountTime=modemCountTime, modemTable=modemTable, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ipRadioCfgNetwork=ipRadioCfgNetwork, tehnika=tehnika, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecond=modemErroredSecond, licenseUpdateStatus=licenseUpdateStatus, modemACMengine=modemACMengine, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, ethQOSTXDropped=ethQOSTXDropped, modemErroredBlock=modemErroredBlock, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled, loopbacks=loopbacks, ethRXLongEvents=ethRXLongEvents, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, aTPCEntry=aTPCEntry, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, e1t1LOS=e1t1LOS, remoteIp=remoteIp, modemErroredSecondRatio=modemErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, ethRXBroadcasts=ethRXBroadcasts, radioRxFrequency=radioRxFrequency, ipRadioCfg=ipRadioCfg, aTPCTable=aTPCTable, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, vlanPortType=vlanPortType, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, localIp=localIp, ethTXCollisions=ethTXCollisions, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, vlanEntry=vlanEntry, modemEntry=modemEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, saf=saf, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRadialMSE=modemRadialMSE, ethTXUnderruns=ethTXUnderruns, hostname=hostname, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, modemCarrierOffset=modemCarrierOffset, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, e1t1AIS=e1t1AIS, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXMulticasts=ethRXMulticasts, safip=safip, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXGiants=ethTXGiants, ethTXVlanTags=ethTXVlanTags, modemBandwith=modemBandwith, radioTxPower=radioTxPower, modemTotalCapacity=modemTotalCapacity, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMaxCollisions=ethTXMaxCollisions)
