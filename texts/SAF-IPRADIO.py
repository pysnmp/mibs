...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:43:27 2021
...
Unsigned32, NotificationType, Counter64, Counter32, Gauge32, Bits, enterprises, IpAddress, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, MibIdentifier, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Counter64", "Counter32", "Gauge32", "Bits", "enterprises", "IpAddress", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemAcqStatus=modemAcqStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, radioSide=radioSide, license=license, ethRXLongEvents=ethRXLongEvents, loopback_tributary_mask=loopback_tributary_mask, aTPCTable=aTPCTable, modemACMmodulationMin=modemACMmodulationMin, ethRXCodeErrors=ethRXCodeErrors, hostname=hostname, ethRXVlanTagsDetected=ethRXVlanTagsDetected, microwaveRadio=microwaveRadio, licenseMask=licenseMask, aTPCEntry=aTPCEntry, ethQOSTXFrames=ethQOSTXFrames, ipRadioMgmt=ipRadioMgmt, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, tehnika=tehnika, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStatEth=ipRadioStatEth, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, vlanEntry=vlanEntry, modemTotalBlockNumber=modemTotalBlockNumber, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, modemUnavailtime=modemUnavailtime, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, description=description, ethTXCRCErrors=ethTXCRCErrors, e1t1AIS=e1t1AIS, ethTXBackpresEvents=ethTXBackpresEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXMulticasts=ethRXMulticasts, restartcpu=restartcpu, radioTable=radioTable, e1t1StatEntry=e1t1StatEntry, ethRXDones=ethRXDones, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, vlanPortType=vlanPortType, modemTotalCapacity=modemTotalCapacity, sysDateAndTime=sysDateAndTime, radioTxPower=radioTxPower, ethTXGiants=ethTXGiants, radioRxFrequency=radioRxFrequency, radioGenStatus=radioGenStatus, ipRadioStat=ipRadioStat, ethTXByteCounterHi=ethTXByteCounterHi, radioLoopback=radioLoopback, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, modemStatistics=modemStatistics, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPauseFrames=ethRXPauseFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, radioEntry=radioEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, saf=saf, pointToPoint=pointToPoint, remoteIp=remoteIp, modemInternalAGCgain=modemInternalAGCgain, vlansEnabled=vlansEnabled, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethTXDones=ethTXDones, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterLow=ethRXByteCounterLow, ipRadio=ipRadio, modemErroredBlock=modemErroredBlock, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, modemCarrierOffset=modemCarrierOffset, ethTXMulticasts=ethTXMulticasts, localIpMask=localIpMask, radioIndex=radioIndex, modemIndex=modemIndex, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecond=modemErroredSecond, loopbacks=loopbacks, localIp=localIp, writeConfig=writeConfig, modemTable=modemTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, vlanCfgStat=vlanCfgStat, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, product=product, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXBroadcasts=ethRXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, modemSymbolRateRx=modemSymbolRateRx, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1Channels=modemE1T1Channels, vlanFid=vlanFid, modemStandard=modemStandard, vlanTable=vlanTable, radioTxFrequency=radioTxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcIndex=atpcIndex, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, modemUptime=modemUptime, modemACMengine=modemACMengine, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors)
