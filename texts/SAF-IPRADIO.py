...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:37:48 2023
...
NotificationType, Integer32, IpAddress, Gauge32, Counter32, ModuleIdentity, TimeTicks, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Bits, Unsigned32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "TimeTicks", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", restartcpu=restartcpu, ethRXCodeErrors=ethRXCodeErrors, e1t1StatTable=e1t1StatTable, ethRXDones=ethRXDones, vlanCfgStat=vlanCfgStat, modemTable=modemTable, ipRadio=ipRadio, modemEntry=modemEntry, hostname=hostname, modemSymbolRateRx=modemSymbolRateRx, ipRadioStatEth=ipRadioStatEth, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBroadcasts=ethTXBroadcasts, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, writeConfig=writeConfig, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, localIp=localIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, ethTXCRCErrors=ethTXCRCErrors, ethTXCollisions=ethTXCollisions, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRowStatus=modemRowStatus, vlanNumber=vlanNumber, e1t1StatEntry=e1t1StatEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, tehnika=tehnika, ethTXUnderruns=ethTXUnderruns, saf=saf, modemIndex=modemIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIpMask=localIpMask, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, radioSide=radioSide, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, microwaveRadio=microwaveRadio, e1t1LOS=e1t1LOS, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, modemUptime=modemUptime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, vlansEnabled=vlansEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, product=product, ethTXPauseFrames=ethTXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemRadialMSE=modemRadialMSE, ethTXBackpresEvents=ethTXBackpresEvents, aTPCTable=aTPCTable, vlanFid=vlanFid, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCRCErrors=ethRXCRCErrors, safip=safip, modemACMmodulationMin=modemACMmodulationMin, aTPCEntry=aTPCEntry, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanTable=vlanTable, vlanPortmap=vlanPortmap, radioIndex=radioIndex, modemStandard=modemStandard, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxMute=radioTxMute, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterLow=ethRXByteCounterLow, modemUnavailtime=modemUnavailtime, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXBroadcasts=ethRXBroadcasts, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, sysTemperature=sysTemperature, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, ethRXMulticasts=ethRXMulticasts, ipRadioCfg=ipRadioCfg, ethTXMulticasts=ethTXMulticasts, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredSecond=modemErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, pointToPoint=pointToPoint, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, license=license, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry)
