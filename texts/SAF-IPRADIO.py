...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:54:51 2022
...
IpAddress, ObjectIdentity, iso, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, TimeTicks, Unsigned32, Counter64, MibIdentifier, Gauge32, NotificationType, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "iso", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "TimeTicks", "Unsigned32", "Counter64", "MibIdentifier", "Gauge32", "NotificationType", "Bits", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBandwith=modemBandwith, atpcIndex=atpcIndex, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUptime=modemUptime, writeConfig=writeConfig, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, ethTXBackpresEvents=ethTXBackpresEvents, licenseUpdateStatus=licenseUpdateStatus, aTPCEntry=aTPCEntry, vlanNumber=vlanNumber, safip=safip, radioDuplexShift=radioDuplexShift, e1t1StatEntry=e1t1StatEntry, hostname=hostname, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEntry=modemEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, loopback_tributary_mask=loopback_tributary_mask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxLevel=radioRxLevel, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRadialMSE=modemRadialMSE, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, modemTotalCapacity=modemTotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMengine=modemACMengine, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, licenseMask=licenseMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxFrequency=radioTxFrequency, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioEntry=radioEntry, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterLow=ethTXWireByteCounterLow, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, ipRadio=ipRadio, aTPCTable=aTPCTable, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, radioRxFrequency=radioRxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, vlansEnabled=vlansEnabled, radioTxMute=radioTxMute, vlanEntry=vlanEntry, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, modemInternalAGCgain=modemInternalAGCgain, saf=saf, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMethernetCapacity=modemACMethernetCapacity, remoteIp=remoteIp, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, modemErroredSecond=modemErroredSecond, pointToPoint=pointToPoint, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, vlanCfgStat=vlanCfgStat, ethRXControlFrames=ethRXControlFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, modemUnavailtime=modemUnavailtime, tehnika=tehnika, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, radioTable=radioTable, license=license, radioGenStatus=radioGenStatus, modemCarrierOffset=modemCarrierOffset, modemSymbolRateTx=modemSymbolRateTx, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, ethTXCollisions=ethTXCollisions, vlanTable=vlanTable, modemIndex=modemIndex, ethRXMulticasts=ethRXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxPower=radioTxPower, modemTable=modemTable, product=product, vlanRowStatus=vlanRowStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethTXMulticasts=ethTXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, vlanFid=vlanFid, loopbacks=loopbacks, sysTemperature=sysTemperature, localIp=localIp, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXBroadcasts=ethTXBroadcasts)
