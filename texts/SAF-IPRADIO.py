...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:54:23 2023
...
Counter32, Gauge32, Counter64, NotificationType, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, NotificationType, ObjectIdentity, IpAddress, enterprises, TimeTicks, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Counter64", "NotificationType", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "NotificationType", "ObjectIdentity", "IpAddress", "enterprises", "TimeTicks", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcIndex=atpcIndex, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXControlFrames=ethTXControlFrames, ethTXCollisions=ethTXCollisions, ethTXLateCollisions=ethTXLateCollisions, modemErroredSecond=modemErroredSecond, sysDateAndTime=sysDateAndTime, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, radioTxPower=radioTxPower, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, modemACMethernetCapacity=modemACMethernetCapacity, ethTXDones=ethTXDones, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, radioEntry=radioEntry, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCTable=aTPCTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemLastAcqError=modemLastAcqError, ethTXBroadcasts=ethTXBroadcasts, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, ethRXCRCErrors=ethRXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, localIp=localIp, modemGeneralStatus=modemGeneralStatus, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxFrequency=radioRxFrequency, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, saf=saf, licenseMask=licenseMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, modemBandwith=modemBandwith, ethRXDones=ethRXDones, vlanPortType=vlanPortType, modemEthernetCapacity=modemEthernetCapacity, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1LOS=e1t1LOS, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSymbolRateTx=modemSymbolRateTx, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, tehnika=tehnika, modemErroredBlock=modemErroredBlock, modemE1T1ChannelMask=modemE1T1ChannelMask, loopbacks=loopbacks, writeConfig=writeConfig, modemUptime=modemUptime, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, ethRXDvEvent=ethRXDvEvent, modemStandard=modemStandard, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, restartcpu=restartcpu, modemRowStatus=modemRowStatus, vlanTable=vlanTable, ethTXGiants=ethTXGiants, e1t1ChannelNr=e1t1ChannelNr, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, modemIndex=modemIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, radioGenStatus=radioGenStatus, radioTable=radioTable, radioDuplexShift=radioDuplexShift, radioIndex=radioIndex, radioSide=radioSide, modemCarrierOffset=modemCarrierOffset, ipRadioStatEth=ipRadioStatEth, radioTxFrequency=radioTxFrequency, ethTXMulticasts=ethTXMulticasts, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, vlanRowStatus=vlanRowStatus, description=description, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, radioLoopback=radioLoopback, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, product=product, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, vlanFid=vlanFid, ethTXExcessiveDefers=ethTXExcessiveDefers, remoteIp=remoteIp, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, modemEntry=modemEntry, ethTXUnderruns=ethTXUnderruns, ethRXDribleNibbles=ethRXDribleNibbles, license=license, ethRXByteCounterLow=ethRXByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, aTPCEntry=aTPCEntry, safip=safip, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, radioRxLevel=radioRxLevel)
