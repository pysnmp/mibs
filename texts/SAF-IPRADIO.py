...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:35:16 2022
...
NotificationType, ObjectIdentity, NotificationType, ModuleIdentity, MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Integer32, TimeTicks, enterprises, IpAddress, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Integer32", "TimeTicks", "enterprises", "IpAddress", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTable=radioTable, modemStatistics=modemStatistics, modemRadialMSE=modemRadialMSE, ethRXDones=ethRXDones, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, radioRxFrequency=radioRxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, ethTXMulticasts=ethTXMulticasts, e1t1StatEntry=e1t1StatEntry, safip=safip, vlanCfgStat=vlanCfgStat, localIp=localIp, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, writeConfig=writeConfig, modemE1T1Channels=modemE1T1Channels, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanEntry=vlanEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, ipRadioStatEth=ipRadioStatEth, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterHi=ethRXByteCounterHi, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecond=modemErroredSecond, ethRXControlFrames=ethRXControlFrames, modemCarrierOffset=modemCarrierOffset, ethGFPCHECErrors=ethGFPCHECErrors, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, product=product, sysTemperature=sysTemperature, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, vlansEnabled=vlansEnabled, radioRxLevel=radioRxLevel, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBroadcasts=ethTXBroadcasts, e1t1AIS=e1t1AIS, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethGFPDropedFrames=ethGFPDropedFrames, modemEthernetCapacity=modemEthernetCapacity, license=license, ethTXCRCErrors=ethTXCRCErrors, modemErroredBlock=modemErroredBlock, radioTxPower=radioTxPower, radioEntry=radioEntry, e1t1LOS=e1t1LOS, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, ethTXCollisions=ethTXCollisions, radioSide=radioSide, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMin=modemACMmodulationMin, ethTXBackpresEvents=ethTXBackpresEvents, loopbacks=loopbacks, aTPCEntry=aTPCEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemUptime=modemUptime, ethTXByteCounterLow=ethTXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, radioDuplexShift=radioDuplexShift, modemModulation=modemModulation, ethRXPrevPktDropped=ethRXPrevPktDropped, microwaveRadio=microwaveRadio, localIpMask=localIpMask, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, vlanTable=vlanTable, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, modemTotalCapacity=modemTotalCapacity, restartcpu=restartcpu, radioLoopback=radioLoopback, modemEntry=modemEntry, aTPCTable=aTPCTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, saf=saf, modemTable=modemTable, e1t1StatTable=e1t1StatTable, atpcIndex=atpcIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, licenseUpdateStatus=licenseUpdateStatus, modemAcqStatus=modemAcqStatus, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ipRadio=ipRadio, modemUnavailtime=modemUnavailtime, ipRadioCfg=ipRadioCfg, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStandard=modemStandard, vlanNumber=vlanNumber, vlanPortType=vlanPortType)
