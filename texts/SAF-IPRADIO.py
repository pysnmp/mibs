...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:51:58 2022
...
TimeTicks, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, ModuleIdentity, Unsigned32, Gauge32, Integer32, enterprises, iso, ObjectIdentity, Bits, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "Integer32", "enterprises", "iso", "ObjectIdentity", "Bits", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioIndex=radioIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, modemErroredSecond=modemErroredSecond, radioEntry=radioEntry, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, modemE1T1Channels=modemE1T1Channels, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStat=ipRadioStat, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, sysTemperature=sysTemperature, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames, modemStatistics=modemStatistics, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, e1t1LOS=e1t1LOS, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMengine=modemACMengine, ethTXCollisions=ethTXCollisions, ipRadioStatEth=ipRadioStatEth, vlanNumber=vlanNumber, modemEthernetCapacity=modemEthernetCapacity, aTPCEntry=aTPCEntry, modemSymbolRateTx=modemSymbolRateTx, ethTXDones=ethTXDones, modemIndex=modemIndex, radioTxMute=radioTxMute, modemCountTime=modemCountTime, safip=safip, ipRadioMgmt=ipRadioMgmt, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, radioGenStatus=radioGenStatus, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, hostname=hostname, ethQOSTXFrames=ethQOSTXFrames, radioTxFrequency=radioTxFrequency, atpcIndex=atpcIndex, radioTxPower=radioTxPower, modemInternalAGCgain=modemInternalAGCgain, modemAcqStatus=modemAcqStatus, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBandwith=modemBandwith, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, ipRadioCfg=ipRadioCfg, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, radioRxFrequency=radioRxFrequency, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, modemEntry=modemEntry, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, product=product, atpcTxPowerCorrection=atpcTxPowerCorrection, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1ChannelMask=modemE1T1ChannelMask, modemLastAcqError=modemLastAcqError, modemCarrierOffset=modemCarrierOffset, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, ethRXDvEvent=ethRXDvEvent, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, modemACMmodulationMax=modemACMmodulationMax, radioTable=radioTable, description=description, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, ethRXByteCounterHi=ethRXByteCounterHi, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, ethGFPCHECErrors=ethGFPCHECErrors, license=license, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterHi=ethTXByteCounterHi, modemUptime=modemUptime, ipRadio=ipRadio, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, ethRXPauseFrames=ethRXPauseFrames, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, licenseMask=licenseMask, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanEntry=vlanEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected)
