...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:10:06 2024
...
ModuleIdentity, ObjectIdentity, enterprises, TimeTicks, IpAddress, Unsigned32, Bits, MibIdentifier, NotificationType, NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "TimeTicks", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortType=vlanPortType, ethTXVlanTags=ethTXVlanTags, localIpMask=localIpMask, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLongEvents=ethRXLongEvents, e1t1StatTable=e1t1StatTable, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1AIS=e1t1AIS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxFrequency=radioRxFrequency, modemCountTime=modemCountTime, modemAcqStatus=modemAcqStatus, sysTemperature=sysTemperature, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, modemEntry=modemEntry, modemStandard=modemStandard, ethTXDones=ethTXDones, ipRadio=ipRadio, modemIndex=modemIndex, hostname=hostname, vlanTable=vlanTable, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE, licenseMask=licenseMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, writeConfig=writeConfig, radioRxLevel=radioRxLevel, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTable=modemTable, modemACMtotalCapacity=modemACMtotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatEntry=e1t1StatEntry, radioIndex=radioIndex, ethTXMulticasts=ethTXMulticasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanFid=vlanFid, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, ethTXBackpresEvents=ethTXBackpresEvents, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, ipRadioStat=ipRadioStat, radioGenStatus=radioGenStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortmap=vlanPortmap, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, ethTXLateCollisions=ethTXLateCollisions, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalBlockNumber=modemTotalBlockNumber, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, license=license, remoteIp=remoteIp, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCollisions=ethTXCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDones=ethRXDones, modemErroredBlock=modemErroredBlock, radioSide=radioSide, modemACMmodulationMin=modemACMmodulationMin, radioDuplexShift=radioDuplexShift, ethRXPauseFrames=ethRXPauseFrames, modemBandwith=modemBandwith, modemRowStatus=modemRowStatus, modemStatistics=modemStatistics, ipRadioMgmt=ipRadioMgmt, loopbacks=loopbacks, localIp=localIp, modemUptime=modemUptime, modemE1T1Channels=modemE1T1Channels, modemUnavailtime=modemUnavailtime, modemModulation=modemModulation, ethTXByteCounterLow=ethTXByteCounterLow, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, ethRXCodeErrors=ethRXCodeErrors, product=product, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCarrierOffset=modemCarrierOffset, e1t1ChannelNr=e1t1ChannelNr, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, ipRadioCfgGeneral=ipRadioCfgGeneral, saf=saf, atpcIndex=atpcIndex, safip=safip, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCRCErrors=ethTXCRCErrors, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, microwaveRadio=microwaveRadio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, ethGFPFCSErrors=ethGFPFCSErrors, vlanRowStatus=vlanRowStatus, radioTxFrequency=radioTxFrequency)
