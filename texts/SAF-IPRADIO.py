...
# Produced by pysmi-1.1.12 at Wed May 29 06:50:56 2024
...
Counter64, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Integer32, ObjectIdentity, MibIdentifier, IpAddress, Gauge32, Bits, NotificationType, Counter32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Integer32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Gauge32", "Bits", "NotificationType", "Counter32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, ipRadioCfg=ipRadioCfg, microwaveRadio=microwaveRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemModulation=modemModulation, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, modemGeneralStatus=modemGeneralStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfgGeneral=ipRadioCfgGeneral, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, ethGFPFCSErrors=ethGFPFCSErrors, radioTable=radioTable, sysTemperature=sysTemperature, licenseMask=licenseMask, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, licenseUpdateStatus=licenseUpdateStatus, modemErroredBlock=modemErroredBlock, hostname=hostname, pointToPoint=pointToPoint, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, modemSymbolRateRx=modemSymbolRateRx, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, modemIndex=modemIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, radioLoopback=radioLoopback, vlanEntry=vlanEntry, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, safip=safip, radioGenStatus=radioGenStatus, e1t1ChannelNr=e1t1ChannelNr, ipRadio=ipRadio, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, product=product, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, ethQOSTXFrames=ethQOSTXFrames, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, modemStatistics=modemStatistics, ethTXBroadcasts=ethTXBroadcasts, radioTxMute=radioTxMute, ethTXDones=ethTXDones, saf=saf, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMengine=modemACMengine, radioIndex=radioIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, license=license, loopbacks=loopbacks, description=description, ethTXMulticasts=ethTXMulticasts, ethQOSTXDropped=ethQOSTXDropped, modemUnavailtime=modemUnavailtime, tehnika=tehnika, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXPauseFrames=ethTXPauseFrames, ipRadioStatEth=ipRadioStatEth, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioDuplexShift=radioDuplexShift, radioTxPower=radioTxPower, localIp=localIp, ethTXVlanTags=ethTXVlanTags, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXControlFrames=ethTXControlFrames, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Frames=ethQOSRXQ1Frames, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, e1t1LOS=e1t1LOS, ethTXUnderruns=ethTXUnderruns, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUptime=modemUptime, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, radioSide=radioSide, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, radioEntry=radioEntry, modemEntry=modemEntry, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, modemRowStatus=modemRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, vlanNumber=vlanNumber)
