...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:45:29 2022
...
Integer32, enterprises, ObjectIdentity, iso, TimeTicks, MibIdentifier, Counter32, Counter64, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Bits, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "ObjectIdentity", "iso", "TimeTicks", "MibIdentifier", "Counter32", "Counter64", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Bits", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioSide=radioSide, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXDones=ethTXDones, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, modemACMengine=modemACMengine, modemGeneralStatus=modemGeneralStatus, modemStandard=modemStandard, localIp=localIp, modemE1T1ChannelMask=modemE1T1ChannelMask, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, radioTxFrequency=radioTxFrequency, vlanCfgStat=vlanCfgStat, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, tehnika=tehnika, ipRadio=ipRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1LOS=e1t1LOS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTable=radioTable, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, vlanEntry=vlanEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateRx=modemSymbolRateRx, ipRadioStat=ipRadioStat, modemAcqStatus=modemAcqStatus, ethRXByteCounterHi=ethRXByteCounterHi, radioTxMute=radioTxMute, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, product=product, e1t1StatEntry=e1t1StatEntry, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredBlock=modemErroredBlock, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortType=vlanPortType, radioDuplexShift=radioDuplexShift, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, aTPCTable=aTPCTable, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxLevel=radioRxLevel, ethTXUnderruns=ethTXUnderruns, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, description=description, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemIndex=modemIndex, ethRXBroadcasts=ethRXBroadcasts, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEntry=modemEntry, ipRadioStatEth=ipRadioStatEth, radioIndex=radioIndex, modemModulation=modemModulation, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, saf=saf, localIpMask=localIpMask, atpcEnabled=atpcEnabled, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, modemSymbolRateTx=modemSymbolRateTx, vlanPortmap=vlanPortmap, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, vlansEnabled=vlansEnabled, vlanTable=vlanTable, atpcIndex=atpcIndex, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUptime=modemUptime, modemTable=modemTable, pointToPoint=pointToPoint, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, licenseMask=licenseMask, hostname=hostname, radioEntry=radioEntry, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, radioLoopback=radioLoopback, license=license, modemACMmodulationMin=modemACMmodulationMin, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterLow=ethTXByteCounterLow, sysTemperature=sysTemperature, loopback_tributary_mask=loopback_tributary_mask)
