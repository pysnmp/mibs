...
# Produced by pysmi-1.1.8 at Tue Feb  8 23:22:35 2022
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, product=product, modemEthernetCapacity=modemEthernetCapacity, e1t1StatEntry=e1t1StatEntry, vlanFid=vlanFid, localIp=localIp, ethTXBackpresEvents=ethTXBackpresEvents, hostname=hostname, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, ethTXControlFrames=ethTXControlFrames, atpcEnabled=atpcEnabled, safip=safip, vlanCfgStat=vlanCfgStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, ipRadio=ipRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, pointToPoint=pointToPoint, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, radioDuplexShift=radioDuplexShift, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, modemTable=modemTable, ethQOSTXDropped=ethQOSTXDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, saf=saf, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanRowStatus=vlanRowStatus, modemTotalCapacity=modemTotalCapacity, modemSymbolRateTx=modemSymbolRateTx, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, radioTxFrequency=radioTxFrequency, aTPCEntry=aTPCEntry, license=license, radioTable=radioTable, ethTXGiants=ethTXGiants, vlanEntry=vlanEntry, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, modemStandard=modemStandard, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, radioLoopback=radioLoopback, radioGenStatus=radioGenStatus, ethRXCodeErrors=ethRXCodeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, sysTemperature=sysTemperature, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, description=description, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMax=modemACMmodulationMax, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, atpcIndex=atpcIndex, modemIndex=modemIndex, vlanPortmap=vlanPortmap, tehnika=tehnika, ethTXCollisions=ethTXCollisions, ipRadioStat=ipRadioStat, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecond=modemErroredSecond, modemStatistics=modemStatistics, ipRadioCfg=ipRadioCfg, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, sysDateAndTime=sysDateAndTime, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioEntry=radioEntry, modemErroredSecondRatio=modemErroredSecondRatio, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames, vlanTable=vlanTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, modemAcqStatus=modemAcqStatus, vlanPortType=vlanPortType, radioTxPower=radioTxPower, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, modemErroredBlock=modemErroredBlock, e1t1ChannelNr=e1t1ChannelNr, loopbacks=loopbacks, e1t1LOS=e1t1LOS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, modemRowStatus=modemRowStatus, e1t1StatTable=e1t1StatTable, modemACMmodulationMin=modemACMmodulationMin, modemCarrierOffset=modemCarrierOffset)
