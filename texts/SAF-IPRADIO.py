...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:49:13 2023
...
ModuleIdentity, MibIdentifier, enterprises, Counter64, NotificationType, TimeTicks, Integer32, Unsigned32, NotificationType, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "enterprises", "Counter64", "NotificationType", "TimeTicks", "Integer32", "Unsigned32", "NotificationType", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, modemErroredBlock=modemErroredBlock, modemACMmodulationMax=modemACMmodulationMax, ethGFPCHECErrors=ethGFPCHECErrors, modemInternalAGCgain=modemInternalAGCgain, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatEntry=e1t1StatEntry, ethTXCollisions=ethTXCollisions, atpcIndex=atpcIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, license=license, microwaveRadio=microwaveRadio, modemBandwith=modemBandwith, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, modemRadialMSE=modemRadialMSE, ipRadioCfg=ipRadioCfg, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, hostname=hostname, atpcEnabled=atpcEnabled, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, modemIndex=modemIndex, vlanPortType=vlanPortType, modemCountTime=modemCountTime, modemUnavailtime=modemUnavailtime, vlanTable=vlanTable, modemLDPCdecoderStress=modemLDPCdecoderStress, modemUptime=modemUptime, modemModulation=modemModulation, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, description=description, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, radioTable=radioTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, vlanEntry=vlanEntry, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, ethTXMulticasts=ethTXMulticasts, ethTXCRCErrors=ethTXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, tehnika=tehnika, ipRadioStat=ipRadioStat, modemACMethernetCapacity=modemACMethernetCapacity, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, modemTable=modemTable, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, safip=safip, saf=saf, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatTable=e1t1StatTable, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, modemAcqStatus=modemAcqStatus, ethRXControlFrames=ethRXControlFrames, ethTXDones=ethTXDones, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, radioTxMute=radioTxMute, ipRadio=ipRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioMgmt=ipRadioMgmt, vlanNumber=vlanNumber, e1t1ChannelNr=e1t1ChannelNr, modemTotalCapacity=modemTotalCapacity, licenseMask=licenseMask, product=product, ipRadioStatEth=ipRadioStatEth, ethQOSTXFrames=ethQOSTXFrames, ethRXDribleNibbles=ethRXDribleNibbles, sysTemperature=sysTemperature, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, remoteIp=remoteIp, radioSide=radioSide, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1Channels=modemE1T1Channels, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanFid=vlanFid, ethRXDvEvent=ethRXDvEvent, e1t1LOS=e1t1LOS, radioGenStatus=radioGenStatus)
