...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:58:42 2021
...
enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, Bits, iso, TimeTicks, Integer32, Counter64, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Bits", "iso", "TimeTicks", "Integer32", "Counter64", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXCollisions=ethTXCollisions, localIp=localIp, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, ethQOSTXFrames=ethQOSTXFrames, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, radioSide=radioSide, saf=saf, radioTxMute=radioTxMute, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, remoteIp=remoteIp, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, safip=safip, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXUnderruns=ethTXUnderruns, ipRadioCfg=ipRadioCfg, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUptime=modemUptime, e1t1ChannelNr=e1t1ChannelNr, ethRXLongEvents=ethRXLongEvents, description=description, vlanTable=vlanTable, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredBlock=modemErroredBlock, modemModulation=modemModulation, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxLevel=radioRxLevel, licenseMask=licenseMask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, ethGFPDropedFrames=ethGFPDropedFrames, radioTxPower=radioTxPower, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, radioGenStatus=radioGenStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDones=ethRXDones, modemErroredSecond=modemErroredSecond, modemStandard=modemStandard, modemRowStatus=modemRowStatus, hostname=hostname, radioTxFrequency=radioTxFrequency, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterLow=ethRXByteCounterLow, microwaveRadio=microwaveRadio, aTPCTable=aTPCTable, modemACMtotalCapacity=modemACMtotalCapacity, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, product=product, restartcpu=restartcpu, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, ethRXPauseFrames=ethRXPauseFrames, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1LOS=e1t1LOS, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, modemStatistics=modemStatistics, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, radioLoopback=radioLoopback, radioEntry=radioEntry, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, atpcIndex=atpcIndex, aTPCEntry=aTPCEntry, modemTable=modemTable, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, modemEthernetCapacity=modemEthernetCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, modemBandwith=modemBandwith, vlanNumber=vlanNumber, modemE1T1Channels=modemE1T1Channels, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, ethRXControlFrames=ethRXControlFrames, ethRXCRCErrors=ethRXCRCErrors, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethRXDvEvent=ethRXDvEvent, modemRadialMSE=modemRadialMSE, localIpMask=localIpMask, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, radioIndex=radioIndex, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, tehnika=tehnika, ethTXDones=ethTXDones, vlanPortmap=vlanPortmap, modemSeverelyErroredSecond=modemSeverelyErroredSecond)
