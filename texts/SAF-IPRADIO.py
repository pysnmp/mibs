...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:47:06 2023
...
Integer32, Counter64, NotificationType, Counter32, enterprises, iso, TimeTicks, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "NotificationType", "Counter32", "enterprises", "iso", "TimeTicks", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Frames=ethQOSRXQ2Frames, product=product, modemACMethernetCapacity=modemACMethernetCapacity, licenseUpdateStatus=licenseUpdateStatus, restartcpu=restartcpu, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, modemUnavailtime=modemUnavailtime, radioEntry=radioEntry, sysTemperature=sysTemperature, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxLevel=radioRxLevel, modemStatistics=modemStatistics, ethTXMulticasts=ethTXMulticasts, description=description, modemSymbolRateTx=modemSymbolRateTx, safip=safip, vlanRowStatus=vlanRowStatus, radioRxFrequency=radioRxFrequency, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, modemAcqStatus=modemAcqStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, vlanPortType=vlanPortType, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, ethTXCollisions=ethTXCollisions, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrror=modemBackgroundBlockErrror, saf=saf, radioTxPower=radioTxPower, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, modemCountTime=modemCountTime, vlanFid=vlanFid, ethTXCRCErrors=ethTXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterLow=ethRXByteCounterLow, loopbacks=loopbacks, radioIndex=radioIndex, vlanTable=vlanTable, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, ethGFPFCSErrors=ethGFPFCSErrors, vlansEnabled=vlansEnabled, radioTable=radioTable, modemStandard=modemStandard, e1t1LOS=e1t1LOS, localIp=localIp, vlanEntry=vlanEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, radioTxMute=radioTxMute, radioLoopback=radioLoopback, radioGenStatus=radioGenStatus, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalCapacity=modemTotalCapacity, licenseMask=licenseMask, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, license=license, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEthernetCapacity=modemEthernetCapacity, ipRadioStatEth=ipRadioStatEth, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, ethRXControlFrames=ethRXControlFrames, modemBandwith=modemBandwith, remoteIp=remoteIp, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, ipRadioCfg=ipRadioCfg, ethGFPDelineationErrors=ethGFPDelineationErrors, hostname=hostname, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioDuplexShift=radioDuplexShift, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, vlanPortmap=vlanPortmap, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, writeConfig=writeConfig, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1AIS=e1t1AIS, ethTXByteCounterHi=ethTXByteCounterHi, modemIndex=modemIndex, ethRXDones=ethRXDones, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, modemCarrierOffset=modemCarrierOffset, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, e1t1ChannelNr=e1t1ChannelNr, e1t1StatEntry=e1t1StatEntry)
