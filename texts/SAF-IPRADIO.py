...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:58:16 2024
...
enterprises, IpAddress, ModuleIdentity, Bits, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, iso, ObjectIdentity, Unsigned32, TimeTicks, MibIdentifier, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "ModuleIdentity", "Bits", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBackpresEvents=ethTXBackpresEvents, tehnika=tehnika, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, modemStandard=modemStandard, ethQOSTXFrames=ethQOSTXFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMin=modemACMmodulationMin, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMulticasts=ethTXMulticasts, modemE1T1Channels=modemE1T1Channels, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, radioTxMute=radioTxMute, modemEntry=modemEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, vlansEnabled=vlansEnabled, modemErroredSecond=modemErroredSecond, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, radioGenStatus=radioGenStatus, ethRXDones=ethRXDones, radioRxLevel=radioRxLevel, ethRXLongEvents=ethRXLongEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXBroadcasts=ethRXBroadcasts, aTPCEntry=aTPCEntry, saf=saf, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, license=license, ipRadioCfgNetwork=ipRadioCfgNetwork, restartcpu=restartcpu, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRadialMSE=modemRadialMSE, ethTXByteCounterHi=ethTXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, modemIndex=modemIndex, modemUptime=modemUptime, pointToPoint=pointToPoint, ethRXDvEvent=ethRXDvEvent, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanTable=vlanTable, radioDuplexShift=radioDuplexShift, ipRadioCfg=ipRadioCfg, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, modemACMengine=modemACMengine, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, ethRXByteCounterLow=ethRXByteCounterLow, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, modemLastAcqError=modemLastAcqError, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, licenseMask=licenseMask, ethTXMaxCollisions=ethTXMaxCollisions, description=description, atpcIndex=atpcIndex, sysDateAndTime=sysDateAndTime, modemTable=modemTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalCapacity=modemTotalCapacity, e1t1LOS=e1t1LOS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMax=modemACMmodulationMax, e1t1AIS=e1t1AIS, remoteIp=remoteIp, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, modemModulation=modemModulation, localIp=localIp, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1ChannelMask=modemE1T1ChannelMask, localIpMask=localIpMask, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCollisions=ethTXCollisions, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, modemBandwith=modemBandwith, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXMulticasts=ethRXMulticasts, aTPCTable=aTPCTable, e1t1StatTable=e1t1StatTable, product=product, modemSymbolRateRx=modemSymbolRateRx)
