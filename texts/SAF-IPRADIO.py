...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:29:02 2023
...
Counter64, TimeTicks, MibIdentifier, Gauge32, Bits, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, NotificationType, ObjectIdentity, Unsigned32, ModuleIdentity, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "MibIdentifier", "Gauge32", "Bits", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "NotificationType", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "iso", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIpMask=localIpMask, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, microwaveRadio=microwaveRadio, modemSymbolRateRx=modemSymbolRateRx, product=product, ethRXByteCounterHi=ethRXByteCounterHi, modemRadialMSE=modemRadialMSE, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, licenseMask=licenseMask, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcIndex=atpcIndex, vlanCfgStat=vlanCfgStat, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, modemACMmodulationMin=modemACMmodulationMin, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTotalCapacity=modemTotalCapacity, ethRXPauseFrames=ethRXPauseFrames, radioTxMute=radioTxMute, ethTXExcessiveDefers=ethTXExcessiveDefers, remoteIp=remoteIp, radioRxFrequency=radioRxFrequency, modemAcqStatus=modemAcqStatus, modemACMengine=modemACMengine, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, vlanNumber=vlanNumber, ethRXBroadcasts=ethRXBroadcasts, ethTXBroadcasts=ethTXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, radioDuplexShift=radioDuplexShift, radioTxFrequency=radioTxFrequency, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, aTPCTable=aTPCTable, radioLoopback=radioLoopback, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1ChannelNr=e1t1ChannelNr, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatEntry=e1t1StatEntry, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1StatTable=e1t1StatTable, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, modemErroredBlock=modemErroredBlock, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEntry=modemEntry, radioTable=radioTable, modemInternalAGCgain=modemInternalAGCgain, e1t1LOS=e1t1LOS, modemRowStatus=modemRowStatus, modemLastAcqError=modemLastAcqError, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, modemTable=modemTable, loopback_tributary_mask=loopback_tributary_mask, description=description, ethRXDones=ethRXDones, radioIndex=radioIndex, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPCHECErrors=ethGFPCHECErrors, radioEntry=radioEntry, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXPauseFrames=ethTXPauseFrames, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, restartcpu=restartcpu, e1t1AIS=e1t1AIS, saf=saf, sysDateAndTime=sysDateAndTime, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, modemGeneralStatus=modemGeneralStatus, license=license, safip=safip, ethRXLongEvents=ethRXLongEvents, ethTXGiants=ethTXGiants, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, hostname=hostname, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadio=ipRadio, ethQOSTXFrames=ethQOSTXFrames, vlanPortmap=vlanPortmap, modemErroredSecondRatio=modemErroredSecondRatio, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, ethRXControlFrames=ethRXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio)
