...
# Produced by pysmi-1.1.12 at Tue Jun  4 14:16:33 2024
...
ModuleIdentity, Bits, Unsigned32, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, TimeTicks, NotificationType, enterprises, MibIdentifier, Counter64, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "TimeTicks", "NotificationType", "enterprises", "MibIdentifier", "Counter64", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", writeConfig=writeConfig, localIp=localIp, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, ethRXControlFrames=ethRXControlFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ethRXBroadcasts=ethRXBroadcasts, modemErroredBlock=modemErroredBlock, ethTXByteCounterHi=ethTXByteCounterHi, modemStatistics=modemStatistics, license=license, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioMgmt=ipRadioMgmt, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanTable=vlanTable, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, modemE1T1Channels=modemE1T1Channels, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemGeneralStatus=modemGeneralStatus, radioTable=radioTable, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMin=modemACMmodulationMin, ethTXPauseFrames=ethTXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBroadcasts=ethTXBroadcasts, ethTXCollisions=ethTXCollisions, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, modemIndex=modemIndex, loopback_tributary_mask=loopback_tributary_mask, modemACMethernetCapacity=modemACMethernetCapacity, radioTxPower=radioTxPower, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, hostname=hostname, radioIndex=radioIndex, restartcpu=restartcpu, radioGenStatus=radioGenStatus, description=description, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, modemRadialMSE=modemRadialMSE, vlanEntry=vlanEntry, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, e1t1AIS=e1t1AIS, remoteIp=remoteIp, modemACMengine=modemACMengine, localIpMask=localIpMask, ethRXLongEvents=ethRXLongEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, product=product, loopbacks=loopbacks, ethTXDones=ethTXDones, radioLoopback=radioLoopback, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemCountTime=modemCountTime, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioSide=radioSide, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, sysDateAndTime=sysDateAndTime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanRowStatus=vlanRowStatus, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, modemTable=modemTable, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1LOS=e1t1LOS, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, ethRXCodeErrors=ethRXCodeErrors, radioEntry=radioEntry, modemUptime=modemUptime, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfg=ipRadioCfg, atpcEnabled=atpcEnabled, ethRXDvEvent=ethRXDvEvent, aTPCEntry=aTPCEntry, ethQOSTXFrames=ethQOSTXFrames, ethTXLateCollisions=ethTXLateCollisions, tehnika=tehnika, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, microwaveRadio=microwaveRadio, modemErroredSecond=modemErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanFid=vlanFid, ethTXCRCErrors=ethTXCRCErrors, ethRXMulticasts=ethRXMulticasts, licenseMask=licenseMask, safip=safip, ethRXDones=ethRXDones, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, ipRadioStatEth=ipRadioStatEth, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset)
