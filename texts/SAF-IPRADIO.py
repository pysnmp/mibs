...
Bits, Counter64, NotificationType, ModuleIdentity, Counter32, IpAddress, TimeTicks, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, Integer32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "TimeTicks", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "Integer32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEntry=modemEntry, e1t1LOS=e1t1LOS, aTPCEntry=aTPCEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSymbolRateRx=modemSymbolRateRx, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMin=modemACMmodulationMin, radioSide=radioSide, modemTotalCapacity=modemTotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, ethTXMulticasts=ethTXMulticasts, ipRadioStat=ipRadioStat, modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIpMask=localIpMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXLateCollisions=ethTXLateCollisions, vlanTable=vlanTable, product=product, ethRXCodeErrors=ethRXCodeErrors, microwaveRadio=microwaveRadio, modemIndex=modemIndex, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, modemTable=modemTable, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, remoteIp=remoteIp, vlanPortmap=vlanPortmap, ipRadioCfgNetwork=ipRadioCfgNetwork, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemTotalBlockNumber=modemTotalBlockNumber, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, modemSymbolRateTx=modemSymbolRateTx, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, modemGeneralStatus=modemGeneralStatus, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXFrames=ethQOSTXFrames, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, ethTXUnderruns=ethTXUnderruns, modemEthernetCapacity=modemEthernetCapacity, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, safip=safip, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCTable=aTPCTable, ipRadioCfg=ipRadioCfg, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCountTime=modemCountTime, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, radioGenStatus=radioGenStatus, ethTXDones=ethTXDones, licenseMask=licenseMask, ethTXCollisions=ethTXCollisions, radioLoopback=radioLoopback, pointToPoint=pointToPoint, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, sysDateAndTime=sysDateAndTime, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, saf=saf, tehnika=tehnika, vlanCfgStat=vlanCfgStat, radioTable=radioTable, atpcEnabled=atpcEnabled, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, atpcIndex=atpcIndex, vlanEntry=vlanEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, modemRowStatus=modemRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioRxFrequency=radioRxFrequency, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxPower=radioTxPower, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, radioDuplexShift=radioDuplexShift, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1AIS=e1t1AIS, e1t1StatTable=e1t1StatTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, license=license, atpcTxPowerCorrection=atpcTxPowerCorrection)
