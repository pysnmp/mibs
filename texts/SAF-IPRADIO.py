...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:51:02 2022
...
Counter32, NotificationType, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, IpAddress, Unsigned32, Bits, NotificationType, MibIdentifier, Integer32, ObjectIdentity, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "IpAddress", "Unsigned32", "Bits", "NotificationType", "MibIdentifier", "Integer32", "ObjectIdentity", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, aTPCTable=aTPCTable, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, radioRxFrequency=radioRxFrequency, ethTXDones=ethTXDones, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, radioDuplexShift=radioDuplexShift, modemStatistics=modemStatistics, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioEntry=radioEntry, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, ethTXVlanTags=ethTXVlanTags, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, microwaveRadio=microwaveRadio, modemAcqStatus=modemAcqStatus, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, radioTxFrequency=radioTxFrequency, ipRadio=ipRadio, atpcEnabled=atpcEnabled, modemEntry=modemEntry, licenseMask=licenseMask, ethRXControlFrames=ethRXControlFrames, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, modemCountTime=modemCountTime, radioTable=radioTable, modemModulation=modemModulation, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanEntry=vlanEntry, ipRadioStatEth=ipRadioStatEth, modemACMengine=modemACMengine, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, modemEthernetCapacity=modemEthernetCapacity, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, ethTXUnderruns=ethTXUnderruns, safip=safip, ethTXLateCollisions=ethTXLateCollisions, localIpMask=localIpMask, modemTotalBlockNumber=modemTotalBlockNumber, radioIndex=radioIndex, product=product, hostname=hostname, loopbacks=loopbacks, ethTXByteCounterHi=ethTXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, description=description, saf=saf, ipRadioStat=ipRadioStat, ipRadioCfgNetwork=ipRadioCfgNetwork, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSymbolRateTx=modemSymbolRateTx, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCEntry=aTPCEntry, modemErroredSecond=modemErroredSecond, license=license, modemRadialMSE=modemRadialMSE, modemUptime=modemUptime, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1ChannelNr=e1t1ChannelNr, ethTXMulticasts=ethTXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, localIp=localIp, modemErroredBlock=modemErroredBlock, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMin=modemACMmodulationMin, writeConfig=writeConfig, radioSide=radioSide, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcIndex=atpcIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, restartcpu=restartcpu, ethRXCodeErrors=ethRXCodeErrors, modemBandwith=modemBandwith, ethRXUnsupOpcodes=ethRXUnsupOpcodes, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, vlanTable=vlanTable, radioLoopback=radioLoopback, modemStandard=modemStandard, modemIndex=modemIndex, vlanPortmap=vlanPortmap, ipRadioCfg=ipRadioCfg)
