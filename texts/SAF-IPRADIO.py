...
# Produced by pysmi-1.1.8 at Fri Jan  7 18:05:30 2022
...
NotificationType, Counter32, TimeTicks, enterprises, Bits, Gauge32, Counter64, iso, NotificationType, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "TimeTicks", "enterprises", "Bits", "Gauge32", "Counter64", "iso", "NotificationType", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTable=modemTable, ethRXControlFrames=ethRXControlFrames, sysTemperature=sysTemperature, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1LOS=e1t1LOS, ethTXCRCErrors=ethTXCRCErrors, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, modemUptime=modemUptime, ethRXCodeErrors=ethRXCodeErrors, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, aTPCTable=aTPCTable, vlansEnabled=vlansEnabled, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, vlanTable=vlanTable, tehnika=tehnika, saf=saf, ethTXGiants=ethTXGiants, ethRXDones=ethRXDones, modemACMethernetCapacity=modemACMethernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, vlanRowStatus=vlanRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, modemRadialMSE=modemRadialMSE, modemIndex=modemIndex, radioLoopback=radioLoopback, modemStatistics=modemStatistics, modemStandard=modemStandard, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, licenseMask=licenseMask, modemACMengine=modemACMengine, ethTXControlFrames=ethTXControlFrames, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, modemACMmodulationMax=modemACMmodulationMax, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortmap=vlanPortmap, restartcpu=restartcpu, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, ethQOSTXDropped=ethQOSTXDropped, atpcIndex=atpcIndex, pointToPoint=pointToPoint, vlanEntry=vlanEntry, vlanPortType=vlanPortType, ipRadioMgmt=ipRadioMgmt, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, radioTxMute=radioTxMute, modemE1T1Channels=modemE1T1Channels, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxPower=radioTxPower, modemSymbolRateTx=modemSymbolRateTx, writeConfig=writeConfig, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalCapacity=modemTotalCapacity, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLongEvents=ethRXLongEvents, radioGenStatus=radioGenStatus, modemGeneralStatus=modemGeneralStatus, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, ethGFPCHECErrors=ethGFPCHECErrors, sysDateAndTime=sysDateAndTime, radioIndex=radioIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, modemEntry=modemEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxFrequency=radioTxFrequency, ethTXCollisions=ethTXCollisions, modemUnavailtime=modemUnavailtime, product=product, remoteIp=remoteIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopbacks=loopbacks, modemBandwith=modemBandwith, modemLastAcqError=modemLastAcqError, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, modemACMmodulationMin=modemACMmodulationMin, license=license, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, description=description, modemSymbolRateRx=modemSymbolRateRx, radioSide=radioSide, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStat=ipRadioStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioDuplexShift=radioDuplexShift, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, radioEntry=radioEntry, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXUnderruns=ethTXUnderruns)
