...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:13:29 2023
...
MibIdentifier, Bits, NotificationType, Counter32, IpAddress, enterprises, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, TimeTicks, Unsigned32, ModuleIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "NotificationType", "Counter32", "IpAddress", "enterprises", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "TimeTicks", "Unsigned32", "ModuleIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, licenseMask=licenseMask, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanFid=vlanFid, vlanNumber=vlanNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1LOS=e1t1LOS, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDvEvent=ethRXDvEvent, modemUptime=modemUptime, modemRowStatus=modemRowStatus, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredBlock=modemErroredBlock, radioTable=radioTable, ethRXCodeErrors=ethRXCodeErrors, modemLastAcqError=modemLastAcqError, ethRXCRCErrors=ethRXCRCErrors, safip=safip, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPauseFrames=ethRXPauseFrames, modemStandard=modemStandard, ipRadio=ipRadio, radioLoopback=radioLoopback, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopbacks=loopbacks, modemLDPCdecoderStress=modemLDPCdecoderStress, saf=saf, pointToPoint=pointToPoint, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, vlansEnabled=vlansEnabled, vlanPortmap=vlanPortmap, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, ethTXMulticasts=ethTXMulticasts, writeConfig=writeConfig, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanCfgStat=vlanCfgStat, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, modemIndex=modemIndex, ethTXMaxCollisions=ethTXMaxCollisions, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPDropedFrames=ethGFPDropedFrames, product=product, microwaveRadio=microwaveRadio, localIpMask=localIpMask, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgGeneral=ipRadioCfgGeneral, sysTemperature=sysTemperature, e1t1AIS=e1t1AIS, vlanTable=vlanTable, ethTXCollisions=ethTXCollisions, modemStatistics=modemStatistics, license=license, ethRXDones=ethRXDones, e1t1ChannelNr=e1t1ChannelNr, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterHi=ethTXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, radioSide=radioSide, description=description, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortType=vlanPortType, modemTable=modemTable, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, hostname=hostname, atpcEnabled=atpcEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, modemE1T1Channels=modemE1T1Channels, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterLow=ethRXByteCounterLow, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioCfg=ipRadioCfg, tehnika=tehnika, vlanEntry=vlanEntry, remoteIp=remoteIp, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBandwith=modemBandwith, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXGiants=ethTXGiants, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, radioRxFrequency=radioRxFrequency)
