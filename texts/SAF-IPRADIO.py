...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:13:59 2021
...
iso, Gauge32, NotificationType, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, enterprises, Counter64, Counter32, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "NotificationType", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "enterprises", "Counter64", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPDropedFrames=ethGFPDropedFrames, modemEthernetCapacity=modemEthernetCapacity, safip=safip, modemTotalBlockNumber=modemTotalBlockNumber, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemUptime=modemUptime, modemAcqStatus=modemAcqStatus, ethRXDvEvent=ethRXDvEvent, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, e1t1ChannelNr=e1t1ChannelNr, description=description, radioTxFrequency=radioTxFrequency, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, modemSymbolRateTx=modemSymbolRateTx, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, restartcpu=restartcpu, vlanTable=vlanTable, modemACMmodulationMax=modemACMmodulationMax, modemModulation=modemModulation, ethRXLongEvents=ethRXLongEvents, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioGenStatus=radioGenStatus, ethTXMaxCollisions=ethTXMaxCollisions, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, licenseUpdateStatus=licenseUpdateStatus, product=product, vlanRowStatus=vlanRowStatus, e1t1LOS=e1t1LOS, modemACMmodulationMin=modemACMmodulationMin, localIp=localIp, ethRXByteCounterLow=ethRXByteCounterLow, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, pointToPoint=pointToPoint, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, sysTemperature=sysTemperature, loopback_tributary_mask=loopback_tributary_mask, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterHi=ethRXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMethernetCapacity=modemACMethernetCapacity, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, modemErroredBlock=modemErroredBlock, ethGFPFCSErrors=ethGFPFCSErrors, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, modemRowStatus=modemRowStatus, vlanPortType=vlanPortType, ethTXGiants=ethTXGiants, ipRadioStatEth=ipRadioStatEth, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxMute=radioTxMute, vlanFid=vlanFid, modemErroredSecond=modemErroredSecond, modemStandard=modemStandard, loopbacks=loopbacks, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatEntry=e1t1StatEntry, vlanEntry=vlanEntry, modemIndex=modemIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateRx=modemSymbolRateRx, e1t1StatTable=e1t1StatTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, license=license, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, tehnika=tehnika, e1t1AIS=e1t1AIS, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, saf=saf, modemBandwith=modemBandwith, ethTXLateCollisions=ethTXLateCollisions, remoteIp=remoteIp, radioTxPower=radioTxPower, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, modemRadialMSE=modemRadialMSE, ethRXUnsupOpcodes=ethRXUnsupOpcodes, writeConfig=writeConfig, localIpMask=localIpMask, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, vlanCfgStat=vlanCfgStat, aTPCTable=aTPCTable, aTPCEntry=aTPCEntry, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, hostname=hostname, ethRXBroadcasts=ethRXBroadcasts, licenseMask=licenseMask, microwaveRadio=microwaveRadio, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, ethTXUnderruns=ethTXUnderruns, atpcIndex=atpcIndex, ethRXCodeErrors=ethRXCodeErrors, ethRXControlFrames=ethRXControlFrames)
