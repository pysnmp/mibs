...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:42:59 2023
...
NotificationType, iso, TimeTicks, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, IpAddress, Counter64, Counter32, Bits, NotificationType, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "IpAddress", "Counter64", "Counter32", "Bits", "NotificationType", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, ethTXGiants=ethTXGiants, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, radioRxLevel=radioRxLevel, vlanNumber=vlanNumber, radioTxPower=radioTxPower, hostname=hostname, modemACMmodulationMin=modemACMmodulationMin, vlansEnabled=vlansEnabled, product=product, e1t1StatTable=e1t1StatTable, e1t1StatEntry=e1t1StatEntry, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXLateCollisions=ethTXLateCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, ethGFPFCSErrors=ethGFPFCSErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, ethRXLongEvents=ethRXLongEvents, remoteIp=remoteIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioIndex=radioIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXDones=ethTXDones, vlanRowStatus=vlanRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1ChannelNr=e1t1ChannelNr, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, radioGenStatus=radioGenStatus, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, modemCarrierOffset=modemCarrierOffset, modemModulation=modemModulation, license=license, sysDateAndTime=sysDateAndTime, radioTxFrequency=radioTxFrequency, modemTable=modemTable, localIp=localIp, modemLastAcqError=modemLastAcqError, restartcpu=restartcpu, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, modemGeneralStatus=modemGeneralStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCRCErrors=ethRXCRCErrors, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, ethRXDribleNibbles=ethRXDribleNibbles, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, safip=safip, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, radioTable=radioTable, licenseMask=licenseMask, ethTXByteCounterLow=ethTXByteCounterLow, modemACMengine=modemACMengine, ethTXMulticasts=ethTXMulticasts, description=description, modemStatistics=modemStatistics, vlanCfgStat=vlanCfgStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, licenseUpdateStatus=licenseUpdateStatus, ethRXDones=ethRXDones, ethTXVlanTags=ethTXVlanTags, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterHi=ethTXWireByteCounterHi, tehnika=tehnika, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, writeConfig=writeConfig, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDropedFrames=ethGFPDropedFrames, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, saf=saf, ethTXPauseFrames=ethTXPauseFrames, modemUptime=modemUptime, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalCapacity=modemTotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, sysTemperature=sysTemperature, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1LOS=e1t1LOS, modemIndex=modemIndex, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, vlanPortType=vlanPortType, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns)
