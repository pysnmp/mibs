...
# Produced by pysmi-1.1.12 at Wed May 29 07:22:29 2024
...
enterprises, Gauge32, ObjectIdentity, Bits, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress, Unsigned32, NotificationType, Counter32, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType", "Counter32", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxMute=radioTxMute, localIp=localIp, modemStandard=modemStandard, e1t1LOS=e1t1LOS, modemStatistics=modemStatistics, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMtotalCapacity=modemACMtotalCapacity, license=license, pointToPoint=pointToPoint, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, modemRadialMSE=modemRadialMSE, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi, saf=saf, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry, modemSymbolRateRx=modemSymbolRateRx, ethRXDribleNibbles=ethRXDribleNibbles, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, e1t1StatTable=e1t1StatTable, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMaxCollisions=ethTXMaxCollisions, loopbacks=loopbacks, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemEntry=modemEntry, ethTXMulticasts=ethTXMulticasts, modemBandwith=modemBandwith, loopback_tributary_mask=loopback_tributary_mask, radioRxLevel=radioRxLevel, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecondRatio=modemErroredSecondRatio, modemModulation=modemModulation, remoteIp=remoteIp, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateTx=modemSymbolRateTx, vlanPortmap=vlanPortmap, description=description, modemErroredSecond=modemErroredSecond, microwaveRadio=microwaveRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterLow=ethRXByteCounterLow, atpcIndex=atpcIndex, licenseMask=licenseMask, modemACMmodulationMin=modemACMmodulationMin, ethTXGiants=ethTXGiants, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, modemLastAcqError=modemLastAcqError, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, radioLoopback=radioLoopback, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, ipRadioMgmt=ipRadioMgmt, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, radioGenStatus=radioGenStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, product=product, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames, localIpMask=localIpMask, aTPCEntry=aTPCEntry, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, ethTXBroadcasts=ethTXBroadcasts, modemACMengine=modemACMengine, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, ethRXDones=ethRXDones, licenseUpdateStatus=licenseUpdateStatus, ethRXCodeErrors=ethRXCodeErrors, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, ethTXDones=ethTXDones, tehnika=tehnika, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, modemTotalCapacity=modemTotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1AIS=e1t1AIS, modemUptime=modemUptime, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemInternalAGCgain=modemInternalAGCgain, modemCarrierOffset=modemCarrierOffset, hostname=hostname, sysDateAndTime=sysDateAndTime, modemIndex=modemIndex, radioIndex=radioIndex, modemRowStatus=modemRowStatus, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, radioSide=radioSide, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDvEvent=ethRXDvEvent, aTPCTable=aTPCTable, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, vlanNumber=vlanNumber, atpcEnabled=atpcEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCRCErrors=ethRXCRCErrors, radioTable=radioTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, restartcpu=restartcpu, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredBlock=modemErroredBlock)
