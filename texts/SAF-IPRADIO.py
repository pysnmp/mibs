...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:24:53 2024
...
Gauge32, ObjectIdentity, TimeTicks, enterprises, ModuleIdentity, MibIdentifier, iso, Bits, Integer32, NotificationType, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "TimeTicks", "enterprises", "ModuleIdentity", "MibIdentifier", "iso", "Bits", "Integer32", "NotificationType", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, radioEntry=radioEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, saf=saf, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, atpcIndex=atpcIndex, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, vlanEntry=vlanEntry, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCRCErrors=ethRXCRCErrors, tehnika=tehnika, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, remoteIp=remoteIp, licenseUpdateStatus=licenseUpdateStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, radioIndex=radioIndex, vlanNumber=vlanNumber, modemRowStatus=modemRowStatus, vlanFid=vlanFid, vlanPortmap=vlanPortmap, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, radioTxMute=radioTxMute, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanTable=vlanTable, modemACMengine=modemACMengine, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, modemLastAcqError=modemLastAcqError, ethRXCodeErrors=ethRXCodeErrors, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioSide=radioSide, localIpMask=localIpMask, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, hostname=hostname, modemUptime=modemUptime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, license=license, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMin=modemACMmodulationMin, radioLoopback=radioLoopback, modemUnavailtime=modemUnavailtime, modemTable=modemTable, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSymbolRateRx=modemSymbolRateRx, ipRadio=ipRadio, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, ethRXByteCounterHi=ethRXByteCounterHi, description=description, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCTable=aTPCTable, ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, modemStandard=modemStandard, licenseMask=licenseMask, ethRXLongEvents=ethRXLongEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, restartcpu=restartcpu, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, modemErroredSecond=modemErroredSecond, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, sysDateAndTime=sysDateAndTime, ethRXDones=ethRXDones, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ethQOSTXDropped=ethQOSTXDropped, ipRadioMgmt=ipRadioMgmt, ethTXCRCErrors=ethTXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredBlock=modemErroredBlock, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, e1t1LOS=e1t1LOS, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, vlansEnabled=vlansEnabled, ethTXBackpresEvents=ethTXBackpresEvents, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, radioTxFrequency=radioTxFrequency, sysTemperature=sysTemperature, modemInternalAGCgain=modemInternalAGCgain, product=product, ipRadioStat=ipRadioStat, ethQOSTXFrames=ethQOSTXFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1Channels=modemE1T1Channels, modemModulation=modemModulation, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, modemACMmodulationMax=modemACMmodulationMax, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, ethQOSRXQ2Frames=ethQOSRXQ2Frames)
