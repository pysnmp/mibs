...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:58:35 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, enterprises, NotificationType, ModuleIdentity, Unsigned32, ObjectIdentity, Gauge32, TimeTicks, Integer32, MibIdentifier, IpAddress, NotificationType, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "enterprises", "NotificationType", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks", "Integer32", "MibIdentifier", "IpAddress", "NotificationType", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, ipRadioStatEth=ipRadioStatEth, ipRadioCfgNetwork=ipRadioCfgNetwork, radioIndex=radioIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethRXMulticasts=ethRXMulticasts, tehnika=tehnika, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, ethRXDones=ethRXDones, license=license, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, e1t1LOS=e1t1LOS, vlanPortType=vlanPortType, ethRXCRCErrors=ethRXCRCErrors, localIpMask=localIpMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, vlanRowStatus=vlanRowStatus, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, e1t1AIS=e1t1AIS, modemEntry=modemEntry, vlanEntry=vlanEntry, modemEthernetCapacity=modemEthernetCapacity, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, ethTXControlFrames=ethTXControlFrames, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, e1t1StatEntry=e1t1StatEntry, pointToPoint=pointToPoint, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, radioGenStatus=radioGenStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, description=description, radioEntry=radioEntry, ethQOSTXFrames=ethQOSTXFrames, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, modemModulation=modemModulation, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPauseFrames=ethRXPauseFrames, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, safip=safip, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXBroadcasts=ethRXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, vlansEnabled=vlansEnabled, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxPower=radioTxPower, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, licenseUpdateStatus=licenseUpdateStatus, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, modemGeneralStatus=modemGeneralStatus, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, radioRxFrequency=radioRxFrequency, modemTotalCapacity=modemTotalCapacity, loopbacks=loopbacks, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMmodulationMin=modemACMmodulationMin, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMengine=modemACMengine, sysDateAndTime=sysDateAndTime, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxMute=radioTxMute, ipRadioMgmt=ipRadioMgmt, remoteIp=remoteIp, aTPCEntry=aTPCEntry, vlanTable=vlanTable, ethRXControlFrames=ethRXControlFrames, modemLastAcqError=modemLastAcqError, modemErroredBlock=modemErroredBlock, saf=saf, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCountTime=modemCountTime, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateTx=modemSymbolRateTx, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStat=ipRadioStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStatistics=modemStatistics, atpcEnabled=atpcEnabled, ipRadioCfg=ipRadioCfg, hostname=hostname, licenseMask=licenseMask, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, atpcTxPowerCorrection=atpcTxPowerCorrection, modemIndex=modemIndex, radioSide=radioSide)
