...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:15:41 2024
...
Bits, Unsigned32, enterprises, NotificationType, NotificationType, iso, IpAddress, TimeTicks, Gauge32, Integer32, ObjectIdentity, MibIdentifier, Counter64, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "enterprises", "NotificationType", "NotificationType", "iso", "IpAddress", "TimeTicks", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter64", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, vlanTable=vlanTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCarrierOffset=modemCarrierOffset, restartcpu=restartcpu, ipRadio=ipRadio, vlanCfgStat=vlanCfgStat, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, ethGFPCHECErrors=ethGFPCHECErrors, modemStandard=modemStandard, modemTable=modemTable, product=product, modemCountTime=modemCountTime, ethRXDribleNibbles=ethRXDribleNibbles, modemModulation=modemModulation, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, modemUnavailtime=modemUnavailtime, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, modemACMengine=modemACMengine, radioTxMute=radioTxMute, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, modemErroredSecond=modemErroredSecond, saf=saf, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMax=modemACMmodulationMax, description=description, radioTxFrequency=radioTxFrequency, localIp=localIp, e1t1ChannelNr=e1t1ChannelNr, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioMgmt=ipRadioMgmt, ethTXVlanTags=ethTXVlanTags, vlansEnabled=vlansEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateTx=modemSymbolRateTx, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanPortType=vlanPortType, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, radioIndex=radioIndex, modemRowStatus=modemRowStatus, radioRxFrequency=radioRxFrequency, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, modemRadialMSE=modemRadialMSE, ethRXControlFrames=ethRXControlFrames, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLastAcqError=modemLastAcqError, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXControlFrames=ethTXControlFrames, radioRxLevel=radioRxLevel, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS, ethTXGiants=ethTXGiants, hostname=hostname, radioDuplexShift=radioDuplexShift, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, ethTXPauseFrames=ethTXPauseFrames, modemUptime=modemUptime, safip=safip, radioEntry=radioEntry, radioSide=radioSide, aTPCTable=aTPCTable, modemTotalBlockNumber=modemTotalBlockNumber, license=license, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, ethRXDones=ethRXDones, modemStatistics=modemStatistics, localIpMask=localIpMask, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, vlanRowStatus=vlanRowStatus, modemACMethernetCapacity=modemACMethernetCapacity, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxPower=radioTxPower, radioTable=radioTable, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseMask=licenseMask, ipRadioStat=ipRadioStat, modemErroredBlock=modemErroredBlock, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, writeConfig=writeConfig)
