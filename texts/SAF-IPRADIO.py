...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:15:31 2021
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, NotificationType, IpAddress, enterprises, ModuleIdentity, NotificationType, iso, Bits, Counter64, MibIdentifier, TimeTicks, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "NotificationType", "IpAddress", "enterprises", "ModuleIdentity", "NotificationType", "iso", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterHi=ethRXByteCounterHi, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterLow=ethRXByteCounterLow, radioDuplexShift=radioDuplexShift, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask, ethRXDvEvent=ethRXDvEvent, product=product, modemGeneralStatus=modemGeneralStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXMulticasts=ethRXMulticasts, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, microwaveRadio=microwaveRadio, localIp=localIp, radioTxMute=radioTxMute, modemACMmodulationMin=modemACMmodulationMin, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1ChannelNr=e1t1ChannelNr, ipRadioStat=ipRadioStat, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, vlanCfgStat=vlanCfgStat, modemRowStatus=modemRowStatus, safip=safip, pointToPoint=pointToPoint, ethTXDones=ethTXDones, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, radioGenStatus=radioGenStatus, modemEthernetCapacity=modemEthernetCapacity, loopback_tributary_mask=loopback_tributary_mask, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, ethRXControlFrames=ethRXControlFrames, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethRXDones=ethRXDones, e1t1StatEntry=e1t1StatEntry, vlanPortmap=vlanPortmap, modemStatistics=modemStatistics, ethQOSRXQ1Frames=ethQOSRXQ1Frames, remoteIp=remoteIp, ethTXUnderruns=ethTXUnderruns, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioMgmt=ipRadioMgmt, radioIndex=radioIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, licenseUpdateStatus=licenseUpdateStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethRXBroadcasts=ethRXBroadcasts, radioTable=radioTable, sysDateAndTime=sysDateAndTime, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalBlockNumber=modemTotalBlockNumber, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, vlanRowStatus=vlanRowStatus, ethQOSTXDropped=ethQOSTXDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemCountTime=modemCountTime, modemACMethernetCapacity=modemACMethernetCapacity, ipRadio=ipRadio, modemACMtotalCapacity=modemACMtotalCapacity, license=license, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCollisions=ethTXCollisions, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, modemEntry=modemEntry, hostname=hostname, aTPCEntry=aTPCEntry, modemTotalCapacity=modemTotalCapacity, writeConfig=writeConfig, modemE1T1Channels=modemE1T1Channels, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXLongEvents=ethRXLongEvents, modemStandard=modemStandard, modemBandwith=modemBandwith, vlansEnabled=vlansEnabled, modemACMmodulationMax=modemACMmodulationMax, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, sysTemperature=sysTemperature, e1t1StatTable=e1t1StatTable, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, ethTXMulticasts=ethTXMulticasts, description=description, ethQOSTXFrames=ethQOSTXFrames, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredBlock=modemErroredBlock, modemIndex=modemIndex, ethTXGiants=ethTXGiants, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXTruncatedFrames=ethRXTruncatedFrames, saf=saf, modemTable=modemTable)
