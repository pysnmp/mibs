...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:43:07 2024
...
NotificationType, NotificationType, iso, ModuleIdentity, IpAddress, MibIdentifier, enterprises, Gauge32, Integer32, Counter64, ObjectIdentity, Unsigned32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "iso", "ModuleIdentity", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "Integer32", "Counter64", "ObjectIdentity", "Unsigned32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, modemSymbolRateTx=modemSymbolRateTx, ethRXDvEvent=ethRXDvEvent, saf=saf, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStat=ipRadioStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXDropped=ethQOSTXDropped, vlanCfgStat=vlanCfgStat, ethTXCRCErrors=ethTXCRCErrors, ethRXDones=ethRXDones, modemACMengine=modemACMengine, modemRadialMSE=modemRadialMSE, radioEntry=radioEntry, microwaveRadio=microwaveRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, modemIndex=modemIndex, ethRXPauseFrames=ethRXPauseFrames, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, modemRowStatus=modemRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, modemE1T1Channels=modemE1T1Channels, modemCarrierOffset=modemCarrierOffset, e1t1AIS=e1t1AIS, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, modemStatistics=modemStatistics, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadio=ipRadio, ipRadioCfg=ipRadioCfg, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, ipRadioMgmt=ipRadioMgmt, radioGenStatus=radioGenStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemStandard=modemStandard, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, localIp=localIp, loopbacks=loopbacks, ethRXLongEvents=ethRXLongEvents, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones, radioLoopback=radioLoopback, ethTXCollisions=ethTXCollisions, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, remoteIp=remoteIp, vlansEnabled=vlansEnabled, license=license, tehnika=tehnika, modemLastAcqError=modemLastAcqError, modemEntry=modemEntry, description=description, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, aTPCEntry=aTPCEntry, writeConfig=writeConfig, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, modemAcqStatus=modemAcqStatus, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, product=product, safip=safip, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanFid=vlanFid, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, radioIndex=radioIndex, radioSide=radioSide, radioTxMute=radioTxMute, aTPCTable=aTPCTable, modemModulation=modemModulation, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, ethTXVlanTags=ethTXVlanTags, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxFrequency=radioRxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, localIpMask=localIpMask, radioRxLevel=radioRxLevel, ethTXControlFrames=ethTXControlFrames, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, licenseMask=licenseMask, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled)
