...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:48:03 2023
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Unsigned32, MibIdentifier, TimeTicks, Counter32, iso, NotificationType, Gauge32, ModuleIdentity, Bits, NotificationType, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Unsigned32", "MibIdentifier", "TimeTicks", "Counter32", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "Bits", "NotificationType", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, vlanPortmap=vlanPortmap, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, radioTxFrequency=radioTxFrequency, restartcpu=restartcpu, vlanNumber=vlanNumber, modemRowStatus=modemRowStatus, radioRxLevel=radioRxLevel, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, ethTXVlanTags=ethTXVlanTags, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDvEvent=ethRXDvEvent, writeConfig=writeConfig, ethRXCodeErrors=ethRXCodeErrors, ethRXBroadcasts=ethRXBroadcasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, radioLoopback=radioLoopback, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMulticasts=ethTXMulticasts, vlanCfgStat=vlanCfgStat, localIp=localIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1Channels=modemE1T1Channels, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDones=ethRXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEntry=modemEntry, radioSide=radioSide, vlanPortType=vlanPortType, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, modemTable=modemTable, vlansEnabled=vlansEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, hostname=hostname, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, pointToPoint=pointToPoint, modemLastAcqError=modemLastAcqError, licenseUpdateStatus=licenseUpdateStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, remoteIp=remoteIp, ethTXGiants=ethTXGiants, description=description, atpcEnabled=atpcEnabled, product=product, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, modemErroredSecond=modemErroredSecond, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, localIpMask=localIpMask, ethQOSTXDropped=ethQOSTXDropped, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, ipRadio=ipRadio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMax=modemACMmodulationMax, loopbacks=loopbacks, safip=safip, ethTXCollisions=ethTXCollisions, license=license, modemTotalCapacity=modemTotalCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethTXLateCollisions=ethTXLateCollisions, radioTable=radioTable, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, aTPCTable=aTPCTable, radioEntry=radioEntry, tehnika=tehnika, radioIndex=radioIndex, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, modemStandard=modemStandard, modemAcqStatus=modemAcqStatus, microwaveRadio=microwaveRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatTable=e1t1StatTable, radioTxMute=radioTxMute, atpcIndex=atpcIndex, sysTemperature=sysTemperature, ethRXMulticasts=ethRXMulticasts, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, modemSymbolRateTx=modemSymbolRateTx, ethTXUnderruns=ethTXUnderruns, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped)
