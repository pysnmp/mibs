...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:16:08 2021
...
Unsigned32, Counter32, IpAddress, Counter64, TimeTicks, Gauge32, Bits, iso, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Integer32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "IpAddress", "Counter64", "TimeTicks", "Gauge32", "Bits", "iso", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Integer32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCRCErrors=ethRXCRCErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecond=modemErroredSecond, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, writeConfig=writeConfig, e1t1LOS=e1t1LOS, ethTXByteCounterLow=ethTXByteCounterLow, modemEntry=modemEntry, radioTxMute=radioTxMute, modemRadialMSE=modemRadialMSE, saf=saf, aTPCEntry=aTPCEntry, modemACMmodulationMax=modemACMmodulationMax, ipRadioStatEth=ipRadioStatEth, loopback_tributary_mask=loopback_tributary_mask, modemInternalAGCgain=modemInternalAGCgain, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, aTPCTable=aTPCTable, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, description=description, radioDuplexShift=radioDuplexShift, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUnavailtime=modemUnavailtime, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, modemSymbolRateRx=modemSymbolRateRx, modemE1T1Channels=modemE1T1Channels, modemModulation=modemModulation, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, ethRXLongEvents=ethRXLongEvents, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, vlanCfgStat=vlanCfgStat, safip=safip, modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethTXGiants=ethTXGiants, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXPauseFrames=ethTXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMengine=modemACMengine, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, modemErroredSecondRatio=modemErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, modemBandwith=modemBandwith, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioStat=ipRadioStat, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDelineationErrors=ethGFPDelineationErrors, sysTemperature=sysTemperature, loopbacks=loopbacks, localIp=localIp, radioTable=radioTable, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfg=ipRadioCfg, vlanNumber=vlanNumber, radioIndex=radioIndex, modemCarrierOffset=modemCarrierOffset, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTotalCapacity=modemTotalCapacity, pointToPoint=pointToPoint, modemACMmodulationMin=modemACMmodulationMin, modemRowStatus=modemRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, radioTxFrequency=radioTxFrequency, modemTable=modemTable, radioRxLevel=radioRxLevel, radioSide=radioSide, vlanPortType=vlanPortType, radioLoopback=radioLoopback, ipRadioMgmt=ipRadioMgmt, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredBlock=modemErroredBlock, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxPower=radioTxPower, e1t1AIS=e1t1AIS, ethQOSTXDropped=ethQOSTXDropped, restartcpu=restartcpu, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, ethRXControlFrames=ethRXControlFrames, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemStatistics=modemStatistics, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, product=product, vlanTable=vlanTable, vlanFid=vlanFid, sysDateAndTime=sysDateAndTime, radioEntry=radioEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, localIpMask=localIpMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow)
