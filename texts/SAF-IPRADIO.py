...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:37:13 2023
...
NotificationType, NotificationType, ModuleIdentity, iso, Integer32, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, Counter32, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "ModuleIdentity", "iso", "Integer32", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "Counter32", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", license=license, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTable=radioTable, modemUnavailtime=modemUnavailtime, modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, radioRxLevel=radioRxLevel, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStatistics=modemStatistics, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, modemErroredSecond=modemErroredSecond, vlanTable=vlanTable, ethRXDribleNibbles=ethRXDribleNibbles, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPauseFrames=ethRXPauseFrames, ipRadioMgmt=ipRadioMgmt, radioSide=radioSide, vlanFid=vlanFid, ethRXBroadcasts=ethRXBroadcasts, modemTable=modemTable, vlanPortmap=vlanPortmap, ethRXLongEvents=ethRXLongEvents, modemSymbolRateRx=modemSymbolRateRx, radioIndex=radioIndex, ethTXControlFrames=ethTXControlFrames, vlanCfgStat=vlanCfgStat, ethGFPDelineationErrors=ethGFPDelineationErrors, restartcpu=restartcpu, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, sysDateAndTime=sysDateAndTime, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, licenseUpdateStatus=licenseUpdateStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMin=modemACMmodulationMin, ethRXDones=ethRXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, modemAcqStatus=modemAcqStatus, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStandard=modemStandard, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, writeConfig=writeConfig, modemE1T1ChannelMask=modemE1T1ChannelMask, radioLoopback=radioLoopback, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBandwith=modemBandwith, safip=safip, licenseMask=licenseMask, ethTXUnderruns=ethTXUnderruns, aTPCTable=aTPCTable, ethRXControlFrames=ethRXControlFrames, ethTXDones=ethTXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, saf=saf, modemModulation=modemModulation, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCRCErrors=ethRXCRCErrors, description=description, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMengine=modemACMengine, loopbacks=loopbacks, radioTxPower=radioTxPower, radioGenStatus=radioGenStatus, ethRXMulticasts=ethRXMulticasts, modemEntry=modemEntry, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, hostname=hostname, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, modemTotalCapacity=modemTotalCapacity, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, modemRadialMSE=modemRadialMSE, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, vlanNumber=vlanNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanEntry=vlanEntry, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, remoteIp=remoteIp, modemIndex=modemIndex, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterHi=ethRXByteCounterHi)
