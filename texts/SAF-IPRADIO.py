...
MibIdentifier, ModuleIdentity, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter32, Unsigned32, NotificationType, enterprises, Integer32, TimeTicks, IpAddress, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter32", "Unsigned32", "NotificationType", "enterprises", "Integer32", "TimeTicks", "IpAddress", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXVlanTagsDetected=ethRXVlanTagsDetected, microwaveRadio=microwaveRadio, atpcEnabled=atpcEnabled, modemEntry=modemEntry, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, vlanRowStatus=vlanRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysTemperature=sysTemperature, radioTxPower=radioTxPower, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, localIpMask=localIpMask, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, vlanPortmap=vlanPortmap, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, ethTXGiants=ethTXGiants, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, modemUptime=modemUptime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTable=modemTable, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, ethRXDvEvent=ethRXDvEvent, vlanFid=vlanFid, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, license=license, e1t1StatEntry=e1t1StatEntry, radioRxLevel=radioRxLevel, modemStandard=modemStandard, e1t1StatTable=e1t1StatTable, sysDateAndTime=sysDateAndTime, description=description, radioTxFrequency=radioTxFrequency, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, restartcpu=restartcpu, aTPCTable=aTPCTable, ethQOSTXFrames=ethQOSTXFrames, modemTotalCapacity=modemTotalCapacity, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, radioGenStatus=radioGenStatus, product=product, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPrevPktDropped=ethRXPrevPktDropped, radioIndex=radioIndex, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors, pointToPoint=pointToPoint, localIp=localIp, vlanPortType=vlanPortType, safip=safip, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, hostname=hostname, radioLoopback=radioLoopback, e1t1AIS=e1t1AIS, ipRadioMgmt=ipRadioMgmt, ipRadio=ipRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXControlFrames=ethRXControlFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, tehnika=tehnika, modemRadialMSE=modemRadialMSE, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXDropped=ethQOSTXDropped, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemIndex=modemIndex, radioEntry=radioEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLastAcqError=modemLastAcqError, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRowStatus=modemRowStatus, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLongEvents=ethRXLongEvents, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, remoteIp=remoteIp, ethRXByteCounterLow=ethRXByteCounterLow, saf=saf, modemBandwith=modemBandwith, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, ethTXDones=ethTXDones)
