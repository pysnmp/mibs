...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:15:08 2022
...
enterprises, IpAddress, iso, Bits, NotificationType, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, Integer32, MibIdentifier, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "iso", "Bits", "NotificationType", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "Integer32", "MibIdentifier", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, vlanPortType=vlanPortType, radioTxPower=radioTxPower, ethQOSTXDropped=ethQOSTXDropped, ethTXDones=ethTXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, e1t1LOS=e1t1LOS, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, saf=saf, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, vlanCfgStat=vlanCfgStat, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, tehnika=tehnika, ethGFPDropedFrames=ethGFPDropedFrames, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, modemAcqStatus=modemAcqStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, product=product, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanEntry=vlanEntry, ethRXCodeErrors=ethRXCodeErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, microwaveRadio=microwaveRadio, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, modemRadialMSE=modemRadialMSE, radioSide=radioSide, radioLoopback=radioLoopback, licenseMask=licenseMask, modemTable=modemTable, ethRXMulticasts=ethRXMulticasts, modemEntry=modemEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemStatistics=modemStatistics, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, remoteIp=remoteIp, ipRadioStatEth=ipRadioStatEth, e1t1StatTable=e1t1StatTable, ethRXDribleNibbles=ethRXDribleNibbles, pointToPoint=pointToPoint, description=description, licenseUpdateStatus=licenseUpdateStatus, ipRadioStat=ipRadioStat, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, modemErroredSecondRatio=modemErroredSecondRatio, vlanFid=vlanFid, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXControlFrames=ethRXControlFrames, modemSymbolRateTx=modemSymbolRateTx, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, modemRowStatus=modemRowStatus, safip=safip, modemACMengine=modemACMengine, license=license, sysDateAndTime=sysDateAndTime, ethRXDones=ethRXDones, modemBandwith=modemBandwith, modemACMmodulationMax=modemACMmodulationMax, restartcpu=restartcpu, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMulticasts=ethTXMulticasts, ethRXCRCErrors=ethRXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanTable=vlanTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxLevel=radioRxLevel, radioTxFrequency=radioTxFrequency, ipRadio=ipRadio, ethTXVlanTags=ethTXVlanTags, modemModulation=modemModulation, radioGenStatus=radioGenStatus, ethTXPauseFrames=ethTXPauseFrames, radioEntry=radioEntry, modemEthernetCapacity=modemEthernetCapacity, modemIndex=modemIndex, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, ethTXCollisions=ethTXCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, modemInternalAGCgain=modemInternalAGCgain, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, radioIndex=radioIndex, modemCarrierOffset=modemCarrierOffset, loopbacks=loopbacks, modemUptime=modemUptime, modemCountTime=modemCountTime, radioTxMute=radioTxMute, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, vlanPortmap=vlanPortmap, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork)
