...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:28:01 2022
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStatistics=modemStatistics, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, ethRXControlFrames=ethRXControlFrames, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, ethTXDones=ethTXDones, localIpMask=localIpMask, microwaveRadio=microwaveRadio, radioRxLevel=radioRxLevel, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUptime=modemUptime, tehnika=tehnika, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, safip=safip, saf=saf, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, vlanTable=vlanTable, ipRadioMgmt=ipRadioMgmt, modemModulation=modemModulation, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysDateAndTime=sysDateAndTime, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, loopback_tributary_mask=loopback_tributary_mask, e1t1AIS=e1t1AIS, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, ipRadioCfg=ipRadioCfg, remoteIp=remoteIp, vlanEntry=vlanEntry, product=product, vlansEnabled=vlansEnabled, modemE1T1Channels=modemE1T1Channels, radioRxFrequency=radioRxFrequency, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, radioGenStatus=radioGenStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredBlock=modemErroredBlock, ethRXPauseFrames=ethRXPauseFrames, radioIndex=radioIndex, licenseUpdateStatus=licenseUpdateStatus, e1t1LOS=e1t1LOS, ipRadio=ipRadio, radioLoopback=radioLoopback, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, pointToPoint=pointToPoint, licenseMask=licenseMask, atpcEnabled=atpcEnabled, modemErroredSecond=modemErroredSecond, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, ipRadioStat=ipRadioStat, vlanFid=vlanFid, sysTemperature=sysTemperature, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ethRXDones=ethRXDones, modemRadialMSE=modemRadialMSE, e1t1StatEntry=e1t1StatEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMethernetCapacity=modemACMethernetCapacity, modemLastAcqError=modemLastAcqError, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, license=license, ethRXByteCounterHi=ethRXByteCounterHi, modemCarrierOffset=modemCarrierOffset, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, modemRowStatus=modemRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, modemEntry=modemEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStandard=modemStandard, modemCountTime=modemCountTime, vlanRowStatus=vlanRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLateCollisions=ethTXLateCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXPauseFrames=ethTXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalCapacity=modemTotalCapacity, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, modemACMmodulationMin=modemACMmodulationMin, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, writeConfig=writeConfig, ethRXCRCErrors=ethRXCRCErrors, radioTable=radioTable, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, description=description, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, radioTxMute=radioTxMute)
