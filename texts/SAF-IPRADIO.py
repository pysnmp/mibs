...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:23:28 2023
...
NotificationType, Counter64, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Gauge32, ObjectIdentity, Unsigned32, NotificationType, iso, enterprises, ModuleIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "NotificationType", "iso", "enterprises", "ModuleIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, saf=saf, e1t1StatTable=e1t1StatTable, ethRXBroadcasts=ethRXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatEntry=e1t1StatEntry, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, radioEntry=radioEntry, modemUnavailtime=modemUnavailtime, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, aTPCEntry=aTPCEntry, modemUptime=modemUptime, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, vlanTable=vlanTable, localIp=localIp, vlanNumber=vlanNumber, hostname=hostname, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, ipRadio=ipRadio, modemACMmodulationMax=modemACMmodulationMax, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, aTPCTable=aTPCTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDribleNibbles=ethRXDribleNibbles, writeConfig=writeConfig, atpcEnabled=atpcEnabled, modemTotalBlockNumber=modemTotalBlockNumber, vlanEntry=vlanEntry, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, modemEntry=modemEntry, ethQOSTXFrames=ethQOSTXFrames, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxMute=radioTxMute, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLateCollisions=ethTXLateCollisions, ethTXDones=ethTXDones, localIpMask=localIpMask, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfg=ipRadioCfg, ethTXByteCounterHi=ethTXByteCounterHi, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxFrequency=radioTxFrequency, radioRxFrequency=radioRxFrequency, modemEthernetCapacity=modemEthernetCapacity, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, restartcpu=restartcpu, atpcIndex=atpcIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMengine=modemACMengine, modemRadialMSE=modemRadialMSE, licenseMask=licenseMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, loopbacks=loopbacks, modemModulation=modemModulation, modemAcqStatus=modemAcqStatus, license=license, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, microwaveRadio=microwaveRadio, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, modemSymbolRateTx=modemSymbolRateTx, e1t1AIS=e1t1AIS, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, sysTemperature=sysTemperature, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, ethTXMaxCollisions=ethTXMaxCollisions, modemIndex=modemIndex, ethTXPauseFrames=ethTXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanRowStatus=vlanRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, safip=safip, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredBlock=modemErroredBlock, modemGeneralStatus=modemGeneralStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1LOS=e1t1LOS, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, vlansEnabled=vlansEnabled, description=description, ethTXControlFrames=ethTXControlFrames)
