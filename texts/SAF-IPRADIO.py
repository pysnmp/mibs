...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:41:17 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Integer32, Counter64, iso, Bits, ObjectIdentity, NotificationType, Unsigned32, enterprises, Counter32, IpAddress, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter64", "iso", "Bits", "ObjectIdentity", "NotificationType", "Unsigned32", "enterprises", "Counter32", "IpAddress", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, modemModulation=modemModulation, sysDateAndTime=sysDateAndTime, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecond=modemErroredSecond, radioEntry=radioEntry, ethTXDones=ethTXDones, licenseMask=licenseMask, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, description=description, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMaxCollisions=ethTXMaxCollisions, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, radioRxLevel=radioRxLevel, license=license, modemCountTime=modemCountTime, radioTxMute=radioTxMute, e1t1StatEntry=e1t1StatEntry, ethRXMulticasts=ethRXMulticasts, modemUptime=modemUptime, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, ethRXByteCounterHi=ethRXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, tehnika=tehnika, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecondRatio=modemErroredSecondRatio, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, ethRXPauseFrames=ethRXPauseFrames, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemLDPCdecoderStress=modemLDPCdecoderStress, modemIndex=modemIndex, modemUnavailtime=modemUnavailtime, e1t1ChannelNr=e1t1ChannelNr, remoteIp=remoteIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysTemperature=sysTemperature, ethRXPrevPktDropped=ethRXPrevPktDropped, pointToPoint=pointToPoint, product=product, modemStatistics=modemStatistics, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanPortmap=vlanPortmap, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTable=radioTable, microwaveRadio=microwaveRadio, atpcEnabled=atpcEnabled, radioGenStatus=radioGenStatus, radioLoopback=radioLoopback, radioTxPower=radioTxPower, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortType=vlanPortType, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, vlanEntry=vlanEntry, ethTXUnderruns=ethTXUnderruns, e1t1StatTable=e1t1StatTable, ethGFPFCSErrors=ethGFPFCSErrors, safip=safip, vlanFid=vlanFid, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTable=modemTable, modemACMengine=modemACMengine, vlanRowStatus=vlanRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIp=localIp, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1Channels=modemE1T1Channels, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXFrames=ethQOSTXFrames, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, modemAcqStatus=modemAcqStatus, ethRXDvEvent=ethRXDvEvent, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, modemInternalAGCgain=modemInternalAGCgain, ipRadio=ipRadio, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, modemEntry=modemEntry, saf=saf, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCarrierOffset=modemCarrierOffset, hostname=hostname, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, loopback_tributary_mask=loopback_tributary_mask, ethGFPCHECErrors=ethGFPCHECErrors, ethRXBroadcasts=ethRXBroadcasts, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStat=ipRadioStat)
