...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:42:25 2023
...
Unsigned32, Gauge32, NotificationType, iso, enterprises, Counter32, TimeTicks, IpAddress, Bits, Integer32, Counter64, ModuleIdentity, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "NotificationType", "iso", "enterprises", "Counter32", "TimeTicks", "IpAddress", "Bits", "Integer32", "Counter64", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEntry=modemEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, ethTXByteCounterHi=ethTXByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCarrierOffset=modemCarrierOffset, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterLow=ethRXByteCounterLow, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStat=ipRadioStat, atpcIndex=atpcIndex, vlanEntry=vlanEntry, saf=saf, aTPCEntry=aTPCEntry, ethTXGiants=ethTXGiants, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, description=description, ipRadioStatEth=ipRadioStatEth, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecond=modemErroredSecond, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDropedFrames=ethGFPDropedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecondRatio=modemErroredSecondRatio, radioEntry=radioEntry, ipRadio=ipRadio, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, modemLastAcqError=modemLastAcqError, modemCountTime=modemCountTime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemModulation=modemModulation, modemIndex=modemIndex, localIpMask=localIpMask, radioTable=radioTable, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBandwith=modemBandwith, radioGenStatus=radioGenStatus, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, e1t1AIS=e1t1AIS, vlanRowStatus=vlanRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopbacks=loopbacks, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, modemEthernetCapacity=modemEthernetCapacity, loopback_tributary_mask=loopback_tributary_mask, license=license, radioTxMute=radioTxMute, safip=safip, radioIndex=radioIndex, modemSymbolRateTx=modemSymbolRateTx, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioRxFrequency=radioRxFrequency, ethTXLateCollisions=ethTXLateCollisions, restartcpu=restartcpu, modemInternalAGCgain=modemInternalAGCgain, ethRXControlFrames=ethRXControlFrames, vlanNumber=vlanNumber, modemRowStatus=modemRowStatus, ethRXCRCErrors=ethRXCRCErrors, e1t1StatTable=e1t1StatTable, product=product, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, ethRXBroadcasts=ethRXBroadcasts, microwaveRadio=microwaveRadio, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, modemACMengine=modemACMengine, ethRXDones=ethRXDones, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, radioTxPower=radioTxPower, vlanCfgStat=vlanCfgStat, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, ethTXBackpresEvents=ethTXBackpresEvents, radioSide=radioSide, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, ethTXMulticasts=ethTXMulticasts, remoteIp=remoteIp, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, vlanFid=vlanFid, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, vlanPortmap=vlanPortmap, ethQOSTXDropped=ethQOSTXDropped, modemAcqStatus=modemAcqStatus, ethTXControlFrames=ethTXControlFrames, ethTXCRCErrors=ethTXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, e1t1StatEntry=e1t1StatEntry, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, pointToPoint=pointToPoint, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXFrames=ethQOSTXFrames)
