...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:26:03 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, NotificationType, TimeTicks, Counter64, Bits, IpAddress, Gauge32, iso, ModuleIdentity, MibIdentifier, ObjectIdentity, NotificationType, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "NotificationType", "TimeTicks", "Counter64", "Bits", "IpAddress", "Gauge32", "iso", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "NotificationType", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, modemEntry=modemEntry, modemUptime=modemUptime, product=product, ethQOSTXDropped=ethQOSTXDropped, modemStatistics=modemStatistics, modemSymbolRateRx=modemSymbolRateRx, radioDuplexShift=radioDuplexShift, vlanFid=vlanFid, modemCountTime=modemCountTime, ethRXByteCounterHi=ethRXByteCounterHi, vlanEntry=vlanEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, radioLoopback=radioLoopback, radioTxMute=radioTxMute, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames, safip=safip, modemAcqStatus=modemAcqStatus, ethRXByteCounterLow=ethRXByteCounterLow, modemIndex=modemIndex, pointToPoint=pointToPoint, vlanTable=vlanTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCEntry=aTPCEntry, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, ethTXGiants=ethTXGiants, ethRXBroadcasts=ethRXBroadcasts, radioEntry=radioEntry, radioGenStatus=radioGenStatus, modemErroredSecond=modemErroredSecond, ethTXBroadcasts=ethTXBroadcasts, e1t1StatTable=e1t1StatTable, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, vlanNumber=vlanNumber, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemModulation=modemModulation, ethRXDvEvent=ethRXDvEvent, ethTXCollisions=ethTXCollisions, ethQOSTXFrames=ethQOSTXFrames, modemRowStatus=modemRowStatus, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, ethRXMulticasts=ethRXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, radioIndex=radioIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcIndex=atpcIndex, ethGFPFCSErrors=ethGFPFCSErrors, saf=saf, modemACMmodulationMax=modemACMmodulationMax, radioTxPower=radioTxPower, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, ethRXControlFrames=ethRXControlFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMengine=modemACMengine, modemACMmodulationMin=modemACMmodulationMin, ethGFPDelineationErrors=ethGFPDelineationErrors, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, restartcpu=restartcpu, localIpMask=localIpMask, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, tehnika=tehnika, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXControlFrames=ethTXControlFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1Channels=modemE1T1Channels, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxFrequency=radioTxFrequency, modemGeneralStatus=modemGeneralStatus, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStat=ipRadioStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, licenseUpdateStatus=licenseUpdateStatus, ethRXCodeErrors=ethRXCodeErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTable=modemTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, license=license, ipRadioCfg=ipRadioCfg, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, vlanCfgStat=vlanCfgStat, localIp=localIp, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, writeConfig=writeConfig, radioSide=radioSide, microwaveRadio=microwaveRadio, ethRXCRCErrors=ethRXCRCErrors, ethRXDones=ethRXDones, loopback_tributary_mask=loopback_tributary_mask, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, sysTemperature=sysTemperature, radioRxFrequency=radioRxFrequency, e1t1AIS=e1t1AIS, vlanPortType=vlanPortType, description=description, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity)
