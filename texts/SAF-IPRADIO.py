...
# Produced by pysmi-1.1.12 at Wed May 29 06:50:29 2024
...
ModuleIdentity, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, IpAddress, iso, MibIdentifier, ObjectIdentity, NotificationType, Counter32, Gauge32, Bits, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "IpAddress", "iso", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter32", "Gauge32", "Bits", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEntry=modemEntry, modemRadialMSE=modemRadialMSE, description=description, sysTemperature=sysTemperature, radioTxPower=radioTxPower, ethRXMulticasts=ethRXMulticasts, ethTXPauseFrames=ethTXPauseFrames, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRowStatus=modemRowStatus, modemTotalCapacity=modemTotalCapacity, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemGeneralStatus=modemGeneralStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioMgmt=ipRadioMgmt, modemACMmodulationMax=modemACMmodulationMax, modemUptime=modemUptime, vlanNumber=vlanNumber, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, localIpMask=localIpMask, radioSide=radioSide, ethTXMaxCollisions=ethTXMaxCollisions, ethTXControlFrames=ethTXControlFrames, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, radioDuplexShift=radioDuplexShift, radioLoopback=radioLoopback, modemE1T1Channels=modemE1T1Channels, tehnika=tehnika, e1t1StatEntry=e1t1StatEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcIndex=atpcIndex, modemIndex=modemIndex, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, ethTXGiants=ethTXGiants, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCTable=aTPCTable, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, writeConfig=writeConfig, modemLDPCdecoderStress=modemLDPCdecoderStress, radioIndex=radioIndex, vlanPortType=vlanPortType, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStat=ipRadioStat, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDvEvent=ethRXDvEvent, ethRXControlFrames=ethRXControlFrames, license=license, safip=safip, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPFCSErrors=ethGFPFCSErrors, localIp=localIp, ethTXUnderruns=ethTXUnderruns, modemModulation=modemModulation, hostname=hostname, ethTXDones=ethTXDones, radioRxLevel=radioRxLevel, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXBroadcasts=ethTXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, ethRXDones=ethRXDones, saf=saf, vlanFid=vlanFid, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterHi=ethTXByteCounterHi, sysDateAndTime=sysDateAndTime, licenseMask=licenseMask, vlansEnabled=vlansEnabled, product=product, vlanPortmap=vlanPortmap, modemACMengine=modemACMengine, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, modemStatistics=modemStatistics, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, remoteIp=remoteIp, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLateCollisions=ethTXLateCollisions, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, ethTXMulticasts=ethTXMulticasts, aTPCEntry=aTPCEntry, vlanCfgStat=vlanCfgStat, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecond=modemErroredSecond, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, radioEntry=radioEntry, microwaveRadio=microwaveRadio, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped)
