...
# Produced by pysmi-1.1.12 at Wed May 29 08:06:45 2024
...
NotificationType, ModuleIdentity, NotificationType, enterprises, Counter64, IpAddress, Bits, TimeTicks, MibIdentifier, iso, ObjectIdentity, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "NotificationType", "enterprises", "Counter64", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "iso", "ObjectIdentity", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, radioDuplexShift=radioDuplexShift, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, e1t1StatEntry=e1t1StatEntry, radioTxFrequency=radioTxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioSide=radioSide, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, aTPCEntry=aTPCEntry, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPFCSErrors=ethGFPFCSErrors, description=description, ethRXPauseFrames=ethRXPauseFrames, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, hostname=hostname, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysDateAndTime=sysDateAndTime, modemSymbolRateRx=modemSymbolRateRx, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, ipRadioStatEth=ipRadioStatEth, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1AIS=e1t1AIS, modemTotalCapacity=modemTotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, ethRXDones=ethRXDones, ipRadio=ipRadio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDvEvent=ethRXDvEvent, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, license=license, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1LOS=e1t1LOS, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, vlanEntry=vlanEntry, restartcpu=restartcpu, pointToPoint=pointToPoint, modemCarrierOffset=modemCarrierOffset, microwaveRadio=microwaveRadio, radioTxPower=radioTxPower, safip=safip, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, tehnika=tehnika, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, sysTemperature=sysTemperature, radioIndex=radioIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, vlanTable=vlanTable, radioTable=radioTable, modemACMengine=modemACMengine, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, ethRXBroadcasts=ethRXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, vlansEnabled=vlansEnabled, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, saf=saf, radioTxMute=radioTxMute, e1t1StatTable=e1t1StatTable, loopback_tributary_mask=loopback_tributary_mask, ethTXGiants=ethTXGiants, radioGenStatus=radioGenStatus, product=product, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, modemModulation=modemModulation, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ethTXDones=ethTXDones, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLongEvents=ethRXLongEvents, localIp=localIp, ethTXControlFrames=ethTXControlFrames, ethTXUnderruns=ethTXUnderruns, modemStandard=modemStandard, modemEntry=modemEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXControlFrames=ethRXControlFrames, modemTable=modemTable, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioLoopback=radioLoopback, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, writeConfig=writeConfig, ethTXBackpresEvents=ethTXBackpresEvents, modemUnavailtime=modemUnavailtime)
