...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:14:57 2022
...
TimeTicks, ObjectIdentity, Integer32, IpAddress, iso, Counter64, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, Counter32, Unsigned32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Integer32", "IpAddress", "iso", "Counter64", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "Counter32", "Unsigned32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, hostname=hostname, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, pointToPoint=pointToPoint, atpcIndex=atpcIndex, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalBlockNumber=modemTotalBlockNumber, localIp=localIp, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, ipRadioCfg=ipRadioCfg, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, tehnika=tehnika, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanCfgStat=vlanCfgStat, restartcpu=restartcpu, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, license=license, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanNumber=vlanNumber, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, modemTable=modemTable, vlanTable=vlanTable, modemRowStatus=modemRowStatus, radioTxPower=radioTxPower, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, microwaveRadio=microwaveRadio, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, e1t1ChannelNr=e1t1ChannelNr, licenseUpdateStatus=licenseUpdateStatus, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, modemModulation=modemModulation, modemEthernetCapacity=modemEthernetCapacity, saf=saf, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, ethRXBroadcasts=ethRXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterLow=ethTXByteCounterLow, remoteIp=remoteIp, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, modemUptime=modemUptime, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDvEvent=ethRXDvEvent, ethTXLateCollisions=ethTXLateCollisions, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, vlanEntry=vlanEntry, licenseMask=licenseMask, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRadialMSE=modemRadialMSE, ethQOSTXFrames=ethQOSTXFrames, radioDuplexShift=radioDuplexShift, vlanFid=vlanFid, ipRadioStat=ipRadioStat, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCRCErrors=ethRXCRCErrors, safip=safip, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, vlanRowStatus=vlanRowStatus, modemGeneralStatus=modemGeneralStatus, ipRadio=ipRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, ethRXDones=ethRXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopbacks=loopbacks, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPCHECErrors=ethGFPCHECErrors, writeConfig=writeConfig, product=product, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, radioIndex=radioIndex, radioLoopback=radioLoopback, ethRXLongEvents=ethRXLongEvents, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, ethTXVlanTags=ethTXVlanTags, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, radioGenStatus=radioGenStatus, modemBandwith=modemBandwith, radioTxMute=radioTxMute, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, vlanPortmap=vlanPortmap, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, vlanPortType=vlanPortType, modemAcqStatus=modemAcqStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, modemIndex=modemIndex, modemEntry=modemEntry)
