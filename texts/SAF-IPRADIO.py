...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:54:29 2022
...
Gauge32, TimeTicks, Counter32, NotificationType, IpAddress, MibIdentifier, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, enterprises, ObjectIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Counter32", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "enterprises", "ObjectIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, modemGeneralStatus=modemGeneralStatus, radioTxMute=radioTxMute, ethTXUnderruns=ethTXUnderruns, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecond=modemErroredSecond, radioSide=radioSide, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, remoteIp=remoteIp, aTPCTable=aTPCTable, modemACMmodulationMax=modemACMmodulationMax, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, modemModulation=modemModulation, modemTable=modemTable, pointToPoint=pointToPoint, microwaveRadio=microwaveRadio, ethQOSTXDropped=ethQOSTXDropped, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlansEnabled=vlansEnabled, modemUptime=modemUptime, saf=saf, hostname=hostname, modemInternalAGCgain=modemInternalAGCgain, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUnavailtime=modemUnavailtime, vlanNumber=vlanNumber, modemCarrierOffset=modemCarrierOffset, ipRadioCfg=ipRadioCfg, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, license=license, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, modemBandwith=modemBandwith, ipRadio=ipRadio, vlanTable=vlanTable, ethTXByteCounterHi=ethTXByteCounterHi, product=product, e1t1LOS=e1t1LOS, ethRXByteCounterLow=ethRXByteCounterLow, ethTXControlFrames=ethTXControlFrames, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStatistics=modemStatistics, aTPCEntry=aTPCEntry, writeConfig=writeConfig, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, radioTxFrequency=radioTxFrequency, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, localIp=localIp, vlanEntry=vlanEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRadialMSE=modemRadialMSE, modemRowStatus=modemRowStatus, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, radioTxPower=radioTxPower, localIpMask=localIpMask, description=description, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanFid=vlanFid, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, ethTXVlanTags=ethTXVlanTags, atpcEnabled=atpcEnabled, loopbacks=loopbacks, ethTXGiants=ethTXGiants, tehnika=tehnika, modemSymbolRateTx=modemSymbolRateTx, e1t1AIS=e1t1AIS, ipRadioMgmt=ipRadioMgmt, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, e1t1StatTable=e1t1StatTable, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, safip=safip, ethGFPCHECErrors=ethGFPCHECErrors, modemIndex=modemIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, radioTable=radioTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseMask=licenseMask, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, modemLastAcqError=modemLastAcqError, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioIndex=radioIndex, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, modemACMethernetCapacity=modemACMethernetCapacity)
