...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:45:18 2023
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanFid=vlanFid, remoteIp=remoteIp, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, licenseMask=licenseMask, modemStandard=modemStandard, atpcIndex=atpcIndex, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopbacks=loopbacks, radioTxMute=radioTxMute, description=description, product=product, modemSymbolRateRx=modemSymbolRateRx, vlanTable=vlanTable, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, ipRadioStat=ipRadioStat, ethRXMulticasts=ethRXMulticasts, restartcpu=restartcpu, radioTxPower=radioTxPower, ethRXControlFrames=ethRXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethTXPauseFrames=ethTXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysTemperature=sysTemperature, radioSide=radioSide, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, modemACMmodulationMin=modemACMmodulationMin, ethGFPFCSErrors=ethGFPFCSErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, ethRXByteCounterLow=ethRXByteCounterLow, license=license, localIpMask=localIpMask, vlanPortmap=vlanPortmap, vlanRowStatus=vlanRowStatus, licenseUpdateStatus=licenseUpdateStatus, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLateCollisions=ethTXLateCollisions, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, modemBandwith=modemBandwith, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPDropedFrames=ethGFPDropedFrames, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, e1t1StatEntry=e1t1StatEntry, vlanEntry=vlanEntry, e1t1LOS=e1t1LOS, radioGenStatus=radioGenStatus, modemTable=modemTable, ethQOSTXDropped=ethQOSTXDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTable=radioTable, radioTxFrequency=radioTxFrequency, modemCarrierOffset=modemCarrierOffset, modemSymbolRateTx=modemSymbolRateTx, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDvEvent=ethRXDvEvent, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, atpcEnabled=atpcEnabled, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, ethTXMulticasts=ethTXMulticasts, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, modemRowStatus=modemRowStatus, ethTXGiants=ethTXGiants, ethTXExcessiveDefers=ethTXExcessiveDefers, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ethTXCollisions=ethTXCollisions, sysDateAndTime=sysDateAndTime, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, writeConfig=writeConfig, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXBroadcasts=ethRXBroadcasts, localIp=localIp, ethTXDones=ethTXDones, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMengine=modemACMengine, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, vlanCfgStat=vlanCfgStat, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLongEvents=ethRXLongEvents, modemModulation=modemModulation, modemErroredSecond=modemErroredSecond, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDones=ethRXDones, radioIndex=radioIndex, modemEntry=modemEntry, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXUnderruns=ethTXUnderruns, modemUptime=modemUptime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioMgmt=ipRadioMgmt, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift)
