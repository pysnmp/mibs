...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:56:16 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, TimeTicks, Integer32, iso, Counter32, IpAddress, NotificationType, Gauge32, ModuleIdentity, Unsigned32, Counter64, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "TimeTicks", "Integer32", "iso", "Counter32", "IpAddress", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "Counter64", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, ethRXPauseFrames=ethRXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, radioTable=radioTable, modemModulation=modemModulation, ethTXCollisions=ethTXCollisions, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, aTPCTable=aTPCTable, localIp=localIp, modemACMengine=modemACMengine, sysTemperature=sysTemperature, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopbacks=loopbacks, vlanCfgStat=vlanCfgStat, ethRXCRCErrors=ethRXCRCErrors, modemRowStatus=modemRowStatus, modemCarrierOffset=modemCarrierOffset, ethGFPCHECErrors=ethGFPCHECErrors, radioSide=radioSide, ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCRCErrors=ethTXCRCErrors, modemTable=modemTable, ipRadio=ipRadio, safip=safip, ethRXDribleNibbles=ethRXDribleNibbles, ethRXBroadcasts=ethRXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, restartcpu=restartcpu, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXDropped=ethQOSTXDropped, product=product, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXVlanTags=ethTXVlanTags, ethRXDones=ethRXDones, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, radioTxPower=radioTxPower, radioLoopback=radioLoopback, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcEnabled=atpcEnabled, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecondRatio=modemErroredSecondRatio, radioEntry=radioEntry, vlanNumber=vlanNumber, sysDateAndTime=sysDateAndTime, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, hostname=hostname, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, ethTXPauseFrames=ethTXPauseFrames, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMaxCollisions=ethTXMaxCollisions, radioDuplexShift=radioDuplexShift, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanRowStatus=vlanRowStatus, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortmap=vlanPortmap, description=description, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEntry=modemEntry, vlanFid=vlanFid, e1t1StatEntry=e1t1StatEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxLevel=radioRxLevel, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, microwaveRadio=microwaveRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, ethRXCodeErrors=ethRXCodeErrors, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, modemCountTime=modemCountTime, radioRxFrequency=radioRxFrequency, modemGeneralStatus=modemGeneralStatus, vlansEnabled=vlansEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, ethTXBroadcasts=ethTXBroadcasts, tehnika=tehnika, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, license=license, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, modemErroredSecond=modemErroredSecond, remoteIp=remoteIp, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateRx=modemSymbolRateRx, saf=saf, ethTXByteCounterLow=ethTXByteCounterLow, modemStatistics=modemStatistics, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, pointToPoint=pointToPoint)
