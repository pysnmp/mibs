...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:15:43 2022
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, Integer32, MibIdentifier, Gauge32, NotificationType, NotificationType, Bits, ModuleIdentity, Counter32, IpAddress, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "Integer32", "MibIdentifier", "Gauge32", "NotificationType", "NotificationType", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, modemTotalCapacity=modemTotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXPauseFrames=ethTXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadio=ipRadio, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, modemUptime=modemUptime, ethTXGiants=ethTXGiants, radioRxLevel=radioRxLevel, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTable=modemTable, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, saf=saf, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, modemModulation=modemModulation, vlanTable=vlanTable, modemCarrierOffset=modemCarrierOffset, modemStandard=modemStandard, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDvEvent=ethRXDvEvent, ethGFPCHECErrors=ethGFPCHECErrors, description=description, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, radioTxPower=radioTxPower, radioTxMute=radioTxMute, aTPCTable=aTPCTable, safip=safip, modemBandwith=modemBandwith, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDropedFrames=ethGFPDropedFrames, sysDateAndTime=sysDateAndTime, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecondRatio=modemErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, product=product, ipRadioMgmt=ipRadioMgmt, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, ethRXControlFrames=ethRXControlFrames, restartcpu=restartcpu, modemInternalAGCgain=modemInternalAGCgain, vlanFid=vlanFid, atpcEnabled=atpcEnabled, writeConfig=writeConfig, remoteIp=remoteIp, ethTXByteCounterHi=ethTXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, modemACMmodulationMin=modemACMmodulationMin, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, e1t1StatEntry=e1t1StatEntry, localIp=localIp, ethRXDribleNibbles=ethRXDribleNibbles, radioIndex=radioIndex, modemStatistics=modemStatistics, radioLoopback=radioLoopback, atpcIndex=atpcIndex, ethTXByteCounterLow=ethTXByteCounterLow, modemRowStatus=modemRowStatus, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, modemRadialMSE=modemRadialMSE, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, vlanPortType=vlanPortType, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, ethQOSTXFrames=ethQOSTXFrames, radioSide=radioSide, modemUnavailtime=modemUnavailtime, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, ethTXLateCollisions=ethTXLateCollisions, pointToPoint=pointToPoint, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth, vlansEnabled=vlansEnabled, radioEntry=radioEntry, ethRXByteCounterLow=ethRXByteCounterLow, tehnika=tehnika, aTPCEntry=aTPCEntry, radioTable=radioTable)
