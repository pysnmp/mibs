...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:34:55 2024
...
Counter32, NotificationType, Gauge32, ModuleIdentity, Counter64, iso, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, IpAddress, NotificationType, Unsigned32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "Counter64", "iso", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "IpAddress", "NotificationType", "Unsigned32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, radioSide=radioSide, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEthernetCapacity=modemEthernetCapacity, vlanTable=vlanTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, ethTXControlFrames=ethTXControlFrames, vlanCfgStat=vlanCfgStat, localIpMask=localIpMask, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUnavailtime=modemUnavailtime, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, modemStandard=modemStandard, radioRxLevel=radioRxLevel, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, ethTXDones=ethTXDones, modemErroredSecond=modemErroredSecond, modemBandwith=modemBandwith, radioDuplexShift=radioDuplexShift, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, vlanPortmap=vlanPortmap, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStat=ipRadioStat, ipRadioMgmt=ipRadioMgmt, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterLow=ethRXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, e1t1ChannelNr=e1t1ChannelNr, vlanEntry=vlanEntry, radioTable=radioTable, loopbacks=loopbacks, ethQOSTXFrames=ethQOSTXFrames, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, modemInternalAGCgain=modemInternalAGCgain, ethRXMulticasts=ethRXMulticasts, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, modemUptime=modemUptime, licenseMask=licenseMask, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, radioEntry=radioEntry, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, ethTXBroadcasts=ethTXBroadcasts, ethTXVlanTags=ethTXVlanTags, modemTable=modemTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, ethTXByteCounterHi=ethTXByteCounterHi, hostname=hostname, vlanNumber=vlanNumber, ethRXBroadcasts=ethRXBroadcasts, saf=saf, localIp=localIp, e1t1AIS=e1t1AIS, sysTemperature=sysTemperature, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatEntry=e1t1StatEntry, safip=safip, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, description=description, aTPCEntry=aTPCEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcEnabled=atpcEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredBlock=modemErroredBlock, ethRXCRCErrors=ethRXCRCErrors, modemModulation=modemModulation, ethTXCollisions=ethTXCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, modemLastAcqError=modemLastAcqError, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadio=ipRadio, ipRadioCfgGeneral=ipRadioCfgGeneral, product=product, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, modemRowStatus=modemRowStatus, modemGeneralStatus=modemGeneralStatus, sysDateAndTime=sysDateAndTime, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, vlanPortType=vlanPortType, ethTXLateCollisions=ethTXLateCollisions, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, writeConfig=writeConfig, license=license, ethTXUnderruns=ethTXUnderruns, radioTxPower=radioTxPower)
