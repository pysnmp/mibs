...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:01:21 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, IpAddress, Counter32, TimeTicks, Counter64, iso, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, Gauge32, enterprises, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "IpAddress", "Counter32", "TimeTicks", "Counter64", "iso", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "enterprises", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUptime=modemUptime, ethQOSTXDropped=ethQOSTXDropped, remoteIp=remoteIp, modemUnavailtime=modemUnavailtime, modemCountTime=modemCountTime, restartcpu=restartcpu, hostname=hostname, e1t1ChannelNr=e1t1ChannelNr, radioTxPower=radioTxPower, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, loopback_tributary_mask=loopback_tributary_mask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateTx=modemSymbolRateTx, atpcEnabled=atpcEnabled, modemRowStatus=modemRowStatus, writeConfig=writeConfig, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, modemACMtotalCapacity=modemACMtotalCapacity, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, atpcIndex=atpcIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTable=radioTable, tehnika=tehnika, ipRadioMgmt=ipRadioMgmt, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, modemStandard=modemStandard, modemTable=modemTable, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, sysDateAndTime=sysDateAndTime, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfg=ipRadioCfg, ethRXDones=ethRXDones, modemIndex=modemIndex, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, ethRXPauseFrames=ethRXPauseFrames, ipRadio=ipRadio, product=product, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, aTPCEntry=aTPCEntry, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecondRatio=modemErroredSecondRatio, radioGenStatus=radioGenStatus, description=description, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterLow=ethTXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBackpresEvents=ethTXBackpresEvents, saf=saf, ethTXLateCollisions=ethTXLateCollisions, aTPCTable=aTPCTable, radioTxMute=radioTxMute, ethTXCollisions=ethTXCollisions, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, modemAcqStatus=modemAcqStatus, modemEntry=modemEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemStatistics=modemStatistics, ethRXMulticasts=ethRXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, modemTotalCapacity=modemTotalCapacity, radioEntry=radioEntry, ethQOSTXFrames=ethQOSTXFrames, ipRadioStatEth=ipRadioStatEth, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, vlanCfgStat=vlanCfgStat, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, license=license, modemLastAcqError=modemLastAcqError, localIp=localIp, radioSide=radioSide, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, safip=safip, modemACMethernetCapacity=modemACMethernetCapacity, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBandwith=modemBandwith)
