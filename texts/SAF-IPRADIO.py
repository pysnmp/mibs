...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:32:24 2022
...
Gauge32, Counter32, MibIdentifier, TimeTicks, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, Integer32, ObjectIdentity, Counter64, ModuleIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibIdentifier", "TimeTicks", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "ModuleIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanEntry=vlanEntry, radioTxFrequency=radioTxFrequency, localIp=localIp, modemLastAcqError=modemLastAcqError, vlansEnabled=vlansEnabled, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, safip=safip, sysDateAndTime=sysDateAndTime, e1t1StatEntry=e1t1StatEntry, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemInternalAGCgain=modemInternalAGCgain, aTPCTable=aTPCTable, radioSide=radioSide, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, ethRXDones=ethRXDones, atpcEnabled=atpcEnabled, aTPCEntry=aTPCEntry, writeConfig=writeConfig, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, modemTable=modemTable, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBandwith=modemBandwith, description=description, modemACMengine=modemACMengine, product=product, modemACMmodulationMin=modemACMmodulationMin, ethTXVlanTags=ethTXVlanTags, remoteIp=remoteIp, sysTemperature=sysTemperature, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPCHECErrors=ethGFPCHECErrors, e1t1LOS=e1t1LOS, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSTXFrames=ethQOSTXFrames, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, radioLoopback=radioLoopback, vlanFid=vlanFid, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, microwaveRadio=microwaveRadio, loopbacks=loopbacks, hostname=hostname, modemErroredBlock=modemErroredBlock, modemIndex=modemIndex, modemACMtotalCapacity=modemACMtotalCapacity, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, ipRadioStat=ipRadioStat, ethTXExcessiveDefers=ethTXExcessiveDefers, restartcpu=restartcpu, licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, modemStatistics=modemStatistics, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxLevel=radioRxLevel, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, radioTxMute=radioTxMute, modemE1T1Channels=modemE1T1Channels, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, tehnika=tehnika, modemAcqStatus=modemAcqStatus, modemCountTime=modemCountTime, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, ethRXMulticasts=ethRXMulticasts, modemEntry=modemEntry, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, modemErroredSecond=modemErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDropedFrames=ethGFPDropedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, ethTXControlFrames=ethTXControlFrames, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemGeneralStatus=modemGeneralStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMax=modemACMmodulationMax, radioGenStatus=radioGenStatus, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, loopback_tributary_mask=loopback_tributary_mask, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCRCErrors=ethRXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, radioTxPower=radioTxPower, license=license)
