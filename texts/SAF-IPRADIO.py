...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:29:29 2023
...
NotificationType, Counter64, Counter32, NotificationType, Gauge32, ModuleIdentity, iso, enterprises, Unsigned32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "iso", "enterprises", "Unsigned32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCountTime=modemCountTime, modemSymbolRateTx=modemSymbolRateTx, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, description=description, ethTXByteCounterLow=ethTXByteCounterLow, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalBlockNumber=modemTotalBlockNumber, modemTotalCapacity=modemTotalCapacity, ethTXGiants=ethTXGiants, licenseMask=licenseMask, modemSymbolRateRx=modemSymbolRateRx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, vlanFid=vlanFid, ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, ethRXCodeErrors=ethRXCodeErrors, ethRXDones=ethRXDones, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLongEvents=ethRXLongEvents, ipRadioMgmt=ipRadioMgmt, radioDuplexShift=radioDuplexShift, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, modemUptime=modemUptime, sysDateAndTime=sysDateAndTime, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, modemStatistics=modemStatistics, modemStandard=modemStandard, e1t1LOS=e1t1LOS, radioGenStatus=radioGenStatus, loopbacks=loopbacks, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXDropped=ethQOSTXDropped, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, e1t1StatTable=e1t1StatTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, microwaveRadio=microwaveRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, restartcpu=restartcpu, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, ethTXVlanTags=ethTXVlanTags, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, radioIndex=radioIndex, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, modemRadialMSE=modemRadialMSE, radioTable=radioTable, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMengine=modemACMengine, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, ethTXBroadcasts=ethTXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, modemModulation=modemModulation, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, modemTable=modemTable, e1t1AIS=e1t1AIS, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, tehnika=tehnika, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, hostname=hostname, vlansEnabled=vlansEnabled, ethTXPauseFrames=ethTXPauseFrames, sysTemperature=sysTemperature, modemIndex=modemIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanPortmap=vlanPortmap, e1t1StatEntry=e1t1StatEntry, product=product, e1t1ChannelNr=e1t1ChannelNr, modemRowStatus=modemRowStatus, license=license, ethTXDones=ethTXDones, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, vlanEntry=vlanEntry, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecond=modemErroredSecond, modemErroredBlock=modemErroredBlock, vlanNumber=vlanNumber, writeConfig=writeConfig, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, licenseUpdateStatus=licenseUpdateStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, radioLoopback=radioLoopback, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, ipRadio=ipRadio)
