...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:16:06 2023
...
Counter32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity, enterprises, Unsigned32, MibIdentifier, Integer32, Counter64, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "enterprises", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, remoteIp=remoteIp, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, loopbacks=loopbacks, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, radioDuplexShift=radioDuplexShift, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, vlanFid=vlanFid, ipRadioStat=ipRadioStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, modemErroredSecondRatio=modemErroredSecondRatio, licenseMask=licenseMask, modemRadialMSE=modemRadialMSE, ethRXDribleNibbles=ethRXDribleNibbles, radioSide=radioSide, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, localIp=localIp, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMulticasts=ethTXMulticasts, saf=saf, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, radioGenStatus=radioGenStatus, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat, modemGeneralStatus=modemGeneralStatus, safip=safip, ethRXCodeErrors=ethRXCodeErrors, radioTxPower=radioTxPower, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1Channels=modemE1T1Channels, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, ethTXMaxCollisions=ethTXMaxCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, modemTable=modemTable, ethRXPauseFrames=ethRXPauseFrames, radioTxFrequency=radioTxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, ethQOSTXFrames=ethQOSTXFrames, modemACMtotalCapacity=modemACMtotalCapacity, licenseUpdateStatus=licenseUpdateStatus, ethTXVlanTags=ethTXVlanTags, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, modemRowStatus=modemRowStatus, ethTXCRCErrors=ethTXCRCErrors, modemTotalCapacity=modemTotalCapacity, atpcEnabled=atpcEnabled, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSymbolRateRx=modemSymbolRateRx, hostname=hostname, ethTXBroadcasts=ethTXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, microwaveRadio=microwaveRadio, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, tehnika=tehnika, restartcpu=restartcpu, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, e1t1AIS=e1t1AIS, product=product, writeConfig=writeConfig, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, radioIndex=radioIndex, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, modemEntry=modemEntry, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, description=description, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXControlFrames=ethRXControlFrames, ethRXByteCounterLow=ethRXByteCounterLow, radioEntry=radioEntry, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ethTXLateCollisions=ethTXLateCollisions, modemCountTime=modemCountTime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, license=license, ethGFPDropedFrames=ethGFPDropedFrames, loopback_tributary_mask=loopback_tributary_mask, ethRXMulticasts=ethRXMulticasts, vlanPortType=vlanPortType, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, vlanEntry=vlanEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond)
