...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:49:30 2024
...
ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, MibIdentifier, enterprises, IpAddress, NotificationType, Counter32, iso, NotificationType, ModuleIdentity, Integer32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "MibIdentifier", "enterprises", "IpAddress", "NotificationType", "Counter32", "iso", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEntry=modemEntry, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, radioSide=radioSide, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, radioTxPower=radioTxPower, loopbacks=loopbacks, vlanRowStatus=vlanRowStatus, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, radioTxMute=radioTxMute, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, ethRXCRCErrors=ethRXCRCErrors, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredBlock=modemErroredBlock, modemCarrierOffset=modemCarrierOffset, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseMask=licenseMask, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemRowStatus=modemRowStatus, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, radioRxFrequency=radioRxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, remoteIp=remoteIp, ethRXDribleNibbles=ethRXDribleNibbles, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDones=ethRXDones, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateRx=modemSymbolRateRx, modemUnavailtime=modemUnavailtime, modemRadialMSE=modemRadialMSE, atpcIndex=atpcIndex, saf=saf, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1ChannelNr=e1t1ChannelNr, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMulticasts=ethTXMulticasts, e1t1StatEntry=e1t1StatEntry, sysTemperature=sysTemperature, modemCountTime=modemCountTime, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortType=vlanPortType, ethTXControlFrames=ethTXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ipRadioStat=ipRadioStat, writeConfig=writeConfig, modemUptime=modemUptime, modemIndex=modemIndex, ethRXCodeErrors=ethRXCodeErrors, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterLow=ethTXWireByteCounterLow, product=product, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, restartcpu=restartcpu, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, modemTable=modemTable, ipRadioStatEth=ipRadioStatEth, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDvEvent=ethRXDvEvent, safip=safip, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, modemStandard=modemStandard, vlanPortmap=vlanPortmap, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, ethQOSTXFrames=ethQOSTXFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1LOS=e1t1LOS, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLongEvents=ethRXLongEvents, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, modemErroredSecond=modemErroredSecond, description=description, ipRadioCfg=ipRadioCfg, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, ethQOSTXDropped=ethQOSTXDropped, vlanEntry=vlanEntry, modemBandwith=modemBandwith, localIp=localIp, ipRadio=ipRadio, hostname=hostname, sysDateAndTime=sysDateAndTime, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions)
