...
# Produced by pysmi-1.1.12 at Wed Dec  4 21:20:27 2024
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ObjectIdentity, Gauge32, IpAddress, NotificationType, enterprises, MibIdentifier, Counter32, Integer32, NotificationType, iso, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ObjectIdentity", "Gauge32", "IpAddress", "NotificationType", "enterprises", "MibIdentifier", "Counter32", "Integer32", "NotificationType", "iso", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterLow=ethTXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, license=license, ethTXLateCollisions=ethTXLateCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, vlanEntry=vlanEntry, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEntry=modemEntry, radioTxFrequency=radioTxFrequency, sysDateAndTime=sysDateAndTime, licenseUpdateStatus=licenseUpdateStatus, localIpMask=localIpMask, radioDuplexShift=radioDuplexShift, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, localIp=localIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, remoteIp=remoteIp, atpcTxPowerCorrection=atpcTxPowerCorrection, sysTemperature=sysTemperature, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, atpcIndex=atpcIndex, vlanNumber=vlanNumber, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTable=modemTable, vlanPortType=vlanPortType, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, writeConfig=writeConfig, ethTXBroadcasts=ethTXBroadcasts, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, description=description, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, ethRXDones=ethRXDones, modemSymbolRateRx=modemSymbolRateRx, ethQOSTXFrames=ethQOSTXFrames, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemModulation=modemModulation, ethTXCRCErrors=ethTXCRCErrors, safip=safip, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStatistics=modemStatistics, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, modemACMengine=modemACMengine, hostname=hostname, radioTxMute=radioTxMute, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, ethGFPFCSErrors=ethGFPFCSErrors, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, vlanRowStatus=vlanRowStatus, modemTotalCapacity=modemTotalCapacity, radioIndex=radioIndex, e1t1LOS=e1t1LOS, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTable=radioTable, modemE1T1ChannelMask=modemE1T1ChannelMask, product=product, radioEntry=radioEntry, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecond=modemErroredSecond, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, radioLoopback=radioLoopback, modemLastAcqError=modemLastAcqError, ethRXControlFrames=ethRXControlFrames, aTPCTable=aTPCTable, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, radioRxLevel=radioRxLevel)
