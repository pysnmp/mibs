...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:49:43 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Gauge32, Bits, ModuleIdentity, enterprises, Unsigned32, TimeTicks, Counter64, NotificationType, Integer32, MibIdentifier, NotificationType, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Gauge32", "Bits", "ModuleIdentity", "enterprises", "Unsigned32", "TimeTicks", "Counter64", "NotificationType", "Integer32", "MibIdentifier", "NotificationType", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanNumber=vlanNumber, ethQOSTXDropped=ethQOSTXDropped, ethRXLongEvents=ethRXLongEvents, license=license, remoteIp=remoteIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcEnabled=atpcEnabled, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, ethGFPFCSErrors=ethGFPFCSErrors, safip=safip, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, radioLoopback=radioLoopback, sysDateAndTime=sysDateAndTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemACMethernetCapacity=modemACMethernetCapacity, modemACMengine=modemACMengine, ethRXPauseFrames=ethRXPauseFrames, radioDuplexShift=radioDuplexShift, ethGFPCHECErrors=ethGFPCHECErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXVlanTags=ethTXVlanTags, hostname=hostname, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCEntry=aTPCEntry, radioTable=radioTable, modemTotalBlockNumber=modemTotalBlockNumber, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanRowStatus=vlanRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, tehnika=tehnika, loopbacks=loopbacks, localIpMask=localIpMask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCRCErrors=ethTXCRCErrors, ethTXControlFrames=ethTXControlFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseMask=licenseMask, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, modemAcqStatus=modemAcqStatus, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, ethTXGiants=ethTXGiants, aTPCTable=aTPCTable, vlanFid=vlanFid, modemSymbolRateRx=modemSymbolRateRx, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfg=ipRadioCfg, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBackpresEvents=ethTXBackpresEvents, vlanCfgStat=vlanCfgStat, ethTXLateCollisions=ethTXLateCollisions, e1t1StatEntry=e1t1StatEntry, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredBlock=modemErroredBlock, ethGFPDropedFrames=ethGFPDropedFrames, modemRadialMSE=modemRadialMSE, ethTXUnderruns=ethTXUnderruns, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, modemStandard=modemStandard, ethRXDones=ethRXDones, ethRXCodeErrors=ethRXCodeErrors, vlanEntry=vlanEntry, ethTXCollisions=ethTXCollisions, ethTXDones=ethTXDones, e1t1LOS=e1t1LOS, saf=saf, product=product, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStatistics=modemStatistics, radioTxFrequency=radioTxFrequency, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, radioSide=radioSide, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, e1t1StatTable=e1t1StatTable, ethTXMulticasts=ethTXMulticasts, restartcpu=restartcpu, ethTXByteCounterLow=ethTXByteCounterLow, localIp=localIp, modemACMtotalCapacity=modemACMtotalCapacity, modemRowStatus=modemRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcTxPowerCorrection=atpcTxPowerCorrection, sysTemperature=sysTemperature, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioIndex=radioIndex)
