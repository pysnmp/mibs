...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:12:55 2022
...
Unsigned32, iso, TimeTicks, enterprises, NotificationType, Counter64, NotificationType, Counter32, MibIdentifier, Bits, ModuleIdentity, Gauge32, Integer32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "TimeTicks", "enterprises", "NotificationType", "Counter64", "NotificationType", "Counter32", "MibIdentifier", "Bits", "ModuleIdentity", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, radioDuplexShift=radioDuplexShift, ethTXUnderruns=ethTXUnderruns, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, localIpMask=localIpMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, modemTotalCapacity=modemTotalCapacity, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXFrames=ethQOSTXFrames, radioIndex=radioIndex, e1t1ChannelNr=e1t1ChannelNr, modemACMengine=modemACMengine, modemEntry=modemEntry, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, modemBandwith=modemBandwith, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCarrierOffset=modemCarrierOffset, aTPCEntry=aTPCEntry, modemGeneralStatus=modemGeneralStatus, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, ethTXMulticasts=ethTXMulticasts, modemUnavailtime=modemUnavailtime, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRowStatus=modemRowStatus, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMtotalCapacity=modemACMtotalCapacity, radioTable=radioTable, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, ethTXDones=ethTXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCRCErrors=ethRXCRCErrors, product=product, licenseMask=licenseMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, pointToPoint=pointToPoint, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, modemSymbolRateTx=modemSymbolRateTx, writeConfig=writeConfig, radioGenStatus=radioGenStatus, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, vlanPortType=vlanPortType, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUptime=modemUptime, hostname=hostname, modemAcqStatus=modemAcqStatus, aTPCTable=aTPCTable, atpcEnabled=atpcEnabled, ethGFPFCSErrors=ethGFPFCSErrors, description=description, modemEthernetCapacity=modemEthernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortmap=vlanPortmap, ethRXCodeErrors=ethRXCodeErrors, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecond=modemErroredSecond, localIp=localIp, ethTXByteCounterLow=ethTXByteCounterLow, modemIndex=modemIndex, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, vlanTable=vlanTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, modemTable=modemTable, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCountTime=modemCountTime, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysTemperature=sysTemperature, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1LOS=e1t1LOS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, tehnika=tehnika, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, restartcpu=restartcpu, ethTXCRCErrors=ethTXCRCErrors, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMax=modemACMmodulationMax, atpcIndex=atpcIndex, e1t1StatEntry=e1t1StatEntry, license=license, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, ethRXDribleNibbles=ethRXDribleNibbles, vlanCfgStat=vlanCfgStat, microwaveRadio=microwaveRadio, vlanFid=vlanFid, safip=safip, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, ethTXBroadcasts=ethTXBroadcasts, ethTXVlanTags=ethTXVlanTags, ethRXMulticasts=ethRXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral)
