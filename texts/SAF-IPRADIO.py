...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:18:33 2024
...
ObjectIdentity, IpAddress, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, iso, Unsigned32, Bits, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "iso", "Unsigned32", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, modemACMengine=modemACMengine, sysTemperature=sysTemperature, e1t1LOS=e1t1LOS, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, modemLDPCdecoderStress=modemLDPCdecoderStress, product=product, modemAcqStatus=modemAcqStatus, atpcEnabled=atpcEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, hostname=hostname, ethTXCRCErrors=ethTXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, description=description, loopback_tributary_mask=loopback_tributary_mask, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxMute=radioTxMute, radioLoopback=radioLoopback, radioSide=radioSide, vlanRowStatus=vlanRowStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, ethRXLongEvents=ethRXLongEvents, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioMgmt=ipRadioMgmt, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterHi=ethTXByteCounterHi, modemCarrierOffset=modemCarrierOffset, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCEntry=aTPCEntry, modemACMethernetCapacity=modemACMethernetCapacity, radioDuplexShift=radioDuplexShift, safip=safip, modemRadialMSE=modemRadialMSE, ethRXMulticasts=ethRXMulticasts, modemTable=modemTable, modemACMtotalCapacity=modemACMtotalCapacity, licenseMask=licenseMask, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, ethRXControlFrames=ethRXControlFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadio=ipRadio, radioTable=radioTable, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseUpdateStatus=licenseUpdateStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, ethTXPauseFrames=ethTXPauseFrames, e1t1AIS=e1t1AIS, vlanFid=vlanFid, e1t1StatTable=e1t1StatTable, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemLastAcqError=modemLastAcqError, tehnika=tehnika, ethTXVlanTags=ethTXVlanTags, ethTXGiants=ethTXGiants, aTPCTable=aTPCTable, radioTxPower=radioTxPower, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioEntry=radioEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, modemBandwith=modemBandwith, modemRowStatus=modemRowStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXUnderruns=ethTXUnderruns, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, writeConfig=writeConfig, ipRadioStat=ipRadioStat, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1Channels=modemE1T1Channels, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, license=license, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMin=modemACMmodulationMin, modemCountTime=modemCountTime, e1t1ChannelNr=e1t1ChannelNr, ethQOSTXDropped=ethQOSTXDropped, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, radioGenStatus=radioGenStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, radioRxLevel=radioRxLevel, modemModulation=modemModulation, radioRxFrequency=radioRxFrequency, ethRXBroadcasts=ethRXBroadcasts, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioIndex=radioIndex, vlanPortType=vlanPortType, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, localIp=localIp, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUnavailtime=modemUnavailtime, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, modemTotalCapacity=modemTotalCapacity)
