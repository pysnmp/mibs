...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:42:58 2021
...
ModuleIdentity, Unsigned32, Counter64, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, MibIdentifier, Bits, Integer32, iso, Gauge32, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "MibIdentifier", "Bits", "Integer32", "iso", "Gauge32", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, ethGFPCHECErrors=ethGFPCHECErrors, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, remoteIp=remoteIp, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioIndex=radioIndex, modemRowStatus=modemRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgNetwork=ipRadioCfgNetwork, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, vlanEntry=vlanEntry, vlanFid=vlanFid, saf=saf, radioTxMute=radioTxMute, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMengine=modemACMengine, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMin=modemACMmodulationMin, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, license=license, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTable=radioTable, ethGFPDelineationErrors=ethGFPDelineationErrors, microwaveRadio=microwaveRadio, ethTXLateCollisions=ethTXLateCollisions, vlansEnabled=vlansEnabled, ethTXBroadcasts=ethTXBroadcasts, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, ethTXGiants=ethTXGiants, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, ipRadioStat=ipRadioStat, ethRXDones=ethRXDones, modemE1T1Channels=modemE1T1Channels, ethTXMaxCollisions=ethTXMaxCollisions, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, safip=safip, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemErroredBlock=modemErroredBlock, aTPCEntry=aTPCEntry, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, e1t1StatTable=e1t1StatTable, sysTemperature=sysTemperature, e1t1LOS=e1t1LOS, atpcIndex=atpcIndex, hostname=hostname, vlanCfgStat=vlanCfgStat, aTPCTable=aTPCTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateRx=modemSymbolRateRx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanPortType=vlanPortType, writeConfig=writeConfig, modemCountTime=modemCountTime, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterLow=ethTXByteCounterLow, tehnika=tehnika, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateTx=modemSymbolRateTx, ethTXControlFrames=ethTXControlFrames, ethRXBroadcasts=ethRXBroadcasts, localIp=localIp, modemEntry=modemEntry, pointToPoint=pointToPoint, restartcpu=restartcpu, atpcEnabled=atpcEnabled, e1t1AIS=e1t1AIS, modemTotalCapacity=modemTotalCapacity, modemErroredSecond=modemErroredSecond, ethTXDones=ethTXDones, modemModulation=modemModulation, description=description, licenseMask=licenseMask, ethRXPrevPktDropped=ethRXPrevPktDropped, product=product, modemACMmodulationMax=modemACMmodulationMax, radioSide=radioSide, radioTxFrequency=radioTxFrequency, e1t1StatEntry=e1t1StatEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCollisions=ethTXCollisions, ethRXMulticasts=ethRXMulticasts, modemAcqStatus=modemAcqStatus, ethRXLongEvents=ethRXLongEvents, e1t1ChannelNr=e1t1ChannelNr, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStatEth=ipRadioStatEth, ethTXPauseFrames=ethTXPauseFrames)
