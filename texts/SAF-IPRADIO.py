...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:08:40 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, enterprises, iso, Gauge32, Counter64, Counter32, ObjectIdentity, TimeTicks, IpAddress, Bits, Unsigned32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "enterprises", "iso", "Gauge32", "Counter64", "Counter32", "ObjectIdentity", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, radioIndex=radioIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, pointToPoint=pointToPoint, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, ethTXDones=ethTXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanFid=vlanFid, vlanEntry=vlanEntry, ethTXGiants=ethTXGiants, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, radioTxFrequency=radioTxFrequency, modemIndex=modemIndex, vlanCfgStat=vlanCfgStat, modemStatistics=modemStatistics, loopback_tributary_mask=loopback_tributary_mask, modemACMengine=modemACMengine, ethRXCRCErrors=ethRXCRCErrors, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxFrequency=radioRxFrequency, localIpMask=localIpMask, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, modemLastAcqError=modemLastAcqError, hostname=hostname, description=description, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, licenseUpdateStatus=licenseUpdateStatus, ethTXCollisions=ethTXCollisions, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecond=modemErroredSecond, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatTable=e1t1StatTable, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEthernetCapacity=modemEthernetCapacity, modemCarrierOffset=modemCarrierOffset, vlanPortType=vlanPortType, ethRXLongEvents=ethRXLongEvents, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, ethQOSTXDropped=ethQOSTXDropped, localIp=localIp, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUnavailtime=modemUnavailtime, modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, modemModulation=modemModulation, product=product, license=license, ethTXByteCounterLow=ethTXByteCounterLow, safip=safip, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, ethGFPCHECErrors=ethGFPCHECErrors, aTPCTable=aTPCTable, e1t1LOS=e1t1LOS, ethGFPFCSErrors=ethGFPFCSErrors, modemBandwith=modemBandwith, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfg=ipRadioCfg, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterHi=ethTXByteCounterHi, radioEntry=radioEntry, saf=saf, restartcpu=restartcpu, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadio=ipRadio, writeConfig=writeConfig, aTPCEntry=aTPCEntry, modemAcqStatus=modemAcqStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemGeneralStatus=modemGeneralStatus, modemCountTime=modemCountTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseMask=licenseMask, radioSide=radioSide, modemE1T1Channels=modemE1T1Channels, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, ethRXControlFrames=ethRXControlFrames, radioGenStatus=radioGenStatus, modemRowStatus=modemRowStatus, ethTXVlanTags=ethTXVlanTags, modemInternalAGCgain=modemInternalAGCgain, ethRXPauseFrames=ethRXPauseFrames, radioTxPower=radioTxPower, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcIndex=atpcIndex, sysDateAndTime=sysDateAndTime)
