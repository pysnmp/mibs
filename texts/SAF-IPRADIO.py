...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:16:19 2022
...
MibIdentifier, Integer32, Counter64, Unsigned32, Bits, ModuleIdentity, TimeTicks, Counter32, IpAddress, NotificationType, NotificationType, enterprises, iso, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Counter64", "Unsigned32", "Bits", "ModuleIdentity", "TimeTicks", "Counter32", "IpAddress", "NotificationType", "NotificationType", "enterprises", "iso", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBandwith=modemBandwith, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemEthernetCapacity=modemEthernetCapacity, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, description=description, ethTXGiants=ethTXGiants, modemModulation=modemModulation, license=license, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, ethRXDvEvent=ethRXDvEvent, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, ethRXByteCounterHi=ethRXByteCounterHi, vlanTable=vlanTable, modemErroredSecond=modemErroredSecond, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, vlanPortmap=vlanPortmap, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDones=ethRXDones, modemTotalBlockNumber=modemTotalBlockNumber, radioRxLevel=radioRxLevel, modemStandard=modemStandard, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXFrames=ethQOSTXFrames, loopback_tributary_mask=loopback_tributary_mask, radioTxMute=radioTxMute, loopbacks=loopbacks, e1t1AIS=e1t1AIS, remoteIp=remoteIp, radioEntry=radioEntry, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMengine=modemACMengine, modemUptime=modemUptime, modemACMmodulationMin=modemACMmodulationMin, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, vlanPortType=vlanPortType, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioGenStatus=radioGenStatus, vlansEnabled=vlansEnabled, atpcEnabled=atpcEnabled, modemTotalCapacity=modemTotalCapacity, modemLastAcqError=modemLastAcqError, localIpMask=localIpMask, modemRadialMSE=modemRadialMSE, modemSymbolRateRx=modemSymbolRateRx, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, vlanCfgStat=vlanCfgStat, ethGFPDropedFrames=ethGFPDropedFrames, pointToPoint=pointToPoint, ethRXTruncatedFrames=ethRXTruncatedFrames, writeConfig=writeConfig, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXMulticasts=ethRXMulticasts, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, radioDuplexShift=radioDuplexShift, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredBlock=modemErroredBlock, ethRXBroadcasts=ethRXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, modemCarrierOffset=modemCarrierOffset, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, ipRadio=ipRadio, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, ethTXDones=ethTXDones, sysTemperature=sysTemperature, modemTable=modemTable, radioLoopback=radioLoopback, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, vlanFid=vlanFid, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStat=ipRadioStat, ethTXBackpresEvents=ethTXBackpresEvents, hostname=hostname, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterLow=ethRXByteCounterLow, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, modemErroredSecondRatio=modemErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, e1t1ChannelNr=e1t1ChannelNr, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxPower=radioTxPower, restartcpu=restartcpu, ethTXVlanTags=ethTXVlanTags, ethTXControlFrames=ethTXControlFrames, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, modemIndex=modemIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSTXDropped=ethQOSTXDropped, radioIndex=radioIndex, product=product, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfg=ipRadioCfg, radioRxFrequency=radioRxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateTx=modemSymbolRateTx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf)
