...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:47:04 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Integer32, Gauge32, ObjectIdentity, Unsigned32, Counter64, NotificationType, ModuleIdentity, NotificationType, Bits, IpAddress, enterprises, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity", "NotificationType", "Bits", "IpAddress", "enterprises", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXUnderruns=ethTXUnderruns, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfg=ipRadioCfg, loopbacks=loopbacks, radioLoopback=radioLoopback, vlanFid=vlanFid, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioIndex=radioIndex, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, vlanNumber=vlanNumber, ethTXDones=ethTXDones, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMin=modemACMmodulationMin, localIpMask=localIpMask, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, radioGenStatus=radioGenStatus, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterHi=ethTXByteCounterHi, modemEntry=modemEntry, e1t1LOS=e1t1LOS, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, licenseMask=licenseMask, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCodeErrors=ethRXCodeErrors, safip=safip, modemErroredSecond=modemErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, modemErroredBlock=modemErroredBlock, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, ethTXVlanTags=ethTXVlanTags, modemLastAcqError=modemLastAcqError, ethRXPauseFrames=ethRXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, loopback_tributary_mask=loopback_tributary_mask, atpcEnabled=atpcEnabled, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, aTPCEntry=aTPCEntry, modemRowStatus=modemRowStatus, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, modemTable=modemTable, hostname=hostname, ethGFPDelineationErrors=ethGFPDelineationErrors, description=description, ethRXDones=ethRXDones, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, ethQOSTXFrames=ethQOSTXFrames, radioEntry=radioEntry, product=product, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, ethGFPCHECErrors=ethGFPCHECErrors, vlanTable=vlanTable, radioTxMute=radioTxMute, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, modemCarrierOffset=modemCarrierOffset, modemLDPCdecoderStress=modemLDPCdecoderStress, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUptime=modemUptime, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, ipRadio=ipRadio, modemIndex=modemIndex, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, writeConfig=writeConfig, remoteIp=remoteIp, vlanEntry=vlanEntry, modemBandwith=modemBandwith, ethTXGiants=ethTXGiants, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, ethRXControlFrames=ethRXControlFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLongEvents=ethRXLongEvents, modemACMengine=modemACMengine, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, license=license, modemModulation=modemModulation, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, saf=saf, ethRXCRCErrors=ethRXCRCErrors)
