...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:18:48 2022
...
Counter32, TimeTicks, iso, Integer32, enterprises, NotificationType, MibIdentifier, Bits, Unsigned32, ModuleIdentity, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "iso", "Integer32", "enterprises", "NotificationType", "MibIdentifier", "Bits", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDribleNibbles=ethRXDribleNibbles, ethTXMulticasts=ethTXMulticasts, modemUnavailtime=modemUnavailtime, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBackpresEvents=ethTXBackpresEvents, licenseUpdateStatus=licenseUpdateStatus, modemEthernetCapacity=modemEthernetCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, vlansEnabled=vlansEnabled, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, modemRowStatus=modemRowStatus, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBroadcasts=ethTXBroadcasts, radioSide=radioSide, saf=saf, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, modemIndex=modemIndex, localIp=localIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioDuplexShift=radioDuplexShift, modemACMengine=modemACMengine, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, ethRXMulticasts=ethRXMulticasts, tehnika=tehnika, ethRXLongEvents=ethRXLongEvents, e1t1ChannelNr=e1t1ChannelNr, ethTXExcessiveDefers=ethTXExcessiveDefers, description=description, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, vlanPortmap=vlanPortmap, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, radioRxFrequency=radioRxFrequency, vlanCfgStat=vlanCfgStat, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCountTime=modemCountTime, modemAcqStatus=modemAcqStatus, radioIndex=radioIndex, modemTable=modemTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXCodeErrors=ethRXCodeErrors, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUptime=modemUptime, product=product, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStatistics=modemStatistics, ipRadioMgmt=ipRadioMgmt, modemLastAcqError=modemLastAcqError, modemStandard=modemStandard, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, e1t1AIS=e1t1AIS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioLoopback=radioLoopback, ethTXUnderruns=ethTXUnderruns, aTPCEntry=aTPCEntry, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, radioTxMute=radioTxMute, pointToPoint=pointToPoint, vlanPortType=vlanPortType, ethTXByteCounterLow=ethTXByteCounterLow, radioRxLevel=radioRxLevel, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, ethQOSTXFrames=ethQOSTXFrames, radioTxPower=radioTxPower, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, modemRadialMSE=modemRadialMSE, modemBandwith=modemBandwith, restartcpu=restartcpu, license=license, ethTXCollisions=ethTXCollisions, modemInternalAGCgain=modemInternalAGCgain, ethTXDones=ethTXDones, loopbacks=loopbacks, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStat=ipRadioStat, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, ethRXPauseFrames=ethRXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, modemTotalCapacity=modemTotalCapacity, modemSymbolRateRx=modemSymbolRateRx, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, modemACMmodulationMax=modemACMmodulationMax, ethRXDvEvent=ethRXDvEvent, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, sysDateAndTime=sysDateAndTime, modemErroredSecondRatio=modemErroredSecondRatio, ipRadio=ipRadio, radioGenStatus=radioGenStatus, localIpMask=localIpMask, ethRXDones=ethRXDones, e1t1StatTable=e1t1StatTable, ethGFPCHECErrors=ethGFPCHECErrors, aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, radioTable=radioTable, sysTemperature=sysTemperature, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors)
