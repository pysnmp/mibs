...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:59:32 2021
...
Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, iso, Counter32, IpAddress, Integer32, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, NotificationType, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "iso", "Counter32", "IpAddress", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "NotificationType", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, modemStandard=modemStandard, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, radioDuplexShift=radioDuplexShift, ipRadioMgmt=ipRadioMgmt, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcEnabled=atpcEnabled, ethTXBackpresEvents=ethTXBackpresEvents, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredBlock=modemErroredBlock, vlanTable=vlanTable, modemBandwith=modemBandwith, modemRowStatus=modemRowStatus, ethRXBroadcasts=ethRXBroadcasts, product=product, hostname=hostname, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, localIpMask=localIpMask, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity, pointToPoint=pointToPoint, modemEntry=modemEntry, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, e1t1LOS=e1t1LOS, modemRadialMSE=modemRadialMSE, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, restartcpu=restartcpu, modemUptime=modemUptime, ethTXGiants=ethTXGiants, modemStatistics=modemStatistics, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxMute=radioTxMute, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, radioLoopback=radioLoopback, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanRowStatus=vlanRowStatus, description=description, ethTXDones=ethTXDones, localIp=localIp, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, aTPCTable=aTPCTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDones=ethRXDones, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, vlanFid=vlanFid, license=license, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfg=ipRadioCfg, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, modemACMengine=modemACMengine, vlanEntry=vlanEntry, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, radioSide=radioSide, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMax=modemACMmodulationMax, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStat=ipRadioStat, ethTXLateCollisions=ethTXLateCollisions, ethRXMulticasts=ethRXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, sysTemperature=sysTemperature, licenseMask=licenseMask, writeConfig=writeConfig, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, modemTable=modemTable, modemCountTime=modemCountTime, loopbacks=loopbacks, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXPauseFrames=ethRXPauseFrames, saf=saf, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, vlansEnabled=vlansEnabled, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemGeneralStatus=modemGeneralStatus, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXFrames=ethQOSTXFrames, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, modemACMethernetCapacity=modemACMethernetCapacity, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, vlanNumber=vlanNumber)
