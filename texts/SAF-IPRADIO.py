...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:36:31 2024
...
Bits, Gauge32, NotificationType, iso, NotificationType, IpAddress, Integer32, enterprises, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "NotificationType", "iso", "NotificationType", "IpAddress", "Integer32", "enterprises", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1ChannelNr=e1t1ChannelNr, modemACMtotalCapacity=modemACMtotalCapacity, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, hostname=hostname, ethTXBackpresEvents=ethTXBackpresEvents, vlanEntry=vlanEntry, remoteIp=remoteIp, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, vlanCfgStat=vlanCfgStat, product=product, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecond=modemErroredSecond, ethTXControlFrames=ethTXControlFrames, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, ethTXCollisions=ethTXCollisions, sysDateAndTime=sysDateAndTime, pointToPoint=pointToPoint, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPCHECErrors=ethGFPCHECErrors, license=license, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioSide=radioSide, modemBandwith=modemBandwith, modemIndex=modemIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortType=vlanPortType, loopback_tributary_mask=loopback_tributary_mask, modemGeneralStatus=modemGeneralStatus, saf=saf, loopbacks=loopbacks, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMax=modemACMmodulationMax, modemErroredBlock=modemErroredBlock, ethRXBroadcasts=ethRXBroadcasts, ethTXDones=ethTXDones, modemUnavailtime=modemUnavailtime, radioEntry=radioEntry, e1t1LOS=e1t1LOS, radioTxFrequency=radioTxFrequency, modemRowStatus=modemRowStatus, ethTXGiants=ethTXGiants, vlanTable=vlanTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatTable=e1t1StatTable, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterHi=ethTXByteCounterHi, modemACMengine=modemACMengine, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMin=modemACMmodulationMin, radioDuplexShift=radioDuplexShift, localIp=localIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, atpcEnabled=atpcEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxMute=radioTxMute, modemModulation=modemModulation, ethTXBroadcasts=ethTXBroadcasts, writeConfig=writeConfig, ethQOSTXDropped=ethQOSTXDropped, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterLow=ethRXByteCounterLow, radioTable=radioTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, vlanFid=vlanFid, ipRadioCfg=ipRadioCfg, localIpMask=localIpMask, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxPower=radioTxPower, modemStatistics=modemStatistics, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, ethRXControlFrames=ethRXControlFrames, vlanRowStatus=vlanRowStatus, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, restartcpu=restartcpu, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, safip=safip, modemCarrierOffset=modemCarrierOffset, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, atpcIndex=atpcIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1Channels=modemE1T1Channels, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxFrequency=radioRxFrequency, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, microwaveRadio=microwaveRadio, description=description, ethRXCRCErrors=ethRXCRCErrors, ipRadio=ipRadio, licenseUpdateStatus=licenseUpdateStatus, modemEntry=modemEntry, modemTable=modemTable)
