...
MibIdentifier, TimeTicks, ModuleIdentity, Unsigned32, Counter64, NotificationType, NotificationType, Counter32, enterprises, Bits, iso, ObjectIdentity, IpAddress, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter64", "NotificationType", "NotificationType", "Counter32", "enterprises", "Bits", "iso", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, description=description, modemACMmodulationMin=modemACMmodulationMin, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, radioIndex=radioIndex, modemStandard=modemStandard, e1t1LOS=e1t1LOS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, modemStatistics=modemStatistics, licenseMask=licenseMask, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDribleNibbles=ethRXDribleNibbles, modemUnavailtime=modemUnavailtime, ethTXLateCollisions=ethTXLateCollisions, ethRXDvEvent=ethRXDvEvent, radioTxPower=radioTxPower, e1t1StatTable=e1t1StatTable, modemTotalBlockNumber=modemTotalBlockNumber, modemBandwith=modemBandwith, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, ethRXBroadcasts=ethRXBroadcasts, radioSide=radioSide, vlanTable=vlanTable, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, radioEntry=radioEntry, modemIndex=modemIndex, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, safip=safip, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, ipRadioStat=ipRadioStat, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXControlFrames=ethTXControlFrames, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, radioTxMute=radioTxMute, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, writeConfig=writeConfig, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, localIpMask=localIpMask, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, product=product, ethRXByteCounterHi=ethRXByteCounterHi, radioTable=radioTable, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, modemRadialMSE=modemRadialMSE, e1t1StatEntry=e1t1StatEntry, vlanNumber=vlanNumber, radioGenStatus=radioGenStatus, modemUptime=modemUptime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, vlanPortmap=vlanPortmap, modemLastAcqError=modemLastAcqError, ethQOSTXFrames=ethQOSTXFrames, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioStatEth=ipRadioStatEth, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, vlanRowStatus=vlanRowStatus, restartcpu=restartcpu, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, vlanFid=vlanFid, microwaveRadio=microwaveRadio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCRCErrors=ethRXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemErroredBlock=modemErroredBlock, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, radioRxFrequency=radioRxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, modemE1T1Channels=modemE1T1Channels, licenseUpdateStatus=licenseUpdateStatus, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, modemCarrierOffset=modemCarrierOffset, vlanEntry=vlanEntry, ipRadioMgmt=ipRadioMgmt, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, license=license, ethTXCollisions=ethTXCollisions, ethTXCRCErrors=ethTXCRCErrors, remoteIp=remoteIp, radioLoopback=radioLoopback, modemEntry=modemEntry, modemTable=modemTable, ipRadioCfg=ipRadioCfg, ethRXTruncatedFrames=ethRXTruncatedFrames)
