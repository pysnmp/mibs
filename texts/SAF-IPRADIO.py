...
# Produced by pysmi-1.1.12 at Wed May 29 11:00:48 2024
...
iso, ModuleIdentity, Gauge32, MibIdentifier, NotificationType, NotificationType, Bits, Counter32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ObjectIdentity, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "NotificationType", "Bits", "Counter32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanCfgStat=vlanCfgStat, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStatEth=ipRadioStatEth, modemSymbolRateRx=modemSymbolRateRx, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, ethTXDones=ethTXDones, saf=saf, modemEthernetCapacity=modemEthernetCapacity, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, modemTable=modemTable, vlanRowStatus=vlanRowStatus, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, modemEntry=modemEntry, ethTXCollisions=ethTXCollisions, microwaveRadio=microwaveRadio, ethRXByteCounterLow=ethRXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXFrames=ethQOSTXFrames, modemLastAcqError=modemLastAcqError, license=license, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCountTime=modemCountTime, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, description=description, radioTxPower=radioTxPower, tehnika=tehnika, ipRadio=ipRadio, localIp=localIp, modemRowStatus=modemRowStatus, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXGiants=ethTXGiants, restartcpu=restartcpu, vlansEnabled=vlansEnabled, radioTable=radioTable, modemACMtotalCapacity=modemACMtotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemModulation=modemModulation, radioGenStatus=radioGenStatus, modemACMengine=modemACMengine, product=product, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCEntry=aTPCEntry, vlanFid=vlanFid, radioSide=radioSide, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1Channels=modemE1T1Channels, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPrevPktDropped=ethRXPrevPktDropped, safip=safip, remoteIp=remoteIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, modemStatistics=modemStatistics, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, radioLoopback=radioLoopback, hostname=hostname, vlanNumber=vlanNumber, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1ChannelNr=e1t1ChannelNr, licenseUpdateStatus=licenseUpdateStatus, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, ethTXBroadcasts=ethTXBroadcasts, radioDuplexShift=radioDuplexShift, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, sysTemperature=sysTemperature, modemBandwith=modemBandwith, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns, vlanPortmap=vlanPortmap, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, modemTotalBlockNumber=modemTotalBlockNumber, aTPCTable=aTPCTable, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, ethTXControlFrames=ethTXControlFrames, modemErroredSecond=modemErroredSecond, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, ethRXPauseFrames=ethRXPauseFrames, ipRadioMgmt=ipRadioMgmt, ethRXMulticasts=ethRXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors)
