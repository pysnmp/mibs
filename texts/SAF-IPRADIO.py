...
# Produced by pysmi-1.1.12 at Tue May 28 13:41:34 2024
...
TimeTicks, ModuleIdentity, Gauge32, Integer32, Counter64, IpAddress, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, Unsigned32, MibIdentifier, NotificationType, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Gauge32", "Integer32", "Counter64", "IpAddress", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "Unsigned32", "MibIdentifier", "NotificationType", "Bits", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlansEnabled=vlansEnabled, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemModulation=modemModulation, modemCarrierOffset=modemCarrierOffset, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, ethRXDvEvent=ethRXDvEvent, radioGenStatus=radioGenStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStandard=modemStandard, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortmap=vlanPortmap, localIpMask=localIpMask, ipRadioStatEth=ipRadioStatEth, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, ethTXVlanTags=ethTXVlanTags, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMaxCollisions=ethTXMaxCollisions, product=product, ethTXGiants=ethTXGiants, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, tehnika=tehnika, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEthernetCapacity=modemEthernetCapacity, ethTXControlFrames=ethTXControlFrames, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, modemACMengine=modemACMengine, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, modemUnavailtime=modemUnavailtime, localIp=localIp, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, sysTemperature=sysTemperature, description=description, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, saf=saf, modemErroredSecond=modemErroredSecond, modemIndex=modemIndex, vlanTable=vlanTable, modemUptime=modemUptime, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, aTPCEntry=aTPCEntry, modemTable=modemTable, modemAcqStatus=modemAcqStatus, ethRXMulticasts=ethRXMulticasts, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, microwaveRadio=microwaveRadio, ipRadioCfg=ipRadioCfg, pointToPoint=pointToPoint, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXExcessiveDefers=ethTXExcessiveDefers, modemStatistics=modemStatistics, aTPCTable=aTPCTable, vlanRowStatus=vlanRowStatus, hostname=hostname, radioTxMute=radioTxMute, ethTXLateCollisions=ethTXLateCollisions, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones, radioRxFrequency=radioRxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, vlanCfgStat=vlanCfgStat, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioMgmt=ipRadioMgmt, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, license=license, e1t1AIS=e1t1AIS, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopback_tributary_mask=loopback_tributary_mask, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, ethGFPFCSErrors=ethGFPFCSErrors, radioRxLevel=radioRxLevel, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1LOS=e1t1LOS, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, radioTxPower=radioTxPower, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry)
