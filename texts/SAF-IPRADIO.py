...
# Produced by pysmi-1.1.0 at Mon Nov 15 20:15:14 2021
...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, ObjectIdentity, Counter32, IpAddress, TimeTicks, ModuleIdentity, NotificationType, Bits, Counter64, iso, NotificationType, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "Counter64", "iso", "NotificationType", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseUpdateStatus=licenseUpdateStatus, loopback_tributary_mask=loopback_tributary_mask, modemTable=modemTable, modemACMengine=modemACMengine, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, hostname=hostname, e1t1AIS=e1t1AIS, ethRXControlFrames=ethRXControlFrames, vlansEnabled=vlansEnabled, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, radioEntry=radioEntry, vlanPortType=vlanPortType, remoteIp=remoteIp, saf=saf, ethRXBroadcasts=ethRXBroadcasts, modemStatistics=modemStatistics, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, aTPCTable=aTPCTable, ipRadio=ipRadio, modemRadialMSE=modemRadialMSE, description=description, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEntry=modemEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalCapacity=modemTotalCapacity, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCodeErrors=ethRXCodeErrors, vlanFid=vlanFid, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, safip=safip, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXFrames=ethQOSTXFrames, writeConfig=writeConfig, radioDuplexShift=radioDuplexShift, modemAcqStatus=modemAcqStatus, vlanCfgStat=vlanCfgStat, product=product, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMax=modemACMmodulationMax, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopbacks=loopbacks, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, tehnika=tehnika, vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, ipRadioStatEth=ipRadioStatEth, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioGenStatus=radioGenStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, microwaveRadio=microwaveRadio, ethTXControlFrames=ethTXControlFrames, radioLoopback=radioLoopback, ethRXMulticasts=ethRXMulticasts, sysDateAndTime=sysDateAndTime, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, vlanNumber=vlanNumber, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, modemUptime=modemUptime, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1Channels=modemE1T1Channels, aTPCEntry=aTPCEntry, radioRxFrequency=radioRxFrequency, modemGeneralStatus=modemGeneralStatus, license=license, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, atpcIndex=atpcIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxMute=radioTxMute, ipRadioMgmt=ipRadioMgmt, restartcpu=restartcpu, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, radioTxPower=radioTxPower, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateRx=modemSymbolRateRx, atpcEnabled=atpcEnabled, ethTXBackpresEvents=ethTXBackpresEvents, localIp=localIp, modemIndex=modemIndex, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, ethGFPFCSErrors=ethGFPFCSErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemCountTime=modemCountTime, vlanTable=vlanTable, ethRXDones=ethRXDones, radioIndex=radioIndex, ethTXBroadcasts=ethTXBroadcasts, ethTXGiants=ethTXGiants, modemErroredSecond=modemErroredSecond, radioSide=radioSide, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, modemModulation=modemModulation, ipRadioStat=ipRadioStat, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, modemACMtotalCapacity=modemACMtotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected)
