...
Gauge32, Counter64, Unsigned32, Integer32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Bits, NotificationType, ModuleIdentity, IpAddress, enterprises, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Unsigned32", "Integer32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Bits", "NotificationType", "ModuleIdentity", "IpAddress", "enterprises", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, radioSide=radioSide, sysTemperature=sysTemperature, ethQOSTXFrames=ethQOSTXFrames, radioGenStatus=radioGenStatus, modemRowStatus=modemRowStatus, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, modemIndex=modemIndex, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemAcqStatus=modemAcqStatus, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalCapacity=modemTotalCapacity, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, modemErroredBlock=modemErroredBlock, vlansEnabled=vlansEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortmap=vlanPortmap, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, localIp=localIp, vlanRowStatus=vlanRowStatus, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, radioTable=radioTable, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXDropped=ethQOSTXDropped, ethTXCollisions=ethTXCollisions, writeConfig=writeConfig, modemE1T1Channels=modemE1T1Channels, ethRXMulticasts=ethRXMulticasts, ethTXBroadcasts=ethTXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStatistics=modemStatistics, ethRXControlFrames=ethRXControlFrames, modemStandard=modemStandard, modemBandwith=modemBandwith, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, microwaveRadio=microwaveRadio, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUptime=modemUptime, ipRadioCfg=ipRadioCfg, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, modemLastAcqError=modemLastAcqError, ethTXGiants=ethTXGiants, atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, aTPCEntry=aTPCEntry, remoteIp=remoteIp, license=license, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSymbolRateTx=modemSymbolRateTx, loopbacks=loopbacks, ethRXPrevPktDropped=ethRXPrevPktDropped, saf=saf, modemCountTime=modemCountTime, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, ethRXLongEvents=ethRXLongEvents, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioIndex=radioIndex, modemTable=modemTable, description=description, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysDateAndTime=sysDateAndTime, ethRXDvEvent=ethRXDvEvent, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, ethTXControlFrames=ethTXControlFrames, radioTxMute=radioTxMute, modemModulation=modemModulation, modemEntry=modemEntry, modemACMmodulationMin=modemACMmodulationMin, vlanEntry=vlanEntry, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, e1t1StatTable=e1t1StatTable, ethTXDones=ethTXDones, product=product, ethTXBackpresEvents=ethTXBackpresEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, e1t1AIS=e1t1AIS, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, ethRXDones=ethRXDones, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain)
