...
NotificationType, iso, Counter32, IpAddress, ModuleIdentity, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, enterprises, Unsigned32, NotificationType, Integer32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "enterprises", "Unsigned32", "NotificationType", "Integer32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, ipRadio=ipRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, hostname=hostname, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, modemEntry=modemEntry, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXMaxCollisions=ethTXMaxCollisions, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, ethTXBackpresEvents=ethTXBackpresEvents, modemModulation=modemModulation, ethTXByteCounterLow=ethTXByteCounterLow, radioIndex=radioIndex, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, e1t1AIS=e1t1AIS, modemErroredSecondRatio=modemErroredSecondRatio, modemIndex=modemIndex, ipRadioMgmt=ipRadioMgmt, licenseUpdateStatus=licenseUpdateStatus, loopbacks=loopbacks, ethQOSTXDropped=ethQOSTXDropped, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, safip=safip, ipRadioStatEth=ipRadioStatEth, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, ethRXBroadcasts=ethRXBroadcasts, aTPCEntry=aTPCEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, product=product, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, ethRXMulticasts=ethRXMulticasts, radioRxFrequency=radioRxFrequency, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMin=modemACMmodulationMin, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, vlanNumber=vlanNumber, vlanTable=vlanTable, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, localIp=localIp, sysTemperature=sysTemperature, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemTable=modemTable, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, modemGeneralStatus=modemGeneralStatus, saf=saf, description=description, radioSide=radioSide, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, radioTable=radioTable, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUptime=modemUptime, modemLastAcqError=modemLastAcqError, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, radioLoopback=radioLoopback, vlanFid=vlanFid, ethRXCRCErrors=ethRXCRCErrors, aTPCTable=aTPCTable, license=license, ethRXControlFrames=ethRXControlFrames, atpcEnabled=atpcEnabled, radioTxMute=radioTxMute, tehnika=tehnika, vlanEntry=vlanEntry, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax)
