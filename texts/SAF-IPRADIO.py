...
# Produced by pysmi-1.1.12 at Tue Jun 25 14:16:52 2024
...
ObjectIdentity, IpAddress, Counter64, Counter32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, iso, Gauge32, Bits, NotificationType, MibIdentifier, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter64", "Counter32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "iso", "Gauge32", "Bits", "NotificationType", "MibIdentifier", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateRx=modemSymbolRateRx, vlanTable=vlanTable, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, modemRadialMSE=modemRadialMSE, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, loopback_tributary_mask=loopback_tributary_mask, modemEthernetCapacity=modemEthernetCapacity, localIpMask=localIpMask, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, localIp=localIp, modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, modemLastAcqError=modemLastAcqError, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemIndex=modemIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioLoopback=radioLoopback, modemGeneralStatus=modemGeneralStatus, ethTXPauseFrames=ethTXPauseFrames, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, ipRadio=ipRadio, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, ethTXMulticasts=ethTXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, ethRXTruncatedFrames=ethRXTruncatedFrames, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, radioRxLevel=radioRxLevel, modemRowStatus=modemRowStatus, modemErroredSecond=modemErroredSecond, saf=saf, ipRadioStat=ipRadioStat, license=license, radioIndex=radioIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, safip=safip, ethRXDvEvent=ethRXDvEvent, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTable=radioTable, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, restartcpu=restartcpu, ethRXDones=ethRXDones, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, aTPCEntry=aTPCEntry, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStatEth=ipRadioStatEth, ipRadioCfgNetwork=ipRadioCfgNetwork, tehnika=tehnika, aTPCTable=aTPCTable, vlanEntry=vlanEntry, ethTXBroadcasts=ethTXBroadcasts, modemTotalCapacity=modemTotalCapacity, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanFid=vlanFid, modemLDPCdecoderStress=modemLDPCdecoderStress, hostname=hostname, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, modemBandwith=modemBandwith, ethTXUnderruns=ethTXUnderruns, modemStatistics=modemStatistics, modemModulation=modemModulation, writeConfig=writeConfig, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, ethQOSTXDropped=ethQOSTXDropped, vlansEnabled=vlansEnabled, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, e1t1AIS=e1t1AIS, modemE1T1Channels=modemE1T1Channels, ethGFPDropedFrames=ethGFPDropedFrames, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, ethRXPauseFrames=ethRXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortmap=vlanPortmap, ethRXLongEvents=ethRXLongEvents, ethRXBroadcasts=ethRXBroadcasts, loopbacks=loopbacks, ethGFPDelineationErrors=ethGFPDelineationErrors)
