...
# Produced by pysmi-1.1.12 at Wed May 29 07:27:45 2024
...
Unsigned32, NotificationType, ObjectIdentity, Bits, ModuleIdentity, Integer32, MibIdentifier, enterprises, NotificationType, IpAddress, Counter64, iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ObjectIdentity", "Bits", "ModuleIdentity", "Integer32", "MibIdentifier", "enterprises", "NotificationType", "IpAddress", "Counter64", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, loopbacks=loopbacks, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, description=description, e1t1StatEntry=e1t1StatEntry, saf=saf, modemInternalAGCgain=modemInternalAGCgain, safip=safip, ethRXControlFrames=ethRXControlFrames, ethRXCodeErrors=ethRXCodeErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, radioSide=radioSide, radioGenStatus=radioGenStatus, modemStatistics=modemStatistics, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, ipRadioMgmt=ipRadioMgmt, aTPCEntry=aTPCEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, license=license, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, ethRXDones=ethRXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadio=ipRadio, atpcIndex=atpcIndex, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, modemRadialMSE=modemRadialMSE, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateTx=modemSymbolRateTx, ethTXPauseFrames=ethTXPauseFrames, modemBandwith=modemBandwith, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, vlanNumber=vlanNumber, ethGFPCHECErrors=ethGFPCHECErrors, ethTXDones=ethTXDones, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBackpresEvents=ethTXBackpresEvents, product=product, microwaveRadio=microwaveRadio, modemIndex=modemIndex, radioLoopback=radioLoopback, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterLow=ethTXByteCounterLow, radioTxMute=radioTxMute, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, ipRadioCfg=ipRadioCfg, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, modemAcqStatus=modemAcqStatus, modemStandard=modemStandard, ethTXCRCErrors=ethTXCRCErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, licenseMask=licenseMask, ethRXPauseFrames=ethRXPauseFrames, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, ipRadioStat=ipRadioStat, remoteIp=remoteIp, tehnika=tehnika, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, vlanPortmap=vlanPortmap, ethTXBroadcasts=ethTXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, ethTXMulticasts=ethTXMulticasts, radioEntry=radioEntry, localIp=localIp, restartcpu=restartcpu, modemUptime=modemUptime, writeConfig=writeConfig, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTable=modemTable, modemE1T1Channels=modemE1T1Channels, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, pointToPoint=pointToPoint, hostname=hostname, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, ethTXCollisions=ethTXCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecondRatio=modemErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemUnavailtime=modemUnavailtime)
