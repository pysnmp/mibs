...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:28:23 2024
...
Integer32, Counter32, Unsigned32, NotificationType, Counter64, ModuleIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, IpAddress, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "IpAddress", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXByteCounterLow=ethRXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, modemIndex=modemIndex, modemE1T1Channels=modemE1T1Channels, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStat=ipRadioStat, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, modemEntry=modemEntry, ethTXVlanTags=ethTXVlanTags, modemRowStatus=modemRowStatus, e1t1AIS=e1t1AIS, ethRXPauseFrames=ethRXPauseFrames, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, modemSymbolRateRx=modemSymbolRateRx, modemCountTime=modemCountTime, modemRadialMSE=modemRadialMSE, modemBandwith=modemBandwith, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBroadcasts=ethTXBroadcasts, modemACMengine=modemACMengine, ethTXCollisions=ethTXCollisions, ethTXGiants=ethTXGiants, ethRXCodeErrors=ethRXCodeErrors, radioTxFrequency=radioTxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateTx=modemSymbolRateTx, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, writeConfig=writeConfig, remoteIp=remoteIp, modemACMmodulationMin=modemACMmodulationMin, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, modemTable=modemTable, tehnika=tehnika, product=product, modemAcqStatus=modemAcqStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemTotalBlockNumber=modemTotalBlockNumber, e1t1ChannelNr=e1t1ChannelNr, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, microwaveRadio=microwaveRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, ethTXByteCounterHi=ethTXByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, modemStatistics=modemStatistics, vlanTable=vlanTable, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, radioTable=radioTable, localIp=localIp, radioIndex=radioIndex, license=license, modemLastAcqError=modemLastAcqError, description=description, sysTemperature=sysTemperature, ethTXMaxCollisions=ethTXMaxCollisions, ethRXBroadcasts=ethRXBroadcasts, ethRXDvEvent=ethRXDvEvent, aTPCTable=aTPCTable, ethTXDones=ethTXDones, restartcpu=restartcpu, licenseUpdateStatus=licenseUpdateStatus, e1t1StatEntry=e1t1StatEntry, ethQOSTXFrames=ethQOSTXFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxPower=radioTxPower, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, safip=safip, ethTXCRCErrors=ethTXCRCErrors, atpcIndex=atpcIndex, licenseMask=licenseMask, vlanNumber=vlanNumber, radioSide=radioSide, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, saf=saf, vlanPortmap=vlanPortmap, modemErroredSecond=modemErroredSecond, e1t1LOS=e1t1LOS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, hostname=hostname, atpcEnabled=atpcEnabled, modemModulation=modemModulation, vlanPortType=vlanPortType, e1t1StatTable=e1t1StatTable, ethRXDones=ethRXDones, radioLoopback=radioLoopback, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, modemStandard=modemStandard, loopbacks=loopbacks, modemUptime=modemUptime, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask)
