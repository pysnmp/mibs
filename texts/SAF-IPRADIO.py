...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:44:55 2021
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Integer32, Unsigned32, MibIdentifier, TimeTicks, enterprises, Gauge32, Counter64, ModuleIdentity, IpAddress, ObjectIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Integer32", "Unsigned32", "MibIdentifier", "TimeTicks", "enterprises", "Gauge32", "Counter64", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, ethGFPDropedFrames=ethGFPDropedFrames, modemGeneralStatus=modemGeneralStatus, safip=safip, ipRadioStatEth=ipRadioStatEth, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, atpcIndex=atpcIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, saf=saf, writeConfig=writeConfig, ethTXDones=ethTXDones, e1t1LOS=e1t1LOS, e1t1StatTable=e1t1StatTable, radioTxPower=radioTxPower, remoteIp=remoteIp, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXVlanTags=ethTXVlanTags, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, ethRXDones=ethRXDones, modemUptime=modemUptime, e1t1StatEntry=e1t1StatEntry, aTPCTable=aTPCTable, radioTxMute=radioTxMute, ipRadioCfg=ipRadioCfg, ipRadioStat=ipRadioStat, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMin=modemACMmodulationMin, radioLoopback=radioLoopback, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanEntry=vlanEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalBlockNumber=modemTotalBlockNumber, e1t1ChannelNr=e1t1ChannelNr, modemTotalCapacity=modemTotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemLastAcqError=modemLastAcqError, e1t1AIS=e1t1AIS, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, modemInternalAGCgain=modemInternalAGCgain, ethTXPauseFrames=ethTXPauseFrames, sysDateAndTime=sysDateAndTime, loopback_tributary_mask=loopback_tributary_mask, radioDuplexShift=radioDuplexShift, vlanPortType=vlanPortType, microwaveRadio=microwaveRadio, modemErroredSecondRatio=modemErroredSecondRatio, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXGiants=ethTXGiants, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, atpcEnabled=atpcEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, vlanNumber=vlanNumber, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, pointToPoint=pointToPoint, modemACMethernetCapacity=modemACMethernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXMulticasts=ethTXMulticasts, ipRadio=ipRadio, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, description=description, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxLevel=radioRxLevel, hostname=hostname, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMengine=modemACMengine, localIpMask=localIpMask, restartcpu=restartcpu, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, radioGenStatus=radioGenStatus, modemTable=modemTable, modemEthernetCapacity=modemEthernetCapacity, modemStandard=modemStandard, ipRadioMgmt=ipRadioMgmt, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterHi=ethRXByteCounterHi, licenseMask=licenseMask, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, license=license, modemIndex=modemIndex, modemACMtotalCapacity=modemACMtotalCapacity, product=product, radioIndex=radioIndex, vlansEnabled=vlansEnabled, ethTXByteCounterHi=ethTXByteCounterHi, ethRXMulticasts=ethRXMulticasts, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, modemBandwith=modemBandwith, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCountTime=modemCountTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, ethRXControlFrames=ethRXControlFrames)
