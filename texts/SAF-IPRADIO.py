...
# Produced by pysmi-1.1.12 at Thu Nov 28 03:02:55 2024
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLateCollisions=ethTXLateCollisions, ipRadio=ipRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, product=product, localIp=localIp, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, ethTXCRCErrors=ethTXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, e1t1AIS=e1t1AIS, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, ethRXBroadcasts=ethRXBroadcasts, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, ipRadioStatEth=ipRadioStatEth, ethRXByteCounterHi=ethRXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, modemRowStatus=modemRowStatus, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, vlanPortType=vlanPortType, modemACMengine=modemACMengine, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, ipRadioMgmt=ipRadioMgmt, ethTXBroadcasts=ethTXBroadcasts, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, modemTable=modemTable, radioSide=radioSide, modemUptime=modemUptime, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanTable=vlanTable, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, modemGeneralStatus=modemGeneralStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxMute=radioTxMute, sysTemperature=sysTemperature, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, vlanCfgStat=vlanCfgStat, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCTable=aTPCTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, license=license, ethQOSTXFrames=ethQOSTXFrames, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, atpcIndex=atpcIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIpMask=localIpMask, ethGFPCHECErrors=ethGFPCHECErrors, radioTable=radioTable, hostname=hostname, ethTXVlanTags=ethTXVlanTags, pointToPoint=pointToPoint, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXMulticasts=ethRXMulticasts, modemModulation=modemModulation, loopbacks=loopbacks, modemStandard=modemStandard, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanNumber=vlanNumber, ethTXDones=ethTXDones, saf=saf, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, ethRXTruncatedFrames=ethRXTruncatedFrames, description=description, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecondRatio=modemErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, ipRadioCfg=ipRadioCfg, licenseMask=licenseMask, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXPauseFrames=ethRXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, writeConfig=writeConfig, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, modemACMethernetCapacity=modemACMethernetCapacity, radioDuplexShift=radioDuplexShift, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLongEvents=ethRXLongEvents, modemTotalCapacity=modemTotalCapacity, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, vlanPortmap=vlanPortmap, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, safip=safip, modemCountTime=modemCountTime)
