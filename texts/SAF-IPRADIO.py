...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, IpAddress, Integer32, NotificationType, TimeTicks, ObjectIdentity, enterprises, Bits, Counter64, Counter32, Gauge32, NotificationType, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "IpAddress", "Integer32", "NotificationType", "TimeTicks", "ObjectIdentity", "enterprises", "Bits", "Counter64", "Counter32", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSTXFrames=ethQOSTXFrames, ethTXDones=ethTXDones, ethRXLongEvents=ethRXLongEvents, localIpMask=localIpMask, ethRXPrevPktDropped=ethRXPrevPktDropped, sysTemperature=sysTemperature, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, ethTXLateCollisions=ethTXLateCollisions, modemTotalBlockNumber=modemTotalBlockNumber, modemCountTime=modemCountTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCEntry=aTPCEntry, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, writeConfig=writeConfig, radioGenStatus=radioGenStatus, license=license, ethRXByteCounterHi=ethRXByteCounterHi, radioTxMute=radioTxMute, ipRadioStat=ipRadioStat, ipRadioCfg=ipRadioCfg, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecond=modemErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSTXDropped=ethQOSTXDropped, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, radioSide=radioSide, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, licenseMask=licenseMask, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, ethRXCRCErrors=ethRXCRCErrors, modemE1T1Channels=modemE1T1Channels, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, radioIndex=radioIndex, radioDuplexShift=radioDuplexShift, modemACMmodulationMin=modemACMmodulationMin, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, ethTXMulticasts=ethTXMulticasts, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEntry=modemEntry, e1t1LOS=e1t1LOS, vlansEnabled=vlansEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, pointToPoint=pointToPoint, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUnavailtime=modemUnavailtime, modemTable=modemTable, modemStatistics=modemStatistics, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXCollisions=ethTXCollisions, modemACMmodulationMax=modemACMmodulationMax, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPauseFrames=ethRXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, ipRadio=ipRadio, remoteIp=remoteIp, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, modemInternalAGCgain=modemInternalAGCgain, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemModulation=modemModulation, saf=saf, localIp=localIp, modemIndex=modemIndex, radioRxFrequency=radioRxFrequency, modemStandard=modemStandard, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, modemACMethernetCapacity=modemACMethernetCapacity, modemRowStatus=modemRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, product=product, licenseUpdateStatus=licenseUpdateStatus, safip=safip, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, modemBandwith=modemBandwith, loopbacks=loopbacks, microwaveRadio=microwaveRadio, radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, ethTXControlFrames=ethTXControlFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDones=ethRXDones, modemACMengine=modemACMengine, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, vlanCfgStat=vlanCfgStat, e1t1StatTable=e1t1StatTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioLoopback=radioLoopback, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, atpcEnabled=atpcEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, restartcpu=restartcpu, ethRXTruncatedFrames=ethRXTruncatedFrames, description=description, modemLastAcqError=modemLastAcqError, loopback_tributary_mask=loopback_tributary_mask)
