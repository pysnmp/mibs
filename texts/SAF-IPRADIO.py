...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:54:58 2021
...
Counter32, TimeTicks, Integer32, NotificationType, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Bits, Unsigned32, MibIdentifier, Counter64, ObjectIdentity, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Bits", "Unsigned32", "MibIdentifier", "Counter64", "ObjectIdentity", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortType=vlanPortType, radioTable=radioTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, modemIndex=modemIndex, radioTxPower=radioTxPower, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, modemTotalBlockNumber=modemTotalBlockNumber, e1t1LOS=e1t1LOS, microwaveRadio=microwaveRadio, loopback_tributary_mask=loopback_tributary_mask, modemLastAcqError=modemLastAcqError, modemBandwith=modemBandwith, ethTXCRCErrors=ethTXCRCErrors, localIp=localIp, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemModulation=modemModulation, modemTable=modemTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioIndex=radioIndex, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXDones=ethTXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredSecond=modemErroredSecond, modemSymbolRateRx=modemSymbolRateRx, remoteIp=remoteIp, modemACMethernetCapacity=modemACMethernetCapacity, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDvEvent=ethRXDvEvent, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxFrequency=radioTxFrequency, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, modemTotalCapacity=modemTotalCapacity, writeConfig=writeConfig, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecondRatio=modemErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, hostname=hostname, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPCHECErrors=ethGFPCHECErrors, license=license, modemUnavailtime=modemUnavailtime, loopbacks=loopbacks, radioRxFrequency=radioRxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadio=ipRadio, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStandard=modemStandard, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStatistics=modemStatistics, vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, modemRowStatus=modemRowStatus, ethTXMaxCollisions=ethTXMaxCollisions, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateTx=modemSymbolRateTx, e1t1StatTable=e1t1StatTable, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, e1t1StatEntry=e1t1StatEntry, ethTXBackpresEvents=ethTXBackpresEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterHi=ethRXByteCounterHi, ethRXMulticasts=ethRXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1Channels=modemE1T1Channels, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, ethRXCRCErrors=ethRXCRCErrors, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, safip=safip, e1t1ChannelNr=e1t1ChannelNr, ethRXControlFrames=ethRXControlFrames, ipRadioMgmt=ipRadioMgmt, ethTXPauseFrames=ethTXPauseFrames, modemEntry=modemEntry, vlanTable=vlanTable, product=product, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCEntry=aTPCEntry, saf=saf, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, sysTemperature=sysTemperature, description=description, radioSide=radioSide, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanEntry=vlanEntry, radioTxMute=radioTxMute, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE)
