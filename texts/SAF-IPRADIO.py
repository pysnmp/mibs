...
# ASN.1 source SAF-IPRADIO
# Source digest sha256:81fca8da09634392c9d92f7743a36eaf319f1712af10d35f4621c9033492376d
...
radioTable = MibTable((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 10), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: radioTable.setStatus('mandatory')
if mibBuilder.loadTexts: radioTable.setDescription('Radio table.')
radioEntry = MibTableRow((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 10, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SAF-IPRADIO", "radioIndex"))
...
aTPCTable = MibTable((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 11), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: aTPCTable.setStatus('mandatory')
if mibBuilder.loadTexts: aTPCTable.setDescription('ATPC table')
aTPCEntry = MibTableRow((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 11, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SAF-IPRADIO", "atpcIndex"))
...
modemTable = MibTable((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 12), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: modemTable.setStatus('mandatory')
if mibBuilder.loadTexts: modemTable.setDescription('CFIP modem table.')
modemEntry = MibTableRow((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 12, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SAF-IPRADIO", "modemIndex"))
...
vlanTable = MibTable((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 14), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: vlanTable.setStatus('mandatory')
if mibBuilder.loadTexts: vlanTable.setDescription('Vlan table')
vlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 1, 1, 14, 1), ).setMaxAccess("notaccessible")
...
e1t1StatTable = MibTable((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 3, 3), ).setMaxAccess("notaccessible")
...
e1t1StatEntry = MibTableRow((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 5, 1, 3, 3, 1), ).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, atpcEnabled=atpcEnabled, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, ethQOSTXFrames=ethQOSTXFrames, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDvEvent=ethRXDvEvent, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBackpresEvents=ethTXBackpresEvents, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, ethTXCollisions=ethTXCollisions, ethTXControlFrames=ethTXControlFrames, ethTXDones=ethTXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXGiants=ethTXGiants, ethTXLateCollisions=ethTXLateCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXMulticasts=ethTXMulticasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, ipRadio=ipRadio, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, ipRadioStatEth=ipRadioStatEth, license=license, licenseMask=licenseMask, licenseUpdateStatus=licenseUpdateStatus, localIp=localIp, localIpMask=localIpMask, loopback_tributary_mask=loopback_tributary_mask, loopbacks=loopbacks, microwaveRadio=microwaveRadio, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, modemACMtotalCapacity=modemACMtotalCapacity, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemE1T1Channels=modemE1T1Channels, modemEntry=modemEntry, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, modemLastAcqError=modemLastAcqError, modemModulation=modemModulation, modemRadialMSE=modemRadialMSE, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStandard=modemStandard, modemStatistics=modemStatistics, modemSymbolRateRx=modemSymbolRateRx, modemSymbolRateTx=modemSymbolRateTx, modemTable=modemTable, modemTotalBlockNumber=modemTotalBlockNumber, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, modemUptime=modemUptime, pointToPoint=pointToPoint, product=product, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, radioGenStatus=radioGenStatus, radioIndex=radioIndex, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, radioRxLevel=radioRxLevel, radioSide=radioSide, radioTable=radioTable, radioTxFrequency=radioTxFrequency, radioTxMute=radioTxMute, radioTxPower=radioTxPower, remoteIp=remoteIp, restartcpu=restartcpu, saf=saf, safip=safip, sysDateAndTime=sysDateAndTime, sysTemperature=sysTemperature, tehnika=tehnika, vlanCfgStat=vlanCfgStat, vlanEntry=vlanEntry, vlanFid=vlanFid, vlanNumber=vlanNumber, vlanPortType=vlanPortType, vlanPortmap=vlanPortmap, vlanRowStatus=vlanRowStatus, vlanTable=vlanTable, vlansEnabled=vlansEnabled, writeConfig=writeConfig)
