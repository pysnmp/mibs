...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:52:22 2021
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ModuleIdentity, iso, MibIdentifier, Bits, Integer32, TimeTicks, Counter64, Unsigned32, ObjectIdentity, Counter32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ModuleIdentity", "iso", "MibIdentifier", "Bits", "Integer32", "TimeTicks", "Counter64", "Unsigned32", "ObjectIdentity", "Counter32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatEntry=e1t1StatEntry, ethQOSTXDropped=ethQOSTXDropped, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency, ethRXCodeErrors=ethRXCodeErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, ethRXVlanTagsDetected=ethRXVlanTagsDetected, description=description, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxLevel=radioRxLevel, writeConfig=writeConfig, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, radioEntry=radioEntry, modemStandard=modemStandard, loopbacks=loopbacks, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1Channels=modemE1T1Channels, modemGeneralStatus=modemGeneralStatus, vlanEntry=vlanEntry, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, modemEthernetCapacity=modemEthernetCapacity, ethRXBroadcasts=ethRXBroadcasts, vlanFid=vlanFid, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, microwaveRadio=microwaveRadio, ethTXControlFrames=ethTXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethTXCollisions=ethTXCollisions, localIpMask=localIpMask, radioTxFrequency=radioTxFrequency, ethTXPauseFrames=ethTXPauseFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseMask=licenseMask, ethRXControlFrames=ethRXControlFrames, radioIndex=radioIndex, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, modemModulation=modemModulation, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, radioSide=radioSide, ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, modemEntry=modemEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, remoteIp=remoteIp, ethRXByteCounterLow=ethRXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, license=license, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, radioGenStatus=radioGenStatus, restartcpu=restartcpu, safip=safip, ethRXDones=ethRXDones, modemTable=modemTable, modemUptime=modemUptime, ipRadioStat=ipRadioStat, ethTXCRCErrors=ethTXCRCErrors, product=product, modemACMmodulationMax=modemACMmodulationMax, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCEntry=aTPCEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemIndex=modemIndex, e1t1AIS=e1t1AIS, modemStatistics=modemStatistics, radioTxPower=radioTxPower, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, modemRadialMSE=modemRadialMSE, ipRadioStatEth=ipRadioStatEth, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, saf=saf, ethTXMulticasts=ethTXMulticasts, vlanTable=vlanTable, modemACMmodulationMin=modemACMmodulationMin, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrror=modemBackgroundBlockErrror, pointToPoint=pointToPoint, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, vlanRowStatus=vlanRowStatus, loopback_tributary_mask=loopback_tributary_mask, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, aTPCTable=aTPCTable, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx)
