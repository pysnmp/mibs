...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:09:41 2022
...
NotificationType, MibIdentifier, NotificationType, iso, Unsigned32, Counter64, Integer32, enterprises, ModuleIdentity, ObjectIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Counter64", "Integer32", "enterprises", "ModuleIdentity", "ObjectIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCodeErrors=ethRXCodeErrors, modemEthernetCapacity=modemEthernetCapacity, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDones=ethRXDones, ethTXLateCollisions=ethTXLateCollisions, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanTable=vlanTable, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxMute=radioTxMute, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, product=product, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, radioGenStatus=radioGenStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethRXPauseFrames=ethRXPauseFrames, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, ethTXByteCounterLow=ethTXByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, tehnika=tehnika, modemUnavailtime=modemUnavailtime, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCEntry=aTPCEntry, ipRadioMgmt=ipRadioMgmt, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, ethRXBroadcasts=ethRXBroadcasts, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, modemTable=modemTable, safip=safip, radioLoopback=radioLoopback, modemEntry=modemEntry, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanCfgStat=vlanCfgStat, modemACMengine=modemACMengine, radioTable=radioTable, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, ethRXDvEvent=ethRXDvEvent, radioSide=radioSide, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanNumber=vlanNumber, remoteIp=remoteIp, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, modemUptime=modemUptime, radioDuplexShift=radioDuplexShift, atpcIndex=atpcIndex, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, e1t1ChannelNr=e1t1ChannelNr, ethTXBroadcasts=ethTXBroadcasts, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLongEvents=ethRXLongEvents, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, modemACMethernetCapacity=modemACMethernetCapacity, description=description, modemCarrierOffset=modemCarrierOffset, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortType=vlanPortType, ethTXDones=ethTXDones, vlanPortmap=vlanPortmap, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, modemCountTime=modemCountTime, aTPCTable=aTPCTable, loopbacks=loopbacks, e1t1StatEntry=e1t1StatEntry, ethGFPCHECErrors=ethGFPCHECErrors, modemModulation=modemModulation, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, vlanFid=vlanFid, modemErroredBlock=modemErroredBlock, licenseMask=licenseMask, modemBandwith=modemBandwith, license=license, writeConfig=writeConfig, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, microwaveRadio=microwaveRadio, ethTXPauseFrames=ethTXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, radioRxLevel=radioRxLevel, licenseUpdateStatus=licenseUpdateStatus, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1Channels=modemE1T1Channels, localIpMask=localIpMask, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXDropped=ethQOSTXDropped, ethRXCRCErrors=ethRXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDropedFrames=ethGFPDropedFrames, radioTxFrequency=radioTxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, ethRXByteCounterLow=ethRXByteCounterLow, e1t1LOS=e1t1LOS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStatistics=modemStatistics, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts)
