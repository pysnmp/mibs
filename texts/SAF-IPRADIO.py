...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:40:56 2022
...
enterprises, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, iso, Bits, ModuleIdentity, NotificationType, IpAddress, Integer32, NotificationType, Counter64, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "NotificationType", "IpAddress", "Integer32", "NotificationType", "Counter64", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, sysDateAndTime=sysDateAndTime, radioTxFrequency=radioTxFrequency, modemUnavailtime=modemUnavailtime, modemErroredSecond=modemErroredSecond, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXDones=ethTXDones, radioTxMute=radioTxMute, writeConfig=writeConfig, vlanCfgStat=vlanCfgStat, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioIndex=radioIndex, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, ethTXUnderruns=ethTXUnderruns, radioSide=radioSide, modemTotalCapacity=modemTotalCapacity, description=description, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, ethGFPFCSErrors=ethGFPFCSErrors, modemBandwith=modemBandwith, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, loopbacks=loopbacks, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDribleNibbles=ethRXDribleNibbles, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, safip=safip, modemACMengine=modemACMengine, product=product, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTable=radioTable, modemSymbolRateRx=modemSymbolRateRx, modemAcqStatus=modemAcqStatus, modemSymbolRateTx=modemSymbolRateTx, remoteIp=remoteIp, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, modemStatistics=modemStatistics, ethRXByteCounterHi=ethRXByteCounterHi, modemIndex=modemIndex, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, modemTable=modemTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, radioTxPower=radioTxPower, microwaveRadio=microwaveRadio, localIpMask=localIpMask, e1t1LOS=e1t1LOS, vlanNumber=vlanNumber, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPauseFrames=ethRXPauseFrames, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, ethTXControlFrames=ethTXControlFrames, saf=saf, licenseUpdateStatus=licenseUpdateStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, e1t1ChannelNr=e1t1ChannelNr, license=license, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, vlanPortType=vlanPortType, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemModulation=modemModulation, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, ipRadioStat=ipRadioStat, vlanPortmap=vlanPortmap, radioEntry=radioEntry, localIp=localIp, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, tehnika=tehnika, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, licenseMask=licenseMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected)
