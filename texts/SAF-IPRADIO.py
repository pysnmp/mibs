...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:06:58 2022
...
NotificationType, Counter64, enterprises, NotificationType, IpAddress, MibIdentifier, TimeTicks, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Gauge32, iso, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "enterprises", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Gauge32", "iso", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioEntry=radioEntry, saf=saf, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, licenseMask=licenseMask, loopbacks=loopbacks, modemSymbolRateRx=modemSymbolRateRx, modemEthernetCapacity=modemEthernetCapacity, ethGFPFCSErrors=ethGFPFCSErrors, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, radioTxFrequency=radioTxFrequency, modemACMengine=modemACMengine, radioLoopback=radioLoopback, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseUpdateStatus=licenseUpdateStatus, modemStandard=modemStandard, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXControlFrames=ethTXControlFrames, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, modemCarrierOffset=modemCarrierOffset, ethTXVlanTags=ethTXVlanTags, ethRXDvEvent=ethRXDvEvent, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanTable=vlanTable, remoteIp=remoteIp, restartcpu=restartcpu, vlanNumber=vlanNumber, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemLastAcqError=modemLastAcqError, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecond=modemErroredSecond, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, modemBandwith=modemBandwith, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLongEvents=ethRXLongEvents, modemModulation=modemModulation, ethRXDribleNibbles=ethRXDribleNibbles, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, radioDuplexShift=radioDuplexShift, radioSide=radioSide, modemErroredBlock=modemErroredBlock, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, atpcIndex=atpcIndex, radioTxMute=radioTxMute, radioTable=radioTable, vlanPortmap=vlanPortmap, radioRxLevel=radioRxLevel, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcEnabled=atpcEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEntry=modemEntry, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, ethTXLateCollisions=ethTXLateCollisions, ipRadioStatEth=ipRadioStatEth, ethGFPDropedFrames=ethGFPDropedFrames, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, hostname=hostname, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, vlansEnabled=vlansEnabled, writeConfig=writeConfig, license=license, ethTXBroadcasts=ethTXBroadcasts, modemTable=modemTable, ethTXGiants=ethTXGiants, modemInternalAGCgain=modemInternalAGCgain, ethTXDones=ethTXDones, ethRXMulticasts=ethRXMulticasts, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, description=description, microwaveRadio=microwaveRadio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, modemIndex=modemIndex, vlanFid=vlanFid, ipRadioStat=ipRadioStat, modemTotalCapacity=modemTotalCapacity, ethQOSTXDropped=ethQOSTXDropped, product=product, modemUnavailtime=modemUnavailtime, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, tehnika=tehnika, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadio=ipRadio)
