...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:11:45 2024
...
NotificationType, ModuleIdentity, NotificationType, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Gauge32, Bits, MibIdentifier, TimeTicks, Integer32, Counter32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "NotificationType", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Gauge32", "Bits", "MibIdentifier", "TimeTicks", "Integer32", "Counter32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, licenseMask=licenseMask, ethTXLateCollisions=ethTXLateCollisions, safip=safip, modemEntry=modemEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1Channels=modemE1T1Channels, modemModulation=modemModulation, modemCountTime=modemCountTime, vlanFid=vlanFid, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMin=modemACMmodulationMin, radioRxFrequency=radioRxFrequency, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Frames=ethQOSRXQ2Frames, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, ethGFPFCSErrors=ethGFPFCSErrors, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, atpcEnabled=atpcEnabled, ethRXDvEvent=ethRXDvEvent, atpcIndex=atpcIndex, radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, modemTable=modemTable, pointToPoint=pointToPoint, modemACMengine=modemACMengine, vlanPortType=vlanPortType, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, ethRXByteCounterLow=ethRXByteCounterLow, radioIndex=radioIndex, e1t1LOS=e1t1LOS, ethTXControlFrames=ethTXControlFrames, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, e1t1StatTable=e1t1StatTable, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, localIp=localIp, modemErroredBlock=modemErroredBlock, ethRXCRCErrors=ethRXCRCErrors, product=product, modemSymbolRateRx=modemSymbolRateRx, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, modemACMmodulationMax=modemACMmodulationMax, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, localIpMask=localIpMask, modemStandard=modemStandard, ipRadioMgmt=ipRadioMgmt, sysDateAndTime=sysDateAndTime, modemInternalAGCgain=modemInternalAGCgain, modemCarrierOffset=modemCarrierOffset, radioGenStatus=radioGenStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioEntry=radioEntry, ethTXMulticasts=ethTXMulticasts, hostname=hostname, modemLastAcqError=modemLastAcqError, description=description, remoteIp=remoteIp, ethGFPCHECErrors=ethGFPCHECErrors, ethTXBackpresEvents=ethTXBackpresEvents, vlanCfgStat=vlanCfgStat, vlanEntry=vlanEntry, modemRadialMSE=modemRadialMSE, radioTxMute=radioTxMute, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, ethQOSTXFrames=ethQOSTXFrames, vlansEnabled=vlansEnabled, radioLoopback=radioLoopback, sysTemperature=sysTemperature, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLongEvents=ethRXLongEvents, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, writeConfig=writeConfig, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, radioDuplexShift=radioDuplexShift, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, restartcpu=restartcpu, radioTable=radioTable, aTPCEntry=aTPCEntry, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortmap=vlanPortmap)
