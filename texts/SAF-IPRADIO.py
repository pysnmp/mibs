...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:55:41 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, NotificationType, Integer32, Unsigned32, Gauge32, MibIdentifier, Counter64, TimeTicks, IpAddress, ObjectIdentity, Counter32, NotificationType, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "MibIdentifier", "Counter64", "TimeTicks", "IpAddress", "ObjectIdentity", "Counter32", "NotificationType", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTable=radioTable, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, description=description, vlanRowStatus=vlanRowStatus, modemLastAcqError=modemLastAcqError, e1t1StatTable=e1t1StatTable, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, tehnika=tehnika, radioRxFrequency=radioRxFrequency, ethRXDvEvent=ethRXDvEvent, ethGFPCHECErrors=ethGFPCHECErrors, modemUptime=modemUptime, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, licenseMask=licenseMask, ethTXBackpresEvents=ethTXBackpresEvents, atpcIndex=atpcIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXControlFrames=ethRXControlFrames, modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlansEnabled=vlansEnabled, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, ipRadioStat=ipRadioStat, modemCountTime=modemCountTime, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioMgmt=ipRadioMgmt, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, modemSymbolRateTx=modemSymbolRateTx, modemEntry=modemEntry, writeConfig=writeConfig, radioIndex=radioIndex, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLateCollisions=ethTXLateCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, product=product, e1t1LOS=e1t1LOS, modemRadialMSE=modemRadialMSE, radioSide=radioSide, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, ethRXByteCounterLow=ethRXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, modemTotalCapacity=modemTotalCapacity, radioRxLevel=radioRxLevel, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCEntry=aTPCEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemUnavailtime=modemUnavailtime, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, modemE1T1Channels=modemE1T1Channels, modemACMethernetCapacity=modemACMethernetCapacity, ethTXPauseFrames=ethTXPauseFrames, modemStatistics=modemStatistics, localIpMask=localIpMask, modemModulation=modemModulation, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRowStatus=modemRowStatus, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, ethRXDones=ethRXDones, vlanEntry=vlanEntry, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1AIS=e1t1AIS, license=license, saf=saf, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, ethTXVlanTags=ethTXVlanTags, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, atpcEnabled=atpcEnabled, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStandard=modemStandard, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBandwith=modemBandwith, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, ethTXMulticasts=ethTXMulticasts, ipRadio=ipRadio, vlanPortType=vlanPortType, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped)
