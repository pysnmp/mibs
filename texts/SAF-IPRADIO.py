...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:04:46 2023
...
iso, MibIdentifier, Counter64, IpAddress, ModuleIdentity, NotificationType, Bits, Gauge32, enterprises, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Counter64", "IpAddress", "ModuleIdentity", "NotificationType", "Bits", "Gauge32", "enterprises", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTable=modemTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXFrames=ethQOSTXFrames, radioTxFrequency=radioTxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfg=ipRadioCfg, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBandwith=modemBandwith, modemACMtotalCapacity=modemACMtotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, ethTXUnderruns=ethTXUnderruns, radioTxPower=radioTxPower, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, ethGFPFCSErrors=ethGFPFCSErrors, sysDateAndTime=sysDateAndTime, license=license, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, product=product, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethTXGiants=ethTXGiants, licenseMask=licenseMask, modemACMethernetCapacity=modemACMethernetCapacity, modemEntry=modemEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, e1t1LOS=e1t1LOS, ethTXCollisions=ethTXCollisions, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, tehnika=tehnika, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalCapacity=modemTotalCapacity, description=description, ethRXDones=ethRXDones, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, modemLastAcqError=modemLastAcqError, radioDuplexShift=radioDuplexShift, e1t1AIS=e1t1AIS, safip=safip, ethRXDvEvent=ethRXDvEvent, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXBroadcasts=ethTXBroadcasts, pointToPoint=pointToPoint, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMulticasts=ethTXMulticasts, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, modemErroredSecond=modemErroredSecond, modemModulation=modemModulation, radioRxFrequency=radioRxFrequency, modemUptime=modemUptime, ethTXLateCollisions=ethTXLateCollisions, ethTXControlFrames=ethTXControlFrames, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcEnabled=atpcEnabled, loopback_tributary_mask=loopback_tributary_mask, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanTable=vlanTable, saf=saf, restartcpu=restartcpu, loopbacks=loopbacks, modemIndex=modemIndex, ethRXControlFrames=ethRXControlFrames, localIpMask=localIpMask, radioSide=radioSide, modemStatistics=modemStatistics, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortType=vlanPortType, hostname=hostname, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, ethRXCodeErrors=ethRXCodeErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxLevel=radioRxLevel, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIp=localIp, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, atpcIndex=atpcIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredBlock=modemErroredBlock, vlansEnabled=vlansEnabled, vlanFid=vlanFid, vlanPortmap=vlanPortmap, ethGFPDropedFrames=ethGFPDropedFrames, radioTable=radioTable, ethTXDones=ethTXDones, ethRXLongEvents=ethRXLongEvents, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadio=ipRadio, modemCarrierOffset=modemCarrierOffset, vlanEntry=vlanEntry, vlanNumber=vlanNumber, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, remoteIp=remoteIp, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames)
