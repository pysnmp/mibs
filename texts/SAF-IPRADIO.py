...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalCapacity=modemTotalCapacity, tehnika=tehnika, radioLoopback=radioLoopback, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, writeConfig=writeConfig, e1t1StatTable=e1t1StatTable, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, ethTXMulticasts=ethTXMulticasts, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, ethTXLateCollisions=ethTXLateCollisions, ethRXBroadcasts=ethRXBroadcasts, modemE1T1Channels=modemE1T1Channels, ipRadio=ipRadio, vlanRowStatus=vlanRowStatus, radioTable=radioTable, ethTXMaxCollisions=ethTXMaxCollisions, radioEntry=radioEntry, modemErroredSecond=modemErroredSecond, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, modemAcqStatus=modemAcqStatus, ethTXControlFrames=ethTXControlFrames, modemRadialMSE=modemRadialMSE, radioSide=radioSide, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, vlanTable=vlanTable, modemCarrierOffset=modemCarrierOffset, modemGeneralStatus=modemGeneralStatus, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, hostname=hostname, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, license=license, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, vlansEnabled=vlansEnabled, ethTXBackpresEvents=ethTXBackpresEvents, sysDateAndTime=sysDateAndTime, ethTXByteCounterLow=ethTXByteCounterLow, modemStatistics=modemStatistics, modemEntry=modemEntry, loopbacks=loopbacks, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, modemSymbolRateRx=modemSymbolRateRx, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, ethRXDones=ethRXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, safip=safip, modemStandard=modemStandard, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemInternalAGCgain=modemInternalAGCgain, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, ipRadioStatEth=ipRadioStatEth, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatEntry=e1t1StatEntry, modemUnavailtime=modemUnavailtime, ethTXBroadcasts=ethTXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxFrequency=radioRxFrequency, restartcpu=restartcpu, remoteIp=remoteIp, radioTxPower=radioTxPower, modemACMtotalCapacity=modemACMtotalCapacity, product=product, e1t1AIS=e1t1AIS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, ethRXTruncatedFrames=ethRXTruncatedFrames, radioIndex=radioIndex, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDropedFrames=ethGFPDropedFrames, modemBandwith=modemBandwith, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanPortmap=vlanPortmap, saf=saf, modemTable=modemTable, vlanEntry=vlanEntry, localIp=localIp)
