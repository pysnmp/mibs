...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:42:05 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, ObjectIdentity, Counter32, NotificationType, Unsigned32, TimeTicks, IpAddress, enterprises, Integer32, Counter64, iso, MibIdentifier, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "Unsigned32", "TimeTicks", "IpAddress", "enterprises", "Integer32", "Counter64", "iso", "MibIdentifier", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioEntry=radioEntry, modemInternalAGCgain=modemInternalAGCgain, licenseMask=licenseMask, localIpMask=localIpMask, aTPCEntry=aTPCEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadio=ipRadio, ethRXControlFrames=ethRXControlFrames, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemIndex=modemIndex, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXFrames=ethQOSTXFrames, vlanCfgStat=vlanCfgStat, ethRXDones=ethRXDones, radioGenStatus=radioGenStatus, modemACMethernetCapacity=modemACMethernetCapacity, e1t1ChannelNr=e1t1ChannelNr, tehnika=tehnika, modemRowStatus=modemRowStatus, modemSymbolRateRx=modemSymbolRateRx, modemACMengine=modemACMengine, vlanPortType=vlanPortType, ethTXBroadcasts=ethTXBroadcasts, radioIndex=radioIndex, radioDuplexShift=radioDuplexShift, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStandard=modemStandard, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1LOS=e1t1LOS, saf=saf, modemStatistics=modemStatistics, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, description=description, modemCarrierOffset=modemCarrierOffset, ipRadioStat=ipRadioStat, license=license, modemModulation=modemModulation, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, vlanFid=vlanFid, atpcIndex=atpcIndex, vlanTable=vlanTable, ethRXLongEvents=ethRXLongEvents, localIp=localIp, aTPCTable=aTPCTable, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, ipRadioStatEth=ipRadioStatEth, hostname=hostname, ipRadioCfg=ipRadioCfg, modemEntry=modemEntry, product=product, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, modemEthernetCapacity=modemEthernetCapacity, modemTable=modemTable, ethTXVlanTags=ethTXVlanTags, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, sysDateAndTime=sysDateAndTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXMulticasts=ethRXMulticasts, modemLastAcqError=modemLastAcqError, modemUnavailtime=modemUnavailtime, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMin=modemACMmodulationMin, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, ethGFPDropedFrames=ethGFPDropedFrames, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMulticasts=ethTXMulticasts, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, loopbacks=loopbacks, radioSide=radioSide, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, e1t1AIS=e1t1AIS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, writeConfig=writeConfig, radioTxFrequency=radioTxFrequency, remoteIp=remoteIp, ethTXLateCollisions=ethTXLateCollisions, ethTXControlFrames=ethTXControlFrames, restartcpu=restartcpu, radioTxMute=radioTxMute, modemACMmodulationMax=modemACMmodulationMax, modemErroredBlock=modemErroredBlock, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors)
