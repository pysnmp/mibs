...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:10:40 2024
...
Counter64, iso, Integer32, NotificationType, Gauge32, TimeTicks, ObjectIdentity, MibIdentifier, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, NotificationType, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Integer32", "NotificationType", "Gauge32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "NotificationType", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", localIpMask=localIpMask, ethRXDones=ethRXDones, modemErroredSecondRatio=modemErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMax=modemACMmodulationMax, vlanPortType=vlanPortType, e1t1StatEntry=e1t1StatEntry, radioTxFrequency=radioTxFrequency, vlansEnabled=vlansEnabled, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, radioLoopback=radioLoopback, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, e1t1StatTable=e1t1StatTable, ethRXCRCErrors=ethRXCRCErrors, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRowStatus=modemRowStatus, vlanEntry=vlanEntry, modemGeneralStatus=modemGeneralStatus, product=product, ethTXControlFrames=ethTXControlFrames, localIp=localIp, modemUptime=modemUptime, ethGFPCHECErrors=ethGFPCHECErrors, loopbacks=loopbacks, ethRXMulticasts=ethRXMulticasts, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, modemCountTime=modemCountTime, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, hostname=hostname, vlanCfgStat=vlanCfgStat, e1t1AIS=e1t1AIS, ethRXDribleNibbles=ethRXDribleNibbles, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, description=description, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxMute=radioTxMute, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, modemEntry=modemEntry, modemModulation=modemModulation, radioTable=radioTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, radioRxLevel=radioRxLevel, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, vlanFid=vlanFid, radioSide=radioSide, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, licenseMask=licenseMask, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, modemTotalBlockNumber=modemTotalBlockNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, remoteIp=remoteIp, radioIndex=radioIndex, modemACMengine=modemACMengine, modemEthernetCapacity=modemEthernetCapacity, modemAcqStatus=modemAcqStatus, modemStandard=modemStandard, ethTXDones=ethTXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, radioTxPower=radioTxPower, vlanNumber=vlanNumber, modemIndex=modemIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, license=license, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, ethTXGiants=ethTXGiants, aTPCTable=aTPCTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, saf=saf, modemErroredBlock=modemErroredBlock, modemUnavailtime=modemUnavailtime, radioEntry=radioEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, radioDuplexShift=radioDuplexShift, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, e1t1LOS=e1t1LOS, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig)
