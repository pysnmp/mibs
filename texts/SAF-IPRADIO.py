...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:32:11 2023
...
ModuleIdentity, TimeTicks, NotificationType, iso, Unsigned32, Counter32, Gauge32, IpAddress, Integer32, enterprises, MibIdentifier, Counter64, NotificationType, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "iso", "Unsigned32", "Counter32", "Gauge32", "IpAddress", "Integer32", "enterprises", "MibIdentifier", "Counter64", "NotificationType", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, writeConfig=writeConfig, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, modemTotalBlockNumber=modemTotalBlockNumber, modemRowStatus=modemRowStatus, modemIndex=modemIndex, description=description, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, ethTXExcessiveDefers=ethTXExcessiveDefers, localIp=localIp, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, sysDateAndTime=sysDateAndTime, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, license=license, vlanPortType=vlanPortType, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, hostname=hostname, radioRxLevel=radioRxLevel, ipRadio=ipRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateTx=modemSymbolRateTx, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcEnabled=atpcEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStandard=modemStandard, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxMute=radioTxMute, ethTXControlFrames=ethTXControlFrames, modemModulation=modemModulation, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, ethRXControlFrames=ethRXControlFrames, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, modemCountTime=modemCountTime, modemStatistics=modemStatistics, aTPCTable=aTPCTable, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, vlanFid=vlanFid, radioDuplexShift=radioDuplexShift, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, modemLDPCdecoderStress=modemLDPCdecoderStress, radioSide=radioSide, ethRXDones=ethRXDones, ethRXDvEvent=ethRXDvEvent, modemInternalAGCgain=modemInternalAGCgain, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, safip=safip, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemTable=modemTable, radioGenStatus=radioGenStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDropedFrames=ethGFPDropedFrames, modemEthernetCapacity=modemEthernetCapacity, modemBandwith=modemBandwith, ethRXPauseFrames=ethRXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCRCErrors=ethTXCRCErrors, e1t1StatTable=e1t1StatTable, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, radioLoopback=radioLoopback, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioEntry=radioEntry, modemErroredSecondRatio=modemErroredSecondRatio, tehnika=tehnika, ethTXBroadcasts=ethTXBroadcasts, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, ethQOSTXFrames=ethQOSTXFrames, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCarrierOffset=modemCarrierOffset, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, remoteIp=remoteIp, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, vlanTable=vlanTable, saf=saf, ethTXPauseFrames=ethTXPauseFrames, product=product, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, ethTXMulticasts=ethTXMulticasts)
