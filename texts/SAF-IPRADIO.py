...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:28:02 2024
...
ObjectIdentity, NotificationType, enterprises, Unsigned32, Gauge32, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, TimeTicks, Integer32, NotificationType, ModuleIdentity, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "enterprises", "Unsigned32", "Gauge32", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "TimeTicks", "Integer32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcIndex=atpcIndex, product=product, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, ethTXBroadcasts=ethTXBroadcasts, licenseMask=licenseMask, radioRxLevel=radioRxLevel, tehnika=tehnika, radioTable=radioTable, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemIndex=modemIndex, atpcEnabled=atpcEnabled, e1t1LOS=e1t1LOS, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, ethRXByteCounterLow=ethRXByteCounterLow, radioTxFrequency=radioTxFrequency, loopback_tributary_mask=loopback_tributary_mask, ethGFPDropedFrames=ethGFPDropedFrames, hostname=hostname, ethTXMaxCollisions=ethTXMaxCollisions, radioSide=radioSide, radioRxFrequency=radioRxFrequency, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXDropped=ethQOSTXDropped, ethTXCollisions=ethTXCollisions, ipRadioStat=ipRadioStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioEntry=radioEntry, ethRXBroadcasts=ethRXBroadcasts, modemTable=modemTable, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, vlanTable=vlanTable, licenseUpdateStatus=licenseUpdateStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, ethRXPauseFrames=ethRXPauseFrames, ethTXBackpresEvents=ethTXBackpresEvents, localIp=localIp, modemErroredSecond=modemErroredSecond, modemGeneralStatus=modemGeneralStatus, vlansEnabled=vlansEnabled, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1ChannelNr=e1t1ChannelNr, radioLoopback=radioLoopback, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, vlanPortmap=vlanPortmap, description=description, modemACMmodulationMax=modemACMmodulationMax, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, sysDateAndTime=sysDateAndTime, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, vlanPortType=vlanPortType, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, e1t1StatTable=e1t1StatTable, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMin=modemACMmodulationMin, vlanNumber=vlanNumber, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, localIpMask=localIpMask, pointToPoint=pointToPoint, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioIndex=radioIndex, saf=saf, restartcpu=restartcpu, ipRadioStatEth=ipRadioStatEth, modemModulation=modemModulation, modemRadialMSE=modemRadialMSE, ipRadio=ipRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, safip=safip, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, modemUnavailtime=modemUnavailtime, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXVlanTags=ethTXVlanTags, sysTemperature=sysTemperature, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, radioTxMute=radioTxMute, ipRadioCfgGeneral=ipRadioCfgGeneral, microwaveRadio=microwaveRadio, e1t1AIS=e1t1AIS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, remoteIp=remoteIp, modemAcqStatus=modemAcqStatus, license=license, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterHi=ethRXByteCounterHi)
