...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:36:14 2023
...
TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, iso, Gauge32, enterprises, Counter64, ModuleIdentity, ObjectIdentity, MibIdentifier, NotificationType, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "iso", "Gauge32", "enterprises", "Counter64", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "NotificationType", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCarrierOffset=modemCarrierOffset, modemTotalCapacity=modemTotalCapacity, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, modemBandwith=modemBandwith, ethRXDones=ethRXDones, modemInternalAGCgain=modemInternalAGCgain, safip=safip, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateRx=modemSymbolRateRx, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEthernetCapacity=modemEthernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCRCErrors=ethRXCRCErrors, radioTxMute=radioTxMute, radioLoopback=radioLoopback, ethTXCRCErrors=ethTXCRCErrors, writeConfig=writeConfig, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredBlock=modemErroredBlock, ethQOSTXDropped=ethQOSTXDropped, modemRadialMSE=modemRadialMSE, aTPCTable=aTPCTable, e1t1StatEntry=e1t1StatEntry, vlanCfgStat=vlanCfgStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemModulation=modemModulation, description=description, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, e1t1LOS=e1t1LOS, modemErroredSecond=modemErroredSecond, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxFrequency=radioRxFrequency, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, radioIndex=radioIndex, aTPCEntry=aTPCEntry, ethTXDones=ethTXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ethTXBackpresEvents=ethTXBackpresEvents, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcEnabled=atpcEnabled, radioTxFrequency=radioTxFrequency, tehnika=tehnika, ethTXBroadcasts=ethTXBroadcasts, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXVlanTags=ethTXVlanTags, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMulticasts=ethTXMulticasts, license=license, modemUnavailtime=modemUnavailtime, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioMgmt=ipRadioMgmt, vlanTable=vlanTable, radioTable=radioTable, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, modemACMmodulationMax=modemACMmodulationMax, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, localIp=localIp, saf=saf, modemTable=modemTable, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, ethTXPauseFrames=ethTXPauseFrames, microwaveRadio=microwaveRadio, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMin=modemACMmodulationMin, ipRadioStat=ipRadioStat, product=product, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStandard=modemStandard, hostname=hostname, atpcIndex=atpcIndex, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemCountTime=modemCountTime, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, modemACMethernetCapacity=modemACMethernetCapacity, ethTXUnderruns=ethTXUnderruns, ethTXMaxCollisions=ethTXMaxCollisions, modemGeneralStatus=modemGeneralStatus, modemLastAcqError=modemLastAcqError, vlanFid=vlanFid, vlanPortmap=vlanPortmap, sysDateAndTime=sysDateAndTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask)
