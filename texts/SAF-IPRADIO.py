...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:25:06 2022
...
Counter32, Integer32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, MibIdentifier, enterprises, Counter64, TimeTicks, ModuleIdentity, Bits, IpAddress, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "MibIdentifier", "enterprises", "Counter64", "TimeTicks", "ModuleIdentity", "Bits", "IpAddress", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioEntry=radioEntry, pointToPoint=pointToPoint, modemTable=modemTable, vlanTable=vlanTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, safip=safip, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, vlanCfgStat=vlanCfgStat, ipRadio=ipRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXControlFrames=ethRXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioLoopback=radioLoopback, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortmap=vlanPortmap, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, license=license, modemErroredBlock=modemErroredBlock, vlanPortType=vlanPortType, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopbacks=loopbacks, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, modemIndex=modemIndex, modemStatistics=modemStatistics, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXByteCounterHi=ethTXByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMmodulationMin=modemACMmodulationMin, modemStandard=modemStandard, modemEntry=modemEntry, ethRXDvEvent=ethRXDvEvent, modemACMengine=modemACMengine, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, tehnika=tehnika, ethTXMaxCollisions=ethTXMaxCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioStat=ipRadioStat, modemBandwith=modemBandwith, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, restartcpu=restartcpu, vlanNumber=vlanNumber, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, radioSide=radioSide, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxPower=radioTxPower, e1t1LOS=e1t1LOS, ethRXLongEvents=ethRXLongEvents, saf=saf, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, vlansEnabled=vlansEnabled, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, remoteIp=remoteIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMulticasts=ethTXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, ethTXControlFrames=ethTXControlFrames, ethTXVlanTags=ethTXVlanTags, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, aTPCEntry=aTPCEntry, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXDropped=ethQOSTXDropped, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, licenseMask=licenseMask, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, ipRadioStatEth=ipRadioStatEth, modemCarrierOffset=modemCarrierOffset, e1t1StatTable=e1t1StatTable, ethTXBackpresEvents=ethTXBackpresEvents, modemModulation=modemModulation, ethRXCRCErrors=ethRXCRCErrors, e1t1StatEntry=e1t1StatEntry, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, ethTXGiants=ethTXGiants, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, radioTxMute=radioTxMute, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, description=description, ethTXCollisions=ethTXCollisions, modemAcqStatus=modemAcqStatus, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, product=product, hostname=hostname, loopback_tributary_mask=loopback_tributary_mask)
