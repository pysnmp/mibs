...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:47:32 2021
...
NotificationType, Gauge32, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, NotificationType, Integer32, Unsigned32, Bits, Counter32, Counter64, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "NotificationType", "Integer32", "Unsigned32", "Bits", "Counter32", "Counter64", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCRCErrors=ethRXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, modemErroredBlock=modemErroredBlock, radioGenStatus=radioGenStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUnavailtime=modemUnavailtime, radioTxMute=radioTxMute, description=description, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, modemStatistics=modemStatistics, e1t1LOS=e1t1LOS, saf=saf, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDones=ethRXDones, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, modemAcqStatus=modemAcqStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, writeConfig=writeConfig, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, vlansEnabled=vlansEnabled, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, ethQOSTXFrames=ethQOSTXFrames, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfg=ipRadioCfg, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxPower=radioTxPower, modemModulation=modemModulation, ethRXBroadcasts=ethRXBroadcasts, modemUptime=modemUptime, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, vlanCfgStat=vlanCfgStat, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, modemStandard=modemStandard, modemTable=modemTable, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioSide=radioSide, atpcEnabled=atpcEnabled, ethTXCRCErrors=ethTXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemIndex=modemIndex, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, sysTemperature=sysTemperature, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, radioIndex=radioIndex, license=license, ethRXMulticasts=ethRXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, aTPCTable=aTPCTable, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, radioLoopback=radioLoopback, localIpMask=localIpMask, radioRxFrequency=radioRxFrequency, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioEntry=radioEntry, ipRadioStatEth=ipRadioStatEth, vlanFid=vlanFid, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, restartcpu=restartcpu, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, atpcIndex=atpcIndex, ethTXBackpresEvents=ethTXBackpresEvents, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, ethGFPFCSErrors=ethGFPFCSErrors, aTPCEntry=aTPCEntry, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, localIp=localIp, product=product, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, e1t1AIS=e1t1AIS, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr, safip=safip)
