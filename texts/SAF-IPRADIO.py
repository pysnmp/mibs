...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:35:33 2021
...
TimeTicks, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, enterprises, Unsigned32, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, Bits, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "enterprises", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "Bits", "Counter32", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, modemInternalAGCgain=modemInternalAGCgain, e1t1ChannelNr=e1t1ChannelNr, e1t1StatEntry=e1t1StatEntry, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemGeneralStatus=modemGeneralStatus, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecond=modemSeverelyErroredSecond, license=license, aTPCEntry=aTPCEntry, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, ethTXCRCErrors=ethTXCRCErrors, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, pointToPoint=pointToPoint, modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, modemRadialMSE=modemRadialMSE, ethRXByteCounterHi=ethRXByteCounterHi, modemUptime=modemUptime, ethTXMulticasts=ethTXMulticasts, radioIndex=radioIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, ethTXControlFrames=ethTXControlFrames, saf=saf, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, modemStandard=modemStandard, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBandwith=modemBandwith, modemStatistics=modemStatistics, modemCarrierOffset=modemCarrierOffset, safip=safip, vlanTable=vlanTable, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, product=product, ethTXPauseFrames=ethTXPauseFrames, radioTxMute=radioTxMute, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMax=modemACMmodulationMax, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, modemTable=modemTable, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, loopback_tributary_mask=loopback_tributary_mask, restartcpu=restartcpu, e1t1LOS=e1t1LOS, modemSymbolRateTx=modemSymbolRateTx, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, vlanPortmap=vlanPortmap, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDones=ethRXDones, modemIndex=modemIndex, ethTXUnderruns=ethTXUnderruns, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, aTPCTable=aTPCTable, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCRCErrors=ethRXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, vlanEntry=vlanEntry, atpcIndex=atpcIndex, e1t1AIS=e1t1AIS, ethTXBackpresEvents=ethTXBackpresEvents, modemCountTime=modemCountTime, modemEthernetCapacity=modemEthernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, localIp=localIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, ipRadio=ipRadio, description=description, ethRXBroadcasts=ethRXBroadcasts, licenseMask=licenseMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTable=radioTable, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, hostname=hostname, vlansEnabled=vlansEnabled, radioSide=radioSide, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, tehnika=tehnika)
