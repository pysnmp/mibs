...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:43:40 2022
...
Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Bits, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32, NotificationType, Integer32, TimeTicks, iso, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Bits", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32", "NotificationType", "Integer32", "TimeTicks", "iso", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxMute=radioTxMute, radioTxPower=radioTxPower, modemCountTime=modemCountTime, modemBandwith=modemBandwith, licenseUpdateStatus=licenseUpdateStatus, modemAcqStatus=modemAcqStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStat=ipRadioStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, saf=saf, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, modemUnavailtime=modemUnavailtime, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortType=vlanPortType, ethTXGiants=ethTXGiants, sysDateAndTime=sysDateAndTime, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, radioLoopback=radioLoopback, ethTXMulticasts=ethTXMulticasts, modemStandard=modemStandard, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXControlFrames=ethRXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSTXFrames=ethQOSTXFrames, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, radioDuplexShift=radioDuplexShift, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, product=product, e1t1StatTable=e1t1StatTable, ipRadioCfgNetwork=ipRadioCfgNetwork, radioIndex=radioIndex, aTPCEntry=aTPCEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, vlanCfgStat=vlanCfgStat, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, restartcpu=restartcpu, modemACMengine=modemACMengine, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, pointToPoint=pointToPoint, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortmap=vlanPortmap, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredBlock=modemErroredBlock, radioGenStatus=radioGenStatus, writeConfig=writeConfig, ipRadioMgmt=ipRadioMgmt, description=description, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, ipRadio=ipRadio, modemErroredSecondRatio=modemErroredSecondRatio, radioTable=radioTable, modemACMethernetCapacity=modemACMethernetCapacity, modemRadialMSE=modemRadialMSE, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, ethGFPFCSErrors=ethGFPFCSErrors, safip=safip, license=license, modemCarrierOffset=modemCarrierOffset, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, sysTemperature=sysTemperature, e1t1LOS=e1t1LOS, remoteIp=remoteIp, vlanEntry=vlanEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUptime=modemUptime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, loopbacks=loopbacks, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, vlanTable=vlanTable, modemTable=modemTable, atpcEnabled=atpcEnabled, ethRXCodeErrors=ethRXCodeErrors, atpcIndex=atpcIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEntry=modemEntry, ethTXMaxCollisions=ethTXMaxCollisions, microwaveRadio=microwaveRadio, modemIndex=modemIndex, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1AIS=e1t1AIS, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDones=ethRXDones, hostname=hostname, ethTXByteCounterHi=ethTXByteCounterHi, vlanFid=vlanFid, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemInternalAGCgain=modemInternalAGCgain, ethTXBroadcasts=ethTXBroadcasts, aTPCTable=aTPCTable)
