...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:43:37 2023
...
ObjectIdentity, ModuleIdentity, enterprises, Gauge32, Counter32, MibIdentifier, IpAddress, TimeTicks, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Unsigned32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "enterprises", "Gauge32", "Counter32", "MibIdentifier", "IpAddress", "TimeTicks", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Unsigned32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, product=product, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, radioTxMute=radioTxMute, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanNumber=vlanNumber, ethTXMaxCollisions=ethTXMaxCollisions, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, saf=saf, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalCapacity=modemTotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemE1T1Channels=modemE1T1Channels, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMax=modemACMmodulationMax, radioDuplexShift=radioDuplexShift, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxLevel=radioRxLevel, aTPCTable=aTPCTable, ethTXControlFrames=ethTXControlFrames, ipRadioStat=ipRadioStat, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioSide=radioSide, modemEntry=modemEntry, modemIndex=modemIndex, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, hostname=hostname, radioLoopback=radioLoopback, ipRadioCfg=ipRadioCfg, ethTXDones=ethTXDones, modemRowStatus=modemRowStatus, radioIndex=radioIndex, remoteIp=remoteIp, modemUptime=modemUptime, pointToPoint=pointToPoint, modemACMengine=modemACMengine, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcEnabled=atpcEnabled, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, ipRadioMgmt=ipRadioMgmt, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethRXCRCErrors=ethRXCRCErrors, license=license, ipRadio=ipRadio, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDvEvent=ethRXDvEvent, ethTXBackpresEvents=ethTXBackpresEvents, e1t1LOS=e1t1LOS, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, modemGeneralStatus=modemGeneralStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, vlanTable=vlanTable, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemCountTime=modemCountTime, ethTXCollisions=ethTXCollisions, modemStatistics=modemStatistics, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortmap=vlanPortmap, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, ethQOSRXQ2Frames=ethQOSRXQ2Frames, writeConfig=writeConfig, loopbacks=loopbacks, loopback_tributary_mask=loopback_tributary_mask, ethRXMulticasts=ethRXMulticasts, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, modemTable=modemTable, modemErroredBlock=modemErroredBlock, ethRXCodeErrors=ethRXCodeErrors, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, restartcpu=restartcpu, ethTXVlanTags=ethTXVlanTags, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTable=radioTable, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, ethQOSTXFrames=ethQOSTXFrames, description=description, radioTxPower=radioTxPower, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, microwaveRadio=microwaveRadio, modemSymbolRateRx=modemSymbolRateRx, ethRXPauseFrames=ethRXPauseFrames, ipRadioStatEth=ipRadioStatEth, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, modemUnavailtime=modemUnavailtime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, sysTemperature=sysTemperature, licenseMask=licenseMask, vlanEntry=vlanEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, safip=safip, modemErroredSecondRatio=modemErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts)
