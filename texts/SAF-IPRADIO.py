...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:06:06 2022
...
Bits, TimeTicks, Counter32, NotificationType, ModuleIdentity, Gauge32, Counter64, ObjectIdentity, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, NotificationType, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "Gauge32", "Counter64", "ObjectIdentity", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "NotificationType", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcTxPowerCorrection=atpcTxPowerCorrection, localIp=localIp, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, license=license, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfg=ipRadioCfg, sysTemperature=sysTemperature, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMengine=modemACMengine, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, ethGFPCHECErrors=ethGFPCHECErrors, remoteIp=remoteIp, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCTable=aTPCTable, e1t1AIS=e1t1AIS, ipRadio=ipRadio, radioTable=radioTable, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCRCErrors=ethRXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, radioSide=radioSide, ipRadioMgmt=ipRadioMgmt, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, radioTxPower=radioTxPower, vlanEntry=vlanEntry, description=description, radioLoopback=radioLoopback, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, ethTXVlanTags=ethTXVlanTags, modemRadialMSE=modemRadialMSE, radioEntry=radioEntry, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, vlanCfgStat=vlanCfgStat, writeConfig=writeConfig, modemModulation=modemModulation, modemErroredSecond=modemErroredSecond, vlanPortmap=vlanPortmap, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, vlanTable=vlanTable, product=product, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStatEth=ipRadioStatEth, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, vlanRowStatus=vlanRowStatus, ethTXControlFrames=ethTXControlFrames, ethTXGiants=ethTXGiants, modemE1T1Channels=modemE1T1Channels, safip=safip, radioDuplexShift=radioDuplexShift, radioTxMute=radioTxMute, modemTotalCapacity=modemTotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEthernetCapacity=modemEthernetCapacity, tehnika=tehnika, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, sysDateAndTime=sysDateAndTime, ethTXBroadcasts=ethTXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, loopbacks=loopbacks, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, saf=saf, ethRXDones=ethRXDones, radioGenStatus=radioGenStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, aTPCEntry=aTPCEntry, ethRXCodeErrors=ethRXCodeErrors, vlanFid=vlanFid, vlansEnabled=vlansEnabled, radioIndex=radioIndex, pointToPoint=pointToPoint, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, modemTable=modemTable, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones, vlanPortType=vlanPortType, ethRXPauseFrames=ethRXPauseFrames, modemGeneralStatus=modemGeneralStatus, ethRXMulticasts=ethRXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseMask=licenseMask, ethTXMaxCollisions=ethTXMaxCollisions, modemEntry=modemEntry)
