...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:06:39 2022
...
Gauge32, ObjectIdentity, MibIdentifier, iso, enterprises, Bits, Counter64, NotificationType, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, NotificationType, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "iso", "enterprises", "Bits", "Counter64", "NotificationType", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "NotificationType", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, modemACMethernetCapacity=modemACMethernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, microwaveRadio=microwaveRadio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, modemAcqStatus=modemAcqStatus, modemSymbolRateRx=modemSymbolRateRx, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1Channels=modemE1T1Channels, ethTXCRCErrors=ethTXCRCErrors, ipRadioStatEth=ipRadioStatEth, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, radioTxPower=radioTxPower, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, saf=saf, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioDuplexShift=radioDuplexShift, modemStatistics=modemStatistics, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, radioSide=radioSide, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, pointToPoint=pointToPoint, ethTXMaxCollisions=ethTXMaxCollisions, licenseMask=licenseMask, writeConfig=writeConfig, localIp=localIp, ethRXDones=ethRXDones, vlanFid=vlanFid, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecond=modemErroredSecond, modemTable=modemTable, vlansEnabled=vlansEnabled, license=license, ethRXDvEvent=ethRXDvEvent, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, radioRxFrequency=radioRxFrequency, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, sysTemperature=sysTemperature, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, ethTXBackpresEvents=ethTXBackpresEvents, remoteIp=remoteIp, modemErroredSecondRatio=modemErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, modemIndex=modemIndex, ethRXByteCounterHi=ethRXByteCounterHi, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, product=product, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXDropped=ethQOSTXDropped, atpcIndex=atpcIndex, ipRadio=ipRadio, vlanTable=vlanTable, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, ethRXPauseFrames=ethRXPauseFrames, vlanNumber=vlanNumber, tehnika=tehnika, ipRadioCfg=ipRadioCfg, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXCodeErrors=ethRXCodeErrors, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, description=description, localIpMask=localIpMask, modemRowStatus=modemRowStatus, safip=safip, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, modemEntry=modemEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors)
