...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:06:31 2023
...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Bits, Integer32, Counter64, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, enterprises, Counter32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Bits", "Integer32", "Counter64", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "enterprises", "Counter32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXDropped=ethQOSTXDropped, license=license, ethTXByteCounterHi=ethTXByteCounterHi, modemGeneralStatus=modemGeneralStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, modemBandwith=modemBandwith, ethTXPauseFrames=ethTXPauseFrames, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfg=ipRadioCfg, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, sysDateAndTime=sysDateAndTime, remoteIp=remoteIp, aTPCEntry=aTPCEntry, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, restartcpu=restartcpu, e1t1AIS=e1t1AIS, hostname=hostname, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, saf=saf, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, licenseMask=licenseMask, vlanTable=vlanTable, vlansEnabled=vlansEnabled, tehnika=tehnika, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, sysTemperature=sysTemperature, vlanNumber=vlanNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, ethTXLateCollisions=ethTXLateCollisions, modemACMengine=modemACMengine, description=description, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxPower=radioTxPower, vlanRowStatus=vlanRowStatus, ethTXUnderruns=ethTXUnderruns, ethTXCRCErrors=ethTXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatEntry=e1t1StatEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCollisions=ethTXCollisions, radioIndex=radioIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStatistics=modemStatistics, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, modemCountTime=modemCountTime, modemUnavailtime=modemUnavailtime, modemModulation=modemModulation, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, localIp=localIp, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, vlanPortmap=vlanPortmap, modemInternalAGCgain=modemInternalAGCgain, ethTXMulticasts=ethTXMulticasts, ipRadioMgmt=ipRadioMgmt, safip=safip, microwaveRadio=microwaveRadio, modemEthernetCapacity=modemEthernetCapacity, writeConfig=writeConfig, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, radioTable=radioTable, loopbacks=loopbacks, ethTXVlanTags=ethTXVlanTags, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, ethTXControlFrames=ethTXControlFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, modemRadialMSE=modemRadialMSE, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcIndex=atpcIndex, modemTable=modemTable, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, modemIndex=modemIndex, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, modemACMmodulationMax=modemACMmodulationMax, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRowStatus=modemRowStatus, radioRxLevel=radioRxLevel, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, radioLoopback=radioLoopback, product=product, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, vlanEntry=vlanEntry, modemAcqStatus=modemAcqStatus)
