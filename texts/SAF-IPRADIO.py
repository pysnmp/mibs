...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:38:12 2022
...
enterprises, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, NotificationType, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "NotificationType", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, modemStatistics=modemStatistics, ethTXByteCounterHi=ethTXByteCounterHi, e1t1LOS=e1t1LOS, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXDropped=ethQOSTXDropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanNumber=vlanNumber, ethTXControlFrames=ethTXControlFrames, restartcpu=restartcpu, modemSymbolRateRx=modemSymbolRateRx, product=product, ethTXLateCollisions=ethTXLateCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, aTPCTable=aTPCTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlansEnabled=vlansEnabled, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, ipRadioStatEth=ipRadioStatEth, modemAcqStatus=modemAcqStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, ethTXCRCErrors=ethTXCRCErrors, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemGeneralStatus=modemGeneralStatus, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, licenseMask=licenseMask, aTPCEntry=aTPCEntry, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, radioGenStatus=radioGenStatus, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, ethRXDones=ethRXDones, modemEntry=modemEntry, vlanFid=vlanFid, loopback_tributary_mask=loopback_tributary_mask, modemLastAcqError=modemLastAcqError, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1AIS=e1t1AIS, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, sysDateAndTime=sysDateAndTime, ethRXTruncatedFrames=ethRXTruncatedFrames, radioSide=radioSide, modemACMmodulationMin=modemACMmodulationMin, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, modemCountTime=modemCountTime, radioEntry=radioEntry, modemUptime=modemUptime, radioTxFrequency=radioTxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, modemACMengine=modemACMengine, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, radioTable=radioTable, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, microwaveRadio=microwaveRadio, ipRadioCfgGeneral=ipRadioCfgGeneral, modemModulation=modemModulation, radioLoopback=radioLoopback, ethTXPauseFrames=ethTXPauseFrames, remoteIp=remoteIp, modemStandard=modemStandard, modemEthernetCapacity=modemEthernetCapacity, radioIndex=radioIndex, modemInternalAGCgain=modemInternalAGCgain, radioTxMute=radioTxMute, loopbacks=loopbacks, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIp=localIp, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRowStatus=modemRowStatus, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, radioTxPower=radioTxPower, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxLevel=radioRxLevel, ethRXDvEvent=ethRXDvEvent, description=description, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, safip=safip, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXLongEvents=ethRXLongEvents, atpcIndex=atpcIndex, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanEntry=vlanEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, tehnika=tehnika, modemErroredBlock=modemErroredBlock, pointToPoint=pointToPoint, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond)
