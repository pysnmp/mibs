...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:10:16 2021
...
Gauge32, ModuleIdentity, Counter64, Counter32, MibIdentifier, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, IpAddress, Bits, ObjectIdentity, enterprises, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter64", "Counter32", "MibIdentifier", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "IpAddress", "Bits", "ObjectIdentity", "enterprises", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, ethTXCRCErrors=ethTXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, radioIndex=radioIndex, modemUnavailtime=modemUnavailtime, sysDateAndTime=sysDateAndTime, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, e1t1AIS=e1t1AIS, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, radioTxPower=radioTxPower, radioLoopback=radioLoopback, product=product, vlanTable=vlanTable, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ethTXUnderruns=ethTXUnderruns, ethGFPDropedFrames=ethGFPDropedFrames, vlanCfgStat=vlanCfgStat, microwaveRadio=microwaveRadio, radioRxFrequency=radioRxFrequency, safip=safip, e1t1StatEntry=e1t1StatEntry, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, localIp=localIp, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, modemEntry=modemEntry, radioSide=radioSide, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, modemStatistics=modemStatistics, ethRXPauseFrames=ethRXPauseFrames, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioGenStatus=radioGenStatus, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, modemTable=modemTable, ipRadioStatEth=ipRadioStatEth, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMengine=modemACMengine, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, modemRadialMSE=modemRadialMSE, ethTXPauseFrames=ethTXPauseFrames, loopbacks=loopbacks, tehnika=tehnika, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, writeConfig=writeConfig, modemGeneralStatus=modemGeneralStatus, saf=saf, modemSymbolRateTx=modemSymbolRateTx, ethRXDvEvent=ethRXDvEvent, hostname=hostname, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, license=license, modemStandard=modemStandard, e1t1LOS=e1t1LOS, ethTXByteCounterLow=ethTXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXMulticasts=ethRXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecond=modemErroredSecond, atpcIndex=atpcIndex, modemRowStatus=modemRowStatus, ipRadio=ipRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanRowStatus=vlanRowStatus, description=description, restartcpu=restartcpu, aTPCEntry=aTPCEntry, vlanPortmap=vlanPortmap, pointToPoint=pointToPoint, ethRXCRCErrors=ethRXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, radioEntry=radioEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMax=modemACMmodulationMax, modemCountTime=modemCountTime, e1t1ChannelNr=e1t1ChannelNr, ethTXDones=ethTXDones, loopback_tributary_mask=loopback_tributary_mask, vlanFid=vlanFid, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemUptime=modemUptime, radioTable=radioTable, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPFCSErrors=ethGFPFCSErrors, localIpMask=localIpMask, modemCarrierOffset=modemCarrierOffset, modemInternalAGCgain=modemInternalAGCgain, modemAcqStatus=modemAcqStatus, remoteIp=remoteIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseMask=licenseMask, ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection)
