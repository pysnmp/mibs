...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:19:48 2022
...
enterprises, TimeTicks, NotificationType, ObjectIdentity, Unsigned32, IpAddress, Bits, MibIdentifier, Counter32, iso, NotificationType, Counter64, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "Counter32", "iso", "NotificationType", "Counter64", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemModulation=modemModulation, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEthernetCapacity=modemEthernetCapacity, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, radioSide=radioSide, radioGenStatus=radioGenStatus, modemStatistics=modemStatistics, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, radioIndex=radioIndex, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, radioRxLevel=radioRxLevel, ethRXByteCounterHi=ethRXByteCounterHi, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, radioTable=radioTable, modemGeneralStatus=modemGeneralStatus, ipRadioStatEth=ipRadioStatEth, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxMute=radioTxMute, aTPCEntry=aTPCEntry, modemUptime=modemUptime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, saf=saf, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTable=modemTable, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMax=modemACMmodulationMax, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, hostname=hostname, license=license, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ipRadioCfg=ipRadioCfg, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, licenseMask=licenseMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanEntry=vlanEntry, ethRXDvEvent=ethRXDvEvent, modemTotalCapacity=modemTotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemIndex=modemIndex, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, ethRXControlFrames=ethRXControlFrames, vlanTable=vlanTable, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, writeConfig=writeConfig, remoteIp=remoteIp, tehnika=tehnika, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXLongEvents=ethRXLongEvents, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, e1t1ChannelNr=e1t1ChannelNr, ethTXUnderruns=ethTXUnderruns, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemAcqStatus=modemAcqStatus, ethRXMulticasts=ethRXMulticasts, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, radioRxFrequency=radioRxFrequency, loopbacks=loopbacks, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, restartcpu=restartcpu, ethTXLateCollisions=ethTXLateCollisions, vlansEnabled=vlansEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStandard=modemStandard, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, safip=safip, localIpMask=localIpMask, e1t1LOS=e1t1LOS, localIp=localIp, modemInternalAGCgain=modemInternalAGCgain, vlanFid=vlanFid, modemErroredBlock=modemErroredBlock, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, description=description, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, modemEntry=modemEntry, modemACMengine=modemACMengine, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecond=modemErroredSecond, microwaveRadio=microwaveRadio, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap)
