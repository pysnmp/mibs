...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:35:43 2022
...
NotificationType, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, MibIdentifier, Integer32, NotificationType, iso, TimeTicks, enterprises, ObjectIdentity, Bits, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "iso", "TimeTicks", "enterprises", "ObjectIdentity", "Bits", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, e1t1AIS=e1t1AIS, modemAcqStatus=modemAcqStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadio=ipRadio, ethTXMaxCollisions=ethTXMaxCollisions, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxPower=radioTxPower, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDones=ethRXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcEnabled=atpcEnabled, modemE1T1Channels=modemE1T1Channels, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, safip=safip, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseUpdateStatus=licenseUpdateStatus, sysTemperature=sysTemperature, ethTXGiants=ethTXGiants, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, modemErroredBlock=modemErroredBlock, description=description, vlanFid=vlanFid, radioEntry=radioEntry, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, ipRadioStat=ipRadioStat, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, modemTotalBlockNumber=modemTotalBlockNumber, vlanTable=vlanTable, modemStatistics=modemStatistics, radioTxFrequency=radioTxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, modemIndex=modemIndex, radioDuplexShift=radioDuplexShift, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, e1t1LOS=e1t1LOS, modemRadialMSE=modemRadialMSE, localIpMask=localIpMask, loopback_tributary_mask=loopback_tributary_mask, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, license=license, ethQOSTXFrames=ethQOSTXFrames, modemCountTime=modemCountTime, modemEthernetCapacity=modemEthernetCapacity, ethTXBroadcasts=ethTXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, modemBandwith=modemBandwith, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, licenseMask=licenseMask, ipRadioStatEth=ipRadioStatEth, modemACMengine=modemACMengine, modemTable=modemTable, vlanPortType=vlanPortType, microwaveRadio=microwaveRadio, localIp=localIp, saf=saf, radioLoopback=radioLoopback, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, product=product, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortmap=vlanPortmap, radioRxFrequency=radioRxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStandard=modemStandard, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioIndex=radioIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, modemModulation=modemModulation, modemEntry=modemEntry, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, modemUptime=modemUptime, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, writeConfig=writeConfig, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, remoteIp=remoteIp, pointToPoint=pointToPoint, ethTXVlanTags=ethTXVlanTags, vlanNumber=vlanNumber, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, hostname=hostname, restartcpu=restartcpu, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts)
