...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:20:20 2021
...
Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter64, iso, MibIdentifier, Gauge32, NotificationType, ModuleIdentity, Integer32, Unsigned32, enterprises, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter64", "iso", "MibIdentifier", "Gauge32", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "enterprises", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, tehnika=tehnika, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethQOSTXFrames=ethQOSTXFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, atpcEnabled=atpcEnabled, radioIndex=radioIndex, radioTable=radioTable, modemTotalBlockNumber=modemTotalBlockNumber, radioLoopback=radioLoopback, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMtotalCapacity=modemACMtotalCapacity, product=product, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, vlanTable=vlanTable, radioEntry=radioEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioMgmt=ipRadioMgmt, ethTXVlanTags=ethTXVlanTags, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, localIp=localIp, radioSide=radioSide, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, localIpMask=localIpMask, ethTXDones=ethTXDones, radioTxPower=radioTxPower, writeConfig=writeConfig, atpcTxPowerCorrection=atpcTxPowerCorrection, microwaveRadio=microwaveRadio, modemEntry=modemEntry, modemTotalCapacity=modemTotalCapacity, ipRadioCfg=ipRadioCfg, radioTxMute=radioTxMute, ethTXBackpresEvents=ethTXBackpresEvents, modemIndex=modemIndex, radioRxFrequency=radioRxFrequency, remoteIp=remoteIp, modemErroredSecond=modemErroredSecond, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, vlansEnabled=vlansEnabled, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, license=license, ethRXLongEvents=ethRXLongEvents, modemSymbolRateTx=modemSymbolRateTx, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCEntry=aTPCEntry, modemTable=modemTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortType=vlanPortType, vlanPortmap=vlanPortmap, modemACMengine=modemACMengine, hostname=hostname, modemStatistics=modemStatistics, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanNumber=vlanNumber, ethTXPauseFrames=ethTXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, safip=safip, modemUptime=modemUptime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1Channels=modemE1T1Channels, ethTXCollisions=ethTXCollisions, e1t1StatEntry=e1t1StatEntry, loopbacks=loopbacks, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemRadialMSE=modemRadialMSE, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCRCErrors=ethRXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioDuplexShift=radioDuplexShift, modemCarrierOffset=modemCarrierOffset, ethTXMulticasts=ethTXMulticasts, e1t1LOS=e1t1LOS, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, licenseUpdateStatus=licenseUpdateStatus, ethRXBroadcasts=ethRXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecondRatio=modemErroredSecondRatio, modemCountTime=modemCountTime, e1t1ChannelNr=e1t1ChannelNr, vlanEntry=vlanEntry, radioGenStatus=radioGenStatus, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, modemModulation=modemModulation, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatTable=e1t1StatTable, description=description, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, saf=saf, atpcIndex=atpcIndex, ethTXControlFrames=ethTXControlFrames, modemBandwith=modemBandwith)
